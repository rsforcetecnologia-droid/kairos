// js/mobile/screens/LoginScreen.js

const { React } = window;
const { useState } = React;

// ✅ CORREÇÃO: O caminho para firebase.js agora é absoluto
import { auth, signInWithEmailAndPassword, signOut } from '/js/mobile/services/firebase.js';
            ...
            <div className="w-full max-w-md">
                ...
                <div className="px-6">
                    <div className="mb-5">
                        ...
                        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="bg-gray-700 text-gray-50 w-full px-4 py-3 rounded-lg text-base border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="seu@email.com" />
                    </div>
                    <div className="mb-4">
                        <label className="text-sm font-medium text-gray-300 mb-2 block">Senha</label>
                        <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="bg-gray-700 text-gray-50 w-full px-4 py-3 rounded-lg text-base border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="••••••••" />
                    </div>
