        ...
        <div class="modal-content">
            ...
            <form id="appointmentForm" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div><label for="apptClientName" class="block text-sm font-medium text-gray-700">Nome do Cliente</label><input type="text" id="apptClientName" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></div>
                    <div><label for="apptClientPhone" class="block text-sm font-medium text-gray-700">Telemóvel do Cliente</label><input type="tel" id="apptClientPhone" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></div>
                </div>
...
export async function loadAgendaPage() {
        ...
        <section>
            <div class="flex flex-wrap justify-between items-center mb-6 gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button data-action="new-appointment" class="py-2 px-4 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 transition">Novo Agendamento</button>
                </div>
            </div>
    ...
    contentDiv.addEventListener('click', async (e) => {
        ...
        let apptData = null;
        const card = targetElement.closest('[data-appointment]');
        if (card) {
