...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${a.status}) em ${r}:`,c),new Error(c)}return a.json()}catch(a){throw console.error(`Falha de rede ao tentar acessar ${r}:`,a.message),a.message.includes("Failed to fetch")||a.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Ma}. Verifique sua conexão com a internet.`):a}}const gu=(t,e,s,n=null)=>{let o=`/api/appointments/${t}?startDate=${e}&endDate=${s}`;return n&&(o+=`&professionalId=${n}`),F(o)},Ph=(t,e,s)=>{const n=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${s}`;return F(n)},$h=({establishmentId:t,professionalId:e,serviceIds:s,date:n})=>{const o=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${s.join(",")}&date=${n}`;return F(o)},Dh=t=>F("/api/appointments",{method:"POST",body:JSON.stringify(t)}),gi=(t,e)=>F(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),Lh=t=>F(`/api/appointments/${t}`,{method:"DELETE"}),Rh=t=>F(`/api/appointments/${t}/reopen`,{method:"POST"}),Mh=(t,e)=>F(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)});let Le;async function Nh(){if(!Le)try{Le=new(window.AudioContext||window.webkitAudioContext)}catch(t){console.error("Não foi possível inicializar o áudio:",t)}}function Bh(){if(!Le){console.warn("AudioContext não inicializado. O som não será tocado.");return}Le.state==="suspended"&&Le.resume();const t=Le.createOscillator(),e=Le.createGain();t.connect(e),e.connect(Le.destination),t.type="sine",t.frequency.setValueAtTime(800,Le.currentTime),e.gain.setValueAtTime(0,Le.currentTime),e.gain.linearRampToValueAtTime(.3,Le.currentTime+.01),e.gain.exponentialRampToValueAtTime(1e-4,Le.currentTime+.2),t.start(Le.currentTime),t.stop(Le.currentTime+.2)}function k(t,e,s="info",n=!1){const o=document.getElementById("toast-container");if(!o)return;n&&Bh();const r=document.createElement("div"),a={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},l={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},c={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${a[s]||a.info}`,r.innerHTML=`
    ...
    `;const c=o.querySelector("[data-close-modal]");c&&(c.onclick=a);const d=o.querySelector('[data-action="close-modal"]');return d&&(d.onclick=a),o.addEventListener("click",p=>{p.target.closest(".modal-content")||a()}),o.style.display="flex",{modalElement:o,close:a,setContent:l}}function mr(t){const e=document.getElementById(t);e&&(e.style.display="none")}function Vh(){document.body.addEventListener("click",()=>{Le||Nh()},{once:!0}),document.addEventListener("click",t=>{const e=t.target.closest('[data-action="close-modal"]');if(e){const n=e.dataset.target;if(n){const o=document.getElementById(n);o&&(o.style.display="none")}}if(t.target.closest("[data-close-modal]")){const n=document.getElementById("genericModal");n&&(n.style.display="none")}})}async function bc(){const t=document.getElementById("cancellationListContainer");if(!t)return;t.innerHTML='<div class="loader mx-auto"></div>';const e=document.getElementById("cancelStartDate").value,s=document.getElementById("cancelEndDate").value;try{const n=await Ph(w.establishmentId,e,s);if(n.length===0){t.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}t.innerHTML=n.map(o=>`
        ...
        `).join("")}catch(n){t.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${n.message}</p>`}}function Fh(){const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const n=`
    ...
    `,{modalElement:o}=Pe({title:"Histórico de Cancelamentos",contentHTML:n,maxWidth:"max-w-3xl"});o.querySelector("#searchCancellationsBtn").addEventListener("click",bc),bc()}const Oe=document.getElementById("sidebar"),vc=document.getElementById("sidebarToggle"),bn=document.getElementById("mainContent"),Oh=document.querySelectorAll(".sidebar-link"),yc=document.getElementById("hamburger-menu-btn"),Ds=document.getElementById("mobile-overlay");function Do(t){!Oe||!bn||(Oe.classList.toggle("collapsed",t),bn.classList.toggle("sidebar-collapsed-shift",t))}function qh(){!Oe||!Ds||(Oe.classList.add("mobile-open"),Ds.classList.add("visible"))}function go(){!Oe||!Ds||(Oe.classList.remove("mobile-open"),Ds.classList.remove("visible"))}function jh(){Do(!Oe.classList.contains("collapsed"))}function Hh(t,e,s){if(!Oe||!bn)return;bn.classList.add("main-content-shift"),window.innerWidth>=768?Do(Oe.classList.contains("collapsed")):(bn.classList.remove("main-content-shift","sidebar-collapsed-shift"),go()),vc&&vc.addEventListener("click",o=>{o.stopPropagation(),jh()}),Oe.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&Oe.classList.contains("collapsed")&&Do(!1)}),Oe.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||Do(!0))}),yc&&yc.addEventListener("click",o=>{o.stopPropagation(),qh()}),Ds&&Ds.addEventListener("click",o=>{o.stopPropagation(),go()});let n=0;Oe.addEventListener("touchstart",o=>{n=o.changedTouches[0].screenX},{passive:!0}),Oe.addEventListener("touchend",o=>{const r=o.changedTouches[0].screenX;n-r>50&&go()},{passive:!0}),Oh.forEach(o=>{const r=o.getAttribute("data-target"),a=r.replace("-section",""),l=s?.[a]!==!1,c=e===null||e[r]?.view===!0;if(!l||!c){o.style.display="none";return}o.style.display="flex",o.addEventListener("click",d=>{d.preventDefault(),r&&typeof t=="function"&&t(r),window.innerWidth<768&&go()})})}const ms=t=>{const e=t||w.establishmentId;return e?F(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Lo=(t,e)=>{const s=t||w.establishmentId;return s?F(`/api/establishments/${s}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Uh=(t,e)=>{const s=t||w.establishmentId;return s?F(`/api/establishments/${s}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},zh=(t,e)=>{const s=t||w.establishmentId;return s?F(`/api/establishments/${s}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Ge=t=>F(`/api/professionals/${t}`),Wh=t=>F(`/api/professionals/details/${t}`),fu=t=>F("/api/professionals",{method:"POST",body:JSON.stringify(t)}),jo=(t,e)=>F(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),xc=(t,e)=>jo(t,{services:e}),bu=t=>F(`/api/professionals/${t}`,{method:"DELETE"}),Gh=t=>{const e=t.map(s=>bu(s));return Promise.all(e)},ps=t=>F(`/api/services/${t}`),vu=t=>F("/api/services",{method:"POST",body:JSON.stringify(t)}),Kh=(t,e)=>F(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Jh=t=>F(`/api/services/${t}`,{method:"DELETE"}),Qh=(t,e)=>F(`/api/services/${t}/status`,{method:"PATCH",body:JSON.stringify({active:e})}),Xh=t=>F(`/api/services/stats/most-popular/${t}`),pr=t=>F(`/api/products/${t}`),yu=t=>F("/api/products",{method:"POST",body:JSON.stringify(t)}),Yh=(t,e)=>F(`/api/products/${t}`,{method:"PUT",body:JSON.stringify(e)}),Zh=t=>F(`/api/products/${t}`,{method:"DELETE"}),eg=(t,e)=>F(`/api/products/${t}/stock`,{method:"PATCH",body:JSON.stringify(e)}),tg=({startDate:t,endDate:e,productId:s,categoryId:n,establishmentId:o})=>{const r=new URLSearchParams({startDate:t,endDate:e});return s&&s!=="all"&&r.append("productId",s),n&&n!=="all"&&r.append("categoryId",n),o&&r.append("establishmentId",o),F(`/api/products/stock-history/report?${r.toString()}`)},sg={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function wc(t,e,s){return new Promise((n,o)=>{const r=new FileReader;r.readAsDataURL(t),r.onload=a=>{const l=new Image;l.src=a.target.result,l.onload=()=>{const c=document.createElement("canvas");let d=l.width,p=l.height;d>e&&(p*=e/d,d=e),c.width=d,c.height=p,c.getContext("2d").drawImage(l,0,0,d,p);const f=t.type==="image/png"&&e<500?"image/png":"image/jpeg";n(c.toDataURL(f,s))},l.onerror=c=>o(c)},r.onerror=a=>o(a)})}let Pt=null;const Ro=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let Ke=0,Ho=[];async function ng(){try{console.log("Iniciando verificação de Onboarding para ID:",w.establishmentId);const t=await ms(w.establishmentId),e=await Ge(w.establishmentId),s=await ps(w.establishmentId);Ho=s||[];const n=t&&t.name&&(t.phone||t.address),o=t&&(t.logo||t.themeColor&&t.themeColor!=="indigo"),r=t&&t.slotInterval>0,a=s&&s.length>0,l=e&&e.length>0;if(console.log("Status Onboarding:",{hasCompanyData:n,hasBranding:o,hasTimeConfig:r,hasService:a,hasProf:l}),n&&r&&l&&a)return;if(!n)Ke=0;else if(!o&&!r)Ke=1;else if(!r)Ke=2;else if(!a)Ke=3;else if(!l)Ke=4;else if(Ke===0)return;og(),bi(Ke)}catch(t){console.error("Erro ao verificar onboarding:",t)}}function og(){document.getElementById("onboarding-overlay")||(Pt=document.createElement("div"),Pt.id="onboarding-overlay",Pt.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",Pt.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",Pt.innerHTML=`
    ...
    `,document.body.appendChild(Pt),fi())}function fi(){const t=Math.round(Ke/Ro.length*100),e=document.getElementById("progress-bar"),s=document.getElementById("progress-text");e&&(e.style.width=`${t}%`),s&&(s.innerText=`${t}%`)}function bi(t){const e=document.getElementById("onboarding-step-content"),s=Ro[t];if(!s){Ec(e);return}let n="";if(s.id==="company_data")n=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(sg).map(([r,a])=>`<option value="${r}">${a.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
        ...
        `;else if(s.id==="first_prof"){const o=Ho.map(a=>`<option value="${a.id}">${a.name}</option>`).join(""),r=Ho.length>0;n=`
            <form id="step-form" class="space-y-3">
        ...
        <div class="mt-6 flex justify-end gap-2">
            ...
            <button type="button" id="next-step-btn" class="bg-indigo-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-indigo-700 transition flex items-center gap-2 text-sm">
                ${t===Ro.length-1?"Concluir":"Próximo"}
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
            </button>
        </div>
    `,document.getElementById("next-step-btn").addEventListener("click",()=>rg(s.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{t===Ro.length-1?Ec(e):(Ke++,fi(),bi(Ke))}),s.id==="branding"){const o=document.getElementById("logo-input"),r=document.getElementById("bg-input");o&&(o.onchange=async a=>{const l=a.target.files[0];if(l)try{const c=await wc(l,200,.8);document.getElementById("logo-base64").value=c,document.getElementById("logo-preview").innerHTML=`<img src="${c}" class="w-full h-full object-contain rounded">`}catch(c){console.error("Erro logo",c)}}),r&&(r.onchange=async a=>{const l=a.target.files[0];if(l)try{const c=await wc(l,1024,.7);document.getElementById("bg-base64").value=c}catch(c){console.error("Erro bg",c)}})}}function Ec(t){t.innerHTML=`
    ...
    `;const e=document.getElementById("progress-bar"),s=document.getElementById("progress-text");e&&(e.style.width="100%"),s&&(s.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{Pt&&Pt.remove(),window.location.reload()}}async function rg(t){const e=document.getElementById("step-form");if(!e.reportValidity())return;const s=document.getElementById("next-step-btn"),n=s.innerHTML;s.disabled=!0,s.innerHTML="Salvando...";const o=new FormData(e),r=Object.fromEntries(o.entries());try{if(t==="company_data")await Lo(w.establishmentId,{name:r.name,phone:r.phone,email:r.email,address:r.address,zipCode:r.zipCode});else if(t==="branding"){const a={};r.logoBase64&&(a.logo=r.logoBase64),r.bgBase64&&(a.backgroundImage=r.bgBase64),r.themeColor&&(a.themeColor=r.themeColor),r.primaryColor&&(a.primaryColor=r.primaryColor),Object.keys(a).length>0&&await Lo(w.establishmentId,a)}else if(t==="time_config"){const a=parseInt(r.slotInterval);await Lo(w.establishmentId,{slotInterval:a})}else if(t==="first_service"){const a=await vu({establishmentId:w.establishmentId,name:r.name,price:parseFloat(r.price),duration:parseInt(r.duration),active:!0});a&&Ho.push(a)}else if(t==="first_prof"){const a=await fu({establishmentId:w.establishmentId,name:r.name,specialty:r.role,active:!0,commissionRate:0});if(r.serviceId&&a&&a.id)try{xc?await xc(a.id,[r.serviceId]):jo&&await jo(a.id,{services:[r.serviceId]})}catch(l){console.warn("Não foi possível vincular o serviço automaticamente.",l)}}else t==="first_product"&&await yu({establishmentId:w.establishmentId,name:r.name,price:parseFloat(r.salePrice),stock:parseInt(r.stock),active:!0});k("Sucesso","Passo concluído!","success"),Ke++,fi(),bi(Ke)}catch(a){k("Erro","Erro ao salvar: "+a.message,"error"),s.disabled=!1,s.innerHTML=n}}var Ls;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(Ls||(Ls={}));class la extends Error{constructor(e,s,n){super(e),this.message=e,this.code=s,this.data=n}}const ag=t=>{var e,s;return t?.androidBridge?"android":!((s=(e=t?.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||s===void 0)&&s.bridge?"ios":"web"},ig=t=>{const e=t.CapacitorCustomPlatform||null,s=t.Capacitor||{},n=s.Plugins=s.Plugins||{},o=()=>e!==null?e.name:ag(t),r=()=>o()!=="web",a=h=>{const f=d.get(h);return!!(f?.platforms.has(o())||l(h))},l=h=>{var f;return(f=s.PluginHeaders)===null||f===void 0?void 0:f.find(y=>y.name===h)},c=h=>t.console.error(h),d=new Map,p=(h,f={})=>{const y=d.get(h);if(y)return console.warn(`Capacitor plugin "${h}" already registered. Cannot register plugins twice.`),y.proxy;const I=o(),_=l(h);let D;const R=async()=>(!D&&I in f?D=typeof f[I]=="function"?D=await f[I]():D=f[I]:e!==null&&!D&&"web"in f&&(D=typeof f.web=="function"?D=await f.web():D=f.web),D),O=(b,v)=>{var S,E;if(_){const C=_?.methods.find(x=>v===x.name);if(C)return C.rtype==="promise"?x=>s.nativePromise(h,v.toString(),x):(x,ne)=>s.nativeCallback(h,v.toString(),x,ne);if(b)return(S=b[v])===null||S===void 0?void 0:S.bind(b)}else{if(b)return(E=b[v])===null||E===void 0?void 0:E.bind(b);throw new la(`"${h}" plugin is not implemented on ${I}`,Ls.Unimplemented)}},N=b=>{let v;const S=(...E)=>{const C=R().then(x=>{const ne=O(x,b);if(ne){const Ne=ne(...E);return v=Ne?.remove,Ne}else throw new la(`"${h}.${b}()" is not implemented on ${I}`,Ls.Unimplemented)});return b==="addListener"&&(C.remove=async()=>v()),C};return S.toString=()=>`${b.toString()}() { [capacitor code] }`,Object.defineProperty(S,"name",{value:b,writable:!1,configurable:!1}),S},B=N("addListener"),H=N("removeListener"),G=(b,v)=>{const S=B({eventName:b},v),E=async()=>{const x=await S;H({eventName:b,callbackId:x},v)},C=new Promise(x=>S.then(()=>x({remove:E})));return C.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await E()},C},T=new Proxy({},{get(b,v){switch(v){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return _?G:B;case"removeListener":return H;default:return N(v)}}});return n[h]=T,d.set(h,{name:h,proxy:T,platforms:new Set([...Object.keys(f),..._?[I]:[]])}),T};return s.convertFileSrc||(s.convertFileSrc=h=>h),s.getPlatform=o,s.handleError=c,s.isNativePlatform=r,s.isPluginAvailable=a,s.registerPlugin=p,s.Exception=la,s.DEBUG=!!s.DEBUG,s.isLoggingEnabled=!!s.isLoggingEnabled,s},lg=t=>t.Capacitor=ig(t),Zt=lg(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),vi=Zt.registerPlugin;class xu{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,s){let n=!1;this.listeners[e]||(this.listeners[e]=[],n=!0),this.listeners[e].push(s);const r=this.windowListeners[e];r&&!r.registered&&this.addWindowListener(r),n&&this.sendRetainedArgumentsForEvent(e);const a=async()=>this.removeListener(e,s);return Promise.resolve({remove:a})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,s,n){const o=this.listeners[e];if(!o){if(n){let r=this.retainedEventArguments[e];r||(r=[]),r.push(s),this.retainedEventArguments[e]=r}return}o.forEach(r=>r(s))}hasListeners(e){var s;return!!(!((s=this.listeners[e])===null||s===void 0)&&s.length)}registerWindowListener(e,s){this.windowListeners[s]={registered:!1,windowEventName:e,pluginEventName:s,handler:n=>{this.notifyListeners(s,n)}}}unimplemented(e="not implemented"){return new Zt.Exception(e,Ls.Unimplemented)}unavailable(e="not available"){return new Zt.Exception(e,Ls.Unavailable)}async removeListener(e,s){const n=this.listeners[e];if(!n)return;const o=n.indexOf(s);this.listeners[e].splice(o,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const s=this.retainedEventArguments[e];s&&(delete this.retainedEventArguments[e],s.forEach(n=>{this.notifyListeners(e,n)}))}}const Ic=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Sc=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class cg extends xu{async getCookies(){const e=document.cookie,s={};return e.split(";").forEach(n=>{if(n.length<=0)return;let[o,r]=n.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=Sc(o).trim(),r=Sc(r).trim(),s[o]=r}),s}async setCookie(e){try{const s=Ic(e.key),n=Ic(e.value),o=`; expires=${(e.expires||"").replace("expires=","")}`,r=(e.path||"/").replace("path=",""),a=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${s}=${n||""}${o}; path=${r}; ${a};`}catch(s){return Promise.reject(s)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(s){return Promise.reject(s)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const s of e)document.cookie=s.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}vi("CapacitorCookies",{web:()=>new cg});const dg=async t=>new Promise((e,s)=>{const n=new FileReader;n.onload=()=>{const o=n.result;e(o.indexOf(",")>=0?o.split(",")[1]:o)},n.onerror=o=>s(o),n.readAsDataURL(t)}),ug=(t={})=>{const e=Object.keys(t);return Object.keys(t).map(o=>o.toLocaleLowerCase()).reduce((o,r,a)=>(o[r]=t[e[a]],o),{})},mg=(t,e=!0)=>t?Object.entries(t).reduce((n,o)=>{const[r,a]=o;let l,c;return Array.isArray(a)?(c="",a.forEach(d=>{l=e?encodeURIComponent(d):d,c+=`${r}=${l}&`}),c.slice(0,-1)):(l=e?encodeURIComponent(a):a,c=`${r}=${l}`),`${n}&${c}`},"").substr(1):null,pg=(t,e={})=>{const s=Object.assign({method:t.method||"GET",headers:t.headers},e),o=ug(t.headers)["content-type"]||"";if(typeof t.data=="string")s.body=t.data;else if(o.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[a,l]of Object.entries(t.data||{}))r.set(a,l);s.body=r.toString()}else if(o.includes("multipart/form-data")||t.data instanceof FormData){const r=new FormData;if(t.data instanceof FormData)t.data.forEach((l,c)=>{r.append(c,l)});else for(const l of Object.keys(t.data))r.append(l,t.data[l]);s.body=r;const a=new Headers(s.headers);a.delete("content-type"),s.headers=a}else(o.includes("application/json")||typeof t.data=="object")&&(s.body=JSON.stringify(t.data));return s};class hg extends xu{async request(e){const s=pg(e,e.webFetchExtra),n=mg(e.params,e.shouldEncodeUrlParams),o=n?`${e.url}?${n}`:e.url,r=await fetch(o,s),a=r.headers.get("content-type")||"";let{responseType:l="text"}=r.ok?e:{};a.includes("application/json")&&(l="json");let c,d;switch(l){case"arraybuffer":case"blob":d=await r.blob(),c=await dg(d);break;case"json":c=await r.json();break;case"document":case"text":default:c=await r.text()}const p={};return r.headers.forEach((h,f)=>{p[f]=h}),{data:c,headers:p,status:r.status,url:r.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}vi("CapacitorHttp",{web:()=>new hg});const Be=vi("PushNotifications",{}),gg=()=>{};var Tc={};const wu=function(t){const e=[];let s=0;for(let n=0;n<t.length;n++){let o=t.charCodeAt(n);o<128?e[s++]=o:o<2048?(e[s++]=o>>6|192,e[s++]=o&63|128):(o&64512)===55296&&n+1<t.length&&(t.charCodeAt(n+1)&64512)===56320?(o=65536+((o&1023)<<10)+(t.charCodeAt(++n)&1023),e[s++]=o>>18|240,e[s++]=o>>12&63|128,e[s++]=o>>6&63|128,e[s++]=o&63|128):(e[s++]=o>>12|224,e[s++]=o>>6&63|128,e[s++]=o&63|128)}return e},fg=function(t){const e=[];let s=0,n=0;for(;s<t.length;){const o=t[s++];if(o<128)e[n++]=String.fromCharCode(o);else if(o>191&&o<224){const r=t[s++];e[n++]=String.fromCharCode((o&31)<<6|r&63)}else if(o>239&&o<365){const r=t[s++],a=t[s++],l=t[s++],c=((o&7)<<18|(r&63)<<12|(a&63)<<6|l&63)-65536;e[n++]=String.fromCharCode(55296+(c>>10)),e[n++]=String.fromCharCode(56320+(c&1023))}else{const r=t[s++],a=t[s++];e[n++]=String.fromCharCode((o&15)<<12|(r&63)<<6|a&63)}}return e.join("")},Eu={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const s=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,n=[];for(let o=0;o<t.length;o+=3){const r=t[o],a=o+1<t.length,l=a?t[o+1]:0,c=o+2<t.length,d=c?t[o+2]:0,p=r>>2,h=(r&3)<<4|l>>4;let f=(l&15)<<2|d>>6,y=d&63;c||(y=64,a||(f=64)),n.push(s[p],s[h],s[f],s[y])}return n.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(wu(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):fg(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const s=e?this.charToByteMapWebSafe_:this.charToByteMap_,n=[];for(let o=0;o<t.length;){const r=s[t.charAt(o++)],l=o<t.length?s[t.charAt(o)]:0;++o;const d=o<t.length?s[t.charAt(o)]:64;++o;const h=o<t.length?s[t.charAt(o)]:64;if(++o,r==null||l==null||d==null||h==null)throw new bg;const f=r<<2|l>>4;if(n.push(f),d!==64){const y=l<<4&240|d>>2;if(n.push(y),h!==64){const I=d<<6&192|h;n.push(I)}}}return n},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}};class bg extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const vg=function(t){const e=wu(t);return Eu.encodeByteArray(e,!0)},Iu=function(t){return vg(t).replace(/\./g,"")},yg=function(t){try{return Eu.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};function xg(){if(typeof self<"u")return self;if(typeof window<"u")return window;if(typeof global<"u")return global;throw new Error("Unable to locate global object.")}const wg=()=>xg().__FIREBASE_DEFAULTS__,Eg=()=>{if(typeof process>"u"||typeof Tc>"u")return;const t=Tc.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},Ig=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&yg(t[1]);return e&&JSON.parse(e)},Sg=()=>{try{return gg()||wg()||Eg()||Ig()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}};function Tg(t){try{return(t.startsWith("http://")||t.startsWith("https://")?new URL(t).hostname:t).endsWith(".cloudworkstations.dev")}catch{return!1}}function kg(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Cg(){const t=Sg()?.forceEnvironment;if(t==="node")return!0;if(t==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function _g(){return!Cg()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function Ag(){try{return typeof indexedDB=="object"}catch{return!1}}function Pg(){return new Promise((t,e)=>{try{let s=!0;const n="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(n);o.onsuccess=()=>{o.result.close(),s||self.indexedDB.deleteDatabase(n),t(!0)},o.onupgradeneeded=()=>{s=!1},o.onerror=()=>{e(o.error?.message||"")}}catch(s){e(s)}})}const $g="FirebaseError";class hs extends Error{constructor(e,s,n){super(s),this.code=e,this.customData=n,this.name=$g,Object.setPrototypeOf(this,hs.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,hr.prototype.create)}}class hr{constructor(e,s,n){this.service=e,this.serviceName=s,this.errors=n}create(e,...s){const n=s[0]||{},o=`${this.service}/${e}`,r=this.errors[e],a=r?Dg(r,n):"Error",l=`${this.serviceName}: ${a} (${o}).`;return new hs(o,l,n)}}function Dg(t,e){return t.replace(Lg,(s,n)=>{const o=e[n];return o!=null?String(o):`<${n}?>`})}const Lg=/\{\$([^}]+)}/g;function Su(t,e){if(t===e)return!0;const s=Object.keys(t),n=Object.keys(e);for(const o of s){if(!n.includes(o))return!1;const r=t[o],a=e[o];if(kc(r)&&kc(a)){if(!Su(r,a))return!1}else if(r!==a)return!1}for(const o of n)if(!s.includes(o))return!1;return!0}function kc(t){return t!==null&&typeof t=="object"}function yt(t){return t&&t._delegate?t._delegate:t}class Dt{constructor(e,s,n){this.name=e,this.instanceFactory=s,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}var ee;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(ee||(ee={}));const Rg={debug:ee.DEBUG,verbose:ee.VERBOSE,info:ee.INFO,warn:ee.WARN,error:ee.ERROR,silent:ee.SILENT},Mg=ee.INFO,Ng={[ee.DEBUG]:"log",[ee.VERBOSE]:"log",[ee.INFO]:"info",[ee.WARN]:"warn",[ee.ERROR]:"error"},Bg=(t,e,...s)=>{if(e<t.logLevel)return;const n=new Date().toISOString(),o=Ng[e];if(o)console[o](`[${n}]  ${t.name}:`,...s);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Tu{constructor(e){this.name=e,this._logLevel=Mg,this._logHandler=Bg,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ee))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Rg[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ee.DEBUG,...e),this._logHandler(this,ee.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ee.VERBOSE,...e),this._logHandler(this,ee.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ee.INFO,...e),this._logHandler(this,ee.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ee.WARN,...e),this._logHandler(this,ee.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ee.ERROR,...e),this._logHandler(this,ee.ERROR,...e)}}const Vg=(t,e)=>e.some(s=>t instanceof s);let Cc,_c;function Fg(){return Cc||(Cc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Og(){return _c||(_c=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const ku=new WeakMap,Na=new WeakMap,Cu=new WeakMap,ca=new WeakMap,yi=new WeakMap;function qg(t){const e=new Promise((s,n)=>{const o=()=>{t.removeEventListener("success",r),t.removeEventListener("error",a)},r=()=>{s(ht(t.result)),o()},a=()=>{n(t.error),o()};t.addEventListener("success",r),t.addEventListener("error",a)});return e.then(s=>{s instanceof IDBCursor&&ku.set(s,t)}).catch(()=>{}),yi.set(e,t),e}function jg(t){if(Na.has(t))return;const e=new Promise((s,n)=>{const o=()=>{t.removeEventListener("complete",r),t.removeEventListener("error",a),t.removeEventListener("abort",a)},r=()=>{s(),o()},a=()=>{n(t.error||new DOMException("AbortError","AbortError")),o()};t.addEventListener("complete",r),t.addEventListener("error",a),t.addEventListener("abort",a)});Na.set(t,e)}let Ba={get(t,e,s){if(t instanceof IDBTransaction){if(e==="done")return Na.get(t);if(e==="objectStoreNames")return t.objectStoreNames||Cu.get(t);if(e==="store")return s.objectStoreNames[1]?void 0:s.objectStore(s.objectStoreNames[0])}return ht(t[e])},set(t,e,s){return t[e]=s,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function Hg(t){Ba=t(Ba)}function Ug(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...s){const n=t.call(da(this),e,...s);return Cu.set(n,e.sort?e.sort():[e]),ht(n)}:Og().includes(t)?function(...e){return t.apply(da(this),e),ht(ku.get(this))}:function(...e){return ht(t.apply(da(this),e))}}function zg(t){return typeof t=="function"?Ug(t):(t instanceof IDBTransaction&&jg(t),Vg(t,Fg())?new Proxy(t,Ba):t)}function ht(t){if(t instanceof IDBRequest)return qg(t);if(ca.has(t))return ca.get(t);const e=zg(t);return e!==t&&(ca.set(t,e),yi.set(e,t)),e}const da=t=>yi.get(t);function gr(t,e,{blocked:s,upgrade:n,blocking:o,terminated:r}={}){const a=indexedDB.open(t,e),l=ht(a);return n&&a.addEventListener("upgradeneeded",c=>{n(ht(a.result),c.oldVersion,c.newVersion,ht(a.transaction),c)}),s&&a.addEventListener("blocked",c=>s(c.oldVersion,c.newVersion,c)),l.then(c=>{r&&c.addEventListener("close",()=>r()),o&&c.addEventListener("versionchange",d=>o(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}function ua(t,{blocked:e}={}){const s=indexedDB.deleteDatabase(t);return e&&s.addEventListener("blocked",n=>e(n.oldVersion,n)),ht(s).then(()=>{})}const Wg=["get","getKey","getAll","getAllKeys","count"],Gg=["put","add","delete","clear"],ma=new Map;function Ac(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(ma.get(e))return ma.get(e);const s=e.replace(/FromIndex$/,""),n=e!==s,o=Gg.includes(s);if(!(s in(n?IDBIndex:IDBObjectStore).prototype)||!(o||Wg.includes(s)))return;const r=async function(a,...l){const c=this.transaction(a,o?"readwrite":"readonly");let d=c.store;return n&&(d=d.index(l.shift())),(await Promise.all([d[s](...l),o&&c.done]))[0]};return ma.set(e,r),r}Hg(t=>({...t,get:(e,s,n)=>Ac(e,s)||t.get(e,s,n),has:(e,s)=>!!Ac(e,s)||t.has(e,s)}));class Kg{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(s=>{if(Jg(s)){const n=s.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(s=>s).join(" ")}}function Jg(t){return t.getComponent()?.type==="VERSION"}const Va="@firebase/app",Pc="0.14.5";const xt=new Tu("@firebase/app"),Qg="@firebase/app-compat",Xg="@firebase/analytics-compat",Yg="@firebase/analytics",Zg="@firebase/app-check-compat",ef="@firebase/app-check",tf="@firebase/auth",sf="@firebase/auth-compat",nf="@firebase/database",of="@firebase/data-connect",rf="@firebase/database-compat",af="@firebase/functions",lf="@firebase/functions-compat",cf="@firebase/installations",df="@firebase/installations-compat",uf="@firebase/messaging",mf="@firebase/messaging-compat",pf="@firebase/performance",hf="@firebase/performance-compat",gf="@firebase/remote-config",ff="@firebase/remote-config-compat",bf="@firebase/storage",vf="@firebase/storage-compat",yf="@firebase/firestore",xf="@firebase/ai",wf="@firebase/firestore-compat",Ef="firebase",If="12.5.0",Sf={[Va]:"fire-core",[Qg]:"fire-core-compat",[Yg]:"fire-analytics",[Xg]:"fire-analytics-compat",[ef]:"fire-app-check",[Zg]:"fire-app-check-compat",[tf]:"fire-auth",[sf]:"fire-auth-compat",[nf]:"fire-rtdb",[of]:"fire-data-connect",[rf]:"fire-rtdb-compat",[af]:"fire-fn",[lf]:"fire-fn-compat",[cf]:"fire-iid",[df]:"fire-iid-compat",[uf]:"fire-fcm",[mf]:"fire-fcm-compat",[pf]:"fire-perf",[hf]:"fire-perf-compat",[gf]:"fire-rc",[ff]:"fire-rc-compat",[bf]:"fire-gcs",[vf]:"fire-gcs-compat",[yf]:"fire-fst",[wf]:"fire-fst-compat",[xf]:"fire-vertex","fire-js":"fire-js",[Ef]:"fire-js-all"};const Tf=new Map,kf=new Map,$c=new Map;function Dc(t,e){try{t.container.addComponent(e)}catch(s){xt.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,s)}}function Lt(t){const e=t.name;if($c.has(e))return xt.debug(`There were multiple attempts to register component ${e}.`),!1;$c.set(e,t);for(const s of Tf.values())Dc(s,t);for(const s of kf.values())Dc(s,t);return!0}function _u(t,e){const s=t.container.getProvider("heartbeat").getImmediate({optional:!0});return s&&s.triggerHeartbeat(),t.container.getProvider(e)}function Cf(t){return t==null?!1:t.settings!==void 0}const _f={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}'","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","server-app-deleted":"Firebase Server App has been deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}.","finalization-registry-not-supported":"FirebaseServerApp deleteOnDeref field defined but the JS runtime does not support FinalizationRegistry.","invalid-server-app-environment":"FirebaseServerApp is not for use in browser environments."},xi=new hr("app","Firebase",_f);const Af=If;function gt(t,e,s){let n=Sf[t]??t;s&&(n+=`-${s}`);const o=n.match(/\s|\//),r=e.match(/\s|\//);if(o||r){const a=[`Unable to register library "${n}" with version "${e}":`];o&&a.push(`library name "${n}" contains illegal characters (whitespace or "/")`),o&&r&&a.push("and"),r&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),xt.warn(a.join(" "));return}Lt(new Dt(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}const Pf="firebase-heartbeat-database",$f=1,Rn="firebase-heartbeat-store";let pa=null;function Au(){return pa||(pa=gr(Pf,$f,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Rn)}catch(s){console.warn(s)}}}}).catch(t=>{throw xi.create("idb-open",{originalErrorMessage:t.message})})),pa}async function Df(t){try{const s=(await Au()).transaction(Rn),n=await s.objectStore(Rn).get(Pu(t));return await s.done,n}catch(e){if(e instanceof hs)xt.warn(e.message);else{const s=xi.create("idb-get",{originalErrorMessage:e?.message});xt.warn(s.message)}}}async function Lc(t,e){try{const n=(await Au()).transaction(Rn,"readwrite");await n.objectStore(Rn).put(e,Pu(t)),await n.done}catch(s){if(s instanceof hs)xt.warn(s.message);else{const n=xi.create("idb-set",{originalErrorMessage:s?.message});xt.warn(n.message)}}}function Pu(t){return`${t.name}!${t.options.appId}`}const Lf=1024,Rf=30;class Mf{constructor(e){this.container=e,this._heartbeatsCache=null;const s=this.container.getProvider("app").getImmediate();this._storage=new Bf(s),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),n=Rc();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===n||this._heartbeatsCache.heartbeats.some(o=>o.date===n))return;if(this._heartbeatsCache.heartbeats.push({date:n,agent:s}),this._heartbeatsCache.heartbeats.length>Rf){const o=Vf(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){xt.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Rc(),{heartbeatsToSend:s,unsentEntries:n}=Nf(this._heartbeatsCache.heartbeats),o=Iu(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(e){return xt.warn(e),""}}}function Rc(){return new Date().toISOString().substring(0,10)}function Nf(t,e=Lf){const s=[];let n=t.slice();for(const o of t){const r=s.find(a=>a.agent===o.agent);if(r){if(r.dates.push(o.date),Mc(s)>e){r.dates.pop();break}}else if(s.push({agent:o.agent,dates:[o.date]}),Mc(s)>e){s.pop();break}n=n.slice(1)}return{heartbeatsToSend:s,unsentEntries:n}}class Bf{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Ag()?Pg().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const s=await Df(this.app);return s?.heartbeats?s:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const n=await this.read();return Lc(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const n=await this.read();return Lc(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}else return}}function Mc(t){return Iu(JSON.stringify({version:2,heartbeats:t})).length}function Vf(t){if(t.length===0)return-1;let e=0,s=t[0].date;for(let n=1;n<t.length;n++)t[n].date<s&&(s=t[n].date,e=n);return e}function Ff(t){Lt(new Dt("platform-logger",e=>new Kg(e),"PRIVATE")),Lt(new Dt("heartbeat",e=>new Mf(e),"PRIVATE")),gt(Va,Pc,t),gt(Va,Pc,"esm2020"),gt("fire-js","")}Ff("");var Nc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};var wi;(function(){var t;function e(T,b){function v(){}v.prototype=b.prototype,T.F=b.prototype,T.prototype=new v,T.prototype.constructor=T,T.D=function(S,E,C){for(var x=Array(arguments.length-2),ne=2;ne<arguments.length;ne++)x[ne-2]=arguments[ne];return b.prototype[E].apply(S,x)}}function s(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(n,s),n.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(T,b,v){v||(v=0);const S=Array(16);if(typeof b=="string")for(var E=0;E<16;++E)S[E]=b.charCodeAt(v++)|b.charCodeAt(v++)<<8|b.charCodeAt(v++)<<16|b.charCodeAt(v++)<<24;else for(E=0;E<16;++E)S[E]=b[v++]|b[v++]<<8|b[v++]<<16|b[v++]<<24;b=T.g[0],v=T.g[1],E=T.g[2];let C=T.g[3],x;x=b+(C^v&(E^C))+S[0]+3614090360&4294967295,b=v+(x<<7&4294967295|x>>>25),x=C+(E^b&(v^E))+S[1]+3905402710&4294967295,C=b+(x<<12&4294967295|x>>>20),x=E+(v^C&(b^v))+S[2]+606105819&4294967295,E=C+(x<<17&4294967295|x>>>15),x=v+(b^E&(C^b))+S[3]+3250441966&4294967295,v=E+(x<<22&4294967295|x>>>10),x=b+(C^v&(E^C))+S[4]+4118548399&4294967295,b=v+(x<<7&4294967295|x>>>25),x=C+(E^b&(v^E))+S[5]+1200080426&4294967295,C=b+(x<<12&4294967295|x>>>20),x=E+(v^C&(b^v))+S[6]+2821735955&4294967295,E=C+(x<<17&4294967295|x>>>15),x=v+(b^E&(C^b))+S[7]+4249261313&4294967295,v=E+(x<<22&4294967295|x>>>10),x=b+(C^v&(E^C))+S[8]+1770035416&4294967295,b=v+(x<<7&4294967295|x>>>25),x=C+(E^b&(v^E))+S[9]+2336552879&4294967295,C=b+(x<<12&4294967295|x>>>20),x=E+(v^C&(b^v))+S[10]+4294925233&4294967295,E=C+(x<<17&4294967295|x>>>15),x=v+(b^E&(C^b))+S[11]+2304563134&4294967295,v=E+(x<<22&4294967295|x>>>10),x=b+(C^v&(E^C))+S[12]+1804603682&4294967295,b=v+(x<<7&4294967295|x>>>25),x=C+(E^b&(v^E))+S[13]+4254626195&4294967295,C=b+(x<<12&4294967295|x>>>20),x=E+(v^C&(b^v))+S[14]+2792965006&4294967295,E=C+(x<<17&4294967295|x>>>15),x=v+(b^E&(C^b))+S[15]+1236535329&4294967295,v=E+(x<<22&4294967295|x>>>10),x=b+(E^C&(v^E))+S[1]+4129170786&4294967295,b=v+(x<<5&4294967295|x>>>27),x=C+(v^E&(b^v))+S[6]+3225465664&4294967295,C=b+(x<<9&4294967295|x>>>23),x=E+(b^v&(C^b))+S[11]+643717713&4294967295,E=C+(x<<14&4294967295|x>>>18),x=v+(C^b&(E^C))+S[0]+3921069994&4294967295,v=E+(x<<20&4294967295|x>>>12),x=b+(E^C&(v^E))+S[5]+3593408605&4294967295,b=v+(x<<5&4294967295|x>>>27),x=C+(v^E&(b^v))+S[10]+38016083&4294967295,C=b+(x<<9&4294967295|x>>>23),x=E+(b^v&(C^b))+S[15]+3634488961&4294967295,E=C+(x<<14&4294967295|x>>>18),x=v+(C^b&(E^C))+S[4]+3889429448&4294967295,v=E+(x<<20&4294967295|x>>>12),x=b+(E^C&(v^E))+S[9]+568446438&4294967295,b=v+(x<<5&4294967295|x>>>27),x=C+(v^E&(b^v))+S[14]+3275163606&4294967295,C=b+(x<<9&4294967295|x>>>23),x=E+(b^v&(C^b))+S[3]+4107603335&4294967295,E=C+(x<<14&4294967295|x>>>18),x=v+(C^b&(E^C))+S[8]+1163531501&4294967295,v=E+(x<<20&4294967295|x>>>12),x=b+(E^C&(v^E))+S[13]+2850285829&4294967295,b=v+(x<<5&4294967295|x>>>27),x=C+(v^E&(b^v))+S[2]+4243563512&4294967295,C=b+(x<<9&4294967295|x>>>23),x=E+(b^v&(C^b))+S[7]+1735328473&4294967295,E=C+(x<<14&4294967295|x>>>18),x=v+(C^b&(E^C))+S[12]+2368359562&4294967295,v=E+(x<<20&4294967295|x>>>12),x=b+(v^E^C)+S[5]+4294588738&4294967295,b=v+(x<<4&4294967295|x>>>28),x=C+(b^v^E)+S[8]+2272392833&4294967295,C=b+(x<<11&4294967295|x>>>21),x=E+(C^b^v)+S[11]+1839030562&4294967295,E=C+(x<<16&4294967295|x>>>16),x=v+(E^C^b)+S[14]+4259657740&4294967295,v=E+(x<<23&4294967295|x>>>9),x=b+(v^E^C)+S[1]+2763975236&4294967295,b=v+(x<<4&4294967295|x>>>28),x=C+(b^v^E)+S[4]+1272893353&4294967295,C=b+(x<<11&4294967295|x>>>21),x=E+(C^b^v)+S[7]+4139469664&4294967295,E=C+(x<<16&4294967295|x>>>16),x=v+(E^C^b)+S[10]+3200236656&4294967295,v=E+(x<<23&4294967295|x>>>9),x=b+(v^E^C)+S[13]+681279174&4294967295,b=v+(x<<4&4294967295|x>>>28),x=C+(b^v^E)+S[0]+3936430074&4294967295,C=b+(x<<11&4294967295|x>>>21),x=E+(C^b^v)+S[3]+3572445317&4294967295,E=C+(x<<16&4294967295|x>>>16),x=v+(E^C^b)+S[6]+76029189&4294967295,v=E+(x<<23&4294967295|x>>>9),x=b+(v^E^C)+S[9]+3654602809&4294967295,b=v+(x<<4&4294967295|x>>>28),x=C+(b^v^E)+S[12]+3873151461&4294967295,C=b+(x<<11&4294967295|x>>>21),x=E+(C^b^v)+S[15]+530742520&4294967295,E=C+(x<<16&4294967295|x>>>16),x=v+(E^C^b)+S[2]+3299628645&4294967295,v=E+(x<<23&4294967295|x>>>9),x=b+(E^(v|~C))+S[0]+4096336452&4294967295,b=v+(x<<6&4294967295|x>>>26),x=C+(v^(b|~E))+S[7]+1126891415&4294967295,C=b+(x<<10&4294967295|x>>>22),x=E+(b^(C|~v))+S[14]+2878612391&4294967295,E=C+(x<<15&4294967295|x>>>17),x=v+(C^(E|~b))+S[5]+4237533241&4294967295,v=E+(x<<21&4294967295|x>>>11),x=b+(E^(v|~C))+S[12]+1700485571&4294967295,b=v+(x<<6&4294967295|x>>>26),x=C+(v^(b|~E))+S[3]+2399980690&4294967295,C=b+(x<<10&4294967295|x>>>22),x=E+(b^(C|~v))+S[10]+4293915773&4294967295,E=C+(x<<15&4294967295|x>>>17),x=v+(C^(E|~b))+S[1]+2240044497&4294967295,v=E+(x<<21&4294967295|x>>>11),x=b+(E^(v|~C))+S[8]+1873313359&4294967295,b=v+(x<<6&4294967295|x>>>26),x=C+(v^(b|~E))+S[15]+4264355552&4294967295,C=b+(x<<10&4294967295|x>>>22),x=E+(b^(C|~v))+S[6]+2734768916&4294967295,E=C+(x<<15&4294967295|x>>>17),x=v+(C^(E|~b))+S[13]+1309151649&4294967295,v=E+(x<<21&4294967295|x>>>11),x=b+(E^(v|~C))+S[4]+4149444226&4294967295,b=v+(x<<6&4294967295|x>>>26),x=C+(v^(b|~E))+S[11]+3174756917&4294967295,C=b+(x<<10&4294967295|x>>>22),x=E+(b^(C|~v))+S[2]+718787259&4294967295,E=C+(x<<15&4294967295|x>>>17),x=v+(C^(E|~b))+S[9]+3951481745&4294967295,T.g[0]=T.g[0]+b&4294967295,T.g[1]=T.g[1]+(E+(x<<21&4294967295|x>>>11))&4294967295,T.g[2]=T.g[2]+E&4294967295,T.g[3]=T.g[3]+C&4294967295}n.prototype.v=function(T,b){b===void 0&&(b=T.length);const v=b-this.blockSize,S=this.C;let E=this.h,C=0;for(;C<b;){if(E==0)for(;C<=v;)o(this,T,C),C+=this.blockSize;if(typeof T=="string"){for(;C<b;)if(S[E++]=T.charCodeAt(C++),E==this.blockSize){o(this,S),E=0;break}}else for(;C<b;)if(S[E++]=T[C++],E==this.blockSize){o(this,S),E=0;break}}this.h=E,this.o+=b},n.prototype.A=function(){var T=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);T[0]=128;for(var b=1;b<T.length-8;++b)T[b]=0;b=this.o*8;for(var v=T.length-8;v<T.length;++v)T[v]=b&255,b/=256;for(this.v(T),T=Array(16),b=0,v=0;v<4;++v)for(let S=0;S<32;S+=8)T[b++]=this.g[v]>>>S&255;return T};function r(T,b){var v=l;return Object.prototype.hasOwnProperty.call(v,T)?v[T]:v[T]=b(T)}function a(T,b){this.h=b;const v=[];let S=!0;for(let E=T.length-1;E>=0;E--){const C=T[E]|0;S&&C==b||(v[E]=C,S=!1)}this.g=v}var l={};function c(T){return-128<=T&&T<128?r(T,function(b){return new a([b|0],b<0?-1:0)}):new a([T|0],T<0?-1:0)}function d(T){if(isNaN(T)||!isFinite(T))return h;if(T<0)return D(d(-T));const b=[];let v=1;for(let S=0;T>=v;S++)b[S]=T/v|0,v*=4294967296;return new a(b,0)}function p(T,b){if(T.length==0)throw Error("number format error: empty string");if(b=b||10,b<2||36<b)throw Error("radix out of range: "+b);if(T.charAt(0)=="-")return D(p(T.substring(1),b));if(T.indexOf("-")>=0)throw Error('number format error: interior "-" character');const v=d(Math.pow(b,8));let S=h;for(let C=0;C<T.length;C+=8){var E=Math.min(8,T.length-C);const x=parseInt(T.substring(C,C+E),b);E<8?(E=d(Math.pow(b,E)),S=S.j(E).add(d(x))):(S=S.j(v),S=S.add(d(x)))}return S}var h=c(0),f=c(1),y=c(16777216);t=a.prototype,t.m=function(){if(_(this))return-D(this).m();let T=0,b=1;for(let v=0;v<this.g.length;v++){const S=this.i(v);T+=(S>=0?S:4294967296+S)*b,b*=4294967296}return T},t.toString=function(T){if(T=T||10,T<2||36<T)throw Error("radix out of range: "+T);if(I(this))return"0";if(_(this))return"-"+D(this).toString(T);const b=d(Math.pow(T,6));var v=this;let S="";for(;;){const E=B(v,b).g;v=R(v,E.j(b));let C=((v.g.length>0?v.g[0]:v.h)>>>0).toString(T);if(v=E,I(v))return C+S;for(;C.length<6;)C="0"+C;S=C+S}},t.i=function(T){return T<0?0:T<this.g.length?this.g[T]:this.h};function I(T){if(T.h!=0)return!1;for(let b=0;b<T.g.length;b++)if(T.g[b]!=0)return!1;return!0}function _(T){return T.h==-1}t.l=function(T){return T=R(this,T),_(T)?-1:I(T)?0:1};function D(T){const b=T.g.length,v=[];for(let S=0;S<b;S++)v[S]=~T.g[S];return new a(v,~T.h).add(f)}t.abs=function(){return _(this)?D(this):this},t.add=function(T){const b=Math.max(this.g.length,T.g.length),v=[];let S=0;for(let E=0;E<=b;E++){let C=S+(this.i(E)&65535)+(T.i(E)&65535),x=(C>>>16)+(this.i(E)>>>16)+(T.i(E)>>>16);S=x>>>16,C&=65535,x&=65535,v[E]=x<<16|C}return new a(v,v[v.length-1]&-2147483648?-1:0)};function R(T,b){return T.add(D(b))}t.j=function(T){if(I(this)||I(T))return h;if(_(this))return _(T)?D(this).j(D(T)):D(D(this).j(T));if(_(T))return D(this.j(D(T)));if(this.l(y)<0&&T.l(y)<0)return d(this.m()*T.m());const b=this.g.length+T.g.length,v=[];for(var S=0;S<2*b;S++)v[S]=0;for(S=0;S<this.g.length;S++)for(let E=0;E<T.g.length;E++){const C=this.i(S)>>>16,x=this.i(S)&65535,ne=T.i(E)>>>16,Ne=T.i(E)&65535;v[2*S+2*E]+=x*Ne,O(v,2*S+2*E),v[2*S+2*E+1]+=C*Ne,O(v,2*S+2*E+1),v[2*S+2*E+1]+=x*ne,O(v,2*S+2*E+1),v[2*S+2*E+2]+=C*ne,O(v,2*S+2*E+2)}for(T=0;T<b;T++)v[T]=v[2*T+1]<<16|v[2*T];for(T=b;T<2*b;T++)v[T]=0;return new a(v,0)};function O(T,b){for(;(T[b]&65535)!=T[b];)T[b+1]+=T[b]>>>16,T[b]&=65535,b++}function N(T,b){this.g=T,this.h=b}function B(T,b){if(I(b))throw Error("division by zero");if(I(T))return new N(h,h);if(_(T))return b=B(D(T),b),new N(D(b.g),D(b.h));if(_(b))return b=B(T,D(b)),new N(D(b.g),b.h);if(T.g.length>30){if(_(T)||_(b))throw Error("slowDivide_ only works with positive integers.");for(var v=f,S=b;S.l(T)<=0;)v=H(v),S=H(S);var E=G(v,1),C=G(S,1);for(S=G(S,2),v=G(v,2);!I(S);){var x=C.add(S);x.l(T)<=0&&(E=E.add(v),C=x),S=G(S,1),v=G(v,1)}return b=R(T,E.j(b)),new N(E,b)}for(E=h;T.l(b)>=0;){for(v=Math.max(1,Math.floor(T.m()/b.m())),S=Math.ceil(Math.log(v)/Math.LN2),S=S<=48?1:Math.pow(2,S-48),C=d(v),x=C.j(b);_(x)||x.l(T)>0;)v-=S,C=d(v),x=C.j(b);I(C)&&(C=f),E=E.add(C),T=R(T,x)}return new N(E,T)}t.B=function(T){return B(this,T).h},t.and=function(T){const b=Math.max(this.g.length,T.g.length),v=[];for(let S=0;S<b;S++)v[S]=this.i(S)&T.i(S);return new a(v,this.h&T.h)},t.or=function(T){const b=Math.max(this.g.length,T.g.length),v=[];for(let S=0;S<b;S++)v[S]=this.i(S)|T.i(S);return new a(v,this.h|T.h)},t.xor=function(T){const b=Math.max(this.g.length,T.g.length),v=[];for(let S=0;S<b;S++)v[S]=this.i(S)^T.i(S);return new a(v,this.h^T.h)};function H(T){const b=T.g.length+1,v=[];for(let S=0;S<b;S++)v[S]=T.i(S)<<1|T.i(S-1)>>>31;return new a(v,T.h)}function G(T,b){const v=b>>5;b%=32;const S=T.g.length-v,E=[];for(let C=0;C<S;C++)E[C]=b>0?T.i(C+v)>>>b|T.i(C+v+1)<<32-b:T.i(C+v);return new a(E,T.h)}n.prototype.digest=n.prototype.A,n.prototype.reset=n.prototype.u,n.prototype.update=n.prototype.v,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,wi=a}).apply(typeof Nc<"u"?Nc:typeof self<"u"?self:typeof window<"u"?window:{});var fo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};var $u,hn,Du,Mo,Fa,Lu,Ru,Mu;(function(){var t,e=Object.defineProperty;function s(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof fo=="object"&&fo];for(var u=0;u<i.length;++u){var m=i[u];if(m&&m.Math==Math)return m}throw Error("Cannot find global object")}var n=s(this);function o(i,u){if(u)e:{var m=n;i=i.split(".");for(var g=0;g<i.length-1;g++){var P=i[g];if(!(P in m))break e;m=m[P]}i=i[i.length-1],g=m[i],u=u(g),u!=g&&u!=null&&e(m,i,{configurable:!0,writable:!0,value:u})}}o("Symbol.dispose",function(i){return i||Symbol("Symbol.dispose")}),o("Array.prototype.values",function(i){return i||function(){return this[Symbol.iterator]()}}),o("Object.entries",function(i){return i||function(u){var m=[],g;for(g in u)Object.prototype.hasOwnProperty.call(u,g)&&m.push([g,u[g]]);return m}});var r=r||{},a=this||self;function l(i){var u=typeof i;return u=="object"&&i!=null||u=="function"}function c(i,u,m){return i.call.apply(i.bind,arguments)}function d(i,u,m){return d=c,d.apply(null,arguments)}function p(i,u){var m=Array.prototype.slice.call(arguments,1);return function(){var g=m.slice();return g.push.apply(g,arguments),i.apply(this,g)}}function h(i,u){function m(){}m.prototype=u.prototype,i.Z=u.prototype,i.prototype=new m,i.prototype.constructor=i,i.Ob=function(g,P,$){for(var q=Array(arguments.length-2),Q=2;Q<arguments.length;Q++)q[Q-2]=arguments[Q];return u.prototype[P].apply(g,q)}}var f=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?i=>i&&AsyncContext.Snapshot.wrap(i):i=>i;function y(i){const u=i.length;if(u>0){const m=Array(u);for(let g=0;g<u;g++)m[g]=i[g];return m}return[]}function I(i,u){for(let g=1;g<arguments.length;g++){const P=arguments[g];var m=typeof P;if(m=m!="object"?m:P?Array.isArray(P)?"array":m:"null",m=="array"||m=="object"&&typeof P.length=="number"){m=i.length||0;const $=P.length||0;i.length=m+$;for(let q=0;q<$;q++)i[m+q]=P[q]}else i.push(P)}}class _{constructor(u,m){this.i=u,this.j=m,this.h=0,this.g=null}get(){let u;return this.h>0?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function D(i){a.setTimeout(()=>{throw i},0)}function R(){var i=T;let u=null;return i.g&&(u=i.g,i.g=i.g.next,i.g||(i.h=null),u.next=null),u}class O{constructor(){this.h=this.g=null}add(u,m){const g=N.get();g.set(u,m),this.h?this.h.next=g:this.g=g,this.h=g}}var N=new _(()=>new B,i=>i.reset());class B{constructor(){this.next=this.g=this.h=null}set(u,m){this.h=u,this.g=m,this.next=null}reset(){this.next=this.g=this.h=null}}let H,G=!1,T=new O,b=()=>{const i=Promise.resolve(void 0);H=()=>{i.then(v)}};function v(){for(var i;i=R();){try{i.h.call(i.g)}catch(m){D(m)}var u=N;u.j(i),u.h<100&&(u.h++,i.next=u.g,u.g=i)}G=!1}function S(){this.u=this.u,this.C=this.C}S.prototype.u=!1,S.prototype.dispose=function(){this.u||(this.u=!0,this.N())},S.prototype[Symbol.dispose]=function(){this.dispose()},S.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function E(i,u){this.type=i,this.g=this.target=u,this.defaultPrevented=!1}E.prototype.h=function(){this.defaultPrevented=!0};var C=(function(){if(!a.addEventListener||!Object.defineProperty)return!1;var i=!1,u=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const m=()=>{};a.addEventListener("test",m,u),a.removeEventListener("test",m,u)}catch{}return i})();function x(i){return/^[\s\xa0]*$/.test(i)}function ne(i,u){E.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i&&this.init(i,u)}h(ne,E),ne.prototype.init=function(i,u){const m=this.type=i.type,g=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;this.target=i.target||i.srcElement,this.g=u,u=i.relatedTarget,u||(m=="mouseover"?u=i.fromElement:m=="mouseout"&&(u=i.toElement)),this.relatedTarget=u,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=i.pointerType,this.state=i.state,this.i=i,i.defaultPrevented&&ne.Z.h.call(this)},ne.prototype.h=function(){ne.Z.h.call(this);const i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var Ne="closure_listenable_"+(Math.random()*1e6|0),Ws=0;function Br(i,u,m,g,P){this.listener=i,this.proxy=null,this.src=u,this.type=m,this.capture=!!g,this.ha=P,this.key=++Ws,this.da=this.fa=!1}function Ze(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function et(i,u,m){for(const g in i)u.call(m,i[g],g,i)}function qp(i,u){for(const m in i)u.call(void 0,i[m],m,i)}function pl(i){const u={};for(const m in i)u[m]=i[m];return u}const hl="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function gl(i,u){let m,g;for(let P=1;P<arguments.length;P++){g=arguments[P];for(m in g)i[m]=g[m];for(let $=0;$<hl.length;$++)m=hl[$],Object.prototype.hasOwnProperty.call(g,m)&&(i[m]=g[m])}}function to(i){this.src=i,this.g={},this.h=0}to.prototype.add=function(i,u,m,g,P){const $=i.toString();i=this.g[$],i||(i=this.g[$]=[],this.h++);const q=Fr(i,u,g,P);return q>-1?(u=i[q],m||(u.fa=!1)):(u=new Br(u,this.src,$,!!g,P),u.fa=m,i.push(u)),u};function Vr(i,u){const m=u.type;if(m in i.g){var g=i.g[m],P=Array.prototype.indexOf.call(g,u,void 0),$;($=P>=0)&&Array.prototype.splice.call(g,P,1),$&&(Ze(u),i.g[m].length==0&&(delete i.g[m],i.h--))}}function Fr(i,u,m,g){for(let P=0;P<i.length;++P){const $=i[P];if(!$.da&&$.listener==u&&$.capture==!!m&&$.ha==g)return P}return-1}var Or="closure_lm_"+(Math.random()*1e6|0),qr={};function fl(i,u,m,g,P){if(Array.isArray(u)){for(let $=0;$<u.length;$++)fl(i,u[$],m,g,P);return null}return m=yl(m),i&&i[Ne]?i.J(u,m,l(g)?!!g.capture:!1,P):jp(i,u,m,!1,g,P)}function jp(i,u,m,g,P,$){if(!u)throw Error("Invalid event type");const q=l(P)?!!P.capture:!!P;let Q=Hr(i);if(Q||(i[Or]=Q=new to(i)),m=Q.add(u,m,g,q,$),m.proxy)return m;if(g=Hp(),m.proxy=g,g.src=i,g.listener=m,i.addEventListener)C||(P=q),P===void 0&&(P=!1),i.addEventListener(u.toString(),g,P);else if(i.attachEvent)i.attachEvent(vl(u.toString()),g);else if(i.addListener&&i.removeListener)i.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return m}function Hp(){function i(m){return u.call(i.src,i.listener,m)}const u=Up;return i}function bl(i,u,m,g,P){if(Array.isArray(u))for(var $=0;$<u.length;$++)bl(i,u[$],m,g,P);else g=l(g)?!!g.capture:!!g,m=yl(m),i&&i[Ne]?(i=i.i,$=String(u).toString(),$ in i.g&&(u=i.g[$],m=Fr(u,m,g,P),m>-1&&(Ze(u[m]),Array.prototype.splice.call(u,m,1),u.length==0&&(delete i.g[$],i.h--)))):i&&(i=Hr(i))&&(u=i.g[u.toString()],i=-1,u&&(i=Fr(u,m,g,P)),(m=i>-1?u[i]:null)&&jr(m))}function jr(i){if(typeof i!="number"&&i&&!i.da){var u=i.src;if(u&&u[Ne])Vr(u.i,i);else{var m=i.type,g=i.proxy;u.removeEventListener?u.removeEventListener(m,g,i.capture):u.detachEvent?u.detachEvent(vl(m),g):u.addListener&&u.removeListener&&u.removeListener(g),(m=Hr(u))?(Vr(m,i),m.h==0&&(m.src=null,u[Or]=null)):Ze(i)}}}function vl(i){return i in qr?qr[i]:qr[i]="on"+i}function Up(i,u){if(i.da)i=!0;else{u=new ne(u,this);const m=i.listener,g=i.ha||i.src;i.fa&&jr(i),i=m.call(g,u)}return i}function Hr(i){return i=i[Or],i instanceof to?i:null}var Ur="__closure_events_fn_"+(Math.random()*1e9>>>0);function yl(i){return typeof i=="function"?i:(i[Ur]||(i[Ur]=function(u){return i.handleEvent(u)}),i[Ur])}function Te(){S.call(this),this.i=new to(this),this.M=this,this.G=null}h(Te,S),Te.prototype[Ne]=!0,Te.prototype.removeEventListener=function(i,u,m,g){bl(this,i,u,m,g)};function $e(i,u){var m,g=i.G;if(g)for(m=[];g;g=g.G)m.push(g);if(i=i.M,g=u.type||u,typeof u=="string")u=new E(u,i);else if(u instanceof E)u.target=u.target||i;else{var P=u;u=new E(g,i),gl(u,P)}P=!0;let $,q;if(m)for(q=m.length-1;q>=0;q--)$=u.g=m[q],P=so($,g,!0,u)&&P;if($=u.g=i,P=so($,g,!0,u)&&P,P=so($,g,!1,u)&&P,m)for(q=0;q<m.length;q++)$=u.g=m[q],P=so($,g,!1,u)&&P}Te.prototype.N=function(){if(Te.Z.N.call(this),this.i){var i=this.i;for(const u in i.g){const m=i.g[u];for(let g=0;g<m.length;g++)Ze(m[g]);delete i.g[u],i.h--}}this.G=null},Te.prototype.J=function(i,u,m,g){return this.i.add(String(i),u,!1,m,g)},Te.prototype.K=function(i,u,m,g){return this.i.add(String(i),u,!0,m,g)};function so(i,u,m,g){if(u=i.i.g[String(u)],!u)return!0;u=u.concat();let P=!0;for(let $=0;$<u.length;++$){const q=u[$];if(q&&!q.da&&q.capture==m){const Q=q.listener,fe=q.ha||q.src;q.fa&&Vr(i.i,q),P=Q.call(fe,g)!==!1&&P}}return P&&!g.defaultPrevented}function zp(i,u){if(typeof i!="function")if(i&&typeof i.handleEvent=="function")i=d(i.handleEvent,i);else throw Error("Invalid listener argument");return Number(u)>2147483647?-1:a.setTimeout(i,u||0)}function xl(i){i.g=zp(()=>{i.g=null,i.i&&(i.i=!1,xl(i))},i.l);const u=i.h;i.h=null,i.m.apply(null,u)}class Wp extends S{constructor(u,m){super(),this.m=u,this.l=m,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:xl(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Gs(i){S.call(this),this.h=i,this.g={}}h(Gs,S);var wl=[];function El(i){et(i.g,function(u,m){this.g.hasOwnProperty(m)&&jr(u)},i),i.g={}}Gs.prototype.N=function(){Gs.Z.N.call(this),El(this)},Gs.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var zr=a.JSON.stringify,Gp=a.JSON.parse,Kp=class{stringify(i){return a.JSON.stringify(i,void 0)}parse(i){return a.JSON.parse(i,void 0)}};function Il(){}function Sl(){}var Ks={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Wr(){E.call(this,"d")}h(Wr,E);function Gr(){E.call(this,"c")}h(Gr,E);var Ot={},Tl=null;function no(){return Tl=Tl||new Te}Ot.Ia="serverreachability";function kl(i){E.call(this,Ot.Ia,i)}h(kl,E);function Js(i){const u=no();$e(u,new kl(u))}Ot.STAT_EVENT="statevent";function Cl(i,u){E.call(this,Ot.STAT_EVENT,i),this.stat=u}h(Cl,E);function De(i){const u=no();$e(u,new Cl(u,i))}Ot.Ja="timingevent";function _l(i,u){E.call(this,Ot.Ja,i),this.size=u}h(_l,E);function Qs(i,u){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){i()},u)}function Xs(){this.g=!0}Xs.prototype.ua=function(){this.g=!1};function Jp(i,u,m,g,P,$){i.info(function(){if(i.g)if($){var q="",Q=$.split("&");for(let oe=0;oe<Q.length;oe++){var fe=Q[oe].split("=");if(fe.length>1){const be=fe[0];fe=fe[1];const st=be.split("_");q=st.length>=2&&st[1]=="type"?q+(be+"="+fe+"&"):q+(be+"=redacted&")}}}else q=null;else q=$;return"XMLHTTP REQ ("+g+") [attempt "+P+"]: "+u+`
`+m+`
`+q})}function Qp(i,u,m,g,P,$,q){i.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+P+"]: "+u+`
`+m+`
`+$+" "+q})}function bs(i,u,m,g){i.info(function(){return"XMLHTTP TEXT ("+u+"): "+Yp(i,m)+(g?" "+g:"")})}function Xp(i,u){i.info(function(){return"TIMEOUT: "+u})}Xs.prototype.info=function(){};function Yp(i,u){if(!i.g)return u;if(!u)return null;try{const $=JSON.parse(u);if($){for(i=0;i<$.length;i++)if(Array.isArray($[i])){var m=$[i];if(!(m.length<2)){var g=m[1];if(Array.isArray(g)&&!(g.length<1)){var P=g[0];if(P!="noop"&&P!="stop"&&P!="close")for(let q=1;q<g.length;q++)g[q]=""}}}}return zr($)}catch{return u}}var oo={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Al={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Pl;function Kr(){}h(Kr,Il),Kr.prototype.g=function(){return new XMLHttpRequest},Pl=new Kr;function Ys(i){return encodeURIComponent(String(i))}function Zp(i){var u=1;i=i.split(":");const m=[];for(;u>0&&i.length;)m.push(i.shift()),u--;return i.length&&m.push(i.join(":")),m}function wt(i,u,m,g){this.j=i,this.i=u,this.l=m,this.S=g||1,this.V=new Gs(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new $l}function $l(){this.i=null,this.g="",this.h=!1}var Dl={},Jr={};function Qr(i,u,m){i.M=1,i.A=ao(tt(u)),i.u=m,i.R=!0,Ll(i,null)}function Ll(i,u){i.F=Date.now(),ro(i),i.B=tt(i.A);var m=i.B,g=i.S;Array.isArray(g)||(g=[String(g)]),Wl(m.i,"t",g),i.C=0,m=i.j.L,i.h=new $l,i.g=dc(i.j,m?u:null,!i.u),i.P>0&&(i.O=new Wp(d(i.Y,i,i.g),i.P)),u=i.V,m=i.g,g=i.ba;var P="readystatechange";Array.isArray(P)||(P&&(wl[0]=P.toString()),P=wl);for(let $=0;$<P.length;$++){const q=fl(m,P[$],g||u.handleEvent,!1,u.h||u);if(!q)break;u.g[q.key]=q}u=i.J?pl(i.J):{},i.u?(i.v||(i.v="POST"),u["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.B,i.v,i.u,u)):(i.v="GET",i.g.ea(i.B,i.v,null,u)),Js(),Jp(i.i,i.v,i.B,i.l,i.S,i.u)}wt.prototype.ba=function(i){i=i.target;const u=this.O;u&&St(i)==3?u.j():this.Y(i)},wt.prototype.Y=function(i){try{if(i==this.g)e:{const Q=St(this.g),fe=this.g.ya(),oe=this.g.ca();if(!(Q<3)&&(Q!=3||this.g&&(this.h.h||this.g.la()||Zl(this.g)))){this.K||Q!=4||fe==7||(fe==8||oe<=0?Js(3):Js(2)),Xr(this);var u=this.g.ca();this.X=u;var m=eh(this);if(this.o=u==200,Qp(this.i,this.v,this.B,this.l,this.S,Q,u),this.o){if(this.U&&!this.L){t:{if(this.g){var g,P=this.g;if((g=P.g?P.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!x(g)){var $=g;break t}}$=null}if(i=$)bs(this.i,this.l,i,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Yr(this,i);else{this.o=!1,this.m=3,De(12),qt(this),Zs(this);break e}}if(this.R){i=!0;let be;for(;!this.K&&this.C<m.length;)if(be=th(this,m),be==Jr){Q==4&&(this.m=4,De(14),i=!1),bs(this.i,this.l,null,"[Incomplete Response]");break}else if(be==Dl){this.m=4,De(15),bs(this.i,this.l,m,"[Invalid Chunk]"),i=!1;break}else bs(this.i,this.l,be,null),Yr(this,be);if(Rl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Q!=4||m.length!=0||this.h.h||(this.m=1,De(16),i=!1),this.o=this.o&&i,!i)bs(this.i,this.l,m,"[Invalid Chunked Response]"),qt(this),Zs(this);else if(m.length>0&&!this.W){this.W=!0;var q=this.j;q.g==this&&q.aa&&!q.P&&(q.j.info("Great, no buffering proxy detected. Bytes received: "+m.length),aa(q),q.P=!0,De(11))}}else bs(this.i,this.l,m,null),Yr(this,m);Q==4&&qt(this),this.o&&!this.K&&(Q==4?ac(this.j,this):(this.o=!1,ro(this)))}else gh(this.g),u==400&&m.indexOf("Unknown SID")>0?(this.m=3,De(12)):(this.m=0,De(13)),qt(this),Zs(this)}}}catch{}finally{}};function eh(i){if(!Rl(i))return i.g.la();const u=Zl(i.g);if(u==="")return"";let m="";const g=u.length,P=St(i.g)==4;if(!i.h.i){if(typeof TextDecoder>"u")return qt(i),Zs(i),"";i.h.i=new a.TextDecoder}for(let $=0;$<g;$++)i.h.h=!0,m+=i.h.i.decode(u[$],{stream:!(P&&$==g-1)});return u.length=0,i.h.g+=m,i.C=0,i.h.g}function Rl(i){return i.g?i.v=="GET"&&i.M!=2&&i.j.Aa:!1}function th(i,u){var m=i.C,g=u.indexOf(`
`,m);return g==-1?Jr:(m=Number(u.substring(m,g)),isNaN(m)?Dl:(g+=1,g+m>u.length?Jr:(u=u.slice(g,g+m),i.C=g+m,u)))}wt.prototype.cancel=function(){this.K=!0,qt(this)};function ro(i){i.T=Date.now()+i.H,Ml(i,i.H)}function Ml(i,u){if(i.D!=null)throw Error("WatchDog timer not null");i.D=Qs(d(i.aa,i),u)}function Xr(i){i.D&&(a.clearTimeout(i.D),i.D=null)}wt.prototype.aa=function(){this.D=null;const i=Date.now();i-this.T>=0?(Xp(this.i,this.B),this.M!=2&&(Js(),De(17)),qt(this),this.m=2,Zs(this)):Ml(this,this.T-i)};function Zs(i){i.j.I==0||i.K||ac(i.j,i)}function qt(i){Xr(i);var u=i.O;u&&typeof u.dispose=="function"&&u.dispose(),i.O=null,El(i.V),i.g&&(u=i.g,i.g=null,u.abort(),u.dispose())}function Yr(i,u){try{var m=i.j;if(m.I!=0&&(m.g==i||Zr(m.h,i))){if(!i.L&&Zr(m.h,i)&&m.I==3){try{var g=m.Ba.g.parse(u)}catch{g=null}if(Array.isArray(g)&&g.length==3){var P=g;if(P[0]==0){e:if(!m.v){if(m.g)if(m.g.F+3e3<i.F)mo(m),co(m);else break e;ra(m),De(18)}}else m.xa=P[1],0<m.xa-m.K&&P[2]<37500&&m.F&&m.A==0&&!m.C&&(m.C=Qs(d(m.Va,m),6e3));Vl(m.h)<=1&&m.ta&&(m.ta=void 0)}else Ht(m,11)}else if((i.L||m.g==i)&&mo(m),!x(u))for(P=m.Ba.g.parse(u),u=0;u<P.length;u++){let oe=P[u];const be=oe[0];if(!(be<=m.K))if(m.K=be,oe=oe[1],m.I==2)if(oe[0]=="c"){m.M=oe[1],m.ba=oe[2];const st=oe[3];st!=null&&(m.ka=st,m.j.info("VER="+m.ka));const Ut=oe[4];Ut!=null&&(m.za=Ut,m.j.info("SVER="+m.za));const Tt=oe[5];Tt!=null&&typeof Tt=="number"&&Tt>0&&(g=1.5*Tt,m.O=g,m.j.info("backChannelRequestTimeoutMs_="+g)),g=m;const kt=i.g;if(kt){const ho=kt.g?kt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(ho){var $=g.h;$.g||ho.indexOf("spdy")==-1&&ho.indexOf("quic")==-1&&ho.indexOf("h2")==-1||($.j=$.l,$.g=new Set,$.h&&(ea($,$.h),$.h=null))}if(g.G){const ia=kt.g?kt.g.getResponseHeader("X-HTTP-Session-Id"):null;ia&&(g.wa=ia,ie(g.J,g.G,ia))}}m.I=3,m.l&&m.l.ra(),m.aa&&(m.T=Date.now()-i.F,m.j.info("Handshake RTT: "+m.T+"ms")),g=m;var q=i;if(g.na=cc(g,g.L?g.ba:null,g.W),q.L){Fl(g.h,q);var Q=q,fe=g.O;fe&&(Q.H=fe),Q.D&&(Xr(Q),ro(Q)),g.g=q}else oc(g);m.i.length>0&&uo(m)}else oe[0]!="stop"&&oe[0]!="close"||Ht(m,7);else m.I==3&&(oe[0]=="stop"||oe[0]=="close"?oe[0]=="stop"?Ht(m,7):oa(m):oe[0]!="noop"&&m.l&&m.l.qa(oe),m.A=0)}}Js(4)}catch{}}var sh=class{constructor(i,u){this.g=i,this.map=u}};function Nl(i){this.l=i||10,a.PerformanceNavigationTiming?(i=a.performance.getEntriesByType("navigation"),i=i.length>0&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Bl(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function Vl(i){return i.h?1:i.g?i.g.size:0}function Zr(i,u){return i.h?i.h==u:i.g?i.g.has(u):!1}function ea(i,u){i.g?i.g.add(u):i.h=u}function Fl(i,u){i.h&&i.h==u?i.h=null:i.g&&i.g.has(u)&&i.g.delete(u)}Nl.prototype.cancel=function(){if(this.i=Ol(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function Ol(i){if(i.h!=null)return i.i.concat(i.h.G);if(i.g!=null&&i.g.size!==0){let u=i.i;for(const m of i.g.values())u=u.concat(m.G);return u}return y(i.i)}var ql=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function nh(i,u){if(i){i=i.split("&");for(let m=0;m<i.length;m++){const g=i[m].indexOf("=");let P,$=null;g>=0?(P=i[m].substring(0,g),$=i[m].substring(g+1)):P=i[m],u(P,$?decodeURIComponent($.replace(/\+/g," ")):"")}}}function Et(i){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let u;i instanceof Et?(this.l=i.l,en(this,i.j),this.o=i.o,this.g=i.g,tn(this,i.u),this.h=i.h,ta(this,Gl(i.i)),this.m=i.m):i&&(u=String(i).match(ql))?(this.l=!1,en(this,u[1]||"",!0),this.o=sn(u[2]||""),this.g=sn(u[3]||"",!0),tn(this,u[4]),this.h=sn(u[5]||"",!0),ta(this,u[6]||"",!0),this.m=sn(u[7]||"")):(this.l=!1,this.i=new on(null,this.l))}Et.prototype.toString=function(){const i=[];var u=this.j;u&&i.push(nn(u,jl,!0),":");var m=this.g;return(m||u=="file")&&(i.push("//"),(u=this.o)&&i.push(nn(u,jl,!0),"@"),i.push(Ys(m).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),m=this.u,m!=null&&i.push(":",String(m))),(m=this.h)&&(this.g&&m.charAt(0)!="/"&&i.push("/"),i.push(nn(m,m.charAt(0)=="/"?ah:rh,!0))),(m=this.i.toString())&&i.push("?",m),(m=this.m)&&i.push("#",nn(m,lh)),i.join("")},Et.prototype.resolve=function(i){const u=tt(this);let m=!!i.j;m?en(u,i.j):m=!!i.o,m?u.o=i.o:m=!!i.g,m?u.g=i.g:m=i.u!=null;var g=i.h;if(m)tn(u,i.u);else if(m=!!i.h){if(g.charAt(0)!="/")if(this.g&&!this.h)g="/"+g;else{var P=u.h.lastIndexOf("/");P!=-1&&(g=u.h.slice(0,P+1)+g)}if(P=g,P==".."||P==".")g="";else if(P.indexOf("./")!=-1||P.indexOf("/.")!=-1){g=P.lastIndexOf("/",0)==0,P=P.split("/");const $=[];for(let q=0;q<P.length;){const Q=P[q++];Q=="."?g&&q==P.length&&$.push(""):Q==".."?(($.length>1||$.length==1&&$[0]!="")&&$.pop(),g&&q==P.length&&$.push("")):($.push(Q),g=!0)}g=$.join("/")}else g=P}return m?u.h=g:m=i.i.toString()!=="",m?ta(u,Gl(i.i)):m=!!i.m,m&&(u.m=i.m),u};function tt(i){return new Et(i)}function en(i,u,m){i.j=m?sn(u,!0):u,i.j&&(i.j=i.j.replace(/:$/,""))}function tn(i,u){if(u){if(u=Number(u),isNaN(u)||u<0)throw Error("Bad port number "+u);i.u=u}else i.u=null}function ta(i,u,m){u instanceof on?(i.i=u,ch(i.i,i.l)):(m||(u=nn(u,ih)),i.i=new on(u,i.l))}function ie(i,u,m){i.i.set(u,m)}function ao(i){return ie(i,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),i}function sn(i,u){return i?u?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function nn(i,u,m){return typeof i=="string"?(i=encodeURI(i).replace(u,oh),m&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function oh(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var jl=/[#\/\?@]/g,rh=/[#\?:]/g,ah=/[#\?]/g,ih=/[#\?@]/g,lh=/#/g;function on(i,u){this.h=this.g=null,this.i=i||null,this.j=!!u}function jt(i){i.g||(i.g=new Map,i.h=0,i.i&&nh(i.i,function(u,m){i.add(decodeURIComponent(u.replace(/\+/g," ")),m)}))}t=on.prototype,t.add=function(i,u){jt(this),this.i=null,i=vs(this,i);let m=this.g.get(i);return m||this.g.set(i,m=[]),m.push(u),this.h+=1,this};function Hl(i,u){jt(i),u=vs(i,u),i.g.has(u)&&(i.i=null,i.h-=i.g.get(u).length,i.g.delete(u))}function Ul(i,u){return jt(i),u=vs(i,u),i.g.has(u)}t.forEach=function(i,u){jt(this),this.g.forEach(function(m,g){m.forEach(function(P){i.call(u,P,g,this)},this)},this)};function zl(i,u){jt(i);let m=[];if(typeof u=="string")Ul(i,u)&&(m=m.concat(i.g.get(vs(i,u))));else for(i=Array.from(i.g.values()),u=0;u<i.length;u++)m=m.concat(i[u]);return m}t.set=function(i,u){return jt(this),this.i=null,i=vs(this,i),Ul(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[u]),this.h+=1,this},t.get=function(i,u){return i?(i=zl(this,i),i.length>0?String(i[0]):u):u};function Wl(i,u,m){Hl(i,u),m.length>0&&(i.i=null,i.g.set(vs(i,u),y(m)),i.h+=m.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],u=Array.from(this.g.keys());for(let g=0;g<u.length;g++){var m=u[g];const P=Ys(m);m=zl(this,m);for(let $=0;$<m.length;$++){let q=P;m[$]!==""&&(q+="="+Ys(m[$])),i.push(q)}}return this.i=i.join("&")};function Gl(i){const u=new on;return u.i=i.i,i.g&&(u.g=new Map(i.g),u.h=i.h),u}function vs(i,u){return u=String(u),i.j&&(u=u.toLowerCase()),u}function ch(i,u){u&&!i.j&&(jt(i),i.i=null,i.g.forEach(function(m,g){const P=g.toLowerCase();g!=P&&(Hl(this,g),Wl(this,P,m))},i)),i.j=u}function dh(i,u){const m=new Xs;if(a.Image){const g=new Image;g.onload=p(It,m,"TestLoadImage: loaded",!0,u,g),g.onerror=p(It,m,"TestLoadImage: error",!1,u,g),g.onabort=p(It,m,"TestLoadImage: abort",!1,u,g),g.ontimeout=p(It,m,"TestLoadImage: timeout",!1,u,g),a.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=i}else u(!1)}function uh(i,u){const m=new Xs,g=new AbortController,P=setTimeout(()=>{g.abort(),It(m,"TestPingServer: timeout",!1,u)},1e4);fetch(i,{signal:g.signal}).then($=>{clearTimeout(P),$.ok?It(m,"TestPingServer: ok",!0,u):It(m,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(P),It(m,"TestPingServer: error",!1,u)})}function It(i,u,m,g,P){try{P&&(P.onload=null,P.onerror=null,P.onabort=null,P.ontimeout=null),g(m)}catch{}}function mh(){this.g=new Kp}function sa(i){this.i=i.Sb||null,this.h=i.ab||!1}h(sa,Il),sa.prototype.g=function(){return new io(this.i,this.h)};function io(i,u){Te.call(this),this.H=i,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}h(io,Te),t=io.prototype,t.open=function(i,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=i,this.D=u,this.readyState=1,an(this)},t.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const u={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};i&&(u.body=i),(this.H||a).fetch(new Request(this.D,u)).then(this.Pa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,rn(this)),this.readyState=0},t.Pa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,an(this)),this.g&&(this.readyState=3,an(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Kl(this)}else i.text().then(this.Oa.bind(this),this.ga.bind(this))};function Kl(i){i.j.read().then(i.Ma.bind(i)).catch(i.ga.bind(i))}t.Ma=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var u=i.value?i.value:new Uint8Array(0);(u=this.B.decode(u,{stream:!i.done}))&&(this.response=this.responseText+=u)}i.done?rn(this):an(this),this.readyState==3&&Kl(this)}},t.Oa=function(i){this.g&&(this.response=this.responseText=i,rn(this))},t.Na=function(i){this.g&&(this.response=i,rn(this))},t.ga=function(){this.g&&rn(this)};function rn(i){i.readyState=4,i.l=null,i.j=null,i.B=null,an(i)}t.setRequestHeader=function(i,u){this.A.append(i,u)},t.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],u=this.h.entries();for(var m=u.next();!m.done;)m=m.value,i.push(m[0]+": "+m[1]),m=u.next();return i.join(`\r
`)};function an(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(io.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function Jl(i){let u="";return et(i,function(m,g){u+=g,u+=":",u+=m,u+=`\r
`}),u}function na(i,u,m){e:{for(g in m){var g=!1;break e}g=!0}g||(m=Jl(m),typeof i=="string"?m!=null&&Ys(m):ie(i,u,m))}function ue(i){Te.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}h(ue,Te);var ph=/^https?$/i,hh=["POST","PUT"];t=ue.prototype,t.Fa=function(i){this.H=i},t.ea=function(i,u,m,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);u=u?u.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Pl.g(),this.g.onreadystatechange=f(d(this.Ca,this));try{this.B=!0,this.g.open(u,String(i),!0),this.B=!1}catch($){Ql(this,$);return}if(i=m||"",m=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var P in g)m.set(P,g[P]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const $ of g.keys())m.set($,g.get($));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(m.keys()).find($=>$.toLowerCase()=="content-type"),P=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(hh,u,void 0)>=0)||g||P||m.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[$,q]of m)this.g.setRequestHeader($,q);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch($){Ql(this,$)}};function Ql(i,u){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=u,i.o=5,Xl(i),lo(i)}function Xl(i){i.A||(i.A=!0,$e(i,"complete"),$e(i,"error"))}t.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,$e(this,"complete"),$e(this,"abort"),lo(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),lo(this,!0)),ue.Z.N.call(this)},t.Ca=function(){this.u||(this.B||this.v||this.j?Yl(this):this.Xa())},t.Xa=function(){Yl(this)};function Yl(i){if(i.h&&typeof r<"u"){if(i.v&&St(i)==4)setTimeout(i.Ca.bind(i),0);else if($e(i,"readystatechange"),St(i)==4){i.h=!1;try{const $=i.ca();e:switch($){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var m;if(!(m=u)){var g;if(g=$===0){let q=String(i.D).match(ql)[1]||null;!q&&a.self&&a.self.location&&(q=a.self.location.protocol.slice(0,-1)),g=!ph.test(q?q.toLowerCase():"")}m=g}if(m)$e(i,"complete"),$e(i,"success");else{i.o=6;try{var P=St(i)>2?i.g.statusText:""}catch{P=""}i.l=P+" ["+i.ca()+"]",Xl(i)}}finally{lo(i)}}}}function lo(i,u){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const m=i.g;i.g=null,u||$e(i,"ready");try{m.onreadystatechange=null}catch{}}}t.isActive=function(){return!!this.g};function St(i){return i.g?i.g.readyState:0}t.ca=function(){try{return St(this)>2?this.g.status:-1}catch{return-1}},t.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.La=function(i){if(this.g){var u=this.g.responseText;return i&&u.indexOf(i)==0&&(u=u.substring(i.length)),Gp(u)}};function Zl(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function gh(i){const u={};i=(i.g&&St(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<i.length;g++){if(x(i[g]))continue;var m=Zp(i[g]);const P=m[0];if(m=m[1],typeof m!="string")continue;m=m.trim();const $=u[P]||[];u[P]=$,$.push(m)}qp(u,function(g){return g.join(", ")})}t.ya=function(){return this.o},t.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function ln(i,u,m){return m&&m.internalChannelParams&&m.internalChannelParams[i]||u}function ec(i){this.za=0,this.i=[],this.j=new Xs,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=ln("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=ln("baseRetryDelayMs",5e3,i),this.Za=ln("retryDelaySeedMs",1e4,i),this.Ta=ln("forwardChannelMaxRetries",2,i),this.va=ln("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new Nl(i&&i.concurrentRequestLimit),this.Ba=new mh,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}t=ec.prototype,t.ka=8,t.I=1,t.connect=function(i,u,m,g){De(0),this.W=i,this.H=u||{},m&&g!==void 0&&(this.H.OSID=m,this.H.OAID=g),this.F=this.X,this.J=cc(this,null,this.W),uo(this)};function oa(i){if(tc(i),i.I==3){var u=i.V++,m=tt(i.J);if(ie(m,"SID",i.M),ie(m,"RID",u),ie(m,"TYPE","terminate"),cn(i,m),u=new wt(i,i.j,u),u.M=2,u.A=ao(tt(m)),m=!1,a.navigator&&a.navigator.sendBeacon)try{m=a.navigator.sendBeacon(u.A.toString(),"")}catch{}!m&&a.Image&&(new Image().src=u.A,m=!0),m||(u.g=dc(u.j,null),u.g.ea(u.A)),u.F=Date.now(),ro(u)}lc(i)}function co(i){i.g&&(aa(i),i.g.cancel(),i.g=null)}function tc(i){co(i),i.v&&(a.clearTimeout(i.v),i.v=null),mo(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function uo(i){if(!Bl(i.h)&&!i.m){i.m=!0;var u=i.Ea;H||b(),G||(H(),G=!0),T.add(u,i),i.D=0}}function fh(i,u){return Vl(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=u.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=Qs(d(i.Ea,i,u),ic(i,i.D)),i.D++,!0)}t.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const P=new wt(this,this.j,i);let $=this.o;if(this.U&&($?($=pl($),gl($,this.U)):$=this.U),this.u!==null||this.R||(P.J=$,$=null),this.S)e:{for(var u=0,m=0;m<this.i.length;m++){t:{var g=this.i[m];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(u+=g,u>4096){u=m;break e}if(u===4096||m===this.i.length-1){u=m+1;break e}}u=1e3}else u=1e3;u=nc(this,P,u),m=tt(this.J),ie(m,"RID",i),ie(m,"CVER",22),this.G&&ie(m,"X-HTTP-Session-Id",this.G),cn(this,m),$&&(this.R?u="headers="+Ys(Jl($))+"&"+u:this.u&&na(m,this.u,$)),ea(this.h,P),this.Ra&&ie(m,"TYPE","init"),this.S?(ie(m,"$req",u),ie(m,"SID","null"),P.U=!0,Qr(P,m,null)):Qr(P,m,u),this.I=2}}else this.I==3&&(i?sc(this,i):this.i.length==0||Bl(this.h)||sc(this))};function sc(i,u){var m;u?m=u.l:m=i.V++;const g=tt(i.J);ie(g,"SID",i.M),ie(g,"RID",m),ie(g,"AID",i.K),cn(i,g),i.u&&i.o&&na(g,i.u,i.o),m=new wt(i,i.j,m,i.D+1),i.u===null&&(m.J=i.o),u&&(i.i=u.G.concat(i.i)),u=nc(i,m,1e3),m.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),ea(i.h,m),Qr(m,g,u)}function cn(i,u){i.H&&et(i.H,function(m,g){ie(u,g,m)}),i.l&&et({},function(m,g){ie(u,g,m)})}function nc(i,u,m){m=Math.min(i.i.length,m);const g=i.l?d(i.l.Ka,i.l,i):null;e:{var P=i.i;let Q=-1;for(;;){const fe=["count="+m];Q==-1?m>0?(Q=P[0].g,fe.push("ofs="+Q)):Q=0:fe.push("ofs="+Q);let oe=!0;for(let be=0;be<m;be++){var $=P[be].g;const st=P[be].map;if($-=Q,$<0)Q=Math.max(0,P[be].g-100),oe=!1;else try{$="req"+$+"_"||"";try{var q=st instanceof Map?st:Object.entries(st);for(const[Ut,Tt]of q){let kt=Tt;l(Tt)&&(kt=zr(Tt)),fe.push($+Ut+"="+encodeURIComponent(kt))}}catch(Ut){throw fe.push($+"type="+encodeURIComponent("_badmap")),Ut}}catch{g&&g(st)}}if(oe){q=fe.join("&");break e}}q=void 0}return i=i.i.splice(0,m),u.G=i,q}function oc(i){if(!i.g&&!i.v){i.Y=1;var u=i.Da;H||b(),G||(H(),G=!0),T.add(u,i),i.A=0}}function ra(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=Qs(d(i.Da,i),ic(i,i.A)),i.A++,!0)}t.Da=function(){if(this.v=null,rc(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=Qs(d(this.Wa,this),i)}},t.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,De(10),co(this),rc(this))};function aa(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function rc(i){i.g=new wt(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var u=tt(i.na);ie(u,"RID","rpc"),ie(u,"SID",i.M),ie(u,"AID",i.K),ie(u,"CI",i.F?"0":"1"),!i.F&&i.ia&&ie(u,"TO",i.ia),ie(u,"TYPE","xmlhttp"),cn(i,u),i.u&&i.o&&na(u,i.u,i.o),i.O&&(i.g.H=i.O);var m=i.g;i=i.ba,m.M=1,m.A=ao(tt(u)),m.u=null,m.R=!0,Ll(m,i)}t.Va=function(){this.C!=null&&(this.C=null,co(this),ra(this),De(19))};function mo(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function ac(i,u){var m=null;if(i.g==u){mo(i),aa(i),i.g=null;var g=2}else if(Zr(i.h,u))m=u.G,Fl(i.h,u),g=1;else return;if(i.I!=0){if(u.o)if(g==1){m=u.u?u.u.length:0,u=Date.now()-u.F;var P=i.D;g=no(),$e(g,new _l(g,m)),uo(i)}else oc(i);else if(P=u.m,P==3||P==0&&u.X>0||!(g==1&&fh(i,u)||g==2&&ra(i)))switch(m&&m.length>0&&(u=i.h,u.i=u.i.concat(m)),P){case 1:Ht(i,5);break;case 4:Ht(i,10);break;case 3:Ht(i,6);break;default:Ht(i,2)}}}function ic(i,u){let m=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(m*=2),m*u}function Ht(i,u){if(i.j.info("Error code "+u),u==2){var m=d(i.bb,i),g=i.Ua;const P=!g;g=new Et(g||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||en(g,"https"),ao(g),P?dh(g.toString(),m):uh(g.toString(),m)}else De(2);i.I=0,i.l&&i.l.pa(u),lc(i),tc(i)}t.bb=function(i){i?(this.j.info("Successfully pinged google.com"),De(2)):(this.j.info("Failed to ping google.com"),De(1))};function lc(i){if(i.I=0,i.ja=[],i.l){const u=Ol(i.h);(u.length!=0||i.i.length!=0)&&(I(i.ja,u),I(i.ja,i.i),i.h.i.length=0,y(i.i),i.i.length=0),i.l.oa()}}function cc(i,u,m){var g=m instanceof Et?tt(m):new Et(m);if(g.g!="")u&&(g.g=u+"."+g.g),tn(g,g.u);else{var P=a.location;g=P.protocol,u=u?u+"."+P.hostname:P.hostname,P=+P.port;const $=new Et(null);g&&en($,g),u&&($.g=u),P&&tn($,P),m&&($.h=m),g=$}return m=i.G,u=i.wa,m&&u&&ie(g,m,u),ie(g,"VER",i.ka),cn(i,g),g}function dc(i,u,m){if(u&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return u=i.Aa&&!i.ma?new ue(new sa({ab:m})):new ue(i.ma),u.Fa(i.L),u}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function uc(){}t=uc.prototype,t.ra=function(){},t.qa=function(){},t.pa=function(){},t.oa=function(){},t.isActive=function(){return!0},t.Ka=function(){};function po(){}po.prototype.g=function(i,u){return new He(i,u)};function He(i,u){Te.call(this),this.g=new ec(u),this.l=i,this.h=u&&u.messageUrlParams||null,i=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(i?i["X-WebChannel-Content-Type"]=u.messageContentType:i={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.sa&&(i?i["X-WebChannel-Client-Profile"]=u.sa:i={"X-WebChannel-Client-Profile":u.sa}),this.g.U=i,(i=u&&u.Qb)&&!x(i)&&(this.g.u=i),this.A=u&&u.supportsCrossDomainXhr||!1,this.v=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!x(u)&&(this.g.G=u,i=this.h,i!==null&&u in i&&(i=this.h,u in i&&delete i[u])),this.j=new ys(this)}h(He,Te),He.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},He.prototype.close=function(){oa(this.g)},He.prototype.o=function(i){var u=this.g;if(typeof i=="string"){var m={};m.__data__=i,i=m}else this.v&&(m={},m.__data__=zr(i),i=m);u.i.push(new sh(u.Ya++,i)),u.I==3&&uo(u)},He.prototype.N=function(){this.g.l=null,delete this.j,oa(this.g),delete this.g,He.Z.N.call(this)};function mc(i){Wr.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var u=i.__sm__;if(u){e:{for(const m in u){i=m;break e}i=void 0}(this.i=i)&&(i=this.i,u=u!==null&&i in u?u[i]:void 0),this.data=u}else this.data=i}h(mc,Wr);function pc(){Gr.call(this),this.status=1}h(pc,Gr);function ys(i){this.g=i}h(ys,uc),ys.prototype.ra=function(){$e(this.g,"a")},ys.prototype.qa=function(i){$e(this.g,new mc(i))},ys.prototype.pa=function(i){$e(this.g,new pc)},ys.prototype.oa=function(){$e(this.g,"b")},po.prototype.createWebChannel=po.prototype.g,He.prototype.send=He.prototype.o,He.prototype.open=He.prototype.m,He.prototype.close=He.prototype.close,Mu=function(){return new po},Ru=function(){return no()},Lu=Ot,Fa={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},oo.NO_ERROR=0,oo.TIMEOUT=8,oo.HTTP_ERROR=6,Mo=oo,Al.COMPLETE="complete",Du=Al,Sl.EventType=Ks,Ks.OPEN="a",Ks.CLOSE="b",Ks.ERROR="c",Ks.MESSAGE="d",Te.prototype.listen=Te.prototype.J,hn=Sl,ue.prototype.listenOnce=ue.prototype.K,ue.prototype.getLastError=ue.prototype.Ha,ue.prototype.getLastErrorCode=ue.prototype.ya,ue.prototype.getStatus=ue.prototype.ca,ue.prototype.getResponseJson=ue.prototype.La,ue.prototype.getResponseText=ue.prototype.la,ue.prototype.send=ue.prototype.ea,ue.prototype.setWithCredentials=ue.prototype.Fa,$u=ue}).apply(typeof fo<"u"?fo:typeof self<"u"?self:typeof window<"u"?window:{});const Bc="@firebase/firestore",Vc="4.9.2";class Ve{constructor(e){this.uid=e}isAuthenticated(){return this.uid!=null}toKey(){return this.isAuthenticated()?"uid:"+this.uid:"anonymous-user"}isEqual(e){return e.uid===this.uid}}Ve.UNAUTHENTICATED=new Ve(null),Ve.GOOGLE_CREDENTIALS=new Ve("google-credentials-uid"),Ve.FIRST_PARTY=new Ve("first-party-uid"),Ve.MOCK_USER=new Ve("mock-user");let Hs="12.3.0";const as=new Tu("@firebase/firestore");function Es(){return as.logLevel}function U(t,...e){if(as.logLevel<=ee.DEBUG){const s=e.map(Ii);as.debug(`Firestore (${Hs}): ${t}`,...s)}}function is(t,...e){if(as.logLevel<=ee.ERROR){const s=e.map(Ii);as.error(`Firestore (${Hs}): ${t}`,...s)}}function Ei(t,...e){if(as.logLevel<=ee.WARN){const s=e.map(Ii);as.warn(`Firestore (${Hs}): ${t}`,...s)}}function Ii(t){if(typeof t=="string")return t;try{return(function(s){return JSON.stringify(s)})(t)}catch{return t}}function Y(t,e,s){let n="Unexpected state";typeof e=="string"?n=e:s=e,Nu(t,n,s)}function Nu(t,e,s){let n=`FIRESTORE (${Hs}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;if(s!==void 0)try{n+=" CONTEXT: "+JSON.stringify(s)}catch{n+=" CONTEXT: "+s}throw is(n),new Error(n)}function me(t,e,s,n){let o="Unexpected state";typeof s=="string"?o=s:n=s,t||Nu(e,o,n)}function ae(t,e){return t}const M={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class z extends hs{constructor(e,s){super(e,s),this.code=e,this.message=s,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}class es{constructor(){this.promise=new Promise(((e,s)=>{this.resolve=e,this.reject=s}))}}class Of{constructor(e,s){this.user=s,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class qf{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,s){e.enqueueRetryable((()=>s(Ve.UNAUTHENTICATED)))}shutdown(){}}class jf{constructor(e){this.t=e,this.currentUser=Ve.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,s){me(this.o===void 0,42304);let n=this.i;const o=c=>this.i!==n?(n=this.i,s(c)):Promise.resolve();let r=new es;this.o=()=>{this.i++,this.currentUser=this.u(),r.resolve(),r=new es,e.enqueueRetryable((()=>o(this.currentUser)))};const a=()=>{const c=r;e.enqueueRetryable((async()=>{await c.promise,await o(this.currentUser)}))},l=c=>{U("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=c,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit((c=>l(c))),setTimeout((()=>{if(!this.auth){const c=this.t.getImmediate({optional:!0});c?l(c):(U("FirebaseAuthCredentialsProvider","Auth not yet detected"),r.resolve(),r=new es)}}),0),a()}getToken(){const e=this.i,s=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(s).then((n=>this.i!==e?(U("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):n?(me(typeof n.accessToken=="string",31837,{l:n}),new Of(n.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return me(e===null||typeof e=="string",2055,{h:e}),new Ve(e)}}class Hf{constructor(e,s,n){this.P=e,this.T=s,this.I=n,this.type="FirstParty",this.user=Ve.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const e=this.R();return e&&this.A.set("Authorization",e),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class Uf{constructor(e,s,n){this.P=e,this.T=s,this.I=n}getToken(){return Promise.resolve(new Hf(this.P,this.T,this.I))}start(e,s){e.enqueueRetryable((()=>s(Ve.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Fc{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class zf{constructor(e,s){this.V=s,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Cf(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,s){me(this.o===void 0,3512);const n=r=>{r.error!=null&&U("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${r.error.message}`);const a=r.token!==this.m;return this.m=r.token,U("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?s(r.token):Promise.resolve()};this.o=r=>{e.enqueueRetryable((()=>n(r)))};const o=r=>{U("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=r,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((r=>o(r))),setTimeout((()=>{if(!this.appCheck){const r=this.V.getImmediate({optional:!0});r?o(r):U("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new Fc(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((s=>s?(me(typeof s.token=="string",44558,{tokenResult:s}),this.m=s.token,new Fc(s.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}function Wf(t){const e=typeof self<"u"&&(self.crypto||self.msCrypto),s=new Uint8Array(t);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(s);else for(let n=0;n<t;n++)s[n]=Math.floor(256*Math.random());return s}class Si{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",s=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const o=Wf(40);for(let r=0;r<o.length;++r)n.length<20&&o[r]<s&&(n+=e.charAt(o[r]%62))}return n}}function se(t,e){return t<e?-1:t>e?1:0}function Oa(t,e){const s=Math.min(t.length,e.length);for(let n=0;n<s;n++){const o=t.charAt(n),r=e.charAt(n);if(o!==r)return ha(o)===ha(r)?se(o,r):ha(o)?1:-1}return se(t.length,e.length)}const Gf=55296,Kf=57343;function ha(t){const e=t.charCodeAt(0);return e>=Gf&&e<=Kf}function Rs(t,e,s){return t.length===e.length&&t.every(((n,o)=>s(n,e[o])))}const Oc="__name__";class ot{constructor(e,s,n){s===void 0?s=0:s>e.length&&Y(637,{offset:s,range:e.length}),n===void 0?n=e.length-s:n>e.length-s&&Y(1746,{length:n,range:e.length-s}),this.segments=e,this.offset=s,this.len=n}get length(){return this.len}isEqual(e){return ot.comparator(this,e)===0}child(e){const s=this.segments.slice(this.offset,this.limit());return e instanceof ot?e.forEach((n=>{s.push(n)})):s.push(e),this.construct(s)}limit(){return this.offset+this.length}popFirst(e){return e=e===void 0?1:e,this.construct(this.segments,this.offset+e,this.length-e)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(e){return this.segments[this.offset+e]}isEmpty(){return this.length===0}isPrefixOf(e){if(e.length<this.length)return!1;for(let s=0;s<this.length;s++)if(this.get(s)!==e.get(s))return!1;return!0}isImmediateParentOf(e){if(this.length+1!==e.length)return!1;for(let s=0;s<this.length;s++)if(this.get(s)!==e.get(s))return!1;return!0}forEach(e){for(let s=this.offset,n=this.limit();s<n;s++)e(this.segments[s])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(e,s){const n=Math.min(e.length,s.length);for(let o=0;o<n;o++){const r=ot.compareSegments(e.get(o),s.get(o));if(r!==0)return r}return se(e.length,s.length)}static compareSegments(e,s){const n=ot.isNumericId(e),o=ot.isNumericId(s);return n&&!o?-1:!n&&o?1:n&&o?ot.extractNumericId(e).compare(ot.extractNumericId(s)):Oa(e,s)}static isNumericId(e){return e.startsWith("__id")&&e.endsWith("__")}static extractNumericId(e){return wi.fromString(e.substring(4,e.length-2))}}class pe extends ot{construct(e,s,n){return new pe(e,s,n)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...e){const s=[];for(const n of e){if(n.indexOf("//")>=0)throw new z(M.INVALID_ARGUMENT,`Invalid segment (${n}). Paths must not contain // in them.`);s.push(...n.split("/").filter((o=>o.length>0)))}return new pe(s)}static emptyPath(){return new pe([])}}const Jf=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Ee extends ot{construct(e,s,n){return new Ee(e,s,n)}static isValidIdentifier(e){return Jf.test(e)}canonicalString(){return this.toArray().map((e=>(e=e.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Ee.isValidIdentifier(e)||(e="`"+e+"`"),e))).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===Oc}static keyField(){return new Ee([Oc])}static fromServerFormat(e){const s=[];let n="",o=0;const r=()=>{if(n.length===0)throw new z(M.INVALID_ARGUMENT,`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);s.push(n),n=""};let a=!1;for(;o<e.length;){const l=e[o];if(l==="\\"){if(o+1===e.length)throw new z(M.INVALID_ARGUMENT,"Path has trailing escape character: "+e);const c=e[o+1];if(c!=="\\"&&c!=="."&&c!=="`")throw new z(M.INVALID_ARGUMENT,"Path has invalid escape sequence: "+e);n+=c,o+=2}else l==="`"?(a=!a,o++):l!=="."||a?(n+=l,o++):(r(),o++)}if(r(),a)throw new z(M.INVALID_ARGUMENT,"Unterminated ` in path: "+e);return new Ee(s)}static emptyPath(){return new Ee([])}}class X{constructor(e){this.path=e}static fromPath(e){return new X(pe.fromString(e))}static fromName(e){return new X(pe.fromString(e).popFirst(5))}static empty(){return new X(pe.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return e!==null&&pe.comparator(this.path,e.path)===0}toString(){return this.path.toString()}static comparator(e,s){return pe.comparator(e.path,s.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new X(new pe(e.slice()))}}function Qf(t,e,s){if(!s)throw new z(M.INVALID_ARGUMENT,`Function ${t}() cannot be called with an empty ${e}.`)}function Xf(t,e,s,n){if(e===!0&&n===!0)throw new z(M.INVALID_ARGUMENT,`${t} and ${s} cannot be used together.`)}function qc(t){if(!X.isDocumentKey(t))throw new z(M.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`)}function Bu(t){return typeof t=="object"&&t!==null&&(Object.getPrototypeOf(t)===Object.prototype||Object.getPrototypeOf(t)===null)}function Ti(t){if(t===void 0)return"undefined";if(t===null)return"null";if(typeof t=="string")return t.length>20&&(t=`${t.substring(0,20)}...`),JSON.stringify(t);if(typeof t=="number"||typeof t=="boolean")return""+t;if(typeof t=="object"){if(t instanceof Array)return"an array";{const e=(function(n){return n.constructor?n.constructor.name:null})(t);return e?`a custom ${e} object`:"an object"}}return typeof t=="function"?"a function":Y(12329,{type:typeof t})}function Uo(t,e){if("_delegate"in t&&(t=t._delegate),!(t instanceof e)){if(e.name===t.constructor.name)throw new z(M.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const s=Ti(t);throw new z(M.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${s}`)}}return t}function ge(t,e){const s={typeString:t};return e&&(s.value=e),s}function Un(t,e){if(!Bu(t))throw new z(M.INVALID_ARGUMENT,"JSON must be an object");let s;for(const n in e)if(e[n]){const o=e[n].typeString,r="value"in e[n]?{value:e[n].value}:void 0;if(!(n in t)){s=`JSON missing required field: '${n}'`;break}const a=t[n];if(o&&typeof a!==o){s=`JSON field '${n}' must be a ${o}.`;break}if(r!==void 0&&a!==r.value){s=`Expected '${n}' field to equal '${r.value}'`;break}}if(s)throw new z(M.INVALID_ARGUMENT,s);return!0}const jc=-62135596800,Hc=1e6;class de{static now(){return de.fromMillis(Date.now())}static fromDate(e){return de.fromMillis(e.getTime())}static fromMillis(e){const s=Math.floor(e/1e3),n=Math.floor((e-1e3*s)*Hc);return new de(s,n)}constructor(e,s){if(this.seconds=e,this.nanoseconds=s,s<0)throw new z(M.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+s);if(s>=1e9)throw new z(M.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+s);if(e<jc)throw new z(M.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new z(M.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Hc}_compareTo(e){return this.seconds===e.seconds?se(this.nanoseconds,e.nanoseconds):se(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:de._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(Un(e,de._jsonSchema))return new de(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-jc;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}de._jsonSchemaVersion="firestore/timestamp/1.0",de._jsonSchema={type:ge("string",de._jsonSchemaVersion),seconds:ge("number"),nanoseconds:ge("number")};class ce{static fromTimestamp(e){return new ce(e)}static min(){return new ce(new de(0,0))}static max(){return new ce(new de(253402300799,999999999))}constructor(e){this.timestamp=e}compareTo(e){return this.timestamp._compareTo(e.timestamp)}isEqual(e){return this.timestamp.isEqual(e.timestamp)}toMicroseconds(){return 1e6*this.timestamp.seconds+this.timestamp.nanoseconds/1e3}toString(){return"SnapshotVersion("+this.timestamp.toString()+")"}toTimestamp(){return this.timestamp}}const Mn=-1;function Yf(t,e){const s=t.toTimestamp().seconds,n=t.toTimestamp().nanoseconds+1,o=ce.fromTimestamp(n===1e9?new de(s+1,0):new de(s,n));return new Rt(o,X.empty(),e)}function Zf(t){return new Rt(t.readTime,t.key,Mn)}class Rt{constructor(e,s,n){this.readTime=e,this.documentKey=s,this.largestBatchId=n}static min(){return new Rt(ce.min(),X.empty(),Mn)}static max(){return new Rt(ce.max(),X.empty(),Mn)}}function e0(t,e){let s=t.readTime.compareTo(e.readTime);return s!==0?s:(s=X.comparator(t.documentKey,e.documentKey),s!==0?s:se(t.largestBatchId,e.largestBatchId))}const t0="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class s0{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((e=>e()))}}async function ki(t){if(t.code!==M.FAILED_PRECONDITION||t.message!==t0)throw t;U("LocalStore","Unexpectedly lost primary lease")}class L{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e((s=>{this.isDone=!0,this.result=s,this.nextCallback&&this.nextCallback(s)}),(s=>{this.isDone=!0,this.error=s,this.catchCallback&&this.catchCallback(s)}))}catch(e){return this.next(void 0,e)}next(e,s){return this.callbackAttached&&Y(59440),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(s,this.error):this.wrapSuccess(e,this.result):new L(((n,o)=>{this.nextCallback=r=>{this.wrapSuccess(e,r).next(n,o)},this.catchCallback=r=>{this.wrapFailure(s,r).next(n,o)}}))}toPromise(){return new Promise(((e,s)=>{this.next(e,s)}))}wrapUserFunction(e){try{const s=e();return s instanceof L?s:L.resolve(s)}catch(s){return L.reject(s)}}wrapSuccess(e,s){return e?this.wrapUserFunction((()=>e(s))):L.resolve(s)}wrapFailure(e,s){return e?this.wrapUserFunction((()=>e(s))):L.reject(s)}static resolve(e){return new L(((s,n)=>{s(e)}))}static reject(e){return new L(((s,n)=>{n(e)}))}static waitFor(e){return new L(((s,n)=>{let o=0,r=0,a=!1;e.forEach((l=>{++o,l.next((()=>{++r,a&&r===o&&s()}),(c=>n(c)))})),a=!0,r===o&&s()}))}static or(e){let s=L.resolve(!1);for(const n of e)s=s.next((o=>o?L.resolve(o):n()));return s}static forEach(e,s){const n=[];return e.forEach(((o,r)=>{n.push(s.call(this,o,r))})),this.waitFor(n)}static mapArray(e,s){return new L(((n,o)=>{const r=e.length,a=new Array(r);let l=0;for(let c=0;c<r;c++){const d=c;s(e[d]).next((p=>{a[d]=p,++l,l===r&&n(a)}),(p=>o(p)))}}))}static doWhile(e,s){return new L(((n,o)=>{const r=()=>{e()===!0?s().next((()=>{r()}),o):n()};r()}))}}function n0(t){const e=t.match(/Android ([\d.]+)/i),s=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(s)}function zn(t){return t.name==="IndexedDbTransactionError"}class Ci{constructor(e,s){this.previousValue=e,s&&(s.sequenceNumberHandler=n=>this.ae(n),this.ue=n=>s.writeSequenceNumber(n))}ae(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.ue&&this.ue(e),e}}Ci.ce=-1;const _i=-1;function Ai(t){return t==null}function zo(t){return t===0&&1/t==-1/0}function o0(t){return typeof t=="number"&&Number.isInteger(t)&&!zo(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}const Vu="";function r0(t){let e="";for(let s=0;s<t.length;s++)e.length>0&&(e=Uc(e)),e=a0(t.get(s),e);return Uc(e)}function a0(t,e){let s=e;const n=t.length;for(let o=0;o<n;o++){const r=t.charAt(o);switch(r){case"\0":s+="";break;case Vu:s+="";break;default:s+=r}}return s}function Uc(t){return t+Vu+""}function zc(t){let e=0;for(const s in t)Object.prototype.hasOwnProperty.call(t,s)&&e++;return e}function gs(t,e){for(const s in t)Object.prototype.hasOwnProperty.call(t,s)&&e(s,t[s])}function Fu(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}class je{constructor(e,s){this.comparator=e,this.root=s||xe.EMPTY}insert(e,s){return new je(this.comparator,this.root.insert(e,s,this.comparator).copy(null,null,xe.BLACK,null,null))}remove(e){return new je(this.comparator,this.root.remove(e,this.comparator).copy(null,null,xe.BLACK,null,null))}get(e){let s=this.root;for(;!s.isEmpty();){const n=this.comparator(e,s.key);if(n===0)return s.value;n<0?s=s.left:n>0&&(s=s.right)}return null}indexOf(e){let s=0,n=this.root;for(;!n.isEmpty();){const o=this.comparator(e,n.key);if(o===0)return s+n.left.size;o<0?n=n.left:(s+=n.left.size+1,n=n.right)}return-1}isEmpty(){return this.root.isEmpty()}get size(){return this.root.size}minKey(){return this.root.minKey()}maxKey(){return this.root.maxKey()}inorderTraversal(e){return this.root.inorderTraversal(e)}forEach(e){this.inorderTraversal(((s,n)=>(e(s,n),!1)))}toString(){const e=[];return this.inorderTraversal(((s,n)=>(e.push(`${s}:${n}`),!1))),`{${e.join(", ")}}`}reverseTraversal(e){return this.root.reverseTraversal(e)}getIterator(){return new bo(this.root,null,this.comparator,!1)}getIteratorFrom(e){return new bo(this.root,e,this.comparator,!1)}getReverseIterator(){return new bo(this.root,null,this.comparator,!0)}getReverseIteratorFrom(e){return new bo(this.root,e,this.comparator,!0)}}class bo{constructor(e,s,n,o){this.isReverse=o,this.nodeStack=[];let r=1;for(;!e.isEmpty();)if(r=s?n(e.key,s):1,s&&o&&(r*=-1),r<0)e=this.isReverse?e.left:e.right;else{if(r===0){this.nodeStack.push(e);break}this.nodeStack.push(e),e=this.isReverse?e.right:e.left}}getNext(){let e=this.nodeStack.pop();const s={key:e.key,value:e.value};if(this.isReverse)for(e=e.left;!e.isEmpty();)this.nodeStack.push(e),e=e.right;else for(e=e.right;!e.isEmpty();)this.nodeStack.push(e),e=e.left;return s}hasNext(){return this.nodeStack.length>0}peek(){if(this.nodeStack.length===0)return null;const e=this.nodeStack[this.nodeStack.length-1];return{key:e.key,value:e.value}}}class xe{constructor(e,s,n,o,r){this.key=e,this.value=s,this.color=n??xe.RED,this.left=o??xe.EMPTY,this.right=r??xe.EMPTY,this.size=this.left.size+1+this.right.size}copy(e,s,n,o,r){return new xe(e??this.key,s??this.value,n??this.color,o??this.left,r??this.right)}isEmpty(){return!1}inorderTraversal(e){return this.left.inorderTraversal(e)||e(this.key,this.value)||this.right.inorderTraversal(e)}reverseTraversal(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}min(){return this.left.isEmpty()?this:this.left.min()}minKey(){return this.min().key}maxKey(){return this.right.isEmpty()?this.key:this.right.maxKey()}insert(e,s,n){let o=this;const r=n(e,o.key);return o=r<0?o.copy(null,null,null,o.left.insert(e,s,n),null):r===0?o.copy(null,s,null,null,null):o.copy(null,null,null,null,o.right.insert(e,s,n)),o.fixUp()}removeMin(){if(this.left.isEmpty())return xe.EMPTY;let e=this;return e.left.isRed()||e.left.left.isRed()||(e=e.moveRedLeft()),e=e.copy(null,null,null,e.left.removeMin(),null),e.fixUp()}remove(e,s){let n,o=this;if(s(e,o.key)<0)o.left.isEmpty()||o.left.isRed()||o.left.left.isRed()||(o=o.moveRedLeft()),o=o.copy(null,null,null,o.left.remove(e,s),null);else{if(o.left.isRed()&&(o=o.rotateRight()),o.right.isEmpty()||o.right.isRed()||o.right.left.isRed()||(o=o.moveRedRight()),s(e,o.key)===0){if(o.right.isEmpty())return xe.EMPTY;n=o.right.min(),o=o.copy(n.key,n.value,null,null,o.right.removeMin())}o=o.copy(null,null,null,null,o.right.remove(e,s))}return o.fixUp()}isRed(){return this.color}fixUp(){let e=this;return e.right.isRed()&&!e.left.isRed()&&(e=e.rotateLeft()),e.left.isRed()&&e.left.left.isRed()&&(e=e.rotateRight()),e.left.isRed()&&e.right.isRed()&&(e=e.colorFlip()),e}moveRedLeft(){let e=this.colorFlip();return e.right.left.isRed()&&(e=e.copy(null,null,null,null,e.right.rotateRight()),e=e.rotateLeft(),e=e.colorFlip()),e}moveRedRight(){let e=this.colorFlip();return e.left.left.isRed()&&(e=e.rotateRight(),e=e.colorFlip()),e}rotateLeft(){const e=this.copy(null,null,xe.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}rotateRight(){const e=this.copy(null,null,xe.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}colorFlip(){const e=this.left.copy(null,null,!this.left.color,null,null),s=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,s)}checkMaxDepth(){const e=this.check();return Math.pow(2,e)<=this.size+1}check(){if(this.isRed()&&this.left.isRed())throw Y(43730,{key:this.key,value:this.value});if(this.right.isRed())throw Y(14113,{key:this.key,value:this.value});const e=this.left.check();if(e!==this.right.check())throw Y(27949);return e+(this.isRed()?0:1)}}xe.EMPTY=null,xe.RED=!0,xe.BLACK=!1;xe.EMPTY=new class{constructor(){this.size=0}get key(){throw Y(57766)}get value(){throw Y(16141)}get color(){throw Y(16727)}get left(){throw Y(29726)}get right(){throw Y(36894)}copy(e,s,n,o,r){return this}insert(e,s,n){return new xe(e,s)}remove(e,s){return this}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}isRed(){return!1}checkMaxDepth(){return!0}check(){return 0}};class Se{constructor(e){this.comparator=e,this.data=new je(this.comparator)}has(e){return this.data.get(e)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(e){return this.data.indexOf(e)}forEach(e){this.data.inorderTraversal(((s,n)=>(e(s),!1)))}forEachInRange(e,s){const n=this.data.getIteratorFrom(e[0]);for(;n.hasNext();){const o=n.getNext();if(this.comparator(o.key,e[1])>=0)return;s(o.key)}}forEachWhile(e,s){let n;for(n=s!==void 0?this.data.getIteratorFrom(s):this.data.getIterator();n.hasNext();)if(!e(n.getNext().key))return}firstAfterOrEqual(e){const s=this.data.getIteratorFrom(e);return s.hasNext()?s.getNext().key:null}getIterator(){return new Wc(this.data.getIterator())}getIteratorFrom(e){return new Wc(this.data.getIteratorFrom(e))}add(e){return this.copy(this.data.remove(e).insert(e,!0))}delete(e){return this.has(e)?this.copy(this.data.remove(e)):this}isEmpty(){return this.data.isEmpty()}unionWith(e){let s=this;return s.size<e.size&&(s=e,e=this),e.forEach((n=>{s=s.add(n)})),s}isEqual(e){if(!(e instanceof Se)||this.size!==e.size)return!1;const s=this.data.getIterator(),n=e.data.getIterator();for(;s.hasNext();){const o=s.getNext().key,r=n.getNext().key;if(this.comparator(o,r)!==0)return!1}return!0}toArray(){const e=[];return this.forEach((s=>{e.push(s)})),e}toString(){const e=[];return this.forEach((s=>e.push(s))),"SortedSet("+e.toString()+")"}copy(e){const s=new Se(this.comparator);return s.data=e,s}}class Wc{constructor(e){this.iter=e}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}class We{constructor(e){this.fields=e,e.sort(Ee.comparator)}static empty(){return new We([])}unionWith(e){let s=new Se(Ee.comparator);for(const n of this.fields)s=s.add(n);for(const n of e)s=s.add(n);return new We(s.toArray())}covers(e){for(const s of this.fields)if(s.isPrefixOf(e))return!0;return!1}isEqual(e){return Rs(this.fields,e.fields,((s,n)=>s.isEqual(n)))}}class i0 extends Error{constructor(){super(...arguments),this.name="Base64DecodeError"}}class at{constructor(e){this.binaryString=e}static fromBase64String(e){const s=(function(o){try{return atob(o)}catch(r){throw typeof DOMException<"u"&&r instanceof DOMException?new i0("Invalid base64 string: "+r):r}})(e);return new at(s)}static fromUint8Array(e){const s=(function(o){let r="";for(let a=0;a<o.length;++a)r+=String.fromCharCode(o[a]);return r})(e);return new at(s)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(s){return btoa(s)})(this.binaryString)}toUint8Array(){return(function(s){const n=new Uint8Array(s.length);for(let o=0;o<s.length;o++)n[o]=s.charCodeAt(o);return n})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return se(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}at.EMPTY_BYTE_STRING=new at("");const l0=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function ls(t){if(me(!!t,39018),typeof t=="string"){let e=0;const s=l0.exec(t);if(me(!!s,46558,{timestamp:t}),s[1]){let o=s[1];o=(o+"000000000").substr(0,9),e=Number(o)}const n=new Date(t);return{seconds:Math.floor(n.getTime()/1e3),nanos:e}}return{seconds:we(t.seconds),nanos:we(t.nanos)}}function we(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Ms(t){return typeof t=="string"?at.fromBase64String(t):at.fromUint8Array(t)}const Ou="server_timestamp",qu="__type__",ju="__previous_value__",Hu="__local_write_time__";function Pi(t){return(t?.mapValue?.fields||{})[qu]?.stringValue===Ou}function $i(t){const e=t.mapValue.fields[ju];return Pi(e)?$i(e):e}function Wo(t){const e=ls(t.mapValue.fields[Hu].timestampValue);return new de(e.seconds,e.nanos)}class c0{constructor(e,s,n,o,r,a,l,c,d,p){this.databaseId=e,this.appId=s,this.persistenceKey=n,this.host=o,this.ssl=r,this.forceLongPolling=a,this.autoDetectLongPolling=l,this.longPollingOptions=c,this.useFetchStreams=d,this.isUsingEmulator=p}}const qa="(default)";class Go{constructor(e,s){this.projectId=e,this.database=s||qa}static empty(){return new Go("","")}get isDefaultDatabase(){return this.database===qa}isEqual(e){return e instanceof Go&&e.projectId===this.projectId&&e.database===this.database}}const Uu="__type__",d0="__max__",vo={mapValue:{}},zu="__vector__",ja="value";function cs(t){return"nullValue"in t?0:"booleanValue"in t?1:"integerValue"in t||"doubleValue"in t?2:"timestampValue"in t?3:"stringValue"in t?5:"bytesValue"in t?6:"referenceValue"in t?7:"geoPointValue"in t?8:"arrayValue"in t?9:"mapValue"in t?Pi(t)?4:m0(t)?9007199254740991:u0(t)?10:11:Y(28295,{value:t})}function it(t,e){if(t===e)return!0;const s=cs(t);if(s!==cs(e))return!1;switch(s){case 0:case 9007199254740991:return!0;case 1:return t.booleanValue===e.booleanValue;case 4:return Wo(t).isEqual(Wo(e));case 3:return(function(o,r){if(typeof o.timestampValue=="string"&&typeof r.timestampValue=="string"&&o.timestampValue.length===r.timestampValue.length)return o.timestampValue===r.timestampValue;const a=ls(o.timestampValue),l=ls(r.timestampValue);return a.seconds===l.seconds&&a.nanos===l.nanos})(t,e);case 5:return t.stringValue===e.stringValue;case 6:return(function(o,r){return Ms(o.bytesValue).isEqual(Ms(r.bytesValue))})(t,e);case 7:return t.referenceValue===e.referenceValue;case 8:return(function(o,r){return we(o.geoPointValue.latitude)===we(r.geoPointValue.latitude)&&we(o.geoPointValue.longitude)===we(r.geoPointValue.longitude)})(t,e);case 2:return(function(o,r){if("integerValue"in o&&"integerValue"in r)return we(o.integerValue)===we(r.integerValue);if("doubleValue"in o&&"doubleValue"in r){const a=we(o.doubleValue),l=we(r.doubleValue);return a===l?zo(a)===zo(l):isNaN(a)&&isNaN(l)}return!1})(t,e);case 9:return Rs(t.arrayValue.values||[],e.arrayValue.values||[],it);case 10:case 11:return(function(o,r){const a=o.mapValue.fields||{},l=r.mapValue.fields||{};if(zc(a)!==zc(l))return!1;for(const c in a)if(a.hasOwnProperty(c)&&(l[c]===void 0||!it(a[c],l[c])))return!1;return!0})(t,e);default:return Y(52216,{left:t})}}function Nn(t,e){return(t.values||[]).find((s=>it(s,e)))!==void 0}function Ns(t,e){if(t===e)return 0;const s=cs(t),n=cs(e);if(s!==n)return se(s,n);switch(s){case 0:case 9007199254740991:return 0;case 1:return se(t.booleanValue,e.booleanValue);case 2:return(function(r,a){const l=we(r.integerValue||r.doubleValue),c=we(a.integerValue||a.doubleValue);return l<c?-1:l>c?1:l===c?0:isNaN(l)?isNaN(c)?0:-1:1})(t,e);case 3:return Gc(t.timestampValue,e.timestampValue);case 4:return Gc(Wo(t),Wo(e));case 5:return Oa(t.stringValue,e.stringValue);case 6:return(function(r,a){const l=Ms(r),c=Ms(a);return l.compareTo(c)})(t.bytesValue,e.bytesValue);case 7:return(function(r,a){const l=r.split("/"),c=a.split("/");for(let d=0;d<l.length&&d<c.length;d++){const p=se(l[d],c[d]);if(p!==0)return p}return se(l.length,c.length)})(t.referenceValue,e.referenceValue);case 8:return(function(r,a){const l=se(we(r.latitude),we(a.latitude));return l!==0?l:se(we(r.longitude),we(a.longitude))})(t.geoPointValue,e.geoPointValue);case 9:return Kc(t.arrayValue,e.arrayValue);case 10:return(function(r,a){const l=r.fields||{},c=a.fields||{},d=l[ja]?.arrayValue,p=c[ja]?.arrayValue,h=se(d?.values?.length||0,p?.values?.length||0);return h!==0?h:Kc(d,p)})(t.mapValue,e.mapValue);case 11:return(function(r,a){if(r===vo.mapValue&&a===vo.mapValue)return 0;if(r===vo.mapValue)return 1;if(a===vo.mapValue)return-1;const l=r.fields||{},c=Object.keys(l),d=a.fields||{},p=Object.keys(d);c.sort(),p.sort();for(let h=0;h<c.length&&h<p.length;++h){const f=Oa(c[h],p[h]);if(f!==0)return f;const y=Ns(l[c[h]],d[p[h]]);if(y!==0)return y}return se(c.length,p.length)})(t.mapValue,e.mapValue);default:throw Y(23264,{he:s})}}function Gc(t,e){if(typeof t=="string"&&typeof e=="string"&&t.length===e.length)return se(t,e);const s=ls(t),n=ls(e),o=se(s.seconds,n.seconds);return o!==0?o:se(s.nanos,n.nanos)}function Kc(t,e){const s=t.values||[],n=e.values||[];for(let o=0;o<s.length&&o<n.length;++o){const r=Ns(s[o],n[o]);if(r)return r}return se(s.length,n.length)}function Bs(t){return Ha(t)}function Ha(t){return"nullValue"in t?"null":"booleanValue"in t?""+t.booleanValue:"integerValue"in t?""+t.integerValue:"doubleValue"in t?""+t.doubleValue:"timestampValue"in t?(function(s){const n=ls(s);return`time(${n.seconds},${n.nanos})`})(t.timestampValue):"stringValue"in t?t.stringValue:"bytesValue"in t?(function(s){return Ms(s).toBase64()})(t.bytesValue):"referenceValue"in t?(function(s){return X.fromName(s).toString()})(t.referenceValue):"geoPointValue"in t?(function(s){return`geo(${s.latitude},${s.longitude})`})(t.geoPointValue):"arrayValue"in t?(function(s){let n="[",o=!0;for(const r of s.values||[])o?o=!1:n+=",",n+=Ha(r);return n+"]"})(t.arrayValue):"mapValue"in t?(function(s){const n=Object.keys(s.fields||{}).sort();let o="{",r=!0;for(const a of n)r?r=!1:o+=",",o+=`${a}:${Ha(s.fields[a])}`;return o+"}"})(t.mapValue):Y(61005,{value:t})}function No(t){switch(cs(t)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:const e=$i(t);return e?16+No(e):16;case 5:return 2*t.stringValue.length;case 6:return Ms(t.bytesValue).approximateByteSize();case 7:return t.referenceValue.length;case 9:return(function(n){return(n.values||[]).reduce(((o,r)=>o+No(r)),0)})(t.arrayValue);case 10:case 11:return(function(n){let o=0;return gs(n.fields,((r,a)=>{o+=r.length+No(a)})),o})(t.mapValue);default:throw Y(13486,{value:t})}}function Ua(t){return!!t&&"integerValue"in t}function Di(t){return!!t&&"arrayValue"in t}function Bo(t){return!!t&&"mapValue"in t}function u0(t){return(t?.mapValue?.fields||{})[Uu]?.stringValue===zu}function vn(t){if(t.geoPointValue)return{geoPointValue:{...t.geoPointValue}};if(t.timestampValue&&typeof t.timestampValue=="object")return{timestampValue:{...t.timestampValue}};if(t.mapValue){const e={mapValue:{fields:{}}};return gs(t.mapValue.fields,((s,n)=>e.mapValue.fields[s]=vn(n))),e}if(t.arrayValue){const e={arrayValue:{values:[]}};for(let s=0;s<(t.arrayValue.values||[]).length;++s)e.arrayValue.values[s]=vn(t.arrayValue.values[s]);return e}return{...t}}function m0(t){return(((t.mapValue||{}).fields||{}).__type__||{}).stringValue===d0}class Ue{constructor(e){this.value=e}static empty(){return new Ue({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let s=this.value;for(let n=0;n<e.length-1;++n)if(s=(s.mapValue.fields||{})[e.get(n)],!Bo(s))return null;return s=(s.mapValue.fields||{})[e.lastSegment()],s||null}}set(e,s){this.getFieldsMap(e.popLast())[e.lastSegment()]=vn(s)}setAll(e){let s=Ee.emptyPath(),n={},o=[];e.forEach(((a,l)=>{if(!s.isImmediateParentOf(l)){const c=this.getFieldsMap(s);this.applyChanges(c,n,o),n={},o=[],s=l.popLast()}a?n[l.lastSegment()]=vn(a):o.push(l.lastSegment())}));const r=this.getFieldsMap(s);this.applyChanges(r,n,o)}delete(e){const s=this.field(e.popLast());Bo(s)&&s.mapValue.fields&&delete s.mapValue.fields[e.lastSegment()]}isEqual(e){return it(this.value,e.value)}getFieldsMap(e){let s=this.value;s.mapValue.fields||(s.mapValue={fields:{}});for(let n=0;n<e.length;++n){let o=s.mapValue.fields[e.get(n)];Bo(o)&&o.mapValue.fields||(o={mapValue:{fields:{}}},s.mapValue.fields[e.get(n)]=o),s=o}return s.mapValue.fields}applyChanges(e,s,n){gs(s,((o,r)=>e[o]=r));for(const o of n)delete e[o]}clone(){return new Ue(vn(this.value))}}function Wu(t){const e=[];return gs(t.fields,((s,n)=>{const o=new Ee([s]);if(Bo(n)){const r=Wu(n.mapValue).fields;if(r.length===0)e.push(o);else for(const a of r)e.push(o.child(a))}else e.push(o)})),new We(e)}class Je{constructor(e,s,n,o,r,a,l){this.key=e,this.documentType=s,this.version=n,this.readTime=o,this.createTime=r,this.data=a,this.documentState=l}static newInvalidDocument(e){return new Je(e,0,ce.min(),ce.min(),ce.min(),Ue.empty(),0)}static newFoundDocument(e,s,n,o){return new Je(e,1,s,ce.min(),n,o,0)}static newNoDocument(e,s){return new Je(e,2,s,ce.min(),ce.min(),Ue.empty(),0)}static newUnknownDocument(e,s){return new Je(e,3,s,ce.min(),ce.min(),Ue.empty(),2)}convertToFoundDocument(e,s){return!this.createTime.isEqual(ce.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=s,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Ue.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Ue.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=ce.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Je&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Je(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}class Ko{constructor(e,s){this.position=e,this.inclusive=s}}function Jc(t,e,s){let n=0;for(let o=0;o<t.position.length;o++){const r=e[o],a=t.position[o];if(r.field.isKeyField()?n=X.comparator(X.fromName(a.referenceValue),s.key):n=Ns(a,s.data.field(r.field)),r.dir==="desc"&&(n*=-1),n!==0)break}return n}function Qc(t,e){if(t===null)return e===null;if(e===null||t.inclusive!==e.inclusive||t.position.length!==e.position.length)return!1;for(let s=0;s<t.position.length;s++)if(!it(t.position[s],e.position[s]))return!1;return!0}class Jo{constructor(e,s="asc"){this.field=e,this.dir=s}}function p0(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}class Gu{}class ye extends Gu{constructor(e,s,n){super(),this.field=e,this.op=s,this.value=n}static create(e,s,n){return e.isKeyField()?s==="in"||s==="not-in"?this.createKeyFieldInFilter(e,s,n):new g0(e,s,n):s==="array-contains"?new v0(e,n):s==="in"?new y0(e,n):s==="not-in"?new x0(e,n):s==="array-contains-any"?new w0(e,n):new ye(e,s,n)}static createKeyFieldInFilter(e,s,n){return s==="in"?new f0(e,n):new b0(e,n)}matches(e){const s=e.data.field(this.field);return this.op==="!="?s!==null&&s.nullValue===void 0&&this.matchesComparison(Ns(s,this.value)):s!==null&&cs(this.value)===cs(s)&&this.matchesComparison(Ns(s,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return Y(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Mt extends Gu{constructor(e,s){super(),this.filters=e,this.op=s,this.Pe=null}static create(e,s){return new Mt(e,s)}matches(e){return Ku(this)?this.filters.find((s=>!s.matches(e)))===void 0:this.filters.find((s=>s.matches(e)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((e,s)=>e.concat(s.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Ku(t){return t.op==="and"}function Ju(t){return h0(t)&&Ku(t)}function h0(t){for(const e of t.filters)if(e instanceof Mt)return!1;return!0}function za(t){if(t instanceof ye)return t.field.canonicalString()+t.op.toString()+Bs(t.value);if(Ju(t))return t.filters.map((e=>za(e))).join(",");{const e=t.filters.map((s=>za(s))).join(",");return`${t.op}(${e})`}}function Qu(t,e){return t instanceof ye?(function(n,o){return o instanceof ye&&n.op===o.op&&n.field.isEqual(o.field)&&it(n.value,o.value)})(t,e):t instanceof Mt?(function(n,o){return o instanceof Mt&&n.op===o.op&&n.filters.length===o.filters.length?n.filters.reduce(((r,a,l)=>r&&Qu(a,o.filters[l])),!0):!1})(t,e):void Y(19439)}function Xu(t){return t instanceof ye?(function(s){return`${s.field.canonicalString()} ${s.op} ${Bs(s.value)}`})(t):t instanceof Mt?(function(s){return s.op.toString()+" {"+s.getFilters().map(Xu).join(" ,")+"}"})(t):"Filter"}class g0 extends ye{constructor(e,s,n){super(e,s,n),this.key=X.fromName(n.referenceValue)}matches(e){const s=X.comparator(e.key,this.key);return this.matchesComparison(s)}}class f0 extends ye{constructor(e,s){super(e,"in",s),this.keys=Yu("in",s)}matches(e){return this.keys.some((s=>s.isEqual(e.key)))}}class b0 extends ye{constructor(e,s){super(e,"not-in",s),this.keys=Yu("not-in",s)}matches(e){return!this.keys.some((s=>s.isEqual(e.key)))}}function Yu(t,e){return(e.arrayValue?.values||[]).map((s=>X.fromName(s.referenceValue)))}class v0 extends ye{constructor(e,s){super(e,"array-contains",s)}matches(e){const s=e.data.field(this.field);return Di(s)&&Nn(s.arrayValue,this.value)}}class y0 extends ye{constructor(e,s){super(e,"in",s)}matches(e){const s=e.data.field(this.field);return s!==null&&Nn(this.value.arrayValue,s)}}class x0 extends ye{constructor(e,s){super(e,"not-in",s)}matches(e){if(Nn(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const s=e.data.field(this.field);return s!==null&&s.nullValue===void 0&&!Nn(this.value.arrayValue,s)}}class w0 extends ye{constructor(e,s){super(e,"array-contains-any",s)}matches(e){const s=e.data.field(this.field);return!(!Di(s)||!s.arrayValue.values)&&s.arrayValue.values.some((n=>Nn(this.value.arrayValue,n)))}}class E0{constructor(e,s=null,n=[],o=[],r=null,a=null,l=null){this.path=e,this.collectionGroup=s,this.orderBy=n,this.filters=o,this.limit=r,this.startAt=a,this.endAt=l,this.Te=null}}function Xc(t,e=null,s=[],n=[],o=null,r=null,a=null){return new E0(t,e,s,n,o,r,a)}function Li(t){const e=ae(t);if(e.Te===null){let s=e.path.canonicalString();e.collectionGroup!==null&&(s+="|cg:"+e.collectionGroup),s+="|f:",s+=e.filters.map((n=>za(n))).join(","),s+="|ob:",s+=e.orderBy.map((n=>(function(r){return r.field.canonicalString()+r.dir})(n))).join(","),Ai(e.limit)||(s+="|l:",s+=e.limit),e.startAt&&(s+="|lb:",s+=e.startAt.inclusive?"b:":"a:",s+=e.startAt.position.map((n=>Bs(n))).join(",")),e.endAt&&(s+="|ub:",s+=e.endAt.inclusive?"a:":"b:",s+=e.endAt.position.map((n=>Bs(n))).join(",")),e.Te=s}return e.Te}function Ri(t,e){if(t.limit!==e.limit||t.orderBy.length!==e.orderBy.length)return!1;for(let s=0;s<t.orderBy.length;s++)if(!p0(t.orderBy[s],e.orderBy[s]))return!1;if(t.filters.length!==e.filters.length)return!1;for(let s=0;s<t.filters.length;s++)if(!Qu(t.filters[s],e.filters[s]))return!1;return t.collectionGroup===e.collectionGroup&&!!t.path.isEqual(e.path)&&!!Qc(t.startAt,e.startAt)&&Qc(t.endAt,e.endAt)}class fr{constructor(e,s=null,n=[],o=[],r=null,a="F",l=null,c=null){this.path=e,this.collectionGroup=s,this.explicitOrderBy=n,this.filters=o,this.limit=r,this.limitType=a,this.startAt=l,this.endAt=c,this.Ie=null,this.Ee=null,this.de=null,this.startAt,this.endAt}}function I0(t,e,s,n,o,r,a,l){return new fr(t,e,s,n,o,r,a,l)}function S0(t){return new fr(t)}function Yc(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function T0(t){return t.collectionGroup!==null}function yn(t){const e=ae(t);if(e.Ie===null){e.Ie=[];const s=new Set;for(const r of e.explicitOrderBy)e.Ie.push(r),s.add(r.field.canonicalString());const n=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(a){let l=new Se(Ee.comparator);return a.filters.forEach((c=>{c.getFlattenedFilters().forEach((d=>{d.isInequality()&&(l=l.add(d.field))}))})),l})(e).forEach((r=>{s.has(r.canonicalString())||r.isKeyField()||e.Ie.push(new Jo(r,n))})),s.has(Ee.keyField().canonicalString())||e.Ie.push(new Jo(Ee.keyField(),n))}return e.Ie}function ts(t){const e=ae(t);return e.Ee||(e.Ee=k0(e,yn(t))),e.Ee}function k0(t,e){if(t.limitType==="F")return Xc(t.path,t.collectionGroup,e,t.filters,t.limit,t.startAt,t.endAt);{e=e.map((o=>{const r=o.dir==="desc"?"asc":"desc";return new Jo(o.field,r)}));const s=t.endAt?new Ko(t.endAt.position,t.endAt.inclusive):null,n=t.startAt?new Ko(t.startAt.position,t.startAt.inclusive):null;return Xc(t.path,t.collectionGroup,e,t.filters,t.limit,s,n)}}function Wa(t,e,s){return new fr(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,s,t.startAt,t.endAt)}function Zu(t,e){return Ri(ts(t),ts(e))&&t.limitType===e.limitType}function em(t){return`${Li(ts(t))}|lt:${t.limitType}`}function dn(t){return`Query(target=${(function(s){let n=s.path.canonicalString();return s.collectionGroup!==null&&(n+=" collectionGroup="+s.collectionGroup),s.filters.length>0&&(n+=`, filters: [${s.filters.map((o=>Xu(o))).join(", ")}]`),Ai(s.limit)||(n+=", limit: "+s.limit),s.orderBy.length>0&&(n+=`, orderBy: [${s.orderBy.map((o=>(function(a){return`${a.field.canonicalString()} (${a.dir})`})(o))).join(", ")}]`),s.startAt&&(n+=", startAt: ",n+=s.startAt.inclusive?"b:":"a:",n+=s.startAt.position.map((o=>Bs(o))).join(",")),s.endAt&&(n+=", endAt: ",n+=s.endAt.inclusive?"a:":"b:",n+=s.endAt.position.map((o=>Bs(o))).join(",")),`Target(${n})`})(ts(t))}; limitType=${t.limitType})`}function Mi(t,e){return e.isFoundDocument()&&(function(n,o){const r=o.key.path;return n.collectionGroup!==null?o.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(r):X.isDocumentKey(n.path)?n.path.isEqual(r):n.path.isImmediateParentOf(r)})(t,e)&&(function(n,o){for(const r of yn(n))if(!r.field.isKeyField()&&o.data.field(r.field)===null)return!1;return!0})(t,e)&&(function(n,o){for(const r of n.filters)if(!r.matches(o))return!1;return!0})(t,e)&&(function(n,o){return!(n.startAt&&!(function(a,l,c){const d=Jc(a,l,c);return a.inclusive?d<=0:d<0})(n.startAt,yn(n),o)||n.endAt&&!(function(a,l,c){const d=Jc(a,l,c);return a.inclusive?d>=0:d>0})(n.endAt,yn(n),o))})(t,e)}function C0(t){return(e,s)=>{let n=!1;for(const o of yn(t)){const r=_0(o,e,s);if(r!==0)return r;n=n||o.field.isKeyField()}return 0}}function _0(t,e,s){const n=t.field.isKeyField()?X.comparator(e.key,s.key):(function(r,a,l){const c=a.data.field(r),d=l.data.field(r);return c!==null&&d!==null?Ns(c,d):Y(42886)})(t.field,e,s);switch(t.dir){case"asc":return n;case"desc":return-1*n;default:return Y(19790,{direction:t.dir})}}class fs{constructor(e,s){this.mapKeyFn=e,this.equalsFn=s,this.inner={},this.innerSize=0}get(e){const s=this.mapKeyFn(e),n=this.inner[s];if(n!==void 0){for(const[o,r]of n)if(this.equalsFn(o,e))return r}}has(e){return this.get(e)!==void 0}set(e,s){const n=this.mapKeyFn(e),o=this.inner[n];if(o===void 0)return this.inner[n]=[[e,s]],void this.innerSize++;for(let r=0;r<o.length;r++)if(this.equalsFn(o[r][0],e))return void(o[r]=[e,s]);o.push([e,s]),this.innerSize++}delete(e){const s=this.mapKeyFn(e),n=this.inner[s];if(n===void 0)return!1;for(let o=0;o<n.length;o++)if(this.equalsFn(n[o][0],e))return n.length===1?delete this.inner[s]:n.splice(o,1),this.innerSize--,!0;return!1}forEach(e){gs(this.inner,((s,n)=>{for(const[o,r]of n)e(o,r)}))}isEmpty(){return Fu(this.inner)}size(){return this.innerSize}}const A0=new je(X.comparator);function Qo(){return A0}const tm=new je(X.comparator);function yo(...t){let e=tm;for(const s of t)e=e.insert(s.key,s);return e}function sm(t){let e=tm;return t.forEach(((s,n)=>e=e.insert(s,n.overlayedDocument))),e}function Xt(){return xn()}function nm(){return xn()}function xn(){return new fs((t=>t.toString()),((t,e)=>t.isEqual(e)))}const P0=new je(X.comparator),$0=new Se(X.comparator);function Ce(...t){let e=$0;for(const s of t)e=e.add(s);return e}const D0=new Se(se);function L0(){return D0}function Ni(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:zo(e)?"-0":e}}function om(t){return{integerValue:""+t}}function R0(t,e){return o0(e)?om(e):Ni(t,e)}class br{constructor(){this._=void 0}}function M0(t,e,s){return t instanceof Xo?(function(o,r){const a={fields:{[qu]:{stringValue:Ou},[Hu]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return r&&Pi(r)&&(r=$i(r)),r&&(a.fields[ju]=r),{mapValue:a}})(s,e):t instanceof Vs?am(t,e):t instanceof Bn?im(t,e):(function(o,r){const a=rm(o,r),l=Zc(a)+Zc(o.Ae);return Ua(a)&&Ua(o.Ae)?om(l):Ni(o.serializer,l)})(t,e)}function N0(t,e,s){return t instanceof Vs?am(t,e):t instanceof Bn?im(t,e):s}function rm(t,e){return t instanceof Yo?(function(n){return Ua(n)||(function(r){return!!r&&"doubleValue"in r})(n)})(e)?e:{integerValue:0}:null}class Xo extends br{}class Vs extends br{constructor(e){super(),this.elements=e}}function am(t,e){const s=lm(e);for(const n of t.elements)s.some((o=>it(o,n)))||s.push(n);return{arrayValue:{values:s}}}class Bn extends br{constructor(e){super(),this.elements=e}}function im(t,e){let s=lm(e);for(const n of t.elements)s=s.filter((o=>!it(o,n)));return{arrayValue:{values:s}}}class Yo extends br{constructor(e,s){super(),this.serializer=e,this.Ae=s}}function Zc(t){return we(t.integerValue||t.doubleValue)}function lm(t){return Di(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}class B0{constructor(e,s){this.field=e,this.transform=s}}function V0(t,e){return t.field.isEqual(e.field)&&(function(n,o){return n instanceof Vs&&o instanceof Vs||n instanceof Bn&&o instanceof Bn?Rs(n.elements,o.elements,it):n instanceof Yo&&o instanceof Yo?it(n.Ae,o.Ae):n instanceof Xo&&o instanceof Xo})(t.transform,e.transform)}class F0{constructor(e,s){this.version=e,this.transformResults=s}}class rt{constructor(e,s){this.updateTime=e,this.exists=s}static none(){return new rt}static exists(e){return new rt(void 0,e)}static updateTime(e){return new rt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Vo(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class vr{}function cm(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new um(t.key,rt.none()):new Wn(t.key,t.data,rt.none());{const s=t.data,n=Ue.empty();let o=new Se(Ee.comparator);for(let r of e.fields)if(!o.has(r)){let a=s.field(r);a===null&&r.length>1&&(r=r.popLast(),a=s.field(r)),a===null?n.delete(r):n.set(r,a),o=o.add(r)}return new Ft(t.key,n,new We(o.toArray()),rt.none())}}function O0(t,e,s){t instanceof Wn?(function(o,r,a){const l=o.value.clone(),c=td(o.fieldTransforms,r,a.transformResults);l.setAll(c),r.convertToFoundDocument(a.version,l).setHasCommittedMutations()})(t,e,s):t instanceof Ft?(function(o,r,a){if(!Vo(o.precondition,r))return void r.convertToUnknownDocument(a.version);const l=td(o.fieldTransforms,r,a.transformResults),c=r.data;c.setAll(dm(o)),c.setAll(l),r.convertToFoundDocument(a.version,c).setHasCommittedMutations()})(t,e,s):(function(o,r,a){r.convertToNoDocument(a.version).setHasCommittedMutations()})(0,e,s)}function wn(t,e,s,n){return t instanceof Wn?(function(r,a,l,c){if(!Vo(r.precondition,a))return l;const d=r.value.clone(),p=sd(r.fieldTransforms,c,a);return d.setAll(p),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null})(t,e,s,n):t instanceof Ft?(function(r,a,l,c){if(!Vo(r.precondition,a))return l;const d=sd(r.fieldTransforms,c,a),p=a.data;return p.setAll(dm(r)),p.setAll(d),a.convertToFoundDocument(a.version,p).setHasLocalMutations(),l===null?null:l.unionWith(r.fieldMask.fields).unionWith(r.fieldTransforms.map((h=>h.field)))})(t,e,s,n):(function(r,a,l){return Vo(r.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):l})(t,e,s)}function q0(t,e){let s=null;for(const n of t.fieldTransforms){const o=e.data.field(n.field),r=rm(n.transform,o||null);r!=null&&(s===null&&(s=Ue.empty()),s.set(n.field,r))}return s||null}function ed(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!(function(n,o){return n===void 0&&o===void 0||!(!n||!o)&&Rs(n,o,((r,a)=>V0(r,a)))})(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class Wn extends vr{constructor(e,s,n,o=[]){super(),this.key=e,this.value=s,this.precondition=n,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class Ft extends vr{constructor(e,s,n,o,r=[]){super(),this.key=e,this.data=s,this.fieldMask=n,this.precondition=o,this.fieldTransforms=r,this.type=1}getFieldMask(){return this.fieldMask}}function dm(t){const e=new Map;return t.fieldMask.fields.forEach((s=>{if(!s.isEmpty()){const n=t.data.field(s);e.set(s,n)}})),e}function td(t,e,s){const n=new Map;me(t.length===s.length,32656,{Re:s.length,Ve:t.length});for(let o=0;o<s.length;o++){const r=t[o],a=r.transform,l=e.data.field(r.field);n.set(r.field,N0(a,l,s[o]))}return n}function sd(t,e,s){const n=new Map;for(const o of t){const r=o.transform,a=s.data.field(o.field);n.set(o.field,M0(r,a,e))}return n}class um extends vr{constructor(e,s){super(),this.key=e,this.precondition=s,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class j0 extends vr{constructor(e,s){super(),this.key=e,this.precondition=s,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}class H0{constructor(e,s,n,o){this.batchId=e,this.localWriteTime=s,this.baseMutations=n,this.mutations=o}applyToRemoteDocument(e,s){const n=s.mutationResults;for(let o=0;o<this.mutations.length;o++){const r=this.mutations[o];r.key.isEqual(e.key)&&O0(r,e,n[o])}}applyToLocalView(e,s){for(const n of this.baseMutations)n.key.isEqual(e.key)&&(s=wn(n,e,s,this.localWriteTime));for(const n of this.mutations)n.key.isEqual(e.key)&&(s=wn(n,e,s,this.localWriteTime));return s}applyToLocalDocumentSet(e,s){const n=nm();return this.mutations.forEach((o=>{const r=e.get(o.key),a=r.overlayedDocument;let l=this.applyToLocalView(a,r.mutatedFields);l=s.has(o.key)?null:l;const c=cm(a,l);c!==null&&n.set(o.key,c),a.isValidDocument()||a.convertToNoDocument(ce.min())})),n}keys(){return this.mutations.reduce(((e,s)=>e.add(s.key)),Ce())}isEqual(e){return this.batchId===e.batchId&&Rs(this.mutations,e.mutations,((s,n)=>ed(s,n)))&&Rs(this.baseMutations,e.baseMutations,((s,n)=>ed(s,n)))}}class Bi{constructor(e,s,n,o){this.batch=e,this.commitVersion=s,this.mutationResults=n,this.docVersions=o}static from(e,s,n){me(e.mutations.length===n.length,58842,{me:e.mutations.length,fe:n.length});let o=(function(){return P0})();const r=e.mutations;for(let a=0;a<r.length;a++)o=o.insert(r[a].key,n[a].version);return new Bi(e,s,n,o)}}class U0{constructor(e,s){this.largestBatchId=e,this.mutation=s}getKey(){return this.mutation.key}isEqual(e){return e!==null&&this.mutation===e.mutation}toString(){return`Overlay{
      largestBatchId: ${this.largestBatchId},
      mutation: ${this.mutation.toString()}
    }`}}var he,Z;function z0(t){switch(t){case M.OK:return Y(64938);case M.CANCELLED:case M.UNKNOWN:case M.DEADLINE_EXCEEDED:case M.RESOURCE_EXHAUSTED:case M.INTERNAL:case M.UNAVAILABLE:case M.UNAUTHENTICATED:return!1;case M.INVALID_ARGUMENT:case M.NOT_FOUND:case M.ALREADY_EXISTS:case M.PERMISSION_DENIED:case M.FAILED_PRECONDITION:case M.ABORTED:case M.OUT_OF_RANGE:case M.UNIMPLEMENTED:case M.DATA_LOSS:return!0;default:return Y(15467,{code:t})}}function W0(t){if(t===void 0)return is("GRPC error has no .code"),M.UNKNOWN;switch(t){case he.OK:return M.OK;case he.CANCELLED:return M.CANCELLED;case he.UNKNOWN:return M.UNKNOWN;case he.DEADLINE_EXCEEDED:return M.DEADLINE_EXCEEDED;case he.RESOURCE_EXHAUSTED:return M.RESOURCE_EXHAUSTED;case he.INTERNAL:return M.INTERNAL;case he.UNAVAILABLE:return M.UNAVAILABLE;case he.UNAUTHENTICATED:return M.UNAUTHENTICATED;case he.INVALID_ARGUMENT:return M.INVALID_ARGUMENT;case he.NOT_FOUND:return M.NOT_FOUND;case he.ALREADY_EXISTS:return M.ALREADY_EXISTS;case he.PERMISSION_DENIED:return M.PERMISSION_DENIED;case he.FAILED_PRECONDITION:return M.FAILED_PRECONDITION;case he.ABORTED:return M.ABORTED;case he.OUT_OF_RANGE:return M.OUT_OF_RANGE;case he.UNIMPLEMENTED:return M.UNIMPLEMENTED;case he.DATA_LOSS:return M.DATA_LOSS;default:return Y(39323,{code:t})}}(Z=he||(he={}))[Z.OK=0]="OK",Z[Z.CANCELLED=1]="CANCELLED",Z[Z.UNKNOWN=2]="UNKNOWN",Z[Z.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",Z[Z.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",Z[Z.NOT_FOUND=5]="NOT_FOUND",Z[Z.ALREADY_EXISTS=6]="ALREADY_EXISTS",Z[Z.PERMISSION_DENIED=7]="PERMISSION_DENIED",Z[Z.UNAUTHENTICATED=16]="UNAUTHENTICATED",Z[Z.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",Z[Z.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",Z[Z.ABORTED=10]="ABORTED",Z[Z.OUT_OF_RANGE=11]="OUT_OF_RANGE",Z[Z.UNIMPLEMENTED=12]="UNIMPLEMENTED",Z[Z.INTERNAL=13]="INTERNAL",Z[Z.UNAVAILABLE=14]="UNAVAILABLE",Z[Z.DATA_LOSS=15]="DATA_LOSS";new wi([4294967295,4294967295],0);class G0{constructor(e,s){this.databaseId=e,this.useProto3Json=s}}function Ga(t,e){return t.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function K0(t,e){return t.useProto3Json?e.toBase64():e.toUint8Array()}function J0(t,e){return Ga(t,e.toTimestamp())}function _s(t){return me(!!t,49232),ce.fromTimestamp((function(s){const n=ls(s);return new de(n.seconds,n.nanos)})(t))}function mm(t,e){return Ka(t,e).canonicalString()}function Ka(t,e){const s=(function(o){return new pe(["projects",o.projectId,"databases",o.database])})(t).child("documents");return e===void 0?s:s.child(e)}function Q0(t){const e=pe.fromString(t);return me(ob(e),10190,{key:e.toString()}),e}function Ja(t,e){return mm(t.databaseId,e.path)}function X0(t){const e=Q0(t);return e.length===4?pe.emptyPath():Z0(e)}function Y0(t){return new pe(["projects",t.databaseId.projectId,"databases",t.databaseId.database]).canonicalString()}function Z0(t){return me(t.length>4&&t.get(4)==="documents",29091,{key:t.toString()}),t.popFirst(5)}function nd(t,e,s){return{name:Ja(t,e),fields:s.value.mapValue.fields}}function eb(t,e){let s;if(e instanceof Wn)s={update:nd(t,e.key,e.value)};else if(e instanceof um)s={delete:Ja(t,e.key)};else if(e instanceof Ft)s={update:nd(t,e.key,e.data),updateMask:nb(e.fieldMask)};else{if(!(e instanceof j0))return Y(16599,{Vt:e.type});s={verify:Ja(t,e.key)}}return e.fieldTransforms.length>0&&(s.updateTransforms=e.fieldTransforms.map((n=>(function(r,a){const l=a.transform;if(l instanceof Xo)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof Vs)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof Bn)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof Yo)return{fieldPath:a.field.canonicalString(),increment:l.Ae};throw Y(20930,{transform:a.transform})})(0,n)))),e.precondition.isNone||(s.currentDocument=(function(o,r){return r.updateTime!==void 0?{updateTime:J0(o,r.updateTime)}:r.exists!==void 0?{exists:r.exists}:Y(27497)})(t,e.precondition)),s}function tb(t,e){return t&&t.length>0?(me(e!==void 0,14353),t.map((s=>(function(o,r){let a=o.updateTime?_s(o.updateTime):_s(r);return a.isEqual(ce.min())&&(a=_s(r)),new F0(a,o.transformResults||[])})(s,e)))):[]}function sb(t){let e=X0(t.parent);const s=t.structuredQuery,n=s.from?s.from.length:0;let o=null;if(n>0){me(n===1,65062);const p=s.from[0];p.allDescendants?o=p.collectionId:e=e.child(p.collectionId)}let r=[];s.where&&(r=(function(h){const f=pm(h);return f instanceof Mt&&Ju(f)?f.getFilters():[f]})(s.where));let a=[];s.orderBy&&(a=(function(h){return h.map((f=>(function(I){return new Jo(Is(I.field),(function(D){switch(D){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}})(I.direction))})(f)))})(s.orderBy));let l=null;s.limit&&(l=(function(h){let f;return f=typeof h=="object"?h.value:h,Ai(f)?null:f})(s.limit));let c=null;s.startAt&&(c=(function(h){const f=!!h.before,y=h.values||[];return new Ko(y,f)})(s.startAt));let d=null;return s.endAt&&(d=(function(h){const f=!h.before,y=h.values||[];return new Ko(y,f)})(s.endAt)),I0(e,o,a,r,l,"F",c,d)}function pm(t){return t.unaryFilter!==void 0?(function(s){switch(s.unaryFilter.op){case"IS_NAN":const n=Is(s.unaryFilter.field);return ye.create(n,"==",{doubleValue:NaN});case"IS_NULL":const o=Is(s.unaryFilter.field);return ye.create(o,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const r=Is(s.unaryFilter.field);return ye.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=Is(s.unaryFilter.field);return ye.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return Y(61313);default:return Y(60726)}})(t):t.fieldFilter!==void 0?(function(s){return ye.create(Is(s.fieldFilter.field),(function(o){switch(o){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return Y(58110);default:return Y(50506)}})(s.fieldFilter.op),s.fieldFilter.value)})(t):t.compositeFilter!==void 0?(function(s){return Mt.create(s.compositeFilter.filters.map((n=>pm(n))),(function(o){switch(o){case"AND":return"and";case"OR":return"or";default:return Y(1026)}})(s.compositeFilter.op))})(t):Y(30097,{filter:t})}function Is(t){return Ee.fromServerFormat(t.fieldPath)}function nb(t){const e=[];return t.fields.forEach((s=>e.push(s.canonicalString()))),{fieldPaths:e}}function ob(t){return t.length>=4&&t.get(0)==="projects"&&t.get(2)==="databases"}class rb{constructor(e){this.yt=e}}function ab(t){const e=sb({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?Wa(e,e.limit,"L"):e}class ib{constructor(){this.Cn=new lb}addToCollectionParentIndex(e,s){return this.Cn.add(s),L.resolve()}getCollectionParents(e,s){return L.resolve(this.Cn.getEntries(s))}addFieldIndex(e,s){return L.resolve()}deleteFieldIndex(e,s){return L.resolve()}deleteAllFieldIndexes(e){return L.resolve()}createTargetIndexes(e,s){return L.resolve()}getDocumentsMatchingTarget(e,s){return L.resolve(null)}getIndexType(e,s){return L.resolve(0)}getFieldIndexes(e,s){return L.resolve([])}getNextCollectionGroupToUpdate(e){return L.resolve(null)}getMinOffset(e,s){return L.resolve(Rt.min())}getMinOffsetFromCollectionGroup(e,s){return L.resolve(Rt.min())}updateCollectionGroup(e,s,n){return L.resolve()}updateIndexEntries(e,s){return L.resolve()}}class lb{constructor(){this.index={}}add(e){const s=e.lastSegment(),n=e.popLast(),o=this.index[s]||new Se(pe.comparator),r=!o.has(n);return this.index[s]=o.add(n),r}has(e){const s=e.lastSegment(),n=e.popLast(),o=this.index[s];return o&&o.has(n)}getEntries(e){return(this.index[e]||new Se(pe.comparator)).toArray()}}const od={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},hm=41943040;class Fe{static withCacheSize(e){return new Fe(e,Fe.DEFAULT_COLLECTION_PERCENTILE,Fe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(e,s,n){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=s,this.maximumSequenceNumbersToCollect=n}}Fe.DEFAULT_COLLECTION_PERCENTILE=10,Fe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Fe.DEFAULT=new Fe(hm,Fe.DEFAULT_COLLECTION_PERCENTILE,Fe.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Fe.DISABLED=new Fe(-1,0,0);class Fs{constructor(e){this.ar=e}next(){return this.ar+=2,this.ar}static ur(){return new Fs(0)}static cr(){return new Fs(-1)}}const rd="LruGarbageCollector",cb=1048576;function ad([t,e],[s,n]){const o=se(t,s);return o===0?se(e,n):o}class db{constructor(e){this.Ir=e,this.buffer=new Se(ad),this.Er=0}dr(){return++this.Er}Ar(e){const s=[e,this.dr()];if(this.buffer.size<this.Ir)this.buffer=this.buffer.add(s);else{const n=this.buffer.last();ad(s,n)<0&&(this.buffer=this.buffer.delete(n).add(s))}}get maxValue(){return this.buffer.last()[0]}}class ub{constructor(e,s,n){this.garbageCollector=e,this.asyncQueue=s,this.localStore=n,this.Rr=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.Vr(6e4)}stop(){this.Rr&&(this.Rr.cancel(),this.Rr=null)}get started(){return this.Rr!==null}Vr(e){U(rd,`Garbage collection scheduled in ${e}ms`),this.Rr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,(async()=>{this.Rr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(s){zn(s)?U(rd,"Ignoring IndexedDB error during garbage collection: ",s):await ki(s)}await this.Vr(3e5)}))}}class mb{constructor(e,s){this.mr=e,this.params=s}calculateTargetCount(e,s){return this.mr.gr(e).next((n=>Math.floor(s/100*n)))}nthSequenceNumber(e,s){if(s===0)return L.resolve(Ci.ce);const n=new db(s);return this.mr.forEachTarget(e,(o=>n.Ar(o.sequenceNumber))).next((()=>this.mr.pr(e,(o=>n.Ar(o))))).next((()=>n.maxValue))}removeTargets(e,s,n){return this.mr.removeTargets(e,s,n)}removeOrphanedDocuments(e,s){return this.mr.removeOrphanedDocuments(e,s)}collect(e,s){return this.params.cacheSizeCollectionThreshold===-1?(U("LruGarbageCollector","Garbage collection skipped; disabled"),L.resolve(od)):this.getCacheSize(e).next((n=>n<this.params.cacheSizeCollectionThreshold?(U("LruGarbageCollector",`Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),od):this.yr(e,s)))}getCacheSize(e){return this.mr.getCacheSize(e)}yr(e,s){let n,o,r,a,l,c,d;const p=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next((h=>(h>this.params.maximumSequenceNumbersToCollect?(U("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${h}`),o=this.params.maximumSequenceNumbersToCollect):o=h,a=Date.now(),this.nthSequenceNumber(e,o)))).next((h=>(n=h,l=Date.now(),this.removeTargets(e,n,s)))).next((h=>(r=h,c=Date.now(),this.removeOrphanedDocuments(e,n)))).next((h=>(d=Date.now(),Es()<=ee.DEBUG&&U("LruGarbageCollector",`LRU Garbage Collection
	Counted targets in ${a-p}ms
	Determined least recently used ${o} in `+(l-a)+`ms
	Removed ${r} targets in `+(c-l)+`ms
	Removed ${h} documents in `+(d-c)+`ms
Total Duration: ${d-p}ms`),L.resolve({didRun:!0,sequenceNumbersCollected:o,targetsRemoved:r,documentsRemoved:h}))))}}function pb(t,e){return new mb(t,e)}class hb{constructor(){this.changes=new fs((e=>e.toString()),((e,s)=>e.isEqual(s))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,s){this.assertNotApplied(),this.changes.set(e,Je.newInvalidDocument(e).setReadTime(s))}getEntry(e,s){this.assertNotApplied();const n=this.changes.get(s);return n!==void 0?L.resolve(n):this.getFromCache(e,s)}getEntries(e,s){return this.getAllFromCache(e,s)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}class gb{constructor(e,s){this.overlayedDocument=e,this.mutatedFields=s}}class fb{constructor(e,s,n,o){this.remoteDocumentCache=e,this.mutationQueue=s,this.documentOverlayCache=n,this.indexManager=o}getDocument(e,s){let n=null;return this.documentOverlayCache.getOverlay(e,s).next((o=>(n=o,this.remoteDocumentCache.getEntry(e,s)))).next((o=>(n!==null&&wn(n.mutation,o,We.empty(),de.now()),o)))}getDocuments(e,s){return this.remoteDocumentCache.getEntries(e,s).next((n=>this.getLocalViewOfDocuments(e,n,Ce()).next((()=>n))))}getLocalViewOfDocuments(e,s,n=Ce()){const o=Xt();return this.populateOverlays(e,o,s).next((()=>this.computeViews(e,s,o,n).next((r=>{let a=yo();return r.forEach(((l,c)=>{a=a.insert(l,c.overlayedDocument)})),a}))))}getOverlayedDocuments(e,s){const n=Xt();return this.populateOverlays(e,n,s).next((()=>this.computeViews(e,s,n,Ce())))}populateOverlays(e,s,n){const o=[];return n.forEach((r=>{s.has(r)||o.push(r)})),this.documentOverlayCache.getOverlays(e,o).next((r=>{r.forEach(((a,l)=>{s.set(a,l)}))}))}computeViews(e,s,n,o){let r=Qo();const a=xn(),l=(function(){return xn()})();return s.forEach(((c,d)=>{const p=n.get(d.key);o.has(d.key)&&(p===void 0||p.mutation instanceof Ft)?r=r.insert(d.key,d):p!==void 0?(a.set(d.key,p.mutation.getFieldMask()),wn(p.mutation,d,p.mutation.getFieldMask(),de.now())):a.set(d.key,We.empty())})),this.recalculateAndSaveOverlays(e,r).next((c=>(c.forEach(((d,p)=>a.set(d,p))),s.forEach(((d,p)=>l.set(d,new gb(p,a.get(d)??null)))),l)))}recalculateAndSaveOverlays(e,s){const n=xn();let o=new je(((a,l)=>a-l)),r=Ce();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,s).next((a=>{for(const l of a)l.keys().forEach((c=>{const d=s.get(c);if(d===null)return;let p=n.get(c)||We.empty();p=l.applyToLocalView(d,p),n.set(c,p);const h=(o.get(l.batchId)||Ce()).add(c);o=o.insert(l.batchId,h)}))})).next((()=>{const a=[],l=o.getReverseIterator();for(;l.hasNext();){const c=l.getNext(),d=c.key,p=c.value,h=nm();p.forEach((f=>{if(!r.has(f)){const y=cm(s.get(f),n.get(f));y!==null&&h.set(f,y),r=r.add(f)}})),a.push(this.documentOverlayCache.saveOverlays(e,d,h))}return L.waitFor(a)})).next((()=>n))}recalculateAndSaveOverlaysForDocumentKeys(e,s){return this.remoteDocumentCache.getEntries(e,s).next((n=>this.recalculateAndSaveOverlays(e,n)))}getDocumentsMatchingQuery(e,s,n,o){return(function(a){return X.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0})(s)?this.getDocumentsMatchingDocumentQuery(e,s.path):T0(s)?this.getDocumentsMatchingCollectionGroupQuery(e,s,n,o):this.getDocumentsMatchingCollectionQuery(e,s,n,o)}getNextDocuments(e,s,n,o){return this.remoteDocumentCache.getAllFromCollectionGroup(e,s,n,o).next((r=>{const a=o-r.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,s,n.largestBatchId,o-r.size):L.resolve(Xt());let l=Mn,c=r;return a.next((d=>L.forEach(d,((p,h)=>(l<h.largestBatchId&&(l=h.largestBatchId),r.get(p)?L.resolve():this.remoteDocumentCache.getEntry(e,p).next((f=>{c=c.insert(p,f)}))))).next((()=>this.populateOverlays(e,d,r))).next((()=>this.computeViews(e,c,d,Ce()))).next((p=>({batchId:l,changes:sm(p)})))))}))}getDocumentsMatchingDocumentQuery(e,s){return this.getDocument(e,new X(s)).next((n=>{let o=yo();return n.isFoundDocument()&&(o=o.insert(n.key,n)),o}))}getDocumentsMatchingCollectionGroupQuery(e,s,n,o){const r=s.collectionGroup;let a=yo();return this.indexManager.getCollectionParents(e,r).next((l=>L.forEach(l,(c=>{const d=(function(h,f){return new fr(f,null,h.explicitOrderBy.slice(),h.filters.slice(),h.limit,h.limitType,h.startAt,h.endAt)})(s,c.child(r));return this.getDocumentsMatchingCollectionQuery(e,d,n,o).next((p=>{p.forEach(((h,f)=>{a=a.insert(h,f)}))}))})).next((()=>a))))}getDocumentsMatchingCollectionQuery(e,s,n,o){let r;return this.documentOverlayCache.getOverlaysForCollection(e,s.path,n.largestBatchId).next((a=>(r=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,s,n,r,o)))).next((a=>{r.forEach(((c,d)=>{const p=d.getKey();a.get(p)===null&&(a=a.insert(p,Je.newInvalidDocument(p)))}));let l=yo();return a.forEach(((c,d)=>{const p=r.get(c);p!==void 0&&wn(p.mutation,d,We.empty(),de.now()),Mi(s,d)&&(l=l.insert(c,d))})),l}))}}class bb{constructor(e){this.serializer=e,this.Lr=new Map,this.kr=new Map}getBundleMetadata(e,s){return L.resolve(this.Lr.get(s))}saveBundleMetadata(e,s){return this.Lr.set(s.id,(function(o){return{id:o.id,version:o.version,createTime:_s(o.createTime)}})(s)),L.resolve()}getNamedQuery(e,s){return L.resolve(this.kr.get(s))}saveNamedQuery(e,s){return this.kr.set(s.name,(function(o){return{name:o.name,query:ab(o.bundledQuery),readTime:_s(o.readTime)}})(s)),L.resolve()}}class vb{constructor(){this.overlays=new je(X.comparator),this.qr=new Map}getOverlay(e,s){return L.resolve(this.overlays.get(s))}getOverlays(e,s){const n=Xt();return L.forEach(s,(o=>this.getOverlay(e,o).next((r=>{r!==null&&n.set(o,r)})))).next((()=>n))}saveOverlays(e,s,n){return n.forEach(((o,r)=>{this.St(e,s,r)})),L.resolve()}removeOverlaysForBatchId(e,s,n){const o=this.qr.get(n);return o!==void 0&&(o.forEach((r=>this.overlays=this.overlays.remove(r))),this.qr.delete(n)),L.resolve()}getOverlaysForCollection(e,s,n){const o=Xt(),r=s.length+1,a=new X(s.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const c=l.getNext().value,d=c.getKey();if(!s.isPrefixOf(d.path))break;d.path.length===r&&c.largestBatchId>n&&o.set(c.getKey(),c)}return L.resolve(o)}getOverlaysForCollectionGroup(e,s,n,o){let r=new je(((d,p)=>d-p));const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===s&&d.largestBatchId>n){let p=r.get(d.largestBatchId);p===null&&(p=Xt(),r=r.insert(d.largestBatchId,p)),p.set(d.getKey(),d)}}const l=Xt(),c=r.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach(((d,p)=>l.set(d,p))),!(l.size()>=o)););return L.resolve(l)}St(e,s,n){const o=this.overlays.get(n.key);if(o!==null){const a=this.qr.get(o.largestBatchId).delete(n.key);this.qr.set(o.largestBatchId,a)}this.overlays=this.overlays.insert(n.key,new U0(s,n));let r=this.qr.get(s);r===void 0&&(r=Ce(),this.qr.set(s,r)),this.qr.set(s,r.add(n.key))}}class yb{constructor(){this.sessionToken=at.EMPTY_BYTE_STRING}getSessionToken(e){return L.resolve(this.sessionToken)}setSessionToken(e,s){return this.sessionToken=s,L.resolve()}}class Vi{constructor(){this.Qr=new Se(ve.$r),this.Ur=new Se(ve.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(e,s){const n=new ve(e,s);this.Qr=this.Qr.add(n),this.Ur=this.Ur.add(n)}Wr(e,s){e.forEach((n=>this.addReference(n,s)))}removeReference(e,s){this.Gr(new ve(e,s))}zr(e,s){e.forEach((n=>this.removeReference(n,s)))}jr(e){const s=new X(new pe([])),n=new ve(s,e),o=new ve(s,e+1),r=[];return this.Ur.forEachInRange([n,o],(a=>{this.Gr(a),r.push(a.key)})),r}Jr(){this.Qr.forEach((e=>this.Gr(e)))}Gr(e){this.Qr=this.Qr.delete(e),this.Ur=this.Ur.delete(e)}Hr(e){const s=new X(new pe([])),n=new ve(s,e),o=new ve(s,e+1);let r=Ce();return this.Ur.forEachInRange([n,o],(a=>{r=r.add(a.key)})),r}containsKey(e){const s=new ve(e,0),n=this.Qr.firstAfterOrEqual(s);return n!==null&&e.isEqual(n.key)}}class ve{constructor(e,s){this.key=e,this.Yr=s}static $r(e,s){return X.comparator(e.key,s.key)||se(e.Yr,s.Yr)}static Kr(e,s){return se(e.Yr,s.Yr)||X.comparator(e.key,s.key)}}class xb{constructor(e,s){this.indexManager=e,this.referenceDelegate=s,this.mutationQueue=[],this.tr=1,this.Zr=new Se(ve.$r)}checkEmpty(e){return L.resolve(this.mutationQueue.length===0)}addMutationBatch(e,s,n,o){const r=this.tr;this.tr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new H0(r,s,n,o);this.mutationQueue.push(a);for(const l of o)this.Zr=this.Zr.add(new ve(l.key,r)),this.indexManager.addToCollectionParentIndex(e,l.key.path.popLast());return L.resolve(a)}lookupMutationBatch(e,s){return L.resolve(this.Xr(s))}getNextMutationBatchAfterBatchId(e,s){const n=s+1,o=this.ei(n),r=o<0?0:o;return L.resolve(this.mutationQueue.length>r?this.mutationQueue[r]:null)}getHighestUnacknowledgedBatchId(){return L.resolve(this.mutationQueue.length===0?_i:this.tr-1)}getAllMutationBatches(e){return L.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,s){const n=new ve(s,0),o=new ve(s,Number.POSITIVE_INFINITY),r=[];return this.Zr.forEachInRange([n,o],(a=>{const l=this.Xr(a.Yr);r.push(l)})),L.resolve(r)}getAllMutationBatchesAffectingDocumentKeys(e,s){let n=new Se(se);return s.forEach((o=>{const r=new ve(o,0),a=new ve(o,Number.POSITIVE_INFINITY);this.Zr.forEachInRange([r,a],(l=>{n=n.add(l.Yr)}))})),L.resolve(this.ti(n))}getAllMutationBatchesAffectingQuery(e,s){const n=s.path,o=n.length+1;let r=n;X.isDocumentKey(r)||(r=r.child(""));const a=new ve(new X(r),0);let l=new Se(se);return this.Zr.forEachWhile((c=>{const d=c.key.path;return!!n.isPrefixOf(d)&&(d.length===o&&(l=l.add(c.Yr)),!0)}),a),L.resolve(this.ti(l))}ti(e){const s=[];return e.forEach((n=>{const o=this.Xr(n);o!==null&&s.push(o)})),s}removeMutationBatch(e,s){me(this.ni(s.batchId,"removed")===0,55003),this.mutationQueue.shift();let n=this.Zr;return L.forEach(s.mutations,(o=>{const r=new ve(o.key,s.batchId);return n=n.delete(r),this.referenceDelegate.markPotentiallyOrphaned(e,o.key)})).next((()=>{this.Zr=n}))}ir(e){}containsKey(e,s){const n=new ve(s,0),o=this.Zr.firstAfterOrEqual(n);return L.resolve(s.isEqual(o&&o.key))}performConsistencyCheck(e){return this.mutationQueue.length,L.resolve()}ni(e,s){return this.ei(e)}ei(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Xr(e){const s=this.ei(e);return s<0||s>=this.mutationQueue.length?null:this.mutationQueue[s]}}class wb{constructor(e){this.ri=e,this.docs=(function(){return new je(X.comparator)})(),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,s){const n=s.key,o=this.docs.get(n),r=o?o.size:0,a=this.ri(s);return this.docs=this.docs.insert(n,{document:s.mutableCopy(),size:a}),this.size+=a-r,this.indexManager.addToCollectionParentIndex(e,n.path.popLast())}removeEntry(e){const s=this.docs.get(e);s&&(this.docs=this.docs.remove(e),this.size-=s.size)}getEntry(e,s){const n=this.docs.get(s);return L.resolve(n?n.document.mutableCopy():Je.newInvalidDocument(s))}getEntries(e,s){let n=Qo();return s.forEach((o=>{const r=this.docs.get(o);n=n.insert(o,r?r.document.mutableCopy():Je.newInvalidDocument(o))})),L.resolve(n)}getDocumentsMatchingQuery(e,s,n,o){let r=Qo();const a=s.path,l=new X(a.child("__id-9223372036854775808__")),c=this.docs.getIteratorFrom(l);for(;c.hasNext();){const{key:d,value:{document:p}}=c.getNext();if(!a.isPrefixOf(d.path))break;d.path.length>a.length+1||e0(Zf(p),n)<=0||(o.has(p.key)||Mi(s,p))&&(r=r.insert(p.key,p.mutableCopy()))}return L.resolve(r)}getAllFromCollectionGroup(e,s,n,o){Y(9500)}ii(e,s){return L.forEach(this.docs,(n=>s(n)))}newChangeBuffer(e){return new Eb(this)}getSize(e){return L.resolve(this.size)}}class Eb extends hb{constructor(e){super(),this.Nr=e}applyChanges(e){const s=[];return this.changes.forEach(((n,o)=>{o.isValidDocument()?s.push(this.Nr.addEntry(e,o)):this.Nr.removeEntry(n)})),L.waitFor(s)}getFromCache(e,s){return this.Nr.getEntry(e,s)}getAllFromCache(e,s){return this.Nr.getEntries(e,s)}}class Ib{constructor(e){this.persistence=e,this.si=new fs((s=>Li(s)),Ri),this.lastRemoteSnapshotVersion=ce.min(),this.highestTargetId=0,this.oi=0,this._i=new Vi,this.targetCount=0,this.ai=Fs.ur()}forEachTarget(e,s){return this.si.forEach(((n,o)=>s(o))),L.resolve()}getLastRemoteSnapshotVersion(e){return L.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return L.resolve(this.oi)}allocateTargetId(e){return this.highestTargetId=this.ai.next(),L.resolve(this.highestTargetId)}setTargetsMetadata(e,s,n){return n&&(this.lastRemoteSnapshotVersion=n),s>this.oi&&(this.oi=s),L.resolve()}Pr(e){this.si.set(e.target,e);const s=e.targetId;s>this.highestTargetId&&(this.ai=new Fs(s),this.highestTargetId=s),e.sequenceNumber>this.oi&&(this.oi=e.sequenceNumber)}addTargetData(e,s){return this.Pr(s),this.targetCount+=1,L.resolve()}updateTargetData(e,s){return this.Pr(s),L.resolve()}removeTargetData(e,s){return this.si.delete(s.target),this._i.jr(s.targetId),this.targetCount-=1,L.resolve()}removeTargets(e,s,n){let o=0;const r=[];return this.si.forEach(((a,l)=>{l.sequenceNumber<=s&&n.get(l.targetId)===null&&(this.si.delete(a),r.push(this.removeMatchingKeysForTargetId(e,l.targetId)),o++)})),L.waitFor(r).next((()=>o))}getTargetCount(e){return L.resolve(this.targetCount)}getTargetData(e,s){const n=this.si.get(s)||null;return L.resolve(n)}addMatchingKeys(e,s,n){return this._i.Wr(s,n),L.resolve()}removeMatchingKeys(e,s,n){this._i.zr(s,n);const o=this.persistence.referenceDelegate,r=[];return o&&s.forEach((a=>{r.push(o.markPotentiallyOrphaned(e,a))})),L.waitFor(r)}removeMatchingKeysForTargetId(e,s){return this._i.jr(s),L.resolve()}getMatchingKeysForTargetId(e,s){const n=this._i.Hr(s);return L.resolve(n)}containsKey(e,s){return L.resolve(this._i.containsKey(s))}}class gm{constructor(e,s){this.ui={},this.overlays={},this.ci=new Ci(0),this.li=!1,this.li=!0,this.hi=new yb,this.referenceDelegate=e(this),this.Pi=new Ib(this),this.indexManager=new ib,this.remoteDocumentCache=(function(o){return new wb(o)})((n=>this.referenceDelegate.Ti(n))),this.serializer=new rb(s),this.Ii=new bb(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.li=!1,Promise.resolve()}get started(){return this.li}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let s=this.overlays[e.toKey()];return s||(s=new vb,this.overlays[e.toKey()]=s),s}getMutationQueue(e,s){let n=this.ui[e.toKey()];return n||(n=new xb(s,this.referenceDelegate),this.ui[e.toKey()]=n),n}getGlobalsCache(){return this.hi}getTargetCache(){return this.Pi}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ii}runTransaction(e,s,n){U("MemoryPersistence","Starting transaction:",e);const o=new Sb(this.ci.next());return this.referenceDelegate.Ei(),n(o).next((r=>this.referenceDelegate.di(o).next((()=>r)))).toPromise().then((r=>(o.raiseOnCommittedEvent(),r)))}Ai(e,s){return L.or(Object.values(this.ui).map((n=>()=>n.containsKey(e,s))))}}class Sb extends s0{constructor(e){super(),this.currentSequenceNumber=e}}class Fi{constructor(e){this.persistence=e,this.Ri=new Vi,this.Vi=null}static mi(e){return new Fi(e)}get fi(){if(this.Vi)return this.Vi;throw Y(60996)}addReference(e,s,n){return this.Ri.addReference(n,s),this.fi.delete(n.toString()),L.resolve()}removeReference(e,s,n){return this.Ri.removeReference(n,s),this.fi.add(n.toString()),L.resolve()}markPotentiallyOrphaned(e,s){return this.fi.add(s.toString()),L.resolve()}removeTarget(e,s){this.Ri.jr(s.targetId).forEach((o=>this.fi.add(o.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,s.targetId).next((o=>{o.forEach((r=>this.fi.add(r.toString())))})).next((()=>n.removeTargetData(e,s)))}Ei(){this.Vi=new Set}di(e){const s=this.persistence.getRemoteDocumentCache().newChangeBuffer();return L.forEach(this.fi,(n=>{const o=X.fromPath(n);return this.gi(e,o).next((r=>{r||s.removeEntry(o,ce.min())}))})).next((()=>(this.Vi=null,s.apply(e))))}updateLimboDocument(e,s){return this.gi(e,s).next((n=>{n?this.fi.delete(s.toString()):this.fi.add(s.toString())}))}Ti(e){return 0}gi(e,s){return L.or([()=>L.resolve(this.Ri.containsKey(s)),()=>this.persistence.getTargetCache().containsKey(e,s),()=>this.persistence.Ai(e,s)])}}class Zo{constructor(e,s){this.persistence=e,this.pi=new fs((n=>r0(n.path)),((n,o)=>n.isEqual(o))),this.garbageCollector=pb(this,s)}static mi(e,s){return new Zo(e,s)}Ei(){}di(e){return L.resolve()}forEachTarget(e,s){return this.persistence.getTargetCache().forEachTarget(e,s)}gr(e){const s=this.wr(e);return this.persistence.getTargetCache().getTargetCount(e).next((n=>s.next((o=>n+o))))}wr(e){let s=0;return this.pr(e,(n=>{s++})).next((()=>s))}pr(e,s){return L.forEach(this.pi,((n,o)=>this.br(e,n,o).next((r=>r?L.resolve():s(o)))))}removeTargets(e,s,n){return this.persistence.getTargetCache().removeTargets(e,s,n)}removeOrphanedDocuments(e,s){let n=0;const o=this.persistence.getRemoteDocumentCache(),r=o.newChangeBuffer();return o.ii(e,(a=>this.br(e,a,s).next((l=>{l||(n++,r.removeEntry(a,ce.min()))})))).next((()=>r.apply(e))).next((()=>n))}markPotentiallyOrphaned(e,s){return this.pi.set(s,e.currentSequenceNumber),L.resolve()}removeTarget(e,s){const n=s.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,n)}addReference(e,s,n){return this.pi.set(n,e.currentSequenceNumber),L.resolve()}removeReference(e,s,n){return this.pi.set(n,e.currentSequenceNumber),L.resolve()}updateLimboDocument(e,s){return this.pi.set(s,e.currentSequenceNumber),L.resolve()}Ti(e){let s=e.key.toString().length;return e.isFoundDocument()&&(s+=No(e.data.value)),s}br(e,s,n){return L.or([()=>this.persistence.Ai(e,s),()=>this.persistence.getTargetCache().containsKey(e,s),()=>{const o=this.pi.get(s);return L.resolve(o!==void 0&&o>n)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}class Oi{constructor(e,s,n,o){this.targetId=e,this.fromCache=s,this.Es=n,this.ds=o}static As(e,s){let n=Ce(),o=Ce();for(const r of s.docChanges)switch(r.type){case 0:n=n.add(r.doc.key);break;case 1:o=o.add(r.doc.key)}return new Oi(e,s.fromCache,n,o)}}class Tb{constructor(){this._documentReadCount=0}get documentReadCount(){return this._documentReadCount}incrementDocumentReadCount(e){this._documentReadCount+=e}}class kb{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return _g()?8:n0(kg())>0?6:4})()}initialize(e,s){this.ps=e,this.indexManager=s,this.Rs=!0}getDocumentsMatchingQuery(e,s,n,o){const r={result:null};return this.ys(e,s).next((a=>{r.result=a})).next((()=>{if(!r.result)return this.ws(e,s,o,n).next((a=>{r.result=a}))})).next((()=>{if(r.result)return;const a=new Tb;return this.Ss(e,s,a).next((l=>{if(r.result=l,this.Vs)return this.bs(e,s,a,l.size)}))})).next((()=>r.result))}bs(e,s,n,o){return n.documentReadCount<this.fs?(Es()<=ee.DEBUG&&U("QueryEngine","SDK will not create cache indexes for query:",dn(s),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),L.resolve()):(Es()<=ee.DEBUG&&U("QueryEngine","Query:",dn(s),"scans",n.documentReadCount,"local documents and returns",o,"documents as results."),n.documentReadCount>this.gs*o?(Es()<=ee.DEBUG&&U("QueryEngine","The SDK decides to create cache indexes for query:",dn(s),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,ts(s))):L.resolve())}ys(e,s){if(Yc(s))return L.resolve(null);let n=ts(s);return this.indexManager.getIndexType(e,n).next((o=>o===0?null:(s.limit!==null&&o===1&&(s=Wa(s,null,"F"),n=ts(s)),this.indexManager.getDocumentsMatchingTarget(e,n).next((r=>{const a=Ce(...r);return this.ps.getDocuments(e,a).next((l=>this.indexManager.getMinOffset(e,n).next((c=>{const d=this.Ds(s,l);return this.Cs(s,d,a,c.readTime)?this.ys(e,Wa(s,null,"F")):this.vs(e,d,s,c)}))))})))))}ws(e,s,n,o){return Yc(s)||o.isEqual(ce.min())?L.resolve(null):this.ps.getDocuments(e,n).next((r=>{const a=this.Ds(s,r);return this.Cs(s,a,n,o)?L.resolve(null):(Es()<=ee.DEBUG&&U("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),dn(s)),this.vs(e,a,s,Yf(o,Mn)).next((l=>l)))}))}Ds(e,s){let n=new Se(C0(e));return s.forEach(((o,r)=>{Mi(e,r)&&(n=n.add(r))})),n}Cs(e,s,n,o){if(e.limit===null)return!1;if(n.size!==s.size)return!0;const r=e.limitType==="F"?s.last():s.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(o)>0)}Ss(e,s,n){return Es()<=ee.DEBUG&&U("QueryEngine","Using full collection scan to execute query:",dn(s)),this.ps.getDocumentsMatchingQuery(e,s,Rt.min(),n)}vs(e,s,n,o){return this.ps.getDocumentsMatchingQuery(e,n,o).next((r=>(s.forEach((a=>{r=r.insert(a.key,a)})),r)))}}const Cb="LocalStore";class _b{constructor(e,s,n,o){this.persistence=e,this.Fs=s,this.serializer=o,this.Ms=new je(se),this.xs=new fs((r=>Li(r)),Ri),this.Os=new Map,this.Ns=e.getRemoteDocumentCache(),this.Pi=e.getTargetCache(),this.Ii=e.getBundleCache(),this.Bs(n)}Bs(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new fb(this.Ns,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Ns.setIndexManager(this.indexManager),this.Fs.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(s=>e.collect(s,this.Ms)))}}function Ab(t,e,s,n){return new _b(t,e,s,n)}async function fm(t,e){const s=ae(t);return await s.persistence.runTransaction("Handle user change","readonly",(n=>{let o;return s.mutationQueue.getAllMutationBatches(n).next((r=>(o=r,s.Bs(e),s.mutationQueue.getAllMutationBatches(n)))).next((r=>{const a=[],l=[];let c=Ce();for(const d of o){a.push(d.batchId);for(const p of d.mutations)c=c.add(p.key)}for(const d of r){l.push(d.batchId);for(const p of d.mutations)c=c.add(p.key)}return s.localDocuments.getDocuments(n,c).next((d=>({Ls:d,removedBatchIds:a,addedBatchIds:l})))}))}))}function Pb(t,e){const s=ae(t);return s.persistence.runTransaction("Acknowledge batch","readwrite-primary",(n=>{const o=e.batch.keys(),r=s.Ns.newChangeBuffer({trackRemovals:!0});return(function(l,c,d,p){const h=d.batch,f=h.keys();let y=L.resolve();return f.forEach((I=>{y=y.next((()=>p.getEntry(c,I))).next((_=>{const D=d.docVersions.get(I);me(D!==null,48541),_.version.compareTo(D)<0&&(h.applyToRemoteDocument(_,d),_.isValidDocument()&&(_.setReadTime(d.commitVersion),p.addEntry(_)))}))})),y.next((()=>l.mutationQueue.removeMutationBatch(c,h)))})(s,n,e,r).next((()=>r.apply(n))).next((()=>s.mutationQueue.performConsistencyCheck(n))).next((()=>s.documentOverlayCache.removeOverlaysForBatchId(n,o,e.batch.batchId))).next((()=>s.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(n,(function(l){let c=Ce();for(let d=0;d<l.mutationResults.length;++d)l.mutationResults[d].transformResults.length>0&&(c=c.add(l.batch.mutations[d].key));return c})(e)))).next((()=>s.localDocuments.getDocuments(n,o)))}))}function $b(t){const e=ae(t);return e.persistence.runTransaction("Get last remote snapshot version","readonly",(s=>e.Pi.getLastRemoteSnapshotVersion(s)))}function Db(t,e){const s=ae(t);return s.persistence.runTransaction("Get next mutation batch","readonly",(n=>(e===void 0&&(e=_i),s.mutationQueue.getNextMutationBatchAfterBatchId(n,e))))}class id{constructor(){this.activeTargetIds=L0()}zs(e){this.activeTargetIds=this.activeTargetIds.add(e)}js(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Gs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Lb{constructor(){this.Mo=new id,this.xo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,s,n){}addLocalQueryTarget(e,s=!0){return s&&this.Mo.zs(e),this.xo[e]||"not-current"}updateQueryState(e,s,n){this.xo[e]=s}removeLocalQueryTarget(e){this.Mo.js(e)}isLocalQueryTarget(e){return this.Mo.activeTargetIds.has(e)}clearQueryState(e){delete this.xo[e]}getAllActiveQueryTargets(){return this.Mo.activeTargetIds}isActiveQueryTarget(e){return this.Mo.activeTargetIds.has(e)}start(){return this.Mo=new id,Promise.resolve()}handleUserChange(e,s,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}class Rb{Oo(e){}shutdown(){}}const ld="ConnectivityMonitor";class cd{constructor(){this.No=()=>this.Bo(),this.Lo=()=>this.ko(),this.qo=[],this.Qo()}Oo(e){this.qo.push(e)}shutdown(){window.removeEventListener("online",this.No),window.removeEventListener("offline",this.Lo)}Qo(){window.addEventListener("online",this.No),window.addEventListener("offline",this.Lo)}Bo(){U(ld,"Network connectivity changed: AVAILABLE");for(const e of this.qo)e(0)}ko(){U(ld,"Network connectivity changed: UNAVAILABLE");for(const e of this.qo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}let xo=null;function Qa(){return xo===null?xo=(function(){return 268435456+Math.round(2147483648*Math.random())})():xo++,"0x"+xo.toString(16)}const ga="RestConnection",Mb={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class Nb{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const s=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Uo=s+"://"+e.host,this.Ko=`projects/${n}/databases/${o}`,this.Wo=this.databaseId.database===qa?`project_id=${n}`:`project_id=${n}&database_id=${o}`}Go(e,s,n,o,r){const a=Qa(),l=this.zo(e,s.toUriEncodedString());U(ga,`Sending RPC '${e}' ${a}:`,l,n);const c={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(c,o,r);const{host:d}=new URL(l),p=Tg(d);return this.Jo(e,l,c,n,p).then((h=>(U(ga,`Received RPC '${e}' ${a}: `,h),h)),(h=>{throw Ei(ga,`RPC '${e}' ${a} failed with error: `,h,"url: ",l,"request:",n),h}))}Ho(e,s,n,o,r,a){return this.Go(e,s,n,o,r)}jo(e,s,n){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Hs})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),s&&s.headers.forEach(((o,r)=>e[r]=o)),n&&n.headers.forEach(((o,r)=>e[r]=o))}zo(e,s){const n=Mb[e];return`${this.Uo}/v1/${s}:${n}`}terminate(){}}class Bb{constructor(e){this.Yo=e.Yo,this.Zo=e.Zo}Xo(e){this.e_=e}t_(e){this.n_=e}r_(e){this.i_=e}onMessage(e){this.s_=e}close(){this.Zo()}send(e){this.Yo(e)}o_(){this.e_()}__(){this.n_()}a_(e){this.i_(e)}u_(e){this.s_(e)}}const ke="WebChannelConnection";class Vb extends Nb{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,s,n,o,r){const a=Qa();return new Promise(((l,c)=>{const d=new $u;d.setWithCredentials(!0),d.listenOnce(Du.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Mo.NO_ERROR:const h=d.getResponseJson();U(ke,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(h)),l(h);break;case Mo.TIMEOUT:U(ke,`RPC '${e}' ${a} timed out`),c(new z(M.DEADLINE_EXCEEDED,"Request time out"));break;case Mo.HTTP_ERROR:const f=d.getStatus();if(U(ke,`RPC '${e}' ${a} failed with status:`,f,"response text:",d.getResponseText()),f>0){let y=d.getResponseJson();Array.isArray(y)&&(y=y[0]);const I=y?.error;if(I&&I.status&&I.message){const _=(function(R){const O=R.toLowerCase().replace(/_/g,"-");return Object.values(M).indexOf(O)>=0?O:M.UNKNOWN})(I.status);c(new z(_,I.message))}else c(new z(M.UNKNOWN,"Server responded with status "+d.getStatus()))}else c(new z(M.UNAVAILABLE,"Connection failed."));break;default:Y(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{U(ke,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(o);U(ke,`RPC '${e}' ${a} sending request:`,o),d.send(s,"POST",p,n,15)}))}T_(e,s,n){const o=Qa(),r=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Mu(),l=Ru(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(c.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(c.useFetchStreams=!0),this.jo(c.initMessageHeaders,s,n),c.encodeInitMessageHeaders=!0;const p=r.join("");U(ke,`Creating RPC '${e}' stream ${o}: ${p}`,c);const h=a.createWebChannel(p,c);this.I_(h);let f=!1,y=!1;const I=new Bb({Yo:D=>{y?U(ke,`Not sending because RPC '${e}' stream ${o} is closed:`,D):(f||(U(ke,`Opening RPC '${e}' stream ${o} transport.`),h.open(),f=!0),U(ke,`RPC '${e}' stream ${o} sending:`,D),h.send(D))},Zo:()=>h.close()}),_=(D,R,O)=>{D.listen(R,(N=>{try{O(N)}catch(B){setTimeout((()=>{throw B}),0)}}))};return _(h,hn.EventType.OPEN,(()=>{y||(U(ke,`RPC '${e}' stream ${o} transport opened.`),I.o_())})),_(h,hn.EventType.CLOSE,(()=>{y||(y=!0,U(ke,`RPC '${e}' stream ${o} transport closed`),I.a_(),this.E_(h))})),_(h,hn.EventType.ERROR,(D=>{y||(y=!0,Ei(ke,`RPC '${e}' stream ${o} transport errored. Name:`,D.name,"Message:",D.message),I.a_(new z(M.UNAVAILABLE,"The operation could not be completed")))})),_(h,hn.EventType.MESSAGE,(D=>{if(!y){const R=D.data[0];me(!!R,16349);const O=R,N=O?.error||O[0]?.error;if(N){U(ke,`RPC '${e}' stream ${o} received error:`,N);const B=N.status;let H=(function(b){const v=he[b];if(v!==void 0)return W0(v)})(B),G=N.message;H===void 0&&(H=M.INTERNAL,G="Unknown error status: "+B+" with message "+N.message),y=!0,I.a_(new z(H,G)),h.close()}else U(ke,`RPC '${e}' stream ${o} received:`,R),I.u_(R)}})),_(l,Lu.STAT_EVENT,(D=>{D.stat===Fa.PROXY?U(ke,`RPC '${e}' stream ${o} detected buffering proxy`):D.stat===Fa.NOPROXY&&U(ke,`RPC '${e}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{I.__()}),0),I}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((s=>s===e))}}function fa(){return typeof document<"u"?document:null}function yr(t){return new G0(t,!0)}class bm{constructor(e,s,n=1e3,o=1.5,r=6e4){this.Mi=e,this.timerId=s,this.d_=n,this.A_=o,this.R_=r,this.V_=0,this.m_=null,this.f_=Date.now(),this.reset()}reset(){this.V_=0}g_(){this.V_=this.R_}p_(e){this.cancel();const s=Math.floor(this.V_+this.y_()),n=Math.max(0,Date.now()-this.f_),o=Math.max(0,s-n);o>0&&U("ExponentialBackoff",`Backing off for ${o} ms (base delay: ${this.V_} ms, delay with jitter: ${s} ms, last attempt: ${n} ms ago)`),this.m_=this.Mi.enqueueAfterDelay(this.timerId,o,(()=>(this.f_=Date.now(),e()))),this.V_*=this.A_,this.V_<this.d_&&(this.V_=this.d_),this.V_>this.R_&&(this.V_=this.R_)}w_(){this.m_!==null&&(this.m_.skipDelay(),this.m_=null)}cancel(){this.m_!==null&&(this.m_.cancel(),this.m_=null)}y_(){return(Math.random()-.5)*this.V_}}const dd="PersistentStream";class Fb{constructor(e,s,n,o,r,a,l,c){this.Mi=e,this.S_=n,this.b_=o,this.connection=r,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=l,this.listener=c,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new bm(e,s)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Mi.enqueueAfterDelay(this.S_,6e4,(()=>this.k_())))}q_(e){this.Q_(),this.stream.send(e)}async k_(){if(this.O_())return this.close(0)}Q_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,s){this.Q_(),this.U_(),this.M_.cancel(),this.D_++,e!==4?this.M_.reset():s&&s.code===M.RESOURCE_EXHAUSTED?(is(s.toString()),is("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):s&&s.code===M.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.K_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.r_(s)}K_(){}auth(){this.state=1;const e=this.W_(this.D_),s=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([n,o])=>{this.D_===s&&this.G_(n,o)}),(n=>{e((()=>{const o=new z(M.UNKNOWN,"Fetching auth token failed: "+n.message);return this.z_(o)}))}))}G_(e,s){const n=this.W_(this.D_);this.stream=this.j_(e,s),this.stream.Xo((()=>{n((()=>this.listener.Xo()))})),this.stream.t_((()=>{n((()=>(this.state=2,this.v_=this.Mi.enqueueAfterDelay(this.b_,1e4,(()=>(this.O_()&&(this.state=3),Promise.resolve()))),this.listener.t_())))})),this.stream.r_((o=>{n((()=>this.z_(o)))})),this.stream.onMessage((o=>{n((()=>++this.F_==1?this.J_(o):this.onNext(o)))}))}N_(){this.state=5,this.M_.p_((async()=>{this.state=0,this.start()}))}z_(e){return U(dd,`close with error: ${e}`),this.stream=null,this.close(4,e)}W_(e){return s=>{this.Mi.enqueueAndForget((()=>this.D_===e?s():(U(dd,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class Ob extends Fb{constructor(e,s,n,o,r,a){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",s,n,o,a),this.serializer=r}get X_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}K_(){this.X_&&this.ea([])}j_(e,s){return this.connection.T_("Write",e,s)}J_(e){return me(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,me(!e.writeResults||e.writeResults.length===0,55816),this.listener.ta()}onNext(e){me(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.M_.reset();const s=tb(e.writeResults,e.commitTime),n=_s(e.commitTime);return this.listener.na(n,s)}ra(){const e={};e.database=Y0(this.serializer),this.q_(e)}ea(e){const s={streamToken:this.lastStreamToken,writes:e.map((n=>eb(this.serializer,n)))};this.q_(s)}}class qb{}class jb extends qb{constructor(e,s,n,o){super(),this.authCredentials=e,this.appCheckCredentials=s,this.connection=n,this.serializer=o,this.ia=!1}sa(){if(this.ia)throw new z(M.FAILED_PRECONDITION,"The client has already been terminated.")}Go(e,s,n,o){return this.sa(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([r,a])=>this.connection.Go(e,Ka(s,n),o,r,a))).catch((r=>{throw r.name==="FirebaseError"?(r.code===M.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),r):new z(M.UNKNOWN,r.toString())}))}Ho(e,s,n,o,r){return this.sa(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([a,l])=>this.connection.Ho(e,Ka(s,n),o,a,l,r))).catch((a=>{throw a.name==="FirebaseError"?(a.code===M.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new z(M.UNKNOWN,a.toString())}))}terminate(){this.ia=!0,this.connection.terminate()}}class Hb{constructor(e,s){this.asyncQueue=e,this.onlineStateHandler=s,this.state="Unknown",this.oa=0,this._a=null,this.aa=!0}ua(){this.oa===0&&(this.ca("Unknown"),this._a=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(()=>(this._a=null,this.la("Backend didn't respond within 10 seconds."),this.ca("Offline"),Promise.resolve()))))}ha(e){this.state==="Online"?this.ca("Unknown"):(this.oa++,this.oa>=1&&(this.Pa(),this.la(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.ca("Offline")))}set(e){this.Pa(),this.oa=0,e==="Online"&&(this.aa=!1),this.ca(e)}ca(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}la(e){const s=`Could not reach Cloud Firestore backend. ${e}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.aa?(is(s),this.aa=!1):U("OnlineStateTracker",s)}Pa(){this._a!==null&&(this._a.cancel(),this._a=null)}}const Gn="RemoteStore";class Ub{constructor(e,s,n,o,r){this.localStore=e,this.datastore=s,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=r,this.Aa.Oo((a=>{n.enqueueAndForget((async()=>{Jn(this)&&(U(Gn,"Restarting streams for network reachability change."),await(async function(c){const d=ae(c);d.Ea.add(4),await Kn(d),d.Ra.set("Unknown"),d.Ea.delete(4),await xr(d)})(this))}))})),this.Ra=new Hb(n,o)}}async function xr(t){if(Jn(t))for(const e of t.da)await e(!0)}async function Kn(t){for(const e of t.da)await e(!1)}function Jn(t){return ae(t).Ea.size===0}async function vm(t,e,s){if(!zn(e))throw e;t.Ea.add(1),await Kn(t),t.Ra.set("Offline"),s||(s=()=>$b(t.localStore)),t.asyncQueue.enqueueRetryable((async()=>{U(Gn,"Retrying IndexedDB access"),await s(),t.Ea.delete(1),await xr(t)}))}function ym(t,e){return e().catch((s=>vm(t,s,e)))}async function wr(t){const e=ae(t),s=Nt(e);let n=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:_i;for(;zb(e);)try{const o=await Db(e.localStore,n);if(o===null){e.Ta.length===0&&s.L_();break}n=o.batchId,Wb(e,o)}catch(o){await vm(e,o)}xm(e)&&wm(e)}function zb(t){return Jn(t)&&t.Ta.length<10}function Wb(t,e){t.Ta.push(e);const s=Nt(t);s.O_()&&s.X_&&s.ea(e.mutations)}function xm(t){return Jn(t)&&!Nt(t).x_()&&t.Ta.length>0}function wm(t){Nt(t).start()}async function Gb(t){Nt(t).ra()}async function Kb(t){const e=Nt(t);for(const s of t.Ta)e.ea(s.mutations)}async function Jb(t,e,s){const n=t.Ta.shift(),o=Bi.from(n,e,s);await ym(t,(()=>t.remoteSyncer.applySuccessfulWrite(o))),await wr(t)}async function Qb(t,e){e&&Nt(t).X_&&await(async function(n,o){if((function(a){return z0(a)&&a!==M.ABORTED})(o.code)){const r=n.Ta.shift();Nt(n).B_(),await ym(n,(()=>n.remoteSyncer.rejectFailedWrite(r.batchId,o))),await wr(n)}})(t,e),xm(t)&&wm(t)}async function ud(t,e){const s=ae(t);s.asyncQueue.verifyOperationInProgress(),U(Gn,"RemoteStore received new credentials");const n=Jn(s);s.Ea.add(3),await Kn(s),n&&s.Ra.set("Unknown"),await s.remoteSyncer.handleCredentialChange(e),s.Ea.delete(3),await xr(s)}async function Xb(t,e){const s=ae(t);e?(s.Ea.delete(2),await xr(s)):e||(s.Ea.add(2),await Kn(s),s.Ra.set("Unknown"))}function Nt(t){return t.fa||(t.fa=(function(s,n,o){const r=ae(s);return r.sa(),new Ob(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,o)})(t.datastore,t.asyncQueue,{Xo:()=>Promise.resolve(),t_:Gb.bind(null,t),r_:Qb.bind(null,t),ta:Kb.bind(null,t),na:Jb.bind(null,t)}),t.da.push((async e=>{e?(t.fa.B_(),await wr(t)):(await t.fa.stop(),t.Ta.length>0&&(U(Gn,`Stopping write stream with ${t.Ta.length} pending writes`),t.Ta=[]))}))),t.fa}class qi{constructor(e,s,n,o,r){this.asyncQueue=e,this.timerId=s,this.targetTimeMs=n,this.op=o,this.removalCallback=r,this.deferred=new es,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((a=>{}))}get promise(){return this.deferred.promise}static createAndSchedule(e,s,n,o,r){const a=Date.now()+n,l=new qi(e,s,a,o,r);return l.start(n),l}start(e){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new z(M.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then((e=>this.deferred.resolve(e)))):Promise.resolve()))}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Em(t,e){if(is("AsyncQueue",`${e}: ${t}`),zn(t))return new z(M.UNAVAILABLE,`${e}: ${t}`);throw t}class Yb{constructor(){this.queries=md(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(s,n){const o=ae(s),r=o.queries;o.queries=md(),r.forEach(((a,l)=>{for(const c of l.Sa)c.onError(n)}))})(this,new z(M.ABORTED,"Firestore shutting down"))}}function md(){return new fs((t=>em(t)),Zu)}function Zb(t){t.Ca.forEach((e=>{e.next()}))}var pd,hd;(hd=pd||(pd={})).Ma="default",hd.Cache="cache";const ev="SyncEngine";class tv{constructor(e,s,n,o,r,a){this.localStore=e,this.remoteStore=s,this.eventManager=n,this.sharedClientState=o,this.currentUser=r,this.maxConcurrentLimboResolutions=a,this.Pu={},this.Tu=new fs((l=>em(l)),Zu),this.Iu=new Map,this.Eu=new Set,this.du=new je(X.comparator),this.Au=new Map,this.Ru=new Vi,this.Vu={},this.mu=new Map,this.fu=Fs.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function sv(t,e,s){const n=av(t);try{const o=await(function(a,l){const c=ae(a),d=de.now(),p=l.reduce(((y,I)=>y.add(I.key)),Ce());let h,f;return c.persistence.runTransaction("Locally write mutations","readwrite",(y=>{let I=Qo(),_=Ce();return c.Ns.getEntries(y,p).next((D=>{I=D,I.forEach(((R,O)=>{O.isValidDocument()||(_=_.add(R))}))})).next((()=>c.localDocuments.getOverlayedDocuments(y,I))).next((D=>{h=D;const R=[];for(const O of l){const N=q0(O,h.get(O.key).overlayedDocument);N!=null&&R.push(new Ft(O.key,N,Wu(N.value.mapValue),rt.exists(!0)))}return c.mutationQueue.addMutationBatch(y,d,R,l)})).next((D=>{f=D;const R=D.applyToLocalDocumentSet(h,_);return c.documentOverlayCache.saveOverlays(y,D.batchId,R)}))})).then((()=>({batchId:f.batchId,changes:sm(h)})))})(n.localStore,e);n.sharedClientState.addPendingMutation(o.batchId),(function(a,l,c){let d=a.Vu[a.currentUser.toKey()];d||(d=new je(se)),d=d.insert(l,c),a.Vu[a.currentUser.toKey()]=d})(n,o.batchId,s),await Er(n,o.changes),await wr(n.remoteStore)}catch(o){const r=Em(o,"Failed to persist write");s.reject(r)}}function gd(t,e,s){const n=ae(t);if(n.isPrimaryClient&&s===0||!n.isPrimaryClient&&s===1){const o=[];n.Tu.forEach(((r,a)=>{const l=a.view.va(e);l.snapshot&&o.push(l.snapshot)})),(function(a,l){const c=ae(a);c.onlineState=l;let d=!1;c.queries.forEach(((p,h)=>{for(const f of h.Sa)f.va(l)&&(d=!0)})),d&&Zb(c)})(n.eventManager,e),o.length&&n.Pu.H_(o),n.onlineState=e,n.isPrimaryClient&&n.sharedClientState.setOnlineState(e)}}async function nv(t,e){const s=ae(t),n=e.batch.batchId;try{const o=await Pb(s.localStore,e);Sm(s,n,null),Im(s,n),s.sharedClientState.updateMutationState(n,"acknowledged"),await Er(s,o)}catch(o){await ki(o)}}async function ov(t,e,s){const n=ae(t);try{const o=await(function(a,l){const c=ae(a);return c.persistence.runTransaction("Reject batch","readwrite-primary",(d=>{let p;return c.mutationQueue.lookupMutationBatch(d,l).next((h=>(me(h!==null,37113),p=h.keys(),c.mutationQueue.removeMutationBatch(d,h)))).next((()=>c.mutationQueue.performConsistencyCheck(d))).next((()=>c.documentOverlayCache.removeOverlaysForBatchId(d,p,l))).next((()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,p))).next((()=>c.localDocuments.getDocuments(d,p)))}))})(n.localStore,e);Sm(n,e,s),Im(n,e),n.sharedClientState.updateMutationState(e,"rejected",s),await Er(n,o)}catch(o){await ki(o)}}function Im(t,e){(t.mu.get(e)||[]).forEach((s=>{s.resolve()})),t.mu.delete(e)}function Sm(t,e,s){const n=ae(t);let o=n.Vu[n.currentUser.toKey()];if(o){const r=o.get(e);r&&(s?r.reject(s):r.resolve(),o=o.remove(e)),n.Vu[n.currentUser.toKey()]=o}}async function Er(t,e,s){const n=ae(t),o=[],r=[],a=[];n.Tu.isEmpty()||(n.Tu.forEach(((l,c)=>{a.push(n.pu(c,e,s).then((d=>{if((d||s)&&n.isPrimaryClient){const p=d?!d.fromCache:s?.targetChanges.get(c.targetId)?.current;n.sharedClientState.updateQueryState(c.targetId,p?"current":"not-current")}if(d){o.push(d);const p=Oi.As(c.targetId,d);r.push(p)}})))})),await Promise.all(a),n.Pu.H_(o),await(async function(c,d){const p=ae(c);try{await p.persistence.runTransaction("notifyLocalViewChanges","readwrite",(h=>L.forEach(d,(f=>L.forEach(f.Es,(y=>p.persistence.referenceDelegate.addReference(h,f.targetId,y))).next((()=>L.forEach(f.ds,(y=>p.persistence.referenceDelegate.removeReference(h,f.targetId,y)))))))))}catch(h){if(!zn(h))throw h;U(Cb,"Failed to update sequence numbers: "+h)}for(const h of d){const f=h.targetId;if(!h.fromCache){const y=p.Ms.get(f),I=y.snapshotVersion,_=y.withLastLimboFreeSnapshotVersion(I);p.Ms=p.Ms.insert(f,_)}}})(n.localStore,r))}async function rv(t,e){const s=ae(t);if(!s.currentUser.isEqual(e)){U(ev,"User change. New user:",e.toKey());const n=await fm(s.localStore,e);s.currentUser=e,(function(r,a){r.mu.forEach((l=>{l.forEach((c=>{c.reject(new z(M.CANCELLED,a))}))})),r.mu.clear()})(s,"'waitForPendingWrites' promise is rejected due to a user change."),s.sharedClientState.handleUserChange(e,n.removedBatchIds,n.addedBatchIds),await Er(s,n.Ls)}}function av(t){const e=ae(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=nv.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=ov.bind(null,e),e}class er{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=yr(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,s){return null}Mu(e,s){return null}vu(e){return Ab(this.persistence,new kb,e.initialUser,this.serializer)}Cu(e){return new gm(Fi.mi,this.serializer)}Du(e){return new Lb}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}er.provider={build:()=>new er};class iv extends er{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,s){me(this.persistence.referenceDelegate instanceof Zo,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new ub(n,e.asyncQueue,s)}Cu(e){const s=this.cacheSizeBytes!==void 0?Fe.withCacheSize(this.cacheSizeBytes):Fe.DEFAULT;return new gm((n=>Zo.mi(n,s)),this.serializer)}}class Xa{async initialize(e,s){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(s),this.remoteStore=this.createRemoteStore(s),this.eventManager=this.createEventManager(s),this.syncEngine=this.createSyncEngine(s,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>gd(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=rv.bind(null,this.syncEngine),await Xb(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new Yb})()}createDatastore(e){const s=yr(e.databaseInfo.databaseId),n=(function(r){return new Vb(r)})(e.databaseInfo);return(function(r,a,l,c){return new jb(r,a,l,c)})(e.authCredentials,e.appCheckCredentials,n,s)}createRemoteStore(e){return(function(n,o,r,a,l){return new Ub(n,o,r,a,l)})(this.localStore,this.datastore,e.asyncQueue,(s=>gd(this.syncEngine,s,0)),(function(){return cd.v()?new cd:new Rb})())}createSyncEngine(e,s){return(function(o,r,a,l,c,d,p){const h=new tv(o,r,a,l,c,d);return p&&(h.gu=!0),h})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,s)}async terminate(){await(async function(s){const n=ae(s);U(Gn,"RemoteStore shutting down."),n.Ea.add(5),await Kn(n),n.Aa.shutdown(),n.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}Xa.provider={build:()=>new Xa};const Bt="FirestoreClient";class lv{constructor(e,s,n,o,r){this.authCredentials=e,this.appCheckCredentials=s,this.asyncQueue=n,this.databaseInfo=o,this.user=Ve.UNAUTHENTICATED,this.clientId=Si.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=r,this.authCredentials.start(n,(async a=>{U(Bt,"Received user=",a.uid),await this.authCredentialListener(a),this.user=a})),this.appCheckCredentials.start(n,(a=>(U(Bt,"Received new app check token=",a),this.appCheckCredentialListener(a,this.user))))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new es;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(s){const n=Em(s,"Failed to shutdown persistence");e.reject(n)}})),e.promise}}async function ba(t,e){t.asyncQueue.verifyOperationInProgress(),U(Bt,"Initializing OfflineComponentProvider");const s=t.configuration;await e.initialize(s);let n=s.initialUser;t.setCredentialChangeListener((async o=>{n.isEqual(o)||(await fm(e.localStore,o),n=o)})),e.persistence.setDatabaseDeletedListener((()=>t.terminate())),t._offlineComponents=e}async function fd(t,e){t.asyncQueue.verifyOperationInProgress();const s=await cv(t);U(Bt,"Initializing OnlineComponentProvider"),await e.initialize(s,t.configuration),t.setCredentialChangeListener((n=>ud(e.remoteStore,n))),t.setAppCheckTokenChangeListener(((n,o)=>ud(e.remoteStore,o))),t._onlineComponents=e}async function cv(t){if(!t._offlineComponents)if(t._uninitializedComponentsProvider){U(Bt,"Using user provided OfflineComponentProvider");try{await ba(t,t._uninitializedComponentsProvider._offline)}catch(e){const s=e;if(!(function(o){return o.name==="FirebaseError"?o.code===M.FAILED_PRECONDITION||o.code===M.UNIMPLEMENTED:!(typeof DOMException<"u"&&o instanceof DOMException)||o.code===22||o.code===20||o.code===11})(s))throw s;Ei("Error using user provided cache. Falling back to memory cache: "+s),await ba(t,new er)}}else U(Bt,"Using default OfflineComponentProvider"),await ba(t,new iv(void 0));return t._offlineComponents}async function dv(t){return t._onlineComponents||(t._uninitializedComponentsProvider?(U(Bt,"Using user provided OnlineComponentProvider"),await fd(t,t._uninitializedComponentsProvider._online)):(U(Bt,"Using default OnlineComponentProvider"),await fd(t,new Xa))),t._onlineComponents}function uv(t){return dv(t).then((e=>e.syncEngine))}function Tm(t){const e={};return t.timeoutSeconds!==void 0&&(e.timeoutSeconds=t.timeoutSeconds),e}const bd=new Map;const mv="firestore.googleapis.com",vd=!0;class yd{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new z(M.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=mv,this.ssl=vd}else this.host=e.host,this.ssl=e.ssl??vd;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=hm;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<cb)throw new z(M.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}Xf("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Tm(e.experimentalLongPollingOptions??{}),(function(n){if(n.timeoutSeconds!==void 0){if(isNaN(n.timeoutSeconds))throw new z(M.INVALID_ARGUMENT,`invalid long polling timeout: ${n.timeoutSeconds} (must not be NaN)`);if(n.timeoutSeconds<5)throw new z(M.INVALID_ARGUMENT,`invalid long polling timeout: ${n.timeoutSeconds} (minimum allowed value is 5)`);if(n.timeoutSeconds>30)throw new z(M.INVALID_ARGUMENT,`invalid long polling timeout: ${n.timeoutSeconds} (maximum allowed value is 30)`)}})(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&(function(n,o){return n.timeoutSeconds===o.timeoutSeconds})(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class km{constructor(e,s,n,o){this._authCredentials=e,this._appCheckCredentials=s,this._databaseId=n,this._app=o,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new yd({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new z(M.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new z(M.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new yd(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=(function(n){if(!n)return new qf;switch(n.type){case"firstParty":return new Uf(n.sessionIndex||"0",n.iamToken||null,n.authTokenFactory||null);case"provider":return n.client;default:throw new z(M.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}})(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return(function(s){const n=bd.get(s);n&&(U("ComponentProvider","Removing Datastore"),bd.delete(s),n.terminate())})(this),Promise.resolve()}}class ji{constructor(e,s,n){this.converter=s,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new ji(this.firestore,e,this._query)}}class Ie{constructor(e,s,n){this.converter=s,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Vn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Ie(this.firestore,e,this._key)}toJSON(){return{type:Ie._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,s,n){if(Un(s,Ie._jsonSchema))return new Ie(e,n||null,new X(pe.fromString(s.referencePath)))}}Ie._jsonSchemaVersion="firestore/documentReference/1.0",Ie._jsonSchema={type:ge("string",Ie._jsonSchemaVersion),referencePath:ge("string")};class Vn extends ji{constructor(e,s,n){super(e,s,S0(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Ie(this.firestore,null,new X(e))}withConverter(e){return new Vn(this.firestore,e,this._path)}}function pv(t,e,...s){if(t=yt(t),arguments.length===1&&(e=Si.newId()),Qf("doc","path",e),t instanceof km){const n=pe.fromString(e,...s);return qc(n),new Ie(t,null,new X(n))}{if(!(t instanceof Ie||t instanceof Vn))throw new z(M.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=t._path.child(pe.fromString(e,...s));return qc(n),new Ie(t.firestore,t instanceof Vn?t.converter:null,new X(n))}}const xd="AsyncQueue";class wd{constructor(e=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new bm(this,"async_queue_retry"),this._c=()=>{const n=fa();n&&U(xd,"Visibility state changed to "+n.visibilityState),this.M_.w_()},this.ac=e;const s=fa();s&&typeof s.addEventListener=="function"&&s.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const s=fa();s&&typeof s.removeEventListener=="function"&&s.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise((()=>{}));const s=new es;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(e().then(s.resolve,s.reject),s.promise))).then((()=>s.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.Xu.push(e),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(e){if(!zn(e))throw e;U(xd,"Operation failed with retryable error: "+e)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(e){const s=this.ac.then((()=>(this.rc=!0,e().catch((n=>{throw this.nc=n,this.rc=!1,is("INTERNAL UNHANDLED ERROR: ",Ed(n)),n})).then((n=>(this.rc=!1,n))))));return this.ac=s,s}enqueueAfterDelay(e,s,n){this.uc(),this.oc.indexOf(e)>-1&&(s=0);const o=qi.createAndSchedule(this,e,s,n,(r=>this.hc(r)));return this.tc.push(o),o}uc(){this.nc&&Y(47125,{Pc:Ed(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ic(e){for(const s of this.tc)if(s.timerId===e)return!0;return!1}Ec(e){return this.Tc().then((()=>{this.tc.sort(((s,n)=>s.targetTimeMs-n.targetTimeMs));for(const s of this.tc)if(s.skipDelay(),e!=="all"&&s.timerId===e)break;return this.Tc()}))}dc(e){this.oc.push(e)}hc(e){const s=this.tc.indexOf(e);this.tc.splice(s,1)}}function Ed(t){let e=t.message||"";return t.stack&&(e=t.stack.includes(t.message)?t.stack:t.message+`
`+t.stack),e}class Hi extends km{constructor(e,s,n,o){super(e,s,n,o),this.type="firestore",this._queue=new wd,this._persistenceKey=o?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new wd(e),this._firestoreClient=void 0,await e}}}function hv(t){if(t._terminated)throw new z(M.FAILED_PRECONDITION,"The client has already been terminated.");return t._firestoreClient||gv(t),t._firestoreClient}function gv(t){const e=t._freezeSettings(),s=(function(o,r,a,l){return new c0(o,r,a,l.host,l.ssl,l.experimentalForceLongPolling,l.experimentalAutoDetectLongPolling,Tm(l.experimentalLongPollingOptions),l.useFetchStreams,l.isUsingEmulator)})(t._databaseId,t._app?.options.appId||"",t._persistenceKey,e);t._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(t._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),t._firestoreClient=new lv(t._authCredentials,t._appCheckCredentials,t._queue,s,t._componentsProvider&&(function(o){const r=o?._online.build();return{_offline:o?._offline.build(r),_online:r}})(t._componentsProvider))}class Qe{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Qe(at.fromBase64String(e))}catch(s){throw new z(M.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+s)}}static fromUint8Array(e){return new Qe(at.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Qe._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Un(e,Qe._jsonSchema))return Qe.fromBase64String(e.bytes)}}Qe._jsonSchemaVersion="firestore/bytes/1.0",Qe._jsonSchema={type:ge("string",Qe._jsonSchemaVersion),bytes:ge("string")};class Ir{constructor(...e){for(let s=0;s<e.length;++s)if(e[s].length===0)throw new z(M.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ee(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}class Sr{constructor(e){this._methodName=e}}class ft{constructor(e,s){if(!isFinite(e)||e<-90||e>90)throw new z(M.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(s)||s<-180||s>180)throw new z(M.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+s);this._lat=e,this._long=s}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return se(this._lat,e._lat)||se(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:ft._jsonSchemaVersion}}static fromJSON(e){if(Un(e,ft._jsonSchema))return new ft(e.latitude,e.longitude)}}ft._jsonSchemaVersion="firestore/geoPoint/1.0",ft._jsonSchema={type:ge("string",ft._jsonSchemaVersion),latitude:ge("number"),longitude:ge("number")};class bt{constructor(e){this._values=(e||[]).map((s=>s))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(n,o){if(n.length!==o.length)return!1;for(let r=0;r<n.length;++r)if(n[r]!==o[r])return!1;return!0})(this._values,e._values)}toJSON(){return{type:bt._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Un(e,bt._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((s=>typeof s=="number")))return new bt(e.vectorValues);throw new z(M.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}bt._jsonSchemaVersion="firestore/vectorValue/1.0",bt._jsonSchema={type:ge("string",bt._jsonSchemaVersion),vectorValues:ge("object")};const fv=/^__.*__$/;class bv{constructor(e,s,n){this.data=e,this.fieldMask=s,this.fieldTransforms=n}toMutation(e,s){return this.fieldMask!==null?new Ft(e,this.data,this.fieldMask,s,this.fieldTransforms):new Wn(e,this.data,s,this.fieldTransforms)}}class Cm{constructor(e,s,n){this.data=e,this.fieldMask=s,this.fieldTransforms=n}toMutation(e,s){return new Ft(e,this.data,this.fieldMask,s,this.fieldTransforms)}}function _m(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Y(40011,{Ac:t})}}class Tr{constructor(e,s,n,o,r,a){this.settings=e,this.databaseId=s,this.serializer=n,this.ignoreUndefinedProperties=o,r===void 0&&this.Rc(),this.fieldTransforms=r||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new Tr({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){const s=this.path?.child(e),n=this.Vc({path:s,fc:!1});return n.gc(e),n}yc(e){const s=this.path?.child(e),n=this.Vc({path:s,fc:!1});return n.Rc(),n}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return tr(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return this.fieldMask.find((s=>e.isPrefixOf(s)))!==void 0||this.fieldTransforms.find((s=>e.isPrefixOf(s.field)))!==void 0}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(e.length===0)throw this.Sc("Document fields must not be empty");if(_m(this.Ac)&&fv.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class vv{constructor(e,s,n){this.databaseId=e,this.ignoreUndefinedProperties=s,this.serializer=n||yr(e)}Cc(e,s,n,o=!1){return new Tr({Ac:e,methodName:s,Dc:n,path:Ee.emptyPath(),fc:!1,bc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Am(t){const e=t._freezeSettings(),s=yr(t._databaseId);return new vv(t._databaseId,!!e.ignoreUndefinedProperties,s)}function yv(t,e,s,n,o,r={}){const a=t.Cc(r.merge||r.mergeFields?2:0,e,s,o);zi("Data must be an object, but it was:",a,n);const l=Pm(n,a);let c,d;if(r.merge)c=new We(a.fieldMask),d=a.fieldTransforms;else if(r.mergeFields){const p=[];for(const h of r.mergeFields){const f=Ya(e,h,s);if(!a.contains(f))throw new z(M.INVALID_ARGUMENT,`Field '${f}' is specified in your field mask but missing from your input data.`);Dm(p,f)||p.push(f)}c=new We(p),d=a.fieldTransforms.filter((h=>c.covers(h.field)))}else c=null,d=a.fieldTransforms;return new bv(new Ue(l),c,d)}class kr extends Sr{_toFieldTransform(e){if(e.Ac!==2)throw e.Ac===1?e.Sc(`${this._methodName}() can only appear at the top level of your update data`):e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof kr}}function xv(t,e,s){return new Tr({Ac:3,Dc:e.settings.Dc,methodName:t._methodName,fc:s},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class Ui extends Sr{constructor(e,s){super(e),this.vc=s}_toFieldTransform(e){const s=xv(this,e,!0),n=this.vc.map((r=>Qn(r,s))),o=new Vs(n);return new B0(e.path,o)}isEqual(e){return e instanceof Ui&&Su(this.vc,e.vc)}}function wv(t,e,s,n){const o=t.Cc(1,e,s);zi("Data must be an object, but it was:",o,n);const r=[],a=Ue.empty();gs(n,((c,d)=>{const p=Wi(e,c,s);d=yt(d);const h=o.yc(p);if(d instanceof kr)r.push(p);else{const f=Qn(d,h);f!=null&&(r.push(p),a.set(p,f))}}));const l=new We(r);return new Cm(a,l,o.fieldTransforms)}function Ev(t,e,s,n,o,r){const a=t.Cc(1,e,s),l=[Ya(e,n,s)],c=[o];if(r.length%2!=0)throw new z(M.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let f=0;f<r.length;f+=2)l.push(Ya(e,r[f])),c.push(r[f+1]);const d=[],p=Ue.empty();for(let f=l.length-1;f>=0;--f)if(!Dm(d,l[f])){const y=l[f];let I=c[f];I=yt(I);const _=a.yc(y);if(I instanceof kr)d.push(y);else{const D=Qn(I,_);D!=null&&(d.push(y),p.set(y,D))}}const h=new We(d);return new Cm(p,h,a.fieldTransforms)}function Qn(t,e){if($m(t=yt(t)))return zi("Unsupported field value:",e,t),Pm(t,e);if(t instanceof Sr)return(function(n,o){if(!_m(o.Ac))throw o.Sc(`${n._methodName}() can only be used with update() and set()`);if(!o.path)throw o.Sc(`${n._methodName}() is not currently supported inside arrays`);const r=n._toFieldTransform(o);r&&o.fieldTransforms.push(r)})(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.fc&&e.Ac!==4)throw e.Sc("Nested arrays are not supported");return(function(n,o){const r=[];let a=0;for(const l of n){let c=Qn(l,o.wc(a));c==null&&(c={nullValue:"NULL_VALUE"}),r.push(c),a++}return{arrayValue:{values:r}}})(t,e)}return(function(n,o){if((n=yt(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return R0(o.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const r=de.fromDate(n);return{timestampValue:Ga(o.serializer,r)}}if(n instanceof de){const r=new de(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:Ga(o.serializer,r)}}if(n instanceof ft)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof Qe)return{bytesValue:K0(o.serializer,n._byteString)};if(n instanceof Ie){const r=o.databaseId,a=n.firestore._databaseId;if(!a.isEqual(r))throw o.Sc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:mm(n.firestore._databaseId||o.databaseId,n._key.path)}}if(n instanceof bt)return(function(a,l){return{mapValue:{fields:{[Uu]:{stringValue:zu},[ja]:{arrayValue:{values:a.toArray().map((d=>{if(typeof d!="number")throw l.Sc("VectorValues must only contain numeric values.");return Ni(l.serializer,d)}))}}}}}})(n,o);throw o.Sc(`Unsupported field value: ${Ti(n)}`)})(t,e)}function Pm(t,e){const s={};return Fu(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):gs(t,((n,o)=>{const r=Qn(o,e.mc(n));r!=null&&(s[n]=r)})),{mapValue:{fields:s}}}function $m(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof de||t instanceof ft||t instanceof Qe||t instanceof Ie||t instanceof Sr||t instanceof bt)}function zi(t,e,s){if(!$m(s)||!Bu(s)){const n=Ti(s);throw n==="an object"?e.Sc(t+" a custom object"):e.Sc(t+" "+n)}}function Ya(t,e,s){if((e=yt(e))instanceof Ir)return e._internalPath;if(typeof e=="string")return Wi(t,e);throw tr("Field path arguments must be of type string or ",t,!1,void 0,s)}const Iv=new RegExp("[~\\*/\\[\\]]");function Wi(t,e,s){if(e.search(Iv)>=0)throw tr(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,s);try{return new Ir(...e.split("."))._internalPath}catch{throw tr(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,s)}}function tr(t,e,s,n,o){const r=n&&!n.isEmpty(),a=o!==void 0;let l=`Function ${e}() called with invalid data`;s&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(r||a)&&(c+=" (found",r&&(c+=` in field ${n}`),a&&(c+=` in document ${o}`),c+=")"),new z(M.INVALID_ARGUMENT,l+t+c)}function Dm(t,e){return t.some((s=>s.isEqual(e)))}class Lm{constructor(e,s,n,o,r){this._firestore=e,this._userDataWriter=s,this._key=n,this._document=o,this._converter=r}get id(){return this._key.path.lastSegment()}get ref(){return new Ie(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new Sv(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const s=this._document.data.field(Rm("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s)}}}class Sv extends Lm{data(){return super.data()}}function Rm(t,e){return typeof e=="string"?Wi(t,e):e instanceof Ir?e._internalPath:e._delegate._internalPath}function Tv(t,e,s){let n;return n=t?s&&(s.merge||s.mergeFields)?t.toFirestore(e,s):t.toFirestore(e):e,n}class wo{constructor(e,s){this.hasPendingWrites=e,this.fromCache=s}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class As extends Lm{constructor(e,s,n,o,r,a){super(e,s,n,o,a),this._firestore=e,this._firestoreImpl=e,this.metadata=r}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const s=new Fo(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(s,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,s={}){if(this._document){const n=this._document.data.field(Rm("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n,s.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new z(M.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,s={};return s.type=As._jsonSchemaVersion,s.bundle="",s.bundleSource="DocumentSnapshot",s.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?s:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),s.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),s)}}As._jsonSchemaVersion="firestore/documentSnapshot/1.0",As._jsonSchema={type:ge("string",As._jsonSchemaVersion),bundleSource:ge("string","DocumentSnapshot"),bundleName:ge("string"),bundle:ge("string")};class Fo extends As{data(e={}){return super.data(e)}}class En{constructor(e,s,n,o){this._firestore=e,this._userDataWriter=s,this._snapshot=o,this.metadata=new wo(o.hasPendingWrites,o.fromCache),this.query=n}get docs(){const e=[];return this.forEach((s=>e.push(s))),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,s){this._snapshot.docs.forEach((n=>{e.call(s,new Fo(this._firestore,this._userDataWriter,n.key,n,new wo(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const s=!!e.includeMetadataChanges;if(s&&this._snapshot.excludesMetadataChanges)throw new z(M.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===s||(this._cachedChanges=(function(o,r){if(o._snapshot.oldDocs.isEmpty()){let a=0;return o._snapshot.docChanges.map((l=>{const c=new Fo(o._firestore,o._userDataWriter,l.doc.key,l.doc,new wo(o._snapshot.mutatedKeys.has(l.doc.key),o._snapshot.fromCache),o.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:a++}}))}{let a=o._snapshot.oldDocs;return o._snapshot.docChanges.filter((l=>r||l.type!==3)).map((l=>{const c=new Fo(o._firestore,o._userDataWriter,l.doc.key,l.doc,new wo(o._snapshot.mutatedKeys.has(l.doc.key),o._snapshot.fromCache),o.query.converter);let d=-1,p=-1;return l.type!==0&&(d=a.indexOf(l.doc.key),a=a.delete(l.doc.key)),l.type!==1&&(a=a.add(l.doc),p=a.indexOf(l.doc.key)),{type:kv(l.type),doc:c,oldIndex:d,newIndex:p}}))}})(this,s),this._cachedChangesIncludeMetadataChanges=s),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new z(M.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=En._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=Si.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const s=[],n=[],o=[];return this.docs.forEach((r=>{r._document!==null&&(s.push(r._document),n.push(this._userDataWriter.convertObjectMap(r._document.data.value.mapValue.fields,"previous")),o.push(r.ref.path))})),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function kv(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Y(61501,{type:t})}}En._jsonSchemaVersion="firestore/querySnapshot/1.0",En._jsonSchema={type:ge("string",En._jsonSchemaVersion),bundleSource:ge("string","QuerySnapshot"),bundleName:ge("string"),bundle:ge("string")};function Cv(t,e,s){t=Uo(t,Ie);const n=Uo(t.firestore,Hi),o=Tv(t.converter,e,s);return Mm(n,[yv(Am(n),"setDoc",t._key,o,t.converter!==null,s).toMutation(t._key,rt.none())])}function _v(t,e,s,...n){t=Uo(t,Ie);const o=Uo(t.firestore,Hi),r=Am(o);let a;return a=typeof(e=yt(e))=="string"||e instanceof Ir?Ev(r,"updateDoc",t._key,e,s,n):wv(r,"updateDoc",t._key,e),Mm(o,[a.toMutation(t._key,rt.exists(!0))])}function Mm(t,e){return(function(n,o){const r=new es;return n.asyncQueue.enqueueAndForget((async()=>sv(await uv(n),o,r))),r.promise})(hv(t),e)}function Av(...t){return new Ui("arrayUnion",t)}(function(e,s=!0){(function(o){Hs=o})(Af),Lt(new Dt("firestore",((n,{instanceIdentifier:o,options:r})=>{const a=n.getProvider("app").getImmediate(),l=new Hi(new jf(n.getProvider("auth-internal")),new zf(a,n.getProvider("app-check-internal")),(function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new z(M.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Go(d.options.projectId,p)})(a,o),a);return r={useFetchStreams:s,...r},l._setSettings(r),l}),"PUBLIC").setMultipleInstances(!0)),gt(Bc,Vc,e),gt(Bc,Vc,"esm2020")})();const Nm="@firebase/installations",Gi="0.6.19";const Bm=1e4,Vm=`w:${Gi}`,Fm="FIS_v2",Pv="https://firebaseinstallations.googleapis.com/v1",$v=3600*1e3,Dv="installations",Lv="Installations";const Rv={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},ds=new hr(Dv,Lv,Rv);function Om(t){return t instanceof hs&&t.code.includes("request-failed")}function qm({projectId:t}){return`${Pv}/projects/${t}/installations`}function jm(t){return{token:t.token,requestStatus:2,expiresIn:Nv(t.expiresIn),creationTime:Date.now()}}async function Hm(t,e){const n=(await e.json()).error;return ds.create("request-failed",{requestName:t,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function Um({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function Mv(t,{refreshToken:e}){const s=Um(t);return s.append("Authorization",Bv(e)),s}async function zm(t){const e=await t();return e.status>=500&&e.status<600?t():e}function Nv(t){return Number(t.replace("s","000"))}function Bv(t){return`${Fm} ${t}`}async function Vv({appConfig:t,heartbeatServiceProvider:e},{fid:s}){const n=qm(t),o=Um(t),r=e.getImmediate({optional:!0});if(r){const d=await r.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const a={fid:s,authVersion:Fm,appId:t.appId,sdkVersion:Vm},l={method:"POST",headers:o,body:JSON.stringify(a)},c=await zm(()=>fetch(n,l));if(c.ok){const d=await c.json();return{fid:d.fid||s,registrationStatus:2,refreshToken:d.refreshToken,authToken:jm(d.authToken)}}else throw await Hm("Create Installation",c)}function Wm(t){return new Promise(e=>{setTimeout(e,t)})}function Fv(t){return btoa(String.fromCharCode(...t)).replace(/\+/g,"-").replace(/\//g,"_")}const Ov=/^[cdef][\w-]{21}$/,Za="";function qv(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const s=jv(t);return Ov.test(s)?s:Za}catch{return Za}}function jv(t){return Fv(t).substr(0,22)}function Cr(t){return`${t.appName}!${t.appId}`}const Gm=new Map;function Km(t,e){const s=Cr(t);Jm(s,e),Hv(s,e)}function Jm(t,e){const s=Gm.get(t);if(s)for(const n of s)n(e)}function Hv(t,e){const s=Uv();s&&s.postMessage({key:t,fid:e}),zv()}let Yt=null;function Uv(){return!Yt&&"BroadcastChannel"in self&&(Yt=new BroadcastChannel("[Firebase] FID Change"),Yt.onmessage=t=>{Jm(t.data.key,t.data.fid)}),Yt}function zv(){Gm.size===0&&Yt&&(Yt.close(),Yt=null)}const Wv="firebase-installations-database",Gv=1,us="firebase-installations-store";let va=null;function Ki(){return va||(va=gr(Wv,Gv,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(us)}}})),va}async function sr(t,e){const s=Cr(t),o=(await Ki()).transaction(us,"readwrite"),r=o.objectStore(us),a=await r.get(s);return await r.put(e,s),await o.done,(!a||a.fid!==e.fid)&&Km(t,e.fid),e}async function Qm(t){const e=Cr(t),n=(await Ki()).transaction(us,"readwrite");await n.objectStore(us).delete(e),await n.done}async function _r(t,e){const s=Cr(t),o=(await Ki()).transaction(us,"readwrite"),r=o.objectStore(us),a=await r.get(s),l=e(a);return l===void 0?await r.delete(s):await r.put(l,s),await o.done,l&&(!a||a.fid!==l.fid)&&Km(t,l.fid),l}async function Ji(t){let e;const s=await _r(t.appConfig,n=>{const o=Kv(n),r=Jv(t,o);return e=r.registrationPromise,r.installationEntry});return s.fid===Za?{installationEntry:await e}:{installationEntry:s,registrationPromise:e}}function Kv(t){const e=t||{fid:qv(),registrationStatus:0};return Xm(e)}function Jv(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(ds.create("app-offline"));return{installationEntry:e,registrationPromise:o}}const s={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},n=Qv(t,s);return{installationEntry:s,registrationPromise:n}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:Xv(t)}:{installationEntry:e}}async function Qv(t,e){try{const s=await Vv(t,e);return sr(t.appConfig,s)}catch(s){throw Om(s)&&s.customData.serverCode===409?await Qm(t.appConfig):await sr(t.appConfig,{fid:e.fid,registrationStatus:0}),s}}async function Xv(t){let e=await Id(t.appConfig);for(;e.registrationStatus===1;)await Wm(100),e=await Id(t.appConfig);if(e.registrationStatus===0){const{installationEntry:s,registrationPromise:n}=await Ji(t);return n||s}return e}function Id(t){return _r(t,e=>{if(!e)throw ds.create("installation-not-found");return Xm(e)})}function Xm(t){return Yv(t)?{fid:t.fid,registrationStatus:0}:t}function Yv(t){return t.registrationStatus===1&&t.registrationTime+Bm<Date.now()}async function Zv({appConfig:t,heartbeatServiceProvider:e},s){const n=ey(t,s),o=Mv(t,s),r=e.getImmediate({optional:!0});if(r){const d=await r.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const a={installation:{sdkVersion:Vm,appId:t.appId}},l={method:"POST",headers:o,body:JSON.stringify(a)},c=await zm(()=>fetch(n,l));if(c.ok){const d=await c.json();return jm(d)}else throw await Hm("Generate Auth Token",c)}function ey(t,{fid:e}){return`${qm(t)}/${e}/authTokens:generate`}async function Qi(t,e=!1){let s;const n=await _r(t.appConfig,r=>{if(!Ym(r))throw ds.create("not-registered");const a=r.authToken;if(!e&&ny(a))return r;if(a.requestStatus===1)return s=ty(t,e),r;{if(!navigator.onLine)throw ds.create("app-offline");const l=ry(r);return s=sy(t,l),l}});return s?await s:n.authToken}async function ty(t,e){let s=await Sd(t.appConfig);for(;s.authToken.requestStatus===1;)await Wm(100),s=await Sd(t.appConfig);const n=s.authToken;return n.requestStatus===0?Qi(t,e):n}function Sd(t){return _r(t,e=>{if(!Ym(e))throw ds.create("not-registered");const s=e.authToken;return ay(s)?{...e,authToken:{requestStatus:0}}:e})}async function sy(t,e){try{const s=await Zv(t,e),n={...e,authToken:s};return await sr(t.appConfig,n),s}catch(s){if(Om(s)&&(s.customData.serverCode===401||s.customData.serverCode===404))await Qm(t.appConfig);else{const n={...e,authToken:{requestStatus:0}};await sr(t.appConfig,n)}throw s}}function Ym(t){return t!==void 0&&t.registrationStatus===2}function ny(t){return t.requestStatus===2&&!oy(t)}function oy(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+$v}function ry(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function ay(t){return t.requestStatus===1&&t.requestTime+Bm<Date.now()}async function iy(t){const e=t,{installationEntry:s,registrationPromise:n}=await Ji(e);return n?n.catch(console.error):Qi(e).catch(console.error),s.fid}async function ly(t,e=!1){const s=t;return await cy(s),(await Qi(s,e)).token}async function cy(t){const{registrationPromise:e}=await Ji(t);e&&await e}function dy(t){if(!t||!t.options)throw ya("App Configuration");if(!t.name)throw ya("App Name");const e=["projectId","apiKey","appId"];for(const s of e)if(!t.options[s])throw ya(s);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function ya(t){return ds.create("missing-app-config-values",{valueName:t})}const Zm="installations",uy="installations-internal",my=t=>{const e=t.getProvider("app").getImmediate(),s=dy(e),n=_u(e,"heartbeat");return{app:e,appConfig:s,heartbeatServiceProvider:n,_delete:()=>Promise.resolve()}},py=t=>{const e=t.getProvider("app").getImmediate(),s=_u(e,Zm).getImmediate();return{getId:()=>iy(s),getToken:o=>ly(s,o)}};function hy(){Lt(new Dt(Zm,my,"PUBLIC")),Lt(new Dt(uy,py,"PRIVATE"))}hy();gt(Nm,Gi);gt(Nm,Gi,"esm2020");const gy="/firebase-messaging-sw.js",fy="/firebase-cloud-messaging-push-scope",ep="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",by="https://fcmregistrations.googleapis.com/v1",tp="google.c.a.c_id",vy="google.c.a.c_l",yy="google.c.a.ts",xy="google.c.a.e",Td=1e4;var kd;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(kd||(kd={}));var Fn;(function(t){t.PUSH_RECEIVED="push-received",t.NOTIFICATION_CLICKED="notification-clicked"})(Fn||(Fn={}));function ct(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function wy(t){const e="=".repeat((4-t.length%4)%4),s=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),n=atob(s),o=new Uint8Array(n.length);for(let r=0;r<n.length;++r)o[r]=n.charCodeAt(r);return o}const xa="fcm_token_details_db",Ey=5,Cd="fcm_token_object_Store";async function Iy(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(xa))return null;let e=null;return(await gr(xa,Ey,{upgrade:async(n,o,r,a)=>{if(o<2||!n.objectStoreNames.contains(Cd))return;const l=a.objectStore(Cd),c=await l.index("fcmSenderId").get(t);if(await l.clear(),!!c){if(o===2){const d=c;if(!d.auth||!d.p256dh||!d.endpoint)return;e={token:d.fcmToken,createTime:d.createTime??Date.now(),subscriptionOptions:{auth:d.auth,p256dh:d.p256dh,endpoint:d.endpoint,swScope:d.swScope,vapidKey:typeof d.vapidKey=="string"?d.vapidKey:ct(d.vapidKey)}}}else if(o===3){const d=c;e={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:ct(d.auth),p256dh:ct(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:ct(d.vapidKey)}}}else if(o===4){const d=c;e={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:ct(d.auth),p256dh:ct(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:ct(d.vapidKey)}}}}}})).close(),await ua(xa),await ua("fcm_vapid_details_db"),await ua("undefined"),Sy(e)?e:null}function Sy(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}const Ty="firebase-messaging-database",ky=1,On="firebase-messaging-store";let wa=null;function sp(){return wa||(wa=gr(Ty,ky,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(On)}}})),wa}async function Cy(t){const e=np(t),n=await(await sp()).transaction(On).objectStore(On).get(e);if(n)return n;{const o=await Iy(t.appConfig.senderId);if(o)return await Xi(t,o),o}}async function Xi(t,e){const s=np(t),o=(await sp()).transaction(On,"readwrite");return await o.objectStore(On).put(e,s),await o.done,e}function np({appConfig:t}){return t.appId}const _y={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"only-available-in-window":"This method is available in a Window context.","only-available-in-sw":"This method is available in a service worker context.","permission-default":"The notification permission was not granted and dismissed instead.","permission-blocked":"The notification permission was not granted and blocked instead.","unsupported-browser":"This browser doesn't support the API's required to use the Firebase SDK.","indexed-db-unsupported":"This browser doesn't support indexedDb.open() (ex. Safari iFrame, Firefox Private Browsing, etc)","failed-service-worker-registration":"We are unable to register the default service worker. {$browserErrorMessage}","token-subscribe-failed":"A problem occurred while subscribing the user to FCM: {$errorInfo}","token-subscribe-no-token":"FCM returned no token when subscribing the user to push.","token-unsubscribe-failed":"A problem occurred while unsubscribing the user from FCM: {$errorInfo}","token-update-failed":"A problem occurred while updating the user from FCM: {$errorInfo}","token-update-no-token":"FCM returned no token when updating the user to push.","use-sw-after-get-token":"The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.","invalid-sw-registration":"The input to useServiceWorker() must be a ServiceWorkerRegistration.","invalid-bg-handler":"The input to setBackgroundMessageHandler() must be a function.","invalid-vapid-key":"The public VAPID key must be a string.","use-vapid-key-after-get-token":"The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."},qe=new hr("messaging","Messaging",_y);async function Ay(t,e){const s=await Zi(t),n=op(e),o={method:"POST",headers:s,body:JSON.stringify(n)};let r;try{r=await(await fetch(Yi(t.appConfig),o)).json()}catch(a){throw qe.create("token-subscribe-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw qe.create("token-subscribe-failed",{errorInfo:a})}if(!r.token)throw qe.create("token-subscribe-no-token");return r.token}async function Py(t,e){const s=await Zi(t),n=op(e.subscriptionOptions),o={method:"PATCH",headers:s,body:JSON.stringify(n)};let r;try{r=await(await fetch(`${Yi(t.appConfig)}/${e.token}`,o)).json()}catch(a){throw qe.create("token-update-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw qe.create("token-update-failed",{errorInfo:a})}if(!r.token)throw qe.create("token-update-no-token");return r.token}async function $y(t,e){const n={method:"DELETE",headers:await Zi(t)};try{const r=await(await fetch(`${Yi(t.appConfig)}/${e}`,n)).json();if(r.error){const a=r.error.message;throw qe.create("token-unsubscribe-failed",{errorInfo:a})}}catch(o){throw qe.create("token-unsubscribe-failed",{errorInfo:o?.toString()})}}function Yi({projectId:t}){return`${by}/projects/${t}/registrations`}async function Zi({appConfig:t,installations:e}){const s=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":`FIS ${s}`})}function op({p256dh:t,auth:e,endpoint:s,vapidKey:n}){const o={web:{endpoint:s,auth:e,p256dh:t}};return n!==ep&&(o.web.applicationPubKey=n),o}const Dy=10080*60*1e3;async function Ly(t){const e=await My(t.swRegistration,t.vapidKey),s={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:ct(e.getKey("auth")),p256dh:ct(e.getKey("p256dh"))},n=await Cy(t.firebaseDependencies);if(n){if(Ny(n.subscriptionOptions,s))return Date.now()>=n.createTime+Dy?Ry(t,{token:n.token,createTime:Date.now(),subscriptionOptions:s}):n.token;try{await $y(t.firebaseDependencies,n.token)}catch(o){console.warn(o)}return _d(t.firebaseDependencies,s)}else return _d(t.firebaseDependencies,s)}async function Ry(t,e){try{const s=await Py(t.firebaseDependencies,e),n={...e,token:s,createTime:Date.now()};return await Xi(t.firebaseDependencies,n),s}catch(s){throw s}}async function _d(t,e){const n={token:await Ay(t,e),createTime:Date.now(),subscriptionOptions:e};return await Xi(t,n),n.token}async function My(t,e){const s=await t.pushManager.getSubscription();return s||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:wy(e)})}function Ny(t,e){const s=e.vapidKey===t.vapidKey,n=e.endpoint===t.endpoint,o=e.auth===t.auth,r=e.p256dh===t.p256dh;return s&&n&&o&&r}function Ad(t){const e={from:t.from,collapseKey:t.collapse_key,messageId:t.fcmMessageId};return By(e,t),Vy(e,t),Fy(e,t),e}function By(t,e){if(!e.notification)return;t.notification={};const s=e.notification.title;s&&(t.notification.title=s);const n=e.notification.body;n&&(t.notification.body=n);const o=e.notification.image;o&&(t.notification.image=o);const r=e.notification.icon;r&&(t.notification.icon=r)}function Vy(t,e){e.data&&(t.data=e.data)}function Fy(t,e){if(!e.fcmOptions&&!e.notification?.click_action)return;t.fcmOptions={};const s=e.fcmOptions?.link??e.notification?.click_action;s&&(t.fcmOptions.link=s);const n=e.fcmOptions?.analytics_label;n&&(t.fcmOptions.analyticsLabel=n)}function Oy(t){return typeof t=="object"&&!!t&&tp in t}function qy(t){if(!t||!t.options)throw Ea("App Configuration Object");if(!t.name)throw Ea("App Name");const e=["projectId","apiKey","appId","messagingSenderId"],{options:s}=t;for(const n of e)if(!s[n])throw Ea(n);return{appName:t.name,projectId:s.projectId,apiKey:s.apiKey,appId:s.appId,senderId:s.messagingSenderId}}function Ea(t){return qe.create("missing-app-config-values",{valueName:t})}class jy{constructor(e,s,n){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const o=qy(e);this.firebaseDependencies={app:e,appConfig:o,installations:s,analyticsProvider:n}}_delete(){return Promise.resolve()}}async function Hy(t){try{t.swRegistration=await navigator.serviceWorker.register(gy,{scope:fy}),t.swRegistration.update().catch(()=>{}),await Uy(t.swRegistration)}catch(e){throw qe.create("failed-service-worker-registration",{browserErrorMessage:e?.message})}}async function Uy(t){return new Promise((e,s)=>{const n=setTimeout(()=>s(new Error(`Service worker not registered after ${Td} ms`)),Td),o=t.installing||t.waiting;t.active?(clearTimeout(n),e()):o?o.onstatechange=r=>{r.target?.state==="activated"&&(o.onstatechange=null,clearTimeout(n),e())}:(clearTimeout(n),s(new Error("No incoming service worker found.")))})}async function zy(t,e){if(!e&&!t.swRegistration&&await Hy(t),!(!e&&t.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw qe.create("invalid-sw-registration");t.swRegistration=e}}async function Wy(t,e){e?t.vapidKey=e:t.vapidKey||(t.vapidKey=ep)}async function rp(t,e){if(!navigator)throw qe.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw qe.create("permission-blocked");return await Wy(t,e?.vapidKey),await zy(t,e?.serviceWorkerRegistration),Ly(t)}async function Gy(t,e,s){const n=Ky(e);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(n,{message_id:s[tp],message_name:s[vy],message_time:s[yy],message_device_time:Math.floor(Date.now()/1e3)})}function Ky(t){switch(t){case Fn.NOTIFICATION_CLICKED:return"notification_open";case Fn.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}async function Jy(t,e){const s=e.data;if(!s.isFirebaseMessaging)return;t.onMessageHandler&&s.messageType===Fn.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(Ad(s)):t.onMessageHandler.next(Ad(s)));const n=s.data;Oy(n)&&n[xy]==="1"&&await Gy(t,s.messageType,n)}const Pd="@firebase/messaging",$d="0.12.23";const Qy=t=>{const e=new jy(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",s=>Jy(e,s)),e},Xy=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:n=>rp(e,n)}};function Yy(){Lt(new Dt("messaging",Qy,"PUBLIC")),Lt(new Dt("messaging-internal",Xy,"PRIVATE")),gt(Pd,$d),gt(Pd,$d,"esm2020")}function Zy(t,e){if(!navigator)throw qe.create("only-available-in-window");return t.onMessageHandler=e,()=>{t.onMessageHandler=null}}async function ex(t,e){return t=yt(t),rp(t,e)}function tx(t,e){return t=yt(t),Zy(t,e)}Yy();const sx="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Dd=!1;async function ap(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await Be.removeAllListeners(),await Be.addListener("registration",async s=>{ip(s.value,!0)}),await Be.addListener("pushNotificationReceived",s=>{});let e=await Be.checkPermissions();e.receive==="prompt"&&(e=await Be.requestPermissions()),e.receive==="granted"&&await Be.register()}catch(e){console.error(e)}return}"Notification"in window&&(Notification.permission==="granted"?nx():Notification.permission==="default"&&console.log("[Push Web] Aguardando interação do utilizador para pedir permissão (iOS Requirement)."))}async function nx(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js"),e=await ex(hc,{vapidKey:sx,serviceWorkerRegistration:t});e&&(console.log("[Push Web] Token:",e),await ip(e,!1)),Dd||(tx(hc,s=>{console.log("[Push Web] Foreground:",s),s.notification&&k(s.notification.title,s.notification.body,"info",!0)}),Dd=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}}async function ip(t,e){const s=_e.currentUser;if(s)try{const n=pv(Ae,"users",s.uid);try{await _v(n,{fcmTokens:Av(t),lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"})}catch(o){o.code==="not-found"&&await Cv(n,{email:s.email,fcmTokens:[t],platform:e?"android_native":"pwa_web"},{merge:!0})}}catch(n){console.error(n)}}const ox=(t,e,s="all",n="all")=>{const o=new URLSearchParams({startDate:t,endDate:e});return s&&s!=="all"&&o.append("professionalId",s),n&&n!=="all"&&o.append("costCenterId",n),F(`/api/reports/indicators?${o.toString()}`)},rx=t=>t?F(`/api/financial/cost-centers/${t}`):Promise.resolve([]),ax=({establishmentId:t,startDate:e,endDate:s,cashierSessionId:n})=>{const o=new URLSearchParams({startDate:e,endDate:s});return n&&n!=="all"&&o.append("cashierSessionId",n),t&&o.append("establishmentId",t),F(`/api/reports/sales?${o.toString()}`)},ix=()=>F("/api/reports/summary",{method:"GET"}),Ar=(t,e,s,n="all")=>{const o=`/api/blockages/${t}?startDate=${e}&endDate=${s}&professionalId=${n}`;return F(o)},Pr=t=>F("/api/blockages",{method:"POST",body:JSON.stringify(t)}),el=t=>F(`/api/blockages/${t}`,{method:"DELETE"}),lp=t=>F("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Xn=t=>t?String(t).replace(/\D/g,""):"",Us=(t,e="",s=null)=>{let n=`/api/clients/${t}`;const o=[];return e&&e.trim().length>0&&o.push(`search=${encodeURIComponent(e.trim())}`),s&&o.push(`limit=${s}`),o.length>0&&(n+=`?${o.join("&")}`),F(n)},cp=t=>{if(!t)throw new Error("ID do cliente é obrigatório");const e=Xn(t);return F(`/api/clients/id/${e}`)},nr=t=>{if(!t.phone)throw new Error("O telefone é obrigatório para criar o cliente.");const e=Xn(t.phone);return F(`/api/clients/${e}`,{method:"PUT",body:JSON.stringify(t)})},dp=(t,e)=>{const s=Xn(t);return F(`/api/clients/${s}`,{method:"PUT",body:JSON.stringify(e)})},lx=t=>{const e=Xn(t);return F(`/api/clients/${e}`,{method:"DELETE"})},Ld=(t,e,s)=>{const n=encodeURIComponent(e),o=encodeURIComponent(s),r=`/api/clients/history/${t}?clientName=${n}&clientPhone=${o}`;return F(r)},cx=(t,e,s)=>{const n=encodeURIComponent(e),o=encodeURIComponent(s),r=`/api/clients/loyalty-history/${t}?clientName=${n}&clientPhone=${o}`;return F(r)},dx=(t,e,s,n)=>F("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientName:e,clientPhone:s,rewardData:n})}),up=(t,e)=>{const s=Xn(e);return cp(s).catch(()=>null)};function A(t){return t==null?"":String(t).replace(/[&<>'"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[e])}function mp(t,e=800,s=800,n=.7){return new Promise((o,r)=>{if(!t.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const a=new FileReader;a.readAsDataURL(t),a.onload=l=>{const c=new Image;c.src=l.target.result,c.onload=()=>{let d=c.width,p=c.height;d>p?d>e&&(p*=e/d,d=e):p>s&&(d*=s/p,p=s);const h=document.createElement("canvas");h.width=d,h.height=p,h.getContext("2d").drawImage(c,0,0,d,p);const y=h.toDataURL("image/jpeg",n);o(y)},c.onerror=d=>r(new Error("Erro ao carregar a imagem para processamento."))},a.onerror=l=>r(new Error("Erro ao ler o ficheiro."))})}const Rd=document.getElementById("content");let Md=!1;const ei=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let Yn=[],$r=[],Os={},Ps=[],K={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},j={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function ux(t){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(t).replace(/\./g,"")}function pp(t){const e=new Date(t);if(e.setHours(0,0,0,0),K.currentView==="week"&&K.weekViewDays===7){const s=e.getDay(),n=e.getDate()-s+(s===0?-6:1);return new Date(e.setDate(n))}return e}function or(){const t=document.getElementById("profSelectorContainer"),e=K.profSearchTerm.toLowerCase();if(!t||!w.professionals)return;let s=w.professionals.filter(r=>K.showInactiveProfs||r.status!=="inactive");e&&(s=s.filter(r=>r.name.toLowerCase().includes(e)));const o=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...s];t.innerHTML=o.map(r=>{const a=K.selectedProfessionalId===r.id,l=r.name==="Todos"?"Todos":r.name.split(" ")[0],c=r.name==="Todos"?"T":r.name.charAt(0).toUpperCase(),d=r.status!=="inactive",p=A(l),h=ei[0],f=r.id!=="all"&&w.professionalColors.get(r.id)||h,y=r.photo||`https://placehold.co/64x64/${f.main?.replace("#","")||"E0E7FF"}/${f.light?.replace("#","")||"4F46E5"}?text=${c}`,I=r.id==="all"?"#e0e7ff":f.light,_=r.id==="all"?"#4f46e5":f.main,R=`border: 3px solid ${a?f.border:"transparent"}; box-shadow: ${a?"0 0 0 2px "+f.border:"none"};`;return`
        ...
        `}).join("")}function mx(t,e,s,n,o){const r=(t||"").replace(/\D/g,""),a=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),l=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),c=`Olá, ${e}! Você tem um agendamento de ${s} com o(a) profissional ${n} para o dia ${a} às ${l}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(c);return`https://wa.me/${r}?text=${d}`}function px(t){const e=document.getElementById("agenda-view");if(!e)return;if(t.sort((n,o)=>new Date(n.startTime)-new Date(o.startTime)),t.length===0){e.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const s=t.map(n=>{const o=new Date(n.startTime),r=new Date(n.endTime),a=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),c=w.professionalColors.get(n.professionalId)||{},d=A(n.reason),p=A(n.professionalName),h=A(n.clientName),f=A(n.serviceName);if(n.type==="blockage")return`
                ...
                </div>`;const y=n.status==="completed",I=y?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",_=y?"Finalizado":"Aberto",D=JSON.stringify(n).replace(/'/g,"&apos;"),R=n.redeemedReward?.points>0,O=n.hasRewards&&!R,N=mx(n.clientPhone,n.clientName,n.serviceName,n.professionalName,n.startTime);return`
        ...
        `}r+="</div>",e.innerHTML=r}function gx(){const t=w.allEvents.filter(e=>K.selectedProfessionalId==="all"||e.professionalId===K.selectedProfessionalId);K.currentView==="list"?px(t):hx(t)}async function lt(){const t=document.getElementById("agenda-view");if(!t)return;t.innerHTML='<div class="loader mx-auto my-10"></div>';let e,s;const n=document.getElementById("weekRange");if(n){if(K.currentView==="list")e=new Date(K.currentDate),e.setHours(0,0,0,0),s=new Date(K.currentDate),s.setHours(23,59,59,999),n.textContent=ux(e);else{const o=tl();e=pp(new Date(K.currentDate)),s=new Date(e),s.setDate(e.getDate()+(o-1)),s.setHours(23,59,59,999),n.textContent=`${e.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${s.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const o=await gu(w.establishmentId,e.toISOString(),s.toISOString(),K.selectedProfessionalId==="all"?null:K.selectedProfessionalId),r=await Ar(w.establishmentId,e.toISOString(),s.toISOString(),K.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const a=r.map(c=>{let d=c.professionalName;if(!d&&c.professionalId){const p=w.professionals?w.professionals.find(h=>h.id===c.professionalId):null;p&&(d=p.name)}return{...c,type:"blockage",professionalName:d||"Não identificado"}}),l=[...o.map(c=>({...c,type:"appointment"})),...a];if(w.allEvents=l,or(),gx(),K.scrollToAppointmentId){const c=document.querySelector(`[data-appointment*='"id":"${K.scrollToAppointmentId}"']`);c&&(c.scrollIntoView({behavior:"smooth",block:"center"}),c.style.transition="background-color 0.5s ease-in-out",c.style.backgroundColor="#e0e7ff",setTimeout(()=>{c.style.backgroundColor=""},2500)),K.scrollToAppointmentId=null}}catch(o){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',k("Erro na Agenda",`Não foi possível carregar a agenda: ${o.message}`,"error"))}}}async function fx(){try{const[t,e,s]=await Promise.all([w.professionals&&w.professionals.length>0?Promise.resolve(w.professionals):Ge(w.establishmentId),w.services&&w.services.length>0?Promise.resolve(w.services):ps(w.establishmentId),Os.enabled!==void 0?Promise.resolve(null):ms(w.establishmentId)]);(!w.professionals||w.professionals.length===0)&&(w.professionals=t||[]),(!w.services||w.services.length===0)&&(w.services=e||[]),Ps=[],s&&(Os=s.loyaltyProgram||{enabled:!1}),w.professionals.forEach((n,o)=>{w.professionalColors.set(n.id,ei[o%ei.length])}),or()}catch(t){console.error("Erro ao popular filtros e dependências do modal:",t),k("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function ti(t){t<1||t>4||(j.step=t,si(null,!0))}function hp(t,e){const s=document.getElementById("multiServiceToggle"),n=s&&s.checked,o=e.classList.contains("selected"),r=j.data.selectedServiceIds.indexOf(t);if(o)e.classList.remove("selected","border-blue-500"),r>-1&&j.data.selectedServiceIds.splice(r,1);else{if(!n){j.data.selectedServiceIds=[];const a=document.getElementById("apptServicesContainer");a&&a.querySelectorAll(".service-card.selected").forEach(l=>{l.classList.remove("selected","border-blue-500")})}e.classList.add("selected","border-blue-500"),j.data.selectedServiceIds.push(t)}}function gp(t,e){const s=document.querySelector(".professional-step-cards");if(!s)return;s.querySelectorAll(".professional-modal-card").forEach(o=>o.classList.remove("selected","border-blue-500")),e.classList.add("selected","border-blue-500");const n=$r.find(o=>o.id===t);j.data.professionalId=t,j.data.professionalName=n?n.name:"N/A"}function bx(t,e){const s=document.getElementById("availableTimesContainer");s&&(s.querySelectorAll(".time-slot-card").forEach(n=>n.classList.remove("selected")),e.classList.add("selected"),j.data.time=t)}async function Nd(){const t=document.getElementById("apptTotalDuration"),e=document.getElementById("availableTimesContainer");if(!t||!e)return;const s=j.data.professionalId,n=j.data.selectedServiceIds,o=document.getElementById("apptDate").value;j.data.date=o;const r=n.reduce((a,l)=>{const c=Yn.find(d=>d.id===l);return a+(c?c.duration+(c.bufferTime||0):0)},0);if(t.textContent=`${r} min`,r===0||!s||!o){e.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}e.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let a=await $h({establishmentId:w.establishmentId,professionalId:s,serviceIds:n,date:o});const l=new Date;if(new Date(o+"T00:00:00").toDateString()===l.toDateString()){const d=l.getHours()*60+l.getMinutes();a=a.filter(p=>{const[h,f]=p.split(":").map(Number);return h*60+f>=d})}if(e.innerHTML="",a.length>0){if(a.forEach(d=>{const p=document.createElement("button");p.type="button",p.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${j.data.time===d?"selected":""}`,p.textContent=d,p.addEventListener("click",()=>bx(d,p)),e.appendChild(p)}),j.data.time){const d=e.querySelector(`[data-action="time-slot"][data-time="${j.data.time}"]`);d&&d.classList.add("selected")}}else e.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(a){console.error("Erro ao buscar horários:",a),e.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function vx(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:s,redeemedReward:n}=j.data,{enabled:o,rewards:r}=Os;if(!o||!e||!r||r.length===0){t.classList.add("hidden"),t.innerHTML="";return}t.classList.remove("hidden");const a=r.filter(c=>s>=c.points);let l=`
    ...
    `),t.querySelector('input[value="none"]').addEventListener("change",c=>{c.target.checked&&(j.data.redeemedReward=null)})}async function yx(t){t.preventDefault();const e=t.target,s=e.querySelector('button[type="submit"]');if(!j.data.time||j.data.selectedServiceIds.length===0||!j.data.professionalId)return k("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");s.disabled=!0,s.textContent="A confirmar...";const n=j.data.selectedServiceIds.map(d=>{const p=Yn.find(h=>h.id===d);return{id:p.id,name:p.name,price:p.price,duration:p.duration,bufferTime:p.bufferTime||0,photo:p.photo||null}}),[o,r]=j.data.time.split(":"),a=new Date(`${j.data.date}T${o}:${r}:00`),l={establishmentId:w.establishmentId,clientName:j.data.clientName,clientPhone:j.data.clientPhone,services:n,professionalId:j.data.professionalId,startTime:a.toISOString(),redeemedReward:j.data.redeemedReward},c=e.querySelector("#appointmentId").value;c&&(l.id=c);try{c?await gi(c,l):await Dh(l),k(`Agendamento ${c?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",lt()}catch(d){k(d.message,"error")}finally{s.disabled=!1,s.textContent="Confirmar Agendamento"}}function fp(t){const e=j.data.clientName===t.name&&j.data.clientPhone===t.phone,s=A(t.name),n=A(t.phone);return`
    ...
    `}async function xx(t){const e=document.getElementById("clientSearchResults");if(!e)return;const s=t.toLowerCase().trim();if(s.length<3){e.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}e.innerHTML='<div class="loader-small mx-auto my-2"></div>';try{const n=await Us(w.establishmentId,s);if(Ps=n,n.length===0){e.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}e.innerHTML=n.map(fp).join(""),e.querySelectorAll('[data-action="select-client"]').forEach(o=>{o.addEventListener("click",r=>{const a=o.dataset.clientName,l=o.dataset.clientPhone,c=parseInt(o.dataset.loyaltyPoints||"0",10);j.data.clientName=a,j.data.clientPhone=l,j.data.clientLoyaltyPoints=c;const d=Os,p=Math.min(...(d?.rewards||[]).map(h=>h.points));j.data.clientHasRewards=d.enabled&&p!==1/0&&j.data.clientLoyaltyPoints>=p,document.getElementById("apptClientName").value=a,document.getElementById("apptClientPhone").value=l,document.querySelectorAll(".client-search-card").forEach(h=>h.classList.remove("selected","border-blue-500")),o.classList.add("selected","border-blue-500")})})}catch(n){console.error("Erro na busca de clientes:",n),e.innerHTML='<p class="text-sm text-red-500">Erro ao buscar clientes.</p>'}}async function wx(t){t.preventDefault();const e=document.getElementById("clientRegistrationForm"),s=e.querySelector('button[type="submit"]'),n={establishmentId:w.establishmentId,name:e.querySelector("#regClientName").value.trim(),email:e.querySelector("#regClientEmail").value.trim(),phone:e.querySelector("#regClientPhone").value.trim(),dobDay:e.querySelector("#regClientDobDay").value.trim(),dobMonth:e.querySelector("#regClientDobMonth").value.trim(),notes:e.querySelector("#regClientNotes").value.trim()};if(!n.name||!n.phone)return k("Erro de Validação","Nome e Telefone são obrigatórios.","error");s.disabled=!0,s.textContent="A salvar...";try{await nr(n),Ps.push({name:n.name,phone:n.phone,loyaltyPoints:0}),j.data.clientName=n.name,j.data.clientPhone=n.phone,j.data.clientHasRewards=!1,j.data.clientLoyaltyPoints=0,k("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",ti(1)}catch(o){k(`Erro ao cadastrar cliente: ${o.message}`,"error")}finally{s.disabled=!1,s.textContent="Salvar"}}function Ex(){Pe({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const e=document.getElementById("clientRegistrationForm");e&&e.addEventListener("submit",wx)}function Ix(){Ex()}function Sx(t,e){const s=t?"Editar Agendamento":"Selecionar Cliente",n=`
    ...
    `;return{title:s,content:n}}function Tx(){const t="Selecionar Serviço",s=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${Yn.map(n=>{const o=j.data.selectedServiceIds.includes(n.id),r=n.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",a=A(n.name);return`
    ...
    `;return{title:t,content:s}}function kx(){const t="Selecionar Profissional",e=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${$r.map(s=>{const n=j.data.professionalId===s.id,o=s.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",r=A(s.name);return`
    ...
    `;return{title:t,content:e}}function Cx(t){const e=t?"Confirmar Edição":"Data e Horário",s=new Date,n=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`,o=j.data.date||n,r=A(j.data.clientName),a=A(j.data.professionalName),l=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:e,content:l}}function _x(t){const e=document.getElementById("apptServicesContainer");if(!e)return;const s=t.toLowerCase(),n=Yn.filter(o=>o.name.toLowerCase().includes(s));e.innerHTML=n.map(o=>{const r=j.data.selectedServiceIds.includes(o.id),a=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),e.querySelectorAll(".service-card").forEach(o=>{o.addEventListener("click",()=>hp(o.dataset.serviceId,o))})}function Ax(t){const e=document.getElementById("apptProfessionalContainer");if(!e)return;const s=t.toLowerCase(),n=$r.filter(o=>o.name.toLowerCase().includes(s));e.innerHTML=n.map(o=>{const r=j.data.professionalId===o.id,a=o.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",l=A(o.name);return`
        ...
        </div>`,s.querySelectorAll('[data-action="next-step"]').forEach(r=>{r.addEventListener("click",()=>{const a=parseInt(r.dataset.currentStep,10);if(a===1){const l=s.querySelector("#apptClientName"),c=s.querySelector("#apptClientPhone");if(j.data.clientName=l.value.trim(),j.data.clientPhone=c.value.trim(),!j.data.clientName||!j.data.clientPhone)return k("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(a===2){if(j.data.selectedServiceIds.length===0)return k("Atenção","Selecione pelo menos um serviço.","error")}else if(a===3&&!j.data.professionalId)return k("Atenção","Selecione um profissional.","error");ti(a+1)})}),s.querySelectorAll('[data-action="prev-step"]').forEach(r=>{r.addEventListener("click",()=>ti(parseInt(r.dataset.currentStep,10)-1))});const o=s.querySelector("#appointmentForm");if(j.step===4&&o&&o.addEventListener("submit",yx),s.style.display="flex",j.step===2){s.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(l=>{l.addEventListener("click",()=>hp(l.dataset.serviceId,l))});const a=s.querySelector("#serviceSearchModalInput");a&&a.addEventListener("input",l=>_x(l.target.value))}if(j.step===3){s.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(l=>{l.addEventListener("click",()=>gp(l.dataset.professionalId,l))});const a=s.querySelector("#professionalSearchModalInput");a&&a.addEventListener("input",l=>Ax(l.target.value))}if(j.step===1){const r=s.querySelector("#clientSearchInput");if(r&&(r.addEventListener("input",l=>xx(l.target.value)),j.data.clientName&&j.data.clientPhone&&Ps.length>0)){const l=document.getElementById("clientSearchResults");l&&(l.innerHTML=Ps.map(fp).join(""))}const a=s.querySelector('[data-action="open-client-registration"]');a&&a.addEventListener("click",Ix)}if(j.step===4){const r=s.querySelector("#apptDate");r&&r.addEventListener("change",Nd),Nd(),vx()}}async function bp(t={}){K.currentDate=t.targetDate?new Date(t.targetDate):K.currentDate||new Date,K.scrollToAppointmentId=t.scrollToAppointmentId||null,K.profSearchTerm="",window.innerWidth<768&&(K.currentView="list"),Rd.innerHTML=`
        <section>
        ...
        </section>`,document.querySelectorAll(".view-btn[data-view]").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(o=>o.classList.remove("active")),s.classList.add("active"),K.currentView=s.dataset.view;const n=document.getElementById("week-days-toggle");if(K.currentView==="week"){if(n.style.display="flex",window.innerWidth<768){K.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(r=>r.classList.remove("active"));const o=document.querySelector('.week-days-btn[data-days="3"]');o&&o.classList.add("active")}}else n.style.display="none";lt()})}),document.querySelectorAll(".week-days-btn").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(n=>n.classList.remove("active")),s.classList.add("active"),K.weekViewDays=parseInt(s.dataset.days,10),lt()})}),document.getElementById("todayBtn").addEventListener("click",()=>{K.currentDate=new Date,lt()});const e=s=>{const n=parseInt(s.currentTarget.dataset.amount,10),o=K.currentView==="week"?tl():1,r=new Date(K.currentDate);r.setDate(r.getDate()+n*o),K.currentDate=r,lt()};document.getElementById("prevBtn").addEventListener("click",e),document.getElementById("nextBtn").addEventListener("click",e),document.getElementById("profSearchInput").addEventListener("input",s=>{K.profSearchTerm=s.target.value,or()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",s=>{K.showInactiveProfs=s.target.checked,or(),lt()}),Md||(Rd.addEventListener("click",async s=>{const n=s.target.closest("[data-action]");if(s.target.closest('[data-action="select-professional"]')){const c=s.target.closest('[data-action="select-professional"]').dataset.profId,d=K.selectedProfessionalId===c&&c!=="all";if(K.selectedProfessionalId=d?"all":c,c!=="all"){const p=document.getElementById("profSearchInput");p&&(p.value=""),K.profSearchTerm=""}await lt();return}if(!n)return;const o=n.dataset.action;let r=null;const a=s.target.closest("[data-appointment]");switch(a&&(r=JSON.parse(a.dataset.appointment.replace(/&apos;/g,"'"))),o){case"new-appointment":si();break;case"edit-appointment":if(!r)return;if(r.status==="completed"){k("Atenção","Agendamentos finalizados não podem ser editados.","error");return}r.hasRewards&&!r.redeemedReward&&k("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),si(r);break;case"delete-appointment":{const l=n.dataset.id;if(await re("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Lh(l),k("Agendamento apagado!","success"),lt()}catch(d){k(`Não foi possível apagar: ${d.message}`,"error")}break}case"open-comanda":if(r){r.hasRewards&&!r.redeemedReward&&r.status!=="completed"&&k("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const l=r.status==="completed"?"finalizadas":"em-atendimento",c={selectedAppointmentId:r.id,initialFilter:l};if(l==="finalizadas"){let d=r.startTime;if(r.transaction&&r.transaction.paidAt){const p=r.transaction.paidAt;typeof p=="object"&&p._seconds?d=new Date(p._seconds*1e3):d=p}c.filterDate=d}Ye("comandas-section",c)}break}}),Md=!0),await fx(),await lt()}const Px=(t,e=null,s=1,n=12)=>{let o=`/api/comandas/${t}?page=${s}&limit=${n}`;return e&&(o+=`&date=${e}`),F(o)},$x=t=>F("/api/sales",{method:"POST",body:JSON.stringify(t)}),Dx=t=>F(`/api/sales/${t}/reopen`,{method:"POST"}),Lx=t=>F(`/api/sales/${t}`,{method:"DELETE"}),vp=()=>F("/api/cashier/status").catch(t=>{if(t.message.includes("404")||t.message.includes("não encontrada"))return null;throw t}),Rx=t=>{const e={establishmentId:t.establishmentId,initialAmount:Number(t.initialAmount),notes:t.notes||""};return console.log("Payload enviado para abrir caixa:",e),F("/api/cashier/open",{method:"POST",body:JSON.stringify(e)})},Mx=(t,e)=>{const s={finalAmount:Number(e)};return console.log("Payload enviado para fechar caixa:",s),F(`/api/cashier/close/${t}`,{method:"PUT",body:JSON.stringify(s)})},Nx=()=>F("/api/cashier/history").then(t=>t||[]).catch(t=>(console.error("Erro ao buscar histórico:",t),[])),Bx=t=>F(`/api/cashier/report/${t}`),yp=t=>F(`/api/packages/${t}`),Vx=t=>F("/api/packages",{method:"POST",body:JSON.stringify(t)}),Fx=(t,e)=>F(`/api/packages/${t}`,{method:"PUT",body:JSON.stringify(e)}),Ox=t=>F(`/api/packages/${t}`,{method:"DELETE"});let V={allComandas:[],catalog:{services:[],products:[],packages:[]},clients:[],activeFilter:"atendimento",selectedComandaId:null,isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,paging:{page:1,limit:12,total:0}},xs=null,Ss=null;function Dr(t){if(t.status==="completed"){const o=t.comandaItems||t.items||[];return o.length>0?o:t.services||[]}const e=t.services||[],s=[...t.comandaItems||[],...t.items||[]];let n=[...e];return s.forEach(o=>{if(o.type==="product"){n.push(o);return}n.some(a=>{const l=a.id&&o.id&&a.id===o.id,c=a.name&&o.name&&a.name===o.name;return l||c})||n.push(o)}),n}function qx(){const t=document.getElementById("comandas-layout");if(t){t.classList.add("detail-view-active");const e=document.getElementById("comanda-detail-container");e&&(e.scrollTop=0)}}function Jt(){const t=document.getElementById("comandas-layout");t&&t.classList.remove("detail-view-active")}function jx(){const t=new Date().toISOString().split("T")[0];Ss.innerHTML=`
    ...
    `}function Hx(){const t=document.getElementById("cashier-controls");t&&(V.isCashierOpen?t.innerHTML=`
    ...
    `;if(!V.isCashierOpen){t.innerHTML=`
        ...
        `;return}const n=Dr(s),o=s.status==="completed",r=s.type==="walk-in"||s.id.startsWith("temp-"),a=r?"":`<button data-action="go-to-appointment" data-id="${s.id}" data-date="${s.startTime}" 
    ...
    `,o||Ux(s,t.querySelector("#loyalty-container"))}async function Ux(t,e){if(!e)return;const s=V.loyaltySettings;if(!s||!s.enabled)return;let n=null;if(t.clientId&&(n=V.clients.find(r=>r.id===t.clientId)),n||(n=V.clients.find(r=>r.name===t.clientName)),!n||n.loyaltyPoints===void 0)try{if(t.clientId)n=await cp(t.clientId);else{const r=await Us(w.establishmentId,t.clientName);n=r.find(a=>a.name===t.clientName)||r[0]}}catch(r){console.error("[Fidelidade] Erro ao buscar cliente",r);return}if(!n||!n.loyaltyPoints)return;const o=(s.rewards||[]).filter(r=>n.loyaltyPoints>=r.costPoints);if(o.length>0){const r=document.createElement("div");r.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center",r.innerHTML=`
            <div class="flex items-center gap-3">
        ...
        `;const a=document.createElement("button");a.innerText="Resgatar",a.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",a.onclick=()=>zx(o),r.appendChild(a),e.innerHTML="",e.appendChild(r)}}function zx(t,e){const s=`
        <div class="space-y-4">
    ...
    `,{modalElement:n,close:o}=Pe({title:"🎁 Resgatar Prémio",contentHTML:s,maxWidth:"max-w-md"});n.addEventListener("click",r=>{const a=r.target.closest('[data-action="select-reward"]');if(a){const l=a.dataset.rewardId,c=t.find(d=>d.id==l);c&&(Wx(c),o())}})}async function Wx(t,e){const s={id:t.serviceId||t.productId||`reward-${Date.now()}`,name:`${t.name}`,price:0,type:t.serviceId?"service":"product",isReward:!0,pointsCost:t.costPoints};await xp(s,1)}function Gx(){Pe({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",Kx)}async function Kx(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const s=e.querySelector('button[type="submit"]'),n=e.querySelector("#regClientName"),a=e.querySelector("#regClientPhone").value.trim().replace(/\D/g,""),l={establishmentId:w.establishmentId,name:n.value.trim(),email:e.querySelector("#regClientEmail").value.trim()||null,phone:a,dob:`${e.querySelector("#regClientDobDay").value.trim()}/${e.querySelector("#regClientDobMonth").value.trim()}`,notes:e.querySelector("#regClientNotes").value.trim()||null};if(!l.name||!a)return k("Erro de Validação","Nome e Telefone (apenas números) são obrigatórios.","error");s.disabled=!0,s.textContent="Verificando...";try{const c=await up(w.establishmentId,a);if(c)k("Atenção",`Cliente já cadastrado: ${c.name}. Selecionando existente...`,"info"),V.clients.find(p=>p.id===c.id)||V.clients.push(c),document.getElementById("genericModal").style.display="none",ni(c.id);else{s.textContent="A salvar...";const d=await nr(l);V.clients.push({id:d.id,...l}),k("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",ni(d.id)}}catch(c){k(`Erro ao processar: ${c.message}`,"error")}finally{s&&(s.disabled=!1,s.textContent="Salvar Cliente")}}function Jx(){if(!V.isCashierOpen){k("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:t,close:e}=Pe({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),s=()=>{let o="";const r=t.querySelector("#add-item-content"),a={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},l=()=>{const c=o.toLowerCase(),d=h=>h.filter(f=>f.name.toLowerCase().includes(c)),p={"modal-service-list":{items:d(V.catalog.services),type:"service"},"modal-product-list":{items:d(V.catalog.products),type:"product"},"modal-package-list":{items:d(V.catalog.packages),type:"package"}};for(const[h,{items:f,type:y}]of Object.entries(p)){const I=r.querySelector(`#${h}`);I&&(I.innerHTML=f.map(_=>`
    ...
    `,{modalElement:o}=Pe({title:"Nova Venda Avulsa",contentHTML:n,maxWidth:"max-w-md"});o.querySelector("#new-sale-form").addEventListener("submit",sw);const r=o.querySelector('[data-action="new-client-from-sale"]');r&&r.addEventListener("click",a=>{a.preventDefault(),o.style.display="none",Gx()})}function Qx(){if(!V.isCashierOpen){k("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const t=V.allComandas.find(h=>h.id===V.selectedComandaId);if(!t)return;const e=Dr(t),s=new Set,n=[];for(const h of e){if(h.type==="service"&&h.id){if(s.has(h.id))continue;s.add(h.id)}n.push(h)}const o=n.reduce((h,f)=>h+(f.price||0),0);let r=[],a={remainingAmount:o,selectedMethod:"dinheiro",installments:1,amountReceived:""};const l=()=>{const h=document.getElementById("payment-list"),f=document.getElementById("remaining-amount"),y=document.getElementById("finalize-checkout-btn"),I=document.getElementById("change-container"),_=document.getElementById("installments-container"),D=document.getElementById("payment-value"),R=document.getElementById("payment-controls"),O=r.reduce((B,H)=>B+H.value,0);a.remainingAmount=o-O,h.innerHTML=r.map((B,H)=>`
    ...
    `,{modalElement:p}=Pe({title:"Finalizar Pagamento",contentHTML:d,maxWidth:"max-w-md"});document.getElementById("payment-value").value=a.remainingAmount.toFixed(2),p.addEventListener("click",h=>{const f=h.target.closest(".payment-method-btn");f&&(a.selectedMethod=f.dataset.method,a.installments=1,document.getElementById("installments-select").value=1,l()),h.target.closest("#add-payment-btn")&&c(),h.target.closest('[data-action="remove-payment"]')&&(r.splice(parseInt(h.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),l()),h.target.closest("#finalize-checkout-btn")&&tw(t,o,r)}),p.addEventListener("change",h=>{h.target.id==="installments-select"&&(a.installments=parseInt(h.target.value,10))}),p.addEventListener("input",h=>{h.target.id==="amount-received"&&(a.amountReceived=h.target.value,l())}),l()}async function Xx(){const t=`
    ...
    `,{modalElement:e}=Pe({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-md"});e.querySelector("#open-cashier-form").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("initial-amount"),o=n.value.trim(),r=document.getElementById("cashier-notes").value.trim(),a=parseFloat(o);if(o===""||isNaN(a)||a<0){k("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),n.focus();return}try{const l={establishmentId:w.establishmentId,initialAmount:parseFloat(a.toFixed(2))};r&&(l.notes=r);const c=await Rx(l);V.isCashierOpen=!0,V.activeCashierSessionId=c.id,await sl(),document.getElementById("genericModal").style.display="none",k("Sucesso!",`Caixa aberto com valor inicial de R$ ${a.toFixed(2)}`,"success")}catch(l){k("Erro",`Não foi possível abrir o caixa: ${l.message}`,"error")}})}async function Yx(){const t=V.activeCashierSessionId;if(t)try{const e=await Bx(t),s=`
        ...
        `,{modalElement:n}=Pe({title:"Fechar Caixa",contentHTML:s,maxWidth:"max-w-md"});n.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const r=parseFloat(document.getElementById("final-amount").value);if(isNaN(r)||r<0){k("Valor Inválido","Insira um valor final válido.","error");return}try{await Mx(t,r),V.isCashierOpen=!1,V.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await sl(),k("Sucesso!","Caixa fechado com sucesso!","success")}catch(a){k("Erro",`Não foi possível fechar o caixa: ${a.message}`,"error")}})}catch(e){k("Erro",`Não foi possível carregar o relatório de fecho: ${e.message}`,"error")}}async function Zx(t){V.activeFilter!==t&&(V.activeFilter=t,V.paging.page=1,document.querySelectorAll(".filter-btn").forEach(e=>e.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${t}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",t!=="finalizadas"),Jt(),await ut(),V.selectedComandaId=null,Xe())}function oi(t){V.selectedComandaId=t,Vt(),qx(),Xe()}async function xp(t,e){const s=V.allComandas.find(o=>o.id===V.selectedComandaId);if(!s)return;const n=Array(e).fill(0).map(()=>({id:t.id,name:t.name,price:t.price,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0}));if(s.comandaItems=s.comandaItems||[],s.comandaItems.push(...n),s.type==="walk-in"&&s.id.startsWith("temp-")){k("Sucesso",`${e}x ${t.name} adicionado(s)!`,"success"),Xe(),Vt();return}try{await gi(s.id,s),k("Sucesso",`${e}x ${t.name} adicionado(s)!`,"success"),Xe(),Vt()}catch(o){k("Erro",`Não foi possível adicionar o item: ${o.message}`,"error"),s.comandaItems.splice(s.comandaItems.length-e,e)}}async function ew(t,e){const s=V.allComandas.find(r=>r.id===V.selectedComandaId);if(!s)return;let n=!1,o=(s.comandaItems||[]).findIndex(r=>r.id===t&&r.type===e);if(o>-1)s.comandaItems.splice(o,1),n=!0;else{let r=(s.services||[]).findIndex(a=>a.id===t);if(r>-1)s.services.splice(r,1),n=!0;else{let a=(s.items||[]).findIndex(l=>l.id===t&&l.type===e);a>-1&&(s.items.splice(a,1),n=!0)}}if(n){if(s.type==="walk-in"&&s.id.startsWith("temp-")){k("Sucesso","Item removido!","success"),Xe(),Vt();return}try{await gi(s.id,s),k("Sucesso","Item removido!","success"),Xe(),Vt()}catch(r){k("Erro",`Não foi possível remover o item: ${r.message}`,"error"),await ut()}}}async function tw(t,e,s){const n=t.type==="appointment",o=Dr(t),r=new Set,a=[];for(const c of o){if(c.type==="service"&&c.id){if(r.has(c.id))continue;r.add(c.id)}a.push(c)}const l={payments:s,totalAmount:e,items:a,cashierSessionId:V.activeCashierSessionId};try{n?await Mh(t.id,l):(l.establishmentId=w.establishmentId,l.clientId=t.clientId,l.clientName=t.clientName,l.professionalId=t.professionalId,l.clientPhone=t.clientPhone,await $x(l)),k("Sucesso!","Venda finalizada com sucesso!","success"),document.getElementById("genericModal").style.display="none",Jt(),V.selectedComandaId=null,await ut()}catch(c){k("Erro no Checkout",c.message,"error")}}async function sw(t){t.preventDefault();const e=document.getElementById("new-sale-client").value,s=document.getElementById("new-sale-professional").value,n=V.clients.find(a=>a.id===e),o=w.professionals.find(a=>a.id===s);if(!n||!o){k("Erro","Selecione um cliente e um profissional válidos.","error");return}const r={id:`temp-${Date.now()}`,type:"walk-in",clientId:n.id,clientName:n.name,clientPhone:n.phone,professionalId:o.id,professionalName:o.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};V.allComandas.unshift(r),V.selectedComandaId=r.id,document.getElementById("genericModal").style.display="none",oi(r.id)}async function ut(){const t=document.getElementById("comandas-list");t.innerHTML='<div class="loader mx-auto mt-10"></div>';const e=V.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const s=await vp();if(V.isCashierOpen=!!s,V.activeCashierSessionId=s?s.id:null,Hx(),!V.isCashierOpen&&V.activeFilter==="atendimento"){Vt(),Xe();return}try{const o=await(void 0)(w.establishmentId);o&&o.loyaltyProgram&&(V.loyaltySettings=o.loyaltyProgram)}catch{console.log("Sem config de fidelidade carregada")}const n=await Px(w.establishmentId,e,V.paging.page,V.paging.limit);if(V.allComandas=n.data||n,V.paging.total=n.total||n.length,V.catalog.services.length===0){const[o,r,a,l,c]=await Promise.all([ps(w.establishmentId),pr(w.establishmentId),yp(w.establishmentId),Us(w.establishmentId),Ge(w.establishmentId)]);V.catalog={services:o,products:r,packages:a},V.clients=l,w.professionals=c}Vt(),V.selectedComandaId,Xe()}catch(s){k("Erro de Carregamento",`Não foi possível carregar os dados: ${s.message}`,"error"),t.innerHTML=`<p class="text-red-500 p-4">${s.message}</p>`}}async function sl(t={}){Ss=document.getElementById("content");try{const e=await vp();V.isCashierOpen=!!e,V.activeCashierSessionId=e?e.id:null}catch(e){console.error("Erro ao verificar caixa:",e),V.isCashierOpen=!1}V.selectedComandaId=t.selectedAppointmentId||null,jx(),xs&&(Ss.removeEventListener("click",xs),Ss.removeEventListener("change",xs)),xs=async e=>{const s=e.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(e.target.id==="filter-date"&&V.activeFilter==="finalizadas"){V.paging.page=1,await ut();return}if(s){if(s.matches("[data-filter]"))Zx(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(e.target.closest('[data-action="go-to-appointment"]')){e.stopPropagation();return}oi(s.dataset.comandaId)}else if(s.matches("[data-action]")){const n=s.dataset.action,o=s.dataset.id||V.selectedComandaId;switch(n){case"back-to-list":{Jt(),V.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(r=>r.classList.remove("selected")),Xe();break}case"new-sale":ni();break;case"add-item":Jx();break;case"checkout":Qx();break;case"open-cashier":Xx();break;case"close-cashier":await Yx();break;case"view-sales-report":Ye("sales-report-section");break;case"remove-item":await ew(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await re("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await Rh(o);const a=V.allComandas.findIndex(l=>l.id===o);a!==-1&&(delete V.allComandas[a].transaction,delete V.allComandas[a].cashierSessionId,delete V.allComandas[a].redeemedReward,V.allComandas[a].status="confirmed"),V.selectedComandaId=null,Jt(),k("Sucesso!","Comanda reaberta para edição.","success"),await ut()}catch(a){k("Erro",`Não foi possível reabrir: ${a.message}`,"error")}break}case"reopen-walk-in":{if(await re("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await Dx(o),k("Sucesso!","Venda revertida."),Jt(),V.selectedComandaId=null,await ut()}catch(a){k("Erro",`Não foi possível reabrir: ${a.message}`,"error")}break}case"go-to-appointment":{const r=s.dataset.id,a=s.dataset.date;Ye("agenda-section",{scrollToAppointmentId:r,targetDate:new Date(a)});break}case"delete-walk-in":{if(await re("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(o.startsWith("temp-"))V.allComandas=V.allComandas.filter(a=>a.id!==o),V.selectedComandaId=null,Vt(),Xe(),k("Sucesso","Venda avulsa removida.","success"),Jt();else try{await Lx(o),k("Sucesso","Venda avulsa excluída com sucesso.","success"),V.selectedComandaId=null,Jt(),await ut()}catch(a){k("Erro",`Não foi possível excluir: ${a.message}`,"error")}break}}}}},Ss.addEventListener("click",xs),Ss.addEventListener("change",xs),t.initialFilter&&(V.activeFilter=t.initialFilter==="finalizadas"?"finalizadas":"atendimento"),t.selectedAppointmentId&&(V.selectedComandaId=t.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(e=>e.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${V.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",V.activeFilter!=="finalizadas"),t.filterDate&&(document.getElementById("filter-date").value=new Date(t.filterDate).toISOString().split("T")[0]),await ut(),V.selectedComandaId&&oi(V.selectedComandaId)}const ri=document.getElementById("content");let Ia={};const Eo=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],te={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],currentTab:"dashboards"};async function nw(){if(!window.Chart)return new Promise((t,e)=>{const s=document.createElement("script");s.src="https://cdn.jsdelivr.net/npm/chart.js",s.onload=t,s.onerror=e,document.head.appendChild(s)})}async function ow(){ri.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">A carregar inteligência de dados...</p></div>';try{await nw();const[t,e]=await Promise.all([Ge(w.establishmentId),rx(w.establishmentId).catch(()=>[])]);te.professionalsList=t||[],te.costCentersList=e||[],rw(),await wp()}catch(t){console.error("Erro no loadReportsPage:",t),ri.innerHTML=`
            ...
            </div>`}}function rw(){const t=te.professionalsList.map(s=>`<option value="${s.id}">${A(s.name)}</option>`).join(""),e=te.costCentersList.map(s=>`<option value="${s.id}">${A(s.name)}</option>`).join("");ri.innerHTML=`
    ...
    `,document.getElementById("btn-filter").onclick=aw,document.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=()=>{te.currentTab=s.dataset.tab,Vd(),Ep()}}),Vd()}function Vd(){document.querySelectorAll(".tab-btn").forEach(t=>{const e=t.dataset.tab===te.currentTab;t.className=e?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function aw(){te.startDate=document.getElementById("report-start").value,te.endDate=document.getElementById("report-end").value,te.selectedProfessional=document.getElementById("report-prof").value,te.selectedCostCenter=document.getElementById("report-cost").value,await wp()}async function wp(){const t=document.getElementById("report-content");t.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const e=ox(te.startDate,te.endDate,te.selectedProfessional,te.selectedCostCenter),s=te.selectedProfessional==="all"?null:te.selectedProfessional,n=new Date(te.startDate+"T00:00:00").toISOString(),o=new Date(te.endDate+"T23:59:59").toISOString(),r=gu(w.establishmentId,n,o,s).catch(c=>[]),[a,l]=await Promise.all([e,r]);te.data=a,te.appointmentsData=Array.isArray(l)?l:[],Ep()}catch(e){console.error(e),t.innerHTML=`
            ...
            </div>`}}function Ep(){const t=document.getElementById("report-content");if(te.data)switch(te.currentTab){case"dashboards":iw(t);break;case"appointments":lw(t);break;case"dre":cw(t);break}}function iw(t){const{dreSimple:e,charts:s}=te.data,n=e||{grossRevenue:0,netProfit:0,variableCosts:0},o=te.data.totalAppointments||0,r=o>0?n.grossRevenue/o:0;t.innerHTML=`
    ...
    `,gn("dailyApptChart","line","Agendamentos",h.map(I=>I.split("-").reverse().slice(0,2).join("/")),f,"#4f46e5")}function cw(t){const{dreFinancial:e}=te.data,s=Object.entries(e.revenues).map(([o,r])=>`
    ...
    `}function gn(t,e,s,n,o,r){const a=document.getElementById(t);if(!a)return;const l=a.getContext("2d");Ia[t]&&Ia[t].destroy();const c={type:e,data:{labels:n,datasets:[{label:s,data:o,backgroundColor:Array.isArray(r)?r:e==="line"?"rgba(79, 70, 229, 0.1)":r,borderColor:Array.isArray(r)?"#fff":r,borderWidth:2,fill:e==="line",tension:.3,borderRadius:e==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:r,pointHoverBackgroundColor:r}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:e==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let p=d.dataset.label||"";return p&&(p+=": "),d.parsed.y!==null?p+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):p+=d.raw,p}}}},scales:e==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};Ia[t]=new Chart(l,c)}const Lr=(t,e="products")=>F(`/api/${e}/categories/${t}`),Ip=(t,e="products")=>F(`/api/${e}/categories`,{method:"POST",body:JSON.stringify(t)}),Sp=(t,e="products")=>F(`/api/${e}/categories/${t}`,{method:"DELETE"}),dw="audit_logs",qs=async(t,e,s,n,o,r=null)=>{try{if(!e)return;await uu($t(Ae,dw),{establishmentId:t,userId:e.uid,userName:e.name||e.email||"Utilizador",module:s,action:n,description:o,details:r,timestamp:new Date})}catch(a){console.error("Falha silenciosa ao registar log:",a)}},Kt=document.getElementById("content");let Ct=null,In="services",ss="all";function js(){const t=_e.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}async function uw(t){t.preventDefault();const s=t.target.closest("#categoryForm").querySelector("#categoryName"),n=s.value;if(n)try{await Ip({establishmentId:w.establishmentId,name:n},"services"),qs(w.establishmentId,js(),"Categorias (Serviços)","Criou",`Criou categoria: ${n}`),s.value="",k("Sucesso","Categoria criada!","success"),await nl(),await Zn()}catch(o){k("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function mw(t){if(await re("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Sp(t,"services"),qs(w.establishmentId,js(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),k("Sucesso","Categoria apagada.","success"),await nl(),await Zn()}catch{k("Erro","Não foi possível apagar a categoria.","error")}}async function nl(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Lr(w.establishmentId,"services");w.serviceCategories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(s=>`
                ...
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function pw(){Pe({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `,maxWidth:"max-w-xl"});const e=document.getElementById("genericModal");if(e){const s=e.querySelector("#categoryForm");s&&(s.addEventListener("submit",uw),e.addEventListener("click",n=>{const o=n.target.closest('button[data-action="delete-category"]');o&&(n.preventDefault(),mw(o.dataset.id))}))}nl()}async function hw(t){t.preventDefault();const e=t.target.closest("#serviceModal"),s=e.querySelector("#serviceId").value,n={},o=e.querySelector('input[name="commissionType"]:checked').value;o==="custom"&&e.querySelectorAll(".professional-commission-row").forEach(a=>{const l=a.dataset.profId;if(a.querySelector('input[type="checkbox"]').checked){const d=parseFloat(a.querySelector('input[type="number"]').value);n[l]=isNaN(d)?0:d}});const r={establishmentId:w.establishmentId,name:e.querySelector("#serviceName").value,price:parseFloat(e.querySelector("#servicePrice").value),duration:parseInt(e.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(e.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:e.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(e.querySelector("#serviceCommissionRate").value)||0,active:e.querySelector("#serviceStatus").value==="true",photo:e.querySelector("#servicePhotoBase64").value,notes:e.querySelector("#serviceNotes").value,commissionType:o,professionalCommissions:n};try{s?(await Kh(s,r),qs(w.establishmentId,js(),"Serviços","Editou",`Editou o serviço: ${r.name}`)):(await vu(r),qs(w.establishmentId,js(),"Serviços","Criou",`Criou novo serviço: ${r.name}`)),document.getElementById("serviceModal").style.display="none",k("Sucesso",`Serviço ${s?"atualizado":"adicionado"} com sucesso!`,"success"),await Zn()}catch(a){k("Erro",a.message,"error")}}function Fd(t=null){const e=document.getElementById("serviceModal"),s=w.serviceCategories||[],n=t?.duration||0,o=t?.bufferTime||0,r=A(t?.name||""),a=A(t?.notes||""),l=t?r:"Novo Serviço",c=s.map(B=>`<option value="${B.id}" ${t?.categoryId===B.id?"selected":""}>${A(B.name)}</option>`).join("");e.innerHTML=`
    ...
    `;const e=document.getElementById("serviceCategoryFilter");e&&(e.innerHTML='<option value="all">Todas as categorias</option>',(w.serviceCategories||[]).forEach(s=>e.innerHTML+=`<option value="${s.id}">${A(s.name)}</option>`)),ol(),Ts()}function fw(){const t=document.getElementById("services-content-container");t.innerHTML=`
    ...
    `}async function Zn(){const t=document.getElementById("services-content-container");if(t){const e=t.querySelector(".loader");e&&(e.style.display="block")}try{const[e,s,n,o]=await Promise.all([ps(w.establishmentId),Ge(w.establishmentId),Lr(w.establishmentId,"services"),Xh(w.establishmentId)]);w.services=(e||[]).filter(Boolean),w.professionals=(s||[]).filter(Boolean),w.serviceCategories=(n||[]).filter(Boolean),w.mostPopularService=o||{name:"N/A",count:0},w.services.forEach(r=>{r.active===void 0&&(r.active=!0)}),Tp(In)}catch(e){t&&(t.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),k("Erro",`Não foi possível carregar os dados: ${e.message}`,"error")}}function Tp(t){if(document.getElementById("services-content-container")){if(In===t&&document.getElementById("services-content-container").children.length>1){In==="services"&&(ol(),Ts());return}In=t,ss="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(e=>{const s=e.dataset.view===t;e.classList.toggle("border-indigo-500",s),e.classList.toggle("text-indigo-600",s),e.classList.toggle("border-transparent",!s),e.classList.toggle("text-gray-500",!s)}),t==="services"?gw():t==="reports"&&fw()}}function bw(){Ct&&(Kt.removeEventListener("click",Ct),Kt.removeEventListener("input",Ct),Kt.removeEventListener("change",Ct)),Ct=async t=>{const e=t.target;if(e.closest('[data-action="toggle-service-status"]')){t.stopPropagation();const o=e.closest('[data-action="toggle-service-status"]'),r=o.dataset.id,a=o.checked;try{await Qh(r,a);const l=w.services.findIndex(c=>c.id===r);l>-1&&(w.services[l].active=a),qs(w.establishmentId,js(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${a?"Ativo":"Inativo"}`),Ts(),ol()}catch(l){k("Erro",`Não foi possível atualizar o status: ${l.message}`,"error"),o.checked=!a,Ts()}return}const s=e.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(e.id==="serviceSearchInput"||e.id==="serviceCategoryFilter"){Ts();return}if(!s)return;if(s.hasAttribute("data-view")){Tp(s.dataset.view);return}switch(s.dataset.action){case"new-service":Fd();break;case"edit-service":const o=JSON.parse(s.dataset.service);Fd(o);break;case"manage-categories":pw();break;case"filter-service":const r=s.dataset.filterType;if(r==="popular")return;ss=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(a=>{const l=a.dataset.filterType,d=l===ss||l==="total"&&ss==="all";a.classList.toggle("ring-2",d),a.classList.toggle("ring-indigo-500",d),a.classList.toggle("shadow-lg",d)}),Ts();break}},Kt.addEventListener("click",Ct),Kt.addEventListener("input",Ct),Kt.addEventListener("change",Ct)}async function vw(){Kt.innerHTML=`
        ...
        </section>`,bw();try{(!w.professionals||w.professionals.length===0)&&(w.professionals=await Ge(w.establishmentId)||[])}catch(t){console.error("Falha ao carregar profissionais:",t),k("Erro","Não foi possível carregar a lista de profissionais.","error"),w.professionals=[]}In="services",ss="all",await Zn()}const Rr="suppliers",rl="purchases",kp="financial_payables",al=async t=>{try{const e=ur($t(Ae,Rr),Ln("establishmentId","==",t)),s=await hi(e),n=[];return s.forEach(o=>{n.push({id:o.id,...o.data()})}),n}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},yw=async t=>{try{return{id:(await uu($t(Ae,Rr),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},xw=async(t,e)=>{try{const s=rs(Ae,Rr,t);return await hu(s,e),{id:t,...e}}catch(s){throw console.error("Erro ao atualizar fornecedor:",s),s}},ww=async t=>{try{const e=rs(Ae,Rr,t);return await Sh(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},Ew=async(t,e=null)=>{try{const s=pu(Ae),n=rs($t(Ae,rl)),o={...t,createdAt:fc()};if(s.set(n,o),e&&e.defaultNatureId&&e.defaultCostCenterId){const r=rs($t(Ae,kp)),a=new Date().toISOString().split("T")[0],l={establishmentId:t.establishmentId,description:`Compra - ${t.supplierName}`,amount:parseFloat(t.totalAmount),dueDate:a,naturezaId:e.defaultNatureId,centroDeCustoId:e.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${t.items.length}`,status:"pending",paymentDate:null,purchaseId:n.id,createdAt:fc()};s.set(r,l)}return await s.commit(),{id:n.id,...o}}catch(s){throw console.error("Erro ao registrar compra com integração:",s),s}},Iw=async(t,e)=>{try{const s=pu(Ae),n=rs(Ae,rl,t);s.delete(n);const o=ur($t(Ae,kp),Ln("purchaseId","==",t),Ln("establishmentId","==",e));return(await hi(o)).forEach(a=>{s.delete(a.ref)}),await s.commit(),!0}catch(s){throw console.error("Erro ao excluir compra e financeiro:",s),s}},Sw=async t=>{try{const e=ur($t(Ae,rl),Ln("establishmentId","==",t),mu("createdAt","desc")),s=await hi(e),n=[];return s.forEach(o=>{n.push({id:o.id,...o.data()})}),n}catch(e){throw console.error("Erro ao buscar histórico de compras:",e),e}},zt=document.getElementById("content");let _t=null,Sn="products",dt="all";async function Tw(t){t.preventDefault();const s=t.target.closest("#categoryForm").querySelector("#categoryName"),n=s.value;if(n)try{await Ip({establishmentId:w.establishmentId,name:n},"products"),s.value="",k("Sucesso","Categoria de produto criada!","success"),await il(),await eo()}catch(o){k("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function kw(t){if(await re("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Sp(t,"products"),k("Sucesso","Categoria de produto apagada.","success"),await il(),await eo()}catch{k("Erro","Não foi possível apagar a categoria.","error")}}async function il(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Lr(w.establishmentId,"products");w.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(s=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${A(s.name)}</span>
                    <button data-action="delete-category" data-id="${s.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Cw(){Pe({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `;const e=document.getElementById("productCategoryFilter");e&&(e.innerHTML='<option value="all">Todas as categorias</option>',(w.categories||[]).forEach(s=>e.innerHTML+=`<option value="${s.id}">${A(s.name)}</option>`)),ll(),qn()}function $w(){const t=document.getElementById("products-content-container"),e=new Date().toISOString().split("T")[0],s=new Date;s.setDate(s.getDate()-30);const n=s.toISOString().split("T")[0];t.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const o=document.getElementById("productFilterReport"),r=document.getElementById("categoryFilterReport");o&&w.products&&(o.innerHTML+=w.products.map(a=>`<option value="${a.id}">${A(a.name)}</option>`).join("")),r&&w.categories&&(r.innerHTML+=w.categories.map(a=>`<option value="${a.id}">${A(a.name)}</option>`).join(""))}async function Dw(){const t=document.getElementById("report-results");t.innerHTML='<div class="loader mx-auto my-8"></div>';const e={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:w.establishmentId};try{const s=await tg(e);if(s.length===0){t.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,t.appendChild(a)})):(t.className="",t.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function eo(){const t=document.getElementById("products-content-container");t&&(t.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[e,s,n]=await Promise.all([pr(w.establishmentId),Lr(w.establishmentId,"products"),al(w.establishmentId)]);w.products=(e||[]).filter(Boolean),w.categories=(s||[]).filter(Boolean),w.suppliers=(n||[]).filter(Boolean),Cp(Sn)}catch(e){t&&(t.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${e.message}</p>`)}}function Cp(t){if(document.getElementById("products-content-container")){if(Sn===t&&document.getElementById("products-content-container").children.length>1){Sn==="products"&&(ll(),qn());return}Sn=t,dt="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(e=>{const s=e.dataset.view===t;e.classList.toggle("border-indigo-500",s),e.classList.toggle("text-indigo-600",s),e.classList.toggle("border-transparent",!s),e.classList.toggle("text-gray-500",!s)}),t==="products"?Pw():t==="movements"&&$w()}}async function Lw(){zt.innerHTML=`
        ...
        </section>`,_t&&(zt.removeEventListener("click",_t),zt.removeEventListener("input",_t),zt.removeEventListener("change",_t)),_t=async t=>{const e=t.target;if(e.id==="productSearchInput"||e.id==="productCategoryFilter"){qn();return}const s=t.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!s||t.target.closest('[data-action-stop-propagation="true"]'))return;if(s.hasAttribute("data-view")){Cp(s.dataset.view);return}switch(s.dataset.action){case"new-product":qd();break;case"edit-product":qd(JSON.parse(s.dataset.product));break;case"manage-product-categories":Cw();break;case"generate-report":await Dw();break;case"filter-stock":const o=s.dataset.filterType;dt=dt===o?"all":o,document.querySelectorAll(".indicator-card").forEach(r=>{r.classList.toggle("ring-2",r.dataset.filterType===dt),r.classList.toggle("ring-indigo-500",r.dataset.filterType===dt),r.classList.toggle("shadow-lg",r.dataset.filterType===dt)}),qn();break}},zt.addEventListener("click",_t),zt.addEventListener("input",_t),zt.addEventListener("change",_t),Sn="products",dt="all",await eo()}const Wt=document.getElementById("content");let At=null,Oo="list",le={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Rw(){Oo==="list"?Mr():Oo==="purchases"?(le.step=1,Tn()):Oo==="history"&&_p()}async function Mw(){try{const t=await al(w.establishmentId);return w.suppliers=t||[],le.allSuppliers=t,!0}catch(t){return console.error(t),!1}}async function Nw(t){if(await re("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await ww(t),k("Sucesso","Fornecedor excluído.","success"),mr("genericModal"),Mr()}catch(e){k("Erro","Erro ao excluir: "+e.message,"error")}}async function Bw(t){t.preventDefault();const e=t.target,s=e.querySelector("#supId").value,n={name:e.querySelector("#supName").value,contactName:e.querySelector("#supContact").value,email:e.querySelector("#supEmail").value,phone:e.querySelector("#supPhone").value,taxId:e.querySelector("#supTaxId").value,category:e.querySelector("#supCategory").value,establishmentId:w.establishmentId},o=e.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="A salvar...";try{s?(await xw(s,n),k("Sucesso","Fornecedor atualizado!","success")):(await yw(n),k("Sucesso","Fornecedor criado!","success")),mr("genericModal"),Mr()}catch(r){k("Erro","Erro ao salvar: "+r.message,"error")}finally{o.disabled=!1,o.textContent="Salvar"}}async function Mr(){const t=document.getElementById("suppliersList");if(!t)return;t.innerHTML='<div class="loader mx-auto my-8"></div>',await Mw();const e=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",s=w.suppliers.filter(r=>r.name.toLowerCase().includes(e)||r.contactName&&r.contactName.toLowerCase().includes(e));if(t.innerHTML="",s.length===0){t.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let n='<div class="flex flex-col gap-2 md:hidden">';s.forEach(r=>{const a=JSON.stringify(r).replace(/"/g,"&quot;"),l=A(r.name),c=A(r.category||"Geral"),d=A(r.contactName||"");n+=`
    ...
    `;s.forEach(r=>{const a=JSON.stringify(r).replace(/"/g,"&quot;"),l=A(r.name),c=A(r.taxId||"Sem doc."),d=A(r.email||"-"),p=A(r.phone||"-"),h=A(r.category||"Geral");o+=`
        ...
        `}),o+="</tbody></table></div>",t.innerHTML=n+o}function Vw(t){const e=t.phone?`https://wa.me/${t.phone.replace(/\D/g,"")}`:"#",s=t.phone?`tel:${t.phone}`:"#",n=t.email?`mailto:${t.email}`:"#",o=JSON.stringify(t).replace(/"/g,"&quot;"),r=A(t.name),a=A(t.category||"Fornecedor"),l=A(t.contactName||""),c=A(t.phone||""),d=`
    ...
    `;Pe({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Tn(){const t=document.getElementById("purchasesContainer");if(t)if(le.step===1){t.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[e,s]=await Promise.all([pr(w.establishmentId),al(w.establishmentId)]);le.allSuppliers=s||[];const n=e.filter(d=>{const p=parseInt(d.currentStock||0),h=parseInt(d.minStock||0);return p<=h});if(le.productsToBuy=n,n.length===0){t.innerHTML=`
            ...
            `,ai()}catch(e){console.error(e),t.innerHTML='<p class="text-red-500 text-center">Erro ao calcular compras.</p>'}}else le.step===2&&Fw(t)}function Fw(t){if(!le.finalOrders||Object.keys(le.finalOrders).length===0){le.step=1,Tn();return}const e=le.isQuoteMode;let s="",n=0;const o=e?"border-indigo-100":"border-gray-200",r=e?"bg-indigo-50 border-indigo-100":"bg-gray-50 border-gray-200",a=e?"bg-blue-100 text-blue-700":"bg-green-100 text-green-700",l=e?"hidden":"flex",c=e?"Cotações Prontas":"Pedidos Prontos",d=e?"text-indigo-600":"text-green-600",p=e?"bg-indigo-50 border-indigo-100":"bg-green-50 border-green-100",h=e?"text-indigo-800":"text-green-800";for(const[f,y]of Object.entries(le.finalOrders)){let I=0,_=y.items.map(H=>{const G=H.qty*H.cost;return I+=G,`
    ...
    `}async function _p(){const t=document.getElementById("historyContainer");if(t){t.innerHTML='<div class="loader mx-auto my-8"></div>';try{const e=await Sw(w.establishmentId);if(e.length===0){t.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let s='<div class="flex flex-col gap-3 md:hidden">';e.forEach(r=>{const a=new Date(r.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),l=A(r.supplierName);s+=`
        ...
        `;t.innerHTML=s+o}catch(e){console.error(e),t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function Ow(t){const e=new Date(t.createdAt.seconds*1e3).toLocaleString("pt-BR"),s=t.items.map(o=>`
    ...
    `;Pe({title:t?"Editar Fornecedor":"Novo Fornecedor",contentHTML:e,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Bw),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>mr("genericModal"))},50)}function jw(){Wt.innerHTML=`
    ...
    `,At&&(Wt.removeEventListener("click",At),Wt.removeEventListener("input",At),Wt.removeEventListener("change",At)),At=t=>{if(t.target.closest("#tab-btn-list")&&Io("list"),t.target.closest("#tab-btn-purchases")&&Io("purchases"),t.target.closest("#tab-btn-history")&&Io("history"),t.target.id==="toggle-quote-mode"&&(le.isQuoteMode=t.target.checked,Tn()),t.target.id==="supplierSearchInput"&&Mr(),t.target.closest("#btn-new-supplier")&&jd(),t.target.closest(".supplier-item-mobile")){const s=t.target.closest(".supplier-item-mobile"),n=JSON.parse(s.dataset.supplier);Vw(n)}const e=t.target.closest("button[data-action]");if(e){const s=e.dataset.action;s==="delete"&&Nw(e.dataset.id),s==="edit"&&jd(JSON.parse(e.dataset.supplier))}if((t.target.classList.contains("qty-input")||t.target.classList.contains("row-select"))&&ai(),t.target.id==="check-all-rows"){const s=t.target.checked;document.querySelectorAll(".row-select").forEach(n=>n.checked=s),ai()}if(t.target.closest("#btn-go-to-orders")){const s=document.querySelectorAll(".product-row"),n={};let o=!1;if(s.forEach(r=>{if(r.offsetParent===null||!r.querySelector(".row-select").checked)return;o=!0;let l="Produto";const c=r.querySelector("td:nth-child(2)"),d=r.querySelector(".font-bold");c?l=c.innerText:d&&(l=d.innerText);const p=parseInt(r.querySelector(".qty-input").value),h=parseFloat(r.dataset.cost),y=r.querySelector(".supplier-select").value;if(y){if(!n[y]){const I=le.allSuppliers.find(_=>_.id===y);n[y]={info:I,items:[]}}n[y].items.push({name:l,qty:p,cost:h})}}),!o){k("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}le.finalOrders=n,le.step=2,Tn()}if(t.target.closest("#btn-back-step1")&&(le.step=1,Tn()),t.target.closest(".btn-send-order")){const s=t.target.closest(".btn-send-order"),n=JSON.parse(decodeURIComponent(s.dataset.supplierInfo)),o=JSON.parse(decodeURIComponent(s.dataset.orderItems)),r=parseFloat(s.dataset.total),a=le.isQuoteMode;if(n.phone){const l=n.phone.replace(/\D/g,"");let c="";a?(c=`Olá *${n.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${n.email}?subject=${encodeURIComponent(l)}&body=${encodeURIComponent(c)}`;window.location.href=d}else k("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(t.target.closest(".btn-register-order")){const s=t.target.closest(".btn-register-order");if(s.disabled)return;const n=JSON.parse(decodeURIComponent(s.dataset.order));n.establishmentId=w.establishmentId,s.disabled=!0,s.textContent="A processar...",ms(w.establishmentId).then(o=>{const r=o.purchaseConfig||null;return Ew(n,r)}).then(()=>{k("Sucesso","Compra registrada e integrada ao financeiro!","success"),s.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',s.classList.replace("bg-blue-600","bg-green-600"),s.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(o=>{s.disabled=!1,s.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',k("Erro","Falha ao registrar compra: "+o.message,"error")})}if(t.target.closest(".btn-delete-purchase")){const n=t.target.closest(".btn-delete-purchase").dataset.id;re("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async o=>{if(o)try{await Iw(n,w.establishmentId),k("Sucesso","Compra e financeiro excluídos.","success"),_p()}catch(r){k("Erro","Erro ao excluir: "+r.message,"error")}})}if(t.target.closest(".btn-print-order")){const n=t.target.closest(".supplier-order-card").dataset.supplierId,o=le.finalOrders[n];o?qw(o,le.isQuoteMode):k("Erro","Dados do pedido não encontrados.","error")}if(t.target.closest(".btn-view-purchase")){const s=t.target.closest(".btn-view-purchase"),n=JSON.parse(s.dataset.purchase);Ow(n)}},Wt.addEventListener("click",At),Wt.addEventListener("input",At),Wt.addEventListener("change",At),Io("list")}function Io(t){Oo=t,["list","purchases","history"].forEach(s=>{const n=document.getElementById(`tab-btn-${s}`),o=document.getElementById(`tab-content-${s}`);s===t?(n.classList.add("border-indigo-500","text-indigo-600"),n.classList.remove("border-transparent","text-gray-500"),o.classList.remove("hidden")):(n.classList.remove("border-indigo-500","text-indigo-600"),n.classList.add("border-transparent","text-gray-500"),o.classList.add("hidden"))});const e=document.getElementById("btn-new-supplier");e&&(t==="list"?e.classList.remove("hidden"):e.classList.add("hidden")),Rw()}const Sa=document.getElementById("content"),Hd={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let mt=new Set,So=null,ks=null;function Hw(t=8){let e="";for(let s=0;s<t;s++)e+=`
        ...
        `;return e}function Uw(t){return t.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':t.map(e=>{const s=e.status==="inactive",n=A(e.name),o=A(e.specialty||"Especialidade"),r=e.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,a=JSON.stringify(e).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Ta(){const t=document.getElementById("genericModal");t.style.display="none",ks&&t.removeEventListener("click",ks)}async function zw(t){const e=document.getElementById("genericModal"),s=t.id?t:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},n=A(s.name),o=w.services||await ps(w.establishmentId),r=w.professionals||await Ge(w.establishmentId),a=`
        ...
        `).join("")}catch(n){s.innerHTML=`<p class="text-red-500">${n.message}</p>`}}}function Qw(t){const e=document.getElementById("genericModal");ks&&e.removeEventListener("click",ks),ks=async s=>{const n=s.target.closest("button[data-action]");if(!n){const r=s.target.closest(".tab-link");r&&(e.querySelectorAll(".tab-link").forEach(a=>a.classList.remove("active")),r.classList.add("active"),e.querySelectorAll(".tab-content").forEach(a=>a.classList.add("hidden")),document.getElementById(r.dataset.tab).classList.remove("hidden"));return}const o=n.dataset.action;switch(s.stopPropagation(),o){case"close-modal":Ta();break;case"delete-professional":const r=n.dataset.id;if(await re("Excluir Profissional",`Tem certeza que deseja excluir ${t.name}? Esta ação não pode ser desfeita.`))try{await bu(r),k("Sucesso!","Profissional excluído.","success"),Ta(),rr()}catch(_){k("Erro",`Não foi possível excluir: ${_.message}`,"error")}break;case"save-professional":const l=document.getElementById("professionalForm"),c=n,d=document.getElementById("profScheduleContainer"),p=Array.from(l.querySelectorAll("#profServicesContainer input:checked")).map(_=>_.value),h={};d&&d.querySelectorAll(".day-schedule-card").forEach(_=>{const D=_.querySelector('[data-field="active"]').dataset.day;h[D]={active:_.querySelector('[data-field="active"]').checked,start:_.querySelector('[data-field="start"]').value,end:_.querySelector('[data-field="end"]').value,breakStart:_.querySelector('[data-field="breakStart"]').value,breakEnd:_.querySelector('[data-field="breakEnd"]').value}});const f={...t,id:l.querySelector("#professionalId").value||void 0,name:l.querySelector("#profName").value,specialty:l.querySelector("#profSpecialty").value,photo:l.querySelector("#profPhotoBase64").value,services:p,workingHours:h,phone:l.querySelector("#profPhone").value,dob:`${l.querySelector("#profDobDay").value}/${l.querySelector("#profDobMonth").value}`,receivesCommission:l.querySelector("#profCommission").value==="sim",showOnAgenda:l.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(l.querySelector("#profOrderOnAgenda").value)||1,notes:l.querySelector("#profNotes").value,status:l.querySelector("#profStatus").value,establishmentId:w.establishmentId};c.disabled=!0,c.textContent="A salvar...";try{f.id?(await jo(f.id,f),k("Sucesso!","Profissional atualizado.","success")):(delete f.id,await fu(f),k("Sucesso!","Profissional criado.","success")),Ta(),rr()}catch(_){k("Erro",_.message,"error"),c.disabled=!1,c.textContent="Salvar"}break;case"delete-blockage":const y=n.dataset.id;if(await re("Apagar Bloqueio","Tem certeza?"))try{await el(y),k("Bloqueio removido.","success");const _=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";kn(t.id,_)}catch(_){k("Erro",_.message,"error")}break;case"batch-delete-blockage":const I=JSON.parse(n.dataset.ids);if(await re("Apagar em Lote",`Tem certeza que deseja apagar ${I.length} bloqueios com este motivo?`))try{await lp(I),k("Bloqueios removidos.","success");const _=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";kn(t.id,_)}catch(_){k("Erro",_.message,"error")}break}},e.addEventListener("click",ks)}function ii(){const t=document.getElementById("batch-actions-container"),e=document.getElementById("selected-count");!t||!e||(mt.size>0?(e.textContent=`${mt.size} selecionado(s)`,t.classList.remove("hidden")):t.classList.add("hidden"))}function Xw(){re("Excluir em Lote",`Tem certeza que deseja excluir ${mt.size} profissionais? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await Gh(Array.from(mt)),k("Sucesso!",`${mt.size} profissionais foram excluídos.`,"success"),mt.clear(),ii(),rr()}catch(e){k("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}function un(){const t=document.getElementById("professionalsList");if(!t)return;if(!w.professionals){t.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",t.innerHTML=Hw();return}const e=document.getElementById("showInactiveProfToggle").checked,s=document.getElementById("profSearchInput").value.toLowerCase(),n=w.professionals.filter(o=>{const r=o.name.toLowerCase().includes(s),a=e||o.status!=="inactive";return r&&a});t.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",t.innerHTML=Uw(n)}async function rr(){mt.clear(),Sa.innerHTML=`
        ...
        </section>`,So&&Sa.removeEventListener("click",So),So=e=>{const s=e.target.closest('[data-action="open-professional-modal"]'),n=e.target.closest('[data-action="batch-delete"]');if(s){e.preventDefault();let r={};if(s.dataset.professional)try{r=JSON.parse(s.dataset.professional)}catch(a){console.error("Erro ao fazer parse do professional data:",a);return}zw(r);return}if(n){Xw();return}const o=e.target.closest(".professional-checkbox");if(o){const r=o.dataset.id;o.checked?mt.add(r):mt.delete(r),un(),ii();return}},Sa.addEventListener("click",So),document.getElementById("profSearchInput").addEventListener("input",un),document.getElementById("showInactiveProfToggle").addEventListener("change",un);const t=document.getElementById("professionalsList");w.professionals=null,w.services=null,un();try{const[e,s]=await Promise.all([Ge(w.establishmentId),ps(w.establishmentId)]);w.professionals=e,w.services=s,un(),ii()}catch{t.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const ka=document.getElementById("content");let pt=[],vt={},Me=null,li="list",ze="all",ci="O Estabelecimento";const Yw=1,Zw=(t,e)=>`Olá, ${t}! Nós da ${e} desejamos a você um Feliz Aniversário! Esperamos que seu dia seja maravilhoso. Venha comemorar conosco! 🎉🎂`,e1=(t,e)=>`Oi, ${t}! Faz um tempo que não te vemos aqui no(a) ${e}. Sentimos sua falta! Temos novidades/ofertas especiais para você. Que tal agendar seu horário?`,t1=[{value:30,label:"30 dias"},{value:60,label:"60 dias"},{value:90,label:"90 dias"},{value:120,label:"120 dias"}];function s1(){return Math.floor(Math.random()*140)+10}function n1(t){if(!t.dob)return!1;const e=t.dob.split("/");if(e.length!==2)return!1;const s=new Date,n=s.getDate(),o=s.getMonth()+1,r=parseInt(e[0],10),a=parseInt(e[1],10);return r===n&&a===o}const o1=[{value:99,label:"Aniversariantes de Hoje"},{value:0,label:"Todos os meses (com DOB)"},{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}];function Ud(){return o1.map(t=>{let e=t.value===99?"selected":"";return`<option value="${t.value}" ${e}>${t.label}</option>`}).join("")}function zd(){return t1.map(t=>{const e=t.value===90?"selected":"";return`<option value="${t.value}" ${e}>${t.label}</option>`}).join("")}function cl(t){if(!t)return 0;let e=0;if(t.totalAmount!==void 0&&t.totalAmount!==null?e=parseFloat(t.totalAmount):t.value!==void 0&&t.value!==null?e=parseFloat(t.value):t.price!==void 0&&t.price!==null&&!Array.isArray(t.price)&&(e=parseFloat(t.price)),!e||e===0){let s=0;t.services&&Array.isArray(t.services)&&(s+=t.services.reduce((o,r)=>{const a=parseFloat(r.price)||parseFloat(r.servicePrice)||0;return o+a},0));const n=t.comandaItems||t.items;n&&Array.isArray(n)&&(s+=n.reduce((o,r)=>{const a=parseFloat(r.price)||0,l=parseInt(r.quantity)||1;return o+a*l},0)),s>0&&(e=s)}return isNaN(e)?0:e}function r1(t,e){const s=`w-5 h-5 ${e} mr-2`;switch(t){case"cadastro":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>`;case"agendamentos":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`;case"historico":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v2a2 2 0 01-2 2h-2.586a1 1 0 00-.707.293l-1.414 1.414a1 1 0 01-1.414 0l-1.414-1.414A1 1 0 009.586 17H7a2 2 0 01-2-2v-2a2 2 0 012-2h12z" /></svg>`;case"fidelidade":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.5a9.5 9.5 0 1019 0 9.5 9.5 0 00-19 0z" /></svg>`;default:return""}}function a1(t="cadastro"){const e=[{id:"cadastro",label:"Cadastro"},{id:"agendamentos",label:"Agend."},{id:"historico",label:"Histórico"},{id:"fidelidade",label:"Fidelidade"}],s=document.getElementById("client-detail-tabs");s&&(s.innerHTML=e.map(n=>{const o=t===n.id,r=o?"text-indigo-600":"text-gray-500";return`
        ...
        `}).join(""),s.querySelectorAll(".tab-btn").forEach(n=>{n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),di(n.dataset.tab)})}))}async function di(t){a1(t);const e=document.getElementById("client-detail-content");if(e){e.innerHTML='<div class="flex h-64 items-center justify-center"><div class="loader"></div></div>';try{switch(t){case"cadastro":e.innerHTML=i1(Me);break;case"agendamentos":case"historico":const s=await Ld(w.establishmentId,Me.name,Me.phone);e.innerHTML=l1(s,t);break;case"fidelidade":let n=[],o=[];try{n=await Ld(w.establishmentId,Me.name,Me.phone)}catch(r){console.error("Erro ao buscar histórico de vendas:",r)}if(vt&&vt.enabled)try{o=await cx(w.establishmentId,Me.name,Me.phone)}catch(r){console.warn("Aviso: Histórico de fidelidade indisponível.",r)}e.innerHTML=d1(Me,n,o);break;default:e.innerHTML='<p class="p-6 text-center text-gray-500">Seção não implementada.</p>'}}catch(s){console.error("Erro crítico ao carregar aba:",s),e.innerHTML=`<div class="p-6 text-center text-red-500"><p>Erro ao carregar dados.</p><p class="text-xs mt-2">${A(s.message)}</p></div>`}}}function i1(t){const e=t?.dob?t.dob.split("/"):["",""],s=A(t?.name||""),n=A(t?.email||""),o=A(t?.phone||""),r=A(t?.notes||""),a=!!t?.id,l=a?"disabled":"",c=a?"mt-1 w-full p-2 border border-gray-300 rounded-md bg-gray-100 text-gray-500 cursor-not-allowed":"mt-1 w-full p-2 border border-gray-300 rounded-md",d=a?'<p class="text-xs text-orange-600 mt-1">O telefone é o ID e não pode ser alterado.</p>':"";return`
    ...
    `}function c1(t,e){const s=(t||[]).filter(c=>{const d=(c.status||"").toLowerCase();return d==="completed"||d==="finished"||d==="paid"||d==="finalized"});let n=0;s.forEach(c=>{n+=cl(c)});let o=vt&&vt.conversionRate?parseFloat(vt.conversionRate):Yw;o<=0&&(o=1);const r=Math.floor(n/o);let a=0;(e||[]).forEach(c=>{c.type==="redeem"&&(a+=c.points?Math.abs(c.points):0)});const l=r-a;return{totalSpent:n,totalPointsEarned:r,totalPointsRedeemed:a,currentBalance:l,moneyPerPoint:o}}function d1(t,e,s){if(!vt||!vt.enabled)return`<div class="p-8 text-center text-gray-500">
    ...
    `}function Ap(t){Me=t,li="detail";const e=t!==null,s=e?"Editar Cliente":"Adicionar Cliente",n=`
    ...
    `,o=window.innerWidth<768,r=o?"max-w-full":"max-w-3xl";if(Pe({title:s,contentHTML:n,maxWidth:r}),o){const d=document.getElementById("genericModal");if(d){const p=d.querySelector(`.${r.replace(":","\\:")}`);p&&(p.style.height="auto",p.style.maxHeight="85vh",p.style.borderRadius="1rem")}}const a=document.getElementById("genericModal");a&&(a.onclick=async d=>{const p=d.target.closest("[data-action]");if(!p)return;switch(p.dataset.action){case"redeem-reward":{const f=parseInt(p.dataset.points,10),y=p.dataset.reward;if(await re("Confirmar Resgate",`Deseja resgatar "${y}" por ${f} pontos?`))try{await dx(w.establishmentId,Me.name,Me.phone,{points:f,reward:y}),k("Prêmio resgatado com sucesso!","success"),await di("fidelidade")}catch(_){k(`Erro ao resgatar: ${_.message}`,"error")}break}case"open-comanda-from-history":{const f=p.dataset.appointmentId;f&&(document.getElementById("genericModal").style.display="none",Ye("comandas-section",{selectedAppointmentId:f,initialFilter:"finalizada"}));break}case"view-appointment":{const f=p.dataset.appointmentId,y=p.dataset.appointmentDate;f&&y&&(document.getElementById("genericModal").style.display="none",Ye("agenda-section",{targetDate:y,scrollToAppointmentId:f}));break}case"save-client":{d.preventDefault(),Wd();break}}}),di("cadastro"),setTimeout(()=>{const d=document.getElementById("client-form");d&&d.addEventListener("submit",p=>{p.preventDefault(),Wd()})},500);const l=document.getElementById("cancelDetailViewBtn");l&&l.addEventListener("click",d=>{d.preventDefault(),document.getElementById("genericModal").style.display="none";const p=document.getElementById("clientSearchInput")?.value||"",h=_n(p,ze);Cn(h,pt.length)});const c=document.getElementById("deleteClientBtn");c&&c.addEventListener("click",async()=>{await u1()})}async function Wd(){const t=document.getElementById("client-form");if(!t)return;const e=t.querySelector("#clientId").value,n=t.querySelector("#clientPhone").value.trim(),o={name:t.querySelector("#clientName").value.trim(),email:t.querySelector("#clientEmail").value.trim(),phone:n,dob:`${t.querySelector("#clientDobDay").value}/${t.querySelector("#clientDobMonth").value}`,notes:t.querySelector("#clientNotes").value.trim(),establishmentId:w.establishmentId};if(!o.name||!o.phone){k("Erro","Nome e Telefone são obrigatórios.","error");return}try{if(e)await dp(e,o),k("Sucesso","Cliente atualizado com sucesso!","success"),document.getElementById("genericModal").style.display="none",await An();else{const r=n.replace(/\D/g,""),a=await up(w.establishmentId,r);a?await re("Cliente Já Existe",`O número ${n} já pertence a "${a.name}".

Deseja ATUALIZAR os dados deste cadastro existente? (O histórico será mantido)`)&&(await nr(o),k("Sucesso","Cadastro existente atualizado!","success"),document.getElementById("genericModal").style.display="none",await An()):(await nr(o),k("Sucesso","Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",await An())}}catch(r){k("Erro",`Não foi possível salvar: ${r.message}`,"error")}}async function u1(){if(!Me||!Me.id)return;if(await re("Excluir Cliente",`Tem certeza que deseja excluir ${Me.name}? Esta ação é irreversível.`))try{await lx(Me.id),k("Sucesso","Cliente excluído.","success"),document.getElementById("genericModal").style.display="none",await An()}catch(e){k("Erro",`Não foi possível excluir: ${e.message}`,"error")}}function Cn(t,e){const s=document.getElementById("clientsList");if(s)if(s.innerHTML="",s.className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 content-start p-2 pb-20",document.getElementById("client-count").textContent=`${t.length} cliente${t.length!==1?"s":""} | Total: ${e}`,t.length>0){const n=ze==="inactive",o=ze==="birthdays";t.forEach(r=>{const a=document.createElement("div");a.className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 hover:shadow-md cursor-pointer transition-all flex flex-col justify-between h-full relative group",a.dataset.clientId=r.id;const l=parseInt(r.loyaltyPoints||0),c=r.totalSpent||0;let d="";const h=`https://wa.me/55${r.phone?r.phone.replace(/\D/g,""):""}?text=`,f=A(r.name),y=A(r.phone);if(n){const I=encodeURIComponent(e1(r.name,ci));d=`<a href="${h+I}" target="_blank" class="absolute top-2 right-2 text-blue-500 bg-blue-50 p-1 rounded-full z-10 hover:bg-blue-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 16.64C16.64 16.64 15.11 17.58 14.54 17.76C13.97 17.94 13.06 18.06 10.66 17.06C8.26 16.06 6.38 13.62 6.38 13.62C6.38 13.62 4.96 11.72 4.96 9.76C4.96 7.8 6.04 6.88 6.04 6.88C6.04 6.88 6.32 6.56 6.6 6.56C6.88 6.56 7.16 6.56 7.16 6.56C7.38 6.56 7.62 6.46 7.86 7.02C8.1 7.58 8.68 9.02 8.68 9.02C8.68 9.02 8.78 9.24 8.64 9.48C8.5 9.72 8.36 9.88 8.16 10.1C7.96 10.32 7.74 10.4 8.02 10.88C8.3 11.36 9.26 12.92 10.68 14.18C11.62 15.02 12.56 15.36 12.94 15.54C13.32 15.72 13.6 15.66 13.84 15.38C14.08 15.1 14.62 14.34 14.62 14.34C14.62 14.34 14.88 14.06 15.18 14.12C15.48 14.18 16.94 14.9 16.94 14.9C16.94 14.9 17.2 15.04 17.3 15.22C17.4 15.4 17.4 16.28 16.64 16.64Z"/></svg></a>`}else if(o&&n1(r)){const I=encodeURIComponent(Zw(r.name,ci));d=`<a href="${h+I}" target="_blank" class="absolute top-2 right-2 text-green-500 bg-green-50 p-1 rounded-full z-10 hover:bg-green-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 16.64C16.64 16.64 15.11 17.58 14.54 17.76C13.97 17.94 13.06 18.06 10.66 17.06C8.26 16.06 6.38 13.62 6.38 13.62C6.38 13.62 4.96 11.72 4.96 9.76C4.96 7.8 6.04 6.88 6.04 6.88C6.04 6.88 6.32 6.56 6.6 6.56C6.88 6.56 7.16 6.56 7.16 6.56C7.38 6.56 7.62 6.46 7.86 7.02C8.1 7.58 8.68 9.02 8.68 9.02C8.68 9.02 8.78 9.24 8.64 9.48C8.5 9.72 8.36 9.88 8.16 10.1C7.96 10.32 7.74 10.4 8.02 10.88C8.3 11.36 9.26 12.92 10.68 14.18C11.62 15.02 12.56 15.36 12.94 15.54C13.32 15.72 13.6 15.66 13.84 15.38C14.08 15.1 14.62 14.34 14.62 14.34C14.62 14.34 14.88 14.06 15.18 14.12C15.48 14.18 16.94 14.9 16.94 14.9C16.94 14.9 17.2 15.04 17.3 15.22C17.4 15.4 17.4 16.28 16.64 16.64Z"/></svg></a>`}a.innerHTML=`
                ${d}
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const p={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,document:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};zs(p,d)})}function $1(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-email-form").addEventListener("submit",async s=>{s.preventDefault();const n=e.querySelector("#newEmail").value,o=e.querySelector("#currentPassword").value;if(!n||!o){k("Erro","Preencha todos os campos.","error");return}const r=e.querySelector('button[form="change-email-form"]');r.disabled=!0,r.textContent="A verificar...";try{const a=_e.currentUser;if(!a)throw new Error("Usuário não autenticado.");const l=bh.credential(a.email,o);await vh(a,l),r.textContent="A enviar link...",await yh(a,n),r.textContent="A atualizar BD...",await zh(w.establishmentId,n),k("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),s.target.reset()}catch(a){let l="Não foi possível alterar o e-mail.";a.code==="auth/wrong-password"?l="A senha atual está incorreta.":a.code==="auth/email-already-in-use"?l="Este e-mail já está sendo usado por outra conta.":a.code==="auth/operation-not-allowed"?l="A troca de e-mail precisa ser habilitada no console do Firebase.":l=a.message,k("Erro",l,"error")}finally{r.disabled=!1,r.textContent="Salvar Novo E-mail"}})}function L1(t,e){const s=A(t.welcomeMessage||"");e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const s=e.querySelector("#establishmentTimezone");if(t.timezone)s.value=t.timezone;else try{const r=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(s.options).some(l=>l.value===r)?s.value=r:s.value="America/Sao_Paulo"}catch{s.value="America/Sao_Paulo"}const n=e.querySelector("#establishmentWorkingHoursContainer"),o=t.workingHours||{};Object.keys(Ca).forEach(r=>{const a=o[r]||{},l=Ca[r],c=a.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${c?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,n.appendChild(d)}),n.addEventListener("change",r=>{const a=r.target.closest('.day-schedule-card input[type="checkbox"]');a&&a.closest(".day-schedule-card").classList.toggle("disabled",!a.checked)}),e.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const a={};Object.keys(Ca).forEach(c=>{a[c]={active:e.querySelector(`#est-${c}-active`).checked,start:e.querySelector(`#est-${c}-start`).value,end:e.querySelector(`#est-${c}-end`).value,breakStart:e.querySelector(`#est-${c}-breakStart`).value,breakEnd:e.querySelector(`#est-${c}-breakEnd`).value}});const l=e.querySelector("#establishmentTimezone").value;zs({workingHours:a,timezone:l},r)})}function N1(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[s,n]=await Promise.all([jn(w.establishmentId),Hn(w.establishmentId)]),o=t.financialIntegration||{},r=t.commissionConfig||{},a=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=ws(s,o.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=ws(n,o.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=ws(s,a.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=ws(n,a.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=ws(s,r.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=ws(n,r.defaultCostCenterId)}catch{k("Erro","Não foi possível carregar os dados para a integração financeira.","error")}e.querySelector("#financial-form").addEventListener("submit",s=>{s.preventDefault();const n={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};zs(n,s)})}function V1(t,e){const s="5516997859430",n=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),o=`https://wa.me/${s}?text=${n}`;e.innerHTML=`
    ...
    `}function F1(t,e){const s="5516997859430",n=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),o=`https://wa.me/${s}?text=${n}`,r="sistemakairosagenda@gmail.com";e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function O1(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${t}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function Np(t="indigo",e){const s=e.querySelector("#color-palette-container"),n=e.querySelector("#establishmentThemeColor");!s||!n||(s.innerHTML="",Object.entries(A1).forEach(([o,r])=>{const a=o===t,l=document.createElement("div");l.className="w-24 text-center cursor-pointer mb-4",l.innerHTML=`
    ...
    `,Qt.querySelector('button[data-action="back-to-list"]').addEventListener("click",n=>{n.preventDefault(),Bp()});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":P1(Re,s);break;case"change-password":$1(Re,s);break;case"change-email":D1(Re,s);break;case"branding":L1(Re,s);break;case"booking":R1(Re,s);break;case"working-hours":M1(Re,s);break;case"loyalty":N1(Re,s);break;case"financial":await B1(Re,s);break;case"support":V1(Re,s);break;case"cancellation":F1(Re,s);break;default:O1(e?e.label:"Definições",s)}}async function Bp(){if(Qt.innerHTML=`
    ...
    `,Qt.querySelector("#settings-menu-list").addEventListener("click",r=>{const a=r.target.closest("button[data-section]");a&&(r.preventDefault(),j1(a.dataset.section))});const o=Qt.querySelector('[data-action="go-to-my-profile"]');o&&o.addEventListener("click",r=>{r.preventDefault(),Ye("my-profile-section")})}const Pn=document.getElementById("content");async function $s(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const s=document.getElementById("filterStartDate")?.value,n=document.getElementById("filterEndDate")?.value,o=await Ar(w.establishmentId,s||new Date().toISOString().split("T")[0],n||new Date().toISOString().split("T")[0],t),r=document.getElementById("filterReason")?.value.toLowerCase(),a=r?o.filter(c=>c.reason&&c.reason.toLowerCase().includes(r)):o,l=a.reduce((c,d)=>{const p=d.reason||"Sem motivo";return c[p]||(c[p]=[]),c[p].push(d),c},{});if(e.innerHTML="",a.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(l).forEach(([c,d])=>{const p=document.createElement("div");p.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let f=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;p.innerHTML+=N}),e.appendChild(p)})}catch(s){e.innerHTML=`<p class="text-center text-red-500">Erro: ${s.message}</p>`}}}async function H1(t){t.preventDefault();const e=t.target,s=e.querySelector("#blockageProfId").value,n=e.querySelector("#blockageDate").value,o=e.querySelector("#blockageEndDate").value||n,r=e.querySelector("#blockageStartTime").value,a=e.querySelector("#blockageEndTime").value,l={establishmentId:w.establishmentId,professionalId:s,startTime:new Date(`${n}T${r}:00`).toISOString(),endTime:new Date(`${o}T${a}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Pr(l),e.reset(),k("Sucesso","Bloqueio adicionado com sucesso!","success"),$s(s)}catch(c){k("Erro",`Não foi possível criar o bloqueio: ${c.message}`,"error")}}async function U1(t){t.preventDefault();const e=t.target,s=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(p=>p.value);if(s.length===0)return k("Atenção","Selecione pelo menos um profissional.","error");const n=e.querySelector("#batchBlockageDate").value,o=e.querySelector("#batchBlockageEndDate").value||n,r=e.querySelector("#batchBlockageStartTime").value,a=e.querySelector("#batchBlockageEndTime").value,l=e.querySelector("#batchBlockageReason").value,c=e.querySelector('button[type="submit"]');c.disabled=!0,c.textContent="Aguarde...";const d=s.map(p=>{const h={establishmentId:w.establishmentId,professionalId:p,startTime:new Date(`${n}T${r}:00`).toISOString(),endTime:new Date(`${o}T${a}:00`).toISOString(),reason:l};return Pr(h)});try{await Promise.all(d),k("Sucesso",`${s.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(h=>h.checked=!1);const p=document.getElementById("blockageProfId").value;p&&$s(p)}catch(p){k("Erro",`Ocorreu um erro: ${p.message}`,"error")}finally{c.disabled=!1,c.textContent="Adicionar Bloqueio em Lote"}}function z1(t){Pn.addEventListener("submit",e=>{e.target.id==="blockageForm"&&H1(e),e.target.id==="batchBlockageForm"&&U1(e)}),Pn.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&$s(t)}),Pn.addEventListener("click",async e=>{const s=e.target.closest("button[data-action]");if(!s)return;const n=s.dataset.action;if(n==="back-to-professionals")Ye("profissionais-section");else if(n==="delete-blockage"){if(await re("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await el(s.dataset.id),k("Sucesso","Bloqueio removido.","success"),$s(t)}catch(r){k("Erro",`Não foi possível remover o bloqueio: ${r.message}`,"error")}}else if(n==="batch-delete-blockage"){const o=JSON.parse(s.dataset.ids);if(await re("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await lp(o),k("Sucesso",`${o.length} bloqueios removidos.`,"success"),$s(t)}catch(a){k("Erro",`Não foi possível apagar os bloqueios: ${a.message}`,"error")}}})}async function W1(t){const{professionalId:e,professionalName:s}=t;if(!e||!s){Pn.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const n=A(s);Pn.innerHTML=`
        <section>
        ...
        </section>`,z1(e),await $s(e);const o=document.getElementById("batchProfSelectionContainer");try{const r=await Ge(w.establishmentId);o.innerHTML=r.map(a=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{o.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const G1=t=>F(`/api/users/${t}`),K1=t=>F("/api/users",{method:"POST",body:JSON.stringify(t)}),J1=(t,e)=>F(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),Q1=t=>F(`/api/users/${t}`,{method:"DELETE"}),X1=(t,e)=>F(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),Y1=(t,e)=>F(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),Gt=document.getElementById("content"),Z1={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},e2={view:"Visualizar",create:"Criar",edit:"Editar"};let mn=null,pn=null;function t2(t){const e=document.getElementById("usersListContainer");if(!e)return;const s=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const n=s?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";e.innerHTML=`<p class="col-span-full text-center text-gray-500">${n}</p>`;return}t.sort((n,o)=>(n.status==="active"?-1:1)-(o.status==="active"?-1:1)),e.innerHTML=t.map(n=>{const o=JSON.stringify(n).replace(/'/g,"&apos;"),r=n.status==="active",a=w.professionals.find(p=>p.id===n.professionalId),l=a?a.name:"N/A",c=a?a.name.charAt(0):n.name.charAt(0),d=a?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(c)}`;return`
    ...
    `}).join("")}function qo(){const t=document.getElementById("showInactiveUsersToggle")?.checked;let e;t?e=w.users:e=w.users.filter(s=>s.status==="active"),t2(e)}function s2(t={}){return Object.entries(Z1).map(([e,s])=>{const n=e==="agenda-section"||e==="comandas-section",o=t[e]?.view_all_prof===!0,r=Object.entries(e2).map(([l,c])=>`
    ...
    `,mn&&Gt.removeEventListener("click",mn),pn&&Gt.removeEventListener("change",pn),mn=async t=>{if(!document.getElementById("user-list-view")){Gt.removeEventListener("click",mn);return}const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":Kd();break;case"edit-user":const n=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));Kd(n);break;case"back-to-list":ar();break;case"delete-user":{t.stopPropagation();const o=e.dataset.userId;if(await re("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await Q1(o),k("Usuário excluído com sucesso!","success"),ar()}catch(a){k(`Erro ao excluir: ${a.message}`,"error")}break}}},pn=async t=>{if(!document.getElementById("user-list-view")){Gt.removeEventListener("change",pn);return}const e=t.target.closest('input[data-action="toggle-user-status"]');if(t.target.id==="showInactiveUsersToggle")qo();else if(e){t.stopPropagation();const s=e.dataset.userId,n=e.checked?"active":"inactive";try{await Y1(s,n),k(`Usuário ${n==="active"?"ativado":"inativado"} com sucesso.`,"success");const o=w.users.findIndex(r=>r.id===s);o>-1&&(w.users[o].status=n,qo())}catch(o){k(`Erro ao atualizar status: ${o.message}`,"error"),e.checked=!e.checked,qo()}}},Gt.addEventListener("click",mn),Gt.addEventListener("change",pn),await n2()}const o2=document.getElementById("content");let Jd={},ui=null;function r2(){Object.values(Jd).forEach(t=>t?.destroy()),Jd={}}function a2(t,e){if(!window.jspdf){k("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:s}=window.jspdf,n=new s({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(n.setFontSize(18),n.text(t,n.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const a=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];n.autoTable({startY:60,head:[["Métrica","Valor"]],body:a,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=n.lastAutoTable?n.lastAutoTable.finalY+20:60;n.text("Detalhes das Vendas",20,r),n.autoTable({html:`#${e}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),n.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Qd(t){const e=document.getElementById("genericModal"),s=A(t.client),n=A(t.items),o=A(t.responsavelCaixa||"N/A"),r=(t.payments||[]).map(a=>`
    ...
    `,e.style.display="flex"}function i2(t){const{summary:e,transactions:s}=t;document.getElementById("summary-revenue").textContent=`R$ ${e.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=e.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${e.averageTicket.toFixed(2)}`;const n=document.getElementById("paymentSummaryTableBody"),o=Object.entries(e.paymentMethodTotals).sort(([,l],[,c])=>c-l);n.innerHTML=o.map(([l,c])=>`
        <tr class="border-b">
    ...
    `}).join(""),r.querySelectorAll("tr").forEach(l=>{l.addEventListener("dblclick",()=>{const c=l.dataset.transactionIndex,d=ui.transactions[c];d&&Qd(d)})}),a.innerHTML=s.map((l,c)=>{const d=A(l.client),p=A(l.items),h=A(l.type);return`
    ...
    `}).join(""),a.querySelectorAll("div[data-transaction-index]").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.transactionIndex,d=ui.transactions[c];d&&Qd(d)})})}async function Xd(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),s=document.getElementById("reportEndDate");if(!t||!e||!s)return;const n=e.value,o=s.value;if(!n||!o)return k("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,a=await ax({establishmentId:w.establishmentId,startDate:n,endDate:o,cashierSessionId:r});ui=a,t.innerHTML=`
        ...
        `,i2(a)}catch(r){k("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${A(r.message)}</p>`}}async function l2(){r2();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const s=e.toISOString().split("T")[0];o2.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Xd),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const n=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${n}_a_${o}`;a2(r,"transactionsTable")});try{const n=await Nx(w.establishmentId),o=document.getElementById("cashierSessionFilter");n&&n.length>0&&n.forEach(r=>{const a=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),l=A(r.closedByName||"N/A");o.innerHTML+=`<option value="${r.id}">${l} - ${a}</option>`})}catch{k("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Xd()}const c2=document.getElementById("content");let W={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},_a=null,To=null,ko=null;function dl(t){const e=new Map,s=[];return t&&(t.forEach(n=>e.set(n.id,{...n,children:[]})),e.forEach(n=>{n.parentId&&e.has(n.parentId)?e.get(n.parentId).children.push(n):s.push(n)})),s}function Vp(t,e,s){if(!t)return;if(!e||e.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const n=(o,r=0)=>{const a="— ".repeat(r);return`
        ...
        `};t.innerHTML=e.map(o=>n(o)).join("")}async function Yd(t){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const e=document.getElementById("genericModal"),s=t==="nature",n=`Gerir ${s?"Naturezas Financeiras":"Centros de Custo"}`,o=s?jn:Hn,r=s?"natures":"costCenters";e.innerHTML=`
        ...
        </div>`,e.style.display="flex";const a=e.querySelector("#hierarchyList"),l=e.querySelector("#itemParent"),c=p=>{const h=dl(p);if(Vp(a,h,t),l){l.innerHTML='<option value="">-- Nível Principal --</option>';const f=(y,I="",_=0)=>{const D=_>0?"— ".repeat(_):"";l.innerHTML+=`<option value="${y.id}">${D}${y.name}</option>`,y.children.forEach(R=>f(R,I+"— "))};h.forEach(y=>f(y))}};try{const p=await o(w.establishmentId);W[r]=p,c(p)}catch(p){console.error(p)}const d=e.querySelector("#hierarchyForm");d&&d.addEventListener("submit",async p=>{p.preventDefault();const h=e.querySelector("#itemName");if(!h)return;const f=h.value,y=l.value,I=s?p1:g1;try{await I({name:f,parentId:y||null,establishmentId:w.establishmentId});const _=await o(w.establishmentId);W[r]=_,c(_),d.reset(),await ns()}catch(_){k("Erro",`Não foi possível criar: ${_.message}`,"error")}})}function d2(t){const e=document.getElementById("cashFlowChart");if(!e)return;const s=e.getContext("2d");_a&&_a.destroy();const n=t.payables.map(o=>o*-1);_a=new Chart(s,{type:"bar",data:{labels:t.labels,datasets:[{label:"Receitas",data:t.receivables,backgroundColor:"rgba(74, 222, 128, 0.6)",borderColor:"rgba(34, 197, 94, 1)",borderWidth:1,yAxisID:"y"},{label:"Despesas",data:n,backgroundColor:"rgba(248, 113, 113, 0.6)",borderColor:"rgba(239, 68, 68, 1)",borderWidth:1,yAxisID:"y"},{label:"Saldo Acumulado",data:t.expectedBalance,type:"line",borderColor:"rgba(59, 130, 246, 1)",backgroundColor:"rgba(59, 130, 246, 0.2)",borderWidth:3,pointRadius:4,pointBackgroundColor:"rgba(59, 130, 246, 1)",fill:!0,tension:.1,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{x:{stacked:!0},y:{type:"linear",display:!0,position:"left",stacked:!0,title:{display:!0,text:"Movimentações (R$)"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Saldo Acumulado (R$)"},grid:{drawOnChartArea:!1}}},plugins:{tooltip:{callbacks:{label:function(o){let r=o.dataset.label||"";if(r&&(r+=": "),o.parsed.y!==null){const a=Math.abs(o.parsed.y);r+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(a)}return r}}}}}})}async function Zd(){const t=document.getElementById("cash-flow-chart-container"),e=document.getElementById("cashFlowStartDate"),s=document.getElementById("cashFlowEndDate");if(!t||!e||!s)return;const n=e.value,o=s.value;if(!n||!o){k("Atenção","Por favor, selecione as datas de início e fim.","error");return}t.innerHTML='<div class="loader mx-auto my-10"></div>';try{const r=await C1(w.establishmentId,n,o);document.getElementById("cash-flow-chart-container")&&(t.innerHTML='<canvas id="cashFlowChart"></canvas>',d2(r))}catch(r){document.getElementById("cash-flow-chart-container")&&(t.innerHTML=`<p class="text-red-500 text-center">Erro ao carregar dados do gráfico: ${r.message}</p>`)}}function eu(){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const t=document.getElementById("genericModal"),e=new Date,s=new Date(e.getFullYear(),e.getMonth(),1).toISOString().split("T")[0],n=e.toISOString().split("T")[0];t.innerHTML=`
    ...
    `,t.style.display="flex"}function m2(){const t=document.getElementById("genericModal");t.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.style.display="flex"}function Co(t,e="all"){let s='<option value="all">Todos</option>';const n=a=>{const l=new Map,c=[];return a&&(a.forEach(d=>l.set(d.id,{...d,children:[]})),l.forEach(d=>{d.parentId&&l.has(d.parentId)?l.get(d.parentId).children.push(d):c.push(d)})),c},o=(a,l=0)=>{const c=l>0?"— ".repeat(l):"",d=a.id===e?"selected":"";s+=`<option value="${a.id}" ${d}>${c}${a.name}</option>`,a.children.forEach(p=>o(p,l+1))};return n(t).forEach(a=>o(a)),s}async function ns(){const t=document.getElementById("financial-content");if(!t)return;const e=document.getElementById("filterStartDate"),s=document.getElementById("filterEndDate");if(!e||!s)return;const n=e.value,o=s.value,r=document.getElementById("filterNaturezaId")?.value,a=document.getElementById("filterCostCenterId")?.value;if(!n||!o){try{const[d,p]=await Promise.all([jn(w.establishmentId),Hn(w.establishmentId)]);if(!document.getElementById("financial-content"))return;W={...W,natures:d,costCenters:p},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=Co(W.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=Co(W.costCenters))}catch(d){k("Erro",`Não foi possível carregar os dados base: ${d.message}`,"error")}mi(),su();return}const l=document.getElementById("payables-list"),c=document.getElementById("receivables-list");l&&(l.innerHTML='<div class="loader mx-auto"></div>'),c&&(c.innerHTML='<div class="loader mx-auto"></div>');try{const d={startDate:n,endDate:o,establishmentId:w.establishmentId};r&&r!=="all"&&(d.natureId=r),a&&a!=="all"&&(d.costCenterId=a);const[p,h,f,y]=await Promise.all([v1(d),I1(d),jn(w.establishmentId),Hn(w.establishmentId)]);if(!document.getElementById("financial-content"))return;const I=(h.previousBalance||0)-(p.previousBalance||0);W={...W,payables:p.entries||[],receivables:h.entries||[],natures:f||[],costCenters:y||[],previousBalance:I,filterNaturezaId:r,filterCostCenterId:a},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=Co(W.natures,W.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=Co(W.costCenters,W.filterCostCenterId)),mi(),su()}catch(d){document.getElementById("financial-content")&&(k("Erro",`Não foi possível carregar os dados: ${d.message}`,"error"),t.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function p2(t,e,s=null){t.preventDefault();const n=t.target,o=n.querySelector('[name="status"]').checked,r=n.querySelector('[name="paymentDate"]').value,a=parseFloat(n.querySelector('[name="amount"]').value),l=parseInt(n.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(a)){k("Erro de Validação","O valor inserido é inválido.","error");return}if(o&&!r){k("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const c={description:n.querySelector('[name="description"]').value,amount:a,dueDate:n.querySelector('[name="dueDate"]').value,naturezaId:n.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:n.querySelector('[name="centroDeCustoId"]').value||null,notes:n.querySelector('[name="notes"]').value,status:o?"paid":"pending",paymentDate:o?r:null,installments:s?1:l,establishmentId:w.establishmentId};try{s?(await(e==="payable"?y1(s,c):S1(s,c)),k("Sucesso","Lançamento atualizado!","success")):(await(e==="payable"?b1(c):E1(c)),k("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await ns()}catch(d){k("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function h2(t,e){if(await re("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(t==="payable"?x1(e):T1(e)),k("Sucesso","Lançamento excluído!","success"),await ns()}catch(n){k("Erro",`Falha ao excluir: ${n.message}`,"error")}}async function g2(t,e){const s=new Date().toISOString().split("T")[0];try{await(t==="payable"?w1(e,s):k1(e,s)),k("Sucesso","Lançamento atualizado!","success"),await ns()}catch(n){k("Erro",`Falha ao atualizar status: ${n.message}`,"error")}}function tu(t){const e=W.currentFilter;return e==="all"?t:t.filter(s=>s.status===e)}function mi(){const t=document.getElementById("payables-list"),e=document.getElementById("receivables-list");if(!t||!e)return;const s=new Map(W.natures.map(l=>[l.id,l.name])),n=new Map(W.costCenters.map(l=>[l.id,l.name])),o=tu(W.payables),r=tu(W.receivables),a=(l,c)=>{const d=l.status==="paid",p=JSON.stringify(l).replace(/'/g,"&apos;"),h=l.naturezaId?s.get(l.naturezaId):"N/A",f=l.centroDeCustoId?n.get(l.centroDeCustoId):"N/A";let y=c==="payable"?"text-red-600":"text-green-600";const I=d?"bg-gray-200 text-gray-600":c==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",_=d?"Finalizado":"Pendente";return d&&(y="text-gray-500"),`
    ...
    `;const o=document.getElementById("main-fab-btn"),r=document.getElementById("fab-menu");if(o&&r){o.addEventListener("click",_=>{_.stopPropagation(),r.classList.toggle("hidden"),o.classList.toggle("rotate-45")});const f=r.querySelector('button[data-action="open-modal"][data-type="receivable"]'),y=r.querySelector('button[data-action="open-modal"][data-type="payable"]'),I=r.querySelector('button[data-action="open-cash-flow-modal"]');f&&f.addEventListener("click",_=>{_.stopPropagation(),Aa("receivable")}),y&&y.addEventListener("click",_=>{_.stopPropagation(),Aa("payable")}),I&&I.addEventListener("click",_=>{_.stopPropagation(),eu()})}To&&document.body.removeEventListener("click",To),ko&&document.getElementById("genericModal").removeEventListener("click",ko);const a=()=>{const f=document.getElementById("filterStartDate"),y=document.getElementById("filterEndDate"),I=document.getElementById("filterNaturezaId"),_=document.getElementById("filterCostCenterId");if(!f)return;W.startDate=f.value,W.endDate=y.value,W.filterNaturezaId=I.value,W.filterCostCenterId=_.value;const D=document.getElementById("advanced-filters");D&&D.classList.contains("hidden")===!1&&window.innerWidth<768&&D.classList.add("hidden"),ns()},l=f=>{const y=f.target.closest("[data-status-filter]");if(!y)return;const I=y.dataset.statusFilter;W.currentFilter=I,document.querySelectorAll("[data-status-filter]").forEach(_=>{_.classList.remove("bg-blue-100","text-blue-800"),_.classList.add("bg-gray-100","text-gray-600")}),y.classList.remove("bg-gray-100","text-gray-600"),y.classList.add("bg-blue-100","text-blue-800"),mi()},c=f=>{const y=document.getElementById("payables-container"),I=document.getElementById("receivables-container"),_=document.getElementById("btn-payables-view"),D=document.getElementById("btn-receivables-view");y&&(window.innerWidth>=1024&&W.currentListView===f||(f==="payables"?(y.classList.remove("hidden"),I.classList.add("hidden"),_&&(_.classList.remove("bg-gray-200"),_.classList.add("bg-red-100","border","border-red-500")),D&&(D.classList.remove("bg-green-100","border","border-green-500"),D.classList.add("bg-gray-200"))):(y.classList.add("hidden"),I.classList.remove("hidden"),_&&(_.classList.remove("bg-red-100","border","border-red-500"),_.classList.add("bg-gray-200")),D&&(D.classList.remove("bg-gray-200"),D.classList.add("bg-green-100","border","border-green-500"))),W.currentListView=f))};document.getElementById("applyDateFilterBtn").addEventListener("click",a),document.getElementById("filterNaturezaId").addEventListener("change",()=>{W.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{W.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(f=>{f.addEventListener("click",l)}),To=f=>{const y=f.target.closest("button[data-action]");if(!y)return;const{action:I,type:_,id:D}=y.dataset;I==="edit"?Aa(_,JSON.parse(y.dataset.item.replace(/&apos;/g,"'"))):I==="delete"?h2(_,D):I==="mark-as-paid"?g2(_,D):I==="manage-natures"?Yd("nature"):I==="manage-cost-centers"?Yd("cost-center"):I==="open-cash-flow-modal"?eu():I==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):I==="open-indicators-modal"?u2():I==="open-settings-modal"?m2():I==="toggle-list-view"&&c(y.dataset.list)},ko=f=>{const y=f.target.closest('button[data-action^="delete-"]');if(y){const I=y.dataset.action.split("-")[1];d(I,y.dataset.id)}},document.body.addEventListener("click",To),document.getElementById("genericModal").addEventListener("click",ko);async function d(f,y){const I=f==="nature",_=I?h1:f1,D=I?jn:Hn,R=I?"natures":"costCenters",O=document.getElementById("hierarchyList");if(await re("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await _(y);const B=await D(w.establishmentId);W[R]=B,Vp(O,dl(B),f),await ns()}catch(B){k("Erro",`Não foi possível apagar: ${B.message}`,"error")}}const p=()=>{const f=window.innerWidth<1024,y=document.getElementById("payables-container"),I=document.getElementById("receivables-container"),_=document.getElementById("list-toggle-buttons");y&&I&&(y.classList.remove("hidden"),I.classList.remove("hidden"),f?(y.classList.remove("lg:col-span-1"),I.classList.remove("lg:col-span-1"),_?.classList.remove("hidden"),c(W.currentListView)):(y.classList.add("lg:col-span-1"),I.classList.add("lg:col-span-1"),_?.classList.add("hidden"),y.classList.remove("hidden"),I.classList.remove("hidden")))};p(),window.addEventListener("resize",p);const h=document.querySelector(`[data-status-filter="${W.currentFilter}"]`);h&&(document.querySelectorAll("[data-status-filter]").forEach(f=>{f.classList.remove("bg-blue-100","text-blue-800"),f.classList.add("bg-gray-100","text-gray-600")}),h.classList.remove("bg-gray-100","text-gray-600"),h.classList.add("bg-blue-100","text-blue-800"));try{const f=await _1(w.establishmentId),y=document.getElementById("summary-today-payables");y&&(y.textContent=`R$ ${f.totalPayables.toFixed(2)}`);const I=document.getElementById("summary-today-receivables");I&&(I.textContent=`R$ ${f.totalReceivables.toFixed(2)}`)}catch{}await ns()}const b2=t=>F("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),v2=t=>F("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),y2=(t,e)=>{const s=new URLSearchParams({startDate:t,endDate:e}).toString();return F(`/api/commissions/stats?${s}`)},x2=(t={})=>{Object.keys(t).forEach(n=>(t[n]===void 0||t[n]===null||t[n]==="")&&delete t[n]);const e=new URLSearchParams(t).toString(),s=`/api/commissions/history${e?"?"+e:""}`;return F(s)},w2=t=>F(`/api/commissions/report/${t}`,{method:"DELETE"}),ir=new Date,nu=new Date(ir.getFullYear(),ir.getMonth(),1),J={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:nu.toISOString().split("T")[0],dashEndDate:ir.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:nu.toISOString().split("T")[0],histEndDate:ir.toISOString().split("T")[0],histProfessionalId:"all"};let _o=null;const fn=document.getElementById("content");async function E2(){try{J.professionals=await Ge(w.establishmentId)}catch(t){console.error("Erro profissionais",t)}L2(),I2(),Nr(),cr("dashboard")}function I2(){_o&&fn.removeEventListener("click",_o),_o=t=>{const e=t.target.closest("button");if(!e)return;const s=e.dataset.action,n=e.dataset.id,o=e.dataset.idx;switch(s){case"tab-nav":cr(e.dataset.tab);break;case"toggle-all-profs":S2();break;case"back-to-filters":J.calculationResult=null,lr(document.getElementById("commissions-content"));break;case"view-preview-items":D2(o);break;case"save-final-report":k2();break;case"start-new-calc":cr("calculator");break;case"print-receipt":C2(n);break;case"delete-report":_2(n);break;case"filter-dashboard":Nr();break;case"filter-history":ul();break}},fn.addEventListener("click",_o),fn.oninput=t=>{if(t.target.classList.contains("input-debit")||t.target.classList.contains("input-credit")){const e=t.target.dataset.idx;P2(e)}},fn.onsubmit=t=>{t.target.id==="calc-form"&&(t.preventDefault(),T2())}}async function Nr(){const t=document.getElementById("dash-start"),e=document.getElementById("dash-end");t&&(J.dashStartDate=t.value),e&&(J.dashEndDate=e.value);const s=document.getElementById("dashboard-stats-container");s&&(s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const n=await y2(J.dashStartDate,J.dashEndDate);J.dashStats={revenue:n.totalRevenue||0,commissions:n.totalCommissionsPaid||0},J.currentTab==="dashboard"&&Fp(document.getElementById("commissions-content"))}catch(n){console.error(n),s&&(s.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function ul(){const t=document.getElementById("hist-start"),e=document.getElementById("hist-end"),s=document.getElementById("hist-prof");t&&(J.histStartDate=t.value),e&&(J.histEndDate=e.value),s&&(J.histProfessionalId=s.value);const n=document.getElementById("history-list-container");if(n){n.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const o=await x2({startDate:J.histStartDate,endDate:J.histEndDate,professionalId:J.histProfessionalId});J.historyData=o,Op(n,o)}catch{n.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function S2(){const t=document.querySelectorAll(".prof-checkbox"),e=Array.from(t).every(s=>s.checked);t.forEach(s=>s.checked=!e)}async function T2(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(r=>r.value);if(t.length===0)return k("Atenção","Selecione profissionais","error");const e={professionalIds:t,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},s=new Date(e.startDate+"T00:00:00").toLocaleDateString("pt-BR"),n=new Date(e.endDate+"T00:00:00").toLocaleDateString("pt-BR");J.periodString=`${s} a ${n}`;const o=document.getElementById("commissions-content");o.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const r=await b2(e);J.calculationResult=r.map(a=>({...a,extraDebit:0,extraCredit:0,finalValue:a.summary.totalCommission,notes:""})),lr(o)}catch(r){k("Erro",r.message,"error"),J.calculationResult=null,lr(o)}}async function k2(){const t=J.calculationResult.length;if(await re("Confirmar",`Gerar ${t} relatórios? Isso marcará as vendas como pagas.`))try{const s=J.calculationResult.map(n=>{const o=n.items.map(r=>r.originalSaleId).filter(r=>r!=null);return v2({professionalId:n.professionalId,professionalName:n.professionalName,period:J.periodString,processedSalesIds:o,reportData:{...n,summary:{...n.summary,finalValue:n.finalValue,extraDebit:n.extraDebit||0,extraCredit:n.extraCredit||0,notes:n.notes||""}}})});await Promise.all(s),k("Sucesso","Pagamentos registrados!","success"),J.calculationResult=null,Nr(),cr("history")}catch(s){k("Erro",s.message,"error")}}function C2(t){const e=J.historyData.find(s=>s.id===t);e&&A2(e)}async function _2(t){if(await re("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await w2(t),k("Sucesso","Registro removido.","success"),ul(),Nr()}catch(s){k("Erro",s.message,"error")}}function A2(t){const{jsPDF:e}=window.jspdf;if(!e)return k("Erro","PDF lib não carregada.","error");const s=new e,n=s.internal.pageSize.getWidth()/2;s.setFontSize(18),s.setFont(void 0,"bold"),s.text("RECIBO DE PAGAMENTO DE COMISSÃO",n,20,{align:"center"}),s.setFontSize(12),s.setFont(void 0,"normal"),s.text(`Profissional: ${t.professionalName}`,15,40),s.text(`Período: ${t.period}`,15,48);const o=[["Comissão Bruta",`R$ ${t.summary.totalCommission.toFixed(2)}`]];t.summary.extraCredit>0&&o.push(["(+) Bônus",`R$ ${t.summary.extraCredit.toFixed(2)}`]),t.summary.extraDebit>0&&o.push(["(-) Descontos",`R$ ${t.summary.extraDebit.toFixed(2)}`]),s.autoTable({startY:60,head:[["Descrição","Valor"]],body:o,theme:"grid"});const r=s.lastAutoTable.finalY+10;s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${(t.summary.finalValue||t.summary.totalCommission).toFixed(2)}`,190,r,{align:"right"}),s.save(`Recibo_${t.professionalName}.pdf`)}function P2(t){const e=document.querySelectorAll(`.input-debit[data-idx="${t}"]`),s=document.querySelectorAll(`.input-credit[data-idx="${t}"]`);let n=0,o=0;if(e.forEach(r=>{r.value&&(n=parseFloat(r.value))}),s.forEach(r=>{r.value&&(o=parseFloat(r.value))}),J.calculationResult&&J.calculationResult[t]){const r=J.calculationResult[t];r.extraDebit=n,r.extraCredit=o,r.finalValue=r.summary.totalCommission-n+o,e.forEach(l=>{l!==document.activeElement&&(l.value=n||"")}),s.forEach(l=>{l!==document.activeElement&&(l.value=o||"")}),document.querySelectorAll(`.final-value-display[data-idx="${t}"]`).forEach(l=>l.innerText=`R$ ${r.finalValue.toFixed(2)}`),$2()}}function $2(){const t=J.calculationResult.reduce((s,n)=>s+n.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(s=>s.innerText=`R$ ${t.toFixed(2)}`)}function D2(t){const e=J.calculationResult[t];if(!e)return;const s=e.items.map(n=>`
    ...
    `}function R2(t){const e=J.professionals.map(s=>`<option value="${s.id}" ${J.histProfessionalId===s.id?"selected":""}>${s.name}</option>`).join("");t.innerHTML=`
        <div class="space-y-6">
    ...
    `,J.historyData.length>0?Op(document.getElementById("history-list-container"),J.historyData):ul()}function Op(t,e){if(e.length===0){t.innerHTML=`
    ...
    `}const Pa=document.getElementById("content");let os={allPackages:[],catalogForModal:{services:[],products:[]}},Ao=null,Cs=null;function M2(t=6){let e="";for(let s=0;s<t;s++)e+=`
        ...
        `;return e}function N2(){const t=document.getElementById("packagesListContainer");if(t){if(os.allPackages.length===0){t.innerHTML=`
        ...
        `}).join("")}}function ou(){const t=document.getElementById("genericModal");t.style.display="none",Cs&&t.removeEventListener("click",Cs)}async function ru(t=null){const e=document.getElementById("genericModal"),s=!!t,n=t?JSON.parse(JSON.stringify(t.items||[])):[],o=A(t?.name||""),r=A(t?.description||""),a=t?.price||"",l=t?.commissionRate||0,c=t?.validityDays||30,d=`
    ...
    `,Ao&&Pa.removeEventListener("click",Ao),Ao=t=>{if(t.target.closest('[data-action-stop-propagation="true"]')){t.stopPropagation();const n=t.target.closest('[data-action="delete-package"]');if(n){const o=n.dataset.id;re("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async r=>{if(r)try{await Ox(o),k("Sucesso!","Pacote excluído.","success"),await ml()}catch(a){k("Erro",`Não foi possível excluir: ${a.message}`,"error")}})}return}const e=t.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!e)return;const s=e.dataset.action;if(s==="new-package")ru(null);else if(s==="edit-package"){const n=JSON.parse(e.dataset.package);ru(n)}},Pa.addEventListener("click",Ao);try{const[t,e,s]=await Promise.all([yp(w.establishmentId),ps(w.establishmentId),pr(w.establishmentId)]);os.allPackages=t,os.catalogForModal={services:e.filter(n=>n.active),products:s},N2()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const V2=document.getElementById("content");let F2=null;async function O2(){const t=A(w.userName||"Usuário"),e=A(_e.currentUser?.email||"E-mail não disponível"),s=w.userName?w.userName.charAt(0):"U";V2.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await q2()}async function q2(){const t=document.getElementById("professional-agenda-block");t.innerHTML="";try{const e=w.userProfessionalId;if(e){const s=await Wh(e);F2=s,s.photo&&(document.getElementById("user-profile-avatar").src=s.photo);const n=A(s.name);t.innerHTML=`
            ...
            `,j2(s.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>dr(s.id,r.target.value)),dr(s.id,"future")}else t.innerHTML=`
    ...
    `}function pi(){const t=Dn.filter(e=>!e.read).length;if(t>0?(La.textContent=t,La.classList.remove("hidden")):La.classList.add("hidden"),Dn.length===0){iu.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}iu.innerHTML=Dn.map(e=>`
    ...
    `).join("")}function J2(t){$n&&$n();const e=$t(Ae,"establishments",t,"notifications"),s=ur(e,Ln("timestamp",">=",new Date),mu("timestamp","desc"));$n=Ch(s,n=>{n.docChanges().forEach(o=>{if(o.type==="added"){const r=o.doc.data();Dn.unshift({title:r.title,message:r.message,time:r.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),k(r.title,r.message,"info",!0),pi();const a=document.querySelector(".sidebar-link.active");a&&a.dataset.target==="agenda-section"&&(r.type==="cancellation"||r.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),bp())}})},n=>{console.error("Erro no listener de notificações em tempo real:",n)})}function Ye(t,e={}){const s=t.replace("-section","");if(t!=="my-profile-section"){const o=w.enabledModules?.[s]!==!1,r=w.userPermissions===null||w.userPermissions[t]?.view===!0;if(!o||!r){Da.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(a=>a.classList.remove("active"));return}}const n=G2[t];n?(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Da.innerHTML="",n(e)):Da.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${t}" ainda não foi implementado.</p></div>`}async function Q2(t){const e=document.getElementById("kpi-appointments-wrapper"),s=document.getElementById("kpi-financial-wrapper"),n=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),r=t===null||t["agenda-section"]?.view===!0,a=t===null||t["financial-section"]?.view===!0;if(r&&e&&e.classList.remove("hidden"),a&&s&&s.classList.remove("hidden"),!(!r&&!a))try{const l=await ix();r&&n&&(n.textContent=l.todayAppointments.toString()),a&&o&&(o.textContent=`R$ ${l.todayRevenue.toFixed(2).replace(".",",")}`)}catch(l){console.error("Erro ao carregar KPIs do cabeçalho:",l)}}async function X2(t){try{console.log("[Nativo] Iniciando configuração de Push..."),Zt.getPlatform()==="android"&&(await Be.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let e=await Be.checkPermissions();if(e.receive==="prompt"&&(e=await Be.requestPermissions()),e.receive!=="granted"){alert("ERRO: Permissão de notificações negada!");return}await Be.register(),Be.addListener("registration",async s=>{console.log("Push Token gerado:",s.value),alert("SUCESSO: Token gerado! "+s.value.substring(0,10)+"...");try{const n=rs(Ae,"users",t);await hu(n,{fcmTokens:kh(s.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(n){alert("Erro ao salvar no Banco: "+n.message),console.error("Erro ao salvar token FCM:",n)}}),Be.addListener("registrationError",s=>{alert("FALHA DE REGISTO: "+JSON.stringify(s)),console.error("Erro no registo de push notifications:",s)}),Be.addListener("pushNotificationReceived",s=>{console.log("Notificação Push recebida:",s),k(s.title,s.body,"info",!0)}),Be.addListener("pushNotificationActionPerformed",s=>{console.log("Ação na notificação push:",s),Ye("agenda-section")})}catch(e){alert("Erro Fatal Push: "+e.message),console.log("Push Notifications não suportado/inicializado:",e)}}async function Y2(){try{await Eh(_e,Ih),console.log("Persistência LOCAL configurada na inicialização.")}catch(t){console.error("Erro ao definir persistência no main.js",t)}Zt.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Vh(),au.addEventListener("click",t=>{t.stopPropagation(),$o.classList.toggle("hidden"),$o.classList.contains("hidden")||(Dn.forEach(e=>e.read=!0),pi())}),W2.addEventListener("click",()=>{Fh()}),Ra.addEventListener("click",t=>{t.stopPropagation(),nt.classList.toggle("active"),nt.classList.contains("active")?nt.classList.remove("hidden"):setTimeout(()=>nt.classList.add("hidden"),200)}),lu&&lu.addEventListener("click",t=>{t.preventDefault(),Ye("my-profile-section"),nt.classList.remove("active"),nt.classList.add("hidden")}),document.addEventListener("click",t=>{!$o.contains(t.target)&&t.target!==au&&$o.classList.add("hidden"),!nt.contains(t.target)&&t.target!==Ra&&nt.classList.contains("active")&&(nt.classList.remove("active"),setTimeout(()=>nt.classList.add("hidden"),200))}),du(_e,async t=>{if(t){console.log("Usuário detectado:",t.email),Zt.isNativePlatform()||(console.log("Inicializando Web Push (PWA)..."),ap());try{const s=(await t.getIdTokenResult(!0)).claims;if((s.role==="owner"||s.role==="employee")&&s.establishmentId){const n=await ms(s.establishmentId);w.enabledModules=n.modules,K2(n.themeColor||"indigo");let o=null,r=t.displayName,a=null;if(s.role==="employee"||s.role==="owner"){const d=rs(Ae,"users",t.uid),p=await Th(d);if(p.exists()){const h=p.data();o=s.role==="employee"?h.permissions||{}:null,r=h.name||r,a=h.professionalId||null}else if(s.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}w.userProfessionalId=a,Zt.isNativePlatform()&&X2(t.uid);const l=r||t.email;_h(s.establishmentId,n.name,o),Ra.textContent=l.charAt(0).toUpperCase(),H2.textContent=l,U2.textContent=t.email;const c=()=>{$n&&$n(),gc(_e).then(()=>window.location.href="/login.html")};z2.addEventListener("click",d=>{d.preventDefault(),c()}),Hh(Ye,o,w.enabledModules),Q2(o),J2(s.establishmentId),pi(),Po.classList.add("fade-out"),$a.style.display="flex",setTimeout(()=>{Po.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{ng()},1500),Ye("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(e){console.error("Erro crítico na inicialização do painel:",e),Po.classList.add("fade-out"),setTimeout(()=>{Po.style.display="none"},500),$a.innerHTML=`
                ...
                `,$a.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{gc(_e).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}Y2();du(_e,t=>{t&&ap()});
