const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-DXykLubn.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-C2XZ_b0c.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as U,d as _,m as zo}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Ms,reauthenticateWithCredential as As,verifyBeforeUpdateEmail as qs,updatePassword as Ns,updateProfile as Rs,setPersistence as js,browserLocalPersistence as Fs,onAuthStateChanged as Ma,signOut as Vo}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as me,getDoc as Aa,updateDoc as wo,setDoc as Hs,addDoc as qa,collection as pe,query as jt,where as nt,getDocs as ko,orderBy as Na,writeBatch as Ra,serverTimestamp as Uo,deleteDoc as Os,arrayUnion as zs,onSnapshot as Vs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Us,onMessage as _s}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Ws(e,t,o){m.establishmentId=e,m.establishmentName=t,m.userPermissions=o}const ja=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",lo=ja?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${ja?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",lo);async function Js(){const e=U.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function E(e,t={}){const o=await Js();if(!o)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=lo.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,a=`${s}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${a}`);try{const n=await fetch(a,{...t,headers:{...o,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${a}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${a}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${lo}. Verifique se o servidor backend está rodando.`):n}}const Fa=(e,t,o,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${o}`;return s&&(r+=`&professionalId=${s}`),E(r)},Gs=({establishmentId:e,professionalId:t,serviceIds:o,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${o.join(",")}&date=${s}`;return E(r)},Ys=e=>E("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Qs=(e,t)=>E(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),_o=e=>E(`/api/appointments/${e}`,{method:"DELETE"}),Xs=e=>E(`/api/appointments/${e}/reopen`,{method:"POST"}),Zs=(e,t)=>E(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let W;async function Ks(){if(!W)try{W=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function er(){if(!W){console.warn("AudioContext não inicializado. O som não será tocado.");return}W.state==="suspended"&&W.resume();const e=W.createOscillator(),t=W.createGain();e.connect(t),t.connect(W.destination),e.type="sine",e.frequency.setValueAtTime(800,W.currentTime),t.gain.setValueAtTime(0,W.currentTime),t.gain.linearRampToValueAtTime(.3,W.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,W.currentTime+.2),e.start(W.currentTime),e.stop(W.currentTime+.2)}function p(e,t,o="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&er();const a=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};a.className=`toast ${n[o]||n.info}`,a.innerHTML=`
    ...
    `,document.body.appendChild(ce),So())}function So(){const e=Math.round(ee/$t.length*100),t=document.getElementById("progress-bar"),o=document.getElementById("progress-text");t&&(t.style.width=`${e}%`),o&&(o.innerText=`${e}%`)}function $o(e){const t=document.getElementById("onboarding-step-content"),o=$t[e];if(!o){Qo(t);return}let s="";if(o.id==="company_data")s=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(hr).map(([a,n])=>`<option value="${a}">${n.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>wr(o.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===$t.length-1?Qo(t):(ee++,So(),$o(ee))}),o.id==="branding"){const r=document.getElementById("logo-input"),a=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Yo(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),a&&(a.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Yo(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Qo(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),o=document.getElementById("progress-text");t&&(t.style.width="100%"),o&&(o.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{ce&&ce.remove(),window.location.reload()}}async function wr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const o=document.getElementById("next-step-btn"),s=o.innerHTML;o.disabled=!0,o.innerHTML="Salvando...";const r=new FormData(t),a=Object.fromEntries(r.entries());try{if(e==="company_data")await St(m.establishmentId,{name:a.name,phone:a.phone,email:a.email,address:a.address,zipCode:a.zipCode});else if(e==="branding"){const n={};a.logoBase64&&(n.logo=a.logoBase64),a.bgBase64&&(n.backgroundImage=a.bgBase64),a.themeColor&&(n.themeColor=a.themeColor),a.primaryColor&&(n.primaryColor=a.primaryColor),Object.keys(n).length>0&&await St(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(a.slotInterval);await St(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await za({establishmentId:m.establishmentId,name:a.name,price:parseFloat(a.price),duration:parseInt(a.duration),active:!0});n&&Tt.push(n)}else if(e==="first_prof"){const n=await Ha({establishmentId:m.establishmentId,name:a.name,specialty:a.role,active:!0,commissionRate:0});if(a.serviceId&&n&&n.id)try{Go?await Go(n.id,[a.serviceId]):Lt&&await Lt(n.id,{services:[a.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Va({establishmentId:m.establishmentId,name:a.name,price:parseFloat(a.salePrice),stock:parseInt(a.stock),active:!0});p("Sucesso","Passo concluído!","success"),ee++,So(),$o(ee)}catch(n){p("Erro","Erro ao salvar: "+n.message,"error"),o.disabled=!1,o.innerHTML=s}}var Fe;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Fe||(Fe={}));class Zt extends Error{constructor(t,o,s){super(t),this.message=t,this.code=o,this.data=s}}const kr=e=>{var t,o;return e?.androidBridge?"android":!((o=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||o===void 0)&&o.bridge?"ios":"web"},Sr=e=>{const t=e.CapacitorCustomPlatform||null,o=e.Capacitor||{},s=o.Plugins=o.Plugins||{},r=()=>t!==null?t.name:kr(e),a=()=>r()!=="web",n=u=>{const g=d.get(u);return!!(g?.platforms.has(r())||i(u))},i=u=>{var g;return(g=o.PluginHeaders)===null||g===void 0?void 0:g.find(b=>b.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,g={})=>{const b=d.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const h=r(),v=i(u);let y;const w=async()=>(!y&&h in g?y=typeof g[h]=="function"?y=await g[h]():y=g[h]:t!==null&&!y&&"web"in g&&(y=typeof g.web=="function"?y=await g.web():y=g.web),y),$=(P,D)=>{var R,F;if(v){const z=v?.methods.find(j=>D===j.name);if(z)return z.rtype==="promise"?j=>o.nativePromise(u,D.toString(),j):(j,Q)=>o.nativeCallback(u,D.toString(),j,Q);if(P)return(R=P[D])===null||R===void 0?void 0:R.bind(P)}else{if(P)return(F=P[D])===null||F===void 0?void 0:F.bind(P);throw new Zt(`"${u}" plugin is not implemented on ${h}`,Fe.Unimplemented)}},k=P=>{let D;const R=(...F)=>{const z=w().then(j=>{const Q=$(j,P);if(Q){const Ee=Q(...F);return D=Ee?.remove,Ee}else throw new Zt(`"${u}.${P}()" is not implemented on ${h}`,Fe.Unimplemented)});return P==="addListener"&&(z.remove=async()=>D()),z};return R.toString=()=>`${P.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:P,writable:!1,configurable:!1}),R},I=k("addListener"),L=k("removeListener"),B=(P,D)=>{const R=I({eventName:P},D),F=async()=>{const j=await R;L({eventName:P,callbackId:j},D)},z=new Promise(j=>R.then(()=>j({remove:F})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},z},N=new Proxy({},{get(P,D){switch(D){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?B:I;case"removeListener":return L;default:return k(D)}}});return s[u]=N,d.set(u,{name:u,proxy:N,platforms:new Set([...Object.keys(g),...v?[h]:[]])}),N};return o.convertFileSrc||(o.convertFileSrc=u=>u),o.getPlatform=r,o.handleError=l,o.isNativePlatform=a,o.isPluginAvailable=n,o.registerPlugin=c,o.Exception=Zt,o.DEBUG=!!o.DEBUG,o.isLoggingEnabled=!!o.isLoggingEnabled,o},$r=e=>e.Capacitor=Sr(e),ae=$r(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ht=ae.registerPlugin;class Ua{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,o){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(o);const a=this.windowListeners[t];a&&!a.registered&&this.addWindowListener(a),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,o);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,o,s){const r=this.listeners[t];if(!r){if(s){let a=this.retainedEventArguments[t];a||(a=[]),a.push(o),this.retainedEventArguments[t]=a}return}r.forEach(a=>a(o))}hasListeners(t){var o;return!!(!((o=this.listeners[t])===null||o===void 0)&&o.length)}registerWindowListener(t,o){this.windowListeners[o]={registered:!1,windowEventName:t,pluginEventName:o,handler:s=>{this.notifyListeners(o,s)}}}unimplemented(t="not implemented"){return new ae.Exception(t,Fe.Unimplemented)}unavailable(t="not available"){return new ae.Exception(t,Fe.Unavailable)}async removeListener(t,o){const s=this.listeners[t];if(!s)return;const r=s.indexOf(o);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const o=this.retainedEventArguments[t];o&&(delete this.retainedEventArguments[t],o.forEach(s=>{this.notifyListeners(t,s)}))}}const Xo=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Zo=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Er extends Ua{async getCookies(){const t=document.cookie,o={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,a]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Zo(r).trim(),a=Zo(a).trim(),o[r]=a}),o}async setCookie(t){try{const o=Xo(t.key),s=Xo(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,a=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${o}=${s||""}${r}; path=${a}; ${n};`}catch(o){return Promise.reject(o)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(o){return Promise.reject(o)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const o of t)document.cookie=o.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ht("CapacitorCookies",{web:()=>new Er});const Ir=async e=>new Promise((t,o)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>o(r),s.readAsDataURL(e)}),Cr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,a,n)=>(r[a]=e[t[n]],r),{})},Lr=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[a,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${a}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${a}=${i}`),`${s}&${l}`},"").substr(1):null,Tr=(e,t={})=>{const o=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Cr(e.headers)["content-type"]||"";if(typeof e.data=="string")o.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const a=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))a.set(n,i);o.body=a.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const a=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{a.append(l,i)});else for(const i of Object.keys(e.data))a.append(i,e.data[i]);o.body=a;const n=new Headers(o.headers);n.delete("content-type"),o.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(o.body=JSON.stringify(e.data));return o};class Pr extends Ua{async request(t){const o=Tr(t,t.webFetchExtra),s=Lr(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,a=await fetch(r,o),n=a.headers.get("content-type")||"";let{responseType:i="text"}=a.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await a.blob(),l=await Ir(d);break;case"json":l=await a.json();break;case"document":case"text":default:l=await a.text()}const c={};return a.headers.forEach((u,g)=>{c[g]=u}),{data:l,headers:c,status:a.status,url:a.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ht("CapacitorHttp",{web:()=>new Pr});const G=Ht("PushNotifications",{}),Dr="modulepreload",Br=function(e){return"/"+e},Ko={},Mr=function(t,o,s){let r=Promise.resolve();if(o&&o.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");r=l(o.map(d=>{if(d=Br(d),d in Ko)return;Ko[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const g=document.createElement("link");if(g.rel=c?"stylesheet":Dr,c||(g.as="script"),g.crossOrigin="",g.href=d,i&&g.setAttribute("nonce",i),document.head.appendChild(g),c)return new Promise((b,h)=>{g.addEventListener("load",b),g.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return r.then(n=>{for(const i of n||[])i.status==="rejected"&&a(i.reason);return t().catch(a)})},ea=Ht("App",{web:()=>Mr(()=>import("./web-DXykLubn.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Ar="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let ta=!1;async function _a(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async o=>{Ga(o.value,!0)}),await G.addListener("pushNotificationReceived",o=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",o)}),await G.addListener("pushNotificationActionPerformed",o=>{const s=o.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Ja()}async function Wa(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Ja(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Ja(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Us(zo,{vapidKey:Ar,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Ga(t,!1)):console.warn("[Push Web] Token veio vazio."),ta||(_s(zo,o=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",o)}),ta=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Ga(e,t){const o=U.currentUser;if(!o){console.warn("Usuário não logado. Token não salvo.");return}const s=me(_,"users",o.uid);try{const r=await Aa(s);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await wo(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Hs(s,{email:o.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(a){console.error("Erro ao criar user:",a)}else console.error("Erro ao atualizar token:",r)}}const qr=(e,t,o="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return o&&o!=="all"&&r.append("professionalId",o),s&&s!=="all"&&r.append("costCenterId",s),E(`/api/reports/indicators?${r.toString()}`)},Nr=e=>e?E(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Rr=({establishmentId:e,startDate:t,endDate:o,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:o});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),E(`/api/reports/sales?${r.toString()}`)},jr=()=>E("/api/reports/summary",{method:"GET"}),Ot=(e,t,o,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${o}&professionalId=${s}`;return E(r)},zt=e=>E("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Eo=e=>E(`/api/blockages/${e}`,{method:"DELETE"}),Ya=e=>E("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Io=e=>e?String(e).replace(/\D/g,""):"",Vt=(e,t="",o=20,s={})=>{const r=new URLSearchParams;return t&&r.append("search",t),o&&r.append("limit",o),s&&s.hasLoyalty&&r.append("hasLoyalty","true"),s&&s.birthMonth&&r.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),E(`/api/clients/${e}?${r.toString()}`)},Qa=(e,t)=>{const o=encodeURIComponent(t);return E(`/api/clients/details/${e}/${o}`)},Xa=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const o=Io(t),s={...e,phone:o,id:o};return E(`/api/clients/${o}`,{method:"PUT",body:JSON.stringify(s)})},Co=Xa,Za=(e,t)=>Xa({...t,id:e}),Fr=e=>{const t=encodeURIComponent(e);return E(`/api/clients/${t}`,{method:"DELETE"})},Hr=(e,t,o,s)=>E("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Io(t),points:o,rewardName:s})}),Or=(e,t)=>Qa(e,Io(t));function f(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Ka(e,t=800,o=800,s=.7){return new Promise((r,a)=>{if(!e.type.match(/image.*/))return a(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>o&&(d*=o/c,c=o);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const b=u.toDataURL("image/jpeg",s);r(b)},l.onerror=d=>a(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>a(new Error("Erro ao ler o ficheiro."))})}const oa=document.getElementById("content");let aa=!1;const co=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let ct=[],Ut=[],He={},Ae=[],T={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},C={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function zr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function es(e){const t=new Date(e);if(t.setHours(0,0,0,0),T.currentView==="week"&&T.weekViewDays===7){const o=t.getDay(),s=t.getDate()-o+(o===0?-6:1);return new Date(t.setDate(s))}return t}function Pt(){const e=document.getElementById("profSelectorContainer"),t=T.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let o=m.professionals.filter(a=>T.showInactiveProfs||a.status!=="inactive");t&&(o=o.filter(a=>a.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...o];e.innerHTML=r.map(a=>{const n=T.selectedProfessionalId===a.id,i=a.name==="Todos"?"Todos":a.name.split(" ")[0],l=a.name==="Todos"?"T":a.name.charAt(0).toUpperCase(),d=a.status!=="inactive",c=f(i),u=co[0],g=a.id!=="all"&&m.professionalColors.get(a.id)||u,b=a.photo||`https://placehold.co/64x64/${g.main?.replace("#","")||"E0E7FF"}/${g.light?.replace("#","")||"4F46E5"}?text=${l}`,h=a.id==="all"?"#e0e7ff":g.light,v=a.id==="all"?"#4f46e5":g.main,w=`border: 3px solid ${n?g.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+g.border:"none"};`;return`
        ...
        `}).join("")}function Vr(e,t,o,s,r){const a=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${o} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${a}?text=${d}`}function Ur(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const o=e.map(s=>{const r=new Date(s.startTime),a=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=a.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(s.professionalId)||{},d=f(s.reason),c=f(s.professionalName),u=f(s.clientName),g=f(s.serviceName),b=T.selectedItems.has(s.id),h=T.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const v=s.status==="completed",y=v?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",w=v?"Finalizado":"Aberto",$=JSON.stringify(s).replace(/'/g,"&apos;"),k=s.redeemedReward?.points>0,I=s.hasRewards&&!k,L=Vr(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),B=T.isSelectionMode?"":'data-action="open-comanda"';return`
        ...
        `}a+="</div>",t.innerHTML=a}function ts(){const e=m.allEvents.filter(t=>T.selectedProfessionalId==="all"||t.professionalId===T.selectedProfessionalId);T.currentView==="list"?Ur(e):_r(e),To()}function To(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(T.isSelectionMode&&T.selectedItems.size>0?(e.innerHTML=`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",Xr)}function Kr(){Zr()}function en(e,t){const o=e?"Editar Agendamento":"Selecionar Cliente",s=`
    ...
    `;return{title:o,content:s}}function tn(){const e="Selecionar Serviço",o=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:e,content:o}}function on(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:e,content:t}}function an(e){const t=e?"Confirmar Edição":"Data e Horário",o=new Date,s=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,r=C.data.date||s,a=f(C.data.clientName),n=f(C.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function sn(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const o=e.toLowerCase(),s=ct.filter(r=>r.name.toLowerCase().includes(o));t.innerHTML=s.map(r=>{const a=C.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>os(r.dataset.serviceId,r))})}function rn(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const o=e.toLowerCase(),s=Ut.filter(r=>r.name.toLowerCase().includes(o));t.innerHTML=s.map(r=>{const a=C.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=f(r.name);return`
        ...
        </div>`,o.querySelectorAll('[data-action="next-step"]').forEach(a=>{a.addEventListener("click",()=>{const n=parseInt(a.dataset.currentStep,10);if(n===1){const i=o.querySelector("#apptClientName"),l=o.querySelector("#apptClientPhone");if(C.data.clientName=i.value.trim(),C.data.clientPhone=l.value.trim(),!C.data.clientName||!C.data.clientPhone)return p("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(C.data.selectedServiceIds.length===0)return p("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!C.data.professionalId)return p("Atenção","Selecione um profissional.","error");uo(n+1)})}),o.querySelectorAll('[data-action="prev-step"]').forEach(a=>{a.addEventListener("click",()=>uo(parseInt(a.dataset.currentStep,10)-1))});const r=o.querySelector("#appointmentForm");if(C.step===4&&r&&r.addEventListener("submit",Yr),o.style.display="flex",C.step===2){o.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>os(i.dataset.serviceId,i))});const n=o.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>sn(i.target.value))}if(C.step===3){o.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>as(i.dataset.professionalId,i))});const n=o.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>rn(i.target.value))}if(C.step===1){const a=o.querySelector("#clientSearchInput");if(a&&(a.addEventListener("input",i=>Qr(i.target.value)),C.data.clientName&&C.data.clientPhone&&Ae.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=Ae.map(ss).join(""))}const n=o.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Kr)}if(C.step===4){const a=o.querySelector("#apptDate");a&&a.addEventListener("change",sa),sa(),Gr()}}async function rs(e={}){T.currentDate=e.targetDate?new Date(e.targetDate):T.currentDate||new Date,T.scrollToAppointmentId=e.scrollToAppointmentId||null,T.profSearchTerm="",T.isSelectionMode=!1,T.selectedItems.clear(),window.innerWidth<768&&(T.currentView="list"),oa.innerHTML=`
        <section>
    ...
    `,_t()}function _t(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");x.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `:e.innerHTML=`
            ...
            <button data-action="view-sales-report" class="py-2 px-4 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 text-sm transition">Relatório</button>
        `)}function it(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!x.isCashierOpen&&x.activeFilter==="atendimento"){e.innerHTML=`
    ...
    `;e.innerHTML=`
        ...
        ${r?"":h}
    `,!r&&(t.clientId||t.clientName)&&Sn(t,e.querySelector("#loyalty-container"))}function kn(e,t){const s=Se(e).reduce((g,b)=>g+Number(b.price||0)*(b.quantity||1),0),r=x.checkoutState,a=r.discount||{type:"real",value:0};let n=0;a.type==="percent"?n=s*a.value/100:n=a.value,n>s&&(n=s);const i=s-n,l=r.payments.reduce((g,b)=>g+b.value,0),d=Math.max(0,i-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;const u=()=>{const g=x.checkoutState.discount.type,b=x.checkoutState.discount.value;let h=g==="percent"?s*b/100:b;h>s&&(h=s);const v=s-h,y=x.checkoutState.payments.reduce((L,B)=>L+B.value,0),w=Math.max(0,v-y),$=t.querySelector("#checkout-total-display");$&&($.textContent=`R$ ${v.toFixed(2)}`);const k=t.querySelector("#checkout-status-msg");k&&(w<=.01?k.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':k.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${w.toFixed(2)}</span></p>`);const I=t.querySelector("#checkout-amount");I&&w>0&&document.activeElement!==I&&(I.value=w.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",g=>{const b=parseFloat(g.target.value)||0;x.checkoutState.discount.value=b,u()}),t.querySelector("#discount-type")?.addEventListener("change",g=>{x.checkoutState.discount.type=g.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",g=>{x.checkoutState.discountReason=g.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",g=>{x.checkoutState.amountReceived=g.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",g=>{x.checkoutState.installments=parseInt(g.target.value,10)})}async function Sn(e,t){if(!t)return;const o=x.loyaltySettings;if(!o||!o.enabled)return;let s=null;try{if(e.clientId)s=await Qa(m.establishmentId,e.clientId);else if(e.clientName){const i=await Vt(m.establishmentId,e.clientName,1);i&&i.length>0&&(s=i[0])}}catch(i){console.warn("Erro ao buscar dados de fidelidade",i)}if(!s||s.loyaltyPoints===void 0)return;const r=Number(s.loyaltyPoints)||0,n=(o.tiers||o.rewards||[]).filter(i=>{const l=Number(i.costPoints||i.points||0);return l>0&&r>=l});if(n.length>0){const i=document.createElement("div");i.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",i.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>$n(n,e),i.appendChild(l),t.innerHTML="",t.appendChild(i)}}function $n(e,t){const o=`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Ln)}async function Ln(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const o=t.querySelector("#regClientName"),r=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!o.value||!r)return p("Erro","Nome e Telefone são obrigatórios.","error");try{const a=await Or(m.establishmentId,r);if(a)p("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",po(a);else{const n=await Co({establishmentId:m.establishmentId,name:o.value,phone:r});p("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",po(n)}}catch(a){p("Erro",a.message,"error")}}async function Tn(){const e=`
    ...
    `,{modalElement:t}=Y({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return p("Valor Inválido","Insira um valor válido.","error");try{const r=await mn({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",p("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),_t(),await re()}catch(r){p("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function Pn(){const e=x.activeCashierSessionId;if(e)try{const t=await bn(e),o=`
        ...
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
        ...
        </div>`;try{await Qn();const[e,t]=await Promise.all([K(m.establishmentId),Nr(m.establishmentId).catch(()=>[])]);M.professionalsList=e||[],M.costCentersList=t||[],Zn(),await gs()}catch(e){console.error("Erro no loadReportsPage:",e),go.innerHTML=`
            ...
            </div>`}}function Zn(){const e=M.professionalsList.map(o=>`<option value="${o.id}">${f(o.name)}</option>`).join(""),t=M.costCentersList.map(o=>`<option value="${o.id}">${f(o.name)}</option>`).join("");go.innerHTML=`
    ...
    `,document.getElementById("toggle-filters-btn").onclick=ca,document.getElementById("btn-apply-filters").onclick=()=>{Kn(),ca()},document.querySelectorAll(".tab-btn").forEach(o=>{o.onclick=()=>{M.currentTab=o.dataset.tab,ua(),bs(),window.scrollTo({top:0,behavior:"smooth"})}}),ua()}function ca(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");M.isFilterOpen=!M.isFilterOpen,M.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function ua(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===M.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Dt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function Kn(){M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.selectedProfessional=document.getElementById("report-prof").value,M.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Dt(M.startDate)} até ${Dt(M.endDate)}`,await gs()}async function gs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader border-t-indigo-600"></div></div>';try{const t=M.selectedProfessional==="all"?null:M.selectedProfessional,o=qr(M.startDate,M.endDate,M.selectedProfessional,M.selectedCostCenter),s=Yn(m.establishmentId,M.startDate,M.endDate).catch(()=>({labels:[],payables:[],receivables:[],expectedBalance:[]})),r=new Date(M.startDate+"T00:00:00").toISOString(),a=new Date(M.endDate+"T23:59:59").toISOString(),n=Fa(m.establishmentId,r,a,t).catch(()=>[]),[i,l,d]=await Promise.all([o,s,n]);M.data=i,M.cashFlowData=l,M.appointmentsData=Array.isArray(d)?d:[],bs()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function bs(){const e=document.getElementById("report-content");if(M.data)switch(M.currentTab){case"dashboards":ei(e);break;case"appointments":ti(e);break;case"dre":oi(e);break}}function ei(e){const{dreSimple:t,charts:o}=M.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0};e.innerHTML=`
    ...
    `,M.cashFlowData&&ai("chart-cashflow-modern",M.cashFlowData),ma("chart-monthly","bar","Receita Mensal",o.salesMonthly.labels,o.salesMonthly.data,da[0]),ma("chart-profs","doughnut","Total Vendas",o.professionals.labels,o.professionals.data,da)}function ti(e){const t=M.appointmentsData,o=t.length;let s=0,r=0,a=0;const n={},i={};let l=new Date(M.startDate);const d=new Date(M.endDate);for(;l<=d;)n[l.toISOString().split("T")[0]]=0,l.setDate(l.getDate()+1);t.forEach(b=>{const h=parseFloat(b.totalAmount||b.price||0),v=(b.status||"").toLowerCase();let y=b.startTime?(b.startTime.toDate?b.startTime.toDate():new Date(b.startTime)).toISOString().split("T")[0]:"";const w=b.professionalName||"Sem Profissional";i[w]||(i[w]={name:w,count:0,value:0}),["cancelled","cancelado","no-show"].includes(v)?r++:(["completed","finalized","paid"].includes(v)&&s++,a+=h,y&&n.hasOwnProperty(y)&&n[y]++,i[w].count++,i[w].value+=h)});const c=Object.keys(n).sort(),u=c.map(b=>n[b]),g=Object.values(i).sort((b,h)=>h.value-b.value);e.innerHTML=`
    ...
    `,si("chart-appointments-daily",c,u)}function oi(e){const{dreFinancial:t}=M.data;if(!t)return;const o=t.totalRevenues,s=(i,l,d,c=!1)=>{const u=o>0?l/o*100:0,g=c?"- ":"";return`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(o=>t.innerHTML+=`<option value="${o.id}">${f(o.name)}</option>`)),Ao(),Pe()}function ui(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ut(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,o,s,r]=await Promise.all([ge(m.establishmentId),K(m.establishmentId),Wt(m.establishmentId,"services"),pr(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(o||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(a=>{a.active===void 0&&(a.active=!0)}),hs(Ke)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),p("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function hs(e){if(document.getElementById("services-content-container")){if(Ke===e&&document.getElementById("services-content-container").children.length>1){Ke==="services"&&(Ao(),Pe());return}Ke=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const o=t.dataset.view===e;t.classList.toggle("border-indigo-500",o),t.classList.toggle("text-indigo-600",o),t.classList.toggle("border-transparent",!o),t.classList.toggle("text-gray-500",!o)}),e==="services"?ci():e==="reports"&&ui()}}function mi(){ie&&(he.removeEventListener("click",ie),he.removeEventListener("input",ie),he.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),a=r.dataset.id,n=r.checked;try{await mr(a,n);const i=m.services.findIndex(l=>l.id===a);i>-1&&(m.services[i].active=n),Oe(m.establishmentId,ze(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${a}) para ${n?"Ativo":"Inativo"}`),Pe(),Ao()}catch(i){p("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Pe()}return}const o=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Pe();return}if(!o)return;if(o.hasAttribute("data-view")){hs(o.dataset.view);return}switch(o.dataset.action){case"new-service":pa();break;case"edit-service":const r=JSON.parse(o.dataset.service);pa(r);break;case"manage-categories":li();break;case"filter-service":const a=o.dataset.filterType;if(a==="popular")return;we=a==="total"?"all":a,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===we||i==="total"&&we==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Pe();break}},he.addEventListener("click",ie),he.addEventListener("input",ie),he.addEventListener("change",ie)}async function pi(){he.innerHTML=`
        ...
        </section>`,mi();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await K(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),p("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Ke="services",we="all",await ut()}const Jt="suppliers",qo="purchases",xs="financial_payables",No=async e=>{try{const t=jt(pe(_,Jt),nt("establishmentId","==",e)),o=await ko(t),s=[];return o.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},gi=async e=>{try{return{id:(await qa(pe(_,Jt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},bi=async(e,t)=>{try{const o=me(_,Jt,e);return await wo(o,t),{id:e,...t}}catch(o){throw console.error("Erro ao atualizar fornecedor:",o),o}},fi=async e=>{try{const t=me(_,Jt,e);return await Os(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},vi=async(e,t=null)=>{try{const o=Ra(_),s=me(pe(_,qo)),r={...e,createdAt:Uo()};if(o.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const a=me(pe(_,xs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:Uo()};o.set(a,i)}return await o.commit(),{id:s.id,...r}}catch(o){throw console.error("Erro ao registrar compra com integração:",o),o}},hi=async(e,t)=>{try{const o=Ra(_),s=me(_,qo,e);o.delete(s);const r=jt(pe(_,xs),nt("purchaseId","==",e),nt("establishmentId","==",t));return(await ko(r)).forEach(n=>{o.delete(n.ref)}),await o.commit(),!0}catch(o){throw console.error("Erro ao excluir compra e financeiro:",o),o}},xi=async e=>{try{const t=jt(pe(_,qo),nt("establishmentId","==",e),Na("createdAt","desc")),o=await ko(t),s=[];return o.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},be=document.getElementById("content");let le=null,et="products",se="all";async function yi(e){e.preventDefault();const o=e.target.closest("#categoryForm").querySelector("#categoryName"),s=o.value;if(s)try{await fs({establishmentId:m.establishmentId,name:s},"products"),o.value="",p("Sucesso","Categoria de produto criada!","success"),await Ro(),await mt()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function wi(e){if(await O("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await vs(e,"products"),p("Sucesso","Categoria de produto apagada.","success"),await Ro(),await mt()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Ro(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Wt(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(o=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${f(o.name)}</span>
                    <button data-action="delete-category" data-id="${o.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
        ...
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                `).join("")):(D.classList.remove("hidden"),D.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else D.classList.add("hidden");a.size>0?(R.innerHTML="",a.forEach(z=>{const j=s.find(Q=>Q.id===z);j&&(R.innerHTML+=`
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};k.querySelector("#modalSupplierSearch").addEventListener("input",I),k.addEventListener("click",P=>{const D=P.target.closest("[data-add-supplier]");if(D){const F=D.dataset.addSupplier;a.add(F),k.querySelector("#modalSupplierSearch").value="",I()}const R=P.target.closest("[data-remove-supplier]");if(R){const F=R.dataset.removeSupplier;a.delete(F),I()}}),I(),k.addEventListener("click",async P=>{const D=P.target.closest("button[data-action]");if(!D)return;const R=D.dataset.action,F=k.querySelector("#productId").value;if(R==="close-modal"&&(k.style.display="none"),R==="delete-product"){if(!F)return;k.style.display="none",await Si(F)}if(R==="save-product-modal"){const z=k.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){p("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const j=D.closest('button[data-action="save-product-modal"]');j.disabled=!0,j.textContent="A salvar...";try{await $i(z)}catch(Q){p("Erro",`Falha ao salvar: ${Q.message}`,"error"),j.disabled=!1,j.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){P.preventDefault();const z=k.querySelector("#stockAdjustmentAmount"),j=k.querySelector("#stockAdjustmentReason"),Q=parseInt(z.value,10),Ee=parseInt(D.dataset.change,10);if(!Q||Q<=0){p("Erro","Por favor, insira uma quantidade válida.","error");return}const Xt=Q*Ee,Bs=j.value||(Xt>0?"Entrada manual":"Saída manual");try{await fr(F,{change:Xt,reason:Bs});const We=m.products.findIndex(Je=>Je.id===F);if(We>-1){const Je=m.products[We].currentStock+Xt;m.products[We].currentStock=Je,k.querySelector("#currentStockDisplay").textContent=Je,k.querySelector("#productCurrentStock").value=Je,z.value="",j.value="",p("Sucesso","Estoque atualizado!","success"),jo(),lt()}}catch(We){p("Erro de Stock",We.message,"error")}}});const L=k.querySelectorAll(".tab-btn"),B=k.querySelectorAll(".tab-content");L.forEach(P=>{P.addEventListener("click",D=>{D.preventDefault(),L.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),P.classList.add("border-indigo-500","text-indigo-600"),P.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),B.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${P.dataset.tab}`).classList.remove("hidden")})});const N=k.querySelector("#productPhotoInput");k.querySelector("#productPhotoButton").addEventListener("click",()=>N.click()),N.onchange=async()=>{const P=N.files[0];if(!P)return;const D=k.querySelector("#productPhotoPreview"),R=k.querySelector("#productPhotoBase64");D.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await ga(P,800,800,"image/jpeg",.8),j=F.length*3/4,Q=1e3*1024;if(j>Q)throw new Error("A imagem é muito grande mesmo após a compressão.");D.src=F,R.value=F}catch(F){console.error("Erro ao processar imagem:",F),p("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),D.src=w,R.value=$,N.value=""}},k.style.display="flex"}function Ei(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(o=>t.innerHTML+=`<option value="${o.id}">${f(o.name)}</option>`)),jo(),lt()}function Ii(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],o=new Date;o.setDate(o.getDate()-30);const s=o.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function mt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,o,s]=await Promise.all([dt(m.establishmentId),Wt(m.establishmentId,"products"),No(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(o||[]).filter(Boolean),m.suppliers=(s||[]).filter(Boolean),ys(et)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function ys(e){if(document.getElementById("products-content-container")){if(et===e&&document.getElementById("products-content-container").children.length>1){et==="products"&&(jo(),lt());return}et=e,se="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const o=t.dataset.view===e;t.classList.toggle("border-indigo-500",o),t.classList.toggle("text-indigo-600",o),t.classList.toggle("border-transparent",!o),t.classList.toggle("text-gray-500",!o)}),e==="products"?Ei():e==="movements"&&Ii()}}async function Li(){be.innerHTML=`
        ...
        </section>`,le&&(be.removeEventListener("click",le),be.removeEventListener("input",le),be.removeEventListener("change",le)),le=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){lt();return}const o=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!o||e.target.closest('[data-action-stop-propagation="true"]'))return;if(o.hasAttribute("data-view")){ys(o.dataset.view);return}switch(o.dataset.action){case"new-product":ba();break;case"edit-product":ba(JSON.parse(o.dataset.product));break;case"manage-product-categories":ki();break;case"generate-report":await Ci();break;case"filter-stock":const r=o.dataset.filterType;se=se===r?"all":r,document.querySelectorAll(".indicator-card").forEach(a=>{a.classList.toggle("ring-2",a.dataset.filterType===se),a.classList.toggle("ring-indigo-500",a.dataset.filterType===se),a.classList.toggle("shadow-lg",a.dataset.filterType===se)}),lt();break}},be.addEventListener("click",le),be.addEventListener("input",le),be.addEventListener("change",le),et="products",se="all",await mt()}const fe=document.getElementById("content");let de=null,Et="list",H={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Ti(){Et==="list"?Gt():Et==="purchases"?(H.step=1,tt()):Et==="history"&&ws()}async function Pi(){try{const e=await No(m.establishmentId);return m.suppliers=e||[],H.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Di(e){if(await O("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await fi(e),p("Sucesso","Fornecedor excluído.","success"),Ft("genericModal"),Gt()}catch(t){p("Erro","Erro ao excluir: "+t.message,"error")}}async function Bi(e){e.preventDefault();const t=e.target,o=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:m.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{o?(await bi(o,s),p("Sucesso","Fornecedor atualizado!","success")):(await gi(s),p("Sucesso","Fornecedor criado!","success")),Ft("genericModal"),Gt()}catch(a){p("Erro","Erro ao salvar: "+a.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Gt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Pi();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",o=m.suppliers.filter(a=>a.name.toLowerCase().includes(t)||a.contactName&&a.contactName.toLowerCase().includes(t));if(e.innerHTML="",o.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let s='<div class="flex flex-col gap-2 md:hidden">';o.forEach(a=>{const n=JSON.stringify(a).replace(/"/g,"&quot;"),i=f(a.name),l=f(a.category||"Geral"),d=f(a.contactName||"");s+=`
    ...
    `;o.forEach(a=>{const n=JSON.stringify(a).replace(/"/g,"&quot;"),i=f(a.name),l=f(a.taxId||"Sem doc."),d=f(a.email||"-"),c=f(a.phone||"-"),u=f(a.category||"Geral");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=s+r}function Mi(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",o=e.phone?`tel:${e.phone}`:"#",s=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),a=f(e.name),n=f(e.category||"Fornecedor"),i=f(e.contactName||""),l=f(e.phone||""),d=`
    ...
    `}async function ws(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await xi(m.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let o='<div class="flex flex-col gap-3 md:hidden">';t.forEach(a=>{const n=new Date(a.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=f(a.supplierName);o+=`
        ...
        `;e.innerHTML=o+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function qi(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),o=e.items.map(r=>`
    ...
    `;Y({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Bi),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Ft("genericModal"))},50)}function Ri(){fe.innerHTML=`
    ...
    `,de&&(fe.removeEventListener("click",de),fe.removeEventListener("input",de),fe.removeEventListener("change",de)),de=e=>{if(e.target.closest("#tab-btn-list")&&gt("list"),e.target.closest("#tab-btn-purchases")&&gt("purchases"),e.target.closest("#tab-btn-history")&&gt("history"),e.target.id==="toggle-quote-mode"&&(H.isQuoteMode=e.target.checked,tt()),e.target.id==="supplierSearchInput"&&Gt(),e.target.closest("#btn-new-supplier")&&fa(),e.target.closest(".supplier-item-mobile")){const o=e.target.closest(".supplier-item-mobile"),s=JSON.parse(o.dataset.supplier);Mi(s)}const t=e.target.closest("button[data-action]");if(t){const o=t.dataset.action;o==="delete"&&Di(t.dataset.id),o==="edit"&&fa(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&bo(),e.target.id==="check-all-rows"){const o=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=o),bo()}if(e.target.closest("#btn-go-to-orders")){const o=document.querySelectorAll(".product-row"),s={};let r=!1;if(o.forEach(a=>{if(a.offsetParent===null||!a.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=a.querySelector("td:nth-child(2)"),d=a.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(a.querySelector(".qty-input").value),u=parseFloat(a.dataset.cost),b=a.querySelector(".supplier-select").value;if(b){if(!s[b]){const h=H.allSuppliers.find(v=>v.id===b);s[b]={info:h,items:[]}}s[b].items.push({name:i,qty:c,cost:u})}}),!r){p("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}H.finalOrders=s,H.step=2,tt()}if(e.target.closest("#btn-back-step1")&&(H.step=1,tt()),e.target.closest(".btn-send-order")){const o=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(o.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(o.dataset.orderItems)),a=parseFloat(o.dataset.total),n=H.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else p("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const o=e.target.closest(".btn-register-order");if(o.disabled)return;const s=JSON.parse(decodeURIComponent(o.dataset.order));s.establishmentId=m.establishmentId,o.disabled=!0,o.textContent="A processar...",$e(m.establishmentId).then(r=>{const a=r.purchaseConfig||null;return vi(s,a)}).then(()=>{p("Sucesso","Compra registrada e integrada ao financeiro!","success"),o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',o.classList.replace("bg-blue-600","bg-green-600"),o.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{o.disabled=!1,o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',p("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;O("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await hi(s,m.establishmentId),p("Sucesso","Compra e financeiro excluídos.","success"),ws()}catch(a){p("Erro","Erro ao excluir: "+a.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=H.finalOrders[s];r?Ni(r,H.isQuoteMode):p("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const o=e.target.closest(".btn-view-purchase"),s=JSON.parse(o.dataset.purchase);qi(s)}},fe.addEventListener("click",de),fe.addEventListener("input",de),fe.addEventListener("change",de),gt("list")}function gt(e){Et=e,["list","purchases","history"].forEach(o=>{const s=document.getElementById(`tab-btn-${o}`),r=document.getElementById(`tab-content-${o}`);o===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Ti()}const Kt=document.getElementById("content"),va={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ne=new Set,bt=null,De=null;function ji(e=8){let t="";for(let o=0;o<e;o++)t+=`
        ...
        `;return t}function Fi(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const o=t.status==="inactive",s=f(t.name),r=f(t.specialty||"Especialidade"),a=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function eo(){const e=document.getElementById("genericModal");e.style.display="none",De&&e.removeEventListener("click",De)}async function Hi(e){const t=document.getElementById("genericModal"),o=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=f(o.name),r=m.services||await ge(m.establishmentId),a=m.professionals||await K(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",Oi(o,r),zi(o),Vi(o,a),_i(o)}function Oi(e,t){const o=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,w)=>{const $=w+1,k=$==s[1]?"selected":"",I=new Date(0,w).toLocaleString("pt-BR",{month:"long"});return`<option value="${$}" ${k}>${I.charAt(0).toUpperCase()+I.slice(1)}</option>`}).join(""),a=e.status||"active",n=f(e.name||""),i=f(e.specialty||""),l=f(e.phone||""),d=f(e.notes||"");o.innerHTML=`
        ...
        `).join("")}catch(s){o.innerHTML=`<p class="text-red-500">${s.message}</p>`}}}function _i(e){const t=document.getElementById("genericModal");De&&t.removeEventListener("click",De),De=async o=>{const s=o.target.closest("button[data-action]");if(!s){const a=o.target.closest(".tab-link");a&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),a.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(a.dataset.tab).classList.remove("hidden"));return}const r=s.dataset.action;switch(o.stopPropagation(),r){case"close-modal":eo();break;case"delete-professional":const a=s.dataset.id;if(await O("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Oa(a),p("Sucesso!","Profissional excluído.","success"),eo(),Bt()}catch(v){p("Erro",`Não foi possível excluir: ${v.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(v=>v.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(v=>{const y=v.querySelector('[data-field="active"]').dataset.day;u[y]={active:v.querySelector('[data-field="active"]').checked,start:v.querySelector('[data-field="start"]').value,end:v.querySelector('[data-field="end"]').value,breakStart:v.querySelector('[data-field="breakStart"]').value,breakEnd:v.querySelector('[data-field="breakEnd"]').value}});const g={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{g.id?(await Lt(g.id,g),p("Sucesso!","Profissional atualizado.","success")):(delete g.id,await Ha(g),p("Sucesso!","Profissional criado.","success")),eo(),Bt()}catch(v){p("Erro",v.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=s.dataset.id;if(await O("Apagar Bloqueio","Tem certeza?"))try{await Eo(b),p("Bloqueio removido.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";ot(e.id,v)}catch(v){p("Erro",v.message,"error")}break;case"batch-delete-blockage":const h=JSON.parse(s.dataset.ids);if(await O("Apagar em Lote",`Tem certeza que deseja apagar ${h.length} bloqueios com este motivo?`))try{await Ya(h),p("Bloqueios removidos.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";ot(e.id,v)}catch(v){p("Erro",v.message,"error")}break}},t.addEventListener("click",De)}function fo(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ne.size>0?(t.textContent=`${ne.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function Wi(){O("Excluir em Lote",`Tem certeza que deseja excluir ${ne.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await dr(Array.from(ne)),p("Sucesso!",`${ne.size} profissionais foram excluídos.`,"success"),ne.clear(),fo(),Bt()}catch(t){p("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ge(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=ji();return}const t=document.getElementById("showInactiveProfToggle").checked,o=document.getElementById("profSearchInput").value.toLowerCase(),s=m.professionals.filter(r=>{const a=r.name.toLowerCase().includes(o),n=t||r.status!=="inactive";return a&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Fi(s)}async function Bt(){ne.clear(),Kt.innerHTML=`
        ...
        </section>`,bt&&Kt.removeEventListener("click",bt),bt=t=>{const o=t.target.closest('[data-action="open-professional-modal"]'),s=t.target.closest('[data-action="batch-delete"]');if(o){t.preventDefault();let a={};if(o.dataset.professional)try{a=JSON.parse(o.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}Hi(a);return}if(s){Wi();return}const r=t.target.closest(".professional-checkbox");if(r){const a=r.dataset.id;r.checked?ne.add(a):ne.delete(a),Ge(),fo();return}},Kt.addEventListener("click",bt),document.getElementById("profSearchInput").addEventListener("input",Ge),document.getElementById("showInactiveProfToggle").addEventListener("change",Ge);const e=document.getElementById("professionalsList");m.professionals=null,m.services=null,Ge();try{const[t,o]=await Promise.all([K(m.establishmentId),ge(m.establishmentId)]);m.professionals=t,m.services=o,Ge(),fo()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}let S={clients:[],selectedClient:null,activeTab:"profile",filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},showFilters:!1,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},desktopModalOpen:!1},ks=null;const Ji=e=>e?String(e).replace(/\D/g,""):"";function Yt(){ks.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client"),t=document.getElementById("btn-back-list");e&&(e.onclick=el),t&&(t.onclick=()=>{S.selectedClient=null,Ve()})}function Ve(){Yt();const e=document.getElementById("clients-content-area"),t=S.filters.inactiveDays||S.filters.birthMonth||S.filters.hasLoyalty||S.filters.hasDebt,o=`
        ...
        <div class="px-4 pb-20 pt-2">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${S.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,g=c.lastVisit?new Date(c.lastVisit).toLocaleDateString("pt-BR"):"Nunca";return`
                    <div class="client-card bg-white p-4 rounded-xl border ${u?"border-l-4 border-l-red-500 border-y-red-100 border-r-red-100":"border-gray-200 border-l-4 border-l-indigo-500"} shadow-sm hover:shadow-md transition cursor-pointer active:bg-gray-50 flex items-center gap-3 group" data-id="${c.id}">
    ...
    `;e.innerHTML=o+s;const r=document.getElementById("client-search"),a=document.getElementById("btn-toggle-filters"),n=document.getElementById("btn-apply-filters"),i=document.getElementById("btn-clear-search");a&&(a.onclick=()=>{S.showFilters=!S.showFilters,Ve()});const l=document.getElementById("filter-birth-month");l&&(l.value=S.filters.birthMonth);const d=()=>{const c=document.getElementById("filter-inactive"),u=document.getElementById("filter-loyalty"),g=document.getElementById("filter-debt"),b=document.getElementById("filter-birth-month");S.filters={search:r.value,inactiveDays:c?c.value:"",birthMonth:b?b.value:"",hasLoyalty:u?u.checked:!1,hasDebt:g?g.checked:!1},vo()};n&&(n.onclick=d),i&&(i.onclick=()=>{S.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},S.showFilters=!1,vo()}),r.addEventListener("keypress",c=>{c.key==="Enter"&&d()}),e.querySelectorAll(".client-card").forEach(c=>{c.onclick=()=>Es(c.dataset.id)})}function Ss(e){const t=`
            ...
            <div class="bg-gradient-to-br from-indigo-600 to-purple-700 p-6 text-white relative">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                    ...
                    <div class="text-center sm:text-left flex-grow">
                        <h2 class="text-2xl font-bold leading-tight break-words">${f(e.name)}</h2>
    ...
    `}function $s(e,t){if(!document.getElementById("tabs-styles")){const a=document.createElement("style");a.id="tabs-styles",a.textContent=`
        ...
        `,t.onclick=r=>{r.target===t&&Ne()},document.body.appendChild(t),S.desktopModalOpen=!0);const o=t.querySelector("#client-modal-content");o.innerHTML=Ss(e);const s=o.querySelector(".desktop-modal-close");s&&s.classList.remove("hidden"),$s(o,e)}function Ne(){const e=document.getElementById("client-details-modal-overlay");e&&e.remove(),S.desktopModalOpen=!1,S.selectedClient=null}function Yi(e){return`
        <form id="form-edit-client" class="space-y-5 pb-20">
            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" value="${f(e.name)}" required class="block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base">
                    </div>
                    
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Telefone</label>
                            <input type="tel" name="phone" value="${f(e.phone||"")}" class="block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">E-mail</label>
                            <input type="email" name="email" value="${f(e.email||"")}" class="block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="dobDay" min="1" max="31" value="${e.dobDay||""}" class="block w-full p-3 rounded-lg border border-gray-300 bg-gray-50 text-base text-center">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Mês Nasc.</label>
                            <input type="number" name="dobMonth" min="1" max="12" value="${e.dobMonth||""}" class="block w-full p-3 rounded-lg border border-gray-300 bg-gray-50 text-base text-center">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                ...
                <textarea name="notes" rows="4" class="block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base" placeholder="Preferências, alergias...">${f(e.notes||"")}</textarea>
            </div>
        ...
        <div class="space-y-6 pb-20">
            <div class="bg-gradient-to-r from-amber-400 to-orange-500 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
                ...
                <div class="flex items-baseline gap-2">
                    <h1 class="text-5xl font-black">${e.loyaltyPoints||0}</h1>
    ...
    `}async function vo(){S.loading=!0,Yt();try{let e=`/api/clients/${m.establishmentId}?limit=20`;S.filters.search&&(e+=`&search=${encodeURIComponent(S.filters.search)}`),S.filters.inactiveDays&&(e+=`&inactiveDays=${S.filters.inactiveDays}`),S.filters.hasLoyalty&&(e+="&hasLoyalty=true"),S.filters.hasDebt&&(e+="&hasDebt=true"),S.clients=await E(e),Ve()}catch(e){console.error(e),p("Erro","Falha ao carregar clientes.","error"),S.clients=[],Ve()}finally{S.loading=!1;const e=document.querySelector(".loader");e&&e.parentElement&&e.parentElement.remove()}}async function ha(e){const t=S.selectedClient;if(!(!t||!t.phone)){S.historyLoading=!0,document.querySelector(".animate-fade-in");try{const o=new Date;o.setMonth(o.getMonth()+12);const s=new Date;s.setFullYear(s.getFullYear()-5);let r=`/api/appointments/${m.establishmentId}?startDate=${s.toISOString()}&endDate=${o.toISOString()}`;r+=`&clientPhone=${encodeURIComponent(Ji(t.phone))}`,r+=`&limit=${S.historyLimit}`;const a=await E(r);S.historyData.appointments=a,S.historyData.sales=a.filter(i=>i.status==="completed").map(i=>({id:i.id,date:i.startTime,totalAmount:i.totalAmount||0,items:i.services||[]}));const n=[];a.forEach(i=>{i.status==="completed"&&i.loyaltyPointsEarned>0&&n.push({type:"earn",points:i.loyaltyPointsEarned,date:i.startTime,description:"Venda finalizada"}),i.loyaltyRedemption&&n.push({type:"redemption",points:i.loyaltyRedemption.cost||0,date:i.startTime,description:`Resgate: ${i.loyaltyRedemption.name}`})}),S.historyData.loyaltyLog=n}catch(o){console.error("Erro ao buscar histórico",o)}finally{S.historyLoading=!1,S.selectedClient&&qe()}}}function Ki(e){const t=e.loyaltyPoints||0,o=`
        <div class="text-center mb-6">
    ...
    `,{modalElement:s,close:r}=Y({title:"Ajuste de Pontos",contentHTML:o,maxWidth:"max-w-xs"});s.querySelector("form").onsubmit=async a=>{a.preventDefault();const n=document.getElementById("redeem-action").value,i=parseInt(document.getElementById("redeem-points").value,10),l=document.getElementById("redeem-reason").value;if(!i||i<=0)return p("Erro","Qtd inválida.","error");if(n==="debit"&&i>t)return p("Erro","Saldo insuficiente.","error");try{let d=t;n==="debit"?(await Hr(m.establishmentId,e.phone,i,l),d-=i):(d+=i,await Za(e.id,{loyaltyPoints:d})),S.selectedClient.loyaltyPoints=d,S.historyData.loyaltyLog.unshift({type:n==="debit"?"redemption":"earn",points:i,date:new Date().toISOString(),description:l+" (Manual)"}),p("Sucesso","Saldo atualizado.","success"),r(),qe()}catch(d){p("Erro",d.message,"error")}}}function Es(e){S.selectedClient=S.clients.find(t=>t.id===e),S.activeTab="profile",S.historyLimit=20,S.historySearchTerm="",S.historyData={appointments:[],sales:[],loyaltyLog:[]},qe()}function el(){const e=`
    ...
    `;const o=t.querySelector("#establishmentTimezone");if(e.timezone)o.value=e.timezone;else try{const a=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(o.options).some(i=>i.value===a)?o.value=a:o.value="America/Sao_Paulo"}catch{o.value="America/Sao_Paulo"}const s=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(to).forEach(a=>{const n=r[a]||{},i=to[a],l=n.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${l?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",a=>{const n=a.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",a=>{a.preventDefault();const n={};Object.keys(to).forEach(l=>{n[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;Ue({workingHours:n,timezone:i},a)})}async function ul(e,t){const o=e.loyaltyProgram||{},s=o.pointsPerVisit||1;let r=[],a=[],n=[];try{[r,a,n]=await Promise.all([ge(m.establishmentId),dt(m.establishmentId),Po(m.establishmentId)])}catch(d){console.error("Erro ao carregar dados para fidelidade:",d)}t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[o,s]=await Promise.all([Do(m.establishmentId),Bo(m.establishmentId)]),r=e.financialIntegration||{},a=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ce(o,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ce(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ce(o,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ce(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ce(o,a.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ce(s,a.defaultCostCenterId)}catch{p("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",o=>{o.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Ue(s,o)})}function pl(e,t){const o="5516997859430",s=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${o}?text=${s}`;t.innerHTML=`
    ...
    `}function Cs(e="indigo",t){const o=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!o||!s||(o.innerHTML="",Object.entries(sl).forEach(([r,a])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{s.value=r,Cs(r,t)}),o.appendChild(i)}),s.value=e)}function fl(e,t){const o=t.querySelector("#slotIntervalContainer"),s=t.querySelector("#establishmentSlotInterval");if(!o||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];o.innerHTML=r.map(a=>{const n=a.value===e;return`<button type="button" data-value="${a.value}" 
    ...
    `,xe.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),Ls()});const o=document.getElementById("settings-content-detail");switch(e){case"personal-data":rl(J,o);break;case"change-password":nl(J,o);break;case"change-email":il(J,o);break;case"branding":ll(J,o);break;case"booking":dl(J,o);break;case"working-hours":cl(J,o);break;case"loyalty":await ul(J,o);break;case"financial":await ml(J,o);break;case"support":pl(J,o);break;case"cancellation":gl(J,o);break;default:bl(t?t.label:"Definições",o)}}async function Ls(){if(xe.innerHTML=`
    ...
    `,Ye&&ve.removeEventListener("click",Ye),Qe&&ve.removeEventListener("change",Qe),Ye=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("click",Ye);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":ya();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));ya(s);break;case"back-to-list":Mt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await O("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await El(r),p("Usuário excluído com sucesso!","success"),Mt()}catch(n){p(`Erro ao excluir: ${n.message}`,"error")}break}}},Qe=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("change",Qe);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")It();else if(t){e.stopPropagation();const o=t.dataset.userId,s=t.checked?"active":"inactive";try{await Cl(o,s),p(`Usuário ${s==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=m.users.findIndex(a=>a.id===o);r>-1&&(m.users[r].status=s,It())}catch(r){p(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,It()}}},ve.addEventListener("click",Ye),ve.addEventListener("change",Qe),await Bl()}const Ml=document.getElementById("content");let wa={},ho=null;function Al(){Object.values(wa).forEach(e=>e?.destroy()),wa={}}function ql(e,t){if(!window.jspdf){p("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:o}=window.jspdf,s=new o({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const a=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,a),s.autoTable({html:`#${t}`,startY:a+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function ka(e){const t=document.getElementById("genericModal"),o=f(e.client),s=f(e.items),r=f(e.responsavelCaixa||"N/A"),a=(e.payments||[]).map(n=>`
    ...
    `}).join(""),a.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ho.transactions[l];d&&ka(d)})}),n.innerHTML=o.map((i,l)=>{const d=f(i.client),c=f(i.items),u=f(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ho.transactions[l];d&&ka(d)})})}async function Sa(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),o=document.getElementById("reportEndDate");if(!e||!t||!o)return;const s=t.value,r=o.value;if(!s||!r)return p("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const a=document.getElementById("cashierSessionFilter").value,n=await Rr({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:a});ho=n,e.innerHTML=`
        ...
        `;e.innerHTML=t.map(r=>s(r)).join("")}async function xo(e){const t=document.getElementById("genericModal"),o=e==="nature",s=o?"Naturezas Financeiras":"Centros de Custo",r=o?Do:Bo,a=o?qn:Rn,n=o?"natures":"costCenters";t.innerHTML=`
    ...
    `}function Ts(){const e=document.getElementById("list-container");if(!e)return;const t=A.currentTab==="receivables",o=t?A.receivables:A.payables;let s=o;if(A.statusFilter!=="all"&&(s=o.filter(n=>n.status===A.statusFilter)),s.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),s.length===0){e.innerHTML=`
        ...
        `}).join("")}async function Wl(e,t){const o=new Date().toISOString().split("T")[0];try{await(e==="payable"?Vn(t,o):Gn(t,o)),p("Sucesso","Lançamento baixado!","success"),await _e()}catch(s){p("Erro",s.message,"error")}}async function Jl(e,t){if(await O("Excluir Lançamento","Tem certeza? Essa ação não pode ser desfeita."))try{await(e==="payable"?zn(t):Jn(t)),p("Sucesso","Lançamento excluído.","success"),await _e()}catch(s){p("Erro",s.message,"error")}}async function Gl(e,t){const s=e==="nature"?Nn:jn;if(await O("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await s(t),xo(e==="nature"?"nature":"cost-center")}catch(a){p("Erro",a.message,"error")}}function Yl(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,q.historyData.length>0?Ds(document.getElementById("history-list-container"),q.historyData):Ho()}function Ds(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ao=document.getElementById("content");let ke={allPackages:[],catalogForModal:{services:[],products:[]}},xt=null,Be=null;function gd(e=6){let t="";for(let o=0;o<e;o++)t+=`
    ...
    `,document.body.appendChild(o);const a=o.querySelector("#item-selection-list"),n=o.querySelector("#item-search-input"),i=()=>{o.remove()};r(a),n.addEventListener("input",()=>{t=n.value,r(a)}),o.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:g}=d.dataset,h=(ke.catalogForModal[u+"s"]||[]).find(v=>v.id===g);h&&(e({...h,type:u}),i())}else(c||l.target===o)&&i()})}async function Oo(){ao.innerHTML=`
    ...
    `,xt&&ao.removeEventListener("click",xt),xt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;O("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async a=>{if(a)try{await hn(r),p("Sucesso!","Pacote excluído.","success"),await Oo()}catch(n){p("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const o=t.dataset.action;if(o==="new-package")Ca(null);else if(o==="edit-package"){const s=JSON.parse(t.dataset.package);Ca(s)}},ao.addEventListener("click",xt);try{const[e,t,o]=await Promise.all([Po(m.establishmentId),ge(m.establishmentId),dt(m.establishmentId)]);ke.allPackages=e,ke.catalogForModal={services:t.filter(s=>s.active),products:o},bd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const vd=document.getElementById("content");let hd=null;async function xd(){const e=f(m.userName||"Usuário"),t=f(U.currentUser?.email||"E-mail não disponível"),o=m.userName?m.userName.charAt(0):"U";vd.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await yd()}async function yd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const o=await lr(t);hd=o,o.photo&&(document.getElementById("user-profile-avatar").src=o.photo);const s=f(o.name);e.innerHTML=`
    ...
    `}function yo(){const e=rt.filter(t=>!t.read).length;if(e>0?(no.textContent=e,no.classList.remove("hidden")):no.classList.add("hidden"),rt.length===0){Ta.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Ta.innerHTML=rt.map(t=>`
