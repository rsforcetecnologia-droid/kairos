...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${pa}. Verifique se o servidor backend está rodando.`):i}}const Oo=(e,t,a,o=null)=>{let s=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(s+=`&professionalId=${o}`),I(s)},ar=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const s=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return I(s)},or=e=>I("/api/appointments",{method:"POST",body:JSON.stringify(e)}),sr=(e,t)=>I(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),_a=e=>I(`/api/appointments/${e}`,{method:"DELETE"}),rr=e=>I(`/api/appointments/${e}/reopen`,{method:"POST"}),ir=(e,t)=>I(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Q;async function nr(){if(!Q)try{Q=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function lr(){if(!Q){console.warn("AudioContext não inicializado. O som não será tocado.");return}Q.state==="suspended"&&Q.resume();const e=Q.createOscillator(),t=Q.createGain();e.connect(t),t.connect(Q.destination),e.type="sine",e.frequency.setValueAtTime(800,Q.currentTime),t.gain.setValueAtTime(0,Q.currentTime),t.gain.linearRampToValueAtTime(.3,Q.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Q.currentTime+.2),e.start(Q.currentTime),e.stop(Q.currentTime+.2)}function g(e,t,a="info",o=!1){const s=document.getElementById("toast-container");if(!s)return;o&&lr();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `;const l=s.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=s.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),s.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),s.style.display="flex",{modalElement:s,close:i,setContent:n}}function dr(){document.body.addEventListener("click",()=>{Q||nr()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const o=t.dataset.target;if(o){const s=document.getElementById(o);s&&(s.style.display="none")}}if(e.target.closest("[data-close-modal]")){const o=document.getElementById("genericModal");o&&(o.style.display="none")}})}const G=document.getElementById("sidebar"),Ce=document.getElementById("sidebarToggle"),at=document.getElementById("mainContent"),cr=document.querySelectorAll(".sidebar-link"),ga=document.getElementById("menu-search"),Wa=document.getElementById("hamburger-menu-btn"),ze=document.getElementById("mobile-overlay");let ge=!0;function xe(e){if(!G||!at)return;G.classList.toggle("collapsed",e),at.classList.toggle("sidebar-collapsed-shift",e);const t=G.querySelector(".sidebar-search-container"),a=G.querySelectorAll(".sidebar-category");e?(t&&(t.style.display="none"),a.forEach(o=>o.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(o=>{const s=o.getAttribute("data-target-submenu"),r=document.getElementById(s),i=o.querySelector(".submenu-arrow");r&&(r.classList.add("hidden"),r.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(t&&(t.style.display="block"),a.forEach(o=>o.style.display="block"))}function ur(){!G||!ze||(G.classList.add("mobile-open"),ze.classList.add("visible"))}function xt(){!G||!ze||(G.classList.remove("mobile-open"),ze.classList.remove("visible"))}function mr(){xe(!G.classList.contains("collapsed"))}function pr(e,t){const a=document.getElementById(e);if(!a)return;const o=a.classList.contains("hidden");o&&window.innerWidth>=1024&&G.classList.contains("collapsed")&&xe(!1),o?(a.classList.remove("hidden"),a.classList.add("flex"),t&&t.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),t&&t.classList.remove("rotate-180"))}function gr(){ga&&ga.addEventListener("input",e=>{const t=e.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const o=a.querySelectorAll("li"),s=a.querySelectorAll(".sidebar-category");if(t===""){o.forEach(r=>r.style.display=""),s.forEach(r=>r.style.display="block");return}s.forEach(r=>r.style.display="none"),o.forEach(r=>{if(r.classList.contains("sidebar-category"))return;const i=r.querySelector(".sidebar-link")||r.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(t)){r.style.display="";const d=r.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const c=d.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const c=document.getElementById(d);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(f=>f.textContent.toLowerCase().includes(t))?r.style.display="":r.style.display="none")}else r.style.display="none"}})})}function br(e,t,a){if(!G||!at)return;at.classList.add("main-content-shift"),window.innerWidth>=1024?(ge=!0,xe(!1)):window.innerWidth>=768?(ge=!1,xe(!0)):(at.classList.remove("main-content-shift","sidebar-collapsed-shift"),xt()),Ce&&Ce.addEventListener("click",s=>{s.stopPropagation(),window.innerWidth>=768?(ge=!ge,xe(!ge),ge?(Ce.classList.add("text-indigo-400"),Ce.classList.remove("text-gray-400")):(Ce.classList.remove("text-indigo-400"),Ce.classList.add("text-gray-400"))):mr()}),G.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!ge&&G.classList.contains("collapsed")&&xe(!1)}),G.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!ge){const s=!!document.querySelector("#sidebarToggle:hover"),r=document.activeElement===ga;!s&&!r&&xe(!0)}}),Wa&&Wa.addEventListener("click",s=>{s.stopPropagation(),ur()}),ze&&ze.addEventListener("click",s=>{s.stopPropagation(),xt()});let o=0;G.addEventListener("touchstart",s=>{o=s.changedTouches[0].screenX},{passive:!0}),G.addEventListener("touchend",s=>{const r=s.changedTouches[0].screenX;o-r>50&&xt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation();const i=s.getAttribute("data-target-submenu"),n=s.querySelector(".submenu-arrow");pr(i,n)})}),gr(),cr.forEach(s=>{const r=s.getAttribute("data-target");if(!r)return;const i=r.replace("-section",""),n=a?.[i]!==!1,l=t===null||t[r]?.view===!0;if(!n||!l){s.parentElement&&s.parentElement.tagName==="LI"?s.parentElement.style.display="none":s.style.display="none";return}s.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),s.classList.add("active"),r&&typeof e=="function"&&e(r),window.innerWidth<768&&xt()})})}const fr=e=>I("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),We=()=>I("/api/establishments/hierarchy",{method:"GET"}),Se=e=>{const t=e||m.establishmentId;return t?I(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},La=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},vr=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},hr=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))};class xr{constructor(t,a,o){this.steps=t,this.currentStep=0,this.onComplete=a,this.onSkip=o,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(t=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),t&&this.onComplete?this.onComplete():!t&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const t=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",t.onBefore&&(await t.onBefore(),await this.sleep(600));const a=await this.waitForElement(t.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const s=a.getBoundingClientRect(),r=8;this.spotlight.style.top=`${s.top+window.scrollY-r}px`,this.spotlight.style.left=`${s.left+window.scrollX-r}px`,this.spotlight.style.width=`${s.width+r*2}px`,this.spotlight.style.height=`${s.height+r*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(s)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const o=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(t){const a=this.popover.getBoundingClientRect(),o=20;let s=t.bottom+window.scrollY+o,r=t.left+window.scrollX;s+a.height>window.scrollY+window.innerHeight&&(s=t.top+window.scrollY-a.height-o),r+a.width>window.innerWidth&&(r=t.right+window.scrollX-a.width),r<o&&(r=o),this.popover.style.top=`${s}px`,this.popover.style.left=`${r}px`}handleResize(){this.isActive&&this.renderStep()}sleep(t){return new Promise(a=>setTimeout(a,t))}async waitForElement(t,a){if(!t)return null;const o=Date.now();for(;Date.now()-o<a;){const s=document.querySelector(t);if(s)return s;await this.sleep(100)}return null}}async function yr(){try{console.log("A verificar Onboarding interativo...");const e=await Se(m.establishmentId);if(!e||e.parentId||e.onboardingCompleted)return;const t=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await La(m.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(s){console.error("Erro ao gravar fim do onboarding",s)}};new xr(t,a,a).start()}catch(e){console.error("Erro fatal ao iniciar onboarding:",e)}}var Ve;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ve||(Ve={}));class sa extends Error{constructor(t,a,o){super(t),this.message=t,this.code=a,this.data=o}}const wr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},kr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},o=a.Plugins=a.Plugins||{},s=()=>t!==null?t.name:wr(e),r=()=>s()!=="web",i=u=>{const p=d.get(u);return!!(p?.platforms.has(s())||n(u))},n=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(f=>f.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,p={})=>{const f=d.get(u);if(f)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),f.proxy;const b=s(),v=n(u);let x;const S=async()=>(!x&&b in p?x=typeof p[b]=="function"?x=await p[b]():x=p[b]:t!==null&&!x&&"web"in p&&(x=typeof p.web=="function"?x=await p.web():x=p.web),x),k=(C,M)=>{var q,H;if(v){const O=v?.methods.find(R=>M===R.name);if(O)return O.rtype==="promise"?R=>a.nativePromise(u,M.toString(),R):(R,_)=>a.nativeCallback(u,M.toString(),R,_);if(C)return(q=C[M])===null||q===void 0?void 0:q.bind(C)}else{if(C)return(H=C[M])===null||H===void 0?void 0:H.bind(C);throw new sa(`"${u}" plugin is not implemented on ${b}`,Ve.Unimplemented)}},E=C=>{let M;const q=(...H)=>{const O=S().then(R=>{const _=k(R,C);if(_){const Le=_(...H);return M=Le?.remove,Le}else throw new sa(`"${u}.${C}()" is not implemented on ${b}`,Ve.Unimplemented)});return C==="addListener"&&(O.remove=async()=>M()),O};return q.toString=()=>`${C.toString()}() { [capacitor code] }`,Object.defineProperty(q,"name",{value:C,writable:!1,configurable:!1}),q},T=E("addListener"),L=E("removeListener"),A=(C,M)=>{const q=T({eventName:C},M),H=async()=>{const R=await q;L({eventName:C,callbackId:R},M)},O=new Promise(R=>q.then(()=>R({remove:H})));return O.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await H()},O},F=new Proxy({},{get(C,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?A:T;case"removeListener":return L;default:return E(M)}}});return o[u]=F,d.set(u,{name:u,proxy:F,platforms:new Set([...Object.keys(p),...v?[b]:[]])}),F};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=s,a.handleError=l,a.isNativePlatform=r,a.isPluginAvailable=i,a.registerPlugin=c,a.Exception=sa,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Sr=e=>e.Capacitor=kr(e),le=Sr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Jt=le.registerPlugin;class zo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let o=!1;this.listeners[t]||(this.listeners[t]=[],o=!0),this.listeners[t].push(a);const r=this.windowListeners[t];r&&!r.registered&&this.addWindowListener(r),o&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,o){const s=this.listeners[t];if(!s){if(o){let r=this.retainedEventArguments[t];r||(r=[]),r.push(a),this.retainedEventArguments[t]=r}return}s.forEach(r=>r(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:o=>{this.notifyListeners(a,o)}}}unimplemented(t="not implemented"){return new le.Exception(t,Ve.Unimplemented)}unavailable(t="not available"){return new le.Exception(t,Ve.Unavailable)}async removeListener(t,a){const o=this.listeners[t];if(!o)return;const s=o.indexOf(a);this.listeners[t].splice(s,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(o=>{this.notifyListeners(t,o)}))}}const Ja=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ga=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class $r extends zo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(o=>{if(o.length<=0)return;let[s,r]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");s=Ga(s).trim(),r=Ga(r).trim(),a[s]=r}),a}async setCookie(t){try{const a=Ja(t.key),o=Ja(t.value),s=`; expires=${(t.expires||"").replace("expires=","")}`,r=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${o||""}${s}; path=${r}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Jt("CapacitorCookies",{web:()=>new $r});const Er=async e=>new Promise((t,a)=>{const o=new FileReader;o.onload=()=>{const s=o.result;t(s.indexOf(",")>=0?s.split(",")[1]:s)},o.onerror=s=>a(s),o.readAsDataURL(e)}),Ir=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(s=>s.toLocaleLowerCase()).reduce((s,r,i)=>(s[r]=e[t[i]],s),{})},Lr=(e,t=!0)=>e?Object.entries(e).reduce((o,s)=>{const[r,i]=s;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=t?encodeURIComponent(d):d,l+=`${r}=${n}&`}),l.slice(0,-1)):(n=t?encodeURIComponent(i):i,l=`${r}=${n}`),`${o}&${l}`},"").substr(1):null,Cr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),s=Ir(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(s.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[i,n]of Object.entries(e.data||{}))r.set(i,n);a.body=r.toString()}else if(s.includes("multipart/form-data")||e.data instanceof FormData){const r=new FormData;if(e.data instanceof FormData)e.data.forEach((n,l)=>{r.append(l,n)});else for(const n of Object.keys(e.data))r.append(n,e.data[n]);a.body=r;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(s.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Tr extends zo{async request(t){const a=Cr(t,t.webFetchExtra),o=Lr(t.params,t.shouldEncodeUrlParams),s=o?`${t.url}?${o}`:t.url,r=await fetch(s,a),i=r.headers.get("content-type")||"";let{responseType:n="text"}=r.ok?t:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await r.blob(),l=await Er(d);break;case"json":l=await r.json();break;case"document":case"text":default:l=await r.text()}const c={};return r.headers.forEach((u,p)=>{c[p]=u}),{data:l,headers:c,status:r.status,url:r.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Jt("CapacitorHttp",{web:()=>new Tr});const X=Jt("PushNotifications",{}),Dr="modulepreload",Pr=function(e){return"/"+e},Ya={},Br=function(t,a,o){let s=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");s=l(a.map(d=>{if(d=Pr(d),d in Ya)return;Ya[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Dr,c||(p.as="script"),p.crossOrigin="",p.href=d,n&&p.setAttribute("nonce",n),document.head.appendChild(p),c)return new Promise((f,b)=>{p.addEventListener("load",f),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return s.then(i=>{for(const n of i||[])n.status==="rejected"&&r(n.reason);return t().catch(r)})},Qa=Jt("App",{web:()=>Br(()=>import("./web-CvzHZQNS.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Mr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Xa=!1;async function Ar(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await X.removeAllListeners(),await X.addListener("registration",async a=>{Uo(a.value,!0)}),await X.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await X.addListener("pushNotificationActionPerformed",a=>{const o=a.notification.data;console.log("Notificação clicada (Ação):",o)});let t=await X.checkPermissions();t.receive==="prompt"&&(t=await X.requestPermissions()),t.receive==="granted"&&await X.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Vo()}async function qr(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Vo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Vo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Zs(Ua,{vapidKey:Mr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Uo(t,!1)):console.warn("[Push Web] Token veio vazio."),Xa||(Ks(Ua,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Xa=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Uo(e,t){const a=oe.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const o=ft(pe,"users",a.uid);try{const s=await Ro(o);if(s.exists()){const i=s.data().fcmTokens||[];if(i.length===1&&i[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Ia(o,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(s){if(s.code==="not-found")try{await Ws(o,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(r){console.error("Erro ao criar user:",r)}else console.error("Erro ao atualizar token:",s)}}const Rr=(e,t,a="all",o="all")=>{const s=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&s.append("professionalId",a),o&&o!=="all"&&s.append("costCenterId",o),I(`/api/reports/indicators?${s.toString()}`)},Nr=e=>e?I(`/api/financial/cost-centers/${e}`):Promise.resolve([]),jr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:o})=>{const s=new URLSearchParams({startDate:t,endDate:a});return o&&o!=="all"&&s.append("cashierSessionId",o),e&&s.append("establishmentId",e),I(`/api/reports/sales?${s.toString()}`)},Fr=()=>I("/api/reports/summary",{method:"GET"}),Ie=e=>I(`/api/services/${e}`),Hr=e=>I("/api/services",{method:"POST",body:JSON.stringify(e)}),Or=(e,t)=>I(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),zr=e=>I(`/api/services/${e}`,{method:"DELETE"}),Vr=(e,t)=>I(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Ur=e=>I(`/api/services/stats/most-popular/${e}`),re=e=>I(`/api/professionals/${e}`),_r=e=>I(`/api/professionals/details/${e}`),Wr=e=>I("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Jr=(e,t)=>I(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),_o=e=>I(`/api/professionals/${e}`,{method:"DELETE"}),Gr=e=>{const t=e.map(a=>_o(a));return Promise.all(t)},Gt=(e,t,a,o="all")=>{const s=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${o}`;return I(s)},Yt=e=>I("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Ca=e=>I(`/api/blockages/${e}`,{method:"DELETE"}),Wo=e=>I("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Ta=e=>e?String(e).replace(/\D/g,""):"",Da=(e,t="",a=20,o={})=>{const s=new URLSearchParams;return t&&s.append("search",t),a&&s.append("limit",a),o&&o.hasLoyalty&&s.append("hasLoyalty","true"),o&&o.birthMonth&&s.append("birthMonth",o.birthMonth),o&&o.inactiveDays&&s.append("inactiveDays",o.inactiveDays),I(`/api/clients/${e}?${s.toString()}`)},Jo=(e,t)=>{const a=encodeURIComponent(t);return I(`/api/clients/details/${e}/${a}`)},Go=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Ta(t),o={...e,phone:a,id:a};return I(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(o)})},Yo=Go,Qo=(e,t)=>Go({...t,id:e}),Yr=e=>{const t=encodeURIComponent(e);return I(`/api/clients/${t}`,{method:"DELETE"})},Qr=(e,t,a,o)=>I("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ta(t),points:a,rewardName:o})}),Xr=(e,t)=>Jo(e,Ta(t));function h(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Xo(e,t=800,a=800,o=.7){return new Promise((s,r)=>{if(!e.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(e),i.onload=n=>{const l=new Image;l.src=n.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const f=u.toDataURL("image/jpeg",o);s(f)},l.onerror=d=>r(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>r(new Error("Erro ao ler o ficheiro."))})}const Za=document.getElementById("content");let Ka=!1;const ba=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Qt=[],fa=[],At={},Zo=[],B={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},P={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function mt(e){const t=new Date(e),a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return t.setDate(o),t.setHours(0,0,0,0),t}function Pa(){const e=document.getElementById("profSelectorContainer");if(!e||!m.professionals)return;let t=m.professionals.filter(s=>B.showInactiveProfs||s.status!=="inactive");const o=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=o.map(s=>{const r=B.selectedProfessionalId===s.id,i=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),n=s.id!=="all"?m.professionalColors.get(s.id)||ba[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            <div class="prof-pill ${r?"active":""}"
                ...
                <span>${z(s.name==="Todos"?"Todos":s.name.split(" ")[0])}</span>
                    ...
                    </div>`;const x=JSON.stringify(u).replace(/'/g,"&apos;"),S=(u.services||[]).reduce((k,E)=>k+(Number(E.price)||0),0)||Number(u.totalPrice||0)||Number(u.servicePrice||0);return`<div class="week-event-chip ${v?"completed":""}" style="--ec: ${b.main};"
                    ${v?"":`data-action="edit-appointment" data-appointment="${x}"`}>
                    ...
                    <div class="we-meta">R$ ${S.toFixed(2).replace(".",",")} · ${z(u.clientPhone||"")}</div>
                    <div class="we-actions">
                        <button class="we-btn" data-action="open-comanda" data-appointment="${x}" title="Comanda" onclick="event.stopPropagation();">
            ...
            <div class="list-date-label">${s}</div>`,r.forEach(i=>{const n=new Date(i.startTime),l=new Date(i.endTime),d=Math.round((l-n)/6e4),c=n.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=m.professionalColors.get(i.professionalId)||{main:"#adb5bd"},p=i.status==="completed";i.clientName&&i.clientName.charAt(0).toUpperCase();const f=JSON.stringify(i).replace(/'/g,"&apos;"),b=B.selectedItems.has(i.id),v=B.isSelectionMode?`<input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-indigo-600" data-action="toggle-select-item" data-id="${i.id}" ${b?"checked":""} onclick="event.stopPropagation()">`:"";if(i.type==="blockage"){o+=`<div class="list-card blockage">
                ...
                </div>`;return}const x=Zr(i.clientPhone,i.clientName,i.serviceName,i.professionalName,i.startTime),S=(i.services||[]).reduce((L,A)=>L+(Number(A.price)||0),0)||Number(i.totalPrice||0)||Number(i.servicePrice||0),k=i.paymentStatus||(i.status==="completed"?"Finalizado":"Agendado"),E=z((i.professionalName||"").split(" ")[0]),T=(i.services||[]).length||(i.serviceName?1:0);o+=`<div class="list-card ${p?"completed":""}"
                ...
                <div class="list-card-info">
                    ...
                    <div class="lc-detail">${z(i.serviceName)} · ${E}</div>
                    <div class="lc-extra">
                        <span>R$ ${S.toFixed(2).replace(".",",")}</span>
                        <span>${z(i.clientPhone||"")}</span>
                        <span>${T} serviço(s)</span>
                        <span>${z(k)}</span>
                    </div>
                </div>
                ...
                <div class="list-card-actions">
                    <button class="lc-action-btn wa" onclick="event.stopPropagation(); window.open('${x}', '_blank')" title="WhatsApp">
            ...
            </div>`}),o+="</div>"}),o+="</div>",t.innerHTML=o}function Ko(){const e=m.allEvents.filter(t=>B.selectedProfessionalId==="all"||t.professionalId===B.selectedProfessionalId);B.currentView==="list"?ei(e):Kr(e),Ba()}function Ba(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(B.isSelectionMode&&B.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
        ...
        </div>`,e.style.display="block",t&&(t.style.display="none")):(e.style.display="none",t&&(t.style.display="flex")))}function ti(){const e=document.getElementById("currentDateDisplay");if(!e)return;const t=new Date;t.setHours(0,0,0,0);const a=new Date(B.currentDate);if(a.setHours(0,0,0,0),ai(t,a),B.currentView==="list")a.toDateString()===t.toDateString()?e.textContent="Hoje":e.textContent=a.toLocaleDateString("pt-BR",{day:"numeric",month:"short",year:"numeric"});else{const o=mt(a),s=new Date(o);s.setDate(o.getDate()+6);const r=o.toLocaleDateString("pt-BR",{day:"numeric",month:"short"}),i=s.toLocaleDateString("pt-BR",{day:"numeric",month:"short",year:"numeric"});e.textContent=`${r} — ${i}`}}function ai(e,t){const a=mt(e),o=mt(t);return a.toDateString()===o.toDateString()}async function ce(){const e=document.getElementById("agenda-view");if(!e)return;B.selectedItems.clear(),Ba(),e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;padding:60px 0;"><div style="width:28px;height:28px;border:2.5px solid #e9ecef;border-top:2.5px solid #4f46e5;border-radius:50%;animation:spin 0.7s linear infinite;"></div></div><style>@keyframes spin{to{transform:rotate(360deg)}}</style>',ti();let t,a;if(B.currentView==="list")t=new Date(B.currentDate),t.setHours(0,0,0,0),a=new Date(t),a.setHours(23,59,59,999);else{const o=mt(B.currentDate);t=new Date(o),a=new Date(o),a.setDate(o.getDate()+6),a.setHours(23,59,59,999)}try{const[o,s]=await Promise.all([Oo(m.establishmentId,t.toISOString(),a.toISOString(),B.selectedProfessionalId==="all"?null:B.selectedProfessionalId),Gt(m.establishmentId,t.toISOString(),a.toISOString(),B.selectedProfessionalId)]);if(!document.getElementById("agenda-view"))return;const r=i=>i.map(n=>({...n,type:n.type||"appointment",professionalName:n.professionalName||(()=>{const l=m.professionals?.find(d=>d.id===n.professionalId);return l?l.name:"Indefinido"})()}));m.allEvents=[...r(o||[]),...r(s||[])],Pa(),Ko()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12" style="color:#868e96;">
                    <i class="bi bi-exclamation-triangle" style="font-size:1.5rem;"></i>
                    <p class="mt-2" style="font-size:0.8rem;">Erro ao carregar agenda.</p>
                </div>`)}}async function oi(){try{const[e,t,a]=await Promise.all([re(m.establishmentId),Ie(m.establishmentId),Se(m.establishmentId)]);m.professionals=e||[],m.services=t||[],Zo=[],a&&(At=a.loyaltyProgram||{enabled:!1}),m.professionals.forEach((o,s)=>{m.professionalColors.set(o.id,ba[s%ba.length])}),Pa()}catch{g("Atenção","Não foi possível carregar os dados da equipa.","error")}}async function es(e={}){B.currentDate=e.targetDate?new Date(e.targetDate):B.currentDate||new Date,B.isSelectionMode=!1,B.selectedItems.clear(),Za.innerHTML=`
        ...
        </div>`,document.getElementById("agendaFab").style.display="flex",document.getElementById("btnPrevDate").addEventListener("click",()=>{B.currentView==="list"?B.currentDate.setDate(B.currentDate.getDate()-1):B.currentDate.setDate(B.currentDate.getDate()-7),ce()}),document.getElementById("btnNextDate").addEventListener("click",()=>{B.currentView==="list"?B.currentDate.setDate(B.currentDate.getDate()+1):B.currentDate.setDate(B.currentDate.getDate()+7),ce()}),document.getElementById("btnToday").addEventListener("click",()=>{B.currentDate=new Date,ce()}),document.getElementById("agendaFab").addEventListener("click",()=>{et()});const t=document.querySelectorAll(".agenda-view-toggle button");t.forEach(o=>{o.addEventListener("click",()=>{t.forEach(s=>s.classList.remove("active")),o.classList.add("active"),B.currentView=o.dataset.view,ce()})});const a=document.getElementById("btnWeekDays");a&&a.addEventListener("click",()=>{si()}),Ka||(Za.addEventListener("click",async o=>{const s=o.target.closest('.we-btn[data-action="open-comanda"], .lc-action-btn[data-action="open-comanda"]');if(s){o.stopPropagation();const u=s.closest(".list-card")||s.closest(".week-event-chip"),p=u&&u.dataset.appointment?JSON.parse(u.dataset.appointment.replace(/&apos;/g,"'")):null;if(!p)return;const f=p.status==="completed"?"finalizadas":"em-atendimento",b={selectedAppointmentId:p.id,initialFilter:f};f==="finalizadas"&&p.transaction?.paidAt&&(b.filterDate=typeof p.transaction.paidAt=="object"?new Date(p.transaction.paidAt._seconds*1e3):p.transaction.paidAt),Y("comandas-section",b);return}if(o.target.closest(".lc-action-btn.wa")){o.stopPropagation();return}if(o.target.dataset?.action==="toggle-select-item"){o.target.checked?B.selectedItems.add(o.target.dataset.id):B.selectedItems.delete(o.target.dataset.id),Ba();return}if(o.target.closest('[data-action="batch-delete"]')){const u=B.selectedItems.size;await U("Excluir em Lote",`Excluir ${u} agendamento(s)?`)&&(await Promise.all(Array.from(B.selectedItems).map(async f=>{try{await _a(f)}catch{}})),g(`${u} excluído(s).`,"success"),B.selectedItems.clear(),B.isSelectionMode=!1,ce());return}const i=o.target.closest('[data-action="select-professional"]');if(i){const u=i.dataset.profId;B.selectedProfessionalId=B.selectedProfessionalId===u&&u!=="all"?"all":u,ce();return}const n=o.target.closest(".week-event-chip[data-appointment]");if(n){const u=JSON.parse(n.dataset.appointment.replace(/&apos;/g,"'"));et(u);return}const l=o.target.closest(".list-card[data-appointment]");if(l){if(B.isSelectionMode)return;const u=JSON.parse(l.dataset.appointment.replace(/&apos;/g,"'"));et(u);return}const d=o.target.closest("[data-action]");if(!d)return;switch(d.dataset.action){case"new-appointment":et();break;case"delete-appointment":{o.stopPropagation();const u=d.dataset.id;await U("Confirmar","Apagar este agendamento?")&&(await _a(u),g("Agendamento apagado.","success"),ce());break}case"open-comanda":{o.stopPropagation();let u=null;const p=o.target.closest("[data-appointment]");if(p&&(u=JSON.parse(p.dataset.appointment.replace(/&apos;/g,"'"))),B.isSelectionMode||!u)return;const f=u.status==="completed"?"finalizadas":"em-atendimento",b={selectedAppointmentId:u.id,initialFilter:f};f==="finalizadas"&&u.transaction?.paidAt&&(b.filterDate=typeof u.transaction.paidAt=="object"?new Date(u.transaction.paidAt._seconds*1e3):u.transaction.paidAt),Y("comandas-section",b);break}}}),Ka=!0),await oi(),await ce()}function si(){const e=document.getElementById("optionsSheet");if(e){e.remove();return}const t=document.createElement("div");t.id="optionsSheet",t.style.cssText="position:fixed;bottom:0;left:50%;right:auto;transform:translateX(-50%) translateY(100%);width:100%;max-width:440px;background:#fff;border-radius:16px 16px 0 0;z-index:10000;box-shadow:0 -8px 30px rgba(0,0,0,0.12);transition:transform 0.3s ease;max-height:60vh;overflow-y:auto;",t.innerHTML=`
        ...
        <div class="p-5 space-y-5">
            ...
            <div id="apptServicesContainer" class="grid grid-cols-2 gap-3 max-h-56 overflow-y-auto">
                ${Qt.map(e=>`<div class="service-card p-3 bg-white rounded-xl border ${P.data.selectedServiceIds.includes(e.id)?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer" data-service-id="${e.id}">
        ...
        <div class="p-5 space-y-5">
            ...
            <div id="apptProfessionalContainer" class="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-52 overflow-y-auto professional-step-cards">
                ${fa.map(e=>`<div class="professional-modal-card p-3 bg-white rounded-xl border ${P.data.professionalId===e.id?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer text-center" data-professional-id="${e.id}">
        ...
        </div>`}}async function et(e=null,t=!1){const a=document.getElementById("appointmentModal");t||(P={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(s=>s.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],time:e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}),Qt=m.services||[],fa=(m.professionals||[]).filter(s=>s.status==="active");let o;switch(P.step){case 1:o=ri(e);break;case 2:o=ii();break;case 3:o=ni();break;case 4:o=li();break}a.innerHTML=`
    ...
    `,Zt()}function Zt(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),Pi()}function Pi(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
        ...
        `:e.innerHTML=`
            ...
            <button data-action="view-sales-report" class="py-2 px-4 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 text-sm transition">Relatório</button>
        `)}function pt(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!y.isCashierOpen&&y.activeFilter==="atendimento"){e.innerHTML=`
        ...
        `,r.appendChild(S)}),e.innerHTML="",e.appendChild(r),so(t)}function so(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:o}=y.paging,s=Math.ceil((a||0)/o);if(s===0)return;const r=document.createElement("div");r.className="flex gap-2 justify-center items-center w-full",r.innerHTML=`
    ...
    `,e.appendChild(r),r.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=s&&(y.paging.page=l,me())}})}function J(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(v=>v.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){Bi(t,e);return}const a=`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const o=$e(t),s=t.status==="completed",r=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),i=o.reduce((v,x)=>{const S=x._source==="original_service",k=x.id||x.name,E=S?`original-${k}`:`${x.type}-${k}`;return v[E]||(v[E]={...x,quantity:0,sources:[]}),v[E].quantity+=1,x._source&&v[E].sources.push(x._source),v},{}),n=Object.values(i).reduce((v,x)=>v+Number(x.price||0)*x.quantity,0),l=h(t.clientName||"Cliente sem nome"),d=h(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,f=`
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(i).map(v=>{const x=v.sources&&v.sources.includes("original_service"),S=y.pendingRedemption&&String(y.pendingRedemption.appliedToItemId)===String(v.id),k=v.isReward||S;return`
    ...
    `,{modalElement:o,close:s}=se({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});o.addEventListener("click",r=>{const i=r.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=e.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(qi(l,t),s())}})}async function qi(e,t){const a=Number(e.costPoints||e.points||0),o=e.name||e.reward,s=e.type||"money";if(s==="money"){const l=parseFloat(e.discount)||0;if(l<=0){g("Erro","O valor do desconto configurado é inválido.","error");return}y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,y.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:"money"},g("Sucesso",`Prémio "${o}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),J();return}const r=$e(t),i=e.itemId?String(e.itemId):null;if(!i){g("Erro de Configuração",`O prémio "${o}" não tem um item vinculado nas configurações.`,"error");return}const n=r.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return s==="service"?d===i||c===i:s==="product"?d===i||u===i:s==="package"?d===i:!1});if(n){let l=parseFloat(e.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,y.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:s,appliedToItemId:n.id},g("Sucesso",`Prémio "${o}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),J()}else g("Item Não Encontrado",`Para resgatar o prémio "${o}", o ${s==="service"?"serviço":s==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function Ri(){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=se({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const s=e.querySelector("#add-item-content");s.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{r>1&&(r--,n())},document.getElementById("quantity-plus-btn").onclick=()=>{r++,n()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await os(s,r),t()}};e.addEventListener("click",s=>{const r=s.target.closest('[data-action="select-item-for-quantity"]'),i=s.target.closest('[data-action="back-to-catalog"]');if(r){const{itemType:n,itemId:l}=r.dataset,c=(y.catalog[n+"s"]||[]).find(u=>u.id===l);c&&o({...c,type:n})}else i&&a()}),a()}async function va(e=null){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await re(m.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const a=`
        <form id="new-sale-form" class="space-y-4">
            ...
            <div>
                ...
                <select id="new-sale-professional" required class="mt-1 w-full p-2 border rounded-md bg-white"><option value="">Selecione...</option>${m.professionals.map(l=>`<option value="${l.id}">${h(l.name)}</option>`).join("")}</select>
            </div>
    ...
    `,{modalElement:t}=se({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const o=parseFloat(document.getElementById("initial-amount").value);if(isNaN(o)||o<0)return g("Valor Inválido","Insira um valor válido.","error");try{const s=await ki({establishmentId:m.establishmentId,initialAmount:parseFloat(o.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=s.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${o.toFixed(2)})`,"success"),Zt(),await me()}catch(s){g("Erro",`Falha ao abrir caixa: ${s.message}`,"error")}})}async function Hi(){const e=y.activeCashierSessionId;if(e)try{const t=await Ei(e),a=`
        ...
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await sn();const[e,t,a]=await Promise.all([re(m.establishmentId),Nr(m.establishmentId).catch(()=>[]),Kt(m.establishmentId).catch(()=>[])]);D.professionalsList=e||[],D.costCentersList=t||[],D.naturesList=a||[],nn(),await ms()}catch(e){console.error("Erro no loadReportsPage:",e),ha.innerHTML=`
            ...
            </div>`}}function nn(){const e=D.professionalsList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join(""),t=D.costCentersList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join("");ha.innerHTML=`
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex-1 min-w-0 mr-2">
                            ...
                            <p class="text-[10px] md:text-xs text-gray-500 mt-0.5 ml-1 truncate" id="date-range-display">
                                ${qt(D.startDate)} até ${qt(D.endDate)}
                            </p>
                        </div>
    ...
    `,fn("chart-cashflow-modern",D.processedCashFlow),lo("chart-daily-revenue","Receita Diária",a.labels.map(r=>r.split("-").reverse().slice(0,2).join("/")),a.data),lo("chart-monthly","Receita Mensal",o.labels,o.data),hn("chart-profs","doughnut","Total Vendas",s.labels,s.data,on),document.querySelectorAll(".chart-toggle").forEach(r=>{r.addEventListener("change",i=>{const n=ee["chart-cashflow-modern"];if(n){const l=parseInt(i.target.dataset.dataset);n.setDatasetVisibility(l,i.target.checked),n.update()}})})}function gn(e){const t=D.appointmentsData,a=t.length;let o=0,s=0,r=0;const i={},n={};let l=new Date(D.startDate);const d=new Date(D.endDate);for(;l<=d;)i[l.toISOString().split("T")[0]]={active:0,cancelled:0},l.setDate(l.getDate()+1);t.forEach(b=>{const v=parseFloat(b.totalAmount||b.price||0),x=(b.status||"").toLowerCase();let S="";if(b.startTime){const E=b.startTime.toDate?b.startTime.toDate():new Date(b.startTime);isNaN(E)||(S=E.toISOString().split("T")[0])}const k=b.professionalName||"Sem Profissional";n[k]||(n[k]={name:k,count:0,value:0}),["cancelled","cancelado","no-show","cancelada"].includes(x)?(s++,S&&i[S]&&i[S].cancelled++):(["completed","finalized","paid"].includes(x)&&o++,r+=v,S&&i[S]&&i[S].active++,n[k].count++,n[k].value+=v)});const c=Object.keys(i).sort(),u=c.map(b=>i[b].active),p=c.map(b=>i[b].cancelled),f=Object.values(n).sort((b,v)=>v.value-b.value);e.innerHTML=`
            ...
            <div class="overflow-x-auto no-scrollbar w-full">
                <table class="w-full text-xs md:text-sm min-w-full">
                    <tbody class="divide-y divide-gray-100">
                        ${f.map((b,v)=>{const x=f[0]?.value||1,S=b.value/x*100;return`
                            <tr class="group">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",yn),t.addEventListener("click",o=>{const s=o.target.closest('button[data-action="delete-category"]');s&&(o.preventDefault(),wn(s.dataset.id))}))}qa()}function Sn(e=[]){if(!st||st.length===0)return`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),Ra(),rt()}function In(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function vt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,o,s,r]=await Promise.all([Ie(m.establishmentId),re(m.establishmentId),ea(m.establishmentId,"services"),Ur(m.establishmentId),We()]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(o||[]).filter(Boolean),m.mostPopularService=s||{name:"N/A",count:0},st=r?.matrizes||[],m.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),fs(ot)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function fs(e){if(document.getElementById("services-content-container")){if(ot===e&&document.getElementById("services-content-container").children.length>1){ot==="services"&&(Ra(),rt());return}ot=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?En():e==="reports"&&In()}}function Ln(){be&&(he.removeEventListener("click",be),he.removeEventListener("input",be),he.removeEventListener("change",be)),be=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const s=t.closest('[data-action="toggle-service-status"]'),r=s.dataset.id,i=s.checked;try{await Vr(r,i);const n=m.services.findIndex(l=>l.id===r);n>-1&&(m.services[n].active=i),de(m.establishmentId,Ue(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${i?"Ativo":"Inativo"}`),rt(),Ra()}catch(n){g("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),s.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){rt();return}if(!a)return;if(a.hasAttribute("data-view")){fs(a.dataset.view);return}switch(a.dataset.action){case"new-service":co();break;case"edit-service":const s=JSON.parse(a.dataset.service);co(s);break;case"manage-categories":kn();break;case"filter-service":const r=a.dataset.filterType;if(r==="popular")return;we=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,d=n===we||n==="total"&&we==="all";i.classList.toggle("ring-2",d),i.classList.toggle("ring-indigo-500",d),i.classList.toggle("shadow-md",d),i.classList.toggle("bg-white",!d)}),rt();break}},he.addEventListener("click",be),he.addEventListener("input",be),he.addEventListener("change",be)}async function Cn(){he.innerHTML=`
        ...
        </div>`,Ln(),ot="services",we="all",await vt()}const ta="suppliers",Na=async e=>{try{const t=jo(Wt(pe,ta),Fo("establishmentId","==",e)),a=await Js(t),o=[];return a.forEach(s=>{o.push({id:s.id,...s.data()})}),o}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Tn=async e=>{try{return{id:(await No(Wt(pe,ta),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},Dn=async(e,t)=>{try{const a=ft(pe,ta,e);return await Ia(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Pn=async e=>{try{const t=ft(pe,ta,e);return await Gs(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},ve=document.getElementById("content");let fe=null,it="products",ue="all";async function Bn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await gs({establishmentId:m.establishmentId,name:o},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await ja(),await ht()}catch(s){g("Erro",`Não foi possível criar a categoria: ${s.message}`,"error")}}async function Mn(e){if(await U("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await bs(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await ja(),await ht()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function ja(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ea(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${h(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                `).join("")):(M.classList.remove("hidden"),M.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else M.classList.add("hidden");r.size>0?(q.innerHTML="",r.forEach(O=>{const R=o.find(_=>_.id===O);R&&(q.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border p-2 rounded shadow-sm" data-id="${R.id}">
                            <div class="text-sm">
                                <p class="font-bold text-gray-800">${h(R.name)}</p>
                                <p class="text-xs text-gray-500">${h(R.contactName||"")} - ${h(R.phone||"")}</p>
                            </div>
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),Fa(),gt()}function jn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const o=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const s=document.getElementById("productFilterReport"),r=document.getElementById("categoryFilterReport");s&&m.products&&(s.innerHTML+=m.products.map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join("")),r&&m.categories&&(r.innerHTML+=m.categories.map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join(""))}async function Fn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await yi(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                <img src="${l}" alt="Imagem de ${h(r.name)}" class="w-16 h-16 rounded-md object-cover flex-shrink-0 sm:w-full sm:h-24 sm:rounded-b-none">
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ht(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,o]=await Promise.all([Xt(m.establishmentId),ea(m.establishmentId,"products"),Na(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(o||[]).filter(Boolean),vs(it)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function vs(e){if(document.getElementById("products-content-container")){if(it===e&&document.getElementById("products-content-container").children.length>1){it==="products"&&(Fa(),gt());return}it=e,ue="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Nn():e==="movements"&&jn()}}async function Hn(){ve.innerHTML=`
        ...
        </section>`,fe&&(ve.removeEventListener("click",fe),ve.removeEventListener("input",fe),ve.removeEventListener("change",fe)),fe=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){gt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){vs(a.dataset.view);return}switch(a.dataset.action){case"new-product":mo();break;case"edit-product":mo(JSON.parse(a.dataset.product));break;case"manage-product-categories":An();break;case"generate-report":await Fn();break;case"filter-stock":const s=a.dataset.filterType;ue=ue===s?"all":s,document.querySelectorAll(".indicator-card").forEach(r=>{r.classList.toggle("ring-2",r.dataset.filterType===ue),r.classList.toggle("ring-indigo-500",r.dataset.filterType===ue),r.classList.toggle("shadow-lg",r.dataset.filterType===ue)}),gt();break}},ve.addEventListener("click",fe),ve.addEventListener("input",fe),ve.addEventListener("change",fe),it="products",ue="all",await ht()}const Dt=document.getElementById("content");let j={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},wt=null;const Rt={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},hs=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function On(){try{const t=(await We()).matrizes||[];j.establishments=[],t.forEach(a=>{j.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(o=>j.establishments.push({id:o.id,name:o.name,type:"Filial"}))})}catch(e){console.warn("Erro ao buscar lojas",e)}j.viewMode="list",j.editingItem=null,j.hasSearched=!1,j.partners=[],zn(),Gn(),xs()}function zn(){Dt.innerHTML=`
    ...
    `}function Vn(){const e=Object.entries(Rt).map(([a,o])=>`<option value="${a}">${o.label}</option>`).join(""),t=hs.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Wn))}function xs(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
        ...
        <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
    `,o='<div class="flex flex-col gap-4 md:hidden">';t.forEach(s=>{let r=s.category;r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const i=Rt[r]||Rt.outros,n=s.document||s.taxId?s.document||s.taxId:"-",l=JSON.stringify(s).replace(/'/g,"&apos;"),d=[s.city,s.state].filter(Boolean).join(" - ");a+=`
        ...
        </div>`;t.innerHTML=i,t.style.display="flex",Kn(a,s),el(a),tl(a,r),ol(a)}function Zn(e=[]){if(!Pt||Pt.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Profissional exclusivo desta unidade.
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return Pt.forEach(a=>{const o=e.includes(a.id)||e.length===0&&a.id===m.establishmentId;t+=`
            <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-white rounded px-2 transition-colors">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${o?"checked":""}>
                <span class="text-sm font-bold text-gray-800">🏢 ${h(a.name)} (Matriz)</span>
            </label>
        `,a.branches&&a.branches.length>0&&a.branches.forEach(s=>{const r=e.includes(s.id)||e.length===0&&s.id===m.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function Kn(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],s=Array.from({length:12},(x,S)=>{const k=S+1,E=k==o[1]?"selected":"",T=new Date(0,S).toLocaleString("pt-BR",{month:"long"});return`<option value="${k}" ${E}>${T.charAt(0).toUpperCase()+T.slice(1)}</option>`}).join(""),r=e.status||"active",i=h(e.name||""),n=h(e.specialty||""),l=h(e.phone||""),d=h(e.notes||"");a.innerHTML=`
            ...
            <div id="profServicesContainer" class="grid grid-cols-2 md:grid-cols-3 gap-3 p-4 border border-gray-200 rounded-xl bg-gray-50 max-h-64 overflow-y-auto">
                ${t.map(x=>`
                    <label class="flex items-center space-x-3 p-2 hover:bg-white rounded-lg cursor-pointer transition-colors border border-transparent hover:border-gray-200 hover:shadow-sm">
                        ...
                        <span class="text-sm font-medium text-gray-700">${h(x.name)}</span>
                    </label>
                `).join("")}
            </div>
        </div>
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=bl)}function bt(){if(w.modalOpen)return;Ha();const e=document.getElementById("clients-content-area"),t=w.filters.inactiveDays||w.filters.birthMonth||w.filters.hasLoyalty||w.filters.hasDebt,a=`
    ...
    `;const a=t.querySelector("#establishmentTimezone");e.timezone&&(a.value=e.timezone);const o=t.querySelector("#establishmentWorkingHoursContainer"),s=e.workingHours||{};Object.keys(na).forEach(r=>{const i=s[r]||{},n=na[r],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,o.appendChild(d)}),o.addEventListener("change",r=>{const i=r.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),t.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const i={};Object.keys(na).forEach(l=>{i[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const n=t.querySelector("#establishmentTimezone").value;Je({workingHours:i,timezone:n},r)})}function $s(e,t){const a=!!e.whatsappInstance;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `}function Es(e="indigo",t){const a=t.querySelector("#color-palette-container"),o=t.querySelector("#establishmentThemeColor");!a||!o||(a.innerHTML="",Object.entries(xl).forEach(([s,r])=>{const i=s===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
    ...
    `;try{W=e.id||m.establishmentId,V=await Se(W);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
            ...
            <div class="max-w-5xl mx-auto w-full pb-20">
                ...
                <div class="bg-gradient-to-r from-indigo-900 to-indigo-700 rounded-xl shadow-lg p-6 mb-8 text-white flex justify-between items-center relative overflow-hidden">
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-1">${h(V.name)} ${a}</h3>
                        <p class="text-indigo-200 text-sm flex items-center gap-2"><i class="bi bi-geo-alt"></i> ${h(V.address||"Morada não definida")}</p>
                    </div>
        ...
        `,ye.querySelectorAll("div[data-section]").forEach(s=>{s.addEventListener("click",r=>{Pl(s.dataset.section)})}),ye.querySelectorAll(".module-toggle").forEach(s=>{s.addEventListener("change",async()=>{const r=s.dataset.module;try{const n={...(await Se(W)).modules,[r]:s.checked};await La(W,{modules:n}),g("Módulos","Módulos atualizados com sucesso.","success")}catch(i){s.checked=!s.checked,g("Erro",i.message,"error")}})})}catch(t){ye.innerHTML=`
        ...
        `}}function Bl(e){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `}).join("")}function wa(){const t=document.getElementById("showInactiveUsersToggle")?.checked?m.users:m.users.filter(a=>a.status==="active");Wl(t)}function Jl(e={}){return Object.entries(Vl).map(([t,a])=>{const o=t==="agenda-section"||t==="comandas-section",s=e[t]?.view_all_prof===!0,r=Object.entries(Ul).map(([n,l])=>`
    ...
    `;const n=i.querySelector("#userRole"),l=i.querySelector("#hierarchySelectorContainer");if(n&&l){n.addEventListener("change",c=>{const u={...e,role:c.target.value};l.innerHTML=fo(u),d()});const d=()=>{l.querySelectorAll(".company-checkbox").forEach(c=>{c.addEventListener("change",u=>{u.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(b=>b.checked=u.target.checked)})})};d()}if(i.addEventListener("submit",async d=>{d.preventDefault();const c={};i.querySelectorAll("input[data-module]").forEach(x=>{const S=x.dataset.module,k=x.dataset.permission;c[S]||(c[S]={}),c[S][k]=x.checked});const u=i.querySelector("#userProfessionalId").value||null,p=i.querySelector("#userRole")?.value||"professional",f=[],b=[];if(p!=="group_admin"&&i.querySelector(".company-checkbox")&&(i.querySelectorAll(".company-checkbox:checked").forEach(x=>{f.push({id:x.value,name:x.dataset.name})}),i.querySelectorAll(".branch-checkbox:checked").forEach(x=>{b.push({id:x.value,name:x.dataset.name,companyId:x.dataset.companyId})}),b.length===0))return g("Atenção","Você deve selecionar pelo menos uma filial para este usuário.","error");const v={name:i.querySelector("#userName").value,permissions:c,professionalId:u,role:p,accessibleCompanies:f,accessibleEstablishments:b};try{if(r){const x=i.querySelector("#userEmail").value;e?.email!==x&&(v.email=x),await Fl(e.id,v),g("Usuário atualizado com sucesso!","success")}else v.email=i.querySelector("#userEmail").value,v.password=i.querySelector("#userPassword").value,await jl(v),g("Usuário criado com sucesso!","success");jt()}catch(x){g(`Erro: ${x.message}`,"error")}}),r){const d=i.querySelector('[data-action="show-password-form"]'),c=i.querySelector("#password-form");d&&c&&(d.addEventListener("click",()=>{d.classList.add("hidden"),c.classList.remove("hidden")}),c.querySelector('[data-action="cancel-password-change"]').addEventListener("click",()=>{d.classList.remove("hidden"),c.classList.add("hidden"),c.querySelector("#userNewPassword").value=""}),c.querySelector('[data-action="save-password"]').addEventListener("click",async u=>{const p=u.target,f=c.querySelector("#userNewPassword").value;if(!f||f.length<6)return g("Aviso","Senha deve ter no mínimo 6 caracteres.","error");if(await U("Alterar Senha","Tem certeza?"))try{p.disabled=!0,p.textContent="...",await Ol(e.id,f),g("Sucesso","Senha alterada.","success"),d.classList.remove("hidden"),c.classList.add("hidden")}catch(b){g("Erro",b.message,"error")}finally{p.disabled=!1,p.textContent="Salvar Senha"}}))}}async function Gl(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([Nl(m.currentViewContext.id),re(m.currentViewContext.id)]);m.users=t,m.professionals=a,wa()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Falha ao carregar.</p>'}}async function jt(){Xe.innerHTML=`
        <style>
    ...
    `,St&&Xe.removeEventListener("click",St),$t&&Xe.removeEventListener("change",$t),St=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":vo();break;case"edit-user":const o=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));vo(o);break;case"back-to-list":jt();break;case"delete-user":{if(e.stopPropagation(),await U("Excluir Usuário","Tem certeza? Ação irreversível."))try{await Hl(t.dataset.userId),g("Usuário excluído!","success"),jt()}catch(s){g(`Erro: ${s.message}`,"error")}break}}},$t=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")wa();else if(t){e.stopPropagation();const a=t.dataset.userId,o=t.checked?"active":"inactive";try{await zl(a,o);const s=m.users.findIndex(r=>r.id===a);s>-1&&(m.users[s].status=o,wa())}catch(s){g(`Erro: ${s.message}`,"error"),t.checked=!t.checked}}},Xe.addEventListener("click",St),Xe.addEventListener("change",$t),await Gl()}const Yl=document.getElementById("content");let ho={},ka=null;function Ql(){Object.values(ho).forEach(e=>e?.destroy()),ho={}}function Xl(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,o=new a({orientation:"landscape",unit:"px",format:"a4"}),s=document.getElementById("salesReportSummaryCards");if(o.setFontSize(18),o.text(e,o.internal.pageSize.getWidth()/2,40,{align:"center"}),s){const i=[["Receita Total",s.querySelector("#summary-revenue").textContent],["Vendas Totais",s.querySelector("#summary-transactions").textContent],["Ticket Médio",s.querySelector("#summary-avg-ticket").textContent]];o.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=o.lastAutoTable?o.lastAutoTable.finalY+20:60;o.text("Detalhes das Vendas",20,r),o.autoTable({html:`#${t}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),o.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function xo(e){const t=document.getElementById("genericModal"),a=h(e.client),o=h(e.items),s=h(e.responsavelCaixa||"N/A"),r=(e.payments||[]).map(i=>`
    ...
    `}).join(""),r.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=ka.transactions[l];d&&xo(d)})}),i.innerHTML=a.map((n,l)=>{const d=h(n.client),c=h(n.items),u=h(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ka.transactions[l];d&&xo(d)})})}async function yo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,s=a.value;if(!o||!s)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,i=await jr({establishmentId:m.establishmentId,startDate:o,endDate:s,cashierSessionId:r});ka=i,e.innerHTML=`
        ...
        `,Zl(i)}catch(r){g("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${h(r.message)}</p>`}}async function Kl(){Ql();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];Yl.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",yo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const o=document.getElementById("reportStartDate").value,s=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${o}_a_${s}`;Xl(r,"transactionsTable")});try{const o=await $i(m.establishmentId),s=document.getElementById("cashierSessionFilter");o&&o.length>0&&o.forEach(r=>{const i=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=h(r.closedByName||"N/A");s.innerHTML+=`<option value="${r.id}">${n} - ${i}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await yo()}const ed=document.getElementById("content");let $={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1},Et=null,It=null;function Oa(e){const t=new Map,a=[];return e&&(e.forEach(o=>t.set(o.id,{...o,children:[]})),t.forEach(o=>{o.parentId&&t.has(o.parentId)?t.get(o.parentId).children.push(o):a.push(o)})),a}function Ls(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,o]=e.split("-"),s=new Date(t,a-1,o),r=String(s.getDate()).padStart(2,"0"),i=s.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:r,month:i,full:s.toLocaleDateString("pt-BR")}}function ne(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function Ft(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[o,s,r]=e.split("-");return new Date(o,s-1,r)<a}function td(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const o=(s,r=0)=>`
        ...
        `;e.innerHTML=t.map(s=>o(s)).join("")}async function Sa(e){const t=document.getElementById("genericModal"),a=e==="nature",o=a?"Plano de Contas (Naturezas)":"Centros de Custo",s=a?Kt:Aa,r=a?_i:Ji,i=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const p=Oa(u);td(n,p,e);const f=l.value;l.innerHTML='<option value="">-- Nível Principal --</option>';const b=(v,x=0)=>{const S="  ".repeat(x)+(x>0?"↳ ":"");l.innerHTML+=`<option value="${v.id}">${S}${v.name}</option>`,v.children.forEach(k=>b(k,x+1))};p.forEach(v=>b(v)),l.value=f};try{const u=await s(m.establishmentId);$[i]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const p=t.querySelector("#itemName").value,f=l.value;try{await r({name:p,parentId:f||null,establishmentId:m.establishmentId});const b=await s(m.establishmentId);$[i]=b,d(b),c.reset(),await Ee(),g("Sucesso","Item adicionado ao plano de contas.","success")}catch(b){g("Erro",b.message,"error")}})}async function ad(){try{const t=(await We()).matrizes||[];$.establishments=[],t.forEach(a=>{$.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(o=>$.establishments.push({id:o.id,name:o.name,type:"Filial"}))}),$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(m.establishmentId)}catch(e){console.warn("Erro ao buscar lojas",e)}Cs(),Ts(),await Ee()}function Cs(){const e=$.establishments.map(t=>`
    ...
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-100","text-indigo-700"),Ds()}function Ts(){const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const s=o.target.checked,r=document.querySelectorAll(".item-checkbox");$.selectedIds.clear(),r.forEach(i=>{i.checked=s,s&&$.selectedIds.add(i.dataset.id)}),qe()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{$.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),qe()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=$.selectedIds.size;if(o===0)return;if(await U("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const r=$.currentTab==="payables"?"payables":"receivables";await ls(r,Array.from($.selectedIds)),g("Sucesso",`${o} itens excluídos.`,"success"),$.selectedIds.clear(),qe(),Ee()}catch{g("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",s=>{const r=s.target.closest("label");s.target.checked?($.filterEstablishmentIds.add(s.target.value),r.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.remove("border-gray-200","text-gray-600")):($.filterEstablishmentIds.delete(s.target.value),r.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.add("border-gray-200","text-gray-600"))})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),s=document.getElementById("toggle-filter-btn");$.isAdvancedFilterOpen=!$.isAdvancedFilterOpen,$.isAdvancedFilterOpen?(o.classList.remove("hidden"),s.classList.add("bg-indigo-50","text-indigo-700","border-indigo-300")):(o.classList.add("hidden"),s.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-300"))}),document.getElementById("settings-btn").addEventListener("click",nd),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",s=>{la(s.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const o=$.currentTab==="payables"?"payable":"receivable";la(o)});const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t.addEventListener("click",()=>wo("receivables")),a.addEventListener("click",()=>wo("payables")),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",s=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-gray-800","text-white","shadow-sm"),r.classList.add("bg-gray-100","text-gray-600")}),s.target.classList.add("bg-gray-800","text-white","shadow-sm"),s.target.classList.remove("bg-gray-100","text-gray-600","hover:bg-gray-200","hover:bg-red-100"),$.statusFilter=s.target.dataset.status,Ht(),Ps()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",s=>{document.querySelectorAll(".date-preset-btn").forEach(d=>d.classList.remove("bg-indigo-100","text-indigo-700")),s.target.classList.add("bg-indigo-100","text-indigo-700");const r=s.target.dataset.preset,i=new Date;let n,l;r==="month"?(n=new Date(i.getFullYear(),i.getMonth(),1),l=new Date(i.getFullYear(),i.getMonth()+1,0)):r==="last_month"?(n=new Date(i.getFullYear(),i.getMonth()-1,1),l=new Date(i.getFullYear(),i.getMonth(),0)):r==="year"&&(n=new Date(i.getFullYear(),0,1),l=new Date(i.getFullYear(),11,31)),document.getElementById("filterStartDate").value=n.toISOString().split("T")[0],document.getElementById("filterEndDate").value=l.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",o=>{$.searchQuery=o.target.value.toLowerCase(),Ht()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",$.filterEstablishmentIds.clear(),$.filterEstablishmentIds.add(m.establishmentId),Cs(),Ts()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{$.startDate=document.getElementById("filterStartDate").value,$.endDate=document.getElementById("filterEndDate").value,$.filterNaturezaId=document.getElementById("filterNaturezaId").value,$.filterCostCenterId=document.getElementById("filterCostCenterId").value,$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(m.establishmentId),document.getElementById("toggle-filter-btn").click(),Ee()}),Et&&document.body.removeEventListener("click",Et),Et=o=>{const s=o.target;if(s.classList.contains("item-checkbox")||s.classList.contains("modal-item-checkbox")){const n=s.value||s.dataset.id;s.checked?$.selectedIds.add(n):$.selectedIds.delete(n),qe(),o.stopPropagation();return}const r=s.closest("button[data-action]");if(r){const{action:n,type:l,id:d}=r.dataset;if(o.stopPropagation(),n==="delete"){const c=r.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");sd(l,JSON.parse(c));return}if(n==="mark-as-paid"){od(l,d);return}if(n==="manage-natures"){Sa("nature");return}if(n==="manage-cost-centers"){Sa("cost-center");return}}const i=s.closest(".financial-row");if(i&&document.getElementById("list-container").contains(i)&&!s.closest("button")&&!s.closest(".item-checkbox")){const{type:n}=i.dataset,l=JSON.parse(i.dataset.item.replace(/&apos;/g,"'"));la(n,l)}},document.body.addEventListener("click",Et),It&&document.getElementById("genericModal").removeEventListener("click",It),It=o=>{if(o.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const r=o.target.closest('button[data-action^="delete-"]');if(r){const i=r.dataset.action.split("-")[1];id(i,r.dataset.id)}},document.getElementById("genericModal").addEventListener("click",It)}function qe(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),o=$.selectedIds.size;t.textContent=o,o>0?(e.classList.remove("hidden"),e.classList.add("flex"),a&&a.classList.add("hidden")):(e.classList.add("hidden"),e.classList.remove("flex"),a&&a.classList.remove("hidden"))}function wo(e){$.currentTab=e,$.selectedIds.clear(),qe(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),o=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-emerald-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),o&&(o.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-emerald-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-emerald-700","shadow-sm"),t.classList.add("text-gray-500"),o&&(o.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")),Ht()}async function Ee(){const e=document.getElementById("list-container");e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A processar transações...</p></div>';try{if($.natures.length===0){const[r,i]=await Promise.all([Kt(m.establishmentId),Aa(m.establishmentId)]);$.natures=r,$.costCenters=i,Ds()}const t=Array.from($.filterEstablishmentIds).join(","),a={startDate:$.startDate,endDate:$.endDate,establishmentId:t};$.filterNaturezaId!=="all"&&(a.natureId=$.filterNaturezaId),$.filterCostCenterId!=="all"&&(a.costCenterId=$.filterCostCenterId);const[o,s]=await Promise.all([cs(a),us(a)]);$.payables=o.entries||[],$.receivables=s.entries||[],Ps(),Ht()}catch(t){e.innerHTML=`
            ...
            </div>`}}function Ds(){const e=o=>{let s='<option value="all">-- Todas as opções --</option>';const r=Oa(o),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");s+=`<option value="${n.id}">${d}${n.name}</option>`,n.children.forEach(c=>i(c,l+1))};return r.forEach(n=>i(n)),s},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e($.natures)),a&&(a.innerHTML=e($.costCenters))}function Ps(){const e=document.getElementById("summary-section");if(!e)return;const t=$.currentTab==="receivables";let o=t?$.receivables:$.payables;$.searchQuery&&(o=o.filter(c=>c.description&&c.description.toLowerCase().includes($.searchQuery)||c.entity&&c.entity.toLowerCase().includes($.searchQuery)||c.notes&&c.notes.toLowerCase().includes($.searchQuery)));const s=o.reduce((c,u)=>c+u.amount,0),r=o.filter(c=>c.status==="paid").reduce((c,u)=>c+u.amount,0),i=o.filter(c=>c.status==="pending"&&!Ft(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),n=o.filter(c=>Ft(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),l=t?"emerald":"red",d=t?"Receitas":"Despesas";e.innerHTML=`
    ...
    `,a.style.display="flex";const r=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");r.addEventListener("change",d=>{i.forEach(c=>c.checked=d.target.checked),l()}),i.forEach(d=>d.addEventListener("change",l));function l(){const d=Array.from(i).filter(c=>c.checked).length;n.innerHTML=d>0?`<i class="bi bi-trash3"></i> Excluir ${d} Parcela(s)`:"Selecione para excluir",n.disabled=d===0,d===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const d=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(d.length===0)return;a.style.display="none",await U("Confirmar Ação",`Tem certeza que deseja apagar estas ${d.length} parcelas permanentemente?`)&&await Bs(e,d)}),l()}async function Bs(e,t){try{t.length===1?e==="payable"?await Xi(t[0]):await tn(t[0]):await ls(e==="payable"?"payables":"receivables",t),g("Sucesso",`${t.length} registo(s) limpo(s) do sistema.`,"success"),$.selectedIds.clear(),qe(),await Ee()}catch(a){g("Erro",a.message,"error")}}async function id(e,t){const o=e==="nature"?Wi:Gi;if(await U("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await o(t),Sa(e==="nature"?"nature":"cost-center")}catch(r){g("Erro",r.message,"error")}}function nd(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function la(e,t=null){const a=document.getElementById("genericModal"),o=e==="payable",s=o?"red":"emerald",r=t?"Editar Lançamento":"Novo Lançamento",i=$.establishments.map(L=>{const A=t?t.establishmentId===L.id:L.id===m.establishmentId;return`<option value="${L.id}" ${A?"selected":""}>${L.type==="Matriz"?"🏢":"📍"} ${L.name}</option>`}).join(""),n=(L,A)=>{let F='<option value="">-- Selecione --</option>';const C=Oa(L),M=(q,H=0)=>{const O="  ".repeat(H)+(H>0?"↳ ":""),R=q.id===A?"selected":"";F+=`<option value="${q.id}" ${R}>${O}${q.name}</option>`,q.children.forEach(_=>M(_,H+1))};return C.forEach(q=>M(q)),F},d=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(L=>`<option value="${L.value}" ${t?.paymentMethod===L.value?"selected":""}>${L.label}</option>`).join("");a.innerHTML=`
        ...
        </div>`,a.style.display="flex";const c=a.querySelector("#financial-form");let u="single",p=2;const f=c.querySelector('[name="amount"]'),b=c.querySelector("#recurrence-options"),v=c.querySelector("#recurrence-summary"),x=c.querySelector("#installments-input"),S=c.querySelector("#status-toggle"),k=c.querySelector("#payment-date-wrapper"),E=c.querySelector('[name="paymentDate"]'),T=()=>{if(u==="single")return;const L=parseFloat(f.value)||0;if(p=parseInt(x.value)||2,L===0){v.innerHTML='<span class="text-xs text-indigo-400 font-medium">Digite o valor total...</span>';return}if(u==="installment"){const A=L/p;v.innerHTML=`
                <div>
    ...
    `}const da=document.getElementById("content");let ke={allPackages:[],catalogForModal:{services:[],products:[]}},Ct=null,Re=null;function Id(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Ld(){const e=document.getElementById("packagesListContainer");if(e){if(ke.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=ke.allPackages.map(t=>{const a=t.status==="active",o=JSON.stringify(t).replace(/'/g,"&apos;"),s=t.price||0,r=t.originalPrice||0,i=r>s?r-s:0,n=r>0?(r-s)/r*100:0,l=h(t.name),d=h(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function So(){const e=document.getElementById("genericModal");e.style.display="none",Re&&e.removeEventListener("click",Re)}async function $o(e=null){const t=document.getElementById("genericModal"),a=!!e,o=e?JSON.parse(JSON.stringify(e.items||[])):[],s=h(e?.name||""),r=h(e?.description||""),i=e?.price||"",n=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(f,b)=>{const v=b.querySelector("#originalPrice"),x=f.reduce((S,k)=>S+k.price*k.quantity,0);v&&(v.textContent=`R$ ${x.toFixed(2)}`)},p=f=>{f.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=f.map((b,v)=>{const x=b.type==="service",S=x?"Serviço":"Produto",k=x?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
    ...
    `,document.body.appendChild(a);const r=a.querySelector("#item-selection-list"),i=a.querySelector("#item-search-input"),n=()=>{a.remove()};s(r),i.addEventListener("input",()=>{t=i.value,s(r)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:p}=d.dataset,b=(ke.catalogForModal[u+"s"]||[]).find(v=>v.id===p);b&&(e({...b,type:u}),n())}else(c||l.target===a)&&n()})}async function Va(){da.innerHTML=`
    ...
    `,await Bd()}async function Bd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await _r(t);Dd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const o=h(a.name);e.innerHTML=`
            ...
            `,Md(a.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>Ut(a.id,r.target.value)),Ut(a.id,"future")}else e.innerHTML=`
        ...
        `}}function Md(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#blockDate").value,s=t.querySelector("#blockStartTime").value,r=t.querySelector("#blockEndTime").value,i=t.querySelector("#blockReason").value;if(!o||!s||!r){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(s>=r){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const n=new Date(`${o}T${s}:00`),l=new Date(`${o}T${r}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Yt({establishmentId:m.establishmentId,professionalId:e,reason:i||"Bloqueado (Meu Perfil)",startTime:n.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;Ut(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),g("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function Ut(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const o=new Date;let s,r;t==="history"?(r=new Date,s=new Date,s.setFullYear(s.getFullYear()-1)):(s=new Date,r=new Date,r.setFullYear(r.getFullYear()+1));let n=(await Gt(m.establishmentId,s.toISOString(),r.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?n=n.filter(l=>l.endTime<o).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=o).sort((l,d)=>l.startTime-d.startTime),n.length>0?(a.innerHTML=n.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,p=h(l.reason||"Sem motivo");return`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const s=(await We()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),s.length===0)t.innerHTML=`
        ...
        `)}function Mt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("kairos_theme",e),ma&&(e==="dark"?ma.innerHTML="☀️":ma.innerHTML="🌙")}function jd(){const e=localStorage.getItem("kairos_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;Mt(e||(t?"dark":"light"))}let ct=null,ut=[];function qs(){if(!Tt||!ua)return;const e=ut.filter(t=>!t.read).length;if(e>0?(Tt.textContent=e,Tt.classList.remove("hidden")):Tt.classList.add("hidden"),ut.length===0){ua.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}ua.innerHTML=ut.map(t=>`
