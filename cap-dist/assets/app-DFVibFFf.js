...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${a}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${a}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${io}. Verifique se o servidor backend está rodando.`):n}}const ja=(e,t,o,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${o}`;return s&&(r+=`&professionalId=${s}`),$(r)},Ws=({establishmentId:e,professionalId:t,serviceIds:o,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${o.join(",")}&date=${s}`;return $(r)},Js=e=>$("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Gs=(e,t)=>$(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),_o=e=>$(`/api/appointments/${e}`,{method:"DELETE"}),Ys=e=>$(`/api/appointments/${e}/reopen`,{method:"POST"}),Qs=(e,t)=>$(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let _;async function Xs(){if(!_)try{_=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Zs(){if(!_){console.warn("AudioContext não inicializado. O som não será tocado.");return}_.state==="suspended"&&_.resume();const e=_.createOscillator(),t=_.createGain();e.connect(t),t.connect(_.destination),e.type="sine",e.frequency.setValueAtTime(800,_.currentTime),t.gain.setValueAtTime(0,_.currentTime),t.gain.linearRampToValueAtTime(.3,_.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,_.currentTime+.2),e.start(_.currentTime),e.stop(_.currentTime+.2)}function g(e,t,o="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&Zs();const a=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};a.className=`toast ${n[o]||n.info}`,a.innerHTML=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(br).map(([a,n])=>`<option value="${a}">${n.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `;const t=document.getElementById("progress-bar"),o=document.getElementById("progress-text");t&&(t.style.width="100%"),o&&(o.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{ce&&ce.remove(),window.location.reload()}}async function xr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const o=document.getElementById("next-step-btn"),s=o.innerHTML;o.disabled=!0,o.innerHTML="Salvando...";const r=new FormData(t),a=Object.fromEntries(r.entries());try{if(e==="company_data")await wt(m.establishmentId,{name:a.name,phone:a.phone,email:a.email,address:a.address,zipCode:a.zipCode});else if(e==="branding"){const n={};a.logoBase64&&(n.logo=a.logoBase64),a.bgBase64&&(n.backgroundImage=a.bgBase64),a.themeColor&&(n.themeColor=a.themeColor),a.primaryColor&&(n.primaryColor=a.primaryColor),Object.keys(n).length>0&&await wt(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(a.slotInterval);await wt(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Oa({establishmentId:m.establishmentId,name:a.name,price:parseFloat(a.price),duration:parseInt(a.duration),active:!0});n&&Lt.push(n)}else if(e==="first_prof"){const n=await Fa({establishmentId:m.establishmentId,name:a.name,specialty:a.role,active:!0,commissionRate:0});if(a.serviceId&&n&&n.id)try{Go?await Go(n.id,[a.serviceId]):Ct&&await Ct(n.id,{services:[a.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await za({establishmentId:m.establishmentId,name:a.name,price:parseFloat(a.salePrice),stock:parseInt(a.stock),active:!0});g("Sucesso","Passo concluído!","success"),K++,So(),$o(K)}catch(n){g("Erro","Erro ao salvar: "+n.message,"error"),o.disabled=!1,o.innerHTML=s}}var Re;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Re||(Re={}));class Xt extends Error{constructor(t,o,s){super(t),this.message=t,this.code=o,this.data=s}}const yr=e=>{var t,o;return e?.androidBridge?"android":!((o=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||o===void 0)&&o.bridge?"ios":"web"},wr=e=>{const t=e.CapacitorCustomPlatform||null,o=e.Capacitor||{},s=o.Plugins=o.Plugins||{},r=()=>t!==null?t.name:yr(e),a=()=>r()!=="web",n=u=>{const p=d.get(u);return!!(p?.platforms.has(r())||i(u))},i=u=>{var p;return(p=o.PluginHeaders)===null||p===void 0?void 0:p.find(f=>f.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,p={})=>{const f=d.get(u);if(f)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),f.proxy;const h=r(),v=i(u);let w;const x=async()=>(!w&&h in p?w=typeof p[h]=="function"?w=await p[h]():w=p[h]:t!==null&&!w&&"web"in p&&(w=typeof p.web=="function"?w=await p.web():w=p.web),w),S=(T,B)=>{var R,j;if(v){const z=v?.methods.find(q=>B===q.name);if(z)return z.rtype==="promise"?q=>o.nativePromise(u,B.toString(),q):(q,Y)=>o.nativeCallback(u,B.toString(),q,Y);if(T)return(R=T[B])===null||R===void 0?void 0:R.bind(T)}else{if(T)return(j=T[B])===null||j===void 0?void 0:j.bind(T);throw new Xt(`"${u}" plugin is not implemented on ${h}`,Re.Unimplemented)}},k=T=>{let B;const R=(...j)=>{const z=x().then(q=>{const Y=S(q,T);if(Y){const Ee=Y(...j);return B=Ee?.remove,Ee}else throw new Xt(`"${u}.${T}()" is not implemented on ${h}`,Re.Unimplemented)});return T==="addListener"&&(z.remove=async()=>B()),z};return R.toString=()=>`${T.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:T,writable:!1,configurable:!1}),R},E=k("addListener"),L=k("removeListener"),N=(T,B)=>{const R=E({eventName:T},B),j=async()=>{const q=await R;L({eventName:T,callbackId:q},B)},z=new Promise(q=>R.then(()=>q({remove:j})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await j()},z},F=new Proxy({},{get(T,B){switch(B){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?N:E;case"removeListener":return L;default:return k(B)}}});return s[u]=F,d.set(u,{name:u,proxy:F,platforms:new Set([...Object.keys(p),...v?[h]:[]])}),F};return o.convertFileSrc||(o.convertFileSrc=u=>u),o.getPlatform=r,o.handleError=l,o.isNativePlatform=a,o.isPluginAvailable=n,o.registerPlugin=c,o.Exception=Xt,o.DEBUG=!!o.DEBUG,o.isLoggingEnabled=!!o.isLoggingEnabled,o},kr=e=>e.Capacitor=wr(e),ae=kr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ot=ae.registerPlugin;class Va{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,o){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(o);const a=this.windowListeners[t];a&&!a.registered&&this.addWindowListener(a),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,o);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,o,s){const r=this.listeners[t];if(!r){if(s){let a=this.retainedEventArguments[t];a||(a=[]),a.push(o),this.retainedEventArguments[t]=a}return}r.forEach(a=>a(o))}hasListeners(t){var o;return!!(!((o=this.listeners[t])===null||o===void 0)&&o.length)}registerWindowListener(t,o){this.windowListeners[o]={registered:!1,windowEventName:t,pluginEventName:o,handler:s=>{this.notifyListeners(o,s)}}}unimplemented(t="not implemented"){return new ae.Exception(t,Re.Unimplemented)}unavailable(t="not available"){return new ae.Exception(t,Re.Unavailable)}async removeListener(t,o){const s=this.listeners[t];if(!s)return;const r=s.indexOf(o);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const o=this.retainedEventArguments[t];o&&(delete this.retainedEventArguments[t],o.forEach(s=>{this.notifyListeners(t,s)}))}}const Xo=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Zo=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Sr extends Va{async getCookies(){const t=document.cookie,o={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,a]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Zo(r).trim(),a=Zo(a).trim(),o[r]=a}),o}async setCookie(t){try{const o=Xo(t.key),s=Xo(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,a=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${o}=${s||""}${r}; path=${a}; ${n};`}catch(o){return Promise.reject(o)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(o){return Promise.reject(o)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const o of t)document.cookie=o.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ot("CapacitorCookies",{web:()=>new Sr});const $r=async e=>new Promise((t,o)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>o(r),s.readAsDataURL(e)}),Er=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,a,n)=>(r[a]=e[t[n]],r),{})},Ir=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[a,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${a}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${a}=${i}`),`${s}&${l}`},"").substr(1):null,Cr=(e,t={})=>{const o=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Er(e.headers)["content-type"]||"";if(typeof e.data=="string")o.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const a=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))a.set(n,i);o.body=a.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const a=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{a.append(l,i)});else for(const i of Object.keys(e.data))a.append(i,e.data[i]);o.body=a;const n=new Headers(o.headers);n.delete("content-type"),o.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(o.body=JSON.stringify(e.data));return o};class Lr extends Va{async request(t){const o=Cr(t,t.webFetchExtra),s=Ir(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,a=await fetch(r,o),n=a.headers.get("content-type")||"";let{responseType:i="text"}=a.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await a.blob(),l=await $r(d);break;case"json":l=await a.json();break;case"document":case"text":default:l=await a.text()}const c={};return a.headers.forEach((u,p)=>{c[p]=u}),{data:l,headers:c,status:a.status,url:a.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ot("CapacitorHttp",{web:()=>new Lr});const J=Ot("PushNotifications",{}),Tr="modulepreload",Pr=function(e){return"/"+e},Ko={},Br=function(t,o,s){let r=Promise.resolve();if(o&&o.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");r=l(o.map(d=>{if(d=Pr(d),d in Ko)return;Ko[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Tr,c||(p.as="script"),p.crossOrigin="",p.href=d,i&&p.setAttribute("nonce",i),document.head.appendChild(p),c)return new Promise((f,h)=>{p.addEventListener("load",f),p.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return r.then(n=>{for(const i of n||[])i.status==="rejected"&&a(i.reason);return t().catch(a)})},ea=Ot("App",{web:()=>Br(()=>import("./web-BsCJ9Z4l.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Dr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let ta=!1;async function Ua(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await J.removeAllListeners(),await J.addListener("registration",async o=>{Ja(o.value,!0)}),await J.addListener("pushNotificationReceived",o=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",o)}),await J.addListener("pushNotificationActionPerformed",o=>{const s=o.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await J.checkPermissions();t.receive==="prompt"&&(t=await J.requestPermissions()),t.receive==="granted"&&await J.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Wa()}async function _a(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Wa(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Wa(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await zs(zo,{vapidKey:Dr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Ja(t,!1)):console.warn("[Push Web] Token veio vazio."),ta||(Vs(zo,o=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",o)}),ta=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Ja(e,t){const o=V.currentUser;if(!o){console.warn("Usuário não logado. Token não salvo.");return}const s=me(U,"users",o.uid);try{const r=await Ma(s);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await wo(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await js(s,{email:o.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(a){console.error("Erro ao criar user:",a)}else console.error("Erro ao atualizar token:",r)}}const Mr=(e,t,o="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return o&&o!=="all"&&r.append("professionalId",o),s&&s!=="all"&&r.append("costCenterId",s),$(`/api/reports/indicators?${r.toString()}`)},Ar=e=>e?$(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Nr=({establishmentId:e,startDate:t,endDate:o,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:o});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),$(`/api/reports/sales?${r.toString()}`)},qr=()=>$("/api/reports/summary",{method:"GET"}),zt=(e,t,o,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${o}&professionalId=${s}`;return $(r)},Vt=e=>$("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Eo=e=>$(`/api/blockages/${e}`,{method:"DELETE"}),Ga=e=>$("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Io=e=>e?String(e).replace(/\D/g,""):"",it=(e,t="",o=20,s={})=>{const r=new URLSearchParams;return t&&r.append("search",t),o&&r.append("limit",o),s.hasLoyalty&&r.append("hasLoyalty","true"),s.birthMonth&&r.append("birthMonth",s.birthMonth),s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),$(`/api/clients/${e}?${r.toString()}`)},lo=(e,t)=>{const o=encodeURIComponent(t);return $(`/api/clients/details/${e}/${o}`)},Rr=e=>{if(!e.phone)throw new Error("Telefone é obrigatório");const t=Io(e.phone),o={...e,phone:t,id:t};return $(`/api/clients/${t}`,{method:"PUT",body:JSON.stringify(o)})},jr=(e,t)=>{const o=Io(t);return $(`/api/clients/full-history/${e}?phone=${o}`)},Ya=e=>{const t=encodeURIComponent(e);return $(`/api/clients/${t}`,{method:"DELETE"})},Fr=(e,t,o,s)=>$("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Io(t),points:o,rewardName:s})});function b(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Qa(e,t=800,o=800,s=.7){return new Promise((r,a)=>{if(!e.type.match(/image.*/))return a(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>o&&(d*=o/c,c=o);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const f=u.toDataURL("image/jpeg",s);r(f)},l.onerror=d=>a(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>a(new Error("Erro ao ler o ficheiro."))})}const oa=document.getElementById("content");let aa=!1;const co=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let lt=[],Ut=[],je={},Ae=[],C={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},I={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Hr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Xa(e){const t=new Date(e);if(t.setHours(0,0,0,0),C.currentView==="week"&&C.weekViewDays===7){const o=t.getDay(),s=t.getDate()-o+(o===0?-6:1);return new Date(t.setDate(s))}return t}function Tt(){const e=document.getElementById("profSelectorContainer"),t=C.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let o=m.professionals.filter(a=>C.showInactiveProfs||a.status!=="inactive");t&&(o=o.filter(a=>a.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...o];e.innerHTML=r.map(a=>{const n=C.selectedProfessionalId===a.id,i=a.name==="Todos"?"Todos":a.name.split(" ")[0],l=a.name==="Todos"?"T":a.name.charAt(0).toUpperCase(),d=a.status!=="inactive",c=b(i),u=co[0],p=a.id!=="all"&&m.professionalColors.get(a.id)||u,f=a.photo||`https://placehold.co/64x64/${p.main?.replace("#","")||"E0E7FF"}/${p.light?.replace("#","")||"4F46E5"}?text=${l}`,h=a.id==="all"?"#e0e7ff":p.light,v=a.id==="all"?"#4f46e5":p.main,x=`border: 3px solid ${n?p.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+p.border:"none"};`;return`
        ...
        `}).join("")}function Or(e,t,o,s,r){const a=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${o} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${a}?text=${d}`}function zr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const o=e.map(s=>{const r=new Date(s.startTime),a=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=a.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(s.professionalId)||{},d=b(s.reason),c=b(s.professionalName),u=b(s.clientName),p=b(s.serviceName),f=C.selectedItems.has(s.id),h=C.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const v=s.status==="completed",w=v?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",x=v?"Finalizado":"Aberto",S=JSON.stringify(s).replace(/'/g,"&apos;"),k=s.redeemedReward?.points>0,E=s.hasRewards&&!k,L=Or(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),N=C.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${S}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
                    <span class="status-badge ${w} mb-1">${x}</span>
                    ...
                    `;const E=JSON.stringify(p).replace(/'/g,"&apos;"),L=p.redeemedReward?.points>0,N=p.hasRewards&&!L,F=p.status==="completed";return`
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                        ...
                        <div class="mt-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-800 truncate">${N?"🎁 ":""}${S}</p>
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(I.data.redeemedReward=null)})}async function Jr(e){e.preventDefault();const t=e.target,o=t.querySelector('button[type="submit"]');if(!I.data.time||I.data.selectedServiceIds.length===0||!I.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");o.disabled=!0,o.textContent="A confirmar...";const s=I.data.selectedServiceIds.map(d=>{const c=lt.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,a]=I.data.time.split(":"),n=new Date(`${I.data.date}T${r}:${a}:00`),i={establishmentId:m.establishmentId,clientName:I.data.clientName,clientPhone:I.data.clientPhone,services:s,professionalId:I.data.professionalId,startTime:n.toISOString(),redeemedReward:I.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Gs(l,i):await Js(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",oe()}catch(d){g(d.message,"error")}finally{o.disabled=!1,o.textContent="Confirmar Agendamento"}}function ts(e){const t=I.data.clientName===e.name&&I.data.clientPhone===e.phone,o=b(e.name),s=b(e.phone);return`
        ...
        <div class="p-5 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="apptClientName" required class="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm" placeholder="Nome Completo" value="${b(I.data.clientName)}">
                </div>
                <div>
                    <label for="apptClientPhone" class="block text-sm font-medium text-gray-700">Telemóvel</label>
                    <input type="tel" id="apptClientPhone" required class="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm" placeholder="(XX) XXXXX-XXXX" value="${b(I.data.clientPhone)}">
                </div>
            </div>
    ...
    `;return{title:o,content:s}}function Kr(){const e="Selecionar Serviço",o=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${lt.map(s=>{const r=I.data.selectedServiceIds.includes(s.id),a=s.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=b(s.name);return`
    ...
    `;return{title:e,content:o}}function en(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Ut.map(o=>{const s=I.data.professionalId===o.id,r=o.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",a=b(o.name);return`
                         <div class="professional-modal-card p-3 bg-white rounded-lg border-2 border-gray-200 text-center cursor-pointer transition-all hover:bg-gray-50 ${s?"selected border-blue-500":""}" data-professional-id="${o.id}">
                             ...
                             <p class="text-[10px] text-gray-500">${b(o.specialty||"Profissional")}</p>
                         </div>`}).join("")}
             </div>
    ...
    `;return{title:e,content:t}}function tn(e){const t=e?"Confirmar Edição":"Data e Horário",o=new Date,s=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,r=I.data.date||s,a=b(I.data.clientName),n=b(I.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function on(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const o=e.toLowerCase(),s=lt.filter(r=>r.name.toLowerCase().includes(o));t.innerHTML=s.map(r=>{const a=I.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${a?"selected border-blue-500":""}" data-service-id="${r.id}">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-sm text-gray-800">${b(r.name)}</p>
                        <p class="text-xs text-gray-500">R$ ${r.price.toFixed(2)} (${r.duration} min)</p>
                    </div>
                </div>
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Ka(r.dataset.serviceId,r))})}function an(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const o=e.toLowerCase(),s=Ut.filter(r=>r.name.toLowerCase().includes(o));t.innerHTML=s.map(r=>{const a=I.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=b(r.name);return`
        ...
        </div>`,o.querySelectorAll('[data-action="next-step"]').forEach(a=>{a.addEventListener("click",()=>{const n=parseInt(a.dataset.currentStep,10);if(n===1){const i=o.querySelector("#apptClientName"),l=o.querySelector("#apptClientPhone");if(I.data.clientName=i.value.trim(),I.data.clientPhone=l.value.trim(),!I.data.clientName||!I.data.clientPhone)return g("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(I.data.selectedServiceIds.length===0)return g("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!I.data.professionalId)return g("Atenção","Selecione um profissional.","error");uo(n+1)})}),o.querySelectorAll('[data-action="prev-step"]').forEach(a=>{a.addEventListener("click",()=>uo(parseInt(a.dataset.currentStep,10)-1))});const r=o.querySelector("#appointmentForm");if(I.step===4&&r&&r.addEventListener("submit",Jr),o.style.display="flex",I.step===2){o.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Ka(i.dataset.serviceId,i))});const n=o.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>on(i.target.value))}if(I.step===3){o.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>es(i.dataset.professionalId,i))});const n=o.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>an(i.target.value))}if(I.step===1){const a=o.querySelector("#clientSearchInput");if(a&&(a.addEventListener("input",i=>Gr(i.target.value)),I.data.clientName&&I.data.clientPhone&&Ae.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=Ae.map(ts).join(""))}const n=o.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Xr)}if(I.step===4){const a=o.querySelector("#apptDate");a&&a.addEventListener("change",sa),sa(),Wr()}}async function os(e={}){C.currentDate=e.targetDate?new Date(e.targetDate):C.currentDate||new Date,C.scrollToAppointmentId=e.scrollToAppointmentId||null,C.profSearchTerm="",C.isSelectionMode=!1,C.selectedItems.clear(),window.innerWidth<768&&(C.currentView="list"),oa.innerHTML=`
        <section>
    ...
    `,_t()}function _t(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),xn()}function xn(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
        ...
        `:e.innerHTML=`
            ...
            <button data-action="view-sales-report" class="py-2 px-4 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 text-sm transition">Relatório</button>
        `)}function rt(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!y.isCashierOpen&&y.activeFilter==="atendimento"){e.innerHTML=`
        ...
        `,t&&(t.innerHTML="");return}const s={atendimento:"confirmed",finalizadas:"completed"}[y.activeFilter],r=y.allComandas.filter(n=>n.status===s);if(r.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda nesta página.</p>',ia(t);return}const a=document.createDocumentFragment();r.forEach(n=>{let d=Fe(n).reduce((x,S)=>x+Number(S.price||0),0);n.status==="completed"&&n.totalAmount!==void 0&&n.totalAmount!==null&&(d=Number(n.totalAmount));const c=n.id===y.selectedComandaId,u=new Date(n.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),p=n.type==="walk-in"||typeof n.id=="string"&&n.id.startsWith("temp-"),f=b(n.clientName||"Cliente sem nome"),h=b(n.professionalName||"Sem profissional"),v=p?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>',w=document.createElement("div");w.className=`comanda-card cursor-pointer ${c?"selected":""}`,w.dataset.action="select-comanda",w.dataset.comandaId=n.id,w.innerHTML=`
            ...
            <div class="flex justify-between items-center mt-1 pointer-events-none">
                ...
                <p class="text-xs text-gray-400 font-medium">${u}</p> 
            </div>
        `,a.appendChild(w)}),e.innerHTML="",e.appendChild(a),ia(t)}function ia(e){if(!e)return;e.innerHTML="";const{page:t,total:o,limit:s}=y.paging,r=Math.ceil((o||0)/s);if(r===0)return;const a=document.createElement("div");a.className="flex gap-2 justify-center items-center w-full",a.innerHTML=`
    ...
    `,e.appendChild(a),a.querySelectorAll("button[data-page]").forEach(n=>{n.onclick=i=>{i.stopPropagation();const l=parseInt(n.dataset.page,10);l>0&&l<=r&&(y.paging.page=l,re())}})}function G(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(x=>x.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){yn(t,e);return}const o=`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const s=Fe(t),r=t.status==="completed",a=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),n=s.reduce((x,S)=>{const k=S._source==="original_service",E=S.id||S.name,L=k?`original-${E}`:`${S.type}-${E}`;return x[L]||(x[L]={...S,quantity:0,sources:[]}),x[L].quantity+=1,S._source&&x[L].sources.push(S._source),x},{}),i=Object.values(n).reduce((x,S)=>x+Number(S.price||0)*S.quantity,0);let l=0,d=i;if(t.discount)t.discount.type==="percent"?l=i*Number(t.discount.value)/100:l=Number(t.discount.value);else if(r&&t.totalAmount!==void 0&&t.totalAmount!==null){const x=Number(t.totalAmount);i>x+.01&&(l=i-x),d=x}(!r||t.totalAmount===void 0)&&(d=i-l);const c=b(t.clientName||"Cliente sem nome"),u=b(t.professionalName||"Profissional não atribuído"),p=t._hasUnsavedChanges,v=`
        <div class="grid grid-cols-3 gap-3 mobile-hidden pt-2">
            ...
            <button data-action="save-comanda" class="col-span-1 py-3 font-bold rounded-xl transition text-sm ${p?"bg-amber-500 text-white hover:bg-amber-600 shadow-lg animate-pulse":"bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-300"}">
                ${p?"Salvar Alterações*":"Salvar"}
            </button>
    ...
    `,w=`
        <div class="mobile-fabs-container">
            ...
            <button data-action="save-comanda" class="fab-btn-secondary ${p?"bg-amber-500 text-white hover:bg-amber-600":"bg-gray-600 text-white hover:bg-gray-700"}" title="Salvar Alterações">
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            <div class="flex justify-between items-start mb-6 border-b pb-4">
                <div>
                    <h3 class="text-xl font-bold text-gray-800 truncate max-w-[200px]">${c}</h3>
            ...
            <div class="space-y-3">
                ...
                ${Object.values(n).map(x=>{const S=x.sources&&x.sources.includes("original_service");return`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm ${x.isReward?"border-yellow-200 bg-yellow-50":""}">
                        <div class="flex items-center gap-3 w-full">
                            <div class="flex-grow min-w-0">
                                ...
                                <p class="text-xs text-gray-500">${x.isReward?'<span class="text-yellow-700 font-bold">Prémio Fidelidade</span>':`R$ ${(x.price||0).toFixed(2)} un.`}</p>
                            </div>
                ...
                ${l>0?`
                    <div class="flex items-center justify-between bg-red-50 p-3 rounded-lg border border-red-100 shadow-sm mt-2">
                         <div class="flex items-center gap-2">
                             <div class="bg-red-100 p-1 rounded-md text-red-600">
                             ...
                             <p class="text-sm font-bold text-red-700">Desconto Aplicado</p>
                         </div>
                         <span class="font-bold text-red-700">- R$ ${l.toFixed(2)}</span>
                    </div>
                `:""}
        ...
        <footer class="p-4 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
            <div class="flex flex-col mb-4">
                ...
                <div class="flex justify-between items-center mb-2 text-xs text-red-500 font-bold">
                    <span>Desconto</span>
                    <span>- R$ ${l.toFixed(2)}</span>
                </div>
                `:""}
                
                <div class="flex flex-col items-start lg:flex-row lg:justify-between lg:items-end">
                    <span class="text-sm text-gray-500 font-medium">Total a Pagar</span>
                    <span class="text-4xl lg:text-3xl font-extrabold text-gray-900 mt-1 lg:mt-0">R$ ${d.toFixed(2)}</span>
                </div>
            </div>
            ${r?`
        ...
        ${r?"":w}
    `,!r&&(t.clientId||t.clientName)&&wn(t,e.querySelector("#loyalty-container"))}function yn(e,t){const s=Fe(e).reduce((p,f)=>p+Number(f.price||0)*(f.quantity||1),0),r=y.checkoutState,a=r.discount||{type:"real",value:0};let n=a.type==="percent"?s*a.value/100:a.value;n>s&&(n=s);const i=s-n,l=r.payments.reduce((p,f)=>p+f.value,0),d=Math.max(0,i-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;t.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar">
            ...
            <div class="text-center mb-6 bg-gray-50 p-6 rounded-xl border border-gray-100">
                ...
                <p id="checkout-total-display" class="text-5xl font-extrabold text-gray-800 mt-2">R$ ${i.toFixed(2)}</p>
                <div id="checkout-remaining-display">
            ...
            <div id="checkout-add-payment-section" class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm ${d<=.01?"hidden":""}">
                ...
                ${["credito","crediario"].includes(r.selectedMethod)?`
                    <div class="mb-3">
                        ...
                        <select id="checkout-installments" class="w-full mt-1 p-2 border rounded-lg text-sm bg-gray-50">
                            ${Array.from({length:12},(p,f)=>`<option value="${f+1}" ${r.installments===f+1?"selected":""}>${f+1}x</option>`).join("")}
                        </select>
                    </div>
                `:""}
    ...
    `;const u=()=>{const p=y.checkoutState.discount;let f=p.type==="percent"?s*p.value/100:p.value;f>s&&(f=s);const h=s-f,v=y.checkoutState.payments.reduce((L,N)=>L+N.value,0),w=Math.max(0,h-v),x=t.querySelector("#checkout-total-display");x&&(x.innerText=`R$ ${h.toFixed(2)}`);const S=t.querySelector("#checkout-remaining-display");S&&(S.innerHTML=w<=.01?'<p class="text-green-600 font-bold mt-2 text-lg">Pago</p>':`<p class="text-red-500 font-medium mt-2">Faltam: R$ ${w.toFixed(2)}</p>`);const k=t.querySelector("#checkout-add-payment-section"),E=t.querySelector("#checkout-amount");k&&(w<=.01?k.classList.add("hidden"):(k.classList.remove("hidden"),E&&(E.value=w.toFixed(2),y.checkoutState.amountReceived=w.toFixed(2))))};t.querySelector("#discount-value")?.addEventListener("input",p=>{const f=parseFloat(p.target.value);y.checkoutState.discount.value=isNaN(f)?0:f,u()}),t.querySelector("#discount-type")?.addEventListener("change",p=>{y.checkoutState.discount.type=p.target.value,u()}),t.querySelector("#checkout-amount")?.addEventListener("input",p=>{r.amountReceived=p.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",p=>{r.installments=parseInt(p.target.value,10)})}async function wn(e,t){if(!t)return;const o=y.loyaltySettings;if(!o||!o.enabled)return;let s=null;try{if(e.clientId)s=await lo(m.establishmentId,e.clientId);else if(e.clientName){const i=await it(m.establishmentId,e.clientName,1);i&&i.length>0&&(s=i[0])}}catch(i){console.warn("Erro ao buscar dados de fidelidade",i)}if(!s||s.loyaltyPoints===void 0)return;const r=Number(s.loyaltyPoints)||0,n=(o.tiers||o.rewards||[]).filter(i=>{const l=Number(i.costPoints||i.points||0);return l>0&&r>=l});if(n.length>0){const i=document.createElement("div");i.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",i.innerHTML=`
            <div class="flex items-center gap-3">
            ...
            <div class="space-y-2 max-h-96 overflow-y-auto custom-scrollbar">
                ${e.map(a=>{const n=a.costPoints||a.points||0,i=a.name||a.reward;return`
                    <button data-action="select-reward" data-reward-id="${a.id||i}" class="w-full flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl hover:border-yellow-400 hover:bg-yellow-50 transition-all group">
                        <div class="text-left">
                            <p class="font-bold text-gray-800 group-hover:text-yellow-700">${b(i)}</p>
    ...
    `,{modalElement:s,close:r}=X({title:"🎁 Resgatar Prémio",contentHTML:o,maxWidth:"max-w-md"});s.addEventListener("click",a=>{const n=a.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,l=e.find(d=>d.id&&d.id==i||(d.name||d.reward)==i);l&&(Sn(l),r())}})}async function Sn(e,t){const o=Number(e.costPoints||e.points||0),s=e.name||e.reward,r={id:e.serviceId||e.productId||`reward-${Date.now()}`,name:`${s}`,price:0,type:e.serviceId?"service":"product",isReward:!0,pointsCost:o};await To(r,1)}function $n(){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=X({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),o=()=>{const r=e.querySelector("#add-item-content");r.innerHTML=`
            ...
            <div class="text-center p-8 relative">
                ...
                <h3 class="font-bold text-2xl text-gray-800 mt-4">${b(r.name)}</h3>
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{a>1&&(a--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{a++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await To(r,a),t()}};e.addEventListener("click",r=>{const a=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(a){const{itemType:i,itemId:l}=a.dataset,c=(y.catalog[i+"s"]||[]).find(u=>u.id===l);c&&s({...c,type:i})}else n&&o()}),o()}async function po(e=null){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await Z(m.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const o=`
    ...
    `,{modalElement:t}=X({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return g("Valor Inválido","Insira um valor válido.","error");try{const r=await cn({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),_t(),await re()}catch(r){g("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function Ln(){const e=y.activeCashierSessionId;if(e)try{const t=await pn(e),o=`
            <form id="close-cashier-form" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="mt-1 relative"><span class="absolute left-3 top-2 text-gray-500 font-semibold">R$</span><input type="number" step="0.01" min="0" id="final-amount" required class="w-full p-2 pl-12 border rounded-md text-lg font-semibold" placeholder="0.00" value="${t.expectedAmount.toFixed(2)}"></div>
                </div>
        ...
        `,{modalElement:s}=X({title:"Fechar Caixa",contentHTML:o,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const a=parseFloat(document.getElementById("final-amount").value);if(isNaN(a)||a<0)return g("Valor Inválido","Insira um valor final válido.","error");try{await un(e,a),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",_t(),await re(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){g("Erro",`Falha ao fechar caixa: ${n.message}`,"error")}})}catch(t){g("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Tn(e){y.activeFilter!==e&&(y.activeFilter=e,y.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),Te(),await re(),y.selectedComandaId=null,y.viewMode="items",G())}function rs(e){y.selectedComandaId=e,y.viewMode="items",rt(),vn(),G()}async function To(e,t){const o=y.allComandas.find(a=>a.id===y.selectedComandaId);if(!o)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),g("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(e.price)||0,r=Array(t).fill(0).map(()=>{const a={id:String(e.id),name:e.name,price:s,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(a.productId=a.id,a.product_id=a.id):e.type==="service"&&(a.serviceId=a.id,a.service_id=a.id),a});o.comandaItems=o.comandaItems||[],o.comandaItems.push(...r),o._cachedItems=null,o._hasUnsavedChanges=!0,G()}async function la(e,t){const o=y.allComandas.find(a=>a.id===y.selectedComandaId);if(!o)return;let s=!1,r=(o.comandaItems||[]).findIndex(a=>a.id==e&&a.type===t);r>-1&&(o.comandaItems.splice(r,1),s=!0),s&&(o._cachedItems=null,o._hasUnsavedChanges=!0,G())}async function Pn(e){if(y.isProcessing)return;const t=Fe(e),o=t.reduce((v,w)=>v+Number(w.price||0)*(w.quantity||1),0),s=y.checkoutState.discount||{type:"real",value:0};let r=s.type==="percent"?o*s.value/100:s.value;r>o&&(r=o);const a=o-r,{payments:n}=y.checkoutState,i=n.reduce((v,w)=>v+w.value,0),l=a-i;if(l>.01){if(!await H("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;n.push({method:"fiado",value:l,installments:1})}y.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const p=y.loyaltySettings;if(p&&p.enabled)if(p.type==="visit")u=Number(p.pointsPerVisit)||1;else{const v=Number(p.pointsPerCurrency)||10;v>0&&(u=Math.floor(a/v))}const f={payments:n,totalAmount:Number(a),items:c,cashierSessionId:y.activeCashierSessionId,loyaltyPointsEarned:u,discount:s},h=document.createElement("div");h.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",h.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(h);try{d?await Qs(e.id,f):(f.establishmentId=m.establishmentId,f.clientId=e.clientId,f.clientName=e.clientName,f.professionalId=e.professionalId,e.clientPhone&&(f.clientPhone=e.clientPhone),await nn(f));let v="Venda finalizada com sucesso!";u>0&&(v+=` Cliente ganhou ${u} pontos!`),g("Sucesso!",v,"success"),Te(),y.selectedComandaId=null,y.viewMode="items",await re()}catch(v){g("Erro no Checkout",v.message,"error")}finally{document.body.contains(h)&&document.body.removeChild(h),y.isProcessing=!1}}async function Bn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),o=document.getElementById("new-sale-professional").value,s=t.value,r=document.getElementById("client-search").value,a=t.dataset.phone||"";if(!s)return g("Erro","Selecione um cliente válido.","error");const n=m.professionals.find(l=>l.id===o);if(!n)return g("Erro","Selecione um profissional válido.","error");const i={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:r.split("(")[0].trim(),clientPhone:a,professionalId:n.id,professionalName:n.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(i),y.selectedComandaId=i.id,y.viewMode="items",document.getElementById("genericModal").style.display="none",rs(i.id)}async function re(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=y.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const o=await dn();if(y.isCashierOpen=!!o,y.activeCashierSessionId=o?o.id:null,_t(),!y.isCashierOpen&&y.activeFilter==="atendimento"){rt(),G();return}try{const r=await(void 0)(m.establishmentId);r&&r.loyaltyProgram&&(y.loyaltySettings=r.loyaltyProgram)}catch{}const s=await sn(m.establishmentId,t,y.paging.page,y.paging.limit);if(y.allComandas=s.data||s,y.paging.total=s.total||s.length,y.catalog.services.length===0){const[r,a,n,i]=await Promise.all([$e(m.establishmentId),Ht(m.establishmentId),as(m.establishmentId),Z(m.establishmentId)]);y.catalog={services:r,products:a,packages:n},m.professionals=i}rt(),G()}catch(o){g("Erro",`Não foi possível carregar os dados: ${o.message}`,"error")}}async function Dn(e={}){Le=document.getElementById("content"),y.selectedComandaId=e.selectedAppointmentId||null,y.viewMode="items",hn(),Ie&&(Le.removeEventListener("click",Ie),Le.removeEventListener("change",Ie)),Ie=async t=>{const o=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&y.activeFilter==="finalizadas"){y.paging.page=1,await re();return}if(o){if(o.matches("[data-filter]"))Tn(o.dataset.filter);else if(o.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}rs(o.dataset.comandaId)}else if(o.matches("[data-action]")){const r=o.dataset.action,a=o.dataset.id||y.selectedComandaId,n=y.allComandas.find(i=>i.id===a);switch(r){case"back-to-list":Te(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(S=>S.classList.remove("selected")),G();break;case"new-sale":po();break;case"add-item":$n();break;case"open-cashier":Cn();break;case"close-cashier":await Ln();break;case"view-sales-report":ee("sales-report-section");break;case"go-to-checkout":await na(n,"checkout");break;case"back-to-items":y.viewMode="items",G();break;case"save-comanda":await na(n,"stay");break;case"select-method":y.checkoutState.selectedMethod=o.dataset.method,y.checkoutState.installments=1,G();break;case"add-payment-checkout":const i=document.getElementById("checkout-amount");let l=parseFloat(i.value);const c=Fe(n).reduce((S,k)=>S+(k.price||0),0),u=y.checkoutState.discount||{type:"real",value:0};let p=u.type==="percent"?c*u.value/100:u.value;p>c&&(p=c);const f=c-p,h=y.checkoutState.payments.reduce((S,k)=>S+k.value,0),v=f-h;if(isNaN(l)||l<=0){g("Valor inválido","Insira um valor maior que zero.","error");break}if(l>v+.05){g("Valor inválido","Valor excede o restante.","error");break}const w={method:y.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(y.checkoutState.selectedMethod)&&y.checkoutState.installments>1&&(w.installments=y.checkoutState.installments),y.checkoutState.payments.push(w),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.installments=1,y.checkoutState.amountReceived="",G();break;case"remove-payment-checkout":const x=parseInt(o.dataset.index,10);y.checkoutState.payments.splice(x,1),G();break;case"finalize-checkout":await Pn(n);break;case"increase-qty":{const S=o.dataset.itemId,k=o.dataset.itemType;if(!S||S==="undefined"||S==="null"){g("Erro","Item inválido para adição.","error");return}let L=Fe(n).find(F=>F.id==S&&F.type===k);L||(L=(y.catalog[k+"s"]||[]).find(T=>T.id==S));const N=L?{id:L.id,name:L.name,price:Number(L.price),type:L.type}:{id:S,name:"Item Indisponível",price:0,type:k};await To(N,1);break}case"decrease-qty":{await la(o.dataset.itemId,o.dataset.itemType);break}case"remove-item":await la(o.dataset.itemId,o.dataset.itemType);break;case"reopen-appointment":{if(await H("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Ys(a);const k=y.allComandas.findIndex(E=>E.id===a);k!==-1&&(y.allComandas[k].status="confirmed",delete y.allComandas[k].transaction),y.selectedComandaId=null,Te(),await re(),g("Sucesso!","Comanda reaberta.","success")}catch(k){g("Erro",k.message,"error")}break}case"go-to-appointment":{const S=o.dataset.id,k=o.dataset.date;ee("agenda-section",{scrollToAppointmentId:S,targetDate:new Date(k)});break}case"delete-walk-in":{if(await H("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(a.startsWith("temp-"))y.allComandas=y.allComandas.filter(k=>k.id!==a),y.selectedComandaId=null,rt(),G(),Te();else try{await ln(a),g("Sucesso","Venda excluída.","success"),y.selectedComandaId=null,Te(),await re()}catch(k){g("Erro",k.message,"error")}break}}}}},Le.addEventListener("click",Ie),Le.addEventListener("change",Ie),e.initialFilter&&(y.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${y.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",y.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await re()}const Po=e=>$(`/api/financial/natures/${e}`),Mn=e=>$("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),An=e=>$(`/api/financial/natures/${e}`,{method:"DELETE"}),Bo=e=>$(`/api/financial/cost-centers/${e}`),Nn=e=>$("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),qn=e=>$(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),ns=(e,t)=>$(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),is=(e,t={})=>{let o=`/api/financial/${e}`;const s=new URLSearchParams;t.establishmentId&&s.append("establishmentId",t.establishmentId),t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId),t.status&&s.append("status",t.status);const r=s.toString();return r&&(o+=`?${r}`),$(o)},ls=(e,t,o)=>$(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(o)}),ds=(e,t)=>$(`/api/financial/${e}/${t}`,{method:"DELETE"}),cs=(e,t,o)=>$(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:o})}),Rn=e=>ns("payables",e),jn=e=>is("payables",e),Fn=(e,t)=>ls("payables",e,t),Hn=e=>ds("payables",e),On=(e,t)=>cs("payables",e,t),zn=e=>ns("receivables",e),Vn=e=>is("receivables",e),Un=(e,t)=>ls("receivables",e,t),_n=e=>ds("receivables",e),Wn=(e,t)=>cs("receivables",e,t),Jn=(e,t,o)=>$(`/api/financial/cash-flow?establishmentId=${e}&startDate=${t}&endDate=${o}`),go=document.getElementById("content");let ue={};const da=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],D={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],cashFlowData:null,currentTab:"dashboards",isFilterOpen:!1};async function Gn(){if(!window.Chart)return new Promise((e,t)=>{const o=document.createElement("script");o.src="https://cdn.jsdelivr.net/npm/chart.js",o.onload=e,o.onerror=t,document.head.appendChild(o)})}async function Yn(){go.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
            ...
            <div class="flex flex-col items-center justify-center h-full text-red-500 p-6 text-center">
                ...
                <p class="text-sm text-gray-600 mt-2">${b(e.message)}</p>
            ...
            </div>`}}function Qn(){const e=D.professionalsList.map(o=>`<option value="${o.id}">${b(o.name)}</option>`).join(""),t=D.costCentersList.map(o=>`<option value="${o.id}">${b(o.name)}</option>`).join("");go.innerHTML=`
    ...
    `,D.cashFlowData&&ti("chart-cashflow-modern",D.cashFlowData),ma("chart-monthly","bar","Receita Mensal",o.salesMonthly.labels,o.salesMonthly.data,da[0]),ma("chart-profs","doughnut","Total Vendas",o.professionals.labels,o.professionals.data,da)}function Kn(e){const t=D.appointmentsData,o=t.length;let s=0,r=0,a=0;const n={},i={};let l=new Date(D.startDate);const d=new Date(D.endDate);for(;l<=d;)n[l.toISOString().split("T")[0]]=0,l.setDate(l.getDate()+1);t.forEach(f=>{const h=parseFloat(f.totalAmount||f.price||0),v=(f.status||"").toLowerCase();let w=f.startTime?(f.startTime.toDate?f.startTime.toDate():new Date(f.startTime)).toISOString().split("T")[0]:"";const x=f.professionalName||"Sem Profissional";i[x]||(i[x]={name:x,count:0,value:0}),["cancelled","cancelado","no-show"].includes(v)?r++:(["completed","finalized","paid"].includes(v)&&s++,a+=h,w&&n.hasOwnProperty(w)&&n[w]++,i[x].count++,i[x].value+=h)});const c=Object.keys(n).sort(),u=c.map(f=>n[f]),p=Object.values(i).sort((f,h)=>h.value-f.value);e.innerHTML=`
    ...
    `,oi("chart-appointments-daily",c,u)}function ei(e){const{dreFinancial:t}=D.data;if(!t)return;const o=t.totalRevenues,s=(i,l,d,c=!1)=>{const u=o>0?l/o*100:0,p=c?"- ":"";return`
        <div class="flex items-center justify-between py-2 md:py-3 px-3 md:px-4 border-b border-dashed border-gray-100 last:border-0">
            <div class="flex-1 pr-2 md:pr-4 overflow-hidden">
                <p class="text-[10px] md:text-xs font-semibold text-gray-600 truncate">${b(i)}</p>
            ...
            <div class="mt-6 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-3">
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async E=>{const L=E.target.closest("button[data-action]");if(!L)return;const N=L.dataset.action,F=L.dataset.id;if(N==="close-modal"&&(t.style.display="none"),N==="delete-service"){if(!F)return;if(t.style.display="none",await H("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const B=m.services.find(R=>R.id===F)?.name||"Desconhecido";await dr(F),He(m.establishmentId,Oe(),"Serviços","Excluiu",`Excluiu o serviço: ${B}`),g("Sucesso","Serviço apagado com sucesso!","success"),await dt()}catch(B){g("Erro",`Não foi possível apagar o serviço: ${B.message}`,"error")}else t.style.display="flex"}});const d=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");d.forEach(E=>{E.addEventListener("click",()=>{d.forEach(L=>{L.classList.remove("border-indigo-500","text-indigo-600"),L.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),E.classList.add("border-indigo-500","text-indigo-600"),E.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),c.forEach(L=>L.classList.add("hidden")),document.getElementById(`tab-content-${E.dataset.tab}`).classList.remove("hidden")})});const u=t.querySelectorAll('input[name="commissionType"]'),p=document.getElementById("defaultCommissionRateContainer"),f=document.getElementById("professionalCommissionsContainer");function h(){const E=t.querySelector('input[name="commissionType"]:checked').value;p&&(p.style.display=E==="default"?"block":"none"),f&&(f.style.display=E==="custom"?"block":"none")}u.forEach(E=>E.addEventListener("change",h));const v=document.getElementById("professionalCommissionsList");v&&(v.innerHTML=(m.professionals||[]).map(E=>{const L=e?.professionalCommissions?.[E.id]!==void 0,N=e?.professionalCommissions?.[E.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${L?"bg-blue-50":""}" data-prof-id="${E.id}">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <img src="${E.photo||`https://placehold.co/40x40/E2E8F0/4A5568?text=${b(E.name.charAt(0))}`}" class="w-8 h-8 rounded-full object-cover">
                        <span class="text-sm font-medium">${b(E.name)}</span>
                    </label>
                    <div class="flex items-center gap-1">
                        <input type="number" value="${N}" class="w-20 p-1 border rounded-md text-sm text-center" ${L?"":"disabled"}>
                        <span class="text-sm font-semibold">%</span>
                    </div>
                </div>
            `}).join(""),v.querySelectorAll('input[type="checkbox"]').forEach(E=>{E.addEventListener("change",L=>{const N=L.target.closest(".professional-commission-row");N.querySelector('input[type="number"]').disabled=!L.target.checked,N.classList.toggle("bg-blue-50",L.target.checked)})})),h();const w=t.querySelector("#serviceForm"),x=t.querySelector("#servicePhotoInput"),S=t.querySelector("#servicePhotoPreview"),k=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>x.click()),x.onchange=async()=>{const E=x.files[0];if(E){S.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const L=await Qa(E,800,800,.8),F=L.length*3/4,T=1e3*1024;if(F>T)throw new Error("A imagem é muito grande mesmo após a compressão.");S.src=L,k.value=L}catch(L){console.error("Erro ao processar imagem:",L),g("Erro de Imagem",L.message||"Não foi possível processar a imagem.","error"),S.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",k.value=e?.photo||"",x.value=""}}},w.addEventListener("submit",ii)}function Pe(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",o=document.getElementById("serviceCategoryFilter")?.value||"all",s=new Map((m.serviceCategories||[]).map(a=>[a.id,a.name]));let r=(m.services||[]).filter(Boolean);if(we!=="all"){const a=we==="active";r=r.filter(n=>n.active!==!1===a)}r=r.filter(a=>{const n=a.name.toLowerCase().includes(t),i=o==="all"||a.categoryId===o;return n&&i}),e.innerHTML="",r.length>0?r.forEach(a=>{const n=document.createElement("div"),i=JSON.stringify(a).replace(/'/g,"&apos;");n.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:bg-gray-50 ${a.active!==!1?"opacity-100":"opacity-50 bg-gray-100"} sm:flex-col`,n.dataset.action="edit-service",n.dataset.service=i;const l=b(a.name),d=b(s.get(a.categoryId)||"N/A"),c=a.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`;n.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(o=>t.innerHTML+=`<option value="${o.id}">${b(o.name)}</option>`)),Mo(),Pe()}function di(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function dt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,o,s,r]=await Promise.all([$e(m.establishmentId),Z(m.establishmentId),Wt(m.establishmentId,"services"),ur(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(o||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(a=>{a.active===void 0&&(a.active=!0)}),fs(Xe)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function fs(e){if(document.getElementById("services-content-container")){if(Xe===e&&document.getElementById("services-content-container").children.length>1){Xe==="services"&&(Mo(),Pe());return}Xe=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const o=t.dataset.view===e;t.classList.toggle("border-indigo-500",o),t.classList.toggle("text-indigo-600",o),t.classList.toggle("border-transparent",!o),t.classList.toggle("text-gray-500",!o)}),e==="services"?li():e==="reports"&&di()}}function ci(){ie&&(he.removeEventListener("click",ie),he.removeEventListener("input",ie),he.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),a=r.dataset.id,n=r.checked;try{await cr(a,n);const i=m.services.findIndex(l=>l.id===a);i>-1&&(m.services[i].active=n),He(m.establishmentId,Oe(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${a}) para ${n?"Ativo":"Inativo"}`),Pe(),Mo()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Pe()}return}const o=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Pe();return}if(!o)return;if(o.hasAttribute("data-view")){fs(o.dataset.view);return}switch(o.dataset.action){case"new-service":pa();break;case"edit-service":const r=JSON.parse(o.dataset.service);pa(r);break;case"manage-categories":ni();break;case"filter-service":const a=o.dataset.filterType;if(a==="popular")return;we=a==="total"?"all":a,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===we||i==="total"&&we==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Pe();break}},he.addEventListener("click",ie),he.addEventListener("input",ie),he.addEventListener("change",ie)}async function ui(){he.innerHTML=`
        ...
        </section>`,ci();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await Z(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Xe="services",we="all",await dt()}const Jt="suppliers",Ao="purchases",bs="financial_payables",No=async e=>{try{const t=jt(pe(U,Jt),st("establishmentId","==",e)),o=await ko(t),s=[];return o.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},mi=async e=>{try{return{id:(await Aa(pe(U,Jt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},pi=async(e,t)=>{try{const o=me(U,Jt,e);return await wo(o,t),{id:e,...t}}catch(o){throw console.error("Erro ao atualizar fornecedor:",o),o}},gi=async e=>{try{const t=me(U,Jt,e);return await Fs(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},fi=async(e,t=null)=>{try{const o=qa(U),s=me(pe(U,Ao)),r={...e,createdAt:Uo()};if(o.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const a=me(pe(U,bs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:Uo()};o.set(a,i)}return await o.commit(),{id:s.id,...r}}catch(o){throw console.error("Erro ao registrar compra com integração:",o),o}},bi=async(e,t)=>{try{const o=qa(U),s=me(U,Ao,e);o.delete(s);const r=jt(pe(U,bs),st("purchaseId","==",e),st("establishmentId","==",t));return(await ko(r)).forEach(n=>{o.delete(n.ref)}),await o.commit(),!0}catch(o){throw console.error("Erro ao excluir compra e financeiro:",o),o}},vi=async e=>{try{const t=jt(pe(U,Ao),st("establishmentId","==",e),Na("createdAt","desc")),o=await ko(t),s=[];return o.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},fe=document.getElementById("content");let le=null,Ze="products",se="all";async function hi(e){e.preventDefault();const o=e.target.closest("#categoryForm").querySelector("#categoryName"),s=o.value;if(s)try{await ps({establishmentId:m.establishmentId,name:s},"products"),o.value="",g("Sucesso","Categoria de produto criada!","success"),await qo(),await ct()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function xi(e){if(await H("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await gs(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await qo(),await ct()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function qo(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Wt(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(o=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${b(o.name)}</span>
                    <button data-action="delete-category" data-id="${o.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                <div class="flex flex-col-reverse sm:flex-row w-full sm:w-auto gap-3">
    ...
    </div>`;const h=t.querySelector("#productCategory"),v=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>v.click()),h.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${b(T.name)}</option>`).join(""),e&&(h.value=e.categoryId||"");const w=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const x=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",S=e?.photo||"";v.onchange=async()=>{const T=v.files[0];if(T){w.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const B=await ga(T,800,800,"image/jpeg",.8),j=B.length*3/4,z=1e3*1024;if(j>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=B,base64Input.value=B}catch(B){console.error("Erro ao processar imagem:",B),g("Erro de Imagem",B.message||"Não foi possível processar a imagem.","error"),preview.src=x,base64Input.value=S,F.value=""}}};const k=t.cloneNode(!0);t.parentNode.replaceChild(k,t);const E=()=>{const T=k.querySelector("#modalSupplierSearch"),B=k.querySelector("#supplierSearchResults"),R=k.querySelector("#selectedSuppliersList"),j=T.value.toLowerCase();if(j.length>0){const z=s.filter(q=>q.name.toLowerCase().includes(j)&&!a.has(q.id));z.length>0?(B.classList.remove("hidden"),B.innerHTML=z.map(q=>`
                    <div class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 text-sm flex justify-between items-center" data-add-supplier="${q.id}">
                        <span class="font-medium">${b(q.name)}</span>
                        <span class="text-indigo-600 text-xs">+ Adicionar</span>
                    </div>
                `).join("")):(B.classList.remove("hidden"),B.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else B.classList.add("hidden");a.size>0?(R.innerHTML="",a.forEach(z=>{const q=s.find(Y=>Y.id===z);q&&(R.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border p-2 rounded shadow-sm" data-id="${q.id}">
                            <div class="text-sm">
                                <p class="font-bold text-gray-800">${b(q.name)}</p>
                                <p class="text-xs text-gray-500">${b(q.contactName||"")} - ${b(q.phone||"")}</p>
                            </div>
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};k.querySelector("#modalSupplierSearch").addEventListener("input",E),k.addEventListener("click",T=>{const B=T.target.closest("[data-add-supplier]");if(B){const j=B.dataset.addSupplier;a.add(j),k.querySelector("#modalSupplierSearch").value="",E()}const R=T.target.closest("[data-remove-supplier]");if(R){const j=R.dataset.removeSupplier;a.delete(j),E()}}),E(),k.addEventListener("click",async T=>{const B=T.target.closest("button[data-action]");if(!B)return;const R=B.dataset.action,j=k.querySelector("#productId").value;if(R==="close-modal"&&(k.style.display="none"),R==="delete-product"){if(!j)return;k.style.display="none",await wi(j)}if(R==="save-product-modal"){const z=k.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const q=B.closest('button[data-action="save-product-modal"]');q.disabled=!0,q.textContent="A salvar...";try{await ki(z)}catch(Y){g("Erro",`Falha ao salvar: ${Y.message}`,"error"),q.disabled=!1,q.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){T.preventDefault();const z=k.querySelector("#stockAdjustmentAmount"),q=k.querySelector("#stockAdjustmentReason"),Y=parseInt(z.value,10),Ee=parseInt(B.dataset.change,10);if(!Y||Y<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Qt=Y*Ee,Ps=q.value||(Qt>0?"Entrada manual":"Saída manual");try{await gr(j,{change:Qt,reason:Ps});const Ue=m.products.findIndex(_e=>_e.id===j);if(Ue>-1){const _e=m.products[Ue].currentStock+Qt;m.products[Ue].currentStock=_e,k.querySelector("#currentStockDisplay").textContent=_e,k.querySelector("#productCurrentStock").value=_e,z.value="",q.value="",g("Sucesso","Estoque atualizado!","success"),Ro(),nt()}}catch(Ue){g("Erro de Stock",Ue.message,"error")}}});const L=k.querySelectorAll(".tab-btn"),N=k.querySelectorAll(".tab-content");L.forEach(T=>{T.addEventListener("click",B=>{B.preventDefault(),L.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),T.classList.add("border-indigo-500","text-indigo-600"),T.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),N.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${T.dataset.tab}`).classList.remove("hidden")})});const F=k.querySelector("#productPhotoInput");k.querySelector("#productPhotoButton").addEventListener("click",()=>F.click()),F.onchange=async()=>{const T=F.files[0];if(!T)return;const B=k.querySelector("#productPhotoPreview"),R=k.querySelector("#productPhotoBase64");B.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const j=await ga(T,800,800,"image/jpeg",.8),q=j.length*3/4,Y=1e3*1024;if(q>Y)throw new Error("A imagem é muito grande mesmo após a compressão.");B.src=j,R.value=j}catch(j){console.error("Erro ao processar imagem:",j),g("Erro de Imagem",j.message||"Não foi possível processar a imagem.","error"),B.src=x,R.value=S,F.value=""}},k.style.display="flex"}function Si(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(o=>t.innerHTML+=`<option value="${o.id}">${b(o.name)}</option>`)),Ro(),nt()}function $i(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],o=new Date;o.setDate(o.getDate()-30);const s=o.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),a=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${b(n.name)}</option>`).join("")),a&&m.categories&&(a.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${b(n.name)}</option>`).join(""))}async function Ei(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const o=await fr(t);if(o.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ${o.map(a=>`
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap font-semibold text-gray-800">${b(a.productName)}</td>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-gray-600 truncate max-w-xs" title="${b(a.reason)}">${b(a.reason)}</td>
                                <td class="px-4 py-3 whitespace-nowrap text-gray-600">${b(a.user)}</td>
                            </tr>`).join("")}
                    </tbody>
                </table>
            </div>`,r=`
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                        <div class="flex justify-between items-start mb-2">
                            <div>
                                ...
                                <h4 class="font-bold text-gray-800 text-base line-clamp-1">${b(a.productName)}</h4>
                            </div>
                        ...
                        <div class="flex justify-between items-center text-xs border-t pt-2 border-dashed border-gray-200">
                            <span class="text-gray-600 truncate max-w-[60%] font-medium" title="${b(a.reason)}">
                                ${b(a.reason)||"Sem motivo"}
                            </span>
    ...
    `;o.forEach(a=>{const n=JSON.stringify(a).replace(/"/g,"&quot;"),i=b(a.name),l=b(a.taxId||"Sem doc."),d=b(a.email||"-"),c=b(a.phone||"-"),u=b(a.category||"Geral");r+=`
            <tr class="hover:bg-gray-50">
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=s+r}function Bi(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",o=e.phone?`tel:${e.phone}`:"#",s=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),a=b(e.name),n=b(e.category||"Fornecedor"),i=b(e.contactName||""),l=b(e.phone||""),d=`
    ...
    `;X({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Ke(){const e=document.getElementById("purchasesContainer");if(e)if(O.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,o]=await Promise.all([Ht(m.establishmentId),No(m.establishmentId)]);O.allSuppliers=o||[];const s=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(O.productsToBuy=s,s.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',a="";s.forEach(d=>{const c=parseInt(d.minStock)||0,u=parseInt(d.currentStock)||0,p=Math.max(c-u,1),f=parseFloat(d.costPrice||0),h=b(d.name);let v='<option value="">Selecione...</option>';O.allSuppliers.length>0?O.allSuppliers.forEach(w=>{const S=d.supplierIds&&d.supplierIds.includes(w.id)?"selected":"";v+=`<option value="${w.id}" ${S}>${b(w.name)}</option>`}):v='<option value="">Sem fornecedores</option>',r+=`
                    <div class="product-row bg-white p-3 rounded-lg shadow-sm border border-gray-200" data-product-id="${d.id}" data-cost="${f}">
                        ...
                        <div class="mt-2 pt-2 border-t border-gray-100 flex justify-between items-center">
                            ...
                            <span class="row-subtotal font-bold text-indigo-600 text-sm">R$ ${(p*f).toFixed(2)}</span>
                        </div>
                    </div>
                `,a+=`
                    <tr class="hover:bg-gray-50 border-b border-gray-100 product-row" data-product-id="${d.id}" data-cost="${f}">
                        ...
                        <td class="p-3 text-right text-sm font-bold text-gray-800 row-subtotal">R$ ${(p*f).toFixed(2)}</td>
                        <td class="p-3 w-48">
        ...
        `}).join("");s+=h;const w=encodeURIComponent(JSON.stringify({supplierId:p,supplierName:f.info.name,totalAmount:h,items:f.items})),x=encodeURIComponent(JSON.stringify({name:f.info.name,phone:f.info.phone,email:f.info.email})),S=encodeURIComponent(JSON.stringify(f.items)),k=b(f.info.name),E=b(f.info.email||"");o+=`
    ...
    `}async function hs(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await vi(m.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let o='<div class="flex flex-col gap-3 md:hidden">';t.forEach(a=>{const n=new Date(a.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=b(a.supplierName);o+=`
            ...
            <tr class="hover:bg-gray-50 border-b border-gray-100">
                ...
                <td class="p-3 font-medium text-gray-800">${b(a.supplierName)}</td>
        ...
        <li class="flex justify-between py-3 border-b border-gray-100 last:border-0">
            <div>
                <p class="font-medium text-sm text-gray-800">${b(r.name)}</p>
        ...
        <div class="space-y-4">
            <div class="flex justify-between items-center bg-gray-50 p-4 rounded-lg">
                <div>
                    ...
                    <p class="font-bold text-gray-900 text-lg">${b(e.supplierName)}</p>
                </div>
                <div class="text-right">
        ...
        <form id="supplierForm" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" id="supName" value="${b(e?.name||"")}" required class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition-shadow" placeholder="Ex: Distribuidora Beleza">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="supContact" value="${b(e?.contactName||"")}" class="w-full p-3 border border-gray-300 rounded-lg outline-none" placeholder="Ex: João Silva">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Telefone / WhatsApp</label>
                    <input type="tel" id="supPhone" value="${b(e?.phone||"")}" class="w-full p-3 border border-gray-300 rounded-lg outline-none" placeholder="(00) 00000-0000">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                    <input type="email" id="supEmail" value="${b(e?.email||"")}" class="w-full p-3 border border-gray-300 rounded-lg outline-none" placeholder="contato@empresa.com">
                </div>

                <div class="col-span-1 md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1">CNPJ / CPF</label>
                    <input type="text" id="supTaxId" value="${b(e?.taxId||"")}" class="w-full p-3 border border-gray-300 rounded-lg outline-none">
                </div>
            </div>
    ...
    `;X({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Pi),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Ft("genericModal"))},50)}function Ni(){be.innerHTML=`
    ...
    `,de&&(be.removeEventListener("click",de),be.removeEventListener("input",de),be.removeEventListener("change",de)),de=e=>{if(e.target.closest("#tab-btn-list")&&mt("list"),e.target.closest("#tab-btn-purchases")&&mt("purchases"),e.target.closest("#tab-btn-history")&&mt("history"),e.target.id==="toggle-quote-mode"&&(O.isQuoteMode=e.target.checked,Ke()),e.target.id==="supplierSearchInput"&&Gt(),e.target.closest("#btn-new-supplier")&&ba(),e.target.closest(".supplier-item-mobile")){const o=e.target.closest(".supplier-item-mobile"),s=JSON.parse(o.dataset.supplier);Bi(s)}const t=e.target.closest("button[data-action]");if(t){const o=t.dataset.action;o==="delete"&&Ti(t.dataset.id),o==="edit"&&ba(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&fo(),e.target.id==="check-all-rows"){const o=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=o),fo()}if(e.target.closest("#btn-go-to-orders")){const o=document.querySelectorAll(".product-row"),s={};let r=!1;if(o.forEach(a=>{if(a.offsetParent===null||!a.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=a.querySelector("td:nth-child(2)"),d=a.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(a.querySelector(".qty-input").value),u=parseFloat(a.dataset.cost),f=a.querySelector(".supplier-select").value;if(f){if(!s[f]){const h=O.allSuppliers.find(v=>v.id===f);s[f]={info:h,items:[]}}s[f].items.push({name:i,qty:c,cost:u})}}),!r){g("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}O.finalOrders=s,O.step=2,Ke()}if(e.target.closest("#btn-back-step1")&&(O.step=1,Ke()),e.target.closest(".btn-send-order")){const o=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(o.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(o.dataset.orderItems)),a=parseFloat(o.dataset.total),n=O.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const o=e.target.closest(".btn-register-order");if(o.disabled)return;const s=JSON.parse(decodeURIComponent(o.dataset.order));s.establishmentId=m.establishmentId,o.disabled=!0,o.textContent="A processar...",Se(m.establishmentId).then(r=>{const a=r.purchaseConfig||null;return fi(s,a)}).then(()=>{g("Sucesso","Compra registrada e integrada ao financeiro!","success"),o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',o.classList.replace("bg-blue-600","bg-green-600"),o.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{o.disabled=!1,o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;H("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await bi(s,m.establishmentId),g("Sucesso","Compra e financeiro excluídos.","success"),hs()}catch(a){g("Erro","Erro ao excluir: "+a.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=O.finalOrders[s];r?Ai(r,O.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const o=e.target.closest(".btn-view-purchase"),s=JSON.parse(o.dataset.purchase);Mi(s)}},be.addEventListener("click",de),be.addEventListener("input",de),be.addEventListener("change",de),mt("list")}function mt(e){St=e,["list","purchases","history"].forEach(o=>{const s=document.getElementById(`tab-btn-${o}`),r=document.getElementById(`tab-content-${o}`);o===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Ci()}const Zt=document.getElementById("content"),va={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ne=new Set,pt=null,Be=null;function qi(e=8){let t="";for(let o=0;o<e;o++)t+=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",Fi(o,r),Hi(o),Oi(o,a),Vi(o)}function Fi(e,t){const o=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(w,x)=>{const S=x+1,k=S==s[1]?"selected":"",E=new Date(0,x).toLocaleString("pt-BR",{month:"long"});return`<option value="${S}" ${k}>${E.charAt(0).toUpperCase()+E.slice(1)}</option>`}).join(""),a=e.status||"active",n=b(e.name||""),i=b(e.specialty||""),l=b(e.phone||""),d=b(e.notes||"");o.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${d}</textarea></div>`;const c=document.getElementById("profPhotoInput"),u=document.getElementById("profPhotoButton"),p=document.getElementById("profPhotoPreview"),f=document.getElementById("profPhotoBase64"),h=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,v=e.photo||"";u&&u.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const w=c.files[0];if(w){p.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const x=await Qa(w,800,800,.8),k=x.length*3/4,E=1e3*1024;if(k>E)throw new Error("A imagem é muito grande mesmo após a compressão.");p.src=x,f.value=x}catch(x){g("Erro de Imagem",x.message||"Não foi possível processar a imagem.","error"),p.src=h,f.value=v,c.value=""}}})}function Hi(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',zi(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function Oi(e,t){const o=document.getElementById("bloqueios");o.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
                ...
                <form id="batchBlockageForm" class="p-4 bg-white rounded-lg shadow-inner space-y-3 mb-4">
                    ...
                    <div id="batchProfSelectionContainer" class="max-h-32 overflow-y-auto p-2 border rounded-md space-y-2">
                        ${t.map(a=>`<label class="flex items-center"><input type="checkbox" name="batch-professionals" value="${a.id}" class="rounded mr-2" ${a.id===e.id?"checked":""}><span>${b(a.name)}</span></label>`).join("")}
                    </div>
            ...
            <div>
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-semibold">Bloqueios de ${b(e.name)}</h3>
        ...
        </div>`;const s=document.getElementById("batchBlockageForm");s&&s.addEventListener("submit",async a=>{a.preventDefault();const n=Array.from(a.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(f=>f.value);if(n.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const i=a.target.batchBlockageStartDate.value,l=a.target.batchBlockageEndDate.value||i,d=a.target.batchBlockageStartTime.value,c=a.target.batchBlockageEndTime.value,u=a.target.batchBlockageReason.value;if(!i||!d||!c)return g("Atenção","Preencha Data de Início, Início e Fim.","error");const p=n.map(f=>{const h={professionalId:f,establishmentId:m.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${c}`).toISOString(),reason:u};return Vt(h)});try{await Promise.all(p),g("Sucesso!",`${n.length} bloqueios foram criados.`);const f=document.getElementById("prof-blockages-filter").value;et(e.id,f)}catch(f){g("Erro",f.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",a=>et(e.id,a.target.value)),await et(e.id,"future")}function zi(e,t){e.innerHTML=Object.keys(va).map(o=>{const s=t[o]||{},r=s.active!==!1;return`
            ...
            <div class="bg-gray-100 rounded-lg p-3 my-2 space-y-2">
                <div class="flex justify-between items-center pb-2 border-b">
                    <h4 class="font-bold text-gray-700">${b(d)} (${c.length})</h4>
    ...
    `)(e||{}),maxWidth:"max-w-3xl"}),window.switchTab=s=>$t(s,t),window.handleSave=Qi,window.handleDelete=Xi,window.loadMoreHistory=()=>{P.historyLimit+=10,$t("history",t)},!t&&e.id)try{if(typeof lo=="function"){const s=await lo(m.establishmentId,e.id);if(s){P.currentClient=s;const r=document.querySelector(".bg-indigo-100.text-indigo-700");r&&(r.textContent=`${s.loyaltyPoints||0} pts`)}}P.history=await jr(m.establishmentId,e.phone)}catch(s){console.error("Aviso: Não foi possível atualizar detalhes do cliente",s),P.history=[]}$t("details",t)},$t=(e,t)=>{const o=document.getElementById("modal-body");if(!o)return;document.querySelectorAll('[id^="tab-btn-"]').forEach(a=>{a.classList.remove("border-indigo-600","text-indigo-600"),a.classList.add("border-transparent","text-gray-500")});const s=document.getElementById(`tab-btn-${e}`);s&&(s.classList.add("border-indigo-600","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"));const r=P.currentClient||{};if(e==="details"){if(o.innerHTML=`
            ...
            <div class="space-y-2">
                ${l.map(d=>{const c=d.costPoints||d.points||0,u=n>=c,p=d.reward||d.name;return`
                        <div class="flex justify-between items-center p-3 border rounded ${u?"bg-green-50 border-green-200":"bg-gray-50 opacity-70"}">
                            <div>
                                <p class="font-bold text-gray-800">${b(p)}</p>
                                <p class="text-xs text-gray-500">${c} pontos necessários</p>
                            </div>
                            <button onclick="window.handleRedeem('${c}', '${b(p)}')" ${u?"":"disabled"} 
        ...
        `,window.handleRedeem=async(d,c)=>{if(await H("Resgatar",`Trocar ${d} pontos por "${c}"?`))try{await Fr(m.establishmentId,r.phone,d,c),g("Sucesso","Resgate realizado!","success"),r.loyaltyPoints=(r.loyaltyPoints||0)-parseInt(d),P.history.unshift({type:"loyalty",description:`Resgate: ${c}`,date:new Date().toISOString(),value:-d,isPoints:!0,status:"completed"}),$t("loyalty",!1),ge()}catch(u){g("Erro",u.message||"Erro ao resgatar","error")}}}},Qi=async()=>{const e=document.getElementById("form-client"),t=new FormData(e),o=t.get("phone").replace(/\D/g,"");if(o.length<10){g("Erro","Telefone inválido","error");return}const s={name:t.get("name"),phone:o,email:t.get("email"),birthDate:t.get("birthDate"),notes:t.get("notes"),establishmentId:m.establishmentId};try{await Rr(s),g("Sucesso","Cliente salvo!","success"),document.getElementById("genericModal").style.display="none",ge()}catch(r){g("Erro","Erro ao salvar cliente","error"),console.error(r)}},Xi=async()=>{if(await H("Excluir","Tem certeza? Isso apagará o histórico deste cliente."))try{const e=P.currentClient.id||xs(P.currentClient.phone);await Ya(e),g("Sucesso","Cliente removido","success"),document.getElementById("genericModal").style.display="none",setTimeout(()=>ge(),500)}catch(e){g("Erro","Erro ao remover","error"),console.error(e)}},Ss=()=>{const e=document.getElementById("clients-grid");if(e){if(e.innerHTML="",P.clients.length===0){e.innerHTML=`
    ...
    `,t.querySelector("#change-password-form").addEventListener("submit",async o=>{o.preventDefault();const s=t.querySelector("#newPassword").value,r=t.querySelector("#confirmPassword").value;if(s!==r){g("Erro","As senhas não coincidem.","error");return}const a=t.querySelector('button[form="change-password-form"]');a.disabled=!0,a.textContent="A Salvar...";try{const n=V.currentUser;if(n)await As(n,s),g("Sucesso","Senha alterada com sucesso!","success"),o.target.reset();else throw new Error("Nenhum usuário autenticado encontrado.")}catch(n){g("Erro",`Não foi possível alterar a senha: ${n.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar Nova Senha"}})}function ol(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async o=>{o.preventDefault();const s=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!s||!r){g("Erro","Preencha todos os campos.","error");return}const a=t.querySelector('button[form="change-email-form"]');a.disabled=!0,a.textContent="A verificar...";try{const n=V.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=Bs.credential(n.email,r);await Ds(n,i),a.textContent="A enviar link...",await Ms(n,s),a.textContent="A atualizar BD...",await rr(m.establishmentId,s),g("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),o.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,g("Erro",i,"error")}finally{a.disabled=!1,a.textContent="Salvar Novo E-mail"}})}function al(e,t){const o=b(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#loyaltyEnabled").checked=o.enabled||!1;const n=t.querySelectorAll('input[name="loyaltyType"]'),i=t.querySelector("#loyalty-config-amount"),l=t.querySelector("#loyalty-config-visit");n.forEach(u=>{u.addEventListener("change",p=>{const f=p.target.value;n.forEach(h=>{const v=h.closest("label");h.checked?v.classList.add("border-indigo-500","bg-indigo-50","ring-1","ring-indigo-500"):v.classList.remove("border-indigo-500","bg-indigo-50","ring-1","ring-indigo-500")}),f==="amount"?(i.classList.remove("hidden"),l.classList.add("hidden")):(i.classList.add("hidden"),l.classList.remove("hidden"))})});const d=t.querySelector("#loyaltyTiersContainer"),c=(u={})=>{const p=document.createElement("div"),f=b(u.reward||"");return p.className="loyalty-tier-row group bg-white md:bg-transparent p-3 md:p-0 border md:border-0 rounded-lg shadow-sm md:shadow-none relative",p.innerHTML=`
    ...
    `;try{const[o,s]=await Promise.all([Po(m.establishmentId),Bo(m.establishmentId)]),r=e.financialIntegration||{},a=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ce(o,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ce(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ce(o,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ce(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ce(o,a.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ce(s,a.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",o=>{o.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};ze(s,o)})}function ll(e,t){const o="5516997859430",s=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${o}?text=${s}`;t.innerHTML=`
    ...
    `,xe.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),Is()});const o=document.getElementById("settings-content-detail");switch(e){case"personal-data":el(W,o);break;case"change-password":tl(W,o);break;case"change-email":ol(W,o);break;case"branding":al(W,o);break;case"booking":sl(W,o);break;case"working-hours":rl(W,o);break;case"loyalty":nl(W,o);break;case"financial":await il(W,o);break;case"support":ll(W,o);break;case"cancellation":dl(W,o);break;default:cl(t?t.label:"Definições",o)}}async function Is(){if(xe.innerHTML=`
        ...
        <div data-action="go-to-my-profile" class="bg-white p-4 rounded-lg shadow-md mb-6 cursor-pointer hover:bg-gray-50 transition-all">
            <div class="text-center relative">
                ...
                <div class="absolute top-0 right-0 p-2 text-gray-400 hover:text-indigo-600" title="Ver Meu Perfil">
                 ...
                 ${m.userName&&m.userName!==V.currentUser.email?`<p class="text-sm text-gray-500">${b(V.currentUser.email)}</p>`:""}
    ...
    `,xe.querySelector("#settings-menu-list").addEventListener("click",a=>{const n=a.target.closest("button[data-section]");n&&(a.preventDefault(),ml(n.dataset.section))});const r=xe.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",a=>{a.preventDefault(),ee("my-profile-section")})}const tt=document.getElementById("content");async function Ne(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const o=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await zt(m.establishmentId,o||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),a=document.getElementById("filterReason")?.value.toLowerCase(),n=a?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(a)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${b(l)} (${d.length})</h4>`;if(d.length>1){const f=JSON.stringify(d.map(h=>h.id));p+=`<button data-action="batch-delete-blockage" data-ids='${f}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",c.innerHTML=p,d.forEach(f=>{const h=new Date(f.startTime),v=new Date(f.endTime),w=h.toLocaleDateString("pt-BR"),x=v.toLocaleDateString("pt-BR"),k=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${w===x?`${w} | ${h.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${w} às ${h.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${x} às ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;c.innerHTML+=k}),t.appendChild(c)})}catch(o){t.innerHTML=`<p class="text-center text-red-500">Erro: ${o.message}</p>`}}}async function pl(e){e.preventDefault();const t=e.target,o=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||s,a=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:m.establishmentId,professionalId:o,startTime:new Date(`${s}T${a}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Vt(i),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),Ne(o)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function gl(e){e.preventDefault();const t=e.target,o=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(o.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||s,a=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=o.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${s}T${a}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Vt(u)});try{await Promise.all(d),g("Sucesso",`${o.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Ne(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function fl(e){tt.addEventListener("submit",t=>{t.target.id==="blockageForm"&&pl(t),t.target.id==="batchBlockageForm"&&gl(t)}),tt.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Ne(e)}),tt.addEventListener("click",async t=>{const o=t.target.closest("button[data-action]");if(!o)return;const s=o.dataset.action;if(s==="back-to-professionals")ee("profissionais-section");else if(s==="delete-blockage"){if(await H("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Eo(o.dataset.id),g("Sucesso","Bloqueio removido.","success"),Ne(e)}catch(a){g("Erro",`Não foi possível remover o bloqueio: ${a.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(o.dataset.ids);if(await H("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Ga(r),g("Sucesso",`${r.length} bloqueios removidos.`,"success"),Ne(e)}catch(n){g("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function bl(e){const{professionalId:t,professionalName:o}=e;if(!t||!o){tt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=b(o);tt.innerHTML=`
        <section>
        ...
        </section>`,fl(t),await Ne(t);const r=document.getElementById("batchProfSelectionContainer");try{const a=await Z(m.establishmentId);r.innerHTML=a.map(n=>`
            <div class="flex items-center">
    ...
    `}).join("")}async function xa(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let o=m.professionals;if(!o||o.length===0)try{o=await Z(m.establishmentId),m.professionals=o}catch{g("Erro","Não foi possível carregar a lista de profissionais.","error")}const s=x=>o.find(S=>S.id===x),r=(x,S)=>{const E=s(x)?.photo,L=S.charAt(0).toUpperCase();return{photoSrc:E||`https://placehold.co/128x128/E2E8F0/4A5568?text=${L}`,initials:L,photoUrl:E||""}},a=e?.professionalId,n=e?.name||"Novo Usuário",i=r(a,n),l=s(a),d=x=>{let S='<option value="">-- Não Associado a um Profissional --</option>';return S+=o.map(k=>`<option value="${k.id}" ${k.id===x?"selected":""}>${k.name} (${k.specialty||"N/A"})</option>`).join(""),S},c=e!==null;t.querySelector("#userFormTitle").textContent=c?`Editar Usuário: ${e.name}`:"Novo Usuário";const u=t.querySelector("#userForm");u.innerHTML=`
    ...
    `;const p=window.innerWidth<768,f=u.querySelector(".bg-white");if(p&&f){f.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const x=u.closest("section");x&&(x.style.padding="0",x.style.margin="0"),f.classList.add("p-4")}const h=u.querySelector("#userProfessionalId"),v=u.querySelector("#userPhotoPreview"),w=u.querySelector("#profPhotoName");if(h.addEventListener("change",x=>{const S=x.target.value,k=s(S),E=k?k.name:"Selecione um profissional",L=r(S,n);v.src=L.photoSrc,w.textContent=E,u.querySelector("#professionalPhotoUrl").value=L.photoUrl}),u.addEventListener("submit",async x=>{x.preventDefault();const S=e?.email,k=u.querySelector("#userEmail").value,E={};u.querySelectorAll('input[type="checkbox"]').forEach(F=>{const T=F.dataset.module,B=F.dataset.permission;E[T]||(E[T]={}),E[T][B]=F.checked});const L=u.querySelector("#userProfessionalId").value||null,N={name:u.querySelector("#userName").value,permissions:E,professionalId:L,establishmentId:m.establishmentId};try{c?(S!==k&&(N.email=k),await xl(e.id,N),g("Usuário atualizado com sucesso!","success")):(N.email=u.querySelector("#userEmail").value,N.password=u.querySelector("#userPassword").value,await hl(N),g("Usuário criado com sucesso!","success")),Mt()}catch(F){g(`Erro: ${F.message}`,"error")}}),c){const x=u.querySelector("#password-change-container"),S=x.querySelector('[data-action="show-password-form"]'),k=x.querySelector("#password-form"),E=k.querySelector('[data-action="save-password"]'),L=k.querySelector('[data-action="cancel-password-change"]');S.addEventListener("click",()=>{S.classList.add("hidden"),k.classList.remove("hidden")}),L.addEventListener("click",()=>{S.classList.remove("hidden"),k.classList.add("hidden"),k.querySelector("#userNewPassword").value=""}),E.addEventListener("click",async()=>{const N=k.querySelector("#userNewPassword").value;if(!N||N.length<6){g("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await H("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{E.disabled=!0,E.textContent="Aguarde...",await wl(e.id,N),g("Sucesso!","A senha do usuário foi alterada.","success"),S.classList.remove("hidden"),k.classList.add("hidden"),k.querySelector("#userNewPassword").value=""}catch(T){g("Erro",`Não foi possível alterar a senha: ${T.message}`,"error")}finally{E.disabled=!1,E.textContent="Salvar Nova Senha"}})}}async function Cl(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,o]=await Promise.all([vl(m.establishmentId),Z(m.establishmentId)]);m.users=t,m.professionals=o,Et()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Mt(){ve.innerHTML=`
    ...
    `}).join(""),a.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ho.transactions[l];d&&wa(d)})}),n.innerHTML=o.map((i,l)=>{const d=b(i.client),c=b(i.items),u=b(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ho.transactions[l];d&&wa(d)})})}async function ka(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),o=document.getElementById("reportEndDate");if(!e||!t||!o)return;const s=t.value,r=o.value;if(!s||!r)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const a=document.getElementById("cashierSessionFilter").value,n=await Nr({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:a});ho=n,e.innerHTML=`
        ...
        `,Bl(n)}catch(a){g("Erro",`Não foi possível carregar o relatório: ${a.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${b(a.message)}</p>`}}async function Dl(){Tl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const o=t.toISOString().split("T")[0];Ll.innerHTML=`
        ...
        </div>`,t.style.display="flex";const i=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const p=Fo(u);Nl(i,p,e);const f=l.value;l.innerHTML='<option value="">-- Categoria Principal --</option>';const h=(v,w=0)=>{const x="  ".repeat(w)+(w>0?"↳ ":"");l.innerHTML+=`<option value="${v.id}">${x}${v.name}</option>`,v.children.forEach(S=>h(S,w+1))};p.forEach(v=>h(v)),l.value=f};try{const u=await r(m.establishmentId);M[n]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const p=t.querySelector("#itemName").value,f=l.value;try{await a({name:p,parentId:f||null,establishmentId:m.establishmentId});const h=await r(m.establishmentId);M[n]=h,d(h),c.reset(),await Ve(),g("Sucesso","Item adicionado.","success")}catch(h){g("Erro",h.message,"error")}})}async function ql(){Rl(),jl(),await Ve()}function Rl(){Ml.innerHTML=`
    ...
    `}function Cs(){const e=document.getElementById("list-container");if(!e)return;const t=M.currentTab==="receivables",o=t?M.receivables:M.payables;let s=o;if(M.statusFilter!=="all"&&(s=o.filter(n=>n.status===M.statusFilter)),s.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),s.length===0){e.innerHTML=`
        ...
        `}).join("")}async function Ol(e,t){const o=new Date().toISOString().split("T")[0];try{await(e==="payable"?On(t,o):Wn(t,o)),g("Sucesso","Lançamento baixado!","success"),await Ve()}catch(s){g("Erro",s.message,"error")}}async function zl(e,t){if(await H("Excluir Lançamento","Tem certeza? Essa ação não pode ser desfeita."))try{await(e==="payable"?Hn(t):_n(t)),g("Sucesso","Lançamento excluído.","success"),await Ve()}catch(s){g("Erro",s.message,"error")}}async function Vl(e,t){const s=e==="nature"?An:qn;if(await H("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await s(t),xo(e==="nature"?"nature":"cost-center")}catch(a){g("Erro",a.message,"error")}}function Ul(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function to(e,t=null){const o=document.getElementById("genericModal"),s=e==="payable",r=`${t?"Editar":"Nova"} ${s?"Despesa":"Receita"}`,a=s?"red":"green",n=(u,p)=>{let f='<option value="">-- Selecione --</option>';const h=Fo(u),v=(w,x=0)=>{const S="  ".repeat(x)+(x>0?"↳ ":""),k=w.id===p?"selected":"";f+=`<option value="${w.id}" ${k}>${S}${w.name}</option>`,w.children.forEach(E=>v(E,x+1))};return h.forEach(w=>v(w)),f};o.innerHTML=`
    ...
    `}const oo=document.getElementById("content");let ke={allPackages:[],catalogForModal:{services:[],products:[]}},vt=null,De=null;function dd(e=6){let t="";for(let o=0;o<e;o++)t+=`
        ...
        `;return t}function cd(){const e=document.getElementById("packagesListContainer");if(e){if(ke.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=ke.allPackages.map(t=>{const o=t.status==="active",s=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,a=t.originalPrice||0,n=a>r?a-r:0,i=a>0?(a-r)/a*100:0,l=b(t.name),d=b(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function Ea(){const e=document.getElementById("genericModal");e.style.display="none",De&&e.removeEventListener("click",De)}async function Ia(e=null){const t=document.getElementById("genericModal"),o=!!e,s=e?JSON.parse(JSON.stringify(e.items||[])):[],r=b(e?.name||""),a=b(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(f,h)=>{const v=h.querySelector("#originalPrice"),w=f.reduce((x,S)=>x+S.price*S.quantity,0);v&&(v.textContent=`R$ ${w.toFixed(2)}`)},p=f=>{f.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=f.map((h,v)=>{const w=h.type==="service",x=w?"Serviço":"Produto",S=w?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <span class="font-medium text-gray-800 truncate">${b(h.name)}</span>
                    </div>
            ...
            `}).join(""),u(f,t)};p(s),c.addEventListener("change",f=>{if(f.target.classList.contains("quantity-input")){const h=parseInt(f.target.dataset.index,10),v=parseInt(f.target.value,10);v>0&&s[h]&&(s[h].quantity=v,p(s))}}),c.addEventListener("click",f=>{if(f.target.classList.contains("remove-item-btn")){const h=parseInt(f.target.dataset.index,10);s.splice(h,1),p(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>ud(f=>{const h=s.find(v=>v.id===f.id&&v.type===f.type);h?h.quantity++:s.push({...f,quantity:1}),p(s)}),De&&t.removeEventListener("click",De),De=async f=>{const h=f.target.closest("button[data-action]");if(!h)return;const v=h.dataset.action;if(f.stopPropagation(),v==="close-modal"&&Ea(),v==="save-package"){const w=h,x={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce((S,k)=>S+k.price*k.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!x.name||!x.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(x.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}w.disabled=!0,w.textContent="A salvar...";try{o?await fn(x.id,x):(delete x.id,await gn(x)),g("Sucesso!",`Pacote ${o?"atualizado":"criado"} com sucesso.`,"success"),Ea(),await Oo()}catch(S){g("Erro",`Não foi possível salvar o pacote: ${S.message}`,"error"),w.disabled=!1,w.textContent="Salvar Pacote"}}},t.addEventListener("click",De)}function ud(e){let t="";const o=document.createElement("div");o.id="item-selection-modal",o.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=ke.catalogForModal.services.filter(h=>h.name.toLowerCase().includes(d)),u=ke.catalogForModal.products.filter(h=>h.name.toLowerCase().includes(d)),p=c.map(h=>`
            <button data-action="select-item" data-item-type="service" data-item-id="${h.id}" class="flex items-center gap-3 w-full p-3 bg-white border rounded-lg hover:bg-gray-50 transition">
                ...
                <span class="flex-grow text-left min-w-0 truncate">${b(h.name)}</span>
                <span class="font-semibold flex-shrink-0">R$ ${h.price.toFixed(2)}</span>
            </button>
        `).join("")||'<p class="text-xs text-gray-400 text-center p-4">Nenhum serviço encontrado.</p>',f=u.map(h=>`
    ...
    `,document.body.appendChild(o);const a=o.querySelector("#item-selection-list"),n=o.querySelector("#item-search-input"),i=()=>{o.remove()};r(a),n.addEventListener("input",()=>{t=n.value,r(a)}),o.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:p}=d.dataset,h=(ke.catalogForModal[u+"s"]||[]).find(v=>v.id===p);h&&(e({...h,type:u}),i())}else(c||l.target===o)&&i()})}async function Oo(){oo.innerHTML=`
    ...
    `,vt&&oo.removeEventListener("click",vt),vt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;H("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async a=>{if(a)try{await bn(r),g("Sucesso!","Pacote excluído.","success"),await Oo()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const o=t.dataset.action;if(o==="new-package")Ia(null);else if(o==="edit-package"){const s=JSON.parse(t.dataset.package);Ia(s)}},oo.addEventListener("click",vt);try{const[e,t,o]=await Promise.all([as(m.establishmentId),$e(m.establishmentId),Ht(m.establishmentId)]);ke.allPackages=e,ke.catalogForModal={services:t.filter(s=>s.active),products:o},cd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const md=document.getElementById("content");let pd=null;async function gd(){const e=b(m.userName||"Usuário"),t=b(V.currentUser?.email||"E-mail não disponível"),o=m.userName?m.userName.charAt(0):"U";md.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await fd()}async function fd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const o=await nr(t);pd=o,o.photo&&(document.getElementById("user-profile-avatar").src=o.photo);const s=b(o.name);e.innerHTML=`
            ...
            `,bd(o.id),document.getElementById("my-blocks-filter").addEventListener("change",a=>Rt(o.id,a.target.value)),Rt(o.id,"future")}else e.innerHTML=`
