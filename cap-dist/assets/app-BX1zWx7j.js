import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as Y,d as _}from"./firebase-config-BCzB3QOS.js";import{EmailAuthProvider as fs,reauthenticateWithCredential as vs,verifyBeforeUpdateEmail as hs,updatePassword as xs,updateProfile as ys,onAuthStateChanged as ws,signOut as Ua}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{addDoc as Po,collection as pe,query as Ft,where as at,getDocs as Ea,orderBy as Mo,writeBatch as Ao,doc as $e,serverTimestamp as _a,deleteDoc as ks,updateDoc as No,getDoc as Ss,onSnapshot as $s}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";const m={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Es(e,t,a){m.establishmentId=e,m.establishmentName=t,m.userPermissions=a}const ca="https://kairos-app-407358446276.us-central1.run.app";console.log("🚀 API configurada para Produção (US):",ca);async function Is(){const e=Y.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function y(e,t={}){const a=await Is();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=ca.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,o=`${s}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${o}`);try{const n=await fetch(o,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ca}. Verifique sua conexão com a internet.`):n}}const qo=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),y(r)},Cs=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return y(s)},Ls=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return y(r)},Ts=e=>y("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Ia=(e,t)=>y(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Bs=e=>y(`/api/appointments/${e}`,{method:"DELETE"}),Ds=e=>y(`/api/appointments/${e}/reopen`,{method:"POST"}),Ps=(e,t)=>y(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let z;async function Ms(){if(!z)try{z=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function As(){if(!z){console.warn("AudioContext não inicializado. O som não será tocado.");return}z.state==="suspended"&&z.resume();const e=z.createOscillator(),t=z.createGain();e.connect(t),t.connect(z.destination),e.type="sine",e.frequency.setValueAtTime(800,z.currentTime),t.gain.setValueAtTime(0,z.currentTime),t.gain.linearRampToValueAtTime(.3,z.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,z.currentTime+.2),e.start(z.currentTime),e.stop(z.currentTime+.2)}function g(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&As();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function Rt(e){const t=document.getElementById(e);t&&(t.style.display="none")}function Ns(){document.body.addEventListener("click",()=>{z||Ms()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const s=t.dataset.target;if(s){const r=document.getElementById(s);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}async function Ja(){const e=document.getElementById("cancellationListContainer");if(!e)return;e.innerHTML='<div class="loader mx-auto"></div>';const t=document.getElementById("cancelStartDate").value,a=document.getElementById("cancelEndDate").value;try{const s=await Cs(m.establishmentId,t,a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}e.innerHTML=s.map(r=>`
        ...
        `).join("")}catch(s){e.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${s.message}</p>`}}function qs(){const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const s=`
    ...
    `,{modalElement:r}=J({title:"Histórico de Cancelamentos",contentHTML:s,maxWidth:"max-w-3xl"});r.querySelector("#searchCancellationsBtn").addEventListener("click",Ja),Ja()}const G=document.getElementById("sidebar"),Wa=document.getElementById("sidebarToggle"),Ge=document.getElementById("mainContent"),Fs=document.querySelectorAll(".sidebar-link"),Ga=document.getElementById("hamburger-menu-btn"),qe=document.getElementById("mobile-overlay");function kt(e){!G||!Ge||(G.classList.toggle("collapsed",e),Ge.classList.toggle("sidebar-collapsed-shift",e))}function Rs(){!G||!qe||(G.classList.add("mobile-open"),qe.classList.add("visible"))}function ut(){!G||!qe||(G.classList.remove("mobile-open"),qe.classList.remove("visible"))}function js(){kt(!G.classList.contains("collapsed"))}function Hs(e,t,a){if(!G||!Ge)return;Ge.classList.add("main-content-shift"),window.innerWidth>=768?kt(G.classList.contains("collapsed")):(Ge.classList.remove("main-content-shift","sidebar-collapsed-shift"),ut()),Wa&&Wa.addEventListener("click",r=>{r.stopPropagation(),js()}),G.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&G.classList.contains("collapsed")&&kt(!1)}),G.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||kt(!0))}),Ga&&Ga.addEventListener("click",r=>{r.stopPropagation(),Rs()}),qe&&qe.addEventListener("click",r=>{r.stopPropagation(),ut()});let s=0;G.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),G.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&ut()},{passive:!0}),Fs.forEach(r=>{const o=r.getAttribute("data-target"),n=o.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[o]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),o&&typeof e=="function"&&e(o),window.innerWidth<768&&ut()})})}const Ee=e=>{const t=e||m.establishmentId;return t?y(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},St=(e,t)=>{const a=e||m.establishmentId;return a?y(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Os=(e,t)=>{const a=e||m.establishmentId;return a?y(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},zs=(e,t)=>{const a=e||m.establishmentId;return a?y(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Q=e=>y(`/api/professionals/${e}`),Vs=e=>y(`/api/professionals/details/${e}`),Fo=e=>y("/api/professionals",{method:"POST",body:JSON.stringify(e)}),ua=(e,t)=>y(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Us=e=>y(`/api/professionals/${e}`,{method:"DELETE"}),Ie=e=>y(`/api/services/${e}`),Ro=e=>y("/api/services",{method:"POST",body:JSON.stringify(e)}),_s=(e,t)=>y(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Js=e=>y(`/api/services/${e}`,{method:"DELETE"}),Ws=(e,t)=>y(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Gs=e=>y(`/api/services/stats/most-popular/${e}`),jt=e=>y(`/api/products/${e}`),jo=e=>y("/api/products",{method:"POST",body:JSON.stringify(e)}),Ys=(e,t)=>y(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),Qs=e=>y(`/api/products/${e}`,{method:"DELETE"}),Xs=(e,t)=>y(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),Zs=({startDate:e,endDate:t,productId:a,categoryId:s,establishmentId:r})=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),r&&o.append("establishmentId",r),y(`/api/products/stock-history/report?${o.toString()}`)},Ks={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function Ya(e,t,a){return new Promise((s,r)=>{const o=new FileReader;o.readAsDataURL(e),o.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const p=e.type==="image/png"&&t<500?"image/png":"image/jpeg";s(l.toDataURL(p,a))},i.onerror=l=>r(l)},o.onerror=n=>r(n)})}let me=null;const $t=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let X=0,Tt=[];async function er(){try{console.log("Iniciando verificação de Onboarding para ID:",m.establishmentId);const e=await Ee(m.establishmentId),t=await Q(m.establishmentId),a=await Ie(m.establishmentId);Tt=a||[];const s=e&&e.name&&(e.phone||e.address),r=e&&(e.logo||e.themeColor&&e.themeColor!=="indigo"),o=e&&e.slotInterval>0,n=a&&a.length>0,i=t&&t.length>0;if(console.log("Status Onboarding:",{hasCompanyData:s,hasBranding:r,hasTimeConfig:o,hasService:n,hasProf:i}),s&&o&&i&&n)return;if(!s)X=0;else if(!r&&!o)X=1;else if(!o)X=2;else if(!n)X=3;else if(!i)X=4;else if(X===0)return;tr(),La(X)}catch(e){console.error("Erro ao verificar onboarding:",e)}}function tr(){document.getElementById("onboarding-overlay")||(me=document.createElement("div"),me.id="onboarding-overlay",me.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",me.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",me.innerHTML=`
    ...
    `,document.body.appendChild(me),Ca())}function Ca(){const e=Math.round(X/$t.length*100),t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width=`${e}%`),a&&(a.innerText=`${e}%`)}function La(e){const t=document.getElementById("onboarding-step-content"),a=$t[e];if(!a){Qa(t);return}let s="";if(a.id==="company_data")s=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(Ks).map(([o,n])=>`<option value="${o}">${n.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>ar(a.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===$t.length-1?Qa(t):(X++,Ca(),La(X))}),a.id==="branding"){const r=document.getElementById("logo-input"),o=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Ya(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),o&&(o.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Ya(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Qa(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{me&&me.remove(),window.location.reload()}}async function ar(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),s=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),o=Object.fromEntries(r.entries());try{if(e==="company_data")await St(m.establishmentId,{name:o.name,phone:o.phone,email:o.email,address:o.address,zipCode:o.zipCode});else if(e==="branding"){const n={};o.logoBase64&&(n.logo=o.logoBase64),o.bgBase64&&(n.backgroundImage=o.bgBase64),o.themeColor&&(n.themeColor=o.themeColor),o.primaryColor&&(n.primaryColor=o.primaryColor),Object.keys(n).length>0&&await St(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(o.slotInterval);await St(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Ro({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.price),duration:parseInt(o.duration),active:!0});n&&Tt.push(n)}else if(e==="first_prof"){const n=await Fo({establishmentId:m.establishmentId,name:o.name,specialty:o.role,active:!0,commissionRate:0});if(o.serviceId&&n&&n.id)try{ua&&await ua(n.id,{services:[o.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await jo({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.salePrice),stock:parseInt(o.stock),active:!0});g("Sucesso","Passo concluído!","success"),X++,Ca(),La(X)}catch(n){g("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=s}}var Fe;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Fe||(Fe={}));class Xt extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const or=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},sr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:or(e),o=()=>r()!=="web",n=u=>{const p=d.get(u);return!!(p?.platforms.has(r())||i(u))},i=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,p={})=>{const b=d.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const f=r(),h=i(u);let w;const S=async()=>(!w&&f in p?w=typeof p[f]=="function"?w=await p[f]():w=p[f]:t!==null&&!w&&"web"in p&&(w=typeof p.web=="function"?w=await p.web():w=p.web),w),I=(L,T)=>{var A,q;if(h){const O=h?.methods.find(M=>T===M.name);if(O)return O.rtype==="promise"?M=>a.nativePromise(u,T.toString(),M):(M,W)=>a.nativeCallback(u,T.toString(),M,W);if(L)return(A=L[T])===null||A===void 0?void 0:A.bind(L)}else{if(L)return(q=L[T])===null||q===void 0?void 0:q.bind(L);throw new Xt(`"${u}" plugin is not implemented on ${f}`,Fe.Unimplemented)}},E=L=>{let T;const A=(...q)=>{const O=S().then(M=>{const W=I(M,L);if(W){const Ce=W(...q);return T=Ce?.remove,Ce}else throw new Xt(`"${u}.${L}()" is not implemented on ${f}`,Fe.Unimplemented)});return L==="addListener"&&(O.remove=async()=>T()),O};return A.toString=()=>`${L.toString()}() { [capacitor code] }`,Object.defineProperty(A,"name",{value:L,writable:!1,configurable:!1}),A},k=E("addListener"),C=E("removeListener"),F=(L,T)=>{const A=k({eventName:L},T),q=async()=>{const M=await A;C({eventName:L,callbackId:M},T)},O=new Promise(M=>A.then(()=>M({remove:q})));return O.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await q()},O},H=new Proxy({},{get(L,T){switch(T){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?F:k;case"removeListener":return C;default:return E(T)}}});return s[u]=H,d.set(u,{name:u,proxy:H,platforms:new Set([...Object.keys(p),...h?[f]:[]])}),H};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Xt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},rr=e=>e.Capacitor=sr(e),ot=rr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ta=ot.registerPlugin;class Ho{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new ot.Exception(t,Fe.Unimplemented)}unavailable(t="not available"){return new ot.Exception(t,Fe.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Xa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Za=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class nr extends Ho{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Za(r).trim(),o=Za(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Xa(t.key),s=Xa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ta("CapacitorCookies",{web:()=>new nr});const ir=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),lr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},dr=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,cr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=lr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class ur extends Ho{async request(t){const a=cr(t,t.webFetchExtra),s=dr(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await ir(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const c={};return o.headers.forEach((u,p)=>{c[p]=u}),{data:l,headers:c,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ta("CapacitorHttp",{web:()=>new ur});const le=Ta("PushNotifications",{}),mr=(e,t,a="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),y(`/api/reports/indicators?${r.toString()}`)},pr=e=>e?y(`/api/financial/cost-centers/${e}`):Promise.resolve([]),gr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),y(`/api/reports/sales?${r.toString()}`)},br=()=>y("/api/reports/summary",{method:"GET"}),Ht=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return y(r)},Ot=e=>y("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Ba=e=>y(`/api/blockages/${e}`,{method:"DELETE"}),Oo=e=>y("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),zt=e=>y(`/api/clients/${e}`),Da=e=>y("/api/clients",{method:"POST",body:JSON.stringify(e)}),fr=(e,t)=>y(`/api/clients/${e}`,{method:"PUT",body:JSON.stringify(t)}),vr=e=>y(`/api/clients/${e}`,{method:"DELETE"}),Ka=(e,t,a)=>{const s=`/api/clients/history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return y(s)},hr=(e,t,a)=>{const s=`/api/clients/loyalty-history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return y(s)},xr=(e,t,a,s)=>y("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientName:t,clientPhone:a,rewardData:s})});function v(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}const eo=document.getElementById("content");let to=!1;const ma=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let lt=[],Vt=[],st={},re=[],D={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},$={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function yr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function zo(e){const t=new Date(e);if(t.setHours(0,0,0,0),D.currentView==="week"&&D.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function Bt(){const e=document.getElementById("profSelectorContainer"),t=D.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let a=m.professionals.filter(o=>D.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=D.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",c=v(i),u=ma[0],p=o.id!=="all"&&m.professionalColors.get(o.id)||u,b=o.photo||`https://placehold.co/64x64/${p.main?.replace("#","")||"E0E7FF"}/${p.light?.replace("#","")||"4F46E5"}?text=${l}`,f=o.id==="all"?"#e0e7ff":p.light,h=o.id==="all"?"#4f46e5":p.main,S=`border: 3px solid ${n?p.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+p.border:"none"};`;return`
        ...
        `}).join("")}function wr(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function kr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(s.professionalId)||{},d=v(s.reason),c=v(s.professionalName),u=v(s.clientName),p=v(s.serviceName);if(s.type==="blockage")return`
                ...
                </div>`;const b=s.status==="completed",f=b?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",h=b?"Finalizado":"Aberto",w=JSON.stringify(s).replace(/'/g,"&apos;"),S=s.redeemedReward?.points>0,I=s.hasRewards&&!S,E=wr(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime);return`
            ...
            </div>`}).join("");t.innerHTML=`<div class="list-view-container">${a}</div>`}function Pa(){return window.innerWidth<768&&D.currentView==="week"?3:D.weekViewDays}function Sr(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"],s=zo(D.currentDate),r=Pa();let o=`<div class="grid divide-x divide-gray-200 min-h-[60vh]" style="grid-template-columns: repeat(${r}, minmax(0, 1fr));">`;for(let n=0;n<r;n++){const i=new Date(s);i.setDate(i.getDate()+n);const l=new Date,d=i.toDateString()===l.toDateString(),c=e.filter(p=>new Date(p.startTime).toDateString()===i.toDateString()).sort((p,b)=>new Date(p.startTime)-new Date(b.startTime));let u='<div class="p-1 space-y-2">';c.length>0?u+=c.map(p=>{const f=new Date(p.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),h=m.professionalColors.get(p.professionalId)||{bg:"#e5e7eb",border:"#9ca3af"},w=v(p.reason),S=v(p.professionalName),I=v(p.clientName),E=v(p.serviceName);if(p.type==="blockage")return`
        ...
        `}o+="</div>",t.innerHTML=o}function $r(){const e=m.allEvents.filter(t=>D.selectedProfessionalId==="all"||t.professionalId===D.selectedProfessionalId);D.currentView==="list"?kr(e):Sr(e)}async function ae(){const e=document.getElementById("agenda-view");if(!e)return;e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const s=document.getElementById("weekRange");if(s){if(D.currentView==="list")t=new Date(D.currentDate),t.setHours(0,0,0,0),a=new Date(D.currentDate),a.setHours(23,59,59,999),s.textContent=yr(t);else{const r=Pa();t=zo(new Date(D.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),s.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await qo(m.establishmentId,t.toISOString(),a.toISOString(),D.selectedProfessionalId==="all"?null:D.selectedProfessionalId),o=await Ht(m.establishmentId,t.toISOString(),a.toISOString(),D.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const n=o.map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=m.professionals?m.professionals.find(u=>u.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(m.allEvents=i,Bt(),$r(),D.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${D.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),D.scrollToAppointmentId=null}}catch(r){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',g("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"))}}}async function Er(){try{const[e,t,a,s]=await Promise.all([m.professionals&&m.professionals.length>0?Promise.resolve(m.professionals):Q(m.establishmentId),m.services&&m.services.length>0?Promise.resolve(m.services):Ie(m.establishmentId),re.length>0?Promise.resolve(re):zt(m.establishmentId),st.enabled!==void 0?Promise.resolve(null):Ee(m.establishmentId)]);(!m.professionals||m.professionals.length===0)&&(m.professionals=e||[]),(!m.services||m.services.length===0)&&(m.services=t||[]),re.length===0&&(re=a||[]),s&&(st=s.loyaltyProgram||{enabled:!1}),m.professionals.forEach((r,o)=>{m.professionalColors.set(r.id,ma[o%ma.length])}),Bt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function pa(e){e<1||e>4||($.step=e,ga(null,!0))}function Vo(e,t){const a=document.getElementById("multiServiceToggle"),s=a&&a.checked,r=t.classList.contains("selected"),o=$.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),o>-1&&$.data.selectedServiceIds.splice(o,1);else{if(!s){$.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),$.data.selectedServiceIds.push(e)}}function Uo(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const s=Vt.find(r=>r.id===e);$.data.professionalId=e,$.data.professionalName=s?s.name:"N/A"}function Ir(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(s=>s.classList.remove("selected")),t.classList.add("selected"),$.data.time=e)}async function ao(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=$.data.professionalId,s=$.data.selectedServiceIds,r=document.getElementById("apptDate").value;$.data.date=r;const o=s.reduce((n,i)=>{const l=lt.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${o} min`,o===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await Ls({establishmentId:m.establishmentId,professionalId:a,serviceIds:s,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[u,p]=c.split(":").map(Number);return u*60+p>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${$.data.time===d?"selected":""}`,c.textContent=d,c.addEventListener("click",()=>Ir(d,c)),t.appendChild(c)}),$.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${$.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function Cr(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:s}=$.data,{enabled:r,rewards:o,pointsPerCurrency:n}=st;if(!r||!t||!o||o.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const i=o.filter(d=>a>=d.points);let l=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",d=>{d.target.checked&&($.data.redeemedReward=null)})}async function Lr(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!$.data.time||$.data.selectedServiceIds.length===0||!$.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const s=$.data.selectedServiceIds.map(d=>{const c=lt.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,o]=$.data.time.split(":"),n=new Date(`${$.data.date}T${r}:${o}:00`),i={establishmentId:m.establishmentId,clientName:$.data.clientName,clientPhone:$.data.clientPhone,services:s,professionalId:$.data.professionalId,startTime:n.toISOString(),redeemedReward:$.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Ia(l,i):await Ts(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",ae()}catch(d){g(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function Tr(e){const t=$.data.clientName===e.name&&$.data.clientPhone===e.phone,a=v(e.name),s=v(e.phone);return`
    ...
    `}async function oo(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.toLowerCase().trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}const s=re.filter(r=>r.name.toLowerCase().includes(a)||r.phone.includes(a));if(s.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=s.map(Tr).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(r=>{r.addEventListener("click",o=>{const n=r.dataset.clientName,i=r.dataset.clientPhone,l=re.find(d=>d.phone===i&&d.name===n);if($.data.clientName=n,$.data.clientPhone=i,l){const d=st,c=Math.min(...(d?.rewards||[]).map(u=>u.points));$.data.clientLoyaltyPoints=l.loyaltyPoints||0,$.data.clientHasRewards=d.enabled&&c!==1/0&&$.data.clientLoyaltyPoints>=c}else $.data.clientHasRewards=!1,$.data.clientLoyaltyPoints=0;document.getElementById("apptClientName").value=n,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(d=>d.classList.remove("selected","border-blue-500")),r.classList.add("selected","border-blue-500")})})}async function Br(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),s={establishmentId:m.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!s.name||!s.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await Da(s),re.push({name:s.name,phone:s.phone,loyaltyPoints:0}),$.data.clientName=s.name,$.data.clientPhone=s.phone,$.data.clientHasRewards=!1,$.data.clientLoyaltyPoints=0,g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",pa(1)}catch(r){g(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function Dr(){J({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",Br)}function Pr(){Dr()}function Mr(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",s=`
    ...
    `;return{title:a,content:s}}function Ar(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${lt.map(s=>{const r=$.data.selectedServiceIds.includes(s.id),o=s.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=v(s.name);return`
    ...
    `;return{title:e,content:a}}function Nr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Vt.map(a=>{const s=$.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",o=v(a.name);return`
    ...
    `;return{title:e,content:t}}function qr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,s=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=$.data.date||s,o=v($.data.clientName),n=v($.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function Fr(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),s=lt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=$.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${o?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Vo(r.dataset.serviceId,r))})}function Rr(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),s=Vt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=$.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=v(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>Uo(r.dataset.professionalId,r))})}async function ga(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const o=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;$={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:o,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}}if(!m.services||!m.professionals||!re||st.enabled===void 0){g("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(lt=m.services,Vt=m.professionals.filter(o=>o.status==="active"),$.data.clientName&&$.data.clientPhone){const o=re.find(n=>n.phone===$.data.clientPhone&&n.name===$.data.clientName);o&&($.data.clientLoyaltyPoints=o.loyaltyPoints||0)}let s={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch($.step){case 1:s=Mr(e);break;case 2:s=Ar();break;case 3:s=Nr();break;case 4:s=qr(e);break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>{o.addEventListener("click",()=>{const n=parseInt(o.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if($.data.clientName=i.value.trim(),$.data.clientPhone=l.value.trim(),!$.data.clientName||!$.data.clientPhone)return g("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if($.data.selectedServiceIds.length===0)return g("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!$.data.professionalId)return g("Atenção","Selecione um profissional.","error");pa(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>{o.addEventListener("click",()=>pa(parseInt(o.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if($.step===4&&r&&r.addEventListener("submit",Lr),a.style.display="flex",$.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Vo(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>Fr(i.target.value))}if($.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>Uo(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>Rr(i.target.value))}if($.step===1){const o=a.querySelector("#clientSearchInput");o&&(o.addEventListener("input",i=>oo(i.target.value)),$.data.clientName&&$.data.clientPhone&&oo(`${$.data.clientName} ${$.data.clientPhone}`));const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Pr)}if($.step===4){const o=a.querySelector("#apptDate");o&&o.addEventListener("change",ao),ao(),Cr()}}async function _o(e={}){D.currentDate=e.targetDate?new Date(e.targetDate):D.currentDate||new Date,D.scrollToAppointmentId=e.scrollToAppointmentId||null,D.profSearchTerm="",window.innerWidth<768&&(D.currentView="list"),eo.innerHTML=`
        <section>
        ...
        </section>`,document.querySelectorAll(".view-btn[data-view]").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(r=>r.classList.remove("active")),a.classList.add("active"),D.currentView=a.dataset.view;const s=document.getElementById("week-days-toggle");if(D.currentView==="week"){if(s.style.display="flex",window.innerWidth<768){D.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(o=>o.classList.remove("active"));const r=document.querySelector('.week-days-btn[data-days="3"]');r&&r.classList.add("active")}}else s.style.display="none";ae()})}),document.querySelectorAll(".week-days-btn").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"),D.weekViewDays=parseInt(a.dataset.days,10),ae()})}),document.getElementById("todayBtn").addEventListener("click",()=>{D.currentDate=new Date,ae()});const t=a=>{const s=parseInt(a.currentTarget.dataset.amount,10),r=D.currentView==="week"?Pa():1,o=new Date(D.currentDate);o.setDate(o.getDate()+s*r),D.currentDate=o,ae()};document.getElementById("prevBtn").addEventListener("click",t),document.getElementById("nextBtn").addEventListener("click",t),document.getElementById("profSearchInput").addEventListener("input",a=>{D.profSearchTerm=a.target.value,Bt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",a=>{D.showInactiveProfs=a.target.checked,Bt(),ae()}),to||(eo.addEventListener("click",async a=>{const s=a.target.closest("[data-action]");if(a.target.closest('[data-action="select-professional"]')){const l=a.target.closest('[data-action="select-professional"]').dataset.profId,d=D.selectedProfessionalId===l&&l!=="all";if(D.selectedProfessionalId=d?"all":l,l!=="all"){const c=document.getElementById("profSearchInput");c&&(c.value=""),D.profSearchTerm=""}await ae();return}if(!s)return;const r=s.dataset.action;let o=null;const n=a.target.closest("[data-appointment]");switch(n&&(o=JSON.parse(n.dataset.appointment.replace(/&apos;/g,"'"))),r){case"new-appointment":ga();break;case"edit-appointment":if(!o)return;if(o.status==="completed"){g("Atenção","Agendamentos finalizados não podem ser editados.","error");return}o.hasRewards&&!o.redeemedReward&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),ga(o);break;case"delete-appointment":{const i=s.dataset.id;if(await j("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Bs(i),g("Agendamento apagado!","success"),ae()}catch(d){g(`Não foi possível apagar: ${d.message}`,"error")}break}case"open-comanda":if(o){o.hasRewards&&!o.redeemedReward&&o.status!=="completed"&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const i=o.status==="completed"?"finalizadas":"em-atendimento",l={selectedAppointmentId:o.id,initialFilter:i};if(i==="finalizadas"){let d=o.startTime;if(o.transaction&&o.transaction.paidAt){const c=o.transaction.paidAt;typeof c=="object"&&c._seconds?d=new Date(c._seconds*1e3):d=c}l.filterDate=d}ee("comandas-section",l)}break}}),to=!0),await Er(),await ae()}const jr=(e,t=null,a=1,s=12)=>{let r=`/api/comandas/${e}?page=${a}&limit=${s}`;return t&&(r+=`&date=${t}`),y(r)},Hr=e=>y("/api/sales",{method:"POST",body:JSON.stringify(e)}),Or=e=>y(`/api/sales/${e}/reopen`,{method:"POST"}),zr=e=>y(`/api/sales/${e}`,{method:"DELETE"}),Jo=()=>y("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),Vr=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),y("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Ur=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),y(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},_r=()=>y("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),Jr=e=>y(`/api/cashier/report/${e}`),Wo=e=>y(`/api/packages/${e}`),Wr=e=>y("/api/packages",{method:"POST",body:JSON.stringify(e)}),Gr=(e,t)=>y(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),Yr=e=>y(`/api/packages/${e}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},clients:[],activeFilter:"atendimento",selectedComandaId:null,isCashierOpen:!1,activeCashierSessionId:null,paging:{page:1,limit:12,total:0}},Le=null,Be=null;function Ut(e){if(e.status==="completed"){const r=e.comandaItems||e.items||[];return r.length>0?r:e.services||[]}const t=e.services||[],a=[...e.comandaItems||[],...e.items||[]];let s=[...t];return a.forEach(r=>{if(r.type==="product"){s.push(r);return}s.some(n=>{const i=n.id&&r.id&&n.id===r.id,l=n.name&&r.name&&n.name===r.name;return i||l})||s.push(r)}),s}function Qr(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function xe(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function Xr(){const e=new Date().toISOString().split("T")[0];Be.innerHTML=`
    ...
    `}function Zr(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `:e.innerHTML=`
            ...
            <button data-action="view-sales-report" class="py-2 px-4 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 text-sm">Relatório</button>
        `)}function ge(){const e=document.getElementById("comandas-list");if(!e)return;if(!x.isCashierOpen&&x.activeFilter==="atendimento"){e.innerHTML=`
        ...
        `;return}const a={atendimento:"confirmed",finalizadas:"completed"}[x.activeFilter],s=x.allComandas.filter(r=>r.status===a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',so(e);return}e.innerHTML=s.map(r=>{const n=Ut(r).reduce((b,f)=>b+(f.price||0),0),i=r.id===x.selectedComandaId,l=new Date(r.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=r.type==="walk-in"||r.id.startsWith("temp-"),c=v(r.clientName),u=v(r.professionalName),p=d?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md">Agendado</span>';return`
    ...
    `;if(!x.isCashierOpen){e.innerHTML=`
        ...
        `;return}const s=Ut(a),r=a.status==="completed",o=a.type==="walk-in"||a.id.startsWith("temp-"),n=o?"":`<button data-action="go-to-appointment" data-id="${a.id}" data-date="${a.startTime}" 
           ...
           </button>`,i=s.reduce((u,p)=>{const b=`${p.type}-${p.id||p.name}`;return u[b]||(u[b]={...p,quantity:0}),u[b].quantity+=1,u},{}),l=Object.values(i).reduce((u,p)=>u+(p.price||0)*p.quantity,0),d=v(a.clientName),c=v(a.professionalName);e.innerHTML=`
    ...
    `}function Kr(){J({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",en)}async function en(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector('button[type="submit"]'),s={establishmentId:m.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim()||null,phone:t.querySelector("#regClientPhone").value.trim(),dob:`${t.querySelector("#regClientDobDay").value.trim()}/${t.querySelector("#regClientDobMonth").value.trim()}`,notes:t.querySelector("#regClientNotes").value.trim()||null};if(!s.name||!s.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{const r=await Da(s);x.clients.push({id:r.id,...s}),g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",Go(r.id)}catch(r){g(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar Cliente"}}function tn(){if(!x.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:e,close:t}=J({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{let r="";const o=e.querySelector("#add-item-content"),n={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},i=()=>{const l=r.toLowerCase(),d=u=>u.filter(p=>p.name.toLowerCase().includes(l)),c={"modal-service-list":{items:d(x.catalog.services),type:"service"},"modal-product-list":{items:d(x.catalog.products),type:"product"},"modal-package-list":{items:d(x.catalog.packages),type:"package"}};for(const[u,{items:p,type:b}]of Object.entries(c)){const f=o.querySelector(`#${u}`);f&&(f.innerHTML=p.map(h=>`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{o>1&&(o--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{o++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await nn(r,o),t()}};e.addEventListener("click",r=>{const o=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(o){const{itemType:i,itemId:l}=o.dataset,c=(x.catalog[i+"s"]||[]).find(u=>u.id===l);c&&s({...c,type:i})}else n&&a()}),a()}async function Go(e=null){if(!x.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!x.clients||x.clients.length===0)try{x.clients=await zt(m.establishmentId)}catch{g("Erro","Não foi possível carregar dados de clientes.","error");return}if(!m.professionals||m.professionals.length===0)try{m.professionals=await Q(m.establishmentId)}catch{g("Erro","Não foi possível carregar dados de profissionais.","error");return}const t=x.clients.map(n=>{const i=n.id===e?"selected":"";return`<option value="${n.id}" ${i}>${v(n.name)} - ${v(n.phone)}</option>`}).join(""),a=m.professionals.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""),s=`
    ...
    `,{modalElement:r}=J({title:"Nova Venda Avulsa",contentHTML:s,maxWidth:"max-w-md"});r.querySelector("#new-sale-form").addEventListener("submit",cn);const o=r.querySelector('[data-action="new-client-from-sale"]');o&&o.addEventListener("click",n=>{n.preventDefault(),r.style.display="none",Kr()})}function an(){if(!x.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const e=x.allComandas.find(u=>u.id===x.selectedComandaId);if(!e)return;const t=Ut(e),a=new Set,s=[];for(const u of t){if(u.type==="service"&&u.id){if(a.has(u.id))continue;a.add(u.id)}s.push(u)}const r=s.reduce((u,p)=>u+(p.price||0),0);let o=[],n={remainingAmount:r,selectedMethod:"dinheiro",installments:1,amountReceived:""};const i=()=>{const u=document.getElementById("payment-list"),p=document.getElementById("remaining-amount"),b=document.getElementById("finalize-checkout-btn"),f=document.getElementById("change-container"),h=document.getElementById("installments-container"),w=document.getElementById("payment-value"),S=document.getElementById("payment-controls"),I=o.reduce((k,C)=>k+C.value,0);n.remainingAmount=r-I,u.innerHTML=o.map((k,C)=>`
    ...
    `,{modalElement:c}=J({title:"Finalizar Pagamento",contentHTML:d,maxWidth:"max-w-md"});document.getElementById("payment-value").value=n.remainingAmount.toFixed(2),c.addEventListener("click",u=>{const p=u.target.closest(".payment-method-btn");p&&(n.selectedMethod=p.dataset.method,n.installments=1,document.getElementById("installments-select").value=1,i()),u.target.closest("#add-payment-btn")&&l(),u.target.closest('[data-action="remove-payment"]')&&(o.splice(parseInt(u.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),i()),u.target.closest("#finalize-checkout-btn")&&dn(e,r,o)}),c.addEventListener("change",u=>{u.target.id==="installments-select"&&(n.installments=parseInt(u.target.value,10))}),c.addEventListener("input",u=>{u.target.id==="amount-received"&&(n.amountReceived=u.target.value,i())}),i()}async function on(){const e=`
    ...
    `,{modalElement:t}=J({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=document.getElementById("initial-amount"),r=s.value.trim(),o=document.getElementById("cashier-notes").value.trim(),n=parseFloat(r);if(r===""||isNaN(n)||n<0){g("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),s.focus();return}try{const i={establishmentId:m.establishmentId,initialAmount:parseFloat(n.toFixed(2))};o&&(i.notes=o);const l=await Vr(i);x.isCashierOpen=!0,x.activeCashierSessionId=l.id,await Ma(),document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto com valor inicial de R$ ${n.toFixed(2)}`,"success")}catch(i){g("Erro",`Não foi possível abrir o caixa: ${i.message}`,"error")}})}async function sn(){const e=x.activeCashierSessionId;if(e)try{const t=await Jr(e),a=`
        ...
        `,{modalElement:s}=J({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0){g("Valor Inválido","Insira um valor final válido.","error");return}try{await Ur(e,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await Ma(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){g("Erro",`Não foi possível fechar o caixa: ${n.message}`,"error")}})}catch(t){g("Erro",`Não foi possível carregar o relatório de fecho: ${t.message}`,"error")}}async function rn(e){x.activeFilter!==e&&(x.activeFilter=e,x.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),xe(),await se(),x.selectedComandaId=null,K())}function ba(e){x.selectedComandaId=e,ge(),Qr(),K()}async function nn(e,t){const a=x.allComandas.find(r=>r.id===x.selectedComandaId);if(!a)return;const s=Array(t).fill(0).map(()=>({id:e.id,name:e.name,price:e.price,type:e.type}));if(a.comandaItems=a.comandaItems||[],a.comandaItems.push(...s),a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),K(),ge();return}try{await Ia(a.id,a),g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),K(),ge()}catch(r){g("Erro",`Não foi possível adicionar o item: ${r.message}`,"error"),a.comandaItems.splice(a.comandaItems.length-t,t)}}async function ln(e,t){const a=x.allComandas.find(o=>o.id===x.selectedComandaId);if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>o.id===e&&o.type===t);if(r>-1)a.comandaItems.splice(r,1),s=!0;else{let o=(a.services||[]).findIndex(n=>n.id===e);if(o>-1)a.services.splice(o,1),s=!0;else{let n=(a.items||[]).findIndex(i=>i.id===e&&i.type===t);n>-1&&(a.items.splice(n,1),s=!0)}}if(s){if(a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso","Item removido!","success"),K(),ge();return}try{await Ia(a.id,a),g("Sucesso","Item removido!","success"),K(),ge()}catch(o){g("Erro",`Não foi possível remover o item: ${o.message}`,"error"),await se()}}}async function dn(e,t,a){const s=e.type==="appointment",r=Ut(e),o=new Set,n=[];for(const l of r){if(l.type==="service"&&l.id){if(o.has(l.id))continue;o.add(l.id)}n.push(l)}const i={payments:a,totalAmount:t,items:n,cashierSessionId:x.activeCashierSessionId};try{s?await Ps(e.id,i):(i.establishmentId=m.establishmentId,i.clientName=e.clientName,i.professionalId=e.professionalId,i.clientPhone=e.clientPhone,await Hr(i)),g("Sucesso!","Venda finalizada com sucesso!","success"),document.getElementById("genericModal").style.display="none",xe(),x.selectedComandaId=null,await se()}catch(l){g("Erro no Checkout",l.message,"error")}}async function cn(e){e.preventDefault();const t=document.getElementById("new-sale-client").value,a=document.getElementById("new-sale-professional").value,s=x.clients.find(n=>n.id===t),r=m.professionals.find(n=>n.id===a);if(!s||!r){g("Erro","Selecione um cliente e um profissional válidos.","error");return}const o={id:`temp-${Date.now()}`,type:"walk-in",clientName:s.name,clientPhone:s.phone,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(o),x.selectedComandaId=o.id,document.getElementById("genericModal").style.display="none",ba(o.id)}async function se(){const e=document.getElementById("comandas-list");e.innerHTML='<div class="loader mx-auto mt-10"></div>';const t=x.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=await Jo();if(x.isCashierOpen=!!a,x.activeCashierSessionId=a?a.id:null,Zr(),!x.isCashierOpen&&x.activeFilter==="atendimento"){ge(),K();return}const s=await jr(m.establishmentId,t,x.paging.page,x.paging.limit);if(x.allComandas=s.data||s,x.paging.total=s.total||s.length,x.catalog.services.length===0){const[r,o,n,i,l]=await Promise.all([Ie(m.establishmentId),jt(m.establishmentId),Wo(m.establishmentId),zt(m.establishmentId),Q(m.establishmentId)]);x.catalog={services:r,products:o,packages:n},x.clients=i,m.professionals=l}ge(),x.selectedComandaId,K()}catch(a){g("Erro de Carregamento",`Não foi possível carregar os dados: ${a.message}`,"error"),e.innerHTML=`<p class="text-red-500 p-4">${a.message}</p>`}}async function Ma(e={}){Be=document.getElementById("content");try{const t=await Jo();x.isCashierOpen=!!t,x.activeCashierSessionId=t?t.id:null}catch(t){console.error("Erro ao verificar caixa:",t),x.isCashierOpen=!1}x.selectedComandaId=e.selectedAppointmentId||null,Xr(),Le&&(Be.removeEventListener("click",Le),Be.removeEventListener("change",Le)),Le=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(t.target.id==="filter-date"&&x.activeFilter==="finalizadas"){x.paging.page=1,await se();return}if(a){if(a.matches("[data-filter]"))rn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}ba(a.dataset.comandaId)}else if(a.matches("[data-action]")){const s=a.dataset.action,r=a.dataset.id||x.selectedComandaId;switch(s){case"back-to-list":{xe(),x.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(o=>o.classList.remove("selected")),K();break}case"new-sale":Go();break;case"add-item":tn();break;case"checkout":an();break;case"open-cashier":on();break;case"close-cashier":await sn();break;case"view-sales-report":ee("sales-report-section");break;case"remove-item":await ln(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await j("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await Ds(r);const n=x.allComandas.findIndex(i=>i.id===r);n!==-1&&(delete x.allComandas[n].transaction,delete x.allComandas[n].cashierSessionId,delete x.allComandas[n].redeemedReward,x.allComandas[n].status="confirmed"),x.selectedComandaId=null,xe(),g("Sucesso!","Comanda reaberta para edição.","success"),await se()}catch(n){g("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"reopen-walk-in":{if(await j("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await Or(r),g("Sucesso!","Venda revertida."),xe(),x.selectedComandaId=null,await se()}catch(n){g("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"go-to-appointment":{const o=a.dataset.id,n=a.dataset.date;ee("agenda-section",{scrollToAppointmentId:o,targetDate:new Date(n)});break}case"delete-walk-in":{if(await j("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(r.startsWith("temp-"))x.allComandas=x.allComandas.filter(n=>n.id!==r),x.selectedComandaId=null,ge(),K(),g("Sucesso","Venda avulsa removida.","success"),xe();else try{await zr(r),g("Sucesso","Venda avulsa excluída com sucesso.","success"),x.selectedComandaId=null,xe(),await se()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}break}}}}},Be.addEventListener("click",Le),Be.addEventListener("change",Le),e.initialFilter&&(x.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(x.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${x.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",x.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await se(),x.selectedComandaId&&ba(x.selectedComandaId)}const fa=document.getElementById("content");let Zt={};const mt=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],N={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],currentTab:"dashboards"};async function un(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function mn(){fa.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">A carregar inteligência de dados...</p></div>';try{await un();const[e,t]=await Promise.all([Q(m.establishmentId),pr(m.establishmentId).catch(()=>[])]);N.professionalsList=e||[],N.costCentersList=t||[],pn(),await Yo()}catch(e){console.error("Erro no loadReportsPage:",e),fa.innerHTML=`
            ...
            </div>`}}function pn(){const e=N.professionalsList.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join(""),t=N.costCentersList.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join("");fa.innerHTML=`
    ...
    `,document.getElementById("btn-filter").onclick=gn,document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{N.currentTab=a.dataset.tab,ro(),Qo()}}),ro()}function ro(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===N.currentTab;e.className=t?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function gn(){N.startDate=document.getElementById("report-start").value,N.endDate=document.getElementById("report-end").value,N.selectedProfessional=document.getElementById("report-prof").value,N.selectedCostCenter=document.getElementById("report-cost").value,await Yo()}async function Yo(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const t=mr(N.startDate,N.endDate,N.selectedProfessional,N.selectedCostCenter),a=N.selectedProfessional==="all"?null:N.selectedProfessional,s=new Date(N.startDate+"T00:00:00").toISOString(),r=new Date(N.endDate+"T23:59:59").toISOString(),o=qo(m.establishmentId,s,r,a).catch(l=>[]),[n,i]=await Promise.all([t,o]);N.data=n,N.appointmentsData=Array.isArray(i)?i:[],Qo()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function Qo(){const e=document.getElementById("report-content");if(N.data)switch(N.currentTab){case"dashboards":bn(e);break;case"appointments":fn(e);break;case"dre":vn(e);break}}function bn(e){const{dreSimple:t,charts:a}=N.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0},r=N.data.totalAppointments||0,o=r>0?s.grossRevenue/r:0;e.innerHTML=`
    ...
    `,Je("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,mt[0]);const n=a.professionals.labels.map(l=>v(l));Je("chart-profs","doughnut","Total Vendas",n,a.professionals.data,mt),Je("chart-daily","line","Vendas Diárias",a.salesDaily.labels,a.salesDaily.data,mt[4]);const i=a.products.labels.map(l=>v(l));Je("chart-products","bar","Total Vendido",i,a.products.data,mt[1])}function fn(e){const t=N.appointmentsData,a=t.length;let s=0,r=0,o=0,n=0;const i={},l={};let d=new Date(N.startDate);const c=new Date(N.endDate);for(;d<=c;)i[d.toISOString().split("T")[0]]=0,d.setDate(d.getDate()+1);t.forEach(f=>{const h=parseFloat(f.totalAmount||f.price||0),w=(f.status||"").toLowerCase();let S=f.startTime?(f.startTime.toDate?f.startTime.toDate():new Date(f.startTime)).toISOString().split("T")[0]:"";const I=f.professionalName||"Sem Profissional";l[I]||(l[I]={name:I,count:0,value:0}),["cancelled","cancelado","no-show"].includes(w)?(r++,n+=h):(["completed","finalized","paid"].includes(w)&&s++,o+=h,S&&i.hasOwnProperty(S)&&i[S]++,l[I].count++,l[I].value+=h)});const u=Object.keys(i).sort(),p=u.map(f=>i[f]),b=Object.values(l).sort((f,h)=>h.count-f.count);e.innerHTML=`
    ...
    `,Je("dailyApptChart","line","Agendamentos",u.map(f=>f.split("-").reverse().slice(0,2).join("/")),p,"#4f46e5")}function vn(e){const{dreFinancial:t}=N.data,a=Object.entries(t.revenues).map(([r,o])=>`
    ...
    `}function Je(e,t,a,s,r,o){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");Zt[e]&&Zt[e].destroy();const l={type:t,data:{labels:s,datasets:[{label:a,data:r,backgroundColor:Array.isArray(o)?o:t==="line"?"rgba(79, 70, 229, 0.1)":o,borderColor:Array.isArray(o)?"#fff":o,borderWidth:2,fill:t==="line",tension:.3,borderRadius:t==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:o,pointHoverBackgroundColor:o}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let c=d.dataset.label||"";return c&&(c+=": "),d.parsed.y!==null?c+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):c+=d.raw,c}}}},scales:t==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};Zt[e]=new Chart(i,l)}const _t=(e,t="products")=>y(`/api/${t}/categories/${e}`),Xo=(e,t="products")=>y(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),Zo=(e,t="products")=>y(`/api/${t}/categories/${e}`,{method:"DELETE"}),hn="audit_logs",Re=async(e,t,a,s,r,o=null)=>{try{if(!t)return;await Po(pe(_,hn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:r,details:o,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},he=document.getElementById("content");let de=null,Ye="services",we="all";function je(){const e=Y.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function xn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Xo({establishmentId:m.establishmentId,name:s},"services"),Re(m.establishmentId,je(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",g("Sucesso","Categoria criada!","success"),await Aa(),await dt()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function yn(e){if(await j("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Zo(e,"services"),Re(m.establishmentId,je(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Aa(),await dt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Aa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function wn(){J({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),Na(),De()}function En(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function dt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,r]=await Promise.all([Ie(m.establishmentId),Q(m.establishmentId),_t(m.establishmentId,"services"),Gs(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(o=>{o.active===void 0&&(o.active=!0)}),Ko(Ye)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function Ko(e){if(document.getElementById("services-content-container")){if(Ye===e&&document.getElementById("services-content-container").children.length>1){Ye==="services"&&(Na(),De());return}Ye=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?$n():e==="reports"&&En()}}function In(){de&&(he.removeEventListener("click",de),he.removeEventListener("input",de),he.removeEventListener("change",de)),de=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),o=r.dataset.id,n=r.checked;try{await Ws(o,n);const i=m.services.findIndex(l=>l.id===o);i>-1&&(m.services[i].active=n),Re(m.establishmentId,je(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${o}) para ${n?"Ativo":"Inativo"}`),De(),Na()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,De()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){De();return}if(!a)return;if(a.hasAttribute("data-view")){Ko(a.dataset.view);return}switch(a.dataset.action){case"new-service":no();break;case"edit-service":const r=JSON.parse(a.dataset.service);no(r);break;case"manage-categories":wn();break;case"filter-service":const o=a.dataset.filterType;if(o==="popular")return;we=o==="total"?"all":o,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===we||i==="total"&&we==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),De();break}},he.addEventListener("click",de),he.addEventListener("input",de),he.addEventListener("change",de)}async function Cn(){he.innerHTML=`
        ...
        </section>`,In();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await Q(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Ye="services",we="all",await dt()}const Jt="suppliers",qa="purchases",es="financial_payables",Fa=async e=>{try{const t=Ft(pe(_,Jt),at("establishmentId","==",e)),a=await Ea(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Ln=async e=>{try{return{id:(await Po(pe(_,Jt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},Tn=async(e,t)=>{try{const a=$e(_,Jt,e);return await No(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Bn=async e=>{try{const t=$e(_,Jt,e);return await ks(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},Dn=async(e,t=null)=>{try{const a=Ao(_),s=$e(pe(_,qa)),r={...e,createdAt:_a()};if(a.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const o=$e(pe(_,es)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:_a()};a.set(o,i)}return await a.commit(),{id:s.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},Pn=async(e,t)=>{try{const a=Ao(_),s=$e(_,qa,e);a.delete(s);const r=Ft(pe(_,es),at("purchaseId","==",e),at("establishmentId","==",t));return(await Ea(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},Mn=async e=>{try{const t=Ft(pe(_,qa),at("establishmentId","==",e),Mo("createdAt","desc")),a=await Ea(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},be=document.getElementById("content");let ce=null,Qe="products",oe="all";async function An(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Xo({establishmentId:m.establishmentId,name:s},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Ra(),await ct()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Nn(e){if(await j("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Zo(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Ra(),await ct()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ra(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function qn(){J({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",An),t.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&Nn(r.dataset.id)}))}Ra()}async function Fn(e){if(!e)return;if(await j("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await Qs(e),g("Sucesso","Produto apagado com sucesso!","success"),await ct()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function Rn(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),s=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),o=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(o).map(l=>l.dataset.id),i={establishmentId:m.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(s)?0:s,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await Ys(t,i):await jo(i),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await ct()}catch(l){throw new Error(l.message)}}function io(e,t=800,a=800,s="image/jpeg",r=.8){return new Promise((o,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,u=d.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const p=document.createElement("canvas");p.width=c,p.height=u,p.getContext("2d").drawImage(d,0,0,c,u);const f=p.toDataURL(s,r);o(f)},d.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function lo(e=null){const t=document.getElementById("productModal"),a=m.categories||[],s=m.suppliers||[],r=a.map(L=>`<option value="${L.id}" ${e?.categoryId===L.id?"selected":""}>${v(L.name)}</option>`).join("");let o=new Set(e?.supplierIds||[]);const n=v(e?.name||""),i=e?.price||"",l=e?.costPrice||"",d=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,p=e?.currentStock||0,b=e?n:"Novo Produto";t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                `).join("")):(T.classList.remove("hidden"),T.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else T.classList.add("hidden");o.size>0?(A.innerHTML="",o.forEach(O=>{const M=s.find(W=>W.id===O);M&&(A.innerHTML+=`
                    ...
                    `)})):A.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};E.querySelector("#modalSupplierSearch").addEventListener("input",k),E.addEventListener("click",L=>{const T=L.target.closest("[data-add-supplier]");if(T){const q=T.dataset.addSupplier;o.add(q),E.querySelector("#modalSupplierSearch").value="",k()}const A=L.target.closest("[data-remove-supplier]");if(A){const q=A.dataset.removeSupplier;o.delete(q),k()}}),k(),E.addEventListener("click",async L=>{const T=L.target.closest("button[data-action]");if(!T)return;const A=T.dataset.action,q=E.querySelector("#productId").value;if(A==="close-modal"&&(E.style.display="none"),A==="delete-product"){if(!q)return;E.style.display="none",await Fn(q)}if(A==="save-product-modal"){const O=E.querySelector("#productForm");if(O){if(!O.querySelector("#productName").value||!O.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const M=T.closest('button[data-action="save-product-modal"]');M.disabled=!0,M.textContent="A salvar...";try{await Rn(O)}catch(W){g("Erro",`Falha ao salvar: ${W.message}`,"error"),M.disabled=!1,M.textContent="Salvar Alterações"}}}if(A==="adjust-stock-modal"){L.preventDefault();const O=E.querySelector("#stockAdjustmentAmount"),M=E.querySelector("#stockAdjustmentReason"),W=parseInt(O.value,10),Ce=parseInt(T.dataset.change,10);if(!W||W<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Qt=W*Ce,bs=M.value||(Qt>0?"Entrada manual":"Saída manual");try{await Xs(q,{change:Qt,reason:bs});const Oe=m.products.findIndex(ze=>ze.id===q);if(Oe>-1){const ze=m.products[Oe].currentStock+Qt;m.products[Oe].currentStock=ze,E.querySelector("#currentStockDisplay").textContent=ze,E.querySelector("#productCurrentStock").value=ze,O.value="",M.value="",g("Sucesso","Estoque atualizado!","success"),ja(),rt()}}catch(Oe){g("Erro de Stock",Oe.message,"error")}}});const C=E.querySelectorAll(".tab-btn"),F=E.querySelectorAll(".tab-content");C.forEach(L=>{L.addEventListener("click",T=>{T.preventDefault(),C.forEach(A=>{A.classList.remove("border-indigo-500","text-indigo-600"),A.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),L.classList.add("border-indigo-500","text-indigo-600"),L.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),F.forEach(A=>A.classList.add("hidden")),document.getElementById(`tab-content-${L.dataset.tab}`).classList.remove("hidden")})});const H=E.querySelector("#productPhotoInput");E.querySelector("#productPhotoButton").addEventListener("click",()=>H.click()),H.onchange=async()=>{const L=H.files[0];if(!L)return;const T=E.querySelector("#productPhotoPreview"),A=E.querySelector("#productPhotoBase64");T.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const q=await io(L,800,800,"image/jpeg",.8),M=q.length*3/4,W=1e3*1024;if(M>W)throw new Error("A imagem é muito grande mesmo após a compressão.");T.src=q,A.value=q}catch(q){console.error("Erro ao processar imagem:",q),g("Erro de Imagem",q.message||"Não foi possível processar a imagem.","error"),T.src=S,A.value=I,H.value=""}},E.style.display="flex"}function jn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),ja(),rt()}function Hn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),o=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join("")),o&&m.categories&&(o.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""))}async function On(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await Zs(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ct(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,s]=await Promise.all([jt(m.establishmentId),_t(m.establishmentId,"products"),Fa(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(s||[]).filter(Boolean),ts(Qe)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function ts(e){if(document.getElementById("products-content-container")){if(Qe===e&&document.getElementById("products-content-container").children.length>1){Qe==="products"&&(ja(),rt());return}Qe=e,oe="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?jn():e==="movements"&&Hn()}}async function zn(){be.innerHTML=`
        ...
        </section>`,ce&&(be.removeEventListener("click",ce),be.removeEventListener("input",ce),be.removeEventListener("change",ce)),ce=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){rt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){ts(a.dataset.view);return}switch(a.dataset.action){case"new-product":lo();break;case"edit-product":lo(JSON.parse(a.dataset.product));break;case"manage-product-categories":qn();break;case"generate-report":await On();break;case"filter-stock":const r=a.dataset.filterType;oe=oe===r?"all":r,document.querySelectorAll(".indicator-card").forEach(o=>{o.classList.toggle("ring-2",o.dataset.filterType===oe),o.classList.toggle("ring-indigo-500",o.dataset.filterType===oe),o.classList.toggle("shadow-lg",o.dataset.filterType===oe)}),rt();break}},be.addEventListener("click",ce),be.addEventListener("input",ce),be.addEventListener("change",ce),Qe="products",oe="all",await ct()}const fe=document.getElementById("content");let ue=null,Et="list",R={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Vn(){Et==="list"?Wt():Et==="purchases"?(R.step=1,Xe()):Et==="history"&&as()}async function Un(){try{const e=await Fa(m.establishmentId);return m.suppliers=e||[],R.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function _n(e){if(await j("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await Bn(e),g("Sucesso","Fornecedor excluído.","success"),Rt("genericModal"),Wt()}catch(t){g("Erro","Erro ao excluir: "+t.message,"error")}}async function Jn(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:m.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await Tn(a,s),g("Sucesso","Fornecedor atualizado!","success")):(await Ln(s),g("Sucesso","Fornecedor criado!","success")),Rt("genericModal"),Wt()}catch(o){g("Erro","Erro ao salvar: "+o.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Wt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Un();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=m.suppliers.filter(o=>o.name.toLowerCase().includes(t)||o.contactName&&o.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let s='<div class="flex flex-col gap-2 md:hidden">';a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.category||"Geral"),d=v(o.contactName||"");s+=`
    ...
    `;a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.taxId||"Sem doc."),d=v(o.email||"-"),c=v(o.phone||"-"),u=v(o.category||"Geral");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=s+r}function Wn(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",s=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),o=v(e.name),n=v(e.category||"Fornecedor"),i=v(e.contactName||""),l=v(e.phone||""),d=`
    ...
    `;J({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Xe(){const e=document.getElementById("purchasesContainer");if(e)if(R.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([jt(m.establishmentId),Fa(m.establishmentId)]);R.allSuppliers=a||[];const s=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(R.productsToBuy=s,s.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',o="";s.forEach(d=>{const c=parseInt(d.minStock)||0,u=parseInt(d.currentStock)||0,p=Math.max(c-u,1),b=parseFloat(d.costPrice||0),f=v(d.name);let h='<option value="">Selecione...</option>';R.allSuppliers.length>0?R.allSuppliers.forEach(w=>{const I=d.supplierIds&&d.supplierIds.includes(w.id)?"selected":"";h+=`<option value="${w.id}" ${I}>${v(w.name)}</option>`}):h='<option value="">Sem fornecedores</option>',r+=`
        ...
        `}).join("");s+=f;const w=encodeURIComponent(JSON.stringify({supplierId:p,supplierName:b.info.name,totalAmount:f,items:b.items})),S=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),I=encodeURIComponent(JSON.stringify(b.items)),E=v(b.info.name),k=v(b.info.email||"");a+=`
    ...
    `}async function as(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await Mn(m.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(o=>{const n=new Date(o.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=v(o.supplierName);a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function Yn(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;J({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Jn),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Rt("genericModal"))},50)}function Xn(){fe.innerHTML=`
    ...
    `,ue&&(fe.removeEventListener("click",ue),fe.removeEventListener("input",ue),fe.removeEventListener("change",ue)),ue=e=>{if(e.target.closest("#tab-btn-list")&&pt("list"),e.target.closest("#tab-btn-purchases")&&pt("purchases"),e.target.closest("#tab-btn-history")&&pt("history"),e.target.id==="toggle-quote-mode"&&(R.isQuoteMode=e.target.checked,Xe()),e.target.id==="supplierSearchInput"&&Wt(),e.target.closest("#btn-new-supplier")&&co(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),s=JSON.parse(a.dataset.supplier);Wn(s)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&_n(t.dataset.id),a==="edit"&&co(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&va(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=a),va()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),s={};let r=!1;if(a.forEach(o=>{if(o.offsetParent===null||!o.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=o.querySelector("td:nth-child(2)"),d=o.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(o.querySelector(".qty-input").value),u=parseFloat(o.dataset.cost),b=o.querySelector(".supplier-select").value;if(b){if(!s[b]){const f=R.allSuppliers.find(h=>h.id===b);s[b]={info:f,items:[]}}s[b].items.push({name:i,qty:c,cost:u})}}),!r){g("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}R.finalOrders=s,R.step=2,Xe()}if(e.target.closest("#btn-back-step1")&&(R.step=1,Xe()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),o=parseFloat(a.dataset.total),n=R.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=m.establishmentId,a.disabled=!0,a.textContent="A processar...",Ee(m.establishmentId).then(r=>{const o=r.purchaseConfig||null;return Dn(s,o)}).then(()=>{g("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;j("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await Pn(s,m.establishmentId),g("Sucesso","Compra e financeiro excluídos.","success"),as()}catch(o){g("Erro","Erro ao excluir: "+o.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=R.finalOrders[s];r?Qn(r,R.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);Yn(s)}},fe.addEventListener("click",ue),fe.addEventListener("input",ue),fe.addEventListener("change",ue),pt("list")}function pt(e){Et=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Vn()}const Kt=document.getElementById("content"),uo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ne=new Set,gt=null,Pe=null;function Zn(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Kn(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",s=v(t.name),r=v(t.specialty||"Especialidade"),o=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function ea(){const e=document.getElementById("genericModal");e.style.display="none",Pe&&e.removeEventListener("click",Pe)}async function ei(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=v(a.name),r=m.services||await Ie(m.establishmentId),o=m.professionals||await Q(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",ti(a,r),oi(a),si(a,o),ni(a)}function ti(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(w,S)=>{const I=S+1,E=I==s[1]?"selected":"",k=new Date(0,S).toLocaleString("pt-BR",{month:"long"});return`<option value="${I}" ${E}>${k.charAt(0).toUpperCase()+k.slice(1)}</option>`}).join(""),o=e.status||"active",n=v(e.name||""),i=v(e.specialty||""),l=v(e.phone||""),d=v(e.notes||"");a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${d}</textarea></div>`;const c=document.getElementById("profPhotoInput"),u=document.getElementById("profPhotoButton"),p=document.getElementById("profPhotoPreview"),b=document.getElementById("profPhotoBase64"),f=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,h=e.photo||"";u&&u.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const w=c.files[0];if(w){p.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const S=await ai(w,800,800,"image/jpeg",.8);p.src=S,b.value=S}catch(S){g("Erro de Imagem",S.message||"Não foi possível processar a imagem.","error"),p.src=f,b.value=h,c.value=""}}})}function ai(e,t=800,a=800,s="image/jpeg",r=.8){return new Promise((o,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,u=d.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const p=document.createElement("canvas");p.width=c,p.height=u,p.getContext("2d").drawImage(d,0,0,c,u);const f=p.toDataURL(s,r);o(f)},d.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function oi(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',ri(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function si(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500">${s.message}</p>`}}}function ni(e){const t=document.getElementById("genericModal");Pe&&t.removeEventListener("click",Pe),Pe=async a=>{const s=a.target.closest("button[data-action]");if(!s){const o=a.target.closest(".tab-link");o&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),o.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(o.dataset.tab).classList.remove("hidden"));return}const r=s.dataset.action;switch(a.stopPropagation(),r){case"close-modal":ea();break;case"delete-professional":const o=s.dataset.id;if(await j("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Us(o),g("Sucesso!","Profissional excluído.","success"),ea(),Dt()}catch(h){g("Erro",`Não foi possível excluir: ${h.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(h=>h.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(h=>{const w=h.querySelector('[data-field="active"]').dataset.day;u[w]={active:h.querySelector('[data-field="active"]').checked,start:h.querySelector('[data-field="start"]').value,end:h.querySelector('[data-field="end"]').value,breakStart:h.querySelector('[data-field="breakStart"]').value,breakEnd:h.querySelector('[data-field="breakEnd"]').value}});const p={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{p.id?(await ua(p.id,p),g("Sucesso!","Profissional atualizado.","success")):(delete p.id,await Fo(p),g("Sucesso!","Profissional criado.","success")),ea(),Dt()}catch(h){g("Erro",h.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=s.dataset.id;if(await j("Apagar Bloqueio","Tem certeza?"))try{await Ba(b),g("Bloqueio removido.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ze(e.id,h)}catch(h){g("Erro",h.message,"error")}break;case"batch-delete-blockage":const f=JSON.parse(s.dataset.ids);if(await j("Apagar em Lote",`Tem certeza que deseja apagar ${f.length} bloqueios com este motivo?`))try{await Oo(f),g("Bloqueios removidos.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ze(e.id,h)}catch(h){g("Erro",h.message,"error")}break}},t.addEventListener("click",Pe)}function ha(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ne.size>0?(t.textContent=`${ne.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function ii(){j("Excluir em Lote",`Tem certeza que deseja excluir ${ne.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await(void 0)(Array.from(ne)),g("Sucesso!",`${ne.size} profissionais foram excluídos.`,"success"),ne.clear(),ha(),Dt()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ve(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Zn();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),s=m.professionals.filter(r=>{const o=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return o&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Kn(s)}async function Dt(){ne.clear(),Kt.innerHTML=`
        ...
        </section>`,gt&&Kt.removeEventListener("click",gt),gt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),s=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let o={};if(a.dataset.professional)try{o=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}ei(o);return}if(s){ii();return}const r=t.target.closest(".professional-checkbox");if(r){const o=r.dataset.id;r.checked?ne.add(o):ne.delete(o),Ve(),ha();return}},Kt.addEventListener("click",gt),document.getElementById("profSearchInput").addEventListener("input",Ve),document.getElementById("showInactiveProfToggle").addEventListener("change",Ve);const e=document.getElementById("professionalsList");m.professionals=null,m.services=null,Ve();try{const[t,a]=await Promise.all([Q(m.establishmentId),Ie(m.establishmentId)]);m.professionals=t,m.services=a,Ve(),ha()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const ta=document.getElementById("content");let Me=[],ie={},U=null,xa="list",Z="all",ya="O Estabelecimento";const li=1,di=(e,t)=>`Olá, ${e}! Nós da ${t} desejamos a você um Feliz Aniversário! Esperamos que seu dia seja maravilhoso. Venha comemorar conosco! 🎉🎂`,ci=(e,t)=>`Oi, ${e}! Faz um tempo que não te vemos aqui no(a) ${t}. Sentimos sua falta! Temos novidades/ofertas especiais para você. Que tal agendar seu horário?`,ui=[{value:30,label:"30 dias"},{value:60,label:"60 dias"},{value:90,label:"90 dias"},{value:120,label:"120 dias"}];function mi(){return Math.floor(Math.random()*140)+10}function pi(e){if(!e.dob)return!1;const t=e.dob.split("/");if(t.length!==2)return!1;const a=new Date,s=a.getDate(),r=a.getMonth()+1,o=parseInt(t[0],10),n=parseInt(t[1],10);return o===s&&n===r}const gi=[{value:99,label:"Aniversariantes de Hoje"},{value:0,label:"Todos os meses (com DOB)"},{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}];function mo(){return gi.map(e=>{let t=e.value===99?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function po(){return ui.map(e=>{const t=e.value===90?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function Ha(e){if(!e)return 0;let t=0;if(e.totalAmount!==void 0&&e.totalAmount!==null?t=parseFloat(e.totalAmount):e.value!==void 0&&e.value!==null?t=parseFloat(e.value):e.price!==void 0&&e.price!==null&&!Array.isArray(e.price)&&(t=parseFloat(e.price)),!t||t===0){let a=0;e.services&&Array.isArray(e.services)&&(a+=e.services.reduce((r,o)=>{const n=parseFloat(o.price)||parseFloat(o.servicePrice)||0;return r+n},0));const s=e.comandaItems||e.items;s&&Array.isArray(s)&&(a+=s.reduce((r,o)=>{const n=parseFloat(o.price)||0,i=parseInt(o.quantity)||1;return r+n*i},0)),a>0&&(t=a)}return isNaN(t)?0:t}function bi(e,t){const a=`w-5 h-5 ${t} mr-2`;switch(e){case"cadastro":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>`;case"agendamentos":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`;case"historico":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v2a2 2 0 01-2 2h-2.586a1 1 0 00-.707.293l-1.414 1.414a1 1 0 01-1.414 0l-1.414-1.414A1 1 0 009.586 17H7a2 2 0 01-2-2v-2a2 2 0 012-2h12z" /></svg>`;case"fidelidade":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.5a9.5 9.5 0 1019 0 9.5 9.5 0 00-19 0z" /></svg>`;default:return""}}function fi(e="cadastro"){const t=[{id:"cadastro",label:"Cadastro"},{id:"agendamentos",label:"Agend."},{id:"historico",label:"Histórico"},{id:"fidelidade",label:"Fidelidade"}],a=document.getElementById("client-detail-tabs");a&&(a.innerHTML=t.map(s=>{const r=e===s.id,o=r?"text-indigo-600":"text-gray-500";return`
        ...
        `}).join(""),a.querySelectorAll(".tab-btn").forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),wa(s.dataset.tab)})}))}async function wa(e){fi(e);const t=document.getElementById("client-detail-content");if(t){t.innerHTML='<div class="flex h-64 items-center justify-center"><div class="loader"></div></div>';try{switch(e){case"cadastro":t.innerHTML=vi(U);break;case"agendamentos":case"historico":const a=await Ka(m.establishmentId,U.name,U.phone);t.innerHTML=hi(a,e);break;case"fidelidade":let s=[],r=[];try{s=await Ka(m.establishmentId,U.name,U.phone)}catch(o){console.error("Erro ao buscar histórico de vendas:",o)}if(ie&&ie.enabled)try{r=await hr(m.establishmentId,U.name,U.phone)}catch(o){console.warn("Aviso: Histórico de fidelidade indisponível.",o)}t.innerHTML=yi(U,s,r);break;default:t.innerHTML='<p class="p-6 text-center text-gray-500">Seção não implementada.</p>'}}catch(a){console.error("Erro crítico ao carregar aba:",a),t.innerHTML=`<div class="p-6 text-center text-red-500"><p>Erro ao carregar dados.</p><p class="text-xs mt-2">${v(a.message)}</p></div>`}}}function vi(e){const t=e?.dob?e.dob.split("/"):["",""],a=v(e?.name||""),s=v(e?.email||""),r=v(e?.phone||""),o=v(e?.notes||"");return`
    ...
    `}function hi(e,t){const a=t==="agendamentos"?"Próximos Agendamentos":"Histórico de Visitas",s=t==="agendamentos"?"Nenhum agendamento futuro.":"Nenhum histórico de visitas.",r=new Date;r.setHours(0,0,0,0);const o=t==="agendamentos",n=(e||[]).filter(i=>{const l=new Date(i.date),d=new Date(l);d.setHours(0,0,0,0);const c=d.getTime()===r.getTime(),u=d>r,p=d<r,b=["completed","finalized","finished","paid"].includes((i.status||"").toLowerCase());return o?!b&&(u||c):p||b});return n.sort((i,l)=>o?new Date(i.date).getTime()-new Date(l.date).getTime():new Date(l.date).getTime()-new Date(i.date).getTime()),n.length===0?`<div class="p-6 text-center text-gray-500">${s}</div>`:`
    ...
    `}function xi(e,t){const a=(e||[]).filter(l=>{const d=(l.status||"").toLowerCase();return d==="completed"||d==="finished"||d==="paid"||d==="finalized"});let s=0;a.forEach(l=>{s+=Ha(l)});let r=ie&&ie.conversionRate?parseFloat(ie.conversionRate):li;r<=0&&(r=1);const o=Math.floor(s/r);let n=0;(t||[]).forEach(l=>{l.type==="redeem"&&(n+=l.points?Math.abs(l.points):0)});const i=o-n;return{totalSpent:s,totalPointsEarned:o,totalPointsRedeemed:n,currentBalance:i,moneyPerPoint:r}}function yi(e,t,a){if(!ie||!ie.enabled)return`<div class="p-8 text-center text-gray-500">
        ...
        </div>`;const s=xi(t,a);e.loyaltyPoints=s.currentBalance,e.totalSpent=s.totalSpent;const r=(ie.tiers||[]).map(i=>{const l=s.currentBalance>=i.points,d=v(i.reward);return`
    ...
    `}function os(e){U=e,xa="detail";const t=e!==null,a=t?"Editar Cliente":"Adicionar Cliente",s=`
    ...
    `,r=window.innerWidth<768,o=r?"max-w-full":"max-w-3xl";if(J({title:a,contentHTML:s,maxWidth:o}),r){const d=document.getElementById("genericModal");if(d){const c=d.querySelector(`.${o.replace(":","\\:")}`);c&&(c.style.height="auto",c.style.maxHeight="85vh",c.style.borderRadius="1rem")}}const n=document.getElementById("genericModal");n&&(n.onclick=async d=>{const c=d.target.closest("[data-action]");if(!c)return;switch(c.dataset.action){case"redeem-reward":{const p=parseInt(c.dataset.points,10),b=c.dataset.reward;if(await j("Confirmar Resgate",`Deseja resgatar "${b}" por ${p} pontos?`))try{await xr(m.establishmentId,U.name,U.phone,{points:p,reward:b}),g("Prêmio resgatado com sucesso!","success"),await wa("fidelidade")}catch(h){g(`Erro ao resgatar: ${h.message}`,"error")}break}case"open-comanda-from-history":{const p=c.dataset.appointmentId;p&&(document.getElementById("genericModal").style.display="none",ee("comandas-section",{selectedAppointmentId:p,initialFilter:"finalizada"}));break}case"view-appointment":{const p=c.dataset.appointmentId,b=c.dataset.appointmentDate;p&&b&&(document.getElementById("genericModal").style.display="none",ee("agenda-section",{targetDate:b,scrollToAppointmentId:p}));break}case"save-client":{d.preventDefault(),go();break}}}),wa("cadastro"),setTimeout(()=>{const d=document.getElementById("client-form");d&&d.addEventListener("submit",c=>{c.preventDefault(),go()})},500);const i=document.getElementById("cancelDetailViewBtn");i&&i.addEventListener("click",d=>{d.preventDefault(),document.getElementById("genericModal").style.display="none",Gt()});const l=document.getElementById("deleteClientBtn");l&&l.addEventListener("click",async()=>{await wi()})}async function go(){const e=document.getElementById("client-form");if(!e)return;const t=e.querySelector("#clientId").value,a={name:e.querySelector("#clientName").value,email:e.querySelector("#clientEmail").value,phone:e.querySelector("#clientPhone").value,dob:`${e.querySelector("#clientDobDay").value}/${e.querySelector("#clientDobMonth").value}`,notes:e.querySelector("#clientNotes").value,establishmentId:m.establishmentId};if(!a.name||!a.phone){g("Erro","Nome e Telefone são obrigatórios.","error");return}try{t?(await fr(t,a),g("Sucesso","Cliente atualizado com sucesso!","success")):(await Da(a),g("Sucesso","Cliente cadastrado com sucesso!","success")),document.getElementById("genericModal").style.display="none",await Gt()}catch(s){g("Erro",`Não foi possível salvar: ${s.message}`,"error")}}async function wi(){if(!U||!U.id)return;if(await j("Excluir Cliente",`Tem certeza que deseja excluir ${U.name}? Esta ação é irreversível.`))try{await vr(U.id),g("Sucesso","Cliente excluído.","success"),document.getElementById("genericModal").style.display="none",await Gt()}catch(t){g("Erro",`Não foi possível excluir: ${t.message}`,"error")}}function It(e,t){const a=document.getElementById("clientsList");if(a)if(a.innerHTML="",a.className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 content-start p-2 pb-20",document.getElementById("client-count").textContent=`${e.length} cliente${e.length!==1?"s":""} | Total: ${t}`,e.length>0){const s=Z==="inactive",r=Z==="birthdays";e.forEach(o=>{const n=document.createElement("div");n.className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 hover:shadow-md cursor-pointer transition-all flex flex-col justify-between h-full relative group",n.dataset.clientId=o.id;const i=o.loyaltyPoints||0,l=o.totalSpent||0;let d="";const u=`https://wa.me/55${o.phone?o.phone.replace(/\D/g,""):""}?text=`,p=v(o.name),b=v(o.phone);if(s){const f=encodeURIComponent(ci(o.name,ya));d=`<a href="${u+f}" target="_blank" class="absolute top-2 right-2 text-blue-500 bg-blue-50 p-1 rounded-full z-10 hover:bg-blue-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 16.64C16.64 16.64 15.11 17.58 14.54 17.76C13.97 17.94 13.06 18.06 10.66 17.06C8.26 16.06 6.38 13.62 6.38 13.62C6.38 13.62 4.96 11.72 4.96 9.76C4.96 7.8 6.04 6.88 6.04 6.88C6.04 6.88 6.32 6.56 6.6 6.56C6.88 6.56 7.16 6.56 7.16 6.56C7.38 6.56 7.62 6.46 7.86 7.02C8.1 7.58 8.68 9.02 8.68 9.02C8.68 9.02 8.78 9.24 8.64 9.48C8.5 9.72 8.36 9.88 8.16 10.1C7.96 10.32 7.74 10.4 8.02 10.88C8.3 11.36 9.26 12.92 10.68 14.18C11.62 15.02 12.56 15.36 12.94 15.54C13.32 15.72 13.6 15.66 13.84 15.38C14.08 15.1 14.62 14.34 14.62 14.34C14.62 14.34 14.88 14.06 15.18 14.12C15.48 14.18 16.94 14.9 16.94 14.9C16.94 14.9 17.2 15.04 17.3 15.22C17.4 15.4 17.4 16.28 16.64 16.64Z"/></svg></a>`}else if(r&&pi(o)){const f=encodeURIComponent(di(o.name,ya));d=`<a href="${u+f}" target="_blank" class="absolute top-2 right-2 text-green-500 bg-green-50 p-1 rounded-full z-10 hover:bg-green-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M... (mesmo icone)"/></svg></a>`}n.innerHTML=`
                ${d}
            ...
            `,n.addEventListener("click",()=>os(o)),a.appendChild(n)})}else a.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum cliente encontrado com os filtros aplicados.</p>'}function Ct(e="",t="all"){const a=e.toLowerCase(),s=a.length>0;let r=0,o=90;const n=window.innerWidth<768;if(t==="birthdays"){const l=n?"mobileBirthMonthFilter":"birthMonthFilter",d=document.getElementById(l);d&&(r=parseInt(d.value,10))}else if(t==="inactive"){const l=n?"mobileInactiveDaysFilter":"inactiveDaysFilter",d=document.getElementById(l);d&&(o=parseInt(d.value,10))}let i=Me.filter(l=>!s||l.name.toLowerCase().includes(a)||(l.phone||"").includes(a));switch(t){case"birthdays":const l=new Date,d=l.getDate(),c=l.getMonth()+1;return i.filter(u=>{if(!u.dob)return!1;const p=u.dob.split("/");if(p.length!==2)return!1;const b=parseInt(p[0],10),f=parseInt(p[1],10);return r===99?b===d&&f===c:r===0?f>=1&&f<=12:f===r});case"inactive":return i.filter(u=>(u.lastAppointmentDaysAgo||mi())>o);case"credit":return i.filter(u=>(u.loyaltyPoints||0)>0);case"all":default:return i}}async function ki(e){const t=document.getElementById("birthMonthFilterContainer"),a=document.getElementById("mobileBirthMonthFilterContainer"),s=document.getElementById("inactiveDaysFilterContainer"),r=document.getElementById("mobileInactiveDaysFilterContainer"),o=e==="birthdays",n=e==="inactive";if([t,a].forEach(d=>d?.classList.toggle("hidden",!o)),[s,r].forEach(d=>d?.classList.toggle("hidden",!n)),o&&Z!=="birthdays"&&document.querySelectorAll("#birthMonthFilter, #mobileBirthMonthFilter").forEach(d=>d.value=99),n&&Z!=="inactive"&&document.querySelectorAll("#inactiveDaysFilter, #mobileInactiveDaysFilter").forEach(d=>d.value=90),Z===e&&!o&&!n)return;Z=e,document.querySelectorAll(".client-filter-btn").forEach(d=>{d.classList.remove("bg-white","text-indigo-600","shadow"),d.classList.add("bg-gray-100","text-gray-600")}),document.querySelectorAll(`[data-filter-key="${e}"]`).forEach(d=>{d.classList.remove("bg-gray-100","text-gray-600"),d.classList.add("bg-white","text-indigo-600","shadow")});const i=document.getElementById("clientSearchInput").value,l=Ct(i,Z);It(l,Me.length)}async function Gt(){xa="list",ta.innerHTML=`
    ...
    `;try{const[c,u]=await Promise.all([zt(m.establishmentId),Ee(m.establishmentId)]);Me=c,ie=u.loyaltyProgram||{enabled:!1},ya=u.name||"O Estabelecimento";const p=Ct("",Z);It(p,Me.length)}catch{const u=document.getElementById("clientsList");u&&(u.innerHTML='<p class="text-red-500 col-span-full text-center mt-10">Erro ao carregar dados dos clientes.</p>')}const e=document.getElementById("filter-sheet"),t=document.getElementById("filter-overlay"),a=document.getElementById("openFilterSheetBtn"),s=document.getElementById("closeFilterSheetBtn"),r=()=>{e.classList.remove("translate-y-full"),t.classList.remove("hidden")},o=()=>{e.classList.add("translate-y-full"),t.classList.add("hidden")};a&&a.addEventListener("click",r),s&&s.addEventListener("click",o),t&&t.addEventListener("click",o);const n=c=>{const u=c.target.closest(".client-filter-btn");if(u){ki(u.dataset.filterKey);const p=u.dataset.filterKey;window.innerWidth<768&&p!=="birthdays"&&p!=="inactive"&&o()}},i=document.getElementById("desktop-filter-bar"),l=document.getElementById("mobile-filter-list");i&&i.addEventListener("click",n),l&&l.addEventListener("click",n);const d=c=>{const u=document.getElementById(c);u&&u.addEventListener("change",()=>{if(Z==="birthdays"||Z==="inactive"){const p=document.getElementById("clientSearchInput").value,b=Ct(p,Z);It(b,Me.length)}})};d("birthMonthFilter"),d("mobileBirthMonthFilter"),d("inactiveDaysFilter"),d("mobileInactiveDaysFilter"),ta.addEventListener("click",async c=>{const u=c.target.closest("[data-action]");xa==="list"&&u&&u.dataset.action==="new-client"&&os(null)}),ta.addEventListener("input",c=>{if(c.target.id==="clientSearchInput"){const u=c.target.value,p=Ct(u,Z);It(p,Me.length)}})}const nt=e=>y(`/api/financial/natures/${e}`),Si=e=>y("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),$i=e=>y(`/api/financial/natures/${e}`,{method:"DELETE"}),it=e=>y(`/api/financial/cost-centers/${e}`),Ei=e=>y("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),Ii=e=>y(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),ss=(e,t)=>y(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),rs=(e,t={})=>{let a=`/api/financial/${e}`;const s=new URLSearchParams;t.establishmentId&&s.append("establishmentId",t.establishmentId),t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId),t.status&&s.append("status",t.status);const r=s.toString();return r&&(a+=`?${r}`),y(a)},ns=(e,t,a)=>y(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),is=(e,t)=>y(`/api/financial/${e}/${t}`,{method:"DELETE"}),ls=(e,t,a)=>y(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Ci=e=>ss("payables",e),Li=e=>rs("payables",e),Ti=(e,t)=>ns("payables",e,t),Bi=e=>is("payables",e),Di=(e,t)=>ls("payables",e,t),Pi=e=>ss("receivables",e),Mi=e=>rs("receivables",e),Ai=(e,t)=>ns("receivables",e,t),Ni=e=>is("receivables",e),qi=(e,t)=>ls("receivables",e,t),Fi=(e,t,a)=>y(`/api/financial/cash-flow?establishmentId=${e}&startDate=${t}&endDate=${a}`),Ri=e=>y(`/api/financial/today-summary/${e}`),ye=document.getElementById("content"),aa={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},ji={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}},ds=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"},{id:"support",icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",label:"Suporte e Ajuda"},{id:"cancellation",icon:"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z",label:"Cancelar Assinatura"}];let V=null;function bo(e,t,a){return new Promise((s,r)=>{const o=new FileReader;o.readAsDataURL(e),o.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const p=e.type==="image/png"&&t<500?"image/png":"image/jpeg";s(l.toDataURL(p,a))},i.onerror=l=>r(l)},o.onerror=n=>r(n)})}function Te(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i="")=>{const l=n.id===t?"selected":"";a+=`<option value="${n.id}" ${l}>${i}${v(n.name)}</option>`,n.children.forEach(d=>r(d,i+"— "))};return s(e).forEach(n=>r(n)),a}async function He(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const s=V||await Ee(m.establishmentId),r=[],{ownerName:o,...n}=e;if(o&&o!==m.userName){const l=Y.currentUser;l&&r.push(ys(l,{displayName:o}).then(()=>{m.userName=o}))}const i={...s,...n};if(r.push(St(m.establishmentId,i)),await Promise.all(r),V=i,g("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),n.themeColor)setTimeout(()=>window.location.reload(),1500);else{const l=document.getElementById("panelEstablishmentName");n.name&&l&&(l.textContent=n.name,m.establishmentName=n.name)}}catch(s){g("Erro",`Não foi possível salvar: ${s.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function Hi(e,t){const a=v(e.name||""),s=v(e.phone||""),r=v(e.document||""),o=v(e.email||""),n=v(e.address||""),i=v(e.website||""),l=v(m.userName||"");t.innerHTML=`
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!s||!r){g("Erro","Preencha todos os campos.","error");return}const o=t.querySelector('button[form="change-email-form"]');o.disabled=!0,o.textContent="A verificar...";try{const n=Y.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=fs.credential(n.email,r);await vs(n,i),o.textContent="A enviar link...",await hs(n,s),o.textContent="A atualizar BD...",await zs(m.establishmentId,s),g("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,g("Erro",i,"error")}finally{o.disabled=!1,o.textContent="Salvar Novo E-mail"}})}function Vi(e,t){const a=v(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([nt(m.establishmentId),it(m.establishmentId)]),r=e.financialIntegration||{},o=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Te(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Te(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Te(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Te(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Te(a,o.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Te(s,o.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};He(s,a)})}function Gi(e,t){const a="5516997859430",s=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${s}`;t.innerHTML=`
    ...
    `}function Yi(e,t){const a="5516997859430",s=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),r=`https://wa.me/${a}?text=${s}`,o="sistemakairosagenda@gmail.com";t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function cs(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(ji).forEach(([r,o])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{s.value=r,cs(r,t)}),a.appendChild(i)}),s.value=e)}function Xi(e,t){const a=t.querySelector("#slotIntervalContainer"),s=t.querySelector("#establishmentSlotInterval");if(!a||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(o=>{const n=o.value===e;return`<button type="button" data-value="${o.value}" 
    ...
    `,ye.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),us()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":Hi(V,a);break;case"change-password":Oi(V,a);break;case"change-email":zi(V,a);break;case"branding":Vi(V,a);break;case"booking":Ui(V,a);break;case"working-hours":_i(V,a);break;case"loyalty":Ji(V,a);break;case"financial":await Wi(V,a);break;case"support":Gi(V,a);break;case"cancellation":Yi(V,a);break;default:Qi(t?t.label:"Definições",a)}}async function us(){if(ye.innerHTML=`
    ...
    `,!V)try{V=await Ee(m.establishmentId)}catch{g("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),ye.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const e=Y.currentUser;e&&e.displayName&&(m.userName=e.displayName);const t=v(m.userName||Y.currentUser.email);let s=`https://placehold.co/96x96/E2E8F0/4A5568?text=${t?t.charAt(0).toUpperCase():"U"}`;e&&e.photoURL&&(s=e.photoURL),ye.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
        ...
        <div data-action="go-to-my-profile" class="bg-white p-4 rounded-lg shadow-md mb-6 cursor-pointer hover:bg-gray-50 transition-all">
            <div class="text-center relative">
                ...
                <div class="absolute top-0 right-0 p-2 text-gray-400 hover:text-indigo-600" title="Ver Meu Perfil">
                 ...
                 ${m.userName&&m.userName!==Y.currentUser.email?`<p class="text-sm text-gray-500">${v(Y.currentUser.email)}</p>`:""}
    ...
    `,ye.querySelector("#settings-menu-list").addEventListener("click",o=>{const n=o.target.closest("button[data-section]");n&&(o.preventDefault(),Zi(n.dataset.section))});const r=ye.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",o=>{o.preventDefault(),ee("my-profile-section")})}const Ke=document.getElementById("content");async function Ne(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await Ht(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${v(l)} (${d.length})</h4>`;if(d.length>1){const b=JSON.stringify(d.map(f=>f.id));p+=`<button data-action="batch-delete-blockage" data-ids='${b}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",c.innerHTML=p,d.forEach(b=>{const f=new Date(b.startTime),h=new Date(b.endTime),w=f.toLocaleDateString("pt-BR"),S=h.toLocaleDateString("pt-BR"),E=`
                    ...
                    </div>`;c.innerHTML+=E}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Ki(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||s,o=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Ot(i),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),Ne(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function el(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||s,o=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Ot(u)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Ne(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function tl(e){Ke.addEventListener("submit",t=>{t.target.id==="blockageForm"&&Ki(t),t.target.id==="batchBlockageForm"&&el(t)}),Ke.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Ne(e)}),Ke.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")ee("profissionais-section");else if(s==="delete-blockage"){if(await j("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Ba(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),Ne(e)}catch(o){g("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await j("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Oo(r),g("Sucesso",`${r.length} bloqueios removidos.`,"success"),Ne(e)}catch(n){g("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function al(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){Ke.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);Ke.innerHTML=`
        <section>
        ...
        </section>`,tl(t),await Ne(t);const r=document.getElementById("batchProfSelectionContainer");try{const o=await Q(m.establishmentId);r.innerHTML=o.map(n=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const ol=e=>y(`/api/users/${e}`),sl=e=>y("/api/users",{method:"POST",body:JSON.stringify(e)}),rl=(e,t)=>y(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),nl=e=>y(`/api/users/${e}`,{method:"DELETE"}),il=(e,t)=>y(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),ll=(e,t)=>y(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),ve=document.getElementById("content"),dl={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},cl={view:"Visualizar",create:"Criar",edit:"Editar"};let Ue=null,_e=null;function ul(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const s=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${s}</p>`;return}e.sort((s,r)=>(s.status==="active"?-1:1)-(r.status==="active"?-1:1)),t.innerHTML=e.map(s=>{const r=JSON.stringify(s).replace(/'/g,"&apos;"),o=s.status==="active",n=m.professionals.find(c=>c.id===s.professionalId),i=n?n.name:"N/A",l=n?n.name.charAt(0):s.name.charAt(0),d=n?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function Lt(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=m.users:t=m.users.filter(a=>a.status==="active"),ul(t)}function ml(e={}){return Object.entries(dl).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,o=Object.entries(cl).map(([i,l])=>`
    ...
    `}).join("")}async function fo(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{a=await Q(m.establishmentId),m.professionals=a}catch{g("Erro","Não foi possível carregar a lista de profissionais.","error")}const s=S=>a.find(I=>I.id===S),r=(S,I)=>{const k=s(S)?.photo,C=I.charAt(0).toUpperCase();return{photoSrc:k||`https://placehold.co/128x128/E2E8F0/4A5568?text=${C}`,initials:C,photoUrl:k||""}},o=e?.professionalId,n=e?.name||"Novo Usuário",i=r(o,n),l=s(o),d=S=>{let I='<option value="">-- Não Associado a um Profissional --</option>';return I+=a.map(E=>`<option value="${E.id}" ${E.id===S?"selected":""}>${E.name} (${E.specialty||"N/A"})</option>`).join(""),I},c=e!==null;t.querySelector("#userFormTitle").textContent=c?`Editar Usuário: ${e.name}`:"Novo Usuário";const u=t.querySelector("#userForm");u.innerHTML=`
    ...
    `;const p=window.innerWidth<768,b=u.querySelector(".bg-white");if(p&&b){b.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const S=u.closest("section");S&&(S.style.padding="0",S.style.margin="0"),b.classList.add("p-4")}const f=u.querySelector("#userProfessionalId"),h=u.querySelector("#userPhotoPreview"),w=u.querySelector("#profPhotoName");if(f.addEventListener("change",S=>{const I=S.target.value,E=s(I),k=E?E.name:"Selecione um profissional",C=r(I,n);h.src=C.photoSrc,w.textContent=k,u.querySelector("#professionalPhotoUrl").value=C.photoUrl}),u.addEventListener("submit",async S=>{S.preventDefault();const I=e?.email,E=u.querySelector("#userEmail").value,k={};u.querySelectorAll('input[type="checkbox"]').forEach(H=>{const L=H.dataset.module,T=H.dataset.permission;k[L]||(k[L]={}),k[L][T]=H.checked});const C=u.querySelector("#userProfessionalId").value||null,F={name:u.querySelector("#userName").value,permissions:k,professionalId:C,establishmentId:m.establishmentId};try{c?(I!==E&&(F.email=E),await rl(e.id,F),g("Usuário atualizado com sucesso!","success")):(F.email=u.querySelector("#userEmail").value,F.password=u.querySelector("#userPassword").value,await sl(F),g("Usuário criado com sucesso!","success")),Pt()}catch(H){g(`Erro: ${H.message}`,"error")}}),c){const S=u.querySelector("#password-change-container"),I=S.querySelector('[data-action="show-password-form"]'),E=S.querySelector("#password-form"),k=E.querySelector('[data-action="save-password"]'),C=E.querySelector('[data-action="cancel-password-change"]');I.addEventListener("click",()=>{I.classList.add("hidden"),E.classList.remove("hidden")}),C.addEventListener("click",()=>{I.classList.remove("hidden"),E.classList.add("hidden"),E.querySelector("#userNewPassword").value=""}),k.addEventListener("click",async()=>{const F=E.querySelector("#userNewPassword").value;if(!F||F.length<6){g("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await j("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{k.disabled=!0,k.textContent="Aguarde...",await il(e.id,F),g("Sucesso!","A senha do usuário foi alterada.","success"),I.classList.remove("hidden"),E.classList.add("hidden"),E.querySelector("#userNewPassword").value=""}catch(L){g("Erro",`Não foi possível alterar a senha: ${L.message}`,"error")}finally{k.disabled=!1,k.textContent="Salvar Nova Senha"}})}}async function pl(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([ol(m.establishmentId),Q(m.establishmentId)]);m.users=t,m.professionals=a,Lt()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Pt(){ve.innerHTML=`
    ...
    `,Ue&&ve.removeEventListener("click",Ue),_e&&ve.removeEventListener("change",_e),Ue=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("click",Ue);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":fo();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));fo(s);break;case"back-to-list":Pt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await j("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await nl(r),g("Usuário excluído com sucesso!","success"),Pt()}catch(n){g(`Erro ao excluir: ${n.message}`,"error")}break}}},_e=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("change",_e);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Lt();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await ll(a,s),g(`Usuário ${s==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=m.users.findIndex(o=>o.id===a);r>-1&&(m.users[r].status=s,Lt())}catch(r){g(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,Lt()}}},ve.addEventListener("click",Ue),ve.addEventListener("change",_e),await pl()}const gl=document.getElementById("content");let vo={},ka=null;function bl(){Object.values(vo).forEach(e=>e?.destroy()),vo={}}function fl(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${t}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function ho(e){const t=document.getElementById("genericModal"),a=v(e.client),s=v(e.items),r=v(e.responsavelCaixa||"N/A"),o=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function vl(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);s.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ka.transactions[l];d&&ho(d)})}),n.innerHTML=a.map((i,l)=>{const d=v(i.client),c=v(i.items),u=v(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ka.transactions[l];d&&ho(d)})})}async function xo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,n=await gr({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:o});ka=n,e.innerHTML=`
        ...
        `,vl(n)}catch(o){g("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function hl(){bl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];gl.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",xo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${r}`;fl(o,"transactionsTable")});try{const s=await _r(m.establishmentId),r=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const n=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=v(o.closedByName||"N/A");r.innerHTML+=`<option value="${o.id}">${i} - ${n}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await xo()}const xl=document.getElementById("content");let B={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},oa=null,bt=null,ft=null;function Oa(e){const t=new Map,a=[];return e&&(e.forEach(s=>t.set(s.id,{...s,children:[]})),t.forEach(s=>{s.parentId&&t.has(s.parentId)?t.get(s.parentId).children.push(s):a.push(s)})),a}function ms(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const s=(r,o=0)=>{const n="— ".repeat(o);return`
        ...
        `};e.innerHTML=t.map(r=>s(r)).join("")}async function yo(e){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const t=document.getElementById("genericModal"),a=e==="nature",s=`Gerir ${a?"Naturezas Financeiras":"Centros de Custo"}`,r=a?nt:it,o=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),i=t.querySelector("#itemParent"),l=c=>{const u=Oa(c);if(ms(n,u,e),i){i.innerHTML='<option value="">-- Nível Principal --</option>';const p=(b,f="",h=0)=>{const w=h>0?"— ".repeat(h):"";i.innerHTML+=`<option value="${b.id}">${w}${b.name}</option>`,b.children.forEach(S=>p(S,f+"— "))};u.forEach(b=>p(b))}};try{const c=await r(m.establishmentId);B[o]=c,l(c)}catch(c){console.error(c)}const d=t.querySelector("#hierarchyForm");d&&d.addEventListener("submit",async c=>{c.preventDefault();const u=t.querySelector("#itemName");if(!u)return;const p=u.value,b=i.value,f=a?Si:Ei;try{await f({name:p,parentId:b||null,establishmentId:m.establishmentId});const h=await r(m.establishmentId);B[o]=h,l(h),d.reset(),await ke()}catch(h){g("Erro",`Não foi possível criar: ${h.message}`,"error")}})}function yl(e){const t=document.getElementById("cashFlowChart");if(!t)return;const a=t.getContext("2d");oa&&oa.destroy();const s=e.payables.map(r=>r*-1);oa=new Chart(a,{type:"bar",data:{labels:e.labels,datasets:[{label:"Receitas",data:e.receivables,backgroundColor:"rgba(74, 222, 128, 0.6)",borderColor:"rgba(34, 197, 94, 1)",borderWidth:1,yAxisID:"y"},{label:"Despesas",data:s,backgroundColor:"rgba(248, 113, 113, 0.6)",borderColor:"rgba(239, 68, 68, 1)",borderWidth:1,yAxisID:"y"},{label:"Saldo Acumulado",data:e.expectedBalance,type:"line",borderColor:"rgba(59, 130, 246, 1)",backgroundColor:"rgba(59, 130, 246, 0.2)",borderWidth:3,pointRadius:4,pointBackgroundColor:"rgba(59, 130, 246, 1)",fill:!0,tension:.1,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{x:{stacked:!0},y:{type:"linear",display:!0,position:"left",stacked:!0,title:{display:!0,text:"Movimentações (R$)"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Saldo Acumulado (R$)"},grid:{drawOnChartArea:!1}}},plugins:{tooltip:{callbacks:{label:function(r){let o=r.dataset.label||"";if(o&&(o+=": "),r.parsed.y!==null){const n=Math.abs(r.parsed.y);o+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(n)}return o}}}}}})}async function wo(){const e=document.getElementById("cash-flow-chart-container"),t=document.getElementById("cashFlowStartDate"),a=document.getElementById("cashFlowEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r){g("Atenção","Por favor, selecione as datas de início e fim.","error");return}e.innerHTML='<div class="loader mx-auto my-10"></div>';try{const o=await Fi(m.establishmentId,s,r);document.getElementById("cash-flow-chart-container")&&(e.innerHTML='<canvas id="cashFlowChart"></canvas>',yl(o))}catch(o){document.getElementById("cash-flow-chart-container")&&(e.innerHTML=`<p class="text-red-500 text-center">Erro ao carregar dados do gráfico: ${o.message}</p>`)}}function ko(){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const e=document.getElementById("genericModal"),t=new Date,a=new Date(t.getFullYear(),t.getMonth(),1).toISOString().split("T")[0],s=t.toISOString().split("T")[0];e.innerHTML=`
    ...
    `,e.style.display="flex"}function kl(){const e=document.getElementById("genericModal");e.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.style.display="flex"}function vt(e,t="all"){let a='<option value="all">Todos</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i=0)=>{const l=i>0?"— ".repeat(i):"",d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${l}${n.name}</option>`,n.children.forEach(c=>r(c,i+1))};return s(e).forEach(n=>r(n)),a}async function ke(){const e=document.getElementById("financial-content");if(!e)return;const t=document.getElementById("filterStartDate"),a=document.getElementById("filterEndDate");if(!t||!a)return;const s=t.value,r=a.value,o=document.getElementById("filterNaturezaId")?.value,n=document.getElementById("filterCostCenterId")?.value;if(!s||!r){try{const[d,c]=await Promise.all([nt(m.establishmentId),it(m.establishmentId)]);if(!document.getElementById("financial-content"))return;B={...B,natures:d,costCenters:c},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=vt(B.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=vt(B.costCenters))}catch(d){g("Erro",`Não foi possível carregar os dados base: ${d.message}`,"error")}Sa(),$o();return}const i=document.getElementById("payables-list"),l=document.getElementById("receivables-list");i&&(i.innerHTML='<div class="loader mx-auto"></div>'),l&&(l.innerHTML='<div class="loader mx-auto"></div>');try{const d={startDate:s,endDate:r,establishmentId:m.establishmentId};o&&o!=="all"&&(d.natureId=o),n&&n!=="all"&&(d.costCenterId=n);const[c,u,p,b]=await Promise.all([Li(d),Mi(d),nt(m.establishmentId),it(m.establishmentId)]);if(!document.getElementById("financial-content"))return;const f=(u.previousBalance||0)-(c.previousBalance||0);B={...B,payables:c.entries||[],receivables:u.entries||[],natures:p||[],costCenters:b||[],previousBalance:f,filterNaturezaId:o,filterCostCenterId:n},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=vt(B.natures,B.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=vt(B.costCenters,B.filterCostCenterId)),Sa(),$o()}catch(d){document.getElementById("financial-content")&&(g("Erro",`Não foi possível carregar os dados: ${d.message}`,"error"),e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function Sl(e,t,a=null){e.preventDefault();const s=e.target,r=s.querySelector('[name="status"]').checked,o=s.querySelector('[name="paymentDate"]').value,n=parseFloat(s.querySelector('[name="amount"]').value),i=parseInt(s.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(n)){g("Erro de Validação","O valor inserido é inválido.","error");return}if(r&&!o){g("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:s.querySelector('[name="description"]').value,amount:n,dueDate:s.querySelector('[name="dueDate"]').value,naturezaId:s.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:s.querySelector('[name="centroDeCustoId"]').value||null,notes:s.querySelector('[name="notes"]').value,status:r?"paid":"pending",paymentDate:r?o:null,installments:a?1:i,establishmentId:m.establishmentId};try{a?(await(t==="payable"?Ti(a,l):Ai(a,l)),g("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?Ci(l):Pi(l)),g("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await ke()}catch(d){g("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function $l(e,t){if(await j("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?Bi(t):Ni(t)),g("Sucesso","Lançamento excluído!","success"),await ke()}catch(s){g("Erro",`Falha ao excluir: ${s.message}`,"error")}}async function El(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Di(t,a):qi(t,a)),g("Sucesso","Lançamento atualizado!","success"),await ke()}catch(s){g("Erro",`Falha ao atualizar status: ${s.message}`,"error")}}function So(e){const t=B.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function Sa(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(B.natures.map(i=>[i.id,i.name])),s=new Map(B.costCenters.map(i=>[i.id,i.name])),r=So(B.payables),o=So(B.receivables),n=(i,l)=>{const d=i.status==="paid",c=JSON.stringify(i).replace(/'/g,"&apos;"),u=i.naturezaId?a.get(i.naturezaId):"N/A",p=i.centroDeCustoId?s.get(i.centroDeCustoId):"N/A";let b=l==="payable"?"text-red-600":"text-green-600";const f=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",h=d?"Finalizado":"Pendente";return d&&(b="text-gray-500"),`
    ...
    `;if(a.innerHTML=`
        ...
        </div>`,a.style.display="flex",t){const p=a.querySelector('[name="naturezaId"]');p&&(p.value=t.naturezaId||"");const b=a.querySelector('[name="centroDeCustoId"]');b&&(b.value=t.centroDeCustoId||"")}const d=a.querySelector("#status"),c=a.querySelector("#payment-date-container"),u=a.querySelector('[name="paymentDate"]');t?.status==="paid"&&(d.checked=!0,c.classList.remove("hidden"),u.value=t.paymentDate||new Date().toISOString().split("T")[0]),d.addEventListener("change",()=>{c.classList.toggle("hidden",!d.checked),u.required=d.checked}),a.querySelector("#financial-form").addEventListener("submit",p=>Sl(p,e,t?.id))}async function Il(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth()-1,1).toISOString().split("T")[0],s=e.toISOString().split("T")[0];B.startDate=a,B.endDate=s,B.currentFilter="pending",B.filterNaturezaId="all",B.filterCostCenterId="all",xl.innerHTML=`
        <section>
    ...
    `;const r=document.getElementById("main-fab-btn"),o=document.getElementById("fab-menu");if(r&&o){r.addEventListener("click",h=>{h.stopPropagation(),o.classList.toggle("hidden"),r.classList.toggle("rotate-45")});const p=o.querySelector('button[data-action="open-modal"][data-type="receivable"]'),b=o.querySelector('button[data-action="open-modal"][data-type="payable"]'),f=o.querySelector('button[data-action="open-cash-flow-modal"]');p&&p.addEventListener("click",h=>{h.stopPropagation(),sa("receivable")}),b&&b.addEventListener("click",h=>{h.stopPropagation(),sa("payable")}),f&&f.addEventListener("click",h=>{h.stopPropagation(),ko()})}bt&&document.body.removeEventListener("click",bt),ft&&document.getElementById("genericModal").removeEventListener("click",ft);const n=()=>{const p=document.getElementById("filterStartDate"),b=document.getElementById("filterEndDate"),f=document.getElementById("filterNaturezaId"),h=document.getElementById("filterCostCenterId");if(!p)return;B.startDate=p.value,B.endDate=b.value,B.filterNaturezaId=f.value,B.filterCostCenterId=h.value;const w=document.getElementById("advanced-filters");w&&w.classList.contains("hidden")===!1&&window.innerWidth<768&&w.classList.add("hidden"),ke()},i=p=>{const b=p.target.closest("[data-status-filter]");if(!b)return;const f=b.dataset.statusFilter;B.currentFilter=f,document.querySelectorAll("[data-status-filter]").forEach(h=>{h.classList.remove("bg-blue-100","text-blue-800"),h.classList.add("bg-gray-100","text-gray-600")}),b.classList.remove("bg-gray-100","text-gray-600"),b.classList.add("bg-blue-100","text-blue-800"),Sa()},l=p=>{const b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),h=document.getElementById("btn-payables-view"),w=document.getElementById("btn-receivables-view");b&&(window.innerWidth>=1024&&B.currentListView===p||(p==="payables"?(b.classList.remove("hidden"),f.classList.add("hidden"),h&&(h.classList.remove("bg-gray-200"),h.classList.add("bg-red-100","border","border-red-500")),w&&(w.classList.remove("bg-green-100","border","border-green-500"),w.classList.add("bg-gray-200"))):(b.classList.add("hidden"),f.classList.remove("hidden"),h&&(h.classList.remove("bg-red-100","border","border-red-500"),h.classList.add("bg-gray-200")),w&&(w.classList.remove("bg-gray-200"),w.classList.add("bg-green-100","border","border-green-500"))),B.currentListView=p))};document.getElementById("applyDateFilterBtn").addEventListener("click",n),document.getElementById("filterNaturezaId").addEventListener("change",()=>{B.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{B.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(p=>{p.addEventListener("click",i)}),bt=p=>{const b=p.target.closest("button[data-action]");if(!b)return;const{action:f,type:h,id:w}=b.dataset;f==="edit"?sa(h,JSON.parse(b.dataset.item.replace(/&apos;/g,"'"))):f==="delete"?$l(h,w):f==="mark-as-paid"?El(h,w):f==="manage-natures"?yo("nature"):f==="manage-cost-centers"?yo("cost-center"):f==="open-cash-flow-modal"?ko():f==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):f==="open-indicators-modal"?wl():f==="open-settings-modal"?kl():f==="toggle-list-view"&&l(b.dataset.list)},ft=p=>{const b=p.target.closest('button[data-action^="delete-"]');if(b){const f=b.dataset.action.split("-")[1];d(f,b.dataset.id)}},document.body.addEventListener("click",bt),document.getElementById("genericModal").addEventListener("click",ft);async function d(p,b){const f=p==="nature",h=f?$i:Ii,w=f?nt:it,S=f?"natures":"costCenters",I=document.getElementById("hierarchyList");if(await j("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await h(b);const k=await w(m.establishmentId);B[S]=k,ms(I,Oa(k),p),await ke()}catch(k){g("Erro",`Não foi possível apagar: ${k.message}`,"error")}}const c=()=>{const p=window.innerWidth<1024,b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),h=document.getElementById("list-toggle-buttons");b&&f&&(b.classList.remove("hidden"),f.classList.remove("hidden"),p?(b.classList.remove("lg:col-span-1"),f.classList.remove("lg:col-span-1"),h?.classList.remove("hidden"),l(B.currentListView)):(b.classList.add("lg:col-span-1"),f.classList.add("lg:col-span-1"),h?.classList.add("hidden"),b.classList.remove("hidden"),f.classList.remove("hidden")))};c(),window.addEventListener("resize",c);const u=document.querySelector(`[data-status-filter="${B.currentFilter}"]`);u&&(document.querySelectorAll("[data-status-filter]").forEach(p=>{p.classList.remove("bg-blue-100","text-blue-800"),p.classList.add("bg-gray-100","text-gray-600")}),u.classList.remove("bg-gray-100","text-gray-600"),u.classList.add("bg-blue-100","text-blue-800"));try{const p=await Ri(m.establishmentId),b=document.getElementById("summary-today-payables");b&&(b.textContent=`R$ ${p.totalPayables.toFixed(2)}`);const f=document.getElementById("summary-today-receivables");f&&(f.textContent=`R$ ${p.totalReceivables.toFixed(2)}`)}catch{}await ke()}const Cl=e=>y("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),Ll=e=>y("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),Tl=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return y(`/api/commissions/stats?${a}`)},Bl=(e={})=>{Object.keys(e).forEach(s=>(e[s]===void 0||e[s]===null||e[s]==="")&&delete e[s]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return y(a)},Dl=e=>y(`/api/commissions/report/${e}`,{method:"DELETE"}),Mt=new Date,Eo=new Date(Mt.getFullYear(),Mt.getMonth(),1),P={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:Eo.toISOString().split("T")[0],dashEndDate:Mt.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:Eo.toISOString().split("T")[0],histEndDate:Mt.toISOString().split("T")[0],histProfessionalId:"all"};let ht=null;const We=document.getElementById("content");async function Pl(){try{P.professionals=await Q(m.establishmentId)}catch(e){console.error("Erro profissionais",e)}Vl(),Ml(),Yt(),Nt("dashboard")}function Ml(){ht&&We.removeEventListener("click",ht),ht=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,s=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":Nt(t.dataset.tab);break;case"toggle-all-profs":Al();break;case"back-to-filters":P.calculationResult=null,At(document.getElementById("commissions-content"));break;case"view-preview-items":zl(r);break;case"save-final-report":ql();break;case"start-new-calc":Nt("calculator");break;case"print-receipt":Fl(s);break;case"delete-report":Rl(s);break;case"filter-dashboard":Yt();break;case"filter-history":za();break}},We.addEventListener("click",ht),We.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Hl(t)}},We.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Nl())}}async function Yt(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(P.dashStartDate=e.value),t&&(P.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const s=await Tl(P.dashStartDate,P.dashEndDate);P.dashStats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0},P.currentTab==="dashboard"&&ps(document.getElementById("commissions-content"))}catch(s){console.error(s),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function za(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(P.histStartDate=e.value),t&&(P.histEndDate=t.value),a&&(P.histProfessionalId=a.value);const s=document.getElementById("history-list-container");if(s){s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await Bl({startDate:P.histStartDate,endDate:P.histEndDate,professionalId:P.histProfessionalId});P.historyData=r,gs(s,r)}catch{s.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Al(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function Nl(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(o=>o.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),s=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");P.periodString=`${a} a ${s}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const o=await Cl(t);P.calculationResult=o.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),At(r)}catch(o){g("Erro",o.message,"error"),P.calculationResult=null,At(r)}}async function ql(){const e=P.calculationResult.length;if(await j("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=P.calculationResult.map(s=>{const r=s.items.map(o=>o.originalSaleId).filter(o=>o!=null);return Ll({professionalId:s.professionalId,professionalName:s.professionalName,period:P.periodString,processedSalesIds:r,reportData:{...s,summary:{...s.summary,finalValue:s.finalValue,extraDebit:s.extraDebit||0,extraCredit:s.extraCredit||0,notes:s.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),P.calculationResult=null,Yt(),Nt("history")}catch(a){g("Erro",a.message,"error")}}function Fl(e){const t=P.historyData.find(a=>a.id===e);t&&jl(t)}async function Rl(e){if(await j("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Dl(e),g("Sucesso","Registro removido.","success"),za(),Yt()}catch(a){g("Erro",a.message,"error")}}function jl(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,s=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",s,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const o=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,o,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Hl(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let s=0,r=0;if(t.forEach(o=>{o.value&&(s=parseFloat(o.value))}),a.forEach(o=>{o.value&&(r=parseFloat(o.value))}),P.calculationResult&&P.calculationResult[e]){const o=P.calculationResult[e];o.extraDebit=s,o.extraCredit=r,o.finalValue=o.summary.totalCommission-s+r,t.forEach(i=>{i!==document.activeElement&&(i.value=s||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${o.finalValue.toFixed(2)}`),Ol()}}function Ol(){const e=P.calculationResult.reduce((a,s)=>a+s.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function zl(e){const t=P.calculationResult[e];if(!t)return;const a=t.items.map(s=>`
    ...
    `}function Ul(e){const t=P.professionals.map(a=>`<option value="${a.id}" ${P.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,P.historyData.length>0?gs(document.getElementById("history-list-container"),P.historyData):za()}function gs(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ra=document.getElementById("content");let Se={allPackages:[],catalogForModal:{services:[],products:[]}},xt=null,Ae=null;function _l(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Jl(){const e=document.getElementById("packagesListContainer");if(e){if(Se.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=Se.allPackages.map(t=>{const a=t.status==="active",s=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,o=t.originalPrice||0,n=o>r?o-r:0,i=o>0?(o-r)/o*100:0,l=v(t.name),d=v(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function Io(){const e=document.getElementById("genericModal");e.style.display="none",Ae&&e.removeEventListener("click",Ae)}async function Co(e=null){const t=document.getElementById("genericModal"),a=!!e,s=e?JSON.parse(JSON.stringify(e.items||[])):[],r=v(e?.name||""),o=v(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(b,f)=>{const h=f.querySelector("#originalPrice"),w=b.reduce((S,I)=>S+I.price*I.quantity,0);h&&(h.textContent=`R$ ${w.toFixed(2)}`)},p=b=>{b.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=b.map((f,h)=>{const w=f.type==="service",S=w?"Serviço":"Produto",I=w?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(b,t)};p(s),c.addEventListener("change",b=>{if(b.target.classList.contains("quantity-input")){const f=parseInt(b.target.dataset.index,10),h=parseInt(b.target.value,10);h>0&&s[f]&&(s[f].quantity=h,p(s))}}),c.addEventListener("click",b=>{if(b.target.classList.contains("remove-item-btn")){const f=parseInt(b.target.dataset.index,10);s.splice(f,1),p(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Wl(b=>{const f=s.find(h=>h.id===b.id&&h.type===b.type);f?f.quantity++:s.push({...b,quantity:1}),p(s)}),Ae&&t.removeEventListener("click",Ae),Ae=async b=>{const f=b.target.closest("button[data-action]");if(!f)return;const h=f.dataset.action;if(b.stopPropagation(),h==="close-modal"&&Io(),h==="save-package"){const w=f,S={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce((I,E)=>I+E.price*E.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!S.name||!S.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(S.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}w.disabled=!0,w.textContent="A salvar...";try{a?await Gr(S.id,S):(delete S.id,await Wr(S)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Io(),await Va()}catch(I){g("Erro",`Não foi possível salvar o pacote: ${I.message}`,"error"),w.disabled=!1,w.textContent="Salvar Pacote"}}},t.addEventListener("click",Ae)}function Wl(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=Se.catalogForModal.services.filter(f=>f.name.toLowerCase().includes(d)),u=Se.catalogForModal.products.filter(f=>f.name.toLowerCase().includes(d)),p=c.map(f=>`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:p}=d.dataset,f=(Se.catalogForModal[u+"s"]||[]).find(h=>h.id===p);f&&(e({...f,type:u}),i())}else(c||l.target===a)&&i()})}async function Va(){ra.innerHTML=`
    ...
    `,xt&&ra.removeEventListener("click",xt),xt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;j("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async o=>{if(o)try{await Yr(r),g("Sucesso!","Pacote excluído.","success"),await Va()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")Co(null);else if(a==="edit-package"){const s=JSON.parse(t.dataset.package);Co(s)}},ra.addEventListener("click",xt);try{const[e,t,a]=await Promise.all([Wo(m.establishmentId),Ie(m.establishmentId),jt(m.establishmentId)]);Se.allPackages=e,Se.catalogForModal={services:t.filter(s=>s.active),products:a},Jl()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Gl=document.getElementById("content");let Yl=null;async function Ql(){const e=v(m.userName||"Usuário"),t=v(Y.currentUser?.email||"E-mail não disponível"),a=m.userName?m.userName.charAt(0):"U";Gl.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await Xl()}async function Xl(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await Vs(t);Yl=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=v(a.name);e.innerHTML=`
            ...
            `,Zl(a.id),document.getElementById("my-blocks-filter").addEventListener("change",o=>qt(a.id,o.target.value)),qt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function Zl(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#blockDate").value,r=t.querySelector("#blockStartTime").value,o=t.querySelector("#blockEndTime").value,n=t.querySelector("#blockReason").value;if(!s||!r||!o){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(r>=o){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${s}T${r}:00`),l=new Date(`${s}T${o}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Ot({establishmentId:m.establishmentId,professionalId:e,reason:n||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;qt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),g("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function qt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const s=new Date;let r,o;t==="history"?(o=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let i=(await Ht(m.establishmentId,r.toISOString(),o.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),i.length>0?(a.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,p=v(l.reason||"Sem motivo");return`
                ...
                `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const c=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await Ba(c),g("Sucesso","Bloqueio removido.","success"),qt(e,t)}catch(u){console.error("Erro ao remover bloqueio:",u),g("Erro",`Não foi possível remover o bloqueio: ${u.message}`,"error")}})})):a.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(s){console.error("Erro ao carregar bloqueios:",s),a.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${v(s.message)}</p>`}}const yt=document.getElementById("loadingScreen"),na=document.getElementById("dashboardContent"),ia=document.getElementById("content"),Lo=document.getElementById("notificationBell"),la=document.getElementById("notificationBadge"),wt=document.getElementById("notificationPanel"),To=document.getElementById("notificationList"),da=document.getElementById("profileMenuButton"),te=document.getElementById("profileDropdown"),Kl=document.getElementById("profileName"),ed=document.getElementById("profileEmail"),td=document.getElementById("logoutButton"),ad=document.getElementById("cancellationHistoryBtn"),Bo=document.getElementById("myProfileLink"),Do={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let et=null,tt=[];const od={"agenda-section":_o,"comandas-section":Ma,"relatorios-section":mn,"servicos-section":Cn,"produtos-section":zn,"suppliers-section":Xn,"profissionais-section":Dt,"clientes-section":Gt,"estabelecimento-section":us,"ausencias-section":al,"users-section":Pt,"sales-report-section":hl,"financial-section":Il,"commissions-section":Pl,"packages-section":Va,"my-profile-section":Ql};function sd(e){const t=Do[e]||Do.indigo,s=(o=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function $a(){const e=tt.filter(t=>!t.read).length;if(e>0?(la.textContent=e,la.classList.remove("hidden")):la.classList.add("hidden"),tt.length===0){To.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}To.innerHTML=tt.map(t=>`
    ...
    `).join("")}function rd(e){et&&et();const t=pe(_,"establishments",e,"notifications"),a=Ft(t,at("timestamp",">=",new Date),Mo("timestamp","desc"));et=$s(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();tt.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(o.title,o.message,"info",!0),$a();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(o.type==="cancellation"||o.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),_o())}})},s=>{console.error("Erro no listener de notificações em tempo real:",s),g("Erro de Conexão","Não foi possível receber atualizações em tempo real. Verifique as regras de segurança do Firestore.","error")})}function ee(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=m.enabledModules?.[a]!==!1,o=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!r||!o){ia.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active"));return}}const s=od[e];s?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),ia.innerHTML="",s(t)):(ia.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`,console.warn(`Nenhum carregador de página definido para: ${e}`))}async function nd(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(o&&t&&t.classList.remove("hidden"),n&&a&&a.classList.remove("hidden"),!(!o&&!n))try{const i=await br();o&&s&&(s.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i),o&&s&&(s.textContent="Erro"),n&&r&&(r.textContent="Erro")}}async function id(e){try{ot.getPlatform()==="android"&&(await le.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal de notificação Android criado com sucesso."));let t=await le.checkPermissions();if(t.receive==="prompt"&&(t=await le.requestPermissions()),t.receive!=="granted"){console.warn("Permissão de notificação push foi negada pelo utilizador.");return}await le.register(),le.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const s=$e(_,"users",e);await No(s,{fcmToken:a.value}),console.log("Token FCM salvo no perfil do utilizador.")}catch(s){console.error("Erro ao salvar token FCM:",s)}}),le.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),le.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),g(a.title,a.body,"info",!0)}),le.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),ee("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function ld(){ot.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Ns(),Lo.addEventListener("click",e=>{e.stopPropagation(),wt.classList.toggle("hidden"),wt.classList.contains("hidden")||(tt.forEach(t=>t.read=!0),$a())}),ad.addEventListener("click",()=>{qs()}),da.addEventListener("click",e=>{e.stopPropagation(),te.classList.toggle("active"),te.classList.contains("active")?te.classList.remove("hidden"):setTimeout(()=>te.classList.add("hidden"),200)}),Bo&&Bo.addEventListener("click",e=>{e.preventDefault(),ee("my-profile-section"),te.classList.remove("active"),te.classList.add("hidden")}),document.addEventListener("click",e=>{!wt.contains(e.target)&&e.target!==Lo&&wt.classList.add("hidden"),!te.contains(e.target)&&e.target!==da&&te.classList.contains("active")&&(te.classList.remove("active"),setTimeout(()=>te.classList.add("hidden"),200))}),ws(Y,async e=>{if(e)try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const s=await Ee(a.establishmentId);m.enabledModules=s.modules,sd(s.themeColor||"indigo");let r=null,o=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=$e(_,"users",e.uid),c=await Ss(d);if(c.exists()){const u=c.data();r=a.role==="employee"?u.permissions||{}:null,o=u.name||o,n=u.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}m.userProfessionalId=n,id(e.uid);const i=o||e.email;Es(a.establishmentId,s.name,r),da.textContent=i.charAt(0).toUpperCase(),Kl.textContent=i,ed.textContent=e.email;const l=()=>{et&&et(),Ua(Y).then(()=>window.location.href="/login.html")};td.addEventListener("click",d=>{d.preventDefault(),l()}),Hs(ee,r,m.enabledModules),nd(r),rd(a.establishmentId),$a(),yt.classList.add("fade-out"),na.style.display="flex",setTimeout(()=>{yt.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{er()},1500),ee("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),yt.classList.add("fade-out"),setTimeout(()=>{yt.style.display="none"},500),na.innerHTML=`
                ...
                `,na.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{Ua(Y).then(()=>window.location.href="/login.html")})}else window.location.href="/login.html"})}ld();
