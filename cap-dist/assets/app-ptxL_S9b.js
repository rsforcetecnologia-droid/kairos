...
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as we,d as xe,m as Fs}from"./firebase-config-seH-87Om.js";import{EmailAuthProvider as _i,reauthenticateWithCredential as Vi,verifyBeforeUpdateEmail as Ui,updatePassword as Wi,updateProfile as Ji,setPersistence as Gi,browserLocalPersistence as Qi,onAuthStateChanged as Xi,signOut as Yi}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as je,getDoc as vs,updateDoc as Mt,setDoc as Zi,addDoc as Lo,collection as Ia,query as Co,where as Do,getDocs as Ki,deleteDoc as er,arrayUnion as tr,orderBy as ar,onSnapshot as sr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{a as C,e as v,s as G,b as f,c as Fe,r as Ea,f as Ra,i as or}from"./utils-DTVAHnIk.js";import{getToken as ir,onMessage as rr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const g={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function nr(t,e,a){g.establishmentId=t,g.establishmentName=e,g.userPermissions=a,g.currentViewContext={type:"BRANCH",id:t,name:e}}const La=(t,e,a,s=null)=>{let i=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(i+=`&professionalId=${s}`),C(i)},lr=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return C(s)},dr=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const i=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return C(i)},cr=t=>C("/api/appointments",{method:"POST",body:JSON.stringify(t)}),ur=(t,e)=>C(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),pr=t=>C(`/api/appointments/${t}`,{method:"DELETE"}),br=t=>C(`/api/appointments/${t}/reopen`,{method:"POST"}),mr=(t,e)=>C(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)}),ne=document.getElementById("sidebar"),We=document.getElementById("sidebarToggle"),St=document.getElementById("mainContent"),gr=document.querySelectorAll(".sidebar-link"),Qa=document.getElementById("menu-search"),Rs=document.getElementById("hamburger-menu-btn"),nt=document.getElementById("mobile-overlay");let Ae=!0;function Oe(t){if(!ne||!St)return;ne.classList.toggle("collapsed",t),St.classList.toggle("sidebar-collapsed-shift",t);const e=ne.querySelector(".sidebar-search-container"),a=ne.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const i=s.getAttribute("data-target-submenu"),o=document.getElementById(i),r=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),r&&r.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function fr(){!ne||!nt||(ne.classList.add("mobile-open"),nt.classList.add("visible"))}function Ft(){!ne||!nt||(ne.classList.remove("mobile-open"),nt.classList.remove("visible"))}function xr(){Oe(!ne.classList.contains("collapsed"))}function hr(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&ne.classList.contains("collapsed")&&Oe(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function vr(){Qa&&Qa.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),i=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),i.forEach(o=>o.style.display="block");return}i.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const r=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!r)return;if(r.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=r.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function yr(t,e,a){if(!ne||!St)return;St.classList.add("main-content-shift"),window.innerWidth>=1024?(Ae=!0,Oe(!1)):window.innerWidth>=768?(Ae=!1,Oe(!0)):(St.classList.remove("main-content-shift","sidebar-collapsed-shift"),Ft()),We&&We.addEventListener("click",i=>{i.stopPropagation(),window.innerWidth>=768?(Ae=!Ae,Oe(!Ae),Ae?(We.classList.add("text-indigo-400"),We.classList.remove("text-gray-400")):(We.classList.remove("text-indigo-400"),We.classList.add("text-gray-400"))):xr()}),ne.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Ae&&ne.classList.contains("collapsed")&&Oe(!1)}),ne.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Ae){const i=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===Qa;!i&&!o&&Oe(!0)}}),Rs&&Rs.addEventListener("click",i=>{i.stopPropagation(),fr()}),nt&&nt.addEventListener("click",i=>{i.stopPropagation(),Ft()});let s=0;ne.addEventListener("touchstart",i=>{s=i.changedTouches[0].screenX},{passive:!0}),ne.addEventListener("touchend",i=>{const o=i.changedTouches[0].screenX;s-o>50&&Ft()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(i=>{i.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const r=i.getAttribute("data-target-submenu"),n=i.querySelector(".submenu-arrow");hr(r,n)})}),vr(),gr.forEach(i=>{const o=i.getAttribute("data-target");if(!o)return;const r=o.replace("-section",""),n=a?.[r]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){i.parentElement&&i.parentElement.tagName==="LI"?i.parentElement.style.display="none":i.style.display="none";return}i.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),i.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&Ft()})})}const wr=t=>C("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),ke=()=>C("/api/establishments/hierarchy",{method:"GET"}),qe=t=>{const e=t||g.establishmentId;return e?C(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ys=(t,e)=>{const a=t||g.establishmentId;return a?C(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},kr=(t,e)=>{const a=t||g.establishmentId;return a?C(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Sr=(t,e)=>{const a=t||g.establishmentId;return a?C(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Ce=t=>C(`/api/professionals/${t}`),Po=t=>C(`/api/professionals/details/${t}`),$r=t=>C("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Xa=(t,e)=>C(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),To=t=>C(`/api/professionals/${t}`,{method:"DELETE"}),Ir=t=>{const e=t.map(a=>To(a));return Promise.all(e)};class Er{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const i=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${i.top+window.scrollY-o}px`,this.spotlight.style.left=`${i.left+window.scrollX-o}px`,this.spotlight.style.width=`${i.width+o*2}px`,this.spotlight.style.height=`${i.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(i)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
    ...
    `}async function Go(t,e){const a=document.getElementById("chart-container"),s=document.getElementById("chart-start-date"),i=document.getElementById("chart-end-date");if(a){const o=document.createElement("div");o.id="chart-loading-overlay",o.className="absolute inset-0 bg-white/70 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-xl",o.innerHTML='<div class="w-8 h-8 border-[3px] border-indigo-100 border-t-indigo-500 rounded-full animate-spin"></div>',a.appendChild(o)}try{const o=Se(t),r=Se(e),n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=await Ta({startDate:o,endDate:r,establishmentId:l}).catch(()=>({entries:[]})),u=n.map(P=>La(P,o+"T00:00:00.000Z",r+"T23:59:59.999Z",null).catch(()=>[])),p=(await Promise.all(u)).flat(),b=d.entries||[],m=[],h=[],y=[];let S=new Date(t);S.setHours(0,0,0,0);const L=new Date(e);for(L.setHours(23,59,59,999);S<=L;){const P=Se(S);m.push(S.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}));const k=b.filter(B=>B.status==="paid"&&(B.paymentDate===P||!B.paymentDate&&B.dueDate.startsWith(P))).reduce((B,U)=>B+U.amount,0),I=p.filter(B=>B.status==="completed"&&B.startTime&&B.startTime.startsWith(P)).length;h.push(k),y.push(I),S.setDate(S.getDate()+1)}pn(m,h,y),s&&(s.value=o),i&&(i.value=r)}catch(o){console.error("Erro ao recarregar grafico:",o)}finally{const o=document.getElementById("chart-loading-overlay");o&&o.remove()}}function pn(t,e,a){const s=document.getElementById("revenueChart");if(!s)return;Oa&&Oa.destroy();const o=s.getContext("2d").createLinearGradient(0,0,0,240);o.addColorStop(0,"rgba(99, 102, 241, 0.2)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)"),Oa=new Chart(s,{type:"line",data:{labels:t,datasets:[{label:"Receita Real (R$)",data:e,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.3,yAxisID:"y"},{label:"Agendamentos Feitos",data:a,borderColor:"#10b981",backgroundColor:"transparent",borderWidth:2,borderDash:[5,5],pointBackgroundColor:"#10b981",pointBorderColor:"#ffffff",pointBorderWidth:1,pointRadius:3,pointHoverRadius:5,fill:!1,tension:.3,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,boxHeight:6,font:{family:"Nunito, sans-serif",size:10,weight:"bold"},color:"#64748b"}},tooltip:{backgroundColor:"#1e293b",padding:10,cornerRadius:8,titleFont:{size:11,family:"Nunito, sans-serif",weight:"normal"},bodyFont:{size:12,weight:"bold",family:"Nunito, sans-serif"},displayColors:!0,usePointStyle:!0,callbacks:{label:function(r){return r.datasetIndex===0?"Receita: "+new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(r.parsed.y):"Concluídos: "+r.parsed.y}}}},scales:{y:{type:"linear",display:!0,position:"left",beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"},maxTicksLimit:6,callback:function(r){return"R$ "+r}}},y1:{type:"linear",display:!0,position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1},border:{display:!1},ticks:{color:"#10b981",font:{family:"Nunito, sans-serif",size:9,weight:"600"},stepSize:1,callback:function(r){if(Math.floor(r)===r)return r}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"}}}},interaction:{intersect:!1,mode:"index"}}})}function bn(){document.getElementById("content").addEventListener("click",e=>{if(e.target.closest("#btn-update-chart")){const o=document.getElementById("chart-start-date"),r=document.getElementById("chart-end-date");if(o&&r&&o.value&&r.value){const n=new Date(o.value+"T00:00:00"),l=new Date(r.value+"T00:00:00");Go(n,l)}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"goto-agenda":case"new-appointment":ie("agenda-section");break;case"goto-pdv":ie("comandas-section");break;case"goto-clients":ie("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${g.establishmentId||""}`;window.open(o,"_blank");break}})}const Ue=t=>C(`/api/services/${t}`),mn=t=>C("/api/services",{method:"POST",body:JSON.stringify(t)}),gn=(t,e)=>C(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Qo=t=>C(`/api/services/${t}`,{method:"DELETE"}),Ba=(t,e,a,s="all")=>{const i=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return C(i)},Ma=t=>C("/api/blockages",{method:"POST",body:JSON.stringify(t)}),$s=t=>C(`/api/blockages/${t}`,{method:"DELETE"}),Xo=t=>C("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Us=document.getElementById("content");let Ws=!1;const ga=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Aa=[],Ya=[],fa={},Yo=[],z={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},R={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Zo(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function ia(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}function Is(){const t=document.getElementById("profSelectorContainer");if(!t||!g.professionals)return;let e=g.professionals.filter(i=>z.showInactiveProfs||i.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(i=>{const o=z.selectedProfessionalId===i.id,r=i.name==="Todos"?"T":i.name.charAt(0).toUpperCase(),n=i.id!=="all"?g.professionalColors.get(i.id)||ga[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        `}t.innerHTML=s,t.querySelectorAll('[data-action="select-date"]').forEach(o=>{o.addEventListener("click",()=>{const r=new Date(o.dataset.date);z.currentDate=r,navigator.vibrate&&navigator.vibrate(30),Pe()})}),requestAnimationFrame(()=>{const o=t.querySelector(".bg-indigo-600");o&&o.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})})}function X(t){return v(t||"")}function xn(t,e,a,s,i){const o=(t||"").replace(/\D/g,""),r=new Date(i).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(i).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${e}! Você tem um agendamento de ${a} com ${s} para ${r} às ${n}. Podemos confirmar?`;return`https://wa.me/${o}?text=${encodeURIComponent(l)}`}function hn(t){const e=document.getElementById("agenda-view");if(!e)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=Zo(z.currentDate),i=new Date;i.setHours(0,0,0,0);let o='<div class="week-container flex gap-2 overflow-x-auto hide-scrollbar px-4" id="weekScroller">';for(let r=0;r<7;r++){const n=new Date(s);n.setDate(s.getDate()+r);const l=n.toDateString()===i.toDateString(),d=t.filter(c=>new Date(c.startTime).toDateString()===n.toDateString()).sort((c,p)=>new Date(c.startTime)-new Date(p.startTime));let u="";d.length===0?u='<div class="week-empty text-xs text-gray-400 text-center py-4 bg-gray-50 rounded-lg border border-dashed border-gray-200"><i class="bi bi-dash-lg block text-lg mb-1"></i>Livre</div>':u=d.map(c=>{const b=new Date(c.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),m=g.professionalColors.get(c.professionalId)||{main:"#adb5bd"},h=c.status==="completed",y=z.selectedItems.has(c.id),S=c.coveredByPlan;if(c.type==="blockage")return`<div class="week-event-chip bg-red-50 border-l-4 border-red-500 rounded-md p-2 mb-2">
                    ...
                    </div>`;const L=JSON.stringify(c).replace(/'/g,"&apos;"),P=y?"ring-2 ring-indigo-500 bg-indigo-50":"bg-white",k=z.isSelectionMode?`<div class="absolute top-1 right-1 z-10">
                           <input type="checkbox" class="w-4 h-4 accent-indigo-600 pointer-events-none" ${y?"checked":""}>
                       </div>`:"";return`<div class="week-event-chip relative shadow-sm border-l-4 rounded-md p-2 mb-2 cursor-pointer transition-transform active:scale-95 ${h?"opacity-60":""} ${P}" style="border-left-color: ${m.main};"
                    ...
                    <div class="text-xs text-gray-800 font-semibold mt-0.5 truncate pr-2">
                        ${X(c.clientName)} 
                        ${S?'<i class="bi bi-gem text-indigo-500 ml-1" title="Cliente VIP"></i>':""}
                    </div>
            ...
            </div>`;return}let a='<div class="list-container px-4 py-2 space-y-4">';t.forEach(s=>{const i=new Date(s.startTime),o=new Date(s.endTime),r=Math.round((o-i)/6e4),n=i.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=g.professionalColors.get(s.professionalId)||{main:"#adb5bd"},d=s.status==="completed",u=JSON.stringify(s).replace(/'/g,"&apos;"),c=z.selectedItems.has(s.id),p=z.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-100 mr-3">
            ...
            </div>`;return}const m=xn(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),h=(s.services||[]).reduce((I,B)=>I+(Number(B.price)||0),0)||Number(s.servicePrice||0),y=s.totalAmount!==void 0?Number(s.totalAmount):h,L=s.coveredByPlan?'<span class="bg-indigo-100 text-indigo-700 text-[9px] px-1.5 py-0.5 rounded border border-indigo-200 font-black uppercase tracking-wider ml-1 flex-shrink-0" title="Coberto pelo Plano VIP"><i class="bi bi-gem mr-0.5"></i> VIP</span>':"",P=s.paymentStatus||(s.status==="completed"?"Finalizado":"Agendado"),k=X((s.professionalName||"").split(" ")[0]);a+=`<div class="list-card flex rounded-2xl p-3.5 shadow-sm border border-gray-100 cursor-pointer transition-transform active:scale-95 ${b} ${d?"opacity-70 bg-gray-50":""}"
            ...
            <div class="flex-1 pl-3.5 flex flex-col justify-center min-w-0">
                ...
                <div class="flex flex-wrap gap-1.5 mt-2.5">
                    ...
                    <span class="text-[0.65rem] px-2 py-0.5 rounded border font-bold ${d?"bg-green-50 text-green-700 border-green-200":"bg-amber-50 text-amber-700 border-amber-200"}">${X(P)}</span>
                </div>
            </div>
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function Ko(){const t=g.allEvents.filter(e=>z.selectedProfessionalId==="all"||e.professionalId===z.selectedProfessionalId);z.currentView==="list"?vn(t):hn(t),Es()}function Es(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(z.isSelectionMode&&z.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function yn(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(z.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(z.currentView==="list"){fn();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function Pe(){const t=document.getElementById("agenda-view");if(!t)return;z.selectedItems.clear(),Es(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',yn();let e,a;if(z.currentView==="list")e=new Date(z.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=Zo(z.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const i=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async d=>{const[u,c]=await Promise.all([La(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId==="all"?null:z.selectedProfessionalId),Ba(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId)]);return{appts:u||[],blockages:c||[]}}),o=await Promise.all(i);let r=[],n=[];if(o.forEach(d=>{r=r.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(u=>({...u,type:u.type||"appointment",professionalName:u.professionalName||(()=>{const c=g.professionals?.find(p=>p.id===u.professionalId);return c?c.name:"Indefinido"})()}));g.allEvents=[...l(r),...l(n)],Is(),Ko()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function wn(){try{const e=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async r=>{const[n,l,d]=await Promise.all([Ce(r),Ue(r),qe(r)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,i=new Map;let o=a[0]?.estDetails;a.forEach(r=>{r.profs.forEach(n=>s.set(n.id,n)),r.services.forEach(n=>i.set(n.id,n))}),g.professionals=Array.from(s.values()),g.services=Array.from(i.values()),Yo=[],o&&(fa=o.loyaltyProgram||{enabled:!1}),g.professionals.forEach((r,n)=>{g.professionalColors.set(r.id,ga[n%ga.length])}),Is()}catch{f("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function ei(t={}){z.currentDate=t.targetDate?new Date(t.targetDate):z.currentDate||new Date,z.isSelectionMode=!1,z.selectedItems.clear(),Us.innerHTML=`
        ...
        </div>`,document.getElementById("btnTodayHeader").addEventListener("click",()=>{z.currentDate=new Date,navigator.vibrate&&navigator.vibrate(30),Pe()}),document.getElementById("btnPrevDate").addEventListener("click",()=>{const a=z.currentView==="week"?7:1;z.currentDate.setDate(z.currentDate.getDate()-a),navigator.vibrate&&navigator.vibrate(20),Pe()}),document.getElementById("btnNextDate").addEventListener("click",()=>{const a=z.currentView==="week"?7:1;z.currentDate.setDate(z.currentDate.getDate()+a),navigator.vibrate&&navigator.vibrate(20),Pe()});const e=document.querySelectorAll(".agenda-view-toggle button");e.forEach(a=>{a.addEventListener("click",()=>{e.forEach(s=>{s.classList.remove("bg-white","shadow-sm"),s.classList.add("text-gray-500")}),a.classList.add("bg-white","shadow-sm"),a.classList.remove("text-gray-500"),z.currentView=a.dataset.view,navigator.vibrate&&navigator.vibrate(20),Pe()})}),document.getElementById("btnWeekDays").addEventListener("click",kn),Ws||(Us.addEventListener("click",async a=>{const s=a.target.closest('[data-action="open-comanda"]');if(s){a.stopPropagation(),navigator.vibrate&&navigator.vibrate(20);const l=s.dataset.appointment||s.closest("[data-appointment]")?.dataset.appointment;if(!l)return;const d=JSON.parse(l.replace(/&apos;/g,"'")),u=d.status==="completed"?"finalizadas":"em-atendimento",c={selectedAppointmentId:d.id,initialFilter:u};u==="finalizadas"&&d.transaction?.paidAt&&(c.filterDate=typeof d.transaction.paidAt=="object"?new Date(d.transaction.paidAt._seconds*1e3):d.transaction.paidAt),ie("comandas-section",c);return}const i=a.target.closest(".lc-action-btn.wa");if(i){a.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),i.dataset.link&&window.open(i.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const l=z.selectedItems.size;await G("Apagar Selecionados",`Deseja apagar ${l} registro(s)? Esta ação é irreversível.`)&&(await Promise.all(Array.from(z.selectedItems).map(async u=>{try{await pr(u)}catch{}})),f(`${l} registro(s) apagado(s).`,"success"),z.selectedItems.clear(),z.isSelectionMode=!1,Pe());return}const o=a.target.closest('[data-action="select-professional"]');if(o){navigator.vibrate&&navigator.vibrate(20);const l=o.dataset.profId;z.selectedProfessionalId=z.selectedProfessionalId===l&&l!=="all"?"all":l,Pe();return}const r=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(r){if(z.isSelectionMode){a.stopPropagation();const d=r.querySelector('input[type="checkbox"]');if(d){const u=JSON.parse(r.dataset.appointment.replace(/&apos;/g,"'")),c=!d.checked;d.checked=c,c?z.selectedItems.add(u.id):z.selectedItems.delete(u.id),(r.classList.contains("week-event-chip")||r.classList.contains("list-card"))&&(c?(r.classList.add("ring-2","ring-indigo-500","bg-indigo-50"),r.classList.remove("bg-white")):(r.classList.remove("ring-2","ring-indigo-500","bg-indigo-50"),r.classList.add("bg-white"))),navigator.vibrate&&navigator.vibrate(15),Es()}return}const l=JSON.parse(r.dataset.appointment.replace(/&apos;/g,"'"));navigator.vibrate&&navigator.vibrate(20),Za(l);return}if(a.target.closest('[data-action="new-appointment"]')){navigator.vibrate&&navigator.vibrate(30),Za();return}}),Ws=!0),await wn(),await Pe()}function kn(){const t=document.getElementById("optionsSheet");if(t){t.remove();return}const e=document.createElement("div");e.id="optionsSheet",e.className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white rounded-t-3xl z-[10000] shadow-[0_-8px_40px_rgba(0,0,0,0.15)] transition-transform duration-300 translate-y-full";const a=z.isSelectionMode?"bg-red-50 text-red-600":"bg-green-50 text-green-700",s=z.isSelectionMode?"bi-x-circle":"bi-check2-square";e.innerHTML=`
        <div class="px-6 py-5">
        ...
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            ...
            <div id="apptServicesContainer" class="flex-1 overflow-y-auto grid grid-cols-2 gap-3 content-start pb-4">
                ${Aa.map(t=>`<div class="service-card p-3 bg-white rounded-xl border-2 transition-all active:scale-95 ${R.data.selectedServiceIds.includes(t.id)?"border-indigo-500 bg-indigo-50 shadow-md":"border-gray-100 hover:border-gray-200 shadow-sm"} cursor-pointer flex flex-col justify-between gap-2" data-service-id="${t.id}">
                        <div>
        ...
        </div>`}}function En(){const t=R.data.date||ia();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
    ...
    `,qa(),Ds()}function Ds(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function qa(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierFromPreviousDay?(t&&(t.innerHTML=`
        ...
        `,i.appendChild(I)}),t.innerHTML="",t.appendChild(i),Zs(e)}function Zs(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=x.paging,i=Math.ceil((a||0)/s);if(i===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full py-1",o.innerHTML=`
    ...
    `;t.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-36 md:pb-6 custom-scrollbar bg-slate-50 relative"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(r).map(L=>{const P=L.sources&&L.sources.includes("original_service"),k=x.pendingRedemption&&String(x.pendingRedemption.appliedToItemId)===String(L.id),I=L.isReward||k;return`
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto custom-scrollbar pr-2">
                        ...
                        ${Object.entries(P).sort((k,I)=>I[1]-k[1]).map(([k,I])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${k}</span><span class="text-[11px] font-bold text-slate-800">${ce(I)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                    </div>
                </div>
            </div>
        </div>`,setTimeout(()=>{const k=document.getElementById("chartFin");k&&(Nt("fin"),j.charts.fin=new Chart(k,{type:"bar",data:{labels:n.length?n:["-"],datasets:[{label:"Receita Realizada",data:d,backgroundColor:"#10b981",stack:"Stack 0",borderRadius:3,order:2},{label:"Receita Prevista",data:u,backgroundColor:"#6ee7b7",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Realizada",data:c,backgroundColor:"#ef4444",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Prevista",data:p,backgroundColor:"#fca5a5",stack:"Stack 0",borderRadius:3,order:2},{label:"Saldo Acumulado",data:b,type:"line",borderColor:"#4f46e5",backgroundColor:"#4f46e5",tension:.4,borderWidth:2,pointRadius:3,yAxisID:"y1",order:1}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{callbacks:{label:function(I){let B=I.dataset.label||"";return B&&(B+=": "),I.parsed.y!==null&&(B+=ce(Math.abs(I.parsed.y))),B},footer:function(I){const B=I[0].dataIndex,U=r[B],D=o[U];if(!D)return"";const O=D.recReal+D.recPrev-(D.despReal+D.despPrev);return`
Saldo Dia: `+ce(O)+`
(Clique para ver)`}}}},onClick:(I,B)=>{if(B.length>0){const U=B[0].index,D=B[0].datasetIndex,O=r[U];let H="all";D===0||D===1?H="receita":(D===2||D===3)&&(H="despesa"),cl(O,H,o[O].items,i)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:I=>ce(Math.abs(I))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:I=>ce(I)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(I=>{I.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",I.onclick=B=>{const U=B.currentTarget,D=parseInt(U.dataset.dataset),O=j.charts.fin;O.isDatasetVisible(D)?(O.hide(D),U.style.opacity="0.4",U.style.background="#f8f9fa"):(O.show(D),U.style.opacity="1",U.style.background="")}}))},100)}function cl(t,e,a,s){let i=document.getElementById("genericModal");i||(i=document.createElement("div"),i.id="genericModal",i.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(i));const o=e==="all"?a:a.filter(l=>l._type===e);let r=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";i.innerHTML=`
    ...
    `}function yt(){const t=document.getElementById("servicesList");if(!t)return;if(_.services===null){t.innerHTML=bi(8);return}const e=ui(),a=_.services.filter(i=>{const o=i.name.toLowerCase().includes(_.searchQuery);let r=!0;_.statusFilter==="active"&&(r=i.active!==!1),_.statusFilter==="inactive"&&(r=i.active===!1);const n=_.filterCategoryId==="all"||i.categoryId===_.filterCategoryId,l=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],d=e.some(u=>l.includes(u));return o&&r&&n&&d});if(kl(a),a.length===0){_.services.length===0?t.innerHTML=`
        ...
        `;return e}async function Sl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=_.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await di({establishmentId:g.establishmentId,name:s,accessibleIn:o},"services"),re(g.establishmentId,ot(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await Ps(),await dt()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function $l(t){if(await G("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ci(t,"services"),re(g.establishmentId,ot(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await Ps(),await dt()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function Ps(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await Na(g.establishmentId,"services");_.categories=e,e.length>0?t.innerHTML=e.map(a=>`
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Sl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),$l(i.dataset.id))}))}Ps()}function El(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
            ...
            </div>`;let e='<div class="space-y-2 mt-1 max-h-48 overflow-y-auto custom-scrollbar pr-2">';return _.hierarchyCache.forEach(a=>{const s=t.includes(a.id)||t.length===0&&a.id===g.establishmentId;e+=`
    ...
    `}function Re(){const t=document.getElementById("productsList");if(!t)return;if(E.products===null){t.innerHTML=fi(8);return}const e=Ts(),a=E.products.filter(i=>{const o=i.name.toLowerCase().includes(E.searchQuery)||i.sku&&i.sku.toLowerCase().includes(E.searchQuery)||i.barcode&&i.barcode.toLowerCase().includes(E.searchQuery),r=i.currentStock||0,n=i.minStock||0;let l=!0;E.stockFilter==="ok"&&(l=r>0&&(n===0||r>n*1.2)),E.stockFilter==="alert"&&(l=n>0&&r>0&&r<=n*1.2),E.stockFilter==="empty"&&(l=r<=0);const d=E.filterCategoryId==="all"||i.categoryId===E.filterCategoryId,u=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],c=e.some(p=>u.includes(p));return o&&l&&d&&c});if(Nl(a),a.length===0){E.products.length===0?t.innerHTML=`
            ...
            </div>`}).join("")}function fi(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;return e}async function Fl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=E.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await di({establishmentId:g.establishmentId,name:s,accessibleIn:o},"products"),re(g.establishmentId,_e(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await Bs(),await Ee()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function Rl(t){if(await G("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ci(t,"products"),re(g.establishmentId,_e(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await Bs(),await Ee()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function Bs(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await Na(g.establishmentId,"products");E.categories=e,e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-white p-3 rounded-xl border border-slate-200 mb-2 shadow-sm">
                    <span class="text-xs font-black text-slate-700 uppercase tracking-widest">${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-white w-8 h-8 flex items-center justify-center bg-red-50 hover:bg-red-600 rounded-lg transition-colors border border-red-100 active:scale-95"><i class="bi bi-trash3 pointer-events-none"></i></button>
    ...
    `,e.querySelectorAll(".tab-link").forEach(T=>{T.addEventListener("click",A=>{A.preventDefault(),e.querySelectorAll(".tab-link").forEach(q=>{q.classList.remove("active","border-indigo-600","text-indigo-600"),q.classList.add("border-transparent","text-slate-400")}),T.classList.add("active","border-indigo-600","text-indigo-600"),T.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(q=>q.classList.add("hidden")),e.querySelector("#"+T.dataset.tab).classList.remove("hidden")})});const L=()=>{const T=document.getElementById("modalSupplierSearch"),A=document.getElementById("supplierSearchResults"),q=document.getElementById("selectedSuppliersList"),Z=T?.value.toLowerCase()||"",ee=E.suppliers||[];if(Z.length>0){const se=ee.filter(Y=>Y.name.toLowerCase().includes(Z)&&!E.tempSupplierIds.has(Y.id));se.length>0?(A.classList.remove("hidden"),A.innerHTML=se.map(Y=>`
                    <div class="p-3.5 hover:bg-indigo-50 cursor-pointer border-b border-slate-100 last:border-0 flex justify-between items-center transition-colors" data-add-supplier="${Y.id}">
                        <span class="font-bold text-xs text-slate-700 uppercase tracking-widest">${v(Y.name)}</span>
                ...
                `).join("")):(A.classList.remove("hidden"),A.innerHTML='<div class="p-4 text-xs font-bold text-slate-500 text-center uppercase tracking-widest">Fornecedor não encontrado.</div>')}else A&&A.classList.add("hidden");E.tempSupplierIds.size>0?(q.classList.remove("justify-center"),q.classList.add("justify-start"),q.innerHTML="",E.tempSupplierIds.forEach(se=>{const Y=ee.find(N=>N.id===se);Y&&(q.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border border-slate-200 p-3.5 rounded-xl shadow-sm hover:border-indigo-200 transition-colors" data-id="${Y.id}">
                            <div>
                                <p class="font-black text-slate-800 text-xs uppercase tracking-widest mb-1">${v(Y.name)}</p>
                                <p class="text-[9px] font-bold text-slate-500 uppercase tracking-widest"><i class="bi bi-person mr-1"></i> ${v(Y.contactName||"N/I")} | <i class="bi bi-telephone mr-1"></i> ${v(Y.phone||"N/I")}</p>
                            </div>
                            <button type="button" class="text-slate-400 hover:text-red-600 w-10 h-10 flex items-center justify-center hover:bg-red-50 rounded-lg transition-colors border border-transparent hover:border-red-100 active:scale-95" data-remove-supplier="${Y.id}" title="Remover">
                                <i class="bi bi-trash3 pointer-events-none"></i>
                            </button>
                        </div>
                    `)})):(q.classList.add("justify-center"),q.classList.remove("justify-start"),q.innerHTML='<p class="text-[10px] text-slate-400 text-center font-bold uppercase tracking-widest">Nenhum fornecedor adicionado ainda.</p>')},P=document.getElementById("modalSupplierSearch");P&&P.addEventListener("input",L),L();const k=e.querySelector("#productPhotoInput"),I=e.querySelector("#productPhotoButton"),B=e.querySelector("#productPhotoContainer"),U=e.querySelector("#productPhotoPreview"),D=e.querySelector("#productPhotoBase64"),O=()=>k?.click();I&&I.addEventListener("click",O),B&&B.addEventListener("click",O),k&&(k.onchange=async()=>{const T=k.files[0];if(!T)return;const A=U.src;U.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const q=await Ea(T,800,800,.8);if(q.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");U.src=q,D.value=q}catch(q){f("Erro de Imagem",q.message,"error"),U.src=A,D.value=a?.photo||""}});const H=document.getElementById("productForm");H&&(H.onsubmit=async T=>{T.preventDefault();const A=e.querySelector('button[type="submit"]'),q=A.innerHTML,Z=document.getElementById("productName"),ee=document.getElementById("productPrice");if(!Z?.value||!ee?.value){f("Aviso","Preencha o Nome e o Preço do produto.","warning");return}const se=parseInt(document.getElementById("productCurrentStock")?.value||"0",10),Y=parseInt(document.getElementById("productMinStock")?.value||"0",10),N=Array.from(document.querySelectorAll('#productForm input[name="accessibleIn"]:checked')).map(W=>W.value),te=N.length>0?N:[g.establishmentId],le={...E.tempProduct,establishmentId:g.establishmentId,accessibleIn:te,name:Z.value.trim(),sku:document.getElementById("productSku")?.value.trim()||"",barcode:document.getElementById("productBarcode")?.value.trim()||"",price:parseFloat(ee.value),costPrice:parseFloat(document.getElementById("productCostPrice")?.value)||0,commissionRate:parseFloat(document.getElementById("productCommissionRate")?.value)||0,currentStock:isNaN(se)?0:se,minStock:isNaN(Y)?0:Y,categoryId:document.getElementById("productCategory")?.value||null,photo:document.getElementById("productPhotoBase64")?.value||"",description:document.getElementById("productDescription")?.value.trim()||"",active:document.getElementById("productStatusToggle")?.checked!==!1,supplierIds:Array.from(E.tempSupplierIds)};A.disabled=!0,A.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> A gravar...';try{s?(await oi(t,le),re(g.establishmentId,_e(),"Produtos","Editou",`Editou o produto: ${le.name}`),f("Sucesso","Produto atualizado com sucesso!","success")):(delete le.id,await si(le),re(g.establishmentId,_e(),"Produtos","Criou",`Criou novo produto: ${le.name}`),f("Sucesso","Produto adicionado à rede!","success")),ra(),await Ee()}catch(W){f("Erro",W.message,"error"),A.disabled=!1,A.innerHTML=q}}),Ml()}async function Vl(){if(!(E.selectedIds.size===0||!await G("Excluir Produtos",`Tem a certeza que deseja excluir ${E.selectedIds.size} produtos do seu inventário?`)))try{const e=Array.from(E.selectedIds).map(a=>Ls(a));await Promise.all(e),f("Sucesso","Produtos excluídos com sucesso.","success"),E.selectedIds.clear(),ls(),await Ee()}catch(e){f("Erro","Não foi possível apagar os produtos: "+e.message,"error")}}async function Ul(){if(!(E.selectedMovementIds.size===0||!await G("Estornar e Excluir",`Deseja excluir as ${E.selectedMovementIds.size} movimentações selecionadas? O saldo de stock será estornado/devolvido ao sistema automaticamente.`)))try{const e=Array.from(E.selectedMovementIds).map(async a=>{const s=E.allMovements.find(i=>i.id===a);s&&await ja(s.productId,{change:-s.change,reason:"Estorno automático de exclusão em lote",establishmentId:s.establishmentId})});await Promise.all(e),f("Sucesso","Movimentações excluídas e stocks estornados.","success"),E.selectedMovementIds.clear(),$t(),xa()}catch(e){f("Erro","Ocorreu um erro ao estornar em lote: "+e.message,"error")}}async function xa(){const t=document.getElementById("report-results");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full"><div class="loader"></div></div>',E.selectedMovementIds.clear(),$t();const e={startDate:document.getElementById("reportStartDate")?.value||"",endDate:document.getElementById("reportEndDate")?.value||"",productId:document.getElementById("productFilterReport")?.value||"all",categoryId:document.getElementById("categoryFilterReport")?.value||"all"};try{const s=Ts().map(n=>ii({...e,establishmentId:n}).catch(l=>[])),i=await Promise.all(s);let o=[];if(i.forEach(n=>{if(!n)return;const l=Array.isArray(n)?n:Array.isArray(n.data)?n.data:Array.isArray(n.movements)?n.movements:[];o=o.concat(l)}),o.sort((n,l)=>_a(l.date)-_a(n.date)),E.allMovements=o,o.length===0){t.innerHTML=`
    ...
    `}function Ql(){const t=Object.entries(ha).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=xi.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Xl(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(ha).map(([r,n])=>`<option value="${r}" ${a===r?"selected":""}>${n.label}</option>`).join(""),i=xi.map(r=>`<option value="${r}" ${t?.state===r?"selected":""}>${r}</option>`).join(""),o=document.getElementById("form-container-wrapper");o&&(o.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Zl))}function hi(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
        ...
        <div class="h-full flex w-full relative overflow-hidden bg-slate-50">
            <section id="professionals-layout-main" class="flex-1 flex flex-col p-4 md:pl-6 md:pr-6 md:pt-6 w-full relative overflow-y-auto custom-scrollbar">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-3 animate-fade-in w-full">
                    <div class="relative w-full md:w-96 flex-shrink-0">
                        <i class="bi bi-search absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 text-sm"></i>
                        <input type="text" id="searchInput" value="${V.searchQuery}" placeholder="Nome ou especialidade..." class="w-full pl-9 pr-3 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all shadow-sm text-sm font-semibold text-slate-700">
                    </div>
    ...
    `}async function va(){const t=document.getElementById("professionalsList"),e=yi();try{const a=e.map(l=>Ce(l)),s=e.map(l=>Ue(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),V.professionals=Array.from(r.values()),g.professionals=V.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),V.services=Array.from(n.values()),od(),wt()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function od(){const t=document.getElementById("filterServiceId");t&&V.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',V.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),V.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function wi(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=V.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function id(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,i=a-s;e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function wt(){const t=document.getElementById("professionalsList");if(!t)return;if(V.professionals===null){t.innerHTML=ki(8);return}const e=yi(),a=V.professionals.filter(s=>{const i=s.name.toLowerCase().includes(V.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(V.searchQuery);let o=!0;V.statusFilter==="active"&&(o=s.status!=="inactive"),V.statusFilter==="inactive"&&(o=s.status==="inactive");const r=V.filterServiceId==="all"||s.services&&s.services.includes(V.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||g.establishmentId],l=e.some(d=>n.includes(d));return i&&o&&r&&l});if(id(a),a.length===0){V.professionals.length===0?t.innerHTML=`
                <div class="col-span-full flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-slate-300 shadow-sm">
                    <div class="w-16 h-16 bg-indigo-50 rounded-full flex items-center justify-center mb-4 border border-indigo-100">
            ...
            `;return}t.innerHTML=a.map(s=>{const i=s.status==="inactive",o=v(s.name),r=v(s.specialty||"Especialidade"),n=s.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(s.name?s.name.charAt(0):"P")}`,l=s.accessibleIn?s.accessibleIn.length:1,d=s.services?s.services.length:0,u=V.selectedIds.has(s.id);return`
            ...
            </div>`}).join("")}function ki(t=8){let e="";for(let a=0;a<t;a++)e+=`
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm flex items-center p-4 animate-pulse h-[98px]">
        ...
        `;return e}async function rd(t){V.viewMode="edit-professional";const e=document.getElementById("prof-modal-inner");if(!e)return;let a={name:"",specialty:"",status:"active",workingHours:{},services:[]};if(t){const r=V.professionals.find(n=>String(n.id)===String(t));r&&(a=JSON.parse(JSON.stringify(r)))}V.tempProf=a;const s=!!a.id,i=v(a.name||"Novo Profissional"),o=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
            <button data-action="close-detail-screen" class="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 text-slate-500 flex items-center justify-center hover:bg-slate-100 hover:text-slate-800 transition-colors active:scale-95 mr-4">
                <i class="bi bi-arrow-left text-lg"></i>
            </button>
    ...
    `,nd(a,V.services),dd(a),await ud(a,V.professionals),pd(a),td()}function nd(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const i=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,b=p==i[1]?"selected":"",m=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${m.charAt(0).toUpperCase()+m.slice(1)}</option>`}).join(""),r=v(t.name||""),n=v(t.specialty||""),l=v(t.phone||""),d=v(t.notes||"");a.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-1 space-y-4">
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-center flex flex-col items-center">
    ...
    `}function ld(t=[]){if(!V.hierarchyCache||V.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${g.establishmentId}">
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-500 text-center">
                <i class="bi bi-info-circle text-2xl block mb-2 text-slate-400"></i> Exclusivo desta unidade.
            </div>`;let e='<div class="space-y-2 mt-1">';return V.hierarchyCache.forEach(a=>{const s=t.includes(a.id)||t.length===0&&a.id===g.establishmentId;e+=`
            <label class="flex items-center space-x-3 p-3 cursor-pointer bg-slate-50 hover:bg-white border border-slate-200 hover:border-indigo-300 rounded-xl transition-colors shadow-sm">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-5 h-5 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500" ${s?"checked":""}>
                <span class="text-xs md:text-sm font-black text-slate-800">🏢 ${v(a.name)}</span>
            </label>
        ...
        <div class="bg-white p-5 md:p-8 rounded-3xl border border-slate-200 shadow-sm">
        ...
        </div>`,cd(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function cd(t,e){t.innerHTML=Object.keys(eo).map(a=>{const s=e[a]||{},i=s.active!==!1;return`
            <div class="day-schedule-card p-4 md:p-5 rounded-2xl ${i?"bg-white border-slate-200 shadow-sm":"bg-slate-50 border-slate-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-4">
                    <span class="font-black text-sm text-slate-800 uppercase tracking-wider flex items-center gap-2"><i class="bi bi-calendar-day text-slate-400"></i> ${eo[a]}</span>
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-[10px] font-bold text-red-500 p-4 bg-red-50 rounded-xl border border-red-100">${s.message}</p>`}}}function pd(t){const e=document.getElementById("prof-modal-inner");if(!e)return;const a=e.querySelectorAll(".tab-link");a.forEach(p=>{p.addEventListener("click",b=>{b.preventDefault(),a.forEach(y=>{y.classList.remove("active","border-indigo-600","text-indigo-600"),y.classList.add("border-transparent","text-slate-400")}),p.classList.add("active","border-indigo-600","text-indigo-600"),p.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.add("hidden"));const m=p.dataset.tab,h=e.querySelector("#"+m);h&&h.classList.remove("hidden")})});const s=e.querySelector("#profPhotoInput"),i=e.querySelector("#profPhotoButton"),o=e.querySelector("#profPhotoContainer"),r=e.querySelector("#profPhotoPreview"),n=e.querySelector("#profPhotoBase64"),l=t.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,d=t.photo||"",u=()=>s.click();i&&i.addEventListener("click",u),o&&o.addEventListener("click",u),s&&(s.onchange=async()=>{const p=s.files[0];if(p){r.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const b=await Ea(p,800,800,.8);if(b.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");r.src=b,n.value=b}catch(b){f("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),r.src=l,n.value=d,s.value=""}}});const c=e.querySelector("#selectAllServicesBtn");if(c){c.addEventListener("click",()=>{const b=e.querySelectorAll('#profServicesContainer input[type="checkbox"]'),m=Array.from(b).every(h=>h.checked);b.forEach(h=>{h.checked=!m}),c.textContent=m?"Selecionar Todos":"Desmarcar Todos"});const p=e.querySelectorAll('#profServicesContainer input[type="checkbox"]');p.length>0&&Array.from(p).every(b=>b.checked)&&(c.textContent="Desmarcar Todos")}}function bd(){Jt&&document.body.removeEventListener("click",Jt),Gt&&ds.removeEventListener("input",Gt),Jt=async t=>{if(t.target.classList.contains("professional-checkbox")){const o=t.target.dataset.id;t.target.checked?V.selectedIds.add(o):V.selectedIds.delete(o),wi(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){V.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600"),wt();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterServiceId").value="all",V.filterServiceId="all",wt();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),V.filterServiceId=document.getElementById("filterServiceId").value,wt();return}const a=t.target.closest("#toggle-filter-btn");if(a){t.preventDefault(),V.isAdvancedFilterOpen=!V.isAdvancedFilterOpen;const o=document.getElementById("filter-panel");V.isAdvancedFilterOpen?(o.classList.remove("hidden"),o.classList.add("block"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200")):(o.classList.add("hidden"),o.classList.remove("block"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"));return}const s=t.target.closest("[data-action]");if(!s){t.target.id==="professionals-layout-detail"&&Qt();return}const i=s.dataset.action;switch(["close-detail-screen","delete-professional","save-professional","delete-blockage","batch-delete-blockage"].includes(i)&&t.stopPropagation(),i){case"open-professional-editor":rd(s.dataset.id);break;case"close-detail-screen":Qt(),V.tempProf=null;break;case"batch-delete":md();break;case"delete-professional":{const o=s.dataset.id,r=V.tempProf?.name||"Profissional";if(await G("Excluir Profissional",`Tem certeza que deseja excluir ${r}? Esta ação não pode ser desfeita.`))try{await To(o),re(g.establishmentId,la(),"Equipe","Excluiu",`Excluiu profissional: ${r}`),f("Sucesso!","Profissional excluído da rede.","success"),Qt(),va()}catch(l){f("Erro",`Não foi possível excluir: ${l.message}`,"error")}break}case"save-professional":{const o=document.getElementById("prof-modal-inner"),r=s,n=o.querySelector("#profScheduleContainer"),l=Array.from(o.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map(S=>S.value),d={};n&&n.querySelectorAll(".day-schedule-card").forEach(S=>{const L=S.querySelector('[data-field="active"]').dataset.day;d[L]={active:S.querySelector('[data-field="active"]').checked,start:S.querySelector('[data-field="start"]').value,end:S.querySelector('[data-field="end"]').value,breakStart:S.querySelector('[data-field="breakStart"]').value,breakEnd:S.querySelector('[data-field="breakEnd"]').value}});const u=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(S=>S.value),c=u.length>0?u:[g.establishmentId],p=o.querySelector("#profStatusToggle").checked,b=o.querySelector("#profCommissionToggle").checked,m=o.querySelector("#profShowOnAgendaToggle").checked,h={...V.tempProf,id:o.querySelector("#professionalId").value||void 0,accessibleIn:c,name:o.querySelector("#profName").value.trim(),specialty:o.querySelector("#profSpecialty").value,photo:o.querySelector("#profPhotoBase64").value,services:l,workingHours:d,phone:o.querySelector("#profPhone").value,dob:`${o.querySelector("#profDobDay").value}/${o.querySelector("#profDobMonth").value}`,receivesCommission:b,showOnAgenda:m,orderOnAgenda:parseInt(o.querySelector("#profOrderOnAgenda").value)||1,notes:o.querySelector("#profNotes").value,status:p?"active":"inactive",establishmentId:g.establishmentId},y=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{h.id?(await Xa(h.id,h),re(g.establishmentId,la(),"Equipe","Editou",`Editou o profissional: ${h.name}`),f("Sucesso!","Dados atualizados.","success")):(delete h.id,await $r(h),re(g.establishmentId,la(),"Equipe","Criou",`Cadastrou o profissional: ${h.name}`),f("Sucesso!","Novo membro adicionado à equipe.","success")),Qt(),va()}catch(S){f("Erro",S.message,"error"),r.disabled=!1,r.innerHTML=y}break}case"delete-blockage":{const o=s.dataset.id;if(await G("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await $s(o),f("Bloqueio removido.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Et(V.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}case"batch-delete-blockage":{const o=JSON.parse(s.dataset.ids);if(await G("Apagar em Lote",`Tem certeza que deseja apagar ${o.length} dias de bloqueio de uma vez?`))try{await Xo(o),f("Bloqueios removidos.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Et(V.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}}},document.body.addEventListener("click",Jt),Gt=t=>{t.target.id==="searchInput"&&(V.searchQuery=t.target.value,wt())},ds.addEventListener("input",Gt)}function md(){G("Excluir em Lote",`Tem certeza que deseja excluir ${V.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await Ir(Array.from(V.selectedIds)),re(g.establishmentId,la(),"Equipe","Excluiu em Lote",`Excluiu ${V.selectedIds.size} profissionais`),f("Sucesso!",`${V.selectedIds.size} profissionais foram excluídos.`,"success"),V.selectedIds.clear(),wi(),va()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}let w={clients:[],selectedClient:null,establishments:[],filterEstablishmentIds:new Set,isAdvancedFilterOpen:!1,filters:{search:"",inactiveDays:"",hasLoyalty:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:50,historyData:{appointments:[],sales:[],loyaltyLog:[],subscriptions:[]}},tt=null,Xt=null,Yt=null;const Ms=t=>t?String(t).replace(/\D/g,""):"",cs=t=>{if(!t)return"Nunca";let e;if(typeof t=="object"&&(t.seconds||t._seconds)){const a=t.seconds||t._seconds;e=new Date(a*1e3)}else e=new Date(t);return isNaN(e.getTime())?"Data Inválida":e.toLocaleDateString("pt-BR")},us=t=>{if(!t)return"CL";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()};function gd(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function Ve(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),w.selectedClient=null}async function fd(){tt=document.getElementById("content"),w.selectedClient=null,w.selectedIds.clear(),w.isAdvancedFilterOpen=!1,w.filters={search:"",inactiveDays:"",hasLoyalty:!1,status:"all"},w.sortConfig={key:"name",direction:"asc"};try{const e=(await ke().catch(()=>({matrizes:[]}))).matrizes||[];w.establishments=[],e.forEach(a=>{w.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>w.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia",t)}xd(),yd(),await As()}function xd(){const t=w.establishments.map(e=>`
    ...
    `}async function As(){w.loading=!0;const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-slate-500 font-bold text-[10px] uppercase tracking-widest">Carregando clientes...</p></div>');try{const a=Array.from(w.filterEstablishmentIds).map(r=>{let n=`/api/clients/${r}?limit=1000`;return C(n).catch(()=>[])}),i=(await Promise.all(a)).flat(),o=new Map;i.forEach(r=>o.set(r.id,r)),w.clients=Array.from(o.values()),he()}catch(e){console.error(e),f("Erro","Falha ao carregar clientes.","error"),t&&(t.innerHTML='<div class="text-center py-10 text-red-500 font-bold text-sm">Erro ao carregar dados.</div>')}finally{w.loading=!1}}function vd(t){const e=document.getElementById("summary-section");if(!e)return;const a=new Date().getMonth()+1,s=new Date().getFullYear(),i=t.length;let o=0,r=0,n=0;t.forEach(l=>{if(l.totalDebt&&parseFloat(l.totalDebt)>0&&r++,l.dobMonth==a&&n++,l.createdAt){const d=new Date(l.createdAt);d.getMonth()+1===a&&d.getFullYear()===s&&o++}}),e.innerHTML=`
    ...
    `}function he(){hd();const t=document.getElementById("list-container");let e=w.clients;if(w.filters.search){const a=w.filters.search.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(w.filters.status==="devendo")e=e.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(w.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;e=e.filter(s=>s.dobMonth==a)}else if(w.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();e=e.filter(i=>{if(!i.createdAt)return!1;const o=new Date(i.createdAt);return o.getMonth()+1===a&&o.getFullYear()===s})}if(w.filters.hasLoyalty&&(e=e.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),w.filters.inactiveDays){const a=parseInt(w.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),e=e.filter(i=>{if(!i.lastVisit&&!i.createdAt)return!1;let o;if(i.lastVisit){const r=i.lastVisit.seconds||i.lastVisit._seconds;o=r?new Date(r*1e3):new Date(i.lastVisit)}else o=new Date(i.createdAt);return o<s})}if(e.sort((a,s)=>{let i,o;switch(w.sortConfig.key){case"name":return i=(a.name||"").toLowerCase(),o=(s.name||"").toLowerCase(),w.sortConfig.direction==="asc"?i.localeCompare(o):o.localeCompare(i);case"contact":return i=a.phone||"",o=s.phone||"",w.sortConfig.direction==="asc"?i.localeCompare(o):o.localeCompare(i);case"lastVisit":i=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,o=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":i=parseFloat(a.totalDebt)||0,o=parseFloat(s.totalDebt)||0;break;default:i=a.name,o=s.name}return i<o?w.sortConfig.direction==="asc"?-1:1:i>o?w.sortConfig.direction==="asc"?1:-1:0}),vd(e),e.length===0){t.innerHTML=`
            ...
            </div>`;return}t.innerHTML=e.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,i=cs(a.lastVisit),o=Ms(a.phone),r=new Date().getMonth()+1,n=a.dobMonth==r,l=w.selectedIds.has(a.id);let d="";return n&&(d+='<span class="bg-indigo-50 text-indigo-700 text-[8px] font-black px-1.5 py-0.5 rounded border border-indigo-200 uppercase tracking-wider shadow-sm flex items-center gap-1"><i class="bi bi-gift-fill"></i> Niver</span> '),a.loyaltyPoints>0&&(d+=`<span class="bg-amber-50 text-amber-700 text-[8px] font-black px-1.5 py-0.5 rounded border border-amber-200 uppercase tracking-wider shadow-sm flex items-center gap-1"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
    ...
    `,t.querySelectorAll(".tab-link").forEach(l=>{l.addEventListener("click",d=>{d.preventDefault(),t.querySelectorAll(".tab-link").forEach(u=>{u.classList.remove("active","border-indigo-600","text-indigo-600"),u.classList.add("border-transparent","text-slate-400")}),l.classList.add("active","border-indigo-600","text-indigo-600"),l.classList.remove("border-transparent","text-slate-400"),t.querySelectorAll(".tab-content").forEach(u=>u.classList.add("hidden")),t.querySelector("#"+l.dataset.tab).classList.remove("hidden")})});const r=t.querySelector("#form-edit-client");r&&(r.onsubmit=Ed);const n=t.querySelector('[data-action="delete-client"]');n&&(n.onclick=Ld)}function Sd(t){const e=new Date,a=t.filter(o=>new Date(o.date)>=e&&o.status!=="cancelled").sort((o,r)=>new Date(o.date)-new Date(r.date)),s=t.filter(o=>new Date(o.date)<e||o.status==="cancelled").sort((o,r)=>new Date(r.date)-new Date(o.date)),i=(o,r)=>{const n=new Date(o.date);let l=r?'<span class="text-slate-500 bg-slate-100 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-slate-200 shadow-sm">Concluído</span>':'<span class="text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-emerald-200 shadow-sm">Confirmado</span>';o.status==="cancelled"&&(l='<span class="text-red-600 bg-red-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-red-200 shadow-sm">Cancelado</span>');const d=w.establishments.find(u=>u.id===o.establishmentId)?.name||"Unidade Local";return`
    ...
    `}function Si(t,e){return e.sort((a,s)=>new Date(s.date)-new Date(a.date)),`
        <div class="space-y-6">
    ...
    `;const h=e.querySelector("#mockup-screen-wrapper"),y=e.querySelector("#mockup-screen"),S=e.querySelector("#previewPrimaryColorInput"),L=e.querySelector("#previewBgColorInput"),P=e.querySelector("#previewTextColorInput"),k=e.querySelector("#previewTitleColorInput"),I=e.querySelector("#typographyInput"),B=e.querySelector("#establishmentWelcomeMessage"),U=e.querySelector("#mockup-welcome"),D=e.querySelector("#socialInstagram"),O=e.querySelector("#socialWhatsapp"),H=e.querySelector("#socialFacebook"),T=e.querySelector("#prevTemplate"),A=e.querySelector("#nextTemplate"),q=e.querySelector("#templateNameDisplay"),Z=e.querySelector("#selectedTemplateId"),ee=W=>{const Q=de[W];h.style.opacity="0.3",h.style.transform="scale(0.96)",setTimeout(()=>{S.value=Q.primary,L.value=Q.bg,P.value=Q.text,k.value=Q.titleColor||Q.text,I.value=Q.font,e.querySelectorAll('input[name="buttonStyle"]').forEach(ge=>{ge.checked=ge.value===Q.btn}),Z.value=Q.id,q.textContent=Q.name,y.style.setProperty("--preview-primary",Q.primary),y.style.setProperty("--preview-bg",Q.bg),y.style.setProperty("--preview-text",Q.text),y.style.setProperty("--preview-title-color",Q.titleColor||Q.text),y.style.setProperty("--preview-font",Q.font),y.style.setProperty("--preview-btn-radius",m(Q.btn)),y.style.setProperty("--preview-card-bg",Q.cardBg),y.style.setProperty("--preview-card-border",Q.cardBorder),h.style.opacity="1",h.style.transform="scale(1)"},300)};T.addEventListener("click",()=>{b=(b-1+de.length)%de.length,ee(b)}),A.addEventListener("click",()=>{b=(b+1)%de.length,ee(b)}),S.addEventListener("input",W=>y.style.setProperty("--preview-primary",W.target.value)),L.addEventListener("input",W=>y.style.setProperty("--preview-bg",W.target.value)),P.addEventListener("input",W=>y.style.setProperty("--preview-text",W.target.value)),k.addEventListener("input",W=>y.style.setProperty("--preview-title-color",W.target.value)),I.addEventListener("change",W=>y.style.setProperty("--preview-font",W.target.value)),e.querySelectorAll('input[name="buttonStyle"]').forEach(W=>{W.addEventListener("change",Q=>{Q.target.checked&&y.style.setProperty("--preview-btn-radius",m(Q.target.value))})}),B.addEventListener("input",W=>U.textContent=W.target.value||"Mensagem...");const se=()=>{e.querySelector("#mockup-insta-icon").classList.toggle("hidden",!D.value.trim()),e.querySelector("#mockup-whats-icon").classList.toggle("hidden",!O.value.trim()),e.querySelector("#mockup-face-icon").classList.toggle("hidden",!H.value.trim())};[D,O,H].forEach(W=>W.addEventListener("input",se));const Y=e.querySelector("#establishmentLogoInput"),N=e.querySelector("#establishmentBgInput"),te=e.querySelector("#establishmentLogoBase64"),le=e.querySelector("#establishmentBackgroundImageBase64");e.querySelector("#triggerLogoUpload").addEventListener("click",W=>{W.target.id!=="establishmentLogoInput"&&Y.click()}),Y.onchange=async W=>{const Q=W.target.files[0];if(Q){const ge=await ao(Q,300,.9);e.querySelector("#establishmentLogoPreview").src=ge,e.querySelector("#mockup-logo").src=ge,te.value=ge}},e.querySelector("#triggerBannerUpload").addEventListener("click",W=>{W.target.id!=="establishmentBgInput"&&N.click()}),N.onchange=async W=>{const Q=W.target.files[0];if(Q){const ge=await ao(Q,1280,.8);e.querySelector("#establishmentBgPreview").src=ge,e.querySelector("#establishmentBgPreview").classList.remove("hidden"),e.querySelector("#establishmentBgPlaceholder").classList.add("hidden"),le.value=ge,e.querySelector("#mockup-banner").src=ge,e.querySelector("#mockup-banner").classList.remove("hidden"),e.querySelector("#mockup-banner-placeholder").classList.add("hidden")}},e.querySelector("#branding-form").addEventListener("submit",W=>{W.preventDefault();let Q="rounded";e.querySelectorAll('input[name="buttonStyle"]').forEach(Ns=>{Ns.checked&&(Q=Ns.value)});const ge={logo:te.value,backgroundImage:le.value,welcomeMessage:B.value,templateId:Z.value,primaryColor:S.value,backgroundColor:L.value,textColor:P.value,titleColor:k.value,typography:I.value,buttonStyle:Q,socialLinks:{instagram:D.value.trim(),whatsapp:O.value.trim(),facebook:H.value.trim()}};gt(ge,W)})}function Ad(t,e){const a=t.urlId||oe;let s=window.location.origin;(s.includes("localhost")||s.includes("capacitor://")||s.includes("127.0.0.1"))&&(s="https://www.kairosagenda.com.br");const i=v(`${s}/agendar?id=${a}`),o=t.publicBookingEnabled||!1,r=o?"Agendamento Online ATIVO":"Agendamento Online INATIVO",n=o?"text-green-600":"text-red-600";e.innerHTML=`
    ...
    `;const n=e.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const u=document.createElement("div");u.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const c=d.type||"money",p=d.itemId||"",b=d.reward||"",m=d.discount||"",h=d.points||d.costPoints||"";u.innerHTML=`
        ...
        `;const y=u.querySelector(".type-select"),S=u.querySelector(".item-select"),L=u.querySelector(".desc-input"),P=u.querySelector(".discount-input"),k=I=>{S.innerHTML='<option value="">Selecione...</option>';let B=[];I==="service"?B=i:I==="product"?B=o:I==="package"&&(B=r),B.forEach(U=>{const D=U.id===p,O=U.name||U.title||"Sem nome",H=U.price||U.salePrice||0;S.innerHTML+=`<option value="${U.id}" data-price="${H}" ${D?"selected":""}>${v(O)}</option>`})};return c!=="money"&&k(c),y.addEventListener("change",I=>{const B=I.target.value;B==="money"?(S.classList.add("hidden"),L.classList.remove("hidden"),L.value="",P.value=""):(S.classList.remove("hidden"),L.classList.add("hidden"),k(B),P.value="")}),S.addEventListener("change",I=>{const B=I.target.selectedOptions[0];if(B&&B.value){L.value=B.text;const U=B.dataset.price;U&&(P.value=parseFloat(U).toFixed(2))}}),u};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),e.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const u=d.target.closest(".remove-loyalty-tier");u&&u.closest(".loyalty-tier-row").remove()}),e.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const u=Array.from(e.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(p=>{const b=p.querySelector(".type-select").value,m=b==="money"?null:p.querySelector(".item-select").value;let h=b==="money"?p.querySelector(".desc-input").value:p.querySelector(".item-select").options[p.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,type:b,itemId:m,reward:h,name:h,discount:parseFloat(p.querySelector('input[data-field="discount"]').value)||0}}),c={loyaltyProgram:{enabled:e.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(e.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:u.filter(p=>p.points>0&&p.reward)}};gt(c,d)})}async function Nd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([Pa(oe),ks(oe)]),i=t.financialIntegration||{},o=t.commissionConfig||{},r=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=Ge(a,i.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=Ge(s,i.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=Ge(a,r.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=Ge(s,r.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=Ge(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=Ge(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};gt(s,a)})}function Fd(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `,ze.querySelector('button[data-action="back-to-menu"]').addEventListener("click",i=>{i.preventDefault(),Ci({id:oe})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":Pd(K,s);break;case"change-password":Td(K,s);break;case"change-email":Bd(K,s);break;case"branding":Md(K,s);break;case"booking":Ad(K,s);break;case"working-hours":jd(K,s);break;case"whatsapp-bot":Li(K,s);break;case"loyalty":await qd(K,s);break;case"financial":await Nd(K,s);break;case"pagarme":Ii(s);break;case"support":Fd(K,s);break;case"cancellation":Rd(K,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Ci(t={}){ze.innerHTML=`
    ...
    `;try{oe=t.id||g.establishmentId,K=await qe(oe);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=K.isMatriz||!K.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=Ei();ze.innerHTML=`
    ...
    `).join("")}const Lt=document.getElementById("content");async function it(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,i=await Ba(g.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),r=o?i.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):i,n=r.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",r.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;u.innerHTML+=P}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function _d(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,i=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,r=e.querySelector("#blockageEndTime").value,n={establishmentId:g.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Ma(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),it(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Vd(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,i=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,r=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:g.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:n};return Ma(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&it(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Ud(t){Lt.addEventListener("submit",e=>{e.target.id==="blockageForm"&&_d(e),e.target.id==="batchBlockageForm"&&Vd(e)}),Lt.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&it(t)}),Lt.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")ie("profissionais-section");else if(s==="delete-blockage"){if(await G("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await $s(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),it(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const i=JSON.parse(a.dataset.ids);if(await G("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${i.length} bloqueios de uma vez?`))try{await Xo(i),f("Sucesso",`${i.length} bloqueios removidos.`,"success"),it(t)}catch(r){f("Erro",`Não foi possível apagar os bloqueios: ${r.message}`,"error")}}})}async function Wd(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){Lt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);Lt.innerHTML=`
        <section>
        ...
        </section>`,Ud(e),await it(e);const i=document.getElementById("batchProfSelectionContainer");try{const o=await Ce(g.establishmentId);i.innerHTML=o.map(r=>`
            <div class="flex items-center">
        ...
        `}).join("")}function Pi(){const e=document.getElementById("showInactiveUsersToggle")?.checked?g.users:g.users.filter(a=>a.status==="active");tc(e)}function ac(t={}){let e="",a=!1;for(const[s,i]of Object.entries(Kd)){const o=Object.entries(i).filter(([r,n])=>{const l=r.replace("-section","");return!(g.enabledModules&&g.enabledModules[l]===!1)});o.length!==0&&(a=!0,e+=`
    ...
    `,Zt&&ft.removeEventListener("click",Zt),Kt&&ft.removeEventListener("change",Kt),Qe&&(window.removeEventListener("kairos:contextChanged",Qe),document.removeEventListener("change",Qe)),Qe=t=>{(t.type==="kairos:contextChanged"||t.target.closest("#multi-context-list"))&&document.getElementById("user-list-view")&&!document.getElementById("user-list-view").classList.contains("hidden")&&ro()},window.addEventListener("kairos:contextChanged",Qe),document.addEventListener("change",Qe),Zt=async t=>{const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":io();break;case"edit-user":const s=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));io(s);break;case"back-to-list":ya();break;case"delete-user":{if(t.stopPropagation(),await G("Excluir Usuário","O usuário perderá totalmente o acesso ao sistema. Confirma?"))try{await Xd(e.dataset.userId),f("Usuário excluído com sucesso.","success"),ya()}catch(i){f(`Erro: ${i.message}`,"error")}break}}},Kt=async t=>{if(t.target.id==="showInactiveUsersToggle"){const e=t.target.nextElementSibling,a=e.nextElementSibling;t.target.checked?(e.classList.replace("bg-slate-200","bg-indigo-500"),a.classList.add("transform","translate-x-5")):(e.classList.replace("bg-indigo-500","bg-slate-200"),a.classList.remove("transform","translate-x-5")),Pi()}else{const e=t.target.closest('input[data-action="toggle-user-status"]');if(e){t.stopPropagation();const a=e.dataset.userId,s=e.checked?"active":"inactive",i=e.nextElementSibling,o=i.nextElementSibling;e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"));try{await Zd(a,s);const r=g.users.findIndex(n=>n.id===a);if(r>-1){g.users[r].status=s;const n=e.closest(".user-card-clickable");s==="inactive"?n.classList.add("opacity-60","bg-slate-50"):n.classList.remove("opacity-60","bg-slate-50")}}catch(r){f(`Erro: ${r.message}`,"error"),e.checked=!e.checked,e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"))}}}},ft.addEventListener("click",Zt),ft.addEventListener("change",Kt),await ro()}const sc=document.getElementById("content");let no={},bs=null;function oc(){Object.values(no).forEach(t=>t?.destroy()),no={}}function ic(t,e){if(!window.jspdf){f("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),i=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(t,s.internal.pageSize.getWidth()/2,40,{align:"center"}),i){const r=[["Receita Total",i.querySelector("#summary-revenue").textContent],["Vendas Totais",i.querySelector("#summary-transactions").textContent],["Ticket Médio",i.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:r,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${e}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function lo(t){const e=document.getElementById("genericModal"),a=v(t.client),s=v(t.items),i=v(t.responsavelCaixa||"N/A"),o=(t.payments||[]).map(r=>`
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=bs.transactions[l];d&&lo(d)})}),r.innerHTML=a.map((n,l)=>{const d=v(n.client),u=v(n.items),c=v(n.type);return`
    ...
    `}).join(""),r.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=bs.transactions[l];d&&lo(d)})})}async function co(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,i=a.value;if(!s||!i)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,r=await ma({establishmentId:g.establishmentId,startDate:s,endDate:i,cashierSessionId:o});bs=r,t.innerHTML=`
        ...
        `,rc(r)}catch(o){f("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function nc(){oc();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];sc.innerHTML=`
        ...
        `};t.innerHTML=e.map(i=>s(i)).join("")}async function uo(t){const e=document.getElementById("genericModal"),a=t==="nature",s=a?"Plano de Naturezas":"Centros de Custo",i=a?Pa:ks,o=a?en:tn,r=a?"natures":"costCenters";e.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",e.innerHTML=`
    ...
    `,Ai()}function uc(){const t=$.currentTab==="receivables",e=t?$.receivables:$.payables;let a=e;if($.statusFilter!=="all"&&(a=e.filter(n=>{const l=ct(n.dueDate,n.status);return $.statusFilter==="overdue"?l:$.statusFilter==="pending"?n.status==="pending"&&!l:n.status===$.statusFilter})),$.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes($.searchQuery)||n.entity&&n.entity.toLowerCase().includes($.searchQuery)||n.notes&&n.notes.toLowerCase().includes($.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map($.natures.map(n=>[n.id,n.name])),i=new Map($.costCenters.map(n=>[n.id,n.name])),o=new Map($.establishments.map(n=>[n.id,n])),r=a.map(n=>{const l=n.status==="paid",d=ct(n.dueDate,n.status);let u=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const c=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?i.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=o.get(n.establishmentId),m=b?b.name:"Atual",h=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:m,Natureza:c,"Centro de Custo":p,Origem:h,"Documento / NFS":n.documentNumber||"",Status:u,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(r),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const u=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,u)}catch(n){console.error("Erro ao exportar:",n),f("Erro","Não foi possível exportar para Excel.","error")}}function pc(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i.bi-chevron-expand, i.bi-chevron-up, i.bi-chevron-down");if(!e)return;t.dataset.sort===$.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=$.sortAsc?"bi bi-chevron-up ml-1 text-indigo-600 text-[11px] font-black":"bi bi-chevron-down ml-1 text-indigo-600 text-[11px] font-black"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-chevron-expand ml-1 opacity-40 text-[10px] font-black")})}function Mi(){document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",r=>{const n=r.currentTarget.dataset.sort;$.sortCol===n?$.sortAsc=!$.sortAsc:($.sortCol=n,$.sortAsc=!0),Ct()})});const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");$.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&$.selectedIds.add(l.value)}),at()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{$.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),at()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=$.selectedIds.size;if(o===0)return;if(await G("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const n=$.currentTab==="payables"?"payables":"receivables";await Uo(n,Array.from($.selectedIds)),f("Sucesso",`${o} itens excluídos.`,"success"),$.selectedIds.clear(),at(),Me()}catch{f("Erro","Falha ao excluir itens.","error")}}),document.getElementById("custom-date-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");$.isAdvancedFilterOpen=!$.isAdvancedFilterOpen,$.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))});const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",uc);const a=document.getElementById("settings-btn");a&&a.addEventListener("click",gc),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(20),bo(r.target.closest("button").dataset.type)})});const s=document.getElementById("tab-receivables"),i=document.getElementById("tab-payables");s.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),po("receivables")}),i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),po("payables")}),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-gray-900","bg-blue-600","bg-emerald-600","bg-red-600","text-white"),l.classList.add("bg-white","text-gray-600")});const n=r.target.dataset.status;n==="all"?r.target.classList.add("bg-gray-900","text-white"):n==="pending"?r.target.classList.add("bg-blue-600","text-white"):n==="paid"?r.target.classList.add("bg-emerald-600","text-white"):n==="overdue"&&r.target.classList.add("bg-red-600","text-white"),r.target.classList.remove("bg-white","text-gray-600"),$.statusFilter=n,Ct()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=u.toISOString().split("T")[0],$.startDate=d.toISOString().split("T")[0],$.endDate=u.toISOString().split("T")[0],Me()})}),document.getElementById("searchInput").addEventListener("input",o=>{$.searchQuery=o.target.value.toLowerCase(),Ct()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",Bi(),Mi(),Me()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(20),$.startDate=document.getElementById("filterStartDate").value,$.endDate=document.getElementById("filterEndDate").value,$.filterNaturezaId=document.getElementById("filterNaturezaId").value,$.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("custom-date-btn").click(),Me()}),ea&&document.body.removeEventListener("click",ea),ea=o=>{const r=o.target;if(r.classList.contains("item-checkbox")||r.classList.contains("modal-item-checkbox")){const d=r.value||r.dataset.id;r.checked?$.selectedIds.add(d):$.selectedIds.delete(d),at(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){const{action:d,type:u,id:c}=n.dataset;if(d==="mark-as-paid"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),bc(u,c);return}if(d==="delete"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(30);const p=n.closest(".financial-row").dataset.item;try{qi(u,JSON.parse(decodeURIComponent(p)))}catch(b){console.error("Parse error on delete",b)}return}if(d==="manage-natures"){o.stopPropagation(),uo("nature");return}if(d==="manage-cost-centers"){o.stopPropagation(),uo("cost-center");return}if(d==="close-modal"){o.stopPropagation(),jt();return}}const l=r.closest(".financial-row");if(l&&document.getElementById("list-container").contains(l)&&!r.closest("button")&&!r.closest(".item-checkbox")){navigator.vibrate&&navigator.vibrate(15);const{type:d}=l.dataset;try{const u=JSON.parse(decodeURIComponent(l.dataset.item));bo(d,u)}catch(u){console.error("Parse error on card click",u),f("Erro","Os dados deste lançamento não puderam ser lidos corretamente.","error")}}},document.body.addEventListener("click",ea),ta&&document.getElementById("genericModal").removeEventListener("click",ta),ta=o=>{const r=o.target.closest('button[data-action^="delete-"]');if(r){const n=r.dataset.action.split("-")[1];handleDeleteHierarchyItem(n,r.dataset.id)}o.target===document.getElementById("genericModal")&&jt()},document.getElementById("genericModal").addEventListener("click",ta)}function at(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=$.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}function po(t){$.currentTab=t,$.selectedIds.clear(),at(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t==="receivables"?(e.classList.add("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.remove("text-gray-500"),a.classList.remove("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.add("text-gray-500")):(a.classList.add("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.remove("text-gray-500"),e.classList.remove("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.add("text-gray-500")),Ct(),ji()}async function Me(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A sincronizar carteira...</p></div>';try{if($.natures.length===0){const[r,n,l,d,u]=await Promise.all([Pa(g.establishmentId),ks(g.establishmentId),At(g.establishmentId).catch(()=>[]),bt(g.establishmentId,"",1e3).catch(()=>[]),Ce(g.establishmentId).catch(()=>[])]);$.natures=r||[],$.costCenters=n||[],$.suppliers=l||[],$.clients=d||[],$.professionals=u||[],Ai()}const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(","),s={startDate:$.startDate,endDate:$.endDate,establishmentId:a};$.filterNaturezaId!=="all"&&(s.natureId=$.filterNaturezaId),$.filterCostCenterId!=="all"&&(s.costCenterId=$.filterCostCenterId);const[i,o]=await Promise.all([Ss(s),Ta(s)]);$.payables=i.entries||[],$.receivables=o.entries||[],ji(),Ct()}catch(e){t.innerHTML=`
    ...
    `}function Ct(){const t=document.getElementById("list-container");if(!t)return;const e=$.currentTab==="receivables",a=e?$.receivables:$.payables;let s=a;if($.statusFilter!=="all"&&(s=a.filter(c=>{const p=ct(c.dueDate,c.status);return $.statusFilter==="overdue"?p:$.statusFilter==="pending"?c.status==="pending"&&!p:c.status===$.statusFilter})),$.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes($.searchQuery)||c.entity&&c.entity.toLowerCase().includes($.searchQuery)||c.notes&&c.notes.toLowerCase().includes($.searchQuery))),s.sort((c,p)=>{let b=c[$.sortCol],m=p[$.sortCol];return $.sortCol==="dueDate"?(b=new Date(b).getTime(),m=new Date(m).getTime()):($.sortCol==="description"||$.sortCol==="status")&&(b=b?b.toLowerCase():"",m=m?m.toLowerCase():""),b<m?$.sortAsc?-1:1:b>m?$.sortAsc?1:-1:0}),pc(),s.length===0){t.innerHTML=`
        ...
        `}).join("")}async function bc(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?on(e,a):dn(e,a)),f("Baixa Realizada","O lançamento foi registado como pago.","success"),await Me()}catch(s){f("Erro",s.message,"error")}}async function qi(t,e){if(!!!e.recurrenceId){await G("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Ni(t,[e.id]);return}mc(t,e)}function mc(t,e){const a=document.getElementById("genericModal"),i=(t==="payable"?$.payables:$.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,u)=>new Date(d.dueDate)-new Date(u.dueDate));a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",a.innerHTML=`
    ...
    `,t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function bo(t,e=null){const a=document.getElementById("genericModal"),s=t==="payable",i=s?"red":"emerald",o=e?"Editar Lançamento":"Novo Lançamento",r=(D,O)=>{let H='<option value="">-- Categoria --</option>';const T=js(D),A=(q,Z=0)=>{const ee="  ".repeat(Z)+(Z>0?"↳ ":""),se=q.id===O?"selected":"";H+=`<option value="${q.id}" ${se}>${ee}${v(q.name)}</option>`,q.children.forEach(Y=>A(Y,Z+1))};return T.forEach(q=>A(q)),H},l=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(D=>`<option value="${D.value}" ${e?.paymentMethod===D.value?"selected":""}>${D.label}</option>`).join(""),d=`
        <datalist id="entity-suggestions">
            ${s?$.suppliers.map(D=>`<option value="${v(D.name)}">Fornecedor</option>`).join("")+$.professionals.map(D=>`<option value="${v(D.name)}">Profissional</option>`).join(""):$.clients.map(D=>`<option value="${v(D.name)} ${D.phone?"- "+v(D.phone):""}">Cliente</option>`).join("")}
        </datalist>
    `,u=e?.establishmentId||g.selectedEstablishments&&g.selectedEstablishments[0]||g.establishmentId,c=$.establishments.map(D=>{const O=D.id===u;return`<option value="${D.id}" ${O?"selected":""}>${D.type==="Matriz"?"🏢":"📍"} ${v(D.name)}</option>`}).join("");a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 md:p-6",a.innerHTML=`
        ${d}
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const D=a.querySelector("#modal-content-wrapper");D&&(D.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),D.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let b="single",m=2;const h=p.querySelector("#modal-delete-btn");h&&h.addEventListener("click",D=>{D.preventDefault(),navigator.vibrate&&navigator.vibrate(30),jt(),setTimeout(()=>qi(t,e),300)});const y=p.querySelector('[name="amount"]'),S=p.querySelector("#recurrence-options"),L=p.querySelector("#recurrence-summary"),P=p.querySelector("#installments-input"),k=p.querySelector("#status-toggle"),I=p.querySelector("#payment-date-wrapper"),B=p.querySelector('[name="paymentDate"]'),U=()=>{if(b==="single")return;const D=parseFloat(y.value)||0;if(m=parseInt(P.value)||2,D===0){L.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(b==="installment"){const O=D/m;L.innerHTML=`
                <div>
            ...
            `}};p.addEventListener("click",D=>{const O=D.target.closest(".mode-btn");if(O&&!e)if(D.preventDefault(),navigator.vibrate&&navigator.vibrate(15),p.querySelectorAll(".mode-btn").forEach(A=>{A.classList.remove("bg-white","text-gray-900","shadow-sm"),A.classList.add("text-gray-500")}),O.classList.add("bg-white","text-gray-900","shadow-sm"),O.classList.remove("text-gray-500"),b=O.dataset.mode,b==="single")S.style.display="none";else{S.style.display="block";const A=S.querySelector("#recurrence-label");A&&(A.textContent=b==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),U()}if(D.target.closest("#btn-minus")&&P){D.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let A=parseInt(P.value)||2;A>2&&(P.value=A-1,U())}if(D.target.closest("#btn-plus")&&P){D.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let A=parseInt(P.value)||2;A<60&&(P.value=A+1,U())}}),y.addEventListener("input",U),P&&P.addEventListener("input",U),k.addEventListener("change",()=>{navigator.vibrate&&navigator.vibrate(20),k.checked?(I.classList.remove("hidden"),B.required=!0):(I.classList.add("hidden"),B.required=!1)}),p.addEventListener("submit",async D=>{D.preventDefault();const O=p.querySelector('button[type="submit"]'),H=O.innerHTML;O.disabled=!0,O.innerHTML='<div class="loader mx-auto h-5 w-5 border-2 border-white border-t-transparent"></div>';const T=new FormData(p),A=k.checked,q=parseFloat(T.get("amount"));let Z=q,ee=1;!e&&b!=="single"&&(ee=parseInt(T.get("installments")),b==="repeat"&&(Z=q*ee));const se=T.get("establishmentId");if(!se){f("Atenção","Selecione uma Unidade válida para o lançamento.","warning"),O.disabled=!1,O.innerHTML=H;return}const Y={companyId:g.companyId,establishmentId:se,description:T.get("description"),amount:Z,dueDate:T.get("dueDate"),naturezaId:T.get("naturezaId")||null,centroDeCustoId:T.get("centroDeCustoId")||null,entity:T.get("entity")||null,paymentMethod:T.get("paymentMethod")||null,documentNumber:T.get("documentNumber")||null,notes:T.get("notes"),status:A?"paid":"pending",paymentDate:A?T.get("paymentDate"):null,installments:ee};ee>1&&!e&&(Y.recurrenceId=self.crypto.randomUUID());try{e?(await(s?an(e.id,Y):nn(e.id,Y)),f("Sucesso","Atualizado com sucesso!","success")):(await(s?Jo(Y):rn(Y)),f("Sucesso","Lançamento criado!","success")),jt(),Me()}catch(N){f("Erro",N.message||"Erro ao salvar","error"),O.disabled=!1,O.innerHTML=H}})}const fc=t=>C("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),xc=t=>C("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),hc=(t,e)=>{const a=new URLSearchParams({startDate:t,endDate:e}).toString();return C(`/api/commissions/stats?${a}`)},vc=(t={})=>{Object.keys(t).forEach(s=>(t[s]===void 0||t[s]===null||t[s]==="")&&delete t[s]);const e=new URLSearchParams(t).toString(),a=`/api/commissions/history${e?"?"+e:""}`;return C(a)},Fi=t=>C(`/api/commissions/report/${t}`,{method:"DELETE"}),wa=new Date,yc=new Date(wa.getFullYear(),wa.getMonth(),1);let F={professionals:[],reports:[],calculationResult:null,periodString:"",establishmentConfig:null,selectedIds:new Set,isAdvancedFilterOpen:!1,startDate:yc.toISOString().split("T")[0],endDate:new Date(wa.getFullYear(),wa.getMonth()+1,0).toISOString().split("T")[0],professionalId:"all",searchQuery:"",stats:{revenue:0,commissions:0,margin:0,netPaid:0},viewMode:"list"},aa=null;const wc=document.getElementById("content");function Dt(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function kc(t){return t?new Date(t).toLocaleDateString("pt-BR"):"--/--/----"}function ka(t){if(!t)return"PR";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()}function Ri(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="none"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&window.innerWidth<768&&(a.style.display="none")}function qs(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="flex"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&window.innerWidth<768&&(a.style.display=""),F.viewMode="list"}async function Sc(){try{const[t,e]=await Promise.all([Ce(g.establishmentId),qe(g.establishmentId).catch(()=>({}))]);F.professionals=t,F.establishmentConfig=e||{}}catch(t){console.error("Erro na inicialização de comissões",t)}F.viewMode="list",$c(),Ec(),await ut()}function $c(){const t=F.professionals.map(e=>`<option value="${e.id}">${e.name}</option>`).join("");wc.innerHTML=`
        <style>
    ...
    `,Ri()}function Ac(){if(F.reports.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}let t=F.reports;if(F.searchQuery){const a=F.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}const e=t.map(a=>{const s=a.summary.totalCommission,i=a.summary.extraDebit||0,o=a.summary.extraCredit||0,r=a.summary.finalValue||s;return{"Data da Apuração":new Date(a.createdAt).toLocaleDateString("pt-BR"),Profissional:a.professionalName,"Período Base":a.period,"Itens Calculados":a.summary.totalItems||0,"Valor Bruto (R$)":s,"Bônus (R$)":o,"Descontos (R$)":i,"Líquido Pago (R$)":r,"Observações/Motivo":a.summary.notes||""}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const a=XLSX.utils.json_to_sheet(e),s=XLSX.utils.book_new();XLSX.utils.book_append_sheet(s,a,"Comissoes");const i=`Relatorio_Comissoes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(s,i)}catch(a){console.error(a),f("Erro","Falha ao exportar Excel.","error")}}function jc(t){const e=F.reports.find(u=>u.id===t);if(!e)return;if(!window.jspdf){f("Erro","A biblioteca de PDF não foi carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a;s.setFillColor(79,70,229),s.rect(0,0,210,40,"F"),s.setTextColor(255,255,255),s.setFontSize(22),s.setFont(void 0,"bold"),s.text("RECIBO DE COMISSÕES",105,20,{align:"center"}),s.setFontSize(10),s.text(`Data de Emissão: ${new Date().toLocaleDateString("pt-BR")}`,105,28,{align:"center"}),s.setTextColor(50,50,50),s.setFontSize(11),s.setFont(void 0,"normal"),s.text("Profissional:",15,55),s.setFont(void 0,"bold"),s.text(e.professionalName,40,55),s.setFont(void 0,"normal"),s.text("Período:",130,55),s.setFont(void 0,"bold"),s.text(e.period,147,55);const i=e.reportData?.items||e.items||[];let o=70;if(i.length>0){const u=i.map(c=>[c.item||"Item",c.client||"--",`R$ ${(c.value||0).toFixed(2)}`,`${c.commissionRate||0}%`,`R$ ${(c.commissionValue||0).toFixed(2)}`]);s.autoTable({startY:o,head:[["Serviço/Produto","Cliente","Valor Base","Taxa","Comissão"]],body:u,theme:"striped",headStyles:{fillColor:[249,250,251],textColor:[75,85,99],fontStyle:"bold"},styles:{fontSize:8},columnStyles:{2:{halign:"right"},3:{halign:"center"},4:{halign:"right",fontStyle:"bold",textColor:[5,150,105]}}}),o=s.lastAutoTable.finalY+15}const r=e.summary,n=r.finalValue||r.totalCommission,l=[["Comissões Brutas (Soma dos Itens)",`R$ ${r.totalCommission.toFixed(2)}`]];r.extraCredit>0&&l.push(["(+) Bônus Extras",`R$ ${r.extraCredit.toFixed(2)}`]),r.extraDebit>0&&l.push(["(-) Descontos / Vales",`R$ ${r.extraDebit.toFixed(2)}`]),s.autoTable({startY:o,head:[["Resumo do Fechamento","Valor"]],body:l,theme:"grid",headStyles:{fillColor:[79,70,229],textColor:[255,255,255]},columnStyles:{1:{halign:"right",fontStyle:"bold"}}});const d=s.lastAutoTable.finalY+15;s.setFillColor(236,253,245),s.rect(120,d-8,75,15,"F"),s.setTextColor(5,150,105),s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${n.toFixed(2)}`,190,d,{align:"right"}),r.notes&&(s.setTextColor(100,100,100),s.setFontSize(9),s.setFont(void 0,"normal"),s.text(`Obs/Motivo: ${r.notes}`,15,d+10)),s.setTextColor(150,150,150),s.setFontSize(9),s.line(20,d+40,90,d+40),s.text("Assinatura da Empresa",55,d+45,{align:"center"}),s.line(120,d+40,190,d+40),s.text("Assinatura do Profissional",155,d+45,{align:"center"}),s.save(`Recibo_Comissoes_${e.professionalName.replace(/\s+/g,"_")}.pdf`)}async function qc(){const t=F.selectedIds.size;if(!(t===0||!await G("Excluir Recibos",`Deseja excluir e estornar ${t} recibo(s)? As vendas associadas voltarão ao status "A Apurar".`)))try{const a=Array.from(F.selectedIds).map(s=>Fi(s));await Promise.all(a),f("Sucesso",`${t} recibos excluídos com sucesso.`,"success"),F.selectedIds.clear(),Pt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),await ut()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns recibos.","error")}}async function Nc(t){if(await G("Excluir Recibo",'ATENÇÃO: Deseja realmente excluir este recibo? As vendas associadas a ele voltarão ao status "A Apurar" e o valor será subtraído dos relatórios. Esta ação não pode ser desfeita.'))try{await Fi(t),f("Sucesso","Recibo cancelado com sucesso. Vendas estornadas para apuração.","success"),qs(),await ut()}catch(a){f("Erro ao Excluir",a.message,"error")}}const He=document.getElementById("content");let M={allPackages:[],catalogForModal:{services:[],products:[]},establishments:[],searchQuery:"",statusFilter:"all",viewMode:"list",tempPackage:null,selectedIds:new Set},Xe=null;function pt(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Fc(){const t=M.allPackages.length,e=M.allPackages.filter(o=>o.status!=="inactive"),a=e.length,s=a>0?e.reduce((o,r)=>o+(r.price||0),0)/a:0;let i=0;return e.forEach(o=>{const r=o.originalPrice||0,n=o.price||0;if(r>0&&r>n){const l=(r-n)/r*100;l>i&&(i=l)}}),{total:t,activeCount:a,avgPrice:s,maxDiscount:i}}function Rc(){const t=document.getElementById("packages-layout-detail");t&&(t.classList.remove("hidden"),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))}))}function ca(){const t=document.getElementById("packages-layout-detail");if(t){t.classList.add("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-0","md:scale-100","md:opacity-100"),e.classList.add("translate-y-full","md:scale-95","md:opacity-0")),setTimeout(()=>{t.classList.add("hidden"),t.style.display="none",t.innerHTML=""},300)}}function Hc(){const t=document.getElementById("packages-layout-detail");if(!t||M.viewMode!=="edit-package"||!M.tempPackage)return;M.tempPackage.name=t.querySelector("#packageName")?.value||"",M.tempPackage.description=t.querySelector("#packageDescription")?.value||"",M.tempPackage.status=t.querySelector("#packageStatus")?.value||"active";const e=parseFloat(t.querySelector("#finalPrice")?.value);M.tempPackage.price=isNaN(e)?"":e;const a=parseFloat(t.querySelector("#commissionRate")?.value);M.tempPackage.commissionRate=isNaN(a)?"":a;const s=parseInt(t.querySelector("#validityDays")?.value,10);M.tempPackage.validityDays=isNaN(s)?"":s,M.tempPackage.sellStartDate=t.querySelector("#sellStartDate")?.value||"",M.tempPackage.sellEndDate=t.querySelector("#sellEndDate")?.value||"";const i=parseInt(t.querySelector("#salesLimit")?.value,10);M.tempPackage.salesLimit=isNaN(i)?"":i;const o=Array.from(t.querySelectorAll(".modal-est-checkbox:checked")).map(r=>r.value);M.tempPackage.establishmentIds=o}async function Oc(){try{const e=(await ke().catch(()=>({matrizes:[]}))).matrizes||[];M.establishments=[],e.forEach(a=>{M.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>M.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}M.viewMode="list",M.selectedIds.clear(),zc(),Wc(),await Sa()}async function Sa(){const t=document.getElementById("packagesListContainer");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-20"><div class="loader mx-auto"></div></div>');const e=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId];try{const a=e.map(c=>Cs(c).catch(()=>[])),s=await Promise.all(a),i=new Map;s.flat().forEach(c=>{i.has(c.id)||i.set(c.id,c)}),M.allPackages=Array.from(i.values());const o=e.map(c=>Ue(c).catch(()=>[])),r=e.map(c=>mt(c).catch(()=>[])),[n,l]=await Promise.all([Promise.all(o),Promise.all(r)]),d=new Map;n.flat().forEach(c=>d.set(c.id,c));const u=new Map;l.flat().forEach(c=>u.set(c.id,c)),M.catalogForModal={services:Array.from(d.values()).filter(c=>c.active),products:Array.from(u.values())},_c(),Ke(),kt()}catch(a){console.error(a),t&&(t.innerHTML=`
            ...
            `)}}function kt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=M.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")));const s=document.getElementById("select-all-toggle");s&&(s.checked=M.allPackages.length>0&&a===M.allPackages.length)}function zc(){He.innerHTML=`
    ...
    `)}function Ke(){const t=document.getElementById("packagesListContainer");if(!t)return;let e=M.allPackages;if(M.statusFilter!=="all"){const s=M.statusFilter==="active";e=e.filter(i=>i.status!=="inactive"===s)}if(M.searchQuery){const s=M.searchQuery.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(e.length===0){t.innerHTML=`
        ...
        `}).join("")}function Vc(){if(M.allPackages.length===0){f("Aviso","Não há pacotes carregados para exportar.","info");return}let t=M.allPackages;if(M.statusFilter!=="all"){const s=M.statusFilter==="active";t=t.filter(i=>i.status!=="inactive"===s)}if(M.searchQuery){const s=M.searchQuery.toLowerCase();t=t.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(t.length===0){f("Aviso","Nenhum pacote corresponde aos filtros atuais.","info");return}const e=new Map(M.establishments.map(s=>[s.id,s.name])),a=t.map(s=>{const i=s.originalPrice||0,o=s.price||0,r=i>0?(i-o)/i*100:0,n=(s.items||[]).map(u=>`${u.quantity}x ${u.name}`).join(" | ");return{"Unidade(s)":(s.establishmentIds||(s.establishmentId?[s.establishmentId]:[])).map(u=>e.get(u)).filter(Boolean).join(", ")||"Não identificada","Nome do Pacote":s.name,Status:s.status!=="inactive"?"Ativo":"Inativo",Descrição:s.description||"","Itens Incluídos":n,"Valor Original (R$)":i,"Preço de Venda (R$)":o,"Desconto (%)":r.toFixed(1)+"%","Comissão (%)":s.commissionRate||0,"Validade de Uso (Dias)":s.validityDays||"Vitalício","Vendas Início":s.sellStartDate?new Date(s.sellStartDate).toLocaleDateString("pt-BR"):"-","Vendas Fim":s.sellEndDate?new Date(s.sellEndDate).toLocaleDateString("pt-BR"):"-"}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const s=XLSX.utils.json_to_sheet(a),i=XLSX.utils.book_new();XLSX.utils.book_append_sheet(i,s,"Pacotes");const o=`Relatorio_Pacotes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(i,o)}catch(s){console.error(s),f("Erro","Falha ao exportar Excel.","error")}}function mo(t=null){M.viewMode="edit-package",M.tempPackage=t?JSON.parse(JSON.stringify(t)):{id:"",name:"",description:"",status:"active",items:[],price:"",originalPrice:0,commissionRate:0,validityDays:"",sellStartDate:"",sellEndDate:"",salesLimit:"",establishmentIds:[g.establishmentId]},gs(),Rc()}function Oi(){const t=document.getElementById("packages-layout-detail");if(!t)return;const a=(M.tempPackage.items||[]).reduce((n,l)=>n+(l.price||0)*(l.quantity||1),0),s=t.querySelector("#finalPrice"),i=t.querySelector("#discountIndicator"),o=t.querySelector("#originalPrice"),r=parseFloat(s?.value)||0;if(o&&(o.textContent=pt(a)),i)if(a>0&&a>r&&r>0){const n=(a-r)/a*100;i.textContent=`${n.toFixed(0)}% OFF`,i.classList.remove("hidden")}else i.classList.add("hidden")}function ms(){const t=document.getElementById("package-items-list");if(!t)return;const e=M.tempPackage.items||[];e.length===0?t.innerHTML=`
        ...
        `}).join(""),Oi()}function go(t){return t?t.includes("T")?t.split("T")[0]:t:""}function gs(){const t=document.getElementById("packages-layout-detail");if(!t)return;const e=M.tempPackage,a=!!e.id,s=v(e.name||""),i=v(e.description||""),o=e.price!==void 0&&e.price!==""?e.price:"",r=e.commissionRate!==void 0&&e.commissionRate!==""?e.commissionRate:"",n=e.validityDays!==void 0&&e.validityDays!==""?e.validityDays:"",l=go(e.sellStartDate),d=go(e.sellEndDate),u=e.salesLimit!==void 0&&e.salesLimit!==""?e.salesLimit:"",c=e.establishmentIds&&e.establishmentIds.length>0?e.establishmentIds:e.establishmentId?[e.establishmentId]:[g.establishmentId],p=M.establishments.map(m=>`
    ...
    `,ms(),requestAnimationFrame(()=>{const m=t.querySelector("#modal-content-wrapper");m&&(m.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),m.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Uc(){M.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `;let a;const s=(o="")=>{const r=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600 text-lg"></i>',product:'<i class="bi bi-box-seam text-emerald-600 text-lg"></i>'},l={"catalog-service-list":{items:M.catalogForModal.services,type:"service"},"catalog-product-list":{items:M.catalogForModal.products,type:"product"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=t.querySelector("#"+d);if(!p)return;const b=u.filter(y=>y.name.toLowerCase().includes(r)).slice(0,50),m=c==="service"?"hover:border-indigo-400 hover:bg-indigo-50/80 hover:shadow-md":"hover:border-emerald-400 hover:bg-emerald-50/80 hover:shadow-md",h=c==="service"?"bg-indigo-100 border-indigo-200 shadow-sm":"bg-emerald-100 border-emerald-200 shadow-sm";p.innerHTML=b.map(y=>y.id?`
            ...
            `:"").join("")||'<div class="flex flex-col items-center justify-center py-8 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50"><i class="bi bi-inbox text-3xl mb-2"></i><p class="text-[10px] font-bold uppercase tracking-widest">Nenhum resultado</p></div>'})};s();const i=t.querySelector("#item-search-input");i&&(i.addEventListener("input",o=>{clearTimeout(a),a=setTimeout(()=>s(o.target.value),300)}),setTimeout(()=>i.focus(),100)),requestAnimationFrame(()=>{const o=t.querySelector("#modal-content-wrapper");o&&(o.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),o.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Wc(){Xe&&(He.removeEventListener("click",Xe),He.removeEventListener("input",Xe),He.removeEventListener("change",Xe)),Xe=async e=>{if(e.target.classList.contains("item-checkbox")){const r=e.target.value;e.target.checked?M.selectedIds.add(r):M.selectedIds.delete(r),kt(),Ke(),e.stopPropagation();return}if(e.target.id==="packages-layout-detail"){ca(),M.viewMode="list",M.tempPackage=null;return}if(e.target.closest("#batch-delete-btn")){const r=M.selectedIds.size;if(r===0)return;if(await G("Excluir Pacotes",`Deseja realmente apagar ${r} pacotes selecionados?`))try{const l=Array.from(M.selectedIds).map(d=>Qs(d));await Promise.all(l),f("Sucesso",`${r} pacote(s) excluído(s).`,"success"),M.selectedIds.clear(),kt(),await Sa()}catch{f("Erro","Ocorreu um erro ao excluir pacotes.","error")}return}if(e.target.closest("#cancel-selection-btn")){M.selectedIds.clear();const r=document.getElementById("select-all-toggle");r&&(r.checked=!1),kt(),Ke();return}const i=e.target.closest("[data-action]");if(!i)return;switch(i.dataset.action){case"new-package":navigator.vibrate&&navigator.vibrate(20),mo(null);break;case"edit-package":navigator.vibrate&&navigator.vibrate(15);const r=i.dataset.id,n=M.allPackages.find(S=>S.id===r);n&&mo(n);break;case"delete-package":e.stopPropagation(),e.preventDefault();const l=i.dataset.id;if(await G("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await Qs(l),f("Sucesso!","Pacote excluído.","success"),M.viewMode==="edit-package"&&M.tempPackage?.id===l&&(ca(),M.viewMode="list"),await Sa()}catch(S){f("Erro",`Não foi possível excluir: ${S.message}`,"error")}break;case"back-to-main":ca(),M.viewMode="list",M.tempPackage=null;break;case"add-item-to-package-btn":Hc(),Uc();break;case"back-to-editor":gs();break;case"select-catalog-item":navigator.vibrate&&navigator.vibrate(10);const{itemType:u,itemId:c}=i.dataset,b=(M.catalogForModal[u+"s"]||[]).find(S=>S.id===c);if(b){const S=M.tempPackage.items.find(L=>L.id===b.id&&L.type===u);S?S.quantity++:M.tempPackage.items.push({...b,type:u,quantity:1}),gs()}break;case"remove-item":navigator.vibrate&&navigator.vibrate(10);const m=parseInt(i.dataset.index,10);M.tempPackage.items.splice(m,1),ms();break;case"toggle-all-ests":const h=document.querySelectorAll(".modal-est-checkbox"),y=Array.from(h).every(S=>S.checked);h.forEach(S=>S.checked=!y);break;case"save-package":await Jc(i);break}},He.addEventListener("click",Xe),He.addEventListener("input",e=>{e.target.id==="search-packages"&&(M.searchQuery=e.target.value,Ke()),e.target.id==="finalPrice"&&Oi()}),He.addEventListener("change",e=>{if(e.target.id==="select-all-toggle"){const a=e.target.checked;M.selectedIds.clear(),a&&M.allPackages.forEach(s=>M.selectedIds.add(s.id)),kt(),Ke()}if(e.target.id==="filter-status"&&(M.statusFilter=e.target.value,Ke()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&M.tempPackage.items[a]&&(M.tempPackage.items[a].quantity=s,ms())}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Vc)}async function Jc(t){const e=M.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const i=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(i.length===0){f("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const o=e.items.reduce((l,d)=>l+d.price*d.quantity,0),r={id:e.id||null,companyId:g.companyId,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:o,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:i,establishmentId:i[0]};if(!r.name||isNaN(r.price)){f("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(r.items.length===0){f("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await zn(r.id,r):(delete r.id,await On(r)),f("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),ca(),M.viewMode="list",M.tempPackage=null,await Sa()}catch(l){f("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const Gc=document.getElementById("content");async function Qc(){const t=we.currentUser;if(!t)return;let e={};try{const l=await vs(je(xe,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(g.userProfessionalId)try{a=await Po(g.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=v(e.name||t.displayName||"Usuário"),i=v(t.email||"E-mail não disponível"),o=v(e.phone||"");let r=e.photo||"";a&&a.photo&&(r=a.photo);const n=r||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;Gc.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async i=>{i.preventDefault();const o=a.querySelector("#b-date-start").value,r=a.querySelector("#b-date-end").value||o,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!o||!n||!l)return f("Atenção","Preencha Data e Horários corretamente.","error");const u=new Date(`${o}T${n}:00`),c=new Date(`${r}T${l}:00`);if(c<=u)return f("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await Ma({establishmentId:g.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:u.toISOString(),endTime:c.toISOString()}),f("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const m=document.getElementById("my-blocks-filter").value;ua(t.id,m)}catch(m){f("Erro",`Falha ao bloquear: ${m.message}`,"error")}finally{p.disabled=!1,p.innerHTML=b}}),document.getElementById("my-blocks-filter").addEventListener("change",i=>ua(t.id,i.target.value)),ua(t.id,"future")}async function ua(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let i,o;e==="history"?(o=new Date,i=new Date,i.setFullYear(i.getFullYear()-1)):(i=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let n=(await Ba(g.establishmentId,i.toISOString(),o.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await $s(u),f("Removido","O bloqueio foi deletado.","success"),ua(t,e)}catch(c){f("Erro",`Não foi possível remover: ${c.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${v(s.message)}</p>`}}let fo=!1;async function $a(t){if(!t)return;t.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const i=(await ke()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),i.length===0)e.innerHTML=`
            ...
            `;else{let o="";i.forEach(r=>{if(a&&!r.isOrphanBranch){const l=document.createElement("option");l.value=r.id,l.textContent=r.name,a.appendChild(l)}const n=r.isMatriz||!r.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';o+=`
                ...
                `}),e.innerHTML=o}fo||(Zc(),fo=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
    ...
    `,ru()}function xs(){const t=document.getElementById("plansGrid");if($e.length===0){t.innerHTML=`
        ...
        `}).join("")}function iu(t=[]){const e=document.getElementById("planServicesContainer");if(fs.length===0){e.innerHTML='<p class="text-xs text-slate-500 col-span-full">Nenhum serviço registado no sistema.</p>';return}e.innerHTML=fs.map(a=>{const s=t.includes(a.id);return`
