...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ia}. Verifique se o servidor backend está rodando.`):n}}const qo=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),S(r)},zs=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return S(r)},Vs=e=>S("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Us=(e,t)=>S(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Oa=e=>S(`/api/appointments/${e}`,{method:"DELETE"}),_s=e=>S(`/api/appointments/${e}/reopen`,{method:"POST"}),Ws=(e,t)=>S(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let W;async function Js(){if(!W)try{W=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Gs(){if(!W){console.warn("AudioContext não inicializado. O som não será tocado.");return}W.state==="suspended"&&W.resume();const e=W.createOscillator(),t=W.createGain();e.connect(t),t.connect(W.destination),e.type="sine",e.frequency.setValueAtTime(800,W.currentTime),t.gain.setValueAtTime(0,W.currentTime),t.gain.linearRampToValueAtTime(.3,W.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,W.currentTime+.2),e.start(W.currentTime),e.stop(W.currentTime+.2)}function p(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&Gs();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>br(a.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===St.length-1?Wa(t):(ee++,ya(),wa(ee))}),a.id==="branding"){const r=document.getElementById("logo-input"),o=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await _a(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),o&&(o.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await _a(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Wa(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{ce&&ce.remove(),window.location.reload()}}async function br(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),s=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),o=Object.fromEntries(r.entries());try{if(e==="company_data")await kt(m.establishmentId,{name:o.name,phone:o.phone,email:o.email,address:o.address,zipCode:o.zipCode});else if(e==="branding"){const n={};o.logoBase64&&(n.logo=o.logoBase64),o.bgBase64&&(n.backgroundImage=o.bgBase64),o.themeColor&&(n.themeColor=o.themeColor),o.primaryColor&&(n.primaryColor=o.primaryColor),Object.keys(n).length>0&&await kt(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(o.slotInterval);await kt(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await jo({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.price),duration:parseInt(o.duration),active:!0});n&&Lt.push(n)}else if(e==="first_prof"){const n=await No({establishmentId:m.establishmentId,name:o.name,specialty:o.role,active:!0,commissionRate:0});if(o.serviceId&&n&&n.id)try{Ua?await Ua(n.id,[o.serviceId]):Ct&&await Ct(n.id,{services:[o.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Fo({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.salePrice),stock:parseInt(o.stock),active:!0});p("Sucesso","Passo concluído!","success"),ee++,ya(),wa(ee)}catch(n){p("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=s}}var qe;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(qe||(qe={}));class Xt extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const fr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},vr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:fr(e),o=()=>r()!=="web",n=u=>{const g=d.get(u);return!!(g?.platforms.has(r())||i(u))},i=u=>{var g;return(g=a.PluginHeaders)===null||g===void 0?void 0:g.find(b=>b.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,g={})=>{const b=d.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const h=r(),f=i(u);let y;const k=async()=>(!y&&h in g?y=typeof g[h]=="function"?y=await g[h]():y=g[h]:t!==null&&!y&&"web"in g&&(y=typeof g.web=="function"?y=await g.web():y=g.web),y),$=(P,B)=>{var R,j;if(f){const z=f?.methods.find(q=>B===q.name);if(z)return z.rtype==="promise"?q=>a.nativePromise(u,B.toString(),q):(q,Y)=>a.nativeCallback(u,B.toString(),q,Y);if(P)return(R=P[B])===null||R===void 0?void 0:R.bind(P)}else{if(P)return(j=P[B])===null||j===void 0?void 0:j.bind(P);throw new Xt(`"${u}" plugin is not implemented on ${h}`,qe.Unimplemented)}},w=P=>{let B;const R=(...j)=>{const z=k().then(q=>{const Y=$(q,P);if(Y){const Se=Y(...j);return B=Se?.remove,Se}else throw new Xt(`"${u}.${P}()" is not implemented on ${h}`,qe.Unimplemented)});return P==="addListener"&&(z.remove=async()=>B()),z};return R.toString=()=>`${P.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:P,writable:!1,configurable:!1}),R},I=w("addListener"),T=w("removeListener"),N=(P,B)=>{const R=I({eventName:P},B),j=async()=>{const q=await R;T({eventName:P,callbackId:q},B)},z=new Promise(q=>R.then(()=>q({remove:j})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await j()},z},F=new Proxy({},{get(P,B){switch(B){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return f?N:I;case"removeListener":return T;default:return w(B)}}});return s[u]=F,d.set(u,{name:u,proxy:F,platforms:new Set([...Object.keys(g),...f?[h]:[]])}),F};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Xt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},hr=e=>e.Capacitor=vr(e),oe=hr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ht=oe.registerPlugin;class Ho{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new oe.Exception(t,qe.Unimplemented)}unavailable(t="not available"){return new oe.Exception(t,qe.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Ja=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ga=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class xr extends Ho{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Ga(r).trim(),o=Ga(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Ja(t.key),s=Ja(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ht("CapacitorCookies",{web:()=>new xr});const yr=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),wr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},kr=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,Sr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=wr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class $r extends Ho{async request(t){const a=Sr(t,t.webFetchExtra),s=kr(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await yr(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const c={};return o.headers.forEach((u,g)=>{c[g]=u}),{data:l,headers:c,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ht("CapacitorHttp",{web:()=>new $r});const G=Ht("PushNotifications",{}),Er="modulepreload",Ir=function(e){return"/"+e},Ya={},Cr=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");r=l(a.map(d=>{if(d=Ir(d),d in Ya)return;Ya[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const g=document.createElement("link");if(g.rel=c?"stylesheet":Er,c||(g.as="script"),g.crossOrigin="",g.href=d,i&&g.setAttribute("nonce",i),document.head.appendChild(g),c)return new Promise((b,h)=>{g.addEventListener("load",b),g.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return r.then(n=>{for(const i of n||[])i.status==="rejected"&&o(i.reason);return t().catch(o)})},Qa=Ht("App",{web:()=>Cr(()=>import("./web-QVwv4Gt3.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Lr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Xa=!1;async function Oo(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{Uo(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Vo()}async function zo(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Vo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Vo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await js(ja,{vapidKey:Lr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Uo(t,!1)):console.warn("[Push Web] Token veio vazio."),Xa||(Fs(ja,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Xa=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Uo(e,t){const a=U.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=me(_,"users",a.uid);try{const r=await Po(s);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await ha(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await As(s,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",r)}}const Tr=(e,t,a="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),S(`/api/reports/indicators?${r.toString()}`)},Pr=e=>e?S(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Br=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),S(`/api/reports/sales?${r.toString()}`)},Dr=()=>S("/api/reports/summary",{method:"GET"}),Ot=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return S(r)},zt=e=>S("/api/blockages",{method:"POST",body:JSON.stringify(e)}),ka=e=>S(`/api/blockages/${e}`,{method:"DELETE"}),_o=e=>S("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Wo=e=>e?String(e).replace(/\D/g,""):"",lt=(e,t="",a=20,s={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),s&&s.hasLoyalty&&r.append("hasLoyalty","true"),s&&s.birthMonth&&r.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),S(`/api/clients/${e}?${r.toString()}`)},Jo=(e,t)=>{const a=encodeURIComponent(t);return S(`/api/clients/details/${e}/${a}`)},Go=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Wo(t),s={...e,phone:a,id:a};return S(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},Sa=Go,Mr=(e,t)=>Go({...t,id:e}),Ar=e=>{const t=encodeURIComponent(e);return S(`/api/clients/${t}`,{method:"DELETE"})},qr=(e,t)=>Jo(e,Wo(t));function v(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Yo(e,t=800,a=800,s=.7){return new Promise((r,o)=>{if(!e.type.match(/image.*/))return o(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const b=u.toDataURL("image/jpeg",s);r(b)},l.onerror=d=>o(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>o(new Error("Erro ao ler o ficheiro."))})}const Za=document.getElementById("content");let Ka=!1;const la=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let dt=[],Vt=[],Ne={},De=[],C={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},E={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Nr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Qo(e){const t=new Date(e);if(t.setHours(0,0,0,0),C.currentView==="week"&&C.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function Tt(){const e=document.getElementById("profSelectorContainer"),t=C.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let a=m.professionals.filter(o=>C.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=C.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",c=v(i),u=la[0],g=o.id!=="all"&&m.professionalColors.get(o.id)||u,b=o.photo||`https://placehold.co/64x64/${g.main?.replace("#","")||"E0E7FF"}/${g.light?.replace("#","")||"4F46E5"}?text=${l}`,h=o.id==="all"?"#e0e7ff":g.light,f=o.id==="all"?"#4f46e5":g.main,k=`border: 3px solid ${n?g.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+g.border:"none"};`;return`
        ...
        `}).join("")}function Rr(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function jr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(s.professionalId)||{},d=v(s.reason),c=v(s.professionalName),u=v(s.clientName),g=v(s.serviceName),b=C.selectedItems.has(s.id),h=C.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const f=s.status==="completed",y=f?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",k=f?"Finalizado":"Aberto",$=JSON.stringify(s).replace(/'/g,"&apos;"),w=s.redeemedReward?.points>0,I=s.hasRewards&&!w,T=Rr(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),N=C.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${$}' style="border-left-color: ${l.border};">
                
                ${h}

                <div class="time-info" ${N}>
                    <p class="font-bold text-md">${n}</p>
                    <p class="text-xs text-gray-500">${i}</p>
                </div>

                <div class="details-info min-w-0" ${N}>
                ...
                <div class="status-info">
                    ...
                    `;const I=JSON.stringify(g).replace(/'/g,"&apos;"),T=g.redeemedReward?.points>0,N=g.hasRewards&&!T,F=g.status==="completed";return`
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                        ...
                        <div class="mt-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-800 truncate">${N?"🎁 ":""}${$}</p>
        ...
        `}o+="</div>",t.innerHTML=o}function Xo(){const e=m.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?jr(e):Fr(e),Ea()}function Ea(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(C.isSelectionMode&&C.selectedItems.size>0?(e.innerHTML=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(E.data.redeemedReward=null)})}async function Vr(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!E.data.time||E.data.selectedServiceIds.length===0||!E.data.professionalId)return p("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const s=E.data.selectedServiceIds.map(d=>{const c=dt.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,o]=E.data.time.split(":"),n=new Date(`${E.data.date}T${r}:${o}:00`),i={establishmentId:m.establishmentId,clientName:E.data.clientName,clientPhone:E.data.clientPhone,services:s,professionalId:E.data.professionalId,startTime:n.toISOString(),redeemedReward:E.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Us(l,i):await Vs(i),p(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",ae()}catch(d){p(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function es(e){const t=E.data.clientName===e.name&&E.data.clientPhone===e.phone,a=v(e.name),s=v(e.phone);return`
    ...
    `;return{title:e,content:a}}function Qr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Vt.map(a=>{const s=E.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",o=v(a.name);return`
    ...
    `;return{title:e,content:t}}function Xr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,s=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=E.data.date||s,o=v(E.data.clientName),n=v(E.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function Zr(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),s=dt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=E.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${o?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Zo(r.dataset.serviceId,r))})}function Kr(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),s=Vt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=E.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=v(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>Ko(r.dataset.professionalId,r))})}async function ca(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const o=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(E={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:o,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}},e&&e.clientName)try{const i=await lt(m.establishmentId,e.clientName),l=i.find(d=>d.phone===e.clientPhone);l&&(E.data.clientLoyaltyPoints=l.loyaltyPoints||0,De=i)}catch(i){console.warn("Não foi possível carregar pontos do cliente para edição:",i)}}if(!m.services||!m.professionals||Ne.enabled===void 0){p("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(dt=m.services,Vt=m.professionals.filter(o=>o.status==="active"),E.data.clientLoyaltyPoints>0){const o=Ne,n=Math.min(...(o?.rewards||[]).map(i=>i.points));E.data.clientHasRewards=o.enabled&&n!==1/0&&E.data.clientLoyaltyPoints>=n}let s={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(E.step){case 1:s=Gr(e);break;case 2:s=Yr();break;case 3:s=Qr();break;case 4:s=Xr(e);break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>{o.addEventListener("click",()=>{const n=parseInt(o.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(E.data.clientName=i.value.trim(),E.data.clientPhone=l.value.trim(),!E.data.clientName||!E.data.clientPhone)return p("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(E.data.selectedServiceIds.length===0)return p("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!E.data.professionalId)return p("Atenção","Selecione um profissional.","error");da(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>{o.addEventListener("click",()=>da(parseInt(o.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if(E.step===4&&r&&r.addEventListener("submit",Vr),a.style.display="flex",E.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Zo(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>Zr(i.target.value))}if(E.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>Ko(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>Kr(i.target.value))}if(E.step===1){const o=a.querySelector("#clientSearchInput");if(o&&(o.addEventListener("input",i=>Ur(i.target.value)),E.data.clientName&&E.data.clientPhone&&De.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=De.map(es).join(""))}const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Jr)}if(E.step===4){const o=a.querySelector("#apptDate");o&&o.addEventListener("change",eo),eo(),zr()}}async function ts(e={}){C.currentDate=e.targetDate?new Date(e.targetDate):C.currentDate||new Date,C.scrollToAppointmentId=e.scrollToAppointmentId||null,C.profSearchTerm="",C.isSelectionMode=!1,C.selectedItems.clear(),window.innerWidth<768&&(C.currentView="list"),Za.innerHTML=`
        <section>
    ...
    `,Ut()}function Ut(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");x.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `,o.appendChild(f)}),e.innerHTML="",e.appendChild(o),oo(t)}function oo(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:s}=x.paging,r=Math.ceil((a||0)/s);if(r===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full",o.innerHTML=`
    ...
    `;e.innerHTML=`
        ...
        ${r?"":h}
    `,!r&&(t.clientId||t.clientName)&&vn(t,e.querySelector("#loyalty-container"))}function fn(e,t){const s=Re(e).reduce((u,g)=>u+Number(g.price||0)*(g.quantity||1),0),r=x.checkoutState,o=r.discount||{type:"real",value:0};let n=0;o.type==="percent"?n=s*o.value/100:n=o.value,n>s&&(n=s);const i=s-n,l=r.payments.reduce((u,g)=>u+g.value,0),d=Math.max(0,i-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `,t.querySelector("#discount-value")?.addEventListener("input",u=>{const g=parseFloat(u.target.value)||0;x.checkoutState.discount.value=g,V()}),t.querySelector("#discount-type")?.addEventListener("change",u=>{x.checkoutState.discount.type=u.target.value,V()}),t.querySelector("#checkout-amount")?.addEventListener("input",u=>{r.amountReceived=u.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",u=>{r.installments=parseInt(u.target.value,10)})}async function vn(e,t){if(!t)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(e.clientId)s=await Jo(m.establishmentId,e.clientId);else if(e.clientName){const i=await lt(m.establishmentId,e.clientName,1);i&&i.length>0&&(s=i[0])}}catch(i){console.warn("Erro ao buscar dados de fidelidade",i)}if(!s||s.loyaltyPoints===void 0)return;const r=Number(s.loyaltyPoints)||0,n=(a.tiers||a.rewards||[]).filter(i=>{const l=Number(i.costPoints||i.points||0);return l>0&&r>=l});if(n.length>0){const i=document.createElement("div");i.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",i.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>hn(n),i.appendChild(l),t.innerHTML="",t.appendChild(i)}}function hn(e,t){const a=`
        <div class="space-y-4">
    ...
    `,{modalElement:s,close:r}=X({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",o=>{const n=o.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,l=e.find(d=>d.id&&d.id==i||(d.name||d.reward)==i);l&&(xn(l),r())}})}async function xn(e,t){const a=Number(e.costPoints||e.points||0),s=e.name||e.reward,r={id:e.serviceId||e.productId||`reward-${Date.now()}`,name:`${s}`,price:0,type:e.serviceId?"service":"product",isReward:!0,pointsCost:a};await Ia(r,1)}function yn(){if(!x.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=X({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const r=e.querySelector("#add-item-content");r.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{o>1&&(o--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{o++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Ia(r,o),t()}};e.addEventListener("click",r=>{const o=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(o){const{itemType:i,itemId:l}=o.dataset,c=(x.catalog[i+"s"]||[]).find(u=>u.id===l);c&&s({...c,type:i})}else n&&a()}),a()}async function ua(e=null){if(!x.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await K(m.establishmentId)}catch{return p("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,{modalElement:t}=X({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return p("Valor Inválido","Insira um valor válido.","error");try{const r=await rn({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",p("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),Ut(),await re()}catch(r){p("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function $n(){const e=x.activeCashierSessionId;if(e)try{const t=await dn(e),a=`
    ...
    `,Zn("chart-appointments-daily",c,u)}function Qn(e){const{dreFinancial:t}=D.data;if(!t)return;const a=t.totalRevenues,s=(i,l,d,c=!1)=>{const u=a>0?l/a*100:0,g=c?"- ":"";return`
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",ei),t.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),ti(r.dataset.id))}))}Ta()}async function oi(e){e.preventDefault();const t=e.target.closest("#serviceModal"),a=t.querySelector("#serviceId").value,s={},r=t.querySelector('input[name="commissionType"]:checked').value;r==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(n=>{const i=n.dataset.profId;if(n.querySelector('input[type="checkbox"]').checked){const d=parseFloat(n.querySelector('input[type="number"]').value);s[i]=isNaN(d)?0:d}});const o={establishmentId:m.establishmentId,name:t.querySelector("#serviceName").value,price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:r,professionalCommissions:s};try{a?(await sr(a,o),je(m.establishmentId,Fe(),"Serviços","Editou",`Editou o serviço: ${o.name}`)):(await jo(o),je(m.establishmentId,Fe(),"Serviços","Criou",`Criou novo serviço: ${o.name}`)),document.getElementById("serviceModal").style.display="none",p("Sucesso",`Serviço ${a?"atualizado":"adicionado"} com sucesso!`,"success"),await ct()}catch(n){p("Erro",n.message,"error")}}function co(e=null){const t=document.getElementById("serviceModal"),a=m.serviceCategories||[],s=e?.duration||0,r=e?.bufferTime||0,o=v(e?.name||""),n=v(e?.notes||""),i=e?o:"Novo Serviço",l=a.map(I=>`<option value="${I.id}" ${e?.categoryId===I.id?"selected":""}>${v(I.name)}</option>`).join("");t.innerHTML=`
            ...
            <div class="mt-6 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-3">
                ...
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${T?"bg-blue-50":""}" data-prof-id="${I.id}">
                    ...
                    <div class="flex items-center gap-1">
                        <input type="number" value="${N}" class="w-20 p-1 border rounded-md text-sm text-center" ${T?"":"disabled"}>
                        <span class="text-sm font-semibold">%</span>
                    </div>
                </div>
            `}).join(""),f.querySelectorAll('input[type="checkbox"]').forEach(I=>{I.addEventListener("change",T=>{const N=T.target.closest(".professional-commission-row");N.querySelector('input[type="number"]').disabled=!T.target.checked,N.classList.toggle("bg-blue-50",T.target.checked)})})),h();const y=t.querySelector("#serviceForm"),k=t.querySelector("#servicePhotoInput"),$=t.querySelector("#servicePhotoPreview"),w=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>k.click()),k.onchange=async()=>{const I=k.files[0];if(I){$.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const T=await Yo(I,800,800,.8),F=T.length*3/4,P=1e3*1024;if(F>P)throw new Error("A imagem é muito grande mesmo após a compressão.");$.src=T,w.value=T}catch(T){console.error("Erro ao processar imagem:",T),p("Erro de Imagem",T.message||"Não foi possível processar a imagem.","error"),$.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",w.value=e?.photo||"",k.value=""}}},y.addEventListener("submit",oi)}function Le(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",s=new Map((m.serviceCategories||[]).map(o=>[o.id,o.name]));let r=(m.services||[]).filter(Boolean);if(ye!=="all"){const o=ye==="active";r=r.filter(n=>n.active!==!1===o)}r=r.filter(o=>{const n=o.name.toLowerCase().includes(t),i=a==="all"||o.categoryId===a;return n&&i}),e.innerHTML="",r.length>0?r.forEach(o=>{const n=document.createElement("div"),i=JSON.stringify(o).replace(/'/g,"&apos;");n.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:bg-gray-50 ${o.active!==!1?"opacity-100":"opacity-50 bg-gray-100"} sm:flex-col`,n.dataset.action="edit-service",n.dataset.service=i;const l=v(o.name),d=v(s.get(o.categoryId)||"N/A"),c=o.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(o.name.charAt(0))}`;n.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),Pa(),Le()}function ri(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ct(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,r]=await Promise.all([ke(m.establishmentId),K(m.establishmentId),_t(m.establishmentId,"services"),ir(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(o=>{o.active===void 0&&(o.active=!0)}),gs(Xe)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),p("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function gs(e){if(document.getElementById("services-content-container")){if(Xe===e&&document.getElementById("services-content-container").children.length>1){Xe==="services"&&(Pa(),Le());return}Xe=e,ye="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?si():e==="reports"&&ri()}}function ni(){ie&&(ve.removeEventListener("click",ie),ve.removeEventListener("input",ie),ve.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),o=r.dataset.id,n=r.checked;try{await nr(o,n);const i=m.services.findIndex(l=>l.id===o);i>-1&&(m.services[i].active=n),je(m.establishmentId,Fe(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${o}) para ${n?"Ativo":"Inativo"}`),Le(),Pa()}catch(i){p("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Le()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Le();return}if(!a)return;if(a.hasAttribute("data-view")){gs(a.dataset.view);return}switch(a.dataset.action){case"new-service":co();break;case"edit-service":const r=JSON.parse(a.dataset.service);co(r);break;case"manage-categories":ai();break;case"filter-service":const o=a.dataset.filterType;if(o==="popular")return;ye=o==="total"?"all":o,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===ye||i==="total"&&ye==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Le();break}},ve.addEventListener("click",ie),ve.addEventListener("input",ie),ve.addEventListener("change",ie)}async function ii(){ve.innerHTML=`
        ...
        </section>`,ni();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await K(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),p("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Xe="services",ye="all",await ct()}const Wt="suppliers",Ba="purchases",bs="financial_payables",Da=async e=>{try{const t=Rt(pe(_,Wt),rt("establishmentId","==",e)),a=await xa(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},li=async e=>{try{return{id:(await Bo(pe(_,Wt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},di=async(e,t)=>{try{const a=me(_,Wt,e);return await ha(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},ci=async e=>{try{const t=me(_,Wt,e);return await qs(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},ui=async(e,t=null)=>{try{const a=Mo(_),s=me(pe(_,Ba)),r={...e,createdAt:Ha()};if(a.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const o=me(pe(_,bs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:Ha()};a.set(o,i)}return await a.commit(),{id:s.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},mi=async(e,t)=>{try{const a=Mo(_),s=me(_,Ba,e);a.delete(s);const r=Rt(pe(_,bs),rt("purchaseId","==",e),rt("establishmentId","==",t));return(await xa(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},pi=async e=>{try{const t=Rt(pe(_,Ba),rt("establishmentId","==",e),Do("createdAt","desc")),a=await xa(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},ge=document.getElementById("content");let le=null,Ze="products",se="all";async function gi(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await ms({establishmentId:m.establishmentId,name:s},"products"),a.value="",p("Sucesso","Categoria de produto criada!","success"),await Ma(),await ut()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function bi(e){if(await O("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ps(e,"products"),p("Sucesso","Categoria de produto apagada.","success"),await Ma(),await ut()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Ma(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
    ...
    </div>`;const h=t.querySelector("#productCategory"),f=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>f.click()),h.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(P=>`<option value="${P.id}" ${e?.categoryId===P.id?"selected":""}>${v(P.name)}</option>`).join(""),e&&(h.value=e.categoryId||"");const y=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const k=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",$=e?.photo||"";f.onchange=async()=>{const P=f.files[0];if(P){y.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const B=await uo(P,800,800,"image/jpeg",.8),j=B.length*3/4,z=1e3*1024;if(j>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=B,base64Input.value=B}catch(B){console.error("Erro ao processar imagem:",B),p("Erro de Imagem",B.message||"Não foi possível processar a imagem.","error"),preview.src=k,base64Input.value=$,F.value=""}}};const w=t.cloneNode(!0);t.parentNode.replaceChild(w,t);const I=()=>{const P=w.querySelector("#modalSupplierSearch"),B=w.querySelector("#supplierSearchResults"),R=w.querySelector("#selectedSuppliersList"),j=P.value.toLowerCase();if(j.length>0){const z=s.filter(q=>q.name.toLowerCase().includes(j)&&!o.has(q.id));z.length>0?(B.classList.remove("hidden"),B.innerHTML=z.map(q=>`
                    <div class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 text-sm flex justify-between items-center" data-add-supplier="${q.id}">
                        <span class="font-medium">${v(q.name)}</span>
                        <span class="text-indigo-600 text-xs">+ Adicionar</span>
                    </div>
                `).join("")):(B.classList.remove("hidden"),B.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else B.classList.add("hidden");o.size>0?(R.innerHTML="",o.forEach(z=>{const q=s.find(Y=>Y.id===z);q&&(R.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border p-2 rounded shadow-sm" data-id="${q.id}">
                            <div class="text-sm">
                                <p class="font-bold text-gray-800">${v(q.name)}</p>
                                <p class="text-xs text-gray-500">${v(q.contactName||"")} - ${v(q.phone||"")}</p>
                            </div>
                            <button type="button" class="text-red-500 hover:text-red-700 p-1" data-remove-supplier="${q.id}" title="Remover">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                            </button>
                        </div>
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};w.querySelector("#modalSupplierSearch").addEventListener("input",I),w.addEventListener("click",P=>{const B=P.target.closest("[data-add-supplier]");if(B){const j=B.dataset.addSupplier;o.add(j),w.querySelector("#modalSupplierSearch").value="",I()}const R=P.target.closest("[data-remove-supplier]");if(R){const j=R.dataset.removeSupplier;o.delete(j),I()}}),I(),w.addEventListener("click",async P=>{const B=P.target.closest("button[data-action]");if(!B)return;const R=B.dataset.action,j=w.querySelector("#productId").value;if(R==="close-modal"&&(w.style.display="none"),R==="delete-product"){if(!j)return;w.style.display="none",await vi(j)}if(R==="save-product-modal"){const z=w.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){p("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const q=B.closest('button[data-action="save-product-modal"]');q.disabled=!0,q.textContent="A salvar...";try{await hi(z)}catch(Y){p("Erro",`Falha ao salvar: ${Y.message}`,"error"),q.disabled=!1,q.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){P.preventDefault();const z=w.querySelector("#stockAdjustmentAmount"),q=w.querySelector("#stockAdjustmentReason"),Y=parseInt(z.value,10),Se=parseInt(B.dataset.change,10);if(!Y||Y<=0){p("Erro","Por favor, insira uma quantidade válida.","error");return}const Qt=Y*Se,Is=q.value||(Qt>0?"Entrada manual":"Saída manual");try{await cr(j,{change:Qt,reason:Is});const Ue=m.products.findIndex(_e=>_e.id===j);if(Ue>-1){const _e=m.products[Ue].currentStock+Qt;m.products[Ue].currentStock=_e,w.querySelector("#currentStockDisplay").textContent=_e,w.querySelector("#productCurrentStock").value=_e,z.value="",q.value="",p("Sucesso","Estoque atualizado!","success"),Aa(),it()}}catch(Ue){p("Erro de Stock",Ue.message,"error")}}});const T=w.querySelectorAll(".tab-btn"),N=w.querySelectorAll(".tab-content");T.forEach(P=>{P.addEventListener("click",B=>{B.preventDefault(),T.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),P.classList.add("border-indigo-500","text-indigo-600"),P.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),N.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${P.dataset.tab}`).classList.remove("hidden")})});const F=w.querySelector("#productPhotoInput");w.querySelector("#productPhotoButton").addEventListener("click",()=>F.click()),F.onchange=async()=>{const P=F.files[0];if(!P)return;const B=w.querySelector("#productPhotoPreview"),R=w.querySelector("#productPhotoBase64");B.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const j=await uo(P,800,800,"image/jpeg",.8),q=j.length*3/4,Y=1e3*1024;if(q>Y)throw new Error("A imagem é muito grande mesmo após a compressão.");B.src=j,R.value=j}catch(j){console.error("Erro ao processar imagem:",j),p("Erro de Imagem",j.message||"Não foi possível processar a imagem.","error"),B.src=k,R.value=$,F.value=""}},w.style.display="flex"}function xi(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;X({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Ke(){const e=document.getElementById("purchasesContainer");if(e)if(H.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([Ft(m.establishmentId),Da(m.establishmentId)]);H.allSuppliers=a||[];const s=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(H.productsToBuy=s,s.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',o="";s.forEach(d=>{const c=parseInt(d.minStock)||0,u=parseInt(d.currentStock)||0,g=Math.max(c-u,1),b=parseFloat(d.costPrice||0),h=v(d.name);let f='<option value="">Selecione...</option>';H.allSuppliers.length>0?H.allSuppliers.forEach(y=>{const $=d.supplierIds&&d.supplierIds.includes(y.id)?"selected":"";f+=`<option value="${y.id}" ${$}>${v(y.name)}</option>`}):f='<option value="">Sem fornecedores</option>',r+=`
            ...
            <div class="flex justify-between py-2 border-b border-gray-50 text-sm">
                ...
                <div class="text-right">
                    ...
                    <span class="text-indigo-600 font-bold block">R$ ${N.toFixed(2)}</span>
                </div>
            </div>
        `}).join("");s+=h;const y=encodeURIComponent(JSON.stringify({supplierId:g,supplierName:b.info.name,totalAmount:h,items:b.items})),k=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),$=encodeURIComponent(JSON.stringify(b.items)),w=v(b.info.name),I=v(b.info.email||"");a+=`
    ...
    `,de&&(be.removeEventListener("click",de),be.removeEventListener("input",de),be.removeEventListener("change",de)),de=e=>{if(e.target.closest("#tab-btn-list")&&pt("list"),e.target.closest("#tab-btn-purchases")&&pt("purchases"),e.target.closest("#tab-btn-history")&&pt("history"),e.target.id==="toggle-quote-mode"&&(H.isQuoteMode=e.target.checked,Ke()),e.target.id==="supplierSearchInput"&&Jt(),e.target.closest("#btn-new-supplier")&&po(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),s=JSON.parse(a.dataset.supplier);Ci(s)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&Ei(t.dataset.id),a==="edit"&&po(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&pa(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=a),pa()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),s={};let r=!1;if(a.forEach(o=>{if(o.offsetParent===null||!o.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=o.querySelector("td:nth-child(2)"),d=o.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(o.querySelector(".qty-input").value),u=parseFloat(o.dataset.cost),b=o.querySelector(".supplier-select").value;if(b){if(!s[b]){const h=H.allSuppliers.find(f=>f.id===b);s[b]={info:h,items:[]}}s[b].items.push({name:i,qty:c,cost:u})}}),!r){p("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}H.finalOrders=s,H.step=2,Ke()}if(e.target.closest("#btn-back-step1")&&(H.step=1,Ke()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),o=parseFloat(a.dataset.total),n=H.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else p("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=m.establishmentId,a.disabled=!0,a.textContent="A processar...",Oe(m.establishmentId).then(r=>{const o=r.purchaseConfig||null;return ui(s,o)}).then(()=>{p("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',p("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;O("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await mi(s,m.establishmentId),p("Sucesso","Compra e financeiro excluídos.","success"),vs()}catch(o){p("Erro","Erro ao excluir: "+o.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=H.finalOrders[s];r?Pi(r,H.isQuoteMode):p("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);Ti(s)}},be.addEventListener("click",de),be.addEventListener("input",de),be.addEventListener("change",de),pt("list")}function pt(e){$t=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Si()}const Zt=document.getElementById("content"),go={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ne=new Set,gt=null,Te=null;function Di(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Mi(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",s=v(t.name),r=v(t.specialty||"Especialidade"),o=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Kt(){const e=document.getElementById("genericModal");e.style.display="none",Te&&e.removeEventListener("click",Te)}async function Ai(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=v(a.name),r=m.services||await ke(m.establishmentId),o=m.professionals||await K(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",qi(a,r),Ni(a),Ri(a,o),Fi(a)}function qi(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,k)=>{const $=k+1,w=$==s[1]?"selected":"",I=new Date(0,k).toLocaleString("pt-BR",{month:"long"});return`<option value="${$}" ${w}>${I.charAt(0).toUpperCase()+I.slice(1)}</option>`}).join(""),o=e.status||"active",n=v(e.name||""),i=v(e.specialty||""),l=v(e.phone||""),d=v(e.notes||"");a.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client"),t=document.getElementById("btn-back-list");e&&(e.onclick=Wi),t&&(t.onclick=()=>{L.selectedClient=null,He()})}function He(){Gt();const e=document.getElementById("clients-content-area"),t=L.clients.filter(o=>o.name.toLowerCase().includes(L.searchTerm.toLowerCase())||o.phone&&o.phone.includes(L.searchTerm)),a=`
    ...
    `;e.innerHTML=a+s;const r=document.getElementById("client-search");r.focus(),r.setSelectionRange(r.value.length,r.value.length),r.addEventListener("input",o=>{L.searchTerm=o.target.value,He()}),e.querySelectorAll(".client-card").forEach(o=>{o.onclick=()=>xs(o.dataset.id)})}async function tt(){Gt();const e=document.getElementById("clients-content-area"),t=L.selectedClient;if(!t)return He();L.activeTab!=="profile"&&await _i(t.id);const a=`
    ...
    `;try{const[a,s]=await Promise.all([Ca(m.establishmentId),La(m.establishmentId)]),r=e.financialIntegration||{},o=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ee(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ee(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ee(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ee(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ee(a,o.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ee(s,o.defaultCostCenterId)}catch{p("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};ze(s,a)})}function rl(e,t){const a="5516997859430",s=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${s}`;t.innerHTML=`
    ...
    `,he.querySelector("#settings-menu-list").addEventListener("click",o=>{const n=o.target.closest("button[data-section]");n&&(o.preventDefault(),dl(n.dataset.section))});const r=he.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",o=>{o.preventDefault(),Z("my-profile-section")})}const at=document.getElementById("content");async function Me(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await Ot(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let g=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${v(l)} (${d.length})</h4>`;if(d.length>1){const b=JSON.stringify(d.map(h=>h.id));g+=`<button data-action="batch-delete-blockage" data-ids='${b}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}g+="</div>",c.innerHTML=g,d.forEach(b=>{const h=new Date(b.startTime),f=new Date(b.endTime),y=h.toLocaleDateString("pt-BR"),k=f.toLocaleDateString("pt-BR"),w=`
        ...
        </section>`,ml(t),await Me(t);const r=document.getElementById("batchProfSelectionContainer");try{const o=await K(m.establishmentId);r.innerHTML=o.map(n=>`
            <div class="flex items-center">
    ...
    `;const g=window.innerWidth<768,b=u.querySelector(".bg-white");if(g&&b){b.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const k=u.closest("section");k&&(k.style.padding="0",k.style.margin="0"),b.classList.add("p-4")}const h=u.querySelector("#userProfessionalId"),f=u.querySelector("#userPhotoPreview"),y=u.querySelector("#profPhotoName");if(h.addEventListener("change",k=>{const $=k.target.value,w=s($),I=w?w.name:"Selecione um profissional",T=r($,n);f.src=T.photoSrc,y.textContent=I,u.querySelector("#professionalPhotoUrl").value=T.photoUrl}),u.addEventListener("submit",async k=>{k.preventDefault();const $=e?.email,w=u.querySelector("#userEmail").value,I={};u.querySelectorAll('input[type="checkbox"]').forEach(F=>{const P=F.dataset.module,B=F.dataset.permission;I[P]||(I[P]={}),I[P][B]=F.checked});const T=u.querySelector("#userProfessionalId").value||null,N={name:u.querySelector("#userName").value,permissions:I,professionalId:T,establishmentId:m.establishmentId};try{c?($!==w&&(N.email=w),await fl(e.id,N),p("Usuário atualizado com sucesso!","success")):(N.email=u.querySelector("#userEmail").value,N.password=u.querySelector("#userPassword").value,await bl(N),p("Usuário criado com sucesso!","success")),Dt()}catch(F){p(`Erro: ${F.message}`,"error")}}),c){const k=u.querySelector("#password-change-container"),$=k.querySelector('[data-action="show-password-form"]'),w=k.querySelector("#password-form"),I=w.querySelector('[data-action="save-password"]'),T=w.querySelector('[data-action="cancel-password-change"]');$.addEventListener("click",()=>{$.classList.add("hidden"),w.classList.remove("hidden")}),T.addEventListener("click",()=>{$.classList.remove("hidden"),w.classList.add("hidden"),w.querySelector("#userNewPassword").value=""}),I.addEventListener("click",async()=>{const N=w.querySelector("#userNewPassword").value;if(!N||N.length<6){p("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await O("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{I.disabled=!0,I.textContent="Aguarde...",await hl(e.id,N),p("Sucesso!","A senha do usuário foi alterada.","success"),$.classList.remove("hidden"),w.classList.add("hidden"),w.querySelector("#userNewPassword").value=""}catch(P){p("Erro",`Não foi possível alterar a senha: ${P.message}`,"error")}finally{I.disabled=!1,I.textContent="Salvar Nova Senha"}})}}async function $l(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([gl(m.establishmentId),K(m.establishmentId)]);m.users=t,m.professionals=a,Et()}catch{p("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Dt(){fe.innerHTML=`
    ...
    `,Je&&fe.removeEventListener("click",Je),Ge&&fe.removeEventListener("change",Ge),Je=async e=>{if(!document.getElementById("user-list-view")){fe.removeEventListener("click",Je);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":fo();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));fo(s);break;case"back-to-list":Dt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await O("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await vl(r),p("Usuário excluído com sucesso!","success"),Dt()}catch(n){p(`Erro ao excluir: ${n.message}`,"error")}break}}},Ge=async e=>{if(!document.getElementById("user-list-view")){fe.removeEventListener("change",Ge);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Et();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await xl(a,s),p(`Usuário ${s==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=m.users.findIndex(o=>o.id===a);r>-1&&(m.users[r].status=s,Et())}catch(r){p(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,Et()}}},fe.addEventListener("click",Je),fe.addEventListener("change",Ge),await $l()}const El=document.getElementById("content");let vo={},ba=null;function Il(){Object.values(vo).forEach(e=>e?.destroy()),vo={}}function Cl(e,t){if(!window.jspdf){p("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${t}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function ho(e){const t=document.getElementById("genericModal"),a=v(e.client),s=v(e.items),r=v(e.responsavelCaixa||"N/A"),o=(e.payments||[]).map(n=>`
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&ho(d)})}),n.innerHTML=a.map((i,l)=>{const d=v(i.client),c=v(i.items),u=v(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&ho(d)})})}async function xo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r)return p("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,n=await Br({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:o});ba=n,e.innerHTML=`
        ...
        `,Ll(n)}catch(o){p("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function Tl(){Il();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];El.innerHTML=`
        ...
        `;e.innerHTML=t.map(r=>s(r)).join("")}async function fa(e){const t=document.getElementById("genericModal"),a=e==="nature",s=a?"Naturezas Financeiras":"Centros de Custo",r=a?Ca:La,o=a?Tn:Bn,n=a?"natures":"costCenters";t.innerHTML=`
    ...
    `}function Ss(){const e=document.getElementById("list-container");if(!e)return;const t=M.currentTab==="receivables",a=t?M.receivables:M.payables;let s=a;if(M.statusFilter!=="all"&&(s=a.filter(n=>n.status===M.statusFilter)),s.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),s.length===0){e.innerHTML=`
        ...
        `}).join("")}async function jl(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Rn(t,a):zn(t,a)),p("Sucesso","Lançamento baixado!","success"),await Ve()}catch(s){p("Erro",s.message,"error")}}async function Fl(e,t){if(await O("Excluir Lançamento","Tem certeza? Essa ação não pode ser desfeita."))try{await(e==="payable"?Nn(t):On(t)),p("Sucesso","Lançamento excluído.","success"),await Ve()}catch(s){p("Erro",s.message,"error")}}async function Hl(e,t){const s=e==="nature"?Pn:Dn;if(await O("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await s(t),fa(e==="nature"?"nature":"cost-center")}catch(o){p("Erro",o.message,"error")}}function Ol(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ta(e,t=null){const a=document.getElementById("genericModal"),s=e==="payable",r=`${t?"Editar":"Nova"} ${s?"Despesa":"Receita"}`,o=s?"red":"green",n=(u,g)=>{let b='<option value="">-- Selecione --</option>';const h=qa(u),f=(y,k=0)=>{const $="  ".repeat(k)+(k>0?"↳ ":""),w=y.id===g?"selected":"";b+=`<option value="${y.id}" ${w}>${$}${y.name}</option>`,y.children.forEach(I=>f(I,k+1))};return h.forEach(y=>f(y)),b};a.innerHTML=`
    ...
    `,A.historyData.length>0?Es(document.getElementById("history-list-container"),A.historyData):Na()}function Es(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const aa=document.getElementById("content");let we={allPackages:[],catalogForModal:{services:[],products:[]}},ht=null,Pe=null;function nd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `}).join("")}}function ko(){const e=document.getElementById("genericModal");e.style.display="none",Pe&&e.removeEventListener("click",Pe)}async function So(e=null){const t=document.getElementById("genericModal"),a=!!e,s=e?JSON.parse(JSON.stringify(e.items||[])):[],r=v(e?.name||""),o=v(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(b,h)=>{const f=h.querySelector("#originalPrice"),y=b.reduce((k,$)=>k+$.price*$.quantity,0);f&&(f.textContent=`R$ ${y.toFixed(2)}`)},g=b=>{b.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=b.map((h,f)=>{const y=h.type==="service",k=y?"Serviço":"Produto",$=y?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(b,t)};g(s),c.addEventListener("change",b=>{if(b.target.classList.contains("quantity-input")){const h=parseInt(b.target.dataset.index,10),f=parseInt(b.target.value,10);f>0&&s[h]&&(s[h].quantity=f,g(s))}}),c.addEventListener("click",b=>{if(b.target.classList.contains("remove-item-btn")){const h=parseInt(b.target.dataset.index,10);s.splice(h,1),g(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>ld(b=>{const h=s.find(f=>f.id===b.id&&f.type===b.type);h?h.quantity++:s.push({...b,quantity:1}),g(s)}),Pe&&t.removeEventListener("click",Pe),Pe=async b=>{const h=b.target.closest("button[data-action]");if(!h)return;const f=h.dataset.action;if(b.stopPropagation(),f==="close-modal"&&ko(),f==="save-package"){const y=h,k={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce(($,w)=>$+w.price*w.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!k.name||!k.price){p("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(k.items.length===0){p("Erro","Adicione pelo menos um item ao pacote.","error");return}y.disabled=!0,y.textContent="A salvar...";try{a?await un(k.id,k):(delete k.id,await cn(k)),p("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),ko(),await Ra()}catch($){p("Erro",`Não foi possível salvar o pacote: ${$.message}`,"error"),y.disabled=!1,y.textContent="Salvar Pacote"}}},t.addEventListener("click",Pe)}function ld(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=we.catalogForModal.services.filter(h=>h.name.toLowerCase().includes(d)),u=we.catalogForModal.products.filter(h=>h.name.toLowerCase().includes(d)),g=c.map(h=>`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:g}=d.dataset,h=(we.catalogForModal[u+"s"]||[]).find(f=>f.id===g);h&&(e({...h,type:u}),i())}else(c||l.target===a)&&i()})}async function Ra(){aa.innerHTML=`
    ...
    `}function va(){const e=st.filter(t=>!t.read).length;if(e>0?(ra.textContent=e,ra.classList.remove("hidden")):ra.classList.add("hidden"),st.length===0){Eo.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Eo.innerHTML=st.map(t=>`
    ...
    `).join("")}function xd(e){ot&&ot();const t=pe(_,"establishments",e,"notifications"),a=Rt(t,rt("timestamp",">=",new Date),Do("timestamp","desc"));ot=Rs(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();st.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),p(o.title,o.message,"info",!0),va();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(o.type==="cancellation"||o.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),ts())}})},s=>{console.error("Erro no listener de notificações em tempo real:",s)})}function Z(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=m.enabledModules?.[a]!==!1,o=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!r||!o){sa.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),xe.classList.contains("absolute")&&(xe.classList.add("hidden"),Be.classList.add("hidden"));return}}const s=vd[e];s?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),sa.innerHTML="",window.innerWidth<768&&(xe.classList.add("hidden"),Be.classList.add("hidden")),s(t)):sa.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`}async function yd(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(o&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),n&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!o&&!n))try{const i=await Dr();o&&s&&(s.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i)}}async function wd(e){try{console.log("[Nativo] Iniciando configuração de Push..."),oe.getPlatform()==="android"&&(await G.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let t=await G.checkPermissions();if(t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive!=="granted")return;await G.register(),G.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const s=me(_,"users",e);await ha(s,{fcmTokens:Ns(a.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(s){console.error("Erro ao salvar token FCM:",s)}}),G.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),G.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),p(a.title,a.body,"info",!0)}),G.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),Z("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function kd(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>e.style.display="block",r=()=>e.style.display="none",o=()=>e.style.display==="block";e&&(t.addEventListener("click",()=>{r(),oe.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{r(),oe.isNativePlatform()?Qa.exitApp():history.back()}),oe.isNativePlatform()?Qa.addListener("backButton",({canGoBack:n})=>{if(o())r();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),l=Array.from(i).filter(u=>u.id!=="exitConfirmationModal");if(l.length>0){l.forEach(u=>u.style.display="none");return}const d=document.getElementById("sidebar");if(d&&!d.classList.contains("hidden")&&window.innerWidth<768){d.classList.add("hidden"),document.getElementById("mobile-overlay").classList.add("hidden");return}const c=document.querySelector(".sidebar-link.active");c&&c.getAttribute("data-target")==="agenda-section"?s():Z("agenda-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",n=>{if(o()){r(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),l=Array.from(i).filter(c=>c.id!=="exitConfirmationModal");if(l.length>0){l.forEach(c=>c.style.display="none"),history.pushState(null,document.title,location.href);return}const d=document.querySelector(".sidebar-link.active");d&&d.getAttribute("data-target")==="agenda-section"?s():(Z("agenda-section"),history.pushState(null,document.title,location.href))})))}async function Sd(){try{await Ds(U,Ms),console.log("Persistência LOCAL configurada na inicialização.")}catch(e){console.error("Erro ao definir persistência no main.js",e)}oe.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Ys(),kd(),Co&&Co.addEventListener("click",e=>{e.stopPropagation(),xe.classList.remove("hidden"),xe.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl"),Be.classList.remove("hidden")}),Be&&Be.addEventListener("click",()=>{xe.classList.add("hidden"),xe.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl"),Be.classList.add("hidden")}),$o.addEventListener("click",e=>{e.stopPropagation(),yt.classList.toggle("hidden"),yt.classList.contains("hidden")||(st.forEach(t=>t.read=!0),va())}),na.addEventListener("click",e=>{e.stopPropagation(),te.classList.toggle("active"),te.classList.contains("active")?te.classList.remove("hidden"):setTimeout(()=>te.classList.add("hidden"),200)}),Io&&Io.addEventListener("click",e=>{e.preventDefault(),Z("my-profile-section"),te.classList.remove("active"),te.classList.add("hidden")}),document.addEventListener("click",e=>{!yt.contains(e.target)&&e.target!==$o&&yt.classList.add("hidden"),!te.contains(e.target)&&e.target!==na&&te.classList.contains("active")&&(te.classList.remove("active"),setTimeout(()=>te.classList.add("hidden"),200))}),To(U,async e=>{if(e){if(console.log("Usuário detectado:",e.email),!oe.isNativePlatform()&&(console.log("Inicializando Web Push (PWA)..."),Oo(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast"),s=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");setTimeout(()=>{t&&(t.style.display="block")},3500),a&&a.addEventListener("click",async()=>{await zo()&&t&&(t.style.display="none")});const o=()=>{t&&(t.style.display="none")};s&&s.addEventListener("click",o),r&&r.addEventListener("click",o)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const s=await Oe(a.establishmentId);m.enabledModules=s.modules,hd(s.themeColor||"indigo");let r=null,o=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=me(_,"users",e.uid),c=await Po(d);if(c.exists()){const u=c.data();r=a.role==="employee"?u.permissions||{}:null,o=u.name||o,n=u.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}m.userProfessionalId=n,oe.isNativePlatform()&&wd(e.uid);const i=o||e.email;Hs(a.establishmentId,s.name,r),na.textContent=i.charAt(0).toUpperCase(),gd.textContent=i,bd.textContent=e.email;const l=()=>{ot&&ot(),Fa(U).then(()=>window.location.href="/login.html")};fd.addEventListener("click",d=>{d.preventDefault(),l()}),Ks(Z,r,m.enabledModules),yd(r),xd(a.establishmentId),va(),xt.classList.add("fade-out"),oa.style.display="flex",setTimeout(()=>{xt.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{pr()},1500),Z("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),xt.classList.add("fade-out"),setTimeout(()=>{xt.style.display="none"},500),oa.innerHTML=`
                ...
                `,oa.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{Fa(U).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}Sd();To(U,async e=>{if(e){await Oo();const a="Notification"in window&&Notification.permission==="default",s=window.Capacitor&&window.Capacitor.isNativePlatform();if(a&&!s){const r=document.getElementById("toast-notification-request"),o=document.getElementById("btn-enable-toast"),n=document.getElementById("btn-deny-toast"),i=document.getElementById("btn-close-toast");setTimeout(()=>{r&&(r.style.display="block")},3500),o&&o.addEventListener("click",async()=>{await zo()&&r&&(r.style.display="none")});const l=()=>{r&&(r.style.display="none")};n&&n.addEventListener("click",l),i&&i.addEventListener("click",l)}}});export{Ho as W};
