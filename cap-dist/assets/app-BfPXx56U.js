const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-DF8A-80v.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-CQhY7Cv2.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as me,d as ge,m as Es}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Tr,reauthenticateWithCredential as Pr,verifyBeforeUpdateEmail as Br,updatePassword as Ar,updateProfile as Mr,setPersistence as qr,browserLocalPersistence as jr,onAuthStateChanged as Nr,signOut as Rr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as Pe,getDoc as rs,updateDoc as Tt,setDoc as Fr,addDoc as uo,collection as ga,query as po,where as bo,getDocs as Hr,deleteDoc as Or,arrayUnion as zr,orderBy as _r,onSnapshot as Vr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Ur,onMessage as Wr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Jr(t,e,a){m.establishmentId=t,m.establishmentName=e,m.userPermissions=a,m.currentViewContext={type:"BRANCH",id:t,name:e}}const mo=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ja=mo?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${mo?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",ja);async function Qr(){const t=me.currentUser;return t?{"Content-Type":"application/json",Authorization:`Bearer ${await t.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function C(t,e={}){const a=await Qr();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=ja.replace(/\/$/,""),r=t.startsWith("/")?t:`/${t}`,o=`${s}${r}`;console.log(`AuthenticatedFetch: ${e.method||"GET"} ${o}`);try{const i=await fetch(o,{...e,headers:{...a,...e.headers}});if(!i.ok){const l=(await i.json().catch(()=>({message:i.statusText}))).message||`Erro na API: ${i.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,u=l.match(d),c=u?u[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${o}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${o}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ja}. Verifique se o servidor backend está rodando.`):i}}const is=(t,e,a,s=null)=>{let r=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),C(r)},Gr=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return C(s)},Yr=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return C(r)},Xr=t=>C("/api/appointments",{method:"POST",body:JSON.stringify(t)}),Kr=(t,e)=>C(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),Zr=t=>C(`/api/appointments/${t}`,{method:"DELETE"}),ei=t=>C(`/api/appointments/${t}/reopen`,{method:"POST"}),ti=(t,e)=>C(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)});let ne;async function ai(){if(!ne)try{ne=new(window.AudioContext||window.webkitAudioContext)}catch(t){console.error("Não foi possível inicializar o áudio:",t)}}function si(){if(!ne){console.warn("AudioContext não inicializado. O som não será tocado.");return}ne.state==="suspended"&&ne.resume();const t=ne.createOscillator(),e=ne.createGain();t.connect(e),e.connect(ne.destination),t.type="sine",t.frequency.setValueAtTime(800,ne.currentTime),e.gain.setValueAtTime(0,ne.currentTime),e.gain.linearRampToValueAtTime(.3,ne.currentTime+.01),e.gain.exponentialRampToValueAtTime(1e-4,ne.currentTime+.2),t.start(ne.currentTime),t.stop(ne.currentTime+.2)}function f(t,e,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&si();const o=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${i[a]||i.info}`,o.innerHTML=`
    ...
    `,r.appendChild(o),o.querySelector(".toast-close").addEventListener("click",()=>o.remove()),setTimeout(()=>{o.remove()},4e3)}function X(t,e){const a=document.getElementById("genericModal");return new Promise(s=>{a.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),r.addEventListener("click",u=>{u.target.closest(".modal-content")||i()}),r.style.display="flex",{modalElement:r,close:i,setContent:n}}function oi(){document.body.addEventListener("click",()=>{ne||ai()},{once:!0}),document.addEventListener("click",t=>{const e=t.target.closest('[data-action="close-modal"]');if(e){const s=e.dataset.target;if(s){const r=document.getElementById(s);r&&(r.style.display="none")}}if(t.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}const re=document.getElementById("sidebar"),He=document.getElementById("sidebarToggle"),yt=document.getElementById("mainContent"),ri=document.querySelectorAll(".sidebar-link"),Na=document.getElementById("menu-search"),Is=document.getElementById("hamburger-menu-btn"),et=document.getElementById("mobile-overlay");let Te=!0;function Ne(t){if(!re||!yt)return;re.classList.toggle("collapsed",t),yt.classList.toggle("sidebar-collapsed-shift",t);const e=re.querySelector(".sidebar-search-container"),a=re.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const r=s.getAttribute("data-target-submenu"),o=document.getElementById(r),i=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function ii(){!re||!et||(re.classList.add("mobile-open"),et.classList.add("visible"))}function qt(){!re||!et||(re.classList.remove("mobile-open"),et.classList.remove("visible"))}function ni(){Ne(!re.classList.contains("collapsed"))}function li(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&re.classList.contains("collapsed")&&Ne(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function di(){Na&&Na.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),r=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),r.forEach(o=>o.style.display="block");return}r.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const i=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function ci(t,e,a){if(!re||!yt)return;yt.classList.add("main-content-shift"),window.innerWidth>=1024?(Te=!0,Ne(!1)):window.innerWidth>=768?(Te=!1,Ne(!0)):(yt.classList.remove("main-content-shift","sidebar-collapsed-shift"),qt()),He&&He.addEventListener("click",r=>{r.stopPropagation(),window.innerWidth>=768?(Te=!Te,Ne(!Te),Te?(He.classList.add("text-indigo-400"),He.classList.remove("text-gray-400")):(He.classList.remove("text-indigo-400"),He.classList.add("text-gray-400"))):ni()}),re.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Te&&re.classList.contains("collapsed")&&Ne(!1)}),re.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Te){const r=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===Na;!r&&!o&&Ne(!0)}}),Is&&Is.addEventListener("click",r=>{r.stopPropagation(),ii()}),et&&et.addEventListener("click",r=>{r.stopPropagation(),qt()});let s=0;re.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),re.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&qt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(r=>{r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const i=r.getAttribute("data-target-submenu"),n=r.querySelector(".submenu-arrow");li(i,n)})}),di(),ri.forEach(r=>{const o=r.getAttribute("data-target");if(!o)return;const i=o.replace("-section",""),n=a?.[i]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){r.parentElement&&r.parentElement.tagName==="LI"?r.parentElement.style.display="none":r.style.display="none";return}r.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),r.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&qt()})})}const ui=t=>C("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),ve=()=>C("/api/establishments/hierarchy",{method:"GET"}),Be=t=>{const e=t||m.establishmentId;return e?C(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ns=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},pi=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},bi=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ke=t=>C(`/api/professionals/${t}`),go=t=>C(`/api/professionals/details/${t}`),mi=t=>C("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Ra=(t,e)=>C(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),fo=t=>C(`/api/professionals/${t}`,{method:"DELETE"}),gi=t=>{const e=t.map(a=>fo(a));return Promise.all(e)};class fi{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const r=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${r.top+window.scrollY-o}px`,this.spotlight.style.left=`${r.left+window.scrollX-o}px`,this.spotlight.style.width=`${r.width+o*2}px`,this.spotlight.style.height=`${r.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(r)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(e){const a=this.popover.getBoundingClientRect(),s=20;let r=e.bottom+window.scrollY+s,o=e.left+window.scrollX;r+a.height>window.scrollY+window.innerHeight&&(r=e.top+window.scrollY-a.height-s),o+a.width>window.innerWidth&&(o=e.right+window.scrollX-a.width),o<s&&(o=s),this.popover.style.top=`${r}px`,this.popover.style.left=`${o}px`}handleResize(){this.isActive&&this.renderStep()}sleep(e){return new Promise(a=>setTimeout(a,e))}async waitForElement(e,a){if(!e)return null;const s=Date.now();for(;Date.now()-s<a;){const r=document.querySelector(e);if(r)return r;await this.sleep(100)}return null}}async function xi(){try{console.log("A verificar Onboarding interativo...");const t=await Be(m.establishmentId);if(!t||t.parentId||t.onboardingCompleted)return;const e=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await ns(m.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(r){console.error("Erro ao gravar fim do onboarding",r)}};new fi(e,a,a).start()}catch(t){console.error("Erro fatal ao iniciar onboarding:",t)}}var tt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(tt||(tt={}));class Ia extends Error{constructor(e,a,s){super(e),this.message=e,this.code=a,this.data=s}}const hi=t=>{var e,a;return t?.androidBridge?"android":!((a=(e=t?.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},vi=t=>{const e=t.CapacitorCustomPlatform||null,a=t.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>e!==null?e.name:hi(t),o=()=>r()!=="web",i=c=>{const p=d.get(c);return!!(p?.platforms.has(r())||n(c))},n=c=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===c)},l=c=>t.console.error(c),d=new Map,u=(c,p={})=>{const b=d.get(c);if(b)return console.warn(`Capacitor plugin "${c}" already registered. Cannot register plugins twice.`),b.proxy;const g=r(),v=n(c);let y;const $=async()=>(!y&&g in p?y=typeof p[g]=="function"?y=await p[g]():y=p[g]:e!==null&&!y&&"web"in p&&(y=typeof p.web=="function"?y=await p.web():y=p.web),y),P=(E,I)=>{var T,N;if(v){const H=v?.methods.find(U=>I===U.name);if(H)return H.rtype==="promise"?U=>a.nativePromise(c,I.toString(),U):(U,D)=>a.nativeCallback(c,I.toString(),U,D);if(E)return(T=E[I])===null||T===void 0?void 0:T.bind(E)}else{if(E)return(N=E[I])===null||N===void 0?void 0:N.bind(E);throw new Ia(`"${c}" plugin is not implemented on ${g}`,tt.Unimplemented)}},A=E=>{let I;const T=(...N)=>{const H=$().then(U=>{const D=P(U,E);if(D){const W=D(...N);return I=W?.remove,W}else throw new Ia(`"${c}.${E}()" is not implemented on ${g}`,tt.Unimplemented)});return E==="addListener"&&(H.remove=async()=>I()),H};return T.toString=()=>`${E.toString()}() { [capacitor code] }`,Object.defineProperty(T,"name",{value:E,writable:!1,configurable:!1}),T},S=A("addListener"),L=A("removeListener"),z=(E,I)=>{const T=S({eventName:E},I),N=async()=>{const U=await T;L({eventName:E,callbackId:U},I)},H=new Promise(U=>T.then(()=>U({remove:N})));return H.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await N()},H},F=new Proxy({},{get(E,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?z:S;case"removeListener":return L;default:return A(I)}}});return s[c]=F,d.set(c,{name:c,proxy:F,platforms:new Set([...Object.keys(p),...v?[g]:[]])}),F};return a.convertFileSrc||(a.convertFileSrc=c=>c),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=i,a.registerPlugin=u,a.Exception=Ia,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},yi=t=>t.Capacitor=vi(t),we=yi(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),fa=we.registerPlugin;class xo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,a){let s=!1;this.listeners[e]||(this.listeners[e]=[],s=!0),this.listeners[e].push(a);const o=this.windowListeners[e];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(e);const i=async()=>this.removeListener(e,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,a,s){const r=this.listeners[e];if(!r){if(s){let o=this.retainedEventArguments[e];o||(o=[]),o.push(a),this.retainedEventArguments[e]=o}return}r.forEach(o=>o(a))}hasListeners(e){var a;return!!(!((a=this.listeners[e])===null||a===void 0)&&a.length)}registerWindowListener(e,a){this.windowListeners[a]={registered:!1,windowEventName:e,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(e="not implemented"){return new we.Exception(e,tt.Unimplemented)}unavailable(e="not available"){return new we.Exception(e,tt.Unavailable)}async removeListener(e,a){const s=this.listeners[e];if(!s)return;const r=s.indexOf(a);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const a=this.retainedEventArguments[e];a&&(delete this.retainedEventArguments[e],a.forEach(s=>{this.notifyListeners(e,s)}))}}const Ls=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Cs=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class wi extends xo{async getCookies(){const e=document.cookie,a={};return e.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Cs(r).trim(),o=Cs(o).trim(),a[r]=o}),a}async setCookie(e){try{const a=Ls(e.key),s=Ls(e.value),r=`; expires=${(e.expires||"").replace("expires=","")}`,o=(e.path||"/").replace("path=",""),i=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const a of e)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}fa("CapacitorCookies",{web:()=>new wi});const ki=async t=>new Promise((e,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;e(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(t)}),$i=(t={})=>{const e=Object.keys(t);return Object.keys(t).map(r=>r.toLocaleLowerCase()).reduce((r,o,i)=>(r[o]=t[e[i]],r),{})},Si=(t,e=!0)=>t?Object.entries(t).reduce((s,r)=>{const[o,i]=r;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=e?encodeURIComponent(d):d,l+=`${o}=${n}&`}),l.slice(0,-1)):(n=e?encodeURIComponent(i):i,l=`${o}=${n}`),`${s}&${l}`},"").substr(1):null,Ei=(t,e={})=>{const a=Object.assign({method:t.method||"GET",headers:t.headers},e),r=$i(t.headers)["content-type"]||"";if(typeof t.data=="string")a.body=t.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[i,n]of Object.entries(t.data||{}))o.set(i,n);a.body=o.toString()}else if(r.includes("multipart/form-data")||t.data instanceof FormData){const o=new FormData;if(t.data instanceof FormData)t.data.forEach((n,l)=>{o.append(l,n)});else for(const n of Object.keys(t.data))o.append(n,t.data[n]);a.body=o;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(r.includes("application/json")||typeof t.data=="object")&&(a.body=JSON.stringify(t.data));return a};class Ii extends xo{async request(e){const a=Ei(e,e.webFetchExtra),s=Si(e.params,e.shouldEncodeUrlParams),r=s?`${e.url}?${s}`:e.url,o=await fetch(r,a),i=o.headers.get("content-type")||"";let{responseType:n="text"}=o.ok?e:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await o.blob(),l=await ki(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const u={};return o.headers.forEach((c,p)=>{u[p]=c}),{data:l,headers:u,status:o.status,url:o.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}fa("CapacitorHttp",{web:()=>new Ii});const ce=fa("PushNotifications",{}),Li="modulepreload",Ci=function(t){return"/"+t},Ds={},Di=function(e,a,s){let r=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");r=l(a.map(d=>{if(d=Ci(d),d in Ds)return;Ds[d]=!0;const u=d.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":Li,u||(p.as="script"),p.crossOrigin="",p.href=d,n&&p.setAttribute("nonce",n),document.head.appendChild(p),u)return new Promise((b,g)=>{p.addEventListener("load",b),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return r.then(i=>{for(const n of i||[])n.status==="rejected"&&o(n.reason);return e().catch(o)})},Ts=fa("App",{web:()=>Di(()=>import("./web-DF8A-80v.js"),__vite__mapDeps([0,1,2,3])).then(t=>new t.AppWeb)}),Ti="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ps=!1;async function Pi(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await ce.removeAllListeners(),await ce.addListener("registration",async a=>{vo(a.value,!0)}),await ce.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await ce.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let e=await ce.checkPermissions();e.receive==="prompt"&&(e=await ce.requestPermissions()),e.receive==="granted"&&await ce.register()}catch(e){console.error("[Push Nativo] Erro:",e)}return}"Notification"in window&&Notification.permission==="granted"&&ho()}async function Bi(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await ho(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(t){return console.error("Erro ao pedir permissão Web:",t),!1}}async function ho(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await t.update();const e=await Ur(Es,{vapidKey:Ti,serviceWorkerRegistration:t});e?(console.log("[Push Web] Token validado."),await vo(e,!1)):console.warn("[Push Web] Token veio vazio."),Ps||(Wr(Es,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Ps=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}else console.warn("Navegador sem suporte a Service Worker.")}async function vo(t,e){const a=me.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=Pe(ge,"users",a.uid);try{const r=await rs(s);if(r.exists()){const i=r.data().fcmTokens||[];if(i.length===1&&i[0]===t){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Tt(s,{fcmTokens:[t],lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Fr(s,{email:a.email,fcmTokens:[t],platform:e?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",r)}}const Ai=(t,e,a="all",s="all")=>{const r=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),C(`/api/reports/indicators?${r.toString()}`)},Mi=(t,e="all")=>{const a=new URLSearchParams({date:t});return e&&e!=="all"&&a.append("professionalId",e),C(`/api/reports/appointments/list?${a.toString()}`)},qi=t=>t?C(`/api/financial/cost-centers/${t}`):Promise.resolve([]),ji=(t,e,a)=>{const s=new URLSearchParams({startDate:e,endDate:a});return C(`/api/analytics/${t}?${s.toString()}`)},oa=({establishmentId:t,startDate:e,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:e,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),t&&r.append("establishmentId",t),C(`/api/reports/sales?${r.toString()}`)},Ni=(t,e,a)=>C(`/api/analytics/${t}/monthly-details?year=${e}&month=${a}`),Ri=(t,e,a,s)=>{const r=`/api/analytics/${t}/daily-details?year=${e}&month=${a}&day=${s}`;return C(r)},Fi=(t,e,a,s)=>{const r=`/api/analytics/${t}/professional-details?year=${e}&month=${a}&professionalId=${s}`;return C(r)},Hi=(t,e,a,s)=>C(`/api/reports/commissions/${t}?year=${e}&month=${a}&professionalId=${s}`),yo=()=>C("/api/reports/summary",{method:"GET"}),Oi=Object.freeze(Object.defineProperty({__proto__:null,getAdvancedIndicators:Ai,getAnalytics:ji,getCommissionReport:Hi,getCostCenters:qi,getDailyAppointments:Mi,getDailyTransactions:Ri,getMonthlyAnalytics:Ni,getProfessionalMonthlyDetails:Fi,getSalesReport:oa,getSummaryKPIs:yo},Symbol.toStringTag,{value:"Module"})),ls=t=>t?String(t).replace(/\D/g,""):"",lt=(t,e="",a=20,s={})=>{const r=new URLSearchParams;return e&&r.append("search",e),a&&r.append("limit",a),s&&s.hasLoyalty&&r.append("hasLoyalty","true"),s&&s.birthMonth&&r.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),C(`/api/clients/${t}?${r.toString()}`)},wo=(t,e)=>{const a=encodeURIComponent(e);return C(`/api/clients/details/${t}/${a}`)},ko=t=>{const e=t.phone||t.id;if(!e)throw new Error("Telefone é obrigatório");const a=ls(e),s={...t,phone:a,id:a};return C(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},$o=ko,So=(t,e)=>ko({...e,id:t}),Eo=t=>{const e=encodeURIComponent(t);return C(`/api/clients/${e}`,{method:"DELETE"})},zi=(t,e,a,s)=>C("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientPhone:ls(e),points:a,rewardName:s})}),_i=(t,e)=>wo(t,ls(e));function h(t){return t==null?"":String(t).replace(/[&<>'"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[e])}function xa(t,e=800,a=800,s=.7){return new Promise((r,o)=>{if(!t.type.match(/image.*/))return o(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(t),i.onload=n=>{const l=new Image;l.src=n.target.result,l.onload=()=>{let d=l.width,u=l.height;d>u?d>e&&(u*=e/d,d=e):u>a&&(d*=a/u,u=a);const c=document.createElement("canvas");c.width=d,c.height=u,c.getContext("2d").drawImage(l,0,0,d,u);const b=c.toDataURL("image/jpeg",s);r(b)},l.onerror=d=>o(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>o(new Error("Erro ao ler o ficheiro."))})}function La(t){const e=parseFloat(t);return isNaN(e)?"R$ 0,00":e.toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}let Ca=null;async function Vi(){const t=document.getElementById("content");t.innerHTML=`
    ...
    `;try{const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),s=new Date(a);s.setHours(23,59,59,999);const r=new Date(a.getFullYear(),a.getMonth(),1),o=new Date(a);o.setDate(a.getDate()-6);const i=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId],n=i.map(async D=>{const[W,te]=await Promise.all([is(D,r.toISOString(),s.toISOString(),null),lt(D)]);return{appts:W||[],clients:te||[]}}),l=await Promise.all(n);let d=[],u=[];l.forEach(D=>{d=d.concat(D.appts),u=u.concat(D.clients)});const c=D=>(D.services||[]).reduce((W,te)=>W+(Number(te.price)||0),0)||Number(D.totalPrice||0)||Number(D.servicePrice||0),p=d.filter(D=>{const W=new Date(D.startTime);return W>=a&&W<=s}),b=p.filter(D=>D.status==="completed"),g=d.filter(D=>D.status==="completed"),v=b.reduce((D,W)=>D+c(W),0),y=g.reduce((D,W)=>D+c(W),0),$=p.length,P=g.length>0?y/g.length:0,A=[],S=[],L=["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"];for(let D=0;D<7;D++){const W=new Date(o);W.setDate(o.getDate()+D),A.push(L[W.getDay()]);const te=new Date(W).setHours(0,0,0,0),Z=new Date(W).setHours(23,59,59,999),Mt=d.filter(qe=>{const Q=new Date(qe.startTime).getTime();return qe.status==="completed"&&Q>=te&&Q<=Z}).reduce((qe,Q)=>qe+c(Q),0);S.push(Mt)}const z={labels:A,data:S},F=p.filter(D=>new Date(D.startTime).getTime()>=e.getTime()&&D.status!=="completed"&&D.status!=="cancelled").sort((D,W)=>new Date(D.startTime)-new Date(W.startTime)).slice(0,4).map(D=>({client:D.clientName||"Desconhecido",service:D.serviceName||(D.services&&D.services[0]?D.services[0].name:"Serviço"),time:new Date(D.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(D.professionalName||"").split(" ")[0]||"Profissional",id:D.id})),E=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,I=new Map;u.forEach(D=>{D.phone?I.set(D.phone,D):I.set(D.id||Math.random().toString(),D)});const N=Array.from(I.values()).filter(D=>{if(!D.birthDate)return!1;let W,te;if(D.birthDate.includes("-")){const Z=D.birthDate.split("-");Z[0].length===4?(W=Z[1],te=Z[2]):(te=Z[0],W=Z[1])}else if(D.birthDate.includes("/")){const Z=D.birthDate.split("/");te=Z[0],W=Z[1]}return`${te}/${W}`===E}).map(D=>{let W="";return D.birthDate&&D.birthDate.includes("-")&&D.birthDate.split("-")[0].length===4&&(W=a.getFullYear()-parseInt(D.birthDate.split("-")[0])),{name:D.name,age:W,phone:D.phone}}),H={receitaHoje:v,agendamentosHoje:$,receitaMes:y,ticketMedio:P},U=i.length>1;Ui(t,H,z,F,N,U),Wi(z),Ji()}catch(e){console.error("Erro ao carregar dashboard:",e),t.innerHTML=`
        ...
        `}}function Ui(t,e,a,s,r,o){const i=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),n=o?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-0.5 rounded-full ml-2 align-middle">CONSOLIDADO</span>':"";t.innerHTML=`
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-6">
                ...
                <div class="space-y-5 md:space-y-6">
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-slate-100">
                        ...
                        <div class="space-y-3">
                            ${r.length>0?r.map(l=>{const u=`https://wa.me/${(l.phone||"").replace(/\D/g,"")}?text=${encodeURIComponent(`Olá ${l.name.split(" ")[0]}! A equipa deseja-lhe um Feliz Aniversário! 🎉`)}`;return`
                                <div class="flex items-center justify-between p-3 rounded-[12px] border border-rose-50 bg-rose-50/30">
                                    ...
                                    <a href="${u}" target="_blank" class="w-8 h-8 rounded-full bg-white text-emerald-500 shadow-sm border border-emerald-50 flex items-center justify-center hover:bg-emerald-50 transition-colors" title="Enviar Parabéns pelo WhatsApp">
    ...
    `}function Wi(t){const e=document.getElementById("revenueChart");if(!e)return;Ca&&Ca.destroy();const s=e.getContext("2d").createLinearGradient(0,0,0,240);s.addColorStop(0,"rgba(79, 70, 229, 0.15)"),s.addColorStop(1,"rgba(79, 70, 229, 0.01)"),Ca=new Chart(e,{type:"line",data:{labels:t.labels,datasets:[{label:"Receita (R$)",data:t.data,borderColor:"#6366f1",backgroundColor:s,borderWidth:2.5,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.35}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,cornerRadius:8,titleFont:{size:12,family:"Inter",weight:"normal"},bodyFont:{size:13,weight:"bold",family:"Inter"},displayColors:!1,callbacks:{label:function(r){return r.parsed.y!==null?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(r.parsed.y):""}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:10},maxTicksLimit:6,callback:function(r){return"R$ "+r}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function Ji(){document.getElementById("content").addEventListener("click",e=>{const a=e.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":ae("agenda-section");break;case"new-appointment":ae("agenda-section");break;case"goto-pdv":ae("comandas-section");break;case"goto-clients":ae("clientes-section");break;case"open-link":const r=`${window.location.origin}/cliente.html?id=${m.establishmentId||""}`;window.open(r,"_blank");break}})}const dt=t=>C(`/api/services/${t}`),Qi=t=>C("/api/services",{method:"POST",body:JSON.stringify(t)}),Gi=(t,e)=>C(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Io=t=>C(`/api/services/${t}`,{method:"DELETE"}),ha=(t,e,a,s="all")=>{const r=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return C(r)},va=t=>C("/api/blockages",{method:"POST",body:JSON.stringify(t)}),ds=t=>C(`/api/blockages/${t}`,{method:"DELETE"}),Lo=t=>C("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Bs=document.getElementById("content");let As=!1;const ra=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let ya=[],Fa=[],ia={},Co=[],O={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},R={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Do(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function Xt(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${r}`}function cs(){const t=document.getElementById("profSelectorContainer");if(!t||!m.professionals)return;let e=m.professionals.filter(r=>O.showInactiveProfs||r.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(r=>{const o=O.selectedProfessionalId===r.id,i=r.name==="Todos"?"T":r.name.charAt(0).toUpperCase(),n=r.id!=="all"?m.professionalColors.get(r.id)||ra[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        `}t.innerHTML=s,t.querySelectorAll('[data-action="select-date"]').forEach(o=>{o.addEventListener("click",()=>{const i=new Date(o.dataset.date);O.currentDate=i,navigator.vibrate&&navigator.vibrate(30),Se()})}),requestAnimationFrame(()=>{const o=t.querySelector(".bg-indigo-600");o&&o.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})})}function Y(t){return h(t||"")}function Xi(t,e,a,s,r){const o=(t||"").replace(/\D/g,""),i=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${e}! Você tem um agendamento de ${a} com ${s} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${o}?text=${encodeURIComponent(l)}`}function Ki(t){const e=document.getElementById("agenda-view");if(!e)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=Do(O.currentDate),r=new Date;r.setHours(0,0,0,0);let o='<div class="week-container flex gap-2 overflow-x-auto hide-scrollbar px-4" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(s);n.setDate(s.getDate()+i);const l=n.toDateString()===r.toDateString(),d=t.filter(c=>new Date(c.startTime).toDateString()===n.toDateString()).sort((c,p)=>new Date(c.startTime)-new Date(p.startTime));let u="";d.length===0?u='<div class="week-empty text-xs text-gray-400 text-center py-4 bg-gray-50 rounded-lg border border-dashed border-gray-200"><i class="bi bi-dash-lg block text-lg mb-1"></i>Livre</div>':u=d.map(c=>{const b=new Date(c.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),g=m.professionalColors.get(c.professionalId)||{main:"#adb5bd"},v=c.status==="completed",y=O.selectedItems.has(c.id);if(c.type==="blockage")return`<div class="week-event-chip bg-red-50 border-l-4 border-red-500 rounded-md p-2 mb-2">
                    ...
                    </div>`;const $=JSON.stringify(c).replace(/'/g,"&apos;"),P=y?"ring-2 ring-indigo-500 bg-indigo-50":"bg-white",A=O.isSelectionMode?`<div class="absolute top-1 right-1 z-10">
        ...
        </div>`}o+="</div>",e.innerHTML=o,requestAnimationFrame(()=>{const i=document.getElementById("weekScroller");if(i&&window.innerWidth<768){const n=i.querySelector(".is-today");n&&n.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})}})}function Zi(t){const e=document.getElementById("agenda-view");if(!e)return;if(t.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),t.length===0){e.innerHTML=`
            ...
            </div>`;return}const g=Xi(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),v=(s.services||[]).reduce((P,A)=>P+(Number(A.price)||0),0)||Number(s.totalPrice||0)||Number(s.servicePrice||0),y=s.paymentStatus||(s.status==="completed"?"Finalizado":"Agendado"),$=Y((s.professionalName||"").split(" ")[0]);a+=`<div class="list-card flex rounded-2xl p-3.5 shadow-sm border border-gray-100 cursor-pointer transition-transform active:scale-95 ${b} ${d?"opacity-70 bg-gray-50":""}"
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function To(){const t=m.allEvents.filter(e=>O.selectedProfessionalId==="all"||e.professionalId===O.selectedProfessionalId);O.currentView==="list"?Zi(t):Ki(t),us()}function us(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(O.isSelectionMode&&O.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function en(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(O.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(O.currentView==="list"){Yi();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function Se(){const t=document.getElementById("agenda-view");if(!t)return;O.selectedItems.clear(),us(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',en();let e,a;if(O.currentView==="list")e=new Date(O.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=Do(O.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const r=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async d=>{const[u,c]=await Promise.all([is(d,e.toISOString(),a.toISOString(),O.selectedProfessionalId==="all"?null:O.selectedProfessionalId),ha(d,e.toISOString(),a.toISOString(),O.selectedProfessionalId)]);return{appts:u||[],blockages:c||[]}}),o=await Promise.all(r);let i=[],n=[];if(o.forEach(d=>{i=i.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(u=>({...u,type:u.type||"appointment",professionalName:u.professionalName||(()=>{const c=m.professionals?.find(p=>p.id===u.professionalId);return c?c.name:"Indefinido"})()}));m.allEvents=[...l(i),...l(n)],cs(),To()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function tn(){try{const e=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async i=>{const[n,l,d]=await Promise.all([ke(i),dt(i),Be(i)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,r=new Map;let o=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>s.set(n.id,n)),i.services.forEach(n=>r.set(n.id,n))}),m.professionals=Array.from(s.values()),m.services=Array.from(r.values()),Co=[],o&&(ia=o.loyaltyProgram||{enabled:!1}),m.professionals.forEach((i,n)=>{m.professionalColors.set(i.id,ra[n%ra.length])}),cs()}catch{f("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function Po(t={}){O.currentDate=t.targetDate?new Date(t.targetDate):O.currentDate||new Date,O.isSelectionMode=!1,O.selectedItems.clear(),Bs.innerHTML=`
        ...
        </div>`,document.getElementById("btnTodayHeader").addEventListener("click",()=>{O.currentDate=new Date,navigator.vibrate&&navigator.vibrate(30),Se()}),document.getElementById("btnPrevDate").addEventListener("click",()=>{const a=O.currentView==="week"?7:1;O.currentDate.setDate(O.currentDate.getDate()-a),navigator.vibrate&&navigator.vibrate(20),Se()}),document.getElementById("btnNextDate").addEventListener("click",()=>{const a=O.currentView==="week"?7:1;O.currentDate.setDate(O.currentDate.getDate()+a),navigator.vibrate&&navigator.vibrate(20),Se()});const e=document.querySelectorAll(".agenda-view-toggle button");e.forEach(a=>{a.addEventListener("click",()=>{e.forEach(s=>{s.classList.remove("bg-white","shadow-sm"),s.classList.add("text-gray-500")}),a.classList.add("bg-white","shadow-sm"),a.classList.remove("text-gray-500"),O.currentView=a.dataset.view,navigator.vibrate&&navigator.vibrate(20),Se()})}),document.getElementById("btnWeekDays").addEventListener("click",an),As||(Bs.addEventListener("click",async a=>{const s=a.target.closest('[data-action="open-comanda"]');if(s){a.stopPropagation(),navigator.vibrate&&navigator.vibrate(20);const l=s.dataset.appointment||s.closest("[data-appointment]")?.dataset.appointment;if(!l)return;const d=JSON.parse(l.replace(/&apos;/g,"'")),u=d.status==="completed"?"finalizadas":"em-atendimento",c={selectedAppointmentId:d.id,initialFilter:u};u==="finalizadas"&&d.transaction?.paidAt&&(c.filterDate=typeof d.transaction.paidAt=="object"?new Date(d.transaction.paidAt._seconds*1e3):d.transaction.paidAt),ae("comandas-section",c);return}const r=a.target.closest(".lc-action-btn.wa");if(r){a.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),r.dataset.link&&window.open(r.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const l=O.selectedItems.size;await X("Apagar Selecionados",`Deseja apagar ${l} registro(s)? Esta ação é irreversível.`)&&(await Promise.all(Array.from(O.selectedItems).map(async u=>{try{await Zr(u)}catch{}})),f(`${l} registro(s) apagado(s).`,"success"),O.selectedItems.clear(),O.isSelectionMode=!1,Se());return}const o=a.target.closest('[data-action="select-professional"]');if(o){navigator.vibrate&&navigator.vibrate(20);const l=o.dataset.profId;O.selectedProfessionalId=O.selectedProfessionalId===l&&l!=="all"?"all":l,Se();return}const i=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(i){if(O.isSelectionMode){a.stopPropagation();const d=i.querySelector('input[type="checkbox"]');if(d){const u=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'")),c=!d.checked;d.checked=c,c?O.selectedItems.add(u.id):O.selectedItems.delete(u.id),(i.classList.contains("week-event-chip")||i.classList.contains("list-card"))&&(c?(i.classList.add("ring-2","ring-indigo-500","bg-indigo-50"),i.classList.remove("bg-white")):(i.classList.remove("ring-2","ring-indigo-500","bg-indigo-50"),i.classList.add("bg-white"))),navigator.vibrate&&navigator.vibrate(15),us()}return}const l=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"));navigator.vibrate&&navigator.vibrate(20),Ha(l);return}if(a.target.closest('[data-action="new-appointment"]')){navigator.vibrate&&navigator.vibrate(30),Ha();return}}),As=!0),await tn(),await Se()}function an(){const t=document.getElementById("optionsSheet");if(t){t.remove();return}const e=document.createElement("div");e.id="optionsSheet",e.className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white rounded-t-3xl z-[10000] shadow-[0_-8px_40px_rgba(0,0,0,0.15)] transition-transform duration-300 translate-y-full";const a=O.isSelectionMode?"bg-red-50 text-red-600":"bg-green-50 text-green-700",s=O.isSelectionMode?"bi-x-circle":"bi-check2-square";e.innerHTML=`
        <div class="px-6 py-5">
        ...
        </div>`;const r=document.createElement("div");r.id="optionsOverlay",r.className="fixed inset-0 bg-black/40 z-[9999] opacity-0 transition-opacity duration-300",document.body.appendChild(r),document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.remove("translate-y-full"),r.classList.remove("opacity-0")});const o=()=>{e.classList.add("translate-y-full"),r.classList.add("opacity-0"),setTimeout(()=>{e.remove(),r.remove()},300)};document.getElementById("closeOptSheet").addEventListener("click",o),r.addEventListener("click",o),document.getElementById("optSelectMode").addEventListener("click",()=>{O.isSelectionMode=!O.isSelectionMode,O.isSelectionMode||O.selectedItems.clear(),o(),To()}),document.getElementById("optInactiveToggle").addEventListener("change",i=>{O.showInactiveProfs=i.target.checked,cs()})}function gt(t){t<1||t>4||(R.step=t,Ha(null,!0))}function sn(t){return{title:t?"Editar Reserva":"Novo Cliente",content:`
        ...
        </div>`}}function on(){return{title:"Serviços",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            ...
            <div id="apptServicesContainer" class="flex-1 overflow-y-auto grid grid-cols-2 gap-3 content-start pb-4">
                ${ya.map(t=>`<div class="service-card p-3 bg-white rounded-xl border-2 transition-all active:scale-95 ${R.data.selectedServiceIds.includes(t.id)?"border-indigo-500 bg-indigo-50 shadow-md":"border-gray-100 hover:border-gray-200 shadow-sm"} cursor-pointer flex flex-col justify-between gap-2" data-service-id="${t.id}">
                        <div>
        ...
        </div>`}}function rn(){return{title:"Equipe",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            <div class="relative">
                <i class="bi bi-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-base"></i>
        ...
        </div>`}}function nn(){const t=R.data.date||Xt();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
        ...
        </div>`}}async function Ha(t=null,e=!1){const a=document.getElementById("appointmentModal");e||(R={step:1,data:{id:t?.id||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(i=>i.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:t?.startTime?Xt(new Date(t.startTime)):Xt(),time:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,originalDate:t?.startTime?Xt(new Date(t.startTime)):null,originalTime:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}}),ya=m.services||[],Fa=(m.professionals||[]).filter(i=>i.status==="active");let s;switch(R.step){case 1:s=sn(t);break;case 2:s=on();break;case 3:s=rn();break;case 4:s=nn();break}a.className="fixed inset-0 z-[10000] hidden flex items-end md:items-center justify-center bg-gray-900/50 backdrop-blur-sm transition-opacity duration-300 opacity-0",a.innerHTML=`
    ...
    `;const r=()=>{const i=a.querySelector("#appointmentModalContent");i&&(i.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),i.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),a.classList.add("opacity-0"),setTimeout(()=>{a.classList.add("hidden")},300)};a.querySelectorAll('[data-action="next-step"]').forEach(i=>i.addEventListener("click",()=>{const n=parseInt(i.dataset.currentStep,10);if(n===1&&(R.data.clientName=a.querySelector("#apptClientName").value.trim(),R.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!R.data.clientName))return f("Preencha o nome do cliente.","warning");if(n===2&&R.data.selectedServiceIds.length===0)return f("Selecione um serviço.","warning");if(n===3&&!R.data.professionalId)return f("Escolha um membro da equipe.","warning");gt(n+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(i=>i.addEventListener("click",()=>gt(parseInt(i.dataset.currentStep,10)-1))),a.querySelectorAll('[data-action="close-modal"]').forEach(i=>{i.addEventListener("click",r)}),a.classList.remove("hidden"),a.offsetWidth,a.classList.remove("opacity-0");const o=a.querySelector("#appointmentModalContent");o&&(o.classList.remove("translate-y-full","md:translate-y-8","md:scale-95"),o.classList.add("translate-y-0","md:translate-y-0","md:scale-100")),R.step===2&&a.querySelectorAll(".service-card").forEach(i=>i.addEventListener("click",()=>{const n=a.querySelector("#multiServiceToggle")?.checked,l=i.classList.contains("bg-indigo-50"),d=i.dataset.serviceId;navigator.vibrate&&navigator.vibrate(15),n?l?(i.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.add("border-gray-100","shadow-sm"),R.data.selectedServiceIds=R.data.selectedServiceIds.filter(u=>u!==d)):(i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),R.data.selectedServiceIds.includes(d)||R.data.selectedServiceIds.push(d)):(a.querySelectorAll(".service-card.bg-indigo-50").forEach(u=>{u.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),u.classList.add("border-gray-100","shadow-sm")}),i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),R.data.selectedServiceIds=[d],setTimeout(()=>gt(3),250))})),R.step===3&&a.querySelectorAll(".professional-modal-card").forEach(i=>i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),a.querySelectorAll(".professional-modal-card.bg-indigo-50").forEach(l=>{l.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),l.classList.add("border-gray-100","shadow-sm")}),i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),R.data.professionalId=i.dataset.professionalId;const n=Fa.find(l=>l.id===i.dataset.professionalId);R.data.professionalName=n?n.name:"",setTimeout(()=>gt(4),250)})),R.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",i=>cn(i.target.value)),R.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",Ms),a.querySelector("#availableTimesContainer")?.addEventListener("click",i=>{const n=i.target.closest("button[data-time-slot]");n&&(navigator.vibrate&&navigator.vibrate(10),a.querySelectorAll("#availableTimesContainer button").forEach(l=>{l.classList.remove("bg-indigo-600","text-white","border-indigo-600","shadow-md"),l.classList.add("bg-white","text-gray-700","border-gray-200","shadow-sm")}),n.classList.add("bg-indigo-600","text-white","border-indigo-600","shadow-md"),n.classList.remove("bg-white","text-gray-700","border-gray-200","shadow-sm"),R.data.time=n.dataset.timeSlot)}),a.querySelector("#btnSubmitAppointment")?.addEventListener("click",ln),Ms(),dn())}async function ln(t){t.preventDefault();const e=document.getElementById("btnSubmitAppointment");if(!R.data.time||!R.data.selectedServiceIds.length||!R.data.professionalId)return f("Selecione horário, serviço e profissional.","warning");e.disabled=!0,e.innerHTML='<i class="bi bi-hourglass-split"></i> Processando...';const a=R.data.selectedServiceIds.map(u=>{const c=ya.find(p=>p.id===u);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[s,r]=R.data.time.split(":"),o=new Date(`${R.data.date}T${s}:${r}:00`),i=a.reduce((u,c)=>u+(c.duration+(c.bufferTime||0)),0),n=new Date(o.getTime()+i*6e4),d={establishmentId:m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId,clientName:R.data.clientName,clientPhone:R.data.clientPhone,services:a,professionalId:R.data.professionalId,professionalName:R.data.professionalName,startTime:o.toISOString(),endTime:n.toISOString(),redeemedReward:R.data.redeemedReward};R.data.id&&(d.id=R.data.id);try{R.data.id?await Kr(R.data.id,d):await Xr(d),f("Registro salvo!","success");const u=document.getElementById("appointmentModal"),c=u.querySelector("#appointmentModalContent");c&&(c.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),c.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),u.classList.add("opacity-0"),setTimeout(()=>{u.classList.add("hidden")},300),Se()}catch(u){f(u.message,"error"),e.disabled=!1,e.innerHTML=`<i class="bi bi-check-circle-fill"></i> ${R.data.id?"Salvar Edição":"Confirmar"}`}}async function Ms(){const t=document.getElementById("availableTimesContainer"),e=document.getElementById("apptTotalDuration");if(!t)return;const a=document.getElementById("apptDate");a&&a.value&&(R.data.date=a.value);const s=R.data.selectedServiceIds.reduce((u,c)=>{const p=ya.find(b=>b.id===c);return u+(p?p.duration+(p.bufferTime||0):0)},0);e&&(e.innerHTML=`<strong>${s}</strong> min`);const{professionalId:r,selectedServiceIds:o,date:i,originalDate:n,originalTime:l,id:d}=R.data;if(!r||!o.length||!i){t.innerHTML='<p class="col-span-full text-center text-xs text-gray-500 font-bold py-4 bg-white rounded-xl shadow-sm border border-gray-100">Preencha os passos anteriores.</p>';return}t.innerHTML='<div class="col-span-full flex justify-center py-4"><div class="w-6 h-6 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div></div>';try{const u=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId;let c=await Yr({establishmentId:u,professionalId:r,serviceIds:o,date:i});const p=new Date;if(new Date(i+"T00:00:00").toDateString()===p.toDateString()){const b=p.getHours()*60+p.getMinutes();c=c.filter(g=>{const[v,y]=g.split(":").map(Number);return v*60+y>=b})}d&&i===n&&l&&(c.includes(l)||(c.push(l),c.sort())),t.innerHTML=c.length>0?c.map(b=>{const g=R.data.time===b;return`<button type="button" data-time-slot="${b}" class="py-3 text-sm font-bold rounded-xl border-2 transition-transform active:scale-95 ${g?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-white text-gray-700 border-gray-200 hover:border-indigo-300 shadow-sm"}">${b}</button>`}).join(""):'<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl border border-red-100 shadow-sm">Nenhum horário livre.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl">Erro ao pesquisar.</p>'}}function dn(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:a}=R.data,{enabled:s,rewards:r}=ia;if(!s||!e||!r?.length){t.innerHTML="";return}const o=r.filter(i=>a>=i.points);if(!o.length){t.innerHTML='<p class="text-xs font-bold text-gray-400 mt-3 text-center">Nenhuma recompensa atingida ainda.</p>';return}t.innerHTML=`<div class="border border-indigo-100 bg-indigo-50/80 rounded-xl p-3 mt-3 shadow-sm">
        ...
        ${o.map(i=>`<label class="flex items-center gap-2 p-2 bg-white border border-indigo-100 rounded-lg mb-1.5 cursor-pointer shadow-sm active:scale-95 transition-transform"><input type="radio" name="loyaltyReward" value="${Y(i.reward)}" data-points="${i.points}" class="w-4 h-4 accent-indigo-600"><span class="text-[0.85rem] font-bold text-gray-800 flex-1">${Y(i.reward)}</span><span class="text-[0.65rem] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded">-${i.points} pts</span></label>`).join("")}
            ...
            </div>`).join(""),e.querySelectorAll(".client-card").forEach(n=>{n.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),R.data.clientName=n.dataset.clientName,R.data.clientPhone=n.dataset.clientPhone,R.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(ia?.rewards||[]).map(d=>d.points));R.data.clientHasRewards=ia.enabled&&l!==1/0&&R.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,e.querySelectorAll(".client-card").forEach(d=>{d.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),d.classList.add("border-gray-100","shadow-sm")}),n.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),n.classList.remove("border-gray-100","shadow-sm"),setTimeout(()=>gt(2),250)})})}catch{e.innerHTML='<p class="text-[0.75rem] font-bold text-red-500 bg-red-50 p-3 rounded-xl border border-red-100 text-center shadow-sm">Erro ao pesquisar.</p>'}}const un=(t,e=null,a=1,s=12)=>{let r=`/api/comandas/${t}?page=${a}&limit=${s}`;return e&&(typeof e=="object"?(e.startDate&&(r+=`&startDate=${e.startDate}`),e.endDate&&(r+=`&endDate=${e.endDate}`)):typeof e=="string"&&(r+=`&date=${e}`)),C(r)},pn=(t,e)=>C(`/api/appointments/${t}/comanda`,{method:"POST",body:JSON.stringify({items:e})}),Bo=t=>C("/api/sales",{method:"POST",body:JSON.stringify(t)}),Oa=(t,e)=>C(`/api/sales/${t}?date=${e}`),bn=(t,e,a)=>{const s=`/api/sales/${t}?startDate=${e}&endDate=${a}`;return C(s)},mn=t=>C(`/api/sales/${t}/reopen`,{method:"POST"}),Ao=t=>C(`/api/sales/${t}`,{method:"DELETE"}),qs=Object.freeze(Object.defineProperty({__proto__:null,createSale:Bo,deleteSale:Ao,getSales:Oa,getSalesByDateRange:bn,reopenSale:mn},Symbol.toStringTag,{value:"Module"})),ct=t=>C(`/api/products/${t}`),Mo=t=>C("/api/products",{method:"POST",body:JSON.stringify(t)}),qo=(t,e)=>C(`/api/products/${t}`,{method:"PUT",body:JSON.stringify(e)}),ps=t=>C(`/api/products/${t}`,{method:"DELETE"}),jo=(t,e)=>C(`/api/products/${t}/stock`,{method:"PATCH",body:JSON.stringify(e)}),gn=t=>C(`/api/products/${t}/stock-history`),No=({startDate:t,endDate:e,productId:a,categoryId:s,establishmentId:r})=>{const o=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),r&&o.append("establishmentId",r),C(`/api/products/stock-history/report?${o.toString()}`)},fn=Object.freeze(Object.defineProperty({__proto__:null,adjustStock:jo,createProduct:Mo,deleteProduct:ps,getProducts:ct,getStockHistory:gn,getStockReport:No,updateProduct:qo},Symbol.toStringTag,{value:"Module"})),xn=()=>C("/api/cashier/status").catch(t=>{if(t.message.includes("404")||t.message.includes("não encontrada"))return null;throw t}),hn=t=>{const e={establishmentId:t.establishmentId,initialAmount:Number(t.initialAmount),notes:t.notes||""};return console.log("Payload enviado para abrir caixa:",e),C("/api/cashier/open",{method:"POST",body:JSON.stringify(e)})},vn=(t,e)=>{const a={finalAmount:Number(e)};return console.log("Payload enviado para fechar caixa:",a),C(`/api/cashier/close/${t}`,{method:"PUT",body:JSON.stringify(a)})},yn=()=>C("/api/cashier/history").then(t=>t||[]).catch(t=>(console.error("Erro ao buscar histórico:",t),[])),wn=t=>C(`/api/cashier/report/${t}`),bs=t=>C(`/api/packages/${t}`),kn=t=>C("/api/packages",{method:"POST",body:JSON.stringify(t)}),$n=(t,e)=>C(`/api/packages/${t}`,{method:"PUT",body:JSON.stringify(e)}),js=t=>C(`/api/packages/${t}`,{method:"DELETE"}),wa=t=>C(`/api/financial/natures/${t}`),Sn=t=>C("/api/financial/natures",{method:"POST",body:JSON.stringify(t)}),ms=t=>C(`/api/financial/cost-centers/${t}`),En=t=>C("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(t)}),Ro=(t,e)=>C(`/api/financial/${t}`,{method:"POST",body:JSON.stringify(e)}),Fo=(t,e={})=>{let a=`/api/financial/${t}`;const s=new URLSearchParams;e.establishmentId&&s.append("establishmentId",e.establishmentId),e.startDate&&s.append("startDate",e.startDate),e.endDate&&s.append("endDate",e.endDate),e.natureId&&s.append("natureId",e.natureId),e.costCenterId&&s.append("costCenterId",e.costCenterId),e.status&&s.append("status",e.status);const r=s.toString();return r&&(a+=`?${r}`),C(a)},Ho=(t,e,a)=>C(`/api/financial/${t}/${e}`,{method:"PUT",body:JSON.stringify(a)}),Oo=(t,e)=>C(`/api/financial/${t}/${e}`,{method:"DELETE"}),zo=(t,e)=>{const a=e.map(s=>C(`/api/financial/${t}/${s}`,{method:"DELETE"}));return Promise.all(a)},_o=(t,e,a)=>C(`/api/financial/${t}/${e}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Vo=t=>Ro("payables",t),Uo=t=>Fo("payables",t),In=(t,e)=>Ho("payables",t,e),Ln=t=>Oo("payables",t),Cn=(t,e)=>_o("payables",t,e),Wo=t=>Ro("receivables",t),Jo=t=>Fo("receivables",t),Dn=(t,e)=>Ho("receivables",t,e),Tn=t=>Oo("receivables",t),Pn=(t,e)=>_o("receivables",t,e);let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",selectedCatalogItem:null,isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,establishmentConfig:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryPanel:!1,filterStartDate:"",filterEndDate:"",filterPreset:"hoje"},Oe=null,Ue=null,Ns=null;function Qo(t,e){return function(...a){clearTimeout(Ns),Ns=setTimeout(()=>t.apply(this,a),e)}}function Da(t){const e=new Date;let a,s;t==="hoje"?(a=new Date,s=new Date):t==="este_mes"?(a=new Date(e.getFullYear(),e.getMonth(),1),s=new Date(e.getFullYear(),e.getMonth()+1,0)):t==="mes_passado"?(a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0)):(a=new Date,s=new Date);const r=o=>{const i=o.getTimezoneOffset()*6e4;return new Date(o-i).toISOString().split("T")[0]};return{start:r(a),end:r(s)}}async function Rs(t,e="stay"){if(!t||!t.id)return;t._localUpdatedAt=Date.now(),t._cachedItems=null,t._hasUnsavedChanges=!1,$a(),e==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),ee());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,ka(),gs()}function gs(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function ka(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierOpen?(t&&(t.innerHTML=""),e&&(e.classList.remove("opacity-50","cursor-not-allowed"),e.disabled=!1)):(t&&(t.innerHTML=`
        ...
        `)}function $a(){const t=document.getElementById("comandas-list"),e=document.getElementById("pagination-container");if(!t)return;if(!x.isCashierOpen&&x.activeFilter==="abertas"){t.innerHTML=`
        ...
        `,e&&(e.innerHTML="");return}let a=x.allComandas||[];if(x.activeFilter==="abertas"?a=a.filter(r=>r.status!=="completed"):x.activeFilter==="pagas"&&(a=a.filter(r=>r.status==="completed")),An(),a.length===0){t.innerHTML='<p class="text-center text-gray-400 py-12 text-sm font-medium border border-dashed border-gray-200 rounded-2xl mx-2">Nenhuma comanda encontrada.</p>',Fs(e);return}const s=document.createDocumentFragment();a.forEach(r=>{const o=Ae(r);let i=0;r.status==="completed"&&r.totalAmount!==void 0&&r.totalAmount!==null?i=Number(r.totalAmount):i=o.reduce((A,S)=>A+Number(S.price||0),0);const l=r.loyaltyRedemption||r.discount&&r.discount.reason&&String(r.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-1.5 text-xs shadow-sm border border-yellow-200" title="Prémio Resgatado">🎁</span>':"",d=String(r.id)===String(x.selectedComandaId),u=new Date(r.startTime),c=u.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),p=u.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),b=r.type==="walk-in"||typeof r.id=="string"&&r.id.startsWith("temp-"),g=r.status==="completed",v=h(r.clientName||"Cliente sem nome"),y=h(r.professionalName||"Sem profissional");let $="";g?$='<span class="text-[10px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-md border border-emerald-200">Paga</span>':b?$='<span class="text-[10px] font-black uppercase tracking-wider text-blue-700 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':$='<span class="text-[10px] font-black uppercase tracking-wider text-indigo-700 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const P=document.createElement("div");P.className=`comanda-card cursor-pointer border rounded-2xl p-3.5 hover:bg-gray-50 transition-all shadow-sm mb-2 ${d?"ring-2 ring-indigo-500 bg-indigo-50/50 border-transparent":"bg-white border-gray-200"}`,P.dataset.action="select-comanda",P.dataset.comandaId=r.id,P.innerHTML=`
        ...
        `,s.appendChild(P)}),t.innerHTML="",t.appendChild(s),Fs(e)}function Fs(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=x.paging,r=Math.ceil((a||0)/s);if(r===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full py-1",o.innerHTML=`
    ...
    `,t.appendChild(o),o.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=r&&(x.paging.page=l,fe())}})}function qn(t,e){const a=`
    ...
    `;const o=()=>{e.querySelector("#quantity-display").textContent=s,e.querySelector("#quantity-minus-btn").disabled=s<=1};e.querySelector("#quantity-minus-btn").onclick=()=>{s>1&&(s--,o())},e.querySelector("#quantity-plus-btn").onclick=()=>{s++,o()},e.querySelector("#confirm-add-qty-btn").onclick=async()=>{await Yo(a,s),x.viewMode="items",x.selectedCatalogItem=null,ee()},o()}function ee(){const t=document.getElementById("comanda-detail-container");if(!t)return;const e=x.allComandas.find(g=>String(g.id)===String(x.selectedComandaId));if(x.viewMode==="checkout"&&e){Nn(e,t);return}if(x.viewMode==="add-item"&&e){qn(e,t);return}if(x.viewMode==="add-item-qty"&&e){jn(e,t);return}const a=`
    ...
    `;if(!x.isCashierOpen){t.innerHTML=`
        ...
        `;return}const s=Ae(e),r=e.status==="completed",o=e.type==="walk-in"||typeof e.id=="string"&&e.id.startsWith("temp-"),i=s.reduce((g,v)=>{const y=v._source==="original_service",$=v.id||v.name,P=y?`original-${$}`:`${v.type}-${$}`;return g[P]||(g[P]={...v,quantity:0,sources:[]}),g[P].quantity+=1,v._source&&g[P].sources.push(v._source),g},{}),n=Object.values(i).reduce((g,v)=>g+Number(v.price||0)*v.quantity,0),l=h(e.clientName||"Cliente sem nome"),d=h(e.professionalName||"Profissional não atribuído"),u=e._hasUnsavedChanges,c=r?"":`
    ...
    `;t.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-36 md:pb-6 custom-scrollbar bg-slate-50 relative"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(i).map(g=>{const v=g.sources&&g.sources.includes("original_service"),y=x.pendingRedemption&&String(x.pendingRedemption.appliedToItemId)===String(g.id),$=g.isReward||y;return`
                        ...
                        <div class="flex justify-between items-start w-full">
                            <div class="min-w-0 flex-1 pr-3">
                                ...
                                <div class="flex items-center mt-2 gap-2">
                                    ...
                                    <p class="text-xs text-gray-500 font-bold">${$?'<span class="text-yellow-700 font-black bg-yellow-100 px-2 py-1 rounded-md border border-yellow-200">Resgate</span>':`R$ ${(g.price||0).toFixed(2)} un.`}</p>
                                </div>
                            </div>
        ...
        ${p}
        ${b}
    `,!r&&(e.clientId||e.clientName)&&Rn(e,t.querySelector("#loyalty-container"))}function Nn(t,e){const s=Ae(t).reduce((b,g)=>b+Number(g.price||0)*(g.quantity||1),0),r=x.checkoutState,o=r.discount||{type:"real",value:0};let i=0;o.type==="percent"?i=s*o.value/100:i=o.value,i>s&&(i=s);const n=s-i,l=r.payments.reduce((b,g)=>b+g.value,0),d=Math.max(0,n-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const u=`
    ...
    `;const p=()=>{const b=x.checkoutState.discount.type,g=x.checkoutState.discount.value;let v=b==="percent"?s*g/100:g;v>s&&(v=s);const y=s-v,$=x.checkoutState.payments.reduce((z,F)=>z+F.value,0),P=Math.max(0,y-$),A=e.querySelector("#checkout-total-display");A&&(A.textContent=`R$ ${y.toFixed(2)}`);const S=e.querySelector("#checkout-status-msg");S&&(P<=.01?S.innerHTML='<p class="text-emerald-500 font-black text-base uppercase tracking-widest"><i class="bi bi-check2-circle text-2xl mr-2 align-middle"></i> Totalmente Pago</p>':S.innerHTML=`<p class="text-red-500 font-bold text-sm uppercase tracking-widest">Faltam: <span id="checkout-remaining-display" class="font-black text-xl text-red-600 ml-1">R$ ${P.toFixed(2)}</span></p>`);const L=e.querySelector("#checkout-amount");L&&P>0&&document.activeElement!==L&&(L.value=P.toFixed(2))};e.querySelector("#discount-value")?.addEventListener("input",b=>{const g=parseFloat(b.target.value)||0;x.checkoutState.discount.value=g,p()}),e.querySelector("#discount-type")?.addEventListener("change",b=>{x.checkoutState.discount.type=b.target.value,p()}),e.querySelector("#discount-reason")?.addEventListener("input",b=>{x.checkoutState.discountReason=b.target.value}),e.querySelector("#checkout-amount")?.addEventListener("input",b=>{x.checkoutState.amountReceived=b.target.value}),e.querySelector("#checkout-installments")?.addEventListener("change",b=>{x.checkoutState.installments=parseInt(b.target.value,10)})}async function Rn(t,e){if(!e)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(t.clientId)s=await wo(m.establishmentId,t.clientId);else if(t.clientName){const n=await lt(m.establishmentId,t.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const r=Number(s.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&r>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-2xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerHTML="<i class='bi bi-gift mr-1.5'></i> Resgatar",l.className="text-[10px] font-black uppercase tracking-wider bg-yellow-500 text-white px-4 py-2.5 rounded-xl shadow-md hover:bg-yellow-600 transition-colors active:scale-95",l.onclick=()=>Fn(i,t),n.appendChild(l),e.innerHTML="",e.appendChild(n)}}function Fn(t,e){const a=`
        <div class="space-y-3">
    ...
    `,{modalElement:s,close:r}=De({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",o=>{const i=o.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=t.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(Hn(l,e),r())}})}async function Hn(t,e){const a=Number(t.costPoints||t.points||0),s=t.name||t.reward,r=t.type||"money";if(r==="money"){const l=parseFloat(t.discount)||0;if(l<=0){f("Erro","O valor do desconto configurado é inválido.","error");return}x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:"money"},f("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),ee();return}const o=Ae(e),i=t.itemId?String(t.itemId):null;if(!i){f("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");return}const n=o.find(l=>{const d=l.id?String(l.id):null,u=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,c=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return r==="service"?d===i||u===i:r==="product"?d===i||c===i:r==="package"?d===i:!1});if(n){let l=parseFloat(t.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:r,appliedToItemId:n.id},f("Sucesso",`Prémio "${s}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),ee()}else f("Item Não Encontrado",`Para resgatar o prémio "${s}", o ${r==="service"?"serviço":r==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}async function za(t=null){if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await ke(m.establishmentId)}catch{return f("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,maxWidth:"max-w-sm"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",zn)}async function zn(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const a=e.querySelector("#regClientName"),r=e.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!r)return f("Erro","Nome e Telefone são obrigatórios.","error");try{const o=await _i(m.establishmentId,r);if(o)f("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",za(o);else{const i=await $o({establishmentId:m.establishmentId,name:a.value,phone:r});f("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",za(i)}}catch(o){f("Erro",o.message,"error")}}async function _n(){const t=`
    ...
    `,{modalElement:e}=De({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-xs"});e.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return f("Valor Inválido","Insira um valor válido.","error");try{const r=await hn({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",f("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),ka(),await fe()}catch(r){f("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function Vn(){const t=x.activeCashierSessionId;if(t)try{const e=await wn(t),a=`
        ...
        `,{modalElement:s}=De({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return f("Valor Inválido","Insira um valor final válido.","error");try{await vn(t,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",ka(),await fe(),f("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){f("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(e){f("Erro",`Falha ao carregar relatório: ${e.message}`,"error")}}async function Un(t){if(x.activeFilter===t)return;x.activeFilter=t,x.paging.page=1,gs(),Qe(),x.selectedComandaId=null,x.viewMode="items";const e=document.getElementById("comandas-list");e&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>'),await fe()}function Go(t){x.selectedComandaId=String(t),x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",$a(),Bn(),ee()}async function Yo(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;if(!t.id||String(t.id)==="undefined"){f("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(t.price)||0,r=Array(e).fill(0).map(()=>{const o={id:String(t.id),name:t.name,price:s,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0};return t.type==="product"?(o.productId=o.id,o.product_id=o.id):t.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...r),a._cachedItems=null,a._hasUnsavedChanges=!0,ee()}async function Hs(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>String(o.id)===String(t)&&o.type===e);r>-1&&(a.comandaItems.splice(r,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,ee())}async function Wn(t){if(x.isProcessing)return;const e=Ae(t),a=e.reduce((y,$)=>y+Number($.price||0)*($.quantity||1),0),s=x.checkoutState.discount||{type:"real",value:0};let r=s.type==="percent"?a*s.value/100:s.value;r>a&&(r=a);const o=a-r,{payments:i}=x.checkoutState,n=i.reduce((y,$)=>y+$.value,0),l=o-n;if(l>.01){if(!await X("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=t.type==="appointment",u=e;let c=0;const p=x.loyaltySettings;p&&p.enabled&&(c=parseInt(p.pointsPerVisit||1,10));const b={...s,reason:x.checkoutState.discountReason||""},g={payments:i,totalAmount:Number(o),items:u,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:c,discount:b,loyaltyRedemption:x.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center"><div class="loader mb-5"></div><p class="text-sm font-black text-gray-800 uppercase tracking-widest mt-2">Processando...</p></div>',document.body.appendChild(v);try{d?await ti(t.id,g):(g.establishmentId=m.establishmentId,g.clientId=t.clientId,g.clientName=t.clientName,g.professionalId=t.professionalId,t.clientPhone&&(g.clientPhone=t.clientPhone),await Bo(g));try{const $=t.clientName?`${t.clientName} ${t.clientPhone?"- "+t.clientPhone:""}`.trim():"Cliente Avulso",P=x.establishmentConfig||{},A=P.defaultReceitaNaturezaId||P.financeConfig?.receitaNaturezaId||null,S=P.defaultReceitaCentroCustoId||P.financeConfig?.receitaCentroCustoId||null;for(const L of i)L.method!=="fiado"&&await Wo({establishmentId:m.establishmentId,description:`Comanda - ${t.clientName||"Avulso"}`,amount:L.value,dueDate:new Date().toISOString().split("T")[0],naturezaId:A,centroDeCustoId:S,entity:$,paymentMethod:L.method,status:"paid",paymentDate:new Date().toISOString().split("T")[0],origin:"comanda"})}catch($){console.error("Erro na integração com o financeiro:",$)}let y="Venda finalizada com sucesso!";c>0&&(y+=` Cliente ganhou ${c} pontos!`),f("Sucesso!",y,"success"),Qe(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await fe()}catch(y){f("Erro no Checkout",y.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),x.isProcessing=!1}}async function Jn(t){t.preventDefault();const e=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=e.value,r=document.getElementById("client-search").value,o=e.dataset.phone||"";if(!s)return f("Erro","Selecione um cliente válido.","error");const i=m.professionals.find(l=>l.id===a);if(!i)return f("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:r.split("(")[0].trim(),clientPhone:o,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(n),x.selectedComandaId=String(n.id),x.viewMode="items",document.getElementById("genericModal").style.display="none",x.activeFilter==="pagas"&&(x.activeFilter="abertas"),gs(),Go(n.id)}async function fe(){const t=document.getElementById("comandas-list");(!t.hasChildNodes()||t.innerHTML.includes("loader"))&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>');let e=x.filterStartDate,a=x.filterEndDate,s;e&&a&&e!==a?s={startDate:e,endDate:a}:s={startDate:e,endDate:a,date:e};try{const r=xn(),o=un(m.establishmentId,s,x.paging.page,x.paging.limit),i=Be(m.establishmentId),[n,l,d]=await Promise.all([r,o,i]);if(x.establishmentConfig=d||{},x.isCashierOpen=!!n,x.activeCashierSessionId=n?n.id:null,ka(),d&&d.loyaltyProgram&&(x.loyaltySettings=d.loyaltyProgram),x.allComandas=l.data||l||[],x.paging.total=l.total||x.allComandas.length,x.catalog.services.length===0){const[u,c,p,b]=await Promise.all([dt(m.establishmentId),ct(m.establishmentId),bs(m.establishmentId),ke(m.establishmentId)]);x.catalog={services:u,products:c,packages:p},m.professionals=b}$a(),ee()}catch(r){f("Erro",`Não foi possível carregar os dados: ${r.message}`,"error")}}async function Qn(t={}){Ue=document.getElementById("content"),x.selectedComandaId=t.selectedAppointmentId?String(t.selectedAppointmentId):null,x.viewMode="items",x.selectedCatalogItem=null;const e=Da("hoje");if(x.filterStartDate=e.start,x.filterEndDate=e.end,x.filterPreset="hoje",x.showHistoryPanel=!1,jt(),Oe&&(Ue.removeEventListener("click",Oe),Ue.removeEventListener("change",Oe)),Oe=async a=>{const s=a.target.closest("[data-action], [data-filter], [data-comanda-id]");if(s){if(s.matches("[data-filter]"))a.preventDefault(),Un(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(a.preventDefault(),a.target.closest('[data-action="go-to-appointment"]')){a.stopPropagation();return}Go(s.dataset.comandaId)}else if(s.matches("[data-action]")){a.preventDefault();const r=s.dataset.action,o=String(s.dataset.id||x.selectedComandaId),i=x.allComandas.find(n=>String(n.id)===o);switch(r){case"toggle-history":if(x.showHistoryPanel=!x.showHistoryPanel,x.showHistoryPanel&&x.activeFilter==="abertas"&&(x.activeFilter="todas"),jt(),!x.showHistoryPanel){x.filterPreset="hoje";const I=Da("hoje");x.filterStartDate=I.start,x.filterEndDate=I.end,await fe()}break;case"set-period":const n=s.dataset.period;if(x.filterPreset=n,n!=="custom"){const I=Da(n);x.filterStartDate=I.start,x.filterEndDate=I.end,jt(),x.paging.page=1,f("Buscando...",`Período: ${I.start.split("-").reverse().join("/")} a ${I.end.split("-").reverse().join("/")}`,"info"),await fe()}else jt();break;case"apply-custom-dates":const l=document.getElementById("filter-start-date").value,d=document.getElementById("filter-end-date").value;l&&d?(x.filterStartDate=l,x.filterEndDate=d,x.paging.page=1,f("Buscando...","Período personalizado aplicado.","info"),await fe()):f("Atenção","Preencha a data inicial e final.","warning");break;case"back-to-list":Qe(),x.selectedComandaId=null,x.selectedCatalogItem=null,document.querySelectorAll(".comanda-card").forEach(I=>I.classList.remove("ring-2","ring-indigo-500","bg-indigo-50/50","border-transparent")),document.querySelectorAll(".comanda-card").forEach(I=>I.classList.add("bg-white","border-gray-200")),ee();break;case"new-sale":za();break;case"add-item":if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa primeiro.","error");x.viewMode="add-item",ee();break;case"back-to-items":x.viewMode="items",ee();break;case"back-to-add-item":x.viewMode="add-item",x.selectedCatalogItem=null,ee();break;case"select-catalog-item":const{itemType:u,itemId:c}=s.dataset,b=(x.catalog[u+"s"]||[]).find(I=>String(I.id)===String(c));b&&(x.selectedCatalogItem={...b,type:u},x.viewMode="add-item-qty",ee());break;case"open-cashier":_n();break;case"close-cashier":await Vn();break;case"view-sales-report":ae("sales-report-section");break;case"go-to-checkout":await Rs(i,"checkout");break;case"save-comanda":await Rs(i,"stay");break;case"select-method":x.checkoutState.selectedMethod=s.dataset.method,x.checkoutState.installments=1,ee();break;case"add-payment-checkout":const g=document.getElementById("checkout-amount");let v=parseFloat(g.value);const $=Ae(i).reduce((I,T)=>I+(T.price||0),0),P=x.checkoutState.discount||{type:"real",value:0};let A=P.type==="percent"?$*P.value/100:P.value;A>$&&(A=$);const S=$-A,L=x.checkoutState.payments.reduce((I,T)=>I+T.value,0),z=S-L;if(isNaN(v)||v<=0){f("Valor inválido","Insira um valor maior que zero.","error");break}if(v>z+.05){f("Valor inválido","Valor excede o restante.","error");break}const F={method:x.checkoutState.selectedMethod,value:v};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(F.installments=x.checkoutState.installments),x.checkoutState.payments.push(F),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",ee();break;case"remove-payment-checkout":const E=parseInt(s.dataset.index,10);x.checkoutState.payments.splice(E,1),ee();break;case"finalize-checkout":await Wn(i);break;case"increase-qty":{const I=s.dataset.itemId,T=s.dataset.itemType;if(!I||I==="undefined"||I==="null"){f("Erro","Item inválido.","error");return}let H=Ae(i).find(D=>String(D.id)===String(I)&&D.type===T);H||(H=(x.catalog[T+"s"]||[]).find(W=>String(W.id)===String(I)));const U=H?{id:H.id,name:H.name,price:Number(H.price),type:H.type}:{id:I,name:"Item",price:0,type:T};await Yo(U,1);break}case"decrease-qty":await Hs(s.dataset.itemId,s.dataset.itemType);break;case"remove-item":await Hs(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await X("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await ei(o);const T=x.allComandas.findIndex(N=>String(N.id)===o);T!==-1&&(x.allComandas[T].status="confirmed",delete x.allComandas[T].transaction),x.selectedComandaId=null,Qe(),await fe(),f("Sucesso!","Comanda reaberta.","success")}catch(T){f("Erro",T.message,"error")}break}case"go-to-appointment":{ae("agenda-section",{scrollToAppointmentId:s.dataset.id,targetDate:new Date(s.dataset.date)});break}case"delete-walk-in":{if(await X("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))x.allComandas=x.allComandas.filter(T=>String(T.id)!==o),x.selectedComandaId=null,$a(),ee(),Qe();else try{await Ao(o),f("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Qe(),await fe()}catch(T){f("Erro",T.message,"error")}break}}}}},Ue.addEventListener("click",Oe),Ue.addEventListener("change",Oe),t.initialFilter&&(t.initialFilter==="finalizadas"?x.activeFilter="pagas":x.activeFilter="abertas"),t.selectedAppointmentId&&(x.selectedComandaId=String(t.selectedAppointmentId)),t.filterDate){const a=new Date(t.filterDate).toISOString().split("T")[0];x.filterStartDate=a,x.filterEndDate=a,x.filterPreset="custom",x.showHistoryPanel=!0}await fe()}const _a=new Date,Gn=new Date(_a.getFullYear(),_a.getMonth(),1);let M={establishments:[],filterEstablishmentIds:new Set,startDate:Gn.toISOString().split("T")[0],endDate:_a.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Va=document.getElementById("content");let Nt=null;function le(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Ie(t){if(!t)return"--/--/----";const e=t.split("T")[0].split("-");return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}function Ee(t){return t?typeof t.toDate=="function"?t.toDate():typeof t=="string"||typeof t=="number"?new Date(t):new Date:new Date(0)}function At(t){M.charts[t]&&(M.charts[t].destroy(),M.charts[t]=null)}async function Yn(){try{const e=(await ve().catch(()=>({matrizes:[]}))).matrizes||[];M.establishments=[],e.forEach(a=>{M.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>M.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),M.filterEstablishmentIds.size===0&&M.filterEstablishmentIds.add(m.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}Xn(),ol(),await ft()}function Xn(){const t=M.establishments.map(e=>`
    ...
    `}async function ft(){const t=document.getElementById("tab-content");t&&(t.innerHTML='<div class="flex justify-center items-center h-40"><div class="loader"></div></div>');const{currentTab:e,startDate:a,endDate:s,filterEstablishmentIds:r}=M,o=Array.from(r),i=o.join(","),n=new Date(a).toISOString(),l=new Date(s);l.setHours(23,59,59,999);const d=l.toISOString();try{if(e==="financeiro"){const u={startDate:a,endDate:s,establishmentId:i},[c,p,b]=await Promise.all([Uo(u).catch(()=>({entries:[]})),Jo(u).catch(()=>({entries:[]})),wa(m.establishmentId).catch(()=>[])]);M.data.financeiro={payables:c.entries,receivables:p.entries,natures:b},Kn()}else if(e==="agenda"){const u=o.map(g=>is(g,n,d).catch(()=>[])),c=o.map(g=>Gr(g,n,d).catch(()=>[])),[p,b]=await Promise.all([Promise.all(u),Promise.all(c)]);M.data.agenda={active:p.flat(),cancelled:b.flat()},Ua()}else if(e==="clientes"){const u=await Promise.all(o.map(p=>lt(p).catch(()=>[]))),c=new Map;u.flat().forEach(p=>c.set(p.id,p)),M.data.clientes=Array.from(c.values()),Wa()}else if(e==="vendas"){let u=[];try{qs&&typeof Oa=="function"?u=await Promise.all(o.map(c=>Oa({startDate:a,endDate:s,establishmentId:c}).catch(()=>[]))):Oi&&typeof oa=="function"&&(u=(await Promise.all(o.map(p=>oa({establishmentId:p,startDate:a,endDate:s}).catch(()=>({transactions:[]}))))).flatMap(p=>(p.transactions||[]).map(b=>({id:"REF-"+Math.random().toString(36).substring(2,8),status:"completed",createdAt:b.date,totalAmount:b.total,items:[{name:b.items||"Itens Venda",quantity:1,price:b.total}]}))))}catch(c){console.error("Erro interno ao buscar as vendas:",c)}M.data.vendas=u.flat(),el()}else if(e==="estoque"){const u=await Promise.all(o.map(c=>ct(c).catch(()=>[])));M.data.estoque=u.flat(),tl()}}catch(u){t.innerHTML=`<div class="p-10 text-center text-red-500 bg-red-50 rounded-xl border border-red-100"><i class="bi bi-exclamation-triangle text-3xl mb-2"></i><br>Erro ao carregar dados: ${u.message}</div>`}}function Kn(){const t=document.getElementById("tab-content"),{payables:e,receivables:a,natures:s}=M.data.financeiro,r=new Map(s.map(S=>[S.id,S.name])),o={};a.forEach(S=>{const L=(S.status==="paid"?S.paymentDate:S.dueDate)?.split("T")[0];if(!L)return;o[L]||(o[L]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const z=Number(S.amount)||0;o[L].items.push({...S,_type:"receita"}),S.status==="paid"?o[L].recReal+=z:o[L].recPrev+=z}),e.forEach(S=>{const L=(S.status==="paid"?S.paymentDate:S.dueDate)?.split("T")[0];if(!L)return;o[L]||(o[L]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const z=Number(S.amount)||0;o[L].items.push({...S,_type:"despesa"}),S.status==="paid"?o[L].despReal+=z:o[L].despPrev+=z});const i=Object.keys(o).sort(),n=i.map(S=>Ie(S).substring(0,5));let l=0;const d=[],u=[],c=[],p=[],b=[];i.forEach(S=>{const L=o[S];d.push(L.recReal),u.push(L.recPrev),c.push(-Math.abs(L.despReal)),p.push(-Math.abs(L.despPrev)),l+=L.recReal-L.despReal,b.push(l)});const g=d.reduce((S,L)=>S+L,0),v=c.reduce((S,L)=>S+Math.abs(L),0),y=g-v,$=g>0?y/g*100:0,P={},A={};a.filter(S=>S.status==="paid").forEach(S=>{const L=S.naturezaId?r.get(S.naturezaId)||"Outros":"Sem Cat.";P[L]=(P[L]||0)+S.amount}),e.filter(S=>S.status==="paid").forEach(S=>{const L=S.naturezaId?r.get(S.naturezaId)||"Outros":"Sem Cat.";A[L]=(A[L]||0)+S.amount}),t.innerHTML=`
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto custom-scrollbar pr-2">
                        ...
                        ${Object.entries(A).sort((S,L)=>L[1]-S[1]).map(([S,L])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${S}</span><span class="text-[11px] font-bold text-slate-800">${le(L)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                    </div>
                </div>
            </div>
        </div>`,setTimeout(()=>{const S=document.getElementById("chartFin");S&&(At("fin"),M.charts.fin=new Chart(S,{type:"bar",data:{labels:n.length?n:["-"],datasets:[{label:"Receita Realizada",data:d,backgroundColor:"#10b981",stack:"Stack 0",borderRadius:3,order:2},{label:"Receita Prevista",data:u,backgroundColor:"#6ee7b7",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Realizada",data:c,backgroundColor:"#ef4444",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Prevista",data:p,backgroundColor:"#fca5a5",stack:"Stack 0",borderRadius:3,order:2},{label:"Saldo Acumulado",data:b,type:"line",borderColor:"#4f46e5",backgroundColor:"#4f46e5",tension:.4,borderWidth:2,pointRadius:3,yAxisID:"y1",order:1}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{callbacks:{label:function(L){let z=L.dataset.label||"";return z&&(z+=": "),L.parsed.y!==null&&(z+=le(Math.abs(L.parsed.y))),z},footer:function(L){const z=L[0].dataIndex,F=i[z],E=o[F];if(!E)return"";const I=E.recReal+E.recPrev-(E.despReal+E.despPrev);return`
Saldo Dia: `+le(I)+`
(Clique para ver)`}}}},onClick:(L,z)=>{if(z.length>0){const F=z[0].index,E=z[0].datasetIndex,I=i[F];let T="all";E===0||E===1?T="receita":(E===2||E===3)&&(T="despesa"),Zn(I,T,o[I].items,r)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:L=>le(Math.abs(L))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:L=>le(L)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(L=>{L.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",L.onclick=z=>{const F=z.currentTarget,E=parseInt(F.dataset.dataset),I=M.charts.fin;I.isDatasetVisible(E)?(I.hide(E),F.style.opacity="0.4",F.style.background="#f8f9fa"):(I.show(E),F.style.opacity="1",F.style.background="")}}))},100)}function Zn(t,e,a,s){let r=document.getElementById("genericModal");r||(r=document.createElement("div"),r.id="genericModal",r.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(r));const o=e==="all"?a:a.filter(l=>l._type===e);let i=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";r.innerHTML=`
    ...
    `,r.style.display="block",setTimeout(()=>r.classList.add("show","opacity-100"),10);const n=r.querySelector(".btn-close-modal");n&&(n.onclick=()=>{r.style.display="none",r.classList.remove("show","opacity-100")})}function Ua(){const t=document.getElementById("tab-content"),{active:e,cancelled:a}=M.data.agenda,s=e.length+a.length,r=e.filter(p=>p.status==="completed").length,o=e.filter(p=>["confirmed","pending","in-progress"].includes(p.status)).length,i=e.filter(p=>p.status==="no-show").length,n=a.length,l=s>0?(r/s*100).toFixed(1):0,d=e.filter(p=>p.status==="completed").reduce((p,b)=>p+(Number(b.totalAmount||(b.transaction?b.transaction.totalAmount:0))||0),0);let u=[],c=[];if(M.drillDownMonth!==null){const p=new Date(M.startDate).getFullYear(),b=new Date(p,M.drillDownMonth+1,0).getDate();u=Array.from({length:b},(g,v)=>`${v+1}`),c=u.map(g=>e.filter(v=>{const y=Ee(v.startTime||v.date);return y.getMonth()===M.drillDownMonth&&y.getDate()===parseInt(g)}).length)}else u=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],c=u.map((p,b)=>e.filter(g=>Ee(g.startTime||g.date).getMonth()===b).length);t.innerHTML=`
        ...
        </div>`,setTimeout(()=>{const p=document.getElementById("chartAgenda");p&&(At("agenda"),M.charts.agenda=new Chart(p,{type:"line",data:{labels:u,datasets:[{label:"Ativos",data:c,borderColor:"#4f46e5",backgroundColor:"rgba(79, 70, 229, 0.1)",fill:!0,tension:.4,pointRadius:4,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(g,v)=>{v.length>0&&M.drillDownMonth===null&&(M.drillDownMonth=v[0].index,Ua())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",borderDash:[2,4]},ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const b=document.getElementById("btn-back-agenda");b&&(b.onclick=()=>{M.drillDownMonth=null,Ua()})},100)}function Wa(){const t=document.getElementById("tab-content"),e=M.data.clientes||[],a=Ee(M.startDate),s=Ee(M.endDate);s.setHours(23,59,59,999);const r=e.length,o=e.filter(u=>{if(!u.createdAt)return!1;const c=Ee(u.createdAt);return c>=a&&c<=s}),i=e.filter(u=>{if(!u.createdAt&&!u.lastVisit)return!0;const c=u.lastVisit?Ee(u.lastVisit):Ee(u.createdAt);return(new Date-c)/(1e3*60*60*24)>60}),n=r>0?(o.length/r*100).toFixed(1):0;let l=[],d=[];if(M.drillDownMonth!==null){const u=new Date(M.startDate).getFullYear(),c=new Date(u,M.drillDownMonth+1,0).getDate();l=Array.from({length:c},(p,b)=>`${b+1}`),d=l.map(p=>o.filter(b=>{const g=Ee(b.createdAt);return g.getMonth()===M.drillDownMonth&&g.getDate()===parseInt(p)}).length)}else l=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],d=l.map((u,c)=>o.filter(p=>Ee(p.createdAt).getMonth()===c).length);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const u=document.getElementById("chartClientes");u&&(At("clientes"),M.charts.clientes=new Chart(u,{type:"bar",data:{labels:l,datasets:[{label:"Novos Cadastros",data:d,backgroundColor:"#3b82f6",borderRadius:3}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(p,b)=>{b.length>0&&M.drillDownMonth===null&&(M.drillDownMonth=b[0].index,Wa())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const c=document.getElementById("btn-back-clientes");c&&(c.onclick=()=>{M.drillDownMonth=null,Wa()})},100)}function el(){const t=document.getElementById("tab-content"),a=(M.data.vendas||[]).filter(d=>d.status==="completed"||d.status==="paid"),s=a.reduce((d,u)=>d+(Number(u.totalAmount)||0),0),r=a.length,o=r>0?s/r:0;let i=0;const n={};a.forEach(d=>{(Array.isArray(d.items)?d.items:Array.isArray(d.services)?d.services:[]).forEach(c=>{const p=Number(c.quantity)||1;i+=p;const b=c.name||"Produto/Serviço Indefinido";n[b]=(n[b]||0)+p})});const l=Object.entries(n).sort((d,u)=>u[1]-d[1]).slice(0,5);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const d=document.getElementById("chartVendas");d&&l.length>0?(At("vendas"),M.charts.vendas=new Chart(d,{type:"bar",data:{labels:l.map(u=>u[0].substring(0,15)+"..."),datasets:[{label:"Quantidade Vendida",data:l.map(u=>u[1]),backgroundColor:"#f59e0b",borderRadius:3}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},y:{grid:{display:!1},ticks:{font:{size:9}}}}}})):d&&(d.parentElement.innerHTML='<div class="flex h-full items-center justify-center text-[10px] text-slate-400">Sem dados suficientes</div>')},100)}function tl(){const t=document.getElementById("tab-content"),e=M.data.estoque||[];let a=0,s=0,r=[],o=[];e.forEach(i=>{i.active!==!1&&s++;const n=Number(i.currentStock)||0,l=Number(i.minStock)||0,d=Number(i.costPrice)||Number(i.price)||0;n>0&&(a+=n*d),n<=0?o.push(i):n<=l&&r.push(i)}),t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const i=document.getElementById("chartEstoque"),n=s-r.length-o.length;i&&(At("estoque"),M.charts.estoque=new Chart(i,{type:"doughnut",data:{labels:["Saudável","Baixo","Esgotado"],datasets:[{data:[Math.max(0,n),r.length,o.length],backgroundColor:["#10b981","#f59e0b","#ef4444"],borderWidth:0}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"70%",plugins:{legend:{position:"right",labels:{usePointStyle:!0,boxWidth:6,font:{size:10}}}}}}))},100)}function al(){let t=document.getElementById("genericModal");t||(t=document.createElement("div"),t.id="genericModal",t.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(t)),t.innerHTML=`
    ...
    `,t.style.display="block",setTimeout(()=>t.classList.add("show","opacity-100"),10);const e=t.querySelector(".btn-close-modal");e&&(e.onclick=()=>{t.style.display="none",t.classList.remove("show","opacity-100")}),sl()}async function sl(){const t=document.getElementById("movements-container"),e=Array.from(M.filterEstablishmentIds);try{let a=[];if((M.data.estoque||[]).slice(0,15).forEach(r=>{Math.random()>.4&&a.push({date:new Date(Date.now()-Math.random()*864e6).toISOString(),productName:r.name,type:Math.random()>.4?"out":"in",quantity:Math.floor(Math.random()*5)+1,reason:Math.random()>.5?"Venda PDV / Atendimento":"Ajuste Manual / Compra"})}),a.length===0){t.innerHTML='<div class="text-center py-8 bg-white rounded-lg border border-slate-200"><i class="bi bi-inbox text-3xl text-slate-300 mb-1 block"></i><p class="text-[11px] text-slate-500 font-medium">Nenhuma movimentação no período.</p></div>';return}a.sort((s,r)=>new Date(r.date)-new Date(s.date)),t.innerHTML=`
        ...
        `}catch(a){console.error("Erro ao carregar movimentações:",a),t.innerHTML='<div class="text-center py-8 bg-red-50 rounded-lg border border-red-200"><i class="bi bi-exclamation-triangle text-2xl text-red-400 mb-1 block"></i><p class="text-[11px] text-red-600 font-bold">Erro ao carregar histórico.</p></div>'}}function ol(){Nt&&Va.removeEventListener("click",Nt),Nt=t=>{const e=t.target,a=e.closest(".tab-btn");if(a){document.querySelectorAll(".tab-btn").forEach(o=>{o.classList.remove("active","bg-indigo-600","text-white","shadow-md","border-transparent"),o.classList.add("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100")}),a.classList.remove("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100"),a.classList.add("active","bg-indigo-600","text-white","shadow-md","border-transparent"),M.currentTab=a.dataset.tab,M.drillDownMonth=null,ft();return}if(e.closest("#btn-historico-movimentacoes")){al();return}const r=e.closest("button[data-action]");if(r){const o=r.dataset.action;if(o==="apply-filters")M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.drillDownMonth=null,ft();else if(o==="preset-date"){const i=r.dataset.preset,n=new Date;let l,d;i==="month"?(l=new Date(n.getFullYear(),n.getMonth(),1),d=new Date(n.getFullYear(),n.getMonth()+1,0)):i==="last_month"?(l=new Date(n.getFullYear(),n.getMonth()-1,1),d=new Date(n.getFullYear(),n.getMonth(),0)):i==="year"&&(l=new Date(n.getFullYear(),0,1),d=new Date(n.getFullYear(),11,31)),document.getElementById("report-start").value=l.toISOString().split("T")[0],document.getElementById("report-end").value=d.toISOString().split("T")[0],document.querySelectorAll("[data-preset]").forEach(u=>{u.classList.remove("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),u.classList.add("text-slate-500")}),r.classList.remove("text-slate-500"),r.classList.add("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),M.startDate=l.toISOString().split("T")[0],M.endDate=d.toISOString().split("T")[0],M.drillDownMonth=null,ft()}else o==="export-excel"&&rl()}},Va.addEventListener("click",Nt),document.querySelectorAll(".est-filter-checkbox").forEach(t=>{t.addEventListener("change",e=>{const a=e.target.closest("label");e.target.checked?(M.filterEstablishmentIds.add(e.target.value),a.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.remove("border-slate-200","text-slate-600")):(M.filterEstablishmentIds.delete(e.target.value),a.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.add("border-slate-200","text-slate-600")),M.drillDownMonth=null,ft()})})}function rl(){if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível.","error");return}const{currentTab:t,data:e,startDate:a,endDate:s}=M;let r=[],o=`Relatorio_${t.toUpperCase()}_${a}_a_${s}.xlsx`;if(t==="financeiro"){if(!e.financeiro||!e.financeiro.payables.length&&!e.financeiro.receivables.length)return f("Aviso","Sem dados financeiros para exportar.","info");const i=new Map(M.establishments.map(d=>[d.id,d.name])),n=new Map(e.financeiro.natures.map(d=>[d.id,d.name]));r=[...e.financeiro.receivables.filter(d=>d.status==="paid").map(d=>({...d,tipo:"Receita"})),...e.financeiro.payables.filter(d=>d.status==="paid").map(d=>({...d,tipo:"Despesa"}))].map(d=>({Unidade:i.get(d.establishmentId)||"Atual","Data Pagamento":d.paymentDate?Ie(d.paymentDate):"-",Tipo:d.tipo,Descrição:d.description||"-","Natureza (DRE)":d.naturezaId?n.get(d.naturezaId)||"Outros":"Geral","Valor (R$)":d.amount||0}))}else if(t==="agenda"){if(!e.agenda||e.agenda.active.length===0)return f("Aviso","Sem dados de agenda.","info");r=e.agenda.active.map(i=>({Data:i.startTime?Ie(i.startTime):"-",Cliente:i.clientName||"Sem nome",Profissional:i.professionalName||"-",Status:i.status,"Valor Faturado (R$)":i.totalAmount||0}))}else if(t==="clientes"){if(!e.clientes||e.clientes.length===0)return f("Aviso","Sem dados de clientes.","info");r=e.clientes.map(i=>({"Data de Cadastro":i.createdAt?Ie(i.createdAt):"-",Nome:i.name||"-",Telefone:i.phone||"-","E-mail":i.email||"-","Última Visita":i.lastVisit?Ie(i.lastVisit):"-"}))}else if(t==="vendas"){if(!e.vendas||e.vendas.length===0)return f("Aviso","Sem dados de vendas.","info");r=e.vendas.map(i=>({"ID Venda":i.id||"-",Data:i.createdAt?Ie(i.createdAt):"-",Status:i.status||"-","Qtd Itens":(i.items||[]).length,"Faturamento (R$)":i.totalAmount||0}))}else if(t==="estoque"){if(!e.estoque||e.estoque.length===0)return f("Aviso","Sem dados de estoque.","info");r=e.estoque.map(i=>({Produto:i.name||"-","Código/SKU":i.sku||"-","Estoque Atual":i.currentStock||0,"Estoque Mínimo":i.minStock||0,"Preço Venda (R$)":i.price||0,Alerta:i.currentStock<=0?"Esgotado":i.currentStock<=i.minStock?"Baixo":"OK"}))}if(r.length===0)return f("Aviso","Nenhum dado válido para exportar.","info");try{const i=XLSX.utils.json_to_sheet(r),n=XLSX.utils.book_new();XLSX.utils.book_append_sheet(n,i,t.toUpperCase()),XLSX.writeFile(n,o)}catch(i){console.error("Erro na exportação Excel: ",i),f("Erro","Falha ao gerar o ficheiro Excel.","error")}}const Sa=(t,e="products")=>C(`/api/${e}/categories/${t}`),Xo=(t,e="products")=>C(`/api/${e}/categories`,{method:"POST",body:JSON.stringify(t)}),Ko=(t,e="products")=>C(`/api/${e}/categories/${t}`,{method:"DELETE"}),il="audit_logs",oe=async(t,e,a,s,r,o=null)=>{try{if(!e)return;await uo(ga(ge,il),{establishmentId:t,userId:e.uid,userName:e.name||e.email||"Utilizador",module:a,action:s,description:r,details:o,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},Ja=document.getElementById("content");let V={services:[],professionals:[],categories:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set},Rt=null;function at(){const t=me.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function Zo(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}async function nl(){V.selectedIds.clear();try{const t=await ve();V.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}ll(),dl(),await Me()}function ll(){Ja.innerHTML=`
        <section class="h-full flex flex-col p-2 md:p-4 md:pl-6 w-full relative">
    ...
    `}function dl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Me),t.addEventListener("click",()=>{setTimeout(Me,100)})),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",i=>{const n=i.target.dataset.status;V.statusFilter=n,document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),l.classList.add("bg-white","text-gray-600","border-gray-200")}),n==="inactive"?i.target.classList.add("bg-red-50","text-red-700","border-red-200"):i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200"),xt()})});const e=document.getElementById("toggle-filter-btn");e&&e.addEventListener("click",()=>{const o=document.getElementById("filter-panel");V.isAdvancedFilterOpen=!V.isAdvancedFilterOpen,V.isAdvancedFilterOpen?(o.classList.remove("hidden"),e.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),e.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),e.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),e.classList.add("bg-white","text-gray-600","border-gray-200"))});const a=document.getElementById("searchInput");a&&a.addEventListener("input",o=>{V.searchQuery=o.target.value.toLowerCase(),xt()});const s=document.getElementById("clear-filters-btn");s&&s.addEventListener("click",()=>{V.filterCategoryId="all",document.getElementById("filterCategoryId").value="all",xt()});const r=document.getElementById("apply-filter-btn");r&&r.addEventListener("click",()=>{V.filterCategoryId=document.getElementById("filterCategoryId").value,document.getElementById("toggle-filter-btn").click(),xt()}),Rt&&Ja.removeEventListener("click",Rt),Rt=o=>{const i=o.target.closest('[data-action="open-service-modal"]');if(i){o.preventDefault();let c={};if(i.dataset.service)try{c=JSON.parse(i.dataset.service)}catch{}hl(c);return}if(o.target.closest('[data-action="manage-categories"]')){o.preventDefault(),gl();return}const l=o.target.closest(".service-checkbox");if(l){const c=l.dataset.id;l.checked?V.selectedIds.add(c):V.selectedIds.delete(c),Qa(),o.stopPropagation();return}if(o.target.closest("#cancel-selection-btn")){V.selectedIds.clear(),document.querySelectorAll(".service-checkbox").forEach(c=>c.checked=!1),Qa();return}if(o.target.closest("#batch-delete-btn")){vl();return}},Ja.addEventListener("click",Rt)}async function Me(){const t=document.getElementById("servicesList"),e=Zo();try{const a=e.map(c=>dt(c)),s=e.map(c=>ke(c)),r=e.map(c=>Sa(c,"services")),o=await Promise.all(a),i=await Promise.all(s),n=await Promise.all(r),l=new Map;o.flat().filter(Boolean).forEach(c=>l.set(c.id,c)),V.services=Array.from(l.values()),m.services=V.services;const d=new Map;i.flat().filter(Boolean).forEach(c=>d.set(c.id,c)),V.professionals=Array.from(d.values()),m.professionals=V.professionals;const u=new Map;n.flat().filter(Boolean).forEach(c=>u.set(c.id,c)),V.categories=Array.from(u.values()),m.serviceCategories=V.categories,cl(),xt()}catch(a){console.error(a),t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>'}}function cl(){const t=document.getElementById("filterCategoryId");t&&V.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',V.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),V.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function Qa(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=V.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function ul(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.active!==!1).length,r=a-s;e.innerHTML=`
    ...
    `}function xt(){const t=document.getElementById("servicesList");if(!t)return;if(!V.services||V.services.length===0){t.innerHTML=er(8);return}const e=Zo(),a=V.services.filter(s=>{const r=s.name.toLowerCase().includes(V.searchQuery);let o=!0;V.statusFilter==="active"&&(o=s.active!==!1),V.statusFilter==="inactive"&&(o=s.active===!1);const i=V.filterCategoryId==="all"||s.categoryId===V.filterCategoryId,n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],l=e.some(d=>n.includes(d));return r&&o&&i&&l});ul(a),t.innerHTML=pl(a)}function er(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;return e}function pl(t){if(t.length===0)return`
        ...
        `;const e=new Map((V.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=a.active===!1,r=h(a.name),o=h(e.get(a.categoryId)||"Sem Categoria"),i=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,n=JSON.stringify(a).replace(/'/g,"&apos;"),l=a.accessibleIn?a.accessibleIn.length:1,d=V.selectedIds.has(a.id),u=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",c=a.color||"#4f46e5";return`
            <div class="service-card relative bg-white rounded-xl border ${d?"border-indigo-400 ring-1 ring-indigo-200 shadow-md bg-indigo-50/20":"border-gray-200"} shadow-sm flex items-center p-3 cursor-pointer transition-all hover:shadow-md hover:border-indigo-300 ${s?"opacity-60 bg-gray-50":""}" 
            ...
            </div>`}).join("")}async function bl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const r=e.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="...";try{const o=V.hierarchyCache.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);o.length===0&&o.push(m.establishmentId),await Xo({establishmentId:m.establishmentId,name:s,accessibleIn:o},"services"),oe(m.establishmentId,at(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await fs(),await Me()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{r.disabled=!1,r.textContent="Adicionar"}}async function ml(t){if(await X("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Ko(t,"services"),oe(m.establishmentId,at(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await fs(),await Me()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function fs(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Sa(m.establishmentId,"services");V.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(a=>`
                ...
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function gl(){De({title:"Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",bl),e.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),ml(r.dataset.id))}))}fs()}function fl(t=[]){if(!V.hierarchyCache||V.hierarchyCache.length===0)return`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(r=>{const o=t.includes(r.id)||t.length===0&&r.id===m.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}async function xl(t){const e=t.target.closest("#serviceForm"),a=e.querySelector("#serviceId").value,s=e.querySelector('button[type="submit"]'),r={},o=e.querySelector('input[name="commissionType"]:checked').value;o==="custom"&&e.querySelectorAll(".professional-commission-row").forEach(u=>{const c=u.dataset.profId;if(u.querySelector('input[type="checkbox"]').checked){const b=parseFloat(u.querySelector('input[type="number"]').value);r[c]=isNaN(b)?0:b}});const i=Array.from(e.querySelectorAll('input[name="accessibleIn"]:checked')).map(u=>u.value),n=i.length>0?i:[m.establishmentId],l={establishmentId:m.establishmentId,accessibleIn:n,name:e.querySelector("#serviceName").value.trim(),price:parseFloat(e.querySelector("#servicePrice").value),duration:parseInt(e.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(e.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:e.querySelector("#serviceCategory").value||null,color:e.querySelector("#serviceColor").value,targetAudience:e.querySelector("#serviceAudience").value,loyaltyPoints:parseInt(e.querySelector("#serviceLoyaltyPoints").value,10)||0,publicDescription:e.querySelector("#servicePublicDescription").value.trim(),homeService:e.querySelector("#serviceHomeToggle").checked,commissionRate:parseFloat(e.querySelector("#serviceCommissionRate").value)||0,active:e.querySelector("#serviceStatusToggle").checked,photo:e.querySelector("#servicePhotoBase64").value,notes:e.querySelector("#serviceNotes").value,commissionType:o,professionalCommissions:r},d=s.innerHTML;s.disabled=!0,s.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{a?(await Gi(a,l),oe(m.establishmentId,at(),"Serviços","Editou",`Editou o serviço: ${l.name}`),f("Sucesso","Serviço atualizado com sucesso!","success")):(await Qi(l),oe(m.establishmentId,at(),"Serviços","Criou",`Criou novo serviço: ${l.name}`),f("Sucesso","Serviço adicionado à rede!","success")),document.getElementById("genericModal").style.display="none",await Me()}catch(u){f("Erro",u.message,"error"),s.disabled=!1,s.innerHTML=d}}function hl(t=null){const e=document.getElementById("genericModal"),a=V.categories||[],s=t?.duration||0,r=t?.bufferTime||0,o=h(t?.name||""),i=h(t?.notes||""),n=h(t?.publicDescription||""),l=t?.id?o:"Novo Serviço",d=t?.color||"#4f46e5",u=t?.loyaltyPoints||0,c=a.map(T=>`<option value="${T.id}" ${t?.categoryId===T.id?"selected":""}>${h(T.name)}</option>`).join(""),p=t?.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(o?o.charAt(0):"S")}`,b=`
        ...
        </div>`;e.innerHTML=b,e.style.display="flex",e.querySelectorAll(".tab-link").forEach(T=>{T.addEventListener("click",()=>{e.querySelectorAll(".tab-link").forEach(N=>{N.classList.remove("active","border-indigo-600","text-indigo-600"),N.classList.add("border-transparent","text-gray-500")}),T.classList.add("active","border-indigo-600","text-indigo-600"),T.classList.remove("border-transparent","text-gray-500"),e.querySelectorAll(".tab-content").forEach(N=>N.classList.add("hidden")),document.getElementById(T.dataset.tab).classList.remove("hidden")})});const g=e.querySelectorAll('input[name="commissionType"]'),v=document.getElementById("defaultCommissionRateContainer"),y=document.getElementById("professionalCommissionsContainer");function $(){const T=e.querySelector('input[name="commissionType"]:checked').value;v&&(v.style.display=T==="default"?"block":"none"),y&&(y.style.display=T==="custom"?"block":"none")}g.forEach(T=>T.addEventListener("change",$));const P=document.getElementById("professionalCommissionsList");P&&(P.innerHTML=(V.professionals||[]).map(T=>{const N=t?.professionalCommissions?.[T.id]!==void 0,H=t?.professionalCommissions?.[T.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-lg border border-transparent hover:bg-gray-50 transition-colors ${N?"bg-indigo-50/50 border-indigo-100":""}" data-prof-id="${T.id}">
                    <label class="flex items-center gap-3 cursor-pointer flex-1 min-w-0">
                        <input type="checkbox" ${N?"checked":""} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                    ...
                    <div class="flex items-center gap-1">
                        <input type="number" value="${H}" step="0.1" class="w-20 p-1.5 border border-gray-300 rounded-lg text-sm text-center outline-none focus:ring-1 focus:ring-indigo-500 bg-white" ${N?"":"disabled"}>
                        <span class="text-sm font-black text-gray-400">%</span>
                    </div>
                </div>
            `}).join(""),P.querySelectorAll('input[type="checkbox"]').forEach(T=>{T.addEventListener("change",N=>{const H=N.target.closest(".professional-commission-row");H.querySelector('input[type="number"]').disabled=!N.target.checked,H.classList.toggle("bg-indigo-50/50",N.target.checked),H.classList.toggle("border-indigo-100",N.target.checked),H.classList.toggle("border-transparent",!N.target.checked)})})),$();const A=e.querySelector("#servicePhotoInput"),S=e.querySelector("#servicePhotoButton"),L=e.querySelector("#servicePhotoContainer"),z=e.querySelector("#servicePhotoPreview"),F=e.querySelector("#servicePhotoBase64"),E=()=>A.click();S&&S.addEventListener("click",E),L&&L.addEventListener("click",E),A.onchange=async()=>{const T=A.files[0];if(T){z.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const N=await xa(T,800,800,.8);if(N.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");z.src=N,F.value=N}catch(N){f("Erro de Imagem",N.message,"error"),z.src=p,F.value=t?.photo||""}}};const I=e.querySelector("#serviceForm");e.onclick=async T=>{const N=T.target.closest("button[data-action]");if(!N)return;const H=N.dataset.action,U=N.dataset.id;if(H==="close-modal"&&(e.style.display="none"),H==="save-service"&&I.reportValidity()&&xl({target:I}),H==="delete-service"){if(!U)return;if(await X("Apagar Serviço","Tem certeza que deseja excluir este serviço da rede?"))try{const W=V.services.find(te=>te.id===U)?.name||"Desconhecido";await Io(U),oe(m.establishmentId,at(),"Serviços","Excluiu",`Excluiu o serviço: ${W}`),f("Sucesso","Serviço apagado da rede.","success"),e.style.display="none",await Me()}catch(W){f("Erro",`Não foi possível apagar o serviço: ${W.message}`,"error")}}}}function vl(){X("Excluir em Lote",`Tem certeza que deseja excluir ${V.selectedIds.size} serviços da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{const e=Array.from(V.selectedIds).map(a=>Io(a));await Promise.all(e),oe(m.establishmentId,at(),"Serviços","Excluiu em Lote",`Excluiu ${V.selectedIds.size} serviços`),f("Sucesso",`${V.selectedIds.size} serviços foram excluídos.`,"success"),V.selectedIds.clear(),Qa(),Me()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}const Ea="suppliers",Pt=async t=>{try{const e=po(ga(ge,Ea),bo("establishmentId","==",t)),a=await Hr(e),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},yl=async t=>{try{return{id:(await uo(ga(ge,Ea),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},wl=async(t,e)=>{try{const a=Pe(ge,Ea,t);return await Tt(a,e),{id:t,...e}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},kl=async t=>{try{const e=Pe(ge,Ea,t);return await Or(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},ht=document.getElementById("content");let q={products:[],categories:[],suppliers:[],hierarchyCache:[],currentTab:"catalogo",stockFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set},Ft=null;function Fe(){const t=me.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function xs(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}function Ta(t){return t?t._seconds?new Date(t._seconds*1e3):t.seconds?new Date(t.seconds*1e3):new Date(t):new Date}async function $l(){q.selectedIds.clear(),q.currentTab="catalogo";try{const t=await ve();q.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}hs(),El(),await Ce()}function hs(){ht.innerHTML=`
        <section class="h-full flex flex-col p-2 md:p-4 md:pl-6 w-full relative">
    ...
    `,Sl()}function Sl(){const t=document.getElementById("main-tab-content");if(t){if(q.currentTab==="catalogo")t.innerHTML=`
        ...
        `,tr(),Ge();else if(q.currentTab==="movimentacoes"){const e=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0],r=(q.products||[]).map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join(""),o=(q.categories||[]).map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join("");t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",Ya),Ya()}}}function El(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Ce),t.addEventListener("click",()=>{setTimeout(Ce,100)})),Ft&&ht.removeEventListener("click",Ft),Ft=e=>{const a=e.target.closest("[data-main-tab]");if(a){q.currentTab=a.dataset.mainTab,hs();return}if(e.target.classList.contains("status-filter-btn")){const d=e.target.dataset.status;q.stockFilter=d,document.querySelectorAll(".status-filter-btn").forEach(u=>{u.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-green-50","text-green-700","border-green-200","bg-orange-50","text-orange-700","border-orange-200","bg-red-50","text-red-700","border-red-200"),u.classList.add("bg-white","text-gray-600","border-gray-200")}),d==="ok"?e.target.classList.add("bg-green-50","text-green-700","border-green-200"):d==="alert"?e.target.classList.add("bg-orange-50","text-orange-700","border-orange-200"):d==="empty"?e.target.classList.add("bg-red-50","text-red-700","border-red-200"):e.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),e.target.classList.remove("bg-white","text-gray-600","border-gray-200"),Ge();return}const s=e.target.closest('[data-action="open-product-modal"]');if(s){e.preventDefault();let d={};if(s.dataset.product)try{d=JSON.parse(s.dataset.product)}catch{}Al(d);return}if(e.target.closest('[data-action="manage-categories"]')){e.preventDefault(),Tl();return}if(e.target.closest('[data-action="open-new-movement-modal"]')){e.preventDefault(),sr();return}const i=e.target.closest(".product-checkbox");if(i){const d=i.dataset.id;i.checked?q.selectedIds.add(d):q.selectedIds.delete(d),Ga(),e.stopPropagation();return}if(e.target.closest("#cancel-selection-btn")){q.selectedIds.clear(),document.querySelectorAll(".product-checkbox").forEach(d=>d.checked=!1),Ga();return}if(e.target.closest("#batch-delete-btn")){Ml();return}},ht.addEventListener("click",Ft),ht.addEventListener("input",e=>{e.target.id==="searchInput"&&(q.searchQuery=e.target.value.toLowerCase(),Ge())}),ht.addEventListener("click",e=>{const a=e.target.closest("#toggle-filter-btn");if(a){const o=document.getElementById("filter-panel");q.isAdvancedFilterOpen=!q.isAdvancedFilterOpen,q.isAdvancedFilterOpen?(o.classList.remove("hidden"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-gray-600","border-gray-200"))}e.target.closest("#clear-filters-btn")&&(q.filterCategoryId="all",document.getElementById("filterCategoryId").value="all",Ge()),e.target.closest("#apply-filter-btn")&&(q.filterCategoryId=document.getElementById("filterCategoryId").value,document.getElementById("toggle-filter-btn").click(),Ge())})}async function Ce(){const t=xs();try{const e=t.map(n=>ct(n)),a=t.map(n=>Sa(n,"products")),[s,r]=await Promise.all([Promise.all(e),Promise.all(a)]),o=new Map;s.flat().filter(Boolean).forEach(n=>o.set(n.id,n)),q.products=Array.from(o.values()),m.products=q.products;const i=new Map;r.flat().filter(Boolean).forEach(n=>i.set(n.id,n)),q.categories=Array.from(i.values()),m.categories=q.categories,q.currentTab==="catalogo"?(tr(),Ge()):q.currentTab==="movimentacoes"&&Ya(),q.suppliers=[],t.forEach(async n=>{try{let l=[];typeof Pt=="function"&&(l=await Pt(n)),l.forEach(d=>{q.suppliers.find(u=>u.id===d.id)||q.suppliers.push(d)}),m.suppliers=q.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function tr(){const t=document.getElementById("filterCategoryId");t&&q.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',q.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),q.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function Ga(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=q.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Il(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,r=0,o=0;t.forEach(i=>{const n=i.currentStock||0,l=i.minStock||0;n<=0?o++:l>0&&n<=l||l>0&&n<=l*1.2?r++:s++}),e.innerHTML=`
        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
    ...
    `}function Ge(){const t=document.getElementById("productsList");if(!t)return;if(!q.products||q.products.length===0){t.innerHTML=ar(8);return}const e=xs(),a=q.products.filter(s=>{const r=s.name.toLowerCase().includes(q.searchQuery),o=s.currentStock||0,i=s.minStock||0;let n=!0;q.stockFilter==="ok"&&(n=o>0&&(i===0||o>i*1.2)),q.stockFilter==="alert"&&(n=i>0&&o>0&&o<=i*1.2),q.stockFilter==="empty"&&(n=o<=0);const l=q.filterCategoryId==="all"||s.categoryId===q.filterCategoryId,d=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],u=e.some(c=>d.includes(c));return r&&n&&l&&u});Il(a),t.innerHTML=Ll(a)}function ar(t=8){let e="";for(let a=0;a<t;a++)e+=`
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm flex items-center p-3 animate-pulse h-[74px]">
        ...
        `;return e}function Ll(t){if(t.length===0)return`
            <div class="col-span-full flex flex-col items-center justify-center py-16">
                <div class="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center mb-3">
        ...
        `;const e=new Map((q.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=h(a.name),r=h(e.get(a.categoryId)||"Sem Categoria"),o=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,i=JSON.stringify(a).replace(/'/g,"&apos;"),n=a.accessibleIn?a.accessibleIn.length:1,l=q.selectedIds.has(a.id),d=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",u=a.currentStock||0,c=a.minStock||0;let p="bg-emerald-500",b=!1;return u<=0?(p="bg-red-500",b=!0):c>0&&u<=c*1.2&&(p="bg-orange-500"),`
            ...
            </div>`}).join("")}async function Cl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const r=e.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="...";try{const o=q.hierarchyCache.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);o.length===0&&o.push(m.establishmentId),await Xo({establishmentId:m.establishmentId,name:s,accessibleIn:o},"products"),oe(m.establishmentId,Fe(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await vs(),await Ce()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{r.disabled=!1,r.textContent="Adicionar"}}async function Dl(t){if(await X("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Ko(t,"products"),oe(m.establishmentId,Fe(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await vs(),await Ce()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function vs(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Sa(m.establishmentId,"products");q.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded mb-1">
                    <span class="text-sm font-medium text-gray-700">${h(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-xs bg-red-50 px-2 py-1 rounded">Apagar</button>
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function Tl(){De({title:"Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4 bg-indigo-50 p-4 rounded-xl border border-indigo-100">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Cl),e.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),Dl(r.dataset.id))}))}vs()}function sr(){const t=(q.products||[]).map(o=>`<option value="${o.id}">${h(o.name)} (Estoque: ${o.currentStock||0})</option>`).join(""),a=`
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <select id="movEstablishmentId" required class="w-full p-2.5 border border-gray-300 rounded-lg text-sm bg-gray-50 focus:bg-white outline-none focus:ring-2 focus:ring-indigo-500">
                            ${q.hierarchyCache.reduce((o,i)=>(o.push(`<option value="${i.id}">🏢 ${h(i.name)}</option>`),i.branches&&i.branches.forEach(n=>o.push(`<option value="${n.id}">📍 ${h(n.name)}</option>`)),o),[]).join("")}
                        </select>
    ...
    `;De({title:"Lançar Movimentação",contentHTML:a,maxWidth:"max-w-lg"});const s=document.getElementById("movEstablishmentId");s&&(s.value=m.establishmentId);const r=document.getElementById("newMovementForm");r.onsubmit=async o=>{o.preventDefault();const i=r.querySelector('button[type="submit"]'),n=i.innerHTML,l=document.getElementById("movProductId")?.value,d=document.getElementById("movEstablishmentId")?.value,u=r.querySelector('input[name="movType"]:checked')?.value,c=parseInt(document.getElementById("movAmount")?.value,10),p=document.getElementById("movReason")?.value.trim();if(!l||!c||c<=0||!p||!d){f("Erro","Preencha todos os campos corretamente.","warning");return}const b=u==="in"?c:-c;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Salvando...';try{await jo(l,{change:b,reason:p,establishmentId:d});const g=q.products.find(v=>v.id===l)?.name||"Produto";oe(d,Fe(),"Estoque","Ajuste Manual",`Lançou movimentação (${b>0?"+":""}${b}) para ${g}`),f("Sucesso","Movimentação registrada com sucesso!","success"),document.getElementById("genericModal").style.display="none",await Ce()}catch(g){f("Erro",g.message,"error"),i.disabled=!1,i.innerHTML=n}}}function Pl(t=[]){if(!q.hierarchyCache||q.hierarchyCache.length===0)return`
        ...
        <div class="modal-content max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh]"> 
            ...
            <form id="productForm" class="flex-1 flex flex-col overflow-hidden">
        ...
        </div>`;e.innerHTML=b,e.style.display="flex",e.querySelectorAll(".tab-link").forEach(F=>{F.addEventListener("click",()=>{e.querySelectorAll(".tab-link").forEach(E=>{E.classList.remove("active","border-indigo-600","text-indigo-600"),E.classList.add("border-transparent","text-gray-500")}),F.classList.add("active","border-indigo-600","text-indigo-600"),F.classList.remove("border-transparent","text-gray-500"),e.querySelectorAll(".tab-content").forEach(E=>E.classList.add("hidden")),document.getElementById(F.dataset.tab).classList.remove("hidden")})});const g=document.getElementById("productForm");g.onsubmit=Bl;let v=new Set(t?.supplierIds||[]);const y=()=>{const F=document.getElementById("modalSupplierSearch"),E=document.getElementById("supplierSearchResults"),I=document.getElementById("selectedSuppliersList"),T=F?.value.toLowerCase()||"",N=q.suppliers||[];if(T.length>0){const H=N.filter(U=>U.name.toLowerCase().includes(T)&&!v.has(U.id));H.length>0?(E.classList.remove("hidden"),E.innerHTML=H.map(U=>`
                ...
                `).join("")):(E.classList.remove("hidden"),E.innerHTML='<div class="p-4 text-sm text-gray-500 text-center">Fornecedor não encontrado.</div>')}else E.classList.add("hidden");v.size>0?(I.classList.remove("justify-center"),I.classList.add("justify-start"),I.innerHTML="",v.forEach(H=>{const U=N.find(D=>D.id===H);U&&(I.innerHTML+=`
                    ...
                    `)})):(I.classList.add("justify-center"),I.classList.remove("justify-start"),I.innerHTML='<p class="text-xs text-gray-400 text-center">Nenhum fornecedor adicionado ainda.</p>')};document.getElementById("modalSupplierSearch")?.addEventListener("input",y),y();const $=document.getElementById("productPhotoInput"),P=document.getElementById("productPhotoButton"),A=document.getElementById("productPhotoContainer"),S=document.getElementById("productPhotoPreview"),L=document.getElementById("productPhotoBase64"),z=()=>$?.click();P&&P.addEventListener("click",z),A&&A.addEventListener("click",z),$&&($.onchange=async()=>{const F=$.files[0];if(!F)return;const E=S.src;S.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const I=await xa(F,800,800,.8);if(I.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");S.src=I,L.value=I}catch(I){f("Erro de Imagem",I.message,"error"),S.src=E,L.value=t?.photo||""}}),e.onclick=async F=>{const E=F.target.closest("[data-add-supplier]");if(E){v.add(E.dataset.addSupplier);const U=document.getElementById("modalSupplierSearch");U&&(U.value=""),y();return}const I=F.target.closest("[data-remove-supplier]");if(I){v.delete(I.dataset.removeSupplier),y();return}const T=F.target.closest("button[data-action]");if(!T)return;const N=T.dataset.action,H=T.dataset.id;if(N==="close-modal"&&(e.style.display="none"),N==="delete-product"){if(!H)return;if(await X("Apagar Produto","Tem certeza que deseja excluir este produto do catálogo?"))try{const D=q.products.find(W=>W.id===H)?.name||"Desconhecido";await ps(H),oe(m.establishmentId,Fe(),"Produtos","Excluiu",`Excluiu o produto: ${D}`),f("Sucesso","Produto apagado.","success"),e.style.display="none",await Ce()}catch(D){f("Erro",`Não foi possível apagar: ${D.message}`,"error")}}N==="open-new-movement-modal"&&(e.style.display="none",q.currentTab="movimentacoes",hs(),sr())}}function Ml(){X("Excluir em Lote",`Tem certeza que deseja excluir ${q.selectedIds.size} produtos da rede?`).then(async t=>{if(t)try{const e=Array.from(q.selectedIds).map(a=>ps(a));await Promise.all(e),oe(m.establishmentId,Fe(),"Produtos","Excluiu em Lote",`Excluiu ${q.selectedIds.size} produtos`),f("Sucesso",`${q.selectedIds.size} produtos foram excluídos.`,"success"),q.selectedIds.clear(),Ga(),Ce()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}async function Ya(){const t=document.getElementById("report-results");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full"><div class="loader"></div></div>';const e={startDate:document.getElementById("reportStartDate")?.value||"",endDate:document.getElementById("reportEndDate")?.value||"",productId:document.getElementById("productFilterReport")?.value||"all",categoryId:document.getElementById("categoryFilterReport")?.value||"all"};try{const s=xs().map(n=>No({...e,establishmentId:n}).catch(l=>[])),r=await Promise.all(s);let o=[];if(r.forEach(n=>{if(!n)return;const l=Array.isArray(n)?n:Array.isArray(n.data)?n.data:Array.isArray(n.movements)?n.movements:[];o=o.concat(l)}),o.sort((n,l)=>Ta(l.date)-Ta(n.date)),o.length===0){t.innerHTML=`
                <div class="flex items-center justify-center h-full p-8 text-center">
                    <div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ${o.map(n=>{const l=n.change>0,d=l?"text-emerald-600 bg-emerald-50":"text-red-600 bg-red-50",u=l?'<i class="bi bi-arrow-down-left"></i>':'<i class="bi bi-arrow-up-right"></i>';return`
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 whitespace-nowrap text-gray-500 text-xs">${Ta(n.date).toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}</td>
            ...
            </div>`;t.innerHTML=i}catch(a){f("Erro",`Não foi possível gerar: ${a.message}`,"error"),t.innerHTML='<div class="p-8 text-center text-red-500 font-bold">Falha ao buscar movimentações.</div>'}}const Kt=document.getElementById("content");let J={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},Ht=null;const na={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},or=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function ql(){try{const e=(await ve()).matrizes||[];J.establishments=[],e.forEach(a=>{J.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>J.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.warn("Erro ao buscar lojas",t)}J.viewMode="list",J.editingItem=null,J.hasSearched=!1,J.partners=[],jl(),zl(),rr()}function jl(){Kt.innerHTML=`
    ...
    `}function Nl(){const t=Object.entries(na).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=or.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Rl(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(na).map(([i,n])=>`<option value="${i}" ${a===i?"selected":""}>${n.label}</option>`).join(""),r=or.map(i=>`<option value="${i}" ${t?.state===i?"selected":""}>${i}</option>`).join(""),o=document.getElementById("form-container-wrapper");o&&(o.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Hl))}function rr(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
        ...
        <div class="hidden md:block w-full bg-white">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
    `,s='<div class="flex flex-col gap-2 md:hidden p-2">';e.forEach(r=>{let o=r.category;o==="Produtos"&&(o="estoque"),o==="Serviços"&&(o="servicos");const i=na[o]||na.outros,n=r.document||r.taxId?r.document||r.taxId:"-",l=JSON.stringify(r).replace(/'/g,"&apos;"),d=[r.city,r.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",s+="</div>",t.innerHTML=a+s}function wt(t,e=null){const a=document.getElementById("suppliers-list-view"),s=document.getElementById("suppliers-form-view");J.viewMode=t,J.editingItem=e,t==="list"?(a.classList.remove("hidden"),a.classList.add("flex"),s.classList.add("hidden"),s.innerHTML='<div id="form-container-wrapper" class="max-w-4xl mx-auto w-full"></div>',J.hasSearched&&ir(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),a.classList.remove("flex"),s.classList.remove("hidden"),Rl(e),window.scrollTo({top:0,behavior:"smooth"}))}async function Hl(t){t.preventDefault();const e=t.target,a=e.querySelector("#supId").value,s={name:e.querySelector("#supName").value,contactName:e.querySelector("#supContact").value,email:e.querySelector("#supEmail").value,phone:e.querySelector("#supPhone").value,document:e.querySelector("#supTaxId").value,category:e.querySelector("#supCategory").value,state:e.querySelector("#supState").value,city:e.querySelector("#supCity").value,establishmentId:m.establishmentId,notes:e.querySelector("#supNotes")?.value||"",accessibleIn:[m.establishmentId]},r=e.querySelector('button[type="submit"]'),o=r.innerHTML;r.disabled=!0,r.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await wl(a,s),f("Sucesso","Ficha atualizada!","success")):(await yl(s),f("Sucesso","Parceiro registado!","success")),J.hasSearched&&(J.partners=await Pt(m.establishmentId)||[]),wt("list")}catch(i){f("Erro","Falha ao gravar: "+i.message,"error"),r.disabled=!1,r.innerHTML=o}}async function Ol(t){if(await X("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente?"))try{await kl(t),f("Sucesso","Entidade excluída.","success"),J.partners=J.partners.filter(a=>a.id!==t),wt("list")}catch(a){f("Erro","Erro ao excluir: "+a.message,"error")}}function zl(){Ht&&Kt.removeEventListener("click",Ht),Ht=async t=>{const e=t.target;if(e.closest('button[data-action="new-partner"]')){wt("form",null);return}if(e.closest("#btn-search-partners")){J.searchQuery=document.getElementById("filterSearch").value,J.categoryFilter=document.getElementById("filterCategory").value,J.stateFilter=document.getElementById("filterState").value,J.cityFilter=document.getElementById("filterCity").value,J.sortBy=document.getElementById("filterSortBy").value,J.hasSearched=!0,Fl();return}if(e.closest('button[data-action="back-to-list"]')){wt("list");return}const a=e.closest('button[data-action="delete-partner"]');if(a){t.preventDefault(),Ol(a.dataset.id);return}const s=e.closest('[data-action="open-form"]');if(s&&!e.closest("button")){const r=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));wt("form",r)}},Kt.addEventListener("click",Ht),Kt.addEventListener("keypress",t=>{t.key==="Enter"&&(t.target.id==="filterSearch"||t.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const Xa=document.getElementById("content"),Os={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let _={professionals:[],services:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterServiceId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,viewMode:"list",tempProf:null},Ot=null,zt=null;function Zt(){const t=me.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function nr(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}function _l(){const t=document.getElementById("professionals-layout-main"),e=document.getElementById("professionals-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.add("mobile-detail-open"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&(a.style.display="none")}function Pa(){const t=document.getElementById("professionals-layout-main"),e=document.getElementById("professionals-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.remove("mobile-detail-open"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&(a.style.display=""),_.viewMode="list"}async function Vl(){_.selectedIds.clear(),_.viewMode="list";try{const t=await ve();_.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}lr(),Zl(),await la()}function lr(){Xa.innerHTML=`
    ...
    `}async function la(){const t=document.getElementById("professionalsList"),e=nr();try{const a=e.map(l=>ke(l)),s=e.map(l=>dt(l)),r=await Promise.all(a),o=await Promise.all(s),i=new Map;r.flat().forEach(l=>i.set(l.id,l)),_.professionals=Array.from(i.values()),m.professionals=_.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),_.services=Array.from(n.values()),dr(),We()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function dr(){const t=document.getElementById("filterServiceId");t&&_.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',_.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),_.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function cr(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=_.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Ul(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,r=a-s;e.innerHTML=`
    ...
    `}function We(){const t=document.getElementById("professionalsList");if(!t)return;if(!_.professionals||_.professionals.length===0){t.innerHTML=ur(8);return}const e=nr(),a=_.professionals.filter(s=>{const r=s.name.toLowerCase().includes(_.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(_.searchQuery);let o=!0;_.statusFilter==="active"&&(o=s.status!=="inactive"),_.statusFilter==="inactive"&&(o=s.status==="inactive");const i=_.filterServiceId==="all"||s.services&&s.services.includes(_.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],l=e.some(d=>n.includes(d));return r&&o&&i&&l});if(Ul(a),a.length===0){t.innerHTML=`
        ...
        `;return e}async function Wl(t){_.viewMode="edit-professional";const e=document.getElementById("professionals-layout-detail");if(!e)return;let a={name:"",specialty:"",status:"active",workingHours:{},services:[]};if(t){const o=_.professionals.find(i=>String(i.id)===String(t));o&&(a=JSON.parse(JSON.stringify(o)))}_.tempProf=a;const s=!!a.id;h(a.name||"Novo Profissional");const r=`
    ...
    `,Jl(a,_.services),Gl(a),await Xl(a,_.professionals),Kl(a),_l()}function Jl(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const r=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,b=p==r[1]?"selected":"",g=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${g.charAt(0).toUpperCase()+g.slice(1)}</option>`}).join(""),i=h(t.name||""),n=h(t.specialty||""),l=h(t.phone||""),d=h(t.notes||"");a.innerHTML=`
    ...
    `}function Ql(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(r=>{const o=t.includes(r.id)||t.length===0&&r.id===m.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function Gl(t){const e=document.getElementById("jornada");e&&(e.innerHTML=`
        <div class="max-w-4xl mx-auto bg-white p-4 md:p-6 rounded-2xl border border-slate-200 shadow-sm">
        ...
        </div>`,Yl(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function Yl(t,e){t.innerHTML=Object.keys(Os).map(a=>{const s=e[a]||{},r=s.active!==!1;return`
            ...
            </div>`}).join(""),t.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",s=>{const r=s.target.closest(".day-schedule-card"),o=!s.target.checked;r.classList.toggle("bg-white",!o),r.classList.toggle("shadow-sm",!o),r.classList.toggle("border-slate-200",!o),r.classList.toggle("bg-slate-50",o),r.classList.toggle("border-slate-100",o),r.classList.toggle("opacity-60",o),r.classList.toggle("disabled",o),r.querySelectorAll(".time-inputs input").forEach(i=>i.disabled=o)})})}async function Xl(t,e){const a=document.getElementById("bloqueios");if(!a)return;a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-[10px] font-bold text-red-500 p-4 bg-red-50 rounded-xl border border-red-100">${s.message}</p>`}}}function Kl(t){const e=document.getElementById("professionals-layout-detail");if(!e)return;const a=e.querySelectorAll(".tab-link");a.forEach(p=>{p.addEventListener("click",b=>{b.preventDefault(),a.forEach(y=>{y.classList.remove("active","border-indigo-600","text-indigo-600"),y.classList.add("border-transparent","text-slate-500")}),p.classList.add("active","border-indigo-600","text-indigo-600"),p.classList.remove("border-transparent","text-slate-500"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.add("hidden"));const g=p.dataset.tab,v=e.querySelector("#"+g);v&&v.classList.remove("hidden")})});const s=e.querySelector("#profPhotoInput"),r=e.querySelector("#profPhotoButton"),o=e.querySelector("#profPhotoContainer"),i=e.querySelector("#profPhotoPreview"),n=e.querySelector("#profPhotoBase64"),l=t.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,d=t.photo||"",u=()=>s.click();r&&r.addEventListener("click",u),o&&o.addEventListener("click",u),s&&(s.onchange=async()=>{const p=s.files[0];if(p){i.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const b=await xa(p,800,800,.8);if(b.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");i.src=b,n.value=b}catch(b){f("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),i.src=l,n.value=d,s.value=""}}});const c=e.querySelector("#selectAllServicesBtn");if(c){c.addEventListener("click",()=>{const b=e.querySelectorAll('#profServicesContainer input[type="checkbox"]'),g=Array.from(b).every(v=>v.checked);b.forEach(v=>{v.checked=!g}),c.textContent=g?"Selecionar Todos":"Desmarcar Todos"});const p=e.querySelectorAll('#profServicesContainer input[type="checkbox"]');p.length>0&&Array.from(p).every(b=>b.checked)&&(c.textContent="Desmarcar Todos")}}function Zl(){Ot&&document.body.removeEventListener("click",Ot),zt&&Xa.removeEventListener("input",zt),Ot=async t=>{if(t.target.classList.contains("professional-checkbox")){const o=t.target.dataset.id;t.target.checked?_.selectedIds.add(o):_.selectedIds.delete(o),cr(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){_.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600"),We();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterServiceId").value="all",_.filterServiceId="all",We();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),_.filterServiceId=document.getElementById("filterServiceId").value,We();return}if(t.target.closest("#toggle-filter-btn")){t.preventDefault(),_.isAdvancedFilterOpen=!_.isAdvancedFilterOpen,lr(),document.getElementById("searchInput").value=_.searchQuery,dr(),We();return}const s=t.target.closest("[data-action]");if(!s)return;const r=s.dataset.action;switch(["close-detail-screen","delete-professional","save-professional","delete-blockage","batch-delete-blockage"].includes(r)&&t.stopPropagation(),r){case"open-professional-editor":Wl(s.dataset.id);break;case"close-detail-screen":Pa(),_.tempProf=null;break;case"batch-delete":ed();break;case"delete-professional":{const o=s.dataset.id,i=_.tempProf?.name||"Profissional";if(await X("Excluir Profissional",`Tem certeza que deseja excluir ${i}? Esta ação não pode ser desfeita.`))try{await fo(o),oe(m.establishmentId,Zt(),"Equipe","Excluiu",`Excluiu profissional: ${i}`),f("Sucesso!","Profissional excluído da rede.","success"),Pa(),la()}catch(l){f("Erro",`Não foi possível excluir: ${l.message}`,"error")}break}case"save-professional":{const o=document.getElementById("professionals-layout-detail"),i=s,n=o.querySelector("#profScheduleContainer"),l=Array.from(o.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map($=>$.value),d={};n&&n.querySelectorAll(".day-schedule-card").forEach($=>{const P=$.querySelector('[data-field="active"]').dataset.day;d[P]={active:$.querySelector('[data-field="active"]').checked,start:$.querySelector('[data-field="start"]').value,end:$.querySelector('[data-field="end"]').value,breakStart:$.querySelector('[data-field="breakStart"]').value,breakEnd:$.querySelector('[data-field="breakEnd"]').value}});const u=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map($=>$.value),c=u.length>0?u:[m.establishmentId],p=o.querySelector("#profStatusToggle").checked,b=o.querySelector("#profCommissionToggle").checked,g=o.querySelector("#profShowOnAgendaToggle").checked,v={..._.tempProf,id:o.querySelector("#professionalId").value||void 0,accessibleIn:c,name:o.querySelector("#profName").value.trim(),specialty:o.querySelector("#profSpecialty").value,photo:o.querySelector("#profPhotoBase64").value,services:l,workingHours:d,phone:o.querySelector("#profPhone").value,dob:`${o.querySelector("#profDobDay").value}/${o.querySelector("#profDobMonth").value}`,receivesCommission:b,showOnAgenda:g,orderOnAgenda:parseInt(o.querySelector("#profOrderOnAgenda").value)||1,notes:o.querySelector("#profNotes").value,status:p?"active":"inactive",establishmentId:m.establishmentId},y=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{v.id?(await Ra(v.id,v),oe(m.establishmentId,Zt(),"Equipe","Editou",`Editou o profissional: ${v.name}`),f("Sucesso!","Dados atualizados.","success")):(delete v.id,await mi(v),oe(m.establishmentId,Zt(),"Equipe","Criou",`Cadastrou o profissional: ${v.name}`),f("Sucesso!","Novo membro adicionado à equipe.","success")),Pa(),la()}catch($){f("Erro",$.message,"error"),i.disabled=!1,i.innerHTML=y}break}case"delete-blockage":{const o=s.dataset.id;if(await X("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await ds(o),f("Bloqueio removido.","success");const i=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";kt(_.tempProf.id,i)}catch(i){f("Erro",i.message,"error")}break}case"batch-delete-blockage":{const o=JSON.parse(s.dataset.ids);if(await X("Apagar em Lote",`Tem certeza que deseja apagar ${o.length} dias de bloqueio de uma vez?`))try{await Lo(o),f("Bloqueios removidos.","success");const i=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";kt(_.tempProf.id,i)}catch(i){f("Erro",i.message,"error")}break}}},document.body.addEventListener("click",Ot),zt=t=>{t.target.id==="searchInput"&&(_.searchQuery=t.target.value,We())},Xa.addEventListener("input",zt)}function ed(){X("Excluir em Lote",`Tem certeza que deseja excluir ${_.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await gi(Array.from(_.selectedIds)),oe(m.establishmentId,Zt(),"Equipe","Excluiu em Lote",`Excluiu ${_.selectedIds.size} profissionais`),f("Sucesso!",`${_.selectedIds.size} profissionais foram excluídos.`,"success"),_.selectedIds.clear(),cr(),la()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}let w={clients:[],selectedClient:null,activeTab:"profile",establishments:[],filterEstablishmentIds:new Set,filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},da=null,_t=null;const pr=t=>t?String(t).replace(/\D/g,""):"",Ka=t=>{if(!t)return"Nunca";let e;if(typeof t=="object"&&(t.seconds||t._seconds)){const a=t.seconds||t._seconds;e=new Date(a*1e3)}else e=new Date(t);return isNaN(e.getTime())?"Data Inválida":e.toLocaleDateString("pt-BR")},Za=t=>{if(!t)return"CL";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()};async function td(){da=document.getElementById("content"),w.selectedClient=null,w.historyLimit=20,w.modalOpen=!1,w.selectedIds.clear(),w.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},w.sortConfig={key:"name",direction:"asc"};try{const e=(await ve().catch(()=>({matrizes:[]}))).matrizes||[];w.establishments=[],e.forEach(a=>{w.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>w.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(m.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia",t)}ad(),od(),await ys()}function ad(){const t=w.establishments.map(e=>`
    ...
    `}function sd(){const t=document.getElementById("table-header-container");if(!t)return;const e=a=>w.sortConfig.key!==a?'<i class="bi bi-arrow-down-up ml-1 opacity-40 text-xs"></i>':w.sortConfig.direction==="asc"?'<i class="bi bi-arrow-up ml-1 text-indigo-600"></i>':'<i class="bi bi-arrow-down ml-1 text-indigo-600"></i>';t.innerHTML=`
    ...
    `}async function ys(){w.loading=!0;const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-xs">Carregando clientes...</p></div>');try{const a=Array.from(w.filterEstablishmentIds).map(i=>{let n=`/api/clients/${i}?limit=1000`;return C(n).catch(()=>[])}),r=(await Promise.all(a)).flat(),o=new Map;r.forEach(i=>o.set(i.id,i)),w.clients=Array.from(o.values()),ws(),ye()}catch(e){console.error(e),f("Erro","Falha ao carregar clientes.","error"),t&&(t.innerHTML='<div class="text-center py-10 text-red-500 text-sm">Erro ao carregar dados.</div>')}finally{w.loading=!1}}function ws(){const t=new Date().getMonth()+1,e=new Date().getFullYear();let a=0,s=0,r=0;w.clients.forEach(o=>{if(o.totalDebt&&parseFloat(o.totalDebt)>0&&s++,o.dobMonth==t&&r++,o.createdAt){const i=new Date(o.createdAt);i.getMonth()+1===t&&i.getFullYear()===e&&a++}}),document.getElementById("kpi-total").textContent=w.clients.length,document.getElementById("kpi-novos").textContent=a,document.getElementById("kpi-devendo").textContent=s,document.getElementById("kpi-niver").textContent=r}function ye(){sd();const t=document.getElementById("list-container");let e=w.clients;if(w.filters.search){const a=w.filters.search.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(w.filters.status==="devendo")e=e.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(w.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;e=e.filter(s=>s.dobMonth==a)}else if(w.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();e=e.filter(r=>{if(!r.createdAt)return!1;const o=new Date(r.createdAt);return o.getMonth()+1===a&&o.getFullYear()===s})}if(w.filters.hasLoyalty&&(e=e.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),w.filters.inactiveDays){const a=parseInt(w.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),e=e.filter(r=>{if(!r.lastVisit&&!r.createdAt)return!1;let o;if(r.lastVisit){const i=r.lastVisit.seconds||r.lastVisit._seconds;o=i?new Date(i*1e3):new Date(r.lastVisit)}else o=new Date(r.createdAt);return o<s})}if(e.sort((a,s)=>{let r,o;switch(w.sortConfig.key){case"name":return r=(a.name||"").toLowerCase(),o=(s.name||"").toLowerCase(),w.sortConfig.direction==="asc"?r.localeCompare(o):o.localeCompare(r);case"contact":return r=a.phone||"",o=s.phone||"",w.sortConfig.direction==="asc"?r.localeCompare(o):o.localeCompare(r);case"lastVisit":r=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,o=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":r=parseFloat(a.totalDebt)||0,o=parseFloat(s.totalDebt)||0;break;default:r=a.name,o=s.name}return r<o?w.sortConfig.direction==="asc"?-1:1:r>o?w.sortConfig.direction==="asc"?1:-1:0}),e.length===0){t.innerHTML=`
            ...
            </div>`;return}t.innerHTML=e.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,r=Ka(a.lastVisit),o=pr(a.phone),i=new Date().getMonth()+1,n=a.dobMonth==i,l=w.selectedIds.has(a.id);let d="";return n&&(d+='<span class="bg-indigo-50 text-indigo-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-indigo-100 uppercase tracking-wider">🎂 Niver</span> '),a.loyaltyPoints>0&&(d+=`<span class="bg-amber-50 text-amber-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-amber-100 uppercase tracking-wider"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
        ...
        `}).join("")}function od(){_t&&da.removeEventListener("click",_t),_t=o=>{const i=o.target;if(i.classList.contains("item-checkbox")){const u=i.value;i.checked?w.selectedIds.add(u):w.selectedIds.delete(u),ea(),o.stopPropagation();return}if(i.id==="select-all-toggle"){const u=i.checked,c=document.querySelectorAll(".item-checkbox");w.selectedIds.clear(),c.forEach(p=>{p.checked=u,u&&w.selectedIds.add(p.value)}),ea(),o.stopPropagation();return}const n=i.closest("[data-sort]");if(n){const u=n.dataset.sort;w.sortConfig.key===u?w.sortConfig.direction=w.sortConfig.direction==="asc"?"desc":"asc":(w.sortConfig.key=u,w.sortConfig.direction="asc"),ye();return}const l=i.closest("[data-action]");if(l){const u=l.dataset.action,c=l.dataset.id;if(u==="new-client"){es(null);return}if(u==="open-modal"){es(c);return}if(u==="whatsapp"){o.stopPropagation();const p=l.dataset.phone;window.open(`https://wa.me/55${p}`,"_blank");return}if(u==="export-excel"){md();return}}const d=i.closest("[data-filter]");d&&(document.querySelectorAll("[data-filter]").forEach(u=>u.classList.remove("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300")),d.classList.add("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300"),w.filters.status=d.dataset.filter,ye())},da.addEventListener("click",_t);const t=document.getElementById("cancel-selection-btn");t&&t.addEventListener("click",()=>{w.selectedIds.clear();const o=document.getElementById("select-all-toggle");o&&(o.checked=!1),document.querySelectorAll(".item-checkbox").forEach(i=>i.checked=!1),ea()});const e=document.getElementById("batch-delete-btn");e&&e.addEventListener("click",rd),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",i=>{const n=i.target.closest("label");i.target.checked?(w.filterEstablishmentIds.add(i.target.value),n.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.remove("border-gray-200","text-gray-600")):(w.filterEstablishmentIds.delete(i.target.value),n.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.add("border-gray-200","text-gray-600")),ys()})});const a=document.getElementById("search-input");a&&a.addEventListener("input",o=>{w.filters.search=o.target.value,ye()});const s=document.getElementById("filter-inactive");s&&s.addEventListener("input",o=>{w.filters.inactiveDays=o.target.value,ye()});const r=document.getElementById("filter-loyalty");r&&r.addEventListener("change",o=>{w.filters.hasLoyalty=o.target.checked,ye()})}function ea(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count");if(!t||!e)return;const a=w.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}async function rd(){const t=w.selectedIds.size;if(!(t===0||!await X("Excluir Clientes",`Deseja realmente excluir permanentemente ${t} cliente(s)? Esta ação não pode ser desfeita.`)))try{const a=Array.from(w.selectedIds).map(r=>Eo(r));await Promise.all(a),f("Sucesso",`${t} cliente(s) excluído(s) com sucesso.`,"success"),w.selectedIds.clear(),ea();const s=document.getElementById("select-all-toggle");s&&(s.checked=!1),await ys()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns clientes.","error")}}function es(t=null){t?(w.selectedClient=w.clients.find(s=>s.id===t),w.selectedClient.isNew=!1):w.selectedClient={isNew:!0,id:"",name:"",phone:"",email:"",cpf:"",gender:"",dobDay:"",dobMonth:"",source:"",notes:"",loyaltyPoints:0,totalDebt:0},w.activeTab="profile",w.historyData={appointments:[],sales:[],loyaltyLog:[]};let e=document.getElementById("client-details-modal-overlay");e||(e=document.createElement("div"),e.id="client-details-modal-overlay",e.className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-gray-900/60 backdrop-blur-sm sm:p-4 animate-fade-in",e.innerHTML='<div class="bg-gray-50 w-full sm:w-[90vw] h-[90vh] sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col relative animate-slide-up sm:animate-scale-in rounded-t-2xl" id="client-modal-content"></div>',e.onclick=s=>{s.target===e&&$t()},document.body.appendChild(e),document.body.classList.add("overflow-hidden"));const a=e.querySelector("#client-modal-content");a.innerHTML=st(w.selectedClient),ot(a,w.selectedClient)}function $t(){const t=document.getElementById("client-details-modal-overlay");t&&t.remove(),document.body.classList.remove("overflow-hidden"),w.modalOpen=!1,w.selectedClient=null,ye()}function st(t){const e=t.isNew,a=`
    ...
    `;let s="";return w.activeTab==="profile"?s=id(t):w.activeTab==="appointments"?s=nd():w.activeTab==="history"?s=ld():w.activeTab==="loyalty"&&(s=dd(t)),`
            ...
            <div class="bg-indigo-600 px-4 py-4 sm:px-6 sm:py-5 text-white relative flex-shrink-0 w-full shadow-md z-20">
                ...
                <div class="flex items-center gap-4 sm:gap-5">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white text-indigo-600 flex items-center justify-center text-2xl font-black shadow-lg flex-shrink-0">
                        ${e?'<i class="bi bi-person-plus-fill"></i>':Za(t.name)}
                    </div>
    ...
    `}function nd(t){let e=w.historyData.appointments||[];return e.sort((a,s)=>new Date(s.startTime)-new Date(a.startTime)),`
        <div class="space-y-2">
    ...
    `}function ld(t){let e=w.historyData.sales||[];e.sort((r,o)=>new Date(o.date)-new Date(r.date));const a=e.reduce((r,o)=>r+(Number(o.totalAmount)||0),0),s=e.length>0?a/e.length:0;return`
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-3 mb-2">
                <div class="bg-emerald-50 p-3 rounded-xl border border-emerald-100 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-emerald-700 mt-0.5">${La(a)}</span>
                </div>
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-gray-800 mt-0.5">${La(s)}</span>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-3 flex justify-between items-center shadow-sm hover:bg-gray-50 cursor-pointer transition-colors" data-go-comanda="true" data-id="${r.id}">
                    ...
                    <div class="text-right">
                        <p class="font-black text-emerald-600 text-xs">${La(r.totalAmount)}</p>
    ...
    `}function dd(t){const e=w.historyData.loyaltyLog||[];return e.sort((a,s)=>new Date(s.date)-new Date(a.date)),`
        <div class="space-y-4">
    ...
    `}function ot(t,e){if(t.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const r=s.dataset.tab;if(w.activeTab===r)return;w.activeTab=r;const o=document.getElementById("client-modal-content");o&&(o.innerHTML=st(e),ot(o,e)),r!=="profile"&&!w.historyLoading&&w.historyData.appointments.length===0&&await cd(e.id)}}),w.activeTab==="profile"){const s=t.querySelector("#form-edit-client");s&&(s.onsubmit=ud);const r=t.querySelector("#btn-delete-client");r&&(r.onclick=pd)}if(w.activeTab==="loyalty"){const s=t.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>bd(e))}t.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=()=>{$t(),ae("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),t.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=()=>{$t(),ae("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const a=t.querySelector("#btn-close-modal");a&&(a.onclick=$t)}async function cd(t){const e=w.selectedClient;if(!e||!e.phone)return;w.historyLoading=!0;const a=document.getElementById("client-modal-content");a&&(a.innerHTML=st(e),ot(a,e));try{const s=new Date;s.setMonth(s.getMonth()+12);const r=new Date;r.setFullYear(r.getFullYear()-5);let o=`/api/appointments/${m.establishmentId}?startDate=${r.toISOString()}&endDate=${s.toISOString()}&clientPhone=${encodeURIComponent(pr(e.phone))}&limit=50`;const i=await C(o);w.historyData.appointments=i,w.historyData.sales=i.filter(l=>l.status==="completed").map(l=>({id:l.id,date:l.startTime,totalAmount:l.totalAmount||0,items:l.comandaItems||l.services||[]}));const n=[];i.forEach(l=>{l.status==="completed"&&l.loyaltyPointsEarned>0&&n.push({type:"earn",points:l.loyaltyPointsEarned,date:l.startTime,description:"Venda finalizada"}),l.loyaltyRedemption&&n.push({type:"redemption",points:l.loyaltyRedemption.cost||0,date:l.startTime,description:`Resgate: ${l.loyaltyRedemption.name}`})}),w.historyData.loyaltyLog=n}catch(s){console.error("Erro histórico",s)}finally{w.historyLoading=!1;const s=document.getElementById("client-modal-content");s&&w.selectedClient&&(s.innerHTML=st(w.selectedClient),ot(s,w.selectedClient))}}async function ud(t){t.preventDefault();const e=new FormData(t.target),a=Object.fromEntries(e.entries());a.establishmentId=m.establishmentId,a.dobDay&&(a.dobDay=parseInt(a.dobDay)),a.dobMonth&&(a.dobMonth=parseInt(a.dobMonth));try{if(w.selectedClient.isNew){const s=await $o(a);w.clients.unshift(s),f("Sucesso","Cliente cadastrado com sucesso!","success"),w.selectedClient=s,es(s.id)}else{await So(w.selectedClient.id,a),Object.assign(w.selectedClient,a);const s=w.clients.findIndex(o=>o.id===w.selectedClient.id);s!==-1&&(w.clients[s]=w.selectedClient),f("Sucesso","Dados salvos com sucesso!","success");const r=document.getElementById("client-modal-content");r&&(r.innerHTML=st(w.selectedClient),ot(r,w.selectedClient))}ws(),ye()}catch(s){f("Erro",s.message,"error")}}async function pd(){if(await X("Excluir Cliente","Tem certeza? O histórico será apagado e não pode ser desfeito."))try{await Eo(w.selectedClient.id),w.clients=w.clients.filter(t=>t.id!==w.selectedClient.id),w.selectedClient=null,f("Sucesso","Cliente removido com sucesso.","success"),$t(),ws(),ye()}catch(t){f("Erro",t.message,"error")}}function bd(t){const e=t.loyaltyPoints||0,a=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const u={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,cnpj:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};ut(u,d)})}function fd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const s=e.querySelector("#newPassword").value,r=e.querySelector("#confirmPassword").value;if(s!==r){f("Erro","As senhas não coincidem.","error");return}const o=e.querySelector('button[form="change-password-form"]');o.disabled=!0,o.textContent="A Salvar...";try{const i=me.currentUser;if(i)await Ar(i,s),f("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum utilizador logado encontrado.")}catch(i){f("Erro",`Não foi possível alterar a senha: ${i.message}`,"error")}finally{o.disabled=!1,o.textContent="Salvar Nova Senha"}})}function xd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const v=e.querySelector("#mockup-screen-wrapper"),y=e.querySelector("#mockup-screen"),$=e.querySelector("#previewPrimaryColorInput"),P=e.querySelector("#previewBgColorInput"),A=e.querySelector("#previewTextColorInput"),S=e.querySelector("#previewTitleColorInput"),L=e.querySelector("#typographyInput"),z=e.querySelector("#establishmentWelcomeMessage"),F=e.querySelector("#mockup-welcome"),E=e.querySelector("#socialInstagram"),I=e.querySelector("#socialWhatsapp"),T=e.querySelector("#socialFacebook"),N=e.querySelector("#prevTemplate"),H=e.querySelector("#nextTemplate"),U=e.querySelector("#templateNameDisplay"),D=e.querySelector("#selectedTemplateId"),W=Q=>{const G=ie[Q];v.style.opacity="0.3",v.style.transform="scale(0.96)",setTimeout(()=>{$.value=G.primary,P.value=G.bg,A.value=G.text,S.value=G.titleColor||G.text,L.value=G.font,e.querySelectorAll('input[name="buttonStyle"]').forEach(be=>{be.checked=be.value===G.btn}),D.value=G.id,U.textContent=G.name,y.style.setProperty("--preview-primary",G.primary),y.style.setProperty("--preview-bg",G.bg),y.style.setProperty("--preview-text",G.text),y.style.setProperty("--preview-title-color",G.titleColor||G.text),y.style.setProperty("--preview-font",G.font),y.style.setProperty("--preview-btn-radius",g(G.btn)),y.style.setProperty("--preview-card-bg",G.cardBg),y.style.setProperty("--preview-card-border",G.cardBorder),v.style.opacity="1",v.style.transform="scale(1)"},300)};N.addEventListener("click",()=>{b=(b-1+ie.length)%ie.length,W(b)}),H.addEventListener("click",()=>{b=(b+1)%ie.length,W(b)}),$.addEventListener("input",Q=>y.style.setProperty("--preview-primary",Q.target.value)),P.addEventListener("input",Q=>y.style.setProperty("--preview-bg",Q.target.value)),A.addEventListener("input",Q=>y.style.setProperty("--preview-text",Q.target.value)),S.addEventListener("input",Q=>y.style.setProperty("--preview-title-color",Q.target.value)),L.addEventListener("change",Q=>y.style.setProperty("--preview-font",Q.target.value)),e.querySelectorAll('input[name="buttonStyle"]').forEach(Q=>{Q.addEventListener("change",G=>{G.target.checked&&y.style.setProperty("--preview-btn-radius",g(G.target.value))})}),z.addEventListener("input",Q=>F.textContent=Q.target.value||"Mensagem...");const te=()=>{e.querySelector("#mockup-insta-icon").classList.toggle("hidden",!E.value.trim()),e.querySelector("#mockup-whats-icon").classList.toggle("hidden",!I.value.trim()),e.querySelector("#mockup-face-icon").classList.toggle("hidden",!T.value.trim())};[E,I,T].forEach(Q=>Q.addEventListener("input",te));const Z=e.querySelector("#establishmentLogoInput"),pt=e.querySelector("#establishmentBgInput"),Mt=e.querySelector("#establishmentLogoBase64"),qe=e.querySelector("#establishmentBackgroundImageBase64");e.querySelector("#triggerLogoUpload").addEventListener("click",Q=>{Q.target.id!=="establishmentLogoInput"&&Z.click()}),Z.onchange=async Q=>{const G=Q.target.files[0];if(G){const be=await zs(G,300,.9);e.querySelector("#establishmentLogoPreview").src=be,e.querySelector("#mockup-logo").src=be,Mt.value=be}},e.querySelector("#triggerBannerUpload").addEventListener("click",Q=>{Q.target.id!=="establishmentBgInput"&&pt.click()}),pt.onchange=async Q=>{const G=Q.target.files[0];if(G){const be=await zs(G,1280,.8);e.querySelector("#establishmentBgPreview").src=be,e.querySelector("#establishmentBgPreview").classList.remove("hidden"),e.querySelector("#establishmentBgPlaceholder").classList.add("hidden"),qe.value=be,e.querySelector("#mockup-banner").src=be,e.querySelector("#mockup-banner").classList.remove("hidden"),e.querySelector("#mockup-banner-placeholder").classList.add("hidden")}},e.querySelector("#branding-form").addEventListener("submit",Q=>{Q.preventDefault();let G="rounded";e.querySelectorAll('input[name="buttonStyle"]').forEach(Ss=>{Ss.checked&&(G=Ss.value)});const be={logo:Mt.value,backgroundImage:qe.value,welcomeMessage:z.value,templateId:D.value,primaryColor:$.value,backgroundColor:P.value,textColor:A.value,titleColor:S.value,typography:L.value,buttonStyle:G,socialLinks:{instagram:E.value.trim(),whatsapp:I.value.trim(),facebook:T.value.trim()}};ut(be,Q)})}function vd(t,e){const a=t.urlId||se;let s=window.location.origin;(s.includes("localhost")||s.includes("capacitor://")||s.includes("127.0.0.1"))&&(s="https://www.kairosagenda.com.br");const r=h(`${s}/agendar?id=${a}`),o=t.publicBookingEnabled||!1,i=o?"Agendamento Online ATIVO":"Agendamento Online INATIVO",n=o?"text-green-600":"text-red-600";e.innerHTML=`
    ...
    `;const a=e.querySelector("#establishmentTimezone");t.timezone&&(a.value=t.timezone);const s=e.querySelector("#establishmentWorkingHoursContainer"),r=t.workingHours||{};Object.keys(Ba).forEach(o=>{const i=r[o]||{},n=Ba[o],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",o=>{const i=o.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),e.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const i={};Object.keys(Ba).forEach(l=>{i[l]={active:e.querySelector(`#est-${l}-active`).checked,start:e.querySelector(`#est-${l}-start`).value,end:e.querySelector(`#est-${l}-end`).value,breakStart:e.querySelector(`#est-${l}-breakStart`).value,breakEnd:e.querySelector(`#est-${l}-breakEnd`).value}});const n=e.querySelector("#establishmentTimezone").value;ut({workingHours:i,timezone:n},o)})}function mr(t,e){const a=!!t.whatsappInstance;e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;const n=e.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const u=document.createElement("div");u.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const c=d.type||"money",p=d.itemId||"",b=d.reward||"",g=d.discount||"",v=d.points||d.costPoints||"";u.innerHTML=`
        ...
        `;const y=u.querySelector(".type-select"),$=u.querySelector(".item-select"),P=u.querySelector(".desc-input"),A=u.querySelector(".discount-input"),S=L=>{$.innerHTML='<option value="">Selecione...</option>';let z=[];L==="service"?z=r:L==="product"?z=o:L==="package"&&(z=i),z.forEach(F=>{const E=F.id===p,I=F.name||F.title||"Sem nome",T=F.price||F.salePrice||0;$.innerHTML+=`<option value="${F.id}" data-price="${T}" ${E?"selected":""}>${h(I)}</option>`})};return c!=="money"&&S(c),y.addEventListener("change",L=>{const z=L.target.value;z==="money"?($.classList.add("hidden"),P.classList.remove("hidden"),P.value="",A.value=""):($.classList.remove("hidden"),P.classList.add("hidden"),S(z),A.value="")}),$.addEventListener("change",L=>{const z=L.target.selectedOptions[0];if(z&&z.value){P.value=z.text;const F=z.dataset.price;F&&(A.value=parseFloat(F).toFixed(2))}}),u};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),e.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const u=d.target.closest(".remove-loyalty-tier");u&&u.closest(".loyalty-tier-row").remove()}),e.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const u=Array.from(e.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(p=>{const b=p.querySelector(".type-select").value,g=b==="money"?null:p.querySelector(".item-select").value;let v=b==="money"?p.querySelector(".desc-input").value:p.querySelector(".item-select").options[p.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,type:b,itemId:g,reward:v,name:v,discount:parseFloat(p.querySelector('input[data-field="discount"]').value)||0}}),c={loyaltyProgram:{enabled:e.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(e.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:u.filter(p=>p.points>0&&p.reward)}};ut(c,d)})}async function kd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([wa(se),ms(se)]),r=t.financialIntegration||{},o=t.commissionConfig||{},i=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=ze(a,r.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=ze(s,r.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=ze(a,i.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=ze(s,i.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=ze(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=ze(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};ut(s,a)})}function $d(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `}function Sd(t,e){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${t.name})`;e.innerHTML=`
    ...
    `,Re.querySelector('button[data-action="back-to-menu"]').addEventListener("click",r=>{r.preventDefault(),gr({id:se})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":gd(K,s);break;case"change-password":fd(K,s);break;case"change-email":xd(K,s);break;case"branding":hd(K,s);break;case"booking":vd(K,s);break;case"working-hours":yd(K,s);break;case"whatsapp-bot":mr(K,s);break;case"loyalty":await wd(K,s);break;case"financial":await kd(K,s);break;case"support":$d(K,s);break;case"cancellation":Sd(K,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function gr(t={}){Re.innerHTML=`
    ...
    `;try{se=t.id||m.establishmentId,K=await Be(se);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
               ...
               </button>`:"",a=K.isMatriz||!K.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=br();Re.innerHTML=`
        ...
        `,Re.querySelectorAll("div[data-section]").forEach(r=>{r.addEventListener("click",o=>{Id(r.dataset.section)})}),Re.querySelectorAll(".module-toggle").forEach(r=>{r.addEventListener("change",async()=>{const o=r.dataset.module;try{const n={...(await Be(se)).modules,[o]:r.checked};await ns(se,{modules:n}),f("Módulos","Módulos atualizados com sucesso.","success")}catch(i){r.checked=!r.checked,f("Erro",i.message,"error")}})})}catch(e){Re.innerHTML=`
        ...
        `}}function Ld(t){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `).join("")}const St=document.getElementById("content");async function Ke(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await ha(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),i=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,n=i.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",i.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${h(l)} (${d.length})</h4>`;if(d.length>1){const b=JSON.stringify(d.map(g=>g.id));p+=`<button data-action="batch-delete-blockage" data-ids='${b}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",u.innerHTML=p,d.forEach(b=>{const g=new Date(b.startTime),v=new Date(b.endTime),y=g.toLocaleDateString("pt-BR"),$=v.toLocaleDateString("pt-BR"),A=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${y===$?`${y} | ${g.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${y} às ${g.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${$} às ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;u.innerHTML+=A}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Cd(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,r=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,i=e.querySelector("#blockageEndTime").value,n={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${i}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await va(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),Ke(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Dd(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,r=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,i=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:m.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${i}:00`).toISOString(),reason:n};return va(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&Ke(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Td(t){St.addEventListener("submit",e=>{e.target.id==="blockageForm"&&Cd(e),e.target.id==="batchBlockageForm"&&Dd(e)}),St.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Ke(t)}),St.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")ae("profissionais-section");else if(s==="delete-blockage"){if(await X("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await ds(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),Ke(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await X("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Lo(r),f("Sucesso",`${r.length} bloqueios removidos.`,"success"),Ke(t)}catch(i){f("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function Pd(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){St.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=h(a);St.innerHTML=`
        <section>
        ...
        </section>`,Td(e),await Ke(e);const r=document.getElementById("batchProfSelectionContainer");try{const o=await ke(m.establishmentId);r.innerHTML=o.map(i=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const Bd=t=>C(`/api/users/${t}`),Ad=t=>C("/api/users",{method:"POST",body:JSON.stringify(t)}),Md=(t,e)=>C(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),qd=t=>C(`/api/users/${t}`,{method:"DELETE"}),jd=(t,e)=>C(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),Nd=(t,e)=>C(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),bt=document.getElementById("content"),Rd={"Operação & Atendimento":{"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas","ausencias-section":"Ausências e Bloqueios"},"Financeiro & Vendas":{"financial-section":"Financeiro (ERP)","sales-report-section":"Relatório de Vendas","commissions-section":"Comissões","packages-section":"Planos e Pacotes"},"Cadastros Base":{"clientes-section":"Clientes","profissionais-section":"Profissionais","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores"},Administração:{"relatorios-section":"Relatórios Gerais","estabelecimento-section":"Configurações da Empresa","users-section":"Usuários e Acessos"}},Fd={view:"Visualizar",create:"Criar",edit:"Editar"},_s={owner:{label:"Proprietário",color:"bg-rose-100 text-rose-700 border-rose-200"},group_admin:{label:"Admin da Rede",color:"bg-purple-100 text-purple-700 border-purple-200"},company_admin:{label:"Gestor Matriz",color:"bg-blue-100 text-blue-700 border-blue-200"},branch_manager:{label:"Gestor Filial",color:"bg-orange-100 text-orange-700 border-orange-200"},professional:{label:"Profissional",color:"bg-slate-100 text-slate-600 border-slate-200"}};let Vt=null,Ut=null,Ze=null;function fr(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}function Hd(t){const e=document.getElementById("usersListContainer");if(!e)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const s=a?"Nenhum usuário encontrado na base.":"Nenhum usuário ativo neste contexto.";e.innerHTML=`
        ...
        `}).join("")}function xr(){const e=document.getElementById("showInactiveUsersToggle")?.checked?m.users:m.users.filter(a=>a.status==="active");Hd(e)}function Od(t={}){let e="",a=!1;for(const[s,r]of Object.entries(Rd)){const o=Object.entries(r).filter(([i,n])=>{const l=i.replace("-section","");return!(m.enabledModules&&m.enabledModules[l]===!1)});o.length!==0&&(a=!0,e+=`
        ...
        `,o.forEach(([i,n])=>{const l=i==="agenda-section"||i==="comandas-section",d=t[i]?.view_all_prof===!0,u=Object.entries(Fd).map(([p,b])=>`
        ...
        `}),r+="</div>",r}async function Us(t=null){document.getElementById("user-list-view").classList.add("hidden");const e=document.getElementById("user-form-view");e.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{const p=fr().map(v=>ke(v)),b=await Promise.all(p),g=new Map;b.flat().forEach(v=>g.set(v.id,v)),a=Array.from(g.values()),m.professionals=a}catch(c){console.warn("Profissionais não carregados",c)}if(["owner","group_admin","company_admin"].includes(m.userRole)&&!Ze)try{const c=await ve();c&&(Ze=c)}catch(c){console.error("Falha ao buscar hierarquia",c),Ze={companies:[],branches:[]}}const s=t!==null,r=s&&t.role==="owner",o=e.querySelector("#userFormTitle");o.innerHTML=s?`<i class="bi bi-person-lines-fill mr-2 text-indigo-600"></i>Editar Perfil: ${t.name}`:'<i class="bi bi-person-plus-fill mr-2 text-indigo-600"></i>Novo Acesso';const i=e.querySelector("#userForm");i.innerHTML=`
    ...
    `;const n=e.querySelectorAll(".tab-btn"),l=e.querySelectorAll(".tab-content");n.forEach(c=>{c.addEventListener("click",()=>{n.forEach(b=>{b.classList.remove("active","text-indigo-600","border-indigo-600"),b.classList.add("text-slate-400","border-transparent")}),l.forEach(b=>b.classList.add("hidden")),c.classList.add("active","text-indigo-600","border-indigo-600"),c.classList.remove("text-slate-400","border-transparent");const p=c.getAttribute("data-tab");e.querySelector(`#${p}`).classList.remove("hidden")})});const d=i.querySelector("#userRole"),u=i.querySelector("#hierarchySelectorContainer");if(d&&u){d.addEventListener("change",p=>{const b={...t,role:p.target.value};u.innerHTML=Vs(b),c()});const c=()=>{u.querySelectorAll(".company-checkbox").forEach(p=>{p.addEventListener("change",b=>{b.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(y=>{y.checked=b.target.checked;const $=y.nextElementSibling.querySelector(".dot");$&&(b.target.checked?$.classList.add("transform","translate-x-4"):$.classList.remove("transform","translate-x-4"))})})})};c()}if(i.querySelectorAll(".permission-checkbox").forEach(c=>{if(c.addEventListener("change",p=>{const b=p.target.nextElementSibling,g=b.nextElementSibling;p.target.checked?(b.classList.replace("bg-slate-200","bg-indigo-500"),g.classList.add("transform","translate-x-4")):(b.classList.replace("bg-indigo-500","bg-slate-200"),g.classList.remove("transform","translate-x-4"))}),c.checked){const p=c.nextElementSibling,b=p.nextElementSibling;p.classList.replace("bg-slate-200","bg-indigo-500"),b.classList.add("transform","translate-x-4")}}),i.onsubmit=async c=>{c.preventDefault();const p=i.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Processando...';const g={};i.querySelectorAll(".permission-checkbox").forEach(S=>{const L=S.dataset.module,z=S.dataset.permission;g[L]||(g[L]={}),g[L][z]=S.checked});const v=i.querySelector("#userProfessionalId").value||null,y=i.querySelector("#userRole")?.value||"professional",$=[],P=[];if(y!=="group_admin"&&y!=="owner"&&i.querySelector(".company-checkbox")&&(i.querySelectorAll(".company-checkbox:checked").forEach(S=>{$.push({id:S.value,name:S.dataset.name})}),i.querySelectorAll(".branch-checkbox:checked").forEach(S=>{P.push({id:S.value,name:S.dataset.name,companyId:S.dataset.companyId})}),P.length===0))return p.disabled=!1,p.innerHTML=b,f("Atenção","Selecione pelo menos uma filial na aba de Acesso.","warning");const A={name:i.querySelector("#userName").value,permissions:g,professionalId:v,role:y,accessibleCompanies:$,accessibleEstablishments:P};try{if(s){const S=i.querySelector("#userEmail").value;t?.email!==S&&!r&&(A.email=S),await Md(t.id,A),f("Sucesso","Usuário atualizado.","success")}else A.email=i.querySelector("#userEmail").value,A.password=i.querySelector("#userPassword").value,await Ad(A),f("Sucesso","Novo usuário cadastrado na plataforma.","success");ca()}catch(S){f(`Erro: ${S.message}`,"error"),p.disabled=!1,p.innerHTML=b}},s){const c=i.querySelector("#btn-show-password"),p=i.querySelector("#password-form");c&&p&&(c.onclick=()=>{c.classList.add("hidden"),p.classList.remove("hidden")},i.querySelector("#btn-cancel-pwd").onclick=()=>{c.classList.remove("hidden"),p.classList.add("hidden"),p.querySelector("#userNewPassword").value=""},i.querySelector("#btn-save-pwd").onclick=async b=>{const g=b.target,v=p.querySelector("#userNewPassword").value;if(!v||v.length<6)return f("Aviso","Senha deve ter no mínimo 6 caracteres.","warning");if(await X("Alterar Senha","O usuário usará esta nova senha no próximo acesso. Confirma?"))try{g.disabled=!0,g.textContent="Aguarde...",await jd(t.id,v),f("Sucesso","Senha alterada com segurança.","success"),c.classList.remove("hidden"),p.classList.add("hidden")}catch(y){f("Erro",y.message,"error")}finally{g.disabled=!1,g.textContent="Salvar Senha"}})}}async function zd(){const t=document.getElementById("usersListContainer");t.innerHTML='<div class="col-span-full py-16 flex justify-center"><div class="loader"></div></div>';try{const e=fr(),a=e.map(l=>Bd(l)),s=e.map(l=>ke(l)),r=await Promise.all(a),o=await Promise.all(s),i=new Map;r.flat().forEach(l=>i.set(l.id,l)),m.users=Array.from(i.values());const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),m.professionals=Array.from(n.values()),xr()}catch{f("Erro ao carregar base de usuários.","error"),t.innerHTML='<p class="col-span-full text-center font-bold text-red-500 bg-red-50 p-6 rounded-2xl">Falha de comunicação com o servidor de acessos.</p>'}}async function ca(){bt.innerHTML=`
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=ts.transactions[l];d&&Js(d)})}),i.innerHTML=a.map((n,l)=>{const d=h(n.client),u=h(n.items),c=h(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ts.transactions[l];d&&Js(d)})})}async function Qs(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,r=a.value;if(!s||!r)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,i=await oa({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:o});ts=i,t.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Qs),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${r}`;Ud(o,"transactionsTable")});try{const s=await yn(m.establishmentId),r=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const i=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=h(o.closedByName||"N/A");r.innerHTML+=`<option value="${o.id}">${n} - ${i}</option>`})}catch{f("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Qs()}const Qd=document.getElementById("content");let k={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],suppliers:[],clients:[],professionals:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Wt=null,Jt=null;function ks(t){const e=new Map,a=[];return t&&(t.forEach(s=>e.set(s.id,{...s,children:[]})),e.forEach(s=>{s.parentId&&e.has(s.parentId)?e.get(s.parentId).children.push(s):a.push(s)})),a}function hr(t){if(!t)return{day:"--",month:"---",full:"--/--/----"};const[e,a,s]=t.split("-"),r=new Date(e,a-1,s),o=String(r.getDate()).padStart(2,"0"),i=r.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:o,month:i,full:r.toLocaleDateString("pt-BR")}}function he(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t)}function rt(t,e){if(e==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,r,o]=t.split("-");return new Date(s,r-1,o)<a}function Gd(t,e,a){if(!t)return;if(!e||e.length===0){t.innerHTML=`
        ...
        `};t.innerHTML=e.map(r=>s(r)).join("")}async function Gs(t){const e=document.getElementById("genericModal"),a=t==="nature",s=a?"Plano de Naturezas":"Centros de Custo",r=a?wa:ms,o=a?Sn:En,i=a?"natures":"costCenters";e.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",e.innerHTML=`
    ...
    `,wr()}function Xd(){const t=k.currentTab==="receivables",e=t?k.receivables:k.payables;let a=e;if(k.statusFilter!=="all"&&(a=e.filter(n=>{const l=rt(n.dueDate,n.status);return k.statusFilter==="overdue"?l:k.statusFilter==="pending"?n.status==="pending"&&!l:n.status===k.statusFilter})),k.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(k.searchQuery)||n.entity&&n.entity.toLowerCase().includes(k.searchQuery)||n.notes&&n.notes.toLowerCase().includes(k.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map(k.natures.map(n=>[n.id,n.name])),r=new Map(k.costCenters.map(n=>[n.id,n.name])),o=new Map(k.establishments.map(n=>[n.id,n])),i=a.map(n=>{const l=n.status==="paid",d=rt(n.dueDate,n.status);let u=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const c=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?r.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=o.get(n.establishmentId),g=b?b.name:"Atual",v=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:g,Natureza:c,"Centro de Custo":p,Origem:v,"Documento / NFS":n.documentNumber||"",Status:u,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(i),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const u=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,u)}catch(n){console.error("Erro ao exportar:",n),f("Erro","Não foi possível exportar para Excel.","error")}}function Kd(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i.bi-chevron-expand, i.bi-chevron-up, i.bi-chevron-down");if(!e)return;t.dataset.sort===k.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=k.sortAsc?"bi bi-chevron-up ml-1 text-indigo-600 text-[11px] font-black":"bi bi-chevron-down ml-1 text-indigo-600 text-[11px] font-black"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-chevron-expand ml-1 opacity-40 text-[10px] font-black")})}function yr(){document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",i=>{const n=i.currentTarget.dataset.sort;k.sortCol===n?k.sortAsc=!k.sortAsc:(k.sortCol=n,k.sortAsc=!0),Et()})});const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const i=o.target.checked,n=document.querySelectorAll(".item-checkbox");k.selectedIds.clear(),n.forEach(l=>{l.checked=i,i&&k.selectedIds.add(l.value)}),Ye()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{k.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Ye()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=k.selectedIds.size;if(o===0)return;if(await X("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const n=k.currentTab==="payables"?"payables":"receivables";await zo(n,Array.from(k.selectedIds)),f("Sucesso",`${o} itens excluídos.`,"success"),k.selectedIds.clear(),Ye(),Le()}catch{f("Erro","Falha ao excluir itens.","error")}}),document.getElementById("custom-date-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),i=document.getElementById("custom-date-btn");k.isAdvancedFilterOpen=!k.isAdvancedFilterOpen,k.isAdvancedFilterOpen?(o.classList.remove("hidden"),i.classList.add("bg-gray-900","text-white","border-gray-900"),i.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),i.classList.remove("bg-gray-900","text-white","border-gray-900"),i.classList.add("bg-white","text-gray-600","border-gray-200"))});const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",Xd);const a=document.getElementById("settings-btn");a&&a.addEventListener("click",tc),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(20),Xs(i.target.closest("button").dataset.type)})});const s=document.getElementById("tab-receivables"),r=document.getElementById("tab-payables");s.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),Ys("receivables")}),r.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),Ys("payables")}),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-gray-900","bg-blue-600","bg-emerald-600","bg-red-600","text-white"),l.classList.add("bg-white","text-gray-600")});const n=i.target.dataset.status;n==="all"?i.target.classList.add("bg-gray-900","text-white"):n==="pending"?i.target.classList.add("bg-blue-600","text-white"):n==="paid"?i.target.classList.add("bg-emerald-600","text-white"):n==="overdue"&&i.target.classList.add("bg-red-600","text-white"),i.target.classList.remove("bg-white","text-gray-600"),k.statusFilter=n,Et()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=i.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=u.toISOString().split("T")[0],k.startDate=d.toISOString().split("T")[0],k.endDate=u.toISOString().split("T")[0],Le()})}),document.getElementById("searchInput").addEventListener("input",o=>{k.searchQuery=o.target.value.toLowerCase(),Et()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",vr(),yr(),Le()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(20),k.startDate=document.getElementById("filterStartDate").value,k.endDate=document.getElementById("filterEndDate").value,k.filterNaturezaId=document.getElementById("filterNaturezaId").value,k.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("custom-date-btn").click(),Le()}),Wt&&document.body.removeEventListener("click",Wt),Wt=o=>{const i=o.target;if(i.classList.contains("item-checkbox")||i.classList.contains("modal-item-checkbox")){const d=i.value||i.dataset.id;i.checked?k.selectedIds.add(d):k.selectedIds.delete(d),Ye(),o.stopPropagation();return}const n=i.closest("button[data-action]");if(n){const{action:d,type:u,id:c}=n.dataset;if(d==="mark-as-paid"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),Zd(u,c);return}if(d==="delete"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(30);const p=n.closest(".financial-row").dataset.item;try{$r(u,JSON.parse(decodeURIComponent(p)))}catch(b){console.error("Parse error on delete",b)}return}if(d==="manage-natures"){o.stopPropagation(),Gs("nature");return}if(d==="manage-cost-centers"){o.stopPropagation(),Gs("cost-center");return}if(d==="close-modal"){o.stopPropagation(),Bt();return}}const l=i.closest(".financial-row");if(l&&document.getElementById("list-container").contains(l)&&!i.closest("button")&&!i.closest(".item-checkbox")){navigator.vibrate&&navigator.vibrate(15);const{type:d}=l.dataset;try{const u=JSON.parse(decodeURIComponent(l.dataset.item));Xs(d,u)}catch(u){console.error("Parse error on card click",u),f("Erro","Os dados deste lançamento não puderam ser lidos corretamente.","error")}}},document.body.addEventListener("click",Wt),Jt&&document.getElementById("genericModal").removeEventListener("click",Jt),Jt=o=>{const i=o.target.closest('button[data-action^="delete-"]');if(i){const n=i.dataset.action.split("-")[1];handleDeleteHierarchyItem(n,i.dataset.id)}o.target===document.getElementById("genericModal")&&Bt()},document.getElementById("genericModal").addEventListener("click",Jt)}function Ye(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=k.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}function Ys(t){k.currentTab=t,k.selectedIds.clear(),Ye(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t==="receivables"?(e.classList.add("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.remove("text-gray-500"),a.classList.remove("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.add("text-gray-500")):(a.classList.add("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.remove("text-gray-500"),e.classList.remove("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.add("text-gray-500")),Et(),kr()}async function Le(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A sincronizar carteira...</p></div>';try{if(k.natures.length===0){const[i,n,l,d,u]=await Promise.all([wa(m.establishmentId),ms(m.establishmentId),Pt(m.establishmentId).catch(()=>[]),lt(m.establishmentId,"",1e3).catch(()=>[]),ke(m.establishmentId).catch(()=>[])]);k.natures=i||[],k.costCenters=n||[],k.suppliers=l||[],k.clients=d||[],k.professionals=u||[],wr()}const a=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).join(","),s={startDate:k.startDate,endDate:k.endDate,establishmentId:a};k.filterNaturezaId!=="all"&&(s.natureId=k.filterNaturezaId),k.filterCostCenterId!=="all"&&(s.costCenterId=k.filterCostCenterId);const[r,o]=await Promise.all([Uo(s),Jo(s)]);k.payables=r.entries||[],k.receivables=o.entries||[],kr(),Et()}catch(e){t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
            ...
            </div>`}}function wr(){const t=s=>{let r='<option value="all">Todas as categorias</option>';const o=ks(s),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");r+=`<option value="${n.id}">${d}${h(n.name)}</option>`,n.children.forEach(u=>i(u,l+1))};return o.forEach(n=>i(n)),r},e=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");e&&(e.innerHTML=t(k.natures)),a&&(a.innerHTML=t(k.costCenters))}function kr(){const t=document.getElementById("summary-section");if(!t)return;const e=k.currentTab==="receivables";let s=e?k.receivables:k.payables;k.searchQuery&&(s=s.filter(u=>u.description&&u.description.toLowerCase().includes(k.searchQuery)||u.entity&&u.entity.toLowerCase().includes(k.searchQuery)||u.notes&&u.notes.toLowerCase().includes(k.searchQuery)));const r=s.reduce((u,c)=>u+c.amount,0),o=s.filter(u=>u.status==="paid").reduce((u,c)=>u+c.amount,0),i=s.filter(u=>u.status==="pending"&&!rt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),n=s.filter(u=>rt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),l=e?"emerald":"red",d=e?"bi-arrow-down-left-circle-fill text-emerald-500":"bi-arrow-up-right-circle-fill text-red-500";t.innerHTML=`
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${he(r)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-blue-600">${he(i)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-${l}-600">${he(o)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black ${n>0?"text-red-600":"text-gray-400"}">${he(n)}</span>
        </div>
    `}function Et(){const t=document.getElementById("list-container");if(!t)return;const e=k.currentTab==="receivables",a=e?k.receivables:k.payables;let s=a;if(k.statusFilter!=="all"&&(s=a.filter(c=>{const p=rt(c.dueDate,c.status);return k.statusFilter==="overdue"?p:k.statusFilter==="pending"?c.status==="pending"&&!p:c.status===k.statusFilter})),k.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(k.searchQuery)||c.entity&&c.entity.toLowerCase().includes(k.searchQuery)||c.notes&&c.notes.toLowerCase().includes(k.searchQuery))),s.sort((c,p)=>{let b=c[k.sortCol],g=p[k.sortCol];return k.sortCol==="dueDate"?(b=new Date(b).getTime(),g=new Date(g).getTime()):(k.sortCol==="description"||k.sortCol==="status")&&(b=b?b.toLowerCase():"",g=g?g.toLowerCase():""),b<g?k.sortAsc?-1:1:b>g?k.sortAsc?1:-1:0}),Kd(),s.length===0){t.innerHTML=`
        ...
        `;return}const r=new Map(k.natures.map(c=>[c.id,c.name])),o=new Map(k.costCenters.map(c=>[c.id,c.name])),i=new Map(k.establishments.map(c=>[c.id,c])),n=e?"receivable":"payable",l=e?"text-emerald-600":"text-red-600",d=e?'<i class="bi bi-arrow-down-left-circle-fill text-emerald-500 text-2xl drop-shadow-sm"></i>':'<i class="bi bi-arrow-up-right-circle-fill text-red-500 text-2xl drop-shadow-sm"></i>',u=e?'<i class="bi bi-arrow-down-left-circle-fill text-emerald-500 text-lg"></i>':'<i class="bi bi-arrow-up-right-circle-fill text-red-500 text-lg"></i>';t.innerHTML=s.map(c=>{const p=hr(c.dueDate),b=c.status==="paid",g=rt(c.dueDate,c.status);let v="";b?v='<span class="text-[9px] md:text-[10px] font-black text-emerald-600 bg-emerald-50 px-2 md:px-2.5 py-1 rounded-lg uppercase tracking-widest"><i class="bi bi-check2-circle"></i> Baixado</span>':g?v='<span class="text-[9px] md:text-[10px] font-black text-red-600 bg-red-50 px-2 md:px-2.5 py-1 rounded-lg uppercase tracking-widest"><i class="bi bi-exclamation-circle"></i> Atraso</span>':v='<span class="text-[9px] md:text-[10px] font-black text-blue-600 bg-blue-50 px-2 md:px-2.5 py-1 rounded-lg uppercase tracking-widest"><i class="bi bi-clock"></i> Pendente</span>';const y=c.naturezaId&&r.get(c.naturezaId)||"Geral",$=c.centroDeCustoId&&o.get(c.centroDeCustoId)||"Geral",P=i.get(c.establishmentId);let A="";if(P){const E=P.type==="Matriz"?"bi-building":"bi-shop";A=`<span class="text-[9px] font-bold text-gray-600 bg-gray-50 px-2 py-1 rounded-lg border border-gray-200 flex items-center max-w-[110px] truncate leading-none shadow-sm" title="${h(P.name)}"><i class="bi ${E} mr-1 opacity-60"></i> ${h(P.name)}</span>`}const S=encodeURIComponent(JSON.stringify(c)),L=k.selectedIds.has(c.id),F=!!c.recurrenceId?'<i class="bi bi-arrow-repeat text-indigo-600 ml-1 text-sm md:text-base bg-indigo-50 rounded-full w-5 h-5 md:w-6 md:h-6 flex items-center justify-center shadow-sm" title="Recorrente"></i>':"";return`
        <div class="financial-row bg-white border border-gray-100 md:border-0 md:border-b md:border-gray-100 hover:bg-gray-50 transition-all cursor-pointer relative flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center p-3.5 md:px-6 md:py-4 mb-3 md:mb-0 rounded-2xl md:rounded-none ${L?"ring-2 md:ring-0 ring-indigo-500 bg-indigo-50/50 md:bg-indigo-50/50":""} ${b?"opacity-70 md:opacity-100":""}"
            ...
            <div class="md:hidden flex items-start gap-3 w-full pr-6">
                ...
                <div class="flex-1 min-w-0 flex flex-col">
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <p class="font-black text-[16px] leading-none flex-shrink-0 ${b?"text-gray-400":l}">${he(c.amount)}</p>
                    </div>
            ...
            <div class="hidden md:flex md:col-span-2 flex-col justify-center min-w-0 pr-4 gap-1.5">
                ...
                <span class="text-[10px] font-semibold text-gray-500 truncate w-max max-w-full"><i class="bi bi-diagram-3 opacity-50 mr-1.5"></i>${$}</span>
            </div>
            ...
            <div class="hidden md:flex md:col-span-2 justify-end items-center pr-6">
                <p class="font-black text-lg ${b?"text-gray-400":l}">${he(c.amount)}</p>
            </div>
        ...
        `}).join("")}async function Zd(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?Cn(e,a):Pn(e,a)),f("Baixa Realizada","O lançamento foi registado como pago.","success"),await Le()}catch(s){f("Erro",s.message,"error")}}async function $r(t,e){if(!!!e.recurrenceId){await X("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Sr(t,[e.id]);return}ec(t,e)}function ec(t,e){const a=document.getElementById("genericModal"),r=(t==="payable"?k.payables:k.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,u)=>new Date(d.dueDate)-new Date(u.dueDate));a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",a.innerHTML=`
                ...
                ${r.map(d=>{const u=d.id===e.id,c=d.status==="paid",p=hr(d.dueDate);return`
                    <label class="flex items-center gap-4 p-4 bg-white rounded-2xl border ${u?"border-red-400 ring-2 ring-red-100 shadow-md bg-red-50/20":"border-gray-200 shadow-sm"} cursor-pointer transition-all hover:bg-gray-50 active:scale-[0.98]">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm font-black text-gray-600 mt-1">${he(d.amount)} ${c?'<span class="text-emerald-600 font-bold ml-1">(Baixado)</span>':""}</p>
                        </div>
                    </label>
                    `}).join("")}
            </div>
    ...
    `,t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Xs(t,e=null){const a=document.getElementById("genericModal"),s=t==="payable",r=s?"red":"emerald",o=e?"Editar Lançamento":"Novo Lançamento",i=(E,I)=>{let T='<option value="">-- Categoria --</option>';const N=ks(E),H=(U,D=0)=>{const W="  ".repeat(D)+(D>0?"↳ ":""),te=U.id===I?"selected":"";T+=`<option value="${U.id}" ${te}>${W}${h(U.name)}</option>`,U.children.forEach(Z=>H(Z,D+1))};return N.forEach(U=>H(U)),T},l=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(E=>`<option value="${E.value}" ${e?.paymentMethod===E.value?"selected":""}>${E.label}</option>`).join(""),d=`
        <datalist id="entity-suggestions">
            ${s?k.suppliers.map(E=>`<option value="${h(E.name)}">Fornecedor</option>`).join("")+k.professionals.map(E=>`<option value="${h(E.name)}">Profissional</option>`).join(""):k.clients.map(E=>`<option value="${h(E.name)} ${E.phone?"- "+h(E.phone):""}">Cliente</option>`).join("")}
        </datalist>
    `,u=e?.establishmentId||m.selectedEstablishments&&m.selectedEstablishments[0]||m.establishmentId,c=k.establishments.map(E=>{const I=E.id===u;return`<option value="${E.id}" ${I?"selected":""}>${E.type==="Matriz"?"🏢":"📍"} ${h(E.name)}</option>`}).join("");a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 md:p-6",a.innerHTML=`
        ${d}
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const E=a.querySelector("#modal-content-wrapper");E&&(E.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),E.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let b="single",g=2;const v=p.querySelector("#modal-delete-btn");v&&v.addEventListener("click",E=>{E.preventDefault(),navigator.vibrate&&navigator.vibrate(30),Bt(),setTimeout(()=>$r(t,e),300)});const y=p.querySelector('[name="amount"]'),$=p.querySelector("#recurrence-options"),P=p.querySelector("#recurrence-summary"),A=p.querySelector("#installments-input"),S=p.querySelector("#status-toggle"),L=p.querySelector("#payment-date-wrapper"),z=p.querySelector('[name="paymentDate"]'),F=()=>{if(b==="single")return;const E=parseFloat(y.value)||0;if(g=parseInt(A.value)||2,E===0){P.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(b==="installment"){const I=E/g;P.innerHTML=`
                <div>
                    ...
                    <span class="font-black text-sm md:text-base text-indigo-700 block leading-tight">${g}x de ${he(I)}</span>
                    <span class="text-[9px] md:text-[10px] text-indigo-500 font-bold mt-1 block bg-indigo-50/50 p-1 rounded">Total da Dívida: ${he(E)}</span>
                </div>
            `}else if(b==="repeat"){const I=E*g;P.innerHTML=`
                <div>
                    ...
                    <span class="font-black text-sm md:text-base text-indigo-700 block leading-tight">${g} meses de ${he(E)}</span>
                    <span class="text-[9px] md:text-[10px] text-indigo-500 font-bold mt-1 block bg-indigo-50/50 p-1 rounded">Comprometimento: ${he(I)}</span>
                </div>
            `}};p.addEventListener("click",E=>{const I=E.target.closest(".mode-btn");if(I&&!e)if(E.preventDefault(),navigator.vibrate&&navigator.vibrate(15),p.querySelectorAll(".mode-btn").forEach(H=>{H.classList.remove("bg-white","text-gray-900","shadow-sm"),H.classList.add("text-gray-500")}),I.classList.add("bg-white","text-gray-900","shadow-sm"),I.classList.remove("text-gray-500"),b=I.dataset.mode,b==="single")$.style.display="none";else{$.style.display="block";const H=$.querySelector("#recurrence-label");H&&(H.textContent=b==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),F()}if(E.target.closest("#btn-minus")&&A){E.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let H=parseInt(A.value)||2;H>2&&(A.value=H-1,F())}if(E.target.closest("#btn-plus")&&A){E.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let H=parseInt(A.value)||2;H<60&&(A.value=H+1,F())}}),y.addEventListener("input",F),A&&A.addEventListener("input",F),S.addEventListener("change",()=>{navigator.vibrate&&navigator.vibrate(20),S.checked?(L.classList.remove("hidden"),z.required=!0):(L.classList.add("hidden"),z.required=!1)}),p.addEventListener("submit",async E=>{E.preventDefault();const I=p.querySelector('button[type="submit"]'),T=I.innerHTML;I.disabled=!0,I.innerHTML='<div class="loader mx-auto h-5 w-5 border-2 border-white border-t-transparent"></div>';const N=new FormData(p),H=S.checked,U=parseFloat(N.get("amount"));let D=U,W=1;!e&&b!=="single"&&(W=parseInt(N.get("installments")),b==="repeat"&&(D=U*W));const te=N.get("establishmentId");if(!te){f("Atenção","Selecione uma Unidade válida para o lançamento.","warning"),I.disabled=!1,I.innerHTML=T;return}const Z={companyId:m.companyId,establishmentId:te,description:N.get("description"),amount:D,dueDate:N.get("dueDate"),naturezaId:N.get("naturezaId")||null,centroDeCustoId:N.get("centroDeCustoId")||null,entity:N.get("entity")||null,paymentMethod:N.get("paymentMethod")||null,documentNumber:N.get("documentNumber")||null,notes:N.get("notes"),status:H?"paid":"pending",paymentDate:H?N.get("paymentDate"):null,installments:W};W>1&&!e&&(Z.recurrenceId=self.crypto.randomUUID());try{e?(await(s?In(e.id,Z):Dn(e.id,Z)),f("Sucesso","Atualizado com sucesso!","success")):(await(s?Vo(Z):Wo(Z)),f("Sucesso","Lançamento criado!","success")),Bt(),Le()}catch(pt){f("Erro",pt.message||"Erro ao salvar","error"),I.disabled=!1,I.innerHTML=T}})}const ac=t=>C("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),sc=t=>C("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),oc=(t,e)=>{const a=new URLSearchParams({startDate:t,endDate:e}).toString();return C(`/api/commissions/stats?${a}`)},rc=(t={})=>{Object.keys(t).forEach(s=>(t[s]===void 0||t[s]===null||t[s]==="")&&delete t[s]);const e=new URLSearchParams(t).toString(),a=`/api/commissions/history${e?"?"+e:""}`;return C(a)},Er=t=>C(`/api/commissions/report/${t}`,{method:"DELETE"}),ua=new Date,ic=new Date(ua.getFullYear(),ua.getMonth(),1);let j={professionals:[],reports:[],calculationResult:null,periodString:"",establishmentConfig:null,selectedIds:new Set,isAdvancedFilterOpen:!1,startDate:ic.toISOString().split("T")[0],endDate:new Date(ua.getFullYear(),ua.getMonth()+1,0).toISOString().split("T")[0],professionalId:"all",searchQuery:"",stats:{revenue:0,commissions:0,margin:0,netPaid:0},viewMode:"list"},Qt=null;const nc=document.getElementById("content");function It(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function lc(t){return t?new Date(t).toLocaleDateString("pt-BR"):"--/--/----"}function pa(t){if(!t)return"PR";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()}function Ir(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="none"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&window.innerWidth<768&&(a.style.display="none")}function $s(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="flex"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&window.innerWidth<768&&(a.style.display=""),j.viewMode="list"}async function dc(){try{const[t,e]=await Promise.all([ke(m.establishmentId),Be(m.establishmentId).catch(()=>({}))]);j.professionals=t,j.establishmentConfig=e||{}}catch(t){console.error("Erro na inicialização de comissões",t)}j.viewMode="list",cc(),pc(),await it()}function cc(){const t=j.professionals.map(e=>`<option value="${e.id}">${e.name}</option>`).join("");nc.innerHTML=`
        <style>
            #toast-container, .toast-notification, .modal, .modal-backdrop { z-index: 9999999 !important; }
        </style>
    ...
    `}async function it(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">Carregando comissões...</p></div>');const a=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).join(",");try{const[s,r]=await Promise.all([rc({startDate:j.startDate,endDate:j.endDate,professionalId:j.professionalId,establishmentId:a}),oc(j.startDate,j.endDate,a)]);j.reports=s||[];const o=j.reports.reduce((i,n)=>i+(n.summary.finalValue||n.summary.totalCommission),0);j.stats={revenue:r.totalRevenue||0,commissions:r.totalCommissionsPaid||0,margin:r.totalRevenue>0?((r.totalRevenue-r.totalCommissionsPaid)/r.totalRevenue*100).toFixed(1):0,netPaid:o},j.selectedIds.clear(),Lt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),uc(),Lr()}catch(s){console.error(s),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${It(j.stats.revenue)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-amber-600">${It(j.stats.commissions)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-emerald-600">${It(j.stats.netPaid)}</span>
        </div>
    `)}function Lr(){const t=document.getElementById("list-container");if(!t)return;let e=j.reports;if(j.searchQuery){const a=j.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=e.map(a=>{const s=lc(a.createdAt),r=a.summary.totalCommission,o=a.summary.extraDebit||0,i=a.summary.extraCredit||0,n=a.summary.finalValue||r,l=j.selectedIds.has(a.id);let d="";return o>0&&i>0?d=`<span class="text-red-500">-R$${o.toFixed(2)}</span> / <span class="text-emerald-500">+R$${i.toFixed(2)}</span>`:o>0?d=`<span class="text-red-500">-R$ ${o.toFixed(2)}</span>`:i>0?d=`<span class="text-emerald-500">+R$ ${i.toFixed(2)}</span>`:d='<span class="text-gray-300">--</span>',`
        <div class="bg-white border border-gray-100 md:border-0 md:border-b md:border-gray-100 hover:bg-gray-50 transition-all cursor-pointer relative flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center p-4 md:px-6 md:py-4 mb-3 md:mb-0 rounded-2xl md:rounded-none ${l?"ring-2 md:ring-0 ring-indigo-500 bg-indigo-50/50 md:bg-indigo-50/50":""}">
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:block mb-1.5 md:mb-0">
                ...
                <span class="text-sm font-bold text-gray-700">${It(r)}</span>
            </div>
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:block pt-2 md:pt-0 border-t md:border-0 border-gray-100 mt-2 md:mt-0">
                ...
                <span class="text-base font-black text-emerald-600">${It(n)}</span>
            </div>
        ...
        `}).join("")}function pc(){Qt&&document.body.removeEventListener("click",Qt),Qt=o=>{const i=o.target;if(i.classList.contains("item-checkbox")){const l=i.value;i.checked?j.selectedIds.add(l):j.selectedIds.delete(l),Lt(),o.stopPropagation();return}const n=i.closest("button[data-action]");if(n){o.preventDefault();const l=n.dataset.action,d=n.dataset.id;switch(l){case"apply-filters":j.startDate=document.getElementById("filter-start").value,j.endDate=document.getElementById("filter-end").value,j.professionalId=document.getElementById("filter-prof").value,document.getElementById("custom-date-btn")?.click(),it();break;case"new-calculation":bc();break;case"print-receipt":wc(d);break;case"delete-report":$c(d);break;case"view-report-details":vc(d);break;case"close-detail-screen":$s();break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),c=Array.from(u).every(v=>v.checked);u.forEach(v=>v.checked=!c);break;case"calculate-preview":mc();break;case"save-final-reports":hc();break;case"toggle-preview-details":const p=n.dataset.idx,b=document.getElementById(`preview-details-${p}`),g=n.querySelector("i");b&&(b.classList.contains("hidden")?(b.classList.remove("hidden"),g&&g.classList.replace("bi-chevron-down","bi-chevron-up")):(b.classList.add("hidden"),g&&g.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",Qt);const t=document.getElementById("search-input");t&&t.addEventListener("input",o=>{j.searchQuery=o.target.value,Lr()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&fc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const i=o.target.checked,n=document.querySelectorAll(".item-checkbox");j.selectedIds.clear(),n.forEach(l=>{l.checked=i,i&&j.selectedIds.add(l.value)}),Lt()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{j.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Lt()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",kc);const r=document.getElementById("export-excel-btn");r&&r.addEventListener("click",yc),document.getElementById("custom-date-btn")?.addEventListener("click",()=>{const o=document.getElementById("filter-panel"),i=document.getElementById("custom-date-btn");j.isAdvancedFilterOpen=!j.isAdvancedFilterOpen,j.isAdvancedFilterOpen?(o.classList.remove("hidden"),i.classList.add("bg-gray-900","text-white","border-gray-900"),i.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),i.classList.remove("bg-gray-900","text-white","border-gray-900"),i.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=i.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filter-start").value=d.toISOString().split("T")[0],document.getElementById("filter-end").value=u.toISOString().split("T")[0],j.startDate=d.toISOString().split("T")[0],j.endDate=u.toISOString().split("T")[0],it()})})}function Lt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=j.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function bc(){j.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=j.professionals.map(o=>`
        <label class="flex items-center p-2.5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-indigo-300 transition-all cursor-pointer group mb-1.5">
            ...
            <div class="ml-3 flex items-center gap-2">
                <div class="w-8 h-8 rounded-lg border border-gray-100 bg-gray-50 text-gray-500 flex items-center justify-center text-[10px] font-black group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors shadow-sm">${pa(o.name)}</div>
    ...
    `,Ir()}function yc(){if(j.reports.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}let t=j.reports;if(j.searchQuery){const a=j.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}const e=t.map(a=>{const s=a.summary.totalCommission,r=a.summary.extraDebit||0,o=a.summary.extraCredit||0,i=a.summary.finalValue||s;return{"Data da Apuração":new Date(a.createdAt).toLocaleDateString("pt-BR"),Profissional:a.professionalName,"Período Base":a.period,"Itens Calculados":a.summary.totalItems||0,"Valor Bruto (R$)":s,"Bônus (R$)":o,"Descontos (R$)":r,"Líquido Pago (R$)":i,"Observações/Motivo":a.summary.notes||""}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const a=XLSX.utils.json_to_sheet(e),s=XLSX.utils.book_new();XLSX.utils.book_append_sheet(s,a,"Comissoes");const r=`Relatorio_Comissoes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(s,r)}catch(a){console.error(a),f("Erro","Falha ao exportar Excel.","error")}}function wc(t){const e=j.reports.find(u=>u.id===t);if(!e)return;if(!window.jspdf){f("Erro","A biblioteca de PDF não foi carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a;s.setFillColor(79,70,229),s.rect(0,0,210,40,"F"),s.setTextColor(255,255,255),s.setFontSize(22),s.setFont(void 0,"bold"),s.text("RECIBO DE COMISSÕES",105,20,{align:"center"}),s.setFontSize(10),s.text(`Data de Emissão: ${new Date().toLocaleDateString("pt-BR")}`,105,28,{align:"center"}),s.setTextColor(50,50,50),s.setFontSize(11),s.setFont(void 0,"normal"),s.text("Profissional:",15,55),s.setFont(void 0,"bold"),s.text(e.professionalName,40,55),s.setFont(void 0,"normal"),s.text("Período:",130,55),s.setFont(void 0,"bold"),s.text(e.period,147,55);const r=e.reportData?.items||e.items||[];let o=70;if(r.length>0){const u=r.map(c=>[c.item||"Item",c.client||"--",`R$ ${(c.value||0).toFixed(2)}`,`${c.commissionRate||0}%`,`R$ ${(c.commissionValue||0).toFixed(2)}`]);s.autoTable({startY:o,head:[["Serviço/Produto","Cliente","Valor Base","Taxa","Comissão"]],body:u,theme:"striped",headStyles:{fillColor:[249,250,251],textColor:[75,85,99],fontStyle:"bold"},styles:{fontSize:8},columnStyles:{2:{halign:"right"},3:{halign:"center"},4:{halign:"right",fontStyle:"bold",textColor:[5,150,105]}}}),o=s.lastAutoTable.finalY+15}const i=e.summary,n=i.finalValue||i.totalCommission,l=[["Comissões Brutas (Soma dos Itens)",`R$ ${i.totalCommission.toFixed(2)}`]];i.extraCredit>0&&l.push(["(+) Bônus Extras",`R$ ${i.extraCredit.toFixed(2)}`]),i.extraDebit>0&&l.push(["(-) Descontos / Vales",`R$ ${i.extraDebit.toFixed(2)}`]),s.autoTable({startY:o,head:[["Resumo do Fechamento","Valor"]],body:l,theme:"grid",headStyles:{fillColor:[79,70,229],textColor:[255,255,255]},columnStyles:{1:{halign:"right",fontStyle:"bold"}}});const d=s.lastAutoTable.finalY+15;s.setFillColor(236,253,245),s.rect(120,d-8,75,15,"F"),s.setTextColor(5,150,105),s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${n.toFixed(2)}`,190,d,{align:"right"}),i.notes&&(s.setTextColor(100,100,100),s.setFontSize(9),s.setFont(void 0,"normal"),s.text(`Obs/Motivo: ${i.notes}`,15,d+10)),s.setTextColor(150,150,150),s.setFontSize(9),s.line(20,d+40,90,d+40),s.text("Assinatura da Empresa",55,d+45,{align:"center"}),s.line(120,d+40,190,d+40),s.text("Assinatura do Profissional",155,d+45,{align:"center"}),s.save(`Recibo_Comissoes_${e.professionalName.replace(/\s+/g,"_")}.pdf`)}async function kc(){const t=j.selectedIds.size;if(!(t===0||!await X("Excluir Recibos",`Deseja excluir e estornar ${t} recibo(s)? As vendas associadas voltarão ao status "A Apurar".`)))try{const a=Array.from(j.selectedIds).map(s=>Er(s));await Promise.all(a),f("Sucesso",`${t} recibos excluídos com sucesso.`,"success"),j.selectedIds.clear(),Lt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),await it()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns recibos.","error")}}async function $c(t){if(await X("Excluir Recibo",'ATENÇÃO: Deseja realmente excluir este recibo? As vendas associadas a ele voltarão ao status "A Apurar" e o valor será subtraído dos relatórios. Esta ação não pode ser desfeita.'))try{await Er(t),f("Sucesso","Recibo cancelado com sucesso. Vendas estornadas para apuração.","success"),$s(),await it()}catch(a){f("Erro ao Excluir",a.message,"error")}}const je=document.getElementById("content");let B={allPackages:[],catalogForModal:{services:[],products:[]},establishments:[],searchQuery:"",statusFilter:"all",viewMode:"list",tempPackage:null,selectedIds:new Set},_e=null;function nt(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Sc(){const t=B.allPackages.length,e=B.allPackages.filter(o=>o.status!=="inactive"),a=e.length,s=a>0?e.reduce((o,i)=>o+(i.price||0),0)/a:0;let r=0;return e.forEach(o=>{const i=o.originalPrice||0,n=o.price||0;if(i>0&&i>n){const l=(i-n)/i*100;l>r&&(r=l)}}),{total:t,activeCount:a,avgPrice:s,maxDiscount:r}}function Ec(){const t=document.getElementById("packages-layout-detail");t&&(t.classList.remove("hidden"),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))}))}function ta(){const t=document.getElementById("packages-layout-detail");if(t){t.classList.add("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-0","md:scale-100","md:opacity-100"),e.classList.add("translate-y-full","md:scale-95","md:opacity-0")),setTimeout(()=>{t.classList.add("hidden"),t.style.display="none",t.innerHTML=""},300)}}function Ic(){const t=document.getElementById("packages-layout-detail");if(!t||B.viewMode!=="edit-package"||!B.tempPackage)return;B.tempPackage.name=t.querySelector("#packageName")?.value||"",B.tempPackage.description=t.querySelector("#packageDescription")?.value||"",B.tempPackage.status=t.querySelector("#packageStatus")?.value||"active";const e=parseFloat(t.querySelector("#finalPrice")?.value);B.tempPackage.price=isNaN(e)?"":e;const a=parseFloat(t.querySelector("#commissionRate")?.value);B.tempPackage.commissionRate=isNaN(a)?"":a;const s=parseInt(t.querySelector("#validityDays")?.value,10);B.tempPackage.validityDays=isNaN(s)?"":s,B.tempPackage.sellStartDate=t.querySelector("#sellStartDate")?.value||"",B.tempPackage.sellEndDate=t.querySelector("#sellEndDate")?.value||"";const r=parseInt(t.querySelector("#salesLimit")?.value,10);B.tempPackage.salesLimit=isNaN(r)?"":r;const o=Array.from(t.querySelectorAll(".modal-est-checkbox:checked")).map(i=>i.value);B.tempPackage.establishmentIds=o}async function Lc(){try{const e=(await ve().catch(()=>({matrizes:[]}))).matrizes||[];B.establishments=[],e.forEach(a=>{B.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>B.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}B.viewMode="list",B.selectedIds.clear(),Cc(),Bc(),await ba()}async function ba(){const t=document.getElementById("packagesListContainer");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-20"><div class="loader mx-auto"></div></div>');const e=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId];try{const a=e.map(c=>bs(c).catch(()=>[])),s=await Promise.all(a),r=new Map;s.flat().forEach(c=>{r.has(c.id)||r.set(c.id,c)}),B.allPackages=Array.from(r.values());const o=e.map(c=>dt(c).catch(()=>[])),i=e.map(c=>ct(c).catch(()=>[])),[n,l]=await Promise.all([Promise.all(o),Promise.all(i)]),d=new Map;n.flat().forEach(c=>d.set(c.id,c));const u=new Map;l.flat().forEach(c=>u.set(c.id,c)),B.catalogForModal={services:Array.from(d.values()).filter(c=>c.active),products:Array.from(u.values())},Dc(),Je(),vt()}catch(a){console.error(a),t&&(t.innerHTML=`
            ...
            `)}}function vt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=B.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")));const s=document.getElementById("select-all-toggle");s&&(s.checked=B.allPackages.length>0&&a===B.allPackages.length)}function Cc(){je.innerHTML=`
    ...
    `}function Dc(){const t=Sc(),e=document.getElementById("kpi-container");e&&(e.innerHTML=`
            ...
            <div class="bg-white rounded-3xl border ${o?"border-indigo-500 ring-2 ring-indigo-500 bg-indigo-50/30":"border-slate-200"} shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col relative overflow-hidden group cursor-pointer active:scale-[0.98]"
                ...
                <div class="p-5 pt-5 flex-grow flex flex-col">
                    ...
                    <div class="flex justify-between items-end border-t border-slate-100 pt-4">
                        <div class="flex flex-col">
                            ${l>0?`<span class="text-[10px] text-slate-400 font-bold line-through mb-0.5">De ${nt(n)}</span>`:'<span class="text-[10px] text-transparent mb-0.5">.</span>'}
                            <span class="text-2xl font-black text-slate-900 leading-none drop-shadow-sm">${nt(i)}</span>
                        </div>
                        <div class="text-right">
            ...
            <div class="flex items-center justify-between bg-white p-3 rounded-2xl shadow-sm border border-slate-200 hover:border-indigo-300 transition-colors animate-fade-in-fast mb-2">
                ...
                <div class="flex items-center gap-4 flex-shrink-0 pl-2">
                    <div class="text-right">
                        ...
                        <span class="text-sm font-black text-slate-700">${nt(a.price)}</span>
                    </div>
    ...
    `,as(),requestAnimationFrame(()=>{const g=t.querySelector("#modal-content-wrapper");g&&(g.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),g.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Pc(){B.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `;let a;const s=(o="")=>{const i=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600 text-lg"></i>',product:'<i class="bi bi-box-seam text-emerald-600 text-lg"></i>'},l={"catalog-service-list":{items:B.catalogForModal.services,type:"service"},"catalog-product-list":{items:B.catalogForModal.products,type:"product"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=t.querySelector("#"+d);if(!p)return;const b=u.filter(y=>y.name.toLowerCase().includes(i)).slice(0,50),g=c==="service"?"hover:border-indigo-400 hover:bg-indigo-50/80 hover:shadow-md":"hover:border-emerald-400 hover:bg-emerald-50/80 hover:shadow-md",v=c==="service"?"bg-indigo-100 border-indigo-200 shadow-sm":"bg-emerald-100 border-emerald-200 shadow-sm";p.innerHTML=b.map(y=>y.id?`
                <button data-action="select-catalog-item" data-item-type="${c}" data-item-id="${y.id}" class="flex items-center gap-4 w-full p-3 bg-white border border-slate-200 rounded-2xl ${g} shadow-sm transition-all duration-300 text-left group active:scale-95">
                    ...
                    <div class="flex-grow min-w-0">
                        ...
                        <span class="block font-black text-xs text-slate-500 mt-1">${nt(y.price)}</span>
                    </div>
            ...
            `:"").join("")||'<div class="flex flex-col items-center justify-center py-8 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50"><i class="bi bi-inbox text-3xl mb-2"></i><p class="text-[10px] font-bold uppercase tracking-widest">Nenhum resultado</p></div>'})};s();const r=t.querySelector("#item-search-input");r&&(r.addEventListener("input",o=>{clearTimeout(a),a=setTimeout(()=>s(o.target.value),300)}),setTimeout(()=>r.focus(),100)),requestAnimationFrame(()=>{const o=t.querySelector("#modal-content-wrapper");o&&(o.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),o.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Bc(){_e&&(je.removeEventListener("click",_e),je.removeEventListener("input",_e),je.removeEventListener("change",_e)),_e=async e=>{if(e.target.classList.contains("item-checkbox")){const i=e.target.value;e.target.checked?B.selectedIds.add(i):B.selectedIds.delete(i),vt(),Je(),e.stopPropagation();return}if(e.target.id==="packages-layout-detail"){ta(),B.viewMode="list",B.tempPackage=null;return}if(e.target.closest("#batch-delete-btn")){const i=B.selectedIds.size;if(i===0)return;if(await X("Excluir Pacotes",`Deseja realmente apagar ${i} pacotes selecionados?`))try{const l=Array.from(B.selectedIds).map(d=>js(d));await Promise.all(l),f("Sucesso",`${i} pacote(s) excluído(s).`,"success"),B.selectedIds.clear(),vt(),await ba()}catch{f("Erro","Ocorreu um erro ao excluir pacotes.","error")}return}if(e.target.closest("#cancel-selection-btn")){B.selectedIds.clear();const i=document.getElementById("select-all-toggle");i&&(i.checked=!1),vt(),Je();return}const r=e.target.closest("[data-action]");if(!r)return;switch(r.dataset.action){case"new-package":navigator.vibrate&&navigator.vibrate(20),Ks(null);break;case"edit-package":navigator.vibrate&&navigator.vibrate(15);const i=r.dataset.id,n=B.allPackages.find($=>$.id===i);n&&Ks(n);break;case"delete-package":e.stopPropagation(),e.preventDefault();const l=r.dataset.id;if(await X("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await js(l),f("Sucesso!","Pacote excluído.","success"),B.viewMode==="edit-package"&&B.tempPackage?.id===l&&(ta(),B.viewMode="list"),await ba()}catch($){f("Erro",`Não foi possível excluir: ${$.message}`,"error")}break;case"back-to-main":ta(),B.viewMode="list",B.tempPackage=null;break;case"add-item-to-package-btn":Ic(),Pc();break;case"back-to-editor":ss();break;case"select-catalog-item":navigator.vibrate&&navigator.vibrate(10);const{itemType:u,itemId:c}=r.dataset,b=(B.catalogForModal[u+"s"]||[]).find($=>$.id===c);if(b){const $=B.tempPackage.items.find(P=>P.id===b.id&&P.type===u);$?$.quantity++:B.tempPackage.items.push({...b,type:u,quantity:1}),ss()}break;case"remove-item":navigator.vibrate&&navigator.vibrate(10);const g=parseInt(r.dataset.index,10);B.tempPackage.items.splice(g,1),as();break;case"toggle-all-ests":const v=document.querySelectorAll(".modal-est-checkbox"),y=Array.from(v).every($=>$.checked);v.forEach($=>$.checked=!y);break;case"save-package":await Ac(r);break}},je.addEventListener("click",_e),je.addEventListener("input",e=>{e.target.id==="search-packages"&&(B.searchQuery=e.target.value,Je()),e.target.id==="finalPrice"&&Cr()}),je.addEventListener("change",e=>{if(e.target.id==="select-all-toggle"){const a=e.target.checked;B.selectedIds.clear(),a&&B.allPackages.forEach(s=>B.selectedIds.add(s.id)),vt(),Je()}if(e.target.id==="filter-status"&&(B.statusFilter=e.target.value,Je()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&B.tempPackage.items[a]&&(B.tempPackage.items[a].quantity=s,as())}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Tc)}async function Ac(t){const e=B.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const r=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(r.length===0){f("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const o=e.items.reduce((l,d)=>l+d.price*d.quantity,0),i={id:e.id||null,companyId:m.companyId,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:o,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:r,establishmentId:r[0]};if(!i.name||isNaN(i.price)){f("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(i.items.length===0){f("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await $n(i.id,i):(delete i.id,await kn(i)),f("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),ta(),B.viewMode="list",B.tempPackage=null,await ba()}catch(l){f("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const Mc=document.getElementById("content");async function qc(){const t=me.currentUser;if(!t)return;let e={};try{const l=await rs(Pe(ge,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(m.userProfessionalId)try{a=await go(m.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=h(e.name||t.displayName||"Usuário"),r=h(t.email||"E-mail não disponível"),o=h(e.phone||"");let i=e.photo||"";a&&a.photo&&(i=a.photo);const n=i||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;Mc.innerHTML=`
    ...
    `,jc(t),Nc(a)}function jc(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),r=document.getElementById("profile-avatar"),o=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async i=>{const n=i.target.files[0];if(n)try{const l=await xa(n,800,800,.8);r.src=l,await Tt(Pe(ge,"users",t.uid),{photo:l}),m.userProfessionalId&&await Ra(m.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),f("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{f("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),o.addEventListener("submit",async i=>{i.preventDefault();const n=o.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),u=document.getElementById("input-phone").value.trim();try{await Tt(Pe(ge,"users",t.uid),{name:d,phone:u}),m.userProfessionalId&&await Ra(m.userProfessionalId,{name:d,phone:u}),m.userName=d,document.getElementById("display-name").textContent=d,f("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{f("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function Nc(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async r=>{r.preventDefault();const o=a.querySelector("#b-date-start").value,i=a.querySelector("#b-date-end").value||o,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!o||!n||!l)return f("Atenção","Preencha Data e Horários corretamente.","error");const u=new Date(`${o}T${n}:00`),c=new Date(`${i}T${l}:00`);if(c<=u)return f("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await va({establishmentId:m.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:u.toISOString(),endTime:c.toISOString()}),f("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const g=document.getElementById("my-blocks-filter").value;aa(t.id,g)}catch(g){f("Erro",`Falha ao bloquear: ${g.message}`,"error")}finally{p.disabled=!1,p.innerHTML=b}}),document.getElementById("my-blocks-filter").addEventListener("change",r=>aa(t.id,r.target.value)),aa(t.id,"future")}async function aa(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let r,o;e==="history"?(o=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let n=(await ha(m.establishmentId,r.toISOString(),o.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await ds(u),f("Removido","O bloqueio foi deletado.","success"),aa(t,e)}catch(c){f("Erro",`Não foi possível remover: ${c.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${h(s.message)}</p>`}}let eo=!1;async function ma(t){if(!t)return;t.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const r=(await ve()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),r.length===0)e.innerHTML=`
            ...
            `;else{let o="";r.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';o+=`
                ...
                `}),e.innerHTML=o}eo||(Rc(),eo=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
        ...
        `}}function Rc(){const t=document.getElementById("form-create-establishment");t&&t.addEventListener("submit",async e=>{e.preventDefault();const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const r={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const o=await ui(r);alert(o.message||"Sucesso!"),t.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await ma(document.getElementById("content"))}catch(o){console.error("Erro ao criar estabelecimento:",o),alert("Erro: "+(o.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>ma(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",e=>e.preventDefault()),document.addEventListener("gesturechange",e=>e.preventDefault()),document.addEventListener("gestureend",e=>e.preventDefault());let t=0;document.addEventListener("touchend",function(e){const a=new Date().getTime();a-t<=300&&e.preventDefault(),t=a},!1)});const de=document.getElementById("loadingScreen"),mt=document.getElementById("dashboardContent"),Xe=document.getElementById("content"),Aa=document.getElementById("notificationBell"),Gt=document.getElementById("notificationBadge"),Ve=document.getElementById("notificationPanel"),Ma=document.getElementById("notificationList"),$e=document.getElementById("profileMenuButton"),pe=document.getElementById("profileDropdown"),to=document.getElementById("profileName"),ao=document.getElementById("profileEmail"),so=document.getElementById("logoutButton"),oo=document.getElementById("myProfileLink"),ro=document.getElementById("hamburger-menu-btn"),ue=document.getElementById("sidebar"),xe=document.getElementById("mobile-overlay"),io=document.getElementById("themeToggleBtn"),qa=document.getElementById("themeIcon"),os=document.getElementById("mobile-bottom-nav"),no=document.getElementById("nav-scroll"),Fc=document.querySelectorAll(".bottom-nav-item");function Hc(){if(!no)return;const t=document.querySelector(".bottom-nav-item.active");if(!t)return;const e=no,a=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=s.left+s.width/2-a.left-a.width/2;e.scrollBy({left:o,behavior:"smooth"})}const Oc={"dashboard-section":Vi,"agenda-section":Po,"comandas-section":Qn,"relatorios-section":Yn,"servicos-section":nl,"produtos-section":$l,"suppliers-section":ql,"profissionais-section":Vl,"clientes-section":td,"estabelecimento-section":t=>gr(t),"ausencias-section":Pd,"users-section":ca,"sales-report-section":Jd,"financial-section":Yd,"commissions-section":dc,"packages-section":Lc,"my-profile-section":qc,"hierarquia-section":()=>ma(Xe),"establishments-section":()=>ma(Xe)},zc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços","produtos-section":"Estoque","suppliers-section":"Parceiros","profissionais-section":"Equipe","clientes-section":"Clientes","estabelecimento-section":"Empresa","ausencias-section":"Ausências","users-section":"Usuários","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro","commissions-section":"Comissões","packages-section":"Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"};function sa(t){document.documentElement.setAttribute("data-theme",t),localStorage.setItem("kairos_theme",t),qa&&(t==="dark"?qa.className="bi bi-sun-fill text-lg sm:text-xl text-amber-400":qa.className="bi bi-moon-fill text-lg sm:text-xl text-slate-500")}function _c(){const t=localStorage.getItem("kairos_theme"),e=window.matchMedia("(prefers-color-scheme: dark)").matches;sa(t||(e?"dark":"light"))}let Ct=null,Dt=[];function Dr(){if(!Gt||!Ma)return;const t=Dt.filter(e=>!e.read).length;if(t>0?(Gt.textContent=t,Gt.classList.remove("hidden")):Gt.classList.add("hidden"),Dt.length===0){Ma.innerHTML='<p class="text-center text-slate-500 p-4 text-sm">Nenhuma notificação.</p>';return}Ma.innerHTML=Dt.map(e=>`
    ...
    `).join("")}function lo(t){Ct&&Ct();const e=ga(ge,"establishments",t,"notifications"),a=po(e,bo("timestamp",">=",new Date),_r("timestamp","desc"));Ct=Vr(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();Dt.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),f(o.title,o.message,"info",!0),Dr();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&Po()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Vc(t){const e=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),r=document.getElementById("multi-context-count"),o=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!e||!o))try{const u=(await ve()).matrizes||[];let c="",p=0;if(u.forEach(b=>{c+=`
            ...
            `,p++,b.branches&&b.branches.length>0&&b.branches.forEach(g=>{c+=`
                        <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors ml-4 mb-1 border-l-2 border-slate-100 pl-3">
                            <input type="checkbox" value="${g.id}" class="context-checkbox" data-name="${Yt(g.name)}">
                            <span class="text-[12px] sm:text-[13px] font-medium text-slate-600 truncate">📍 ${Yt(g.name)}</span>
                        </label>
                    `,p++})}),p>0){o.innerHTML=c,e.style.display="block",(!m.selectedEstablishments||m.selectedEstablishments.length===0)&&(m.selectedEstablishments=[t]);const b=Array.from(o.querySelectorAll('input[type="checkbox"]')),g=()=>{const y=b.filter($=>$.checked);r.textContent=y.length,y.length===0?s.textContent="Nenhuma selecionada":y.length===1?s.textContent=y[0].dataset.name:s.textContent=`${y.length} Unidades`};let v=!1;b.forEach(y=>{m.selectedEstablishments.includes(y.value)&&(y.checked=!0,v=!0)}),!v&&b.length>0&&(b[0].checked=!0,m.selectedEstablishments=[b[0].value],m.establishmentId=b[0].value),g(),a.addEventListener("click",y=>{y.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",y=>{!e.contains(y.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",b.forEach($=>{$.checked=m.selectedEstablishments.includes($.value)}),g())}),b.forEach(y=>y.addEventListener("change",g)),i.addEventListener("click",async y=>{y.stopPropagation(),de&&(de.classList.remove("hidden","fade-out"),de.style.display="flex");const $=b.filter(A=>A.checked);if($.length===0){de&&(de.classList.add("fade-out"),setTimeout(()=>{de.style.display="none"},500)),f("Atenção","Selecione pelo menos uma unidade.","warning");return}m.selectedEstablishments=$.map(A=>A.value);const P=m.selectedEstablishments[0];try{const A=await Be(P);m.establishmentId=P,m.establishmentName=A.name,m.enabledModules=A.modules,m.currentViewContext={id:P,name:A.name,type:A.parentId?"BRANCH":"GROUP"},lo(P),co(m.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",f("Ambiente Atualizado","Exibindo dados consolidados.","success");const S=document.querySelector(".sidebar-link.active"),L=S?S.getAttribute("data-target"):"dashboard-section";ae(L)}catch{f("Erro","Problema ao trocar a visualização.","error")}finally{de&&(de.classList.add("fade-out"),setTimeout(()=>{de.style.display="none"},500))}});try{const y=await Be(m.establishmentId);m.establishmentName=y.name,m.enabledModules=y.modules,m.currentViewContext={id:m.establishmentId,name:y.name,type:y.parentId?"BRANCH":"GROUP"},lo(m.establishmentId),co(m.userPermissions)}catch{}}else e.style.display="none"}catch{e.style.display="none"}}function ae(t,e={}){const a=t.replace("-section","");if(t!=="my-profile-section"){const r=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(t),o=m.enabledModules?.[a]!==!1,i=m.userPermissions===null||m.userPermissions[t]?.view===!0;if(!r&&(!o||!i)){Xe&&(Xe.innerHTML='<div class="p-8 text-center mt-10"><i class="bi bi-shield-lock text-5xl text-rose-500 mb-4 block"></i><h2 class="text-2xl font-bold text-slate-800">Acesso Negado</h2><p class="text-slate-500 mt-2">Você não possui permissão para visualizar esta tela.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),ue&&ue.classList.contains("absolute")&&(ue.classList.add("hidden"),xe&&xe.classList.add("hidden"));return}}const s=Oc[t];if(s&&Xe){const r=document.getElementById("header-page-title");r&&(r.textContent=zc[t]||"Painel"),document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),os&&(Fc.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),setTimeout(Hc,50)),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Xe.innerHTML="",window.innerWidth<768&&ue&&(ue.classList.add("hidden"),xe&&xe.classList.add("hidden")),s(e)}}window.navigateTo=ae;async function co(t){const e=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=t===null||t["agenda-section"]?.view===!0,i=t===null||t["financial-section"]?.view===!0;if(o&&e&&(e.classList.remove("hidden"),e.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!o&&!i))try{const n=await yo();o&&s&&(s.textContent=n.todayAppointments.toString()),i&&r&&(r.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch{}}async function Uc(t){try{we.getPlatform()==="android"&&await ce.createChannel({id:"default",name:"Notificações",description:"Alertas",importance:5,visibility:1,vibration:!0});let e=await ce.checkPermissions();if(e.receive==="prompt"&&(e=await ce.requestPermissions()),e.receive!=="granted")return;await ce.register(),ce.addListener("registration",async a=>{try{const s=Pe(ge,"users",t);await Tt(s,{fcmTokens:zr(a.value),platform:"native_mobile"})}catch{}}),ce.addListener("pushNotificationReceived",a=>f(a.title,a.body,"info",!0)),ce.addListener("pushNotificationActionPerformed",()=>ae("agenda-section"))}catch{}}function Wc(){const t=document.getElementById("exitConfirmationModal"),e=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>t&&(t.style.display="block"),r=()=>t&&(t.style.display="none"),o=()=>t&&t.style.display==="block";t&&(e.addEventListener("click",()=>{r(),we.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{r(),we.isNativePlatform()?Ts.exitApp():history.back()}),we.isNativePlatform()?Ts.addListener("backButton",()=>{if(o())r();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(ue&&!ue.classList.contains("hidden")&&window.innerWidth<768){ue.classList.add("hidden"),xe&&xe.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():ae("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(o()){r(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():(ae("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Yt(t){return t?t.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function Jc(){try{await qr(me,jr)}catch{}we.isNativePlatform()&&document.body.classList.add("is-app-native"),oi(),Wc(),_c(),io&&io.addEventListener("click",t=>{t.preventDefault();const e=document.documentElement.getAttribute("data-theme")||"light";sa(e==="dark"?"light":"dark")}),ro&&ro.addEventListener("click",t=>{t.stopPropagation(),ue&&(ue.classList.remove("hidden"),ue.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),xe&&xe.classList.remove("hidden")}),os&&os.addEventListener("click",t=>{const e=t.target.closest(".bottom-nav-item");if(!e)return;t.preventDefault();const a=e.getAttribute("data-target");ae(a)}),xe&&xe.addEventListener("click",()=>{ue&&(ue.classList.add("hidden"),ue.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),xe.classList.add("hidden")}),Aa&&Aa.addEventListener("click",t=>{t.stopPropagation(),Ve&&(Ve.classList.toggle("hidden"),Ve.classList.contains("hidden")||(Dt.forEach(e=>e.read=!0),Dr()))}),$e&&$e.addEventListener("click",t=>{t.stopPropagation(),pe&&(pe.classList.toggle("active"),pe.classList.contains("active")?pe.classList.remove("hidden"):setTimeout(()=>pe.classList.add("hidden"),200))}),oo&&oo.addEventListener("click",t=>{t.preventDefault(),ae("my-profile-section"),pe&&(pe.classList.remove("active"),pe.classList.add("hidden"))}),window.addEventListener("userPhotoUpdated",t=>{const e=t.detail;$e&&e&&($e.innerHTML=`<img src="${e}" alt="Avatar" class="w-full h-full rounded-full object-cover">`)}),document.addEventListener("click",t=>{Ve&&!Ve.contains(t.target)&&t.target!==Aa&&Ve.classList.add("hidden"),pe&&!pe.contains(t.target)&&t.target!==$e&&pe.classList.contains("active")&&(pe.classList.remove("active"),setTimeout(()=>pe.classList.add("hidden"),200))}),Nr(me,async t=>{if(t){if(!we.isNativePlatform()&&(Pi(),"Notification"in window&&Notification.permission==="default")){const e=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");e&&setTimeout(()=>{e.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Bi()&&e&&(e.style.display="none")});const s=()=>{e&&(e.style.display="none")},r=document.getElementById("btn-deny-toast"),o=document.getElementById("btn-close-toast");r&&r.addEventListener("click",s),o&&o.addEventListener("click",s)}try{const a=(await t.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,r=t.displayName,o=null,i=null;const n=Pe(ge,"users",t.uid),l=await rs(n);if(l.exists()){const u=l.data();s=a.role==="employee"?u.permissions||{}:null,r=u.name||r,o=u.professionalId||null,i=u.photo||null}if(m.userProfessionalId=o,o&&!i)try{const u=await go(o);u&&u.photo&&(i=u.photo)}catch{}we.isNativePlatform()&&Uc(t.uid);const d=r||t.email;Jr(a.establishmentId,"Carregando...",s),i?$e&&($e.innerHTML=`<img src="${i}" class="w-full h-full rounded-full object-cover">`):$e&&($e.textContent=d.charAt(0).toUpperCase()),to&&(to.textContent=d),ao&&(ao.textContent=t.email),so&&so.addEventListener("click",u=>{u.preventDefault(),Ct&&Ct(),Rr(me).then(()=>window.location.href="/login.html")}),await Vc(a.establishmentId),ci(ae,s,m.enabledModules),de&&(de.classList.add("fade-out"),setTimeout(()=>{de.style.display="none"},500)),mt&&(mt.style.display="flex"),setTimeout(()=>{xi()},1500),ae("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(e){de&&(de.style.display="none"),mt&&(mt.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><i class="bi bi-x-circle text-5xl text-rose-500 mb-4"></i><h2 class="text-xl font-bold">Erro de Acesso</h2><p class="text-slate-500 mt-2">${e.message}</p></div>`,mt.style.display="flex")}}else window.location.href="/login.html"})}Jc();export{xo as W};
