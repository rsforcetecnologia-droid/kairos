...
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as ke,d as he,m as Ns}from"./firebase-config-seH-87Om.js";import{EmailAuthProvider as Hi,reauthenticateWithCredential as Oi,verifyBeforeUpdateEmail as zi,updatePassword as _i,updateProfile as Vi,setPersistence as Ui,browserLocalPersistence as Wi,onAuthStateChanged as Ji,signOut as Gi}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as qe,getDoc as ys,updateDoc as jt,setDoc as Qi,addDoc as $o,collection as Da,query as Lo,where as Co,getDocs as Yi,deleteDoc as Xi,arrayUnion as Zi,orderBy as Ki,onSnapshot as er}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{a as A,e as y,s as K,b as f,c as Ne,r as Pa,f as za,i as tr}from"./utils-DTVAHnIk.js";import{getToken as ar,onMessage as sr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const g={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function or(t,e,a){g.establishmentId=t,g.establishmentName=e,g.userPermissions=a,g.currentViewContext={type:"BRANCH",id:t,name:e}}const Ta=(t,e,a,s=null)=>{let i=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(i+=`&professionalId=${s}`),A(i)},ir=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return A(s)},rr=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const i=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return A(i)},nr=t=>A("/api/appointments",{method:"POST",body:JSON.stringify(t)}),lr=(t,e)=>A(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),dr=(t,e)=>A(`/api/appointments/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),cr=t=>A(`/api/appointments/${t}`,{method:"DELETE"}),ur=t=>A(`/api/appointments/${t}/reopen`,{method:"POST"}),pr=(t,e)=>A(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)}),le=document.getElementById("sidebar"),Ye=document.getElementById("sidebarToggle"),St=document.getElementById("mainContent"),br=document.querySelectorAll(".sidebar-link"),Za=document.getElementById("menu-search"),Rs=document.getElementById("hamburger-menu-btn"),ut=document.getElementById("mobile-overlay");let je=!0;function Oe(t){if(!le||!St)return;le.classList.toggle("collapsed",t),St.classList.toggle("sidebar-collapsed-shift",t);const e=le.querySelector(".sidebar-search-container"),a=le.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const i=s.getAttribute("data-target-submenu"),o=document.getElementById(i),r=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),r&&r.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function mr(){!le||!ut||(le.classList.add("mobile-open"),ut.classList.add("visible"))}function Ot(){!le||!ut||(le.classList.remove("mobile-open"),ut.classList.remove("visible"))}function gr(){Oe(!le.classList.contains("collapsed"))}function fr(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&le.classList.contains("collapsed")&&Oe(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function xr(){Za&&Za.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),i=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),i.forEach(o=>o.style.display="block");return}i.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const r=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!r)return;if(r.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=r.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(m=>m.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function hr(t,e,a){if(!le||!St)return;St.classList.add("main-content-shift"),window.innerWidth>=1024?(je=!0,Oe(!1)):window.innerWidth>=768?(je=!1,Oe(!0)):(St.classList.remove("main-content-shift","sidebar-collapsed-shift"),Ot()),Ye&&Ye.addEventListener("click",i=>{i.stopPropagation(),window.innerWidth>=768?(je=!je,Oe(!je),je?(Ye.classList.add("text-indigo-400"),Ye.classList.remove("text-gray-400")):(Ye.classList.remove("text-indigo-400"),Ye.classList.add("text-gray-400"))):gr()}),le.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!je&&le.classList.contains("collapsed")&&Oe(!1)}),le.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!je){const i=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===Za;!i&&!o&&Oe(!0)}}),Rs&&Rs.addEventListener("click",i=>{i.stopPropagation(),mr()}),ut&&ut.addEventListener("click",i=>{i.stopPropagation(),Ot()});let s=0;le.addEventListener("touchstart",i=>{s=i.changedTouches[0].screenX},{passive:!0}),le.addEventListener("touchend",i=>{const o=i.changedTouches[0].screenX;s-o>50&&Ot()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(i=>{i.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const r=i.getAttribute("data-target-submenu"),n=i.querySelector(".submenu-arrow");fr(r,n)})}),xr(),br.forEach(i=>{const o=i.getAttribute("data-target");if(!o)return;const r=o.replace("-section",""),n=a?.[r]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){i.parentElement&&i.parentElement.tagName==="LI"?i.parentElement.style.display="none":i.style.display="none";return}i.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),i.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&Ot()})})}const vr=t=>A("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),De=()=>A("/api/establishments/hierarchy",{method:"GET"}),Me=t=>{const e=t||g.establishmentId;return e?A(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},qt=(t,e)=>{const a=t||g.establishmentId;return a?A(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},yr=(t,e)=>{const a=t||g.establishmentId;return a?A(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},wr=(t,e)=>{const a=t||g.establishmentId;return a?A(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Pe=t=>A(`/api/professionals/${t}`),Do=t=>A(`/api/professionals/details/${t}`),kr=t=>A("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Ka=(t,e)=>A(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),Po=t=>A(`/api/professionals/${t}`,{method:"DELETE"}),Ir=t=>{const e=t.map(a=>Po(a));return Promise.all(e)};class Sr{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const i=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${i.top+window.scrollY-o}px`,this.spotlight.style.left=`${i.left+window.scrollX-o}px`,this.spotlight.style.width=`${i.width+o*2}px`,this.spotlight.style.height=`${i.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(i)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
    ...
    `;try{const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),s=new Date(a);s.setHours(23,59,59,999);const i=new Date(a.getFullYear(),a.getMonth(),1),o=new Date(a.getFullYear(),a.getMonth()+1,0),r=new Date(a);r.setDate(a.getDate()-6);const n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=n.map(async T=>{const[X,ie]=await Promise.all([Ta(T,i.toISOString(),s.toISOString(),null).catch(()=>[]),xt(T).catch(()=>[])]);return{appts:X,clients:ie}}),u=Promise.all([ja({startDate:Ie(i),endDate:Ie(o),establishmentId:l}).catch(()=>({entries:[]})),Is({startDate:Ie(i),endDate:Ie(o),establishmentId:l}).catch(()=>({entries:[]}))]),[c,[p,m]]=await Promise.all([Promise.all(d),u]);let b=[],x=[];c.forEach(T=>{b=b.concat(T.appts),x=x.concat(T.clients)});const v=p.entries||[],I=m.entries||[],S=Ie(a),C=v.filter(T=>T.status==="paid").reduce((T,X)=>T+X.amount,0),V=I.filter(T=>T.status==="paid").reduce((T,X)=>T+X.amount,0),M=C-V,q=v.filter(T=>T.status==="paid"&&(T.paymentDate===S||!T.paymentDate&&T.dueDate.startsWith(S))).reduce((T,X)=>T+X.amount,0),L=b.filter(T=>{const X=new Date(T.startTime);return X>=a&&X<=s}),k=L.length,H=b.filter(T=>T.status==="completed"),z=H.length>0?C/H.length:0,D=L.filter(T=>new Date(T.startTime).getTime()>=e.getTime()&&T.status!=="completed"&&T.status!=="cancelled").sort((T,X)=>new Date(T.startTime)-new Date(X.startTime)).slice(0,4).map(T=>({client:T.clientName||"Desconhecido",service:T.serviceName||(T.services&&T.services[0]?T.services[0].name:"Serviço"),time:new Date(T.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(T.professionalName||"").split(" ")[0]||"Profissionais",id:T.id})),j=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,R=new Map;x.forEach(T=>{T.phone?R.set(T.phone,T):R.set(T.id||Math.random().toString(),T)});const G=Array.from(R.values()).filter(T=>{if(!T.birthDate)return!1;let X,ie;if(T.birthDate.includes("-")){const J=T.birthDate.split("-");J[0].length===4?(X=J[1],ie=J[2]):(ie=J[0],X=J[1])}else if(T.birthDate.includes("/")){const J=T.birthDate.split("/");ie=J[0],X=J[1]}return`${ie}/${X}`===j}).map(T=>{let X="";return T.birthDate&&T.birthDate.includes("-")&&T.birthDate.split("-")[0].length===4&&(X=a.getFullYear()-parseInt(T.birthDate.split("-")[0])),{name:T.name,age:X,phone:T.phone}}),Y={receitaHoje:q,agendamentosHoje:k,receitaMes:C,despesaMes:V,saldoMes:M,ticketMedio:z},Q=n.length>1;en(t,Y,D,G,Q,Ie(r),Ie(a)),await Jo(r,a),an()}catch(e){console.error("Erro ao carregar dashboard:",e),t.innerHTML=`
                            ...
                            ${a.length>0?a.map(d=>`
                                <div data-action="goto-agenda" class="flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-slate-50 hover:bg-indigo-50 hover:border-indigo-200 transition-colors cursor-pointer group">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-semibold text-slate-700 text-[0.8rem] group-hover:text-indigo-700 transition-colors">${y(d.client)}</p>
                                            <p class="text-[10px] font-medium text-slate-500 mt-0.5">${y(d.service)} <span class="mx-1 text-slate-300">•</span> ${y(d.prof)}</p>
                                        </div>
                                    </div>
                            ...
                            ${s.length>0?s.map(d=>{const c=`https://wa.me/${(d.phone||"").replace(/\D/g,"")}?text=${encodeURIComponent(`Olá ${d.name.split(" ")[0]}! A equipa deseja-lhe um Feliz Aniversário! 🎉`)}`;return`
                                <div class="flex items-center justify-between p-2.5 rounded-xl border border-rose-100 bg-rose-50/40 hover:bg-rose-50 transition-colors">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <div>
                                            <p class="font-semibold text-slate-700 text-[0.75rem] leading-tight">${y(d.name)}</p>
    ...
    `}async function Jo(t,e){const a=document.getElementById("chart-container"),s=document.getElementById("chart-start-date"),i=document.getElementById("chart-end-date");if(a){const o=document.createElement("div");o.id="chart-loading-overlay",o.className="absolute inset-0 bg-white/70 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-xl",o.innerHTML='<div class="w-8 h-8 border-[3px] border-indigo-100 border-t-indigo-500 rounded-full animate-spin"></div>',a.appendChild(o)}try{const o=Ie(t),r=Ie(e),n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=await ja({startDate:o,endDate:r,establishmentId:l}).catch(()=>({entries:[]})),u=n.map(C=>Ta(C,o+"T00:00:00.000Z",r+"T23:59:59.999Z",null).catch(()=>[])),p=(await Promise.all(u)).flat(),m=d.entries||[],b=[],x=[],v=[];let I=new Date(t);I.setHours(0,0,0,0);const S=new Date(e);for(S.setHours(23,59,59,999);I<=S;){const C=Ie(I);b.push(I.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}));const V=m.filter(q=>q.status==="paid"&&(q.paymentDate===C||!q.paymentDate&&q.dueDate.startsWith(C))).reduce((q,L)=>q+L.amount,0),M=p.filter(q=>q.status==="completed"&&q.startTime&&q.startTime.startsWith(C)).length;x.push(V),v.push(M),I.setDate(I.getDate()+1)}tn(b,x,v),s&&(s.value=o),i&&(i.value=r)}catch(o){console.error("Erro ao recarregar grafico:",o)}finally{const o=document.getElementById("chart-loading-overlay");o&&o.remove()}}function tn(t,e,a){const s=document.getElementById("revenueChart");if(!s)return;Va&&Va.destroy();const o=s.getContext("2d").createLinearGradient(0,0,0,240);o.addColorStop(0,"rgba(99, 102, 241, 0.2)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)"),Va=new Chart(s,{type:"line",data:{labels:t,datasets:[{label:"Receita Real (R$)",data:e,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.3,yAxisID:"y"},{label:"Agendamentos Feitos",data:a,borderColor:"#10b981",backgroundColor:"transparent",borderWidth:2,borderDash:[5,5],pointBackgroundColor:"#10b981",pointBorderColor:"#ffffff",pointBorderWidth:1,pointRadius:3,pointHoverRadius:5,fill:!1,tension:.3,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,boxHeight:6,font:{family:"Nunito, sans-serif",size:10,weight:"bold"},color:"#64748b"}},tooltip:{backgroundColor:"#1e293b",padding:10,cornerRadius:8,titleFont:{size:11,family:"Nunito, sans-serif",weight:"normal"},bodyFont:{size:12,weight:"bold",family:"Nunito, sans-serif"},displayColors:!0,usePointStyle:!0,callbacks:{label:function(r){return r.datasetIndex===0?"Receita: "+new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(r.parsed.y):"Concluídos: "+r.parsed.y}}}},scales:{y:{type:"linear",display:!0,position:"left",beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"},maxTicksLimit:6,callback:function(r){return"R$ "+r}}},y1:{type:"linear",display:!0,position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1},border:{display:!1},ticks:{color:"#10b981",font:{family:"Nunito, sans-serif",size:9,weight:"600"},stepSize:1,callback:function(r){if(Math.floor(r)===r)return r}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"}}}},interaction:{intersect:!1,mode:"index"}}})}function an(){document.getElementById("content").addEventListener("click",e=>{if(e.target.closest("#btn-update-chart")){const o=document.getElementById("chart-start-date"),r=document.getElementById("chart-end-date");if(o&&r&&o.value&&r.value){const n=new Date(o.value+"T00:00:00"),l=new Date(r.value+"T00:00:00");Jo(n,l)}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"goto-agenda":case"new-appointment":re("agenda-section");break;case"goto-pdv":re("comandas-section");break;case"goto-clients":re("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${g.establishmentId||""}`;window.open(o,"_blank");break}})}const Ge=t=>A(`/api/services/${t}`),sn=t=>A("/api/services",{method:"POST",body:JSON.stringify(t)}),on=(t,e)=>A(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Go=t=>A(`/api/services/${t}`,{method:"DELETE"}),qa=(t,e,a,s="all")=>{const i=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return A(i)},Fa=t=>A("/api/blockages",{method:"POST",body:JSON.stringify(t)}),Ss=t=>A(`/api/blockages/${t}`,{method:"DELETE"}),Qo=t=>A("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})});document.getElementById("content");let Us=!1;const ha=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Na=[],es=[],va={},Yo=[],N={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set,loadedEstablishments:[]},_={step:1,data:{id:null,establishmentId:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Xo(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function la(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}function Es(){const t=document.getElementById("profSelectorContainer");if(!t||!g.professionals)return;let e=g.professionals.filter(i=>N.showInactiveProfs||i.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(i=>{const o=N.selectedProfessionalId===i.id,r=i.name==="Todos"?"T":i.name.charAt(0).toUpperCase(),n=i.id!=="all"?g.professionalColors.get(i.id)||ha[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        `}t.innerHTML=s,t.querySelectorAll('[data-action="select-date"]').forEach(o=>{o.addEventListener("click",()=>{const r=new Date(o.dataset.date);N.currentDate=r,navigator.vibrate&&navigator.vibrate(30),Se()})}),requestAnimationFrame(()=>{const o=t.querySelector(".bg-indigo-600");o&&o.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})})}function te(t){return y(t||"")}function nn(t,e,a,s,i){const o=(t||"").replace(/\D/g,""),r=new Date(i).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(i).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${e}! Você tem um agendamento de ${a} com ${s} para ${r} às ${n}. Podemos confirmar?`;return`https://wa.me/${o}?text=${encodeURIComponent(l)}`}function ln(t){const e=document.getElementById("agenda-view");if(!e)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=Xo(N.currentDate),i=new Date;i.setHours(0,0,0,0);let o='<div class="week-container flex gap-2 overflow-x-auto hide-scrollbar px-4" id="weekScroller">';for(let r=0;r<7;r++){const n=new Date(s);n.setDate(s.getDate()+r);const l=n.toDateString()===i.toDateString(),d=t.filter(c=>new Date(c.startTime).toDateString()===n.toDateString()).sort((c,p)=>new Date(c.startTime)-new Date(p.startTime));let u="";d.length===0?u='<div class="week-empty text-xs text-gray-400 text-center py-4 bg-gray-50 rounded-lg border border-dashed border-gray-200"><i class="bi bi-dash-lg block text-lg mb-1 pointer-events-none"></i>Livre</div>':u=d.map(c=>{const m=new Date(c.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),x=new Date(c.endTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),v=g.professionalColors.get(c.professionalId)||{main:"#adb5bd"},I=c.status==="completed",S=N.selectedItems.has(c.id),C=c.coveredByPlan;if(c.type==="blockage")return`<div class="week-event-chip bg-red-50 border-l-4 border-red-500 rounded-md p-2 mb-2 shadow-sm cursor-default">
                    ...
                    </div>`;const V=S?"ring-2 ring-indigo-500 bg-indigo-50":"bg-white",M=N.isSelectionMode?`<div class="absolute top-1 right-1 z-10 pointer-events-none">
                           <input type="checkbox" class="w-4 h-4 accent-indigo-600 pointer-events-none" ${S?"checked":""}>
                       </div>`:"";let q="";return c.status==="completed"?q='<i class="bi bi-check-all text-green-500 ml-1" title="Finalizado"></i>':c.status==="confirmed"?q='<i class="bi bi-hand-thumbs-up-fill text-blue-500 ml-1" title="Confirmado"></i>':q='<i class="bi bi-clock-history text-orange-400 ml-1" title="Aguardando Confirmação"></i>',`<div class="week-event-chip relative shadow-sm border-l-4 rounded-md p-2 mb-2 cursor-pointer transition-transform active:scale-95 ${I?"opacity-60":""} ${V}" style="border-left-color: ${v.main};"
                    ...
                    <div class="text-xs text-gray-800 font-semibold mt-0.5 truncate pr-2 flex items-center pointer-events-none">
                        ${te(c.clientName)} 
                        ${q}
                        ${C?'<i class="bi bi-gem text-indigo-500 ml-1" title="Cliente VIP"></i>':""}
                    </div>
            ...
            </div>`;return}let a='<div class="list-container px-4 py-2 space-y-4">';t.forEach(s=>{const i=new Date(s.startTime),o=new Date(s.endTime),r=Math.round((o-i)/6e4),n=i.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=g.professionalColors.get(s.professionalId)||{main:"#adb5bd"},u=s.status==="completed",c=N.selectedItems.has(s.id),p=N.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-100 mr-3 pointer-events-none">
            ...
            </div>`;return}const b=nn(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),x=(s.services||[]).reduce((q,L)=>q+(Number(L.price)||0),0)||Number(s.servicePrice||0),v=s.totalAmount!==void 0?Number(s.totalAmount):x,S=s.coveredByPlan?'<span class="bg-indigo-100 text-indigo-700 text-[9px] px-1.5 py-0.5 rounded border border-indigo-200 font-black uppercase tracking-wider ml-1 flex-shrink-0" title="Coberto pelo Plano VIP"><i class="bi bi-gem mr-0.5"></i> VIP</span>':"";let C="";s.status==="completed"?C='<span class="text-[0.65rem] px-2 py-0.5 rounded border font-bold bg-green-50 text-green-700 border-green-200"><i class="bi bi-check-all"></i> Finalizado</span>':s.status==="confirmed"?C='<span class="text-[0.65rem] px-2 py-0.5 rounded border font-bold bg-blue-50 text-blue-700 border-blue-200"><i class="bi bi-hand-thumbs-up-fill"></i> Confirmado</span>':C='<span class="text-[0.65rem] px-2 py-0.5 rounded border font-bold bg-orange-50 text-orange-700 border-orange-200"><i class="bi bi-clock-history"></i> Aguardando Confirmação</span>';const V=te((s.professionalName||"").split(" ")[0]);let M="";if(N.loadedEstablishments.length>1){const q=N.loadedEstablishments.find(k=>k.id===s.establishmentId),L=q?q.name:"Outra Unidade";M=`<span class="text-[0.6rem] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded border border-gray-200 font-bold truncate max-w-[100px]"><i class="bi bi-shop"></i> ${te(L)}</span>`}a+=`<div class="list-card flex rounded-2xl p-3.5 shadow-sm border border-gray-100 ${m} ${u?"opacity-70 bg-gray-50":""}"
            ...
            <div class="flex-1 flex min-w-0 cursor-pointer transition-transform active:scale-[0.98]" data-action="edit-appointment" data-appointment-id="${s.id}">
                ...
                <div class="flex-1 pl-3.5 flex flex-col justify-center min-w-0 pointer-events-none">
                    ...
                    <p class="text-xs text-gray-600 mt-0.5 truncate">${te(s.serviceName)} <span class="font-bold text-indigo-600 px-1">·</span> ${V}</p>
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function Zo(){const t=g.allEvents.filter(e=>N.selectedProfessionalId==="all"||e.professionalId===N.selectedProfessionalId);N.currentView==="list"?dn(t):ln(t),$s()}function $s(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(N.isSelectionMode&&N.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
            <span class="font-semibold text-sm flex items-center"><span class="bg-indigo-500 text-white w-6 h-6 flex items-center justify-center rounded-full mr-2 text-xs">${N.selectedItems.size}</span> selecionados</span>
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function cn(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(N.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(N.currentView==="list"){rn();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function Se(){const t=document.getElementById("agenda-view");if(!t)return;N.selectedItems.clear(),$s(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',cn();let e,a;if(N.currentView==="list")e=new Date(N.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=Xo(N.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const i=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async u=>{const[c,p]=await Promise.all([Ta(u,e.toISOString(),a.toISOString(),N.selectedProfessionalId==="all"?null:N.selectedProfessionalId),qa(u,e.toISOString(),a.toISOString(),N.selectedProfessionalId)]);return{appts:c||[],blockages:p||[]}}),o=await Promise.all(i);let r=[],n=[];if(o.forEach(u=>{r=r.concat(u.appts),n=n.concat(u.blockages)}),!document.getElementById("agenda-view"))return;const l=u=>u.map(c=>({...c,type:"appointment",professionalName:c.professionalName||(()=>{const p=g.professionals?.find(m=>m.id===c.professionalId);return p?p.name:"Indefinido"})()})),d=u=>u.map(c=>({...c,type:"blockage",professionalName:c.professionalName||(()=>{const p=g.professionals?.find(m=>m.id===c.professionalId);return p?p.name:"Indefinido"})()}));g.allEvents=[...l(r),...d(n)],Es(),Zo()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function un(){try{const e=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async r=>{const[n,l,d]=await Promise.all([Pe(r),Ge(r),Me(r)]);return{estId:r,profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,i=new Map;let o=a[0]?.estDetails;N.loadedEstablishments=a.map(r=>({id:r.estId,name:r.estDetails?.nomeFantasia||r.estDetails?.name||`Unidade ${r.estId.substring(0,4)}`})),a.forEach(r=>{r.profs.forEach(n=>s.set(n.id,n)),r.services.forEach(n=>i.set(n.id,n))}),g.professionals=Array.from(s.values()),g.services=Array.from(i.values()),Yo=[],o&&(va=o.loyaltyProgram||{enabled:!1}),g.professionals.forEach((r,n)=>{g.professionalColors.set(r.id,ha[n%ha.length])}),Es()}catch{f("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function pn(t,e){if(!await K("Confirmar Agendamento","Deseja confirmar este agendamento manualmente?"))return;const s=e.innerHTML;e.innerHTML='<div class="w-5 h-5 border-2 border-blue-200 border-t-blue-600 rounded-full animate-spin pointer-events-none"></div>',e.disabled=!0;try{await dr(t,"confirmed"),f("Agendamento confirmado!","success"),Se()}catch(i){console.error("Erro ao confirmar:",i),f("Erro ao confirmar: "+i.message,"error"),e.innerHTML=s,e.disabled=!1}}function Ws(){const t=document.getElementById("estSelectorModal");t&&t.remove();const e=document.createElement("div");e.id="estSelectorModal",e.className="fixed inset-0 z-[11000] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm transition-opacity duration-300 px-4 opacity-0";const a=(N.loadedEstablishments||[]).map(i=>`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.remove("opacity-0");const i=e.querySelector("#estSelectorModalContent");i.classList.remove("scale-95"),i.classList.add("scale-100")});const s=()=>{e.classList.add("opacity-0");const i=e.querySelector("#estSelectorModalContent");i.classList.remove("scale-100"),i.classList.add("scale-95"),setTimeout(()=>e.remove(),300)};document.getElementById("closeEstModalBtn").addEventListener("click",s),e.querySelectorAll(".est-option-btn").forEach(i=>{i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=i.dataset.estId;s(),setTimeout(()=>{Et({establishmentId:o},!1)},300)})})}async function Ko(t={}){N.currentDate=t.targetDate?new Date(t.targetDate):N.currentDate||new Date,N.isSelectionMode=!1,N.selectedItems.clear();const e=document.getElementById("content");if(!e)return;e.innerHTML=`
                ...
                <div class="flex justify-between items-center px-4 py-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="agenda-view-toggle bg-gray-100 p-1 rounded-xl flex gap-1">
                            <button type="button" class="${N.currentView==="list"?"bg-white shadow-sm":"text-gray-500"} rounded-lg px-3 py-1 text-xs font-bold transition-all" data-action="setView" data-view="list">Lista</button>
                            <button type="button" class="${N.currentView==="week"?"bg-white shadow-sm":"text-gray-500"} rounded-lg px-3 py-1 text-xs font-bold transition-all" data-action="setView" data-view="week">Semana</button>
                        </div>
                    </div>
                </div>
        ...
        </div>`,document.getElementById("btnTodayHeader").addEventListener("click",()=>{N.currentDate=new Date,navigator.vibrate&&navigator.vibrate(30),Se()}),document.getElementById("btnPrevDate").addEventListener("click",()=>{const s=N.currentView==="week"?7:1;N.currentDate.setDate(N.currentDate.getDate()-s),navigator.vibrate&&navigator.vibrate(20),Se()}),document.getElementById("btnNextDate").addEventListener("click",()=>{const s=N.currentView==="week"?7:1;N.currentDate.setDate(N.currentDate.getDate()+s),navigator.vibrate&&navigator.vibrate(20),Se()});const a=document.querySelectorAll(".agenda-view-toggle button");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(i=>{i.classList.remove("bg-white","shadow-sm"),i.classList.add("text-gray-500")}),s.classList.add("bg-white","shadow-sm"),s.classList.remove("text-gray-500"),N.currentView=s.dataset.view,navigator.vibrate&&navigator.vibrate(20),Se()})}),document.getElementById("btnWeekDays").addEventListener("click",bn),Us||(document.body.addEventListener("click",async s=>{if(!document.getElementById("agenda-view"))return;const i=s.target.closest('[data-action="confirm-appointment"]');if(i){s.preventDefault(),s.stopPropagation(),navigator.vibrate&&navigator.vibrate(20);const c=i.dataset.appointmentId;if(!c)return;pn(c,i);return}const o=s.target.closest('[data-action="open-comanda"]');if(o){s.preventDefault(),s.stopPropagation(),navigator.vibrate&&navigator.vibrate(20);const c=o.dataset.appointmentId;if(!c)return;const p=g.allEvents.find(x=>x.id===c);if(!p)return;const m=p.status==="completed"?"finalizadas":"em-atendimento",b={selectedAppointmentId:p.id,initialFilter:m};m==="finalizadas"&&p.transaction?.paidAt&&(b.filterDate=typeof p.transaction.paidAt=="object"?new Date(p.transaction.paidAt._seconds*1e3):p.transaction.paidAt),re("comandas-section",b);return}const r=s.target.closest(".lc-action-btn.wa");if(r){s.preventDefault(),s.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),r.dataset.link&&window.open(r.dataset.link,"_blank");return}if(s.target.closest('[data-action="batch-delete"]')){s.preventDefault(),s.stopPropagation();const c=N.selectedItems.size;await K("Apagar Selecionados",`Deseja apagar ${c} registro(s)? Esta ação é irreversível.`)&&(await Promise.all(Array.from(N.selectedItems).map(async m=>{try{await cr(m)}catch{}})),f(`${c} registro(s) apagado(s).`,"success"),N.selectedItems.clear(),N.isSelectionMode=!1,Se());return}const l=s.target.closest('[data-action="select-professional"]');if(l){s.preventDefault(),s.stopPropagation(),navigator.vibrate&&navigator.vibrate(20);const c=l.dataset.profId;N.selectedProfessionalId=N.selectedProfessionalId===c&&c!=="all"?"all":c,Se();return}if(s.target.closest('[data-action="open-new-appointment-modal"]')){if(s.preventDefault(),s.stopPropagation(),navigator.vibrate&&navigator.vibrate(30),N.loadedEstablishments&&N.loadedEstablishments.length>1)Ws();else{const c=N.loadedEstablishments&&N.loadedEstablishments.length===1?N.loadedEstablishments[0].id:g.establishmentId;Et({establishmentId:c},!1)}return}const u=s.target.closest('[data-action="edit-appointment"]');if(u){s.preventDefault(),s.stopPropagation();const c=u.dataset.appointmentId,p=g.allEvents.find(m=>m.id===c);if(N.isSelectionMode){const m=u.closest(".list-card, .week-event-chip");if(!m)return;const b=m.querySelector('input[type="checkbox"]');if(b&&p){const x=!b.checked;b.checked=x,x?N.selectedItems.add(p.id):N.selectedItems.delete(p.id),(m.classList.contains("week-event-chip")||m.classList.contains("list-card"))&&(x?(m.classList.add("ring-2","ring-indigo-500","bg-indigo-50"),m.classList.remove("bg-white")):(m.classList.remove("ring-2","ring-indigo-500","bg-indigo-50"),m.classList.add("bg-white"))),navigator.vibrate&&navigator.vibrate(15),$s()}return}p&&(navigator.vibrate&&navigator.vibrate(20),Et(p));return}}),Us=!0),await un(),await Se(),(t.action==="new-appointment"||t.openNewAppointment)&&setTimeout(()=>{if(N.loadedEstablishments&&N.loadedEstablishments.length>1)Ws();else{const s=N.loadedEstablishments&&N.loadedEstablishments.length===1?N.loadedEstablishments[0].id:g.establishmentId;Et({establishmentId:s},!1)}},500)}function bn(){const t=document.getElementById("optionsSheet");if(t){t.remove();return}const e=document.createElement("div");e.id="optionsSheet",e.className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white rounded-t-3xl z-[10000] shadow-[0_-8px_40px_rgba(0,0,0,0.15)] transition-transform duration-300 translate-y-full";const a=N.isSelectionMode?"bg-red-50 text-red-600":"bg-green-50 text-green-700",s=N.isSelectionMode?"bi-x-circle":"bi-check2-square";e.innerHTML=`
        <div class="px-6 py-5">
            ...
            <div class="mb-5">
                ...
                <button type="button" id="optSelectMode" class="w-full py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 ${a} transition-colors active:scale-95">
                    <i class="bi ${s} text-lg pointer-events-none"></i> ${N.isSelectionMode?"Desativar Modo de Exclusão":"Ativar Seleção Múltipla"}
                </button>
                <p class="text-xs text-gray-500 text-center mt-2.5">${N.isSelectionMode?"Toque num cartão para desmarcar.":"Permite selecionar vários registros para apagar."}</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <label class="flex items-center gap-3 p-3.5 bg-gray-50 border border-gray-100 rounded-xl cursor-pointer">
                    <input type="checkbox" id="optInactiveToggle" class="w-5 h-5 accent-indigo-600 rounded" ${N.showInactiveProfs?"checked":""}>
                    <span class="text-sm font-semibold text-gray-700">Exibir profissionais inativos na barra</span>
                </label>
            </div>
        </div>`;const i=document.createElement("div");i.id="optionsOverlay",i.className="fixed inset-0 bg-black/40 z-[9999] opacity-0 transition-opacity duration-300",document.body.appendChild(i),document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.remove("translate-y-full"),i.classList.remove("opacity-0")});const o=()=>{e.classList.add("translate-y-full"),i.classList.add("opacity-0"),setTimeout(()=>{e.remove(),i.remove()},300)};document.getElementById("closeOptSheet").addEventListener("click",o),i.addEventListener("click",o),document.getElementById("optSelectMode").addEventListener("click",()=>{N.isSelectionMode=!N.isSelectionMode,N.isSelectionMode||N.selectedItems.clear(),o(),Zo()}),document.getElementById("optInactiveToggle").addEventListener("change",r=>{N.showInactiveProfs=r.target.checked,Es()})}function yt(t){t<1||t>4||(_.step=t,Et(null,!0))}function mn(t){return{title:t?"Editar Reserva":"Novo Cliente",content:`
        <div class="p-4 space-y-4 flex-1">
            <div class="space-y-3">
                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Nome Completo</label>
                    <input type="text" id="apptClientName" placeholder="Ex: João Silva" class="w-full p-3 bg-white border border-gray-300 rounded-xl text-sm text-gray-900 font-semibold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all shadow-sm" value="${te(_.data.clientName)}">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">WhatsApp / Telefone</label>
                    <input type="tel" id="apptClientPhone" placeholder="(00) 00000-0000" class="w-full p-3 bg-white border border-gray-300 rounded-xl text-sm text-gray-900 font-semibold focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all shadow-sm" value="${te(_.data.clientPhone)}">
                </div>
            </div>
        ...
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            <div class="flex items-center gap-3">
                ...
                <label class="flex items-center gap-2 bg-white px-3 py-3 rounded-xl border border-gray-200 cursor-pointer shadow-sm">
                    <input type="checkbox" id="multiServiceToggle" class="w-5 h-5 accent-indigo-600 rounded" ${_.data.selectedServiceIds.length>1?"checked":""}>
            ...
            <div id="apptServicesContainer" class="flex-1 overflow-y-auto grid grid-cols-2 gap-3 content-start pb-4">
                ${Na.map(t=>`<div class="service-card p-3 bg-white rounded-xl border-2 transition-all active:scale-95 ${_.data.selectedServiceIds.includes(t.id)?"border-indigo-500 bg-indigo-50 shadow-md":"border-gray-100 hover:border-gray-200 shadow-sm"} cursor-pointer flex flex-col justify-between gap-2" data-service-id="${t.id}">
                        <div>
        ...
        </div>`}}function xn(){const t=_.data.date||la();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            
            <div class="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-xl shadow-sm">
                <div class="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-black text-lg">${te(_.data.clientName).charAt(0)}</div>
                <div class="flex-1 min-w-0">
                    <p class="font-bold text-sm text-gray-900 truncate">${te(_.data.clientName)}</p>
                    <p class="text-xs font-bold text-gray-500 truncate mt-0.5"><i class="bi bi-person-badge mr-1"></i> ${te(_.data.professionalName)}</p>
                </div>
            </div>
        ...
        <div class="p-4 bg-white border-t border-gray-200 flex gap-3 pb-safe">
            ...
            <button type="button" id="btnSubmitAppointment" class="w-2/3 py-3.5 bg-indigo-600 text-white font-bold rounded-xl shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2 text-sm">
                <i class="bi bi-check-circle-fill pointer-events-none"></i> ${_.data.id?"Salvar":"Confirmar"}
            </button>
        </div>`}}async function Et(t=null,e=!1){const a=document.getElementById("appointmentModal");e||(_={step:1,data:{id:t?.id||null,establishmentId:t?.establishmentId||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(r=>r.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:t?.startTime?la(new Date(t.startTime)):la(),time:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,originalDate:t?.startTime?la(new Date(t.startTime)):null,originalTime:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}}),Na=g.services||[],es=(g.professionals||[]).filter(r=>r.status==="active");let s;switch(_.step){case 1:s=mn(t);break;case 2:s=gn();break;case 3:s=fn();break;case 4:s=xn();break}a.className="fixed inset-0 z-[10000] hidden flex items-end md:items-center justify-center bg-gray-900/50 backdrop-blur-sm transition-opacity duration-300 opacity-0",a.innerHTML=`
            ...
            <header class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between pt-safe-top md:pt-4 shadow-sm z-20">
                ...
                <div class="text-center flex-1 px-2">
                    ...
                    <div class="flex items-center justify-center gap-1 mt-1">
                        <div class="w-2 h-2 rounded-full ${_.step>=1?"bg-indigo-600":"bg-gray-200"}"></div>
                        <div class="w-2 h-2 rounded-full ${_.step>=2?"bg-indigo-600":"bg-gray-200"}"></div>
                        <div class="w-2 h-2 rounded-full ${_.step>=3?"bg-indigo-600":"bg-gray-200"}"></div>
                        <div class="w-2 h-2 rounded-full ${_.step>=4?"bg-indigo-600":"bg-gray-200"}"></div>
                    </div>
                </div>
    ...
    `;const i=()=>{const r=a.querySelector("#appointmentModalContent");r&&(r.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),r.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),a.classList.add("opacity-0"),setTimeout(()=>{a.classList.add("hidden")},300)};a.querySelectorAll('[data-action="next-step"]').forEach(r=>r.addEventListener("click",()=>{const n=parseInt(r.dataset.currentStep,10);if(n===1&&(_.data.clientName=a.querySelector("#apptClientName").value.trim(),_.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!_.data.clientName))return f("Preencha o nome do cliente.","warning");if(n===2&&_.data.selectedServiceIds.length===0)return f("Selecione um serviço.","warning");if(n===3&&!_.data.professionalId)return f("Escolha um membro da equipe.","warning");yt(n+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(r=>r.addEventListener("click",()=>yt(parseInt(r.dataset.currentStep,10)-1))),a.querySelectorAll('[data-action="close-modal"]').forEach(r=>{r.addEventListener("click",i)}),a.classList.remove("hidden"),a.offsetWidth,a.classList.remove("opacity-0");const o=a.querySelector("#appointmentModalContent");o&&(o.classList.remove("translate-y-full","md:translate-y-8","md:scale-95"),o.classList.add("translate-y-0","md:translate-y-0","md:scale-100")),_.step===2&&a.querySelectorAll(".service-card").forEach(r=>r.addEventListener("click",()=>{const n=a.querySelector("#multiServiceToggle")?.checked,l=r.classList.contains("bg-indigo-50"),d=r.dataset.serviceId;navigator.vibrate&&navigator.vibrate(15),n?l?(r.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.add("border-gray-100","shadow-sm"),_.data.selectedServiceIds=_.data.selectedServiceIds.filter(u=>u!==d)):(r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),_.data.selectedServiceIds.includes(d)||_.data.selectedServiceIds.push(d)):(a.querySelectorAll(".service-card.bg-indigo-50").forEach(u=>{u.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),u.classList.add("border-gray-100","shadow-sm")}),r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),_.data.selectedServiceIds=[d],setTimeout(()=>yt(3),250))})),_.step===3&&a.querySelectorAll(".professional-modal-card").forEach(r=>r.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),a.querySelectorAll(".professional-modal-card.bg-indigo-50").forEach(l=>{l.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),l.classList.add("border-gray-100","shadow-sm")}),r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),_.data.professionalId=r.dataset.professionalId;const n=es.find(l=>l.id===r.dataset.professionalId);_.data.professionalName=n?n.name:"",setTimeout(()=>yt(4),250)})),_.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",r=>yn(r.target.value)),_.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",Js),a.querySelector("#availableTimesContainer")?.addEventListener("click",r=>{const n=r.target.closest("button[data-time-slot]");n&&(navigator.vibrate&&navigator.vibrate(10),a.querySelectorAll("#availableTimesContainer button").forEach(l=>{l.classList.remove("bg-indigo-600","text-white","border-indigo-600","shadow-md"),l.classList.add("bg-white","text-gray-700","border-gray-200","shadow-sm")}),n.classList.add("bg-indigo-600","text-white","border-indigo-600","shadow-md"),n.classList.remove("bg-white","text-gray-700","border-gray-200","shadow-sm"),_.data.time=n.dataset.timeSlot)}),a.querySelector("#btnSubmitAppointment")?.addEventListener("click",hn),Js(),vn())}async function hn(t){t.preventDefault();const e=document.getElementById("btnSubmitAppointment");if(!_.data.time||!_.data.selectedServiceIds.length||!_.data.professionalId)return f("Selecione horário, serviço e profissional.","warning");e.disabled=!0,e.innerHTML='<i class="bi bi-hourglass-split pointer-events-none"></i> Processando...';const a=_.data.selectedServiceIds.map(u=>{const c=Na.find(p=>p.id===u);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[s,i]=_.data.time.split(":"),o=new Date(`${_.data.date}T${s}:${i}:00`),r=a.reduce((u,c)=>u+(c.duration+(c.bufferTime||0)),0),n=new Date(o.getTime()+r*6e4),d={establishmentId:_.data.establishmentId||(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId),clientName:_.data.clientName,clientPhone:_.data.clientPhone,services:a,professionalId:_.data.professionalId,professionalName:_.data.professionalName,startTime:o.toISOString(),endTime:n.toISOString(),redeemedReward:_.data.redeemedReward};_.data.id&&(d.id=_.data.id);try{_.data.id?await lr(_.data.id,d):await nr(d),f("Registro salvo!","success");const u=document.getElementById("appointmentModal"),c=u.querySelector("#appointmentModalContent");c&&(c.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),c.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),u.classList.add("opacity-0"),setTimeout(()=>{u.classList.add("hidden")},300),Se()}catch(u){f(u.message,"error"),e.disabled=!1,e.innerHTML=`<i class="bi bi-check-circle-fill pointer-events-none"></i> ${_.data.id?"Salvar Edição":"Confirmar"}`}}async function Js(){const t=document.getElementById("availableTimesContainer"),e=document.getElementById("apptTotalDuration");if(!t)return;const a=document.getElementById("apptDate");a&&a.value&&(_.data.date=a.value);const s=_.data.selectedServiceIds.reduce((u,c)=>{const p=Na.find(m=>m.id===c);return u+(p?p.duration+(p.bufferTime||0):0)},0);e&&(e.innerHTML=`<strong>${s}</strong> min`);const{professionalId:i,selectedServiceIds:o,date:r,originalDate:n,originalTime:l,id:d}=_.data;if(!i||!o.length||!r){t.innerHTML='<p class="col-span-full text-center text-xs text-gray-500 font-bold py-4 bg-white rounded-xl shadow-sm border border-gray-100">Preencha os passos anteriores.</p>';return}t.innerHTML='<div class="col-span-full flex justify-center py-4"><div class="w-6 h-6 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div></div>';try{const u=_.data.establishmentId||(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId);let c=await rr({establishmentId:u,professionalId:i,serviceIds:o,date:r});const p=new Date;if(new Date(r+"T00:00:00").toDateString()===p.toDateString()){const m=p.getHours()*60+p.getMinutes();c=c.filter(b=>{const[x,v]=b.split(":").map(Number);return x*60+v>=m})}d&&r===n&&l&&(c.includes(l)||(c.push(l),c.sort())),t.innerHTML=c.length>0?c.map(m=>{const b=_.data.time===m;return`<button type="button" data-time-slot="${m}" class="py-3 text-sm font-bold rounded-xl border-2 transition-transform active:scale-95 ${b?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-white text-gray-700 border-gray-200 hover:border-indigo-300 shadow-sm"}">${m}</button>`}).join(""):'<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl border border-red-100 shadow-sm">Nenhum horário livre.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl">Erro ao pesquisar.</p>'}}function vn(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:a}=_.data,{enabled:s,rewards:i}=va;if(!s||!e||!i?.length){t.innerHTML="";return}const o=i.filter(r=>a>=r.points);if(!o.length){t.innerHTML='<p class="text-xs font-bold text-gray-400 mt-3 text-center">Nenhuma recompensa atingida ainda.</p>';return}t.innerHTML=`<div class="border border-indigo-100 bg-indigo-50/80 rounded-xl p-3 mt-3 shadow-sm">
    ...
    `,document.body.appendChild(a);try{const s=(t.comandaItems||[]).filter(i=>i&&i.id&&String(i.id)!=="undefined"&&String(i.id)!=="null").map(i=>{const o={...i};if(o.id=String(i.id),o.type==="product"){const r=o.id;o.productId||(o.productId=r),o.product_id||(o.product_id=r)}if(o.type==="service"){const r=o.id;o.serviceId||(o.serviceId=r),o.service_id||(o.service_id=r)}return o});t.type==="walk-in"&&String(t.id).startsWith("temp-")||await ei(t.id,s),document.body.contains(a)&&document.body.removeChild(a),e!=="checkout"&&(f("Sucesso","Comanda atualizada e salva!","success"),se())}catch(s){document.body.contains(a)&&document.body.removeChild(a),t._hasUnsavedChanges=!0,se(),f("Erro","Falha ao salvar no servidor: "+s.message,"warning")}}function Fe(t){if(!t._cachedItems){let e=[];if(t.status==="completed"){const a=t.comandaItems||t.items||[];e=a.length>0?a:t.services||[]}else{const a=(t.services||[]).map(r=>({...r,_source:"original_service",type:"service"})),s=a.reduce((r,n)=>{const l=String(n.id);return r[l]=(r[l]||0)+1,r},{}),i=[...t.comandaItems||[],...t.items||[]],o=[];i.forEach(r=>{const n=String(r.id);(r.type==="service"||!r.type)&&s[n]>0?s[n]--:o.push({...r,_source:"extra"})}),e=[...a,...o]}return t._cachedItems=e,t._cachedTimestamp=Date.now(),e}return t._cachedItems}function Fn(){const t=document.getElementById("comandas-layout");t&&t.classList.add("mobile-detail-open");const e=document.getElementById("mobile-bottom-nav");e&&(e.style.display="none")}function it(){const t=document.getElementById("comandas-layout");t&&t.classList.remove("mobile-detail-open");const e=document.getElementById("mobile-bottom-nav");e&&(e.style.display="")}function Nn(){const t=xe(new Date);let e=h.allComandas||[];h.filterPreset==="hoje"?e=e.filter(u=>{const c=xe(u.startTime||u.date||u.createdAt);return u.status!=="completed"&&c<=t||u.status==="completed"&&c===t}):h.filterPreset!=="custom"&&(e=e.filter(u=>xe(u.startTime||u.date||u.createdAt)<=t));const a=e.filter(u=>u.status!=="completed").length,s=e.filter(u=>u.status==="completed"),i=s.reduce((u,c)=>{let p=0;if(c.totalAmount!==void 0&&c.totalAmount!==null)p=Number(c.totalAmount);else{let m=Fe(c).reduce((b,x)=>b+Number(x.price||0),0);p=Math.max(0,m-Number(c.planDiscount||0))}return u+p},0),o=s.length>0?i/s.length:0,r=document.getElementById("kpi-abertas"),n=document.getElementById("kpi-pagas"),l=document.getElementById("kpi-vendas"),d=document.getElementById("kpi-ticket");r&&(r.textContent=a),n&&(n.textContent=s.length),l&&(l.textContent=`R$ ${i.toFixed(2).replace(".",",")}`),d&&(d.textContent=`R$ ${o.toFixed(2).replace(".",",")}`)}function zt(){at.innerHTML=`
    ...
    `,Ra(),Ds()}function Ds(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${h.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function Ra(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");h.isCashierFromPreviousDay?(t&&(t.innerHTML=`
        ...
        `,e&&(e.innerHTML="");return}const a=xe(new Date);let s=h.allComandas||[];if(h.filterPreset==="hoje"?s=s.filter(o=>{const r=xe(o.startTime||o.date||o.createdAt);return h.activeFilter==="abertas"?o.status!=="completed"&&r<=a:h.activeFilter==="pagas"?o.status==="completed"&&r===a:o.status!=="completed"&&r<=a||o.status==="completed"&&r===a}):h.filterPreset!=="custom"?s=s.filter(o=>{const r=xe(o.startTime||o.date||o.createdAt);return h.activeFilter==="abertas"?o.status!=="completed"&&r<=a:h.activeFilter==="pagas"?o.status==="completed"&&r<=a:r<=a}):h.activeFilter==="abertas"?s=s.filter(o=>o.status!=="completed"):h.activeFilter==="pagas"&&(s=s.filter(o=>o.status==="completed")),Nn(),s.length===0){t.innerHTML='<p class="text-center text-gray-400 py-12 text-sm font-medium border border-dashed border-gray-200 rounded-2xl mx-2">Nenhuma comanda encontrada.</p>',Xs(e);return}const i=document.createDocumentFragment();s.forEach(o=>{const r=Fe(o);let n=0;if(o.status==="completed"&&o.totalAmount!==void 0&&o.totalAmount!==null)n=Number(o.totalAmount);else{const q=r.reduce((L,k)=>L+Number(k.price||0),0);n=Math.max(0,q-Number(o.planDiscount||0))}const d=o.loyaltyRedemption||o.discount&&o.discount.reason&&String(o.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-1.5 text-xs shadow-sm border border-yellow-200" title="Prémio Resgatado">🎁</span>':"",c=o.coveredByPlan?'<span class="inline-flex items-center justify-center bg-indigo-100 text-indigo-700 rounded-md px-2 py-0.5 text-[9px] font-black border border-indigo-200 uppercase tracking-wider shadow-sm ml-1.5" title="Clube VIP"><i class="bi bi-gem mr-1"></i> VIP</span>':"",p=String(o.id)===String(h.selectedComandaId),m=new Date(o.startTime||o.date||o.createdAt),b=m.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),x=m.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),v=o.type==="walk-in"||typeof o.id=="string"&&o.id.startsWith("temp-"),I=o.status==="completed",S=y(o.clientName||"Cliente sem nome"),C=y(o.professionalName||"Sem profissional");let V="";I?V='<span class="text-[10px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-md border border-emerald-200">Paga</span>':v?V='<span class="text-[10px] font-black uppercase tracking-wider text-blue-700 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':V='<span class="text-[10px] font-black uppercase tracking-wider text-indigo-700 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const M=document.createElement("div");M.className=`comanda-card cursor-pointer border rounded-2xl p-3.5 hover:bg-gray-50 transition-all shadow-sm mb-2 ${p?"ring-2 ring-indigo-500 bg-indigo-50/50 border-transparent":"bg-white border-gray-200"}`,M.dataset.action="select-comanda",M.dataset.comandaId=o.id,M.innerHTML=`
            ...
            <div class="flex justify-between items-center mt-1 pointer-events-none gap-2">
                <div class="flex items-center gap-2 min-w-0 flex-1">
                    ${V}
                    <p class="text-xs text-gray-500 truncate font-medium"><i class="bi bi-person mr-1 opacity-50"></i>${C}</p>
                </div>
        ...
        `,i.appendChild(M)}),t.innerHTML="",t.appendChild(i),Xs(e)}function Xs(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=h.paging,i=Math.ceil((a||0)/s);if(i===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full py-1",o.innerHTML=`
    ...
    `;const s=(o="")=>{const r=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600"></i>',product:'<i class="bi bi-box-seam text-emerald-600"></i>',package:'<i class="bi bi-boxes text-purple-600"></i>'},l={"catalog-service-list":{items:h.catalog.services,type:"service"},"catalog-product-list":{items:h.catalog.products,type:"product"},"catalog-package-list":{items:h.catalog.packages,type:"package"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=e.querySelector("#"+d);if(!p)return;const m=u.filter(b=>b.name.toLowerCase().includes(r)).slice(0,50);p.innerHTML=m.map(b=>b.id?`
                <button data-action="select-catalog-item" data-item-type="${c}" data-item-id="${b.id}" class="flex items-center gap-3 w-full p-3 bg-white border border-gray-200 rounded-xl hover:border-indigo-400 hover:bg-indigo-50 shadow-sm transition-all text-left group active:scale-95">
                    ...
                    <span class="flex-grow text-sm font-bold text-gray-800 line-clamp-2 leading-tight group-hover:text-indigo-700">${y(b.name)}</span>
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto flex flex-col items-center justify-center p-4 bg-slate-50 relative custom-scrollbar">
            <div class="text-center bg-white p-5 md:p-6 rounded-3xl shadow-sm border border-gray-200 w-full max-w-sm">
                ...
                <h3 class="font-black text-lg md:text-xl text-gray-900 leading-tight mb-2 line-clamp-2">${y(a.name)}</h3>
    ...
    `;if(h.isCashierFromPreviousDay){t.innerHTML=`
        ...
        `;return}const s=Fe(e),i=e.status==="completed",o=e.type==="walk-in"||typeof e.id=="string"&&e.id.startsWith("temp-"),r=s.reduce((S,C)=>{const V=C._source==="original_service",M=C.id||C.name,q=V?`original-${M}`:`${C.type}-${M}`;return S[q]||(S[q]={...C,quantity:0,sources:[]}),S[q].quantity+=1,C._source&&S[q].sources.push(C._source),S},{}),n=Number(e.planDiscount||0),l=Object.values(r).reduce((S,C)=>S+Number(C.price||0)*C.quantity,0),d=Math.max(0,l-n),u=y(e.clientName||"Cliente sem nome"),c=y(e.professionalName||"Profissional não atribuído"),p=e._hasUnsavedChanges,b=e.coveredByPlan?'<span class="mt-2 inline-block px-2 py-1 text-[10px] font-black uppercase tracking-widest text-indigo-700 bg-indigo-100 border border-indigo-200 rounded-md shadow-sm"><i class="bi bi-gem"></i> Clube VIP Aplicado</span>':"",x=i?"":`
    ...
    `;t.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-36 md:pb-6 custom-scrollbar bg-slate-50 relative"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(r).map(S=>{const C=S.sources&&S.sources.includes("original_service"),V=h.pendingRedemption&&String(h.pendingRedemption.appliedToItemId)===String(S.id),M=S.isReward||V;return`
                    <div class="flex flex-col bg-white p-4 rounded-2xl border border-gray-200 shadow-sm ${M?"border-yellow-400 bg-yellow-50 ring-2 ring-yellow-200":""}">
                        <div class="flex justify-between items-start w-full">
                            <div class="min-w-0 flex-1 pr-3">
                                ...
                                <div class="flex items-center mt-2 gap-2">
                                    ${C?'<span class="text-[9px] font-black uppercase tracking-widest text-indigo-700 bg-indigo-100 px-2 py-1 rounded-md border border-indigo-200">Fixo Agenda</span>':""}
                                    <p class="text-xs text-gray-500 font-bold">${M?'<span class="text-yellow-700 font-black bg-yellow-100 px-2 py-1 rounded-md border border-yellow-200">Resgate</span>':`R$ ${(S.price||0).toFixed(2)} un.`}</p>
                                </div>
                            </div>
    ...
    `;e.innerHTML=`
        ...
        ${p}
    `;const m=()=>{const b=h.checkoutState.discount.type,x=h.checkoutState.discount.value;let v=b==="percent"?i*x/100:x;v>i&&(v=i);const I=Math.max(0,i-v-a),S=h.checkoutState.payments.reduce((L,k)=>L+k.value,0),C=Math.max(0,I-S),V=e.querySelector("#checkout-total-display");V&&(V.textContent=`R$ ${I.toFixed(2)}`);const M=e.querySelector("#checkout-status-msg");M&&(C<=.01?M.innerHTML='<p class="text-emerald-500 font-black text-base uppercase tracking-widest"><i class="bi bi-check2-circle text-2xl mr-2 align-middle"></i> Totalmente Pago</p>':M.innerHTML=`<p class="text-red-500 font-bold text-sm uppercase tracking-widest">Faltam: <span id="checkout-remaining-display" class="font-black text-xl text-red-600 ml-1">R$ ${C.toFixed(2)}</span></p>`);const q=e.querySelector("#checkout-amount");q&&C>0&&document.activeElement!==q&&(q.value=C.toFixed(2))};e.querySelector("#discount-value")?.addEventListener("input",b=>{const x=parseFloat(b.target.value)||0;h.checkoutState.discount.value=x,m()}),e.querySelector("#discount-type")?.addEventListener("change",b=>{h.checkoutState.discount.type=b.target.value,m()}),e.querySelector("#discount-reason")?.addEventListener("input",b=>{h.checkoutState.discountReason=b.target.value}),e.querySelector("#checkout-amount")?.addEventListener("input",b=>{h.checkoutState.amountReceived=b.target.value}),e.querySelector("#checkout-installments")?.addEventListener("change",b=>{h.checkoutState.installments=parseInt(b.target.value,10)})}async function _n(t,e){if(!e)return;const a=h.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(t.clientId)s=await jo(g.establishmentId,t.clientId);else if(t.clientName){const n=await xt(g.establishmentId,t.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const i=Number(s.loyaltyPoints)||0,r=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&i>=l});if(r.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-2xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
            <div class="flex items-center gap-3">
                    ...
                    <button data-action="select-reward" data-reward-id="${o.id||n}" class="w-full flex items-center justify-between p-4 bg-white border border-gray-200 rounded-2xl hover:border-yellow-400 hover:bg-yellow-50 transition-all group shadow-sm text-left active:scale-95">
                        <div class="flex-1 min-w-0 pr-3">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <p class="font-black text-gray-900 group-hover:text-yellow-700 text-base truncate">${y(n)}</p>
                            </div>
    ...
    `,{modalElement:s,close:i}=Ne({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",o=>{const r=o.target.closest('[data-action="select-reward"]');if(r){const n=r.dataset.rewardId,l=t.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(Un(l,e),i())}})}async function Un(t,e){const a=Number(t.costPoints||t.points||0),s=t.name||t.reward,i=t.type||"money";if(i==="money"){const l=parseFloat(t.discount)||0;if(l<=0){f("Erro","O valor do desconto configurado é inválido.","error");return}h.checkoutState.discount={type:"real",value:l},h.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,h.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:"money"},f("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),se();return}const o=Fe(e),r=t.itemId?String(t.itemId):null;if(!r){f("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");return}const n=o.find(l=>{const d=l.id?String(l.id):null,u=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,c=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return i==="service"?d===r||u===r:i==="product"?d===r||c===r:i==="package"?d===r:!1});if(n){let l=parseFloat(t.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),h.checkoutState.discount={type:"real",value:l},h.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,h.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:i,appliedToItemId:n.id},f("Sucesso",`Prémio "${s}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),se()}else f("Item Não Encontrado",`Para resgatar o prémio "${s}", o ${i==="service"?"serviço":i==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}async function as(t=null){if(!h.isCashierOpen)return f("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(h.isCashierFromPreviousDay)return f("Ação Bloqueada","Feche o caixa pendente do dia anterior antes de iniciar novas vendas.","warning");if(!g.professionals||g.professionals.length===0)try{g.professionals=await Pe(g.establishmentId)}catch{return f("Erro","Não foi possível carregar profissionais.","error")}const a=`
        <form id="new-sale-form" class="space-y-4">
            ...
            <div class="pt-2 border-t border-gray-100">
                ...
                <select id="new-sale-professional" required class="w-full p-3.5 border border-gray-300 rounded-xl bg-gray-50 focus:bg-white text-sm font-bold text-gray-800 outline-none focus:ring-2 focus:ring-indigo-500 transition-colors shadow-inner">
                    ...
                    ${g.professionals.map(l=>`<option value="${l.id}">${y(l.name)}</option>`).join("")}
                </select>
            </div>
            <div class="pt-4">
    ...
    `,maxWidth:"max-w-sm"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",Jn)}async function Jn(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const a=e.querySelector("#regClientName"),i=e.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!i)return f("Erro","Nome e Telefone são obrigatórios.","error");let o=null;try{o=await _r(g.establishmentId,i)}catch{console.log("Cliente não encontrado na base, prosseguindo com criação...")}try{if(o&&o.id)f("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",as(o);else{const r=await Fo({establishmentId:g.establishmentId,name:a.value,phone:i});f("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",as(r)}}catch(r){f("Erro ao cadastrar",r.message,"error")}}async function Gn(){const t=`
    ...
    `,{modalElement:e}=Ne({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-xs"});e.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return f("Valor Inválido","Insira um valor válido.","error");try{const i=await Tn({establishmentId:g.establishmentId,initialAmount:parseFloat(s.toFixed(2))});h.isCashierOpen=!0,h.activeCashierSessionId=i.id,h.isCashierFromPreviousDay=!1,document.getElementById("genericModal").style.display="none",f("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),Ra(),await $e()}catch(i){f("Erro",`Falha ao abrir caixa: ${i.message}`,"error")}})}async function Qn(){const t=h.activeCashierSessionId;if(t)try{const e=await Mn(t),a=`
        ...
        `,{modalElement:s}=Ne({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("#close-cashier-form").addEventListener("submit",async i=>{i.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return f("Valor Inválido","Insira um valor final válido.","error");try{await An(t,o),h.isCashierOpen=!1,h.activeCashierSessionId=null,h.isCashierFromPreviousDay=!1,document.getElementById("genericModal").style.display="none",Ra(),await $e(),f("Sucesso!","Caixa fechado com sucesso!","success")}catch(r){f("Erro",`Falha ao fechar caixa: ${r.message}`,"error")}})}catch(e){f("Erro",`Falha ao carregar relatório: ${e.message}`,"error")}}async function Yn(t){if(h.activeFilter===t)return;h.activeFilter=t,h.paging.page=1,Ds(),it(),h.selectedComandaId=null,h.viewMode="items";const e=document.getElementById("comandas-list");e&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>'),Ht()}function ii(t){h.selectedComandaId=String(t),h.viewMode="items",h.pendingRedemption=null,h.checkoutState.discount={type:"real",value:0},h.checkoutState.discountReason="",Ht(),Fn(),se()}async function ri(t,e){const a=h.allComandas.find(o=>String(o.id)===String(h.selectedComandaId));if(!a)return;if(!t.id||String(t.id)==="undefined"){f("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(t.price)||0,i=Array(e).fill(0).map(()=>{const o={id:String(t.id),name:t.name,price:s,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0};return t.type==="product"?(o.productId=o.id,o.product_id=o.id):t.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...i),a._cachedItems=null,a._hasUnsavedChanges=!0,se()}async function Zs(t,e){const a=h.allComandas.find(o=>String(o.id)===String(h.selectedComandaId));if(!a)return;let s=!1,i=(a.comandaItems||[]).findIndex(o=>String(o.id)===String(t)&&o.type===e);i>-1&&(a.comandaItems.splice(i,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,se())}async function Xn(t){if(h.isProcessing)return;const e=Number(t.planDiscount||0),a=Fe(t),s=a.reduce((I,S)=>I+Number(S.price||0)*(S.quantity||1),0),i=h.checkoutState.discount||{type:"real",value:0};let o=i.type==="percent"?s*i.value/100:i.value;o>s&&(o=s);const r=Math.max(0,s-o-e),{payments:n}=h.checkoutState,l=n.reduce((I,S)=>I+S.value,0),d=r-l;if(d>.01){if(!await K("Pagamento Parcial",`O valor de R$ ${d.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;n.push({method:"fiado",value:d,installments:1})}h.isProcessing=!0;const u=t.type==="appointment",c=a;let p=0;const m=h.loyaltySettings;m&&m.enabled&&(!t.coveredByPlan||r>0)&&(p=parseInt(m.pointsPerVisit||1,10));const b={...i,reason:h.checkoutState.discountReason||""},x={payments:n,totalAmount:Number(r),items:c,cashierSessionId:h.activeCashierSessionId,loyaltyPointsEarned:p,discount:b,loyaltyRedemption:h.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center"><div class="loader mb-5"></div><p class="text-sm font-black text-gray-800 uppercase tracking-widest mt-2">Processando...</p></div>',document.body.appendChild(v);try{u?await pr(t.id,x):(x.establishmentId=g.establishmentId,x.clientId=t.clientId,x.clientName=t.clientName,x.professionalId=t.professionalId,t.clientPhone&&(x.clientPhone=t.clientPhone),await ti(x));let I="Venda finalizada com sucesso!";p>0&&(I+=` Cliente ganhou ${p} pontos!`),f("Sucesso!",I,"success"),it(),h.selectedComandaId=null,h.viewMode="items",h.pendingRedemption=null,await $e()}catch(I){f("Erro no Checkout",I.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),h.isProcessing=!1}}async function Zn(t){t.preventDefault();const e=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=e.value,i=document.getElementById("client-search").value,o=e.dataset.phone||"";if(!s)return f("Erro","Selecione um cliente válido.","error");const r=g.professionals.find(l=>l.id===a);if(!r)return f("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:i.split("(")[0].trim(),clientPhone:o,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};h.allComandas.unshift(n),h.selectedComandaId=String(n.id),h.viewMode="items",document.getElementById("genericModal").style.display="none",h.activeFilter==="pagas"&&(h.activeFilter="abertas"),Ds(),ii(n.id)}async function $e(){const t=document.getElementById("comandas-list");(!t.hasChildNodes()||t.innerHTML.includes("loader"))&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>');let e=h.filterStartDate,a=h.filterEndDate;if(h.filterPreset==="hoje"){a=xe(new Date);const o=new Date;o.setDate(o.getDate()-45),e=xe(o)}let s;e&&a&&e!==a?s={startDate:e,endDate:a}:s={startDate:e,endDate:a,date:e};try{const i=Pn(),o=ya(g.establishmentId,s,h.paging.page,h.paging.limit),r=Me(g.establishmentId),[n,l,d]=await Promise.all([i,o,r]);if(h.establishmentConfig=d||{},h.isCashierOpen=!!n,h.activeCashierSessionId=n?n.id:null,h.isCashierFromPreviousDay=!1,n&&n.openedAt){const u=xe(n.openedAt),c=xe(new Date);u<c&&(h.isCashierFromPreviousDay=!0)}if(Ra(),d&&d.loyaltyProgram&&(h.loyaltySettings=d.loyaltyProgram),h.allComandas=l.data||l||[],h.paging.total=l.total||h.allComandas.length,h.catalog.services.length===0){const[u,c,p,m]=await Promise.all([Ge(g.establishmentId),Rt(g.establishmentId),Cs(g.establishmentId),Pe(g.establishmentId)]);h.catalog={services:u,products:c,packages:p},g.professionals=m}Ht(),se()}catch(i){f("Erro",`Não foi possível carregar os dados: ${i.message}`,"error")}}async function Kn(t={}){at=document.getElementById("content"),h.selectedComandaId=t.selectedAppointmentId?String(t.selectedAppointmentId):null,h.viewMode="items",h.selectedCatalogItem=null;const e=Ua("hoje");if(h.filterStartDate=e.start,h.filterEndDate=e.end,h.filterPreset="hoje",h.showHistoryPanel=!1,zt(),Xe&&(at.removeEventListener("click",Xe),at.removeEventListener("change",Xe)),Xe=async a=>{const s=a.target.closest("[data-action], [data-filter], [data-comanda-id]");if(s){if(s.matches("[data-filter]"))a.preventDefault(),Yn(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(a.preventDefault(),a.target.closest('[data-action="go-to-appointment"]')){a.stopPropagation();return}ii(s.dataset.comandaId)}else if(s.matches("[data-action]")){a.preventDefault();const i=s.dataset.action,o=String(s.dataset.id||h.selectedComandaId),r=h.allComandas.find(n=>String(n.id)===o);switch(i){case"toggle-history":if(h.showHistoryPanel=!h.showHistoryPanel,h.showHistoryPanel&&h.activeFilter==="abertas"&&(h.activeFilter="todas"),zt(),!h.showHistoryPanel){h.filterPreset="hoje";const z=Ua("hoje");h.filterStartDate=z.start,h.filterEndDate=z.end,await $e()}break;case"set-period":const n=s.dataset.period;if(h.filterPreset=n,n!=="custom"){const z=Ua(n);h.filterStartDate=z.start,h.filterEndDate=z.end,zt(),h.paging.page=1,f("Buscando...",`Período: ${z.start.split("-").reverse().join("/")} a ${z.end.split("-").reverse().join("/")}`,"info"),await $e()}else zt();break;case"apply-custom-dates":const l=document.getElementById("filter-start-date").value,d=document.getElementById("filter-end-date").value;l&&d?(h.filterStartDate=l,h.filterEndDate=d,h.paging.page=1,f("Buscando...","Período personalizado aplicado.","info"),await $e()):f("Atenção","Preencha a data inicial e final.","warning");break;case"back-to-list":it(),h.selectedComandaId=null,h.selectedCatalogItem=null,document.querySelectorAll(".comanda-card").forEach(z=>z.classList.remove("ring-2","ring-indigo-500","bg-indigo-50/50","border-transparent")),document.querySelectorAll(".comanda-card").forEach(z=>z.classList.add("bg-white","border-gray-200")),se();break;case"new-sale":as();break;case"add-item":if(!h.isCashierOpen)return f("Caixa Fechado","Abra o caixa primeiro.","error");h.viewMode="add-item",se();break;case"back-to-items":h.viewMode="items",se();break;case"back-to-add-item":h.viewMode="add-item",h.selectedCatalogItem=null,se();break;case"select-catalog-item":const{itemType:u,itemId:c}=s.dataset,m=(h.catalog[u+"s"]||[]).find(z=>String(z.id)===String(c));m&&(h.selectedCatalogItem={...m,type:u},h.viewMode="add-item-qty",se());break;case"open-cashier":Gn();break;case"close-cashier":await Qn();break;case"view-sales-report":re("sales-report-section");break;case"go-to-checkout":await Ys(r,"checkout");break;case"save-comanda":await Ys(r,"stay");break;case"select-method":h.checkoutState.selectedMethod=s.dataset.method,h.checkoutState.installments=1,se();break;case"add-payment-checkout":const b=document.getElementById("checkout-amount");let x=parseFloat(b.value);const v=Number(r.planDiscount||0),S=Fe(r).reduce((z,D)=>z+(D.price||0),0),C=h.checkoutState.discount||{type:"real",value:0};let V=C.type==="percent"?S*C.value/100:C.value;V>S&&(V=S);const M=Math.max(0,S-V-v),q=h.checkoutState.payments.reduce((z,D)=>z+D.value,0),L=M-q;if(isNaN(x)||x<=0){f("Valor inválido","Insira um valor maior que zero.","error");break}if(x>L+.05){f("Valor inválido","Valor excede o restante.","error");break}const k={method:h.checkoutState.selectedMethod,value:x};["credito","crediario"].includes(h.checkoutState.selectedMethod)&&h.checkoutState.installments>1&&(k.installments=h.checkoutState.installments),h.checkoutState.payments.push(k),h.checkoutState.selectedMethod="dinheiro",h.checkoutState.installments=1,h.checkoutState.amountReceived="",se();break;case"remove-payment-checkout":const H=parseInt(s.dataset.index,10);h.checkoutState.payments.splice(H,1),se();break;case"finalize-checkout":await Xn(r);break;case"increase-qty":{const z=s.dataset.itemId,D=s.dataset.itemType;if(!z||z==="undefined"||z==="null"){f("Erro","Item inválido.","error");return}let R=Fe(r).find(G=>String(G.id)===String(z)&&G.type===D);R||(R=(h.catalog[D+"s"]||[]).find(Y=>String(Y.id)===String(z)));const B=R?{id:R.id,name:R.name,price:Number(R.price),type:R.type}:{id:z,name:"Item",price:0,type:D};await ri(B,1);break}case"decrease-qty":await Zs(s.dataset.itemId,s.dataset.itemType);break;case"remove-item":await Zs(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await K("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await ur(o);const D=h.allComandas.findIndex(j=>String(j.id)===o);D!==-1&&(h.allComandas[D].status="confirmed",delete h.allComandas[D].transaction),h.selectedComandaId=null,it(),await $e(),f("Sucesso!","Comanda reaberta.","success")}catch(D){f("Erro",D.message,"error")}break}case"go-to-appointment":{re("agenda-section",{scrollToAppointmentId:s.dataset.id,targetDate:new Date(s.dataset.date)});break}case"delete-walk-in":{if(await K("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))h.allComandas=h.allComandas.filter(D=>String(D.id)!==o),h.selectedComandaId=null,Ht(),se(),it();else try{await ai(o),f("Sucesso","Venda excluída.","success"),h.selectedComandaId=null,it(),await $e()}catch(D){f("Erro",D.message,"error")}break}}}}},at.addEventListener("click",Xe),at.addEventListener("change",Xe),t.initialFilter&&(t.initialFilter==="finalizadas"?h.activeFilter="pagas":h.activeFilter="abertas"),t.selectedAppointmentId&&(h.selectedComandaId=String(t.selectedAppointmentId)),t.filterDate){const a=new Date(t.filterDate).toISOString().split("T")[0];h.filterStartDate=a,h.filterEndDate=a,h.filterPreset="custom",h.showHistoryPanel=!0}await $e()}const ss=new Date,el=new Date(ss.getFullYear(),ss.getMonth(),1);let P={startDate:el.toISOString().split("T")[0],endDate:ss.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,agendaFilters:{status:null,professional:null,service:null},data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const os=document.getElementById("content");let _t=null;function tl(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t&&t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function me(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function ze(t){if(!t)return"--/--/----";const e=t.split("T")[0].split("-");return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}function fe(t){return t?typeof t.toDate=="function"?t.toDate():typeof t=="string"||typeof t=="number"?new Date(t):new Date:new Date(0)}function Ue(t){P.charts[t]&&(P.charts[t].destroy(),P.charts[t]=null)}async function al(){sl(),nl(),await st()}function sl(){os.innerHTML=`
    ...
    `}async function st(){const t=document.getElementById("tab-content");t&&(t.innerHTML='<div class="flex flex-col justify-center items-center h-64"><div class="loader mb-4 border-indigo-500"></div><p class="text-xs font-bold text-slate-400 uppercase tracking-widest animate-pulse">Compilando Dados...</p></div>');const{currentTab:e,startDate:a,endDate:s}=P,i=tl(),o=i.join(","),r=new Date(a).toISOString(),n=new Date(s);n.setHours(23,59,59,999);const l=n.toISOString();try{if(e==="financeiro"){const d={startDate:a,endDate:s,establishmentId:o},[u,c,p]=await Promise.all([Is(d).catch(()=>({entries:[]})),ja(d).catch(()=>({entries:[]})),Ma(g.establishmentId).catch(()=>[])]);P.data.financeiro={payables:u.entries||[],receivables:c.entries||[],natures:p||[]},ol()}else if(e==="agenda"){const d=i.map(b=>Ta(b,r,l).catch(()=>[])),u=i.map(b=>ir(b,r,l).catch(()=>[])),[c,p]=await Promise.all([Promise.all(d),Promise.all(u)]),m=new Map;c.flat().forEach(b=>m.set(b.id,b)),p.flat().forEach(b=>{b.status="cancelled",m.set(b.id,b)}),P.data.agenda=Array.from(m.values()),Ve()}else if(e==="clientes"){const d=await Promise.all(i.map(c=>xt(c).catch(()=>[]))),u=new Map;d.flat().forEach(c=>u.set(c.id,c)),P.data.clientes=Array.from(u.values()),is()}else if(e==="vendas"){try{let u=(await Promise.all(i.map(b=>Mo({establishmentId:b,startDate:a,endDate:s}).catch(()=>[])))).flatMap(b=>Array.isArray(b)?b:b.transactions||b.data||[]),c=[];$n&&typeof ts=="function"&&(c=(await Promise.all(i.map(x=>ts(x,r,l).catch(()=>[])))).flat());let p=[];if(In&&typeof ya=="function"){const x=(await Promise.all(i.map(S=>ya(S).catch(()=>({data:[]}))))).flatMap(S=>Array.isArray(S)?S:S.data||S.comandas||[]),v=new Date(r),I=new Date(l);p=x.filter(S=>{const C=fe(S.createdAt||S.date||S.timestamp);return C>=v&&C<=I})}const m=new Map;u.forEach(b=>m.set(b.id,b)),c.forEach(b=>m.set(b.id,b)),p.forEach(b=>m.set(b.id,b)),P.data.vendas=Array.from(m.values())}catch(d){console.warn("Aviso ao buscar vendas:",d),P.data.vendas=[]}il()}else if(e==="estoque"){const d=await Promise.all(i.map(c=>Rt(c).catch(()=>[]))),u=new Map;d.flat().forEach(c=>u.set(c.id,c)),P.data.estoque=Array.from(u.values()),rl()}}catch(d){t.innerHTML=`
        ...
        `}}function ol(){const t=document.getElementById("tab-content"),{payables:e,receivables:a,natures:s}=P.data.financeiro,i=new Map(s.map(L=>[L.id,L.name])),o={};a.forEach(L=>{const k=(L.status==="paid"?L.paymentDate:L.dueDate)?.split("T")[0];if(!k)return;o[k]||(o[k]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const H=Number(L.amount)||0;o[k].items.push({...L,_type:"receita"}),L.status==="paid"?o[k].recReal+=H:o[k].recPrev+=H}),e.forEach(L=>{const k=(L.status==="paid"?L.paymentDate:L.dueDate)?.split("T")[0];if(!k)return;o[k]||(o[k]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const H=Number(L.amount)||0;o[k].items.push({...L,_type:"despesa"}),L.status==="paid"?o[k].despReal+=H:o[k].despPrev+=H});const r=Object.keys(o).sort(),n=r.map(L=>ze(L).substring(0,5));let l=0;const d=[],u=[],c=[],p=[],m=[];r.forEach(L=>{const k=o[L];d.push(k.recReal),u.push(k.recPrev),c.push(-Math.abs(k.despReal)),p.push(-Math.abs(k.despPrev)),l+=k.recReal-k.despReal,m.push(l)});const b=d.reduce((L,k)=>L+k,0),x=c.reduce((L,k)=>L+Math.abs(k),0),v=b-x,I=b>0?v/b*100:0,S=v>=0?"bg-emerald-50 border-emerald-200 text-emerald-800":"bg-red-50 border-red-200 text-red-800",C=v>=0?'<i class="bi bi-graph-up-arrow mr-2 text-emerald-500"></i>':'<i class="bi bi-graph-down-arrow mr-2 text-red-500"></i>',V=v>=0?"O fluxo de caixa operacional está positivo neste período.":"Atenção: As despesas superaram as receitas no período selecionado.",M={},q={};a.filter(L=>L.status==="paid").forEach(L=>{const k=L.naturezaId?i.get(L.naturezaId)||"Outros":"Sem Cat.";M[k]=(M[k]||0)+L.amount}),e.filter(L=>L.status==="paid").forEach(L=>{const k=L.naturezaId?i.get(L.naturezaId)||"Outros":"Sem Cat.";q[k]=(q[k]||0)+L.amount}),t.innerHTML=`
        <div class="space-y-4 animate-fade-in">
            
            <div class="flex items-center p-3 rounded-xl border shadow-sm ${S}">
                ${C}
                <span class="text-xs font-bold tracking-wide">${V}</span>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col hover:border-indigo-300 transition-colors"><span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-wallet2 text-indigo-500 mr-1 text-sm"></i> Saldo do Período</span><span class="text-xl md:text-2xl font-black ${v>=0?"text-emerald-600":"text-red-600"} mt-1">${me(v)}</span></div>
                ...
                <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto custom-scrollbar pr-3">
                        <div class="mb-5">
                            ...
                            ${Object.entries(M).sort((L,k)=>k[1]-L[1]).map(([L,k])=>`<div class="flex justify-between items-center mb-2"><span class="text-xs font-medium text-slate-600 truncate mr-2">${L}</span><span class="text-xs font-black text-slate-800">${me(k)}</span></div>`).join("")||'<p class="text-xs font-medium text-slate-400">Sem receitas pagas no período.</p>'}
                        </div>
                        <div>
                            <p class="text-[10px] font-black text-red-500 uppercase tracking-widest border-b border-red-100 pb-2 mb-3">Despesas</p>
                            ${Object.entries(q).sort((L,k)=>k[1]-L[1]).map(([L,k])=>`<div class="flex justify-between items-center mb-2"><span class="text-xs font-medium text-slate-600 truncate mr-2">${L}</span><span class="text-xs font-black text-slate-800">${me(k)}</span></div>`).join("")||'<p class="text-xs font-medium text-slate-400">Sem despesas pagas no período.</p>'}
                        </div>
                    </div>
                </div>
            </div>
        </div>`,setTimeout(()=>{const L=document.getElementById("chartFin");L&&(Ue("fin"),P.charts.fin=new Chart(L,{type:"bar",data:{labels:n.length?n:["-"],datasets:[{label:"Receita Realizada",data:d,backgroundColor:"#10b981",stack:"Stack 0",borderRadius:4,order:2},{label:"Receita Prevista",data:u,backgroundColor:"#6ee7b7",stack:"Stack 0",borderRadius:4,order:2},{label:"Despesa Realizada",data:c,backgroundColor:"#ef4444",stack:"Stack 0",borderRadius:4,order:2},{label:"Despesa Prevista",data:p,backgroundColor:"#fca5a5",stack:"Stack 0",borderRadius:4,order:2},{label:"Saldo Acumulado",data:m,type:"line",borderColor:"#4f46e5",backgroundColor:"rgba(79, 70, 229, 0.1)",fill:!0,tension:.4,borderWidth:3,pointRadius:4,yAxisID:"y1",order:1}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"rgba(15, 23, 42, 0.9)",titleFont:{size:13,family:"Inter"},bodyFont:{size:12,family:"Inter"},padding:12,cornerRadius:8,callbacks:{label:function(k){let H=k.dataset.label||"";return H&&(H+=": "),k.parsed.y!==null&&(H+=me(Math.abs(k.parsed.y))),H}}}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{family:"Inter",weight:"bold"}}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[4,4],color:"#f1f5f9"},ticks:{font:{size:10,family:"Inter"},callback:k=>me(Math.abs(k))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:10,family:"Inter"},callback:k=>me(k)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(k=>{k.className="fin-toggle-btn flex items-center gap-2 px-3 py-1.5 text-[10px] font-black uppercase tracking-widest transition-all shadow-sm rounded-lg border cursor-pointer",k.onclick=H=>{const z=H.currentTarget,D=parseInt(z.dataset.dataset),j=P.charts.fin;j.isDatasetVisible(D)?(j.hide(D),z.style.opacity="0.4",z.style.filter="grayscale(100%)"):(j.show(D),z.style.opacity="1",z.style.filter="none")}}))},100)}function Ve(){const t=document.getElementById("tab-content"),e=P.data.agenda||[],a=e.length,s=e.filter(B=>B.status==="completed"||B.status==="concluida").length,i=e.filter(B=>["confirmed","pending","in-progress"].includes(B.status)).length,o=e.filter(B=>B.status==="no-show").length,r=e.filter(B=>B.status==="cancelled"||B.status==="cancelada").length;let n=e;P.agendaFilters.status&&(P.agendaFilters.status==="concluidas"?n=n.filter(B=>B.status==="completed"||B.status==="concluida"):P.agendaFilters.status==="aguardando"?n=n.filter(B=>["confirmed","pending","in-progress"].includes(B.status)):P.agendaFilters.status==="noshow"?n=n.filter(B=>B.status==="no-show"):P.agendaFilters.status==="canceladas"&&(n=n.filter(B=>B.status==="cancelled"||B.status==="cancelada"))),P.agendaFilters.professional&&(n=n.filter(B=>(B.professionalName||"Sem Profissional")===P.agendaFilters.professional)),P.agendaFilters.service&&(n=n.filter(B=>B.services&&Array.isArray(B.services)&&B.services.length>0?B.services.some(G=>(G.name||G.nome||"Serviço Indefinido")===P.agendaFilters.service):B.serviceName?B.serviceName===P.agendaFilters.service:P.agendaFilters.service==="Outros"));const l=n.length,d=n.filter(B=>B.status==="completed"||B.status==="concluida").length,u=n.filter(B=>B.status==="cancelled"||B.status==="cancelada").length,c=l>0?(d/l*100).toFixed(1):0,p=l>0?(u/l*100).toFixed(1):0,m=n.filter(B=>B.status==="completed"||B.status==="concluida").reduce((B,G)=>B+(Number(G.totalAmount||(G.transaction?G.transaction.totalAmount:0))||0),0),b=p>20?"bg-amber-50 border-amber-200 text-amber-800":"bg-indigo-50 border-indigo-200 text-indigo-800",x=p>20?'<i class="bi bi-exclamation-triangle mr-2 text-amber-500"></i>':'<i class="bi bi-calendar-check mr-2 text-indigo-500"></i>',v=p>20?`Atenção: A taxa de cancelamento está alta (${p}%). Considere enviar lembretes aos clientes.`:`A agenda fluiu bem neste cenário, com ${c}% de aproveitamento.`;let I=[],S=[],C=[];if(P.drillDownMonth!==null){const B=new Date(P.startDate).getFullYear(),G=new Date(B,P.drillDownMonth+1,0).getDate();I=Array.from({length:G},(Y,Q)=>`${Q+1}`),S=I.map(Y=>n.filter(Q=>{const T=fe(Q.startTime||Q.date);return T.getMonth()===P.drillDownMonth&&T.getDate()===parseInt(Y)&&Q.status!=="cancelled"&&Q.status!=="cancelada"}).length),C=I.map(Y=>n.filter(Q=>{const T=fe(Q.startTime||Q.date);return T.getMonth()===P.drillDownMonth&&T.getDate()===parseInt(Y)&&(Q.status==="cancelled"||Q.status==="cancelada")}).length)}else I=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],S=I.map((B,G)=>n.filter(Y=>fe(Y.startTime||Y.date).getMonth()===G&&Y.status!=="cancelled"&&Y.status!=="cancelada").length),C=I.map((B,G)=>n.filter(Y=>fe(Y.startTime||Y.date).getMonth()===G&&(Y.status==="cancelled"||Y.status==="cancelada")).length);const V={},M={};n.forEach(B=>{if((B.status==="cancelled"||B.status==="cancelada")&&P.agendaFilters.status!=="canceladas")return;const G=B.professionalName||"Sem Profissional";V[G]=(V[G]||0)+1,B.services&&Array.isArray(B.services)&&B.services.length>0?B.services.forEach(Y=>{const Q=Y.name||Y.nome||"Serviço Indefinido";M[Q]=(M[Q]||0)+1}):B.serviceName?M[B.serviceName]=(M[B.serviceName]||0)+1:M.Outros=(M.Outros||0)+1});const q=Object.entries(V).sort((B,G)=>G[1]-B[1]).slice(0,5),L=Object.entries(M).sort((B,G)=>G[1]-B[1]).slice(0,5),k=P.agendaFilters.status,H=k?"border-slate-200":"border-slate-800 ring-2 ring-slate-200",z=k==="concluidas"?"border-emerald-500 ring-2 ring-emerald-200":"border-emerald-100",D=k==="aguardando"?"border-amber-500 ring-2 ring-amber-200":"border-amber-100",j=k==="noshow"?"border-red-500 ring-2 ring-red-200":"border-red-100",R=k==="canceladas"?"border-slate-500 ring-2 ring-slate-300":"border-slate-200";t.innerHTML=`
        <div class="space-y-4 animate-fade-in">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                <div data-agenda-filter="todos" class="cursor-pointer transition-transform hover:scale-105 bg-white p-4 rounded-2xl border ${H} shadow-sm">
                ...
                <div data-agenda-filter="concluidas" class="cursor-pointer transition-transform hover:scale-105 bg-emerald-50 p-4 rounded-2xl border ${z} shadow-sm">
                ...
                <div data-agenda-filter="aguardando" class="cursor-pointer transition-transform hover:scale-105 bg-amber-50 p-4 rounded-2xl border ${D} shadow-sm">
                ...
                <div data-agenda-filter="noshow" class="cursor-pointer transition-transform hover:scale-105 bg-red-50 p-4 rounded-2xl border ${j} shadow-sm">
                ...
                <div data-agenda-filter="canceladas" class="cursor-pointer transition-transform hover:scale-105 bg-slate-100 p-4 rounded-2xl border ${R} shadow-sm">
                        ...
                        ${a.slice(0,8).map(d=>{const c=(Array.isArray(d.items)?d.items:Array.isArray(d.services)?d.services:Array.isArray(d.cart)?d.cart:[]).length||1,p=Number(d.totalAmount||d.total||d.totalValue||d.valorTotal||0),m=d.createdAt||d.date||d.timestamp||"";return`
                                <div class="flex items-center justify-between border border-slate-100 bg-slate-50 hover:bg-slate-100 transition-colors p-3 rounded-xl">
                                    <div>
                                        ...
                                        <p class="text-[10px] font-bold text-slate-400 mt-0.5">${ze(m)}</p>
                                    </div>
    ...
    `}async function bt(){const t=document.getElementById("servicesList"),e=di();try{const a=e.map(c=>Ge(c)),s=e.map(c=>Pe(c)),i=e.map(c=>Ha(c,"services")),o=await Promise.all(a),r=await Promise.all(s),n=await Promise.all(i),l=new Map;o.flat().filter(Boolean).forEach(c=>l.set(c.id,c)),U.services=Array.from(l.values()),g.services=U.services;const d=new Map;r.flat().filter(Boolean).forEach(c=>d.set(c.id,c)),U.professionals=Array.from(d.values()),g.professionals=U.professionals;const u=new Map;n.flat().filter(Boolean).forEach(c=>u.set(c.id,c)),U.categories=Array.from(u.values()),g.serviceCategories=U.categories,bl(),wt()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function bl(){const t=document.getElementById("filterCategoryId");t&&U.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',U.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=y(e.name),U.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function ci(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=U.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function ml(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.active!==!1).length,i=a-s;e.innerHTML=`
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",gl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),fl(i.dataset.id))}))}Ps()}function hl(t=[]){if(!U.hierarchyCache||U.hierarchyCache.length===0)return`
            ...
            </div>`;let e='<div class="space-y-2 mt-1 max-h-48 overflow-y-auto custom-scrollbar pr-2">';return U.hierarchyCache.forEach(a=>{const s=t.includes(a.id)||t.length===0&&a.id===g.establishmentId;e+=`
            <label class="flex items-center space-x-3 p-3 cursor-pointer bg-slate-50 hover:bg-white border border-slate-200 hover:border-indigo-300 rounded-xl transition-colors shadow-sm">
                ...
                <span class="text-xs md:text-sm font-black text-slate-800">🏢 ${y(a.name)}</span>
            </label>
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                    <label class="flex items-center space-x-3 p-3 ml-8 cursor-pointer bg-white hover:bg-indigo-50/50 border border-slate-100 hover:border-indigo-200 rounded-xl transition-colors border-l-4 border-l-indigo-200 shadow-sm">
                        ...
                        <span class="text-xs font-bold text-slate-600">📍 ${y(i.name)}</span>
                    </label>
                `})}),e+="</div>",e}function vl(t){U.viewMode="edit-service";const e=document.getElementById("service-modal-inner");if(!e)return;let a={name:"",active:!0,duration:30,price:0};if(t){const D=U.services?.find(j=>String(j.id)===String(t));D&&(a=JSON.parse(JSON.stringify(D)))}U.tempService=a;const s=!!a.id,i=U.categories||[],o=a.duration||30,r=a.bufferTime||0,n=y(a.name||""),l=y(a.notes||""),d=y(a.publicDescription||""),u=s?n:"Novo Serviço",c=a.color||"#4f46e5",p=a.loyaltyPoints||0,m=i.map(D=>`<option value="${D.id}" ${a.categoryId===D.id?"selected":""}>${y(D.name)}</option>`).join(""),b=a.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(n?n.charAt(0):"S")}`,x=`
    ...
    `,e.querySelectorAll(".tab-link").forEach(D=>{D.addEventListener("click",j=>{j.preventDefault(),e.querySelectorAll(".tab-link").forEach(R=>{R.classList.remove("active","border-indigo-600","text-indigo-600"),R.classList.add("border-transparent","text-slate-400")}),D.classList.add("active","border-indigo-600","text-indigo-600"),D.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(R=>R.classList.add("hidden")),e.querySelector("#"+D.dataset.tab).classList.remove("hidden")})});const v=e.querySelectorAll('input[name="commissionType"]'),I=e.querySelector("#defaultCommissionRateContainer"),S=e.querySelector("#professionalCommissionsContainer");function C(){const D=e.querySelector('input[name="commissionType"]:checked').value;I&&(I.style.display=D==="default"?"block":"none"),S&&(S.style.display=D==="custom"?"block":"none")}v.forEach(D=>D.addEventListener("change",C));const V=e.querySelector("#professionalCommissionsList");V&&(V.innerHTML=(U.professionals||[]).map(D=>{const j=a.professionalCommissions?.[D.id]!==void 0,R=a.professionalCommissions?.[D.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2.5 rounded-xl border border-transparent hover:bg-slate-50 transition-colors ${j?"bg-indigo-50/50 border-indigo-100 shadow-sm":""}" data-prof-id="${D.id}">
                    <label class="flex items-center gap-3 cursor-pointer flex-1 min-w-0">
                        <input type="checkbox" ${j?"checked":""} class="h-5 w-5 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 shadow-sm cursor-pointer">
                        <img src="${D.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${y(D.name.charAt(0))}`}" class="w-10 h-10 rounded-full object-cover border border-white shadow-sm flex-shrink-0">
                        <span class="text-xs font-black text-slate-800 truncate uppercase tracking-widest">${y(D.name)}</span>
                    </label>
                    <div class="flex items-center gap-1.5 ml-3">
                        <input type="number" value="${R}" step="0.1" class="w-20 p-2 border border-slate-300 rounded-lg text-sm font-bold text-center outline-none focus:ring-2 focus:ring-indigo-500 bg-white shadow-inner transition-shadow" ${j?"":"disabled"}>
                        <span class="text-[10px] font-black text-slate-400">%</span>
                    </div>
                </div>
            `}).join(""),V.querySelectorAll('input[type="checkbox"]').forEach(D=>{D.addEventListener("change",j=>{const R=j.target.closest(".professional-commission-row"),B=R.querySelector('input[type="number"]');B.disabled=!j.target.checked,R.classList.toggle("bg-indigo-50/50",j.target.checked),R.classList.toggle("border-indigo-100",j.target.checked),R.classList.toggle("shadow-sm",j.target.checked),R.classList.toggle("border-transparent",!j.target.checked),j.target.checked&&B.focus()})})),C();const M=e.querySelector("#servicePhotoInput"),q=e.querySelector("#servicePhotoButton"),L=e.querySelector("#servicePhotoContainer"),k=e.querySelector("#servicePhotoPreview"),H=e.querySelector("#servicePhotoBase64"),z=()=>M.click();q&&q.addEventListener("click",z),L&&L.addEventListener("click",z),M.onchange=async()=>{const D=M.files[0];if(D){k.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const j=await Pa(D,800,800,.8);if(j.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");k.src=j,H.value=j}catch(j){f("Erro de Imagem",j.message,"error"),k.src=b,H.value=a.photo||""}}},cl()}function yl(){K("Excluir em Lote",`Tem certeza que deseja excluir ${U.selectedIds.size} serviços da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{const e=Array.from(U.selectedIds).map(a=>Go(a));await Promise.all(e),ne(g.establishmentId,dt(),"Serviços","Excluiu em Lote",`Excluiu ${U.selectedIds.size} serviços`),f("Sucesso",`${U.selectedIds.size} serviços foram excluídos.`,"success"),U.selectedIds.clear(),ci(),bt()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}function wl(){Vt&&document.body.removeEventListener("click",Vt),Ut&&rs.removeEventListener("input",Ut),Vt=async t=>{if(t.target.classList.contains("service-checkbox")){const o=t.target.dataset.id;t.target.checked?U.selectedIds.add(o):U.selectedIds.delete(o),ci(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){U.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600","bg-red-600","border-red-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),U.statusFilter==="inactive"?(e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-red-600","text-white","border-red-600")):(e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600")),wt();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterCategoryId").value="all",U.filterCategoryId="all",wt();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),U.filterCategoryId=document.getElementById("filterCategoryId").value,wt();return}const a=t.target.closest("#toggle-filter-btn");if(a){t.preventDefault(),U.isAdvancedFilterOpen=!U.isAdvancedFilterOpen;const o=document.getElementById("filter-panel");U.isAdvancedFilterOpen?(o.classList.remove("hidden"),o.classList.add("block"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.remove("bg-white","text-slate-700","border-slate-200")):(o.classList.add("hidden"),o.classList.remove("block"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-slate-700","border-slate-200"));return}if(t.target.id==="services-layout-detail"){Wt();return}const s=t.target.closest("[data-action]");if(!s)return;const i=s.dataset.action;switch(["close-detail-screen","delete-service","save-service","manage-categories","open-service-editor","batch-delete"].includes(i)&&t.stopPropagation(),i){case"manage-categories":xl();break;case"open-service-editor":vl(s.dataset.id);break;case"close-detail-screen":Wt();break;case"batch-delete":yl();break;case"delete-service":{const o=s.dataset.id;if(!o)return;if(await K("Apagar Serviço","Tem certeza que deseja excluir este serviço da rede?"))try{const n=U.services.find(l=>l.id===o)?.name||"Desconhecido";await Go(o),ne(g.establishmentId,dt(),"Serviços","Excluiu",`Excluiu o serviço: ${n}`),f("Sucesso","Serviço apagado da rede.","success"),Wt(),await bt()}catch(n){f("Erro",`Não foi possível apagar o serviço: ${n.message}`,"error")}break}case"save-service":{t.preventDefault();const o=document.getElementById("serviceForm");if(!o.reportValidity())return;const r=s,n=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{const l=o.querySelector("#serviceId").value,d=o.querySelector('input[name="commissionType"]:checked').value,u={};d==="custom"&&o.querySelectorAll(".professional-commission-row").forEach(b=>{const x=b.dataset.profId;if(b.querySelector('input[type="checkbox"]').checked){const I=parseFloat(b.querySelector('input[type="number"]').value);u[x]=isNaN(I)?0:I}});const c=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(b=>b.value),p=c.length>0?c:[g.establishmentId],m={...U.tempService,establishmentId:g.establishmentId,accessibleIn:p,name:o.querySelector("#serviceName").value.trim(),price:parseFloat(o.querySelector("#servicePrice").value),duration:parseInt(o.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(o.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:o.querySelector("#serviceCategory").value||null,color:o.querySelector("#serviceColor").value,targetAudience:o.querySelector("#serviceAudience").value,loyaltyPoints:parseInt(o.querySelector("#serviceLoyaltyPoints").value,10)||0,publicDescription:o.querySelector("#servicePublicDescription").value.trim(),homeService:o.querySelector("#serviceHomeToggle").checked,commissionRate:parseFloat(o.querySelector("#serviceCommissionRate").value)||0,active:o.querySelector("#serviceStatusToggle").checked,photo:o.querySelector("#servicePhotoBase64").value,notes:o.querySelector("#serviceNotes").value,commissionType:d,professionalCommissions:u};l?(await on(l,m),ne(g.establishmentId,dt(),"Serviços","Editou",`Editou o serviço: ${m.name}`),f("Sucesso","Serviço atualizado com sucesso!","success")):(delete m.id,await sn(m),ne(g.establishmentId,dt(),"Serviços","Criou",`Criou novo serviço: ${m.name}`),f("Sucesso","Serviço adicionado à rede!","success")),Wt(),await bt()}catch(l){f("Erro",l.message,"error"),r.disabled=!1,r.innerHTML=n}break}}},document.body.addEventListener("click",Vt),Ut=t=>{t.target.id==="searchInput"&&(U.searchQuery=t.target.value,wt())},rs.addEventListener("input",Ut)}const Oa="suppliers",Ft=async t=>{try{const e=Lo(Da(he,Oa),Co("establishmentId","==",t)),a=await Yi(e),s=[];return a.forEach(i=>{s.push({id:i.id,...i.data()})}),s}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},kl=async t=>{try{return{id:(await $o(Da(he,Oa),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},Il=async(t,e)=>{try{const a=qe(he,Oa,t);return await jt(a,e),{id:t,...e}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Sl=async t=>{try{const e=qe(he,Oa,t);return await Xi(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},ns=document.getElementById("content");let $={products:null,categories:[],suppliers:[],hierarchyCache:[],allMovements:[],currentTab:"catalogo",stockFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,isMovementFilterOpen:!1,selectedIds:new Set,selectedMovementIds:new Set,tempProduct:null,tempSupplierIds:new Set},Jt=null,Gt=null;function We(){const t=ke.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function Ts(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function Wa(t){return t?t._seconds?new Date(t._seconds*1e3):t.seconds?new Date(t.seconds*1e3):new Date(t):new Date}function El(){const t=document.getElementById("products-layout-detail"),e=document.getElementById("product-modal-inner"),a=document.getElementById("mobile-bottom-nav");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),a&&(a.style.display="none"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function da(){const t=document.getElementById("products-layout-detail"),e=document.getElementById("product-modal-inner"),a=document.getElementById("mobile-bottom-nav");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow="",a&&(a.style.display="")},300)),$.tempProduct=null,$.tempSupplierIds.clear()}function $l(){const t=document.getElementById("movement-layout-detail"),e=document.getElementById("movement-modal-inner"),a=document.getElementById("mobile-bottom-nav");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),a&&(a.style.display="none"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function ls(){const t=document.getElementById("movement-layout-detail"),e=document.getElementById("movement-modal-inner"),a=document.getElementById("mobile-bottom-nav");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow="",a&&(a.style.display="")},300))}async function Ll(){$.selectedIds.clear(),$.selectedMovementIds.clear(),$.currentTab="catalogo",$.products=null;try{const t=await De();$.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}pi(),Nl(),await Le()}function pi(){ns.innerHTML=`
        <div class="h-full flex w-full relative overflow-hidden bg-slate-50">
    ...
    `,Cl()}function Cl(){const t=document.getElementById("main-tab-content");if(t){if($.currentTab==="catalogo")t.innerHTML=`
        ...
        `;else if($.currentTab==="movimentacoes"){const e=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0],i=($.products||[]).map(r=>`<option value="${r.id}">${y(r.name)}</option>`).join(""),o=($.categories||[]).map(r=>`<option value="${r.id}">${y(r.name)}</option>`).join("");t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",wa),wa()}}}async function Le(){const t=Ts();try{const e=t.map(n=>Rt(n)),a=t.map(n=>Ha(n,"products")),[s,i]=await Promise.all([Promise.all(e),Promise.all(a)]),o=new Map;s.flat().filter(Boolean).forEach(n=>o.set(n.id,n)),$.products=Array.from(o.values()),g.products=$.products;const r=new Map;i.flat().filter(Boolean).forEach(n=>r.set(n.id,n)),$.categories=Array.from(r.values()),g.categories=$.categories,$.currentTab==="catalogo"?(bi(),Re()):$.currentTab==="movimentacoes"&&wa(),$.suppliers=[],t.forEach(async n=>{try{let l=[];typeof Ft=="function"&&(l=await Ft(n)),l.forEach(d=>{$.suppliers.find(u=>u.id===d.id)||$.suppliers.push(d)}),g.suppliers=$.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function bi(){const t=document.getElementById("filterCategoryId");t&&$.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',$.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=y(e.name),$.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function ds(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=$.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function $t(){const t=document.getElementById("movement-batch-action-bar"),e=document.getElementById("mov-selected-count"),a=$.selectedMovementIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Dl(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,i=0,o=0,r=0;t.forEach(n=>{const l=n.currentStock||0,d=n.minStock||0;n.active!==!1&&n.price&&l>0&&(r+=n.price*l),l<=0?o++:d>0&&l<=d||d>0&&l<=d*1.2?i++:s++}),e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function Re(){const t=document.getElementById("productsList");if(!t)return;if($.products===null){t.innerHTML=mi(8);return}const e=Ts(),a=$.products.filter(i=>{const o=i.name.toLowerCase().includes($.searchQuery)||i.sku&&i.sku.toLowerCase().includes($.searchQuery)||i.barcode&&i.barcode.toLowerCase().includes($.searchQuery),r=i.currentStock||0,n=i.minStock||0;let l=!0;$.stockFilter==="ok"&&(l=r>0&&(n===0||r>n*1.2)),$.stockFilter==="alert"&&(l=n>0&&r>0&&r<=n*1.2),$.stockFilter==="empty"&&(l=r<=0);const d=$.filterCategoryId==="all"||i.categoryId===$.filterCategoryId,u=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],c=e.some(p=>u.includes(p));return o&&l&&d&&c});if(Dl(a),a.length===0){$.products.length===0?t.innerHTML=`
        ...
        `;return e}async function Pl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=$.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await ni({establishmentId:g.establishmentId,name:s,accessibleIn:o},"products"),ne(g.establishmentId,We(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await As(),await Le()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function Tl(t){if(await K("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await li(t,"products"),ne(g.establishmentId,We(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await As(),await Le()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function As(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await Ha(g.establishmentId,"products");$.categories=e,e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-white p-3 rounded-xl border border-slate-200 mb-2 shadow-sm">
                    <span class="text-xs font-black text-slate-700 uppercase tracking-widest">${y(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-white w-8 h-8 flex items-center justify-center bg-red-50 hover:bg-red-600 rounded-lg transition-colors border border-red-100 active:scale-95"><i class="bi bi-trash3 pointer-events-none"></i></button>
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Pl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),Tl(i.dataset.id))}))}As()}function Bl(){const t=($.products||[]).map(r=>`<option value="${r.id}">${y(r.name)} (Estoque: ${r.currentStock||0})</option>`).join(""),e=$.hierarchyCache.reduce((r,n)=>(r.push(`<option value="${n.id}">🏢 ${y(n.name)}</option>`),n.branches&&n.branches.forEach(l=>r.push(`<option value="${l.id}">📍 ${y(l.name)}</option>`)),r),[]).join(""),a=document.getElementById("movement-modal-inner"),s=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
    ...
    `;a.innerHTML=s,$l();const i=document.getElementById("movEstablishmentId");i&&(i.value=g.establishmentId);const o=document.getElementById("newMovementForm");o.onsubmit=async r=>{r.preventDefault();const n=a.querySelector('button[type="submit"]'),l=n.innerHTML,d=document.getElementById("movProductId")?.value,u=document.getElementById("movEstablishmentId")?.value,c=o.querySelector('input[name="movType"]:checked')?.value,p=parseInt(document.getElementById("movAmount")?.value,10),m=document.getElementById("movReason")?.value.trim();if(!d||!p||p<=0||!m||!u){f("Erro","Preencha todos os campos corretamente.","warning");return}const b=c==="in"?p:-p;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Salvando...';try{await Ls(d,{change:b,reason:m,establishmentId:u});const x=$.products.find(v=>v.id===d)?.name||"Produto";ne(u,We(),"Estoque","Ajuste Manual",`Lançou movimentação (${b>0?"+":""}${b}) para ${x}`),f("Sucesso","Movimentação registrada com sucesso!","success"),ls(),await Le()}catch(x){f("Erro",x.message,"error"),n.disabled=!1,n.innerHTML=l}}}function Ml(t=[]){if(!$.hierarchyCache||$.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${g.establishmentId}">
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-500 text-center">
                <i class="bi bi-info-circle text-2xl block mb-2 text-slate-400"></i> Exclusivo desta unidade.
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function jl(t){$.viewMode="edit-product";const e=document.getElementById("product-modal-inner");if(!e)return;let a={name:"",active:!0,price:0,costPrice:0,currentStock:0,minStock:0,maxStock:0,supplierIds:[]};if(t){const D=$.products?.find(j=>String(j.id)===String(t));D&&(a=JSON.parse(JSON.stringify(D)))}$.tempProduct=a,$.tempSupplierIds=new Set(a.supplierIds||[]);const s=!!a.id,i=$.categories||[],o=y(a.name||""),r=y(a.sku||""),n=y(a.barcode||""),l=y(a.description||""),d=s?o:"Novo Produto",u=a.price!==void 0?a.price:"",c=a.costPrice!==void 0?a.costPrice:"",p=a.commissionRate!==void 0?a.commissionRate:"",m=a.currentStock||0,b=a.minStock||0;a.maxStock;const x=i.map(D=>`<option value="${D.id}" ${a.categoryId===D.id?"selected":""}>${y(D.name)}</option>`).join(""),v=a.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(o?o.charAt(0):"P")}`,I=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
            <button data-action="close-detail-screen" class="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 text-slate-500 flex items-center justify-center hover:bg-slate-100 hover:text-slate-800 transition-colors active:scale-95 mr-4">
                <i class="bi bi-arrow-left text-lg"></i>
            </button>
                        ...
                        <div class="lg:col-span-1 space-y-4">
                            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-center flex flex-col items-center">
                                ...
                                <div class="relative group w-32 h-32 mb-5 cursor-pointer" id="productPhotoContainer">
                                    <img id="productPhotoPreview" src="${v}" alt="Foto" class="w-full h-full rounded-2xl object-cover border-4 border-slate-50 shadow-md transition-all group-hover:brightness-75">
    ...
    `,e.querySelectorAll(".tab-link").forEach(D=>{D.addEventListener("click",j=>{j.preventDefault(),e.querySelectorAll(".tab-link").forEach(R=>{R.classList.remove("active","border-indigo-600","text-indigo-600"),R.classList.add("border-transparent","text-slate-400")}),D.classList.add("active","border-indigo-600","text-indigo-600"),D.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(R=>R.classList.add("hidden")),e.querySelector("#"+D.dataset.tab).classList.remove("hidden")})});const S=()=>{const D=document.getElementById("modalSupplierSearch"),j=document.getElementById("supplierSearchResults"),R=document.getElementById("selectedSuppliersList"),B=D?.value.toLowerCase()||"",G=$.suppliers||[];if(B.length>0){const Y=G.filter(Q=>Q.name.toLowerCase().includes(B)&&!$.tempSupplierIds.has(Q.id));Y.length>0?(j.classList.remove("hidden"),j.innerHTML=Y.map(Q=>`
                    <div class="p-3.5 hover:bg-indigo-50 cursor-pointer border-b border-slate-100 last:border-0 flex justify-between items-center transition-colors" data-add-supplier="${Q.id}">
                        <span class="font-bold text-xs text-slate-700 uppercase tracking-widest">${y(Q.name)}</span>
                ...
                `).join("")):(j.classList.remove("hidden"),j.innerHTML='<div class="p-4 text-xs font-bold text-slate-500 text-center uppercase tracking-widest">Fornecedor não encontrado.</div>')}else j&&j.classList.add("hidden");$.tempSupplierIds.size>0?(R.classList.remove("justify-center"),R.classList.add("justify-start"),R.innerHTML="",$.tempSupplierIds.forEach(Y=>{const Q=G.find(T=>T.id===Y);Q&&(R.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border border-slate-200 p-3.5 rounded-xl shadow-sm hover:border-indigo-200 transition-colors" data-id="${Q.id}">
                            <div>
                                <p class="font-black text-slate-800 text-xs uppercase tracking-widest mb-1">${y(Q.name)}</p>
                                <p class="text-[9px] font-bold text-slate-500 uppercase tracking-widest"><i class="bi bi-person mr-1"></i> ${y(Q.contactName||"N/I")} | <i class="bi bi-telephone mr-1"></i> ${y(Q.phone||"N/I")}</p>
                            </div>
                    ...
                    `)})):(R.classList.add("justify-center"),R.classList.remove("justify-start"),R.innerHTML='<p class="text-[10px] text-slate-400 text-center font-bold uppercase tracking-widest">Nenhum fornecedor adicionado ainda.</p>')},C=document.getElementById("modalSupplierSearch");C&&C.addEventListener("input",S),S();const V=e.querySelector("#productPhotoInput"),M=e.querySelector("#productPhotoButton"),q=e.querySelector("#productPhotoContainer"),L=e.querySelector("#productPhotoPreview"),k=e.querySelector("#productPhotoBase64"),H=()=>V?.click();M&&M.addEventListener("click",H),q&&q.addEventListener("click",H),V&&(V.onchange=async()=>{const D=V.files[0];if(!D)return;const j=L.src;L.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const R=await Pa(D,800,800,.8);if(R.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");L.src=R,k.value=R}catch(R){f("Erro de Imagem",R.message,"error"),L.src=j,k.value=a?.photo||""}});const z=document.getElementById("productForm");z&&(z.onsubmit=async D=>{D.preventDefault();const j=e.querySelector('button[type="submit"]'),R=j.innerHTML,B=document.getElementById("productName"),G=document.getElementById("productPrice");if(!B?.value||!G?.value){f("Aviso","Preencha o Nome e o Preço do produto.","warning");return}const Y=parseInt(document.getElementById("productCurrentStock")?.value||"0",10),Q=parseInt(document.getElementById("productMinStock")?.value||"0",10),T=Array.from(document.querySelectorAll('#productForm input[name="accessibleIn"]:checked')).map(J=>J.value),X=T.length>0?T:[g.establishmentId],ie={...$.tempProduct,establishmentId:g.establishmentId,accessibleIn:X,name:B.value.trim(),sku:document.getElementById("productSku")?.value.trim()||"",barcode:document.getElementById("productBarcode")?.value.trim()||"",price:parseFloat(G.value),costPrice:parseFloat(document.getElementById("productCostPrice")?.value)||0,commissionRate:parseFloat(document.getElementById("productCommissionRate")?.value)||0,currentStock:isNaN(Y)?0:Y,minStock:isNaN(Q)?0:Q,categoryId:document.getElementById("productCategory")?.value||null,photo:document.getElementById("productPhotoBase64")?.value||"",description:document.getElementById("productDescription")?.value.trim()||"",active:document.getElementById("productStatusToggle")?.checked!==!1,supplierIds:Array.from($.tempSupplierIds)};j.disabled=!0,j.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> A gravar...';try{s?(await Cn(t,ie),ne(g.establishmentId,We(),"Produtos","Editou",`Editou o produto: ${ie.name}`),f("Sucesso","Produto atualizado com sucesso!","success")):(delete ie.id,await Ln(ie),ne(g.establishmentId,We(),"Produtos","Criou",`Criou novo produto: ${ie.name}`),f("Sucesso","Produto adicionado à rede!","success")),da(),await Le()}catch(J){f("Erro",J.message,"error"),j.disabled=!1,j.innerHTML=R}}),El()}async function ql(){if(!($.selectedIds.size===0||!await K("Excluir Produtos",`Tem a certeza que deseja excluir ${$.selectedIds.size} produtos do seu inventário?`)))try{const e=Array.from($.selectedIds).map(a=>si(a));await Promise.all(e),f("Sucesso","Produtos excluídos com sucesso.","success"),$.selectedIds.clear(),ds(),await Le()}catch(e){f("Erro","Não foi possível apagar os produtos: "+e.message,"error")}}async function Fl(){if(!($.selectedMovementIds.size===0||!await K("Estornar e Excluir",`Deseja excluir as ${$.selectedMovementIds.size} movimentações selecionadas? O saldo de stock será estornado/devolvido ao sistema automaticamente.`)))try{const e=Array.from($.selectedMovementIds).map(async a=>{const s=$.allMovements.find(i=>i.id===a);s&&await Ls(s.productId,{change:-s.change,reason:"Estorno automático de exclusão em lote",establishmentId:s.establishmentId})});await Promise.all(e),f("Sucesso","Movimentações excluídas e stocks estornados.","success"),$.selectedMovementIds.clear(),$t(),wa()}catch(e){f("Erro","Ocorreu um erro ao estornar em lote: "+e.message,"error")}}async function wa(){const t=document.getElementById("report-results");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full"><div class="loader"></div></div>',$.selectedMovementIds.clear(),$t();const e={startDate:document.getElementById("reportStartDate")?.value||"",endDate:document.getElementById("reportEndDate")?.value||"",productId:document.getElementById("productFilterReport")?.value||"all",categoryId:document.getElementById("categoryFilterReport")?.value||"all"};try{const s=Ts().map(n=>Dn({...e,establishmentId:n}).catch(l=>[])),i=await Promise.all(s);let o=[];if(i.forEach(n=>{if(!n)return;const l=Array.isArray(n)?n:Array.isArray(n.data)?n.data:Array.isArray(n.movements)?n.movements:[];o=o.concat(l)}),o.sort((n,l)=>Wa(l.date)-Wa(n.date)),$.allMovements=o,o.length===0){t.innerHTML=`
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ${o.map(n=>{const l=n.change>0,d=l?"text-emerald-700 bg-emerald-50 border-emerald-200":"text-red-700 bg-red-50 border-red-200",u=l?'<i class="bi bi-arrow-down-left"></i>':'<i class="bi bi-arrow-up-right"></i>',c=$.selectedMovementIds.has(n.id),p=c?"bg-indigo-50/30":"hover:bg-slate-50/50",m=Wa(n.date),b=m.toLocaleDateString("pt-BR"),x=m.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`
                            <tr class="transition-colors ${p}">
                                ...
                                <td class="px-5 py-3 text-xs font-black text-slate-800 uppercase tracking-widest">${y(n.productName)}</td>
                                ...
                                <td class="px-5 py-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest truncate max-w-[250px]" title="${y(n.reason)}">${y(n.reason)}</td>
    ...
    `,s='<div class="flex flex-col gap-2 md:hidden p-2">';e.forEach(i=>{let o=i.category;o==="Produtos"&&(o="estoque"),o==="Serviços"&&(o="servicos");const r=ka[o]||ka.outros,n=i.document||i.taxId?i.document||i.taxId:"-",l=JSON.stringify(i).replace(/'/g,"&apos;"),d=[i.city,i.state].filter(Boolean).join(" - ");a+=`
            <tr class="hover:bg-gray-50 cursor-pointer transition-colors group" data-action="open-form" data-item='${l}'>
                ...
                <td class="px-3 py-2">
                    <p class="font-bold text-gray-800 text-xs group-hover:text-indigo-700 transition-colors">${y(i.name)}</p>
                    ${i.email?`<p class="text-[9px] text-gray-500 mt-0.5 truncate max-w-[200px]"><i class="bi bi-envelope mr-1 opacity-50"></i>${y(i.email)}</p>`:""}
                </td>
                <td class="px-3 py-2 text-xs font-medium text-gray-600">${y(n)}</td>
                <td class="px-3 py-2">
                    <div class="text-xs font-medium text-gray-800">${y(i.contactName||"-")}</div>
                    ${d?`<div class="text-[9px] font-bold uppercase tracking-wider text-gray-400 mt-0.5"><i class="bi bi-geo-alt mr-1"></i>${y(d)}</div>`:""}
                </td>
                <td class="px-3 py-2 text-center">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-3 flex flex-col gap-2 active:scale-[0.98] transition-transform cursor-pointer relative overflow-hidden" data-action="open-form" data-item='${l}'>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <h3 class="font-bold text-gray-900 text-xs leading-tight truncate">${y(i.name)}</h3>
                    </div>
                </div>
    ...
    `}async function Ia(){const t=document.getElementById("professionalsList"),e=hi();try{const a=e.map(l=>Pe(l)),s=e.map(l=>Ge(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),W.professionals=Array.from(r.values()),g.professionals=W.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),W.services=Array.from(n.values()),Yl(),kt()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function Yl(){const t=document.getElementById("filterServiceId");t&&W.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',W.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=y(e.name),W.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function vi(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=W.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Xl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,i=a-s;e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function kt(){const t=document.getElementById("professionalsList");if(!t)return;if(W.professionals===null){t.innerHTML=yi(8);return}const e=hi(),a=W.professionals.filter(s=>{const i=s.name.toLowerCase().includes(W.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(W.searchQuery);let o=!0;W.statusFilter==="active"&&(o=s.status!=="inactive"),W.statusFilter==="inactive"&&(o=s.status==="inactive");const r=W.filterServiceId==="all"||s.services&&s.services.includes(W.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||g.establishmentId],l=e.some(d=>n.includes(d));return i&&o&&r&&l});if(Xl(a),a.length===0){W.professionals.length===0?t.innerHTML=`
            ...
            `;return}t.innerHTML=a.map(s=>{const i=s.status==="inactive",o=y(s.name),r=y(s.specialty||"Especialidade"),n=s.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(s.name?s.name.charAt(0):"P")}`,l=s.accessibleIn?s.accessibleIn.length:1,d=s.services?s.services.length:0,u=W.selectedIds.has(s.id);return`
    ...
    `,Kl(a,W.services),td(a),await sd(a,W.professionals),od(a),Jl()}function Kl(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const i=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,m=p==i[1]?"selected":"",b=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${m}>${b.charAt(0).toUpperCase()+b.slice(1)}</option>`}).join(""),r=y(t.name||""),n=y(t.specialty||""),l=y(t.phone||""),d=y(t.notes||"");a.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-1 space-y-4">
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-center flex flex-col items-center">
                ...
                <div id="profServicesContainer" class="grid grid-cols-1 sm:grid-cols-2 gap-2 flex-1 overflow-y-auto max-h-80 custom-scrollbar pr-2">
                    ${e.map(u=>`
                        <label class="flex items-center space-x-3 p-3 bg-slate-50 rounded-xl cursor-pointer transition-colors border border-slate-200 hover:border-indigo-300 hover:shadow-sm">
                            ...
                            <span class="text-xs font-bold text-slate-700 truncate" title="${y(u.name)}">${y(u.name)}</span>
                        </label>
                    `).join("")}
    ...
    `}function ed(t=[]){if(!W.hierarchyCache||W.hierarchyCache.length===0)return`
            ...
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-500 text-center">
                <i class="bi bi-info-circle text-2xl block mb-2 text-slate-400"></i> Exclusivo desta unidade.
            </div>`;let e='<div class="space-y-2 mt-1">';return W.hierarchyCache.forEach(a=>{const s=t.includes(a.id)||t.length===0&&a.id===g.establishmentId;e+=`
            <label class="flex items-center space-x-3 p-3 cursor-pointer bg-slate-50 hover:bg-white border border-slate-200 hover:border-indigo-300 rounded-xl transition-colors shadow-sm">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-5 h-5 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500" ${s?"checked":""}>
                <span class="text-xs md:text-sm font-black text-slate-800">🏢 ${y(a.name)}</span>
            </label>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 bg-white p-5 md:p-8 rounded-3xl border border-slate-200 shadow-sm">
                        ...
                        <div id="batchProfSelectionContainer" class="max-h-40 overflow-y-auto custom-scrollbar p-2.5 border border-orange-200 rounded-xl bg-white space-y-1.5 shadow-inner">
                            ${e.map(o=>`
                                <label class="flex items-center space-x-3 hover:bg-orange-50 p-2.5 rounded-lg cursor-pointer transition-colors border border-transparent hover:border-orange-100">
                                    ...
                                    <span class="text-xs font-bold text-slate-700">${y(o.name)}</span>
                                </label>`).join("")}
                        </div>
                    </div>
            ...
            <div class="xl:pl-2 flex flex-col">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-3 border-b border-slate-100 pb-4">
                    <div>
                        ...
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">${y((t.name||"").split(" ")[0]||"Deste Perfil")}</p>
                    </div>
        ...
        </div>`;const s=document.getElementById("batchBlockageForm");s&&s.addEventListener("submit",async o=>{o.preventDefault();const r=s.querySelector('button[type="submit"]'),n=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';const l=Array.from(o.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(x=>x.value);if(l.length===0)return r.disabled=!1,r.innerHTML=n,f("Atenção","Selecione pelo menos um profissional.","error");const d=o.target.batchBlockageStartDate.value,u=o.target.batchBlockageEndDate.value||d,c=o.target.batchBlockageStartTime.value,p=o.target.batchBlockageEndTime.value,m=o.target.batchBlockageReason.value;if(!d||!c||!p)return r.disabled=!1,r.innerHTML=n,f("Atenção","Preencha Data de Início, Hora de Início e Fim.","error");const b=l.map(x=>{const v={professionalId:x,establishmentId:g.establishmentId,startTime:new Date(`${d}T${c}`).toISOString(),endTime:new Date(`${u}T${p}`).toISOString(),reason:m};return Fa(v)});try{await Promise.all(b),f("Sucesso!",`${l.length} bloqueios foram criados.`),s.reset(),o.target.querySelectorAll('input[name="batch-professionals"]').forEach(v=>{v.checked=v.value===t.id});const x=document.getElementById("prof-blockages-filter").value;Ct(t.id,x)}catch(x){f("Erro",x.message,"error")}finally{r.disabled=!1,r.innerHTML=n}});const i=document.getElementById("prof-blockages-filter");i&&i.addEventListener("change",o=>Ct(t.id,o.target.value)),t.id&&await Ct(t.id,"future")}async function Ct(t,e="future"){const a=document.getElementById("blockagesList");if(a){if(a.innerHTML='<div class="loader mx-auto mt-10"></div>',!t){a.innerHTML=`
            ...
            <div class="bg-white border border-slate-200 rounded-xl shadow-sm mb-4 overflow-hidden">
                <div class="bg-slate-50 px-4 py-3 border-b border-slate-200 flex justify-between items-center">
                    <h4 class="font-black text-xs text-slate-800 flex items-center gap-2"><i class="bi bi-tag-fill text-orange-400 text-sm"></i> ${y(d)}</h4>
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-[10px] font-bold text-red-500 p-4 bg-red-50 rounded-xl border border-red-100">${s.message}</p>`}}}function od(t){const e=document.getElementById("prof-modal-inner");if(!e)return;const a=e.querySelectorAll(".tab-link");a.forEach(p=>{p.addEventListener("click",m=>{m.preventDefault(),a.forEach(v=>{v.classList.remove("active","border-indigo-600","text-indigo-600"),v.classList.add("border-transparent","text-slate-400")}),p.classList.add("active","border-indigo-600","text-indigo-600"),p.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(v=>v.classList.add("hidden"));const b=p.dataset.tab,x=e.querySelector("#"+b);x&&x.classList.remove("hidden")})});const s=e.querySelector("#profPhotoInput"),i=e.querySelector("#profPhotoButton"),o=e.querySelector("#profPhotoContainer"),r=e.querySelector("#profPhotoPreview"),n=e.querySelector("#profPhotoBase64"),l=t.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,d=t.photo||"",u=()=>s.click();i&&i.addEventListener("click",u),o&&o.addEventListener("click",u),s&&(s.onchange=async()=>{const p=s.files[0];if(p){r.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const m=await Pa(p,800,800,.8);if(m.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");r.src=m,n.value=m}catch(m){f("Erro de Imagem",m.message||"Não foi possível processar a imagem.","error"),r.src=l,n.value=d,s.value=""}}});const c=e.querySelector("#selectAllServicesBtn");if(c){c.addEventListener("click",()=>{const m=e.querySelectorAll('#profServicesContainer input[type="checkbox"]'),b=Array.from(m).every(x=>x.checked);m.forEach(x=>{x.checked=!b}),c.textContent=b?"Selecionar Todos":"Desmarcar Todos"});const p=e.querySelectorAll('#profServicesContainer input[type="checkbox"]');p.length>0&&Array.from(p).every(m=>m.checked)&&(c.textContent="Desmarcar Todos")}}function id(){Yt&&document.body.removeEventListener("click",Yt),Xt&&cs.removeEventListener("input",Xt),Yt=async t=>{if(t.target.classList.contains("professional-checkbox")){const o=t.target.dataset.id;t.target.checked?W.selectedIds.add(o):W.selectedIds.delete(o),vi(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){W.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600"),kt();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterServiceId").value="all",W.filterServiceId="all",kt();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),W.filterServiceId=document.getElementById("filterServiceId").value,kt();return}const a=t.target.closest("#toggle-filter-btn");if(a){t.preventDefault(),W.isAdvancedFilterOpen=!W.isAdvancedFilterOpen;const o=document.getElementById("filter-panel");W.isAdvancedFilterOpen?(o.classList.remove("hidden"),o.classList.add("block"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200")):(o.classList.add("hidden"),o.classList.remove("block"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"));return}const s=t.target.closest("[data-action]");if(!s){t.target.id==="professionals-layout-detail"&&Zt();return}const i=s.dataset.action;switch(["close-detail-screen","delete-professional","save-professional","delete-blockage","batch-delete-blockage"].includes(i)&&t.stopPropagation(),i){case"open-professional-editor":Zl(s.dataset.id);break;case"close-detail-screen":Zt(),W.tempProf=null;break;case"batch-delete":rd();break;case"delete-professional":{const o=s.dataset.id,r=W.tempProf?.name||"Profissional";if(await K("Excluir Profissional",`Tem certeza que deseja excluir ${r}? Esta ação não pode ser desfeita.`))try{await Po(o),ne(g.establishmentId,ua(),"Equipe","Excluiu",`Excluiu profissional: ${r}`),f("Sucesso!","Profissional excluído da rede.","success"),Zt(),Ia()}catch(l){f("Erro",`Não foi possível excluir: ${l.message}`,"error")}break}case"save-professional":{const o=document.getElementById("prof-modal-inner"),r=s,n=o.querySelector("#profScheduleContainer"),l=Array.from(o.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map(I=>I.value),d={};n&&n.querySelectorAll(".day-schedule-card").forEach(I=>{const S=I.querySelector('[data-field="active"]').dataset.day;d[S]={active:I.querySelector('[data-field="active"]').checked,start:I.querySelector('[data-field="start"]').value,end:I.querySelector('[data-field="end"]').value,breakStart:I.querySelector('[data-field="breakStart"]').value,breakEnd:I.querySelector('[data-field="breakEnd"]').value}});const u=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(I=>I.value),c=u.length>0?u:[g.establishmentId],p=o.querySelector("#profStatusToggle").checked,m=o.querySelector("#profCommissionToggle").checked,b=o.querySelector("#profShowOnAgendaToggle").checked,x={...W.tempProf,id:o.querySelector("#professionalId").value||void 0,accessibleIn:c,name:o.querySelector("#profName").value.trim(),specialty:o.querySelector("#profSpecialty").value,photo:o.querySelector("#profPhotoBase64").value,services:l,workingHours:d,phone:o.querySelector("#profPhone").value,dob:`${o.querySelector("#profDobDay").value}/${o.querySelector("#profDobMonth").value}`,receivesCommission:m,showOnAgenda:b,orderOnAgenda:parseInt(o.querySelector("#profOrderOnAgenda").value)||1,notes:o.querySelector("#profNotes").value,status:p?"active":"inactive",establishmentId:g.establishmentId},v=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{x.id?(await Ka(x.id,x),ne(g.establishmentId,ua(),"Equipe","Editou",`Editou o profissional: ${x.name}`),f("Sucesso!","Dados atualizados.","success")):(delete x.id,await kr(x),ne(g.establishmentId,ua(),"Equipe","Criou",`Cadastrou o profissional: ${x.name}`),f("Sucesso!","Novo membro adicionado à equipe.","success")),Zt(),Ia()}catch(I){f("Erro",I.message,"error"),r.disabled=!1,r.innerHTML=v}break}case"delete-blockage":{const o=s.dataset.id;if(await K("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await Ss(o),f("Bloqueio removido.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ct(W.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}case"batch-delete-blockage":{const o=JSON.parse(s.dataset.ids);if(await K("Apagar em Lote",`Tem certeza que deseja apagar ${o.length} dias de bloqueio de uma vez?`))try{await Qo(o),f("Bloqueios removidos.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ct(W.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}}},document.body.addEventListener("click",Yt),Xt=t=>{t.target.id==="searchInput"&&(W.searchQuery=t.target.value,kt())},cs.addEventListener("input",Xt)}function rd(){K("Excluir em Lote",`Tem certeza que deseja excluir ${W.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await Ir(Array.from(W.selectedIds)),ne(g.establishmentId,ua(),"Equipe","Excluiu em Lote",`Excluiu ${W.selectedIds.size} profissionais`),f("Sucesso!",`${W.selectedIds.size} profissionais foram excluídos.`,"success"),W.selectedIds.clear(),vi(),Ia()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}let w={clients:[],selectedClient:null,establishments:[],filterEstablishmentIds:new Set,isAdvancedFilterOpen:!1,filters:{search:"",inactiveDays:"",hasLoyalty:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:50,historyData:{appointments:[],sales:[],loyaltyLog:[],subscriptions:[]}},rt=null,Kt=null,ea=null;const Bs=t=>t?String(t).replace(/\D/g,""):"",us=t=>{if(!t)return"Nunca";let e;if(typeof t=="object"&&(t.seconds||t._seconds)){const a=t.seconds||t._seconds;e=new Date(a*1e3)}else e=new Date(t);return isNaN(e.getTime())?"Data Inválida":e.toLocaleDateString("pt-BR")},ps=t=>{if(!t)return"CL";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()};function nd(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function Je(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),w.selectedClient=null}async function ld(){rt=document.getElementById("content"),w.selectedClient=null,w.selectedIds.clear(),w.isAdvancedFilterOpen=!1,w.filters={search:"",inactiveDays:"",hasLoyalty:!1,status:"all"},w.sortConfig={key:"name",direction:"asc"};try{const e=(await De().catch(()=>({matrizes:[]}))).matrizes||[];w.establishments=[],e.forEach(a=>{w.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>w.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia",t)}dd(),pd(),await Ms()}function dd(){const t=w.establishments.map(e=>`
        ...
        <div class="border-b border-slate-100 hover:bg-slate-50 transition-colors relative group flex flex-col md:grid md:grid-cols-12 md:gap-2 md:items-center p-3 md:p-3 mb-2 md:mb-0 bg-white md:bg-transparent rounded-2xl md:rounded-none shadow-sm md:shadow-none border md:border-b md:border-x-0 md:border-t-0 mx-2 md:mx-0 ${s?"border-l-4 border-l-red-400":"border-l-4 border-l-transparent hover:border-l-indigo-300"} ${l?"bg-indigo-50/40 ring-1 ring-indigo-200 border-indigo-200":""} cursor-pointer active:scale-[0.99] md:active:scale-100" data-action="open-modal" data-id="${a.id}">
            ...
            <div class="flex justify-between items-start md:hidden mb-2 relative">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="pr-6 min-w-0">
                        <p class="font-black text-sm text-slate-800 truncate max-w-[180px]">${y(a.name)}</p>
                        <p class="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">${y(a.phone||"Sem contato")}</p>
                    </div>
                </div>
            ...
            <div class="hidden md:flex md:col-span-4 items-center gap-3 pl-2">
                ...
                <div class="min-w-0 flex-1">
                    <p class="font-black text-sm text-slate-800 truncate" title="${y(a.name)}">${y(a.name)}</p>
                    <div class="flex gap-1.5 mt-1">${d}</div>
                </div>
            </div>

            <div class="hidden md:block md:col-span-3">
                <p class="text-[10px] font-black text-slate-700 uppercase tracking-widest">${y(a.phone||"--")}</p>
                <p class="text-[9px] text-slate-400 font-bold truncate w-full mt-0.5" title="${y(a.email||"")}">${y(a.email||"--")}</p>
            </div>
                        ...
                        <div class="bg-white p-5 md:p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="tel" name="phone" value="${y(e.phone||"")}" required placeholder="(00) 00000-0000" class="w-full p-3.5 border border-slate-300 rounded-xl text-sm font-bold text-slate-800 outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50 focus:bg-white shadow-inner transition-colors">
                                </div>
                                <div>
                                    <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5 ml-1">CPF</label>
                                    <input type="text" name="cpf" value="${y(e.cpf||"")}" placeholder="000.000.000-00" class="w-full p-3.5 border border-slate-300 rounded-xl text-sm font-bold text-slate-800 outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50 focus:bg-white shadow-inner transition-colors">
                                </div>
                            </div>

                            <div>
                                <label class="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5 ml-1">E-mail</label>
                                <input type="email" name="email" value="${y(e.email||"")}" class="w-full p-3.5 border border-slate-300 rounded-xl text-sm font-bold text-slate-800 outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50 focus:bg-white shadow-inner transition-colors">
                            </div>
                        </div>
    ...
    `,t.querySelectorAll(".tab-link").forEach(l=>{l.addEventListener("click",d=>{d.preventDefault(),t.querySelectorAll(".tab-link").forEach(u=>{u.classList.remove("active","border-indigo-600","text-indigo-600"),u.classList.add("border-transparent","text-slate-400")}),l.classList.add("active","border-indigo-600","text-indigo-600"),l.classList.remove("border-transparent","text-slate-400"),t.querySelectorAll(".tab-content").forEach(u=>u.classList.add("hidden")),t.querySelector("#"+l.dataset.tab).classList.remove("hidden")})});const r=t.querySelector("#form-edit-client");r&&(r.onsubmit=hd);const n=t.querySelector('[data-action="delete-client"]');n&&(n.onclick=vd)}function gd(t){const e=new Date,a=t.filter(o=>new Date(o.date)>=e&&o.status!=="cancelled").sort((o,r)=>new Date(o.date)-new Date(r.date)),s=t.filter(o=>new Date(o.date)<e||o.status==="cancelled").sort((o,r)=>new Date(r.date)-new Date(o.date)),i=(o,r)=>{const n=new Date(o.date);let l="";o.status==="cancelled"?l='<span class="text-red-600 bg-red-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-red-200 shadow-sm">Cancelado</span>':o.status==="completed"||r?l='<span class="text-slate-500 bg-slate-100 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-slate-200 shadow-sm">Concluído</span>':o.status==="confirmed"?l='<span class="text-blue-700 bg-blue-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-blue-200 shadow-sm">Confirmado</span>':l='<span class="text-orange-700 bg-orange-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-orange-200 shadow-sm">Aguardando</span>';const d=w.establishments.find(u=>u.id===o.establishmentId)?.name||"Unidade Local";return`
        <div class="bg-white border border-slate-200 rounded-2xl p-3 flex gap-3 shadow-sm items-center cursor-pointer active:scale-[0.98] transition-transform hover:border-indigo-300" data-go-agenda="true" data-id="${o.id}" data-date="${o.date}" data-est="${o.establishmentId}">
            ...
            <div class="flex-grow min-w-0">
                <p class="font-black text-sm text-slate-800 truncate">${y(o.description||"Serviço Variado")}</p>
                ...
                <div class="p-3 space-y-1 max-h-80 overflow-y-auto custom-scrollbar overscroll-contain">
                    ${e.length>0?e.map(a=>{const s=a.points<0;return`
                        <div class="flex justify-between items-center py-3 px-4 border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors rounded-xl">
                            <div>
                                <p class="text-[10px] font-black text-slate-800 uppercase tracking-wider">${y(a.description||(s?"Resgate":"Acúmulo"))}</p>
        ...
        ${t.map(a=>{const s=a.status==="past_due",i=a.status==="active";a.status;const o=i?"text-emerald-700 bg-emerald-50 border-emerald-200":s?"text-red-700 bg-red-50 border-red-200":"text-gray-700 bg-gray-50 border-gray-200",r=i?"Ativo":s?"Pagamento Atrasado":"Cancelado",n=i?"bi-check-circle-fill text-emerald-500":s?"bi-exclamation-circle-fill text-red-500":"bi-x-circle-fill text-gray-500";let l="N/A";if(a.currentPeriodEnd){const c=typeof a.currentPeriodEnd=="object"&&a.currentPeriodEnd._seconds?new Date(a.currentPeriodEnd._seconds*1e3):new Date(a.currentPeriodEnd);isNaN(c.getTime())||(l=c.toLocaleDateString("pt-BR"))}const d=a.usageLimit?`${a.usageCurrentMonth||0} / ${a.usageLimit}`:`${a.usageCurrentMonth||0} (Ilimitado)`,u=`https://wa.me/55${Bs(e.phone)}?text=${encodeURIComponent("Olá "+e.name.split(" ")[0]+", notamos uma pendência na renovação do seu "+a.planName+". Podemos ajudar?")}`;return`
            <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
                <div class="flex justify-between items-start mb-4 border-b border-slate-100 pb-4">
                    <div>
                        <h4 class="font-black text-lg text-slate-800 flex items-center gap-2"><i class="bi bi-gem text-indigo-500"></i> ${y(a.planName)}</h4>
    ...
    `;try{let e=null;try{e=await A("/api/pagarme/recipient")}catch(s){if(!s.message.includes("404"))throw s}if(e&&e.id){t.innerHTML=`
                <div class="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 text-center shadow-sm max-w-2xl mx-auto mt-6">
                    ...
                    <div class="bg-white rounded-xl p-4 inline-block text-left border border-emerald-100">
                        ...
                        <p class="text-sm font-mono font-bold text-gray-700">${y(e.id)}</p>
                    </div>
                </div>
            `;return}t.innerHTML=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const u={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,cnpj:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};Qe(u,d)})}function Id(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const x=e.querySelector("#mockup-screen-wrapper"),v=e.querySelector("#mockup-screen"),I=e.querySelector("#previewPrimaryColorInput"),S=e.querySelector("#previewBgColorInput"),C=e.querySelector("#previewTextColorInput"),V=e.querySelector("#previewTitleColorInput"),M=e.querySelector("#typographyInput"),q=e.querySelector("#establishmentWelcomeMessage"),L=e.querySelector("#mockup-welcome"),k=e.querySelector("#socialInstagram"),H=e.querySelector("#socialWhatsapp"),z=e.querySelector("#socialFacebook"),D=e.querySelector("#prevTemplate"),j=e.querySelector("#nextTemplate"),R=e.querySelector("#templateNameDisplay"),B=e.querySelector("#selectedTemplateId"),G=J=>{const ae=de[J];x.style.opacity="0.3",x.style.transform="scale(0.96)",setTimeout(()=>{I.value=ae.primary,S.value=ae.bg,C.value=ae.text,V.value=ae.titleColor||ae.text,M.value=ae.font,e.querySelectorAll('input[name="buttonStyle"]').forEach(ge=>{ge.checked=ge.value===ae.btn}),B.value=ae.id,R.textContent=ae.name,v.style.setProperty("--preview-primary",ae.primary),v.style.setProperty("--preview-bg",ae.bg),v.style.setProperty("--preview-text",ae.text),v.style.setProperty("--preview-title-color",ae.titleColor||ae.text),v.style.setProperty("--preview-font",ae.font),v.style.setProperty("--preview-btn-radius",b(ae.btn)),v.style.setProperty("--preview-card-bg",ae.cardBg),v.style.setProperty("--preview-card-border",ae.cardBorder),x.style.opacity="1",x.style.transform="scale(1)"},300)};D.addEventListener("click",()=>{m=(m-1+de.length)%de.length,G(m)}),j.addEventListener("click",()=>{m=(m+1)%de.length,G(m)}),I.addEventListener("input",J=>v.style.setProperty("--preview-primary",J.target.value)),S.addEventListener("input",J=>v.style.setProperty("--preview-bg",J.target.value)),C.addEventListener("input",J=>v.style.setProperty("--preview-text",J.target.value)),V.addEventListener("input",J=>v.style.setProperty("--preview-title-color",J.target.value)),M.addEventListener("change",J=>v.style.setProperty("--preview-font",J.target.value)),e.querySelectorAll('input[name="buttonStyle"]').forEach(J=>{J.addEventListener("change",ae=>{ae.target.checked&&v.style.setProperty("--preview-btn-radius",b(ae.target.value))})}),q.addEventListener("input",J=>L.textContent=J.target.value||"Mensagem...");const Y=()=>{e.querySelector("#mockup-insta-icon").classList.toggle("hidden",!k.value.trim()),e.querySelector("#mockup-whats-icon").classList.toggle("hidden",!H.value.trim()),e.querySelector("#mockup-face-icon").classList.toggle("hidden",!z.value.trim())};[k,H,z].forEach(J=>J.addEventListener("input",Y));const Q=e.querySelector("#establishmentLogoInput"),T=e.querySelector("#establishmentBgInput"),X=e.querySelector("#establishmentLogoBase64"),ie=e.querySelector("#establishmentBackgroundImageBase64");e.querySelector("#triggerLogoUpload").addEventListener("click",J=>{J.target.id!=="establishmentLogoInput"&&Q.click()}),Q.onchange=async J=>{const ae=J.target.files[0];if(ae){const ge=await to(ae,300,.9);e.querySelector("#establishmentLogoPreview").src=ge,e.querySelector("#mockup-logo").src=ge,X.value=ge}},e.querySelector("#triggerBannerUpload").addEventListener("click",J=>{J.target.id!=="establishmentBgInput"&&T.click()}),T.onchange=async J=>{const ae=J.target.files[0];if(ae){const ge=await to(ae,1280,.8);e.querySelector("#establishmentBgPreview").src=ge,e.querySelector("#establishmentBgPreview").classList.remove("hidden"),e.querySelector("#establishmentBgPlaceholder").classList.add("hidden"),ie.value=ge,e.querySelector("#mockup-banner").src=ge,e.querySelector("#mockup-banner").classList.remove("hidden"),e.querySelector("#mockup-banner-placeholder").classList.add("hidden")}},e.querySelector("#branding-form").addEventListener("submit",J=>{J.preventDefault();let ae="rounded";e.querySelectorAll('input[name="buttonStyle"]').forEach(Fs=>{Fs.checked&&(ae=Fs.value)});const ge={logo:X.value,backgroundImage:ie.value,welcomeMessage:q.value,templateId:B.value,primaryColor:I.value,backgroundColor:S.value,textColor:C.value,titleColor:V.value,typography:M.value,buttonStyle:ae,socialLinks:{instagram:k.value.trim(),whatsapp:H.value.trim(),facebook:z.value.trim()}};Qe(ge,J)})}function $d(t,e){const a=t.urlId||oe;let s=window.location.origin;(s.includes("localhost")||s.includes("capacitor://")||s.includes("127.0.0.1"))&&(s="https://www.kairosagenda.com.br");const i=y(`${s}/agendar?id=${a}`),o=t.publicBookingEnabled||!1,r=o?"Agendamento Online ATIVO":"Agendamento Online INATIVO",n=o?"text-green-600":"text-red-600";e.innerHTML=`
    ...
    `;const n=e.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const u=document.createElement("div");u.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const c=d.type||"money",p=d.itemId||"",m=d.reward||"",b=d.discount||"",x=d.points||d.costPoints||"";u.innerHTML=`
            ...
            <div class="relative md:col-span-2">
                ...
                <div class="flex gap-2">
                    <input type="text" placeholder="Ex: R$ 20 de Desconto" data-field="rewardName" value="${y(m)}" class="desc-input flex-1 p-2 border border-gray-300 rounded-md ${c!=="money"?"hidden":""}">
        ...
        `;const v=u.querySelector(".type-select"),I=u.querySelector(".item-select"),S=u.querySelector(".desc-input"),C=u.querySelector(".discount-input"),V=M=>{I.innerHTML='<option value="">Selecione...</option>';let q=[];M==="service"?q=i:M==="product"?q=o:M==="package"&&(q=r),q.forEach(L=>{const k=L.id===p,H=L.name||L.title||"Sem nome",z=L.price||L.salePrice||0;I.innerHTML+=`<option value="${L.id}" data-price="${z}" ${k?"selected":""}>${y(H)}</option>`})};return c!=="money"&&V(c),v.addEventListener("change",M=>{const q=M.target.value;q==="money"?(I.classList.add("hidden"),S.classList.remove("hidden"),S.value="",C.value=""):(I.classList.remove("hidden"),S.classList.add("hidden"),V(q),C.value="")}),I.addEventListener("change",M=>{const q=M.target.selectedOptions[0];if(q&&q.value){S.value=q.text;const L=q.dataset.price;L&&(C.value=parseFloat(L).toFixed(2))}}),u};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),e.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const u=d.target.closest(".remove-loyalty-tier");u&&u.closest(".loyalty-tier-row").remove()}),e.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const u=Array.from(e.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(p=>{const m=p.querySelector(".type-select").value,b=m==="money"?null:p.querySelector(".item-select").value;let x=m==="money"?p.querySelector(".desc-input").value:p.querySelector(".item-select").options[p.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,type:m,itemId:b,reward:x,name:x,discount:parseFloat(p.querySelector('input[data-field="discount"]').value)||0}}),c={loyaltyProgram:{enabled:e.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(e.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:u.filter(p=>p.points>0&&p.reward)}};Qe(c,d)})}async function Pd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([Ma(oe),ks(oe)]),i=t.financialIntegration||{},o=t.commissionConfig||{},r=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=Ze(a,i.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=Ze(s,i.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=Ze(a,r.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=Ze(s,r.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=Ze(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=Ze(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};Qe(s,a)})}function Td(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `,_e.querySelector('button[data-action="back-to-menu"]').addEventListener("click",i=>{i.preventDefault(),Ei({id:oe})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":kd(ee,s);break;case"change-password":Id(ee,s);break;case"change-email":Sd(ee,s);break;case"branding":Ed(ee,s);break;case"booking":$d(ee,s);break;case"working-hours":Ld(ee,s);break;case"whatsapp-bot":ba(ee,s);break;case"auto-messages":Cd(ee,s);break;case"loyalty":await Dd(ee,s);break;case"financial":await Pd(ee,s);break;case"pagarme":Ii(s);break;case"support":Td(ee,s);break;case"cancellation":Ad(ee,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Ei(t={}){_e.innerHTML=`
    ...
    `;try{oe=t.id||g.establishmentId,ee=await Me(oe);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=ee.isMatriz||!ee.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=Si();_e.innerHTML=`
            <div class="max-w-5xl mx-auto w-full pb-20">
                ...
                <div class="bg-gradient-to-r from-indigo-900 to-indigo-700 rounded-xl shadow-lg p-6 mb-8 text-white flex justify-between items-center relative overflow-hidden">
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-1">${y(ee.name)} ${a}</h3>
                        <p class="text-indigo-200 text-sm flex items-center gap-2"><i class="bi bi-geo-alt"></i> ${y(ee.address||"Morada não definida")}</p>
                    </div>
        ...
        `,_e.querySelectorAll("div[data-section]").forEach(i=>{i.addEventListener("click",o=>{Md(i.dataset.section)})}),_e.querySelectorAll(".module-toggle").forEach(i=>{i.addEventListener("change",async()=>{const o=i.dataset.module;try{const n={...(await Me(oe)).modules,[o]:i.checked};await qt(oe,{modules:n}),f("Módulos","Módulos atualizados com sucesso.","success")}catch(r){i.checked=!i.checked,f("Erro",r.message,"error")}})})}catch(e){_e.innerHTML=`
    ...
    `).join("")}const Dt=document.getElementById("content");async function ct(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,i=await qa(g.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),r=o?i.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):i,n=r.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",r.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${y(l)} (${d.length})</h4>`;if(d.length>1){const m=JSON.stringify(d.map(b=>b.id));p+=`<button data-action="batch-delete-blockage" data-ids='${m}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",u.innerHTML=p,d.forEach(m=>{const b=new Date(m.startTime),x=new Date(m.endTime),v=b.toLocaleDateString("pt-BR"),I=x.toLocaleDateString("pt-BR"),C=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${v===I?`${v} | ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${x.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${v} às ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${I} às ${x.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;u.innerHTML+=C}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function qd(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,i=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,r=e.querySelector("#blockageEndTime").value,n={establishmentId:g.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Fa(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),ct(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Fd(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,i=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,r=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:g.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:n};return Fa(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&ct(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Nd(t){Dt.addEventListener("submit",e=>{e.target.id==="blockageForm"&&qd(e),e.target.id==="batchBlockageForm"&&Fd(e)}),Dt.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&ct(t)}),Dt.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")re("profissionais-section");else if(s==="delete-blockage"){if(await K("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Ss(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),ct(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const i=JSON.parse(a.dataset.ids);if(await K("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${i.length} bloqueios de uma vez?`))try{await Qo(i),f("Sucesso",`${i.length} bloqueios removidos.`,"success"),ct(t)}catch(r){f("Erro",`Não foi possível apagar os bloqueios: ${r.message}`,"error")}}})}async function Rd(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){Dt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=y(a);Dt.innerHTML=`
        <section>
        ...
        </section>`,Nd(e),await ct(e);const i=document.getElementById("batchProfSelectionContainer");try{const o=await Pe(g.establishmentId);i.innerHTML=o.map(r=>`
            <div class="flex items-center">
                ...
                <label for="prof-batch-${r.id}" class="ml-2 text-sm text-gray-700">${y(r.name)}</label>
            </div>`).join("")}catch{i.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const Hd=t=>A(`/api/users/${t}`),Od=t=>A("/api/users",{method:"POST",body:JSON.stringify(t)}),zd=(t,e)=>A(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),_d=t=>A(`/api/users/${t}`,{method:"DELETE"}),Vd=(t,e)=>A(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),Ud=(t,e)=>A(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),ht=document.getElementById("content"),Wd={"Operação & Atendimento":{"dashboard-section":{title:"Dashboard",icon:"bi-grid-1x2-fill"},"agenda-section":{title:"Agenda",icon:"bi-calendar3"},"comandas-section":{title:"Comandas / PDV",icon:"bi-receipt"},"ausencias-section":{title:"Ausências e Bloqueios",icon:"bi-clock-history"}},"Financeiro & Vendas":{"financial-section":{title:"Financeiro (ERP)",icon:"bi-currency-dollar"},"sales-report-section":{title:"Relatório de Vendas",icon:"bi-graph-up-arrow"},"commissions-section":{title:"Comissões",icon:"bi-percent"},"packages-section":{title:"Planos e Pacotes",icon:"bi-box-seam"}},"Cadastros Base":{"clientes-section":{title:"Clientes",icon:"bi-people"},"profissionais-section":{title:"Profissionais",icon:"bi-person-workspace"},"servicos-section":{title:"Serviços",icon:"bi-scissors"},"produtos-section":{title:"Produtos",icon:"bi-box"},"suppliers-section":{title:"Fornecedores",icon:"bi-truck"}},Administração:{"relatorios-section":{title:"Relatórios Gerais",icon:"bi-bar-chart-fill"},"estabelecimento-section":{title:"Configurações da Empresa",icon:"bi-gear-fill"},"users-section":{title:"Usuários e Acessos",icon:"bi-shield-lock-fill"}}},Jd={view:"Visualizar",create:"Criar",edit:"Editar"},ao={owner:{label:"Proprietário",color:"bg-rose-100 text-rose-700 border-rose-200"},group_admin:{label:"Admin da Rede",color:"bg-purple-100 text-purple-700 border-purple-200"},company_admin:{label:"Gestor Matriz",color:"bg-blue-100 text-blue-700 border-blue-200"},branch_manager:{label:"Gestor Filial",color:"bg-orange-100 text-orange-700 border-orange-200"},professional:{label:"Profissional",color:"bg-slate-100 text-slate-600 border-slate-200"}};let ta=null,aa=null,Ke=null,Ae=null;function $i(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.currentViewContext?.id||g.establishmentId]}function Gd(t){const e=document.getElementById("usersListContainer");if(!e)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const s=a?"Nenhum usuário encontrado na base.":"Nenhum usuário ativo neste contexto.";e.innerHTML=`
        ...
        <div class="user-card-clickable bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between p-4 cursor-pointer hover:border-indigo-300 hover:shadow-md transition-all active:scale-[0.99] ${o?"":"opacity-60 bg-slate-50"}" 
            ...
            <div class="flex items-center gap-4 w-full md:w-auto mb-4 md:mb-0">
                ...
                <div class="flex-1 min-w-0 pointer-events-none">
                    ...
                    <p class="text-[10px] md:text-xs text-slate-500 font-medium truncate mb-1">${y(s.email)}</p>
        ...
        `}).join("")}function Li(){const e=document.getElementById("showInactiveUsersToggle")?.checked?g.users:g.users.filter(a=>a.status==="active");Gd(e)}function Qd(t={}){let e="",a=!1;for(const[s,i]of Object.entries(Wd)){const o=Object.entries(i).filter(([r])=>{const n=r.replace("-section","");return!(g.enabledModules&&g.enabledModules[n]===!1)});o.length!==0&&(a=!0,e+=`
        <div class="mb-8 last:mb-0">
            <h4 class="font-black text-xs text-slate-400 uppercase tracking-widest mb-4 border-b border-slate-100 pb-2 flex items-center gap-2">
                <i class="bi bi-folder2-open text-indigo-400 text-lg"></i> ${s}
            </h4>
        ...
        `,o.forEach(([r,n])=>{const l=r==="agenda-section"||r==="comandas-section",d=t[r]?.view_all_prof===!0,u=Object.entries(Jd).map(([p,m])=>`
                <label class="flex items-center justify-between cursor-pointer py-1.5 px-2 rounded-lg hover:bg-slate-50 transition-colors">
                    <span class="text-[10px] text-slate-600 font-bold uppercase tracking-widest">${m}</span>
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 hover:border-indigo-300 hover:shadow-md transition-all flex flex-col justify-between relative overflow-hidden group">
                ...
                <h5 class="font-black text-sm text-slate-800 mb-3 flex items-center gap-2 pl-2">
                    <i class="bi ${n.icon} text-slate-400 group-hover:text-indigo-500 transition-colors"></i> 
                    ${n.title}
                </h5>
            ...
            `}),e+="</div></div>")}return a?e:'<div class="p-6 bg-rose-50 border border-rose-100 rounded-2xl text-center"><p class="text-sm font-bold text-rose-600">Sua empresa não possui módulos ativados. Contate o suporte.</p></div>'}function so(t){if(!Ae)return'<p class="text-xs text-rose-500 p-4">Carregando lista de unidades...</p>';if(g.userRole==="professional")return"";const e=t?.accessibleEstablishments?.map(o=>o.id)||[],a=t?.accessibleCompanies?.map(o=>o.id)||[],s=t?.role||"professional";if(s==="owner"||s==="group_admin")return'<div class="p-5 bg-indigo-50 border border-indigo-200 rounded-xl text-indigo-800 text-sm font-black flex items-center justify-center gap-3"><i class="bi bi-shield-check text-2xl"></i> Acesso Total (Toda a Rede)</div>';if(!Ae.companies||Ae.companies.length===0)return'<p class="text-xs text-slate-500 p-4">Nenhuma unidade disponível na hierarquia.</p>';let i='<div class="space-y-3 max-h-60 overflow-y-auto custom-scrollbar p-1">';return Ae.companies.forEach(o=>{const r=a.includes(o.id),n=Ae.branches.filter(l=>l.companyId===o.id);i+=`
        ...
        `}),i+="</div>",i}async function oo(t=null){document.getElementById("user-list-view").classList.add("hidden");const e=document.getElementById("user-form-view");e.classList.remove("hidden");let a=g.professionals;if(!a||a.length===0)try{const m=$i().map(v=>Pe(v)),b=await Promise.all(m),x=new Map;b.flat().forEach(v=>x.set(v.id,v)),a=Array.from(x.values()),g.professionals=a}catch(p){console.warn("Profissionais não carregados",p)}if(["owner","group_admin","company_admin","admin"].includes(g.userRole)&&!Ae)try{const p=await De();if(p&&p.matrizes){const m=[],b=[];p.matrizes.forEach(x=>{m.push({id:x.id,name:x.name}),x.branches&&x.branches.length>0&&x.branches.forEach(v=>{b.push({id:v.id,name:v.name,companyId:x.id})})}),Ae={companies:m,branches:b}}else p&&(Ae=p)}catch(p){console.error("Falha ao buscar hierarquia",p),Ae={companies:[],branches:[]}}const s=t!==null,i=s&&t.role==="owner",o=g.userRole==="owner",r=e.querySelector("#userFormTitle");r.innerHTML=s?`<i class="bi bi-person-lines-fill mr-2 text-indigo-600"></i>Editar Perfil: ${t.name}`:'<i class="bi bi-person-plus-fill mr-2 text-indigo-600"></i>Novo Acesso';const n=e.querySelector("#userForm");n.innerHTML=`
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col min-h-[70vh]">
            ...
            <div class="flex-1 p-4 md:p-6 bg-slate-50/30 overflow-y-auto">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                        ...
                        <div class="form-group max-w-xl">
                            ...
                            <select id="userProfessionalId" class="w-full p-3 border border-slate-300 rounded-xl text-sm font-bold text-slate-800 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-orange-500 outline-none shadow-inner transition-colors">
                                ...
                                ${a?.map(p=>`<option value="${p.id}" ${p.id===t?.professionalId?"selected":""}>${p.name}</option>`).join("")}
                            </select>
                ...
                <div id="tab-acesso" class="tab-content hidden space-y-6 animate-fade-in-fast">
                    ${["owner","group_admin","company_admin","admin"].includes(g.userRole)?`
                    <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div>
                                ...
                                <select id="userRole" class="w-full p-3.5 border border-indigo-200 rounded-xl text-sm font-black text-indigo-900 bg-indigo-50 focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none shadow-sm transition-colors" ${i&&!o?"disabled":""}>
                                    ${o?`<option value="owner" ${t?.role==="owner"?"selected":""}>Proprietário (Dono do Negócio)</option>`:""}
                                    ${["owner","group_admin","admin"].includes(g.userRole)?`<option value="group_admin" ${t?.role==="group_admin"?"selected":""}>Administrador Geral (Acesso Total)</option>`:""}
    ...
    `;const l=e.querySelectorAll(".tab-btn"),d=e.querySelectorAll(".tab-content");l.forEach(p=>{p.addEventListener("click",()=>{l.forEach(b=>{b.classList.remove("active","text-indigo-600","border-indigo-600"),b.classList.add("text-slate-400","border-transparent")}),d.forEach(b=>b.classList.add("hidden")),p.classList.add("active","text-indigo-600","border-indigo-600"),p.classList.remove("text-slate-400","border-transparent");const m=p.getAttribute("data-tab");e.querySelector(`#${m}`).classList.remove("hidden")})});const u=n.querySelector("#userRole"),c=n.querySelector("#hierarchySelectorContainer");if(u&&c){u.addEventListener("change",m=>{const b={...t,role:m.target.value};c.innerHTML=so(b),p()});const p=()=>{c.querySelectorAll(".company-checkbox").forEach(m=>{m.addEventListener("change",b=>{b.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(I=>{I.checked=b.target.checked;const S=I.nextElementSibling.querySelector(".dot");S&&(b.target.checked?S.classList.add("transform","translate-x-4"):S.classList.remove("transform","translate-x-4"))})})})};p()}if(n.querySelectorAll(".permission-checkbox").forEach(p=>{if(p.addEventListener("change",m=>{const b=m.target.nextElementSibling,x=b.nextElementSibling;m.target.checked?(b.classList.replace("bg-slate-200","bg-indigo-500"),b.classList.replace("bg-indigo-200","bg-indigo-500"),x.classList.add("transform","translate-x-4")):(b.classList.replace("bg-indigo-500","bg-slate-200"),b.classList.replace("bg-indigo-500","bg-indigo-200"),x.classList.remove("transform","translate-x-4"))}),p.checked){const m=p.nextElementSibling,b=m.nextElementSibling;m.classList.replace("bg-slate-200","bg-indigo-500"),m.classList.replace("bg-indigo-200","bg-indigo-500"),b.classList.add("transform","translate-x-4")}}),n.onsubmit=async p=>{p.preventDefault();const m=n.querySelector('button[type="submit"]'),b=m.innerHTML;m.disabled=!0,m.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Processando...';const x={};n.querySelectorAll(".permission-checkbox").forEach(M=>{const q=M.dataset.module,L=M.dataset.permission;x[q]||(x[q]={}),x[q][L]=M.checked});const v=n.querySelector("#userProfessionalId").value||null,I=n.querySelector("#userRole")?.value||"professional",S=[],C=[];if(I!=="group_admin"&&I!=="owner"&&n.querySelector(".company-checkbox")&&(n.querySelectorAll(".company-checkbox:checked").forEach(M=>{S.push({id:M.value,name:M.dataset.name})}),n.querySelectorAll(".branch-checkbox:checked").forEach(M=>{C.push({id:M.value,name:M.dataset.name,companyId:M.dataset.companyId})}),C.length===0))return m.disabled=!1,m.innerHTML=b,f("Atenção","Selecione pelo menos uma filial na aba de Acesso.","warning");const V={name:n.querySelector("#userName").value,permissions:x,professionalId:v,role:I,accessibleCompanies:S,accessibleEstablishments:C};try{if(s){const M=n.querySelector("#userEmail").value;t?.email!==M&&!i&&(V.email=M),await zd(t.id,V),f("Sucesso","Usuário atualizado.","success")}else V.email=n.querySelector("#userEmail").value,V.password=n.querySelector("#userPassword").value,await Od(V),f("Sucesso","Novo usuário cadastrado na plataforma.","success");Sa()}catch(M){f(`Erro: ${M.message}`,"error"),m.disabled=!1,m.innerHTML=b}},s){const p=n.querySelector("#btn-show-password"),m=n.querySelector("#password-form");p&&m&&(p.onclick=()=>{p.classList.add("hidden"),m.classList.remove("hidden")},n.querySelector("#btn-cancel-pwd").onclick=()=>{p.classList.remove("hidden"),m.classList.add("hidden"),m.querySelector("#userNewPassword").value=""},n.querySelector("#btn-save-pwd").onclick=async b=>{const x=b.target,v=m.querySelector("#userNewPassword").value;if(!v||v.length<6)return f("Aviso","Senha deve ter no mínimo 6 caracteres.","warning");if(await K("Alterar Senha","O usuário usará esta nova senha no próximo acesso. Confirma?"))try{x.disabled=!0,x.textContent="Aguarde...",await Vd(t.id,v),f("Sucesso","Senha alterada com segurança.","success"),p.classList.remove("hidden"),m.classList.add("hidden")}catch(I){f("Erro",I.message,"error")}finally{x.disabled=!1,x.textContent="Salvar Senha"}})}}async function io(){const t=document.getElementById("usersListContainer");if(t){t.innerHTML='<div class="col-span-full py-16 flex justify-center"><div class="loader"></div></div>';try{const e=$i(),a=e.map(l=>Hd(l)),s=e.map(l=>Pe(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),g.users=Array.from(r.values());const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),g.professionals=Array.from(n.values()),Li()}catch{f("Erro ao carregar base de usuários.","error"),t.innerHTML='<p class="col-span-full text-center font-bold text-red-500 bg-red-50 p-6 rounded-2xl">Falha de comunicação com o servidor de acessos.</p>'}}}async function Sa(){ht.innerHTML=`
    ...
    `,ta&&ht.removeEventListener("click",ta),aa&&ht.removeEventListener("change",aa),Ke&&(window.removeEventListener("kairos:contextChanged",Ke),document.removeEventListener("change",Ke)),Ke=t=>{(t.type==="kairos:contextChanged"||t.target.closest("#multi-context-list"))&&document.getElementById("user-list-view")&&!document.getElementById("user-list-view").classList.contains("hidden")&&io()},window.addEventListener("kairos:contextChanged",Ke),document.addEventListener("change",Ke),ta=async t=>{const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":oo();break;case"edit-user":const s=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));oo(s);break;case"back-to-list":Sa();break;case"delete-user":{if(t.stopPropagation(),await K("Excluir Usuário","O usuário perderá totalmente o acesso ao sistema. Confirma?"))try{await _d(e.dataset.userId),f("Usuário excluído com sucesso.","success"),Sa()}catch(i){f(`Erro: ${i.message}`,"error")}break}}},aa=async t=>{if(t.target.id==="showInactiveUsersToggle"){const e=t.target.nextElementSibling,a=e.nextElementSibling;t.target.checked?(e.classList.replace("bg-slate-200","bg-indigo-500"),a.classList.add("transform","translate-x-5")):(e.classList.replace("bg-indigo-500","bg-slate-200"),a.classList.remove("transform","translate-x-5")),Li()}else{const e=t.target.closest('input[data-action="toggle-user-status"]');if(e){t.stopPropagation();const a=e.dataset.userId,s=e.checked?"active":"inactive",i=e.nextElementSibling,o=i.nextElementSibling;e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"));try{await Ud(a,s);const r=g.users.findIndex(n=>n.id===a);if(r>-1){g.users[r].status=s;const n=e.closest(".user-card-clickable");s==="inactive"?n.classList.add("opacity-60","bg-slate-50"):n.classList.remove("opacity-60","bg-slate-50")}}catch(r){f(`Erro: ${r.message}`,"error"),e.checked=!e.checked,e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"))}}}},ht.addEventListener("click",ta),ht.addEventListener("change",aa),await io()}const Yd=document.getElementById("content");let ro={},ms=null;function Xd(){Object.values(ro).forEach(t=>t?.destroy()),ro={}}function Zd(t,e){if(!window.jspdf){f("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),i=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(t,s.internal.pageSize.getWidth()/2,40,{align:"center"}),i){const r=[["Receita Total",i.querySelector("#summary-revenue").textContent],["Vendas Totais",i.querySelector("#summary-transactions").textContent],["Ticket Médio",i.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:r,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${e}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function no(t){const e=document.getElementById("genericModal"),a=y(t.client),s=y(t.items),i=y(t.responsavelCaixa||"N/A"),o=(t.payments||[]).map(r=>`
        <div class="flex justify-between text-sm">
            <span>${y(r.method.charAt(0).toUpperCase()+r.method.slice(1))}</span>
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=ms.transactions[l];d&&no(d)})}),r.innerHTML=a.map((n,l)=>{const d=y(n.client),u=y(n.items),c=y(n.type);return`
    ...
    `}).join(""),r.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ms.transactions[l];d&&no(d)})})}async function lo(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,i=a.value;if(!s||!i)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,r=await Mo({establishmentId:g.establishmentId,startDate:s,endDate:i,cashierSessionId:o});ms=r,t.innerHTML=`
        ...
        `,Kd(r)}catch(o){f("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${y(o.message)}</p>`}}async function ec(){Xd();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];Yd.innerHTML=`
    ...
    `}function Pt(){const t=document.getElementById("list-container");if(!t)return;const e=E.currentTab==="receivables",a=e?E.receivables:E.payables;let s=a;if(E.statusFilter!=="all"&&(s=a.filter(c=>{const p=mt(c.dueDate,c.status);return E.statusFilter==="overdue"?p:E.statusFilter==="pending"?c.status==="pending"&&!p:c.status===E.statusFilter})),E.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(E.searchQuery)||c.entity&&c.entity.toLowerCase().includes(E.searchQuery)||c.notes&&c.notes.toLowerCase().includes(E.searchQuery))),s.sort((c,p)=>{let m=c[E.sortCol],b=p[E.sortCol];return E.sortCol==="dueDate"?(m=new Date(m).getTime(),b=new Date(b).getTime()):(E.sortCol==="description"||E.sortCol==="status")&&(m=m?m.toLowerCase():"",b=b?b.toLowerCase():""),m<b?E.sortAsc?-1:1:m>b?E.sortAsc?1:-1:0}),ic(),s.length===0){t.innerHTML=`
        ...
        <div class="financial-row bg-white border border-gray-100 md:border-0 md:border-b md:border-gray-100 hover:bg-gray-50 transition-all cursor-pointer relative flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center p-3.5 md:px-6 md:py-4 mb-3 md:mb-0 rounded-2xl md:rounded-none ${M?"ring-2 md:ring-0 ring-indigo-500 bg-indigo-50/50 md:bg-indigo-50/50":""} ${m?"opacity-70 md:opacity-100":""}"
            ...
            <div class="md:hidden flex items-start gap-3 w-full pr-6">
                ...
                <div class="flex-1 min-w-0 flex flex-col">
                    <div class="flex justify-between items-center mb-1">
                        <p class="font-bold text-[14px] text-gray-900 truncate leading-tight pr-2 ${m?"line-through text-gray-400":""}">${y(c.description)}</p>
                    ...
                    <div class="flex justify-between items-end mt-1.5">
                        <div class="flex flex-col gap-1.5 overflow-hidden pr-2">
                            <p class="text-[10px] text-gray-500 font-semibold truncate leading-none"><i class="bi bi-person opacity-60 mr-1"></i>${y(c.entity||"Sem Entidade")}</p>
            ...
            <div class="hidden md:flex md:col-span-4 flex-col justify-center min-w-0 pr-4">
                <div class="flex items-center gap-2.5">
                    ${u}
                    <p class="font-bold text-sm text-gray-900 truncate ${m?"line-through text-gray-400":""}">${y(c.description)}</p>
                    ${c.documentNumber?`<span class="text-[9px] font-bold bg-gray-100 text-gray-600 px-2 py-1 rounded-lg border border-gray-200 shadow-sm leading-none flex-shrink-0">NF: ${y(c.documentNumber)}</span>`:""}
                </div>
                <p class="text-xs text-gray-500 font-semibold truncate mt-1.5 pl-7"><i class="bi bi-person opacity-60 mr-1.5"></i>${y(c.entity||"Sem Entidade associada")}</p>
            </div>

            <div class="hidden md:flex md:col-span-2 flex-col justify-center min-w-0 pr-4 gap-1.5">
                <span class="text-[10px] font-bold text-gray-700 bg-gray-100 px-2.5 py-1 rounded-lg border border-gray-200 w-max max-w-full truncate shadow-sm"><i class="bi bi-tag opacity-50 mr-1.5"></i>${v}</span>
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar bg-gray-50 pb-safe md:pb-4">
                ${i.map(d=>{const u=d.id===e.id,c=d.status==="paid",p=Ci(d.dueDate);return`
                    <label class="flex items-center gap-4 p-4 bg-white rounded-2xl border ${u?"border-red-400 ring-2 ring-red-100 shadow-md bg-red-50/20":"border-gray-200 shadow-sm"} cursor-pointer transition-all hover:bg-gray-50 active:scale-[0.98]">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-bold text-gray-900 truncate">${y(d.description)}</p>
    ...
    `,t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function po(t,e=null){const a=document.getElementById("genericModal"),s=t==="payable",i=s?"red":"emerald",o=e?"Editar Lançamento":"Novo Lançamento",r=(k,H)=>{let z='<option value="">-- Categoria --</option>';const D=js(k),j=(R,B=0)=>{const G="  ".repeat(B)+(B>0?"↳ ":""),Y=R.id===H?"selected":"";z+=`<option value="${R.id}" ${Y}>${G}${y(R.name)}</option>`,R.children.forEach(Q=>j(Q,B+1))};return D.forEach(R=>j(R)),z},l=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(k=>`<option value="${k.value}" ${e?.paymentMethod===k.value?"selected":""}>${k.label}</option>`).join(""),d=`
        <datalist id="entity-suggestions">
            ${s?E.suppliers.map(k=>`<option value="${y(k.name)}">Fornecedor</option>`).join("")+E.professionals.map(k=>`<option value="${y(k.name)}">Profissional</option>`).join(""):E.clients.map(k=>`<option value="${y(k.name)} ${k.phone?"- "+y(k.phone):""}">Cliente</option>`).join("")}
        </datalist>
    `,u=e?.establishmentId||g.selectedEstablishments&&g.selectedEstablishments[0]||g.establishmentId,c=E.establishments.map(k=>{const H=k.id===u;return`<option value="${k.id}" ${H?"selected":""}>${k.type==="Matriz"?"🏢":"📍"} ${y(k.name)}</option>`}).join("");a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 md:p-6",a.innerHTML=`
        ${d}
                    ...
                    <div class="bg-white p-4 md:p-6 md:rounded-3xl border-b md:border border-gray-200 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="description" required 
                                ...
                                value="${e?.description?y(e.description):""}" placeholder="Ex: Fornecedor de Bebidas...">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="entity" list="entity-suggestions" 
                                    ...
                                    value="${e?.entity?y(e.entity):""}" placeholder="Nome da pessoa ou empresa..." autocomplete="off">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 md:col-span-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="documentNumber" 
                                    ...
                                    value="${e?.documentNumber?y(e.documentNumber):""}" placeholder="Opcional">
                            </div>
                            <div>
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const k=a.querySelector("#modal-content-wrapper");k&&(k.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),k.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let m="single",b=2;const x=p.querySelector("#modal-delete-btn");x&&x.addEventListener("click",k=>{k.preventDefault(),navigator.vibrate&&navigator.vibrate(30),Nt(),setTimeout(()=>Bi(t,e),300)});const v=p.querySelector('[name="amount"]'),I=p.querySelector("#recurrence-options"),S=p.querySelector("#recurrence-summary"),C=p.querySelector("#installments-input"),V=p.querySelector("#status-toggle"),M=p.querySelector("#payment-date-wrapper"),q=p.querySelector('[name="paymentDate"]'),L=()=>{if(m==="single")return;const k=parseFloat(v.value)||0;if(b=parseInt(C.value)||2,k===0){S.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(m==="installment"){const H=k/b;S.innerHTML=`
                <div>
                    ...
                    <span class="font-black text-sm md:text-base text-indigo-700 block leading-tight">${b}x de ${we(H)}</span>
            ...
            `}else if(m==="repeat"){const H=k*b;S.innerHTML=`
                <div>
                    ...
                    <span class="text-[9px] md:text-[10px] text-indigo-500 font-bold mt-1 block bg-indigo-50/50 p-1 rounded">Comprometimento: ${we(H)}</span>
                </div>
            `}};p.addEventListener("click",k=>{const H=k.target.closest(".mode-btn");if(H&&!e)if(k.preventDefault(),navigator.vibrate&&navigator.vibrate(15),p.querySelectorAll(".mode-btn").forEach(j=>{j.classList.remove("bg-white","text-gray-900","shadow-sm"),j.classList.add("text-gray-500")}),H.classList.add("bg-white","text-gray-900","shadow-sm"),H.classList.remove("text-gray-500"),m=H.dataset.mode,m==="single")I.style.display="none";else{I.style.display="block";const j=I.querySelector("#recurrence-label");j&&(j.textContent=m==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),L()}if(k.target.closest("#btn-minus")&&C){k.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let j=parseInt(C.value)||2;j>2&&(C.value=j-1,L())}if(k.target.closest("#btn-plus")&&C){k.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let j=parseInt(C.value)||2;j<60&&(C.value=j+1,L())}}),v.addEventListener("input",L),C&&C.addEventListener("input",L),V.addEventListener("change",()=>{navigator.vibrate&&navigator.vibrate(20),V.checked?(M.classList.remove("hidden"),q.required=!0):(M.classList.add("hidden"),q.required=!1)}),p.addEventListener("submit",async k=>{k.preventDefault();const H=p.querySelector('button[type="submit"]'),z=H.innerHTML;H.disabled=!0,H.innerHTML='<div class="loader mx-auto h-5 w-5 border-2 border-white border-t-transparent"></div>';const D=new FormData(p),j=V.checked,R=parseFloat(D.get("amount"));let B=R,G=1;!e&&m!=="single"&&(G=parseInt(D.get("installments")),m==="repeat"&&(B=R*G));const Y=D.get("establishmentId");if(!Y){f("Atenção","Selecione uma Unidade válida para o lançamento.","warning"),H.disabled=!1,H.innerHTML=z;return}const Q={companyId:g.companyId,establishmentId:Y,description:D.get("description"),amount:B,dueDate:D.get("dueDate"),naturezaId:D.get("naturezaId")||null,centroDeCustoId:D.get("centroDeCustoId")||null,entity:D.get("entity")||null,paymentMethod:D.get("paymentMethod")||null,documentNumber:D.get("documentNumber")||null,notes:D.get("notes"),status:j?"paid":"pending",paymentDate:j?D.get("paymentDate"):null,installments:G};G>1&&!e&&(Q.recurrenceId=self.crypto.randomUUID());try{e?(await(s?Wr(e.id,Q):Yr(e.id,Q)),f("Sucesso","Atualizado com sucesso!","success")):(await(s?Wo(Q):Qr(Q)),f("Sucesso","Lançamento criado!","success")),Nt(),Be()}catch(T){f("Erro",T.message||"Erro ao salvar","error"),H.disabled=!1,H.innerHTML=z}})}const dc=t=>A("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),cc=t=>A("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),uc=(t,e)=>{const a=new URLSearchParams({startDate:t,endDate:e}).toString();return A(`/api/commissions/stats?${a}`)},pc=(t={})=>{Object.keys(t).forEach(s=>(t[s]===void 0||t[s]===null||t[s]==="")&&delete t[s]);const e=new URLSearchParams(t).toString(),a=`/api/commissions/history${e?"?"+e:""}`;return A(a)},ji=t=>A(`/api/commissions/report/${t}`,{method:"DELETE"}),Ea=new Date,bc=new Date(Ea.getFullYear(),Ea.getMonth(),1);let O={professionals:[],reports:[],calculationResult:null,periodString:"",establishmentConfig:null,selectedIds:new Set,isAdvancedFilterOpen:!1,startDate:bc.toISOString().split("T")[0],endDate:new Date(Ea.getFullYear(),Ea.getMonth()+1,0).toISOString().split("T")[0],professionalId:"all",searchQuery:"",stats:{revenue:0,commissions:0,margin:0,netPaid:0},viewMode:"list"},ia=null;const mc=document.getElementById("content");function Tt(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function gc(t){return t?new Date(t).toLocaleDateString("pt-BR"):"--/--/----"}function $a(t){if(!t)return"PR";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()}function qi(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="none"),e&&(e.classList.remove("hidden"),e.className="fixed inset-0 z-[99999] bg-slate-900/40 backdrop-blur-sm flex flex-col items-center justify-end md:justify-center w-full h-[100dvh] overflow-hidden"),a&&window.innerWidth<768&&(a.style.display="none")}function qs(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="flex"),e&&(e.classList.add("hidden"),e.className="hidden"),a&&window.innerWidth<768&&(a.style.display=""),O.viewMode="list",O.calculationResult=null}async function fc(){try{const[t,e]=await Promise.all([Pe(g.establishmentId),Me(g.establishmentId).catch(()=>({}))]);O.professionals=t,O.establishmentConfig=e||{}}catch(t){console.error("Erro na inicialização de comissões",t)}O.viewMode="list",xc(),vc(),await gt()}function xc(){const t=O.professionals.map(e=>`<option value="${e.id}">${e.name}</option>`).join("");mc.innerHTML=`
        <style>
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar w-full relative z-0 pb-[100px] md:pb-6" id="scrollable-content">
                ...
                <div class="px-4 py-3 flex flex-col gap-4 max-w-7xl mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div class="relative w-full md:w-80">
                            <i class="bi bi-search absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg"></i>
                            <input type="text" id="search-input" value="${O.searchQuery}" placeholder="Buscar relatórios..." class="w-full pl-11 pr-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl text-sm font-medium focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all">
                        </div>
                    </div>
                    ...
                    <div id="filter-panel" class="hidden animate-fade-in-down">
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-4">
                            <div class="grid grid-cols-2 gap-4 flex-1">
                                <div>
                                    <label class="block text-xs font-bold text-gray-500 mb-1.5 ml-1">Data Inicial</label>
                                    <input type="date" id="filter-start" value="${O.startDate}" class="w-full py-2.5 px-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold text-gray-800 focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-500 mb-1.5 ml-1">Data Final</label>
                                    <input type="date" id="filter-end" value="${O.endDate}" class="w-full py-2.5 px-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold text-gray-800 focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                                </div>
                            </div>
                            <div class="flex-1">
    ...
    `}async function gt(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">Carregando comissões...</p></div>');const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(",");try{const[s,i]=await Promise.all([pc({startDate:O.startDate,endDate:O.endDate,professionalId:O.professionalId,establishmentId:a}),uc(O.startDate,O.endDate,a)]);O.reports=s||[];const o=O.reports.reduce((r,n)=>r+(n.summary.finalValue||n.summary.totalCommission),0);O.stats={revenue:i.totalRevenue||0,commissions:i.totalCommissionsPaid||0,margin:i.totalRevenue>0?((i.totalRevenue-i.totalCommissionsPaid)/i.totalRevenue*100).toFixed(1):0,netPaid:o},O.selectedIds.clear(),At(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),hc(),Fi()}catch(s){console.error(s),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${Tt(O.stats.revenue)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-amber-600">${Tt(O.stats.commissions)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-blue-600">${O.stats.margin}%</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-emerald-600">${Tt(O.stats.netPaid)}</span>
        </div>
    `)}function Fi(){const t=document.getElementById("list-container");if(!t)return;let e=O.reports;if(O.searchQuery){const a=O.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `}).join("")}function vc(){ia&&document.body.removeEventListener("click",ia),ia=o=>{const r=o.target;if(r.classList.contains("item-checkbox")){const l=r.value;r.checked?O.selectedIds.add(l):O.selectedIds.delete(l),At(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){o.preventDefault();const l=n.dataset.action,d=n.dataset.id;switch(l){case"apply-filters":O.startDate=document.getElementById("filter-start").value,O.endDate=document.getElementById("filter-end").value,O.professionalId=document.getElementById("filter-prof").value,document.getElementById("custom-date-btn")?.click(),gt();break;case"new-calculation":wc();break;case"whatsapp-receipt":Cc(d);break;case"print-receipt":Pc(d);break;case"delete-report":Ac(d);break;case"view-report-details":Lc(d);break;case"close-detail-screen":qs();break;case"set-calc-preset":yc(n);break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),c=Array.from(u).every(x=>x.checked);u.forEach(x=>x.checked=!c),document.querySelectorAll(".prof-toggle-ui").forEach(x=>{c?(x.classList.replace("bg-indigo-500","bg-slate-100"),x.classList.replace("border-indigo-500","border-slate-300"),x.querySelector(".toggle-dot").classList.replace("translate-x-4","translate-x-0")):(x.classList.replace("bg-slate-100","bg-indigo-500"),x.classList.replace("border-slate-300","border-indigo-500"),x.querySelector(".toggle-dot").classList.replace("translate-x-0","translate-x-4"))});break;case"calculate-preview":kc();break;case"save-final-reports":$c();break;case"toggle-preview-details":const p=n.dataset.idx,m=document.getElementById(`preview-details-${p}`),b=n.querySelector("i.chevron-icon");m&&(m.classList.contains("hidden")?(m.classList.remove("hidden"),b&&b.classList.replace("bi-chevron-down","bi-chevron-up")):(m.classList.add("hidden"),b&&b.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",ia),document.body.addEventListener("change",o=>{if(o.target.classList.contains("custom-toggle-input")){const r=o.target.closest("label"),n=r.querySelector(".toggle-bg"),l=r.querySelector(".toggle-dot"),d=r.querySelector(".toggle-text");o.target.checked?(n.classList.replace("bg-slate-200","bg-indigo-500"),l.classList.replace("translate-x-1","translate-x-6"),d&&d.classList.replace("text-slate-500","text-indigo-700")):(n.classList.replace("bg-indigo-500","bg-slate-200"),l.classList.replace("translate-x-6","translate-x-1"),d&&d.classList.replace("text-indigo-700","text-slate-500"))}if(o.target.classList.contains("prof-checkbox")){const r=o.target.closest("label"),n=r.querySelector(".prof-toggle-ui"),l=r.querySelector(".toggle-dot");o.target.checked?(n.classList.replace("bg-slate-100","bg-indigo-500"),n.classList.replace("border-slate-300","border-indigo-500"),l.classList.replace("translate-x-0","translate-x-4")):(n.classList.replace("bg-indigo-500","bg-slate-100"),n.classList.replace("border-indigo-500","border-slate-300"),l.classList.replace("translate-x-4","translate-x-0"))}});const t=document.getElementById("search-input");t&&t.addEventListener("input",o=>{O.searchQuery=o.target.value,Fi()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&Sc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");O.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&O.selectedIds.add(l.value)}),At()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{O.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),At()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",Tc);const i=document.getElementById("export-excel-btn");i&&i.addEventListener("click",Dc),document.getElementById("custom-date-btn")?.addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");O.isAdvancedFilterOpen=!O.isAdvancedFilterOpen,O.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filter-start").value=d.toISOString().split("T")[0],document.getElementById("filter-end").value=u.toISOString().split("T")[0],O.startDate=d.toISOString().split("T")[0],O.endDate=u.toISOString().split("T")[0],gt()})})}function yc(t){const e=t.dataset.preset,a=new Date;let s,i;e==="month"?(s=new Date(a.getFullYear(),a.getMonth(),1),i=new Date(a.getFullYear(),a.getMonth()+1,0)):e==="last_month"?(s=new Date(a.getFullYear(),a.getMonth()-1,1),i=new Date(a.getFullYear(),a.getMonth(),0)):e==="today"&&(s=new Date,i=new Date),s&&i&&(document.getElementById("calc-start-date").value=s.toISOString().split("T")[0],document.getElementById("calc-end-date").value=i.toISOString().split("T")[0]),document.querySelectorAll('button[data-action="set-calc-preset"]').forEach(o=>{o.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),o.classList.add("bg-white","text-gray-500","border-gray-200")}),t.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),t.classList.remove("bg-white","text-gray-500","border-gray-200")}function At(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=O.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function wc(){O.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=O.professionals.map(i=>`
    ...
    `,qi()}async function kc(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(u=>u.value);if(t.length===0)return f("Atenção","Selecione pelo menos um profissional na lista.","warning");const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(","),s=document.getElementById("calc-start-date"),i=document.getElementById("calc-end-date");if(!s||!i||!s.value||!i.value)return f("Atenção","As datas de início e fim são obrigatórias.","warning");const o={professionalIds:t,startDate:s.value,endDate:i.value,establishmentId:a,calculationTypes:{services:document.getElementById("calc-type-services")?.checked||!1,products:document.getElementById("calc-type-products")?.checked||!1,packages:document.getElementById("calc-type-packages")?.checked||!1}},r=new Date(o.startDate+"T00:00:00").toLocaleDateString("pt-BR"),n=new Date(o.endDate+"T00:00:00").toLocaleDateString("pt-BR");O.periodString=`${r} a ${n}`;const l=document.getElementById("btn-calc-action"),d=l.innerHTML;l.innerHTML='<div class="loader-small border-white mr-2"></div> Processando...',l.disabled=!0;try{const u=await dc(o);O.calculationResult=u.map(c=>({...c,extraDebit:0,extraCredit:0,finalValue:c.summary.totalCommission,notes:""})),Ic()}catch(u){f("Erro na Apuração",u.message,"error"),l.innerHTML=d,l.disabled=!1}}function Ic(){O.viewMode="preview-calc";const t=O.calculationResult;if(!t||t.length===0||t.every(n=>n.summary.totalCommission===0)){f("Aviso","Nenhuma comissão encontrada para os filtros selecionados.","info");const n=document.getElementById("btn-calc-action");n.innerHTML='<i class="bi bi-calculator text-lg"></i> Calcular Vendas',n.disabled=!1;return}const e=document.getElementById("calc-header-title");e&&(e.innerText="Revisão e Pagamento (2/2)");const a=document.getElementById("calc-step-1"),s=document.getElementById("calc-step-2"),i=document.getElementById("btn-calc-action");a&&a.classList.add("hidden"),s&&s.classList.remove("hidden"),i&&(i.dataset.action="save-final-reports",i.className="w-full md:w-auto py-3 px-8 bg-emerald-600 text-white font-black text-sm rounded-xl hover:bg-emerald-700 shadow-md transition-transform active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider",i.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',i.disabled=!1);const o=t.reduce((n,l)=>n+l.finalValue,0),r=t.map((n,l)=>{if(n.summary.totalCommission===0)return"";const d=n.establishmentName||"Unidade Atual",u=(n.items||[]).map(p=>`
        ...
        <div class="bg-gradient-to-r from-indigo-700 to-indigo-800 p-5 rounded-2xl shadow-lg text-white mb-6 flex flex-col md:flex-row justify-between items-start md:items-center relative overflow-hidden border border-indigo-600 gap-4 sticky top-0 z-10">
            ...
            <div class="text-left md:text-right z-10 flex flex-col items-start md:items-end w-full md:w-auto">
                ...
                <span class="text-xs font-black bg-white/20 px-3 py-2 rounded-xl border border-white/30 shadow-sm flex items-center gap-2"><i class="bi bi-calendar3"></i> ${O.periodString}</span>
            </div>
        </div>
        ${r}
    `)}function Sc(t){const e=document.querySelector(`.input-debit[data-idx="${t}"]`),a=document.querySelector(`.input-credit[data-idx="${t}"]`),s=document.querySelector(`.input-notes[data-idx="${t}"]`);let i=parseFloat(e?.value)||0,o=parseFloat(a?.value)||0,r=s?.value||"";if(O.calculationResult&&O.calculationResult[t]){const n=O.calculationResult[t];n.extraDebit=i,n.extraCredit=o,n.notes=r,n.finalValue=n.summary.totalCommission-i+o;const l=document.querySelector(`.final-value-display[data-idx="${t}"]`);l&&(l.innerText=`R$ ${n.finalValue.toFixed(2)}`),Ec()}}function Ec(){const t=O.calculationResult.reduce((a,s)=>a+s.finalValue,0),e=document.getElementById("grand-total-preview");e&&(e.innerText=`R$ ${t.toFixed(2)}`)}async function $c(){const t=O.calculationResult.filter(i=>i.summary.totalCommission>0),e=t.length;if(e===0)return f("Aviso","Não há valores para pagar.","info");if(!await K("Confirmar Pagamentos",`Você está prestes a gerar recibos e marcar as vendas de ${e} profissional(is) como PAGAS. Essa ação lançará a despesa correspondente no Financeiro da respectiva unidade. Confirmar?`))return;const s=document.getElementById("btn-calc-action");s.innerHTML='<div class="loader-small border-white mr-2"></div> Finalizando...',s.disabled=!0;try{const i=t.map(async o=>{const r=(o.items||[]).map(l=>l.originalSaleId).filter(l=>l!=null),n=o.establishmentId||g.establishmentId;await cc({professionalId:o.professionalId,professionalName:o.professionalName,period:O.periodString,processedSalesIds:r,establishmentId:n,establishmentName:o.establishmentName||"",reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}});try{if(o.finalValue>0){const l=O.establishmentConfig||{},d=l.defaultDespesaNaturezaId||l.financeConfig?.despesaNaturezaId||null,u=l.defaultDespesaCentroCustoId||l.financeConfig?.despesaCentroCustoId||null;await Wo({establishmentId:n,description:`Comissões - ${o.period}`,amount:o.finalValue,dueDate:new Date().toISOString().split("T")[0],naturezaId:d,centroDeCustoId:u,entity:o.professionalName,paymentMethod:"dinheiro",status:"paid",paymentDate:new Date().toISOString().split("T")[0],origin:"commission"})}}catch(l){console.error("Erro ao integrar com financeiro (Despesa):",l)}});await Promise.all(i),f("Sucesso","Pagamentos registrados e integrados ao financeiro!","success"),O.calculationResult=null,qs(),await gt()}catch(i){f("Erro ao Salvar",i.message,"error"),s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1}}function Lc(t){O.viewMode="report-details";const e=document.getElementById("commissions-layout-detail");if(!e)return;const a=O.reports.find(c=>c.id===t);if(!a)return;const s=a.reportData?.items||a.items||[],i=a.summary,o=i.extraDebit||0,r=i.extraCredit||0,n=i.notes||"",l=a.establishmentName||"Unidade Atual",d=s.map(c=>`
        <tr class="border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors">
    ...
    `,qi()}function Cc(t){const e=O.reports.find(l=>l.id===t);if(!e)return;const a=e.summary||{},s=e.establishmentName||"Unidade Principal";let i=`*RECIBO DE COMISSÕES* 💰
...
`,i+="_Este é um recibo gerado automaticamente pelo sistema._";const n=`https://wa.me/?text=${encodeURIComponent(i)}`;window.open(n,"_blank")}function Dc(){if(O.reports.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}let t=O.reports;if(O.searchQuery){const a=O.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}const e=t.map(a=>{const s=a.summary.totalCommission,i=a.summary.extraDebit||0,o=a.summary.extraCredit||0,r=a.summary.finalValue||s;return{"Data da Apuração":new Date(a.createdAt).toLocaleDateString("pt-BR"),Unidade:a.establishmentName||"Unidade Principal",Profissional:a.professionalName,"Período Base":a.period,"Itens Calculados":a.summary.totalItems||0,"Valor Bruto (R$)":s,"Bônus (R$)":o,"Descontos (R$)":i,"Líquido Pago (R$)":r,"Observações/Motivo":a.summary.notes||""}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const a=XLSX.utils.json_to_sheet(e),s=XLSX.utils.book_new();XLSX.utils.book_append_sheet(s,a,"Comissoes");const i=`Relatorio_Comissoes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(s,i)}catch(a){console.error(a),f("Erro","Falha ao exportar Excel.","error")}}function Pc(t){const e=O.reports.find(u=>u.id===t);if(!e)return;if(!window.jspdf){f("Erro","A biblioteca de PDF não foi carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a;s.setFillColor(79,70,229),s.rect(0,0,210,40,"F"),s.setTextColor(255,255,255),s.setFontSize(22),s.setFont(void 0,"bold"),s.text("RECIBO DE COMISSÕES",105,20,{align:"center"}),s.setFontSize(10),s.text(`Data de Emissão: ${new Date().toLocaleDateString("pt-BR")} - Unidade: ${e.establishmentName||"Principal"}`,105,28,{align:"center"}),s.setTextColor(50,50,50),s.setFontSize(11),s.setFont(void 0,"normal"),s.text("Profissional:",15,55),s.setFont(void 0,"bold"),s.text(e.professionalName,40,55),s.setFont(void 0,"normal"),s.text("Período:",130,55),s.setFont(void 0,"bold"),s.text(e.period,147,55);const i=e.reportData?.items||e.items||[];let o=70;if(i.length>0){const u=i.map(c=>[c.item||"Item",c.client||"--",`R$ ${(c.value||0).toFixed(2)}`,`${c.commissionRate||0}%`,`R$ ${(c.commissionValue||0).toFixed(2)}`]);s.autoTable({startY:o,head:[["Serviço/Produto","Cliente","Valor Base","Taxa","Comissão"]],body:u,theme:"striped",headStyles:{fillColor:[249,250,251],textColor:[75,85,99],fontStyle:"bold"},styles:{fontSize:8},columnStyles:{2:{halign:"right"},3:{halign:"center"},4:{halign:"right",fontStyle:"bold",textColor:[5,150,105]}}}),o=s.lastAutoTable.finalY+15}const r=e.summary,n=r.finalValue||r.totalCommission,l=[["Comissões Brutas (Soma dos Itens)",`R$ ${r.totalCommission.toFixed(2)}`]];r.extraCredit>0&&l.push(["(+) Bônus Extras",`R$ ${r.extraCredit.toFixed(2)}`]),r.extraDebit>0&&l.push(["(-) Descontos / Vales",`R$ ${r.extraDebit.toFixed(2)}`]),s.autoTable({startY:o,head:[["Resumo do Fechamento","Valor"]],body:l,theme:"grid",headStyles:{fillColor:[79,70,229],textColor:[255,255,255]},columnStyles:{1:{halign:"right",fontStyle:"bold"}}});const d=s.lastAutoTable.finalY+15;s.setFillColor(236,253,245),s.rect(120,d-8,75,15,"F"),s.setTextColor(5,150,105),s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${n.toFixed(2)}`,190,d,{align:"right"}),r.notes&&(s.setTextColor(100,100,100),s.setFontSize(9),s.setFont(void 0,"normal"),s.text(`Obs/Motivo: ${r.notes}`,15,d+10)),s.setTextColor(150,150,150),s.setFontSize(9),s.line(20,d+40,90,d+40),s.text("Assinatura da Empresa",55,d+45,{align:"center"}),s.line(120,d+40,190,d+40),s.text("Assinatura do Profissional",155,d+45,{align:"center"}),s.save(`Recibo_Comissoes_${e.professionalName.replace(/\s+/g,"_")}.pdf`)}async function Tc(){const t=O.selectedIds.size;if(!(t===0||!await K("Excluir Recibos",`Deseja excluir e estornar ${t} recibo(s)? As vendas associadas voltarão ao status "A Apurar".`)))try{const a=Array.from(O.selectedIds).map(s=>ji(s));await Promise.all(a),f("Sucesso",`${t} recibos excluídos com sucesso.`,"success"),O.selectedIds.clear(),At(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),await gt()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns recibos.","error")}}async function Ac(t){if(await K("Excluir Recibo",'ATENÇÃO: Deseja realmente excluir este recibo? As vendas associadas a ele voltarão ao status "A Apurar" e o valor será subtraído dos relatórios. Esta ação não pode ser desfeita.'))try{await ji(t),f("Sucesso","Recibo cancelado com sucesso. Vendas estornadas para apuração.","success"),qs(),await gt()}catch(a){f("Erro ao Excluir",a.message,"error")}}const He=document.getElementById("content");let F={allPackages:[],catalogForModal:{services:[],products:[]},establishments:[],searchQuery:"",statusFilter:"all",viewMode:"list",tempPackage:null,selectedIds:new Set},et=null;function ft(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Bc(){const t=F.allPackages.length,e=F.allPackages.filter(o=>o.status!=="inactive"),a=e.length,s=a>0?e.reduce((o,r)=>o+(r.price||0),0)/a:0;let i=0;return e.forEach(o=>{const r=o.originalPrice||0,n=o.price||0;if(r>0&&r>n){const l=(r-n)/r*100;l>i&&(i=l)}}),{total:t,activeCount:a,avgPrice:s,maxDiscount:i}}function Mc(){const t=document.getElementById("packages-layout-detail");t&&(t.classList.remove("hidden"),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))}))}function ma(){const t=document.getElementById("packages-layout-detail");if(t){t.classList.add("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-0","md:scale-100","md:opacity-100"),e.classList.add("translate-y-full","md:scale-95","md:opacity-0")),setTimeout(()=>{t.classList.add("hidden"),t.style.display="none",t.innerHTML=""},300)}}function jc(){const t=document.getElementById("packages-layout-detail");if(!t||F.viewMode!=="edit-package"||!F.tempPackage)return;F.tempPackage.name=t.querySelector("#packageName")?.value||"",F.tempPackage.description=t.querySelector("#packageDescription")?.value||"",F.tempPackage.status=t.querySelector("#packageStatus")?.value||"active";const e=parseFloat(t.querySelector("#finalPrice")?.value);F.tempPackage.price=isNaN(e)?"":e;const a=parseFloat(t.querySelector("#commissionRate")?.value);F.tempPackage.commissionRate=isNaN(a)?"":a;const s=parseInt(t.querySelector("#validityDays")?.value,10);F.tempPackage.validityDays=isNaN(s)?"":s,F.tempPackage.sellStartDate=t.querySelector("#sellStartDate")?.value||"",F.tempPackage.sellEndDate=t.querySelector("#sellEndDate")?.value||"";const i=parseInt(t.querySelector("#salesLimit")?.value,10);F.tempPackage.salesLimit=isNaN(i)?"":i;const o=Array.from(t.querySelectorAll(".modal-est-checkbox:checked")).map(r=>r.value);F.tempPackage.establishmentIds=o}async function qc(){try{const e=(await De().catch(()=>({matrizes:[]}))).matrizes||[];F.establishments=[],e.forEach(a=>{F.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>F.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}F.viewMode="list",F.selectedIds.clear(),Fc(),Oc(),await La()}async function La(){const t=document.getElementById("packagesListContainer");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-20"><div class="loader mx-auto"></div></div>');const e=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId];try{const a=e.map(c=>Cs(c).catch(()=>[])),s=await Promise.all(a),i=new Map;s.flat().forEach(c=>{i.has(c.id)||i.set(c.id,c)}),F.allPackages=Array.from(i.values());const o=e.map(c=>Ge(c).catch(()=>[])),r=e.map(c=>Rt(c).catch(()=>[])),[n,l]=await Promise.all([Promise.all(o),Promise.all(r)]),d=new Map;n.flat().forEach(c=>d.set(c.id,c));const u=new Map;l.flat().forEach(c=>u.set(c.id,c)),F.catalogForModal={services:Array.from(d.values()).filter(c=>c.active),products:Array.from(u.values())},Nc(),ot(),It()}catch(a){console.error(a),t&&(t.innerHTML=`
            ...
            `)}}function It(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=F.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")));const s=document.getElementById("select-all-toggle");s&&(s.checked=F.allPackages.length>0&&a===F.allPackages.length)}function Fc(){He.innerHTML=`
    ...
    `)}function ot(){const t=document.getElementById("packagesListContainer");if(!t)return;let e=F.allPackages;if(F.statusFilter!=="all"){const s=F.statusFilter==="active";e=e.filter(i=>i.status!=="inactive"===s)}if(F.searchQuery){const s=F.searchQuery.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(e.length===0){t.innerHTML=`
        ...
        `;return}const a=new Map(F.establishments.map(s=>[s.id,s]));t.innerHTML=e.map(s=>{const i=s.status!=="inactive",o=F.selectedIds.has(s.id),r=s.price||0,n=s.originalPrice||0,l=n>0&&n>r?(n-r)/n*100:0,d=y(s.name),u=y(s.description||"Nenhuma descrição detalhada."),c=(s.items||[]).reduce((v,I)=>v+(I.quantity||1),0),p=s.validityDays?`${s.validityDays} dias de uso`:"Uso vitalício",m=s.sellEndDate?`Vendas até ${new Date(s.sellEndDate).toLocaleDateString("pt-BR")}`:"Venda contínua",b=s.establishmentIds||(s.establishmentId?[s.establishmentId]:[]);let x="";if(b.length===1){const v=a.get(b[0]);v&&(x=`<span class="text-[9px] px-2 py-1 rounded-md bg-slate-100 text-slate-600 font-bold border border-slate-200 flex items-center w-max shadow-sm"><i class="bi ${v.type==="Matriz"?"bi-building":"bi-shop"} mr-1 opacity-50"></i> ${v.name}</span>`)}else b.length>1&&(x=`<span class="text-[9px] px-2 py-1 rounded-md bg-indigo-50 text-indigo-600 font-bold border border-indigo-100 flex items-center w-max shadow-sm"><i class="bi bi-buildings mr-1 opacity-50"></i> ${b.length} Unidades</span>`);return`
        ...
        `}).join("")}function Rc(){if(F.allPackages.length===0){f("Aviso","Não há pacotes carregados para exportar.","info");return}let t=F.allPackages;if(F.statusFilter!=="all"){const s=F.statusFilter==="active";t=t.filter(i=>i.status!=="inactive"===s)}if(F.searchQuery){const s=F.searchQuery.toLowerCase();t=t.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(t.length===0){f("Aviso","Nenhum pacote corresponde aos filtros atuais.","info");return}const e=new Map(F.establishments.map(s=>[s.id,s.name])),a=t.map(s=>{const i=s.originalPrice||0,o=s.price||0,r=i>0?(i-o)/i*100:0,n=(s.items||[]).map(u=>`${u.quantity}x ${u.name}`).join(" | ");return{"Unidade(s)":(s.establishmentIds||(s.establishmentId?[s.establishmentId]:[])).map(u=>e.get(u)).filter(Boolean).join(", ")||"Não identificada","Nome do Pacote":s.name,Status:s.status!=="inactive"?"Ativo":"Inativo",Descrição:s.description||"","Itens Incluídos":n,"Valor Original (R$)":i,"Preço de Venda (R$)":o,"Desconto (%)":r.toFixed(1)+"%","Comissão (%)":s.commissionRate||0,"Validade de Uso (Dias)":s.validityDays||"Vitalício","Vendas Início":s.sellStartDate?new Date(s.sellStartDate).toLocaleDateString("pt-BR"):"-","Vendas Fim":s.sellEndDate?new Date(s.sellEndDate).toLocaleDateString("pt-BR"):"-"}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const s=XLSX.utils.json_to_sheet(a),i=XLSX.utils.book_new();XLSX.utils.book_append_sheet(i,s,"Pacotes");const o=`Relatorio_Pacotes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(i,o)}catch(s){console.error(s),f("Erro","Falha ao exportar Excel.","error")}}function bo(t=null){F.viewMode="edit-package",F.tempPackage=t?JSON.parse(JSON.stringify(t)):{id:"",name:"",description:"",status:"active",items:[],price:"",originalPrice:0,commissionRate:0,validityDays:"",sellStartDate:"",sellEndDate:"",salesLimit:"",establishmentIds:[g.establishmentId]},fs(),Mc()}function Ni(){const t=document.getElementById("packages-layout-detail");if(!t)return;const a=(F.tempPackage.items||[]).reduce((n,l)=>n+(l.price||0)*(l.quantity||1),0),s=t.querySelector("#finalPrice"),i=t.querySelector("#discountIndicator"),o=t.querySelector("#originalPrice"),r=parseFloat(s?.value)||0;if(o&&(o.textContent=ft(a)),i)if(a>0&&a>r&&r>0){const n=(a-r)/a*100;i.textContent=`${n.toFixed(0)}% OFF`,i.classList.remove("hidden")}else i.classList.add("hidden")}function gs(){const t=document.getElementById("package-items-list");if(!t)return;const e=F.tempPackage.items||[];e.length===0?t.innerHTML=`
            ...
            <div class="flex items-center justify-between bg-white p-3 rounded-2xl shadow-sm border border-slate-200 hover:border-indigo-300 transition-colors animate-fade-in-fast mb-2">
                <div class="flex items-center gap-4 min-w-0 flex-1">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="font-black text-slate-800 text-sm truncate leading-tight">${y(a.name)}</p>
                    </div>
                </div>
        ...
        `}).join(""),Ni()}function mo(t){return t?t.includes("T")?t.split("T")[0]:t:""}function fs(){const t=document.getElementById("packages-layout-detail");if(!t)return;const e=F.tempPackage,a=!!e.id,s=y(e.name||""),i=y(e.description||""),o=e.price!==void 0&&e.price!==""?e.price:"",r=e.commissionRate!==void 0&&e.commissionRate!==""?e.commissionRate:"",n=e.validityDays!==void 0&&e.validityDays!==""?e.validityDays:"",l=mo(e.sellStartDate),d=mo(e.sellEndDate),u=e.salesLimit!==void 0&&e.salesLimit!==""?e.salesLimit:"",c=e.establishmentIds&&e.establishmentIds.length>0?e.establishmentIds:e.establishmentId?[e.establishmentId]:[g.establishmentId],p=F.establishments.map(b=>`
    ...
    `,gs(),requestAnimationFrame(()=>{const b=t.querySelector("#modal-content-wrapper");b&&(b.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),b.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Hc(){F.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `;let a;const s=(o="")=>{const r=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600 text-lg"></i>',product:'<i class="bi bi-box-seam text-emerald-600 text-lg"></i>'},l={"catalog-service-list":{items:F.catalogForModal.services,type:"service"},"catalog-product-list":{items:F.catalogForModal.products,type:"product"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=t.querySelector("#"+d);if(!p)return;const m=u.filter(v=>v.name.toLowerCase().includes(r)).slice(0,50),b=c==="service"?"hover:border-indigo-400 hover:bg-indigo-50/80 hover:shadow-md":"hover:border-emerald-400 hover:bg-emerald-50/80 hover:shadow-md",x=c==="service"?"bg-indigo-100 border-indigo-200 shadow-sm":"bg-emerald-100 border-emerald-200 shadow-sm";p.innerHTML=m.map(v=>v.id?`
                <button data-action="select-catalog-item" data-item-type="${c}" data-item-id="${v.id}" class="flex items-center gap-4 w-full p-3 bg-white border border-slate-200 rounded-2xl ${b} shadow-sm transition-all duration-300 text-left group active:scale-95">
                    ...
                    <div class="flex-grow min-w-0">
                        <span class="block text-sm font-black text-slate-800 truncate group-hover:text-indigo-900 transition-colors">${y(v.name)}</span>
                        <span class="block font-black text-xs text-slate-500 mt-1">${ft(v.price)}</span>
                    </div>
            ...
            `:"").join("")||'<div class="flex flex-col items-center justify-center py-8 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50"><i class="bi bi-inbox text-3xl mb-2"></i><p class="text-[10px] font-bold uppercase tracking-widest">Nenhum resultado</p></div>'})};s();const i=t.querySelector("#item-search-input");i&&(i.addEventListener("input",o=>{clearTimeout(a),a=setTimeout(()=>s(o.target.value),300)}),setTimeout(()=>i.focus(),100)),requestAnimationFrame(()=>{const o=t.querySelector("#modal-content-wrapper");o&&(o.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),o.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Oc(){et&&(He.removeEventListener("click",et),He.removeEventListener("input",et),He.removeEventListener("change",et)),et=async e=>{if(e.target.classList.contains("item-checkbox")){const r=e.target.value;e.target.checked?F.selectedIds.add(r):F.selectedIds.delete(r),It(),ot(),e.stopPropagation();return}if(e.target.id==="packages-layout-detail"){ma(),F.viewMode="list",F.tempPackage=null;return}if(e.target.closest("#batch-delete-btn")){const r=F.selectedIds.size;if(r===0)return;if(await K("Excluir Pacotes",`Deseja realmente apagar ${r} pacotes selecionados?`))try{const l=Array.from(F.selectedIds).map(d=>Gs(d));await Promise.all(l),f("Sucesso",`${r} pacote(s) excluído(s).`,"success"),F.selectedIds.clear(),It(),await La()}catch{f("Erro","Ocorreu um erro ao excluir pacotes.","error")}return}if(e.target.closest("#cancel-selection-btn")){F.selectedIds.clear();const r=document.getElementById("select-all-toggle");r&&(r.checked=!1),It(),ot();return}const i=e.target.closest("[data-action]");if(!i)return;switch(i.dataset.action){case"new-package":navigator.vibrate&&navigator.vibrate(20),bo(null);break;case"edit-package":navigator.vibrate&&navigator.vibrate(15);const r=i.dataset.id,n=F.allPackages.find(I=>I.id===r);n&&bo(n);break;case"delete-package":e.stopPropagation(),e.preventDefault();const l=i.dataset.id;if(await K("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await Gs(l),f("Sucesso!","Pacote excluído.","success"),F.viewMode==="edit-package"&&F.tempPackage?.id===l&&(ma(),F.viewMode="list"),await La()}catch(I){f("Erro",`Não foi possível excluir: ${I.message}`,"error")}break;case"back-to-main":ma(),F.viewMode="list",F.tempPackage=null;break;case"add-item-to-package-btn":jc(),Hc();break;case"back-to-editor":fs();break;case"select-catalog-item":navigator.vibrate&&navigator.vibrate(10);const{itemType:u,itemId:c}=i.dataset,m=(F.catalogForModal[u+"s"]||[]).find(I=>I.id===c);if(m){const I=F.tempPackage.items.find(S=>S.id===m.id&&S.type===u);I?I.quantity++:F.tempPackage.items.push({...m,type:u,quantity:1}),fs()}break;case"remove-item":navigator.vibrate&&navigator.vibrate(10);const b=parseInt(i.dataset.index,10);F.tempPackage.items.splice(b,1),gs();break;case"toggle-all-ests":const x=document.querySelectorAll(".modal-est-checkbox"),v=Array.from(x).every(I=>I.checked);x.forEach(I=>I.checked=!v);break;case"save-package":await zc(i);break}},He.addEventListener("click",et),He.addEventListener("input",e=>{e.target.id==="search-packages"&&(F.searchQuery=e.target.value,ot()),e.target.id==="finalPrice"&&Ni()}),He.addEventListener("change",e=>{if(e.target.id==="select-all-toggle"){const a=e.target.checked;F.selectedIds.clear(),a&&F.allPackages.forEach(s=>F.selectedIds.add(s.id)),It(),ot()}if(e.target.id==="filter-status"&&(F.statusFilter=e.target.value,ot()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&F.tempPackage.items[a]&&(F.tempPackage.items[a].quantity=s,gs())}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Rc)}async function zc(t){const e=F.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const i=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(i.length===0){f("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const o=e.items.reduce((l,d)=>l+d.price*d.quantity,0),r={id:e.id||null,companyId:g.companyId,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:o,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:i,establishmentId:i[0]};if(!r.name||isNaN(r.price)){f("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(r.items.length===0){f("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await qn(r.id,r):(delete r.id,await jn(r)),f("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),ma(),F.viewMode="list",F.tempPackage=null,await La()}catch(l){f("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const _c=document.getElementById("content");async function Vc(){const t=ke.currentUser;if(!t)return;let e={};try{const l=await ys(qe(he,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(g.userProfessionalId)try{a=await Do(g.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=y(e.name||t.displayName||"Usuário"),i=y(t.email||"E-mail não disponível"),o=y(e.phone||"");let r=e.photo||"";a&&a.photo&&(r=a.photo);const n=r||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;_c.innerHTML=`
    ...
    `,Uc(t),Wc(a)}function Uc(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),i=document.getElementById("profile-avatar"),o=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async r=>{const n=r.target.files[0];if(n)try{const l=await Pa(n,800,800,.8);i.src=l,await jt(qe(he,"users",t.uid),{photo:l}),g.userProfessionalId&&await Ka(g.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),f("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{f("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),o.addEventListener("submit",async r=>{r.preventDefault();const n=o.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),u=document.getElementById("input-phone").value.trim();try{await jt(qe(he,"users",t.uid),{name:d,phone:u}),g.userProfessionalId&&await Ka(g.userProfessionalId,{name:d,phone:u}),g.userName=d,document.getElementById("display-name").textContent=d,f("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{f("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function Wc(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async i=>{i.preventDefault();const o=a.querySelector("#b-date-start").value,r=a.querySelector("#b-date-end").value||o,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!o||!n||!l)return f("Atenção","Preencha Data e Horários corretamente.","error");const u=new Date(`${o}T${n}:00`),c=new Date(`${r}T${l}:00`);if(c<=u)return f("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),m=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await Fa({establishmentId:g.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:u.toISOString(),endTime:c.toISOString()}),f("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const b=document.getElementById("my-blocks-filter").value;ga(t.id,b)}catch(b){f("Erro",`Falha ao bloquear: ${b.message}`,"error")}finally{p.disabled=!1,p.innerHTML=m}}),document.getElementById("my-blocks-filter").addEventListener("change",i=>ga(t.id,i.target.value)),ga(t.id,"future")}async function ga(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let i,o;e==="history"?(o=new Date,i=new Date,i.setFullYear(i.getFullYear()-1)):(i=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let n=(await qa(g.establishmentId,i.toISOString(),o.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `;return}a.innerHTML=n.map(l=>{const d=l.endTime<new Date,u=y(l.reason||"Bloqueio");return`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await Ss(u),f("Removido","O bloqueio foi deletado.","success"),ga(t,e)}catch(c){f("Erro",`Não foi possível remover: ${c.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${y(s.message)}</p>`}}let go=!1;async function Ca(t){if(!t)return;t.innerHTML=`
    ...
    `,tu()}function hs(){const t=document.getElementById("plansGrid");if(Ee.length===0){t.innerHTML=`
        ...
        `;return}const e={monthly:"mês",quarterly:"trimestre",semiannual:"semestre",yearly:"ano"};t.innerHTML=Ee.map(a=>{const s=a.active,i=e[a.billingCycle]||a.billingCycle,o=(a.servicesIncluded||[]).length,r=a.usageLimit?`${a.usageLimit} usos`:"Ilimitado";return`
            <div class="bg-white rounded-2xl border ${s?"border-slate-200 hover:border-indigo-300":"border-slate-200 opacity-75"} shadow-sm p-6 flex flex-col transition-colors relative">
                ...
                <h3 class="text-lg font-black text-slate-800 pr-16 leading-tight">${y(a.name)}</h3>
                <p class="text-xs text-slate-500 mt-1 line-clamp-2 flex-1">${y(a.description||"Sem descrição")}</p>
