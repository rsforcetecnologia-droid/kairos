const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-48vqLagP.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-kVXFFoHW.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as ge,d as me,m as Ls}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Tr,reauthenticateWithCredential as Pr,verifyBeforeUpdateEmail as Br,updatePassword as Ar,updateProfile as Mr,setPersistence as qr,browserLocalPersistence as jr,onAuthStateChanged as Nr,signOut as Rr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as Te,getDoc as ns,updateDoc as Ct,setDoc as Fr,addDoc as po,collection as ua,query as bo,where as go,getDocs as Hr,deleteDoc as Or,arrayUnion as zr,orderBy as _r,onSnapshot as Vr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Ur,onMessage as Wr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const g={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Qr(t,e,a){g.establishmentId=t,g.establishmentName=e,g.userPermissions=a,g.currentViewContext={type:"BRANCH",id:t,name:e}}const mo=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",Aa=mo?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${mo?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",Aa);async function Jr(){const t=ge.currentUser;return t?{"Content-Type":"application/json",Authorization:`Bearer ${await t.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function C(t,e={}){const a=await Jr();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=Aa.replace(/\/$/,""),o=t.startsWith("/")?t:`/${t}`,r=`${s}${o}`;console.log(`AuthenticatedFetch: ${e.method||"GET"} ${r}`);try{const i=await fetch(r,{...e,headers:{...a,...e.headers}});if(!i.ok){const l=(await i.json().catch(()=>({message:i.statusText}))).message||`Erro na API: ${i.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Aa}. Verifique se o servidor backend está rodando.`):i}}const ls=(t,e,a,s=null)=>{let o=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(o+=`&professionalId=${s}`),C(o)},Gr=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return C(s)},Xr=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const o=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return C(o)},Yr=t=>C("/api/appointments",{method:"POST",body:JSON.stringify(t)}),Zr=(t,e)=>C(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),Kr=t=>C(`/api/appointments/${t}`,{method:"DELETE"}),ei=t=>C(`/api/appointments/${t}/reopen`,{method:"POST"}),ti=(t,e)=>C(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)});let re;async function ai(){if(!re)try{re=new(window.AudioContext||window.webkitAudioContext)}catch(t){console.error("Não foi possível inicializar o áudio:",t)}}function si(){if(!re){console.warn("AudioContext não inicializado. O som não será tocado.");return}re.state==="suspended"&&re.resume();const t=re.createOscillator(),e=re.createGain();t.connect(e),e.connect(re.destination),t.type="sine",t.frequency.setValueAtTime(800,re.currentTime),e.gain.setValueAtTime(0,re.currentTime),e.gain.linearRampToValueAtTime(.3,re.currentTime+.01),e.gain.exponentialRampToValueAtTime(1e-4,re.currentTime+.2),t.start(re.currentTime),t.stop(re.currentTime+.2)}function m(t,e,a="info",s=!1){const o=document.getElementById("toast-container");if(!o)return;s&&si();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `;const l=o.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=o.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),o.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),o.style.display="flex",{modalElement:o,close:i,setContent:n}}function oi(){document.body.addEventListener("click",()=>{re||ai()},{once:!0}),document.addEventListener("click",t=>{const e=t.target.closest('[data-action="close-modal"]');if(e){const s=e.dataset.target;if(s){const o=document.getElementById(s);o&&(o.style.display="none")}}if(t.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}const se=document.getElementById("sidebar"),He=document.getElementById("sidebarToggle"),ht=document.getElementById("mainContent"),ri=document.querySelectorAll(".sidebar-link"),Ma=document.getElementById("menu-search"),Cs=document.getElementById("hamburger-menu-btn"),Ke=document.getElementById("mobile-overlay");let Ce=!0;function qe(t){if(!se||!ht)return;se.classList.toggle("collapsed",t),ht.classList.toggle("sidebar-collapsed-shift",t);const e=se.querySelector(".sidebar-search-container"),a=se.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const o=s.getAttribute("data-target-submenu"),r=document.getElementById(o),i=s.querySelector(".submenu-arrow");r&&(r.classList.add("hidden"),r.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function ii(){!se||!Ke||(se.classList.add("mobile-open"),Ke.classList.add("visible"))}function Bt(){!se||!Ke||(se.classList.remove("mobile-open"),Ke.classList.remove("visible"))}function ni(){qe(!se.classList.contains("collapsed"))}function li(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&se.classList.contains("collapsed")&&qe(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function di(){Ma&&Ma.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),o=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(r=>r.style.display=""),o.forEach(r=>r.style.display="block");return}o.forEach(r=>r.style.display="none"),s.forEach(r=>{if(r.classList.contains("sidebar-category"))return;const i=r.querySelector(".sidebar-link")||r.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(e)){r.style.display="";const d=r.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const c=d.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const c=document.getElementById(d);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?r.style.display="":r.style.display="none")}else r.style.display="none"}})})}function ci(t,e,a){if(!se||!ht)return;ht.classList.add("main-content-shift"),window.innerWidth>=1024?(Ce=!0,qe(!1)):window.innerWidth>=768?(Ce=!1,qe(!0)):(ht.classList.remove("main-content-shift","sidebar-collapsed-shift"),Bt()),He&&He.addEventListener("click",o=>{o.stopPropagation(),window.innerWidth>=768?(Ce=!Ce,qe(!Ce),Ce?(He.classList.add("text-indigo-400"),He.classList.remove("text-gray-400")):(He.classList.remove("text-indigo-400"),He.classList.add("text-gray-400"))):ni()}),se.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Ce&&se.classList.contains("collapsed")&&qe(!1)}),se.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Ce){const o=!!document.querySelector("#sidebarToggle:hover"),r=document.activeElement===Ma;!o&&!r&&qe(!0)}}),Cs&&Cs.addEventListener("click",o=>{o.stopPropagation(),ii()}),Ke&&Ke.addEventListener("click",o=>{o.stopPropagation(),Bt()});let s=0;se.addEventListener("touchstart",o=>{s=o.changedTouches[0].screenX},{passive:!0}),se.addEventListener("touchend",o=>{const r=o.changedTouches[0].screenX;s-r>50&&Bt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(o=>{o.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation();const i=o.getAttribute("data-target-submenu"),n=o.querySelector(".submenu-arrow");li(i,n)})}),di(),ri.forEach(o=>{const r=o.getAttribute("data-target");if(!r)return;const i=r.replace("-section",""),n=a?.[i]!==!1,l=e===null||e[r]?.view===!0;if(!n||!l){o.parentElement&&o.parentElement.tagName==="LI"?o.parentElement.style.display="none":o.style.display="none";return}o.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),o.classList.add("active"),r&&typeof t=="function"&&t(r),window.innerWidth<768&&Bt()})})}const ui=t=>C("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),fe=()=>C("/api/establishments/hierarchy",{method:"GET"}),Pe=t=>{const e=t||g.establishmentId;return e?C(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ds=(t,e)=>{const a=t||g.establishmentId;return a?C(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},pi=(t,e)=>{const a=t||g.establishmentId;return a?C(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},bi=(t,e)=>{const a=t||g.establishmentId;return a?C(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ke=t=>C(`/api/professionals/${t}`),fo=t=>C(`/api/professionals/details/${t}`),gi=t=>C("/api/professionals",{method:"POST",body:JSON.stringify(t)}),qa=(t,e)=>C(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),xo=t=>C(`/api/professionals/${t}`,{method:"DELETE"}),mi=t=>{const e=t.map(a=>xo(a));return Promise.all(e)};class fi{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const o=a.getBoundingClientRect(),r=8;this.spotlight.style.top=`${o.top+window.scrollY-r}px`,this.spotlight.style.left=`${o.left+window.scrollX-r}px`,this.spotlight.style.width=`${o.width+r*2}px`,this.spotlight.style.height=`${o.height+r*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(o)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
            <div class="p-5">
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(e){const a=this.popover.getBoundingClientRect(),s=20;let o=e.bottom+window.scrollY+s,r=e.left+window.scrollX;o+a.height>window.scrollY+window.innerHeight&&(o=e.top+window.scrollY-a.height-s),r+a.width>window.innerWidth&&(r=e.right+window.scrollX-a.width),r<s&&(r=s),this.popover.style.top=`${o}px`,this.popover.style.left=`${r}px`}handleResize(){this.isActive&&this.renderStep()}sleep(e){return new Promise(a=>setTimeout(a,e))}async waitForElement(e,a){if(!e)return null;const s=Date.now();for(;Date.now()-s<a;){const o=document.querySelector(e);if(o)return o;await this.sleep(100)}return null}}async function xi(){try{console.log("A verificar Onboarding interativo...");const t=await Pe(g.establishmentId);if(!t||t.parentId||t.onboardingCompleted)return;const e=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await ds(g.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(o){console.error("Erro ao gravar fim do onboarding",o)}};new fi(e,a,a).start()}catch(t){console.error("Erro fatal ao iniciar onboarding:",t)}}var et;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(et||(et={}));class $a extends Error{constructor(e,a,s){super(e),this.message=e,this.code=a,this.data=s}}const hi=t=>{var e,a;return t?.androidBridge?"android":!((a=(e=t?.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},vi=t=>{const e=t.CapacitorCustomPlatform||null,a=t.Capacitor||{},s=a.Plugins=a.Plugins||{},o=()=>e!==null?e.name:hi(t),r=()=>o()!=="web",i=u=>{const p=d.get(u);return!!(p?.platforms.has(o())||n(u))},n=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===u)},l=u=>t.console.error(u),d=new Map,c=(u,p={})=>{const b=d.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const f=o(),h=n(u);let y;const S=async()=>(!y&&f in p?y=typeof p[f]=="function"?y=await p[f]():y=p[f]:e!==null&&!y&&"web"in p&&(y=typeof p.web=="function"?y=await p.web():y=p.web),y),P=(j,I)=>{var L,F;if(h){const V=h?.methods.find(U=>I===U.name);if(V)return V.rtype==="promise"?U=>a.nativePromise(u,I.toString(),U):(U,T)=>a.nativeCallback(u,I.toString(),U,T);if(j)return(L=j[I])===null||L===void 0?void 0:L.bind(j)}else{if(j)return(F=j[I])===null||F===void 0?void 0:F.bind(j);throw new $a(`"${u}" plugin is not implemented on ${f}`,et.Unimplemented)}},N=j=>{let I;const L=(...F)=>{const V=S().then(U=>{const T=P(U,j);if(T){const W=T(...F);return I=W?.remove,W}else throw new $a(`"${u}.${j}()" is not implemented on ${f}`,et.Unimplemented)});return j==="addListener"&&(V.remove=async()=>I()),V};return L.toString=()=>`${j.toString()}() { [capacitor code] }`,Object.defineProperty(L,"name",{value:j,writable:!1,configurable:!1}),L},$=N("addListener"),E=N("removeListener"),D=(j,I)=>{const L=$({eventName:j},I),F=async()=>{const U=await L;E({eventName:j,callbackId:U},I)},V=new Promise(U=>L.then(()=>U({remove:F})));return V.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},V},B=new Proxy({},{get(j,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?D:$;case"removeListener":return E;default:return N(I)}}});return s[u]=B,d.set(u,{name:u,proxy:B,platforms:new Set([...Object.keys(p),...h?[f]:[]])}),B};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=o,a.handleError=l,a.isNativePlatform=r,a.isPluginAvailable=i,a.registerPlugin=c,a.Exception=$a,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},yi=t=>t.Capacitor=vi(t),we=yi(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),pa=we.registerPlugin;class ho{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,a){let s=!1;this.listeners[e]||(this.listeners[e]=[],s=!0),this.listeners[e].push(a);const r=this.windowListeners[e];r&&!r.registered&&this.addWindowListener(r),s&&this.sendRetainedArgumentsForEvent(e);const i=async()=>this.removeListener(e,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,a,s){const o=this.listeners[e];if(!o){if(s){let r=this.retainedEventArguments[e];r||(r=[]),r.push(a),this.retainedEventArguments[e]=r}return}o.forEach(r=>r(a))}hasListeners(e){var a;return!!(!((a=this.listeners[e])===null||a===void 0)&&a.length)}registerWindowListener(e,a){this.windowListeners[a]={registered:!1,windowEventName:e,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(e="not implemented"){return new we.Exception(e,et.Unimplemented)}unavailable(e="not available"){return new we.Exception(e,et.Unavailable)}async removeListener(e,a){const s=this.listeners[e];if(!s)return;const o=s.indexOf(a);this.listeners[e].splice(o,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const a=this.retainedEventArguments[e];a&&(delete this.retainedEventArguments[e],a.forEach(s=>{this.notifyListeners(e,s)}))}}const Ds=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ts=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class wi extends ho{async getCookies(){const e=document.cookie,a={};return e.split(";").forEach(s=>{if(s.length<=0)return;let[o,r]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=Ts(o).trim(),r=Ts(r).trim(),a[o]=r}),a}async setCookie(e){try{const a=Ds(e.key),s=Ds(e.value),o=`; expires=${(e.expires||"").replace("expires=","")}`,r=(e.path||"/").replace("path=",""),i=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${a}=${s||""}${o}; path=${r}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const a of e)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}pa("CapacitorCookies",{web:()=>new wi});const ki=async t=>new Promise((e,a)=>{const s=new FileReader;s.onload=()=>{const o=s.result;e(o.indexOf(",")>=0?o.split(",")[1]:o)},s.onerror=o=>a(o),s.readAsDataURL(t)}),$i=(t={})=>{const e=Object.keys(t);return Object.keys(t).map(o=>o.toLocaleLowerCase()).reduce((o,r,i)=>(o[r]=t[e[i]],o),{})},Si=(t,e=!0)=>t?Object.entries(t).reduce((s,o)=>{const[r,i]=o;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=e?encodeURIComponent(d):d,l+=`${r}=${n}&`}),l.slice(0,-1)):(n=e?encodeURIComponent(i):i,l=`${r}=${n}`),`${s}&${l}`},"").substr(1):null,Ei=(t,e={})=>{const a=Object.assign({method:t.method||"GET",headers:t.headers},e),o=$i(t.headers)["content-type"]||"";if(typeof t.data=="string")a.body=t.data;else if(o.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[i,n]of Object.entries(t.data||{}))r.set(i,n);a.body=r.toString()}else if(o.includes("multipart/form-data")||t.data instanceof FormData){const r=new FormData;if(t.data instanceof FormData)t.data.forEach((n,l)=>{r.append(l,n)});else for(const n of Object.keys(t.data))r.append(n,t.data[n]);a.body=r;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(o.includes("application/json")||typeof t.data=="object")&&(a.body=JSON.stringify(t.data));return a};class Ii extends ho{async request(e){const a=Ei(e,e.webFetchExtra),s=Si(e.params,e.shouldEncodeUrlParams),o=s?`${e.url}?${s}`:e.url,r=await fetch(o,a),i=r.headers.get("content-type")||"";let{responseType:n="text"}=r.ok?e:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await r.blob(),l=await ki(d);break;case"json":l=await r.json();break;case"document":case"text":default:l=await r.text()}const c={};return r.headers.forEach((u,p)=>{c[p]=u}),{data:l,headers:c,status:r.status,url:r.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}pa("CapacitorHttp",{web:()=>new Ii});const de=pa("PushNotifications",{}),Li="modulepreload",Ci=function(t){return"/"+t},Ps={},Di=function(e,a,s){let o=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");o=l(a.map(d=>{if(d=Ci(d),d in Ps)return;Ps[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Li,c||(p.as="script"),p.crossOrigin="",p.href=d,n&&p.setAttribute("nonce",n),document.head.appendChild(p),c)return new Promise((b,f)=>{p.addEventListener("load",b),p.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return o.then(i=>{for(const n of i||[])n.status==="rejected"&&r(n.reason);return e().catch(r)})},Bs=pa("App",{web:()=>Di(()=>import("./web-48vqLagP.js"),__vite__mapDeps([0,1,2,3])).then(t=>new t.AppWeb)}),Ti="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let As=!1;async function Pi(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await de.removeAllListeners(),await de.addListener("registration",async a=>{yo(a.value,!0)}),await de.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await de.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let e=await de.checkPermissions();e.receive==="prompt"&&(e=await de.requestPermissions()),e.receive==="granted"&&await de.register()}catch(e){console.error("[Push Nativo] Erro:",e)}return}"Notification"in window&&Notification.permission==="granted"&&vo()}async function Bi(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await vo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(t){return console.error("Erro ao pedir permissão Web:",t),!1}}async function vo(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await t.update();const e=await Ur(Ls,{vapidKey:Ti,serviceWorkerRegistration:t});e?(console.log("[Push Web] Token validado."),await yo(e,!1)):console.warn("[Push Web] Token veio vazio."),As||(Wr(Ls,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),As=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}else console.warn("Navegador sem suporte a Service Worker.")}async function yo(t,e){const a=ge.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=Te(me,"users",a.uid);try{const o=await ns(s);if(o.exists()){const i=o.data().fcmTokens||[];if(i.length===1&&i[0]===t){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Ct(s,{fcmTokens:[t],lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(o){if(o.code==="not-found")try{await Fr(s,{email:a.email,fcmTokens:[t],platform:e?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(r){console.error("Erro ao criar user:",r)}else console.error("Erro ao atualizar token:",o)}}const Ai=(t,e,a="all",s="all")=>{const o=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&o.append("professionalId",a),s&&s!=="all"&&o.append("costCenterId",s),C(`/api/reports/indicators?${o.toString()}`)},Mi=(t,e="all")=>{const a=new URLSearchParams({date:t});return e&&e!=="all"&&a.append("professionalId",e),C(`/api/reports/appointments/list?${a.toString()}`)},qi=t=>t?C(`/api/financial/cost-centers/${t}`):Promise.resolve([]),ji=(t,e,a)=>{const s=new URLSearchParams({startDate:e,endDate:a});return C(`/api/analytics/${t}?${s.toString()}`)},ta=({establishmentId:t,startDate:e,endDate:a,cashierSessionId:s})=>{const o=new URLSearchParams({startDate:e,endDate:a});return s&&s!=="all"&&o.append("cashierSessionId",s),t&&o.append("establishmentId",t),C(`/api/reports/sales?${o.toString()}`)},Ni=(t,e,a)=>C(`/api/analytics/${t}/monthly-details?year=${e}&month=${a}`),Ri=(t,e,a,s)=>{const o=`/api/analytics/${t}/daily-details?year=${e}&month=${a}&day=${s}`;return C(o)},Fi=(t,e,a,s)=>{const o=`/api/analytics/${t}/professional-details?year=${e}&month=${a}&professionalId=${s}`;return C(o)},Hi=(t,e,a,s)=>C(`/api/reports/commissions/${t}?year=${e}&month=${a}&professionalId=${s}`),wo=()=>C("/api/reports/summary",{method:"GET"}),Oi=Object.freeze(Object.defineProperty({__proto__:null,getAdvancedIndicators:Ai,getAnalytics:ji,getCommissionReport:Hi,getCostCenters:qi,getDailyAppointments:Mi,getDailyTransactions:Ri,getMonthlyAnalytics:Ni,getProfessionalMonthlyDetails:Fi,getSalesReport:ta,getSummaryKPIs:wo},Symbol.toStringTag,{value:"Module"})),cs=t=>t?String(t).replace(/\D/g,""):"",lt=(t,e="",a=20,s={})=>{const o=new URLSearchParams;return e&&o.append("search",e),a&&o.append("limit",a),s&&s.hasLoyalty&&o.append("hasLoyalty","true"),s&&s.birthMonth&&o.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&o.append("inactiveDays",s.inactiveDays),C(`/api/clients/${t}?${o.toString()}`)},ko=(t,e)=>{const a=encodeURIComponent(e);return C(`/api/clients/details/${t}/${a}`)},$o=t=>{const e=t.phone||t.id;if(!e)throw new Error("Telefone é obrigatório");const a=cs(e),s={...t,phone:a,id:a};return C(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},So=$o,Eo=(t,e)=>$o({...e,id:t}),Io=t=>{const e=encodeURIComponent(t);return C(`/api/clients/${e}`,{method:"DELETE"})},zi=(t,e,a,s)=>C("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientPhone:cs(e),points:a,rewardName:s})}),_i=(t,e)=>ko(t,cs(e));function v(t){return t==null?"":String(t).replace(/[&<>'"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[e])}function ba(t,e=800,a=800,s=.7){return new Promise((o,r)=>{if(!t.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(t),i.onload=n=>{const l=new Image;l.src=n.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>e&&(c*=e/d,d=e):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const b=u.toDataURL("image/jpeg",s);o(b)},l.onerror=d=>r(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>r(new Error("Erro ao ler o ficheiro."))})}function Sa(t){const e=parseFloat(t);return isNaN(e)?"R$ 0,00":e.toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}let Ea=null;async function Vi(){const t=document.getElementById("content");t.innerHTML=`
    ...
    `;try{const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),s=new Date(a);s.setHours(23,59,59,999);const o=new Date(a.getFullYear(),a.getMonth(),1),r=new Date(a);r.setDate(a.getDate()-6);const i=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],n=i.map(async T=>{const[W,ne]=await Promise.all([ls(T,o.toISOString(),s.toISOString(),null),lt(T)]);return{appts:W||[],clients:ne||[]}}),l=await Promise.all(n);let d=[],c=[];l.forEach(T=>{d=d.concat(T.appts),c=c.concat(T.clients)});const u=T=>(T.services||[]).reduce((W,ne)=>W+(Number(ne.price)||0),0)||Number(T.totalPrice||0)||Number(T.servicePrice||0),p=d.filter(T=>{const W=new Date(T.startTime);return W>=a&&W<=s}),b=p.filter(T=>T.status==="completed"),f=d.filter(T=>T.status==="completed"),h=b.reduce((T,W)=>T+u(W),0),y=f.reduce((T,W)=>T+u(W),0),S=p.length,P=f.length>0?y/f.length:0,N=[],$=[],E=["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"];for(let T=0;T<7;T++){const W=new Date(r);W.setDate(r.getDate()+T),N.push(E[W.getDay()]);const ne=new Date(W).setHours(0,0,0,0),ue=new Date(W).setHours(23,59,59,999),Pt=d.filter(Me=>{const J=new Date(Me.startTime).getTime();return Me.status==="completed"&&J>=ne&&J<=ue}).reduce((Me,J)=>Me+u(J),0);$.push(Pt)}const D={labels:N,data:$},B=p.filter(T=>new Date(T.startTime).getTime()>=e.getTime()&&T.status!=="completed"&&T.status!=="cancelled").sort((T,W)=>new Date(T.startTime)-new Date(W.startTime)).slice(0,4).map(T=>({client:T.clientName||"Desconhecido",service:T.serviceName||(T.services&&T.services[0]?T.services[0].name:"Serviço"),time:new Date(T.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(T.professionalName||"").split(" ")[0]||"Profissional",id:T.id})),j=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,I=new Map;c.forEach(T=>{T.phone?I.set(T.phone,T):I.set(T.id||Math.random().toString(),T)});const F=Array.from(I.values()).filter(T=>{if(!T.birthDate)return!1;let W,ne;if(T.birthDate.includes("-")){const ue=T.birthDate.split("-");ue[0].length===4?(W=ue[1],ne=ue[2]):(ne=ue[0],W=ue[1])}else if(T.birthDate.includes("/")){const ue=T.birthDate.split("/");ne=ue[0],W=ue[1]}return`${ne}/${W}`===j}).map(T=>{let W="";return T.birthDate&&T.birthDate.includes("-")&&T.birthDate.split("-")[0].length===4&&(W=a.getFullYear()-parseInt(T.birthDate.split("-")[0])),{name:T.name,age:W,phone:T.phone}}),V={receitaHoje:h,agendamentosHoje:S,receitaMes:y,ticketMedio:P},U=i.length>1;Ui(t,V,D,B,F,U),Wi(D),Qi()}catch(e){console.error("Erro ao carregar dashboard:",e),t.innerHTML=`
        ...
        `}}function Ui(t,e,a,s,o,r){const i=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),n=r?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-0.5 rounded-full ml-2 align-middle">CONSOLIDADO</span>':"";t.innerHTML=`
    ...
    `}function Wi(t){const e=document.getElementById("revenueChart");if(!e)return;Ea&&Ea.destroy();const s=e.getContext("2d").createLinearGradient(0,0,0,240);s.addColorStop(0,"rgba(79, 70, 229, 0.15)"),s.addColorStop(1,"rgba(79, 70, 229, 0.01)"),Ea=new Chart(e,{type:"line",data:{labels:t.labels,datasets:[{label:"Receita (R$)",data:t.data,borderColor:"#6366f1",backgroundColor:s,borderWidth:2.5,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.35}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,cornerRadius:8,titleFont:{size:12,family:"Inter",weight:"normal"},bodyFont:{size:13,weight:"bold",family:"Inter"},displayColors:!1,callbacks:{label:function(o){return o.parsed.y!==null?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(o.parsed.y):""}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:10},maxTicksLimit:6,callback:function(o){return"R$ "+o}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function Qi(){document.getElementById("content").addEventListener("click",e=>{const a=e.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":ee("agenda-section");break;case"new-appointment":ee("agenda-section");break;case"goto-pdv":ee("comandas-section");break;case"goto-clients":ee("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${g.establishmentId||""}`;window.open(o,"_blank");break}})}const dt=t=>C(`/api/services/${t}`),Ji=t=>C("/api/services",{method:"POST",body:JSON.stringify(t)}),Gi=(t,e)=>C(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Lo=t=>C(`/api/services/${t}`,{method:"DELETE"}),ga=(t,e,a,s="all")=>{const o=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return C(o)},ma=t=>C("/api/blockages",{method:"POST",body:JSON.stringify(t)}),us=t=>C(`/api/blockages/${t}`,{method:"DELETE"}),Co=t=>C("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Ms=document.getElementById("content");let qs=!1;const aa=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let fa=[],ja=[],sa={},Do=[],z={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},R={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function To(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function Gt(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}function ps(){const t=document.getElementById("profSelectorContainer");if(!t||!g.professionals)return;let e=g.professionals.filter(o=>z.showInactiveProfs||o.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(o=>{const r=z.selectedProfessionalId===o.id,i=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),n=o.id!=="all"?g.professionalColors.get(o.id)||aa[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        </div>`}r+="</div>",e.innerHTML=r,requestAnimationFrame(()=>{const i=document.getElementById("weekScroller");if(i&&window.innerWidth<768){const n=i.querySelector(".is-today");n&&n.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})}})}function Ki(t){const e=document.getElementById("agenda-view");if(!e)return;if(t.sort((s,o)=>new Date(s.startTime)-new Date(o.startTime)),t.length===0){e.innerHTML=`
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function Po(){const t=g.allEvents.filter(e=>z.selectedProfessionalId==="all"||e.professionalId===z.selectedProfessionalId);z.currentView==="list"?Ki(t):Zi(t),bs()}function bs(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(z.isSelectionMode&&z.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function en(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(z.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(z.currentView==="list"){Xi();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function je(){const t=document.getElementById("agenda-view");if(!t)return;z.selectedItems.clear(),bs(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',en();let e,a;if(z.currentView==="list")e=new Date(z.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=To(z.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const o=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async d=>{const[c,u]=await Promise.all([ls(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId==="all"?null:z.selectedProfessionalId),ga(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId)]);return{appts:c||[],blockages:u||[]}}),r=await Promise.all(o);let i=[],n=[];if(r.forEach(d=>{i=i.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(c=>({...c,type:c.type||"appointment",professionalName:c.professionalName||(()=>{const u=g.professionals?.find(p=>p.id===c.professionalId);return u?u.name:"Indefinido"})()}));g.allEvents=[...l(i),...l(n)],ps(),Po()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function tn(){try{const e=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async i=>{const[n,l,d]=await Promise.all([ke(i),dt(i),Pe(i)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,o=new Map;let r=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>s.set(n.id,n)),i.services.forEach(n=>o.set(n.id,n))}),g.professionals=Array.from(s.values()),g.services=Array.from(o.values()),Do=[],r&&(sa=r.loyaltyProgram||{enabled:!1}),g.professionals.forEach((i,n)=>{g.professionalColors.set(i.id,aa[n%aa.length])}),ps()}catch{m("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function Bo(t={}){z.currentDate=t.targetDate?new Date(t.targetDate):z.currentDate||new Date,z.isSelectionMode=!1,z.selectedItems.clear(),Ms.innerHTML=`
        ...
        </div>`;const o=document.createElement("div");o.id="optionsOverlay",o.className="fixed inset-0 bg-black/40 z-[9999] opacity-0 transition-opacity duration-300",document.body.appendChild(o),document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.remove("translate-y-full"),o.classList.remove("opacity-0")});const r=()=>{e.classList.add("translate-y-full"),o.classList.add("opacity-0"),setTimeout(()=>{e.remove(),o.remove()},300)};document.getElementById("closeOptSheet").addEventListener("click",r),o.addEventListener("click",r),document.getElementById("optSelectMode").addEventListener("click",()=>{z.isSelectionMode=!z.isSelectionMode,z.isSelectionMode||z.selectedItems.clear(),r(),Po()}),document.getElementById("optInactiveToggle").addEventListener("change",i=>{z.showInactiveProfs=i.target.checked,ps()})}function gt(t){t<1||t>4||(R.step=t,Na(null,!0))}function sn(t){return{title:t?"Editar Reserva":"Novo Cliente",content:`
        ...
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            ...
            <div id="apptServicesContainer" class="flex-1 overflow-y-auto grid grid-cols-2 gap-3 content-start pb-4">
                ${fa.map(t=>`<div class="service-card p-3 bg-white rounded-xl border-2 transition-all active:scale-95 ${R.data.selectedServiceIds.includes(t.id)?"border-indigo-500 bg-indigo-50 shadow-md":"border-gray-100 hover:border-gray-200 shadow-sm"} cursor-pointer flex flex-col justify-between gap-2" data-service-id="${t.id}">
                        <div>
        ...
        </div>`}}function nn(){const t=R.data.date||Gt();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
        ...
        </div>`}}async function Na(t=null,e=!1){const a=document.getElementById("appointmentModal");e||(R={step:1,data:{id:t?.id||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(o=>o.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:t?.startTime?Gt(new Date(t.startTime)):Gt(),time:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,originalDate:t?.startTime?Gt(new Date(t.startTime)):null,originalTime:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}}),fa=g.services||[],ja=(g.professionals||[]).filter(o=>o.status==="active");let s;switch(R.step){case 1:s=sn(t);break;case 2:s=on();break;case 3:s=rn();break;case 4:s=nn();break}a.className="fixed inset-0 z-[10000] bg-gray-50 flex flex-col w-full h-full transform transition-transform duration-300 translate-y-full",a.innerHTML=`
    ...
    `,a.querySelectorAll('[data-action="next-step"]').forEach(o=>o.addEventListener("click",()=>{const r=parseInt(o.dataset.currentStep,10);if(r===1&&(R.data.clientName=a.querySelector("#apptClientName").value.trim(),R.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!R.data.clientName))return m("Preencha o nome do cliente.","warning");if(r===2&&R.data.selectedServiceIds.length===0)return m("Selecione um serviço.","warning");if(r===3&&!R.data.professionalId)return m("Escolha um membro da equipe.","warning");gt(r+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>o.addEventListener("click",()=>gt(parseInt(o.dataset.currentStep,10)-1))),a.querySelectorAll('[data-action="close-modal"]').forEach(o=>{o.addEventListener("click",()=>{a.classList.remove("translate-y-0"),a.classList.add("translate-y-full"),setTimeout(()=>{a.classList.add("hidden")},300)})}),a.classList.remove("hidden"),requestAnimationFrame(()=>{a.classList.remove("translate-y-full"),a.classList.add("translate-y-0")}),R.step===2&&a.querySelectorAll(".service-card").forEach(o=>o.addEventListener("click",()=>{const r=a.querySelector("#multiServiceToggle")?.checked,i=o.classList.contains("bg-indigo-50"),n=o.dataset.serviceId;navigator.vibrate&&navigator.vibrate(15),r?i?(o.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),o.classList.add("border-gray-100","shadow-sm"),R.data.selectedServiceIds=R.data.selectedServiceIds.filter(l=>l!==n)):(o.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),o.classList.remove("border-gray-100","shadow-sm"),R.data.selectedServiceIds.includes(n)||R.data.selectedServiceIds.push(n)):(a.querySelectorAll(".service-card.bg-indigo-50").forEach(l=>{l.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),l.classList.add("border-gray-100","shadow-sm")}),o.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),o.classList.remove("border-gray-100","shadow-sm"),R.data.selectedServiceIds=[n],setTimeout(()=>gt(3),250))})),R.step===3&&a.querySelectorAll(".professional-modal-card").forEach(o=>o.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),a.querySelectorAll(".professional-modal-card.bg-indigo-50").forEach(i=>{i.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.add("border-gray-100","shadow-sm")}),o.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),o.classList.remove("border-gray-100","shadow-sm"),R.data.professionalId=o.dataset.professionalId;const r=ja.find(i=>i.id===o.dataset.professionalId);R.data.professionalName=r?r.name:"",setTimeout(()=>gt(4),250)})),R.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",o=>cn(o.target.value)),R.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",js),a.querySelector("#availableTimesContainer")?.addEventListener("click",o=>{const r=o.target.closest("button[data-time-slot]");r&&(navigator.vibrate&&navigator.vibrate(10),a.querySelectorAll("#availableTimesContainer button").forEach(i=>{i.classList.remove("bg-indigo-600","text-white","border-indigo-600","shadow-md"),i.classList.add("bg-white","text-gray-700","border-gray-200","shadow-sm")}),r.classList.add("bg-indigo-600","text-white","border-indigo-600","shadow-md"),r.classList.remove("bg-white","text-gray-700","border-gray-200","shadow-sm"),R.data.time=r.dataset.timeSlot)}),a.querySelector("#btnSubmitAppointment")?.addEventListener("click",ln),js(),dn())}async function ln(t){t.preventDefault();const e=document.getElementById("btnSubmitAppointment");if(!R.data.time||!R.data.selectedServiceIds.length||!R.data.professionalId)return m("Selecione horário, serviço e profissional.","warning");e.disabled=!0,e.innerHTML='<i class="bi bi-hourglass-split"></i> Processando...';const a=R.data.selectedServiceIds.map(c=>{const u=fa.find(p=>p.id===c);return{id:u.id,name:u.name,price:u.price,duration:u.duration,bufferTime:u.bufferTime||0,photo:u.photo||null}}),[s,o]=R.data.time.split(":"),r=new Date(`${R.data.date}T${s}:${o}:00`),i=a.reduce((c,u)=>c+(u.duration+(u.bufferTime||0)),0),n=new Date(r.getTime()+i*6e4),d={establishmentId:g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId,clientName:R.data.clientName,clientPhone:R.data.clientPhone,services:a,professionalId:R.data.professionalId,professionalName:R.data.professionalName,startTime:r.toISOString(),endTime:n.toISOString(),redeemedReward:R.data.redeemedReward};R.data.id&&(d.id=R.data.id);try{R.data.id?await Zr(R.data.id,d):await Yr(d),m("Registro salvo!","success");const c=document.getElementById("appointmentModal");c.classList.remove("translate-y-0"),c.classList.add("translate-y-full"),setTimeout(()=>{c.classList.add("hidden")},300),je()}catch(c){m(c.message,"error"),e.disabled=!1,e.innerHTML=`<i class="bi bi-check-circle-fill"></i> ${R.data.id?"Salvar Edição":"Confirmar"}`}}async function js(){const t=document.getElementById("availableTimesContainer"),e=document.getElementById("apptTotalDuration");if(!t)return;const a=document.getElementById("apptDate");a&&a.value&&(R.data.date=a.value);const s=R.data.selectedServiceIds.reduce((c,u)=>{const p=fa.find(b=>b.id===u);return c+(p?p.duration+(p.bufferTime||0):0)},0);e&&(e.innerHTML=`<strong>${s}</strong> min`);const{professionalId:o,selectedServiceIds:r,date:i,originalDate:n,originalTime:l,id:d}=R.data;if(!o||!r.length||!i){t.innerHTML='<p class="col-span-full text-center text-xs text-gray-500 font-bold py-4 bg-white rounded-xl shadow-sm border border-gray-100">Preencha os passos anteriores.</p>';return}t.innerHTML='<div class="col-span-full flex justify-center py-4"><div class="w-6 h-6 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div></div>';try{const c=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId;let u=await Xr({establishmentId:c,professionalId:o,serviceIds:r,date:i});const p=new Date;if(new Date(i+"T00:00:00").toDateString()===p.toDateString()){const b=p.getHours()*60+p.getMinutes();u=u.filter(f=>{const[h,y]=f.split(":").map(Number);return h*60+y>=b})}d&&i===n&&l&&(u.includes(l)||(u.push(l),u.sort())),t.innerHTML=u.length>0?u.map(b=>{const f=R.data.time===b;return`<button type="button" data-time-slot="${b}" class="py-3 text-sm font-bold rounded-xl border-2 transition-transform active:scale-95 ${f?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-white text-gray-700 border-gray-200 hover:border-indigo-300 shadow-sm"}">${b}</button>`}).join(""):'<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl border border-red-100 shadow-sm">Nenhum horário livre.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl">Erro ao pesquisar.</p>'}}function dn(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:a}=R.data,{enabled:s,rewards:o}=sa;if(!s||!e||!o?.length){t.innerHTML="";return}const r=o.filter(i=>a>=i.points);if(!r.length){t.innerHTML='<p class="text-xs font-bold text-gray-400 mt-3 text-center">Nenhuma recompensa atingida ainda.</p>';return}t.innerHTML=`<div class="border border-indigo-100 bg-indigo-50/80 rounded-xl p-3 mt-3 shadow-sm">
        ...
        ${r.map(i=>`<label class="flex items-center gap-2 p-2 bg-white border border-indigo-100 rounded-lg mb-1.5 cursor-pointer shadow-sm active:scale-95 transition-transform"><input type="radio" name="loyaltyReward" value="${X(i.reward)}" data-points="${i.points}" class="w-4 h-4 accent-indigo-600"><span class="text-[0.85rem] font-bold text-gray-800 flex-1">${X(i.reward)}</span><span class="text-[0.65rem] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded">-${i.points} pts</span></label>`).join("")}
            ...
            </div>`).join(""),e.querySelectorAll(".client-card").forEach(n=>{n.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),R.data.clientName=n.dataset.clientName,R.data.clientPhone=n.dataset.clientPhone,R.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(sa?.rewards||[]).map(d=>d.points));R.data.clientHasRewards=sa.enabled&&l!==1/0&&R.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,e.querySelectorAll(".client-card").forEach(d=>{d.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),d.classList.add("border-gray-100","shadow-sm")}),n.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),n.classList.remove("border-gray-100","shadow-sm"),setTimeout(()=>gt(2),250)})})}catch{e.innerHTML='<p class="text-[0.75rem] font-bold text-red-500 bg-red-50 p-3 rounded-xl border border-red-100 text-center shadow-sm">Erro ao pesquisar.</p>'}}const un=(t,e=null,a=1,s=12)=>{let o=`/api/comandas/${t}?page=${a}&limit=${s}`;return e&&(typeof e=="object"?(e.startDate&&(o+=`&startDate=${e.startDate}`),e.endDate&&(o+=`&endDate=${e.endDate}`)):typeof e=="string"&&(o+=`&date=${e}`)),C(o)},pn=(t,e)=>C(`/api/appointments/${t}/comanda`,{method:"POST",body:JSON.stringify({items:e})}),Ao=t=>C("/api/sales",{method:"POST",body:JSON.stringify(t)}),Ra=(t,e)=>C(`/api/sales/${t}?date=${e}`),bn=(t,e,a)=>{const s=`/api/sales/${t}?startDate=${e}&endDate=${a}`;return C(s)},gn=t=>C(`/api/sales/${t}/reopen`,{method:"POST"}),Mo=t=>C(`/api/sales/${t}`,{method:"DELETE"}),Ns=Object.freeze(Object.defineProperty({__proto__:null,createSale:Ao,deleteSale:Mo,getSales:Ra,getSalesByDateRange:bn,reopenSale:gn},Symbol.toStringTag,{value:"Module"})),ct=t=>C(`/api/products/${t}`),qo=t=>C("/api/products",{method:"POST",body:JSON.stringify(t)}),jo=(t,e)=>C(`/api/products/${t}`,{method:"PUT",body:JSON.stringify(e)}),gs=t=>C(`/api/products/${t}`,{method:"DELETE"}),No=(t,e)=>C(`/api/products/${t}/stock`,{method:"PATCH",body:JSON.stringify(e)}),mn=t=>C(`/api/products/${t}/stock-history`),Ro=({startDate:t,endDate:e,productId:a,categoryId:s,establishmentId:o})=>{const r=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&r.append("productId",a),s&&s!=="all"&&r.append("categoryId",s),o&&r.append("establishmentId",o),C(`/api/products/stock-history/report?${r.toString()}`)},fn=Object.freeze(Object.defineProperty({__proto__:null,adjustStock:No,createProduct:qo,deleteProduct:gs,getProducts:ct,getStockHistory:mn,getStockReport:Ro,updateProduct:jo},Symbol.toStringTag,{value:"Module"})),xn=()=>C("/api/cashier/status").catch(t=>{if(t.message.includes("404")||t.message.includes("não encontrada"))return null;throw t}),hn=t=>{const e={establishmentId:t.establishmentId,initialAmount:Number(t.initialAmount),notes:t.notes||""};return console.log("Payload enviado para abrir caixa:",e),C("/api/cashier/open",{method:"POST",body:JSON.stringify(e)})},vn=(t,e)=>{const a={finalAmount:Number(e)};return console.log("Payload enviado para fechar caixa:",a),C(`/api/cashier/close/${t}`,{method:"PUT",body:JSON.stringify(a)})},yn=()=>C("/api/cashier/history").then(t=>t||[]).catch(t=>(console.error("Erro ao buscar histórico:",t),[])),wn=t=>C(`/api/cashier/report/${t}`),ms=t=>C(`/api/packages/${t}`),kn=t=>C("/api/packages",{method:"POST",body:JSON.stringify(t)}),$n=(t,e)=>C(`/api/packages/${t}`,{method:"PUT",body:JSON.stringify(e)}),Sn=t=>C(`/api/packages/${t}`,{method:"DELETE"}),xa=t=>C(`/api/financial/natures/${t}`),En=t=>C("/api/financial/natures",{method:"POST",body:JSON.stringify(t)}),In=t=>C(`/api/financial/natures/${t}`,{method:"DELETE"}),fs=t=>C(`/api/financial/cost-centers/${t}`),Ln=t=>C("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(t)}),Cn=t=>C(`/api/financial/cost-centers/${t}`,{method:"DELETE"}),Fo=(t,e)=>C(`/api/financial/${t}`,{method:"POST",body:JSON.stringify(e)}),Ho=(t,e={})=>{let a=`/api/financial/${t}`;const s=new URLSearchParams;e.establishmentId&&s.append("establishmentId",e.establishmentId),e.startDate&&s.append("startDate",e.startDate),e.endDate&&s.append("endDate",e.endDate),e.natureId&&s.append("natureId",e.natureId),e.costCenterId&&s.append("costCenterId",e.costCenterId),e.status&&s.append("status",e.status);const o=s.toString();return o&&(a+=`?${o}`),C(a)},Oo=(t,e,a)=>C(`/api/financial/${t}/${e}`,{method:"PUT",body:JSON.stringify(a)}),zo=(t,e)=>C(`/api/financial/${t}/${e}`,{method:"DELETE"}),_o=(t,e)=>{const a=e.map(s=>C(`/api/financial/${t}/${s}`,{method:"DELETE"}));return Promise.all(a)},Vo=(t,e,a)=>C(`/api/financial/${t}/${e}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Uo=t=>Fo("payables",t),Wo=t=>Ho("payables",t),Dn=(t,e)=>Oo("payables",t,e),Tn=t=>zo("payables",t),Pn=(t,e)=>Vo("payables",t,e),Qo=t=>Fo("receivables",t),Jo=t=>Ho("receivables",t),Bn=(t,e)=>Oo("receivables",t,e),An=t=>zo("receivables",t),Mn=(t,e)=>Vo("receivables",t,e);let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",selectedCatalogItem:null,isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,establishmentConfig:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryPanel:!1,filterStartDate:"",filterEndDate:"",filterPreset:"hoje"},Oe=null,Ue=null,Rs=null;function Go(t,e){return function(...a){clearTimeout(Rs),Rs=setTimeout(()=>t.apply(this,a),e)}}function Ia(t){const e=new Date;let a,s;t==="hoje"?(a=new Date,s=new Date):t==="este_mes"?(a=new Date(e.getFullYear(),e.getMonth(),1),s=new Date(e.getFullYear(),e.getMonth()+1,0)):t==="mes_passado"?(a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0)):(a=new Date,s=new Date);const o=r=>{const i=r.getTimezoneOffset()*6e4;return new Date(r-i).toISOString().split("T")[0]};return{start:o(a),end:o(s)}}async function Fs(t,e="stay"){if(!t||!t.id)return;t._localUpdatedAt=Date.now(),t._cachedItems=null,t._hasUnsavedChanges=!1,va(),e==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),K());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,ha(),xs()}function xs(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function ha(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierOpen?(t&&(t.innerHTML=""),e&&(e.classList.remove("opacity-50","cursor-not-allowed"),e.disabled=!1)):(t&&(t.innerHTML=`
        ...
        `),e&&(e.classList.add("opacity-50","cursor-not-allowed"),e.disabled=!0)),Nn()}function Nn(){const t=document.getElementById("cashier-controls");t&&(x.isCashierOpen?t.innerHTML=`
        ...
        `,s.appendChild(P)}),t.innerHTML="",t.appendChild(s),Hs(e)}function Hs(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=x.paging,o=Math.ceil((a||0)/s);if(o===0)return;const r=document.createElement("div");r.className="flex gap-2 justify-center items-center w-full",r.innerHTML=`
    ...
    `,t.appendChild(r),r.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=o&&(x.paging.page=l,xe())}})}function Rn(t,e){const a=`
    ...
    `;const r=()=>{e.querySelector("#quantity-display").textContent=s,e.querySelector("#quantity-minus-btn").disabled=s<=1};e.querySelector("#quantity-minus-btn").onclick=()=>{s>1&&(s--,r())},e.querySelector("#quantity-plus-btn").onclick=()=>{s++,r()},e.querySelector("#confirm-add-qty-btn").onclick=async()=>{await Yo(a,s),x.viewMode="items",x.selectedCatalogItem=null,K()},r()}function K(){const t=document.getElementById("comanda-detail-container");if(!t)return;const e=x.allComandas.find(f=>String(f.id)===String(x.selectedComandaId));if(x.viewMode==="checkout"&&e){Hn(e,t);return}if(x.viewMode==="add-item"&&e){Rn(e,t);return}if(x.viewMode==="add-item-qty"&&e){Fn(e,t);return}const a=`
    ...
    `;if(!x.isCashierOpen){t.innerHTML=`
        ...
        `;return}const s=Be(e),o=e.status==="completed",r=e.type==="walk-in"||typeof e.id=="string"&&e.id.startsWith("temp-"),i=s.reduce((f,h)=>{const y=h._source==="original_service",S=h.id||h.name,P=y?`original-${S}`:`${h.type}-${S}`;return f[P]||(f[P]={...h,quantity:0,sources:[]}),f[P].quantity+=1,h._source&&f[P].sources.push(h._source),f},{}),n=Object.values(i).reduce((f,h)=>f+Number(h.price||0)*h.quantity,0),l=v(e.clientName||"Cliente sem nome"),d=v(e.professionalName||"Profissional não atribuído"),c=e._hasUnsavedChanges,u=`
    ...
    `;t.innerHTML=`
        ...
        ${p}
        ${b}
    `,!o&&(e.clientId||e.clientName)&&On(e,t.querySelector("#loyalty-container"))}function Hn(t,e){const s=Be(t).reduce((b,f)=>b+Number(f.price||0)*(f.quantity||1),0),o=x.checkoutState,r=o.discount||{type:"real",value:0};let i=0;r.type==="percent"?i=s*r.value/100:i=r.value,i>s&&(i=s);const n=s-i,l=o.payments.reduce((b,f)=>b+f.value,0),d=Math.max(0,n-l);(!o.amountReceived||d>0)&&(o.amountReceived=d.toFixed(2));const c=`
        <div class="md:hidden p-4 border-b border-gray-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
            <button data-action="back-to-items" class="w-10 h-10 rounded-full bg-gray-100 text-gray-700 flex items-center justify-center hover:bg-gray-200 shadow-inner active:scale-90 transition-transform">
                <i class="bi bi-arrow-left text-lg"></i>
            </button>
    ...
    `;const p=()=>{const b=x.checkoutState.discount.type,f=x.checkoutState.discount.value;let h=b==="percent"?s*f/100:f;h>s&&(h=s);const y=s-h,S=x.checkoutState.payments.reduce((D,B)=>D+B.value,0),P=Math.max(0,y-S),N=e.querySelector("#checkout-total-display");N&&(N.textContent=`R$ ${y.toFixed(2)}`);const $=e.querySelector("#checkout-status-msg");$&&(P<=.01?$.innerHTML='<p class="text-emerald-500 font-black text-sm uppercase tracking-widest"><i class="bi bi-check2-circle text-lg mr-1"></i> Pago</p>':$.innerHTML=`<p class="text-red-500 font-bold text-sm">Faltam: <span id="checkout-remaining-display" class="font-black text-lg">R$ ${P.toFixed(2)}</span></p>`);const E=e.querySelector("#checkout-amount");E&&P>0&&document.activeElement!==E&&(E.value=P.toFixed(2))};e.querySelector("#discount-value")?.addEventListener("input",b=>{const f=parseFloat(b.target.value)||0;x.checkoutState.discount.value=f,p()}),e.querySelector("#discount-type")?.addEventListener("change",b=>{x.checkoutState.discount.type=b.target.value,p()}),e.querySelector("#discount-reason")?.addEventListener("input",b=>{x.checkoutState.discountReason=b.target.value}),e.querySelector("#checkout-amount")?.addEventListener("input",b=>{x.checkoutState.amountReceived=b.target.value}),e.querySelector("#checkout-installments")?.addEventListener("change",b=>{x.checkoutState.installments=parseInt(b.target.value,10)})}async function On(t,e){if(!e)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(t.clientId)s=await ko(g.establishmentId,t.clientId);else if(t.clientName){const n=await lt(g.establishmentId,t.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const o=Number(s.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&o>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-3 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerHTML="<i class='bi bi-gift mr-1'></i> Resgatar",l.className="text-[10px] font-black uppercase tracking-wider bg-yellow-500 text-white px-3 py-2 rounded-lg shadow-md hover:bg-yellow-600 transition-colors",l.onclick=()=>zn(i,t),n.appendChild(l),e.innerHTML="",e.appendChild(n)}}function zn(t,e){const a=`
        <div class="space-y-3">
    ...
    `,{modalElement:s,close:o}=Le({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",r=>{const i=r.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=t.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(_n(l,e),o())}})}async function _n(t,e){const a=Number(t.costPoints||t.points||0),s=t.name||t.reward,o=t.type||"money";if(o==="money"){const l=parseFloat(t.discount)||0;if(l<=0){m("Erro","O valor do desconto configurado é inválido.","error");return}x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:"money"},m("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),K();return}const r=Be(e),i=t.itemId?String(t.itemId):null;if(!i){m("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");return}const n=r.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return o==="service"?d===i||c===i:o==="product"?d===i||u===i:o==="package"?d===i:!1});if(n){let l=parseFloat(t.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:o,appliedToItemId:n.id},m("Sucesso",`Prémio "${s}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),K()}else m("Item Não Encontrado",`Para resgatar o prémio "${s}", o ${o==="service"?"serviço":o==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}async function Fa(t=null){if(!x.isCashierOpen)return m("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!g.professionals||g.professionals.length===0)try{g.professionals=await ke(g.establishmentId)}catch{return m("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,maxWidth:"max-w-sm"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",Un)}async function Un(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const a=e.querySelector("#regClientName"),o=e.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!o)return m("Erro","Nome e Telefone são obrigatórios.","error");try{const r=await _i(g.establishmentId,o);if(r)m("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",Fa(r);else{const i=await So({establishmentId:g.establishmentId,name:a.value,phone:o});m("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",Fa(i)}}catch(r){m("Erro",r.message,"error")}}async function Wn(){const t=`
    ...
    `,{modalElement:e}=Le({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-xs"});e.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return m("Valor Inválido","Insira um valor válido.","error");try{const o=await hn({establishmentId:g.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=o.id,document.getElementById("genericModal").style.display="none",m("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),ha(),await xe()}catch(o){m("Erro",`Falha ao abrir caixa: ${o.message}`,"error")}})}async function Qn(){const t=x.activeCashierSessionId;if(t)try{const e=await wn(t),a=`
        ...
        `,{modalElement:s}=Le({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const r=parseFloat(document.getElementById("final-amount").value);if(isNaN(r)||r<0)return m("Valor Inválido","Insira um valor final válido.","error");try{await vn(t,r),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",ha(),await xe(),m("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){m("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(e){m("Erro",`Falha ao carregar relatório: ${e.message}`,"error")}}async function Jn(t){if(x.activeFilter===t)return;x.activeFilter=t,x.paging.page=1,xs(),Qe(),x.selectedComandaId=null,x.viewMode="items";const e=document.getElementById("comandas-list");e&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>'),await xe()}function Xo(t){x.selectedComandaId=String(t),x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",va(),qn(),K()}async function Yo(t,e){const a=x.allComandas.find(r=>String(r.id)===String(x.selectedComandaId));if(!a)return;if(!t.id||String(t.id)==="undefined"){m("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(t.price)||0,o=Array(e).fill(0).map(()=>{const r={id:String(t.id),name:t.name,price:s,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0};return t.type==="product"?(r.productId=r.id,r.product_id=r.id):t.type==="service"&&(r.serviceId=r.id,r.service_id=r.id),r});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...o),a._cachedItems=null,a._hasUnsavedChanges=!0,K()}async function Os(t,e){const a=x.allComandas.find(r=>String(r.id)===String(x.selectedComandaId));if(!a)return;let s=!1,o=(a.comandaItems||[]).findIndex(r=>String(r.id)===String(t)&&r.type===e);o>-1&&(a.comandaItems.splice(o,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,K())}async function Gn(t){if(x.isProcessing)return;const e=Be(t),a=e.reduce((y,S)=>y+Number(S.price||0)*(S.quantity||1),0),s=x.checkoutState.discount||{type:"real",value:0};let o=s.type==="percent"?a*s.value/100:s.value;o>a&&(o=a);const r=a-o,{payments:i}=x.checkoutState,n=i.reduce((y,S)=>y+S.value,0),l=r-n;if(l>.01){if(!await Y("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=t.type==="appointment",c=e;let u=0;const p=x.loyaltySettings;p&&p.enabled&&(u=parseInt(p.pointsPerVisit||1,10));const b={...s,reason:x.checkoutState.discountReason||""},f={payments:i,totalAmount:Number(r),items:c,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:u,discount:b,loyaltyRedemption:x.pendingRedemption},h=document.createElement("div");h.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",h.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4"></div><p class="text-sm font-black text-gray-800 uppercase tracking-widest mt-2">Finalizando...</p></div>',document.body.appendChild(h);try{d?await ti(t.id,f):(f.establishmentId=g.establishmentId,f.clientId=t.clientId,f.clientName=t.clientName,f.professionalId=t.professionalId,t.clientPhone&&(f.clientPhone=t.clientPhone),await Ao(f));try{const S=t.clientName?`${t.clientName} ${t.clientPhone?"- "+t.clientPhone:""}`.trim():"Cliente Avulso",P=x.establishmentConfig||{},N=P.defaultReceitaNaturezaId||P.financeConfig?.receitaNaturezaId||null,$=P.defaultReceitaCentroCustoId||P.financeConfig?.receitaCentroCustoId||null;for(const E of i)E.method!=="fiado"&&await Qo({establishmentId:g.establishmentId,description:`Comanda - ${t.clientName||"Avulso"}`,amount:E.value,dueDate:new Date().toISOString().split("T")[0],naturezaId:N,centroDeCustoId:$,entity:S,paymentMethod:E.method,status:"paid",paymentDate:new Date().toISOString().split("T")[0],origin:"comanda"})}catch(S){console.error("Erro na integração com o financeiro:",S)}let y="Venda finalizada com sucesso!";u>0&&(y+=` Cliente ganhou ${u} pontos!`),m("Sucesso!",y,"success"),Qe(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await xe()}catch(y){m("Erro no Checkout",y.message,"error")}finally{document.body.contains(h)&&document.body.removeChild(h),x.isProcessing=!1}}async function Xn(t){t.preventDefault();const e=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=e.value,o=document.getElementById("client-search").value,r=e.dataset.phone||"";if(!s)return m("Erro","Selecione um cliente válido.","error");const i=g.professionals.find(l=>l.id===a);if(!i)return m("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:o.split("(")[0].trim(),clientPhone:r,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(n),x.selectedComandaId=String(n.id),x.viewMode="items",document.getElementById("genericModal").style.display="none",x.activeFilter==="pagas"&&(x.activeFilter="abertas"),xs(),Xo(n.id)}async function xe(){const t=document.getElementById("comandas-list");(!t.hasChildNodes()||t.innerHTML.includes("loader"))&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>');let e=x.filterStartDate,a=x.filterEndDate,s;e&&a&&e!==a?s={startDate:e,endDate:a}:s={startDate:e,endDate:a,date:e};try{const o=xn(),r=un(g.establishmentId,s,x.paging.page,x.paging.limit),i=Pe(g.establishmentId),[n,l,d]=await Promise.all([o,r,i]);if(x.establishmentConfig=d||{},x.isCashierOpen=!!n,x.activeCashierSessionId=n?n.id:null,ha(),d&&d.loyaltyProgram&&(x.loyaltySettings=d.loyaltyProgram),x.allComandas=l.data||l||[],x.paging.total=l.total||x.allComandas.length,x.catalog.services.length===0){const[c,u,p,b]=await Promise.all([dt(g.establishmentId),ct(g.establishmentId),ms(g.establishmentId),ke(g.establishmentId)]);x.catalog={services:c,products:u,packages:p},g.professionals=b}va(),K()}catch(o){m("Erro",`Não foi possível carregar os dados: ${o.message}`,"error")}}async function Yn(t={}){Ue=document.getElementById("content"),x.selectedComandaId=t.selectedAppointmentId?String(t.selectedAppointmentId):null,x.viewMode="items",x.selectedCatalogItem=null;const e=Ia("hoje");if(x.filterStartDate=e.start,x.filterEndDate=e.end,x.filterPreset="hoje",x.showHistoryPanel=!1,At(),Oe&&(Ue.removeEventListener("click",Oe),Ue.removeEventListener("change",Oe)),Oe=async a=>{const s=a.target.closest("[data-action], [data-filter], [data-comanda-id]");if(s){if(s.matches("[data-filter]"))a.preventDefault(),Jn(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(a.preventDefault(),a.target.closest('[data-action="go-to-appointment"]')){a.stopPropagation();return}Xo(s.dataset.comandaId)}else if(s.matches("[data-action]")){a.preventDefault();const o=s.dataset.action,r=String(s.dataset.id||x.selectedComandaId),i=x.allComandas.find(n=>String(n.id)===r);switch(o){case"toggle-history":if(x.showHistoryPanel=!x.showHistoryPanel,x.showHistoryPanel&&x.activeFilter==="abertas"&&(x.activeFilter="todas"),At(),!x.showHistoryPanel){x.filterPreset="hoje";const I=Ia("hoje");x.filterStartDate=I.start,x.filterEndDate=I.end,await xe()}break;case"set-period":const n=s.dataset.period;if(x.filterPreset=n,n!=="custom"){const I=Ia(n);x.filterStartDate=I.start,x.filterEndDate=I.end,At(),x.paging.page=1,m("Buscando...",`Período: ${I.start.split("-").reverse().join("/")} a ${I.end.split("-").reverse().join("/")}`,"info"),await xe()}else At();break;case"apply-custom-dates":const l=document.getElementById("filter-start-date").value,d=document.getElementById("filter-end-date").value;l&&d?(x.filterStartDate=l,x.filterEndDate=d,x.paging.page=1,m("Buscando...","Período personalizado aplicado.","info"),await xe()):m("Atenção","Preencha a data inicial e final.","warning");break;case"back-to-list":Qe(),x.selectedComandaId=null,x.selectedCatalogItem=null,document.querySelectorAll(".comanda-card").forEach(I=>I.classList.remove("ring-2","ring-indigo-500","bg-indigo-50/50")),document.querySelectorAll(".comanda-card").forEach(I=>I.classList.add("bg-white")),K();break;case"new-sale":Fa();break;case"add-item":if(!x.isCashierOpen)return m("Caixa Fechado","Abra o caixa primeiro.","error");x.viewMode="add-item",K();break;case"back-to-items":x.viewMode="items",K();break;case"back-to-add-item":x.viewMode="add-item",x.selectedCatalogItem=null,K();break;case"select-catalog-item":const{itemType:c,itemId:u}=s.dataset,b=(x.catalog[c+"s"]||[]).find(I=>String(I.id)===String(u));b&&(x.selectedCatalogItem={...b,type:c},x.viewMode="add-item-qty",K());break;case"open-cashier":Wn();break;case"close-cashier":await Qn();break;case"view-sales-report":ee("sales-report-section");break;case"go-to-checkout":await Fs(i,"checkout");break;case"save-comanda":await Fs(i,"stay");break;case"select-method":x.checkoutState.selectedMethod=s.dataset.method,x.checkoutState.installments=1,K();break;case"add-payment-checkout":const f=document.getElementById("checkout-amount");let h=parseFloat(f.value);const S=Be(i).reduce((I,L)=>I+(L.price||0),0),P=x.checkoutState.discount||{type:"real",value:0};let N=P.type==="percent"?S*P.value/100:P.value;N>S&&(N=S);const $=S-N,E=x.checkoutState.payments.reduce((I,L)=>I+L.value,0),D=$-E;if(isNaN(h)||h<=0){m("Valor inválido","Insira um valor maior que zero.","error");break}if(h>D+.05){m("Valor inválido","Valor excede o restante.","error");break}const B={method:x.checkoutState.selectedMethod,value:h};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(B.installments=x.checkoutState.installments),x.checkoutState.payments.push(B),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",K();break;case"remove-payment-checkout":const j=parseInt(s.dataset.index,10);x.checkoutState.payments.splice(j,1),K();break;case"finalize-checkout":await Gn(i);break;case"increase-qty":{const I=s.dataset.itemId,L=s.dataset.itemType;if(!I||I==="undefined"||I==="null"){m("Erro","Item inválido.","error");return}let V=Be(i).find(T=>String(T.id)===String(I)&&T.type===L);V||(V=(x.catalog[L+"s"]||[]).find(W=>String(W.id)===String(I)));const U=V?{id:V.id,name:V.name,price:Number(V.price),type:V.type}:{id:I,name:"Item",price:0,type:L};await Yo(U,1);break}case"decrease-qty":await Os(s.dataset.itemId,s.dataset.itemType);break;case"remove-item":await Os(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await Y("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await ei(r);const L=x.allComandas.findIndex(F=>String(F.id)===r);L!==-1&&(x.allComandas[L].status="confirmed",delete x.allComandas[L].transaction),x.selectedComandaId=null,Qe(),await xe(),m("Sucesso!","Comanda reaberta.","success")}catch(L){m("Erro",L.message,"error")}break}case"go-to-appointment":{ee("agenda-section",{scrollToAppointmentId:s.dataset.id,targetDate:new Date(s.dataset.date)});break}case"delete-walk-in":{if(await Y("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(r.startsWith("temp-"))x.allComandas=x.allComandas.filter(L=>String(L.id)!==r),x.selectedComandaId=null,va(),K(),Qe();else try{await Mo(r),m("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Qe(),await xe()}catch(L){m("Erro",L.message,"error")}break}}}}},Ue.addEventListener("click",Oe),Ue.addEventListener("change",Oe),t.initialFilter&&(t.initialFilter==="finalizadas"?x.activeFilter="pagas":x.activeFilter="abertas"),t.selectedAppointmentId&&(x.selectedComandaId=String(t.selectedAppointmentId)),t.filterDate){const a=new Date(t.filterDate).toISOString().split("T")[0];x.filterStartDate=a,x.filterEndDate=a,x.filterPreset="custom",x.showHistoryPanel=!0}await xe()}const Ha=new Date,Zn=new Date(Ha.getFullYear(),Ha.getMonth(),1);let M={establishments:[],filterEstablishmentIds:new Set,startDate:Zn.toISOString().split("T")[0],endDate:Ha.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Oa=document.getElementById("content");let Mt=null;function ie(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Ee(t){if(!t)return"--/--/----";const e=t.split("T")[0].split("-");return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}function Se(t){return t?typeof t.toDate=="function"?t.toDate():typeof t=="string"||typeof t=="number"?new Date(t):new Date:new Date(0)}function Tt(t){M.charts[t]&&(M.charts[t].destroy(),M.charts[t]=null)}async function Kn(){try{const e=(await fe().catch(()=>({matrizes:[]}))).matrizes||[];M.establishments=[],e.forEach(a=>{M.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>M.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),M.filterEstablishmentIds.size===0&&M.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}el(),nl(),await mt()}function el(){const t=M.establishments.map(e=>`
...
(Clique para ver)`}}}},onClick:(E,D)=>{if(D.length>0){const B=D[0].index,j=D[0].datasetIndex,I=i[B];let L="all";j===0||j===1?L="receita":(j===2||j===3)&&(L="despesa"),al(I,L,r[I].items,o)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:E=>ie(Math.abs(E))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:E=>ie(E)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(E=>{E.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",E.onclick=D=>{const B=D.currentTarget,j=parseInt(B.dataset.dataset),I=M.charts.fin;I.isDatasetVisible(j)?(I.hide(j),B.style.opacity="0.4",B.style.background="#f8f9fa"):(I.show(j),B.style.opacity="1",B.style.background="")}}))},100)}function al(t,e,a,s){let o=document.getElementById("genericModal");o||(o=document.createElement("div"),o.id="genericModal",o.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(o));const r=e==="all"?a:a.filter(l=>l._type===e);let i=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";o.innerHTML=`
    ...
    `,o.style.display="block",setTimeout(()=>o.classList.add("show","opacity-100"),10);const n=o.querySelector(".btn-close-modal");n&&(n.onclick=()=>{o.style.display="none",o.classList.remove("show","opacity-100")})}function za(){const t=document.getElementById("tab-content"),{active:e,cancelled:a}=M.data.agenda,s=e.length+a.length,o=e.filter(p=>p.status==="completed").length,r=e.filter(p=>["confirmed","pending","in-progress"].includes(p.status)).length,i=e.filter(p=>p.status==="no-show").length,n=a.length,l=s>0?(o/s*100).toFixed(1):0,d=e.filter(p=>p.status==="completed").reduce((p,b)=>p+(Number(b.totalAmount||(b.transaction?b.transaction.totalAmount:0))||0),0);let c=[],u=[];if(M.drillDownMonth!==null){const p=new Date(M.startDate).getFullYear(),b=new Date(p,M.drillDownMonth+1,0).getDate();c=Array.from({length:b},(f,h)=>`${h+1}`),u=c.map(f=>e.filter(h=>{const y=Se(h.startTime||h.date);return y.getMonth()===M.drillDownMonth&&y.getDate()===parseInt(f)}).length)}else c=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],u=c.map((p,b)=>e.filter(f=>Se(f.startTime||f.date).getMonth()===b).length);t.innerHTML=`
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const c=document.getElementById("chartClientes");c&&(Tt("clientes"),M.charts.clientes=new Chart(c,{type:"bar",data:{labels:l,datasets:[{label:"Novos Cadastros",data:d,backgroundColor:"#3b82f6",borderRadius:3}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(p,b)=>{b.length>0&&M.drillDownMonth===null&&(M.drillDownMonth=b[0].index,_a())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const u=document.getElementById("btn-back-clientes");u&&(u.onclick=()=>{M.drillDownMonth=null,_a()})},100)}function sl(){const t=document.getElementById("tab-content"),a=(M.data.vendas||[]).filter(d=>d.status==="completed"||d.status==="paid"),s=a.reduce((d,c)=>d+(Number(c.totalAmount)||0),0),o=a.length,r=o>0?s/o:0;let i=0;const n={};a.forEach(d=>{(Array.isArray(d.items)?d.items:Array.isArray(d.services)?d.services:[]).forEach(u=>{const p=Number(u.quantity)||1;i+=p;const b=u.name||"Produto/Serviço Indefinido";n[b]=(n[b]||0)+p})});const l=Object.entries(n).sort((d,c)=>c[1]-d[1]).slice(0,5);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const d=document.getElementById("chartVendas");d&&l.length>0?(Tt("vendas"),M.charts.vendas=new Chart(d,{type:"bar",data:{labels:l.map(c=>c[0].substring(0,15)+"..."),datasets:[{label:"Quantidade Vendida",data:l.map(c=>c[1]),backgroundColor:"#f59e0b",borderRadius:3}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},y:{grid:{display:!1},ticks:{font:{size:9}}}}}})):d&&(d.parentElement.innerHTML='<div class="flex h-full items-center justify-center text-[10px] text-slate-400">Sem dados suficientes</div>')},100)}function ol(){const t=document.getElementById("tab-content"),e=M.data.estoque||[];let a=0,s=0,o=[],r=[];e.forEach(i=>{i.active!==!1&&s++;const n=Number(i.currentStock)||0,l=Number(i.minStock)||0,d=Number(i.costPrice)||Number(i.price)||0;n>0&&(a+=n*d),n<=0?r.push(i):n<=l&&o.push(i)}),t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
    ...
    `}function pl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Ae),t.addEventListener("click",()=>{setTimeout(Ae,100)})),document.querySelectorAll(".status-filter-btn").forEach(r=>{r.addEventListener("click",i=>{const n=i.target.dataset.status;_.statusFilter=n,document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),l.classList.add("bg-white","text-gray-600","border-gray-200")}),n==="inactive"?i.target.classList.add("bg-red-50","text-red-700","border-red-200"):i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200"),ft()})});const e=document.getElementById("toggle-filter-btn");e&&e.addEventListener("click",()=>{const r=document.getElementById("filter-panel");_.isAdvancedFilterOpen=!_.isAdvancedFilterOpen,_.isAdvancedFilterOpen?(r.classList.remove("hidden"),e.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),e.classList.remove("bg-white","text-gray-600","border-gray-200")):(r.classList.add("hidden"),e.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),e.classList.add("bg-white","text-gray-600","border-gray-200"))});const a=document.getElementById("searchInput");a&&a.addEventListener("input",r=>{_.searchQuery=r.target.value.toLowerCase(),ft()});const s=document.getElementById("clear-filters-btn");s&&s.addEventListener("click",()=>{_.filterCategoryId="all",document.getElementById("filterCategoryId").value="all",ft()});const o=document.getElementById("apply-filter-btn");o&&o.addEventListener("click",()=>{_.filterCategoryId=document.getElementById("filterCategoryId").value,document.getElementById("toggle-filter-btn").click(),ft()}),qt&&Va.removeEventListener("click",qt),qt=r=>{const i=r.target.closest('[data-action="open-service-modal"]');if(i){r.preventDefault();let u={};if(i.dataset.service)try{u=JSON.parse(i.dataset.service)}catch{}wl(u);return}if(r.target.closest('[data-action="manage-categories"]')){r.preventDefault(),hl();return}const l=r.target.closest(".service-checkbox");if(l){const u=l.dataset.id;l.checked?_.selectedIds.add(u):_.selectedIds.delete(u),Ua(),r.stopPropagation();return}if(r.target.closest("#cancel-selection-btn")){_.selectedIds.clear(),document.querySelectorAll(".service-checkbox").forEach(u=>u.checked=!1),Ua();return}if(r.target.closest("#batch-delete-btn")){kl();return}},Va.addEventListener("click",qt)}async function Ae(){const t=document.getElementById("servicesList"),e=er();try{const a=e.map(u=>dt(u)),s=e.map(u=>ke(u)),o=e.map(u=>ya(u,"services")),r=await Promise.all(a),i=await Promise.all(s),n=await Promise.all(o),l=new Map;r.flat().filter(Boolean).forEach(u=>l.set(u.id,u)),_.services=Array.from(l.values()),g.services=_.services;const d=new Map;i.flat().filter(Boolean).forEach(u=>d.set(u.id,u)),_.professionals=Array.from(d.values()),g.professionals=_.professionals;const c=new Map;n.flat().filter(Boolean).forEach(u=>c.set(u.id,u)),_.categories=Array.from(c.values()),g.serviceCategories=_.categories,bl(),ft()}catch(a){console.error(a),t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>'}}function bl(){const t=document.getElementById("filterCategoryId");t&&_.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',_.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),_.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function Ua(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=_.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function gl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(r=>r.active!==!1).length,o=a-s;e.innerHTML=`
    ...
    `}function ft(){const t=document.getElementById("servicesList");if(!t)return;if(!_.services||_.services.length===0){t.innerHTML=tr(8);return}const e=er(),a=_.services.filter(s=>{const o=s.name.toLowerCase().includes(_.searchQuery);let r=!0;_.statusFilter==="active"&&(r=s.active!==!1),_.statusFilter==="inactive"&&(r=s.active===!1);const i=_.filterCategoryId==="all"||s.categoryId===_.filterCategoryId,n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||g.establishmentId],l=e.some(d=>n.includes(d));return o&&r&&i&&l});gl(a),t.innerHTML=ml(a)}function tr(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;const e=new Map((_.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=a.active===!1,o=v(a.name),r=v(e.get(a.categoryId)||"Sem Categoria"),i=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,n=JSON.stringify(a).replace(/'/g,"&apos;"),l=a.accessibleIn?a.accessibleIn.length:1,d=_.selectedIds.has(a.id),c=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",u=a.color||"#4f46e5";return`
            <div class="service-card relative bg-white rounded-xl border ${d?"border-indigo-400 ring-1 ring-indigo-200 shadow-md bg-indigo-50/20":"border-gray-200"} shadow-sm flex items-center p-3 cursor-pointer transition-all hover:shadow-md hover:border-indigo-300 ${s?"opacity-60 bg-gray-50":""}" 
            ...
            </div>`}).join("")}async function fl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const o=e.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const r=_.hierarchyCache.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);r.length===0&&r.push(g.establishmentId),await Zo({establishmentId:g.establishmentId,name:s,accessibleIn:r},"services"),ae(g.establishmentId,tt(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",m("Sucesso","Categoria criada!","success"),await hs(),await Ae()}catch(r){m("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Adicionar"}}async function xl(t){if(await Y("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Ko(t,"services"),ae(g.establishmentId,tt(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),m("Sucesso","Categoria apagada.","success"),await hs(),await Ae()}catch{m("Erro","Não foi possível apagar a categoria.","error")}}async function hs(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await ya(g.establishmentId,"services");_.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(a=>`
                ...
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function hl(){Le({title:"Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",fl),e.addEventListener("click",s=>{const o=s.target.closest('button[data-action="delete-category"]');o&&(s.preventDefault(),xl(o.dataset.id))}))}hs()}function vl(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const r=t.includes(o.id)||t.length===0&&o.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}async function yl(t){const e=t.target.closest("#serviceForm"),a=e.querySelector("#serviceId").value,s=e.querySelector('button[type="submit"]'),o={},r=e.querySelector('input[name="commissionType"]:checked').value;r==="custom"&&e.querySelectorAll(".professional-commission-row").forEach(c=>{const u=c.dataset.profId;if(c.querySelector('input[type="checkbox"]').checked){const b=parseFloat(c.querySelector('input[type="number"]').value);o[u]=isNaN(b)?0:b}});const i=Array.from(e.querySelectorAll('input[name="accessibleIn"]:checked')).map(c=>c.value),n=i.length>0?i:[g.establishmentId],l={establishmentId:g.establishmentId,accessibleIn:n,name:e.querySelector("#serviceName").value.trim(),price:parseFloat(e.querySelector("#servicePrice").value),duration:parseInt(e.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(e.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:e.querySelector("#serviceCategory").value||null,color:e.querySelector("#serviceColor").value,targetAudience:e.querySelector("#serviceAudience").value,loyaltyPoints:parseInt(e.querySelector("#serviceLoyaltyPoints").value,10)||0,publicDescription:e.querySelector("#servicePublicDescription").value.trim(),homeService:e.querySelector("#serviceHomeToggle").checked,commissionRate:parseFloat(e.querySelector("#serviceCommissionRate").value)||0,active:e.querySelector("#serviceStatusToggle").checked,photo:e.querySelector("#servicePhotoBase64").value,notes:e.querySelector("#serviceNotes").value,commissionType:r,professionalCommissions:o},d=s.innerHTML;s.disabled=!0,s.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{a?(await Gi(a,l),ae(g.establishmentId,tt(),"Serviços","Editou",`Editou o serviço: ${l.name}`),m("Sucesso","Serviço atualizado com sucesso!","success")):(await Ji(l),ae(g.establishmentId,tt(),"Serviços","Criou",`Criou novo serviço: ${l.name}`),m("Sucesso","Serviço adicionado à rede!","success")),document.getElementById("genericModal").style.display="none",await Ae()}catch(c){m("Erro",c.message,"error"),s.disabled=!1,s.innerHTML=d}}function wl(t=null){const e=document.getElementById("genericModal"),a=_.categories||[],s=t?.duration||0,o=t?.bufferTime||0,r=v(t?.name||""),i=v(t?.notes||""),n=v(t?.publicDescription||""),l=t?.id?r:"Novo Serviço",d=t?.color||"#4f46e5",c=t?.loyaltyPoints||0,u=a.map(L=>`<option value="${L.id}" ${t?.categoryId===L.id?"selected":""}>${v(L.name)}</option>`).join(""),p=t?.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(r?r.charAt(0):"S")}`,b=`
        <div class="modal-content max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh]"> 
            ...
            `}).join(""),P.querySelectorAll('input[type="checkbox"]').forEach(L=>{L.addEventListener("change",F=>{const V=F.target.closest(".professional-commission-row");V.querySelector('input[type="number"]').disabled=!F.target.checked,V.classList.toggle("bg-indigo-50/50",F.target.checked),V.classList.toggle("border-indigo-100",F.target.checked),V.classList.toggle("border-transparent",!F.target.checked)})})),S();const N=e.querySelector("#servicePhotoInput"),$=e.querySelector("#servicePhotoButton"),E=e.querySelector("#servicePhotoContainer"),D=e.querySelector("#servicePhotoPreview"),B=e.querySelector("#servicePhotoBase64"),j=()=>N.click();$&&$.addEventListener("click",j),E&&E.addEventListener("click",j),N.onchange=async()=>{const L=N.files[0];if(L){D.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await ba(L,800,800,.8);if(F.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");D.src=F,B.value=F}catch(F){m("Erro de Imagem",F.message,"error"),D.src=p,B.value=t?.photo||""}}};const I=e.querySelector("#serviceForm");e.onclick=async L=>{const F=L.target.closest("button[data-action]");if(!F)return;const V=F.dataset.action,U=F.dataset.id;if(V==="close-modal"&&(e.style.display="none"),V==="save-service"&&I.reportValidity()&&yl({target:I}),V==="delete-service"){if(!U)return;if(await Y("Apagar Serviço","Tem certeza que deseja excluir este serviço da rede?"))try{const W=_.services.find(ne=>ne.id===U)?.name||"Desconhecido";await Lo(U),ae(g.establishmentId,tt(),"Serviços","Excluiu",`Excluiu o serviço: ${W}`),m("Sucesso","Serviço apagado da rede.","success"),e.style.display="none",await Ae()}catch(W){m("Erro",`Não foi possível apagar o serviço: ${W.message}`,"error")}}}}function kl(){Y("Excluir em Lote",`Tem certeza que deseja excluir ${_.selectedIds.size} serviços da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{const e=Array.from(_.selectedIds).map(a=>Lo(a));await Promise.all(e),ae(g.establishmentId,tt(),"Serviços","Excluiu em Lote",`Excluiu ${_.selectedIds.size} serviços`),m("Sucesso",`${_.selectedIds.size} serviços foram excluídos.`,"success"),_.selectedIds.clear(),Ua(),Ae()}catch(e){m("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}const wa="suppliers",Dt=async t=>{try{const e=bo(ua(me,wa),go("establishmentId","==",t)),a=await Hr(e),s=[];return a.forEach(o=>{s.push({id:o.id,...o.data()})}),s}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},$l=async t=>{try{return{id:(await po(ua(me,wa),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},Sl=async(t,e)=>{try{const a=Te(me,wa,t);return await Ct(a,e),{id:t,...e}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},El=async t=>{try{const e=Te(me,wa,t);return await Or(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},xt=document.getElementById("content");let q={products:[],categories:[],suppliers:[],hierarchyCache:[],currentTab:"catalogo",stockFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set},jt=null;function Re(){const t=ge.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function vs(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function La(t){return t?t._seconds?new Date(t._seconds*1e3):t.seconds?new Date(t.seconds*1e3):new Date(t):new Date}async function Il(){q.selectedIds.clear(),q.currentTab="catalogo";try{const t=await fe();q.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}ys(),Cl(),await Ie()}function ys(){xt.innerHTML=`
        <section class="h-full flex flex-col p-2 md:p-4 md:pl-6 w-full relative">
    ...
    `,Ll()}function Ll(){const t=document.getElementById("main-tab-content");if(t){if(q.currentTab==="catalogo")t.innerHTML=`
        ...
        `,ar(),Je();else if(q.currentTab==="movimentacoes"){const e=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0],o=(q.products||[]).map(i=>`<option value="${i.id}">${v(i.name)}</option>`).join(""),r=(q.categories||[]).map(i=>`<option value="${i.id}">${v(i.name)}</option>`).join("");t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",Qa),Qa()}}}function Cl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Ie),t.addEventListener("click",()=>{setTimeout(Ie,100)})),jt&&xt.removeEventListener("click",jt),jt=e=>{const a=e.target.closest("[data-main-tab]");if(a){q.currentTab=a.dataset.mainTab,ys();return}if(e.target.classList.contains("status-filter-btn")){const d=e.target.dataset.status;q.stockFilter=d,document.querySelectorAll(".status-filter-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-green-50","text-green-700","border-green-200","bg-orange-50","text-orange-700","border-orange-200","bg-red-50","text-red-700","border-red-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),d==="ok"?e.target.classList.add("bg-green-50","text-green-700","border-green-200"):d==="alert"?e.target.classList.add("bg-orange-50","text-orange-700","border-orange-200"):d==="empty"?e.target.classList.add("bg-red-50","text-red-700","border-red-200"):e.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),e.target.classList.remove("bg-white","text-gray-600","border-gray-200"),Je();return}const s=e.target.closest('[data-action="open-product-modal"]');if(s){e.preventDefault();let d={};if(s.dataset.product)try{d=JSON.parse(s.dataset.product)}catch{}jl(d);return}if(e.target.closest('[data-action="manage-categories"]')){e.preventDefault(),Al();return}if(e.target.closest('[data-action="open-new-movement-modal"]')){e.preventDefault(),or();return}const i=e.target.closest(".product-checkbox");if(i){const d=i.dataset.id;i.checked?q.selectedIds.add(d):q.selectedIds.delete(d),Wa(),e.stopPropagation();return}if(e.target.closest("#cancel-selection-btn")){q.selectedIds.clear(),document.querySelectorAll(".product-checkbox").forEach(d=>d.checked=!1),Wa();return}if(e.target.closest("#batch-delete-btn")){Nl();return}},xt.addEventListener("click",jt),xt.addEventListener("input",e=>{e.target.id==="searchInput"&&(q.searchQuery=e.target.value.toLowerCase(),Je())}),xt.addEventListener("click",e=>{const a=e.target.closest("#toggle-filter-btn");if(a){const r=document.getElementById("filter-panel");q.isAdvancedFilterOpen=!q.isAdvancedFilterOpen,q.isAdvancedFilterOpen?(r.classList.remove("hidden"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.remove("bg-white","text-gray-600","border-gray-200")):(r.classList.add("hidden"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-gray-600","border-gray-200"))}e.target.closest("#clear-filters-btn")&&(q.filterCategoryId="all",document.getElementById("filterCategoryId").value="all",Je()),e.target.closest("#apply-filter-btn")&&(q.filterCategoryId=document.getElementById("filterCategoryId").value,document.getElementById("toggle-filter-btn").click(),Je())})}async function Ie(){const t=vs();try{const e=t.map(n=>ct(n)),a=t.map(n=>ya(n,"products")),[s,o]=await Promise.all([Promise.all(e),Promise.all(a)]),r=new Map;s.flat().filter(Boolean).forEach(n=>r.set(n.id,n)),q.products=Array.from(r.values()),g.products=q.products;const i=new Map;o.flat().filter(Boolean).forEach(n=>i.set(n.id,n)),q.categories=Array.from(i.values()),g.categories=q.categories,q.currentTab==="catalogo"?(ar(),Je()):q.currentTab==="movimentacoes"&&Qa(),q.suppliers=[],t.forEach(async n=>{try{let l=[];typeof Dt=="function"&&(l=await Dt(n)),l.forEach(d=>{q.suppliers.find(c=>c.id===d.id)||q.suppliers.push(d)}),g.suppliers=q.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function ar(){const t=document.getElementById("filterCategoryId");t&&q.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',q.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),q.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function Wa(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=q.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Dl(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,o=0,r=0;t.forEach(i=>{const n=i.currentStock||0,l=i.minStock||0;n<=0?r++:l>0&&n<=l||l>0&&n<=l*1.2?o++:s++}),e.innerHTML=`
        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
    ...
    `}function Je(){const t=document.getElementById("productsList");if(!t)return;if(!q.products||q.products.length===0){t.innerHTML=sr(8);return}const e=vs(),a=q.products.filter(s=>{const o=s.name.toLowerCase().includes(q.searchQuery),r=s.currentStock||0,i=s.minStock||0;let n=!0;q.stockFilter==="ok"&&(n=r>0&&(i===0||r>i*1.2)),q.stockFilter==="alert"&&(n=i>0&&r>0&&r<=i*1.2),q.stockFilter==="empty"&&(n=r<=0);const l=q.filterCategoryId==="all"||s.categoryId===q.filterCategoryId,d=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||g.establishmentId],c=e.some(u=>d.includes(u));return o&&n&&l&&c});Dl(a),t.innerHTML=Tl(a)}function sr(t=8){let e="";for(let a=0;a<t;a++)e+=`
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm flex items-center p-3 animate-pulse h-[74px]">
        ...
        `;return e}function Tl(t){if(t.length===0)return`
            <div class="col-span-full flex flex-col items-center justify-center py-16">
                <div class="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center mb-3">
        ...
        `;const e=new Map((q.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=v(a.name),o=v(e.get(a.categoryId)||"Sem Categoria"),r=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,i=JSON.stringify(a).replace(/'/g,"&apos;"),n=a.accessibleIn?a.accessibleIn.length:1,l=q.selectedIds.has(a.id),d=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",c=a.currentStock||0,u=a.minStock||0;let p="bg-emerald-500",b=!1;return c<=0?(p="bg-red-500",b=!0):u>0&&c<=u*1.2&&(p="bg-orange-500"),`
            ...
            </div>`}).join("")}async function Pl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const o=e.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const r=q.hierarchyCache.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);r.length===0&&r.push(g.establishmentId),await Zo({establishmentId:g.establishmentId,name:s,accessibleIn:r},"products"),ae(g.establishmentId,Re(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",m("Sucesso","Categoria criada!","success"),await ws(),await Ie()}catch(r){m("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Adicionar"}}async function Bl(t){if(await Y("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Ko(t,"products"),ae(g.establishmentId,Re(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),m("Sucesso","Categoria apagada.","success"),await ws(),await Ie()}catch{m("Erro","Não foi possível apagar a categoria.","error")}}async function ws(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await ya(g.establishmentId,"products");q.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded mb-1">
                    <span class="text-sm font-medium text-gray-700">${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-xs bg-red-50 px-2 py-1 rounded">Apagar</button>
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function Al(){Le({title:"Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4 bg-indigo-50 p-4 rounded-xl border border-indigo-100">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Pl),e.addEventListener("click",s=>{const o=s.target.closest('button[data-action="delete-category"]');o&&(s.preventDefault(),Bl(o.dataset.id))}))}ws()}function or(){const t=(q.products||[]).map(r=>`<option value="${r.id}">${v(r.name)} (Estoque: ${r.currentStock||0})</option>`).join(""),a=`
        ...
        <div class="modal-content max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh]"> 
            ...
            <form id="productForm" class="flex-1 flex flex-col overflow-hidden">
                ...
                `).join("")):(j.classList.remove("hidden"),j.innerHTML='<div class="p-4 text-sm text-gray-500 text-center">Fornecedor não encontrado.</div>')}else j.classList.add("hidden");h.size>0?(I.classList.remove("justify-center"),I.classList.add("justify-start"),I.innerHTML="",h.forEach(V=>{const U=F.find(T=>T.id===V);U&&(I.innerHTML+=`
                    ...
                    `)})):(I.classList.add("justify-center"),I.classList.remove("justify-start"),I.innerHTML='<p class="text-xs text-gray-400 text-center">Nenhum fornecedor adicionado ainda.</p>')};document.getElementById("modalSupplierSearch")?.addEventListener("input",y),y();const S=document.getElementById("productPhotoInput"),P=document.getElementById("productPhotoButton"),N=document.getElementById("productPhotoContainer"),$=document.getElementById("productPhotoPreview"),E=document.getElementById("productPhotoBase64"),D=()=>S?.click();P&&P.addEventListener("click",D),N&&N.addEventListener("click",D),S&&(S.onchange=async()=>{const B=S.files[0];if(!B)return;const j=$.src;$.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const I=await ba(B,800,800,.8);if(I.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");$.src=I,E.value=I}catch(I){m("Erro de Imagem",I.message,"error"),$.src=j,E.value=t?.photo||""}}),e.onclick=async B=>{const j=B.target.closest("[data-add-supplier]");if(j){h.add(j.dataset.addSupplier);const U=document.getElementById("modalSupplierSearch");U&&(U.value=""),y();return}const I=B.target.closest("[data-remove-supplier]");if(I){h.delete(I.dataset.removeSupplier),y();return}const L=B.target.closest("button[data-action]");if(!L)return;const F=L.dataset.action,V=L.dataset.id;if(F==="close-modal"&&(e.style.display="none"),F==="delete-product"){if(!V)return;if(await Y("Apagar Produto","Tem certeza que deseja excluir este produto do catálogo?"))try{const T=q.products.find(W=>W.id===V)?.name||"Desconhecido";await gs(V),ae(g.establishmentId,Re(),"Produtos","Excluiu",`Excluiu o produto: ${T}`),m("Sucesso","Produto apagado.","success"),e.style.display="none",await Ie()}catch(T){m("Erro",`Não foi possível apagar: ${T.message}`,"error")}}F==="open-new-movement-modal"&&(e.style.display="none",q.currentTab="movimentacoes",ys(),or())}}function Nl(){Y("Excluir em Lote",`Tem certeza que deseja excluir ${q.selectedIds.size} produtos da rede?`).then(async t=>{if(t)try{const e=Array.from(q.selectedIds).map(a=>gs(a));await Promise.all(e),ae(g.establishmentId,Re(),"Produtos","Excluiu em Lote",`Excluiu ${q.selectedIds.size} produtos`),m("Sucesso",`${q.selectedIds.size} produtos foram excluídos.`,"success"),q.selectedIds.clear(),Wa(),Ie()}catch(e){m("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}async function Qa(){const t=document.getElementById("report-results");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full"><div class="loader"></div></div>';const e={startDate:document.getElementById("reportStartDate")?.value||"",endDate:document.getElementById("reportEndDate")?.value||"",productId:document.getElementById("productFilterReport")?.value||"all",categoryId:document.getElementById("categoryFilterReport")?.value||"all"};try{const s=vs().map(n=>Ro({...e,establishmentId:n}).catch(l=>[])),o=await Promise.all(s);let r=[];if(o.forEach(n=>{if(!n)return;const l=Array.isArray(n)?n:Array.isArray(n.data)?n.data:Array.isArray(n.movements)?n.movements:[];r=r.concat(l)}),r.sort((n,l)=>La(l.date)-La(n.date)),r.length===0){t.innerHTML=`
                <div class="flex items-center justify-center h-full p-8 text-center">
                    <div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ${r.map(n=>{const l=n.change>0,d=l?"text-emerald-600 bg-emerald-50":"text-red-600 bg-red-50",c=l?'<i class="bi bi-arrow-down-left"></i>':'<i class="bi bi-arrow-up-right"></i>';return`
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 whitespace-nowrap text-gray-500 text-xs">${La(n.date).toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}</td>
    ...
    `}function Hl(){const t=Object.entries(oa).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=rr.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Ol(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(oa).map(([i,n])=>`<option value="${i}" ${a===i?"selected":""}>${n.label}</option>`).join(""),o=rr.map(i=>`<option value="${i}" ${t?.state===i?"selected":""}>${i}</option>`).join(""),r=document.getElementById("form-container-wrapper");r&&(r.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",_l))}function ir(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
    ...
    `,s='<div class="flex flex-col gap-2 md:hidden p-2">';e.forEach(o=>{let r=o.category;r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const i=oa[r]||oa.outros,n=o.document||o.taxId?o.document||o.taxId:"-",l=JSON.stringify(o).replace(/'/g,"&apos;"),d=[o.city,o.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",s+="</div>",t.innerHTML=a+s}function vt(t,e=null){const a=document.getElementById("suppliers-list-view"),s=document.getElementById("suppliers-form-view");Q.viewMode=t,Q.editingItem=e,t==="list"?(a.classList.remove("hidden"),a.classList.add("flex"),s.classList.add("hidden"),s.innerHTML='<div id="form-container-wrapper" class="max-w-4xl mx-auto w-full"></div>',Q.hasSearched&&nr(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),a.classList.remove("flex"),s.classList.remove("hidden"),Ol(e),window.scrollTo({top:0,behavior:"smooth"}))}async function _l(t){t.preventDefault();const e=t.target,a=e.querySelector("#supId").value,s={name:e.querySelector("#supName").value,contactName:e.querySelector("#supContact").value,email:e.querySelector("#supEmail").value,phone:e.querySelector("#supPhone").value,document:e.querySelector("#supTaxId").value,category:e.querySelector("#supCategory").value,state:e.querySelector("#supState").value,city:e.querySelector("#supCity").value,establishmentId:g.establishmentId,notes:e.querySelector("#supNotes")?.value||"",accessibleIn:[g.establishmentId]},o=e.querySelector('button[type="submit"]'),r=o.innerHTML;o.disabled=!0,o.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await Sl(a,s),m("Sucesso","Ficha atualizada!","success")):(await $l(s),m("Sucesso","Parceiro registado!","success")),Q.hasSearched&&(Q.partners=await Dt(g.establishmentId)||[]),vt("list")}catch(i){m("Erro","Falha ao gravar: "+i.message,"error"),o.disabled=!1,o.innerHTML=r}}async function Vl(t){if(await Y("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente?"))try{await El(t),m("Sucesso","Entidade excluída.","success"),Q.partners=Q.partners.filter(a=>a.id!==t),vt("list")}catch(a){m("Erro","Erro ao excluir: "+a.message,"error")}}function Ul(){Nt&&Xt.removeEventListener("click",Nt),Nt=async t=>{const e=t.target;if(e.closest('button[data-action="new-partner"]')){vt("form",null);return}if(e.closest("#btn-search-partners")){Q.searchQuery=document.getElementById("filterSearch").value,Q.categoryFilter=document.getElementById("filterCategory").value,Q.stateFilter=document.getElementById("filterState").value,Q.cityFilter=document.getElementById("filterCity").value,Q.sortBy=document.getElementById("filterSortBy").value,Q.hasSearched=!0,zl();return}if(e.closest('button[data-action="back-to-list"]')){vt("list");return}const a=e.closest('button[data-action="delete-partner"]');if(a){t.preventDefault(),Vl(a.dataset.id);return}const s=e.closest('[data-action="open-form"]');if(s&&!e.closest("button")){const o=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));vt("form",o)}},Xt.addEventListener("click",Nt),Xt.addEventListener("keypress",t=>{t.key==="Enter"&&(t.target.id==="filterSearch"||t.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const Ja=document.getElementById("content"),zs={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let O={professionals:[],services:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterServiceId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,viewMode:"list",tempProf:null},Rt=null,Ft=null;function Yt(){const t=ge.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function lr(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function Wl(){const t=document.getElementById("professionals-layout-main"),e=document.getElementById("professionals-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.add("mobile-detail-open"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&(a.style.display="none")}function Ca(){const t=document.getElementById("professionals-layout-main"),e=document.getElementById("professionals-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.remove("mobile-detail-open"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&(a.style.display=""),O.viewMode="list"}async function Ql(){O.selectedIds.clear(),O.viewMode="list";try{const t=await fe();O.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}dr(),ad(),await ra()}function dr(){Ja.innerHTML=`
    ...
    `}async function ra(){const t=document.getElementById("professionalsList"),e=lr();try{const a=e.map(l=>ke(l)),s=e.map(l=>dt(l)),o=await Promise.all(a),r=await Promise.all(s),i=new Map;o.flat().forEach(l=>i.set(l.id,l)),O.professionals=Array.from(i.values()),g.professionals=O.professionals;const n=new Map;r.flat().forEach(l=>n.set(l.id,l)),O.services=Array.from(n.values()),cr(),We()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function cr(){const t=document.getElementById("filterServiceId");t&&O.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',O.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),O.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function ur(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=O.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Jl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(r=>r.status!=="inactive").length,o=a-s;e.innerHTML=`
    ...
    `}function We(){const t=document.getElementById("professionalsList");if(!t)return;if(!O.professionals||O.professionals.length===0){t.innerHTML=pr(8);return}const e=lr(),a=O.professionals.filter(s=>{const o=s.name.toLowerCase().includes(O.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(O.searchQuery);let r=!0;O.statusFilter==="active"&&(r=s.status!=="inactive"),O.statusFilter==="inactive"&&(r=s.status==="inactive");const i=O.filterServiceId==="all"||s.services&&s.services.includes(O.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||g.establishmentId],l=e.some(d=>n.includes(d));return o&&r&&i&&l});if(Jl(a),a.length===0){t.innerHTML=`
    ...
    `,Xl(a,O.services),Zl(a),await ed(a,O.professionals),td(a),Wl()}function Xl(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const o=t.dob?t.dob.split("/"):["",""],r=Array.from({length:12},(c,u)=>{const p=u+1,b=p==o[1]?"selected":"",f=new Date(0,u).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${f.charAt(0).toUpperCase()+f.slice(1)}</option>`}).join(""),i=v(t.name||""),n=v(t.specialty||""),l=v(t.phone||""),d=v(t.notes||"");a.innerHTML=`
    ...
    `}function Yl(t=[]){if(!O.hierarchyCache||O.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${g.establishmentId}">
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const r=t.includes(o.id)||t.length===0&&o.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function Zl(t){const e=document.getElementById("jornada");e&&(e.innerHTML=`
        ...
        </div>`,Kl(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function Kl(t,e){t.innerHTML=Object.keys(zs).map(a=>{const s=e[a]||{},o=s.active!==!1;return`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-[10px] font-bold text-red-500 p-4 bg-red-50 rounded-xl border border-red-100">${s.message}</p>`}}}function td(t){const e=document.getElementById("professionals-layout-detail");if(!e)return;const a=e.querySelectorAll(".tab-link");a.forEach(p=>{p.addEventListener("click",b=>{b.preventDefault(),a.forEach(y=>{y.classList.remove("active","border-indigo-600","text-indigo-600"),y.classList.add("border-transparent","text-slate-500")}),p.classList.add("active","border-indigo-600","text-indigo-600"),p.classList.remove("border-transparent","text-slate-500"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.add("hidden"));const f=p.dataset.tab,h=e.querySelector("#"+f);h&&h.classList.remove("hidden")})});const s=e.querySelector("#profPhotoInput"),o=e.querySelector("#profPhotoButton"),r=e.querySelector("#profPhotoContainer"),i=e.querySelector("#profPhotoPreview"),n=e.querySelector("#profPhotoBase64"),l=t.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,d=t.photo||"",c=()=>s.click();o&&o.addEventListener("click",c),r&&r.addEventListener("click",c),s&&(s.onchange=async()=>{const p=s.files[0];if(p){i.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const b=await ba(p,800,800,.8);if(b.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");i.src=b,n.value=b}catch(b){m("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),i.src=l,n.value=d,s.value=""}}});const u=e.querySelector("#selectAllServicesBtn");if(u){u.addEventListener("click",()=>{const b=e.querySelectorAll('#profServicesContainer input[type="checkbox"]'),f=Array.from(b).every(h=>h.checked);b.forEach(h=>{h.checked=!f}),u.textContent=f?"Selecionar Todos":"Desmarcar Todos"});const p=e.querySelectorAll('#profServicesContainer input[type="checkbox"]');p.length>0&&Array.from(p).every(b=>b.checked)&&(u.textContent="Desmarcar Todos")}}function ad(){Rt&&document.body.removeEventListener("click",Rt),Ft&&Ja.removeEventListener("input",Ft),Rt=async t=>{if(t.target.classList.contains("professional-checkbox")){const r=t.target.dataset.id;t.target.checked?O.selectedIds.add(r):O.selectedIds.delete(r),ur(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){O.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-indigo-600","text-white","border-indigo-600"),r.classList.add("bg-white","text-slate-600","border-slate-200")}),e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600"),We();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterServiceId").value="all",O.filterServiceId="all",We();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),O.filterServiceId=document.getElementById("filterServiceId").value,We();return}if(t.target.closest("#toggle-filter-btn")){t.preventDefault(),O.isAdvancedFilterOpen=!O.isAdvancedFilterOpen,dr(),document.getElementById("searchInput").value=O.searchQuery,cr(),We();return}const s=t.target.closest("[data-action]");if(!s)return;const o=s.dataset.action;switch(["close-detail-screen","delete-professional","save-professional","delete-blockage","batch-delete-blockage"].includes(o)&&t.stopPropagation(),o){case"open-professional-editor":Gl(s.dataset.id);break;case"close-detail-screen":Ca(),O.tempProf=null;break;case"batch-delete":sd();break;case"delete-professional":{const r=s.dataset.id,i=O.tempProf?.name||"Profissional";if(await Y("Excluir Profissional",`Tem certeza que deseja excluir ${i}? Esta ação não pode ser desfeita.`))try{await xo(r),ae(g.establishmentId,Yt(),"Equipe","Excluiu",`Excluiu profissional: ${i}`),m("Sucesso!","Profissional excluído da rede.","success"),Ca(),ra()}catch(l){m("Erro",`Não foi possível excluir: ${l.message}`,"error")}break}case"save-professional":{const r=document.getElementById("professionals-layout-detail"),i=s,n=r.querySelector("#profScheduleContainer"),l=Array.from(r.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map(S=>S.value),d={};n&&n.querySelectorAll(".day-schedule-card").forEach(S=>{const P=S.querySelector('[data-field="active"]').dataset.day;d[P]={active:S.querySelector('[data-field="active"]').checked,start:S.querySelector('[data-field="start"]').value,end:S.querySelector('[data-field="end"]').value,breakStart:S.querySelector('[data-field="breakStart"]').value,breakEnd:S.querySelector('[data-field="breakEnd"]').value}});const c=Array.from(r.querySelectorAll('input[name="accessibleIn"]:checked')).map(S=>S.value),u=c.length>0?c:[g.establishmentId],p=r.querySelector("#profStatusToggle").checked,b=r.querySelector("#profCommissionToggle").checked,f=r.querySelector("#profShowOnAgendaToggle").checked,h={...O.tempProf,id:r.querySelector("#professionalId").value||void 0,accessibleIn:u,name:r.querySelector("#profName").value.trim(),specialty:r.querySelector("#profSpecialty").value,photo:r.querySelector("#profPhotoBase64").value,services:l,workingHours:d,phone:r.querySelector("#profPhone").value,dob:`${r.querySelector("#profDobDay").value}/${r.querySelector("#profDobMonth").value}`,receivesCommission:b,showOnAgenda:f,orderOnAgenda:parseInt(r.querySelector("#profOrderOnAgenda").value)||1,notes:r.querySelector("#profNotes").value,status:p?"active":"inactive",establishmentId:g.establishmentId},y=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{h.id?(await qa(h.id,h),ae(g.establishmentId,Yt(),"Equipe","Editou",`Editou o profissional: ${h.name}`),m("Sucesso!","Dados atualizados.","success")):(delete h.id,await gi(h),ae(g.establishmentId,Yt(),"Equipe","Criou",`Cadastrou o profissional: ${h.name}`),m("Sucesso!","Novo membro adicionado à equipe.","success")),Ca(),ra()}catch(S){m("Erro",S.message,"error"),i.disabled=!1,i.innerHTML=y}break}case"delete-blockage":{const r=s.dataset.id;if(await Y("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await us(r),m("Bloqueio removido.","success");const i=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";yt(O.tempProf.id,i)}catch(i){m("Erro",i.message,"error")}break}case"batch-delete-blockage":{const r=JSON.parse(s.dataset.ids);if(await Y("Apagar em Lote",`Tem certeza que deseja apagar ${r.length} dias de bloqueio de uma vez?`))try{await Co(r),m("Bloqueios removidos.","success");const i=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";yt(O.tempProf.id,i)}catch(i){m("Erro",i.message,"error")}break}}},document.body.addEventListener("click",Rt),Ft=t=>{t.target.id==="searchInput"&&(O.searchQuery=t.target.value,We())},Ja.addEventListener("input",Ft)}function sd(){Y("Excluir em Lote",`Tem certeza que deseja excluir ${O.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await mi(Array.from(O.selectedIds)),ae(g.establishmentId,Yt(),"Equipe","Excluiu em Lote",`Excluiu ${O.selectedIds.size} profissionais`),m("Sucesso!",`${O.selectedIds.size} profissionais foram excluídos.`,"success"),O.selectedIds.clear(),ur(),ra()}catch(e){m("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}let k={clients:[],selectedClient:null,activeTab:"profile",establishments:[],filterEstablishmentIds:new Set,filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},ia=null,Ht=null;const br=t=>t?String(t).replace(/\D/g,""):"",Ga=t=>{if(!t)return"Nunca";let e;if(typeof t=="object"&&(t.seconds||t._seconds)){const a=t.seconds||t._seconds;e=new Date(a*1e3)}else e=new Date(t);return isNaN(e.getTime())?"Data Inválida":e.toLocaleDateString("pt-BR")},Xa=t=>{if(!t)return"CL";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()};async function od(){ia=document.getElementById("content"),k.selectedClient=null,k.historyLimit=20,k.modalOpen=!1,k.selectedIds.clear(),k.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},k.sortConfig={key:"name",direction:"asc"};try{const e=(await fe().catch(()=>({matrizes:[]}))).matrizes||[];k.establishments=[],e.forEach(a=>{k.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>k.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),k.filterEstablishmentIds.size===0&&k.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia",t)}rd(),nd(),await ks()}function rd(){const t=k.establishments.map(e=>`
    ...
    `}function id(){const t=document.getElementById("table-header-container");if(!t)return;const e=a=>k.sortConfig.key!==a?'<i class="bi bi-arrow-down-up ml-1 opacity-40 text-xs"></i>':k.sortConfig.direction==="asc"?'<i class="bi bi-arrow-up ml-1 text-indigo-600"></i>':'<i class="bi bi-arrow-down ml-1 text-indigo-600"></i>';t.innerHTML=`
    ...
    `}async function ks(){k.loading=!0;const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-xs">Carregando clientes...</p></div>');try{const a=Array.from(k.filterEstablishmentIds).map(i=>{let n=`/api/clients/${i}?limit=1000`;return C(n).catch(()=>[])}),o=(await Promise.all(a)).flat(),r=new Map;o.forEach(i=>r.set(i.id,i)),k.clients=Array.from(r.values()),$s(),ve()}catch(e){console.error(e),m("Erro","Falha ao carregar clientes.","error"),t&&(t.innerHTML='<div class="text-center py-10 text-red-500 text-sm">Erro ao carregar dados.</div>')}finally{k.loading=!1}}function $s(){const t=new Date().getMonth()+1,e=new Date().getFullYear();let a=0,s=0,o=0;k.clients.forEach(r=>{if(r.totalDebt&&parseFloat(r.totalDebt)>0&&s++,r.dobMonth==t&&o++,r.createdAt){const i=new Date(r.createdAt);i.getMonth()+1===t&&i.getFullYear()===e&&a++}}),document.getElementById("kpi-total").textContent=k.clients.length,document.getElementById("kpi-novos").textContent=a,document.getElementById("kpi-devendo").textContent=s,document.getElementById("kpi-niver").textContent=o}function ve(){id();const t=document.getElementById("list-container");let e=k.clients;if(k.filters.search){const a=k.filters.search.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(k.filters.status==="devendo")e=e.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(k.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;e=e.filter(s=>s.dobMonth==a)}else if(k.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();e=e.filter(o=>{if(!o.createdAt)return!1;const r=new Date(o.createdAt);return r.getMonth()+1===a&&r.getFullYear()===s})}if(k.filters.hasLoyalty&&(e=e.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),k.filters.inactiveDays){const a=parseInt(k.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),e=e.filter(o=>{if(!o.lastVisit&&!o.createdAt)return!1;let r;if(o.lastVisit){const i=o.lastVisit.seconds||o.lastVisit._seconds;r=i?new Date(i*1e3):new Date(o.lastVisit)}else r=new Date(o.createdAt);return r<s})}if(e.sort((a,s)=>{let o,r;switch(k.sortConfig.key){case"name":return o=(a.name||"").toLowerCase(),r=(s.name||"").toLowerCase(),k.sortConfig.direction==="asc"?o.localeCompare(r):r.localeCompare(o);case"contact":return o=a.phone||"",r=s.phone||"",k.sortConfig.direction==="asc"?o.localeCompare(r):r.localeCompare(o);case"lastVisit":o=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,r=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":o=parseFloat(a.totalDebt)||0,r=parseFloat(s.totalDebt)||0;break;default:o=a.name,r=s.name}return o<r?k.sortConfig.direction==="asc"?-1:1:o>r?k.sortConfig.direction==="asc"?1:-1:0}),e.length===0){t.innerHTML=`
            ...
            </div>`;return}t.innerHTML=e.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,o=Ga(a.lastVisit),r=br(a.phone),i=new Date().getMonth()+1,n=a.dobMonth==i,l=k.selectedIds.has(a.id);let d="";return n&&(d+='<span class="bg-indigo-50 text-indigo-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-indigo-100 uppercase tracking-wider">🎂 Niver</span> '),a.loyaltyPoints>0&&(d+=`<span class="bg-amber-50 text-amber-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-amber-100 uppercase tracking-wider"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
        ...
        `}).join("")}function nd(){Ht&&ia.removeEventListener("click",Ht),Ht=r=>{const i=r.target;if(i.classList.contains("item-checkbox")){const c=i.value;i.checked?k.selectedIds.add(c):k.selectedIds.delete(c),Zt(),r.stopPropagation();return}if(i.id==="select-all-toggle"){const c=i.checked,u=document.querySelectorAll(".item-checkbox");k.selectedIds.clear(),u.forEach(p=>{p.checked=c,c&&k.selectedIds.add(p.value)}),Zt(),r.stopPropagation();return}const n=i.closest("[data-sort]");if(n){const c=n.dataset.sort;k.sortConfig.key===c?k.sortConfig.direction=k.sortConfig.direction==="asc"?"desc":"asc":(k.sortConfig.key=c,k.sortConfig.direction="asc"),ve();return}const l=i.closest("[data-action]");if(l){const c=l.dataset.action,u=l.dataset.id;if(c==="new-client"){Ya(null);return}if(c==="open-modal"){Ya(u);return}if(c==="whatsapp"){r.stopPropagation();const p=l.dataset.phone;window.open(`https://wa.me/55${p}`,"_blank");return}if(c==="export-excel"){xd();return}}const d=i.closest("[data-filter]");d&&(document.querySelectorAll("[data-filter]").forEach(c=>c.classList.remove("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300")),d.classList.add("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300"),k.filters.status=d.dataset.filter,ve())},ia.addEventListener("click",Ht);const t=document.getElementById("cancel-selection-btn");t&&t.addEventListener("click",()=>{k.selectedIds.clear();const r=document.getElementById("select-all-toggle");r&&(r.checked=!1),document.querySelectorAll(".item-checkbox").forEach(i=>i.checked=!1),Zt()});const e=document.getElementById("batch-delete-btn");e&&e.addEventListener("click",ld),document.querySelectorAll(".est-filter-checkbox").forEach(r=>{r.addEventListener("change",i=>{const n=i.target.closest("label");i.target.checked?(k.filterEstablishmentIds.add(i.target.value),n.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.remove("border-gray-200","text-gray-600")):(k.filterEstablishmentIds.delete(i.target.value),n.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.add("border-gray-200","text-gray-600")),ks()})});const a=document.getElementById("search-input");a&&a.addEventListener("input",r=>{k.filters.search=r.target.value,ve()});const s=document.getElementById("filter-inactive");s&&s.addEventListener("input",r=>{k.filters.inactiveDays=r.target.value,ve()});const o=document.getElementById("filter-loyalty");o&&o.addEventListener("change",r=>{k.filters.hasLoyalty=r.target.checked,ve()})}function Zt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count");if(!t||!e)return;const a=k.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}async function ld(){const t=k.selectedIds.size;if(!(t===0||!await Y("Excluir Clientes",`Deseja realmente excluir permanentemente ${t} cliente(s)? Esta ação não pode ser desfeita.`)))try{const a=Array.from(k.selectedIds).map(o=>Io(o));await Promise.all(a),m("Sucesso",`${t} cliente(s) excluído(s) com sucesso.`,"success"),k.selectedIds.clear(),Zt();const s=document.getElementById("select-all-toggle");s&&(s.checked=!1),await ks()}catch{m("Erro ao Excluir","Ocorreu um erro ao excluir alguns clientes.","error")}}function Ya(t=null){t?(k.selectedClient=k.clients.find(s=>s.id===t),k.selectedClient.isNew=!1):k.selectedClient={isNew:!0,id:"",name:"",phone:"",email:"",cpf:"",gender:"",dobDay:"",dobMonth:"",source:"",notes:"",loyaltyPoints:0,totalDebt:0},k.activeTab="profile",k.historyData={appointments:[],sales:[],loyaltyLog:[]};let e=document.getElementById("client-details-modal-overlay");e||(e=document.createElement("div"),e.id="client-details-modal-overlay",e.className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-gray-900/60 backdrop-blur-sm sm:p-4 animate-fade-in",e.innerHTML='<div class="bg-gray-50 w-full sm:w-[90vw] h-[90vh] sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col relative animate-slide-up sm:animate-scale-in rounded-t-2xl" id="client-modal-content"></div>',e.onclick=s=>{s.target===e&&wt()},document.body.appendChild(e),document.body.classList.add("overflow-hidden"));const a=e.querySelector("#client-modal-content");a.innerHTML=at(k.selectedClient),st(a,k.selectedClient)}function wt(){const t=document.getElementById("client-details-modal-overlay");t&&t.remove(),document.body.classList.remove("overflow-hidden"),k.modalOpen=!1,k.selectedClient=null,ve()}function at(t){const e=t.isNew,a=`
    ...
    `;let s="";return k.activeTab==="profile"?s=dd(t):k.activeTab==="appointments"?s=cd():k.activeTab==="history"?s=ud():k.activeTab==="loyalty"&&(s=pd(t)),`
            ...
            <div class="bg-indigo-600 px-4 py-4 sm:px-6 sm:py-5 text-white relative flex-shrink-0 w-full shadow-md z-20">
                ...
                <div class="flex items-center gap-4 sm:gap-5">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white text-indigo-600 flex items-center justify-center text-2xl font-black shadow-lg flex-shrink-0">
                        ${e?'<i class="bi bi-person-plus-fill"></i>':Xa(t.name)}
                    </div>
    ...
    `}function cd(t){let e=k.historyData.appointments||[];return e.sort((a,s)=>new Date(s.startTime)-new Date(a.startTime)),`
        <div class="space-y-2">
    ...
    `}function ud(t){let e=k.historyData.sales||[];e.sort((o,r)=>new Date(r.date)-new Date(o.date));const a=e.reduce((o,r)=>o+(Number(r.totalAmount)||0),0),s=e.length>0?a/e.length:0;return`
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-3 mb-2">
                <div class="bg-emerald-50 p-3 rounded-xl border border-emerald-100 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-emerald-700 mt-0.5">${Sa(a)}</span>
                </div>
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-gray-800 mt-0.5">${Sa(s)}</span>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-3 flex justify-between items-center shadow-sm hover:bg-gray-50 cursor-pointer transition-colors" data-go-comanda="true" data-id="${o.id}">
                    ...
                    <div class="text-right">
                        <p class="font-black text-emerald-600 text-xs">${Sa(o.totalAmount)}</p>
    ...
    `}function pd(t){const e=k.historyData.loyaltyLog||[];return e.sort((a,s)=>new Date(s.date)-new Date(a.date)),`
        <div class="space-y-4">
    ...
    `}function st(t,e){if(t.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const o=s.dataset.tab;if(k.activeTab===o)return;k.activeTab=o;const r=document.getElementById("client-modal-content");r&&(r.innerHTML=at(e),st(r,e)),o!=="profile"&&!k.historyLoading&&k.historyData.appointments.length===0&&await bd(e.id)}}),k.activeTab==="profile"){const s=t.querySelector("#form-edit-client");s&&(s.onsubmit=gd);const o=t.querySelector("#btn-delete-client");o&&(o.onclick=md)}if(k.activeTab==="loyalty"){const s=t.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>fd(e))}t.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=()=>{wt(),ee("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),t.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=()=>{wt(),ee("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const a=t.querySelector("#btn-close-modal");a&&(a.onclick=wt)}async function bd(t){const e=k.selectedClient;if(!e||!e.phone)return;k.historyLoading=!0;const a=document.getElementById("client-modal-content");a&&(a.innerHTML=at(e),st(a,e));try{const s=new Date;s.setMonth(s.getMonth()+12);const o=new Date;o.setFullYear(o.getFullYear()-5);let r=`/api/appointments/${g.establishmentId}?startDate=${o.toISOString()}&endDate=${s.toISOString()}&clientPhone=${encodeURIComponent(br(e.phone))}&limit=50`;const i=await C(r);k.historyData.appointments=i,k.historyData.sales=i.filter(l=>l.status==="completed").map(l=>({id:l.id,date:l.startTime,totalAmount:l.totalAmount||0,items:l.comandaItems||l.services||[]}));const n=[];i.forEach(l=>{l.status==="completed"&&l.loyaltyPointsEarned>0&&n.push({type:"earn",points:l.loyaltyPointsEarned,date:l.startTime,description:"Venda finalizada"}),l.loyaltyRedemption&&n.push({type:"redemption",points:l.loyaltyRedemption.cost||0,date:l.startTime,description:`Resgate: ${l.loyaltyRedemption.name}`})}),k.historyData.loyaltyLog=n}catch(s){console.error("Erro histórico",s)}finally{k.historyLoading=!1;const s=document.getElementById("client-modal-content");s&&k.selectedClient&&(s.innerHTML=at(k.selectedClient),st(s,k.selectedClient))}}async function gd(t){t.preventDefault();const e=new FormData(t.target),a=Object.fromEntries(e.entries());a.establishmentId=g.establishmentId,a.dobDay&&(a.dobDay=parseInt(a.dobDay)),a.dobMonth&&(a.dobMonth=parseInt(a.dobMonth));try{if(k.selectedClient.isNew){const s=await So(a);k.clients.unshift(s),m("Sucesso","Cliente cadastrado com sucesso!","success"),k.selectedClient=s,Ya(s.id)}else{await Eo(k.selectedClient.id,a),Object.assign(k.selectedClient,a);const s=k.clients.findIndex(r=>r.id===k.selectedClient.id);s!==-1&&(k.clients[s]=k.selectedClient),m("Sucesso","Dados salvos com sucesso!","success");const o=document.getElementById("client-modal-content");o&&(o.innerHTML=at(k.selectedClient),st(o,k.selectedClient))}$s(),ve()}catch(s){m("Erro",s.message,"error")}}async function md(){if(await Y("Excluir Cliente","Tem certeza? O histórico será apagado e não pode ser desfeito."))try{await Io(k.selectedClient.id),k.clients=k.clients.filter(t=>t.id!==k.selectedClient.id),k.selectedClient=null,m("Sucesso","Cliente removido com sucesso.","success"),wt(),$s(),ve()}catch(t){m("Erro",t.message,"error")}}function fd(t){const e=t.loyaltyPoints||0,a=`
    ...
    `,e.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const s=e.querySelector("#newPassword").value,o=e.querySelector("#confirmPassword").value;if(s!==o){m("Erro","As senhas não coincidem.","error");return}const r=e.querySelector('button[form="change-password-form"]');r.disabled=!0,r.textContent="A Salvar...";try{const i=ge.currentUser;if(i)await Ar(i,s),m("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum utilizador logado encontrado.")}catch(i){m("Erro",`Não foi possível alterar a senha: ${i.message}`,"error")}finally{r.disabled=!1,r.textContent="Salvar Nova Senha"}})}function yd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=e.querySelector("#establishmentTimezone");t.timezone&&(a.value=t.timezone);const s=e.querySelector("#establishmentWorkingHoursContainer"),o=t.workingHours||{};Object.keys(Da).forEach(r=>{const i=o[r]||{},n=Da[r],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",r=>{const i=r.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),e.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const i={};Object.keys(Da).forEach(l=>{i[l]={active:e.querySelector(`#est-${l}-active`).checked,start:e.querySelector(`#est-${l}-start`).value,end:e.querySelector(`#est-${l}-end`).value,breakStart:e.querySelector(`#est-${l}-breakStart`).value,breakEnd:e.querySelector(`#est-${l}-breakEnd`).value}});const n=e.querySelector("#establishmentTimezone").value;ut({workingHours:i,timezone:n},r)})}function mr(t,e){const a=!!t.whatsappInstance;e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;try{const[a,s]=await Promise.all([xa(te),fs(te)]),o=t.financialIntegration||{},r=t.commissionConfig||{},i=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=ze(a,o.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=ze(s,o.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=ze(a,i.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=ze(s,i.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=ze(a,r.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=ze(s,r.defaultCostCenterId)}catch{m("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};ut(s,a)})}function Id(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `}function Ld(t,e){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${t.name})`;e.innerHTML=`
    ...
    `,Ne.querySelector('button[data-action="back-to-menu"]').addEventListener("click",o=>{o.preventDefault(),fr({id:te})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":hd(Z,s);break;case"change-password":vd(Z,s);break;case"change-email":yd(Z,s);break;case"branding":wd(Z,s);break;case"booking":kd(Z,s);break;case"working-hours":$d(Z,s);break;case"whatsapp-bot":mr(Z,s);break;case"loyalty":await Sd(Z,s);break;case"financial":await Ed(Z,s);break;case"support":Id(Z,s);break;case"cancellation":Ld(Z,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function fr(t={}){Ne.innerHTML=`
    ...
    `;try{te=t.id||g.establishmentId,Z=await Pe(te);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=Z.isMatriz||!Z.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=gr();Ne.innerHTML=`
        ...
        `,Ne.querySelectorAll("div[data-section]").forEach(o=>{o.addEventListener("click",r=>{Dd(o.dataset.section)})}),Ne.querySelectorAll(".module-toggle").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.module;try{const n={...(await Pe(te)).modules,[r]:o.checked};await ds(te,{modules:n}),m("Módulos","Módulos atualizados com sucesso.","success")}catch(i){o.checked=!o.checked,m("Erro",i.message,"error")}})})}catch(e){Ne.innerHTML=`
    ...
    `).join("")}const kt=document.getElementById("content");async function Ye(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,o=await ga(g.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),r=document.getElementById("filterReason")?.value.toLowerCase(),i=r?o.filter(l=>l.reason&&l.reason.toLowerCase().includes(r)):o,n=i.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(e.innerHTML="",i.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;c.innerHTML+=N}),e.appendChild(c)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Pd(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,o=e.querySelector("#blockageEndDate").value||s,r=e.querySelector("#blockageStartTime").value,i=e.querySelector("#blockageEndTime").value,n={establishmentId:g.establishmentId,professionalId:a,startTime:new Date(`${s}T${r}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await ma(n),e.reset(),m("Sucesso","Bloqueio adicionado com sucesso!","success"),Ye(a)}catch(l){m("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Bd(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return m("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,o=e.querySelector("#batchBlockageEndDate").value||s,r=e.querySelector("#batchBlockageStartTime").value,i=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:g.establishmentId,professionalId:c,startTime:new Date(`${s}T${r}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:n};return ma(u)});try{await Promise.all(d),m("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Ye(c)}catch(c){m("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Ad(t){kt.addEventListener("submit",e=>{e.target.id==="blockageForm"&&Pd(e),e.target.id==="batchBlockageForm"&&Bd(e)}),kt.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Ye(t)}),kt.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")ee("profissionais-section");else if(s==="delete-blockage"){if(await Y("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await us(a.dataset.id),m("Sucesso","Bloqueio removido.","success"),Ye(t)}catch(r){m("Erro",`Não foi possível remover o bloqueio: ${r.message}`,"error")}}else if(s==="batch-delete-blockage"){const o=JSON.parse(a.dataset.ids);if(await Y("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await Co(o),m("Sucesso",`${o.length} bloqueios removidos.`,"success"),Ye(t)}catch(i){m("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function Md(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){kt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);kt.innerHTML=`
        <section>
        ...
        </section>`,Ad(e),await Ye(e);const o=document.getElementById("batchProfSelectionContainer");try{const r=await ke(g.establishmentId);o.innerHTML=r.map(i=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{o.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const qd=t=>C(`/api/users/${t}`),jd=t=>C("/api/users",{method:"POST",body:JSON.stringify(t)}),Nd=(t,e)=>C(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),Rd=t=>C(`/api/users/${t}`,{method:"DELETE"}),Fd=(t,e)=>C(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),Hd=(t,e)=>C(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),pt=document.getElementById("content"),Od={"Operação & Atendimento":{"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas","ausencias-section":"Ausências e Bloqueios"},"Financeiro & Vendas":{"financial-section":"Financeiro (ERP)","sales-report-section":"Relatório de Vendas","commissions-section":"Comissões","packages-section":"Planos e Pacotes"},"Cadastros Base":{"clientes-section":"Clientes","profissionais-section":"Profissionais","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores"},Administração:{"relatorios-section":"Relatórios Gerais","estabelecimento-section":"Configurações da Empresa","users-section":"Usuários e Acessos"}},zd={view:"Visualizar",create:"Criar",edit:"Editar"},Vs={owner:{label:"Proprietário",color:"bg-rose-100 text-rose-700 border-rose-200"},group_admin:{label:"Admin da Rede",color:"bg-purple-100 text-purple-700 border-purple-200"},company_admin:{label:"Gestor Matriz",color:"bg-blue-100 text-blue-700 border-blue-200"},branch_manager:{label:"Gestor Filial",color:"bg-orange-100 text-orange-700 border-orange-200"},professional:{label:"Profissional",color:"bg-slate-100 text-slate-600 border-slate-200"}};let Ot=null,zt=null,Ze=null;function xr(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function _d(t){const e=document.getElementById("usersListContainer");if(!e)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const s=a?"Nenhum usuário encontrado na base.":"Nenhum usuário ativo neste contexto.";e.innerHTML=`
        ...
        `}).join("")}function hr(){const e=document.getElementById("showInactiveUsersToggle")?.checked?g.users:g.users.filter(a=>a.status==="active");_d(e)}function Vd(t={}){let e="",a=!1;for(const[s,o]of Object.entries(Od)){const r=Object.entries(o).filter(([i,n])=>{const l=i.replace("-section","");return!(g.enabledModules&&g.enabledModules[l]===!1)});r.length!==0&&(a=!0,e+=`
        ...
        `,r.forEach(([i,n])=>{const l=i==="agenda-section"||i==="comandas-section",d=t[i]?.view_all_prof===!0,c=Object.entries(zd).map(([p,b])=>`
        ...
        `}),o+="</div>",o}async function Ws(t=null){document.getElementById("user-list-view").classList.add("hidden");const e=document.getElementById("user-form-view");e.classList.remove("hidden");let a=g.professionals;if(!a||a.length===0)try{const p=xr().map(h=>ke(h)),b=await Promise.all(p),f=new Map;b.flat().forEach(h=>f.set(h.id,h)),a=Array.from(f.values()),g.professionals=a}catch(u){console.warn("Profissionais não carregados",u)}if(["owner","group_admin","company_admin"].includes(g.userRole)&&!Ze)try{const u=await fe();u&&(Ze=u)}catch(u){console.error("Falha ao buscar hierarquia",u),Ze={companies:[],branches:[]}}const s=t!==null,o=s&&t.role==="owner",r=e.querySelector("#userFormTitle");r.innerHTML=s?`<i class="bi bi-person-lines-fill mr-2 text-indigo-600"></i>Editar Perfil: ${t.name}`:'<i class="bi bi-person-plus-fill mr-2 text-indigo-600"></i>Novo Acesso';const i=e.querySelector("#userForm");i.innerHTML=`
    ...
    `,e.style.display="flex"}function Gd(t){const{summary:e,transactions:a}=t;document.getElementById("summary-revenue").textContent=`R$ ${e.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=e.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${e.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),o=Object.entries(e.paymentMethodTotals).sort(([,n],[,l])=>l-n);s.innerHTML=o.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),r.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=Za.transactions[l];d&&Js(d)})}),i.innerHTML=a.map((n,l)=>{const d=v(n.client),c=v(n.items),u=v(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=Za.transactions[l];d&&Js(d)})})}async function Gs(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,o=a.value;if(!s||!o)return m("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,i=await ta({establishmentId:g.establishmentId,startDate:s,endDate:o,cashierSessionId:r});Za=i,t.innerHTML=`
        ...
        `,Gd(i)}catch(r){m("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${v(r.message)}</p>`}}async function Xd(){Qd();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];Wd.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Gs),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${s}_a_${o}`;Jd(r,"transactionsTable")});try{const s=await yn(g.establishmentId),o=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(r=>{const i=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=v(r.closedByName||"N/A");o.innerHTML+=`<option value="${r.id}">${n} - ${i}</option>`})}catch{m("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Gs()}const Yd=document.getElementById("content");let w={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],suppliers:[],clients:[],professionals:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},_t=null,Vt=null;function Ss(t){const e=new Map,a=[];return t&&(t.forEach(s=>e.set(s.id,{...s,children:[]})),e.forEach(s=>{s.parentId&&e.has(s.parentId)?e.get(s.parentId).children.push(s):a.push(s)})),a}function vr(t){if(!t)return{day:"--",month:"---",full:"--/--/----"};const[e,a,s]=t.split("-"),o=new Date(e,a-1,s),r=String(o.getDate()).padStart(2,"0"),i=o.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:r,month:i,full:o.toLocaleDateString("pt-BR")}}function ye(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t)}function ot(t,e){if(e==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,o,r]=t.split("-");return new Date(s,o-1,r)<a}function Zd(t,e,a){if(!t)return;if(!e||e.length===0){t.innerHTML=`
        ...
        `};t.innerHTML=e.map(o=>s(o)).join("")}async function Ka(t){const e=document.getElementById("genericModal"),a=t==="nature",s=a?"Plano de Naturezas":"Centros de Custo",o=a?xa:fs,r=a?En:Ln,i=a?"natures":"costCenters";e.innerHTML=`
    ...
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),document.querySelector('.date-preset-btn[data-preset="month"]').classList.remove("bg-white","text-gray-600","border-gray-200"),kr()}function ec(){const t=w.currentTab==="receivables",e=t?w.receivables:w.payables;let a=e;if(w.statusFilter!=="all"&&(a=e.filter(n=>{const l=ot(n.dueDate,n.status);return w.statusFilter==="overdue"?l:w.statusFilter==="pending"?n.status==="pending"&&!l:n.status===w.statusFilter})),w.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(w.searchQuery)||n.entity&&n.entity.toLowerCase().includes(w.searchQuery)||n.notes&&n.notes.toLowerCase().includes(w.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){m("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map(w.natures.map(n=>[n.id,n.name])),o=new Map(w.costCenters.map(n=>[n.id,n.name])),r=new Map(w.establishments.map(n=>[n.id,n])),i=a.map(n=>{const l=n.status==="paid",d=ot(n.dueDate,n.status);let c=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const u=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?o.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=r.get(n.establishmentId),f=b?b.name:"Atual",h=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:f,Natureza:u,"Centro de Custo":p,Origem:h,"Documento / NFS":n.documentNumber||"",Status:c,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){m("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(i),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const c=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,c)}catch(n){console.error("Erro ao exportar:",n),m("Erro","Não foi possível exportar para Excel.","error")}}function wr(){const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const r=o.target.checked,i=document.querySelectorAll(".item-checkbox");w.selectedIds.clear(),i.forEach(n=>{n.checked=r,r&&w.selectedIds.add(n.dataset.id)}),Ge()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{w.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Ge()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=w.selectedIds.size;if(o===0)return;if(await Y("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const i=w.currentTab==="payables"?"payables":"receivables";await _o(i,Array.from(w.selectedIds)),m("Sucesso",`${o} itens excluídos.`,"success"),w.selectedIds.clear(),Ge(),Fe()}catch{m("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",r=>{const i=r.target.closest("label");r.target.checked?(w.filterEstablishmentIds.add(r.target.value),i.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.remove("border-gray-200","text-gray-600")):(w.filterEstablishmentIds.delete(r.target.value),i.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.add("border-gray-200","text-gray-600"))})}),document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",r=>{const i=r.currentTarget.dataset.sort;w.sortCol===i?w.sortAsc=!w.sortAsc:(w.sortCol=i,w.sortAsc=!0),$t()})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("toggle-filter-btn");w.isAdvancedFilterOpen=!w.isAdvancedFilterOpen,w.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.getElementById("settings-btn").addEventListener("click",ic);const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",ec),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",r=>{Ta(r.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const o=w.currentTab==="payables"?"payable":"receivable";Ta(o)});const a=document.getElementById("tab-receivables"),s=document.getElementById("tab-payables");a.addEventListener("click",()=>Xs("receivables")),s.addEventListener("click",()=>Xs("payables")),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",r=>{document.querySelectorAll(".status-filter-btn").forEach(i=>{i.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),i.classList.add("bg-white","text-gray-600")}),r.target.dataset.status==="overdue"?r.target.classList.add("bg-red-50","text-red-700","border-red-200"):r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600"),w.statusFilter=r.target.dataset.status,$t(),$r()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const i=r.target.dataset.preset,n=new Date;let l,d;i==="month"?(l=new Date(n.getFullYear(),n.getMonth(),1),d=new Date(n.getFullYear(),n.getMonth()+1,0)):i==="last_month"?(l=new Date(n.getFullYear(),n.getMonth()-1,1),d=new Date(n.getFullYear(),n.getMonth(),0)):i==="year"&&(l=new Date(n.getFullYear(),0,1),d=new Date(n.getFullYear(),11,31)),document.getElementById("filterStartDate").value=l.toISOString().split("T")[0],document.getElementById("filterEndDate").value=d.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",o=>{w.searchQuery=o.target.value.toLowerCase(),$t()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",w.filterEstablishmentIds.clear(),w.filterEstablishmentIds.add(g.establishmentId),yr(),wr()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{w.startDate=document.getElementById("filterStartDate").value,w.endDate=document.getElementById("filterEndDate").value,w.filterNaturezaId=document.getElementById("filterNaturezaId").value,w.filterCostCenterId=document.getElementById("filterCostCenterId").value,w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(g.establishmentId),document.getElementById("toggle-filter-btn").click(),Fe()}),_t&&document.body.removeEventListener("click",_t),_t=o=>{const r=o.target;if(r.classList.contains("item-checkbox")||r.classList.contains("modal-item-checkbox")){const l=r.value||r.dataset.id;r.checked?w.selectedIds.add(l):w.selectedIds.delete(l),Ge(),o.stopPropagation();return}const i=r.closest("button[data-action]");if(i){const{action:l,type:d,id:c}=i.dataset;if(o.stopPropagation(),l==="delete"){const u=i.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");sc(d,JSON.parse(u));return}if(l==="mark-as-paid"){ac(d,c);return}if(l==="manage-natures"){Ka("nature");return}if(l==="manage-cost-centers"){Ka("cost-center");return}}const n=r.closest(".financial-row");if(n&&document.getElementById("list-container").contains(n)&&!r.closest("button")&&!r.closest(".item-checkbox")){const{type:l}=n.dataset,d=JSON.parse(n.dataset.item.replace(/&apos;/g,"'"));Ta(l,d)}},document.body.addEventListener("click",_t),Vt&&document.getElementById("genericModal").removeEventListener("click",Vt),Vt=o=>{if(o.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const i=o.target.closest('button[data-action^="delete-"]');if(i){const n=i.dataset.action.split("-")[1];rc(n,i.dataset.id)}},document.getElementById("genericModal").addEventListener("click",Vt)}function Ge(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=document.getElementById("fab-add"),s=w.selectedIds.size;e.textContent=s,s>0?(t.classList.remove("hidden"),t.classList.add("flex"),a&&a.classList.add("hidden")):(t.classList.add("hidden"),t.classList.remove("flex"),a&&a.classList.remove("hidden"))}function Xs(t){w.currentTab=t,w.selectedIds.clear(),Ge(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),s=document.getElementById("fab-add");t==="receivables"?(e.classList.add("bg-white","text-emerald-700","shadow"),e.classList.remove("text-gray-600"),a.classList.remove("bg-white","text-red-700","shadow"),a.classList.add("text-gray-600"),s&&(s.className="md:hidden fixed bottom-20 right-4 w-12 h-12 bg-emerald-600 text-white rounded-full shadow-lg flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow"),a.classList.remove("text-gray-600"),e.classList.remove("bg-white","text-emerald-700","shadow"),e.classList.add("text-gray-600"),s&&(s.className="md:hidden fixed bottom-20 right-4 w-12 h-12 bg-red-600 text-white rounded-full shadow-lg flex items-center justify-center hover:scale-105 transition-all z-40")),$t()}async function Fe(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-xs">A processar transações...</p></div>';try{if(w.natures.length===0){const[r,i,n,l,d]=await Promise.all([xa(g.establishmentId),fs(g.establishmentId),Dt(g.establishmentId).catch(()=>[]),lt(g.establishmentId,"",1e3).catch(()=>[]),ke(g.establishmentId).catch(()=>[])]);w.natures=r||[],w.costCenters=i||[],w.suppliers=n||[],w.clients=l||[],w.professionals=d||[],kr()}const e=Array.from(w.filterEstablishmentIds).join(","),a={startDate:w.startDate,endDate:w.endDate,establishmentId:e};w.filterNaturezaId!=="all"&&(a.natureId=w.filterNaturezaId),w.filterCostCenterId!=="all"&&(a.costCenterId=w.filterCostCenterId);const[s,o]=await Promise.all([Wo(a),Jo(a)]);w.payables=s.entries||[],w.receivables=o.entries||[],$r(),$t()}catch(e){t.innerHTML=`
            ...
            </div>`}}function kr(){const t=s=>{let o='<option value="all">-- Todas as opções --</option>';const r=Ss(s),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");o+=`<option value="${n.id}">${d}${n.name}</option>`,n.children.forEach(c=>i(c,l+1))};return r.forEach(n=>i(n)),o},e=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");e&&(e.innerHTML=t(w.natures)),a&&(a.innerHTML=t(w.costCenters))}function $r(){const t=document.getElementById("summary-section");if(!t)return;const e=w.currentTab==="receivables";let s=e?w.receivables:w.payables;w.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(w.searchQuery)||c.entity&&c.entity.toLowerCase().includes(w.searchQuery)||c.notes&&c.notes.toLowerCase().includes(w.searchQuery)));const o=s.reduce((c,u)=>c+u.amount,0),r=s.filter(c=>c.status==="paid").reduce((c,u)=>c+u.amount,0),i=s.filter(c=>c.status==="pending"&&!ot(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),n=s.filter(c=>ot(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),l=e?"emerald":"red",d=e?"Receitas":"Despesas";t.innerHTML=`
        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
    ...
    `}function tc(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i");if(!e)return;t.dataset.sort===w.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=w.sortAsc?"bi bi-arrow-up ml-1 text-indigo-600":"bi bi-arrow-down ml-1 text-indigo-600"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-arrow-down-up ml-1 opacity-30 text-[10px]")})}function $t(){const t=document.getElementById("list-container");if(!t)return;const e=w.currentTab==="receivables",a=e?w.receivables:w.payables;let s=a;if(w.statusFilter!=="all"&&(s=a.filter(d=>{const c=ot(d.dueDate,d.status);return w.statusFilter==="overdue"?c:w.statusFilter==="pending"?d.status==="pending"&&!c:d.status===w.statusFilter})),w.searchQuery&&(s=s.filter(d=>d.description&&d.description.toLowerCase().includes(w.searchQuery)||d.entity&&d.entity.toLowerCase().includes(w.searchQuery)||d.notes&&d.notes.toLowerCase().includes(w.searchQuery))),s.sort((d,c)=>{let u=d[w.sortCol],p=c[w.sortCol];return w.sortCol==="dueDate"?(u=new Date(u).getTime(),p=new Date(p).getTime()):(w.sortCol==="description"||w.sortCol==="status")&&(u=u?u.toLowerCase():"",p=p?p.toLowerCase():""),u<p?w.sortAsc?-1:1:u>p?w.sortAsc?1:-1:0}),tc(),s.length===0){t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <div class="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center mb-3">
        ...
        `}).join("")}async function ac(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?Pn(e,a):Mn(e,a)),m("Baixa Realizada","O lançamento foi registado como pago.","success"),await Fe()}catch(s){m("Erro",s.message,"error")}}async function sc(t,e){if(!!!e.recurrenceId){await Y("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Sr(t,[e.id]);return}oc(t,e)}function oc(t,e){const a=document.getElementById("genericModal"),o=(t==="payable"?w.payables:w.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,c)=>new Date(d.dueDate)-new Date(c.dueDate));a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${o.map(d=>{const c=d.id===e.id,u=d.status==="paid",p=vr(d.dueDate);return`
    ...
    `,a.style.display="flex";const r=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");r.addEventListener("change",d=>{i.forEach(c=>c.checked=d.target.checked),l()}),i.forEach(d=>d.addEventListener("change",l));function l(){const d=Array.from(i).filter(c=>c.checked).length;n.innerHTML=d>0?`<i class="bi bi-trash3"></i> Excluir ${d} Parcela(s)`:"Selecione para excluir",n.disabled=d===0,d===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const d=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(d.length===0)return;a.style.display="none",await Y("Confirmar Ação",`Tem certeza que deseja apagar estas ${d.length} parcelas permanentemente?`)&&await Sr(t,d)}),l()}async function Sr(t,e){try{e.length===1?t==="payable"?await Tn(e[0]):await An(e[0]):await _o(t==="payable"?"payables":"receivables",e),m("Sucesso",`${e.length} registo(s) limpo(s) do sistema.`,"success"),w.selectedIds.clear(),Ge(),await Fe()}catch(a){m("Erro",a.message,"error")}}async function rc(t,e){const s=t==="nature"?In:Cn;if(await Y("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await s(e),Ka(t==="nature"?"nature":"cost-center")}catch(r){m("Erro",r.message,"error")}}function ic(){const t=document.getElementById("genericModal");t.innerHTML=`
        ...
        <div class="modal-content max-w-3xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden m-4 flex flex-col max-h-[90vh]">
            ...
            <form id="financial-form" class="flex-1 overflow-y-auto custom-scrollbar bg-gray-50">
                ...
                <div>
                    ...
                    <span class="font-bold text-sm text-indigo-700 block leading-tight">${b}x de ${ye(B)}</span>
    ...
    `}async function rt(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>');const e=Array.from(A.filterEstablishmentIds).join(",");try{const[a,s]=await Promise.all([cc({startDate:A.startDate,endDate:A.endDate,professionalId:A.professionalId,establishmentId:e}),dc(A.startDate,A.endDate,e)]);A.reports=a||[];const o=A.reports.reduce((r,i)=>r+(i.summary.finalValue||i.summary.totalCommission),0);A.stats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0,margin:s.totalRevenue>0?((s.totalRevenue-s.totalCommissionsPaid)/s.totalRevenue*100).toFixed(1):0,netPaid:o},A.selectedIds.clear(),Et(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),fc(),Lr()}catch(a){console.error(a),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
                <p class="text-gray-600 text-xs font-medium">Erro ao carregar dados.</p>
            </div>`)}}function fc(){const t=document.getElementById("kpi-revenue"),e=document.getElementById("kpi-commissions"),a=document.getElementById("kpi-margin"),s=document.getElementById("kpi-net");t&&(t.textContent=St(A.stats.revenue)),e&&(e.textContent=St(A.stats.commissions)),a&&(a.textContent=`${A.stats.margin}%`),s&&(s.textContent=St(A.stats.netPaid))}function Lr(){const t=document.getElementById("list-container");if(!t)return;let e=A.reports;if(A.searchQuery){const a=A.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=e.map(a=>{const s=bc(a.createdAt),o=a.summary.totalCommission,r=a.summary.extraDebit||0,i=a.summary.extraCredit||0,n=a.summary.finalValue||o,l=A.selectedIds.has(a.id);let d="";return r>0&&i>0?d=`<span class="text-red-500">-R$${r.toFixed(2)}</span> / <span class="text-emerald-500">+R$${i.toFixed(2)}</span>`:r>0?d=`<span class="text-red-500">-R$ ${r.toFixed(2)}</span>`:i>0?d=`<span class="text-emerald-500">+R$ ${i.toFixed(2)}</span>`:d='<span class="text-gray-300">--</span>',`
        ...
        `}).join("")}function xc(){Ut&&document.body.removeEventListener("click",Ut),Ut=i=>{const n=i.target;if(n.classList.contains("item-checkbox")){const d=n.value;n.checked?A.selectedIds.add(d):A.selectedIds.delete(d),Et(),i.stopPropagation();return}const l=n.closest("button[data-action]");if(l){i.preventDefault();const d=l.dataset.action,c=l.dataset.id;switch(d){case"apply-filters":A.startDate=document.getElementById("filter-start").value,A.endDate=document.getElementById("filter-end").value,A.professionalId=document.getElementById("filter-prof").value,rt();break;case"new-calculation":hc();break;case"print-receipt":Ic(c);break;case"delete-report":Cc(c);break;case"view-report-details":Sc(c);break;case"close-detail-screen":Es();break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),p=Array.from(u).every(y=>y.checked);u.forEach(y=>y.checked=!p);break;case"calculate-preview":vc();break;case"save-final-reports":$c();break;case"toggle-preview-details":const b=l.dataset.idx,f=document.getElementById(`preview-details-${b}`),h=l.querySelector("i");f&&(f.classList.contains("hidden")?(f.classList.remove("hidden"),h&&h.classList.replace("bi-chevron-down","bi-chevron-up")):(f.classList.add("hidden"),h&&h.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",Ut);const t=document.getElementById("search-input");t&&t.addEventListener("input",i=>{A.searchQuery=i.target.value,Lr()}),document.body.addEventListener("input",i=>{(i.target.classList.contains("input-debit")||i.target.classList.contains("input-credit")||i.target.classList.contains("input-notes"))&&wc(i.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",i=>{const n=i.target.checked,l=document.querySelectorAll(".item-checkbox");A.selectedIds.clear(),l.forEach(d=>{d.checked=n,n&&A.selectedIds.add(d.value)}),Et()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{A.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(i=>i.checked=!1),Et()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",Lc);const o=document.getElementById("establishment-filters-container");o&&o.addEventListener("change",i=>{if(i.target.classList.contains("est-filter-checkbox")){const n=i.target.closest("label");i.target.checked?(A.filterEstablishmentIds.add(i.target.value),n.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.remove("border-gray-200","text-gray-600")):(A.filterEstablishmentIds.delete(i.target.value),n.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.add("border-gray-200","text-gray-600")),rt()}});const r=document.getElementById("export-excel-btn");r&&r.addEventListener("click",Ec)}function Et(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=A.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function hc(){A.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=A.professionals.map(r=>`
    ...
    `,Ir()}async function vc(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(d=>d.value);if(t.length===0)return m("Atenção","Selecione pelo menos um profissional.","warning");const e=Array.from(A.filterEstablishmentIds).join(","),a=document.getElementById("calc-start-date"),s=document.getElementById("calc-end-date");if(!a||!s||!a.value||!s.value)return m("Atenção","As datas de início e fim são obrigatórias.","warning");const o={professionalIds:t,startDate:a.value,endDate:s.value,establishmentId:e,calculationTypes:{services:document.getElementById("calc-type-services")?.checked||!1,products:document.getElementById("calc-type-products")?.checked||!1,packages:document.getElementById("calc-type-packages")?.checked||!1}},r=new Date(o.startDate+"T00:00:00").toLocaleDateString("pt-BR"),i=new Date(o.endDate+"T00:00:00").toLocaleDateString("pt-BR");A.periodString=`${r} a ${i}`;const n=document.getElementById("btn-calc-action"),l=n.innerHTML;n.innerHTML='<div class="loader-small border-white mr-2"></div> Processando...',n.disabled=!0;try{const d=await nc(o);A.calculationResult=d.map(c=>({...c,extraDebit:0,extraCredit:0,finalValue:c.summary.totalCommission,notes:""})),yc()}catch(d){m("Erro na Apuração",d.message,"error"),n.innerHTML=l,n.disabled=!1}}function yc(){A.viewMode="preview-calc";const t=A.calculationResult;if(!t||t.length===0||t.every(i=>i.summary.totalCommission===0)){m("Aviso","Nenhuma comissão encontrada para os filtros selecionados.","info");const i=document.getElementById("btn-calc-action");i.innerHTML='<i class="bi bi-calculator text-lg"></i> Calcular Vendas',i.disabled=!1;return}const e=document.getElementById("calc-step-1"),a=document.getElementById("calc-step-2"),s=document.getElementById("btn-calc-action");e&&e.classList.add("hidden"),a&&a.classList.remove("hidden"),s&&(s.dataset.action="save-final-reports",s.className="w-full md:w-auto py-3.5 px-8 bg-emerald-600 text-white font-black text-sm rounded-xl hover:bg-emerald-700 shadow-md transition-transform active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider",s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1);const o=t.reduce((i,n)=>i+n.finalValue,0),r=t.map((i,n)=>{if(i.summary.totalCommission===0)return"";const l=(i.items||[]).map(c=>`
        ...
        ${r}
    `)}function wc(t){const e=document.querySelector(`.input-debit[data-idx="${t}"]`),a=document.querySelector(`.input-credit[data-idx="${t}"]`),s=document.querySelector(`.input-notes[data-idx="${t}"]`);let o=parseFloat(e?.value)||0,r=parseFloat(a?.value)||0,i=s?.value||"";if(A.calculationResult&&A.calculationResult[t]){const n=A.calculationResult[t];n.extraDebit=o,n.extraCredit=r,n.notes=i,n.finalValue=n.summary.totalCommission-o+r;const l=document.querySelector(`.final-value-display[data-idx="${t}"]`);l&&(l.innerText=`R$ ${n.finalValue.toFixed(2)}`),kc()}}function kc(){const t=A.calculationResult.reduce((a,s)=>a+s.finalValue,0),e=document.getElementById("grand-total-preview");e&&(e.innerText=`R$ ${t.toFixed(2)}`)}async function $c(){const t=A.calculationResult.filter(o=>o.summary.totalCommission>0),e=t.length;if(e===0)return m("Aviso","Não há valores para pagar.","info");if(!await Y("Confirmar Pagamentos",`Você está prestes a gerar recibos e marcar as vendas de ${e} profissional(is) como PAGAS. Essa ação lançará a despesa correspondente no Financeiro. Confirmar?`))return;const s=document.getElementById("btn-calc-action");s.innerHTML='<div class="loader-small border-white mr-2"></div> Finalizando...',s.disabled=!0;try{const o=t.map(async r=>{const i=(r.items||[]).map(n=>n.originalSaleId).filter(n=>n!=null);await lc({professionalId:r.professionalId,professionalName:r.professionalName,period:A.periodString,processedSalesIds:i,establishmentId:g.establishmentId,reportData:{...r,summary:{...r.summary,finalValue:r.finalValue,extraDebit:r.extraDebit||0,extraCredit:r.extraCredit||0,notes:r.notes||""}}});try{if(r.finalValue>0){const n=A.establishmentConfig||{},l=n.defaultDespesaNaturezaId||n.financeConfig?.despesaNaturezaId||null,d=n.defaultDespesaCentroCustoId||n.financeConfig?.despesaCentroCustoId||null;await Uo({establishmentId:g.establishmentId,description:`Comissões - ${r.period}`,amount:r.finalValue,dueDate:new Date().toISOString().split("T")[0],naturezaId:l,centroDeCustoId:d,entity:r.professionalName,paymentMethod:"dinheiro",status:"paid",paymentDate:new Date().toISOString().split("T")[0],origin:"commission"})}}catch(n){console.error("Erro ao integrar com financeiro (Despesa):",n)}});await Promise.all(o),m("Sucesso","Pagamentos registrados e integrados ao financeiro!","success"),A.calculationResult=null,Es(),await rt()}catch(o){m("Erro ao Salvar",o.message,"error"),s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1}}function Sc(t){A.viewMode="report-details";const e=document.getElementById("commissions-layout-detail");if(!e)return;const a=A.reports.find(u=>u.id===t);if(!a)return;const s=a.reportData?.items||a.items||[],o=a.summary,r=o.extraDebit||0,i=o.extraCredit||0,n=o.notes||"",l=`
        <div class="p-4 border-b border-gray-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
            <button data-action="close-detail-screen" class="w-10 h-10 rounded-full bg-gray-100 text-gray-700 flex items-center justify-center hover:bg-gray-200 shadow-inner transition-transform active:scale-95">
                <i class="bi bi-arrow-left text-lg"></i>
            </button>
    ...
    `,Ir()}function Ec(){if(A.reports.length===0){m("Aviso","Não há dados para exportar com os filtros atuais.","info");return}let t=A.reports;if(A.searchQuery){const a=A.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}const e=t.map(a=>{const s=a.summary.totalCommission,o=a.summary.extraDebit||0,r=a.summary.extraCredit||0,i=a.summary.finalValue||s;return{"Data da Apuração":new Date(a.createdAt).toLocaleDateString("pt-BR"),Profissional:a.professionalName,"Período Base":a.period,"Itens Calculados":a.summary.totalItems||0,"Valor Bruto (R$)":s,"Bônus (R$)":r,"Descontos (R$)":o,"Líquido Pago (R$)":i,"Observações/Motivo":a.summary.notes||""}});try{if(typeof XLSX>"u"){m("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const a=XLSX.utils.json_to_sheet(e),s=XLSX.utils.book_new();XLSX.utils.book_append_sheet(s,a,"Comissoes");const o=`Relatorio_Comissoes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(s,o)}catch(a){console.error(a),m("Erro","Falha ao exportar Excel.","error")}}function Ic(t){const e=A.reports.find(c=>c.id===t);if(!e)return;if(!window.jspdf){m("Erro","A biblioteca de PDF não foi carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a;s.setFillColor(79,70,229),s.rect(0,0,210,40,"F"),s.setTextColor(255,255,255),s.setFontSize(22),s.setFont(void 0,"bold"),s.text("RECIBO DE COMISSÕES",105,20,{align:"center"}),s.setFontSize(10),s.text(`Data de Emissão: ${new Date().toLocaleDateString("pt-BR")}`,105,28,{align:"center"}),s.setTextColor(50,50,50),s.setFontSize(11),s.setFont(void 0,"normal"),s.text("Profissional:",15,55),s.setFont(void 0,"bold"),s.text(e.professionalName,40,55),s.setFont(void 0,"normal"),s.text("Período:",130,55),s.setFont(void 0,"bold"),s.text(e.period,147,55);const o=e.reportData?.items||e.items||[];let r=70;if(o.length>0){const c=o.map(u=>[u.item||"Item",u.client||"--",`R$ ${(u.value||0).toFixed(2)}`,`${u.commissionRate||0}%`,`R$ ${(u.commissionValue||0).toFixed(2)}`]);s.autoTable({startY:r,head:[["Serviço/Produto","Cliente","Valor Base","Taxa","Comissão"]],body:c,theme:"striped",headStyles:{fillColor:[249,250,251],textColor:[75,85,99],fontStyle:"bold"},styles:{fontSize:8},columnStyles:{2:{halign:"right"},3:{halign:"center"},4:{halign:"right",fontStyle:"bold",textColor:[5,150,105]}}}),r=s.lastAutoTable.finalY+15}const i=e.summary,n=i.finalValue||i.totalCommission,l=[["Comissões Brutas (Soma dos Itens)",`R$ ${i.totalCommission.toFixed(2)}`]];i.extraCredit>0&&l.push(["(+) Bônus Extras",`R$ ${i.extraCredit.toFixed(2)}`]),i.extraDebit>0&&l.push(["(-) Descontos / Vales",`R$ ${i.extraDebit.toFixed(2)}`]),s.autoTable({startY:r,head:[["Resumo do Fechamento","Valor"]],body:l,theme:"grid",headStyles:{fillColor:[79,70,229],textColor:[255,255,255]},columnStyles:{1:{halign:"right",fontStyle:"bold"}}});const d=s.lastAutoTable.finalY+15;s.setFillColor(236,253,245),s.rect(120,d-8,75,15,"F"),s.setTextColor(5,150,105),s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${n.toFixed(2)}`,190,d,{align:"right"}),i.notes&&(s.setTextColor(100,100,100),s.setFontSize(9),s.setFont(void 0,"normal"),s.text(`Obs/Motivo: ${i.notes}`,15,d+10)),s.setTextColor(150,150,150),s.setFontSize(9),s.line(20,d+40,90,d+40),s.text("Assinatura da Empresa",55,d+45,{align:"center"}),s.line(120,d+40,190,d+40),s.text("Assinatura do Profissional",155,d+45,{align:"center"}),s.save(`Recibo_Comissoes_${e.professionalName.replace(/\s+/g,"_")}.pdf`)}async function Lc(){const t=A.selectedIds.size;if(!(t===0||!await Y("Excluir Recibos",`Deseja excluir e estornar ${t} recibo(s)? As vendas associadas voltarão ao status "A Apurar".`)))try{const a=Array.from(A.selectedIds).map(s=>Er(s));await Promise.all(a),m("Sucesso",`${t} recibos excluídos com sucesso.`,"success"),A.selectedIds.clear(),Et(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),await rt()}catch{m("Erro ao Excluir","Ocorreu um erro ao excluir alguns recibos.","error")}}async function Cc(t){if(await Y("Excluir Recibo",'ATENÇÃO: Deseja realmente excluir este recibo? As vendas associadas a ele voltarão ao status "A Apurar" e o valor será subtraído dos relatórios. Esta ação não pode ser desfeita.'))try{await Er(t),m("Sucesso","Recibo cancelado com sucesso. Vendas estornadas para apuração.","success"),Es(),await rt()}catch(a){m("Erro ao Excluir",a.message,"error")}}const De=document.getElementById("content");let H={allPackages:[],catalogForModal:{services:[],products:[]},establishments:[],filterEstablishmentIds:new Set,searchQuery:"",statusFilter:"all",viewMode:"list",tempPackage:null},_e=null;function it(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Dc(){const t=H.allPackages.length,e=H.allPackages.filter(r=>r.status!=="inactive"),a=e.length,s=a>0?e.reduce((r,i)=>r+(i.price||0),0)/a:0;let o=0;return e.forEach(r=>{const i=r.originalPrice||0,n=r.price||0;if(i>0&&i>n){const l=(i-n)/i*100;l>o&&(o=l)}}),{total:t,activeCount:a,avgPrice:s,maxDiscount:o}}function Tc(){const t=document.getElementById("packages-layout-main"),e=document.getElementById("packages-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.add("mobile-detail-open"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&(a.style.display="none")}function ts(){const t=document.getElementById("packages-layout-main"),e=document.getElementById("packages-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.remove("mobile-detail-open"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&(a.style.display="")}async function Pc(){try{const e=(await fe().catch(()=>({matrizes:[]}))).matrizes||[];H.establishments=[],e.forEach(a=>{H.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>H.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),H.filterEstablishmentIds.size===0&&H.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}H.viewMode="list",Bc(),jc(),await da()}async function da(){const t=document.getElementById("packagesListContainer");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-20"><div class="loader"></div></div>');try{const e=Array.from(H.filterEstablishmentIds).map(i=>ms(i).catch(()=>[])),a=await Promise.all(e),s=new Map;a.flat().forEach(i=>{s.has(i.id)||s.set(i.id,i)}),H.allPackages=Array.from(s.values());const[o,r]=await Promise.all([dt(g.establishmentId).catch(()=>[]),ct(g.establishmentId).catch(()=>[])]);H.catalogForModal={services:(o||[]).filter(i=>i.active),products:r||[]},Ac(),as()}catch(e){console.error(e),t&&(t.innerHTML=`
            ...
            `)}}function Bc(){const t=H.establishments.map(e=>`
    ...
    `}function Ac(){const t=Dc(),e=document.getElementById("kpi-container");e&&(e.innerHTML=`
        <div class="bg-white p-1.5 md:p-3 rounded-lg border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `,ss()}function qc(){H.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
        <div class="p-4 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
    ...
    `;const a=(o="")=>{const r=o.toLowerCase(),i={service:'<i class="bi bi-scissors text-indigo-600"></i>',product:'<i class="bi bi-box-seam text-emerald-600"></i>'},n={"catalog-service-list":{items:H.catalogForModal.services,type:"service"},"catalog-product-list":{items:H.catalogForModal.products,type:"product"}};Object.entries(n).forEach(([l,{items:d,type:c}])=>{const u=t.querySelector("#"+l);if(!u)return;const p=d.filter(h=>h.name.toLowerCase().includes(r)).slice(0,50),b=c==="service"?"hover:border-indigo-300 hover:bg-indigo-50/50":"hover:border-emerald-300 hover:bg-emerald-50/50",f=c==="service"?"bg-indigo-100 border-indigo-200":"bg-emerald-100 border-emerald-200";u.innerHTML=p.map(h=>h.id?`
            ...
            `:"").join("")||'<p class="text-[10px] font-bold uppercase tracking-widest text-slate-400 text-center py-6 border border-dashed border-slate-200 rounded-xl">Vazio</p>'})};a();const s=t.querySelector("#item-search-input");s&&(s.addEventListener("input",debounce(o=>{a(o.target.value)},300)),setTimeout(()=>s.focus(),100))}function jc(){_e&&(De.removeEventListener("click",_e),De.removeEventListener("input",_e),De.removeEventListener("change",_e)),_e=async e=>{const a=e.target.closest('[data-action="delete-package"]');if(a){e.stopPropagation(),e.preventDefault();const r=a.dataset.id;if(await Y("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await Sn(r),m("Sucesso!","Pacote excluído.","success"),H.viewMode==="edit-package"&&H.tempPackage?.id===r&&(ts(),H.viewMode="list"),await da()}catch(n){m("Erro",`Não foi possível excluir: ${n.message}`,"error")}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"new-package":Ys(null);break;case"edit-package":const r=s.dataset.id,i=H.allPackages.find(b=>b.id===r);i&&Ys(i);break;case"back-to-main":ts(),H.viewMode="list",H.tempPackage=null;break;case"add-item-to-package-btn":qc();break;case"back-to-editor":os();break;case"select-catalog-item":const{itemType:n,itemId:l}=s.dataset,c=(H.catalogForModal[n+"s"]||[]).find(b=>b.id===l);if(c){const b=H.tempPackage.items.find(f=>f.id===c.id&&f.type===n);b?b.quantity++:H.tempPackage.items.push({...c,type:n,quantity:1}),os()}break;case"toggle-all-ests":const u=document.querySelectorAll(".modal-est-checkbox"),p=Array.from(u).every(b=>b.checked);u.forEach(b=>b.checked=!p);break;case"save-package":await Nc(s);break}},De.addEventListener("click",_e),De.addEventListener("input",e=>{e.target.id==="search-packages"&&(H.searchQuery=e.target.value,as()),e.target.id==="finalPrice"&&Cr()}),De.addEventListener("change",e=>{if(e.target.id==="filter-status"&&(H.statusFilter=e.target.value,as()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&H.tempPackage.items[a]&&(H.tempPackage.items[a].quantity=s,ss())}if(e.target.classList.contains("est-filter-checkbox")&&e.target.closest("#establishment-filters-container")){const a=e.target.closest("label");e.target.checked?(H.filterEstablishmentIds.add(e.target.value),a.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),a.classList.remove("border-slate-200","text-slate-600")):(H.filterEstablishmentIds.delete(e.target.value),a.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),a.classList.add("border-slate-200","text-slate-600")),da()}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Mc),De.addEventListener("click",e=>{const a=e.target.closest(".remove-item-btn");if(a&&H.viewMode==="edit-package"){const s=parseInt(a.dataset.index,10);H.tempPackage.items.splice(s,1),ss()}})}async function Nc(t){const e=H.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const o=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(o.length===0){m("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const r=e.items.reduce((l,d)=>l+d.price*d.quantity,0),i={id:e.id||null,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:r,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:o,establishmentId:o[0]};if(!i.name||isNaN(i.price)){m("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(i.items.length===0){m("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await $n(i.id,i):(delete i.id,await kn(i)),m("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),ts(),H.viewMode="list",H.tempPackage=null,await da()}catch(l){m("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const Rc=document.getElementById("content");async function Fc(){const t=ge.currentUser;if(!t)return;let e={};try{const l=await ns(Te(me,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(g.userProfessionalId)try{a=await fo(g.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=v(e.name||t.displayName||"Usuário"),o=v(t.email||"E-mail não disponível"),r=v(e.phone||"");let i=e.photo||"";a&&a.photo&&(i=a.photo);const n=i||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;Rc.innerHTML=`
    ...
    `,Hc(t),Oc(a)}function Hc(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),o=document.getElementById("profile-avatar"),r=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async i=>{const n=i.target.files[0];if(n)try{const l=await ba(n,800,800,.8);o.src=l,await Ct(Te(me,"users",t.uid),{photo:l}),g.userProfessionalId&&await qa(g.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),m("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{m("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),r.addEventListener("submit",async i=>{i.preventDefault();const n=r.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),c=document.getElementById("input-phone").value.trim();try{await Ct(Te(me,"users",t.uid),{name:d,phone:c}),g.userProfessionalId&&await qa(g.userProfessionalId,{name:d,phone:c}),g.userName=d,document.getElementById("display-name").textContent=d,m("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{m("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function Oc(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async o=>{o.preventDefault();const r=a.querySelector("#b-date-start").value,i=a.querySelector("#b-date-end").value||r,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!r||!n||!l)return m("Atenção","Preencha Data e Horários corretamente.","error");const c=new Date(`${r}T${n}:00`),u=new Date(`${i}T${l}:00`);if(u<=c)return m("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await ma({establishmentId:g.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:c.toISOString(),endTime:u.toISOString()}),m("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const f=document.getElementById("my-blocks-filter").value;Kt(t.id,f)}catch(f){m("Erro",`Falha ao bloquear: ${f.message}`,"error")}finally{p.disabled=!1,p.innerHTML=b}}),document.getElementById("my-blocks-filter").addEventListener("change",o=>Kt(t.id,o.target.value)),Kt(t.id,"future")}async function Kt(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let o,r;e==="history"?(r=new Date,o=new Date,o.setFullYear(o.getFullYear()-1)):(o=new Date,r=new Date,r.setFullYear(r.getFullYear()+1));let n=(await ga(g.establishmentId,o.toISOString(),r.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const c=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await us(c),m("Removido","O bloqueio foi deletado.","success"),Kt(t,e)}catch(u){m("Erro",`Não foi possível remover: ${u.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${v(s.message)}</p>`}}let Zs=!1;async function ca(t){if(!t)return;t.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const o=(await fe()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),o.length===0)e.innerHTML=`
            ...
            `;else{let r="";o.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';r+=`
                ...
                `}),e.innerHTML=r}Zs||(zc(),Zs=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
        ...
        `}}function zc(){const t=document.getElementById("form-create-establishment");t&&t.addEventListener("submit",async e=>{e.preventDefault();const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const o={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const r=await ui(o);alert(r.message||"Sucesso!"),t.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await ca(document.getElementById("content"))}catch(r){console.error("Erro ao criar estabelecimento:",r),alert("Erro: "+(r.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>ca(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(e){e.preventDefault()}),document.addEventListener("gesturechange",function(e){e.preventDefault()}),document.addEventListener("gestureend",function(e){e.preventDefault()});let t=0;document.addEventListener("touchend",function(e){const a=new Date().getTime();a-t<=300&&e.preventDefault(),t=a},!1)});const le=document.getElementById("loadingScreen"),bt=document.getElementById("dashboardContent"),Xe=document.getElementById("content"),Pa=document.getElementById("notificationBell"),Wt=document.getElementById("notificationBadge"),Ve=document.getElementById("notificationPanel"),Ba=document.getElementById("notificationList"),$e=document.getElementById("profileMenuButton"),pe=document.getElementById("profileDropdown"),Ks=document.getElementById("profileName"),eo=document.getElementById("profileEmail"),to=document.getElementById("logoutButton"),ao=document.getElementById("myProfileLink"),so=document.getElementById("hamburger-menu-btn"),ce=document.getElementById("sidebar"),he=document.getElementById("mobile-overlay"),oo=document.getElementById("themeToggleBtn"),ro=document.getElementById("themeIcon"),rs=document.getElementById("mobile-bottom-nav"),nt=document.getElementById("nav-scroll"),io=document.getElementById("scroll-hint-left"),no=document.getElementById("scroll-hint-right"),_c=document.querySelectorAll(".bottom-nav-item");function is(){if(!nt||!io||!no)return;const{scrollLeft:t,scrollWidth:e,clientWidth:a}=nt;io.classList.toggle("visible",t>5),no.classList.toggle("visible",t+a<e-5)}function Vc(){if(!nt)return;const t=document.querySelector(".bottom-nav-item.active");if(!t)return;const e=nt,a=e.getBoundingClientRect(),s=t.getBoundingClientRect(),r=s.left+s.width/2-a.left-a.width/2;e.scrollBy({left:r,behavior:"smooth"})}const Uc={"dashboard-section":Vi,"agenda-section":Bo,"comandas-section":Yn,"relatorios-section":Kn,"servicos-section":cl,"produtos-section":Il,"suppliers-section":Rl,"profissionais-section":Ql,"clientes-section":od,"estabelecimento-section":t=>fr(t),"ausencias-section":Md,"users-section":na,"sales-report-section":Xd,"financial-section":Kd,"commissions-section":gc,"packages-section":Pc,"my-profile-section":Fc,"hierarquia-section":()=>ca(Xe),"establishments-section":()=>ca(Xe)},Wc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços do Menu","produtos-section":"Produtos (Estoque)","suppliers-section":"Parceiros de Negócio","profissionais-section":"Equipe / Profissionais","clientes-section":"Clientes","estabelecimento-section":"Minha Empresa","ausencias-section":"Ausências","users-section":"Usuários e Acessos","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro (ERP)","commissions-section":"Comissões","packages-section":"Planos e Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"},lo={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#eef2ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#eff6ff",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#1f2937"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#64748b",hover:"#475569",light:"#f1f5f9",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};function Qt(t){const e=lo[t]||lo.indigo,s=(r=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:"79, 70, 229"})(e.main);document.body.style.setProperty("--theme-main",e.main);const o=document.getElementById("dynamic-theme-styles");o&&(o.innerHTML=`
            :root {
        ...
        `)}function ea(t){document.documentElement.setAttribute("data-theme",t),localStorage.setItem("kairos_theme",t),ro&&(ro.innerHTML=t==="dark"?"☀️":"🌙")}function Qc(){const t=localStorage.getItem("kairos_theme"),e=window.matchMedia("(prefers-color-scheme: dark)").matches;ea(t||(e?"dark":"light"))}let It=null,Lt=[];function Dr(){if(!Wt||!Ba)return;const t=Lt.filter(e=>!e.read).length;if(t>0?(Wt.textContent=t,Wt.classList.remove("hidden")):Wt.classList.add("hidden"),Lt.length===0){Ba.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Ba.innerHTML=Lt.map(e=>`
    ...
    `).join("")}function co(t){It&&It();const e=ua(me,"establishments",t,"notifications"),a=bo(e,go("timestamp",">=",new Date),_r("timestamp","desc"));It=Vr(a,s=>{s.docChanges().forEach(o=>{if(o.type==="added"){const r=o.doc.data();Lt.unshift({title:r.title,message:r.message,time:r.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),m(r.title,r.message,"info",!0),Dr();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&Bo()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Jc(t){const e=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),o=document.getElementById("multi-context-count"),r=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!e||!r))try{const c=(await fe()).matrizes||[];let u="",p=0;if(c.forEach(b=>{u+=`
            ...
            `,p++,b.branches&&b.branches.length>0&&b.branches.forEach(f=>{u+=`
                    ...
                    `,p++})}),p>0){r.innerHTML=u,e.style.display="block",(!g.selectedEstablishments||g.selectedEstablishments.length===0)&&(g.selectedEstablishments=[t]);const b=Array.from(r.querySelectorAll('input[type="checkbox"]')),f=()=>{const y=b.filter(S=>S.checked);o.textContent=y.length,y.length===0?s.textContent="Nenhuma selecionada":y.length===1?s.textContent=y[0].dataset.name:s.textContent=`${y.length} Unidades`};let h=!1;b.forEach(y=>{g.selectedEstablishments.includes(y.value)&&(y.checked=!0,h=!0)}),!h&&b.length>0&&(b[0].checked=!0,g.selectedEstablishments=[b[0].value],g.establishmentId=b[0].value),f(),a.addEventListener("click",y=>{y.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",y=>{!e.contains(y.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",b.forEach(S=>{S.checked=g.selectedEstablishments.includes(S.value)}),f())}),b.forEach(y=>y.addEventListener("change",f)),i.addEventListener("click",async y=>{y.stopPropagation(),le&&(le.classList.remove("hidden","fade-out"),le.style.display="flex");const S=b.filter(N=>N.checked);if(S.length===0){le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500)),m("Atenção","Tem de selecionar pelo menos uma unidade.","warning");return}g.selectedEstablishments=S.map(N=>N.value);const P=g.selectedEstablishments[0];try{const N=await Pe(P);g.establishmentId=P,g.establishmentName=N.name,g.enabledModules=N.modules,g.currentViewContext={id:P,name:N.name,type:N.parentId?"BRANCH":"GROUP"},typeof Qt=="function"&&Qt(N.themeColor||"indigo"),co(P),uo(g.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",m("Ambiente Atualizado","Exibindo informações consolidadas.","success");const $=document.querySelector(".sidebar-link.active"),E=$?$.getAttribute("data-target"):"dashboard-section";ee(E)}catch{m("Erro","Ocorreu um problema ao trocar a visualização.","error")}finally{le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500))}});try{const y=await Pe(g.establishmentId);g.establishmentName=y.name,g.enabledModules=y.modules,g.currentViewContext={id:g.establishmentId,name:y.name,type:y.parentId?"BRANCH":"GROUP"},typeof Qt=="function"&&Qt(y.themeColor||"indigo"),co(g.establishmentId),uo(g.userPermissions)}catch{}}else e.style.display="none"}catch{e.style.display="none"}}function ee(t,e={}){const a=t.replace("-section","");if(t!=="my-profile-section"){const o=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(t),r=g.enabledModules?.[a]!==!1,i=g.userPermissions===null||g.userPermissions[t]?.view===!0;if(!o&&(!r||!i)){Xe&&(Xe.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),ce&&ce.classList.contains("absolute")&&(ce.classList.add("hidden"),he&&he.classList.add("hidden"));return}}const s=Uc[t];if(s&&Xe){const o=document.getElementById("header-page-title");o&&(o.textContent=Wc[t]||"Painel de Gestão"),document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===t)}),rs&&(_c.forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===t)}),setTimeout(Vc,50),setTimeout(is,100)),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),Xe.innerHTML="",window.innerWidth<768&&ce&&(ce.classList.add("hidden"),he&&he.classList.add("hidden")),s(e)}}window.navigateTo=ee;async function uo(t){const e=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),r=t===null||t["agenda-section"]?.view===!0,i=t===null||t["financial-section"]?.view===!0;if(r&&e&&(e.classList.remove("hidden"),e.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!r&&!i))try{const n=await wo();r&&s&&(s.textContent=n.todayAppointments.toString()),i&&o&&(o.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch{}}async function Gc(t){try{we.getPlatform()==="android"&&await de.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0});let e=await de.checkPermissions();if(e.receive==="prompt"&&(e=await de.requestPermissions()),e.receive!=="granted")return;await de.register(),de.addListener("registration",async a=>{try{const s=Te(me,"users",t);await Ct(s,{fcmTokens:zr(a.value),platform:"native_mobile"})}catch{}}),de.addListener("pushNotificationReceived",a=>m(a.title,a.body,"info",!0)),de.addListener("pushNotificationActionPerformed",()=>ee("agenda-section"))}catch{}}function Xc(){const t=document.getElementById("exitConfirmationModal"),e=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>t&&(t.style.display="block"),o=()=>t&&(t.style.display="none"),r=()=>t&&t.style.display==="block";t&&(e.addEventListener("click",()=>{o(),we.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{o(),we.isNativePlatform()?Bs.exitApp():history.back()}),we.isNativePlatform()?Bs.addListener("backButton",()=>{if(r())o();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(ce&&!ce.classList.contains("hidden")&&window.innerWidth<768){ce.classList.add("hidden"),he&&he.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():ee("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(r()){o(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():(ee("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Jt(t){return t?t.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function Yc(){try{await qr(ge,jr)}catch{}we.isNativePlatform()&&document.body.classList.add("is-app-native"),oi(),Xc(),Qc(),oo&&oo.addEventListener("click",t=>{t.preventDefault();const e=document.documentElement.getAttribute("data-theme");ea(e==="dark"?"light":"dark")}),so&&so.addEventListener("click",t=>{t.stopPropagation(),ce&&(ce.classList.remove("hidden"),ce.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),he&&he.classList.remove("hidden")}),rs&&(rs.addEventListener("click",t=>{const e=t.target.closest(".bottom-nav-item");if(!e)return;t.preventDefault();const a=e.getAttribute("data-target");ee(a)}),nt&&nt.addEventListener("scroll",is),is()),he&&he.addEventListener("click",()=>{ce&&(ce.classList.add("hidden"),ce.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),he.classList.add("hidden")}),Pa&&Pa.addEventListener("click",t=>{t.stopPropagation(),Ve&&(Ve.classList.toggle("hidden"),Ve.classList.contains("hidden")||(Lt.forEach(e=>e.read=!0),Dr()))}),$e&&$e.addEventListener("click",t=>{t.stopPropagation(),pe&&(pe.classList.toggle("active"),pe.classList.contains("active")?pe.classList.remove("hidden"):setTimeout(()=>pe.classList.add("hidden"),200))}),ao&&ao.addEventListener("click",t=>{t.preventDefault(),ee("my-profile-section"),pe&&(pe.classList.remove("active"),pe.classList.add("hidden"))}),window.addEventListener("userPhotoUpdated",t=>{const e=t.detail;$e&&e&&($e.innerHTML=`<img src="${e}" alt="Avatar" class="w-full h-full rounded-full object-cover">`)}),document.addEventListener("click",t=>{Ve&&!Ve.contains(t.target)&&t.target!==Pa&&Ve.classList.add("hidden"),pe&&!pe.contains(t.target)&&t.target!==$e&&pe.classList.contains("active")&&(pe.classList.remove("active"),setTimeout(()=>pe.classList.add("hidden"),200))}),Nr(ge,async t=>{if(t){if(!we.isNativePlatform()&&(Pi(),"Notification"in window&&Notification.permission==="default")){const e=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");e&&setTimeout(()=>{e.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Bi()&&e&&(e.style.display="none")});const s=()=>{e&&(e.style.display="none")},o=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");o&&o.addEventListener("click",s),r&&r.addEventListener("click",s)}try{const a=(await t.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,o=t.displayName,r=null,i=null;const n=Te(me,"users",t.uid),l=await ns(n);if(l.exists()){const c=l.data();s=a.role==="employee"?c.permissions||{}:null,o=c.name||o,r=c.professionalId||null,i=c.photo||null}if(g.userProfessionalId=r,r&&!i)try{const c=await fo(r);c&&c.photo&&(i=c.photo)}catch(c){console.warn("Erro ao buscar foto profissional no topo",c)}we.isNativePlatform()&&Gc(t.uid);const d=o||t.email;Qr(a.establishmentId,"Carregando...",s),i?$e&&($e.innerHTML=`<img src="${i}" class="w-full h-full rounded-full object-cover">`):$e&&($e.textContent=d.charAt(0).toUpperCase()),Ks&&(Ks.textContent=d),eo&&(eo.textContent=t.email),to&&to.addEventListener("click",c=>{c.preventDefault(),It&&It(),Rr(ge).then(()=>window.location.href="/login.html")}),await Jc(a.establishmentId),ci(ee,s,g.enabledModules),le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500)),bt&&(bt.style.display="flex"),setTimeout(()=>{xi()},1500),ee("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(e){le&&(le.style.display="none"),bt&&(bt.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><h2>Erro de Acesso</h2><p>${e.message}</p></div>`,bt.style.display="flex")}}else window.location.href="/login.html"})}Yc();export{ho as W};
