const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-yxf0oJHl.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/utils-JfzC6GFr.js","assets/styles-CQhY7Cv2.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as we,d as xe,m as Ts}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Ni,reauthenticateWithCredential as Fi,verifyBeforeUpdateEmail as Ri,updatePassword as Hi,updateProfile as Oi,setPersistence as zi,browserLocalPersistence as _i,onAuthStateChanged as Vi,signOut as Ui}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as Ae,getDoc as bs,updateDoc as Bt,setDoc as Wi,addDoc as vo,collection as Sa,query as yo,where as wo,getDocs as Ji,deleteDoc as Gi,arrayUnion as Qi,orderBy as Xi,onSnapshot as Yi}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{a as L,e as v,s as G,b as f,c as Ne,r as $a,f as Na,i as Zi}from"./utils-JfzC6GFr.js";import{getToken as Ki,onMessage as er}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const g={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function tr(t,e,a){g.establishmentId=t,g.establishmentName=e,g.userPermissions=a,g.currentViewContext={type:"BRANCH",id:t,name:e}}const Ea=(t,e,a,s=null)=>{let i=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(i+=`&professionalId=${s}`),L(i)},ar=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return L(s)},sr=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const i=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return L(i)},or=t=>L("/api/appointments",{method:"POST",body:JSON.stringify(t)}),ir=(t,e)=>L(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),rr=t=>L(`/api/appointments/${t}`,{method:"DELETE"}),nr=t=>L(`/api/appointments/${t}/reopen`,{method:"POST"}),lr=(t,e)=>L(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)}),ne=document.getElementById("sidebar"),Ve=document.getElementById("sidebarToggle"),kt=document.getElementById("mainContent"),dr=document.querySelectorAll(".sidebar-link"),Wa=document.getElementById("menu-search"),Bs=document.getElementById("hamburger-menu-btn"),it=document.getElementById("mobile-overlay");let Me=!0;function He(t){if(!ne||!kt)return;ne.classList.toggle("collapsed",t),kt.classList.toggle("sidebar-collapsed-shift",t);const e=ne.querySelector(".sidebar-search-container"),a=ne.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const i=s.getAttribute("data-target-submenu"),o=document.getElementById(i),r=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),r&&r.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function cr(){!ne||!it||(ne.classList.add("mobile-open"),it.classList.add("visible"))}function Nt(){!ne||!it||(ne.classList.remove("mobile-open"),it.classList.remove("visible"))}function ur(){He(!ne.classList.contains("collapsed"))}function pr(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&ne.classList.contains("collapsed")&&He(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function br(){Wa&&Wa.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),i=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),i.forEach(o=>o.style.display="block");return}i.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const r=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!r)return;if(r.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=r.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function mr(t,e,a){if(!ne||!kt)return;kt.classList.add("main-content-shift"),window.innerWidth>=1024?(Me=!0,He(!1)):window.innerWidth>=768?(Me=!1,He(!0)):(kt.classList.remove("main-content-shift","sidebar-collapsed-shift"),Nt()),Ve&&Ve.addEventListener("click",i=>{i.stopPropagation(),window.innerWidth>=768?(Me=!Me,He(!Me),Me?(Ve.classList.add("text-indigo-400"),Ve.classList.remove("text-gray-400")):(Ve.classList.remove("text-indigo-400"),Ve.classList.add("text-gray-400"))):ur()}),ne.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Me&&ne.classList.contains("collapsed")&&He(!1)}),ne.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Me){const i=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===Wa;!i&&!o&&He(!0)}}),Bs&&Bs.addEventListener("click",i=>{i.stopPropagation(),cr()}),it&&it.addEventListener("click",i=>{i.stopPropagation(),Nt()});let s=0;ne.addEventListener("touchstart",i=>{s=i.changedTouches[0].screenX},{passive:!0}),ne.addEventListener("touchend",i=>{const o=i.changedTouches[0].screenX;s-o>50&&Nt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(i=>{i.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const r=i.getAttribute("data-target-submenu"),n=i.querySelector(".submenu-arrow");pr(r,n)})}),br(),dr.forEach(i=>{const o=i.getAttribute("data-target");if(!o)return;const r=o.replace("-section",""),n=a?.[r]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){i.parentElement&&i.parentElement.tagName==="LI"?i.parentElement.style.display="none":i.style.display="none";return}i.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),i.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&Nt()})})}const gr=t=>L("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),ke=()=>L("/api/establishments/hierarchy",{method:"GET"}),je=t=>{const e=t||g.establishmentId;return e?L(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ms=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},fr=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},xr=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Le=t=>L(`/api/professionals/${t}`),ko=t=>L(`/api/professionals/details/${t}`),hr=t=>L("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Ja=(t,e)=>L(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),So=t=>L(`/api/professionals/${t}`,{method:"DELETE"}),vr=t=>{const e=t.map(a=>So(a));return Promise.all(e)};class yr{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const i=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${i.top+window.scrollY-o}px`,this.spotlight.style.left=`${i.left+window.scrollX-o}px`,this.spotlight.style.width=`${i.width+o*2}px`,this.spotlight.style.height=`${i.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(i)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
            <div class="p-5">
    ...
    `;try{const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),s=new Date(a);s.setHours(23,59,59,999);const i=new Date(a.getFullYear(),a.getMonth(),1),o=new Date(a.getFullYear(),a.getMonth()+1,0),r=new Date(a);r.setDate(a.getDate()-6);const n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=n.map(async q=>{const[ee,le]=await Promise.all([Ea(q,i.toISOString(),s.toISOString(),null).catch(()=>[]),ut(q).catch(()=>[])]);return{appts:ee,clients:le}}),u=Promise.all([Da({startDate:Se(i),endDate:Se(o),establishmentId:l}).catch(()=>({entries:[]})),xs({startDate:Se(i),endDate:Se(o),establishmentId:l}).catch(()=>({entries:[]}))]),[c,[p,b]]=await Promise.all([Promise.all(d),u]);let m=[],h=[];c.forEach(q=>{m=m.concat(q.appts),h=h.concat(q.clients)});const y=p.entries||[],k=b.entries||[],M=Se(a),P=y.filter(q=>q.status==="paid").reduce((q,ee)=>q+ee.amount,0),$=k.filter(q=>q.status==="paid").reduce((q,ee)=>q+ee.amount,0),I=P-$,N=y.filter(q=>q.status==="paid"&&(q.paymentDate===M||!q.paymentDate&&q.dueDate.startsWith(M))).reduce((q,ee)=>q+ee.amount,0),U=m.filter(q=>{const ee=new Date(q.startTime);return ee>=a&&ee<=s}),C=U.length,D=m.filter(q=>q.status==="completed"),V=D.length>0?P/D.length:0,T=U.filter(q=>new Date(q.startTime).getTime()>=e.getTime()&&q.status!=="completed"&&q.status!=="cancelled").sort((q,ee)=>new Date(q.startTime)-new Date(ee.startTime)).slice(0,4).map(q=>({client:q.clientName||"Desconhecido",service:q.serviceName||(q.services&&q.services[0]?q.services[0].name:"Serviço"),time:new Date(q.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(q.professionalName||"").split(" ")[0]||"Profissionais",id:q.id})),B=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,R=new Map;h.forEach(q=>{q.phone?R.set(q.phone,q):R.set(q.id||Math.random().toString(),q)});const te=Array.from(R.values()).filter(q=>{if(!q.birthDate)return!1;let ee,le;if(q.birthDate.includes("-")){const W=q.birthDate.split("-");W[0].length===4?(ee=W[1],le=W[2]):(le=W[0],ee=W[1])}else if(q.birthDate.includes("/")){const W=q.birthDate.split("/");le=W[0],ee=W[1]}return`${le}/${ee}`===B}).map(q=>{let ee="";return q.birthDate&&q.birthDate.includes("-")&&q.birthDate.split("-")[0].length===4&&(ee=a.getFullYear()-parseInt(q.birthDate.split("-")[0])),{name:q.name,age:ee,phone:q.phone}}),re={receitaHoje:N,agendamentosHoje:C,receitaMes:P,despesaMes:$,saldoMes:I,ticketMedio:V},Z=n.length>1;on(t,re,T,te,Z,Se(r),Se(a)),await Ho(r,a),nn()}catch(e){console.error("Erro ao carregar dashboard:",e),t.innerHTML=`
        ...
        `}}function on(t,e,a,s,i,o,r){const n=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),l=i?`
    ...
    `}async function Ho(t,e){const a=document.getElementById("chart-container"),s=document.getElementById("chart-start-date"),i=document.getElementById("chart-end-date");if(a){const o=document.createElement("div");o.id="chart-loading-overlay",o.className="absolute inset-0 bg-white/70 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-xl",o.innerHTML='<div class="w-8 h-8 border-[3px] border-indigo-100 border-t-indigo-500 rounded-full animate-spin"></div>',a.appendChild(o)}try{const o=Se(t),r=Se(e),n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=await Da({startDate:o,endDate:r,establishmentId:l}).catch(()=>({entries:[]})),u=n.map(P=>Ea(P,o+"T00:00:00.000Z",r+"T23:59:59.999Z",null).catch(()=>[])),p=(await Promise.all(u)).flat(),b=d.entries||[],m=[],h=[],y=[];let k=new Date(t);k.setHours(0,0,0,0);const M=new Date(e);for(M.setHours(23,59,59,999);k<=M;){const P=Se(k);m.push(k.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}));const $=b.filter(N=>N.status==="paid"&&(N.paymentDate===P||!N.paymentDate&&N.dueDate.startsWith(P))).reduce((N,U)=>N+U.amount,0),I=p.filter(N=>N.status==="completed"&&N.startTime&&N.startTime.startsWith(P)).length;h.push($),y.push(I),k.setDate(k.getDate()+1)}rn(m,h,y),s&&(s.value=o),i&&(i.value=r)}catch(o){console.error("Erro ao recarregar grafico:",o)}finally{const o=document.getElementById("chart-loading-overlay");o&&o.remove()}}function rn(t,e,a){const s=document.getElementById("revenueChart");if(!s)return;Ra&&Ra.destroy();const o=s.getContext("2d").createLinearGradient(0,0,0,240);o.addColorStop(0,"rgba(99, 102, 241, 0.2)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)"),Ra=new Chart(s,{type:"line",data:{labels:t,datasets:[{label:"Receita Real (R$)",data:e,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.3,yAxisID:"y"},{label:"Agendamentos Feitos",data:a,borderColor:"#10b981",backgroundColor:"transparent",borderWidth:2,borderDash:[5,5],pointBackgroundColor:"#10b981",pointBorderColor:"#ffffff",pointBorderWidth:1,pointRadius:3,pointHoverRadius:5,fill:!1,tension:.3,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,boxHeight:6,font:{family:"Nunito, sans-serif",size:10,weight:"bold"},color:"#64748b"}},tooltip:{backgroundColor:"#1e293b",padding:10,cornerRadius:8,titleFont:{size:11,family:"Nunito, sans-serif",weight:"normal"},bodyFont:{size:12,weight:"bold",family:"Nunito, sans-serif"},displayColors:!0,usePointStyle:!0,callbacks:{label:function(r){return r.datasetIndex===0?"Receita: "+new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(r.parsed.y):"Concluídos: "+r.parsed.y}}}},scales:{y:{type:"linear",display:!0,position:"left",beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"},maxTicksLimit:6,callback:function(r){return"R$ "+r}}},y1:{type:"linear",display:!0,position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1},border:{display:!1},ticks:{color:"#10b981",font:{family:"Nunito, sans-serif",size:9,weight:"600"},stepSize:1,callback:function(r){if(Math.floor(r)===r)return r}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"}}}},interaction:{intersect:!1,mode:"index"}}})}function nn(){document.getElementById("content").addEventListener("click",e=>{if(e.target.closest("#btn-update-chart")){const o=document.getElementById("chart-start-date"),r=document.getElementById("chart-end-date");if(o&&r&&o.value&&r.value){const n=new Date(o.value+"T00:00:00"),l=new Date(r.value+"T00:00:00");Ho(n,l)}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"goto-agenda":case"new-appointment":oe("agenda-section");break;case"goto-pdv":oe("comandas-section");break;case"goto-clients":oe("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${g.establishmentId||""}`;window.open(o,"_blank");break}})}const pt=t=>L(`/api/services/${t}`),ln=t=>L("/api/services",{method:"POST",body:JSON.stringify(t)}),dn=(t,e)=>L(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Oo=t=>L(`/api/services/${t}`,{method:"DELETE"}),Pa=(t,e,a,s="all")=>{const i=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return L(i)},Ta=t=>L("/api/blockages",{method:"POST",body:JSON.stringify(t)}),hs=t=>L(`/api/blockages/${t}`,{method:"DELETE"}),zo=t=>L("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Fs=document.getElementById("content");let Rs=!1;const ba=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Ba=[],Ga=[],ma={},_o=[],O={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},H={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Vo(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function oa(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}function vs(){const t=document.getElementById("profSelectorContainer");if(!t||!g.professionals)return;let e=g.professionals.filter(i=>O.showInactiveProfs||i.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(i=>{const o=O.selectedProfessionalId===i.id,r=i.name==="Todos"?"T":i.name.charAt(0).toUpperCase(),n=i.id!=="all"?g.professionalColors.get(i.id)||ba[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        </div>`}o+="</div>",e.innerHTML=o,requestAnimationFrame(()=>{const r=document.getElementById("weekScroller");if(r&&window.innerWidth<768){const n=r.querySelector(".is-today");n&&n.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})}})}function bn(t){const e=document.getElementById("agenda-view");if(!e)return;if(t.sort((s,i)=>new Date(s.startTime)-new Date(i.startTime)),t.length===0){e.innerHTML=`
        ...
        </div>`}}function hn(){return{title:"Serviços",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            ...
            <div id="apptServicesContainer" class="flex-1 overflow-y-auto grid grid-cols-2 gap-3 content-start pb-4">
                ${Ba.map(t=>`<div class="service-card p-3 bg-white rounded-xl border-2 transition-all active:scale-95 ${H.data.selectedServiceIds.includes(t.id)?"border-indigo-500 bg-indigo-50 shadow-md":"border-gray-100 hover:border-gray-200 shadow-sm"} cursor-pointer flex flex-col justify-between gap-2" data-service-id="${t.id}">
                        <div>
        ...
        </div>`}}function vn(){return{title:"Equipe",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            <div class="relative">
                <i class="bi bi-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-base"></i>
        ...
        </div>`}}function yn(){const t=H.data.date||oa();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
        ...
        </div>`}}async function Qa(t=null,e=!1){const a=document.getElementById("appointmentModal");e||(H={step:1,data:{id:t?.id||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(r=>r.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:t?.startTime?oa(new Date(t.startTime)):oa(),time:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,originalDate:t?.startTime?oa(new Date(t.startTime)):null,originalTime:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}}),Ba=g.services||[],Ga=(g.professionals||[]).filter(r=>r.status==="active");let s;switch(H.step){case 1:s=xn(t);break;case 2:s=hn();break;case 3:s=vn();break;case 4:s=yn();break}a.className="fixed inset-0 z-[10000] hidden flex items-end md:items-center justify-center bg-gray-900/50 backdrop-blur-sm transition-opacity duration-300 opacity-0",a.innerHTML=`
    ...
    `,Aa(),Ss()}function Ss(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function Aa(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierFromPreviousDay?(t&&(t.innerHTML=`
        ...
        `),e&&(e.classList.add("opacity-50","cursor-not-allowed"),e.disabled=!0)),Rn()}function Rn(){const t=document.getElementById("cashier-controls");t&&(x.isCashierFromPreviousDay?t.innerHTML=`
    ...
    `,t.appendChild(o),o.querySelectorAll("button[data-page]").forEach(r=>{r.onclick=n=>{n.stopPropagation();const l=parseInt(r.dataset.page,10);l>0&&l<=i&&(x.paging.page=l,$e())}})}function Hn(t,e){const a=`
    ...
    `;t.innerHTML=`
        ...
        ${p}
        ${b}
    `,!i&&(e.clientId||e.clientName)&&_n(e,t.querySelector("#loyalty-container"))}function zn(t,e){const s=qe(t).reduce((b,m)=>b+Number(m.price||0)*(m.quantity||1),0),i=x.checkoutState,o=i.discount||{type:"real",value:0};let r=0;o.type==="percent"?r=s*o.value/100:r=o.value,r>s&&(r=s);const n=s-r,l=i.payments.reduce((b,m)=>b+m.value,0),d=Math.max(0,n-l);(!i.amountReceived||d>0)&&(i.amountReceived=d.toFixed(2));const u=`
    ...
    `,maxWidth:"max-w-sm"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",Jn)}async function Jn(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const a=e.querySelector("#regClientName"),i=e.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!i)return f("Erro","Nome e Telefone são obrigatórios.","error");let o=null;try{o=await Jr(g.establishmentId,i)}catch{console.log("Cliente não encontrado na base, prosseguindo com criação...")}try{if(o&&o.id)f("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",Ya(o);else{const r=await Po({establishmentId:g.establishmentId,name:a.value,phone:i});f("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",Ya(r)}}catch(r){f("Erro ao cadastrar",r.message,"error")}}async function Gn(){const t=`
...
(Clique para ver)`}}}},onClick:(I,N)=>{if(N.length>0){const U=N[0].index,C=N[0].datasetIndex,D=r[U];let V="all";C===0||C===1?V="receita":(C===2||C===3)&&(V="despesa"),ol(D,V,o[D].items,i)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:I=>ce(Math.abs(I))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:I=>ce(I)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(I=>{I.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",I.onclick=N=>{const U=N.currentTarget,C=parseInt(U.dataset.dataset),D=j.charts.fin;D.isDatasetVisible(C)?(D.hide(C),U.style.opacity="0.4",U.style.background="#f8f9fa"):(D.show(C),U.style.opacity="1",U.style.background="")}}))},100)}function ol(t,e,a,s){let i=document.getElementById("genericModal");i||(i=document.createElement("div"),i.id="genericModal",i.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(i));const o=e==="all"?a:a.filter(l=>l._type===e);let r=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";i.innerHTML=`
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",xl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),hl(i.dataset.id))}))}$s()}function yl(t=[]){if(!z.hierarchyCache||z.hierarchyCache.length===0)return`
    ...
    `,Pl()}function Pl(){const t=document.getElementById("main-tab-content");if(t){if(E.currentTab==="catalogo")t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",ga),ga()}}}async function Ee(){const t=Es();try{const e=t.map(n=>bt(n)),a=t.map(n=>ja(n,"products")),[s,i]=await Promise.all([Promise.all(e),Promise.all(a)]),o=new Map;s.flat().filter(Boolean).forEach(n=>o.set(n.id,n)),E.products=Array.from(o.values()),g.products=E.products;const r=new Map;i.flat().filter(Boolean).forEach(n=>r.set(n.id,n)),E.categories=Array.from(r.values()),g.categories=E.categories,E.currentTab==="catalogo"?(ni(),Fe()):E.currentTab==="movimentacoes"&&ga(),E.suppliers=[],t.forEach(async n=>{try{let l=[];typeof Mt=="function"&&(l=await Mt(n)),l.forEach(d=>{E.suppliers.find(u=>u.id===d.id)||E.suppliers.push(d)}),g.suppliers=E.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function ni(){const t=document.getElementById("filterCategoryId");t&&E.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',E.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),E.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function is(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=E.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function St(){const t=document.getElementById("movement-batch-action-bar"),e=document.getElementById("mov-selected-count"),a=E.selectedMovementIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Tl(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,i=0,o=0,r=0;t.forEach(n=>{const l=n.currentStock||0,d=n.minStock||0;n.active!==!1&&n.price&&l>0&&(r+=n.price*l),l<=0?o++:d>0&&l<=d||d>0&&l<=d*1.2?i++:s++}),e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function Fe(){const t=document.getElementById("productsList");if(!t)return;if(E.products===null){t.innerHTML=li(8);return}const e=Es(),a=E.products.filter(i=>{const o=i.name.toLowerCase().includes(E.searchQuery)||i.sku&&i.sku.toLowerCase().includes(E.searchQuery)||i.barcode&&i.barcode.toLowerCase().includes(E.searchQuery),r=i.currentStock||0,n=i.minStock||0;let l=!0;E.stockFilter==="ok"&&(l=r>0&&(n===0||r>n*1.2)),E.stockFilter==="alert"&&(l=n>0&&r>0&&r<=n*1.2),E.stockFilter==="empty"&&(l=r<=0);const d=E.filterCategoryId==="all"||i.categoryId===E.filterCategoryId,u=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],c=e.some(p=>u.includes(p));return o&&l&&d&&c});if(Tl(a),a.length===0){E.products.length===0?t.innerHTML=`
        ...
        `;return e}async function Bl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=E.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await ti({establishmentId:g.establishmentId,name:s,accessibleIn:o},"products"),ie(g.establishmentId,ze(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await Is(),await Ee()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function Ml(t){if(await G("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ai(t,"products"),ie(g.establishmentId,ze(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await Is(),await Ee()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function Is(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await ja(g.establishmentId,"products");E.categories=e,e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-white p-3 rounded-xl border border-slate-200 mb-2 shadow-sm">
                    <span class="text-xs font-black text-slate-700 uppercase tracking-widest">${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-white w-8 h-8 flex items-center justify-center bg-red-50 hover:bg-red-600 rounded-lg transition-colors border border-red-100 active:scale-95"><i class="bi bi-trash3 pointer-events-none"></i></button>
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Bl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),Ml(i.dataset.id))}))}Is()}function jl(){const t=(E.products||[]).map(r=>`<option value="${r.id}">${v(r.name)} (Estoque: ${r.currentStock||0})</option>`).join(""),e=E.hierarchyCache.reduce((r,n)=>(r.push(`<option value="${n.id}">🏢 ${v(n.name)}</option>`),n.branches&&n.branches.forEach(l=>r.push(`<option value="${l.id}">📍 ${v(l.name)}</option>`)),r),[]).join(""),a=document.getElementById("movement-modal-inner"),s=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
    ...
    `,e.querySelectorAll(".tab-link").forEach(T=>{T.addEventListener("click",B=>{B.preventDefault(),e.querySelectorAll(".tab-link").forEach(R=>{R.classList.remove("active","border-indigo-600","text-indigo-600"),R.classList.add("border-transparent","text-slate-400")}),T.classList.add("active","border-indigo-600","text-indigo-600"),T.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(R=>R.classList.add("hidden")),e.querySelector("#"+T.dataset.tab).classList.remove("hidden")})});const M=()=>{const T=document.getElementById("modalSupplierSearch"),B=document.getElementById("supplierSearchResults"),R=document.getElementById("selectedSuppliersList"),Y=T?.value.toLowerCase()||"",te=E.suppliers||[];if(Y.length>0){const re=te.filter(Z=>Z.name.toLowerCase().includes(Y)&&!E.tempSupplierIds.has(Z.id));re.length>0?(B.classList.remove("hidden"),B.innerHTML=re.map(Z=>`
            ...
            </div>`;t.innerHTML=r}catch(a){f("Erro",`Não foi possível gerar: ${a.message}`,"error"),t.innerHTML='<div class="p-8 text-center text-red-500 font-bold bg-red-50 rounded-xl m-4 border border-red-100">Falha ao buscar movimentações.</div>'}}function Hl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Ee),t.addEventListener("click",()=>{setTimeout(Ee,100)})),_t&&document.body.removeEventListener("click",_t),Vt&&ss.removeEventListener("input",Vt),_t=async e=>{const a=e.target.closest("[data-main-tab]");if(a){E.currentTab=a.dataset.mainTab,ri(),E.currentTab==="catalogo"&&E.products!==null&&(ni(),Fe());return}if(e.target.classList.contains("product-checkbox")){const c=e.target.dataset.id;e.target.checked?E.selectedIds.add(c):E.selectedIds.delete(c),is(),e.stopPropagation();return}if(e.target.closest("#cancel-selection-btn")){E.selectedIds.clear(),is(),Fe();return}if(e.target.classList.contains("movement-checkbox")){const c=e.target.dataset.id;e.target.checked?E.selectedMovementIds.add(c):E.selectedMovementIds.delete(c),St();const p=e.target.closest("tr");e.target.checked?(p.classList.add("bg-indigo-50/30"),p.classList.remove("hover:bg-slate-50/50")):(p.classList.remove("bg-indigo-50/30"),p.classList.add("hover:bg-slate-50/50")),e.stopPropagation();return}if(e.target.id==="selectAllMovements"){const c=document.querySelectorAll(".movement-checkbox"),p=e.target.checked;c.forEach(b=>{b.checked=p;const m=b.dataset.id;p?E.selectedMovementIds.add(m):E.selectedMovementIds.delete(m);const h=b.closest("tr");p?(h.classList.add("bg-indigo-50/30"),h.classList.remove("hover:bg-slate-50/50")):(h.classList.remove("bg-indigo-50/30"),h.classList.add("hover:bg-slate-50/50"))}),St(),e.stopPropagation();return}if(e.target.closest("#cancel-mov-selection-btn")){E.selectedMovementIds.clear(),St();const c=document.getElementById("selectAllMovements");c&&(c.checked=!1),document.querySelectorAll(".movement-checkbox").forEach(p=>{p.checked=!1;const b=p.closest("tr");b.classList.remove("bg-indigo-50/30"),b.classList.add("hover:bg-slate-50/50")});return}const o=e.target.closest(".status-filter-btn");if(o){E.stockFilter=o.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(c=>{c.classList.remove("bg-indigo-600","text-white","border-indigo-600","bg-emerald-600","border-emerald-600","bg-amber-500","border-amber-500","bg-red-600","border-red-600"),c.classList.add("bg-white","text-slate-600","border-slate-200")}),E.stockFilter==="ok"?o.classList.add("bg-emerald-600","text-white","border-emerald-600"):E.stockFilter==="alert"?o.classList.add("bg-amber-500","text-white","border-amber-500"):E.stockFilter==="empty"?o.classList.add("bg-red-600","text-white","border-red-600"):o.classList.add("bg-indigo-600","text-white","border-indigo-600"),o.classList.remove("bg-white","text-slate-600","border-slate-200"),Fe();return}if(e.target.id==="clear-filters-btn"){e.preventDefault(),document.getElementById("filterCategoryId").value="all",E.filterCategoryId="all",Fe();return}if(e.target.id==="apply-filter-btn"){e.preventDefault(),E.filterCategoryId=document.getElementById("filterCategoryId").value,Fe();return}const r=e.target.closest("#toggle-filter-btn");if(r){e.preventDefault(),E.isAdvancedFilterOpen=!E.isAdvancedFilterOpen;const c=document.getElementById("filter-panel");E.isAdvancedFilterOpen?(c.classList.remove("hidden"),c.classList.add("block"),r.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.remove("bg-white","text-slate-700","border-slate-200")):(c.classList.add("hidden"),c.classList.remove("block"),r.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.add("bg-white","text-slate-700","border-slate-200"));return}if(e.target.id==="products-layout-detail"){ia();return}if(e.target.id==="movement-layout-detail"){os();return}const n=e.target.closest("[data-add-supplier]");if(n){E.tempSupplierIds.add(n.dataset.addSupplier);const c=document.getElementById("modalSupplierSearch");c&&(c.value=""),c.dispatchEvent(new Event("input"));return}const l=e.target.closest("[data-remove-supplier]");if(l){E.tempSupplierIds.delete(l.dataset.removeSupplier);const c=document.getElementById("modalSupplierSearch");c&&c.dispatchEvent(new Event("input"));return}const d=e.target.closest("[data-action]");if(!d)return;const u=d.dataset.action;switch(["close-detail-screen","close-movement-modal","delete-product","manage-categories","open-product-editor","batch-delete","open-new-movement-modal","batch-delete-movements"].includes(u)&&e.stopPropagation(),u){case"manage-categories":Al();break;case"open-product-editor":Nl(d.dataset.id);break;case"close-detail-screen":ia();break;case"close-movement-modal":os();break;case"batch-delete":Fl();break;case"batch-delete-movements":Rl();break;case"open-new-movement-modal":jl();break;case"delete-movement":{const c=d.dataset.id,p=d.dataset.productId,b=d.dataset.estId;if(!c)return;const m=E.allMovements.find(y=>y.id===c);if(!m){f("Aviso","Não foi possível ler os detalhes desta movimentação.","warning");return}if(await G("Estornar e Apagar Movimentação","Tem a certeza que deseja excluir esta movimentação? O saldo de stock será devolvido ao produto de forma automática."))try{throw await Ma(p,{change:-m.change,reason:"Estorno automático de exclusão de movimento",establishmentId:b}),new Error("A função de excluir movimentação ainda não está implementada no servidor.");ie(g.establishmentId,ze(),"Estoque","Excluiu Movimento",`Excluiu e estornou a movimentação ID: ${c}`),f("Sucesso","Movimentação excluída e saldo de stock estornado.","success"),await Ee()}catch(y){f("Erro",y.message,"error")}break}case"delete-product":{const c=d.dataset.id;if(!c)return;if(await G("Apagar Produto","Tem certeza que deseja excluir este produto do estoque?"))try{const b=E.products.find(m=>m.id===c)?.name||"Desconhecido";await ws(c),ie(g.establishmentId,ze(),"Produtos","Excluiu",`Excluiu o produto: ${b}`),f("Sucesso","Produto removido do estoque.","success"),ia(),await Ee()}catch(b){f("Erro",`Não foi possível apagar o produto: ${b.message}`,"error")}break}}},document.body.addEventListener("click",_t),Vt=e=>{e.target.id==="searchInput"&&(E.searchQuery=e.target.value,Fe())},ss.addEventListener("input",Vt)}const ra=document.getElementById("content");let J={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},Ut=null;const fa={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},di=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function Ol(){try{const e=(await ke()).matrizes||[];J.establishments=[],e.forEach(a=>{J.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>J.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.warn("Erro ao buscar lojas",t)}J.viewMode="list",J.editingItem=null,J.hasSearched=!1,J.partners=[],zl(),Gl(),ci()}function zl(){ra.innerHTML=`
    ...
    `}function _l(){const t=Object.entries(fa).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=di.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Vl(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(fa).map(([r,n])=>`<option value="${r}" ${a===r?"selected":""}>${n.label}</option>`).join(""),i=di.map(r=>`<option value="${r}" ${t?.state===r?"selected":""}>${r}</option>`).join(""),o=document.getElementById("form-container-wrapper");o&&(o.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Wl))}function ci(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
    ...
    `}async function xa(){const t=document.getElementById("professionalsList"),e=pi();try{const a=e.map(l=>Le(l)),s=e.map(l=>pt(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),_.professionals=Array.from(r.values()),g.professionals=_.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),_.services=Array.from(n.values()),Zl(),yt()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function Zl(){const t=document.getElementById("filterServiceId");t&&_.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',_.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),_.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function bi(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=_.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Kl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,i=a-s;e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `,td(a,_.services),sd(a),await id(a,_.professionals),rd(a),Ql()}function td(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const i=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,b=p==i[1]?"selected":"",m=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${m.charAt(0).toUpperCase()+m.slice(1)}</option>`}).join(""),r=v(t.name||""),n=v(t.specialty||""),l=v(t.phone||""),d=v(t.notes||"");a.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-1 space-y-4">
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-center flex flex-col items-center">
    ...
    `}function ad(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${g.establishmentId}">
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-500 text-center">
                <i class="bi bi-info-circle text-2xl block mb-2 text-slate-400"></i> Exclusivo desta unidade.
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function sd(t){const e=document.getElementById("jornada");e&&(e.innerHTML=`
        <div class="bg-white p-5 md:p-8 rounded-3xl border border-slate-200 shadow-sm">
        ...
        </div>`,od(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function od(t,e){t.innerHTML=Object.keys(Js).map(a=>{const s=e[a]||{},i=s.active!==!1;return`
            ...
            </div>`}).join(""),t.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",s=>{const i=s.target.closest(".day-schedule-card"),o=!s.target.checked;i.classList.toggle("bg-white",!o),i.classList.toggle("shadow-sm",!o),i.classList.toggle("border-slate-200",!o),i.classList.toggle("bg-slate-50",o),i.classList.toggle("border-slate-100",o),i.classList.toggle("opacity-60",o),i.classList.toggle("disabled",o),i.querySelectorAll(".time-inputs input").forEach(r=>r.disabled=o)})})}async function id(t,e){const a=document.getElementById("bloqueios");if(!a)return;a.innerHTML=`
    ...
    `}function pd(){const t=document.getElementById("table-header-container");if(!t)return;const e=a=>w.sortConfig.key!==a?'<i class="bi bi-arrow-down-up ml-1 opacity-40 text-xs"></i>':w.sortConfig.direction==="asc"?'<i class="bi bi-arrow-up ml-1 text-indigo-600"></i>':'<i class="bi bi-arrow-down ml-1 text-indigo-600"></i>';t.innerHTML=`
    ...
    `,t.querySelectorAll(".tab-link").forEach(l=>{l.addEventListener("click",d=>{d.preventDefault(),t.querySelectorAll(".tab-link").forEach(u=>{u.classList.remove("active","border-indigo-600","text-indigo-600"),u.classList.add("border-transparent","text-slate-400")}),l.classList.add("active","border-indigo-600","text-indigo-600"),l.classList.remove("border-transparent","text-slate-400"),t.querySelectorAll(".tab-content").forEach(u=>u.classList.add("hidden")),t.querySelector("#"+l.dataset.tab).classList.remove("hidden")})});const r=t.querySelector("#form-edit-client");r&&(r.onsubmit=vd);const n=t.querySelector('[data-action="delete-client"]');n&&(n.onclick=yd)}function xd(t){const e=new Date,a=t.filter(o=>new Date(o.date)>=e&&o.status!=="cancelled").sort((o,r)=>new Date(o.date)-new Date(r.date)),s=t.filter(o=>new Date(o.date)<e||o.status==="cancelled").sort((o,r)=>new Date(r.date)-new Date(o.date)),i=(o,r)=>{const n=new Date(o.date);let l=r?'<span class="text-slate-500 bg-slate-100 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-slate-200 shadow-sm">Concluído</span>':'<span class="text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-emerald-200 shadow-sm">Confirmado</span>';o.status==="cancelled"&&(l='<span class="text-red-600 bg-red-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-red-200 shadow-sm">Cancelado</span>');const d=w.establishments.find(u=>u.id===o.establishmentId)?.name||"Unidade Local";return`
    ...
    `}function hd(t){t.sort((s,i)=>new Date(i.date)-new Date(s.date));const e=t.reduce((s,i)=>s+(Number(i.value)||0),0),a=t.length>0?e/t.length:0;return`
        <div class="space-y-6">
            <div class="grid grid-cols-2 gap-3">
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const u={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,cnpj:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};mt(u,d)})}function $d(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const s=e.querySelector("#newPassword").value,i=e.querySelector("#confirmPassword").value;if(s!==i){f("Erro","As senhas não coincidem.","error");return}const o=e.querySelector('button[form="change-password-form"]');o.disabled=!0,o.textContent="A Salvar...";try{const r=we.currentUser;if(r)await Hi(r,s),f("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum utilizador logado encontrado.")}catch(r){f("Erro",`Não foi possível alterar a senha: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Salvar Nova Senha"}})}function Ed(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([Ca(se),fs(se)]),i=t.financialIntegration||{},o=t.commissionConfig||{},r=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=We(a,i.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=We(s,i.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=We(a,r.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=We(s,r.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=We(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=We(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};mt(s,a)})}function Td(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `}function Bd(t,e){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${t.name})`;e.innerHTML=`
    ...
    `,Oe.querySelector('button[data-action="back-to-menu"]').addEventListener("click",i=>{i.preventDefault(),ki({id:se})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":Sd(K,s);break;case"change-password":$d(K,s);break;case"change-email":Ed(K,s);break;case"branding":Id(K,s);break;case"booking":Ld(K,s);break;case"working-hours":Cd(K,s);break;case"whatsapp-bot":wi(K,s);break;case"loyalty":await Dd(K,s);break;case"financial":await Pd(K,s);break;case"pagarme":vi(s);break;case"support":Td(K,s);break;case"cancellation":Bd(K,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function ki(t={}){Oe.innerHTML=`
    ...
    `;try{se=t.id||g.establishmentId,K=await je(se);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
               ...
               </button>`:"",a=K.isMatriz||!K.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=yi();Oe.innerHTML=`
    ...
    `).join("")}const It=document.getElementById("content");async function st(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,i=await Pa(g.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),r=o?i.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):i,n=r.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",r.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;u.innerHTML+=P}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function qd(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,i=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,r=e.querySelector("#blockageEndTime").value,n={establishmentId:g.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Ta(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),st(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Nd(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,i=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,r=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:g.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:n};return Ta(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&st(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Fd(t){It.addEventListener("submit",e=>{e.target.id==="blockageForm"&&qd(e),e.target.id==="batchBlockageForm"&&Nd(e)}),It.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&st(t)}),It.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")oe("profissionais-section");else if(s==="delete-blockage"){if(await G("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await hs(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),st(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const i=JSON.parse(a.dataset.ids);if(await G("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${i.length} bloqueios de uma vez?`))try{await zo(i),f("Sucesso",`${i.length} bloqueios removidos.`,"success"),st(t)}catch(r){f("Erro",`Não foi possível apagar os bloqueios: ${r.message}`,"error")}}})}async function Rd(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){It.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);It.innerHTML=`
        <section>
        ...
        </section>`,Fd(e),await st(e);const i=document.getElementById("batchProfSelectionContainer");try{const o=await Le(g.establishmentId);i.innerHTML=o.map(r=>`
            <div class="flex items-center">
        ...
        `}).join("")}function $i(){const e=document.getElementById("showInactiveUsersToggle")?.checked?g.users:g.users.filter(a=>a.status==="active");Gd(e)}function Qd(t={}){let e="",a=!1;for(const[s,i]of Object.entries(Wd)){const o=Object.entries(i).filter(([r,n])=>{const l=r.replace("-section","");return!(g.enabledModules&&g.enabledModules[l]===!1)});o.length!==0&&(a=!0,e+=`
        ...
        `,o.forEach(([r,n])=>{const l=r==="agenda-section"||r==="comandas-section",d=t[r]?.view_all_prof===!0,u=Object.entries(Jd).map(([p,b])=>`
    ...
    `}).join(""),r.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ds.transactions[l];d&&to(d)})})}async function ao(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,i=a.value;if(!s||!i)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,r=await pa({establishmentId:g.establishmentId,startDate:s,endDate:i,cashierSessionId:o});ds=r,t.innerHTML=`
        ...
        `,Kd(r)}catch(o){f("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function ec(){Yd();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];Xd.innerHTML=`
    ...
    `,Ci()}function oc(){const t=S.currentTab==="receivables",e=t?S.receivables:S.payables;let a=e;if(S.statusFilter!=="all"&&(a=e.filter(n=>{const l=lt(n.dueDate,n.status);return S.statusFilter==="overdue"?l:S.statusFilter==="pending"?n.status==="pending"&&!l:n.status===S.statusFilter})),S.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(S.searchQuery)||n.entity&&n.entity.toLowerCase().includes(S.searchQuery)||n.notes&&n.notes.toLowerCase().includes(S.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map(S.natures.map(n=>[n.id,n.name])),i=new Map(S.costCenters.map(n=>[n.id,n.name])),o=new Map(S.establishments.map(n=>[n.id,n])),r=a.map(n=>{const l=n.status==="paid",d=lt(n.dueDate,n.status);let u=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const c=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?i.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=o.get(n.establishmentId),m=b?b.name:"Atual",h=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:m,Natureza:c,"Centro de Custo":p,Origem:h,"Documento / NFS":n.documentNumber||"",Status:u,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(r),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const u=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,u)}catch(n){console.error("Erro ao exportar:",n),f("Erro","Não foi possível exportar para Excel.","error")}}function ic(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i.bi-chevron-expand, i.bi-chevron-up, i.bi-chevron-down");if(!e)return;t.dataset.sort===S.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=S.sortAsc?"bi bi-chevron-up ml-1 text-indigo-600 text-[11px] font-black":"bi bi-chevron-down ml-1 text-indigo-600 text-[11px] font-black"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-chevron-expand ml-1 opacity-40 text-[10px] font-black")})}function Li(){document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",r=>{const n=r.currentTarget.dataset.sort;S.sortCol===n?S.sortAsc=!S.sortAsc:(S.sortCol=n,S.sortAsc=!0),Lt()})});const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");S.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&S.selectedIds.add(l.value)}),et()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{S.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),et()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=S.selectedIds.size;if(o===0)return;if(await G("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const n=S.currentTab==="payables"?"payables":"receivables";await No(n,Array.from(S.selectedIds)),f("Sucesso",`${o} itens excluídos.`,"success"),S.selectedIds.clear(),et(),Be()}catch{f("Erro","Falha ao excluir itens.","error")}}),document.getElementById("custom-date-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");S.isAdvancedFilterOpen=!S.isAdvancedFilterOpen,S.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))});const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",oc);const a=document.getElementById("settings-btn");a&&a.addEventListener("click",lc),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(20),io(r.target.closest("button").dataset.type)})});const s=document.getElementById("tab-receivables"),i=document.getElementById("tab-payables");s.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),oo("receivables")}),i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),oo("payables")}),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-gray-900","bg-blue-600","bg-emerald-600","bg-red-600","text-white"),l.classList.add("bg-white","text-gray-600")});const n=r.target.dataset.status;n==="all"?r.target.classList.add("bg-gray-900","text-white"):n==="pending"?r.target.classList.add("bg-blue-600","text-white"):n==="paid"?r.target.classList.add("bg-emerald-600","text-white"):n==="overdue"&&r.target.classList.add("bg-red-600","text-white"),r.target.classList.remove("bg-white","text-gray-600"),S.statusFilter=n,Lt()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=u.toISOString().split("T")[0],S.startDate=d.toISOString().split("T")[0],S.endDate=u.toISOString().split("T")[0],Be()})}),document.getElementById("searchInput").addEventListener("input",o=>{S.searchQuery=o.target.value.toLowerCase(),Lt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",Ii(),Li(),Be()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(20),S.startDate=document.getElementById("filterStartDate").value,S.endDate=document.getElementById("filterEndDate").value,S.filterNaturezaId=document.getElementById("filterNaturezaId").value,S.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("custom-date-btn").click(),Be()}),Kt&&document.body.removeEventListener("click",Kt),Kt=o=>{const r=o.target;if(r.classList.contains("item-checkbox")||r.classList.contains("modal-item-checkbox")){const d=r.value||r.dataset.id;r.checked?S.selectedIds.add(d):S.selectedIds.delete(d),et(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){const{action:d,type:u,id:c}=n.dataset;if(d==="mark-as-paid"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),rc(u,c);return}if(d==="delete"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(30);const p=n.closest(".financial-row").dataset.item;try{Pi(u,JSON.parse(decodeURIComponent(p)))}catch(b){console.error("Parse error on delete",b)}return}if(d==="manage-natures"){o.stopPropagation(),so("nature");return}if(d==="manage-cost-centers"){o.stopPropagation(),so("cost-center");return}if(d==="close-modal"){o.stopPropagation(),At();return}}const l=r.closest(".financial-row");if(l&&document.getElementById("list-container").contains(l)&&!r.closest("button")&&!r.closest(".item-checkbox")){navigator.vibrate&&navigator.vibrate(15);const{type:d}=l.dataset;try{const u=JSON.parse(decodeURIComponent(l.dataset.item));io(d,u)}catch(u){console.error("Parse error on card click",u),f("Erro","Os dados deste lançamento não puderam ser lidos corretamente.","error")}}},document.body.addEventListener("click",Kt),ea&&document.getElementById("genericModal").removeEventListener("click",ea),ea=o=>{const r=o.target.closest('button[data-action^="delete-"]');if(r){const n=r.dataset.action.split("-")[1];handleDeleteHierarchyItem(n,r.dataset.id)}o.target===document.getElementById("genericModal")&&At()},document.getElementById("genericModal").addEventListener("click",ea)}function et(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=S.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}function oo(t){S.currentTab=t,S.selectedIds.clear(),et(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t==="receivables"?(e.classList.add("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.remove("text-gray-500"),a.classList.remove("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.add("text-gray-500")):(a.classList.add("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.remove("text-gray-500"),e.classList.remove("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.add("text-gray-500")),Lt(),Di()}async function Be(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A sincronizar carteira...</p></div>';try{if(S.natures.length===0){const[r,n,l,d,u]=await Promise.all([Ca(g.establishmentId),fs(g.establishmentId),Mt(g.establishmentId).catch(()=>[]),ut(g.establishmentId,"",1e3).catch(()=>[]),Le(g.establishmentId).catch(()=>[])]);S.natures=r||[],S.costCenters=n||[],S.suppliers=l||[],S.clients=d||[],S.professionals=u||[],Ci()}const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(","),s={startDate:S.startDate,endDate:S.endDate,establishmentId:a};S.filterNaturezaId!=="all"&&(s.natureId=S.filterNaturezaId),S.filterCostCenterId!=="all"&&(s.costCenterId=S.filterCostCenterId);const[i,o]=await Promise.all([xs(s),Da(s)]);S.payables=i.entries||[],S.receivables=o.entries||[],Di(),Lt()}catch(e){t.innerHTML=`
            ...
            </div>`}}function Ci(){const t=s=>{let i='<option value="all">Todas as categorias</option>';const o=Cs(s),r=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");i+=`<option value="${n.id}">${d}${v(n.name)}</option>`,n.children.forEach(u=>r(u,l+1))};return o.forEach(n=>r(n)),i},e=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");e&&(e.innerHTML=t(S.natures)),a&&(a.innerHTML=t(S.costCenters))}function Di(){const t=document.getElementById("summary-section");if(!t)return;const e=S.currentTab==="receivables";let s=e?S.receivables:S.payables;S.searchQuery&&(s=s.filter(u=>u.description&&u.description.toLowerCase().includes(S.searchQuery)||u.entity&&u.entity.toLowerCase().includes(S.searchQuery)||u.notes&&u.notes.toLowerCase().includes(S.searchQuery)));const i=s.reduce((u,c)=>u+c.amount,0),o=s.filter(u=>u.status==="paid").reduce((u,c)=>u+c.amount,0),r=s.filter(u=>u.status==="pending"&&!lt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),n=s.filter(u=>lt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),l=e?"emerald":"red",d=e?"bi-arrow-down-left-circle-fill text-emerald-500":"bi-arrow-up-right-circle-fill text-red-500";t.innerHTML=`
    ...
    `}function Lt(){const t=document.getElementById("list-container");if(!t)return;const e=S.currentTab==="receivables",a=e?S.receivables:S.payables;let s=a;if(S.statusFilter!=="all"&&(s=a.filter(c=>{const p=lt(c.dueDate,c.status);return S.statusFilter==="overdue"?p:S.statusFilter==="pending"?c.status==="pending"&&!p:c.status===S.statusFilter})),S.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(S.searchQuery)||c.entity&&c.entity.toLowerCase().includes(S.searchQuery)||c.notes&&c.notes.toLowerCase().includes(S.searchQuery))),s.sort((c,p)=>{let b=c[S.sortCol],m=p[S.sortCol];return S.sortCol==="dueDate"?(b=new Date(b).getTime(),m=new Date(m).getTime()):(S.sortCol==="description"||S.sortCol==="status")&&(b=b?b.toLowerCase():"",m=m?m.toLowerCase():""),b<m?S.sortAsc?-1:1:b>m?S.sortAsc?1:-1:0}),ic(),s.length===0){t.innerHTML=`
        ...
        `}).join("")}async function rc(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?Zr(e,a):an(e,a)),f("Baixa Realizada","O lançamento foi registado como pago.","success"),await Be()}catch(s){f("Erro",s.message,"error")}}async function Pi(t,e){if(!!!e.recurrenceId){await G("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Ti(t,[e.id]);return}nc(t,e)}function nc(t,e){const a=document.getElementById("genericModal"),i=(t==="payable"?S.payables:S.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,u)=>new Date(d.dueDate)-new Date(u.dueDate));a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",a.innerHTML=`
        <div id="modal-content-wrapper" class="w-full md:max-w-2xl bg-gray-50 md:bg-white flex flex-col transform transition-all duration-300 translate-y-full md:translate-y-0 md:scale-95 md:opacity-0 h-full md:h-auto md:max-h-[90vh] rounded-t-3xl md:rounded-3xl overflow-hidden shadow-2xl relative" style="font-family: 'Plus Jakarta Sans', 'Nunito', sans-serif;">
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar bg-gray-50 pb-safe md:pb-4">
                ${i.map(d=>{const u=d.id===e.id,c=d.status==="paid",p=Ei(d.dueDate);return`
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const C=a.querySelector("#modal-content-wrapper");C&&(C.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),C.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let b="single",m=2;const h=p.querySelector("#modal-delete-btn");h&&h.addEventListener("click",C=>{C.preventDefault(),navigator.vibrate&&navigator.vibrate(30),At(),setTimeout(()=>Pi(t,e),300)});const y=p.querySelector('[name="amount"]'),k=p.querySelector("#recurrence-options"),M=p.querySelector("#recurrence-summary"),P=p.querySelector("#installments-input"),$=p.querySelector("#status-toggle"),I=p.querySelector("#payment-date-wrapper"),N=p.querySelector('[name="paymentDate"]'),U=()=>{if(b==="single")return;const C=parseFloat(y.value)||0;if(m=parseInt(P.value)||2,C===0){M.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(b==="installment"){const D=C/m;M.innerHTML=`
                <div>
    ...
    `}async function dt(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">Carregando comissões...</p></div>');const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(",");try{const[s,i]=await Promise.all([pc({startDate:F.startDate,endDate:F.endDate,professionalId:F.professionalId,establishmentId:a}),uc(F.startDate,F.endDate,a)]);F.reports=s||[];const o=F.reports.reduce((r,n)=>r+(n.summary.finalValue||n.summary.totalCommission),0);F.stats={revenue:i.totalRevenue||0,commissions:i.totalCommissionsPaid||0,margin:i.totalRevenue>0?((i.totalRevenue-i.totalCommissionsPaid)/i.totalRevenue*100).toFixed(1):0,netPaid:o},F.selectedIds.clear(),Dt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),hc(),Ai()}catch(s){console.error(s),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
    ...
    `)}function Ai(){const t=document.getElementById("list-container");if(!t)return;let e=F.reports;if(F.searchQuery){const a=F.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=e.map(a=>{const s=gc(a.createdAt),i=a.summary.totalCommission,o=a.summary.extraDebit||0,r=a.summary.extraCredit||0,n=a.summary.finalValue||i,l=F.selectedIds.has(a.id);let d="";return o>0&&r>0?d=`<span class="text-red-500">-R$${o.toFixed(2)}</span> / <span class="text-emerald-500">+R$${r.toFixed(2)}</span>`:o>0?d=`<span class="text-red-500">-R$ ${o.toFixed(2)}</span>`:r>0?d=`<span class="text-emerald-500">+R$ ${r.toFixed(2)}</span>`:d='<span class="text-gray-300">--</span>',`
        ...
        `}).join("")}function vc(){ta&&document.body.removeEventListener("click",ta),ta=o=>{const r=o.target;if(r.classList.contains("item-checkbox")){const l=r.value;r.checked?F.selectedIds.add(l):F.selectedIds.delete(l),Dt(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){o.preventDefault();const l=n.dataset.action,d=n.dataset.id;switch(l){case"apply-filters":F.startDate=document.getElementById("filter-start").value,F.endDate=document.getElementById("filter-end").value,F.professionalId=document.getElementById("filter-prof").value,document.getElementById("custom-date-btn")?.click(),dt();break;case"new-calculation":yc();break;case"print-receipt":Cc(d);break;case"delete-report":Pc(d);break;case"view-report-details":Ic(d);break;case"close-detail-screen":Ds();break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),c=Array.from(u).every(h=>h.checked);u.forEach(h=>h.checked=!c);break;case"calculate-preview":wc();break;case"save-final-reports":Ec();break;case"toggle-preview-details":const p=n.dataset.idx,b=document.getElementById(`preview-details-${p}`),m=n.querySelector("i");b&&(b.classList.contains("hidden")?(b.classList.remove("hidden"),m&&m.classList.replace("bi-chevron-down","bi-chevron-up")):(b.classList.add("hidden"),m&&m.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",ta);const t=document.getElementById("search-input");t&&t.addEventListener("input",o=>{F.searchQuery=o.target.value,Ai()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&Sc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");F.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&F.selectedIds.add(l.value)}),Dt()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{F.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Dt()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",Dc);const i=document.getElementById("export-excel-btn");i&&i.addEventListener("click",Lc),document.getElementById("custom-date-btn")?.addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");F.isAdvancedFilterOpen=!F.isAdvancedFilterOpen,F.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filter-start").value=d.toISOString().split("T")[0],document.getElementById("filter-end").value=u.toISOString().split("T")[0],F.startDate=d.toISOString().split("T")[0],F.endDate=u.toISOString().split("T")[0],dt()})})}function Dt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=F.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function yc(){F.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=F.professionals.map(o=>`
    ...
    `,Mi()}function Lc(){if(F.reports.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}let t=F.reports;if(F.searchQuery){const a=F.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}const e=t.map(a=>{const s=a.summary.totalCommission,i=a.summary.extraDebit||0,o=a.summary.extraCredit||0,r=a.summary.finalValue||s;return{"Data da Apuração":new Date(a.createdAt).toLocaleDateString("pt-BR"),Profissional:a.professionalName,"Período Base":a.period,"Itens Calculados":a.summary.totalItems||0,"Valor Bruto (R$)":s,"Bônus (R$)":o,"Descontos (R$)":i,"Líquido Pago (R$)":r,"Observações/Motivo":a.summary.notes||""}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const a=XLSX.utils.json_to_sheet(e),s=XLSX.utils.book_new();XLSX.utils.book_append_sheet(s,a,"Comissoes");const i=`Relatorio_Comissoes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(s,i)}catch(a){console.error(a),f("Erro","Falha ao exportar Excel.","error")}}function Cc(t){const e=F.reports.find(u=>u.id===t);if(!e)return;if(!window.jspdf){f("Erro","A biblioteca de PDF não foi carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a;s.setFillColor(79,70,229),s.rect(0,0,210,40,"F"),s.setTextColor(255,255,255),s.setFontSize(22),s.setFont(void 0,"bold"),s.text("RECIBO DE COMISSÕES",105,20,{align:"center"}),s.setFontSize(10),s.text(`Data de Emissão: ${new Date().toLocaleDateString("pt-BR")}`,105,28,{align:"center"}),s.setTextColor(50,50,50),s.setFontSize(11),s.setFont(void 0,"normal"),s.text("Profissional:",15,55),s.setFont(void 0,"bold"),s.text(e.professionalName,40,55),s.setFont(void 0,"normal"),s.text("Período:",130,55),s.setFont(void 0,"bold"),s.text(e.period,147,55);const i=e.reportData?.items||e.items||[];let o=70;if(i.length>0){const u=i.map(c=>[c.item||"Item",c.client||"--",`R$ ${(c.value||0).toFixed(2)}`,`${c.commissionRate||0}%`,`R$ ${(c.commissionValue||0).toFixed(2)}`]);s.autoTable({startY:o,head:[["Serviço/Produto","Cliente","Valor Base","Taxa","Comissão"]],body:u,theme:"striped",headStyles:{fillColor:[249,250,251],textColor:[75,85,99],fontStyle:"bold"},styles:{fontSize:8},columnStyles:{2:{halign:"right"},3:{halign:"center"},4:{halign:"right",fontStyle:"bold",textColor:[5,150,105]}}}),o=s.lastAutoTable.finalY+15}const r=e.summary,n=r.finalValue||r.totalCommission,l=[["Comissões Brutas (Soma dos Itens)",`R$ ${r.totalCommission.toFixed(2)}`]];r.extraCredit>0&&l.push(["(+) Bônus Extras",`R$ ${r.extraCredit.toFixed(2)}`]),r.extraDebit>0&&l.push(["(-) Descontos / Vales",`R$ ${r.extraDebit.toFixed(2)}`]),s.autoTable({startY:o,head:[["Resumo do Fechamento","Valor"]],body:l,theme:"grid",headStyles:{fillColor:[79,70,229],textColor:[255,255,255]},columnStyles:{1:{halign:"right",fontStyle:"bold"}}});const d=s.lastAutoTable.finalY+15;s.setFillColor(236,253,245),s.rect(120,d-8,75,15,"F"),s.setTextColor(5,150,105),s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${n.toFixed(2)}`,190,d,{align:"right"}),r.notes&&(s.setTextColor(100,100,100),s.setFontSize(9),s.setFont(void 0,"normal"),s.text(`Obs/Motivo: ${r.notes}`,15,d+10)),s.setTextColor(150,150,150),s.setFontSize(9),s.line(20,d+40,90,d+40),s.text("Assinatura da Empresa",55,d+45,{align:"center"}),s.line(120,d+40,190,d+40),s.text("Assinatura do Profissional",155,d+45,{align:"center"}),s.save(`Recibo_Comissoes_${e.professionalName.replace(/\s+/g,"_")}.pdf`)}async function Dc(){const t=F.selectedIds.size;if(!(t===0||!await G("Excluir Recibos",`Deseja excluir e estornar ${t} recibo(s)? As vendas associadas voltarão ao status "A Apurar".`)))try{const a=Array.from(F.selectedIds).map(s=>Bi(s));await Promise.all(a),f("Sucesso",`${t} recibos excluídos com sucesso.`,"success"),F.selectedIds.clear(),Dt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),await dt()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns recibos.","error")}}async function Pc(t){if(await G("Excluir Recibo",'ATENÇÃO: Deseja realmente excluir este recibo? As vendas associadas a ele voltarão ao status "A Apurar" e o valor será subtraído dos relatórios. Esta ação não pode ser desfeita.'))try{await Bi(t),f("Sucesso","Recibo cancelado com sucesso. Vendas estornadas para apuração.","success"),Ds(),await dt()}catch(a){f("Erro ao Excluir",a.message,"error")}}const Re=document.getElementById("content");let A={allPackages:[],catalogForModal:{services:[],products:[]},establishments:[],searchQuery:"",statusFilter:"all",viewMode:"list",tempPackage:null,selectedIds:new Set},Ge=null;function ct(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Tc(){const t=A.allPackages.length,e=A.allPackages.filter(o=>o.status!=="inactive"),a=e.length,s=a>0?e.reduce((o,r)=>o+(r.price||0),0)/a:0;let i=0;return e.forEach(o=>{const r=o.originalPrice||0,n=o.price||0;if(r>0&&r>n){const l=(r-n)/r*100;l>i&&(i=l)}}),{total:t,activeCount:a,avgPrice:s,maxDiscount:i}}function Bc(){const t=document.getElementById("packages-layout-detail");t&&(t.classList.remove("hidden"),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))}))}function da(){const t=document.getElementById("packages-layout-detail");if(t){t.classList.add("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-0","md:scale-100","md:opacity-100"),e.classList.add("translate-y-full","md:scale-95","md:opacity-0")),setTimeout(()=>{t.classList.add("hidden"),t.style.display="none",t.innerHTML=""},300)}}function Mc(){const t=document.getElementById("packages-layout-detail");if(!t||A.viewMode!=="edit-package"||!A.tempPackage)return;A.tempPackage.name=t.querySelector("#packageName")?.value||"",A.tempPackage.description=t.querySelector("#packageDescription")?.value||"",A.tempPackage.status=t.querySelector("#packageStatus")?.value||"active";const e=parseFloat(t.querySelector("#finalPrice")?.value);A.tempPackage.price=isNaN(e)?"":e;const a=parseFloat(t.querySelector("#commissionRate")?.value);A.tempPackage.commissionRate=isNaN(a)?"":a;const s=parseInt(t.querySelector("#validityDays")?.value,10);A.tempPackage.validityDays=isNaN(s)?"":s,A.tempPackage.sellStartDate=t.querySelector("#sellStartDate")?.value||"",A.tempPackage.sellEndDate=t.querySelector("#sellEndDate")?.value||"";const i=parseInt(t.querySelector("#salesLimit")?.value,10);A.tempPackage.salesLimit=isNaN(i)?"":i;const o=Array.from(t.querySelectorAll(".modal-est-checkbox:checked")).map(r=>r.value);A.tempPackage.establishmentIds=o}async function Ac(){try{const e=(await ke().catch(()=>({matrizes:[]}))).matrizes||[];A.establishments=[],e.forEach(a=>{A.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>A.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}A.viewMode="list",A.selectedIds.clear(),jc(),Rc(),await wa()}async function wa(){const t=document.getElementById("packagesListContainer");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-20"><div class="loader mx-auto"></div></div>');const e=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId];try{const a=e.map(c=>ks(c).catch(()=>[])),s=await Promise.all(a),i=new Map;s.flat().forEach(c=>{i.has(c.id)||i.set(c.id,c)}),A.allPackages=Array.from(i.values());const o=e.map(c=>pt(c).catch(()=>[])),r=e.map(c=>bt(c).catch(()=>[])),[n,l]=await Promise.all([Promise.all(o),Promise.all(r)]),d=new Map;n.flat().forEach(c=>d.set(c.id,c));const u=new Map;l.flat().forEach(c=>u.set(c.id,c)),A.catalogForModal={services:Array.from(d.values()).filter(c=>c.active),products:Array.from(u.values())},qc(),Ye(),wt()}catch(a){console.error(a),t&&(t.innerHTML=`
            ...
            `)}}function wt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=A.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")));const s=document.getElementById("select-all-toggle");s&&(s.checked=A.allPackages.length>0&&a===A.allPackages.length)}function jc(){Re.innerHTML=`
    ...
    `}function qc(){const t=Tc(),e=document.getElementById("kpi-container");e&&(e.innerHTML=`
    ...
    `)}function Ye(){const t=document.getElementById("packagesListContainer");if(!t)return;let e=A.allPackages;if(A.statusFilter!=="all"){const s=A.statusFilter==="active";e=e.filter(i=>i.status!=="inactive"===s)}if(A.searchQuery){const s=A.searchQuery.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(e.length===0){t.innerHTML=`
        ...
        `}).join("")}function Nc(){if(A.allPackages.length===0){f("Aviso","Não há pacotes carregados para exportar.","info");return}let t=A.allPackages;if(A.statusFilter!=="all"){const s=A.statusFilter==="active";t=t.filter(i=>i.status!=="inactive"===s)}if(A.searchQuery){const s=A.searchQuery.toLowerCase();t=t.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(t.length===0){f("Aviso","Nenhum pacote corresponde aos filtros atuais.","info");return}const e=new Map(A.establishments.map(s=>[s.id,s.name])),a=t.map(s=>{const i=s.originalPrice||0,o=s.price||0,r=i>0?(i-o)/i*100:0,n=(s.items||[]).map(u=>`${u.quantity}x ${u.name}`).join(" | ");return{"Unidade(s)":(s.establishmentIds||(s.establishmentId?[s.establishmentId]:[])).map(u=>e.get(u)).filter(Boolean).join(", ")||"Não identificada","Nome do Pacote":s.name,Status:s.status!=="inactive"?"Ativo":"Inativo",Descrição:s.description||"","Itens Incluídos":n,"Valor Original (R$)":i,"Preço de Venda (R$)":o,"Desconto (%)":r.toFixed(1)+"%","Comissão (%)":s.commissionRate||0,"Validade de Uso (Dias)":s.validityDays||"Vitalício","Vendas Início":s.sellStartDate?new Date(s.sellStartDate).toLocaleDateString("pt-BR"):"-","Vendas Fim":s.sellEndDate?new Date(s.sellEndDate).toLocaleDateString("pt-BR"):"-"}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const s=XLSX.utils.json_to_sheet(a),i=XLSX.utils.book_new();XLSX.utils.book_append_sheet(i,s,"Pacotes");const o=`Relatorio_Pacotes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(i,o)}catch(s){console.error(s),f("Erro","Falha ao exportar Excel.","error")}}function ro(t=null){A.viewMode="edit-package",A.tempPackage=t?JSON.parse(JSON.stringify(t)):{id:"",name:"",description:"",status:"active",items:[],price:"",originalPrice:0,commissionRate:0,validityDays:"",sellStartDate:"",sellEndDate:"",salesLimit:"",establishmentIds:[g.establishmentId]},us(),Bc()}function ji(){const t=document.getElementById("packages-layout-detail");if(!t)return;const a=(A.tempPackage.items||[]).reduce((n,l)=>n+(l.price||0)*(l.quantity||1),0),s=t.querySelector("#finalPrice"),i=t.querySelector("#discountIndicator"),o=t.querySelector("#originalPrice"),r=parseFloat(s?.value)||0;if(o&&(o.textContent=ct(a)),i)if(a>0&&a>r&&r>0){const n=(a-r)/a*100;i.textContent=`${n.toFixed(0)}% OFF`,i.classList.remove("hidden")}else i.classList.add("hidden")}function cs(){const t=document.getElementById("package-items-list");if(!t)return;const e=A.tempPackage.items||[];e.length===0?t.innerHTML=`
    ...
    `,cs(),requestAnimationFrame(()=>{const m=t.querySelector("#modal-content-wrapper");m&&(m.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),m.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Fc(){A.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `;let a;const s=(o="")=>{const r=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600 text-lg"></i>',product:'<i class="bi bi-box-seam text-emerald-600 text-lg"></i>'},l={"catalog-service-list":{items:A.catalogForModal.services,type:"service"},"catalog-product-list":{items:A.catalogForModal.products,type:"product"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=t.querySelector("#"+d);if(!p)return;const b=u.filter(y=>y.name.toLowerCase().includes(r)).slice(0,50),m=c==="service"?"hover:border-indigo-400 hover:bg-indigo-50/80 hover:shadow-md":"hover:border-emerald-400 hover:bg-emerald-50/80 hover:shadow-md",h=c==="service"?"bg-indigo-100 border-indigo-200 shadow-sm":"bg-emerald-100 border-emerald-200 shadow-sm";p.innerHTML=b.map(y=>y.id?`
            ...
            `:"").join("")||'<div class="flex flex-col items-center justify-center py-8 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50"><i class="bi bi-inbox text-3xl mb-2"></i><p class="text-[10px] font-bold uppercase tracking-widest">Nenhum resultado</p></div>'})};s();const i=t.querySelector("#item-search-input");i&&(i.addEventListener("input",o=>{clearTimeout(a),a=setTimeout(()=>s(o.target.value),300)}),setTimeout(()=>i.focus(),100)),requestAnimationFrame(()=>{const o=t.querySelector("#modal-content-wrapper");o&&(o.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),o.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Rc(){Ge&&(Re.removeEventListener("click",Ge),Re.removeEventListener("input",Ge),Re.removeEventListener("change",Ge)),Ge=async e=>{if(e.target.classList.contains("item-checkbox")){const r=e.target.value;e.target.checked?A.selectedIds.add(r):A.selectedIds.delete(r),wt(),Ye(),e.stopPropagation();return}if(e.target.id==="packages-layout-detail"){da(),A.viewMode="list",A.tempPackage=null;return}if(e.target.closest("#batch-delete-btn")){const r=A.selectedIds.size;if(r===0)return;if(await G("Excluir Pacotes",`Deseja realmente apagar ${r} pacotes selecionados?`))try{const l=Array.from(A.selectedIds).map(d=>zs(d));await Promise.all(l),f("Sucesso",`${r} pacote(s) excluído(s).`,"success"),A.selectedIds.clear(),wt(),await wa()}catch{f("Erro","Ocorreu um erro ao excluir pacotes.","error")}return}if(e.target.closest("#cancel-selection-btn")){A.selectedIds.clear();const r=document.getElementById("select-all-toggle");r&&(r.checked=!1),wt(),Ye();return}const i=e.target.closest("[data-action]");if(!i)return;switch(i.dataset.action){case"new-package":navigator.vibrate&&navigator.vibrate(20),ro(null);break;case"edit-package":navigator.vibrate&&navigator.vibrate(15);const r=i.dataset.id,n=A.allPackages.find(k=>k.id===r);n&&ro(n);break;case"delete-package":e.stopPropagation(),e.preventDefault();const l=i.dataset.id;if(await G("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await zs(l),f("Sucesso!","Pacote excluído.","success"),A.viewMode==="edit-package"&&A.tempPackage?.id===l&&(da(),A.viewMode="list"),await wa()}catch(k){f("Erro",`Não foi possível excluir: ${k.message}`,"error")}break;case"back-to-main":da(),A.viewMode="list",A.tempPackage=null;break;case"add-item-to-package-btn":Mc(),Fc();break;case"back-to-editor":us();break;case"select-catalog-item":navigator.vibrate&&navigator.vibrate(10);const{itemType:u,itemId:c}=i.dataset,b=(A.catalogForModal[u+"s"]||[]).find(k=>k.id===c);if(b){const k=A.tempPackage.items.find(M=>M.id===b.id&&M.type===u);k?k.quantity++:A.tempPackage.items.push({...b,type:u,quantity:1}),us()}break;case"remove-item":navigator.vibrate&&navigator.vibrate(10);const m=parseInt(i.dataset.index,10);A.tempPackage.items.splice(m,1),cs();break;case"toggle-all-ests":const h=document.querySelectorAll(".modal-est-checkbox"),y=Array.from(h).every(k=>k.checked);h.forEach(k=>k.checked=!y);break;case"save-package":await Hc(i);break}},Re.addEventListener("click",Ge),Re.addEventListener("input",e=>{e.target.id==="search-packages"&&(A.searchQuery=e.target.value,Ye()),e.target.id==="finalPrice"&&ji()}),Re.addEventListener("change",e=>{if(e.target.id==="select-all-toggle"){const a=e.target.checked;A.selectedIds.clear(),a&&A.allPackages.forEach(s=>A.selectedIds.add(s.id)),wt(),Ye()}if(e.target.id==="filter-status"&&(A.statusFilter=e.target.value,Ye()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&A.tempPackage.items[a]&&(A.tempPackage.items[a].quantity=s,cs())}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Nc)}async function Hc(t){const e=A.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const i=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(i.length===0){f("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const o=e.items.reduce((l,d)=>l+d.price*d.quantity,0),r={id:e.id||null,companyId:g.companyId,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:o,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:i,establishmentId:i[0]};if(!r.name||isNaN(r.price)){f("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(r.items.length===0){f("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await qn(r.id,r):(delete r.id,await jn(r)),f("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),da(),A.viewMode="list",A.tempPackage=null,await wa()}catch(l){f("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const Oc=document.getElementById("content");async function zc(){const t=we.currentUser;if(!t)return;let e={};try{const l=await bs(Ae(xe,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(g.userProfessionalId)try{a=await ko(g.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=v(e.name||t.displayName||"Usuário"),i=v(t.email||"E-mail não disponível"),o=v(e.phone||"");let r=e.photo||"";a&&a.photo&&(r=a.photo);const n=r||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;Oc.innerHTML=`
    ...
    `,_c(t),Vc(a)}function _c(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),i=document.getElementById("profile-avatar"),o=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async r=>{const n=r.target.files[0];if(n)try{const l=await $a(n,800,800,.8);i.src=l,await Bt(Ae(xe,"users",t.uid),{photo:l}),g.userProfessionalId&&await Ja(g.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),f("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{f("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),o.addEventListener("submit",async r=>{r.preventDefault();const n=o.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),u=document.getElementById("input-phone").value.trim();try{await Bt(Ae(xe,"users",t.uid),{name:d,phone:u}),g.userProfessionalId&&await Ja(g.userProfessionalId,{name:d,phone:u}),g.userName=d,document.getElementById("display-name").textContent=d,f("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{f("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function Vc(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const i=(await ke()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),i.length===0)e.innerHTML=`
            ...
            `;else{let o="";i.forEach(r=>{if(a&&!r.isOrphanBranch){const l=document.createElement("option");l.value=r.id,l.textContent=r.name,a.appendChild(l)}const n=r.isMatriz||!r.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';o+=`
                ...
                `}),e.innerHTML=o}lo||(Uc(),lo=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
        ...
        `}}function Uc(){const t=document.getElementById("form-create-establishment");t&&t.addEventListener("submit",async e=>{e.preventDefault();const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const i={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const o=await gr(i);alert(o.message||"Sucesso!"),t.reset();const r=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(r);n&&n.hide(),await ka(document.getElementById("content"))}catch(o){console.error("Erro ao criar estabelecimento:",o),alert("Erro: "+(o.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>ka(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",e=>e.preventDefault()),document.addEventListener("gesturechange",e=>e.preventDefault()),document.addEventListener("gestureend",e=>e.preventDefault());let t=0;document.addEventListener("touchend",function(e){const a=new Date().getTime();a-t<=300&&e.preventDefault(),t=a},!1)});const ue=document.getElementById("loadingScreen"),ft=document.getElementById("dashboardContent"),tt=document.getElementById("content"),_a=document.getElementById("notificationBell"),aa=document.getElementById("notificationBadge"),Qe=document.getElementById("notificationPanel"),Va=document.getElementById("notificationList"),Ce=document.getElementById("profileMenuButton"),me=document.getElementById("profileDropdown"),co=document.getElementById("profileName"),uo=document.getElementById("profileEmail"),po=document.getElementById("logoutButton"),bo=document.getElementById("myProfileLink"),mo=document.getElementById("hamburger-menu-btn"),be=document.getElementById("sidebar"),ve=document.getElementById("mobile-overlay"),go=document.getElementById("themeToggleBtn"),Ua=document.getElementById("themeIcon"),ps=document.getElementById("mobile-bottom-nav"),fo=document.getElementById("nav-scroll"),Wc=document.querySelectorAll(".bottom-nav-item");function Jc(){if(!fo)return;const t=document.querySelector(".bottom-nav-item.active");if(!t)return;const e=fo,a=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=s.left+s.width/2-a.left-a.width/2;e.scrollBy({left:o,behavior:"smooth"})}const Gc={"dashboard-section":sn,"agenda-section":Wo,"comandas-section":Kn,"relatorios-section":tl,"servicos-section":bl,"produtos-section":Dl,"suppliers-section":Ol,"profissionais-section":Xl,"clientes-section":cd,"estabelecimento-section":t=>ki(t),"ausencias-section":Rd,"users-section":ha,"sales-report-section":ec,"financial-section":sc,"commissions-section":fc,"packages-section":Ac,"my-profile-section":zc,"hierarquia-section":()=>ka(tt),"establishments-section":()=>ka(tt)},Qc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços","produtos-section":"Estoque","suppliers-section":"Parceiros","profissionais-section":"Equipe","clientes-section":"Clientes","estabelecimento-section":"Empresa","ausencias-section":"Ausências","users-section":"Usuários","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro","commissions-section":"Comissões","packages-section":"Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"};function ua(t){document.documentElement.setAttribute("data-theme",t),localStorage.setItem("kairos_theme",t),Ua&&(t==="dark"?Ua.className="bi bi-sun-fill text-lg sm:text-xl text-amber-400":Ua.className="bi bi-moon-fill text-lg sm:text-xl text-slate-500")}function Xc(){const t=localStorage.getItem("kairos_theme"),e=window.matchMedia("(prefers-color-scheme: dark)").matches;ua(t||(e?"dark":"light"))}let Pt=null,Tt=[];function qi(){if(!aa||!Va)return;const t=Tt.filter(e=>!e.read).length;if(t>0?(aa.textContent=t,aa.classList.remove("hidden")):aa.classList.add("hidden"),Tt.length===0){Va.innerHTML='<p class="text-center text-slate-500 p-4 text-sm">Nenhuma notificação.</p>';return}Va.innerHTML=Tt.map(e=>`
    ...
    `).join("")}function xo(t){Pt&&Pt();const e=Sa(xe,"establishments",t,"notifications"),a=yo(e,wo("timestamp",">=",new Date),Xi("timestamp","desc"));Pt=Yi(a,s=>{s.docChanges().forEach(i=>{if(i.type==="added"){const o=i.doc.data();Tt.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),f(o.title,o.message,"info",!0),qi();const r=document.querySelector(".sidebar-link.active");r&&r.dataset.target==="agenda-section"&&Wo()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Yc(t){const e=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),i=document.getElementById("multi-context-count"),o=document.getElementById("multi-context-list"),r=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!e||!o))try{const u=(await ke()).matrizes||[];let c="",p=0;if(u.forEach(b=>{c+=`
