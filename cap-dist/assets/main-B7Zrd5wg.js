import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as U,d as Z}from"./firebase-config-BCzB3QOS.js";import{EmailAuthProvider as Go,reauthenticateWithCredential as Yo,verifyBeforeUpdateEmail as Xo,updatePassword as Qo,updateProfile as Zo,onAuthStateChanged as Ko,signOut as Ba}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{addDoc as pa,collection as De,getDocs as bo,query as fo,orderBy as vo,doc as Lt,deleteDoc as es,updateDoc as ho,getDoc as ts,where as as,onSnapshot as os}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";const p={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function ss(e,t,a){p.establishmentId=e,p.establishmentName=t,p.userPermissions=a}const Kt="https://kairos-app-407358446276.us-central1.run.app";console.log("🚀 API configurada para Produção (US):",Kt);async function rs(){const e=U.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function w(e,t={}){const a=await rs();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=Kt.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,o=`${s}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${o}`);try{const n=await fetch(o,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,u=l.match(d),c=u?u[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Kt}. Verifique sua conexão com a internet.`):n}}const ns=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),w(r)},is=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return w(s)},ls=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return w(r)},ds=e=>w("/api/appointments",{method:"POST",body:JSON.stringify(e)}),ga=(e,t)=>w(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),cs=e=>w(`/api/appointments/${e}`,{method:"DELETE"}),us=e=>w(`/api/appointments/${e}/reopen`,{method:"POST"}),ms=(e,t)=>w(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let R;async function ps(){if(!R)try{R=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function gs(){if(!R){console.warn("AudioContext não inicializado. O som não será tocado.");return}R.state==="suspended"&&R.resume();const e=R.createOscillator(),t=R.createGain();e.connect(t),t.connect(R.destination),e.type="sine",e.frequency.setValueAtTime(800,R.currentTime),t.gain.setValueAtTime(0,R.currentTime),t.gain.linearRampToValueAtTime(.3,R.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,R.currentTime+.2),e.start(R.currentTime),e.stop(R.currentTime+.2)}function g(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&gs();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `,r.appendChild(o),o.querySelector(".toast-close").addEventListener("click",()=>o.remove()),setTimeout(()=>{o.remove()},4e3)}function A(e,t){const a=document.getElementById("genericModal");return new Promise(s=>{a.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",u=>{u.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function Tt(e){const t=document.getElementById(e);t&&(t.style.display="none")}function bs(){document.body.addEventListener("click",()=>{R||ps()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const s=t.dataset.target;if(s){const r=document.getElementById(s);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}async function Da(){const e=document.getElementById("cancellationListContainer");if(!e)return;e.innerHTML='<div class="loader mx-auto"></div>';const t=document.getElementById("cancelStartDate").value,a=document.getElementById("cancelEndDate").value;try{const s=await is(p.establishmentId,t,a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}e.innerHTML=s.map(r=>`
        ...
        `).join("")}catch(s){e.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${s.message}</p>`}}function fs(){const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const s=`
    ...
    `,{modalElement:r}=N({title:"Histórico de Cancelamentos",contentHTML:s,maxWidth:"max-w-3xl"});r.querySelector("#searchCancellationsBtn").addEventListener("click",Da),Da()}const z=document.getElementById("sidebar"),Ma=document.getElementById("sidebarToggle"),Re=document.getElementById("mainContent"),vs=document.querySelectorAll(".sidebar-link"),Pa=document.getElementById("hamburger-menu-btn"),Ie=document.getElementById("mobile-overlay");function ft(e){!z||!Re||(z.classList.toggle("collapsed",e),Re.classList.toggle("sidebar-collapsed-shift",e))}function hs(){!z||!Ie||(z.classList.add("mobile-open"),Ie.classList.add("visible"))}function ot(){!z||!Ie||(z.classList.remove("mobile-open"),Ie.classList.remove("visible"))}function xs(){ft(!z.classList.contains("collapsed"))}function ys(e,t,a){if(!z||!Re)return;Re.classList.add("main-content-shift"),window.innerWidth>=768?ft(z.classList.contains("collapsed")):(Re.classList.remove("main-content-shift","sidebar-collapsed-shift"),ot()),Ma&&Ma.addEventListener("click",r=>{r.stopPropagation(),xs()}),z.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&z.classList.contains("collapsed")&&ft(!1)}),z.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||ft(!0))}),Pa&&Pa.addEventListener("click",r=>{r.stopPropagation(),hs()}),Ie&&Ie.addEventListener("click",r=>{r.stopPropagation(),ot()});let s=0;z.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),z.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&ot()},{passive:!0}),vs.forEach(r=>{const o=r.getAttribute("data-target"),n=o.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[o]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),o&&typeof e=="function"&&e(o),window.innerWidth<768&&ot()})})}const Qe=e=>{const t=e||p.establishmentId;return t?w(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ws=(e,t)=>{const a=e||p.establishmentId;return a?w(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ks=(e,t)=>{const a=e||p.establishmentId;return a?w(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Ss=(e,t)=>{const a=e||p.establishmentId;return a?w(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},_=e=>w(`/api/professionals/${e}`),$s=e=>w(`/api/professionals/details/${e}`),Es=e=>w("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Cs=(e,t)=>w(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Is=e=>w(`/api/professionals/${e}`,{method:"DELETE"});var Le;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Le||(Le={}));class Ot extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const Ls=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Ts=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:Ls(e),o=()=>r()!=="web",n=c=>{const m=d.get(c);return!!(m?.platforms.has(r())||i(c))},i=c=>{var m;return(m=a.PluginHeaders)===null||m===void 0?void 0:m.find(b=>b.name===c)},l=c=>e.console.error(c),d=new Map,u=(c,m={})=>{const b=d.get(c);if(b)return console.warn(`Capacitor plugin "${c}" already registered. Cannot register plugins twice.`),b.proxy;const f=r(),v=i(c);let x;const h=async()=>(!x&&f in m?x=typeof m[f]=="function"?x=await m[f]():x=m[f]:t!==null&&!x&&"web"in m&&(x=typeof m.web=="function"?x=await m.web():x=m.web),x),k=(M,q)=>{var F,O;if(v){const se=v?.methods.find(W=>q===W.name);if(se)return se.rtype==="promise"?W=>a.nativePromise(c,q.toString(),W):(W,tt)=>a.nativeCallback(c,q.toString(),W,tt);if(M)return(F=M[q])===null||F===void 0?void 0:F.bind(M)}else{if(M)return(O=M[q])===null||O===void 0?void 0:O.bind(M);throw new Ot(`"${c}" plugin is not implemented on ${f}`,Le.Unimplemented)}},$=M=>{let q;const F=(...O)=>{const se=h().then(W=>{const tt=k(W,M);if(tt){const at=tt(...O);return q=at?.remove,at}else throw new Ot(`"${c}.${M}()" is not implemented on ${f}`,Le.Unimplemented)});return M==="addListener"&&(se.remove=async()=>q()),se};return F.toString=()=>`${M.toString()}() { [capacitor code] }`,Object.defineProperty(F,"name",{value:M,writable:!1,configurable:!1}),F},E=$("addListener"),I=$("removeListener"),D=(M,q)=>{const F=E({eventName:M},q),O=async()=>{const W=await F;I({eventName:M,callbackId:W},q)},se=new Promise(W=>F.then(()=>W({remove:O})));return se.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await O()},se},H=new Proxy({},{get(M,q){switch(q){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?D:E;case"removeListener":return I;default:return $(q)}}});return s[c]=H,d.set(c,{name:c,proxy:H,platforms:new Set([...Object.keys(m),...v?[f]:[]])}),H};return a.convertFileSrc||(a.convertFileSrc=c=>c),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=u,a.Exception=Ot,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Bs=e=>e.Capacitor=Ts(e),_e=Bs(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),ba=_e.registerPlugin;class xo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new _e.Exception(t,Le.Unimplemented)}unavailable(t="not available"){return new _e.Exception(t,Le.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Aa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),qa=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ds extends xo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=qa(r).trim(),o=qa(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Aa(t.key),s=Aa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}ba("CapacitorCookies",{web:()=>new Ds});const Ms=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),Ps=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},As=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,qs=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Ps(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Ns extends xo{async request(t){const a=qs(t,t.webFetchExtra),s=As(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await Ms(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const u={};return o.headers.forEach((c,m)=>{u[m]=c}),{data:l,headers:u,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}ba("CapacitorHttp",{web:()=>new Ns});const re=ba("PushNotifications",{}),Fs=(e,t,a="all",s="all")=>{const r={startDate:e,endDate:t};a&&a!=="all"&&(r.professionalId=a),s&&s!=="all"&&(r.costCenterId=s);const o=new URLSearchParams(r).toString();return w(`/api/reports/indicators?${o}`)},Rs=(e,t="all")=>{const a={date:e};t&&t!=="all"&&(a.professionalId=t);const s=new URLSearchParams(a).toString();return w(`/api/reports/appointments/list?${s}`)},js=()=>w("/api/financial/cost-centers"),Hs=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{let r=`/api/reports/sales/${e}?startDate=${t}&endDate=${a}`;return s&&s!=="all"&&(r+=`&cashierSessionId=${s}`),w(r)},Os=()=>w("/api/reports/summary",{method:"GET"}),Me=e=>w(`/api/services/${e}`),zs=e=>w("/api/services",{method:"POST",body:JSON.stringify(e)}),Vs=(e,t)=>w(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Us=e=>w(`/api/services/${e}`,{method:"DELETE"}),Js=(e,t)=>w(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),_s=e=>w(`/api/services/stats/most-popular/${e}`),Bt=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return w(r)},Dt=e=>w("/api/blockages",{method:"POST",body:JSON.stringify(e)}),fa=e=>w(`/api/blockages/${e}`,{method:"DELETE"}),yo=e=>w("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Mt=e=>w(`/api/clients/${e}`),va=e=>w("/api/clients",{method:"POST",body:JSON.stringify(e)}),Ws=(e,t)=>w(`/api/clients/${e}`,{method:"PUT",body:JSON.stringify(t)}),Gs=e=>w(`/api/clients/${e}`,{method:"DELETE"}),Na=(e,t,a)=>{const s=`/api/clients/history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return w(s)},Ys=(e,t,a)=>{const s=`/api/clients/loyalty-history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return w(s)},Xs=(e,t,a,s)=>w("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientName:t,clientPhone:a,rewardData:s})}),Fa=document.getElementById("content");let Ra=!1;const ea=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let Ze=[],Pt=[],We={},ae=[],L={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},S={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Qs(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function wo(e){const t=new Date(e);if(t.setHours(0,0,0,0),L.currentView==="week"&&L.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function wt(){const e=document.getElementById("profSelectorContainer"),t=L.profSearchTerm.toLowerCase();if(!e||!p.professionals)return;let a=p.professionals.filter(o=>L.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=L.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",u=ea[0],c=o.id!=="all"&&p.professionalColors.get(o.id)||u,m=o.photo||`https://placehold.co/64x64/${c.main?.replace("#","")||"E0E7FF"}/${c.light?.replace("#","")||"4F46E5"}?text=${l}`,b=o.id==="all"?"#e0e7ff":c.light,f=o.id==="all"?"#4f46e5":c.main,x=`border: 3px solid ${n?c.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+c.border:"none"};`;return`
            <div class="prof-card ${n?"selected":""} ${d?"":"opacity-50"}" 
                 data-action="select-professional" 
                 data-prof-id="${o.id}">
                ${o.id==="all"?`<div class="prof-card-all-placeholder" style="background-color: ${b}; color: ${f}; ${x}">
                           ${l}
                          </div>`:`<img src="${m}" alt="${o.name}" class="prof-card-photo" style="${x}" />`}
                <span class="prof-card-name">${i}</span>
            </div>
        `}).join("")}function Zs(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function Ks(e){const t=document.getElementById("agenda-view");if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=p.professionalColors.get(s.professionalId)||{};if(s.type==="blockage")return`
                ...
                </div>`;const d=s.status==="completed",u=d?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",c=d?"Finalizado":"Aberto",m=JSON.stringify(s).replace(/'/g,"&apos;"),b=s.redeemedReward?.points>0,f=s.hasRewards&&!b,v=Zs(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime);return`
            <div class="appointment-list-card" data-appointment='${m}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
                    ...
                    `;const x=JSON.stringify(m).replace(/'/g,"&apos;"),h=m.redeemedReward?.points>0,k=m.hasRewards&&!h,$=m.status==="completed";return`
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                         style="background-color: ${v.bg}; border-left-color: ${v.border};"
                         data-action="open-comanda" data-appointment='${x}'>
                        
                        <div class="flex justify-between items-center">
                            <span class="font-bold text-xs text-gray-900">${f}</span>
                            ${$?'<span class="text-[10px] font-semibold bg-green-200 text-green-800 px-1 rounded-sm">OK</span>':""}
                        </div>

                        <div class="mt-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-800 truncate">${k?"🎁 ":""}${m.clientName}</p>
        ...
        `}o+="</div>",t.innerHTML=o}function tr(){const e=p.allEvents.filter(t=>L.selectedProfessionalId==="all"||t.professionalId===L.selectedProfessionalId);L.currentView==="list"?Ks(e):er(e)}async function K(){const e=document.getElementById("agenda-view");if(!e)return;e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const s=document.getElementById("weekRange");if(L.currentView==="list")t=new Date(L.currentDate),t.setHours(0,0,0,0),a=new Date(L.currentDate),a.setHours(23,59,59,999),s.textContent=Qs(t);else{const r=ha();t=wo(new Date(L.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),s.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await ns(p.establishmentId,t.toISOString(),a.toISOString(),L.selectedProfessionalId==="all"?null:L.selectedProfessionalId),n=(await Bt(p.establishmentId,t.toISOString(),a.toISOString(),L.selectedProfessionalId)).map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const u=p.professionals?p.professionals.find(c=>c.id===l.professionalId):null;u&&(d=u.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(p.allEvents=i,wt(),tr(),L.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${L.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),L.scrollToAppointmentId=null}}catch(r){g("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"),e.innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>'}}async function ar(){try{const[e,t,a,s]=await Promise.all([p.professionals&&p.professionals.length>0?Promise.resolve(p.professionals):_(p.establishmentId),p.services&&p.services.length>0?Promise.resolve(p.services):Me(p.establishmentId),ae.length>0?Promise.resolve(ae):Mt(p.establishmentId),We.enabled!==void 0?Promise.resolve(null):Qe(p.establishmentId)]);(!p.professionals||p.professionals.length===0)&&(p.professionals=e||[]),(!p.services||p.services.length===0)&&(p.services=t||[]),ae.length===0&&(ae=a||[]),s&&(We=s.loyaltyProgram||{enabled:!1}),p.professionals.forEach((r,o)=>{p.professionalColors.set(r.id,ea[o%ea.length])}),wt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function ta(e){e<1||e>4||(S.step=e,aa(null,!0))}function ko(e,t){const a=document.getElementById("multiServiceToggle"),s=a&&a.checked,r=t.classList.contains("selected"),o=S.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),o>-1&&S.data.selectedServiceIds.splice(o,1);else{if(!s){S.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),S.data.selectedServiceIds.push(e)}}function So(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const s=Pt.find(r=>r.id===e);S.data.professionalId=e,S.data.professionalName=s?s.name:"N/A"}function or(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(s=>s.classList.remove("selected")),t.classList.add("selected"),S.data.time=e)}async function ja(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=S.data.professionalId,s=S.data.selectedServiceIds,r=document.getElementById("apptDate").value;S.data.date=r;const o=s.reduce((n,i)=>{const l=Ze.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${o} min`,o===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await ls({establishmentId:p.establishmentId,professionalId:a,serviceIds:s,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(u=>{const[c,m]=u.split(":").map(Number);return c*60+m>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const u=document.createElement("button");u.type="button",u.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${S.data.time===d?"selected":""}`,u.textContent=d,u.addEventListener("click",()=>or(d,u)),t.appendChild(u)}),S.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${S.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function sr(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:s}=S.data,{enabled:r,rewards:o,pointsPerCurrency:n}=We;if(!r||!t||!o||o.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const i=o.filter(d=>a>=d.points);let l=`
        <h4 class="text-md font-semibold text-gray-700 mb-2">🎁 Prêmios Disponíveis (${a} pontos)</h4>
    `;i.length>0?(l+='<div class="space-y-2">',l+=i.map(d=>{const u=s?.reward===d.reward;return`
                <label class="flex items-center p-3 bg-white rounded-lg border border-gray-300 cursor-pointer hover:bg-gray-50">
                    <input type="radio" name="loyaltyReward" class="form-radio text-indigo-600" 
                           ...
                           ${u?"checked":""}>
                    <span class="ml-3">
                        <span class="font-semibold text-gray-800">${d.reward}</span>
                        <span class="text-sm text-gray-600"> (-${d.points} pontos)</span>
                    </span>
                </label>
            `}).join(""),l+="</div>"):l+='<p class="text-sm text-gray-600">Pontos insuficientes para resgatar os prêmios disponíveis.</p>',e.innerHTML=l,e.querySelectorAll('input[name="loyaltyReward"]').forEach(d=>{d.addEventListener("change",u=>{u.target.checked&&(S.data.redeemedReward={reward:u.target.value,points:parseInt(u.target.dataset.points,10)})})}),e.insertAdjacentHTML("beforeend",`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",d=>{d.target.checked&&(S.data.redeemedReward=null)})}async function rr(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!S.data.time||S.data.selectedServiceIds.length===0||!S.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const s=S.data.selectedServiceIds.map(d=>{const u=Ze.find(c=>c.id===d);return{id:u.id,name:u.name,price:u.price,duration:u.duration,bufferTime:u.bufferTime||0,photo:u.photo||null}}),[r,o]=S.data.time.split(":"),n=new Date(`${S.data.date}T${r}:${o}:00`),i={establishmentId:p.establishmentId,clientName:S.data.clientName,clientPhone:S.data.clientPhone,services:s,professionalId:S.data.professionalId,startTime:n.toISOString(),redeemedReward:S.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await ga(l,i):await ds(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",K()}catch(d){g(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function nr(e){return`
    ...
    `}async function Ha(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.toLowerCase().trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}const s=ae.filter(r=>r.name.toLowerCase().includes(a)||r.phone.includes(a));if(s.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=s.map(nr).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(r=>{r.addEventListener("click",o=>{const n=r.dataset.clientName,i=r.dataset.clientPhone,l=ae.find(d=>d.phone===i&&d.name===n);if(S.data.clientName=n,S.data.clientPhone=i,l){const d=We,u=Math.min(...(d?.rewards||[]).map(c=>c.points));S.data.clientLoyaltyPoints=l.loyaltyPoints||0,S.data.clientHasRewards=d.enabled&&u!==1/0&&S.data.clientLoyaltyPoints>=u}else S.data.clientHasRewards=!1,S.data.clientLoyaltyPoints=0;document.getElementById("apptClientName").value=n,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(d=>d.classList.remove("selected","border-blue-500")),r.classList.add("selected","border-blue-500")})})}async function ir(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),s={establishmentId:p.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!s.name||!s.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await va(s),ae.push({name:s.name,phone:s.phone,loyaltyPoints:0}),S.data.clientName=s.name,S.data.clientPhone=s.phone,S.data.clientHasRewards=!1,S.data.clientLoyaltyPoints=0,g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",ta(1)}catch(r){g(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function lr(){N({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",ir)}function dr(){lr()}function cr(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",s=`
    ...
    `;return{title:a,content:s}}function ur(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${Ze.map(s=>{const r=S.data.selectedServiceIds.includes(s.id),o=s.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
    ...
    `;return{title:e,content:a}}function mr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Pt.map(a=>{const s=S.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P";return`
    ...
    `;return{title:e,content:t}}function pr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,s=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=S.data.date||s,o=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:o}}function gr(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),s=Ze.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=S.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${o?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>ko(r.dataset.serviceId,r))})}function br(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),s=Pt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=S.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P";return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>So(r.dataset.professionalId,r))})}async function aa(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const o=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;S={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:o,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}}if(!p.services||!p.professionals||!ae||We.enabled===void 0){g("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(Ze=p.services,Pt=p.professionals.filter(o=>o.status==="active"),S.data.clientName&&S.data.clientPhone){const o=ae.find(n=>n.phone===S.data.clientPhone&&n.name===S.data.clientName);o&&(S.data.clientLoyaltyPoints=o.loyaltyPoints||0)}let s={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(S.step){case 1:s=cr(e);break;case 2:s=ur();break;case 3:s=mr();break;case 4:s=pr(e);break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>{o.addEventListener("click",()=>{const n=parseInt(o.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(S.data.clientName=i.value.trim(),S.data.clientPhone=l.value.trim(),!S.data.clientName||!S.data.clientPhone)return g("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(S.data.selectedServiceIds.length===0)return g("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!S.data.professionalId)return g("Atenção","Selecione um profissional.","error");ta(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>{o.addEventListener("click",()=>ta(parseInt(o.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if(S.step===4&&r&&r.addEventListener("submit",rr),a.style.display="flex",S.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>ko(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>gr(i.target.value))}if(S.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>So(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>br(i.target.value))}if(S.step===1){const o=a.querySelector("#clientSearchInput");o&&(o.addEventListener("input",i=>Ha(i.target.value)),S.data.clientName&&S.data.clientPhone&&Ha(`${S.data.clientName} ${S.data.clientPhone}`));const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",dr)}if(S.step===4){const o=a.querySelector("#apptDate");o&&o.addEventListener("change",ja),ja(),sr()}}async function $o(e={}){L.currentDate=e.targetDate?new Date(e.targetDate):L.currentDate||new Date,L.scrollToAppointmentId=e.scrollToAppointmentId||null,L.profSearchTerm="",window.innerWidth<768&&(L.currentView="list"),Fa.innerHTML=`
        <section>
                ...
                <div class="flex flex-col sm:flex-row sm:flex-wrap sm:justify-between sm:items-center mb-4 gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2 order-2 sm:order-1">
                        <div class="flex items-center gap-1 rounded-lg bg-gray-200 p-1">
                            <button data-view="list" class="view-btn ${L.currentView==="list"?"active":""}">Lista</button>
                            <button data-view="week" class="view-btn ${L.currentView==="week"?"active":""}">Semana</button>
                        </div>
                        <div id="week-days-toggle" class="${L.currentView==="week"?"flex":"hidden"} items-center gap-1 rounded-lg bg-gray-200 p-1">
        ...
        </section>`,document.querySelectorAll(".view-btn[data-view]").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(r=>r.classList.remove("active")),a.classList.add("active"),L.currentView=a.dataset.view;const s=document.getElementById("week-days-toggle");if(L.currentView==="week"){if(s.style.display="flex",window.innerWidth<768){L.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(o=>o.classList.remove("active"));const r=document.querySelector('.week-days-btn[data-days="3"]');r&&r.classList.add("active")}}else s.style.display="none";K()})}),document.querySelectorAll(".week-days-btn").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"),L.weekViewDays=parseInt(a.dataset.days,10),K()})}),document.getElementById("todayBtn").addEventListener("click",()=>{L.currentDate=new Date,K()});const t=a=>{const s=parseInt(a.currentTarget.dataset.amount,10),r=L.currentView==="week"?ha():1,o=new Date(L.currentDate);o.setDate(o.getDate()+s*r),L.currentDate=o,K()};document.getElementById("prevBtn").addEventListener("click",t),document.getElementById("nextBtn").addEventListener("click",t),document.getElementById("profSearchInput").addEventListener("input",a=>{L.profSearchTerm=a.target.value,wt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",a=>{L.showInactiveProfs=a.target.checked,wt(),K()}),Ra||(Fa.addEventListener("click",async a=>{const s=a.target.closest("[data-action]");if(a.target.closest('[data-action="select-professional"]')){const l=a.target.closest('[data-action="select-professional"]').dataset.profId,d=L.selectedProfessionalId===l&&l!=="all";if(L.selectedProfessionalId=d?"all":l,l!=="all"){const u=document.getElementById("profSearchInput");u&&(u.value=""),L.profSearchTerm=""}await K();return}if(!s)return;const r=s.dataset.action;let o=null;const n=a.target.closest("[data-appointment]");switch(n&&(o=JSON.parse(n.dataset.appointment.replace(/&apos;/g,"'"))),r){case"new-appointment":aa();break;case"edit-appointment":if(!o)return;if(o.status==="completed"){g("Atenção","Agendamentos finalizados não podem ser editados.","error");return}o.hasRewards&&!o.redeemedReward&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),aa(o);break;case"delete-appointment":{const i=s.dataset.id;if(await A("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await cs(i),g("Agendamento apagado!","success"),K()}catch(d){g(`Não foi possível apagar: ${d.message}`,"error")}break}case"open-comanda":if(o){o.hasRewards&&!o.redeemedReward&&o.status!=="completed"&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const i=o.status==="completed"?"finalizadas":"em-atendimento",l={selectedAppointmentId:o.id,initialFilter:i};if(i==="finalizadas"){let d=o.startTime;if(o.transaction&&o.transaction.paidAt){const u=o.transaction.paidAt;typeof u=="object"&&u._seconds?d=new Date(u._seconds*1e3):d=u}l.filterDate=d}Y("comandas-section",l)}break}}),Ra=!0),await ar(),await K()}const fr=(e,t=null,a=1,s=12)=>{let r=`/api/comandas/${e}?page=${a}&limit=${s}`;return t&&(r+=`&date=${t}`),w(r)},vr=e=>w("/api/sales",{method:"POST",body:JSON.stringify(e)}),hr=e=>w(`/api/sales/${e}/reopen`,{method:"POST"}),xr=e=>w(`/api/sales/${e}`,{method:"DELETE"}),At=e=>w(`/api/products/${e}`),yr=e=>w("/api/products",{method:"POST",body:JSON.stringify(e)}),wr=(e,t)=>w(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),kr=e=>w(`/api/products/${e}`,{method:"DELETE"}),Sr=(e,t)=>w(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),$r=({startDate:e,endDate:t,productId:a,categoryId:s})=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("productId",a),s&&s!=="all"&&r.append("categoryId",s),w(`/api/products/stock-history/report?${r.toString()}`)},Eo=()=>w("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),Er=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),w("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Cr=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),w(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},Ir=()=>w("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),Lr=e=>w(`/api/cashier/report/${e}`),Co=e=>w(`/api/packages/${e}`),Tr=e=>w("/api/packages",{method:"POST",body:JSON.stringify(e)}),Br=(e,t)=>w(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),Dr=e=>w(`/api/packages/${e}`,{method:"DELETE"});let y={allComandas:[],catalog:{services:[],products:[],packages:[]},clients:[],activeFilter:"atendimento",selectedComandaId:null,isCashierOpen:!1,activeCashierSessionId:null,paging:{page:1,limit:12,total:0}},xe=null,ye=null;function qt(e){if(e.status==="completed"){const r=e.comandaItems||e.items||[];return r.length>0?r:e.services||[]}const t=e.services||[],a=[...e.comandaItems||[],...e.items||[]];let s=[...t];return a.forEach(r=>{if(r.type==="product"){s.push(r);return}s.some(n=>{const i=n.id&&r.id&&n.id===r.id,l=n.name&&r.name&&n.name===r.name;return i||l})||s.push(r)}),s}function Mr(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function ge(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function Pr(){const e=new Date().toISOString().split("T")[0];ye.innerHTML=`
                ...
                <div id="comandas-list-column">
                    <div class="p-4 pb-2 sticky top-0 bg-white z-10 border-b border-gray-100">
                        <button 
                            ...
                            class="w-full py-3 px-4 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition shadow-md flex items-center justify-center gap-2 mb-3 ${y.isCashierOpen?"":"opacity-50 cursor-not-allowed"}"
                            ${y.isCashierOpen?"":"disabled"}
                        >
    ...
    `}function Ar(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
        ...
        `:e.innerHTML=`
            ...
            <button data-action="view-sales-report" class="py-2 px-4 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 text-sm">Relatório</button>
        `)}function de(){const e=document.getElementById("comandas-list");if(!e)return;if(!y.isCashierOpen&&y.activeFilter==="atendimento"){e.innerHTML=`
        ...
        `;return}const a={atendimento:"confirmed",finalizadas:"completed"}[y.activeFilter],s=y.allComandas.filter(r=>r.status===a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',Oa(e);return}e.innerHTML=s.map(r=>{const n=qt(r).reduce((c,m)=>c+(m.price||0),0),i=r.id===y.selectedComandaId,l=new Date(r.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=r.type==="walk-in"||r.id.startsWith("temp-")?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md">Agendado</span>';return`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const a=y.allComandas.find(d=>d.id===y.selectedComandaId);if(!a){e.innerHTML=`
            <div class="hidden lg:flex flex-col items-center justify-center h-full text-center text-gray-400">
        ...
        `;return}const s=qt(a),r=a.status==="completed",o=a.type==="walk-in"||a.id.startsWith("temp-"),n=o?"":`<button data-action="go-to-appointment" data-id="${a.id}" data-date="${a.startTime}" 
           ...
           </button>`,i=s.reduce((d,u)=>{const c=`${u.type}-${u.id||u.name}`;return d[c]||(d[c]={...u,quantity:0}),d[c].quantity+=1,d},{}),l=Object.values(i).reduce((d,u)=>d+(u.price||0)*u.quantity,0);e.innerHTML=`
                ...
                ${Object.values(i).map(d=>`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-800 line-clamp-1">${d.name}</p>
                                <p class="text-xs text-gray-500">R$ ${(d.price||0).toFixed(2)} un.</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            <span class="font-bold text-gray-900">R$ ${(d.price*d.quantity).toFixed(2)}</span>
                            ${r?"":`<button data-action="remove-item" data-item-id="${d.id}" data-item-type="${d.type}" class="text-red-400 hover:text-red-600 p-1 rounded-full hover:bg-red-50"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>`}
                        </div>
                    </div>
                `).join("")}
    ...
    `}function qr(){N({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Nr)}async function Nr(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector('button[type="submit"]'),s={establishmentId:p.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim()||null,phone:t.querySelector("#regClientPhone").value.trim(),dob:`${t.querySelector("#regClientDobDay").value.trim()}/${t.querySelector("#regClientDobMonth").value.trim()}`,notes:t.querySelector("#regClientNotes").value.trim()||null};if(!s.name||!s.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{const r=await va(s);y.clients.push({id:r.id,...s}),g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",Io(r.id)}catch(r){g(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar Cliente"}}function Fr(){if(!y.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:e,close:t}=N({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{let r="";const o=e.querySelector("#add-item-content"),n={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},i=()=>{const l=r.toLowerCase(),d=c=>c.filter(m=>m.name.toLowerCase().includes(l)),u={"modal-service-list":{items:d(y.catalog.services),type:"service"},"modal-product-list":{items:d(y.catalog.products),type:"product"},"modal-package-list":{items:d(y.catalog.packages),type:"package"}};for(const[c,{items:m,type:b}]of Object.entries(u)){const f=o.querySelector(`#${c}`);f&&(f.innerHTML=m.map(v=>`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{o>1&&(o--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{o++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await zr(r,o),t()}};e.addEventListener("click",r=>{const o=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(o){const{itemType:i,itemId:l}=o.dataset,u=(y.catalog[i+"s"]||[]).find(c=>c.id===l);u&&s({...u,type:i})}else n&&a()}),a()}async function Io(e=null){if(!y.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!y.clients||y.clients.length===0)try{y.clients=await Mt(p.establishmentId)}catch{g("Erro","Não foi possível carregar dados de clientes.","error");return}if(!p.professionals||p.professionals.length===0)try{p.professionals=await _(p.establishmentId)}catch{g("Erro","Não foi possível carregar dados de profissionais.","error");return}const t=y.clients.map(n=>{const i=n.id===e?"selected":"";return`<option value="${n.id}" ${i}>${n.name} - ${n.phone}</option>`}).join(""),a=p.professionals.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""),s=`
    ...
    `,{modalElement:r}=N({title:"Nova Venda Avulsa",contentHTML:s,maxWidth:"max-w-md"});r.querySelector("#new-sale-form").addEventListener("submit",Jr);const o=r.querySelector('[data-action="new-client-from-sale"]');o&&o.addEventListener("click",n=>{n.preventDefault(),r.style.display="none",qr()})}function Rr(){if(!y.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const e=y.allComandas.find(c=>c.id===y.selectedComandaId);if(!e)return;const t=qt(e),a=new Set,s=[];for(const c of t){if(c.type==="service"&&c.id){if(a.has(c.id))continue;a.add(c.id)}s.push(c)}const r=s.reduce((c,m)=>c+(m.price||0),0);let o=[],n={remainingAmount:r,selectedMethod:"dinheiro",installments:1,amountReceived:""};const i=()=>{const c=document.getElementById("payment-list"),m=document.getElementById("remaining-amount"),b=document.getElementById("finalize-checkout-btn"),f=document.getElementById("change-container"),v=document.getElementById("installments-container"),x=document.getElementById("payment-value"),h=document.getElementById("payment-controls"),k=o.reduce((E,I)=>E+I.value,0);n.remainingAmount=r-k,c.innerHTML=o.map((E,I)=>`
            <div class="flex justify-between items-center bg-gray-100 p-2 rounded-md animate-fade-in-fast">
                <span class="font-medium text-sm">${E.method.charAt(0).toUpperCase()+E.method.slice(1)} ${E.installments>1?`(${E.installments}x)`:""}</span>
                <div class="flex items-center gap-2">
                    <span class="font-semibold">R$ ${E.value.toFixed(2)}</span>
                    <button data-action="remove-payment" data-payment-index="${I}" class="text-red-500 font-bold">&times;</button>
                </div>
            </div>`).join(""),n.remainingAmount<=.001?(m.textContent="Total Pago!",m.className="text-lg font-bold text-center mb-4 text-green-600",x.value="",b.disabled=!1,h&&(h.style.display="none")):(m.textContent=`Faltam: R$ ${n.remainingAmount.toFixed(2)}`,m.className="text-lg font-bold text-center mb-4 text-red-600",x.value=n.remainingAmount.toFixed(2),b.disabled=!0,h&&(h.style.display="block")),document.querySelectorAll(".payment-method-btn").forEach(E=>{E.classList.toggle("ring-2",E.dataset.method===n.selectedMethod),E.classList.toggle("ring-offset-2",E.dataset.method===n.selectedMethod)}),v.style.display=["credito","crediario"].includes(n.selectedMethod)?"block":"none",f.style.display=n.selectedMethod==="dinheiro"&&n.remainingAmount>0?"block":"none";const $=parseFloat(n.amountReceived)-n.remainingAmount;document.getElementById("change-value").textContent=`R$ ${$>0?$.toFixed(2):"0.00"}`},l=()=>{const c=document.getElementById("payment-value");let m=parseFloat(c.value);if(isNaN(m)||m<=0){g("Valor Inválido","Insira um valor de pagamento válido e maior que zero.","error");return}if(m>n.remainingAmount+.001){g("Valor Inválido","O valor excede o saldo restante.","error");return}const b={method:n.selectedMethod,value:m};["credito","crediario"].includes(n.selectedMethod)&&n.installments>1&&(b.installments=n.installments),o.push(b),n.selectedMethod="dinheiro",n.installments=1,document.getElementById("installments-select").value=1,i()},d=`
        ...
        <div id="payment-controls" class="space-y-4 border-t pt-4">
            ...
            <div id="installments-container" class="hidden"><label class="text-sm font-medium">Parcelas</label><select id="installments-select" class="w-full p-2 border rounded-md bg-white mt-1">${Array.from({length:12},(c,m)=>`<option value="${m+1}">${m+1}x</option>`).join("")}</select></div>
    ...
    `,{modalElement:u}=N({title:"Finalizar Pagamento",contentHTML:d,maxWidth:"max-w-md"});document.getElementById("payment-value").value=n.remainingAmount.toFixed(2),u.addEventListener("click",c=>{const m=c.target.closest(".payment-method-btn");m&&(n.selectedMethod=m.dataset.method,n.installments=1,document.getElementById("installments-select").value=1,i()),c.target.closest("#add-payment-btn")&&l(),c.target.closest('[data-action="remove-payment"]')&&(o.splice(parseInt(c.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),i()),c.target.closest("#finalize-checkout-btn")&&Ur(e,r,o)}),u.addEventListener("change",c=>{c.target.id==="installments-select"&&(n.installments=parseInt(c.target.value,10))}),u.addEventListener("input",c=>{c.target.id==="amount-received"&&(n.amountReceived=c.target.value,i())}),i()}async function jr(){const e=`
    ...
    `,{modalElement:t}=N({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=document.getElementById("initial-amount"),r=s.value.trim(),o=document.getElementById("cashier-notes").value.trim(),n=parseFloat(r);if(r===""||isNaN(n)||n<0){g("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),s.focus();return}try{const i={establishmentId:p.establishmentId,initialAmount:parseFloat(n.toFixed(2))};o&&(i.notes=o);const l=await Er(i);y.isCashierOpen=!0,y.activeCashierSessionId=l.id,await xa(),document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto com valor inicial de R$ ${n.toFixed(2)}`,"success")}catch(i){g("Erro",`Não foi possível abrir o caixa: ${i.message}`,"error")}})}async function Hr(){const e=y.activeCashierSessionId;if(e)try{const t=await Lr(e),a=`
        ...
        `,{modalElement:s}=N({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0){g("Valor Inválido","Insira um valor final válido.","error");return}try{await Cr(e,o),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await xa(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){g("Erro",`Não foi possível fechar o caixa: ${n.message}`,"error")}})}catch(t){g("Erro",`Não foi possível carregar o relatório de fecho: ${t.message}`,"error")}}async function Or(e){y.activeFilter!==e&&(y.activeFilter=e,y.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),ge(),await te(),y.selectedComandaId=null,G())}function oa(e){y.selectedComandaId=e,de(),Mr(),G()}async function zr(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;const s=Array(t).fill(0).map(()=>({id:e.id,name:e.name,price:e.price,type:e.type}));if(a.comandaItems=a.comandaItems||[],a.comandaItems.push(...s),a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),G(),de();return}try{await ga(a.id,a),g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),G(),de()}catch(r){g("Erro",`Não foi possível adicionar o item: ${r.message}`,"error"),a.comandaItems.splice(a.comandaItems.length-t,t)}}async function Vr(e,t){const a=y.allComandas.find(o=>o.id===y.selectedComandaId);if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>o.id===e&&o.type===t);if(r>-1)a.comandaItems.splice(r,1),s=!0;else{let o=(a.services||[]).findIndex(n=>n.id===e);if(o>-1)a.services.splice(o,1),s=!0;else{let n=(a.items||[]).findIndex(i=>i.id===e&&i.type===t);n>-1&&(a.items.splice(n,1),s=!0)}}if(s){if(a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso","Item removido!","success"),G(),de();return}try{await ga(a.id,a),g("Sucesso","Item removido!","success"),G(),de()}catch(o){g("Erro",`Não foi possível remover o item: ${o.message}`,"error"),await te()}}}async function Ur(e,t,a){const s=e.type==="appointment",r=qt(e),o=new Set,n=[];for(const l of r){if(l.type==="service"&&l.id){if(o.has(l.id))continue;o.add(l.id)}n.push(l)}const i={payments:a,totalAmount:t,items:n,cashierSessionId:y.activeCashierSessionId};try{s?await ms(e.id,i):(i.clientName=e.clientName,i.professionalId=e.professionalId,i.clientPhone=e.clientPhone,await vr(i)),g("Sucesso!","Venda finalizada com sucesso!","success"),document.getElementById("genericModal").style.display="none",ge(),y.selectedComandaId=null,await te()}catch(l){g("Erro no Checkout",l.message,"error")}}async function Jr(e){e.preventDefault();const t=document.getElementById("new-sale-client").value,a=document.getElementById("new-sale-professional").value,s=y.clients.find(n=>n.id===t),r=p.professionals.find(n=>n.id===a);if(!s||!r){g("Erro","Selecione um cliente e um profissional válidos.","error");return}const o={id:`temp-${Date.now()}`,type:"walk-in",clientName:s.name,clientPhone:s.phone,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(o),y.selectedComandaId=o.id,document.getElementById("genericModal").style.display="none",oa(o.id)}async function te(){const e=document.getElementById("comandas-list");e.innerHTML='<div class="loader mx-auto mt-10"></div>';const t=y.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=await Eo();if(y.isCashierOpen=!!a,y.activeCashierSessionId=a?a.id:null,Ar(),!y.isCashierOpen&&y.activeFilter==="atendimento"){de(),G();return}const s=await fr(p.establishmentId,t,y.paging.page,y.paging.limit);if(y.allComandas=s.data||s,y.paging.total=s.total||s.length,y.catalog.services.length===0){const[r,o,n,i,l]=await Promise.all([Me(p.establishmentId),At(p.establishmentId),Co(p.establishmentId),Mt(p.establishmentId),_(p.establishmentId)]);y.catalog={services:r,products:o,packages:n},y.clients=i,p.professionals=l}de(),y.selectedComandaId,G()}catch(a){g("Erro de Carregamento",`Não foi possível carregar os dados: ${a.message}`,"error"),e.innerHTML=`<p class="text-red-500 p-4">${a.message}</p>`}}async function xa(e={}){ye=document.getElementById("content");try{const t=await Eo();y.isCashierOpen=!!t,y.activeCashierSessionId=t?t.id:null}catch(t){console.error("Erro ao verificar caixa:",t),y.isCashierOpen=!1}y.selectedComandaId=e.selectedAppointmentId||null,Pr(),xe&&(ye.removeEventListener("click",xe),ye.removeEventListener("change",xe)),xe=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(t.target.id==="filter-date"&&y.activeFilter==="finalizadas"){y.paging.page=1,await te();return}if(a){if(a.matches("[data-filter]"))Or(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}oa(a.dataset.comandaId)}else if(a.matches("[data-action]")){const s=a.dataset.action,r=a.dataset.id||y.selectedComandaId;switch(s){case"back-to-list":{ge(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(o=>o.classList.remove("selected")),G();break}case"new-sale":Io();break;case"add-item":Fr();break;case"checkout":Rr();break;case"open-cashier":jr();break;case"close-cashier":await Hr();break;case"view-sales-report":Y("sales-report-section");break;case"remove-item":await Vr(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await A("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await us(r);const n=y.allComandas.findIndex(i=>i.id===r);n!==-1&&(delete y.allComandas[n].transaction,delete y.allComandas[n].cashierSessionId,delete y.allComandas[n].redeemedReward,y.allComandas[n].status="confirmed"),y.selectedComandaId=null,ge(),g("Sucesso!","Comanda reaberta para edição.","success"),await te()}catch(n){g("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"reopen-walk-in":{if(await A("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await hr(r),g("Sucesso!","Venda revertida."),ge(),y.selectedComandaId=null,await te()}catch(n){g("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"go-to-appointment":{const o=a.dataset.id,n=a.dataset.date;Y("agenda-section",{scrollToAppointmentId:o,targetDate:new Date(n)});break}case"delete-walk-in":{if(await A("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(r.startsWith("temp-"))y.allComandas=y.allComandas.filter(n=>n.id!==r),y.selectedComandaId=null,de(),G(),g("Sucesso","Venda avulsa removida.","success"),ge();else try{await xr(r),g("Sucesso","Venda avulsa excluída com sucesso.","success"),y.selectedComandaId=null,ge(),await te()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}break}}}}},ye.addEventListener("click",xe),ye.addEventListener("change",xe),e.initialFilter&&(y.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${y.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",y.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await te(),y.selectedComandaId&&oa(y.selectedComandaId)}const sa=document.getElementById("content");let Ee={};const st=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],B={startDate:new Date(new Date().getFullYear(),0,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,currentTab:"dashboards",apptViewMode:"year",apptSelectedMonth:null};async function _r(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function Wr(){sa.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">Carregando inteligência de dados...</p></div>';try{await _r();const[e,t]=await Promise.all([_(p.establishmentId),js().catch(()=>[])]);B.professionalsList=e,B.costCentersList=t,Gr(),await Lo()}catch(e){sa.innerHTML=`
            ...
            </div>`}}function Gr(){const e=B.professionalsList.map(a=>`<option value="${a.id}">${a.name}</option>`).join(""),t=B.costCentersList.map(a=>`<option value="${a.id}">${a.name}</option>`).join("");sa.innerHTML=`
    ...
    `,document.getElementById("btn-filter").onclick=Yr,document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{B.currentTab=a.dataset.tab,za(),To()}}),za()}function za(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===B.currentTab;e.className=t?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function Yr(){B.startDate=document.getElementById("report-start").value,B.endDate=document.getElementById("report-end").value,B.selectedProfessional=document.getElementById("report-prof").value,B.selectedCostCenter=document.getElementById("report-cost").value,B.apptViewMode="year",B.apptSelectedMonth=null,await Lo()}async function Lo(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const t=await Fs(B.startDate,B.endDate,B.selectedProfessional,B.selectedCostCenter);B.data=t,To()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function To(){const e=document.getElementById("report-content");switch(B.currentTab){case"dashboards":Xr(e);break;case"appointments":ya(e);break;case"dre":en(e);break}}function Xr(e){const{dreSimple:t,charts:a}=B.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0},r=B.data.totalAppointments||0,o=r>0?s.grossRevenue/r:0;e.innerHTML=`
    ...
    `,rt("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,st[0]),rt("chart-profs","doughnut","Total Vendas",a.professionals.labels,a.professionals.data,st),rt("chart-daily","line","Vendas Diárias",a.salesDaily.labels,a.salesDaily.data,st[4]),rt("chart-products","bar","Total Vendido",a.products.labels,a.products.data,st[1])}function ya(e){const{charts:t}=B.data;let a='<h3 class="font-bold text-gray-700 text-lg">Visão Anual/Mensal</h3>',s="Clique na barra do Mês para detalhar os dias";B.apptViewMode==="month"&&(a=`
            ...
            </div>`,s="Clique na barra do Dia para ver a lista de clientes"),e.innerHTML=`
    ...
    `;const r=document.getElementById("btn-back-year");r&&(r.onclick=()=>{B.apptViewMode="year",B.apptSelectedMonth=null,ya(e)});try{Qr()}catch(o){console.error("Erro ao renderizar gráfico de agendamentos:",o)}}function Qr(){const e=document.getElementById("chart-appointments").getContext("2d");Ee["chart-appointments"]&&Ee["chart-appointments"].destroy();const{charts:t}=B.data;let a,s;if(B.apptViewMode==="year")a=t.appointmentsMonthly.labels,s=t.appointmentsMonthly.data;else{const o=B.apptSelectedMonth.match(/([a-zç\.]+)(?:[\/\s\-]*)(\d{2,4})/i);if(!o){console.error("Formato de mês não reconhecido:",B.apptSelectedMonth);return}const n=o[1].toLowerCase().replace(/\./g,"").trim(),i=o[2],l=i.length===2?"20"+i:i,c=`/${{jan:"01",fev:"02",mar:"03",abr:"04",mai:"05",jun:"06",jul:"07",ago:"08",set:"09",out:"10",nov:"11",dez:"12",janeiro:"01",fevereiro:"02",março:"03",abril:"04",maio:"05",junho:"06",julho:"07",agosto:"08",setembro:"09",outubro:"10",novembro:"11",dezembro:"12"}[n]||"01"}/${l}`,m=Object.entries(t.appointmentsDaily.data).map(([b,f],v)=>{const x=t.appointmentsDaily.labels[v];return x.includes(c)?{label:x,value:f}:null}).filter(Boolean);a=m.map(b=>b.label),s=m.map(b=>b.value)}const r={type:"bar",data:{labels:a,datasets:[{label:"Volume de Agendamentos",data:s,backgroundColor:B.apptViewMode==="year"?"#3b82f6":"#8b5cf6",borderRadius:4,hoverBackgroundColor:"#1e40af"}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(o,n)=>{if(n.length>0){const i=n[0].index,l=a[i];Zr(l)}},plugins:{legend:{display:!1},tooltip:{callbacks:{label:o=>` ${o.raw} Agendamentos`}}}}};Ee["chart-appointments"]=new Chart(e,r)}function Zr(e){B.apptViewMode==="year"?(B.apptViewMode="month",B.apptSelectedMonth=e,ya(document.getElementById("report-content"))):B.apptViewMode==="month"&&Kr(e)}async function Kr(e){const[t,a,s]=e.split("/"),r=`${s}-${a}-${t}`;N({title:"Carregando...",contentHTML:'<div class="p-8 text-center"><div class="loader mx-auto"></div></div>',maxWidth:"max-w-2xl"});try{const o=await Rs(r,B.selectedProfessional);let n="";o.length===0?n='<div class="text-center py-8 text-gray-500 bg-gray-50 rounded-lg">Nenhum agendamento encontrado para este dia.</div>':n=`
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                            ${o.map(l=>`
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-4 py-3 font-bold text-gray-900">${l.time||"--:--"}</td>
                                    <td class="px-4 py-3 text-indigo-700 font-medium">${l.professionalName||"N/A"}</td>
                                    <td class="px-4 py-3 text-gray-700">${l.clientName||"Cliente"}</td>
                                    <td class="px-4 py-3 text-gray-500">${l.serviceName||"Serviço"}</td>
                                    <td class="px-4 py-3">
                                        <span class="px-2 py-1 rounded-full text-xs font-bold ${l.status==="completed"?"bg-green-100 text-green-800":l.status==="canceled"?"bg-red-100 text-red-800":"bg-blue-100 text-blue-800"}">
                                            ${l.status==="completed"?"Concluído":l.status==="canceled"?"Cancelado":"Agendado"}
                                        </span>
                                    </td>
                                </tr>
                            `).join("")}
    ...
    `}function rt(e,t,a,s,r,o){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");Ee[e]&&Ee[e].destroy();const l={type:t,data:{labels:s,datasets:[{label:a,data:r,backgroundColor:Array.isArray(o)?o:t==="line"?"rgba(79, 70, 229, 0.1)":o,borderColor:Array.isArray(o)?"#fff":o,borderWidth:2,fill:t==="line",tension:.3,borderRadius:t==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:o,pointHoverBackgroundColor:o}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let u=d.dataset.label||"";return u&&(u+=": "),d.parsed.y!==null?u+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):u+=d.raw,u}}}},scales:t==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};Ee[e]=new Chart(i,l)}const Nt=(e,t="products")=>w(`/api/${t}/categories/${e}`),Bo=(e,t="products")=>w(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),Do=(e,t="products")=>w(`/api/${t}/categories/${e}`,{method:"DELETE"}),tn="audit_logs",Te=async(e,t,a,s,r,o=null)=>{try{if(!t)return;await pa(De(Z,tn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:r,details:o,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},pe=document.getElementById("content");let ne=null,je="services",fe="all";function Be(){const e=U.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function an(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Bo({establishmentId:p.establishmentId,name:s},"services"),Te(p.establishmentId,Be(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",g("Sucesso","Categoria criada!","success"),await wa(),await Ke()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function on(e){if(await A("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Do(e,"services"),Te(p.establishmentId,Be(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await wa(),await Ke()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function wa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Nt(p.establishmentId,"services");p.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function sn(){N({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",an),t.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),on(r.dataset.id))}))}wa()}async function rn(e){e.preventDefault();const t=e.target.closest("#serviceModal"),a=t.querySelector("#serviceId").value,s={},r=t.querySelector('input[name="commissionType"]:checked').value;r==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(n=>{const i=n.dataset.profId;if(n.querySelector('input[type="checkbox"]').checked){const d=parseFloat(n.querySelector('input[type="number"]').value);s[i]=isNaN(d)?0:d}});const o={establishmentId:p.establishmentId,name:t.querySelector("#serviceName").value,price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:r,professionalCommissions:s};try{a?(await Vs(a,o),Te(p.establishmentId,Be(),"Serviços","Editou",`Editou o serviço: ${o.name}`)):(await zs(o),Te(p.establishmentId,Be(),"Serviços","Criou",`Criou novo serviço: ${o.name}`)),document.getElementById("serviceModal").style.display="none",g("Sucesso",`Serviço ${a?"atualizado":"adicionado"} com sucesso!`,"success"),await Ke()}catch(n){g("Erro",n.message,"error")}}function nn(e,t=800,a=800,s="image/jpeg",r=.8){return new Promise((o,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let u=d.width,c=d.height;u>c?u>t&&(c*=t/u,u=t):c>a&&(u*=a/c,c=a);const m=document.createElement("canvas");m.width=u,m.height=c,m.getContext("2d").drawImage(d,0,0,u,c);const f=m.toDataURL(s,r);o(f)},d.onerror=u=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function Va(e=null){const t=document.getElementById("serviceModal"),a=p.serviceCategories||[],s=e?.duration||0,r=e?.bufferTime||0,o=a.map(h=>`<option value="${h.id}" ${e?.categoryId===h.id?"selected":""}>${h.name}</option>`).join("");t.innerHTML=`
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async h=>{const k=h.target.closest("button[data-action]");if(!k)return;const $=k.dataset.action,E=k.dataset.id;if($==="close-modal"&&(t.style.display="none"),$==="delete-service"){if(!E)return;if(t.style.display="none",await A("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const D=p.services.find(H=>H.id===E)?.name||"Desconhecido";await Us(E),Te(p.establishmentId,Be(),"Serviços","Excluiu",`Excluiu o serviço: ${D}`),g("Sucesso","Serviço apagado com sucesso!","success"),await Ke()}catch(D){g("Erro",`Não foi possível apagar o serviço: ${D.message}`,"error")}else t.style.display="flex"}});const n=t.querySelectorAll(".tab-btn"),i=t.querySelectorAll(".tab-content");n.forEach(h=>{h.addEventListener("click",()=>{n.forEach(k=>{k.classList.remove("border-indigo-500","text-indigo-600"),k.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),h.classList.add("border-indigo-500","text-indigo-600"),h.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),i.forEach(k=>k.classList.add("hidden")),document.getElementById(`tab-content-${h.dataset.tab}`).classList.remove("hidden")})});const l=t.querySelectorAll('input[name="commissionType"]'),d=document.getElementById("defaultCommissionRateContainer"),u=document.getElementById("professionalCommissionsContainer");function c(){const h=t.querySelector('input[name="commissionType"]:checked').value;d&&(d.style.display=h==="default"?"block":"none"),u&&(u.style.display=h==="custom"?"block":"none")}l.forEach(h=>h.addEventListener("change",c));const m=document.getElementById("professionalCommissionsList");m&&(m.innerHTML=(p.professionals||[]).map(h=>{const k=e?.professionalCommissions?.[h.id]!==void 0,$=e?.professionalCommissions?.[h.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${k?"bg-blue-50":""}" data-prof-id="${h.id}">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" ${k?"checked":""} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                    ...
                    <div class="flex items-center gap-1">
                        <input type="number" value="${$}" class="w-20 p-1 border rounded-md text-sm text-center" ${k?"":"disabled"}>
                        <span class="text-sm font-semibold">%</span>
                    </div>
                </div>
            `}).join(""),m.querySelectorAll('input[type="checkbox"]').forEach(h=>{h.addEventListener("change",k=>{const $=k.target.closest(".professional-commission-row");$.querySelector('input[type="number"]').disabled=!k.target.checked,$.classList.toggle("bg-blue-50",k.target.checked)})})),c();const b=t.querySelector("#serviceForm"),f=t.querySelector("#servicePhotoInput"),v=t.querySelector("#servicePhotoPreview"),x=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>f.click()),f.onchange=async()=>{const h=f.files[0];if(h){v.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const k=await nn(h,800,800,"image/jpeg",.8),E=k.length*3/4,I=1e3*1024;if(E>I)throw new Error("A imagem é muito grande mesmo após a compressão.");v.src=k,x.value=k}catch(k){console.error("Erro ao processar imagem:",k),g("Erro de Imagem",k.message||"Não foi possível processar a imagem.","error"),v.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",x.value=e?.photo||"",f.value=""}}},b.addEventListener("submit",rn)}function we(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",s=new Map((p.serviceCategories||[]).map(o=>[o.id,o.name]));let r=(p.services||[]).filter(Boolean);if(fe!=="all"){const o=fe==="active";r=r.filter(n=>n.active!==!1===o)}r=r.filter(o=>{const n=o.name.toLowerCase().includes(t),i=a==="all"||o.categoryId===a;return n&&i}),e.innerHTML="",r.length>0?r.forEach(o=>{const n=document.createElement("div"),i=JSON.stringify(o).replace(/'/g,"&apos;");n.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:bg-gray-50 ${o.active!==!1?"opacity-100":"opacity-50 bg-gray-100"} sm:flex-col`,n.dataset.action="edit-service",n.dataset.service=i;const l=o.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(o.name.charAt(0))}`,d=s.get(o.categoryId)||"N/A";n.innerHTML=`
                <img src="${l}" alt="Imagem de ${o.name}" class="w-20 h-20 object-cover flex-shrink-0 sm:w-full sm:h-24">
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${a.name}</option>`)),ka(),we()}function dn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function Ke(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,r]=await Promise.all([Me(p.establishmentId),_(p.establishmentId),Nt(p.establishmentId,"services"),_s(p.establishmentId)]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(s||[]).filter(Boolean),p.mostPopularService=r||{name:"N/A",count:0},p.services.forEach(o=>{o.active===void 0&&(o.active=!0)}),Mo(je)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function Mo(e){if(document.getElementById("services-content-container")){if(je===e&&document.getElementById("services-content-container").children.length>1){je==="services"&&(ka(),we());return}je=e,fe="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?ln():e==="reports"&&dn()}}function cn(){ne&&(pe.removeEventListener("click",ne),pe.removeEventListener("input",ne),pe.removeEventListener("change",ne)),ne=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),o=r.dataset.id,n=r.checked;try{await Js(o,n);const i=p.services.findIndex(l=>l.id===o);i>-1&&(p.services[i].active=n),Te(p.establishmentId,Be(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${o}) para ${n?"Ativo":"Inativo"}`),we(),ka()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,we()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){we();return}if(!a)return;if(a.hasAttribute("data-view")){Mo(a.dataset.view);return}switch(a.dataset.action){case"new-service":Va();break;case"edit-service":const r=JSON.parse(a.dataset.service);Va(r);break;case"manage-categories":sn();break;case"filter-service":const o=a.dataset.filterType;if(o==="popular")return;fe=o==="total"?"all":o,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===fe||i==="total"&&fe==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),we();break}},pe.addEventListener("click",ne),pe.addEventListener("input",ne),pe.addEventListener("change",ne)}async function un(){pe.innerHTML=`
        ...
        </section>`,cn();try{(!p.professionals||p.professionals.length===0)&&(p.professionals=await _(p.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),p.professionals=[]}je="services",fe="all",await Ke()}const Ft="suppliers",Po="purchases",Sa=async()=>{try{const e=await bo(De(Z,Ft)),t=[];return e.forEach(a=>{t.push({id:a.id,...a.data()})}),t}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},mn=async e=>{try{return{id:(await pa(De(Z,Ft),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},pn=async(e,t)=>{try{const a=Lt(Z,Ft,e);return await ho(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},gn=async e=>{try{const t=Lt(Z,Ft,e);return await es(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},bn=async e=>{try{const t={...e,createdAt:new Date};return{id:(await pa(De(Z,Po),t)).id,...t}}catch(t){throw console.error("Erro ao registrar compra:",t),t}},fn=async e=>{try{const t=fo(De(Z,Po),vo("createdAt","desc")),a=await bo(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},ce=document.getElementById("content");let ie=null,He="products",ee="all";async function vn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Bo({establishmentId:p.establishmentId,name:s},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await $a(),await et()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function hn(e){if(await A("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Do(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await $a(),await et()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function $a(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Nt(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${a.name}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function xn(){N({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",vn),t.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&hn(r.dataset.id)}))}$a()}async function yn(e){if(!e)return;if(await A("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await kr(e),g("Sucesso","Produto apagado com sucesso!","success"),await et()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function wn(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),s=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),o=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(o).map(l=>l.dataset.id),i={establishmentId:p.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(s)?0:s,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await wr(t,i):await yr(i),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await et()}catch(l){throw new Error(l.message)}}function Ua(e,t=800,a=800,s="image/jpeg",r=.8){return new Promise((o,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let u=d.width,c=d.height;u>c?u>t&&(c*=t/u,u=t):c>a&&(u*=a/c,c=a);const m=document.createElement("canvas");m.width=u,m.height=c,m.getContext("2d").drawImage(d,0,0,u,c);const f=m.toDataURL(s,r);o(f)},d.onerror=u=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function Ja(e=null){const t=document.getElementById("productModal"),a=p.categories||[],s=p.suppliers||[],r=a.map(x=>`<option value="${x.id}" ${e?.categoryId===x.id?"selected":""}>${x.name}</option>`).join("");let o=new Set(e?.supplierIds||[]);t.innerHTML=`
    ...
    </div>`;const n=t.querySelector("#productCategory"),i=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>i.click()),n.innerHTML='<option value="">Sem categoria</option>'+(p.categories||[]).map(x=>`<option value="${x.id}" ${e?.categoryId===x.id?"selected":""}>${x.name}</option>`).join(""),e&&(n.value=e.categoryId||"");const l=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const d=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",u=e?.photo||"";i.onchange=async()=>{const x=i.files[0];if(x){l.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const h=await Ua(x,800,800,"image/jpeg",.8),$=h.length*3/4,E=1e3*1024;if($>E)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=h,base64Input.value=h}catch(h){console.error("Erro ao processar imagem:",h),g("Erro de Imagem",h.message||"Não foi possível processar a imagem.","error"),preview.src=d,base64Input.value=u,v.value=""}}};const c=t.cloneNode(!0);t.parentNode.replaceChild(c,t);const m=()=>{const x=c.querySelector("#modalSupplierSearch"),h=c.querySelector("#supplierSearchResults"),k=c.querySelector("#selectedSuppliersList"),$=x.value.toLowerCase();if($.length>0){const E=s.filter(I=>I.name.toLowerCase().includes($)&&!o.has(I.id));E.length>0?(h.classList.remove("hidden"),h.innerHTML=E.map(I=>`
                    <div class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 text-sm flex justify-between items-center" data-add-supplier="${I.id}">
                        <span class="font-medium">${I.name}</span>
                        <span class="text-indigo-600 text-xs">+ Adicionar</span>
                    </div>
                `).join("")):(h.classList.remove("hidden"),h.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else h.classList.add("hidden");o.size>0?(k.innerHTML="",o.forEach(E=>{const I=s.find(D=>D.id===E);I&&(k.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border p-2 rounded shadow-sm" data-id="${I.id}">
                            <div class="text-sm">
                                <p class="font-bold text-gray-800">${I.name}</p>
                                <p class="text-xs text-gray-500">${I.contactName||""} - ${I.phone||""}</p>
                            </div>
                            <button type="button" class="text-red-500 hover:text-red-700 p-1" data-remove-supplier="${I.id}" title="Remover">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                            </button>
                        </div>
                    `)})):k.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};c.querySelector("#modalSupplierSearch").addEventListener("input",m),c.addEventListener("click",x=>{const h=x.target.closest("[data-add-supplier]");if(h){const $=h.dataset.addSupplier;o.add($),c.querySelector("#modalSupplierSearch").value="",m()}const k=x.target.closest("[data-remove-supplier]");if(k){const $=k.dataset.removeSupplier;o.delete($),m()}}),m(),c.addEventListener("click",async x=>{const h=x.target.closest("button[data-action]");if(!h)return;const k=h.dataset.action,$=c.querySelector("#productId").value;if(k==="close-modal"&&(c.style.display="none"),k==="delete-product"){if(!$)return;c.style.display="none",await yn($)}if(k==="save-product-modal"){const E=c.querySelector("#productForm");if(E){if(!E.querySelector("#productName").value||!E.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const I=h.closest('button[data-action="save-product-modal"]');I.disabled=!0,I.textContent="A salvar...";try{await wn(E)}catch(D){g("Erro",`Falha ao salvar: ${D.message}`,"error"),I.disabled=!1,I.textContent="Salvar Alterações"}}}if(k==="adjust-stock-modal"){x.preventDefault();const E=c.querySelector("#stockAdjustmentAmount"),I=c.querySelector("#stockAdjustmentReason"),D=parseInt(E.value,10),H=parseInt(h.dataset.change,10);if(!D||D<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const M=D*H,q=I.value||(M>0?"Entrada manual":"Saída manual");try{await Sr($,{change:M,reason:q});const F=p.products.findIndex(O=>O.id===$);if(F>-1){const O=p.products[F].currentStock+M;p.products[F].currentStock=O,c.querySelector("#currentStockDisplay").textContent=O,c.querySelector("#productCurrentStock").value=O,E.value="",I.value="",g("Sucesso","Estoque atualizado!","success"),Ea(),Ge()}}catch(F){g("Erro de Stock",F.message,"error")}}});const b=c.querySelectorAll(".tab-btn"),f=c.querySelectorAll(".tab-content");b.forEach(x=>{x.addEventListener("click",h=>{h.preventDefault(),b.forEach(k=>{k.classList.remove("border-indigo-500","text-indigo-600"),k.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),x.classList.add("border-indigo-500","text-indigo-600"),x.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),f.forEach(k=>k.classList.add("hidden")),document.getElementById(`tab-content-${x.dataset.tab}`).classList.remove("hidden")})});const v=c.querySelector("#productPhotoInput");c.querySelector("#productPhotoButton").addEventListener("click",()=>v.click()),v.onchange=async()=>{const x=v.files[0];if(!x)return;const h=c.querySelector("#productPhotoPreview"),k=c.querySelector("#productPhotoBase64");h.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const $=await Ua(x,800,800,"image/jpeg",.8),I=$.length*3/4,D=1e3*1024;if(I>D)throw new Error("A imagem é muito grande mesmo após a compressão.");h.src=$,k.value=$}catch($){console.error("Erro ao processar imagem:",$),g("Erro de Imagem",$.message||"Não foi possível processar a imagem.","error"),h.src=d,k.value=u,v.value=""}},c.style.display="flex"}function kn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${a.name}</option>`)),Ea(),Ge()}function Sn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        ...
        </div>`;const r=document.getElementById("productFilterReport"),o=document.getElementById("categoryFilterReport");r&&p.products&&(r.innerHTML+=p.products.map(n=>`<option value="${n.id}">${n.name}</option>`).join("")),o&&p.categories&&(o.innerHTML+=p.categories.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""))}async function $n(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value};try{const a=await $r(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                <div class="flex-1 sm:p-3 sm:flex sm:flex-col sm:flex-grow">
                    <div class="sm:flex-grow">
                        ...
                        <p class="text-xs text-gray-500 text-left mb-2 hidden sm:block">Categoria: ${d}</p>
                    </div>
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function et(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,s]=await Promise.all([At(p.establishmentId),Nt(p.establishmentId,"products"),Sa()]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),p.suppliers=(s||[]).filter(Boolean),Ao(He)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function Ao(e){if(document.getElementById("products-content-container")){if(He===e&&document.getElementById("products-content-container").children.length>1){He==="products"&&(Ea(),Ge());return}He=e,ee="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?kn():e==="movements"&&Sn()}}async function En(){ce.innerHTML=`
        ...
        </section>`,ie&&(ce.removeEventListener("click",ie),ce.removeEventListener("input",ie),ce.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){Ge();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){Ao(a.dataset.view);return}switch(a.dataset.action){case"new-product":Ja();break;case"edit-product":Ja(JSON.parse(a.dataset.product));break;case"manage-product-categories":xn();break;case"generate-report":await $n();break;case"filter-stock":const r=a.dataset.filterType;ee=ee===r?"all":r,document.querySelectorAll(".indicator-card").forEach(o=>{o.classList.toggle("ring-2",o.dataset.filterType===ee),o.classList.toggle("ring-indigo-500",o.dataset.filterType===ee),o.classList.toggle("shadow-lg",o.dataset.filterType===ee)}),Ge();break}},ce.addEventListener("click",ie),ce.addEventListener("input",ie),ce.addEventListener("change",ie),He="products",ee="all",await et()}const ue=document.getElementById("content");let le=null,vt="list",P={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Cn(){vt==="list"?Rt():vt==="purchases"?(P.step=1,Oe()):vt==="history"&&Mn()}async function In(){try{const e=await Sa();return p.suppliers=e||[],P.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Ln(e){if(await A("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await gn(e),g("Sucesso","Fornecedor excluído.","success"),Tt("genericModal"),Rt()}catch(t){g("Erro","Erro ao excluir: "+t.message,"error")}}async function Tn(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await pn(a,s),g("Sucesso","Fornecedor atualizado!","success")):(await mn(s),g("Sucesso","Fornecedor criado!","success")),Tt("genericModal"),Rt()}catch(o){g("Erro","Erro ao salvar: "+o.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Rt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await In();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=p.suppliers.filter(o=>o.name.toLowerCase().includes(t)||o.contactName&&o.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let s='<div class="flex flex-col gap-2 md:hidden">';a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;");s+=`
    ...
    `;a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=s+r}function Bn(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",s=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),o=`
    ...
    `;N({title:"",contentHTML:o,maxWidth:"max-w-md"})}async function Oe(){const e=document.getElementById("purchasesContainer");if(e)if(P.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([At(p.establishmentId),Sa()]);P.allSuppliers=a||[];const s=t.filter(d=>{const u=parseInt(d.currentStock||0),c=parseInt(d.minStock||0);return u<=c});if(P.productsToBuy=s,s.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',o="";s.forEach(d=>{const u=parseInt(d.minStock)||0,c=parseInt(d.currentStock)||0,m=Math.max(u-c,1),b=parseFloat(d.costPrice||0);let f='<option value="">Selecione...</option>';P.allSuppliers.length>0?P.allSuppliers.forEach(v=>{const h=d.supplierIds&&d.supplierIds.includes(v.id)?"selected":"";f+=`<option value="${v.id}" ${h}>${v.name}</option>`}):f='<option value="">Sem fornecedores</option>',r+=`
                        ...
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <div class="text-right">
                                ...
                                <div class="flex items-center justify-end gap-1 text-xs">
                                    <span class="font-bold text-red-600">${c}</span>
                                    <span class="text-gray-400">/</span>
                                    <span class="font-medium text-gray-600">${u} (Mín)</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <tr class="hover:bg-gray-50 border-b border-gray-100 product-row" data-product-id="${d.id}" data-cost="${b}">
                        ...
                        <td class="p-3 text-center text-xs text-gray-600">
                            <div class="flex flex-col items-center">
                                <span class="font-bold text-red-600">${c} <span class="text-gray-400 font-normal">Atual</span></span>
                                <span class="border-t border-gray-200 w-12 my-0.5"></span>
                                <span class="font-medium">${u} <span class="text-gray-400 font-normal">Mínimo</span></span>
                            </div>
                        </td>
            ...
            `,ra()}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao calcular compras.</p>'}}else P.step===2&&Dn(e)}function Dn(e){if(!P.finalOrders||Object.keys(P.finalOrders).length===0){P.step=1,Oe();return}const t=P.isQuoteMode;let a="",s=0;const r=t?"border-indigo-100":"border-gray-200",o=t?"bg-indigo-50 border-indigo-100":"bg-gray-50 border-gray-200",n=t?"bg-blue-100 text-blue-700":"bg-green-100 text-green-700",i=t?"hidden":"flex",l=t?"Cotações Prontas":"Pedidos Prontos",d=t?"text-indigo-600":"text-green-600",u=t?"bg-indigo-50 border-indigo-100":"bg-green-50 border-green-100",c=t?"text-indigo-800":"text-green-800";for(const[m,b]of Object.entries(P.finalOrders)){let f=0,v=b.items.map($=>{const E=$.qty*$.cost;return f+=E,`
            <div class="flex justify-between py-2 border-b border-gray-50 text-sm">
                <span class="text-gray-800 font-medium">${$.name}</span>
                <div class="text-right">
                    <span class="text-gray-500 text-xs block">${$.qty} x R$ ${$.cost.toFixed(2)}</span>
                    <span class="text-indigo-600 font-bold block">R$ ${E.toFixed(2)}</span>
                </div>
            </div>
        `}).join("");s+=f;const x=encodeURIComponent(JSON.stringify({supplierId:m,supplierName:b.info.name,totalAmount:f,items:b.items})),h=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),k=encodeURIComponent(JSON.stringify(b.items));a+=`
        ...
        <div class="space-y-4 animate-fade-in pb-24">
            <div class="flex flex-col justify-between items-center gap-3 ${u} p-4 rounded-lg border text-center">
                <div>
                    <h3 class="font-bold ${c} text-lg">${l}</h3>
    ...
    `}async function Mn(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await fn(p.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(o=>{const n=new Date(o.createdAt.seconds*1e3).toLocaleDateString("pt-BR");a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function Pn(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;N({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Tn),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Tt("genericModal"))},50)}function qn(){ue.innerHTML=`
    ...
    `,le&&(ue.removeEventListener("click",le),ue.removeEventListener("input",le),ue.removeEventListener("change",le)),le=e=>{if(e.target.closest("#tab-btn-list")&&nt("list"),e.target.closest("#tab-btn-purchases")&&nt("purchases"),e.target.closest("#tab-btn-history")&&nt("history"),e.target.id==="toggle-quote-mode"&&(P.isQuoteMode=e.target.checked,Oe()),e.target.id==="supplierSearchInput"&&Rt(),e.target.closest("#btn-new-supplier")&&_a(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),s=JSON.parse(a.dataset.supplier);Bn(s)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&Ln(t.dataset.id),a==="edit"&&_a(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&ra(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=a),ra()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),s={};let r=!1;if(a.forEach(o=>{if(o.offsetParent===null||!o.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=o.querySelector("td:nth-child(2)"),d=o.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const u=parseInt(o.querySelector(".qty-input").value),c=parseFloat(o.dataset.cost),b=o.querySelector(".supplier-select").value;if(b){if(!s[b]){const f=P.allSuppliers.find(v=>v.id===b);s[b]={info:f,items:[]}}s[b].items.push({name:i,qty:u,cost:c})}}),!r){g("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}P.finalOrders=s,P.step=2,Oe()}if(e.target.closest("#btn-back-step1")&&(P.step=1,Oe()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),o=parseFloat(a.dataset.total),n=P.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?

Gostaria de solicitar uma *cotação* para os seguintes itens:

`,r.forEach(u=>{l+=`- ${u.qty}x ${u.name}
`}),l+=`
...
`,r.forEach(u=>{l+=`- ${u.qty}x ${u.name}
`}),l+=`
Aguardo confirmação.`);const d=`https://wa.me/${i}?text=${encodeURIComponent(l)}`;window.open(d,"_blank"),g("Aberto","WhatsApp aberto.","success")}else if(s.email){const i=n?`Solicitação de Cotação - ${p.establishmentName||"Empresa"}`:`Pedido de Compra - ${p.establishmentName||"Empresa"}`;let l=`Olá ${s.name},
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order"),s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=p.establishmentId,bn(s).then(()=>{g("Sucesso","Compra registrada no histórico!","success"),a.disabled=!0,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=P.finalOrders[s];r?An(r,P.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);Pn(s)}},ue.addEventListener("click",le),ue.addEventListener("input",le),ue.addEventListener("change",le),nt("list")}function nt(e){vt=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Cn()}const zt=document.getElementById("content"),Wa={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let oe=new Set,it=null,ke=null;function Nn(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Fn(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,r=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Vt(){const e=document.getElementById("genericModal");e.style.display="none",ke&&e.removeEventListener("click",ke)}async function Rn(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=p.services||await Me(p.establishmentId),r=p.professionals||await _(p.establishmentId),o=`
        ...
        </div>`;t.innerHTML=o,t.style.display="flex",jn(a,s),On(a),zn(a,r),Un(a)}function jn(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(m,b)=>{const f=b+1,v=f==s[1]?"selected":"",x=new Date(0,b).toLocaleString("pt-BR",{month:"long"});return`<option value="${f}" ${v}>${x.charAt(0).toUpperCase()+x.slice(1)}</option>`}).join(""),o=e.status||"active";a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${e.notes||""}</textarea></div>`;const n=document.getElementById("profPhotoInput"),i=document.getElementById("profPhotoButton"),l=document.getElementById("profPhotoPreview"),d=document.getElementById("profPhotoBase64"),u=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,c=e.photo||"";i&&i.addEventListener("click",()=>n.click()),n&&(n.onchange=async()=>{const m=n.files[0];if(m){l.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const b=await Hn(m,800,800,"image/jpeg",.8);l.src=b,d.value=b}catch(b){g("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),l.src=u,d.value=c,n.value=""}}})}function Hn(e,t=800,a=800,s="image/jpeg",r=.8){return new Promise((o,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let u=d.width,c=d.height;u>c?u>t&&(c*=t/u,u=t):c>a&&(u*=a/c,c=a);const m=document.createElement("canvas");m.width=u,m.height=c,m.getContext("2d").drawImage(d,0,0,u,c);const f=m.toDataURL(s,r);o(f)},d.onerror=u=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function On(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',Vn(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function zn(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        </div>`;const s=document.getElementById("batchBlockageForm");s&&s.addEventListener("submit",async o=>{o.preventDefault();const n=Array.from(o.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(b=>b.value);if(n.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const i=o.target.batchBlockageStartDate.value,l=o.target.batchBlockageEndDate.value||i,d=o.target.batchBlockageStartTime.value,u=o.target.batchBlockageEndTime.value,c=o.target.batchBlockageReason.value;if(!i||!d||!u)return g("Atenção","Preencha Data de Início, Início e Fim.","error");const m=n.map(b=>{const f={professionalId:b,establishmentId:p.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${u}`).toISOString(),reason:c};return Dt(f)});try{await Promise.all(m),g("Sucesso!",`${n.length} bloqueios foram criados.`);const b=document.getElementById("prof-blockages-filter").value;ze(e.id,b)}catch(b){g("Erro",b.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",o=>ze(e.id,o.target.value)),await ze(e.id,"future")}function Vn(e,t){e.innerHTML=Object.keys(Wa).map(a=>{const s=t[a]||{},r=s.active!==!1;return`
            <div class="day-schedule-card p-3 rounded-lg ${r?"bg-white":"bg-gray-100 disabled"} border">
                 <div class="flex justify-between items-center"><span class="font-semibold text-gray-800">${Wa[a]}</span><label class="flex items-center cursor-pointer"><div class="relative"><input type="checkbox" data-day="${a}" data-field="active" class="sr-only" ${r?"checked":""}><div class="toggle-bg block bg-gray-300 w-10 h-6 rounded-full"></div></div></label></div>
            ...
            </div>`}).join(""),e.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",s=>{const r=s.target.closest(".day-schedule-card"),o=!s.target.checked;r.classList.toggle("bg-white",!o),r.classList.toggle("bg-gray-100",o),r.classList.toggle("disabled",o),r.querySelectorAll(".time-inputs input").forEach(n=>n.disabled=o)})})}async function ze(e,t="future"){const a=document.getElementById("blockagesList");if(a){a.innerHTML='<div class="loader mx-auto"></div>';try{const s=new Date;let r,o;t==="history"?(o=new Date,r=new Date,r.setFullYear(r.getFullYear()-2)):(r=new Date,o=new Date,o.setFullYear(o.getFullYear()+2));let i=(await Bt(p.establishmentId,r.toISOString(),o.toISOString(),e)).map(d=>({...d,startTime:new Date(d.startTime),endTime:new Date(d.endTime)}));t==="history"?i=i.filter(d=>d.endTime<s).sort((d,u)=>u.startTime-d.startTime):i=i.filter(d=>d.endTime>=s).sort((d,u)=>d.startTime-u.startTime);const l=i.reduce((d,u)=>{const c=u.reason||"Sem motivo";return d[c]||(d[c]=[]),d[c].push(u),d},{});if(Object.keys(l).length===0){a.innerHTML=`<p class="text-center text-gray-500 text-sm py-4">Nenhum bloqueio ${t==="history"?"no histórico":"futuro"}.</p>`;return}a.innerHTML=Object.entries(l).map(([d,u])=>`
            <div class="bg-gray-100 rounded-lg p-3 my-2 space-y-2">
                <div class="flex justify-between items-center pb-2 border-b">
                    <h4 class="font-bold text-gray-700">${d} (${u.length})</h4>
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500">${s.message}</p>`}}}function Un(e){const t=document.getElementById("genericModal");ke&&t.removeEventListener("click",ke),ke=async a=>{const s=a.target.closest("button[data-action]");if(!s){const o=a.target.closest(".tab-link");o&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),o.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(o.dataset.tab).classList.remove("hidden"));return}const r=s.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Vt();break;case"delete-professional":const o=s.dataset.id;if(await A("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Is(o),g("Sucesso!","Profissional excluído.","success"),Vt(),kt()}catch(v){g("Erro",`Não foi possível excluir: ${v.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),u=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(v=>v.value),c={};d&&d.querySelectorAll(".day-schedule-card").forEach(v=>{const x=v.querySelector('[data-field="active"]').dataset.day;c[x]={active:v.querySelector('[data-field="active"]').checked,start:v.querySelector('[data-field="start"]').value,end:v.querySelector('[data-field="end"]').value,breakStart:v.querySelector('[data-field="breakStart"]').value,breakEnd:v.querySelector('[data-field="breakEnd"]').value}});const m={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:u,workingHours:c,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value};l.disabled=!0,l.textContent="A salvar...";try{m.id?(await Cs(m.id,m),g("Sucesso!","Profissional atualizado.","success")):(delete m.id,await Es(m),g("Sucesso!","Profissional criado.","success")),Vt(),kt()}catch(v){g("Erro",v.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=s.dataset.id;if(await A("Apagar Bloqueio","Tem certeza?"))try{await fa(b),g("Bloqueio removido.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";ze(e.id,v)}catch(v){g("Erro",v.message,"error")}break;case"batch-delete-blockage":const f=JSON.parse(s.dataset.ids);if(await A("Apagar em Lote",`Tem certeza que deseja apagar ${f.length} bloqueios com este motivo?`))try{await yo(f),g("Bloqueios removidos.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";ze(e.id,v)}catch(v){g("Erro",v.message,"error")}break}},t.addEventListener("click",ke)}function na(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(oe.size>0?(t.textContent=`${oe.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function Jn(){A("Excluir em Lote",`Tem certeza que deseja excluir ${oe.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await(void 0)(Array.from(oe)),g("Sucesso!",`${oe.size} profissionais foram excluídos.`,"success"),oe.clear(),na(),kt()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ae(){const e=document.getElementById("professionalsList");if(!e)return;if(!p.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Nn();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),s=p.professionals.filter(r=>{const o=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return o&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Fn(s)}async function kt(){oe.clear(),zt.innerHTML=`
        ...
        </section>`,it&&zt.removeEventListener("click",it),it=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),s=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let o={};if(a.dataset.professional)try{o=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}Rn(o);return}if(s){Jn();return}const r=t.target.closest(".professional-checkbox");if(r){const o=r.dataset.id;r.checked?oe.add(o):oe.delete(o),Ae(),na();return}},zt.addEventListener("click",it),document.getElementById("profSearchInput").addEventListener("input",Ae),document.getElementById("showInactiveProfToggle").addEventListener("change",Ae);const e=document.getElementById("professionalsList");p.professionals=null,p.services=null,Ae();try{const[t,a]=await Promise.all([_(p.establishmentId),Me(p.establishmentId)]);p.professionals=t,p.services=a,Ae(),na()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const Ut=document.getElementById("content");let Se=[],Q={},j=null,ia="list",J="all",la="O Estabelecimento";const qo=1,_n=(e,t)=>`Olá, ${e}! Nós da ${t} desejamos a você um Feliz Aniversário! Esperamos que seu dia seja maravilhoso. Venha comemorar conosco! 🎉🎂`,Wn=(e,t)=>`Oi, ${e}! Faz um tempo que não te vemos aqui no(a) ${t}. Sentimos sua falta! Temos novidades/ofertas especiais para você. Que tal agendar seu horário?`,Gn=[{value:30,label:"30 dias"},{value:60,label:"60 dias"},{value:90,label:"90 dias"},{value:120,label:"120 dias"}];function Yn(){return Math.floor(Math.random()*140)+10}function Xn(e){if(!e.dob)return!1;const t=e.dob.split("/");if(t.length!==2)return!1;const a=new Date,s=a.getDate(),r=a.getMonth()+1,o=parseInt(t[0],10),n=parseInt(t[1],10);return o===s&&n===r}const Qn=[{value:99,label:"Aniversariantes de Hoje"},{value:0,label:"Todos os meses (com DOB)"},{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}];function Ga(){return Qn.map(e=>{let t=e.value===99?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function Ya(){return Gn.map(e=>{const t=e.value===90?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function Ca(e){if(!e)return 0;let t=0;if(e.totalAmount!==void 0&&e.totalAmount!==null?t=parseFloat(e.totalAmount):e.value!==void 0&&e.value!==null?t=parseFloat(e.value):e.price!==void 0&&e.price!==null&&!Array.isArray(e.price)&&(t=parseFloat(e.price)),!t||t===0){let a=0;e.services&&Array.isArray(e.services)&&(a+=e.services.reduce((r,o)=>{const n=parseFloat(o.price)||parseFloat(o.servicePrice)||0;return r+n},0));const s=e.comandaItems||e.items;s&&Array.isArray(s)&&(a+=s.reduce((r,o)=>{const n=parseFloat(o.price)||0,i=parseInt(o.quantity)||1;return r+n*i},0)),a>0&&(t=a)}return isNaN(t)?0:t}function Zn(e,t){const a=`w-5 h-5 ${t} mr-2`;switch(e){case"cadastro":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>`;case"agendamentos":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`;case"historico":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v2a2 2 0 01-2 2h-2.586a1 1 0 00-.707.293l-1.414 1.414a1 1 0 01-1.414 0l-1.414-1.414A1 1 0 009.586 17H7a2 2 0 01-2-2v-2a2 2 0 012-2h12z" /></svg>`;case"fidelidade":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.5a9.5 9.5 0 1019 0 9.5 9.5 0 00-19 0z" /></svg>`;default:return""}}function Kn(e="cadastro"){const t=[{id:"cadastro",label:"Cadastro"},{id:"agendamentos",label:"Agend."},{id:"historico",label:"Histórico"},{id:"fidelidade",label:"Fidelidade"}],a=document.getElementById("client-detail-tabs");a&&(a.innerHTML=t.map(s=>{const r=e===s.id,o=r?"text-indigo-600":"text-gray-500";return`
            <button data-tab="${s.id}" class="tab-btn flex-1 py-3 px-2 border-b-2 font-medium text-xs sm:text-sm transition-colors flex items-center justify-center ${r?"border-indigo-500 text-indigo-600 bg-indigo-50":"border-transparent text-gray-500 hover:text-gray-700"}">
                ${Zn(s.id,o)}
                ${s.label}
            </button>
        `}).join(""),a.querySelectorAll(".tab-btn").forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),da(s.dataset.tab)})}))}async function da(e){Kn(e);const t=document.getElementById("client-detail-content");if(t){t.innerHTML='<div class="flex h-64 items-center justify-center"><div class="loader"></div></div>';try{switch(e){case"cadastro":t.innerHTML=ei(j);break;case"agendamentos":case"historico":const a=await Na(p.establishmentId,j.name,j.phone);t.innerHTML=ti(a,e);break;case"fidelidade":let s=[],r=[];try{s=await Na(p.establishmentId,j.name,j.phone)}catch(o){console.error("Erro ao buscar histórico de vendas:",o)}if(Q&&Q.enabled)try{r=await Ys(p.establishmentId,j.name,j.phone)}catch(o){console.warn("Aviso: Histórico de fidelidade indisponível.",o)}t.innerHTML=oi(j,s,r);break;default:t.innerHTML='<p class="p-6 text-center text-gray-500">Seção não implementada.</p>'}}catch(a){console.error("Erro crítico ao carregar aba:",a),t.innerHTML=`<div class="p-6 text-center text-red-500"><p>Erro ao carregar dados.</p><p class="text-xs mt-2">${a.message}</p></div>`}}}function ei(e){const t=e?.dob?e.dob.split("/"):["",""];return`
    ...
    `}function ti(e,t){const a=t==="agendamentos"?"Próximos Agendamentos":"Histórico de Visitas",s=t==="agendamentos"?"Nenhum agendamento futuro.":"Nenhum histórico de visitas.",r=new Date;r.setHours(0,0,0,0);const o=t==="agendamentos",n=(e||[]).filter(i=>{const l=new Date(i.date),d=new Date(l);d.setHours(0,0,0,0);const u=d.getTime()===r.getTime(),c=d>r,m=d<r,b=["completed","finalized","finished","paid"].includes((i.status||"").toLowerCase());return o?!b&&(c||u):m||b});return n.sort((i,l)=>o?new Date(i.date).getTime()-new Date(l.date).getTime():new Date(l.date).getTime()-new Date(i.date).getTime()),n.length===0?`<div class="p-6 text-center text-gray-500">${s}</div>`:`
        <div class="p-4 space-y-3">
            <h4 class="font-semibold text-lg mb-2 pl-2">${a}</h4>
            ${n.map(i=>{const l=t==="historico",d=Ca(i);return`
                    <div class="bg-white border p-3 rounded-lg flex justify-between items-center shadow-sm cursor-pointer hover:bg-gray-50"
                        data-action="${l?"open-comanda-from-history":"view-appointment"}" 
                        data-appointment-id="${i.id}"
                        data-appointment-date="${i.date}"> 
                        
                        <div>
                            <p class="font-bold text-gray-800 text-sm">${i.serviceName||"Serviço"}</p>
                            <p class="text-xs text-gray-500">${new Date(i.date).toLocaleDateString("pt-BR")} - ${i.professionalName||""}</p>
                        </div>

                        <span class="text-xs font-bold ${l?"text-indigo-600 bg-indigo-50 px-2 py-1 rounded":"text-green-600 bg-green-50 px-2 py-1 rounded"}">
                            ${l?`R$ ${d.toFixed(2)}`:"VER"}
                        </span>
                    </div>
                `}).join("")}
        </div>
    `}function ai(e,t){const a=(e||[]).filter(l=>{const d=(l.status||"").toLowerCase();return d==="completed"||d==="finished"||d==="paid"||d==="finalized"});let s=0;a.forEach(l=>{s+=Ca(l)});const r=Q&&Q.conversionRate?parseFloat(Q.conversionRate):qo,o=Math.floor(s*r);let n=0;(t||[]).forEach(l=>{l.type==="redeem"&&(n+=l.points||0)});const i=o-n;return{totalSpent:s,totalPointsEarned:o,totalPointsRedeemed:n,currentBalance:i}}function oi(e,t,a){if(!Q||!Q.enabled)return`<div class="p-8 text-center text-gray-500">
        ...
        </div>`;const s=ai(t,a);e.loyaltyPoints=s.currentBalance,e.totalSpent=s.totalSpent;const r=(Q.tiers||[]).map(l=>{const d=s.currentBalance>=l.points;return`
            <div class="flex justify-between items-center p-3 rounded-lg border ${d?"bg-green-50 border-green-200":"bg-gray-50 border-gray-200"}">
                <div>
                    <p class="font-bold text-sm ${d?"text-green-800":"text-gray-700"}">${l.reward}</p>
                    <p class="text-xs ${d?"text-green-600":"text-gray-500"} font-medium">${l.points} pts</p>
                </div>
                <button data-action="redeem-reward" data-points="${l.points}" data-reward="${l.reward}" ${d?"":"disabled"}
            ...
            </div>`}).join("")||'<p class="text-sm text-gray-400 italic">Nenhum prêmio configurado.</p>',o=[],n=Q.conversionRate||qo;(t||[]).forEach(l=>{const d=(l.status||"").toLowerCase();if(d==="completed"||d==="finished"||d==="paid"||d==="finalized"){const u=Ca(l),c=Math.floor(u*n);c>0&&o.push({type:"earn",desc:`Serviço/Compra (R$ ${u.toFixed(2)})`,points:c,date:l.date||l.createdAt})}}),(a||[]).forEach(l=>{o.push({type:"redeem",desc:`Resgate: ${l.reward||"Prêmio"}`,points:l.points,date:l.timestamp||l.date})}),o.sort((l,d)=>new Date(d.date)-new Date(l.date));const i=o.length>0?o.map(l=>`
        <div class="flex justify-between items-center py-2 border-b last:border-0 border-gray-100">
            <div>
                <p class="text-xs font-semibold text-gray-700">${l.desc}</p>
                <p class="text-[10px] text-gray-400">${new Date(l.date).toLocaleDateString("pt-BR")} ${new Date(l.date).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}</p>
            </div>
            <span class="text-xs font-bold ${l.type==="earn"?"text-green-600":"text-red-500"}">
    ...
    `).join(""):'<p class="text-xs text-center text-gray-400 py-4">Sem movimentações.</p>';return`
        <div class="p-4 space-y-6">
            <div class="bg-gradient-to-r from-indigo-600 to-blue-500 rounded-xl p-5 text-white shadow-lg text-center relative overflow-hidden">
                ...
                <p class="text-5xl font-extrabold mb-1">${s.currentBalance}</p>
                <p class="text-sm opacity-90">Total Gasto: R$ ${s.totalSpent.toFixed(2)}</p>
            </div>
    ...
    `}function No(e){j=e,ia="detail";const t=e!==null,a=t?"Editar Cliente":"Adicionar Cliente",s=`
        <div class="flex flex-col h-full bg-white rounded-xl overflow-hidden">
            ...
            <footer class="p-4 bg-gray-50 border-t flex justify-between items-center flex-shrink-0">
                <button type="button" id="deleteClientBtn" data-action="delete-client" class="text-red-500 hover:bg-red-50 p-2 rounded-full transition ${t?"":"hidden"}" title="Excluir">
    ...
    `,r=window.innerWidth<768,o=r?"max-w-full":"max-w-3xl";if(N({title:a,contentHTML:s,maxWidth:o}),r){const d=document.getElementById("genericModal");if(d){const u=d.querySelector(`.${o.replace(":","\\:")}`);u&&(u.style.height="auto",u.style.maxHeight="85vh",u.style.borderRadius="1rem")}}const n=document.getElementById("genericModal");n&&(n.onclick=async d=>{const u=d.target.closest("[data-action]");if(!u)return;switch(u.dataset.action){case"redeem-reward":{const m=parseInt(u.dataset.points,10),b=u.dataset.reward;if(await A("Confirmar Resgate",`Deseja resgatar "${b}" por ${m} pontos?`))try{await Xs(p.establishmentId,j.name,j.phone,{points:m,reward:b}),g("Prêmio resgatado com sucesso!","success"),await da("fidelidade")}catch(v){g(`Erro ao resgatar: ${v.message}`,"error")}break}case"open-comanda-from-history":{const m=u.dataset.appointmentId;m&&(document.getElementById("genericModal").style.display="none",Y("comandas-section",{selectedAppointmentId:m,initialFilter:"finalizada"}));break}case"view-appointment":{const m=u.dataset.appointmentId,b=u.dataset.appointmentDate;m&&b&&(document.getElementById("genericModal").style.display="none",Y("agenda-section",{targetDate:b,scrollToAppointmentId:m}));break}case"save-client":{d.preventDefault(),Xa();break}}}),da("cadastro"),setTimeout(()=>{const d=document.getElementById("client-form");d&&d.addEventListener("submit",u=>{u.preventDefault(),Xa()})},500);const i=document.getElementById("cancelDetailViewBtn");i&&i.addEventListener("click",d=>{d.preventDefault(),document.getElementById("genericModal").style.display="none",jt()});const l=document.getElementById("deleteClientBtn");l&&l.addEventListener("click",async()=>{await si()})}async function Xa(){const e=document.getElementById("client-form");if(!e)return;const t=e.querySelector("#clientId").value,a={name:e.querySelector("#clientName").value,email:e.querySelector("#clientEmail").value,phone:e.querySelector("#clientPhone").value,dob:`${e.querySelector("#clientDobDay").value}/${e.querySelector("#clientDobMonth").value}`,notes:e.querySelector("#clientNotes").value,establishmentId:p.establishmentId};if(!a.name||!a.phone){g("Erro","Nome e Telefone são obrigatórios.","error");return}try{t?(await Ws(t,a),g("Sucesso","Cliente atualizado com sucesso!","success")):(await va(a),g("Sucesso","Cliente cadastrado com sucesso!","success")),document.getElementById("genericModal").style.display="none",await jt()}catch(s){g("Erro",`Não foi possível salvar: ${s.message}`,"error")}}async function si(){if(!j||!j.id)return;if(await A("Excluir Cliente",`Tem certeza que deseja excluir ${j.name}? Esta ação é irreversível.`))try{await Gs(j.id),g("Sucesso","Cliente excluído.","success"),document.getElementById("genericModal").style.display="none",await jt()}catch(t){g("Erro",`Não foi possível excluir: ${t.message}`,"error")}}function ht(e,t){const a=document.getElementById("clientsList");if(a)if(a.innerHTML="",a.className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 content-start p-2 pb-20",document.getElementById("client-count").textContent=`${e.length} cliente${e.length!==1?"s":""} | Total: ${t}`,e.length>0){const s=J==="inactive",r=J==="birthdays";e.forEach(o=>{const n=document.createElement("div");n.className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 hover:shadow-md cursor-pointer transition-all flex flex-col justify-between h-full relative group",n.dataset.clientId=o.id;const i=o.loyaltyPoints||0,l=o.totalSpent||0;let d="";const c=`https://wa.me/55${o.phone?o.phone.replace(/\D/g,""):""}?text=`;if(s){const m=encodeURIComponent(Wn(o.name,la));d=`<a href="${c+m}" target="_blank" class="absolute top-2 right-2 text-blue-500 bg-blue-50 p-1 rounded-full z-10 hover:bg-blue-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 16.64C16.64 16.64 15.11 17.58 14.54 17.76C13.97 17.94 13.06 18.06 10.66 17.06C8.26 16.06 6.38 13.62 6.38 13.62C6.38 13.62 4.96 11.72 4.96 9.76C4.96 7.8 6.04 6.88 6.04 6.88C6.04 6.88 6.32 6.56 6.6 6.56C6.88 6.56 7.16 6.56 7.16 6.56C7.38 6.56 7.62 6.46 7.86 7.02C8.1 7.58 8.68 9.02 8.68 9.02C8.68 9.02 8.78 9.24 8.64 9.48C8.5 9.72 8.36 9.88 8.16 10.1C7.96 10.32 7.74 10.4 8.02 10.88C8.3 11.36 9.26 12.92 10.68 14.18C11.62 15.02 12.56 15.36 12.94 15.54C13.32 15.72 13.6 15.66 13.84 15.38C14.08 15.1 14.62 14.34 14.62 14.34C14.62 14.34 14.88 14.06 15.18 14.12C15.48 14.18 16.94 14.9 16.94 14.9C16.94 14.9 17.2 15.04 17.3 15.22C17.4 15.4 17.4 16.28 16.64 16.64Z"/></svg></a>`}else if(r&&Xn(o)){const m=encodeURIComponent(_n(o.name,la));d=`<a href="${c+m}" target="_blank" class="absolute top-2 right-2 text-green-500 bg-green-50 p-1 rounded-full z-10 hover:bg-green-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M... (mesmo icone)"/></svg></a>`}n.innerHTML=`
                ${d}
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div class="min-w-0">
                        <p class="font-bold text-gray-800 text-sm truncate leading-tight">${o.name}</p>
                        <p class="text-[10px] text-gray-500 truncate">${o.phone}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-1 border-t pt-2 mt-auto">
                    <div class="text-center border-r border-gray-100">
                        ...
                        <p class="text-xs font-bold text-gray-700">R$ ${l.toFixed(0)}</p>
                    </div>
                    <div class="text-center">
                        <p class="text-[10px] text-gray-400 uppercase font-semibold">Pontos</p>
                        <p class="text-xs font-bold text-indigo-600">${i}</p>
                    </div>
                </div>
            `,n.addEventListener("click",()=>No(o)),a.appendChild(n)})}else a.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum cliente encontrado com os filtros aplicados.</p>'}function xt(e="",t="all"){const a=e.toLowerCase(),s=a.length>0;let r=0,o=90;const n=window.innerWidth<768;if(t==="birthdays"){const l=n?"mobileBirthMonthFilter":"birthMonthFilter",d=document.getElementById(l);d&&(r=parseInt(d.value,10))}else if(t==="inactive"){const l=n?"mobileInactiveDaysFilter":"inactiveDaysFilter",d=document.getElementById(l);d&&(o=parseInt(d.value,10))}let i=Se.filter(l=>!s||l.name.toLowerCase().includes(a)||(l.phone||"").includes(a));switch(t){case"birthdays":const l=new Date,d=l.getDate(),u=l.getMonth()+1;return i.filter(c=>{if(!c.dob)return!1;const m=c.dob.split("/");if(m.length!==2)return!1;const b=parseInt(m[0],10),f=parseInt(m[1],10);return r===99?b===d&&f===u:r===0?f>=1&&f<=12:f===r});case"inactive":return i.filter(c=>(c.lastAppointmentDaysAgo||Yn())>o);case"credit":return i.filter(c=>(c.loyaltyPoints||0)>0);case"all":default:return i}}async function ri(e){const t=document.getElementById("birthMonthFilterContainer"),a=document.getElementById("mobileBirthMonthFilterContainer"),s=document.getElementById("inactiveDaysFilterContainer"),r=document.getElementById("mobileInactiveDaysFilterContainer"),o=e==="birthdays",n=e==="inactive";if([t,a].forEach(d=>d?.classList.toggle("hidden",!o)),[s,r].forEach(d=>d?.classList.toggle("hidden",!n)),o&&J!=="birthdays"&&document.querySelectorAll("#birthMonthFilter, #mobileBirthMonthFilter").forEach(d=>d.value=99),n&&J!=="inactive"&&document.querySelectorAll("#inactiveDaysFilter, #mobileInactiveDaysFilter").forEach(d=>d.value=90),J===e&&!o&&!n)return;J=e,document.querySelectorAll(".client-filter-btn").forEach(d=>{d.classList.remove("bg-white","text-indigo-600","shadow"),d.classList.add("bg-gray-100","text-gray-600")}),document.querySelectorAll(`[data-filter-key="${e}"]`).forEach(d=>{d.classList.remove("bg-gray-100","text-gray-600"),d.classList.add("bg-white","text-indigo-600","shadow")});const i=document.getElementById("clientSearchInput").value,l=xt(i,J);ht(l,Se.length)}async function jt(){ia="list",Ut.innerHTML=`
    ...
    `;try{const[u,c]=await Promise.all([Mt(p.establishmentId),Qe(p.establishmentId)]);Se=u,Q=c.loyaltyProgram||{enabled:!1},la=c.name||"O Estabelecimento";const m=xt("",J);ht(m,Se.length)}catch{const c=document.getElementById("clientsList");c&&(c.innerHTML='<p class="text-red-500 col-span-full text-center mt-10">Erro ao carregar dados dos clientes.</p>')}const e=document.getElementById("filter-sheet"),t=document.getElementById("filter-overlay"),a=document.getElementById("openFilterSheetBtn"),s=document.getElementById("closeFilterSheetBtn"),r=()=>{e.classList.remove("translate-y-full"),t.classList.remove("hidden")},o=()=>{e.classList.add("translate-y-full"),t.classList.add("hidden")};a&&a.addEventListener("click",r),s&&s.addEventListener("click",o),t&&t.addEventListener("click",o);const n=u=>{const c=u.target.closest(".client-filter-btn");if(c){ri(c.dataset.filterKey);const m=c.dataset.filterKey;window.innerWidth<768&&m!=="birthdays"&&m!=="inactive"&&o()}},i=document.getElementById("desktop-filter-bar"),l=document.getElementById("mobile-filter-list");i&&i.addEventListener("click",n),l&&l.addEventListener("click",n);const d=u=>{const c=document.getElementById(u);c&&c.addEventListener("change",()=>{if(J==="birthdays"||J==="inactive"){const m=document.getElementById("clientSearchInput").value,b=xt(m,J);ht(b,Se.length)}})};d("birthMonthFilter"),d("mobileBirthMonthFilter"),d("inactiveDaysFilter"),d("mobileInactiveDaysFilter"),Ut.addEventListener("click",async u=>{const c=u.target.closest("[data-action]");ia==="list"&&c&&c.dataset.action==="new-client"&&No(null)}),Ut.addEventListener("input",u=>{if(u.target.id==="clientSearchInput"){const c=u.target.value,m=xt(c,J);ht(m,Se.length)}})}const Ye=()=>w("/api/financial/natures"),ni=e=>w("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),ii=e=>w(`/api/financial/natures/${e}`,{method:"DELETE"}),Xe=()=>w("/api/financial/cost-centers"),li=e=>w("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),di=e=>w(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),Fo=(e,t)=>w(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),Ro=(e,t={})=>{let a=`/api/financial/${e}`;const s=new URLSearchParams;t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId);const r=s.toString();return r&&(a+=`?${r}`),w(a)},jo=(e,t,a)=>w(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),Ho=(e,t)=>w(`/api/financial/${e}/${t}`,{method:"DELETE"}),Oo=(e,t,a)=>w(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),ci=e=>Fo("payables",e),ui=e=>Ro("payables",e),mi=(e,t)=>jo("payables",e,t),pi=e=>Ho("payables",e),gi=(e,t)=>Oo("payables",e,t),bi=e=>Fo("receivables",e),fi=e=>Ro("receivables",e),vi=(e,t)=>jo("receivables",e,t),hi=e=>Ho("receivables",e),xi=(e,t)=>Oo("receivables",e,t),yi=(e,t)=>w(`/api/financial/cash-flow?startDate=${e}&endDate=${t}`),wi=()=>w("/api/financial/today-summary"),be=document.getElementById("content"),Jt={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},ki={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}},zo=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"}];let V=null;function Qa(e,t,a){return new Promise((s,r)=>{const o=new FileReader;o.readAsDataURL(e),o.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,u=i.height;d>t&&(u*=t/d,d=t),l.width=d,l.height=u,l.getContext("2d").drawImage(i,0,0,d,u);const m=e.type==="image/png"&&t<500?"image/png":"image/jpeg";s(l.toDataURL(m,a))},i.onerror=l=>r(l)},o.onerror=n=>r(n)})}function lt(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i="")=>{const l=n.id===t?"selected":"";a+=`<option value="${n.id}" ${l}>${i}${n.name}</option>`,n.children.forEach(d=>r(d,i+"— "))};return s(e).forEach(n=>r(n)),a}async function Pe(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const s=V||await Qe(p.establishmentId),r=[],{ownerName:o,...n}=e;if(o&&o!==p.userName){const l=U.currentUser;l&&r.push(Zo(l,{displayName:o}).then(()=>{p.userName=o}))}const i={...s,...n};if(r.push(ws(p.establishmentId,i)),await Promise.all(r),V=i,g("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),n.themeColor)setTimeout(()=>window.location.reload(),1500);else{const l=document.getElementById("panelEstablishmentName");n.name&&l&&(l.textContent=n.name,p.establishmentName=n.name)}}catch(s){g("Erro",`Não foi possível salvar: ${s.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function Si(e,t){t.innerHTML=`
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",a=>{a.preventDefault();const s={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,document:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};Pe(s,a)})}function $i(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!s||!r){g("Erro","Preencha todos os campos.","error");return}const o=t.querySelector('button[form="change-email-form"]');o.disabled=!0,o.textContent="A verificar...";try{const n=U.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=Go.credential(n.email,r);await Yo(n,i),o.textContent="A enviar link...",await Xo(n,s),o.textContent="A atualizar BD...",await Ss(p.establishmentId,s),g("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,g("Erro",i,"error")}finally{o.disabled=!1,o.textContent="Salvar Novo E-mail"}})}function Ci(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#establishmentLogoBase64").value=e.logo||"",t.querySelector("#establishmentBackgroundImageBase64").value=e.backgroundImage||"",Vo(e.themeColor||"indigo",t),t.querySelector("#establishmentLogoButton").onclick=()=>t.querySelector("#establishmentLogoInput").click(),t.querySelector("#establishmentLogoInput").onchange=async a=>{const s=a.target.files[0];if(s)try{const r=await Qa(s,300,.9);t.querySelector("#establishmentLogoPreview").src=r,t.querySelector("#establishmentLogoBase64").value=r}catch(r){console.error("Erro ao processar logo:",r),g("Erro","Formato de imagem inválido ou corrompido.","error")}},t.querySelector("#establishmentBgButton").onclick=()=>t.querySelector("#establishmentBgInput").click(),t.querySelector("#establishmentBgInput").onchange=async a=>{const s=a.target.files[0];if(s){const r=t.querySelector("#establishmentBgButton"),o=r.textContent;try{r.textContent="A processar...",r.disabled=!0;const n=await Qa(s,1280,.7);t.querySelector("#establishmentBgPreview").src=n,t.querySelector("#establishmentBgPreview").classList.remove("hidden"),t.querySelector("#establishmentBgPlaceholder").classList.add("hidden"),t.querySelector("#establishmentBackgroundImageBase64").value=n}catch(n){console.error("Erro ao processar fundo:",n),g("Erro","Não foi possível processar esta imagem. Tente outra.","error")}finally{r.textContent=o,r.disabled=!1}}},t.querySelector("#establishmentBgRemoveBtn").onclick=()=>{t.querySelector("#establishmentBgPreview").src="",t.querySelector("#establishmentBgPreview").classList.add("hidden"),t.querySelector("#establishmentBgPlaceholder").classList.remove("hidden"),t.querySelector("#establishmentBackgroundImageBase64").value=""},t.querySelector("#branding-form").addEventListener("submit",a=>{a.preventDefault();const s={logo:t.querySelector("#establishmentLogoBase64").value,welcomeMessage:t.querySelector("#establishmentWelcomeMessage").value,backgroundImage:t.querySelector("#establishmentBackgroundImageBase64").value,primaryColor:t.querySelector("#establishmentPrimaryColorInput").value,textColor:t.querySelector("#establishmentTextColorInput").value,themeColor:t.querySelector("#establishmentThemeColor").value};Pe(s,a)})}function Ii(e,t){const a=e.urlId||p.establishmentId,s="https://www.kairosagenda.com.br";let r=window.location.origin;(r.includes("localhost")||r.includes("capacitor://")||r.includes("127.0.0.1")||r.includes("192.168"))&&(r=s);const o=`${r}/agendar?id=${a}`,n=e.publicBookingEnabled||!1,i=n?"Agendamento Online ATIVO":"Agendamento Online INATIVO",l=n?"text-green-600":"text-red-600";t.innerHTML=`
    ...
    `,t.querySelector("#copyBookingLinkBtn").addEventListener("click",()=>{const d=t.querySelector("#publicBookingLink");if(navigator.clipboard&&window.isSecureContext)navigator.clipboard.writeText(d.value).then(()=>{g("Sucesso","Link copiado para a área de transferência!","success")}).catch(u=>{g("Erro","Não foi possível copiar o link.","error")});else try{d.select(),document.execCommand("copy"),d.blur(),g("Sucesso","Link copiado para a área de transferência!","success")}catch{g("Erro","Não foi possível copiar o link. Por favor, copie manualmente.","error")}}),t.querySelector("#publicBookingToggle").addEventListener("change",async d=>{const u=d.target.checked,c=t.querySelector("#publicBookingStatusText");u?(c.textContent="Agendamento Online ATIVO",c.className="text-sm font-semibold text-green-600"):(c.textContent="Agendamento Online INATIVO",c.className="text-sm font-semibold text-red-600");try{d.target.disabled=!0,await ks(p.establishmentId,u),V.publicBookingEnabled=u,g("Sucesso",`Agendamento online ${u?"ativado":"desativado"}!`,"success")}catch(m){g("Erro",`Não foi possível alterar o status: ${m.message}`,"error"),d.target.checked=!u,u?(c.textContent="Agendamento Online ATIVO",c.className="text-sm font-semibold text-green-600"):(c.textContent="Agendamento Online INATIVO",c.className="text-sm font-semibold text-red-600")}finally{d.target.disabled=!1}}),Mi(e.slotInterval||30,t),t.querySelector("#booking-form").addEventListener("submit",d=>{d.preventDefault();const u={slotInterval:parseInt(t.querySelector("#establishmentSlotInterval").value,10)};Pe(u,d)})}function Li(e,t){t.innerHTML=`
         <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");if(e.timezone)a.value=e.timezone;else try{const o=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(a.options).some(i=>i.value===o)?a.value=o:a.value="America/Sao_Paulo"}catch{a.value="America/Sao_Paulo"}const s=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(Jt).forEach(o=>{const n=r[o]||{},i=Jt[o],l=n.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${l?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",o=>{const n=o.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const n={};Object.keys(Jt).forEach(l=>{n[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;Pe({workingHours:n,timezone:i},o)})}function Ti(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([Ye(),Xe()]),r=e.financialIntegration||{},o=e.commissionConfig||{};t.querySelector("#financialNatureId").innerHTML=lt(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=lt(s,r.defaultCentroDeCustoId),t.querySelector("#commissionNatureId").innerHTML=lt(a,o.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=lt(s,o.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Pe(s,a)})}function Di(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${e}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function Vo(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(ki).forEach(([r,o])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{s.value=r,Vo(r,t)}),a.appendChild(i)}),s.value=e)}function Mi(e,t){const a=t.querySelector("#slotIntervalContainer"),s=t.querySelector("#establishmentSlotInterval");if(!a||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(o=>{const n=o.value===e;return`<button type="button" data-value="${o.value}" 
    ...
    `,be.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),Uo()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":Si(V,a);break;case"change-password":$i(V,a);break;case"change-email":Ei(V,a);break;case"branding":Ci(V,a);break;case"booking":Ii(V,a);break;case"working-hours":Li(V,a);break;case"loyalty":Ti(V,a);break;case"financial":await Bi(V,a);break;default:Di(t?t.label:"Definições",a)}}async function Uo(){if(be.innerHTML=`
    ...
    `,!V)try{V=await Qe(p.establishmentId)}catch{g("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),be.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const e=U.currentUser;e&&e.displayName&&(p.userName=e.displayName);const t=p.userName||U.currentUser.email,a=t?t.charAt(0).toUpperCase():"U";be.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
            ...
            <div class="text-center relative">
                ...
                <div class="absolute top-0 right-0 p-2 text-gray-400 hover:text-indigo-600" title="Ver Meu Perfil">
                 ...
                 <div class="relative w-24 h-24 mx-auto">
                    <img id="user-avatar" src="https://placehold.co/96x96/E2E8F0/4A5568?text=${a}" class="w-24 h-24 rounded-full object-cover">
                 </div>
    ...
    `,be.querySelector("#settings-menu-list").addEventListener("click",r=>{const o=r.target.closest("button[data-section]");o&&(r.preventDefault(),Pi(o.dataset.section))});const s=be.querySelector('[data-action="go-to-my-profile"]');s&&s.addEventListener("click",r=>{r.preventDefault(),Y("my-profile-section")})}const Ve=document.getElementById("content");async function Ce(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await Bt(p.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let c=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${l} (${d.length})</h4>`;if(d.length>1){const m=JSON.stringify(d.map(b=>b.id));c+=`<button data-action="batch-delete-blockage" data-ids='${m}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}c+="</div>",u.innerHTML=c,d.forEach(m=>{const b=new Date(m.startTime),f=new Date(m.endTime),v=b.toLocaleDateString("pt-BR"),x=f.toLocaleDateString("pt-BR"),k=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${v===x?`${v} | ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${f.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${v} às ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${x} às ${f.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;u.innerHTML+=k}),t.appendChild(u)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Ai(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||s,o=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:p.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Dt(i),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),Ce(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function qi(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||s,o=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:p.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Dt(c)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&Ce(u)}catch(u){g("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Ni(e){Ve.addEventListener("submit",t=>{t.target.id==="blockageForm"&&Ai(t),t.target.id==="batchBlockageForm"&&qi(t)}),Ve.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Ce(e)}),Ve.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")Y("profissionais-section");else if(s==="delete-blockage"){if(await A("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await fa(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),Ce(e)}catch(o){g("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await A("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await yo(r),g("Sucesso",`${r.length} bloqueios removidos.`,"success"),Ce(e)}catch(n){g("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function Fi(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){Ve.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}Ve.innerHTML=`
        <section>
        ...
        </section>`,Ni(t),await Ce(t);const s=document.getElementById("batchProfSelectionContainer");try{const r=await _(p.establishmentId);s.innerHTML=r.map(o=>`
            <div class="flex items-center">
    ...
    `}).join("")}function yt(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=p.users:t=p.users.filter(a=>a.status==="active"),_i(t)}function Wi(e={}){return Object.entries(Ui).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,o=Object.entries(Ji).map(([i,l])=>`
    ...
    `}).join("")}async function Za(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=p.professionals;if(!a||a.length===0)try{a=await _(p.establishmentId),p.professionals=a}catch{g("Erro","Não foi possível carregar a lista de profissionais.","error")}const s=h=>a.find(k=>k.id===h),r=(h,k)=>{const E=s(h)?.photo,I=k.charAt(0).toUpperCase();return{photoSrc:E||`https://placehold.co/128x128/E2E8F0/4A5568?text=${I}`,initials:I,photoUrl:E||""}},o=e?.professionalId,n=e?.name||"Novo Usuário",i=r(o,n),l=s(o),d=h=>{let k='<option value="">-- Não Associado a um Profissional --</option>';return k+=a.map($=>`<option value="${$.id}" ${$.id===h?"selected":""}>${$.name} (${$.specialty||"N/A"})</option>`).join(""),k},u=e!==null;t.querySelector("#userFormTitle").textContent=u?`Editar Usuário: ${e.name}`:"Novo Usuário";const c=t.querySelector("#userForm");c.innerHTML=`
    ...
    `;const m=window.innerWidth<768,b=c.querySelector(".bg-white");if(m&&b){b.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const h=c.closest("section");h&&(h.style.padding="0",h.style.margin="0"),b.classList.add("p-4")}const f=c.querySelector("#userProfessionalId"),v=c.querySelector("#userPhotoPreview"),x=c.querySelector("#profPhotoName");if(f.addEventListener("change",h=>{const k=h.target.value,$=s(k),E=$?$.name:"Selecione um profissional",I=r(k,n);v.src=I.photoSrc,x.textContent=E,c.querySelector("#professionalPhotoUrl").value=I.photoUrl}),c.addEventListener("submit",async h=>{h.preventDefault();const k=e?.email,$=c.querySelector("#userEmail").value,E={};c.querySelectorAll('input[type="checkbox"]').forEach(H=>{const M=H.dataset.module,q=H.dataset.permission;E[M]||(E[M]={}),E[M][q]=H.checked});const I=c.querySelector("#userProfessionalId").value||null,D={name:c.querySelector("#userName").value,permissions:E,professionalId:I};try{u?(k!==$&&(D.email=$),await Hi(e.id,D),g("Usuário atualizado com sucesso!","success")):(D.email=c.querySelector("#userEmail").value,D.password=c.querySelector("#userPassword").value,await ji(D),g("Usuário criado com sucesso!","success")),St()}catch(H){g(`Erro: ${H.message}`,"error")}}),u){const h=c.querySelector("#password-change-container"),k=h.querySelector('[data-action="show-password-form"]'),$=h.querySelector("#password-form"),E=$.querySelector('[data-action="save-password"]'),I=$.querySelector('[data-action="cancel-password-change"]');k.addEventListener("click",()=>{k.classList.add("hidden"),$.classList.remove("hidden")}),I.addEventListener("click",()=>{k.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}),E.addEventListener("click",async()=>{const D=$.querySelector("#userNewPassword").value;if(!D||D.length<6){g("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await A("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{E.disabled=!0,E.textContent="Aguarde...",await zi(e.id,D),g("Sucesso!","A senha do usuário foi alterada.","success"),k.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}catch(M){g("Erro",`Não foi possível alterar a senha: ${M.message}`,"error")}finally{E.disabled=!1,E.textContent="Salvar Nova Senha"}})}}async function Gi(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([Ri(p.establishmentId),_(p.establishmentId)]);p.users=t,p.professionals=a,yt()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function St(){me.innerHTML=`
    ...
    `,qe&&me.removeEventListener("click",qe),Ne&&me.removeEventListener("change",Ne),qe=async e=>{if(!document.getElementById("user-list-view")){me.removeEventListener("click",qe);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":Za();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));Za(s);break;case"back-to-list":St();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await A("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await Oi(r),g("Usuário excluído com sucesso!","success"),St()}catch(n){g(`Erro ao excluir: ${n.message}`,"error")}break}}},Ne=async e=>{if(!document.getElementById("user-list-view")){me.removeEventListener("change",Ne);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")yt();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await Vi(a,s),g(`Usuário ${s==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=p.users.findIndex(o=>o.id===a);r>-1&&(p.users[r].status=s,yt())}catch(r){g(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,yt()}}},me.addEventListener("click",qe),me.addEventListener("change",Ne),await Gi()}const Yi=document.getElementById("content");let Ka={},ca=null;function Xi(){Object.values(Ka).forEach(e=>e?.destroy()),Ka={}}function Qi(e,t){const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${t}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function eo(e){const t=document.getElementById("genericModal"),a=(e.payments||[]).map(s=>`
    ...
    `,t.style.display="flex"}function Zi(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);s.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ca.transactions[l];d&&eo(d)})}),n.innerHTML=a.map((i,l)=>`
    ...
    `).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ca.transactions[l];d&&eo(d)})})}async function to(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,n=await Hs({establishmentId:p.establishmentId,startDate:s,endDate:r,cashierSessionId:o});ca=n,e.innerHTML=`
        ...
        `,Zi(n)}catch(o){g("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${o.message}</p>`}}async function Ki(){Xi();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];Yi.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",to),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${r}`;Qi(o,"transactionsTable")});try{const s=await Ir(),r=document.getElementById("cashierSessionFilter");s.forEach(o=>{const n=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=o.closedByName||"N/A";r.innerHTML+=`<option value="${o.id}">${i} - ${n}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await to()}const el=document.getElementById("content");let C={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},_t=null,dt=null,ct=null;function Ia(e){const t=new Map,a=[];return e&&(e.forEach(s=>t.set(s.id,{...s,children:[]})),t.forEach(s=>{s.parentId&&t.has(s.parentId)?t.get(s.parentId).children.push(s):a.push(s)})),a}function Jo(e,t,a){if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const s=(r,o=0)=>{const n="— ".repeat(o);return`
        ...
        `};e.innerHTML=t.map(r=>s(r)).join("")}async function ao(e){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const t=document.getElementById("genericModal"),a=e==="nature",s=`Gerir ${a?"Naturezas Financeiras":"Centros de Custo"}`,r=a?Ye:Xe,o=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),i=t.querySelector("#itemParent"),l=u=>{const c=Ia(u);Jo(n,c,e),i.innerHTML='<option value="">-- Nível Principal --</option>';const m=(b,f="",v=0)=>{const x=v>0?"— ".repeat(v):"";i.innerHTML+=`<option value="${b.id}">${x}${b.name}</option>`,b.children.forEach(h=>m(h,f+"— "))};c.forEach(b=>m(b))},d=await r();C[o]=d,l(d),t.querySelector("#hierarchyForm").addEventListener("submit",async u=>{u.preventDefault();const c=t.querySelector("#itemName").value,m=i.value,b=a?ni:li;try{await b({name:c,parentId:m||null});const f=await r();C[o]=f,l(f),t.querySelector("#hierarchyForm").reset(),await ve()}catch(f){g("Erro",`Não foi possível criar: ${f.message}`,"error")}})}function tl(e){const t=document.getElementById("cashFlowChart");if(!t)return;const a=t.getContext("2d");_t&&_t.destroy();const s=e.payables.map(r=>r*-1);_t=new Chart(a,{type:"bar",data:{labels:e.labels,datasets:[{label:"Receitas",data:e.receivables,backgroundColor:"rgba(74, 222, 128, 0.6)",borderColor:"rgba(34, 197, 94, 1)",borderWidth:1,yAxisID:"y"},{label:"Despesas",data:s,backgroundColor:"rgba(248, 113, 113, 0.6)",borderColor:"rgba(239, 68, 68, 1)",borderWidth:1,yAxisID:"y"},{label:"Saldo Acumulado",data:e.expectedBalance,type:"line",borderColor:"rgba(59, 130, 246, 1)",backgroundColor:"rgba(59, 130, 246, 0.2)",borderWidth:3,pointRadius:4,pointBackgroundColor:"rgba(59, 130, 246, 1)",fill:!0,tension:.1,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{x:{stacked:!0},y:{type:"linear",display:!0,position:"left",stacked:!0,title:{display:!0,text:"Movimentações (R$)"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Saldo Acumulado (R$)"},grid:{drawOnChartArea:!1}}},plugins:{tooltip:{callbacks:{label:function(r){let o=r.dataset.label||"";if(o&&(o+=": "),r.parsed.y!==null){const n=Math.abs(r.parsed.y);o+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(n)}return o}}}}}})}async function oo(){const e=document.getElementById("cash-flow-chart-container"),t=document.getElementById("cashFlowStartDate").value,a=document.getElementById("cashFlowEndDate").value;if(!t||!a){g("Atenção","Por favor, selecione as datas de início e fim.","error");return}e.innerHTML='<div class="loader mx-auto my-10"></div>';try{const s=await yi(t,a);e.innerHTML='<canvas id="cashFlowChart"></canvas>',tl(s)}catch(s){e.innerHTML=`<p class="text-red-500 text-center">Erro ao carregar dados do gráfico: ${s.message}</p>`}}function so(){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const e=document.getElementById("genericModal"),t=new Date,a=new Date(t.getFullYear(),t.getMonth(),1).toISOString().split("T")[0],s=t.toISOString().split("T")[0];e.innerHTML=`
    ...
    `,e.style.display="flex",e.querySelector("#generateCashFlowBtn").addEventListener("click",oo),oo()}function al(){const e=document.getElementById("genericModal"),t=C.payables.filter(c=>c.status==="pending").reduce((c,m)=>c+m.amount,0),a=C.receivables.filter(c=>c.status==="pending").reduce((c,m)=>c+m.amount,0),s=a-t,r=C.payables.filter(c=>c.status==="paid").reduce((c,m)=>c+m.amount,0),o=C.receivables.filter(c=>c.status==="paid").reduce((c,m)=>c+m.amount,0),n=o-r,i=C.previousBalance||0,l=i+n,d=c=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(c),u=c=>c>=0?"text-green-600":"text-red-600";e.innerHTML=`
                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-inner">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                        ...
                        <div class="bg-white p-3 rounded-lg shadow-lg border-b-4 ${u(n)==="text-green-600"?"border-green-600":"border-red-600"}">
                            ...
                            <p class="text-2xl font-bold ${u(n)}">${d(n)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-inner">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
                        <div class="bg-white p-3 rounded-lg shadow-sm border-b-4 border-indigo-400">
                            ...
                            <p class="text-2xl font-bold ${u(i)}">${d(i)}</p>
                        ...
                        <div class="bg-white p-3 rounded-lg shadow-lg border-b-4 border-blue-600">
                            ...
                            <p class="text-2xl font-bold ${u(l)}">${d(l)}</p>
                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-inner">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                        ...
                        <div class="bg-white p-3 rounded-lg shadow-lg border-b-4 ${u(s)==="text-green-600"?"border-green-600":"border-red-600"}">
                            ...
                            <p class="text-2xl font-bold ${u(s)}">${d(s)}</p>
                        </div>
                    </div>
                </div>
    ...
    `,e.style.display="flex"}function ol(){const e=document.getElementById("genericModal");e.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.style.display="flex"}function ut(e,t="all"){let a='<option value="all">Todos</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i=0)=>{const l=i>0?"— ".repeat(i):"",d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${l}${n.name}</option>`,n.children.forEach(u=>r(u,i+1))};return s(e).forEach(n=>r(n)),a}async function ve(){const e=document.getElementById("financial-content"),t=document.getElementById("filterStartDate")?.value,a=document.getElementById("filterEndDate")?.value,s=document.getElementById("filterNaturezaId")?.value,r=document.getElementById("filterCostCenterId")?.value;if(!t||!a){try{const[i,l]=await Promise.all([Ye(),Xe()]);C={...C,natures:i,costCenters:l},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=ut(C.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=ut(C.costCenters))}catch(i){g("Erro",`Não foi possível carregar os dados base: ${i.message}`,"error")}ua(),no();return}const o=document.getElementById("payables-list"),n=document.getElementById("receivables-list");o&&(o.innerHTML='<div class="loader mx-auto"></div>'),n&&(n.innerHTML='<div class="loader mx-auto"></div>');try{const i={startDate:t,endDate:a};s&&s!=="all"&&(i.natureId=s),r&&r!=="all"&&(i.costCenterId=r);const[l,d,u,c]=await Promise.all([ui(i),fi(i),Ye(),Xe()]),m=d.previousBalance-l.previousBalance;C={...C,payables:l.entries,receivables:d.entries,natures:u,costCenters:c,previousBalance:m,filterNaturezaId:s,filterCostCenterId:r},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=ut(C.natures,C.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=ut(C.costCenters,C.filterCostCenterId)),ua(),no()}catch(i){g("Erro",`Não foi possível carregar os dados: ${i.message}`,"error"),e&&(e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function sl(e,t,a=null){e.preventDefault();const s=e.target,r=s.querySelector('[name="status"]').checked,o=s.querySelector('[name="paymentDate"]').value,n=parseFloat(s.querySelector('[name="amount"]').value),i=parseInt(s.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(n)){g("Erro de Validação","O valor inserido é inválido.","error");return}if(r&&!o){g("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:s.querySelector('[name="description"]').value,amount:n,dueDate:s.querySelector('[name="dueDate"]').value,naturezaId:s.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:s.querySelector('[name="centroDeCustoId"]').value||null,notes:s.querySelector('[name="notes"]').value,status:r?"paid":"pending",paymentDate:r?o:null,installments:a?1:i};try{a?(await(t==="payable"?mi(a,l):vi(a,l)),g("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?ci(l):bi(l)),g("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await ve()}catch(d){g("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function rl(e,t){if(await A("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?pi(t):hi(t)),g("Sucesso","Lançamento excluído!","success"),await ve()}catch(s){g("Erro",`Falha ao excluir: ${s.message}`,"error")}}async function nl(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?gi(t,a):xi(t,a)),g("Sucesso","Lançamento atualizado!","success"),await ve()}catch(s){g("Erro",`Falha ao atualizar status: ${s.message}`,"error")}}function ro(e){const t=C.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function ua(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(C.natures.map(i=>[i.id,i.name])),s=new Map(C.costCenters.map(i=>[i.id,i.name])),r=ro(C.payables),o=ro(C.receivables),n=(i,l)=>{const d=i.status==="paid",u=JSON.stringify(i).replace(/'/g,"&apos;"),c=i.naturezaId?a.get(i.naturezaId):"N/A",m=i.centroDeCustoId?s.get(i.centroDeCustoId):"N/A";let b=l==="payable"?"text-red-600":"text-green-600";const f=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",v=d?"Finalizado":"Pendente";return d&&(b="text-gray-500"),`
                ...
                <div class="flex items-center gap-2 text-right">
                    ...
                    <div class="flex flex-col items-center gap-1">
                        ...
                        <div class="flex">
                            ...
                            <button data-action="edit" data-type="${l}" data-item='${u}' class="text-gray-400 hover:text-blue-500 p-1" title="Editar"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L16.732 3.732z"></path></svg></button>
        ...
        </div>`};e.innerHTML=r.map(i=>n(i,"payable")).join("")||'<p class="text-center text-gray-500 py-4">Nenhuma conta a pagar.</p>',t.innerHTML=o.map(i=>n(i,"receivable")).join("")||'<p class="text-center text-gray-500 py-4">Nenhuma conta a receber.</p>'}function no(){const e=C.payables.filter(r=>r.status==="pending").reduce((r,o)=>r+o.amount,0),t=C.receivables.filter(r=>r.status==="pending").reduce((r,o)=>r+o.amount,0),a=t-e;document.getElementById("summary-pending-receivables").textContent=`R$ ${t.toFixed(2)}`,document.getElementById("summary-pending-payables").textContent=`R$ ${e.toFixed(2)}`,document.getElementById("summary-pending-balance").textContent=`R$ ${a.toFixed(2)}`;const s=document.getElementById("summary-pending-balance");s&&(s.className=`text-2xl font-bold ${a>=0?"text-green-600":"text-red-600"}`)}function Wt(e,t=null){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const a=document.getElementById("genericModal"),s=`${t?"Editar":"Nova"} ${e==="payable"?"Despesa":"Receita"}`,r=e==="payable"?"bg-red-600 hover:bg-red-700":"bg-green-600 hover:bg-green-700",o=m=>{let b='<option value="">-- Selecione (Opcional) --</option>';const f=Ia(m),v=(x,h="",k=0)=>{const $=k>0?"— ".repeat(k):"";b+=`<option value="${x.id}">${$}${x.name}</option>`,x.children.forEach(E=>v(E,h+"— "))};return f.forEach(x=>v(x)),b},n=o(C.natures),i=o(C.costCenters),l=t?"":`
        <div>
    ...
    `;a.innerHTML=`
        ...
        </div>`,a.style.display="flex",t&&(a.querySelector('[name="naturezaId"]').value=t.naturezaId||"",a.querySelector('[name="centroDeCustoId"]').value=t.centroDeCustoId||"");const d=a.querySelector("#status"),u=a.querySelector("#payment-date-container"),c=a.querySelector('[name="paymentDate"]');t?.status==="paid"&&(d.checked=!0,u.classList.remove("hidden"),c.value=t.paymentDate||new Date().toISOString().split("T")[0]),d.addEventListener("change",()=>{u.classList.toggle("hidden",!d.checked),c.required=d.checked}),a.querySelector("#financial-form").addEventListener("submit",m=>sl(m,e,t?.id))}async function il(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth()-1,1).toISOString().split("T")[0],s=e.toISOString().split("T")[0];C.startDate=a,C.endDate=s,C.currentFilter="pending",C.filterNaturezaId="all",C.filterCostCenterId="all",el.innerHTML=`
        <section>
    ...
    `;const r=document.getElementById("main-fab-btn"),o=document.getElementById("fab-menu");if(r&&o){r.addEventListener("click",v=>{v.stopPropagation(),o.classList.toggle("hidden"),r.classList.toggle("rotate-45")});const m=o.querySelector('button[data-action="open-modal"][data-type="receivable"]'),b=o.querySelector('button[data-action="open-modal"][data-type="payable"]'),f=o.querySelector('button[data-action="open-cash-flow-modal"]');m&&m.addEventListener("click",v=>{v.stopPropagation(),Wt("receivable")}),b&&b.addEventListener("click",v=>{v.stopPropagation(),Wt("payable")}),f&&f.addEventListener("click",v=>{v.stopPropagation(),so()})}dt&&document.body.removeEventListener("click",dt),ct&&document.getElementById("genericModal").removeEventListener("click",ct);const n=()=>{const m=document.getElementById("filterStartDate"),b=document.getElementById("filterEndDate"),f=document.getElementById("filterNaturezaId"),v=document.getElementById("filterCostCenterId");C.startDate=m.value,C.endDate=b.value,C.filterNaturezaId=f.value,C.filterCostCenterId=v.value;const x=document.getElementById("advanced-filters");x&&x.classList.contains("hidden")===!1&&window.innerWidth<768&&x.classList.add("hidden"),ve()},i=m=>{const b=m.target.closest("[data-status-filter]");if(!b)return;const f=b.dataset.statusFilter;C.currentFilter=f,document.querySelectorAll("[data-status-filter]").forEach(v=>{v.classList.remove("bg-blue-100","text-blue-800"),v.classList.add("bg-gray-100","text-gray-600")}),b.classList.remove("bg-gray-100","text-gray-600"),b.classList.add("bg-blue-100","text-blue-800"),ua()},l=m=>{const b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),v=document.getElementById("btn-payables-view"),x=document.getElementById("btn-receivables-view");window.innerWidth>=1024&&C.currentListView===m||(m==="payables"?(b.classList.remove("hidden"),f.classList.add("hidden"),v&&(v.classList.remove("bg-gray-200"),v.classList.add("bg-red-100","border","border-red-500")),x&&(x.classList.remove("bg-green-100","border","border-green-500"),x.classList.add("bg-gray-200"))):(b.classList.add("hidden"),f.classList.remove("hidden"),v&&(v.classList.remove("bg-red-100","border","border-red-500"),v.classList.add("bg-gray-200")),x&&(x.classList.remove("bg-gray-200"),x.classList.add("bg-green-100","border","border-green-500"))),C.currentListView=m)};document.getElementById("applyDateFilterBtn").addEventListener("click",n),document.getElementById("filterNaturezaId").addEventListener("change",()=>{C.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{C.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(m=>{m.addEventListener("click",i)}),dt=m=>{const b=m.target.closest("button[data-action]");if(!b)return;const{action:f,type:v,id:x}=b.dataset;f==="edit"?Wt(v,JSON.parse(b.dataset.item.replace(/&apos;/g,"'"))):f==="delete"?rl(v,x):f==="mark-as-paid"?nl(v,x):f==="manage-natures"?ao("nature"):f==="manage-cost-centers"?ao("cost-center"):f==="open-cash-flow-modal"?so():f==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):f==="open-indicators-modal"?al():f==="open-settings-modal"?ol():f==="toggle-list-view"&&l(b.dataset.list)},ct=m=>{const b=m.target.closest('button[data-action^="delete-"]');if(b){const f=b.dataset.action.split("-")[1];d(f,b.dataset.id)}},document.body.addEventListener("click",dt),document.getElementById("genericModal").addEventListener("click",ct);async function d(m,b){const f=m==="nature",v=f?ii:di,x=f?Ye:Xe,h=f?"natures":"costCenters",k=document.getElementById("hierarchyList");if(await A("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await v(b);const E=await x();C[h]=E,Jo(k,Ia(E),m),await ve()}catch(E){g("Erro",`Não foi possível apagar: ${E.message}`,"error")}}const u=()=>{const m=window.innerWidth<1024,b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),v=document.getElementById("list-toggle-buttons");b&&f&&(b.classList.remove("hidden"),f.classList.remove("hidden"),m?(b.classList.remove("lg:col-span-1"),f.classList.remove("lg:col-span-1"),v?.classList.remove("hidden"),l(C.currentListView)):(b.classList.add("lg:col-span-1"),f.classList.add("lg:col-span-1"),v?.classList.add("hidden"),b.classList.remove("hidden"),f.classList.remove("hidden")))};u(),window.addEventListener("resize",u);const c=document.querySelector(`[data-status-filter="${C.currentFilter}"]`);c&&(document.querySelectorAll("[data-status-filter]").forEach(m=>{m.classList.remove("bg-blue-100","text-blue-800"),m.classList.add("bg-gray-100","text-gray-600")}),c.classList.remove("bg-gray-100","text-gray-600"),c.classList.add("bg-blue-100","text-blue-800"));try{const m=await wi(),b=document.getElementById("summary-today-payables");b&&(b.textContent=`R$ ${m.totalPayables.toFixed(2)}`);const f=document.getElementById("summary-today-receivables");f&&(f.textContent=`R$ ${m.totalReceivables.toFixed(2)}`)}catch{g("Erro","Não foi possível carregar o resumo do dia.","error")}await ve()}const ll=e=>w("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),dl=e=>w("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),cl=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return w(`/api/commissions/stats?${a}`)},ul=(e={})=>{Object.keys(e).forEach(s=>(e[s]===void 0||e[s]===null||e[s]==="")&&delete e[s]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return w(a)},ml=e=>w(`/api/commissions/report/${e}`,{method:"DELETE"}),$t=new Date,io=new Date($t.getFullYear(),$t.getMonth(),1),T={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:io.toISOString().split("T")[0],dashEndDate:$t.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:io.toISOString().split("T")[0],histEndDate:$t.toISOString().split("T")[0],histProfessionalId:"all"};let mt=null;const Fe=document.getElementById("content");async function pl(){try{T.professionals=await _(p.establishmentId)}catch(e){console.error("Erro profissionais",e)}$l(),gl(),Ht(),Ct("dashboard")}function gl(){mt&&Fe.removeEventListener("click",mt),mt=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,s=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":Ct(t.dataset.tab);break;case"toggle-all-profs":bl();break;case"back-to-filters":T.calculationResult=null,Et(document.getElementById("commissions-content"));break;case"view-preview-items":Sl(r);break;case"save-final-report":vl();break;case"start-new-calc":Ct("calculator");break;case"print-receipt":hl(s);break;case"delete-report":xl(s);break;case"filter-dashboard":Ht();break;case"filter-history":La();break}},Fe.addEventListener("click",mt),Fe.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;wl(t)}},Fe.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),fl())}}async function Ht(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(T.dashStartDate=e.value),t&&(T.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const s=await cl(T.dashStartDate,T.dashEndDate);T.dashStats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0},T.currentTab==="dashboard"&&_o(document.getElementById("commissions-content"))}catch(s){console.error(s),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function La(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(T.histStartDate=e.value),t&&(T.histEndDate=t.value),a&&(T.histProfessionalId=a.value);const s=document.getElementById("history-list-container");if(s){s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await ul({startDate:T.histStartDate,endDate:T.histEndDate,professionalId:T.histProfessionalId});T.historyData=r,Wo(s,r)}catch{s.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function bl(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function fl(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(o=>o.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),s=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");T.periodString=`${a} a ${s}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const o=await ll(t);T.calculationResult=o.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),Et(r)}catch(o){g("Erro",o.message,"error"),T.calculationResult=null,Et(r)}}async function vl(){const e=T.calculationResult.length;if(await A("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=T.calculationResult.map(s=>{const r=s.items.map(o=>o.originalSaleId).filter(o=>o!=null);return dl({professionalId:s.professionalId,professionalName:s.professionalName,period:T.periodString,processedSalesIds:r,reportData:{...s,summary:{...s.summary,finalValue:s.finalValue,extraDebit:s.extraDebit||0,extraCredit:s.extraCredit||0,notes:s.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),T.calculationResult=null,Ht(),Ct("history")}catch(a){g("Erro",a.message,"error")}}function hl(e){const t=T.historyData.find(a=>a.id===e);t&&yl(t)}async function xl(e){if(await A("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await ml(e),g("Sucesso","Registro removido.","success"),La(),Ht()}catch(a){g("Erro",a.message,"error")}}function yl(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,s=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",s,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const o=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,o,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function wl(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let s=0,r=0;if(t.forEach(o=>{o.value&&(s=parseFloat(o.value))}),a.forEach(o=>{o.value&&(r=parseFloat(o.value))}),T.calculationResult&&T.calculationResult[e]){const o=T.calculationResult[e];o.extraDebit=s,o.extraCredit=r,o.finalValue=o.summary.totalCommission-s+r,t.forEach(i=>{i!==document.activeElement&&(i.value=s||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${o.finalValue.toFixed(2)}`),kl()}}function kl(){const e=T.calculationResult.reduce((a,s)=>a+s.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function Sl(e){const t=T.calculationResult[e];if(!t)return;const a=t.items.map(s=>`
    ...
    `).join("");N({title:"Detalhes da Comissão",contentHTML:`<div class="bg-gray-50 p-3 rounded-lg mb-4 flex justify-between items-center"><div><p class="text-xs text-gray-500">Profissional</p><p class="font-bold text-gray-800">${t.professionalName}</p></div><div class="text-right"><p class="text-xs text-gray-500">Total Itens</p><p class="font-bold text-gray-800">${t.items.length}</p></div></div><div class="border rounded-lg overflow-hidden max-h-[60vh] overflow-y-auto">${a}</div>`,maxWidth:"max-w-md"})}function Et(e){if(T.calculationResult){const t=T.calculationResult,a=t.reduce((o,n)=>o+n.finalValue,0),s=t.map((o,n)=>`
            ...
            </div>`}else{const t=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=T.professionals.map(r=>`
        ...
        <div class="space-y-6 animate-fade-in">
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4 items-end">
                <div class="flex-1 w-full">
                    ...
                    <input type="date" id="dash-start" value="${T.dashStartDate}" class="w-full mt-1 rounded-lg border-gray-300">
                </div>
                <div class="flex-1 w-full">
                    <label class="text-xs font-bold text-gray-500 uppercase">Data Final</label>
                    <input type="date" id="dash-end" value="${T.dashEndDate}" class="w-full mt-1 rounded-lg border-gray-300">
                </div>
    ...
    `}function El(e){const t=T.professionals.map(a=>`<option value="${a.id}" ${T.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <div>
                        ...
                        <input type="date" id="hist-start" value="${T.histStartDate}" class="w-full mt-1 rounded-lg border-gray-300">
                    </div>
                    <div>
                        <label class="text-xs font-bold text-gray-500 uppercase">Até</label>
                        <input type="date" id="hist-end" value="${T.histEndDate}" class="w-full mt-1 rounded-lg border-gray-300">
                    </div>
                    <div>
    ...
    `,T.historyData.length>0?Wo(document.getElementById("history-list-container"),T.historyData):La()}function Wo(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const Gt=document.getElementById("content");let he={allPackages:[],catalogForModal:{services:[],products:[]}},pt=null,$e=null;function Cl(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Il(){const e=document.getElementById("packagesListContainer");if(e){if(he.allPackages.length===0){e.innerHTML=`
        ...
        `}).join("")}}function lo(){const e=document.getElementById("genericModal");e.style.display="none",$e&&e.removeEventListener("click",$e)}async function co(e=null){const t=document.getElementById("genericModal"),a=!!e,s=e?JSON.parse(JSON.stringify(e.items||[])):[],r=`
    ...
    `;t.innerHTML=r,t.style.display="flex";const o=t.querySelector("#package-items-list"),n=(l,d)=>{const u=d.querySelector("#originalPrice"),c=l.reduce((m,b)=>m+b.price*b.quantity,0);u&&(u.textContent=`R$ ${c.toFixed(2)}`)},i=l=>{l.length===0?o.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':o.innerHTML=l.map((d,u)=>{const c=d.type==="service",m=c?"Serviço":"Produto",b=c?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        <input type="number" value="${d.quantity}" min="1" class="w-12 p-1 border rounded-md text-sm quantity-input flex-shrink-0" data-index="${u}">
                        <!-- (NOVO) Selo de Tipo -->
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                        <span class="text-sm text-gray-600">R$ ${d.price.toFixed(2)}</span>
            ...
            `}).join(""),n(l,t)};i(s),o.addEventListener("change",l=>{if(l.target.classList.contains("quantity-input")){const d=parseInt(l.target.dataset.index,10),u=parseInt(l.target.value,10);u>0&&s[d]&&(s[d].quantity=u,i(s))}}),o.addEventListener("click",l=>{if(l.target.classList.contains("remove-item-btn")){const d=parseInt(l.target.dataset.index,10);s.splice(d,1),i(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Ll(l=>{const d=s.find(u=>u.id===l.id&&u.type===l.type);d?d.quantity++:s.push({...l,quantity:1}),i(s)}),$e&&t.removeEventListener("click",$e),$e=async l=>{const d=l.target.closest("button[data-action]");if(!d)return;const u=d.dataset.action;if(l.stopPropagation(),u==="close-modal"&&lo(),u==="save-package"){const c=d,m={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce((b,f)=>b+f.price*f.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null};if(!m.name||!m.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(m.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}c.disabled=!0,c.textContent="A salvar...";try{a?await Br(m.id,m):(delete m.id,await Tr(m)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),lo(),await Ta()}catch(b){g("Erro",`Não foi possível salvar o pacote: ${b.message}`,"error"),c.disabled=!1,c.textContent="Salvar Pacote"}}},t.addEventListener("click",$e)}function Ll(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),u=he.catalogForModal.services.filter(f=>f.name.toLowerCase().includes(d)),c=he.catalogForModal.products.filter(f=>f.name.toLowerCase().includes(d)),m=u.map(f=>`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),u=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:c,itemId:m}=d.dataset,f=(he.catalogForModal[c+"s"]||[]).find(v=>v.id===m);f&&(e({...f,type:c}),i())}else(u||l.target===a)&&i()})}async function Ta(){Gt.innerHTML=`
    ...
    `,pt&&Gt.removeEventListener("click",pt),pt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;A("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async o=>{if(o)try{await Dr(r),g("Sucesso!","Pacote excluído.","success"),await Ta()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")co(null);else if(a==="edit-package"){const s=JSON.parse(t.dataset.package);co(s)}},Gt.addEventListener("click",pt);try{const[e,t,a]=await Promise.all([Co(p.establishmentId),Me(p.establishmentId),At(p.establishmentId)]);he.allPackages=e,he.catalogForModal={services:t.filter(s=>s.active),products:a},Il()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Tl=document.getElementById("content");let Bl=null;async function Dl(){Tl.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await Ml()}async function Ml(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await $s(t);Bl=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo),e.innerHTML=`
            ...
            `,Pl(a.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>It(a.id,r.target.value)),It(a.id,"future")}else e.innerHTML=`
        ...
        `}}function Pl(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#blockDate").value,r=t.querySelector("#blockStartTime").value,o=t.querySelector("#blockEndTime").value,n=t.querySelector("#blockReason").value;if(!s||!r||!o){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(r>=o){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${s}T${r}:00`),l=new Date(`${s}T${o}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Dt({establishmentId:p.establishmentId,professionalId:e,reason:n||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const u=document.getElementById("my-blocks-filter").value;It(e,u)}catch(u){console.error("Erro ao bloquear agenda:",u),g("Erro",`Não foi possível bloquear a agenda: ${u.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function It(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const s=new Date;let r,o;t==="history"?(o=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let i=(await Bt(p.establishmentId,r.toISOString(),o.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),i.length>0?(a.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),u=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`;return`
                    <div class="flex items-center justify-between p-3 ${l.endTime<new Date?"bg-gray-100 opacity-75":"bg-white border border-gray-200"} rounded-md shadow-sm">
                        <div>
                            <p class="font-semibold text-gray-800">${d} das ${u}</p>
                            <p class="text-sm text-gray-600">${l.reason||"Sem motivo"}</p>
                        </div>
                ...
                `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await fa(u),g("Sucesso","Bloqueio removido.","success"),It(e,t)}catch(c){console.error("Erro ao remover bloqueio:",c),g("Erro",`Não foi possível remover o bloqueio: ${c.message}`,"error")}})})):a.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(s){console.error("Erro ao carregar bloqueios:",s),a.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${s.message}</p>`}}const gt=document.getElementById("loadingScreen"),Yt=document.getElementById("dashboardContent"),Xt=document.getElementById("content"),uo=document.getElementById("notificationBell"),Qt=document.getElementById("notificationBadge"),bt=document.getElementById("notificationPanel"),mo=document.getElementById("notificationList"),Zt=document.getElementById("profileMenuButton"),X=document.getElementById("profileDropdown"),Al=document.getElementById("profileName"),ql=document.getElementById("profileEmail"),Nl=document.getElementById("logoutButton"),Fl=document.getElementById("cancellationHistoryBtn"),po=document.getElementById("myProfileLink"),go={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let Ue=null,Je=[];const Rl={"agenda-section":$o,"comandas-section":xa,"relatorios-section":Wr,"servicos-section":un,"produtos-section":En,"suppliers-section":qn,"profissionais-section":kt,"clientes-section":jt,"estabelecimento-section":Uo,"ausencias-section":Fi,"users-section":St,"sales-report-section":Ki,"financial-section":il,"commissions-section":pl,"packages-section":Ta,"my-profile-section":Dl};function jl(e){const t=go[e]||go.indigo,s=(o=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function ma(){const e=Je.filter(t=>!t.read).length;if(e>0?(Qt.textContent=e,Qt.classList.remove("hidden")):Qt.classList.add("hidden"),Je.length===0){mo.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}mo.innerHTML=Je.map(t=>`
    ...
    `).join("")}function Hl(e){Ue&&Ue();const t=De(Z,"establishments",e,"notifications"),a=fo(t,as("timestamp",">=",new Date),vo("timestamp","desc"));Ue=os(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();Je.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(o.title,o.message,"info",!0),ma();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(o.type==="cancellation"||o.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),$o())}})},s=>{console.error("Erro no listener de notificações em tempo real:",s),g("Erro de Conexão","Não foi possível receber atualizações em tempo real. Verifique as regras de segurança do Firestore.","error")})}function Y(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=p.enabledModules?.[a]!==!1,o=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!r||!o){Xt.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active"));return}}const s=Rl[e];s?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),Xt.innerHTML="",s(t)):(Xt.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`,console.warn(`Nenhum carregador de página definido para: ${e}`))}async function Ol(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(o&&t&&t.classList.remove("hidden"),n&&a&&a.classList.remove("hidden"),!(!o&&!n))try{const i=await Os();o&&s&&(s.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i),o&&s&&(s.textContent="Erro"),n&&r&&(r.textContent="Erro")}}async function zl(e){try{_e.getPlatform()==="android"&&(await re.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal de notificação Android criado com sucesso."));let t=await re.checkPermissions();if(t.receive==="prompt"&&(t=await re.requestPermissions()),t.receive!=="granted"){console.warn("Permissão de notificação push foi negada pelo utilizador.");return}await re.register(),re.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const s=Lt(Z,"users",e);await ho(s,{fcmToken:a.value}),console.log("Token FCM salvo no perfil do utilizador.")}catch(s){console.error("Erro ao salvar token FCM:",s)}}),re.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),re.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),g(a.title,a.body,"info",!0)}),re.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),Y("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function Vl(){_e.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),bs(),uo.addEventListener("click",e=>{e.stopPropagation(),bt.classList.toggle("hidden"),bt.classList.contains("hidden")||(Je.forEach(t=>t.read=!0),ma())}),Fl.addEventListener("click",()=>{fs()}),Zt.addEventListener("click",e=>{e.stopPropagation(),X.classList.toggle("active"),X.classList.contains("active")?X.classList.remove("hidden"):setTimeout(()=>X.classList.add("hidden"),200)}),po&&po.addEventListener("click",e=>{e.preventDefault(),Y("my-profile-section"),X.classList.remove("active"),X.classList.add("hidden")}),document.addEventListener("click",e=>{!bt.contains(e.target)&&e.target!==uo&&bt.classList.add("hidden"),!X.contains(e.target)&&e.target!==Zt&&X.classList.contains("active")&&(X.classList.remove("active"),setTimeout(()=>X.classList.add("hidden"),200))}),Ko(U,async e=>{if(e)try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const s=await Qe(a.establishmentId);p.enabledModules=s.modules,jl(s.themeColor||"indigo");let r=null,o=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=Lt(Z,"users",e.uid),u=await ts(d);if(u.exists()){const c=u.data();r=a.role==="employee"?c.permissions||{}:null,o=c.name||o,n=c.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}p.userProfessionalId=n,zl(e.uid);const i=o||e.email;ss(a.establishmentId,s.name,r),Zt.textContent=i.charAt(0).toUpperCase(),Al.textContent=i,ql.textContent=e.email;const l=()=>{Ue&&Ue(),Ba(U).then(()=>window.location.href="/login.html")};Nl.addEventListener("click",d=>{d.preventDefault(),l()}),ys(Y,r,p.enabledModules),Ol(r),Hl(a.establishmentId),ma(),gt.classList.add("fade-out"),Yt.style.display="flex",setTimeout(()=>{gt.style.display="none"},500),Y("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),gt.classList.add("fade-out"),setTimeout(()=>{gt.style.display="none"},500),Yt.innerHTML=`
                ...
                `,Yt.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{Ba(U).then(()=>window.location.href="/login.html")})}else window.location.href="/login.html"})}Vl();
