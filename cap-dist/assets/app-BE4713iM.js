import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as V,d as U,m as Oa}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Es,reauthenticateWithCredential as Is,verifyBeforeUpdateEmail as Cs,updatePassword as Ls,updateProfile as Ts,setPersistence as Ps,browserLocalPersistence as Bs,onAuthStateChanged as Co,signOut as za}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as ce,getDoc as Lo,updateDoc as wa,setDoc as Ds,addDoc as To,collection as ue,query as Rt,where as ot,getDocs as ka,orderBy as Po,writeBatch as Bo,serverTimestamp as Va,deleteDoc as Ms,arrayUnion as As,onSnapshot as Ns}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as qs,onMessage as Rs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Fs(e,t,a){m.establishmentId=e,m.establishmentName=t,m.userPermissions=a}const Do=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ia=Do?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${Do?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",ia);async function js(){const e=V.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function y(e,t={}){const a=await js();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=ia.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,o=`${s}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${o}`);try{const n=await fetch(o,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ia}. Verifique se o servidor backend está rodando.`):n}}const Mo=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),y(r)},Hs=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return y(s)},Os=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return y(r)},zs=e=>y("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Sa=(e,t)=>y(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Vs=e=>y(`/api/appointments/${e}`,{method:"DELETE"}),Us=e=>y(`/api/appointments/${e}/reopen`,{method:"POST"}),_s=(e,t)=>y(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let J;async function Js(){if(!J)try{J=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Ws(){if(!J){console.warn("AudioContext não inicializado. O som não será tocado.");return}J.state==="suspended"&&J.resume();const e=J.createOscillator(),t=J.createGain();e.connect(t),t.connect(J.destination),e.type="sine",e.frequency.setValueAtTime(800,J.currentTime),t.gain.setValueAtTime(0,J.currentTime),t.gain.linearRampToValueAtTime(.3,J.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,J.currentTime+.2),e.start(J.currentTime),e.stop(J.currentTime+.2)}function b(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&Ws();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function Ft(e){const t=document.getElementById(e);t&&(t.style.display="none")}function Gs(){document.body.addEventListener("click",()=>{J||Js()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const s=t.dataset.target;if(s){const r=document.getElementById(s);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}async function Ua(){const e=document.getElementById("cancellationListContainer");if(!e)return;e.innerHTML='<div class="loader mx-auto"></div>';const t=document.getElementById("cancelStartDate").value,a=document.getElementById("cancelEndDate").value;try{const s=await Hs(m.establishmentId,t,a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}e.innerHTML=s.map(r=>`
        ...
        `).join("")}catch(s){e.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${s.message}</p>`}}function Ys(){const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const s=`
    ...
    `,{modalElement:r}=_({title:"Histórico de Cancelamentos",contentHTML:s,maxWidth:"max-w-3xl"});r.querySelector("#searchCancellationsBtn").addEventListener("click",Ua),Ua()}const Q=document.getElementById("sidebar"),_a=document.getElementById("sidebarToggle"),Ye=document.getElementById("mainContent"),Qs=document.querySelectorAll(".sidebar-link"),Ja=document.getElementById("hamburger-menu-btn"),Ne=document.getElementById("mobile-overlay");function wt(e){!Q||!Ye||(Q.classList.toggle("collapsed",e),Ye.classList.toggle("sidebar-collapsed-shift",e))}function Xs(){!Q||!Ne||(Q.classList.add("mobile-open"),Ne.classList.add("visible"))}function ct(){!Q||!Ne||(Q.classList.remove("mobile-open"),Ne.classList.remove("visible"))}function Zs(){wt(!Q.classList.contains("collapsed"))}function Ks(e,t,a){if(!Q||!Ye)return;Ye.classList.add("main-content-shift"),window.innerWidth>=768?wt(Q.classList.contains("collapsed")):(Ye.classList.remove("main-content-shift","sidebar-collapsed-shift"),ct()),_a&&_a.addEventListener("click",r=>{r.stopPropagation(),Zs()}),Q.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&Q.classList.contains("collapsed")&&wt(!1)}),Q.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||wt(!0))}),Ja&&Ja.addEventListener("click",r=>{r.stopPropagation(),Xs()}),Ne&&Ne.addEventListener("click",r=>{r.stopPropagation(),ct()});let s=0;Q.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),Q.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&ct()},{passive:!0}),Qs.forEach(r=>{const o=r.getAttribute("data-target"),n=o.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[o]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),o&&typeof e=="function"&&e(o),window.innerWidth<768&&ct()})})}const $e=e=>{const t=e||m.establishmentId;return t?y(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},kt=(e,t)=>{const a=e||m.establishmentId;return a?y(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},er=(e,t)=>{const a=e||m.establishmentId;return a?y(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},tr=(e,t)=>{const a=e||m.establishmentId;return a?y(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},X=e=>y(`/api/professionals/${e}`),ar=e=>y(`/api/professionals/details/${e}`),Ao=e=>y("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Ct=(e,t)=>y(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Wa=(e,t)=>Ct(e,{services:t}),No=e=>y(`/api/professionals/${e}`,{method:"DELETE"}),or=e=>{const t=e.map(a=>No(a));return Promise.all(t)},Ee=e=>y(`/api/services/${e}`),qo=e=>y("/api/services",{method:"POST",body:JSON.stringify(e)}),sr=(e,t)=>y(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),rr=e=>y(`/api/services/${e}`,{method:"DELETE"}),nr=(e,t)=>y(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),ir=e=>y(`/api/services/stats/most-popular/${e}`),jt=e=>y(`/api/products/${e}`),Ro=e=>y("/api/products",{method:"POST",body:JSON.stringify(e)}),lr=(e,t)=>y(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),dr=e=>y(`/api/products/${e}`,{method:"DELETE"}),cr=(e,t)=>y(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),ur=({startDate:e,endDate:t,productId:a,categoryId:s,establishmentId:r})=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),r&&o.append("establishmentId",r),y(`/api/products/stock-history/report?${o.toString()}`)},mr={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function Ga(e,t,a){return new Promise((s,r)=>{const o=new FileReader;o.readAsDataURL(e),o.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const p=e.type==="image/png"&&t<500?"image/png":"image/jpeg";s(l.toDataURL(p,a))},i.onerror=l=>r(l)},o.onerror=n=>r(n)})}let de=null;const St=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let Z=0,Lt=[];async function pr(){try{console.log("Iniciando verificação de Onboarding para ID:",m.establishmentId);const e=await $e(m.establishmentId),t=await X(m.establishmentId),a=await Ee(m.establishmentId);Lt=a||[];const s=e&&e.name&&(e.phone||e.address),r=e&&(e.logo||e.themeColor&&e.themeColor!=="indigo"),o=e&&e.slotInterval>0,n=a&&a.length>0,i=t&&t.length>0;if(console.log("Status Onboarding:",{hasCompanyData:s,hasBranding:r,hasTimeConfig:o,hasService:n,hasProf:i}),s&&o&&i&&n)return;if(!s)Z=0;else if(!r&&!o)Z=1;else if(!o)Z=2;else if(!n)Z=3;else if(!i)Z=4;else if(Z===0)return;gr(),Ea(Z)}catch(e){console.error("Erro ao verificar onboarding:",e)}}function gr(){document.getElementById("onboarding-overlay")||(de=document.createElement("div"),de.id="onboarding-overlay",de.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",de.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",de.innerHTML=`
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>br(a.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===St.length-1?Ya(t):(Z++,$a(),Ea(Z))}),a.id==="branding"){const r=document.getElementById("logo-input"),o=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Ga(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),o&&(o.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Ga(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Ya(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{de&&de.remove(),window.location.reload()}}async function br(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),s=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),o=Object.fromEntries(r.entries());try{if(e==="company_data")await kt(m.establishmentId,{name:o.name,phone:o.phone,email:o.email,address:o.address,zipCode:o.zipCode});else if(e==="branding"){const n={};o.logoBase64&&(n.logo=o.logoBase64),o.bgBase64&&(n.backgroundImage=o.bgBase64),o.themeColor&&(n.themeColor=o.themeColor),o.primaryColor&&(n.primaryColor=o.primaryColor),Object.keys(n).length>0&&await kt(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(o.slotInterval);await kt(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await qo({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.price),duration:parseInt(o.duration),active:!0});n&&Lt.push(n)}else if(e==="first_prof"){const n=await Ao({establishmentId:m.establishmentId,name:o.name,specialty:o.role,active:!0,commissionRate:0});if(o.serviceId&&n&&n.id)try{Wa?await Wa(n.id,[o.serviceId]):Ct&&await Ct(n.id,{services:[o.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Ro({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.salePrice),stock:parseInt(o.stock),active:!0});b("Sucesso","Passo concluído!","success"),Z++,$a(),Ea(Z)}catch(n){b("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=s}}var qe;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(qe||(qe={}));class Yt extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const fr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},vr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:fr(e),o=()=>r()!=="web",n=u=>{const p=d.get(u);return!!(p?.platforms.has(r())||i(u))},i=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(g=>g.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,p={})=>{const g=d.get(u);if(g)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),g.proxy;const f=r(),h=i(u);let w;const S=async()=>(!w&&f in p?w=typeof p[f]=="function"?w=await p[f]():w=p[f]:t!==null&&!w&&"web"in p&&(w=typeof p.web=="function"?w=await p.web():w=p.web),w),I=(L,P)=>{var N,R;if(h){const z=h?.methods.find(A=>P===A.name);if(z)return z.rtype==="promise"?A=>a.nativePromise(u,P.toString(),A):(A,Y)=>a.nativeCallback(u,P.toString(),A,Y);if(L)return(N=L[P])===null||N===void 0?void 0:N.bind(L)}else{if(L)return(R=L[P])===null||R===void 0?void 0:R.bind(L);throw new Yt(`"${u}" plugin is not implemented on ${f}`,qe.Unimplemented)}},$=L=>{let P;const N=(...R)=>{const z=S().then(A=>{const Y=I(A,L);if(Y){const Ie=Y(...R);return P=Ie?.remove,Ie}else throw new Yt(`"${u}.${L}()" is not implemented on ${f}`,qe.Unimplemented)});return L==="addListener"&&(z.remove=async()=>P()),z};return N.toString=()=>`${L.toString()}() { [capacitor code] }`,Object.defineProperty(N,"name",{value:L,writable:!1,configurable:!1}),N},k=$("addListener"),C=$("removeListener"),F=(L,P)=>{const N=k({eventName:L},P),R=async()=>{const A=await N;C({eventName:L,callbackId:A},P)},z=new Promise(A=>N.then(()=>A({remove:R})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await R()},z},O=new Proxy({},{get(L,P){switch(P){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?F:k;case"removeListener":return C;default:return $(P)}}});return s[u]=O,d.set(u,{name:u,proxy:O,platforms:new Set([...Object.keys(p),...h?[f]:[]])}),O};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Yt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},hr=e=>e.Capacitor=vr(e),ye=hr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ia=ye.registerPlugin;class Fo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new ye.Exception(t,qe.Unimplemented)}unavailable(t="not available"){return new ye.Exception(t,qe.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Qa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Xa=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class xr extends Fo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Xa(r).trim(),o=Xa(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Qa(t.key),s=Qa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ia("CapacitorCookies",{web:()=>new xr});const yr=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),wr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},kr=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,Sr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=wr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class $r extends Fo{async request(t){const a=Sr(t,t.webFetchExtra),s=kr(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await yr(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const c={};return o.headers.forEach((u,p)=>{c[p]=u}),{data:l,headers:c,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ia("CapacitorHttp",{web:()=>new $r});const G=Ia("PushNotifications",{}),Er="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Za=!1;async function jo(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{zo(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Oo()}async function Ho(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Oo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Oo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await qs(Oa,{vapidKey:Er,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await zo(t,!1)):console.warn("[Push Web] Token veio vazio."),Za||(Rs(Oa,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Za=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function zo(e,t){const a=V.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=ce(U,"users",a.uid);try{const r=await Lo(s);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await wa(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Ds(s,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",r)}}const Ir=(e,t,a="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),y(`/api/reports/indicators?${r.toString()}`)},Cr=e=>e?y(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Lr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),y(`/api/reports/sales?${r.toString()}`)},Tr=()=>y("/api/reports/summary",{method:"GET"}),Ht=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return y(r)},Ot=e=>y("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Ca=e=>y(`/api/blockages/${e}`,{method:"DELETE"}),Vo=e=>y("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),La=e=>e?String(e).replace(/\D/g,""):"",He=(e,t="",a=20,s={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),s.hasLoyalty&&r.append("hasLoyalty","true"),s.birthMonth&&r.append("birthMonth",s.birthMonth),s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),y(`/api/clients/${e}?${r.toString()}`)},la=(e,t)=>{const a=encodeURIComponent(t);return y(`/api/clients/details/${e}/${a}`)},Pr=e=>{if(!e.phone)throw new Error("Telefone é obrigatório");const t=La(e.phone),a={...e,phone:t,id:t};return y(`/api/clients/${t}`,{method:"PUT",body:JSON.stringify(a)})},Br=(e,t)=>{const a=La(t);return y(`/api/clients/full-history/${e}?phone=${a}`)},Uo=e=>{const t=encodeURIComponent(e);return y(`/api/clients/${t}`,{method:"DELETE"})},Dr=(e,t,a,s)=>y("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:La(t),points:a,rewardName:s})});function v(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function _o(e,t=800,a=800,s=.7){return new Promise((r,o)=>{if(!e.type.match(/image.*/))return o(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const g=u.toDataURL("image/jpeg",s);r(g)},l.onerror=d=>o(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>o(new Error("Erro ao ler o ficheiro."))})}const Ka=document.getElementById("content");let eo=!1;const da=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let it=[],zt=[],Re={},Me=[],D={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},E={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Mr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Jo(e){const t=new Date(e);if(t.setHours(0,0,0,0),D.currentView==="week"&&D.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function Tt(){const e=document.getElementById("profSelectorContainer"),t=D.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let a=m.professionals.filter(o=>D.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=D.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",c=v(i),u=da[0],p=o.id!=="all"&&m.professionalColors.get(o.id)||u,g=o.photo||`https://placehold.co/64x64/${p.main?.replace("#","")||"E0E7FF"}/${p.light?.replace("#","")||"4F46E5"}?text=${l}`,f=o.id==="all"?"#e0e7ff":p.light,h=o.id==="all"?"#4f46e5":p.main,S=`border: 3px solid ${n?p.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+p.border:"none"};`;return`
        ...
        `}).join("")}function Ar(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function Nr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(s.professionalId)||{},d=v(s.reason),c=v(s.professionalName),u=v(s.clientName),p=v(s.serviceName);if(s.type==="blockage")return`
                ...
                </div>`;const g=s.status==="completed",f=g?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",h=g?"Finalizado":"Aberto",w=JSON.stringify(s).replace(/'/g,"&apos;"),S=s.redeemedReward?.points>0,I=s.hasRewards&&!S,$=Ar(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime);return`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(E.data.redeemedReward=null)})}async function Or(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!E.data.time||E.data.selectedServiceIds.length===0||!E.data.professionalId)return b("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const s=E.data.selectedServiceIds.map(d=>{const c=it.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,o]=E.data.time.split(":"),n=new Date(`${E.data.date}T${r}:${o}:00`),i={establishmentId:m.establishmentId,clientName:E.data.clientName,clientPhone:E.data.clientPhone,services:s,professionalId:E.data.professionalId,startTime:n.toISOString(),redeemedReward:E.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Sa(l,i):await zs(i),b(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",ae()}catch(d){b(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function Yo(e){const t=E.data.clientName===e.name&&E.data.clientPhone===e.phone,a=v(e.name),s=v(e.phone);return`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",Vr)}function _r(){Ur()}function Jr(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",s=`
    ...
    `;return{title:a,content:s}}function Wr(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:e,content:t}}function Yr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,s=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=E.data.date||s,o=v(E.data.clientName),n=v(E.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function Qr(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),s=it.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=E.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Wo(r.dataset.serviceId,r))})}function Xr(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),s=zt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=E.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=v(r.name);return`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>{o.addEventListener("click",()=>{const n=parseInt(o.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(E.data.clientName=i.value.trim(),E.data.clientPhone=l.value.trim(),!E.data.clientName||!E.data.clientPhone)return b("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(E.data.selectedServiceIds.length===0)return b("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!E.data.professionalId)return b("Atenção","Selecione um profissional.","error");ca(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>{o.addEventListener("click",()=>ca(parseInt(o.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if(E.step===4&&r&&r.addEventListener("submit",Or),a.style.display="flex",E.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Wo(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>Qr(i.target.value))}if(E.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>Go(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>Xr(i.target.value))}if(E.step===1){const o=a.querySelector("#clientSearchInput");if(o&&(o.addEventListener("input",i=>zr(i.target.value)),E.data.clientName&&E.data.clientPhone&&Me.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=Me.map(Yo).join(""))}const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",_r)}if(E.step===4){const o=a.querySelector("#apptDate");o&&o.addEventListener("change",to),to(),Hr()}}async function Qo(e={}){D.currentDate=e.targetDate?new Date(e.targetDate):D.currentDate||new Date,D.scrollToAppointmentId=e.scrollToAppointmentId||null,D.profSearchTerm="",window.innerWidth<768&&(D.currentView="list"),Ka.innerHTML=`
        <section>
        ...
        </section>`,document.querySelectorAll(".view-btn[data-view]").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(r=>r.classList.remove("active")),a.classList.add("active"),D.currentView=a.dataset.view;const s=document.getElementById("week-days-toggle");if(D.currentView==="week"){if(s.style.display="flex",window.innerWidth<768){D.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(o=>o.classList.remove("active"));const r=document.querySelector('.week-days-btn[data-days="3"]');r&&r.classList.add("active")}}else s.style.display="none";ae()})}),document.querySelectorAll(".week-days-btn").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"),D.weekViewDays=parseInt(a.dataset.days,10),ae()})}),document.getElementById("todayBtn").addEventListener("click",()=>{D.currentDate=new Date,ae()});const t=a=>{const s=parseInt(a.currentTarget.dataset.amount,10),r=D.currentView==="week"?Ta():1,o=new Date(D.currentDate);o.setDate(o.getDate()+s*r),D.currentDate=o,ae()};document.getElementById("prevBtn").addEventListener("click",t),document.getElementById("nextBtn").addEventListener("click",t),document.getElementById("profSearchInput").addEventListener("input",a=>{D.profSearchTerm=a.target.value,Tt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",a=>{D.showInactiveProfs=a.target.checked,Tt(),ae()}),eo||(Ka.addEventListener("click",async a=>{const s=a.target.closest("[data-action]");if(a.target.closest('[data-action="select-professional"]')){const l=a.target.closest('[data-action="select-professional"]').dataset.profId,d=D.selectedProfessionalId===l&&l!=="all";if(D.selectedProfessionalId=d?"all":l,l!=="all"){const c=document.getElementById("profSearchInput");c&&(c.value=""),D.profSearchTerm=""}await ae();return}if(!s)return;const r=s.dataset.action;let o=null;const n=a.target.closest("[data-appointment]");switch(n&&(o=JSON.parse(n.dataset.appointment.replace(/&apos;/g,"'"))),r){case"new-appointment":ua();break;case"edit-appointment":if(!o)return;if(o.status==="completed"){b("Atenção","Agendamentos finalizados não podem ser editados.","error");return}o.hasRewards&&!o.redeemedReward&&b("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),ua(o);break;case"delete-appointment":{const i=s.dataset.id;if(await j("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Vs(i),b("Agendamento apagado!","success"),ae()}catch(d){b(`Não foi possível apagar: ${d.message}`,"error")}break}case"open-comanda":if(o){o.hasRewards&&!o.redeemedReward&&o.status!=="completed"&&b("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const i=o.status==="completed"?"finalizadas":"em-atendimento",l={selectedAppointmentId:o.id,initialFilter:i};if(i==="finalizadas"){let d=o.startTime;if(o.transaction&&o.transaction.paidAt){const c=o.transaction.paidAt;typeof c=="object"&&c._seconds?d=new Date(c._seconds*1e3):d=c}l.filterDate=d}te("comandas-section",l)}break}}),eo=!0),await Fr(),await ae()}const Zr=(e,t=null,a=1,s=12)=>{let r=`/api/comandas/${e}?page=${a}&limit=${s}`;return t&&(r+=`&date=${t}`),y(r)},Kr=e=>y("/api/sales",{method:"POST",body:JSON.stringify(e)}),en=e=>y(`/api/sales/${e}/reopen`,{method:"POST"}),tn=e=>y(`/api/sales/${e}`,{method:"DELETE"}),Xo=()=>y("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),an=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),y("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},on=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),y(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},sn=()=>y("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),rn=e=>y(`/api/cashier/report/${e}`),Zo=e=>y(`/api/packages/${e}`),nn=e=>y("/api/packages",{method:"POST",body:JSON.stringify(e)}),ln=(e,t)=>y(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),dn=e=>y(`/api/packages/${e}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},clients:[],activeFilter:"atendimento",selectedComandaId:null,isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,paging:{page:1,limit:12,total:0}},Ce=null,Te=null;function Vt(e){if(e.status==="completed"){const r=e.comandaItems||e.items||[];return r.length>0?r:e.services||[]}const t=e.services||[],a=[...e.comandaItems||[],...e.items||[]];let s=[...t];return a.forEach(r=>{if(r.type==="product"){s.push(r);return}s.some(n=>{const i=n.id&&r.id&&n.id===r.id,l=n.name&&r.name&&n.name===r.name;return i||l})||s.push(r)}),s}function cn(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function he(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function un(){const e=new Date().toISOString().split("T")[0];Te.innerHTML=`
    ...
    `}function mn(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `;return}const a={atendimento:"confirmed",finalizadas:"completed"}[x.activeFilter],s=x.allComandas.filter(r=>r.status===a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',ao(e);return}e.innerHTML=s.map(r=>{const n=Vt(r).reduce((g,f)=>g+(f.price||0),0),i=r.id===x.selectedComandaId,l=new Date(r.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=r.type==="walk-in"||r.id.startsWith("temp-"),c=v(r.clientName),u=v(r.professionalName),p=d?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md">Agendado</span>';return`
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    ${g.isReward?'<span class="text-yellow-700 font-bold">Prémio Fidelidade</span>':`R$ ${(g.price||0).toFixed(2)} un.`}
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
    ...
    `,r||pn(a,e.querySelector("#loyalty-container"))}async function pn(e,t){if(!t)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;if(e.clientId&&(s=x.clients.find(n=>n.id===e.clientId)),s||(s=x.clients.find(n=>n.name===e.clientName)),!s||s.loyaltyPoints===void 0)try{if(e.clientId)s=await la(e.clientId);else{const n=await He(m.establishmentId,e.clientName);s=n.find(i=>i.name===e.clientName)||n[0]}}catch(n){console.error("[Fidelidade] Erro ao buscar cliente",n);return}if(!s||!s.loyaltyPoints)return;const o=(a.tiers||a.rewards||[]).filter(n=>{const i=n.costPoints||n.points||0;return s.loyaltyPoints>=i});if(o.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center",n.innerHTML=`
        ...
        `;const i=document.createElement("button");i.innerText="Resgatar",i.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",i.onclick=()=>gn(o),n.appendChild(i),t.innerHTML="",t.appendChild(n)}}function gn(e,t){const a=`
        <div class="space-y-4">
    ...
    `,{modalElement:s,close:r}=_({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",o=>{const n=o.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,l=e.find(d=>d.id&&d.id==i||(d.name||d.reward)==i);l&&(bn(l),r())}})}async function bn(e,t){const a=e.costPoints||e.points||0,s=e.name||e.reward,r={id:e.serviceId||e.productId||`reward-${Date.now()}`,name:`${s}`,price:0,type:e.serviceId?"service":"product",isReward:!0,pointsCost:a};await Ko(r,1)}function fn(){_({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,{modalElement:r}=_({title:"Nova Venda Avulsa",contentHTML:s,maxWidth:"max-w-md"});r.querySelector("#new-sale-form").addEventListener("submit",En);const o=r.querySelector('[data-action="new-client-from-sale"]');o&&o.addEventListener("click",n=>{n.preventDefault(),r.style.display="none",fn()})}function xn(){if(!x.isCashierOpen){b("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const e=x.allComandas.find(u=>u.id===x.selectedComandaId);if(!e)return;const t=Vt(e),a=new Set,s=[];for(const u of t){if(u.type==="service"&&u.id){if(a.has(u.id))continue;a.add(u.id)}s.push(u)}const r=s.reduce((u,p)=>u+(p.price||0),0);let o=[],n={remainingAmount:r,selectedMethod:"dinheiro",installments:1,amountReceived:""};const i=()=>{const u=document.getElementById("payment-list"),p=document.getElementById("remaining-amount"),g=document.getElementById("finalize-checkout-btn"),f=document.getElementById("change-container"),h=document.getElementById("installments-container"),w=document.getElementById("payment-value"),S=document.getElementById("payment-controls"),I=o.reduce((k,C)=>k+C.value,0);n.remainingAmount=r-I,u.innerHTML=o.map((k,C)=>`
    ...
    `,{modalElement:c}=_({title:"Finalizar Pagamento",contentHTML:d,maxWidth:"max-w-md"});document.getElementById("payment-value").value=n.remainingAmount.toFixed(2),c.addEventListener("click",u=>{const p=u.target.closest(".payment-method-btn");p&&(n.selectedMethod=p.dataset.method,n.installments=1,document.getElementById("installments-select").value=1,i()),u.target.closest("#add-payment-btn")&&l(),u.target.closest('[data-action="remove-payment"]')&&(o.splice(parseInt(u.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),i()),u.target.closest("#finalize-checkout-btn")&&$n(e,r,o)}),c.addEventListener("change",u=>{u.target.id==="installments-select"&&(n.installments=parseInt(u.target.value,10))}),c.addEventListener("input",u=>{u.target.id==="amount-received"&&(n.amountReceived=u.target.value,i())}),i()}async function yn(){const e=`
    ...
    `,{modalElement:t}=_({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=document.getElementById("initial-amount"),r=s.value.trim(),o=document.getElementById("cashier-notes").value.trim(),n=parseFloat(r);if(r===""||isNaN(n)||n<0){b("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),s.focus();return}try{const i={establishmentId:m.establishmentId,initialAmount:parseFloat(n.toFixed(2))};o&&(i.notes=o);const l=await an(i);x.isCashierOpen=!0,x.activeCashierSessionId=l.id,await Pa(),document.getElementById("genericModal").style.display="none",b("Sucesso!",`Caixa aberto com valor inicial de R$ ${n.toFixed(2)}`,"success")}catch(i){b("Erro",`Não foi possível abrir o caixa: ${i.message}`,"error")}})}async function wn(){const e=x.activeCashierSessionId;if(e)try{const t=await rn(e),a=`
        ...
        `,{modalElement:s}=_({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0){b("Valor Inválido","Insira um valor final válido.","error");return}try{await on(e,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await Pa(),b("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){b("Erro",`Não foi possível fechar o caixa: ${n.message}`,"error")}})}catch(t){b("Erro",`Não foi possível carregar o relatório de fecho: ${t.message}`,"error")}}async function kn(e){x.activeFilter!==e&&(x.activeFilter=e,x.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),he(),await se(),x.selectedComandaId=null,K())}function pa(e){x.selectedComandaId=e,me(),cn(),K()}async function Ko(e,t){const a=x.allComandas.find(r=>r.id===x.selectedComandaId);if(!a)return;const s=Array(t).fill(0).map(()=>({id:e.id,name:e.name,price:e.price,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0}));if(a.comandaItems=a.comandaItems||[],a.comandaItems.push(...s),a.type==="walk-in"&&a.id.startsWith("temp-")){b("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),K(),me();return}try{await Sa(a.id,a),b("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),K(),me()}catch(r){b("Erro",`Não foi possível adicionar o item: ${r.message}`,"error"),a.comandaItems.splice(a.comandaItems.length-t,t)}}async function Sn(e,t){const a=x.allComandas.find(o=>o.id===x.selectedComandaId);if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>o.id===e&&o.type===t);if(r>-1)a.comandaItems.splice(r,1),s=!0;else{let o=(a.services||[]).findIndex(n=>n.id===e);if(o>-1)a.services.splice(o,1),s=!0;else{let n=(a.items||[]).findIndex(i=>i.id===e&&i.type===t);n>-1&&(a.items.splice(n,1),s=!0)}}if(s){if(a.type==="walk-in"&&a.id.startsWith("temp-")){b("Sucesso","Item removido!","success"),K(),me();return}try{await Sa(a.id,a),b("Sucesso","Item removido!","success"),K(),me()}catch(o){b("Erro",`Não foi possível remover o item: ${o.message}`,"error"),await se()}}}async function $n(e,t,a){const s=e.type==="appointment",r=Vt(e),o=new Set,n=[];for(const c of r){if(c.type==="service"&&c.id){if(o.has(c.id))continue;o.add(c.id)}n.push(c)}let i=0;const l=x.loyaltySettings;if(l&&l.enabled)if(l.type==="visit")i=l.pointsPerVisit||1;else{const c=l.pointsPerCurrency||10;i=Math.floor(t/c)}const d={payments:a,totalAmount:t,items:n,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:i};try{s?await _s(e.id,d):(d.establishmentId=m.establishmentId,d.clientId=e.clientId,d.clientName=e.clientName,d.professionalId=e.professionalId,d.clientPhone=e.clientPhone,await Kr(d));let c="Venda finalizada com sucesso!";i>0&&(c+=` Cliente ganhou ${i} pontos.`),b("Sucesso!",c,"success"),document.getElementById("genericModal").style.display="none",he(),x.selectedComandaId=null,await se()}catch(c){b("Erro no Checkout",c.message,"error")}}async function En(e){e.preventDefault();const t=document.getElementById("new-sale-client").value,a=document.getElementById("new-sale-professional").value,s=x.clients.find(n=>n.id===t),r=m.professionals.find(n=>n.id===a);if(!s||!r){b("Erro","Selecione um cliente e um profissional válidos.","error");return}const o={id:`temp-${Date.now()}`,type:"walk-in",clientId:s.id,clientName:s.name,clientPhone:s.phone,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(o),x.selectedComandaId=o.id,document.getElementById("genericModal").style.display="none",pa(o.id)}async function se(){const e=document.getElementById("comandas-list");e.innerHTML='<div class="loader mx-auto mt-10"></div>';const t=x.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=await Xo();if(x.isCashierOpen=!!a,x.activeCashierSessionId=a?a.id:null,mn(),!x.isCashierOpen&&x.activeFilter==="atendimento"){me(),K();return}try{const r=await(void 0)(m.establishmentId);r&&r.loyaltyProgram&&(x.loyaltySettings=r.loyaltyProgram)}catch{console.log("Sem config de fidelidade carregada")}const s=await Zr(m.establishmentId,t,x.paging.page,x.paging.limit);if(x.allComandas=s.data||s,x.paging.total=s.total||s.length,x.catalog.services.length===0){const[r,o,n,i,l]=await Promise.all([Ee(m.establishmentId),jt(m.establishmentId),Zo(m.establishmentId),He(m.establishmentId),X(m.establishmentId)]);x.catalog={services:r,products:o,packages:n},x.clients=i,m.professionals=l}me(),x.selectedComandaId,K()}catch(a){b("Erro de Carregamento",`Não foi possível carregar os dados: ${a.message}`,"error"),e.innerHTML=`<p class="text-red-500 p-4">${a.message}</p>`}}async function Pa(e={}){Te=document.getElementById("content");try{const t=await Xo();x.isCashierOpen=!!t,x.activeCashierSessionId=t?t.id:null}catch(t){console.error("Erro ao verificar caixa:",t),x.isCashierOpen=!1}x.selectedComandaId=e.selectedAppointmentId||null,un(),Ce&&(Te.removeEventListener("click",Ce),Te.removeEventListener("change",Ce)),Ce=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(t.target.id==="filter-date"&&x.activeFilter==="finalizadas"){x.paging.page=1,await se();return}if(a){if(a.matches("[data-filter]"))kn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}pa(a.dataset.comandaId)}else if(a.matches("[data-action]")){const s=a.dataset.action,r=a.dataset.id||x.selectedComandaId;switch(s){case"back-to-list":{he(),x.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(o=>o.classList.remove("selected")),K();break}case"new-sale":ma();break;case"add-item":hn();break;case"checkout":xn();break;case"open-cashier":yn();break;case"close-cashier":await wn();break;case"view-sales-report":te("sales-report-section");break;case"remove-item":await Sn(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await j("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await Us(r);const n=x.allComandas.findIndex(i=>i.id===r);n!==-1&&(delete x.allComandas[n].transaction,delete x.allComandas[n].cashierSessionId,delete x.allComandas[n].redeemedReward,x.allComandas[n].status="confirmed"),x.selectedComandaId=null,he(),b("Sucesso!","Comanda reaberta para edição.","success"),await se()}catch(n){b("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"reopen-walk-in":{if(await j("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await en(r),b("Sucesso!","Venda revertida."),he(),x.selectedComandaId=null,await se()}catch(n){b("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"go-to-appointment":{const o=a.dataset.id,n=a.dataset.date;te("agenda-section",{scrollToAppointmentId:o,targetDate:new Date(n)});break}case"delete-walk-in":{if(await j("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(r.startsWith("temp-"))x.allComandas=x.allComandas.filter(n=>n.id!==r),x.selectedComandaId=null,me(),K(),b("Sucesso","Venda avulsa removida.","success"),he();else try{await tn(r),b("Sucesso","Venda avulsa excluída com sucesso.","success"),x.selectedComandaId=null,he(),await se()}catch(n){b("Erro",`Não foi possível excluir: ${n.message}`,"error")}break}}}}},Te.addEventListener("click",Ce),Te.addEventListener("change",Ce),e.initialFilter&&(x.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(x.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${x.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",x.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await se(),x.selectedComandaId&&pa(x.selectedComandaId)}const ga=document.getElementById("content");let Qt={};const ut=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],q={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],currentTab:"dashboards"};async function In(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function Cn(){ga.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">A carregar inteligência de dados...</p></div>';try{await In();const[e,t]=await Promise.all([X(m.establishmentId),Cr(m.establishmentId).catch(()=>[])]);q.professionalsList=e||[],q.costCentersList=t||[],Ln(),await es()}catch(e){console.error("Erro no loadReportsPage:",e),ga.innerHTML=`
            ...
            </div>`}}function Ln(){const e=q.professionalsList.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join(""),t=q.costCentersList.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join("");ga.innerHTML=`
    ...
    `,document.getElementById("btn-filter").onclick=Tn,document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{q.currentTab=a.dataset.tab,oo(),ts()}}),oo()}function oo(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===q.currentTab;e.className=t?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function Tn(){q.startDate=document.getElementById("report-start").value,q.endDate=document.getElementById("report-end").value,q.selectedProfessional=document.getElementById("report-prof").value,q.selectedCostCenter=document.getElementById("report-cost").value,await es()}async function es(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const t=Ir(q.startDate,q.endDate,q.selectedProfessional,q.selectedCostCenter),a=q.selectedProfessional==="all"?null:q.selectedProfessional,s=new Date(q.startDate+"T00:00:00").toISOString(),r=new Date(q.endDate+"T23:59:59").toISOString(),o=Mo(m.establishmentId,s,r,a).catch(l=>[]),[n,i]=await Promise.all([t,o]);q.data=n,q.appointmentsData=Array.isArray(i)?i:[],ts()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ts(){const e=document.getElementById("report-content");if(q.data)switch(q.currentTab){case"dashboards":Pn(e);break;case"appointments":Bn(e);break;case"dre":Dn(e);break}}function Pn(e){const{dreSimple:t,charts:a}=q.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0},r=q.data.totalAppointments||0,o=r>0?s.grossRevenue/r:0;e.innerHTML=`
    ...
    `,We("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,ut[0]);const n=a.professionals.labels.map(l=>v(l));We("chart-profs","doughnut","Total Vendas",n,a.professionals.data,ut),We("chart-daily","line","Vendas Diárias",a.salesDaily.labels,a.salesDaily.data,ut[4]);const i=a.products.labels.map(l=>v(l));We("chart-products","bar","Total Vendido",i,a.products.data,ut[1])}function Bn(e){const t=q.appointmentsData,a=t.length;let s=0,r=0,o=0,n=0;const i={},l={};let d=new Date(q.startDate);const c=new Date(q.endDate);for(;d<=c;)i[d.toISOString().split("T")[0]]=0,d.setDate(d.getDate()+1);t.forEach(f=>{const h=parseFloat(f.totalAmount||f.price||0),w=(f.status||"").toLowerCase();let S=f.startTime?(f.startTime.toDate?f.startTime.toDate():new Date(f.startTime)).toISOString().split("T")[0]:"";const I=f.professionalName||"Sem Profissional";l[I]||(l[I]={name:I,count:0,value:0}),["cancelled","cancelado","no-show"].includes(w)?(r++,n+=h):(["completed","finalized","paid"].includes(w)&&s++,o+=h,S&&i.hasOwnProperty(S)&&i[S]++,l[I].count++,l[I].value+=h)});const u=Object.keys(i).sort(),p=u.map(f=>i[f]),g=Object.values(l).sort((f,h)=>h.count-f.count);e.innerHTML=`
    ...
    `,We("dailyApptChart","line","Agendamentos",u.map(f=>f.split("-").reverse().slice(0,2).join("/")),p,"#4f46e5")}function Dn(e){const{dreFinancial:t}=q.data,a=Object.entries(t.revenues).map(([r,o])=>`
    ...
    `}function We(e,t,a,s,r,o){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");Qt[e]&&Qt[e].destroy();const l={type:t,data:{labels:s,datasets:[{label:a,data:r,backgroundColor:Array.isArray(o)?o:t==="line"?"rgba(79, 70, 229, 0.1)":o,borderColor:Array.isArray(o)?"#fff":o,borderWidth:2,fill:t==="line",tension:.3,borderRadius:t==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:o,pointHoverBackgroundColor:o}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let c=d.dataset.label||"";return c&&(c+=": "),d.parsed.y!==null?c+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):c+=d.raw,c}}}},scales:t==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};Qt[e]=new Chart(i,l)}const Ut=(e,t="products")=>y(`/api/${t}/categories/${e}`),as=(e,t="products")=>y(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),os=(e,t="products")=>y(`/api/${t}/categories/${e}`,{method:"DELETE"}),Mn="audit_logs",Fe=async(e,t,a,s,r,o=null)=>{try{if(!t)return;await To(ue(U,Mn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:r,details:o,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},ve=document.getElementById("content");let ne=null,Qe="services",we="all";function je(){const e=V.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function An(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await as({establishmentId:m.establishmentId,name:s},"services"),Fe(m.establishmentId,je(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",b("Sucesso","Categoria criada!","success"),await Ba(),await lt()}catch(r){b("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Nn(e){if(await j("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await os(e,"services"),Fe(m.establishmentId,je(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),b("Sucesso","Categoria apagada.","success"),await Ba(),await lt()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function Ba(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Ut(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function qn(){_({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),Da(),Pe()}function jn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function lt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,r]=await Promise.all([Ee(m.establishmentId),X(m.establishmentId),Ut(m.establishmentId,"services"),ir(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(o=>{o.active===void 0&&(o.active=!0)}),ss(Qe)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),b("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function ss(e){if(document.getElementById("services-content-container")){if(Qe===e&&document.getElementById("services-content-container").children.length>1){Qe==="services"&&(Da(),Pe());return}Qe=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Fn():e==="reports"&&jn()}}function Hn(){ne&&(ve.removeEventListener("click",ne),ve.removeEventListener("input",ne),ve.removeEventListener("change",ne)),ne=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),o=r.dataset.id,n=r.checked;try{await nr(o,n);const i=m.services.findIndex(l=>l.id===o);i>-1&&(m.services[i].active=n),Fe(m.establishmentId,je(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${o}) para ${n?"Ativo":"Inativo"}`),Pe(),Da()}catch(i){b("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Pe()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Pe();return}if(!a)return;if(a.hasAttribute("data-view")){ss(a.dataset.view);return}switch(a.dataset.action){case"new-service":so();break;case"edit-service":const r=JSON.parse(a.dataset.service);so(r);break;case"manage-categories":qn();break;case"filter-service":const o=a.dataset.filterType;if(o==="popular")return;we=o==="total"?"all":o,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===we||i==="total"&&we==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Pe();break}},ve.addEventListener("click",ne),ve.addEventListener("input",ne),ve.addEventListener("change",ne)}async function On(){ve.innerHTML=`
        ...
        </section>`,Hn();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await X(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),b("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Qe="services",we="all",await lt()}const _t="suppliers",Ma="purchases",rs="financial_payables",Aa=async e=>{try{const t=Rt(ue(U,_t),ot("establishmentId","==",e)),a=await ka(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},zn=async e=>{try{return{id:(await To(ue(U,_t),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},Vn=async(e,t)=>{try{const a=ce(U,_t,e);return await wa(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Un=async e=>{try{const t=ce(U,_t,e);return await Ms(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},_n=async(e,t=null)=>{try{const a=Bo(U),s=ce(ue(U,Ma)),r={...e,createdAt:Va()};if(a.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const o=ce(ue(U,rs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:Va()};a.set(o,i)}return await a.commit(),{id:s.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},Jn=async(e,t)=>{try{const a=Bo(U),s=ce(U,Ma,e);a.delete(s);const r=Rt(ue(U,rs),ot("purchaseId","==",e),ot("establishmentId","==",t));return(await ka(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},Wn=async e=>{try{const t=Rt(ue(U,Ma),ot("establishmentId","==",e),Po("createdAt","desc")),a=await ka(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},ge=document.getElementById("content");let ie=null,Xe="products",oe="all";async function Gn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await as({establishmentId:m.establishmentId,name:s},"products"),a.value="",b("Sucesso","Categoria de produto criada!","success"),await Na(),await dt()}catch(r){b("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Yn(e){if(await j("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await os(e,"products"),b("Sucesso","Categoria de produto apagada.","success"),await Na(),await dt()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function Na(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Ut(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Qn(){_({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const f=t.querySelector("#productCategory"),h=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>h.click()),f.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(L=>`<option value="${L.id}" ${e?.categoryId===L.id?"selected":""}>${v(L.name)}</option>`).join(""),e&&(f.value=e.categoryId||"");const w=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const S=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",I=e?.photo||"";h.onchange=async()=>{const L=h.files[0];if(L){w.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const P=await ro(L,800,800,"image/jpeg",.8),R=P.length*3/4,z=1e3*1024;if(R>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=P,base64Input.value=P}catch(P){console.error("Erro ao processar imagem:",P),b("Erro de Imagem",P.message||"Não foi possível processar a imagem.","error"),preview.src=S,base64Input.value=I,O.value=""}}};const $=t.cloneNode(!0);t.parentNode.replaceChild($,t);const k=()=>{const L=$.querySelector("#modalSupplierSearch"),P=$.querySelector("#supplierSearchResults"),N=$.querySelector("#selectedSuppliersList"),R=L.value.toLowerCase();if(R.length>0){const z=s.filter(A=>A.name.toLowerCase().includes(R)&&!o.has(A.id));z.length>0?(P.classList.remove("hidden"),P.innerHTML=z.map(A=>`
                ...
                `).join("")):(P.classList.remove("hidden"),P.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else P.classList.add("hidden");o.size>0?(N.innerHTML="",o.forEach(z=>{const A=s.find(Y=>Y.id===z);A&&(N.innerHTML+=`
                    ...
                    `)})):N.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};$.querySelector("#modalSupplierSearch").addEventListener("input",k),$.addEventListener("click",L=>{const P=L.target.closest("[data-add-supplier]");if(P){const R=P.dataset.addSupplier;o.add(R),$.querySelector("#modalSupplierSearch").value="",k()}const N=L.target.closest("[data-remove-supplier]");if(N){const R=N.dataset.removeSupplier;o.delete(R),k()}}),k(),$.addEventListener("click",async L=>{const P=L.target.closest("button[data-action]");if(!P)return;const N=P.dataset.action,R=$.querySelector("#productId").value;if(N==="close-modal"&&($.style.display="none"),N==="delete-product"){if(!R)return;$.style.display="none",await Xn(R)}if(N==="save-product-modal"){const z=$.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){b("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const A=P.closest('button[data-action="save-product-modal"]');A.disabled=!0,A.textContent="A salvar...";try{await Zn(z)}catch(Y){b("Erro",`Falha ao salvar: ${Y.message}`,"error"),A.disabled=!1,A.textContent="Salvar Alterações"}}}if(N==="adjust-stock-modal"){L.preventDefault();const z=$.querySelector("#stockAdjustmentAmount"),A=$.querySelector("#stockAdjustmentReason"),Y=parseInt(z.value,10),Ie=parseInt(P.dataset.change,10);if(!Y||Y<=0){b("Erro","Por favor, insira uma quantidade válida.","error");return}const Gt=Y*Ie,$s=A.value||(Gt>0?"Entrada manual":"Saída manual");try{await cr(R,{change:Gt,reason:$s});const ze=m.products.findIndex(Ve=>Ve.id===R);if(ze>-1){const Ve=m.products[ze].currentStock+Gt;m.products[ze].currentStock=Ve,$.querySelector("#currentStockDisplay").textContent=Ve,$.querySelector("#productCurrentStock").value=Ve,z.value="",A.value="",b("Sucesso","Estoque atualizado!","success"),qa(),st()}}catch(ze){b("Erro de Stock",ze.message,"error")}}});const C=$.querySelectorAll(".tab-btn"),F=$.querySelectorAll(".tab-content");C.forEach(L=>{L.addEventListener("click",P=>{P.preventDefault(),C.forEach(N=>{N.classList.remove("border-indigo-500","text-indigo-600"),N.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),L.classList.add("border-indigo-500","text-indigo-600"),L.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),F.forEach(N=>N.classList.add("hidden")),document.getElementById(`tab-content-${L.dataset.tab}`).classList.remove("hidden")})});const O=$.querySelector("#productPhotoInput");$.querySelector("#productPhotoButton").addEventListener("click",()=>O.click()),O.onchange=async()=>{const L=O.files[0];if(!L)return;const P=$.querySelector("#productPhotoPreview"),N=$.querySelector("#productPhotoBase64");P.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const R=await ro(L,800,800,"image/jpeg",.8),A=R.length*3/4,Y=1e3*1024;if(A>Y)throw new Error("A imagem é muito grande mesmo após a compressão.");P.src=R,N.value=R}catch(R){console.error("Erro ao processar imagem:",R),b("Erro de Imagem",R.message||"Não foi possível processar a imagem.","error"),P.src=S,N.value=I,O.value=""}},$.style.display="flex"}function Kn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),qa(),st()}function ei(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        ...
        </div>`;const r=document.getElementById("productFilterReport"),o=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join("")),o&&m.categories&&(o.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""))}async function ti(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await ur(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
        ...
        </section>`,ie&&(ge.removeEventListener("click",ie),ge.removeEventListener("input",ie),ge.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){st();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){ns(a.dataset.view);return}switch(a.dataset.action){case"new-product":no();break;case"edit-product":no(JSON.parse(a.dataset.product));break;case"manage-product-categories":Qn();break;case"generate-report":await ti();break;case"filter-stock":const r=a.dataset.filterType;oe=oe===r?"all":r,document.querySelectorAll(".indicator-card").forEach(o=>{o.classList.toggle("ring-2",o.dataset.filterType===oe),o.classList.toggle("ring-indigo-500",o.dataset.filterType===oe),o.classList.toggle("shadow-lg",o.dataset.filterType===oe)}),st();break}},ge.addEventListener("click",ie),ge.addEventListener("input",ie),ge.addEventListener("change",ie),Xe="products",oe="all",await dt()}const be=document.getElementById("content");let le=null,$t="list",H={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function oi(){$t==="list"?Jt():$t==="purchases"?(H.step=1,Ze()):$t==="history"&&is()}async function si(){try{const e=await Aa(m.establishmentId);return m.suppliers=e||[],H.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function ri(e){if(await j("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await Un(e),b("Sucesso","Fornecedor excluído.","success"),Ft("genericModal"),Jt()}catch(t){b("Erro","Erro ao excluir: "+t.message,"error")}}async function ni(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:m.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await Vn(a,s),b("Sucesso","Fornecedor atualizado!","success")):(await zn(s),b("Sucesso","Fornecedor criado!","success")),Ft("genericModal"),Jt()}catch(o){b("Erro","Erro ao salvar: "+o.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Jt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await si();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=m.suppliers.filter(o=>o.name.toLowerCase().includes(t)||o.contactName&&o.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let s='<div class="flex flex-col gap-2 md:hidden">';a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.category||"Geral"),d=v(o.contactName||"");s+=`
    ...
    `;a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.taxId||"Sem doc."),d=v(o.email||"-"),c=v(o.phone||"-"),u=v(o.category||"Geral");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=s+r}function ii(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",s=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),o=v(e.name),n=v(e.category||"Fornecedor"),i=v(e.contactName||""),l=v(e.phone||""),d=`
    ...
    `}async function is(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await Wn(m.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(o=>{const n=new Date(o.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=v(o.supplierName);a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function di(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;_({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",ni),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Ft("genericModal"))},50)}function ui(){be.innerHTML=`
    ...
    `,le&&(be.removeEventListener("click",le),be.removeEventListener("input",le),be.removeEventListener("change",le)),le=e=>{if(e.target.closest("#tab-btn-list")&&mt("list"),e.target.closest("#tab-btn-purchases")&&mt("purchases"),e.target.closest("#tab-btn-history")&&mt("history"),e.target.id==="toggle-quote-mode"&&(H.isQuoteMode=e.target.checked,Ze()),e.target.id==="supplierSearchInput"&&Jt(),e.target.closest("#btn-new-supplier")&&io(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),s=JSON.parse(a.dataset.supplier);ii(s)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&ri(t.dataset.id),a==="edit"&&io(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&ba(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=a),ba()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),s={};let r=!1;if(a.forEach(o=>{if(o.offsetParent===null||!o.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=o.querySelector("td:nth-child(2)"),d=o.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(o.querySelector(".qty-input").value),u=parseFloat(o.dataset.cost),g=o.querySelector(".supplier-select").value;if(g){if(!s[g]){const f=H.allSuppliers.find(h=>h.id===g);s[g]={info:f,items:[]}}s[g].items.push({name:i,qty:c,cost:u})}}),!r){b("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}H.finalOrders=s,H.step=2,Ze()}if(e.target.closest("#btn-back-step1")&&(H.step=1,Ze()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),o=parseFloat(a.dataset.total),n=H.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else b("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=m.establishmentId,a.disabled=!0,a.textContent="A processar...",$e(m.establishmentId).then(r=>{const o=r.purchaseConfig||null;return _n(s,o)}).then(()=>{b("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',b("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;j("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await Jn(s,m.establishmentId),b("Sucesso","Compra e financeiro excluídos.","success"),is()}catch(o){b("Erro","Erro ao excluir: "+o.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=H.finalOrders[s];r?ci(r,H.isQuoteMode):b("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);di(s)}},be.addEventListener("click",le),be.addEventListener("input",le),be.addEventListener("change",le),mt("list")}function mt(e){$t=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),oi()}const Xt=document.getElementById("content"),lo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let re=new Set,pt=null,Be=null;function mi(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function pi(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",s=v(t.name),r=v(t.specialty||"Especialidade"),o=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Zt(){const e=document.getElementById("genericModal");e.style.display="none",Be&&e.removeEventListener("click",Be)}async function gi(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=v(a.name),r=m.services||await Ee(m.establishmentId),o=m.professionals||await X(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",bi(a,r),fi(a),vi(a,o),xi(a)}function bi(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(w,S)=>{const I=S+1,$=I==s[1]?"selected":"",k=new Date(0,S).toLocaleString("pt-BR",{month:"long"});return`<option value="${I}" ${$}>${k.charAt(0).toUpperCase()+k.slice(1)}</option>`}).join(""),o=e.status||"active",n=v(e.name||""),i=v(e.specialty||""),l=v(e.phone||""),d=v(e.notes||"");a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${d}</textarea></div>`;const c=document.getElementById("profPhotoInput"),u=document.getElementById("profPhotoButton"),p=document.getElementById("profPhotoPreview"),g=document.getElementById("profPhotoBase64"),f=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,h=e.photo||"";u&&u.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const w=c.files[0];if(w){p.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const S=await _o(w,800,800,.8),$=S.length*3/4,k=1e3*1024;if($>k)throw new Error("A imagem é muito grande mesmo após a compressão.");p.src=S,g.value=S}catch(S){b("Erro de Imagem",S.message||"Não foi possível processar a imagem.","error"),p.src=f,g.value=h,c.value=""}}})}function fi(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',hi(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function vi(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500">${s.message}</p>`}}}function xi(e){const t=document.getElementById("genericModal");Be&&t.removeEventListener("click",Be),Be=async a=>{const s=a.target.closest("button[data-action]");if(!s){const o=a.target.closest(".tab-link");o&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),o.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(o.dataset.tab).classList.remove("hidden"));return}const r=s.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Zt();break;case"delete-professional":const o=s.dataset.id;if(await j("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await No(o),b("Sucesso!","Profissional excluído.","success"),Zt(),Pt()}catch(h){b("Erro",`Não foi possível excluir: ${h.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(h=>h.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(h=>{const w=h.querySelector('[data-field="active"]').dataset.day;u[w]={active:h.querySelector('[data-field="active"]').checked,start:h.querySelector('[data-field="start"]').value,end:h.querySelector('[data-field="end"]').value,breakStart:h.querySelector('[data-field="breakStart"]').value,breakEnd:h.querySelector('[data-field="breakEnd"]').value}});const p={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{p.id?(await Ct(p.id,p),b("Sucesso!","Profissional atualizado.","success")):(delete p.id,await Ao(p),b("Sucesso!","Profissional criado.","success")),Zt(),Pt()}catch(h){b("Erro",h.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const g=s.dataset.id;if(await j("Apagar Bloqueio","Tem certeza?"))try{await Ca(g),b("Bloqueio removido.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ke(e.id,h)}catch(h){b("Erro",h.message,"error")}break;case"batch-delete-blockage":const f=JSON.parse(s.dataset.ids);if(await j("Apagar em Lote",`Tem certeza que deseja apagar ${f.length} bloqueios com este motivo?`))try{await Vo(f),b("Bloqueios removidos.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ke(e.id,h)}catch(h){b("Erro",h.message,"error")}break}},t.addEventListener("click",Be)}function fa(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(re.size>0?(t.textContent=`${re.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function yi(){j("Excluir em Lote",`Tem certeza que deseja excluir ${re.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await or(Array.from(re)),b("Sucesso!",`${re.size} profissionais foram excluídos.`,"success"),re.clear(),fa(),Pt()}catch(t){b("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ue(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=mi();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),s=m.professionals.filter(r=>{const o=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return o&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=pi(s)}async function Pt(){re.clear(),Xt.innerHTML=`
        ...
        </section>`,pt&&Xt.removeEventListener("click",pt),pt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),s=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let o={};if(a.dataset.professional)try{o=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}gi(o);return}if(s){yi();return}const r=t.target.closest(".professional-checkbox");if(r){const o=r.dataset.id;r.checked?re.add(o):re.delete(o),Ue(),fa();return}},Xt.addEventListener("click",pt),document.getElementById("profSearchInput").addEventListener("input",Ue),document.getElementById("showInactiveProfToggle").addEventListener("change",Ue);const e=document.getElementById("professionalsList");m.professionals=null,m.services=null,Ue();try{const[t,a]=await Promise.all([X(m.establishmentId),Ee(m.establishmentId)]);m.professionals=t,m.services=a,Ue(),fa()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}let T={clients:[],establishment:null,searchTimeout:null,currentClient:null,history:[],historyLimit:10,filters:{hasLoyalty:!1,birthMonth:"",inactiveDays:""},showFilters:!1,selectionMode:!1,selectedClients:new Set};const ls=e=>e?e.replace(/\D/g,""):"",Bt=e=>{if(!e)return"";const t=e.replace(/\D/g,"");return t.length>10?t.replace(/^(\d\d)(\d{5})(\d{4}).*/,"($1) $2-$3"):t.replace(/^(\d\d)(\d{4})(\d{0,4}).*/,"($1) $2-$3")},wi=e=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0),va=e=>{if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?"-":t.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return"-"}},ki=()=>{T.showFilters=!T.showFilters;const e=document.getElementById("filter-panel");e&&e.classList.toggle("hidden",!T.showFilters)},ds=()=>{T.selectionMode=!T.selectionMode,T.selectedClients.clear(),ms(),Ra()},cs=e=>{T.selectedClients.has(e)?T.selectedClients.delete(e):T.selectedClients.add(e),Ra();const t=document.getElementById(`card-${e}`);if(t){const a=t.querySelector(".client-checkbox");a&&(a.checked=T.selectedClients.has(e)),T.selectedClients.has(e)?t.classList.add("ring-2","ring-indigo-500","bg-indigo-50"):t.classList.remove("ring-2","ring-indigo-500","bg-indigo-50")}},Ra=()=>{const e=document.getElementById("header-normal"),t=document.getElementById("header-selection"),a=document.getElementById("selected-count");T.selectionMode?(e.classList.add("hidden"),t.classList.remove("hidden"),a&&(a.textContent=`${T.selectedClients.size} selecionado(s)`)):(e.classList.remove("hidden"),t.classList.add("hidden"))},Si=async()=>{const e=T.selectedClients.size;if(e!==0&&await j("Excluir Clientes",`Tem certeza que deseja excluir ${e} clientes selecionados? Esta ação não pode ser desfeita.`)){const t=document.getElementById("btn-bulk-delete");t&&(t.disabled=!0,t.textContent="Excluindo...");try{const a=Array.from(T.selectedClients).map(s=>Uo(s));await Promise.all(a),b("Sucesso",`${e} clientes excluídos com sucesso!`,"success"),ds(),setTimeout(()=>pe(),500)}catch(a){console.error(a),b("Erro","Ocorreu um erro ao excluir alguns clientes.","error"),t&&(t.disabled=!1,t.textContent="Excluir")}}},$i=()=>{const e=document.getElementById("filter-loyalty"),t=document.getElementById("filter-month"),a=document.getElementById("filter-inactive");T.filters.hasLoyalty=e?e.checked:!1,T.filters.birthMonth=t?t.value:"",T.filters.inactiveDays=a?a.value:"",pe()},Ei=()=>{const e=document.getElementById("filter-loyalty"),t=document.getElementById("filter-month"),a=document.getElementById("filter-inactive");e&&(e.checked=!1),t&&(t.value=""),a&&(a.value=""),T.filters={hasLoyalty:!1,birthMonth:"",inactiveDays:""},pe()},us=async(e=null)=>{T.currentClient=e,T.historyLimit=10;const t=!e;if(_({title:"",contentHTML:(s=>`
        <div class="h-[80vh] flex flex-col bg-gray-50 rounded-lg overflow-hidden">
            <div class="bg-white border-b px-6 py-4 flex justify-between items-center shrink-0">
                <div>
                    ...
                    ${t?"":`<p class="text-sm text-gray-500">${Bt(s.phone)}</p>`}
                </div>
                ${t?"":`
    ...
    `)(e||{}),maxWidth:"max-w-3xl"}),window.switchTab=s=>Et(s,t),window.handleSave=Ii,window.handleDelete=Ci,window.loadMoreHistory=()=>{T.historyLimit+=10,Et("history",t)},!t&&e.id)try{if(typeof la=="function"){const s=await la(m.establishmentId,e.id);if(s){T.currentClient=s;const r=document.querySelector(".bg-indigo-100.text-indigo-700");r&&(r.textContent=`${s.loyaltyPoints||0} pts`)}}T.history=await Br(m.establishmentId,e.phone)}catch(s){console.error("Aviso: Não foi possível atualizar detalhes do cliente",s),T.history=[]}Et("details",t)},Et=(e,t)=>{const a=document.getElementById("modal-body");if(!a)return;document.querySelectorAll('[id^="tab-btn-"]').forEach(o=>{o.classList.remove("border-indigo-600","text-indigo-600"),o.classList.add("border-transparent","text-gray-500")});const s=document.getElementById(`tab-btn-${e}`);s&&(s.classList.add("border-indigo-600","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"));const r=T.currentClient||{};if(e==="details"){if(a.innerHTML=`
            <form id="form-client" class="space-y-4 max-w-lg mx-auto">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Telefone (WhatsApp)</label>
                    <input type="tel" name="phone" id="input-phone" value="${Bt(r.phone)}" 
        ...
        `,t){const o=document.getElementById("input-phone");o&&(o.oninput=n=>n.target.value=Bt(n.target.value))}}else if(e==="appointments"){const o=new Date,n=T.history.filter(i=>{const l=new Date(i.date);return i.type==="appointment"&&l>=o&&i.status!=="cancelled"&&i.status!=="cancelado"&&i.status!=="completed"&&i.status!=="finalizado"});if(n.sort((i,l)=>new Date(i.date)-new Date(l.date)),!n.length){a.innerHTML=`<div class="text-center py-10">
        ...
        `}else if(e==="history"){const o=[...T.history].filter(l=>l.type==="appointment"&&(l.status==="completed"||l.status==="finalizado")).sort((l,d)=>new Date(d.date)-new Date(l.date)),n=o.slice(0,T.historyLimit),i=o.length>T.historyLimit;if(!n.length){a.innerHTML='<div class="text-center text-gray-400 mt-10">Nenhum histórico de agendamento finalizado.</div>';return}a.innerHTML=`
            <div class="space-y-3">
                ${n.map(l=>`
            ...
            <div class="space-y-2">
                ${l.map(d=>{const c=d.costPoints||d.points||0,u=n>=c,p=d.reward||d.name;return`
                        <div class="flex justify-between items-center p-3 border rounded ${u?"bg-green-50 border-green-200":"bg-gray-50 opacity-70"}">
                            ...
                            <button onclick="window.handleRedeem('${c}', '${v(p)}')" ${u?"":"disabled"} 
        ...
        `,window.handleRedeem=async(d,c)=>{if(await j("Resgatar",`Trocar ${d} pontos por "${c}"?`))try{await Dr(m.establishmentId,r.phone,d,c),b("Sucesso","Resgate realizado!","success"),r.loyaltyPoints=(r.loyaltyPoints||0)-parseInt(d),T.history.unshift({type:"loyalty",description:`Resgate: ${c}`,date:new Date().toISOString(),value:-d,isPoints:!0,status:"completed"}),Et("loyalty",!1),pe()}catch(u){b("Erro",u.message||"Erro ao resgatar","error")}}}},Ii=async()=>{const e=document.getElementById("form-client"),t=new FormData(e),a=t.get("phone").replace(/\D/g,"");if(a.length<10){b("Erro","Telefone inválido","error");return}const s={name:t.get("name"),phone:a,email:t.get("email"),birthDate:t.get("birthDate"),notes:t.get("notes"),establishmentId:m.establishmentId};try{await Pr(s),b("Sucesso","Cliente salvo!","success"),document.getElementById("genericModal").style.display="none",pe()}catch(r){b("Erro","Erro ao salvar cliente","error"),console.error(r)}},Ci=async()=>{if(await j("Excluir","Tem certeza? Isso apagará o histórico deste cliente."))try{const e=T.currentClient.id||ls(T.currentClient.phone);await Uo(e),b("Sucesso","Cliente removido","success"),document.getElementById("genericModal").style.display="none",setTimeout(()=>pe(),500)}catch(e){b("Erro","Erro ao remover","error"),console.error(e)}},ms=()=>{const e=document.getElementById("clients-grid");if(e){if(e.innerHTML="",T.clients.length===0){e.innerHTML=`
        ...
        `;return}T.clients.forEach(t=>{const a=document.createElement("div"),s=t.id||ls(t.phone),r=T.selectedClients.has(s);a.id=`card-${s}`,a.className=`bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-all cursor-pointer flex items-center justify-between group relative ${r?"ring-2 ring-indigo-500 bg-indigo-50":""}`,a.onclick=l=>{l.target.type!=="checkbox"&&(T.selectionMode?cs(s):us(t))};const o=t.lastVisit||t.lastServiceDate||t.lastAppointmentDate;let n="Nunca visitou";if(o){const l=va(o);l&&l!=="-"&&(n=`Última visita: ${l.split(" ")[0]}`)}const i=T.selectionMode?`
        ...
        `:"";a.innerHTML=`
            ${i}
            <div class="flex items-center gap-4 ${T.selectionMode?"ml-6":""}">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">${Bt(t.phone)}</p>
        ...
        `,e.appendChild(a)})}},pe=async(e="")=>{const t=document.getElementById("clients-grid");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-10"><div class="loader"></div></div>');const a=e||document.getElementById("search-input")?.value||"";try{if(T.clients=await He(m.establishmentId,a,100,T.filters),T.filters.inactiveDays){const s=parseInt(T.filters.inactiveDays,10);if(!isNaN(s)&&s>0){const r=new Date,o=new Date(r.setDate(r.getDate()-s));T.clients=T.clients.filter(n=>{const i=n.lastVisit||n.lastServiceDate;if(!i)return!0;const l=new Date(i);return isNaN(l.getTime())?!0:l<o})}}ms(),Ra()}catch(s){console.error(s),t&&(t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao carregar lista.</p>')}},Li=async()=>{const e=document.getElementById("content");e.innerHTML=`
    ...
    `;const a=t.querySelector("#establishmentTimezone");if(e.timezone)a.value=e.timezone;else try{const o=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(a.options).some(i=>i.value===o)?a.value=o:a.value="America/Sao_Paulo"}catch{a.value="America/Sao_Paulo"}const s=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(Kt).forEach(o=>{const n=r[o]||{},i=Kt[o],l=n.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${l?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",o=>{const n=o.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const n={};Object.keys(Kt).forEach(l=>{n[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;Oe({workingHours:n,timezone:i},o)})}function Zi(e,t){const a=e.loyaltyProgram||{},s=a.type||"amount",r=a.pointsPerCurrency||10,o=a.pointsPerVisit||1;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([rt(m.establishmentId),nt(m.establishmentId)]),r=e.financialIntegration||{},o=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Le(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Le(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Le(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Le(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Le(a,o.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Le(s,o.defaultCostCenterId)}catch{b("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Oe(s,a)})}function el(e,t){const a="5516997859430",s=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${s}`;t.innerHTML=`
    ...
    `}function tl(e,t){const a="5516997859430",s=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),r=`https://wa.me/${a}?text=${s}`,o="sistemakairosagenda@gmail.com";t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function xs(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(_i).forEach(([r,o])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{s.value=r,xs(r,t)}),a.appendChild(i)}),s.value=e)}function ol(e,t){const a=t.querySelector("#slotIntervalContainer"),s=t.querySelector("#establishmentSlotInterval");if(!a||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(o=>{const n=o.value===e;return`<button type="button" data-value="${o.value}" 
    ...
    `,xe.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),ys()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":Ji(W,a);break;case"change-password":Wi(W,a);break;case"change-email":Gi(W,a);break;case"branding":Yi(W,a);break;case"booking":Qi(W,a);break;case"working-hours":Xi(W,a);break;case"loyalty":Zi(W,a);break;case"financial":await Ki(W,a);break;case"support":el(W,a);break;case"cancellation":tl(W,a);break;default:al(t?t.label:"Definições",a)}}async function ys(){if(xe.innerHTML=`
    ...
    `,xe.querySelector("#settings-menu-list").addEventListener("click",o=>{const n=o.target.closest("button[data-section]");n&&(o.preventDefault(),sl(n.dataset.section))});const r=xe.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",o=>{o.preventDefault(),te("my-profile-section")})}const et=document.getElementById("content");async function Ae(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await Ht(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;c.innerHTML+=$}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function rl(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||s,o=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Ot(i),t.reset(),b("Sucesso","Bloqueio adicionado com sucesso!","success"),Ae(a)}catch(l){b("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function nl(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return b("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||s,o=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Ot(u)});try{await Promise.all(d),b("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Ae(c)}catch(c){b("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function il(e){et.addEventListener("submit",t=>{t.target.id==="blockageForm"&&rl(t),t.target.id==="batchBlockageForm"&&nl(t)}),et.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Ae(e)}),et.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")te("profissionais-section");else if(s==="delete-blockage"){if(await j("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Ca(a.dataset.id),b("Sucesso","Bloqueio removido.","success"),Ae(e)}catch(o){b("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await j("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Vo(r),b("Sucesso",`${r.length} bloqueios removidos.`,"success"),Ae(e)}catch(n){b("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function ll(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){et.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);et.innerHTML=`
        <section>
        ...
        </section>`,il(t),await Ae(t);const r=document.getElementById("batchProfSelectionContainer");try{const o=await X(m.establishmentId);r.innerHTML=o.map(n=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const dl=e=>y(`/api/users/${e}`),cl=e=>y("/api/users",{method:"POST",body:JSON.stringify(e)}),ul=(e,t)=>y(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),ml=e=>y(`/api/users/${e}`,{method:"DELETE"}),pl=(e,t)=>y(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),gl=(e,t)=>y(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),fe=document.getElementById("content"),bl={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},fl={view:"Visualizar",create:"Criar",edit:"Editar"};let _e=null,Je=null;function vl(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const s=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${s}</p>`;return}e.sort((s,r)=>(s.status==="active"?-1:1)-(r.status==="active"?-1:1)),t.innerHTML=e.map(s=>{const r=JSON.stringify(s).replace(/'/g,"&apos;"),o=s.status==="active",n=m.professionals.find(c=>c.id===s.professionalId),i=n?n.name:"N/A",l=n?n.name.charAt(0):s.name.charAt(0),d=n?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function It(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=m.users:t=m.users.filter(a=>a.status==="active"),vl(t)}function hl(e={}){return Object.entries(bl).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,o=Object.entries(fl).map(([i,l])=>`
    ...
    `;const p=window.innerWidth<768,g=u.querySelector(".bg-white");if(p&&g){g.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const S=u.closest("section");S&&(S.style.padding="0",S.style.margin="0"),g.classList.add("p-4")}const f=u.querySelector("#userProfessionalId"),h=u.querySelector("#userPhotoPreview"),w=u.querySelector("#profPhotoName");if(f.addEventListener("change",S=>{const I=S.target.value,$=s(I),k=$?$.name:"Selecione um profissional",C=r(I,n);h.src=C.photoSrc,w.textContent=k,u.querySelector("#professionalPhotoUrl").value=C.photoUrl}),u.addEventListener("submit",async S=>{S.preventDefault();const I=e?.email,$=u.querySelector("#userEmail").value,k={};u.querySelectorAll('input[type="checkbox"]').forEach(O=>{const L=O.dataset.module,P=O.dataset.permission;k[L]||(k[L]={}),k[L][P]=O.checked});const C=u.querySelector("#userProfessionalId").value||null,F={name:u.querySelector("#userName").value,permissions:k,professionalId:C,establishmentId:m.establishmentId};try{c?(I!==$&&(F.email=$),await ul(e.id,F),b("Usuário atualizado com sucesso!","success")):(F.email=u.querySelector("#userEmail").value,F.password=u.querySelector("#userPassword").value,await cl(F),b("Usuário criado com sucesso!","success")),Dt()}catch(O){b(`Erro: ${O.message}`,"error")}}),c){const S=u.querySelector("#password-change-container"),I=S.querySelector('[data-action="show-password-form"]'),$=S.querySelector("#password-form"),k=$.querySelector('[data-action="save-password"]'),C=$.querySelector('[data-action="cancel-password-change"]');I.addEventListener("click",()=>{I.classList.add("hidden"),$.classList.remove("hidden")}),C.addEventListener("click",()=>{I.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}),k.addEventListener("click",async()=>{const F=$.querySelector("#userNewPassword").value;if(!F||F.length<6){b("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await j("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{k.disabled=!0,k.textContent="Aguarde...",await pl(e.id,F),b("Sucesso!","A senha do usuário foi alterada.","success"),I.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}catch(L){b("Erro",`Não foi possível alterar a senha: ${L.message}`,"error")}finally{k.disabled=!1,k.textContent="Salvar Nova Senha"}})}}async function xl(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([dl(m.establishmentId),X(m.establishmentId)]);m.users=t,m.professionals=a,It()}catch{b("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Dt(){fe.innerHTML=`
    ...
    `,_e&&fe.removeEventListener("click",_e),Je&&fe.removeEventListener("change",Je),_e=async e=>{if(!document.getElementById("user-list-view")){fe.removeEventListener("click",_e);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":uo();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));uo(s);break;case"back-to-list":Dt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await j("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await ml(r),b("Usuário excluído com sucesso!","success"),Dt()}catch(n){b(`Erro ao excluir: ${n.message}`,"error")}break}}},Je=async e=>{if(!document.getElementById("user-list-view")){fe.removeEventListener("change",Je);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")It();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await gl(a,s),b(`Usuário ${s==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=m.users.findIndex(o=>o.id===a);r>-1&&(m.users[r].status=s,It())}catch(r){b(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,It()}}},fe.addEventListener("click",_e),fe.addEventListener("change",Je),await xl()}const yl=document.getElementById("content");let mo={},ha=null;function wl(){Object.values(mo).forEach(e=>e?.destroy()),mo={}}function kl(e,t){if(!window.jspdf){b("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${t}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function po(e){const t=document.getElementById("genericModal"),a=v(e.client),s=v(e.items),r=v(e.responsavelCaixa||"N/A"),o=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function Sl(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);s.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ha.transactions[l];d&&po(d)})}),n.innerHTML=a.map((i,l)=>{const d=v(i.client),c=v(i.items),u=v(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ha.transactions[l];d&&po(d)})})}async function go(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r)return b("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,n=await Lr({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:o});ha=n,e.innerHTML=`
        ...
        `,Sl(n)}catch(o){b("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function $l(){wl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];yl.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",go),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${r}`;kl(o,"transactionsTable")});try{const s=await sn(m.establishmentId),r=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const n=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=v(o.closedByName||"N/A");r.innerHTML+=`<option value="${o.id}">${i} - ${n}</option>`})}catch{b("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await go()}const El=document.getElementById("content");let B={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},ea=null,gt=null,bt=null;function Fa(e){const t=new Map,a=[];return e&&(e.forEach(s=>t.set(s.id,{...s,children:[]})),t.forEach(s=>{s.parentId&&t.has(s.parentId)?t.get(s.parentId).children.push(s):a.push(s)})),a}function ws(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const s=(r,o=0)=>{const n="— ".repeat(o);return`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),i=t.querySelector("#itemParent"),l=c=>{const u=Fa(c);if(ws(n,u,e),i){i.innerHTML='<option value="">-- Nível Principal --</option>';const p=(g,f="",h=0)=>{const w=h>0?"— ".repeat(h):"";i.innerHTML+=`<option value="${g.id}">${w}${g.name}</option>`,g.children.forEach(S=>p(S,f+"— "))};u.forEach(g=>p(g))}};try{const c=await r(m.establishmentId);B[o]=c,l(c)}catch(c){console.error(c)}const d=t.querySelector("#hierarchyForm");d&&d.addEventListener("submit",async c=>{c.preventDefault();const u=t.querySelector("#itemName");if(!u)return;const p=u.value,g=i.value,f=a?Ti:Bi;try{await f({name:p,parentId:g||null,establishmentId:m.establishmentId});const h=await r(m.establishmentId);B[o]=h,l(h),d.reset(),await ke()}catch(h){b("Erro",`Não foi possível criar: ${h.message}`,"error")}})}function Il(e){const t=document.getElementById("cashFlowChart");if(!t)return;const a=t.getContext("2d");ea&&ea.destroy();const s=e.payables.map(r=>r*-1);ea=new Chart(a,{type:"bar",data:{labels:e.labels,datasets:[{label:"Receitas",data:e.receivables,backgroundColor:"rgba(74, 222, 128, 0.6)",borderColor:"rgba(34, 197, 94, 1)",borderWidth:1,yAxisID:"y"},{label:"Despesas",data:s,backgroundColor:"rgba(248, 113, 113, 0.6)",borderColor:"rgba(239, 68, 68, 1)",borderWidth:1,yAxisID:"y"},{label:"Saldo Acumulado",data:e.expectedBalance,type:"line",borderColor:"rgba(59, 130, 246, 1)",backgroundColor:"rgba(59, 130, 246, 0.2)",borderWidth:3,pointRadius:4,pointBackgroundColor:"rgba(59, 130, 246, 1)",fill:!0,tension:.1,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{x:{stacked:!0},y:{type:"linear",display:!0,position:"left",stacked:!0,title:{display:!0,text:"Movimentações (R$)"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Saldo Acumulado (R$)"},grid:{drawOnChartArea:!1}}},plugins:{tooltip:{callbacks:{label:function(r){let o=r.dataset.label||"";if(o&&(o+=": "),r.parsed.y!==null){const n=Math.abs(r.parsed.y);o+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(n)}return o}}}}}})}async function fo(){const e=document.getElementById("cash-flow-chart-container"),t=document.getElementById("cashFlowStartDate"),a=document.getElementById("cashFlowEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r){b("Atenção","Por favor, selecione as datas de início e fim.","error");return}e.innerHTML='<div class="loader mx-auto my-10"></div>';try{const o=await Vi(m.establishmentId,s,r);document.getElementById("cash-flow-chart-container")&&(e.innerHTML='<canvas id="cashFlowChart"></canvas>',Il(o))}catch(o){document.getElementById("cash-flow-chart-container")&&(e.innerHTML=`<p class="text-red-500 text-center">Erro ao carregar dados do gráfico: ${o.message}</p>`)}}function vo(){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const e=document.getElementById("genericModal"),t=new Date,a=new Date(t.getFullYear(),t.getMonth(),1).toISOString().split("T")[0],s=t.toISOString().split("T")[0];e.innerHTML=`
    ...
    `,e.style.display="flex"}function ft(e,t="all"){let a='<option value="all">Todos</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i=0)=>{const l=i>0?"— ".repeat(i):"",d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${l}${n.name}</option>`,n.children.forEach(c=>r(c,i+1))};return s(e).forEach(n=>r(n)),a}async function ke(){const e=document.getElementById("financial-content");if(!e)return;const t=document.getElementById("filterStartDate"),a=document.getElementById("filterEndDate");if(!t||!a)return;const s=t.value,r=a.value,o=document.getElementById("filterNaturezaId")?.value,n=document.getElementById("filterCostCenterId")?.value;if(!s||!r){try{const[d,c]=await Promise.all([rt(m.establishmentId),nt(m.establishmentId)]);if(!document.getElementById("financial-content"))return;B={...B,natures:d,costCenters:c},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=ft(B.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=ft(B.costCenters))}catch(d){b("Erro",`Não foi possível carregar os dados base: ${d.message}`,"error")}xa(),xo();return}const i=document.getElementById("payables-list"),l=document.getElementById("receivables-list");i&&(i.innerHTML='<div class="loader mx-auto"></div>'),l&&(l.innerHTML='<div class="loader mx-auto"></div>');try{const d={startDate:s,endDate:r,establishmentId:m.establishmentId};o&&o!=="all"&&(d.natureId=o),n&&n!=="all"&&(d.costCenterId=n);const[c,u,p,g]=await Promise.all([Ai(d),ji(d),rt(m.establishmentId),nt(m.establishmentId)]);if(!document.getElementById("financial-content"))return;const f=(u.previousBalance||0)-(c.previousBalance||0);B={...B,payables:c.entries||[],receivables:u.entries||[],natures:p||[],costCenters:g||[],previousBalance:f,filterNaturezaId:o,filterCostCenterId:n},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=ft(B.natures,B.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=ft(B.costCenters,B.filterCostCenterId)),xa(),xo()}catch(d){document.getElementById("financial-content")&&(b("Erro",`Não foi possível carregar os dados: ${d.message}`,"error"),e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function Tl(e,t,a=null){e.preventDefault();const s=e.target,r=s.querySelector('[name="status"]').checked,o=s.querySelector('[name="paymentDate"]').value,n=parseFloat(s.querySelector('[name="amount"]').value),i=parseInt(s.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(n)){b("Erro de Validação","O valor inserido é inválido.","error");return}if(r&&!o){b("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:s.querySelector('[name="description"]').value,amount:n,dueDate:s.querySelector('[name="dueDate"]').value,naturezaId:s.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:s.querySelector('[name="centroDeCustoId"]').value||null,notes:s.querySelector('[name="notes"]').value,status:r?"paid":"pending",paymentDate:r?o:null,installments:a?1:i,establishmentId:m.establishmentId};try{a?(await(t==="payable"?Ni(a,l):Hi(a,l)),b("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?Mi(l):Fi(l)),b("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await ke()}catch(d){b("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function Pl(e,t){if(await j("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?qi(t):Oi(t)),b("Sucesso","Lançamento excluído!","success"),await ke()}catch(s){b("Erro",`Falha ao excluir: ${s.message}`,"error")}}async function Bl(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Ri(t,a):zi(t,a)),b("Sucesso","Lançamento atualizado!","success"),await ke()}catch(s){b("Erro",`Falha ao atualizar status: ${s.message}`,"error")}}function ho(e){const t=B.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function xa(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(B.natures.map(i=>[i.id,i.name])),s=new Map(B.costCenters.map(i=>[i.id,i.name])),r=ho(B.payables),o=ho(B.receivables),n=(i,l)=>{const d=i.status==="paid",c=JSON.stringify(i).replace(/'/g,"&apos;"),u=i.naturezaId?a.get(i.naturezaId):"N/A",p=i.centroDeCustoId?s.get(i.centroDeCustoId):"N/A";let g=l==="payable"?"text-red-600":"text-green-600";const f=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",h=d?"Finalizado":"Pendente";return d&&(g="text-gray-500"),`
    ...
    `;if(a.innerHTML=`
        ...
        </div>`,a.style.display="flex",t){const p=a.querySelector('[name="naturezaId"]');p&&(p.value=t.naturezaId||"");const g=a.querySelector('[name="centroDeCustoId"]');g&&(g.value=t.centroDeCustoId||"")}const d=a.querySelector("#status"),c=a.querySelector("#payment-date-container"),u=a.querySelector('[name="paymentDate"]');t?.status==="paid"&&(d.checked=!0,c.classList.remove("hidden"),u.value=t.paymentDate||new Date().toISOString().split("T")[0]),d.addEventListener("change",()=>{c.classList.toggle("hidden",!d.checked),u.required=d.checked}),a.querySelector("#financial-form").addEventListener("submit",p=>Tl(p,e,t?.id))}async function Dl(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth()-1,1).toISOString().split("T")[0],s=e.toISOString().split("T")[0];B.startDate=a,B.endDate=s,B.currentFilter="pending",B.filterNaturezaId="all",B.filterCostCenterId="all",El.innerHTML=`
        <section>
    ...
    `;const r=document.getElementById("main-fab-btn"),o=document.getElementById("fab-menu");if(r&&o){r.addEventListener("click",h=>{h.stopPropagation(),o.classList.toggle("hidden"),r.classList.toggle("rotate-45")});const p=o.querySelector('button[data-action="open-modal"][data-type="receivable"]'),g=o.querySelector('button[data-action="open-modal"][data-type="payable"]'),f=o.querySelector('button[data-action="open-cash-flow-modal"]');p&&p.addEventListener("click",h=>{h.stopPropagation(),ta("receivable")}),g&&g.addEventListener("click",h=>{h.stopPropagation(),ta("payable")}),f&&f.addEventListener("click",h=>{h.stopPropagation(),vo()})}gt&&document.body.removeEventListener("click",gt),bt&&document.getElementById("genericModal").removeEventListener("click",bt);const n=()=>{const p=document.getElementById("filterStartDate"),g=document.getElementById("filterEndDate"),f=document.getElementById("filterNaturezaId"),h=document.getElementById("filterCostCenterId");if(!p)return;B.startDate=p.value,B.endDate=g.value,B.filterNaturezaId=f.value,B.filterCostCenterId=h.value;const w=document.getElementById("advanced-filters");w&&w.classList.contains("hidden")===!1&&window.innerWidth<768&&w.classList.add("hidden"),ke()},i=p=>{const g=p.target.closest("[data-status-filter]");if(!g)return;const f=g.dataset.statusFilter;B.currentFilter=f,document.querySelectorAll("[data-status-filter]").forEach(h=>{h.classList.remove("bg-blue-100","text-blue-800"),h.classList.add("bg-gray-100","text-gray-600")}),g.classList.remove("bg-gray-100","text-gray-600"),g.classList.add("bg-blue-100","text-blue-800"),xa()},l=p=>{const g=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),h=document.getElementById("btn-payables-view"),w=document.getElementById("btn-receivables-view");g&&(window.innerWidth>=1024&&B.currentListView===p||(p==="payables"?(g.classList.remove("hidden"),f.classList.add("hidden"),h&&(h.classList.remove("bg-gray-200"),h.classList.add("bg-red-100","border","border-red-500")),w&&(w.classList.remove("bg-green-100","border","border-green-500"),w.classList.add("bg-gray-200"))):(g.classList.add("hidden"),f.classList.remove("hidden"),h&&(h.classList.remove("bg-red-100","border","border-red-500"),h.classList.add("bg-gray-200")),w&&(w.classList.remove("bg-gray-200"),w.classList.add("bg-green-100","border","border-green-500"))),B.currentListView=p))};document.getElementById("applyDateFilterBtn").addEventListener("click",n),document.getElementById("filterNaturezaId").addEventListener("change",()=>{B.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{B.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(p=>{p.addEventListener("click",i)}),gt=p=>{const g=p.target.closest("button[data-action]");if(!g)return;const{action:f,type:h,id:w}=g.dataset;f==="edit"?ta(h,JSON.parse(g.dataset.item.replace(/&apos;/g,"'"))):f==="delete"?Pl(h,w):f==="mark-as-paid"?Bl(h,w):f==="manage-natures"?bo("nature"):f==="manage-cost-centers"?bo("cost-center"):f==="open-cash-flow-modal"?vo():f==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):f==="open-indicators-modal"?Cl():f==="open-settings-modal"?Ll():f==="toggle-list-view"&&l(g.dataset.list)},bt=p=>{const g=p.target.closest('button[data-action^="delete-"]');if(g){const f=g.dataset.action.split("-")[1];d(f,g.dataset.id)}},document.body.addEventListener("click",gt),document.getElementById("genericModal").addEventListener("click",bt);async function d(p,g){const f=p==="nature",h=f?Pi:Di,w=f?rt:nt,S=f?"natures":"costCenters",I=document.getElementById("hierarchyList");if(await j("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await h(g);const k=await w(m.establishmentId);B[S]=k,ws(I,Fa(k),p),await ke()}catch(k){b("Erro",`Não foi possível apagar: ${k.message}`,"error")}}const c=()=>{const p=window.innerWidth<1024,g=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),h=document.getElementById("list-toggle-buttons");g&&f&&(g.classList.remove("hidden"),f.classList.remove("hidden"),p?(g.classList.remove("lg:col-span-1"),f.classList.remove("lg:col-span-1"),h?.classList.remove("hidden"),l(B.currentListView)):(g.classList.add("lg:col-span-1"),f.classList.add("lg:col-span-1"),h?.classList.add("hidden"),g.classList.remove("hidden"),f.classList.remove("hidden")))};c(),window.addEventListener("resize",c);const u=document.querySelector(`[data-status-filter="${B.currentFilter}"]`);u&&(document.querySelectorAll("[data-status-filter]").forEach(p=>{p.classList.remove("bg-blue-100","text-blue-800"),p.classList.add("bg-gray-100","text-gray-600")}),u.classList.remove("bg-gray-100","text-gray-600"),u.classList.add("bg-blue-100","text-blue-800"));try{const p=await Ui(m.establishmentId),g=document.getElementById("summary-today-payables");g&&(g.textContent=`R$ ${p.totalPayables.toFixed(2)}`);const f=document.getElementById("summary-today-receivables");f&&(f.textContent=`R$ ${p.totalReceivables.toFixed(2)}`)}catch{}await ke()}const Ml=e=>y("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),Al=e=>y("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),Nl=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return y(`/api/commissions/stats?${a}`)},ql=(e={})=>{Object.keys(e).forEach(s=>(e[s]===void 0||e[s]===null||e[s]==="")&&delete e[s]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return y(a)},Rl=e=>y(`/api/commissions/report/${e}`,{method:"DELETE"}),Mt=new Date,yo=new Date(Mt.getFullYear(),Mt.getMonth(),1),M={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:yo.toISOString().split("T")[0],dashEndDate:Mt.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:yo.toISOString().split("T")[0],histEndDate:Mt.toISOString().split("T")[0],histProfessionalId:"all"};let vt=null;const Ge=document.getElementById("content");async function Fl(){try{M.professionals=await X(m.establishmentId)}catch(e){console.error("Erro profissionais",e)}Yl(),jl(),Wt(),Nt("dashboard")}function jl(){vt&&Ge.removeEventListener("click",vt),vt=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,s=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":Nt(t.dataset.tab);break;case"toggle-all-profs":Hl();break;case"back-to-filters":M.calculationResult=null,At(document.getElementById("commissions-content"));break;case"view-preview-items":Gl(r);break;case"save-final-report":zl();break;case"start-new-calc":Nt("calculator");break;case"print-receipt":Vl(s);break;case"delete-report":Ul(s);break;case"filter-dashboard":Wt();break;case"filter-history":ja();break}},Ge.addEventListener("click",vt),Ge.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Jl(t)}},Ge.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Ol())}}async function Wt(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(M.dashStartDate=e.value),t&&(M.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const s=await Nl(M.dashStartDate,M.dashEndDate);M.dashStats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0},M.currentTab==="dashboard"&&ks(document.getElementById("commissions-content"))}catch(s){console.error(s),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function ja(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(M.histStartDate=e.value),t&&(M.histEndDate=t.value),a&&(M.histProfessionalId=a.value);const s=document.getElementById("history-list-container");if(s){s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await ql({startDate:M.histStartDate,endDate:M.histEndDate,professionalId:M.histProfessionalId});M.historyData=r,Ss(s,r)}catch{s.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Hl(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function Ol(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(o=>o.value);if(e.length===0)return b("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),s=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");M.periodString=`${a} a ${s}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const o=await Ml(t);M.calculationResult=o.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),At(r)}catch(o){b("Erro",o.message,"error"),M.calculationResult=null,At(r)}}async function zl(){const e=M.calculationResult.length;if(await j("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=M.calculationResult.map(s=>{const r=s.items.map(o=>o.originalSaleId).filter(o=>o!=null);return Al({professionalId:s.professionalId,professionalName:s.professionalName,period:M.periodString,processedSalesIds:r,reportData:{...s,summary:{...s.summary,finalValue:s.finalValue,extraDebit:s.extraDebit||0,extraCredit:s.extraCredit||0,notes:s.notes||""}}})});await Promise.all(a),b("Sucesso","Pagamentos registrados!","success"),M.calculationResult=null,Wt(),Nt("history")}catch(a){b("Erro",a.message,"error")}}function Vl(e){const t=M.historyData.find(a=>a.id===e);t&&_l(t)}async function Ul(e){if(await j("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Rl(e),b("Sucesso","Registro removido.","success"),ja(),Wt()}catch(a){b("Erro",a.message,"error")}}function _l(e){const{jsPDF:t}=window.jspdf;if(!t)return b("Erro","PDF lib não carregada.","error");const a=new t,s=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",s,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const o=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,o,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Jl(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let s=0,r=0;if(t.forEach(o=>{o.value&&(s=parseFloat(o.value))}),a.forEach(o=>{o.value&&(r=parseFloat(o.value))}),M.calculationResult&&M.calculationResult[e]){const o=M.calculationResult[e];o.extraDebit=s,o.extraCredit=r,o.finalValue=o.summary.totalCommission-s+r,t.forEach(i=>{i!==document.activeElement&&(i.value=s||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${o.finalValue.toFixed(2)}`),Wl()}}function Wl(){const e=M.calculationResult.reduce((a,s)=>a+s.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function Gl(e){const t=M.calculationResult[e];if(!t)return;const a=t.items.map(s=>`
    ...
    `}function Ql(e){const t=M.professionals.map(a=>`<option value="${a.id}" ${M.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,M.historyData.length>0?Ss(document.getElementById("history-list-container"),M.historyData):ja()}function Ss(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const aa=document.getElementById("content");let Se={allPackages:[],catalogForModal:{services:[],products:[]}},ht=null,De=null;function Xl(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Zl(){const e=document.getElementById("packagesListContainer");if(e){if(Se.allPackages.length===0){e.innerHTML=`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:p}=d.dataset,f=(Se.catalogForModal[u+"s"]||[]).find(h=>h.id===p);f&&(e({...f,type:u}),i())}else(c||l.target===a)&&i()})}async function Ha(){aa.innerHTML=`
    ...
    `,ht&&aa.removeEventListener("click",ht),ht=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;j("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async o=>{if(o)try{await dn(r),b("Sucesso!","Pacote excluído.","success"),await Ha()}catch(n){b("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")ko(null);else if(a==="edit-package"){const s=JSON.parse(t.dataset.package);ko(s)}},aa.addEventListener("click",ht);try{const[e,t,a]=await Promise.all([Zo(m.establishmentId),Ee(m.establishmentId),jt(m.establishmentId)]);Se.allPackages=e,Se.catalogForModal={services:t.filter(s=>s.active),products:a},Zl()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const ed=document.getElementById("content");let td=null;async function ad(){const e=v(m.userName||"Usuário"),t=v(V.currentUser?.email||"E-mail não disponível"),a=m.userName?m.userName.charAt(0):"U";ed.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await od()}async function od(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await ar(t);td=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=v(a.name);e.innerHTML=`
            ...
            `,sd(a.id),document.getElementById("my-blocks-filter").addEventListener("change",o=>qt(a.id,o.target.value)),qt(a.id,"future")}else e.innerHTML=`
    ...
    `}function ya(){const e=at.filter(t=>!t.read).length;if(e>0?(ra.textContent=e,ra.classList.remove("hidden")):ra.classList.add("hidden"),at.length===0){$o.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}$o.innerHTML=at.map(t=>`
    ...
    `).join("")}function ud(e){tt&&tt();const t=ue(U,"establishments",e,"notifications"),a=Rt(t,ot("timestamp",">=",new Date),Po("timestamp","desc"));tt=Ns(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();at.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),b(o.title,o.message,"info",!0),ya();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(o.type==="cancellation"||o.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),Qo())}})},s=>{console.error("Erro no listener de notificações em tempo real:",s)})}function te(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=m.enabledModules?.[a]!==!1,o=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!r||!o){sa.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active"));return}}const s=dd[e];s?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),sa.innerHTML="",s(t)):sa.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`}async function md(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(o&&t&&t.classList.remove("hidden"),n&&a&&a.classList.remove("hidden"),!(!o&&!n))try{const i=await Tr();o&&s&&(s.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i)}}async function pd(e){try{console.log("[Nativo] Iniciando configuração de Push..."),ye.getPlatform()==="android"&&(await G.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let t=await G.checkPermissions();if(t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive!=="granted"){alert("ERRO: Permissão de notificações negada!");return}await G.register(),G.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const s=ce(U,"users",e);await wa(s,{fcmTokens:As(a.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(s){alert("Erro ao salvar no Banco: "+s.message),console.error("Erro ao salvar token FCM:",s)}}),G.addListener("registrationError",a=>{alert("FALHA DE REGISTO: "+JSON.stringify(a)),console.error("Erro no registo de push notifications:",a)}),G.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),b(a.title,a.body,"info",!0)}),G.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),te("agenda-section")})}catch(t){alert("Erro Fatal Push: "+t.message),console.log("Push Notifications não suportado/inicializado:",t)}}async function gd(){try{await Ps(V,Bs),console.log("Persistência LOCAL configurada na inicialização.")}catch(e){console.error("Erro ao definir persistência no main.js",e)}ye.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Gs(),So.addEventListener("click",e=>{e.stopPropagation(),yt.classList.toggle("hidden"),yt.classList.contains("hidden")||(at.forEach(t=>t.read=!0),ya())}),ld.addEventListener("click",()=>{Ys()}),na.addEventListener("click",e=>{e.stopPropagation(),ee.classList.toggle("active"),ee.classList.contains("active")?ee.classList.remove("hidden"):setTimeout(()=>ee.classList.add("hidden"),200)}),Eo&&Eo.addEventListener("click",e=>{e.preventDefault(),te("my-profile-section"),ee.classList.remove("active"),ee.classList.add("hidden")}),document.addEventListener("click",e=>{!yt.contains(e.target)&&e.target!==So&&yt.classList.add("hidden"),!ee.contains(e.target)&&e.target!==na&&ee.classList.contains("active")&&(ee.classList.remove("active"),setTimeout(()=>ee.classList.add("hidden"),200))}),Co(V,async e=>{if(e){if(console.log("Usuário detectado:",e.email),!ye.isNativePlatform()&&(console.log("Inicializando Web Push (PWA)..."),jo(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast"),s=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");setTimeout(()=>{t&&(t.style.display="block")},3500),a&&a.addEventListener("click",async()=>{await Ho()&&t&&(t.style.display="none")});const o=()=>{t&&(t.style.display="none")};s&&s.addEventListener("click",o),r&&r.addEventListener("click",o)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const s=await $e(a.establishmentId);m.enabledModules=s.modules,cd(s.themeColor||"indigo");let r=null,o=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=ce(U,"users",e.uid),c=await Lo(d);if(c.exists()){const u=c.data();r=a.role==="employee"?u.permissions||{}:null,o=u.name||o,n=u.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}m.userProfessionalId=n,ye.isNativePlatform()&&pd(e.uid);const i=o||e.email;Fs(a.establishmentId,s.name,r),na.textContent=i.charAt(0).toUpperCase(),rd.textContent=i,nd.textContent=e.email;const l=()=>{tt&&tt(),za(V).then(()=>window.location.href="/login.html")};id.addEventListener("click",d=>{d.preventDefault(),l()}),Ks(te,r,m.enabledModules),md(r),ud(a.establishmentId),ya(),xt.classList.add("fade-out"),oa.style.display="flex",setTimeout(()=>{xt.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{pr()},1500),te("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),xt.classList.add("fade-out"),setTimeout(()=>{xt.style.display="none"},500),oa.innerHTML=`
                ...
                `,oa.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{za(V).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}gd();Co(V,async e=>{if(e){await jo();const a="Notification"in window&&Notification.permission==="default",s=window.Capacitor&&window.Capacitor.isNativePlatform();if(a&&!s){const r=document.getElementById("toast-notification-request"),o=document.getElementById("btn-enable-toast"),n=document.getElementById("btn-deny-toast"),i=document.getElementById("btn-close-toast");setTimeout(()=>{r&&(r.style.display="block")},3500),o&&o.addEventListener("click",async()=>{await Ho()&&r&&(r.style.display="none")});const l=()=>{r&&(r.style.display="none")};n&&n.addEventListener("click",l),i&&i.addEventListener("click",l)}}});
