import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{initializeApp as vo}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import{getAuth as ho,EmailAuthProvider as yo,reauthenticateWithCredential as xo,verifyBeforeUpdateEmail as wo,updatePassword as ko,updateProfile as Eo,onAuthStateChanged as So,signOut as da}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{getFirestore as $o,doc as _a,getDoc as Io,updateDoc as Co,arrayUnion as Lo,collection as Bo,query as To,where as Mo,orderBy as Do,onSnapshot as Po}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";const Ao={apiKey:"AIzaSyAlJaPEW5-yOb-8wkB8EJZhAML2M2yI8Ao",authDomain:"kairos-system.firebaseapp.com",projectId:"kairos-system",storageBucket:"kairos-system.appspot.com",messagingSenderId:"603994960586",appId:"1:603994960586:web:30d2c030eed3c55eccfa33",measurementId:"G-SVHFXKV5EC"},Wa=vo(Ao),V=ho(Wa),Gt=$o(Wa);var Se;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Se||(Se={}));class Et extends Error{constructor(t,a,n){super(t),this.message=t,this.code=a,this.data=n}}const No=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},qo=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},n=a.Plugins=a.Plugins||{},o=()=>t!==null?t.name:No(e),s=()=>o()!=="web",r=m=>{const u=d.get(m);return!!(u?.platforms.has(o())||i(m))},i=m=>{var u;return(u=a.PluginHeaders)===null||u===void 0?void 0:u.find(b=>b.name===m)},l=m=>e.console.error(m),d=new Map,c=(m,u={})=>{const b=d.get(m);if(b)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),b.proxy;const f=o(),v=i(m);let k;const $=async()=>(!k&&f in u?k=typeof u[f]=="function"?k=await u[f]():k=u[f]:t!==null&&!k&&"web"in u&&(k=typeof u.web=="function"?k=await u.web():k=u.web),k),S=(L,M)=>{var W,ee;if(v){const te=v?.methods.find(z=>M===z.name);if(te)return te.rtype==="promise"?z=>a.nativePromise(m,M.toString(),z):(z,Xe)=>a.nativeCallback(m,M.toString(),z,Xe);if(L)return(W=L[M])===null||W===void 0?void 0:W.bind(L)}else{if(L)return(ee=L[M])===null||ee===void 0?void 0:ee.bind(L);throw new Et(`"${m}" plugin is not implemented on ${f}`,Se.Unimplemented)}},w=L=>{let M;const W=(...ee)=>{const te=$().then(z=>{const Xe=S(z,L);if(Xe){const Qe=Xe(...ee);return M=Qe?.remove,Qe}else throw new Et(`"${m}.${L}()" is not implemented on ${f}`,Se.Unimplemented)});return L==="addListener"&&(te.remove=async()=>M()),te};return W.toString=()=>`${L.toString()}() { [capacitor code] }`,Object.defineProperty(W,"name",{value:L,writable:!1,configurable:!1}),W},E=w("addListener"),B=w("removeListener"),D=(L,M)=>{const W=E({eventName:L},M),ee=async()=>{const z=await W;B({eventName:L,callbackId:z},M)},te=new Promise(z=>W.then(()=>z({remove:ee})));return te.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await ee()},te},N=new Proxy({},{get(L,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?D:E;case"removeListener":return B;default:return w(M)}}});return n[m]=N,d.set(m,{name:m,proxy:N,platforms:new Set([...Object.keys(u),...v?[f]:[]])}),N};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=o,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=r,a.registerPlugin=c,a.Exception=Et,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Fo=e=>e.Capacitor=qo(e),mt=Fo(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Yt=mt.registerPlugin;class Ja{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let n=!1;this.listeners[t]||(this.listeners[t]=[],n=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),n&&this.sendRetainedArgumentsForEvent(t);const r=async()=>this.removeListener(t,a);return Promise.resolve({remove:r})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,n){const o=this.listeners[t];if(!o){if(n){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}o.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:n=>{this.notifyListeners(a,n)}}}unimplemented(t="not implemented"){return new mt.Exception(t,Se.Unimplemented)}unavailable(t="not available"){return new mt.Exception(t,Se.Unavailable)}async removeListener(t,a){const n=this.listeners[t];if(!n)return;const o=n.indexOf(a);this.listeners[t].splice(o,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(n=>{this.notifyListeners(t,n)}))}}const ca=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),ma=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ro extends Ja{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(n=>{if(n.length<=0)return;let[o,s]=n.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=ma(o).trim(),s=ma(s).trim(),a[o]=s}),a}async setCookie(t){try{const a=ca(t.key),n=ca(t.value),o=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),r=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${n||""}${o}; path=${s}; ${r};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Yt("CapacitorCookies",{web:()=>new Ro});const Ho=async e=>new Promise((t,a)=>{const n=new FileReader;n.onload=()=>{const o=n.result;t(o.indexOf(",")>=0?o.split(",")[1]:o)},n.onerror=o=>a(o),n.readAsDataURL(e)}),jo=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(o=>o.toLocaleLowerCase()).reduce((o,s,r)=>(o[s]=e[t[r]],o),{})},Oo=(e,t=!0)=>e?Object.entries(e).reduce((n,o)=>{const[s,r]=o;let i,l;return Array.isArray(r)?(l="",r.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${s}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(r):r,l=`${s}=${i}`),`${n}&${l}`},"").substr(1):null,zo=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),o=jo(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(o.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[r,i]of Object.entries(e.data||{}))s.set(r,i);a.body=s.toString()}else if(o.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{s.append(l,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);a.body=s;const r=new Headers(a.headers);r.delete("content-type"),a.headers=r}else(o.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Vo extends Ja{async request(t){const a=zo(t,t.webFetchExtra),n=Oo(t.params,t.shouldEncodeUrlParams),o=n?`${t.url}?${n}`:t.url,s=await fetch(o,a),r=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};r.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await s.blob(),l=await Ho(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const c={};return s.headers.forEach((m,u)=>{c[u]=m}),{data:l,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Yt("CapacitorHttp",{web:()=>new Vo});const ae=Yt("PushNotifications",{}),p={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Uo(e,t,a){p.establishmentId=e,p.establishmentName=t,p.userPermissions=a}const Nt="https://kairos-service-603994960586.southamerica-east1.run.app";console.log("🚀 API configurada para Produção:",Nt);async function _o(){const e=V.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function y(e,t={}){const a=await _o();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const n=`${Nt}${e}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${n}`);try{const o=await fetch(n,{...t,headers:{...a,...t.headers}});if(!o.ok){const r=(await o.json().catch(()=>({message:o.statusText}))).message||`Erro na API: ${o.status}`;if(r.includes("FAILED_PRECONDITION")&&r.includes("requires an index")){const i=/(https:\/\/[^\s]+)/,l=r.match(i),d=l?l[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${o.status}) em ${n}:`,r),new Error(r)}return o.json()}catch(o){throw console.error(`Falha de rede ao tentar acessar ${n}:`,o.message),o.message.includes("Failed to fetch")||o.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Nt}. Verifique sua conexão com a internet.`):o}}const Wo=(e,t,a,n=null)=>{let o=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return n&&(o+=`&professionalId=${n}`),y(o)},Jo=(e,t,a)=>{const n=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return y(n)},Go=e=>y("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Xt=(e,t)=>y(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Yo=e=>y(`/api/appointments/${e}`,{method:"DELETE"}),Xo=e=>y(`/api/appointments/${e}/reopen`,{method:"POST"}),Qo=(e,t)=>y(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let q;async function Zo(){if(!q)try{q=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Ko(){if(!q){console.warn("AudioContext não inicializado. O som não será tocado.");return}q.state==="suspended"&&q.resume();const e=q.createOscillator(),t=q.createGain();e.connect(t),t.connect(q.destination),e.type="sine",e.frequency.setValueAtTime(800,q.currentTime),t.gain.setValueAtTime(0,q.currentTime),t.gain.linearRampToValueAtTime(.3,q.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,q.currentTime+.2),e.start(q.currentTime),e.stop(q.currentTime+.2)}function g(e,t,a="info",n=!1){const o=document.getElementById("toast-container");if(!o)return;n&&Ko();const s=document.createElement("div"),r={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${r[a]||r.info}`,s.innerHTML=`
    ...
    `;const l=o.querySelector("[data-close-modal]");l&&(l.onclick=r);const d=o.querySelector('[data-action="close-modal"]');return d&&(d.onclick=r),o.addEventListener("click",c=>{c.target.closest(".modal-content")||r()}),o.style.display="flex",{modalElement:o,close:r,setContent:i}}function es(){document.body.addEventListener("click",()=>{q||Zo()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const n=t.dataset.target;if(n){const o=document.getElementById(n);o&&(o.style.display="none")}}if(e.target.closest("[data-close-modal]")){const n=document.getElementById("genericModal");n&&(n.style.display="none")}})}async function ua(){const e=document.getElementById("cancellationListContainer");if(!e)return;e.innerHTML='<div class="loader mx-auto"></div>';const t=document.getElementById("cancelStartDate").value,a=document.getElementById("cancelEndDate").value;try{const n=await Jo(p.establishmentId,t,a);if(n.length===0){e.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}e.innerHTML=n.map(o=>`
        ...
        `).join("")}catch(n){e.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${n.message}</p>`}}function ts(){const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const n=`
    ...
    `,{modalElement:o}=j({title:"Histórico de Cancelamentos",contentHTML:n,maxWidth:"max-w-3xl"});o.querySelector("#searchCancellationsBtn").addEventListener("click",ua),ua()}const R=document.getElementById("sidebar"),pa=document.getElementById("sidebarToggle"),Me=document.getElementById("mainContent"),as=document.querySelectorAll(".sidebar-link"),ga=document.getElementById("hamburger-menu-btn"),$e=document.getElementById("mobile-overlay");function rt(e){!R||!Me||(R.classList.toggle("collapsed",e),Me.classList.toggle("sidebar-collapsed-shift",e))}function os(){!R||!$e||(R.classList.add("mobile-open"),$e.classList.add("visible"))}function Ze(){!R||!$e||(R.classList.remove("mobile-open"),$e.classList.remove("visible"))}function ss(){rt(!R.classList.contains("collapsed"))}function ns(e,t,a){if(!R||!Me)return;Me.classList.add("main-content-shift"),window.innerWidth>=768?rt(R.classList.contains("collapsed")):(Me.classList.remove("main-content-shift","sidebar-collapsed-shift"),Ze()),pa&&pa.addEventListener("click",o=>{o.stopPropagation(),ss()}),R.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&R.classList.contains("collapsed")&&rt(!1)}),R.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||rt(!0))}),ga&&ga.addEventListener("click",o=>{o.stopPropagation(),os()}),$e&&$e.addEventListener("click",o=>{o.stopPropagation(),Ze()});let n=0;R.addEventListener("touchstart",o=>{n=o.changedTouches[0].screenX},{passive:!0}),R.addEventListener("touchend",o=>{const s=o.changedTouches[0].screenX;n-s>50&&Ze()},{passive:!0}),as.forEach(o=>{const s=o.getAttribute("data-target"),r=s.replace("-section",""),i=a?.[r]!==!1,l=t===null||t[s]?.view===!0;if(!i||!l){o.style.display="none";return}o.style.display="flex",o.addEventListener("click",d=>{d.preventDefault(),s&&typeof e=="function"&&e(s),window.innerWidth<768&&Ze()})})}const _e=e=>{const t=e||p.establishmentId;return t?y(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},rs=(e,t)=>{const a=e||p.establishmentId;return a?y(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},is=(e,t)=>{const a=e||p.establishmentId;return a?y(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ls=(e,t)=>{const a=e||p.establishmentId;return a?y(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},_=e=>y(`/api/professionals/${e}`),ds=e=>y(`/api/professionals/details/${e}`),cs=e=>y("/api/professionals",{method:"POST",body:JSON.stringify(e)}),ms=(e,t)=>y(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),us=e=>y(`/api/professionals/${e}`,{method:"DELETE"}),ps=(e,t,a)=>y(`/api/analytics/${e}?startDate=${t}&endDate=${a}`),gs=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:n})=>{let o=`/api/reports/sales/${e}?startDate=${t}&endDate=${a}`;return n&&n!=="all"&&(o+=`&cashierSessionId=${n}`),y(o)},fs=(e,t,a)=>y(`/api/analytics/${e}/monthly-details?year=${t}&month=${a}`),bs=(e,t,a,n)=>{const o=`/api/analytics/${e}/daily-details?year=${t}&month=${a}&day=${n}`;return y(o)},vs=(e,t,a,n)=>{const o=`/api/analytics/${e}/professional-details?year=${t}&month=${a}&professionalId=${n}`;return y(o)},hs=()=>y("/api/reports/summary",{method:"GET"}),Ie=e=>y(`/api/services/${e}`),ys=e=>y("/api/services",{method:"POST",body:JSON.stringify(e)}),xs=(e,t)=>y(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),ws=e=>y(`/api/services/${e}`,{method:"DELETE"}),ks=(e,t)=>y(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Es=e=>y(`/api/services/stats/most-popular/${e}`),vt=(e,t,a,n="all")=>{const o=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${n}`;return y(o)},ht=e=>y("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Qt=e=>y(`/api/blockages/${e}`,{method:"DELETE"}),Ga=e=>y("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),We=e=>y(`/api/clients/${e}`),Zt=e=>y("/api/clients",{method:"POST",body:JSON.stringify(e)}),Ss=(e,t)=>y(`/api/clients/${e}`,{method:"PUT",body:JSON.stringify(t)}),$s=e=>y(`/api/clients/${e}`,{method:"DELETE"}),Is=(e,t,a)=>{const n=`/api/clients/history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return y(n)},Cs=(e,t,a)=>{const n=`/api/clients/loyalty-history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return y(n)},Ls=(e,t,a,n)=>y("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientName:t,clientPhone:a,rewardData:n})}),fa=document.getElementById("content"),Bs=window.location.origin;let ba=!1;const qt=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let Je=[],yt=[],je={},Z=[],C={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},x={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Ts(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Ya(e){const t=new Date(e);if(t.setHours(0,0,0,0),C.currentView==="week"&&C.weekViewDays===7){const a=t.getDay(),n=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(n))}return t}function ut(){const e=document.getElementById("profSelectorContainer"),t=C.profSearchTerm.toLowerCase();if(!e||!p.professionals)return;let a=p.professionals.filter(s=>C.showInactiveProfs||s.status!=="inactive");t&&(a=a.filter(s=>s.name.toLowerCase().includes(t)));const o=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=o.map(s=>{const r=C.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],l=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),d=s.status!=="inactive",c=qt[0],m=s.id!=="all"&&p.professionalColors.get(s.id)||c,u=s.photo||`https://placehold.co/64x64/${m.main?.replace("#","")||"E0E7FF"}/${m.light?.replace("#","")||"4F46E5"}?text=${l}`,b=s.id==="all"?"#e0e7ff":m.light,f=s.id==="all"?"#4f46e5":m.main,k=`border: 3px solid ${r?m.border:"transparent"}; box-shadow: ${r?"0 0 0 2px "+m.border:"none"};`;return`
            <div class="prof-card ${r?"selected":""} ${d?"":"opacity-50"}" 
        ...
        `}).join("")}function Ms(e,t,a,n,o){const s=(e||"").replace(/\D/g,""),r=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${n} para o dia ${r} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${s}?text=${d}`}function Ds(e){const t=document.getElementById("agenda-view");if(e.sort((n,o)=>new Date(n.startTime)-new Date(o.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(n=>{const o=new Date(n.startTime),s=new Date(n.endTime),r=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=p.professionalColors.get(n.professionalId)||{};if(n.type==="blockage")return`
                ...
                </div>`;const d=n.status==="completed",c=d?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",m=d?"Finalizado":"Aberto",u=JSON.stringify(n).replace(/'/g,"&apos;"),b=n.redeemedReward?.points>0,f=n.hasRewards&&!b,v=Ms(n.clientPhone,n.clientName,n.serviceName,n.professionalName,n.startTime);return`
            <div class="appointment-list-card" data-appointment='${u}' style="border-left-color: ${l.border};">
            ...
            </div>`}).join("");t.innerHTML=`<div class="list-view-container">${a}</div>`}function Kt(){return window.innerWidth<768&&C.currentView==="week"?3:C.weekViewDays}function Ps(e){const t=document.getElementById("agenda-view"),a=["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"],n=Ya(C.currentDate),o=Kt();let s=`<div class="grid divide-x divide-gray-200 min-h-[60vh]" style="grid-template-columns: repeat(${o}, minmax(0, 1fr));">`;for(let r=0;r<o;r++){const i=new Date(n);i.setDate(i.getDate()+r);const l=new Date,d=i.toDateString()===l.toDateString(),c=e.filter(u=>new Date(u.startTime).toDateString()===i.toDateString()).sort((u,b)=>new Date(u.startTime)-new Date(b.startTime));let m='<div class="p-1 space-y-2">';c.length>0?m+=c.map(u=>{const f=new Date(u.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),v=p.professionalColors.get(u.professionalId)||{bg:"#e5e7eb",border:"#9ca3af"};if(u.type==="blockage")return`
        ...
        `}s+="</div>",t.innerHTML=s}function As(){const e=p.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?Ds(e):Ps(e)}async function G(){const e=document.getElementById("agenda-view");if(!e)return;e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const n=document.getElementById("weekRange");if(C.currentView==="list")t=new Date(C.currentDate),t.setHours(0,0,0,0),a=new Date(C.currentDate),a.setHours(23,59,59,999),n.textContent=Ts(t);else{const o=Kt();t=Ya(new Date(C.currentDate)),a=new Date(t),a.setDate(t.getDate()+(o-1)),a.setHours(23,59,59,999),n.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const o=await Wo(p.establishmentId,t.toISOString(),a.toISOString(),C.selectedProfessionalId==="all"?null:C.selectedProfessionalId),r=(await vt(p.establishmentId,t.toISOString(),a.toISOString(),C.selectedProfessionalId)).map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=p.professionals?p.professionals.find(m=>m.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...o.map(l=>({...l,type:"appointment"})),...r];if(p.allEvents=i,ut(),As(),C.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${C.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),C.scrollToAppointmentId=null}}catch(o){g("Erro na Agenda",`Não foi possível carregar a agenda: ${o.message}`,"error"),e.innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>'}}async function Ns(){try{const[e,t,a,n]=await Promise.all([p.professionals&&p.professionals.length>0?Promise.resolve(p.professionals):_(p.establishmentId),p.services&&p.services.length>0?Promise.resolve(p.services):Ie(p.establishmentId),Z.length>0?Promise.resolve(Z):We(p.establishmentId),je.enabled!==void 0?Promise.resolve(null):_e(p.establishmentId)]);(!p.professionals||p.professionals.length===0)&&(p.professionals=e||[]),(!p.services||p.services.length===0)&&(p.services=t||[]),Z.length===0&&(Z=a||[]),n&&(je=n.loyaltyProgram||{enabled:!1}),p.professionals.forEach((o,s)=>{p.professionalColors.set(o.id,qt[s%qt.length])}),ut()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function Ft(e){e<1||e>4||(x.step=e,Rt(null,!0))}function Xa(e,t){const a=t.classList.contains("selected"),n=x.data.selectedServiceIds.indexOf(e);a?(t.classList.remove("selected","border-blue-500"),n>-1&&x.data.selectedServiceIds.splice(n,1)):(t.classList.add("selected","border-blue-500"),x.data.selectedServiceIds.push(e))}function Qa(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(o=>o.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const n=yt.find(o=>o.id===e);x.data.professionalId=e,x.data.professionalName=n?n.name:"N/A"}function qs(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(n=>n.classList.remove("selected")),t.classList.add("selected"),x.data.time=e)}async function va(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=x.data.professionalId,n=x.data.selectedServiceIds,o=document.getElementById("apptDate").value;x.data.date=o;const s=n.reduce((r,i)=>{const l=Je.find(d=>d.id===i);return r+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${s} min`,s===0||!a||!o){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{const r=n.join(","),i=await fetch(`${Bs}/api/availability?establishmentId=${p.establishmentId}&professionalId=${a}&serviceIds=${r}&date=${o}`);if(!i.ok)throw new Error("Falha na resposta da API de disponibilidade");let l=await i.json();const d=new Date;if(new Date(o+"T00:00:00").toDateString()===d.toDateString()){const m=d.getHours()*60+d.getMinutes();l=l.filter(u=>{const[b,f]=u.split(":").map(Number);return b*60+f>=m})}if(t.innerHTML="",l.length>0){if(l.forEach(m=>{const u=document.createElement("button");u.type="button",u.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${x.data.time===m?"selected":""}`,u.textContent=m,u.addEventListener("click",()=>qs(m,u)),t.appendChild(u)}),x.data.time){const m=t.querySelector(`[data-action="time-slot"][data-time="${x.data.time}"]`);m&&m.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function Fs(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:n}=x.data,{enabled:o,rewards:s,pointsPerCurrency:r}=je;if(!o||!t||!s||s.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const i=s.filter(d=>a>=d.points);let l=`
        <h4 class="text-md font-semibold text-gray-700 mb-2">🎁 Prêmios Disponíveis (${a} pontos)</h4>
    `;i.length>0?(l+='<div class="space-y-2">',l+=i.map(d=>{const c=n?.reward===d.reward;return`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",d=>{d.target.checked&&(x.data.redeemedReward=null)})}async function Rs(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!x.data.time||x.data.selectedServiceIds.length===0||!x.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const n=x.data.selectedServiceIds.map(d=>{const c=Je.find(m=>m.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[o,s]=x.data.time.split(":"),r=new Date(`${x.data.date}T${o}:${s}:00`),i={establishmentId:p.establishmentId,clientName:x.data.clientName,clientPhone:x.data.clientPhone,services:n,professionalId:x.data.professionalId,startTime:r.toISOString(),redeemedReward:x.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Xt(l,i):await Go(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",G()}catch(d){g(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function Hs(e){return`
    ...
    `}async function ha(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.toLowerCase().trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}const n=Z.filter(o=>o.name.toLowerCase().includes(a)||o.phone.includes(a));if(n.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=n.map(Hs).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(o=>{o.addEventListener("click",s=>{const r=o.dataset.clientName,i=o.dataset.clientPhone,l=Z.find(d=>d.phone===i&&d.name===r);if(x.data.clientName=r,x.data.clientPhone=i,l){const d=je,c=Math.min(...(d?.rewards||[]).map(m=>m.points));x.data.clientLoyaltyPoints=l.loyaltyPoints||0,x.data.clientHasRewards=d.enabled&&c!==1/0&&x.data.clientLoyaltyPoints>=c}else x.data.clientHasRewards=!1,x.data.clientLoyaltyPoints=0;document.getElementById("apptClientName").value=r,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(d=>d.classList.remove("selected","border-blue-500")),o.classList.add("selected","border-blue-500")})})}async function js(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),n={establishmentId:p.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!n.name||!n.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await Zt(n),Z.push({name:n.name,phone:n.phone,loyaltyPoints:0}),x.data.clientName=n.name,x.data.clientPhone=n.phone,x.data.clientHasRewards=!1,x.data.clientLoyaltyPoints=0,g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",Ft(1)}catch(o){g(`Erro ao cadastrar cliente: ${o.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function Os(){j({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",js)}function zs(){Os()}function Vs(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",n=`
    ...
    `;return{title:a,content:n}}function Us(){const e="Selecionar Serviço",t=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:e,content:t}}function _s(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${yt.map(a=>{const n=x.data.professionalId===a.id,o=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P";return`
    ...
    `;return{title:e,content:t}}function Ws(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,n=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,o=x.data.date||n,s=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:s}}function Js(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),n=Je.filter(o=>o.name.toLowerCase().includes(a));t.innerHTML=n.map(o=>{const s=x.data.selectedServiceIds.includes(o.id),r=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(o=>{o.addEventListener("click",()=>Xa(o.dataset.serviceId,o))})}function Gs(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),n=yt.filter(o=>o.name.toLowerCase().includes(a));t.innerHTML=n.map(o=>{const s=x.data.professionalId===o.id,r=o.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P";return`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(s=>{s.addEventListener("click",()=>{const r=parseInt(s.dataset.currentStep,10);if(r===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(x.data.clientName=i.value.trim(),x.data.clientPhone=l.value.trim(),!x.data.clientName||!x.data.clientPhone)return g("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(r===2){if(x.data.selectedServiceIds.length===0)return g("Atenção","Selecione pelo menos um serviço.","error")}else if(r===3&&!x.data.professionalId)return g("Atenção","Selecione um profissional.","error");Ft(r+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(s=>{s.addEventListener("click",()=>Ft(parseInt(s.dataset.currentStep,10)-1))});const o=a.querySelector("#appointmentForm");if(x.step===4&&o&&o.addEventListener("submit",Rs),a.style.display="flex",x.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Xa(i.dataset.serviceId,i))});const r=a.querySelector("#serviceSearchModalInput");r&&r.addEventListener("input",i=>Js(i.target.value))}if(x.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>Qa(i.dataset.professionalId,i))});const r=a.querySelector("#professionalSearchModalInput");r&&r.addEventListener("input",i=>Gs(i.target.value))}if(x.step===1){const s=a.querySelector("#clientSearchInput");s&&(s.addEventListener("input",i=>ha(i.target.value)),x.data.clientName&&x.data.clientPhone&&ha(`${x.data.clientName} ${x.data.clientPhone}`));const r=a.querySelector('[data-action="open-client-registration"]');r&&r.addEventListener("click",zs)}if(x.step===4){const s=a.querySelector("#apptDate");s&&s.addEventListener("change",va),va(),Fs()}}async function Za(e={}){C.currentDate=e.targetDate?new Date(e.targetDate):C.currentDate||new Date,C.scrollToAppointmentId=e.scrollToAppointmentId||null,C.profSearchTerm="",window.innerWidth<768&&(C.currentView="list"),fa.innerHTML=`
        <section>
        ...
        </section>`,document.querySelectorAll(".view-btn[data-view]").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(o=>o.classList.remove("active")),a.classList.add("active"),C.currentView=a.dataset.view;const n=document.getElementById("week-days-toggle");if(C.currentView==="week"){if(n.style.display="flex",window.innerWidth<768){C.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(s=>s.classList.remove("active"));const o=document.querySelector('.week-days-btn[data-days="3"]');o&&o.classList.add("active")}}else n.style.display="none";G()})}),document.querySelectorAll(".week-days-btn").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(n=>n.classList.remove("active")),a.classList.add("active"),C.weekViewDays=parseInt(a.dataset.days,10),G()})}),document.getElementById("todayBtn").addEventListener("click",()=>{C.currentDate=new Date,G()});const t=a=>{const n=parseInt(a.currentTarget.dataset.amount,10),o=C.currentView==="week"?Kt():1,s=new Date(C.currentDate);s.setDate(s.getDate()+n*o),C.currentDate=s,G()};document.getElementById("prevBtn").addEventListener("click",t),document.getElementById("nextBtn").addEventListener("click",t),document.getElementById("profSearchInput").addEventListener("input",a=>{C.profSearchTerm=a.target.value,ut()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",a=>{C.showInactiveProfs=a.target.checked,ut(),G()}),ba||(fa.addEventListener("click",async a=>{const n=a.target.closest("[data-action]");if(a.target.closest('[data-action="select-professional"]')){const l=a.target.closest('[data-action="select-professional"]').dataset.profId,d=C.selectedProfessionalId===l&&l!=="all";if(C.selectedProfessionalId=d?"all":l,l!=="all"){const c=document.getElementById("profSearchInput");c&&(c.value=""),C.profSearchTerm=""}await G();return}if(!n)return;const o=n.dataset.action;let s=null;const r=a.target.closest("[data-appointment]");switch(r&&(s=JSON.parse(r.dataset.appointment.replace(/&apos;/g,"'"))),o){case"new-appointment":Rt();break;case"edit-appointment":if(!s)return;if(s.status==="completed"){g("Atenção","Agendamentos finalizados não podem ser editados.","error");return}s.hasRewards&&!s.redeemedReward&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),Rt(s);break;case"delete-appointment":{const i=n.dataset.id;if(await T("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Yo(i),g("Agendamento apagado!","success"),G()}catch(d){g(`Não foi possível apagar: ${d.message}`,"error")}break}case"open-comanda":if(s){s.hasRewards&&!s.redeemedReward&&s.status!=="completed"&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const i=s.status==="completed"?"finalizadas":"em-atendimento",l={selectedAppointmentId:s.id,initialFilter:i};i==="finalizadas"&&(l.filterDate=s.startTime),A("comandas-section",l)}break}}),ba=!0),await Ns(),await G()}const Ys=e=>y(`/api/comandas/${e}`),Xs=e=>y("/api/sales",{method:"POST",body:JSON.stringify(e)}),Qs=e=>y(`/api/sales/${e}/reopen`,{method:"POST"}),Zs=e=>y(`/api/sales/${e}`,{method:"DELETE"}),ea=e=>y(`/api/products/${e}`),Ks=e=>y("/api/products",{method:"POST",body:JSON.stringify(e)}),en=(e,t)=>y(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),tn=e=>y(`/api/products/${e}`,{method:"DELETE"}),an=(e,t)=>y(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),on=({startDate:e,endDate:t,productId:a,categoryId:n})=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("productId",a),n&&n!=="all"&&o.append("categoryId",n),y(`/api/products/stock-history/report?${o.toString()}`)},Ka=()=>y("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),sn=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),y("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},nn=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),y(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},rn=()=>y("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),ln=e=>y(`/api/cashier/report/${e}`),eo=e=>y(`/api/packages/${e}`),dn=e=>y("/api/packages",{method:"POST",body:JSON.stringify(e)}),cn=(e,t)=>y(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),mn=e=>y(`/api/packages/${e}`,{method:"DELETE"});let h={allComandas:[],catalog:{services:[],products:[],packages:[]},clients:[],activeFilter:"atendimento",selectedComandaId:null,isCashierOpen:!1,activeCashierSessionId:null,paging:{page:1,limit:12,total:0}},fe=null,be=null;function un(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function ce(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function pn(){const e=new Date().toISOString().split("T")[0];be.innerHTML=`
    ...
    `}function gn(){const e=document.getElementById("cashier-controls");e&&(h.isCashierOpen?e.innerHTML=`
        ...
        `;return}const a={atendimento:"confirmed",finalizadas:"completed"}[h.activeFilter],n=h.allComandas.filter(o=>o.status===a);if(n.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',ya(e);return}e.innerHTML=n.map(o=>{const r=[...o.services||[],...o.comandaItems||[],...o.items||[]].reduce((m,u)=>m+(u.price||0),0),i=o.id===h.selectedComandaId,l=new Date(o.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),c=o.type==="walk-in"||o.id.startsWith("temp-")?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md">Agendado</span>';return`
    ...
    `;if(!h.isCashierOpen){e.innerHTML=`
        ...
        `;return}const a=h.allComandas.find(d=>d.id===h.selectedComandaId);if(!a){e.innerHTML=`
            <div class="hidden lg:flex flex-col items-center justify-center h-full text-center text-gray-400">
        ...
        `;return}const n=[...a.services||[],...a.comandaItems||[],...a.items||[]],o=a.status==="completed",s=a.type==="walk-in"||a.id.startsWith("temp-"),r=s?"":`<button data-action="go-to-appointment" data-id="${a.id}" data-date="${a.startTime}" 
           ...
           </button>`,i=n.reduce((d,c)=>{const m=`${c.type}-${c.id||c.name}`;if(!d[m]){const u=(a.services||[]).some(b=>b.id===c.id&&b.name===c.name);d[m]={...c,quantity:0,isOriginalService:u&&c.type==="service"}}return d[m].quantity+=1,d},{}),l=Object.values(i).reduce((d,c)=>d+(c.price||0)*c.quantity,0);e.innerHTML=`
                ...
                ${Object.values(i).map(d=>`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            ${o?"":`<button data-action="remove-item" data-item-id="${d.id}" data-item-type="${d.type}" class="text-red-400 hover:text-red-600 p-1 rounded-full hover:bg-red-50"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>`}
                        </div>
                    </div>
                `).join("")}
    ...
    `}function fn(){j({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",bn)}async function bn(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector('button[type="submit"]'),n={establishmentId:p.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim()||null,phone:t.querySelector("#regClientPhone").value.trim(),dob:`${t.querySelector("#regClientDobDay").value.trim()}/${t.querySelector("#regClientDobMonth").value.trim()}`,notes:t.querySelector("#regClientNotes").value.trim()||null};if(!n.name||!n.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{const o=await Zt(n);h.clients.push({id:o.id,...n}),g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",to(o.id)}catch(o){g(`Erro ao cadastrar cliente: ${o.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar Cliente"}}function vn(){if(!h.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:e,close:t}=j({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{let o="";const s=e.querySelector("#add-item-content"),r={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},i=()=>{const l=o.toLowerCase(),d=m=>m.filter(u=>u.name.toLowerCase().includes(l)),c={"modal-service-list":{items:d(h.catalog.services),type:"service"},"modal-product-list":{items:d(h.catalog.products),type:"product"},"modal-package-list":{items:d(h.catalog.packages),type:"package"}};for(const[m,{items:u,type:b}]of Object.entries(c)){const f=s.querySelector(`#${m}`);f&&(f.innerHTML=u.map(v=>`
            ...
            </div>`,i(),s.querySelector("#item-search-input").addEventListener("input",l=>{o=l.target.value,i()})},n=o=>{let s=1;const r=e.querySelector("#add-item-content"),i=()=>{document.getElementById("quantity-display").textContent=s,document.getElementById("quantity-minus-btn").disabled=s<=1};r.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await kn(o,s),t()}};e.addEventListener("click",o=>{const s=o.target.closest('[data-action="select-item-for-quantity"]'),r=o.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:i,itemId:l}=s.dataset,c=(h.catalog[i+"s"]||[]).find(m=>m.id===l);c&&n({...c,type:i})}else r&&a()}),a()}async function to(e=null){if(!h.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!h.clients||h.clients.length===0)try{h.clients=await We(p.establishmentId)}catch{g("Erro","Não foi possível carregar dados de clientes.","error");return}if(!p.professionals||p.professionals.length===0)try{p.professionals=await _(p.establishmentId)}catch{g("Erro","Não foi possível carregar dados de profissionais.","error");return}const t=h.clients.map(r=>{const i=r.id===e?"selected":"";return`<option value="${r.id}" ${i}>${r.name} - ${r.phone}</option>`}).join(""),a=p.professionals.map(r=>`<option value="${r.id}">${r.name}</option>`).join(""),n=`
    ...
    `,{modalElement:o}=j({title:"Nova Venda Avulsa",contentHTML:n,maxWidth:"max-w-md"});o.querySelector("#new-sale-form").addEventListener("submit",$n);const s=o.querySelector('[data-action="new-client-from-sale"]');s&&s.addEventListener("click",r=>{r.preventDefault(),o.style.display="none",fn()})}function hn(){if(!h.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const e=h.allComandas.find(d=>d.id===h.selectedComandaId);if(!e)return;const a=[...e.services||[],...e.comandaItems||[],...e.items||[]].reduce((d,c)=>d+(c.price||0),0);let n=[],o={remainingAmount:a,selectedMethod:"dinheiro",installments:1,amountReceived:""};const s=()=>{const d=document.getElementById("payment-list"),c=document.getElementById("remaining-amount"),m=document.getElementById("finalize-checkout-btn"),u=document.getElementById("change-container"),b=document.getElementById("installments-container"),f=document.getElementById("payment-value"),v=document.getElementById("payment-controls"),k=n.reduce((S,w)=>S+w.value,0);o.remainingAmount=a-k,d.innerHTML=n.map((S,w)=>`
            ...
            </div>`).join(""),o.remainingAmount<=.001?(c.textContent="Total Pago!",c.className="text-lg font-bold text-center mb-4 text-green-600",f.value="",m.disabled=!1,v&&(v.style.display="none")):(c.textContent=`Faltam: R$ ${o.remainingAmount.toFixed(2)}`,c.className="text-lg font-bold text-center mb-4 text-red-600",f.value=o.remainingAmount.toFixed(2),m.disabled=!0,v&&(v.style.display="block")),document.querySelectorAll(".payment-method-btn").forEach(S=>{S.classList.toggle("ring-2",S.dataset.method===o.selectedMethod),S.classList.toggle("ring-offset-2",S.dataset.method===o.selectedMethod)}),b.style.display=["credito","crediario"].includes(o.selectedMethod)?"block":"none",u.style.display=o.selectedMethod==="dinheiro"&&o.remainingAmount>0?"block":"none";const $=parseFloat(o.amountReceived)-o.remainingAmount;document.getElementById("change-value").textContent=`R$ ${$>0?$.toFixed(2):"0.00"}`},r=()=>{const d=document.getElementById("payment-value");let c=parseFloat(d.value);if(isNaN(c)||c<=0){g("Valor Inválido","Insira um valor de pagamento válido e maior que zero.","error");return}if(c>o.remainingAmount+.001){g("Valor Inválido","O valor excede o saldo restante.","error");return}const m={method:o.selectedMethod,value:c};["credito","crediario"].includes(o.selectedMethod)&&o.installments>1&&(m.installments=o.installments),n.push(m),o.selectedMethod="dinheiro",o.installments=1,document.getElementById("installments-select").value=1,s()},i=`
        ...
        <div id="payment-controls" class="space-y-4 border-t pt-4">
            ...
            <div id="installments-container" class="hidden"><label class="text-sm font-medium">Parcelas</label><select id="installments-select" class="w-full p-2 border rounded-md bg-white mt-1">${Array.from({length:12},(d,c)=>`<option value="${c+1}">${c+1}x</option>`).join("")}</select></div>
    ...
    `,{modalElement:l}=j({title:"Finalizar Pagamento",contentHTML:i,maxWidth:"max-w-md"});document.getElementById("payment-value").value=o.remainingAmount.toFixed(2),l.addEventListener("click",d=>{const c=d.target.closest(".payment-method-btn");c&&(o.selectedMethod=c.dataset.method,o.installments=1,document.getElementById("installments-select").value=1,s()),d.target.closest("#add-payment-btn")&&r(),d.target.closest('[data-action="remove-payment"]')&&(n.splice(parseInt(d.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),s()),d.target.closest("#finalize-checkout-btn")&&Sn(e,a,n)}),l.addEventListener("change",d=>{d.target.id==="installments-select"&&(o.installments=parseInt(d.target.value,10))}),l.addEventListener("input",d=>{d.target.id==="amount-received"&&(o.amountReceived=d.target.value,s())}),s()}async function yn(){const e=`
    ...
    `,{modalElement:t}=j({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const n=document.getElementById("initial-amount"),o=n.value.trim(),s=document.getElementById("cashier-notes").value.trim(),r=parseFloat(o);if(o===""||isNaN(r)||r<0){g("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),n.focus();return}try{const i={establishmentId:p.establishmentId,initialAmount:parseFloat(r.toFixed(2))};s&&(i.notes=s);const l=await sn(i);h.isCashierOpen=!0,h.activeCashierSessionId=l.id,await ta(),document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto com valor inicial de R$ ${r.toFixed(2)}`,"success")}catch(i){g("Erro",`Não foi possível abrir o caixa: ${i.message}`,"error")}})}async function xn(){const e=h.activeCashierSessionId;if(e)try{const t=await ln(e),a=`
        ...
        `,{modalElement:n}=j({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});n.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const s=parseFloat(document.getElementById("final-amount").value);if(isNaN(s)||s<0){g("Valor Inválido","Insira um valor final válido.","error");return}try{await nn(e,s),h.isCashierOpen=!1,h.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await ta(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(r){g("Erro",`Não foi possível fechar o caixa: ${r.message}`,"error")}})}catch(t){g("Erro",`Não foi possível carregar o relatório de fecho: ${t.message}`,"error")}}async function wn(e){h.activeFilter!==e&&(h.activeFilter=e,h.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),ce(),await X(),h.selectedComandaId=null,U())}function Ht(e){h.selectedComandaId=e,re(),un(),U()}async function kn(e,t){const a=h.allComandas.find(o=>o.id===h.selectedComandaId);if(!a)return;const n=Array(t).fill(0).map(()=>({id:e.id,name:e.name,price:e.price,type:e.type}));if(a.comandaItems=a.comandaItems||[],a.comandaItems.push(...n),a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),U(),re();return}try{await Xt(a.id,a),g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),U(),re()}catch(o){g("Erro",`Não foi possível adicionar o item: ${o.message}`,"error"),a.comandaItems.splice(a.comandaItems.length-t,t)}}async function En(e,t){const a=h.allComandas.find(s=>s.id===h.selectedComandaId);if(!a)return;let n=!1,o=(a.comandaItems||[]).findIndex(s=>s.id===e&&s.type===t);if(o>-1)a.comandaItems.splice(o,1),n=!0;else{let s=(a.services||[]).findIndex(r=>r.id===e);if(s>-1)a.services.splice(s,1),n=!0;else{let r=(a.items||[]).findIndex(i=>i.id===e&&i.type===t);r>-1&&(a.items.splice(r,1),n=!0)}}if(n){if(a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso","Item removido!","success"),U(),re();return}try{await Xt(a.id,a),g("Sucesso","Item removido!","success"),U(),re()}catch(s){g("Erro",`Não foi possível remover o item: ${s.message}`,"error"),await X()}}}async function Sn(e,t,a){const n=e.type==="appointment",o=[...e.services||[],...e.comandaItems||[],...e.items||[]],s={payments:a,totalAmount:t,items:o,cashierSessionId:h.activeCashierSessionId};try{n?await Qo(e.id,s):(s.clientName=e.clientName,s.professionalId=e.professionalId,s.clientPhone=e.clientPhone,await Xs(s)),g("Sucesso!","Venda finalizada com sucesso!","success"),document.getElementById("genericModal").style.display="none",ce(),h.selectedComandaId=null,await X()}catch(r){g("Erro no Checkout",r.message,"error")}}async function $n(e){e.preventDefault();const t=document.getElementById("new-sale-client").value,a=document.getElementById("new-sale-professional").value,n=h.clients.find(r=>r.id===t),o=p.professionals.find(r=>r.id===a);if(!n||!o){g("Erro","Selecione um cliente e um profissional válidos.","error");return}const s={id:`temp-${Date.now()}`,type:"walk-in",clientName:n.name,clientPhone:n.phone,professionalId:o.id,professionalName:o.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};h.allComandas.unshift(s),h.selectedComandaId=s.id,document.getElementById("genericModal").style.display="none",Ht(s.id)}async function X(){const e=document.getElementById("comandas-list");e.innerHTML='<div class="loader mx-auto mt-10"></div>';const t=h.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=await Ka();if(h.isCashierOpen=!!a,h.activeCashierSessionId=a?a.id:null,gn(),!h.isCashierOpen&&h.activeFilter==="atendimento"){re(),U();return}const n=await Ys(p.establishmentId,t,h.paging.page,h.paging.limit);if(h.allComandas=n.data||n,h.paging.total=n.total||n.length,h.catalog.services.length===0){const[o,s,r,i,l]=await Promise.all([Ie(p.establishmentId),ea(p.establishmentId),eo(p.establishmentId),We(p.establishmentId),_(p.establishmentId)]);h.catalog={services:o,products:s,packages:r},h.clients=i,p.professionals=l}re(),h.selectedComandaId,U()}catch(a){g("Erro de Carregamento",`Não foi possível carregar os dados: ${a.message}`,"error"),e.innerHTML=`<p class="text-red-500 p-4">${a.message}</p>`}}async function ta(e={}){be=document.getElementById("content");try{const t=await Ka();h.isCashierOpen=!!t,h.activeCashierSessionId=t?t.id:null}catch(t){console.error("Erro ao verificar caixa:",t),h.isCashierOpen=!1}h.selectedComandaId=e.selectedAppointmentId||null,pn(),fe&&(be.removeEventListener("click",fe),be.removeEventListener("change",fe)),fe=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(t.target.id==="filter-date"&&h.activeFilter==="finalizadas"){h.paging.page=1,await X();return}if(a){if(a.matches("[data-filter]"))wn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}Ht(a.dataset.comandaId)}else if(a.matches("[data-action]")){const n=a.dataset.action,o=a.dataset.id||h.selectedComandaId;switch(n){case"back-to-list":{ce(),h.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(s=>s.classList.remove("selected")),U();break}case"new-sale":to();break;case"add-item":vn();break;case"checkout":hn();break;case"open-cashier":yn();break;case"close-cashier":await xn();break;case"view-sales-report":A("sales-report-section");break;case"remove-item":await En(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await T("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await Xo(o);const r=h.allComandas.findIndex(i=>i.id===o);r!==-1&&(delete h.allComandas[r].transaction,delete h.allComandas[r].cashierSessionId,delete h.allComandas[r].redeemedReward,h.allComandas[r].status="confirmed"),h.selectedComandaId=null,ce(),g("Sucesso!","Comanda reaberta para edição.","success"),await X()}catch(r){g("Erro",`Não foi possível reabrir: ${r.message}`,"error")}break}case"reopen-walk-in":{if(await T("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await Qs(o),g("Sucesso!","Venda revertida."),ce(),h.selectedComandaId=null,await X()}catch(r){g("Erro",`Não foi possível reabrir: ${r.message}`,"error")}break}case"go-to-appointment":{const s=a.dataset.id,r=a.dataset.date;A("agenda-section",{scrollToAppointmentId:s,targetDate:new Date(r)});break}case"delete-walk-in":{if(await T("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(o.startsWith("temp-"))h.allComandas=h.allComandas.filter(r=>r.id!==o),h.selectedComandaId=null,re(),U(),g("Sucesso","Venda avulsa removida.","success"),ce();else try{await Zs(o),g("Sucesso","Venda avulsa excluída com sucesso.","success"),h.selectedComandaId=null,ce(),await X()}catch(r){g("Erro",`Não foi possível excluir: ${r.message}`,"error")}break}}}}},be.addEventListener("click",fe),be.addEventListener("change",fe),e.initialFilter&&(h.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(h.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${h.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",h.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await X(),h.selectedComandaId&&Ht(h.selectedComandaId)}const xt=document.getElementById("content");let ne={},In=null,Cn=null,P={year:null,month:null,monthName:null,professionalId:null,professionalName:null},xa=[];const ve=["#4f46e5","#22c55e","#f97316","#06b6d4","#e11d48","#6366f1","#84cc16","#f59e0b"];function aa(){Object.values(ne).forEach(e=>e?.destroy()),ne={}}function Ln(e){const t=document.getElementById("kpi-revenue"),a=document.getElementById("kpi-transactions"),n=document.getElementById("kpi-popular-item");t&&(t.textContent=`R$ ${e.totalRevenue.toFixed(2)}`),a&&(a.textContent=e.totalTransactions),n&&(n.textContent=e.mostPopularItem||"N/A"),document.querySelectorAll(".kpi-loader").forEach(o=>o.classList.add("hidden")),document.querySelectorAll(".kpi-value").forEach(o=>o.classList.remove("hidden"))}function Bn(e){const t="Detalhes da Transação",a=`
    ...
    `;j({title:t,contentHTML:a,maxWidth:"max-w-md"})}async function Oe(e,t,a){P={year:e,month:t,monthName:a},xt.innerHTML=`
        <section>
        ...
        </section>`,document.getElementById("backToMainBtn").addEventListener("click",jt);try{const n=await fs(p.establishmentId,e,t);Cn=n,document.querySelector(".loader-container").classList.add("hidden"),document.getElementById("monthly-details-view").classList.remove("hidden");const o=n.revenueByDay.map(u=>u.day),s=n.revenueByDay.map(u=>u.revenue),r=n.salesByProfessional.map(u=>u.name),i=n.salesByProfessional.map(u=>u.count),l=n.topItems.map(u=>u.name),d=n.topItems.map(u=>u.count),c=["Agendamentos","Vendas Avulsas"],m=[n.revenueByTransactionType.appointment,n.revenueByTransactionType.sales];aa(),ne.monthlyRevenue=new Chart(document.getElementById("monthlyRevenueChart").getContext("2d"),{type:"bar",data:{labels:o,datasets:[{label:"Receita Diária",data:s,backgroundColor:ve[0]}]},options:{responsive:!0,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0}},onClick:(u,b)=>{if(b.length>0){const f=o[b[0].index];Tn(e,t,f)}}}}),ne.salesByProfessional=new Chart(document.getElementById("salesByProfessionalChart").getContext("2d"),{type:"pie",data:{labels:r,datasets:[{label:"Vendas",data:i,backgroundColor:ve,hoverOffset:16}]},options:{responsive:!0,plugins:{legend:{position:"right"}},onClick:(u,b)=>{if(b.length>0){const f=b[0].index,v=n.salesByProfessional[f];v&&Mn(e,t,v.id,v.name)}}}}),ne.topItems=new Chart(document.getElementById("topItemsChart").getContext("2d"),{type:"bar",data:{labels:l,datasets:[{label:"Itens Vendidos",data:d,backgroundColor:ve[2]}]},options:{indexAxis:"y",responsive:!0,plugins:{legend:{display:!1}},scales:{x:{beginAtZero:!0}}}}),ne.revenueByType=new Chart(document.getElementById("revenueByTypeChart").getContext("2d"),{type:"doughnut",data:{labels:c,datasets:[{label:"Receita por Tipo",data:m,backgroundColor:[ve[1],ve[3]],hoverOffset:16}]},options:{responsive:!0,plugins:{legend:{position:"right"}}}})}catch(n){g("Erro",`Não foi possível carregar os detalhes do mês: ${n.message}`,"error"),jt()}}async function Tn(e,t,a){P={...P,day:a},xt.innerHTML=`
        <section>
            <div class="flex justify-between items-center mb-6">
        ...
        `).join(""),document.querySelectorAll("#daily-transactions-list tr").forEach(s=>{s.addEventListener("click",r=>{const i=r.currentTarget.getAttribute("data-index"),l=xa[i];l&&Bn(l)})})}catch(n){g("Erro",`Não foi possível carregar os detalhes diários: ${n.message}`,"error"),Oe(P.year,P.month,P.monthName)}}async function Mn(e,t,a,n){P={year:e,month:t,professionalId:a,professionalName:n},xt.innerHTML=`
        <section>
            <div class="flex justify-between items-center mb-6">
                <button id="backToMonthlyBtn" class="py-2 px-4 bg-gray-200 text-gray-800 font-semibold rounded-lg hover:bg-gray-300">
                    < Voltar
        ...
        `).join("")}catch(o){g("Erro",`Não foi possível carregar os detalhes do profissional: ${o.message}`,"error"),Oe(P.year,P.month,P.monthName)}}async function Dn(e,t,a){const n=t.getElementsAtEventForMode(e,"nearest",{intersect:!0},!1);if(n.length>0){const s=n[0].index,r=a[s];r&&await Oe(r.year,r.monthIndex,r.month)}}async function wa(){const e=document.getElementById("main-reports-view"),t=document.getElementById("startDate"),a=document.getElementById("endDate");if(!e||!t||!a){console.error("Elementos essenciais para o relatório não foram encontrados no DOM.");return}e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';const n=t.value,o=a.value;if(!n||!o)return e.innerHTML='<p class="text-red-500 p-8 text-center">Selecione as datas para gerar o relatório.</p>',g("Atenção","Por favor, selecione as datas de início e fim.","error");try{const s=await ps(p.establishmentId,n,o);In=s,e.innerHTML=`
            ...
            </div>`,Ln(s.kpis),setTimeout(()=>{const r=document.getElementById("transactionsByMonthChart");r&&(aa(),ne.main=new Chart(r.getContext("2d"),{type:"bar",data:{labels:s.transactionsByMonth.map(i=>i.month),datasets:[{label:"Receita Total",data:s.transactionsByMonth.map(i=>i.revenue),backgroundColor:ve[0],borderRadius:5}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:i=>`R$ ${i.raw.toFixed(2)}`}}},scales:{y:{beginAtZero:!0}},onClick:(i,l)=>Dn(i,ne.main,s.transactionsByMonth)}}))},50)}catch(s){g("Erro",`Não foi possível carregar os relatórios: ${s.message}`,"error"),e.innerHTML='<p class="text-red-500 p-8 text-center">Erro ao carregar os dados dos relatórios. Por favor, tente novamente.</p>'}}async function jt(){aa();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];xt.innerHTML=`
        <section>
            ...
            <div id="main-reports-view">
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",wa),await wa()}const wt=(e,t="products")=>y(`/api/${t}/categories/${e}`),ao=(e,t="products")=>y(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),oo=(e,t="products")=>y(`/api/${t}/categories/${e}`,{method:"DELETE"}),de=document.getElementById("content");let oe=null,De="services",ue="all";async function Pn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),n=a.value;if(n)try{await ao({establishmentId:p.establishmentId,name:n},"services"),a.value="",g("Sucesso","Categoria criada!","success"),await oa(),await Ge()}catch(o){g("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function An(e){if(await T("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await oo(e,"services"),g("Sucesso","Categoria apagada.","success"),await oa(),await Ge()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function oa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await wt(p.establishmentId,"services");p.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Nn(){j({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Pn),t.addEventListener("click",n=>{const o=n.target.closest('button[data-action="delete-category"]');o&&(n.preventDefault(),An(o.dataset.id))}))}oa()}async function qn(e){e.preventDefault();const t=e.target.closest("#serviceModal"),a=t.querySelector("#serviceId").value,n={},o=t.querySelector('input[name="commissionType"]:checked').value;o==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(r=>{const i=r.dataset.profId;if(r.querySelector('input[type="checkbox"]').checked){const d=parseFloat(r.querySelector('input[type="number"]').value);n[i]=isNaN(d)?0:d}});const s={establishmentId:p.establishmentId,name:t.querySelector("#serviceName").value,price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:o,professionalCommissions:n};try{a?await xs(a,s):await ys(s),document.getElementById("serviceModal").style.display="none",g("Sucesso",`Serviço ${a?"atualizado":"adicionado"} com sucesso!`,"success"),await Ge()}catch(r){g("Erro",r.message,"error")}}function Fn(e,t=800,a=800,n="image/jpeg",o=.8){return new Promise((s,r)=>{if(!e.type.startsWith("image/"))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,m=d.height;c>m?c>t&&(m*=t/c,c=t):m>a&&(c*=a/m,m=a);const u=document.createElement("canvas");u.width=c,u.height=m,u.getContext("2d").drawImage(d,0,0,c,m);const f=u.toDataURL(n,o);s(f)},d.onerror=c=>r(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>r(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function ka(e=null){const t=document.getElementById("serviceModal"),a=p.serviceCategories||[],n=e?.duration||0,o=e?.bufferTime||0,s=a.map(w=>`<option value="${w.id}" ${e?.categoryId===w.id?"selected":""}>${w.name}</option>`).join("");t.innerHTML=`
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async w=>{const E=w.target.closest("button[data-action]");if(!E)return;const B=E.dataset.action,D=E.dataset.id;if(B==="close-modal"&&(t.style.display="none"),B==="delete-service"){if(!D)return;if(t.style.display="none",await T("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{await ws(D),g("Sucesso","Serviço apagado com sucesso!","success"),await Ge()}catch(L){g("Erro",`Não foi possível apagar o serviço: ${L.message}`,"error")}else t.style.display="flex"}});const r=t.querySelectorAll(".tab-btn"),i=t.querySelectorAll(".tab-content");r.forEach(w=>{w.addEventListener("click",()=>{r.forEach(E=>{E.classList.remove("border-indigo-500","text-indigo-600"),E.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),w.classList.add("border-indigo-500","text-indigo-600"),w.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),i.forEach(E=>E.classList.add("hidden")),document.getElementById(`tab-content-${w.dataset.tab}`).classList.remove("hidden")})});const l=t.querySelectorAll('input[name="commissionType"]'),d=document.getElementById("defaultCommissionRateContainer"),c=document.getElementById("professionalCommissionsContainer");function m(){const w=t.querySelector('input[name="commissionType"]:checked').value;d&&(d.style.display=w==="default"?"block":"none"),c&&(c.style.display=w==="custom"?"block":"none")}l.forEach(w=>w.addEventListener("change",m));const u=document.getElementById("professionalCommissionsList");u&&(u.innerHTML=(p.professionals||[]).map(w=>{const E=e?.professionalCommissions?.[w.id]!==void 0,B=e?.professionalCommissions?.[w.id]||0;return`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${a.name}</option>`)),sa(),he()}function Hn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function Ge(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,n,o]=await Promise.all([Ie(p.establishmentId),_(p.establishmentId),wt(p.establishmentId,"services"),Es(p.establishmentId)]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(n||[]).filter(Boolean),p.mostPopularService=o||{name:"N/A",count:0},p.services.forEach(s=>{s.active===void 0&&(s.active=!0)}),so(De)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function so(e){if(document.getElementById("services-content-container")){if(De===e&&document.getElementById("services-content-container").children.length>1){De==="services"&&(sa(),he());return}De=e,ue="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Rn():e==="reports"&&Hn()}}function jn(){oe&&(de.removeEventListener("click",oe),de.removeEventListener("input",oe),de.removeEventListener("change",oe)),oe=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const o=t.closest('[data-action="toggle-service-status"]'),s=o.dataset.id,r=o.checked;try{await ks(s,r);const i=p.services.findIndex(l=>l.id===s);i>-1&&(p.services[i].active=r),he(),sa()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),o.checked=!r,he()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){he();return}if(!a)return;if(a.hasAttribute("data-view")){so(a.dataset.view);return}switch(a.dataset.action){case"new-service":ka();break;case"edit-service":const o=JSON.parse(a.dataset.service);ka(o);break;case"manage-categories":Nn();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;ue=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(r=>{const i=r.dataset.filterType,d=i===ue||i==="total"&&ue==="all";r.classList.toggle("ring-2",d),r.classList.toggle("ring-indigo-500",d),r.classList.toggle("shadow-lg",d)}),he();break}},de.addEventListener("click",oe),de.addEventListener("input",oe),de.addEventListener("change",oe)}async function On(){de.innerHTML=`
        ...
        </section>`,jn();try{(!p.professionals||p.professionals.length===0)&&(p.professionals=await _(p.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),p.professionals=[]}De="services",ue="all",await Ge()}const ie=document.getElementById("content");let se=null,Pe="products",Y="all";async function zn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),n=a.value;if(n)try{await ao({establishmentId:p.establishmentId,name:n},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await na(),await Ye()}catch(o){g("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function Vn(e){if(await T("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await oo(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await na(),await Ye()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function na(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await wt(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${a.name}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Un(){j({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",zn),t.addEventListener("click",n=>{const o=n.target.closest('button[data-action="delete-category"]');o&&Vn(o.dataset.id)}))}na()}async function _n(e){if(!e)return;if(await T("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await tn(e),g("Sucesso","Produto apagado com sucesso!","success"),await Ye()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function Wn(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),n=parseInt(e.querySelector("#productMinStock").value),o=parseInt(e.querySelector("#productMaxStock").value),s={establishmentId:p.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(n)?0:n,maxStock:isNaN(o)?0:o,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value};try{t?await en(t,s):await Ks(s),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await Ye()}catch(r){throw new Error(r.message)}}function Ea(e,t=800,a=800,n="image/jpeg",o=.8){return new Promise((s,r)=>{if(!e.type.startsWith("image/"))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,m=d.height;c>m?c>t&&(m*=t/c,c=t):m>a&&(c*=a/m,m=a);const u=document.createElement("canvas");u.width=c,u.height=m,u.getContext("2d").drawImage(d,0,0,c,m);const f=u.toDataURL(n,o);s(f)},d.onerror=c=>r(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>r(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function Sa(e=null){const t=document.getElementById("productModal"),n=(p.categories||[]).map(f=>`<option value="${f.id}" ${e?.categoryId===f.id?"selected":""}>${f.name}</option>`).join("");t.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${a.name}</option>`)),ra(),ze()}function Gn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const n=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const o=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");o&&p.products&&(o.innerHTML+=p.products.map(r=>`<option value="${r.id}">${r.name}</option>`).join("")),s&&p.categories&&(s.innerHTML+=p.categories.map(r=>`<option value="${r.id}">${r.name}</option>`).join(""))}async function Yn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value};try{const a=await on(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(r)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function Ye(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a]=await Promise.all([ea(p.establishmentId),wt(p.establishmentId,"products")]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),no(Pe)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function no(e){if(document.getElementById("products-content-container")){if(Pe===e&&document.getElementById("products-content-container").children.length>1){Pe==="products"&&(ra(),ze());return}Pe=e,Y="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Jn():e==="movements"&&Gn()}}async function Xn(){ie.innerHTML=`
        ...
        `;return t}function Zn(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",n=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,o=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function $t(){const e=document.getElementById("genericModal");e.style.display="none",ye&&e.removeEventListener("click",ye)}async function Kn(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},n=p.services||await Ie(p.establishmentId),o=p.professionals||await _(p.establishmentId),s=`
        ...
        </div>`;t.innerHTML=s,t.style.display="flex",er(a,n),ar(a),or(a,o),nr(a)}function er(e,t){const a=document.getElementById("professionalForm"),n=e.dob?e.dob.split("/"):["",""],o=Array.from({length:12},(u,b)=>{const f=b+1,v=f==n[1]?"selected":"",k=new Date(0,b).toLocaleString("pt-BR",{month:"long"});return`<option value="${f}" ${v}>${k.charAt(0).toUpperCase()+k.slice(1)}</option>`}).join(""),s=e.status||"active";a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${e.notes||""}</textarea></div>`;const r=document.getElementById("profPhotoInput"),i=document.getElementById("profPhotoButton"),l=document.getElementById("profPhotoPreview"),d=document.getElementById("profPhotoBase64"),c=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,m=e.photo||"";i&&i.addEventListener("click",()=>r.click()),r&&(r.onchange=async()=>{const u=r.files[0];if(u){l.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const b=await tr(u,800,800,"image/jpeg",.8);l.src=b,d.value=b}catch(b){g("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),l.src=c,d.value=m,r.value=""}}})}function tr(e,t=800,a=800,n="image/jpeg",o=.8){return new Promise((s,r)=>{if(!e.type.startsWith("image/"))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,m=d.height;c>m?c>t&&(m*=t/c,c=t):m>a&&(c*=a/m,m=a);const u=document.createElement("canvas");u.width=c,u.height=m,u.getContext("2d").drawImage(d,0,0,c,m);const f=u.toDataURL(n,o);s(f)},d.onerror=c=>r(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>r(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function ar(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',sr(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function or(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        </div>`;const n=document.getElementById("batchBlockageForm");n&&n.addEventListener("submit",async s=>{s.preventDefault();const r=Array.from(s.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(b=>b.value);if(r.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const i=s.target.batchBlockageStartDate.value,l=s.target.batchBlockageEndDate.value||i,d=s.target.batchBlockageStartTime.value,c=s.target.batchBlockageEndTime.value,m=s.target.batchBlockageReason.value;if(!i||!d||!c)return g("Atenção","Preencha Data de Início, Início e Fim.","error");const u=r.map(b=>{const f={professionalId:b,establishmentId:p.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${c}`).toISOString(),reason:m};return ht(f)});try{await Promise.all(u),g("Sucesso!",`${r.length} bloqueios foram criados.`);const b=document.getElementById("prof-blockages-filter").value;Ae(e.id,b)}catch(b){g("Erro",b.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",s=>Ae(e.id,s.target.value)),await Ae(e.id,"future")}function sr(e,t){e.innerHTML=Object.keys($a).map(a=>{const n=t[a]||{},o=n.active!==!1;return`
        ...
        </section>`,Ke&&St.removeEventListener("click",Ke),Ke=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),n=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let s={};if(a.dataset.professional)try{s=JSON.parse(a.dataset.professional)}catch(r){console.error("Erro ao fazer parse do professional data:",r);return}Kn(s);return}if(n){rr();return}const o=t.target.closest(".professional-checkbox");if(o){const s=o.dataset.id;o.checked?K.add(s):K.delete(s),Le(),Ot();return}},St.addEventListener("click",Ke),document.getElementById("profSearchInput").addEventListener("input",Le),document.getElementById("showInactiveProfToggle").addEventListener("change",Le);const e=document.getElementById("professionalsList");p.professionals=null,p.services=null,Le();try{const[t,a]=await Promise.all([_(p.establishmentId),Ie(p.establishmentId)]);p.professionals=t,p.services=a,Le(),Ot()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const It=document.getElementById("content");let Q=[],Ne={},F=null,zt="list",O="all",Vt="O Estabelecimento";const ir=(e,t)=>`Olá, ${e}! Nós da ${t} desejamos a você um Feliz Aniversário! Esperamos que seu dia seja maravilhoso. Venha comemorar conosco! 🎉🎂`,lr=(e,t)=>`Oi, ${e}! Faz um tempo que não te vemos aqui no(a) ${t}. Sentimos sua falta! Temos novidades/ofertas especiais para você. Que tal agendar seu horário?`,dr=[{value:30,label:"30 dias"},{value:60,label:"60 dias"},{value:90,label:"90 dias"},{value:120,label:"120 dias"}];function cr(){return Math.floor(Math.random()*140)+10}function mr(e){if(!e.dob)return!1;const t=e.dob.split("/");if(t.length!==2)return!1;const a=new Date,n=a.getDate(),o=a.getMonth()+1,s=parseInt(t[0],10),r=parseInt(t[1],10);return s===n&&r===o}const ur=[{value:99,label:"Aniversariantes de Hoje"},{value:0,label:"Todos os meses (com DOB)"},{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}];function Ia(){return ur.map(e=>{let t="";return e.value===99&&(t="selected"),`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function Ca(){return dr.map(e=>{const t=e.value===90?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function pr(e,t){const a=`w-5 h-5 ${t} mr-2`;switch(e){case"cadastro":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>`;case"agendamentos":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`;case"historico":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v2a2 2 0 01-2 2h-2.586a1 1 0 00-.707.293l-1.414 1.414a1 1 0 01-1.414 0l-1.414-1.414A1 1 0 009.586 17H7a2 2 0 01-2-2v-2a2 2 0 012-2h12z" /></svg>`;case"fidelidade":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.5a9.5 9.5 0 1019 0 9.5 9.5 0 00-19 0z" /></svg>`;default:return""}}function gr(e="cadastro"){const t=[{id:"cadastro",label:"Cadastro"},{id:"agendamentos",label:"Próximos Agend."},{id:"historico",label:"Histórico"},{id:"fidelidade",label:"Fidelidade"}],a=document.getElementById("client-detail-tabs");a&&(a.innerHTML=t.map(n=>{const o=e===n.id,s=o?"text-indigo-600":"text-gray-500";return`
        ...
        `}).join(""),a.querySelectorAll(".tab-btn").forEach(n=>{n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),Ut(n.dataset.tab)})}))}async function Ut(e){gr(e);const t=document.getElementById("client-detail-content");if(t)switch(t.innerHTML='<form id="client-form" class="p-6 space-y-4"><div class="loader mx-auto my-8"></div></form>',e){case"cadastro":t.innerHTML=fr(F);break;case"agendamentos":case"historico":try{const n=await Is(p.establishmentId,F.name,F.phone);t.innerHTML=br(n,e)}catch(n){console.error("Erro ao carregar histórico do cliente:",n),t.innerHTML=`<form id="client-form" class="p-6 space-y-4"><p class="text-center text-red-500">Erro ao carregar o histórico: ${n.message}</p></form>`}break;case"fidelidade":const a=await Cs(p.establishmentId,F.name,F.phone);t.innerHTML=vr(F,a);break;default:t.innerHTML='<form id="client-form" class="p-6 space-y-4"><p class="p-4 text-center text-gray-500">Secção não implementada.</p></form>'}}function fr(e){const t=e?.dob?e.dob.split("/"):["",""];return`
    ...
    `}function br(e,t){const a=t==="agendamentos"?"Próximos Agendamentos":"Histórico de Visitas",n=t==="agendamentos"?"Nenhum agendamento futuro.":"Nenhum histórico de visitas.",o=new Date;o.setHours(0,0,0,0);const s=t==="agendamentos",r=(e||[]).filter(i=>{const l=new Date(i.date);return s?l>=o:l<o});return r.sort((i,l)=>s?new Date(i.date).getTime()-new Date(l.date).getTime():new Date(l.date).getTime()-new Date(i.date).getTime()),r.length===0?`<form id="client-form" class="p-6 space-y-4"><p class="p-4 text-center text-gray-500">${n}</p></form>`:`
        <form id="client-form" class="p-6 space-y-4">
            <div class="space-y-3 max-h-96 overflow-y-auto">
                <h4 class="font-semibold text-lg mb-2">${a}</h4>
                ${r.map(i=>{const l=new Date(i.date)<o;return`
    ...
    `}function vr(e,t){const a=e.loyaltyPoints||0;let n='<p class="text-sm text-gray-500">O programa de fidelidade não está ativo.</p>';Ne.enabled&&Ne.tiers&&(n=Ne.tiers.map(s=>{const r=a>=s.points;return`
    ...
    `}function _t(e){F=e,zt="detail";const t=e!==null,a=t?"Editar Cliente":"Adicionar Cliente",n=`
    ...
    `,o=window.innerWidth<768,s=o?"max-w-full":"max-w-3xl";if(j({title:a,contentHTML:n,maxWidth:s}),o){const c=document.getElementById("genericModal");if(c){const m=c.querySelector(`.${s.replace(":","\\:")}`);m&&(m.style.height="auto",m.style.maxHeight="85vh",m.style.borderRadius="1rem")}}const r=document.getElementById("genericModal");r&&r.addEventListener("click",async c=>{const m=c.target.closest("[data-action]");if(!m)return;switch(m.dataset.action){case"redeem-reward":{const b=parseInt(m.dataset.points,10),f=m.dataset.reward;if(await T("Confirmar Resgate",`Deseja resgatar "${f}" por ${b} pontos?`))try{await Ls(p.establishmentId,F.name,F.phone,{points:b,reward:f}),g("Prémio resgatado com sucesso!","success"),Q=await We(p.establishmentId);const $=Q.find(S=>S.id===F.id);$&&(F=$),Ut("fidelidade")}catch(k){g(`Erro ao resgatar: ${k.message}`,"error")}break}case"open-comanda-from-history":{const b=m.dataset.appointmentId;b&&(document.getElementById("genericModal").style.display="none",A("comandas-section",{selectedAppointmentId:b,initialFilter:"finalizada"}));break}case"view-appointment":{const b=m.dataset.appointmentId,f=m.dataset.appointmentDate;b&&f&&(document.getElementById("genericModal").style.display="none",A("agenda-section",{targetDate:f,scrollToAppointmentId:b}));break}}}),Ut("cadastro");const i=document.getElementById("client-form");i&&i.addEventListener("submit",c=>{c.preventDefault(),hr()});const l=document.getElementById("cancelDetailViewBtn");l&&l.addEventListener("click",c=>{c.preventDefault(),document.getElementById("genericModal").style.display="none",kt()});const d=document.getElementById("deleteClientBtn");d&&d.addEventListener("click",async()=>{await yr()})}async function hr(){const e=document.getElementById("client-form");if(!e)return;const t=e.querySelector("#clientId").value,a={name:e.querySelector("#clientName").value,email:e.querySelector("#clientEmail").value,phone:e.querySelector("#clientPhone").value,dob:`${e.querySelector("#clientDobDay").value}/${e.querySelector("#clientDobMonth").value}`,notes:e.querySelector("#clientNotes").value,establishmentId:p.establishmentId};if(!a.name||!a.phone){g("Erro","Nome e Telefone são obrigatórios.","error");return}try{t?(await Ss(t,a),g("Sucesso","Cliente atualizado com sucesso!","success")):(await Zt(a),g("Sucesso","Cliente cadastrado com sucesso!","success")),document.getElementById("genericModal").style.display="none",await kt()}catch(n){g("Erro",`Não foi possível salvar: ${n.message}`,"error")}}async function yr(){if(!F||!F.id)return;if(await T("Excluir Cliente",`Tem certeza que deseja excluir ${F.name}? Esta ação é irreversível.`))try{await $s(F.id),g("Sucesso","Cliente excluído.","success"),document.getElementById("genericModal").style.display="none",await kt()}catch(t){g("Erro",`Não foi possível excluir: ${t.message}`,"error")}}function it(e,t){const a=document.getElementById("clientsList");if(a)if(a.innerHTML="",document.getElementById("client-count").textContent=`${e.length} cliente${e.length!==1?"s":""} | Total: ${t}`,e.length>0){const n=O==="inactive",o=O==="birthdays";e.forEach(s=>{const r=document.createElement("div");r.className="client-card bg-white rounded-lg shadow p-4 flex flex-col cursor-pointer",r.dataset.clientId=s.id;const i=s.loyaltyPoints||0,l=Ne.enabled?`${i} pts`:`R$ ${i.toFixed(2)}`;let d="";const m=`https://wa.me/55${s.phone?s.phone.replace(/\D/g,""):""}?text=`;if(n){const u=encodeURIComponent(lr(s.name,Vt));d=`
                    ...
                    </a>`}else if(o&&mr(s)){const b=encodeURIComponent(ir(s.name,Vt));d=`
            ...
            `,r.addEventListener("click",()=>_t(s)),a.appendChild(r)})}else a.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum cliente encontrado com os filtros aplicados.</p>'}function lt(e="",t="all"){const a=e.toLowerCase(),n=a.length>0;let o=0,s=90;const r=window.innerWidth<768;if(t==="birthdays"){const l=r?"mobileBirthMonthFilter":"birthMonthFilter",d=document.getElementById(l);d&&(o=parseInt(d.value,10))}else if(t==="inactive"){const l=r?"mobileInactiveDaysFilter":"inactiveDaysFilter",d=document.getElementById(l);d&&(s=parseInt(d.value,10))}let i=Q.filter(l=>!n||l.name.toLowerCase().includes(a)||(l.phone||"").includes(a));switch(t){case"birthdays":const l=new Date,d=l.getDate(),c=l.getMonth()+1;return i.filter(m=>{if(!m.dob)return!1;const u=m.dob.split("/");if(u.length!==2)return!1;const b=parseInt(u[0],10),f=parseInt(u[1],10);return o===99?b===d&&f===c:o===0?f>=1&&f<=12:f===o});case"inactive":return i.filter(m=>(m.lastAppointmentDaysAgo||cr())>s);case"scheduled":return i.filter(m=>m.loyaltyPoints>50);case"credit":return i.filter(m=>(m.loyaltyPoints||0)>0);case"debit":return i.filter(m=>!1);case"package":return i.filter(m=>!1);case"all":default:return i}}async function xr(e){const t=document.getElementById("birthMonthFilterContainer"),a=document.getElementById("mobileBirthMonthFilterContainer"),n=document.getElementById("inactiveDaysFilterContainer"),o=document.getElementById("mobileInactiveDaysFilterContainer");if(e==="birthdays"){if(t?.classList.remove("hidden"),a?.classList.remove("hidden"),n?.classList.add("hidden"),o?.classList.add("hidden"),O!=="birthdays"){const l=document.getElementById("birthMonthFilter");l&&(l.value=99);const d=document.getElementById("mobileBirthMonthFilter");d&&(d.value=99)}}else if(e==="inactive"){if(n?.classList.remove("hidden"),o?.classList.remove("hidden"),t?.classList.add("hidden"),a?.classList.add("hidden"),O!=="inactive"){const l=document.getElementById("inactiveDaysFilter");l&&(l.value=90);const d=document.getElementById("mobileInactiveDaysFilter");d&&(d.value=90)}}else t?.classList.add("hidden"),a?.classList.add("hidden"),n?.classList.add("hidden"),o?.classList.add("hidden");if(O===e&&e!=="birthdays"&&e!=="inactive")return;O=e,document.querySelectorAll(".client-filter-btn").forEach(l=>{l.classList.remove("bg-white","text-indigo-600","shadow"),l.classList.add("bg-gray-100","text-gray-600")}),document.querySelectorAll(`[data-filter-key="${e}"]`).forEach(l=>{l&&(l.classList.remove("bg-gray-100","text-gray-600"),l.classList.add("bg-white","text-indigo-600","shadow"))});const r=document.getElementById("clientSearchInput").value,i=lt(r,O);it(i,Q.length)}async function kt(){zt="list",It.innerHTML=`
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",a=>{a.preventDefault();const n={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,document:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};Ce(n,a)})}function Hr(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const n=t.querySelector("#newEmail").value,o=t.querySelector("#currentPassword").value;if(!n||!o){g("Erro","Preencha todos os campos.","error");return}const s=t.querySelector('button[form="change-email-form"]');s.disabled=!0,s.textContent="A verificar...";try{const r=V.currentUser;if(!r)throw new Error("Usuário não autenticado.");const i=yo.credential(r.email,o);await xo(r,i),s.textContent="A enviar link...",await wo(r,n),s.textContent="A atualizar BD...",await ls(p.establishmentId,n),g("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(r){let i="Não foi possível alterar o e-mail.";r.code==="auth/wrong-password"?i="A senha atual está incorreta.":r.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":r.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=r.message,g("Erro",i,"error")}finally{s.disabled=!1,s.textContent="Salvar Novo E-mail"}})}function Or(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
        ...
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md space-y-8">
            ...
            <div>
                ...
                <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <span id="publicBookingStatusText" class="text-sm font-semibold ${r}">
                        ${s}
                    </span>
                </div>
            </div>
    ...
    `,t.querySelector("#copyBookingLinkBtn").addEventListener("click",()=>{const i=t.querySelector("#publicBookingLink");if(navigator.clipboard&&window.isSecureContext)navigator.clipboard.writeText(i.value).then(()=>{g("Sucesso","Link copiado para a área de transferência!","success")}).catch(l=>{g("Erro","Não foi possível copiar o link.","error")});else try{i.select(),document.execCommand("copy"),i.blur(),g("Sucesso","Link copiado para a área de transferência!","success")}catch{g("Erro","Não foi possível copiar o link. Por favor, copie manualmente.","error")}}),t.querySelector("#publicBookingToggle").addEventListener("change",async i=>{const l=i.target.checked,d=t.querySelector("#publicBookingStatusText");l?(d.textContent="Agendamento Online ATIVO",d.className="text-sm font-semibold text-green-600"):(d.textContent="Agendamento Online INATIVO",d.className="text-sm font-semibold text-red-600");try{i.target.disabled=!0,await is(p.establishmentId,l),H.publicBookingEnabled=l,g("Sucesso",`Agendamento online ${l?"ativado":"desativado"}!`,"success")}catch(c){g("Erro",`Não foi possível alterar o status: ${c.message}`,"error"),i.target.checked=!l,l?(d.textContent="Agendamento Online ATIVO",d.className="text-sm font-semibold text-green-600"):(d.textContent="Agendamento Online INATIVO",d.className="text-sm font-semibold text-red-600")}finally{i.target.disabled=!1}}),Jr(e.slotInterval||30,t),t.querySelector("#booking-form").addEventListener("submit",i=>{i.preventDefault();const l={slotInterval:parseInt(t.querySelector("#establishmentSlotInterval").value,10)};Ce(l,i)})}function Vr(e,t){t.innerHTML=`
         <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentWorkingHoursContainer"),n=e.workingHours||{};Object.keys(Ct).forEach(o=>{const s=n[o]||{},r=Ct[o],i=s.active!==!1,l=document.createElement("div");l.className=`day-schedule-card p-4 rounded-lg ${i?"bg-gray-50":"bg-gray-100 disabled"}`,l.innerHTML=`
            ...
            </div>`,a.appendChild(l)}),a.addEventListener("change",o=>{const s=o.target.closest('.day-schedule-card input[type="checkbox"]');s&&s.closest(".day-schedule-card").classList.toggle("disabled",!s.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const s={};Object.keys(Ct).forEach(r=>{s[r]={active:t.querySelector(`#est-${r}-active`).checked,start:t.querySelector(`#est-${r}-start`).value,end:t.querySelector(`#est-${r}-end`).value,breakStart:t.querySelector(`#est-${r}-breakStart`).value,breakEnd:t.querySelector(`#est-${r}-breakEnd`).value}}),Ce({workingHours:s},o)})}function Ur(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,n]=await Promise.all([Ve(),Ue()]),o=e.financialIntegration||{};t.querySelector("#financialNatureId").innerHTML=La(a,o.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=La(n,o.defaultCentroDeCustoId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const n={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null}};Ce(n,a)})}function Wr(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${e}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function po(e="indigo",t){const a=t.querySelector("#color-palette-container"),n=t.querySelector("#establishmentThemeColor");!a||!n||(a.innerHTML="",Object.entries(Fr).forEach(([o,s])=>{const r=o===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer",i.innerHTML=`
    ...
    `,me.querySelector('button[data-action="back-to-list"]').addEventListener("click",n=>{n.preventDefault(),go()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":Rr(H,a);break;case"change-password":Hr(H,a);break;case"change-email":jr(H,a);break;case"branding":Or(H,a);break;case"booking":zr(H,a);break;case"working-hours":Vr(H,a);break;case"loyalty":Ur(H,a);break;case"financial":await _r(H,a);break;default:Wr(t?t.label:"Definições",a)}}async function go(){if(me.innerHTML=`
    ...
    `,me.querySelector("#settings-menu-list").addEventListener("click",n=>{const o=n.target.closest("button[data-section]");o&&(n.preventDefault(),Gr(o.dataset.section))});const a=me.querySelector('[data-action="go-to-my-profile"]');a&&a.addEventListener("click",n=>{n.preventDefault(),A("my-profile-section")})}const qe=document.getElementById("content");async function ke(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,n=document.getElementById("filterEndDate")?.value,o=await vt(p.establishmentId,a||new Date().toISOString().split("T")[0],n||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),r=s?o.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):o,i=r.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",r.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let m=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${l} (${d.length})</h4>`;if(d.length>1){const u=JSON.stringify(d.map(b=>b.id));m+=`<button data-action="batch-delete-blockage" data-ids='${u}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}m+="</div>",c.innerHTML=m,d.forEach(u=>{const b=new Date(u.startTime),f=new Date(u.endTime),v=b.toLocaleDateString("pt-BR"),k=f.toLocaleDateString("pt-BR"),S=`
                    ...
                    </div>`;c.innerHTML+=S}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Yr(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,n=t.querySelector("#blockageDate").value,o=t.querySelector("#blockageEndDate").value||n,s=t.querySelector("#blockageStartTime").value,r=t.querySelector("#blockageEndTime").value,i={establishmentId:p.establishmentId,professionalId:a,startTime:new Date(`${n}T${s}:00`).toISOString(),endTime:new Date(`${o}T${r}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await ht(i),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),ke(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Xr(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const n=t.querySelector("#batchBlockageDate").value,o=t.querySelector("#batchBlockageEndDate").value||n,s=t.querySelector("#batchBlockageStartTime").value,r=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const m={establishmentId:p.establishmentId,professionalId:c,startTime:new Date(`${n}T${s}:00`).toISOString(),endTime:new Date(`${o}T${r}:00`).toISOString(),reason:i};return ht(m)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(m=>m.checked=!1);const c=document.getElementById("blockageProfId").value;c&&ke(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Qr(e){qe.addEventListener("submit",t=>{t.target.id==="blockageForm"&&Yr(t),t.target.id==="batchBlockageForm"&&Xr(t)}),qe.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&ke(e)}),qe.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const n=a.dataset.action;if(n==="back-to-professionals")A("profissionais-section");else if(n==="delete-blockage"){if(await T("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Qt(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),ke(e)}catch(s){g("Erro",`Não foi possível remover o bloqueio: ${s.message}`,"error")}}else if(n==="batch-delete-blockage"){const o=JSON.parse(a.dataset.ids);if(await T("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await Ga(o),g("Sucesso",`${o.length} bloqueios removidos.`,"success"),ke(e)}catch(r){g("Erro",`Não foi possível apagar os bloqueios: ${r.message}`,"error")}}})}async function Zr(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){qe.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}qe.innerHTML=`
        <section>
        ...
        </section>`,Qr(t),await ke(t);const n=document.getElementById("batchProfSelectionContainer");try{const o=await _(p.establishmentId);n.innerHTML=o.map(s=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{n.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const Kr=e=>y(`/api/users/${e}`),ei=e=>y("/api/users",{method:"POST",body:JSON.stringify(e)}),ti=(e,t)=>y(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),ai=e=>y(`/api/users/${e}`,{method:"DELETE"}),oi=(e,t)=>y(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),si=(e,t)=>y(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),le=document.getElementById("content"),ni={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","profissionais-section":"Profissionais","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},ri={view:"Visualizar",create:"Criar",edit:"Editar"};let Be=null,Te=null;function ii(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const n=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${n}</p>`;return}e.sort((n,o)=>(n.status==="active"?-1:1)-(o.status==="active"?-1:1)),t.innerHTML=e.map(n=>{const o=JSON.stringify(n).replace(/'/g,"&apos;"),s=n.status==="active",r=p.professionals.find(c=>c.id===n.professionalId),i=r?r.name:"N/A",l=r?r.name.charAt(0):n.name.charAt(0),d=r?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function dt(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=p.users:t=p.users.filter(a=>a.status==="active"),ii(t)}function li(e={}){return Object.entries(ni).map(([t,a])=>{const n=t==="agenda-section"||t==="comandas-section",o=e[t]?.view_all_prof===!0,s=Object.entries(ri).map(([i,l])=>`
    ...
    `,Be&&le.removeEventListener("click",Be),Te&&le.removeEventListener("change",Te),Be=async e=>{if(!document.getElementById("user-list-view")){le.removeEventListener("click",Be);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":Ba();break;case"edit-user":const n=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));Ba(n);break;case"back-to-list":gt();break;case"delete-user":{e.stopPropagation();const o=t.dataset.userId;if(await T("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await ai(o),g("Usuário excluído com sucesso!","success"),gt()}catch(r){g(`Erro ao excluir: ${r.message}`,"error")}break}}},Te=async e=>{if(!document.getElementById("user-list-view")){le.removeEventListener("change",Te);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")dt();else if(t){e.stopPropagation();const a=t.dataset.userId,n=t.checked?"active":"inactive";try{await si(a,n),g(`Usuário ${n==="active"?"ativado":"inativado"} com sucesso.`,"success");const o=p.users.findIndex(s=>s.id===a);o>-1&&(p.users[o].status=n,dt())}catch(o){g(`Erro ao atualizar status: ${o.message}`,"error"),t.checked=!t.checked,dt()}}},le.addEventListener("click",Be),le.addEventListener("change",Te),await di()}const ci=document.getElementById("content");let Ta={},Wt=null;function mi(){Object.values(Ta).forEach(e=>e?.destroy()),Ta={}}function ui(e,t){const{jsPDF:a}=window.jspdf,n=new a({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(n.setFontSize(18),n.text(e,n.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const r=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];n.autoTable({startY:60,head:[["Métrica","Valor"]],body:r,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=n.lastAutoTable?n.lastAutoTable.finalY+20:60;n.text("Detalhes das Vendas",20,s),n.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),n.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Ma(e){const t=document.getElementById("genericModal"),a=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function pi(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const n=document.getElementById("paymentSummaryTableBody"),o=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);n.innerHTML=o.map(([i,l])=>`
        <tr class="border-b">
    ...
    `).join(""),s.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=Wt.transactions[l];d&&Ma(d)})}),r.innerHTML=a.map((i,l)=>`
    ...
    `).join(""),r.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=Wt.transactions[l];d&&Ma(d)})})}async function Da(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const n=t.value,o=a.value;if(!n||!o)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,r=await gs({establishmentId:p.establishmentId,startDate:n,endDate:o,cashierSessionId:s});Wt=r,e.innerHTML=`
        ...
        `,pi(r)}catch(s){g("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${s.message}</p>`}}async function gi(){mi();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];ci.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Da),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const n=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${n}_a_${o}`;ui(s,"transactionsTable")});try{const n=await rn(),o=document.getElementById("cashierSessionFilter");n.forEach(s=>{const r=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=s.closedByName||"N/A";o.innerHTML+=`<option value="${s.id}">${i} - ${r}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Da()}const fi=document.getElementById("content");let I={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},Lt=null,et=null,tt=null;function ia(e){const t=new Map,a=[];return e&&(e.forEach(n=>t.set(n.id,{...n,children:[]})),t.forEach(n=>{n.parentId&&t.has(n.parentId)?t.get(n.parentId).children.push(n):a.push(n)})),a}function fo(e,t,a){if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const n=(o,s=0)=>{const r="— ".repeat(s);return`
    ...
    `,e.style.display="flex",e.querySelector("#generateCashFlowBtn").addEventListener("click",Aa),Aa()}function vi(){const e=document.getElementById("genericModal"),t=I.payables.filter(m=>m.status==="pending").reduce((m,u)=>m+u.amount,0),a=I.receivables.filter(m=>m.status==="pending").reduce((m,u)=>m+u.amount,0),n=a-t,o=I.payables.filter(m=>m.status==="paid").reduce((m,u)=>m+u.amount,0),s=I.receivables.filter(m=>m.status==="paid").reduce((m,u)=>m+u.amount,0),r=s-o,i=I.previousBalance||0,l=i+r,d=m=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(m),c=m=>m>=0?"text-green-600":"text-red-600";e.innerHTML=`
                ...
                <div class="bg-gray-50 p-4 rounded-lg shadow-inner">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                        ...
                        <div class="bg-white p-3 rounded-lg shadow-lg border-b-4 ${c(r)==="text-green-600"?"border-green-600":"border-red-600"}">
                            ...
                            <p class="text-2xl font-bold ${c(r)}">${d(r)}</p>
                        </div>
                    </div>
                </div>
    ...
    `,e.style.display="flex"}function hi(){const e=document.getElementById("genericModal");e.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.style.display="flex"}function at(e,t="all"){let a='<option value="all">Todos</option>';const n=r=>{const i=new Map,l=[];return r&&(r.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},o=(r,i=0)=>{const l=i>0?"— ".repeat(i):"",d=r.id===t?"selected":"";a+=`<option value="${r.id}" ${d}>${l}${r.name}</option>`,r.children.forEach(c=>o(c,i+1))};return n(e).forEach(r=>o(r)),a}async function pe(){const e=document.getElementById("financial-content"),t=document.getElementById("filterStartDate")?.value,a=document.getElementById("filterEndDate")?.value,n=document.getElementById("filterNaturezaId")?.value,o=document.getElementById("filterCostCenterId")?.value;if(!t||!a){try{const[i,l]=await Promise.all([Ve(),Ue()]);I={...I,natures:i,costCenters:l},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=at(I.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=at(I.costCenters))}catch(i){g("Erro",`Não foi possível carregar os dados base: ${i.message}`,"error")}Jt(),Fa();return}const s=document.getElementById("payables-list"),r=document.getElementById("receivables-list");s&&(s.innerHTML='<div class="loader mx-auto"></div>'),r&&(r.innerHTML='<div class="loader mx-auto"></div>');try{const i={startDate:t,endDate:a};n&&n!=="all"&&(i.natureId=n),o&&o!=="all"&&(i.costCenterId=o);const[l,d,c,m]=await Promise.all([Ir(i),Mr(i),Ve(),Ue()]),u=d.previousBalance-l.previousBalance;I={...I,payables:l.entries,receivables:d.entries,natures:c,costCenters:m,previousBalance:u,filterNaturezaId:n,filterCostCenterId:o},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=at(I.natures,I.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=at(I.costCenters,I.filterCostCenterId)),Jt(),Fa()}catch(i){g("Erro",`Não foi possível carregar os dados: ${i.message}`,"error"),e&&(e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function yi(e,t,a=null){e.preventDefault();const n=e.target,o=n.querySelector('[name="status"]').checked,s=n.querySelector('[name="paymentDate"]').value,r=parseFloat(n.querySelector('[name="amount"]').value),i=parseInt(n.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(r)){g("Erro de Validação","O valor inserido é inválido.","error");return}if(o&&!s){g("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:n.querySelector('[name="description"]').value,amount:r,dueDate:n.querySelector('[name="dueDate"]').value,naturezaId:n.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:n.querySelector('[name="centroDeCustoId"]').value||null,notes:n.querySelector('[name="notes"]').value,status:o?"paid":"pending",paymentDate:o?s:null,installments:a?1:i};try{a?(await(t==="payable"?Cr(a,l):Dr(a,l)),g("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?$r(l):Tr(l)),g("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await pe()}catch(d){g("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function xi(e,t){if(await T("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?Lr(t):Pr(t)),g("Sucesso","Lançamento excluído!","success"),await pe()}catch(n){g("Erro",`Falha ao excluir: ${n.message}`,"error")}}async function wi(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Br(t,a):Ar(t,a)),g("Sucesso","Lançamento atualizado!","success"),await pe()}catch(n){g("Erro",`Falha ao atualizar status: ${n.message}`,"error")}}function qa(e){const t=I.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function Jt(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(I.natures.map(i=>[i.id,i.name])),n=new Map(I.costCenters.map(i=>[i.id,i.name])),o=qa(I.payables),s=qa(I.receivables),r=(i,l)=>{const d=i.status==="paid",c=JSON.stringify(i).replace(/'/g,"&apos;"),m=i.naturezaId?a.get(i.naturezaId):"N/A",u=i.centroDeCustoId?n.get(i.centroDeCustoId):"N/A";let b=l==="payable"?"text-red-600":"text-green-600";const f=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",v=d?"Finalizado":"Pendente";return d&&(b="text-gray-500"),`
    ...
    `;a.innerHTML=`
        ...
        </div>`,a.style.display="flex",t&&(a.querySelector('[name="naturezaId"]').value=t.naturezaId||"",a.querySelector('[name="centroDeCustoId"]').value=t.centroDeCustoId||"");const d=a.querySelector("#status"),c=a.querySelector("#payment-date-container"),m=a.querySelector('[name="paymentDate"]');t?.status==="paid"&&(d.checked=!0,c.classList.remove("hidden"),m.value=t.paymentDate||new Date().toISOString().split("T")[0]),d.addEventListener("change",()=>{c.classList.toggle("hidden",!d.checked),m.required=d.checked}),a.querySelector("#financial-form").addEventListener("submit",u=>yi(u,e,t?.id))}async function ki(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth()-1,1).toISOString().split("T")[0],n=e.toISOString().split("T")[0];I.startDate=a,I.endDate=n,I.currentFilter="pending",I.filterNaturezaId="all",I.filterCostCenterId="all",fi.innerHTML=`
        <section>
    ...
    `;const o=document.getElementById("main-fab-btn"),s=document.getElementById("fab-menu");if(o&&s){o.addEventListener("click",v=>{v.stopPropagation(),s.classList.toggle("hidden"),o.classList.toggle("rotate-45")});const u=s.querySelector('button[data-action="open-modal"][data-type="receivable"]'),b=s.querySelector('button[data-action="open-modal"][data-type="payable"]'),f=s.querySelector('button[data-action="open-cash-flow-modal"]');u&&u.addEventListener("click",v=>{v.stopPropagation(),Bt("receivable")}),b&&b.addEventListener("click",v=>{v.stopPropagation(),Bt("payable")}),f&&f.addEventListener("click",v=>{v.stopPropagation(),Na()})}et&&document.body.removeEventListener("click",et),tt&&document.getElementById("genericModal").removeEventListener("click",tt);const r=()=>{const u=document.getElementById("filterStartDate"),b=document.getElementById("filterEndDate"),f=document.getElementById("filterNaturezaId"),v=document.getElementById("filterCostCenterId");I.startDate=u.value,I.endDate=b.value,I.filterNaturezaId=f.value,I.filterCostCenterId=v.value;const k=document.getElementById("advanced-filters");k&&k.classList.contains("hidden")===!1&&window.innerWidth<768&&k.classList.add("hidden"),pe()},i=u=>{const b=u.target.closest("[data-status-filter]");if(!b)return;const f=b.dataset.statusFilter;I.currentFilter=f,document.querySelectorAll("[data-status-filter]").forEach(v=>{v.classList.remove("bg-blue-100","text-blue-800"),v.classList.add("bg-gray-100","text-gray-600")}),b.classList.remove("bg-gray-100","text-gray-600"),b.classList.add("bg-blue-100","text-blue-800"),Jt()},l=u=>{const b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),v=document.getElementById("btn-payables-view"),k=document.getElementById("btn-receivables-view");window.innerWidth>=1024&&I.currentListView===u||(u==="payables"?(b.classList.remove("hidden"),f.classList.add("hidden"),v&&(v.classList.remove("bg-gray-200"),v.classList.add("bg-red-100","border","border-red-500")),k&&(k.classList.remove("bg-green-100","border","border-green-500"),k.classList.add("bg-gray-200"))):(b.classList.add("hidden"),f.classList.remove("hidden"),v&&(v.classList.remove("bg-red-100","border","border-red-500"),v.classList.add("bg-gray-200")),k&&(k.classList.remove("bg-gray-200"),k.classList.add("bg-green-100","border","border-green-500"))),I.currentListView=u)};document.getElementById("applyDateFilterBtn").addEventListener("click",r),document.getElementById("filterNaturezaId").addEventListener("change",()=>{I.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{I.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(u=>{u.addEventListener("click",i)}),et=u=>{const b=u.target.closest("button[data-action]");if(!b)return;const{action:f,type:v,id:k}=b.dataset;f==="edit"?Bt(v,JSON.parse(b.dataset.item.replace(/&apos;/g,"'"))):f==="delete"?xi(v,k):f==="mark-as-paid"?wi(v,k):f==="manage-natures"?Pa("nature"):f==="manage-cost-centers"?Pa("cost-center"):f==="open-cash-flow-modal"?Na():f==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):f==="open-indicators-modal"?vi():f==="open-settings-modal"?hi():f==="toggle-list-view"&&l(b.dataset.list)},tt=u=>{const b=u.target.closest('button[data-action^="delete-"]');if(b){const f=b.dataset.action.split("-")[1];d(f,b.dataset.id)}},document.body.addEventListener("click",et),document.getElementById("genericModal").addEventListener("click",tt);async function d(u,b){const f=u==="nature",v=f?kr:Sr,k=f?Ve:Ue,$=f?"natures":"costCenters",S=document.getElementById("hierarchyList");if(await T("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await v(b);const E=await k();I[$]=E,fo(S,ia(E),u),await pe()}catch(E){g("Erro",`Não foi possível apagar: ${E.message}`,"error")}}const c=()=>{const u=window.innerWidth<1024,b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),v=document.getElementById("list-toggle-buttons");b&&f&&(b.classList.remove("hidden"),f.classList.remove("hidden"),u?(b.classList.remove("lg:col-span-1"),f.classList.remove("lg:col-span-1"),v?.classList.remove("hidden"),l(I.currentListView)):(b.classList.add("lg:col-span-1"),f.classList.add("lg:col-span-1"),v?.classList.add("hidden"),b.classList.remove("hidden"),f.classList.remove("hidden")))};c(),window.addEventListener("resize",c);const m=document.querySelector(`[data-status-filter="${I.currentFilter}"]`);m&&(document.querySelectorAll("[data-status-filter]").forEach(u=>{u.classList.remove("bg-blue-100","text-blue-800"),u.classList.add("bg-gray-100","text-gray-600")}),m.classList.remove("bg-gray-100","text-gray-600"),m.classList.add("bg-blue-100","text-blue-800"));try{const u=await qr(),b=document.getElementById("summary-today-payables");b&&(b.textContent=`R$ ${u.totalPayables.toFixed(2)}`);const f=document.getElementById("summary-today-receivables");f&&(f.textContent=`R$ ${u.totalReceivables.toFixed(2)}`)}catch{g("Erro","Não foi possível carregar o resumo do dia.","error")}await pe()}const Ei=e=>y("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),Si=e=>y("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),$i=(e={})=>{const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return y(a)},Ii=e=>y(`/api/commissions/report/${e}`,{method:"DELETE"}),Ee=document.getElementById("content");let Fe=[],bo="",ot=null,xe={};function Ci(e){const{jsPDF:t}=window.jspdf,a=new t;a.setFontSize(18),a.text(`Recibo de Comissão - ${e.professionalName}`,105,20,null,null,"center"),a.setFontSize(12),a.text(`Período: ${e.period}`,105,30,null,null,"center"),a.autoTable({startY:40,head:[["Descrição","Valor (R$)"]],body:[["Total Comissionável",`R$ ${e.summary.totalCommissionableValue.toFixed(2)}`],["Total de Itens",e.summary.totalItems]],theme:"striped"});const n=a.lastAutoTable.finalY+20;a.setFontSize(14),a.setFont(void 0,"bold"),a.text("Valor Total da Comissão:",14,n),a.text(`R$ ${e.summary.totalCommission.toFixed(2)}`,190,n,null,null,"right");const o=n+80;a.line(40,o,170,o),a.setFontSize(10),a.setFont(void 0,"normal"),a.text(e.professionalName,105,o+10,null,null,"center"),a.save(`recibo_comissao_${e.professionalName}_${e.period.replace(/\//g,"-")}.pdf`)}function Li(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth(),1).toISOString().split("T")[0],a=e.toISOString().split("T")[0],o=`
        ...
        <label class="flex items-center p-2 bg-white rounded-lg border border-gray-300 cursor-pointer hover:bg-indigo-50 transition">
            <input type="checkbox" value="${d.id}" class="professional-checkbox h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
            <span class="ml-3 text-sm font-medium text-gray-700">${d.name}</span>
        </label>
    `).join("")}
                </div>
            </div>
    ...
    `,{modalElement:s}=j({title:"✨ Novo Cálculo de Comissões",contentHTML:o,maxWidth:"max-w-xl"}),r=s.querySelector("#calculation-form"),i=s.querySelector("#calc-professionals-all"),l=s.querySelectorAll(".professional-checkbox");i.addEventListener("change",d=>{l.forEach(c=>{c.checked=d.target.checked})}),l.forEach(d=>{d.addEventListener("change",()=>{d.checked?Array.from(l).every(m=>m.checked)&&(i.checked=!0):i.checked=!1})}),r.addEventListener("submit",d=>{d.preventDefault();const c=Array.from(l).filter(u=>u.checked).map(u=>u.value);if(c.length===0){g("Atenção","Selecione pelo menos um profissional para o cálculo.","error");return}Ti({professionalIds:c});const m=s.querySelector("[data-close-modal]");m?m.click():s.style.display="none"})}async function Bi(e){if(await T("Excluir Relatório","Tem a certeza que deseja excluir permanentemente este relatório de comissão? Esta ação não pode ser desfeita."))try{await Ii(e),g("Sucesso!","Relatório de comissão excluído.","success"),ct()}catch(a){g("Erro",`Não foi possível excluir: ${a.message}`,"error")}}async function Ti(e){const{professionalIds:t}=e,a=document.getElementById("calc-start-date")?.value,n=document.getElementById("calc-end-date")?.value,o={services:document.getElementById("calc-type-services")?.checked,products:document.getElementById("calc-type-products")?.checked,packages:document.getElementById("calc-type-packages")?.checked};if(!a||!n){g("Erro","As datas não foram capturadas corretamente.","error");return}A("commissions-section",{view:"results",isLoading:!0});try{const s=await Ei({professionalIds:t,startDate:a,endDate:n,calculationTypes:o});Fe=s;const r=`${new Date(a+"T00:00:00").toLocaleDateString("pt-BR")} a ${new Date(n+"T00:00:00").toLocaleDateString("pt-BR")}`;bo=r,Pi(s,r)}catch(s){g("Erro",`Não foi possível calcular: ${s.message}`,"error"),A("commissions-section",{view:"history"})}}async function Mi(){if(Fe.length===0){g("Erro","Não há resultados para salvar.","error");return}const e=bo;if(await T("Salvar Relatórios",`Tem a certeza que deseja salvar ${Fe.length} relatório(s) de comissão para o período de ${e}?`))try{const a=Fe.map(n=>Si({professionalId:n.professionalId,professionalName:n.professionalName,period:e,reportData:n}));await Promise.all(a),g("Sucesso!","Relatórios de comissão salvos.","success"),A("commissions-section",{view:"history"})}catch(a){g("Erro",`Não foi possível salvar: ${a.message}`,"error")}}async function ct(){const e=document.getElementById("commissionHistory");if(!e)return;const t=document.getElementById("filter-professional")?.value||"",a=document.getElementById("filter-month")?.value||"";xe={},t&&t!=="all"&&(xe.professionalId=t),a&&(xe.period=a),e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const n=await $i(xe);if(n.length===0){e.innerHTML='<p class="text-center text-gray-500 py-8">Nenhum relatório de comissão salvo encontrado para os filtros.</p>';return}e.innerHTML=`
            <div class="space-y-3">
                ${n.map(o=>`
            ...
            </div>`}catch(n){e.innerHTML=`<p class="text-red-500 text-center">Erro ao carregar histórico: ${n.message}</p>`}}function Di(){if(!p.professionals){Ee.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A carregar dados...</p></div>';return}const e=p.professionals.map(s=>`<option value="${s.id}">${s.name}</option>`).join(""),t=[],a=new Date;for(let s=0;s<12;s++){const r=new Date(a.getFullYear(),a.getMonth()-s,1),i=r.getFullYear(),d=(r.getMonth()+1).toString().padStart(2,"0"),c=`${i}-${d}`,m=r.toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.push(`<option value="${c}">${m}</option>`)}const n=xe.professionalId||"all",o=xe.period||"";Ee.innerHTML=`
    ...
    `,document.getElementById("filter-professional").value=n,document.getElementById("filter-month").value=o,document.getElementById("filter-professional").addEventListener("change",ct),document.getElementById("filter-month").addEventListener("change",ct),ct()}function Pi(e,t){Fe=e;const a=e.reduce((n,o)=>n+o.summary.totalCommission,0);Ee.innerHTML=`
        <section>
    ...
    `}async function Ai(e={}){const{view:t="history",isLoading:a=!1}=e;if(ot&&Ee.removeEventListener("click",ot),ot=n=>{const o=n.target.closest("button[data-action]");if(!o)return;switch(o.dataset.action){case"open-calculator":Li();break;case"back-to-history":A("commissions-section",{view:"history"});break;case"save-reports":Mi();break;case"generate-receipt":const r=JSON.parse(o.dataset.report.replace(/&apos;/g,"'"));Ci(r);break;case"delete-report":const i=o.dataset.id;Bi(i);break}},Ee.addEventListener("click",ot),a){Ee.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A calcular comissões...</p></div>';return}if(!p.professionals||p.professionals.length===0)try{p.professionals=await _(p.establishmentId)}catch{g("Erro","Não foi possível carregar a lista de profissionais.","error"),p.professionals=[]}(t==="history"||t==="main")&&Di()}const Tt=document.getElementById("content");let ge={allPackages:[],catalogForModal:{services:[],products:[]}},st=null,we=null;function Ni(e=6){let t="";for(let a=0;a<e;a++)t+=`
    ...
    `;t.innerHTML=o,t.style.display="flex";const s=t.querySelector("#package-items-list"),r=(l,d)=>{const c=d.querySelector("#originalPrice"),m=l.reduce((u,b)=>u+b.price*b.quantity,0);c&&(c.textContent=`R$ ${m.toFixed(2)}`)},i=l=>{l.length===0?s.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':s.innerHTML=l.map((d,c)=>{const m=d.type==="service",u=m?"Serviço":"Produto",b=m?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        <input type="number" value="${d.quantity}" min="1" class="w-12 p-1 border rounded-md text-sm quantity-input flex-shrink-0" data-index="${c}">
                        <!-- (NOVO) Selo de Tipo -->
            ...
            `}).join(""),r(l,t)};i(n),s.addEventListener("change",l=>{if(l.target.classList.contains("quantity-input")){const d=parseInt(l.target.dataset.index,10),c=parseInt(l.target.value,10);c>0&&n[d]&&(n[d].quantity=c,i(n))}}),s.addEventListener("click",l=>{if(l.target.classList.contains("remove-item-btn")){const d=parseInt(l.target.dataset.index,10);n.splice(d,1),i(n)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Fi(l=>{const d=n.find(c=>c.id===l.id&&c.type===l.type);d?d.quantity++:n.push({...l,quantity:1}),i(n)}),we&&t.removeEventListener("click",we),we=async l=>{const d=l.target.closest("button[data-action]");if(!d)return;const c=d.dataset.action;if(l.stopPropagation(),c==="close-modal"&&Ra(),c==="save-package"){const m=d,u={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:n,originalPrice:n.reduce((b,f)=>b+f.price*f.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null};if(!u.name||!u.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(u.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}m.disabled=!0,m.textContent="A salvar...";try{a?await cn(u.id,u):(delete u.id,await dn(u)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Ra(),await la()}catch(b){g("Erro",`Não foi possível salvar o pacote: ${b.message}`,"error"),m.disabled=!1,m.textContent="Salvar Pacote"}}},t.addEventListener("click",we)}function Fi(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const n={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},o=l=>{const d=t.toLowerCase(),c=ge.catalogForModal.services.filter(f=>f.name.toLowerCase().includes(d)),m=ge.catalogForModal.products.filter(f=>f.name.toLowerCase().includes(d)),u=c.map(f=>`
    ...
    `,document.body.appendChild(a);const s=a.querySelector("#item-selection-list"),r=a.querySelector("#item-search-input"),i=()=>{a.remove()};o(s),r.addEventListener("input",()=>{t=r.value,o(s)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:m,itemId:u}=d.dataset,f=(ge.catalogForModal[m+"s"]||[]).find(v=>v.id===u);f&&(e({...f,type:m}),i())}else(c||l.target===a)&&i()})}async function la(){Tt.innerHTML=`
    ...
    `,st&&Tt.removeEventListener("click",st),st=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const n=e.target.closest('[data-action="delete-package"]');if(n){const o=n.dataset.id;T("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await mn(o),g("Sucesso!","Pacote excluído.","success"),await la()}catch(r){g("Erro",`Não foi possível excluir: ${r.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")Ha(null);else if(a==="edit-package"){const n=JSON.parse(t.dataset.package);Ha(n)}},Tt.addEventListener("click",st);try{const[e,t,a]=await Promise.all([eo(p.establishmentId),Ie(p.establishmentId),ea(p.establishmentId)]);ge.allPackages=e,ge.catalogForModal={services:t.filter(n=>n.active),products:a},qi()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Ri=document.getElementById("content");let Hi=null;async function ji(){Ri.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await Oi()}async function Oi(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await ds(t);Hi=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo),e.innerHTML=`
            ...
            `,zi(a.id),document.getElementById("my-blocks-filter").addEventListener("change",o=>ft(a.id,o.target.value)),ft(a.id,"future")}else e.innerHTML=`
        ...
        `}}function zi(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const n=t.querySelector("#blockDate").value,o=t.querySelector("#blockStartTime").value,s=t.querySelector("#blockEndTime").value,r=t.querySelector("#blockReason").value;if(!n||!o||!s){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(o>=s){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${n}T${o}:00`),l=new Date(`${n}T${s}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await ht({establishmentId:p.establishmentId,professionalId:e,reason:r||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;ft(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),g("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function ft(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const n=new Date;let o,s;t==="history"?(s=new Date,o=new Date,o.setFullYear(o.getFullYear()-1)):(o=new Date,s=new Date,s.setFullYear(s.getFullYear()+1));let i=(await vt(p.establishmentId,o.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<n).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=n).sort((l,d)=>l.startTime-d.startTime),i.length>0?(a.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`;return`
                ...
                `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const c=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await Qt(c),g("Sucesso","Bloqueio removido.","success"),ft(e,t)}catch(m){console.error("Erro ao remover bloqueio:",m),g("Erro",`Não foi possível remover o bloqueio: ${m.message}`,"error")}})})):a.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(n){console.error("Erro ao carregar bloqueios:",n),a.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${n.message}</p>`}}const ja=document.getElementById("loadingScreen"),Mt=document.getElementById("dashboardContent"),Dt=document.getElementById("content"),Oa=document.getElementById("notificationBell"),Pt=document.getElementById("notificationBadge"),nt=document.getElementById("notificationPanel"),za=document.getElementById("notificationList"),At=document.getElementById("profileMenuButton"),J=document.getElementById("profileDropdown"),Vi=document.getElementById("profileName"),Ui=document.getElementById("profileEmail"),_i=document.getElementById("logoutButton"),Wi=document.getElementById("cancellationHistoryBtn"),Va=document.getElementById("myProfileLink"),Ua={indigo:{main:"#4f46e5",light:"#e0e7ff",text:"white",hover:"#4338ca"},rose:{main:"#e11d48",light:"#ffe4e6",text:"white",hover:"#be123c"},green:{main:"#16a34a",light:"#d1fae5",text:"white",hover:"#15803d"},sky:{main:"#0284c7",light:"#e0f2fe",text:"white",hover:"#0369a1"},amber:{main:"#d97706",light:"#fef3c7",text:"#1f2937",hover:"#b45309"}};let Re=null,He=[];const Ji={"agenda-section":Za,"comandas-section":ta,"relatorios-section":jt,"servicos-section":On,"produtos-section":Xn,"profissionais-section":pt,"clientes-section":kt,"estabelecimento-section":go,"ausencias-section":Zr,"users-section":gt,"sales-report-section":gi,"financial-section":ki,"commissions-section":Ai,"packages-section":la,"my-profile-section":ji};async function Gi(e){if(!mt.isNativePlatform()){console.log("Notificações Push nativas desativadas (Ambiente Web).");return}try{console.log("Inicializando Push Notifications...");let t=await ae.checkPermissions();if(t.receive==="prompt"&&(t=await ae.requestPermissions()),t.receive!=="granted"){console.warn("Permissão para notificações push foi negada.");return}await ae.register(),ae.removeAllListeners(),ae.addListener("registration",async a=>{console.log("Push Registration Token:",a.value);try{const n=_a(Gt,"users",e);await Co(n,{fcmTokens:Lo(a.value),lastLoginDevice:new Date}),console.log("Token FCM salvo com sucesso no perfil do usuário.")}catch(n){console.error("Erro ao salvar token FCM no Firestore:",n)}}),ae.addListener("registrationError",a=>{console.error("Erro no registro do Push:",a)}),ae.addListener("pushNotificationReceived",a=>{console.log("Notificação recebida (Foreground):",a),g(a.title,a.body,"info",!0),bt()}),ae.addListener("pushNotificationActionPerformed",a=>{console.log("Ação da notificação (Clique):",a);const n=a.notification.data;n&&n.section?A(n.section):A("agenda-section")})}catch(t){console.error("Falha fatal ao inicializar Push Notifications:",t)}}function Yi(e){const t=Ua[e]||Ua.indigo,a=document.getElementById("dynamic-theme-styles"),o=(r=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:null})(t.main),s=e==="amber"?"#1f2937":"white";a.innerHTML=`
        .sidebar-link.active { 
    ...
    `}function bt(){const e=He.filter(t=>!t.read).length;if(e>0?(Pt.textContent=e,Pt.classList.remove("hidden")):Pt.classList.add("hidden"),He.length===0){za.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}za.innerHTML=He.map(t=>`
    ...
    `).join("")}function Xi(e){Re&&Re();const t=Bo(Gt,"establishments",e,"notifications"),a=To(t,Mo("timestamp",">=",new Date),Do("timestamp","desc"));Re=Po(a,n=>{n.docChanges().forEach(o=>{if(o.type==="added"){const s=o.doc.data();He.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(s.title,s.message,"info",!0),bt();const r=document.querySelector(".sidebar-link.active");r&&r.dataset.target==="agenda-section"&&(s.type==="cancellation"||s.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),Za())}})},n=>{console.error("Erro no listener de notificações em tempo real:",n),g("Erro de Conexão","Não foi possível receber atualizações em tempo real. Verifique as regras de segurança do Firestore.","error")})}function A(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const o=p.enabledModules?.[a]!==!1,s=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!o||!s){Dt.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active"));return}}const n=Ji[e];n?(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Dt.innerHTML="",n(t)):(Dt.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`,console.warn(`Nenhum carregador de página definido para: ${e}`))}async function Qi(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),n=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,r=e===null||e["financial-section"]?.view===!0;if(s&&t&&t.classList.remove("hidden"),r&&a&&a.classList.remove("hidden"),!(!s&&!r))try{const i=await hs();s&&n&&(n.textContent=i.todayAppointments.toString()),r&&o&&(o.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i),s&&n&&(n.textContent="Erro"),r&&o&&(o.textContent="Erro")}}function Zi(){es(),Oa.addEventListener("click",e=>{e.stopPropagation(),nt.classList.toggle("hidden"),nt.classList.contains("hidden")||(He.forEach(t=>t.read=!0),bt())}),Wi.addEventListener("click",()=>{ts()}),At.addEventListener("click",e=>{e.stopPropagation(),J.classList.toggle("active"),J.classList.contains("active")?J.classList.remove("hidden"):setTimeout(()=>J.classList.add("hidden"),200)}),Va&&Va.addEventListener("click",e=>{e.preventDefault(),A("my-profile-section"),J.classList.remove("active"),J.classList.add("hidden")}),document.addEventListener("click",e=>{!nt.contains(e.target)&&e.target!==Oa&&nt.classList.add("hidden"),!J.contains(e.target)&&e.target!==At&&J.classList.contains("active")&&(J.classList.remove("active"),setTimeout(()=>J.classList.add("hidden"),200))}),So(V,async e=>{if(e)try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const n=await _e(a.establishmentId);p.enabledModules=n.modules,Yi(n.themeColor);let o=null,s=e.displayName,r=null;if(a.role==="employee"||a.role==="owner"){const d=_a(Gt,"users",e.uid),c=await Io(d);if(c.exists()){const m=c.data();o=a.role==="employee"?m.permissions||{}:null,s=m.name||s,r=m.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}p.userProfessionalId=r;const i=s||e.email;Uo(a.establishmentId,n.name,o),At.textContent=i.charAt(0).toUpperCase(),Vi.textContent=i,Ui.textContent=e.email,await Gi(e.uid);const l=()=>{Re&&Re(),da(V).then(()=>window.location.href="/login.html")};_i.addEventListener("click",d=>{d.preventDefault(),l()}),ns(A,o,p.enabledModules),Qi(o),Xi(a.establishmentId),bt(),ja.style.display="none",Mt.style.display="flex",A("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),ja.style.display="none",Mt.innerHTML=`
                ...
                `,Mt.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{da(V).then(()=>window.location.href="/login.html")})}else window.location.href="/login.html"})}Zi();
