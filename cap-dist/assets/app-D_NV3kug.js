const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-Cm2yjKxs.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-CZYPZ0h4.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as ie,d as be,m as Za}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Vs,reauthenticateWithCredential as _s,verifyBeforeUpdateEmail as Us,updatePassword as Ws,updateProfile as Js,setPersistence as Gs,browserLocalPersistence as Ys,onAuthStateChanged as Qs,signOut as Xs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as bt,getDoc as _o,updateDoc as Ma,setDoc as Zs,addDoc as Uo,collection as Yt,query as Wo,where as Jo,getDocs as Ks,deleteDoc as er,arrayUnion as tr,orderBy as ar,onSnapshot as or}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as sr,onMessage as rr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const p={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function ir(e,t,a){p.establishmentId=e,p.establishmentName=t,p.userPermissions=a,p.currentViewContext={type:"BRANCH",id:e,name:t}}const Go=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",va=Go?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${Go?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",va);async function nr(){const e=ie.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function L(e,t={}){const a=await nr();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const r=va.replace(/\/$/,""),o=e.startsWith("/")?e:`/${e}`,s=`${r}${o}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${s}`);try{const i=await fetch(s,{...t,headers:{...a,...t.headers}});if(!i.ok){const l=(await i.json().catch(()=>({message:i.statusText}))).message||`Erro na API: ${i.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${s}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${s}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${va}. Verifique se o servidor backend está rodando.`):i}}const Aa=(e,t,a,r=null)=>{let o=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return r&&(o+=`&professionalId=${r}`),L(o)},lr=({establishmentId:e,professionalId:t,serviceIds:a,date:r})=>{const o=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${r}`;return L(o)},dr=e=>L("/api/appointments",{method:"POST",body:JSON.stringify(e)}),cr=(e,t)=>L(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),ur=e=>L(`/api/appointments/${e}`,{method:"DELETE"}),pr=e=>L(`/api/appointments/${e}/reopen`,{method:"POST"}),mr=(e,t)=>L(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Q;async function gr(){if(!Q)try{Q=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function br(){if(!Q){console.warn("AudioContext não inicializado. O som não será tocado.");return}Q.state==="suspended"&&Q.resume();const e=Q.createOscillator(),t=Q.createGain();e.connect(t),t.connect(Q.destination),e.type="sine",e.frequency.setValueAtTime(800,Q.currentTime),t.gain.setValueAtTime(0,Q.currentTime),t.gain.linearRampToValueAtTime(.3,Q.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Q.currentTime+.2),e.start(Q.currentTime),e.stop(Q.currentTime+.2)}function g(e,t,a="info",r=!1){const o=document.getElementById("toast-container");if(!o)return;r&&br();const s=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${i[a]||i.info}`,s.innerHTML=`
    ...
    `,o.appendChild(s),s.querySelector(".toast-close").addEventListener("click",()=>s.remove()),setTimeout(()=>{s.remove()},4e3)}function W(e,t){const a=document.getElementById("genericModal");return new Promise(r=>{a.innerHTML=`
            ...
            </div>`,a.style.display="flex",document.getElementById("genericModalConfirmBtn").onclick=()=>{a.style.display="none",r(!0)},document.getElementById("genericModalCancelBtn").onclick=()=>{a.style.display="none",r(!1)}})}function ne({title:e,contentHTML:t,maxWidth:a="max-w-4xl",showCloseButton:r=!0}){let o=document.getElementById("genericModal");const s=o.cloneNode(!1);o.parentNode.replaceChild(s,o),o=s;const i=()=>{o.style.display="none"},n=c=>{o.querySelector("#genericModalContentBody").innerHTML=c};o.innerHTML=`
    ...
    `;const l=o.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=o.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),o.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),o.style.display="flex",{modalElement:o,close:i,setContent:n}}function fr(){document.body.addEventListener("click",()=>{Q||gr()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const r=t.dataset.target;if(r){const o=document.getElementById(r);o&&(o.style.display="none")}}if(e.target.closest("[data-close-modal]")){const r=document.getElementById("genericModal");r&&(r.style.display="none")}})}const Y=document.getElementById("sidebar"),Pe=document.getElementById("sidebarToggle"),ot=document.getElementById("mainContent"),xr=document.querySelectorAll(".sidebar-link"),ya=document.getElementById("menu-search"),Ka=document.getElementById("hamburger-menu-btn"),We=document.getElementById("mobile-overlay");let fe=!0;function $e(e){if(!Y||!ot)return;Y.classList.toggle("collapsed",e),ot.classList.toggle("sidebar-collapsed-shift",e);const t=Y.querySelector(".sidebar-search-container"),a=Y.querySelectorAll(".sidebar-category");e?(t&&(t.style.display="none"),a.forEach(r=>r.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(r=>{const o=r.getAttribute("data-target-submenu"),s=document.getElementById(o),i=r.querySelector(".submenu-arrow");s&&(s.classList.add("hidden"),s.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(t&&(t.style.display="block"),a.forEach(r=>r.style.display="block"))}function hr(){!Y||!We||(Y.classList.add("mobile-open"),We.classList.add("visible"))}function yt(){!Y||!We||(Y.classList.remove("mobile-open"),We.classList.remove("visible"))}function vr(){$e(!Y.classList.contains("collapsed"))}function yr(e,t){const a=document.getElementById(e);if(!a)return;const r=a.classList.contains("hidden");r&&window.innerWidth>=1024&&Y.classList.contains("collapsed")&&$e(!1),r?(a.classList.remove("hidden"),a.classList.add("flex"),t&&t.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),t&&t.classList.remove("rotate-180"))}function wr(){ya&&ya.addEventListener("input",e=>{const t=e.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const r=a.querySelectorAll("li"),o=a.querySelectorAll(".sidebar-category");if(t===""){r.forEach(s=>s.style.display=""),o.forEach(s=>s.style.display="block");return}o.forEach(s=>s.style.display="none"),r.forEach(s=>{if(s.classList.contains("sidebar-category"))return;const i=s.querySelector(".sidebar-link")||s.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(t)){s.style.display="";const d=s.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const c=d.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const c=document.getElementById(d);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(x=>x.textContent.toLowerCase().includes(t))?s.style.display="":s.style.display="none")}else s.style.display="none"}})})}function kr(e,t,a){if(!Y||!ot)return;ot.classList.add("main-content-shift"),window.innerWidth>=1024?(fe=!0,$e(!1)):window.innerWidth>=768?(fe=!1,$e(!0)):(ot.classList.remove("main-content-shift","sidebar-collapsed-shift"),yt()),Pe&&Pe.addEventListener("click",o=>{o.stopPropagation(),window.innerWidth>=768?(fe=!fe,$e(!fe),fe?(Pe.classList.add("text-indigo-400"),Pe.classList.remove("text-gray-400")):(Pe.classList.remove("text-indigo-400"),Pe.classList.add("text-gray-400"))):vr()}),Y.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!fe&&Y.classList.contains("collapsed")&&$e(!1)}),Y.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!fe){const o=!!document.querySelector("#sidebarToggle:hover"),s=document.activeElement===ya;!o&&!s&&$e(!0)}}),Ka&&Ka.addEventListener("click",o=>{o.stopPropagation(),hr()}),We&&We.addEventListener("click",o=>{o.stopPropagation(),yt()});let r=0;Y.addEventListener("touchstart",o=>{r=o.changedTouches[0].screenX},{passive:!0}),Y.addEventListener("touchend",o=>{const s=o.changedTouches[0].screenX;r-s>50&&yt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(o=>{o.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation();const i=o.getAttribute("data-target-submenu"),n=o.querySelector(".submenu-arrow");yr(i,n)})}),wr(),xr.forEach(o=>{const s=o.getAttribute("data-target");if(!s)return;const i=s.replace("-section",""),n=a?.[i]!==!1,l=t===null||t[s]?.view===!0;if(!n||!l){o.parentElement&&o.parentElement.tagName==="LI"?o.parentElement.style.display="none":o.style.display="none";return}o.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),o.classList.add("active"),s&&typeof e=="function"&&e(s),window.innerWidth<768&&yt()})})}const Sr=e=>L("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),Qe=()=>L("/api/establishments/hierarchy",{method:"GET"}),Ce=e=>{const t=e||p.establishmentId;return t?L(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},qa=(e,t)=>{const a=e||p.establishmentId;return a?L(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},$r=(e,t)=>{const a=e||p.establishmentId;return a?L(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Er=(e,t)=>{const a=e||p.establishmentId;return a?L(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))};class Ir{constructor(t,a,r){this.steps=t,this.currentStep=0,this.onComplete=a,this.onSkip=r,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(t=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),t&&this.onComplete?this.onComplete():!t&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const t=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",t.onBefore&&(await t.onBefore(),await this.sleep(600));const a=await this.waitForElement(t.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const o=a.getBoundingClientRect(),s=8;this.spotlight.style.top=`${o.top+window.scrollY-s}px`,this.spotlight.style.left=`${o.left+window.scrollX-s}px`,this.spotlight.style.width=`${o.width+s*2}px`,this.spotlight.style.height=`${o.height+s*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(o)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const r=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
            <div class="p-5">
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(t){const a=this.popover.getBoundingClientRect(),r=20;let o=t.bottom+window.scrollY+r,s=t.left+window.scrollX;o+a.height>window.scrollY+window.innerHeight&&(o=t.top+window.scrollY-a.height-r),s+a.width>window.innerWidth&&(s=t.right+window.scrollX-a.width),s<r&&(s=r),this.popover.style.top=`${o}px`,this.popover.style.left=`${s}px`}handleResize(){this.isActive&&this.renderStep()}sleep(t){return new Promise(a=>setTimeout(a,t))}async waitForElement(t,a){if(!t)return null;const r=Date.now();for(;Date.now()-r<a;){const o=document.querySelector(t);if(o)return o;await this.sleep(100)}return null}}async function Lr(){try{console.log("A verificar Onboarding interativo...");const e=await Ce(p.establishmentId);if(!e||e.parentId||e.onboardingCompleted)return;const t=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await qa(p.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(o){console.error("Erro ao gravar fim do onboarding",o)}};new Ir(t,a,a).start()}catch(e){console.error("Erro fatal ao iniciar onboarding:",e)}}var Je;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Je||(Je={}));class da extends Error{constructor(t,a,r){super(t),this.message=t,this.code=a,this.data=r}}const Cr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Dr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},r=a.Plugins=a.Plugins||{},o=()=>t!==null?t.name:Cr(e),s=()=>o()!=="web",i=u=>{const m=d.get(u);return!!(m?.platforms.has(o())||n(u))},n=u=>{var m;return(m=a.PluginHeaders)===null||m===void 0?void 0:m.find(x=>x.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,m={})=>{const x=d.get(u);if(x)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),x.proxy;const b=o(),v=n(u);let f;const $=async()=>(!f&&b in m?f=typeof m[b]=="function"?f=await m[b]():f=m[b]:t!==null&&!f&&"web"in m&&(f=typeof m.web=="function"?f=await m.web():f=m.web),f),k=(T,M)=>{var R,O;if(v){const z=v?.methods.find(j=>M===j.name);if(z)return z.rtype==="promise"?j=>a.nativePromise(u,M.toString(),j):(j,C)=>a.nativeCallback(u,M.toString(),j,C);if(T)return(R=T[M])===null||R===void 0?void 0:R.bind(T)}else{if(T)return(O=T[M])===null||O===void 0?void 0:O.bind(T);throw new da(`"${u}" plugin is not implemented on ${b}`,Je.Unimplemented)}},w=T=>{let M;const R=(...O)=>{const z=$().then(j=>{const C=k(j,T);if(C){const V=C(...O);return M=V?.remove,V}else throw new da(`"${u}.${T}()" is not implemented on ${b}`,Je.Unimplemented)});return T==="addListener"&&(z.remove=async()=>M()),z};return R.toString=()=>`${T.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:T,writable:!1,configurable:!1}),R},D=w("addListener"),I=w("removeListener"),q=(T,M)=>{const R=D({eventName:T},M),O=async()=>{const j=await R;I({eventName:T,callbackId:j},M)},z=new Promise(j=>R.then(()=>j({remove:O})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await O()},z},N=new Proxy({},{get(T,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?q:D;case"removeListener":return I;default:return w(M)}}});return r[u]=N,d.set(u,{name:u,proxy:N,platforms:new Set([...Object.keys(m),...v?[b]:[]])}),N};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=o,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=i,a.registerPlugin=c,a.Exception=da,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Tr=e=>e.Capacitor=Dr(e),pe=Tr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Qt=pe.registerPlugin;class Yo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let r=!1;this.listeners[t]||(this.listeners[t]=[],r=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),r&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,r){const o=this.listeners[t];if(!o){if(r){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}o.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:r=>{this.notifyListeners(a,r)}}}unimplemented(t="not implemented"){return new pe.Exception(t,Je.Unimplemented)}unavailable(t="not available"){return new pe.Exception(t,Je.Unavailable)}async removeListener(t,a){const r=this.listeners[t];if(!r)return;const o=r.indexOf(a);this.listeners[t].splice(o,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(r=>{this.notifyListeners(t,r)}))}}const eo=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),to=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Br extends Yo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(r=>{if(r.length<=0)return;let[o,s]=r.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=to(o).trim(),s=to(s).trim(),a[o]=s}),a}async setCookie(t){try{const a=eo(t.key),r=eo(t.value),o=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${r||""}${o}; path=${s}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Qt("CapacitorCookies",{web:()=>new Br});const Pr=async e=>new Promise((t,a)=>{const r=new FileReader;r.onload=()=>{const o=r.result;t(o.indexOf(",")>=0?o.split(",")[1]:o)},r.onerror=o=>a(o),r.readAsDataURL(e)}),Mr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(o=>o.toLocaleLowerCase()).reduce((o,s,i)=>(o[s]=e[t[i]],o),{})},Ar=(e,t=!0)=>e?Object.entries(e).reduce((r,o)=>{const[s,i]=o;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=t?encodeURIComponent(d):d,l+=`${s}=${n}&`}),l.slice(0,-1)):(n=t?encodeURIComponent(i):i,l=`${s}=${n}`),`${r}&${l}`},"").substr(1):null,qr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),o=Mr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(o.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[i,n]of Object.entries(e.data||{}))s.set(i,n);a.body=s.toString()}else if(o.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((n,l)=>{s.append(l,n)});else for(const n of Object.keys(e.data))s.append(n,e.data[n]);a.body=s;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(o.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Rr extends Yo{async request(t){const a=qr(t,t.webFetchExtra),r=Ar(t.params,t.shouldEncodeUrlParams),o=r?`${t.url}?${r}`:t.url,s=await fetch(o,a),i=s.headers.get("content-type")||"";let{responseType:n="text"}=s.ok?t:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await s.blob(),l=await Pr(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const c={};return s.headers.forEach((u,m)=>{c[m]=u}),{data:l,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Qt("CapacitorHttp",{web:()=>new Rr});const ee=Qt("PushNotifications",{}),jr="modulepreload",Nr=function(e){return"/"+e},ao={},Fr=function(t,a,r){let o=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");o=l(a.map(d=>{if(d=Nr(d),d in ao)return;ao[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":jr,c||(m.as="script"),m.crossOrigin="",m.href=d,n&&m.setAttribute("nonce",n),document.head.appendChild(m),c)return new Promise((x,b)=>{m.addEventListener("load",x),m.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return o.then(i=>{for(const n of i||[])n.status==="rejected"&&s(n.reason);return t().catch(s)})},oo=Qt("App",{web:()=>Fr(()=>import("./web-Cm2yjKxs.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Hr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let so=!1;async function Or(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await ee.removeAllListeners(),await ee.addListener("registration",async a=>{Xo(a.value,!0)}),await ee.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await ee.addListener("pushNotificationActionPerformed",a=>{const r=a.notification.data;console.log("Notificação clicada (Ação):",r)});let t=await ee.checkPermissions();t.receive==="prompt"&&(t=await ee.requestPermissions()),t.receive==="granted"&&await ee.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Qo()}async function zr(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Qo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Qo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await sr(Za,{vapidKey:Hr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Xo(t,!1)):console.warn("[Push Web] Token veio vazio."),so||(rr(Za,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),so=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Xo(e,t){const a=ie.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const r=bt(be,"users",a.uid);try{const o=await _o(r);if(o.exists()){const i=o.data().fcmTokens||[];if(i.length===1&&i[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Ma(r,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(o){if(o.code==="not-found")try{await Zs(r,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(s){console.error("Erro ao criar user:",s)}else console.error("Erro ao atualizar token:",o)}}const Vr=(e,t,a="all",r="all")=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("professionalId",a),r&&r!=="all"&&o.append("costCenterId",r),L(`/api/reports/indicators?${o.toString()}`)},_r=e=>e?L(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Ur=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:r})=>{const o=new URLSearchParams({startDate:t,endDate:a});return r&&r!=="all"&&o.append("cashierSessionId",r),e&&o.append("establishmentId",e),L(`/api/reports/sales?${o.toString()}`)},Wr=()=>L("/api/reports/summary",{method:"GET"}),Ra=e=>e?String(e).replace(/\D/g,""):"",Xt=(e,t="",a=20,r={})=>{const o=new URLSearchParams;return t&&o.append("search",t),a&&o.append("limit",a),r&&r.hasLoyalty&&o.append("hasLoyalty","true"),r&&r.birthMonth&&o.append("birthMonth",r.birthMonth),r&&r.inactiveDays&&o.append("inactiveDays",r.inactiveDays),L(`/api/clients/${e}?${o.toString()}`)},Zo=(e,t)=>{const a=encodeURIComponent(t);return L(`/api/clients/details/${e}/${a}`)},Ko=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Ra(t),r={...e,phone:a,id:a};return L(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(r)})},es=Ko,ts=(e,t)=>Ko({...t,id:e}),Jr=e=>{const t=encodeURIComponent(e);return L(`/api/clients/${t}`,{method:"DELETE"})},Gr=(e,t,a,r)=>L("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ra(t),points:a,rewardName:r})}),Yr=(e,t)=>Zo(e,Ra(t));function h(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function as(e,t=800,a=800,r=.7){return new Promise((o,s)=>{if(!e.type.match(/image.*/))return s(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(e),i.onload=n=>{const l=new Image;l.src=n.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const x=u.toDataURL("image/jpeg",r);o(x)},l.onerror=d=>s(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>s(new Error("Erro ao ler o ficheiro."))})}let ca=null;async function Qr(){const e=document.getElementById("content");e.innerHTML=`
    ...
    `;try{const t=new Date,a=new Date(t.getFullYear(),t.getMonth(),t.getDate()),r=new Date(a);r.setHours(23,59,59,999);const o=new Date(a.getFullYear(),a.getMonth(),1),s=new Date(a);s.setDate(a.getDate()-6);const i=p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId],n=i.map(async C=>{const[V,Z]=await Promise.all([Aa(C,o.toISOString(),r.toISOString(),null),Xt(C)]);return{appts:V||[],clients:Z||[]}}),l=await Promise.all(n);let d=[],c=[];l.forEach(C=>{d=d.concat(C.appts),c=c.concat(C.clients)});const u=C=>(C.services||[]).reduce((V,Z)=>V+(Number(Z.price)||0),0)||Number(C.totalPrice||0)||Number(C.servicePrice||0),m=d.filter(C=>{const V=new Date(C.startTime);return V>=a&&V<=r}),x=m.filter(C=>C.status==="completed"),b=d.filter(C=>C.status==="completed"),v=x.reduce((C,V)=>C+u(V),0),f=b.reduce((C,V)=>C+u(V),0),$=m.length,k=b.length>0?f/b.length:0,w=[],D=[],I=["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"];for(let C=0;C<7;C++){const V=new Date(s);V.setDate(s.getDate()+C),w.push(I[V.getDay()]);const Z=new Date(V).setHours(0,0,0,0),se=new Date(V).setHours(23,59,59,999),we=d.filter(ht=>{const vt=new Date(ht.startTime).getTime();return ht.status==="completed"&&vt>=Z&&vt<=se}).reduce((ht,vt)=>ht+u(vt),0);D.push(we)}const q={labels:w,data:D},N=m.filter(C=>new Date(C.startTime).getTime()>=t.getTime()&&C.status!=="completed"&&C.status!=="cancelled").sort((C,V)=>new Date(C.startTime)-new Date(V.startTime)).slice(0,4).map(C=>({client:C.clientName||"Desconhecido",service:C.serviceName||(C.services&&C.services[0]?C.services[0].name:"Serviço"),time:new Date(C.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(C.professionalName||"").split(" ")[0]||"Profissional",id:C.id})),T=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,M=new Map;c.forEach(C=>{C.phone?M.set(C.phone,C):M.set(C.id||Math.random().toString(),C)});const O=Array.from(M.values()).filter(C=>{if(!C.birthDate)return!1;let V,Z;if(C.birthDate.includes("-")){const se=C.birthDate.split("-");se[0].length===4?(V=se[1],Z=se[2]):(Z=se[0],V=se[1])}else if(C.birthDate.includes("/")){const se=C.birthDate.split("/");Z=se[0],V=se[1]}return`${Z}/${V}`===T}).map(C=>{let V="";return C.birthDate&&C.birthDate.includes("-")&&C.birthDate.split("-")[0].length===4&&(V=a.getFullYear()-parseInt(C.birthDate.split("-")[0])),{name:C.name,age:V,phone:C.phone}}),z={receitaHoje:v,agendamentosHoje:$,receitaMes:f,ticketMedio:k},j=i.length>1;Xr(e,z,q,N,O,j),Zr(q),Kr()}catch(t){console.error("Erro ao carregar dashboard:",t),e.innerHTML=`
        ...
        `}}function Xr(e,t,a,r,o,s){const i=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),n=s?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-0.5 rounded-full ml-2 align-middle">CONSOLIDADO</span>':"";e.innerHTML=`
    ...
    `}function Zr(e){const t=document.getElementById("revenueChart");if(!t)return;ca&&ca.destroy();const r=t.getContext("2d").createLinearGradient(0,0,0,240);r.addColorStop(0,"rgba(79, 70, 229, 0.15)"),r.addColorStop(1,"rgba(79, 70, 229, 0.01)"),ca=new Chart(t,{type:"line",data:{labels:e.labels,datasets:[{label:"Receita (R$)",data:e.data,borderColor:"#6366f1",backgroundColor:r,borderWidth:2.5,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.35}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,cornerRadius:8,titleFont:{size:12,family:"Inter",weight:"normal"},bodyFont:{size:13,weight:"bold",family:"Inter"},displayColors:!1,callbacks:{label:function(o){return o.parsed.y!==null?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(o.parsed.y):""}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:10},maxTicksLimit:6,callback:function(o){return"R$ "+o}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function Kr(){document.getElementById("content").addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":J("agenda-section");break;case"new-appointment":J("agenda-section");break;case"goto-pdv":J("comandas-section");break;case"goto-clients":J("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${p.establishmentId||""}`;window.open(o,"_blank");break}})}const Te=e=>L(`/api/services/${e}`),ei=e=>L("/api/services",{method:"POST",body:JSON.stringify(e)}),ti=(e,t)=>L(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),ai=e=>L(`/api/services/${e}`,{method:"DELETE"}),oi=(e,t)=>L(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),si=e=>L(`/api/services/stats/most-popular/${e}`),le=e=>L(`/api/professionals/${e}`),ri=e=>L(`/api/professionals/details/${e}`),ii=e=>L("/api/professionals",{method:"POST",body:JSON.stringify(e)}),ni=(e,t)=>L(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),os=e=>L(`/api/professionals/${e}`,{method:"DELETE"}),li=e=>{const t=e.map(a=>os(a));return Promise.all(t)},Zt=(e,t,a,r="all")=>{const o=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${r}`;return L(o)},Kt=e=>L("/api/blockages",{method:"POST",body:JSON.stringify(e)}),ja=e=>L(`/api/blockages/${e}`,{method:"DELETE"}),ss=e=>L("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),ro=document.getElementById("content");let io=!1;const wa=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let ea=[],ka=[],jt={},rs=[],B={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},A={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Na(e){const t=new Date(e),a=t.getDay(),r=t.getDate()-a+(a===0?-6:1);return t.setDate(r),t.setHours(0,0,0,0),t}function Fa(){const e=document.getElementById("profSelectorContainer");if(!e||!p.professionals)return;let t=p.professionals.filter(o=>B.showInactiveProfs||o.status!=="inactive");const r=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=r.map(o=>{const s=B.selectedProfessionalId===o.id,i=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),n=o.id!=="all"?p.professionalColors.get(o.id)||wa[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            <div class="prof-pill ${s?"active":""}"
                 data-action="select-professional" data-prof-id="${o.id}"
                 style="--pc: ${n.main}; --pb: ${s?n.bg:""}; --pl: ${n.light};">
                <div class="prof-pill-dot" ${o.photo?`style="background-image: url('${_(o.photo)}'); background-size: cover; background-position: center;"`:""}>
                    ${o.photo?"":i}
                </div>
                <span>${_(o.name==="Todos"?"Todos":o.name.split(" ")[0])}</span>
            </div>`}).join("")}function _(e){return h(e||"")}function di(e,t,a,r,o){const s=(e||"").replace(/\D/g,""),i=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com ${r} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${s}?text=${encodeURIComponent(l)}`}function ci(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],r=Na(B.currentDate),o=new Date;o.setHours(0,0,0,0);let s='<div class="week-container" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(r);n.setDate(r.getDate()+i);const l=n.toDateString()===o.toDateString(),d=e.filter(u=>new Date(u.startTime).toDateString()===n.toDateString()).sort((u,m)=>new Date(u.startTime)-new Date(m.startTime));let c="";d.length===0?c='<div class="week-empty"><i class="bi bi-dash-lg" style="font-size:1rem;display:block;margin-bottom:4px;"></i>Sem agendamentos</div>':c=d.map(u=>{const x=new Date(u.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),b=p.professionalColors.get(u.professionalId)||{main:"#adb5bd"},v=u.status==="completed",f=B.selectedItems.has(u.id);if(u.type==="blockage")return`<div class="week-event-chip week-blockage">
                    ...
                    </div>`;const $=JSON.stringify(u).replace(/'/g,"&apos;"),k=f?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"",w=B.isSelectionMode?`<div style="position:absolute; top:6px; right:6px; z-index:1;">
                           <input type="checkbox" style="width:16px; height:16px; accent-color:#4f46e5; pointer-events:none;" ${f?"checked":""}>
                       </div>`:"";return`<div class="week-event-chip ${v?"completed":""}" style="--ec: ${b.main}; ${k}"
                    data-action="edit-appointment" data-appointment='${$}'>
                    ${w}
                    <div class="we-time">${x}</div>
                    <div class="we-client" style="${B.isSelectionMode?"padding-right:20px;":""}">${_(u.clientName)}</div>
                ...
                </div>`}).join(""),s+=`<div class="week-day-col">
            ...
            </div>`;return}const a={};e.forEach(o=>{const s=new Date(o.startTime).toLocaleDateString("pt-BR",{weekday:"long",day:"numeric",month:"long"});a[s]||(a[s]=[]),a[s].push(o)});let r='<div class="list-container">';Object.entries(a).forEach(([o,s])=>{r+=`<div class="list-date-group">
            <div class="list-date-label">${o}</div>`,s.forEach(i=>{const n=new Date(i.startTime),l=new Date(i.endTime),d=Math.round((l-n)/6e4),c=n.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=p.professionalColors.get(i.professionalId)||{main:"#adb5bd"},m=i.status==="completed",x=JSON.stringify(i).replace(/'/g,"&apos;"),b=B.selectedItems.has(i.id),v=B.isSelectionMode?`<div style="display:flex; align-items:center; margin-right: 12px; margin-left: 4px;">
                ...
                </div>`;return}const $=di(i.clientPhone,i.clientName,i.serviceName,i.professionalName,i.startTime),k=(i.services||[]).reduce((q,N)=>q+(Number(N.price)||0),0)||Number(i.totalPrice||0)||Number(i.servicePrice||0),w=i.paymentStatus||(i.status==="completed"?"Finalizado":"Agendado"),D=_((i.professionalName||"").split(" ")[0]),I=(i.services||[]).length||(i.serviceName?1:0);r+=`<div class="list-card ${m?"completed":""}" style="${f}"
                ...
                <div class="list-card-info">
                    ...
                    <div class="lc-detail">${_(i.serviceName)} · ${D}</div>
                    <div class="lc-extra" style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 8px;">
                        <span style="font-size: 0.65rem; color: #4b5563; background: #f3f4f6; padding: 2px 8px; border-radius: 6px; font-weight: 500;">R$ ${k.toFixed(2).replace(".",",")}</span>
                        ...
                        <span style="font-size: 0.65rem; color: #4b5563; background: #f3f4f6; padding: 2px 8px; border-radius: 6px; font-weight: 500;">${I} serv.</span>
                        <span style="font-size: 0.65rem; color: ${m?"#059669":"#d97706"}; background: ${m?"#d1fae5":"#fef3c7"}; padding: 2px 8px; border-radius: 6px; font-weight: 600;">${_(w)}</span>
                    </div>
                </div>
            ...
            </div>`}),r+="</div>"}),r+="</div>",t.innerHTML=r}function is(){const e=p.allEvents.filter(t=>B.selectedProfessionalId==="all"||t.professionalId===B.selectedProfessionalId);B.currentView==="list"?ui(e):ci(e),Ha()}function Ha(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(B.isSelectionMode&&B.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
            <span class="font-semibold text-sm"><span style="color:#7c3aed; font-size:1.1rem; margin-right:4px;">${B.selectedItems.size}</span> selecionados</span>
        ...
        </div>`,e.style.display="block",t&&(t.style.transform="scale(0)")):(e.style.display="none",t&&(t.style.transform="scale(1)")))}function pi(){const e=document.getElementById("currentDateDisplay");if(!e)return;const t=new Date;t.setHours(0,0,0,0);const a=new Date(B.currentDate);if(a.setHours(0,0,0,0),B.currentView==="list")a.toDateString()===t.toDateString()?e.textContent="Hoje":e.textContent=a.toLocaleDateString("pt-BR",{day:"numeric",month:"long"});else{const r=Na(a),o=new Date(r);o.setDate(r.getDate()+6);const s=r.toLocaleDateString("pt-BR",{day:"numeric",month:"short"}),i=o.toLocaleDateString("pt-BR",{day:"numeric",month:"short"});e.textContent=`${s} - ${i}`}}async function ve(){const e=document.getElementById("agenda-view");if(!e)return;B.selectedItems.clear(),Ha(),e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;padding:60px 0;"><div style="width:28px;height:28px;border:2.5px solid #e9ecef;border-top:2.5px solid #4f46e5;border-radius:50%;animation:spin 0.7s linear infinite;"></div></div><style>@keyframes spin{to{transform:rotate(360deg)}}</style>',pi();let t,a;if(B.currentView==="list")t=new Date(B.currentDate),t.setHours(0,0,0,0),a=new Date(t),a.setHours(23,59,59,999);else{const r=Na(B.currentDate);t=new Date(r),a=new Date(r),a.setDate(r.getDate()+6),a.setHours(23,59,59,999)}try{const o=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(async d=>{const[c,u]=await Promise.all([Aa(d,t.toISOString(),a.toISOString(),B.selectedProfessionalId==="all"?null:B.selectedProfessionalId),Zt(d,t.toISOString(),a.toISOString(),B.selectedProfessionalId)]);return{appts:c||[],blockages:u||[]}}),s=await Promise.all(o);let i=[],n=[];if(s.forEach(d=>{i=i.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(c=>({...c,type:c.type||"appointment",professionalName:c.professionalName||(()=>{const u=p.professionals?.find(m=>m.id===c.professionalId);return u?u.name:"Indefinido"})()}));p.allEvents=[...l(i),...l(n)],Fa(),is()}catch(r){console.error(r),document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12" style="color:#868e96;">
                    <i class="bi bi-exclamation-triangle" style="font-size:1.5rem;"></i>
                    <p class="mt-2" style="font-size:0.8rem;">Erro ao carregar agenda.</p>
                </div>`)}}async function mi(){try{const t=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(async i=>{const[n,l,d]=await Promise.all([le(i),Te(i),Ce(i)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(t),r=new Map,o=new Map;let s=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>r.set(n.id,n)),i.services.forEach(n=>o.set(n.id,n))}),p.professionals=Array.from(r.values()),p.services=Array.from(o.values()),rs=[],s&&(jt=s.loyaltyProgram||{enabled:!1}),p.professionals.forEach((i,n)=>{p.professionalColors.set(i.id,wa[n%wa.length])}),Fa()}catch{g("Atenção","Não foi possível carregar os dados da equipa.","error")}}async function ns(e={}){B.currentDate=e.targetDate?new Date(e.targetDate):B.currentDate||new Date,B.isSelectionMode=!1,B.selectedItems.clear(),ro.innerHTML=`
            ...
            <div style="background: #fff; padding: 14px 16px; border-bottom: 1px solid #f1f3f5; position: sticky; top: 0; z-index: 10; display:flex; flex-direction:column; gap:16px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div class="agenda-view-toggle" style="background: #f1f3f5; padding: 4px; border-radius: 12px; display:flex; gap:4px; margin:0;">
                        <button class="${B.currentView==="list"?"active shadow-sm":""}" data-action="setView" data-view="list" style="border-radius: 8px; padding: 6px 16px; font-weight:600;">Lista</button>
                        <button class="${B.currentView==="week"?"active shadow-sm":""}" data-action="setView" data-view="week" style="border-radius: 8px; padding: 6px 16px; font-weight:600;">Semana</button>
                    </div>
        ...
        </div>`,document.getElementById("btnPrevDate").addEventListener("click",()=>{B.currentView==="list"?B.currentDate.setDate(B.currentDate.getDate()-1):B.currentDate.setDate(B.currentDate.getDate()-7),ve()}),document.getElementById("btnNextDate").addEventListener("click",()=>{B.currentView==="list"?B.currentDate.setDate(B.currentDate.getDate()+1):B.currentDate.setDate(B.currentDate.getDate()+7),ve()}),document.getElementById("btnTodayHeader").addEventListener("click",()=>{B.currentDate=new Date,ve()});const t=document.querySelectorAll(".agenda-view-toggle button");t.forEach(a=>{a.addEventListener("click",()=>{t.forEach(r=>{r.classList.remove("active","shadow-sm"),r.style.backgroundColor="transparent"}),a.classList.add("active","shadow-sm"),a.style.backgroundColor="#fff",B.currentView=a.dataset.view,ve()})}),document.getElementById("btnWeekDays").addEventListener("click",()=>{gi()}),io||(ro.addEventListener("click",async a=>{const r=a.target.closest('[data-action="open-comanda"]');if(r){a.stopPropagation();const l=r.dataset.appointment||r.closest("[data-appointment]")?.dataset.appointment;if(!l)return;const d=JSON.parse(l.replace(/&apos;/g,"'")),c=d.status==="completed"?"finalizadas":"em-atendimento",u={selectedAppointmentId:d.id,initialFilter:c};c==="finalizadas"&&d.transaction?.paidAt&&(u.filterDate=typeof d.transaction.paidAt=="object"?new Date(d.transaction.paidAt._seconds*1e3):d.transaction.paidAt),J("comandas-section",u);return}const o=a.target.closest(".lc-action-btn.wa");if(o){a.stopPropagation(),o.dataset.link&&window.open(o.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const l=B.selectedItems.size;await W("Excluir Selecionados",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)&&(await Promise.all(Array.from(B.selectedItems).map(async c=>{try{await ur(c)}catch{}})),g(`${l} agendamento(s) excluído(s).`,"success"),B.selectedItems.clear(),B.isSelectionMode=!1,ve());return}const s=a.target.closest('[data-action="select-professional"]');if(s){const l=s.dataset.profId;B.selectedProfessionalId=B.selectedProfessionalId===l&&l!=="all"?"all":l,ve();return}const i=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(i){if(B.isSelectionMode){a.stopPropagation();const d=i.querySelector('input[type="checkbox"]');if(d){const c=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'")),u=!d.checked;d.checked=u,u?B.selectedItems.add(c.id):B.selectedItems.delete(c.id),(i.classList.contains("week-event-chip")||i.classList.contains("list-card"))&&(u?(i.style.boxShadow="0 0 0 2px #4f46e5",i.style.backgroundColor="#eff6ff"):(i.style.boxShadow="none",i.style.backgroundColor=i.classList.contains("week-event-chip")?"#f8f9fa":"#fff")),Ha()}return}const l=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"));Sa(l);return}if(a.target.closest('[data-action="new-appointment"]')){Sa();return}}),io=!0),await mi(),await ve()}function gi(){const e=document.getElementById("optionsSheet");if(e){e.remove();return}const t=document.createElement("div");t.id="optionsSheet",t.style.cssText="position:fixed;bottom:0;left:50%;right:auto;transform:translateX(-50%) translateY(100%);width:100%;max-width:440px;background:#fff;border-radius:24px 24px 0 0;z-index:10000;box-shadow:0 -8px 40px rgba(0,0,0,0.15);transition:transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);";const a=B.isSelectionMode?"#fee2e2":"#f0fdf4",r=B.isSelectionMode?"#ef4444":"#16a34a",o=B.isSelectionMode?"bi-x-circle":"bi-check2-square";t.innerHTML=`
        <div style="padding:20px 24px;">
            ...
            <div style="margin-bottom:20px;">
                ...
                <button id="optSelectMode" style="width:100%;padding:12px 16px;border:none;background:${a};border-radius:12px;font-size:0.9rem;font-weight:600;color:${r};cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:background 0.2s;">
                    <i class="bi ${o}"></i> ${B.isSelectionMode?"Desativar Modo de Exclusão":"Ativar Seleção para Excluir"}
                </button>
                <p style="font-size:0.75rem; color:#6b7280; text-align:center; margin-top:8px;">${B.isSelectionMode?"Toque num card para desmarcar.":"Permite selecionar vários agendamentos para apagar de uma vez."}</p>
            </div>
            ...
            <div style="margin-bottom:16px;">
                ...
                <label style="display:flex;align-items:center;gap:12px;font-size:0.9rem;font-weight:500;color:#374151;cursor:pointer;padding:8px 0; background:#f9fafb; border-radius:12px; padding:12px 16px;">
                    <input type="checkbox" id="optInactiveToggle" style="width:18px;height:18px;accent-color:#4f46e5;" ${B.showInactiveProfs?"checked":""}>
                    Exibir profissionais inativos na barra superior
                </label>
            </div>
        </div>`;const s=document.createElement("div");s.id="optionsOverlay",s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.4);z-index:9999;opacity:0;transition:opacity 0.3s;",document.body.appendChild(s),document.body.appendChild(t),requestAnimationFrame(()=>{t.style.transform="translateX(-50%) translateY(0)",s.style.opacity="1"});const i=()=>{t.style.transform="translateX(-50%) translateY(100%)",s.style.opacity="0",setTimeout(()=>{t.remove(),s.remove()},300)};document.getElementById("closeOptSheet").addEventListener("click",i),s.addEventListener("click",i),document.getElementById("optSelectMode").addEventListener("click",()=>{B.isSelectionMode=!B.isSelectionMode,B.isSelectionMode||B.selectedItems.clear(),i(),is(),B.isSelectionMode&&setTimeout(()=>{g("Modo de Exclusão Ativo.","info")},300)}),document.getElementById("optInactiveToggle").addEventListener("change",n=>{B.showInactiveProfs=n.target.checked,Fa()})}function no(e){e<1||e>4||(A.step=e,Sa(null,!0))}function bi(e){return{title:e?"Editar Reserva":"Identificar Cliente",content:`
        <div class="p-5 space-y-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-gray-500 mb-1.5">Nome *</label>
                    <input type="text" id="apptClientName" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm" value="${_(A.data.clientName)}">
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-500 mb-1.5">Telefone/WhatsApp *</label>
                    <input type="tel" id="apptClientPhone" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm" value="${_(A.data.clientPhone)}">
                </div>
            </div>
        ...
        <div class="p-5 space-y-5">
            <div class="flex items-center gap-3">
                ...
                <label class="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg border border-gray-200">
                    <input type="checkbox" id="multiServiceToggle" class="w-4 h-4 rounded" ${A.data.selectedServiceIds.length>1?"checked":""}>
            ...
            <div id="apptServicesContainer" class="grid grid-cols-2 gap-3 max-h-56 overflow-y-auto">
                ${ea.map(e=>`<div class="service-card p-3 bg-white rounded-xl border ${A.data.selectedServiceIds.includes(e.id)?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer" data-service-id="${e.id}">
        ...
        <div class="p-5 space-y-5">
            ...
            <div id="apptProfessionalContainer" class="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-52 overflow-y-auto professional-step-cards">
                ${ka.map(e=>`<div class="professional-modal-card p-3 bg-white rounded-xl border ${A.data.professionalId===e.id?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer text-center" data-professional-id="${e.id}">
        ...
        </div>`}}function hi(){const e=A.data.date||new Date().toISOString().split("T")[0];return{title:"Data e Horário",content:`
        <div class="p-5 space-y-5">
            <div class="flex items-center gap-3 p-3 bg-indigo-50 rounded-xl">
                <div class="w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold flex-shrink-0">${_(A.data.clientName).charAt(0)}</div>
                <div class="min-w-0">
                    <p class="font-semibold text-sm text-gray-900 truncate">${_(A.data.clientName)}</p>
                    <p class="text-xs text-gray-500 truncate">${_(A.data.professionalName)}</p>
                </div>
            </div>
            <div>
        ...
        <div class="px-5 py-4 border-t border-gray-100 flex justify-between gap-3">
            ...
            <button type="submit" class="py-2.5 px-8 bg-indigo-600 text-white font-semibold text-sm rounded-lg flex items-center gap-2"><i class="bi bi-calendar-check"></i> ${A.data.id?"Salvar":"Agendar"}</button>
        </div>`}}async function Sa(e=null,t=!1){const a=document.getElementById("appointmentModal");t||(A={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(o=>o.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],time:e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}),ea=p.services||[],ka=(p.professionals||[]).filter(o=>o.status==="active");let r;switch(A.step){case 1:r=bi(e);break;case 2:r=fi();break;case 3:r=xi();break;case 4:r=hi();break}a.innerHTML=`
        <div class="modal-content max-w-xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden m-4 flex flex-col" style="max-height:90vh;">
            <header class="px-5 py-4 border-b border-gray-100 flex justify-between items-center bg-white">
                <div class="flex items-center gap-3">
                    <span class="w-7 h-7 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-xs">${A.step}/4</span>
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>o.addEventListener("click",()=>{const s=parseInt(o.dataset.currentStep,10);if(s===1&&(A.data.clientName=a.querySelector("#apptClientName").value.trim(),A.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!A.data.clientName))return g("Preencha o nome do cliente.","warning");if(s===2&&A.data.selectedServiceIds.length===0)return g("Selecione um serviço.","warning");if(s===3&&!A.data.professionalId)return g("Escolha um profissional.","warning");no(s+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>o.addEventListener("click",()=>no(parseInt(o.dataset.currentStep,10)-1))),a.querySelector('[data-action="close-modal"]')?.addEventListener("click",()=>{a.style.display="none"}),A.step===4&&a.querySelector("#appointmentForm").addEventListener("submit",vi),a.style.display="flex",A.step===2&&a.querySelectorAll(".service-card").forEach(o=>o.addEventListener("click",()=>{const s=a.querySelector("#multiServiceToggle")?.checked,i=o.classList.contains("selected");s||(a.querySelectorAll(".service-card.selected").forEach(l=>l.classList.remove("selected","border-indigo-500","bg-indigo-50")),A.data.selectedServiceIds=[]);const n=o.dataset.serviceId;i?(o.classList.remove("selected","border-indigo-500","bg-indigo-50"),A.data.selectedServiceIds=A.data.selectedServiceIds.filter(l=>l!==n)):(o.classList.add("selected","border-indigo-500","bg-indigo-50"),A.data.selectedServiceIds.push(n))})),A.step===3&&a.querySelectorAll(".professional-modal-card").forEach(o=>o.addEventListener("click",()=>{a.querySelectorAll(".professional-modal-card.selected").forEach(i=>i.classList.remove("selected","border-indigo-500","bg-indigo-50")),o.classList.add("selected","border-indigo-500","bg-indigo-50"),A.data.professionalId=o.dataset.professionalId;const s=ka.find(i=>i.id===o.dataset.professionalId);A.data.professionalName=s?s.name:""})),A.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",o=>wi(o.target.value)),A.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",lo),lo(),yi())}async function vi(e){e.preventDefault();const a=e.target.querySelector('button[type="submit"]');if(!A.data.time||!A.data.selectedServiceIds.length||!A.data.professionalId)return g("Selecione horário, serviço e profissional.","warning");a.disabled=!0,a.innerHTML="Aguarde...";const r=A.data.selectedServiceIds.map(d=>{const c=ea.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[o,s]=A.data.time.split(":"),i=new Date(`${A.data.date}T${o}:${s}:00`),l={establishmentId:p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments[0]:p.establishmentId,clientName:A.data.clientName,clientPhone:A.data.clientPhone,services:r,professionalId:A.data.professionalId,professionalName:A.data.professionalName,startTime:i.toISOString(),redeemedReward:A.data.redeemedReward};A.data.id&&(l.id=A.data.id);try{A.data.id?await cr(A.data.id,l):await dr(l),g("Agendamento registrado!","success"),document.getElementById("appointmentModal").style.display="none",ve()}catch(d){g(d.message,"error"),a.disabled=!1,a.textContent="Agendar"}}async function lo(){const e=document.getElementById("availableTimesContainer"),t=document.getElementById("apptTotalDuration");if(!e)return;const a=A.data.selectedServiceIds.reduce((i,n)=>{const l=ea.find(d=>d.id===n);return i+(l?l.duration+(l.bufferTime||0):0)},0);t&&(t.textContent=`${a} min`);const{professionalId:r,selectedServiceIds:o,date:s}=A.data;if(!r||!o.length||!s){e.innerHTML='<p class="col-span-full text-center text-xs text-gray-400">Selecione serviço e profissional</p>';return}try{const i=p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments[0]:p.establishmentId;let n=await lr({establishmentId:i,professionalId:r,serviceIds:o,date:s});const l=new Date;if(new Date(s+"T00:00:00").toDateString()===l.toDateString()){const d=l.getHours()*60+l.getMinutes();n=n.filter(c=>{const[u,m]=c.split(":").map(Number);return u*60+m>=d})}e.innerHTML=n.length>0?n.map(d=>`<button type="button" class="p-2 text-sm font-semibold rounded-lg border ${A.data.time===d?"bg-indigo-600 text-white border-indigo-600":"bg-gray-50 text-gray-700 border-gray-200 hover:bg-indigo-50"}" onclick="document.querySelectorAll('#availableTimesContainer button').forEach(b=>{b.classList.remove('bg-indigo-600','text-white','border-indigo-600');b.classList.add('bg-gray-50','text-gray-700','border-gray-200')});this.classList.add('bg-indigo-600','text-white','border-indigo-600');this.classList.remove('bg-gray-50','text-gray-700','border-gray-200');window._selectedTime='${d}';">${d}</button>`).join(""):'<p class="col-span-full text-center text-xs text-gray-400">Sem horários</p>'}catch{e.innerHTML='<p class="col-span-full text-center text-xs text-red-400">Erro</p>'}}function yi(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a}=A.data,{enabled:r,rewards:o}=jt;if(!r||!t||!o?.length){e.innerHTML="";return}const s=o.filter(i=>a>=i.points);if(!s.length){e.innerHTML='<p class="text-xs text-gray-400">Sem recompensas disponíveis.</p>';return}e.innerHTML=`<div class="border-t border-gray-100 pt-4">
        <p class="text-xs font-semibold text-gray-500 mb-2">Resgate fidelidade (${a} pts)</p>
        ${s.map(i=>`<label class="flex items-center gap-3 p-2 bg-gray-50 rounded-lg mb-1 cursor-pointer"><input type="radio" name="loyaltyReward" value="${_(i.reward)}" data-points="${i.points}" class="accent-indigo-600"><span class="text-sm">${_(i.reward)} (-${i.points} pts)</span></label>`).join("")}
    </div>`,e.querySelectorAll('input[name="loyaltyReward"]').forEach(i=>{i.addEventListener("change",n=>{n.target.checked&&(A.data.redeemedReward={reward:n.target.value,points:parseInt(n.target.dataset.points,10)})})})}async function wi(e){const t=document.getElementById("clientSearchResults");if(!t||e.trim().length<3){t&&(t.innerHTML='<p class="text-xs text-gray-400">Digite pelo menos 3 caracteres...</p>');return}t.innerHTML='<div class="text-center py-3"><div class="w-5 h-5 border-2 border-indigo-200 border-t-indigo-600 rounded-full animate-spin mx-auto"></div></div>';try{const r=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(n=>Xt(n,e.trim())),o=await Promise.all(r),s=new Map;o.forEach(n=>{n.forEach(l=>{l.phone?s.set(l.phone,l):s.set(l.id||Math.random().toString(),l)})});const i=Array.from(s.values());if(rs=i,!i.length){t.innerHTML='<p class="text-xs text-gray-400">Nenhum cliente encontrado.</p>';return}t.innerHTML=i.map(n=>`<div class="client-card p-2.5 bg-white rounded-lg border ${A.data.clientName===n.name&&A.data.clientPhone===n.phone?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer flex items-center gap-2" data-client-name="${_(n.name)}" data-client-phone="${_(n.phone)}" data-loyalty-points="${n.loyaltyPoints||0}">
            ...
            </div>`).join(""),t.querySelectorAll(".client-card").forEach(n=>n.addEventListener("click",()=>{A.data.clientName=n.dataset.clientName,A.data.clientPhone=n.dataset.clientPhone,A.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(jt?.rewards||[]).map(d=>d.points));A.data.clientHasRewards=jt.enabled&&l!==1/0&&A.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,t.querySelectorAll(".client-card").forEach(d=>d.classList.remove("border-indigo-500","bg-indigo-50")),n.classList.add("border-indigo-500","bg-indigo-50")}))}catch{t.innerHTML='<p class="text-xs text-red-400">Erro ao buscar.</p>'}}const ki=(e,t=null,a=1,r=12)=>{let o=`/api/comandas/${e}?page=${a}&limit=${r}`;return t&&(o+=`&date=${t}`),L(o)},Si=(e,t)=>L(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),$i=e=>L("/api/sales",{method:"POST",body:JSON.stringify(e)}),Ei=e=>L(`/api/sales/${e}`,{method:"DELETE"}),ta=e=>L(`/api/products/${e}`),Ii=e=>L("/api/products",{method:"POST",body:JSON.stringify(e)}),Li=(e,t)=>L(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ci=e=>L(`/api/products/${e}`,{method:"DELETE"}),Di=(e,t)=>L(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),Ti=({startDate:e,endDate:t,productId:a,categoryId:r,establishmentId:o})=>{const s=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&s.append("productId",a),r&&r!=="all"&&s.append("categoryId",r),o&&s.append("establishmentId",o),L(`/api/products/stock-history/report?${s.toString()}`)},Bi=()=>L("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),Pi=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),L("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Mi=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),L(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},Ai=()=>L("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),qi=e=>L(`/api/cashier/report/${e}`),Oa=e=>L(`/api/packages/${e}`),Ri=e=>L("/api/packages",{method:"POST",body:JSON.stringify(e)}),ji=(e,t)=>L(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ni=e=>L(`/api/packages/${e}`,{method:"DELETE"});let y={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryDate:!1},Me=null,Re=null,co=null;function ls(e,t){return function(...a){clearTimeout(co),co=setTimeout(()=>e.apply(this,a),t)}}async function uo(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,sa(),t==="checkout"&&(y.viewMode="checkout",y.checkoutState.payments||(y.checkoutState.payments=[]),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.amountReceived="",y.checkoutState.discount.value||(y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason=""),X());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,document.body.appendChild(a);try{const r=(e.comandaItems||[]).filter(o=>o&&o.id&&String(o.id)!=="undefined"&&String(o.id)!=="null").map(o=>{const s={...o};if(s.id=String(o.id),s.type==="product"){const i=s.id;s.productId||(s.productId=i),s.product_id||(s.product_id=i)}if(s.type==="service"){const i=s.id;s.serviceId||(s.serviceId=i),s.service_id||(s.service_id=i)}return s});e.type==="walk-in"&&String(e.id).startsWith("temp-")||await Si(e.id,r),document.body.contains(a)&&document.body.removeChild(a),t!=="checkout"&&(g("Sucesso","Comanda atualizada!","success"),X())}catch(r){document.body.contains(a)&&document.body.removeChild(a),console.error("Erro ao salvar:",r),e._hasUnsavedChanges=!0,X(),g("Erro","Falha ao salvar no servidor: "+r.message,"warning")}}function ye(e){if(!e._cachedItems){let t=[];if(e.status==="completed"){const a=e.comandaItems||e.items||[];t=a.length>0?a:e.services||[]}else{const a=(e.services||[]).map(i=>({...i,_source:"original_service",type:"service"})),r=a.reduce((i,n)=>{const l=String(n.id);return i[l]=(i[l]||0)+1,i},{}),o=[...e.comandaItems||[],...e.items||[]],s=[];o.forEach(i=>{const n=String(i.id);(i.type==="service"||!i.type)&&r[n]>0?r[n]--:s.push({...i,_source:"extra"})}),t=[...a,...s]}return e._cachedItems=t,e._cachedTimestamp=Date.now(),t}return e._cachedItems}function Fi(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function je(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function Hi(){const e=y.allComandas||[],t=e.filter(d=>d.status!=="completed").length,a=e.filter(d=>d.status==="completed"),r=a.reduce((d,c)=>{let u=c.totalAmount!==void 0?Number(c.totalAmount):ye(c).reduce((m,x)=>m+Number(x.price||0),0);return d+u},0),o=a.length>0?r/a.length:0,s=document.getElementById("kpi-abertas"),i=document.getElementById("kpi-pagas"),n=document.getElementById("kpi-vendas"),l=document.getElementById("kpi-ticket");s&&(s.textContent=t),i&&(i.textContent=a.length),n&&(n.textContent=`R$ ${r.toFixed(2).replace(".",",")}`),l&&(l.textContent=`R$ ${o.toFixed(2).replace(".",",")}`)}function Oi(){const e=new Date().toISOString().split("T")[0];Re.innerHTML=`
    ...
    `,oa(),aa()}function aa(){document.querySelectorAll(".filter-btn").forEach(a=>{a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-gray-600","border-gray-200")});const e=document.querySelector(`[data-filter="${y.activeFilter}"]`);e&&(e.classList.remove("bg-white","text-gray-600","border-gray-200"),e.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"));const t=document.getElementById("finalizadas-datepicker");t&&t.classList.toggle("hidden",!y.showHistoryDate)}function oa(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),zi()}function zi(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
        ...
        `)}function sa(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!y.isCashierOpen&&y.activeFilter==="abertas"){e.innerHTML=`
        ...
        `,t&&(t.innerHTML="");return}let a=y.allComandas||[];if(y.activeFilter==="abertas"?a=a.filter(o=>o.status!=="completed"):y.activeFilter==="pagas"&&(a=a.filter(o=>o.status==="completed")),Hi(),a.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada para este filtro.</p>',po(t);return}const r=document.createDocumentFragment();a.forEach(o=>{const s=ye(o);let i=0;o.status==="completed"&&o.totalAmount!==void 0&&o.totalAmount!==null?i=Number(o.totalAmount):i=s.reduce((D,I)=>D+Number(I.price||0),0);const l=o.loyaltyRedemption||o.discount&&o.discount.reason&&String(o.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-2" title="Prémio Resgatado">🎁</span>':"",d=o.id===y.selectedComandaId,c=new Date(o.startTime),u=c.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),m=c.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),x=`${u} às ${m}`,b=o.type==="walk-in"||typeof o.id=="string"&&o.id.startsWith("temp-"),v=o.status==="completed",f=h(o.clientName||"Cliente sem nome"),$=h(o.professionalName||"Sem profissional");let k="";v?k='<span class="text-[10px] font-bold uppercase text-green-700 bg-green-100 px-2 py-0.5 rounded-md border border-green-200">Paga</span>':b?k='<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':k='<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const w=document.createElement("div");w.className=`comanda-card cursor-pointer ${d?"selected":""}`,w.dataset.action="select-comanda",w.dataset.comandaId=o.id,w.innerHTML=`
            ...
            <div class="flex justify-between items-center mt-1 pointer-events-none">
                <div class="flex items-center gap-2">
                    ${k}
                    <p class="text-xs text-gray-500 truncate max-w-[100px]">${$}</p>
                </div>
                <p class="text-[11px] text-gray-600 font-semibold bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200">${x}</p> 
            </div>
        `,r.appendChild(w)}),e.innerHTML="",e.appendChild(r),po(t)}function po(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:r}=y.paging,o=Math.ceil((a||0)/r);if(o===0)return;const s=document.createElement("div");s.className="flex gap-2 justify-center items-center w-full",s.innerHTML=`
    ...
    `,e.appendChild(s),s.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=o&&(y.paging.page=l,de())}})}function X(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(v=>v.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){Vi(t,e);return}const a=`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const r=ye(t),o=t.status==="completed",s=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),i=r.reduce((v,f)=>{const $=f._source==="original_service",k=f.id||f.name,w=$?`original-${k}`:`${f.type}-${k}`;return v[w]||(v[w]={...f,quantity:0,sources:[]}),v[w].quantity+=1,f._source&&v[w].sources.push(f._source),v},{}),n=Object.values(i).reduce((v,f)=>v+Number(f.price||0)*f.quantity,0),l=h(t.clientName||"Cliente sem nome"),d=h(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,x=`
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(i).map(v=>{const f=v.sources&&v.sources.includes("original_service"),$=y.pendingRedemption&&String(y.pendingRedemption.appliedToItemId)===String(v.id),k=v.isReward||$;return`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm ${k?"border-yellow-300 bg-yellow-50 ring-1 ring-yellow-200":""}">
                        <div class="flex items-center gap-3 w-full">
                            ...
                            ${o?`<span class="flex items-center justify-center w-8 h-8 bg-gray-100 text-gray-700 font-bold text-sm rounded-lg">${v.quantity}x</span>`:`
        ...
        ${o?"":b}
    `,!o&&(t.clientId||t.clientName)&&_i(t,e.querySelector("#loyalty-container"))}function Vi(e,t){const r=ye(e).reduce((m,x)=>m+Number(x.price||0)*(x.quantity||1),0),o=y.checkoutState,s=o.discount||{type:"real",value:0};let i=0;s.type==="percent"?i=r*s.value/100:i=s.value,i>r&&(i=r);const n=r-i,l=o.payments.reduce((m,x)=>m+x.value,0),d=Math.max(0,n-l);(!o.amountReceived||d>0)&&(o.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
                ...
                ${["credito","crediario"].includes(o.selectedMethod)?`
                    <div class="mb-3">
                        ...
                        <select id="checkout-installments" class="w-full mt-1 p-2 border rounded-lg text-sm bg-gray-50">
                            ${Array.from({length:12},(m,x)=>`<option value="${x+1}" ${o.installments===x+1?"selected":""}>${x+1}x</option>`).join("")}
                        </select>
                    </div>
                `:""}
    ...
    `;const u=()=>{const m=y.checkoutState.discount.type,x=y.checkoutState.discount.value;let b=m==="percent"?r*x/100:x;b>r&&(b=r);const v=r-b,f=y.checkoutState.payments.reduce((I,q)=>I+q.value,0),$=Math.max(0,v-f),k=t.querySelector("#checkout-total-display");k&&(k.textContent=`R$ ${v.toFixed(2)}`);const w=t.querySelector("#checkout-status-msg");w&&($<=.01?w.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':w.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${$.toFixed(2)}</span></p>`);const D=t.querySelector("#checkout-amount");D&&$>0&&document.activeElement!==D&&(D.value=$.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",m=>{const x=parseFloat(m.target.value)||0;y.checkoutState.discount.value=x,u()}),t.querySelector("#discount-type")?.addEventListener("change",m=>{y.checkoutState.discount.type=m.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",m=>{y.checkoutState.discountReason=m.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",m=>{y.checkoutState.amountReceived=m.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",m=>{y.checkoutState.installments=parseInt(m.target.value,10)})}async function _i(e,t){if(!t)return;const a=y.loyaltySettings;if(!a||!a.enabled)return;let r=null;try{if(e.clientId)r=await Zo(p.establishmentId,e.clientId);else if(e.clientName){const n=await Xt(p.establishmentId,e.clientName,1);n&&n.length>0&&(r=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!r||r.loyaltyPoints===void 0)return;const o=Number(r.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&o>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>Ui(i,e),n.appendChild(l),t.innerHTML="",t.appendChild(n)}}function Ui(e,t){const a=`
        <div class="space-y-4">
            <p class="text-sm text-gray-600 mb-4">O cliente possui pontos suficientes para resgatar os seguintes itens:</p>
            <div class="space-y-2 max-h-96 overflow-y-auto custom-scrollbar">
                ${e.map(s=>{const i=s.costPoints||s.points||0,n=s.name||s.reward,l=s.type||"money",d=s.discount?parseFloat(s.discount).toFixed(2):"0.00";let c="",u="bg-gray-100 text-gray-600";switch(l){case"service":c="Serviço",u="bg-indigo-100 text-indigo-700";break;case"product":c="Produto",u="bg-green-100 text-green-700";break;case"package":c="Pacote",u="bg-purple-100 text-purple-700";break;case"money":default:c="Valor Livre",u="bg-yellow-100 text-yellow-700";break}return`
                    <button data-action="select-reward" data-reward-id="${s.id||n}" class="w-full flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl hover:border-yellow-400 hover:bg-yellow-50 transition-all group">
    ...
    `,{modalElement:r,close:o}=ne({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});r.addEventListener("click",s=>{const i=s.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=e.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(Wi(l,t),o())}})}async function Wi(e,t){const a=Number(e.costPoints||e.points||0),r=e.name||e.reward,o=e.type||"money";if(o==="money"){const l=parseFloat(e.discount)||0;if(l<=0){g("Erro","O valor do desconto configurado é inválido.","error");return}y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${r}`,y.pendingRedemption={rewardId:e.id||null,name:r,cost:a,type:"money"},g("Sucesso",`Prémio "${r}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),X();return}const s=ye(t),i=e.itemId?String(e.itemId):null;if(!i){g("Erro de Configuração",`O prémio "${r}" não tem um item vinculado nas configurações.`,"error");return}const n=s.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return o==="service"?d===i||c===i:o==="product"?d===i||u===i:o==="package"?d===i:!1});if(n){let l=parseFloat(e.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${r}`,y.pendingRedemption={rewardId:e.id||null,name:r,cost:a,type:o,appliedToItemId:n.id},g("Sucesso",`Prémio "${r}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),X()}else g("Item Não Encontrado",`Para resgatar o prémio "${r}", o ${o==="service"?"serviço":o==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function Ji(){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=ne({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const o=e.querySelector("#add-item-content");o.innerHTML=`
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div><h4 class="font-semibold mb-2 text-center text-purple-600">Pacotes</h4><div id="modal-package-list" class="space-y-2 max-h-80 overflow-y-auto custom-scrollbar"></div></div>
                    ...
                    <button data-action="select-item-for-quantity" data-item-type="${x}" data-item-id="${f.id}" class="flex items-center gap-2 w-full p-2 bg-white border rounded hover:bg-gray-50 transition text-left">
                        <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-gray-50">${d[x]}</div>
                        <span class="flex-grow text-sm truncate">${h(f.name)}</span>
                        <span class="font-bold text-xs text-gray-700">R$ ${f.price.toFixed(2)}</span>
                    </button>
                `:"").join("")||'<p class="text-xs text-gray-400 text-center py-2">Nada encontrado</p>'})};s();const i=document.getElementById("item-search-input");i.addEventListener("input",ls(n=>{s(n.target.value)},300)),setTimeout(()=>i.focus(),100)},r=o=>{let s=1;const i=e.querySelector("#add-item-content"),n=()=>{document.getElementById("quantity-display").textContent=s,document.getElementById("quantity-minus-btn").disabled=s<=1};i.innerHTML=`
            <div class="text-center p-8 relative">
                ...
                <h3 class="font-bold text-2xl text-gray-800 mt-4">${h(o.name)}</h3>
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,n())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,n()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await cs(o,s),t()}};e.addEventListener("click",o=>{const s=o.target.closest('[data-action="select-item-for-quantity"]'),i=o.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:n,itemId:l}=s.dataset,c=(y.catalog[n+"s"]||[]).find(u=>u.id===l);c&&r({...c,type:n})}else i&&a()}),a()}async function $a(e=null){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!p.professionals||p.professionals.length===0)try{p.professionals=await le(p.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const a=`
        <form id="new-sale-form" class="space-y-4">
            ...
            <div>
                ...
                <select id="new-sale-professional" required class="mt-1 w-full p-2 border rounded-md bg-white"><option value="">Selecione...</option>${p.professionals.map(l=>`<option value="${l.id}">${h(l.name)}</option>`).join("")}</select>
            </div>
    ...
    `,{modalElement:r}=ne({title:"Nova Venda Avulsa",contentHTML:a,maxWidth:"max-w-md"}),o=r.querySelector("#client-search"),s=r.querySelector("#client-suggestions"),i=r.querySelector("#selected-client-id");e&&(i.value=e.id,o.value=`${e.name} (${e.phone||"Sem tel"})`,o.classList.add("bg-green-50","border-green-300","text-green-800")),o.addEventListener("input",ls(async l=>{const d=l.target.value.trim();if(i.value="",o.classList.remove("bg-green-50","border-green-300","text-green-800"),d.length<2){s.classList.add("hidden");return}try{s.innerHTML='<li class="p-2 text-xs text-gray-500">Buscando...</li>',s.classList.remove("hidden");const c=await Xt(p.establishmentId,d,10);c.length===0?s.innerHTML='<li class="p-2 text-xs text-gray-500">Nenhum cliente encontrado</li>':s.innerHTML=c.map(u=>`<li data-client-id="${u.id}" data-client-name="${u.name}" data-client-phone="${u.phone}" class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 transition-colors"><div class="font-bold text-sm text-gray-800">${h(u.name)}</div><div class="text-xs text-gray-500">${u.phone||"Sem telefone"}</div></li>`).join("")}catch{s.classList.add("hidden")}},400)),s.addEventListener("click",l=>{const d=l.target.closest("li[data-client-id]");d&&(i.value=d.dataset.clientId,i.dataset.name=d.dataset.clientName,i.dataset.phone=d.dataset.clientPhone,o.value=`${d.dataset.clientName}`,o.classList.add("bg-green-50","border-green-300","text-green-800"),s.classList.add("hidden"))}),document.addEventListener("click",l=>{!o.contains(l.target)&&!s.contains(l.target)&&s.classList.add("hidden")}),r.querySelector("#new-sale-form").addEventListener("submit",en);const n=r.querySelector('[data-action="new-client-from-sale"]');n&&n.addEventListener("click",l=>{l.preventDefault(),r.style.display="none",Gi()})}function Gi(){ne({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Yi)}async function Yi(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),o=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!o)return g("Erro","Nome e Telefone são obrigatórios.","error");try{const s=await Yr(p.establishmentId,o);if(s)g("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",$a(s);else{const i=await es({establishmentId:p.establishmentId,name:a.value,phone:o});g("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",$a(i)}}catch(s){g("Erro",s.message,"error")}}async function Qi(){const e=`
    ...
    `,{modalElement:t}=ne({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const r=parseFloat(document.getElementById("initial-amount").value);if(isNaN(r)||r<0)return g("Valor Inválido","Insira um valor válido.","error");try{const o=await Pi({establishmentId:p.establishmentId,initialAmount:parseFloat(r.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=o.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${r.toFixed(2)})`,"success"),oa(),await de()}catch(o){g("Erro",`Falha ao abrir caixa: ${o.message}`,"error")}})}async function Xi(){const e=y.activeCashierSessionId;if(e)try{const t=await qi(e),a=`
        ...
        `,{modalElement:r}=ne({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});r.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const s=parseFloat(document.getElementById("final-amount").value);if(isNaN(s)||s<0)return g("Valor Inválido","Insira um valor final válido.","error");try{await Mi(e,s),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",oa(),await de(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){g("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(t){g("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Zi(e){if(y.activeFilter===e)return;y.activeFilter=e,y.paging.page=1,aa(),je(),y.selectedComandaId=null,y.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await de()}function ds(e){y.selectedComandaId=e,y.viewMode="items",y.pendingRedemption=null,y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason="",sa(),Fi(),X()}async function cs(e,t){const a=y.allComandas.find(s=>s.id===y.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){g("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const r=parseFloat(e.price)||0,o=Array(t).fill(0).map(()=>{const s={id:String(e.id),name:e.name,price:r,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(s.productId=s.id,s.product_id=s.id):e.type==="service"&&(s.serviceId=s.id,s.service_id=s.id),s});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...o),a._cachedItems=null,a._hasUnsavedChanges=!0,X()}async function mo(e,t){const a=y.allComandas.find(s=>s.id===y.selectedComandaId);if(!a)return;let r=!1,o=(a.comandaItems||[]).findIndex(s=>s.id==e&&s.type===t);o>-1&&(a.comandaItems.splice(o,1),r=!0),r&&(a._cachedItems=null,a._hasUnsavedChanges=!0,X())}async function Ki(e){if(y.isProcessing)return;const t=ye(e),a=t.reduce((f,$)=>f+Number($.price||0)*($.quantity||1),0),r=y.checkoutState.discount||{type:"real",value:0};let o=r.type==="percent"?a*r.value/100:r.value;o>a&&(o=a);const s=a-o,{payments:i}=y.checkoutState,n=i.reduce((f,$)=>f+$.value,0),l=s-n;if(l>.01){if(!await W("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}y.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const m=y.loyaltySettings;m&&m.enabled&&(u=parseInt(m.pointsPerVisit||1,10));const x={...r,reason:y.checkoutState.discountReason||""},b={payments:i,totalAmount:Number(s),items:c,cashierSessionId:y.activeCashierSessionId,loyaltyPointsEarned:u,discount:x,loyaltyRedemption:y.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(v);try{d?await mr(e.id,b):(b.establishmentId=p.establishmentId,b.clientId=e.clientId,b.clientName=e.clientName,b.professionalId=e.professionalId,e.clientPhone&&(b.clientPhone=e.clientPhone),await $i(b));let f="Venda finalizada com sucesso!";u>0&&(f+=` Cliente ganhou ${u} pontos!`),g("Sucesso!",f,"success"),je(),y.selectedComandaId=null,y.viewMode="items",y.pendingRedemption=null,await de()}catch(f){g("Erro no Checkout",f.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),y.isProcessing=!1}}async function en(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,r=t.value,o=document.getElementById("client-search").value,s=t.dataset.phone||"";if(!r)return g("Erro","Selecione um cliente válido.","error");const i=p.professionals.find(l=>l.id===a);if(!i)return g("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:r,clientName:o.split("(")[0].trim(),clientPhone:s,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(n),y.selectedComandaId=n.id,y.viewMode="items",document.getElementById("genericModal").style.display="none",y.activeFilter==="pagas"&&(y.activeFilter="abertas"),aa(),ds(n.id)}async function de(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=y.showHistoryDate?document.getElementById("filter-date").value:null;try{const a=Bi(),r=ki(p.establishmentId,t,y.paging.page,y.paging.limit),o=Ce(p.establishmentId),[s,i,n]=await Promise.all([a,r,o]);if(y.isCashierOpen=!!s,y.activeCashierSessionId=s?s.id:null,oa(),n&&n.loyaltyProgram&&(y.loyaltySettings=n.loyaltyProgram),y.allComandas=i.data||i||[],y.paging.total=i.total||y.allComandas.length,y.catalog.services.length===0){const[l,d,c,u]=await Promise.all([Te(p.establishmentId),ta(p.establishmentId),Oa(p.establishmentId),le(p.establishmentId)]);y.catalog={services:l,products:d,packages:c},p.professionals=u}sa(),X()}catch(a){g("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function tn(e={}){Re=document.getElementById("content"),y.selectedComandaId=e.selectedAppointmentId||null,y.viewMode="items",Oi(),Me&&(Re.removeEventListener("click",Me),Re.removeEventListener("change",Me)),Me=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"){y.paging.page=1,await de();return}if(a){if(a.matches("[data-filter]"))Zi(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}ds(a.dataset.comandaId)}else if(a.matches("[data-action]")){const o=a.dataset.action,s=a.dataset.id||y.selectedComandaId,i=y.allComandas.find(n=>n.id===s);switch(o){case"toggle-history":y.showHistoryDate=!y.showHistoryDate,y.showHistoryDate&&y.activeFilter==="abertas"&&(y.activeFilter="todas"),aa(),y.showHistoryDate||await de();break;case"back-to-list":je(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(k=>k.classList.remove("selected")),X();break;case"new-sale":$a();break;case"add-item":Ji();break;case"open-cashier":Qi();break;case"close-cashier":await Xi();break;case"view-sales-report":J("sales-report-section");break;case"go-to-checkout":await uo(i,"checkout");break;case"back-to-items":y.viewMode="items",X();break;case"save-comanda":await uo(i,"stay");break;case"select-method":y.checkoutState.selectedMethod=a.dataset.method,y.checkoutState.installments=1,X();break;case"add-payment-checkout":const n=document.getElementById("checkout-amount");let l=parseFloat(n.value);const c=ye(i).reduce((k,w)=>k+(w.price||0),0),u=y.checkoutState.discount||{type:"real",value:0};let m=u.type==="percent"?c*u.value/100:u.value;m>c&&(m=c);const x=c-m,b=y.checkoutState.payments.reduce((k,w)=>k+w.value,0),v=x-b;if(isNaN(l)||l<=0){g("Valor inválido","Insira um valor maior que zero.","error");break}if(l>v+.05){g("Valor inválido","Valor excede o restante.","error");break}const f={method:y.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(y.checkoutState.selectedMethod)&&y.checkoutState.installments>1&&(f.installments=y.checkoutState.installments),y.checkoutState.payments.push(f),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.installments=1,y.checkoutState.amountReceived="",X();break;case"remove-payment-checkout":const $=parseInt(a.dataset.index,10);y.checkoutState.payments.splice($,1),X();break;case"finalize-checkout":await Ki(i);break;case"increase-qty":{const k=a.dataset.itemId,w=a.dataset.itemType;if(!k||k==="undefined"||k==="null"){g("Erro","Item inválido.","error");return}let I=ye(i).find(N=>N.id==k&&N.type===w);I||(I=(y.catalog[w+"s"]||[]).find(T=>T.id==k));const q=I?{id:I.id,name:I.name,price:Number(I.price),type:I.type}:{id:k,name:"Item",price:0,type:w};await cs(q,1);break}case"decrease-qty":await mo(a.dataset.itemId,a.dataset.itemType);break;case"remove-item":await mo(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await W("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await pr(s);const w=y.allComandas.findIndex(D=>D.id===s);w!==-1&&(y.allComandas[w].status="confirmed",delete y.allComandas[w].transaction),y.selectedComandaId=null,je(),await de(),g("Sucesso!","Comanda reaberta.","success")}catch(w){g("Erro",w.message,"error")}break}case"go-to-appointment":{J("agenda-section",{scrollToAppointmentId:a.dataset.id,targetDate:new Date(a.dataset.date)});break}case"delete-walk-in":{if(await W("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(s.startsWith("temp-"))y.allComandas=y.allComandas.filter(w=>w.id!==s),y.selectedComandaId=null,sa(),X(),je();else try{await Ei(s),g("Sucesso","Venda excluída.","success"),y.selectedComandaId=null,je(),await de()}catch(w){g("Erro",w.message,"error")}break}}}}},Re.addEventListener("click",Me),Re.addEventListener("change",Me),e.initialFilter&&(e.initialFilter==="finalizadas"?y.activeFilter="pagas":y.activeFilter="abertas"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0],y.showHistoryDate=!0),await de()}const ra=e=>L(`/api/financial/natures/${e}`),an=e=>L("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),on=e=>L(`/api/financial/natures/${e}`,{method:"DELETE"}),za=e=>L(`/api/financial/cost-centers/${e}`),sn=e=>L("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),rn=e=>L(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),us=(e,t)=>L(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),ps=(e,t={})=>{let a=`/api/financial/${e}`;const r=new URLSearchParams;t.establishmentId&&r.append("establishmentId",t.establishmentId),t.startDate&&r.append("startDate",t.startDate),t.endDate&&r.append("endDate",t.endDate),t.natureId&&r.append("natureId",t.natureId),t.costCenterId&&r.append("costCenterId",t.costCenterId),t.status&&r.append("status",t.status);const o=r.toString();return o&&(a+=`?${o}`),L(a)},ms=(e,t,a)=>L(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),gs=(e,t)=>L(`/api/financial/${e}/${t}`,{method:"DELETE"}),bs=(e,t)=>{const a=t.map(r=>L(`/api/financial/${e}/${r}`,{method:"DELETE"}));return Promise.all(a)},fs=(e,t,a)=>L(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),nn=e=>us("payables",e),xs=e=>ps("payables",e),ln=(e,t)=>ms("payables",e,t),dn=e=>gs("payables",e),cn=(e,t)=>fs("payables",e,t),un=e=>us("receivables",e),hs=e=>ps("receivables",e),pn=(e,t)=>ms("receivables",e,t),mn=e=>gs("receivables",e),gn=(e,t)=>fs("receivables",e,t),Ea=document.getElementById("content");let oe={};const wt={creditRealized:"#10b981",creditProvisioned:"#6ee7b7",debitRealized:"#ef4444",debitProvisioned:"#fca5a5"},bn=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],P={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],naturesList:[],rawPayables:[],rawReceivables:[],processedDRE:null,processedCashFlow:null,processedDailyRevenue:null,backendData:null,appointmentsData:[],currentTab:"dashboards",isFilterOpen:!1};async function fn(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function xn(){Ea.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await fn();const[e,t,a]=await Promise.all([le(p.establishmentId),_r(p.establishmentId).catch(()=>[]),ra(p.establishmentId).catch(()=>[])]);P.professionalsList=e||[],P.costCentersList=t||[],P.naturesList=a||[],hn(),await vs()}catch(e){console.error("Erro no loadReportsPage:",e),Ea.innerHTML=`
            ...
            </div>`}}function hn(){const e=P.professionalsList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join(""),t=P.costCentersList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join("");Ea.innerHTML=`
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex-1 min-w-0 mr-2">
                            ...
                            <p class="text-[10px] md:text-xs text-gray-500 mt-0.5 ml-1 truncate" id="date-range-display">
                                ${Nt(P.startDate)} até ${Nt(P.endDate)}
                            </p>
                        </div>
    ...
    `,document.getElementById("toggle-filters-btn").onclick=go,document.getElementById("btn-apply-filters").onclick=()=>{vn(),go()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{P.currentTab=a.dataset.tab,bo(),ys(),window.scrollTo({top:0,behavior:"smooth"})}}),bo()}function go(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");P.isFilterOpen=!P.isFilterOpen,P.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function bo(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===P.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Nt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function vn(){P.startDate=document.getElementById("report-start").value,P.endDate=document.getElementById("report-end").value,P.selectedProfessional=document.getElementById("report-prof").value,P.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Nt(P.startDate)} até ${Nt(P.endDate)}`,await vs()}function yn(e,t){const a=new Map;P.naturesList.forEach(o=>a.set(o.id,o.name));const r={revenues:{},expenses:{},totalRevenues:0,totalExpenses:0,netResult:0};return t.forEach(o=>{if(o.status==="paid"){const s=o.naturezaId?a.get(o.naturezaId)||"Outras Receitas":"Geral";r.revenues[s]||(r.revenues[s]=0),r.revenues[s]+=o.amount,r.totalRevenues+=o.amount}}),e.forEach(o=>{if(o.status==="paid"){const s=o.naturezaId?a.get(o.naturezaId)||"Outras Despesas":"Geral";r.expenses[s]||(r.expenses[s]=0),r.expenses[s]+=o.amount,r.totalExpenses+=o.amount}}),r.netResult=r.totalRevenues-r.totalExpenses,r}function wn(e,t){const a={},r=d=>{a[d]||(a[d]={realizedCredit:0,provisionedCredit:0,realizedDebit:0,provisionedDebit:0})};let o=new Date(P.startDate);const s=new Date(P.endDate);for(;o<=s;)r(o.toISOString().split("T")[0]),o.setDate(o.getDate()+1);t.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedCredit+=d.amount:a[c].provisionedCredit+=d.amount)}),e.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedDebit+=d.amount:a[c].provisionedDebit+=d.amount)});const i=Object.keys(a).sort(),n=[];let l=0;return i.forEach(d=>{const c=a[d],u=c.realizedCredit+c.provisionedCredit-(c.realizedDebit+c.provisionedDebit);l+=u,n.push(l)}),{labels:i,realizedCredit:i.map(d=>a[d].realizedCredit),provisionedCredit:i.map(d=>a[d].provisionedCredit),realizedDebit:i.map(d=>a[d].realizedDebit*-1),provisionedDebit:i.map(d=>a[d].provisionedDebit*-1),balance:n}}function kn(e){const t={};let a=new Date(P.startDate);const r=new Date(P.endDate);for(;a<=r;)t[a.toISOString().split("T")[0]]=0,a.setDate(a.getDate()+1);e.forEach(i=>{if(i.status==="paid"){const n=i.dueDate.split("T")[0];t.hasOwnProperty(n)&&(t[n]+=i.amount)}});const o=Object.keys(t).sort(),s=o.map(i=>t[i]);return{labels:o,data:s}}function Sn(e){const t=e.length;if(t<2)return{trendData:Array(t).fill(e[0]||0),color:"#9ca3af"};let a=0,r=0,o=0,s=0;for(let c=0;c<t;c++)a+=c,r+=e[c],o+=c*e[c],s+=c*c;const i=(t*o-a*r)/(t*s-a*a),n=(r-i*a)/t,l=[];for(let c=0;c<t;c++)l.push(i*c+n);const d=i>=0?"#10b981":"#ef4444";return{trendData:l,color:d}}async function vs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20 w-full"><div class="loader border-t-indigo-600"></div></div>';try{const t={startDate:P.startDate,endDate:P.endDate,establishmentId:p.establishmentId};P.selectedCostCenter!=="all"&&(t.costCenterId=P.selectedCostCenter);const[a,r]=await Promise.all([xs(t),hs(t)]);P.rawPayables=a.entries||[],P.rawReceivables=r.entries||[];const o=await Vr(P.startDate,P.endDate,P.selectedProfessional,P.selectedCostCenter).catch(()=>({charts:{professionals:{labels:[],data:[]},salesMonthly:{labels:[],data:[]}}}));P.backendData=o,P.processedDRE=yn(P.rawPayables,P.rawReceivables),P.processedCashFlow=wn(P.rawPayables,P.rawReceivables),P.processedDailyRevenue=kn(P.rawReceivables);const s=new Date(P.startDate+"T00:00:00").toISOString(),i=new Date(P.endDate+"T23:59:59").toISOString(),n=P.selectedProfessional==="all"?null:P.selectedProfessional,l=await Aa(p.establishmentId,s,i,n).catch(()=>[]);P.appointmentsData=Array.isArray(l)?l:[],ys()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ys(){const e=document.getElementById("report-content");switch(P.currentTab){case"dashboards":$n(e);break;case"appointments":En(e);break;case"dre":In(e);break}}function $n(e){const t=P.processedDRE,a=P.processedDailyRevenue,r=P.backendData.charts?.salesMonthly||{labels:[],data:[]},o=P.backendData.charts?.professionals||{labels:[],data:[]};e.innerHTML=`
    ...
    `,Ln("chart-cashflow-modern",P.processedCashFlow),fo("chart-daily-revenue","Receita Diária",a.labels.map(s=>s.split("-").reverse().slice(0,2).join("/")),a.data),fo("chart-monthly","Receita Mensal",r.labels,r.data),Dn("chart-profs","doughnut","Total Vendas",o.labels,o.data,bn),document.querySelectorAll(".chart-toggle").forEach(s=>{s.addEventListener("change",i=>{const n=oe["chart-cashflow-modern"];if(n){const l=parseInt(i.target.dataset.dataset);n.setDatasetVisibility(l,i.target.checked),n.update()}})})}function En(e){const t=P.appointmentsData,a=t.length;let r=0,o=0,s=0;const i={},n={};let l=new Date(P.startDate);const d=new Date(P.endDate);for(;l<=d;)i[l.toISOString().split("T")[0]]={active:0,cancelled:0},l.setDate(l.getDate()+1);t.forEach(b=>{const v=parseFloat(b.totalAmount||b.price||0),f=(b.status||"").toLowerCase();let $="";if(b.startTime){const w=b.startTime.toDate?b.startTime.toDate():new Date(b.startTime);isNaN(w)||($=w.toISOString().split("T")[0])}const k=b.professionalName||"Sem Profissional";n[k]||(n[k]={name:k,count:0,value:0}),["cancelled","cancelado","no-show","cancelada"].includes(f)?(o++,$&&i[$]&&i[$].cancelled++):(["completed","finalized","paid"].includes(f)&&r++,s+=v,$&&i[$]&&i[$].active++,n[k].count++,n[k].value+=v)});const c=Object.keys(i).sort(),u=c.map(b=>i[b].active),m=c.map(b=>i[b].cancelled),x=Object.values(n).sort((b,v)=>v.value-b.value);e.innerHTML=`
            ...
            <div class="overflow-x-auto no-scrollbar w-full">
                <table class="w-full text-xs md:text-sm min-w-full">
                    <tbody class="divide-y divide-gray-100">
                        ${x.map((b,v)=>{const f=x[0]?.value||1,$=b.value/f*100;return`
                            <tr class="group">
    ...
    `,Cn("chart-appointments-daily",c,u,m),document.querySelectorAll(".app-chart-toggle").forEach(b=>{b.addEventListener("change",v=>{const f=oe["chart-appointments-daily"];if(f){const $=parseInt(v.target.dataset.dataset);f.setDatasetVisibility($,v.target.checked),f.update()}})})}function In(e){const t=P.processedDRE;if(!t)return;const a=t.totalRevenues,r=(n,l,d,c=!1)=>{const u=a>0?l/a*100:0,m=c?"- ":"";return`
        ...
        </div>`},o=Object.entries(t.revenues).map(([n,l])=>r(n,l,"text-emerald-600",!1)).join(""),s=Object.entries(t.expenses).map(([n,l])=>r(n,l,"text-red-500",!0)).join(""),i=t.netResult>=0?"Lucro Real":"Prejuízo Real";e.innerHTML=`
    ...
    `}function Ln(e,t){const a=document.getElementById(e);if(!a)return;const r=a.getContext("2d");oe[e]&&oe[e].destroy();const o=r.createLinearGradient(0,0,0,400);o.addColorStop(0,"rgba(59, 130, 246, 0.4)"),o.addColorStop(1,"rgba(59, 130, 246, 0.0)");const s=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));oe[e]=new Chart(r,{type:"bar",data:{labels:s,datasets:[{label:"Créd. Realizado",data:t.realizedCredit,backgroundColor:wt.creditRealized,borderRadius:3,barPercentage:.7,order:1},{label:"Créd. Provisionado",data:t.provisionedCredit,backgroundColor:wt.creditProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:2},{label:"Déb. Realizado",data:t.realizedDebit,backgroundColor:wt.debitRealized,borderRadius:3,barPercentage:.7,order:3},{label:"Déb. Provisionado",data:t.provisionedDebit,backgroundColor:wt.debitProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:4},{label:"Saldo Acumulado",data:t.balance,type:"line",borderColor:"#3b82f6",backgroundColor:o,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!0,tension:.4,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10,callbacks:{label:function(i){let n=i.dataset.label||"";return n&&(n+=": "),i.parsed.y!==null&&(n+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(Math.abs(i.parsed.y))),n}}}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{size:10}}},y:{stacked:!0,display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(Math.abs(i)),font:{size:10}}}}}})}function Cn(e,t,a,r){const o=document.getElementById(e);if(!o)return;const s=o.getContext("2d");oe[e]&&oe[e].destroy();const i=t.map(n=>n.split("-").reverse().slice(0,2).join("/"));oe[e]=new Chart(s,{type:"bar",data:{labels:i,datasets:[{label:"Realizados",data:a,backgroundColor:"#4f46e5",borderRadius:3,barPercentage:.6,order:1},{label:"Cancelados",data:r,backgroundColor:"#ef4444",borderRadius:3,barPercentage:.6,order:2}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function fo(e,t,a,r){const o=document.getElementById(e);if(!o)return;const s=o.getContext("2d");oe[e]&&oe[e].destroy();const{trendData:i,color:n}=Sn(r),l=i.map((u,m)=>m===i.length-1?"triangle":"circle"),d=i.map((u,m)=>m===i.length-1?6:3),c=i.map((u,m)=>m===i.length-1&&n==="#ef4444"?180:0);oe[e]=new Chart(s,{type:"bar",data:{labels:a,datasets:[{label:t,data:r,backgroundColor:"#4f46e5",borderRadius:4,order:1},{label:"Tendência",data:i,type:"line",borderColor:n,borderWidth:3,pointStyle:l,pointRadius:d,pointRotation:c,pointBackgroundColor:"#fff",pointBorderColor:n,pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!1,tension:0,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9},callback:u=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(u)}}}}})}function Dn(e,t,a,r,o,s){const i=document.getElementById(e);if(!i)return;const n=i.getContext("2d");oe[e]&&oe[e].destroy(),new Chart(n,{type:t,data:{labels:r,datasets:[{label:a,data:o,backgroundColor:s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:{}}})}const ia=(e,t="products")=>L(`/api/${t}/categories/${e}`),ws=(e,t="products")=>L(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),ks=(e,t="products")=>L(`/api/${t}/categories/${e}`,{method:"DELETE"}),Tn="audit_logs",me=async(e,t,a,r,o,s=null)=>{try{if(!t)return;await Uo(Yt(be,Tn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:r,description:o,details:s,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},Se=document.getElementById("content");let xe=null,st="services",Ie="all",rt=[];function Ge(){const e=ie.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function Bn(e){e.preventDefault();const t=e.target.closest("#categoryForm"),a=t.querySelector("#categoryName"),r=a.value;if(!r)return;const o=t.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const s=rt.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);s.length===0&&s.push(p.establishmentId),await ws({establishmentId:p.establishmentId,name:r,accessibleIn:s},"services"),me(p.establishmentId,Ge(),"Categorias (Serviços)","Criou",`Criou categoria: ${r}`),a.value="",g("Sucesso","Categoria criada!","success"),await Va(),await ft()}catch(s){g("Erro",`Não foi possível criar a categoria: ${s.message}`,"error")}finally{o.disabled=!1,o.textContent="Adicionar"}}async function Pn(e){if(await W("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ks(e,"services"),me(p.establishmentId,Ge(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Va(),await ft()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Va(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ia(p.establishmentId,"services");p.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Mn(){ne({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Bn),t.addEventListener("click",r=>{const o=r.target.closest('button[data-action="delete-category"]');o&&(r.preventDefault(),Pn(o.dataset.id))}))}Va()}function An(e=[]){if(!rt||rt.length===0)return`
            ...
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return rt.forEach(a=>{const r=e.includes(a.id)||e.length===0&&a.id===p.establishmentId;t+=`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const s=e.includes(o.id)||e.length===0&&o.id===p.establishmentId;t+=`
                    <label class="flex items-center space-x-3 py-1.5 ml-6 cursor-pointer hover:bg-white rounded px-2 transition-colors border-l-2 border-indigo-100 pl-4">
                        <input type="checkbox" name="accessibleIn" value="${o.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${s?"checked":""}>
                        <span class="text-sm font-medium text-gray-600">📍 ${h(o.name)}</span>
                    </label>
                `})}),t+="</div>",t}async function qn(e){e.preventDefault();const t=e.target.closest("#serviceModal"),a=t.querySelector("#serviceId").value,r={},o=t.querySelector('input[name="commissionType"]:checked').value;o==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(l=>{const d=l.dataset.profId;if(l.querySelector('input[type="checkbox"]').checked){const u=parseFloat(l.querySelector('input[type="number"]').value);r[d]=isNaN(u)?0:u}});const s=Array.from(t.querySelectorAll('input[name="accessibleIn"]:checked')).map(l=>l.value),i=s.length>0?s:[p.establishmentId],n={establishmentId:p.establishmentId,accessibleIn:i,name:t.querySelector("#serviceName").value.trim(),price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:o,professionalCommissions:r};try{a?(await ti(a,n),me(p.establishmentId,Ge(),"Serviços","Editou",`Editou o serviço: ${n.name}`)):(await ei(n),me(p.establishmentId,Ge(),"Serviços","Criou",`Criou novo serviço: ${n.name}`)),document.getElementById("serviceModal").style.display="none",g("Sucesso",`Serviço ${a?"atualizado":"adicionado"} com sucesso!`,"success"),await ft()}catch(l){g("Erro",l.message,"error")}}function xo(e=null){const t=document.getElementById("serviceModal"),a=p.serviceCategories||[],r=e?.duration||0,o=e?.bufferTime||0,s=h(e?.name||""),i=h(e?.notes||""),n=e?s:"Novo Serviço",l=a.map(D=>`<option value="${D.id}" ${e?.categoryId===D.id?"selected":""}>${h(D.name)}</option>`).join("");t.innerHTML=`
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async D=>{const I=D.target.closest("button[data-action]");if(!I)return;const q=I.dataset.action,N=I.dataset.id;if(q==="close-modal"&&(t.style.display="none"),q==="delete-service"){if(!N)return;if(t.style.display="none",await W("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const M=p.services.find(R=>R.id===N)?.name||"Desconhecido";await ai(N),me(p.establishmentId,Ge(),"Serviços","Excluiu",`Excluiu o serviço: ${M}`),g("Sucesso","Serviço apagado com sucesso!","success"),await ft()}catch(M){g("Erro",`Não foi possível apagar o serviço: ${M.message}`,"error")}else t.style.display="flex"}});const d=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");d.forEach(D=>{D.addEventListener("click",()=>{d.forEach(I=>{I.classList.remove("border-indigo-500","text-indigo-600"),I.classList.add("border-transparent","text-gray-500")}),D.classList.add("border-indigo-500","text-indigo-600"),D.classList.remove("border-transparent","text-gray-500"),c.forEach(I=>I.classList.add("hidden")),document.getElementById(`tab-content-${D.dataset.tab}`).classList.remove("hidden")})});const u=t.querySelectorAll('input[name="commissionType"]'),m=document.getElementById("defaultCommissionRateContainer"),x=document.getElementById("professionalCommissionsContainer");function b(){const D=t.querySelector('input[name="commissionType"]:checked').value;m&&(m.style.display=D==="default"?"block":"none"),x&&(x.style.display=D==="custom"?"block":"none")}u.forEach(D=>D.addEventListener("change",b));const v=document.getElementById("professionalCommissionsList");v&&(v.innerHTML=(p.professionals||[]).map(D=>{const I=e?.professionalCommissions?.[D.id]!==void 0,q=e?.professionalCommissions?.[D.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${I?"bg-blue-50":""}" data-prof-id="${D.id}">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" ${I?"checked":""} class="h-4 w-4 rounded border-gray-300 text-indigo-600">
                        <img src="${D.photo||`https://placehold.co/40x40/E2E8F0/4A5568?text=${h(D.name.charAt(0))}`}" class="w-8 h-8 rounded-full object-cover">
                        <span class="text-sm font-medium">${h(D.name)}</span>
                    </label>
                    <div class="flex items-center gap-1">
                        <input type="number" value="${q}" class="w-20 p-1 border rounded-md text-sm text-center" ${I?"":"disabled"}>
                        <span class="text-sm font-semibold">%</span>
                    </div>
                </div>
            `}).join(""),v.querySelectorAll('input[type="checkbox"]').forEach(D=>{D.addEventListener("change",I=>{const q=I.target.closest(".professional-commission-row");q.querySelector('input[type="number"]').disabled=!I.target.checked,q.classList.toggle("bg-blue-50",I.target.checked)})})),b();const f=t.querySelector("#serviceForm"),$=t.querySelector("#servicePhotoInput"),k=t.querySelector("#servicePhotoPreview"),w=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>$.click()),$.onchange=async()=>{const D=$.files[0];if(D){k.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const I=await as(D,800,800,.8);if(I.length*3/4>1e3*1024)throw new Error("Imagem muito grande.");k.src=I,w.value=I}catch(I){g("Erro de Imagem",I.message,"error"),k.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",w.value=e?.photo||""}}},f.addEventListener("submit",qn)}function it(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",r=new Map((p.serviceCategories||[]).map(s=>[s.id,s.name]));let o=(p.services||[]).filter(Boolean);if(Ie!=="all"){const s=Ie==="active";o=o.filter(i=>i.active!==!1===s)}o=o.filter(s=>{const i=s.name.toLowerCase().includes(t),n=a==="all"||s.categoryId===a;return i&&n}),e.innerHTML="",o.length>0?o.forEach(s=>{const i=document.createElement("div"),n=JSON.stringify(s).replace(/'/g,"&apos;");i.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:border-indigo-300 border border-transparent ${s.active!==!1?"opacity-100":"opacity-60 bg-gray-100"} sm:flex-col`,i.dataset.action="edit-service",i.dataset.service=n;const l=h(s.name),d=h(r.get(s.categoryId)||"Sem Categoria"),c=s.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(s.name.charAt(0))}`;i.innerHTML=`
                ...
                </div>`,e.appendChild(i)}):e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum serviço encontrado.</p>'}function _a(){const e={active:0,inactive:0,total:0},t=(p.services||[]).filter(Boolean);t.forEach(i=>{i.active===!1?e.inactive++:e.active++}),e.total=t.length;const a=document.getElementById("indicator-total"),r=document.getElementById("indicator-active"),o=document.getElementById("indicator-inactive"),s=document.getElementById("indicator-popular");a&&(a.textContent=e.total),r&&(r.textContent=e.active),o&&(o.textContent=e.inactive),s&&(p.mostPopularService&&p.mostPopularService.name!=="N/A"?(s.textContent=h(p.mostPopularService.name),s.closest(".indicator-card").title=`${p.mostPopularService.name} (${p.mostPopularService.count} agendamentos)`):s.textContent="Nenhum agendado")}function Rn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),_a(),it()}function jn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ft(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,r,o,s]=await Promise.all([Te(p.establishmentId),le(p.establishmentId),ia(p.establishmentId,"services"),si(p.establishmentId),Qe()]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(r||[]).filter(Boolean),p.mostPopularService=o||{name:"N/A",count:0},rt=s?.matrizes||[],p.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),Ss(st)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function Ss(e){if(document.getElementById("services-content-container")){if(st===e&&document.getElementById("services-content-container").children.length>1){st==="services"&&(_a(),it());return}st=e,Ie="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Rn():e==="reports"&&jn()}}function Nn(){xe&&(Se.removeEventListener("click",xe),Se.removeEventListener("input",xe),Se.removeEventListener("change",xe)),xe=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const o=t.closest('[data-action="toggle-service-status"]'),s=o.dataset.id,i=o.checked;try{await oi(s,i);const n=p.services.findIndex(l=>l.id===s);n>-1&&(p.services[n].active=i),me(p.establishmentId,Ge(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${i?"Ativo":"Inativo"}`),it(),_a()}catch(n){g("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),o.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){it();return}if(!a)return;if(a.hasAttribute("data-view")){Ss(a.dataset.view);return}switch(a.dataset.action){case"new-service":xo();break;case"edit-service":const o=JSON.parse(a.dataset.service);xo(o);break;case"manage-categories":Mn();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;Ie=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,d=n===Ie||n==="total"&&Ie==="all";i.classList.toggle("ring-2",d),i.classList.toggle("ring-indigo-500",d),i.classList.toggle("shadow-md",d),i.classList.toggle("bg-white",!d)}),it();break}},Se.addEventListener("click",xe),Se.addEventListener("input",xe),Se.addEventListener("change",xe)}async function Fn(){Se.innerHTML=`
        ...
        </div>`,Nn(),st="services",Ie="all",await ft()}const na="suppliers",Ua=async e=>{try{const t=Wo(Yt(be,na),Jo("establishmentId","==",e)),a=await Ks(t),r=[];return a.forEach(o=>{r.push({id:o.id,...o.data()})}),r}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Hn=async e=>{try{return{id:(await Uo(Yt(be,na),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},On=async(e,t)=>{try{const a=bt(be,na,e);return await Ma(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},zn=async e=>{try{const t=bt(be,na,e);return await er(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},ke=document.getElementById("content");let he=null,nt="products",ge="all";async function Vn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),r=a.value;if(r)try{await ws({establishmentId:p.establishmentId,name:r},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Wa(),await xt()}catch(o){g("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function _n(e){if(await W("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ks(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Wa(),await xt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Wa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ia(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${h(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Un(){ne({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Vn),t.addEventListener("click",r=>{const o=r.target.closest('button[data-action="delete-category"]');o&&_n(o.dataset.id)}))}Wa()}async function Wn(e){if(!e)return;if(await W("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await Ci(e),g("Sucesso","Produto apagado com sucesso!","success"),await xt()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function Jn(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),r=parseInt(e.querySelector("#productMinStock").value),o=parseInt(e.querySelector("#productMaxStock").value),s=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),i=Array.from(s).map(l=>l.dataset.id),n={establishmentId:p.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(r)?0:r,maxStock:isNaN(o)?0:o,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:i};try{t?await Li(t,n):await Ii(n),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await xt()}catch(l){throw new Error(l.message)}}function ho(e,t=800,a=800,r="image/jpeg",o=.8){return new Promise((s,i)=>{if(!e.type.startsWith("image/"))return i(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,u=d.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const m=document.createElement("canvas");m.width=c,m.height=u,m.getContext("2d").drawImage(d,0,0,c,u);const b=m.toDataURL(r,o);s(b)},d.onerror=c=>i(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},n.onerror=l=>i(new Error("Não foi possível ler o ficheiro.")),n.readAsDataURL(e)})}function vo(e=null){const t=document.getElementById("productModal"),a=p.categories||[],r=p.suppliers||[],o=a.map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${h(T.name)}</option>`).join("");let s=new Set(e?.supplierIds||[]);const i=h(e?.name||""),n=e?.price||"",l=e?.costPrice||"",d=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,m=e?.currentStock||0,x=e?i:"Novo Produto";t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const b=t.querySelector("#productCategory"),v=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>v.click()),b.innerHTML='<option value="">Sem categoria</option>'+(p.categories||[]).map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${h(T.name)}</option>`).join(""),e&&(b.value=e.categoryId||"");const f=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const $=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",k=e?.photo||"";v.onchange=async()=>{const T=v.files[0];if(T){f.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const M=await ho(T,800,800,"image/jpeg",.8),O=M.length*3/4,z=1e3*1024;if(O>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=M,base64Input.value=M}catch(M){console.error("Erro ao processar imagem:",M),g("Erro de Imagem",M.message||"Não foi possível processar a imagem.","error"),preview.src=$,base64Input.value=k,N.value=""}}};const w=t.cloneNode(!0);t.parentNode.replaceChild(w,t);const D=()=>{const T=w.querySelector("#modalSupplierSearch"),M=w.querySelector("#supplierSearchResults"),R=w.querySelector("#selectedSuppliersList"),O=T.value.toLowerCase();if(O.length>0){const z=r.filter(j=>j.name.toLowerCase().includes(O)&&!s.has(j.id));z.length>0?(M.classList.remove("hidden"),M.innerHTML=z.map(j=>`
                ...
                `).join("")):(M.classList.remove("hidden"),M.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else M.classList.add("hidden");s.size>0?(R.innerHTML="",s.forEach(z=>{const j=r.find(C=>C.id===z);j&&(R.innerHTML+=`
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};w.querySelector("#modalSupplierSearch").addEventListener("input",D),w.addEventListener("click",T=>{const M=T.target.closest("[data-add-supplier]");if(M){const O=M.dataset.addSupplier;s.add(O),w.querySelector("#modalSupplierSearch").value="",D()}const R=T.target.closest("[data-remove-supplier]");if(R){const O=R.dataset.removeSupplier;s.delete(O),D()}}),D(),w.addEventListener("click",async T=>{const M=T.target.closest("button[data-action]");if(!M)return;const R=M.dataset.action,O=w.querySelector("#productId").value;if(R==="close-modal"&&(w.style.display="none"),R==="delete-product"){if(!O)return;w.style.display="none",await Wn(O)}if(R==="save-product-modal"){const z=w.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const j=M.closest('button[data-action="save-product-modal"]');j.disabled=!0,j.textContent="A salvar...";try{await Jn(z)}catch(C){g("Erro",`Falha ao salvar: ${C.message}`,"error"),j.disabled=!1,j.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){T.preventDefault();const z=w.querySelector("#stockAdjustmentAmount"),j=w.querySelector("#stockAdjustmentReason"),C=parseInt(z.value,10),V=parseInt(M.dataset.change,10);if(!C||C<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Z=C*V,se=j.value||(Z>0?"Entrada manual":"Saída manual");try{await Di(O,{change:Z,reason:se});const Be=p.products.findIndex(we=>we.id===O);if(Be>-1){const we=p.products[Be].currentStock+Z;p.products[Be].currentStock=we,w.querySelector("#currentStockDisplay").textContent=we,w.querySelector("#productCurrentStock").value=we,z.value="",j.value="",g("Sucesso","Estoque atualizado!","success"),Ja(),mt()}}catch(Be){g("Erro de Stock",Be.message,"error")}}});const I=w.querySelectorAll(".tab-btn"),q=w.querySelectorAll(".tab-content");I.forEach(T=>{T.addEventListener("click",M=>{M.preventDefault(),I.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),T.classList.add("border-indigo-500","text-indigo-600"),T.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),q.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${T.dataset.tab}`).classList.remove("hidden")})});const N=w.querySelector("#productPhotoInput");w.querySelector("#productPhotoButton").addEventListener("click",()=>N.click()),N.onchange=async()=>{const T=N.files[0];if(!T)return;const M=w.querySelector("#productPhotoPreview"),R=w.querySelector("#productPhotoBase64");M.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const O=await ho(T,800,800,"image/jpeg",.8),j=O.length*3/4,C=1e3*1024;if(j>C)throw new Error("A imagem é muito grande mesmo após a compressão.");M.src=O,R.value=O}catch(O){console.error("Erro ao processar imagem:",O),g("Erro de Imagem",O.message||"Não foi possível processar a imagem.","error"),M.src=$,R.value=k,N.value=""}},w.style.display="flex"}function Gn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),Ja(),mt()}function Yn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const r=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const o=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");o&&p.products&&(o.innerHTML+=p.products.map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join("")),s&&p.categories&&(s.innerHTML+=p.categories.map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join(""))}async function Qn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:p.establishmentId};try{const a=await Ti(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ${a.map(s=>`
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap font-semibold text-gray-800">${h(s.productName)}</td>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-gray-600 truncate max-w-xs" title="${h(s.reason)}">${h(s.reason)}</td>
                                <td class="px-4 py-3 whitespace-nowrap text-gray-600">${h(s.user)}</td>
                            </tr>`).join("")}
                    </tbody>
                </table>
            </div>`,o=`
            <div class="md:hidden space-y-3 pb-20">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                        <div class="flex justify-between items-start mb-2">
                            <div>
                                ...
                                <h4 class="font-bold text-gray-800 text-base line-clamp-1">${h(s.productName)}</h4>
                            </div>
                        ...
                        <div class="flex justify-between items-center text-xs border-t pt-2 border-dashed border-gray-200">
                            <span class="text-gray-600 truncate max-w-[60%] font-medium" title="${h(s.reason)}">
                                ${h(s.reason)||"Sem motivo"}
                            </span>
                ...
                `).join("")}
            </div>`;e.innerHTML=r+o}catch(a){g("Erro",`Não foi possível gerar o relatório: ${a.message}`,"error"),e.innerHTML=`<div class="bg-white border border-red-200 rounded-lg p-8 text-center text-red-500">${a.message}</div>`}}function Ja(){const e={ok:0,near_min:0,at_min:0,empty:0};if(!p.products)return;p.products.forEach(s=>{if(!s)return;const i=s.currentStock,n=s.minStock;i<=0?e.empty++:n>0&&i<=n?e.at_min++:n>0&&i<=n*1.2?e.near_min++:e.ok++});const t=document.getElementById("indicator-ok"),a=document.getElementById("indicator-near-min"),r=document.getElementById("indicator-at-min"),o=document.getElementById("indicator-empty");t&&(t.textContent=e.ok),a&&(a.textContent=e.near_min),r&&(r.textContent=e.at_min),o&&(o.textContent=e.empty)}function mt(){const e=document.getElementById("productsList");if(!e)return;const t=document.getElementById("productSearchInput")?.value.toLowerCase()||"",a=document.getElementById("productCategoryFilter")?.value||"all",r=new Map((p.categories||[]).map(s=>[s.id,s.name]));let o=(p.products||[]).filter(Boolean);ge!=="all"&&(o=o.filter(s=>{const i=s.currentStock,n=s.minStock;switch(ge){case"ok":return i>0&&(n===0||i>n*1.2);case"near_min":return n>0&&i>n&&i<=n*1.2;case"at_min":return n>0&&i>0&&i<=n;case"empty":return i<=0;default:return!0}})),o=o.filter(s=>{const i=s.name.toLowerCase().includes(t),n=a==="all"||s.categoryId===a;return i&&n}),e.innerHTML="",o.length>0?(e.className="space-y-3 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 sm:gap-4 sm:space-y-0",o.forEach(s=>{const i=document.createElement("div"),n=JSON.stringify(s).replace(/'/g,"&apos;");i.className=`product-card bg-white rounded-lg shadow-md flex items-center gap-3 p-3 overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:bg-gray-50 
                              sm:flex-col sm:p-0 sm:items-stretch sm:gap-0`,i.dataset.action="edit-product",i.dataset.product=n;const l=s.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(s.name.charAt(0))}`,d=r.get(s.categoryId)||"N/A";let c="",u="text-gray-500";const m=s.currentStock,x=s.minStock;m<=0?(c='<span class="text-xs font-semibold text-red-600">Esgotado</span>',u="text-red-600 font-semibold"):x>0&&m<=x?(c='<span class="text-xs font-semibold text-orange-600">Estoque Mínimo</span>',u="text-orange-600 font-semibold"):x>0&&m<=x*1.2?(c='<span class="text-xs font-semibold text-blue-600">Estoque Baixo</span>',u="text-blue-600 font-semibold"):(c='<span class="text-xs font-semibold text-green-600">Em Estoque</span>',u="text-green-600 font-semibold"),i.innerHTML=`
                <img src="${l}" alt="Imagem de ${h(s.name)}" class="w-16 h-16 rounded-md object-cover flex-shrink-0 sm:w-full sm:h-24 sm:rounded-b-none">
                
                <div class="flex-1 sm:p-3 sm:flex sm:flex-col sm:flex-grow">
                    <div class="sm:flex-grow">
                        <div class="flex justify-between items-start mb-1 gap-2">
                            <h3 class="text-sm font-bold text-gray-900 flex-1 text-left">${h(s.name)}</h3>
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function xt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,r]=await Promise.all([ta(p.establishmentId),ia(p.establishmentId,"products"),Ua(p.establishmentId)]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),p.suppliers=(r||[]).filter(Boolean),$s(nt)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function $s(e){if(document.getElementById("products-content-container")){if(nt===e&&document.getElementById("products-content-container").children.length>1){nt==="products"&&(Ja(),mt());return}nt=e,ge="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Gn():e==="movements"&&Yn()}}async function Xn(){ke.innerHTML=`
        ...
        </section>`,he&&(ke.removeEventListener("click",he),ke.removeEventListener("input",he),ke.removeEventListener("change",he)),he=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){mt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){$s(a.dataset.view);return}switch(a.dataset.action){case"new-product":vo();break;case"edit-product":vo(JSON.parse(a.dataset.product));break;case"manage-product-categories":Un();break;case"generate-report":await Qn();break;case"filter-stock":const o=a.dataset.filterType;ge=ge===o?"all":o,document.querySelectorAll(".indicator-card").forEach(s=>{s.classList.toggle("ring-2",s.dataset.filterType===ge),s.classList.toggle("ring-indigo-500",s.dataset.filterType===ge),s.classList.toggle("shadow-lg",s.dataset.filterType===ge)}),mt();break}},ke.addEventListener("click",he),ke.addEventListener("input",he),ke.addEventListener("change",he),nt="products",ge="all",await xt()}const Mt=document.getElementById("content");let H={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},kt=null;const Ft={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},Es=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function Zn(){try{const t=(await Qe()).matrizes||[];H.establishments=[],t.forEach(a=>{H.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(r=>H.establishments.push({id:r.id,name:r.name,type:"Filial"}))})}catch(e){console.warn("Erro ao buscar lojas",e)}H.viewMode="list",H.editingItem=null,H.hasSearched=!1,H.partners=[],Kn(),rl(),Is()}function Kn(){Mt.innerHTML=`
    ...
    `}function el(){const e=Object.entries(Ft).map(([a,r])=>`<option value="${a}">${r.label}</option>`).join(""),t=Es.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function tl(e=null){const t=!!e,a=t?"Ficha do Parceiro":"Novo Parceiro de Negócio";let r=e?.category||"";r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const o=Object.entries(Ft).map(([n,l])=>`<option value="${n}" ${r===n?"selected":""}>${l.label}</option>`).join(""),s=Es.map(n=>`<option value="${n}" ${e?.state===n?"selected":""}>${n}</option>`).join(""),i=document.getElementById("form-container-wrapper");i&&(i.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",ol))}function Is(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
        ...
        `)}async function al(){const e=document.getElementById("partners-grid");if(!H.hasSearched){Is();return}e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="text-sm text-gray-500 mt-4 font-medium">Buscando parceiros...</p></div>';try{const t=await Ua(p.establishmentId);H.partners=t||[],Ls()}catch(t){e.innerHTML=`<div class="text-center py-10 text-red-500 font-bold">Erro ao carregar parceiros: ${t.message}</div>`}}function Ls(){const e=document.getElementById("partners-grid");if(!e)return;let t=H.partners;if(H.searchQuery){const o=H.searchQuery.toLowerCase();t=t.filter(s=>s.name.toLowerCase().includes(o)||s.document&&s.document.includes(o)||s.taxId&&s.taxId.includes(o)||s.email&&s.email.toLowerCase().includes(o)||s.contactName&&s.contactName.toLowerCase().includes(o))}if(H.categoryFilter!=="all"&&(t=t.filter(o=>o.category===H.categoryFilter)),H.stateFilter!=="all"&&(t=t.filter(o=>o.state===H.stateFilter)),H.cityFilter){const o=H.cityFilter.toLowerCase();t=t.filter(s=>s.city&&s.city.toLowerCase().includes(o))}if(t.sort((o,s)=>{let i="",n="";return H.sortBy==="name_asc"||H.sortBy==="name_desc"?(i=(o.name||"").toLowerCase(),n=(s.name||"").toLowerCase()):H.sortBy==="contact_asc"&&(i=(o.contactName||"").toLowerCase(),n=(s.contactName||"").toLowerCase()),H.sortBy==="name_desc"?n.localeCompare(i):i.localeCompare(n)}),t.length===0){e.innerHTML=`
        ...
        <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
    `,r='<div class="flex flex-col gap-4 md:hidden">';t.forEach(o=>{let s=o.category;s==="Produtos"&&(s="estoque"),s==="Serviços"&&(s="servicos");const i=Ft[s]||Ft.outros,n=o.document||o.taxId?o.document||o.taxId:"-",l=JSON.stringify(o).replace(/'/g,"&apos;"),d=[o.city,o.state].filter(Boolean).join(" - ");a+=`
            <tr class="hover:bg-indigo-50/50 cursor-pointer transition-colors group" data-action="open-form" data-item='${l}'>
                ...
                <td class="p-4">
                    <p class="font-bold text-gray-900 text-sm group-hover:text-indigo-700 transition-colors">${h(o.name)}</p>
                    ${o.email?`<p class="text-xs text-gray-500 mt-0.5"><i class="bi bi-envelope mr-1 opacity-50"></i>${h(o.email)}</p>`:""}
                </td>
                <td class="p-4 text-sm font-medium text-gray-600">${h(n)}</td>
                <td class="p-4">
                    <div class="text-sm font-medium text-gray-800">${h(o.contactName||"-")}</div>
                    ${d?`<div class="text-[10px] font-bold uppercase tracking-wider text-gray-400 mt-1"><i class="bi bi-geo-alt mr-1"></i>${h(d)}</div>`:""}
                </td>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex flex-col gap-3 active:scale-[0.98] transition-transform cursor-pointer relative overflow-hidden" data-action="open-form" data-item='${l}'>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <h3 class="font-black text-gray-900 text-base leading-tight truncate">${h(o.name)}</h3>
                    </div>
                </div>
        ...
        `}),a+="</tbody></table></div>",r+="</div>",e.innerHTML=a+r}function lt(e,t=null){const a=document.getElementById("suppliers-list-view"),r=document.getElementById("suppliers-form-view");H.viewMode=e,H.editingItem=t,e==="list"?(a.classList.remove("hidden"),r.classList.add("hidden"),r.innerHTML='<div id="form-container-wrapper" class="max-w-5xl mx-auto px-4 sm:px-6 py-8 pb-24"></div>',H.hasSearched&&Ls(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),r.classList.remove("hidden"),tl(t),window.scrollTo({top:0,behavior:"smooth"}))}async function ol(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,r={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,document:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,state:t.querySelector("#supState").value,city:t.querySelector("#supCity").value,establishmentId:p.establishmentId,notes:t.querySelector("#supNotes")?.value||"",accessibleIn:[p.establishmentId]},o=t.querySelector('button[type="submit"]'),s=o.innerHTML;o.disabled=!0,o.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await On(a,r),g("Sucesso","Ficha atualizada!","success")):(await Hn(r),g("Sucesso","Parceiro registado!","success")),H.hasSearched&&(H.partners=await Ua(p.establishmentId)||[]),lt("list")}catch(i){g("Erro","Falha ao gravar: "+i.message,"error"),o.disabled=!1,o.innerHTML=s}}async function sl(e){if(await W("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente? Os lançamentos financeiros antigos não serão apagados."))try{await zn(e),g("Sucesso","Entidade excluída.","success"),H.partners=H.partners.filter(a=>a.id!==e),lt("list")}catch(a){g("Erro","Erro ao excluir: "+a.message,"error")}}function rl(){kt&&Mt.removeEventListener("click",kt),kt=async e=>{const t=e.target;if(t.closest('button[data-action="new-partner"]')){lt("form",null);return}if(t.closest("#btn-search-partners")){H.searchQuery=document.getElementById("filterSearch").value,H.categoryFilter=document.getElementById("filterCategory").value,H.stateFilter=document.getElementById("filterState").value,H.cityFilter=document.getElementById("filterCity").value,H.sortBy=document.getElementById("filterSortBy").value,H.hasSearched=!0,al();return}if(t.closest('button[data-action="back-to-list"]')){lt("list");return}const a=t.closest('button[data-action="delete-partner"]');if(a){e.preventDefault(),sl(a.dataset.id);return}const r=t.closest('[data-action="open-form"]');if(r&&!t.closest("button")){const o=JSON.parse(r.dataset.item.replace(/&apos;/g,"'"));lt("form",o)}},Mt.addEventListener("click",kt),Mt.addEventListener("keypress",e=>{e.key==="Enter"&&(e.target.id==="filterSearch"||e.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const ua=document.getElementById("content"),yo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ce=new Set,St=null,Ne=null,At=[];function qt(){const e=ie.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}function il(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function nl(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",r=h(t.name),o=h(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,l=n>1?`<span class="text-[10px] font-bold bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded ml-2 border border-indigo-200" title="Atende em ${n} unidades"><i class="bi bi-diagram-3"></i> ${n} Lojas</span>`:"";return`
            <div class="professional-card bg-white rounded-lg shadow-md flex items-center gap-4 p-3 cursor-pointer transition-transform transform hover:shadow-lg hover:bg-gray-50
                ...
                <img src="${s}" alt="Foto de ${r}" class="w-16 h-16 rounded-full object-cover flex-shrink-0
            ...
            </div>`}).join("")}function pa(){const e=document.getElementById("genericModal");e.style.display="none",Ne&&e.removeEventListener("click",Ne)}async function ll(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},r=h(a.name),o=p.services||await Te(p.establishmentId),s=p.professionals||await le(p.establishmentId),i=`
        ...
        </div>`;t.innerHTML=i,t.style.display="flex",cl(a,o),ul(a),pl(a,s),gl(a)}function dl(e=[]){if(!At||At.length===0)return`
            <input type="hidden" name="accessibleIn" value="${p.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Profissional exclusivo desta unidade.
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return At.forEach(a=>{const r=e.includes(a.id)||e.length===0&&a.id===p.establishmentId;t+=`
            <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-white rounded px-2 transition-colors">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${r?"checked":""}>
                <span class="text-sm font-bold text-gray-800">🏢 ${h(a.name)} (Matriz)</span>
            </label>
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const s=e.includes(o.id)||e.length===0&&o.id===p.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function cl(e,t){const a=document.getElementById("professionalForm"),r=e.dob?e.dob.split("/"):["",""],o=Array.from({length:12},(f,$)=>{const k=$+1,w=k==r[1]?"selected":"",D=new Date(0,$).toLocaleString("pt-BR",{month:"long"});return`<option value="${k}" ${w}>${D.charAt(0).toUpperCase()+D.slice(1)}</option>`}).join(""),s=e.status||"active",i=h(e.name||""),n=h(e.specialty||""),l=h(e.phone||""),d=h(e.notes||"");a.innerHTML=`
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        ...
                        <div id="batchProfSelectionContainer" class="max-h-40 overflow-y-auto p-3 border border-orange-200 rounded-lg bg-white space-y-2 shadow-sm">
                            ${t.map(s=>`
                                <label class="flex items-center space-x-3 hover:bg-orange-50 p-1 rounded cursor-pointer transition-colors">
                                    ...
                                    <span class="text-sm font-medium text-gray-700">${h(s.name)}</span>
                                </label>`).join("")}
                        </div>
                    </div>
        ...
        </div>`;const r=document.getElementById("batchBlockageForm");r&&r.addEventListener("submit",async s=>{s.preventDefault();const i=r.querySelector('button[type="submit"]'),n=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm"></span> A gravar...';const l=Array.from(s.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(v=>v.value);if(l.length===0)return i.disabled=!1,i.innerHTML=n,g("Atenção","Selecione pelo menos um profissional.","error");const d=s.target.batchBlockageStartDate.value,c=s.target.batchBlockageEndDate.value||d,u=s.target.batchBlockageStartTime.value,m=s.target.batchBlockageEndTime.value,x=s.target.batchBlockageReason.value;if(!d||!u||!m)return i.disabled=!1,i.innerHTML=n,g("Atenção","Preencha Data de Início, Hora de Início e Fim.","error");const b=l.map(v=>{const f={professionalId:v,establishmentId:p.establishmentId,startTime:new Date(`${d}T${u}`).toISOString(),endTime:new Date(`${c}T${m}`).toISOString(),reason:x};return Kt(f)});try{await Promise.all(b),g("Sucesso!",`${l.length} bloqueios foram criados.`),r.reset(),s.target.querySelectorAll('input[name="batch-professionals"]').forEach(f=>{f.checked=f.value===e.id});const v=document.getElementById("prof-blockages-filter").value;dt(e.id,v)}catch(v){g("Erro",v.message,"error")}finally{i.disabled=!1,i.innerHTML=n}}),document.getElementById("prof-blockages-filter").addEventListener("change",s=>dt(e.id,s.target.value)),await dt(e.id,"future")}function ml(e,t){e.innerHTML=Object.keys(yo).map(a=>{const r=t[a]||{},o=r.active!==!1;return`
            <div class="day-schedule-card p-4 rounded-xl ${o?"bg-white border-gray-200 shadow-sm":"bg-gray-50 border-gray-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-3">
                    <span class="font-bold text-gray-800">${yo[a]}</span>
                ...
                <div class="time-inputs grid grid-cols-2 gap-3 mt-2 text-sm">
                    <div><label class="text-xs text-gray-500 font-medium">Abertura:</label><input type="time" data-day="${a}" data-field="start" value="${r.start||"09:00"}" class="w-full p-2 border border-gray-300 rounded-lg outline-none focus:ring-1 focus:ring-indigo-500 bg-white" ${o?"":"disabled"}></div>
                    <div><label class="text-xs text-gray-500 font-medium">Fecho:</label><input type="time" data-day="${a}" data-field="end" value="${r.end||"18:00"}" class="w-full p-2 border border-gray-300 rounded-lg outline-none focus:ring-1 focus:ring-indigo-500 bg-white" ${o?"":"disabled"}></div>
                    <div><label class="text-xs text-gray-500 font-medium">Início Pausa:</label><input type="time" data-day="${a}" data-field="breakStart" value="${r.breakStart||"12:00"}" class="w-full p-2 border border-gray-300 rounded-lg outline-none focus:ring-1 focus:ring-indigo-500 bg-white" ${o?"":"disabled"}></div>
                    <div><label class="text-xs text-gray-500 font-medium">Fim Pausa:</label><input type="time" data-day="${a}" data-field="breakEnd" value="${r.breakEnd||"13:00"}" class="w-full p-2 border border-gray-300 rounded-lg outline-none focus:ring-1 focus:ring-indigo-500 bg-white" ${o?"":"disabled"}></div>
                </div>
            </div>`}).join(""),e.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",r=>{const o=r.target.closest(".day-schedule-card"),s=!r.target.checked;o.classList.toggle("bg-white",!s),o.classList.toggle("shadow-sm",!s),o.classList.toggle("border-gray-200",!s),o.classList.toggle("bg-gray-50",s),o.classList.toggle("border-gray-100",s),o.classList.toggle("opacity-60",s),o.classList.toggle("disabled",s),o.querySelectorAll(".time-inputs input").forEach(i=>i.disabled=s)})})}async function dt(e,t="future"){const a=document.getElementById("blockagesList");if(a){a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const r=new Date;let o,s;t==="history"?(s=new Date,o=new Date,o.setFullYear(o.getFullYear()-2)):(o=new Date,s=new Date,s.setFullYear(s.getFullYear()+2));let n=(await Zt(p.establishmentId,o.toISOString(),s.toISOString(),e)).map(d=>({...d,startTime:new Date(d.startTime),endTime:new Date(d.endTime)}));t==="history"?n=n.filter(d=>d.endTime<r).sort((d,c)=>c.startTime-d.startTime):n=n.filter(d=>d.endTime>=r).sort((d,c)=>d.startTime-c.startTime);const l=n.reduce((d,c)=>{const u=c.reason||"Sem motivo detalhado";return d[u]||(d[u]=[]),d[u].push(c),d},{});if(Object.keys(l).length===0){a.innerHTML=`
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm mb-4 overflow-hidden">
                <div class="bg-gray-50 px-4 py-3 border-b flex justify-between items-center">
                    <h4 class="font-bold text-gray-800 flex items-center gap-2"><i class="bi bi-tag text-orange-500"></i> ${h(d)}</h4>
        ...
        `).join("")}catch(r){a.innerHTML=`<p class="text-red-500 p-4">${r.message}</p>`}}}function gl(e){const t=document.getElementById("genericModal");Ne&&t.removeEventListener("click",Ne),Ne=async a=>{const r=a.target.closest("button[data-action]");if(!r){const s=a.target.closest(".tab-link");s&&(t.querySelectorAll(".tab-link").forEach(i=>{i.classList.remove("active","border-indigo-600","text-indigo-600"),i.classList.add("border-transparent","text-gray-500")}),s.classList.add("active","border-indigo-600","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),t.querySelectorAll(".tab-content").forEach(i=>i.classList.add("hidden")),document.getElementById(s.dataset.tab).classList.remove("hidden"));return}const o=r.dataset.action;switch(a.stopPropagation(),o){case"close-modal":pa();break;case"delete-professional":const s=r.dataset.id;if(await W("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita e ele será removido da agenda e de todas as lojas.`))try{await os(s),me(p.establishmentId,qt(),"Equipe","Excluiu",`Excluiu profissional: ${e.name}`),g("Sucesso!","Profissional excluído da rede.","success"),pa(),Ht()}catch(k){g("Erro",`Não foi possível excluir: ${k.message}`,"error")}break;case"save-professional":const n=document.getElementById("professionalForm"),l=r,d=document.getElementById("profScheduleContainer"),c=Array.from(n.querySelectorAll("#profServicesContainer input:checked")).map(k=>k.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(k=>{const w=k.querySelector('[data-field="active"]').dataset.day;u[w]={active:k.querySelector('[data-field="active"]').checked,start:k.querySelector('[data-field="start"]').value,end:k.querySelector('[data-field="end"]').value,breakStart:k.querySelector('[data-field="breakStart"]').value,breakEnd:k.querySelector('[data-field="breakEnd"]').value}});const m=Array.from(n.querySelectorAll('input[name="accessibleIn"]:checked')).map(k=>k.value),x=m.length>0?m:[p.establishmentId],b={...e,id:n.querySelector("#professionalId").value||void 0,accessibleIn:x,name:n.querySelector("#profName").value.trim(),specialty:n.querySelector("#profSpecialty").value,photo:n.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:n.querySelector("#profPhone").value,dob:`${n.querySelector("#profDobDay").value}/${n.querySelector("#profDobMonth").value}`,receivesCommission:n.querySelector("#profCommission").value==="sim",showOnAgenda:n.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(n.querySelector("#profOrderOnAgenda").value)||1,notes:n.querySelector("#profNotes").value,status:n.querySelector("#profStatus").value,establishmentId:p.establishmentId},v=l.innerHTML;l.disabled=!0,l.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{b.id?(await ni(b.id,b),me(p.establishmentId,qt(),"Equipe","Editou",`Editou o profissional: ${b.name}`),g("Sucesso!","Dados atualizados.","success")):(delete b.id,await ii(b),me(p.establishmentId,qt(),"Equipe","Criou",`Cadastrou o profissional: ${b.name}`),g("Sucesso!","Novo membro adicionado à equipe.","success")),pa(),Ht()}catch(k){g("Erro",k.message,"error"),l.disabled=!1,l.innerHTML=v}break;case"delete-blockage":const f=r.dataset.id;if(await W("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await ja(f),g("Bloqueio removido.","success");const k=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";dt(e.id,k)}catch(k){g("Erro",k.message,"error")}break;case"batch-delete-blockage":const $=JSON.parse(r.dataset.ids);if(await W("Apagar em Lote",`Tem certeza que deseja apagar ${$.length} dias de bloqueio de uma vez?`))try{await ss($),g("Bloqueios removidos.","success");const k=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";dt(e.id,k)}catch(k){g("Erro",k.message,"error")}break}},t.addEventListener("click",Ne)}function Ia(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ce.size>0?(t.textContent=`${ce.size} selecionado(s)`,e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex")))}function bl(){W("Excluir em Lote",`Tem certeza que deseja excluir ${ce.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await li(Array.from(ce)),me(p.establishmentId,qt(),"Equipe","Excluiu em Lote",`Excluiu ${ce.size} profissionais`),g("Sucesso!",`${ce.size} profissionais foram excluídos.`,"success"),ce.clear(),Ia(),Ht()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ze(){const e=document.getElementById("professionalsList");if(!e)return;if(!p.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=il();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),r=p.professionals.filter(o=>{const s=o.name.toLowerCase().includes(a),i=t||o.status!=="inactive";return s&&i});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=nl(r)}async function Ht(){ce.clear(),ua.innerHTML=`
        ...
        </section>`,St&&ua.removeEventListener("click",St),St=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),r=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let s={};if(a.dataset.professional)try{s=JSON.parse(a.dataset.professional)}catch(i){console.error("Erro ao fazer parse do professional data:",i);return}ll(s);return}if(r){bl();return}const o=t.target.closest(".professional-checkbox");if(o){const s=o.dataset.id;o.checked?ce.add(s):ce.delete(s),Ze(),Ia();return}},ua.addEventListener("click",St),document.getElementById("profSearchInput").addEventListener("input",Ze),document.getElementById("showInactiveProfToggle").addEventListener("change",Ze);const e=document.getElementById("professionalsList");p.professionals=null,p.services=null,Ze();try{const[t,a,r]=await Promise.all([le(p.establishmentId),Te(p.establishmentId),Qe()]);p.professionals=t,p.services=a,At=r?.matrizes||[],Ze(),Ia()}catch{e.innerHTML='<p class="text-red-500 col-span-full font-bold text-center py-10 bg-red-50 rounded-lg border border-red-100">Erro ao carregar dados do servidor.</p>'}}let S={clients:[],selectedClient:null,activeTab:"profile",filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},showFilters:!1,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},Cs=null;const fl=e=>e?String(e).replace(/\D/g,""):"",xl=e=>{if(!e)return"Nunca";let t;if(typeof e=="object"&&(e.seconds||e._seconds)){const a=e.seconds||e._seconds;t=new Date(a*1e3)}else t=new Date(e);return isNaN(t.getTime())?"Data Inválida":t.toLocaleDateString("pt-BR")};function Ga(){Cs.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=Il)}function gt(){if(S.modalOpen)return;Ga();const e=document.getElementById("clients-content-area"),t=S.filters.inactiveDays||S.filters.birthMonth||S.filters.hasLoyalty||S.filters.hasDebt,a=`
    ...
    `,r=S.clients.length>0?`
        <div class="px-3 sm:px-4 pb-20 pt-2 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${S.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,m=xl(c.lastVisit);return`
    ...
    `;e.innerHTML=a+r;const o=document.getElementById("client-search"),s=document.getElementById("btn-toggle-filters"),i=document.getElementById("btn-apply-filters"),n=document.getElementById("btn-clear-search");s&&(s.onclick=()=>{S.showFilters=!S.showFilters,gt()});const l=document.getElementById("filter-birth-month");l&&(l.value=S.filters.birthMonth);const d=()=>{const c=document.getElementById("filter-inactive"),u=document.getElementById("filter-loyalty"),m=document.getElementById("filter-debt"),x=document.getElementById("filter-birth-month");S.filters={search:o.value,inactiveDays:c?c.value:"",birthMonth:x?x.value:"",hasLoyalty:u?u.checked:!1,hasDebt:m?m.checked:!1},La()};i&&(i.onclick=d),n&&(n.onclick=()=>{S.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},S.showFilters=!1,La()}),o.addEventListener("keypress",c=>{c.key==="Enter"&&d()}),e.querySelectorAll(".client-card").forEach(c=>{c.onclick=()=>Ds(c.dataset.id)})}function hl(e){const t=`
    ...
    `;let a="";return S.activeTab==="profile"?a=wl(e):S.activeTab==="appointments"?a=kl():S.activeTab==="history"?a=Sl():S.activeTab==="loyalty"&&(a=$l(e)),`
    ...
    `}function vl(e,t){if(!document.getElementById("tabs-styles")){const s=document.createElement("style");s.id="tabs-styles",s.textContent=`
        ...
        `,e.appendChild(s)}if(e.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const i=s.dataset.tab;if(S.activeTab===i)return;(i==="appointments"||i==="history")&&(S.historyLimit=20,S.historySearchTerm=""),S.activeTab=i,ze(),i!=="profile"&&!S.historyLoading&&S.historyData.appointments.length===0&&await wo(t.id)}}),S.activeTab==="profile"){const s=e.querySelector("#form-edit-client"),i=e.querySelector("#btn-delete-client");s&&(s.onsubmit=Ll),i&&(i.onclick=Cl)}if(S.activeTab==="loyalty"){const s=e.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>El(t))}const a=e.querySelector("#history-search-input");if(a){const s=a.value;a.value="",a.focus(),a.value=s,a.addEventListener("input",i=>{S.historySearchTerm=i.target.value,ze()})}const r=e.querySelector("#btn-load-more");r&&(r.onclick=()=>{S.historyLimit+=20,ze(),wo(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=i=>{Ve(),J("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=i=>{Ve(),J("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const o=e.querySelector("#btn-close-modal");o&&(o.onclick=Ve)}async function ze(){const e=S.selectedClient;if(!e){Ve();return}yl(e)}function yl(e){let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 animate-fade-in",t.innerHTML=`
        ...
        `,t.onclick=r=>{r.target===t&&Ve()},document.body.appendChild(t),document.body.classList.add("overflow-hidden"),S.modalOpen=!0);const a=t.querySelector("#client-modal-content");a.innerHTML=hl(e),vl(a,e)}function Ve(){const e=document.getElementById("client-details-modal-overlay");e&&e.remove(),document.body.classList.remove("overflow-hidden"),S.modalOpen=!1,S.selectedClient=null,gt()}function wl(e){return`
    ...
    `}function kl(e){let t=S.historyData.appointments||[];if(S.historySearchTerm){const r=S.historySearchTerm.toLowerCase();t=t.filter(o=>o.serviceName&&o.serviceName.toLowerCase().includes(r)||o.professionalName&&o.professionalName.toLowerCase().includes(r))}t.sort((r,o)=>new Date(o.startTime)-new Date(r.startTime));const a=r=>{const o=new Date(r.startTime),s=o.toLocaleDateString("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).replace(".",""),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),n=o<new Date;let l=n?"Concluído":"Agendado",d=n?"bg-gray-200 text-gray-600":"bg-green-100 text-green-700";return r.status==="cancelled"&&(l="Cancelado",d="bg-red-100 text-red-600"),`
    ...
    `}function Sl(e){let t=S.historyData.sales||[];if(S.historySearchTerm){const a=S.historySearchTerm.toLowerCase();t=t.filter(r=>r.id.includes(a))}return t.sort((a,r)=>new Date(r.date)-new Date(a.date)),t.length===0&&!S.historySearchTerm?'<div class="text-center py-12 text-gray-400">Nenhum registro financeiro.</div>':`
        <div class="space-y-4 w-full">
            <div class="sticky top-0 bg-gray-50 pt-2 pb-2 z-10 w-full">
                <div class="relative w-full">
                    <input type="text" id="history-search-input" 
            ...
            <div class="space-y-3 w-full">
                ${t.map(a=>{const r=new Date(a.date||a.createdAt),o=a.totalAmount||0;return`
    ...
    `}function $l(e){const t=S.historyData.loyaltyLog||[];t.sort((r,o)=>new Date(o.date)-new Date(r.date));const a=t.length>0?t.map(r=>{const o=r.type==="redemption";return`
            <div class="flex justify-between items-center py-3 border-b border-gray-100 last:border-0 w-full">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-700">${h(r.description||(o?"Resgate":"Acúmulo"))}</p>
    ...
    `}async function La(){S.loading=!0,Ga();try{let e=`/api/clients/${p.establishmentId}?limit=20`;S.filters.search&&(e+=`&search=${encodeURIComponent(S.filters.search)}`),S.filters.inactiveDays&&(e+=`&inactiveDays=${S.filters.inactiveDays}`),S.filters.hasLoyalty&&(e+="&hasLoyalty=true"),S.filters.hasDebt&&(e+="&hasDebt=true"),S.clients=await L(e),gt()}catch(e){console.error(e),g("Erro","Falha ao carregar clientes.","error"),S.clients=[],gt()}finally{S.loading=!1;const e=document.querySelector(".loader");e&&e.parentElement&&e.parentElement.remove()}}async function wo(e){const t=S.selectedClient;if(!(!t||!t.phone)){S.historyLoading=!0;try{const a=new Date;a.setMonth(a.getMonth()+12);const r=new Date;r.setFullYear(r.getFullYear()-5);let o=`/api/appointments/${p.establishmentId}?startDate=${r.toISOString()}&endDate=${a.toISOString()}`;o+=`&clientPhone=${encodeURIComponent(fl(t.phone))}`,o+=`&limit=${S.historyLimit}`;const s=await L(o);S.historyData.appointments=s,S.historyData.sales=s.filter(n=>n.status==="completed").map(n=>({id:n.id,date:n.startTime,totalAmount:n.totalAmount||0,items:n.comandaItems||n.services||[]}));const i=[];s.forEach(n=>{n.status==="completed"&&n.loyaltyPointsEarned>0&&i.push({type:"earn",points:n.loyaltyPointsEarned,date:n.startTime,description:"Venda finalizada"}),n.loyaltyRedemption&&i.push({type:"redemption",points:n.loyaltyRedemption.cost||0,date:n.startTime,description:`Resgate: ${n.loyaltyRedemption.name}`})}),S.historyData.loyaltyLog=i}catch(a){console.error("Erro ao buscar histórico",a)}finally{S.historyLoading=!1,S.modalOpen&&S.selectedClient&&ze()}}}function El(e){const t=e.loyaltyPoints||0,a=`
    ...
    `,{modalElement:r,close:o}=ne({title:"Ajuste de Pontos",contentHTML:a,maxWidth:"w-[90%] max-w-xs"});r.querySelector("form").onsubmit=async s=>{s.preventDefault();const i=document.getElementById("redeem-action").value,n=parseInt(document.getElementById("redeem-points").value,10),l=document.getElementById("redeem-reason").value;if(!n||n<=0)return g("Erro","Qtd inválida.","error");if(i==="debit"&&n>t)return g("Erro","Saldo insuficiente.","error");try{let d=t;i==="debit"?(await Gr(p.establishmentId,e.phone,n,l),d-=n):(d+=n,await ts(e.id,{loyaltyPoints:d})),S.selectedClient.loyaltyPoints=d,S.historyData.loyaltyLog.unshift({type:i==="debit"?"redemption":"earn",points:n,date:new Date().toISOString(),description:l+" (Manual)"}),g("Sucesso","Saldo atualizado.","success"),o(),ze()}catch(d){g("Erro",d.message,"error")}}}function Ds(e){S.selectedClient=S.clients.find(t=>t.id===e),S.activeTab="profile",S.historyLimit=20,S.historySearchTerm="",S.historyData={appointments:[],sales:[],loyaltyLog:[]},ze()}function Il(){const e=`
    ...
    `,{modalElement:t,close:a}=ne({title:"Novo Cliente",contentHTML:e,maxWidth:"w-[90%] max-w-sm"});t.querySelector("form").onsubmit=async r=>{r.preventDefault();const o=document.getElementById("new-name").value,s=document.getElementById("new-phone").value;try{const i=await es({establishmentId:p.establishmentId,name:o,phone:s});S.clients.unshift(i),g("Sucesso","Cliente criado!","success"),a(),Ds(i.id)}catch(i){g("Erro",i.message,"error")}}}async function Ll(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());a.establishmentId=p.establishmentId;try{await ts(S.selectedClient.id,a),Object.assign(S.selectedClient,a);const r=S.clients.findIndex(o=>o.id===S.selectedClient.id);r!==-1&&(S.clients[r]=S.selectedClient),g("Sucesso","Dados salvos!","success")}catch(r){g("Erro",r.message,"error")}}async function Cl(){if(await W("Excluir Cliente","Tem certeza? O histórico será apagado."))try{await Jr(S.selectedClient.id),S.clients=S.clients.filter(e=>e.id!==S.selectedClient.id),S.selectedClient=null,g("Sucesso","Cliente removido.","success"),Ve(),gt()}catch(e){g("Erro",e.message,"error")}}async function Dl(){Cs=document.getElementById("content"),S.selectedClient=null,S.searchTerm="",S.historyLimit=20,S.showFilters=!1,S.modalOpen=!1,S.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},Ga(),await La()}const Ee=document.getElementById("content"),ma={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},Tl={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};let U=null,G=null;function Ts(){return[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais da Unidade"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"whatsapp-bot",icon:"M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z",label:"Atendente Virtual (WhatsApp)"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"},{id:"support",icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",label:"Suporte e Ajuda"},{id:"cancellation",icon:"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z",label:"Cancelar Assinatura"}]}function ko(e,t,a){return new Promise((r,o)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=i=>{const n=new Image;n.src=i.target.result,n.onload=()=>{const l=document.createElement("canvas");let d=n.width,c=n.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(n,0,0,d,c);const m=e.type==="image/png"&&t<500?"image/png":"image/jpeg";r(l.toDataURL(m,a))},n.onerror=l=>o(l)},s.onerror=i=>o(i)})}function Ae(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const r=i=>{const n=new Map,l=[];return i&&(i.forEach(d=>n.set(d.id,{...d,children:[]})),n.forEach(d=>{d.parentId&&n.has(d.parentId)?n.get(d.parentId).children.push(d):l.push(d)})),l},o=(i,n="")=>{const l=i.id===t?"selected":"";a+=`<option value="${i.id}" ${l}>${n}${h(i.name)}</option>`,i.children.forEach(d=>o(d,n+"— "))};return r(e).forEach(i=>o(i)),a}async function Xe(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const r=[],{ownerName:o,...s}=e;if(o&&o!==p.userName){const n=ie.currentUser;n&&r.push(Js(n,{displayName:o}).then(()=>{p.userName=o}))}const i={...U,...s};r.push(qa(G,i)),await Promise.all(r),U=i,g("Sucesso","Definições salvas com sucesso!","success"),s.themeColor&&G===p.establishmentId&&setTimeout(()=>window.location.reload(),1500)}catch(r){g("Erro",`Não foi possível salvar: ${r.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function Bl(e,t){const a=h(e.name||""),r=h(e.phone||""),o=h(e.cnpj||""),s=h(e.email||""),i=h(e.address||""),n=h(e.website||""),l=h(p.userName||"");t.innerHTML=`
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const c={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,cnpj:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};Xe(c,d)})}function Pl(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const r=t.querySelector("#newPassword").value,o=t.querySelector("#confirmPassword").value;if(r!==o){g("Erro","As senhas não coincidem.","error");return}const s=t.querySelector('button[form="change-password-form"]');s.disabled=!0,s.textContent="A Salvar...";try{const i=ie.currentUser;if(i)await Ws(i,r),g("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum usuário logado encontrado.")}catch(i){g("Erro",`Não foi possível alterar a senha: ${i.message}`,"error")}finally{s.disabled=!1,s.textContent="Salvar Nova Senha"}})}function Ml(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const r=t.querySelector("#newEmail").value,o=t.querySelector("#currentPassword").value,s=t.querySelector('button[form="change-email-form"]');s.disabled=!0,s.textContent="A verificar...";try{const i=ie.currentUser,n=Vs.credential(i.email,o);await _s(i,n),await Us(i,r),await Er(G,r),g("Sucesso","Link de verificação enviado! Verifique o seu novo e-mail.","success"),a.target.reset()}catch(i){g("Erro",i.message,"error")}finally{s.disabled=!1,s.textContent="Salvar Novo E-mail"}})}function Al(e,t){const a=h(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#establishmentLogoBase64").value=e.logo||"",t.querySelector("#establishmentBackgroundImageBase64").value=e.backgroundImage||"",Ps(e.themeColor||"indigo",t),t.querySelector("#establishmentLogoButton").onclick=()=>t.querySelector("#establishmentLogoInput").click(),t.querySelector("#establishmentLogoInput").onchange=async r=>{const o=r.target.files[0];if(o){const s=await ko(o,300,.9);t.querySelector("#establishmentLogoPreview").src=s,t.querySelector("#establishmentLogoBase64").value=s}},t.querySelector("#establishmentBgButton").onclick=()=>t.querySelector("#establishmentBgInput").click(),t.querySelector("#establishmentBgInput").onchange=async r=>{const o=r.target.files[0];if(o){const s=t.querySelector("#establishmentBgButton");s.textContent="A processar...",s.disabled=!0;try{const i=await ko(o,1280,.7);t.querySelector("#establishmentBgPreview").src=i,t.querySelector("#establishmentBgPreview").classList.remove("hidden"),t.querySelector("#establishmentBgPlaceholder").classList.add("hidden"),t.querySelector("#establishmentBackgroundImageBase64").value=i}finally{s.textContent="Carregar Fundo",s.disabled=!1}}},t.querySelector("#establishmentBgRemoveBtn").onclick=()=>{t.querySelector("#establishmentBgPreview").src="",t.querySelector("#establishmentBgPreview").classList.add("hidden"),t.querySelector("#establishmentBgPlaceholder").classList.remove("hidden"),t.querySelector("#establishmentBackgroundImageBase64").value=""},t.querySelector("#branding-form").addEventListener("submit",r=>{r.preventDefault();const o={logo:t.querySelector("#establishmentLogoBase64").value,welcomeMessage:t.querySelector("#establishmentWelcomeMessage").value,backgroundImage:t.querySelector("#establishmentBackgroundImageBase64").value,primaryColor:t.querySelector("#establishmentPrimaryColorInput").value,textColor:t.querySelector("#establishmentTextColorInput").value,themeColor:t.querySelector("#establishmentThemeColor").value};Xe(o,r)})}function ql(e,t){const a=e.urlId||G;let r=window.location.origin;(r.includes("localhost")||r.includes("capacitor://")||r.includes("127.0.0.1"))&&(r="https://www.kairosagenda.com.br");const o=h(`${r}/agendar?id=${a}`),s=e.publicBookingEnabled||!1,i=s?"Agendamento Online ATIVO":"Agendamento Online INATIVO",n=s?"text-green-600":"text-red-600";t.innerHTML=`
    ...
    `;const a=t.querySelector("#establishmentTimezone");e.timezone&&(a.value=e.timezone);const r=t.querySelector("#establishmentWorkingHoursContainer"),o=e.workingHours||{};Object.keys(ma).forEach(s=>{const i=o[s]||{},n=ma[s],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            <div class="time-inputs grid grid-cols-2 gap-3">
                <div><label class="text-xs text-gray-500">Abertura:</label><input type="time" id="est-${s}-start" value="${i.start||"09:00"}" class="w-full rounded-md border-gray-300 p-2 text-sm bg-white"></div>
                <div><label class="text-xs text-gray-500">Fecho:</label><input type="time" id="est-${s}-end" value="${i.end||"18:00"}" class="w-full rounded-md border-gray-300 p-2 text-sm bg-white"></div>
                <div><label class="text-xs text-gray-500">Início Pausa:</label><input type="time" id="est-${s}-breakStart" value="${i.breakStart||"12:00"}" class="w-full rounded-md border-gray-300 p-2 text-sm bg-white"></div>
                <div><label class="text-xs text-gray-500">Fim Pausa:</label><input type="time" id="est-${s}-breakEnd" value="${i.breakEnd||"13:00"}" class="w-full rounded-md border-gray-300 p-2 text-sm bg-white"></div>
            </div>`,r.appendChild(d)}),r.addEventListener("change",s=>{const i=s.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),t.querySelector("#working-hours-form").addEventListener("submit",s=>{s.preventDefault();const i={};Object.keys(ma).forEach(l=>{i[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const n=t.querySelector("#establishmentTimezone").value;Xe({workingHours:i,timezone:n},s)})}function Bs(e,t){const a=!!e.whatsappInstance;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;let r=null;const o=t.querySelector("#btnGenerateQr"),s=t.querySelector("#btnCancelQr");o&&o.addEventListener("click",async()=>{o.disabled=!0,o.innerHTML='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Gerando...';const n="https://us-central1-kairos-agenda-us.cloudfunctions.net/whatsapp/api/whatsapp";try{const d=await(await fetch(`${n}/connect`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({establishmentId:G})})).json();if(d.qrcode){t.querySelector("#whatsappStatusArea").classList.add("hidden"),t.querySelector("#qrCodeDisplayArea").classList.remove("hidden");const c=d.qrcode.includes("data:image")?d.qrcode:`data:image/png;base64,${d.qrcode}`;t.querySelector("#qrCodeImage").src=c,r=setInterval(async()=>{try{const m=await(await fetch(`${n}/status/${G}`)).json();m.connected&&(clearInterval(r),U.whatsappInstance=m.instanceName,t.querySelector("#qrCodeDisplayArea").classList.add("hidden"),t.querySelector("#connectedStatusArea").classList.remove("hidden"),g("Sucesso","WhatsApp conectado com sucesso!","success"))}catch(u){console.error("Erro ao verificar status do WhatsApp",u)}},5e3)}else g("Erro na API",d.error||"Erro desconhecido","error")}catch(l){console.error(l),g("Erro de Conexão","Não foi possível acessar o servidor Kairós.","error")}finally{o.disabled=!1,o.innerHTML='<i class="bi bi-phone-vibrate"></i> Gerar QR Code'}}),s&&s.addEventListener("click",()=>{r&&clearInterval(r),t.querySelector("#qrCodeDisplayArea").classList.add("hidden"),t.querySelector("#whatsappStatusArea").classList.remove("hidden")});const i=t.querySelector("#btnDisconnectWhatsapp");i&&i.addEventListener("click",async()=>{if(!confirm("Tem certeza que deseja DESCONECTAR? O bot parará de responder imediatamente."))return;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Desconectando...';const n="https://us-central1-kairos-agenda-us.cloudfunctions.net/whatsapp/api/whatsapp";try{const d=await(await fetch(`${n}/disconnect`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({establishmentId:G})})).json();d.success?(g("Sucesso","WhatsApp desconectado!","success"),U.whatsappInstance=null,Bs(U,t)):alert("Erro ao desconectar: "+d.error)}catch(l){console.error(l),g("Erro","Falha ao comunicar com o servidor.","error")}finally{i&&(i.disabled=!1,i.innerHTML='<i class="bi bi-power"></i> Desconectar')}})}async function jl(e,t){const a=e.loyaltyProgram||{},r=a.pointsPerVisit||1;let o=[],s=[],i=[];try{[o,s,i]=await Promise.all([Te(G),ta(G),Oa(G)])}catch(d){console.error("Erro ao carregar dados para fidelidade:",d)}t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
             <div class="flex justify-between items-center mb-6">
    ...
    `;const n=t.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const c=document.createElement("div");c.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const u=d.type||"money",m=d.itemId||"",x=d.reward||"",b=d.discount||"",v=d.points||d.costPoints||"";c.innerHTML=`
        ...
        `;const f=c.querySelector(".type-select"),$=c.querySelector(".item-select"),k=c.querySelector(".desc-input"),w=c.querySelector(".discount-input"),D=I=>{$.innerHTML='<option value="">Selecione...</option>';let q=[];I==="service"?q=o:I==="product"?q=s:I==="package"&&(q=i),q.forEach(N=>{const T=N.id===m,M=N.name||N.title||"Sem nome",R=N.price||N.salePrice||0;$.innerHTML+=`<option value="${N.id}" data-price="${R}" ${T?"selected":""}>${h(M)}</option>`})};return u!=="money"&&D(u),f.addEventListener("change",I=>{const q=I.target.value;q==="money"?($.classList.add("hidden"),k.classList.remove("hidden"),k.value="",w.value=""):($.classList.remove("hidden"),k.classList.add("hidden"),D(q),w.value="")}),$.addEventListener("change",I=>{const q=I.target.selectedOptions[0];if(q&&q.value){k.value=q.text;const N=q.dataset.price;N&&(w.value=parseFloat(N).toFixed(2))}}),c};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),t.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const c=d.target.closest(".remove-loyalty-tier");c&&c.closest(".loyalty-tier-row").remove()}),t.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const c=Array.from(t.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(m=>{const x=m.querySelector(".type-select").value,b=x==="money"?null:m.querySelector(".item-select").value;let v=x==="money"?m.querySelector(".desc-input").value:m.querySelector(".item-select").options[m.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(m.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(m.querySelector('input[data-field="points"]').value,10)||0,type:x,itemId:b,reward:v,name:v,discount:parseFloat(m.querySelector('input[data-field="discount"]').value)||0}}),u={loyaltyProgram:{enabled:t.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(t.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:c.filter(m=>m.points>0&&m.reward)}};Xe(u,d)})}async function Nl(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,r]=await Promise.all([ra(G),za(G)]),o=e.financialIntegration||{},s=e.commissionConfig||{},i=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ae(a,o.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ae(r,o.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ae(a,i.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ae(r,i.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ae(a,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ae(r,s.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar o plano de contas da unidade.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const r={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Xe(r,a)})}function Fl(e,t){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${e.name}).`;t.innerHTML=`
    ...
    `}function Ps(e="indigo",t){const a=t.querySelector("#color-palette-container"),r=t.querySelector("#establishmentThemeColor");!a||!r||(a.innerHTML="",Object.entries(Tl).forEach(([o,s])=>{const i=o===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
            ...
            <p class="text-xs mt-2 font-medium ${i?"text-gray-900 font-bold":"text-gray-500"}">${s.name}</p>
        `,n.addEventListener("click",()=>{r.value=o,Ps(o,t)}),a.appendChild(n)}),r.value=e)}function Ol(e,t){const a=t.querySelector("#slotIntervalContainer"),r=t.querySelector("#establishmentSlotInterval");if(!a||!r)return;const o=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=o.map(s=>{const i=s.value===e;return`<button type="button" data-value="${s.value}" 
    ...
    `,Ee.querySelector('button[data-action="back-to-menu"]').addEventListener("click",o=>{o.preventDefault(),Ms({id:G})});const r=document.getElementById("settings-content-detail");switch(e){case"personal-data":Bl(U,r);break;case"change-password":Pl(U,r);break;case"change-email":Ml(U,r);break;case"branding":Al(U,r);break;case"booking":ql(U,r);break;case"working-hours":Rl(U,r);break;case"whatsapp-bot":Bs(U,r);break;case"loyalty":await jl(U,r);break;case"financial":await Nl(U,r);break;case"support":Fl(U,r);break;case"cancellation":Hl(U,r);break;default:r.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Ms(e={}){Ee.innerHTML=`
    ...
    `;try{G=e.id||p.establishmentId,U=await Ce(G);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
               ...
               </button>`:"",a=U.isMatriz||!U.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',r=Ts();Ee.innerHTML=`
        ...
        `,Ee.querySelectorAll("div[data-section]").forEach(o=>{o.addEventListener("click",s=>{zl(o.dataset.section)})}),Ee.querySelectorAll(".module-toggle").forEach(o=>{o.addEventListener("change",async()=>{const s=o.dataset.module;try{const n={...(await Ce(G)).modules,[s]:o.checked};await qa(G,{modules:n}),g("Módulos","Módulos atualizados com sucesso.","success")}catch(i){o.checked=!o.checked,g("Erro",i.message,"error")}})})}catch(t){Ee.innerHTML=`
    ...
    `).join("")}const ct=document.getElementById("content");async function _e(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,r=document.getElementById("filterEndDate")?.value,o=await Zt(p.establishmentId,a||new Date().toISOString().split("T")[0],r||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),i=s?o.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):o,n=i.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",i.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let m=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${h(l)} (${d.length})</h4>`;if(d.length>1){const x=JSON.stringify(d.map(b=>b.id));m+=`<button data-action="batch-delete-blockage" data-ids='${x}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}m+="</div>",c.innerHTML=m,d.forEach(x=>{const b=new Date(x.startTime),v=new Date(x.endTime),f=b.toLocaleDateString("pt-BR"),$=v.toLocaleDateString("pt-BR"),w=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${f===$?`${f} | ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${f} às ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${$} às ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;c.innerHTML+=w}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function _l(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,r=t.querySelector("#blockageDate").value,o=t.querySelector("#blockageEndDate").value||r,s=t.querySelector("#blockageStartTime").value,i=t.querySelector("#blockageEndTime").value,n={establishmentId:p.establishmentId,professionalId:a,startTime:new Date(`${r}T${s}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Kt(n),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),_e(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Ul(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const r=t.querySelector("#batchBlockageDate").value,o=t.querySelector("#batchBlockageEndDate").value||r,s=t.querySelector("#batchBlockageStartTime").value,i=t.querySelector("#batchBlockageEndTime").value,n=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:p.establishmentId,professionalId:c,startTime:new Date(`${r}T${s}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:n};return Kt(u)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&_e(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Wl(e){ct.addEventListener("submit",t=>{t.target.id==="blockageForm"&&_l(t),t.target.id==="batchBlockageForm"&&Ul(t)}),ct.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&_e(e)}),ct.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const r=a.dataset.action;if(r==="back-to-professionals")J("profissionais-section");else if(r==="delete-blockage"){if(await W("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await ja(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),_e(e)}catch(s){g("Erro",`Não foi possível remover o bloqueio: ${s.message}`,"error")}}else if(r==="batch-delete-blockage"){const o=JSON.parse(a.dataset.ids);if(await W("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await ss(o),g("Sucesso",`${o.length} bloqueios removidos.`,"success"),_e(e)}catch(i){g("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function Jl(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){ct.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const r=h(a);ct.innerHTML=`
        <section>
        ...
        </section>`,Wl(t),await _e(t);const o=document.getElementById("batchProfSelectionContainer");try{const s=await le(p.establishmentId);o.innerHTML=s.map(i=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{o.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const Gl=e=>L(`/api/users/${e}`),Yl=e=>L("/api/users",{method:"POST",body:JSON.stringify(e)}),Ql=(e,t)=>L(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),Xl=e=>L(`/api/users/${e}`,{method:"DELETE"}),Zl=(e,t)=>L(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),Kl=(e,t)=>L(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),Ke=document.getElementById("content"),ed={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},td={view:"Visualizar",create:"Criar",edit:"Editar"};let $t=null,Et=null,Ue=null;const ad={group_admin:"Administrador do Grupo",company_admin:"Gestor de Matriz",branch_manager:"Gestor de Filial",professional:"Profissional Padrão"};function od(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const r=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${r}</p>`;return}e.sort((r,o)=>(r.status==="active"?-1:1)-(o.status==="active"?-1:1)),t.innerHTML=e.map(r=>{const o=JSON.stringify(r).replace(/'/g,"&apos;"),s=r.status==="active",i=p.professionals.find(m=>m.id===r.professionalId),n=i?i.name:"N/A",l=i?i.name.charAt(0):r.name.charAt(0),d=i?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`,c=ad[r.role]||"Profissional",u=r.role==="group_admin"?"bg-purple-100 text-purple-800":r.role==="company_admin"?"bg-blue-100 text-blue-800":r.role==="branch_manager"?"bg-orange-100 text-orange-800":"bg-gray-100 text-gray-800";return`
            ...
            <div class="p-3 flex-grow flex flex-col justify-between min-w-0">
                ...
                <div class="mt-2 flex items-center justify-between gap-2">
                    <label class="flex items-center cursor-pointer" title="${s?"Ativo":"Inativo"}">
                        <div class="relative">
                            <input type="checkbox" data-action="toggle-user-status" data-user-id="${r.id}" class="sr-only" ${s?"checked":""}>
    ...
    `}).join("")}function Ca(){const t=document.getElementById("showInactiveUsersToggle")?.checked?p.users:p.users.filter(a=>a.status==="active");od(t)}function sd(e={}){return Object.entries(ed).map(([t,a])=>{const r=t==="agenda-section"||t==="comandas-section",o=e[t]?.view_all_prof===!0,s=Object.entries(td).map(([n,l])=>`
    ...
    `}).join("")}function So(e){if(!Ue||p.userRole==="professional")return"";const t=e?.accessibleEstablishments?.map(s=>s.id)||[],a=e?.accessibleCompanies?.map(s=>s.id)||[];if((e?.role||"professional")==="group_admin")return'<div class="p-3 bg-purple-50 border border-purple-200 rounded-lg text-purple-800 text-sm font-bold">Acesso Total (Global) liberado.</div>';let o='<div class="space-y-3 max-h-48 overflow-y-auto custom-scrollbar p-2 bg-gray-50 rounded border">';return Ue.companies.forEach(s=>{const i=a.includes(s.id),n=Ue.branches.filter(l=>l.companyId===s.id);o+=`
            <div class="company-block">
                <label class="flex items-center space-x-2 cursor-pointer mb-1">
                    <input type="checkbox" class="company-checkbox rounded text-indigo-600 focus:ring-indigo-500 h-4 w-4" value="${s.id}" data-name="${s.name}" ${i?"checked":""}>
        ...
        `}),o+="</div>",o}async function $o(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=p.professionals;if(!a||a.length===0)try{a=await le(p.currentViewContext.id),p.professionals=a}catch{console.warn("Profissionais não carregados")}if(["group_admin","company_admin"].includes(p.userRole)&&!Ue)try{const d=await fetch("/api/establishments/hierarchy",{headers:{Authorization:`Bearer ${await p.getAuthToken?.()||""}`}});d.ok&&(Ue=await d.json())}catch(d){console.error("Falha ao buscar hierarquia",d),Ue={companies:[],branches:[]}}const r=d=>a?.find(c=>c.id===d),o=e?.professionalId;r(o);const s=e!==null;t.querySelector("#userFormTitle").textContent=s?`Editar: ${e.name}`:"Novo Usuário";const i=t.querySelector("#userForm");i.innerHTML=`
    ...
    `,$t&&Ke.removeEventListener("click",$t),Et&&Ke.removeEventListener("change",Et),$t=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":$o();break;case"edit-user":const r=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));$o(r);break;case"back-to-list":Ot();break;case"delete-user":{if(e.stopPropagation(),await W("Excluir Usuário","Tem certeza? Ação irreversível."))try{await Xl(t.dataset.userId),g("Usuário excluído!","success"),Ot()}catch(o){g(`Erro: ${o.message}`,"error")}break}}},Et=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Ca();else if(t){e.stopPropagation();const a=t.dataset.userId,r=t.checked?"active":"inactive";try{await Kl(a,r);const o=p.users.findIndex(s=>s.id===a);o>-1&&(p.users[o].status=r,Ca())}catch(o){g(`Erro: ${o.message}`,"error"),t.checked=!t.checked}}},Ke.addEventListener("click",$t),Ke.addEventListener("change",Et),await rd()}const id=document.getElementById("content");let Eo={},Da=null;function nd(){Object.values(Eo).forEach(e=>e?.destroy()),Eo={}}function ld(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,r=new a({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(r.setFontSize(18),r.text(e,r.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const i=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];r.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=r.lastAutoTable?r.lastAutoTable.finalY+20:60;r.text("Detalhes das Vendas",20,s),r.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),r.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Io(e){const t=document.getElementById("genericModal"),a=h(e.client),r=h(e.items),o=h(e.responsavelCaixa||"N/A"),s=(e.payments||[]).map(i=>`
    ...
    `,t.style.display="flex"}function dd(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const r=document.getElementById("paymentSummaryTableBody"),o=Object.entries(t.paymentMethodTotals).sort(([,n],[,l])=>l-n);r.innerHTML=o.map(([n,l])=>`
        <tr class="border-b">
    ...
    `).join("");const s=document.getElementById("transactionsTableBody"),i=document.getElementById("mobileTransactionsList");if(a.length===0){const n='<tr><td colspan="5" class="text-center py-8 text-gray-500">Nenhuma venda encontrada para o período selecionado.</td></tr>';s.innerHTML=n,i.innerHTML='<div class="text-center py-8 text-gray-500">Nenhuma venda encontrada.</div>';return}s.innerHTML=a.map((n,l)=>{const d=h(n.client),c=h(n.items),u=h(n.type);return`
    ...
    `}).join(""),s.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=Da.transactions[l];d&&Io(d)})}),i.innerHTML=a.map((n,l)=>{const d=h(n.client),c=h(n.items),u=h(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=Da.transactions[l];d&&Io(d)})})}async function Lo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const r=t.value,o=a.value;if(!r||!o)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,i=await Ur({establishmentId:p.establishmentId,startDate:r,endDate:o,cashierSessionId:s});Da=i,e.innerHTML=`
        ...
        `,dd(i)}catch(s){g("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${h(s.message)}</p>`}}async function cd(){nd();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];id.innerHTML=`
        <section class="pb-20 md:pb-0"> <div class="flex flex-col gap-4 mb-6">
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Lo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const r=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${r}_a_${o}`;ld(s,"transactionsTable")});try{const r=await Ai(p.establishmentId),o=document.getElementById("cashierSessionFilter");r&&r.length>0&&r.forEach(s=>{const i=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=h(s.closedByName||"N/A");o.innerHTML+=`<option value="${s.id}">${n} - ${i}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Lo()}const ud=document.getElementById("content");let E={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1},It=null,Lt=null;function Ya(e){const t=new Map,a=[];return e&&(e.forEach(r=>t.set(r.id,{...r,children:[]})),t.forEach(r=>{r.parentId&&t.has(r.parentId)?t.get(r.parentId).children.push(r):a.push(r)})),a}function As(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,r]=e.split("-"),o=new Date(t,a-1,r),s=String(o.getDate()).padStart(2,"0"),i=o.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:s,month:i,full:o.toLocaleDateString("pt-BR")}}function ue(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function zt(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[r,o,s]=e.split("-");return new Date(r,o-1,s)<a}function pd(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const r=(o,s=0)=>`
            <div class="flex justify-between items-center bg-gray-50 p-2.5 rounded-lg border border-gray-100 mb-1 hover:bg-gray-100 transition-colors" style="margin-left: ${s*16}px;">
                <span class="text-sm font-medium text-gray-700"><i class="bi ${s===0?"bi-folder2-open text-indigo-500":"bi-arrow-return-right text-gray-400"} mr-2"></i>${o.name}</span>
            ...
            ${o.children.map(n=>r(n,s+1)).join("")}
        `;e.innerHTML=t.map(o=>r(o)).join("")}async function Ta(e){const t=document.getElementById("genericModal"),a=e==="nature",r=a?"Plano de Contas (Naturezas)":"Centros de Custo",o=a?ra:za,s=a?an:sn,i=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const m=Ya(u);pd(n,m,e);const x=l.value;l.innerHTML='<option value="">-- Nível Principal --</option>';const b=(v,f=0)=>{const $="  ".repeat(f)+(f>0?"↳ ":"");l.innerHTML+=`<option value="${v.id}">${$}${v.name}</option>`,v.children.forEach(k=>b(k,f+1))};m.forEach(v=>b(v)),l.value=x};try{const u=await o(p.establishmentId);E[i]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const m=t.querySelector("#itemName").value,x=l.value;try{await s({name:m,parentId:x||null,establishmentId:p.establishmentId});const b=await o(p.establishmentId);E[i]=b,d(b),c.reset(),await De(),g("Sucesso","Item adicionado ao plano de contas.","success")}catch(b){g("Erro",b.message,"error")}})}async function md(){try{const t=(await Qe()).matrizes||[];E.establishments=[],t.forEach(a=>{E.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(r=>E.establishments.push({id:r.id,name:r.name,type:"Filial"}))}),E.filterEstablishmentIds.size===0&&E.filterEstablishmentIds.add(p.establishmentId)}catch(e){console.warn("Erro ao buscar lojas",e)}qs(),Rs(),await De()}function qs(){const e=E.establishments.map(t=>`
        <label class="inline-flex items-center gap-2 px-3 py-2 bg-white border ${E.filterEstablishmentIds.has(t.id)?"border-indigo-500 ring-1 ring-indigo-500 bg-indigo-50/20 text-indigo-700":"border-gray-200 text-gray-600"} rounded-xl cursor-pointer hover:bg-gray-50 transition-all shadow-sm est-label select-none">
            <input type="checkbox" class="est-filter-checkbox rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 w-4 h-4" value="${t.id}" ${E.filterEstablishmentIds.has(t.id)?"checked":""}>
        ...
        <div class="flex flex-col h-[calc(100vh-80px)] md:h-auto bg-gray-100 w-full overflow-hidden relative font-sans">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4">
                    ...
                    <div class="flex flex-col md:flex-row gap-3 items-center w-full">
                        <div class="relative w-full md:w-96 flex-shrink-0">
                            <i class="bi bi-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                            <input type="text" id="searchInput" value="${E.searchQuery}" placeholder="Pesquisar descrição ou obs..." class="w-full pl-10 p-2.5 bg-gray-50 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 outline-none transition-all">
                        </div>
                        ...
                        <button id="toggle-filter-btn" class="w-full md:w-auto px-4 py-2.5 bg-white border border-gray-300 text-gray-700 font-bold rounded-lg hover:bg-gray-50 transition-colors shadow-sm flex items-center justify-center gap-2 flex-shrink-0 ${E.isAdvancedFilterOpen?"bg-indigo-50 text-indigo-700 border-indigo-300":""}">
                            <i class="bi bi-funnel"></i> Filtros Avançados
                        </button>
                    </div>

                    <div id="filter-panel" class="${E.isAdvancedFilterOpen?"block":"hidden"} mt-4 bg-indigo-50/50 p-5 rounded-xl border border-indigo-100 shadow-inner">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" id="filterStartDate" value="${E.startDate}" class="w-full p-2.5 border border-gray-300 rounded-lg text-sm bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                            </div>
                            <div>
                                <label class="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">Data Final</label>
                                <input type="date" id="filterEndDate" value="${E.endDate}" class="w-full p-2.5 border border-gray-300 rounded-lg text-sm bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                            </div>
                    ...
                    <div class="flex mt-6 bg-gray-100/80 p-1 rounded-xl border border-gray-200">
                        <button id="tab-receivables" class="flex-1 py-2.5 text-sm font-black rounded-lg shadow-sm transition-all flex justify-center items-center gap-2 ${E.currentTab==="receivables"?"bg-white text-emerald-700":"text-gray-500"}">
                            A Receber / Entradas
                        </button>
                        <button id="tab-payables" class="flex-1 py-2.5 text-sm font-bold rounded-lg transition-all flex justify-center items-center gap-2 ${E.currentTab==="payables"?"bg-white text-red-700 shadow-sm":"text-gray-500 hover:text-gray-700"}">
                            A Pagar / Saídas
                        </button>
                    </div>
                </div>
            ...
            <div class="flex-1 overflow-y-auto px-4 py-6 max-w-7xl mx-auto w-full space-y-6 custom-scrollbar">
                ...
                <div class="flex flex-wrap gap-2 mb-4 bg-white p-2 rounded-xl shadow-sm border border-gray-200">
                    <button data-status="all" class="status-filter-btn px-4 py-2 text-xs font-bold rounded-lg transition-colors ${E.statusFilter==="all"?"bg-gray-800 text-white shadow-sm":"bg-gray-100 text-gray-600 hover:bg-gray-200"}">Todos</button>
                    <button data-status="pending" class="status-filter-btn px-4 py-2 text-xs font-bold rounded-lg transition-colors ${E.statusFilter==="pending"?"bg-gray-800 text-white shadow-sm":"bg-gray-100 text-gray-600 hover:bg-gray-200"}">Abertos / Prov.</button>
                    <button data-status="paid" class="status-filter-btn px-4 py-2 text-xs font-bold rounded-lg transition-colors ${E.statusFilter==="paid"?"bg-gray-800 text-white shadow-sm":"bg-gray-100 text-gray-600 hover:bg-gray-200"}">Baixados</button>
                    <button data-status="overdue" class="status-filter-btn px-4 py-2 text-xs font-bold rounded-lg transition-colors ${E.statusFilter==="overdue"?"bg-gray-800 text-white shadow-sm":"bg-gray-100 text-gray-600 hover:bg-red-100 hover:text-red-700"}">Atrasados</button>
                </div>
            ...
            <button id="fab-add" class="md:hidden fixed bottom-6 right-6 w-14 h-14 ${E.currentTab==="receivables"?"bg-emerald-600 hover:scale-105":"bg-red-600 hover:scale-105"} text-white rounded-full shadow-xl flex items-center justify-center transition-all z-40">
                <i class="bi bi-plus-lg text-2xl"></i>
            </button>

        </div>
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-100","text-indigo-700"),js()}function Rs(){const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",r=>{const o=r.target.checked,s=document.querySelectorAll(".item-checkbox");E.selectedIds.clear(),s.forEach(i=>{i.checked=o,o&&E.selectedIds.add(i.dataset.id)}),Fe()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{E.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(r=>r.checked=!1),Fe()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const r=E.selectedIds.size;if(r===0)return;if(await W("Excluir Lançamentos",`Deseja realmente apagar ${r} registros financeiros?`))try{const s=E.currentTab==="payables"?"payables":"receivables";await bs(s,Array.from(E.selectedIds)),g("Sucesso",`${r} itens excluídos.`,"success"),E.selectedIds.clear(),Fe(),De()}catch{g("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(r=>{r.addEventListener("change",o=>{const s=o.target.closest("label");o.target.checked?(E.filterEstablishmentIds.add(o.target.value),s.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),s.classList.remove("border-gray-200","text-gray-600")):(E.filterEstablishmentIds.delete(o.target.value),s.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),s.classList.add("border-gray-200","text-gray-600"))})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const r=document.getElementById("filter-panel"),o=document.getElementById("toggle-filter-btn");E.isAdvancedFilterOpen=!E.isAdvancedFilterOpen,E.isAdvancedFilterOpen?(r.classList.remove("hidden"),o.classList.add("bg-indigo-50","text-indigo-700","border-indigo-300")):(r.classList.add("hidden"),o.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-300"))}),document.getElementById("settings-btn").addEventListener("click",hd),document.querySelectorAll('[data-action="new-financial"]').forEach(r=>{r.addEventListener("click",o=>{ga(o.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const r=E.currentTab==="payables"?"payable":"receivable";ga(r)});const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t.addEventListener("click",()=>Co("receivables")),a.addEventListener("click",()=>Co("payables")),document.querySelectorAll(".status-filter-btn").forEach(r=>{r.addEventListener("click",o=>{document.querySelectorAll(".status-filter-btn").forEach(s=>{s.classList.remove("bg-gray-800","text-white","shadow-sm"),s.classList.add("bg-gray-100","text-gray-600")}),o.target.classList.add("bg-gray-800","text-white","shadow-sm"),o.target.classList.remove("bg-gray-100","text-gray-600","hover:bg-gray-200","hover:bg-red-100"),E.statusFilter=o.target.dataset.status,Vt(),Ns()})}),document.querySelectorAll(".date-preset-btn").forEach(r=>{r.addEventListener("click",o=>{document.querySelectorAll(".date-preset-btn").forEach(d=>d.classList.remove("bg-indigo-100","text-indigo-700")),o.target.classList.add("bg-indigo-100","text-indigo-700");const s=o.target.dataset.preset,i=new Date;let n,l;s==="month"?(n=new Date(i.getFullYear(),i.getMonth(),1),l=new Date(i.getFullYear(),i.getMonth()+1,0)):s==="last_month"?(n=new Date(i.getFullYear(),i.getMonth()-1,1),l=new Date(i.getFullYear(),i.getMonth(),0)):s==="year"&&(n=new Date(i.getFullYear(),0,1),l=new Date(i.getFullYear(),11,31)),document.getElementById("filterStartDate").value=n.toISOString().split("T")[0],document.getElementById("filterEndDate").value=l.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",r=>{E.searchQuery=r.target.value.toLowerCase(),Vt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const r=new Date;document.getElementById("filterStartDate").value=new Date(r.getFullYear(),r.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(r.getFullYear(),r.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",E.filterEstablishmentIds.clear(),E.filterEstablishmentIds.add(p.establishmentId),qs(),Rs()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{E.startDate=document.getElementById("filterStartDate").value,E.endDate=document.getElementById("filterEndDate").value,E.filterNaturezaId=document.getElementById("filterNaturezaId").value,E.filterCostCenterId=document.getElementById("filterCostCenterId").value,E.filterEstablishmentIds.size===0&&E.filterEstablishmentIds.add(p.establishmentId),document.getElementById("toggle-filter-btn").click(),De()}),It&&document.body.removeEventListener("click",It),It=r=>{const o=r.target;if(o.classList.contains("item-checkbox")||o.classList.contains("modal-item-checkbox")){const n=o.value||o.dataset.id;o.checked?E.selectedIds.add(n):E.selectedIds.delete(n),Fe(),r.stopPropagation();return}const s=o.closest("button[data-action]");if(s){const{action:n,type:l,id:d}=s.dataset;if(r.stopPropagation(),n==="delete"){const c=s.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");bd(l,JSON.parse(c));return}if(n==="mark-as-paid"){gd(l,d);return}if(n==="manage-natures"){Ta("nature");return}if(n==="manage-cost-centers"){Ta("cost-center");return}}const i=o.closest(".financial-row");if(i&&document.getElementById("list-container").contains(i)&&!o.closest("button")&&!o.closest(".item-checkbox")){const{type:n}=i.dataset,l=JSON.parse(i.dataset.item.replace(/&apos;/g,"'"));ga(n,l)}},document.body.addEventListener("click",It),Lt&&document.getElementById("genericModal").removeEventListener("click",Lt),Lt=r=>{if(r.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const s=r.target.closest('button[data-action^="delete-"]');if(s){const i=s.dataset.action.split("-")[1];xd(i,s.dataset.id)}},document.getElementById("genericModal").addEventListener("click",Lt)}function Fe(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),r=E.selectedIds.size;t.textContent=r,r>0?(e.classList.remove("hidden"),e.classList.add("flex"),a&&a.classList.add("hidden")):(e.classList.add("hidden"),e.classList.remove("flex"),a&&a.classList.remove("hidden"))}function Co(e){E.currentTab=e,E.selectedIds.clear(),Fe(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),r=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-emerald-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),r&&(r.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-emerald-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-emerald-700","shadow-sm"),t.classList.add("text-gray-500"),r&&(r.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")),Vt()}async function De(){const e=document.getElementById("list-container");e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A processar transações...</p></div>';try{if(E.natures.length===0){const[s,i]=await Promise.all([ra(p.establishmentId),za(p.establishmentId)]);E.natures=s,E.costCenters=i,js()}const t=Array.from(E.filterEstablishmentIds).join(","),a={startDate:E.startDate,endDate:E.endDate,establishmentId:t};E.filterNaturezaId!=="all"&&(a.natureId=E.filterNaturezaId),E.filterCostCenterId!=="all"&&(a.costCenterId=E.filterCostCenterId);const[r,o]=await Promise.all([xs(a),hs(a)]);E.payables=r.entries||[],E.receivables=o.entries||[],Ns(),Vt()}catch(t){e.innerHTML=`
            ...
            </div>`}}function js(){const e=r=>{let o='<option value="all">-- Todas as opções --</option>';const s=Ya(r),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");o+=`<option value="${n.id}">${d}${n.name}</option>`,n.children.forEach(c=>i(c,l+1))};return s.forEach(n=>i(n)),o},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(E.natures)),a&&(a.innerHTML=e(E.costCenters))}function Ns(){const e=document.getElementById("summary-section");if(!e)return;const t=E.currentTab==="receivables";let r=t?E.receivables:E.payables;E.searchQuery&&(r=r.filter(c=>c.description&&c.description.toLowerCase().includes(E.searchQuery)||c.entity&&c.entity.toLowerCase().includes(E.searchQuery)||c.notes&&c.notes.toLowerCase().includes(E.searchQuery)));const o=r.reduce((c,u)=>c+u.amount,0),s=r.filter(c=>c.status==="paid").reduce((c,u)=>c+u.amount,0),i=r.filter(c=>c.status==="pending"&&!zt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),n=r.filter(c=>zt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),l=t?"emerald":"red",d=t?"Receitas":"Despesas";e.innerHTML=`
        ...
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
            ...
            <p class="text-xl font-bold text-${l}-600">${ue(s)}</p>
        </div>
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
            ...
            <p class="text-xl font-bold ${n>0?"text-red-600":"text-gray-400"}">${ue(n)}</p>
        </div>
    `}function Vt(){const e=document.getElementById("list-container");if(!e)return;const t=E.currentTab==="receivables",a=t?E.receivables:E.payables;let r=a;if(E.statusFilter!=="all"&&(r=a.filter(l=>{const d=zt(l.dueDate,l.status);return E.statusFilter==="overdue"?d:E.statusFilter==="pending"?l.status==="pending"&&!d:l.status===E.statusFilter})),E.searchQuery&&(r=r.filter(l=>l.description&&l.description.toLowerCase().includes(E.searchQuery)||l.entity&&l.entity.toLowerCase().includes(E.searchQuery)||l.notes&&l.notes.toLowerCase().includes(E.searchQuery))),r.sort((l,d)=>new Date(l.dueDate)-new Date(d.dueDate)),r.length===0){e.innerHTML=`
        ...
        `;return}const o=new Map(E.natures.map(l=>[l.id,l.name])),s=new Map(E.establishments.map(l=>[l.id,l])),i=t?"receivable":"payable",n=t?"text-emerald-600":"text-red-600";e.innerHTML=r.map(l=>{const d=As(l.dueDate),c=l.status==="paid",u=zt(l.dueDate,l.status);let m="";c?m='<span class="bg-gray-100 text-gray-600 border border-gray-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-check2-circle mr-1"></i>Baixado</span>':u?m='<span class="bg-red-50 text-red-600 border border-red-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-exclamation-circle mr-1"></i>Atrasado</span>':m='<span class="bg-blue-50 text-blue-600 border border-blue-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-clock-history mr-1"></i>A Vencer</span>';const x=l.naturezaId?o.get(l.naturezaId)||"Não Categorizado":"Geral",b=s.get(l.establishmentId);let v="";if(b){const I=b.type==="Matriz"?"bi-building":"bi-shop";v=`<span class="text-[9px] px-1.5 py-0.5 rounded bg-slate-100 text-slate-600 font-bold border border-slate-200 flex items-center whitespace-nowrap w-max" title="Unidade: ${b.name}"><i class="bi ${I} mr-1 opacity-60"></i> ${b.name}</span>`}else v='<span class="text-[9px] px-1.5 py-0.5 rounded bg-gray-100 text-gray-600 font-bold border border-gray-200 flex items-center whitespace-nowrap w-max"><i class="bi bi-geo-alt mr-1 opacity-60"></i> Atual</span>';const f=JSON.stringify(l).replace(/'/g,"&apos;"),$=E.selectedIds.has(l.id),w=!!l.recurrenceId?'<i class="bi bi-arrow-repeat text-indigo-400 ml-1.5 text-xs" title="Lançamento Recorrente"></i>':"",D=l.entity?`<span class="text-xs text-gray-500 font-medium truncate block"><i class="bi bi-person mr-1 opacity-50"></i>${l.entity}</span>`:"";return`
        <div class="financial-row md:grid md:grid-cols-12 md:gap-4 md:items-center bg-white p-4 md:p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer relative group flex flex-col gap-3 ${$?"bg-indigo-50/30":""}"
            ...
            <div class="md:col-span-4 hidden md:flex flex-col justify-center">
                ...
                <div class="flex items-center gap-2 mt-1">
                    ...
                    <p class="text-[10px] text-gray-500 flex items-center font-medium">
                        <i class="bi bi-tag mr-1 opacity-50"></i> ${x} ${w}
                    </p>
                </div>
            </div>
            ...
            <div class="md:hidden flex flex-wrap items-center gap-2 mt-1">
                ...
                <span class="text-[10px] px-2 py-1 rounded bg-gray-100 text-gray-600 font-bold border border-gray-200 flex items-center">
                    <i class="bi bi-tag mr-1.5 opacity-50"></i> ${x} ${w}
                </span>
            </div>
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:justify-end border-t border-gray-100 md:border-t-0 pt-3 md:pt-0 mt-1 md:mt-0">
                ...
                <p class="font-black text-base ${c?"text-gray-400":n}">${ue(l.amount)}</p>
            </div>
        ...
        `}).join("")}async function gd(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?cn(t,a):gn(t,a)),g("Baixa Realizada","O lançamento foi registado como pago.","success"),await De()}catch(r){g("Erro",r.message,"error")}}async function bd(e,t){if(!!!t.recurrenceId){await W("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Fs(e,[t.id]);return}fd(e,t)}function fd(e,t){const a=document.getElementById("genericModal"),o=(e==="payable"?E.payables:E.receivables).filter(d=>d.recurrenceId===t.recurrenceId).sort((d,c)=>new Date(d.dueDate)-new Date(c.dueDate));a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${o.map(d=>{const c=d.id===t.id,u=d.status==="paid",m=As(d.dueDate);return`
                    <label class="flex items-center gap-4 p-3 bg-white rounded-xl border ${c?"border-red-400 ring-1 ring-red-100 shadow-sm bg-red-50/30":"border-gray-200 hover:bg-gray-50"} cursor-pointer transition-all">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs font-medium text-gray-500 mt-0.5">${ue(d.amount)} ${u?'<span class="text-emerald-600 font-bold ml-1">(Baixado)</span>':""}</p>
                        </div>
    ...
    `,a.style.display="flex";const s=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");s.addEventListener("change",d=>{i.forEach(c=>c.checked=d.target.checked),l()}),i.forEach(d=>d.addEventListener("change",l));function l(){const d=Array.from(i).filter(c=>c.checked).length;n.innerHTML=d>0?`<i class="bi bi-trash3"></i> Excluir ${d} Parcela(s)`:"Selecione para excluir",n.disabled=d===0,d===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const d=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(d.length===0)return;a.style.display="none",await W("Confirmar Ação",`Tem certeza que deseja apagar estas ${d.length} parcelas permanentemente?`)&&await Fs(e,d)}),l()}async function Fs(e,t){try{t.length===1?e==="payable"?await dn(t[0]):await mn(t[0]):await bs(e==="payable"?"payables":"receivables",t),g("Sucesso",`${t.length} registo(s) limpo(s) do sistema.`,"success"),E.selectedIds.clear(),Fe(),await De()}catch(a){g("Erro",a.message,"error")}}async function xd(e,t){const r=e==="nature"?on:rn;if(await W("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await r(t),Ta(e==="nature"?"nature":"cost-center")}catch(s){g("Erro",s.message,"error")}}function hd(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ga(e,t=null){const a=document.getElementById("genericModal"),r=e==="payable",o=r?"red":"emerald",s=t?"Editar Lançamento":"Novo Lançamento",i=E.establishments.map(I=>{const q=t?t.establishmentId===I.id:I.id===p.establishmentId;return`<option value="${I.id}" ${q?"selected":""}>${I.type==="Matriz"?"🏢":"📍"} ${I.name}</option>`}).join(""),n=(I,q)=>{let N='<option value="">-- Selecione --</option>';const T=Ya(I),M=(R,O=0)=>{const z="  ".repeat(O)+(O>0?"↳ ":""),j=R.id===q?"selected":"";N+=`<option value="${R.id}" ${j}>${z}${R.name}</option>`,R.children.forEach(C=>M(C,O+1))};return T.forEach(R=>M(R)),N},d=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(I=>`<option value="${I.value}" ${t?.paymentMethod===I.value?"selected":""}>${I.label}</option>`).join("");a.innerHTML=`
        <div class="modal-content max-w-3xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden m-4 flex flex-col max-h-[90vh]">
            ...
            <div class="bg-${o}-600 px-6 py-5 flex justify-between items-center flex-shrink-0 relative overflow-hidden">
                ...
                <div class="flex items-center gap-4 relative z-10">
                    ...
                    <div>
                        <h2 class="text-xl font-black text-white tracking-wide">${s}</h2>
                        <p class="text-xs text-${o}-100 font-medium uppercase tracking-widest mt-0.5">${r?"Contas a Pagar / Despesa":"Contas a Receber / Receita"}</p>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <select name="centroDeCustoId" class="w-full p-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-${o}-500 outline-none text-sm font-medium text-gray-700 transition-shadow">
                                ${n(E.costCenters,t?.centroDeCustoId)}
                            </select>
                        </div>
                        <div>
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-5">
                        <label class="flex items-center gap-4 cursor-pointer group">
                            ...
                            <div>
                                <span class="block text-sm font-black text-gray-800 group-hover:text-${o}-700 transition-colors uppercase tracking-wide">Marcar como ${r?"Pago":"Recebido"}</span>
        ...
        </div>`,a.style.display="flex";const c=a.querySelector("#financial-form");let u="single",m=2;const x=c.querySelector('[name="amount"]'),b=c.querySelector("#recurrence-options"),v=c.querySelector("#recurrence-summary"),f=c.querySelector("#installments-input"),$=c.querySelector("#status-toggle"),k=c.querySelector("#payment-date-wrapper"),w=c.querySelector('[name="paymentDate"]'),D=()=>{if(u==="single")return;const I=parseFloat(x.value)||0;if(m=parseInt(f.value)||2,I===0){v.innerHTML='<span class="text-xs text-indigo-400 font-medium">Digite o valor total...</span>';return}if(u==="installment"){const q=I/m;v.innerHTML=`
                <div>
                    <span class="block text-[10px] text-indigo-400 uppercase tracking-widest font-bold mb-1">Simulação do Parcelamento</span>
                    <span class="font-black text-lg text-indigo-700 block leading-tight">${m}x de ${ue(q)}</span>
                    <span class="text-xs text-indigo-500 font-medium">Total: ${ue(I)}</span>
                </div>
            `}else if(u==="repeat"){const q=I*m;v.innerHTML=`
                <div>
                    <span class="block text-[10px] text-indigo-400 uppercase tracking-widest font-bold mb-1">Geração Recorrente Fixa</span>
                    <span class="font-black text-lg text-indigo-700 block leading-tight">${m}x de ${ue(I)}</span>
                    <span class="text-xs text-indigo-500 font-medium">Lançamento Total: ${ue(q)}</span>
                </div>
            `}};t||a.querySelectorAll(".mode-btn").forEach(I=>{I.addEventListener("click",q=>{if(a.querySelectorAll(".mode-btn").forEach(N=>{N.classList.remove("bg-gray-900","text-white","shadow-sm"),N.classList.add("text-gray-500","hover:bg-gray-100")}),q.target.classList.add("bg-gray-900","text-white","shadow-sm"),q.target.classList.remove("text-gray-500","hover:bg-gray-100"),u=q.target.dataset.mode,u==="single")b.classList.add("hidden");else{b.classList.remove("hidden");const N=b.querySelector("label");N.textContent=u==="installment"?"Número de Parcelas":"Repetir por quantos meses?",D()}})}),x.addEventListener("input",D),f&&(f.addEventListener("input",D),c.querySelector("#btn-minus").addEventListener("click",()=>{let I=parseInt(f.value)||2;I>2&&(f.value=I-1,D())}),c.querySelector("#btn-plus").addEventListener("click",()=>{let I=parseInt(f.value)||2;I<60&&(f.value=I+1,D())})),$.addEventListener("change",()=>{$.checked?(k.classList.remove("hidden"),w.required=!0):(k.classList.add("hidden"),w.required=!1)}),c.addEventListener("submit",async I=>{I.preventDefault();const q=c.querySelector('button[type="submit"]'),N=q.innerHTML;q.disabled=!0,q.innerHTML='<div class="loader-small border-white"></div> A gravar...';const T=new FormData(c),M=$.checked,R=parseFloat(T.get("amount"));let O=R,z=1;!t&&u!=="single"&&(z=parseInt(T.get("installments")),u==="repeat"&&(O=R*z));const j={establishmentId:T.get("establishmentId"),description:T.get("description"),amount:O,dueDate:T.get("dueDate"),naturezaId:T.get("naturezaId")||null,centroDeCustoId:T.get("centroDeCustoId")||null,entity:T.get("entity")||null,paymentMethod:T.get("paymentMethod")||null,documentNumber:T.get("documentNumber")||null,notes:T.get("notes"),status:M?"paid":"pending",paymentDate:M?T.get("paymentDate"):null,installments:z};z>1&&!t&&(j.recurrenceId=self.crypto.randomUUID());try{t?(await(r?ln(t.id,j):pn(t.id,j)),g("Sucesso","Atualizado com sucesso!","success")):(await(r?nn(j):un(j)),g("Sucesso","Lançamento criado!","success")),document.getElementById("genericModal").style.display="none",De()}catch(C){g("Erro",C.message||"Erro ao salvar","error"),q.disabled=!1,q.innerHTML=N}})}const vd=e=>L("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),yd=e=>L("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),wd=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return L(`/api/commissions/stats?${a}`)},kd=(e={})=>{Object.keys(e).forEach(r=>(e[r]===void 0||e[r]===null||e[r]==="")&&delete e[r]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return L(a)},Sd=e=>L(`/api/commissions/report/${e}`,{method:"DELETE"}),_t=new Date,Do=new Date(_t.getFullYear(),_t.getMonth(),1),F={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:Do.toISOString().split("T")[0],dashEndDate:_t.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:Do.toISOString().split("T")[0],histEndDate:_t.toISOString().split("T")[0],histProfessionalId:"all"};let Ct=null;const at=document.getElementById("content");async function $d(){try{F.professionals=await le(p.establishmentId)}catch(e){console.error("Erro profissionais",e)}qd(),Ed(),la(),Wt("dashboard")}function Ed(){Ct&&at.removeEventListener("click",Ct),Ct=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,r=t.dataset.id,o=t.dataset.idx;switch(a){case"tab-nav":Wt(t.dataset.tab);break;case"toggle-all-profs":Id();break;case"back-to-filters":F.calculationResult=null,Ut(document.getElementById("commissions-content"));break;case"view-preview-items":Ad(o);break;case"save-final-report":Cd();break;case"start-new-calc":Wt("calculator");break;case"print-receipt":Dd(r);break;case"delete-report":Td(r);break;case"filter-dashboard":la();break;case"filter-history":Qa();break}},at.addEventListener("click",Ct),at.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Pd(t)}},at.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Ld())}}async function la(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(F.dashStartDate=e.value),t&&(F.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const r=await wd(F.dashStartDate,F.dashEndDate);F.dashStats={revenue:r.totalRevenue||0,commissions:r.totalCommissionsPaid||0},F.currentTab==="dashboard"&&Hs(document.getElementById("commissions-content"))}catch(r){console.error(r),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Qa(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(F.histStartDate=e.value),t&&(F.histEndDate=t.value),a&&(F.histProfessionalId=a.value);const r=document.getElementById("history-list-container");if(r){r.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const o=await kd({startDate:F.histStartDate,endDate:F.histEndDate,professionalId:F.histProfessionalId});F.historyData=o,Os(r,o)}catch{r.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Id(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function Ld(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),r=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");F.periodString=`${a} a ${r}`;const o=document.getElementById("commissions-content");o.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await vd(t);F.calculationResult=s.map(i=>({...i,extraDebit:0,extraCredit:0,finalValue:i.summary.totalCommission,notes:""})),Ut(o)}catch(s){g("Erro",s.message,"error"),F.calculationResult=null,Ut(o)}}async function Cd(){const e=F.calculationResult.length;if(await W("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=F.calculationResult.map(r=>{const o=r.items.map(s=>s.originalSaleId).filter(s=>s!=null);return yd({professionalId:r.professionalId,professionalName:r.professionalName,period:F.periodString,processedSalesIds:o,reportData:{...r,summary:{...r.summary,finalValue:r.finalValue,extraDebit:r.extraDebit||0,extraCredit:r.extraCredit||0,notes:r.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),F.calculationResult=null,la(),Wt("history")}catch(a){g("Erro",a.message,"error")}}function Dd(e){const t=F.historyData.find(a=>a.id===e);t&&Bd(t)}async function Td(e){if(await W("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Sd(e),g("Sucesso","Registro removido.","success"),Qa(),la()}catch(a){g("Erro",a.message,"error")}}function Bd(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,r=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",r,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const o=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&o.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&o.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:o,theme:"grid"});const s=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Pd(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let r=0,o=0;if(t.forEach(s=>{s.value&&(r=parseFloat(s.value))}),a.forEach(s=>{s.value&&(o=parseFloat(s.value))}),F.calculationResult&&F.calculationResult[e]){const s=F.calculationResult[e];s.extraDebit=r,s.extraCredit=o,s.finalValue=s.summary.totalCommission-r+o,t.forEach(n=>{n!==document.activeElement&&(n.value=r||"")}),a.forEach(n=>{n!==document.activeElement&&(n.value=o||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(n=>n.innerText=`R$ ${s.finalValue.toFixed(2)}`),Md()}}function Md(){const e=F.calculationResult.reduce((a,r)=>a+r.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function Ad(e){const t=F.calculationResult[e];if(!t)return;const a=t.items.map(r=>`
    ...
    `).join("");ne({title:"Detalhes da Comissão",contentHTML:`<div class="bg-gray-50 p-3 rounded-lg mb-4 flex justify-between items-center"><div><p class="text-xs text-gray-500">Profissional</p><p class="font-bold text-gray-800">${t.professionalName}</p></div><div class="text-right"><p class="text-xs text-gray-500">Total Itens</p><p class="font-bold text-gray-800">${t.items.length}</p></div></div><div class="border rounded-lg overflow-hidden max-h-[60vh] overflow-y-auto">${a}</div>`,maxWidth:"max-w-md"})}function Ut(e){if(F.calculationResult){const t=F.calculationResult,a=t.reduce((s,i)=>s+i.finalValue,0),r=t.map((s,i)=>`
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-4">
                ...
                <div class="grid grid-cols-2 gap-3 mb-3">
                    <div><label class="text-xs font-bold text-red-500 uppercase">Desc.</label><input type="number" step="0.01" data-idx="${i}" class="input-debit w-full mt-1 p-2 border border-red-200 rounded-lg bg-red-50 font-bold text-red-700" value="${s.extraDebit||""}"></div>
                    <div><label class="text-xs font-bold text-green-500 uppercase">Bônus</label><input type="number" step="0.01" data-idx="${i}" class="input-credit w-full mt-1 p-2 border border-green-200 rounded-lg bg-green-50 font-bold text-green-700" value="${s.extraCredit||""}"></div>
                </div>
                <div class="flex justify-between items-center bg-gray-50 p-3 rounded-lg"><span class="text-sm font-medium">Líquido</span><span class="text-xl font-bold text-indigo-700 final-value-display" data-idx="${i}">R$ ${s.finalValue.toFixed(2)}</span></div>
            ...
            <td class="px-6 py-4 text-right"><input type="number" step="0.01" data-idx="${i}" class="input-debit w-24 text-right border-gray-300 rounded bg-red-50 text-red-700" value="${s.extraDebit||""}"></td>
            <td class="px-6 py-4 text-right"><input type="number" step="0.01" data-idx="${i}" class="input-credit w-24 text-right border-gray-300 rounded bg-green-50 text-green-700" value="${s.extraCredit||""}"></td>
            <td class="px-6 py-4 text-right font-bold text-indigo-700 final-value-display" data-idx="${i}">R$ ${s.finalValue.toFixed(2)}</td>
            ...
            </div>`}else{const t=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],r=F.professionals.map(o=>`
        ...
        <div class="space-y-6 animate-fade-in">
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4 items-end">
                <div class="flex-1 w-full">
                    ...
                    <input type="date" id="dash-start" value="${F.dashStartDate}" class="w-full mt-1 rounded-lg border-gray-300">
                </div>
                <div class="flex-1 w-full">
                    <label class="text-xs font-bold text-gray-500 uppercase">Data Final</label>
                    <input type="date" id="dash-end" value="${F.dashEndDate}" class="w-full mt-1 rounded-lg border-gray-300">
                </div>
    ...
    `}function Rd(e){const t=F.professionals.map(a=>`<option value="${a.id}" ${F.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <div>
                        ...
                        <input type="date" id="hist-start" value="${F.histStartDate}" class="w-full mt-1 rounded-lg border-gray-300">
                    </div>
                    <div>
                        <label class="text-xs font-bold text-gray-500 uppercase">Até</label>
                        <input type="date" id="hist-end" value="${F.histEndDate}" class="w-full mt-1 rounded-lg border-gray-300">
                    </div>
                    <div>
    ...
    `,F.historyData.length>0?Os(document.getElementById("history-list-container"),F.historyData):Qa()}function Os(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ba=document.getElementById("content");let Le={allPackages:[],catalogForModal:{services:[],products:[]}},Dt=null,He=null;function jd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Nd(){const e=document.getElementById("packagesListContainer");if(e){if(Le.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=Le.allPackages.map(t=>{const a=t.status==="active",r=JSON.stringify(t).replace(/'/g,"&apos;"),o=t.price||0,s=t.originalPrice||0,i=s>o?s-o:0,n=s>0?(s-o)/s*100:0,l=h(t.name),d=h(t.description||"Sem descrição");return`
                ...
                <div class="p-4 flex-grow">
                    ...
                    <div class="mt-3 pt-3 border-t flex justify-between items-end">
                        <div>
                            ...
                            ${i>0?`<p class="text-xs text-gray-500 line-through">De R$ ${s.toFixed(2)}</p>
        ...
        `}).join("")}}function To(){const e=document.getElementById("genericModal");e.style.display="none",He&&e.removeEventListener("click",He)}async function Bo(e=null){const t=document.getElementById("genericModal"),a=!!e,r=e?JSON.parse(JSON.stringify(e.items||[])):[],o=h(e?.name||""),s=h(e?.description||""),i=e?.price||"",n=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(x,b)=>{const v=b.querySelector("#originalPrice"),f=x.reduce(($,k)=>$+k.price*k.quantity,0);v&&(v.textContent=`R$ ${f.toFixed(2)}`)},m=x=>{x.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=x.map((b,v)=>{const f=b.type==="service",$=f?"Serviço":"Produto",k=f?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(x,t)};m(r),c.addEventListener("change",x=>{if(x.target.classList.contains("quantity-input")){const b=parseInt(x.target.dataset.index,10),v=parseInt(x.target.value,10);v>0&&r[b]&&(r[b].quantity=v,m(r))}}),c.addEventListener("click",x=>{if(x.target.classList.contains("remove-item-btn")){const b=parseInt(x.target.dataset.index,10);r.splice(b,1),m(r)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Fd(x=>{const b=r.find(v=>v.id===x.id&&v.type===x.type);b?b.quantity++:r.push({...x,quantity:1}),m(r)}),He&&t.removeEventListener("click",He),He=async x=>{const b=x.target.closest("button[data-action]");if(!b)return;const v=b.dataset.action;if(x.stopPropagation(),v==="close-modal"&&To(),v==="save-package"){const f=b,$={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:r,originalPrice:r.reduce((k,w)=>k+w.price*w.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:p.establishmentId};if(!$.name||!$.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if($.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}f.disabled=!0,f.textContent="A salvar...";try{a?await ji($.id,$):(delete $.id,await Ri($)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),To(),await Xa()}catch(k){g("Erro",`Não foi possível salvar o pacote: ${k.message}`,"error"),f.disabled=!1,f.textContent="Salvar Pacote"}}},t.addEventListener("click",He)}function Fd(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const r={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},o=l=>{const d=t.toLowerCase(),c=Le.catalogForModal.services.filter(b=>b.name.toLowerCase().includes(d)),u=Le.catalogForModal.products.filter(b=>b.name.toLowerCase().includes(d)),m=c.map(b=>`
    ...
    `,document.body.appendChild(a);const s=a.querySelector("#item-selection-list"),i=a.querySelector("#item-search-input"),n=()=>{a.remove()};o(s),i.addEventListener("input",()=>{t=i.value,o(s)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:m}=d.dataset,b=(Le.catalogForModal[u+"s"]||[]).find(v=>v.id===m);b&&(e({...b,type:u}),n())}else(c||l.target===a)&&n()})}async function Xa(){ba.innerHTML=`
    ...
    `,Dt&&ba.removeEventListener("click",Dt),Dt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const r=e.target.closest('[data-action="delete-package"]');if(r){const o=r.dataset.id;W("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await Ni(o),g("Sucesso!","Pacote excluído.","success"),await Xa()}catch(i){g("Erro",`Não foi possível excluir: ${i.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")Bo(null);else if(a==="edit-package"){const r=JSON.parse(t.dataset.package);Bo(r)}},ba.addEventListener("click",Dt);try{const[e,t,a]=await Promise.all([Oa(p.establishmentId),Te(p.establishmentId),ta(p.establishmentId)]);Le.allPackages=e,Le.catalogForModal={services:t.filter(r=>r.active),products:a},Nd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Hd=document.getElementById("content");let Od=null;async function zd(){const e=h(p.userName||"Usuário"),t=h(ie.currentUser?.email||"E-mail não disponível"),a=p.userName?p.userName.charAt(0):"U";Hd.innerHTML=`
    ...
    `,await Vd()}async function Vd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await ri(t);Od=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const r=h(a.name);e.innerHTML=`
            ...
            `,_d(a.id),document.getElementById("my-blocks-filter").addEventListener("change",s=>Jt(a.id,s.target.value)),Jt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function _d(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const r=t.querySelector("#blockDate").value,o=t.querySelector("#blockStartTime").value,s=t.querySelector("#blockEndTime").value,i=t.querySelector("#blockReason").value;if(!r||!o||!s){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(o>=s){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const n=new Date(`${r}T${o}:00`),l=new Date(`${r}T${s}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Kt({establishmentId:p.establishmentId,professionalId:e,reason:i||"Bloqueado (Meu Perfil)",startTime:n.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;Jt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),g("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function Jt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const r=new Date;let o,s;t==="history"?(s=new Date,o=new Date,o.setFullYear(o.getFullYear()-1)):(o=new Date,s=new Date,s.setFullYear(s.getFullYear()+1));let n=(await Zt(p.establishmentId,o.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?n=n.filter(l=>l.endTime<r).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=r).sort((l,d)=>l.startTime-d.startTime),n.length>0?(a.innerHTML=n.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,m=h(l.reason||"Sem motivo");return`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const o=(await Qe()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),o.length===0)t.innerHTML=`
            ...
            `;else{let s="";o.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';s+=`
                ...
                `,i.branches&&i.branches.length>0?i.branches.forEach(l=>{s+=`
                ...
                `}),t.innerHTML=s}Po||(Ud(),Po=!0)}catch(r){console.error("Erro na renderização da rede:",r),t.innerHTML=`
        ...
        `}}function Ud(){const e=document.getElementById("form-create-establishment");e&&e.addEventListener("submit",async t=>{t.preventDefault();const a=e.querySelector('button[type="submit"]'),r=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const o={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const s=await Sr(o);alert(s.message||"Sucesso!"),e.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await Gt(document.getElementById("content"))}catch(s){console.error("Erro ao criar estabelecimento:",s),alert("Erro: "+(s.message||"Falha ao gravar dados."))}finally{a.innerHTML=r,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>Gt(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const K=document.getElementById("loadingScreen"),et=document.getElementById("dashboardContent"),Oe=document.getElementById("content"),fa=document.getElementById("notificationBell"),Tt=document.getElementById("notificationBadge"),qe=document.getElementById("notificationPanel"),xa=document.getElementById("notificationList"),tt=document.getElementById("profileMenuButton"),ae=document.getElementById("profileDropdown"),Mo=document.getElementById("profileName"),Ao=document.getElementById("profileEmail"),qo=document.getElementById("logoutButton"),Ro=document.getElementById("myProfileLink"),jo=document.getElementById("hamburger-menu-btn"),te=document.getElementById("sidebar"),re=document.getElementById("mobile-overlay"),No=document.getElementById("themeToggleBtn"),ha=document.getElementById("themeIcon"),Ba=document.getElementById("mobile-bottom-nav"),Ye=document.getElementById("nav-scroll"),Fo=document.getElementById("scroll-hint-left"),Ho=document.getElementById("scroll-hint-right"),Wd=document.querySelectorAll(".bottom-nav-item");function Pa(){if(!Ye||!Fo||!Ho)return;const{scrollLeft:e,scrollWidth:t,clientWidth:a}=Ye;Fo.classList.toggle("visible",e>5),Ho.classList.toggle("visible",e+a<t-5)}function Jd(){if(!Ye)return;const e=document.querySelector(".bottom-nav-item.active");if(!e)return;const t=Ye,a=t.getBoundingClientRect(),r=e.getBoundingClientRect(),s=r.left+r.width/2-a.left-a.width/2;t.scrollBy({left:s,behavior:"smooth"})}const Gd={"dashboard-section":Qr,"agenda-section":ns,"comandas-section":tn,"relatorios-section":xn,"servicos-section":Fn,"produtos-section":Xn,"suppliers-section":Zn,"profissionais-section":Ht,"clientes-section":Dl,"estabelecimento-section":e=>Ms(e),"ausencias-section":Jl,"users-section":Ot,"sales-report-section":cd,"financial-section":md,"commissions-section":$d,"packages-section":Xa,"my-profile-section":zd,"hierarquia-section":()=>Gt(Oe),"establishments-section":()=>Gt(Oe)},Oo={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#eef2ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#eff6ff",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#1f2937"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#64748b",hover:"#475569",light:"#f1f5f9",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};function Bt(e){const t=Oo[e]||Oo.indigo,r=(s=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const o=document.getElementById("dynamic-theme-styles");o&&(o.innerHTML=`
            :root {
        ...
        `)}function Rt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("kairos_theme",e),ha&&(e==="dark"?ha.innerHTML="☀️":ha.innerHTML="🌙")}function Yd(){const e=localStorage.getItem("kairos_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;Rt(e||(t?"dark":"light"))}let ut=null,pt=[];function zs(){if(!Tt||!xa)return;const e=pt.filter(t=>!t.read).length;if(e>0?(Tt.textContent=e,Tt.classList.remove("hidden")):Tt.classList.add("hidden"),pt.length===0){xa.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}xa.innerHTML=pt.map(t=>`
    ...
    `).join("")}function zo(e){ut&&ut();const t=Yt(be,"establishments",e,"notifications"),a=Wo(t,Jo("timestamp",">=",new Date),ar("timestamp","desc"));ut=or(a,r=>{r.docChanges().forEach(o=>{if(o.type==="added"){const s=o.doc.data();pt.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(s.title,s.message,"info",!0),zs();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&ns()}})},r=>{console.error("Erro no listener de notificações:",r)})}async function Qd(e){const t=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),r=document.getElementById("multi-context-label"),o=document.getElementById("multi-context-count"),s=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!t||!s))try{const c=(await Qe()).matrizes||[];let u="",m=0;if(c.forEach(x=>{u+=`
                <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors mb-1">
                    <input type="checkbox" value="${x.id}" class="context-checkbox" data-name="${Pt(x.name)}">
                    <span class="text-[13px] sm:text-sm font-bold text-slate-700 truncate">🏢 ${Pt(x.name)}</span>
                </label>
            `,m++,x.branches&&x.branches.length>0&&x.branches.forEach(b=>{u+=`
                        <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors ml-4 mb-1 border-l-2 border-slate-100 pl-3">
                            <input type="checkbox" value="${b.id}" class="context-checkbox" data-name="${Pt(b.name)}">
                            <span class="text-[12px] sm:text-[13px] font-medium text-slate-600 truncate">📍 ${Pt(b.name)}</span>
                        </label>
                    `,m++})}),m>0){s.innerHTML=u,t.style.display="block",(!p.selectedEstablishments||p.selectedEstablishments.length===0)&&(p.selectedEstablishments=[e]);const x=Array.from(s.querySelectorAll('input[type="checkbox"]')),b=()=>{const f=x.filter($=>$.checked);o.textContent=f.length,f.length===0?r.textContent="Nenhuma selecionada":f.length===1?r.textContent=f[0].dataset.name:r.textContent=`${f.length} Unidades`};let v=!1;x.forEach(f=>{p.selectedEstablishments.includes(f.value)&&(f.checked=!0,v=!0)}),!v&&x.length>0&&(x[0].checked=!0,p.selectedEstablishments=[x[0].value],p.establishmentId=x[0].value),b(),a.addEventListener("click",f=>{f.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",f=>{!t.contains(f.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",x.forEach($=>{$.checked=p.selectedEstablishments.includes($.value)}),b())}),x.forEach(f=>{f.addEventListener("change",b)}),i.addEventListener("click",async f=>{f.stopPropagation(),K&&(K.classList.remove("hidden","fade-out"),K.style.display="flex");const $=x.filter(w=>w.checked);if($.length===0){K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500)),g("Atenção","Tem de selecionar pelo menos uma unidade.","warning");return}p.selectedEstablishments=$.map(w=>w.value);const k=p.selectedEstablishments[0];try{const w=await Ce(k);p.establishmentId=k,p.establishmentName=w.name,p.enabledModules=w.modules,p.currentViewContext={id:k,name:w.name,type:w.parentId?"BRANCH":"GROUP"},typeof Bt=="function"&&Bt(w.themeColor||"indigo"),zo(k),Vo(p.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",g("Ambiente Atualizado","Exibindo informações consolidadas.","success");const D=document.querySelector(".sidebar-link.active"),I=D?D.getAttribute("data-target"):"dashboard-section";J(I)}catch(w){console.error("Erro ao aplicar contextos:",w),g("Erro","Ocorreu um problema ao trocar a visualização.","error")}finally{K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500))}});try{const f=await Ce(p.establishmentId);p.establishmentName=f.name,p.enabledModules=f.modules,p.currentViewContext={id:p.establishmentId,name:f.name,type:f.parentId?"BRANCH":"GROUP"},typeof Bt=="function"&&Bt(f.themeColor||"indigo"),zo(p.establishmentId),Vo(p.userPermissions)}catch(f){console.error(f)}}else t.style.display="none"}catch(d){console.error("Erro ao carregar switcher de contexto:",d),t.style.display="none"}}function J(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const o=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(e),s=p.enabledModules?.[a]!==!1,i=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!o&&(!s||!i)){Oe&&(Oe.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),te&&te.classList.contains("absolute")&&(te.classList.add("hidden"),re&&re.classList.add("hidden"));return}}const r=Gd[e];r&&Oe&&(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),Ba&&(Wd.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),setTimeout(Jd,50),setTimeout(Pa,100)),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Oe.innerHTML="",window.innerWidth<768&&te&&(te.classList.add("hidden"),re&&re.classList.add("hidden")),r(t))}window.navigateTo=J;async function Vo(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),r=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,i=e===null||e["financial-section"]?.view===!0;if(s&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!s&&!i))try{const n=await Wr();s&&r&&(r.textContent=n.todayAppointments.toString()),i&&o&&(o.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch(n){console.error("Erro ao carregar KPIs do cabeçalho:",n)}}async function Xd(e){try{pe.getPlatform()==="android"&&await ee.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0});let t=await ee.checkPermissions();if(t.receive==="prompt"&&(t=await ee.requestPermissions()),t.receive!=="granted")return;await ee.register(),ee.addListener("registration",async a=>{try{const r=bt(be,"users",e);await Ma(r,{fcmTokens:tr(a.value),platform:"native_mobile"})}catch{}}),ee.addListener("pushNotificationReceived",a=>g(a.title,a.body,"info",!0)),ee.addListener("pushNotificationActionPerformed",()=>J("agenda-section"))}catch{}}function Zd(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),r=()=>e&&(e.style.display="block"),o=()=>e&&(e.style.display="none"),s=()=>e&&e.style.display==="block";e&&(t.addEventListener("click",()=>{o(),pe.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{o(),pe.isNativePlatform()?oo.exitApp():history.back()}),pe.isNativePlatform()?oo.addListener("backButton",()=>{if(s())o();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(te&&!te.classList.contains("hidden")&&window.innerWidth<768){te.classList.add("hidden"),re&&re.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?r():J("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(s()){o(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?r():(J("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Pt(e){return e?e.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function Kd(){try{await Gs(ie,Ys)}catch{}pe.isNativePlatform()&&document.body.classList.add("is-app-native"),fr(),Zd(),Yd(),No&&No.addEventListener("click",e=>{e.preventDefault();const t=document.documentElement.getAttribute("data-theme");Rt(t==="dark"?"light":"dark")}),jo&&jo.addEventListener("click",e=>{e.stopPropagation(),te&&(te.classList.remove("hidden"),te.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),re&&re.classList.remove("hidden")}),Ba&&(Ba.addEventListener("click",e=>{const t=e.target.closest(".bottom-nav-item");if(!t)return;e.preventDefault();const a=t.getAttribute("data-target");J(a)}),Ye&&Ye.addEventListener("scroll",Pa),Pa()),re&&re.addEventListener("click",()=>{te&&(te.classList.add("hidden"),te.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),re.classList.add("hidden")}),fa&&fa.addEventListener("click",e=>{e.stopPropagation(),qe&&(qe.classList.toggle("hidden"),qe.classList.contains("hidden")||(pt.forEach(t=>t.read=!0),zs()))}),tt&&tt.addEventListener("click",e=>{e.stopPropagation(),ae&&(ae.classList.toggle("active"),ae.classList.contains("active")?ae.classList.remove("hidden"):setTimeout(()=>ae.classList.add("hidden"),200))}),Ro&&Ro.addEventListener("click",e=>{e.preventDefault(),J("my-profile-section"),ae&&(ae.classList.remove("active"),ae.classList.add("hidden"))}),document.addEventListener("click",e=>{qe&&!qe.contains(e.target)&&e.target!==fa&&qe.classList.add("hidden"),ae&&!ae.contains(e.target)&&e.target!==tt&&ae.classList.contains("active")&&(ae.classList.remove("active"),setTimeout(()=>ae.classList.add("hidden"),200))}),Qs(ie,async e=>{if(e){if(!pe.isNativePlatform()&&(Or(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");t&&setTimeout(()=>{t.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await zr()&&t&&(t.style.display="none")});const r=()=>{t&&(t.style.display="none")},o=document.getElementById("btn-deny-toast"),s=document.getElementById("btn-close-toast");o&&o.addEventListener("click",r),s&&s.addEventListener("click",r)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let r=null,o=e.displayName,s=null;const i=bt(be,"users",e.uid),n=await _o(i);if(n.exists()){const d=n.data();r=a.role==="employee"?d.permissions||{}:null,o=d.name||o,s=d.professionalId||null}p.userProfessionalId=s,pe.isNativePlatform()&&Xd(e.uid);const l=o||e.email;ir(a.establishmentId,"Carregando...",r),tt&&(tt.textContent=l.charAt(0).toUpperCase()),Mo&&(Mo.textContent=l),Ao&&(Ao.textContent=e.email),qo&&qo.addEventListener("click",d=>{d.preventDefault(),ut&&ut(),Xs(ie).then(()=>window.location.href="/login.html")}),await Qd(a.establishmentId),kr(J,r,p.enabledModules),K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500)),et&&(et.style.display="flex"),setTimeout(()=>{Lr()},1500),J("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(t){console.error("Erro na inicialização:",t),K&&(K.style.display="none"),et&&(et.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><h2>Erro de Acesso</h2><p>${t.message}</p></div>`,et.style.display="flex")}}else window.location.href="/login.html"})}Kd();export{Yo as W};
