const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-DttZawE2.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-vhIfPenq.css"])))=>i.map(i=>d[i]);
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ra}. Verifique se o servidor backend está rodando.`):i}}const Do=(e,t,a,o=null)=>{let s=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(s+=`&professionalId=${o}`),I(s)},Js=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const s=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return I(s)},Gs=e=>I("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Qs=(e,t)=>I(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ra=e=>I(`/api/appointments/${e}`,{method:"DELETE"}),Ys=e=>I(`/api/appointments/${e}/reopen`,{method:"POST"}),Xs=(e,t)=>I(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let G;async function Zs(){if(!G)try{G=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Ks(){if(!G){console.warn("AudioContext não inicializado. O som não será tocado.");return}G.state==="suspended"&&G.resume();const e=G.createOscillator(),t=G.createGain();e.connect(t),t.connect(G.destination),e.type="sine",e.frequency.setValueAtTime(800,G.currentTime),t.gain.setValueAtTime(0,G.currentTime),t.gain.linearRampToValueAtTime(.3,G.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,G.currentTime+.2),e.start(G.currentTime),e.stop(G.currentTime+.2)}function g(e,t,a="info",o=!1){const s=document.getElementById("toast-container");if(!s)return;o&&Ks();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `,ve.querySelector('button[data-action="back-to-menu"]').addEventListener("click",s=>{s.preventDefault(),xs({id:_})});const o=document.getElementById("settings-content-detail");switch(e){case"personal-data":ul(z,o);break;case"change-password":ml(z,o);break;case"change-email":pl(z,o);break;case"branding":gl(z,o);break;case"booking":bl(z,o);break;case"working-hours":fl(z,o);break;case"whatsapp-bot":bs(z,o);break;case"loyalty":await xl(z,o);break;case"financial":await vl(z,o);break;case"support":hl(z,o);break;case"cancellation":yl(z,o);break;default:o.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function xs(e={}){ve.innerHTML=`
