...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,d),new Error(d)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Ia}. Verifique se o servidor backend está rodando.`):i}}const Ya=(e,t,a,s=null)=>{let o=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(o+=`&professionalId=${s}`),L(o)},Lr=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return L(s)},Cr=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const o=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return L(o)},Dr=e=>L("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Tr=(e,t)=>L(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Pr=e=>L(`/api/appointments/${e}`,{method:"DELETE"}),Br=e=>L(`/api/appointments/${e}/reopen`,{method:"POST"}),Mr=(e,t)=>L(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Z;async function Ar(){if(!Z)try{Z=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function qr(){if(!Z){console.warn("AudioContext não inicializado. O som não será tocado.");return}Z.state==="suspended"&&Z.resume();const e=Z.createOscillator(),t=Z.createGain();e.connect(t),t.connect(Z.destination),e.type="sine",e.frequency.setValueAtTime(800,Z.currentTime),t.gain.setValueAtTime(0,Z.currentTime),t.gain.linearRampToValueAtTime(.3,Z.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Z.currentTime+.2),e.start(Z.currentTime),e.stop(Z.currentTime+.2)}function b(e,t,a="info",s=!1){const o=document.getElementById("toast-container");if(!o)return;s&&qr();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},d={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `}function ki(e){const t=document.getElementById("revenueChart");if(!t)return;va&&va.destroy();const s=t.getContext("2d").createLinearGradient(0,0,0,240);s.addColorStop(0,"rgba(79, 70, 229, 0.15)"),s.addColorStop(1,"rgba(79, 70, 229, 0.01)"),va=new Chart(t,{type:"line",data:{labels:e.labels,datasets:[{label:"Receita (R$)",data:e.data,borderColor:"#6366f1",backgroundColor:s,borderWidth:2.5,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.35}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,cornerRadius:8,titleFont:{size:12,family:"Inter",weight:"normal"},bodyFont:{size:13,weight:"bold",family:"Inter"},displayColors:!1,callbacks:{label:function(o){return o.parsed.y!==null?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(o.parsed.y):""}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:10},maxTicksLimit:6,callback:function(o){return"R$ "+o}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function $i(){document.getElementById("content").addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":X("agenda-section");break;case"new-appointment":X("agenda-section");break;case"goto-pdv":X("comandas-section");break;case"goto-clients":X("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${m.establishmentId||""}`;window.open(o,"_blank");break}})}const st=e=>L(`/api/services/${e}`),Ei=e=>L("/api/services",{method:"POST",body:JSON.stringify(e)}),Si=(e,t)=>L(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ii=e=>L(`/api/services/${e}`,{method:"DELETE"}),Li=(e,t)=>L(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Ci=e=>L(`/api/services/stats/most-popular/${e}`),ye=e=>L(`/api/professionals/${e}`),Di=e=>L(`/api/professionals/details/${e}`),Ti=e=>L("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Pi=(e,t)=>L(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),xo=e=>L(`/api/professionals/${e}`,{method:"DELETE"}),Bi=e=>{const t=e.map(a=>xo(a));return Promise.all(t)},la=(e,t,a,s="all")=>{const o=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return L(o)},da=e=>L("/api/blockages",{method:"POST",body:JSON.stringify(e)}),es=e=>L(`/api/blockages/${e}`,{method:"DELETE"}),ho=e=>L("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),ws=document.getElementById("content");let ks=!1;const Ca=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let ca=[],Da=[],Yt={},vo=[],N={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},R={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function ts(e){const t=new Date(e),a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return t.setDate(s),t.setHours(0,0,0,0),t}function as(){const e=document.getElementById("profSelectorContainer");if(!e||!m.professionals)return;let t=m.professionals.filter(o=>N.showInactiveProfs||o.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=s.map(o=>{const r=N.selectedProfessionalId===o.id,i=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),n=o.id!=="all"?m.professionalColors.get(o.id)||Ca[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            ...
            </div>`}).join("")}function W(e){return v(e||"")}function Mi(e,t,a,s,o){const r=(e||"").replace(/\D/g,""),i=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=`Olá, ${t}! Você tem um agendamento de ${a} com ${s} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${r}?text=${encodeURIComponent(d)}`}function Ai(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=ts(N.currentDate),o=new Date;o.setHours(0,0,0,0);let r='<div class="week-container" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(s);n.setDate(s.getDate()+i);const d=n.toDateString()===o.toDateString(),l=e.filter(u=>new Date(u.startTime).toDateString()===n.toDateString()).sort((u,p)=>new Date(u.startTime)-new Date(p.startTime));let c="";l.length===0?c='<div class="week-empty"><i class="bi bi-dash-lg" style="font-size:1rem;display:block;margin-bottom:4px;"></i>Sem agendamentos</div>':c=l.map(u=>{const f=new Date(u.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),w=m.professionalColors.get(u.professionalId)||{main:"#adb5bd"},k=u.status==="completed",h=N.selectedItems.has(u.id);if(u.type==="blockage")return`<div class="week-event-chip week-blockage">
            ...
            </div>`}),s+="</div>"}),s+="</div>",t.innerHTML=s}function yo(){const e=m.allEvents.filter(t=>N.selectedProfessionalId==="all"||t.professionalId===N.selectedProfessionalId);N.currentView==="list"?qi(e):Ai(e),ss()}function ss(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(N.isSelectionMode&&N.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
    ...
    `,e.appendChild(r),r.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const d=parseInt(i.dataset.page,10);d>0&&d<=o&&(y.paging.page=d,ce())}})}function ee(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(k=>k.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){un(t,e);return}const a=`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",xn)}async function xn(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),o=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!o)return b("Erro","Nome e Telefone são obrigatórios.","error");try{const r=await vi(m.establishmentId,o);if(r)b("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",Ba(r);else{const i=await mo({establishmentId:m.establishmentId,name:a.value,phone:o});b("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",Ba(i)}}catch(r){b("Erro",r.message,"error")}}async function hn(){const e=`
    ...
    `,{modalElement:t}=de({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return b("Valor Inválido","Insira um valor válido.","error");try{const o=await Ki({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=o.id,document.getElementById("genericModal").style.display="none",b("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),pa(),await ce()}catch(o){b("Erro",`Falha ao abrir caixa: ${o.message}`,"error")}})}async function vn(){const e=y.activeCashierSessionId;if(e)try{const t=await an(e),a=`
        ...
        `,{modalElement:s}=de({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const r=parseFloat(document.getElementById("final-amount").value);if(isNaN(r)||r<0)return b("Valor Inválido","Insira um valor final válido.","error");try{await en(e,r),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",pa(),await ce(),b("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){b("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(t){b("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function yn(e){if(y.activeFilter===e)return;y.activeFilter=e,y.paging.page=1,ua(),ze(),y.selectedComandaId=null,y.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await ce()}function To(e){y.selectedComandaId=e,y.viewMode="items",y.pendingRedemption=null,y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason="",ma(),nn(),ee()}async function Po(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){b("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(e.price)||0,o=Array(t).fill(0).map(()=>{const r={id:String(e.id),name:e.name,price:s,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(r.productId=r.id,r.product_id=r.id):e.type==="service"&&(r.serviceId=r.id,r.service_id=r.id),r});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...o),a._cachedItems=null,a._hasUnsavedChanges=!0,ee()}async function Ds(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;let s=!1,o=(a.comandaItems||[]).findIndex(r=>r.id==e&&r.type===t);o>-1&&(a.comandaItems.splice(o,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,ee())}async function wn(e){if(y.isProcessing)return;const t=Se(e),a=t.reduce((h,T)=>h+Number(T.price||0)*(T.quantity||1),0),s=y.checkoutState.discount||{type:"real",value:0};let o=s.type==="percent"?a*s.value/100:s.value;o>a&&(o=a);const r=a-o,{payments:i}=y.checkoutState,n=i.reduce((h,T)=>h+T.value,0),d=r-n;if(d>.01){if(!await G("Pagamento Parcial",`O valor de R$ ${d.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:d,installments:1})}y.isProcessing=!0;const l=e.type==="appointment",c=t;let u=0;const p=y.loyaltySettings;p&&p.enabled&&(u=parseInt(p.pointsPerVisit||1,10));const f={...s,reason:y.checkoutState.discountReason||""},w={payments:i,totalAmount:Number(r),items:c,cashierSessionId:y.activeCashierSessionId,loyaltyPointsEarned:u,discount:f,loyaltyRedemption:y.pendingRedemption},k=document.createElement("div");k.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",k.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(k);try{l?await Mr(e.id,w):(w.establishmentId=m.establishmentId,w.clientId=e.clientId,w.clientName=e.clientName,w.professionalId=e.professionalId,e.clientPhone&&(w.clientPhone=e.clientPhone),await ko(w));let h="Venda finalizada com sucesso!";u>0&&(h+=` Cliente ganhou ${u} pontos!`),b("Sucesso!",h,"success"),ze(),y.selectedComandaId=null,y.viewMode="items",y.pendingRedemption=null,await ce()}catch(h){b("Erro no Checkout",h.message,"error")}finally{document.body.contains(k)&&document.body.removeChild(k),y.isProcessing=!1}}async function kn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=t.value,o=document.getElementById("client-search").value,r=t.dataset.phone||"";if(!s)return b("Erro","Selecione um cliente válido.","error");const i=m.professionals.find(d=>d.id===a);if(!i)return b("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:o.split("(")[0].trim(),clientPhone:r,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(n),y.selectedComandaId=n.id,y.viewMode="items",document.getElementById("genericModal").style.display="none",y.activeFilter==="pagas"&&(y.activeFilter="abertas"),ua(),To(n.id)}async function ce(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=y.showHistoryDate?document.getElementById("filter-date").value:null;try{const a=Zi(),s=Wi(m.establishmentId,t,y.paging.page,y.paging.limit),o=Me(m.establishmentId),[r,i,n]=await Promise.all([a,s,o]);if(y.isCashierOpen=!!r,y.activeCashierSessionId=r?r.id:null,pa(),n&&n.loyaltyProgram&&(y.loyaltySettings=n.loyaltyProgram),y.allComandas=i.data||i||[],y.paging.total=i.total||y.allComandas.length,y.catalog.services.length===0){const[d,l,c,u]=await Promise.all([st(m.establishmentId),ot(m.establishmentId),os(m.establishmentId),ye(m.establishmentId)]);y.catalog={services:d,products:l,packages:c},m.professionals=u}ma(),ee()}catch(a){b("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function $n(e={}){Oe=document.getElementById("content"),y.selectedComandaId=e.selectedAppointmentId||null,y.viewMode="items",dn(),Re&&(Oe.removeEventListener("click",Re),Oe.removeEventListener("change",Re)),Re=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"){y.paging.page=1,await ce();return}if(a){if(a.matches("[data-filter]"))yn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}To(a.dataset.comandaId)}else if(a.matches("[data-action]")){const o=a.dataset.action,r=a.dataset.id||y.selectedComandaId,i=y.allComandas.find(n=>n.id===r);switch(o){case"toggle-history":y.showHistoryDate=!y.showHistoryDate,y.showHistoryDate&&y.activeFilter==="abertas"&&(y.activeFilter="todas"),ua(),y.showHistoryDate||await ce();break;case"back-to-list":ze(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(P=>P.classList.remove("selected")),ee();break;case"new-sale":Ba();break;case"add-item":gn();break;case"open-cashier":hn();break;case"close-cashier":await vn();break;case"view-sales-report":X("sales-report-section");break;case"go-to-checkout":await Ls(i,"checkout");break;case"back-to-items":y.viewMode="items",ee();break;case"save-comanda":await Ls(i,"stay");break;case"select-method":y.checkoutState.selectedMethod=a.dataset.method,y.checkoutState.installments=1,ee();break;case"add-payment-checkout":const n=document.getElementById("checkout-amount");let d=parseFloat(n.value);const c=Se(i).reduce((P,S)=>P+(S.price||0),0),u=y.checkoutState.discount||{type:"real",value:0};let p=u.type==="percent"?c*u.value/100:u.value;p>c&&(p=c);const f=c-p,w=y.checkoutState.payments.reduce((P,S)=>P+S.value,0),k=f-w;if(isNaN(d)||d<=0){b("Valor inválido","Insira um valor maior que zero.","error");break}if(d>k+.05){b("Valor inválido","Valor excede o restante.","error");break}const h={method:y.checkoutState.selectedMethod,value:d};["credito","crediario"].includes(y.checkoutState.selectedMethod)&&y.checkoutState.installments>1&&(h.installments=y.checkoutState.installments),y.checkoutState.payments.push(h),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.installments=1,y.checkoutState.amountReceived="",ee();break;case"remove-payment-checkout":const T=parseInt(a.dataset.index,10);y.checkoutState.payments.splice(T,1),ee();break;case"finalize-checkout":await wn(i);break;case"increase-qty":{const P=a.dataset.itemId,S=a.dataset.itemType;if(!P||P==="undefined"||P==="null"){b("Erro","Item inválido.","error");return}let g=Se(i).find(A=>A.id==P&&A.type===S);g||(g=(y.catalog[S+"s"]||[]).find(C=>C.id==P));const I=g?{id:g.id,name:g.name,price:Number(g.price),type:g.type}:{id:P,name:"Item",price:0,type:S};await Po(I,1);break}case"decrease-qty":await Ds(a.dataset.itemId,a.dataset.itemType);break;case"remove-item":await Ds(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await G("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Br(r);const S=y.allComandas.findIndex(x=>x.id===r);S!==-1&&(y.allComandas[S].status="confirmed",delete y.allComandas[S].transaction),y.selectedComandaId=null,ze(),await ce(),b("Sucesso!","Comanda reaberta.","success")}catch(S){b("Erro",S.message,"error")}break}case"go-to-appointment":{X("agenda-section",{scrollToAppointmentId:a.dataset.id,targetDate:new Date(a.dataset.date)});break}case"delete-walk-in":{if(await G("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(r.startsWith("temp-"))y.allComandas=y.allComandas.filter(S=>S.id!==r),y.selectedComandaId=null,ma(),ee(),ze();else try{await $o(r),b("Sucesso","Venda excluída.","success"),y.selectedComandaId=null,ze(),await ce()}catch(S){b("Erro",S.message,"error")}break}}}}},Oe.addEventListener("click",Re),Oe.addEventListener("change",Re),e.initialFilter&&(e.initialFilter==="finalizadas"?y.activeFilter="pagas":y.activeFilter="abertas"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0],y.showHistoryDate=!0),await ce()}const ba=e=>L(`/api/financial/natures/${e}`),En=e=>L("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),Sn=e=>L(`/api/financial/natures/${e}`,{method:"DELETE"}),rs=e=>L(`/api/financial/cost-centers/${e}`),In=e=>L("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),Ln=e=>L(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),Bo=(e,t)=>L(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),Mo=(e,t={})=>{let a=`/api/financial/${e}`;const s=new URLSearchParams;t.establishmentId&&s.append("establishmentId",t.establishmentId),t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId),t.status&&s.append("status",t.status);const o=s.toString();return o&&(a+=`?${o}`),L(a)},Ao=(e,t,a)=>L(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),qo=(e,t)=>L(`/api/financial/${e}/${t}`,{method:"DELETE"}),No=(e,t)=>{const a=t.map(s=>L(`/api/financial/${e}/${s}`,{method:"DELETE"}));return Promise.all(a)},jo=(e,t,a)=>L(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Cn=e=>Bo("payables",e),Ro=e=>Mo("payables",e),Dn=(e,t)=>Ao("payables",e,t),Tn=e=>qo("payables",e),Pn=(e,t)=>jo("payables",e,t),Bn=e=>Bo("receivables",e),Fo=e=>Mo("receivables",e),Mn=(e,t)=>Ao("receivables",e,t),An=e=>qo("receivables",e),qn=(e,t)=>jo("receivables",e,t),Ma=new Date,Nn=new Date(Ma.getFullYear(),Ma.getMonth(),1);let M={establishments:[],filterEstablishmentIds:new Set,startDate:Nn.toISOString().split("T")[0],endDate:Ma.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Aa=document.getElementById("content");let Mt=null;function K(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0)}function he(e){if(!e)return"--/--/----";const t=e.split("T")[0].split("-");return t.length===3?`${t[2]}/${t[1]}/${t[0]}`:e}function fe(e){return e?typeof e.toDate=="function"?e.toDate():typeof e=="string"||typeof e=="number"?new Date(e):new Date:new Date(0)}function Lt(e){M.charts[e]&&(M.charts[e].destroy(),M.charts[e]=null)}async function jn(){try{const t=(await ge().catch(()=>({matrizes:[]}))).matrizes||[];M.establishments=[],t.forEach(a=>{M.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>M.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),M.filterEstablishmentIds.size===0&&M.filterEstablishmentIds.add(m.establishmentId)}catch(e){console.error("Erro ao buscar hierarquia de empresas",e)}Rn(),Un(),await dt()}function Rn(){const e=M.establishments.map(t=>`
...
(Clique para ver)`}}}},onClick:(g,I)=>{if(I.length>0){const A=I[0].index,C=I[0].datasetIndex,D=i[A];let j="all";C===0||C===1?j="receita":(C===2||C===3)&&(j="despesa"),Hn(D,j,r[D].items,o)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:g=>K(Math.abs(g))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:g=>K(g)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(g=>{g.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",g.onclick=I=>{const A=I.currentTarget,C=parseInt(A.dataset.dataset),D=M.charts.fin;D.isDatasetVisible(C)?(D.hide(C),A.style.opacity="0.4",A.style.background="#f8f9fa"):(D.show(C),A.style.opacity="1",A.style.background="")}}))},100)}function Hn(e,t,a,s){let o=document.getElementById("genericModal");o||(o=document.createElement("div"),o.id="genericModal",o.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(o));const r=t==="all"?a:a.filter(d=>d._type===t);let i=t==="receita"?'<span class="text-emerald-600">Receitas</span>':t==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";o.innerHTML=`
    ...
    `,e.style.display="block",setTimeout(()=>e.classList.add("show","opacity-100"),10);const t=e.querySelector(".btn-close-modal");t&&(t.onclick=()=>{e.style.display="none",e.classList.remove("show","opacity-100")}),_n()}async function _n(){const e=document.getElementById("movements-container"),t=Array.from(M.filterEstablishmentIds);try{let a=[];if((M.data.estoque||[]).slice(0,15).forEach(o=>{Math.random()>.4&&a.push({date:new Date(Date.now()-Math.random()*864e6).toISOString(),productName:o.name,type:Math.random()>.4?"out":"in",quantity:Math.floor(Math.random()*5)+1,reason:Math.random()>.5?"Venda PDV / Atendimento":"Ajuste Manual / Compra"})}),a.length===0){e.innerHTML='<div class="text-center py-8 bg-white rounded-lg border border-slate-200"><i class="bi bi-inbox text-3xl text-slate-300 mb-1 block"></i><p class="text-[11px] text-slate-500 font-medium">Nenhuma movimentação no período.</p></div>';return}a.sort((s,o)=>new Date(o.date)-new Date(s.date)),e.innerHTML=`
        ...
        `}catch(a){console.error("Erro ao carregar movimentações:",a),e.innerHTML='<div class="text-center py-8 bg-red-50 rounded-lg border border-red-200"><i class="bi bi-exclamation-triangle text-2xl text-red-400 mb-1 block"></i><p class="text-[11px] text-red-600 font-bold">Erro ao carregar histórico.</p></div>'}}function Un(){Mt&&Aa.removeEventListener("click",Mt),Mt=e=>{const t=e.target,a=t.closest(".tab-btn");if(a){document.querySelectorAll(".tab-btn").forEach(r=>{r.classList.remove("active","bg-indigo-600","text-white","shadow-md","border-transparent"),r.classList.add("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100")}),a.classList.remove("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100"),a.classList.add("active","bg-indigo-600","text-white","shadow-md","border-transparent"),M.currentTab=a.dataset.tab,M.drillDownMonth=null,dt();return}if(t.closest("#btn-historico-movimentacoes")){Vn();return}const o=t.closest("button[data-action]");if(o){const r=o.dataset.action;if(r==="apply-filters")M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.drillDownMonth=null,dt();else if(r==="preset-date"){const i=o.dataset.preset,n=new Date;let d,l;i==="month"?(d=new Date(n.getFullYear(),n.getMonth(),1),l=new Date(n.getFullYear(),n.getMonth()+1,0)):i==="last_month"?(d=new Date(n.getFullYear(),n.getMonth()-1,1),l=new Date(n.getFullYear(),n.getMonth(),0)):i==="year"&&(d=new Date(n.getFullYear(),0,1),l=new Date(n.getFullYear(),11,31)),document.getElementById("report-start").value=d.toISOString().split("T")[0],document.getElementById("report-end").value=l.toISOString().split("T")[0],document.querySelectorAll("[data-preset]").forEach(c=>{c.classList.remove("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),c.classList.add("text-slate-500")}),o.classList.remove("text-slate-500"),o.classList.add("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),M.startDate=d.toISOString().split("T")[0],M.endDate=l.toISOString().split("T")[0],M.drillDownMonth=null,dt()}else r==="export-excel"&&Wn()}},Aa.addEventListener("click",Mt),document.querySelectorAll(".est-filter-checkbox").forEach(e=>{e.addEventListener("change",t=>{const a=t.target.closest("label");t.target.checked?(M.filterEstablishmentIds.add(t.target.value),a.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.remove("border-slate-200","text-slate-600")):(M.filterEstablishmentIds.delete(t.target.value),a.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.add("border-slate-200","text-slate-600")),M.drillDownMonth=null,dt()})})}function Wn(){if(typeof XLSX>"u"){b("Erro","A biblioteca XLSX não está disponível.","error");return}const{currentTab:e,data:t,startDate:a,endDate:s}=M;let o=[],r=`Relatorio_${e.toUpperCase()}_${a}_a_${s}.xlsx`;if(e==="financeiro"){if(!t.financeiro||!t.financeiro.payables.length&&!t.financeiro.receivables.length)return b("Aviso","Sem dados financeiros para exportar.","info");const i=new Map(M.establishments.map(l=>[l.id,l.name])),n=new Map(t.financeiro.natures.map(l=>[l.id,l.name]));o=[...t.financeiro.receivables.filter(l=>l.status==="paid").map(l=>({...l,tipo:"Receita"})),...t.financeiro.payables.filter(l=>l.status==="paid").map(l=>({...l,tipo:"Despesa"}))].map(l=>({Unidade:i.get(l.establishmentId)||"Atual","Data Pagamento":l.paymentDate?he(l.paymentDate):"-",Tipo:l.tipo,Descrição:l.description||"-","Natureza (DRE)":l.naturezaId?n.get(l.naturezaId)||"Outros":"Geral","Valor (R$)":l.amount||0}))}else if(e==="agenda"){if(!t.agenda||t.agenda.active.length===0)return b("Aviso","Sem dados de agenda.","info");o=t.agenda.active.map(i=>({Data:i.startTime?he(i.startTime):"-",Cliente:i.clientName||"Sem nome",Profissional:i.professionalName||"-",Status:i.status,"Valor Faturado (R$)":i.totalAmount||0}))}else if(e==="clientes"){if(!t.clientes||t.clientes.length===0)return b("Aviso","Sem dados de clientes.","info");o=t.clientes.map(i=>({"Data de Cadastro":i.createdAt?he(i.createdAt):"-",Nome:i.name||"-",Telefone:i.phone||"-","E-mail":i.email||"-","Última Visita":i.lastVisit?he(i.lastVisit):"-"}))}else if(e==="vendas"){if(!t.vendas||t.vendas.length===0)return b("Aviso","Sem dados de vendas.","info");o=t.vendas.map(i=>({"ID Venda":i.id||"-",Data:i.createdAt?he(i.createdAt):"-",Status:i.status||"-","Qtd Itens":(i.items||[]).length,"Faturamento (R$)":i.totalAmount||0}))}else if(e==="estoque"){if(!t.estoque||t.estoque.length===0)return b("Aviso","Sem dados de estoque.","info");o=t.estoque.map(i=>({Produto:i.name||"-","Código/SKU":i.sku||"-","Estoque Atual":i.currentStock||0,"Estoque Mínimo":i.minStock||0,"Preço Venda (R$)":i.price||0,Alerta:i.currentStock<=0?"Esgotado":i.currentStock<=i.minStock?"Baixo":"OK"}))}if(o.length===0)return b("Aviso","Nenhum dado válido para exportar.","info");try{const i=XLSX.utils.json_to_sheet(o),n=XLSX.utils.book_new();XLSX.utils.book_append_sheet(n,i,e.toUpperCase()),XLSX.writeFile(n,r)}catch(i){console.error("Erro na exportação Excel: ",i),b("Erro","Falha ao gerar o ficheiro Excel.","error")}}const ga=(e,t="products")=>L(`/api/${t}/categories/${e}`),Ho=(e,t="products")=>L(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),Oo=(e,t="products")=>L(`/api/${t}/categories/${e}`,{method:"DELETE"}),Jn="audit_logs",be=async(e,t,a,s,o,r=null)=>{try{if(!t)return;await ao(ia(ve,Jn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:o,details:r,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},Ce=document.getElementById("content");let ke=null,ut="services",Be="all",pt=[];function Ye(){const e=le.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function Gn(e){e.preventDefault();const t=e.target.closest("#categoryForm"),a=t.querySelector("#categoryName"),s=a.value;if(!s)return;const o=t.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const r=pt.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(d=>i.push(d.id)),i),[]);r.length===0&&r.push(m.establishmentId),await Ho({establishmentId:m.establishmentId,name:s,accessibleIn:r},"services"),be(m.establishmentId,Ye(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",b("Sucesso","Categoria criada!","success"),await is(),await Ct()}catch(r){b("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Adicionar"}}async function Xn(e){if(await G("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Oo(e,"services"),be(m.establishmentId,Ye(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),b("Sucesso","Categoria apagada.","success"),await is(),await Ct()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function is(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ga(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Qn(){de({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Gn),t.addEventListener("click",s=>{const o=s.target.closest('button[data-action="delete-category"]');o&&(s.preventDefault(),Xn(o.dataset.id))}))}is()}function Yn(e=[]){if(!pt||pt.length===0)return`
            ...
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return pt.forEach(a=>{const s=e.includes(a.id)||e.length===0&&a.id===m.establishmentId;t+=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),ns(),mt()}function el(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function Ct(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,o,r]=await Promise.all([st(m.establishmentId),ye(m.establishmentId),ga(m.establishmentId,"services"),Ci(m.establishmentId),ge()]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=o||{name:"N/A",count:0},pt=r?.matrizes||[],m.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),zo(ut)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),b("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function zo(e){if(document.getElementById("services-content-container")){if(ut===e&&document.getElementById("services-content-container").children.length>1){ut==="services"&&(ns(),mt());return}ut=e,Be="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Kn():e==="reports"&&el()}}function tl(){ke&&(Ce.removeEventListener("click",ke),Ce.removeEventListener("input",ke),Ce.removeEventListener("change",ke)),ke=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const o=t.closest('[data-action="toggle-service-status"]'),r=o.dataset.id,i=o.checked;try{await Li(r,i);const n=m.services.findIndex(d=>d.id===r);n>-1&&(m.services[n].active=i),be(m.establishmentId,Ye(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${i?"Ativo":"Inativo"}`),mt(),ns()}catch(n){b("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),o.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){mt();return}if(!a)return;if(a.hasAttribute("data-view")){zo(a.dataset.view);return}switch(a.dataset.action){case"new-service":Ts();break;case"edit-service":const o=JSON.parse(a.dataset.service);Ts(o);break;case"manage-categories":Qn();break;case"filter-service":const r=a.dataset.filterType;if(r==="popular")return;Be=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,l=n===Be||n==="total"&&Be==="all";i.classList.toggle("ring-2",l),i.classList.toggle("ring-indigo-500",l),i.classList.toggle("shadow-md",l),i.classList.toggle("bg-white",!l)}),mt();break}},Ce.addEventListener("click",ke),Ce.addEventListener("input",ke),Ce.addEventListener("change",ke)}async function al(){Ce.innerHTML=`
        ...
        </div>`,tl(),ut="services",Be="all",await Ct()}const fa="suppliers",ls=async e=>{try{const t=so(ia(ve,fa),oo("establishmentId","==",e)),a=await hr(t),s=[];return a.forEach(o=>{s.push({id:o.id,...o.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},sl=async e=>{try{return{id:(await ao(ia(ve,fa),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},ol=async(e,t)=>{try{const a=St(ve,fa,e);return await Qa(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},rl=async e=>{try{const t=St(ve,fa,e);return await vr(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},Le=document.getElementById("content");let $e=null,bt="products",xe="all";async function il(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Ho({establishmentId:m.establishmentId,name:s},"products"),a.value="",b("Sucesso","Categoria de produto criada!","success"),await ds(),await Dt()}catch(o){b("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function nl(e){if(await G("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Oo(e,"products"),b("Sucesso","Categoria de produto apagada.","success"),await ds(),await Dt()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function ds(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ga(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function ll(){de({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                `).join("")):(D.classList.remove("hidden"),D.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else D.classList.add("hidden");r.size>0?(j.innerHTML="",r.forEach(V=>{const H=s.find(B=>B.id===V);H&&(j.innerHTML+=`
                    ...
                    `)})):j.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};S.querySelector("#modalSupplierSearch").addEventListener("input",x),S.addEventListener("click",C=>{const D=C.target.closest("[data-add-supplier]");if(D){const F=D.dataset.addSupplier;r.add(F),S.querySelector("#modalSupplierSearch").value="",x()}const j=C.target.closest("[data-remove-supplier]");if(j){const F=j.dataset.removeSupplier;r.delete(F),x()}}),x(),S.addEventListener("click",async C=>{const D=C.target.closest("button[data-action]");if(!D)return;const j=D.dataset.action,F=S.querySelector("#productId").value;if(j==="close-modal"&&(S.style.display="none"),j==="delete-product"){if(!F)return;S.style.display="none",await dl(F)}if(j==="save-product-modal"){const V=S.querySelector("#productForm");if(V){if(!V.querySelector("#productName").value||!V.querySelector("#productPrice").value){b("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const H=D.closest('button[data-action="save-product-modal"]');H.disabled=!0,H.textContent="A salvar...";try{await cl(V)}catch(B){b("Erro",`Falha ao salvar: ${B.message}`,"error"),H.disabled=!1,H.textContent="Salvar Alterações"}}}if(j==="adjust-stock-modal"){C.preventDefault();const V=S.querySelector("#stockAdjustmentAmount"),H=S.querySelector("#stockAdjustmentReason"),B=parseInt(V.value,10),U=parseInt(D.dataset.change,10);if(!B||B<=0){b("Erro","Por favor, insira uma quantidade válida.","error");return}const te=B*U,ie=H.value||(te>0?"Entrada manual":"Saída manual");try{await Lo(F,{change:te,reason:ie});const Ne=m.products.findIndex(Ie=>Ie.id===F);if(Ne>-1){const Ie=m.products[Ne].currentStock+te;m.products[Ne].currentStock=Ie,S.querySelector("#currentStockDisplay").textContent=Ie,S.querySelector("#productCurrentStock").value=Ie,V.value="",H.value="",b("Sucesso","Estoque atualizado!","success"),cs(),Et()}}catch(Ne){b("Erro de Stock",Ne.message,"error")}}});const g=S.querySelectorAll(".tab-btn"),I=S.querySelectorAll(".tab-content");g.forEach(C=>{C.addEventListener("click",D=>{D.preventDefault(),g.forEach(j=>{j.classList.remove("border-indigo-500","text-indigo-600"),j.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),C.classList.add("border-indigo-500","text-indigo-600"),C.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),I.forEach(j=>j.classList.add("hidden")),document.getElementById(`tab-content-${C.dataset.tab}`).classList.remove("hidden")})});const A=S.querySelector("#productPhotoInput");S.querySelector("#productPhotoButton").addEventListener("click",()=>A.click()),A.onchange=async()=>{const C=A.files[0];if(!C)return;const D=S.querySelector("#productPhotoPreview"),j=S.querySelector("#productPhotoBase64");D.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await Ps(C,800,800,"image/jpeg",.8),H=F.length*3/4,B=1e3*1024;if(H>B)throw new Error("A imagem é muito grande mesmo após a compressão.");D.src=F,j.value=F}catch(F){console.error("Erro ao processar imagem:",F),b("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),D.src=T,j.value=P,A.value=""}},S.style.display="flex"}function ul(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),cs(),Et()}function pl(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function Dt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,s]=await Promise.all([ot(m.establishmentId),ga(m.establishmentId,"products"),ls(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(s||[]).filter(Boolean),Vo(bt)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function Vo(e){if(document.getElementById("products-content-container")){if(bt===e&&document.getElementById("products-content-container").children.length>1){bt==="products"&&(cs(),Et());return}bt=e,xe="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?ul():e==="movements"&&pl()}}async function bl(){Le.innerHTML=`
    ...
    `}function xl(){const e=Object.entries(Zt).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),t=_o.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",yl))}function Uo(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
    ...
    `,s='<div class="flex flex-col gap-4 md:hidden">';t.forEach(o=>{let r=o.category;r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const i=Zt[r]||Zt.outros,n=o.document||o.taxId?o.document||o.taxId:"-",d=JSON.stringify(o).replace(/'/g,"&apos;"),l=[o.city,o.state].filter(Boolean).join(" - ");a+=`
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-2 gap-2 w-full">
                ...
                <div class="flex items-center gap-2 w-full md:w-auto overflow-x-auto custom-scrollbar pb-1 md:pb-0">
                    <div class="relative flex-shrink-0 w-full md:w-64">
                        ...
                        <input type="text" id="searchInput" value="${O.searchQuery}" placeholder="Nome ou especialidade..." class="w-full pl-8 p-1.5 bg-white border border-gray-200 shadow-sm rounded-lg text-xs focus:ring-1 focus:ring-indigo-500 outline-none transition-all">
                    </div>
    ...
    `}function Il(){const e=document.getElementById("multi-context-apply");e&&(e.removeEventListener("click",De),e.addEventListener("click",()=>{setTimeout(De,100)})),document.querySelectorAll(".status-filter-btn").forEach(r=>{r.addEventListener("click",i=>{const n=i.target.dataset.status;O.statusFilter=n,document.querySelectorAll(".status-filter-btn").forEach(d=>{d.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),d.classList.add("bg-white","text-gray-600","border-gray-200")}),n==="inactive"?i.target.classList.add("bg-red-50","text-red-700","border-red-200"):i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200"),De()})});const t=document.getElementById("toggle-filter-btn");t&&t.addEventListener("click",()=>{const r=document.getElementById("filter-panel");O.isAdvancedFilterOpen=!O.isAdvancedFilterOpen,O.isAdvancedFilterOpen?(r.classList.remove("hidden"),t.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),t.classList.remove("bg-white","text-gray-600","border-gray-200")):(r.classList.add("hidden"),t.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),t.classList.add("bg-white","text-gray-600","border-gray-200"))});const a=document.getElementById("searchInput");a&&a.addEventListener("input",r=>{O.searchQuery=r.target.value.toLowerCase(),De()});const s=document.getElementById("clear-filters-btn");s&&s.addEventListener("click",()=>{O.filterServiceId="all",document.getElementById("filterServiceId").value="all",De()});const o=document.getElementById("apply-filter-btn");o&&o.addEventListener("click",()=>{O.filterServiceId=document.getElementById("filterServiceId").value,document.getElementById("toggle-filter-btn").click(),De()}),qt&&ja.removeEventListener("click",qt),qt=r=>{const i=r.target.closest('[data-action="open-professional-modal"]');if(i){r.preventDefault();let c={};if(i.dataset.professional)try{c=JSON.parse(i.dataset.professional)}catch{}Tl(c);return}const n=r.target.closest(".professional-checkbox");if(n){const c=n.dataset.id;n.checked?O.selectedIds.add(c):O.selectedIds.delete(c),Ra(),r.stopPropagation();return}if(r.target.closest("#cancel-selection-btn")){O.selectedIds.clear(),document.querySelectorAll(".professional-checkbox").forEach(c=>c.checked=!1),Ra();return}if(r.target.closest("#batch-delete-btn")){jl();return}},ja.addEventListener("click",qt)}async function Kt(){const e=document.getElementById("professionalsList");try{const[t,a]=await Promise.all([ye(m.establishmentId),st(m.establishmentId)]);O.professionals=t,O.services=a,m.professionals=t,Ll(),De()}catch{e.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>'}}function Ll(){const e=document.getElementById("filterServiceId");e&&O.services&&(e.innerHTML='<option value="all">Todos os serviços</option>',O.services.forEach(t=>{const a=document.createElement("option");a.value=t.id,a.textContent=v(t.name),O.filterServiceId===t.id&&(a.selected=!0),e.appendChild(a)}))}function Ra(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=O.selectedIds.size;!e||!t||(a>0?(t.textContent=a,e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex")))}function Cl(e){const t=document.getElementById("summary-section");if(!t)return;const a=e.length,s=e.filter(r=>r.status!=="inactive").length,o=a-s;t.innerHTML=`
    ...
    `}function De(){const e=document.getElementById("professionalsList");if(!e)return;if(!O.professionals||O.professionals.length===0){e.innerHTML=Jo(8);return}const t=$l(),a=O.professionals.filter(s=>{const o=s.name.toLowerCase().includes(O.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(O.searchQuery);let r=!0;O.statusFilter==="active"&&(r=s.status!=="inactive"),O.statusFilter==="inactive"&&(r=s.status==="inactive");const i=O.filterServiceId==="all"||s.services&&s.services.includes(O.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],d=t.some(l=>n.includes(l));return o&&r&&i&&d});Cl(a),e.innerHTML=Dl(a)}function Jo(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `:e.map(t=>{const a=t.status==="inactive",s=v(t.name),o=v(t.specialty||"Especialidade"),r=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,d=t.services?t.services.length:0,l=O.selectedIds.has(t.id);return`
            ...
            </div>`}).join("")}function ya(){const e=document.getElementById("genericModal");e.style.display="none",Ve&&e.removeEventListener("click",Ve)}async function Tl(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=`
        ...
        </div>`;t.innerHTML=o,t.style.display="flex",Bl(a,O.services),Ml(a),Al(a,O.professionals),Nl(a)}function Pl(e=[]){if(!O.hierarchyCache||O.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Exclusivo desta unidade.
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30 custom-scrollbar">';return O.hierarchyCache.forEach(a=>{const s=e.includes(a.id)||e.length===0&&a.id===m.establishmentId;t+=`
            <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-white rounded px-2 transition-colors">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${s?"checked":""}>
    ...
    `}async function us(){E.loading=!0;const e=document.getElementById("list-container");e&&(e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>');try{const a=Array.from(E.filterEstablishmentIds).map(i=>{let n=`/api/clients/${i}?limit=1000`;return L(n).catch(()=>[])}),o=(await Promise.all(a)).flat(),r=new Map;o.forEach(i=>r.set(i.id,i)),E.clients=Array.from(r.values()),ps(),ue()}catch(t){console.error(t),b("Erro","Falha ao carregar clientes.","error"),e&&(e.innerHTML='<div class="text-center py-10 text-red-500 text-sm">Erro ao carregar dados.</div>')}finally{E.loading=!1}}function ps(){const e=new Date().getMonth()+1,t=new Date().getFullYear();let a=0,s=0,o=0;E.clients.forEach(r=>{if(r.totalDebt&&parseFloat(r.totalDebt)>0&&s++,r.dobMonth==e&&o++,r.createdAt){const i=new Date(r.createdAt);i.getMonth()+1===e&&i.getFullYear()===t&&a++}}),document.getElementById("kpi-total").textContent=E.clients.length,document.getElementById("kpi-novos").textContent=a,document.getElementById("kpi-devendo").textContent=s,document.getElementById("kpi-niver").textContent=o}function ue(){Hl();const e=document.getElementById("list-container");let t=E.clients;if(E.filters.search){const a=E.filters.search.toLowerCase();t=t.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(E.filters.status==="devendo")t=t.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(E.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;t=t.filter(s=>s.dobMonth==a)}else if(E.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();t=t.filter(o=>{if(!o.createdAt)return!1;const r=new Date(o.createdAt);return r.getMonth()+1===a&&r.getFullYear()===s})}if(E.filters.hasLoyalty&&(t=t.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),E.filters.inactiveDays){const a=parseInt(E.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),t=t.filter(o=>{if(!o.lastVisit&&!o.createdAt)return!1;let r;if(o.lastVisit){const i=o.lastVisit.seconds||o.lastVisit._seconds;r=i?new Date(i*1e3):new Date(o.lastVisit)}else r=new Date(o.createdAt);return r<s})}if(t.sort((a,s)=>{let o,r;switch(E.sortConfig.key){case"name":return o=(a.name||"").toLowerCase(),r=(s.name||"").toLowerCase(),E.sortConfig.direction==="asc"?o.localeCompare(r):r.localeCompare(o);case"contact":return o=a.phone||"",r=s.phone||"",E.sortConfig.direction==="asc"?o.localeCompare(r):r.localeCompare(o);case"lastVisit":o=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,r=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":o=parseFloat(a.totalDebt)||0,r=parseFloat(s.totalDebt)||0;break;default:o=a.name,r=s.name}return o<r?E.sortConfig.direction==="asc"?-1:1:o>r?E.sortConfig.direction==="asc"?1:-1:0}),t.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=t.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,o=Fa(a.lastVisit),r=Go(a.phone),i=new Date().getMonth()+1,n=a.dobMonth==i,d=E.selectedIds.has(a.id);let l="";return n&&(l+='<span class="bg-indigo-100 text-indigo-700 text-[8px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider">🎂 Aniversariante</span> '),a.loyaltyPoints>0&&(l+=`<span class="bg-amber-100 text-amber-700 text-[8px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
    ...
    `}function Yo(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(Zl).forEach(([o,r])=>{const i=o===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
    ...
    `,Pe.querySelector('button[data-action="back-to-menu"]').addEventListener("click",o=>{o.preventDefault(),Zo({id:Q})});const s=document.getElementById("settings-content-detail");switch(e){case"personal-data":Kl(J,s);break;case"change-password":ed(J,s);break;case"change-email":td(J,s);break;case"branding":ad(J,s);break;case"booking":sd(J,s);break;case"working-hours":od(J,s);break;case"whatsapp-bot":Qo(J,s);break;case"loyalty":await rd(J,s);break;case"financial":await id(J,s);break;case"support":nd(J,s);break;case"cancellation":ld(J,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Zo(e={}){Pe.innerHTML=`
    ...
    `;try{Q=e.id||m.establishmentId,J=await Me(Q);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=J.isMatriz||!J.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=Xo();Pe.innerHTML=`
        ...
        `,Pe.querySelectorAll("div[data-section]").forEach(o=>{o.addEventListener("click",r=>{cd(o.dataset.section)})}),Pe.querySelectorAll(".module-toggle").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.module;try{const n={...(await Me(Q)).modules,[r]:o.checked};await Za(Q,{modules:n}),b("Módulos","Módulos atualizados com sucesso.","success")}catch(i){o.checked=!o.checked,b("Erro",i.message,"error")}})})}catch(t){Pe.innerHTML=`
    ...
    `).join("")}const ht=document.getElementById("content");async function Je(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,o=await la(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),r=document.getElementById("filterReason")?.value.toLowerCase(),i=r?o.filter(d=>d.reason&&d.reason.toLowerCase().includes(r)):o,n=i.reduce((d,l)=>{const c=l.reason||"Sem motivo";return d[c]||(d[c]=[]),d[c].push(l),d},{});if(t.innerHTML="",i.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([d,l])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
        ...
        </section>`,bd(t),await Je(t);const o=document.getElementById("batchProfSelectionContainer");try{const r=await ye(m.establishmentId);o.innerHTML=r.map(i=>`
            <div class="flex items-center">
    ...
    `,jt&&it.removeEventListener("click",jt),Rt&&it.removeEventListener("change",Rt),jt=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":Ns();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));Ns(s);break;case"back-to-list":ta();break;case"delete-user":{if(e.stopPropagation(),await G("Excluir Usuário","Tem certeza? Ação irreversível."))try{await vd(t.dataset.userId),b("Usuário excluído!","success"),ta()}catch(o){b(`Erro: ${o.message}`,"error")}break}}},Rt=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")za();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await wd(a,s);const o=m.users.findIndex(r=>r.id===a);o>-1&&(m.users[o].status=s,za())}catch(o){b(`Erro: ${o.message}`,"error"),t.checked=!t.checked}}},it.addEventListener("click",jt),it.addEventListener("change",Rt),await Ld()}const Cd=document.getElementById("content");let js={},Va=null;function Dd(){Object.values(js).forEach(e=>e?.destroy()),js={}}function Td(e,t){if(!window.jspdf){b("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const i=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,r),s.autoTable({html:`#${t}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Rs(e){const t=document.getElementById("genericModal"),a=v(e.client),s=v(e.items),o=v(e.responsavelCaixa||"N/A"),r=(e.payments||[]).map(i=>`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const d=n.dataset.transactionIndex,l=Va.transactions[d];l&&Rs(l)})})}async function Fs(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,o=a.value;if(!s||!o)return b("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,i=await Qt({establishmentId:m.establishmentId,startDate:s,endDate:o,cashierSessionId:r});Va=i,e.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Fs),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${s}_a_${o}`;Td(r,"transactionsTable")});try{const s=await tn(m.establishmentId),o=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(r=>{const i=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=v(r.closedByName||"N/A");o.innerHTML+=`<option value="${r.id}">${n} - ${i}</option>`})}catch{b("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Fs()}const Md=document.getElementById("content");let $={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Ft=null,Ht=null;function ms(e){const t=new Map,a=[];return e&&(e.forEach(s=>t.set(s.id,{...s,children:[]})),t.forEach(s=>{s.parentId&&t.has(s.parentId)?t.get(s.parentId).children.push(s):a.push(s)})),a}function Ko(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,s]=e.split("-"),o=new Date(t,a-1,s),r=String(o.getDate()).padStart(2,"0"),i=o.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:r,month:i,full:o.toLocaleDateString("pt-BR")}}function pe(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function et(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,o,r]=e.split("-");return new Date(s,o-1,r)<a}function Ad(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML=`
        ...
        `};e.innerHTML=t.map(o=>s(o)).join("")}async function _a(e){const t=document.getElementById("genericModal"),a=e==="nature",s=a?"Plano de Naturezas":"Centros de Custo",o=a?ba:rs,r=a?En:In,i=a?"natures":"costCenters";t.innerHTML=`
    ...
    `}function jd(){document.querySelectorAll(".sort-header").forEach(e=>{const t=e.querySelector("i");if(!t)return;e.dataset.sort===$.sortCol?(e.classList.add("text-indigo-700"),e.classList.remove("text-gray-500"),t.className=$.sortAsc?"bi bi-arrow-up ml-1 text-indigo-600":"bi bi-arrow-down ml-1 text-indigo-600"):(e.classList.remove("text-indigo-700"),e.classList.add("text-gray-500"),t.className="bi bi-arrow-down-up ml-1 opacity-30 text-[10px]")})}function vt(){const e=document.getElementById("list-container");if(!e)return;const t=$.currentTab==="receivables",a=t?$.receivables:$.payables;let s=a;if($.statusFilter!=="all"&&(s=a.filter(l=>{const c=et(l.dueDate,l.status);return $.statusFilter==="overdue"?c:$.statusFilter==="pending"?l.status==="pending"&&!c:l.status===$.statusFilter})),$.searchQuery&&(s=s.filter(l=>l.description&&l.description.toLowerCase().includes($.searchQuery)||l.entity&&l.entity.toLowerCase().includes($.searchQuery)||l.notes&&l.notes.toLowerCase().includes($.searchQuery))),s.sort((l,c)=>{let u=l[$.sortCol],p=c[$.sortCol];return $.sortCol==="dueDate"?(u=new Date(u).getTime(),p=new Date(p).getTime()):($.sortCol==="description"||$.sortCol==="status")&&(u=u?u.toLowerCase():"",p=p?p.toLowerCase():""),u<p?$.sortAsc?-1:1:u>p?$.sortAsc?1:-1:0}),jd(),s.length===0){e.innerHTML=`
        ...
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${o.map(l=>{const c=l.id===t.id,u=l.status==="paid",p=Ko(l.dueDate);return`
    ...
    `}async function tt(){const e=document.getElementById("list-container");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';const t=Array.from(q.filterEstablishmentIds).join(",");try{const[a,s]=await Promise.all([Wd({startDate:q.startDate,endDate:q.endDate,professionalId:q.professionalId,establishmentId:t}),Ud(q.startDate,q.endDate,t)]);q.reports=a||[];const o=q.reports.reduce((r,i)=>r+(i.summary.finalValue||i.summary.totalCommission),0);q.stats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0,margin:s.totalRevenue>0?((s.totalRevenue-s.totalCommissionsPaid)/s.totalRevenue*100).toFixed(1):0,netPaid:o},q.selectedIds.clear(),wt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),Zd(),ir()}catch(a){console.error(a),e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
                <p class="text-slate-600 text-xs font-medium">Erro ao carregar dados.</p>
            </div>`}}function Zd(){document.getElementById("kpi-revenue").textContent=yt(q.stats.revenue),document.getElementById("kpi-commissions").textContent=yt(q.stats.commissions),document.getElementById("kpi-margin").textContent=`${q.stats.margin}%`,document.getElementById("kpi-net").textContent=yt(q.stats.netPaid)}function ir(){const e=document.getElementById("list-container");let t=q.reports;if(q.searchQuery){const a=q.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(t.length===0){e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-20 text-center">
                <div class="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center mb-3">
        ...
        `}).join("")}function Kd(){Ot&&document.body.removeEventListener("click",Ot),Ot=o=>{const r=o.target;if(r.classList.contains("item-checkbox")){const n=r.value;r.checked?q.selectedIds.add(n):q.selectedIds.delete(n),wt(),o.stopPropagation();return}const i=r.closest("button[data-action]");if(i){const n=i.dataset.action,d=i.dataset.id;switch(n){case"apply-filters":q.startDate=document.getElementById("filter-start").value,q.endDate=document.getElementById("filter-end").value,q.professionalId=document.getElementById("filter-prof").value,tt();break;case"new-calculation":ec();break;case"print-receipt":lc(d);break;case"delete-report":cc(d);break;case"view-report-details":ic(d);break;case"toggle-all-profs":const l=document.querySelectorAll(".prof-checkbox"),c=Array.from(l).every(w=>w.checked);l.forEach(w=>w.checked=!c);break;case"calculate-preview":tc();break;case"save-final-reports":rc();break;case"toggle-preview-details":const u=i.dataset.idx,p=document.getElementById(`preview-details-${u}`),f=i.querySelector("i");p&&(p.classList.contains("hidden")?(p.classList.remove("hidden"),f&&f.classList.replace("bi-chevron-down","bi-chevron-up")):(p.classList.add("hidden"),f&&f.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",Ot),document.getElementById("search-input").addEventListener("input",o=>{q.searchQuery=o.target.value,ir()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&sc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const r=o.target.checked,i=document.querySelectorAll(".item-checkbox");q.selectedIds.clear(),i.forEach(n=>{n.checked=r,r&&q.selectedIds.add(n.value)}),wt()});const t=document.getElementById("cancel-selection-btn");t&&t.addEventListener("click",()=>{q.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),wt()});const a=document.getElementById("batch-delete-btn");a&&a.addEventListener("click",dc),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",r=>{const i=r.target.closest("label");r.target.checked?(q.filterEstablishmentIds.add(r.target.value),i.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.remove("border-slate-200","text-slate-600")):(q.filterEstablishmentIds.delete(r.target.value),i.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.add("border-slate-200","text-slate-600")),tt()})});const s=document.getElementById("export-excel-btn");s&&s.addEventListener("click",nc)}function wt(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=q.selectedIds.size;t&&(t.textContent=a),e&&(a>0?(e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex")))}function ec(){const e=new Date().toISOString().split("T")[0],t=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],a=q.professionals.map(o=>`
    ...
    `}function bc(){const e=uc(),t=document.getElementById("kpi-container");t&&(t.innerHTML=`
        ...
        <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col relative overflow-hidden group">
            ...
            <span class="text-2xl font-black text-indigo-600 mt-1 z-10">${qe(e.avgPrice)}</span>
        </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-indigo-300 transition-all duration-300 flex flex-col relative overflow-hidden group cursor-pointer"
                ...
                <div class="p-5 flex-grow">
                    ...
                    <div class="flex justify-between items-end">
                        <div>
                            ${n>0?`<p class="text-[10px] text-slate-400 font-bold line-through mb-0.5">De ${qe(i)}</p>`:""}
                            <p class="text-2xl font-black text-slate-900 leading-none">${qe(r)}</p>
                        </div>
                        <div class="text-right">
    ...
    `;t.innerHTML=w,t.style.display="flex";const k=t.querySelector("#package-items-list"),h=t.querySelector("#finalPrice"),T=t.querySelector("#discountIndicator"),P=x=>{const g=x.reduce((A,C)=>A+(C.price||0)*(C.quantity||1),0),I=parseFloat(h.value)||0;if(t.querySelector("#originalPrice").textContent=qe(g),g>0&&g>I&&I>0){const A=(g-I)/g*100;T.textContent=`${A.toFixed(0)}% OFF`,T.classList.remove("hidden")}else T.classList.add("hidden")},S=x=>{x.length===0?k.innerHTML=`
                ...
                <div class="flex items-center justify-between bg-white p-2 rounded-xl shadow-sm border border-slate-200 hover:border-indigo-300 transition-colors animate-fade-in-fast">
                    ...
                    <div class="flex items-center gap-3 flex-shrink-0 pl-2">
                        <div class="text-right">
                            ...
                            <span class="text-xs font-black text-slate-700">${qe(g.price)}</span>
                        </div>
            ...
            `}).join(""),P(x)};S(s),k.addEventListener("change",x=>{if(x.target.classList.contains("quantity-input")){const g=parseInt(x.target.dataset.index,10),I=parseInt(x.target.value,10);I>0&&s[g]&&(s[g].quantity=I,S(s))}}),k.addEventListener("click",x=>{const g=x.target.closest(".remove-item-btn");if(g){const I=parseInt(g.dataset.index,10);s.splice(I,1),S(s)}}),h.addEventListener("input",()=>{P(s)}),t.querySelector("#add-item-to-package-btn").onclick=()=>fc(x=>{const g=s.find(I=>I.id===x.id&&I.type===x.type);g?g.quantity++:s.push({...x,quantity:1}),S(s)}),Ue&&t.removeEventListener("click",Ue),Ue=async x=>{const g=x.target.closest("button[data-action]");if(!g)return;const I=g.dataset.action;if(x.stopPropagation(),I==="close-modal"&&Os(),I==="toggle-all-ests"){const A=document.querySelectorAll(".modal-est-checkbox"),C=Array.from(A).every(D=>D.checked);A.forEach(D=>D.checked=!C)}if(I==="save-package"){const A=g,C=Array.from(document.querySelectorAll(".modal-est-checkbox:checked")).map(F=>F.value);if(C.length===0){b("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const D=s.reduce((F,V)=>F+V.price*V.quantity,0),j={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:D,price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,sellStartDate:document.getElementById("sellStartDate").value||null,sellEndDate:document.getElementById("sellEndDate").value||null,salesLimit:parseInt(document.getElementById("salesLimit").value,10)||null,establishmentIds:C,establishmentId:C[0]};if(!j.name||isNaN(j.price)){b("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(j.items.length===0){b("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}A.disabled=!0,A.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await on(j.id,j):(delete j.id,await sn(j)),b("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Os(),await sa()}catch(F){b("Erro",`Não foi possível salvar o pacote: ${F.message}`,"error"),A.disabled=!1,A.innerHTML='<i class="bi bi-save2"></i> Salvar Pacote'}}},t.addEventListener("click",Ue)}function fc(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[110] p-4 animate-fade-in-fast";const s=n=>{const d=t.toLowerCase(),l=_.catalogForModal.services.filter(f=>f.name.toLowerCase().includes(d)),c=_.catalogForModal.products.filter(f=>f.name.toLowerCase().includes(d)),u=l.map(f=>`
            <button data-action="select-item" data-item-type="service" data-item-id="${f.id}" class="flex items-center gap-3 w-full p-2 bg-white border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all text-left group">
                ...
                <div class="flex-grow min-w-0">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">${qe(f.price)}</p>
                </div>
    ...
    `,await wc()}async function wc(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await Di(t);vc=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=v(a.name);e.innerHTML=`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const o=(await ge()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),o.length===0)t.innerHTML=`
        ...
        `)}function Xt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("kairos_theme",e),Sa&&(e==="dark"?Sa.innerHTML="☀️":Sa.innerHTML="🌙")}function Cc(){const e=localStorage.getItem("kairos_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;Xt(e||(t?"dark":"light"))}let kt=null,$t=[];function nr(){if(!Vt||!Ea)return;const e=$t.filter(t=>!t.read).length;if(e>0?(Vt.textContent=e,Vt.classList.remove("hidden")):Vt.classList.add("hidden"),$t.length===0){Ea.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Ea.innerHTML=$t.map(t=>`
