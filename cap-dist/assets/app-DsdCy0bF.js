...
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as he,d as me,m as Ls}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Pr,reauthenticateWithCredential as Tr,verifyBeforeUpdateEmail as Br,updatePassword as Mr,updateProfile as Ar,setPersistence as qr,browserLocalPersistence as jr,onAuthStateChanged as Nr,signOut as Rr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as Ae,getDoc as ns,updateDoc as Bt,setDoc as Fr,addDoc as mo,collection as fa,query as go,where as fo,getDocs as Hr,deleteDoc as Or,arrayUnion as zr,orderBy as Vr,onSnapshot as _r}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{a as C,e as h,s as Y,b as f,c as Be,r as xa,f as Da,i as Ur}from"./utils-JfzC6GFr.js";import{getToken as Wr,onMessage as Jr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Qr(t,e,a){m.establishmentId=t,m.establishmentName=e,m.userPermissions=a,m.currentViewContext={type:"BRANCH",id:t,name:e}}const ha=(t,e,a,s=null)=>{let r=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),C(r)},Gr=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return C(s)},Yr=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return C(r)},Xr=t=>C("/api/appointments",{method:"POST",body:JSON.stringify(t)}),Zr=(t,e)=>C(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),Kr=t=>C(`/api/appointments/${t}`,{method:"DELETE"}),ei=t=>C(`/api/appointments/${t}/reopen`,{method:"POST"}),ti=(t,e)=>C(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)}),re=document.getElementById("sidebar"),ze=document.getElementById("sidebarToggle"),kt=document.getElementById("mainContent"),ai=document.querySelectorAll(".sidebar-link"),Fa=document.getElementById("menu-search"),Cs=document.getElementById("hamburger-menu-btn"),st=document.getElementById("mobile-overlay");let Me=!0;function Fe(t){if(!re||!kt)return;re.classList.toggle("collapsed",t),kt.classList.toggle("sidebar-collapsed-shift",t);const e=re.querySelector(".sidebar-search-container"),a=re.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const r=s.getAttribute("data-target-submenu"),o=document.getElementById(r),i=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function si(){!re||!st||(re.classList.add("mobile-open"),st.classList.add("visible"))}function jt(){!re||!st||(re.classList.remove("mobile-open"),st.classList.remove("visible"))}function oi(){Fe(!re.classList.contains("collapsed"))}function ri(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&re.classList.contains("collapsed")&&Fe(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function ii(){Fa&&Fa.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),r=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),r.forEach(o=>o.style.display="block");return}r.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const i=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function ni(t,e,a){if(!re||!kt)return;kt.classList.add("main-content-shift"),window.innerWidth>=1024?(Me=!0,Fe(!1)):window.innerWidth>=768?(Me=!1,Fe(!0)):(kt.classList.remove("main-content-shift","sidebar-collapsed-shift"),jt()),ze&&ze.addEventListener("click",r=>{r.stopPropagation(),window.innerWidth>=768?(Me=!Me,Fe(!Me),Me?(ze.classList.add("text-indigo-400"),ze.classList.remove("text-gray-400")):(ze.classList.remove("text-indigo-400"),ze.classList.add("text-gray-400"))):oi()}),re.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Me&&re.classList.contains("collapsed")&&Fe(!1)}),re.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Me){const r=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===Fa;!r&&!o&&Fe(!0)}}),Cs&&Cs.addEventListener("click",r=>{r.stopPropagation(),si()}),st&&st.addEventListener("click",r=>{r.stopPropagation(),jt()});let s=0;re.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),re.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&jt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(r=>{r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const i=r.getAttribute("data-target-submenu"),n=r.querySelector(".submenu-arrow");ri(i,n)})}),ii(),ai.forEach(r=>{const o=r.getAttribute("data-target");if(!o)return;const i=o.replace("-section",""),n=a?.[i]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){r.parentElement&&r.parentElement.tagName==="LI"?r.parentElement.style.display="none":r.style.display="none";return}r.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),r.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&jt()})})}const li=t=>C("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),ve=()=>C("/api/establishments/hierarchy",{method:"GET"}),qe=t=>{const e=t||m.establishmentId;return e?C(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ls=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},di=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ci=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},$e=t=>C(`/api/professionals/${t}`),xo=t=>C(`/api/professionals/details/${t}`),ui=t=>C("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Ha=(t,e)=>C(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),ho=t=>C(`/api/professionals/${t}`,{method:"DELETE"}),pi=t=>{const e=t.map(a=>ho(a));return Promise.all(e)};class bi{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const r=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${r.top+window.scrollY-o}px`,this.spotlight.style.left=`${r.left+window.scrollX-o}px`,this.spotlight.style.width=`${r.width+o*2}px`,this.spotlight.style.height=`${r.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(r)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
    ...
    `}async function qo(t,e){const a=document.getElementById("chart-container"),s=document.getElementById("chart-start-date"),r=document.getElementById("chart-end-date");if(a){const o=document.createElement("div");o.id="chart-loading-overlay",o.className="absolute inset-0 bg-white/70 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-xl",o.innerHTML='<div class="w-8 h-8 border-[3px] border-indigo-100 border-t-indigo-500 rounded-full animate-spin"></div>',a.appendChild(o)}try{const o=we(t),i=we(e),n=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId],l=n.join(","),d=await wa({startDate:o,endDate:i,establishmentId:l}).catch(()=>({entries:[]})),u=n.map(T=>ha(T,o+"T00:00:00.000Z",i+"T23:59:59.999Z",null).catch(()=>[])),p=(await Promise.all(u)).flat(),b=d.entries||[],g=[],v=[],y=[];let k=new Date(t);k.setHours(0,0,0,0);const P=new Date(e);for(P.setHours(23,59,59,999);k<=P;){const T=we(k);g.push(k.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}));const $=b.filter(q=>q.status==="paid"&&(q.paymentDate===T||!q.paymentDate&&q.dueDate.startsWith(T))).reduce((q,N)=>q+N.amount,0),L=p.filter(q=>q.status==="completed"&&q.startTime&&q.startTime.startsWith(T)).length;v.push($),y.push(L),k.setDate(k.getDate()+1)}Zi(g,v,y),s&&(s.value=o),r&&(r.value=i)}catch(o){console.error("Erro ao recarregar grafico:",o)}finally{const o=document.getElementById("chart-loading-overlay");o&&o.remove()}}function Zi(t,e,a){const s=document.getElementById("revenueChart");if(!s)return;Ta&&Ta.destroy();const o=s.getContext("2d").createLinearGradient(0,0,0,240);o.addColorStop(0,"rgba(99, 102, 241, 0.2)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)"),Ta=new Chart(s,{type:"line",data:{labels:t,datasets:[{label:"Receita Real (R$)",data:e,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.3,yAxisID:"y"},{label:"Agendamentos Feitos",data:a,borderColor:"#10b981",backgroundColor:"transparent",borderWidth:2,borderDash:[5,5],pointBackgroundColor:"#10b981",pointBorderColor:"#ffffff",pointBorderWidth:1,pointRadius:3,pointHoverRadius:5,fill:!1,tension:.3,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,boxHeight:6,font:{family:"Nunito, sans-serif",size:10,weight:"bold"},color:"#64748b"}},tooltip:{backgroundColor:"#1e293b",padding:10,cornerRadius:8,titleFont:{size:11,family:"Nunito, sans-serif",weight:"normal"},bodyFont:{size:12,weight:"bold",family:"Nunito, sans-serif"},displayColors:!0,usePointStyle:!0,callbacks:{label:function(i){return i.datasetIndex===0?"Receita: "+new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(i.parsed.y):"Concluídos: "+i.parsed.y}}}},scales:{y:{type:"linear",display:!0,position:"left",beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"},maxTicksLimit:6,callback:function(i){return"R$ "+i}}},y1:{type:"linear",display:!0,position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1},border:{display:!1},ticks:{color:"#10b981",font:{family:"Nunito, sans-serif",size:9,weight:"600"},stepSize:1,callback:function(i){if(Math.floor(i)===i)return i}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"}}}},interaction:{intersect:!1,mode:"index"}}})}function Ki(){document.getElementById("content").addEventListener("click",e=>{if(e.target.closest("#btn-update-chart")){const o=document.getElementById("chart-start-date"),i=document.getElementById("chart-end-date");if(o&&i&&o.value&&i.value){const n=new Date(o.value+"T00:00:00"),l=new Date(i.value+"T00:00:00");qo(n,l)}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"goto-agenda":case"new-appointment":se("agenda-section");break;case"goto-pdv":se("comandas-section");break;case"goto-clients":se("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${m.establishmentId||""}`;window.open(o,"_blank");break}})}const pt=t=>C(`/api/services/${t}`),en=t=>C("/api/services",{method:"POST",body:JSON.stringify(t)}),tn=(t,e)=>C(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),jo=t=>C(`/api/services/${t}`,{method:"DELETE"}),ka=(t,e,a,s="all")=>{const r=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return C(r)},Sa=t=>C("/api/blockages",{method:"POST",body:JSON.stringify(t)}),ps=t=>C(`/api/blockages/${t}`,{method:"DELETE"}),No=t=>C("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),As=document.getElementById("content");let qs=!1;const ia=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let $a=[],Oa=[],na={},Ro=[],z={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},H={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Fo(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function Zt(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${r}`}function bs(){const t=document.getElementById("profSelectorContainer");if(!t||!m.professionals)return;let e=m.professionals.filter(r=>z.showInactiveProfs||r.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(r=>{const o=z.selectedProfessionalId===r.id,i=r.name==="Todos"?"T":r.name.charAt(0).toUpperCase(),n=r.id!=="all"?m.professionalColors.get(r.id)||ia[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function Ho(){const t=m.allEvents.filter(e=>z.selectedProfessionalId==="all"||e.professionalId===z.selectedProfessionalId);z.currentView==="list"?rn(t):on(t),ms()}function ms(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(z.isSelectionMode&&z.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function nn(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(z.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(z.currentView==="list"){an();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function Le(){const t=document.getElementById("agenda-view");if(!t)return;z.selectedItems.clear(),ms(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',nn();let e,a;if(z.currentView==="list")e=new Date(z.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=Fo(z.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const r=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async d=>{const[u,c]=await Promise.all([ha(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId==="all"?null:z.selectedProfessionalId),ka(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId)]);return{appts:u||[],blockages:c||[]}}),o=await Promise.all(r);let i=[],n=[];if(o.forEach(d=>{i=i.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(u=>({...u,type:u.type||"appointment",professionalName:u.professionalName||(()=>{const c=m.professionals?.find(p=>p.id===u.professionalId);return c?c.name:"Indefinido"})()}));m.allEvents=[...l(i),...l(n)],bs(),Ho()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function ln(){try{const e=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async i=>{const[n,l,d]=await Promise.all([$e(i),pt(i),qe(i)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,r=new Map;let o=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>s.set(n.id,n)),i.services.forEach(n=>r.set(n.id,n))}),m.professionals=Array.from(s.values()),m.services=Array.from(r.values()),Ro=[],o&&(na=o.loyaltyProgram||{enabled:!1}),m.professionals.forEach((i,n)=>{m.professionalColors.set(i.id,ia[n%ia.length])}),bs()}catch{f("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function Oo(t={}){z.currentDate=t.targetDate?new Date(t.targetDate):z.currentDate||new Date,z.isSelectionMode=!1,z.selectedItems.clear(),As.innerHTML=`
        ...
        </div>`;const r=document.createElement("div");r.id="optionsOverlay",r.className="fixed inset-0 bg-black/40 z-[9999] opacity-0 transition-opacity duration-300",document.body.appendChild(r),document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.remove("translate-y-full"),r.classList.remove("opacity-0")});const o=()=>{e.classList.add("translate-y-full"),r.classList.add("opacity-0"),setTimeout(()=>{e.remove(),r.remove()},300)};document.getElementById("closeOptSheet").addEventListener("click",o),r.addEventListener("click",o),document.getElementById("optSelectMode").addEventListener("click",()=>{z.isSelectionMode=!z.isSelectionMode,z.isSelectionMode||z.selectedItems.clear(),o(),Ho()}),document.getElementById("optInactiveToggle").addEventListener("change",i=>{z.showInactiveProfs=i.target.checked,bs()})}function xt(t){t<1||t>4||(H.step=t,za(null,!0))}function cn(t){return{title:t?"Editar Reserva":"Novo Cliente",content:`
        ...
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            ...
            <div id="apptServicesContainer" class="flex-1 overflow-y-auto grid grid-cols-2 gap-3 content-start pb-4">
                ${$a.map(t=>`<div class="service-card p-3 bg-white rounded-xl border-2 transition-all active:scale-95 ${H.data.selectedServiceIds.includes(t.id)?"border-indigo-500 bg-indigo-50 shadow-md":"border-gray-100 hover:border-gray-200 shadow-sm"} cursor-pointer flex flex-col justify-between gap-2" data-service-id="${t.id}">
                        <div>
        ...
        </div>`}}function bn(){const t=H.data.date||Zt();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
    ...
    `;const r=()=>{const i=a.querySelector("#appointmentModalContent");i&&(i.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),i.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),a.classList.add("opacity-0"),setTimeout(()=>{a.classList.add("hidden")},300)};a.querySelectorAll('[data-action="next-step"]').forEach(i=>i.addEventListener("click",()=>{const n=parseInt(i.dataset.currentStep,10);if(n===1&&(H.data.clientName=a.querySelector("#apptClientName").value.trim(),H.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!H.data.clientName))return f("Preencha o nome do cliente.","warning");if(n===2&&H.data.selectedServiceIds.length===0)return f("Selecione um serviço.","warning");if(n===3&&!H.data.professionalId)return f("Escolha um membro da equipe.","warning");xt(n+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(i=>i.addEventListener("click",()=>xt(parseInt(i.dataset.currentStep,10)-1))),a.querySelectorAll('[data-action="close-modal"]').forEach(i=>{i.addEventListener("click",r)}),a.classList.remove("hidden"),a.offsetWidth,a.classList.remove("opacity-0");const o=a.querySelector("#appointmentModalContent");o&&(o.classList.remove("translate-y-full","md:translate-y-8","md:scale-95"),o.classList.add("translate-y-0","md:translate-y-0","md:scale-100")),H.step===2&&a.querySelectorAll(".service-card").forEach(i=>i.addEventListener("click",()=>{const n=a.querySelector("#multiServiceToggle")?.checked,l=i.classList.contains("bg-indigo-50"),d=i.dataset.serviceId;navigator.vibrate&&navigator.vibrate(15),n?l?(i.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.add("border-gray-100","shadow-sm"),H.data.selectedServiceIds=H.data.selectedServiceIds.filter(u=>u!==d)):(i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds.includes(d)||H.data.selectedServiceIds.push(d)):(a.querySelectorAll(".service-card.bg-indigo-50").forEach(u=>{u.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),u.classList.add("border-gray-100","shadow-sm")}),i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds=[d],setTimeout(()=>xt(3),250))})),H.step===3&&a.querySelectorAll(".professional-modal-card").forEach(i=>i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),a.querySelectorAll(".professional-modal-card.bg-indigo-50").forEach(l=>{l.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),l.classList.add("border-gray-100","shadow-sm")}),i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),H.data.professionalId=i.dataset.professionalId;const n=Oa.find(l=>l.id===i.dataset.professionalId);H.data.professionalName=n?n.name:"",setTimeout(()=>xt(4),250)})),H.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",i=>fn(i.target.value)),H.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",js),a.querySelector("#availableTimesContainer")?.addEventListener("click",i=>{const n=i.target.closest("button[data-time-slot]");n&&(navigator.vibrate&&navigator.vibrate(10),a.querySelectorAll("#availableTimesContainer button").forEach(l=>{l.classList.remove("bg-indigo-600","text-white","border-indigo-600","shadow-md"),l.classList.add("bg-white","text-gray-700","border-gray-200","shadow-sm")}),n.classList.add("bg-indigo-600","text-white","border-indigo-600","shadow-md"),n.classList.remove("bg-white","text-gray-700","border-gray-200","shadow-sm"),H.data.time=n.dataset.timeSlot)}),a.querySelector("#btnSubmitAppointment")?.addEventListener("click",mn),js(),gn())}async function mn(t){t.preventDefault();const e=document.getElementById("btnSubmitAppointment");if(!H.data.time||!H.data.selectedServiceIds.length||!H.data.professionalId)return f("Selecione horário, serviço e profissional.","warning");e.disabled=!0,e.innerHTML='<i class="bi bi-hourglass-split"></i> Processando...';const a=H.data.selectedServiceIds.map(u=>{const c=$a.find(p=>p.id===u);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[s,r]=H.data.time.split(":"),o=new Date(`${H.data.date}T${s}:${r}:00`),i=a.reduce((u,c)=>u+(c.duration+(c.bufferTime||0)),0),n=new Date(o.getTime()+i*6e4),d={establishmentId:m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId,clientName:H.data.clientName,clientPhone:H.data.clientPhone,services:a,professionalId:H.data.professionalId,professionalName:H.data.professionalName,startTime:o.toISOString(),endTime:n.toISOString(),redeemedReward:H.data.redeemedReward};H.data.id&&(d.id=H.data.id);try{H.data.id?await Zr(H.data.id,d):await Xr(d),f("Registro salvo!","success");const u=document.getElementById("appointmentModal"),c=u.querySelector("#appointmentModalContent");c&&(c.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),c.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),u.classList.add("opacity-0"),setTimeout(()=>{u.classList.add("hidden")},300),Le()}catch(u){f(u.message,"error"),e.disabled=!1,e.innerHTML=`<i class="bi bi-check-circle-fill"></i> ${H.data.id?"Salvar Edição":"Confirmar"}`}}async function js(){const t=document.getElementById("availableTimesContainer"),e=document.getElementById("apptTotalDuration");if(!t)return;const a=document.getElementById("apptDate");a&&a.value&&(H.data.date=a.value);const s=H.data.selectedServiceIds.reduce((u,c)=>{const p=$a.find(b=>b.id===c);return u+(p?p.duration+(p.bufferTime||0):0)},0);e&&(e.innerHTML=`<strong>${s}</strong> min`);const{professionalId:r,selectedServiceIds:o,date:i,originalDate:n,originalTime:l,id:d}=H.data;if(!r||!o.length||!i){t.innerHTML='<p class="col-span-full text-center text-xs text-gray-500 font-bold py-4 bg-white rounded-xl shadow-sm border border-gray-100">Preencha os passos anteriores.</p>';return}t.innerHTML='<div class="col-span-full flex justify-center py-4"><div class="w-6 h-6 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div></div>';try{const u=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId;let c=await Yr({establishmentId:u,professionalId:r,serviceIds:o,date:i});const p=new Date;if(new Date(i+"T00:00:00").toDateString()===p.toDateString()){const b=p.getHours()*60+p.getMinutes();c=c.filter(g=>{const[v,y]=g.split(":").map(Number);return v*60+y>=b})}d&&i===n&&l&&(c.includes(l)||(c.push(l),c.sort())),t.innerHTML=c.length>0?c.map(b=>{const g=H.data.time===b;return`<button type="button" data-time-slot="${b}" class="py-3 text-sm font-bold rounded-xl border-2 transition-transform active:scale-95 ${g?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-white text-gray-700 border-gray-200 hover:border-indigo-300 shadow-sm"}">${b}</button>`}).join(""):'<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl border border-red-100 shadow-sm">Nenhum horário livre.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl">Erro ao pesquisar.</p>'}}function gn(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:a}=H.data,{enabled:s,rewards:r}=na;if(!s||!e||!r?.length){t.innerHTML="";return}const o=r.filter(i=>a>=i.points);if(!o.length){t.innerHTML='<p class="text-xs font-bold text-gray-400 mt-3 text-center">Nenhuma recompensa atingida ainda.</p>';return}t.innerHTML=`<div class="border border-indigo-100 bg-indigo-50/80 rounded-xl p-3 mt-3 shadow-sm">
        ...
        ${o.map(i=>`<label class="flex items-center gap-2 p-2 bg-white border border-indigo-100 rounded-lg mb-1.5 cursor-pointer shadow-sm active:scale-95 transition-transform"><input type="radio" name="loyaltyReward" value="${G(i.reward)}" data-points="${i.points}" class="w-4 h-4 accent-indigo-600"><span class="text-[0.85rem] font-bold text-gray-800 flex-1">${G(i.reward)}</span><span class="text-[0.65rem] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded">-${i.points} pts</span></label>`).join("")}
            ...
            </div>`).join(""),e.querySelectorAll(".client-card").forEach(n=>{n.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),H.data.clientName=n.dataset.clientName,H.data.clientPhone=n.dataset.clientPhone,H.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(na?.rewards||[]).map(d=>d.points));H.data.clientHasRewards=na.enabled&&l!==1/0&&H.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,e.querySelectorAll(".client-card").forEach(d=>{d.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),d.classList.add("border-gray-100","shadow-sm")}),n.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),n.classList.remove("border-gray-100","shadow-sm"),setTimeout(()=>xt(2),250)})})}catch{e.innerHTML='<p class="text-[0.75rem] font-bold text-red-500 bg-red-50 p-3 rounded-xl border border-red-100 text-center shadow-sm">Erro ao pesquisar.</p>'}}const xn=(t,e=null,a=1,s=12)=>{let r=`/api/comandas/${t}?page=${a}&limit=${s}`;return e&&(typeof e=="object"?(e.startDate&&(r+=`&startDate=${e.startDate}`),e.endDate&&(r+=`&endDate=${e.endDate}`)):typeof e=="string"&&(r+=`&date=${e}`)),C(r)},hn=(t,e)=>C(`/api/appointments/${t}/comanda`,{method:"POST",body:JSON.stringify({items:e})}),zo=t=>C("/api/sales",{method:"POST",body:JSON.stringify(t)}),Va=(t,e)=>C(`/api/sales/${t}?date=${e}`),vn=(t,e,a)=>{const s=`/api/sales/${t}?startDate=${e}&endDate=${a}`;return C(s)},yn=t=>C(`/api/sales/${t}/reopen`,{method:"POST"}),Vo=t=>C(`/api/sales/${t}`,{method:"DELETE"}),Ns=Object.freeze(Object.defineProperty({__proto__:null,createSale:zo,deleteSale:Vo,getSales:Va,getSalesByDateRange:vn,reopenSale:yn},Symbol.toStringTag,{value:"Module"})),bt=t=>C(`/api/products/${t}`),_o=t=>C("/api/products",{method:"POST",body:JSON.stringify(t)}),Uo=(t,e)=>C(`/api/products/${t}`,{method:"PUT",body:JSON.stringify(e)}),gs=t=>C(`/api/products/${t}`,{method:"DELETE"}),Wo=(t,e)=>C(`/api/products/${t}/stock`,{method:"PATCH",body:JSON.stringify(e)}),wn=t=>C(`/api/products/${t}/stock-history`),Jo=({startDate:t,endDate:e,productId:a,categoryId:s,establishmentId:r})=>{const o=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),r&&o.append("establishmentId",r),C(`/api/products/stock-history/report?${o.toString()}`)},kn=Object.freeze(Object.defineProperty({__proto__:null,adjustStock:Wo,createProduct:_o,deleteProduct:gs,getProducts:bt,getStockHistory:wn,getStockReport:Jo,updateProduct:Uo},Symbol.toStringTag,{value:"Module"})),Sn=()=>C("/api/cashier/status").catch(t=>{if(t.message.includes("404")||t.message.includes("não encontrada"))return null;throw t}),$n=t=>{const e={establishmentId:t.establishmentId,initialAmount:Number(t.initialAmount),notes:t.notes||""};return console.log("Payload enviado para abrir caixa:",e),C("/api/cashier/open",{method:"POST",body:JSON.stringify(e)})},En=(t,e)=>{const a={finalAmount:Number(e)};return console.log("Payload enviado para fechar caixa:",a),C(`/api/cashier/close/${t}`,{method:"PUT",body:JSON.stringify(a)})},In=()=>C("/api/cashier/history").then(t=>t||[]).catch(t=>(console.error("Erro ao buscar histórico:",t),[])),Ln=t=>C(`/api/cashier/report/${t}`),fs=t=>C(`/api/packages/${t}`),Cn=t=>C("/api/packages",{method:"POST",body:JSON.stringify(t)}),Dn=(t,e)=>C(`/api/packages/${t}`,{method:"PUT",body:JSON.stringify(e)}),Rs=t=>C(`/api/packages/${t}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",selectedCatalogItem:null,isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,establishmentConfig:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryPanel:!1,filterStartDate:"",filterEndDate:"",filterPreset:"hoje"},Ve=null,Qe=null,Fs=null;function Qo(t,e){return function(...a){clearTimeout(Fs),Fs=setTimeout(()=>t.apply(this,a),e)}}function Ba(t){const e=new Date;let a,s;t==="hoje"?(a=new Date,s=new Date):t==="este_mes"?(a=new Date(e.getFullYear(),e.getMonth(),1),s=new Date(e.getFullYear(),e.getMonth()+1,0)):t==="mes_passado"?(a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0)):(a=new Date,s=new Date);const r=o=>{const i=o.getTimezoneOffset()*6e4;return new Date(o-i).toISOString().split("T")[0]};return{start:r(a),end:r(s)}}async function Hs(t,e="stay"){if(!t||!t.id)return;t._localUpdatedAt=Date.now(),t._cachedItems=null,t._hasUnsavedChanges=!1,Ia(),e==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),te());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,Ea(),xs()}function xs(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function Ea(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierOpen?(t&&(t.innerHTML=""),e&&(e.classList.remove("opacity-50","cursor-not-allowed"),e.disabled=!1)):(t&&(t.innerHTML=`
        ...
        `,s.appendChild(P)}),t.innerHTML="",t.appendChild(s),Os(e)}function Os(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=x.paging,r=Math.ceil((a||0)/s);if(r===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full py-1",o.innerHTML=`
    ...
    `,t.appendChild(o),o.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=r&&(x.paging.page=l,ge())}})}function Mn(t,e){const a=`
    ...
    `;const o=()=>{e.querySelector("#quantity-display").textContent=s,e.querySelector("#quantity-minus-btn").disabled=s<=1};e.querySelector("#quantity-minus-btn").onclick=()=>{s>1&&(s--,o())},e.querySelector("#quantity-plus-btn").onclick=()=>{s++,o()},e.querySelector("#confirm-add-qty-btn").onclick=async()=>{await Yo(a,s),x.viewMode="items",x.selectedCatalogItem=null,te()},o()}function te(){const t=document.getElementById("comanda-detail-container");if(!t)return;const e=x.allComandas.find(g=>String(g.id)===String(x.selectedComandaId));if(x.viewMode==="checkout"&&e){qn(e,t);return}if(x.viewMode==="add-item"&&e){Mn(e,t);return}if(x.viewMode==="add-item-qty"&&e){An(e,t);return}const a=`
    ...
    `,{modalElement:e}=Be({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-xs"});e.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return f("Valor Inválido","Insira um valor válido.","error");try{const r=await $n({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",f("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),Ea(),await ge()}catch(r){f("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function zn(){const t=x.activeCashierSessionId;if(t)try{const e=await Ln(t),a=`
        ...
        `,{modalElement:s}=Be({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return f("Valor Inválido","Insira um valor final válido.","error");try{await En(t,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Ea(),await ge(),f("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){f("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(e){f("Erro",`Falha ao carregar relatório: ${e.message}`,"error")}}async function Vn(t){if(x.activeFilter===t)return;x.activeFilter=t,x.paging.page=1,xs(),Xe(),x.selectedComandaId=null,x.viewMode="items";const e=document.getElementById("comandas-list");e&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>'),await ge()}function Go(t){x.selectedComandaId=String(t),x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",Ia(),Pn(),te()}async function Yo(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;if(!t.id||String(t.id)==="undefined"){f("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(t.price)||0,r=Array(e).fill(0).map(()=>{const o={id:String(t.id),name:t.name,price:s,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0};return t.type==="product"?(o.productId=o.id,o.product_id=o.id):t.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...r),a._cachedItems=null,a._hasUnsavedChanges=!0,te()}async function zs(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>String(o.id)===String(t)&&o.type===e);r>-1&&(a.comandaItems.splice(r,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,te())}async function _n(t){if(x.isProcessing)return;const e=je(t),a=e.reduce((y,k)=>y+Number(k.price||0)*(k.quantity||1),0),s=x.checkoutState.discount||{type:"real",value:0};let r=s.type==="percent"?a*s.value/100:s.value;r>a&&(r=a);const o=a-r,{payments:i}=x.checkoutState,n=i.reduce((y,k)=>y+k.value,0),l=o-n;if(l>.01){if(!await Y("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=t.type==="appointment",u=e;let c=0;const p=x.loyaltySettings;p&&p.enabled&&(c=parseInt(p.pointsPerVisit||1,10));const b={...s,reason:x.checkoutState.discountReason||""},g={payments:i,totalAmount:Number(o),items:u,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:c,discount:b,loyaltyRedemption:x.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center"><div class="loader mb-5"></div><p class="text-sm font-black text-gray-800 uppercase tracking-widest mt-2">Processando...</p></div>',document.body.appendChild(v);try{d?await ti(t.id,g):(g.establishmentId=m.establishmentId,g.clientId=t.clientId,g.clientName=t.clientName,g.professionalId=t.professionalId,t.clientPhone&&(g.clientPhone=t.clientPhone),await zo(g));let y="Venda finalizada com sucesso!";c>0&&(y+=` Cliente ganhou ${c} pontos!`),f("Sucesso!",y,"success"),Xe(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await ge()}catch(y){f("Erro no Checkout",y.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),x.isProcessing=!1}}async function Un(t){t.preventDefault();const e=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=e.value,r=document.getElementById("client-search").value,o=e.dataset.phone||"";if(!s)return f("Erro","Selecione um cliente válido.","error");const i=m.professionals.find(l=>l.id===a);if(!i)return f("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:r.split("(")[0].trim(),clientPhone:o,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(n),x.selectedComandaId=String(n.id),x.viewMode="items",document.getElementById("genericModal").style.display="none",x.activeFilter==="pagas"&&(x.activeFilter="abertas"),xs(),Go(n.id)}async function ge(){const t=document.getElementById("comandas-list");(!t.hasChildNodes()||t.innerHTML.includes("loader"))&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>');let e=x.filterStartDate,a=x.filterEndDate,s;e&&a&&e!==a?s={startDate:e,endDate:a}:s={startDate:e,endDate:a,date:e};try{const r=Sn(),o=xn(m.establishmentId,s,x.paging.page,x.paging.limit),i=qe(m.establishmentId),[n,l,d]=await Promise.all([r,o,i]);if(x.establishmentConfig=d||{},x.isCashierOpen=!!n,x.activeCashierSessionId=n?n.id:null,Ea(),d&&d.loyaltyProgram&&(x.loyaltySettings=d.loyaltyProgram),x.allComandas=l.data||l||[],x.paging.total=l.total||x.allComandas.length,x.catalog.services.length===0){const[u,c,p,b]=await Promise.all([pt(m.establishmentId),bt(m.establishmentId),fs(m.establishmentId),$e(m.establishmentId)]);x.catalog={services:u,products:c,packages:p},m.professionals=b}Ia(),te()}catch(r){f("Erro",`Não foi possível carregar os dados: ${r.message}`,"error")}}async function Wn(t={}){Qe=document.getElementById("content"),x.selectedComandaId=t.selectedAppointmentId?String(t.selectedAppointmentId):null,x.viewMode="items",x.selectedCatalogItem=null;const e=Ba("hoje");if(x.filterStartDate=e.start,x.filterEndDate=e.end,x.filterPreset="hoje",x.showHistoryPanel=!1,Nt(),Ve&&(Qe.removeEventListener("click",Ve),Qe.removeEventListener("change",Ve)),Ve=async a=>{const s=a.target.closest("[data-action], [data-filter], [data-comanda-id]");if(s){if(s.matches("[data-filter]"))a.preventDefault(),Vn(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(a.preventDefault(),a.target.closest('[data-action="go-to-appointment"]')){a.stopPropagation();return}Go(s.dataset.comandaId)}else if(s.matches("[data-action]")){a.preventDefault();const r=s.dataset.action,o=String(s.dataset.id||x.selectedComandaId),i=x.allComandas.find(n=>String(n.id)===o);switch(r){case"toggle-history":if(x.showHistoryPanel=!x.showHistoryPanel,x.showHistoryPanel&&x.activeFilter==="abertas"&&(x.activeFilter="todas"),Nt(),!x.showHistoryPanel){x.filterPreset="hoje";const I=Ba("hoje");x.filterStartDate=I.start,x.filterEndDate=I.end,await ge()}break;case"set-period":const n=s.dataset.period;if(x.filterPreset=n,n!=="custom"){const I=Ba(n);x.filterStartDate=I.start,x.filterEndDate=I.end,Nt(),x.paging.page=1,f("Buscando...",`Período: ${I.start.split("-").reverse().join("/")} a ${I.end.split("-").reverse().join("/")}`,"info"),await ge()}else Nt();break;case"apply-custom-dates":const l=document.getElementById("filter-start-date").value,d=document.getElementById("filter-end-date").value;l&&d?(x.filterStartDate=l,x.filterEndDate=d,x.paging.page=1,f("Buscando...","Período personalizado aplicado.","info"),await ge()):f("Atenção","Preencha a data inicial e final.","warning");break;case"back-to-list":Xe(),x.selectedComandaId=null,x.selectedCatalogItem=null,document.querySelectorAll(".comanda-card").forEach(I=>I.classList.remove("ring-2","ring-indigo-500","bg-indigo-50/50","border-transparent")),document.querySelectorAll(".comanda-card").forEach(I=>I.classList.add("bg-white","border-gray-200")),te();break;case"new-sale":_a();break;case"add-item":if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa primeiro.","error");x.viewMode="add-item",te();break;case"back-to-items":x.viewMode="items",te();break;case"back-to-add-item":x.viewMode="add-item",x.selectedCatalogItem=null,te();break;case"select-catalog-item":const{itemType:u,itemId:c}=s.dataset,b=(x.catalog[u+"s"]||[]).find(I=>String(I.id)===String(c));b&&(x.selectedCatalogItem={...b,type:u},x.viewMode="add-item-qty",te());break;case"open-cashier":On();break;case"close-cashier":await zn();break;case"view-sales-report":se("sales-report-section");break;case"go-to-checkout":await Hs(i,"checkout");break;case"save-comanda":await Hs(i,"stay");break;case"select-method":x.checkoutState.selectedMethod=s.dataset.method,x.checkoutState.installments=1,te();break;case"add-payment-checkout":const g=document.getElementById("checkout-amount");let v=parseFloat(g.value);const k=je(i).reduce((I,D)=>I+(D.price||0),0),P=x.checkoutState.discount||{type:"real",value:0};let T=P.type==="percent"?k*P.value/100:P.value;T>k&&(T=k);const $=k-T,L=x.checkoutState.payments.reduce((I,D)=>I+D.value,0),q=$-L;if(isNaN(v)||v<=0){f("Valor inválido","Insira um valor maior que zero.","error");break}if(v>q+.05){f("Valor inválido","Valor excede o restante.","error");break}const N={method:x.checkoutState.selectedMethod,value:v};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(N.installments=x.checkoutState.installments),x.checkoutState.payments.push(N),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",te();break;case"remove-payment-checkout":const E=parseInt(s.dataset.index,10);x.checkoutState.payments.splice(E,1),te();break;case"finalize-checkout":await _n(i);break;case"increase-qty":{const I=s.dataset.itemId,D=s.dataset.itemType;if(!I||I==="undefined"||I==="null"){f("Erro","Item inválido.","error");return}let O=je(i).find(Z=>String(Z.id)===String(I)&&Z.type===D);O||(O=(x.catalog[D+"s"]||[]).find(K=>String(K.id)===String(I)));const U=O?{id:O.id,name:O.name,price:Number(O.price),type:O.type}:{id:I,name:"Item",price:0,type:D};await Yo(U,1);break}case"decrease-qty":await zs(s.dataset.itemId,s.dataset.itemType);break;case"remove-item":await zs(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await Y("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await ei(o);const D=x.allComandas.findIndex(R=>String(R.id)===o);D!==-1&&(x.allComandas[D].status="confirmed",delete x.allComandas[D].transaction),x.selectedComandaId=null,Xe(),await ge(),f("Sucesso!","Comanda reaberta.","success")}catch(D){f("Erro",D.message,"error")}break}case"go-to-appointment":{se("agenda-section",{scrollToAppointmentId:s.dataset.id,targetDate:new Date(s.dataset.date)});break}case"delete-walk-in":{if(await Y("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))x.allComandas=x.allComandas.filter(D=>String(D.id)!==o),x.selectedComandaId=null,Ia(),te(),Xe();else try{await Vo(o),f("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Xe(),await ge()}catch(D){f("Erro",D.message,"error")}break}}}}},Qe.addEventListener("click",Ve),Qe.addEventListener("change",Ve),t.initialFilter&&(t.initialFilter==="finalizadas"?x.activeFilter="pagas":x.activeFilter="abertas"),t.selectedAppointmentId&&(x.selectedComandaId=String(t.selectedAppointmentId)),t.filterDate){const a=new Date(t.filterDate).toISOString().split("T")[0];x.filterStartDate=a,x.filterEndDate=a,x.filterPreset="custom",x.showHistoryPanel=!0}await ge()}const Ua=new Date,Jn=new Date(Ua.getFullYear(),Ua.getMonth(),1);let M={establishments:[],filterEstablishmentIds:new Set,startDate:Jn.toISOString().split("T")[0],endDate:Ua.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Wa=document.getElementById("content");let Rt=null;function ne(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function De(t){if(!t)return"--/--/----";const e=t.split("T")[0].split("-");return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}function Ce(t){return t?typeof t.toDate=="function"?t.toDate():typeof t=="string"||typeof t=="number"?new Date(t):new Date:new Date(0)}function qt(t){M.charts[t]&&(M.charts[t].destroy(),M.charts[t]=null)}async function Qn(){try{const e=(await ve().catch(()=>({matrizes:[]}))).matrizes||[];M.establishments=[],e.forEach(a=>{M.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>M.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),M.filterEstablishmentIds.size===0&&M.filterEstablishmentIds.add(m.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}Gn(),al(),await ht()}function Gn(){const t=M.establishments.map(e=>`
...
(Clique para ver)`}}}},onClick:(L,q)=>{if(q.length>0){const N=q[0].index,E=q[0].datasetIndex,I=i[N];let D="all";E===0||E===1?D="receita":(E===2||E===3)&&(D="despesa"),Xn(I,D,o[I].items,r)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:L=>ne(Math.abs(L))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:L=>ne(L)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(L=>{L.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",L.onclick=q=>{const N=q.currentTarget,E=parseInt(N.dataset.dataset),I=M.charts.fin;I.isDatasetVisible(E)?(I.hide(E),N.style.opacity="0.4",N.style.background="#f8f9fa"):(I.show(E),N.style.opacity="1",N.style.background="")}}))},100)}function Xn(t,e,a,s){let r=document.getElementById("genericModal");r||(r=document.createElement("div"),r.id="genericModal",r.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(r));const o=e==="all"?a:a.filter(l=>l._type===e);let i=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";r.innerHTML=`
    ...
    `}function vt(){const t=document.getElementById("servicesList");if(!t)return;if(!_.services||_.services.length===0){t.innerHTML=er(8);return}const e=Ko(),a=_.services.filter(s=>{const r=s.name.toLowerCase().includes(_.searchQuery);let o=!0;_.statusFilter==="active"&&(o=s.active!==!1),_.statusFilter==="inactive"&&(o=s.active===!1);const i=_.filterCategoryId==="all"||s.categoryId===_.filterCategoryId,n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],l=e.some(d=>n.includes(d));return r&&o&&i&&l});dl(a),t.innerHTML=cl(a)}function er(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;const e=new Map((_.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=a.active===!1,r=h(a.name),o=h(e.get(a.categoryId)||"Sem Categoria"),i=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,n=JSON.stringify(a).replace(/'/g,"&apos;"),l=a.accessibleIn?a.accessibleIn.length:1,d=_.selectedIds.has(a.id),u=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",c=a.color||"#4f46e5";return`
            <div class="service-card relative bg-white rounded-xl border ${d?"border-indigo-400 ring-1 ring-indigo-200 shadow-md bg-indigo-50/20":"border-gray-200"} shadow-sm flex items-center p-3 cursor-pointer transition-all hover:shadow-md hover:border-indigo-300 ${s?"opacity-60 bg-gray-50":""}" 
                ...
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function bl(){Be({title:"Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",ul),e.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),pl(r.dataset.id))}))}hs()}function ml(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(r=>{const o=t.includes(r.id)||t.length===0&&r.id===m.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}async function gl(t){const e=t.target.closest("#serviceForm"),a=e.querySelector("#serviceId").value,s=e.querySelector('button[type="submit"]'),r={},o=e.querySelector('input[name="commissionType"]:checked').value;o==="custom"&&e.querySelectorAll(".professional-commission-row").forEach(u=>{const c=u.dataset.profId;if(u.querySelector('input[type="checkbox"]').checked){const b=parseFloat(u.querySelector('input[type="number"]').value);r[c]=isNaN(b)?0:b}});const i=Array.from(e.querySelectorAll('input[name="accessibleIn"]:checked')).map(u=>u.value),n=i.length>0?i:[m.establishmentId],l={establishmentId:m.establishmentId,accessibleIn:n,name:e.querySelector("#serviceName").value.trim(),price:parseFloat(e.querySelector("#servicePrice").value),duration:parseInt(e.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(e.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:e.querySelector("#serviceCategory").value||null,color:e.querySelector("#serviceColor").value,targetAudience:e.querySelector("#serviceAudience").value,loyaltyPoints:parseInt(e.querySelector("#serviceLoyaltyPoints").value,10)||0,publicDescription:e.querySelector("#servicePublicDescription").value.trim(),homeService:e.querySelector("#serviceHomeToggle").checked,commissionRate:parseFloat(e.querySelector("#serviceCommissionRate").value)||0,active:e.querySelector("#serviceStatusToggle").checked,photo:e.querySelector("#servicePhotoBase64").value,notes:e.querySelector("#serviceNotes").value,commissionType:o,professionalCommissions:r},d=s.innerHTML;s.disabled=!0,s.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{a?(await tn(a,l),oe(m.establishmentId,rt(),"Serviços","Editou",`Editou o serviço: ${l.name}`),f("Sucesso","Serviço atualizado com sucesso!","success")):(await en(l),oe(m.establishmentId,rt(),"Serviços","Criou",`Criou novo serviço: ${l.name}`),f("Sucesso","Serviço adicionado à rede!","success")),document.getElementById("genericModal").style.display="none",await Ne()}catch(u){f("Erro",u.message,"error"),s.disabled=!1,s.innerHTML=d}}function fl(t=null){const e=document.getElementById("genericModal"),a=_.categories||[],s=t?.duration||0,r=t?.bufferTime||0,o=h(t?.name||""),i=h(t?.notes||""),n=h(t?.publicDescription||""),l=t?.id?o:"Novo Serviço",d=t?.color||"#4f46e5",u=t?.loyaltyPoints||0,c=a.map(D=>`<option value="${D.id}" ${t?.categoryId===D.id?"selected":""}>${h(D.name)}</option>`).join(""),p=t?.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(o?o.charAt(0):"S")}`,b=`
        <div class="modal-content max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh]"> 
            ...
            `}).join(""),P.querySelectorAll('input[type="checkbox"]').forEach(D=>{D.addEventListener("change",R=>{const O=R.target.closest(".professional-commission-row");O.querySelector('input[type="number"]').disabled=!R.target.checked,O.classList.toggle("bg-indigo-50/50",R.target.checked),O.classList.toggle("border-indigo-100",R.target.checked),O.classList.toggle("border-transparent",!R.target.checked)})})),k();const T=e.querySelector("#servicePhotoInput"),$=e.querySelector("#servicePhotoButton"),L=e.querySelector("#servicePhotoContainer"),q=e.querySelector("#servicePhotoPreview"),N=e.querySelector("#servicePhotoBase64"),E=()=>T.click();$&&$.addEventListener("click",E),L&&L.addEventListener("click",E),T.onchange=async()=>{const D=T.files[0];if(D){q.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const R=await xa(D,800,800,.8);if(R.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");q.src=R,N.value=R}catch(R){f("Erro de Imagem",R.message,"error"),q.src=p,N.value=t?.photo||""}}};const I=e.querySelector("#serviceForm");e.onclick=async D=>{const R=D.target.closest("button[data-action]");if(!R)return;const O=R.dataset.action,U=R.dataset.id;if(O==="close-modal"&&(e.style.display="none"),O==="save-service"&&I.reportValidity()&&gl({target:I}),O==="delete-service"){if(!U)return;if(await Y("Apagar Serviço","Tem certeza que deseja excluir este serviço da rede?"))try{const K=_.services.find(ye=>ye.id===U)?.name||"Desconhecido";await jo(U),oe(m.establishmentId,rt(),"Serviços","Excluiu",`Excluiu o serviço: ${K}`),f("Sucesso","Serviço apagado da rede.","success"),e.style.display="none",await Ne()}catch(K){f("Erro",`Não foi possível apagar o serviço: ${K.message}`,"error")}}}}function xl(){Y("Excluir em Lote",`Tem certeza que deseja excluir ${_.selectedIds.size} serviços da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{const e=Array.from(_.selectedIds).map(a=>jo(a));await Promise.all(e),oe(m.establishmentId,rt(),"Serviços","Excluiu em Lote",`Excluiu ${_.selectedIds.size} serviços`),f("Sucesso",`${_.selectedIds.size} serviços foram excluídos.`,"success"),_.selectedIds.clear(),Ya(),Ne()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}const Ca="suppliers",Mt=async t=>{try{const e=go(fa(me,Ca),fo("establishmentId","==",t)),a=await Hr(e),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},hl=async t=>{try{return{id:(await mo(fa(me,Ca),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},vl=async(t,e)=>{try{const a=Ae(me,Ca,t);return await Bt(a,e),{id:t,...e}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},yl=async t=>{try{const e=Ae(me,Ca,t);return await Or(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},yt=document.getElementById("content");let A={products:[],categories:[],suppliers:[],hierarchyCache:[],currentTab:"catalogo",stockFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set},Ht=null;function Oe(){const t=he.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function vs(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}function Ma(t){return t?t._seconds?new Date(t._seconds*1e3):t.seconds?new Date(t.seconds*1e3):new Date(t):new Date}async function wl(){A.selectedIds.clear(),A.currentTab="catalogo";try{const t=await ve();A.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}ys(),Sl(),await Te()}function ys(){yt.innerHTML=`
        <section class="h-full flex flex-col p-2 md:p-4 md:pl-6 w-full relative">
    ...
    `,kl()}function kl(){const t=document.getElementById("main-tab-content");if(t){if(A.currentTab==="catalogo")t.innerHTML=`
        ...
        `,tr(),Ze();else if(A.currentTab==="movimentacoes"){const e=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0],r=(A.products||[]).map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join(""),o=(A.categories||[]).map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join("");t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",Za),Za()}}}function Sl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Te),t.addEventListener("click",()=>{setTimeout(Te,100)})),Ht&&yt.removeEventListener("click",Ht),Ht=e=>{const a=e.target.closest("[data-main-tab]");if(a){A.currentTab=a.dataset.mainTab,ys();return}if(e.target.classList.contains("status-filter-btn")){const d=e.target.dataset.status;A.stockFilter=d,document.querySelectorAll(".status-filter-btn").forEach(u=>{u.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-green-50","text-green-700","border-green-200","bg-orange-50","text-orange-700","border-orange-200","bg-red-50","text-red-700","border-red-200"),u.classList.add("bg-white","text-gray-600","border-gray-200")}),d==="ok"?e.target.classList.add("bg-green-50","text-green-700","border-green-200"):d==="alert"?e.target.classList.add("bg-orange-50","text-orange-700","border-orange-200"):d==="empty"?e.target.classList.add("bg-red-50","text-red-700","border-red-200"):e.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),e.target.classList.remove("bg-white","text-gray-600","border-gray-200"),Ze();return}const s=e.target.closest('[data-action="open-product-modal"]');if(s){e.preventDefault();let d={};if(s.dataset.product)try{d=JSON.parse(s.dataset.product)}catch{}Tl(d);return}if(e.target.closest('[data-action="manage-categories"]')){e.preventDefault(),Cl();return}if(e.target.closest('[data-action="open-new-movement-modal"]')){e.preventDefault(),sr();return}const i=e.target.closest(".product-checkbox");if(i){const d=i.dataset.id;i.checked?A.selectedIds.add(d):A.selectedIds.delete(d),Xa(),e.stopPropagation();return}if(e.target.closest("#cancel-selection-btn")){A.selectedIds.clear(),document.querySelectorAll(".product-checkbox").forEach(d=>d.checked=!1),Xa();return}if(e.target.closest("#batch-delete-btn")){Bl();return}},yt.addEventListener("click",Ht),yt.addEventListener("input",e=>{e.target.id==="searchInput"&&(A.searchQuery=e.target.value.toLowerCase(),Ze())}),yt.addEventListener("click",e=>{const a=e.target.closest("#toggle-filter-btn");if(a){const o=document.getElementById("filter-panel");A.isAdvancedFilterOpen=!A.isAdvancedFilterOpen,A.isAdvancedFilterOpen?(o.classList.remove("hidden"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-gray-600","border-gray-200"))}e.target.closest("#clear-filters-btn")&&(A.filterCategoryId="all",document.getElementById("filterCategoryId").value="all",Ze()),e.target.closest("#apply-filter-btn")&&(A.filterCategoryId=document.getElementById("filterCategoryId").value,document.getElementById("toggle-filter-btn").click(),Ze())})}async function Te(){const t=vs();try{const e=t.map(n=>bt(n)),a=t.map(n=>La(n,"products")),[s,r]=await Promise.all([Promise.all(e),Promise.all(a)]),o=new Map;s.flat().filter(Boolean).forEach(n=>o.set(n.id,n)),A.products=Array.from(o.values()),m.products=A.products;const i=new Map;r.flat().filter(Boolean).forEach(n=>i.set(n.id,n)),A.categories=Array.from(i.values()),m.categories=A.categories,A.currentTab==="catalogo"?(tr(),Ze()):A.currentTab==="movimentacoes"&&Za(),A.suppliers=[],t.forEach(async n=>{try{let l=[];typeof Mt=="function"&&(l=await Mt(n)),l.forEach(d=>{A.suppliers.find(u=>u.id===d.id)||A.suppliers.push(d)}),m.suppliers=A.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function tr(){const t=document.getElementById("filterCategoryId");t&&A.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',A.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),A.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function Xa(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=A.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function $l(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,r=0,o=0;t.forEach(i=>{const n=i.currentStock||0,l=i.minStock||0;n<=0?o++:l>0&&n<=l||l>0&&n<=l*1.2?r++:s++}),e.innerHTML=`
        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
    ...
    `}function Ze(){const t=document.getElementById("productsList");if(!t)return;if(!A.products||A.products.length===0){t.innerHTML=ar(8);return}const e=vs(),a=A.products.filter(s=>{const r=s.name.toLowerCase().includes(A.searchQuery),o=s.currentStock||0,i=s.minStock||0;let n=!0;A.stockFilter==="ok"&&(n=o>0&&(i===0||o>i*1.2)),A.stockFilter==="alert"&&(n=i>0&&o>0&&o<=i*1.2),A.stockFilter==="empty"&&(n=o<=0);const l=A.filterCategoryId==="all"||s.categoryId===A.filterCategoryId,d=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],u=e.some(c=>d.includes(c));return r&&n&&l&&u});$l(a),t.innerHTML=El(a)}function ar(t=8){let e="";for(let a=0;a<t;a++)e+=`
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm flex items-center p-3 animate-pulse h-[74px]">
        ...
        `;const e=new Map((A.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=h(a.name),r=h(e.get(a.categoryId)||"Sem Categoria"),o=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,i=JSON.stringify(a).replace(/'/g,"&apos;"),n=a.accessibleIn?a.accessibleIn.length:1,l=A.selectedIds.has(a.id),d=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",u=a.currentStock||0,c=a.minStock||0;let p="bg-emerald-500",b=!1;return u<=0?(p="bg-red-500",b=!0):c>0&&u<=c*1.2&&(p="bg-orange-500"),`
            ...
            </div>`}).join("")}async function Il(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const r=e.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="...";try{const o=A.hierarchyCache.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);o.length===0&&o.push(m.establishmentId),await Xo({establishmentId:m.establishmentId,name:s,accessibleIn:o},"products"),oe(m.establishmentId,Oe(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await ws(),await Te()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{r.disabled=!1,r.textContent="Adicionar"}}async function Ll(t){if(await Y("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Zo(t,"products"),oe(m.establishmentId,Oe(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await ws(),await Te()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function ws(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await La(m.establishmentId,"products");A.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded mb-1">
                    <span class="text-sm font-medium text-gray-700">${h(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-xs bg-red-50 px-2 py-1 rounded">Apagar</button>
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function Cl(){Be({title:"Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4 bg-indigo-50 p-4 rounded-xl border border-indigo-100">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Il),e.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),Ll(r.dataset.id))}))}ws()}function sr(){const t=(A.products||[]).map(o=>`<option value="${o.id}">${h(o.name)} (Estoque: ${o.currentStock||0})</option>`).join(""),a=`
    ...
    `}function ql(){const t=Object.entries(la).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=or.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function jl(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(la).map(([i,n])=>`<option value="${i}" ${a===i?"selected":""}>${n.label}</option>`).join(""),r=or.map(i=>`<option value="${i}" ${t?.state===i?"selected":""}>${i}</option>`).join(""),o=document.getElementById("form-container-wrapper");o&&(o.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Rl))}function rr(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
    ...
    `}async function da(){const t=document.getElementById("professionalsList"),e=nr();try{const a=e.map(l=>$e(l)),s=e.map(l=>pt(l)),r=await Promise.all(a),o=await Promise.all(s),i=new Map;r.flat().forEach(l=>i.set(l.id,l)),V.professionals=Array.from(i.values()),m.professionals=V.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),V.services=Array.from(n.values()),dr(),Ge()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function dr(){const t=document.getElementById("filterServiceId");t&&V.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',V.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),V.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function cr(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=V.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Vl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,r=a-s;e.innerHTML=`
    ...
    `}function Ge(){const t=document.getElementById("professionalsList");if(!t)return;if(!V.professionals||V.professionals.length===0){t.innerHTML=ur(8);return}const e=nr(),a=V.professionals.filter(s=>{const r=s.name.toLowerCase().includes(V.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(V.searchQuery);let o=!0;V.statusFilter==="active"&&(o=s.status!=="inactive"),V.statusFilter==="inactive"&&(o=s.status==="inactive");const i=V.filterServiceId==="all"||s.services&&s.services.includes(V.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],l=e.some(d=>n.includes(d));return r&&o&&i&&l});if(Vl(a),a.length===0){t.innerHTML=`
    ...
    `,Ul(a,V.services),Jl(a),await Gl(a,V.professionals),Yl(a),Ol()}function Ul(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const r=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,b=p==r[1]?"selected":"",g=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${g.charAt(0).toUpperCase()+g.slice(1)}</option>`}).join(""),i=h(t.name||""),n=h(t.specialty||""),l=h(t.phone||""),d=h(t.notes||"");a.innerHTML=`
    ...
    `}function Wl(t=[]){if(!V.hierarchyCache||V.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
        ...
        <div class="max-w-4xl mx-auto bg-white p-4 md:p-6 rounded-2xl border border-slate-200 shadow-sm">
        ...
        </div>`,Ql(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function Ql(t,e){t.innerHTML=Object.keys(Vs).map(a=>{const s=e[a]||{},r=s.active!==!1;return`
            <div class="day-schedule-card p-3 md:p-4 rounded-xl ${r?"bg-white border-slate-200 shadow-sm":"bg-slate-50 border-slate-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-3">
                    <span class="font-black text-sm text-slate-800 uppercase tracking-wider">${Vs[a]}</span>
            ...
            </div>`}).join(""),t.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",s=>{const r=s.target.closest(".day-schedule-card"),o=!s.target.checked;r.classList.toggle("bg-white",!o),r.classList.toggle("shadow-sm",!o),r.classList.toggle("border-slate-200",!o),r.classList.toggle("bg-slate-50",o),r.classList.toggle("border-slate-100",o),r.classList.toggle("opacity-60",o),r.classList.toggle("disabled",o),r.querySelectorAll(".time-inputs input").forEach(i=>i.disabled=o)})})}async function Gl(t,e){const a=document.getElementById("bloqueios");if(!a)return;a.innerHTML=`
    ...
    `}async function ks(){w.loading=!0;const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-xs">Carregando clientes...</p></div>');try{const a=Array.from(w.filterEstablishmentIds).map(i=>{let n=`/api/clients/${i}?limit=1000`;return C(n).catch(()=>[])}),r=(await Promise.all(a)).flat(),o=new Map;r.forEach(i=>o.set(i.id,i)),w.clients=Array.from(o.values()),Ss(),ke()}catch(e){console.error(e),f("Erro","Falha ao carregar clientes.","error"),t&&(t.innerHTML='<div class="text-center py-10 text-red-500 text-sm">Erro ao carregar dados.</div>')}finally{w.loading=!1}}function Ss(){const t=new Date().getMonth()+1,e=new Date().getFullYear();let a=0,s=0,r=0;w.clients.forEach(o=>{if(o.totalDebt&&parseFloat(o.totalDebt)>0&&s++,o.dobMonth==t&&r++,o.createdAt){const i=new Date(o.createdAt);i.getMonth()+1===t&&i.getFullYear()===e&&a++}}),document.getElementById("kpi-total").textContent=w.clients.length,document.getElementById("kpi-novos").textContent=a,document.getElementById("kpi-devendo").textContent=s,document.getElementById("kpi-niver").textContent=r}function ke(){td();const t=document.getElementById("list-container");let e=w.clients;if(w.filters.search){const a=w.filters.search.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(w.filters.status==="devendo")e=e.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(w.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;e=e.filter(s=>s.dobMonth==a)}else if(w.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();e=e.filter(r=>{if(!r.createdAt)return!1;const o=new Date(r.createdAt);return o.getMonth()+1===a&&o.getFullYear()===s})}if(w.filters.hasLoyalty&&(e=e.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),w.filters.inactiveDays){const a=parseInt(w.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),e=e.filter(r=>{if(!r.lastVisit&&!r.createdAt)return!1;let o;if(r.lastVisit){const i=r.lastVisit.seconds||r.lastVisit._seconds;o=i?new Date(i*1e3):new Date(r.lastVisit)}else o=new Date(r.createdAt);return o<s})}if(e.sort((a,s)=>{let r,o;switch(w.sortConfig.key){case"name":return r=(a.name||"").toLowerCase(),o=(s.name||"").toLowerCase(),w.sortConfig.direction==="asc"?r.localeCompare(o):o.localeCompare(r);case"contact":return r=a.phone||"",o=s.phone||"",w.sortConfig.direction==="asc"?r.localeCompare(o):o.localeCompare(r);case"lastVisit":r=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,o=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":r=parseFloat(a.totalDebt)||0,o=parseFloat(s.totalDebt)||0;break;default:r=a.name,o=s.name}return r<o?w.sortConfig.direction==="asc"?-1:1:r>o?w.sortConfig.direction==="asc"?1:-1:0}),e.length===0){t.innerHTML=`
            ...
            </div>`;return}t.innerHTML=e.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,r=es(a.lastVisit),o=pr(a.phone),i=new Date().getMonth()+1,n=a.dobMonth==i,l=w.selectedIds.has(a.id);let d="";return n&&(d+='<span class="bg-indigo-50 text-indigo-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-indigo-100 uppercase tracking-wider">🎂 Niver</span> '),a.loyaltyPoints>0&&(d+=`<span class="bg-amber-50 text-amber-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-amber-100 uppercase tracking-wider"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
        ...
        `}).join("")}function ad(){_t&&ca.removeEventListener("click",_t),_t=o=>{const i=o.target;if(i.classList.contains("item-checkbox")){const u=i.value;i.checked?w.selectedIds.add(u):w.selectedIds.delete(u),ta(),o.stopPropagation();return}if(i.id==="select-all-toggle"){const u=i.checked,c=document.querySelectorAll(".item-checkbox");w.selectedIds.clear(),c.forEach(p=>{p.checked=u,u&&w.selectedIds.add(p.value)}),ta(),o.stopPropagation();return}const n=i.closest("[data-sort]");if(n){const u=n.dataset.sort;w.sortConfig.key===u?w.sortConfig.direction=w.sortConfig.direction==="asc"?"desc":"asc":(w.sortConfig.key=u,w.sortConfig.direction="asc"),ke();return}const l=i.closest("[data-action]");if(l){const u=l.dataset.action,c=l.dataset.id;if(u==="new-client"){as(null);return}if(u==="open-modal"){as(c);return}if(u==="whatsapp"){o.stopPropagation();const p=l.dataset.phone;window.open(`https://wa.me/55${p}`,"_blank");return}if(u==="export-excel"){pd();return}}const d=i.closest("[data-filter]");d&&(document.querySelectorAll("[data-filter]").forEach(u=>u.classList.remove("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300")),d.classList.add("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300"),w.filters.status=d.dataset.filter,ke())},ca.addEventListener("click",_t);const t=document.getElementById("cancel-selection-btn");t&&t.addEventListener("click",()=>{w.selectedIds.clear();const o=document.getElementById("select-all-toggle");o&&(o.checked=!1),document.querySelectorAll(".item-checkbox").forEach(i=>i.checked=!1),ta()});const e=document.getElementById("batch-delete-btn");e&&e.addEventListener("click",sd),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",i=>{const n=i.target.closest("label");i.target.checked?(w.filterEstablishmentIds.add(i.target.value),n.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.remove("border-gray-200","text-gray-600")):(w.filterEstablishmentIds.delete(i.target.value),n.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.add("border-gray-200","text-gray-600")),ks()})});const a=document.getElementById("search-input");a&&a.addEventListener("input",o=>{w.filters.search=o.target.value,ke()});const s=document.getElementById("filter-inactive");s&&s.addEventListener("input",o=>{w.filters.inactiveDays=o.target.value,ke()});const r=document.getElementById("filter-loyalty");r&&r.addEventListener("change",o=>{w.filters.hasLoyalty=o.target.checked,ke()})}function ta(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count");if(!t||!e)return;const a=w.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}async function sd(){const t=w.selectedIds.size;if(!(t===0||!await Y("Excluir Clientes",`Deseja realmente excluir permanentemente ${t} cliente(s)? Esta ação não pode ser desfeita.`)))try{const a=Array.from(w.selectedIds).map(r=>Lo(r));await Promise.all(a),f("Sucesso",`${t} cliente(s) excluído(s) com sucesso.`,"success"),w.selectedIds.clear(),ta();const s=document.getElementById("select-all-toggle");s&&(s.checked=!1),await ks()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns clientes.","error")}}function as(t=null){t?(w.selectedClient=w.clients.find(s=>s.id===t),w.selectedClient.isNew=!1):w.selectedClient={isNew:!0,id:"",name:"",phone:"",email:"",cpf:"",gender:"",dobDay:"",dobMonth:"",source:"",notes:"",loyaltyPoints:0,totalDebt:0},w.activeTab="profile",w.historyData={appointments:[],sales:[],loyaltyLog:[]};let e=document.getElementById("client-details-modal-overlay");e||(e=document.createElement("div"),e.id="client-details-modal-overlay",e.className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-gray-900/60 backdrop-blur-sm sm:p-4 animate-fade-in",e.innerHTML='<div class="bg-gray-50 w-full sm:w-[90vw] h-[90vh] sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col relative animate-slide-up sm:animate-scale-in rounded-t-2xl" id="client-modal-content"></div>',e.onclick=s=>{s.target===e&&Et()},document.body.appendChild(e),document.body.classList.add("overflow-hidden"));const a=e.querySelector("#client-modal-content");a.innerHTML=it(w.selectedClient),nt(a,w.selectedClient)}function Et(){const t=document.getElementById("client-details-modal-overlay");t&&t.remove(),document.body.classList.remove("overflow-hidden"),w.modalOpen=!1,w.selectedClient=null,ke()}function it(t){const e=t.isNew,a=`
            ...
            <div class="bg-indigo-600 px-4 py-4 sm:px-6 sm:py-5 text-white relative flex-shrink-0 w-full shadow-md z-20">
                ...
                <div class="flex items-center gap-4 sm:gap-5">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white text-indigo-600 flex items-center justify-center text-2xl font-black shadow-lg flex-shrink-0">
                        ${e?'<i class="bi bi-person-plus-fill"></i>':ts(t.name)}
                    </div>
    ...
    `}function id(t){let e=w.historyData.sales||[];e.sort((r,o)=>new Date(o.date)-new Date(r.date));const a=e.reduce((r,o)=>r+(Number(o.totalAmount)||0),0),s=e.length>0?a/e.length:0;return`
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-3 mb-2">
                <div class="bg-emerald-50 p-3 rounded-xl border border-emerald-100 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-emerald-700 mt-0.5">${Da(a)}</span>
                </div>
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-gray-800 mt-0.5">${Da(s)}</span>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-3 flex justify-between items-center shadow-sm hover:bg-gray-50 cursor-pointer transition-colors" data-go-comanda="true" data-id="${r.id}">
                    ...
                    <div class="text-right">
                        <p class="font-black text-emerald-600 text-xs">${Da(r.totalAmount)}</p>
    ...
    `}function nt(t,e){if(t.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const r=s.dataset.tab;if(w.activeTab===r)return;w.activeTab=r;const o=document.getElementById("client-modal-content");o&&(o.innerHTML=it(e),nt(o,e)),r!=="profile"&&!w.historyLoading&&w.historyData.appointments.length===0&&await ld(e.id)}}),w.activeTab==="profile"){const s=t.querySelector("#form-edit-client");s&&(s.onsubmit=dd);const r=t.querySelector("#btn-delete-client");r&&(r.onclick=cd)}if(w.activeTab==="loyalty"){const s=t.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>ud(e))}t.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=()=>{Et(),se("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),t.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=()=>{Et(),se("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const a=t.querySelector("#btn-close-modal");a&&(a.onclick=Et)}async function ld(t){const e=w.selectedClient;if(!e||!e.phone)return;w.historyLoading=!0;const a=document.getElementById("client-modal-content");a&&(a.innerHTML=it(e),nt(a,e));try{const s=new Date;s.setMonth(s.getMonth()+12);const r=new Date;r.setFullYear(r.getFullYear()-5);let o=`/api/appointments/${m.establishmentId}?startDate=${r.toISOString()}&endDate=${s.toISOString()}&clientPhone=${encodeURIComponent(pr(e.phone))}&limit=50`;const i=await C(o);w.historyData.appointments=i,w.historyData.sales=i.filter(l=>l.status==="completed").map(l=>({id:l.id,date:l.startTime,totalAmount:l.totalAmount||0,items:l.comandaItems||l.services||[]}));const n=[];i.forEach(l=>{l.status==="completed"&&l.loyaltyPointsEarned>0&&n.push({type:"earn",points:l.loyaltyPointsEarned,date:l.startTime,description:"Venda finalizada"}),l.loyaltyRedemption&&n.push({type:"redemption",points:l.loyaltyRedemption.cost||0,date:l.startTime,description:`Resgate: ${l.loyaltyRedemption.name}`})}),w.historyData.loyaltyLog=n}catch(s){console.error("Erro histórico",s)}finally{w.historyLoading=!1;const s=document.getElementById("client-modal-content");s&&w.selectedClient&&(s.innerHTML=it(w.selectedClient),nt(s,w.selectedClient))}}async function dd(t){t.preventDefault();const e=new FormData(t.target),a=Object.fromEntries(e.entries());a.establishmentId=m.establishmentId,a.dobDay&&(a.dobDay=parseInt(a.dobDay)),a.dobMonth&&(a.dobMonth=parseInt(a.dobMonth));try{if(w.selectedClient.isNew){const s=await Eo(a);w.clients.unshift(s),f("Sucesso","Cliente cadastrado com sucesso!","success"),w.selectedClient=s,as(s.id)}else{await Io(w.selectedClient.id,a),Object.assign(w.selectedClient,a);const s=w.clients.findIndex(o=>o.id===w.selectedClient.id);s!==-1&&(w.clients[s]=w.selectedClient),f("Sucesso","Dados salvos com sucesso!","success");const r=document.getElementById("client-modal-content");r&&(r.innerHTML=it(w.selectedClient),nt(r,w.selectedClient))}Ss(),ke()}catch(s){f("Erro",s.message,"error")}}async function cd(){if(await Y("Excluir Cliente","Tem certeza? O histórico será apagado e não pode ser desfeito."))try{await Lo(w.selectedClient.id),w.clients=w.clients.filter(t=>t.id!==w.selectedClient.id),w.selectedClient=null,f("Sucesso","Cliente removido com sucesso.","success"),Et(),Ss(),ke()}catch(t){f("Erro",t.message,"error")}}function ud(t){const e=t.loyaltyPoints||0,a=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const u={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,cnpj:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};mt(u,d)})}function md(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([ya(ae),cs(ae)]),r=t.financialIntegration||{},o=t.commissionConfig||{},i=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=_e(a,r.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=_e(s,r.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=_e(a,i.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=_e(s,i.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=_e(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=_e(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};mt(s,a)})}function wd(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `}function Sd(t,e){const a=e.querySelector("#slotIntervalContainer"),s=e.querySelector("#establishmentSlotInterval");if(!a||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(o=>{const i=o.value===t;return`<button type="button" data-value="${o.value}" 
    ...
    `,He.querySelector('button[data-action="back-to-menu"]').addEventListener("click",r=>{r.preventDefault(),gr({id:ae})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":bd(X,s);break;case"change-password":md(X,s);break;case"change-email":gd(X,s);break;case"branding":fd(X,s);break;case"booking":xd(X,s);break;case"working-hours":hd(X,s);break;case"whatsapp-bot":mr(X,s);break;case"loyalty":await vd(X,s);break;case"financial":await yd(X,s);break;case"support":wd(X,s);break;case"cancellation":kd(X,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function gr(t={}){He.innerHTML=`
    ...
    `;try{ae=t.id||m.establishmentId,X=await qe(ae);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
               ...
               </button>`:"",a=X.isMatriz||!X.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=br();He.innerHTML=`
        ...
        `,He.querySelectorAll("div[data-section]").forEach(r=>{r.addEventListener("click",o=>{$d(r.dataset.section)})}),He.querySelectorAll(".module-toggle").forEach(r=>{r.addEventListener("change",async()=>{const o=r.dataset.module;try{const n={...(await qe(ae)).modules,[o]:r.checked};await ls(ae,{modules:n}),f("Módulos","Módulos atualizados com sucesso.","success")}catch(i){r.checked=!r.checked,f("Erro",i.message,"error")}})})}catch(e){He.innerHTML=`
    ...
    `).join("")}const It=document.getElementById("content");async function tt(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await ka(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),i=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,n=i.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",i.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;u.innerHTML+=T}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Id(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,r=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,i=e.querySelector("#blockageEndTime").value,n={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${i}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Sa(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),tt(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Ld(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,r=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,i=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:m.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${i}:00`).toISOString(),reason:n};return Sa(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&tt(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Cd(t){It.addEventListener("submit",e=>{e.target.id==="blockageForm"&&Id(e),e.target.id==="batchBlockageForm"&&Ld(e)}),It.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&tt(t)}),It.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")se("profissionais-section");else if(s==="delete-blockage"){if(await Y("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await ps(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),tt(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await Y("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await No(r),f("Sucesso",`${r.length} bloqueios removidos.`,"success"),tt(t)}catch(i){f("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function Dd(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){It.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=h(a);It.innerHTML=`
        <section>
        ...
        </section>`,Cd(e),await tt(e);const r=document.getElementById("batchProfSelectionContainer");try{const o=await $e(m.establishmentId);r.innerHTML=o.map(i=>`
            <div class="flex items-center">
        ...
        `}).join("")}function xr(){const e=document.getElementById("showInactiveUsersToggle")?.checked?m.users:m.users.filter(a=>a.status==="active");Rd(e)}function Fd(t={}){let e="",a=!1;for(const[s,r]of Object.entries(jd)){const o=Object.entries(r).filter(([i,n])=>{const l=i.replace("-section","");return!(m.enabledModules&&m.enabledModules[l]===!1)});o.length!==0&&(a=!0,e+=`
        ...
        `,o.forEach(([i,n])=>{const l=i==="agenda-section"||i==="comandas-section",d=t[i]?.view_all_prof===!0,u=Object.entries(Nd).map(([p,b])=>`
        ...
        `}),r+="</div>",r}async function Js(t=null){document.getElementById("user-list-view").classList.add("hidden");const e=document.getElementById("user-form-view");e.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{const p=fr().map(v=>$e(v)),b=await Promise.all(p),g=new Map;b.flat().forEach(v=>g.set(v.id,v)),a=Array.from(g.values()),m.professionals=a}catch(c){console.warn("Profissionais não carregados",c)}if(["owner","group_admin","company_admin"].includes(m.userRole)&&!at)try{const c=await ve();c&&(at=c)}catch(c){console.error("Falha ao buscar hierarquia",c),at={companies:[],branches:[]}}const s=t!==null,r=s&&t.role==="owner",o=e.querySelector("#userFormTitle");o.innerHTML=s?`<i class="bi bi-person-lines-fill mr-2 text-indigo-600"></i>Editar Perfil: ${t.name}`:'<i class="bi bi-person-plus-fill mr-2 text-indigo-600"></i>Novo Acesso';const i=e.querySelector("#userForm");i.innerHTML=`
    ...
    `,e.style.display="flex"}function Vd(t){const{summary:e,transactions:a}=t;document.getElementById("summary-revenue").textContent=`R$ ${e.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=e.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${e.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),r=Object.entries(e.paymentMethodTotals).sort(([,n],[,l])=>l-n);s.innerHTML=r.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=ss.transactions[l];d&&Ys(d)})}),i.innerHTML=a.map((n,l)=>{const d=h(n.client),u=h(n.items),c=h(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ss.transactions[l];d&&Ys(d)})})}async function Xs(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,r=a.value;if(!s||!r)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,i=await ra({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:o});ss=i,t.innerHTML=`
        ...
        `,Vd(i)}catch(o){f("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${h(o.message)}</p>`}}async function _d(){Od();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];Hd.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Xs),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${r}`;zd(o,"transactionsTable")});try{const s=await In(m.establishmentId),r=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const i=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=h(o.closedByName||"N/A");r.innerHTML+=`<option value="${o.id}">${n} - ${i}</option>`})}catch{f("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Xs()}const Ud=document.getElementById("content");let S={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],suppliers:[],clients:[],professionals:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Jt=null,Qt=null;function $s(t){const e=new Map,a=[];return t&&(t.forEach(s=>e.set(s.id,{...s,children:[]})),e.forEach(s=>{s.parentId&&e.has(s.parentId)?e.get(s.parentId).children.push(s):a.push(s)})),a}function hr(t){if(!t)return{day:"--",month:"---",full:"--/--/----"};const[e,a,s]=t.split("-"),r=new Date(e,a-1,s),o=String(r.getDate()).padStart(2,"0"),i=r.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:o,month:i,full:r.toLocaleDateString("pt-BR")}}function xe(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t)}function lt(t,e){if(e==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,r,o]=t.split("-");return new Date(s,r-1,o)<a}function Wd(t,e,a){if(!t)return;if(!e||e.length===0){t.innerHTML=`
    ...
    `,wr()}function Qd(){const t=S.currentTab==="receivables",e=t?S.receivables:S.payables;let a=e;if(S.statusFilter!=="all"&&(a=e.filter(n=>{const l=lt(n.dueDate,n.status);return S.statusFilter==="overdue"?l:S.statusFilter==="pending"?n.status==="pending"&&!l:n.status===S.statusFilter})),S.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(S.searchQuery)||n.entity&&n.entity.toLowerCase().includes(S.searchQuery)||n.notes&&n.notes.toLowerCase().includes(S.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map(S.natures.map(n=>[n.id,n.name])),r=new Map(S.costCenters.map(n=>[n.id,n.name])),o=new Map(S.establishments.map(n=>[n.id,n])),i=a.map(n=>{const l=n.status==="paid",d=lt(n.dueDate,n.status);let u=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const c=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?r.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=o.get(n.establishmentId),g=b?b.name:"Atual",v=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:g,Natureza:c,"Centro de Custo":p,Origem:v,"Documento / NFS":n.documentNumber||"",Status:u,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(i),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const u=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,u)}catch(n){console.error("Erro ao exportar:",n),f("Erro","Não foi possível exportar para Excel.","error")}}function Gd(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i.bi-chevron-expand, i.bi-chevron-up, i.bi-chevron-down");if(!e)return;t.dataset.sort===S.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=S.sortAsc?"bi bi-chevron-up ml-1 text-indigo-600 text-[11px] font-black":"bi bi-chevron-down ml-1 text-indigo-600 text-[11px] font-black"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-chevron-expand ml-1 opacity-40 text-[10px] font-black")})}function yr(){document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",i=>{const n=i.currentTarget.dataset.sort;S.sortCol===n?S.sortAsc=!S.sortAsc:(S.sortCol=n,S.sortAsc=!0),Lt()})});const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const i=o.target.checked,n=document.querySelectorAll(".item-checkbox");S.selectedIds.clear(),n.forEach(l=>{l.checked=i,i&&S.selectedIds.add(l.value)}),Ke()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{S.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Ke()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=S.selectedIds.size;if(o===0)return;if(await Y("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const n=S.currentTab==="payables"?"payables":"receivables";await Bo(n,Array.from(S.selectedIds)),f("Sucesso",`${o} itens excluídos.`,"success"),S.selectedIds.clear(),Ke(),Pe()}catch{f("Erro","Falha ao excluir itens.","error")}}),document.getElementById("custom-date-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),i=document.getElementById("custom-date-btn");S.isAdvancedFilterOpen=!S.isAdvancedFilterOpen,S.isAdvancedFilterOpen?(o.classList.remove("hidden"),i.classList.add("bg-gray-900","text-white","border-gray-900"),i.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),i.classList.remove("bg-gray-900","text-white","border-gray-900"),i.classList.add("bg-white","text-gray-600","border-gray-200"))});const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",Qd);const a=document.getElementById("settings-btn");a&&a.addEventListener("click",Zd),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(20),eo(i.target.closest("button").dataset.type)})});const s=document.getElementById("tab-receivables"),r=document.getElementById("tab-payables");s.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),Ks("receivables")}),r.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),Ks("payables")}),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-gray-900","bg-blue-600","bg-emerald-600","bg-red-600","text-white"),l.classList.add("bg-white","text-gray-600")});const n=i.target.dataset.status;n==="all"?i.target.classList.add("bg-gray-900","text-white"):n==="pending"?i.target.classList.add("bg-blue-600","text-white"):n==="paid"?i.target.classList.add("bg-emerald-600","text-white"):n==="overdue"&&i.target.classList.add("bg-red-600","text-white"),i.target.classList.remove("bg-white","text-gray-600"),S.statusFilter=n,Lt()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=i.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=u.toISOString().split("T")[0],S.startDate=d.toISOString().split("T")[0],S.endDate=u.toISOString().split("T")[0],Pe()})}),document.getElementById("searchInput").addEventListener("input",o=>{S.searchQuery=o.target.value.toLowerCase(),Lt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",vr(),yr(),Pe()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(20),S.startDate=document.getElementById("filterStartDate").value,S.endDate=document.getElementById("filterEndDate").value,S.filterNaturezaId=document.getElementById("filterNaturezaId").value,S.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("custom-date-btn").click(),Pe()}),Jt&&document.body.removeEventListener("click",Jt),Jt=o=>{const i=o.target;if(i.classList.contains("item-checkbox")||i.classList.contains("modal-item-checkbox")){const d=i.value||i.dataset.id;i.checked?S.selectedIds.add(d):S.selectedIds.delete(d),Ke(),o.stopPropagation();return}const n=i.closest("button[data-action]");if(n){const{action:d,type:u,id:c}=n.dataset;if(d==="mark-as-paid"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),Yd(u,c);return}if(d==="delete"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(30);const p=n.closest(".financial-row").dataset.item;try{Sr(u,JSON.parse(decodeURIComponent(p)))}catch(b){console.error("Parse error on delete",b)}return}if(d==="manage-natures"){o.stopPropagation(),Zs("nature");return}if(d==="manage-cost-centers"){o.stopPropagation(),Zs("cost-center");return}if(d==="close-modal"){o.stopPropagation(),At();return}}const l=i.closest(".financial-row");if(l&&document.getElementById("list-container").contains(l)&&!i.closest("button")&&!i.closest(".item-checkbox")){navigator.vibrate&&navigator.vibrate(15);const{type:d}=l.dataset;try{const u=JSON.parse(decodeURIComponent(l.dataset.item));eo(d,u)}catch(u){console.error("Parse error on card click",u),f("Erro","Os dados deste lançamento não puderam ser lidos corretamente.","error")}}},document.body.addEventListener("click",Jt),Qt&&document.getElementById("genericModal").removeEventListener("click",Qt),Qt=o=>{const i=o.target.closest('button[data-action^="delete-"]');if(i){const n=i.dataset.action.split("-")[1];handleDeleteHierarchyItem(n,i.dataset.id)}o.target===document.getElementById("genericModal")&&At()},document.getElementById("genericModal").addEventListener("click",Qt)}function Ke(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=S.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}function Ks(t){S.currentTab=t,S.selectedIds.clear(),Ke(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t==="receivables"?(e.classList.add("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.remove("text-gray-500"),a.classList.remove("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.add("text-gray-500")):(a.classList.add("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.remove("text-gray-500"),e.classList.remove("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.add("text-gray-500")),Lt(),kr()}async function Pe(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A sincronizar carteira...</p></div>';try{if(S.natures.length===0){const[i,n,l,d,u]=await Promise.all([ya(m.establishmentId),cs(m.establishmentId),Mt(m.establishmentId).catch(()=>[]),ut(m.establishmentId,"",1e3).catch(()=>[]),$e(m.establishmentId).catch(()=>[])]);S.natures=i||[],S.costCenters=n||[],S.suppliers=l||[],S.clients=d||[],S.professionals=u||[],wr()}const a=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).join(","),s={startDate:S.startDate,endDate:S.endDate,establishmentId:a};S.filterNaturezaId!=="all"&&(s.natureId=S.filterNaturezaId),S.filterCostCenterId!=="all"&&(s.costCenterId=S.filterCostCenterId);const[r,o]=await Promise.all([us(s),wa(s)]);S.payables=r.entries||[],S.receivables=o.entries||[],kr(),Lt()}catch(e){t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
    ...
    `}function Lt(){const t=document.getElementById("list-container");if(!t)return;const e=S.currentTab==="receivables",a=e?S.receivables:S.payables;let s=a;if(S.statusFilter!=="all"&&(s=a.filter(c=>{const p=lt(c.dueDate,c.status);return S.statusFilter==="overdue"?p:S.statusFilter==="pending"?c.status==="pending"&&!p:c.status===S.statusFilter})),S.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(S.searchQuery)||c.entity&&c.entity.toLowerCase().includes(S.searchQuery)||c.notes&&c.notes.toLowerCase().includes(S.searchQuery))),s.sort((c,p)=>{let b=c[S.sortCol],g=p[S.sortCol];return S.sortCol==="dueDate"?(b=new Date(b).getTime(),g=new Date(g).getTime()):(S.sortCol==="description"||S.sortCol==="status")&&(b=b?b.toLowerCase():"",g=g?g.toLowerCase():""),b<g?S.sortAsc?-1:1:b>g?S.sortAsc?1:-1:0}),Gd(),s.length===0){t.innerHTML=`
        ...
        `}).join("")}async function Yd(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?Ui(e,a):Gi(e,a)),f("Baixa Realizada","O lançamento foi registado como pago.","success"),await Pe()}catch(s){f("Erro",s.message,"error")}}async function Sr(t,e){if(!!!e.recurrenceId){await Y("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await $r(t,[e.id]);return}Xd(t,e)}function Xd(t,e){const a=document.getElementById("genericModal"),r=(t==="payable"?S.payables:S.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,u)=>new Date(d.dueDate)-new Date(u.dueDate));a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",a.innerHTML=`
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const E=a.querySelector("#modal-content-wrapper");E&&(E.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),E.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let b="single",g=2;const v=p.querySelector("#modal-delete-btn");v&&v.addEventListener("click",E=>{E.preventDefault(),navigator.vibrate&&navigator.vibrate(30),At(),setTimeout(()=>Sr(t,e),300)});const y=p.querySelector('[name="amount"]'),k=p.querySelector("#recurrence-options"),P=p.querySelector("#recurrence-summary"),T=p.querySelector("#installments-input"),$=p.querySelector("#status-toggle"),L=p.querySelector("#payment-date-wrapper"),q=p.querySelector('[name="paymentDate"]'),N=()=>{if(b==="single")return;const E=parseFloat(y.value)||0;if(g=parseInt(T.value)||2,E===0){P.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(b==="installment"){const I=E/g;P.innerHTML=`
                <div>
    ...
    `}async function dt(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">Carregando comissões...</p></div>');const a=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).join(",");try{const[s,r]=await Promise.all([ac({startDate:j.startDate,endDate:j.endDate,professionalId:j.professionalId,establishmentId:a}),tc(j.startDate,j.endDate,a)]);j.reports=s||[];const o=j.reports.reduce((i,n)=>i+(n.summary.finalValue||n.summary.totalCommission),0);j.stats={revenue:r.totalRevenue||0,commissions:r.totalCommissionsPaid||0,margin:r.totalRevenue>0?((r.totalRevenue-r.totalCommissionsPaid)/r.totalRevenue*100).toFixed(1):0,netPaid:o},j.selectedIds.clear(),Dt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),lc(),Lr()}catch(s){console.error(s),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
                <p class="text-gray-600 text-sm font-medium">Erro ao carregar dados.</p>
            </div>`)}}function lc(){const t=document.getElementById("kpi-section");t&&(t.innerHTML=`
    ...
    `)}function Lr(){const t=document.getElementById("list-container");if(!t)return;let e=j.reports;if(j.searchQuery){const a=j.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=e.map(a=>{const s=rc(a.createdAt),r=a.summary.totalCommission,o=a.summary.extraDebit||0,i=a.summary.extraCredit||0,n=a.summary.finalValue||r,l=j.selectedIds.has(a.id);let d="";return o>0&&i>0?d=`<span class="text-red-500">-R$${o.toFixed(2)}</span> / <span class="text-emerald-500">+R$${i.toFixed(2)}</span>`:o>0?d=`<span class="text-red-500">-R$ ${o.toFixed(2)}</span>`:i>0?d=`<span class="text-emerald-500">+R$ ${i.toFixed(2)}</span>`:d='<span class="text-gray-300">--</span>',`
        ...
        `}).join("")}function dc(){Gt&&document.body.removeEventListener("click",Gt),Gt=o=>{const i=o.target;if(i.classList.contains("item-checkbox")){const l=i.value;i.checked?j.selectedIds.add(l):j.selectedIds.delete(l),Dt(),o.stopPropagation();return}const n=i.closest("button[data-action]");if(n){o.preventDefault();const l=n.dataset.action,d=n.dataset.id;switch(l){case"apply-filters":j.startDate=document.getElementById("filter-start").value,j.endDate=document.getElementById("filter-end").value,j.professionalId=document.getElementById("filter-prof").value,document.getElementById("custom-date-btn")?.click(),dt();break;case"new-calculation":cc();break;case"print-receipt":hc(d);break;case"delete-report":yc(d);break;case"view-report-details":fc(d);break;case"close-detail-screen":Es();break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),c=Array.from(u).every(v=>v.checked);u.forEach(v=>v.checked=!c);break;case"calculate-preview":uc();break;case"save-final-reports":gc();break;case"toggle-preview-details":const p=n.dataset.idx,b=document.getElementById(`preview-details-${p}`),g=n.querySelector("i");b&&(b.classList.contains("hidden")?(b.classList.remove("hidden"),g&&g.classList.replace("bi-chevron-down","bi-chevron-up")):(b.classList.add("hidden"),g&&g.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",Gt);const t=document.getElementById("search-input");t&&t.addEventListener("input",o=>{j.searchQuery=o.target.value,Lr()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&bc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const i=o.target.checked,n=document.querySelectorAll(".item-checkbox");j.selectedIds.clear(),n.forEach(l=>{l.checked=i,i&&j.selectedIds.add(l.value)}),Dt()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{j.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Dt()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",vc);const r=document.getElementById("export-excel-btn");r&&r.addEventListener("click",xc),document.getElementById("custom-date-btn")?.addEventListener("click",()=>{const o=document.getElementById("filter-panel"),i=document.getElementById("custom-date-btn");j.isAdvancedFilterOpen=!j.isAdvancedFilterOpen,j.isAdvancedFilterOpen?(o.classList.remove("hidden"),i.classList.add("bg-gray-900","text-white","border-gray-900"),i.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),i.classList.remove("bg-gray-900","text-white","border-gray-900"),i.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=i.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filter-start").value=d.toISOString().split("T")[0],document.getElementById("filter-end").value=u.toISOString().split("T")[0],j.startDate=d.toISOString().split("T")[0],j.endDate=u.toISOString().split("T")[0],dt()})})}function Dt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=j.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function cc(){j.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=j.professionals.map(o=>`
    ...
    `,Ir()}async function uc(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(u=>u.value);if(t.length===0)return f("Atenção","Selecione pelo menos um profissional.","warning");const a=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).join(","),s=document.getElementById("calc-start-date"),r=document.getElementById("calc-end-date");if(!s||!r||!s.value||!r.value)return f("Atenção","As datas de início e fim são obrigatórias.","warning");const o={professionalIds:t,startDate:s.value,endDate:r.value,establishmentId:a,calculationTypes:{services:document.getElementById("calc-type-services")?.checked||!1,products:document.getElementById("calc-type-products")?.checked||!1,packages:document.getElementById("calc-type-packages")?.checked||!1}},i=new Date(o.startDate+"T00:00:00").toLocaleDateString("pt-BR"),n=new Date(o.endDate+"T00:00:00").toLocaleDateString("pt-BR");j.periodString=`${i} a ${n}`;const l=document.getElementById("btn-calc-action"),d=l.innerHTML;l.innerHTML='<div class="loader-small border-white mr-2"></div> Processando...',l.disabled=!0;try{const u=await Kd(o);j.calculationResult=u.map(c=>({...c,extraDebit:0,extraCredit:0,finalValue:c.summary.totalCommission,notes:""})),pc()}catch(u){f("Erro na Apuração",u.message,"error"),l.innerHTML=d,l.disabled=!1}}function pc(){j.viewMode="preview-calc";const t=j.calculationResult;if(!t||t.length===0||t.every(i=>i.summary.totalCommission===0)){f("Aviso","Nenhuma comissão encontrada para os filtros selecionados.","info");const i=document.getElementById("btn-calc-action");i.innerHTML='<i class="bi bi-calculator text-lg"></i> Calcular Vendas',i.disabled=!1;return}const e=document.getElementById("calc-step-1"),a=document.getElementById("calc-step-2"),s=document.getElementById("btn-calc-action");e&&e.classList.add("hidden"),a&&a.classList.remove("hidden"),s&&(s.dataset.action="save-final-reports",s.className="w-full md:w-auto py-3.5 px-8 bg-emerald-600 text-white font-black text-sm rounded-xl hover:bg-emerald-700 shadow-md transition-transform active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider",s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1);const r=t.reduce((i,n)=>i+n.finalValue,0),o=t.map((i,n)=>{if(i.summary.totalCommission===0)return"";const l=(i.items||[]).map(u=>`
        ...
        ${o}
    `)}function bc(t){const e=document.querySelector(`.input-debit[data-idx="${t}"]`),a=document.querySelector(`.input-credit[data-idx="${t}"]`),s=document.querySelector(`.input-notes[data-idx="${t}"]`);let r=parseFloat(e?.value)||0,o=parseFloat(a?.value)||0,i=s?.value||"";if(j.calculationResult&&j.calculationResult[t]){const n=j.calculationResult[t];n.extraDebit=r,n.extraCredit=o,n.notes=i,n.finalValue=n.summary.totalCommission-r+o;const l=document.querySelector(`.final-value-display[data-idx="${t}"]`);l&&(l.innerText=`R$ ${n.finalValue.toFixed(2)}`),mc()}}function mc(){const t=j.calculationResult.reduce((a,s)=>a+s.finalValue,0),e=document.getElementById("grand-total-preview");e&&(e.innerText=`R$ ${t.toFixed(2)}`)}async function gc(){const t=j.calculationResult.filter(r=>r.summary.totalCommission>0),e=t.length;if(e===0)return f("Aviso","Não há valores para pagar.","info");if(!await Y("Confirmar Pagamentos",`Você está prestes a gerar recibos e marcar as vendas de ${e} profissional(is) como PAGAS. Essa ação lançará a despesa correspondente no Financeiro. Confirmar?`))return;const s=document.getElementById("btn-calc-action");s.innerHTML='<div class="loader-small border-white mr-2"></div> Finalizando...',s.disabled=!0;try{const r=t.map(async o=>{const i=(o.items||[]).map(n=>n.originalSaleId).filter(n=>n!=null);await ec({professionalId:o.professionalId,professionalName:o.professionalName,period:j.periodString,processedSalesIds:i,establishmentId:m.establishmentId,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}});try{if(o.finalValue>0){const n=j.establishmentConfig||{},l=n.defaultDespesaNaturezaId||n.financeConfig?.despesaNaturezaId||null,d=n.defaultDespesaCentroCustoId||n.financeConfig?.despesaCentroCustoId||null;await Ao({establishmentId:m.establishmentId,description:`Comissões - ${o.period}`,amount:o.finalValue,dueDate:new Date().toISOString().split("T")[0],naturezaId:l,centroDeCustoId:d,entity:o.professionalName,paymentMethod:"dinheiro",status:"paid",paymentDate:new Date().toISOString().split("T")[0],origin:"commission"})}}catch(n){console.error("Erro ao integrar com financeiro (Despesa):",n)}});await Promise.all(r),f("Sucesso","Pagamentos registrados e integrados ao financeiro!","success"),j.calculationResult=null,Es(),await dt()}catch(r){f("Erro ao Salvar",r.message,"error"),s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1}}function fc(t){j.viewMode="report-details";const e=document.getElementById("commissions-layout-detail");if(!e)return;const a=j.reports.find(c=>c.id===t);if(!a)return;const s=a.reportData?.items||a.items||[],r=a.summary,o=r.extraDebit||0,i=r.extraCredit||0,n=r.notes||"",l=`
    ...
    `}function Ic(){const t=wc(),e=document.getElementById("kpi-container");e&&(e.innerHTML=`
    ...
    `,os(),requestAnimationFrame(()=>{const g=t.querySelector("#modal-content-wrapper");g&&(g.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),g.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Cc(){B.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `,Mc(t),Ac(a)}function Mc(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),r=document.getElementById("profile-avatar"),o=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async i=>{const n=i.target.files[0];if(n)try{const l=await xa(n,800,800,.8);r.src=l,await Bt(Ae(me,"users",t.uid),{photo:l}),m.userProfessionalId&&await Ha(m.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),f("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{f("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),o.addEventListener("submit",async i=>{i.preventDefault();const n=o.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),u=document.getElementById("input-phone").value.trim();try{await Bt(Ae(me,"users",t.uid),{name:d,phone:u}),m.userProfessionalId&&await Ha(m.userProfessionalId,{name:d,phone:u}),m.userName=d,document.getElementById("display-name").textContent=d,f("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{f("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function Ac(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async r=>{r.preventDefault();const o=a.querySelector("#b-date-start").value,i=a.querySelector("#b-date-end").value||o,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!o||!n||!l)return f("Atenção","Preencha Data e Horários corretamente.","error");const u=new Date(`${o}T${n}:00`),c=new Date(`${i}T${l}:00`);if(c<=u)return f("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await Sa({establishmentId:m.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:u.toISOString(),endTime:c.toISOString()}),f("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const g=document.getElementById("my-blocks-filter").value;sa(t.id,g)}catch(g){f("Erro",`Falha ao bloquear: ${g.message}`,"error")}finally{p.disabled=!1,p.innerHTML=b}}),document.getElementById("my-blocks-filter").addEventListener("change",r=>sa(t.id,r.target.value)),sa(t.id,"future")}async function sa(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let r,o;e==="history"?(o=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let n=(await ka(m.establishmentId,r.toISOString(),o.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await ps(u),f("Removido","O bloqueio foi deletado.","success"),sa(t,e)}catch(c){f("Erro",`Não foi possível remover: ${c.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${h(s.message)}</p>`}}let so=!1;async function ga(t){if(!t)return;t.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const r=(await ve()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),r.length===0)e.innerHTML=`
            ...
            `;else{let o="";r.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';o+=`
                ...
                `}),e.innerHTML=o}so||(qc(),so=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
        ...
        `}}function qc(){const t=document.getElementById("form-create-establishment");t&&t.addEventListener("submit",async e=>{e.preventDefault();const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const r={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const o=await li(r);alert(o.message||"Sucesso!"),t.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await ga(document.getElementById("content"))}catch(o){console.error("Erro ao criar estabelecimento:",o),alert("Erro: "+(o.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>ga(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",e=>e.preventDefault()),document.addEventListener("gesturechange",e=>e.preventDefault()),document.addEventListener("gestureend",e=>e.preventDefault());let t=0;document.addEventListener("touchend",function(e){const a=new Date().getTime();a-t<=300&&e.preventDefault(),t=a},!1)});const le=document.getElementById("loadingScreen"),ft=document.getElementById("dashboardContent"),et=document.getElementById("content"),ja=document.getElementById("notificationBell"),Yt=document.getElementById("notificationBadge"),Je=document.getElementById("notificationPanel"),Na=document.getElementById("notificationList"),Ie=document.getElementById("profileMenuButton"),ue=document.getElementById("profileDropdown"),oo=document.getElementById("profileName"),ro=document.getElementById("profileEmail"),io=document.getElementById("logoutButton"),no=document.getElementById("myProfileLink"),lo=document.getElementById("hamburger-menu-btn"),ce=document.getElementById("sidebar"),fe=document.getElementById("mobile-overlay"),co=document.getElementById("themeToggleBtn"),Ra=document.getElementById("themeIcon"),is=document.getElementById("mobile-bottom-nav"),uo=document.getElementById("nav-scroll"),jc=document.querySelectorAll(".bottom-nav-item");function Nc(){if(!uo)return;const t=document.querySelector(".bottom-nav-item.active");if(!t)return;const e=uo,a=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=s.left+s.width/2-a.left-a.width/2;e.scrollBy({left:o,behavior:"smooth"})}const Rc={"dashboard-section":Yi,"agenda-section":Oo,"comandas-section":Wn,"relatorios-section":Qn,"servicos-section":rl,"produtos-section":wl,"suppliers-section":Ml,"profissionais-section":zl,"clientes-section":Kl,"estabelecimento-section":t=>gr(t),"ausencias-section":Dd,"users-section":ua,"sales-report-section":_d,"financial-section":Jd,"commissions-section":ic,"packages-section":$c,"my-profile-section":Bc,"hierarquia-section":()=>ga(et),"establishments-section":()=>ga(et)},Fc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços","produtos-section":"Estoque","suppliers-section":"Parceiros","profissionais-section":"Equipe","clientes-section":"Clientes","estabelecimento-section":"Empresa","ausencias-section":"Ausências","users-section":"Usuários","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro","commissions-section":"Comissões","packages-section":"Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"};function oa(t){document.documentElement.setAttribute("data-theme",t),localStorage.setItem("kairos_theme",t),Ra&&(t==="dark"?Ra.className="bi bi-sun-fill text-lg sm:text-xl text-amber-400":Ra.className="bi bi-moon-fill text-lg sm:text-xl text-slate-500")}function Hc(){const t=localStorage.getItem("kairos_theme"),e=window.matchMedia("(prefers-color-scheme: dark)").matches;oa(t||(e?"dark":"light"))}let Pt=null,Tt=[];function Dr(){if(!Yt||!Na)return;const t=Tt.filter(e=>!e.read).length;if(t>0?(Yt.textContent=t,Yt.classList.remove("hidden")):Yt.classList.add("hidden"),Tt.length===0){Na.innerHTML='<p class="text-center text-slate-500 p-4 text-sm">Nenhuma notificação.</p>';return}Na.innerHTML=Tt.map(e=>`
    ...
    `).join("")}function po(t){Pt&&Pt();const e=fa(me,"establishments",t,"notifications"),a=go(e,fo("timestamp",">=",new Date),Vr("timestamp","desc"));Pt=_r(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();Tt.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),f(o.title,o.message,"info",!0),Dr();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&Oo()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Oc(t){const e=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),r=document.getElementById("multi-context-count"),o=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!e||!o))try{const u=(await ve()).matrizes||[];let c="",p=0;if(u.forEach(b=>{c+=`
            ...
            `,p++,b.branches&&b.branches.length>0&&b.branches.forEach(g=>{c+=`
                    ...
                    `,p++})}),p>0){o.innerHTML=c,e.style.display="block",(!m.selectedEstablishments||m.selectedEstablishments.length===0)&&(m.selectedEstablishments=[t]);const b=Array.from(o.querySelectorAll('input[type="checkbox"]')),g=()=>{const y=b.filter(k=>k.checked);r.textContent=y.length,y.length===0?s.textContent="Nenhuma selecionada":y.length===1?s.textContent=y[0].dataset.name:s.textContent=`${y.length} Unidades`};let v=!1;b.forEach(y=>{m.selectedEstablishments.includes(y.value)&&(y.checked=!0,v=!0)}),!v&&b.length>0&&(b[0].checked=!0,m.selectedEstablishments=[b[0].value],m.establishmentId=b[0].value),g(),a.addEventListener("click",y=>{y.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",y=>{!e.contains(y.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",b.forEach(k=>{k.checked=m.selectedEstablishments.includes(k.value)}),g())}),b.forEach(y=>y.addEventListener("change",g)),i.addEventListener("click",async y=>{y.stopPropagation(),le&&(le.classList.remove("hidden","fade-out"),le.style.display="flex");const k=b.filter(T=>T.checked);if(k.length===0){le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500)),f("Atenção","Selecione pelo menos uma unidade.","warning");return}m.selectedEstablishments=k.map(T=>T.value);const P=m.selectedEstablishments[0];try{const T=await qe(P);m.establishmentId=P,m.establishmentName=T.name,m.enabledModules=T.modules,m.currentViewContext={id:P,name:T.name,type:T.parentId?"BRANCH":"GROUP"},po(P),bo(m.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",f("Ambiente Atualizado","Exibindo dados consolidados.","success");const $=document.querySelector(".sidebar-link.active"),L=$?$.getAttribute("data-target"):"dashboard-section";se(L)}catch{f("Erro","Problema ao trocar a visualização.","error")}finally{le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500))}});try{const y=await qe(m.establishmentId);m.establishmentName=y.name,m.enabledModules=y.modules,m.currentViewContext={id:m.establishmentId,name:y.name,type:y.parentId?"BRANCH":"GROUP"},po(m.establishmentId),bo(m.userPermissions)}catch{}}else e.style.display="none"}catch{e.style.display="none"}}function se(t,e={}){const a=t.replace("-section","");if(t!=="my-profile-section"){const r=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(t),o=m.enabledModules?.[a]!==!1,i=m.userPermissions===null||m.userPermissions[t]?.view===!0;if(!r&&(!o||!i)){et&&(et.innerHTML='<div class="p-8 text-center mt-10"><i class="bi bi-shield-lock text-5xl text-rose-500 mb-4 block"></i><h2 class="text-2xl font-bold text-slate-800">Acesso Negado</h2><p class="text-slate-500 mt-2">Você não possui permissão para visualizar esta tela.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),ce&&ce.classList.contains("absolute")&&(ce.classList.add("hidden"),fe&&fe.classList.add("hidden"));return}}const s=Rc[t];if(s&&et){const r=document.getElementById("header-page-title");r&&(r.textContent=Fc[t]||"Painel"),document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),is&&(jc.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),setTimeout(Nc,50)),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),et.innerHTML="",window.innerWidth<768&&ce&&(ce.classList.add("hidden"),fe&&fe.classList.add("hidden")),s(e)}}window.navigateTo=se;async function bo(t){const e=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=t===null||t["agenda-section"]?.view===!0,i=t===null||t["financial-section"]?.view===!0;if(o&&e&&(e.classList.remove("hidden"),e.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!o&&!i))try{const n=await ko();o&&s&&(s.textContent=n.todayAppointments.toString()),i&&r&&(r.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch{}}async function zc(t){try{Se.getPlatform()==="android"&&await de.createChannel({id:"default",name:"Notificações",description:"Alertas",importance:5,visibility:1,vibration:!0});let e=await de.checkPermissions();if(e.receive==="prompt"&&(e=await de.requestPermissions()),e.receive!=="granted")return;await de.register(),de.addListener("registration",async a=>{try{const s=Ae(me,"users",t);await Bt(s,{fcmTokens:zr(a.value),platform:"native_mobile"})}catch{}}),de.addListener("pushNotificationReceived",a=>f(a.title,a.body,"info",!0)),de.addListener("pushNotificationActionPerformed",()=>se("agenda-section"))}catch{}}function Vc(){const t=document.getElementById("exitConfirmationModal"),e=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>t&&(t.style.display="block"),r=()=>t&&(t.style.display="none"),o=()=>t&&t.style.display==="block";t&&(e.addEventListener("click",()=>{r(),Se.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{r(),Se.isNativePlatform()?Bs.exitApp():history.back()}),Se.isNativePlatform()?Bs.addListener("backButton",()=>{if(o())r();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(ce&&!ce.classList.contains("hidden")&&window.innerWidth<768){ce.classList.add("hidden"),fe&&fe.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():se("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(o()){r(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():(se("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Xt(t){return t?t.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function _c(){try{await qr(he,jr)}catch{}Se.isNativePlatform()&&document.body.classList.add("is-app-native"),Ur(),Vc(),Hc(),co&&co.addEventListener("click",t=>{t.preventDefault();const e=document.documentElement.getAttribute("data-theme")||"light";oa(e==="dark"?"light":"dark")}),lo&&lo.addEventListener("click",t=>{t.stopPropagation(),ce&&(ce.classList.remove("hidden"),ce.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),fe&&fe.classList.remove("hidden")}),is&&is.addEventListener("click",t=>{const e=t.target.closest(".bottom-nav-item");if(!e)return;t.preventDefault();const a=e.getAttribute("data-target");se(a)}),fe&&fe.addEventListener("click",()=>{ce&&(ce.classList.add("hidden"),ce.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),fe.classList.add("hidden")}),ja&&ja.addEventListener("click",t=>{t.stopPropagation(),Je&&(Je.classList.toggle("hidden"),Je.classList.contains("hidden")||(Tt.forEach(e=>e.read=!0),Dr()))}),Ie&&Ie.addEventListener("click",t=>{t.stopPropagation(),ue&&(ue.classList.toggle("active"),ue.classList.contains("active")?ue.classList.remove("hidden"):setTimeout(()=>ue.classList.add("hidden"),200))}),no&&no.addEventListener("click",t=>{t.preventDefault(),se("my-profile-section"),ue&&(ue.classList.remove("active"),ue.classList.add("hidden"))}),window.addEventListener("userPhotoUpdated",t=>{const e=t.detail;Ie&&e&&(Ie.innerHTML=`<img src="${e}" alt="Avatar" class="w-full h-full rounded-full object-cover">`)}),document.addEventListener("click",t=>{Je&&!Je.contains(t.target)&&t.target!==ja&&Je.classList.add("hidden"),ue&&!ue.contains(t.target)&&t.target!==Ie&&ue.classList.contains("active")&&(ue.classList.remove("active"),setTimeout(()=>ue.classList.add("hidden"),200))}),Nr(he,async t=>{if(t){if(!Se.isNativePlatform()&&(Ci(),"Notification"in window&&Notification.permission==="default")){const e=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");e&&setTimeout(()=>{e.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Di()&&e&&(e.style.display="none")});const s=()=>{e&&(e.style.display="none")},r=document.getElementById("btn-deny-toast"),o=document.getElementById("btn-close-toast");r&&r.addEventListener("click",s),o&&o.addEventListener("click",s)}try{const a=(await t.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,r=t.displayName,o=null,i=null;const n=Ae(me,"users",t.uid),l=await ns(n);if(l.exists()){const u=l.data();s=a.role==="employee"?u.permissions||{}:null,r=u.name||r,o=u.professionalId||null,i=u.photo||null}if(m.userProfessionalId=o,o&&!i)try{const u=await xo(o);u&&u.photo&&(i=u.photo)}catch{}Se.isNativePlatform()&&zc(t.uid);const d=r||t.email;Qr(a.establishmentId,"Carregando...",s),i?Ie&&(Ie.innerHTML=`<img src="${i}" class="w-full h-full rounded-full object-cover">`):Ie&&(Ie.textContent=d.charAt(0).toUpperCase()),oo&&(oo.textContent=d),ro&&(ro.textContent=t.email),io&&io.addEventListener("click",u=>{u.preventDefault(),Pt&&Pt(),Rr(he).then(()=>window.location.href="/login.html")}),await Oc(a.establishmentId),ni(se,s,m.enabledModules),le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500)),ft&&(ft.style.display="flex"),setTimeout(()=>{mi()},1500),se("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(e){le&&(le.style.display="none"),ft&&(ft.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><i class="bi bi-x-circle text-5xl text-rose-500 mb-4"></i><h2 class="text-xl font-bold">Erro de Acesso</h2><p class="text-slate-500 mt-2">${e.message}</p></div>`,ft.style.display="flex")}}else window.location.href="/login.html"})}_c();export{vo as W};
