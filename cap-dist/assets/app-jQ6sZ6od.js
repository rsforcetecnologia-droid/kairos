...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${a.status}) em ${r}:`,c),new Error(c)}return a.json()}catch(a){throw console.error(`Falha de rede ao tentar acessar ${r}:`,a.message),a.message.includes("Failed to fetch")||a.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Da}. Verifique sua conexão com a internet.`):a}}const pu=(t,e,s,n=null)=>{let o=`/api/appointments/${t}?startDate=${e}&endDate=${s}`;return n&&(o+=`&professionalId=${n}`),F(o)},kh=(t,e,s)=>{const n=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${s}`;return F(n)},Ch=({establishmentId:t,professionalId:e,serviceIds:s,date:n})=>{const o=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${s.join(",")}&date=${n}`;return F(o)},_h=t=>F("/api/appointments",{method:"POST",body:JSON.stringify(t)}),ui=(t,e)=>F(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),Ah=t=>F(`/api/appointments/${t}`,{method:"DELETE"}),Ph=t=>F(`/api/appointments/${t}/reopen`,{method:"POST"}),$h=(t,e)=>F(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)});let De;async function Dh(){if(!De)try{De=new(window.AudioContext||window.webkitAudioContext)}catch(t){console.error("Não foi possível inicializar o áudio:",t)}}function Lh(){if(!De){console.warn("AudioContext não inicializado. O som não será tocado.");return}De.state==="suspended"&&De.resume();const t=De.createOscillator(),e=De.createGain();t.connect(e),e.connect(De.destination),t.type="sine",t.frequency.setValueAtTime(800,De.currentTime),e.gain.setValueAtTime(0,De.currentTime),e.gain.linearRampToValueAtTime(.3,De.currentTime+.01),e.gain.exponentialRampToValueAtTime(1e-4,De.currentTime+.2),t.start(De.currentTime),t.stop(De.currentTime+.2)}function k(t,e,s="info",n=!1){const o=document.getElementById("toast-container");if(!o)return;n&&Lh();const r=document.createElement("div"),a={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},l={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},c={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${a[s]||a.info}`,r.innerHTML=`
    ...
    `;const c=o.querySelector("[data-close-modal]");c&&(c.onclick=a);const d=o.querySelector('[data-action="close-modal"]');return d&&(d.onclick=a),o.addEventListener("click",p=>{p.target.closest(".modal-content")||a()}),o.style.display="flex",{modalElement:o,close:a,setContent:l}}function cr(t){const e=document.getElementById(t);e&&(e.style.display="none")}function Rh(){document.body.addEventListener("click",()=>{De||Dh()},{once:!0}),document.addEventListener("click",t=>{const e=t.target.closest('[data-action="close-modal"]');if(e){const n=e.dataset.target;if(n){const o=document.getElementById(n);o&&(o.style.display="none")}}if(t.target.closest("[data-close-modal]")){const n=document.getElementById("genericModal");n&&(n.style.display="none")}})}async function gc(){const t=document.getElementById("cancellationListContainer");if(!t)return;t.innerHTML='<div class="loader mx-auto"></div>';const e=document.getElementById("cancelStartDate").value,s=document.getElementById("cancelEndDate").value;try{const n=await kh(w.establishmentId,e,s);if(n.length===0){t.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}t.innerHTML=n.map(o=>`
        ...
        `).join("")}catch(n){t.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${n.message}</p>`}}function Mh(){const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const n=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(Yh).map(([r,a])=>`<option value="${r}">${a.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>tg(s.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{t===Do.length-1?xc(e):(Ke++,mi(),pi(Ke))}),s.id==="branding"){const o=document.getElementById("logo-input"),r=document.getElementById("bg-input");o&&(o.onchange=async a=>{const l=a.target.files[0];if(l)try{const c=await yc(l,200,.8);document.getElementById("logo-base64").value=c,document.getElementById("logo-preview").innerHTML=`<img src="${c}" class="w-full h-full object-contain rounded">`}catch(c){console.error("Erro logo",c)}}),r&&(r.onchange=async a=>{const l=a.target.files[0];if(l)try{const c=await yc(l,1024,.7);document.getElementById("bg-base64").value=c}catch(c){console.error("Erro bg",c)}})}}function xc(t){t.innerHTML=`
...
`+t.stack),e}class Fi extends Sm{constructor(e,s,n,o){super(e,s,n,o),this.type="firestore",this._queue=new yd,this._persistenceKey=o?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new yd(e),this._firestoreClient=void 0,await e}}}function dv(t){if(t._terminated)throw new z(M.FAILED_PRECONDITION,"The client has already been terminated.");return t._firestoreClient||uv(t),t._firestoreClient}function uv(t){const e=t._freezeSettings(),s=(function(o,r,a,l){return new r0(o,r,a,l.host,l.ssl,l.experimentalForceLongPolling,l.experimentalAutoDetectLongPolling,Im(l.experimentalLongPollingOptions),l.useFetchStreams,l.isUsingEmulator)})(t._databaseId,t._app?.options.appId||"",t._persistenceKey,e);t._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(t._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),t._firestoreClient=new ov(t._authCredentials,t._appCheckCredentials,t._queue,s,t._componentsProvider&&(function(o){const r=o?._online.build();return{_offline:o?._offline.build(r),_online:r}})(t._componentsProvider))}class Qe{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Qe(at.fromBase64String(e))}catch(s){throw new z(M.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+s)}}static fromUint8Array(e){return new Qe(at.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Qe._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(jn(e,Qe._jsonSchema))return Qe.fromBase64String(e.bytes)}}Qe._jsonSchemaVersion="firestore/bytes/1.0",Qe._jsonSchema={type:ge("string",Qe._jsonSchemaVersion),bytes:ge("string")};class xr{constructor(...e){for(let s=0;s<e.length;++s)if(e[s].length===0)throw new z(M.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ee(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}class wr{constructor(e){this._methodName=e}}class ft{constructor(e,s){if(!isFinite(e)||e<-90||e>90)throw new z(M.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(s)||s<-180||s>180)throw new z(M.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+s);this._lat=e,this._long=s}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return se(this._lat,e._lat)||se(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:ft._jsonSchemaVersion}}static fromJSON(e){if(jn(e,ft._jsonSchema))return new ft(e.latitude,e.longitude)}}ft._jsonSchemaVersion="firestore/geoPoint/1.0",ft._jsonSchema={type:ge("string",ft._jsonSchemaVersion),latitude:ge("number"),longitude:ge("number")};class bt{constructor(e){this._values=(e||[]).map((s=>s))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(n,o){if(n.length!==o.length)return!1;for(let r=0;r<n.length;++r)if(n[r]!==o[r])return!1;return!0})(this._values,e._values)}toJSON(){return{type:bt._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(jn(e,bt._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((s=>typeof s=="number")))return new bt(e.vectorValues);throw new z(M.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}bt._jsonSchemaVersion="firestore/vectorValue/1.0",bt._jsonSchema={type:ge("string",bt._jsonSchemaVersion),vectorValues:ge("object")};const mv=/^__.*__$/;class pv{constructor(e,s,n){this.data=e,this.fieldMask=s,this.fieldTransforms=n}toMutation(e,s){return this.fieldMask!==null?new Ft(e,this.data,this.fieldMask,s,this.fieldTransforms):new Un(e,this.data,s,this.fieldTransforms)}}class Tm{constructor(e,s,n){this.data=e,this.fieldMask=s,this.fieldTransforms=n}toMutation(e,s){return new Ft(e,this.data,this.fieldMask,s,this.fieldTransforms)}}function km(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Y(40011,{Ac:t})}}class Er{constructor(e,s,n,o,r,a){this.settings=e,this.databaseId=s,this.serializer=n,this.ignoreUndefinedProperties=o,r===void 0&&this.Rc(),this.fieldTransforms=r||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new Er({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){const s=this.path?.child(e),n=this.Vc({path:s,fc:!1});return n.gc(e),n}yc(e){const s=this.path?.child(e),n=this.Vc({path:s,fc:!1});return n.Rc(),n}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return Zo(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return this.fieldMask.find((s=>e.isPrefixOf(s)))!==void 0||this.fieldTransforms.find((s=>e.isPrefixOf(s.field)))!==void 0}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(e.length===0)throw this.Sc("Document fields must not be empty");if(km(this.Ac)&&mv.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class hv{constructor(e,s,n){this.databaseId=e,this.ignoreUndefinedProperties=s,this.serializer=n||fr(e)}Cc(e,s,n,o=!1){return new Er({Ac:e,methodName:s,Dc:n,path:Ee.emptyPath(),fc:!1,bc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Cm(t){const e=t._freezeSettings(),s=fr(t._databaseId);return new hv(t._databaseId,!!e.ignoreUndefinedProperties,s)}function gv(t,e,s,n,o,r={}){const a=t.Cc(r.merge||r.mergeFields?2:0,e,s,o);qi("Data must be an object, but it was:",a,n);const l=_m(n,a);let c,d;if(r.merge)c=new We(a.fieldMask),d=a.fieldTransforms;else if(r.mergeFields){const p=[];for(const h of r.mergeFields){const f=Ja(e,h,s);if(!a.contains(f))throw new z(M.INVALID_ARGUMENT,`Field '${f}' is specified in your field mask but missing from your input data.`);Pm(p,f)||p.push(f)}c=new We(p),d=a.fieldTransforms.filter((h=>c.covers(h.field)))}else c=null,d=a.fieldTransforms;return new pv(new Ue(l),c,d)}class Ir extends wr{_toFieldTransform(e){if(e.Ac!==2)throw e.Ac===1?e.Sc(`${this._methodName}() can only appear at the top level of your update data`):e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Ir}}function fv(t,e,s){return new Er({Ac:3,Dc:e.settings.Dc,methodName:t._methodName,fc:s},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class Oi extends wr{constructor(e,s){super(e),this.vc=s}_toFieldTransform(e){const s=fv(this,e,!0),n=this.vc.map((r=>Kn(r,s))),o=new Vs(n);return new L0(e.path,o)}isEqual(e){return e instanceof Oi&&Eu(this.vc,e.vc)}}function bv(t,e,s,n){const o=t.Cc(1,e,s);qi("Data must be an object, but it was:",o,n);const r=[],a=Ue.empty();gs(n,((c,d)=>{const p=ji(e,c,s);d=yt(d);const h=o.yc(p);if(d instanceof Ir)r.push(p);else{const f=Kn(d,h);f!=null&&(r.push(p),a.set(p,f))}}));const l=new We(r);return new Tm(a,l,o.fieldTransforms)}function vv(t,e,s,n,o,r){const a=t.Cc(1,e,s),l=[Ja(e,n,s)],c=[o];if(r.length%2!=0)throw new z(M.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let f=0;f<r.length;f+=2)l.push(Ja(e,r[f])),c.push(r[f+1]);const d=[],p=Ue.empty();for(let f=l.length-1;f>=0;--f)if(!Pm(d,l[f])){const y=l[f];let I=c[f];I=yt(I);const _=a.yc(y);if(I instanceof Ir)d.push(y);else{const D=Kn(I,_);D!=null&&(d.push(y),p.set(y,D))}}const h=new We(d);return new Tm(p,h,a.fieldTransforms)}function Kn(t,e){if(Am(t=yt(t)))return qi("Unsupported field value:",e,t),_m(t,e);if(t instanceof wr)return(function(n,o){if(!km(o.Ac))throw o.Sc(`${n._methodName}() can only be used with update() and set()`);if(!o.path)throw o.Sc(`${n._methodName}() is not currently supported inside arrays`);const r=n._toFieldTransform(o);r&&o.fieldTransforms.push(r)})(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.fc&&e.Ac!==4)throw e.Sc("Nested arrays are not supported");return(function(n,o){const r=[];let a=0;for(const l of n){let c=Kn(l,o.wc(a));c==null&&(c={nullValue:"NULL_VALUE"}),r.push(c),a++}return{arrayValue:{values:r}}})(t,e)}return(function(n,o){if((n=yt(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return P0(o.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const r=de.fromDate(n);return{timestampValue:Ua(o.serializer,r)}}if(n instanceof de){const r=new de(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:Ua(o.serializer,r)}}if(n instanceof ft)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof Qe)return{bytesValue:U0(o.serializer,n._byteString)};if(n instanceof Ie){const r=o.databaseId,a=n.firestore._databaseId;if(!a.isEqual(r))throw o.Sc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:dm(n.firestore._databaseId||o.databaseId,n._key.path)}}if(n instanceof bt)return(function(a,l){return{mapValue:{fields:{[ju]:{stringValue:Hu},[Fa]:{arrayValue:{values:a.toArray().map((d=>{if(typeof d!="number")throw l.Sc("VectorValues must only contain numeric values.");return Di(l.serializer,d)}))}}}}}})(n,o);throw o.Sc(`Unsupported field value: ${wi(n)}`)})(t,e)}function _m(t,e){const s={};return Bu(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):gs(t,((n,o)=>{const r=Kn(o,e.mc(n));r!=null&&(s[n]=r)})),{mapValue:{fields:s}}}function Am(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof de||t instanceof ft||t instanceof Qe||t instanceof Ie||t instanceof wr||t instanceof bt)}function qi(t,e,s){if(!Am(s)||!Mu(s)){const n=wi(s);throw n==="an object"?e.Sc(t+" a custom object"):e.Sc(t+" "+n)}}function Ja(t,e,s){if((e=yt(e))instanceof xr)return e._internalPath;if(typeof e=="string")return ji(t,e);throw Zo("Field path arguments must be of type string or ",t,!1,void 0,s)}const yv=new RegExp("[~\\*/\\[\\]]");function ji(t,e,s){if(e.search(yv)>=0)throw Zo(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,s);try{return new xr(...e.split("."))._internalPath}catch{throw Zo(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,s)}}function Zo(t,e,s,n,o){const r=n&&!n.isEmpty(),a=o!==void 0;let l=`Function ${e}() called with invalid data`;s&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(r||a)&&(c+=" (found",r&&(c+=` in field ${n}`),a&&(c+=` in document ${o}`),c+=")"),new z(M.INVALID_ARGUMENT,l+t+c)}function Pm(t,e){return t.some((s=>s.isEqual(e)))}class $m{constructor(e,s,n,o,r){this._firestore=e,this._userDataWriter=s,this._key=n,this._document=o,this._converter=r}get id(){return this._key.path.lastSegment()}get ref(){return new Ie(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new xv(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const s=this._document.data.field(Dm("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s)}}}class xv extends $m{data(){return super.data()}}function Dm(t,e){return typeof e=="string"?ji(t,e):e instanceof xr?e._internalPath:e._delegate._internalPath}function wv(t,e,s){let n;return n=t?s&&(s.merge||s.mergeFields)?t.toFirestore(e,s):t.toFirestore(e):e,n}class yo{constructor(e,s){this.hasPendingWrites=e,this.fromCache=s}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class As extends $m{constructor(e,s,n,o,r,a){super(e,s,n,o,a),this._firestore=e,this._firestoreImpl=e,this.metadata=r}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const s=new Bo(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(s,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,s={}){if(this._document){const n=this._document.data.field(Dm("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n,s.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new z(M.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,s={};return s.type=As._jsonSchemaVersion,s.bundle="",s.bundleSource="DocumentSnapshot",s.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?s:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),s.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),s)}}As._jsonSchemaVersion="firestore/documentSnapshot/1.0",As._jsonSchema={type:ge("string",As._jsonSchemaVersion),bundleSource:ge("string","DocumentSnapshot"),bundleName:ge("string"),bundle:ge("string")};class Bo extends As{data(e={}){return super.data(e)}}class wn{constructor(e,s,n,o){this._firestore=e,this._userDataWriter=s,this._snapshot=o,this.metadata=new yo(o.hasPendingWrites,o.fromCache),this.query=n}get docs(){const e=[];return this.forEach((s=>e.push(s))),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,s){this._snapshot.docs.forEach((n=>{e.call(s,new Bo(this._firestore,this._userDataWriter,n.key,n,new yo(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const s=!!e.includeMetadataChanges;if(s&&this._snapshot.excludesMetadataChanges)throw new z(M.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===s||(this._cachedChanges=(function(o,r){if(o._snapshot.oldDocs.isEmpty()){let a=0;return o._snapshot.docChanges.map((l=>{const c=new Bo(o._firestore,o._userDataWriter,l.doc.key,l.doc,new yo(o._snapshot.mutatedKeys.has(l.doc.key),o._snapshot.fromCache),o.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:a++}}))}{let a=o._snapshot.oldDocs;return o._snapshot.docChanges.filter((l=>r||l.type!==3)).map((l=>{const c=new Bo(o._firestore,o._userDataWriter,l.doc.key,l.doc,new yo(o._snapshot.mutatedKeys.has(l.doc.key),o._snapshot.fromCache),o.query.converter);let d=-1,p=-1;return l.type!==0&&(d=a.indexOf(l.doc.key),a=a.delete(l.doc.key)),l.type!==1&&(a=a.add(l.doc),p=a.indexOf(l.doc.key)),{type:Ev(l.type),doc:c,oldIndex:d,newIndex:p}}))}})(this,s),this._cachedChangesIncludeMetadataChanges=s),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new z(M.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=wn._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=xi.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const s=[],n=[],o=[];return this.docs.forEach((r=>{r._document!==null&&(s.push(r._document),n.push(this._userDataWriter.convertObjectMap(r._document.data.value.mapValue.fields,"previous")),o.push(r.ref.path))})),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function Ev(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Y(61501,{type:t})}}wn._jsonSchemaVersion="firestore/querySnapshot/1.0",wn._jsonSchema={type:ge("string",wn._jsonSchemaVersion),bundleSource:ge("string","QuerySnapshot"),bundleName:ge("string"),bundle:ge("string")};function Iv(t,e,s){t=jo(t,Ie);const n=jo(t.firestore,Fi),o=wv(t.converter,e,s);return Lm(n,[gv(Cm(n),"setDoc",t._key,o,t.converter!==null,s).toMutation(t._key,rt.none())])}function Sv(t,e,s,...n){t=jo(t,Ie);const o=jo(t.firestore,Fi),r=Cm(o);let a;return a=typeof(e=yt(e))=="string"||e instanceof xr?vv(r,"updateDoc",t._key,e,s,n):bv(r,"updateDoc",t._key,e),Lm(o,[a.toMutation(t._key,rt.exists(!0))])}function Lm(t,e){return(function(n,o){const r=new es;return n.asyncQueue.enqueueAndForget((async()=>Yb(await iv(n),o,r))),r.promise})(dv(t),e)}function Tv(...t){return new Oi("arrayUnion",t)}(function(e,s=!0){(function(o){Hs=o})(Tf),Lt(new Dt("firestore",((n,{instanceIdentifier:o,options:r})=>{const a=n.getProvider("app").getImmediate(),l=new Fi(new Vf(n.getProvider("auth-internal")),new qf(a,n.getProvider("app-check-internal")),(function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new z(M.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new zo(d.options.projectId,p)})(a,o),a);return r={useFetchStreams:s,...r},l._setSettings(r),l}),"PUBLIC").setMultipleInstances(!0)),gt(Mc,Nc,e),gt(Mc,Nc,"esm2020")})();const Rm="@firebase/installations",Hi="0.6.19";const Mm=1e4,Nm=`w:${Hi}`,Bm="FIS_v2",kv="https://firebaseinstallations.googleapis.com/v1",Cv=3600*1e3,_v="installations",Av="Installations";const Pv={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},ds=new ur(_v,Av,Pv);function Vm(t){return t instanceof hs&&t.code.includes("request-failed")}function Fm({projectId:t}){return`${kv}/projects/${t}/installations`}function Om(t){return{token:t.token,requestStatus:2,expiresIn:Dv(t.expiresIn),creationTime:Date.now()}}async function qm(t,e){const n=(await e.json()).error;return ds.create("request-failed",{requestName:t,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function jm({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function $v(t,{refreshToken:e}){const s=jm(t);return s.append("Authorization",Lv(e)),s}async function Hm(t){const e=await t();return e.status>=500&&e.status<600?t():e}function Dv(t){return Number(t.replace("s","000"))}function Lv(t){return`${Bm} ${t}`}async function Rv({appConfig:t,heartbeatServiceProvider:e},{fid:s}){const n=Fm(t),o=jm(t),r=e.getImmediate({optional:!0});if(r){const d=await r.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const a={fid:s,authVersion:Bm,appId:t.appId,sdkVersion:Nm},l={method:"POST",headers:o,body:JSON.stringify(a)},c=await Hm(()=>fetch(n,l));if(c.ok){const d=await c.json();return{fid:d.fid||s,registrationStatus:2,refreshToken:d.refreshToken,authToken:Om(d.authToken)}}else throw await qm("Create Installation",c)}function Um(t){return new Promise(e=>{setTimeout(e,t)})}function Mv(t){return btoa(String.fromCharCode(...t)).replace(/\+/g,"-").replace(/\//g,"_")}const Nv=/^[cdef][\w-]{21}$/,Qa="";function Bv(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const s=Vv(t);return Nv.test(s)?s:Qa}catch{return Qa}}function Vv(t){return Mv(t).substr(0,22)}function Sr(t){return`${t.appName}!${t.appId}`}const zm=new Map;function Wm(t,e){const s=Sr(t);Gm(s,e),Fv(s,e)}function Gm(t,e){const s=zm.get(t);if(s)for(const n of s)n(e)}function Fv(t,e){const s=Ov();s&&s.postMessage({key:t,fid:e}),qv()}let Yt=null;function Ov(){return!Yt&&"BroadcastChannel"in self&&(Yt=new BroadcastChannel("[Firebase] FID Change"),Yt.onmessage=t=>{Gm(t.data.key,t.data.fid)}),Yt}function qv(){zm.size===0&&Yt&&(Yt.close(),Yt=null)}const jv="firebase-installations-database",Hv=1,us="firebase-installations-store";let ga=null;function Ui(){return ga||(ga=mr(jv,Hv,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(us)}}})),ga}async function er(t,e){const s=Sr(t),o=(await Ui()).transaction(us,"readwrite"),r=o.objectStore(us),a=await r.get(s);return await r.put(e,s),await o.done,(!a||a.fid!==e.fid)&&Wm(t,e.fid),e}async function Km(t){const e=Sr(t),n=(await Ui()).transaction(us,"readwrite");await n.objectStore(us).delete(e),await n.done}async function Tr(t,e){const s=Sr(t),o=(await Ui()).transaction(us,"readwrite"),r=o.objectStore(us),a=await r.get(s),l=e(a);return l===void 0?await r.delete(s):await r.put(l,s),await o.done,l&&(!a||a.fid!==l.fid)&&Wm(t,l.fid),l}async function zi(t){let e;const s=await Tr(t.appConfig,n=>{const o=Uv(n),r=zv(t,o);return e=r.registrationPromise,r.installationEntry});return s.fid===Qa?{installationEntry:await e}:{installationEntry:s,registrationPromise:e}}function Uv(t){const e=t||{fid:Bv(),registrationStatus:0};return Jm(e)}function zv(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(ds.create("app-offline"));return{installationEntry:e,registrationPromise:o}}const s={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},n=Wv(t,s);return{installationEntry:s,registrationPromise:n}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:Gv(t)}:{installationEntry:e}}async function Wv(t,e){try{const s=await Rv(t,e);return er(t.appConfig,s)}catch(s){throw Vm(s)&&s.customData.serverCode===409?await Km(t.appConfig):await er(t.appConfig,{fid:e.fid,registrationStatus:0}),s}}async function Gv(t){let e=await wd(t.appConfig);for(;e.registrationStatus===1;)await Um(100),e=await wd(t.appConfig);if(e.registrationStatus===0){const{installationEntry:s,registrationPromise:n}=await zi(t);return n||s}return e}function wd(t){return Tr(t,e=>{if(!e)throw ds.create("installation-not-found");return Jm(e)})}function Jm(t){return Kv(t)?{fid:t.fid,registrationStatus:0}:t}function Kv(t){return t.registrationStatus===1&&t.registrationTime+Mm<Date.now()}async function Jv({appConfig:t,heartbeatServiceProvider:e},s){const n=Qv(t,s),o=$v(t,s),r=e.getImmediate({optional:!0});if(r){const d=await r.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const a={installation:{sdkVersion:Nm,appId:t.appId}},l={method:"POST",headers:o,body:JSON.stringify(a)},c=await Hm(()=>fetch(n,l));if(c.ok){const d=await c.json();return Om(d)}else throw await qm("Generate Auth Token",c)}function Qv(t,{fid:e}){return`${Fm(t)}/${e}/authTokens:generate`}async function Wi(t,e=!1){let s;const n=await Tr(t.appConfig,r=>{if(!Qm(r))throw ds.create("not-registered");const a=r.authToken;if(!e&&Zv(a))return r;if(a.requestStatus===1)return s=Xv(t,e),r;{if(!navigator.onLine)throw ds.create("app-offline");const l=ty(r);return s=Yv(t,l),l}});return s?await s:n.authToken}async function Xv(t,e){let s=await Ed(t.appConfig);for(;s.authToken.requestStatus===1;)await Um(100),s=await Ed(t.appConfig);const n=s.authToken;return n.requestStatus===0?Wi(t,e):n}function Ed(t){return Tr(t,e=>{if(!Qm(e))throw ds.create("not-registered");const s=e.authToken;return sy(s)?{...e,authToken:{requestStatus:0}}:e})}async function Yv(t,e){try{const s=await Jv(t,e),n={...e,authToken:s};return await er(t.appConfig,n),s}catch(s){if(Vm(s)&&(s.customData.serverCode===401||s.customData.serverCode===404))await Km(t.appConfig);else{const n={...e,authToken:{requestStatus:0}};await er(t.appConfig,n)}throw s}}function Qm(t){return t!==void 0&&t.registrationStatus===2}function Zv(t){return t.requestStatus===2&&!ey(t)}function ey(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+Cv}function ty(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function sy(t){return t.requestStatus===1&&t.requestTime+Mm<Date.now()}async function ny(t){const e=t,{installationEntry:s,registrationPromise:n}=await zi(e);return n?n.catch(console.error):Wi(e).catch(console.error),s.fid}async function oy(t,e=!1){const s=t;return await ry(s),(await Wi(s,e)).token}async function ry(t){const{registrationPromise:e}=await zi(t);e&&await e}function ay(t){if(!t||!t.options)throw fa("App Configuration");if(!t.name)throw fa("App Name");const e=["projectId","apiKey","appId"];for(const s of e)if(!t.options[s])throw fa(s);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function fa(t){return ds.create("missing-app-config-values",{valueName:t})}const Xm="installations",iy="installations-internal",ly=t=>{const e=t.getProvider("app").getImmediate(),s=ay(e),n=ku(e,"heartbeat");return{app:e,appConfig:s,heartbeatServiceProvider:n,_delete:()=>Promise.resolve()}},cy=t=>{const e=t.getProvider("app").getImmediate(),s=ku(e,Xm).getImmediate();return{getId:()=>ny(s),getToken:o=>oy(s,o)}};function dy(){Lt(new Dt(Xm,ly,"PUBLIC")),Lt(new Dt(iy,cy,"PRIVATE"))}dy();gt(Rm,Hi);gt(Rm,Hi,"esm2020");const uy="/firebase-messaging-sw.js",my="/firebase-cloud-messaging-push-scope",Ym="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",py="https://fcmregistrations.googleapis.com/v1",Zm="google.c.a.c_id",hy="google.c.a.c_l",gy="google.c.a.ts",fy="google.c.a.e",Id=1e4;var Sd;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Sd||(Sd={}));var Bn;(function(t){t.PUSH_RECEIVED="push-received",t.NOTIFICATION_CLICKED="notification-clicked"})(Bn||(Bn={}));function ct(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function by(t){const e="=".repeat((4-t.length%4)%4),s=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),n=atob(s),o=new Uint8Array(n.length);for(let r=0;r<n.length;++r)o[r]=n.charCodeAt(r);return o}const ba="fcm_token_details_db",vy=5,Td="fcm_token_object_Store";async function yy(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(ba))return null;let e=null;return(await mr(ba,vy,{upgrade:async(n,o,r,a)=>{if(o<2||!n.objectStoreNames.contains(Td))return;const l=a.objectStore(Td),c=await l.index("fcmSenderId").get(t);if(await l.clear(),!!c){if(o===2){const d=c;if(!d.auth||!d.p256dh||!d.endpoint)return;e={token:d.fcmToken,createTime:d.createTime??Date.now(),subscriptionOptions:{auth:d.auth,p256dh:d.p256dh,endpoint:d.endpoint,swScope:d.swScope,vapidKey:typeof d.vapidKey=="string"?d.vapidKey:ct(d.vapidKey)}}}else if(o===3){const d=c;e={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:ct(d.auth),p256dh:ct(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:ct(d.vapidKey)}}}else if(o===4){const d=c;e={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:ct(d.auth),p256dh:ct(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:ct(d.vapidKey)}}}}}})).close(),await la(ba),await la("fcm_vapid_details_db"),await la("undefined"),xy(e)?e:null}function xy(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}const wy="firebase-messaging-database",Ey=1,Vn="firebase-messaging-store";let va=null;function ep(){return va||(va=mr(wy,Ey,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Vn)}}})),va}async function Iy(t){const e=tp(t),n=await(await ep()).transaction(Vn).objectStore(Vn).get(e);if(n)return n;{const o=await yy(t.appConfig.senderId);if(o)return await Gi(t,o),o}}async function Gi(t,e){const s=tp(t),o=(await ep()).transaction(Vn,"readwrite");return await o.objectStore(Vn).put(e,s),await o.done,e}function tp({appConfig:t}){return t.appId}const Sy={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"only-available-in-window":"This method is available in a Window context.","only-available-in-sw":"This method is available in a service worker context.","permission-default":"The notification permission was not granted and dismissed instead.","permission-blocked":"The notification permission was not granted and blocked instead.","unsupported-browser":"This browser doesn't support the API's required to use the Firebase SDK.","indexed-db-unsupported":"This browser doesn't support indexedDb.open() (ex. Safari iFrame, Firefox Private Browsing, etc)","failed-service-worker-registration":"We are unable to register the default service worker. {$browserErrorMessage}","token-subscribe-failed":"A problem occurred while subscribing the user to FCM: {$errorInfo}","token-subscribe-no-token":"FCM returned no token when subscribing the user to push.","token-unsubscribe-failed":"A problem occurred while unsubscribing the user from FCM: {$errorInfo}","token-update-failed":"A problem occurred while updating the user from FCM: {$errorInfo}","token-update-no-token":"FCM returned no token when updating the user to push.","use-sw-after-get-token":"The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.","invalid-sw-registration":"The input to useServiceWorker() must be a ServiceWorkerRegistration.","invalid-bg-handler":"The input to setBackgroundMessageHandler() must be a function.","invalid-vapid-key":"The public VAPID key must be a string.","use-vapid-key-after-get-token":"The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."},qe=new ur("messaging","Messaging",Sy);async function Ty(t,e){const s=await Ji(t),n=sp(e),o={method:"POST",headers:s,body:JSON.stringify(n)};let r;try{r=await(await fetch(Ki(t.appConfig),o)).json()}catch(a){throw qe.create("token-subscribe-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw qe.create("token-subscribe-failed",{errorInfo:a})}if(!r.token)throw qe.create("token-subscribe-no-token");return r.token}async function ky(t,e){const s=await Ji(t),n=sp(e.subscriptionOptions),o={method:"PATCH",headers:s,body:JSON.stringify(n)};let r;try{r=await(await fetch(`${Ki(t.appConfig)}/${e.token}`,o)).json()}catch(a){throw qe.create("token-update-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw qe.create("token-update-failed",{errorInfo:a})}if(!r.token)throw qe.create("token-update-no-token");return r.token}async function Cy(t,e){const n={method:"DELETE",headers:await Ji(t)};try{const r=await(await fetch(`${Ki(t.appConfig)}/${e}`,n)).json();if(r.error){const a=r.error.message;throw qe.create("token-unsubscribe-failed",{errorInfo:a})}}catch(o){throw qe.create("token-unsubscribe-failed",{errorInfo:o?.toString()})}}function Ki({projectId:t}){return`${py}/projects/${t}/registrations`}async function Ji({appConfig:t,installations:e}){const s=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":`FIS ${s}`})}function sp({p256dh:t,auth:e,endpoint:s,vapidKey:n}){const o={web:{endpoint:s,auth:e,p256dh:t}};return n!==Ym&&(o.web.applicationPubKey=n),o}const _y=10080*60*1e3;async function Ay(t){const e=await $y(t.swRegistration,t.vapidKey),s={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:ct(e.getKey("auth")),p256dh:ct(e.getKey("p256dh"))},n=await Iy(t.firebaseDependencies);if(n){if(Dy(n.subscriptionOptions,s))return Date.now()>=n.createTime+_y?Py(t,{token:n.token,createTime:Date.now(),subscriptionOptions:s}):n.token;try{await Cy(t.firebaseDependencies,n.token)}catch(o){console.warn(o)}return kd(t.firebaseDependencies,s)}else return kd(t.firebaseDependencies,s)}async function Py(t,e){try{const s=await ky(t.firebaseDependencies,e),n={...e,token:s,createTime:Date.now()};return await Gi(t.firebaseDependencies,n),s}catch(s){throw s}}async function kd(t,e){const n={token:await Ty(t,e),createTime:Date.now(),subscriptionOptions:e};return await Gi(t,n),n.token}async function $y(t,e){const s=await t.pushManager.getSubscription();return s||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:by(e)})}function Dy(t,e){const s=e.vapidKey===t.vapidKey,n=e.endpoint===t.endpoint,o=e.auth===t.auth,r=e.p256dh===t.p256dh;return s&&n&&o&&r}function Cd(t){const e={from:t.from,collapseKey:t.collapse_key,messageId:t.fcmMessageId};return Ly(e,t),Ry(e,t),My(e,t),e}function Ly(t,e){if(!e.notification)return;t.notification={};const s=e.notification.title;s&&(t.notification.title=s);const n=e.notification.body;n&&(t.notification.body=n);const o=e.notification.image;o&&(t.notification.image=o);const r=e.notification.icon;r&&(t.notification.icon=r)}function Ry(t,e){e.data&&(t.data=e.data)}function My(t,e){if(!e.fcmOptions&&!e.notification?.click_action)return;t.fcmOptions={};const s=e.fcmOptions?.link??e.notification?.click_action;s&&(t.fcmOptions.link=s);const n=e.fcmOptions?.analytics_label;n&&(t.fcmOptions.analyticsLabel=n)}function Ny(t){return typeof t=="object"&&!!t&&Zm in t}function By(t){if(!t||!t.options)throw ya("App Configuration Object");if(!t.name)throw ya("App Name");const e=["projectId","apiKey","appId","messagingSenderId"],{options:s}=t;for(const n of e)if(!s[n])throw ya(n);return{appName:t.name,projectId:s.projectId,apiKey:s.apiKey,appId:s.appId,senderId:s.messagingSenderId}}function ya(t){return qe.create("missing-app-config-values",{valueName:t})}class Vy{constructor(e,s,n){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const o=By(e);this.firebaseDependencies={app:e,appConfig:o,installations:s,analyticsProvider:n}}_delete(){return Promise.resolve()}}async function Fy(t){try{t.swRegistration=await navigator.serviceWorker.register(uy,{scope:my}),t.swRegistration.update().catch(()=>{}),await Oy(t.swRegistration)}catch(e){throw qe.create("failed-service-worker-registration",{browserErrorMessage:e?.message})}}async function Oy(t){return new Promise((e,s)=>{const n=setTimeout(()=>s(new Error(`Service worker not registered after ${Id} ms`)),Id),o=t.installing||t.waiting;t.active?(clearTimeout(n),e()):o?o.onstatechange=r=>{r.target?.state==="activated"&&(o.onstatechange=null,clearTimeout(n),e())}:(clearTimeout(n),s(new Error("No incoming service worker found.")))})}async function qy(t,e){if(!e&&!t.swRegistration&&await Fy(t),!(!e&&t.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw qe.create("invalid-sw-registration");t.swRegistration=e}}async function jy(t,e){e?t.vapidKey=e:t.vapidKey||(t.vapidKey=Ym)}async function np(t,e){if(!navigator)throw qe.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw qe.create("permission-blocked");return await jy(t,e?.vapidKey),await qy(t,e?.serviceWorkerRegistration),Ay(t)}async function Hy(t,e,s){const n=Uy(e);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(n,{message_id:s[Zm],message_name:s[hy],message_time:s[gy],message_device_time:Math.floor(Date.now()/1e3)})}function Uy(t){switch(t){case Bn.NOTIFICATION_CLICKED:return"notification_open";case Bn.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}async function zy(t,e){const s=e.data;if(!s.isFirebaseMessaging)return;t.onMessageHandler&&s.messageType===Bn.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(Cd(s)):t.onMessageHandler.next(Cd(s)));const n=s.data;Ny(n)&&n[fy]==="1"&&await Hy(t,s.messageType,n)}const _d="@firebase/messaging",Ad="0.12.23";const Wy=t=>{const e=new Vy(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",s=>zy(e,s)),e},Gy=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:n=>np(e,n)}};function Ky(){Lt(new Dt("messaging",Wy,"PUBLIC")),Lt(new Dt("messaging-internal",Gy,"PRIVATE")),gt(_d,Ad),gt(_d,Ad,"esm2020")}function Jy(t,e){if(!navigator)throw qe.create("only-available-in-window");return t.onMessageHandler=e,()=>{t.onMessageHandler=null}}async function Qy(t,e){return t=yt(t),np(t,e)}function Xy(t,e){return t=yt(t),Jy(t,e)}Ky();const Yy="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Pd=!1;async function op(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await Be.removeAllListeners(),await Be.addListener("registration",async s=>{rp(s.value,!0)}),await Be.addListener("pushNotificationReceived",s=>{});let e=await Be.checkPermissions();e.receive==="prompt"&&(e=await Be.requestPermissions()),e.receive==="granted"&&await Be.register()}catch(e){console.error(e)}return}"Notification"in window&&(Notification.permission==="granted"?Zy():Notification.permission==="default"&&console.log("[Push Web] Aguardando interação do utilizador para pedir permissão (iOS Requirement)."))}async function Zy(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js"),e=await Qy(mc,{vapidKey:Yy,serviceWorkerRegistration:t});e&&(console.log("[Push Web] Token:",e),await rp(e,!1)),Pd||(Xy(mc,s=>{console.log("[Push Web] Foreground:",s),s.notification&&k(s.notification.title,s.notification.body,"info",!0)}),Pd=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}}async function rp(t,e){const s=_e.currentUser;if(s)try{const n=cv(Ae,"users",s.uid);try{await Sv(n,{fcmTokens:Tv(t),lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"})}catch(o){o.code==="not-found"&&await Iv(n,{email:s.email,fcmTokens:[t],platform:e?"android_native":"pwa_web"},{merge:!0})}}catch(n){console.error(n)}}const ex=(t,e,s="all",n="all")=>{const o=new URLSearchParams({startDate:t,endDate:e});return s&&s!=="all"&&o.append("professionalId",s),n&&n!=="all"&&o.append("costCenterId",n),F(`/api/reports/indicators?${o.toString()}`)},tx=t=>t?F(`/api/financial/cost-centers/${t}`):Promise.resolve([]),sx=({establishmentId:t,startDate:e,endDate:s,cashierSessionId:n})=>{const o=new URLSearchParams({startDate:e,endDate:s});return n&&n!=="all"&&o.append("cashierSessionId",n),t&&o.append("establishmentId",t),F(`/api/reports/sales?${o.toString()}`)},nx=()=>F("/api/reports/summary",{method:"GET"}),kr=(t,e,s,n="all")=>{const o=`/api/blockages/${t}?startDate=${e}&endDate=${s}&professionalId=${n}`;return F(o)},Cr=t=>F("/api/blockages",{method:"POST",body:JSON.stringify(t)}),Qi=t=>F(`/api/blockages/${t}`,{method:"DELETE"}),ap=t=>F("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Jn=(t,e="",s=null)=>{let n=`/api/clients/${t}`;const o=[];return e&&e.trim().length>0&&o.push(`search=${encodeURIComponent(e.trim())}`),s&&o.push(`limit=${s}`),o.length>0&&(n+=`?${o.join("&")}`),F(n)},Xi=t=>F("/api/clients",{method:"POST",body:JSON.stringify(t)}),ip=(t,e)=>F(`/api/clients/${t}`,{method:"PUT",body:JSON.stringify(e)}),ox=t=>F(`/api/clients/${t}`,{method:"DELETE"}),$d=(t,e,s)=>{const n=encodeURIComponent(e),o=encodeURIComponent(s),r=`/api/clients/history/${t}?clientName=${n}&clientPhone=${o}`;return F(r)},rx=(t,e,s)=>{const n=encodeURIComponent(e),o=encodeURIComponent(s),r=`/api/clients/loyalty-history/${t}?clientName=${n}&clientPhone=${o}`;return F(r)},ax=(t,e,s,n)=>F("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientName:e,clientPhone:s,rewardData:n})});function A(t){return t==null?"":String(t).replace(/[&<>'"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[e])}function lp(t,e=800,s=800,n=.7){return new Promise((o,r)=>{if(!t.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const a=new FileReader;a.readAsDataURL(t),a.onload=l=>{const c=new Image;c.src=l.target.result,c.onload=()=>{let d=c.width,p=c.height;d>p?d>e&&(p*=e/d,d=e):p>s&&(d*=s/p,p=s);const h=document.createElement("canvas");h.width=d,h.height=p,h.getContext("2d").drawImage(c,0,0,d,p);const y=h.toDataURL("image/jpeg",n);o(y)},c.onerror=d=>r(new Error("Erro ao carregar a imagem para processamento."))},a.onerror=l=>r(new Error("Erro ao ler o ficheiro."))})}const Dd=document.getElementById("content");let Ld=!1;const Xa=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let Qn=[],_r=[],Os={},Ps=[],K={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},j={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function ix(t){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(t).replace(/\./g,"")}function cp(t){const e=new Date(t);if(e.setHours(0,0,0,0),K.currentView==="week"&&K.weekViewDays===7){const s=e.getDay(),n=e.getDate()-s+(s===0?-6:1);return new Date(e.setDate(n))}return e}function tr(){const t=document.getElementById("profSelectorContainer"),e=K.profSearchTerm.toLowerCase();if(!t||!w.professionals)return;let s=w.professionals.filter(r=>K.showInactiveProfs||r.status!=="inactive");e&&(s=s.filter(r=>r.name.toLowerCase().includes(e)));const o=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...s];t.innerHTML=o.map(r=>{const a=K.selectedProfessionalId===r.id,l=r.name==="Todos"?"Todos":r.name.split(" ")[0],c=r.name==="Todos"?"T":r.name.charAt(0).toUpperCase(),d=r.status!=="inactive",p=A(l),h=Xa[0],f=r.id!=="all"&&w.professionalColors.get(r.id)||h,y=r.photo||`https://placehold.co/64x64/${f.main?.replace("#","")||"E0E7FF"}/${f.light?.replace("#","")||"4F46E5"}?text=${c}`,I=r.id==="all"?"#e0e7ff":f.light,_=r.id==="all"?"#4f46e5":f.main,R=`border: 3px solid ${a?f.border:"transparent"}; box-shadow: ${a?"0 0 0 2px "+f.border:"none"};`;return`
        ...
        `}).join("")}function lx(t,e,s,n,o){const r=(t||"").replace(/\D/g,""),a=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),l=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),c=`Olá, ${e}! Você tem um agendamento de ${s} com o(a) profissional ${n} para o dia ${a} às ${l}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(c);return`https://wa.me/${r}?text=${d}`}function cx(t){const e=document.getElementById("agenda-view");if(!e)return;if(t.sort((n,o)=>new Date(n.startTime)-new Date(o.startTime)),t.length===0){e.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const s=t.map(n=>{const o=new Date(n.startTime),r=new Date(n.endTime),a=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),c=w.professionalColors.get(n.professionalId)||{},d=A(n.reason),p=A(n.professionalName),h=A(n.clientName),f=A(n.serviceName);if(n.type==="blockage")return`
                ...
                </div>`;const y=n.status==="completed",I=y?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",_=y?"Finalizado":"Aberto",D=JSON.stringify(n).replace(/'/g,"&apos;"),R=n.redeemedReward?.points>0,O=n.hasRewards&&!R,N=lx(n.clientPhone,n.clientName,n.serviceName,n.professionalName,n.startTime);return`
    ...
    `;return{title:t,content:e}}function Ix(t){const e=t?"Confirmar Edição":"Data e Horário",s=new Date,n=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`,o=j.data.date||n,r=A(j.data.clientName),a=A(j.data.professionalName),l=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:e,content:l}}function Sx(t){const e=document.getElementById("apptServicesContainer");if(!e)return;const s=t.toLowerCase(),n=Qn.filter(o=>o.name.toLowerCase().includes(s));e.innerHTML=n.map(o=>{const r=j.data.selectedServiceIds.includes(o.id),a=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),e.querySelectorAll(".service-card").forEach(o=>{o.addEventListener("click",()=>dp(o.dataset.serviceId,o))})}function Tx(t){const e=document.getElementById("apptProfessionalContainer");if(!e)return;const s=t.toLowerCase(),n=_r.filter(o=>o.name.toLowerCase().includes(s));e.innerHTML=n.map(o=>{const r=j.data.professionalId===o.id,a=o.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",l=A(o.name);return`
                ...
                ${Object.values(l).map(h=>`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-800 line-clamp-1">${A(h.name)}</p>
                                <p class="text-xs text-gray-500">R$ ${(h.price||0).toFixed(2)} un.</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
    ...
    `}function Ox(){Me({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",qx)}async function qx(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const s=e.querySelector('button[type="submit"]'),n={establishmentId:w.establishmentId,name:e.querySelector("#regClientName").value.trim(),email:e.querySelector("#regClientEmail").value.trim()||null,phone:e.querySelector("#regClientPhone").value.trim(),dob:`${e.querySelector("#regClientDobDay").value.trim()}/${e.querySelector("#regClientDobMonth").value.trim()}`,notes:e.querySelector("#regClientNotes").value.trim()||null};if(!n.name||!n.phone)return k("Erro de Validação","Nome e Telefone são obrigatórios.","error");s.disabled=!0,s.textContent="A salvar...";try{const o=await Xi(n);V.clients.push({id:o.id,...n}),k("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",fp(o.id)}catch(o){k(`Erro ao cadastrar cliente: ${o.message}`,"error")}finally{s.disabled=!1,s.textContent="Salvar Cliente"}}function jx(){if(!V.isCashierOpen){k("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:t,close:e}=Me({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),s=()=>{let o="";const r=t.querySelector("#add-item-content"),a={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},l=()=>{const c=o.toLowerCase(),d=h=>h.filter(f=>f.name.toLowerCase().includes(c)),p={"modal-service-list":{items:d(V.catalog.services),type:"service"},"modal-product-list":{items:d(V.catalog.products),type:"product"},"modal-package-list":{items:d(V.catalog.packages),type:"package"}};for(const[h,{items:f,type:y}]of Object.entries(p)){const I=r.querySelector(`#${h}`);I&&(I.innerHTML=f.map(_=>`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{r>1&&(r--,l())},document.getElementById("quantity-plus-btn").onclick=()=>{r++,l()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Gx(o,r),e()}};t.addEventListener("click",o=>{const r=o.target.closest('[data-action="select-item-for-quantity"]'),a=o.target.closest('[data-action="back-to-catalog"]');if(r){const{itemType:l,itemId:c}=r.dataset,p=(V.catalog[l+"s"]||[]).find(h=>h.id===c);p&&n({...p,type:l})}else a&&s()}),s()}async function fp(t=null){if(!V.isCashierOpen){k("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!V.clients||V.clients.length===0)try{V.clients=await Jn(w.establishmentId)}catch{k("Erro","Não foi possível carregar dados de clientes.","error");return}if(!w.professionals||w.professionals.length===0)try{w.professionals=await Ge(w.establishmentId)}catch{k("Erro","Não foi possível carregar dados de profissionais.","error");return}const e=V.clients.map(a=>{const l=a.id===t?"selected":"";return`<option value="${a.id}" ${l}>${A(a.name)} - ${A(a.phone)}</option>`}).join(""),s=w.professionals.map(a=>`<option value="${a.id}">${A(a.name)}</option>`).join(""),n=`
    ...
    `,{modalElement:o}=Me({title:"Nova Venda Avulsa",contentHTML:n,maxWidth:"max-w-md"});o.querySelector("#new-sale-form").addEventListener("submit",Qx);const r=o.querySelector('[data-action="new-client-from-sale"]');r&&r.addEventListener("click",a=>{a.preventDefault(),o.style.display="none",Ox()})}function Hx(){if(!V.isCashierOpen){k("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const t=V.allComandas.find(h=>h.id===V.selectedComandaId);if(!t)return;const e=Ar(t),s=new Set,n=[];for(const h of e){if(h.type==="service"&&h.id){if(s.has(h.id))continue;s.add(h.id)}n.push(h)}const o=n.reduce((h,f)=>h+(f.price||0),0);let r=[],a={remainingAmount:o,selectedMethod:"dinheiro",installments:1,amountReceived:""};const l=()=>{const h=document.getElementById("payment-list"),f=document.getElementById("remaining-amount"),y=document.getElementById("finalize-checkout-btn"),I=document.getElementById("change-container"),_=document.getElementById("installments-container"),D=document.getElementById("payment-value"),R=document.getElementById("payment-controls"),O=r.reduce((B,H)=>B+H.value,0);a.remainingAmount=o-O,h.innerHTML=r.map((B,H)=>`
    ...
    `,{modalElement:p}=Me({title:"Finalizar Pagamento",contentHTML:d,maxWidth:"max-w-md"});document.getElementById("payment-value").value=a.remainingAmount.toFixed(2),p.addEventListener("click",h=>{const f=h.target.closest(".payment-method-btn");f&&(a.selectedMethod=f.dataset.method,a.installments=1,document.getElementById("installments-select").value=1,l()),h.target.closest("#add-payment-btn")&&c(),h.target.closest('[data-action="remove-payment"]')&&(r.splice(parseInt(h.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),l()),h.target.closest("#finalize-checkout-btn")&&Jx(t,o,r)}),p.addEventListener("change",h=>{h.target.id==="installments-select"&&(a.installments=parseInt(h.target.value,10))}),p.addEventListener("input",h=>{h.target.id==="amount-received"&&(a.amountReceived=h.target.value,l())}),l()}async function Ux(){const t=`
    ...
    `,{modalElement:e}=Me({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-md"});e.querySelector("#open-cashier-form").addEventListener("submit",async s=>{s.preventDefault();const n=document.getElementById("initial-amount"),o=n.value.trim(),r=document.getElementById("cashier-notes").value.trim(),a=parseFloat(o);if(o===""||isNaN(a)||a<0){k("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),n.focus();return}try{const l={establishmentId:w.establishmentId,initialAmount:parseFloat(a.toFixed(2))};r&&(l.notes=r);const c=await Px(l);V.isCashierOpen=!0,V.activeCashierSessionId=c.id,await Zi(),document.getElementById("genericModal").style.display="none",k("Sucesso!",`Caixa aberto com valor inicial de R$ ${a.toFixed(2)}`,"success")}catch(l){k("Erro",`Não foi possível abrir o caixa: ${l.message}`,"error")}})}async function zx(){const t=V.activeCashierSessionId;if(t)try{const e=await Lx(t),s=`
        ...
        `,{modalElement:n}=Me({title:"Fechar Caixa",contentHTML:s,maxWidth:"max-w-md"});n.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const r=parseFloat(document.getElementById("final-amount").value);if(isNaN(r)||r<0){k("Valor Inválido","Insira um valor final válido.","error");return}try{await $x(t,r),V.isCashierOpen=!1,V.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await Zi(),k("Sucesso!","Caixa fechado com sucesso!","success")}catch(a){k("Erro",`Não foi possível fechar o caixa: ${a.message}`,"error")}})}catch(e){k("Erro",`Não foi possível carregar o relatório de fecho: ${e.message}`,"error")}}async function Wx(t){V.activeFilter!==t&&(V.activeFilter=t,V.paging.page=1,document.querySelectorAll(".filter-btn").forEach(e=>e.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${t}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",t!=="finalizadas"),Jt(),await ut(),V.selectedComandaId=null,Xe())}function ei(t){V.selectedComandaId=t,Vt(),Bx(),Xe()}async function Gx(t,e){const s=V.allComandas.find(o=>o.id===V.selectedComandaId);if(!s)return;const n=Array(e).fill(0).map(()=>({id:t.id,name:t.name,price:t.price,type:t.type}));if(s.comandaItems=s.comandaItems||[],s.comandaItems.push(...n),s.type==="walk-in"&&s.id.startsWith("temp-")){k("Sucesso",`${e}x ${t.name} adicionado(s)!`,"success"),Xe(),Vt();return}try{await ui(s.id,s),k("Sucesso",`${e}x ${t.name} adicionado(s)!`,"success"),Xe(),Vt()}catch(o){k("Erro",`Não foi possível adicionar o item: ${o.message}`,"error"),s.comandaItems.splice(s.comandaItems.length-e,e)}}async function Kx(t,e){const s=V.allComandas.find(r=>r.id===V.selectedComandaId);if(!s)return;let n=!1,o=(s.comandaItems||[]).findIndex(r=>r.id===t&&r.type===e);if(o>-1)s.comandaItems.splice(o,1),n=!0;else{let r=(s.services||[]).findIndex(a=>a.id===t);if(r>-1)s.services.splice(r,1),n=!0;else{let a=(s.items||[]).findIndex(l=>l.id===t&&l.type===e);a>-1&&(s.items.splice(a,1),n=!0)}}if(n){if(s.type==="walk-in"&&s.id.startsWith("temp-")){k("Sucesso","Item removido!","success"),Xe(),Vt();return}try{await ui(s.id,s),k("Sucesso","Item removido!","success"),Xe(),Vt()}catch(r){k("Erro",`Não foi possível remover o item: ${r.message}`,"error"),await ut()}}}async function Jx(t,e,s){const n=t.type==="appointment",o=Ar(t),r=new Set,a=[];for(const c of o){if(c.type==="service"&&c.id){if(r.has(c.id))continue;r.add(c.id)}a.push(c)}const l={payments:s,totalAmount:e,items:a,cashierSessionId:V.activeCashierSessionId};try{n?await $h(t.id,l):(l.establishmentId=w.establishmentId,l.clientName=t.clientName,l.professionalId=t.professionalId,l.clientPhone=t.clientPhone,await Cx(l)),k("Sucesso!","Venda finalizada com sucesso!","success"),document.getElementById("genericModal").style.display="none",Jt(),V.selectedComandaId=null,await ut()}catch(c){k("Erro no Checkout",c.message,"error")}}async function Qx(t){t.preventDefault();const e=document.getElementById("new-sale-client").value,s=document.getElementById("new-sale-professional").value,n=V.clients.find(a=>a.id===e),o=w.professionals.find(a=>a.id===s);if(!n||!o){k("Erro","Selecione um cliente e um profissional válidos.","error");return}const r={id:`temp-${Date.now()}`,type:"walk-in",clientName:n.name,clientPhone:n.phone,professionalId:o.id,professionalName:o.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};V.allComandas.unshift(r),V.selectedComandaId=r.id,document.getElementById("genericModal").style.display="none",ei(r.id)}async function ut(){const t=document.getElementById("comandas-list");t.innerHTML='<div class="loader mx-auto mt-10"></div>';const e=V.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const s=await hp();if(V.isCashierOpen=!!s,V.activeCashierSessionId=s?s.id:null,Fx(),!V.isCashierOpen&&V.activeFilter==="atendimento"){Vt(),Xe();return}const n=await kx(w.establishmentId,e,V.paging.page,V.paging.limit);if(V.allComandas=n.data||n,V.paging.total=n.total||n.length,V.catalog.services.length===0){const[o,r,a,l,c]=await Promise.all([ps(w.establishmentId),dr(w.establishmentId),gp(w.establishmentId),Jn(w.establishmentId),Ge(w.establishmentId)]);V.catalog={services:o,products:r,packages:a},V.clients=l,w.professionals=c}Vt(),V.selectedComandaId,Xe()}catch(s){k("Erro de Carregamento",`Não foi possível carregar os dados: ${s.message}`,"error"),t.innerHTML=`<p class="text-red-500 p-4">${s.message}</p>`}}async function Zi(t={}){Ss=document.getElementById("content");try{const e=await hp();V.isCashierOpen=!!e,V.activeCashierSessionId=e?e.id:null}catch(e){console.error("Erro ao verificar caixa:",e),V.isCashierOpen=!1}V.selectedComandaId=t.selectedAppointmentId||null,Vx(),xs&&(Ss.removeEventListener("click",xs),Ss.removeEventListener("change",xs)),xs=async e=>{const s=e.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(e.target.id==="filter-date"&&V.activeFilter==="finalizadas"){V.paging.page=1,await ut();return}if(s){if(s.matches("[data-filter]"))Wx(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(e.target.closest('[data-action="go-to-appointment"]')){e.stopPropagation();return}ei(s.dataset.comandaId)}else if(s.matches("[data-action]")){const n=s.dataset.action,o=s.dataset.id||V.selectedComandaId;switch(n){case"back-to-list":{Jt(),V.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(r=>r.classList.remove("selected")),Xe();break}case"new-sale":fp();break;case"add-item":jx();break;case"checkout":Hx();break;case"open-cashier":Ux();break;case"close-cashier":await zx();break;case"view-sales-report":Ye("sales-report-section");break;case"remove-item":await Kx(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await le("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await Ph(o);const a=V.allComandas.findIndex(l=>l.id===o);a!==-1&&(delete V.allComandas[a].transaction,delete V.allComandas[a].cashierSessionId,delete V.allComandas[a].redeemedReward,V.allComandas[a].status="confirmed"),V.selectedComandaId=null,Jt(),k("Sucesso!","Comanda reaberta para edição.","success"),await ut()}catch(a){k("Erro",`Não foi possível reabrir: ${a.message}`,"error")}break}case"reopen-walk-in":{if(await le("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await _x(o),k("Sucesso!","Venda revertida."),Jt(),V.selectedComandaId=null,await ut()}catch(a){k("Erro",`Não foi possível reabrir: ${a.message}`,"error")}break}case"go-to-appointment":{const r=s.dataset.id,a=s.dataset.date;Ye("agenda-section",{scrollToAppointmentId:r,targetDate:new Date(a)});break}case"delete-walk-in":{if(await le("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(o.startsWith("temp-"))V.allComandas=V.allComandas.filter(a=>a.id!==o),V.selectedComandaId=null,Vt(),Xe(),k("Sucesso","Venda avulsa removida.","success"),Jt();else try{await Ax(o),k("Sucesso","Venda avulsa excluída com sucesso.","success"),V.selectedComandaId=null,Jt(),await ut()}catch(a){k("Erro",`Não foi possível excluir: ${a.message}`,"error")}break}}}}},Ss.addEventListener("click",xs),Ss.addEventListener("change",xs),t.initialFilter&&(V.activeFilter=t.initialFilter==="finalizadas"?"finalizadas":"atendimento"),t.selectedAppointmentId&&(V.selectedComandaId=t.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(e=>e.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${V.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",V.activeFilter!=="finalizadas"),t.filterDate&&(document.getElementById("filter-date").value=new Date(t.filterDate).toISOString().split("T")[0]),await ut(),V.selectedComandaId&&ei(V.selectedComandaId)}const ti=document.getElementById("content");let xa={};const xo=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],te={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],currentTab:"dashboards"};async function Xx(){if(!window.Chart)return new Promise((t,e)=>{const s=document.createElement("script");s.src="https://cdn.jsdelivr.net/npm/chart.js",s.onload=t,s.onerror=e,document.head.appendChild(s)})}async function Yx(){ti.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">A carregar inteligência de dados...</p></div>';try{await Xx();const[t,e]=await Promise.all([Ge(w.establishmentId),tx(w.establishmentId).catch(()=>[])]);te.professionalsList=t||[],te.costCentersList=e||[],Zx(),await bp()}catch(t){console.error("Erro no loadReportsPage:",t),ti.innerHTML=`
            ...
            </div>`}}function Zx(){const t=te.professionalsList.map(s=>`<option value="${s.id}">${A(s.name)}</option>`).join(""),e=te.costCentersList.map(s=>`<option value="${s.id}">${A(s.name)}</option>`).join("");ti.innerHTML=`
    ...
    `,document.getElementById("btn-filter").onclick=ew,document.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=()=>{te.currentTab=s.dataset.tab,Nd(),vp()}}),Nd()}function Nd(){document.querySelectorAll(".tab-btn").forEach(t=>{const e=t.dataset.tab===te.currentTab;t.className=e?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function ew(){te.startDate=document.getElementById("report-start").value,te.endDate=document.getElementById("report-end").value,te.selectedProfessional=document.getElementById("report-prof").value,te.selectedCostCenter=document.getElementById("report-cost").value,await bp()}async function bp(){const t=document.getElementById("report-content");t.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const e=ex(te.startDate,te.endDate,te.selectedProfessional,te.selectedCostCenter),s=te.selectedProfessional==="all"?null:te.selectedProfessional,n=new Date(te.startDate+"T00:00:00").toISOString(),o=new Date(te.endDate+"T23:59:59").toISOString(),r=pu(w.establishmentId,n,o,s).catch(c=>[]),[a,l]=await Promise.all([e,r]);te.data=a,te.appointmentsData=Array.isArray(l)?l:[],vp()}catch(e){console.error(e),t.innerHTML=`
            ...
            </div>`}}function vp(){const t=document.getElementById("report-content");if(te.data)switch(te.currentTab){case"dashboards":tw(t);break;case"appointments":sw(t);break;case"dre":nw(t);break}}function tw(t){const{dreSimple:e,charts:s}=te.data,n=e||{grossRevenue:0,netProfit:0,variableCosts:0},o=te.data.totalAppointments||0,r=o>0?n.grossRevenue/o:0;t.innerHTML=`
    ...
    `,hn("dailyApptChart","line","Agendamentos",h.map(I=>I.split("-").reverse().slice(0,2).join("/")),f,"#4f46e5")}function nw(t){const{dreFinancial:e}=te.data,s=Object.entries(e.revenues).map(([o,r])=>`
    ...
    `}function hn(t,e,s,n,o,r){const a=document.getElementById(t);if(!a)return;const l=a.getContext("2d");xa[t]&&xa[t].destroy();const c={type:e,data:{labels:n,datasets:[{label:s,data:o,backgroundColor:Array.isArray(r)?r:e==="line"?"rgba(79, 70, 229, 0.1)":r,borderColor:Array.isArray(r)?"#fff":r,borderWidth:2,fill:e==="line",tension:.3,borderRadius:e==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:r,pointHoverBackgroundColor:r}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:e==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let p=d.dataset.label||"";return p&&(p+=": "),d.parsed.y!==null?p+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):p+=d.raw,p}}}},scales:e==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};xa[t]=new Chart(l,c)}const Pr=(t,e="products")=>F(`/api/${e}/categories/${t}`),yp=(t,e="products")=>F(`/api/${e}/categories`,{method:"POST",body:JSON.stringify(t)}),xp=(t,e="products")=>F(`/api/${e}/categories/${t}`,{method:"DELETE"}),ow="audit_logs",qs=async(t,e,s,n,o,r=null)=>{try{if(!e)return;await cu($t(Ae,ow),{establishmentId:t,userId:e.uid,userName:e.name||e.email||"Utilizador",module:s,action:n,description:o,details:r,timestamp:new Date})}catch(a){console.error("Falha silenciosa ao registar log:",a)}},Kt=document.getElementById("content");let Ct=null,En="services",ss="all";function js(){const t=_e.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}async function rw(t){t.preventDefault();const s=t.target.closest("#categoryForm").querySelector("#categoryName"),n=s.value;if(n)try{await yp({establishmentId:w.establishmentId,name:n},"services"),qs(w.establishmentId,js(),"Categorias (Serviços)","Criou",`Criou categoria: ${n}`),s.value="",k("Sucesso","Categoria criada!","success"),await el(),await Xn()}catch(o){k("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function aw(t){if(await le("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await xp(t,"services"),qs(w.establishmentId,js(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),k("Sucesso","Categoria apagada.","success"),await el(),await Xn()}catch{k("Erro","Não foi possível apagar a categoria.","error")}}async function el(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Pr(w.establishmentId,"services");w.serviceCategories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(s=>`
                ...
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function iw(){Me({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `;const e=document.getElementById("serviceCategoryFilter");e&&(e.innerHTML='<option value="all">Todas as categorias</option>',(w.serviceCategories||[]).forEach(s=>e.innerHTML+=`<option value="${s.id}">${A(s.name)}</option>`)),tl(),Ts()}function dw(){const t=document.getElementById("services-content-container");t.innerHTML=`
    ...
    `}async function Xn(){const t=document.getElementById("services-content-container");if(t){const e=t.querySelector(".loader");e&&(e.style.display="block")}try{const[e,s,n,o]=await Promise.all([ps(w.establishmentId),Ge(w.establishmentId),Pr(w.establishmentId,"services"),Gh(w.establishmentId)]);w.services=(e||[]).filter(Boolean),w.professionals=(s||[]).filter(Boolean),w.serviceCategories=(n||[]).filter(Boolean),w.mostPopularService=o||{name:"N/A",count:0},w.services.forEach(r=>{r.active===void 0&&(r.active=!0)}),wp(En)}catch(e){t&&(t.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),k("Erro",`Não foi possível carregar os dados: ${e.message}`,"error")}}function wp(t){if(document.getElementById("services-content-container")){if(En===t&&document.getElementById("services-content-container").children.length>1){En==="services"&&(tl(),Ts());return}En=t,ss="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(e=>{const s=e.dataset.view===t;e.classList.toggle("border-indigo-500",s),e.classList.toggle("text-indigo-600",s),e.classList.toggle("border-transparent",!s),e.classList.toggle("text-gray-500",!s)}),t==="services"?cw():t==="reports"&&dw()}}function uw(){Ct&&(Kt.removeEventListener("click",Ct),Kt.removeEventListener("input",Ct),Kt.removeEventListener("change",Ct)),Ct=async t=>{const e=t.target;if(e.closest('[data-action="toggle-service-status"]')){t.stopPropagation();const o=e.closest('[data-action="toggle-service-status"]'),r=o.dataset.id,a=o.checked;try{await Wh(r,a);const l=w.services.findIndex(c=>c.id===r);l>-1&&(w.services[l].active=a),qs(w.establishmentId,js(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${a?"Ativo":"Inativo"}`),Ts(),tl()}catch(l){k("Erro",`Não foi possível atualizar o status: ${l.message}`,"error"),o.checked=!a,Ts()}return}const s=e.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(e.id==="serviceSearchInput"||e.id==="serviceCategoryFilter"){Ts();return}if(!s)return;if(s.hasAttribute("data-view")){wp(s.dataset.view);return}switch(s.dataset.action){case"new-service":Bd();break;case"edit-service":const o=JSON.parse(s.dataset.service);Bd(o);break;case"manage-categories":iw();break;case"filter-service":const r=s.dataset.filterType;if(r==="popular")return;ss=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(a=>{const l=a.dataset.filterType,d=l===ss||l==="total"&&ss==="all";a.classList.toggle("ring-2",d),a.classList.toggle("ring-indigo-500",d),a.classList.toggle("shadow-lg",d)}),Ts();break}},Kt.addEventListener("click",Ct),Kt.addEventListener("input",Ct),Kt.addEventListener("change",Ct)}async function mw(){Kt.innerHTML=`
        ...
        </section>`,uw();try{(!w.professionals||w.professionals.length===0)&&(w.professionals=await Ge(w.establishmentId)||[])}catch(t){console.error("Falha ao carregar profissionais:",t),k("Erro","Não foi possível carregar a lista de profissionais.","error"),w.professionals=[]}En="services",ss="all",await Xn()}const $r="suppliers",sl="purchases",Ep="financial_payables",nl=async t=>{try{const e=lr($t(Ae,$r),$n("establishmentId","==",t)),s=await di(e),n=[];return s.forEach(o=>{n.push({id:o.id,...o.data()})}),n}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},pw=async t=>{try{return{id:(await cu($t(Ae,$r),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},hw=async(t,e)=>{try{const s=rs(Ae,$r,t);return await mu(s,e),{id:t,...e}}catch(s){throw console.error("Erro ao atualizar fornecedor:",s),s}},gw=async t=>{try{const e=rs(Ae,$r,t);return await xh(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},fw=async(t,e=null)=>{try{const s=uu(Ae),n=rs($t(Ae,sl)),o={...t,createdAt:hc()};if(s.set(n,o),e&&e.defaultNatureId&&e.defaultCostCenterId){const r=rs($t(Ae,Ep)),a=new Date().toISOString().split("T")[0],l={establishmentId:t.establishmentId,description:`Compra - ${t.supplierName}`,amount:parseFloat(t.totalAmount),dueDate:a,naturezaId:e.defaultNatureId,centroDeCustoId:e.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${t.items.length}`,status:"pending",paymentDate:null,purchaseId:n.id,createdAt:hc()};s.set(r,l)}return await s.commit(),{id:n.id,...o}}catch(s){throw console.error("Erro ao registrar compra com integração:",s),s}},bw=async(t,e)=>{try{const s=uu(Ae),n=rs(Ae,sl,t);s.delete(n);const o=lr($t(Ae,Ep),$n("purchaseId","==",t),$n("establishmentId","==",e));return(await di(o)).forEach(a=>{s.delete(a.ref)}),await s.commit(),!0}catch(s){throw console.error("Erro ao excluir compra e financeiro:",s),s}},vw=async t=>{try{const e=lr($t(Ae,sl),$n("establishmentId","==",t),du("createdAt","desc")),s=await di(e),n=[];return s.forEach(o=>{n.push({id:o.id,...o.data()})}),n}catch(e){throw console.error("Erro ao buscar histórico de compras:",e),e}},zt=document.getElementById("content");let _t=null,In="products",dt="all";async function yw(t){t.preventDefault();const s=t.target.closest("#categoryForm").querySelector("#categoryName"),n=s.value;if(n)try{await yp({establishmentId:w.establishmentId,name:n},"products"),s.value="",k("Sucesso","Categoria de produto criada!","success"),await ol(),await Yn()}catch(o){k("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function xw(t){if(await le("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await xp(t,"products"),k("Sucesso","Categoria de produto apagada.","success"),await ol(),await Yn()}catch{k("Erro","Não foi possível apagar a categoria.","error")}}async function ol(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Pr(w.establishmentId,"products");w.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(s=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${A(s.name)}</span>
                    <button data-action="delete-category" data-id="${s.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function ww(){Me({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `;const e=document.getElementById("productCategoryFilter");e&&(e.innerHTML='<option value="all">Todas as categorias</option>',(w.categories||[]).forEach(s=>e.innerHTML+=`<option value="${s.id}">${A(s.name)}</option>`)),rl(),Fn()}function Tw(){const t=document.getElementById("products-content-container"),e=new Date().toISOString().split("T")[0],s=new Date;s.setDate(s.getDate()-30);const n=s.toISOString().split("T")[0];t.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const o=document.getElementById("productFilterReport"),r=document.getElementById("categoryFilterReport");o&&w.products&&(o.innerHTML+=w.products.map(a=>`<option value="${a.id}">${A(a.name)}</option>`).join("")),r&&w.categories&&(r.innerHTML+=w.categories.map(a=>`<option value="${a.id}">${A(a.name)}</option>`).join(""))}async function kw(){const t=document.getElementById("report-results");t.innerHTML='<div class="loader mx-auto my-8"></div>';const e={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:w.establishmentId};try{const s=await Xh(e);if(s.length===0){t.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,t.appendChild(a)})):(t.className="",t.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function Yn(){const t=document.getElementById("products-content-container");t&&(t.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[e,s,n]=await Promise.all([dr(w.establishmentId),Pr(w.establishmentId,"products"),nl(w.establishmentId)]);w.products=(e||[]).filter(Boolean),w.categories=(s||[]).filter(Boolean),w.suppliers=(n||[]).filter(Boolean),Ip(In)}catch(e){t&&(t.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${e.message}</p>`)}}function Ip(t){if(document.getElementById("products-content-container")){if(In===t&&document.getElementById("products-content-container").children.length>1){In==="products"&&(rl(),Fn());return}In=t,dt="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(e=>{const s=e.dataset.view===t;e.classList.toggle("border-indigo-500",s),e.classList.toggle("text-indigo-600",s),e.classList.toggle("border-transparent",!s),e.classList.toggle("text-gray-500",!s)}),t==="products"?Sw():t==="movements"&&Tw()}}async function Cw(){zt.innerHTML=`
        ...
        </section>`,_t&&(zt.removeEventListener("click",_t),zt.removeEventListener("input",_t),zt.removeEventListener("change",_t)),_t=async t=>{const e=t.target;if(e.id==="productSearchInput"||e.id==="productCategoryFilter"){Fn();return}const s=t.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!s||t.target.closest('[data-action-stop-propagation="true"]'))return;if(s.hasAttribute("data-view")){Ip(s.dataset.view);return}switch(s.dataset.action){case"new-product":Fd();break;case"edit-product":Fd(JSON.parse(s.dataset.product));break;case"manage-product-categories":ww();break;case"generate-report":await kw();break;case"filter-stock":const o=s.dataset.filterType;dt=dt===o?"all":o,document.querySelectorAll(".indicator-card").forEach(r=>{r.classList.toggle("ring-2",r.dataset.filterType===dt),r.classList.toggle("ring-indigo-500",r.dataset.filterType===dt),r.classList.toggle("shadow-lg",r.dataset.filterType===dt)}),Fn();break}},zt.addEventListener("click",_t),zt.addEventListener("input",_t),zt.addEventListener("change",_t),In="products",dt="all",await Yn()}const Wt=document.getElementById("content");let At=null,Vo="list",ie={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function _w(){Vo==="list"?Dr():Vo==="purchases"?(ie.step=1,Sn()):Vo==="history"&&Sp()}async function Aw(){try{const t=await nl(w.establishmentId);return w.suppliers=t||[],ie.allSuppliers=t,!0}catch(t){return console.error(t),!1}}async function Pw(t){if(await le("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await gw(t),k("Sucesso","Fornecedor excluído.","success"),cr("genericModal"),Dr()}catch(e){k("Erro","Erro ao excluir: "+e.message,"error")}}async function $w(t){t.preventDefault();const e=t.target,s=e.querySelector("#supId").value,n={name:e.querySelector("#supName").value,contactName:e.querySelector("#supContact").value,email:e.querySelector("#supEmail").value,phone:e.querySelector("#supPhone").value,taxId:e.querySelector("#supTaxId").value,category:e.querySelector("#supCategory").value,establishmentId:w.establishmentId},o=e.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="A salvar...";try{s?(await hw(s,n),k("Sucesso","Fornecedor atualizado!","success")):(await pw(n),k("Sucesso","Fornecedor criado!","success")),cr("genericModal"),Dr()}catch(r){k("Erro","Erro ao salvar: "+r.message,"error")}finally{o.disabled=!1,o.textContent="Salvar"}}async function Dr(){const t=document.getElementById("suppliersList");if(!t)return;t.innerHTML='<div class="loader mx-auto my-8"></div>',await Aw();const e=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",s=w.suppliers.filter(r=>r.name.toLowerCase().includes(e)||r.contactName&&r.contactName.toLowerCase().includes(e));if(t.innerHTML="",s.length===0){t.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let n='<div class="flex flex-col gap-2 md:hidden">';s.forEach(r=>{const a=JSON.stringify(r).replace(/"/g,"&quot;"),l=A(r.name),c=A(r.category||"Geral"),d=A(r.contactName||"");n+=`
    ...
    `;s.forEach(r=>{const a=JSON.stringify(r).replace(/"/g,"&quot;"),l=A(r.name),c=A(r.taxId||"Sem doc."),d=A(r.email||"-"),p=A(r.phone||"-"),h=A(r.category||"Geral");o+=`
        ...
        `}),o+="</tbody></table></div>",t.innerHTML=n+o}function Dw(t){const e=t.phone?`https://wa.me/${t.phone.replace(/\D/g,"")}`:"#",s=t.phone?`tel:${t.phone}`:"#",n=t.email?`mailto:${t.email}`:"#",o=JSON.stringify(t).replace(/"/g,"&quot;"),r=A(t.name),a=A(t.category||"Fornecedor"),l=A(t.contactName||""),c=A(t.phone||""),d=`
    ...
    `}async function Sp(){const t=document.getElementById("historyContainer");if(t){t.innerHTML='<div class="loader mx-auto my-8"></div>';try{const e=await vw(w.establishmentId);if(e.length===0){t.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let s='<div class="flex flex-col gap-3 md:hidden">';e.forEach(r=>{const a=new Date(r.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),l=A(r.supplierName);s+=`
        ...
        `;t.innerHTML=s+o}catch(e){console.error(e),t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function Rw(t){const e=new Date(t.createdAt.seconds*1e3).toLocaleString("pt-BR"),s=t.items.map(o=>`
    ...
    `;Me({title:t?"Editar Fornecedor":"Novo Fornecedor",contentHTML:e,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",$w),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>cr("genericModal"))},50)}function Nw(){Wt.innerHTML=`
...
Aguardo retorno.`;const d=`mailto:${n.email}?subject=${encodeURIComponent(l)}&body=${encodeURIComponent(c)}`;window.location.href=d}else k("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(t.target.closest(".btn-register-order")){const s=t.target.closest(".btn-register-order");if(s.disabled)return;const n=JSON.parse(decodeURIComponent(s.dataset.order));n.establishmentId=w.establishmentId,s.disabled=!0,s.textContent="A processar...",ms(w.establishmentId).then(o=>{const r=o.purchaseConfig||null;return fw(n,r)}).then(()=>{k("Sucesso","Compra registrada e integrada ao financeiro!","success"),s.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',s.classList.replace("bg-blue-600","bg-green-600"),s.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(o=>{s.disabled=!1,s.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',k("Erro","Falha ao registrar compra: "+o.message,"error")})}if(t.target.closest(".btn-delete-purchase")){const n=t.target.closest(".btn-delete-purchase").dataset.id;le("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async o=>{if(o)try{await bw(n,w.establishmentId),k("Sucesso","Compra e financeiro excluídos.","success"),Sp()}catch(r){k("Erro","Erro ao excluir: "+r.message,"error")}})}if(t.target.closest(".btn-print-order")){const n=t.target.closest(".supplier-order-card").dataset.supplierId,o=ie.finalOrders[n];o?Mw(o,ie.isQuoteMode):k("Erro","Dados do pedido não encontrados.","error")}if(t.target.closest(".btn-view-purchase")){const s=t.target.closest(".btn-view-purchase"),n=JSON.parse(s.dataset.purchase);Rw(n)}},Wt.addEventListener("click",At),Wt.addEventListener("input",At),Wt.addEventListener("change",At),wo("list")}function wo(t){Vo=t,["list","purchases","history"].forEach(s=>{const n=document.getElementById(`tab-btn-${s}`),o=document.getElementById(`tab-content-${s}`);s===t?(n.classList.add("border-indigo-500","text-indigo-600"),n.classList.remove("border-transparent","text-gray-500"),o.classList.remove("hidden")):(n.classList.remove("border-indigo-500","text-indigo-600"),n.classList.add("border-transparent","text-gray-500"),o.classList.add("hidden"))});const e=document.getElementById("btn-new-supplier");e&&(t==="list"?e.classList.remove("hidden"):e.classList.add("hidden")),_w()}const wa=document.getElementById("content"),qd={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let mt=new Set,Eo=null,ks=null;function Bw(t=8){let e="";for(let s=0;s<t;s++)e+=`
        ...
        `;return e}function Vw(t){return t.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':t.map(e=>{const s=e.status==="inactive",n=A(e.name),o=A(e.specialty||"Especialidade"),r=e.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,a=JSON.stringify(e).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Ea(){const t=document.getElementById("genericModal");t.style.display="none",ks&&t.removeEventListener("click",ks)}async function Fw(t){const e=document.getElementById("genericModal"),s=t.id?t:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},n=A(s.name),o=w.services||await ps(w.establishmentId),r=w.professionals||await Ge(w.establishmentId),a=`
        ...
        </section>`,Eo&&wa.removeEventListener("click",Eo),Eo=e=>{const s=e.target.closest('[data-action="open-professional-modal"]'),n=e.target.closest('[data-action="batch-delete"]');if(s){e.preventDefault();let r={};if(s.dataset.professional)try{r=JSON.parse(s.dataset.professional)}catch(a){console.error("Erro ao fazer parse do professional data:",a);return}Fw(r);return}if(n){zw();return}const o=e.target.closest(".professional-checkbox");if(o){const r=o.dataset.id;o.checked?mt.add(r):mt.delete(r),dn(),ni();return}},wa.addEventListener("click",Eo),document.getElementById("profSearchInput").addEventListener("input",dn),document.getElementById("showInactiveProfToggle").addEventListener("change",dn);const t=document.getElementById("professionalsList");w.professionals=null,w.services=null,dn();try{const[e,s]=await Promise.all([Ge(w.establishmentId),ps(w.establishmentId)]);w.professionals=e,w.services=s,dn(),ni()}catch{t.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const Ia=document.getElementById("content");let pt=[],vt={},Re=null,oi="list",ze="all",ri="O Estabelecimento";const Ww=1,Gw=(t,e)=>`Olá, ${t}! Nós da ${e} desejamos a você um Feliz Aniversário! Esperamos que seu dia seja maravilhoso. Venha comemorar conosco! 🎉🎂`,Kw=(t,e)=>`Oi, ${t}! Faz um tempo que não te vemos aqui no(a) ${e}. Sentimos sua falta! Temos novidades/ofertas especiais para você. Que tal agendar seu horário?`,Jw=[{value:30,label:"30 dias"},{value:60,label:"60 dias"},{value:90,label:"90 dias"},{value:120,label:"120 dias"}];function Qw(){return Math.floor(Math.random()*140)+10}function Xw(t){if(!t.dob)return!1;const e=t.dob.split("/");if(e.length!==2)return!1;const s=new Date,n=s.getDate(),o=s.getMonth()+1,r=parseInt(e[0],10),a=parseInt(e[1],10);return r===n&&a===o}const Yw=[{value:99,label:"Aniversariantes de Hoje"},{value:0,label:"Todos os meses (com DOB)"},{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}];function jd(){return Yw.map(t=>{let e=t.value===99?"selected":"";return`<option value="${t.value}" ${e}>${t.label}</option>`}).join("")}function Hd(){return Jw.map(t=>{const e=t.value===90?"selected":"";return`<option value="${t.value}" ${e}>${t.label}</option>`}).join("")}function al(t){if(!t)return 0;let e=0;if(t.totalAmount!==void 0&&t.totalAmount!==null?e=parseFloat(t.totalAmount):t.value!==void 0&&t.value!==null?e=parseFloat(t.value):t.price!==void 0&&t.price!==null&&!Array.isArray(t.price)&&(e=parseFloat(t.price)),!e||e===0){let s=0;t.services&&Array.isArray(t.services)&&(s+=t.services.reduce((o,r)=>{const a=parseFloat(r.price)||parseFloat(r.servicePrice)||0;return o+a},0));const n=t.comandaItems||t.items;n&&Array.isArray(n)&&(s+=n.reduce((o,r)=>{const a=parseFloat(r.price)||0,l=parseInt(r.quantity)||1;return o+a*l},0)),s>0&&(e=s)}return isNaN(e)?0:e}function Zw(t,e){const s=`w-5 h-5 ${e} mr-2`;switch(t){case"cadastro":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>`;case"agendamentos":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`;case"historico":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v2a2 2 0 01-2 2h-2.586a1 1 0 00-.707.293l-1.414 1.414a1 1 0 01-1.414 0l-1.414-1.414A1 1 0 009.586 17H7a2 2 0 01-2-2v-2a2 2 0 012-2h12z" /></svg>`;case"fidelidade":return`<svg xmlns="http://www.w3.org/2000/svg" class="${s}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.5a9.5 9.5 0 1019 0 9.5 9.5 0 00-19 0z" /></svg>`;default:return""}}function e1(t="cadastro"){const e=[{id:"cadastro",label:"Cadastro"},{id:"agendamentos",label:"Agend."},{id:"historico",label:"Histórico"},{id:"fidelidade",label:"Fidelidade"}],s=document.getElementById("client-detail-tabs");s&&(s.innerHTML=e.map(n=>{const o=t===n.id,r=o?"text-indigo-600":"text-gray-500";return`
        ...
        `}).join(""),s.querySelectorAll(".tab-btn").forEach(n=>{n.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation(),ai(n.dataset.tab)})}))}async function ai(t){e1(t);const e=document.getElementById("client-detail-content");if(e){e.innerHTML='<div class="flex h-64 items-center justify-center"><div class="loader"></div></div>';try{switch(t){case"cadastro":e.innerHTML=t1(Re);break;case"agendamentos":case"historico":const s=await $d(w.establishmentId,Re.name,Re.phone);e.innerHTML=s1(s,t);break;case"fidelidade":let n=[],o=[];try{n=await $d(w.establishmentId,Re.name,Re.phone)}catch(r){console.error("Erro ao buscar histórico de vendas:",r)}if(vt&&vt.enabled)try{o=await rx(w.establishmentId,Re.name,Re.phone)}catch(r){console.warn("Aviso: Histórico de fidelidade indisponível.",r)}e.innerHTML=o1(Re,n,o);break;default:e.innerHTML='<p class="p-6 text-center text-gray-500">Seção não implementada.</p>'}}catch(s){console.error("Erro crítico ao carregar aba:",s),e.innerHTML=`<div class="p-6 text-center text-red-500"><p>Erro ao carregar dados.</p><p class="text-xs mt-2">${A(s.message)}</p></div>`}}}function t1(t){const e=t?.dob?t.dob.split("/"):["",""],s=A(t?.name||""),n=A(t?.email||""),o=A(t?.phone||""),r=A(t?.notes||"");return`
    ...
    `}function n1(t,e){const s=(t||[]).filter(c=>{const d=(c.status||"").toLowerCase();return d==="completed"||d==="finished"||d==="paid"||d==="finalized"});let n=0;s.forEach(c=>{n+=al(c)});let o=vt&&vt.conversionRate?parseFloat(vt.conversionRate):Ww;o<=0&&(o=1);const r=Math.floor(n/o);let a=0;(e||[]).forEach(c=>{c.type==="redeem"&&(a+=c.points?Math.abs(c.points):0)});const l=r-a;return{totalSpent:n,totalPointsEarned:r,totalPointsRedeemed:a,currentBalance:l,moneyPerPoint:o}}function o1(t,e,s){if(!vt||!vt.enabled)return`<div class="p-8 text-center text-gray-500">
    ...
    `}function Tp(t){Re=t,oi="detail";const e=t!==null,s=e?"Editar Cliente":"Adicionar Cliente",n=`
    ...
    `,o=window.innerWidth<768,r=o?"max-w-full":"max-w-3xl";if(Me({title:s,contentHTML:n,maxWidth:r}),o){const d=document.getElementById("genericModal");if(d){const p=d.querySelector(`.${r.replace(":","\\:")}`);p&&(p.style.height="auto",p.style.maxHeight="85vh",p.style.borderRadius="1rem")}}const a=document.getElementById("genericModal");a&&(a.onclick=async d=>{const p=d.target.closest("[data-action]");if(!p)return;switch(p.dataset.action){case"redeem-reward":{const f=parseInt(p.dataset.points,10),y=p.dataset.reward;if(await le("Confirmar Resgate",`Deseja resgatar "${y}" por ${f} pontos?`))try{await ax(w.establishmentId,Re.name,Re.phone,{points:f,reward:y}),k("Prêmio resgatado com sucesso!","success"),await ai("fidelidade")}catch(_){k(`Erro ao resgatar: ${_.message}`,"error")}break}case"open-comanda-from-history":{const f=p.dataset.appointmentId;f&&(document.getElementById("genericModal").style.display="none",Ye("comandas-section",{selectedAppointmentId:f,initialFilter:"finalizada"}));break}case"view-appointment":{const f=p.dataset.appointmentId,y=p.dataset.appointmentDate;f&&y&&(document.getElementById("genericModal").style.display="none",Ye("agenda-section",{targetDate:y,scrollToAppointmentId:f}));break}case"save-client":{d.preventDefault(),Ud();break}}}),ai("cadastro"),setTimeout(()=>{const d=document.getElementById("client-form");d&&d.addEventListener("submit",p=>{p.preventDefault(),Ud()})},500);const l=document.getElementById("cancelDetailViewBtn");l&&l.addEventListener("click",d=>{d.preventDefault(),document.getElementById("genericModal").style.display="none";const p=document.getElementById("clientSearchInput")?.value||"",h=Cn(p,ze);kn(h,pt.length)});const c=document.getElementById("deleteClientBtn");c&&c.addEventListener("click",async()=>{await r1()})}async function Ud(){const t=document.getElementById("client-form");if(!t)return;const e=t.querySelector("#clientId").value,s={name:t.querySelector("#clientName").value,email:t.querySelector("#clientEmail").value,phone:t.querySelector("#clientPhone").value,dob:`${t.querySelector("#clientDobDay").value}/${t.querySelector("#clientDobMonth").value}`,notes:t.querySelector("#clientNotes").value,establishmentId:w.establishmentId};if(!s.name||!s.phone){k("Erro","Nome e Telefone são obrigatórios.","error");return}try{e?(await ip(e,s),k("Sucesso","Cliente atualizado com sucesso!","success")):(await Xi(s),k("Sucesso","Cliente cadastrado com sucesso!","success")),document.getElementById("genericModal").style.display="none",await il()}catch(n){k("Erro",`Não foi possível salvar: ${n.message}`,"error")}}async function r1(){if(!Re||!Re.id)return;if(await le("Excluir Cliente",`Tem certeza que deseja excluir ${Re.name}? Esta ação é irreversível.`))try{await ox(Re.id),k("Sucesso","Cliente excluído.","success"),document.getElementById("genericModal").style.display="none",await il()}catch(e){k("Erro",`Não foi possível excluir: ${e.message}`,"error")}}function kn(t,e){const s=document.getElementById("clientsList");if(s)if(s.innerHTML="",s.className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 content-start p-2 pb-20",document.getElementById("client-count").textContent=`${t.length} cliente${t.length!==1?"s":""} | Total: ${e}`,t.length>0){const n=ze==="inactive",o=ze==="birthdays";t.forEach(r=>{const a=document.createElement("div");a.className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 hover:shadow-md cursor-pointer transition-all flex flex-col justify-between h-full relative group",a.dataset.clientId=r.id;const l=parseInt(r.loyaltyPoints||0),c=r.totalSpent||0;let d="";const h=`https://wa.me/55${r.phone?r.phone.replace(/\D/g,""):""}?text=`,f=A(r.name),y=A(r.phone);if(n){const I=encodeURIComponent(Kw(r.name,ri));d=`<a href="${h+I}" target="_blank" class="absolute top-2 right-2 text-blue-500 bg-blue-50 p-1 rounded-full z-10 hover:bg-blue-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 16.64C16.64 16.64 15.11 17.58 14.54 17.76C13.97 17.94 13.06 18.06 10.66 17.06C8.26 16.06 6.38 13.62 6.38 13.62C6.38 13.62 4.96 11.72 4.96 9.76C4.96 7.8 6.04 6.88 6.04 6.88C6.04 6.88 6.32 6.56 6.6 6.56C6.88 6.56 7.16 6.56 7.16 6.56C7.38 6.56 7.62 6.46 7.86 7.02C8.1 7.58 8.68 9.02 8.68 9.02C8.68 9.02 8.78 9.24 8.64 9.48C8.5 9.72 8.36 9.88 8.16 10.1C7.96 10.32 7.74 10.4 8.02 10.88C8.3 11.36 9.26 12.92 10.68 14.18C11.62 15.02 12.56 15.36 12.94 15.54C13.32 15.72 13.6 15.66 13.84 15.38C14.08 15.1 14.62 14.34 14.62 14.34C14.62 14.34 14.88 14.06 15.18 14.12C15.48 14.18 16.94 14.9 16.94 14.9C16.94 14.9 17.2 15.04 17.3 15.22C17.4 15.4 17.4 16.28 16.64 16.64Z"/></svg></a>`}else if(o&&Xw(r)){const I=encodeURIComponent(Gw(r.name,ri));d=`<a href="${h+I}" target="_blank" class="absolute top-2 right-2 text-green-500 bg-green-50 p-1 rounded-full z-10 hover:bg-green-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M... (mesmo icone)"/></svg></a>`}a.innerHTML=`
                ${d}
    ...
    `;try{const[p,h]=await Promise.all([Jn(w.establishmentId),ms(w.establishmentId)]);pt=p,vt=h.loyaltyProgram||{enabled:!1},ri=h.name||"O Estabelecimento";const f=Cn("",ze);kn(f,pt.length)}catch{const h=document.getElementById("clientsList");h&&(h.innerHTML='<p class="text-red-500 col-span-full text-center mt-10">Erro ao carregar dados dos clientes.</p>')}const t=document.getElementById("filter-sheet"),e=document.getElementById("filter-overlay"),s=document.getElementById("openFilterSheetBtn"),n=document.getElementById("closeFilterSheetBtn"),o=()=>{t.classList.remove("translate-y-full"),e.classList.remove("hidden")},r=()=>{t.classList.add("translate-y-full"),e.classList.add("hidden")};s&&s.addEventListener("click",o),n&&n.addEventListener("click",r),e&&e.addEventListener("click",r);const a=p=>{const h=p.target.closest(".client-filter-btn");if(h){a1(h.dataset.filterKey);const f=h.dataset.filterKey;window.innerWidth<768&&f!=="birthdays"&&f!=="inactive"&&r()}},l=document.getElementById("desktop-filter-bar"),c=document.getElementById("mobile-filter-list");l&&l.addEventListener("click",a),c&&c.addEventListener("click",a);const d=p=>{const h=document.getElementById(p);h&&h.addEventListener("change",()=>{if(ze==="birthdays"||ze==="inactive"){const f=document.getElementById("clientSearchInput").value,y=Cn(f,ze);kn(y,pt.length)}})};d("birthMonthFilter"),d("mobileBirthMonthFilter"),d("inactiveDaysFilter"),d("mobileInactiveDaysFilter"),Ia.addEventListener("click",async p=>{const h=p.target.closest("[data-action]");oi==="list"&&h&&h.dataset.action==="new-client"&&Tp(null)}),Ia.addEventListener("input",p=>{if(p.target.id==="clientSearchInput"){const h=p.target.value,f=Cn(h,ze);kn(f,pt.length)}})}const On=t=>F(`/api/financial/natures/${t}`),i1=t=>F("/api/financial/natures",{method:"POST",body:JSON.stringify(t)}),l1=t=>F(`/api/financial/natures/${t}`,{method:"DELETE"}),qn=t=>F(`/api/financial/cost-centers/${t}`),c1=t=>F("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(t)}),d1=t=>F(`/api/financial/cost-centers/${t}`,{method:"DELETE"}),kp=(t,e)=>F(`/api/financial/${t}`,{method:"POST",body:JSON.stringify(e)}),Cp=(t,e={})=>{let s=`/api/financial/${t}`;const n=new URLSearchParams;e.establishmentId&&n.append("establishmentId",e.establishmentId),e.startDate&&n.append("startDate",e.startDate),e.endDate&&n.append("endDate",e.endDate),e.natureId&&n.append("natureId",e.natureId),e.costCenterId&&n.append("costCenterId",e.costCenterId),e.status&&n.append("status",e.status);const o=n.toString();return o&&(s+=`?${o}`),F(s)},_p=(t,e,s)=>F(`/api/financial/${t}/${e}`,{method:"PUT",body:JSON.stringify(s)}),Ap=(t,e)=>F(`/api/financial/${t}/${e}`,{method:"DELETE"}),Pp=(t,e,s)=>F(`/api/financial/${t}/${e}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:s})}),u1=t=>kp("payables",t),m1=t=>Cp("payables",t),p1=(t,e)=>_p("payables",t,e),h1=t=>Ap("payables",t),g1=(t,e)=>Pp("payables",t,e),f1=t=>kp("receivables",t),b1=t=>Cp("receivables",t),v1=(t,e)=>_p("receivables",t,e),y1=t=>Ap("receivables",t),x1=(t,e)=>Pp("receivables",t,e),w1=(t,e,s)=>F(`/api/financial/cash-flow?establishmentId=${t}&startDate=${e}&endDate=${s}`),E1=t=>F(`/api/financial/today-summary/${t}`),Qt=document.getElementById("content"),Sa={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},I1={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}},$p=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"},{id:"support",icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",label:"Suporte e Ajuda"},{id:"cancellation",icon:"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z",label:"Cancelar Assinatura"}];let Le=null;function zd(t,e,s){return new Promise((n,o)=>{const r=new FileReader;r.readAsDataURL(t),r.onload=a=>{const l=new Image;l.src=a.target.result,l.onload=()=>{const c=document.createElement("canvas");let d=l.width,p=l.height;d>e&&(p*=e/d,d=e),c.width=d,c.height=p,c.getContext("2d").drawImage(l,0,0,d,p);const f=t.type==="image/png"&&e<500?"image/png":"image/jpeg";n(c.toDataURL(f,s))},l.onerror=c=>o(c)},r.onerror=a=>o(a)})}function ws(t,e=null){let s='<option value="">-- Selecione (Opcional) --</option>';const n=a=>{const l=new Map,c=[];return a&&(a.forEach(d=>l.set(d.id,{...d,children:[]})),l.forEach(d=>{d.parentId&&l.has(d.parentId)?l.get(d.parentId).children.push(d):c.push(d)})),c},o=(a,l="")=>{const c=a.id===e?"selected":"";s+=`<option value="${a.id}" ${c}>${l}${A(a.name)}</option>`,a.children.forEach(d=>o(d,l+"— "))};return n(t).forEach(a=>o(a)),s}async function Us(t,e){const s=e.target.querySelector('button[type="submit"]');s&&(s.disabled=!0,s.textContent="A Salvar...");try{const n=Le||await ms(w.establishmentId),o=[],{ownerName:r,...a}=t;if(r&&r!==w.userName){const c=_e.currentUser;c&&o.push(bh(c,{displayName:r}).then(()=>{w.userName=r}))}const l={...n,...a};if(o.push($o(w.establishmentId,l)),await Promise.all(o),Le=l,k("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),a.themeColor)setTimeout(()=>window.location.reload(),1500);else{const c=document.getElementById("panelEstablishmentName");a.name&&c&&(c.textContent=a.name,w.establishmentName=a.name)}}catch(n){k("Erro",`Não foi possível salvar: ${n.message}`,"error")}finally{s&&(s.disabled=!1,s.textContent="Salvar")}}function S1(t,e){const s=A(t.name||""),n=A(t.phone||""),o=A(t.document||""),r=A(t.email||""),a=A(t.address||""),l=A(t.website||""),c=A(w.userName||"");e.innerHTML=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const p={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,document:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};Us(p,d)})}function T1(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-email-form").addEventListener("submit",async s=>{s.preventDefault();const n=e.querySelector("#newEmail").value,o=e.querySelector("#currentPassword").value;if(!n||!o){k("Erro","Preencha todos os campos.","error");return}const r=e.querySelector('button[form="change-email-form"]');r.disabled=!0,r.textContent="A verificar...";try{const a=_e.currentUser;if(!a)throw new Error("Usuário não autenticado.");const l=ph.credential(a.email,o);await hh(a,l),r.textContent="A enviar link...",await gh(a,n),r.textContent="A atualizar BD...",await qh(w.establishmentId,n),k("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),s.target.reset()}catch(a){let l="Não foi possível alterar o e-mail.";a.code==="auth/wrong-password"?l="A senha atual está incorreta.":a.code==="auth/email-already-in-use"?l="Este e-mail já está sendo usado por outra conta.":a.code==="auth/operation-not-allowed"?l="A troca de e-mail precisa ser habilitada no console do Firebase.":l=a.message,k("Erro",l,"error")}finally{r.disabled=!1,r.textContent="Salvar Novo E-mail"}})}function C1(t,e){const s=A(t.welcomeMessage||"");e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const s=e.querySelector("#establishmentTimezone");if(t.timezone)s.value=t.timezone;else try{const r=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(s.options).some(l=>l.value===r)?s.value=r:s.value="America/Sao_Paulo"}catch{s.value="America/Sao_Paulo"}const n=e.querySelector("#establishmentWorkingHoursContainer"),o=t.workingHours||{};Object.keys(Sa).forEach(r=>{const a=o[r]||{},l=Sa[r],c=a.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${c?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,n.appendChild(d)}),n.addEventListener("change",r=>{const a=r.target.closest('.day-schedule-card input[type="checkbox"]');a&&a.closest(".day-schedule-card").classList.toggle("disabled",!a.checked)}),e.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const a={};Object.keys(Sa).forEach(c=>{a[c]={active:e.querySelector(`#est-${c}-active`).checked,start:e.querySelector(`#est-${c}-start`).value,end:e.querySelector(`#est-${c}-end`).value,breakStart:e.querySelector(`#est-${c}-breakStart`).value,breakEnd:e.querySelector(`#est-${c}-breakEnd`).value}});const l=e.querySelector("#establishmentTimezone").value;Us({workingHours:a,timezone:l},r)})}function P1(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[s,n]=await Promise.all([On(w.establishmentId),qn(w.establishmentId)]),o=t.financialIntegration||{},r=t.commissionConfig||{},a=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=ws(s,o.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=ws(n,o.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=ws(s,a.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=ws(n,a.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=ws(s,r.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=ws(n,r.defaultCostCenterId)}catch{k("Erro","Não foi possível carregar os dados para a integração financeira.","error")}e.querySelector("#financial-form").addEventListener("submit",s=>{s.preventDefault();const n={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};Us(n,s)})}function D1(t,e){const s="5516997859430",n=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),o=`https://wa.me/${s}?text=${n}`;e.innerHTML=`
    ...
    `}function L1(t,e){const s="5516997859430",n=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),o=`https://wa.me/${s}?text=${n}`,r="sistemakairosagenda@gmail.com";e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function R1(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${t}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function Dp(t="indigo",e){const s=e.querySelector("#color-palette-container"),n=e.querySelector("#establishmentThemeColor");!s||!n||(s.innerHTML="",Object.entries(I1).forEach(([o,r])=>{const a=o===t,l=document.createElement("div");l.className="w-24 text-center cursor-pointer mb-4",l.innerHTML=`
    ...
    `,Qt.querySelector('button[data-action="back-to-list"]').addEventListener("click",n=>{n.preventDefault(),Lp()});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":S1(Le,s);break;case"change-password":T1(Le,s);break;case"change-email":k1(Le,s);break;case"branding":C1(Le,s);break;case"booking":_1(Le,s);break;case"working-hours":A1(Le,s);break;case"loyalty":P1(Le,s);break;case"financial":await $1(Le,s);break;case"support":D1(Le,s);break;case"cancellation":L1(Le,s);break;default:R1(e?e.label:"Definições",s)}}async function Lp(){if(Qt.innerHTML=`
    ...
    `,Qt.querySelector("#settings-menu-list").addEventListener("click",r=>{const a=r.target.closest("button[data-section]");a&&(r.preventDefault(),N1(a.dataset.section))});const o=Qt.querySelector('[data-action="go-to-my-profile"]');o&&o.addEventListener("click",r=>{r.preventDefault(),Ye("my-profile-section")})}const _n=document.getElementById("content");async function $s(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const s=document.getElementById("filterStartDate")?.value,n=document.getElementById("filterEndDate")?.value,o=await kr(w.establishmentId,s||new Date().toISOString().split("T")[0],n||new Date().toISOString().split("T")[0],t),r=document.getElementById("filterReason")?.value.toLowerCase(),a=r?o.filter(c=>c.reason&&c.reason.toLowerCase().includes(r)):o,l=a.reduce((c,d)=>{const p=d.reason||"Sem motivo";return c[p]||(c[p]=[]),c[p].push(d),c},{});if(e.innerHTML="",a.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(l).forEach(([c,d])=>{const p=document.createElement("div");p.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let f=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;p.innerHTML+=N}),e.appendChild(p)})}catch(s){e.innerHTML=`<p class="text-center text-red-500">Erro: ${s.message}</p>`}}}async function B1(t){t.preventDefault();const e=t.target,s=e.querySelector("#blockageProfId").value,n=e.querySelector("#blockageDate").value,o=e.querySelector("#blockageEndDate").value||n,r=e.querySelector("#blockageStartTime").value,a=e.querySelector("#blockageEndTime").value,l={establishmentId:w.establishmentId,professionalId:s,startTime:new Date(`${n}T${r}:00`).toISOString(),endTime:new Date(`${o}T${a}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Cr(l),e.reset(),k("Sucesso","Bloqueio adicionado com sucesso!","success"),$s(s)}catch(c){k("Erro",`Não foi possível criar o bloqueio: ${c.message}`,"error")}}async function V1(t){t.preventDefault();const e=t.target,s=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(p=>p.value);if(s.length===0)return k("Atenção","Selecione pelo menos um profissional.","error");const n=e.querySelector("#batchBlockageDate").value,o=e.querySelector("#batchBlockageEndDate").value||n,r=e.querySelector("#batchBlockageStartTime").value,a=e.querySelector("#batchBlockageEndTime").value,l=e.querySelector("#batchBlockageReason").value,c=e.querySelector('button[type="submit"]');c.disabled=!0,c.textContent="Aguarde...";const d=s.map(p=>{const h={establishmentId:w.establishmentId,professionalId:p,startTime:new Date(`${n}T${r}:00`).toISOString(),endTime:new Date(`${o}T${a}:00`).toISOString(),reason:l};return Cr(h)});try{await Promise.all(d),k("Sucesso",`${s.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(h=>h.checked=!1);const p=document.getElementById("blockageProfId").value;p&&$s(p)}catch(p){k("Erro",`Ocorreu um erro: ${p.message}`,"error")}finally{c.disabled=!1,c.textContent="Adicionar Bloqueio em Lote"}}function F1(t){_n.addEventListener("submit",e=>{e.target.id==="blockageForm"&&B1(e),e.target.id==="batchBlockageForm"&&V1(e)}),_n.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&$s(t)}),_n.addEventListener("click",async e=>{const s=e.target.closest("button[data-action]");if(!s)return;const n=s.dataset.action;if(n==="back-to-professionals")Ye("profissionais-section");else if(n==="delete-blockage"){if(await le("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Qi(s.dataset.id),k("Sucesso","Bloqueio removido.","success"),$s(t)}catch(r){k("Erro",`Não foi possível remover o bloqueio: ${r.message}`,"error")}}else if(n==="batch-delete-blockage"){const o=JSON.parse(s.dataset.ids);if(await le("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await ap(o),k("Sucesso",`${o.length} bloqueios removidos.`,"success"),$s(t)}catch(a){k("Erro",`Não foi possível apagar os bloqueios: ${a.message}`,"error")}}})}async function O1(t){const{professionalId:e,professionalName:s}=t;if(!e||!s){_n.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const n=A(s);_n.innerHTML=`
        <section>
        ...
        </section>`,F1(e),await $s(e);const o=document.getElementById("batchProfSelectionContainer");try{const r=await Ge(w.establishmentId);o.innerHTML=r.map(a=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{o.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const q1=t=>F(`/api/users/${t}`),j1=t=>F("/api/users",{method:"POST",body:JSON.stringify(t)}),H1=(t,e)=>F(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),U1=t=>F(`/api/users/${t}`,{method:"DELETE"}),z1=(t,e)=>F(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),W1=(t,e)=>F(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),Gt=document.getElementById("content"),G1={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},K1={view:"Visualizar",create:"Criar",edit:"Editar"};let un=null,mn=null;function J1(t){const e=document.getElementById("usersListContainer");if(!e)return;const s=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const n=s?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";e.innerHTML=`<p class="col-span-full text-center text-gray-500">${n}</p>`;return}t.sort((n,o)=>(n.status==="active"?-1:1)-(o.status==="active"?-1:1)),e.innerHTML=t.map(n=>{const o=JSON.stringify(n).replace(/'/g,"&apos;"),r=n.status==="active",a=w.professionals.find(p=>p.id===n.professionalId),l=a?a.name:"N/A",c=a?a.name.charAt(0):n.name.charAt(0),d=a?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(c)}`;return`
    ...
    `}).join("")}function Fo(){const t=document.getElementById("showInactiveUsersToggle")?.checked;let e;t?e=w.users:e=w.users.filter(s=>s.status==="active"),J1(e)}function Q1(t={}){return Object.entries(G1).map(([e,s])=>{const n=e==="agenda-section"||e==="comandas-section",o=t[e]?.view_all_prof===!0,r=Object.entries(K1).map(([l,c])=>`
    ...
    `,un&&Gt.removeEventListener("click",un),mn&&Gt.removeEventListener("change",mn),un=async t=>{if(!document.getElementById("user-list-view")){Gt.removeEventListener("click",un);return}const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":Wd();break;case"edit-user":const n=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));Wd(n);break;case"back-to-list":nr();break;case"delete-user":{t.stopPropagation();const o=e.dataset.userId;if(await le("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await U1(o),k("Usuário excluído com sucesso!","success"),nr()}catch(a){k(`Erro ao excluir: ${a.message}`,"error")}break}}},mn=async t=>{if(!document.getElementById("user-list-view")){Gt.removeEventListener("change",mn);return}const e=t.target.closest('input[data-action="toggle-user-status"]');if(t.target.id==="showInactiveUsersToggle")Fo();else if(e){t.stopPropagation();const s=e.dataset.userId,n=e.checked?"active":"inactive";try{await W1(s,n),k(`Usuário ${n==="active"?"ativado":"inativado"} com sucesso.`,"success");const o=w.users.findIndex(r=>r.id===s);o>-1&&(w.users[o].status=n,Fo())}catch(o){k(`Erro ao atualizar status: ${o.message}`,"error"),e.checked=!e.checked,Fo()}}},Gt.addEventListener("click",un),Gt.addEventListener("change",mn),await X1()}const Y1=document.getElementById("content");let Gd={},ii=null;function Z1(){Object.values(Gd).forEach(t=>t?.destroy()),Gd={}}function e2(t,e){if(!window.jspdf){k("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:s}=window.jspdf,n=new s({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(n.setFontSize(18),n.text(t,n.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const a=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];n.autoTable({startY:60,head:[["Métrica","Valor"]],body:a,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=n.lastAutoTable?n.lastAutoTable.finalY+20:60;n.text("Detalhes das Vendas",20,r),n.autoTable({html:`#${e}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),n.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Kd(t){const e=document.getElementById("genericModal"),s=A(t.client),n=A(t.items),o=A(t.responsavelCaixa||"N/A"),r=(t.payments||[]).map(a=>`
    ...
    `,e.style.display="flex"}function t2(t){const{summary:e,transactions:s}=t;document.getElementById("summary-revenue").textContent=`R$ ${e.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=e.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${e.averageTicket.toFixed(2)}`;const n=document.getElementById("paymentSummaryTableBody"),o=Object.entries(e.paymentMethodTotals).sort(([,l],[,c])=>c-l);n.innerHTML=o.map(([l,c])=>`
        <tr class="border-b">
    ...
    `}).join(""),a.querySelectorAll("div[data-transaction-index]").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.transactionIndex,d=ii.transactions[c];d&&Kd(d)})})}async function Jd(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),s=document.getElementById("reportEndDate");if(!t||!e||!s)return;const n=e.value,o=s.value;if(!n||!o)return k("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,a=await sx({establishmentId:w.establishmentId,startDate:n,endDate:o,cashierSessionId:r});ii=a,t.innerHTML=`
        ...
        `,t2(a)}catch(r){k("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${A(r.message)}</p>`}}async function s2(){Z1();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const s=e.toISOString().split("T")[0];Y1.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Jd),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const n=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${n}_a_${o}`;e2(r,"transactionsTable")});try{const n=await Dx(w.establishmentId),o=document.getElementById("cashierSessionFilter");n&&n.length>0&&n.forEach(r=>{const a=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),l=A(r.closedByName||"N/A");o.innerHTML+=`<option value="${r.id}">${l} - ${a}</option>`})}catch{k("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Jd()}const n2=document.getElementById("content");let W={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},Ta=null,Io=null,So=null;function ll(t){const e=new Map,s=[];return t&&(t.forEach(n=>e.set(n.id,{...n,children:[]})),e.forEach(n=>{n.parentId&&e.has(n.parentId)?e.get(n.parentId).children.push(n):s.push(n)})),s}function Rp(t,e,s){if(!t)return;if(!e||e.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const n=(o,r=0)=>{const a="— ".repeat(r);return`
    ...
    `,t.style.display="flex"}function a2(){const t=document.getElementById("genericModal");t.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const o=document.getElementById("main-fab-btn"),r=document.getElementById("fab-menu");if(o&&r){o.addEventListener("click",_=>{_.stopPropagation(),r.classList.toggle("hidden"),o.classList.toggle("rotate-45")});const f=r.querySelector('button[data-action="open-modal"][data-type="receivable"]'),y=r.querySelector('button[data-action="open-modal"][data-type="payable"]'),I=r.querySelector('button[data-action="open-cash-flow-modal"]');f&&f.addEventListener("click",_=>{_.stopPropagation(),ka("receivable")}),y&&y.addEventListener("click",_=>{_.stopPropagation(),ka("payable")}),I&&I.addEventListener("click",_=>{_.stopPropagation(),Yd()})}Io&&document.body.removeEventListener("click",Io),So&&document.getElementById("genericModal").removeEventListener("click",So);const a=()=>{const f=document.getElementById("filterStartDate"),y=document.getElementById("filterEndDate"),I=document.getElementById("filterNaturezaId"),_=document.getElementById("filterCostCenterId");if(!f)return;W.startDate=f.value,W.endDate=y.value,W.filterNaturezaId=I.value,W.filterCostCenterId=_.value;const D=document.getElementById("advanced-filters");D&&D.classList.contains("hidden")===!1&&window.innerWidth<768&&D.classList.add("hidden"),ns()},l=f=>{const y=f.target.closest("[data-status-filter]");if(!y)return;const I=y.dataset.statusFilter;W.currentFilter=I,document.querySelectorAll("[data-status-filter]").forEach(_=>{_.classList.remove("bg-blue-100","text-blue-800"),_.classList.add("bg-gray-100","text-gray-600")}),y.classList.remove("bg-gray-100","text-gray-600"),y.classList.add("bg-blue-100","text-blue-800"),li()},c=f=>{const y=document.getElementById("payables-container"),I=document.getElementById("receivables-container"),_=document.getElementById("btn-payables-view"),D=document.getElementById("btn-receivables-view");y&&(window.innerWidth>=1024&&W.currentListView===f||(f==="payables"?(y.classList.remove("hidden"),I.classList.add("hidden"),_&&(_.classList.remove("bg-gray-200"),_.classList.add("bg-red-100","border","border-red-500")),D&&(D.classList.remove("bg-green-100","border","border-green-500"),D.classList.add("bg-gray-200"))):(y.classList.add("hidden"),I.classList.remove("hidden"),_&&(_.classList.remove("bg-red-100","border","border-red-500"),_.classList.add("bg-gray-200")),D&&(D.classList.remove("bg-gray-200"),D.classList.add("bg-green-100","border","border-green-500"))),W.currentListView=f))};document.getElementById("applyDateFilterBtn").addEventListener("click",a),document.getElementById("filterNaturezaId").addEventListener("change",()=>{W.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{W.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(f=>{f.addEventListener("click",l)}),Io=f=>{const y=f.target.closest("button[data-action]");if(!y)return;const{action:I,type:_,id:D}=y.dataset;I==="edit"?ka(_,JSON.parse(y.dataset.item.replace(/&apos;/g,"'"))):I==="delete"?l2(_,D):I==="mark-as-paid"?c2(_,D):I==="manage-natures"?Qd("nature"):I==="manage-cost-centers"?Qd("cost-center"):I==="open-cash-flow-modal"?Yd():I==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):I==="open-indicators-modal"?r2():I==="open-settings-modal"?a2():I==="toggle-list-view"&&c(y.dataset.list)},So=f=>{const y=f.target.closest('button[data-action^="delete-"]');if(y){const I=y.dataset.action.split("-")[1];d(I,y.dataset.id)}},document.body.addEventListener("click",Io),document.getElementById("genericModal").addEventListener("click",So);async function d(f,y){const I=f==="nature",_=I?l1:d1,D=I?On:qn,R=I?"natures":"costCenters",O=document.getElementById("hierarchyList");if(await le("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await _(y);const B=await D(w.establishmentId);W[R]=B,Rp(O,ll(B),f),await ns()}catch(B){k("Erro",`Não foi possível apagar: ${B.message}`,"error")}}const p=()=>{const f=window.innerWidth<1024,y=document.getElementById("payables-container"),I=document.getElementById("receivables-container"),_=document.getElementById("list-toggle-buttons");y&&I&&(y.classList.remove("hidden"),I.classList.remove("hidden"),f?(y.classList.remove("lg:col-span-1"),I.classList.remove("lg:col-span-1"),_?.classList.remove("hidden"),c(W.currentListView)):(y.classList.add("lg:col-span-1"),I.classList.add("lg:col-span-1"),_?.classList.add("hidden"),y.classList.remove("hidden"),I.classList.remove("hidden")))};p(),window.addEventListener("resize",p);const h=document.querySelector(`[data-status-filter="${W.currentFilter}"]`);h&&(document.querySelectorAll("[data-status-filter]").forEach(f=>{f.classList.remove("bg-blue-100","text-blue-800"),f.classList.add("bg-gray-100","text-gray-600")}),h.classList.remove("bg-gray-100","text-gray-600"),h.classList.add("bg-blue-100","text-blue-800"));try{const f=await E1(w.establishmentId),y=document.getElementById("summary-today-payables");y&&(y.textContent=`R$ ${f.totalPayables.toFixed(2)}`);const I=document.getElementById("summary-today-receivables");I&&(I.textContent=`R$ ${f.totalReceivables.toFixed(2)}`)}catch{}await ns()}const u2=t=>F("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),m2=t=>F("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),p2=(t,e)=>{const s=new URLSearchParams({startDate:t,endDate:e}).toString();return F(`/api/commissions/stats?${s}`)},h2=(t={})=>{Object.keys(t).forEach(n=>(t[n]===void 0||t[n]===null||t[n]==="")&&delete t[n]);const e=new URLSearchParams(t).toString(),s=`/api/commissions/history${e?"?"+e:""}`;return F(s)},g2=t=>F(`/api/commissions/report/${t}`,{method:"DELETE"}),or=new Date,tu=new Date(or.getFullYear(),or.getMonth(),1),J={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:tu.toISOString().split("T")[0],dashEndDate:or.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:tu.toISOString().split("T")[0],histEndDate:or.toISOString().split("T")[0],histProfessionalId:"all"};let ko=null;const gn=document.getElementById("content");async function f2(){try{J.professionals=await Ge(w.establishmentId)}catch(t){console.error("Erro profissionais",t)}C2(),b2(),Lr(),ar("dashboard")}function b2(){ko&&gn.removeEventListener("click",ko),ko=t=>{const e=t.target.closest("button");if(!e)return;const s=e.dataset.action,n=e.dataset.id,o=e.dataset.idx;switch(s){case"tab-nav":ar(e.dataset.tab);break;case"toggle-all-profs":v2();break;case"back-to-filters":J.calculationResult=null,rr(document.getElementById("commissions-content"));break;case"view-preview-items":k2(o);break;case"save-final-report":x2();break;case"start-new-calc":ar("calculator");break;case"print-receipt":w2(n);break;case"delete-report":E2(n);break;case"filter-dashboard":Lr();break;case"filter-history":cl();break}},gn.addEventListener("click",ko),gn.oninput=t=>{if(t.target.classList.contains("input-debit")||t.target.classList.contains("input-credit")){const e=t.target.dataset.idx;S2(e)}},gn.onsubmit=t=>{t.target.id==="calc-form"&&(t.preventDefault(),y2())}}async function Lr(){const t=document.getElementById("dash-start"),e=document.getElementById("dash-end");t&&(J.dashStartDate=t.value),e&&(J.dashEndDate=e.value);const s=document.getElementById("dashboard-stats-container");s&&(s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const n=await p2(J.dashStartDate,J.dashEndDate);J.dashStats={revenue:n.totalRevenue||0,commissions:n.totalCommissionsPaid||0},J.currentTab==="dashboard"&&Mp(document.getElementById("commissions-content"))}catch(n){console.error(n),s&&(s.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function cl(){const t=document.getElementById("hist-start"),e=document.getElementById("hist-end"),s=document.getElementById("hist-prof");t&&(J.histStartDate=t.value),e&&(J.histEndDate=e.value),s&&(J.histProfessionalId=s.value);const n=document.getElementById("history-list-container");if(n){n.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const o=await h2({startDate:J.histStartDate,endDate:J.histEndDate,professionalId:J.histProfessionalId});J.historyData=o,Np(n,o)}catch{n.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function v2(){const t=document.querySelectorAll(".prof-checkbox"),e=Array.from(t).every(s=>s.checked);t.forEach(s=>s.checked=!e)}async function y2(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(r=>r.value);if(t.length===0)return k("Atenção","Selecione profissionais","error");const e={professionalIds:t,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},s=new Date(e.startDate+"T00:00:00").toLocaleDateString("pt-BR"),n=new Date(e.endDate+"T00:00:00").toLocaleDateString("pt-BR");J.periodString=`${s} a ${n}`;const o=document.getElementById("commissions-content");o.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const r=await u2(e);J.calculationResult=r.map(a=>({...a,extraDebit:0,extraCredit:0,finalValue:a.summary.totalCommission,notes:""})),rr(o)}catch(r){k("Erro",r.message,"error"),J.calculationResult=null,rr(o)}}async function x2(){const t=J.calculationResult.length;if(await le("Confirmar",`Gerar ${t} relatórios? Isso marcará as vendas como pagas.`))try{const s=J.calculationResult.map(n=>{const o=n.items.map(r=>r.originalSaleId).filter(r=>r!=null);return m2({professionalId:n.professionalId,professionalName:n.professionalName,period:J.periodString,processedSalesIds:o,reportData:{...n,summary:{...n.summary,finalValue:n.finalValue,extraDebit:n.extraDebit||0,extraCredit:n.extraCredit||0,notes:n.notes||""}}})});await Promise.all(s),k("Sucesso","Pagamentos registrados!","success"),J.calculationResult=null,Lr(),ar("history")}catch(s){k("Erro",s.message,"error")}}function w2(t){const e=J.historyData.find(s=>s.id===t);e&&I2(e)}async function E2(t){if(await le("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await g2(t),k("Sucesso","Registro removido.","success"),cl(),Lr()}catch(s){k("Erro",s.message,"error")}}function I2(t){const{jsPDF:e}=window.jspdf;if(!e)return k("Erro","PDF lib não carregada.","error");const s=new e,n=s.internal.pageSize.getWidth()/2;s.setFontSize(18),s.setFont(void 0,"bold"),s.text("RECIBO DE PAGAMENTO DE COMISSÃO",n,20,{align:"center"}),s.setFontSize(12),s.setFont(void 0,"normal"),s.text(`Profissional: ${t.professionalName}`,15,40),s.text(`Período: ${t.period}`,15,48);const o=[["Comissão Bruta",`R$ ${t.summary.totalCommission.toFixed(2)}`]];t.summary.extraCredit>0&&o.push(["(+) Bônus",`R$ ${t.summary.extraCredit.toFixed(2)}`]),t.summary.extraDebit>0&&o.push(["(-) Descontos",`R$ ${t.summary.extraDebit.toFixed(2)}`]),s.autoTable({startY:60,head:[["Descrição","Valor"]],body:o,theme:"grid"});const r=s.lastAutoTable.finalY+10;s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${(t.summary.finalValue||t.summary.totalCommission).toFixed(2)}`,190,r,{align:"right"}),s.save(`Recibo_${t.professionalName}.pdf`)}function S2(t){const e=document.querySelectorAll(`.input-debit[data-idx="${t}"]`),s=document.querySelectorAll(`.input-credit[data-idx="${t}"]`);let n=0,o=0;if(e.forEach(r=>{r.value&&(n=parseFloat(r.value))}),s.forEach(r=>{r.value&&(o=parseFloat(r.value))}),J.calculationResult&&J.calculationResult[t]){const r=J.calculationResult[t];r.extraDebit=n,r.extraCredit=o,r.finalValue=r.summary.totalCommission-n+o,e.forEach(l=>{l!==document.activeElement&&(l.value=n||"")}),s.forEach(l=>{l!==document.activeElement&&(l.value=o||"")}),document.querySelectorAll(`.final-value-display[data-idx="${t}"]`).forEach(l=>l.innerText=`R$ ${r.finalValue.toFixed(2)}`),T2()}}function T2(){const t=J.calculationResult.reduce((s,n)=>s+n.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(s=>s.innerText=`R$ ${t.toFixed(2)}`)}function k2(t){const e=J.calculationResult[t];if(!e)return;const s=e.items.map(n=>`
    ...
    `}function _2(t){const e=J.professionals.map(s=>`<option value="${s.id}" ${J.histProfessionalId===s.id?"selected":""}>${s.name}</option>`).join("");t.innerHTML=`
        <div class="space-y-6">
    ...
    `,J.historyData.length>0?Np(document.getElementById("history-list-container"),J.historyData):cl()}function Np(t,e){if(e.length===0){t.innerHTML=`
    ...
    `}const Ca=document.getElementById("content");let os={allPackages:[],catalogForModal:{services:[],products:[]}},Co=null,Cs=null;function A2(t=6){let e="";for(let s=0;s<t;s++)e+=`
        ...
        `;return e}function P2(){const t=document.getElementById("packagesListContainer");if(t){if(os.allPackages.length===0){t.innerHTML=`
    ...
    `,await M2()}async function M2(){const t=document.getElementById("professional-agenda-block");t.innerHTML="";try{const e=w.userProfessionalId;if(e){const s=await jh(e);L2=s,s.photo&&(document.getElementById("user-profile-avatar").src=s.photo);const n=A(s.name);t.innerHTML=`
            ...
            `,N2(s.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>ir(s.id,r.target.value)),ir(s.id,"future")}else t.innerHTML=`
    ...
    `}function ci(){const t=Pn.filter(e=>!e.read).length;if(t>0?(Pa.textContent=t,Pa.classList.remove("hidden")):Pa.classList.add("hidden"),Pn.length===0){ru.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}ru.innerHTML=Pn.map(e=>`
    ...
    `).join("")}function H2(t){An&&An();const e=$t(Ae,"establishments",t,"notifications"),s=lr(e,$n("timestamp",">=",new Date),du("timestamp","desc"));An=Ih(s,n=>{n.docChanges().forEach(o=>{if(o.type==="added"){const r=o.doc.data();Pn.unshift({title:r.title,message:r.message,time:r.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),k(r.title,r.message,"info",!0),ci();const a=document.querySelector(".sidebar-link.active");a&&a.dataset.target==="agenda-section"&&(r.type==="cancellation"||r.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),pp())}})},n=>{console.error("Erro no listener de notificações em tempo real:",n)})}function Ye(t,e={}){const s=t.replace("-section","");if(t!=="my-profile-section"){const o=w.enabledModules?.[s]!==!1,r=w.userPermissions===null||w.userPermissions[t]?.view===!0;if(!o||!r){Aa.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(a=>a.classList.remove("active"));return}}const n=q2[t];n?(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Aa.innerHTML="",n(e)):Aa.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${t}" ainda não foi implementado.</p></div>`}async function U2(t){const e=document.getElementById("kpi-appointments-wrapper"),s=document.getElementById("kpi-financial-wrapper"),n=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),r=t===null||t["agenda-section"]?.view===!0,a=t===null||t["financial-section"]?.view===!0;if(r&&e&&e.classList.remove("hidden"),a&&s&&s.classList.remove("hidden"),!(!r&&!a))try{const l=await nx();r&&n&&(n.textContent=l.todayAppointments.toString()),a&&o&&(o.textContent=`R$ ${l.todayRevenue.toFixed(2).replace(".",",")}`)}catch(l){console.error("Erro ao carregar KPIs do cabeçalho:",l)}}async function z2(t){try{console.log("[Nativo] Iniciando configuração de Push..."),Zt.getPlatform()==="android"&&(await Be.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let e=await Be.checkPermissions();if(e.receive==="prompt"&&(e=await Be.requestPermissions()),e.receive!=="granted"){alert("ERRO: Permissão de notificações negada!");return}await Be.register(),Be.addListener("registration",async s=>{console.log("Push Token gerado:",s.value),alert("SUCESSO: Token gerado! "+s.value.substring(0,10)+"...");try{const n=rs(Ae,"users",t);await mu(n,{fcmTokens:Eh(s.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(n){alert("Erro ao salvar no Banco: "+n.message),console.error("Erro ao salvar token FCM:",n)}}),Be.addListener("registrationError",s=>{alert("FALHA DE REGISTO: "+JSON.stringify(s)),console.error("Erro no registo de push notifications:",s)}),Be.addListener("pushNotificationReceived",s=>{console.log("Notificação Push recebida:",s),k(s.title,s.body,"info",!0)}),Be.addListener("pushNotificationActionPerformed",s=>{console.log("Ação na notificação push:",s),Ye("agenda-section")})}catch(e){alert("Erro Fatal Push: "+e.message),console.log("Push Notifications não suportado/inicializado:",e)}}async function W2(){try{await vh(_e,yh),console.log("Persistência LOCAL configurada na inicialização.")}catch(t){console.error("Erro ao definir persistência no main.js",t)}Zt.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Rh(),ou.addEventListener("click",t=>{t.stopPropagation(),Ao.classList.toggle("hidden"),Ao.classList.contains("hidden")||(Pn.forEach(e=>e.read=!0),ci())}),O2.addEventListener("click",()=>{Mh()}),$a.addEventListener("click",t=>{t.stopPropagation(),nt.classList.toggle("active"),nt.classList.contains("active")?nt.classList.remove("hidden"):setTimeout(()=>nt.classList.add("hidden"),200)}),au&&au.addEventListener("click",t=>{t.preventDefault(),Ye("my-profile-section"),nt.classList.remove("active"),nt.classList.add("hidden")}),document.addEventListener("click",t=>{!Ao.contains(t.target)&&t.target!==ou&&Ao.classList.add("hidden"),!nt.contains(t.target)&&t.target!==$a&&nt.classList.contains("active")&&(nt.classList.remove("active"),setTimeout(()=>nt.classList.add("hidden"),200))}),lu(_e,async t=>{if(t){console.log("Usuário detectado:",t.email),Zt.isNativePlatform()||(console.log("Inicializando Web Push (PWA)..."),op());try{const s=(await t.getIdTokenResult(!0)).claims;if((s.role==="owner"||s.role==="employee")&&s.establishmentId){const n=await ms(s.establishmentId);w.enabledModules=n.modules,j2(n.themeColor||"indigo");let o=null,r=t.displayName,a=null;if(s.role==="employee"||s.role==="owner"){const d=rs(Ae,"users",t.uid),p=await wh(d);if(p.exists()){const h=p.data();o=s.role==="employee"?h.permissions||{}:null,r=h.name||r,a=h.professionalId||null}else if(s.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}w.userProfessionalId=a,Zt.isNativePlatform()&&z2(t.uid);const l=r||t.email;Sh(s.establishmentId,n.name,o),$a.textContent=l.charAt(0).toUpperCase(),B2.textContent=l,V2.textContent=t.email;const c=()=>{An&&An(),pc(_e).then(()=>window.location.href="/login.html")};F2.addEventListener("click",d=>{d.preventDefault(),c()}),Fh(Ye,o,w.enabledModules),U2(o),H2(s.establishmentId),ci(),_o.classList.add("fade-out"),_a.style.display="flex",setTimeout(()=>{_o.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{Zh()},1500),Ye("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(e){console.error("Erro crítico na inicialização do painel:",e),_o.classList.add("fade-out"),setTimeout(()=>{_o.style.display="none"},500),_a.innerHTML=`
                ...
                `,_a.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{pc(_e).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}W2();lu(_e,t=>{t&&op()});
