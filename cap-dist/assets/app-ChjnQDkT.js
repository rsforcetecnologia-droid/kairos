const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-BqG6AAOx.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/utils-JfzC6GFr.js","assets/styles-CQhY7Cv2.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as ye,d as fe,m as Ds}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Bi,reauthenticateWithCredential as Ai,verifyBeforeUpdateEmail as qi,updatePassword as ji,updateProfile as Ni,setPersistence as Ri,browserLocalPersistence as Fi,onAuthStateChanged as Hi,signOut as Oi}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as Be,getDoc as cs,updateDoc as Pt,setDoc as zi,addDoc as xo,collection as ya,query as ho,where as vo,getDocs as _i,deleteDoc as Vi,arrayUnion as Ui,orderBy as Wi,onSnapshot as Ji}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{a as L,e as v,s as Q,b as f,c as je,r as wa,f as Aa,i as Qi}from"./utils-JfzC6GFr.js";import{getToken as Gi,onMessage as Yi}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const g={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Xi(t,e,a){g.establishmentId=t,g.establishmentName=e,g.userPermissions=a,g.currentViewContext={type:"BRANCH",id:t,name:e}}const ka=(t,e,a,s=null)=>{let i=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(i+=`&professionalId=${s}`),L(i)},Zi=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return L(s)},Ki=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const i=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return L(i)},er=t=>L("/api/appointments",{method:"POST",body:JSON.stringify(t)}),tr=(t,e)=>L(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),ar=t=>L(`/api/appointments/${t}`,{method:"DELETE"}),sr=t=>L(`/api/appointments/${t}/reopen`,{method:"POST"}),or=(t,e)=>L(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)}),ne=document.getElementById("sidebar"),_e=document.getElementById("sidebarToggle"),yt=document.getElementById("mainContent"),ir=document.querySelectorAll(".sidebar-link"),_a=document.getElementById("menu-search"),Ps=document.getElementById("hamburger-menu-btn"),st=document.getElementById("mobile-overlay");let Me=!0;function Fe(t){if(!ne||!yt)return;ne.classList.toggle("collapsed",t),yt.classList.toggle("sidebar-collapsed-shift",t);const e=ne.querySelector(".sidebar-search-container"),a=ne.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const i=s.getAttribute("data-target-submenu"),o=document.getElementById(i),r=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),r&&r.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function rr(){!ne||!st||(ne.classList.add("mobile-open"),st.classList.add("visible"))}function At(){!ne||!st||(ne.classList.remove("mobile-open"),st.classList.remove("visible"))}function nr(){Fe(!ne.classList.contains("collapsed"))}function lr(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&ne.classList.contains("collapsed")&&Fe(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function dr(){_a&&_a.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),i=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),i.forEach(o=>o.style.display="block");return}i.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const r=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!r)return;if(r.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=r.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function cr(t,e,a){if(!ne||!yt)return;yt.classList.add("main-content-shift"),window.innerWidth>=1024?(Me=!0,Fe(!1)):window.innerWidth>=768?(Me=!1,Fe(!0)):(yt.classList.remove("main-content-shift","sidebar-collapsed-shift"),At()),_e&&_e.addEventListener("click",i=>{i.stopPropagation(),window.innerWidth>=768?(Me=!Me,Fe(!Me),Me?(_e.classList.add("text-indigo-400"),_e.classList.remove("text-gray-400")):(_e.classList.remove("text-indigo-400"),_e.classList.add("text-gray-400"))):nr()}),ne.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Me&&ne.classList.contains("collapsed")&&Fe(!1)}),ne.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Me){const i=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===_a;!i&&!o&&Fe(!0)}}),Ps&&Ps.addEventListener("click",i=>{i.stopPropagation(),rr()}),st&&st.addEventListener("click",i=>{i.stopPropagation(),At()});let s=0;ne.addEventListener("touchstart",i=>{s=i.changedTouches[0].screenX},{passive:!0}),ne.addEventListener("touchend",i=>{const o=i.changedTouches[0].screenX;s-o>50&&At()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(i=>{i.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const r=i.getAttribute("data-target-submenu"),n=i.querySelector(".submenu-arrow");lr(r,n)})}),dr(),ir.forEach(i=>{const o=i.getAttribute("data-target");if(!o)return;const r=o.replace("-section",""),n=a?.[r]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){i.parentElement&&i.parentElement.tagName==="LI"?i.parentElement.style.display="none":i.style.display="none";return}i.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),i.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&At()})})}const ur=t=>L("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),we=()=>L("/api/establishments/hierarchy",{method:"GET"}),Ae=t=>{const e=t||g.establishmentId;return e?L(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},us=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},pr=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},br=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Ie=t=>L(`/api/professionals/${t}`),yo=t=>L(`/api/professionals/details/${t}`),mr=t=>L("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Va=(t,e)=>L(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),wo=t=>L(`/api/professionals/${t}`,{method:"DELETE"}),gr=t=>{const e=t.map(a=>wo(a));return Promise.all(e)};class fr{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const i=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${i.top+window.scrollY-o}px`,this.spotlight.style.left=`${i.left+window.scrollX-o}px`,this.spotlight.style.width=`${i.width+o*2}px`,this.spotlight.style.height=`${i.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(i)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
            <div class="p-5">
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(e){const a=this.popover.getBoundingClientRect(),s=20;let i=e.bottom+window.scrollY+s,o=e.left+window.scrollX;i+a.height>window.scrollY+window.innerHeight&&(i=e.top+window.scrollY-a.height-s),o+a.width>window.innerWidth&&(o=e.right+window.scrollX-a.width),o<s&&(o=s),this.popover.style.top=`${i}px`,this.popover.style.left=`${o}px`}handleResize(){this.isActive&&this.renderStep()}sleep(e){return new Promise(a=>setTimeout(a,e))}async waitForElement(e,a){if(!e)return null;const s=Date.now();for(;Date.now()-s<a;){const i=document.querySelector(e);if(i)return i;await this.sleep(100)}return null}}async function xr(){try{console.log("A verificar Onboarding interativo...");const t=await Ae(g.establishmentId);if(!t||t.parentId||t.onboardingCompleted)return;const e=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await us(g.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(i){console.error("Erro ao gravar fim do onboarding",i)}};new fr(e,a,a).start()}catch(t){console.error("Erro fatal ao iniciar onboarding:",t)}}var ot;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(ot||(ot={}));class qa extends Error{constructor(e,a,s){super(e),this.message=e,this.code=a,this.data=s}}const hr=t=>{var e,a;return t?.androidBridge?"android":!((a=(e=t?.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},vr=t=>{const e=t.CapacitorCustomPlatform||null,a=t.Capacitor||{},s=a.Plugins=a.Plugins||{},i=()=>e!==null?e.name:hr(t),o=()=>i()!=="web",r=c=>{const p=d.get(c);return!!(p?.platforms.has(i())||n(c))},n=c=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===c)},l=c=>t.console.error(c),d=new Map,u=(c,p={})=>{const b=d.get(c);if(b)return console.warn(`Capacitor plugin "${c}" already registered. Cannot register plugins twice.`),b.proxy;const m=i(),h=n(c);let y;const w=async()=>(!y&&m in p?y=typeof p[m]=="function"?y=await p[m]():y=p[m]:e!==null&&!y&&"web"in p&&(y=typeof p.web=="function"?y=await p.web():y=p.web),y),M=(C,D)=>{var V,P;if(h){const T=h?.methods.find(F=>D===F.name);if(T)return T.rtype==="promise"?F=>a.nativePromise(c,D.toString(),F):(F,X)=>a.nativeCallback(c,D.toString(),F,X);if(C)return(V=C[D])===null||V===void 0?void 0:V.bind(C)}else{if(C)return(P=C[D])===null||P===void 0?void 0:P.bind(C);throw new qa(`"${c}" plugin is not implemented on ${m}`,ot.Unimplemented)}},B=C=>{let D;const V=(...P)=>{const T=w().then(F=>{const X=M(F,C);if(X){const te=X(...P);return D=te?.remove,te}else throw new qa(`"${c}.${C}()" is not implemented on ${m}`,ot.Unimplemented)});return C==="addListener"&&(T.remove=async()=>D()),T};return V.toString=()=>`${C.toString()}() { [capacitor code] }`,Object.defineProperty(V,"name",{value:C,writable:!1,configurable:!1}),V},S=B("addListener"),I=B("removeListener"),N=(C,D)=>{const V=S({eventName:C},D),P=async()=>{const F=await V;I({eventName:C,callbackId:F},D)},T=new Promise(F=>V.then(()=>F({remove:P})));return T.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await P()},T},U=new Proxy({},{get(C,D){switch(D){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?N:S;case"removeListener":return I;default:return B(D)}}});return s[c]=U,d.set(c,{name:c,proxy:U,platforms:new Set([...Object.keys(p),...h?[m]:[]])}),U};return a.convertFileSrc||(a.convertFileSrc=c=>c),a.getPlatform=i,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=r,a.registerPlugin=u,a.Exception=qa,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},yr=t=>t.Capacitor=vr(t),$e=yr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Sa=$e.registerPlugin;class ko{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,a){let s=!1;this.listeners[e]||(this.listeners[e]=[],s=!0),this.listeners[e].push(a);const o=this.windowListeners[e];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(e);const r=async()=>this.removeListener(e,a);return Promise.resolve({remove:r})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,a,s){const i=this.listeners[e];if(!i){if(s){let o=this.retainedEventArguments[e];o||(o=[]),o.push(a),this.retainedEventArguments[e]=o}return}i.forEach(o=>o(a))}hasListeners(e){var a;return!!(!((a=this.listeners[e])===null||a===void 0)&&a.length)}registerWindowListener(e,a){this.windowListeners[a]={registered:!1,windowEventName:e,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(e="not implemented"){return new $e.Exception(e,ot.Unimplemented)}unavailable(e="not available"){return new $e.Exception(e,ot.Unavailable)}async removeListener(e,a){const s=this.listeners[e];if(!s)return;const i=s.indexOf(a);this.listeners[e].splice(i,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const a=this.retainedEventArguments[e];a&&(delete this.retainedEventArguments[e],a.forEach(s=>{this.notifyListeners(e,s)}))}}const Ts=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ms=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class wr extends ko{async getCookies(){const e=document.cookie,a={};return e.split(";").forEach(s=>{if(s.length<=0)return;let[i,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=Ms(i).trim(),o=Ms(o).trim(),a[i]=o}),a}async setCookie(e){try{const a=Ts(e.key),s=Ts(e.value),i=`; expires=${(e.expires||"").replace("expires=","")}`,o=(e.path||"/").replace("path=",""),r=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${a}=${s||""}${i}; path=${o}; ${r};`}catch(a){return Promise.reject(a)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const a of e)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}Sa("CapacitorCookies",{web:()=>new wr});const kr=async t=>new Promise((e,a)=>{const s=new FileReader;s.onload=()=>{const i=s.result;e(i.indexOf(",")>=0?i.split(",")[1]:i)},s.onerror=i=>a(i),s.readAsDataURL(t)}),Sr=(t={})=>{const e=Object.keys(t);return Object.keys(t).map(i=>i.toLocaleLowerCase()).reduce((i,o,r)=>(i[o]=t[e[r]],i),{})},$r=(t,e=!0)=>t?Object.entries(t).reduce((s,i)=>{const[o,r]=i;let n,l;return Array.isArray(r)?(l="",r.forEach(d=>{n=e?encodeURIComponent(d):d,l+=`${o}=${n}&`}),l.slice(0,-1)):(n=e?encodeURIComponent(r):r,l=`${o}=${n}`),`${s}&${l}`},"").substr(1):null,Ir=(t,e={})=>{const a=Object.assign({method:t.method||"GET",headers:t.headers},e),i=Sr(t.headers)["content-type"]||"";if(typeof t.data=="string")a.body=t.data;else if(i.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[r,n]of Object.entries(t.data||{}))o.set(r,n);a.body=o.toString()}else if(i.includes("multipart/form-data")||t.data instanceof FormData){const o=new FormData;if(t.data instanceof FormData)t.data.forEach((n,l)=>{o.append(l,n)});else for(const n of Object.keys(t.data))o.append(n,t.data[n]);a.body=o;const r=new Headers(a.headers);r.delete("content-type"),a.headers=r}else(i.includes("application/json")||typeof t.data=="object")&&(a.body=JSON.stringify(t.data));return a};class Er extends ko{async request(e){const a=Ir(e,e.webFetchExtra),s=$r(e.params,e.shouldEncodeUrlParams),i=s?`${e.url}?${s}`:e.url,o=await fetch(i,a),r=o.headers.get("content-type")||"";let{responseType:n="text"}=o.ok?e:{};r.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await o.blob(),l=await kr(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const u={};return o.headers.forEach((c,p)=>{u[p]=c}),{data:l,headers:u,status:o.status,url:o.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}Sa("CapacitorHttp",{web:()=>new Er});const pe=Sa("PushNotifications",{}),Lr="modulepreload",Cr=function(t){return"/"+t},Bs={},Dr=function(e,a,s){let i=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),n=r?.nonce||r?.getAttribute("nonce");i=l(a.map(d=>{if(d=Cr(d),d in Bs)return;Bs[d]=!0;const u=d.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":Lr,u||(p.as="script"),p.crossOrigin="",p.href=d,n&&p.setAttribute("nonce",n),document.head.appendChild(p),u)return new Promise((b,m)=>{p.addEventListener("load",b),p.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(r){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=r,window.dispatchEvent(n),!n.defaultPrevented)throw r}return i.then(r=>{for(const n of r||[])n.status==="rejected"&&o(n.reason);return e().catch(o)})},As=Sa("App",{web:()=>Dr(()=>import("./web-BqG6AAOx.js"),__vite__mapDeps([0,1,2,3,4])).then(t=>new t.AppWeb)}),Pr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let qs=!1;async function Tr(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await pe.removeAllListeners(),await pe.addListener("registration",async a=>{$o(a.value,!0)}),await pe.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await pe.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let e=await pe.checkPermissions();e.receive==="prompt"&&(e=await pe.requestPermissions()),e.receive==="granted"&&await pe.register()}catch(e){console.error("[Push Nativo] Erro:",e)}return}"Notification"in window&&Notification.permission==="granted"&&So()}async function Mr(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await So(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(t){return console.error("Erro ao pedir permissão Web:",t),!1}}async function So(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await t.update();const e=await Gi(Ds,{vapidKey:Pr,serviceWorkerRegistration:t});e?(console.log("[Push Web] Token validado."),await $o(e,!1)):console.warn("[Push Web] Token veio vazio."),qs||(Yi(Ds,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),qs=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}else console.warn("Navegador sem suporte a Service Worker.")}async function $o(t,e){const a=ye.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=Be(fe,"users",a.uid);try{const i=await cs(s);if(i.exists()){const r=i.data().fcmTokens||[];if(r.length===1&&r[0]===t){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Pt(s,{fcmTokens:[t],lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(i){if(i.code==="not-found")try{await zi(s,{email:a.email,fcmTokens:[t],platform:e?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",i)}}const Br=(t,e,a="all",s="all")=>{const i=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&i.append("professionalId",a),s&&s!=="all"&&i.append("costCenterId",s),L(`/api/reports/indicators?${i.toString()}`)},Ar=(t,e="all")=>{const a=new URLSearchParams({date:t});return e&&e!=="all"&&a.append("professionalId",e),L(`/api/reports/appointments/list?${a.toString()}`)},qr=t=>t?L(`/api/financial/cost-centers/${t}`):Promise.resolve([]),jr=(t,e,a)=>{const s=new URLSearchParams({startDate:e,endDate:a});return L(`/api/analytics/${t}?${s.toString()}`)},la=({establishmentId:t,startDate:e,endDate:a,cashierSessionId:s})=>{const i=new URLSearchParams({startDate:e,endDate:a});return s&&s!=="all"&&i.append("cashierSessionId",s),t&&i.append("establishmentId",t),L(`/api/reports/sales?${i.toString()}`)},Nr=(t,e,a)=>L(`/api/analytics/${t}/monthly-details?year=${e}&month=${a}`),Rr=(t,e,a,s)=>{const i=`/api/analytics/${t}/daily-details?year=${e}&month=${a}&day=${s}`;return L(i)},Fr=(t,e,a,s)=>{const i=`/api/analytics/${t}/professional-details?year=${e}&month=${a}&professionalId=${s}`;return L(i)},Hr=(t,e,a,s)=>L(`/api/reports/commissions/${t}?year=${e}&month=${a}&professionalId=${s}`),Io=()=>L("/api/reports/summary",{method:"GET"}),Or=Object.freeze(Object.defineProperty({__proto__:null,getAdvancedIndicators:Br,getAnalytics:jr,getCommissionReport:Hr,getCostCenters:qr,getDailyAppointments:Ar,getDailyTransactions:Rr,getMonthlyAnalytics:Nr,getProfessionalMonthlyDetails:Fr,getSalesReport:la,getSummaryKPIs:Io},Symbol.toStringTag,{value:"Module"})),ps=t=>t?String(t).replace(/\D/g,""):"",dt=(t,e="",a=20,s={})=>{const i=new URLSearchParams;return e&&i.append("search",e),a&&i.append("limit",a),s&&s.hasLoyalty&&i.append("hasLoyalty","true"),s&&s.birthMonth&&i.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&i.append("inactiveDays",s.inactiveDays),L(`/api/clients/${t}?${i.toString()}`)},Eo=(t,e)=>{const a=encodeURIComponent(e);return L(`/api/clients/details/${t}/${a}`)},Lo=t=>{const e=t.phone||t.id;if(!e)throw new Error("Telefone é obrigatório");const a=ps(e),s={...t,phone:a,id:a};return L(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},Co=Lo,Do=(t,e)=>Lo({...e,id:t}),Po=t=>{const e=encodeURIComponent(t);return L(`/api/clients/${e}`,{method:"DELETE"})},zr=(t,e,a,s)=>L("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientPhone:ps(e),points:a,rewardName:s})}),_r=(t,e)=>Eo(t,ps(e)),$a=t=>L(`/api/financial/natures/${t}`),Vr=t=>L("/api/financial/natures",{method:"POST",body:JSON.stringify(t)}),bs=t=>L(`/api/financial/cost-centers/${t}`),Ur=t=>L("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(t)}),To=(t,e)=>L(`/api/financial/${t}`,{method:"POST",body:JSON.stringify(e)}),Mo=(t,e={})=>{let a=`/api/financial/${t}`;const s=new URLSearchParams;e.establishmentId&&s.append("establishmentId",e.establishmentId),e.startDate&&s.append("startDate",e.startDate),e.endDate&&s.append("endDate",e.endDate),e.natureId&&s.append("natureId",e.natureId),e.costCenterId&&s.append("costCenterId",e.costCenterId),e.status&&s.append("status",e.status);const i=s.toString();return i&&(a+=`?${i}`),L(a)},Bo=(t,e,a)=>L(`/api/financial/${t}/${e}`,{method:"PUT",body:JSON.stringify(a)}),Ao=(t,e)=>L(`/api/financial/${t}/${e}`,{method:"DELETE"}),qo=(t,e)=>{const a=e.map(s=>L(`/api/financial/${t}/${s}`,{method:"DELETE"}));return Promise.all(a)},jo=(t,e,a)=>L(`/api/financial/${t}/${e}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),No=t=>To("payables",t),ms=t=>Mo("payables",t),Wr=(t,e)=>Bo("payables",t,e),Jr=t=>Ao("payables",t),Qr=(t,e)=>jo("payables",t,e),Gr=t=>To("receivables",t),Ia=t=>Mo("receivables",t),Yr=(t,e)=>Bo("receivables",t,e),Xr=t=>Ao("receivables",t),Zr=(t,e)=>jo("receivables",t,e);let ja=null;function ke(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${s}`}async function Kr(){const t=document.getElementById("content");t.innerHTML=`
    ...
    `;try{const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),s=new Date(a);s.setHours(23,59,59,999);const i=new Date(a.getFullYear(),a.getMonth(),1),o=new Date(a.getFullYear(),a.getMonth()+1,0),r=new Date(a);r.setDate(a.getDate()-6);const n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=n.map(async j=>{const[ee,le]=await Promise.all([ka(j,i.toISOString(),s.toISOString(),null).catch(()=>[]),dt(j).catch(()=>[])]);return{appts:ee,clients:le}}),u=Promise.all([Ia({startDate:ke(i),endDate:ke(o),establishmentId:l}).catch(()=>({entries:[]})),ms({startDate:ke(i),endDate:ke(o),establishmentId:l}).catch(()=>({entries:[]}))]),[c,[p,b]]=await Promise.all([Promise.all(d),u]);let m=[],h=[];c.forEach(j=>{m=m.concat(j.appts),h=h.concat(j.clients)});const y=p.entries||[],w=b.entries||[],M=ke(a),B=y.filter(j=>j.status==="paid").reduce((j,ee)=>j+ee.amount,0),S=w.filter(j=>j.status==="paid").reduce((j,ee)=>j+ee.amount,0),I=B-S,N=y.filter(j=>j.status==="paid"&&(j.paymentDate===M||!j.paymentDate&&j.dueDate.startsWith(M))).reduce((j,ee)=>j+ee.amount,0),U=m.filter(j=>{const ee=new Date(j.startTime);return ee>=a&&ee<=s}),C=U.length,D=m.filter(j=>j.status==="completed"),V=D.length>0?B/D.length:0,P=U.filter(j=>new Date(j.startTime).getTime()>=e.getTime()&&j.status!=="completed"&&j.status!=="cancelled").sort((j,ee)=>new Date(j.startTime)-new Date(ee.startTime)).slice(0,4).map(j=>({client:j.clientName||"Desconhecido",service:j.serviceName||(j.services&&j.services[0]?j.services[0].name:"Serviço"),time:new Date(j.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(j.professionalName||"").split(" ")[0]||"Profissionais",id:j.id})),T=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,F=new Map;h.forEach(j=>{j.phone?F.set(j.phone,j):F.set(j.id||Math.random().toString(),j)});const te=Array.from(F.values()).filter(j=>{if(!j.birthDate)return!1;let ee,le;if(j.birthDate.includes("-")){const W=j.birthDate.split("-");W[0].length===4?(ee=W[1],le=W[2]):(le=W[0],ee=W[1])}else if(j.birthDate.includes("/")){const W=j.birthDate.split("/");le=W[0],ee=W[1]}return`${le}/${ee}`===T}).map(j=>{let ee="";return j.birthDate&&j.birthDate.includes("-")&&j.birthDate.split("-")[0].length===4&&(ee=a.getFullYear()-parseInt(j.birthDate.split("-")[0])),{name:j.name,age:ee,phone:j.phone}}),re={receitaHoje:N,agendamentosHoje:C,receitaMes:B,despesaMes:S,saldoMes:I,ticketMedio:V},Z=n.length>1;en(t,re,P,te,Z,ke(r),ke(a)),await Ro(r,a),an()}catch(e){console.error("Erro ao carregar dashboard:",e),t.innerHTML=`
    ...
    `}async function Ro(t,e){const a=document.getElementById("chart-container"),s=document.getElementById("chart-start-date"),i=document.getElementById("chart-end-date");if(a){const o=document.createElement("div");o.id="chart-loading-overlay",o.className="absolute inset-0 bg-white/70 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-xl",o.innerHTML='<div class="w-8 h-8 border-[3px] border-indigo-100 border-t-indigo-500 rounded-full animate-spin"></div>',a.appendChild(o)}try{const o=ke(t),r=ke(e),n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=await Ia({startDate:o,endDate:r,establishmentId:l}).catch(()=>({entries:[]})),u=n.map(B=>ka(B,o+"T00:00:00.000Z",r+"T23:59:59.999Z",null).catch(()=>[])),p=(await Promise.all(u)).flat(),b=d.entries||[],m=[],h=[],y=[];let w=new Date(t);w.setHours(0,0,0,0);const M=new Date(e);for(M.setHours(23,59,59,999);w<=M;){const B=ke(w);m.push(w.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}));const S=b.filter(N=>N.status==="paid"&&(N.paymentDate===B||!N.paymentDate&&N.dueDate.startsWith(B))).reduce((N,U)=>N+U.amount,0),I=p.filter(N=>N.status==="completed"&&N.startTime&&N.startTime.startsWith(B)).length;h.push(S),y.push(I),w.setDate(w.getDate()+1)}tn(m,h,y),s&&(s.value=o),i&&(i.value=r)}catch(o){console.error("Erro ao recarregar grafico:",o)}finally{const o=document.getElementById("chart-loading-overlay");o&&o.remove()}}function tn(t,e,a){const s=document.getElementById("revenueChart");if(!s)return;ja&&ja.destroy();const o=s.getContext("2d").createLinearGradient(0,0,0,240);o.addColorStop(0,"rgba(99, 102, 241, 0.2)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)"),ja=new Chart(s,{type:"line",data:{labels:t,datasets:[{label:"Receita Real (R$)",data:e,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.3,yAxisID:"y"},{label:"Agendamentos Feitos",data:a,borderColor:"#10b981",backgroundColor:"transparent",borderWidth:2,borderDash:[5,5],pointBackgroundColor:"#10b981",pointBorderColor:"#ffffff",pointBorderWidth:1,pointRadius:3,pointHoverRadius:5,fill:!1,tension:.3,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,boxHeight:6,font:{family:"Nunito, sans-serif",size:10,weight:"bold"},color:"#64748b"}},tooltip:{backgroundColor:"#1e293b",padding:10,cornerRadius:8,titleFont:{size:11,family:"Nunito, sans-serif",weight:"normal"},bodyFont:{size:12,weight:"bold",family:"Nunito, sans-serif"},displayColors:!0,usePointStyle:!0,callbacks:{label:function(r){return r.datasetIndex===0?"Receita: "+new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(r.parsed.y):"Concluídos: "+r.parsed.y}}}},scales:{y:{type:"linear",display:!0,position:"left",beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"},maxTicksLimit:6,callback:function(r){return"R$ "+r}}},y1:{type:"linear",display:!0,position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1},border:{display:!1},ticks:{color:"#10b981",font:{family:"Nunito, sans-serif",size:9,weight:"600"},stepSize:1,callback:function(r){if(Math.floor(r)===r)return r}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"}}}},interaction:{intersect:!1,mode:"index"}}})}function an(){document.getElementById("content").addEventListener("click",e=>{if(e.target.closest("#btn-update-chart")){const o=document.getElementById("chart-start-date"),r=document.getElementById("chart-end-date");if(o&&r&&o.value&&r.value){const n=new Date(o.value+"T00:00:00"),l=new Date(r.value+"T00:00:00");Ro(n,l)}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"goto-agenda":case"new-appointment":oe("agenda-section");break;case"goto-pdv":oe("comandas-section");break;case"goto-clients":oe("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${g.establishmentId||""}`;window.open(o,"_blank");break}})}const ct=t=>L(`/api/services/${t}`),sn=t=>L("/api/services",{method:"POST",body:JSON.stringify(t)}),on=(t,e)=>L(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Fo=t=>L(`/api/services/${t}`,{method:"DELETE"}),Ea=(t,e,a,s="all")=>{const i=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return L(i)},La=t=>L("/api/blockages",{method:"POST",body:JSON.stringify(t)}),gs=t=>L(`/api/blockages/${t}`,{method:"DELETE"}),Ho=t=>L("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),js=document.getElementById("content");let Ns=!1;const da=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Ca=[],Ua=[],ca={},Oo=[],O={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},H={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function zo(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function ea(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}function fs(){const t=document.getElementById("profSelectorContainer");if(!t||!g.professionals)return;let e=g.professionals.filter(i=>O.showInactiveProfs||i.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(i=>{const o=O.selectedProfessionalId===i.id,r=i.name==="Todos"?"T":i.name.charAt(0).toUpperCase(),n=i.id!=="all"?g.professionalColors.get(i.id)||da[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        `}t.innerHTML=s,t.querySelectorAll('[data-action="select-date"]').forEach(o=>{o.addEventListener("click",()=>{const r=new Date(o.dataset.date);O.currentDate=r,navigator.vibrate&&navigator.vibrate(30),Le()})}),requestAnimationFrame(()=>{const o=t.querySelector(".bg-indigo-600");o&&o.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})})}function Y(t){return v(t||"")}function nn(t,e,a,s,i){const o=(t||"").replace(/\D/g,""),r=new Date(i).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(i).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${e}! Você tem um agendamento de ${a} com ${s} para ${r} às ${n}. Podemos confirmar?`;return`https://wa.me/${o}?text=${encodeURIComponent(l)}`}function ln(t){const e=document.getElementById("agenda-view");if(!e)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=zo(O.currentDate),i=new Date;i.setHours(0,0,0,0);let o='<div class="week-container flex gap-2 overflow-x-auto hide-scrollbar px-4" id="weekScroller">';for(let r=0;r<7;r++){const n=new Date(s);n.setDate(s.getDate()+r);const l=n.toDateString()===i.toDateString(),d=t.filter(c=>new Date(c.startTime).toDateString()===n.toDateString()).sort((c,p)=>new Date(c.startTime)-new Date(p.startTime));let u="";d.length===0?u='<div class="week-empty text-xs text-gray-400 text-center py-4 bg-gray-50 rounded-lg border border-dashed border-gray-200"><i class="bi bi-dash-lg block text-lg mb-1"></i>Livre</div>':u=d.map(c=>{const b=new Date(c.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),m=g.professionalColors.get(c.professionalId)||{main:"#adb5bd"},h=c.status==="completed",y=O.selectedItems.has(c.id);if(c.type==="blockage")return`<div class="week-event-chip bg-red-50 border-l-4 border-red-500 rounded-md p-2 mb-2">
                    ...
                    </div>`;const w=JSON.stringify(c).replace(/'/g,"&apos;"),M=y?"ring-2 ring-indigo-500 bg-indigo-50":"bg-white",B=O.isSelectionMode?`<div class="absolute top-1 right-1 z-10">
                    ...
                    data-action="edit-appointment" data-appointment='${w}'>
                    ${B}
            ...
            </div>`;return}const m=nn(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),h=(s.services||[]).reduce((M,B)=>M+(Number(B.price)||0),0)||Number(s.totalPrice||0)||Number(s.servicePrice||0),y=s.paymentStatus||(s.status==="completed"?"Finalizado":"Agendado"),w=Y((s.professionalName||"").split(" ")[0]);a+=`<div class="list-card flex rounded-2xl p-3.5 shadow-sm border border-gray-100 cursor-pointer transition-transform active:scale-95 ${b} ${d?"opacity-70 bg-gray-50":""}"
            ...
            <div class="flex-1 pl-3.5 flex flex-col justify-center min-w-0">
                ...
                <p class="text-xs text-gray-600 mt-0.5 truncate">${Y(s.serviceName)} <span class="font-bold text-indigo-600 px-1">·</span> ${w}</p>
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function _o(){const t=g.allEvents.filter(e=>O.selectedProfessionalId==="all"||e.professionalId===O.selectedProfessionalId);O.currentView==="list"?dn(t):ln(t),xs()}function xs(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(O.isSelectionMode&&O.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function cn(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(O.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(O.currentView==="list"){rn();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function Le(){const t=document.getElementById("agenda-view");if(!t)return;O.selectedItems.clear(),xs(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',cn();let e,a;if(O.currentView==="list")e=new Date(O.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=zo(O.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const i=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async d=>{const[u,c]=await Promise.all([ka(d,e.toISOString(),a.toISOString(),O.selectedProfessionalId==="all"?null:O.selectedProfessionalId),Ea(d,e.toISOString(),a.toISOString(),O.selectedProfessionalId)]);return{appts:u||[],blockages:c||[]}}),o=await Promise.all(i);let r=[],n=[];if(o.forEach(d=>{r=r.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(u=>({...u,type:u.type||"appointment",professionalName:u.professionalName||(()=>{const c=g.professionals?.find(p=>p.id===u.professionalId);return c?c.name:"Indefinido"})()}));g.allEvents=[...l(r),...l(n)],fs(),_o()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function un(){try{const e=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async r=>{const[n,l,d]=await Promise.all([Ie(r),ct(r),Ae(r)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,i=new Map;let o=a[0]?.estDetails;a.forEach(r=>{r.profs.forEach(n=>s.set(n.id,n)),r.services.forEach(n=>i.set(n.id,n))}),g.professionals=Array.from(s.values()),g.services=Array.from(i.values()),Oo=[],o&&(ca=o.loyaltyProgram||{enabled:!1}),g.professionals.forEach((r,n)=>{g.professionalColors.set(r.id,da[n%da.length])}),fs()}catch{f("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function Vo(t={}){O.currentDate=t.targetDate?new Date(t.targetDate):O.currentDate||new Date,O.isSelectionMode=!1,O.selectedItems.clear(),js.innerHTML=`
        ...
        </div>`}}function mn(){return{title:"Serviços",content:`
        ...
        </div>`}}function gn(){return{title:"Equipe",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            <div class="relative">
                <i class="bi bi-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-base"></i>
        ...
        </div>`}}function fn(){const t=H.data.date||ea();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
        ...
        </div>`}}async function Wa(t=null,e=!1){const a=document.getElementById("appointmentModal");e||(H={step:1,data:{id:t?.id||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(r=>r.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:t?.startTime?ea(new Date(t.startTime)):ea(),time:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,originalDate:t?.startTime?ea(new Date(t.startTime)):null,originalTime:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}}),Ca=g.services||[],Ua=(g.professionals||[]).filter(r=>r.status==="active");let s;switch(H.step){case 1:s=bn(t);break;case 2:s=mn();break;case 3:s=gn();break;case 4:s=fn();break}a.className="fixed inset-0 z-[10000] hidden flex items-end md:items-center justify-center bg-gray-900/50 backdrop-blur-sm transition-opacity duration-300 opacity-0",a.innerHTML=`
    ...
    `;const i=()=>{const r=a.querySelector("#appointmentModalContent");r&&(r.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),r.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),a.classList.add("opacity-0"),setTimeout(()=>{a.classList.add("hidden")},300)};a.querySelectorAll('[data-action="next-step"]').forEach(r=>r.addEventListener("click",()=>{const n=parseInt(r.dataset.currentStep,10);if(n===1&&(H.data.clientName=a.querySelector("#apptClientName").value.trim(),H.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!H.data.clientName))return f("Preencha o nome do cliente.","warning");if(n===2&&H.data.selectedServiceIds.length===0)return f("Selecione um serviço.","warning");if(n===3&&!H.data.professionalId)return f("Escolha um membro da equipe.","warning");gt(n+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(r=>r.addEventListener("click",()=>gt(parseInt(r.dataset.currentStep,10)-1))),a.querySelectorAll('[data-action="close-modal"]').forEach(r=>{r.addEventListener("click",i)}),a.classList.remove("hidden"),a.offsetWidth,a.classList.remove("opacity-0");const o=a.querySelector("#appointmentModalContent");o&&(o.classList.remove("translate-y-full","md:translate-y-8","md:scale-95"),o.classList.add("translate-y-0","md:translate-y-0","md:scale-100")),H.step===2&&a.querySelectorAll(".service-card").forEach(r=>r.addEventListener("click",()=>{const n=a.querySelector("#multiServiceToggle")?.checked,l=r.classList.contains("bg-indigo-50"),d=r.dataset.serviceId;navigator.vibrate&&navigator.vibrate(15),n?l?(r.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.add("border-gray-100","shadow-sm"),H.data.selectedServiceIds=H.data.selectedServiceIds.filter(u=>u!==d)):(r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds.includes(d)||H.data.selectedServiceIds.push(d)):(a.querySelectorAll(".service-card.bg-indigo-50").forEach(u=>{u.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),u.classList.add("border-gray-100","shadow-sm")}),r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds=[d],setTimeout(()=>gt(3),250))})),H.step===3&&a.querySelectorAll(".professional-modal-card").forEach(r=>r.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),a.querySelectorAll(".professional-modal-card.bg-indigo-50").forEach(l=>{l.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),l.classList.add("border-gray-100","shadow-sm")}),r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),H.data.professionalId=r.dataset.professionalId;const n=Ua.find(l=>l.id===r.dataset.professionalId);H.data.professionalName=n?n.name:"",setTimeout(()=>gt(4),250)})),H.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",r=>vn(r.target.value)),H.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",Rs),a.querySelector("#availableTimesContainer")?.addEventListener("click",r=>{const n=r.target.closest("button[data-time-slot]");n&&(navigator.vibrate&&navigator.vibrate(10),a.querySelectorAll("#availableTimesContainer button").forEach(l=>{l.classList.remove("bg-indigo-600","text-white","border-indigo-600","shadow-md"),l.classList.add("bg-white","text-gray-700","border-gray-200","shadow-sm")}),n.classList.add("bg-indigo-600","text-white","border-indigo-600","shadow-md"),n.classList.remove("bg-white","text-gray-700","border-gray-200","shadow-sm"),H.data.time=n.dataset.timeSlot)}),a.querySelector("#btnSubmitAppointment")?.addEventListener("click",xn),Rs(),hn())}async function xn(t){t.preventDefault();const e=document.getElementById("btnSubmitAppointment");if(!H.data.time||!H.data.selectedServiceIds.length||!H.data.professionalId)return f("Selecione horário, serviço e profissional.","warning");e.disabled=!0,e.innerHTML='<i class="bi bi-hourglass-split"></i> Processando...';const a=H.data.selectedServiceIds.map(u=>{const c=Ca.find(p=>p.id===u);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[s,i]=H.data.time.split(":"),o=new Date(`${H.data.date}T${s}:${i}:00`),r=a.reduce((u,c)=>u+(c.duration+(c.bufferTime||0)),0),n=new Date(o.getTime()+r*6e4),d={establishmentId:g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId,clientName:H.data.clientName,clientPhone:H.data.clientPhone,services:a,professionalId:H.data.professionalId,professionalName:H.data.professionalName,startTime:o.toISOString(),endTime:n.toISOString(),redeemedReward:H.data.redeemedReward};H.data.id&&(d.id=H.data.id);try{H.data.id?await tr(H.data.id,d):await er(d),f("Registro salvo!","success");const u=document.getElementById("appointmentModal"),c=u.querySelector("#appointmentModalContent");c&&(c.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),c.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),u.classList.add("opacity-0"),setTimeout(()=>{u.classList.add("hidden")},300),Le()}catch(u){f(u.message,"error"),e.disabled=!1,e.innerHTML=`<i class="bi bi-check-circle-fill"></i> ${H.data.id?"Salvar Edição":"Confirmar"}`}}async function Rs(){const t=document.getElementById("availableTimesContainer"),e=document.getElementById("apptTotalDuration");if(!t)return;const a=document.getElementById("apptDate");a&&a.value&&(H.data.date=a.value);const s=H.data.selectedServiceIds.reduce((u,c)=>{const p=Ca.find(b=>b.id===c);return u+(p?p.duration+(p.bufferTime||0):0)},0);e&&(e.innerHTML=`<strong>${s}</strong> min`);const{professionalId:i,selectedServiceIds:o,date:r,originalDate:n,originalTime:l,id:d}=H.data;if(!i||!o.length||!r){t.innerHTML='<p class="col-span-full text-center text-xs text-gray-500 font-bold py-4 bg-white rounded-xl shadow-sm border border-gray-100">Preencha os passos anteriores.</p>';return}t.innerHTML='<div class="col-span-full flex justify-center py-4"><div class="w-6 h-6 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div></div>';try{const u=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId;let c=await Ki({establishmentId:u,professionalId:i,serviceIds:o,date:r});const p=new Date;if(new Date(r+"T00:00:00").toDateString()===p.toDateString()){const b=p.getHours()*60+p.getMinutes();c=c.filter(m=>{const[h,y]=m.split(":").map(Number);return h*60+y>=b})}d&&r===n&&l&&(c.includes(l)||(c.push(l),c.sort())),t.innerHTML=c.length>0?c.map(b=>{const m=H.data.time===b;return`<button type="button" data-time-slot="${b}" class="py-3 text-sm font-bold rounded-xl border-2 transition-transform active:scale-95 ${m?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-white text-gray-700 border-gray-200 hover:border-indigo-300 shadow-sm"}">${b}</button>`}).join(""):'<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl border border-red-100 shadow-sm">Nenhum horário livre.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl">Erro ao pesquisar.</p>'}}function hn(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:a}=H.data,{enabled:s,rewards:i}=ca;if(!s||!e||!i?.length){t.innerHTML="";return}const o=i.filter(r=>a>=r.points);if(!o.length){t.innerHTML='<p class="text-xs font-bold text-gray-400 mt-3 text-center">Nenhuma recompensa atingida ainda.</p>';return}t.innerHTML=`<div class="border border-indigo-100 bg-indigo-50/80 rounded-xl p-3 mt-3 shadow-sm">
        ...
        ${o.map(r=>`<label class="flex items-center gap-2 p-2 bg-white border border-indigo-100 rounded-lg mb-1.5 cursor-pointer shadow-sm active:scale-95 transition-transform"><input type="radio" name="loyaltyReward" value="${Y(r.reward)}" data-points="${r.points}" class="w-4 h-4 accent-indigo-600"><span class="text-[0.85rem] font-bold text-gray-800 flex-1">${Y(r.reward)}</span><span class="text-[0.65rem] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded">-${r.points} pts</span></label>`).join("")}
            ...
            </div>`).join(""),e.querySelectorAll(".client-card").forEach(n=>{n.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),H.data.clientName=n.dataset.clientName,H.data.clientPhone=n.dataset.clientPhone,H.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(ca?.rewards||[]).map(d=>d.points));H.data.clientHasRewards=ca.enabled&&l!==1/0&&H.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,e.querySelectorAll(".client-card").forEach(d=>{d.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),d.classList.add("border-gray-100","shadow-sm")}),n.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),n.classList.remove("border-gray-100","shadow-sm"),setTimeout(()=>gt(2),250)})})}catch{e.innerHTML='<p class="text-[0.75rem] font-bold text-red-500 bg-red-50 p-3 rounded-xl border border-red-100 text-center shadow-sm">Erro ao pesquisar.</p>'}}const yn=(t,e=null,a=1,s=12)=>{let i=`/api/comandas/${t}?page=${a}&limit=${s}`;return e&&(typeof e=="object"?(e.startDate&&(i+=`&startDate=${e.startDate}`),e.endDate&&(i+=`&endDate=${e.endDate}`)):typeof e=="string"&&(i+=`&date=${e}`)),L(i)},wn=(t,e)=>L(`/api/appointments/${t}/comanda`,{method:"POST",body:JSON.stringify({items:e})}),Uo=t=>L("/api/sales",{method:"POST",body:JSON.stringify(t)}),Ja=(t,e)=>L(`/api/sales/${t}?date=${e}`),kn=(t,e,a)=>{const s=`/api/sales/${t}?startDate=${e}&endDate=${a}`;return L(s)},Sn=t=>L(`/api/sales/${t}/reopen`,{method:"POST"}),Wo=t=>L(`/api/sales/${t}`,{method:"DELETE"}),Fs=Object.freeze(Object.defineProperty({__proto__:null,createSale:Uo,deleteSale:Wo,getSales:Ja,getSalesByDateRange:kn,reopenSale:Sn},Symbol.toStringTag,{value:"Module"})),ut=t=>L(`/api/products/${t}`),Jo=t=>L("/api/products",{method:"POST",body:JSON.stringify(t)}),Qo=(t,e)=>L(`/api/products/${t}`,{method:"PUT",body:JSON.stringify(e)}),hs=t=>L(`/api/products/${t}`,{method:"DELETE"}),Da=(t,e)=>L(`/api/products/${t}/stock`,{method:"PATCH",body:JSON.stringify(e)}),$n=t=>L(`/api/products/${t}/stock-history`),Go=({startDate:t,endDate:e,productId:a,categoryId:s,establishmentId:i})=>{const o=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),i&&o.append("establishmentId",i),L(`/api/products/stock-history/report?${o.toString()}`)},In=Object.freeze(Object.defineProperty({__proto__:null,adjustStock:Da,createProduct:Jo,deleteProduct:hs,getProducts:ut,getStockHistory:$n,getStockReport:Go,updateProduct:Qo},Symbol.toStringTag,{value:"Module"})),En=()=>L("/api/cashier/status").catch(t=>{if(t.message.includes("404")||t.message.includes("não encontrada"))return null;throw t}),Ln=t=>{const e={establishmentId:t.establishmentId,initialAmount:Number(t.initialAmount),notes:t.notes||""};return console.log("Payload enviado para abrir caixa:",e),L("/api/cashier/open",{method:"POST",body:JSON.stringify(e)})},Cn=(t,e)=>{const a={finalAmount:Number(e)};return console.log("Payload enviado para fechar caixa:",a),L(`/api/cashier/close/${t}`,{method:"PUT",body:JSON.stringify(a)})},Dn=()=>L("/api/cashier/history").then(t=>t||[]).catch(t=>(console.error("Erro ao buscar histórico:",t),[])),Pn=t=>L(`/api/cashier/report/${t}`),vs=t=>L(`/api/packages/${t}`),Tn=t=>L("/api/packages",{method:"POST",body:JSON.stringify(t)}),Mn=(t,e)=>L(`/api/packages/${t}`,{method:"PUT",body:JSON.stringify(e)}),Hs=t=>L(`/api/packages/${t}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",selectedCatalogItem:null,isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,establishmentConfig:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryPanel:!1,filterStartDate:"",filterEndDate:"",filterPreset:"hoje"},Ve=null,Ge=null,Os=null;function Yo(t,e){return function(...a){clearTimeout(Os),Os=setTimeout(()=>t.apply(this,a),e)}}function Na(t){const e=new Date;let a,s;t==="hoje"?(a=new Date,s=new Date):t==="este_mes"?(a=new Date(e.getFullYear(),e.getMonth(),1),s=new Date(e.getFullYear(),e.getMonth()+1,0)):t==="mes_passado"?(a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0)):(a=new Date,s=new Date);const i=o=>{const r=o.getTimezoneOffset()*6e4;return new Date(o-r).toISOString().split("T")[0]};return{start:i(a),end:i(s)}}async function zs(t,e="stay"){if(!t||!t.id)return;t._localUpdatedAt=Date.now(),t._cachedItems=null,t._hasUnsavedChanges=!1,Ta(),e==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),ae());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,Pa(),ys()}function ys(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function Pa(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierOpen?(t&&(t.innerHTML=""),e&&(e.classList.remove("opacity-50","cursor-not-allowed"),e.disabled=!1)):(t&&(t.innerHTML=`
        ...
        `),e&&(e.classList.add("opacity-50","cursor-not-allowed"),e.disabled=!0)),qn()}function qn(){const t=document.getElementById("cashier-controls");t&&(x.isCashierOpen?t.innerHTML=`
        ...
        `)}function Ta(){const t=document.getElementById("comandas-list"),e=document.getElementById("pagination-container");if(!t)return;if(!x.isCashierOpen&&x.activeFilter==="abertas"){t.innerHTML=`
        ...
        `,e&&(e.innerHTML="");return}let a=x.allComandas||[];if(x.activeFilter==="abertas"?a=a.filter(i=>i.status!=="completed"):x.activeFilter==="pagas"&&(a=a.filter(i=>i.status==="completed")),An(),a.length===0){t.innerHTML='<p class="text-center text-gray-400 py-12 text-sm font-medium border border-dashed border-gray-200 rounded-2xl mx-2">Nenhuma comanda encontrada.</p>',_s(e);return}const s=document.createDocumentFragment();a.forEach(i=>{const o=qe(i);let r=0;i.status==="completed"&&i.totalAmount!==void 0&&i.totalAmount!==null?r=Number(i.totalAmount):r=o.reduce((B,S)=>B+Number(S.price||0),0);const l=i.loyaltyRedemption||i.discount&&i.discount.reason&&String(i.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-1.5 text-xs shadow-sm border border-yellow-200" title="Prémio Resgatado">🎁</span>':"",d=String(i.id)===String(x.selectedComandaId),u=new Date(i.startTime),c=u.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),p=u.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),b=i.type==="walk-in"||typeof i.id=="string"&&i.id.startsWith("temp-"),m=i.status==="completed",h=v(i.clientName||"Cliente sem nome"),y=v(i.professionalName||"Sem profissional");let w="";m?w='<span class="text-[10px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-md border border-emerald-200">Paga</span>':b?w='<span class="text-[10px] font-black uppercase tracking-wider text-blue-700 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':w='<span class="text-[10px] font-black uppercase tracking-wider text-indigo-700 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const M=document.createElement("div");M.className=`comanda-card cursor-pointer border rounded-2xl p-3.5 hover:bg-gray-50 transition-all shadow-sm mb-2 ${d?"ring-2 ring-indigo-500 bg-indigo-50/50 border-transparent":"bg-white border-gray-200"}`,M.dataset.action="select-comanda",M.dataset.comandaId=i.id,M.innerHTML=`
            <div class="flex justify-between items-start mb-2.5 pointer-events-none">
                ...
                <div class="flex items-center flex-shrink-0">
                    <p class="font-black ${m?"text-emerald-600":"text-gray-900"} text-base">R$ ${r.toFixed(2)}</p>
                    ${l}
                </div>
            </div>
        ...
        `,s.appendChild(M)}),t.innerHTML="",t.appendChild(s),_s(e)}function _s(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=x.paging,i=Math.ceil((a||0)/s);if(i===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full py-1",o.innerHTML=`
    ...
    `,t.appendChild(o),o.querySelectorAll("button[data-page]").forEach(r=>{r.onclick=n=>{n.stopPropagation();const l=parseInt(r.dataset.page,10);l>0&&l<=i&&(x.paging.page=l,xe())}})}function jn(t,e){const a=`
    ...
    `;if(!x.isCashierOpen){t.innerHTML=`
        ...
        `;return}const s=qe(e),i=e.status==="completed",o=e.type==="walk-in"||typeof e.id=="string"&&e.id.startsWith("temp-"),r=s.reduce((m,h)=>{const y=h._source==="original_service",w=h.id||h.name,M=y?`original-${w}`:`${h.type}-${w}`;return m[M]||(m[M]={...h,quantity:0,sources:[]}),m[M].quantity+=1,h._source&&m[M].sources.push(h._source),m},{}),n=Object.values(r).reduce((m,h)=>m+Number(h.price||0)*h.quantity,0),l=v(e.clientName||"Cliente sem nome"),d=v(e.professionalName||"Profissional não atribuído"),u=e._hasUnsavedChanges,c=i?"":`
    ...
    `;t.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-36 md:pb-6 custom-scrollbar bg-slate-50 relative"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(r).map(m=>{const h=m.sources&&m.sources.includes("original_service"),y=x.pendingRedemption&&String(x.pendingRedemption.appliedToItemId)===String(m.id),w=m.isReward||y;return`
                    <div class="flex flex-col bg-white p-4 rounded-2xl border border-gray-200 shadow-sm ${w?"border-yellow-400 bg-yellow-50 ring-2 ring-yellow-200":""}">
                        <div class="flex justify-between items-start w-full">
                            <div class="min-w-0 flex-1 pr-3">
                                ...
                                <div class="flex items-center mt-2 gap-2">
                                    ...
                                    <p class="text-xs text-gray-500 font-bold">${w?'<span class="text-yellow-700 font-black bg-yellow-100 px-2 py-1 rounded-md border border-yellow-200">Resgate</span>':`R$ ${(m.price||0).toFixed(2)} un.`}</p>
                                </div>
                            </div>
        ...
        ${p}
        ${b}
    `,!i&&(e.clientId||e.clientName)&&Fn(e,t.querySelector("#loyalty-container"))}function Rn(t,e){const s=qe(t).reduce((b,m)=>b+Number(m.price||0)*(m.quantity||1),0),i=x.checkoutState,o=i.discount||{type:"real",value:0};let r=0;o.type==="percent"?r=s*o.value/100:r=o.value,r>s&&(r=s);const n=s-r,l=i.payments.reduce((b,m)=>b+m.value,0),d=Math.max(0,n-l);(!i.amountReceived||d>0)&&(i.amountReceived=d.toFixed(2));const u=`
    ...
    `;const p=()=>{const b=x.checkoutState.discount.type,m=x.checkoutState.discount.value;let h=b==="percent"?s*m/100:m;h>s&&(h=s);const y=s-h,w=x.checkoutState.payments.reduce((N,U)=>N+U.value,0),M=Math.max(0,y-w),B=e.querySelector("#checkout-total-display");B&&(B.textContent=`R$ ${y.toFixed(2)}`);const S=e.querySelector("#checkout-status-msg");S&&(M<=.01?S.innerHTML='<p class="text-emerald-500 font-black text-base uppercase tracking-widest"><i class="bi bi-check2-circle text-2xl mr-2 align-middle"></i> Totalmente Pago</p>':S.innerHTML=`<p class="text-red-500 font-bold text-sm uppercase tracking-widest">Faltam: <span id="checkout-remaining-display" class="font-black text-xl text-red-600 ml-1">R$ ${M.toFixed(2)}</span></p>`);const I=e.querySelector("#checkout-amount");I&&M>0&&document.activeElement!==I&&(I.value=M.toFixed(2))};e.querySelector("#discount-value")?.addEventListener("input",b=>{const m=parseFloat(b.target.value)||0;x.checkoutState.discount.value=m,p()}),e.querySelector("#discount-type")?.addEventListener("change",b=>{x.checkoutState.discount.type=b.target.value,p()}),e.querySelector("#discount-reason")?.addEventListener("input",b=>{x.checkoutState.discountReason=b.target.value}),e.querySelector("#checkout-amount")?.addEventListener("input",b=>{x.checkoutState.amountReceived=b.target.value}),e.querySelector("#checkout-installments")?.addEventListener("change",b=>{x.checkoutState.installments=parseInt(b.target.value,10)})}async function Fn(t,e){if(!e)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(t.clientId)s=await Eo(g.establishmentId,t.clientId);else if(t.clientName){const n=await dt(g.establishmentId,t.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const i=Number(s.loyaltyPoints)||0,r=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&i>=l});if(r.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-2xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerHTML="<i class='bi bi-gift mr-1.5'></i> Resgatar",l.className="text-[10px] font-black uppercase tracking-wider bg-yellow-500 text-white px-4 py-2.5 rounded-xl shadow-md hover:bg-yellow-600 transition-colors active:scale-95",l.onclick=()=>Hn(r,t),n.appendChild(l),e.innerHTML="",e.appendChild(n)}}function Hn(t,e){const a=`
        <div class="space-y-3">
    ...
    `,{modalElement:s,close:i}=je({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",o=>{const r=o.target.closest('[data-action="select-reward"]');if(r){const n=r.dataset.rewardId,l=t.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(On(l,e),i())}})}async function On(t,e){const a=Number(t.costPoints||t.points||0),s=t.name||t.reward,i=t.type||"money";if(i==="money"){const l=parseFloat(t.discount)||0;if(l<=0){f("Erro","O valor do desconto configurado é inválido.","error");return}x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:"money"},f("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),ae();return}const o=qe(e),r=t.itemId?String(t.itemId):null;if(!r){f("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");return}const n=o.find(l=>{const d=l.id?String(l.id):null,u=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,c=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return i==="service"?d===r||u===r:i==="product"?d===r||c===r:i==="package"?d===r:!1});if(n){let l=parseFloat(t.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:i,appliedToItemId:n.id},f("Sucesso",`Prémio "${s}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),ae()}else f("Item Não Encontrado",`Para resgatar o prémio "${s}", o ${i==="service"?"serviço":i==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}async function Qa(t=null){if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!g.professionals||g.professionals.length===0)try{g.professionals=await Ie(g.establishmentId)}catch{return f("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,maxWidth:"max-w-sm"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",_n)}async function _n(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const a=e.querySelector("#regClientName"),i=e.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!i)return f("Erro","Nome e Telefone são obrigatórios.","error");try{const o=await _r(g.establishmentId,i);if(o)f("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",Qa(o);else{const r=await Co({establishmentId:g.establishmentId,name:a.value,phone:i});f("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",Qa(r)}}catch(o){f("Erro",o.message,"error")}}async function Vn(){const t=`
    ...
    `,{modalElement:e}=je({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-xs"});e.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return f("Valor Inválido","Insira um valor válido.","error");try{const i=await Ln({establishmentId:g.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=i.id,document.getElementById("genericModal").style.display="none",f("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),Pa(),await xe()}catch(i){f("Erro",`Falha ao abrir caixa: ${i.message}`,"error")}})}async function Un(){const t=x.activeCashierSessionId;if(t)try{const e=await Pn(t),a=`
        ...
        `,{modalElement:s}=je({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("#close-cashier-form").addEventListener("submit",async i=>{i.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return f("Valor Inválido","Insira um valor final válido.","error");try{await Cn(t,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Pa(),await xe(),f("Sucesso!","Caixa fechado com sucesso!","success")}catch(r){f("Erro",`Falha ao fechar caixa: ${r.message}`,"error")}})}catch(e){f("Erro",`Falha ao carregar relatório: ${e.message}`,"error")}}async function Wn(t){if(x.activeFilter===t)return;x.activeFilter=t,x.paging.page=1,ys(),Xe(),x.selectedComandaId=null,x.viewMode="items";const e=document.getElementById("comandas-list");e&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>'),await xe()}function Xo(t){x.selectedComandaId=String(t),x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",Ta(),Bn(),ae()}async function Zo(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;if(!t.id||String(t.id)==="undefined"){f("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(t.price)||0,i=Array(e).fill(0).map(()=>{const o={id:String(t.id),name:t.name,price:s,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0};return t.type==="product"?(o.productId=o.id,o.product_id=o.id):t.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...i),a._cachedItems=null,a._hasUnsavedChanges=!0,ae()}async function Vs(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;let s=!1,i=(a.comandaItems||[]).findIndex(o=>String(o.id)===String(t)&&o.type===e);i>-1&&(a.comandaItems.splice(i,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,ae())}async function Jn(t){if(x.isProcessing)return;const e=qe(t),a=e.reduce((y,w)=>y+Number(w.price||0)*(w.quantity||1),0),s=x.checkoutState.discount||{type:"real",value:0};let i=s.type==="percent"?a*s.value/100:s.value;i>a&&(i=a);const o=a-i,{payments:r}=x.checkoutState,n=r.reduce((y,w)=>y+w.value,0),l=o-n;if(l>.01){if(!await Q("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;r.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=t.type==="appointment",u=e;let c=0;const p=x.loyaltySettings;p&&p.enabled&&(c=parseInt(p.pointsPerVisit||1,10));const b={...s,reason:x.checkoutState.discountReason||""},m={payments:r,totalAmount:Number(o),items:u,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:c,discount:b,loyaltyRedemption:x.pendingRedemption},h=document.createElement("div");h.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",h.innerHTML='<div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center"><div class="loader mb-5"></div><p class="text-sm font-black text-gray-800 uppercase tracking-widest mt-2">Processando...</p></div>',document.body.appendChild(h);try{d?await or(t.id,m):(m.establishmentId=g.establishmentId,m.clientId=t.clientId,m.clientName=t.clientName,m.professionalId=t.professionalId,t.clientPhone&&(m.clientPhone=t.clientPhone),await Uo(m));let y="Venda finalizada com sucesso!";c>0&&(y+=` Cliente ganhou ${c} pontos!`),f("Sucesso!",y,"success"),Xe(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await xe()}catch(y){f("Erro no Checkout",y.message,"error")}finally{document.body.contains(h)&&document.body.removeChild(h),x.isProcessing=!1}}async function Qn(t){t.preventDefault();const e=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=e.value,i=document.getElementById("client-search").value,o=e.dataset.phone||"";if(!s)return f("Erro","Selecione um cliente válido.","error");const r=g.professionals.find(l=>l.id===a);if(!r)return f("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:i.split("(")[0].trim(),clientPhone:o,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(n),x.selectedComandaId=String(n.id),x.viewMode="items",document.getElementById("genericModal").style.display="none",x.activeFilter==="pagas"&&(x.activeFilter="abertas"),ys(),Xo(n.id)}async function xe(){const t=document.getElementById("comandas-list");(!t.hasChildNodes()||t.innerHTML.includes("loader"))&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>');let e=x.filterStartDate,a=x.filterEndDate,s;e&&a&&e!==a?s={startDate:e,endDate:a}:s={startDate:e,endDate:a,date:e};try{const i=En(),o=yn(g.establishmentId,s,x.paging.page,x.paging.limit),r=Ae(g.establishmentId),[n,l,d]=await Promise.all([i,o,r]);if(x.establishmentConfig=d||{},x.isCashierOpen=!!n,x.activeCashierSessionId=n?n.id:null,Pa(),d&&d.loyaltyProgram&&(x.loyaltySettings=d.loyaltyProgram),x.allComandas=l.data||l||[],x.paging.total=l.total||x.allComandas.length,x.catalog.services.length===0){const[u,c,p,b]=await Promise.all([ct(g.establishmentId),ut(g.establishmentId),vs(g.establishmentId),Ie(g.establishmentId)]);x.catalog={services:u,products:c,packages:p},g.professionals=b}Ta(),ae()}catch(i){f("Erro",`Não foi possível carregar os dados: ${i.message}`,"error")}}async function Gn(t={}){Ge=document.getElementById("content"),x.selectedComandaId=t.selectedAppointmentId?String(t.selectedAppointmentId):null,x.viewMode="items",x.selectedCatalogItem=null;const e=Na("hoje");if(x.filterStartDate=e.start,x.filterEndDate=e.end,x.filterPreset="hoje",x.showHistoryPanel=!1,qt(),Ve&&(Ge.removeEventListener("click",Ve),Ge.removeEventListener("change",Ve)),Ve=async a=>{const s=a.target.closest("[data-action], [data-filter], [data-comanda-id]");if(s){if(s.matches("[data-filter]"))a.preventDefault(),Wn(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(a.preventDefault(),a.target.closest('[data-action="go-to-appointment"]')){a.stopPropagation();return}Xo(s.dataset.comandaId)}else if(s.matches("[data-action]")){a.preventDefault();const i=s.dataset.action,o=String(s.dataset.id||x.selectedComandaId),r=x.allComandas.find(n=>String(n.id)===o);switch(i){case"toggle-history":if(x.showHistoryPanel=!x.showHistoryPanel,x.showHistoryPanel&&x.activeFilter==="abertas"&&(x.activeFilter="todas"),qt(),!x.showHistoryPanel){x.filterPreset="hoje";const D=Na("hoje");x.filterStartDate=D.start,x.filterEndDate=D.end,await xe()}break;case"set-period":const n=s.dataset.period;if(x.filterPreset=n,n!=="custom"){const D=Na(n);x.filterStartDate=D.start,x.filterEndDate=D.end,qt(),x.paging.page=1,f("Buscando...",`Período: ${D.start.split("-").reverse().join("/")} a ${D.end.split("-").reverse().join("/")}`,"info"),await xe()}else qt();break;case"apply-custom-dates":const l=document.getElementById("filter-start-date").value,d=document.getElementById("filter-end-date").value;l&&d?(x.filterStartDate=l,x.filterEndDate=d,x.paging.page=1,f("Buscando...","Período personalizado aplicado.","info"),await xe()):f("Atenção","Preencha a data inicial e final.","warning");break;case"back-to-list":Xe(),x.selectedComandaId=null,x.selectedCatalogItem=null,document.querySelectorAll(".comanda-card").forEach(D=>D.classList.remove("ring-2","ring-indigo-500","bg-indigo-50/50","border-transparent")),document.querySelectorAll(".comanda-card").forEach(D=>D.classList.add("bg-white","border-gray-200")),ae();break;case"new-sale":Qa();break;case"add-item":if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa primeiro.","error");x.viewMode="add-item",ae();break;case"back-to-items":x.viewMode="items",ae();break;case"back-to-add-item":x.viewMode="add-item",x.selectedCatalogItem=null,ae();break;case"select-catalog-item":const{itemType:u,itemId:c}=s.dataset,b=(x.catalog[u+"s"]||[]).find(D=>String(D.id)===String(c));b&&(x.selectedCatalogItem={...b,type:u},x.viewMode="add-item-qty",ae());break;case"open-cashier":Vn();break;case"close-cashier":await Un();break;case"view-sales-report":oe("sales-report-section");break;case"go-to-checkout":await zs(r,"checkout");break;case"save-comanda":await zs(r,"stay");break;case"select-method":x.checkoutState.selectedMethod=s.dataset.method,x.checkoutState.installments=1,ae();break;case"add-payment-checkout":const m=document.getElementById("checkout-amount");let h=parseFloat(m.value);const w=qe(r).reduce((D,V)=>D+(V.price||0),0),M=x.checkoutState.discount||{type:"real",value:0};let B=M.type==="percent"?w*M.value/100:M.value;B>w&&(B=w);const S=w-B,I=x.checkoutState.payments.reduce((D,V)=>D+V.value,0),N=S-I;if(isNaN(h)||h<=0){f("Valor inválido","Insira um valor maior que zero.","error");break}if(h>N+.05){f("Valor inválido","Valor excede o restante.","error");break}const U={method:x.checkoutState.selectedMethod,value:h};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(U.installments=x.checkoutState.installments),x.checkoutState.payments.push(U),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",ae();break;case"remove-payment-checkout":const C=parseInt(s.dataset.index,10);x.checkoutState.payments.splice(C,1),ae();break;case"finalize-checkout":await Jn(r);break;case"increase-qty":{const D=s.dataset.itemId,V=s.dataset.itemType;if(!D||D==="undefined"||D==="null"){f("Erro","Item inválido.","error");return}let T=qe(r).find(X=>String(X.id)===String(D)&&X.type===V);T||(T=(x.catalog[V+"s"]||[]).find(te=>String(te.id)===String(D)));const F=T?{id:T.id,name:T.name,price:Number(T.price),type:T.type}:{id:D,name:"Item",price:0,type:V};await Zo(F,1);break}case"decrease-qty":await Vs(s.dataset.itemId,s.dataset.itemType);break;case"remove-item":await Vs(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await Q("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await sr(o);const V=x.allComandas.findIndex(P=>String(P.id)===o);V!==-1&&(x.allComandas[V].status="confirmed",delete x.allComandas[V].transaction),x.selectedComandaId=null,Xe(),await xe(),f("Sucesso!","Comanda reaberta.","success")}catch(V){f("Erro",V.message,"error")}break}case"go-to-appointment":{oe("agenda-section",{scrollToAppointmentId:s.dataset.id,targetDate:new Date(s.dataset.date)});break}case"delete-walk-in":{if(await Q("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))x.allComandas=x.allComandas.filter(V=>String(V.id)!==o),x.selectedComandaId=null,Ta(),ae(),Xe();else try{await Wo(o),f("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Xe(),await xe()}catch(V){f("Erro",V.message,"error")}break}}}}},Ge.addEventListener("click",Ve),Ge.addEventListener("change",Ve),t.initialFilter&&(t.initialFilter==="finalizadas"?x.activeFilter="pagas":x.activeFilter="abertas"),t.selectedAppointmentId&&(x.selectedComandaId=String(t.selectedAppointmentId)),t.filterDate){const a=new Date(t.filterDate).toISOString().split("T")[0];x.filterStartDate=a,x.filterEndDate=a,x.filterPreset="custom",x.showHistoryPanel=!0}await xe()}const Ga=new Date,Yn=new Date(Ga.getFullYear(),Ga.getMonth(),1);let q={establishments:[],filterEstablishmentIds:new Set,startDate:Yn.toISOString().split("T")[0],endDate:Ga.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Ya=document.getElementById("content");let jt=null;function ce(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function De(t){if(!t)return"--/--/----";const e=t.split("T")[0].split("-");return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}function Ce(t){return t?typeof t.toDate=="function"?t.toDate():typeof t=="string"||typeof t=="number"?new Date(t):new Date:new Date(0)}function Bt(t){q.charts[t]&&(q.charts[t].destroy(),q.charts[t]=null)}async function Xn(){try{const e=(await we().catch(()=>({matrizes:[]}))).matrizes||[];q.establishments=[],e.forEach(a=>{q.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>q.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),q.filterEstablishmentIds.size===0&&q.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}Zn(),il(),await ft()}function Zn(){const t=q.establishments.map(e=>`
    ...
    `}async function ft(){const t=document.getElementById("tab-content");t&&(t.innerHTML='<div class="flex justify-center items-center h-40"><div class="loader"></div></div>');const{currentTab:e,startDate:a,endDate:s,filterEstablishmentIds:i}=q,o=Array.from(i),r=o.join(","),n=new Date(a).toISOString(),l=new Date(s);l.setHours(23,59,59,999);const d=l.toISOString();try{if(e==="financeiro"){const u={startDate:a,endDate:s,establishmentId:r},[c,p,b]=await Promise.all([ms(u).catch(()=>({entries:[]})),Ia(u).catch(()=>({entries:[]})),$a(g.establishmentId).catch(()=>[])]);q.data.financeiro={payables:c.entries,receivables:p.entries,natures:b},Kn()}else if(e==="agenda"){const u=o.map(m=>ka(m,n,d).catch(()=>[])),c=o.map(m=>Zi(m,n,d).catch(()=>[])),[p,b]=await Promise.all([Promise.all(u),Promise.all(c)]);q.data.agenda={active:p.flat(),cancelled:b.flat()},Xa()}else if(e==="clientes"){const u=await Promise.all(o.map(p=>dt(p).catch(()=>[]))),c=new Map;u.flat().forEach(p=>c.set(p.id,p)),q.data.clientes=Array.from(c.values()),Za()}else if(e==="vendas"){let u=[];try{Fs&&typeof Ja=="function"?u=await Promise.all(o.map(c=>Ja({startDate:a,endDate:s,establishmentId:c}).catch(()=>[]))):Or&&typeof la=="function"&&(u=(await Promise.all(o.map(p=>la({establishmentId:p,startDate:a,endDate:s}).catch(()=>({transactions:[]}))))).flatMap(p=>(p.transactions||[]).map(b=>({id:"REF-"+Math.random().toString(36).substring(2,8),status:"completed",createdAt:b.date,totalAmount:b.total,items:[{name:b.items||"Itens Venda",quantity:1,price:b.total}]}))))}catch(c){console.error("Erro interno ao buscar as vendas:",c)}q.data.vendas=u.flat(),tl()}else if(e==="estoque"){const u=await Promise.all(o.map(c=>ut(c).catch(()=>[])));q.data.estoque=u.flat(),al()}}catch(u){t.innerHTML=`<div class="p-10 text-center text-red-500 bg-red-50 rounded-xl border border-red-100"><i class="bi bi-exclamation-triangle text-3xl mb-2"></i><br>Erro ao carregar dados: ${u.message}</div>`}}function Kn(){const t=document.getElementById("tab-content"),{payables:e,receivables:a,natures:s}=q.data.financeiro,i=new Map(s.map(S=>[S.id,S.name])),o={};a.forEach(S=>{const I=(S.status==="paid"?S.paymentDate:S.dueDate)?.split("T")[0];if(!I)return;o[I]||(o[I]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const N=Number(S.amount)||0;o[I].items.push({...S,_type:"receita"}),S.status==="paid"?o[I].recReal+=N:o[I].recPrev+=N}),e.forEach(S=>{const I=(S.status==="paid"?S.paymentDate:S.dueDate)?.split("T")[0];if(!I)return;o[I]||(o[I]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const N=Number(S.amount)||0;o[I].items.push({...S,_type:"despesa"}),S.status==="paid"?o[I].despReal+=N:o[I].despPrev+=N});const r=Object.keys(o).sort(),n=r.map(S=>De(S).substring(0,5));let l=0;const d=[],u=[],c=[],p=[],b=[];r.forEach(S=>{const I=o[S];d.push(I.recReal),u.push(I.recPrev),c.push(-Math.abs(I.despReal)),p.push(-Math.abs(I.despPrev)),l+=I.recReal-I.despReal,b.push(l)});const m=d.reduce((S,I)=>S+I,0),h=c.reduce((S,I)=>S+Math.abs(I),0),y=m-h,w=m>0?y/m*100:0,M={},B={};a.filter(S=>S.status==="paid").forEach(S=>{const I=S.naturezaId?i.get(S.naturezaId)||"Outros":"Sem Cat.";M[I]=(M[I]||0)+S.amount}),e.filter(S=>S.status==="paid").forEach(S=>{const I=S.naturezaId?i.get(S.naturezaId)||"Outros":"Sem Cat.";B[I]=(B[I]||0)+S.amount}),t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                ...
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-pie-chart text-amber-500 mr-1"></i> Margem Real</span><span class="text-lg md:text-xl font-black ${w>=0?"text-indigo-600":"text-red-600"} mt-0.5">${w.toFixed(1)}%</span></div>
            </div>
...
(Clique para ver)`}}}},onClick:(I,N)=>{if(N.length>0){const U=N[0].index,C=N[0].datasetIndex,D=r[U];let V="all";C===0||C===1?V="receita":(C===2||C===3)&&(V="despesa"),el(D,V,o[D].items,i)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:I=>ce(Math.abs(I))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:I=>ce(I)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(I=>{I.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",I.onclick=N=>{const U=N.currentTarget,C=parseInt(U.dataset.dataset),D=q.charts.fin;D.isDatasetVisible(C)?(D.hide(C),U.style.opacity="0.4",U.style.background="#f8f9fa"):(D.show(C),U.style.opacity="1",U.style.background="")}}))},100)}function el(t,e,a,s){let i=document.getElementById("genericModal");i||(i=document.createElement("div"),i.id="genericModal",i.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(i));const o=e==="all"?a:a.filter(l=>l._type===e);let r=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";i.innerHTML=`
        <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none sm:max-w-3xl sm:mx-auto my-8">
            <div class="modal-content relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-xl shadow-2xl border-0">
                <div class="modal-header flex items-center justify-between p-3 border-b border-slate-200 bg-slate-50 rounded-t-xl">
                    <h5 class="text-sm font-bold text-slate-800"><i class="bi bi-search text-indigo-600 mr-1.5"></i> ${r} em ${De(t)}</h5>
    ...
    `,t.style.display="block",setTimeout(()=>t.classList.add("show","opacity-100"),10);const e=t.querySelector(".btn-close-modal");e&&(e.onclick=()=>{t.style.display="none",t.classList.remove("show","opacity-100")}),ol()}async function ol(){const t=document.getElementById("movements-container"),e=Array.from(q.filterEstablishmentIds);try{let a=[];if((q.data.estoque||[]).slice(0,15).forEach(i=>{Math.random()>.4&&a.push({date:new Date(Date.now()-Math.random()*864e6).toISOString(),productName:i.name,type:Math.random()>.4?"out":"in",quantity:Math.floor(Math.random()*5)+1,reason:Math.random()>.5?"Venda PDV / Atendimento":"Ajuste Manual / Compra"})}),a.length===0){t.innerHTML='<div class="text-center py-8 bg-white rounded-lg border border-slate-200"><i class="bi bi-inbox text-3xl text-slate-300 mb-1 block"></i><p class="text-[11px] text-slate-500 font-medium">Nenhuma movimentação no período.</p></div>';return}a.sort((s,i)=>new Date(i.date)-new Date(s.date)),t.innerHTML=`
        ...
        `}catch(a){console.error("Erro ao carregar movimentações:",a),t.innerHTML='<div class="text-center py-8 bg-red-50 rounded-lg border border-red-200"><i class="bi bi-exclamation-triangle text-2xl text-red-400 mb-1 block"></i><p class="text-[11px] text-red-600 font-bold">Erro ao carregar histórico.</p></div>'}}function il(){jt&&Ya.removeEventListener("click",jt),jt=t=>{const e=t.target,a=e.closest(".tab-btn");if(a){document.querySelectorAll(".tab-btn").forEach(o=>{o.classList.remove("active","bg-indigo-600","text-white","shadow-md","border-transparent"),o.classList.add("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100")}),a.classList.remove("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100"),a.classList.add("active","bg-indigo-600","text-white","shadow-md","border-transparent"),q.currentTab=a.dataset.tab,q.drillDownMonth=null,ft();return}if(e.closest("#btn-historico-movimentacoes")){sl();return}const i=e.closest("button[data-action]");if(i){const o=i.dataset.action;if(o==="apply-filters")q.startDate=document.getElementById("report-start").value,q.endDate=document.getElementById("report-end").value,q.drillDownMonth=null,ft();else if(o==="preset-date"){const r=i.dataset.preset,n=new Date;let l,d;r==="month"?(l=new Date(n.getFullYear(),n.getMonth(),1),d=new Date(n.getFullYear(),n.getMonth()+1,0)):r==="last_month"?(l=new Date(n.getFullYear(),n.getMonth()-1,1),d=new Date(n.getFullYear(),n.getMonth(),0)):r==="year"&&(l=new Date(n.getFullYear(),0,1),d=new Date(n.getFullYear(),11,31)),document.getElementById("report-start").value=l.toISOString().split("T")[0],document.getElementById("report-end").value=d.toISOString().split("T")[0],document.querySelectorAll("[data-preset]").forEach(u=>{u.classList.remove("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),u.classList.add("text-slate-500")}),i.classList.remove("text-slate-500"),i.classList.add("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),q.startDate=l.toISOString().split("T")[0],q.endDate=d.toISOString().split("T")[0],q.drillDownMonth=null,ft()}else o==="export-excel"&&rl()}},Ya.addEventListener("click",jt),document.querySelectorAll(".est-filter-checkbox").forEach(t=>{t.addEventListener("change",e=>{const a=e.target.closest("label");e.target.checked?(q.filterEstablishmentIds.add(e.target.value),a.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.remove("border-slate-200","text-slate-600")):(q.filterEstablishmentIds.delete(e.target.value),a.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.add("border-slate-200","text-slate-600")),q.drillDownMonth=null,ft()})})}function rl(){if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível.","error");return}const{currentTab:t,data:e,startDate:a,endDate:s}=q;let i=[],o=`Relatorio_${t.toUpperCase()}_${a}_a_${s}.xlsx`;if(t==="financeiro"){if(!e.financeiro||!e.financeiro.payables.length&&!e.financeiro.receivables.length)return f("Aviso","Sem dados financeiros para exportar.","info");const r=new Map(q.establishments.map(d=>[d.id,d.name])),n=new Map(e.financeiro.natures.map(d=>[d.id,d.name]));i=[...e.financeiro.receivables.filter(d=>d.status==="paid").map(d=>({...d,tipo:"Receita"})),...e.financeiro.payables.filter(d=>d.status==="paid").map(d=>({...d,tipo:"Despesa"}))].map(d=>({Unidade:r.get(d.establishmentId)||"Atual","Data Pagamento":d.paymentDate?De(d.paymentDate):"-",Tipo:d.tipo,Descrição:d.description||"-","Natureza (DRE)":d.naturezaId?n.get(d.naturezaId)||"Outros":"Geral","Valor (R$)":d.amount||0}))}else if(t==="agenda"){if(!e.agenda||e.agenda.active.length===0)return f("Aviso","Sem dados de agenda.","info");i=e.agenda.active.map(r=>({Data:r.startTime?De(r.startTime):"-",Cliente:r.clientName||"Sem nome",Profissional:r.professionalName||"-",Status:r.status,"Valor Faturado (R$)":r.totalAmount||0}))}else if(t==="clientes"){if(!e.clientes||e.clientes.length===0)return f("Aviso","Sem dados de clientes.","info");i=e.clientes.map(r=>({"Data de Cadastro":r.createdAt?De(r.createdAt):"-",Nome:r.name||"-",Telefone:r.phone||"-","E-mail":r.email||"-","Última Visita":r.lastVisit?De(r.lastVisit):"-"}))}else if(t==="vendas"){if(!e.vendas||e.vendas.length===0)return f("Aviso","Sem dados de vendas.","info");i=e.vendas.map(r=>({"ID Venda":r.id||"-",Data:r.createdAt?De(r.createdAt):"-",Status:r.status||"-","Qtd Itens":(r.items||[]).length,"Faturamento (R$)":r.totalAmount||0}))}else if(t==="estoque"){if(!e.estoque||e.estoque.length===0)return f("Aviso","Sem dados de estoque.","info");i=e.estoque.map(r=>({Produto:r.name||"-","Código/SKU":r.sku||"-","Estoque Atual":r.currentStock||0,"Estoque Mínimo":r.minStock||0,"Preço Venda (R$)":r.price||0,Alerta:r.currentStock<=0?"Esgotado":r.currentStock<=r.minStock?"Baixo":"OK"}))}if(i.length===0)return f("Aviso","Nenhum dado válido para exportar.","info");try{const r=XLSX.utils.json_to_sheet(i),n=XLSX.utils.book_new();XLSX.utils.book_append_sheet(n,r,t.toUpperCase()),XLSX.writeFile(n,o)}catch(r){console.error("Erro na exportação Excel: ",r),f("Erro","Falha ao gerar o ficheiro Excel.","error")}}const Ma=(t,e="products")=>L(`/api/${e}/categories/${t}`),Ko=(t,e="products")=>L(`/api/${e}/categories`,{method:"POST",body:JSON.stringify(t)}),ei=(t,e="products")=>L(`/api/${e}/categories/${t}`,{method:"DELETE"}),nl="audit_logs",ie=async(t,e,a,s,i,o=null)=>{try{if(!e)return;await xo(ya(fe,nl),{establishmentId:t,userId:e.uid,userName:e.name||e.email||"Utilizador",module:a,action:s,description:i,details:o,timestamp:new Date})}catch(r){console.error("Falha silenciosa ao registar log:",r)}},Ka=document.getElementById("content");let z={services:null,professionals:[],categories:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,tempService:null},Nt=null,Rt=null;function et(){const t=ye.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function ti(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function ll(){const t=document.getElementById("services-layout-detail"),e=document.getElementById("service-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function Ft(){const t=document.getElementById("services-layout-detail"),e=document.getElementById("service-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),z.tempService=null}async function dl(){z.selectedIds.clear(),z.services=null;try{const t=await we();z.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}cl(),vl(),await it()}function cl(){Ka.innerHTML=`
    ...
    `}async function it(){const t=document.getElementById("servicesList"),e=ti();try{const a=e.map(c=>ct(c)),s=e.map(c=>Ie(c)),i=e.map(c=>Ma(c,"services")),o=await Promise.all(a),r=await Promise.all(s),n=await Promise.all(i),l=new Map;o.flat().filter(Boolean).forEach(c=>l.set(c.id,c)),z.services=Array.from(l.values()),g.services=z.services;const d=new Map;r.flat().filter(Boolean).forEach(c=>d.set(c.id,c)),z.professionals=Array.from(d.values()),g.professionals=z.professionals;const u=new Map;n.flat().filter(Boolean).forEach(c=>u.set(c.id,c)),z.categories=Array.from(u.values()),g.serviceCategories=z.categories,ul(),xt()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function ul(){const t=document.getElementById("filterCategoryId");t&&z.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',z.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),z.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function ai(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=z.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function pl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.active!==!1).length,i=a-s;e.innerHTML=`
    ...
    `}function xt(){const t=document.getElementById("servicesList");if(!t)return;if(z.services===null){t.innerHTML=si(8);return}const e=ti(),a=z.services.filter(i=>{const o=i.name.toLowerCase().includes(z.searchQuery);let r=!0;z.statusFilter==="active"&&(r=i.active!==!1),z.statusFilter==="inactive"&&(r=i.active===!1);const n=z.filterCategoryId==="all"||i.categoryId===z.filterCategoryId,l=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],d=e.some(u=>l.includes(u));return o&&r&&n&&d});if(pl(a),a.length===0){z.services.length===0?t.innerHTML=`
        ...
        `;return e}async function bl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=z.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await Ko({establishmentId:g.establishmentId,name:s,accessibleIn:o},"services"),ie(g.establishmentId,et(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await ws(),await it()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function ml(t){if(await Q("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ei(t,"services"),ie(g.establishmentId,et(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await ws(),await it()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function ws(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await Ma(g.establishmentId,"services");z.categories=e,e.length>0?t.innerHTML=e.map(a=>`
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",bl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),ml(i.dataset.id))}))}ws()}function fl(t=[]){if(!z.hierarchyCache||z.hierarchyCache.length===0)return`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function xl(t){z.viewMode="edit-service";const e=document.getElementById("service-modal-inner");if(!e)return;let a={name:"",active:!0,duration:30,price:0};if(t){const P=z.services?.find(T=>String(T.id)===String(t));P&&(a=JSON.parse(JSON.stringify(P)))}z.tempService=a;const s=!!a.id,i=z.categories||[],o=a.duration||30,r=a.bufferTime||0,n=v(a.name||""),l=v(a.notes||""),d=v(a.publicDescription||""),u=s?n:"Novo Serviço",c=a.color||"#4f46e5",p=a.loyaltyPoints||0,b=i.map(P=>`<option value="${P.id}" ${a.categoryId===P.id?"selected":""}>${v(P.name)}</option>`).join(""),m=a.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(n?n.charAt(0):"S")}`,h=`
    ...
    `,e.querySelectorAll(".tab-link").forEach(P=>{P.addEventListener("click",T=>{T.preventDefault(),e.querySelectorAll(".tab-link").forEach(F=>{F.classList.remove("active","border-indigo-600","text-indigo-600"),F.classList.add("border-transparent","text-slate-400")}),P.classList.add("active","border-indigo-600","text-indigo-600"),P.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(F=>F.classList.add("hidden")),e.querySelector("#"+P.dataset.tab).classList.remove("hidden")})});const y=e.querySelectorAll('input[name="commissionType"]'),w=e.querySelector("#defaultCommissionRateContainer"),M=e.querySelector("#professionalCommissionsContainer");function B(){const P=e.querySelector('input[name="commissionType"]:checked').value;w&&(w.style.display=P==="default"?"block":"none"),M&&(M.style.display=P==="custom"?"block":"none")}y.forEach(P=>P.addEventListener("change",B));const S=e.querySelector("#professionalCommissionsList");S&&(S.innerHTML=(z.professionals||[]).map(P=>{const T=a.professionalCommissions?.[P.id]!==void 0,F=a.professionalCommissions?.[P.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2.5 rounded-xl border border-transparent hover:bg-slate-50 transition-colors ${T?"bg-indigo-50/50 border-indigo-100 shadow-sm":""}" data-prof-id="${P.id}">
                    <label class="flex items-center gap-3 cursor-pointer flex-1 min-w-0">
                        ...
                        <img src="${P.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${v(P.name.charAt(0))}`}" class="w-10 h-10 rounded-full object-cover border border-white shadow-sm flex-shrink-0">
                        <span class="text-xs font-black text-slate-800 truncate uppercase tracking-widest">${v(P.name)}</span>
                    </label>
            ...
            `}).join(""),S.querySelectorAll('input[type="checkbox"]').forEach(P=>{P.addEventListener("change",T=>{const F=T.target.closest(".professional-commission-row"),X=F.querySelector('input[type="number"]');X.disabled=!T.target.checked,F.classList.toggle("bg-indigo-50/50",T.target.checked),F.classList.toggle("border-indigo-100",T.target.checked),F.classList.toggle("shadow-sm",T.target.checked),F.classList.toggle("border-transparent",!T.target.checked),T.target.checked&&X.focus()})})),B();const I=e.querySelector("#servicePhotoInput"),N=e.querySelector("#servicePhotoButton"),U=e.querySelector("#servicePhotoContainer"),C=e.querySelector("#servicePhotoPreview"),D=e.querySelector("#servicePhotoBase64"),V=()=>I.click();N&&N.addEventListener("click",V),U&&U.addEventListener("click",V),I.onchange=async()=>{const P=I.files[0];if(P){C.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const T=await wa(P,800,800,.8);if(T.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");C.src=T,D.value=T}catch(T){f("Erro de Imagem",T.message,"error"),C.src=m,D.value=a.photo||""}}},ll()}function hl(){Q("Excluir em Lote",`Tem certeza que deseja excluir ${z.selectedIds.size} serviços da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{const e=Array.from(z.selectedIds).map(a=>Fo(a));await Promise.all(e),ie(g.establishmentId,et(),"Serviços","Excluiu em Lote",`Excluiu ${z.selectedIds.size} serviços`),f("Sucesso",`${z.selectedIds.size} serviços foram excluídos.`,"success"),z.selectedIds.clear(),ai(),it()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}function vl(){Nt&&document.body.removeEventListener("click",Nt),Rt&&Ka.removeEventListener("input",Rt),Nt=async t=>{if(t.target.classList.contains("service-checkbox")){const o=t.target.dataset.id;t.target.checked?z.selectedIds.add(o):z.selectedIds.delete(o),ai(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){z.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600","bg-red-600","border-red-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),z.statusFilter==="inactive"?(e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-red-600","text-white","border-red-600")):(e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600")),xt();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterCategoryId").value="all",z.filterCategoryId="all",xt();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),z.filterCategoryId=document.getElementById("filterCategoryId").value,xt();return}const a=t.target.closest("#toggle-filter-btn");if(a){t.preventDefault(),z.isAdvancedFilterOpen=!z.isAdvancedFilterOpen;const o=document.getElementById("filter-panel");z.isAdvancedFilterOpen?(o.classList.remove("hidden"),o.classList.add("block"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.remove("bg-white","text-slate-700","border-slate-200")):(o.classList.add("hidden"),o.classList.remove("block"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-slate-700","border-slate-200"));return}if(t.target.id==="services-layout-detail"){Ft();return}const s=t.target.closest("[data-action]");if(!s)return;const i=s.dataset.action;switch(["close-detail-screen","delete-service","save-service","manage-categories","open-service-editor","batch-delete"].includes(i)&&t.stopPropagation(),i){case"manage-categories":gl();break;case"open-service-editor":xl(s.dataset.id);break;case"close-detail-screen":Ft();break;case"batch-delete":hl();break;case"delete-service":{const o=s.dataset.id;if(!o)return;if(await Q("Apagar Serviço","Tem certeza que deseja excluir este serviço da rede?"))try{const n=z.services.find(l=>l.id===o)?.name||"Desconhecido";await Fo(o),ie(g.establishmentId,et(),"Serviços","Excluiu",`Excluiu o serviço: ${n}`),f("Sucesso","Serviço apagado da rede.","success"),Ft(),await it()}catch(n){f("Erro",`Não foi possível apagar o serviço: ${n.message}`,"error")}break}case"save-service":{t.preventDefault();const o=document.getElementById("serviceForm");if(!o.reportValidity())return;const r=s,n=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{const l=o.querySelector("#serviceId").value,d=o.querySelector('input[name="commissionType"]:checked').value,u={};d==="custom"&&o.querySelectorAll(".professional-commission-row").forEach(m=>{const h=m.dataset.profId;if(m.querySelector('input[type="checkbox"]').checked){const w=parseFloat(m.querySelector('input[type="number"]').value);u[h]=isNaN(w)?0:w}});const c=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(m=>m.value),p=c.length>0?c:[g.establishmentId],b={...z.tempService,establishmentId:g.establishmentId,accessibleIn:p,name:o.querySelector("#serviceName").value.trim(),price:parseFloat(o.querySelector("#servicePrice").value),duration:parseInt(o.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(o.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:o.querySelector("#serviceCategory").value||null,color:o.querySelector("#serviceColor").value,targetAudience:o.querySelector("#serviceAudience").value,loyaltyPoints:parseInt(o.querySelector("#serviceLoyaltyPoints").value,10)||0,publicDescription:o.querySelector("#servicePublicDescription").value.trim(),homeService:o.querySelector("#serviceHomeToggle").checked,commissionRate:parseFloat(o.querySelector("#serviceCommissionRate").value)||0,active:o.querySelector("#serviceStatusToggle").checked,photo:o.querySelector("#servicePhotoBase64").value,notes:o.querySelector("#serviceNotes").value,commissionType:d,professionalCommissions:u};l?(await on(l,b),ie(g.establishmentId,et(),"Serviços","Editou",`Editou o serviço: ${b.name}`),f("Sucesso","Serviço atualizado com sucesso!","success")):(delete b.id,await sn(b),ie(g.establishmentId,et(),"Serviços","Criou",`Criou novo serviço: ${b.name}`),f("Sucesso","Serviço adicionado à rede!","success")),Ft(),await it()}catch(l){f("Erro",l.message,"error"),r.disabled=!1,r.innerHTML=n}break}}},document.body.addEventListener("click",Nt),Rt=t=>{t.target.id==="searchInput"&&(z.searchQuery=t.target.value,xt())},Ka.addEventListener("input",Rt)}const Ba="suppliers",Tt=async t=>{try{const e=ho(ya(fe,Ba),vo("establishmentId","==",t)),a=await _i(e),s=[];return a.forEach(i=>{s.push({id:i.id,...i.data()})}),s}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},yl=async t=>{try{return{id:(await xo(ya(fe,Ba),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},wl=async(t,e)=>{try{const a=Be(fe,Ba,t);return await Pt(a,e),{id:t,...e}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},kl=async t=>{try{const e=Be(fe,Ba,t);return await Vi(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},es=document.getElementById("content");let $={products:null,categories:[],suppliers:[],hierarchyCache:[],allMovements:[],currentTab:"catalogo",stockFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,selectedMovementIds:new Set,tempProduct:null,tempSupplierIds:new Set},Ht=null,Ot=null;function Oe(){const t=ye.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function ks(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function Ra(t){return t?t._seconds?new Date(t._seconds*1e3):t.seconds?new Date(t.seconds*1e3):new Date(t):new Date}function Sl(){const t=document.getElementById("products-layout-detail"),e=document.getElementById("product-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function ta(){const t=document.getElementById("products-layout-detail"),e=document.getElementById("product-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),$.tempProduct=null,$.tempSupplierIds.clear()}function $l(){const t=document.getElementById("movement-layout-detail"),e=document.getElementById("movement-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function ts(){const t=document.getElementById("movement-layout-detail"),e=document.getElementById("movement-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300))}async function Il(){$.selectedIds.clear(),$.selectedMovementIds.clear(),$.currentTab="catalogo",$.products=null;try{const t=await we();$.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}oi(),jl(),await Se()}function oi(){es.innerHTML=`
        <div class="h-full flex w-full relative overflow-hidden bg-slate-50">
    ...
    `,El()}function El(){const t=document.getElementById("main-tab-content");if(t){if($.currentTab==="catalogo")t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",ua),ua()}}}async function Se(){const t=ks();try{const e=t.map(n=>ut(n)),a=t.map(n=>Ma(n,"products")),[s,i]=await Promise.all([Promise.all(e),Promise.all(a)]),o=new Map;s.flat().filter(Boolean).forEach(n=>o.set(n.id,n)),$.products=Array.from(o.values()),g.products=$.products;const r=new Map;i.flat().filter(Boolean).forEach(n=>r.set(n.id,n)),$.categories=Array.from(r.values()),g.categories=$.categories,$.currentTab==="catalogo"?(ii(),Ne()):$.currentTab==="movimentacoes"&&ua(),$.suppliers=[],t.forEach(async n=>{try{let l=[];typeof Tt=="function"&&(l=await Tt(n)),l.forEach(d=>{$.suppliers.find(u=>u.id===d.id)||$.suppliers.push(d)}),g.suppliers=$.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function ii(){const t=document.getElementById("filterCategoryId");t&&$.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',$.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),$.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function as(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=$.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function wt(){const t=document.getElementById("movement-batch-action-bar"),e=document.getElementById("mov-selected-count"),a=$.selectedMovementIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Ll(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,i=0,o=0,r=0;t.forEach(n=>{const l=n.currentStock||0,d=n.minStock||0;n.active!==!1&&n.price&&l>0&&(r+=n.price*l),l<=0?o++:d>0&&l<=d||d>0&&l<=d*1.2?i++:s++}),e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function Ne(){const t=document.getElementById("productsList");if(!t)return;if($.products===null){t.innerHTML=ri(8);return}const e=ks(),a=$.products.filter(i=>{const o=i.name.toLowerCase().includes($.searchQuery)||i.sku&&i.sku.toLowerCase().includes($.searchQuery)||i.barcode&&i.barcode.toLowerCase().includes($.searchQuery),r=i.currentStock||0,n=i.minStock||0;let l=!0;$.stockFilter==="ok"&&(l=r>0&&(n===0||r>n*1.2)),$.stockFilter==="alert"&&(l=n>0&&r>0&&r<=n*1.2),$.stockFilter==="empty"&&(l=r<=0);const d=$.filterCategoryId==="all"||i.categoryId===$.filterCategoryId,u=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],c=e.some(p=>u.includes(p));return o&&l&&d&&c});if(Ll(a),a.length===0){$.products.length===0?t.innerHTML=`
            ...
            </div>`}).join("")}function ri(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;return e}async function Cl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=$.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await Ko({establishmentId:g.establishmentId,name:s,accessibleIn:o},"products"),ie(g.establishmentId,Oe(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await Ss(),await Se()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function Dl(t){if(await Q("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ei(t,"products"),ie(g.establishmentId,Oe(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await Ss(),await Se()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function Ss(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await Ma(g.establishmentId,"products");$.categories=e,e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-white p-3 rounded-xl border border-slate-200 mb-2 shadow-sm">
                    <span class="text-xs font-black text-slate-700 uppercase tracking-widest">${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-white w-8 h-8 flex items-center justify-center bg-red-50 hover:bg-red-600 rounded-lg transition-colors border border-red-100 active:scale-95"><i class="bi bi-trash3 pointer-events-none"></i></button>
                </div>`).join(""):t.innerHTML='<div class="text-center py-6 bg-slate-50 rounded-xl border border-dashed border-slate-200"><p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Nenhuma categoria criada.</p></div>'}catch{t.innerHTML='<p class="text-red-500 text-center text-[10px] font-bold p-4 bg-red-50 rounded-xl">Erro ao carregar categorias.</p>'}}}function Pl(){je({title:"Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="bg-indigo-50 p-4 rounded-2xl border border-indigo-100">
                <p class="text-[10px] text-indigo-800 mb-3 font-bold uppercase tracking-widest"><i class="bi bi-info-circle mr-1"></i> Categorias disponíveis para toda a rede.</p>
                <form id="categoryForm" class="flex gap-2 items-end">
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Cl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),Dl(i.dataset.id))}))}Ss()}function Tl(){const t=($.products||[]).map(r=>`<option value="${r.id}">${v(r.name)} (Estoque: ${r.currentStock||0})</option>`).join(""),e=$.hierarchyCache.reduce((r,n)=>(r.push(`<option value="${n.id}">🏢 ${v(n.name)}</option>`),n.branches&&n.branches.forEach(l=>r.push(`<option value="${l.id}">📍 ${v(l.name)}</option>`)),r),[]).join(""),a=document.getElementById("movement-modal-inner"),s=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
    ...
    `;a.innerHTML=s,$l();const i=document.getElementById("movEstablishmentId");i&&(i.value=g.establishmentId);const o=document.getElementById("newMovementForm");o.onsubmit=async r=>{r.preventDefault();const n=a.querySelector('button[type="submit"]'),l=n.innerHTML,d=document.getElementById("movProductId")?.value,u=document.getElementById("movEstablishmentId")?.value,c=o.querySelector('input[name="movType"]:checked')?.value,p=parseInt(document.getElementById("movAmount")?.value,10),b=document.getElementById("movReason")?.value.trim();if(!d||!p||p<=0||!b||!u){f("Erro","Preencha todos os campos corretamente.","warning");return}const m=c==="in"?p:-p;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Salvando...';try{await Da(d,{change:m,reason:b,establishmentId:u});const h=$.products.find(y=>y.id===d)?.name||"Produto";ie(u,Oe(),"Estoque","Ajuste Manual",`Lançou movimentação (${m>0?"+":""}${m}) para ${h}`),f("Sucesso","Movimentação registrada com sucesso!","success"),ts(),await Se()}catch(h){f("Erro",h.message,"error"),n.disabled=!1,n.innerHTML=l}}}function Ml(t=[]){if(!$.hierarchyCache||$.hierarchyCache.length===0)return`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function Bl(t){$.viewMode="edit-product";const e=document.getElementById("product-modal-inner");if(!e)return;let a={name:"",active:!0,price:0,costPrice:0,currentStock:0,minStock:0,maxStock:0,supplierIds:[]};if(t){const P=$.products?.find(T=>String(T.id)===String(t));P&&(a=JSON.parse(JSON.stringify(P)))}$.tempProduct=a,$.tempSupplierIds=new Set(a.supplierIds||[]);const s=!!a.id,i=$.categories||[],o=v(a.name||""),r=v(a.sku||""),n=v(a.barcode||""),l=v(a.description||""),d=s?o:"Novo Produto",u=a.price!==void 0?a.price:"",c=a.costPrice!==void 0?a.costPrice:"",p=a.commissionRate!==void 0?a.commissionRate:"",b=a.currentStock||0,m=a.minStock||0;a.maxStock;const h=i.map(P=>`<option value="${P.id}" ${a.categoryId===P.id?"selected":""}>${v(P.name)}</option>`).join(""),y=a.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(o?o.charAt(0):"P")}`,w=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
            <button data-action="close-detail-screen" class="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 text-slate-500 flex items-center justify-center hover:bg-slate-100 hover:text-slate-800 transition-colors active:scale-95 mr-4">
                <i class="bi bi-arrow-left text-lg"></i>
            </button>
    ...
    `,e.querySelectorAll(".tab-link").forEach(P=>{P.addEventListener("click",T=>{T.preventDefault(),e.querySelectorAll(".tab-link").forEach(F=>{F.classList.remove("active","border-indigo-600","text-indigo-600"),F.classList.add("border-transparent","text-slate-400")}),P.classList.add("active","border-indigo-600","text-indigo-600"),P.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(F=>F.classList.add("hidden")),e.querySelector("#"+P.dataset.tab).classList.remove("hidden")})});const M=()=>{const P=document.getElementById("modalSupplierSearch"),T=document.getElementById("supplierSearchResults"),F=document.getElementById("selectedSuppliersList"),X=P?.value.toLowerCase()||"",te=$.suppliers||[];if(X.length>0){const re=te.filter(Z=>Z.name.toLowerCase().includes(X)&&!$.tempSupplierIds.has(Z.id));re.length>0?(T.classList.remove("hidden"),T.innerHTML=re.map(Z=>`
                ...
                `).join("")):(T.classList.remove("hidden"),T.innerHTML='<div class="p-4 text-xs font-bold text-slate-500 text-center uppercase tracking-widest">Fornecedor não encontrado.</div>')}else T&&T.classList.add("hidden");$.tempSupplierIds.size>0?(F.classList.remove("justify-center"),F.classList.add("justify-start"),F.innerHTML="",$.tempSupplierIds.forEach(re=>{const Z=te.find(j=>j.id===re);Z&&(F.innerHTML+=`
                    ...
                    `)})):(F.classList.add("justify-center"),F.classList.remove("justify-start"),F.innerHTML='<p class="text-[10px] text-slate-400 text-center font-bold uppercase tracking-widest">Nenhum fornecedor adicionado ainda.</p>')},B=document.getElementById("modalSupplierSearch");B&&B.addEventListener("input",M),M();const S=e.querySelector("#productPhotoInput"),I=e.querySelector("#productPhotoButton"),N=e.querySelector("#productPhotoContainer"),U=e.querySelector("#productPhotoPreview"),C=e.querySelector("#productPhotoBase64"),D=()=>S?.click();I&&I.addEventListener("click",D),N&&N.addEventListener("click",D),S&&(S.onchange=async()=>{const P=S.files[0];if(!P)return;const T=U.src;U.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const F=await wa(P,800,800,.8);if(F.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");U.src=F,C.value=F}catch(F){f("Erro de Imagem",F.message,"error"),U.src=T,C.value=a?.photo||""}});const V=document.getElementById("productForm");V&&(V.onsubmit=async P=>{P.preventDefault();const T=e.querySelector('button[type="submit"]'),F=T.innerHTML,X=document.getElementById("productName"),te=document.getElementById("productPrice");if(!X?.value||!te?.value){f("Aviso","Preencha o Nome e o Preço do produto.","warning");return}const re=parseInt(document.getElementById("productCurrentStock")?.value||"0",10),Z=parseInt(document.getElementById("productMinStock")?.value||"0",10),j=Array.from(document.querySelectorAll('#productForm input[name="accessibleIn"]:checked')).map(W=>W.value),ee=j.length>0?j:[g.establishmentId],le={...$.tempProduct,establishmentId:g.establishmentId,accessibleIn:ee,name:X.value.trim(),sku:document.getElementById("productSku")?.value.trim()||"",barcode:document.getElementById("productBarcode")?.value.trim()||"",price:parseFloat(te.value),costPrice:parseFloat(document.getElementById("productCostPrice")?.value)||0,commissionRate:parseFloat(document.getElementById("productCommissionRate")?.value)||0,currentStock:isNaN(re)?0:re,minStock:isNaN(Z)?0:Z,categoryId:document.getElementById("productCategory")?.value||null,photo:document.getElementById("productPhotoBase64")?.value||"",description:document.getElementById("productDescription")?.value.trim()||"",active:document.getElementById("productStatusToggle")?.checked!==!1,supplierIds:Array.from($.tempSupplierIds)};T.disabled=!0,T.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> A gravar...';try{s?(await Qo(t,le),ie(g.establishmentId,Oe(),"Produtos","Editou",`Editou o produto: ${le.name}`),f("Sucesso","Produto atualizado com sucesso!","success")):(delete le.id,await Jo(le),ie(g.establishmentId,Oe(),"Produtos","Criou",`Criou novo produto: ${le.name}`),f("Sucesso","Produto adicionado à rede!","success")),ta(),await Se()}catch(W){f("Erro",W.message,"error"),T.disabled=!1,T.innerHTML=F}}),Sl()}async function Al(){if(!($.selectedIds.size===0||!await Q("Excluir Produtos",`Tem a certeza que deseja excluir ${$.selectedIds.size} produtos do seu inventário?`)))try{const e=Array.from($.selectedIds).map(a=>hs(a));await Promise.all(e),f("Sucesso","Produtos excluídos com sucesso.","success"),$.selectedIds.clear(),as(),await Se()}catch(e){f("Erro","Não foi possível apagar os produtos: "+e.message,"error")}}async function ql(){if(!($.selectedMovementIds.size===0||!await Q("Estornar e Excluir",`Deseja excluir as ${$.selectedMovementIds.size} movimentações selecionadas? O saldo de stock será estornado/devolvido ao sistema automaticamente.`)))try{const e=Array.from($.selectedMovementIds).map(async a=>{const s=$.allMovements.find(i=>i.id===a);s&&await Da(s.productId,{change:-s.change,reason:"Estorno automático de exclusão em lote",establishmentId:s.establishmentId})});await Promise.all(e),f("Sucesso","Movimentações excluídas e stocks estornados.","success"),$.selectedMovementIds.clear(),wt(),ua()}catch(e){f("Erro","Ocorreu um erro ao estornar em lote: "+e.message,"error")}}async function ua(){const t=document.getElementById("report-results");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full"><div class="loader"></div></div>',$.selectedMovementIds.clear(),wt();const e={startDate:document.getElementById("reportStartDate")?.value||"",endDate:document.getElementById("reportEndDate")?.value||"",productId:document.getElementById("productFilterReport")?.value||"all",categoryId:document.getElementById("categoryFilterReport")?.value||"all"};try{const s=ks().map(n=>Go({...e,establishmentId:n}).catch(l=>[])),i=await Promise.all(s);let o=[];if(i.forEach(n=>{if(!n)return;const l=Array.isArray(n)?n:Array.isArray(n.data)?n.data:Array.isArray(n.movements)?n.movements:[];o=o.concat(l)}),o.sort((n,l)=>Ra(l.date)-Ra(n.date)),$.allMovements=o,o.length===0){t.innerHTML=`
            ...
            </div>`;t.innerHTML=r}catch(a){f("Erro",`Não foi possível gerar: ${a.message}`,"error"),t.innerHTML='<div class="p-8 text-center text-red-500 font-bold bg-red-50 rounded-xl m-4 border border-red-100">Falha ao buscar movimentações.</div>'}}function jl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Se),t.addEventListener("click",()=>{setTimeout(Se,100)})),Ht&&document.body.removeEventListener("click",Ht),Ot&&es.removeEventListener("input",Ot),Ht=async e=>{const a=e.target.closest("[data-main-tab]");if(a){$.currentTab=a.dataset.mainTab,oi(),$.currentTab==="catalogo"&&$.products!==null&&(ii(),Ne());return}if(e.target.classList.contains("product-checkbox")){const c=e.target.dataset.id;e.target.checked?$.selectedIds.add(c):$.selectedIds.delete(c),as(),e.stopPropagation();return}if(e.target.closest("#cancel-selection-btn")){$.selectedIds.clear(),as(),Ne();return}if(e.target.classList.contains("movement-checkbox")){const c=e.target.dataset.id;e.target.checked?$.selectedMovementIds.add(c):$.selectedMovementIds.delete(c),wt();const p=e.target.closest("tr");e.target.checked?(p.classList.add("bg-indigo-50/30"),p.classList.remove("hover:bg-slate-50/50")):(p.classList.remove("bg-indigo-50/30"),p.classList.add("hover:bg-slate-50/50")),e.stopPropagation();return}if(e.target.id==="selectAllMovements"){const c=document.querySelectorAll(".movement-checkbox"),p=e.target.checked;c.forEach(b=>{b.checked=p;const m=b.dataset.id;p?$.selectedMovementIds.add(m):$.selectedMovementIds.delete(m);const h=b.closest("tr");p?(h.classList.add("bg-indigo-50/30"),h.classList.remove("hover:bg-slate-50/50")):(h.classList.remove("bg-indigo-50/30"),h.classList.add("hover:bg-slate-50/50"))}),wt(),e.stopPropagation();return}if(e.target.closest("#cancel-mov-selection-btn")){$.selectedMovementIds.clear(),wt();const c=document.getElementById("selectAllMovements");c&&(c.checked=!1),document.querySelectorAll(".movement-checkbox").forEach(p=>{p.checked=!1;const b=p.closest("tr");b.classList.remove("bg-indigo-50/30"),b.classList.add("hover:bg-slate-50/50")});return}const o=e.target.closest(".status-filter-btn");if(o){$.stockFilter=o.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(c=>{c.classList.remove("bg-indigo-600","text-white","border-indigo-600","bg-emerald-600","border-emerald-600","bg-amber-500","border-amber-500","bg-red-600","border-red-600"),c.classList.add("bg-white","text-slate-600","border-slate-200")}),$.stockFilter==="ok"?o.classList.add("bg-emerald-600","text-white","border-emerald-600"):$.stockFilter==="alert"?o.classList.add("bg-amber-500","text-white","border-amber-500"):$.stockFilter==="empty"?o.classList.add("bg-red-600","text-white","border-red-600"):o.classList.add("bg-indigo-600","text-white","border-indigo-600"),o.classList.remove("bg-white","text-slate-600","border-slate-200"),Ne();return}if(e.target.id==="clear-filters-btn"){e.preventDefault(),document.getElementById("filterCategoryId").value="all",$.filterCategoryId="all",Ne();return}if(e.target.id==="apply-filter-btn"){e.preventDefault(),$.filterCategoryId=document.getElementById("filterCategoryId").value,Ne();return}const r=e.target.closest("#toggle-filter-btn");if(r){e.preventDefault(),$.isAdvancedFilterOpen=!$.isAdvancedFilterOpen;const c=document.getElementById("filter-panel");$.isAdvancedFilterOpen?(c.classList.remove("hidden"),c.classList.add("block"),r.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.remove("bg-white","text-slate-700","border-slate-200")):(c.classList.add("hidden"),c.classList.remove("block"),r.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.add("bg-white","text-slate-700","border-slate-200"));return}if(e.target.id==="products-layout-detail"){ta();return}if(e.target.id==="movement-layout-detail"){ts();return}const n=e.target.closest("[data-add-supplier]");if(n){$.tempSupplierIds.add(n.dataset.addSupplier);const c=document.getElementById("modalSupplierSearch");c&&(c.value=""),c.dispatchEvent(new Event("input"));return}const l=e.target.closest("[data-remove-supplier]");if(l){$.tempSupplierIds.delete(l.dataset.removeSupplier);const c=document.getElementById("modalSupplierSearch");c&&c.dispatchEvent(new Event("input"));return}const d=e.target.closest("[data-action]");if(!d)return;const u=d.dataset.action;switch(["close-detail-screen","close-movement-modal","delete-product","manage-categories","open-product-editor","batch-delete","open-new-movement-modal","batch-delete-movements"].includes(u)&&e.stopPropagation(),u){case"manage-categories":Pl();break;case"open-product-editor":Bl(d.dataset.id);break;case"close-detail-screen":ta();break;case"close-movement-modal":ts();break;case"batch-delete":Al();break;case"batch-delete-movements":ql();break;case"open-new-movement-modal":Tl();break;case"delete-movement":{const c=d.dataset.id,p=d.dataset.productId,b=d.dataset.estId;if(!c)return;const m=$.allMovements.find(y=>y.id===c);if(!m){f("Aviso","Não foi possível ler os detalhes desta movimentação.","warning");return}if(await Q("Estornar e Apagar Movimentação","Tem a certeza que deseja excluir esta movimentação? O saldo de stock será devolvido ao produto de forma automática."))try{throw await Da(p,{change:-m.change,reason:"Estorno automático de exclusão de movimento",establishmentId:b}),new Error("A função de excluir movimentação ainda não está implementada no servidor.");ie(g.establishmentId,Oe(),"Estoque","Excluiu Movimento",`Excluiu e estornou a movimentação ID: ${c}`),f("Sucesso","Movimentação excluída e saldo de stock estornado.","success"),await Se()}catch(y){f("Erro",y.message,"error")}break}case"delete-product":{const c=d.dataset.id;if(!c)return;if(await Q("Apagar Produto","Tem certeza que deseja excluir este produto do estoque?"))try{const b=$.products.find(m=>m.id===c)?.name||"Desconhecido";await hs(c),ie(g.establishmentId,Oe(),"Produtos","Excluiu",`Excluiu o produto: ${b}`),f("Sucesso","Produto removido do estoque.","success"),ta(),await Se()}catch(b){f("Erro",`Não foi possível apagar o produto: ${b.message}`,"error")}break}}},document.body.addEventListener("click",Ht),Ot=e=>{e.target.id==="searchInput"&&($.searchQuery=e.target.value,Ne())},es.addEventListener("input",Ot)}const aa=document.getElementById("content");let J={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},zt=null;const pa={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},ni=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function Nl(){try{const e=(await we()).matrizes||[];J.establishments=[],e.forEach(a=>{J.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>J.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.warn("Erro ao buscar lojas",t)}J.viewMode="list",J.editingItem=null,J.hasSearched=!1,J.partners=[],Rl(),Vl(),li()}function Rl(){aa.innerHTML=`
    ...
    `}function Fl(){const t=Object.entries(pa).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=ni.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Hl(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(pa).map(([r,n])=>`<option value="${r}" ${a===r?"selected":""}>${n.label}</option>`).join(""),i=ni.map(r=>`<option value="${r}" ${t?.state===r?"selected":""}>${r}</option>`).join(""),o=document.getElementById("form-container-wrapper");o&&(o.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",zl))}function li(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
    ...
    `,s='<div class="flex flex-col gap-2 md:hidden p-2">';e.forEach(i=>{let o=i.category;o==="Produtos"&&(o="estoque"),o==="Serviços"&&(o="servicos");const r=pa[o]||pa.outros,n=i.document||i.taxId?i.document||i.taxId:"-",l=JSON.stringify(i).replace(/'/g,"&apos;"),d=[i.city,i.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",s+="</div>",t.innerHTML=a+s}function kt(t,e=null){const a=document.getElementById("suppliers-list-view"),s=document.getElementById("suppliers-form-view");J.viewMode=t,J.editingItem=e,t==="list"?(a.classList.remove("hidden"),a.classList.add("flex"),s.classList.add("hidden"),s.innerHTML='<div id="form-container-wrapper" class="max-w-4xl mx-auto w-full"></div>',J.hasSearched&&di(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),a.classList.remove("flex"),s.classList.remove("hidden"),Hl(e),window.scrollTo({top:0,behavior:"smooth"}))}async function zl(t){t.preventDefault();const e=t.target,a=e.querySelector("#supId").value,s={name:e.querySelector("#supName").value,contactName:e.querySelector("#supContact").value,email:e.querySelector("#supEmail").value,phone:e.querySelector("#supPhone").value,document:e.querySelector("#supTaxId").value,category:e.querySelector("#supCategory").value,state:e.querySelector("#supState").value,city:e.querySelector("#supCity").value,establishmentId:g.establishmentId,notes:e.querySelector("#supNotes")?.value||"",accessibleIn:[g.establishmentId]},i=e.querySelector('button[type="submit"]'),o=i.innerHTML;i.disabled=!0,i.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await wl(a,s),f("Sucesso","Ficha atualizada!","success")):(await yl(s),f("Sucesso","Parceiro registado!","success")),J.hasSearched&&(J.partners=await Tt(g.establishmentId)||[]),kt("list")}catch(r){f("Erro","Falha ao gravar: "+r.message,"error"),i.disabled=!1,i.innerHTML=o}}async function _l(t){if(await Q("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente?"))try{await kl(t),f("Sucesso","Entidade excluída.","success"),J.partners=J.partners.filter(a=>a.id!==t),kt("list")}catch(a){f("Erro","Erro ao excluir: "+a.message,"error")}}function Vl(){zt&&aa.removeEventListener("click",zt),zt=async t=>{const e=t.target;if(e.closest('button[data-action="new-partner"]')){kt("form",null);return}if(e.closest("#btn-search-partners")){J.searchQuery=document.getElementById("filterSearch").value,J.categoryFilter=document.getElementById("filterCategory").value,J.stateFilter=document.getElementById("filterState").value,J.cityFilter=document.getElementById("filterCity").value,J.sortBy=document.getElementById("filterSortBy").value,J.hasSearched=!0,Ol();return}if(e.closest('button[data-action="back-to-list"]')){kt("list");return}const a=e.closest('button[data-action="delete-partner"]');if(a){t.preventDefault(),_l(a.dataset.id);return}const s=e.closest('[data-action="open-form"]');if(s&&!e.closest("button")){const i=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));kt("form",i)}},aa.addEventListener("click",zt),aa.addEventListener("keypress",t=>{t.key==="Enter"&&(t.target.id==="filterSearch"||t.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const ss=document.getElementById("content"),Us={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let _={professionals:null,services:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterServiceId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,viewMode:"list",tempProf:null},_t=null,Vt=null;function sa(){const t=ye.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function ci(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function Ul(){const t=document.getElementById("professionals-layout-detail"),e=document.getElementById("prof-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function Ut(){const t=document.getElementById("professionals-layout-detail"),e=document.getElementById("prof-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),_.viewMode="list"}async function Wl(){_.selectedIds.clear(),_.viewMode="list",_.professionals=null;try{const t=await we();_.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}Jl(),sd(),await ba()}function Jl(){ss.innerHTML=`
        <div class="h-full flex w-full relative overflow-hidden bg-slate-50">
    ...
    `}async function ba(){const t=document.getElementById("professionalsList"),e=ci();try{const a=e.map(l=>Ie(l)),s=e.map(l=>ct(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),_.professionals=Array.from(r.values()),g.professionals=_.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),_.services=Array.from(n.values()),Ql(),ht()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function Ql(){const t=document.getElementById("filterServiceId");t&&_.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',_.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),_.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function ui(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=_.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Gl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,i=a-s;e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function ht(){const t=document.getElementById("professionalsList");if(!t)return;if(_.professionals===null){t.innerHTML=pi(8);return}const e=ci(),a=_.professionals.filter(s=>{const i=s.name.toLowerCase().includes(_.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(_.searchQuery);let o=!0;_.statusFilter==="active"&&(o=s.status!=="inactive"),_.statusFilter==="inactive"&&(o=s.status==="inactive");const r=_.filterServiceId==="all"||s.services&&s.services.includes(_.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||g.establishmentId],l=e.some(d=>n.includes(d));return i&&o&&r&&l});if(Gl(a),a.length===0){_.professionals.length===0?t.innerHTML=`
                <div class="col-span-full flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-slate-300 shadow-sm">
                    <div class="w-16 h-16 bg-indigo-50 rounded-full flex items-center justify-center mb-4 border border-indigo-100">
            ...
            </div>`}).join("")}function pi(t=8){let e="";for(let a=0;a<t;a++)e+=`
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm flex items-center p-4 animate-pulse h-[98px]">
    ...
    `,Xl(a,_.services),Kl(a),await td(a,_.professionals),ad(a),Ul()}function Xl(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const i=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,b=p==i[1]?"selected":"",m=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${m.charAt(0).toUpperCase()+m.slice(1)}</option>`}).join(""),r=v(t.name||""),n=v(t.specialty||""),l=v(t.phone||""),d=v(t.notes||"");a.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-1 space-y-4">
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-center flex flex-col items-center">
    ...
    `}function Zl(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${g.establishmentId}">
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-500 text-center">
                <i class="bi bi-info-circle text-2xl block mb-2 text-slate-400"></i> Exclusivo desta unidade.
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function Kl(t){const e=document.getElementById("jornada");e&&(e.innerHTML=`
        <div class="bg-white p-5 md:p-8 rounded-3xl border border-slate-200 shadow-sm">
        ...
        </div>`,ed(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function ed(t,e){t.innerHTML=Object.keys(Us).map(a=>{const s=e[a]||{},i=s.active!==!1;return`
            <div class="day-schedule-card p-4 md:p-5 rounded-2xl ${i?"bg-white border-slate-200 shadow-sm":"bg-slate-50 border-slate-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-4">
                    <span class="font-black text-sm text-slate-800 uppercase tracking-wider flex items-center gap-2"><i class="bi bi-calendar-day text-slate-400"></i> ${Us[a]}</span>
            ...
            </div>`}).join(""),t.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",s=>{const i=s.target.closest(".day-schedule-card"),o=!s.target.checked;i.classList.toggle("bg-white",!o),i.classList.toggle("shadow-sm",!o),i.classList.toggle("border-slate-200",!o),i.classList.toggle("bg-slate-50",o),i.classList.toggle("border-slate-100",o),i.classList.toggle("opacity-60",o),i.classList.toggle("disabled",o),i.querySelectorAll(".time-inputs input").forEach(r=>r.disabled=o)})})}async function td(t,e){const a=document.getElementById("bloqueios");if(!a)return;a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-[10px] font-bold text-red-500 p-4 bg-red-50 rounded-xl border border-red-100">${s.message}</p>`}}}function ad(t){const e=document.getElementById("prof-modal-inner");if(!e)return;const a=e.querySelectorAll(".tab-link");a.forEach(p=>{p.addEventListener("click",b=>{b.preventDefault(),a.forEach(y=>{y.classList.remove("active","border-indigo-600","text-indigo-600"),y.classList.add("border-transparent","text-slate-400")}),p.classList.add("active","border-indigo-600","text-indigo-600"),p.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.add("hidden"));const m=p.dataset.tab,h=e.querySelector("#"+m);h&&h.classList.remove("hidden")})});const s=e.querySelector("#profPhotoInput"),i=e.querySelector("#profPhotoButton"),o=e.querySelector("#profPhotoContainer"),r=e.querySelector("#profPhotoPreview"),n=e.querySelector("#profPhotoBase64"),l=t.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,d=t.photo||"",u=()=>s.click();i&&i.addEventListener("click",u),o&&o.addEventListener("click",u),s&&(s.onchange=async()=>{const p=s.files[0];if(p){r.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const b=await wa(p,800,800,.8);if(b.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");r.src=b,n.value=b}catch(b){f("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),r.src=l,n.value=d,s.value=""}}});const c=e.querySelector("#selectAllServicesBtn");if(c){c.addEventListener("click",()=>{const b=e.querySelectorAll('#profServicesContainer input[type="checkbox"]'),m=Array.from(b).every(h=>h.checked);b.forEach(h=>{h.checked=!m}),c.textContent=m?"Selecionar Todos":"Desmarcar Todos"});const p=e.querySelectorAll('#profServicesContainer input[type="checkbox"]');p.length>0&&Array.from(p).every(b=>b.checked)&&(c.textContent="Desmarcar Todos")}}function sd(){_t&&document.body.removeEventListener("click",_t),Vt&&ss.removeEventListener("input",Vt),_t=async t=>{if(t.target.classList.contains("professional-checkbox")){const o=t.target.dataset.id;t.target.checked?_.selectedIds.add(o):_.selectedIds.delete(o),ui(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){_.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600"),ht();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterServiceId").value="all",_.filterServiceId="all",ht();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),_.filterServiceId=document.getElementById("filterServiceId").value,ht();return}const a=t.target.closest("#toggle-filter-btn");if(a){t.preventDefault(),_.isAdvancedFilterOpen=!_.isAdvancedFilterOpen;const o=document.getElementById("filter-panel");_.isAdvancedFilterOpen?(o.classList.remove("hidden"),o.classList.add("block"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200")):(o.classList.add("hidden"),o.classList.remove("block"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"));return}const s=t.target.closest("[data-action]");if(!s){t.target.id==="professionals-layout-detail"&&Ut();return}const i=s.dataset.action;switch(["close-detail-screen","delete-professional","save-professional","delete-blockage","batch-delete-blockage"].includes(i)&&t.stopPropagation(),i){case"open-professional-editor":Yl(s.dataset.id);break;case"close-detail-screen":Ut(),_.tempProf=null;break;case"batch-delete":od();break;case"delete-professional":{const o=s.dataset.id,r=_.tempProf?.name||"Profissional";if(await Q("Excluir Profissional",`Tem certeza que deseja excluir ${r}? Esta ação não pode ser desfeita.`))try{await wo(o),ie(g.establishmentId,sa(),"Equipe","Excluiu",`Excluiu profissional: ${r}`),f("Sucesso!","Profissional excluído da rede.","success"),Ut(),ba()}catch(l){f("Erro",`Não foi possível excluir: ${l.message}`,"error")}break}case"save-professional":{const o=document.getElementById("prof-modal-inner"),r=s,n=o.querySelector("#profScheduleContainer"),l=Array.from(o.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map(w=>w.value),d={};n&&n.querySelectorAll(".day-schedule-card").forEach(w=>{const M=w.querySelector('[data-field="active"]').dataset.day;d[M]={active:w.querySelector('[data-field="active"]').checked,start:w.querySelector('[data-field="start"]').value,end:w.querySelector('[data-field="end"]').value,breakStart:w.querySelector('[data-field="breakStart"]').value,breakEnd:w.querySelector('[data-field="breakEnd"]').value}});const u=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(w=>w.value),c=u.length>0?u:[g.establishmentId],p=o.querySelector("#profStatusToggle").checked,b=o.querySelector("#profCommissionToggle").checked,m=o.querySelector("#profShowOnAgendaToggle").checked,h={..._.tempProf,id:o.querySelector("#professionalId").value||void 0,accessibleIn:c,name:o.querySelector("#profName").value.trim(),specialty:o.querySelector("#profSpecialty").value,photo:o.querySelector("#profPhotoBase64").value,services:l,workingHours:d,phone:o.querySelector("#profPhone").value,dob:`${o.querySelector("#profDobDay").value}/${o.querySelector("#profDobMonth").value}`,receivesCommission:b,showOnAgenda:m,orderOnAgenda:parseInt(o.querySelector("#profOrderOnAgenda").value)||1,notes:o.querySelector("#profNotes").value,status:p?"active":"inactive",establishmentId:g.establishmentId},y=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{h.id?(await Va(h.id,h),ie(g.establishmentId,sa(),"Equipe","Editou",`Editou o profissional: ${h.name}`),f("Sucesso!","Dados atualizados.","success")):(delete h.id,await mr(h),ie(g.establishmentId,sa(),"Equipe","Criou",`Cadastrou o profissional: ${h.name}`),f("Sucesso!","Novo membro adicionado à equipe.","success")),Ut(),ba()}catch(w){f("Erro",w.message,"error"),r.disabled=!1,r.innerHTML=y}break}case"delete-blockage":{const o=s.dataset.id;if(await Q("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await gs(o),f("Bloqueio removido.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";St(_.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}case"batch-delete-blockage":{const o=JSON.parse(s.dataset.ids);if(await Q("Apagar em Lote",`Tem certeza que deseja apagar ${o.length} dias de bloqueio de uma vez?`))try{await Ho(o),f("Bloqueios removidos.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";St(_.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}}},document.body.addEventListener("click",_t),Vt=t=>{t.target.id==="searchInput"&&(_.searchQuery=t.target.value,ht())},ss.addEventListener("input",Vt)}function od(){Q("Excluir em Lote",`Tem certeza que deseja excluir ${_.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await gr(Array.from(_.selectedIds)),ie(g.establishmentId,sa(),"Equipe","Excluiu em Lote",`Excluiu ${_.selectedIds.size} profissionais`),f("Sucesso!",`${_.selectedIds.size} profissionais foram excluídos.`,"success"),_.selectedIds.clear(),ui(),ba()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}let E={clients:[],selectedClient:null,establishments:[],filterEstablishmentIds:new Set,filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:50,historyData:{appointments:[],sales:[],loyaltyLog:[]}},ma=null,Wt=null;const bi=t=>t?String(t).replace(/\D/g,""):"",os=t=>{if(!t)return"Nunca";let e;if(typeof t=="object"&&(t.seconds||t._seconds)){const a=t.seconds||t._seconds;e=new Date(a*1e3)}else e=new Date(t);return isNaN(e.getTime())?"Data Inválida":e.toLocaleDateString("pt-BR")},is=t=>{if(!t)return"CL";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()};function id(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function ze(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),E.selectedClient=null}async function rd(){ma=document.getElementById("content"),E.selectedClient=null,E.selectedIds.clear(),E.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},E.sortConfig={key:"name",direction:"asc"};try{const e=(await we().catch(()=>({matrizes:[]}))).matrizes||[];E.establishments=[],e.forEach(a=>{E.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>E.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),E.filterEstablishmentIds.size===0&&E.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia",t)}nd(),dd(),await $s()}function nd(){const t=E.establishments.map(e=>`
    ...
    `}function ld(){const t=document.getElementById("table-header-container");if(!t)return;const e=a=>E.sortConfig.key!==a?'<i class="bi bi-arrow-down-up ml-1 opacity-40 text-xs"></i>':E.sortConfig.direction==="asc"?'<i class="bi bi-arrow-up ml-1 text-indigo-600"></i>':'<i class="bi bi-arrow-down ml-1 text-indigo-600"></i>';t.innerHTML=`
    ...
    `}async function $s(){E.loading=!0;const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-slate-500 font-bold text-[10px] uppercase tracking-widest">Carregando clientes...</p></div>');try{const a=Array.from(E.filterEstablishmentIds).map(r=>{let n=`/api/clients/${r}?limit=1000`;return L(n).catch(()=>[])}),i=(await Promise.all(a)).flat(),o=new Map;i.forEach(r=>o.set(r.id,r)),E.clients=Array.from(o.values()),Is(),Pe()}catch(e){console.error(e),f("Erro","Falha ao carregar clientes.","error"),t&&(t.innerHTML='<div class="text-center py-10 text-red-500 font-bold text-sm">Erro ao carregar dados.</div>')}finally{E.loading=!1}}function Is(){const t=new Date().getMonth()+1,e=new Date().getFullYear();let a=0,s=0,i=0;E.clients.forEach(o=>{if(o.totalDebt&&parseFloat(o.totalDebt)>0&&s++,o.dobMonth==t&&i++,o.createdAt){const r=new Date(o.createdAt);r.getMonth()+1===t&&r.getFullYear()===e&&a++}}),document.getElementById("kpi-total").textContent=E.clients.length,document.getElementById("kpi-novos").textContent=a,document.getElementById("kpi-devendo").textContent=s,document.getElementById("kpi-niver").textContent=i}function Pe(){ld();const t=document.getElementById("list-container");let e=E.clients;if(E.filters.search){const a=E.filters.search.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(E.filters.status==="devendo")e=e.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(E.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;e=e.filter(s=>s.dobMonth==a)}else if(E.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();e=e.filter(i=>{if(!i.createdAt)return!1;const o=new Date(i.createdAt);return o.getMonth()+1===a&&o.getFullYear()===s})}if(E.filters.hasLoyalty&&(e=e.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),E.filters.inactiveDays){const a=parseInt(E.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),e=e.filter(i=>{if(!i.lastVisit&&!i.createdAt)return!1;let o;if(i.lastVisit){const r=i.lastVisit.seconds||i.lastVisit._seconds;o=r?new Date(r*1e3):new Date(i.lastVisit)}else o=new Date(i.createdAt);return o<s})}if(e.sort((a,s)=>{let i,o;switch(E.sortConfig.key){case"name":return i=(a.name||"").toLowerCase(),o=(s.name||"").toLowerCase(),E.sortConfig.direction==="asc"?i.localeCompare(o):o.localeCompare(i);case"contact":return i=a.phone||"",o=s.phone||"",E.sortConfig.direction==="asc"?i.localeCompare(o):o.localeCompare(i);case"lastVisit":i=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,o=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":i=parseFloat(a.totalDebt)||0,o=parseFloat(s.totalDebt)||0;break;default:i=a.name,o=s.name}return i<o?E.sortConfig.direction==="asc"?-1:1:i>o?E.sortConfig.direction==="asc"?1:-1:0}),e.length===0){t.innerHTML=`
            ...
            </div>`;return}t.innerHTML=e.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,i=os(a.lastVisit),o=bi(a.phone),r=new Date().getMonth()+1,n=a.dobMonth==r,l=E.selectedIds.has(a.id);let d="";return n&&(d+='<span class="bg-indigo-50 text-indigo-700 text-[8px] font-black px-1.5 py-0.5 rounded border border-indigo-200 uppercase tracking-wider shadow-sm flex items-center gap-1"><i class="bi bi-gift-fill"></i> Niver</span> '),a.loyaltyPoints>0&&(d+=`<span class="bg-amber-50 text-amber-700 text-[8px] font-black px-1.5 py-0.5 rounded border border-amber-200 uppercase tracking-wider shadow-sm flex items-center gap-1"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
        ...
        `}).join("")}function dd(){Wt&&ma.removeEventListener("click",Wt),Wt=o=>{const r=o.target;if(r.classList.contains("item-checkbox")){const u=r.value;r.checked?E.selectedIds.add(u):E.selectedIds.delete(u),oa();const c=r.closest('div[data-action="open-modal"]');r.checked?c.classList.add("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200"):c.classList.remove("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200"),o.stopPropagation();return}if(r.dataset.actionStopPropagation==="true"&&o.stopPropagation(),r.id==="select-all-toggle"){const u=r.checked,c=document.querySelectorAll(".item-checkbox");E.selectedIds.clear(),c.forEach(p=>{p.checked=u,u&&E.selectedIds.add(p.value);const b=p.closest('div[data-action="open-modal"]');u?b.classList.add("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200"):b.classList.remove("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200")}),oa(),o.stopPropagation();return}const n=r.closest("[data-sort]");if(n){const u=n.dataset.sort;E.sortConfig.key===u?E.sortConfig.direction=E.sortConfig.direction==="asc"?"desc":"asc":(E.sortConfig.key=u,E.sortConfig.direction="asc"),Pe();return}const l=r.closest("[data-action]");if(l){const u=l.dataset.action,c=l.dataset.id;if(u==="new-client"){Ws(null);return}if(u==="open-modal"){Ws(c);return}if(u==="close-detail-screen"){ze();return}if(u==="whatsapp"){o.stopPropagation();const p=l.dataset.phone;window.open(`https://wa.me/55${p}`,"_blank");return}if(u==="export-excel"){hd();return}}if(r.id==="clients-layout-detail"){ze();return}const d=r.closest("[data-filter]");d&&(document.querySelectorAll("[data-filter]").forEach(u=>u.classList.remove("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300")),d.classList.add("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300"),E.filters.status=d.dataset.filter,Pe())},ma.addEventListener("click",Wt);const t=document.getElementById("cancel-selection-btn");t&&t.addEventListener("click",()=>{E.selectedIds.clear();const o=document.getElementById("select-all-toggle");o&&(o.checked=!1),document.querySelectorAll(".item-checkbox").forEach(r=>{r.checked=!1,r.closest('div[data-action="open-modal"]').classList.remove("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200")}),oa()});const e=document.getElementById("batch-delete-btn");e&&e.addEventListener("click",cd),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",r=>{const n=r.target.closest("label");r.target.checked?(E.filterEstablishmentIds.add(r.target.value),n.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.remove("border-slate-200","text-slate-600")):(E.filterEstablishmentIds.delete(r.target.value),n.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.add("border-slate-200","text-slate-600")),$s()})});const a=document.getElementById("search-input");a&&a.addEventListener("input",o=>{E.filters.search=o.target.value,Pe()});const s=document.getElementById("filter-inactive");s&&s.addEventListener("input",o=>{E.filters.inactiveDays=o.target.value,Pe()});const i=document.getElementById("filter-loyalty");i&&i.addEventListener("change",o=>{E.filters.hasLoyalty=o.target.checked,Pe()})}function oa(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count");if(!t||!e)return;const a=E.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}async function cd(){const t=E.selectedIds.size;if(!(t===0||!await Q("Excluir Clientes",`Deseja realmente excluir permanentemente ${t} cliente(s)? O histórico de agendamentos será mantido, mas o cadastro será apagado.`)))try{const a=Array.from(E.selectedIds).map(i=>Po(i));await Promise.all(a),f("Sucesso",`${t} cliente(s) excluído(s) com sucesso.`,"success"),E.selectedIds.clear(),oa();const s=document.getElementById("select-all-toggle");s&&(s.checked=!1),await $s()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns clientes.","error")}}function Ws(t=null){t?(E.selectedClient=E.clients.find(a=>a.id===t),E.selectedClient.isNew=!1):E.selectedClient={isNew:!0,id:"",name:"",phone:"",email:"",cpf:"",gender:"",dobDay:"",dobMonth:"",source:"",notes:"",loyaltyPoints:0,totalDebt:0},E.historyData={appointments:[],sales:[],loyaltyLog:[]};const e=document.getElementById("client-modal-content")||document.getElementById("client-modal-inner");e&&(ud(e,E.selectedClient),id(),E.selectedClient.isNew||md(E.selectedClient))}function ud(t,e){const a=e.isNew,s=v(e.name||""),i=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
    ...
    `,t.querySelectorAll(".tab-link").forEach(l=>{l.addEventListener("click",d=>{d.preventDefault(),t.querySelectorAll(".tab-link").forEach(u=>{u.classList.remove("active","border-indigo-600","text-indigo-600"),u.classList.add("border-transparent","text-slate-400")}),l.classList.add("active","border-indigo-600","text-indigo-600"),l.classList.remove("border-transparent","text-slate-400"),t.querySelectorAll(".tab-content").forEach(u=>u.classList.add("hidden")),t.querySelector("#"+l.dataset.tab).classList.remove("hidden")})});const r=t.querySelector("#form-edit-client");r&&(r.onsubmit=gd);const n=t.querySelector('[data-action="delete-client"]');n&&(n.onclick=fd)}function pd(t){return t.sort((e,a)=>new Date(a.startTime)-new Date(e.startTime)),`
        <div class="space-y-3">
            ${t.length?t.map(e=>{const a=new Date(e.startTime);let i=a<new Date?'<span class="bg-slate-100 text-slate-600 px-2 py-0.5 rounded-md text-[9px] font-black uppercase border border-slate-200">Concluído</span>':'<span class="bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded-md text-[9px] font-black uppercase border border-emerald-200">Agendado</span>';return e.status==="cancelled"&&(i='<span class="bg-red-50 text-red-600 px-2 py-0.5 rounded-md text-[9px] font-black uppercase border border-red-200">Cancelado</span>'),`
    ...
    `}function bd(t){t.sort((s,i)=>new Date(i.date)-new Date(s.date));const e=t.reduce((s,i)=>s+(Number(i.totalAmount)||0),0),a=t.length>0?e/t.length:0;return`
        <div class="space-y-6">
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-emerald-50 p-4 md:p-5 rounded-2xl border border-emerald-100 shadow-sm flex flex-col text-center justify-center">
                    ...
                    <span class="text-2xl md:text-3xl font-black text-emerald-700 mt-1">${Aa(e)}</span>
                </div>
                <div class="bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col text-center justify-center">
                    ...
                    <span class="text-2xl md:text-3xl font-black text-slate-800 mt-1">${Aa(a)}</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                ...
                <div class="p-3 space-y-2">
                    ...
                    <div class="bg-white border border-slate-100 rounded-xl p-4 flex justify-between items-center shadow-sm hover:border-indigo-200 cursor-pointer transition-all active:scale-[0.98]" data-go-comanda="true" data-id="${s.id}">
                        ...
                        <div class="text-right">
                            <p class="font-black text-emerald-600 text-sm bg-emerald-50 px-2 py-0.5 rounded-lg border border-emerald-100">${Aa(s.totalAmount)}</p>
    ...
    `}function mi(t,e){return e.sort((a,s)=>new Date(s.date)-new Date(a.date)),`
        <div class="space-y-6">
    ...
    `}async function md(t){if(!t||!t.phone)return;const e=bi(t.phone);try{const a=new Date;a.setMonth(a.getMonth()+12);const s=new Date;s.setFullYear(s.getFullYear()-5);let i=`/api/appointments/${g.establishmentId}?startDate=${s.toISOString()}&endDate=${a.toISOString()}&clientPhone=${encodeURIComponent(e)}&limit=100`;const o=await L(i);E.historyData.appointments=o,E.historyData.sales=o.filter(u=>u.status==="completed").map(u=>({id:u.id,date:u.startTime,totalAmount:u.totalAmount||0,items:u.comandaItems||u.services||[]}));const r=[];o.forEach(u=>{u.status==="completed"&&u.loyaltyPointsEarned>0&&r.push({type:"earn",points:u.loyaltyPointsEarned,date:u.startTime,description:"Serviço / Venda concluída"}),u.loyaltyRedemption&&r.push({type:"redemption",points:u.loyaltyRedemption.cost||0,date:u.startTime,description:`Resgate: ${u.loyaltyRedemption.name}`})}),E.historyData.loyaltyLog=r;const n=document.getElementById("historico-agendamentos-container");n&&(n.innerHTML=pd(E.historyData.appointments));const l=document.getElementById("historico-financeiro-container");l&&(l.innerHTML=bd(E.historyData.sales));const d=document.getElementById("historico-fidelidade-container");d&&(d.innerHTML=mi(t,E.historyData.loyaltyLog)),gi(t)}catch(a){console.error("Erro ao buscar histórico via telefone",a);const s='<div class="text-center py-6 text-red-500 font-bold text-[10px] uppercase bg-red-50 rounded-xl m-2 border border-red-100">Falha na busca. O Telefone está preenchido corretamente?</div>',i=document.getElementById("historico-agendamentos-container");i&&(i.innerHTML=s);const o=document.getElementById("historico-financeiro-container");o&&(o.innerHTML=s);const r=document.getElementById("historico-fidelidade-container");r&&(r.innerHTML=s)}}function gi(t){const e=document.getElementById("client-modal-inner");if(!e)return;e.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=()=>{ze(),oe("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=()=>{ze(),oe("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const a=e.querySelector('[data-action="manual-redeem"]');a&&(a.onclick=s=>{s.preventDefault(),xd(t)})}async function gd(t){t.preventDefault();const e=t.target.querySelector('button[type="submit"]'),a=e.innerHTML;e.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Gravando...',e.disabled=!0;const s=new FormData(t.target),i=Object.fromEntries(s.entries());i.establishmentId=g.establishmentId,i.dobDay&&(i.dobDay=parseInt(i.dobDay)),i.dobMonth&&(i.dobMonth=parseInt(i.dobMonth));try{if(E.selectedClient.isNew){const o=await Co(i);E.clients.unshift(o),f("Sucesso","Cliente cadastrado com sucesso!","success"),ze()}else{await Do(E.selectedClient.id,i),Object.assign(E.selectedClient,i);const o=E.clients.findIndex(r=>r.id===E.selectedClient.id);o!==-1&&(E.clients[o]=E.selectedClient),f("Sucesso","Dados salvos com sucesso!","success"),ze()}Is(),Pe()}catch(o){f("Erro",o.message,"error"),e.innerHTML=a,e.disabled=!1}}async function fd(t){if(t.preventDefault(),!!await Q("Excluir Cliente","Tem certeza? O histórico financeiro será mantido de forma anônima, mas a ficha cadastral será perdida permanentemente."))try{await Po(E.selectedClient.id),E.clients=E.clients.filter(a=>a.id!==E.selectedClient.id),f("Sucesso","Cliente removido com sucesso.","success"),ze(),Is(),Pe()}catch(a){f("Erro",a.message,"error")}}function xd(t){const e=t.loyaltyPoints||0,a=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const u={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,cnpj:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};pt(u,d)})}function yd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const s=e.querySelector("#newPassword").value,i=e.querySelector("#confirmPassword").value;if(s!==i){f("Erro","As senhas não coincidem.","error");return}const o=e.querySelector('button[form="change-password-form"]');o.disabled=!0,o.textContent="A Salvar...";try{const r=ye.currentUser;if(r)await ji(r,s),f("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum utilizador logado encontrado.")}catch(r){f("Erro",`Não foi possível alterar a senha: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Salvar Nova Senha"}})}function wd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const h=e.querySelector("#mockup-screen-wrapper"),y=e.querySelector("#mockup-screen"),w=e.querySelector("#previewPrimaryColorInput"),M=e.querySelector("#previewBgColorInput"),B=e.querySelector("#previewTextColorInput"),S=e.querySelector("#previewTitleColorInput"),I=e.querySelector("#typographyInput"),N=e.querySelector("#establishmentWelcomeMessage"),U=e.querySelector("#mockup-welcome"),C=e.querySelector("#socialInstagram"),D=e.querySelector("#socialWhatsapp"),V=e.querySelector("#socialFacebook"),P=e.querySelector("#prevTemplate"),T=e.querySelector("#nextTemplate"),F=e.querySelector("#templateNameDisplay"),X=e.querySelector("#selectedTemplateId"),te=W=>{const G=de[W];h.style.opacity="0.3",h.style.transform="scale(0.96)",setTimeout(()=>{w.value=G.primary,M.value=G.bg,B.value=G.text,S.value=G.titleColor||G.text,I.value=G.font,e.querySelectorAll('input[name="buttonStyle"]').forEach(ge=>{ge.checked=ge.value===G.btn}),X.value=G.id,F.textContent=G.name,y.style.setProperty("--preview-primary",G.primary),y.style.setProperty("--preview-bg",G.bg),y.style.setProperty("--preview-text",G.text),y.style.setProperty("--preview-title-color",G.titleColor||G.text),y.style.setProperty("--preview-font",G.font),y.style.setProperty("--preview-btn-radius",m(G.btn)),y.style.setProperty("--preview-card-bg",G.cardBg),y.style.setProperty("--preview-card-border",G.cardBorder),h.style.opacity="1",h.style.transform="scale(1)"},300)};P.addEventListener("click",()=>{b=(b-1+de.length)%de.length,te(b)}),T.addEventListener("click",()=>{b=(b+1)%de.length,te(b)}),w.addEventListener("input",W=>y.style.setProperty("--preview-primary",W.target.value)),M.addEventListener("input",W=>y.style.setProperty("--preview-bg",W.target.value)),B.addEventListener("input",W=>y.style.setProperty("--preview-text",W.target.value)),S.addEventListener("input",W=>y.style.setProperty("--preview-title-color",W.target.value)),I.addEventListener("change",W=>y.style.setProperty("--preview-font",W.target.value)),e.querySelectorAll('input[name="buttonStyle"]').forEach(W=>{W.addEventListener("change",G=>{G.target.checked&&y.style.setProperty("--preview-btn-radius",m(G.target.value))})}),N.addEventListener("input",W=>U.textContent=W.target.value||"Mensagem...");const re=()=>{e.querySelector("#mockup-insta-icon").classList.toggle("hidden",!C.value.trim()),e.querySelector("#mockup-whats-icon").classList.toggle("hidden",!D.value.trim()),e.querySelector("#mockup-face-icon").classList.toggle("hidden",!V.value.trim())};[C,D,V].forEach(W=>W.addEventListener("input",re));const Z=e.querySelector("#establishmentLogoInput"),j=e.querySelector("#establishmentBgInput"),ee=e.querySelector("#establishmentLogoBase64"),le=e.querySelector("#establishmentBackgroundImageBase64");e.querySelector("#triggerLogoUpload").addEventListener("click",W=>{W.target.id!=="establishmentLogoInput"&&Z.click()}),Z.onchange=async W=>{const G=W.target.files[0];if(G){const ge=await Js(G,300,.9);e.querySelector("#establishmentLogoPreview").src=ge,e.querySelector("#mockup-logo").src=ge,ee.value=ge}},e.querySelector("#triggerBannerUpload").addEventListener("click",W=>{W.target.id!=="establishmentBgInput"&&j.click()}),j.onchange=async W=>{const G=W.target.files[0];if(G){const ge=await Js(G,1280,.8);e.querySelector("#establishmentBgPreview").src=ge,e.querySelector("#establishmentBgPreview").classList.remove("hidden"),e.querySelector("#establishmentBgPlaceholder").classList.add("hidden"),le.value=ge,e.querySelector("#mockup-banner").src=ge,e.querySelector("#mockup-banner").classList.remove("hidden"),e.querySelector("#mockup-banner-placeholder").classList.add("hidden")}},e.querySelector("#branding-form").addEventListener("submit",W=>{W.preventDefault();let G="rounded";e.querySelectorAll('input[name="buttonStyle"]').forEach(Cs=>{Cs.checked&&(G=Cs.value)});const ge={logo:ee.value,backgroundImage:le.value,welcomeMessage:N.value,templateId:X.value,primaryColor:w.value,backgroundColor:M.value,textColor:B.value,titleColor:S.value,typography:I.value,buttonStyle:G,socialLinks:{instagram:C.value.trim(),whatsapp:D.value.trim(),facebook:V.value.trim()}};pt(ge,W)})}function Sd(t,e){const a=t.urlId||se;let s=window.location.origin;(s.includes("localhost")||s.includes("capacitor://")||s.includes("127.0.0.1"))&&(s="https://www.kairosagenda.com.br");const i=v(`${s}/agendar?id=${a}`),o=t.publicBookingEnabled||!1,r=o?"Agendamento Online ATIVO":"Agendamento Online INATIVO",n=o?"text-green-600":"text-red-600";e.innerHTML=`
    ...
    `;const a=e.querySelector("#establishmentTimezone");t.timezone&&(a.value=t.timezone);const s=e.querySelector("#establishmentWorkingHoursContainer"),i=t.workingHours||{};Object.keys(Fa).forEach(o=>{const r=i[o]||{},n=Fa[o],l=r.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",o=>{const r=o.target.closest('.day-schedule-card input[type="checkbox"]');if(r){const n=r.closest(".day-schedule-card");n.classList.toggle("disabled",!r.checked),n.classList.toggle("opacity-60",!r.checked),n.classList.toggle("bg-gray-50",r.checked),n.classList.toggle("bg-gray-100",!r.checked)}}),e.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const r={};Object.keys(Fa).forEach(l=>{r[l]={active:e.querySelector(`#est-${l}-active`).checked,start:e.querySelector(`#est-${l}-start`).value,end:e.querySelector(`#est-${l}-end`).value,breakStart:e.querySelector(`#est-${l}-breakStart`).value,breakEnd:e.querySelector(`#est-${l}-breakEnd`).value}});const n=e.querySelector("#establishmentTimezone").value;pt({workingHours:r,timezone:n},o)})}function xi(t,e){const a=!!t.whatsappInstance;e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;const n=e.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const u=document.createElement("div");u.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const c=d.type||"money",p=d.itemId||"",b=d.reward||"",m=d.discount||"",h=d.points||d.costPoints||"";u.innerHTML=`
        ...
        `;const y=u.querySelector(".type-select"),w=u.querySelector(".item-select"),M=u.querySelector(".desc-input"),B=u.querySelector(".discount-input"),S=I=>{w.innerHTML='<option value="">Selecione...</option>';let N=[];I==="service"?N=i:I==="product"?N=o:I==="package"&&(N=r),N.forEach(U=>{const C=U.id===p,D=U.name||U.title||"Sem nome",V=U.price||U.salePrice||0;w.innerHTML+=`<option value="${U.id}" data-price="${V}" ${C?"selected":""}>${v(D)}</option>`})};return c!=="money"&&S(c),y.addEventListener("change",I=>{const N=I.target.value;N==="money"?(w.classList.add("hidden"),M.classList.remove("hidden"),M.value="",B.value=""):(w.classList.remove("hidden"),M.classList.add("hidden"),S(N),B.value="")}),w.addEventListener("change",I=>{const N=I.target.selectedOptions[0];if(N&&N.value){M.value=N.text;const U=N.dataset.price;U&&(B.value=parseFloat(U).toFixed(2))}}),u};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),e.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const u=d.target.closest(".remove-loyalty-tier");u&&u.closest(".loyalty-tier-row").remove()}),e.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const u=Array.from(e.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(p=>{const b=p.querySelector(".type-select").value,m=b==="money"?null:p.querySelector(".item-select").value;let h=b==="money"?p.querySelector(".desc-input").value:p.querySelector(".item-select").options[p.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,type:b,itemId:m,reward:h,name:h,discount:parseFloat(p.querySelector('input[data-field="discount"]').value)||0}}),c={loyaltyProgram:{enabled:e.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(e.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:u.filter(p=>p.points>0&&p.reward)}};pt(c,d)})}async function Ed(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([$a(se),bs(se)]),i=t.financialIntegration||{},o=t.commissionConfig||{},r=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=Ue(a,i.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=Ue(s,i.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=Ue(a,r.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=Ue(s,r.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=Ue(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=Ue(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};pt(s,a)})}function Ld(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `}function Cd(t,e){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${t.name})`;e.innerHTML=`
    ...
    `}function Dd(t,e){const a=e.querySelector("#slotIntervalContainer"),s=e.querySelector("#establishmentSlotInterval");if(!a||!s)return;const i=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=i.map(o=>{const r=o.value===t;return`<button type="button" data-value="${o.value}" 
    ...
    `,He.querySelector('button[data-action="back-to-menu"]').addEventListener("click",i=>{i.preventDefault(),hi({id:se})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":vd(K,s);break;case"change-password":yd(K,s);break;case"change-email":wd(K,s);break;case"branding":kd(K,s);break;case"booking":Sd(K,s);break;case"working-hours":$d(K,s);break;case"whatsapp-bot":xi(K,s);break;case"loyalty":await Id(K,s);break;case"financial":await Ed(K,s);break;case"support":Ld(K,s);break;case"cancellation":Cd(K,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function hi(t={}){He.innerHTML=`
    ...
    `;try{se=t.id||g.establishmentId,K=await Ae(se);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=K.isMatriz||!K.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=fi();He.innerHTML=`
        ...
        `,He.querySelectorAll("div[data-section]").forEach(i=>{i.addEventListener("click",o=>{Pd(i.dataset.section)})}),He.querySelectorAll(".module-toggle").forEach(i=>{i.addEventListener("change",async()=>{const o=i.dataset.module;try{const n={...(await Ae(se)).modules,[o]:i.checked};await us(se,{modules:n}),f("Módulos","Módulos atualizados com sucesso.","success")}catch(r){i.checked=!i.checked,f("Erro",r.message,"error")}})})}catch(e){He.innerHTML=`
        ...
        `}}function Td(t){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `).join("")}const $t=document.getElementById("content");async function tt(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,i=await Ea(g.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),r=o?i.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):i,n=r.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",r.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${v(l)} (${d.length})</h4>`;if(d.length>1){const b=JSON.stringify(d.map(m=>m.id));p+=`<button data-action="batch-delete-blockage" data-ids='${b}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",u.innerHTML=p,d.forEach(b=>{const m=new Date(b.startTime),h=new Date(b.endTime),y=m.toLocaleDateString("pt-BR"),w=h.toLocaleDateString("pt-BR"),B=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${y===w?`${y} | ${m.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${h.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${y} às ${m.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${w} às ${h.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;u.innerHTML+=B}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Md(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,i=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,r=e.querySelector("#blockageEndTime").value,n={establishmentId:g.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await La(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),tt(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Bd(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,i=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,r=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:g.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:n};return La(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&tt(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Ad(t){$t.addEventListener("submit",e=>{e.target.id==="blockageForm"&&Md(e),e.target.id==="batchBlockageForm"&&Bd(e)}),$t.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&tt(t)}),$t.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")oe("profissionais-section");else if(s==="delete-blockage"){if(await Q("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await gs(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),tt(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const i=JSON.parse(a.dataset.ids);if(await Q("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${i.length} bloqueios de uma vez?`))try{await Ho(i),f("Sucesso",`${i.length} bloqueios removidos.`,"success"),tt(t)}catch(r){f("Erro",`Não foi possível apagar os bloqueios: ${r.message}`,"error")}}})}async function qd(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){$t.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);$t.innerHTML=`
        <section>
        ...
        </section>`,Ad(e),await tt(e);const i=document.getElementById("batchProfSelectionContainer");try{const o=await Ie(g.establishmentId);i.innerHTML=o.map(r=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{i.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const jd=t=>L(`/api/users/${t}`),Nd=t=>L("/api/users",{method:"POST",body:JSON.stringify(t)}),Rd=(t,e)=>L(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),Fd=t=>L(`/api/users/${t}`,{method:"DELETE"}),Hd=(t,e)=>L(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),Od=(t,e)=>L(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),bt=document.getElementById("content"),zd={"Operação & Atendimento":{"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas","ausencias-section":"Ausências e Bloqueios"},"Financeiro & Vendas":{"financial-section":"Financeiro (ERP)","sales-report-section":"Relatório de Vendas","commissions-section":"Comissões","packages-section":"Planos e Pacotes"},"Cadastros Base":{"clientes-section":"Clientes","profissionais-section":"Profissionais","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores"},Administração:{"relatorios-section":"Relatórios Gerais","estabelecimento-section":"Configurações da Empresa","users-section":"Usuários e Acessos"}},_d={view:"Visualizar",create:"Criar",edit:"Editar"},Qs={owner:{label:"Proprietário",color:"bg-rose-100 text-rose-700 border-rose-200"},group_admin:{label:"Admin da Rede",color:"bg-purple-100 text-purple-700 border-purple-200"},company_admin:{label:"Gestor Matriz",color:"bg-blue-100 text-blue-700 border-blue-200"},branch_manager:{label:"Gestor Filial",color:"bg-orange-100 text-orange-700 border-orange-200"},professional:{label:"Profissional",color:"bg-slate-100 text-slate-600 border-slate-200"}};let Jt=null,Qt=null,We=null,at=null;function vi(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.currentViewContext?.id||g.establishmentId]}function Vd(t){const e=document.getElementById("usersListContainer");if(!e)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const s=a?"Nenhum usuário encontrado na base.":"Nenhum usuário ativo neste contexto.";e.innerHTML=`
        ...
        `}).join("")}function yi(){const e=document.getElementById("showInactiveUsersToggle")?.checked?g.users:g.users.filter(a=>a.status==="active");Vd(e)}function Ud(t={}){let e="",a=!1;for(const[s,i]of Object.entries(zd)){const o=Object.entries(i).filter(([r,n])=>{const l=r.replace("-section","");return!(g.enabledModules&&g.enabledModules[l]===!1)});o.length!==0&&(a=!0,e+=`
        ...
        `,o.forEach(([r,n])=>{const l=r==="agenda-section"||r==="comandas-section",d=t[r]?.view_all_prof===!0,u=Object.entries(_d).map(([p,b])=>`
        ...
        `}),i+="</div>",i}async function Ys(t=null){document.getElementById("user-list-view").classList.add("hidden");const e=document.getElementById("user-form-view");e.classList.remove("hidden");let a=g.professionals;if(!a||a.length===0)try{const p=vi().map(h=>Ie(h)),b=await Promise.all(p),m=new Map;b.flat().forEach(h=>m.set(h.id,h)),a=Array.from(m.values()),g.professionals=a}catch(c){console.warn("Profissionais não carregados",c)}if(["owner","group_admin","company_admin"].includes(g.userRole)&&!at)try{const c=await we();c&&(at=c)}catch(c){console.error("Falha ao buscar hierarquia",c),at={companies:[],branches:[]}}const s=t!==null,i=s&&t.role==="owner",o=e.querySelector("#userFormTitle");o.innerHTML=s?`<i class="bi bi-person-lines-fill mr-2 text-indigo-600"></i>Editar Perfil: ${t.name}`:'<i class="bi bi-person-plus-fill mr-2 text-indigo-600"></i>Novo Acesso';const r=e.querySelector("#userForm");r.innerHTML=`
    ...
    `;const n=e.querySelectorAll(".tab-btn"),l=e.querySelectorAll(".tab-content");n.forEach(c=>{c.addEventListener("click",()=>{n.forEach(b=>{b.classList.remove("active","text-indigo-600","border-indigo-600"),b.classList.add("text-slate-400","border-transparent")}),l.forEach(b=>b.classList.add("hidden")),c.classList.add("active","text-indigo-600","border-indigo-600"),c.classList.remove("text-slate-400","border-transparent");const p=c.getAttribute("data-tab");e.querySelector(`#${p}`).classList.remove("hidden")})});const d=r.querySelector("#userRole"),u=r.querySelector("#hierarchySelectorContainer");if(d&&u){d.addEventListener("change",p=>{const b={...t,role:p.target.value};u.innerHTML=Gs(b),c()});const c=()=>{u.querySelectorAll(".company-checkbox").forEach(p=>{p.addEventListener("change",b=>{b.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(y=>{y.checked=b.target.checked;const w=y.nextElementSibling.querySelector(".dot");w&&(b.target.checked?w.classList.add("transform","translate-x-4"):w.classList.remove("transform","translate-x-4"))})})})};c()}if(r.querySelectorAll(".permission-checkbox").forEach(c=>{if(c.addEventListener("change",p=>{const b=p.target.nextElementSibling,m=b.nextElementSibling;p.target.checked?(b.classList.replace("bg-slate-200","bg-indigo-500"),m.classList.add("transform","translate-x-4")):(b.classList.replace("bg-indigo-500","bg-slate-200"),m.classList.remove("transform","translate-x-4"))}),c.checked){const p=c.nextElementSibling,b=p.nextElementSibling;p.classList.replace("bg-slate-200","bg-indigo-500"),b.classList.add("transform","translate-x-4")}}),r.onsubmit=async c=>{c.preventDefault();const p=r.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Processando...';const m={};r.querySelectorAll(".permission-checkbox").forEach(S=>{const I=S.dataset.module,N=S.dataset.permission;m[I]||(m[I]={}),m[I][N]=S.checked});const h=r.querySelector("#userProfessionalId").value||null,y=r.querySelector("#userRole")?.value||"professional",w=[],M=[];if(y!=="group_admin"&&y!=="owner"&&r.querySelector(".company-checkbox")&&(r.querySelectorAll(".company-checkbox:checked").forEach(S=>{w.push({id:S.value,name:S.dataset.name})}),r.querySelectorAll(".branch-checkbox:checked").forEach(S=>{M.push({id:S.value,name:S.dataset.name,companyId:S.dataset.companyId})}),M.length===0))return p.disabled=!1,p.innerHTML=b,f("Atenção","Selecione pelo menos uma filial na aba de Acesso.","warning");const B={name:r.querySelector("#userName").value,permissions:m,professionalId:h,role:y,accessibleCompanies:w,accessibleEstablishments:M};try{if(s){const S=r.querySelector("#userEmail").value;t?.email!==S&&!i&&(B.email=S),await Rd(t.id,B),f("Sucesso","Usuário atualizado.","success")}else B.email=r.querySelector("#userEmail").value,B.password=r.querySelector("#userPassword").value,await Nd(B),f("Sucesso","Novo usuário cadastrado na plataforma.","success");ga()}catch(S){f(`Erro: ${S.message}`,"error"),p.disabled=!1,p.innerHTML=b}},s){const c=r.querySelector("#btn-show-password"),p=r.querySelector("#password-form");c&&p&&(c.onclick=()=>{c.classList.add("hidden"),p.classList.remove("hidden")},r.querySelector("#btn-cancel-pwd").onclick=()=>{c.classList.remove("hidden"),p.classList.add("hidden"),p.querySelector("#userNewPassword").value=""},r.querySelector("#btn-save-pwd").onclick=async b=>{const m=b.target,h=p.querySelector("#userNewPassword").value;if(!h||h.length<6)return f("Aviso","Senha deve ter no mínimo 6 caracteres.","warning");if(await Q("Alterar Senha","O usuário usará esta nova senha no próximo acesso. Confirma?"))try{m.disabled=!0,m.textContent="Aguarde...",await Hd(t.id,h),f("Sucesso","Senha alterada com segurança.","success"),c.classList.remove("hidden"),p.classList.add("hidden")}catch(y){f("Erro",y.message,"error")}finally{m.disabled=!1,m.textContent="Salvar Senha"}})}}async function Xs(){const t=document.getElementById("usersListContainer");if(t){t.innerHTML='<div class="col-span-full py-16 flex justify-center"><div class="loader"></div></div>';try{const e=vi(),a=e.map(l=>jd(l)),s=e.map(l=>Ie(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),g.users=Array.from(r.values());const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),g.professionals=Array.from(n.values()),yi()}catch{f("Erro ao carregar base de usuários.","error"),t.innerHTML='<p class="col-span-full text-center font-bold text-red-500 bg-red-50 p-6 rounded-2xl">Falha de comunicação com o servidor de acessos.</p>'}}}async function ga(){bt.innerHTML=`
    ...
    `,Jt&&bt.removeEventListener("click",Jt),Qt&&bt.removeEventListener("change",Qt),We&&(window.removeEventListener("kairos:contextChanged",We),document.removeEventListener("change",We)),We=t=>{(t.type==="kairos:contextChanged"||t.target.closest("#multi-context-list"))&&document.getElementById("user-list-view")&&!document.getElementById("user-list-view").classList.contains("hidden")&&Xs()},window.addEventListener("kairos:contextChanged",We),document.addEventListener("change",We),Jt=async t=>{const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":Ys();break;case"edit-user":const s=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));Ys(s);break;case"back-to-list":ga();break;case"delete-user":{if(t.stopPropagation(),await Q("Excluir Usuário","O usuário perderá totalmente o acesso ao sistema. Confirma?"))try{await Fd(e.dataset.userId),f("Usuário excluído com sucesso.","success"),ga()}catch(i){f(`Erro: ${i.message}`,"error")}break}}},Qt=async t=>{if(t.target.id==="showInactiveUsersToggle"){const e=t.target.nextElementSibling,a=e.nextElementSibling;t.target.checked?(e.classList.replace("bg-slate-200","bg-indigo-500"),a.classList.add("transform","translate-x-5")):(e.classList.replace("bg-indigo-500","bg-slate-200"),a.classList.remove("transform","translate-x-5")),yi()}else{const e=t.target.closest('input[data-action="toggle-user-status"]');if(e){t.stopPropagation();const a=e.dataset.userId,s=e.checked?"active":"inactive",i=e.nextElementSibling,o=i.nextElementSibling;e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"));try{await Od(a,s);const r=g.users.findIndex(n=>n.id===a);if(r>-1){g.users[r].status=s;const n=e.closest(".user-card-clickable");s==="inactive"?n.classList.add("opacity-60","bg-slate-50"):n.classList.remove("opacity-60","bg-slate-50")}}catch(r){f(`Erro: ${r.message}`,"error"),e.checked=!e.checked,e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"))}}}},bt.addEventListener("click",Jt),bt.addEventListener("change",Qt),await Xs()}const Wd=document.getElementById("content");let Zs={},rs=null;function Jd(){Object.values(Zs).forEach(t=>t?.destroy()),Zs={}}function Qd(t,e){if(!window.jspdf){f("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),i=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(t,s.internal.pageSize.getWidth()/2,40,{align:"center"}),i){const r=[["Receita Total",i.querySelector("#summary-revenue").textContent],["Vendas Totais",i.querySelector("#summary-transactions").textContent],["Ticket Médio",i.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:r,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${e}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Ks(t){const e=document.getElementById("genericModal"),a=v(t.client),s=v(t.items),i=v(t.responsavelCaixa||"N/A"),o=(t.payments||[]).map(r=>`
    ...
    `,e.style.display="flex"}function Gd(t){const{summary:e,transactions:a}=t;document.getElementById("summary-revenue").textContent=`R$ ${e.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=e.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${e.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),i=Object.entries(e.paymentMethodTotals).sort(([,n],[,l])=>l-n);s.innerHTML=i.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=rs.transactions[l];d&&Ks(d)})}),r.innerHTML=a.map((n,l)=>{const d=v(n.client),u=v(n.items),c=v(n.type);return`
    ...
    `}).join(""),r.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=rs.transactions[l];d&&Ks(d)})})}async function eo(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,i=a.value;if(!s||!i)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,r=await la({establishmentId:g.establishmentId,startDate:s,endDate:i,cashierSessionId:o});rs=r,t.innerHTML=`
        ...
        `,Gd(r)}catch(o){f("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function Yd(){Jd();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];Wd.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",eo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,i=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${i}`;Qd(o,"transactionsTable")});try{const s=await Dn(g.establishmentId),i=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const r=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=v(o.closedByName||"N/A");i.innerHTML+=`<option value="${o.id}">${n} - ${r}</option>`})}catch{f("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await eo()}const Xd=document.getElementById("content");let k={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],suppliers:[],clients:[],professionals:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Gt=null,Yt=null;function Es(t){const e=new Map,a=[];return t&&(t.forEach(s=>e.set(s.id,{...s,children:[]})),e.forEach(s=>{s.parentId&&e.has(s.parentId)?e.get(s.parentId).children.push(s):a.push(s)})),a}function wi(t){if(!t)return{day:"--",month:"---",full:"--/--/----"};const[e,a,s]=t.split("-"),i=new Date(e,a-1,s),o=String(i.getDate()).padStart(2,"0"),r=i.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:o,month:r,full:i.toLocaleDateString("pt-BR")}}function ve(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t)}function rt(t,e){if(e==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,i,o]=t.split("-");return new Date(s,i-1,o)<a}function Zd(t,e,a){if(!t)return;if(!e||e.length===0){t.innerHTML=`
        ...
        `};t.innerHTML=e.map(i=>s(i)).join("")}async function to(t){const e=document.getElementById("genericModal"),a=t==="nature",s=a?"Plano de Naturezas":"Centros de Custo",i=a?$a:bs,o=a?Vr:Ur,r=a?"natures":"costCenters";e.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",e.innerHTML=`
        ...
        </div>`,e.style.display="flex",requestAnimationFrame(()=>{e.classList.remove("opacity-0");const c=e.querySelector("#modal-content-wrapper");c&&(c.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),c.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const n=e.querySelector("#hierarchyList"),l=e.querySelector("#itemParent"),d=c=>{const p=Es(c);Zd(n,p,t);const b=l.value;l.innerHTML='<option value="">-- Nível Principal --</option>';const m=(h,y=0)=>{const w="  ".repeat(y)+(y>0?"↳ ":"");l.innerHTML+=`<option value="${h.id}">${w}${v(h.name)}</option>`,h.children.forEach(M=>m(M,y+1))};p.forEach(h=>m(h)),l.value=b};try{const c=await i(g.establishmentId);k[r]=c,d(c)}catch(c){console.error(c)}const u=e.querySelector("#hierarchyForm");u.addEventListener("submit",async c=>{c.preventDefault();const p=e.querySelector("#itemName").value,b=l.value;try{await o({name:p,parentId:b||null,establishmentId:g.establishmentId});const m=await i(g.establishmentId);k[r]=m,d(m),u.reset(),await Te(),f("Sucesso","Item adicionado à estrutura.","success")}catch(m){f("Erro",m.message,"error")}})}function Mt(){const t=document.getElementById("genericModal");t.classList.add("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-0","md:scale-100","md:opacity-100"),e.classList.add("translate-y-full","md:scale-95","md:opacity-0")),setTimeout(()=>{t.style.display="none",t.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",t.innerHTML=""},300)}async function Kd(){try{const e=(await we()).matrizes||[];k.establishments=[],e.forEach(a=>{k.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>k.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.warn("Erro ao buscar lojas",t)}ki(),Si(),await Te()}function ki(){Xd.innerHTML=`
    ...
    `,$i()}function ec(){const t=k.currentTab==="receivables",e=t?k.receivables:k.payables;let a=e;if(k.statusFilter!=="all"&&(a=e.filter(n=>{const l=rt(n.dueDate,n.status);return k.statusFilter==="overdue"?l:k.statusFilter==="pending"?n.status==="pending"&&!l:n.status===k.statusFilter})),k.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(k.searchQuery)||n.entity&&n.entity.toLowerCase().includes(k.searchQuery)||n.notes&&n.notes.toLowerCase().includes(k.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map(k.natures.map(n=>[n.id,n.name])),i=new Map(k.costCenters.map(n=>[n.id,n.name])),o=new Map(k.establishments.map(n=>[n.id,n])),r=a.map(n=>{const l=n.status==="paid",d=rt(n.dueDate,n.status);let u=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const c=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?i.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=o.get(n.establishmentId),m=b?b.name:"Atual",h=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:m,Natureza:c,"Centro de Custo":p,Origem:h,"Documento / NFS":n.documentNumber||"",Status:u,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(r),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const u=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,u)}catch(n){console.error("Erro ao exportar:",n),f("Erro","Não foi possível exportar para Excel.","error")}}function tc(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i.bi-chevron-expand, i.bi-chevron-up, i.bi-chevron-down");if(!e)return;t.dataset.sort===k.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=k.sortAsc?"bi bi-chevron-up ml-1 text-indigo-600 text-[11px] font-black":"bi bi-chevron-down ml-1 text-indigo-600 text-[11px] font-black"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-chevron-expand ml-1 opacity-40 text-[10px] font-black")})}function Si(){document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",r=>{const n=r.currentTarget.dataset.sort;k.sortCol===n?k.sortAsc=!k.sortAsc:(k.sortCol=n,k.sortAsc=!0),It()})});const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");k.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&k.selectedIds.add(l.value)}),Ze()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{k.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Ze()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=k.selectedIds.size;if(o===0)return;if(await Q("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const n=k.currentTab==="payables"?"payables":"receivables";await qo(n,Array.from(k.selectedIds)),f("Sucesso",`${o} itens excluídos.`,"success"),k.selectedIds.clear(),Ze(),Te()}catch{f("Erro","Falha ao excluir itens.","error")}}),document.getElementById("custom-date-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");k.isAdvancedFilterOpen=!k.isAdvancedFilterOpen,k.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))});const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",ec);const a=document.getElementById("settings-btn");a&&a.addEventListener("click",oc),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(20),so(r.target.closest("button").dataset.type)})});const s=document.getElementById("tab-receivables"),i=document.getElementById("tab-payables");s.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),ao("receivables")}),i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),ao("payables")}),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-gray-900","bg-blue-600","bg-emerald-600","bg-red-600","text-white"),l.classList.add("bg-white","text-gray-600")});const n=r.target.dataset.status;n==="all"?r.target.classList.add("bg-gray-900","text-white"):n==="pending"?r.target.classList.add("bg-blue-600","text-white"):n==="paid"?r.target.classList.add("bg-emerald-600","text-white"):n==="overdue"&&r.target.classList.add("bg-red-600","text-white"),r.target.classList.remove("bg-white","text-gray-600"),k.statusFilter=n,It()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=u.toISOString().split("T")[0],k.startDate=d.toISOString().split("T")[0],k.endDate=u.toISOString().split("T")[0],Te()})}),document.getElementById("searchInput").addEventListener("input",o=>{k.searchQuery=o.target.value.toLowerCase(),It()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",ki(),Si(),Te()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(20),k.startDate=document.getElementById("filterStartDate").value,k.endDate=document.getElementById("filterEndDate").value,k.filterNaturezaId=document.getElementById("filterNaturezaId").value,k.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("custom-date-btn").click(),Te()}),Gt&&document.body.removeEventListener("click",Gt),Gt=o=>{const r=o.target;if(r.classList.contains("item-checkbox")||r.classList.contains("modal-item-checkbox")){const d=r.value||r.dataset.id;r.checked?k.selectedIds.add(d):k.selectedIds.delete(d),Ze(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){const{action:d,type:u,id:c}=n.dataset;if(d==="mark-as-paid"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),ac(u,c);return}if(d==="delete"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(30);const p=n.closest(".financial-row").dataset.item;try{Ei(u,JSON.parse(decodeURIComponent(p)))}catch(b){console.error("Parse error on delete",b)}return}if(d==="manage-natures"){o.stopPropagation(),to("nature");return}if(d==="manage-cost-centers"){o.stopPropagation(),to("cost-center");return}if(d==="close-modal"){o.stopPropagation(),Mt();return}}const l=r.closest(".financial-row");if(l&&document.getElementById("list-container").contains(l)&&!r.closest("button")&&!r.closest(".item-checkbox")){navigator.vibrate&&navigator.vibrate(15);const{type:d}=l.dataset;try{const u=JSON.parse(decodeURIComponent(l.dataset.item));so(d,u)}catch(u){console.error("Parse error on card click",u),f("Erro","Os dados deste lançamento não puderam ser lidos corretamente.","error")}}},document.body.addEventListener("click",Gt),Yt&&document.getElementById("genericModal").removeEventListener("click",Yt),Yt=o=>{const r=o.target.closest('button[data-action^="delete-"]');if(r){const n=r.dataset.action.split("-")[1];handleDeleteHierarchyItem(n,r.dataset.id)}o.target===document.getElementById("genericModal")&&Mt()},document.getElementById("genericModal").addEventListener("click",Yt)}function Ze(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=k.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}function ao(t){k.currentTab=t,k.selectedIds.clear(),Ze(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t==="receivables"?(e.classList.add("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.remove("text-gray-500"),a.classList.remove("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.add("text-gray-500")):(a.classList.add("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.remove("text-gray-500"),e.classList.remove("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.add("text-gray-500")),It(),Ii()}async function Te(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A sincronizar carteira...</p></div>';try{if(k.natures.length===0){const[r,n,l,d,u]=await Promise.all([$a(g.establishmentId),bs(g.establishmentId),Tt(g.establishmentId).catch(()=>[]),dt(g.establishmentId,"",1e3).catch(()=>[]),Ie(g.establishmentId).catch(()=>[])]);k.natures=r||[],k.costCenters=n||[],k.suppliers=l||[],k.clients=d||[],k.professionals=u||[],$i()}const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(","),s={startDate:k.startDate,endDate:k.endDate,establishmentId:a};k.filterNaturezaId!=="all"&&(s.natureId=k.filterNaturezaId),k.filterCostCenterId!=="all"&&(s.costCenterId=k.filterCostCenterId);const[i,o]=await Promise.all([ms(s),Ia(s)]);k.payables=i.entries||[],k.receivables=o.entries||[],Ii(),It()}catch(e){t.innerHTML=`
            ...
            </div>`}}function $i(){const t=s=>{let i='<option value="all">Todas as categorias</option>';const o=Es(s),r=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");i+=`<option value="${n.id}">${d}${v(n.name)}</option>`,n.children.forEach(u=>r(u,l+1))};return o.forEach(n=>r(n)),i},e=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");e&&(e.innerHTML=t(k.natures)),a&&(a.innerHTML=t(k.costCenters))}function Ii(){const t=document.getElementById("summary-section");if(!t)return;const e=k.currentTab==="receivables";let s=e?k.receivables:k.payables;k.searchQuery&&(s=s.filter(u=>u.description&&u.description.toLowerCase().includes(k.searchQuery)||u.entity&&u.entity.toLowerCase().includes(k.searchQuery)||u.notes&&u.notes.toLowerCase().includes(k.searchQuery)));const i=s.reduce((u,c)=>u+c.amount,0),o=s.filter(u=>u.status==="paid").reduce((u,c)=>u+c.amount,0),r=s.filter(u=>u.status==="pending"&&!rt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),n=s.filter(u=>rt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),l=e?"emerald":"red",d=e?"bi-arrow-down-left-circle-fill text-emerald-500":"bi-arrow-up-right-circle-fill text-red-500";t.innerHTML=`
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${ve(i)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-blue-600">${ve(r)}</span>
        </div>
    ...
    `}function It(){const t=document.getElementById("list-container");if(!t)return;const e=k.currentTab==="receivables",a=e?k.receivables:k.payables;let s=a;if(k.statusFilter!=="all"&&(s=a.filter(c=>{const p=rt(c.dueDate,c.status);return k.statusFilter==="overdue"?p:k.statusFilter==="pending"?c.status==="pending"&&!p:c.status===k.statusFilter})),k.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(k.searchQuery)||c.entity&&c.entity.toLowerCase().includes(k.searchQuery)||c.notes&&c.notes.toLowerCase().includes(k.searchQuery))),s.sort((c,p)=>{let b=c[k.sortCol],m=p[k.sortCol];return k.sortCol==="dueDate"?(b=new Date(b).getTime(),m=new Date(m).getTime()):(k.sortCol==="description"||k.sortCol==="status")&&(b=b?b.toLowerCase():"",m=m?m.toLowerCase():""),b<m?k.sortAsc?-1:1:b>m?k.sortAsc?1:-1:0}),tc(),s.length===0){t.innerHTML=`
        ...
        `;return}const i=new Map(k.natures.map(c=>[c.id,c.name])),o=new Map(k.costCenters.map(c=>[c.id,c.name])),r=new Map(k.establishments.map(c=>[c.id,c])),n=e?"receivable":"payable",l=e?"text-emerald-600":"text-red-600",d=e?'<i class="bi bi-arrow-down-left-circle-fill text-emerald-500 text-2xl drop-shadow-sm"></i>':'<i class="bi bi-arrow-up-right-circle-fill text-red-500 text-2xl drop-shadow-sm"></i>',u=e?'<i class="bi bi-arrow-down-left-circle-fill text-emerald-500 text-lg"></i>':'<i class="bi bi-arrow-up-right-circle-fill text-red-500 text-lg"></i>';t.innerHTML=s.map(c=>{const p=wi(c.dueDate),b=c.status==="paid",m=rt(c.dueDate,c.status);let h="";b?h='<span class="text-[9px] md:text-[10px] font-black text-emerald-600 bg-emerald-50 px-2 md:px-2.5 py-1 rounded-lg uppercase tracking-widest"><i class="bi bi-check2-circle"></i> Baixado</span>':m?h='<span class="text-[9px] md:text-[10px] font-black text-red-600 bg-red-50 px-2 md:px-2.5 py-1 rounded-lg uppercase tracking-widest"><i class="bi bi-exclamation-circle"></i> Atraso</span>':h='<span class="text-[9px] md:text-[10px] font-black text-blue-600 bg-blue-50 px-2 md:px-2.5 py-1 rounded-lg uppercase tracking-widest"><i class="bi bi-clock"></i> Pendente</span>';const y=c.naturezaId&&i.get(c.naturezaId)||"Geral",w=c.centroDeCustoId&&o.get(c.centroDeCustoId)||"Geral",M=r.get(c.establishmentId);let B="";if(M){const C=M.type==="Matriz"?"bi-building":"bi-shop";B=`<span class="text-[9px] font-bold text-gray-600 bg-gray-50 px-2 py-1 rounded-lg border border-gray-200 flex items-center max-w-[110px] truncate leading-none shadow-sm" title="${v(M.name)}"><i class="bi ${C} mr-1 opacity-60"></i> ${v(M.name)}</span>`}const S=encodeURIComponent(JSON.stringify(c)),I=k.selectedIds.has(c.id),U=!!c.recurrenceId?'<i class="bi bi-arrow-repeat text-indigo-600 ml-1 text-sm md:text-base bg-indigo-50 rounded-full w-5 h-5 md:w-6 md:h-6 flex items-center justify-center shadow-sm" title="Recorrente"></i>':"";return`
        <div class="financial-row bg-white border border-gray-100 md:border-0 md:border-b md:border-gray-100 hover:bg-gray-50 transition-all cursor-pointer relative flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center p-3.5 md:px-6 md:py-4 mb-3 md:mb-0 rounded-2xl md:rounded-none ${I?"ring-2 md:ring-0 ring-indigo-500 bg-indigo-50/50 md:bg-indigo-50/50":""} ${b?"opacity-70 md:opacity-100":""}"
            ...
            <div class="hidden md:flex md:col-span-2 flex-col justify-center min-w-0 pr-4 gap-1.5">
                ...
                <span class="text-[10px] font-semibold text-gray-500 truncate w-max max-w-full"><i class="bi bi-diagram-3 opacity-50 mr-1.5"></i>${w}</span>
            </div>
        ...
        `}).join("")}async function ac(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?Qr(e,a):Zr(e,a)),f("Baixa Realizada","O lançamento foi registado como pago.","success"),await Te()}catch(s){f("Erro",s.message,"error")}}async function Ei(t,e){if(!!!e.recurrenceId){await Q("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Li(t,[e.id]);return}sc(t,e)}function sc(t,e){const a=document.getElementById("genericModal"),i=(t==="payable"?k.payables:k.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,u)=>new Date(d.dueDate)-new Date(u.dueDate));a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",a.innerHTML=`
        <div id="modal-content-wrapper" class="w-full md:max-w-2xl bg-gray-50 md:bg-white flex flex-col transform transition-all duration-300 translate-y-full md:translate-y-0 md:scale-95 md:opacity-0 h-full md:h-auto md:max-h-[90vh] rounded-t-3xl md:rounded-3xl overflow-hidden shadow-2xl relative" style="font-family: 'Plus Jakarta Sans', 'Nunito', sans-serif;">
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar bg-gray-50 pb-safe md:pb-4">
                ${i.map(d=>{const u=d.id===e.id,c=d.status==="paid",p=wi(d.dueDate);return`
    ...
    `,t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function so(t,e=null){const a=document.getElementById("genericModal"),s=t==="payable",i=s?"red":"emerald",o=e?"Editar Lançamento":"Novo Lançamento",r=(C,D)=>{let V='<option value="">-- Categoria --</option>';const P=Es(C),T=(F,X=0)=>{const te="  ".repeat(X)+(X>0?"↳ ":""),re=F.id===D?"selected":"";V+=`<option value="${F.id}" ${re}>${te}${v(F.name)}</option>`,F.children.forEach(Z=>T(Z,X+1))};return P.forEach(F=>T(F)),V},l=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(C=>`<option value="${C.value}" ${e?.paymentMethod===C.value?"selected":""}>${C.label}</option>`).join(""),d=`
        <datalist id="entity-suggestions">
            ${s?k.suppliers.map(C=>`<option value="${v(C.name)}">Fornecedor</option>`).join("")+k.professionals.map(C=>`<option value="${v(C.name)}">Profissional</option>`).join(""):k.clients.map(C=>`<option value="${v(C.name)} ${C.phone?"- "+v(C.phone):""}">Cliente</option>`).join("")}
        </datalist>
    `,u=e?.establishmentId||g.selectedEstablishments&&g.selectedEstablishments[0]||g.establishmentId,c=k.establishments.map(C=>{const D=C.id===u;return`<option value="${C.id}" ${D?"selected":""}>${C.type==="Matriz"?"🏢":"📍"} ${v(C.name)}</option>`}).join("");a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 md:p-6",a.innerHTML=`
        ${d}
                        ...
                        <div class="grid grid-cols-1 md:col-span-2 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="centroDeCustoId" class="w-full py-3 px-4 bg-gray-50 focus:bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-${i}-500 outline-none text-sm font-bold text-gray-700 transition-all shadow-sm">
                                    ${r(k.costCenters,e?.centroDeCustoId)}
                                </select>
                            </div>
                        </div>
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const C=a.querySelector("#modal-content-wrapper");C&&(C.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),C.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let b="single",m=2;const h=p.querySelector("#modal-delete-btn");h&&h.addEventListener("click",C=>{C.preventDefault(),navigator.vibrate&&navigator.vibrate(30),Mt(),setTimeout(()=>Ei(t,e),300)});const y=p.querySelector('[name="amount"]'),w=p.querySelector("#recurrence-options"),M=p.querySelector("#recurrence-summary"),B=p.querySelector("#installments-input"),S=p.querySelector("#status-toggle"),I=p.querySelector("#payment-date-wrapper"),N=p.querySelector('[name="paymentDate"]'),U=()=>{if(b==="single")return;const C=parseFloat(y.value)||0;if(m=parseInt(B.value)||2,C===0){M.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(b==="installment"){const D=C/m;M.innerHTML=`
                <div>
            ...
            `}};p.addEventListener("click",C=>{const D=C.target.closest(".mode-btn");if(D&&!e)if(C.preventDefault(),navigator.vibrate&&navigator.vibrate(15),p.querySelectorAll(".mode-btn").forEach(T=>{T.classList.remove("bg-white","text-gray-900","shadow-sm"),T.classList.add("text-gray-500")}),D.classList.add("bg-white","text-gray-900","shadow-sm"),D.classList.remove("text-gray-500"),b=D.dataset.mode,b==="single")w.style.display="none";else{w.style.display="block";const T=w.querySelector("#recurrence-label");T&&(T.textContent=b==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),U()}if(C.target.closest("#btn-minus")&&B){C.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let T=parseInt(B.value)||2;T>2&&(B.value=T-1,U())}if(C.target.closest("#btn-plus")&&B){C.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let T=parseInt(B.value)||2;T<60&&(B.value=T+1,U())}}),y.addEventListener("input",U),B&&B.addEventListener("input",U),S.addEventListener("change",()=>{navigator.vibrate&&navigator.vibrate(20),S.checked?(I.classList.remove("hidden"),N.required=!0):(I.classList.add("hidden"),N.required=!1)}),p.addEventListener("submit",async C=>{C.preventDefault();const D=p.querySelector('button[type="submit"]'),V=D.innerHTML;D.disabled=!0,D.innerHTML='<div class="loader mx-auto h-5 w-5 border-2 border-white border-t-transparent"></div>';const P=new FormData(p),T=S.checked,F=parseFloat(P.get("amount"));let X=F,te=1;!e&&b!=="single"&&(te=parseInt(P.get("installments")),b==="repeat"&&(X=F*te));const re=P.get("establishmentId");if(!re){f("Atenção","Selecione uma Unidade válida para o lançamento.","warning"),D.disabled=!1,D.innerHTML=V;return}const Z={companyId:g.companyId,establishmentId:re,description:P.get("description"),amount:X,dueDate:P.get("dueDate"),naturezaId:P.get("naturezaId")||null,centroDeCustoId:P.get("centroDeCustoId")||null,entity:P.get("entity")||null,paymentMethod:P.get("paymentMethod")||null,documentNumber:P.get("documentNumber")||null,notes:P.get("notes"),status:T?"paid":"pending",paymentDate:T?P.get("paymentDate"):null,installments:te};te>1&&!e&&(Z.recurrenceId=self.crypto.randomUUID());try{e?(await(s?Wr(e.id,Z):Yr(e.id,Z)),f("Sucesso","Atualizado com sucesso!","success")):(await(s?No(Z):Gr(Z)),f("Sucesso","Lançamento criado!","success")),Mt(),Te()}catch(j){f("Erro",j.message||"Erro ao salvar","error"),D.disabled=!1,D.innerHTML=V}})}const ic=t=>L("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),rc=t=>L("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),nc=(t,e)=>{const a=new URLSearchParams({startDate:t,endDate:e}).toString();return L(`/api/commissions/stats?${a}`)},lc=(t={})=>{Object.keys(t).forEach(s=>(t[s]===void 0||t[s]===null||t[s]==="")&&delete t[s]);const e=new URLSearchParams(t).toString(),a=`/api/commissions/history${e?"?"+e:""}`;return L(a)},Ci=t=>L(`/api/commissions/report/${t}`,{method:"DELETE"}),fa=new Date,dc=new Date(fa.getFullYear(),fa.getMonth(),1);let R={professionals:[],reports:[],calculationResult:null,periodString:"",establishmentConfig:null,selectedIds:new Set,isAdvancedFilterOpen:!1,startDate:dc.toISOString().split("T")[0],endDate:new Date(fa.getFullYear(),fa.getMonth()+1,0).toISOString().split("T")[0],professionalId:"all",searchQuery:"",stats:{revenue:0,commissions:0,margin:0,netPaid:0},viewMode:"list"},Xt=null;const cc=document.getElementById("content");function Et(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function uc(t){return t?new Date(t).toLocaleDateString("pt-BR"):"--/--/----"}function xa(t){if(!t)return"PR";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()}function Di(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="none"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&window.innerWidth<768&&(a.style.display="none")}function Ls(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="flex"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&window.innerWidth<768&&(a.style.display=""),R.viewMode="list"}async function pc(){try{const[t,e]=await Promise.all([Ie(g.establishmentId),Ae(g.establishmentId).catch(()=>({}))]);R.professionals=t,R.establishmentConfig=e||{}}catch(t){console.error("Erro na inicialização de comissões",t)}R.viewMode="list",bc(),gc(),await nt()}function bc(){const t=R.professionals.map(e=>`<option value="${e.id}">${e.name}</option>`).join("");cc.innerHTML=`
        <style>
    ...
    `}async function nt(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">Carregando comissões...</p></div>');const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(",");try{const[s,i]=await Promise.all([lc({startDate:R.startDate,endDate:R.endDate,professionalId:R.professionalId,establishmentId:a}),nc(R.startDate,R.endDate,a)]);R.reports=s||[];const o=R.reports.reduce((r,n)=>r+(n.summary.finalValue||n.summary.totalCommission),0);R.stats={revenue:i.totalRevenue||0,commissions:i.totalCommissionsPaid||0,margin:i.totalRevenue>0?((i.totalRevenue-i.totalCommissionsPaid)/i.totalRevenue*100).toFixed(1):0,netPaid:o},R.selectedIds.clear(),Lt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),mc(),Pi()}catch(s){console.error(s),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
                <p class="text-gray-600 text-sm font-medium">Erro ao carregar dados.</p>
            </div>`)}}function mc(){const t=document.getElementById("kpi-section");t&&(t.innerHTML=`
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${Et(R.stats.revenue)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-amber-600">${Et(R.stats.commissions)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-emerald-600">${Et(R.stats.netPaid)}</span>
        </div>
    `)}function Pi(){const t=document.getElementById("list-container");if(!t)return;let e=R.reports;if(R.searchQuery){const a=R.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=e.map(a=>{const s=uc(a.createdAt),i=a.summary.totalCommission,o=a.summary.extraDebit||0,r=a.summary.extraCredit||0,n=a.summary.finalValue||i,l=R.selectedIds.has(a.id);let d="";return o>0&&r>0?d=`<span class="text-red-500">-R$${o.toFixed(2)}</span> / <span class="text-emerald-500">+R$${r.toFixed(2)}</span>`:o>0?d=`<span class="text-red-500">-R$ ${o.toFixed(2)}</span>`:r>0?d=`<span class="text-emerald-500">+R$ ${r.toFixed(2)}</span>`:d='<span class="text-gray-300">--</span>',`
        <div class="bg-white border border-gray-100 md:border-0 md:border-b md:border-gray-100 hover:bg-gray-50 transition-all cursor-pointer relative flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center p-4 md:px-6 md:py-4 mb-3 md:mb-0 rounded-2xl md:rounded-none ${l?"ring-2 md:ring-0 ring-indigo-500 bg-indigo-50/50 md:bg-indigo-50/50":""}">
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:block mb-1.5 md:mb-0">
                ...
                <span class="text-sm font-bold text-gray-700">${Et(i)}</span>
            </div>
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:block pt-2 md:pt-0 border-t md:border-0 border-gray-100 mt-2 md:mt-0">
                ...
                <span class="text-base font-black text-emerald-600">${Et(n)}</span>
            </div>
        ...
        `}).join("")}function gc(){Xt&&document.body.removeEventListener("click",Xt),Xt=o=>{const r=o.target;if(r.classList.contains("item-checkbox")){const l=r.value;r.checked?R.selectedIds.add(l):R.selectedIds.delete(l),Lt(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){o.preventDefault();const l=n.dataset.action,d=n.dataset.id;switch(l){case"apply-filters":R.startDate=document.getElementById("filter-start").value,R.endDate=document.getElementById("filter-end").value,R.professionalId=document.getElementById("filter-prof").value,document.getElementById("custom-date-btn")?.click(),nt();break;case"new-calculation":fc();break;case"print-receipt":$c(d);break;case"delete-report":Ec(d);break;case"view-report-details":kc(d);break;case"close-detail-screen":Ls();break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),c=Array.from(u).every(h=>h.checked);u.forEach(h=>h.checked=!c);break;case"calculate-preview":xc();break;case"save-final-reports":wc();break;case"toggle-preview-details":const p=n.dataset.idx,b=document.getElementById(`preview-details-${p}`),m=n.querySelector("i");b&&(b.classList.contains("hidden")?(b.classList.remove("hidden"),m&&m.classList.replace("bi-chevron-down","bi-chevron-up")):(b.classList.add("hidden"),m&&m.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",Xt);const t=document.getElementById("search-input");t&&t.addEventListener("input",o=>{R.searchQuery=o.target.value,Pi()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&vc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");R.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&R.selectedIds.add(l.value)}),Lt()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{R.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Lt()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",Ic);const i=document.getElementById("export-excel-btn");i&&i.addEventListener("click",Sc),document.getElementById("custom-date-btn")?.addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");R.isAdvancedFilterOpen=!R.isAdvancedFilterOpen,R.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filter-start").value=d.toISOString().split("T")[0],document.getElementById("filter-end").value=u.toISOString().split("T")[0],R.startDate=d.toISOString().split("T")[0],R.endDate=u.toISOString().split("T")[0],nt()})})}function Lt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=R.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function fc(){R.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=R.professionals.map(o=>`
    ...
    `,Di()}async function xc(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(u=>u.value);if(t.length===0)return f("Atenção","Selecione pelo menos um profissional.","warning");const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(","),s=document.getElementById("calc-start-date"),i=document.getElementById("calc-end-date");if(!s||!i||!s.value||!i.value)return f("Atenção","As datas de início e fim são obrigatórias.","warning");const o={professionalIds:t,startDate:s.value,endDate:i.value,establishmentId:a,calculationTypes:{services:document.getElementById("calc-type-services")?.checked||!1,products:document.getElementById("calc-type-products")?.checked||!1,packages:document.getElementById("calc-type-packages")?.checked||!1}},r=new Date(o.startDate+"T00:00:00").toLocaleDateString("pt-BR"),n=new Date(o.endDate+"T00:00:00").toLocaleDateString("pt-BR");R.periodString=`${r} a ${n}`;const l=document.getElementById("btn-calc-action"),d=l.innerHTML;l.innerHTML='<div class="loader-small border-white mr-2"></div> Processando...',l.disabled=!0;try{const u=await ic(o);R.calculationResult=u.map(c=>({...c,extraDebit:0,extraCredit:0,finalValue:c.summary.totalCommission,notes:""})),hc()}catch(u){f("Erro na Apuração",u.message,"error"),l.innerHTML=d,l.disabled=!1}}function hc(){R.viewMode="preview-calc";const t=R.calculationResult;if(!t||t.length===0||t.every(r=>r.summary.totalCommission===0)){f("Aviso","Nenhuma comissão encontrada para os filtros selecionados.","info");const r=document.getElementById("btn-calc-action");r.innerHTML='<i class="bi bi-calculator text-lg"></i> Calcular Vendas',r.disabled=!1;return}const e=document.getElementById("calc-step-1"),a=document.getElementById("calc-step-2"),s=document.getElementById("btn-calc-action");e&&e.classList.add("hidden"),a&&a.classList.remove("hidden"),s&&(s.dataset.action="save-final-reports",s.className="w-full md:w-auto py-3.5 px-8 bg-emerald-600 text-white font-black text-sm rounded-xl hover:bg-emerald-700 shadow-md transition-transform active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider",s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1);const i=t.reduce((r,n)=>r+n.finalValue,0),o=t.map((r,n)=>{if(r.summary.totalCommission===0)return"";const l=(r.items||[]).map(u=>`
        ...
        ${o}
    `)}function vc(t){const e=document.querySelector(`.input-debit[data-idx="${t}"]`),a=document.querySelector(`.input-credit[data-idx="${t}"]`),s=document.querySelector(`.input-notes[data-idx="${t}"]`);let i=parseFloat(e?.value)||0,o=parseFloat(a?.value)||0,r=s?.value||"";if(R.calculationResult&&R.calculationResult[t]){const n=R.calculationResult[t];n.extraDebit=i,n.extraCredit=o,n.notes=r,n.finalValue=n.summary.totalCommission-i+o;const l=document.querySelector(`.final-value-display[data-idx="${t}"]`);l&&(l.innerText=`R$ ${n.finalValue.toFixed(2)}`),yc()}}function yc(){const t=R.calculationResult.reduce((a,s)=>a+s.finalValue,0),e=document.getElementById("grand-total-preview");e&&(e.innerText=`R$ ${t.toFixed(2)}`)}async function wc(){const t=R.calculationResult.filter(i=>i.summary.totalCommission>0),e=t.length;if(e===0)return f("Aviso","Não há valores para pagar.","info");if(!await Q("Confirmar Pagamentos",`Você está prestes a gerar recibos e marcar as vendas de ${e} profissional(is) como PAGAS. Essa ação lançará a despesa correspondente no Financeiro. Confirmar?`))return;const s=document.getElementById("btn-calc-action");s.innerHTML='<div class="loader-small border-white mr-2"></div> Finalizando...',s.disabled=!0;try{const i=t.map(async o=>{const r=(o.items||[]).map(n=>n.originalSaleId).filter(n=>n!=null);await rc({professionalId:o.professionalId,professionalName:o.professionalName,period:R.periodString,processedSalesIds:r,establishmentId:g.establishmentId,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}});try{if(o.finalValue>0){const n=R.establishmentConfig||{},l=n.defaultDespesaNaturezaId||n.financeConfig?.despesaNaturezaId||null,d=n.defaultDespesaCentroCustoId||n.financeConfig?.despesaCentroCustoId||null;await No({establishmentId:g.establishmentId,description:`Comissões - ${o.period}`,amount:o.finalValue,dueDate:new Date().toISOString().split("T")[0],naturezaId:l,centroDeCustoId:d,entity:o.professionalName,paymentMethod:"dinheiro",status:"paid",paymentDate:new Date().toISOString().split("T")[0],origin:"commission"})}}catch(n){console.error("Erro ao integrar com financeiro (Despesa):",n)}});await Promise.all(i),f("Sucesso","Pagamentos registrados e integrados ao financeiro!","success"),R.calculationResult=null,Ls(),await nt()}catch(i){f("Erro ao Salvar",i.message,"error"),s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1}}function kc(t){R.viewMode="report-details";const e=document.getElementById("commissions-layout-detail");if(!e)return;const a=R.reports.find(c=>c.id===t);if(!a)return;const s=a.reportData?.items||a.items||[],i=a.summary,o=i.extraDebit||0,r=i.extraCredit||0,n=i.notes||"",l=`
    ...
    `,Di()}function Sc(){if(R.reports.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}let t=R.reports;if(R.searchQuery){const a=R.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}const e=t.map(a=>{const s=a.summary.totalCommission,i=a.summary.extraDebit||0,o=a.summary.extraCredit||0,r=a.summary.finalValue||s;return{"Data da Apuração":new Date(a.createdAt).toLocaleDateString("pt-BR"),Profissional:a.professionalName,"Período Base":a.period,"Itens Calculados":a.summary.totalItems||0,"Valor Bruto (R$)":s,"Bônus (R$)":o,"Descontos (R$)":i,"Líquido Pago (R$)":r,"Observações/Motivo":a.summary.notes||""}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const a=XLSX.utils.json_to_sheet(e),s=XLSX.utils.book_new();XLSX.utils.book_append_sheet(s,a,"Comissoes");const i=`Relatorio_Comissoes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(s,i)}catch(a){console.error(a),f("Erro","Falha ao exportar Excel.","error")}}function $c(t){const e=R.reports.find(u=>u.id===t);if(!e)return;if(!window.jspdf){f("Erro","A biblioteca de PDF não foi carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a;s.setFillColor(79,70,229),s.rect(0,0,210,40,"F"),s.setTextColor(255,255,255),s.setFontSize(22),s.setFont(void 0,"bold"),s.text("RECIBO DE COMISSÕES",105,20,{align:"center"}),s.setFontSize(10),s.text(`Data de Emissão: ${new Date().toLocaleDateString("pt-BR")}`,105,28,{align:"center"}),s.setTextColor(50,50,50),s.setFontSize(11),s.setFont(void 0,"normal"),s.text("Profissional:",15,55),s.setFont(void 0,"bold"),s.text(e.professionalName,40,55),s.setFont(void 0,"normal"),s.text("Período:",130,55),s.setFont(void 0,"bold"),s.text(e.period,147,55);const i=e.reportData?.items||e.items||[];let o=70;if(i.length>0){const u=i.map(c=>[c.item||"Item",c.client||"--",`R$ ${(c.value||0).toFixed(2)}`,`${c.commissionRate||0}%`,`R$ ${(c.commissionValue||0).toFixed(2)}`]);s.autoTable({startY:o,head:[["Serviço/Produto","Cliente","Valor Base","Taxa","Comissão"]],body:u,theme:"striped",headStyles:{fillColor:[249,250,251],textColor:[75,85,99],fontStyle:"bold"},styles:{fontSize:8},columnStyles:{2:{halign:"right"},3:{halign:"center"},4:{halign:"right",fontStyle:"bold",textColor:[5,150,105]}}}),o=s.lastAutoTable.finalY+15}const r=e.summary,n=r.finalValue||r.totalCommission,l=[["Comissões Brutas (Soma dos Itens)",`R$ ${r.totalCommission.toFixed(2)}`]];r.extraCredit>0&&l.push(["(+) Bônus Extras",`R$ ${r.extraCredit.toFixed(2)}`]),r.extraDebit>0&&l.push(["(-) Descontos / Vales",`R$ ${r.extraDebit.toFixed(2)}`]),s.autoTable({startY:o,head:[["Resumo do Fechamento","Valor"]],body:l,theme:"grid",headStyles:{fillColor:[79,70,229],textColor:[255,255,255]},columnStyles:{1:{halign:"right",fontStyle:"bold"}}});const d=s.lastAutoTable.finalY+15;s.setFillColor(236,253,245),s.rect(120,d-8,75,15,"F"),s.setTextColor(5,150,105),s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${n.toFixed(2)}`,190,d,{align:"right"}),r.notes&&(s.setTextColor(100,100,100),s.setFontSize(9),s.setFont(void 0,"normal"),s.text(`Obs/Motivo: ${r.notes}`,15,d+10)),s.setTextColor(150,150,150),s.setFontSize(9),s.line(20,d+40,90,d+40),s.text("Assinatura da Empresa",55,d+45,{align:"center"}),s.line(120,d+40,190,d+40),s.text("Assinatura do Profissional",155,d+45,{align:"center"}),s.save(`Recibo_Comissoes_${e.professionalName.replace(/\s+/g,"_")}.pdf`)}async function Ic(){const t=R.selectedIds.size;if(!(t===0||!await Q("Excluir Recibos",`Deseja excluir e estornar ${t} recibo(s)? As vendas associadas voltarão ao status "A Apurar".`)))try{const a=Array.from(R.selectedIds).map(s=>Ci(s));await Promise.all(a),f("Sucesso",`${t} recibos excluídos com sucesso.`,"success"),R.selectedIds.clear(),Lt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),await nt()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns recibos.","error")}}async function Ec(t){if(await Q("Excluir Recibo",'ATENÇÃO: Deseja realmente excluir este recibo? As vendas associadas a ele voltarão ao status "A Apurar" e o valor será subtraído dos relatórios. Esta ação não pode ser desfeita.'))try{await Ci(t),f("Sucesso","Recibo cancelado com sucesso. Vendas estornadas para apuração.","success"),Ls(),await nt()}catch(a){f("Erro ao Excluir",a.message,"error")}}const Re=document.getElementById("content");let A={allPackages:[],catalogForModal:{services:[],products:[]},establishments:[],searchQuery:"",statusFilter:"all",viewMode:"list",tempPackage:null,selectedIds:new Set},Je=null;function lt(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Lc(){const t=A.allPackages.length,e=A.allPackages.filter(o=>o.status!=="inactive"),a=e.length,s=a>0?e.reduce((o,r)=>o+(r.price||0),0)/a:0;let i=0;return e.forEach(o=>{const r=o.originalPrice||0,n=o.price||0;if(r>0&&r>n){const l=(r-n)/r*100;l>i&&(i=l)}}),{total:t,activeCount:a,avgPrice:s,maxDiscount:i}}function Cc(){const t=document.getElementById("packages-layout-detail");t&&(t.classList.remove("hidden"),t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))}))}function ia(){const t=document.getElementById("packages-layout-detail");if(t){t.classList.add("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-0","md:scale-100","md:opacity-100"),e.classList.add("translate-y-full","md:scale-95","md:opacity-0")),setTimeout(()=>{t.classList.add("hidden"),t.style.display="none",t.innerHTML=""},300)}}function Dc(){const t=document.getElementById("packages-layout-detail");if(!t||A.viewMode!=="edit-package"||!A.tempPackage)return;A.tempPackage.name=t.querySelector("#packageName")?.value||"",A.tempPackage.description=t.querySelector("#packageDescription")?.value||"",A.tempPackage.status=t.querySelector("#packageStatus")?.value||"active";const e=parseFloat(t.querySelector("#finalPrice")?.value);A.tempPackage.price=isNaN(e)?"":e;const a=parseFloat(t.querySelector("#commissionRate")?.value);A.tempPackage.commissionRate=isNaN(a)?"":a;const s=parseInt(t.querySelector("#validityDays")?.value,10);A.tempPackage.validityDays=isNaN(s)?"":s,A.tempPackage.sellStartDate=t.querySelector("#sellStartDate")?.value||"",A.tempPackage.sellEndDate=t.querySelector("#sellEndDate")?.value||"";const i=parseInt(t.querySelector("#salesLimit")?.value,10);A.tempPackage.salesLimit=isNaN(i)?"":i;const o=Array.from(t.querySelectorAll(".modal-est-checkbox:checked")).map(r=>r.value);A.tempPackage.establishmentIds=o}async function Pc(){try{const e=(await we().catch(()=>({matrizes:[]}))).matrizes||[];A.establishments=[],e.forEach(a=>{A.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>A.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}A.viewMode="list",A.selectedIds.clear(),Tc(),qc(),await ha()}async function ha(){const t=document.getElementById("packagesListContainer");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-20"><div class="loader mx-auto"></div></div>');const e=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId];try{const a=e.map(c=>vs(c).catch(()=>[])),s=await Promise.all(a),i=new Map;s.flat().forEach(c=>{i.has(c.id)||i.set(c.id,c)}),A.allPackages=Array.from(i.values());const o=e.map(c=>ct(c).catch(()=>[])),r=e.map(c=>ut(c).catch(()=>[])),[n,l]=await Promise.all([Promise.all(o),Promise.all(r)]),d=new Map;n.flat().forEach(c=>d.set(c.id,c));const u=new Map;l.flat().forEach(c=>u.set(c.id,c)),A.catalogForModal={services:Array.from(d.values()).filter(c=>c.active),products:Array.from(u.values())},Mc(),Ye(),vt()}catch(a){console.error(a),t&&(t.innerHTML=`
            ...
            `)}}function vt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=A.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")));const s=document.getElementById("select-all-toggle");s&&(s.checked=A.allPackages.length>0&&a===A.allPackages.length)}function Tc(){Re.innerHTML=`
    ...
    `}function Mc(){const t=Lc(),e=document.getElementById("kpi-container");e&&(e.innerHTML=`
    ...
    `)}function Ye(){const t=document.getElementById("packagesListContainer");if(!t)return;let e=A.allPackages;if(A.statusFilter!=="all"){const s=A.statusFilter==="active";e=e.filter(i=>i.status!=="inactive"===s)}if(A.searchQuery){const s=A.searchQuery.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(e.length===0){t.innerHTML=`
                ...
                <div class="p-5 pt-5 flex-grow flex flex-col">
                    ...
                    <div class="flex justify-between items-end border-t border-slate-100 pt-4">
                        <div class="flex flex-col">
                            ...
                            <span class="text-2xl font-black text-slate-900 leading-none drop-shadow-sm">${lt(r)}</span>
                        </div>
                        <div class="text-right">
        ...
        `}).join("")}function Bc(){if(A.allPackages.length===0){f("Aviso","Não há pacotes carregados para exportar.","info");return}let t=A.allPackages;if(A.statusFilter!=="all"){const s=A.statusFilter==="active";t=t.filter(i=>i.status!=="inactive"===s)}if(A.searchQuery){const s=A.searchQuery.toLowerCase();t=t.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(t.length===0){f("Aviso","Nenhum pacote corresponde aos filtros atuais.","info");return}const e=new Map(A.establishments.map(s=>[s.id,s.name])),a=t.map(s=>{const i=s.originalPrice||0,o=s.price||0,r=i>0?(i-o)/i*100:0,n=(s.items||[]).map(u=>`${u.quantity}x ${u.name}`).join(" | ");return{"Unidade(s)":(s.establishmentIds||(s.establishmentId?[s.establishmentId]:[])).map(u=>e.get(u)).filter(Boolean).join(", ")||"Não identificada","Nome do Pacote":s.name,Status:s.status!=="inactive"?"Ativo":"Inativo",Descrição:s.description||"","Itens Incluídos":n,"Valor Original (R$)":i,"Preço de Venda (R$)":o,"Desconto (%)":r.toFixed(1)+"%","Comissão (%)":s.commissionRate||0,"Validade de Uso (Dias)":s.validityDays||"Vitalício","Vendas Início":s.sellStartDate?new Date(s.sellStartDate).toLocaleDateString("pt-BR"):"-","Vendas Fim":s.sellEndDate?new Date(s.sellEndDate).toLocaleDateString("pt-BR"):"-"}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const s=XLSX.utils.json_to_sheet(a),i=XLSX.utils.book_new();XLSX.utils.book_append_sheet(i,s,"Pacotes");const o=`Relatorio_Pacotes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(i,o)}catch(s){console.error(s),f("Erro","Falha ao exportar Excel.","error")}}function oo(t=null){A.viewMode="edit-package",A.tempPackage=t?JSON.parse(JSON.stringify(t)):{id:"",name:"",description:"",status:"active",items:[],price:"",originalPrice:0,commissionRate:0,validityDays:"",sellStartDate:"",sellEndDate:"",salesLimit:"",establishmentIds:[g.establishmentId]},ls(),Cc()}function Ti(){const t=document.getElementById("packages-layout-detail");if(!t)return;const a=(A.tempPackage.items||[]).reduce((n,l)=>n+(l.price||0)*(l.quantity||1),0),s=t.querySelector("#finalPrice"),i=t.querySelector("#discountIndicator"),o=t.querySelector("#originalPrice"),r=parseFloat(s?.value)||0;if(o&&(o.textContent=lt(a)),i)if(a>0&&a>r&&r>0){const n=(a-r)/a*100;i.textContent=`${n.toFixed(0)}% OFF`,i.classList.remove("hidden")}else i.classList.add("hidden")}function ns(){const t=document.getElementById("package-items-list");if(!t)return;const e=A.tempPackage.items||[];e.length===0?t.innerHTML=`
    ...
    `,ns(),requestAnimationFrame(()=>{const m=t.querySelector("#modal-content-wrapper");m&&(m.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),m.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Ac(){A.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `;let a;const s=(o="")=>{const r=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600 text-lg"></i>',product:'<i class="bi bi-box-seam text-emerald-600 text-lg"></i>'},l={"catalog-service-list":{items:A.catalogForModal.services,type:"service"},"catalog-product-list":{items:A.catalogForModal.products,type:"product"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=t.querySelector("#"+d);if(!p)return;const b=u.filter(y=>y.name.toLowerCase().includes(r)).slice(0,50),m=c==="service"?"hover:border-indigo-400 hover:bg-indigo-50/80 hover:shadow-md":"hover:border-emerald-400 hover:bg-emerald-50/80 hover:shadow-md",h=c==="service"?"bg-indigo-100 border-indigo-200 shadow-sm":"bg-emerald-100 border-emerald-200 shadow-sm";p.innerHTML=b.map(y=>y.id?`
            ...
            `:"").join("")||'<div class="flex flex-col items-center justify-center py-8 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50"><i class="bi bi-inbox text-3xl mb-2"></i><p class="text-[10px] font-bold uppercase tracking-widest">Nenhum resultado</p></div>'})};s();const i=t.querySelector("#item-search-input");i&&(i.addEventListener("input",o=>{clearTimeout(a),a=setTimeout(()=>s(o.target.value),300)}),setTimeout(()=>i.focus(),100)),requestAnimationFrame(()=>{const o=t.querySelector("#modal-content-wrapper");o&&(o.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),o.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function qc(){Je&&(Re.removeEventListener("click",Je),Re.removeEventListener("input",Je),Re.removeEventListener("change",Je)),Je=async e=>{if(e.target.classList.contains("item-checkbox")){const r=e.target.value;e.target.checked?A.selectedIds.add(r):A.selectedIds.delete(r),vt(),Ye(),e.stopPropagation();return}if(e.target.id==="packages-layout-detail"){ia(),A.viewMode="list",A.tempPackage=null;return}if(e.target.closest("#batch-delete-btn")){const r=A.selectedIds.size;if(r===0)return;if(await Q("Excluir Pacotes",`Deseja realmente apagar ${r} pacotes selecionados?`))try{const l=Array.from(A.selectedIds).map(d=>Hs(d));await Promise.all(l),f("Sucesso",`${r} pacote(s) excluído(s).`,"success"),A.selectedIds.clear(),vt(),await ha()}catch{f("Erro","Ocorreu um erro ao excluir pacotes.","error")}return}if(e.target.closest("#cancel-selection-btn")){A.selectedIds.clear();const r=document.getElementById("select-all-toggle");r&&(r.checked=!1),vt(),Ye();return}const i=e.target.closest("[data-action]");if(!i)return;switch(i.dataset.action){case"new-package":navigator.vibrate&&navigator.vibrate(20),oo(null);break;case"edit-package":navigator.vibrate&&navigator.vibrate(15);const r=i.dataset.id,n=A.allPackages.find(w=>w.id===r);n&&oo(n);break;case"delete-package":e.stopPropagation(),e.preventDefault();const l=i.dataset.id;if(await Q("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await Hs(l),f("Sucesso!","Pacote excluído.","success"),A.viewMode==="edit-package"&&A.tempPackage?.id===l&&(ia(),A.viewMode="list"),await ha()}catch(w){f("Erro",`Não foi possível excluir: ${w.message}`,"error")}break;case"back-to-main":ia(),A.viewMode="list",A.tempPackage=null;break;case"add-item-to-package-btn":Dc(),Ac();break;case"back-to-editor":ls();break;case"select-catalog-item":navigator.vibrate&&navigator.vibrate(10);const{itemType:u,itemId:c}=i.dataset,b=(A.catalogForModal[u+"s"]||[]).find(w=>w.id===c);if(b){const w=A.tempPackage.items.find(M=>M.id===b.id&&M.type===u);w?w.quantity++:A.tempPackage.items.push({...b,type:u,quantity:1}),ls()}break;case"remove-item":navigator.vibrate&&navigator.vibrate(10);const m=parseInt(i.dataset.index,10);A.tempPackage.items.splice(m,1),ns();break;case"toggle-all-ests":const h=document.querySelectorAll(".modal-est-checkbox"),y=Array.from(h).every(w=>w.checked);h.forEach(w=>w.checked=!y);break;case"save-package":await jc(i);break}},Re.addEventListener("click",Je),Re.addEventListener("input",e=>{e.target.id==="search-packages"&&(A.searchQuery=e.target.value,Ye()),e.target.id==="finalPrice"&&Ti()}),Re.addEventListener("change",e=>{if(e.target.id==="select-all-toggle"){const a=e.target.checked;A.selectedIds.clear(),a&&A.allPackages.forEach(s=>A.selectedIds.add(s.id)),vt(),Ye()}if(e.target.id==="filter-status"&&(A.statusFilter=e.target.value,Ye()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&A.tempPackage.items[a]&&(A.tempPackage.items[a].quantity=s,ns())}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Bc)}async function jc(t){const e=A.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const i=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(i.length===0){f("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const o=e.items.reduce((l,d)=>l+d.price*d.quantity,0),r={id:e.id||null,companyId:g.companyId,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:o,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:i,establishmentId:i[0]};if(!r.name||isNaN(r.price)){f("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(r.items.length===0){f("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await Mn(r.id,r):(delete r.id,await Tn(r)),f("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),ia(),A.viewMode="list",A.tempPackage=null,await ha()}catch(l){f("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const Nc=document.getElementById("content");async function Rc(){const t=ye.currentUser;if(!t)return;let e={};try{const l=await cs(Be(fe,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(g.userProfessionalId)try{a=await yo(g.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=v(e.name||t.displayName||"Usuário"),i=v(t.email||"E-mail não disponível"),o=v(e.phone||"");let r=e.photo||"";a&&a.photo&&(r=a.photo);const n=r||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;Nc.innerHTML=`
    ...
    `,Fc(t),Hc(a)}function Fc(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),i=document.getElementById("profile-avatar"),o=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async r=>{const n=r.target.files[0];if(n)try{const l=await wa(n,800,800,.8);i.src=l,await Pt(Be(fe,"users",t.uid),{photo:l}),g.userProfessionalId&&await Va(g.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),f("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{f("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),o.addEventListener("submit",async r=>{r.preventDefault();const n=o.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),u=document.getElementById("input-phone").value.trim();try{await Pt(Be(fe,"users",t.uid),{name:d,phone:u}),g.userProfessionalId&&await Va(g.userProfessionalId,{name:d,phone:u}),g.userName=d,document.getElementById("display-name").textContent=d,f("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{f("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function Hc(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async i=>{i.preventDefault();const o=a.querySelector("#b-date-start").value,r=a.querySelector("#b-date-end").value||o,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!o||!n||!l)return f("Atenção","Preencha Data e Horários corretamente.","error");const u=new Date(`${o}T${n}:00`),c=new Date(`${r}T${l}:00`);if(c<=u)return f("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await La({establishmentId:g.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:u.toISOString(),endTime:c.toISOString()}),f("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const m=document.getElementById("my-blocks-filter").value;ra(t.id,m)}catch(m){f("Erro",`Falha ao bloquear: ${m.message}`,"error")}finally{p.disabled=!1,p.innerHTML=b}}),document.getElementById("my-blocks-filter").addEventListener("change",i=>ra(t.id,i.target.value)),ra(t.id,"future")}async function ra(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let i,o;e==="history"?(o=new Date,i=new Date,i.setFullYear(i.getFullYear()-1)):(i=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let n=(await Ea(g.establishmentId,i.toISOString(),o.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await gs(u),f("Removido","O bloqueio foi deletado.","success"),ra(t,e)}catch(c){f("Erro",`Não foi possível remover: ${c.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${v(s.message)}</p>`}}let ro=!1;async function va(t){if(!t)return;t.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const i=(await we()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),i.length===0)e.innerHTML=`
            ...
            `;else{let o="";i.forEach(r=>{if(a&&!r.isOrphanBranch){const l=document.createElement("option");l.value=r.id,l.textContent=r.name,a.appendChild(l)}const n=r.isMatriz||!r.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';o+=`
                ...
                `}),e.innerHTML=o}ro||(Oc(),ro=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
        ...
        `}}function Oc(){const t=document.getElementById("form-create-establishment");t&&t.addEventListener("submit",async e=>{e.preventDefault();const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const i={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const o=await ur(i);alert(o.message||"Sucesso!"),t.reset();const r=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(r);n&&n.hide(),await va(document.getElementById("content"))}catch(o){console.error("Erro ao criar estabelecimento:",o),alert("Erro: "+(o.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>va(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",e=>e.preventDefault()),document.addEventListener("gesturechange",e=>e.preventDefault()),document.addEventListener("gestureend",e=>e.preventDefault());let t=0;document.addEventListener("touchend",function(e){const a=new Date().getTime();a-t<=300&&e.preventDefault(),t=a},!1)});const ue=document.getElementById("loadingScreen"),mt=document.getElementById("dashboardContent"),Ke=document.getElementById("content"),Ha=document.getElementById("notificationBell"),Zt=document.getElementById("notificationBadge"),Qe=document.getElementById("notificationPanel"),Oa=document.getElementById("notificationList"),Ee=document.getElementById("profileMenuButton"),me=document.getElementById("profileDropdown"),no=document.getElementById("profileName"),lo=document.getElementById("profileEmail"),co=document.getElementById("logoutButton"),uo=document.getElementById("myProfileLink"),po=document.getElementById("hamburger-menu-btn"),be=document.getElementById("sidebar"),he=document.getElementById("mobile-overlay"),bo=document.getElementById("themeToggleBtn"),za=document.getElementById("themeIcon"),ds=document.getElementById("mobile-bottom-nav"),mo=document.getElementById("nav-scroll"),zc=document.querySelectorAll(".bottom-nav-item");function _c(){if(!mo)return;const t=document.querySelector(".bottom-nav-item.active");if(!t)return;const e=mo,a=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=s.left+s.width/2-a.left-a.width/2;e.scrollBy({left:o,behavior:"smooth"})}const Vc={"dashboard-section":Kr,"agenda-section":Vo,"comandas-section":Gn,"relatorios-section":Xn,"servicos-section":dl,"produtos-section":Il,"suppliers-section":Nl,"profissionais-section":Wl,"clientes-section":rd,"estabelecimento-section":t=>hi(t),"ausencias-section":qd,"users-section":ga,"sales-report-section":Yd,"financial-section":Kd,"commissions-section":pc,"packages-section":Pc,"my-profile-section":Rc,"hierarquia-section":()=>va(Ke),"establishments-section":()=>va(Ke)},Uc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços","produtos-section":"Estoque","suppliers-section":"Parceiros","profissionais-section":"Equipe","clientes-section":"Clientes","estabelecimento-section":"Empresa","ausencias-section":"Ausências","users-section":"Usuários","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro","commissions-section":"Comissões","packages-section":"Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"};function na(t){document.documentElement.setAttribute("data-theme",t),localStorage.setItem("kairos_theme",t),za&&(t==="dark"?za.className="bi bi-sun-fill text-lg sm:text-xl text-amber-400":za.className="bi bi-moon-fill text-lg sm:text-xl text-slate-500")}function Wc(){const t=localStorage.getItem("kairos_theme"),e=window.matchMedia("(prefers-color-scheme: dark)").matches;na(t||(e?"dark":"light"))}let Ct=null,Dt=[];function Mi(){if(!Zt||!Oa)return;const t=Dt.filter(e=>!e.read).length;if(t>0?(Zt.textContent=t,Zt.classList.remove("hidden")):Zt.classList.add("hidden"),Dt.length===0){Oa.innerHTML='<p class="text-center text-slate-500 p-4 text-sm">Nenhuma notificação.</p>';return}Oa.innerHTML=Dt.map(e=>`
    ...
    `).join("")}function go(t){Ct&&Ct();const e=ya(fe,"establishments",t,"notifications"),a=ho(e,vo("timestamp",">=",new Date),Wi("timestamp","desc"));Ct=Ji(a,s=>{s.docChanges().forEach(i=>{if(i.type==="added"){const o=i.doc.data();Dt.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),f(o.title,o.message,"info",!0),Mi();const r=document.querySelector(".sidebar-link.active");r&&r.dataset.target==="agenda-section"&&Vo()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Jc(t){const e=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),i=document.getElementById("multi-context-count"),o=document.getElementById("multi-context-list"),r=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!e||!o))try{const u=(await we()).matrizes||[];let c="",p=0;if(u.forEach(b=>{c+=`
                <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors mb-1">
                    <input type="checkbox" value="${b.id}" class="context-checkbox" data-name="${Kt(b.name)}">
                    <span class="text-[13px] sm:text-sm font-bold text-slate-700 truncate">🏢 ${Kt(b.name)}</span>
                </label>
            `,p++,b.branches&&b.branches.length>0&&b.branches.forEach(m=>{c+=`
                        <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors ml-4 mb-1 border-l-2 border-slate-100 pl-3">
                            <input type="checkbox" value="${m.id}" class="context-checkbox" data-name="${Kt(m.name)}">
                            <span class="text-[12px] sm:text-[13px] font-medium text-slate-600 truncate">📍 ${Kt(m.name)}</span>
                        </label>
                    `,p++})}),p>0){o.innerHTML=c,e.style.display="block",(!g.selectedEstablishments||g.selectedEstablishments.length===0)&&(g.selectedEstablishments=[t]);const b=Array.from(o.querySelectorAll('input[type="checkbox"]')),m=()=>{const y=b.filter(w=>w.checked);i.textContent=y.length,y.length===0?s.textContent="Nenhuma selecionada":y.length===1?s.textContent=y[0].dataset.name:s.textContent=`${y.length} Unidades`};let h=!1;b.forEach(y=>{g.selectedEstablishments.includes(y.value)&&(y.checked=!0,h=!0)}),!h&&b.length>0&&(b[0].checked=!0,g.selectedEstablishments=[b[0].value],g.establishmentId=b[0].value),m(),a.addEventListener("click",y=>{y.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",y=>{!e.contains(y.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",b.forEach(w=>{w.checked=g.selectedEstablishments.includes(w.value)}),m())}),b.forEach(y=>y.addEventListener("change",m)),r.addEventListener("click",async y=>{y.stopPropagation(),ue&&(ue.classList.remove("hidden","fade-out"),ue.style.display="flex");const w=b.filter(B=>B.checked);if(w.length===0){ue&&(ue.classList.add("fade-out"),setTimeout(()=>{ue.style.display="none"},500)),f("Atenção","Selecione pelo menos uma unidade.","warning");return}g.selectedEstablishments=w.map(B=>B.value);const M=g.selectedEstablishments[0];try{const B=await Ae(M);g.establishmentId=M,g.establishmentName=B.name,g.enabledModules=B.modules,g.currentViewContext={id:M,name:B.name,type:B.parentId?"BRANCH":"GROUP"},go(M),fo(g.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",f("Ambiente Atualizado","Exibindo dados consolidados.","success");const S=document.querySelector(".sidebar-link.active"),I=S?S.getAttribute("data-target"):"dashboard-section";oe(I)}catch{f("Erro","Problema ao trocar a visualização.","error")}finally{ue&&(ue.classList.add("fade-out"),setTimeout(()=>{ue.style.display="none"},500))}});try{const y=await Ae(g.establishmentId);g.establishmentName=y.name,g.enabledModules=y.modules,g.currentViewContext={id:g.establishmentId,name:y.name,type:y.parentId?"BRANCH":"GROUP"},go(g.establishmentId),fo(g.userPermissions)}catch{}}else e.style.display="none"}catch{e.style.display="none"}}function oe(t,e={}){const a=t.replace("-section","");if(t!=="my-profile-section"){const i=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(t),o=g.enabledModules?.[a]!==!1,r=g.userPermissions===null||g.userPermissions[t]?.view===!0;if(!i&&(!o||!r)){Ke&&(Ke.innerHTML='<div class="p-8 text-center mt-10"><i class="bi bi-shield-lock text-5xl text-rose-500 mb-4 block"></i><h2 class="text-2xl font-bold text-slate-800">Acesso Negado</h2><p class="text-slate-500 mt-2">Você não possui permissão para visualizar esta tela.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),be&&be.classList.contains("absolute")&&(be.classList.add("hidden"),he&&he.classList.add("hidden"));return}}const s=Vc[t];if(s&&Ke){const i=document.getElementById("header-page-title");i&&(i.textContent=Uc[t]||"Painel"),document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),ds&&(zc.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),setTimeout(_c,50)),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Ke.innerHTML="",window.innerWidth<768&&be&&(be.classList.add("hidden"),he&&he.classList.add("hidden")),s(e)}}window.navigateTo=oe;async function fo(t){const e=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),i=document.getElementById("kpi-today-revenue"),o=t===null||t["agenda-section"]?.view===!0,r=t===null||t["financial-section"]?.view===!0;if(o&&e&&(e.classList.remove("hidden"),e.classList.add("inline-flex")),r&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!o&&!r))try{const n=await Io();o&&s&&(s.textContent=n.todayAppointments.toString()),r&&i&&(i.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch{}}async function Qc(t){try{$e.getPlatform()==="android"&&await pe.createChannel({id:"default",name:"Notificações",description:"Alertas",importance:5,visibility:1,vibration:!0});let e=await pe.checkPermissions();if(e.receive==="prompt"&&(e=await pe.requestPermissions()),e.receive!=="granted")return;await pe.register(),pe.addListener("registration",async a=>{try{const s=Be(fe,"users",t);await Pt(s,{fcmTokens:Ui(a.value),platform:"native_mobile"})}catch{}}),pe.addListener("pushNotificationReceived",a=>f(a.title,a.body,"info",!0)),pe.addListener("pushNotificationActionPerformed",()=>oe("agenda-section"))}catch{}}function Gc(){const t=document.getElementById("exitConfirmationModal"),e=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>t&&(t.style.display="block"),i=()=>t&&(t.style.display="none"),o=()=>t&&t.style.display==="block";t&&(e.addEventListener("click",()=>{i(),$e.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{i(),$e.isNativePlatform()?As.exitApp():history.back()}),$e.isNativePlatform()?As.addListener("backButton",()=>{if(o())i();else{const r=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(r).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(be&&!be.classList.contains("hidden")&&window.innerWidth<768){be.classList.add("hidden"),he&&he.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():oe("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(o()){i(),history.pushState(null,document.title,location.href);return}const r=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(r).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():(oe("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Kt(t){return t?t.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function Yc(){try{await Ri(ye,Fi)}catch{}$e.isNativePlatform()&&document.body.classList.add("is-app-native"),Qi(),Gc(),Wc(),bo&&bo.addEventListener("click",t=>{t.preventDefault();const e=document.documentElement.getAttribute("data-theme")||"light";na(e==="dark"?"light":"dark")}),po&&po.addEventListener("click",t=>{t.stopPropagation(),be&&(be.classList.remove("hidden"),be.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),he&&he.classList.remove("hidden")}),ds&&ds.addEventListener("click",t=>{const e=t.target.closest(".bottom-nav-item");if(!e)return;t.preventDefault();const a=e.getAttribute("data-target");oe(a)}),he&&he.addEventListener("click",()=>{be&&(be.classList.add("hidden"),be.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),he.classList.add("hidden")}),Ha&&Ha.addEventListener("click",t=>{t.stopPropagation(),Qe&&(Qe.classList.toggle("hidden"),Qe.classList.contains("hidden")||(Dt.forEach(e=>e.read=!0),Mi()))}),Ee&&Ee.addEventListener("click",t=>{t.stopPropagation(),me&&(me.classList.toggle("active"),me.classList.contains("active")?me.classList.remove("hidden"):setTimeout(()=>me.classList.add("hidden"),200))}),uo&&uo.addEventListener("click",t=>{t.preventDefault(),oe("my-profile-section"),me&&(me.classList.remove("active"),me.classList.add("hidden"))}),window.addEventListener("userPhotoUpdated",t=>{const e=t.detail;Ee&&e&&(Ee.innerHTML=`<img src="${e}" alt="Avatar" class="w-full h-full rounded-full object-cover">`)}),document.addEventListener("click",t=>{Qe&&!Qe.contains(t.target)&&t.target!==Ha&&Qe.classList.add("hidden"),me&&!me.contains(t.target)&&t.target!==Ee&&me.classList.contains("active")&&(me.classList.remove("active"),setTimeout(()=>me.classList.add("hidden"),200))}),Hi(ye,async t=>{if(t){if(!$e.isNativePlatform()&&(Tr(),"Notification"in window&&Notification.permission==="default")){const e=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");e&&setTimeout(()=>{e.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Mr()&&e&&(e.style.display="none")});const s=()=>{e&&(e.style.display="none")},i=document.getElementById("btn-deny-toast"),o=document.getElementById("btn-close-toast");i&&i.addEventListener("click",s),o&&o.addEventListener("click",s)}try{const a=(await t.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,i=t.displayName,o=null,r=null;const n=Be(fe,"users",t.uid),l=await cs(n);if(l.exists()){const u=l.data();s=a.role==="employee"?u.permissions||{}:null,i=u.name||i,o=u.professionalId||null,r=u.photo||null}if(g.userProfessionalId=o,o&&!r)try{const u=await yo(o);u&&u.photo&&(r=u.photo)}catch{}$e.isNativePlatform()&&Qc(t.uid);const d=i||t.email;Xi(a.establishmentId,"Carregando...",s),r?Ee&&(Ee.innerHTML=`<img src="${r}" class="w-full h-full rounded-full object-cover">`):Ee&&(Ee.textContent=d.charAt(0).toUpperCase()),no&&(no.textContent=d),lo&&(lo.textContent=t.email),co&&co.addEventListener("click",u=>{u.preventDefault(),Ct&&Ct(),Oi(ye).then(()=>window.location.href="/login.html")}),await Jc(a.establishmentId),cr(oe,s,g.enabledModules),ue&&(ue.classList.add("fade-out"),setTimeout(()=>{ue.style.display="none"},500)),mt&&(mt.style.display="flex"),setTimeout(()=>{xr()},1500),oe("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(e){ue&&(ue.style.display="none"),mt&&(mt.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><i class="bi bi-x-circle text-5xl text-rose-500 mb-4"></i><h2 class="text-xl font-bold">Erro de Acesso</h2><p class="text-slate-500 mt-2">${e.message}</p></div>`,mt.style.display="flex")}}else window.location.href="/login.html"})}Yc();export{ko as W};
