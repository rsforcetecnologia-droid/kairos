...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ia}. Verifique sua conexão com a internet.`):n}}const Po=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),w(r)},Ds=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return w(s)},Ms=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return w(r)},As=e=>w("/api/appointments",{method:"POST",body:JSON.stringify(e)}),ka=(e,t)=>w(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ns=e=>w(`/api/appointments/${e}`,{method:"DELETE"}),qs=e=>w(`/api/appointments/${e}/reopen`,{method:"POST"}),Rs=(e,t)=>w(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let J;async function Fs(){if(!J)try{J=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function js(){if(!J){console.warn("AudioContext não inicializado. O som não será tocado.");return}J.state==="suspended"&&J.resume();const e=J.createOscillator(),t=J.createGain();e.connect(t),t.connect(J.destination),e.type="sine",e.frequency.setValueAtTime(800,J.currentTime),t.gain.setValueAtTime(0,J.currentTime),t.gain.linearRampToValueAtTime(.3,J.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,J.currentTime+.2),e.start(J.currentTime),e.stop(J.currentTime+.2)}function g(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&js();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `,document.body.appendChild(de),Sa())}function Sa(){const e=Math.round(Z/St.length*100),t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width=`${e}%`),a&&(a.innerText=`${e}%`)}function $a(e){const t=document.getElementById("onboarding-step-content"),a=St[e];if(!a){Ja(t);return}let s="";if(a.id==="company_data")s=`
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>ir(a.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===St.length-1?Ja(t):(Z++,Sa(),$a(Z))}),a.id==="branding"){const r=document.getElementById("logo-input"),o=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await _a(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),o&&(o.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await _a(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Ja(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{de&&de.remove(),window.location.reload()}}async function ir(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),s=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),o=Object.fromEntries(r.entries());try{if(e==="company_data")await kt(u.establishmentId,{name:o.name,phone:o.phone,email:o.email,address:o.address,zipCode:o.zipCode});else if(e==="branding"){const n={};o.logoBase64&&(n.logo=o.logoBase64),o.bgBase64&&(n.backgroundImage=o.bgBase64),o.themeColor&&(n.themeColor=o.themeColor),o.primaryColor&&(n.primaryColor=o.primaryColor),Object.keys(n).length>0&&await kt(u.establishmentId,n)}else if(e==="time_config"){const n=parseInt(o.slotInterval);await kt(u.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Mo({establishmentId:u.establishmentId,name:o.name,price:parseFloat(o.price),duration:parseInt(o.duration),active:!0});n&&Ct.push(n)}else if(e==="first_prof"){const n=await Bo({establishmentId:u.establishmentId,name:o.name,specialty:o.role,active:!0,commissionRate:0});if(o.serviceId&&n&&n.id)try{Ua?await Ua(n.id,[o.serviceId]):It&&await It(n.id,{services:[o.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Ao({establishmentId:u.establishmentId,name:o.name,price:parseFloat(o.salePrice),stock:parseInt(o.stock),active:!0});g("Sucesso","Passo concluído!","success"),Z++,Sa(),$a(Z)}catch(n){g("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=s}}var Ne;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ne||(Ne={}));class Yt extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const lr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},dr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:lr(e),o=()=>r()!=="web",n=m=>{const b=d.get(m);return!!(b?.platforms.has(r())||i(m))},i=m=>{var b;return(b=a.PluginHeaders)===null||b===void 0?void 0:b.find(p=>p.name===m)},l=m=>e.console.error(m),d=new Map,c=(m,b={})=>{const p=d.get(m);if(p)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),p.proxy;const f=r(),h=i(m);let y;const S=async()=>(!y&&f in b?y=typeof b[f]=="function"?y=await b[f]():y=b[f]:t!==null&&!y&&"web"in b&&(y=typeof b.web=="function"?y=await b.web():y=b.web),y),I=(L,T)=>{var A,q;if(h){const z=h?.methods.find(M=>T===M.name);if(z)return z.rtype==="promise"?M=>a.nativePromise(m,T.toString(),M):(M,Y)=>a.nativeCallback(m,T.toString(),M,Y);if(L)return(A=L[T])===null||A===void 0?void 0:A.bind(L)}else{if(L)return(q=L[T])===null||q===void 0?void 0:q.bind(L);throw new Yt(`"${m}" plugin is not implemented on ${f}`,Ne.Unimplemented)}},$=L=>{let T;const A=(...q)=>{const z=S().then(M=>{const Y=I(M,L);if(Y){const Ee=Y(...q);return T=Ee?.remove,Ee}else throw new Yt(`"${m}.${L}()" is not implemented on ${f}`,Ne.Unimplemented)});return L==="addListener"&&(z.remove=async()=>T()),z};return A.toString=()=>`${L.toString()}() { [capacitor code] }`,Object.defineProperty(A,"name",{value:L,writable:!1,configurable:!1}),A},k=$("addListener"),C=$("removeListener"),R=(L,T)=>{const A=k({eventName:L},T),q=async()=>{const M=await A;C({eventName:L,callbackId:M},T)},z=new Promise(M=>A.then(()=>M({remove:q})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await q()},z},O=new Proxy({},{get(L,T){switch(T){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?R:k;case"removeListener":return C;default:return $(T)}}});return s[m]=O,d.set(m,{name:m,proxy:O,platforms:new Set([...Object.keys(b),...h?[f]:[]])}),O};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Yt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},cr=e=>e.Capacitor=dr(e),xe=cr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ea=xe.registerPlugin;class No{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new xe.Exception(t,Ne.Unimplemented)}unavailable(t="not available"){return new xe.Exception(t,Ne.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Wa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ga=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class ur extends No{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Ga(r).trim(),o=Ga(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Wa(t.key),s=Wa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ea("CapacitorCookies",{web:()=>new ur});const mr=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),pr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},gr=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,br=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=pr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class fr extends No{async request(t){const a=br(t,t.webFetchExtra),s=gr(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await mr(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const c={};return o.headers.forEach((m,b)=>{c[b]=m}),{data:l,headers:c,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ea("CapacitorHttp",{web:()=>new fr});const G=Ea("PushNotifications",{}),vr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ya=!1;async function qo(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{jo(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Fo()}async function Ro(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Fo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Fo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Ls(Fa,{vapidKey:vr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await jo(t,!1)):console.warn("[Push Web] Token veio vazio."),Ya||(Ts(Fa,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Ya=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function jo(e,t){const a=V.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=ce(U,"users",a.uid);try{const r=await Io(s);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await ya(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await $s(s,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",r)}}const hr=(e,t,a="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),w(`/api/reports/indicators?${r.toString()}`)},xr=e=>e?w(`/api/financial/cost-centers/${e}`):Promise.resolve([]),yr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),w(`/api/reports/sales?${r.toString()}`)},wr=()=>w("/api/reports/summary",{method:"GET"}),jt=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return w(r)},Ht=e=>w("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Ia=e=>w(`/api/blockages/${e}`,{method:"DELETE"}),Ho=e=>w("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Ot=e=>e?String(e).replace(/\D/g,""):"",He=(e,t="",a=20,s={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),s.hasLoyalty&&r.append("hasLoyalty","true"),s.birthMonth&&r.append("birthMonth",s.birthMonth),s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),w(`/api/clients/${e}?${r.toString()}`)},kr=e=>{if(!e.phone)throw new Error("Telefone é obrigatório");const t=Ot(e.phone),a={...e,phone:t,id:t};return w(`/api/clients/${t}`,{method:"PUT",body:JSON.stringify(a)})},Sr=(e,t)=>{const a=Ot(t);return w(`/api/clients/full-history/${e}?phone=${a}`)},$r=e=>{const t=Ot(e);return w(`/api/clients/${t}`,{method:"DELETE"})},Er=(e,t,a,s)=>w("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ot(t),points:a,rewardName:s})});function v(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Oo(e,t=800,a=800,s=.7){return new Promise((r,o)=>{if(!e.type.match(/image.*/))return o(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const m=document.createElement("canvas");m.width=d,m.height=c,m.getContext("2d").drawImage(l,0,0,d,c);const p=m.toDataURL("image/jpeg",s);r(p)},l.onerror=d=>o(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>o(new Error("Erro ao ler o ficheiro."))})}const Qa=document.getElementById("content");let Xa=!1;const la=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let it=[],zt=[],qe={},De=[],B={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},E={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Ir(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function zo(e){const t=new Date(e);if(t.setHours(0,0,0,0),B.currentView==="week"&&B.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function Lt(){const e=document.getElementById("profSelectorContainer"),t=B.profSearchTerm.toLowerCase();if(!e||!u.professionals)return;let a=u.professionals.filter(o=>B.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=B.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",c=v(i),m=la[0],b=o.id!=="all"&&u.professionalColors.get(o.id)||m,p=o.photo||`https://placehold.co/64x64/${b.main?.replace("#","")||"E0E7FF"}/${b.light?.replace("#","")||"4F46E5"}?text=${l}`,f=o.id==="all"?"#e0e7ff":b.light,h=o.id==="all"?"#4f46e5":b.main,S=`border: 3px solid ${n?b.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+b.border:"none"};`;return`
            <div class="prof-card ${n?"selected":""} ${d?"":"opacity-50"}" 
                ...
                ${o.id==="all"?`<div class="prof-card-all-placeholder" style="background-color: ${f}; color: ${h}; ${S}">
                           ${l}
                          </div>`:`<img src="${p}" alt="${c}" class="prof-card-photo" style="${S}" />`}
                <span class="prof-card-name">${c}</span>
            </div>
        `}).join("")}function Cr(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function Lr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=u.professionalColors.get(s.professionalId)||{},d=v(s.reason),c=v(s.professionalName),m=v(s.clientName),b=v(s.serviceName);if(s.type==="blockage")return`
                ...
                </div>`;const p=s.status==="completed",f=p?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",h=p?"Finalizado":"Aberto",y=JSON.stringify(s).replace(/'/g,"&apos;"),S=s.redeemedReward?.points>0,I=s.hasRewards&&!S,$=Cr(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime);return`
            <div class="appointment-list-card" data-appointment='${y}' style="border-left-color: ${l.border};">
                ...
                <div class="details-info min-w-0" data-action="open-comanda">
                    <p class="font-bold text-gray-800 truncate">${I?"🎁 ":""}${m}</p>
                ...
                <div class="status-info">
                    ...
                    `;const k=JSON.stringify(b).replace(/'/g,"&apos;"),C=b.redeemedReward?.points>0,R=b.hasRewards&&!C,O=b.status==="completed";return`
        ...
        `}o+="</div>",t.innerHTML=o}function Pr(){const e=u.allEvents.filter(t=>B.selectedProfessionalId==="all"||t.professionalId===B.selectedProfessionalId);B.currentView==="list"?Lr(e):Tr(e)}async function te(){const e=document.getElementById("agenda-view");if(!e)return;e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const s=document.getElementById("weekRange");if(s){if(B.currentView==="list")t=new Date(B.currentDate),t.setHours(0,0,0,0),a=new Date(B.currentDate),a.setHours(23,59,59,999),s.textContent=Ir(t);else{const r=Ca();t=zo(new Date(B.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),s.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await Po(u.establishmentId,t.toISOString(),a.toISOString(),B.selectedProfessionalId==="all"?null:B.selectedProfessionalId),o=await jt(u.establishmentId,t.toISOString(),a.toISOString(),B.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const n=o.map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=u.professionals?u.professionals.find(m=>m.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(u.allEvents=i,Lt(),Pr(),B.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${B.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),B.scrollToAppointmentId=null}}catch(r){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',g("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"))}}}async function Br(){try{const[e,t,a]=await Promise.all([u.professionals&&u.professionals.length>0?Promise.resolve(u.professionals):X(u.establishmentId),u.services&&u.services.length>0?Promise.resolve(u.services):$e(u.establishmentId),qe.enabled!==void 0?Promise.resolve(null):Se(u.establishmentId)]);(!u.professionals||u.professionals.length===0)&&(u.professionals=e||[]),(!u.services||u.services.length===0)&&(u.services=t||[]),De=[],a&&(qe=a.loyaltyProgram||{enabled:!1}),u.professionals.forEach((s,r)=>{u.professionalColors.set(s.id,la[r%la.length])}),Lt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function da(e){e<1||e>4||(E.step=e,ca(null,!0))}function Vo(e,t){const a=document.getElementById("multiServiceToggle"),s=a&&a.checked,r=t.classList.contains("selected"),o=E.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),o>-1&&E.data.selectedServiceIds.splice(o,1);else{if(!s){E.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),E.data.selectedServiceIds.push(e)}}function Uo(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const s=zt.find(r=>r.id===e);E.data.professionalId=e,E.data.professionalName=s?s.name:"N/A"}function Dr(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(s=>s.classList.remove("selected")),t.classList.add("selected"),E.data.time=e)}async function Za(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=E.data.professionalId,s=E.data.selectedServiceIds,r=document.getElementById("apptDate").value;E.data.date=r;const o=s.reduce((n,i)=>{const l=it.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${o} min`,o===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await Ms({establishmentId:u.establishmentId,professionalId:a,serviceIds:s,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[m,b]=c.split(":").map(Number);return m*60+b>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${E.data.time===d?"selected":""}`,c.textContent=d,c.addEventListener("click",()=>Dr(d,c)),t.appendChild(c)}),E.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${E.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function Mr(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:s}=E.data,{enabled:r,rewards:o}=qe;if(!r||!t||!o||o.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const n=o.filter(l=>a>=l.points);let i=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(E.data.redeemedReward=null)})}async function Ar(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!E.data.time||E.data.selectedServiceIds.length===0||!E.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const s=E.data.selectedServiceIds.map(d=>{const c=it.find(m=>m.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,o]=E.data.time.split(":"),n=new Date(`${E.data.date}T${r}:${o}:00`),i={establishmentId:u.establishmentId,clientName:E.data.clientName,clientPhone:E.data.clientPhone,services:s,professionalId:E.data.professionalId,startTime:n.toISOString(),redeemedReward:E.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await ka(l,i):await As(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",te()}catch(d){g(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function _o(e){const t=E.data.clientName===e.name&&E.data.clientPhone===e.phone,a=v(e.name),s=v(e.phone);return`
    ...
    `;return{title:e,content:t}}function zr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,s=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=E.data.date||s,o=v(E.data.clientName),n=v(E.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function Vr(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),s=it.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=E.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${o?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Vo(r.dataset.serviceId,r))})}function Ur(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),s=zt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=E.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=v(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>Uo(r.dataset.professionalId,r))})}async function ca(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const o=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(E={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:o,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}},e&&e.clientName)try{const i=await He(u.establishmentId,e.clientName),l=i.find(d=>d.phone===e.clientPhone);l&&(E.data.clientLoyaltyPoints=l.loyaltyPoints||0,De=i)}catch(i){console.warn("Não foi possível carregar pontos do cliente para edição:",i)}}if(!u.services||!u.professionals||qe.enabled===void 0){g("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(it=u.services,zt=u.professionals.filter(o=>o.status==="active"),E.data.clientLoyaltyPoints>0){const o=qe,n=Math.min(...(o?.rewards||[]).map(i=>i.points));E.data.clientHasRewards=o.enabled&&n!==1/0&&E.data.clientLoyaltyPoints>=n}let s={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(E.step){case 1:s=jr(e);break;case 2:s=Hr();break;case 3:s=Or();break;case 4:s=zr(e);break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>{o.addEventListener("click",()=>{const n=parseInt(o.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(E.data.clientName=i.value.trim(),E.data.clientPhone=l.value.trim(),!E.data.clientName||!E.data.clientPhone)return g("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(E.data.selectedServiceIds.length===0)return g("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!E.data.professionalId)return g("Atenção","Selecione um profissional.","error");da(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>{o.addEventListener("click",()=>da(parseInt(o.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if(E.step===4&&r&&r.addEventListener("submit",Ar),a.style.display="flex",E.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Vo(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>Vr(i.target.value))}if(E.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>Uo(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>Ur(i.target.value))}if(E.step===1){const o=a.querySelector("#clientSearchInput");if(o&&(o.addEventListener("input",i=>Nr(i.target.value)),E.data.clientName&&E.data.clientPhone&&De.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=De.map(_o).join(""))}const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Fr)}if(E.step===4){const o=a.querySelector("#apptDate");o&&o.addEventListener("change",Za),Za(),Mr()}}async function Jo(e={}){B.currentDate=e.targetDate?new Date(e.targetDate):B.currentDate||new Date,B.scrollToAppointmentId=e.scrollToAppointmentId||null,B.profSearchTerm="",window.innerWidth<768&&(B.currentView="list"),Qa.innerHTML=`
        <section>
    ...
    `}function sn(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `;return}const a={atendimento:"confirmed",finalizadas:"completed"}[x.activeFilter],s=x.allComandas.filter(r=>r.status===a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',Ka(e);return}e.innerHTML=s.map(r=>{const n=Vt(r).reduce((p,f)=>p+(f.price||0),0),i=r.id===x.selectedComandaId,l=new Date(r.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=r.type==="walk-in"||r.id.startsWith("temp-"),c=v(r.clientName),m=v(r.professionalName),b=d?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md">Agendado</span>';return`
            <div data-action="select-comanda" data-comanda-id="${r.id}" 
                ...
                <div class="flex justify-between items-center mt-1">
                    <div class="flex items-center gap-2">
                        ${b}
                        <p class="text-xs text-gray-500 truncate max-w-[100px]">${m}</p>
                    </div>
    ...
    `;if(!x.isCashierOpen){e.innerHTML=`
        ...
        `;return}const a=x.allComandas.find(p=>p.id===x.selectedComandaId);if(!a){e.innerHTML=`
            <div class="hidden lg:flex flex-col items-center justify-center h-full text-center text-gray-400">
        ...
        `;return}const s=Vt(a),r=a.status==="completed",o=a.type==="walk-in"||a.id.startsWith("temp-"),n=o?"":`<button data-action="go-to-appointment" data-id="${a.id}" data-date="${a.startTime}" 
           ...
           </button>`,i=s.reduce((p,f)=>{const h=`${f.type}-${f.id||f.name}`;return p[h]||(p[h]={...f,quantity:0}),p[h].quantity+=1,p},{}),l=Object.values(i).reduce((p,f)=>p+(f.price||0)*f.quantity,0),d=v(a.clientName),c=v(a.professionalName),m=`
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    ${p.isReward?'<span class="text-yellow-700 font-bold">Prémio Fidelidade</span>':`R$ ${(p.price||0).toFixed(2)} un.`}
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            <span class="font-bold text-gray-900">R$ ${(p.price*p.quantity).toFixed(2)}</span>
                            ${r?"":`<button data-action="remove-item" data-item-id="${p.id}" data-item-type="${p.type}" class="text-red-400 hover:text-red-600 p-1 rounded-full hover:bg-red-50"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>`}
                        </div>
                    </div>
                `).join("")}
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",cn)}async function cn(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector('button[type="submit"]'),s=t.querySelector("#regClientName"),n=t.querySelector("#regClientPhone").value.trim().replace(/\D/g,""),i={establishmentId:u.establishmentId,name:s.value.trim(),email:t.querySelector("#regClientEmail").value.trim()||null,phone:n,dob:`${t.querySelector("#regClientDobDay").value.trim()}/${t.querySelector("#regClientDobMonth").value.trim()}`,notes:t.querySelector("#regClientNotes").value.trim()||null};if(!i.name||!n)return g("Erro de Validação","Nome e Telefone (apenas números) são obrigatórios.","error");a.disabled=!0,a.textContent="Verificando...";try{const l=await(void 0)(u.establishmentId,n);if(l)g("Atenção",`Cliente já cadastrado: ${l.name}. Selecionando existente...`,"info"),x.clients.find(c=>c.id===l.id)||x.clients.push(l),document.getElementById("genericModal").style.display="none",ua(l.id);else{a.textContent="A salvar...";const d=await(void 0)(i);x.clients.push({id:d.id,...i}),g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",ua(d.id)}}catch(l){g(`Erro ao processar: ${l.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar Cliente")}}function un(){if(!x.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:e,close:t}=_({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{let r="";const o=e.querySelector("#add-item-content"),n={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},i=()=>{const l=r.toLowerCase(),d=m=>m.filter(b=>b.name.toLowerCase().includes(l)),c={"modal-service-list":{items:d(x.catalog.services),type:"service"},"modal-product-list":{items:d(x.catalog.products),type:"product"},"modal-package-list":{items:d(x.catalog.packages),type:"package"}};for(const[m,{items:b,type:p}]of Object.entries(c)){const f=o.querySelector(`#${m}`);f&&(f.innerHTML=b.map(h=>`
                        <button data-action="select-item-for-quantity" data-item-type="${p}" data-item-id="${h.id}" class="flex items-center gap-3 w-full p-3 bg-white border rounded-lg hover:bg-gray-50 transition">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-gray-100">${n[p]}</div>
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{o>1&&(o--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{o++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Yo(r,o),t()}};e.addEventListener("click",r=>{const o=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(o){const{itemType:i,itemId:l}=o.dataset,c=(x.catalog[i+"s"]||[]).find(m=>m.id===l);c&&s({...c,type:i})}else n&&a()}),a()}async function ua(e=null){if(!x.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!x.clients||x.clients.length===0)try{x.clients=await He(u.establishmentId)}catch{g("Erro","Não foi possível carregar dados de clientes.","error");return}if(!u.professionals||u.professionals.length===0)try{u.professionals=await X(u.establishmentId)}catch{g("Erro","Não foi possível carregar dados de profissionais.","error");return}const t=x.clients.map(n=>{const i=n.id===e?"selected":"";return`<option value="${n.id}" ${i}>${v(n.name)} - ${v(n.phone)}</option>`}).join(""),a=u.professionals.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""),s=`
    ...
    `,{modalElement:r}=_({title:"Nova Venda Avulsa",contentHTML:s,maxWidth:"max-w-md"});r.querySelector("#new-sale-form").addEventListener("submit",hn);const o=r.querySelector('[data-action="new-client-from-sale"]');o&&o.addEventListener("click",n=>{n.preventDefault(),r.style.display="none",dn()})}function mn(){if(!x.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const e=x.allComandas.find(m=>m.id===x.selectedComandaId);if(!e)return;const t=Vt(e),a=new Set,s=[];for(const m of t){if(m.type==="service"&&m.id){if(a.has(m.id))continue;a.add(m.id)}s.push(m)}const r=s.reduce((m,b)=>m+(b.price||0),0);let o=[],n={remainingAmount:r,selectedMethod:"dinheiro",installments:1,amountReceived:""};const i=()=>{const m=document.getElementById("payment-list"),b=document.getElementById("remaining-amount"),p=document.getElementById("finalize-checkout-btn"),f=document.getElementById("change-container"),h=document.getElementById("installments-container"),y=document.getElementById("payment-value"),S=document.getElementById("payment-controls"),I=o.reduce((k,C)=>k+C.value,0);n.remainingAmount=r-I,m.innerHTML=o.map((k,C)=>`
            ...
            </div>`).join(""),n.remainingAmount<=.001?(b.textContent="Total Pago!",b.className="text-lg font-bold text-center mb-4 text-green-600",y.value="",p.disabled=!1,S&&(S.style.display="none")):(b.textContent=`Faltam: R$ ${n.remainingAmount.toFixed(2)}`,b.className="text-lg font-bold text-center mb-4 text-red-600",y.value=n.remainingAmount.toFixed(2),p.disabled=!0,S&&(S.style.display="block")),document.querySelectorAll(".payment-method-btn").forEach(k=>{k.classList.toggle("ring-2",k.dataset.method===n.selectedMethod),k.classList.toggle("ring-offset-2",k.dataset.method===n.selectedMethod)}),h.style.display=["credito","crediario"].includes(n.selectedMethod)?"block":"none",f.style.display=n.selectedMethod==="dinheiro"&&n.remainingAmount>0?"block":"none";const $=parseFloat(n.amountReceived)-n.remainingAmount;document.getElementById("change-value").textContent=`R$ ${$>0?$.toFixed(2):"0.00"}`},l=()=>{const m=document.getElementById("payment-value");let b=parseFloat(m.value);if(isNaN(b)||b<=0){g("Valor Inválido","Insira um valor de pagamento válido e maior que zero.","error");return}if(b>n.remainingAmount+.001){g("Valor Inválido","O valor excede o saldo restante.","error");return}const p={method:n.selectedMethod,value:b};["credito","crediario"].includes(n.selectedMethod)&&n.installments>1&&(p.installments=n.installments),o.push(p),n.selectedMethod="dinheiro",n.installments=1,document.getElementById("installments-select").value=1,i()},d=`
        ...
        <div id="payment-controls" class="space-y-4 border-t pt-4">
            ...
            <div id="installments-container" class="hidden"><label class="text-sm font-medium">Parcelas</label><select id="installments-select" class="w-full p-2 border rounded-md bg-white mt-1">${Array.from({length:12},(m,b)=>`<option value="${b+1}">${b+1}x</option>`).join("")}</select></div>
    ...
    `,{modalElement:c}=_({title:"Finalizar Pagamento",contentHTML:d,maxWidth:"max-w-md"});document.getElementById("payment-value").value=n.remainingAmount.toFixed(2),c.addEventListener("click",m=>{const b=m.target.closest(".payment-method-btn");b&&(n.selectedMethod=b.dataset.method,n.installments=1,document.getElementById("installments-select").value=1,i()),m.target.closest("#add-payment-btn")&&l(),m.target.closest('[data-action="remove-payment"]')&&(o.splice(parseInt(m.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),i()),m.target.closest("#finalize-checkout-btn")&&vn(e,r,o)}),c.addEventListener("change",m=>{m.target.id==="installments-select"&&(n.installments=parseInt(m.target.value,10))}),c.addEventListener("input",m=>{m.target.id==="amount-received"&&(n.amountReceived=m.target.value,i())}),i()}async function pn(){const e=`
    ...
    `,{modalElement:t}=_({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=document.getElementById("initial-amount"),r=s.value.trim(),o=document.getElementById("cashier-notes").value.trim(),n=parseFloat(r);if(r===""||isNaN(n)||n<0){g("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),s.focus();return}try{const i={establishmentId:u.establishmentId,initialAmount:parseFloat(n.toFixed(2))};o&&(i.notes=o);const l=await Yr(i);x.isCashierOpen=!0,x.activeCashierSessionId=l.id,await La(),document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto com valor inicial de R$ ${n.toFixed(2)}`,"success")}catch(i){g("Erro",`Não foi possível abrir o caixa: ${i.message}`,"error")}})}async function gn(){const e=x.activeCashierSessionId;if(e)try{const t=await Zr(e),a=`
    ...
    `,document.getElementById("btn-filter").onclick=kn,document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{N.currentTab=a.dataset.tab,eo(),Xo()}}),eo()}function eo(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===N.currentTab;e.className=t?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function kn(){N.startDate=document.getElementById("report-start").value,N.endDate=document.getElementById("report-end").value,N.selectedProfessional=document.getElementById("report-prof").value,N.selectedCostCenter=document.getElementById("report-cost").value,await Qo()}async function Qo(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const t=hr(N.startDate,N.endDate,N.selectedProfessional,N.selectedCostCenter),a=N.selectedProfessional==="all"?null:N.selectedProfessional,s=new Date(N.startDate+"T00:00:00").toISOString(),r=new Date(N.endDate+"T23:59:59").toISOString(),o=Po(u.establishmentId,s,r,a).catch(l=>[]),[n,i]=await Promise.all([t,o]);N.data=n,N.appointmentsData=Array.isArray(i)?i:[],Xo()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function Xo(){const e=document.getElementById("report-content");if(N.data)switch(N.currentTab){case"dashboards":Sn(e);break;case"appointments":$n(e);break;case"dre":En(e);break}}function Sn(e){const{dreSimple:t,charts:a}=N.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0},r=N.data.totalAppointments||0,o=r>0?s.grossRevenue/r:0;e.innerHTML=`
    ...
    `,We("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,ut[0]);const n=a.professionals.labels.map(l=>v(l));We("chart-profs","doughnut","Total Vendas",n,a.professionals.data,ut),We("chart-daily","line","Vendas Diárias",a.salesDaily.labels,a.salesDaily.data,ut[4]);const i=a.products.labels.map(l=>v(l));We("chart-products","bar","Total Vendido",i,a.products.data,ut[1])}function $n(e){const t=N.appointmentsData,a=t.length;let s=0,r=0,o=0,n=0;const i={},l={};let d=new Date(N.startDate);const c=new Date(N.endDate);for(;d<=c;)i[d.toISOString().split("T")[0]]=0,d.setDate(d.getDate()+1);t.forEach(f=>{const h=parseFloat(f.totalAmount||f.price||0),y=(f.status||"").toLowerCase();let S=f.startTime?(f.startTime.toDate?f.startTime.toDate():new Date(f.startTime)).toISOString().split("T")[0]:"";const I=f.professionalName||"Sem Profissional";l[I]||(l[I]={name:I,count:0,value:0}),["cancelled","cancelado","no-show"].includes(y)?(r++,n+=h):(["completed","finalized","paid"].includes(y)&&s++,o+=h,S&&i.hasOwnProperty(S)&&i[S]++,l[I].count++,l[I].value+=h)});const m=Object.keys(i).sort(),b=m.map(f=>i[f]),p=Object.values(l).sort((f,h)=>h.count-f.count);e.innerHTML=`
    ...
    `,We("dailyApptChart","line","Agendamentos",m.map(f=>f.split("-").reverse().slice(0,2).join("/")),b,"#4f46e5")}function En(e){const{dreFinancial:t}=N.data,a=Object.entries(t.revenues).map(([r,o])=>`
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async k=>{const C=k.target.closest("button[data-action]");if(!C)return;const R=C.dataset.action,O=C.dataset.id;if(R==="close-modal"&&(t.style.display="none"),R==="delete-service"){if(!O)return;if(t.style.display="none",await H("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const T=u.services.find(A=>A.id===O)?.name||"Desconhecido";await Xs(O),Re(u.establishmentId,Fe(),"Serviços","Excluiu",`Excluiu o serviço: ${T}`),g("Sucesso","Serviço apagado com sucesso!","success"),await lt()}catch(T){g("Erro",`Não foi possível apagar o serviço: ${T.message}`,"error")}else t.style.display="flex"}});const d=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");d.forEach(k=>{k.addEventListener("click",()=>{d.forEach(C=>{C.classList.remove("border-indigo-500","text-indigo-600"),C.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),k.classList.add("border-indigo-500","text-indigo-600"),k.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),c.forEach(C=>C.classList.add("hidden")),document.getElementById(`tab-content-${k.dataset.tab}`).classList.remove("hidden")})});const m=t.querySelectorAll('input[name="commissionType"]'),b=document.getElementById("defaultCommissionRateContainer"),p=document.getElementById("professionalCommissionsContainer");function f(){const k=t.querySelector('input[name="commissionType"]:checked').value;b&&(b.style.display=k==="default"?"block":"none"),p&&(p.style.display=k==="custom"?"block":"none")}m.forEach(k=>k.addEventListener("change",f));const h=document.getElementById("professionalCommissionsList");h&&(h.innerHTML=(u.professionals||[]).map(k=>{const C=e?.professionalCommissions?.[k.id]!==void 0,R=e?.professionalCommissions?.[k.id]||0;return`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(u.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),Pa(),Te()}function Dn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="flex justify-between items-center mb-4">
                <h2 id="productModalTitle" class="text-2xl font-bold text-gray-800">${p}</h2>
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const f=t.querySelector("#productCategory"),h=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>h.click()),f.innerHTML='<option value="">Sem categoria</option>'+(u.categories||[]).map(L=>`<option value="${L.id}" ${e?.categoryId===L.id?"selected":""}>${v(L.name)}</option>`).join(""),e&&(f.value=e.categoryId||"");const y=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const S=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",I=e?.photo||"";h.onchange=async()=>{const L=h.files[0];if(L){y.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const T=await ao(L,800,800,"image/jpeg",.8),q=T.length*3/4,z=1e3*1024;if(q>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=T,base64Input.value=T}catch(T){console.error("Erro ao processar imagem:",T),g("Erro de Imagem",T.message||"Não foi possível processar a imagem.","error"),preview.src=S,base64Input.value=I,O.value=""}}};const $=t.cloneNode(!0);t.parentNode.replaceChild($,t);const k=()=>{const L=$.querySelector("#modalSupplierSearch"),T=$.querySelector("#supplierSearchResults"),A=$.querySelector("#selectedSuppliersList"),q=L.value.toLowerCase();if(q.length>0){const z=s.filter(M=>M.name.toLowerCase().includes(q)&&!o.has(M.id));z.length>0?(T.classList.remove("hidden"),T.innerHTML=z.map(M=>`
                ...
                `).join("")):(T.classList.remove("hidden"),T.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else T.classList.add("hidden");o.size>0?(A.innerHTML="",o.forEach(z=>{const M=s.find(Y=>Y.id===z);M&&(A.innerHTML+=`
                    ...
                    `)})):A.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};$.querySelector("#modalSupplierSearch").addEventListener("input",k),$.addEventListener("click",L=>{const T=L.target.closest("[data-add-supplier]");if(T){const q=T.dataset.addSupplier;o.add(q),$.querySelector("#modalSupplierSearch").value="",k()}const A=L.target.closest("[data-remove-supplier]");if(A){const q=A.dataset.removeSupplier;o.delete(q),k()}}),k(),$.addEventListener("click",async L=>{const T=L.target.closest("button[data-action]");if(!T)return;const A=T.dataset.action,q=$.querySelector("#productId").value;if(A==="close-modal"&&($.style.display="none"),A==="delete-product"){if(!q)return;$.style.display="none",await Un(q)}if(A==="save-product-modal"){const z=$.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const M=T.closest('button[data-action="save-product-modal"]');M.disabled=!0,M.textContent="A salvar...";try{await _n(z)}catch(Y){g("Erro",`Falha ao salvar: ${Y.message}`,"error"),M.disabled=!1,M.textContent="Salvar Alterações"}}}if(A==="adjust-stock-modal"){L.preventDefault();const z=$.querySelector("#stockAdjustmentAmount"),M=$.querySelector("#stockAdjustmentReason"),Y=parseInt(z.value,10),Ee=parseInt(T.dataset.change,10);if(!Y||Y<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Gt=Y*Ee,fs=M.value||(Gt>0?"Entrada manual":"Saída manual");try{await ar(q,{change:Gt,reason:fs});const ze=u.products.findIndex(Ve=>Ve.id===q);if(ze>-1){const Ve=u.products[ze].currentStock+Gt;u.products[ze].currentStock=Ve,$.querySelector("#currentStockDisplay").textContent=Ve,$.querySelector("#productCurrentStock").value=Ve,z.value="",M.value="",g("Sucesso","Estoque atualizado!","success"),Aa(),st()}}catch(ze){g("Erro de Stock",ze.message,"error")}}});const C=$.querySelectorAll(".tab-btn"),R=$.querySelectorAll(".tab-content");C.forEach(L=>{L.addEventListener("click",T=>{T.preventDefault(),C.forEach(A=>{A.classList.remove("border-indigo-500","text-indigo-600"),A.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),L.classList.add("border-indigo-500","text-indigo-600"),L.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),R.forEach(A=>A.classList.add("hidden")),document.getElementById(`tab-content-${L.dataset.tab}`).classList.remove("hidden")})});const O=$.querySelector("#productPhotoInput");$.querySelector("#productPhotoButton").addEventListener("click",()=>O.click()),O.onchange=async()=>{const L=O.files[0];if(!L)return;const T=$.querySelector("#productPhotoPreview"),A=$.querySelector("#productPhotoBase64");T.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const q=await ao(L,800,800,"image/jpeg",.8),M=q.length*3/4,Y=1e3*1024;if(M>Y)throw new Error("A imagem é muito grande mesmo após a compressão.");T.src=q,A.value=q}catch(q){console.error("Erro ao processar imagem:",q),g("Erro de Imagem",q.message||"Não foi possível processar a imagem.","error"),T.src=S,A.value=I,O.value=""}},$.style.display="flex"}function Jn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(u.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),Aa(),st()}function Wn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        ...
        </div>`;const r=document.getElementById("productFilterReport"),o=document.getElementById("categoryFilterReport");r&&u.products&&(r.innerHTML+=u.products.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join("")),o&&u.categories&&(o.innerHTML+=u.categories.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""))}async function Gn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:u.establishmentId};try{const a=await or(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
        ...
        </section>`,ie&&(pe.removeEventListener("click",ie),pe.removeEventListener("input",ie),pe.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){st();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){as(a.dataset.view);return}switch(a.dataset.action){case"new-product":oo();break;case"edit-product":oo(JSON.parse(a.dataset.product));break;case"manage-product-categories":Vn();break;case"generate-report":await Gn();break;case"filter-stock":const r=a.dataset.filterType;ae=ae===r?"all":r,document.querySelectorAll(".indicator-card").forEach(o=>{o.classList.toggle("ring-2",o.dataset.filterType===ae),o.classList.toggle("ring-indigo-500",o.dataset.filterType===ae),o.classList.toggle("shadow-lg",o.dataset.filterType===ae)}),st();break}},pe.addEventListener("click",ie),pe.addEventListener("input",ie),pe.addEventListener("change",ie),Xe="products",ae="all",await dt()}const ge=document.getElementById("content");let le=null,$t="list",j={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Qn(){$t==="list"?Jt():$t==="purchases"?(j.step=1,Ze()):$t==="history"&&os()}async function Xn(){try{const e=await Da(u.establishmentId);return u.suppliers=e||[],j.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Zn(e){if(await H("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await Rn(e),g("Sucesso","Fornecedor excluído.","success"),Rt("genericModal"),Jt()}catch(t){g("Erro","Erro ao excluir: "+t.message,"error")}}async function Kn(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:u.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await qn(a,s),g("Sucesso","Fornecedor atualizado!","success")):(await Nn(s),g("Sucesso","Fornecedor criado!","success")),Rt("genericModal"),Jt()}catch(o){g("Erro","Erro ao salvar: "+o.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Jt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Xn();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=u.suppliers.filter(o=>o.name.toLowerCase().includes(t)||o.contactName&&o.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let s='<div class="flex flex-col gap-2 md:hidden">';a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.category||"Geral"),d=v(o.contactName||"");s+=`
    ...
    `;a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.taxId||"Sem doc."),d=v(o.email||"-"),c=v(o.phone||"-"),m=v(o.category||"Geral");r+=`
            <tr class="hover:bg-gray-50">
    ...
    `;_({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Ze(){const e=document.getElementById("purchasesContainer");if(e)if(j.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([Ft(u.establishmentId),Da(u.establishmentId)]);j.allSuppliers=a||[];const s=t.filter(d=>{const c=parseInt(d.currentStock||0),m=parseInt(d.minStock||0);return c<=m});if(j.productsToBuy=s,s.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',o="";s.forEach(d=>{const c=parseInt(d.minStock)||0,m=parseInt(d.currentStock)||0,b=Math.max(c-m,1),p=parseFloat(d.costPrice||0),f=v(d.name);let h='<option value="">Selecione...</option>';j.allSuppliers.length>0?j.allSuppliers.forEach(y=>{const I=d.supplierIds&&d.supplierIds.includes(y.id)?"selected":"";h+=`<option value="${y.id}" ${I}>${v(y.name)}</option>`}):h='<option value="">Sem fornecedores</option>',r+=`
                    <div class="product-row bg-white p-3 rounded-lg shadow-sm border border-gray-200" data-product-id="${d.id}" data-cost="${p}">
                        <div class="flex justify-between items-start mb-2">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Custo: R$ ${p.toFixed(2)}</p>
                                </div>
                            </div>
                            <div class="text-right">
                        ...
                        <div class="mt-2 pt-2 border-t border-gray-100 flex justify-between items-center">
                            ...
                            <span class="row-subtotal font-bold text-indigo-600 text-sm">R$ ${(b*p).toFixed(2)}</span>
                        </div>
                    </div>
                `,o+=`
                    <tr class="hover:bg-gray-50 border-b border-gray-100 product-row" data-product-id="${d.id}" data-cost="${p}">
                        ...
                        <td class="p-3 text-right text-sm text-gray-600">R$ ${p.toFixed(2)}</td>
                        <td class="p-3 text-right text-sm font-bold text-gray-800 row-subtotal">R$ ${(b*p).toFixed(2)}</td>
                        <td class="p-3 w-48">
        ...
        `}).join("");s+=f;const y=encodeURIComponent(JSON.stringify({supplierId:b,supplierName:p.info.name,totalAmount:f,items:p.items})),S=encodeURIComponent(JSON.stringify({name:p.info.name,phone:p.info.phone,email:p.info.email})),I=encodeURIComponent(JSON.stringify(p.items)),$=v(p.info.name),k=v(p.info.email||"");a+=`
    ...
    `}async function os(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await Hn(u.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(o=>{const n=new Date(o.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=v(o.supplierName);a+=`
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=u.establishmentId,a.disabled=!0,a.textContent="A processar...",Se(u.establishmentId).then(r=>{const o=r.purchaseConfig||null;return Fn(s,o)}).then(()=>{g("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;H("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await jn(s,u.establishmentId),g("Sucesso","Compra e financeiro excluídos.","success"),os()}catch(o){g("Erro","Erro ao excluir: "+o.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=j.finalOrders[s];r?oi(r,j.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);ai(s)}},ge.addEventListener("click",le),ge.addEventListener("input",le),ge.addEventListener("change",le),mt("list")}function mt(e){$t=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Qn()}const Xt=document.getElementById("content"),ro={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let se=new Set,pt=null,Pe=null;function ri(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",li(a,r),di(a),ci(a,o),mi(a)}function li(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,S)=>{const I=S+1,$=I==s[1]?"selected":"",k=new Date(0,S).toLocaleString("pt-BR",{month:"long"});return`<option value="${I}" ${$}>${k.charAt(0).toUpperCase()+k.slice(1)}</option>`}).join(""),o=e.status||"active",n=v(e.name||""),i=v(e.specialty||""),l=v(e.phone||""),d=v(e.notes||"");a.innerHTML=`
        ...
        </div>`;const s=document.getElementById("batchBlockageForm");s&&s.addEventListener("submit",async o=>{o.preventDefault();const n=Array.from(o.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(p=>p.value);if(n.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const i=o.target.batchBlockageStartDate.value,l=o.target.batchBlockageEndDate.value||i,d=o.target.batchBlockageStartTime.value,c=o.target.batchBlockageEndTime.value,m=o.target.batchBlockageReason.value;if(!i||!d||!c)return g("Atenção","Preencha Data de Início, Início e Fim.","error");const b=n.map(p=>{const f={professionalId:p,establishmentId:u.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${c}`).toISOString(),reason:m};return Ht(f)});try{await Promise.all(b),g("Sucesso!",`${n.length} bloqueios foram criados.`);const p=document.getElementById("prof-blockages-filter").value;Ke(e.id,p)}catch(p){g("Erro",p.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",o=>Ke(e.id,o.target.value)),await Ke(e.id,"future")}function ui(e,t){e.innerHTML=Object.keys(ro).map(a=>{const s=t[a]||{},r=s.active!==!1;return`
    ...
    `;if(_({title:"",contentHTML:a,maxWidth:"max-w-3xl"}),window.switchTab=s=>fa(s,t),window.handleSave=hi,window.handleDelete=xi,!t)try{F.history=await Sr(u.establishmentId,e.phone)}catch(s){console.error("Erro ao carregar histórico",s),F.history=[]}fa("details",t)},fa=(e,t)=>{const a=document.getElementById("modal-body");if(!a)return;document.querySelectorAll('[id^="tab-btn-"]').forEach(o=>{o.classList.remove("border-indigo-600","text-indigo-600"),o.classList.add("border-transparent","text-gray-500")});const s=document.getElementById(`tab-btn-${e}`);s&&(s.classList.add("border-indigo-600","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"));const r=F.currentClient||{};if(e==="details"){if(a.innerHTML=`
        ...
        `,window.handleRedeem=async(i,l)=>{if(await H("Resgatar",`Trocar ${i} pontos por "${l}"?`))try{await Er(u.establishmentId,r.phone,i,l),g("Sucesso","Resgate realizado!","success"),r.loyaltyPoints=(r.loyaltyPoints||0)-parseInt(i),F.history.unshift({type:"loyalty",description:`Resgate: ${l}`,date:new Date().toISOString(),value:-i,isPoints:!0,status:"completed"}),fa("loyalty",!1)}catch(d){g("Erro",d.message||"Erro ao resgatar","error")}}}},hi=async()=>{const e=document.getElementById("form-client"),t=new FormData(e),a=t.get("phone").replace(/\D/g,"");if(a.length<10){g("Erro","Telefone inválido","error");return}const s={name:t.get("name"),phone:a,email:t.get("email"),birthDate:t.get("birthDate"),notes:t.get("notes"),establishmentId:u.establishmentId};try{await kr(s),g("Sucesso","Cliente salvo!","success"),document.getElementById("genericModal").style.display="none",je()}catch(r){g("Erro","Erro ao salvar cliente","error"),console.error(r)}},xi=async()=>{if(await H("Excluir","Tem certeza? Isso apagará o histórico deste cliente."))try{await $r(F.currentClient.phone),g("Sucesso","Cliente removido","success"),document.getElementById("genericModal").style.display="none",je()}catch{g("Erro","Erro ao remover","error")}},yi=()=>{const e=document.getElementById("clients-grid");if(e){if(e.innerHTML="",F.clients.length===0){e.innerHTML=`
    ...
    `;try{const[a,s]=await Promise.all([rt(u.establishmentId),nt(u.establishmentId)]),r=e.financialIntegration||{},o=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ce(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ce(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ce(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ce(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ce(a,o.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ce(s,o.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Oe(s,a)})}function Wi(e,t){const a="5516997859430",s=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${s}`;t.innerHTML=`
    ...
    `,!W)try{W=await Se(u.establishmentId)}catch{g("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),he.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const e=V.currentUser;e&&e.displayName&&(u.userName=e.displayName);const t=v(u.userName||V.currentUser.email);let s=`https://placehold.co/96x96/E2E8F0/4A5568?text=${t?t.charAt(0).toUpperCase():"U"}`;e&&e.photoURL&&(s=e.photoURL),he.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
    ...
    `,he.querySelector("#settings-menu-list").addEventListener("click",o=>{const n=o.target.closest("button[data-section]");n&&(o.preventDefault(),Xi(n.dataset.section))});const r=he.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",o=>{o.preventDefault(),re("my-profile-section")})}const et=document.getElementById("content");async function Me(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await jt(u.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let b=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${v(l)} (${d.length})</h4>`;if(d.length>1){const p=JSON.stringify(d.map(f=>f.id));b+=`<button data-action="batch-delete-blockage" data-ids='${p}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}b+="</div>",c.innerHTML=b,d.forEach(p=>{const f=new Date(p.startTime),h=new Date(p.endTime),y=f.toLocaleDateString("pt-BR"),S=h.toLocaleDateString("pt-BR"),$=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        ...
                        <button class="p-1 rounded-full text-gray-500 hover:bg-gray-100 hover:text-red-600" data-action="delete-blockage" data-id="${p.id}">Apagar</button>
                    </div>`;c.innerHTML+=$}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Zi(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||s,o=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:u.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Ht(i),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),Me(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Ki(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||s,o=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const m={establishmentId:u.establishmentId,professionalId:c,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Ht(m)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(m=>m.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Me(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function el(e){et.addEventListener("submit",t=>{t.target.id==="blockageForm"&&Zi(t),t.target.id==="batchBlockageForm"&&Ki(t)}),et.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Me(e)}),et.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")re("profissionais-section");else if(s==="delete-blockage"){if(await H("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Ia(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),Me(e)}catch(o){g("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await H("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Ho(r),g("Sucesso",`${r.length} bloqueios removidos.`,"success"),Me(e)}catch(n){g("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function tl(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){et.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);et.innerHTML=`
        <section>
        ...
        </section>`,el(t),await Me(t);const r=document.getElementById("batchProfSelectionContainer");try{const o=await X(u.establishmentId);r.innerHTML=o.map(n=>`
            <div class="flex items-center">
    ...
    `}).join("")}function Et(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=u.users:t=u.users.filter(a=>a.status==="active"),cl(t)}function ul(e={}){return Object.entries(ll).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,o=Object.entries(dl).map(([i,l])=>`
    ...
    `;const b=window.innerWidth<768,p=m.querySelector(".bg-white");if(b&&p){p.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const S=m.closest("section");S&&(S.style.padding="0",S.style.margin="0"),p.classList.add("p-4")}const f=m.querySelector("#userProfessionalId"),h=m.querySelector("#userPhotoPreview"),y=m.querySelector("#profPhotoName");if(f.addEventListener("change",S=>{const I=S.target.value,$=s(I),k=$?$.name:"Selecione um profissional",C=r(I,n);h.src=C.photoSrc,y.textContent=k,m.querySelector("#professionalPhotoUrl").value=C.photoUrl}),m.addEventListener("submit",async S=>{S.preventDefault();const I=e?.email,$=m.querySelector("#userEmail").value,k={};m.querySelectorAll('input[type="checkbox"]').forEach(O=>{const L=O.dataset.module,T=O.dataset.permission;k[L]||(k[L]={}),k[L][T]=O.checked});const C=m.querySelector("#userProfessionalId").value||null,R={name:m.querySelector("#userName").value,permissions:k,professionalId:C,establishmentId:u.establishmentId};try{c?(I!==$&&(R.email=$),await sl(e.id,R),g("Usuário atualizado com sucesso!","success")):(R.email=m.querySelector("#userEmail").value,R.password=m.querySelector("#userPassword").value,await ol(R),g("Usuário criado com sucesso!","success")),Bt()}catch(O){g(`Erro: ${O.message}`,"error")}}),c){const S=m.querySelector("#password-change-container"),I=S.querySelector('[data-action="show-password-form"]'),$=S.querySelector("#password-form"),k=$.querySelector('[data-action="save-password"]'),C=$.querySelector('[data-action="cancel-password-change"]');I.addEventListener("click",()=>{I.classList.add("hidden"),$.classList.remove("hidden")}),C.addEventListener("click",()=>{I.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}),k.addEventListener("click",async()=>{const R=$.querySelector("#userNewPassword").value;if(!R||R.length<6){g("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await H("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{k.disabled=!0,k.textContent="Aguarde...",await nl(e.id,R),g("Sucesso!","A senha do usuário foi alterada.","success"),I.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}catch(L){g("Erro",`Não foi possível alterar a senha: ${L.message}`,"error")}finally{k.disabled=!1,k.textContent="Salvar Nova Senha"}})}}async function ml(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([al(u.establishmentId),X(u.establishmentId)]);u.users=t,u.professionals=a,Et()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Bt(){be.innerHTML=`
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=va.transactions[l];d&&uo(d)})}),n.innerHTML=a.map((i,l)=>{const d=v(i.client),c=v(i.items),m=v(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=va.transactions[l];d&&uo(d)})})}async function mo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,n=await yr({establishmentId:u.establishmentId,startDate:s,endDate:r,cashierSessionId:o});va=n,e.innerHTML=`
        ...
        `,fl(n)}catch(o){g("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function vl(){gl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];pl.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),i=t.querySelector("#itemParent"),l=c=>{const m=Na(c);if(ps(n,m,e),i){i.innerHTML='<option value="">-- Nível Principal --</option>';const b=(p,f="",h=0)=>{const y=h>0?"— ".repeat(h):"";i.innerHTML+=`<option value="${p.id}">${y}${p.name}</option>`,p.children.forEach(S=>b(S,f+"— "))};m.forEach(p=>b(p))}};try{const c=await r(u.establishmentId);P[o]=c,l(c)}catch(c){console.error(c)}const d=t.querySelector("#hierarchyForm");d&&d.addEventListener("submit",async c=>{c.preventDefault();const m=t.querySelector("#itemName");if(!m)return;const b=m.value,p=i.value,f=a?ki:$i;try{await f({name:b,parentId:p||null,establishmentId:u.establishmentId});const h=await r(u.establishmentId);P[o]=h,l(h),d.reset(),await we()}catch(h){g("Erro",`Não foi possível criar: ${h.message}`,"error")}})}function xl(e){const t=document.getElementById("cashFlowChart");if(!t)return;const a=t.getContext("2d");ea&&ea.destroy();const s=e.payables.map(r=>r*-1);ea=new Chart(a,{type:"bar",data:{labels:e.labels,datasets:[{label:"Receitas",data:e.receivables,backgroundColor:"rgba(74, 222, 128, 0.6)",borderColor:"rgba(34, 197, 94, 1)",borderWidth:1,yAxisID:"y"},{label:"Despesas",data:s,backgroundColor:"rgba(248, 113, 113, 0.6)",borderColor:"rgba(239, 68, 68, 1)",borderWidth:1,yAxisID:"y"},{label:"Saldo Acumulado",data:e.expectedBalance,type:"line",borderColor:"rgba(59, 130, 246, 1)",backgroundColor:"rgba(59, 130, 246, 0.2)",borderWidth:3,pointRadius:4,pointBackgroundColor:"rgba(59, 130, 246, 1)",fill:!0,tension:.1,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{x:{stacked:!0},y:{type:"linear",display:!0,position:"left",stacked:!0,title:{display:!0,text:"Movimentações (R$)"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Saldo Acumulado (R$)"},grid:{drawOnChartArea:!1}}},plugins:{tooltip:{callbacks:{label:function(r){let o=r.dataset.label||"";if(o&&(o+=": "),r.parsed.y!==null){const n=Math.abs(r.parsed.y);o+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(n)}return o}}}}}})}async function go(){const e=document.getElementById("cash-flow-chart-container"),t=document.getElementById("cashFlowStartDate"),a=document.getElementById("cashFlowEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r){g("Atenção","Por favor, selecione as datas de início e fim.","error");return}e.innerHTML='<div class="loader mx-auto my-10"></div>';try{const o=await qi(u.establishmentId,s,r);document.getElementById("cash-flow-chart-container")&&(e.innerHTML='<canvas id="cashFlowChart"></canvas>',xl(o))}catch(o){document.getElementById("cash-flow-chart-container")&&(e.innerHTML=`<p class="text-red-500 text-center">Erro ao carregar dados do gráfico: ${o.message}</p>`)}}function bo(){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const e=document.getElementById("genericModal"),t=new Date,a=new Date(t.getFullYear(),t.getMonth(),1).toISOString().split("T")[0],s=t.toISOString().split("T")[0];e.innerHTML=`
    ...
    `,e.style.display="flex";const r=e.querySelector("#generateCashFlowBtn");r&&(r.addEventListener("click",go),go())}function yl(){const e=document.getElementById("genericModal"),t=P.payables.filter(m=>m.status==="pending").reduce((m,b)=>m+b.amount,0),a=P.receivables.filter(m=>m.status==="pending").reduce((m,b)=>m+b.amount,0),s=a-t,r=P.payables.filter(m=>m.status==="paid").reduce((m,b)=>m+b.amount,0),o=P.receivables.filter(m=>m.status==="paid").reduce((m,b)=>m+b.amount,0),n=o-r,i=P.previousBalance||0,l=i+n,d=m=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(m),c=m=>m>=0?"text-green-600":"text-red-600";e.innerHTML=`
    ...
    `,e.style.display="flex"}function ft(e,t="all"){let a='<option value="all">Todos</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i=0)=>{const l=i>0?"— ".repeat(i):"",d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${l}${n.name}</option>`,n.children.forEach(c=>r(c,i+1))};return s(e).forEach(n=>r(n)),a}async function we(){const e=document.getElementById("financial-content");if(!e)return;const t=document.getElementById("filterStartDate"),a=document.getElementById("filterEndDate");if(!t||!a)return;const s=t.value,r=a.value,o=document.getElementById("filterNaturezaId")?.value,n=document.getElementById("filterCostCenterId")?.value;if(!s||!r){try{const[d,c]=await Promise.all([rt(u.establishmentId),nt(u.establishmentId)]);if(!document.getElementById("financial-content"))return;P={...P,natures:d,costCenters:c},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=ft(P.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=ft(P.costCenters))}catch(d){g("Erro",`Não foi possível carregar os dados base: ${d.message}`,"error")}ha(),vo();return}const i=document.getElementById("payables-list"),l=document.getElementById("receivables-list");i&&(i.innerHTML='<div class="loader mx-auto"></div>'),l&&(l.innerHTML='<div class="loader mx-auto"></div>');try{const d={startDate:s,endDate:r,establishmentId:u.establishmentId};o&&o!=="all"&&(d.natureId=o),n&&n!=="all"&&(d.costCenterId=n);const[c,m,b,p]=await Promise.all([Ci(d),Di(d),rt(u.establishmentId),nt(u.establishmentId)]);if(!document.getElementById("financial-content"))return;const f=(m.previousBalance||0)-(c.previousBalance||0);P={...P,payables:c.entries||[],receivables:m.entries||[],natures:b||[],costCenters:p||[],previousBalance:f,filterNaturezaId:o,filterCostCenterId:n},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=ft(P.natures,P.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=ft(P.costCenters,P.filterCostCenterId)),ha(),vo()}catch(d){document.getElementById("financial-content")&&(g("Erro",`Não foi possível carregar os dados: ${d.message}`,"error"),e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function kl(e,t,a=null){e.preventDefault();const s=e.target,r=s.querySelector('[name="status"]').checked,o=s.querySelector('[name="paymentDate"]').value,n=parseFloat(s.querySelector('[name="amount"]').value),i=parseInt(s.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(n)){g("Erro de Validação","O valor inserido é inválido.","error");return}if(r&&!o){g("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:s.querySelector('[name="description"]').value,amount:n,dueDate:s.querySelector('[name="dueDate"]').value,naturezaId:s.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:s.querySelector('[name="centroDeCustoId"]').value||null,notes:s.querySelector('[name="notes"]').value,status:r?"paid":"pending",paymentDate:r?o:null,installments:a?1:i,establishmentId:u.establishmentId};try{a?(await(t==="payable"?Li(a,l):Mi(a,l)),g("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?Ii(l):Bi(l)),g("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await we()}catch(d){g("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function Sl(e,t){if(await H("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?Ti(t):Ai(t)),g("Sucesso","Lançamento excluído!","success"),await we()}catch(s){g("Erro",`Falha ao excluir: ${s.message}`,"error")}}async function $l(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Pi(t,a):Ni(t,a)),g("Sucesso","Lançamento atualizado!","success"),await we()}catch(s){g("Erro",`Falha ao atualizar status: ${s.message}`,"error")}}function fo(e){const t=P.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function ha(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(P.natures.map(i=>[i.id,i.name])),s=new Map(P.costCenters.map(i=>[i.id,i.name])),r=fo(P.payables),o=fo(P.receivables),n=(i,l)=>{const d=i.status==="paid",c=JSON.stringify(i).replace(/'/g,"&apos;"),m=i.naturezaId?a.get(i.naturezaId):"N/A",b=i.centroDeCustoId?s.get(i.centroDeCustoId):"N/A";let p=l==="payable"?"text-red-600":"text-green-600";const f=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",h=d?"Finalizado":"Pendente";return d&&(p="text-gray-500"),`
        <div class="bg-white p-3 rounded-lg shadow-sm border-l-4 ${d?"border-gray-300 opacity-70":l==="payable"?"border-red-400":"border-green-400"}">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2 text-right">
                    <p class="font-bold text-lg ${p}">R$ ${i.amount.toFixed(2)}</p>
    ...
    `;if(a.innerHTML=`
        ...
        </div>`,a.style.display="flex",t){const b=a.querySelector('[name="naturezaId"]');b&&(b.value=t.naturezaId||"");const p=a.querySelector('[name="centroDeCustoId"]');p&&(p.value=t.centroDeCustoId||"")}const d=a.querySelector("#status"),c=a.querySelector("#payment-date-container"),m=a.querySelector('[name="paymentDate"]');t?.status==="paid"&&(d.checked=!0,c.classList.remove("hidden"),m.value=t.paymentDate||new Date().toISOString().split("T")[0]),d.addEventListener("change",()=>{c.classList.toggle("hidden",!d.checked),m.required=d.checked}),a.querySelector("#financial-form").addEventListener("submit",b=>kl(b,e,t?.id))}async function El(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth()-1,1).toISOString().split("T")[0],s=e.toISOString().split("T")[0];P.startDate=a,P.endDate=s,P.currentFilter="pending",P.filterNaturezaId="all",P.filterCostCenterId="all",hl.innerHTML=`
        <section>
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),m=(p,f)=>{const h=f.querySelector("#originalPrice"),y=p.reduce((S,I)=>S+I.price*I.quantity,0);h&&(h.textContent=`R$ ${y.toFixed(2)}`)},b=p=>{p.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=p.map((f,h)=>{const y=f.type==="service",S=y?"Serviço":"Produto",I=y?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),m(p,t)};b(s),c.addEventListener("change",p=>{if(p.target.classList.contains("quantity-input")){const f=parseInt(p.target.dataset.index,10),h=parseInt(p.target.value,10);h>0&&s[f]&&(s[f].quantity=h,b(s))}}),c.addEventListener("click",p=>{if(p.target.classList.contains("remove-item-btn")){const f=parseInt(p.target.dataset.index,10);s.splice(f,1),b(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Jl(p=>{const f=s.find(h=>h.id===p.id&&h.type===p.type);f?f.quantity++:s.push({...p,quantity:1}),b(s)}),Be&&t.removeEventListener("click",Be),Be=async p=>{const f=p.target.closest("button[data-action]");if(!f)return;const h=f.dataset.action;if(p.stopPropagation(),h==="close-modal"&&xo(),h==="save-package"){const y=f,S={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce((I,$)=>I+$.price*$.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:u.establishmentId};if(!S.name||!S.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(S.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}y.disabled=!0,y.textContent="A salvar...";try{a?await en(S.id,S):(delete S.id,await Kr(S)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),xo(),await Ra()}catch(I){g("Erro",`Não foi possível salvar o pacote: ${I.message}`,"error"),y.disabled=!1,y.textContent="Salvar Pacote"}}},t.addEventListener("click",Be)}function Jl(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=ke.catalogForModal.services.filter(f=>f.name.toLowerCase().includes(d)),m=ke.catalogForModal.products.filter(f=>f.name.toLowerCase().includes(d)),b=c.map(f=>`
        ...
        `).join("")||'<p class="text-xs text-gray-400 text-center p-4">Nenhum serviço encontrado.</p>',p=m.map(f=>`
        ...
        `).join("")||'<p class="text-xs text-gray-400 text-center p-4">Nenhum produto encontrado.</p>';l.innerHTML=`
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><h4 class="font-semibold mb-2 text-center text-green-600">Produtos</h4><div id="modal-product-list" class="space-y-2 max-h-96 overflow-y-auto">${p}</div></div>
            </div>
        `};a.innerHTML=`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:m,itemId:b}=d.dataset,f=(ke.catalogForModal[m+"s"]||[]).find(h=>h.id===b);f&&(e({...f,type:m}),i())}else(c||l.target===a)&&i()})}async function Ra(){aa.innerHTML=`
    ...
    `,ht&&aa.removeEventListener("click",ht),ht=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;H("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async o=>{if(o)try{await tn(r),g("Sucesso!","Pacote excluído.","success"),await Ra()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")yo(null);else if(a==="edit-package"){const s=JSON.parse(t.dataset.package);yo(s)}},aa.addEventListener("click",ht);try{const[e,t,a]=await Promise.all([Go(u.establishmentId),$e(u.establishmentId),Ft(u.establishmentId)]);ke.allPackages=e,ke.catalogForModal={services:t.filter(s=>s.active),products:a},_l()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Wl=document.getElementById("content");let Gl=null;async function Yl(){const e=v(u.userName||"Usuário"),t=v(V.currentUser?.email||"E-mail não disponível"),a=u.userName?u.userName.charAt(0):"U";Wl.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await Ql()}async function Ql(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=u.userProfessionalId;if(t){const a=await Gs(t);Gl=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=v(a.name);e.innerHTML=`
