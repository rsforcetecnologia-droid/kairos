const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-CVWsAgCe.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-C2XZ_b0c.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as U,d as _,m as Fa}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Ms,reauthenticateWithCredential as As,verifyBeforeUpdateEmail as qs,updatePassword as Ns,updateProfile as Rs,setPersistence as js,browserLocalPersistence as Fs,onAuthStateChanged as Po,signOut as Ha}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as me,getDoc as Bo,updateDoc as ha,setDoc as Hs,addDoc as Do,collection as pe,query as Rt,where as ot,getDocs as xa,orderBy as Mo,writeBatch as Ao,serverTimestamp as Oa,deleteDoc as Os,arrayUnion as zs,onSnapshot as Vs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Us,onMessage as _s}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Ws(e,t,a){m.establishmentId=e,m.establishmentName=t,m.userPermissions=a}const qo=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ia=qo?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${qo?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",ia);async function Js(){const e=U.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function E(e,t={}){const a=await Js();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const o=ia.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,s=`${o}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${s}`);try{const n=await fetch(s,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${s}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${s}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ia}. Verifique se o servidor backend está rodando.`):n}}const No=(e,t,a,o=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(r+=`&professionalId=${o}`),E(r)},Gs=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return E(r)},Ys=e=>E("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Qs=(e,t)=>E(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),za=e=>E(`/api/appointments/${e}`,{method:"DELETE"}),Xs=e=>E(`/api/appointments/${e}/reopen`,{method:"POST"}),Zs=(e,t)=>E(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let W;async function Ks(){if(!W)try{W=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function er(){if(!W){console.warn("AudioContext não inicializado. O som não será tocado.");return}W.state==="suspended"&&W.resume();const e=W.createOscillator(),t=W.createGain();e.connect(t),t.connect(W.destination),e.type="sine",e.frequency.setValueAtTime(800,W.currentTime),t.gain.setValueAtTime(0,W.currentTime),t.gain.linearRampToValueAtTime(.3,W.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,W.currentTime+.2),e.start(W.currentTime),e.stop(W.currentTime+.2)}function p(e,t,a="info",o=!1){const r=document.getElementById("toast-container");if(!r)return;o&&er();const s=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${n[a]||n.info}`,s.innerHTML=`
    ...
    `,r.appendChild(s),s.querySelector(".toast-close").addEventListener("click",()=>s.remove()),setTimeout(()=>{s.remove()},4e3)}function O(e,t){const a=document.getElementById("genericModal");return new Promise(o=>{a.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function jt(e){const t=document.getElementById(e);t&&(t.style.display="none")}function tr(){document.body.addEventListener("click",()=>{W||Ks()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const o=t.dataset.target;if(o){const r=document.getElementById(o);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const o=document.getElementById("genericModal");o&&(o.style.display="none")}})}const X=document.getElementById("sidebar"),Va=document.getElementById("sidebarToggle"),Ye=document.getElementById("mainContent"),ar=document.querySelectorAll(".sidebar-link"),Ua=document.getElementById("hamburger-menu-btn"),Ne=document.getElementById("mobile-overlay");function wt(e){!X||!Ye||(X.classList.toggle("collapsed",e),Ye.classList.toggle("sidebar-collapsed-shift",e))}function or(){!X||!Ne||(X.classList.add("mobile-open"),Ne.classList.add("visible"))}function mt(){!X||!Ne||(X.classList.remove("mobile-open"),Ne.classList.remove("visible"))}function sr(){wt(!X.classList.contains("collapsed"))}function rr(e,t,a){if(!X||!Ye)return;Ye.classList.add("main-content-shift"),window.innerWidth>=768?wt(X.classList.contains("collapsed")):(Ye.classList.remove("main-content-shift","sidebar-collapsed-shift"),mt()),Va&&Va.addEventListener("click",r=>{r.stopPropagation(),sr()}),X.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&X.classList.contains("collapsed")&&wt(!1)}),X.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||wt(!0))}),Ua&&Ua.addEventListener("click",r=>{r.stopPropagation(),or()}),Ne&&Ne.addEventListener("click",r=>{r.stopPropagation(),mt()});let o=0;X.addEventListener("touchstart",r=>{o=r.changedTouches[0].screenX},{passive:!0}),X.addEventListener("touchend",r=>{const s=r.changedTouches[0].screenX;o-s>50&&mt()},{passive:!0}),ar.forEach(r=>{const s=r.getAttribute("data-target"),n=s.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[s]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),s&&typeof e=="function"&&e(s),window.innerWidth<768&&mt()})})}const $e=e=>{const t=e||m.establishmentId;return t?E(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},kt=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},nr=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ir=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},K=e=>E(`/api/professionals/${e}`),lr=e=>E(`/api/professionals/details/${e}`),Ro=e=>E("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Ct=(e,t)=>E(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),_a=(e,t)=>Ct(e,{services:t}),jo=e=>E(`/api/professionals/${e}`,{method:"DELETE"}),dr=e=>{const t=e.map(a=>jo(a));return Promise.all(t)},ge=e=>E(`/api/services/${e}`),Fo=e=>E("/api/services",{method:"POST",body:JSON.stringify(e)}),cr=(e,t)=>E(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),ur=e=>E(`/api/services/${e}`,{method:"DELETE"}),mr=(e,t)=>E(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),pr=e=>E(`/api/services/stats/most-popular/${e}`),lt=e=>E(`/api/products/${e}`),Ho=e=>E("/api/products",{method:"POST",body:JSON.stringify(e)}),gr=(e,t)=>E(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),br=e=>E(`/api/products/${e}`,{method:"DELETE"}),fr=(e,t)=>E(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),vr=({startDate:e,endDate:t,productId:a,categoryId:o,establishmentId:r})=>{const s=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&s.append("productId",a),o&&o!=="all"&&s.append("categoryId",o),r&&s.append("establishmentId",r),E(`/api/products/stock-history/report?${s.toString()}`)},hr={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function Wa(e,t,a){return new Promise((o,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const g=e.type==="image/png"&&t<500?"image/png":"image/jpeg";o(l.toDataURL(g,a))},i.onerror=l=>r(l)},s.onerror=n=>r(n)})}let ce=null;const St=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let ee=0,Lt=[];async function xr(){try{console.log("Iniciando verificação de Onboarding para ID:",m.establishmentId);const e=await $e(m.establishmentId),t=await K(m.establishmentId),a=await ge(m.establishmentId);Lt=a||[];const o=e&&e.name&&(e.phone||e.address),r=e&&(e.logo||e.themeColor&&e.themeColor!=="indigo"),s=e&&e.slotInterval>0,n=a&&a.length>0,i=t&&t.length>0;if(console.log("Status Onboarding:",{hasCompanyData:o,hasBranding:r,hasTimeConfig:s,hasService:n,hasProf:i}),o&&s&&i&&n)return;if(!o)ee=0;else if(!r&&!s)ee=1;else if(!s)ee=2;else if(!n)ee=3;else if(!i)ee=4;else if(ee===0)return;yr(),wa(ee)}catch(e){console.error("Erro ao verificar onboarding:",e)}}function yr(){document.getElementById("onboarding-overlay")||(ce=document.createElement("div"),ce.id="onboarding-overlay",ce.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",ce.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",ce.innerHTML=`
    ...
    `,document.body.appendChild(ce),ya())}function ya(){const e=Math.round(ee/St.length*100),t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width=`${e}%`),a&&(a.innerText=`${e}%`)}function wa(e){const t=document.getElementById("onboarding-step-content"),a=St[e];if(!a){Ja(t);return}let o="";if(a.id==="company_data")o=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(hr).map(([s,n])=>`<option value="${s}">${n.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
        ...
        `;else if(a.id==="first_prof"){const r=Lt.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""),s=Lt.length>0;o=`
            <form id="step-form" class="space-y-3">
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>wr(a.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===St.length-1?Ja(t):(ee++,ya(),wa(ee))}),a.id==="branding"){const r=document.getElementById("logo-input"),s=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Wa(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),s&&(s.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Wa(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Ja(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{ce&&ce.remove(),window.location.reload()}}async function wr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),o=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),s=Object.fromEntries(r.entries());try{if(e==="company_data")await kt(m.establishmentId,{name:s.name,phone:s.phone,email:s.email,address:s.address,zipCode:s.zipCode});else if(e==="branding"){const n={};s.logoBase64&&(n.logo=s.logoBase64),s.bgBase64&&(n.backgroundImage=s.bgBase64),s.themeColor&&(n.themeColor=s.themeColor),s.primaryColor&&(n.primaryColor=s.primaryColor),Object.keys(n).length>0&&await kt(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(s.slotInterval);await kt(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Fo({establishmentId:m.establishmentId,name:s.name,price:parseFloat(s.price),duration:parseInt(s.duration),active:!0});n&&Lt.push(n)}else if(e==="first_prof"){const n=await Ro({establishmentId:m.establishmentId,name:s.name,specialty:s.role,active:!0,commissionRate:0});if(s.serviceId&&n&&n.id)try{_a?await _a(n.id,[s.serviceId]):Ct&&await Ct(n.id,{services:[s.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Ho({establishmentId:m.establishmentId,name:s.name,price:parseFloat(s.salePrice),stock:parseInt(s.stock),active:!0});p("Sucesso","Passo concluído!","success"),ee++,ya(),wa(ee)}catch(n){p("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=o}}var Re;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Re||(Re={}));class Xt extends Error{constructor(t,a,o){super(t),this.message=t,this.code=a,this.data=o}}const kr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Sr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},o=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:kr(e),s=()=>r()!=="web",n=u=>{const g=d.get(u);return!!(g?.platforms.has(r())||i(u))},i=u=>{var g;return(g=a.PluginHeaders)===null||g===void 0?void 0:g.find(b=>b.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,g={})=>{const b=d.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const h=r(),v=i(u);let y;const w=async()=>(!y&&h in g?y=typeof g[h]=="function"?y=await g[h]():y=g[h]:t!==null&&!y&&"web"in g&&(y=typeof g.web=="function"?y=await g.web():y=g.web),y),$=(P,B)=>{var R,F;if(v){const z=v?.methods.find(j=>B===j.name);if(z)return z.rtype==="promise"?j=>a.nativePromise(u,B.toString(),j):(j,Q)=>a.nativeCallback(u,B.toString(),j,Q);if(P)return(R=P[B])===null||R===void 0?void 0:R.bind(P)}else{if(P)return(F=P[B])===null||F===void 0?void 0:F.bind(P);throw new Xt(`"${u}" plugin is not implemented on ${h}`,Re.Unimplemented)}},k=P=>{let B;const R=(...F)=>{const z=w().then(j=>{const Q=$(j,P);if(Q){const Ee=Q(...F);return B=Ee?.remove,Ee}else throw new Xt(`"${u}.${P}()" is not implemented on ${h}`,Re.Unimplemented)});return P==="addListener"&&(z.remove=async()=>B()),z};return R.toString=()=>`${P.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:P,writable:!1,configurable:!1}),R},I=k("addListener"),L=k("removeListener"),D=(P,B)=>{const R=I({eventName:P},B),F=async()=>{const j=await R;L({eventName:P,callbackId:j},B)},z=new Promise(j=>R.then(()=>j({remove:F})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},z},N=new Proxy({},{get(P,B){switch(B){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?D:I;case"removeListener":return L;default:return k(B)}}});return o[u]=N,d.set(u,{name:u,proxy:N,platforms:new Set([...Object.keys(g),...v?[h]:[]])}),N};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Xt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},$r=e=>e.Capacitor=Sr(e),oe=$r(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ft=oe.registerPlugin;class Oo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let o=!1;this.listeners[t]||(this.listeners[t]=[],o=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),o&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,o){const r=this.listeners[t];if(!r){if(o){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}r.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:o=>{this.notifyListeners(a,o)}}}unimplemented(t="not implemented"){return new oe.Exception(t,Re.Unimplemented)}unavailable(t="not available"){return new oe.Exception(t,Re.Unavailable)}async removeListener(t,a){const o=this.listeners[t];if(!o)return;const r=o.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(o=>{this.notifyListeners(t,o)}))}}const Ga=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ya=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Er extends Oo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(o=>{if(o.length<=0)return;let[r,s]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Ya(r).trim(),s=Ya(s).trim(),a[r]=s}),a}async setCookie(t){try{const a=Ga(t.key),o=Ga(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${o||""}${r}; path=${s}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ft("CapacitorCookies",{web:()=>new Er});const Ir=async e=>new Promise((t,a)=>{const o=new FileReader;o.onload=()=>{const r=o.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},o.onerror=r=>a(r),o.readAsDataURL(e)}),Cr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,s,n)=>(r[s]=e[t[n]],r),{})},Lr=(e,t=!0)=>e?Object.entries(e).reduce((o,r)=>{const[s,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${s}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${s}=${i}`),`${o}&${l}`},"").substr(1):null,Tr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Cr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))s.set(n,i);a.body=s.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{s.append(l,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);a.body=s;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Pr extends Oo{async request(t){const a=Tr(t,t.webFetchExtra),o=Lr(t.params,t.shouldEncodeUrlParams),r=o?`${t.url}?${o}`:t.url,s=await fetch(r,a),n=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await s.blob(),l=await Ir(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const c={};return s.headers.forEach((u,g)=>{c[g]=u}),{data:l,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ft("CapacitorHttp",{web:()=>new Pr});const G=Ft("PushNotifications",{}),Br="modulepreload",Dr=function(e){return"/"+e},Qa={},Mr=function(t,a,o){let r=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");r=l(a.map(d=>{if(d=Dr(d),d in Qa)return;Qa[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const g=document.createElement("link");if(g.rel=c?"stylesheet":Br,c||(g.as="script"),g.crossOrigin="",g.href=d,i&&g.setAttribute("nonce",i),document.head.appendChild(g),c)return new Promise((b,h)=>{g.addEventListener("load",b),g.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return r.then(n=>{for(const i of n||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})},Xa=Ft("App",{web:()=>Mr(()=>import("./web-CVWsAgCe.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Ar="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Za=!1;async function zo(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{_o(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const o=a.notification.data;console.log("Notificação clicada (Ação):",o)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Uo()}async function Vo(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Uo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Uo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Us(Fa,{vapidKey:Ar,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await _o(t,!1)):console.warn("[Push Web] Token veio vazio."),Za||(_s(Fa,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Za=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function _o(e,t){const a=U.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const o=me(_,"users",a.uid);try{const r=await Bo(o);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await ha(o,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Hs(o,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(s){console.error("Erro ao criar user:",s)}else console.error("Erro ao atualizar token:",r)}}const qr=(e,t,a="all",o="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),o&&o!=="all"&&r.append("costCenterId",o),E(`/api/reports/indicators?${r.toString()}`)},Nr=e=>e?E(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Rr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:o})=>{const r=new URLSearchParams({startDate:t,endDate:a});return o&&o!=="all"&&r.append("cashierSessionId",o),e&&r.append("establishmentId",e),E(`/api/reports/sales?${r.toString()}`)},jr=()=>E("/api/reports/summary",{method:"GET"}),Ht=(e,t,a,o="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${o}`;return E(r)},Ot=e=>E("/api/blockages",{method:"POST",body:JSON.stringify(e)}),ka=e=>E(`/api/blockages/${e}`,{method:"DELETE"}),Wo=e=>E("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Sa=e=>e?String(e).replace(/\D/g,""):"",zt=(e,t="",a=20,o={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),o&&o.hasLoyalty&&r.append("hasLoyalty","true"),o&&o.birthMonth&&r.append("birthMonth",o.birthMonth),o&&o.inactiveDays&&r.append("inactiveDays",o.inactiveDays),E(`/api/clients/${e}?${r.toString()}`)},Jo=(e,t)=>{const a=encodeURIComponent(t);return E(`/api/clients/details/${e}/${a}`)},Go=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Sa(t),o={...e,phone:a,id:a};return E(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(o)})},$a=Go,Yo=(e,t)=>Go({...t,id:e}),Fr=e=>{const t=encodeURIComponent(e);return E(`/api/clients/${t}`,{method:"DELETE"})},Hr=(e,t,a,o)=>E("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Sa(t),points:a,rewardName:o})}),Or=(e,t)=>Jo(e,Sa(t));function f(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Qo(e,t=800,a=800,o=.7){return new Promise((r,s)=>{if(!e.type.match(/image.*/))return s(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const b=u.toDataURL("image/jpeg",o);r(b)},l.onerror=d=>s(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>s(new Error("Erro ao ler o ficheiro."))})}const Ka=document.getElementById("content");let eo=!1;const la=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let dt=[],Vt=[],je={},Ae=[],T={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},C={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function zr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Xo(e){const t=new Date(e);if(t.setHours(0,0,0,0),T.currentView==="week"&&T.weekViewDays===7){const a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(o))}return t}function Tt(){const e=document.getElementById("profSelectorContainer"),t=T.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let a=m.professionals.filter(s=>T.showInactiveProfs||s.status!=="inactive");t&&(a=a.filter(s=>s.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(s=>{const n=T.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],l=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),d=s.status!=="inactive",c=f(i),u=la[0],g=s.id!=="all"&&m.professionalColors.get(s.id)||u,b=s.photo||`https://placehold.co/64x64/${g.main?.replace("#","")||"E0E7FF"}/${g.light?.replace("#","")||"4F46E5"}?text=${l}`,h=s.id==="all"?"#e0e7ff":g.light,v=s.id==="all"?"#4f46e5":g.main,w=`border: 3px solid ${n?g.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+g.border:"none"};`;return`
            <div class="prof-card ${n?"selected":""} ${d?"":"opacity-50"}" 
                 data-action="select-professional" 
                 data-prof-id="${s.id}">
                ${s.id==="all"?`<div class="prof-card-all-placeholder" style="background-color: ${h}; color: ${v}; ${w}">
                           ${l}
                          </div>`:`<img src="${b}" alt="${c}" class="prof-card-photo" style="${w}" />`}
                <span class="prof-card-name">${c}</span>
            </div>
        `}).join("")}function Vr(e,t,a,o,r){const s=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${o} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${s}?text=${d}`}function Ur(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((o,r)=>new Date(o.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(o=>{const r=new Date(o.startTime),s=new Date(o.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(o.professionalId)||{},d=f(o.reason),c=f(o.professionalName),u=f(o.clientName),g=f(o.serviceName),b=T.selectedItems.has(o.id),h=T.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const v=o.status==="completed",y=v?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",w=v?"Finalizado":"Aberto",$=JSON.stringify(o).replace(/'/g,"&apos;"),k=o.redeemedReward?.points>0,I=o.hasRewards&&!k,L=Vr(o.clientPhone,o.clientName,o.serviceName,o.professionalName,o.startTime),D=T.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${$}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
                    ...
                    `;const I=JSON.stringify(g).replace(/'/g,"&apos;"),L=g.redeemedReward?.points>0,D=g.hasRewards&&!L,N=g.status==="completed";return`
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                        ...
                        <div class="mt-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-800 truncate">${D?"🎁 ":""}${$}</p>
        ...
        `,e.style.display="block",t&&(t.style.display="none")):(e.style.display="none",t&&(t.style.display="flex")))}async function ae(){const e=document.getElementById("agenda-view");if(!e)return;T.selectedItems.clear(),Ia(),e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const o=document.getElementById("weekRange");if(o){if(T.currentView==="list")t=new Date(T.currentDate),t.setHours(0,0,0,0),a=new Date(T.currentDate),a.setHours(23,59,59,999),o.textContent=zr(t);else{const r=Ea();t=Xo(new Date(T.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),o.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await No(m.establishmentId,t.toISOString(),a.toISOString(),T.selectedProfessionalId==="all"?null:T.selectedProfessionalId),s=await Ht(m.establishmentId,t.toISOString(),a.toISOString(),T.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const n=s.map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=m.professionals?m.professionals.find(u=>u.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(m.allEvents=i,Tt(),Zo(),T.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${T.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),T.scrollToAppointmentId=null}}catch(r){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',p("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"))}}}async function Wr(){try{const[e,t,a]=await Promise.all([m.professionals&&m.professionals.length>0?Promise.resolve(m.professionals):K(m.establishmentId),m.services&&m.services.length>0?Promise.resolve(m.services):ge(m.establishmentId),je.enabled!==void 0?Promise.resolve(null):$e(m.establishmentId)]);(!m.professionals||m.professionals.length===0)&&(m.professionals=e||[]),(!m.services||m.services.length===0)&&(m.services=t||[]),Ae=[],a&&(je=a.loyaltyProgram||{enabled:!1}),m.professionals.forEach((o,r)=>{m.professionalColors.set(o.id,la[r%la.length])}),Tt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),p("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function da(e){e<1||e>4||(C.step=e,ca(null,!0))}function Ko(e,t){const a=document.getElementById("multiServiceToggle"),o=a&&a.checked,r=t.classList.contains("selected"),s=C.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),s>-1&&C.data.selectedServiceIds.splice(s,1);else{if(!o){C.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),C.data.selectedServiceIds.push(e)}}function es(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const o=Vt.find(r=>r.id===e);C.data.professionalId=e,C.data.professionalName=o?o.name:"N/A"}function Jr(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(o=>o.classList.remove("selected")),t.classList.add("selected"),C.data.time=e)}async function to(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=C.data.professionalId,o=C.data.selectedServiceIds,r=document.getElementById("apptDate").value;C.data.date=r;const s=o.reduce((n,i)=>{const l=dt.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${s} min`,s===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await Gs({establishmentId:m.establishmentId,professionalId:a,serviceIds:o,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[u,g]=c.split(":").map(Number);return u*60+g>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${C.data.time===d?"selected":""}`,c.textContent=d,c.addEventListener("click",()=>Jr(d,c)),t.appendChild(c)}),C.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${C.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function Gr(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:o}=C.data,{enabled:r,rewards:s}=je;if(!r||!t||!s||s.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const n=s.filter(l=>a>=l.points);let i=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(C.data.redeemedReward=null)})}async function Yr(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!C.data.time||C.data.selectedServiceIds.length===0||!C.data.professionalId)return p("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const o=C.data.selectedServiceIds.map(d=>{const c=dt.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,s]=C.data.time.split(":"),n=new Date(`${C.data.date}T${r}:${s}:00`),i={establishmentId:m.establishmentId,clientName:C.data.clientName,clientPhone:C.data.clientPhone,services:o,professionalId:C.data.professionalId,startTime:n.toISOString(),redeemedReward:C.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Qs(l,i):await Ys(i),p(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",ae()}catch(d){p(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function ts(e){const t=C.data.clientName===e.name&&C.data.clientPhone===e.phone,a=f(e.name),o=f(e.phone);return`
    ...
    `}async function Qr(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}t.innerHTML='<div class="loader-small mx-auto my-2"></div>';try{const o=await zt(m.establishmentId,a);if(Ae=o,o.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=o.map(ts).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(r=>{r.addEventListener("click",s=>{const n=r.dataset.clientName,i=r.dataset.clientPhone,l=parseInt(r.dataset.loyaltyPoints||"0",10);C.data.clientName=n,C.data.clientPhone=i,C.data.clientLoyaltyPoints=l;const d=je,c=Math.min(...(d?.rewards||[]).map(u=>u.points));C.data.clientHasRewards=d.enabled&&c!==1/0&&C.data.clientLoyaltyPoints>=c,document.getElementById("apptClientName").value=n,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(u=>u.classList.remove("selected","border-blue-500")),r.classList.add("selected","border-blue-500")})})}catch(o){console.error("Erro na busca de clientes:",o),t.innerHTML='<p class="text-sm text-red-500">Erro ao buscar clientes.</p>'}}async function Xr(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),o={establishmentId:m.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!o.name||!o.phone)return p("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await $a(o),Ae.push({name:o.name,phone:o.phone,loyaltyPoints:0}),C.data.clientName=o.name,C.data.clientPhone=o.phone,C.data.clientHasRewards=!1,C.data.clientLoyaltyPoints=0,p("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",da(1)}catch(r){p(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function Zr(){Y({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",Xr)}function Kr(){Zr()}function en(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",o=`
    ...
    `;return{title:a,content:o}}function tn(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${dt.map(o=>{const r=C.data.selectedServiceIds.includes(o.id),s=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=f(o.name);return`
    ...
    `;return{title:e,content:a}}function an(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Vt.map(a=>{const o=C.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",s=f(a.name);return`
    ...
    `;return{title:e,content:t}}function on(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=C.data.date||o,s=f(C.data.clientName),n=f(C.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function sn(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),o=dt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=C.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${s?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Ko(r.dataset.serviceId,r))})}function rn(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),o=Vt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=C.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=f(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>es(r.dataset.professionalId,r))})}async function ca(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const s=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(C={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:s,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}},e&&e.clientName)try{const i=await zt(m.establishmentId,e.clientName),l=i.find(d=>d.phone===e.clientPhone);l&&(C.data.clientLoyaltyPoints=l.loyaltyPoints||0,Ae=i)}catch(i){console.warn("Não foi possível carregar pontos do cliente para edição:",i)}}if(!m.services||!m.professionals||je.enabled===void 0){p("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(dt=m.services,Vt=m.professionals.filter(s=>s.status==="active"),C.data.clientLoyaltyPoints>0){const s=je,n=Math.min(...(s?.rewards||[]).map(i=>i.points));C.data.clientHasRewards=s.enabled&&n!==1/0&&C.data.clientLoyaltyPoints>=n}let o={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(C.step){case 1:o=en(e);break;case 2:o=tn();break;case 3:o=an();break;case 4:o=on(e);break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(C.data.clientName=i.value.trim(),C.data.clientPhone=l.value.trim(),!C.data.clientName||!C.data.clientPhone)return p("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(C.data.selectedServiceIds.length===0)return p("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!C.data.professionalId)return p("Atenção","Selecione um profissional.","error");da(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(s=>{s.addEventListener("click",()=>da(parseInt(s.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if(C.step===4&&r&&r.addEventListener("submit",Yr),a.style.display="flex",C.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Ko(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>sn(i.target.value))}if(C.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>es(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>rn(i.target.value))}if(C.step===1){const s=a.querySelector("#clientSearchInput");if(s&&(s.addEventListener("input",i=>Qr(i.target.value)),C.data.clientName&&C.data.clientPhone&&Ae.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=Ae.map(ts).join(""))}const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Kr)}if(C.step===4){const s=a.querySelector("#apptDate");s&&s.addEventListener("change",to),to(),Gr()}}async function as(e={}){T.currentDate=e.targetDate?new Date(e.targetDate):T.currentDate||new Date,T.scrollToAppointmentId=e.scrollToAppointmentId||null,T.profSearchTerm="",T.isSelectionMode=!1,T.selectedItems.clear(),window.innerWidth<768&&(T.currentView="list"),Ka.innerHTML=`
        <section>
        ...
        </section>`;const t=document.getElementById("btn-toggle-select");t.addEventListener("click",()=>{T.isSelectionMode=!T.isSelectionMode,T.isSelectionMode||T.selectedItems.clear(),t.classList.toggle("bg-blue-100",T.isSelectionMode),t.classList.toggle("text-blue-700",T.isSelectionMode),Zo()}),document.querySelectorAll(".view-btn[data-view]").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(s=>s.classList.remove("active")),o.classList.add("active"),T.currentView=o.dataset.view;const r=document.getElementById("week-days-toggle");if(T.currentView==="week"){if(r.style.display="flex",window.innerWidth<768){T.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(n=>n.classList.remove("active"));const s=document.querySelector('.week-days-btn[data-days="3"]');s&&s.classList.add("active")}}else r.style.display="none";ae()})}),document.querySelectorAll(".week-days-btn").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(r=>r.classList.remove("active")),o.classList.add("active"),T.weekViewDays=parseInt(o.dataset.days,10),ae()})}),document.getElementById("todayBtn").addEventListener("click",()=>{T.currentDate=new Date,ae()});const a=o=>{const r=parseInt(o.currentTarget.dataset.amount,10),s=T.currentView==="week"?Ea():1,n=new Date(T.currentDate);n.setDate(n.getDate()+r*s),T.currentDate=n,ae()};document.getElementById("prevBtn").addEventListener("click",a),document.getElementById("nextBtn").addEventListener("click",a),document.getElementById("profSearchInput").addEventListener("input",o=>{T.profSearchTerm=o.target.value,Tt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",o=>{T.showInactiveProfs=o.target.checked,Tt(),ae()}),eo||(Ka.addEventListener("click",async o=>{const r=o.target.closest("[data-action]");if(o.target.dataset.action==="toggle-select-item"){const l=o.target.dataset.id;o.target.checked?T.selectedItems.add(l):T.selectedItems.delete(l),Ia();return}if(r&&r.dataset.action==="batch-delete"){const l=T.selectedItems.size;if(await O("Excluir em Lote",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)){const c=Array.from(T.selectedItems);let u=0;try{await Promise.all(c.map(async g=>{try{await za(g),u++}catch(b){console.error(`Falha ao excluir ${g}`,b)}})),p(`${u} agendamento(s) excluído(s).`,"success"),T.selectedItems.clear(),T.isSelectionMode=!1,document.getElementById("btn-toggle-select").classList.remove("bg-blue-100","text-blue-700"),ae()}catch{p("Erro ao processar exclusão em lote.","error")}}return}if(o.target.closest('[data-action="select-professional"]')){const d=o.target.closest('[data-action="select-professional"]').dataset.profId,c=T.selectedProfessionalId===d&&d!=="all";if(T.selectedProfessionalId=c?"all":d,d!=="all"){const u=document.getElementById("profSearchInput");u&&(u.value=""),T.profSearchTerm=""}await ae();return}if(!r)return;const s=r.dataset.action;let n=null;const i=o.target.closest("[data-appointment]");switch(i&&(n=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"))),s){case"new-appointment":ca();break;case"edit-appointment":if(T.isSelectionMode||!n)return;if(n.status==="completed"){p("Atenção","Agendamentos finalizados não podem ser editados.","error");return}n.hasRewards&&!n.redeemedReward&&p("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),ca(n);break;case"delete-appointment":{if(T.isSelectionMode)return;const l=r.dataset.id;if(await O("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await za(l),p("Agendamento apagado!","success"),ae()}catch(c){p(`Não foi possível apagar: ${c.message}`,"error")}break}case"open-comanda":if(T.isSelectionMode)return;if(n){n.hasRewards&&!n.redeemedReward&&n.status!=="completed"&&p("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const l=n.status==="completed"?"finalizadas":"em-atendimento",d={selectedAppointmentId:n.id,initialFilter:l};if(l==="finalizadas"){let c=n.startTime;if(n.transaction&&n.transaction.paidAt){const u=n.transaction.paidAt;typeof u=="object"&&u._seconds?c=new Date(u._seconds*1e3):c=u}d.filterDate=c}Z("comandas-section",d)}break}}),eo=!0),await Wr(),await ae()}const nn=(e,t=null,a=1,o=12)=>{let r=`/api/comandas/${e}?page=${a}&limit=${o}`;return t&&(r+=`&date=${t}`),E(r)},ln=(e,t)=>E(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),dn=e=>E("/api/sales",{method:"POST",body:JSON.stringify(e)}),cn=e=>E(`/api/sales/${e}`,{method:"DELETE"}),un=()=>E("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),mn=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),E("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},pn=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),E(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},gn=()=>E("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),bn=e=>E(`/api/cashier/report/${e}`),Ca=e=>E(`/api/packages/${e}`),fn=e=>E("/api/packages",{method:"POST",body:JSON.stringify(e)}),vn=(e,t)=>E(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),hn=e=>E(`/api/packages/${e}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"atendimento",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,pendingRedemption:null,paging:{page:1,limit:10,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1},Ie=null,Le=null,ao=null;function os(e,t){return function(...a){clearTimeout(ao),ao=setTimeout(()=>e.apply(this,a),t)}}async function oo(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,st(),t==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),V());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,Ut()}function Ut(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");x.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),wn()}function wn(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `:e.innerHTML=`
            ...
            <button data-action="view-sales-report" class="py-2 px-4 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 text-sm transition">Relatório</button>
        `)}function st(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!x.isCashierOpen&&x.activeFilter==="atendimento"){e.innerHTML=`
        ...
        `,s.appendChild(w)}),e.innerHTML="",e.appendChild(s),so(t)}function so(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:o}=x.paging,r=Math.ceil((a||0)/o);if(r===0)return;const s=document.createElement("div");s.className="flex gap-2 justify-center items-center w-full",s.innerHTML=`
    ...
    `;e.innerHTML=`
        ...
        ${r?"":h}
    `,!r&&(t.clientId||t.clientName)&&Sn(t,e.querySelector("#loyalty-container"))}function kn(e,t){const o=Se(e).reduce((g,b)=>g+Number(b.price||0)*(b.quantity||1),0),r=x.checkoutState,s=r.discount||{type:"real",value:0};let n=0;s.type==="percent"?n=o*s.value/100:n=s.value,n>o&&(n=o);const i=o-n,l=r.payments.reduce((g,b)=>g+b.value,0),d=Math.max(0,i-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;const u=()=>{const g=x.checkoutState.discount.type,b=x.checkoutState.discount.value;let h=g==="percent"?o*b/100:b;h>o&&(h=o);const v=o-h,y=x.checkoutState.payments.reduce((L,D)=>L+D.value,0),w=Math.max(0,v-y),$=t.querySelector("#checkout-total-display");$&&($.textContent=`R$ ${v.toFixed(2)}`);const k=t.querySelector("#checkout-status-msg");k&&(w<=.01?k.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':k.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${w.toFixed(2)}</span></p>`);const I=t.querySelector("#checkout-amount");I&&w>0&&document.activeElement!==I&&(I.value=w.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",g=>{const b=parseFloat(g.target.value)||0;x.checkoutState.discount.value=b,u()}),t.querySelector("#discount-type")?.addEventListener("change",g=>{x.checkoutState.discount.type=g.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",g=>{x.checkoutState.discountReason=g.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",g=>{x.checkoutState.amountReceived=g.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",g=>{x.checkoutState.installments=parseInt(g.target.value,10)})}async function Sn(e,t){if(!t)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let o=null;try{if(e.clientId)o=await Jo(m.establishmentId,e.clientId);else if(e.clientName){const i=await zt(m.establishmentId,e.clientName,1);i&&i.length>0&&(o=i[0])}}catch(i){console.warn("Erro ao buscar dados de fidelidade",i)}if(!o||o.loyaltyPoints===void 0)return;const r=Number(o.loyaltyPoints)||0,n=(a.tiers||a.rewards||[]).filter(i=>{const l=Number(i.costPoints||i.points||0);return l>0&&r>=l});if(n.length>0){const i=document.createElement("div");i.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",i.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>$n(n,e),i.appendChild(l),t.innerHTML="",t.appendChild(i)}}function $n(e,t){const a=`
        <div class="space-y-4">
    ...
    `,{modalElement:o,close:r}=Y({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});o.addEventListener("click",s=>{const n=s.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,l=e.find(d=>d.id&&d.id==i||(d.name||d.reward)==i);l&&(En(l,t),r())}})}async function En(e,t){const a=Number(e.costPoints||e.points||0),o=e.name||e.reward,r=e.type||"money";if(r==="money"){const l=parseFloat(e.discount)||0;if(l<=0){p("Erro","O valor do desconto configurado é inválido.","error");return}x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,x.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:"money"},p("Sucesso",`Prémio "${o}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),V();return}const s=Se(t),n=e.itemId?String(e.itemId):null;if(!n){p("Erro de Configuração",`O prémio "${o}" não tem um item vinculado nas configurações.`,"error");return}const i=s.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return r==="service"?d===n||c===n:r==="product"?d===n||u===n:r==="package"?d===n:!1});if(i){let l=parseFloat(e.discount);(!l||l<=0)&&(l=parseFloat(i.price||0)),x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,x.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:r,appliedToItemId:i.id},p("Sucesso",`Prémio "${o}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),V()}else p("Item Não Encontrado",`Para resgatar o prémio "${o}", o ${r==="service"?"serviço":r==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function In(){if(!x.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=Y({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const r=e.querySelector("#add-item-content");r.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await rs(r,s),t()}};e.addEventListener("click",r=>{const s=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:i,itemId:l}=s.dataset,c=(x.catalog[i+"s"]||[]).find(u=>u.id===l);c&&o({...c,type:i})}else n&&a()}),a()}async function ua(e=null){if(!x.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await K(m.establishmentId)}catch{return p("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Ln)}async function Ln(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),r=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!r)return p("Erro","Nome e Telefone são obrigatórios.","error");try{const s=await Or(m.establishmentId,r);if(s)p("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",ua(s);else{const n=await $a({establishmentId:m.establishmentId,name:a.value,phone:r});p("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",ua(n)}}catch(s){p("Erro",s.message,"error")}}async function Tn(){const e=`
    ...
    `,{modalElement:t}=Y({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const o=parseFloat(document.getElementById("initial-amount").value);if(isNaN(o)||o<0)return p("Valor Inválido","Insira um valor válido.","error");try{const r=await mn({establishmentId:m.establishmentId,initialAmount:parseFloat(o.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",p("Sucesso!",`Caixa aberto (R$ ${o.toFixed(2)})`,"success"),Ut(),await re()}catch(r){p("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function Pn(){const e=x.activeCashierSessionId;if(e)try{const t=await bn(e),a=`
        ...
        `,{modalElement:o}=Y({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});o.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const s=parseFloat(document.getElementById("final-amount").value);if(isNaN(s)||s<0)return p("Valor Inválido","Insira um valor final válido.","error");try{await pn(e,s),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Ut(),await re(),p("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){p("Erro",`Falha ao fechar caixa: ${n.message}`,"error")}})}catch(t){p("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Bn(e){if(x.activeFilter===e)return;x.activeFilter=e,x.paging.page=1,document.querySelectorAll(".filter-btn").forEach(a=>a.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),Te(),x.selectedComandaId=null,x.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await re(),V()}function ss(e){x.selectedComandaId=e,x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",st(),xn(),V()}async function rs(e,t){const a=x.allComandas.find(s=>s.id===x.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),p("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const o=parseFloat(e.price)||0,r=Array(t).fill(0).map(()=>{const s={id:String(e.id),name:e.name,price:o,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(s.productId=s.id,s.product_id=s.id):e.type==="service"&&(s.serviceId=s.id,s.service_id=s.id),s});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...r),a._cachedItems=null,a._hasUnsavedChanges=!0,V()}async function ro(e,t){const a=x.allComandas.find(s=>s.id===x.selectedComandaId);if(!a)return;let o=!1,r=(a.comandaItems||[]).findIndex(s=>s.id==e&&s.type===t);r>-1&&(a.comandaItems.splice(r,1),o=!0),o&&(a._cachedItems=null,a._hasUnsavedChanges=!0,V())}async function Dn(e){if(x.isProcessing)return;const t=Se(e),a=t.reduce((y,w)=>y+Number(w.price||0)*(w.quantity||1),0),o=x.checkoutState.discount||{type:"real",value:0};let r=o.type==="percent"?a*o.value/100:o.value;r>a&&(r=a);const s=a-r,{payments:n}=x.checkoutState,i=n.reduce((y,w)=>y+w.value,0),l=s-i;if(l>.01){if(!await O("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;n.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const g=x.loyaltySettings;g&&g.enabled&&(u=parseInt(g.pointsPerVisit||1,10),console.log(`Fidelidade: Cliente ganhou ${u} pontos fixos pela visita.`));const b={...o,reason:x.checkoutState.discountReason||""},h={payments:n,totalAmount:Number(s),items:c,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:u,discount:b,loyaltyRedemption:x.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(v);try{d?await Zs(e.id,h):(h.establishmentId=m.establishmentId,h.clientId=e.clientId,h.clientName=e.clientName,h.professionalId=e.professionalId,e.clientPhone&&(h.clientPhone=e.clientPhone),await dn(h));let y="Venda finalizada com sucesso!";u>0&&(y+=` Cliente ganhou ${u} pontos!`),p("Sucesso!",y,"success"),Te(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await re()}catch(y){p("Erro no Checkout",y.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),x.isProcessing=!1}}async function Mn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,o=t.value,r=document.getElementById("client-search").value,s=t.dataset.phone||"";if(!o)return p("Erro","Selecione um cliente válido.","error");const n=m.professionals.find(l=>l.id===a);if(!n)return p("Erro","Selecione um profissional válido.","error");const i={id:`temp-${Date.now()}`,type:"walk-in",clientId:o,clientName:r.split("(")[0].trim(),clientPhone:s,professionalId:n.id,professionalName:n.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(i),x.selectedComandaId=i.id,x.viewMode="items",document.getElementById("genericModal").style.display="none",ss(i.id)}async function re(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=x.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=un(),o=nn(m.establishmentId,t,x.paging.page,x.paging.limit),r=$e(m.establishmentId),[s,n,i]=await Promise.all([a,o,r]);if(x.isCashierOpen=!!s,x.activeCashierSessionId=s?s.id:null,Ut(),i&&i.loyaltyProgram&&(x.loyaltySettings=i.loyaltyProgram),!x.isCashierOpen&&x.activeFilter==="atendimento"){st(),V();return}if(x.allComandas=n.data||n,x.paging.total=n.total||n.length,x.catalog.services.length===0){const[l,d,c,u]=await Promise.all([ge(m.establishmentId),lt(m.establishmentId),Ca(m.establishmentId),K(m.establishmentId)]);x.catalog={services:l,products:d,packages:c},m.professionals=u}st(),V()}catch(a){p("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function An(e={}){Le=document.getElementById("content"),x.selectedComandaId=e.selectedAppointmentId||null,x.viewMode="items",yn(),Ie&&(Le.removeEventListener("click",Ie),Le.removeEventListener("change",Ie)),Ie=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&x.activeFilter==="finalizadas"){x.paging.page=1,await re();return}if(a){if(a.matches("[data-filter]"))Bn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}ss(a.dataset.comandaId)}else if(a.matches("[data-action]")){const r=a.dataset.action,s=a.dataset.id||x.selectedComandaId,n=x.allComandas.find(i=>i.id===s);switch(r){case"back-to-list":Te(),x.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach($=>$.classList.remove("selected")),V();break;case"new-sale":ua();break;case"add-item":In();break;case"open-cashier":Tn();break;case"close-cashier":await Pn();break;case"view-sales-report":Z("sales-report-section");break;case"go-to-checkout":await oo(n,"checkout");break;case"back-to-items":x.viewMode="items",V();break;case"save-comanda":await oo(n,"stay");break;case"select-method":x.checkoutState.selectedMethod=a.dataset.method,x.checkoutState.installments=1,V();break;case"add-payment-checkout":const i=document.getElementById("checkout-amount");let l=parseFloat(i.value);const c=Se(n).reduce(($,k)=>$+(k.price||0),0),u=x.checkoutState.discount||{type:"real",value:0};let g=u.type==="percent"?c*u.value/100:u.value;g>c&&(g=c);const b=c-g,h=x.checkoutState.payments.reduce(($,k)=>$+k.value,0),v=b-h;if(isNaN(l)||l<=0){p("Valor inválido","Insira um valor maior que zero.","error");break}if(l>v+.05){p("Valor inválido","Valor excede o restante.","error");break}const y={method:x.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(y.installments=x.checkoutState.installments),x.checkoutState.payments.push(y),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",V();break;case"remove-payment-checkout":const w=parseInt(a.dataset.index,10);x.checkoutState.payments.splice(w,1),V();break;case"finalize-checkout":await Dn(n);break;case"increase-qty":{const $=a.dataset.itemId,k=a.dataset.itemType;if(!$||$==="undefined"||$==="null"){p("Erro","Item inválido para adição.","error");return}let L=Se(n).find(N=>N.id==$&&N.type===k);L||(L=(x.catalog[k+"s"]||[]).find(P=>P.id==$));const D=L?{id:L.id,name:L.name,price:Number(L.price),type:L.type}:{id:$,name:"Item Indisponível",price:0,type:k};await rs(D,1);break}case"decrease-qty":{await ro(a.dataset.itemId,a.dataset.itemType);break}case"remove-item":await ro(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await O("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Xs(s);const k=x.allComandas.findIndex(I=>I.id===s);k!==-1&&(x.allComandas[k].status="confirmed",delete x.allComandas[k].transaction),x.selectedComandaId=null,Te(),await re(),p("Sucesso!","Comanda reaberta.","success")}catch(k){p("Erro",k.message,"error")}break}case"go-to-appointment":{const $=a.dataset.id,k=a.dataset.date;Z("agenda-section",{scrollToAppointmentId:$,targetDate:new Date(k)});break}case"delete-walk-in":{if(await O("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(s.startsWith("temp-"))x.allComandas=x.allComandas.filter(k=>k.id!==s),x.selectedComandaId=null,st(),V(),Te();else try{await cn(s),p("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Te(),await re()}catch(k){p("Erro",k.message,"error")}break}}}}},Le.addEventListener("click",Ie),Le.addEventListener("change",Ie),e.initialFilter&&(x.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(x.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${x.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",x.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await re()}const La=e=>E(`/api/financial/natures/${e}`),qn=e=>E("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),Nn=e=>E(`/api/financial/natures/${e}`,{method:"DELETE"}),Ta=e=>E(`/api/financial/cost-centers/${e}`),Rn=e=>E("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),jn=e=>E(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),ns=(e,t)=>E(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),is=(e,t={})=>{let a=`/api/financial/${e}`;const o=new URLSearchParams;t.establishmentId&&o.append("establishmentId",t.establishmentId),t.startDate&&o.append("startDate",t.startDate),t.endDate&&o.append("endDate",t.endDate),t.natureId&&o.append("natureId",t.natureId),t.costCenterId&&o.append("costCenterId",t.costCenterId),t.status&&o.append("status",t.status);const r=o.toString();return r&&(a+=`?${r}`),E(a)},ls=(e,t,a)=>E(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),ds=(e,t)=>E(`/api/financial/${e}/${t}`,{method:"DELETE"}),cs=(e,t,a)=>E(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Fn=e=>ns("payables",e),Hn=e=>is("payables",e),On=(e,t)=>ls("payables",e,t),zn=e=>ds("payables",e),Vn=(e,t)=>cs("payables",e,t),Un=e=>ns("receivables",e),_n=e=>is("receivables",e),Wn=(e,t)=>ls("receivables",e,t),Jn=e=>ds("receivables",e),Gn=(e,t)=>cs("receivables",e,t),Yn=(e,t,a)=>E(`/api/financial/cash-flow?establishmentId=${e}&startDate=${t}&endDate=${a}`),ma=document.getElementById("content");let ue={};const no=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],M={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],cashFlowData:null,currentTab:"dashboards",isFilterOpen:!1};async function Qn(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function Xn(){ma.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
        ...
        </div>`;try{await Qn();const[e,t]=await Promise.all([K(m.establishmentId),Nr(m.establishmentId).catch(()=>[])]);M.professionalsList=e||[],M.costCentersList=t||[],Zn(),await us()}catch(e){console.error("Erro no loadReportsPage:",e),ma.innerHTML=`
            ...
            </div>`}}function Zn(){const e=M.professionalsList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join(""),t=M.costCentersList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join("");ma.innerHTML=`
                    ...
                    <div class="flex justify-between items-center">
                        <div class="overflow-hidden mr-2">
                            ...
                            <p class="text-[10px] md:text-xs text-gray-500 mt-0.5 truncate" id="date-range-display">
                                ${Pt(M.startDate)} até ${Pt(M.endDate)}
                            </p>
                        </div>
    ...
    `,document.getElementById("toggle-filters-btn").onclick=io,document.getElementById("btn-apply-filters").onclick=()=>{Kn(),io()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{M.currentTab=a.dataset.tab,lo(),ms(),window.scrollTo({top:0,behavior:"smooth"})}}),lo()}function io(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");M.isFilterOpen=!M.isFilterOpen,M.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function lo(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===M.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Pt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function Kn(){M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.selectedProfessional=document.getElementById("report-prof").value,M.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Pt(M.startDate)} até ${Pt(M.endDate)}`,await us()}async function us(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader border-t-indigo-600"></div></div>';try{const t=M.selectedProfessional==="all"?null:M.selectedProfessional,a=qr(M.startDate,M.endDate,M.selectedProfessional,M.selectedCostCenter),o=Yn(m.establishmentId,M.startDate,M.endDate).catch(()=>({labels:[],payables:[],receivables:[],expectedBalance:[]})),r=new Date(M.startDate+"T00:00:00").toISOString(),s=new Date(M.endDate+"T23:59:59").toISOString(),n=No(m.establishmentId,r,s,t).catch(()=>[]),[i,l,d]=await Promise.all([a,o,n]);M.data=i,M.cashFlowData=l,M.appointmentsData=Array.isArray(d)?d:[],ms()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ms(){const e=document.getElementById("report-content");if(M.data)switch(M.currentTab){case"dashboards":ei(e);break;case"appointments":ti(e);break;case"dre":ai(e);break}}function ei(e){const{dreSimple:t,charts:a}=M.data,o=t||{grossRevenue:0,netProfit:0,variableCosts:0};e.innerHTML=`
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 animate-slide-up w-full">
            <div class="bg-white p-4 md:p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <p class="text-xl md:text-2xl font-black text-gray-800 tracking-tight">R$ ${o.grossRevenue.toLocaleString("pt-BR",{minimumFractionDigits:2})}</p>
            ...
            <div class="bg-white p-4 md:p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-xl md:text-2xl font-black text-red-500 tracking-tight">R$ ${o.variableCosts.toLocaleString("pt-BR",{minimumFractionDigits:2})}</p>
                <div class="mt-3 md:mt-4 h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
                     <div class="h-full bg-red-500 rounded-full" style="width: ${o.grossRevenue>0?o.variableCosts/o.grossRevenue*100:0}%"></div>
                </div>
            </div>
            ...
            <div class="bg-white p-4 md:p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-xl md:text-2xl font-black text-emerald-600 tracking-tight">R$ ${o.netProfit.toLocaleString("pt-BR",{minimumFractionDigits:2})}</p>
                 <div class="mt-3 md:mt-4 h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
                     <div class="h-full bg-emerald-500 rounded-full" style="width: ${o.grossRevenue>0?o.netProfit/o.grossRevenue*100:0}%"></div>
                </div>
            </div>
        </div>
    ...
    `,M.cashFlowData&&oi("chart-cashflow-modern",M.cashFlowData),co("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,no[0]),co("chart-profs","doughnut","Total Vendas",a.professionals.labels,a.professionals.data,no)}function ti(e){const t=M.appointmentsData,a=t.length;let o=0,r=0,s=0;const n={},i={};let l=new Date(M.startDate);const d=new Date(M.endDate);for(;l<=d;)n[l.toISOString().split("T")[0]]=0,l.setDate(l.getDate()+1);t.forEach(b=>{const h=parseFloat(b.totalAmount||b.price||0),v=(b.status||"").toLowerCase();let y=b.startTime?(b.startTime.toDate?b.startTime.toDate():new Date(b.startTime)).toISOString().split("T")[0]:"";const w=b.professionalName||"Sem Profissional";i[w]||(i[w]={name:w,count:0,value:0}),["cancelled","cancelado","no-show"].includes(v)?r++:(["completed","finalized","paid"].includes(v)&&o++,s+=h,y&&n.hasOwnProperty(y)&&n[y]++,i[w].count++,i[w].value+=h)});const c=Object.keys(n).sort(),u=c.map(b=>n[b]),g=Object.values(i).sort((b,h)=>h.value-b.value);e.innerHTML=`
    ...
    `,si("chart-appointments-daily",c,u)}function ai(e){const{dreFinancial:t}=M.data;if(!t)return;const a=t.totalRevenues,o=(i,l,d,c=!1)=>{const u=a>0?l/a*100:0,g=c?"- ":"";return`
        ...
        </div>`},r=Object.entries(t.revenues).map(([i,l])=>o(i,l,"text-emerald-600",!1)).join(""),s=Object.entries(t.expenses).map(([i,l])=>o(i,l,"text-red-500",!0)).join("");t.netResult>=0;const n=t.netResult>=0?"Lucro":"Prejuízo";e.innerHTML=`
    ...
    `}function oi(e,t){const a=document.getElementById(e);if(!a)return;const o=a.getContext("2d");ue[e]&&ue[e].destroy();const r=o.createLinearGradient(0,0,0,400);r.addColorStop(0,"rgba(59, 130, 246, 0.4)"),r.addColorStop(1,"rgba(59, 130, 246, 0.0)");const s=t.payables.map(i=>i*-1),n=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));ue[e]=new Chart(o,{type:"bar",data:{labels:n,datasets:[{label:"Saldo",data:t.expectedBalance,type:"line",borderColor:"#3b82f6",backgroundColor:r,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:6,hitRadius:30,fill:!0,tension:.4,order:0,yAxisID:"y"},{label:"Entradas",data:t.receivables,backgroundColor:"#34d399",borderRadius:4,barPercentage:.6,order:1,yAxisID:"y"},{label:"Saídas",data:s,backgroundColor:"#f87171",borderRadius:4,barPercentage:.6,order:2,yAxisID:"y"}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,font:{family:"'Inter', sans-serif",size:10}}},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(i),font:{size:10}}}}}})}function si(e,t,a){const o=document.getElementById(e);if(!o)return;const r=o.getContext("2d");ue[e]&&ue[e].destroy();const s=r.createLinearGradient(0,0,0,300);s.addColorStop(0,"rgba(99, 102, 241, 0.5)"),s.addColorStop(1,"rgba(99, 102, 241, 0.0)");const n=t.map(i=>i.split("-").reverse().slice(0,2).join("/"));ue[e]=new Chart(r,{type:"line",data:{labels:n,datasets:[{label:"Agendamentos",data:a,borderColor:"#6366f1",backgroundColor:s,borderWidth:2,fill:!0,tension:.4,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointHoverRadius:5,hitRadius:30}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#6366f1",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function co(e,t,a,o,r,s){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");ue[e]&&ue[e].destroy(),new Chart(i,{type:t,data:{labels:o,datasets:[{label:a,data:r,backgroundColor:s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:t==="doughnut"?{}:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9}}}}}})}const _t=(e,t="products")=>E(`/api/${t}/categories/${e}`),ps=(e,t="products")=>E(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),gs=(e,t="products")=>E(`/api/${t}/categories/${e}`,{method:"DELETE"}),ri="audit_logs",Fe=async(e,t,a,o,r,s=null)=>{try{if(!t)return;await Do(pe(_,ri),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:o,description:r,details:s,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},he=document.getElementById("content");let ie=null,Qe="services",we="all";function He(){const e=U.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function ni(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await ps({establishmentId:m.establishmentId,name:o},"services"),Fe(m.establishmentId,He(),"Categorias (Serviços)","Criou",`Criou categoria: ${o}`),a.value="",p("Sucesso","Categoria criada!","success"),await Pa(),await ct()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function ii(e){if(await O("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await gs(e,"services"),Fe(m.establishmentId,He(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),p("Sucesso","Categoria apagada.","success"),await Pa(),await ct()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Pa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function li(){Y({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",ni),t.addEventListener("click",o=>{const r=o.target.closest('button[data-action="delete-category"]');r&&(o.preventDefault(),ii(r.dataset.id))}))}Pa()}async function di(e){e.preventDefault();const t=e.target.closest("#serviceModal"),a=t.querySelector("#serviceId").value,o={},r=t.querySelector('input[name="commissionType"]:checked').value;r==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(n=>{const i=n.dataset.profId;if(n.querySelector('input[type="checkbox"]').checked){const d=parseFloat(n.querySelector('input[type="number"]').value);o[i]=isNaN(d)?0:d}});const s={establishmentId:m.establishmentId,name:t.querySelector("#serviceName").value,price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:r,professionalCommissions:o};try{a?(await cr(a,s),Fe(m.establishmentId,He(),"Serviços","Editou",`Editou o serviço: ${s.name}`)):(await Fo(s),Fe(m.establishmentId,He(),"Serviços","Criou",`Criou novo serviço: ${s.name}`)),document.getElementById("serviceModal").style.display="none",p("Sucesso",`Serviço ${a?"atualizado":"adicionado"} com sucesso!`,"success"),await ct()}catch(n){p("Erro",n.message,"error")}}function uo(e=null){const t=document.getElementById("serviceModal"),a=m.serviceCategories||[],o=e?.duration||0,r=e?.bufferTime||0,s=f(e?.name||""),n=f(e?.notes||""),i=e?s:"Novo Serviço",l=a.map(I=>`<option value="${I.id}" ${e?.categoryId===I.id?"selected":""}>${f(I.name)}</option>`).join("");t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[85vh] my-auto">
        <form id="serviceForm">
            ...
            `}).join(""),v.querySelectorAll('input[type="checkbox"]').forEach(I=>{I.addEventListener("change",L=>{const D=L.target.closest(".professional-commission-row");D.querySelector('input[type="number"]').disabled=!L.target.checked,D.classList.toggle("bg-blue-50",L.target.checked)})})),h();const y=t.querySelector("#serviceForm"),w=t.querySelector("#servicePhotoInput"),$=t.querySelector("#servicePhotoPreview"),k=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>w.click()),w.onchange=async()=>{const I=w.files[0];if(I){$.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const L=await Qo(I,800,800,.8),N=L.length*3/4,P=1e3*1024;if(N>P)throw new Error("A imagem é muito grande mesmo após a compressão.");$.src=L,k.value=L}catch(L){console.error("Erro ao processar imagem:",L),p("Erro de Imagem",L.message||"Não foi possível processar a imagem.","error"),$.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",k.value=e?.photo||"",w.value=""}}},y.addEventListener("submit",di)}function Pe(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",o=new Map((m.serviceCategories||[]).map(s=>[s.id,s.name]));let r=(m.services||[]).filter(Boolean);if(we!=="all"){const s=we==="active";r=r.filter(n=>n.active!==!1===s)}r=r.filter(s=>{const n=s.name.toLowerCase().includes(t),i=a==="all"||s.categoryId===a;return n&&i}),e.innerHTML="",r.length>0?r.forEach(s=>{const n=document.createElement("div"),i=JSON.stringify(s).replace(/'/g,"&apos;");n.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:bg-gray-50 ${s.active!==!1?"opacity-100":"opacity-50 bg-gray-100"} sm:flex-col`,n.dataset.action="edit-service",n.dataset.service=i;const l=f(s.name),d=f(o.get(s.categoryId)||"N/A"),c=s.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(s.name.charAt(0))}`;n.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),Ba(),Pe()}function ui(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ct(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,o,r]=await Promise.all([ge(m.establishmentId),K(m.establishmentId),_t(m.establishmentId,"services"),pr(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(o||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(s=>{s.active===void 0&&(s.active=!0)}),bs(Qe)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),p("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function bs(e){if(document.getElementById("services-content-container")){if(Qe===e&&document.getElementById("services-content-container").children.length>1){Qe==="services"&&(Ba(),Pe());return}Qe=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?ci():e==="reports"&&ui()}}function mi(){ie&&(he.removeEventListener("click",ie),he.removeEventListener("input",ie),he.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),s=r.dataset.id,n=r.checked;try{await mr(s,n);const i=m.services.findIndex(l=>l.id===s);i>-1&&(m.services[i].active=n),Fe(m.establishmentId,He(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${n?"Ativo":"Inativo"}`),Pe(),Ba()}catch(i){p("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Pe()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Pe();return}if(!a)return;if(a.hasAttribute("data-view")){bs(a.dataset.view);return}switch(a.dataset.action){case"new-service":uo();break;case"edit-service":const r=JSON.parse(a.dataset.service);uo(r);break;case"manage-categories":li();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;we=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===we||i==="total"&&we==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Pe();break}},he.addEventListener("click",ie),he.addEventListener("input",ie),he.addEventListener("change",ie)}async function pi(){he.innerHTML=`
        ...
        </section>`,mi();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await K(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),p("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Qe="services",we="all",await ct()}const Wt="suppliers",Da="purchases",fs="financial_payables",Ma=async e=>{try{const t=Rt(pe(_,Wt),ot("establishmentId","==",e)),a=await xa(t),o=[];return a.forEach(r=>{o.push({id:r.id,...r.data()})}),o}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},gi=async e=>{try{return{id:(await Do(pe(_,Wt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},bi=async(e,t)=>{try{const a=me(_,Wt,e);return await ha(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},fi=async e=>{try{const t=me(_,Wt,e);return await Os(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},vi=async(e,t=null)=>{try{const a=Ao(_),o=me(pe(_,Da)),r={...e,createdAt:Oa()};if(a.set(o,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const s=me(pe(_,fs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:o.id,createdAt:Oa()};a.set(s,i)}return await a.commit(),{id:o.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},hi=async(e,t)=>{try{const a=Ao(_),o=me(_,Da,e);a.delete(o);const r=Rt(pe(_,fs),ot("purchaseId","==",e),ot("establishmentId","==",t));return(await xa(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},xi=async e=>{try{const t=Rt(pe(_,Da),ot("establishmentId","==",e),Mo("createdAt","desc")),a=await xa(t),o=[];return a.forEach(r=>{o.push({id:r.id,...r.data()})}),o}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},be=document.getElementById("content");let le=null,Xe="products",se="all";async function yi(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await ps({establishmentId:m.establishmentId,name:o},"products"),a.value="",p("Sucesso","Categoria de produto criada!","success"),await Aa(),await ut()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function wi(e){if(await O("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await gs(e,"products"),p("Sucesso","Categoria de produto apagada.","success"),await Aa(),await ut()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Aa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${f(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function ki(){Y({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",yi),t.addEventListener("click",o=>{const r=o.target.closest('button[data-action="delete-category"]');r&&wi(r.dataset.id)}))}Aa()}async function Si(e){if(!e)return;if(await O("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await br(e),p("Sucesso","Produto apagado com sucesso!","success"),await ut()}catch(a){p("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function $i(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),o=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),s=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(s).map(l=>l.dataset.id),i={establishmentId:m.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(o)?0:o,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await gr(t,i):await Ho(i),document.getElementById("productModal").style.display="none",p("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await ut()}catch(l){throw new Error(l.message)}}function mo(e,t=800,a=800,o="image/jpeg",r=.8){return new Promise((s,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,u=d.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const g=document.createElement("canvas");g.width=c,g.height=u,g.getContext("2d").drawImage(d,0,0,c,u);const h=g.toDataURL(o,r);s(h)},d.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function po(e=null){const t=document.getElementById("productModal"),a=m.categories||[],o=m.suppliers||[],r=a.map(P=>`<option value="${P.id}" ${e?.categoryId===P.id?"selected":""}>${f(P.name)}</option>`).join("");let s=new Set(e?.supplierIds||[]);const n=f(e?.name||""),i=e?.price||"",l=e?.costPrice||"",d=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,g=e?.currentStock||0,b=e?n:"Novo Produto";t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const h=t.querySelector("#productCategory"),v=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>v.click()),h.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(P=>`<option value="${P.id}" ${e?.categoryId===P.id?"selected":""}>${f(P.name)}</option>`).join(""),e&&(h.value=e.categoryId||"");const y=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const w=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",$=e?.photo||"";v.onchange=async()=>{const P=v.files[0];if(P){y.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const B=await mo(P,800,800,"image/jpeg",.8),F=B.length*3/4,z=1e3*1024;if(F>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=B,base64Input.value=B}catch(B){console.error("Erro ao processar imagem:",B),p("Erro de Imagem",B.message||"Não foi possível processar a imagem.","error"),preview.src=w,base64Input.value=$,N.value=""}}};const k=t.cloneNode(!0);t.parentNode.replaceChild(k,t);const I=()=>{const P=k.querySelector("#modalSupplierSearch"),B=k.querySelector("#supplierSearchResults"),R=k.querySelector("#selectedSuppliersList"),F=P.value.toLowerCase();if(F.length>0){const z=o.filter(j=>j.name.toLowerCase().includes(F)&&!s.has(j.id));z.length>0?(B.classList.remove("hidden"),B.innerHTML=z.map(j=>`
                ...
                `).join("")):(B.classList.remove("hidden"),B.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else B.classList.add("hidden");s.size>0?(R.innerHTML="",s.forEach(z=>{const j=o.find(Q=>Q.id===z);j&&(R.innerHTML+=`
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};k.querySelector("#modalSupplierSearch").addEventListener("input",I),k.addEventListener("click",P=>{const B=P.target.closest("[data-add-supplier]");if(B){const F=B.dataset.addSupplier;s.add(F),k.querySelector("#modalSupplierSearch").value="",I()}const R=P.target.closest("[data-remove-supplier]");if(R){const F=R.dataset.removeSupplier;s.delete(F),I()}}),I(),k.addEventListener("click",async P=>{const B=P.target.closest("button[data-action]");if(!B)return;const R=B.dataset.action,F=k.querySelector("#productId").value;if(R==="close-modal"&&(k.style.display="none"),R==="delete-product"){if(!F)return;k.style.display="none",await Si(F)}if(R==="save-product-modal"){const z=k.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){p("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const j=B.closest('button[data-action="save-product-modal"]');j.disabled=!0,j.textContent="A salvar...";try{await $i(z)}catch(Q){p("Erro",`Falha ao salvar: ${Q.message}`,"error"),j.disabled=!1,j.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){P.preventDefault();const z=k.querySelector("#stockAdjustmentAmount"),j=k.querySelector("#stockAdjustmentReason"),Q=parseInt(z.value,10),Ee=parseInt(B.dataset.change,10);if(!Q||Q<=0){p("Erro","Por favor, insira uma quantidade válida.","error");return}const Qt=Q*Ee,Ds=j.value||(Qt>0?"Entrada manual":"Saída manual");try{await fr(F,{change:Qt,reason:Ds});const Ve=m.products.findIndex(Ue=>Ue.id===F);if(Ve>-1){const Ue=m.products[Ve].currentStock+Qt;m.products[Ve].currentStock=Ue,k.querySelector("#currentStockDisplay").textContent=Ue,k.querySelector("#productCurrentStock").value=Ue,z.value="",j.value="",p("Sucesso","Estoque atualizado!","success"),qa(),rt()}}catch(Ve){p("Erro de Stock",Ve.message,"error")}}});const L=k.querySelectorAll(".tab-btn"),D=k.querySelectorAll(".tab-content");L.forEach(P=>{P.addEventListener("click",B=>{B.preventDefault(),L.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),P.classList.add("border-indigo-500","text-indigo-600"),P.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),D.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${P.dataset.tab}`).classList.remove("hidden")})});const N=k.querySelector("#productPhotoInput");k.querySelector("#productPhotoButton").addEventListener("click",()=>N.click()),N.onchange=async()=>{const P=N.files[0];if(!P)return;const B=k.querySelector("#productPhotoPreview"),R=k.querySelector("#productPhotoBase64");B.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await mo(P,800,800,"image/jpeg",.8),j=F.length*3/4,Q=1e3*1024;if(j>Q)throw new Error("A imagem é muito grande mesmo após a compressão.");B.src=F,R.value=F}catch(F){console.error("Erro ao processar imagem:",F),p("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),B.src=w,R.value=$,N.value=""}},k.style.display="flex"}function Ei(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),qa(),rt()}function Ii(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const o=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join("")),s&&m.categories&&(s.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join(""))}async function Ci(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await vr(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ut(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,o]=await Promise.all([lt(m.establishmentId),_t(m.establishmentId,"products"),Ma(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(o||[]).filter(Boolean),vs(Xe)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function vs(e){if(document.getElementById("products-content-container")){if(Xe===e&&document.getElementById("products-content-container").children.length>1){Xe==="products"&&(qa(),rt());return}Xe=e,se="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Ei():e==="movements"&&Ii()}}async function Li(){be.innerHTML=`
        ...
        </section>`,le&&(be.removeEventListener("click",le),be.removeEventListener("input",le),be.removeEventListener("change",le)),le=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){rt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){vs(a.dataset.view);return}switch(a.dataset.action){case"new-product":po();break;case"edit-product":po(JSON.parse(a.dataset.product));break;case"manage-product-categories":ki();break;case"generate-report":await Ci();break;case"filter-stock":const r=a.dataset.filterType;se=se===r?"all":r,document.querySelectorAll(".indicator-card").forEach(s=>{s.classList.toggle("ring-2",s.dataset.filterType===se),s.classList.toggle("ring-indigo-500",s.dataset.filterType===se),s.classList.toggle("shadow-lg",s.dataset.filterType===se)}),rt();break}},be.addEventListener("click",le),be.addEventListener("input",le),be.addEventListener("change",le),Xe="products",se="all",await ut()}const fe=document.getElementById("content");let de=null,$t="list",H={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Ti(){$t==="list"?Jt():$t==="purchases"?(H.step=1,Ze()):$t==="history"&&hs()}async function Pi(){try{const e=await Ma(m.establishmentId);return m.suppliers=e||[],H.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Bi(e){if(await O("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await fi(e),p("Sucesso","Fornecedor excluído.","success"),jt("genericModal"),Jt()}catch(t){p("Erro","Erro ao excluir: "+t.message,"error")}}async function Di(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,o={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:m.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await bi(a,o),p("Sucesso","Fornecedor atualizado!","success")):(await gi(o),p("Sucesso","Fornecedor criado!","success")),jt("genericModal"),Jt()}catch(s){p("Erro","Erro ao salvar: "+s.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Jt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Pi();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=m.suppliers.filter(s=>s.name.toLowerCase().includes(t)||s.contactName&&s.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let o='<div class="flex flex-col gap-2 md:hidden">';a.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=f(s.name),l=f(s.category||"Geral"),d=f(s.contactName||"");o+=`
    ...
    `;a.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=f(s.name),l=f(s.taxId||"Sem doc."),d=f(s.email||"-"),c=f(s.phone||"-"),u=f(s.category||"Geral");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=o+r}function Mi(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",o=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),s=f(e.name),n=f(e.category||"Fornecedor"),i=f(e.contactName||""),l=f(e.phone||""),d=`
    ...
    `;Y({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Ze(){const e=document.getElementById("purchasesContainer");if(e)if(H.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([lt(m.establishmentId),Ma(m.establishmentId)]);H.allSuppliers=a||[];const o=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(H.productsToBuy=o,o.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',s="";o.forEach(d=>{const c=parseInt(d.minStock)||0,u=parseInt(d.currentStock)||0,g=Math.max(c-u,1),b=parseFloat(d.costPrice||0),h=f(d.name);let v='<option value="">Selecione...</option>';H.allSuppliers.length>0?H.allSuppliers.forEach(y=>{const $=d.supplierIds&&d.supplierIds.includes(y.id)?"selected":"";v+=`<option value="${y.id}" ${$}>${f(y.name)}</option>`}):v='<option value="">Sem fornecedores</option>',r+=`
            ...
            `,pa()}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao calcular compras.</p>'}}else H.step===2&&Ai(e)}function Ai(e){if(!H.finalOrders||Object.keys(H.finalOrders).length===0){H.step=1,Ze();return}const t=H.isQuoteMode;let a="",o=0;const r=t?"border-indigo-100":"border-gray-200",s=t?"bg-indigo-50 border-indigo-100":"bg-gray-50 border-gray-200",n=t?"bg-blue-100 text-blue-700":"bg-green-100 text-green-700",i=t?"hidden":"flex",l=t?"Cotações Prontas":"Pedidos Prontos",d=t?"text-indigo-600":"text-green-600",c=t?"bg-indigo-50 border-indigo-100":"bg-green-50 border-green-100",u=t?"text-indigo-800":"text-green-800";for(const[g,b]of Object.entries(H.finalOrders)){let h=0,v=b.items.map(L=>{const D=L.qty*L.cost;return h+=D,`
        ...
        `}).join("");o+=h;const y=encodeURIComponent(JSON.stringify({supplierId:g,supplierName:b.info.name,totalAmount:h,items:b.items})),w=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),$=encodeURIComponent(JSON.stringify(b.items)),k=f(b.info.name),I=f(b.info.email||"");a+=`
    ...
    `}async function hs(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await xi(m.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(s=>{const n=new Date(s.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=f(s.supplierName);a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function qi(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;Y({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Di),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>jt("genericModal"))},50)}function Ri(){fe.innerHTML=`
    ...
    `,de&&(fe.removeEventListener("click",de),fe.removeEventListener("input",de),fe.removeEventListener("change",de)),de=e=>{if(e.target.closest("#tab-btn-list")&&pt("list"),e.target.closest("#tab-btn-purchases")&&pt("purchases"),e.target.closest("#tab-btn-history")&&pt("history"),e.target.id==="toggle-quote-mode"&&(H.isQuoteMode=e.target.checked,Ze()),e.target.id==="supplierSearchInput"&&Jt(),e.target.closest("#btn-new-supplier")&&go(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),o=JSON.parse(a.dataset.supplier);Mi(o)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&Bi(t.dataset.id),a==="edit"&&go(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&pa(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(o=>o.checked=a),pa()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),o={};let r=!1;if(a.forEach(s=>{if(s.offsetParent===null||!s.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=s.querySelector("td:nth-child(2)"),d=s.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(s.querySelector(".qty-input").value),u=parseFloat(s.dataset.cost),b=s.querySelector(".supplier-select").value;if(b){if(!o[b]){const h=H.allSuppliers.find(v=>v.id===b);o[b]={info:h,items:[]}}o[b].items.push({name:i,qty:c,cost:u})}}),!r){p("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}H.finalOrders=o,H.step=2,Ze()}if(e.target.closest("#btn-back-step1")&&(H.step=1,Ze()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),o=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),s=parseFloat(a.dataset.total),n=H.isQuoteMode;if(o.phone){const i=o.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${o.name}*, tudo bem?
...
`,r.forEach(c=>{l+=`- ${c.qty}x ${c.name}
`}),l+=`
Aguardo confirmação.`);const d=`https://wa.me/${i}?text=${encodeURIComponent(l)}`;window.open(d,"_blank"),p("Aberto","WhatsApp aberto.","success")}else if(o.email){const i=n?`Solicitação de Cotação - ${m.establishmentName||"Empresa"}`:`Pedido de Compra - ${m.establishmentName||"Empresa"}`;let l=`Olá ${o.name},
...
Aguardo retorno.`;const d=`mailto:${o.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else p("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const o=JSON.parse(decodeURIComponent(a.dataset.order));o.establishmentId=m.establishmentId,a.disabled=!0,a.textContent="A processar...",$e(m.establishmentId).then(r=>{const s=r.purchaseConfig||null;return vi(o,s)}).then(()=>{p("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',p("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const o=e.target.closest(".btn-delete-purchase").dataset.id;O("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await hi(o,m.establishmentId),p("Sucesso","Compra e financeiro excluídos.","success"),hs()}catch(s){p("Erro","Erro ao excluir: "+s.message,"error")}})}if(e.target.closest(".btn-print-order")){const o=e.target.closest(".supplier-order-card").dataset.supplierId,r=H.finalOrders[o];r?Ni(r,H.isQuoteMode):p("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),o=JSON.parse(a.dataset.purchase);qi(o)}},fe.addEventListener("click",de),fe.addEventListener("input",de),fe.addEventListener("change",de),pt("list")}function pt(e){$t=e,["list","purchases","history"].forEach(a=>{const o=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(o.classList.add("border-indigo-500","text-indigo-600"),o.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(o.classList.remove("border-indigo-500","text-indigo-600"),o.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Ti()}const Zt=document.getElementById("content"),bo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ne=new Set,gt=null,Be=null;function ji(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Fi(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",o=f(t.name),r=f(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Kt(){const e=document.getElementById("genericModal");e.style.display="none",Be&&e.removeEventListener("click",Be)}async function Hi(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=f(a.name),r=m.services||await ge(m.establishmentId),s=m.professionals||await K(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",Oi(a,r),zi(a),Vi(a,s),_i(a)}function Oi(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,w)=>{const $=w+1,k=$==o[1]?"selected":"",I=new Date(0,w).toLocaleString("pt-BR",{month:"long"});return`<option value="${$}" ${k}>${I.charAt(0).toUpperCase()+I.slice(1)}</option>`}).join(""),s=e.status||"active",n=f(e.name||""),i=f(e.specialty||""),l=f(e.phone||""),d=f(e.notes||"");a.innerHTML=`
        ...
        </div>`;const o=document.getElementById("batchBlockageForm");o&&o.addEventListener("submit",async s=>{s.preventDefault();const n=Array.from(s.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(b=>b.value);if(n.length===0)return p("Atenção","Selecione pelo menos um profissional.","error");const i=s.target.batchBlockageStartDate.value,l=s.target.batchBlockageEndDate.value||i,d=s.target.batchBlockageStartTime.value,c=s.target.batchBlockageEndTime.value,u=s.target.batchBlockageReason.value;if(!i||!d||!c)return p("Atenção","Preencha Data de Início, Início e Fim.","error");const g=n.map(b=>{const h={professionalId:b,establishmentId:m.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${c}`).toISOString(),reason:u};return Ot(h)});try{await Promise.all(g),p("Sucesso!",`${n.length} bloqueios foram criados.`);const b=document.getElementById("prof-blockages-filter").value;Ke(e.id,b)}catch(b){p("Erro",b.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",s=>Ke(e.id,s.target.value)),await Ke(e.id,"future")}function Ui(e,t){e.innerHTML=Object.keys(bo).map(a=>{const o=t[a]||{},r=o.active!==!1;return`
        ...
        `).join("")}catch(o){a.innerHTML=`<p class="text-red-500">${o.message}</p>`}}}function _i(e){const t=document.getElementById("genericModal");Be&&t.removeEventListener("click",Be),Be=async a=>{const o=a.target.closest("button[data-action]");if(!o){const s=a.target.closest(".tab-link");s&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),s.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(s.dataset.tab).classList.remove("hidden"));return}const r=o.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Kt();break;case"delete-professional":const s=o.dataset.id;if(await O("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await jo(s),p("Sucesso!","Profissional excluído.","success"),Kt(),Bt()}catch(v){p("Erro",`Não foi possível excluir: ${v.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=o,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(v=>v.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(v=>{const y=v.querySelector('[data-field="active"]').dataset.day;u[y]={active:v.querySelector('[data-field="active"]').checked,start:v.querySelector('[data-field="start"]').value,end:v.querySelector('[data-field="end"]').value,breakStart:v.querySelector('[data-field="breakStart"]').value,breakEnd:v.querySelector('[data-field="breakEnd"]').value}});const g={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{g.id?(await Ct(g.id,g),p("Sucesso!","Profissional atualizado.","success")):(delete g.id,await Ro(g),p("Sucesso!","Profissional criado.","success")),Kt(),Bt()}catch(v){p("Erro",v.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=o.dataset.id;if(await O("Apagar Bloqueio","Tem certeza?"))try{await ka(b),p("Bloqueio removido.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ke(e.id,v)}catch(v){p("Erro",v.message,"error")}break;case"batch-delete-blockage":const h=JSON.parse(o.dataset.ids);if(await O("Apagar em Lote",`Tem certeza que deseja apagar ${h.length} bloqueios com este motivo?`))try{await Wo(h),p("Bloqueios removidos.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ke(e.id,v)}catch(v){p("Erro",v.message,"error")}break}},t.addEventListener("click",Be)}function ga(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ne.size>0?(t.textContent=`${ne.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function Wi(){O("Excluir em Lote",`Tem certeza que deseja excluir ${ne.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await dr(Array.from(ne)),p("Sucesso!",`${ne.size} profissionais foram excluídos.`,"success"),ne.clear(),ga(),Bt()}catch(t){p("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function _e(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=ji();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),o=m.professionals.filter(r=>{const s=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return s&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Fi(o)}async function Bt(){ne.clear(),Zt.innerHTML=`
        ...
        </section>`,gt&&Zt.removeEventListener("click",gt),gt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),o=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let s={};if(a.dataset.professional)try{s=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}Hi(s);return}if(o){Wi();return}const r=t.target.closest(".professional-checkbox");if(r){const s=r.dataset.id;r.checked?ne.add(s):ne.delete(s),_e(),ga();return}},Zt.addEventListener("click",gt),document.getElementById("profSearchInput").addEventListener("input",_e),document.getElementById("showInactiveProfToggle").addEventListener("change",_e);const e=document.getElementById("professionalsList");m.professionals=null,m.services=null,_e();try{const[t,a]=await Promise.all([K(m.establishmentId),ge(m.establishmentId)]);m.professionals=t,m.services=a,_e(),ga()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}let S={clients:[],selectedClient:null,activeTab:"profile",filters:{search:"",inactiveDays:"",hasLoyalty:!1,hasDebt:!1},isFiltersExpanded:!1,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]}},xs=null;function Gt(){xs.innerHTML=`
        <section class="flex flex-col h-full bg-gray-50 relative">
            <div class="bg-white border-b shadow-sm z-30 flex-shrink-0 sticky top-0">
                <div class="p-4 flex flex-col sm:flex-row justify-between items-center gap-3 max-w-7xl mx-auto w-full">
                    <div class="w-full sm:w-auto flex justify-between items-center">
                        ...
                        ${S.selectedClient?`
                        <button id="btn-back-list" class="sm:hidden text-gray-600 bg-gray-100 p-2 rounded-full active:scale-95 transition">
                    ...
                    <div class="w-full sm:w-auto flex gap-2">
                        ${S.selectedClient?`
                        <button id="btn-back-list-desktop" class="hidden sm:flex w-auto bg-white text-gray-700 px-4 py-2.5 rounded-lg hover:bg-gray-100 transition border border-gray-300 items-center justify-center gap-2 text-sm font-bold active:scale-95 transform duration-150 shadow-sm">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                            Voltar
                        </button>
                        `:`
                        <button id="btn-new-client" class="w-full sm:w-auto bg-indigo-600 text-white px-4 py-3 sm:py-2.5 rounded-xl hover:bg-indigo-700 transition shadow flex items-center justify-center gap-2 text-sm font-bold active:scale-95 transform duration-150">
            ...
            <div id="clients-content-area" class="flex-grow overflow-y-auto w-full max-w-7xl mx-auto scroll-smooth">
                ${S.loading?'<div class="flex justify-center pt-20"><div class="loader border-t-indigo-600"></div></div>':""}
            </div>
        </section>
    `;const e=document.getElementById("btn-new-client"),t=document.getElementById("btn-back-list"),a=document.getElementById("btn-back-list-desktop");e&&(e.onclick=Qi);const o=()=>{S.selectedClient=null,nt()};t&&(t.onclick=o),a&&(a.onclick=o)}function nt(){Gt();const e=document.getElementById("clients-content-area"),t=`
        <div class="sticky top-0 bg-gray-50 z-20 px-4 pt-4 pb-2 shadow-sm">
            <div class="bg-white p-2 rounded-xl border border-gray-200 shadow-sm">
                
                <div class="flex gap-2 items-center">
                    <div class="relative flex-grow">
                        <input type="text" id="client-search" 
                            class="w-full py-3 pl-10 pr-3 rounded-lg bg-gray-50 border-transparent focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none transition" 
                    ...
                    <button id="btn-toggle-filters" class="p-3 border border-gray-200 rounded-lg text-gray-600 bg-white hover:bg-gray-50 transition active:bg-gray-100 relative">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
                        ${S.filters.inactiveDays||S.filters.hasLoyalty||S.filters.hasDebt?'<span class="absolute top-1 right-1 w-2.5 h-2.5 bg-indigo-600 rounded-full border border-white"></span>':""}
                    </button>
                </div>

                <div id="advanced-filters" class="${S.isFiltersExpanded?"block":"hidden"} mt-3 pt-3 border-t border-gray-100 animate-fade-in space-y-3">
                    
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1">Dias sem visita</label>
                        <input type="number" id="filter-inactive" inputmode="numeric"
                            class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 text-base outline-none" 
                            placeholder="Ex: 30" 
                            value="${S.filters.inactiveDays}">
                    </div>

                    <div class="flex flex-col gap-2">
                        <label class="flex items-center p-2 border rounded-lg active:bg-gray-50">
                            <input type="checkbox" id="filter-loyalty" class="rounded text-indigo-600 focus:ring-indigo-500 w-5 h-5" ${S.filters.hasLoyalty?"checked":""}>
                            <span class="ml-3 text-sm text-gray-700 font-medium">Tem Pontos de Fidelidade</span>
                        </label>
                        <label class="flex items-center p-2 border rounded-lg border-red-100 active:bg-red-50">
                            <input type="checkbox" id="filter-debt" class="rounded text-red-600 focus:ring-red-500 w-5 h-5" ${S.filters.hasDebt?"checked":""}>
                            <span class="ml-3 text-sm font-bold text-red-600">Possui Débitos (Fiado)</span>
                        </label>
                    </div>

                    <button id="btn-apply-filters" class="w-full bg-gray-800 text-white py-3 rounded-lg text-sm font-bold shadow-md active:scale-95 transition">
                        Aplicar Filtros
                    </button>
                </div>
    ...
    `,a=S.clients.length>0?`
        <div class="p-4 pb-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ${S.clients.map(l=>{const d=l.totalDebt&&parseFloat(l.totalDebt)>0;return`
                <div class="client-card bg-white p-4 rounded-xl border ${d?"border-red-300 bg-red-50/30":"border-gray-200"} shadow-sm active:scale-[0.98] transition-transform duration-100 cursor-pointer flex items-center gap-4 select-none" data-id="${l.id}">
                    
                    <div class="w-14 h-14 rounded-full ${d?"bg-red-100 text-red-600":"bg-indigo-100 text-indigo-600"} flex items-center justify-center font-bold text-xl flex-shrink-0 shadow-sm">
                        ${l.name.charAt(0).toUpperCase()}
                    </div>
                    
                    <div class="flex-grow min-w-0">
                        <h3 class="font-bold text-gray-800 text-lg leading-tight truncate">${f(l.name)}</h3>
                        <p class="text-sm text-gray-500 truncate mb-1">${l.phone||"Sem telefone"}</p>
                        
                        <div class="flex flex-wrap gap-1">
                            ${l.loyaltyPoints?`<span class="text-[10px] font-bold text-amber-700 bg-amber-100 px-2 py-0.5 rounded-full border border-amber-200">⭐ ${l.loyaltyPoints}</span>`:""}
                            ${d?`<span class="text-[10px] font-bold text-red-700 bg-red-100 px-2 py-0.5 rounded-full border border-red-200">Devendo: R$ ${parseFloat(l.totalDebt).toFixed(2)}</span>`:""}
                        </div>
                    </div>
    ...
    `:`
        <div class="flex flex-col items-center justify-center py-20 px-6 opacity-60 text-center">
            ...
            <p class="text-sm text-gray-500">Tente buscar por outro nome.</p>
        </div>
    `;e.innerHTML=t+a;const o=document.getElementById("client-search"),r=document.getElementById("btn-toggle-filters"),s=document.getElementById("advanced-filters");r&&(r.onclick=()=>{S.isFiltersExpanded=!S.isFiltersExpanded,S.isFiltersExpanded?(s.classList.remove("hidden"),r.classList.add("bg-indigo-50","text-indigo-600","border-indigo-300")):(s.classList.add("hidden"),r.classList.remove("bg-indigo-50","text-indigo-600","border-indigo-300"))});const n=()=>{const l=document.getElementById("filter-inactive"),d=document.getElementById("filter-loyalty"),c=document.getElementById("filter-debt");S.filters={search:o.value,inactiveDays:l?l.value:"",hasLoyalty:d?d.checked:!1,hasDebt:c?c.checked:!1},Ss()},i=document.getElementById("btn-apply-filters");i&&(i.onclick=n),o.addEventListener("keypress",l=>{l.key==="Enter"&&n()}),e.querySelectorAll(".client-card").forEach(l=>{l.onclick=()=>Es(l.dataset.id)})}function it(){Gt();const e=document.getElementById("clients-content-area"),t=S.selectedClient;if(!t)return nt();const a=`
        <div class="bg-indigo-600 text-white p-6 rounded-b-3xl shadow-md mb-4 relative overflow-hidden flex-shrink-0">
            ...
            <div class="flex flex-col items-center text-center relative z-10">
                <div class="w-20 h-20 rounded-full bg-white text-indigo-600 flex items-center justify-center text-3xl font-bold shadow-lg mb-2 border-4 border-indigo-400">
                    ${t.name.charAt(0).toUpperCase()}
                </div>
                <h2 class="text-xl font-bold leading-tight break-words w-full">${f(t.name)}</h2>
                <div class="flex items-center justify-center gap-2 mt-1 opacity-90 text-xs">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                    <span>${t.phone||"Sem telefone"}</span>
                </div>
                ${t.totalDebt&&t.totalDebt>0?`
                    <div class="mt-2 bg-red-500/90 text-white px-3 py-0.5 rounded-full text-xs font-bold shadow-sm">
                        Débito: R$ ${parseFloat(t.totalDebt).toFixed(2)}
                    </div>
                `:""}
            </div>
        </div>
    `,o=`
        <div class="bg-white border-b sticky top-0 z-20 shadow-sm w-full flex-shrink-0">
            <div class="flex overflow-x-auto no-scrollbar gap-1 px-4 py-2 w-full touch-pan-x">
                <button class="tab-btn ${S.activeTab==="profile"?"active":""}" data-tab="profile">
                    👤 <span class="ml-1">Perfil</span>
                </button>
                <button class="tab-btn ${S.activeTab==="appointments"?"active":""}" data-tab="appointments">
                    📅 <span class="ml-1">Agendas</span>
                </button>
                <button class="tab-btn ${S.activeTab==="history"?"active":""}" data-tab="history">
                    💰 <span class="ml-1">Histórico</span>
                </button>
                <button class="tab-btn ${S.activeTab==="loyalty"?"active":""}" data-tab="loyalty">
                    ⭐ <span class="ml-1">Fidelidade</span>
                </button>
            </div>
        </div>
    `;e.innerHTML=`
        <div class="w-full bg-gray-50 min-h-full flex flex-col">
            ${a}
            ${o}
            <div id="tab-content-area" class="p-4 flex-grow relative pb-32 min-h-[300px]">
                </div>
        </div>
    `;const r=document.getElementById("tab-content-area"),s=["appointments","history","loyalty"].includes(S.activeTab),n=S.historyData.appointments.length>0;if(s&&!n&&!S.historyLoading)r.innerHTML='<div class="flex justify-center pt-10"><div class="loader"></div></div>',$s(t.id).then(()=>{it()});else if(S.historyLoading)r.innerHTML='<div class="flex justify-center pt-10"><div class="loader"></div></div>';else{let i="";S.activeTab==="profile"?i=Ji(t):S.activeTab==="appointments"?i=ws():S.activeTab==="history"?i=ks():S.activeTab==="loyalty"&&(i=Gi(t)),r.innerHTML=`<div class="animate-fade-in max-w-2xl mx-auto">${i}</div>`,ys(e,t)}if(!document.getElementById("tabs-styles")){const i=document.createElement("style");i.id="tabs-styles",i.textContent=`
            .tab-btn { padding: 8px 16px; white-space: nowrap; font-size: 0.9rem; font-weight: 500; color: #6b7280; background: #f3f4f6; border-radius: 99px; transition: all 0.2s; flex-shrink: 0; }
            .tab-btn.active { color: #fff; background-color: #4f46e5; font-weight: 700; box-shadow: 0 2px 4px rgba(79, 70, 229, 0.3); }
            .no-scrollbar::-webkit-scrollbar { display: none; }
            .no-scrollbar { -ms-overflow-style: none; scrollbar-width: none; }
        `,e.appendChild(i)}e.querySelectorAll(".tab-btn").forEach(i=>{i.onclick=()=>{const l=i.dataset.tab;S.activeTab!==l&&((l==="appointments"||l==="history")&&(S.historyLimit=20,S.historySearchTerm=""),S.activeTab=l,it())}})}function ys(e,t){if(S.activeTab==="profile"){const r=document.getElementById("form-edit-client"),s=document.getElementById("btn-delete-client");r&&(r.onsubmit=Xi),s&&(s.onclick=Zi)}if(S.activeTab==="loyalty"){const r=document.getElementById("btn-manual-redeem");r&&(r.onclick=()=>Yi(t))}const a=document.getElementById("history-search-input");if(a){const r=a.value;a.value="",a.focus(),a.value=r,a.addEventListener("input",s=>{S.historySearchTerm=s.target.value;const n=document.querySelector("#tab-content-area .animate-fade-in");n&&(S.activeTab==="appointments"&&(n.innerHTML=ws()),S.activeTab==="history"&&(n.innerHTML=ks()),ys(e,t))})}const o=document.getElementById("btn-load-more");o&&(o.onclick=async()=>{S.historyLimit+=20;const r=o;r.innerHTML='<div class="loader w-4 h-4 border-indigo-600"></div>',await $s(t.id),it()}),e.querySelectorAll("[data-go-agenda]").forEach(r=>{r.onclick=()=>Z("agenda-section",{targetDate:new Date(r.dataset.date),scrollToAppointmentId:r.dataset.id})}),e.querySelectorAll("[data-go-comanda]").forEach(r=>{r.onclick=()=>Z("comandas-section",{selectedAppointmentId:r.dataset.id,initialFilter:"finalizadas"})})}function Ji(e){return`
        <form id="form-edit-client" class="space-y-6">
            <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                <h3 class="font-bold text-gray-800 mb-4 flex items-center gap-2 border-b pb-2">
                    <span class="bg-indigo-100 p-1.5 rounded-lg text-indigo-600">👤</span>
                    Dados Pessoais
                </h3>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" value="${f(e.name)}" required 
                            class="block w-full p-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base appearance-none">
                    </div>
                    
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">Telefone / WhatsApp</label>
                        <input type="tel" name="phone" value="${f(e.phone||"")}" 
                            class="block w-full p-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base appearance-none">
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">E-mail</label>
                        <input type="email" name="email" value="${f(e.email||"")}" 
                            class="block w-full p-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base appearance-none">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="dobDay" min="1" max="31" inputmode="numeric" value="${e.dobDay||""}" 
                                class="block w-full p-3 rounded-xl border border-gray-300 bg-gray-50 text-base text-center appearance-none">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Mês Nasc.</label>
                            <input type="number" name="dobMonth" min="1" max="12" inputmode="numeric" value="${e.dobMonth||""}" 
                                class="block w-full p-3 rounded-xl border border-gray-300 bg-gray-50 text-base text-center appearance-none">
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                <h3 class="font-bold text-gray-800 mb-3 flex items-center gap-2 border-b pb-2">
                    <span class="bg-yellow-100 p-1.5 rounded-lg text-yellow-600">📝</span>
                    Anotações
                </h3>
                <textarea name="notes" rows="4" 
                    class="block w-full p-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition text-base appearance-none" 
                    placeholder="Preferências, alergias ou observações...">${f(e.notes||"")}</textarea>
            </div>
            
            <div class="pt-4 space-y-3">
                <button type="submit" class="w-full bg-indigo-600 text-white px-6 py-4 rounded-xl font-bold shadow-lg hover:bg-indigo-700 transition transform active:scale-[0.98] text-base">
                    Salvar Alterações
                </button>
                
                <button type="button" id="btn-delete-client" class="w-full bg-white text-red-500 border border-red-200 px-6 py-3 rounded-xl font-bold transition text-sm flex items-center justify-center gap-2 active:bg-red-50">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                    Excluir Cliente
                </button>
            </div>
        </form>
    `}function ws(e){let t=S.historyData.appointments||[];if(S.historySearchTerm){const o=S.historySearchTerm.toLowerCase();t=t.filter(r=>r.serviceName&&r.serviceName.toLowerCase().includes(o)||r.professionalName&&r.professionalName.toLowerCase().includes(o))}t.sort((o,r)=>new Date(r.startTime)-new Date(o.startTime));const a=o=>{const r=new Date(o.startTime),s=r.getDate(),n=r.toLocaleDateString("pt-BR",{month:"short"}).toUpperCase().replace(".",""),i=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=r<new Date;let d=l?"border-l-4 border-l-gray-300 bg-gray-50 opacity-80":"border-l-4 border-l-green-500 bg-white",c=l?"Concluído":"Agendado";return o.status==="cancelled"&&(d="border-l-4 border-l-red-400 bg-red-50 opacity-70",c="Cancelado"),`
            <div class="relative rounded-r-xl border-t border-b border-r border-gray-200 ${d} p-4 shadow-sm mb-3 flex gap-4 cursor-pointer active:scale-[0.98] transition"
                 data-go-agenda="true" data-id="${o.id}" data-date="${o.startTime}">
                
                <div class="flex flex-col items-center justify-center pr-3 border-r border-gray-200 min-w-[3.5rem]">
                    <span class="text-2xl font-black text-gray-700 leading-none">${s}</span>
                ...
                <div class="flex-grow min-w-0 flex flex-col justify-center">
                    ...
                    <p class="text-xs text-gray-500 truncate mb-1">Prof: ${f(o.professionalName||"N/A")}</p>
                    <div class="flex items-center gap-2">
                        <span class="text-xs font-mono bg-gray-100 px-1.5 rounded text-gray-600">🕒 ${i}</span>
                        <span class="text-[10px] uppercase font-bold text-gray-400">${c}</span>
                    </div>
                </div>
            </div>
        `};return`
        <div class="space-y-4">
            <div class="relative">
                <input type="text" id="history-search-input" 
                    class="w-full p-3 pl-10 bg-white border border-gray-300 rounded-xl text-base focus:ring-2 focus:ring-indigo-500 outline-none shadow-sm" 
            ...
            <div class="pb-4">
                ${t.length?t.map(a).join(""):'<div class="flex flex-col items-center py-10 text-gray-400"><p class="italic">Nenhum agendamento encontrado.</p></div>'}
            </div>
            
            ${t.length>=S.historyLimit?`
            <button id="btn-load-more" class="w-full py-3 text-sm text-indigo-600 font-bold bg-indigo-50 rounded-xl hover:bg-indigo-100 transition mb-6">
                Carregar mais antigos
            </button>`:""}
        </div>
    `}function ks(e){let t=S.historyData.sales||[];if(S.historySearchTerm){const a=S.historySearchTerm.toLowerCase();t=t.filter(o=>o.id.toLowerCase().includes(a))}return t.sort((a,o)=>new Date(o.date)-new Date(a.date)),t.length===0&&!S.historySearchTerm?`<div class="text-center py-12 text-gray-400 flex flex-col items-center">
        ...
        <div class="space-y-4">
            <div class="relative">
                <input type="text" id="history-search-input" 
                    class="w-full p-3 pl-10 bg-white border border-gray-300 rounded-xl text-base focus:ring-2 focus:ring-indigo-500 outline-none shadow-sm" 
                    placeholder="Buscar ID da venda..." 
                    value="${S.historySearchTerm}">
                <svg class="w-5 h-5 text-gray-400 absolute left-3 top-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
            </div>
            ...
            <div class="space-y-3 pb-4">
                ${t.map(a=>{const o=new Date(a.date||a.createdAt),r=a.totalAmount||0;return`
                    <div class="bg-white border border-gray-100 rounded-2xl p-4 flex justify-between items-center shadow-sm active:bg-gray-50 cursor-pointer active:scale-[0.98] transition"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-bold text-gray-800 text-sm">Venda <span class="text-xs text-gray-400">#${a.id.slice(-4)}</span></p>
                                <p class="text-xs text-gray-500">${o.toLocaleDateString()} às ${o.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="font-black text-gray-800">R$ ${parseFloat(r).toFixed(2)}</p>
                            <svg class="w-4 h-4 text-gray-300 ml-auto mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                        </div>
                    </div>
                    `}).join("")}
            </div>
    ...
    `}function Gi(e){const t=S.historyData.loyaltyLog||[];t.sort((o,r)=>new Date(r.date)-new Date(o.date));const a=t.length>0?t.map(o=>{const r=o.type==="redemption";return`
            <div class="flex justify-between items-center py-4 border-b border-gray-100 last:border-0">
                <div class="flex items-center gap-3">
                    <div class="w-2 h-2 rounded-full ${r?"bg-red-500":"bg-green-500"} shadow-sm"></div>
                    <div>
                        <p class="text-sm font-bold text-gray-700 leading-tight">${f(o.description||(r?"Resgate":"Acúmulo"))}</p>
                        <p class="text-[10px] text-gray-400 mt-0.5">${new Date(o.date).toLocaleDateString()}</p>
                    </div>
                </div>
                <span class="font-black text-sm ${r?"text-red-600":"text-green-600"} bg-gray-50 px-2 py-1 rounded-md">
                    ${r?"-":"+"}${o.points}
                </span>
            </div>
        `}).join(""):'<p class="text-center text-gray-400 py-6 text-xs italic">Sem histórico recente.</p>';return`
        <div class="space-y-6">
            <div class="bg-gradient-to-br from-amber-400 to-orange-500 rounded-3xl p-6 text-white shadow-xl relative overflow-hidden">
                <div class="absolute right-0 top-0 opacity-10 transform translate-x-4 -translate-y-4">
                    <svg class="w-48 h-48" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                </div>
                
                <p class="text-amber-100 font-bold uppercase tracking-wider text-xs mb-1">Saldo de Pontos</p>
                <div class="flex items-baseline gap-2 relative z-10">
                    <h1 class="text-6xl font-black tracking-tighter shadow-sm">${e.loyaltyPoints||0}</h1>
                    <span class="text-xl opacity-90 font-medium">pts</span>
                </div>
                
                <button id="btn-manual-redeem" class="mt-6 w-full bg-white/20 hover:bg-white/30 text-white text-sm font-bold py-3.5 px-4 rounded-xl backdrop-blur-md transition border border-white/30 flex items-center justify-center gap-2 active:scale-95 shadow-sm">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
                <h4 class="text-xs font-bold text-gray-400 uppercase tracking-wide mb-2">Últimas Movimentações</h4>
                ${a}
            </div>
        </div>
    `}async function Ss(){S.loading=!0,Gt();try{let e=`/api/clients/${m.establishmentId}?limit=20`;S.filters.search&&(e+=`&search=${encodeURIComponent(S.filters.search)}`),S.filters.inactiveDays&&(e+=`&inactiveDays=${S.filters.inactiveDays}`),S.filters.hasLoyalty&&(e+="&hasLoyalty=true"),S.filters.hasDebt&&(e+="&hasDebt=true"),S.clients=await E(e),nt()}catch(e){console.error(e),p("Erro","Falha ao carregar clientes.","error"),S.clients=[],nt()}finally{S.loading=!1;const e=document.querySelector(".loader");e&&e.parentElement&&!document.getElementById("clients-content-area")&&e.parentElement.remove()}}async function $s(e){const t=S.selectedClient;if(!(!t||!t.phone)){S.historyLoading=!0;try{const a=new Date;a.setMonth(a.getMonth()+12);const o=new Date;o.setFullYear(o.getFullYear()-5);let r=`/api/appointments/${m.establishmentId}?startDate=${o.toISOString()}&endDate=${a.toISOString()}`;r+=`&clientPhone=${encodeURIComponent(t.phone)}`,r+=`&limit=${S.historyLimit}`;const s=await E(r);S.historyData.appointments=s,S.historyData.sales=s.filter(i=>i.status==="completed").map(i=>({id:i.id,date:i.startTime,totalAmount:i.totalAmount||0,items:i.services||[]}));const n=[];s.forEach(i=>{i.status==="completed"&&i.loyaltyPointsEarned>0&&n.push({type:"earn",points:i.loyaltyPointsEarned,date:i.startTime,description:"Venda finalizada"}),i.loyaltyRedemption&&n.push({type:"redemption",points:i.loyaltyRedemption.cost||0,date:i.startTime,description:`Resgate: ${i.loyaltyRedemption.name}`})}),S.historyData.loyaltyLog=n}catch(a){console.error("Erro ao buscar histórico",a)}finally{S.historyLoading=!1}}}function Yi(e){const t=e.loyaltyPoints||0,a=`
        <div class="text-center mb-6">
            <p class="text-xs text-gray-500 uppercase font-bold tracking-wide">Saldo Atual</p>
            <h2 class="text-5xl font-black text-gray-800">${t}</h2>
        </div>
        <form id="manual-redeem-form" class="space-y-4">
            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Tipo de Ação</label>
                <div class="grid grid-cols-2 gap-2">
                    <label class="cursor-pointer">
                        <input type="radio" name="action_type" value="debit" checked class="peer sr-only">
                        <div class="p-3 rounded-xl border border-gray-200 text-center peer-checked:bg-red-50 peer-checked:border-red-500 peer-checked:text-red-700 transition">
                            <div class="font-bold">Remover</div>
                            <div class="text-xs">Resgate</div>
                        </div>
                    </label>
                    <label class="cursor-pointer">
                        <input type="radio" name="action_type" value="credit" class="peer sr-only">
                        <div class="p-3 rounded-xl border border-gray-200 text-center peer-checked:bg-green-50 peer-checked:border-green-500 peer-checked:text-green-700 transition">
                            <div class="font-bold">Adicionar</div>
                            <div class="text-xs">Correção</div>
                        </div>
                    </label>
                </div>
            </div>
            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Pontos</label>
                <input type="number" id="redeem-points" inputmode="numeric" min="1" required class="w-full p-4 border rounded-xl text-xl font-bold text-center outline-none focus:ring-2 focus:ring-indigo-500" placeholder="0">
            </div>
            <div>
            ...
            <div class="pt-4">
                <button type="submit" class="w-full bg-gray-900 text-white px-4 py-4 rounded-xl font-bold shadow-lg hover:bg-black active:scale-[0.98] transition">Confirmar</button>
            </div>
        </form>
    `,{modalElement:o,close:r}=Y({title:"Ajuste Manual",contentHTML:a,maxWidth:"max-w-xs"});o.querySelector("form").onsubmit=async s=>{s.preventDefault();const n=document.querySelector('input[name="action_type"]:checked').value,i=parseInt(document.getElementById("redeem-points").value,10),l=document.getElementById("redeem-reason").value;if(!i||i<=0)return p("Erro","Qtd inválida.","error");if(n==="debit"&&i>t)return p("Erro","Saldo insuficiente.","error");try{let d=t;n==="debit"?(await Hr(m.establishmentId,e.phone,i,l),d-=i):(d+=i,await Yo(e.id,{loyaltyPoints:d})),S.selectedClient.loyaltyPoints=d,S.historyData.loyaltyLog.unshift({type:n==="debit"?"redemption":"earn",points:i,date:new Date().toISOString(),description:l+" (Manual)"}),p("Sucesso","Saldo atualizado.","success"),r(),it()}catch(d){p("Erro",d.message,"error")}}}function Es(e){S.selectedClient=S.clients.find(t=>t.id===e),S.activeTab="profile",S.historyLimit=20,S.historySearchTerm="",S.historyData={appointments:[],sales:[],loyaltyLog:[]},it()}function Qi(){const e=`
        <form id="modal-new-client-form" class="space-y-4">
            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Nome Completo *</label>
                <input type="text" id="new-name" required class="w-full border border-gray-300 p-3 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 text-base">
            </div>
            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Telefone (WhatsApp) *</label>
                <input type="tel" id="new-phone" inputmode="tel" required class="w-full border border-gray-300 p-3 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 text-base">
            </div>
            <div class="pt-4">
                <button type="submit" class="w-full bg-indigo-600 text-white px-6 py-4 rounded-xl font-bold shadow hover:bg-indigo-700 active:scale-95 transition">Cadastrar Cliente</button>
            </div>
        </form>
    `,{modalElement:t,close:a}=Y({title:"Novo Cliente",contentHTML:e,maxWidth:"max-w-sm"});t.querySelector("form").onsubmit=async o=>{o.preventDefault();const r=document.getElementById("new-name").value,s=document.getElementById("new-phone").value;try{const n=await $a({establishmentId:m.establishmentId,name:r,phone:s});S.clients.unshift(n),p("Sucesso","Cliente criado!","success"),a(),Es(n.id)}catch(n){p("Erro",n.message,"error")}}}async function Xi(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());a.establishmentId=m.establishmentId;try{await Yo(S.selectedClient.id,a),Object.assign(S.selectedClient,a);const o=S.clients.findIndex(r=>r.id===S.selectedClient.id);o!==-1&&(S.clients[o]=S.selectedClient),p("Sucesso","Dados salvos!","success")}catch(o){p("Erro",o.message,"error")}}async function Zi(){if(await O("Excluir Cliente","Tem certeza? O histórico será apagado."))try{await Fr(S.selectedClient.id),S.clients=S.clients.filter(e=>e.id!==S.selectedClient.id),S.selectedClient=null,p("Sucesso","Cliente removido.","success"),nt()}catch(e){p("Erro",e.message,"error")}}async function Ki(){xs=document.getElementById("content"),S.selectedClient=null,S.searchTerm="",S.historyLimit=20,S.isFiltersExpanded=!1,Gt(),await Ss()}const xe=document.getElementById("content"),ea={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},el={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}},Is=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"},{id:"support",icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",label:"Suporte e Ajuda"},{id:"cancellation",icon:"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z",label:"Cancelar Assinatura"}];let J=null;function fo(e,t,a){return new Promise((o,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const g=e.type==="image/png"&&t<500?"image/png":"image/jpeg";o(l.toDataURL(g,a))},i.onerror=l=>r(l)},s.onerror=n=>r(n)})}function Ce(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const o=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i="")=>{const l=n.id===t?"selected":"";a+=`<option value="${n.id}" ${l}>${i}${f(n.name)}</option>`,n.children.forEach(d=>r(d,i+"— "))};return o(e).forEach(n=>r(n)),a}async function Oe(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const o=J||await $e(m.establishmentId),r=[],{ownerName:s,...n}=e;if(s&&s!==m.userName){const l=U.currentUser;l&&r.push(Rs(l,{displayName:s}).then(()=>{m.userName=s}))}const i={...o,...n};if(r.push(kt(m.establishmentId,i)),await Promise.all(r),J=i,p("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),n.themeColor)setTimeout(()=>window.location.reload(),1500);else{const l=document.getElementById("panelEstablishmentName");n.name&&l&&(l.textContent=n.name,m.establishmentName=n.name)}}catch(o){p("Erro",`Não foi possível salvar: ${o.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function tl(e,t){const a=f(e.name||""),o=f(e.phone||""),r=f(e.document||""),s=f(e.email||""),n=f(e.address||""),i=f(e.website||""),l=f(m.userName||"");t.innerHTML=`
    ...
    `,t.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newPassword").value,r=t.querySelector("#confirmPassword").value;if(o!==r){p("Erro","As senhas não coincidem.","error");return}const s=t.querySelector('button[form="change-password-form"]');s.disabled=!0,s.textContent="A Salvar...";try{const n=U.currentUser;if(n)await Ns(n,o),p("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum usuário autenticado encontrado.")}catch(n){p("Erro",`Não foi possível alterar a senha: ${n.message}`,"error")}finally{s.disabled=!1,s.textContent="Salvar Nova Senha"}})}function ol(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!o||!r){p("Erro","Preencha todos os campos.","error");return}const s=t.querySelector('button[form="change-email-form"]');s.disabled=!0,s.textContent="A verificar...";try{const n=U.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=Ms.credential(n.email,r);await As(n,i),s.textContent="A enviar link...",await qs(n,o),s.textContent="A atualizar BD...",await ir(m.establishmentId,o),p("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,p("Erro",i,"error")}finally{s.disabled=!1,s.textContent="Salvar Novo E-mail"}})}function sl(e,t){const a=f(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");if(e.timezone)a.value=e.timezone;else try{const s=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(a.options).some(i=>i.value===s)?a.value=s:a.value="America/Sao_Paulo"}catch{a.value="America/Sao_Paulo"}const o=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(ea).forEach(s=>{const n=r[s]||{},i=ea[s],l=n.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${l?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,o.appendChild(d)}),o.addEventListener("change",s=>{const n=s.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",s=>{s.preventDefault();const n={};Object.keys(ea).forEach(l=>{n[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;Oe({workingHours:n,timezone:i},s)})}async function il(e,t){const a=e.loyaltyProgram||{},o=a.pointsPerVisit||1;let r=[],s=[],n=[];try{[r,s,n]=await Promise.all([ge(m.establishmentId),lt(m.establishmentId),Ca(m.establishmentId)])}catch(d){console.error("Erro ao carregar dados para fidelidade:",d)}t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#loyaltyEnabled").checked=a.enabled||!1;const i=t.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const c=document.createElement("div");c.className="loyalty-tier-row group bg-white md:bg-transparent p-3 md:p-0 border md:border-0 rounded-lg shadow-sm md:shadow-none relative md:grid md:grid-cols-[0.8fr_1fr_1.5fr_1fr_auto] md:gap-2 md:items-start";const u=d.type||"money",g=d.itemId||"",b=d.reward||"",h=d.discount||"",v=d.points||d.costPoints||"";c.innerHTML=`
    ...
    `;try{const[a,o]=await Promise.all([La(m.establishmentId),Ta(m.establishmentId)]),r=e.financialIntegration||{},s=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ce(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ce(o,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ce(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ce(o,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ce(a,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ce(o,s.defaultCostCenterId)}catch{p("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const o={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Oe(o,a)})}function dl(e,t){const a="5516997859430",o=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${o}`;t.innerHTML=`
    ...
    `}function cl(e,t){const a="5516997859430",o=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),r=`https://wa.me/${a}?text=${o}`,s="sistemakairosagenda@gmail.com";t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function Cs(e="indigo",t){const a=t.querySelector("#color-palette-container"),o=t.querySelector("#establishmentThemeColor");!a||!o||(a.innerHTML="",Object.entries(el).forEach(([r,s])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
    ...
    `,xe.querySelector('button[data-action="back-to-list"]').addEventListener("click",o=>{o.preventDefault(),Ls()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":tl(J,a);break;case"change-password":al(J,a);break;case"change-email":ol(J,a);break;case"branding":sl(J,a);break;case"booking":rl(J,a);break;case"working-hours":nl(J,a);break;case"loyalty":await il(J,a);break;case"financial":await ll(J,a);break;case"support":dl(J,a);break;case"cancellation":cl(J,a);break;default:ul(t?t.label:"Definições",a)}}async function Ls(){if(xe.innerHTML=`
    ...
    `,xe.querySelector("#settings-menu-list").addEventListener("click",s=>{const n=s.target.closest("button[data-section]");n&&(s.preventDefault(),pl(n.dataset.section))});const r=xe.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",s=>{s.preventDefault(),Z("my-profile-section")})}const et=document.getElementById("content");async function qe(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,o=document.getElementById("filterEndDate")?.value,r=await Ht(m.establishmentId,a||new Date().toISOString().split("T")[0],o||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),n=s?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let g=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;c.innerHTML+=k}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function gl(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,o=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||o,s=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${o}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Ot(i),t.reset(),p("Sucesso","Bloqueio adicionado com sucesso!","success"),qe(a)}catch(l){p("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function bl(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return p("Atenção","Selecione pelo menos um profissional.","error");const o=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||o,s=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${o}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Ot(u)});try{await Promise.all(d),p("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&qe(c)}catch(c){p("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function fl(e){et.addEventListener("submit",t=>{t.target.id==="blockageForm"&&gl(t),t.target.id==="batchBlockageForm"&&bl(t)}),et.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&qe(e)}),et.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const o=a.dataset.action;if(o==="back-to-professionals")Z("profissionais-section");else if(o==="delete-blockage"){if(await O("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await ka(a.dataset.id),p("Sucesso","Bloqueio removido.","success"),qe(e)}catch(s){p("Erro",`Não foi possível remover o bloqueio: ${s.message}`,"error")}}else if(o==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await O("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Wo(r),p("Sucesso",`${r.length} bloqueios removidos.`,"success"),qe(e)}catch(n){p("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function vl(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){et.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const o=f(a);et.innerHTML=`
        <section>
        ...
        </section>`,fl(t),await qe(t);const r=document.getElementById("batchProfSelectionContainer");try{const s=await K(m.establishmentId);r.innerHTML=s.map(n=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const hl=e=>E(`/api/users/${e}`),xl=e=>E("/api/users",{method:"POST",body:JSON.stringify(e)}),yl=(e,t)=>E(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),wl=e=>E(`/api/users/${e}`,{method:"DELETE"}),kl=(e,t)=>E(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),Sl=(e,t)=>E(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),ve=document.getElementById("content"),$l={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},El={view:"Visualizar",create:"Criar",edit:"Editar"};let We=null,Je=null;function Il(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const o=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${o}</p>`;return}e.sort((o,r)=>(o.status==="active"?-1:1)-(r.status==="active"?-1:1)),t.innerHTML=e.map(o=>{const r=JSON.stringify(o).replace(/'/g,"&apos;"),s=o.status==="active",n=m.professionals.find(c=>c.id===o.professionalId),i=n?n.name:"N/A",l=n?n.name.charAt(0):o.name.charAt(0),d=n?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function Et(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=m.users:t=m.users.filter(a=>a.status==="active"),Il(t)}function Cl(e={}){return Object.entries($l).map(([t,a])=>{const o=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,s=Object.entries(El).map(([i,l])=>`
    ...
    `}).join("")}async function vo(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{a=await K(m.establishmentId),m.professionals=a}catch{p("Erro","Não foi possível carregar a lista de profissionais.","error")}const o=w=>a.find($=>$.id===w),r=(w,$)=>{const I=o(w)?.photo,L=$.charAt(0).toUpperCase();return{photoSrc:I||`https://placehold.co/128x128/E2E8F0/4A5568?text=${L}`,initials:L,photoUrl:I||""}},s=e?.professionalId,n=e?.name||"Novo Usuário",i=r(s,n),l=o(s),d=w=>{let $='<option value="">-- Não Associado a um Profissional --</option>';return $+=a.map(k=>`<option value="${k.id}" ${k.id===w?"selected":""}>${k.name} (${k.specialty||"N/A"})</option>`).join(""),$},c=e!==null;t.querySelector("#userFormTitle").textContent=c?`Editar Usuário: ${e.name}`:"Novo Usuário";const u=t.querySelector("#userForm");u.innerHTML=`
    ...
    `;const g=window.innerWidth<768,b=u.querySelector(".bg-white");if(g&&b){b.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const w=u.closest("section");w&&(w.style.padding="0",w.style.margin="0"),b.classList.add("p-4")}const h=u.querySelector("#userProfessionalId"),v=u.querySelector("#userPhotoPreview"),y=u.querySelector("#profPhotoName");if(h.addEventListener("change",w=>{const $=w.target.value,k=o($),I=k?k.name:"Selecione um profissional",L=r($,n);v.src=L.photoSrc,y.textContent=I,u.querySelector("#professionalPhotoUrl").value=L.photoUrl}),u.addEventListener("submit",async w=>{w.preventDefault();const $=e?.email,k=u.querySelector("#userEmail").value,I={};u.querySelectorAll('input[type="checkbox"]').forEach(N=>{const P=N.dataset.module,B=N.dataset.permission;I[P]||(I[P]={}),I[P][B]=N.checked});const L=u.querySelector("#userProfessionalId").value||null,D={name:u.querySelector("#userName").value,permissions:I,professionalId:L,establishmentId:m.establishmentId};try{c?($!==k&&(D.email=k),await yl(e.id,D),p("Usuário atualizado com sucesso!","success")):(D.email=u.querySelector("#userEmail").value,D.password=u.querySelector("#userPassword").value,await xl(D),p("Usuário criado com sucesso!","success")),Dt()}catch(N){p(`Erro: ${N.message}`,"error")}}),c){const w=u.querySelector("#password-change-container"),$=w.querySelector('[data-action="show-password-form"]'),k=w.querySelector("#password-form"),I=k.querySelector('[data-action="save-password"]'),L=k.querySelector('[data-action="cancel-password-change"]');$.addEventListener("click",()=>{$.classList.add("hidden"),k.classList.remove("hidden")}),L.addEventListener("click",()=>{$.classList.remove("hidden"),k.classList.add("hidden"),k.querySelector("#userNewPassword").value=""}),I.addEventListener("click",async()=>{const D=k.querySelector("#userNewPassword").value;if(!D||D.length<6){p("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await O("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{I.disabled=!0,I.textContent="Aguarde...",await kl(e.id,D),p("Sucesso!","A senha do usuário foi alterada.","success"),$.classList.remove("hidden"),k.classList.add("hidden"),k.querySelector("#userNewPassword").value=""}catch(P){p("Erro",`Não foi possível alterar a senha: ${P.message}`,"error")}finally{I.disabled=!1,I.textContent="Salvar Nova Senha"}})}}async function Ll(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([hl(m.establishmentId),K(m.establishmentId)]);m.users=t,m.professionals=a,Et()}catch{p("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Dt(){ve.innerHTML=`
    ...
    `,We&&ve.removeEventListener("click",We),Je&&ve.removeEventListener("change",Je),We=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("click",We);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":vo();break;case"edit-user":const o=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));vo(o);break;case"back-to-list":Dt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await O("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await wl(r),p("Usuário excluído com sucesso!","success"),Dt()}catch(n){p(`Erro ao excluir: ${n.message}`,"error")}break}}},Je=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("change",Je);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Et();else if(t){e.stopPropagation();const a=t.dataset.userId,o=t.checked?"active":"inactive";try{await Sl(a,o),p(`Usuário ${o==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=m.users.findIndex(s=>s.id===a);r>-1&&(m.users[r].status=o,Et())}catch(r){p(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,Et()}}},ve.addEventListener("click",We),ve.addEventListener("change",Je),await Ll()}const Tl=document.getElementById("content");let ho={},ba=null;function Pl(){Object.values(ho).forEach(e=>e?.destroy()),ho={}}function Bl(e,t){if(!window.jspdf){p("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,o=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(o.setFontSize(18),o.text(e,o.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];o.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=o.lastAutoTable?o.lastAutoTable.finalY+20:60;o.text("Detalhes das Vendas",20,s),o.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),o.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function xo(e){const t=document.getElementById("genericModal"),a=f(e.client),o=f(e.items),r=f(e.responsavelCaixa||"N/A"),s=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function Dl(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const o=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);o.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),s.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&xo(d)})}),n.innerHTML=a.map((i,l)=>{const d=f(i.client),c=f(i.items),u=f(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&xo(d)})})}async function yo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,r=a.value;if(!o||!r)return p("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,n=await Rr({establishmentId:m.establishmentId,startDate:o,endDate:r,cashierSessionId:s});ba=n,e.innerHTML=`
        ...
        `,Dl(n)}catch(s){p("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${f(s.message)}</p>`}}async function Ml(){Pl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];Tl.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",yo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const o=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${o}_a_${r}`;Bl(s,"transactionsTable")});try{const o=await gn(m.establishmentId),r=document.getElementById("cashierSessionFilter");o&&o.length>0&&o.forEach(s=>{const n=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=f(s.closedByName||"N/A");r.innerHTML+=`<option value="${s.id}">${i} - ${n}</option>`})}catch{p("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await yo()}const Al=document.getElementById("content");let A={payables:[],receivables:[],natures:[],costCenters:[],currentTab:"payables",statusFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",isFilterOpen:!1},bt=null,ft=null;function Na(e){const t=new Map,a=[];return e&&(e.forEach(o=>t.set(o.id,{...o,children:[]})),t.forEach(o=>{o.parentId&&t.has(o.parentId)?t.get(o.parentId).children.push(o):a.push(o)})),a}function ql(e){if(!e)return{day:"--",month:"---"};const t=new Date(e+"T00:00:00"),a=t.getDate().toString().padStart(2,"0"),o=t.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:a,month:o,full:t.toLocaleDateString("pt-BR")}}function It(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function Nl(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const o=(r,s=0)=>`
        ...
        `;e.innerHTML=t.map(r=>o(r)).join("")}async function fa(e){const t=document.getElementById("genericModal"),a=e==="nature",o=a?"Naturezas Financeiras":"Centros de Custo",r=a?La:Ta,s=a?qn:Rn,n=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const i=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const g=Na(u);Nl(i,g,e);const b=l.value;l.innerHTML='<option value="">-- Categoria Principal --</option>';const h=(v,y=0)=>{const w="  ".repeat(y)+(y>0?"↳ ":"");l.innerHTML+=`<option value="${v.id}">${w}${v.name}</option>`,v.children.forEach($=>h($,y+1))};g.forEach(v=>h(v)),l.value=b};try{const u=await r(m.establishmentId);A[n]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const g=t.querySelector("#itemName").value,b=l.value;try{await s({name:g,parentId:b||null,establishmentId:m.establishmentId});const h=await r(m.establishmentId);A[n]=h,d(h),c.reset(),await ze(),p("Sucesso","Item adicionado.","success")}catch(h){p("Erro",h.message,"error")}})}async function Rl(){jl(),Fl(),await ze()}function jl(){Al.innerHTML=`
    ...
    `}function Fl(){document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const a=document.getElementById("filter-panel"),o=document.getElementById("toggle-filter-btn");A.isFilterOpen=!A.isFilterOpen,A.isFilterOpen?(a.classList.remove("hidden"),o.classList.add("bg-indigo-100","text-indigo-600")):(a.classList.add("hidden"),o.classList.remove("bg-indigo-100","text-indigo-600"))}),document.getElementById("settings-btn").addEventListener("click",_l),document.getElementById("fab-add").addEventListener("click",()=>{const a=A.currentTab==="payables"?"payable":"receivable";ta(a)});const e=document.getElementById("tab-receivables"),t=document.getElementById("tab-payables");e.addEventListener("click",()=>wo("receivables")),t.addEventListener("click",()=>wo("payables")),document.querySelectorAll(".status-filter-btn").forEach(a=>{a.addEventListener("click",o=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-indigo-100","text-indigo-700"),r.classList.add("text-gray-500")}),o.target.classList.add("bg-indigo-100","text-indigo-700"),o.target.classList.remove("text-gray-500"),A.statusFilter=o.target.dataset.status})}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{A.startDate=document.getElementById("filterStartDate").value,A.endDate=document.getElementById("filterEndDate").value,A.filterNaturezaId=document.getElementById("filterNaturezaId").value,A.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("toggle-filter-btn").click(),ze()}),bt&&document.body.removeEventListener("click",bt),bt=a=>{const o=a.target,r=o.closest("button[data-action]");if(r){const{action:n,type:i,id:l}=r.dataset;if(a.stopPropagation(),n==="delete"){Vl(i,l);return}if(n==="mark-as-paid"){zl(i,l);return}if(n==="manage-natures"){fa("nature");return}if(n==="manage-cost-centers"){fa("cost-center");return}if(n==="edit"){const d=JSON.parse(r.dataset.item.replace(/&apos;/g,"'"));ta(i,d);return}}const s=o.closest(".financial-card-item");if(s&&document.getElementById("list-container").contains(s)){const{type:n}=s.dataset,i=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));ta(n,i)}},document.body.addEventListener("click",bt),ft&&document.getElementById("genericModal").removeEventListener("click",ft),ft=a=>{if(a.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const r=a.target.closest('button[data-action^="delete-"]');if(r){const s=r.dataset.action.split("-")[1];Ul(s,r.dataset.id)}},document.getElementById("genericModal").addEventListener("click",ft)}function wo(e){A.currentTab=e;const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),o=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-green-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),o.className="fixed bottom-6 right-6 w-14 h-14 bg-green-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-green-700 hover:scale-105 transition-all z-40"):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-green-700","shadow-sm"),t.classList.add("text-gray-500"),o.className="fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-red-700 hover:scale-105 transition-all z-40"),Ts()}async function ze(){const e=document.getElementById("list-container");e.innerHTML='<div class="loader mx-auto my-10"></div>';try{if(A.natures.length===0){const[r,s]=await Promise.all([La(m.establishmentId),Ta(m.establishmentId)]);A.natures=r,A.costCenters=s,Hl()}const t={startDate:A.startDate,endDate:A.endDate,establishmentId:m.establishmentId};A.filterNaturezaId!=="all"&&(t.natureId=A.filterNaturezaId),A.filterCostCenterId!=="all"&&(t.costCenterId=A.filterCostCenterId);const[a,o]=await Promise.all([Hn(t),_n(t)]);A.payables=a.entries||[],A.receivables=o.entries||[],Ol(),Ts()}catch(t){e.innerHTML=`<p class="text-center text-red-500 mt-10">Erro ao carregar: ${t.message}</p>`}}function Hl(){const e=o=>{let r='<option value="all">Todas</option>';const s=Na(o),n=(i,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");r+=`<option value="${i.id}">${d}${i.name}</option>`,i.children.forEach(c=>n(c,l+1))};return s.forEach(i=>n(i)),r},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(A.natures)),a&&(a.innerHTML=e(A.costCenters)),t&&(t.value=A.filterNaturezaId),a&&(a.value=A.filterCostCenterId)}function Ol(){const e=document.getElementById("summary-section");if(!e)return;const t=A.receivables.reduce((l,d)=>l+d.amount,0),a=A.receivables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),o=t-a,r=A.payables.reduce((l,d)=>l+d.amount,0),s=A.payables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),n=r-s,i=a-s;e.innerHTML=`
        <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
            ...
            <p class="text-xl font-bold text-green-600">${It(o)}</p>
        </div>
        <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
    ...
    `}function Ts(){const e=document.getElementById("list-container");if(!e)return;const t=A.currentTab==="receivables",a=t?A.receivables:A.payables;let o=a;if(A.statusFilter!=="all"&&(o=a.filter(n=>n.status===A.statusFilter)),o.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),o.length===0){e.innerHTML=`
        ...
        `;return}const r=new Map(A.natures.map(n=>[n.id,n.name])),s=t?"receivable":"payable";e.innerHTML=o.map(n=>{const i=ql(n.dueDate),l=n.status==="paid",d=l?"text-gray-400":t?"text-green-600":"text-red-500",c=n.naturezaId&&r.get(n.naturezaId)||"Geral",u=JSON.stringify(n).replace(/'/g,"&apos;");return`
        ...
        `}).join("")}async function zl(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Vn(t,a):Gn(t,a)),p("Sucesso","Lançamento baixado!","success"),await ze()}catch(o){p("Erro",o.message,"error")}}async function Vl(e,t){if(await O("Excluir Lançamento","Tem certeza? Essa ação não pode ser desfeita."))try{await(e==="payable"?zn(t):Jn(t)),p("Sucesso","Lançamento excluído.","success"),await ze()}catch(o){p("Erro",o.message,"error")}}async function Ul(e,t){const o=e==="nature"?Nn:jn;if(await O("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await o(t),fa(e==="nature"?"nature":"cost-center")}catch(s){p("Erro",s.message,"error")}}function _l(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ta(e,t=null){const a=document.getElementById("genericModal"),o=e==="payable",r=`${t?"Editar":"Nova"} ${o?"Despesa":"Receita"}`,s=o?"red":"green",n=(u,g)=>{let b='<option value="">-- Selecione --</option>';const h=Na(u),v=(y,w=0)=>{const $="  ".repeat(w)+(w>0?"↳ ":""),k=y.id===g?"selected":"";b+=`<option value="${y.id}" ${k}>${$}${y.name}</option>`,y.children.forEach(I=>v(I,w+1))};return h.forEach(y=>v(y)),b};a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden w-full m-4">
            <div class="bg-${s}-50 px-6 py-4 border-b border-${s}-100 flex justify-between items-center">
                <h2 class="text-xl font-bold text-${s}-800">${r}</h2>
                <button type="button" data-action="close-modal" class="text-${s}-400 hover:text-${s}-600 text-2xl font-bold">&times;</button>
            </div>
            ...
            <form id="financial-form" class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="description" required class="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-${s}-500 outline-none transition-all" value="${t?.description||""}" placeholder="Ex: Conta de Luz, Venda Balcão...">
                </div>

                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Valor (R$)</label>
                        <input type="number" step="0.01" name="amount" required class="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-${s}-500 outline-none font-bold text-gray-700" value="${t?.amount||""}">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Vencimento</label>
                        <input type="date" name="dueDate" required class="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-${s}-500 outline-none" value="${t?.dueDate||new Date().toISOString().split("T")[0]}">
                    </div>
                </div>
                ...
                <div class="p-3 bg-gray-50 rounded-xl border border-gray-100">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" id="toggle-installments" class="w-4 h-4 text-${s}-600 rounded focus:ring-${s}-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="naturezaId" class="w-full p-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-${s}-500 outline-none text-sm">
                            ${n(A.natures,t?.naturezaId)}
                        </select>
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Centro de Custo</label>
                        <select name="centroDeCustoId" class="w-full p-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-${s}-500 outline-none text-sm">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="2" class="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-${s}-500 outline-none text-sm">${t?.notes||""}</textarea>
                </div>

                <div class="border-t border-gray-100 pt-4 mt-2">
                    <label class="flex items-center justify-between cursor-pointer group">
                        <span class="text-sm font-bold text-gray-700 group-hover:text-${s}-700 transition-colors">Já foi Pago/Recebido?</span>
                        <div class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="status" id="status-toggle" class="sr-only peer" ${t?.status==="paid"?"checked":""}>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-${s}-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-${s}-600"></div>
                        </div>
                    </label>
                    
                    <div id="payment-date-wrapper" class="${t?.status==="paid"?"":"hidden"} mt-3 bg-${s}-50 p-3 rounded-lg animate-fade-in">
                        <label class="block text-xs font-bold text-${s}-700 mb-1">Data do Pagamento</label>
                        <input type="date" name="paymentDate" class="w-full p-2 border border-${s}-200 rounded-lg text-sm" value="${t?.paymentDate||new Date().toISOString().split("T")[0]}">
                    </div>
                </div>
                ...
                <div class="pt-4 flex gap-3">
                    ...
                    <button type="submit" class="flex-1 py-3 bg-${s}-600 text-white font-semibold rounded-xl hover:bg-${s}-700 shadow-lg active:scale-95 transition-transform">Salvar</button>
                </div>
            </form>
        </div>`,a.style.display="flex";const i=a.querySelector("#financial-form"),l=i.querySelector("#status-toggle"),d=i.querySelector("#payment-date-wrapper"),c=i.querySelector('[name="paymentDate"]');if(!t){const u=i.querySelector("#toggle-installments"),g=i.querySelector("#installments-container");u.addEventListener("change",()=>{g.classList.toggle("hidden",!u.checked)})}l.addEventListener("change",()=>{l.checked?(d.classList.remove("hidden"),c.required=!0):(d.classList.add("hidden"),c.required=!1)}),i.addEventListener("submit",async u=>{u.preventDefault();const g=new FormData(i),b=l.checked,h={description:g.get("description"),amount:parseFloat(g.get("amount")),dueDate:g.get("dueDate"),naturezaId:g.get("naturezaId")||null,centroDeCustoId:g.get("centroDeCustoId")||null,notes:g.get("notes"),status:b?"paid":"pending",paymentDate:b?g.get("paymentDate"):null,establishmentId:m.establishmentId},v=g.get("installments");!t&&v&&parseInt(v)>1?h.installments=parseInt(v):h.installments=1;try{t?(await(o?On(t.id,h):Wn(t.id,h)),p("Sucesso","Atualizado com sucesso!","success")):(await(o?Fn(h):Un(h)),p("Sucesso","Criado com sucesso!","success")),document.getElementById("genericModal").style.display="none",ze()}catch(y){p("Erro",y.message,"error")}})}const Wl=e=>E("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),Jl=e=>E("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),Gl=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return E(`/api/commissions/stats?${a}`)},Yl=(e={})=>{Object.keys(e).forEach(o=>(e[o]===void 0||e[o]===null||e[o]==="")&&delete e[o]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return E(a)},Ql=e=>E(`/api/commissions/report/${e}`,{method:"DELETE"}),Mt=new Date,ko=new Date(Mt.getFullYear(),Mt.getMonth(),1),q={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:ko.toISOString().split("T")[0],dashEndDate:Mt.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:ko.toISOString().split("T")[0],histEndDate:Mt.toISOString().split("T")[0],histProfessionalId:"all"};let vt=null;const Ge=document.getElementById("content");async function Xl(){try{q.professionals=await K(m.establishmentId)}catch(e){console.error("Erro profissionais",e)}ld(),Zl(),Yt(),qt("dashboard")}function Zl(){vt&&Ge.removeEventListener("click",vt),vt=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,o=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":qt(t.dataset.tab);break;case"toggle-all-profs":Kl();break;case"back-to-filters":q.calculationResult=null,At(document.getElementById("commissions-content"));break;case"view-preview-items":id(r);break;case"save-final-report":td();break;case"start-new-calc":qt("calculator");break;case"print-receipt":ad(o);break;case"delete-report":od(o);break;case"filter-dashboard":Yt();break;case"filter-history":Ra();break}},Ge.addEventListener("click",vt),Ge.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;rd(t)}},Ge.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),ed())}}async function Yt(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(q.dashStartDate=e.value),t&&(q.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const o=await Gl(q.dashStartDate,q.dashEndDate);q.dashStats={revenue:o.totalRevenue||0,commissions:o.totalCommissionsPaid||0},q.currentTab==="dashboard"&&Ps(document.getElementById("commissions-content"))}catch(o){console.error(o),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Ra(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(q.histStartDate=e.value),t&&(q.histEndDate=t.value),a&&(q.histProfessionalId=a.value);const o=document.getElementById("history-list-container");if(o){o.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await Yl({startDate:q.histStartDate,endDate:q.histEndDate,professionalId:q.histProfessionalId});q.historyData=r,Bs(o,r)}catch{o.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Kl(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function ed(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return p("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),o=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");q.periodString=`${a} a ${o}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await Wl(t);q.calculationResult=s.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),At(r)}catch(s){p("Erro",s.message,"error"),q.calculationResult=null,At(r)}}async function td(){const e=q.calculationResult.length;if(await O("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=q.calculationResult.map(o=>{const r=o.items.map(s=>s.originalSaleId).filter(s=>s!=null);return Jl({professionalId:o.professionalId,professionalName:o.professionalName,period:q.periodString,processedSalesIds:r,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}})});await Promise.all(a),p("Sucesso","Pagamentos registrados!","success"),q.calculationResult=null,Yt(),qt("history")}catch(a){p("Erro",a.message,"error")}}function ad(e){const t=q.historyData.find(a=>a.id===e);t&&sd(t)}async function od(e){if(await O("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Ql(e),p("Sucesso","Registro removido.","success"),Ra(),Yt()}catch(a){p("Erro",a.message,"error")}}function sd(e){const{jsPDF:t}=window.jspdf;if(!t)return p("Erro","PDF lib não carregada.","error");const a=new t,o=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",o,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const s=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function rd(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let o=0,r=0;if(t.forEach(s=>{s.value&&(o=parseFloat(s.value))}),a.forEach(s=>{s.value&&(r=parseFloat(s.value))}),q.calculationResult&&q.calculationResult[e]){const s=q.calculationResult[e];s.extraDebit=o,s.extraCredit=r,s.finalValue=s.summary.totalCommission-o+r,t.forEach(i=>{i!==document.activeElement&&(i.value=o||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${s.finalValue.toFixed(2)}`),nd()}}function nd(){const e=q.calculationResult.reduce((a,o)=>a+o.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function id(e){const t=q.calculationResult[e];if(!t)return;const a=t.items.map(o=>`
    ...
    `).join("");Y({title:"Detalhes da Comissão",contentHTML:`<div class="bg-gray-50 p-3 rounded-lg mb-4 flex justify-between items-center"><div><p class="text-xs text-gray-500">Profissional</p><p class="font-bold text-gray-800">${t.professionalName}</p></div><div class="text-right"><p class="text-xs text-gray-500">Total Itens</p><p class="font-bold text-gray-800">${t.items.length}</p></div></div><div class="border rounded-lg overflow-hidden max-h-[60vh] overflow-y-auto">${a}</div>`,maxWidth:"max-w-md"})}function At(e){if(q.calculationResult){const t=q.calculationResult,a=t.reduce((s,n)=>s+n.finalValue,0),o=t.map((s,n)=>`
            ...
            </div>`}else{const t=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],o=q.professionals.map(r=>`
    ...
    `}function dd(e){const t=q.professionals.map(a=>`<option value="${a.id}" ${q.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,q.historyData.length>0?Bs(document.getElementById("history-list-container"),q.historyData):Ra()}function Bs(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const aa=document.getElementById("content");let ke={allPackages:[],catalogForModal:{services:[],products:[]}},ht=null,De=null;function cd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function ud(){const e=document.getElementById("packagesListContainer");if(e){if(ke.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=ke.allPackages.map(t=>{const a=t.status==="active",o=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,s=t.originalPrice||0,n=s>r?s-r:0,i=s>0?(s-r)/s*100:0,l=f(t.name),d=f(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function So(){const e=document.getElementById("genericModal");e.style.display="none",De&&e.removeEventListener("click",De)}async function $o(e=null){const t=document.getElementById("genericModal"),a=!!e,o=e?JSON.parse(JSON.stringify(e.items||[])):[],r=f(e?.name||""),s=f(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(b,h)=>{const v=h.querySelector("#originalPrice"),y=b.reduce((w,$)=>w+$.price*$.quantity,0);v&&(v.textContent=`R$ ${y.toFixed(2)}`)},g=b=>{b.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=b.map((h,v)=>{const y=h.type==="service",w=y?"Serviço":"Produto",$=y?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(b,t)};g(o),c.addEventListener("change",b=>{if(b.target.classList.contains("quantity-input")){const h=parseInt(b.target.dataset.index,10),v=parseInt(b.target.value,10);v>0&&o[h]&&(o[h].quantity=v,g(o))}}),c.addEventListener("click",b=>{if(b.target.classList.contains("remove-item-btn")){const h=parseInt(b.target.dataset.index,10);o.splice(h,1),g(o)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>md(b=>{const h=o.find(v=>v.id===b.id&&v.type===b.type);h?h.quantity++:o.push({...b,quantity:1}),g(o)}),De&&t.removeEventListener("click",De),De=async b=>{const h=b.target.closest("button[data-action]");if(!h)return;const v=h.dataset.action;if(b.stopPropagation(),v==="close-modal"&&So(),v==="save-package"){const y=h,w={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:o,originalPrice:o.reduce(($,k)=>$+k.price*k.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!w.name||!w.price){p("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(w.items.length===0){p("Erro","Adicione pelo menos um item ao pacote.","error");return}y.disabled=!0,y.textContent="A salvar...";try{a?await vn(w.id,w):(delete w.id,await fn(w)),p("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),So(),await ja()}catch($){p("Erro",`Não foi possível salvar o pacote: ${$.message}`,"error"),y.disabled=!1,y.textContent="Salvar Pacote"}}},t.addEventListener("click",De)}function md(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const o={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=ke.catalogForModal.services.filter(h=>h.name.toLowerCase().includes(d)),u=ke.catalogForModal.products.filter(h=>h.name.toLowerCase().includes(d)),g=c.map(h=>`
    ...
    `,document.body.appendChild(a);const s=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(s),n.addEventListener("input",()=>{t=n.value,r(s)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:g}=d.dataset,h=(ke.catalogForModal[u+"s"]||[]).find(v=>v.id===g);h&&(e({...h,type:u}),i())}else(c||l.target===a)&&i()})}async function ja(){aa.innerHTML=`
    ...
    `,ht&&aa.removeEventListener("click",ht),ht=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const o=e.target.closest('[data-action="delete-package"]');if(o){const r=o.dataset.id;O("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await hn(r),p("Sucesso!","Pacote excluído.","success"),await ja()}catch(n){p("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")$o(null);else if(a==="edit-package"){const o=JSON.parse(t.dataset.package);$o(o)}},aa.addEventListener("click",ht);try{const[e,t,a]=await Promise.all([Ca(m.establishmentId),ge(m.establishmentId),lt(m.establishmentId)]);ke.allPackages=e,ke.catalogForModal={services:t.filter(o=>o.active),products:a},ud()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const pd=document.getElementById("content");let gd=null;async function bd(){const e=f(m.userName||"Usuário"),t=f(U.currentUser?.email||"E-mail não disponível"),a=m.userName?m.userName.charAt(0):"U";pd.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await fd()}async function fd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await lr(t);gd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const o=f(a.name);e.innerHTML=`
            ...
            `,vd(a.id),document.getElementById("my-blocks-filter").addEventListener("change",s=>Nt(a.id,s.target.value)),Nt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function vd(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#blockDate").value,r=t.querySelector("#blockStartTime").value,s=t.querySelector("#blockEndTime").value,n=t.querySelector("#blockReason").value;if(!o||!r||!s){p("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(r>=s){p("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${o}T${r}:00`),l=new Date(`${o}T${s}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Ot({establishmentId:m.establishmentId,professionalId:e,reason:n||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),p("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;Nt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),p("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function Nt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const o=new Date;let r,s;t==="history"?(s=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,s=new Date,s.setFullYear(s.getFullYear()+1));let i=(await Ht(m.establishmentId,r.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<o).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=o).sort((l,d)=>l.startTime-d.startTime),i.length>0?(a.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,g=f(l.reason||"Sem motivo");return`
                ...
                `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const c=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await ka(c),p("Sucesso","Bloqueio removido.","success"),Nt(e,t)}catch(u){console.error("Erro ao remover bloqueio:",u),p("Erro",`Não foi possível remover o bloqueio: ${u.message}`,"error")}})})):a.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(o){console.error("Erro ao carregar bloqueios:",o),a.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${f(o.message)}</p>`}}document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const xt=document.getElementById("loadingScreen"),oa=document.getElementById("dashboardContent"),sa=document.getElementById("content"),Eo=document.getElementById("notificationBell"),ra=document.getElementById("notificationBadge"),yt=document.getElementById("notificationPanel"),Io=document.getElementById("notificationList"),na=document.getElementById("profileMenuButton"),te=document.getElementById("profileDropdown"),hd=document.getElementById("profileName"),xd=document.getElementById("profileEmail"),yd=document.getElementById("logoutButton"),Co=document.getElementById("myProfileLink"),Lo=document.getElementById("hamburger-menu-btn"),ye=document.getElementById("sidebar"),Me=document.getElementById("mobile-overlay"),To={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let tt=null,at=[];const wd={"agenda-section":as,"comandas-section":An,"relatorios-section":Xn,"servicos-section":pi,"produtos-section":Li,"suppliers-section":Ri,"profissionais-section":Bt,"clientes-section":Ki,"estabelecimento-section":Ls,"ausencias-section":vl,"users-section":Dt,"sales-report-section":Ml,"financial-section":Rl,"commissions-section":Xl,"packages-section":ja,"my-profile-section":bd};function kd(e){const t=To[e]||To.indigo,o=(s=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function va(){const e=at.filter(t=>!t.read).length;if(e>0?(ra.textContent=e,ra.classList.remove("hidden")):ra.classList.add("hidden"),at.length===0){Io.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Io.innerHTML=at.map(t=>`
    ...
    `).join("")}function Sd(e){tt&&tt();const t=pe(_,"establishments",e,"notifications"),a=Rt(t,ot("timestamp",">=",new Date),Mo("timestamp","desc"));tt=Vs(a,o=>{o.docChanges().forEach(r=>{if(r.type==="added"){const s=r.doc.data();at.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),p(s.title,s.message,"info",!0),va();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(s.type==="cancellation"||s.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),as())}})},o=>{console.error("Erro no listener de notificações em tempo real:",o)})}function Z(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=m.enabledModules?.[a]!==!1,s=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!r||!s){sa.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),ye.classList.contains("absolute")&&(ye.classList.add("hidden"),Me.classList.add("hidden"));return}}const o=wd[e];o?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),sa.innerHTML="",window.innerWidth<768&&(ye.classList.add("hidden"),Me.classList.add("hidden")),o(t)):sa.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`}async function $d(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),o=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(s&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),n&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!s&&!n))try{const i=await jr();s&&o&&(o.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i)}}async function Ed(e){try{console.log("[Nativo] Iniciando configuração de Push..."),oe.getPlatform()==="android"&&(await G.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let t=await G.checkPermissions();if(t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive!=="granted")return;await G.register(),G.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const o=me(_,"users",e);await ha(o,{fcmTokens:zs(a.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(o){console.error("Erro ao salvar token FCM:",o)}}),G.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),G.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),p(a.title,a.body,"info",!0)}),G.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),Z("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function Id(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),o=()=>e.style.display="block",r=()=>e.style.display="none",s=()=>e.style.display==="block";e&&(t.addEventListener("click",()=>{r(),oe.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{r(),oe.isNativePlatform()?Xa.exitApp():history.back()}),oe.isNativePlatform()?Xa.addListener("backButton",({canGoBack:n})=>{if(s())r();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),l=Array.from(i).filter(u=>u.id!=="exitConfirmationModal");if(l.length>0){l.forEach(u=>u.style.display="none");return}const d=document.getElementById("sidebar");if(d&&!d.classList.contains("hidden")&&window.innerWidth<768){d.classList.add("hidden"),document.getElementById("mobile-overlay").classList.add("hidden");return}const c=document.querySelector(".sidebar-link.active");c&&c.getAttribute("data-target")==="agenda-section"?o():Z("agenda-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",n=>{if(s()){r(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),l=Array.from(i).filter(c=>c.id!=="exitConfirmationModal");if(l.length>0){l.forEach(c=>c.style.display="none"),history.pushState(null,document.title,location.href);return}const d=document.querySelector(".sidebar-link.active");d&&d.getAttribute("data-target")==="agenda-section"?o():(Z("agenda-section"),history.pushState(null,document.title,location.href))})))}async function Cd(){try{await js(U,Fs),console.log("Persistência LOCAL configurada na inicialização.")}catch(e){console.error("Erro ao definir persistência no main.js",e)}oe.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),tr(),Id(),Lo&&Lo.addEventListener("click",e=>{e.stopPropagation(),ye.classList.remove("hidden"),ye.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl"),Me.classList.remove("hidden")}),Me&&Me.addEventListener("click",()=>{ye.classList.add("hidden"),ye.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl"),Me.classList.add("hidden")}),Eo.addEventListener("click",e=>{e.stopPropagation(),yt.classList.toggle("hidden"),yt.classList.contains("hidden")||(at.forEach(t=>t.read=!0),va())}),na.addEventListener("click",e=>{e.stopPropagation(),te.classList.toggle("active"),te.classList.contains("active")?te.classList.remove("hidden"):setTimeout(()=>te.classList.add("hidden"),200)}),Co&&Co.addEventListener("click",e=>{e.preventDefault(),Z("my-profile-section"),te.classList.remove("active"),te.classList.add("hidden")}),document.addEventListener("click",e=>{!yt.contains(e.target)&&e.target!==Eo&&yt.classList.add("hidden"),!te.contains(e.target)&&e.target!==na&&te.classList.contains("active")&&(te.classList.remove("active"),setTimeout(()=>te.classList.add("hidden"),200))}),Po(U,async e=>{if(e){if(console.log("Usuário detectado:",e.email),!oe.isNativePlatform()&&(console.log("Inicializando Web Push (PWA)..."),zo(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast"),o=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");setTimeout(()=>{t&&(t.style.display="block")},3500),a&&a.addEventListener("click",async()=>{await Vo()&&t&&(t.style.display="none")});const s=()=>{t&&(t.style.display="none")};o&&o.addEventListener("click",s),r&&r.addEventListener("click",s)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const o=await $e(a.establishmentId);m.enabledModules=o.modules,kd(o.themeColor||"indigo");let r=null,s=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=me(_,"users",e.uid),c=await Bo(d);if(c.exists()){const u=c.data();r=a.role==="employee"?u.permissions||{}:null,s=u.name||s,n=u.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}m.userProfessionalId=n,oe.isNativePlatform()&&Ed(e.uid);const i=s||e.email;Ws(a.establishmentId,o.name,r),na.textContent=i.charAt(0).toUpperCase(),hd.textContent=i,xd.textContent=e.email;const l=()=>{tt&&tt(),Ha(U).then(()=>window.location.href="/login.html")};yd.addEventListener("click",d=>{d.preventDefault(),l()}),rr(Z,r,m.enabledModules),$d(r),Sd(a.establishmentId),va(),xt.classList.add("fade-out"),oa.style.display="flex",setTimeout(()=>{xt.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{xr()},1500),Z("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),xt.classList.add("fade-out"),setTimeout(()=>{xt.style.display="none"},500),oa.innerHTML=`
                ...
                `,oa.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{Ha(U).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}Cd();Po(U,async e=>{if(e){await zo();const a="Notification"in window&&Notification.permission==="default",o=window.Capacitor&&window.Capacitor.isNativePlatform();if(a&&!o){const r=document.getElementById("toast-notification-request"),s=document.getElementById("btn-enable-toast"),n=document.getElementById("btn-deny-toast"),i=document.getElementById("btn-close-toast");setTimeout(()=>{r&&(r.style.display="block")},3500),s&&s.addEventListener("click",async()=>{await Vo()&&r&&(r.style.display="none")});const l=()=>{r&&(r.style.display="none")};n&&n.addEventListener("click",l),i&&i.addEventListener("click",l)}}});export{Oo as W};
