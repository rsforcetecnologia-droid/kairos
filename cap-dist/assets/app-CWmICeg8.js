const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-CiuYYUou.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/utils-JfzC6GFr.js","assets/styles-CQhY7Cv2.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as he,d as me,m as Is}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Cr,reauthenticateWithCredential as Dr,verifyBeforeUpdateEmail as Pr,updatePassword as Tr,updateProfile as Br,setPersistence as Mr,browserLocalPersistence as Ar,onAuthStateChanged as qr,signOut as jr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as Ae,getDoc as is,updateDoc as Tt,setDoc as Nr,addDoc as po,collection as ga,query as bo,where as mo,getDocs as Rr,deleteDoc as Fr,arrayUnion as Hr,orderBy as Or,onSnapshot as zr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{a as C,e as h,s as Y,b as f,c as Be,r as fa,f as Ca,i as Vr}from"./utils-JfzC6GFr.js";import{getToken as _r,onMessage as Ur}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Wr(t,e,a){m.establishmentId=t,m.establishmentName=e,m.userPermissions=a,m.currentViewContext={type:"BRANCH",id:t,name:e}}const xa=(t,e,a,s=null)=>{let r=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),C(r)},Jr=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return C(s)},Qr=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return C(r)},Gr=t=>C("/api/appointments",{method:"POST",body:JSON.stringify(t)}),Yr=(t,e)=>C(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),Xr=t=>C(`/api/appointments/${t}`,{method:"DELETE"}),Zr=t=>C(`/api/appointments/${t}/reopen`,{method:"POST"}),Kr=(t,e)=>C(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)}),re=document.getElementById("sidebar"),ze=document.getElementById("sidebarToggle"),wt=document.getElementById("mainContent"),ei=document.querySelectorAll(".sidebar-link"),Ra=document.getElementById("menu-search"),Ls=document.getElementById("hamburger-menu-btn"),at=document.getElementById("mobile-overlay");let Me=!0;function Fe(t){if(!re||!wt)return;re.classList.toggle("collapsed",t),wt.classList.toggle("sidebar-collapsed-shift",t);const e=re.querySelector(".sidebar-search-container"),a=re.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const r=s.getAttribute("data-target-submenu"),o=document.getElementById(r),i=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function ti(){!re||!at||(re.classList.add("mobile-open"),at.classList.add("visible"))}function qt(){!re||!at||(re.classList.remove("mobile-open"),at.classList.remove("visible"))}function ai(){Fe(!re.classList.contains("collapsed"))}function si(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&re.classList.contains("collapsed")&&Fe(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function oi(){Ra&&Ra.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),r=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),r.forEach(o=>o.style.display="block");return}r.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const i=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function ri(t,e,a){if(!re||!wt)return;wt.classList.add("main-content-shift"),window.innerWidth>=1024?(Me=!0,Fe(!1)):window.innerWidth>=768?(Me=!1,Fe(!0)):(wt.classList.remove("main-content-shift","sidebar-collapsed-shift"),qt()),ze&&ze.addEventListener("click",r=>{r.stopPropagation(),window.innerWidth>=768?(Me=!Me,Fe(!Me),Me?(ze.classList.add("text-indigo-400"),ze.classList.remove("text-gray-400")):(ze.classList.remove("text-indigo-400"),ze.classList.add("text-gray-400"))):ai()}),re.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Me&&re.classList.contains("collapsed")&&Fe(!1)}),re.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Me){const r=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===Ra;!r&&!o&&Fe(!0)}}),Ls&&Ls.addEventListener("click",r=>{r.stopPropagation(),ti()}),at&&at.addEventListener("click",r=>{r.stopPropagation(),qt()});let s=0;re.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),re.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&qt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(r=>{r.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const i=r.getAttribute("data-target-submenu"),n=r.querySelector(".submenu-arrow");si(i,n)})}),oi(),ei.forEach(r=>{const o=r.getAttribute("data-target");if(!o)return;const i=o.replace("-section",""),n=a?.[i]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){r.parentElement&&r.parentElement.tagName==="LI"?r.parentElement.style.display="none":r.style.display="none";return}r.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),r.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&qt()})})}const ii=t=>C("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),ve=()=>C("/api/establishments/hierarchy",{method:"GET"}),qe=t=>{const e=t||m.establishmentId;return e?C(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ns=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ni=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},li=(t,e)=>{const a=t||m.establishmentId;return a?C(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},$e=t=>C(`/api/professionals/${t}`),go=t=>C(`/api/professionals/details/${t}`),di=t=>C("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Fa=(t,e)=>C(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),fo=t=>C(`/api/professionals/${t}`,{method:"DELETE"}),ci=t=>{const e=t.map(a=>fo(a));return Promise.all(e)};class ui{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const r=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${r.top+window.scrollY-o}px`,this.spotlight.style.left=`${r.left+window.scrollX-o}px`,this.spotlight.style.width=`${r.width+o*2}px`,this.spotlight.style.height=`${r.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(r)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
            <div class="p-5">
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(e){const a=this.popover.getBoundingClientRect(),s=20;let r=e.bottom+window.scrollY+s,o=e.left+window.scrollX;r+a.height>window.scrollY+window.innerHeight&&(r=e.top+window.scrollY-a.height-s),o+a.width>window.innerWidth&&(o=e.right+window.scrollX-a.width),o<s&&(o=s),this.popover.style.top=`${r}px`,this.popover.style.left=`${o}px`}handleResize(){this.isActive&&this.renderStep()}sleep(e){return new Promise(a=>setTimeout(a,e))}async waitForElement(e,a){if(!e)return null;const s=Date.now();for(;Date.now()-s<a;){const r=document.querySelector(e);if(r)return r;await this.sleep(100)}return null}}async function pi(){try{console.log("A verificar Onboarding interativo...");const t=await qe(m.establishmentId);if(!t||t.parentId||t.onboardingCompleted)return;const e=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await ns(m.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(r){console.error("Erro ao gravar fim do onboarding",r)}};new ui(e,a,a).start()}catch(t){console.error("Erro fatal ao iniciar onboarding:",t)}}var st;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(st||(st={}));class Da extends Error{constructor(e,a,s){super(e),this.message=e,this.code=a,this.data=s}}const bi=t=>{var e,a;return t?.androidBridge?"android":!((a=(e=t?.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},mi=t=>{const e=t.CapacitorCustomPlatform||null,a=t.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>e!==null?e.name:bi(t),o=()=>r()!=="web",i=c=>{const p=d.get(c);return!!(p?.platforms.has(r())||n(c))},n=c=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===c)},l=c=>t.console.error(c),d=new Map,u=(c,p={})=>{const b=d.get(c);if(b)return console.warn(`Capacitor plugin "${c}" already registered. Cannot register plugins twice.`),b.proxy;const g=r(),v=n(c);let y;const k=async()=>(!y&&g in p?y=typeof p[g]=="function"?y=await p[g]():y=p[g]:e!==null&&!y&&"web"in p&&(y=typeof p.web=="function"?y=await p.web():y=p.web),y),P=(E,I)=>{var D,R;if(v){const O=v?.methods.find(U=>I===U.name);if(O)return O.rtype==="promise"?U=>a.nativePromise(c,I.toString(),U):(U,Z)=>a.nativeCallback(c,I.toString(),U,Z);if(E)return(D=E[I])===null||D===void 0?void 0:D.bind(E)}else{if(E)return(R=E[I])===null||R===void 0?void 0:R.bind(E);throw new Da(`"${c}" plugin is not implemented on ${g}`,st.Unimplemented)}},T=E=>{let I;const D=(...R)=>{const O=k().then(U=>{const Z=P(U,E);if(Z){const K=Z(...R);return I=K?.remove,K}else throw new Da(`"${c}.${E}()" is not implemented on ${g}`,st.Unimplemented)});return E==="addListener"&&(O.remove=async()=>I()),O};return D.toString=()=>`${E.toString()}() { [capacitor code] }`,Object.defineProperty(D,"name",{value:E,writable:!1,configurable:!1}),D},$=T("addListener"),L=T("removeListener"),q=(E,I)=>{const D=$({eventName:E},I),R=async()=>{const U=await D;L({eventName:E,callbackId:U},I)},O=new Promise(U=>D.then(()=>U({remove:R})));return O.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await R()},O},N=new Proxy({},{get(E,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?q:$;case"removeListener":return L;default:return T(I)}}});return s[c]=N,d.set(c,{name:c,proxy:N,platforms:new Set([...Object.keys(p),...v?[g]:[]])}),N};return a.convertFileSrc||(a.convertFileSrc=c=>c),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=i,a.registerPlugin=u,a.Exception=Da,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},gi=t=>t.Capacitor=mi(t),Se=gi(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),ha=Se.registerPlugin;class xo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,a){let s=!1;this.listeners[e]||(this.listeners[e]=[],s=!0),this.listeners[e].push(a);const o=this.windowListeners[e];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(e);const i=async()=>this.removeListener(e,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,a,s){const r=this.listeners[e];if(!r){if(s){let o=this.retainedEventArguments[e];o||(o=[]),o.push(a),this.retainedEventArguments[e]=o}return}r.forEach(o=>o(a))}hasListeners(e){var a;return!!(!((a=this.listeners[e])===null||a===void 0)&&a.length)}registerWindowListener(e,a){this.windowListeners[a]={registered:!1,windowEventName:e,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(e="not implemented"){return new Se.Exception(e,st.Unimplemented)}unavailable(e="not available"){return new Se.Exception(e,st.Unavailable)}async removeListener(e,a){const s=this.listeners[e];if(!s)return;const r=s.indexOf(a);this.listeners[e].splice(r,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const a=this.retainedEventArguments[e];a&&(delete this.retainedEventArguments[e],a.forEach(s=>{this.notifyListeners(e,s)}))}}const Cs=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ds=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class fi extends xo{async getCookies(){const e=document.cookie,a={};return e.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Ds(r).trim(),o=Ds(o).trim(),a[r]=o}),a}async setCookie(e){try{const a=Cs(e.key),s=Cs(e.value),r=`; expires=${(e.expires||"").replace("expires=","")}`,o=(e.path||"/").replace("path=",""),i=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const a of e)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}ha("CapacitorCookies",{web:()=>new fi});const xi=async t=>new Promise((e,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;e(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(t)}),hi=(t={})=>{const e=Object.keys(t);return Object.keys(t).map(r=>r.toLocaleLowerCase()).reduce((r,o,i)=>(r[o]=t[e[i]],r),{})},vi=(t,e=!0)=>t?Object.entries(t).reduce((s,r)=>{const[o,i]=r;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=e?encodeURIComponent(d):d,l+=`${o}=${n}&`}),l.slice(0,-1)):(n=e?encodeURIComponent(i):i,l=`${o}=${n}`),`${s}&${l}`},"").substr(1):null,yi=(t,e={})=>{const a=Object.assign({method:t.method||"GET",headers:t.headers},e),r=hi(t.headers)["content-type"]||"";if(typeof t.data=="string")a.body=t.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[i,n]of Object.entries(t.data||{}))o.set(i,n);a.body=o.toString()}else if(r.includes("multipart/form-data")||t.data instanceof FormData){const o=new FormData;if(t.data instanceof FormData)t.data.forEach((n,l)=>{o.append(l,n)});else for(const n of Object.keys(t.data))o.append(n,t.data[n]);a.body=o;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(r.includes("application/json")||typeof t.data=="object")&&(a.body=JSON.stringify(t.data));return a};class wi extends xo{async request(e){const a=yi(e,e.webFetchExtra),s=vi(e.params,e.shouldEncodeUrlParams),r=s?`${e.url}?${s}`:e.url,o=await fetch(r,a),i=o.headers.get("content-type")||"";let{responseType:n="text"}=o.ok?e:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await o.blob(),l=await xi(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const u={};return o.headers.forEach((c,p)=>{u[p]=c}),{data:l,headers:u,status:o.status,url:o.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}ha("CapacitorHttp",{web:()=>new wi});const de=ha("PushNotifications",{}),ki="modulepreload",Si=function(t){return"/"+t},Ps={},$i=function(e,a,s){let r=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");r=l(a.map(d=>{if(d=Si(d),d in Ps)return;Ps[d]=!0;const u=d.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":ki,u||(p.as="script"),p.crossOrigin="",p.href=d,n&&p.setAttribute("nonce",n),document.head.appendChild(p),u)return new Promise((b,g)=>{p.addEventListener("load",b),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return r.then(i=>{for(const n of i||[])n.status==="rejected"&&o(n.reason);return e().catch(o)})},Ts=ha("App",{web:()=>$i(()=>import("./web-CiuYYUou.js"),__vite__mapDeps([0,1,2,3,4])).then(t=>new t.AppWeb)}),Ei="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Bs=!1;async function Ii(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await de.removeAllListeners(),await de.addListener("registration",async a=>{vo(a.value,!0)}),await de.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await de.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let e=await de.checkPermissions();e.receive==="prompt"&&(e=await de.requestPermissions()),e.receive==="granted"&&await de.register()}catch(e){console.error("[Push Nativo] Erro:",e)}return}"Notification"in window&&Notification.permission==="granted"&&ho()}async function Li(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await ho(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(t){return console.error("Erro ao pedir permissão Web:",t),!1}}async function ho(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await t.update();const e=await _r(Is,{vapidKey:Ei,serviceWorkerRegistration:t});e?(console.log("[Push Web] Token validado."),await vo(e,!1)):console.warn("[Push Web] Token veio vazio."),Bs||(Ur(Is,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Bs=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}else console.warn("Navegador sem suporte a Service Worker.")}async function vo(t,e){const a=he.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=Ae(me,"users",a.uid);try{const r=await is(s);if(r.exists()){const i=r.data().fcmTokens||[];if(i.length===1&&i[0]===t){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Tt(s,{fcmTokens:[t],lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Nr(s,{email:a.email,fcmTokens:[t],platform:e?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",r)}}const Ci=(t,e,a="all",s="all")=>{const r=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),C(`/api/reports/indicators?${r.toString()}`)},Di=(t,e="all")=>{const a=new URLSearchParams({date:t});return e&&e!=="all"&&a.append("professionalId",e),C(`/api/reports/appointments/list?${a.toString()}`)},Pi=t=>t?C(`/api/financial/cost-centers/${t}`):Promise.resolve([]),Ti=(t,e,a)=>{const s=new URLSearchParams({startDate:e,endDate:a});return C(`/api/analytics/${t}?${s.toString()}`)},oa=({establishmentId:t,startDate:e,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:e,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),t&&r.append("establishmentId",t),C(`/api/reports/sales?${r.toString()}`)},Bi=(t,e,a)=>C(`/api/analytics/${t}/monthly-details?year=${e}&month=${a}`),Mi=(t,e,a,s)=>{const r=`/api/analytics/${t}/daily-details?year=${e}&month=${a}&day=${s}`;return C(r)},Ai=(t,e,a,s)=>{const r=`/api/analytics/${t}/professional-details?year=${e}&month=${a}&professionalId=${s}`;return C(r)},qi=(t,e,a,s)=>C(`/api/reports/commissions/${t}?year=${e}&month=${a}&professionalId=${s}`),yo=()=>C("/api/reports/summary",{method:"GET"}),ji=Object.freeze(Object.defineProperty({__proto__:null,getAdvancedIndicators:Ci,getAnalytics:Ti,getCommissionReport:qi,getCostCenters:Pi,getDailyAppointments:Di,getDailyTransactions:Mi,getMonthlyAnalytics:Bi,getProfessionalMonthlyDetails:Ai,getSalesReport:oa,getSummaryKPIs:yo},Symbol.toStringTag,{value:"Module"})),ls=t=>t?String(t).replace(/\D/g,""):"",ct=(t,e="",a=20,s={})=>{const r=new URLSearchParams;return e&&r.append("search",e),a&&r.append("limit",a),s&&s.hasLoyalty&&r.append("hasLoyalty","true"),s&&s.birthMonth&&r.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),C(`/api/clients/${t}?${r.toString()}`)},wo=(t,e)=>{const a=encodeURIComponent(e);return C(`/api/clients/details/${t}/${a}`)},ko=t=>{const e=t.phone||t.id;if(!e)throw new Error("Telefone é obrigatório");const a=ls(e),s={...t,phone:a,id:a};return C(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},So=ko,$o=(t,e)=>ko({...e,id:t}),Eo=t=>{const e=encodeURIComponent(t);return C(`/api/clients/${e}`,{method:"DELETE"})},Ni=(t,e,a,s)=>C("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientPhone:ls(e),points:a,rewardName:s})}),Ri=(t,e)=>wo(t,ls(e)),va=t=>C(`/api/financial/natures/${t}`),Fi=t=>C("/api/financial/natures",{method:"POST",body:JSON.stringify(t)}),ds=t=>C(`/api/financial/cost-centers/${t}`),Hi=t=>C("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(t)}),Io=(t,e)=>C(`/api/financial/${t}`,{method:"POST",body:JSON.stringify(e)}),Lo=(t,e={})=>{let a=`/api/financial/${t}`;const s=new URLSearchParams;e.establishmentId&&s.append("establishmentId",e.establishmentId),e.startDate&&s.append("startDate",e.startDate),e.endDate&&s.append("endDate",e.endDate),e.natureId&&s.append("natureId",e.natureId),e.costCenterId&&s.append("costCenterId",e.costCenterId),e.status&&s.append("status",e.status);const r=s.toString();return r&&(a+=`?${r}`),C(a)},Co=(t,e,a)=>C(`/api/financial/${t}/${e}`,{method:"PUT",body:JSON.stringify(a)}),Do=(t,e)=>C(`/api/financial/${t}/${e}`,{method:"DELETE"}),Po=(t,e)=>{const a=e.map(s=>C(`/api/financial/${t}/${s}`,{method:"DELETE"}));return Promise.all(a)},To=(t,e,a)=>C(`/api/financial/${t}/${e}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Bo=t=>Io("payables",t),cs=t=>Lo("payables",t),Oi=(t,e)=>Co("payables",t,e),zi=t=>Do("payables",t),Vi=(t,e)=>To("payables",t,e),_i=t=>Io("receivables",t),ya=t=>Lo("receivables",t),Ui=(t,e)=>Co("receivables",t,e),Wi=t=>Do("receivables",t),Ji=(t,e)=>To("receivables",t,e);let Pa=null;function we(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${s}`}async function Qi(){const t=document.getElementById("content");t.innerHTML=`
    ...
    `;try{const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),s=new Date(a);s.setHours(23,59,59,999);const r=new Date(a.getFullYear(),a.getMonth(),1),o=new Date(a.getFullYear(),a.getMonth()+1,0),i=new Date(a);i.setDate(a.getDate()-6);const n=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId],l=n.join(","),d=n.map(async F=>{const[ee,Ee]=await Promise.all([xa(F,r.toISOString(),s.toISOString(),null).catch(()=>[]),ct(F).catch(()=>[])]);return{appts:ee,clients:Ee}}),u=Promise.all([ya({startDate:we(r),endDate:we(o),establishmentId:l}).catch(()=>({entries:[]})),cs({startDate:we(r),endDate:we(o),establishmentId:l}).catch(()=>({entries:[]}))]),[c,[p,b]]=await Promise.all([Promise.all(d),u]);let g=[],v=[];c.forEach(F=>{g=g.concat(F.appts),v=v.concat(F.clients)});const y=p.entries||[],k=b.entries||[],P=we(a),T=y.filter(F=>F.status==="paid").reduce((F,ee)=>F+ee.amount,0),$=k.filter(F=>F.status==="paid").reduce((F,ee)=>F+ee.amount,0),L=T-$,q=y.filter(F=>F.status==="paid"&&(F.paymentDate===P||!F.paymentDate&&F.dueDate.startsWith(P))).reduce((F,ee)=>F+ee.amount,0),N=g.filter(F=>{const ee=new Date(F.startTime);return ee>=a&&ee<=s}),E=N.length,I=g.filter(F=>F.status==="completed"),D=I.length>0?T/I.length:0,R=N.filter(F=>new Date(F.startTime).getTime()>=e.getTime()&&F.status!=="completed"&&F.status!=="cancelled").sort((F,ee)=>new Date(F.startTime)-new Date(ee.startTime)).slice(0,4).map(F=>({client:F.clientName||"Desconhecido",service:F.serviceName||(F.services&&F.services[0]?F.services[0].name:"Serviço"),time:new Date(F.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(F.professionalName||"").split(" ")[0]||"Profissionais",id:F.id})),O=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,U=new Map;v.forEach(F=>{F.phone?U.set(F.phone,F):U.set(F.id||Math.random().toString(),F)});const K=Array.from(U.values()).filter(F=>{if(!F.birthDate)return!1;let ee,Ee;if(F.birthDate.includes("-")){const W=F.birthDate.split("-");W[0].length===4?(ee=W[1],Ee=W[2]):(Ee=W[0],ee=W[1])}else if(F.birthDate.includes("/")){const W=F.birthDate.split("/");Ee=W[0],ee=W[1]}return`${Ee}/${ee}`===O}).map(F=>{let ee="";return F.birthDate&&F.birthDate.includes("-")&&F.birthDate.split("-")[0].length===4&&(ee=a.getFullYear()-parseInt(F.birthDate.split("-")[0])),{name:F.name,age:ee,phone:F.phone}}),ye={receitaHoje:q,agendamentosHoje:E,receitaMes:T,despesaMes:$,saldoMes:L,ticketMedio:D},pe=n.length>1;Gi(t,ye,R,K,pe,we(i),we(a)),await Mo(i,a),Xi()}catch(e){console.error("Erro ao carregar dashboard:",e),t.innerHTML=`
        ...
        `}}function Gi(t,e,a,s,r,o,i){const n=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),l=r?`
    ...
    `}async function Mo(t,e){const a=document.getElementById("chart-container"),s=document.getElementById("chart-start-date"),r=document.getElementById("chart-end-date");if(a){const o=document.createElement("div");o.id="chart-loading-overlay",o.className="absolute inset-0 bg-white/70 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-xl",o.innerHTML='<div class="w-8 h-8 border-[3px] border-indigo-100 border-t-indigo-500 rounded-full animate-spin"></div>',a.appendChild(o)}try{const o=we(t),i=we(e),n=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId],l=n.join(","),d=await ya({startDate:o,endDate:i,establishmentId:l}).catch(()=>({entries:[]})),u=n.map(T=>xa(T,o+"T00:00:00.000Z",i+"T23:59:59.999Z",null).catch(()=>[])),p=(await Promise.all(u)).flat(),b=d.entries||[],g=[],v=[],y=[];let k=new Date(t);k.setHours(0,0,0,0);const P=new Date(e);for(P.setHours(23,59,59,999);k<=P;){const T=we(k);g.push(k.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}));const $=b.filter(q=>q.status==="paid"&&(q.paymentDate===T||!q.paymentDate&&q.dueDate.startsWith(T))).reduce((q,N)=>q+N.amount,0),L=p.filter(q=>q.status==="completed"&&q.startTime&&q.startTime.startsWith(T)).length;v.push($),y.push(L),k.setDate(k.getDate()+1)}Yi(g,v,y),s&&(s.value=o),r&&(r.value=i)}catch(o){console.error("Erro ao recarregar grafico:",o)}finally{const o=document.getElementById("chart-loading-overlay");o&&o.remove()}}function Yi(t,e,a){const s=document.getElementById("revenueChart");if(!s)return;Pa&&Pa.destroy();const o=s.getContext("2d").createLinearGradient(0,0,0,240);o.addColorStop(0,"rgba(99, 102, 241, 0.2)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)"),Pa=new Chart(s,{type:"line",data:{labels:t,datasets:[{label:"Receita Real (R$)",data:e,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.3,yAxisID:"y"},{label:"Agendamentos Feitos",data:a,borderColor:"#10b981",backgroundColor:"transparent",borderWidth:2,borderDash:[5,5],pointBackgroundColor:"#10b981",pointBorderColor:"#ffffff",pointBorderWidth:1,pointRadius:3,pointHoverRadius:5,fill:!1,tension:.3,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,boxHeight:6,font:{family:"Nunito, sans-serif",size:10,weight:"bold"},color:"#64748b"}},tooltip:{backgroundColor:"#1e293b",padding:10,cornerRadius:8,titleFont:{size:11,family:"Nunito, sans-serif",weight:"normal"},bodyFont:{size:12,weight:"bold",family:"Nunito, sans-serif"},displayColors:!0,usePointStyle:!0,callbacks:{label:function(i){return i.datasetIndex===0?"Receita: "+new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(i.parsed.y):"Concluídos: "+i.parsed.y}}}},scales:{y:{type:"linear",display:!0,position:"left",beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"},maxTicksLimit:6,callback:function(i){return"R$ "+i}}},y1:{type:"linear",display:!0,position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1},border:{display:!1},ticks:{color:"#10b981",font:{family:"Nunito, sans-serif",size:9,weight:"600"},stepSize:1,callback:function(i){if(Math.floor(i)===i)return i}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"}}}},interaction:{intersect:!1,mode:"index"}}})}function Xi(){document.getElementById("content").addEventListener("click",e=>{if(e.target.closest("#btn-update-chart")){const o=document.getElementById("chart-start-date"),i=document.getElementById("chart-end-date");if(o&&i&&o.value&&i.value){const n=new Date(o.value+"T00:00:00"),l=new Date(i.value+"T00:00:00");Mo(n,l)}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"goto-agenda":case"new-appointment":se("agenda-section");break;case"goto-pdv":se("comandas-section");break;case"goto-clients":se("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${m.establishmentId||""}`;window.open(o,"_blank");break}})}const ut=t=>C(`/api/services/${t}`),Zi=t=>C("/api/services",{method:"POST",body:JSON.stringify(t)}),Ki=(t,e)=>C(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Ao=t=>C(`/api/services/${t}`,{method:"DELETE"}),wa=(t,e,a,s="all")=>{const r=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return C(r)},ka=t=>C("/api/blockages",{method:"POST",body:JSON.stringify(t)}),us=t=>C(`/api/blockages/${t}`,{method:"DELETE"}),qo=t=>C("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Ms=document.getElementById("content");let As=!1;const ra=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Sa=[],Ha=[],ia={},jo=[],z={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},H={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function No(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function Xt(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${r}`}function ps(){const t=document.getElementById("profSelectorContainer");if(!t||!m.professionals)return;let e=m.professionals.filter(r=>z.showInactiveProfs||r.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(r=>{const o=z.selectedProfessionalId===r.id,i=r.name==="Todos"?"T":r.name.charAt(0).toUpperCase(),n=r.id!=="all"?m.professionalColors.get(r.id)||ra[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        `}t.innerHTML=s,t.querySelectorAll('[data-action="select-date"]').forEach(o=>{o.addEventListener("click",()=>{const i=new Date(o.dataset.date);z.currentDate=i,navigator.vibrate&&navigator.vibrate(30),Le()})}),requestAnimationFrame(()=>{const o=t.querySelector(".bg-indigo-600");o&&o.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})})}function G(t){return h(t||"")}function tn(t,e,a,s,r){const o=(t||"").replace(/\D/g,""),i=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${e}! Você tem um agendamento de ${a} com ${s} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${o}?text=${encodeURIComponent(l)}`}function an(t){const e=document.getElementById("agenda-view");if(!e)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=No(z.currentDate),r=new Date;r.setHours(0,0,0,0);let o='<div class="week-container flex gap-2 overflow-x-auto hide-scrollbar px-4" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(s);n.setDate(s.getDate()+i);const l=n.toDateString()===r.toDateString(),d=t.filter(c=>new Date(c.startTime).toDateString()===n.toDateString()).sort((c,p)=>new Date(c.startTime)-new Date(p.startTime));let u="";d.length===0?u='<div class="week-empty text-xs text-gray-400 text-center py-4 bg-gray-50 rounded-lg border border-dashed border-gray-200"><i class="bi bi-dash-lg block text-lg mb-1"></i>Livre</div>':u=d.map(c=>{const b=new Date(c.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),g=m.professionalColors.get(c.professionalId)||{main:"#adb5bd"},v=c.status==="completed",y=z.selectedItems.has(c.id);if(c.type==="blockage")return`<div class="week-event-chip bg-red-50 border-l-4 border-red-500 rounded-md p-2 mb-2">
                    ...
                    </div>`;const k=JSON.stringify(c).replace(/'/g,"&apos;"),P=y?"ring-2 ring-indigo-500 bg-indigo-50":"bg-white",T=z.isSelectionMode?`<div class="absolute top-1 right-1 z-10">
        ...
        </div>`}o+="</div>",e.innerHTML=o,requestAnimationFrame(()=>{const i=document.getElementById("weekScroller");if(i&&window.innerWidth<768){const n=i.querySelector(".is-today");n&&n.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})}})}function sn(t){const e=document.getElementById("agenda-view");if(!e)return;if(t.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),t.length===0){e.innerHTML=`
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function Ro(){const t=m.allEvents.filter(e=>z.selectedProfessionalId==="all"||e.professionalId===z.selectedProfessionalId);z.currentView==="list"?sn(t):an(t),bs()}function bs(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(z.isSelectionMode&&z.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function on(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(z.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(z.currentView==="list"){en();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function Le(){const t=document.getElementById("agenda-view");if(!t)return;z.selectedItems.clear(),bs(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',on();let e,a;if(z.currentView==="list")e=new Date(z.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=No(z.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const r=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async d=>{const[u,c]=await Promise.all([xa(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId==="all"?null:z.selectedProfessionalId),wa(d,e.toISOString(),a.toISOString(),z.selectedProfessionalId)]);return{appts:u||[],blockages:c||[]}}),o=await Promise.all(r);let i=[],n=[];if(o.forEach(d=>{i=i.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(u=>({...u,type:u.type||"appointment",professionalName:u.professionalName||(()=>{const c=m.professionals?.find(p=>p.id===u.professionalId);return c?c.name:"Indefinido"})()}));m.allEvents=[...l(i),...l(n)],ps(),Ro()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function rn(){try{const e=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async i=>{const[n,l,d]=await Promise.all([$e(i),ut(i),qe(i)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,r=new Map;let o=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>s.set(n.id,n)),i.services.forEach(n=>r.set(n.id,n))}),m.professionals=Array.from(s.values()),m.services=Array.from(r.values()),jo=[],o&&(ia=o.loyaltyProgram||{enabled:!1}),m.professionals.forEach((i,n)=>{m.professionalColors.set(i.id,ra[n%ra.length])}),ps()}catch{f("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function Fo(t={}){z.currentDate=t.targetDate?new Date(t.targetDate):z.currentDate||new Date,z.isSelectionMode=!1,z.selectedItems.clear(),Ms.innerHTML=`
        ...
        </div>`;const r=document.createElement("div");r.id="optionsOverlay",r.className="fixed inset-0 bg-black/40 z-[9999] opacity-0 transition-opacity duration-300",document.body.appendChild(r),document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.remove("translate-y-full"),r.classList.remove("opacity-0")});const o=()=>{e.classList.add("translate-y-full"),r.classList.add("opacity-0"),setTimeout(()=>{e.remove(),r.remove()},300)};document.getElementById("closeOptSheet").addEventListener("click",o),r.addEventListener("click",o),document.getElementById("optSelectMode").addEventListener("click",()=>{z.isSelectionMode=!z.isSelectionMode,z.isSelectionMode||z.selectedItems.clear(),o(),Ro()}),document.getElementById("optInactiveToggle").addEventListener("change",i=>{z.showInactiveProfs=i.target.checked,ps()})}function ft(t){t<1||t>4||(H.step=t,Oa(null,!0))}function ln(t){return{title:t?"Editar Reserva":"Novo Cliente",content:`
        ...
        </div>`}}function dn(){return{title:"Serviços",content:`
        ...
        </div>`}}function cn(){return{title:"Equipe",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            <div class="relative">
                <i class="bi bi-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-base"></i>
        ...
        </div>`}}function un(){const t=H.data.date||Xt();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
        ...
        </div>`}}async function Oa(t=null,e=!1){const a=document.getElementById("appointmentModal");e||(H={step:1,data:{id:t?.id||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(i=>i.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:t?.startTime?Xt(new Date(t.startTime)):Xt(),time:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,originalDate:t?.startTime?Xt(new Date(t.startTime)):null,originalTime:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}}),Sa=m.services||[],Ha=(m.professionals||[]).filter(i=>i.status==="active");let s;switch(H.step){case 1:s=ln(t);break;case 2:s=dn();break;case 3:s=cn();break;case 4:s=un();break}a.className="fixed inset-0 z-[10000] hidden flex items-end md:items-center justify-center bg-gray-900/50 backdrop-blur-sm transition-opacity duration-300 opacity-0",a.innerHTML=`
    ...
    `;const r=()=>{const i=a.querySelector("#appointmentModalContent");i&&(i.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),i.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),a.classList.add("opacity-0"),setTimeout(()=>{a.classList.add("hidden")},300)};a.querySelectorAll('[data-action="next-step"]').forEach(i=>i.addEventListener("click",()=>{const n=parseInt(i.dataset.currentStep,10);if(n===1&&(H.data.clientName=a.querySelector("#apptClientName").value.trim(),H.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!H.data.clientName))return f("Preencha o nome do cliente.","warning");if(n===2&&H.data.selectedServiceIds.length===0)return f("Selecione um serviço.","warning");if(n===3&&!H.data.professionalId)return f("Escolha um membro da equipe.","warning");ft(n+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(i=>i.addEventListener("click",()=>ft(parseInt(i.dataset.currentStep,10)-1))),a.querySelectorAll('[data-action="close-modal"]').forEach(i=>{i.addEventListener("click",r)}),a.classList.remove("hidden"),a.offsetWidth,a.classList.remove("opacity-0");const o=a.querySelector("#appointmentModalContent");o&&(o.classList.remove("translate-y-full","md:translate-y-8","md:scale-95"),o.classList.add("translate-y-0","md:translate-y-0","md:scale-100")),H.step===2&&a.querySelectorAll(".service-card").forEach(i=>i.addEventListener("click",()=>{const n=a.querySelector("#multiServiceToggle")?.checked,l=i.classList.contains("bg-indigo-50"),d=i.dataset.serviceId;navigator.vibrate&&navigator.vibrate(15),n?l?(i.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.add("border-gray-100","shadow-sm"),H.data.selectedServiceIds=H.data.selectedServiceIds.filter(u=>u!==d)):(i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds.includes(d)||H.data.selectedServiceIds.push(d)):(a.querySelectorAll(".service-card.bg-indigo-50").forEach(u=>{u.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),u.classList.add("border-gray-100","shadow-sm")}),i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds=[d],setTimeout(()=>ft(3),250))})),H.step===3&&a.querySelectorAll(".professional-modal-card").forEach(i=>i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),a.querySelectorAll(".professional-modal-card.bg-indigo-50").forEach(l=>{l.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),l.classList.add("border-gray-100","shadow-sm")}),i.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),i.classList.remove("border-gray-100","shadow-sm"),H.data.professionalId=i.dataset.professionalId;const n=Ha.find(l=>l.id===i.dataset.professionalId);H.data.professionalName=n?n.name:"",setTimeout(()=>ft(4),250)})),H.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",i=>mn(i.target.value)),H.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",qs),a.querySelector("#availableTimesContainer")?.addEventListener("click",i=>{const n=i.target.closest("button[data-time-slot]");n&&(navigator.vibrate&&navigator.vibrate(10),a.querySelectorAll("#availableTimesContainer button").forEach(l=>{l.classList.remove("bg-indigo-600","text-white","border-indigo-600","shadow-md"),l.classList.add("bg-white","text-gray-700","border-gray-200","shadow-sm")}),n.classList.add("bg-indigo-600","text-white","border-indigo-600","shadow-md"),n.classList.remove("bg-white","text-gray-700","border-gray-200","shadow-sm"),H.data.time=n.dataset.timeSlot)}),a.querySelector("#btnSubmitAppointment")?.addEventListener("click",pn),qs(),bn())}async function pn(t){t.preventDefault();const e=document.getElementById("btnSubmitAppointment");if(!H.data.time||!H.data.selectedServiceIds.length||!H.data.professionalId)return f("Selecione horário, serviço e profissional.","warning");e.disabled=!0,e.innerHTML='<i class="bi bi-hourglass-split"></i> Processando...';const a=H.data.selectedServiceIds.map(u=>{const c=Sa.find(p=>p.id===u);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[s,r]=H.data.time.split(":"),o=new Date(`${H.data.date}T${s}:${r}:00`),i=a.reduce((u,c)=>u+(c.duration+(c.bufferTime||0)),0),n=new Date(o.getTime()+i*6e4),d={establishmentId:m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId,clientName:H.data.clientName,clientPhone:H.data.clientPhone,services:a,professionalId:H.data.professionalId,professionalName:H.data.professionalName,startTime:o.toISOString(),endTime:n.toISOString(),redeemedReward:H.data.redeemedReward};H.data.id&&(d.id=H.data.id);try{H.data.id?await Yr(H.data.id,d):await Gr(d),f("Registro salvo!","success");const u=document.getElementById("appointmentModal"),c=u.querySelector("#appointmentModalContent");c&&(c.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),c.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),u.classList.add("opacity-0"),setTimeout(()=>{u.classList.add("hidden")},300),Le()}catch(u){f(u.message,"error"),e.disabled=!1,e.innerHTML=`<i class="bi bi-check-circle-fill"></i> ${H.data.id?"Salvar Edição":"Confirmar"}`}}async function qs(){const t=document.getElementById("availableTimesContainer"),e=document.getElementById("apptTotalDuration");if(!t)return;const a=document.getElementById("apptDate");a&&a.value&&(H.data.date=a.value);const s=H.data.selectedServiceIds.reduce((u,c)=>{const p=Sa.find(b=>b.id===c);return u+(p?p.duration+(p.bufferTime||0):0)},0);e&&(e.innerHTML=`<strong>${s}</strong> min`);const{professionalId:r,selectedServiceIds:o,date:i,originalDate:n,originalTime:l,id:d}=H.data;if(!r||!o.length||!i){t.innerHTML='<p class="col-span-full text-center text-xs text-gray-500 font-bold py-4 bg-white rounded-xl shadow-sm border border-gray-100">Preencha os passos anteriores.</p>';return}t.innerHTML='<div class="col-span-full flex justify-center py-4"><div class="w-6 h-6 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div></div>';try{const u=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId;let c=await Qr({establishmentId:u,professionalId:r,serviceIds:o,date:i});const p=new Date;if(new Date(i+"T00:00:00").toDateString()===p.toDateString()){const b=p.getHours()*60+p.getMinutes();c=c.filter(g=>{const[v,y]=g.split(":").map(Number);return v*60+y>=b})}d&&i===n&&l&&(c.includes(l)||(c.push(l),c.sort())),t.innerHTML=c.length>0?c.map(b=>{const g=H.data.time===b;return`<button type="button" data-time-slot="${b}" class="py-3 text-sm font-bold rounded-xl border-2 transition-transform active:scale-95 ${g?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-white text-gray-700 border-gray-200 hover:border-indigo-300 shadow-sm"}">${b}</button>`}).join(""):'<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl border border-red-100 shadow-sm">Nenhum horário livre.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl">Erro ao pesquisar.</p>'}}function bn(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:a}=H.data,{enabled:s,rewards:r}=ia;if(!s||!e||!r?.length){t.innerHTML="";return}const o=r.filter(i=>a>=i.points);if(!o.length){t.innerHTML='<p class="text-xs font-bold text-gray-400 mt-3 text-center">Nenhuma recompensa atingida ainda.</p>';return}t.innerHTML=`<div class="border border-indigo-100 bg-indigo-50/80 rounded-xl p-3 mt-3 shadow-sm">
        ...
        ${o.map(i=>`<label class="flex items-center gap-2 p-2 bg-white border border-indigo-100 rounded-lg mb-1.5 cursor-pointer shadow-sm active:scale-95 transition-transform"><input type="radio" name="loyaltyReward" value="${G(i.reward)}" data-points="${i.points}" class="w-4 h-4 accent-indigo-600"><span class="text-[0.85rem] font-bold text-gray-800 flex-1">${G(i.reward)}</span><span class="text-[0.65rem] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded">-${i.points} pts</span></label>`).join("")}
            ...
            </div>`).join(""),e.querySelectorAll(".client-card").forEach(n=>{n.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),H.data.clientName=n.dataset.clientName,H.data.clientPhone=n.dataset.clientPhone,H.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(ia?.rewards||[]).map(d=>d.points));H.data.clientHasRewards=ia.enabled&&l!==1/0&&H.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,e.querySelectorAll(".client-card").forEach(d=>{d.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),d.classList.add("border-gray-100","shadow-sm")}),n.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),n.classList.remove("border-gray-100","shadow-sm"),setTimeout(()=>ft(2),250)})})}catch{e.innerHTML='<p class="text-[0.75rem] font-bold text-red-500 bg-red-50 p-3 rounded-xl border border-red-100 text-center shadow-sm">Erro ao pesquisar.</p>'}}const gn=(t,e=null,a=1,s=12)=>{let r=`/api/comandas/${t}?page=${a}&limit=${s}`;return e&&(typeof e=="object"?(e.startDate&&(r+=`&startDate=${e.startDate}`),e.endDate&&(r+=`&endDate=${e.endDate}`)):typeof e=="string"&&(r+=`&date=${e}`)),C(r)},fn=(t,e)=>C(`/api/appointments/${t}/comanda`,{method:"POST",body:JSON.stringify({items:e})}),Ho=t=>C("/api/sales",{method:"POST",body:JSON.stringify(t)}),za=(t,e)=>C(`/api/sales/${t}?date=${e}`),xn=(t,e,a)=>{const s=`/api/sales/${t}?startDate=${e}&endDate=${a}`;return C(s)},hn=t=>C(`/api/sales/${t}/reopen`,{method:"POST"}),Oo=t=>C(`/api/sales/${t}`,{method:"DELETE"}),js=Object.freeze(Object.defineProperty({__proto__:null,createSale:Ho,deleteSale:Oo,getSales:za,getSalesByDateRange:xn,reopenSale:hn},Symbol.toStringTag,{value:"Module"})),pt=t=>C(`/api/products/${t}`),zo=t=>C("/api/products",{method:"POST",body:JSON.stringify(t)}),Vo=(t,e)=>C(`/api/products/${t}`,{method:"PUT",body:JSON.stringify(e)}),ms=t=>C(`/api/products/${t}`,{method:"DELETE"}),_o=(t,e)=>C(`/api/products/${t}/stock`,{method:"PATCH",body:JSON.stringify(e)}),vn=t=>C(`/api/products/${t}/stock-history`),Uo=({startDate:t,endDate:e,productId:a,categoryId:s,establishmentId:r})=>{const o=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),r&&o.append("establishmentId",r),C(`/api/products/stock-history/report?${o.toString()}`)},yn=Object.freeze(Object.defineProperty({__proto__:null,adjustStock:_o,createProduct:zo,deleteProduct:ms,getProducts:pt,getStockHistory:vn,getStockReport:Uo,updateProduct:Vo},Symbol.toStringTag,{value:"Module"})),wn=()=>C("/api/cashier/status").catch(t=>{if(t.message.includes("404")||t.message.includes("não encontrada"))return null;throw t}),kn=t=>{const e={establishmentId:t.establishmentId,initialAmount:Number(t.initialAmount),notes:t.notes||""};return console.log("Payload enviado para abrir caixa:",e),C("/api/cashier/open",{method:"POST",body:JSON.stringify(e)})},Sn=(t,e)=>{const a={finalAmount:Number(e)};return console.log("Payload enviado para fechar caixa:",a),C(`/api/cashier/close/${t}`,{method:"PUT",body:JSON.stringify(a)})},$n=()=>C("/api/cashier/history").then(t=>t||[]).catch(t=>(console.error("Erro ao buscar histórico:",t),[])),En=t=>C(`/api/cashier/report/${t}`),gs=t=>C(`/api/packages/${t}`),In=t=>C("/api/packages",{method:"POST",body:JSON.stringify(t)}),Ln=(t,e)=>C(`/api/packages/${t}`,{method:"PUT",body:JSON.stringify(e)}),Ns=t=>C(`/api/packages/${t}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",selectedCatalogItem:null,isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,establishmentConfig:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryPanel:!1,filterStartDate:"",filterEndDate:"",filterPreset:"hoje"},Ve=null,Je=null,Rs=null;function Wo(t,e){return function(...a){clearTimeout(Rs),Rs=setTimeout(()=>t.apply(this,a),e)}}function Ta(t){const e=new Date;let a,s;t==="hoje"?(a=new Date,s=new Date):t==="este_mes"?(a=new Date(e.getFullYear(),e.getMonth(),1),s=new Date(e.getFullYear(),e.getMonth()+1,0)):t==="mes_passado"?(a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0)):(a=new Date,s=new Date);const r=o=>{const i=o.getTimezoneOffset()*6e4;return new Date(o-i).toISOString().split("T")[0]};return{start:r(a),end:r(s)}}async function Fs(t,e="stay"){if(!t||!t.id)return;t._localUpdatedAt=Date.now(),t._cachedItems=null,t._hasUnsavedChanges=!1,Ea(),e==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),te());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,document.body.appendChild(a);try{const s=(t.comandaItems||[]).filter(r=>r&&r.id&&String(r.id)!=="undefined"&&String(r.id)!=="null").map(r=>{const o={...r};if(o.id=String(r.id),o.type==="product"){const i=o.id;o.productId||(o.productId=i),o.product_id||(o.product_id=i)}if(o.type==="service"){const i=o.id;o.serviceId||(o.serviceId=i),o.service_id||(o.service_id=i)}return o});t.type==="walk-in"&&String(t.id).startsWith("temp-")||await fn(t.id,s),document.body.contains(a)&&document.body.removeChild(a),e!=="checkout"&&(f("Sucesso","Comanda atualizada e salva!","success"),te())}catch(s){document.body.contains(a)&&document.body.removeChild(a),t._hasUnsavedChanges=!0,te(),f("Erro","Falha ao salvar no servidor: "+s.message,"warning")}}function je(t){if(!t._cachedItems){let e=[];if(t.status==="completed"){const a=t.comandaItems||t.items||[];e=a.length>0?a:t.services||[]}else{const a=(t.services||[]).map(i=>({...i,_source:"original_service",type:"service"})),s=a.reduce((i,n)=>{const l=String(n.id);return i[l]=(i[l]||0)+1,i},{}),r=[...t.comandaItems||[],...t.items||[]],o=[];r.forEach(i=>{const n=String(i.id);(i.type==="service"||!i.type)&&s[n]>0?s[n]--:o.push({...i,_source:"extra"})}),e=[...a,...o]}return t._cachedItems=e,t._cachedTimestamp=Date.now(),e}return t._cachedItems}function Cn(){const t=document.getElementById("comandas-layout");t&&t.classList.add("mobile-detail-open");const e=document.getElementById("mobile-bottom-nav");e&&(e.style.display="none")}function Ye(){const t=document.getElementById("comandas-layout");t&&t.classList.remove("mobile-detail-open");const e=document.getElementById("mobile-bottom-nav");e&&(e.style.display="")}function Dn(){const t=x.allComandas||[],e=t.filter(d=>d.status!=="completed").length,a=t.filter(d=>d.status==="completed"),s=a.reduce((d,u)=>{let c=u.totalAmount!==void 0?Number(u.totalAmount):je(u).reduce((p,b)=>p+Number(b.price||0),0);return d+c},0),r=a.length>0?s/a.length:0,o=document.getElementById("kpi-abertas"),i=document.getElementById("kpi-pagas"),n=document.getElementById("kpi-vendas"),l=document.getElementById("kpi-ticket");o&&(o.textContent=e),i&&(i.textContent=a.length),n&&(n.textContent=`R$ ${s.toFixed(2).replace(".",",")}`),l&&(l.textContent=`R$ ${r.toFixed(2).replace(".",",")}`)}function jt(){Je.innerHTML=`
    ...
    `,$a(),fs()}function fs(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function $a(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierOpen?(t&&(t.innerHTML=""),e&&(e.classList.remove("opacity-50","cursor-not-allowed"),e.disabled=!1)):(t&&(t.innerHTML=`
        ...
        `),e&&(e.classList.add("opacity-50","cursor-not-allowed"),e.disabled=!0)),Pn()}function Pn(){const t=document.getElementById("cashier-controls");t&&(x.isCashierOpen?t.innerHTML=`
        ...
        `)}function Ea(){const t=document.getElementById("comandas-list"),e=document.getElementById("pagination-container");if(!t)return;if(!x.isCashierOpen&&x.activeFilter==="abertas"){t.innerHTML=`
        ...
        `,e&&(e.innerHTML="");return}let a=x.allComandas||[];if(x.activeFilter==="abertas"?a=a.filter(r=>r.status!=="completed"):x.activeFilter==="pagas"&&(a=a.filter(r=>r.status==="completed")),Dn(),a.length===0){t.innerHTML='<p class="text-center text-gray-400 py-12 text-sm font-medium border border-dashed border-gray-200 rounded-2xl mx-2">Nenhuma comanda encontrada.</p>',Hs(e);return}const s=document.createDocumentFragment();a.forEach(r=>{const o=je(r);let i=0;r.status==="completed"&&r.totalAmount!==void 0&&r.totalAmount!==null?i=Number(r.totalAmount):i=o.reduce((T,$)=>T+Number($.price||0),0);const l=r.loyaltyRedemption||r.discount&&r.discount.reason&&String(r.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-1.5 text-xs shadow-sm border border-yellow-200" title="Prémio Resgatado">🎁</span>':"",d=String(r.id)===String(x.selectedComandaId),u=new Date(r.startTime),c=u.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),p=u.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),b=r.type==="walk-in"||typeof r.id=="string"&&r.id.startsWith("temp-"),g=r.status==="completed",v=h(r.clientName||"Cliente sem nome"),y=h(r.professionalName||"Sem profissional");let k="";g?k='<span class="text-[10px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-md border border-emerald-200">Paga</span>':b?k='<span class="text-[10px] font-black uppercase tracking-wider text-blue-700 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':k='<span class="text-[10px] font-black uppercase tracking-wider text-indigo-700 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const P=document.createElement("div");P.className=`comanda-card cursor-pointer border rounded-2xl p-3.5 hover:bg-gray-50 transition-all shadow-sm mb-2 ${d?"ring-2 ring-indigo-500 bg-indigo-50/50 border-transparent":"bg-white border-gray-200"}`,P.dataset.action="select-comanda",P.dataset.comandaId=r.id,P.innerHTML=`
        ...
        `,s.appendChild(P)}),t.innerHTML="",t.appendChild(s),Hs(e)}function Hs(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=x.paging,r=Math.ceil((a||0)/s);if(r===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full py-1",o.innerHTML=`
    ...
    `,t.appendChild(o),o.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=r&&(x.paging.page=l,ge())}})}function Tn(t,e){const a=`
    ...
    `;const o=()=>{e.querySelector("#quantity-display").textContent=s,e.querySelector("#quantity-minus-btn").disabled=s<=1};e.querySelector("#quantity-minus-btn").onclick=()=>{s>1&&(s--,o())},e.querySelector("#quantity-plus-btn").onclick=()=>{s++,o()},e.querySelector("#confirm-add-qty-btn").onclick=async()=>{await Qo(a,s),x.viewMode="items",x.selectedCatalogItem=null,te()},o()}function te(){const t=document.getElementById("comanda-detail-container");if(!t)return;const e=x.allComandas.find(g=>String(g.id)===String(x.selectedComandaId));if(x.viewMode==="checkout"&&e){Mn(e,t);return}if(x.viewMode==="add-item"&&e){Tn(e,t);return}if(x.viewMode==="add-item-qty"&&e){Bn(e,t);return}const a=`
    ...
    `;if(!x.isCashierOpen){t.innerHTML=`
        ...
        `;return}const s=je(e),r=e.status==="completed",o=e.type==="walk-in"||typeof e.id=="string"&&e.id.startsWith("temp-"),i=s.reduce((g,v)=>{const y=v._source==="original_service",k=v.id||v.name,P=y?`original-${k}`:`${v.type}-${k}`;return g[P]||(g[P]={...v,quantity:0,sources:[]}),g[P].quantity+=1,v._source&&g[P].sources.push(v._source),g},{}),n=Object.values(i).reduce((g,v)=>g+Number(v.price||0)*v.quantity,0),l=h(e.clientName||"Cliente sem nome"),d=h(e.professionalName||"Profissional não atribuído"),u=e._hasUnsavedChanges,c=r?"":`
    ...
    `;t.innerHTML=`
        ...
        ${p}
        ${b}
    `,!r&&(e.clientId||e.clientName)&&An(e,t.querySelector("#loyalty-container"))}function Mn(t,e){const s=je(t).reduce((b,g)=>b+Number(g.price||0)*(g.quantity||1),0),r=x.checkoutState,o=r.discount||{type:"real",value:0};let i=0;o.type==="percent"?i=s*o.value/100:i=o.value,i>s&&(i=s);const n=s-i,l=r.payments.reduce((b,g)=>b+g.value,0),d=Math.max(0,n-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const u=`
    ...
    `;const p=()=>{const b=x.checkoutState.discount.type,g=x.checkoutState.discount.value;let v=b==="percent"?s*g/100:g;v>s&&(v=s);const y=s-v,k=x.checkoutState.payments.reduce((q,N)=>q+N.value,0),P=Math.max(0,y-k),T=e.querySelector("#checkout-total-display");T&&(T.textContent=`R$ ${y.toFixed(2)}`);const $=e.querySelector("#checkout-status-msg");$&&(P<=.01?$.innerHTML='<p class="text-emerald-500 font-black text-base uppercase tracking-widest"><i class="bi bi-check2-circle text-2xl mr-2 align-middle"></i> Totalmente Pago</p>':$.innerHTML=`<p class="text-red-500 font-bold text-sm uppercase tracking-widest">Faltam: <span id="checkout-remaining-display" class="font-black text-xl text-red-600 ml-1">R$ ${P.toFixed(2)}</span></p>`);const L=e.querySelector("#checkout-amount");L&&P>0&&document.activeElement!==L&&(L.value=P.toFixed(2))};e.querySelector("#discount-value")?.addEventListener("input",b=>{const g=parseFloat(b.target.value)||0;x.checkoutState.discount.value=g,p()}),e.querySelector("#discount-type")?.addEventListener("change",b=>{x.checkoutState.discount.type=b.target.value,p()}),e.querySelector("#discount-reason")?.addEventListener("input",b=>{x.checkoutState.discountReason=b.target.value}),e.querySelector("#checkout-amount")?.addEventListener("input",b=>{x.checkoutState.amountReceived=b.target.value}),e.querySelector("#checkout-installments")?.addEventListener("change",b=>{x.checkoutState.installments=parseInt(b.target.value,10)})}async function An(t,e){if(!e)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(t.clientId)s=await wo(m.establishmentId,t.clientId);else if(t.clientName){const n=await ct(m.establishmentId,t.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const r=Number(s.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&r>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-2xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerHTML="<i class='bi bi-gift mr-1.5'></i> Resgatar",l.className="text-[10px] font-black uppercase tracking-wider bg-yellow-500 text-white px-4 py-2.5 rounded-xl shadow-md hover:bg-yellow-600 transition-colors active:scale-95",l.onclick=()=>qn(i,t),n.appendChild(l),e.innerHTML="",e.appendChild(n)}}function qn(t,e){const a=`
        <div class="space-y-3">
    ...
    `,{modalElement:s,close:r}=Be({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",o=>{const i=o.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=t.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(jn(l,e),r())}})}async function jn(t,e){const a=Number(t.costPoints||t.points||0),s=t.name||t.reward,r=t.type||"money";if(r==="money"){const l=parseFloat(t.discount)||0;if(l<=0){f("Erro","O valor do desconto configurado é inválido.","error");return}x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:"money"},f("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),te();return}const o=je(e),i=t.itemId?String(t.itemId):null;if(!i){f("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");return}const n=o.find(l=>{const d=l.id?String(l.id):null,u=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,c=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return r==="service"?d===i||u===i:r==="product"?d===i||c===i:r==="package"?d===i:!1});if(n){let l=parseFloat(t.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:t.id||null,name:s,cost:a,type:r,appliedToItemId:n.id},f("Sucesso",`Prémio "${s}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),te()}else f("Item Não Encontrado",`Para resgatar o prémio "${s}", o ${r==="service"?"serviço":r==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}async function Va(t=null){if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await $e(m.establishmentId)}catch{return f("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,maxWidth:"max-w-sm"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",Rn)}async function Rn(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const a=e.querySelector("#regClientName"),r=e.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!r)return f("Erro","Nome e Telefone são obrigatórios.","error");try{const o=await Ri(m.establishmentId,r);if(o)f("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",Va(o);else{const i=await So({establishmentId:m.establishmentId,name:a.value,phone:r});f("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",Va(i)}}catch(o){f("Erro",o.message,"error")}}async function Fn(){const t=`
    ...
    `,{modalElement:e}=Be({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-xs"});e.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return f("Valor Inválido","Insira um valor válido.","error");try{const r=await kn({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",f("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),$a(),await ge()}catch(r){f("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function Hn(){const t=x.activeCashierSessionId;if(t)try{const e=await En(t),a=`
        ...
        `,{modalElement:s}=Be({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return f("Valor Inválido","Insira um valor final válido.","error");try{await Sn(t,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",$a(),await ge(),f("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){f("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(e){f("Erro",`Falha ao carregar relatório: ${e.message}`,"error")}}async function On(t){if(x.activeFilter===t)return;x.activeFilter=t,x.paging.page=1,fs(),Ye(),x.selectedComandaId=null,x.viewMode="items";const e=document.getElementById("comandas-list");e&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>'),await ge()}function Jo(t){x.selectedComandaId=String(t),x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",Ea(),Cn(),te()}async function Qo(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;if(!t.id||String(t.id)==="undefined"){f("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(t.price)||0,r=Array(e).fill(0).map(()=>{const o={id:String(t.id),name:t.name,price:s,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0};return t.type==="product"?(o.productId=o.id,o.product_id=o.id):t.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...r),a._cachedItems=null,a._hasUnsavedChanges=!0,te()}async function Os(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>String(o.id)===String(t)&&o.type===e);r>-1&&(a.comandaItems.splice(r,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,te())}async function zn(t){if(x.isProcessing)return;const e=je(t),a=e.reduce((y,k)=>y+Number(k.price||0)*(k.quantity||1),0),s=x.checkoutState.discount||{type:"real",value:0};let r=s.type==="percent"?a*s.value/100:s.value;r>a&&(r=a);const o=a-r,{payments:i}=x.checkoutState,n=i.reduce((y,k)=>y+k.value,0),l=o-n;if(l>.01){if(!await Y("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=t.type==="appointment",u=e;let c=0;const p=x.loyaltySettings;p&&p.enabled&&(c=parseInt(p.pointsPerVisit||1,10));const b={...s,reason:x.checkoutState.discountReason||""},g={payments:i,totalAmount:Number(o),items:u,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:c,discount:b,loyaltyRedemption:x.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center"><div class="loader mb-5"></div><p class="text-sm font-black text-gray-800 uppercase tracking-widest mt-2">Processando...</p></div>',document.body.appendChild(v);try{d?await Kr(t.id,g):(g.establishmentId=m.establishmentId,g.clientId=t.clientId,g.clientName=t.clientName,g.professionalId=t.professionalId,t.clientPhone&&(g.clientPhone=t.clientPhone),await Ho(g));let y="Venda finalizada com sucesso!";c>0&&(y+=` Cliente ganhou ${c} pontos!`),f("Sucesso!",y,"success"),Ye(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await ge()}catch(y){f("Erro no Checkout",y.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),x.isProcessing=!1}}async function Vn(t){t.preventDefault();const e=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=e.value,r=document.getElementById("client-search").value,o=e.dataset.phone||"";if(!s)return f("Erro","Selecione um cliente válido.","error");const i=m.professionals.find(l=>l.id===a);if(!i)return f("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:r.split("(")[0].trim(),clientPhone:o,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(n),x.selectedComandaId=String(n.id),x.viewMode="items",document.getElementById("genericModal").style.display="none",x.activeFilter==="pagas"&&(x.activeFilter="abertas"),fs(),Jo(n.id)}async function ge(){const t=document.getElementById("comandas-list");(!t.hasChildNodes()||t.innerHTML.includes("loader"))&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>');let e=x.filterStartDate,a=x.filterEndDate,s;e&&a&&e!==a?s={startDate:e,endDate:a}:s={startDate:e,endDate:a,date:e};try{const r=wn(),o=gn(m.establishmentId,s,x.paging.page,x.paging.limit),i=qe(m.establishmentId),[n,l,d]=await Promise.all([r,o,i]);if(x.establishmentConfig=d||{},x.isCashierOpen=!!n,x.activeCashierSessionId=n?n.id:null,$a(),d&&d.loyaltyProgram&&(x.loyaltySettings=d.loyaltyProgram),x.allComandas=l.data||l||[],x.paging.total=l.total||x.allComandas.length,x.catalog.services.length===0){const[u,c,p,b]=await Promise.all([ut(m.establishmentId),pt(m.establishmentId),gs(m.establishmentId),$e(m.establishmentId)]);x.catalog={services:u,products:c,packages:p},m.professionals=b}Ea(),te()}catch(r){f("Erro",`Não foi possível carregar os dados: ${r.message}`,"error")}}async function _n(t={}){Je=document.getElementById("content"),x.selectedComandaId=t.selectedAppointmentId?String(t.selectedAppointmentId):null,x.viewMode="items",x.selectedCatalogItem=null;const e=Ta("hoje");if(x.filterStartDate=e.start,x.filterEndDate=e.end,x.filterPreset="hoje",x.showHistoryPanel=!1,jt(),Ve&&(Je.removeEventListener("click",Ve),Je.removeEventListener("change",Ve)),Ve=async a=>{const s=a.target.closest("[data-action], [data-filter], [data-comanda-id]");if(s){if(s.matches("[data-filter]"))a.preventDefault(),On(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(a.preventDefault(),a.target.closest('[data-action="go-to-appointment"]')){a.stopPropagation();return}Jo(s.dataset.comandaId)}else if(s.matches("[data-action]")){a.preventDefault();const r=s.dataset.action,o=String(s.dataset.id||x.selectedComandaId),i=x.allComandas.find(n=>String(n.id)===o);switch(r){case"toggle-history":if(x.showHistoryPanel=!x.showHistoryPanel,x.showHistoryPanel&&x.activeFilter==="abertas"&&(x.activeFilter="todas"),jt(),!x.showHistoryPanel){x.filterPreset="hoje";const I=Ta("hoje");x.filterStartDate=I.start,x.filterEndDate=I.end,await ge()}break;case"set-period":const n=s.dataset.period;if(x.filterPreset=n,n!=="custom"){const I=Ta(n);x.filterStartDate=I.start,x.filterEndDate=I.end,jt(),x.paging.page=1,f("Buscando...",`Período: ${I.start.split("-").reverse().join("/")} a ${I.end.split("-").reverse().join("/")}`,"info"),await ge()}else jt();break;case"apply-custom-dates":const l=document.getElementById("filter-start-date").value,d=document.getElementById("filter-end-date").value;l&&d?(x.filterStartDate=l,x.filterEndDate=d,x.paging.page=1,f("Buscando...","Período personalizado aplicado.","info"),await ge()):f("Atenção","Preencha a data inicial e final.","warning");break;case"back-to-list":Ye(),x.selectedComandaId=null,x.selectedCatalogItem=null,document.querySelectorAll(".comanda-card").forEach(I=>I.classList.remove("ring-2","ring-indigo-500","bg-indigo-50/50","border-transparent")),document.querySelectorAll(".comanda-card").forEach(I=>I.classList.add("bg-white","border-gray-200")),te();break;case"new-sale":Va();break;case"add-item":if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa primeiro.","error");x.viewMode="add-item",te();break;case"back-to-items":x.viewMode="items",te();break;case"back-to-add-item":x.viewMode="add-item",x.selectedCatalogItem=null,te();break;case"select-catalog-item":const{itemType:u,itemId:c}=s.dataset,b=(x.catalog[u+"s"]||[]).find(I=>String(I.id)===String(c));b&&(x.selectedCatalogItem={...b,type:u},x.viewMode="add-item-qty",te());break;case"open-cashier":Fn();break;case"close-cashier":await Hn();break;case"view-sales-report":se("sales-report-section");break;case"go-to-checkout":await Fs(i,"checkout");break;case"save-comanda":await Fs(i,"stay");break;case"select-method":x.checkoutState.selectedMethod=s.dataset.method,x.checkoutState.installments=1,te();break;case"add-payment-checkout":const g=document.getElementById("checkout-amount");let v=parseFloat(g.value);const k=je(i).reduce((I,D)=>I+(D.price||0),0),P=x.checkoutState.discount||{type:"real",value:0};let T=P.type==="percent"?k*P.value/100:P.value;T>k&&(T=k);const $=k-T,L=x.checkoutState.payments.reduce((I,D)=>I+D.value,0),q=$-L;if(isNaN(v)||v<=0){f("Valor inválido","Insira um valor maior que zero.","error");break}if(v>q+.05){f("Valor inválido","Valor excede o restante.","error");break}const N={method:x.checkoutState.selectedMethod,value:v};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(N.installments=x.checkoutState.installments),x.checkoutState.payments.push(N),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",te();break;case"remove-payment-checkout":const E=parseInt(s.dataset.index,10);x.checkoutState.payments.splice(E,1),te();break;case"finalize-checkout":await zn(i);break;case"increase-qty":{const I=s.dataset.itemId,D=s.dataset.itemType;if(!I||I==="undefined"||I==="null"){f("Erro","Item inválido.","error");return}let O=je(i).find(Z=>String(Z.id)===String(I)&&Z.type===D);O||(O=(x.catalog[D+"s"]||[]).find(K=>String(K.id)===String(I)));const U=O?{id:O.id,name:O.name,price:Number(O.price),type:O.type}:{id:I,name:"Item",price:0,type:D};await Qo(U,1);break}case"decrease-qty":await Os(s.dataset.itemId,s.dataset.itemType);break;case"remove-item":await Os(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await Y("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Zr(o);const D=x.allComandas.findIndex(R=>String(R.id)===o);D!==-1&&(x.allComandas[D].status="confirmed",delete x.allComandas[D].transaction),x.selectedComandaId=null,Ye(),await ge(),f("Sucesso!","Comanda reaberta.","success")}catch(D){f("Erro",D.message,"error")}break}case"go-to-appointment":{se("agenda-section",{scrollToAppointmentId:s.dataset.id,targetDate:new Date(s.dataset.date)});break}case"delete-walk-in":{if(await Y("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))x.allComandas=x.allComandas.filter(D=>String(D.id)!==o),x.selectedComandaId=null,Ea(),te(),Ye();else try{await Oo(o),f("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Ye(),await ge()}catch(D){f("Erro",D.message,"error")}break}}}}},Je.addEventListener("click",Ve),Je.addEventListener("change",Ve),t.initialFilter&&(t.initialFilter==="finalizadas"?x.activeFilter="pagas":x.activeFilter="abertas"),t.selectedAppointmentId&&(x.selectedComandaId=String(t.selectedAppointmentId)),t.filterDate){const a=new Date(t.filterDate).toISOString().split("T")[0];x.filterStartDate=a,x.filterEndDate=a,x.filterPreset="custom",x.showHistoryPanel=!0}await ge()}const _a=new Date,Un=new Date(_a.getFullYear(),_a.getMonth(),1);let M={establishments:[],filterEstablishmentIds:new Set,startDate:Un.toISOString().split("T")[0],endDate:_a.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Ua=document.getElementById("content");let Nt=null;function ne(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function De(t){if(!t)return"--/--/----";const e=t.split("T")[0].split("-");return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}function Ce(t){return t?typeof t.toDate=="function"?t.toDate():typeof t=="string"||typeof t=="number"?new Date(t):new Date:new Date(0)}function At(t){M.charts[t]&&(M.charts[t].destroy(),M.charts[t]=null)}async function Wn(){try{const e=(await ve().catch(()=>({matrizes:[]}))).matrizes||[];M.establishments=[],e.forEach(a=>{M.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>M.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),M.filterEstablishmentIds.size===0&&M.filterEstablishmentIds.add(m.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}Jn(),el(),await xt()}function Jn(){const t=M.establishments.map(e=>`
    ...
    `}async function xt(){const t=document.getElementById("tab-content");t&&(t.innerHTML='<div class="flex justify-center items-center h-40"><div class="loader"></div></div>');const{currentTab:e,startDate:a,endDate:s,filterEstablishmentIds:r}=M,o=Array.from(r),i=o.join(","),n=new Date(a).toISOString(),l=new Date(s);l.setHours(23,59,59,999);const d=l.toISOString();try{if(e==="financeiro"){const u={startDate:a,endDate:s,establishmentId:i},[c,p,b]=await Promise.all([cs(u).catch(()=>({entries:[]})),ya(u).catch(()=>({entries:[]})),va(m.establishmentId).catch(()=>[])]);M.data.financeiro={payables:c.entries,receivables:p.entries,natures:b},Qn()}else if(e==="agenda"){const u=o.map(g=>xa(g,n,d).catch(()=>[])),c=o.map(g=>Jr(g,n,d).catch(()=>[])),[p,b]=await Promise.all([Promise.all(u),Promise.all(c)]);M.data.agenda={active:p.flat(),cancelled:b.flat()},Wa()}else if(e==="clientes"){const u=await Promise.all(o.map(p=>ct(p).catch(()=>[]))),c=new Map;u.flat().forEach(p=>c.set(p.id,p)),M.data.clientes=Array.from(c.values()),Ja()}else if(e==="vendas"){let u=[];try{js&&typeof za=="function"?u=await Promise.all(o.map(c=>za({startDate:a,endDate:s,establishmentId:c}).catch(()=>[]))):ji&&typeof oa=="function"&&(u=(await Promise.all(o.map(p=>oa({establishmentId:p,startDate:a,endDate:s}).catch(()=>({transactions:[]}))))).flatMap(p=>(p.transactions||[]).map(b=>({id:"REF-"+Math.random().toString(36).substring(2,8),status:"completed",createdAt:b.date,totalAmount:b.total,items:[{name:b.items||"Itens Venda",quantity:1,price:b.total}]}))))}catch(c){console.error("Erro interno ao buscar as vendas:",c)}M.data.vendas=u.flat(),Yn()}else if(e==="estoque"){const u=await Promise.all(o.map(c=>pt(c).catch(()=>[])));M.data.estoque=u.flat(),Xn()}}catch(u){t.innerHTML=`<div class="p-10 text-center text-red-500 bg-red-50 rounded-xl border border-red-100"><i class="bi bi-exclamation-triangle text-3xl mb-2"></i><br>Erro ao carregar dados: ${u.message}</div>`}}function Qn(){const t=document.getElementById("tab-content"),{payables:e,receivables:a,natures:s}=M.data.financeiro,r=new Map(s.map($=>[$.id,$.name])),o={};a.forEach($=>{const L=($.status==="paid"?$.paymentDate:$.dueDate)?.split("T")[0];if(!L)return;o[L]||(o[L]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const q=Number($.amount)||0;o[L].items.push({...$,_type:"receita"}),$.status==="paid"?o[L].recReal+=q:o[L].recPrev+=q}),e.forEach($=>{const L=($.status==="paid"?$.paymentDate:$.dueDate)?.split("T")[0];if(!L)return;o[L]||(o[L]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const q=Number($.amount)||0;o[L].items.push({...$,_type:"despesa"}),$.status==="paid"?o[L].despReal+=q:o[L].despPrev+=q});const i=Object.keys(o).sort(),n=i.map($=>De($).substring(0,5));let l=0;const d=[],u=[],c=[],p=[],b=[];i.forEach($=>{const L=o[$];d.push(L.recReal),u.push(L.recPrev),c.push(-Math.abs(L.despReal)),p.push(-Math.abs(L.despPrev)),l+=L.recReal-L.despReal,b.push(l)});const g=d.reduce(($,L)=>$+L,0),v=c.reduce(($,L)=>$+Math.abs(L),0),y=g-v,k=g>0?y/g*100:0,P={},T={};a.filter($=>$.status==="paid").forEach($=>{const L=$.naturezaId?r.get($.naturezaId)||"Outros":"Sem Cat.";P[L]=(P[L]||0)+$.amount}),e.filter($=>$.status==="paid").forEach($=>{const L=$.naturezaId?r.get($.naturezaId)||"Outros":"Sem Cat.";T[L]=(T[L]||0)+$.amount}),t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-arrow-up-circle text-emerald-500 mr-1"></i> Rec. Realizada</span><span class="text-lg md:text-xl font-black text-slate-800 mt-0.5">${ne(g)}</span></div>
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-arrow-down-circle text-red-500 mr-1"></i> Desp. Realizada</span><span class="text-lg md:text-xl font-black text-slate-800 mt-0.5">${ne(v)}</span></div>
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-wallet2 text-indigo-500 mr-1"></i> Saldo do Período</span><span class="text-lg md:text-xl font-black ${y>=0?"text-emerald-600":"text-red-600"} mt-0.5">${ne(y)}</span></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto custom-scrollbar pr-2">
                        ...
                        ${Object.entries(P).sort(($,L)=>L[1]-$[1]).map(([$,L])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${$}</span><span class="text-[11px] font-bold text-slate-800">${ne(L)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                        <div class="mb-2"><p class="text-[9px] font-bold text-red-500 uppercase border-b border-red-100 pb-1 mb-1.5">Despesas</p>
                        ${Object.entries(T).sort(($,L)=>L[1]-$[1]).map(([$,L])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${$}</span><span class="text-[11px] font-bold text-slate-800">${ne(L)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                    </div>
                </div>
            </div>
        </div>`,setTimeout(()=>{const $=document.getElementById("chartFin");$&&(At("fin"),M.charts.fin=new Chart($,{type:"bar",data:{labels:n.length?n:["-"],datasets:[{label:"Receita Realizada",data:d,backgroundColor:"#10b981",stack:"Stack 0",borderRadius:3,order:2},{label:"Receita Prevista",data:u,backgroundColor:"#6ee7b7",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Realizada",data:c,backgroundColor:"#ef4444",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Prevista",data:p,backgroundColor:"#fca5a5",stack:"Stack 0",borderRadius:3,order:2},{label:"Saldo Acumulado",data:b,type:"line",borderColor:"#4f46e5",backgroundColor:"#4f46e5",tension:.4,borderWidth:2,pointRadius:3,yAxisID:"y1",order:1}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{callbacks:{label:function(L){let q=L.dataset.label||"";return q&&(q+=": "),L.parsed.y!==null&&(q+=ne(Math.abs(L.parsed.y))),q},footer:function(L){const q=L[0].dataIndex,N=i[q],E=o[N];if(!E)return"";const I=E.recReal+E.recPrev-(E.despReal+E.despPrev);return`
Saldo Dia: `+ne(I)+`
(Clique para ver)`}}}},onClick:(L,q)=>{if(q.length>0){const N=q[0].index,E=q[0].datasetIndex,I=i[N];let D="all";E===0||E===1?D="receita":(E===2||E===3)&&(D="despesa"),Gn(I,D,o[I].items,r)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:L=>ne(Math.abs(L))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:L=>ne(L)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(L=>{L.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",L.onclick=q=>{const N=q.currentTarget,E=parseInt(N.dataset.dataset),I=M.charts.fin;I.isDatasetVisible(E)?(I.hide(E),N.style.opacity="0.4",N.style.background="#f8f9fa"):(I.show(E),N.style.opacity="1",N.style.background="")}}))},100)}function Gn(t,e,a,s){let r=document.getElementById("genericModal");r||(r=document.createElement("div"),r.id="genericModal",r.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(r));const o=e==="all"?a:a.filter(l=>l._type===e);let i=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";r.innerHTML=`
    ...
    `,r.style.display="block",setTimeout(()=>r.classList.add("show","opacity-100"),10);const n=r.querySelector(".btn-close-modal");n&&(n.onclick=()=>{r.style.display="none",r.classList.remove("show","opacity-100")})}function Wa(){const t=document.getElementById("tab-content"),{active:e,cancelled:a}=M.data.agenda,s=e.length+a.length,r=e.filter(p=>p.status==="completed").length,o=e.filter(p=>["confirmed","pending","in-progress"].includes(p.status)).length,i=e.filter(p=>p.status==="no-show").length,n=a.length,l=s>0?(r/s*100).toFixed(1):0,d=e.filter(p=>p.status==="completed").reduce((p,b)=>p+(Number(b.totalAmount||(b.transaction?b.transaction.totalAmount:0))||0),0);let u=[],c=[];if(M.drillDownMonth!==null){const p=new Date(M.startDate).getFullYear(),b=new Date(p,M.drillDownMonth+1,0).getDate();u=Array.from({length:b},(g,v)=>`${v+1}`),c=u.map(g=>e.filter(v=>{const y=Ce(v.startTime||v.date);return y.getMonth()===M.drillDownMonth&&y.getDate()===parseInt(g)}).length)}else u=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],c=u.map((p,b)=>e.filter(g=>Ce(g.startTime||g.date).getMonth()===b).length);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="bg-emerald-600 p-4 rounded-xl text-white shadow-sm flex items-center justify-between"><div><p class="text-[10px] font-bold uppercase opacity-80 tracking-widest mb-1">Receita Atendimentos</p><p class="text-2xl md:text-3xl font-black">${ne(d)}</p></div><i class="bi bi-cash-coin text-3xl opacity-50"></i></div>
            </div>
        ...
        </div>`,setTimeout(()=>{const p=document.getElementById("chartAgenda");p&&(At("agenda"),M.charts.agenda=new Chart(p,{type:"line",data:{labels:u,datasets:[{label:"Ativos",data:c,borderColor:"#4f46e5",backgroundColor:"rgba(79, 70, 229, 0.1)",fill:!0,tension:.4,pointRadius:4,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(g,v)=>{v.length>0&&M.drillDownMonth===null&&(M.drillDownMonth=v[0].index,Wa())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",borderDash:[2,4]},ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const b=document.getElementById("btn-back-agenda");b&&(b.onclick=()=>{M.drillDownMonth=null,Wa()})},100)}function Ja(){const t=document.getElementById("tab-content"),e=M.data.clientes||[],a=Ce(M.startDate),s=Ce(M.endDate);s.setHours(23,59,59,999);const r=e.length,o=e.filter(u=>{if(!u.createdAt)return!1;const c=Ce(u.createdAt);return c>=a&&c<=s}),i=e.filter(u=>{if(!u.createdAt&&!u.lastVisit)return!0;const c=u.lastVisit?Ce(u.lastVisit):Ce(u.createdAt);return(new Date-c)/(1e3*60*60*24)>60}),n=r>0?(o.length/r*100).toFixed(1):0;let l=[],d=[];if(M.drillDownMonth!==null){const u=new Date(M.startDate).getFullYear(),c=new Date(u,M.drillDownMonth+1,0).getDate();l=Array.from({length:c},(p,b)=>`${b+1}`),d=l.map(p=>o.filter(b=>{const g=Ce(b.createdAt);return g.getMonth()===M.drillDownMonth&&g.getDate()===parseInt(p)}).length)}else l=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],d=l.map((u,c)=>o.filter(p=>Ce(p.createdAt).getMonth()===c).length);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const u=document.getElementById("chartClientes");u&&(At("clientes"),M.charts.clientes=new Chart(u,{type:"bar",data:{labels:l,datasets:[{label:"Novos Cadastros",data:d,backgroundColor:"#3b82f6",borderRadius:3}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(p,b)=>{b.length>0&&M.drillDownMonth===null&&(M.drillDownMonth=b[0].index,Ja())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const c=document.getElementById("btn-back-clientes");c&&(c.onclick=()=>{M.drillDownMonth=null,Ja()})},100)}function Yn(){const t=document.getElementById("tab-content"),a=(M.data.vendas||[]).filter(d=>d.status==="completed"||d.status==="paid"),s=a.reduce((d,u)=>d+(Number(u.totalAmount)||0),0),r=a.length,o=r>0?s/r:0;let i=0;const n={};a.forEach(d=>{(Array.isArray(d.items)?d.items:Array.isArray(d.services)?d.services:[]).forEach(c=>{const p=Number(c.quantity)||1;i+=p;const b=c.name||"Produto/Serviço Indefinido";n[b]=(n[b]||0)+p})});const l=Object.entries(n).sort((d,u)=>u[1]-d[1]).slice(0,5);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                <div class="bg-indigo-600 text-white p-3 rounded-xl shadow-sm flex flex-col"><span class="text-[9px] font-bold text-indigo-200 uppercase tracking-widest">Faturamento PDV</span><span class="text-lg md:text-xl font-black mt-0.5">${ne(s)}</span></div>
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Ticket Médio</span><span class="text-lg md:text-xl font-black text-slate-800 mt-0.5">${ne(o)}</span></div>
                        ...
                        ${a.slice(0,8).map(d=>{const u=Array.isArray(d.items)?d.items.length:Array.isArray(d.services)?d.services.length:1;return`
                                <div class="flex items-center justify-between border border-slate-100 bg-slate-50 p-2 rounded-lg">
                                    ...
                                    <div class="text-right">
                                        <p class="text-[11px] font-black text-emerald-600">${ne(d.totalAmount)}</p>
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const d=document.getElementById("chartVendas");d&&l.length>0?(At("vendas"),M.charts.vendas=new Chart(d,{type:"bar",data:{labels:l.map(u=>u[0].substring(0,15)+"..."),datasets:[{label:"Quantidade Vendida",data:l.map(u=>u[1]),backgroundColor:"#f59e0b",borderRadius:3}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},y:{grid:{display:!1},ticks:{font:{size:9}}}}}})):d&&(d.parentElement.innerHTML='<div class="flex h-full items-center justify-center text-[10px] text-slate-400">Sem dados suficientes</div>')},100)}function Xn(){const t=document.getElementById("tab-content"),e=M.data.estoque||[];let a=0,s=0,r=[],o=[];e.forEach(i=>{i.active!==!1&&s++;const n=Number(i.currentStock)||0,l=Number(i.minStock)||0,d=Number(i.costPrice)||Number(i.price)||0;n>0&&(a+=n*d),n<=0?o.push(i):n<=l&&r.push(i)}),t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                <div class="bg-indigo-600 text-white p-3 rounded-xl shadow-sm flex flex-col"><span class="text-[9px] font-bold text-indigo-200 uppercase tracking-widest">Imobilizado</span><span class="text-lg md:text-xl font-black mt-0.5">${ne(a)}</span></div>
    ...
    `}function rl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Ne),t.addEventListener("click",()=>{setTimeout(Ne,100)})),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",i=>{const n=i.target.dataset.status;_.statusFilter=n,document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),l.classList.add("bg-white","text-gray-600","border-gray-200")}),n==="inactive"?i.target.classList.add("bg-red-50","text-red-700","border-red-200"):i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200"),ht()})});const e=document.getElementById("toggle-filter-btn");e&&e.addEventListener("click",()=>{const o=document.getElementById("filter-panel");_.isAdvancedFilterOpen=!_.isAdvancedFilterOpen,_.isAdvancedFilterOpen?(o.classList.remove("hidden"),e.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),e.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),e.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),e.classList.add("bg-white","text-gray-600","border-gray-200"))});const a=document.getElementById("searchInput");a&&a.addEventListener("input",o=>{_.searchQuery=o.target.value.toLowerCase(),ht()});const s=document.getElementById("clear-filters-btn");s&&s.addEventListener("click",()=>{_.filterCategoryId="all",document.getElementById("filterCategoryId").value="all",ht()});const r=document.getElementById("apply-filter-btn");r&&r.addEventListener("click",()=>{_.filterCategoryId=document.getElementById("filterCategoryId").value,document.getElementById("toggle-filter-btn").click(),ht()}),Rt&&Qa.removeEventListener("click",Rt),Rt=o=>{const i=o.target.closest('[data-action="open-service-modal"]');if(i){o.preventDefault();let c={};if(i.dataset.service)try{c=JSON.parse(i.dataset.service)}catch{}ml(c);return}if(o.target.closest('[data-action="manage-categories"]')){o.preventDefault(),ul();return}const l=o.target.closest(".service-checkbox");if(l){const c=l.dataset.id;l.checked?_.selectedIds.add(c):_.selectedIds.delete(c),Ga(),o.stopPropagation();return}if(o.target.closest("#cancel-selection-btn")){_.selectedIds.clear(),document.querySelectorAll(".service-checkbox").forEach(c=>c.checked=!1),Ga();return}if(o.target.closest("#batch-delete-btn")){gl();return}},Qa.addEventListener("click",Rt)}async function Ne(){const t=document.getElementById("servicesList"),e=Xo();try{const a=e.map(c=>ut(c)),s=e.map(c=>$e(c)),r=e.map(c=>Ia(c,"services")),o=await Promise.all(a),i=await Promise.all(s),n=await Promise.all(r),l=new Map;o.flat().filter(Boolean).forEach(c=>l.set(c.id,c)),_.services=Array.from(l.values()),m.services=_.services;const d=new Map;i.flat().filter(Boolean).forEach(c=>d.set(c.id,c)),_.professionals=Array.from(d.values()),m.professionals=_.professionals;const u=new Map;n.flat().filter(Boolean).forEach(c=>u.set(c.id,c)),_.categories=Array.from(u.values()),m.serviceCategories=_.categories,il(),ht()}catch(a){console.error(a),t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>'}}function il(){const t=document.getElementById("filterCategoryId");t&&_.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',_.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),_.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function Ga(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=_.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function nl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.active!==!1).length,r=a-s;e.innerHTML=`
    ...
    `}function ht(){const t=document.getElementById("servicesList");if(!t)return;if(!_.services||_.services.length===0){t.innerHTML=Zo(8);return}const e=Xo(),a=_.services.filter(s=>{const r=s.name.toLowerCase().includes(_.searchQuery);let o=!0;_.statusFilter==="active"&&(o=s.active!==!1),_.statusFilter==="inactive"&&(o=s.active===!1);const i=_.filterCategoryId==="all"||s.categoryId===_.filterCategoryId,n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],l=e.some(d=>n.includes(d));return r&&o&&i&&l});nl(a),t.innerHTML=ll(a)}function Zo(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;const e=new Map((_.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=a.active===!1,r=h(a.name),o=h(e.get(a.categoryId)||"Sem Categoria"),i=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,n=JSON.stringify(a).replace(/'/g,"&apos;"),l=a.accessibleIn?a.accessibleIn.length:1,d=_.selectedIds.has(a.id),u=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",c=a.color||"#4f46e5";return`
            <div class="service-card relative bg-white rounded-xl border ${d?"border-indigo-400 ring-1 ring-indigo-200 shadow-md bg-indigo-50/20":"border-gray-200"} shadow-sm flex items-center p-3 cursor-pointer transition-all hover:shadow-md hover:border-indigo-300 ${s?"opacity-60 bg-gray-50":""}" 
            ...
            </div>`}).join("")}async function dl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const r=e.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="...";try{const o=_.hierarchyCache.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);o.length===0&&o.push(m.establishmentId),await Go({establishmentId:m.establishmentId,name:s,accessibleIn:o},"services"),oe(m.establishmentId,ot(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await xs(),await Ne()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{r.disabled=!1,r.textContent="Adicionar"}}async function cl(t){if(await Y("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Yo(t,"services"),oe(m.establishmentId,ot(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await xs(),await Ne()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function xs(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Ia(m.establishmentId,"services");_.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(a=>`
                ...
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function ul(){Be({title:"Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",dl),e.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),cl(r.dataset.id))}))}xs()}function pl(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(r=>{const o=t.includes(r.id)||t.length===0&&r.id===m.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}async function bl(t){const e=t.target.closest("#serviceForm"),a=e.querySelector("#serviceId").value,s=e.querySelector('button[type="submit"]'),r={},o=e.querySelector('input[name="commissionType"]:checked').value;o==="custom"&&e.querySelectorAll(".professional-commission-row").forEach(u=>{const c=u.dataset.profId;if(u.querySelector('input[type="checkbox"]').checked){const b=parseFloat(u.querySelector('input[type="number"]').value);r[c]=isNaN(b)?0:b}});const i=Array.from(e.querySelectorAll('input[name="accessibleIn"]:checked')).map(u=>u.value),n=i.length>0?i:[m.establishmentId],l={establishmentId:m.establishmentId,accessibleIn:n,name:e.querySelector("#serviceName").value.trim(),price:parseFloat(e.querySelector("#servicePrice").value),duration:parseInt(e.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(e.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:e.querySelector("#serviceCategory").value||null,color:e.querySelector("#serviceColor").value,targetAudience:e.querySelector("#serviceAudience").value,loyaltyPoints:parseInt(e.querySelector("#serviceLoyaltyPoints").value,10)||0,publicDescription:e.querySelector("#servicePublicDescription").value.trim(),homeService:e.querySelector("#serviceHomeToggle").checked,commissionRate:parseFloat(e.querySelector("#serviceCommissionRate").value)||0,active:e.querySelector("#serviceStatusToggle").checked,photo:e.querySelector("#servicePhotoBase64").value,notes:e.querySelector("#serviceNotes").value,commissionType:o,professionalCommissions:r},d=s.innerHTML;s.disabled=!0,s.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{a?(await Ki(a,l),oe(m.establishmentId,ot(),"Serviços","Editou",`Editou o serviço: ${l.name}`),f("Sucesso","Serviço atualizado com sucesso!","success")):(await Zi(l),oe(m.establishmentId,ot(),"Serviços","Criou",`Criou novo serviço: ${l.name}`),f("Sucesso","Serviço adicionado à rede!","success")),document.getElementById("genericModal").style.display="none",await Ne()}catch(u){f("Erro",u.message,"error"),s.disabled=!1,s.innerHTML=d}}function ml(t=null){const e=document.getElementById("genericModal"),a=_.categories||[],s=t?.duration||0,r=t?.bufferTime||0,o=h(t?.name||""),i=h(t?.notes||""),n=h(t?.publicDescription||""),l=t?.id?o:"Novo Serviço",d=t?.color||"#4f46e5",u=t?.loyaltyPoints||0,c=a.map(D=>`<option value="${D.id}" ${t?.categoryId===D.id?"selected":""}>${h(D.name)}</option>`).join(""),p=t?.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(o?o.charAt(0):"S")}`,b=`
        <div class="modal-content max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh]"> 
            ...
            `}).join(""),P.querySelectorAll('input[type="checkbox"]').forEach(D=>{D.addEventListener("change",R=>{const O=R.target.closest(".professional-commission-row");O.querySelector('input[type="number"]').disabled=!R.target.checked,O.classList.toggle("bg-indigo-50/50",R.target.checked),O.classList.toggle("border-indigo-100",R.target.checked),O.classList.toggle("border-transparent",!R.target.checked)})})),k();const T=e.querySelector("#servicePhotoInput"),$=e.querySelector("#servicePhotoButton"),L=e.querySelector("#servicePhotoContainer"),q=e.querySelector("#servicePhotoPreview"),N=e.querySelector("#servicePhotoBase64"),E=()=>T.click();$&&$.addEventListener("click",E),L&&L.addEventListener("click",E),T.onchange=async()=>{const D=T.files[0];if(D){q.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const R=await fa(D,800,800,.8);if(R.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");q.src=R,N.value=R}catch(R){f("Erro de Imagem",R.message,"error"),q.src=p,N.value=t?.photo||""}}};const I=e.querySelector("#serviceForm");e.onclick=async D=>{const R=D.target.closest("button[data-action]");if(!R)return;const O=R.dataset.action,U=R.dataset.id;if(O==="close-modal"&&(e.style.display="none"),O==="save-service"&&I.reportValidity()&&bl({target:I}),O==="delete-service"){if(!U)return;if(await Y("Apagar Serviço","Tem certeza que deseja excluir este serviço da rede?"))try{const K=_.services.find(ye=>ye.id===U)?.name||"Desconhecido";await Ao(U),oe(m.establishmentId,ot(),"Serviços","Excluiu",`Excluiu o serviço: ${K}`),f("Sucesso","Serviço apagado da rede.","success"),e.style.display="none",await Ne()}catch(K){f("Erro",`Não foi possível apagar o serviço: ${K.message}`,"error")}}}}function gl(){Y("Excluir em Lote",`Tem certeza que deseja excluir ${_.selectedIds.size} serviços da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{const e=Array.from(_.selectedIds).map(a=>Ao(a));await Promise.all(e),oe(m.establishmentId,ot(),"Serviços","Excluiu em Lote",`Excluiu ${_.selectedIds.size} serviços`),f("Sucesso",`${_.selectedIds.size} serviços foram excluídos.`,"success"),_.selectedIds.clear(),Ga(),Ne()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}const La="suppliers",Bt=async t=>{try{const e=bo(ga(me,La),mo("establishmentId","==",t)),a=await Rr(e),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},fl=async t=>{try{return{id:(await po(ga(me,La),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},xl=async(t,e)=>{try{const a=Ae(me,La,t);return await Tt(a,e),{id:t,...e}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},hl=async t=>{try{const e=Ae(me,La,t);return await Fr(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},vt=document.getElementById("content");let A={products:[],categories:[],suppliers:[],hierarchyCache:[],currentTab:"catalogo",stockFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set},Ft=null;function Oe(){const t=he.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function hs(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}function Ba(t){return t?t._seconds?new Date(t._seconds*1e3):t.seconds?new Date(t.seconds*1e3):new Date(t):new Date}async function vl(){A.selectedIds.clear(),A.currentTab="catalogo";try{const t=await ve();A.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}vs(),wl(),await Te()}function vs(){vt.innerHTML=`
        <section class="h-full flex flex-col p-2 md:p-4 md:pl-6 w-full relative">
    ...
    `,yl()}function yl(){const t=document.getElementById("main-tab-content");if(t){if(A.currentTab==="catalogo")t.innerHTML=`
        ...
        `,Ko(),Xe();else if(A.currentTab==="movimentacoes"){const e=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0],r=(A.products||[]).map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join(""),o=(A.categories||[]).map(i=>`<option value="${i.id}">${h(i.name)}</option>`).join("");t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",Xa),Xa()}}}function wl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Te),t.addEventListener("click",()=>{setTimeout(Te,100)})),Ft&&vt.removeEventListener("click",Ft),Ft=e=>{const a=e.target.closest("[data-main-tab]");if(a){A.currentTab=a.dataset.mainTab,vs();return}if(e.target.classList.contains("status-filter-btn")){const d=e.target.dataset.status;A.stockFilter=d,document.querySelectorAll(".status-filter-btn").forEach(u=>{u.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-green-50","text-green-700","border-green-200","bg-orange-50","text-orange-700","border-orange-200","bg-red-50","text-red-700","border-red-200"),u.classList.add("bg-white","text-gray-600","border-gray-200")}),d==="ok"?e.target.classList.add("bg-green-50","text-green-700","border-green-200"):d==="alert"?e.target.classList.add("bg-orange-50","text-orange-700","border-orange-200"):d==="empty"?e.target.classList.add("bg-red-50","text-red-700","border-red-200"):e.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),e.target.classList.remove("bg-white","text-gray-600","border-gray-200"),Xe();return}const s=e.target.closest('[data-action="open-product-modal"]');if(s){e.preventDefault();let d={};if(s.dataset.product)try{d=JSON.parse(s.dataset.product)}catch{}Dl(d);return}if(e.target.closest('[data-action="manage-categories"]')){e.preventDefault(),Il();return}if(e.target.closest('[data-action="open-new-movement-modal"]')){e.preventDefault(),tr();return}const i=e.target.closest(".product-checkbox");if(i){const d=i.dataset.id;i.checked?A.selectedIds.add(d):A.selectedIds.delete(d),Ya(),e.stopPropagation();return}if(e.target.closest("#cancel-selection-btn")){A.selectedIds.clear(),document.querySelectorAll(".product-checkbox").forEach(d=>d.checked=!1),Ya();return}if(e.target.closest("#batch-delete-btn")){Pl();return}},vt.addEventListener("click",Ft),vt.addEventListener("input",e=>{e.target.id==="searchInput"&&(A.searchQuery=e.target.value.toLowerCase(),Xe())}),vt.addEventListener("click",e=>{const a=e.target.closest("#toggle-filter-btn");if(a){const o=document.getElementById("filter-panel");A.isAdvancedFilterOpen=!A.isAdvancedFilterOpen,A.isAdvancedFilterOpen?(o.classList.remove("hidden"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-gray-600","border-gray-200"))}e.target.closest("#clear-filters-btn")&&(A.filterCategoryId="all",document.getElementById("filterCategoryId").value="all",Xe()),e.target.closest("#apply-filter-btn")&&(A.filterCategoryId=document.getElementById("filterCategoryId").value,document.getElementById("toggle-filter-btn").click(),Xe())})}async function Te(){const t=hs();try{const e=t.map(n=>pt(n)),a=t.map(n=>Ia(n,"products")),[s,r]=await Promise.all([Promise.all(e),Promise.all(a)]),o=new Map;s.flat().filter(Boolean).forEach(n=>o.set(n.id,n)),A.products=Array.from(o.values()),m.products=A.products;const i=new Map;r.flat().filter(Boolean).forEach(n=>i.set(n.id,n)),A.categories=Array.from(i.values()),m.categories=A.categories,A.currentTab==="catalogo"?(Ko(),Xe()):A.currentTab==="movimentacoes"&&Xa(),A.suppliers=[],t.forEach(async n=>{try{let l=[];typeof Bt=="function"&&(l=await Bt(n)),l.forEach(d=>{A.suppliers.find(u=>u.id===d.id)||A.suppliers.push(d)}),m.suppliers=A.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function Ko(){const t=document.getElementById("filterCategoryId");t&&A.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',A.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),A.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function Ya(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=A.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function kl(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,r=0,o=0;t.forEach(i=>{const n=i.currentStock||0,l=i.minStock||0;n<=0?o++:l>0&&n<=l||l>0&&n<=l*1.2?r++:s++}),e.innerHTML=`
        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
    ...
    `}function Xe(){const t=document.getElementById("productsList");if(!t)return;if(!A.products||A.products.length===0){t.innerHTML=er(8);return}const e=hs(),a=A.products.filter(s=>{const r=s.name.toLowerCase().includes(A.searchQuery),o=s.currentStock||0,i=s.minStock||0;let n=!0;A.stockFilter==="ok"&&(n=o>0&&(i===0||o>i*1.2)),A.stockFilter==="alert"&&(n=i>0&&o>0&&o<=i*1.2),A.stockFilter==="empty"&&(n=o<=0);const l=A.filterCategoryId==="all"||s.categoryId===A.filterCategoryId,d=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],u=e.some(c=>d.includes(c));return r&&n&&l&&u});kl(a),t.innerHTML=Sl(a)}function er(t=8){let e="";for(let a=0;a<t;a++)e+=`
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm flex items-center p-3 animate-pulse h-[74px]">
        ...
        `;return e}function Sl(t){if(t.length===0)return`
            <div class="col-span-full flex flex-col items-center justify-center py-16">
                <div class="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center mb-3">
        ...
        `;const e=new Map((A.categories||[]).map(a=>[a.id,a.name]));return t.map(a=>{const s=h(a.name),r=h(e.get(a.categoryId)||"Sem Categoria"),o=a.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(a.name.charAt(0))}`,i=JSON.stringify(a).replace(/'/g,"&apos;"),n=a.accessibleIn?a.accessibleIn.length:1,l=A.selectedIds.has(a.id),d=a.price!==void 0?parseFloat(a.price).toFixed(2):"0.00",u=a.currentStock||0,c=a.minStock||0;let p="bg-emerald-500",b=!1;return u<=0?(p="bg-red-500",b=!0):c>0&&u<=c*1.2&&(p="bg-orange-500"),`
            ...
            </div>`}).join("")}async function $l(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const r=e.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="...";try{const o=A.hierarchyCache.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);o.length===0&&o.push(m.establishmentId),await Go({establishmentId:m.establishmentId,name:s,accessibleIn:o},"products"),oe(m.establishmentId,Oe(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await ys(),await Te()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{r.disabled=!1,r.textContent="Adicionar"}}async function El(t){if(await Y("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Yo(t,"products"),oe(m.establishmentId,Oe(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await ys(),await Te()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function ys(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await Ia(m.establishmentId,"products");A.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded mb-1">
                    <span class="text-sm font-medium text-gray-700">${h(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-xs bg-red-50 px-2 py-1 rounded">Apagar</button>
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500 text-sm">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center text-sm">Erro ao carregar categorias.</p>'}}}function Il(){Be({title:"Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4 bg-indigo-50 p-4 rounded-xl border border-indigo-100">
    ...
    `,maxWidth:"max-w-lg"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",$l),e.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&(s.preventDefault(),El(r.dataset.id))}))}ys()}function tr(){const t=(A.products||[]).map(o=>`<option value="${o.id}">${h(o.name)} (Estoque: ${o.currentStock||0})</option>`).join(""),a=`
    ...
    `;Be({title:"Lançar Movimentação",contentHTML:a,maxWidth:"max-w-lg"});const s=document.getElementById("movEstablishmentId");s&&(s.value=m.establishmentId);const r=document.getElementById("newMovementForm");r.onsubmit=async o=>{o.preventDefault();const i=r.querySelector('button[type="submit"]'),n=i.innerHTML,l=document.getElementById("movProductId")?.value,d=document.getElementById("movEstablishmentId")?.value,u=r.querySelector('input[name="movType"]:checked')?.value,c=parseInt(document.getElementById("movAmount")?.value,10),p=document.getElementById("movReason")?.value.trim();if(!l||!c||c<=0||!p||!d){f("Erro","Preencha todos os campos corretamente.","warning");return}const b=u==="in"?c:-c;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Salvando...';try{await _o(l,{change:b,reason:p,establishmentId:d});const g=A.products.find(v=>v.id===l)?.name||"Produto";oe(d,Oe(),"Estoque","Ajuste Manual",`Lançou movimentação (${b>0?"+":""}${b}) para ${g}`),f("Sucesso","Movimentação registrada com sucesso!","success"),document.getElementById("genericModal").style.display="none",await Te()}catch(g){f("Erro",g.message,"error"),i.disabled=!1,i.innerHTML=n}}}function Ll(t=[]){if(!A.hierarchyCache||A.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Exclusivo desta unidade.
        ...
        <div class="modal-content max-w-4xl p-0 overflow-hidden flex flex-col max-h-[90vh]"> 
            ...
            <form id="productForm" class="flex-1 flex flex-col overflow-hidden">
                ...
                `).join("")):(E.classList.remove("hidden"),E.innerHTML='<div class="p-4 text-sm text-gray-500 text-center">Fornecedor não encontrado.</div>')}else E.classList.add("hidden");v.size>0?(I.classList.remove("justify-center"),I.classList.add("justify-start"),I.innerHTML="",v.forEach(O=>{const U=R.find(Z=>Z.id===O);U&&(I.innerHTML+=`
                    ...
                    `)})):(I.classList.add("justify-center"),I.classList.remove("justify-start"),I.innerHTML='<p class="text-xs text-gray-400 text-center">Nenhum fornecedor adicionado ainda.</p>')};document.getElementById("modalSupplierSearch")?.addEventListener("input",y),y();const k=document.getElementById("productPhotoInput"),P=document.getElementById("productPhotoButton"),T=document.getElementById("productPhotoContainer"),$=document.getElementById("productPhotoPreview"),L=document.getElementById("productPhotoBase64"),q=()=>k?.click();P&&P.addEventListener("click",q),T&&T.addEventListener("click",q),k&&(k.onchange=async()=>{const N=k.files[0];if(!N)return;const E=$.src;$.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const I=await fa(N,800,800,.8);if(I.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");$.src=I,L.value=I}catch(I){f("Erro de Imagem",I.message,"error"),$.src=E,L.value=t?.photo||""}}),e.onclick=async N=>{const E=N.target.closest("[data-add-supplier]");if(E){v.add(E.dataset.addSupplier);const U=document.getElementById("modalSupplierSearch");U&&(U.value=""),y();return}const I=N.target.closest("[data-remove-supplier]");if(I){v.delete(I.dataset.removeSupplier),y();return}const D=N.target.closest("button[data-action]");if(!D)return;const R=D.dataset.action,O=D.dataset.id;if(R==="close-modal"&&(e.style.display="none"),R==="delete-product"){if(!O)return;if(await Y("Apagar Produto","Tem certeza que deseja excluir este produto do catálogo?"))try{const Z=A.products.find(K=>K.id===O)?.name||"Desconhecido";await ms(O),oe(m.establishmentId,Oe(),"Produtos","Excluiu",`Excluiu o produto: ${Z}`),f("Sucesso","Produto apagado.","success"),e.style.display="none",await Te()}catch(Z){f("Erro",`Não foi possível apagar: ${Z.message}`,"error")}}R==="open-new-movement-modal"&&(e.style.display="none",A.currentTab="movimentacoes",vs(),tr())}}function Pl(){Y("Excluir em Lote",`Tem certeza que deseja excluir ${A.selectedIds.size} produtos da rede?`).then(async t=>{if(t)try{const e=Array.from(A.selectedIds).map(a=>ms(a));await Promise.all(e),oe(m.establishmentId,Oe(),"Produtos","Excluiu em Lote",`Excluiu ${A.selectedIds.size} produtos`),f("Sucesso",`${A.selectedIds.size} produtos foram excluídos.`,"success"),A.selectedIds.clear(),Ya(),Te()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}async function Xa(){const t=document.getElementById("report-results");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full"><div class="loader"></div></div>';const e={startDate:document.getElementById("reportStartDate")?.value||"",endDate:document.getElementById("reportEndDate")?.value||"",productId:document.getElementById("productFilterReport")?.value||"all",categoryId:document.getElementById("categoryFilterReport")?.value||"all"};try{const s=hs().map(n=>Uo({...e,establishmentId:n}).catch(l=>[])),r=await Promise.all(s);let o=[];if(r.forEach(n=>{if(!n)return;const l=Array.isArray(n)?n:Array.isArray(n.data)?n.data:Array.isArray(n.movements)?n.movements:[];o=o.concat(l)}),o.sort((n,l)=>Ba(l.date)-Ba(n.date)),o.length===0){t.innerHTML=`
                <div class="flex items-center justify-center h-full p-8 text-center">
                    <div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ${o.map(n=>{const l=n.change>0,d=l?"text-emerald-600 bg-emerald-50":"text-red-600 bg-red-50",u=l?'<i class="bi bi-arrow-down-left"></i>':'<i class="bi bi-arrow-up-right"></i>';return`
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 whitespace-nowrap text-gray-500 text-xs">${Ba(n.date).toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}</td>
    ...
    `}function Ml(){const t=Object.entries(na).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=ar.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Al(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(na).map(([i,n])=>`<option value="${i}" ${a===i?"selected":""}>${n.label}</option>`).join(""),r=ar.map(i=>`<option value="${i}" ${t?.state===i?"selected":""}>${i}</option>`).join(""),o=document.getElementById("form-container-wrapper");o&&(o.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",jl))}function sr(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
    ...
    `,s='<div class="flex flex-col gap-2 md:hidden p-2">';e.forEach(r=>{let o=r.category;o==="Produtos"&&(o="estoque"),o==="Serviços"&&(o="servicos");const i=na[o]||na.outros,n=r.document||r.taxId?r.document||r.taxId:"-",l=JSON.stringify(r).replace(/'/g,"&apos;"),d=[r.city,r.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",s+="</div>",t.innerHTML=a+s}function kt(t,e=null){const a=document.getElementById("suppliers-list-view"),s=document.getElementById("suppliers-form-view");J.viewMode=t,J.editingItem=e,t==="list"?(a.classList.remove("hidden"),a.classList.add("flex"),s.classList.add("hidden"),s.innerHTML='<div id="form-container-wrapper" class="max-w-4xl mx-auto w-full"></div>',J.hasSearched&&or(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),a.classList.remove("flex"),s.classList.remove("hidden"),Al(e),window.scrollTo({top:0,behavior:"smooth"}))}async function jl(t){t.preventDefault();const e=t.target,a=e.querySelector("#supId").value,s={name:e.querySelector("#supName").value,contactName:e.querySelector("#supContact").value,email:e.querySelector("#supEmail").value,phone:e.querySelector("#supPhone").value,document:e.querySelector("#supTaxId").value,category:e.querySelector("#supCategory").value,state:e.querySelector("#supState").value,city:e.querySelector("#supCity").value,establishmentId:m.establishmentId,notes:e.querySelector("#supNotes")?.value||"",accessibleIn:[m.establishmentId]},r=e.querySelector('button[type="submit"]'),o=r.innerHTML;r.disabled=!0,r.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await xl(a,s),f("Sucesso","Ficha atualizada!","success")):(await fl(s),f("Sucesso","Parceiro registado!","success")),J.hasSearched&&(J.partners=await Bt(m.establishmentId)||[]),kt("list")}catch(i){f("Erro","Falha ao gravar: "+i.message,"error"),r.disabled=!1,r.innerHTML=o}}async function Nl(t){if(await Y("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente?"))try{await hl(t),f("Sucesso","Entidade excluída.","success"),J.partners=J.partners.filter(a=>a.id!==t),kt("list")}catch(a){f("Erro","Erro ao excluir: "+a.message,"error")}}function Rl(){Ht&&Zt.removeEventListener("click",Ht),Ht=async t=>{const e=t.target;if(e.closest('button[data-action="new-partner"]')){kt("form",null);return}if(e.closest("#btn-search-partners")){J.searchQuery=document.getElementById("filterSearch").value,J.categoryFilter=document.getElementById("filterCategory").value,J.stateFilter=document.getElementById("filterState").value,J.cityFilter=document.getElementById("filterCity").value,J.sortBy=document.getElementById("filterSortBy").value,J.hasSearched=!0,ql();return}if(e.closest('button[data-action="back-to-list"]')){kt("list");return}const a=e.closest('button[data-action="delete-partner"]');if(a){t.preventDefault(),Nl(a.dataset.id);return}const s=e.closest('[data-action="open-form"]');if(s&&!e.closest("button")){const r=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));kt("form",r)}},Zt.addEventListener("click",Ht),Zt.addEventListener("keypress",t=>{t.key==="Enter"&&(t.target.id==="filterSearch"||t.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const Za=document.getElementById("content"),zs={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let V={professionals:[],services:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterServiceId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,viewMode:"list",tempProf:null},Ot=null,zt=null;function Kt(){const t=he.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function rr(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}function Fl(){const t=document.getElementById("professionals-layout-main"),e=document.getElementById("professionals-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.add("mobile-detail-open"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&(a.style.display="none")}function Ma(){const t=document.getElementById("professionals-layout-main"),e=document.getElementById("professionals-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&t.classList.remove("mobile-detail-open"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&(a.style.display=""),V.viewMode="list"}async function Hl(){V.selectedIds.clear(),V.viewMode="list";try{const t=await ve();V.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}ir(),Gl(),await la()}function ir(){Za.innerHTML=`
    ...
    `}async function la(){const t=document.getElementById("professionalsList"),e=rr();try{const a=e.map(l=>$e(l)),s=e.map(l=>ut(l)),r=await Promise.all(a),o=await Promise.all(s),i=new Map;r.flat().forEach(l=>i.set(l.id,l)),V.professionals=Array.from(i.values()),m.professionals=V.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),V.services=Array.from(n.values()),nr(),Qe()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function nr(){const t=document.getElementById("filterServiceId");t&&V.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',V.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=h(e.name),V.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function lr(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=V.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Ol(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,r=a-s;e.innerHTML=`
    ...
    `}function Qe(){const t=document.getElementById("professionalsList");if(!t)return;if(!V.professionals||V.professionals.length===0){t.innerHTML=dr(8);return}const e=rr(),a=V.professionals.filter(s=>{const r=s.name.toLowerCase().includes(V.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(V.searchQuery);let o=!0;V.statusFilter==="active"&&(o=s.status!=="inactive"),V.statusFilter==="inactive"&&(o=s.status==="inactive");const i=V.filterServiceId==="all"||s.services&&s.services.includes(V.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],l=e.some(d=>n.includes(d));return r&&o&&i&&l});if(Ol(a),a.length===0){t.innerHTML=`
    ...
    `,Vl(a,V.services),Ul(a),await Jl(a,V.professionals),Ql(a),Fl()}function Vl(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const r=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,b=p==r[1]?"selected":"",g=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${g.charAt(0).toUpperCase()+g.slice(1)}</option>`}).join(""),i=h(t.name||""),n=h(t.specialty||""),l=h(t.phone||""),d=h(t.notes||"");a.innerHTML=`
    ...
    `}function _l(t=[]){if(!V.hierarchyCache||V.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(r=>{const o=t.includes(r.id)||t.length===0&&r.id===m.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function Ul(t){const e=document.getElementById("jornada");e&&(e.innerHTML=`
        <div class="max-w-4xl mx-auto bg-white p-4 md:p-6 rounded-2xl border border-slate-200 shadow-sm">
        ...
        </div>`,Wl(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function Wl(t,e){t.innerHTML=Object.keys(zs).map(a=>{const s=e[a]||{},r=s.active!==!1;return`
            ...
            </div>`}).join(""),t.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",s=>{const r=s.target.closest(".day-schedule-card"),o=!s.target.checked;r.classList.toggle("bg-white",!o),r.classList.toggle("shadow-sm",!o),r.classList.toggle("border-slate-200",!o),r.classList.toggle("bg-slate-50",o),r.classList.toggle("border-slate-100",o),r.classList.toggle("opacity-60",o),r.classList.toggle("disabled",o),r.querySelectorAll(".time-inputs input").forEach(i=>i.disabled=o)})})}async function Jl(t,e){const a=document.getElementById("bloqueios");if(!a)return;a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-[10px] font-bold text-red-500 p-4 bg-red-50 rounded-xl border border-red-100">${s.message}</p>`}}}function Ql(t){const e=document.getElementById("professionals-layout-detail");if(!e)return;const a=e.querySelectorAll(".tab-link");a.forEach(p=>{p.addEventListener("click",b=>{b.preventDefault(),a.forEach(y=>{y.classList.remove("active","border-indigo-600","text-indigo-600"),y.classList.add("border-transparent","text-slate-500")}),p.classList.add("active","border-indigo-600","text-indigo-600"),p.classList.remove("border-transparent","text-slate-500"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.add("hidden"));const g=p.dataset.tab,v=e.querySelector("#"+g);v&&v.classList.remove("hidden")})});const s=e.querySelector("#profPhotoInput"),r=e.querySelector("#profPhotoButton"),o=e.querySelector("#profPhotoContainer"),i=e.querySelector("#profPhotoPreview"),n=e.querySelector("#profPhotoBase64"),l=t.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,d=t.photo||"",u=()=>s.click();r&&r.addEventListener("click",u),o&&o.addEventListener("click",u),s&&(s.onchange=async()=>{const p=s.files[0];if(p){i.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const b=await fa(p,800,800,.8);if(b.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");i.src=b,n.value=b}catch(b){f("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),i.src=l,n.value=d,s.value=""}}});const c=e.querySelector("#selectAllServicesBtn");if(c){c.addEventListener("click",()=>{const b=e.querySelectorAll('#profServicesContainer input[type="checkbox"]'),g=Array.from(b).every(v=>v.checked);b.forEach(v=>{v.checked=!g}),c.textContent=g?"Selecionar Todos":"Desmarcar Todos"});const p=e.querySelectorAll('#profServicesContainer input[type="checkbox"]');p.length>0&&Array.from(p).every(b=>b.checked)&&(c.textContent="Desmarcar Todos")}}function Gl(){Ot&&document.body.removeEventListener("click",Ot),zt&&Za.removeEventListener("input",zt),Ot=async t=>{if(t.target.classList.contains("professional-checkbox")){const o=t.target.dataset.id;t.target.checked?V.selectedIds.add(o):V.selectedIds.delete(o),lr(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){V.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600"),Qe();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterServiceId").value="all",V.filterServiceId="all",Qe();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),V.filterServiceId=document.getElementById("filterServiceId").value,Qe();return}if(t.target.closest("#toggle-filter-btn")){t.preventDefault(),V.isAdvancedFilterOpen=!V.isAdvancedFilterOpen,ir(),document.getElementById("searchInput").value=V.searchQuery,nr(),Qe();return}const s=t.target.closest("[data-action]");if(!s)return;const r=s.dataset.action;switch(["close-detail-screen","delete-professional","save-professional","delete-blockage","batch-delete-blockage"].includes(r)&&t.stopPropagation(),r){case"open-professional-editor":zl(s.dataset.id);break;case"close-detail-screen":Ma(),V.tempProf=null;break;case"batch-delete":Yl();break;case"delete-professional":{const o=s.dataset.id,i=V.tempProf?.name||"Profissional";if(await Y("Excluir Profissional",`Tem certeza que deseja excluir ${i}? Esta ação não pode ser desfeita.`))try{await fo(o),oe(m.establishmentId,Kt(),"Equipe","Excluiu",`Excluiu profissional: ${i}`),f("Sucesso!","Profissional excluído da rede.","success"),Ma(),la()}catch(l){f("Erro",`Não foi possível excluir: ${l.message}`,"error")}break}case"save-professional":{const o=document.getElementById("professionals-layout-detail"),i=s,n=o.querySelector("#profScheduleContainer"),l=Array.from(o.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map(k=>k.value),d={};n&&n.querySelectorAll(".day-schedule-card").forEach(k=>{const P=k.querySelector('[data-field="active"]').dataset.day;d[P]={active:k.querySelector('[data-field="active"]').checked,start:k.querySelector('[data-field="start"]').value,end:k.querySelector('[data-field="end"]').value,breakStart:k.querySelector('[data-field="breakStart"]').value,breakEnd:k.querySelector('[data-field="breakEnd"]').value}});const u=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(k=>k.value),c=u.length>0?u:[m.establishmentId],p=o.querySelector("#profStatusToggle").checked,b=o.querySelector("#profCommissionToggle").checked,g=o.querySelector("#profShowOnAgendaToggle").checked,v={...V.tempProf,id:o.querySelector("#professionalId").value||void 0,accessibleIn:c,name:o.querySelector("#profName").value.trim(),specialty:o.querySelector("#profSpecialty").value,photo:o.querySelector("#profPhotoBase64").value,services:l,workingHours:d,phone:o.querySelector("#profPhone").value,dob:`${o.querySelector("#profDobDay").value}/${o.querySelector("#profDobMonth").value}`,receivesCommission:b,showOnAgenda:g,orderOnAgenda:parseInt(o.querySelector("#profOrderOnAgenda").value)||1,notes:o.querySelector("#profNotes").value,status:p?"active":"inactive",establishmentId:m.establishmentId},y=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{v.id?(await Fa(v.id,v),oe(m.establishmentId,Kt(),"Equipe","Editou",`Editou o profissional: ${v.name}`),f("Sucesso!","Dados atualizados.","success")):(delete v.id,await di(v),oe(m.establishmentId,Kt(),"Equipe","Criou",`Cadastrou o profissional: ${v.name}`),f("Sucesso!","Novo membro adicionado à equipe.","success")),Ma(),la()}catch(k){f("Erro",k.message,"error"),i.disabled=!1,i.innerHTML=y}break}case"delete-blockage":{const o=s.dataset.id;if(await Y("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await us(o),f("Bloqueio removido.","success");const i=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";St(V.tempProf.id,i)}catch(i){f("Erro",i.message,"error")}break}case"batch-delete-blockage":{const o=JSON.parse(s.dataset.ids);if(await Y("Apagar em Lote",`Tem certeza que deseja apagar ${o.length} dias de bloqueio de uma vez?`))try{await qo(o),f("Bloqueios removidos.","success");const i=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";St(V.tempProf.id,i)}catch(i){f("Erro",i.message,"error")}break}}},document.body.addEventListener("click",Ot),zt=t=>{t.target.id==="searchInput"&&(V.searchQuery=t.target.value,Qe())},Za.addEventListener("input",zt)}function Yl(){Y("Excluir em Lote",`Tem certeza que deseja excluir ${V.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await ci(Array.from(V.selectedIds)),oe(m.establishmentId,Kt(),"Equipe","Excluiu em Lote",`Excluiu ${V.selectedIds.size} profissionais`),f("Sucesso!",`${V.selectedIds.size} profissionais foram excluídos.`,"success"),V.selectedIds.clear(),lr(),la()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}let w={clients:[],selectedClient:null,activeTab:"profile",establishments:[],filterEstablishmentIds:new Set,filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},da=null,Vt=null;const cr=t=>t?String(t).replace(/\D/g,""):"",Ka=t=>{if(!t)return"Nunca";let e;if(typeof t=="object"&&(t.seconds||t._seconds)){const a=t.seconds||t._seconds;e=new Date(a*1e3)}else e=new Date(t);return isNaN(e.getTime())?"Data Inválida":e.toLocaleDateString("pt-BR")},es=t=>{if(!t)return"CL";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()};async function Xl(){da=document.getElementById("content"),w.selectedClient=null,w.historyLimit=20,w.modalOpen=!1,w.selectedIds.clear(),w.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},w.sortConfig={key:"name",direction:"asc"};try{const e=(await ve().catch(()=>({matrizes:[]}))).matrizes||[];w.establishments=[],e.forEach(a=>{w.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>w.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(m.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia",t)}Zl(),ed(),await ws()}function Zl(){const t=w.establishments.map(e=>`
    ...
    `}function Kl(){const t=document.getElementById("table-header-container");if(!t)return;const e=a=>w.sortConfig.key!==a?'<i class="bi bi-arrow-down-up ml-1 opacity-40 text-xs"></i>':w.sortConfig.direction==="asc"?'<i class="bi bi-arrow-up ml-1 text-indigo-600"></i>':'<i class="bi bi-arrow-down ml-1 text-indigo-600"></i>';t.innerHTML=`
    ...
    `}async function ws(){w.loading=!0;const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-xs">Carregando clientes...</p></div>');try{const a=Array.from(w.filterEstablishmentIds).map(i=>{let n=`/api/clients/${i}?limit=1000`;return C(n).catch(()=>[])}),r=(await Promise.all(a)).flat(),o=new Map;r.forEach(i=>o.set(i.id,i)),w.clients=Array.from(o.values()),ks(),ke()}catch(e){console.error(e),f("Erro","Falha ao carregar clientes.","error"),t&&(t.innerHTML='<div class="text-center py-10 text-red-500 text-sm">Erro ao carregar dados.</div>')}finally{w.loading=!1}}function ks(){const t=new Date().getMonth()+1,e=new Date().getFullYear();let a=0,s=0,r=0;w.clients.forEach(o=>{if(o.totalDebt&&parseFloat(o.totalDebt)>0&&s++,o.dobMonth==t&&r++,o.createdAt){const i=new Date(o.createdAt);i.getMonth()+1===t&&i.getFullYear()===e&&a++}}),document.getElementById("kpi-total").textContent=w.clients.length,document.getElementById("kpi-novos").textContent=a,document.getElementById("kpi-devendo").textContent=s,document.getElementById("kpi-niver").textContent=r}function ke(){Kl();const t=document.getElementById("list-container");let e=w.clients;if(w.filters.search){const a=w.filters.search.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(w.filters.status==="devendo")e=e.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(w.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;e=e.filter(s=>s.dobMonth==a)}else if(w.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();e=e.filter(r=>{if(!r.createdAt)return!1;const o=new Date(r.createdAt);return o.getMonth()+1===a&&o.getFullYear()===s})}if(w.filters.hasLoyalty&&(e=e.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),w.filters.inactiveDays){const a=parseInt(w.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),e=e.filter(r=>{if(!r.lastVisit&&!r.createdAt)return!1;let o;if(r.lastVisit){const i=r.lastVisit.seconds||r.lastVisit._seconds;o=i?new Date(i*1e3):new Date(r.lastVisit)}else o=new Date(r.createdAt);return o<s})}if(e.sort((a,s)=>{let r,o;switch(w.sortConfig.key){case"name":return r=(a.name||"").toLowerCase(),o=(s.name||"").toLowerCase(),w.sortConfig.direction==="asc"?r.localeCompare(o):o.localeCompare(r);case"contact":return r=a.phone||"",o=s.phone||"",w.sortConfig.direction==="asc"?r.localeCompare(o):o.localeCompare(r);case"lastVisit":r=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,o=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":r=parseFloat(a.totalDebt)||0,o=parseFloat(s.totalDebt)||0;break;default:r=a.name,o=s.name}return r<o?w.sortConfig.direction==="asc"?-1:1:r>o?w.sortConfig.direction==="asc"?1:-1:0}),e.length===0){t.innerHTML=`
            ...
            </div>`;return}t.innerHTML=e.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,r=Ka(a.lastVisit),o=cr(a.phone),i=new Date().getMonth()+1,n=a.dobMonth==i,l=w.selectedIds.has(a.id);let d="";return n&&(d+='<span class="bg-indigo-50 text-indigo-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-indigo-100 uppercase tracking-wider">🎂 Niver</span> '),a.loyaltyPoints>0&&(d+=`<span class="bg-amber-50 text-amber-600 text-[8px] font-bold px-1.5 py-0.5 rounded border border-amber-100 uppercase tracking-wider"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
        ...
        `}).join("")}function ed(){Vt&&da.removeEventListener("click",Vt),Vt=o=>{const i=o.target;if(i.classList.contains("item-checkbox")){const u=i.value;i.checked?w.selectedIds.add(u):w.selectedIds.delete(u),ea(),o.stopPropagation();return}if(i.id==="select-all-toggle"){const u=i.checked,c=document.querySelectorAll(".item-checkbox");w.selectedIds.clear(),c.forEach(p=>{p.checked=u,u&&w.selectedIds.add(p.value)}),ea(),o.stopPropagation();return}const n=i.closest("[data-sort]");if(n){const u=n.dataset.sort;w.sortConfig.key===u?w.sortConfig.direction=w.sortConfig.direction==="asc"?"desc":"asc":(w.sortConfig.key=u,w.sortConfig.direction="asc"),ke();return}const l=i.closest("[data-action]");if(l){const u=l.dataset.action,c=l.dataset.id;if(u==="new-client"){ts(null);return}if(u==="open-modal"){ts(c);return}if(u==="whatsapp"){o.stopPropagation();const p=l.dataset.phone;window.open(`https://wa.me/55${p}`,"_blank");return}if(u==="export-excel"){cd();return}}const d=i.closest("[data-filter]");d&&(document.querySelectorAll("[data-filter]").forEach(u=>u.classList.remove("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300")),d.classList.add("ring-2","ring-offset-1","ring-indigo-400","border-indigo-300"),w.filters.status=d.dataset.filter,ke())},da.addEventListener("click",Vt);const t=document.getElementById("cancel-selection-btn");t&&t.addEventListener("click",()=>{w.selectedIds.clear();const o=document.getElementById("select-all-toggle");o&&(o.checked=!1),document.querySelectorAll(".item-checkbox").forEach(i=>i.checked=!1),ea()});const e=document.getElementById("batch-delete-btn");e&&e.addEventListener("click",td),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",i=>{const n=i.target.closest("label");i.target.checked?(w.filterEstablishmentIds.add(i.target.value),n.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.remove("border-gray-200","text-gray-600")):(w.filterEstablishmentIds.delete(i.target.value),n.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.add("border-gray-200","text-gray-600")),ws()})});const a=document.getElementById("search-input");a&&a.addEventListener("input",o=>{w.filters.search=o.target.value,ke()});const s=document.getElementById("filter-inactive");s&&s.addEventListener("input",o=>{w.filters.inactiveDays=o.target.value,ke()});const r=document.getElementById("filter-loyalty");r&&r.addEventListener("change",o=>{w.filters.hasLoyalty=o.target.checked,ke()})}function ea(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count");if(!t||!e)return;const a=w.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}async function td(){const t=w.selectedIds.size;if(!(t===0||!await Y("Excluir Clientes",`Deseja realmente excluir permanentemente ${t} cliente(s)? Esta ação não pode ser desfeita.`)))try{const a=Array.from(w.selectedIds).map(r=>Eo(r));await Promise.all(a),f("Sucesso",`${t} cliente(s) excluído(s) com sucesso.`,"success"),w.selectedIds.clear(),ea();const s=document.getElementById("select-all-toggle");s&&(s.checked=!1),await ws()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns clientes.","error")}}function ts(t=null){t?(w.selectedClient=w.clients.find(s=>s.id===t),w.selectedClient.isNew=!1):w.selectedClient={isNew:!0,id:"",name:"",phone:"",email:"",cpf:"",gender:"",dobDay:"",dobMonth:"",source:"",notes:"",loyaltyPoints:0,totalDebt:0},w.activeTab="profile",w.historyData={appointments:[],sales:[],loyaltyLog:[]};let e=document.getElementById("client-details-modal-overlay");e||(e=document.createElement("div"),e.id="client-details-modal-overlay",e.className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-gray-900/60 backdrop-blur-sm sm:p-4 animate-fade-in",e.innerHTML='<div class="bg-gray-50 w-full sm:w-[90vw] h-[90vh] sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col relative animate-slide-up sm:animate-scale-in rounded-t-2xl" id="client-modal-content"></div>',e.onclick=s=>{s.target===e&&$t()},document.body.appendChild(e),document.body.classList.add("overflow-hidden"));const a=e.querySelector("#client-modal-content");a.innerHTML=rt(w.selectedClient),it(a,w.selectedClient)}function $t(){const t=document.getElementById("client-details-modal-overlay");t&&t.remove(),document.body.classList.remove("overflow-hidden"),w.modalOpen=!1,w.selectedClient=null,ke()}function rt(t){const e=t.isNew,a=`
    ...
    `;let s="";return w.activeTab==="profile"?s=ad(t):w.activeTab==="appointments"?s=sd():w.activeTab==="history"?s=od():w.activeTab==="loyalty"&&(s=rd(t)),`
            ...
            <div class="bg-indigo-600 px-4 py-4 sm:px-6 sm:py-5 text-white relative flex-shrink-0 w-full shadow-md z-20">
                ...
                <div class="flex items-center gap-4 sm:gap-5">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white text-indigo-600 flex items-center justify-center text-2xl font-black shadow-lg flex-shrink-0">
                        ${e?'<i class="bi bi-person-plus-fill"></i>':es(t.name)}
                    </div>
    ...
    `}function sd(t){let e=w.historyData.appointments||[];return e.sort((a,s)=>new Date(s.startTime)-new Date(a.startTime)),`
        <div class="space-y-2">
    ...
    `}function od(t){let e=w.historyData.sales||[];e.sort((r,o)=>new Date(o.date)-new Date(r.date));const a=e.reduce((r,o)=>r+(Number(o.totalAmount)||0),0),s=e.length>0?a/e.length:0;return`
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-3 mb-2">
                <div class="bg-emerald-50 p-3 rounded-xl border border-emerald-100 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-emerald-700 mt-0.5">${Ca(a)}</span>
                </div>
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-lg font-black text-gray-800 mt-0.5">${Ca(s)}</span>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-3 flex justify-between items-center shadow-sm hover:bg-gray-50 cursor-pointer transition-colors" data-go-comanda="true" data-id="${r.id}">
                    ...
                    <div class="text-right">
                        <p class="font-black text-emerald-600 text-xs">${Ca(r.totalAmount)}</p>
    ...
    `}function rd(t){const e=w.historyData.loyaltyLog||[];return e.sort((a,s)=>new Date(s.date)-new Date(a.date)),`
        <div class="space-y-4">
    ...
    `}function it(t,e){if(t.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const r=s.dataset.tab;if(w.activeTab===r)return;w.activeTab=r;const o=document.getElementById("client-modal-content");o&&(o.innerHTML=rt(e),it(o,e)),r!=="profile"&&!w.historyLoading&&w.historyData.appointments.length===0&&await id(e.id)}}),w.activeTab==="profile"){const s=t.querySelector("#form-edit-client");s&&(s.onsubmit=nd);const r=t.querySelector("#btn-delete-client");r&&(r.onclick=ld)}if(w.activeTab==="loyalty"){const s=t.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>dd(e))}t.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=()=>{$t(),se("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),t.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=()=>{$t(),se("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const a=t.querySelector("#btn-close-modal");a&&(a.onclick=$t)}async function id(t){const e=w.selectedClient;if(!e||!e.phone)return;w.historyLoading=!0;const a=document.getElementById("client-modal-content");a&&(a.innerHTML=rt(e),it(a,e));try{const s=new Date;s.setMonth(s.getMonth()+12);const r=new Date;r.setFullYear(r.getFullYear()-5);let o=`/api/appointments/${m.establishmentId}?startDate=${r.toISOString()}&endDate=${s.toISOString()}&clientPhone=${encodeURIComponent(cr(e.phone))}&limit=50`;const i=await C(o);w.historyData.appointments=i,w.historyData.sales=i.filter(l=>l.status==="completed").map(l=>({id:l.id,date:l.startTime,totalAmount:l.totalAmount||0,items:l.comandaItems||l.services||[]}));const n=[];i.forEach(l=>{l.status==="completed"&&l.loyaltyPointsEarned>0&&n.push({type:"earn",points:l.loyaltyPointsEarned,date:l.startTime,description:"Venda finalizada"}),l.loyaltyRedemption&&n.push({type:"redemption",points:l.loyaltyRedemption.cost||0,date:l.startTime,description:`Resgate: ${l.loyaltyRedemption.name}`})}),w.historyData.loyaltyLog=n}catch(s){console.error("Erro histórico",s)}finally{w.historyLoading=!1;const s=document.getElementById("client-modal-content");s&&w.selectedClient&&(s.innerHTML=rt(w.selectedClient),it(s,w.selectedClient))}}async function nd(t){t.preventDefault();const e=new FormData(t.target),a=Object.fromEntries(e.entries());a.establishmentId=m.establishmentId,a.dobDay&&(a.dobDay=parseInt(a.dobDay)),a.dobMonth&&(a.dobMonth=parseInt(a.dobMonth));try{if(w.selectedClient.isNew){const s=await So(a);w.clients.unshift(s),f("Sucesso","Cliente cadastrado com sucesso!","success"),w.selectedClient=s,ts(s.id)}else{await $o(w.selectedClient.id,a),Object.assign(w.selectedClient,a);const s=w.clients.findIndex(o=>o.id===w.selectedClient.id);s!==-1&&(w.clients[s]=w.selectedClient),f("Sucesso","Dados salvos com sucesso!","success");const r=document.getElementById("client-modal-content");r&&(r.innerHTML=rt(w.selectedClient),it(r,w.selectedClient))}ks(),ke()}catch(s){f("Erro",s.message,"error")}}async function ld(){if(await Y("Excluir Cliente","Tem certeza? O histórico será apagado e não pode ser desfeito."))try{await Eo(w.selectedClient.id),w.clients=w.clients.filter(t=>t.id!==w.selectedClient.id),w.selectedClient=null,f("Sucesso","Cliente removido com sucesso.","success"),$t(),ks(),ke()}catch(t){f("Erro",t.message,"error")}}function dd(t){const e=t.loyaltyPoints||0,a=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const u={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,cnpj:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};bt(u,d)})}function pd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const s=e.querySelector("#newPassword").value,r=e.querySelector("#confirmPassword").value;if(s!==r){f("Erro","As senhas não coincidem.","error");return}const o=e.querySelector('button[form="change-password-form"]');o.disabled=!0,o.textContent="A Salvar...";try{const i=he.currentUser;if(i)await Tr(i,s),f("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum utilizador logado encontrado.")}catch(i){f("Erro",`Não foi possível alterar a senha: ${i.message}`,"error")}finally{o.disabled=!1,o.textContent="Salvar Nova Senha"}})}function bd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const v=e.querySelector("#mockup-screen-wrapper"),y=e.querySelector("#mockup-screen"),k=e.querySelector("#previewPrimaryColorInput"),P=e.querySelector("#previewBgColorInput"),T=e.querySelector("#previewTextColorInput"),$=e.querySelector("#previewTitleColorInput"),L=e.querySelector("#typographyInput"),q=e.querySelector("#establishmentWelcomeMessage"),N=e.querySelector("#mockup-welcome"),E=e.querySelector("#socialInstagram"),I=e.querySelector("#socialWhatsapp"),D=e.querySelector("#socialFacebook"),R=e.querySelector("#prevTemplate"),O=e.querySelector("#nextTemplate"),U=e.querySelector("#templateNameDisplay"),Z=e.querySelector("#selectedTemplateId"),K=W=>{const Q=ie[W];v.style.opacity="0.3",v.style.transform="scale(0.96)",setTimeout(()=>{k.value=Q.primary,P.value=Q.bg,T.value=Q.text,$.value=Q.titleColor||Q.text,L.value=Q.font,e.querySelectorAll('input[name="buttonStyle"]').forEach(be=>{be.checked=be.value===Q.btn}),Z.value=Q.id,U.textContent=Q.name,y.style.setProperty("--preview-primary",Q.primary),y.style.setProperty("--preview-bg",Q.bg),y.style.setProperty("--preview-text",Q.text),y.style.setProperty("--preview-title-color",Q.titleColor||Q.text),y.style.setProperty("--preview-font",Q.font),y.style.setProperty("--preview-btn-radius",g(Q.btn)),y.style.setProperty("--preview-card-bg",Q.cardBg),y.style.setProperty("--preview-card-border",Q.cardBorder),v.style.opacity="1",v.style.transform="scale(1)"},300)};R.addEventListener("click",()=>{b=(b-1+ie.length)%ie.length,K(b)}),O.addEventListener("click",()=>{b=(b+1)%ie.length,K(b)}),k.addEventListener("input",W=>y.style.setProperty("--preview-primary",W.target.value)),P.addEventListener("input",W=>y.style.setProperty("--preview-bg",W.target.value)),T.addEventListener("input",W=>y.style.setProperty("--preview-text",W.target.value)),$.addEventListener("input",W=>y.style.setProperty("--preview-title-color",W.target.value)),L.addEventListener("change",W=>y.style.setProperty("--preview-font",W.target.value)),e.querySelectorAll('input[name="buttonStyle"]').forEach(W=>{W.addEventListener("change",Q=>{Q.target.checked&&y.style.setProperty("--preview-btn-radius",g(Q.target.value))})}),q.addEventListener("input",W=>N.textContent=W.target.value||"Mensagem...");const ye=()=>{e.querySelector("#mockup-insta-icon").classList.toggle("hidden",!E.value.trim()),e.querySelector("#mockup-whats-icon").classList.toggle("hidden",!I.value.trim()),e.querySelector("#mockup-face-icon").classList.toggle("hidden",!D.value.trim())};[E,I,D].forEach(W=>W.addEventListener("input",ye));const pe=e.querySelector("#establishmentLogoInput"),F=e.querySelector("#establishmentBgInput"),ee=e.querySelector("#establishmentLogoBase64"),Ee=e.querySelector("#establishmentBackgroundImageBase64");e.querySelector("#triggerLogoUpload").addEventListener("click",W=>{W.target.id!=="establishmentLogoInput"&&pe.click()}),pe.onchange=async W=>{const Q=W.target.files[0];if(Q){const be=await Vs(Q,300,.9);e.querySelector("#establishmentLogoPreview").src=be,e.querySelector("#mockup-logo").src=be,ee.value=be}},e.querySelector("#triggerBannerUpload").addEventListener("click",W=>{W.target.id!=="establishmentBgInput"&&F.click()}),F.onchange=async W=>{const Q=W.target.files[0];if(Q){const be=await Vs(Q,1280,.8);e.querySelector("#establishmentBgPreview").src=be,e.querySelector("#establishmentBgPreview").classList.remove("hidden"),e.querySelector("#establishmentBgPlaceholder").classList.add("hidden"),Ee.value=be,e.querySelector("#mockup-banner").src=be,e.querySelector("#mockup-banner").classList.remove("hidden"),e.querySelector("#mockup-banner-placeholder").classList.add("hidden")}},e.querySelector("#branding-form").addEventListener("submit",W=>{W.preventDefault();let Q="rounded";e.querySelectorAll('input[name="buttonStyle"]').forEach(Es=>{Es.checked&&(Q=Es.value)});const be={logo:ee.value,backgroundImage:Ee.value,welcomeMessage:q.value,templateId:Z.value,primaryColor:k.value,backgroundColor:P.value,textColor:T.value,titleColor:$.value,typography:L.value,buttonStyle:Q,socialLinks:{instagram:E.value.trim(),whatsapp:I.value.trim(),facebook:D.value.trim()}};bt(be,W)})}function gd(t,e){const a=t.urlId||ae;let s=window.location.origin;(s.includes("localhost")||s.includes("capacitor://")||s.includes("127.0.0.1"))&&(s="https://www.kairosagenda.com.br");const r=h(`${s}/agendar?id=${a}`),o=t.publicBookingEnabled||!1,i=o?"Agendamento Online ATIVO":"Agendamento Online INATIVO",n=o?"text-green-600":"text-red-600";e.innerHTML=`
    ...
    `;const a=e.querySelector("#establishmentTimezone");t.timezone&&(a.value=t.timezone);const s=e.querySelector("#establishmentWorkingHoursContainer"),r=t.workingHours||{};Object.keys(Aa).forEach(o=>{const i=r[o]||{},n=Aa[o],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",o=>{const i=o.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),e.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const i={};Object.keys(Aa).forEach(l=>{i[l]={active:e.querySelector(`#est-${l}-active`).checked,start:e.querySelector(`#est-${l}-start`).value,end:e.querySelector(`#est-${l}-end`).value,breakStart:e.querySelector(`#est-${l}-breakStart`).value,breakEnd:e.querySelector(`#est-${l}-breakEnd`).value}});const n=e.querySelector("#establishmentTimezone").value;bt({workingHours:i,timezone:n},o)})}function pr(t,e){const a=!!t.whatsappInstance;e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;const n=e.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const u=document.createElement("div");u.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const c=d.type||"money",p=d.itemId||"",b=d.reward||"",g=d.discount||"",v=d.points||d.costPoints||"";u.innerHTML=`
        ...
        `;const y=u.querySelector(".type-select"),k=u.querySelector(".item-select"),P=u.querySelector(".desc-input"),T=u.querySelector(".discount-input"),$=L=>{k.innerHTML='<option value="">Selecione...</option>';let q=[];L==="service"?q=r:L==="product"?q=o:L==="package"&&(q=i),q.forEach(N=>{const E=N.id===p,I=N.name||N.title||"Sem nome",D=N.price||N.salePrice||0;k.innerHTML+=`<option value="${N.id}" data-price="${D}" ${E?"selected":""}>${h(I)}</option>`})};return c!=="money"&&$(c),y.addEventListener("change",L=>{const q=L.target.value;q==="money"?(k.classList.add("hidden"),P.classList.remove("hidden"),P.value="",T.value=""):(k.classList.remove("hidden"),P.classList.add("hidden"),$(q),T.value="")}),k.addEventListener("change",L=>{const q=L.target.selectedOptions[0];if(q&&q.value){P.value=q.text;const N=q.dataset.price;N&&(T.value=parseFloat(N).toFixed(2))}}),u};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),e.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const u=d.target.closest(".remove-loyalty-tier");u&&u.closest(".loyalty-tier-row").remove()}),e.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const u=Array.from(e.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(p=>{const b=p.querySelector(".type-select").value,g=b==="money"?null:p.querySelector(".item-select").value;let v=b==="money"?p.querySelector(".desc-input").value:p.querySelector(".item-select").options[p.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,type:b,itemId:g,reward:v,name:v,discount:parseFloat(p.querySelector('input[data-field="discount"]').value)||0}}),c={loyaltyProgram:{enabled:e.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(e.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:u.filter(p=>p.points>0&&p.reward)}};bt(c,d)})}async function hd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([va(ae),ds(ae)]),r=t.financialIntegration||{},o=t.commissionConfig||{},i=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=_e(a,r.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=_e(s,r.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=_e(a,i.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=_e(s,i.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=_e(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=_e(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};bt(s,a)})}function vd(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `}function wd(t,e){const a=e.querySelector("#slotIntervalContainer"),s=e.querySelector("#establishmentSlotInterval");if(!a||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(o=>{const i=o.value===t;return`<button type="button" data-value="${o.value}" 
    ...
    `,He.querySelector('button[data-action="back-to-menu"]').addEventListener("click",r=>{r.preventDefault(),br({id:ae})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":ud(X,s);break;case"change-password":pd(X,s);break;case"change-email":bd(X,s);break;case"branding":md(X,s);break;case"booking":gd(X,s);break;case"working-hours":fd(X,s);break;case"whatsapp-bot":pr(X,s);break;case"loyalty":await xd(X,s);break;case"financial":await hd(X,s);break;case"support":vd(X,s);break;case"cancellation":yd(X,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function br(t={}){He.innerHTML=`
    ...
    `;try{ae=t.id||m.establishmentId,X=await qe(ae);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=X.isMatriz||!X.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=ur();He.innerHTML=`
        ...
        `,He.querySelectorAll("div[data-section]").forEach(r=>{r.addEventListener("click",o=>{kd(r.dataset.section)})}),He.querySelectorAll(".module-toggle").forEach(r=>{r.addEventListener("change",async()=>{const o=r.dataset.module;try{const n={...(await qe(ae)).modules,[o]:r.checked};await ns(ae,{modules:n}),f("Módulos","Módulos atualizados com sucesso.","success")}catch(i){r.checked=!r.checked,f("Erro",i.message,"error")}})})}catch(e){He.innerHTML=`
        ...
        `}}function Sd(t){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `).join("")}const Et=document.getElementById("content");async function et(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await wa(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),i=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,n=i.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",i.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${h(l)} (${d.length})</h4>`;if(d.length>1){const b=JSON.stringify(d.map(g=>g.id));p+=`<button data-action="batch-delete-blockage" data-ids='${b}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",u.innerHTML=p,d.forEach(b=>{const g=new Date(b.startTime),v=new Date(b.endTime),y=g.toLocaleDateString("pt-BR"),k=v.toLocaleDateString("pt-BR"),T=`
                    ...
                    </div>`;u.innerHTML+=T}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function $d(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,r=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,i=e.querySelector("#blockageEndTime").value,n={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${i}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await ka(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),et(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Ed(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,r=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,i=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:m.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${i}:00`).toISOString(),reason:n};return ka(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&et(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Id(t){Et.addEventListener("submit",e=>{e.target.id==="blockageForm"&&$d(e),e.target.id==="batchBlockageForm"&&Ed(e)}),Et.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&et(t)}),Et.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")se("profissionais-section");else if(s==="delete-blockage"){if(await Y("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await us(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),et(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await Y("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await qo(r),f("Sucesso",`${r.length} bloqueios removidos.`,"success"),et(t)}catch(i){f("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function Ld(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){Et.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=h(a);Et.innerHTML=`
        <section>
        ...
        </section>`,Id(e),await et(e);const r=document.getElementById("batchProfSelectionContainer");try{const o=await $e(m.establishmentId);r.innerHTML=o.map(i=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const Cd=t=>C(`/api/users/${t}`),Dd=t=>C("/api/users",{method:"POST",body:JSON.stringify(t)}),Pd=(t,e)=>C(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),Td=t=>C(`/api/users/${t}`,{method:"DELETE"}),Bd=(t,e)=>C(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),Md=(t,e)=>C(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),mt=document.getElementById("content"),Ad={"Operação & Atendimento":{"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas","ausencias-section":"Ausências e Bloqueios"},"Financeiro & Vendas":{"financial-section":"Financeiro (ERP)","sales-report-section":"Relatório de Vendas","commissions-section":"Comissões","packages-section":"Planos e Pacotes"},"Cadastros Base":{"clientes-section":"Clientes","profissionais-section":"Profissionais","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores"},Administração:{"relatorios-section":"Relatórios Gerais","estabelecimento-section":"Configurações da Empresa","users-section":"Usuários e Acessos"}},qd={view:"Visualizar",create:"Criar",edit:"Editar"},_s={owner:{label:"Proprietário",color:"bg-rose-100 text-rose-700 border-rose-200"},group_admin:{label:"Admin da Rede",color:"bg-purple-100 text-purple-700 border-purple-200"},company_admin:{label:"Gestor Matriz",color:"bg-blue-100 text-blue-700 border-blue-200"},branch_manager:{label:"Gestor Filial",color:"bg-orange-100 text-orange-700 border-orange-200"},professional:{label:"Profissional",color:"bg-slate-100 text-slate-600 border-slate-200"}};let _t=null,Ut=null,tt=null;function mr(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[m.establishmentId]}function jd(t){const e=document.getElementById("usersListContainer");if(!e)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const s=a?"Nenhum usuário encontrado na base.":"Nenhum usuário ativo neste contexto.";e.innerHTML=`
        ...
        `}).join("")}function gr(){const e=document.getElementById("showInactiveUsersToggle")?.checked?m.users:m.users.filter(a=>a.status==="active");jd(e)}function Nd(t={}){let e="",a=!1;for(const[s,r]of Object.entries(Ad)){const o=Object.entries(r).filter(([i,n])=>{const l=i.replace("-section","");return!(m.enabledModules&&m.enabledModules[l]===!1)});o.length!==0&&(a=!0,e+=`
        ...
        `,o.forEach(([i,n])=>{const l=i==="agenda-section"||i==="comandas-section",d=t[i]?.view_all_prof===!0,u=Object.entries(qd).map(([p,b])=>`
        ...
        `}),r+="</div>",r}async function Ws(t=null){document.getElementById("user-list-view").classList.add("hidden");const e=document.getElementById("user-form-view");e.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{const p=mr().map(v=>$e(v)),b=await Promise.all(p),g=new Map;b.flat().forEach(v=>g.set(v.id,v)),a=Array.from(g.values()),m.professionals=a}catch(c){console.warn("Profissionais não carregados",c)}if(["owner","group_admin","company_admin"].includes(m.userRole)&&!tt)try{const c=await ve();c&&(tt=c)}catch(c){console.error("Falha ao buscar hierarquia",c),tt={companies:[],branches:[]}}const s=t!==null,r=s&&t.role==="owner",o=e.querySelector("#userFormTitle");o.innerHTML=s?`<i class="bi bi-person-lines-fill mr-2 text-indigo-600"></i>Editar Perfil: ${t.name}`:'<i class="bi bi-person-plus-fill mr-2 text-indigo-600"></i>Novo Acesso';const i=e.querySelector("#userForm");i.innerHTML=`
    ...
    `;const n=e.querySelectorAll(".tab-btn"),l=e.querySelectorAll(".tab-content");n.forEach(c=>{c.addEventListener("click",()=>{n.forEach(b=>{b.classList.remove("active","text-indigo-600","border-indigo-600"),b.classList.add("text-slate-400","border-transparent")}),l.forEach(b=>b.classList.add("hidden")),c.classList.add("active","text-indigo-600","border-indigo-600"),c.classList.remove("text-slate-400","border-transparent");const p=c.getAttribute("data-tab");e.querySelector(`#${p}`).classList.remove("hidden")})});const d=i.querySelector("#userRole"),u=i.querySelector("#hierarchySelectorContainer");if(d&&u){d.addEventListener("change",p=>{const b={...t,role:p.target.value};u.innerHTML=Us(b),c()});const c=()=>{u.querySelectorAll(".company-checkbox").forEach(p=>{p.addEventListener("change",b=>{b.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(y=>{y.checked=b.target.checked;const k=y.nextElementSibling.querySelector(".dot");k&&(b.target.checked?k.classList.add("transform","translate-x-4"):k.classList.remove("transform","translate-x-4"))})})})};c()}if(i.querySelectorAll(".permission-checkbox").forEach(c=>{if(c.addEventListener("change",p=>{const b=p.target.nextElementSibling,g=b.nextElementSibling;p.target.checked?(b.classList.replace("bg-slate-200","bg-indigo-500"),g.classList.add("transform","translate-x-4")):(b.classList.replace("bg-indigo-500","bg-slate-200"),g.classList.remove("transform","translate-x-4"))}),c.checked){const p=c.nextElementSibling,b=p.nextElementSibling;p.classList.replace("bg-slate-200","bg-indigo-500"),b.classList.add("transform","translate-x-4")}}),i.onsubmit=async c=>{c.preventDefault();const p=i.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Processando...';const g={};i.querySelectorAll(".permission-checkbox").forEach($=>{const L=$.dataset.module,q=$.dataset.permission;g[L]||(g[L]={}),g[L][q]=$.checked});const v=i.querySelector("#userProfessionalId").value||null,y=i.querySelector("#userRole")?.value||"professional",k=[],P=[];if(y!=="group_admin"&&y!=="owner"&&i.querySelector(".company-checkbox")&&(i.querySelectorAll(".company-checkbox:checked").forEach($=>{k.push({id:$.value,name:$.dataset.name})}),i.querySelectorAll(".branch-checkbox:checked").forEach($=>{P.push({id:$.value,name:$.dataset.name,companyId:$.dataset.companyId})}),P.length===0))return p.disabled=!1,p.innerHTML=b,f("Atenção","Selecione pelo menos uma filial na aba de Acesso.","warning");const T={name:i.querySelector("#userName").value,permissions:g,professionalId:v,role:y,accessibleCompanies:k,accessibleEstablishments:P};try{if(s){const $=i.querySelector("#userEmail").value;t?.email!==$&&!r&&(T.email=$),await Pd(t.id,T),f("Sucesso","Usuário atualizado.","success")}else T.email=i.querySelector("#userEmail").value,T.password=i.querySelector("#userPassword").value,await Dd(T),f("Sucesso","Novo usuário cadastrado na plataforma.","success");ca()}catch($){f(`Erro: ${$.message}`,"error"),p.disabled=!1,p.innerHTML=b}},s){const c=i.querySelector("#btn-show-password"),p=i.querySelector("#password-form");c&&p&&(c.onclick=()=>{c.classList.add("hidden"),p.classList.remove("hidden")},i.querySelector("#btn-cancel-pwd").onclick=()=>{c.classList.remove("hidden"),p.classList.add("hidden"),p.querySelector("#userNewPassword").value=""},i.querySelector("#btn-save-pwd").onclick=async b=>{const g=b.target,v=p.querySelector("#userNewPassword").value;if(!v||v.length<6)return f("Aviso","Senha deve ter no mínimo 6 caracteres.","warning");if(await Y("Alterar Senha","O usuário usará esta nova senha no próximo acesso. Confirma?"))try{g.disabled=!0,g.textContent="Aguarde...",await Bd(t.id,v),f("Sucesso","Senha alterada com segurança.","success"),c.classList.remove("hidden"),p.classList.add("hidden")}catch(y){f("Erro",y.message,"error")}finally{g.disabled=!1,g.textContent="Salvar Senha"}})}}async function Rd(){const t=document.getElementById("usersListContainer");t.innerHTML='<div class="col-span-full py-16 flex justify-center"><div class="loader"></div></div>';try{const e=mr(),a=e.map(l=>Cd(l)),s=e.map(l=>$e(l)),r=await Promise.all(a),o=await Promise.all(s),i=new Map;r.flat().forEach(l=>i.set(l.id,l)),m.users=Array.from(i.values());const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),m.professionals=Array.from(n.values()),gr()}catch{f("Erro ao carregar base de usuários.","error"),t.innerHTML='<p class="col-span-full text-center font-bold text-red-500 bg-red-50 p-6 rounded-2xl">Falha de comunicação com o servidor de acessos.</p>'}}async function ca(){mt.innerHTML=`
    ...
    `,_t&&mt.removeEventListener("click",_t),Ut&&mt.removeEventListener("change",Ut),_t=async t=>{const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":Ws();break;case"edit-user":const s=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));Ws(s);break;case"back-to-list":ca();break;case"delete-user":{if(t.stopPropagation(),await Y("Excluir Usuário","O usuário perderá totalmente o acesso ao sistema. Confirma?"))try{await Td(e.dataset.userId),f("Usuário excluído com sucesso.","success"),ca()}catch(r){f(`Erro: ${r.message}`,"error")}break}}},Ut=async t=>{if(t.target.id==="showInactiveUsersToggle"){const e=t.target.nextElementSibling,a=e.nextElementSibling;t.target.checked?(e.classList.replace("bg-slate-200","bg-indigo-500"),a.classList.add("transform","translate-x-5")):(e.classList.replace("bg-indigo-500","bg-slate-200"),a.classList.remove("transform","translate-x-5")),gr()}else{const e=t.target.closest('input[data-action="toggle-user-status"]');if(e){t.stopPropagation();const a=e.dataset.userId,s=e.checked?"active":"inactive",r=e.nextElementSibling,o=r.nextElementSibling;e.checked?(r.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(r.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"));try{await Md(a,s);const i=m.users.findIndex(n=>n.id===a);if(i>-1){m.users[i].status=s;const n=e.closest(".user-card-clickable");s==="inactive"?n.classList.add("opacity-60","bg-slate-50"):n.classList.remove("opacity-60","bg-slate-50")}}catch(i){f(`Erro: ${i.message}`,"error"),e.checked=!e.checked,e.checked?(r.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(r.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"))}}}},mt.addEventListener("click",_t),mt.addEventListener("change",Ut),await Rd()}const Fd=document.getElementById("content");let Js={},as=null;function Hd(){Object.values(Js).forEach(t=>t?.destroy()),Js={}}function Od(t,e){if(!window.jspdf){f("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(t,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const i=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${e}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Qs(t){const e=document.getElementById("genericModal"),a=h(t.client),s=h(t.items),r=h(t.responsavelCaixa||"N/A"),o=(t.payments||[]).map(i=>`
    ...
    `,e.style.display="flex"}function zd(t){const{summary:e,transactions:a}=t;document.getElementById("summary-revenue").textContent=`R$ ${e.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=e.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${e.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),r=Object.entries(e.paymentMethodTotals).sort(([,n],[,l])=>l-n);s.innerHTML=r.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=as.transactions[l];d&&Qs(d)})}),i.innerHTML=a.map((n,l)=>{const d=h(n.client),u=h(n.items),c=h(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=as.transactions[l];d&&Qs(d)})})}async function Gs(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,r=a.value;if(!s||!r)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,i=await oa({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:o});as=i,t.innerHTML=`
        ...
        `,zd(i)}catch(o){f("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${h(o.message)}</p>`}}async function Vd(){Hd();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];Fd.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Gs),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${r}`;Od(o,"transactionsTable")});try{const s=await $n(m.establishmentId),r=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const i=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=h(o.closedByName||"N/A");r.innerHTML+=`<option value="${o.id}">${n} - ${i}</option>`})}catch{f("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Gs()}const _d=document.getElementById("content");let S={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],suppliers:[],clients:[],professionals:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Wt=null,Jt=null;function Ss(t){const e=new Map,a=[];return t&&(t.forEach(s=>e.set(s.id,{...s,children:[]})),e.forEach(s=>{s.parentId&&e.has(s.parentId)?e.get(s.parentId).children.push(s):a.push(s)})),a}function fr(t){if(!t)return{day:"--",month:"---",full:"--/--/----"};const[e,a,s]=t.split("-"),r=new Date(e,a-1,s),o=String(r.getDate()).padStart(2,"0"),i=r.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:o,month:i,full:r.toLocaleDateString("pt-BR")}}function xe(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t)}function nt(t,e){if(e==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,r,o]=t.split("-");return new Date(s,r-1,o)<a}function Ud(t,e,a){if(!t)return;if(!e||e.length===0){t.innerHTML=`
        ...
        `};t.innerHTML=e.map(r=>s(r)).join("")}async function Ys(t){const e=document.getElementById("genericModal"),a=t==="nature",s=a?"Plano de Naturezas":"Centros de Custo",r=a?va:ds,o=a?Fi:Hi,i=a?"natures":"costCenters";e.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",e.innerHTML=`
    ...
    `,vr()}function Jd(){const t=S.currentTab==="receivables",e=t?S.receivables:S.payables;let a=e;if(S.statusFilter!=="all"&&(a=e.filter(n=>{const l=nt(n.dueDate,n.status);return S.statusFilter==="overdue"?l:S.statusFilter==="pending"?n.status==="pending"&&!l:n.status===S.statusFilter})),S.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(S.searchQuery)||n.entity&&n.entity.toLowerCase().includes(S.searchQuery)||n.notes&&n.notes.toLowerCase().includes(S.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map(S.natures.map(n=>[n.id,n.name])),r=new Map(S.costCenters.map(n=>[n.id,n.name])),o=new Map(S.establishments.map(n=>[n.id,n])),i=a.map(n=>{const l=n.status==="paid",d=nt(n.dueDate,n.status);let u=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const c=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?r.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=o.get(n.establishmentId),g=b?b.name:"Atual",v=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:g,Natureza:c,"Centro de Custo":p,Origem:v,"Documento / NFS":n.documentNumber||"",Status:u,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(i),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const u=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,u)}catch(n){console.error("Erro ao exportar:",n),f("Erro","Não foi possível exportar para Excel.","error")}}function Qd(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i.bi-chevron-expand, i.bi-chevron-up, i.bi-chevron-down");if(!e)return;t.dataset.sort===S.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=S.sortAsc?"bi bi-chevron-up ml-1 text-indigo-600 text-[11px] font-black":"bi bi-chevron-down ml-1 text-indigo-600 text-[11px] font-black"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-chevron-expand ml-1 opacity-40 text-[10px] font-black")})}function hr(){document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",i=>{const n=i.currentTarget.dataset.sort;S.sortCol===n?S.sortAsc=!S.sortAsc:(S.sortCol=n,S.sortAsc=!0),It()})});const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const i=o.target.checked,n=document.querySelectorAll(".item-checkbox");S.selectedIds.clear(),n.forEach(l=>{l.checked=i,i&&S.selectedIds.add(l.value)}),Ze()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{S.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Ze()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=S.selectedIds.size;if(o===0)return;if(await Y("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const n=S.currentTab==="payables"?"payables":"receivables";await Po(n,Array.from(S.selectedIds)),f("Sucesso",`${o} itens excluídos.`,"success"),S.selectedIds.clear(),Ze(),Pe()}catch{f("Erro","Falha ao excluir itens.","error")}}),document.getElementById("custom-date-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),i=document.getElementById("custom-date-btn");S.isAdvancedFilterOpen=!S.isAdvancedFilterOpen,S.isAdvancedFilterOpen?(o.classList.remove("hidden"),i.classList.add("bg-gray-900","text-white","border-gray-900"),i.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),i.classList.remove("bg-gray-900","text-white","border-gray-900"),i.classList.add("bg-white","text-gray-600","border-gray-200"))});const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",Jd);const a=document.getElementById("settings-btn");a&&a.addEventListener("click",Xd),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(20),Zs(i.target.closest("button").dataset.type)})});const s=document.getElementById("tab-receivables"),r=document.getElementById("tab-payables");s.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),Xs("receivables")}),r.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),Xs("payables")}),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-gray-900","bg-blue-600","bg-emerald-600","bg-red-600","text-white"),l.classList.add("bg-white","text-gray-600")});const n=i.target.dataset.status;n==="all"?i.target.classList.add("bg-gray-900","text-white"):n==="pending"?i.target.classList.add("bg-blue-600","text-white"):n==="paid"?i.target.classList.add("bg-emerald-600","text-white"):n==="overdue"&&i.target.classList.add("bg-red-600","text-white"),i.target.classList.remove("bg-white","text-gray-600"),S.statusFilter=n,It()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=i.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=u.toISOString().split("T")[0],S.startDate=d.toISOString().split("T")[0],S.endDate=u.toISOString().split("T")[0],Pe()})}),document.getElementById("searchInput").addEventListener("input",o=>{S.searchQuery=o.target.value.toLowerCase(),It()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",xr(),hr(),Pe()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(20),S.startDate=document.getElementById("filterStartDate").value,S.endDate=document.getElementById("filterEndDate").value,S.filterNaturezaId=document.getElementById("filterNaturezaId").value,S.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("custom-date-btn").click(),Pe()}),Wt&&document.body.removeEventListener("click",Wt),Wt=o=>{const i=o.target;if(i.classList.contains("item-checkbox")||i.classList.contains("modal-item-checkbox")){const d=i.value||i.dataset.id;i.checked?S.selectedIds.add(d):S.selectedIds.delete(d),Ze(),o.stopPropagation();return}const n=i.closest("button[data-action]");if(n){const{action:d,type:u,id:c}=n.dataset;if(d==="mark-as-paid"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),Gd(u,c);return}if(d==="delete"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(30);const p=n.closest(".financial-row").dataset.item;try{wr(u,JSON.parse(decodeURIComponent(p)))}catch(b){console.error("Parse error on delete",b)}return}if(d==="manage-natures"){o.stopPropagation(),Ys("nature");return}if(d==="manage-cost-centers"){o.stopPropagation(),Ys("cost-center");return}if(d==="close-modal"){o.stopPropagation(),Mt();return}}const l=i.closest(".financial-row");if(l&&document.getElementById("list-container").contains(l)&&!i.closest("button")&&!i.closest(".item-checkbox")){navigator.vibrate&&navigator.vibrate(15);const{type:d}=l.dataset;try{const u=JSON.parse(decodeURIComponent(l.dataset.item));Zs(d,u)}catch(u){console.error("Parse error on card click",u),f("Erro","Os dados deste lançamento não puderam ser lidos corretamente.","error")}}},document.body.addEventListener("click",Wt),Jt&&document.getElementById("genericModal").removeEventListener("click",Jt),Jt=o=>{const i=o.target.closest('button[data-action^="delete-"]');if(i){const n=i.dataset.action.split("-")[1];handleDeleteHierarchyItem(n,i.dataset.id)}o.target===document.getElementById("genericModal")&&Mt()},document.getElementById("genericModal").addEventListener("click",Jt)}function Ze(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=S.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}function Xs(t){S.currentTab=t,S.selectedIds.clear(),Ze(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t==="receivables"?(e.classList.add("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.remove("text-gray-500"),a.classList.remove("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.add("text-gray-500")):(a.classList.add("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.remove("text-gray-500"),e.classList.remove("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.add("text-gray-500")),It(),yr()}async function Pe(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A sincronizar carteira...</p></div>';try{if(S.natures.length===0){const[i,n,l,d,u]=await Promise.all([va(m.establishmentId),ds(m.establishmentId),Bt(m.establishmentId).catch(()=>[]),ct(m.establishmentId,"",1e3).catch(()=>[]),$e(m.establishmentId).catch(()=>[])]);S.natures=i||[],S.costCenters=n||[],S.suppliers=l||[],S.clients=d||[],S.professionals=u||[],vr()}const a=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).join(","),s={startDate:S.startDate,endDate:S.endDate,establishmentId:a};S.filterNaturezaId!=="all"&&(s.natureId=S.filterNaturezaId),S.filterCostCenterId!=="all"&&(s.costCenterId=S.filterCostCenterId);const[r,o]=await Promise.all([cs(s),ya(s)]);S.payables=r.entries||[],S.receivables=o.entries||[],yr(),It()}catch(e){t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
            ...
            </div>`}}function vr(){const t=s=>{let r='<option value="all">Todas as categorias</option>';const o=Ss(s),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");r+=`<option value="${n.id}">${d}${h(n.name)}</option>`,n.children.forEach(u=>i(u,l+1))};return o.forEach(n=>i(n)),r},e=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");e&&(e.innerHTML=t(S.natures)),a&&(a.innerHTML=t(S.costCenters))}function yr(){const t=document.getElementById("summary-section");if(!t)return;const e=S.currentTab==="receivables";let s=e?S.receivables:S.payables;S.searchQuery&&(s=s.filter(u=>u.description&&u.description.toLowerCase().includes(S.searchQuery)||u.entity&&u.entity.toLowerCase().includes(S.searchQuery)||u.notes&&u.notes.toLowerCase().includes(S.searchQuery)));const r=s.reduce((u,c)=>u+c.amount,0),o=s.filter(u=>u.status==="paid").reduce((u,c)=>u+c.amount,0),i=s.filter(u=>u.status==="pending"&&!nt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),n=s.filter(u=>nt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),l=e?"emerald":"red",d=e?"bi-arrow-down-left-circle-fill text-emerald-500":"bi-arrow-up-right-circle-fill text-red-500";t.innerHTML=`
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${xe(r)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-blue-600">${xe(i)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 md:p-4 rounded-2xl md:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-${l}-600">${xe(o)}</span>
        </div>
    ...
    `}function It(){const t=document.getElementById("list-container");if(!t)return;const e=S.currentTab==="receivables",a=e?S.receivables:S.payables;let s=a;if(S.statusFilter!=="all"&&(s=a.filter(c=>{const p=nt(c.dueDate,c.status);return S.statusFilter==="overdue"?p:S.statusFilter==="pending"?c.status==="pending"&&!p:c.status===S.statusFilter})),S.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(S.searchQuery)||c.entity&&c.entity.toLowerCase().includes(S.searchQuery)||c.notes&&c.notes.toLowerCase().includes(S.searchQuery))),s.sort((c,p)=>{let b=c[S.sortCol],g=p[S.sortCol];return S.sortCol==="dueDate"?(b=new Date(b).getTime(),g=new Date(g).getTime()):(S.sortCol==="description"||S.sortCol==="status")&&(b=b?b.toLowerCase():"",g=g?g.toLowerCase():""),b<g?S.sortAsc?-1:1:b>g?S.sortAsc?1:-1:0}),Qd(),s.length===0){t.innerHTML=`
        ...
        <div class="financial-row bg-white border border-gray-100 md:border-0 md:border-b md:border-gray-100 hover:bg-gray-50 transition-all cursor-pointer relative flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center p-3.5 md:px-6 md:py-4 mb-3 md:mb-0 rounded-2xl md:rounded-none ${L?"ring-2 md:ring-0 ring-indigo-500 bg-indigo-50/50 md:bg-indigo-50/50":""} ${b?"opacity-70 md:opacity-100":""}"
            ...
            <div class="md:hidden flex items-start gap-3 w-full pr-6">
                ...
                <div class="flex-1 min-w-0 flex flex-col">
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <p class="font-black text-[16px] leading-none flex-shrink-0 ${b?"text-gray-400":l}">${xe(c.amount)}</p>
                    </div>
            ...
            <div class="hidden md:flex md:col-span-2 justify-end items-center pr-6">
                <p class="font-black text-lg ${b?"text-gray-400":l}">${xe(c.amount)}</p>
            </div>
        ...
        `}).join("")}async function Gd(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?Vi(e,a):Ji(e,a)),f("Baixa Realizada","O lançamento foi registado como pago.","success"),await Pe()}catch(s){f("Erro",s.message,"error")}}async function wr(t,e){if(!!!e.recurrenceId){await Y("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await kr(t,[e.id]);return}Yd(t,e)}function Yd(t,e){const a=document.getElementById("genericModal"),r=(t==="payable"?S.payables:S.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,u)=>new Date(d.dueDate)-new Date(u.dueDate));a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",a.innerHTML=`
        <div id="modal-content-wrapper" class="w-full md:max-w-2xl bg-gray-50 md:bg-white flex flex-col transform transition-all duration-300 translate-y-full md:translate-y-0 md:scale-95 md:opacity-0 h-full md:h-auto md:max-h-[90vh] rounded-t-3xl md:rounded-3xl overflow-hidden shadow-2xl relative" style="font-family: 'Plus Jakarta Sans', 'Nunito', sans-serif;">
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar bg-gray-50 pb-safe md:pb-4">
                ${r.map(d=>{const u=d.id===e.id,c=d.status==="paid",p=fr(d.dueDate);return`
                    <label class="flex items-center gap-4 p-4 bg-white rounded-2xl border ${u?"border-red-400 ring-2 ring-red-100 shadow-md bg-red-50/20":"border-gray-200 shadow-sm"} cursor-pointer transition-all hover:bg-gray-50 active:scale-[0.98]">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm font-black text-gray-600 mt-1">${xe(d.amount)} ${c?'<span class="text-emerald-600 font-bold ml-1">(Baixado)</span>':""}</p>
                        </div>
                    </label>
                    `}).join("")}
            </div>
    ...
    `,t.style.display="flex",requestAnimationFrame(()=>{t.classList.remove("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),e.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Zs(t,e=null){const a=document.getElementById("genericModal"),s=t==="payable",r=s?"red":"emerald",o=e?"Editar Lançamento":"Novo Lançamento",i=(E,I)=>{let D='<option value="">-- Categoria --</option>';const R=Ss(E),O=(U,Z=0)=>{const K="  ".repeat(Z)+(Z>0?"↳ ":""),ye=U.id===I?"selected":"";D+=`<option value="${U.id}" ${ye}>${K}${h(U.name)}</option>`,U.children.forEach(pe=>O(pe,Z+1))};return R.forEach(U=>O(U)),D},l=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(E=>`<option value="${E.value}" ${e?.paymentMethod===E.value?"selected":""}>${E.label}</option>`).join(""),d=`
        <datalist id="entity-suggestions">
            ${s?S.suppliers.map(E=>`<option value="${h(E.name)}">Fornecedor</option>`).join("")+S.professionals.map(E=>`<option value="${h(E.name)}">Profissional</option>`).join(""):S.clients.map(E=>`<option value="${h(E.name)} ${E.phone?"- "+h(E.phone):""}">Cliente</option>`).join("")}
        </datalist>
    `,u=e?.establishmentId||m.selectedEstablishments&&m.selectedEstablishments[0]||m.establishmentId,c=S.establishments.map(E=>{const I=E.id===u;return`<option value="${E.id}" ${I?"selected":""}>${E.type==="Matriz"?"🏢":"📍"} ${h(E.name)}</option>`}).join("");a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 md:p-6",a.innerHTML=`
        ${d}
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const E=a.querySelector("#modal-content-wrapper");E&&(E.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),E.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let b="single",g=2;const v=p.querySelector("#modal-delete-btn");v&&v.addEventListener("click",E=>{E.preventDefault(),navigator.vibrate&&navigator.vibrate(30),Mt(),setTimeout(()=>wr(t,e),300)});const y=p.querySelector('[name="amount"]'),k=p.querySelector("#recurrence-options"),P=p.querySelector("#recurrence-summary"),T=p.querySelector("#installments-input"),$=p.querySelector("#status-toggle"),L=p.querySelector("#payment-date-wrapper"),q=p.querySelector('[name="paymentDate"]'),N=()=>{if(b==="single")return;const E=parseFloat(y.value)||0;if(g=parseInt(T.value)||2,E===0){P.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(b==="installment"){const I=E/g;P.innerHTML=`
                <div>
                    ...
                    <span class="font-black text-sm md:text-base text-indigo-700 block leading-tight">${g}x de ${xe(I)}</span>
                    <span class="text-[9px] md:text-[10px] text-indigo-500 font-bold mt-1 block bg-indigo-50/50 p-1 rounded">Total da Dívida: ${xe(E)}</span>
                </div>
            `}else if(b==="repeat"){const I=E*g;P.innerHTML=`
                <div>
                    ...
                    <span class="font-black text-sm md:text-base text-indigo-700 block leading-tight">${g} meses de ${xe(E)}</span>
                    <span class="text-[9px] md:text-[10px] text-indigo-500 font-bold mt-1 block bg-indigo-50/50 p-1 rounded">Comprometimento: ${xe(I)}</span>
                </div>
            `}};p.addEventListener("click",E=>{const I=E.target.closest(".mode-btn");if(I&&!e)if(E.preventDefault(),navigator.vibrate&&navigator.vibrate(15),p.querySelectorAll(".mode-btn").forEach(O=>{O.classList.remove("bg-white","text-gray-900","shadow-sm"),O.classList.add("text-gray-500")}),I.classList.add("bg-white","text-gray-900","shadow-sm"),I.classList.remove("text-gray-500"),b=I.dataset.mode,b==="single")k.style.display="none";else{k.style.display="block";const O=k.querySelector("#recurrence-label");O&&(O.textContent=b==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),N()}if(E.target.closest("#btn-minus")&&T){E.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let O=parseInt(T.value)||2;O>2&&(T.value=O-1,N())}if(E.target.closest("#btn-plus")&&T){E.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let O=parseInt(T.value)||2;O<60&&(T.value=O+1,N())}}),y.addEventListener("input",N),T&&T.addEventListener("input",N),$.addEventListener("change",()=>{navigator.vibrate&&navigator.vibrate(20),$.checked?(L.classList.remove("hidden"),q.required=!0):(L.classList.add("hidden"),q.required=!1)}),p.addEventListener("submit",async E=>{E.preventDefault();const I=p.querySelector('button[type="submit"]'),D=I.innerHTML;I.disabled=!0,I.innerHTML='<div class="loader mx-auto h-5 w-5 border-2 border-white border-t-transparent"></div>';const R=new FormData(p),O=$.checked,U=parseFloat(R.get("amount"));let Z=U,K=1;!e&&b!=="single"&&(K=parseInt(R.get("installments")),b==="repeat"&&(Z=U*K));const ye=R.get("establishmentId");if(!ye){f("Atenção","Selecione uma Unidade válida para o lançamento.","warning"),I.disabled=!1,I.innerHTML=D;return}const pe={companyId:m.companyId,establishmentId:ye,description:R.get("description"),amount:Z,dueDate:R.get("dueDate"),naturezaId:R.get("naturezaId")||null,centroDeCustoId:R.get("centroDeCustoId")||null,entity:R.get("entity")||null,paymentMethod:R.get("paymentMethod")||null,documentNumber:R.get("documentNumber")||null,notes:R.get("notes"),status:O?"paid":"pending",paymentDate:O?R.get("paymentDate"):null,installments:K};K>1&&!e&&(pe.recurrenceId=self.crypto.randomUUID());try{e?(await(s?Oi(e.id,pe):Ui(e.id,pe)),f("Sucesso","Atualizado com sucesso!","success")):(await(s?Bo(pe):_i(pe)),f("Sucesso","Lançamento criado!","success")),Mt(),Pe()}catch(F){f("Erro",F.message||"Erro ao salvar","error"),I.disabled=!1,I.innerHTML=D}})}const Zd=t=>C("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),Kd=t=>C("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),ec=(t,e)=>{const a=new URLSearchParams({startDate:t,endDate:e}).toString();return C(`/api/commissions/stats?${a}`)},tc=(t={})=>{Object.keys(t).forEach(s=>(t[s]===void 0||t[s]===null||t[s]==="")&&delete t[s]);const e=new URLSearchParams(t).toString(),a=`/api/commissions/history${e?"?"+e:""}`;return C(a)},Sr=t=>C(`/api/commissions/report/${t}`,{method:"DELETE"}),ua=new Date,ac=new Date(ua.getFullYear(),ua.getMonth(),1);let j={professionals:[],reports:[],calculationResult:null,periodString:"",establishmentConfig:null,selectedIds:new Set,isAdvancedFilterOpen:!1,startDate:ac.toISOString().split("T")[0],endDate:new Date(ua.getFullYear(),ua.getMonth()+1,0).toISOString().split("T")[0],professionalId:"all",searchQuery:"",stats:{revenue:0,commissions:0,margin:0,netPaid:0},viewMode:"list"},Qt=null;const sc=document.getElementById("content");function Lt(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function oc(t){return t?new Date(t).toLocaleDateString("pt-BR"):"--/--/----"}function pa(t){if(!t)return"PR";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()}function $r(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="none"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&window.innerWidth<768&&(a.style.display="none")}function $s(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="flex"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&window.innerWidth<768&&(a.style.display=""),j.viewMode="list"}async function rc(){try{const[t,e]=await Promise.all([$e(m.establishmentId),qe(m.establishmentId).catch(()=>({}))]);j.professionals=t,j.establishmentConfig=e||{}}catch(t){console.error("Erro na inicialização de comissões",t)}j.viewMode="list",ic(),lc(),await lt()}function ic(){const t=j.professionals.map(e=>`<option value="${e.id}">${e.name}</option>`).join("");sc.innerHTML=`
        <style>
            #toast-container, .toast-notification, .modal, .modal-backdrop { z-index: 9999999 !important; }
        </style>
    ...
    `}async function lt(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">Carregando comissões...</p></div>');const a=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).join(",");try{const[s,r]=await Promise.all([tc({startDate:j.startDate,endDate:j.endDate,professionalId:j.professionalId,establishmentId:a}),ec(j.startDate,j.endDate,a)]);j.reports=s||[];const o=j.reports.reduce((i,n)=>i+(n.summary.finalValue||n.summary.totalCommission),0);j.stats={revenue:r.totalRevenue||0,commissions:r.totalCommissionsPaid||0,margin:r.totalRevenue>0?((r.totalRevenue-r.totalCommissionsPaid)/r.totalRevenue*100).toFixed(1):0,netPaid:o},j.selectedIds.clear(),Ct(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),nc(),Er()}catch(s){console.error(s),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
                <p class="text-gray-600 text-sm font-medium">Erro ao carregar dados.</p>
            </div>`)}}function nc(){const t=document.getElementById("kpi-section");t&&(t.innerHTML=`
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${Lt(j.stats.revenue)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-amber-600">${Lt(j.stats.commissions)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-emerald-600">${Lt(j.stats.netPaid)}</span>
        </div>
    `)}function Er(){const t=document.getElementById("list-container");if(!t)return;let e=j.reports;if(j.searchQuery){const a=j.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=e.map(a=>{const s=oc(a.createdAt),r=a.summary.totalCommission,o=a.summary.extraDebit||0,i=a.summary.extraCredit||0,n=a.summary.finalValue||r,l=j.selectedIds.has(a.id);let d="";return o>0&&i>0?d=`<span class="text-red-500">-R$${o.toFixed(2)}</span> / <span class="text-emerald-500">+R$${i.toFixed(2)}</span>`:o>0?d=`<span class="text-red-500">-R$ ${o.toFixed(2)}</span>`:i>0?d=`<span class="text-emerald-500">+R$ ${i.toFixed(2)}</span>`:d='<span class="text-gray-300">--</span>',`
        ...
        `}).join("")}function lc(){Qt&&document.body.removeEventListener("click",Qt),Qt=o=>{const i=o.target;if(i.classList.contains("item-checkbox")){const l=i.value;i.checked?j.selectedIds.add(l):j.selectedIds.delete(l),Ct(),o.stopPropagation();return}const n=i.closest("button[data-action]");if(n){o.preventDefault();const l=n.dataset.action,d=n.dataset.id;switch(l){case"apply-filters":j.startDate=document.getElementById("filter-start").value,j.endDate=document.getElementById("filter-end").value,j.professionalId=document.getElementById("filter-prof").value,document.getElementById("custom-date-btn")?.click(),lt();break;case"new-calculation":dc();break;case"print-receipt":xc(d);break;case"delete-report":vc(d);break;case"view-report-details":gc(d);break;case"close-detail-screen":$s();break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),c=Array.from(u).every(v=>v.checked);u.forEach(v=>v.checked=!c);break;case"calculate-preview":cc();break;case"save-final-reports":mc();break;case"toggle-preview-details":const p=n.dataset.idx,b=document.getElementById(`preview-details-${p}`),g=n.querySelector("i");b&&(b.classList.contains("hidden")?(b.classList.remove("hidden"),g&&g.classList.replace("bi-chevron-down","bi-chevron-up")):(b.classList.add("hidden"),g&&g.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",Qt);const t=document.getElementById("search-input");t&&t.addEventListener("input",o=>{j.searchQuery=o.target.value,Er()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&pc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const i=o.target.checked,n=document.querySelectorAll(".item-checkbox");j.selectedIds.clear(),n.forEach(l=>{l.checked=i,i&&j.selectedIds.add(l.value)}),Ct()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{j.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Ct()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",hc);const r=document.getElementById("export-excel-btn");r&&r.addEventListener("click",fc),document.getElementById("custom-date-btn")?.addEventListener("click",()=>{const o=document.getElementById("filter-panel"),i=document.getElementById("custom-date-btn");j.isAdvancedFilterOpen=!j.isAdvancedFilterOpen,j.isAdvancedFilterOpen?(o.classList.remove("hidden"),i.classList.add("bg-gray-900","text-white","border-gray-900"),i.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),i.classList.remove("bg-gray-900","text-white","border-gray-900"),i.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",i=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=i.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filter-start").value=d.toISOString().split("T")[0],document.getElementById("filter-end").value=u.toISOString().split("T")[0],j.startDate=d.toISOString().split("T")[0],j.endDate=u.toISOString().split("T")[0],lt()})})}function Ct(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=j.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function dc(){j.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=j.professionals.map(o=>`
    ...
    `}function Ec(){const t=yc(),e=document.getElementById("kpi-container");e&&(e.innerHTML=`
    ...
    `,ss(),requestAnimationFrame(()=>{const g=t.querySelector("#modal-content-wrapper");g&&(g.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),g.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Lc(){B.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `;let a;const s=(o="")=>{const i=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600 text-lg"></i>',product:'<i class="bi bi-box-seam text-emerald-600 text-lg"></i>'},l={"catalog-service-list":{items:B.catalogForModal.services,type:"service"},"catalog-product-list":{items:B.catalogForModal.products,type:"product"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=t.querySelector("#"+d);if(!p)return;const b=u.filter(y=>y.name.toLowerCase().includes(i)).slice(0,50),g=c==="service"?"hover:border-indigo-400 hover:bg-indigo-50/80 hover:shadow-md":"hover:border-emerald-400 hover:bg-emerald-50/80 hover:shadow-md",v=c==="service"?"bg-indigo-100 border-indigo-200 shadow-sm":"bg-emerald-100 border-emerald-200 shadow-sm";p.innerHTML=b.map(y=>y.id?`
            ...
            `:"").join("")||'<div class="flex flex-col items-center justify-center py-8 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50"><i class="bi bi-inbox text-3xl mb-2"></i><p class="text-[10px] font-bold uppercase tracking-widest">Nenhum resultado</p></div>'})};s();const r=t.querySelector("#item-search-input");r&&(r.addEventListener("input",o=>{clearTimeout(a),a=setTimeout(()=>s(o.target.value),300)}),setTimeout(()=>r.focus(),100)),requestAnimationFrame(()=>{const o=t.querySelector("#modal-content-wrapper");o&&(o.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),o.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Cc(){Ue&&(Re.removeEventListener("click",Ue),Re.removeEventListener("input",Ue),Re.removeEventListener("change",Ue)),Ue=async e=>{if(e.target.classList.contains("item-checkbox")){const i=e.target.value;e.target.checked?B.selectedIds.add(i):B.selectedIds.delete(i),yt(),Ge(),e.stopPropagation();return}if(e.target.id==="packages-layout-detail"){ta(),B.viewMode="list",B.tempPackage=null;return}if(e.target.closest("#batch-delete-btn")){const i=B.selectedIds.size;if(i===0)return;if(await Y("Excluir Pacotes",`Deseja realmente apagar ${i} pacotes selecionados?`))try{const l=Array.from(B.selectedIds).map(d=>Ns(d));await Promise.all(l),f("Sucesso",`${i} pacote(s) excluído(s).`,"success"),B.selectedIds.clear(),yt(),await ba()}catch{f("Erro","Ocorreu um erro ao excluir pacotes.","error")}return}if(e.target.closest("#cancel-selection-btn")){B.selectedIds.clear();const i=document.getElementById("select-all-toggle");i&&(i.checked=!1),yt(),Ge();return}const r=e.target.closest("[data-action]");if(!r)return;switch(r.dataset.action){case"new-package":navigator.vibrate&&navigator.vibrate(20),Ks(null);break;case"edit-package":navigator.vibrate&&navigator.vibrate(15);const i=r.dataset.id,n=B.allPackages.find(k=>k.id===i);n&&Ks(n);break;case"delete-package":e.stopPropagation(),e.preventDefault();const l=r.dataset.id;if(await Y("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await Ns(l),f("Sucesso!","Pacote excluído.","success"),B.viewMode==="edit-package"&&B.tempPackage?.id===l&&(ta(),B.viewMode="list"),await ba()}catch(k){f("Erro",`Não foi possível excluir: ${k.message}`,"error")}break;case"back-to-main":ta(),B.viewMode="list",B.tempPackage=null;break;case"add-item-to-package-btn":kc(),Lc();break;case"back-to-editor":os();break;case"select-catalog-item":navigator.vibrate&&navigator.vibrate(10);const{itemType:u,itemId:c}=r.dataset,b=(B.catalogForModal[u+"s"]||[]).find(k=>k.id===c);if(b){const k=B.tempPackage.items.find(P=>P.id===b.id&&P.type===u);k?k.quantity++:B.tempPackage.items.push({...b,type:u,quantity:1}),os()}break;case"remove-item":navigator.vibrate&&navigator.vibrate(10);const g=parseInt(r.dataset.index,10);B.tempPackage.items.splice(g,1),ss();break;case"toggle-all-ests":const v=document.querySelectorAll(".modal-est-checkbox"),y=Array.from(v).every(k=>k.checked);v.forEach(k=>k.checked=!y);break;case"save-package":await Dc(r);break}},Re.addEventListener("click",Ue),Re.addEventListener("input",e=>{e.target.id==="search-packages"&&(B.searchQuery=e.target.value,Ge()),e.target.id==="finalPrice"&&Ir()}),Re.addEventListener("change",e=>{if(e.target.id==="select-all-toggle"){const a=e.target.checked;B.selectedIds.clear(),a&&B.allPackages.forEach(s=>B.selectedIds.add(s.id)),yt(),Ge()}if(e.target.id==="filter-status"&&(B.statusFilter=e.target.value,Ge()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&B.tempPackage.items[a]&&(B.tempPackage.items[a].quantity=s,ss())}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Ic)}async function Dc(t){const e=B.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const r=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(r.length===0){f("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const o=e.items.reduce((l,d)=>l+d.price*d.quantity,0),i={id:e.id||null,companyId:m.companyId,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:o,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:r,establishmentId:r[0]};if(!i.name||isNaN(i.price)){f("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(i.items.length===0){f("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await Ln(i.id,i):(delete i.id,await In(i)),f("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),ta(),B.viewMode="list",B.tempPackage=null,await ba()}catch(l){f("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const Pc=document.getElementById("content");async function Tc(){const t=he.currentUser;if(!t)return;let e={};try{const l=await is(Ae(me,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(m.userProfessionalId)try{a=await go(m.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=h(e.name||t.displayName||"Usuário"),r=h(t.email||"E-mail não disponível"),o=h(e.phone||"");let i=e.photo||"";a&&a.photo&&(i=a.photo);const n=i||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;Pc.innerHTML=`
    ...
    `,Bc(t),Mc(a)}function Bc(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),r=document.getElementById("profile-avatar"),o=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async i=>{const n=i.target.files[0];if(n)try{const l=await fa(n,800,800,.8);r.src=l,await Tt(Ae(me,"users",t.uid),{photo:l}),m.userProfessionalId&&await Fa(m.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),f("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{f("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),o.addEventListener("submit",async i=>{i.preventDefault();const n=o.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),u=document.getElementById("input-phone").value.trim();try{await Tt(Ae(me,"users",t.uid),{name:d,phone:u}),m.userProfessionalId&&await Fa(m.userProfessionalId,{name:d,phone:u}),m.userName=d,document.getElementById("display-name").textContent=d,f("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{f("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function Mc(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async r=>{r.preventDefault();const o=a.querySelector("#b-date-start").value,i=a.querySelector("#b-date-end").value||o,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!o||!n||!l)return f("Atenção","Preencha Data e Horários corretamente.","error");const u=new Date(`${o}T${n}:00`),c=new Date(`${i}T${l}:00`);if(c<=u)return f("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await ka({establishmentId:m.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:u.toISOString(),endTime:c.toISOString()}),f("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const g=document.getElementById("my-blocks-filter").value;aa(t.id,g)}catch(g){f("Erro",`Falha ao bloquear: ${g.message}`,"error")}finally{p.disabled=!1,p.innerHTML=b}}),document.getElementById("my-blocks-filter").addEventListener("change",r=>aa(t.id,r.target.value)),aa(t.id,"future")}async function aa(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let r,o;e==="history"?(o=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let n=(await wa(m.establishmentId,r.toISOString(),o.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await us(u),f("Removido","O bloqueio foi deletado.","success"),aa(t,e)}catch(c){f("Erro",`Não foi possível remover: ${c.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${h(s.message)}</p>`}}let to=!1;async function ma(t){if(!t)return;t.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const r=(await ve()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),r.length===0)e.innerHTML=`
            ...
            `;else{let o="";r.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';o+=`
                ...
                `}),e.innerHTML=o}to||(Ac(),to=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
        ...
        `}}function Ac(){const t=document.getElementById("form-create-establishment");t&&t.addEventListener("submit",async e=>{e.preventDefault();const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const r={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const o=await ii(r);alert(o.message||"Sucesso!"),t.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await ma(document.getElementById("content"))}catch(o){console.error("Erro ao criar estabelecimento:",o),alert("Erro: "+(o.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>ma(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",e=>e.preventDefault()),document.addEventListener("gesturechange",e=>e.preventDefault()),document.addEventListener("gestureend",e=>e.preventDefault());let t=0;document.addEventListener("touchend",function(e){const a=new Date().getTime();a-t<=300&&e.preventDefault(),t=a},!1)});const le=document.getElementById("loadingScreen"),gt=document.getElementById("dashboardContent"),Ke=document.getElementById("content"),qa=document.getElementById("notificationBell"),Gt=document.getElementById("notificationBadge"),We=document.getElementById("notificationPanel"),ja=document.getElementById("notificationList"),Ie=document.getElementById("profileMenuButton"),ue=document.getElementById("profileDropdown"),ao=document.getElementById("profileName"),so=document.getElementById("profileEmail"),oo=document.getElementById("logoutButton"),ro=document.getElementById("myProfileLink"),io=document.getElementById("hamburger-menu-btn"),ce=document.getElementById("sidebar"),fe=document.getElementById("mobile-overlay"),no=document.getElementById("themeToggleBtn"),Na=document.getElementById("themeIcon"),rs=document.getElementById("mobile-bottom-nav"),lo=document.getElementById("nav-scroll"),qc=document.querySelectorAll(".bottom-nav-item");function jc(){if(!lo)return;const t=document.querySelector(".bottom-nav-item.active");if(!t)return;const e=lo,a=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=s.left+s.width/2-a.left-a.width/2;e.scrollBy({left:o,behavior:"smooth"})}const Nc={"dashboard-section":Qi,"agenda-section":Fo,"comandas-section":_n,"relatorios-section":Wn,"servicos-section":sl,"produtos-section":vl,"suppliers-section":Tl,"profissionais-section":Hl,"clientes-section":Xl,"estabelecimento-section":t=>br(t),"ausencias-section":Ld,"users-section":ca,"sales-report-section":Vd,"financial-section":Wd,"commissions-section":rc,"packages-section":Sc,"my-profile-section":Tc,"hierarquia-section":()=>ma(Ke),"establishments-section":()=>ma(Ke)},Rc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços","produtos-section":"Estoque","suppliers-section":"Parceiros","profissionais-section":"Equipe","clientes-section":"Clientes","estabelecimento-section":"Empresa","ausencias-section":"Ausências","users-section":"Usuários","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro","commissions-section":"Comissões","packages-section":"Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"};function sa(t){document.documentElement.setAttribute("data-theme",t),localStorage.setItem("kairos_theme",t),Na&&(t==="dark"?Na.className="bi bi-sun-fill text-lg sm:text-xl text-amber-400":Na.className="bi bi-moon-fill text-lg sm:text-xl text-slate-500")}function Fc(){const t=localStorage.getItem("kairos_theme"),e=window.matchMedia("(prefers-color-scheme: dark)").matches;sa(t||(e?"dark":"light"))}let Dt=null,Pt=[];function Lr(){if(!Gt||!ja)return;const t=Pt.filter(e=>!e.read).length;if(t>0?(Gt.textContent=t,Gt.classList.remove("hidden")):Gt.classList.add("hidden"),Pt.length===0){ja.innerHTML='<p class="text-center text-slate-500 p-4 text-sm">Nenhuma notificação.</p>';return}ja.innerHTML=Pt.map(e=>`
    ...
    `).join("")}function co(t){Dt&&Dt();const e=ga(me,"establishments",t,"notifications"),a=bo(e,mo("timestamp",">=",new Date),Or("timestamp","desc"));Dt=zr(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();Pt.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),f(o.title,o.message,"info",!0),Lr();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&Fo()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Hc(t){const e=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),r=document.getElementById("multi-context-count"),o=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!e||!o))try{const u=(await ve()).matrizes||[];let c="",p=0;if(u.forEach(b=>{c+=`
            ...
            `,p++,b.branches&&b.branches.length>0&&b.branches.forEach(g=>{c+=`
                    ...
                    `,p++})}),p>0){o.innerHTML=c,e.style.display="block",(!m.selectedEstablishments||m.selectedEstablishments.length===0)&&(m.selectedEstablishments=[t]);const b=Array.from(o.querySelectorAll('input[type="checkbox"]')),g=()=>{const y=b.filter(k=>k.checked);r.textContent=y.length,y.length===0?s.textContent="Nenhuma selecionada":y.length===1?s.textContent=y[0].dataset.name:s.textContent=`${y.length} Unidades`};let v=!1;b.forEach(y=>{m.selectedEstablishments.includes(y.value)&&(y.checked=!0,v=!0)}),!v&&b.length>0&&(b[0].checked=!0,m.selectedEstablishments=[b[0].value],m.establishmentId=b[0].value),g(),a.addEventListener("click",y=>{y.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",y=>{!e.contains(y.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",b.forEach(k=>{k.checked=m.selectedEstablishments.includes(k.value)}),g())}),b.forEach(y=>y.addEventListener("change",g)),i.addEventListener("click",async y=>{y.stopPropagation(),le&&(le.classList.remove("hidden","fade-out"),le.style.display="flex");const k=b.filter(T=>T.checked);if(k.length===0){le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500)),f("Atenção","Selecione pelo menos uma unidade.","warning");return}m.selectedEstablishments=k.map(T=>T.value);const P=m.selectedEstablishments[0];try{const T=await qe(P);m.establishmentId=P,m.establishmentName=T.name,m.enabledModules=T.modules,m.currentViewContext={id:P,name:T.name,type:T.parentId?"BRANCH":"GROUP"},co(P),uo(m.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",f("Ambiente Atualizado","Exibindo dados consolidados.","success");const $=document.querySelector(".sidebar-link.active"),L=$?$.getAttribute("data-target"):"dashboard-section";se(L)}catch{f("Erro","Problema ao trocar a visualização.","error")}finally{le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500))}});try{const y=await qe(m.establishmentId);m.establishmentName=y.name,m.enabledModules=y.modules,m.currentViewContext={id:m.establishmentId,name:y.name,type:y.parentId?"BRANCH":"GROUP"},co(m.establishmentId),uo(m.userPermissions)}catch{}}else e.style.display="none"}catch{e.style.display="none"}}function se(t,e={}){const a=t.replace("-section","");if(t!=="my-profile-section"){const r=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(t),o=m.enabledModules?.[a]!==!1,i=m.userPermissions===null||m.userPermissions[t]?.view===!0;if(!r&&(!o||!i)){Ke&&(Ke.innerHTML='<div class="p-8 text-center mt-10"><i class="bi bi-shield-lock text-5xl text-rose-500 mb-4 block"></i><h2 class="text-2xl font-bold text-slate-800">Acesso Negado</h2><p class="text-slate-500 mt-2">Você não possui permissão para visualizar esta tela.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),ce&&ce.classList.contains("absolute")&&(ce.classList.add("hidden"),fe&&fe.classList.add("hidden"));return}}const s=Nc[t];if(s&&Ke){const r=document.getElementById("header-page-title");r&&(r.textContent=Rc[t]||"Painel"),document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),rs&&(qc.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),setTimeout(jc,50)),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Ke.innerHTML="",window.innerWidth<768&&ce&&(ce.classList.add("hidden"),fe&&fe.classList.add("hidden")),s(e)}}window.navigateTo=se;async function uo(t){const e=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=t===null||t["agenda-section"]?.view===!0,i=t===null||t["financial-section"]?.view===!0;if(o&&e&&(e.classList.remove("hidden"),e.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!o&&!i))try{const n=await yo();o&&s&&(s.textContent=n.todayAppointments.toString()),i&&r&&(r.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch{}}async function Oc(t){try{Se.getPlatform()==="android"&&await de.createChannel({id:"default",name:"Notificações",description:"Alertas",importance:5,visibility:1,vibration:!0});let e=await de.checkPermissions();if(e.receive==="prompt"&&(e=await de.requestPermissions()),e.receive!=="granted")return;await de.register(),de.addListener("registration",async a=>{try{const s=Ae(me,"users",t);await Tt(s,{fcmTokens:Hr(a.value),platform:"native_mobile"})}catch{}}),de.addListener("pushNotificationReceived",a=>f(a.title,a.body,"info",!0)),de.addListener("pushNotificationActionPerformed",()=>se("agenda-section"))}catch{}}function zc(){const t=document.getElementById("exitConfirmationModal"),e=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>t&&(t.style.display="block"),r=()=>t&&(t.style.display="none"),o=()=>t&&t.style.display==="block";t&&(e.addEventListener("click",()=>{r(),Se.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{r(),Se.isNativePlatform()?Ts.exitApp():history.back()}),Se.isNativePlatform()?Ts.addListener("backButton",()=>{if(o())r();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(ce&&!ce.classList.contains("hidden")&&window.innerWidth<768){ce.classList.add("hidden"),fe&&fe.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():se("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(o()){r(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():(se("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Yt(t){return t?t.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function Vc(){try{await Mr(he,Ar)}catch{}Se.isNativePlatform()&&document.body.classList.add("is-app-native"),Vr(),zc(),Fc(),no&&no.addEventListener("click",t=>{t.preventDefault();const e=document.documentElement.getAttribute("data-theme")||"light";sa(e==="dark"?"light":"dark")}),io&&io.addEventListener("click",t=>{t.stopPropagation(),ce&&(ce.classList.remove("hidden"),ce.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),fe&&fe.classList.remove("hidden")}),rs&&rs.addEventListener("click",t=>{const e=t.target.closest(".bottom-nav-item");if(!e)return;t.preventDefault();const a=e.getAttribute("data-target");se(a)}),fe&&fe.addEventListener("click",()=>{ce&&(ce.classList.add("hidden"),ce.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),fe.classList.add("hidden")}),qa&&qa.addEventListener("click",t=>{t.stopPropagation(),We&&(We.classList.toggle("hidden"),We.classList.contains("hidden")||(Pt.forEach(e=>e.read=!0),Lr()))}),Ie&&Ie.addEventListener("click",t=>{t.stopPropagation(),ue&&(ue.classList.toggle("active"),ue.classList.contains("active")?ue.classList.remove("hidden"):setTimeout(()=>ue.classList.add("hidden"),200))}),ro&&ro.addEventListener("click",t=>{t.preventDefault(),se("my-profile-section"),ue&&(ue.classList.remove("active"),ue.classList.add("hidden"))}),window.addEventListener("userPhotoUpdated",t=>{const e=t.detail;Ie&&e&&(Ie.innerHTML=`<img src="${e}" alt="Avatar" class="w-full h-full rounded-full object-cover">`)}),document.addEventListener("click",t=>{We&&!We.contains(t.target)&&t.target!==qa&&We.classList.add("hidden"),ue&&!ue.contains(t.target)&&t.target!==Ie&&ue.classList.contains("active")&&(ue.classList.remove("active"),setTimeout(()=>ue.classList.add("hidden"),200))}),qr(he,async t=>{if(t){if(!Se.isNativePlatform()&&(Ii(),"Notification"in window&&Notification.permission==="default")){const e=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");e&&setTimeout(()=>{e.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Li()&&e&&(e.style.display="none")});const s=()=>{e&&(e.style.display="none")},r=document.getElementById("btn-deny-toast"),o=document.getElementById("btn-close-toast");r&&r.addEventListener("click",s),o&&o.addEventListener("click",s)}try{const a=(await t.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,r=t.displayName,o=null,i=null;const n=Ae(me,"users",t.uid),l=await is(n);if(l.exists()){const u=l.data();s=a.role==="employee"?u.permissions||{}:null,r=u.name||r,o=u.professionalId||null,i=u.photo||null}if(m.userProfessionalId=o,o&&!i)try{const u=await go(o);u&&u.photo&&(i=u.photo)}catch{}Se.isNativePlatform()&&Oc(t.uid);const d=r||t.email;Wr(a.establishmentId,"Carregando...",s),i?Ie&&(Ie.innerHTML=`<img src="${i}" class="w-full h-full rounded-full object-cover">`):Ie&&(Ie.textContent=d.charAt(0).toUpperCase()),ao&&(ao.textContent=d),so&&(so.textContent=t.email),oo&&oo.addEventListener("click",u=>{u.preventDefault(),Dt&&Dt(),jr(he).then(()=>window.location.href="/login.html")}),await Hc(a.establishmentId),ri(se,s,m.enabledModules),le&&(le.classList.add("fade-out"),setTimeout(()=>{le.style.display="none"},500)),gt&&(gt.style.display="flex"),setTimeout(()=>{pi()},1500),se("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(e){le&&(le.style.display="none"),gt&&(gt.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><i class="bi bi-x-circle text-5xl text-rose-500 mb-4"></i><h2 class="text-xl font-bold">Erro de Acesso</h2><p class="text-slate-500 mt-2">${e.message}</p></div>`,gt.style.display="flex")}}else window.location.href="/login.html"})}Vc();export{xo as W};
