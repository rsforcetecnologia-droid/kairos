const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-DSHgAxl4.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-C2XZ_b0c.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as U,d as J,m as Ga}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Js,reauthenticateWithCredential as Ws,verifyBeforeUpdateEmail as Gs,updatePassword as Ys,updateProfile as Qs,setPersistence as Xs,browserLocalPersistence as Zs,onAuthStateChanged as Oo,signOut as Ya}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as ge,getDoc as zo,updateDoc as Ca,setDoc as Ks,addDoc as Vo,collection as be,query as Ut,where as dt,getDocs as La,orderBy as Uo,writeBatch as _o,serverTimestamp as Qa,deleteDoc as er,arrayUnion as tr,onSnapshot as ar}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as or,onMessage as sr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function rr(e,t,a){m.establishmentId=e,m.establishmentName=t,m.userPermissions=a,m.currentViewContext={type:"BRANCH",id:e,name:t}}const Jo=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ga=Jo?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${Jo?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",ga);async function nr(){const e=U.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function E(e,t={}){const a=await nr();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const o=ga.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,s=`${o}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${s}`);try{const n=await fetch(s,{...t,headers:{...a,...t.headers}});if(!n.ok){const d=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(d.includes("FAILED_PRECONDITION")&&d.includes("requires an index")){const l=/(https:\/\/[^\s]+)/,c=d.match(l),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${s}:`,d),new Error(d)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${s}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ga}. Verifique se o servidor backend está rodando.`):n}}const Wo=(e,t,a,o=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(r+=`&professionalId=${o}`),E(r)},ir=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return E(r)},lr=e=>E("/api/appointments",{method:"POST",body:JSON.stringify(e)}),dr=(e,t)=>E(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Xa=e=>E(`/api/appointments/${e}`,{method:"DELETE"}),cr=e=>E(`/api/appointments/${e}/reopen`,{method:"POST"}),ur=(e,t)=>E(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let W;async function mr(){if(!W)try{W=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function pr(){if(!W){console.warn("AudioContext não inicializado. O som não será tocado.");return}W.state==="suspended"&&W.resume();const e=W.createOscillator(),t=W.createGain();e.connect(t),t.connect(W.destination),e.type="sine",e.frequency.setValueAtTime(800,W.currentTime),t.gain.setValueAtTime(0,W.currentTime),t.gain.linearRampToValueAtTime(.3,W.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,W.currentTime+.2),e.start(W.currentTime),e.stop(W.currentTime+.2)}function g(e,t,a="info",o=!1){const r=document.getElementById("toast-container");if(!r)return;o&&pr();const s=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},d={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${n[a]||n.info}`,s.innerHTML=`
    ...
    `;const d=r.querySelector("[data-close-modal]");d&&(d.onclick=n);const l=r.querySelector('[data-action="close-modal"]');return l&&(l.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function _t(e){const t=document.getElementById(e);t&&(t.style.display="none")}function gr(){document.body.addEventListener("click",()=>{W||mr()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const o=t.dataset.target;if(o){const r=document.getElementById(o);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const o=document.getElementById("genericModal");o&&(o.style.display="none")}})}const Y=document.getElementById("sidebar"),Za=document.getElementById("sidebarToggle"),et=document.getElementById("mainContent"),br=document.querySelectorAll(".sidebar-link"),Ka=document.getElementById("hamburger-menu-btn"),Ve=document.getElementById("mobile-overlay"),eo=document.getElementById("cadastros-menu-btn"),me=document.getElementById("cadastros-submenu"),sa=document.getElementById("cadastros-arrow");function tt(e){!Y||!et||(Y.classList.toggle("collapsed",e),et.classList.toggle("sidebar-collapsed-shift",e),e&&me&&!me.classList.contains("hidden")&&Go(!0))}function fr(){!Y||!Ve||(Y.classList.add("mobile-open"),Ve.classList.add("visible"))}function vt(){!Y||!Ve||(Y.classList.remove("mobile-open"),Ve.classList.remove("visible"))}function vr(){tt(!Y.classList.contains("collapsed"))}function Go(e=!1){if(!me||!sa)return;const t=me.classList.contains("hidden");e||!t?(me.classList.add("hidden"),me.classList.remove("flex"),sa.classList.remove("rotate-180")):(window.innerWidth>=1024&&Y.classList.contains("collapsed")&&tt(!1),me.classList.remove("hidden"),me.classList.add("flex"),sa.classList.add("rotate-180"))}function hr(e,t,a){if(!Y||!et)return;et.classList.add("main-content-shift"),window.innerWidth>=768?tt(Y.classList.contains("collapsed")):(et.classList.remove("main-content-shift","sidebar-collapsed-shift"),vt()),Za&&Za.addEventListener("click",r=>{r.stopPropagation(),vr()}),Y.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&Y.classList.contains("collapsed")&&tt(!1)}),Y.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||tt(!0))}),Ka&&Ka.addEventListener("click",r=>{r.stopPropagation(),fr()}),Ve&&Ve.addEventListener("click",r=>{r.stopPropagation(),vt()});let o=0;Y.addEventListener("touchstart",r=>{o=r.changedTouches[0].screenX},{passive:!0}),Y.addEventListener("touchend",r=>{const s=r.changedTouches[0].screenX;o-s>50&&vt()},{passive:!0}),eo&&eo.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),Go()}),br.forEach(r=>{const s=r.getAttribute("data-target");if(!s)return;const n=s.replace("-section",""),i=a?.[n]!==!1,d=t===null||t[s]?.view===!0;if(!i||!d){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",l=>{l.preventDefault(),s&&typeof e=="function"&&e(s),window.innerWidth<768&&vt()})})}const xr=e=>E("/api/establishments/groups",{method:"POST",body:JSON.stringify({name:e})}),yr=(e,t,a)=>E("/api/establishments/companies",{method:"POST",body:JSON.stringify({name:e,cnpj:t,groupId:a})}),wr=e=>E("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),kr=()=>E("/api/establishments/hierarchy",{method:"GET"}),Ie=e=>{const t=e||m.establishmentId;return t?E(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Tt=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Sr=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},$r=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ee=e=>E(`/api/professionals/${e}`),Er=e=>E(`/api/professionals/details/${e}`),Yo=e=>E("/api/professionals",{method:"POST",body:JSON.stringify(e)}),At=(e,t)=>E(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),to=(e,t)=>At(e,{services:t}),Qo=e=>E(`/api/professionals/${e}`,{method:"DELETE"}),Ir=e=>{const t=e.map(a=>Qo(a));return Promise.all(t)},fe=e=>E(`/api/services/${e}`),Xo=e=>E("/api/services",{method:"POST",body:JSON.stringify(e)}),Cr=(e,t)=>E(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Lr=e=>E(`/api/services/${e}`,{method:"DELETE"}),Tr=(e,t)=>E(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Br=e=>E(`/api/services/stats/most-popular/${e}`),pt=e=>E(`/api/products/${e}`),Zo=e=>E("/api/products",{method:"POST",body:JSON.stringify(e)}),Dr=(e,t)=>E(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),Pr=e=>E(`/api/products/${e}`,{method:"DELETE"}),Mr=(e,t)=>E(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),Ar=({startDate:e,endDate:t,productId:a,categoryId:o,establishmentId:r})=>{const s=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&s.append("productId",a),o&&o!=="all"&&s.append("categoryId",o),r&&s.append("establishmentId",r),E(`/api/products/stock-history/report?${s.toString()}`)},qr={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function ao(e,t,a){return new Promise((o,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const d=document.createElement("canvas");let l=i.width,c=i.height;l>t&&(c*=t/l,l=t),d.width=l,d.height=c,d.getContext("2d").drawImage(i,0,0,l,c);const p=e.type==="image/png"&&t<500?"image/png":"image/jpeg";o(d.toDataURL(p,a))},i.onerror=d=>r(d)},s.onerror=n=>r(n)})}let pe=null;const Bt=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let te=0,qt=[];async function Nr(){try{console.log("Iniciando verificação de Onboarding para ID:",m.establishmentId);const e=await Ie(m.establishmentId),t=await ee(m.establishmentId),a=await fe(m.establishmentId);qt=a||[];const o=e&&e.name&&(e.phone||e.address),r=e&&(e.logo||e.themeColor&&e.themeColor!=="indigo"),s=e&&e.slotInterval>0,n=a&&a.length>0,i=t&&t.length>0;if(console.log("Status Onboarding:",{hasCompanyData:o,hasBranding:r,hasTimeConfig:s,hasService:n,hasProf:i}),o&&s&&i&&n)return;if(!o)te=0;else if(!r&&!s)te=1;else if(!s)te=2;else if(!n)te=3;else if(!i)te=4;else if(te===0)return;Rr(),Ba(te)}catch(e){console.error("Erro ao verificar onboarding:",e)}}function Rr(){document.getElementById("onboarding-overlay")||(pe=document.createElement("div"),pe.id="onboarding-overlay",pe.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",pe.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",pe.innerHTML=`
    ...
    `,document.body.appendChild(pe),Ta())}function Ta(){const e=Math.round(te/Bt.length*100),t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width=`${e}%`),a&&(a.innerText=`${e}%`)}function Ba(e){const t=document.getElementById("onboarding-step-content"),a=Bt[e];if(!a){oo(t);return}let o="";if(a.id==="company_data")o=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(qr).map(([s,n])=>`<option value="${s}">${n.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
        ...
        `;else if(a.id==="first_prof"){const r=qt.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""),s=qt.length>0;o=`
            <form id="step-form" class="space-y-3">
        ...
        <div class="mt-6 flex justify-end gap-2">
            ...
            <button type="button" id="next-step-btn" class="bg-indigo-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-indigo-700 transition flex items-center gap-2 text-sm">
                ${e===Bt.length-1?"Concluir":"Próximo"}
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
            </button>
        </div>
    `,document.getElementById("next-step-btn").addEventListener("click",()=>jr(a.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===Bt.length-1?oo(t):(te++,Ta(),Ba(te))}),a.id==="branding"){const r=document.getElementById("logo-input"),s=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const d=await ao(i,200,.8);document.getElementById("logo-base64").value=d,document.getElementById("logo-preview").innerHTML=`<img src="${d}" class="w-full h-full object-contain rounded">`}catch(d){console.error("Erro logo",d)}}),s&&(s.onchange=async n=>{const i=n.target.files[0];if(i)try{const d=await ao(i,1024,.7);document.getElementById("bg-base64").value=d}catch(d){console.error("Erro bg",d)}})}}function oo(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{pe&&pe.remove(),window.location.reload()}}async function jr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),o=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),s=Object.fromEntries(r.entries());try{if(e==="company_data")await Tt(m.establishmentId,{name:s.name,phone:s.phone,email:s.email,address:s.address,zipCode:s.zipCode});else if(e==="branding"){const n={};s.logoBase64&&(n.logo=s.logoBase64),s.bgBase64&&(n.backgroundImage=s.bgBase64),s.themeColor&&(n.themeColor=s.themeColor),s.primaryColor&&(n.primaryColor=s.primaryColor),Object.keys(n).length>0&&await Tt(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(s.slotInterval);await Tt(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Xo({establishmentId:m.establishmentId,name:s.name,price:parseFloat(s.price),duration:parseInt(s.duration),active:!0});n&&qt.push(n)}else if(e==="first_prof"){const n=await Yo({establishmentId:m.establishmentId,name:s.name,specialty:s.role,active:!0,commissionRate:0});if(s.serviceId&&n&&n.id)try{to?await to(n.id,[s.serviceId]):At&&await At(n.id,{services:[s.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Zo({establishmentId:m.establishmentId,name:s.name,price:parseFloat(s.salePrice),stock:parseInt(s.stock),active:!0});g("Sucesso","Passo concluído!","success"),te++,Ta(),Ba(te)}catch(n){g("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=o}}var Ue;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ue||(Ue={}));class ra extends Error{constructor(t,a,o){super(t),this.message=t,this.code=a,this.data=o}}const Fr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Hr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},o=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:Fr(e),s=()=>r()!=="web",n=u=>{const p=l.get(u);return!!(p?.platforms.has(r())||i(u))},i=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===u)},d=u=>e.console.error(u),l=new Map,c=(u,p={})=>{const b=l.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const v=r(),h=i(u);let y;const w=async()=>(!y&&v in p?y=typeof p[v]=="function"?y=await p[v]():y=p[v]:t!==null&&!y&&"web"in p&&(y=typeof p.web=="function"?y=await p.web():y=p.web),y),$=(B,M)=>{var R,F;if(h){const O=h?.methods.find(j=>M===j.name);if(O)return O.rtype==="promise"?j=>a.nativePromise(u,M.toString(),j):(j,Q)=>a.nativeCallback(u,M.toString(),j,Q);if(B)return(R=B[M])===null||R===void 0?void 0:R.bind(B)}else{if(B)return(F=B[M])===null||F===void 0?void 0:F.bind(B);throw new ra(`"${u}" plugin is not implemented on ${v}`,Ue.Unimplemented)}},k=B=>{let M;const R=(...F)=>{const O=w().then(j=>{const Q=$(j,B);if(Q){const Ce=Q(...F);return M=Ce?.remove,Ce}else throw new ra(`"${u}.${B}()" is not implemented on ${v}`,Ue.Unimplemented)});return B==="addListener"&&(O.remove=async()=>M()),O};return R.toString=()=>`${B.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:B,writable:!1,configurable:!1}),R},C=k("addListener"),T=k("removeListener"),A=(B,M)=>{const R=C({eventName:B},M),F=async()=>{const j=await R;T({eventName:B,callbackId:j},M)},O=new Promise(j=>R.then(()=>j({remove:F})));return O.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},O},q=new Proxy({},{get(B,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?A:C;case"removeListener":return T;default:return k(M)}}});return o[u]=q,l.set(u,{name:u,proxy:q,platforms:new Set([...Object.keys(p),...h?[v]:[]])}),q};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=d,a.isNativePlatform=s,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=ra,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Or=e=>e.Capacitor=Hr(e),se=Or(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Jt=se.registerPlugin;class Ko{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let o=!1;this.listeners[t]||(this.listeners[t]=[],o=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),o&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,o){const r=this.listeners[t];if(!r){if(o){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}r.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:o=>{this.notifyListeners(a,o)}}}unimplemented(t="not implemented"){return new se.Exception(t,Ue.Unimplemented)}unavailable(t="not available"){return new se.Exception(t,Ue.Unavailable)}async removeListener(t,a){const o=this.listeners[t];if(!o)return;const r=o.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(o=>{this.notifyListeners(t,o)}))}}const so=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),ro=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class zr extends Ko{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(o=>{if(o.length<=0)return;let[r,s]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=ro(r).trim(),s=ro(s).trim(),a[r]=s}),a}async setCookie(t){try{const a=so(t.key),o=so(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${o||""}${r}; path=${s}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Jt("CapacitorCookies",{web:()=>new zr});const Vr=async e=>new Promise((t,a)=>{const o=new FileReader;o.onload=()=>{const r=o.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},o.onerror=r=>a(r),o.readAsDataURL(e)}),Ur=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,s,n)=>(r[s]=e[t[n]],r),{})},_r=(e,t=!0)=>e?Object.entries(e).reduce((o,r)=>{const[s,n]=r;let i,d;return Array.isArray(n)?(d="",n.forEach(l=>{i=t?encodeURIComponent(l):l,d+=`${s}=${i}&`}),d.slice(0,-1)):(i=t?encodeURIComponent(n):n,d=`${s}=${i}`),`${o}&${d}`},"").substr(1):null,Jr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Ur(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))s.set(n,i);a.body=s.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,d)=>{s.append(d,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);a.body=s;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Wr extends Ko{async request(t){const a=Jr(t,t.webFetchExtra),o=_r(t.params,t.shouldEncodeUrlParams),r=o?`${t.url}?${o}`:t.url,s=await fetch(r,a),n=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};n.includes("application/json")&&(i="json");let d,l;switch(i){case"arraybuffer":case"blob":l=await s.blob(),d=await Vr(l);break;case"json":d=await s.json();break;case"document":case"text":default:d=await s.text()}const c={};return s.headers.forEach((u,p)=>{c[p]=u}),{data:d,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Jt("CapacitorHttp",{web:()=>new Wr});const G=Jt("PushNotifications",{}),Gr="modulepreload",Yr=function(e){return"/"+e},no={},Qr=function(t,a,o){let r=Promise.resolve();if(a&&a.length>0){let d=function(l){return Promise.all(l.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");r=d(a.map(l=>{if(l=Yr(l),l in no)return;no[l]=!0;const c=l.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Gr,c||(p.as="script"),p.crossOrigin="",p.href=l,i&&p.setAttribute("nonce",i),document.head.appendChild(p),c)return new Promise((b,v)=>{p.addEventListener("load",b),p.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return r.then(n=>{for(const i of n||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})},io=Jt("App",{web:()=>Qr(()=>import("./web-DSHgAxl4.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Xr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let lo=!1;async function es(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{os(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const o=a.notification.data;console.log("Notificação clicada (Ação):",o)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&as()}async function ts(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await as(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function as(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await or(Ga,{vapidKey:Xr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await os(t,!1)):console.warn("[Push Web] Token veio vazio."),lo||(sr(Ga,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),lo=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function os(e,t){const a=U.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const o=ge(J,"users",a.uid);try{const r=await zo(o);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Ca(o,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Ks(o,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(s){console.error("Erro ao criar user:",s)}else console.error("Erro ao atualizar token:",r)}}const Zr=(e,t,a="all",o="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),o&&o!=="all"&&r.append("costCenterId",o),E(`/api/reports/indicators?${r.toString()}`)},Kr=e=>e?E(`/api/financial/cost-centers/${e}`):Promise.resolve([]),en=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:o})=>{const r=new URLSearchParams({startDate:t,endDate:a});return o&&o!=="all"&&r.append("cashierSessionId",o),e&&r.append("establishmentId",e),E(`/api/reports/sales?${r.toString()}`)},tn=()=>E("/api/reports/summary",{method:"GET"}),Wt=(e,t,a,o="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${o}`;return E(r)},Gt=e=>E("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Da=e=>E(`/api/blockages/${e}`,{method:"DELETE"}),ss=e=>E("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Pa=e=>e?String(e).replace(/\D/g,""):"",Yt=(e,t="",a=20,o={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),o&&o.hasLoyalty&&r.append("hasLoyalty","true"),o&&o.birthMonth&&r.append("birthMonth",o.birthMonth),o&&o.inactiveDays&&r.append("inactiveDays",o.inactiveDays),E(`/api/clients/${e}?${r.toString()}`)},rs=(e,t)=>{const a=encodeURIComponent(t);return E(`/api/clients/details/${e}/${a}`)},ns=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Pa(t),o={...e,phone:a,id:a};return E(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(o)})},Ma=ns,is=(e,t)=>ns({...t,id:e}),an=e=>{const t=encodeURIComponent(e);return E(`/api/clients/${t}`,{method:"DELETE"})},on=(e,t,a,o)=>E("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Pa(t),points:a,rewardName:o})}),sn=(e,t)=>rs(e,Pa(t));function f(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function ls(e,t=800,a=800,o=.7){return new Promise((r,s)=>{if(!e.type.match(/image.*/))return s(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const d=new Image;d.src=i.target.result,d.onload=()=>{let l=d.width,c=d.height;l>c?l>t&&(c*=t/l,l=t):c>a&&(l*=a/c,c=a);const u=document.createElement("canvas");u.width=l,u.height=c,u.getContext("2d").drawImage(d,0,0,l,c);const b=u.toDataURL("image/jpeg",o);r(b)},d.onerror=l=>s(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>s(new Error("Erro ao ler o ficheiro."))})}const co=document.getElementById("content");let uo=!1;const ba=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let gt=[],Qt=[],_e={},Re=[],L={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},I={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function rn(e){return new Intl.DateTimeFormat("pt-BR",{day:"2-digit",month:"2-digit"}).format(e)}function ds(e){const t=new Date(e);if(t.setHours(0,0,0,0),L.currentView==="week"&&L.weekViewDays===7){const a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(o))}return t}function Nt(){const e=document.getElementById("profSelectorContainer"),t=L.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let a=m.professionals.filter(s=>L.showInactiveProfs||s.status!=="inactive");t&&(a=a.filter(s=>s.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(s=>{const n=L.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],d=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),l=s.status!=="inactive",c=f(i),u=ba[0],p=s.id!=="all"&&m.professionalColors.get(s.id)||u,b=s.photo||`https://placehold.co/64x64/${p.main?.replace("#","")||"E0E7FF"}/${p.light?.replace("#","")||"4F46E5"}?text=${d}`,v=s.id==="all"?"#e0e7ff":p.light,h=s.id==="all"?"#4f46e5":p.main,w=`border: 3px solid ${n?p.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+p.border:"none"};`;return`
        ...
        `}).join("")}function nn(e,t,a,o,r){const s=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${o} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,l=encodeURIComponent(d);return`https://wa.me/${s}?text=${l}`}function ln(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((o,r)=>new Date(o.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(o=>{const r=new Date(o.startTime),s=new Date(o.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=m.professionalColors.get(o.professionalId)||{},l=f(o.reason),c=f(o.professionalName),u=f(o.clientName),p=f(o.serviceName),b=L.selectedItems.has(o.id),v=L.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const h=o.status==="completed",y=h?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",w=h?"Finalizado":"Aberto",$=JSON.stringify(o).replace(/'/g,"&apos;"),k=o.redeemedReward?.points>0,C=o.hasRewards&&!k,T=nn(o.clientPhone,o.clientName,o.serviceName,o.professionalName,o.startTime),A=L.isSelectionMode?"":'data-action="open-comanda"';return`
            ...
            </div>`}).join("");t.innerHTML=`<div class="list-view-container space-y-2 pb-24">${a}</div>`}function cs(){return L.weekViewDays}function dn(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"],o=ds(L.currentDate),r=cs(),i=100/(window.innerWidth<768?3:r),d=`flex: 0 0 ${i}%; width: ${i}%; max-width: ${i}%; box-sizing: border-box; overflow: hidden;`;let l=`
        <style>
    ...
    `;for(let c=0;c<r;c++){const u=new Date(o);u.setDate(u.getDate()+c);const p=new Date,b=u.toDateString()===p.toDateString(),v=e.filter(w=>new Date(w.startTime).toDateString()===u.toDateString()).sort((w,$)=>new Date(w.startTime)-new Date($.startTime));let h='<div class="flex-grow overflow-y-auto overflow-x-hidden px-1 py-1.5 space-y-2 pb-24 min-w-0">';v.length>0?h+=v.map(w=>{const k=new Date(w.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),C=m.professionalColors.get(w.professionalId)||{main:"#9ca3af"},T=f(w.reason),A=f(w.professionalName||"Indefinido"),q=f(w.clientName),B=f(w.serviceName);if(w.type==="blockage")return`
                    ...
                    <div class="relative p-1.5 rounded-md bg-white border border-gray-100 shadow-sm cursor-pointer hover:shadow-md transition-all duration-200 overflow-hidden min-w-0 w-full flex flex-col" 
                        ...
                        <div class="pl-1 min-w-0 w-full flex flex-col h-full justify-center">
                            ...
                            <p class="text-[9px] text-gray-500 truncate mt-0.5 leading-tight w-full">${B}</p>
        ...
        `}l+="</div>",t.innerHTML=l,setTimeout(()=>{const c=t.querySelector(".agenda-scroll-container"),u=c?.querySelector(".bg-indigo-600");if(c&&u){const p=u.parentElement;c.scrollTo({left:p.offsetLeft,behavior:"smooth"})}},150)}function us(){const e=m.allEvents.filter(t=>L.selectedProfessionalId==="all"||t.professionalId===L.selectedProfessionalId);L.currentView==="list"?ln(e):dn(e),Aa()}function Aa(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(L.isSelectionMode&&L.selectedItems.size>0?(e.innerHTML=`
        ...
        `,e.style.display="block",t&&(t.style.display="none")):(e.style.display="none",t&&(t.style.display="flex")))}async function oe(){const e=document.getElementById("agenda-view");if(!e)return;L.selectedItems.clear(),Aa(),e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const o=document.getElementById("weekRange");if(!o)return;if(L.currentView==="list")t=new Date(L.currentDate),t.setHours(0,0,0,0),a=new Date(L.currentDate),a.setHours(23,59,59,999),o.textContent=rn(t);else{const s=cs();t=ds(new Date(L.currentDate)),a=new Date(t),a.setDate(t.getDate()+(s-1)),a.setHours(23,59,59,999);const n=t.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=a.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"});o.textContent=`${n} a ${i}`}const r=document.getElementById("dateFilterInput");if(r){const s=L.currentDate,n=s.getFullYear(),i=String(s.getMonth()+1).padStart(2,"0"),d=String(s.getDate()).padStart(2,"0");r.value=`${n}-${i}-${d}`}try{const s=await Wo(m.establishmentId,t.toISOString(),a.toISOString(),L.selectedProfessionalId==="all"?null:L.selectedProfessionalId),n=await Wt(m.establishmentId,t.toISOString(),a.toISOString(),L.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const i=n.map(l=>{let c=l.professionalName;if(!c&&l.professionalId){const u=m.professionals?m.professionals.find(p=>p.id===l.professionalId):null;u&&(c=u.name)}return{...l,type:"blockage",professionalName:c||"Não identificado"}}),d=[...s.map(l=>({...l,type:"appointment"})),...i];if(m.allEvents=d,Nt(),us(),L.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${L.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),L.scrollToAppointmentId=null}}catch(s){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',g("Erro na Agenda",`Não foi possível carregar a agenda: ${s.message}`,"error"))}}async function cn(){try{const[e,t,a]=await Promise.all([m.professionals&&m.professionals.length>0?Promise.resolve(m.professionals):ee(m.establishmentId),m.services&&m.services.length>0?Promise.resolve(m.services):fe(m.establishmentId),_e.enabled!==void 0?Promise.resolve(null):Ie(m.establishmentId)]);(!m.professionals||m.professionals.length===0)&&(m.professionals=e||[]),(!m.services||m.services.length===0)&&(m.services=t||[]),Re=[],a&&(_e=a.loyaltyProgram||{enabled:!1}),m.professionals.forEach((o,r)=>{m.professionalColors.set(o.id,ba[r%ba.length])}),Nt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function fa(e){e<1||e>4||(I.step=e,va(null,!0))}function ms(e,t){const a=document.getElementById("multiServiceToggle"),o=a&&a.checked,r=t.classList.contains("selected"),s=I.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),s>-1&&I.data.selectedServiceIds.splice(s,1);else{if(!o){I.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),I.data.selectedServiceIds.push(e)}}function ps(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const o=Qt.find(r=>r.id===e);I.data.professionalId=e,I.data.professionalName=o?o.name:"N/A"}function un(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(o=>o.classList.remove("selected")),t.classList.add("selected"),I.data.time=e)}async function mo(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=I.data.professionalId,o=I.data.selectedServiceIds,r=document.getElementById("apptDate").value;I.data.date=r;const s=o.reduce((n,i)=>{const d=gt.find(l=>l.id===i);return n+(d?d.duration+(d.bufferTime||0):0)},0);if(e.textContent=`${s} min`,s===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await ir({establishmentId:m.establishmentId,professionalId:a,serviceIds:o,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const l=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[u,p]=c.split(":").map(Number);return u*60+p>=l})}if(t.innerHTML="",n.length>0){if(n.forEach(l=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${I.data.time===l?"selected":""}`,c.textContent=l,c.addEventListener("click",()=>un(l,c)),t.appendChild(c)}),I.data.time){const l=t.querySelector(`[data-action="time-slot"][data-time="${I.data.time}"]`);l&&l.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function mn(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:o}=I.data,{enabled:r,rewards:s}=_e;if(!r||!t||!s||s.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const n=s.filter(d=>a>=d.points);let i=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",d=>{d.target.checked&&(I.data.redeemedReward=null)})}async function pn(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!I.data.time||I.data.selectedServiceIds.length===0||!I.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const o=I.data.selectedServiceIds.map(l=>{const c=gt.find(u=>u.id===l);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,s]=I.data.time.split(":"),n=new Date(`${I.data.date}T${r}:${s}:00`),i={establishmentId:m.establishmentId,clientName:I.data.clientName,clientPhone:I.data.clientPhone,services:o,professionalId:I.data.professionalId,startTime:n.toISOString(),redeemedReward:I.data.redeemedReward},d=t.querySelector("#appointmentId").value;d&&(i.id=d);try{d?await dr(d,i):await lr(i),g(`Agendamento ${d?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",oe()}catch(l){g(l.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function gs(e){const t=I.data.clientName===e.name&&I.data.clientPhone===e.phone,a=f(e.name),o=f(e.phone);return`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",bn)}function vn(){fn()}function hn(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",o=`
    ...
    `;return{title:a,content:o}}function xn(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${gt.map(o=>{const r=I.data.selectedServiceIds.includes(o.id),s=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=f(o.name);return`
    ...
    `;return{title:e,content:a}}function yn(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Qt.map(a=>{const o=I.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",s=f(a.name);return`
    ...
    `;return{title:e,content:t}}function wn(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=I.data.date||o,s=f(I.data.clientName),n=f(I.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function kn(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),o=gt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=I.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${s?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>ms(r.dataset.serviceId,r))})}function Sn(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),o=Qt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=I.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=f(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>ps(r.dataset.professionalId,r))})}async function va(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const s=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(I={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:s,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}},e&&e.clientName)try{const i=await Yt(m.establishmentId,e.clientName),d=i.find(l=>l.phone===e.clientPhone);d&&(I.data.clientLoyaltyPoints=d.loyaltyPoints||0,Re=i)}catch(i){console.warn("Não foi possível carregar pontos do cliente para edição:",i)}}if(!m.services||!m.professionals||_e.enabled===void 0){g("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(gt=m.services,Qt=m.professionals.filter(s=>s.status==="active"),I.data.clientLoyaltyPoints>0){const s=_e,n=Math.min(...(s?.rewards||[]).map(i=>i.points));I.data.clientHasRewards=s.enabled&&n!==1/0&&I.data.clientLoyaltyPoints>=n}let o={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(I.step){case 1:o=hn(e);break;case 2:o=xn();break;case 3:o=yn();break;case 4:o=wn(e);break}a.innerHTML=`
        ...
        </section>`;const t=document.getElementById("btn-toggle-filters"),a=document.getElementById("filters-panel");t&&a&&t.addEventListener("click",()=>{a.classList.toggle("hidden"),a.classList.toggle("flex"),t.classList.toggle("bg-blue-50"),t.classList.toggle("text-blue-600"),t.classList.toggle("border-blue-300")});const o=document.getElementById("btn-toggle-select");o.addEventListener("click",()=>{L.isSelectionMode=!L.isSelectionMode,L.isSelectionMode||L.selectedItems.clear(),o.classList.toggle("bg-blue-100",L.isSelectionMode),o.classList.toggle("text-blue-700",L.isSelectionMode),o.classList.toggle("border-blue-300",L.isSelectionMode),us()}),document.querySelectorAll(".view-btn[data-view]").forEach(r=>{r.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(n=>n.classList.remove("bg-white","shadow-sm")),r.classList.add("bg-white","shadow-sm"),L.currentView=r.dataset.view;const s=document.getElementById("week-days-toggle");if(L.currentView==="week"){if(s.classList.remove("hidden"),s.classList.add("flex"),window.innerWidth<768){L.weekViewDays=7,document.querySelectorAll(".week-days-btn").forEach(i=>i.classList.remove("bg-white","shadow-sm"));const n=document.querySelector('.week-days-btn[data-days="7"]');n&&n.classList.add("bg-white","shadow-sm")}}else s.classList.remove("flex"),s.classList.add("hidden");oe()})}),document.querySelectorAll(".week-days-btn").forEach(r=>{r.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(s=>s.classList.remove("bg-white","shadow-sm")),r.classList.add("bg-white","shadow-sm"),L.weekViewDays=parseInt(r.dataset.days,10),oe()})}),document.getElementById("todayBtn").addEventListener("click",()=>{L.currentDate=new Date,oe()}),document.getElementById("dateFilterInput").addEventListener("change",r=>{if(r.target.value){const[s,n,i]=r.target.value.split("-");L.currentDate=new Date(s,n-1,i),oe()}}),document.getElementById("profSearchInput").addEventListener("input",r=>{L.profSearchTerm=r.target.value,Nt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",r=>{L.showInactiveProfs=r.target.checked,Nt(),oe()}),uo||(co.addEventListener("click",async r=>{const s=r.target.closest("[data-action]");if(r.target.dataset.action==="toggle-select-item"){const l=r.target.dataset.id;r.target.checked?L.selectedItems.add(l):L.selectedItems.delete(l),Aa();return}if(s&&s.dataset.action==="batch-delete"){const l=L.selectedItems.size;if(await H("Excluir em Lote",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)){const u=Array.from(L.selectedItems);let p=0;try{await Promise.all(u.map(async v=>{try{await Xa(v),p++}catch(h){console.error(`Falha ao excluir ${v}`,h)}})),g(`${p} agendamento(s) excluído(s).`,"success"),L.selectedItems.clear(),L.isSelectionMode=!1;const b=document.getElementById("btn-toggle-select");b&&b.classList.remove("bg-blue-100","text-blue-700","border-blue-300"),oe()}catch{g("Erro ao processar exclusão em lote.","error")}}return}if(r.target.closest('[data-action="select-professional"]')){const c=r.target.closest('[data-action="select-professional"]').dataset.profId,u=L.selectedProfessionalId===c&&c!=="all";if(L.selectedProfessionalId=u?"all":c,c!=="all"){const p=document.getElementById("profSearchInput");p&&(p.value=""),L.profSearchTerm=""}await oe();return}if(!s)return;const n=s.dataset.action;let i=null;const d=r.target.closest("[data-appointment]");switch(d&&(i=JSON.parse(d.dataset.appointment.replace(/&apos;/g,"'"))),n){case"new-appointment":va();break;case"edit-appointment":if(L.isSelectionMode||!i)return;if(i.status==="completed"){g("Atenção","Agendamentos finalizados não podem ser editados.","error");return}i.hasRewards&&!i.redeemedReward&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),va(i);break;case"delete-appointment":{if(L.isSelectionMode)return;const l=s.dataset.id;if(await H("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Xa(l),g("Agendamento apagado!","success"),oe()}catch(u){g(`Não foi possível apagar: ${u.message}`,"error")}break}case"open-comanda":if(L.isSelectionMode)return;if(i){i.hasRewards&&!i.redeemedReward&&i.status!=="completed"&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const l=i.status==="completed"?"finalizadas":"em-atendimento",c={selectedAppointmentId:i.id,initialFilter:l};if(l==="finalizadas"){let u=i.startTime;if(i.transaction&&i.transaction.paidAt){const p=i.transaction.paidAt;typeof p=="object"&&p._seconds?u=new Date(p._seconds*1e3):u=p}c.filterDate=u}K("comandas-section",c)}break}}),uo=!0),await cn(),await oe()}const $n=(e,t=null,a=1,o=12)=>{let r=`/api/comandas/${e}?page=${a}&limit=${o}`;return t&&(r+=`&date=${t}`),E(r)},En=(e,t)=>E(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),In=e=>E("/api/sales",{method:"POST",body:JSON.stringify(e)}),Cn=e=>E(`/api/sales/${e}`,{method:"DELETE"}),Ln=()=>E("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),Tn=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),E("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Bn=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),E(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},Dn=()=>E("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),Pn=e=>E(`/api/cashier/report/${e}`),qa=e=>E(`/api/packages/${e}`),Mn=e=>E("/api/packages",{method:"POST",body:JSON.stringify(e)}),An=(e,t)=>E(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),qn=e=>E(`/api/packages/${e}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"atendimento",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,pendingRedemption:null,paging:{page:1,limit:10,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1},Le=null,Be=null,po=null;function fs(e,t){return function(...a){clearTimeout(po),po=setTimeout(()=>e.apply(this,a),t)}}async function go(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,ct(),t==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),V());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,Xt()}function Xt(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");x.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),jn()}function jn(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `:e.innerHTML=`
            ...
            <button data-action="view-sales-report" class="py-2 px-4 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 text-sm transition">Relatório</button>
        `)}function ct(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!x.isCashierOpen&&x.activeFilter==="atendimento"){e.innerHTML=`
        ...
        `,s.appendChild(w)}),e.innerHTML="",e.appendChild(s),bo(t)}function bo(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:o}=x.paging,r=Math.ceil((a||0)/o);if(r===0)return;const s=document.createElement("div");s.className="flex gap-2 justify-center items-center w-full",s.innerHTML=`
    ...
    `;e.innerHTML=`
        ...
        ${r?"":v}
    `,!r&&(t.clientId||t.clientName)&&Hn(t,e.querySelector("#loyalty-container"))}function Fn(e,t){const o=$e(e).reduce((p,b)=>p+Number(b.price||0)*(b.quantity||1),0),r=x.checkoutState,s=r.discount||{type:"real",value:0};let n=0;s.type==="percent"?n=o*s.value/100:n=s.value,n>o&&(n=o);const i=o-n,d=r.payments.reduce((p,b)=>p+b.value,0),l=Math.max(0,i-d);(!r.amountReceived||l>0)&&(r.amountReceived=l.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;const u=()=>{const p=x.checkoutState.discount.type,b=x.checkoutState.discount.value;let v=p==="percent"?o*b/100:b;v>o&&(v=o);const h=o-v,y=x.checkoutState.payments.reduce((T,A)=>T+A.value,0),w=Math.max(0,h-y),$=t.querySelector("#checkout-total-display");$&&($.textContent=`R$ ${h.toFixed(2)}`);const k=t.querySelector("#checkout-status-msg");k&&(w<=.01?k.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':k.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${w.toFixed(2)}</span></p>`);const C=t.querySelector("#checkout-amount");C&&w>0&&document.activeElement!==C&&(C.value=w.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",p=>{const b=parseFloat(p.target.value)||0;x.checkoutState.discount.value=b,u()}),t.querySelector("#discount-type")?.addEventListener("change",p=>{x.checkoutState.discount.type=p.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",p=>{x.checkoutState.discountReason=p.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",p=>{x.checkoutState.amountReceived=p.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",p=>{x.checkoutState.installments=parseInt(p.target.value,10)})}async function Hn(e,t){if(!t)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let o=null;try{if(e.clientId)o=await rs(m.establishmentId,e.clientId);else if(e.clientName){const i=await Yt(m.establishmentId,e.clientName,1);i&&i.length>0&&(o=i[0])}}catch(i){console.warn("Erro ao buscar dados de fidelidade",i)}if(!o||o.loyaltyPoints===void 0)return;const r=Number(o.loyaltyPoints)||0,n=(a.tiers||a.rewards||[]).filter(i=>{const d=Number(i.costPoints||i.points||0);return d>0&&r>=d});if(n.length>0){const i=document.createElement("div");i.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",i.innerHTML=`
        ...
        `;const d=document.createElement("button");d.innerText="Resgatar",d.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",d.onclick=()=>On(n,e),i.appendChild(d),t.innerHTML="",t.appendChild(i)}}function On(e,t){const a=`
        <div class="space-y-4">
    ...
    `,{modalElement:o,close:r}=_({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});o.addEventListener("click",s=>{const n=s.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,d=e.find(l=>l.id&&l.id==i||(l.name||l.reward)==i);d&&(zn(d,t),r())}})}async function zn(e,t){const a=Number(e.costPoints||e.points||0),o=e.name||e.reward,r=e.type||"money";if(r==="money"){const d=parseFloat(e.discount)||0;if(d<=0){g("Erro","O valor do desconto configurado é inválido.","error");return}x.checkoutState.discount={type:"real",value:d},x.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,x.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:"money"},g("Sucesso",`Prémio "${o}" resgatado! Desconto de R$ ${d.toFixed(2)} aplicado.`,"success"),V();return}const s=$e(t),n=e.itemId?String(e.itemId):null;if(!n){g("Erro de Configuração",`O prémio "${o}" não tem um item vinculado nas configurações.`,"error");return}const i=s.find(d=>{const l=d.id?String(d.id):null,c=d.serviceId?String(d.serviceId):d.service_id?String(d.service_id):null,u=d.productId?String(d.productId):d.product_id?String(d.product_id):null;return r==="service"?l===n||c===n:r==="product"?l===n||u===n:r==="package"?l===n:!1});if(i){let d=parseFloat(e.discount);(!d||d<=0)&&(d=parseFloat(i.price||0)),x.checkoutState.discount={type:"real",value:d},x.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,x.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:r,appliedToItemId:i.id},g("Sucesso",`Prémio "${o}" resgatado! Item encontrado e desconto de R$ ${d.toFixed(2)} aplicado.`,"success"),V()}else g("Item Não Encontrado",`Para resgatar o prémio "${o}", o ${r==="service"?"serviço":r==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function Vn(){if(!x.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=_({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const r=e.querySelector("#add-item-content");r.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await hs(r,s),t()}};e.addEventListener("click",r=>{const s=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:i,itemId:d}=s.dataset,c=(x.catalog[i+"s"]||[]).find(u=>u.id===d);c&&o({...c,type:i})}else n&&a()}),a()}async function ha(e=null){if(!x.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await ee(m.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const a=`
        <form id="new-sale-form" class="space-y-4">
            ...
            <div>
                ...
                <select id="new-sale-professional" required class="mt-1 w-full p-2 border rounded-md bg-white"><option value="">Selecione...</option>${m.professionals.map(d=>`<option value="${d.id}">${f(d.name)}</option>`).join("")}</select>
            </div>
    ...
    `,{modalElement:o}=_({title:"Nova Venda Avulsa",contentHTML:a,maxWidth:"max-w-md"}),r=o.querySelector("#client-search"),s=o.querySelector("#client-suggestions"),n=o.querySelector("#selected-client-id");e&&(n.value=e.id,r.value=`${e.name} (${e.phone||"Sem tel"})`,r.classList.add("bg-green-50","border-green-300","text-green-800")),r.addEventListener("input",fs(async d=>{const l=d.target.value.trim();if(n.value="",r.classList.remove("bg-green-50","border-green-300","text-green-800"),l.length<2){s.classList.add("hidden");return}try{s.innerHTML='<li class="p-2 text-xs text-gray-500">Buscando...</li>',s.classList.remove("hidden");const c=await Yt(m.establishmentId,l,10);c.length===0?s.innerHTML='<li class="p-2 text-xs text-gray-500">Nenhum cliente encontrado</li>':s.innerHTML=c.map(u=>`<li data-client-id="${u.id}" data-client-name="${u.name}" data-client-phone="${u.phone}" class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 transition-colors"><div class="font-bold text-sm text-gray-800">${f(u.name)}</div><div class="text-xs text-gray-500">${u.phone||"Sem telefone"}</div></li>`).join("")}catch{s.classList.add("hidden")}},400)),s.addEventListener("click",d=>{const l=d.target.closest("li[data-client-id]");l&&(n.value=l.dataset.clientId,n.dataset.name=l.dataset.clientName,n.dataset.phone=l.dataset.clientPhone,r.value=`${l.dataset.clientName}`,r.classList.add("bg-green-50","border-green-300","text-green-800"),s.classList.add("hidden"))}),document.addEventListener("click",d=>{!r.contains(d.target)&&!s.contains(d.target)&&s.classList.add("hidden")}),o.querySelector("#new-sale-form").addEventListener("submit",Qn);const i=o.querySelector('[data-action="new-client-from-sale"]');i&&i.addEventListener("click",d=>{d.preventDefault(),o.style.display="none",Un()})}function Un(){_({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",_n)}async function _n(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),r=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!r)return g("Erro","Nome e Telefone são obrigatórios.","error");try{const s=await sn(m.establishmentId,r);if(s)g("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",ha(s);else{const n=await Ma({establishmentId:m.establishmentId,name:a.value,phone:r});g("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",ha(n)}}catch(s){g("Erro",s.message,"error")}}async function Jn(){const e=`
    ...
    `,{modalElement:t}=_({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const o=parseFloat(document.getElementById("initial-amount").value);if(isNaN(o)||o<0)return g("Valor Inválido","Insira um valor válido.","error");try{const r=await Tn({establishmentId:m.establishmentId,initialAmount:parseFloat(o.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${o.toFixed(2)})`,"success"),Xt(),await ne()}catch(r){g("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function Wn(){const e=x.activeCashierSessionId;if(e)try{const t=await Pn(e),a=`
        ...
        `,{modalElement:o}=_({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});o.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const s=parseFloat(document.getElementById("final-amount").value);if(isNaN(s)||s<0)return g("Valor Inválido","Insira um valor final válido.","error");try{await Bn(e,s),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Xt(),await ne(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){g("Erro",`Falha ao fechar caixa: ${n.message}`,"error")}})}catch(t){g("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Gn(e){if(x.activeFilter===e)return;x.activeFilter=e,x.paging.page=1,document.querySelectorAll(".filter-btn").forEach(a=>a.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),De(),x.selectedComandaId=null,x.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await ne(),V()}function vs(e){x.selectedComandaId=e,x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",ct(),Nn(),V()}async function hs(e,t){const a=x.allComandas.find(s=>s.id===x.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),g("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const o=parseFloat(e.price)||0,r=Array(t).fill(0).map(()=>{const s={id:String(e.id),name:e.name,price:o,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(s.productId=s.id,s.product_id=s.id):e.type==="service"&&(s.serviceId=s.id,s.service_id=s.id),s});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...r),a._cachedItems=null,a._hasUnsavedChanges=!0,V()}async function fo(e,t){const a=x.allComandas.find(s=>s.id===x.selectedComandaId);if(!a)return;let o=!1,r=(a.comandaItems||[]).findIndex(s=>s.id==e&&s.type===t);r>-1&&(a.comandaItems.splice(r,1),o=!0),o&&(a._cachedItems=null,a._hasUnsavedChanges=!0,V())}async function Yn(e){if(x.isProcessing)return;const t=$e(e),a=t.reduce((y,w)=>y+Number(w.price||0)*(w.quantity||1),0),o=x.checkoutState.discount||{type:"real",value:0};let r=o.type==="percent"?a*o.value/100:o.value;r>a&&(r=a);const s=a-r,{payments:n}=x.checkoutState,i=n.reduce((y,w)=>y+w.value,0),d=s-i;if(d>.01){if(!await H("Pagamento Parcial",`O valor de R$ ${d.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;n.push({method:"fiado",value:d,installments:1})}x.isProcessing=!0;const l=e.type==="appointment",c=t;let u=0;const p=x.loyaltySettings;p&&p.enabled&&(u=parseInt(p.pointsPerVisit||1,10),console.log(`Fidelidade: Cliente ganhou ${u} pontos fixos pela visita.`));const b={...o,reason:x.checkoutState.discountReason||""},v={payments:n,totalAmount:Number(s),items:c,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:u,discount:b,loyaltyRedemption:x.pendingRedemption},h=document.createElement("div");h.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",h.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(h);try{l?await ur(e.id,v):(v.establishmentId=m.establishmentId,v.clientId=e.clientId,v.clientName=e.clientName,v.professionalId=e.professionalId,e.clientPhone&&(v.clientPhone=e.clientPhone),await In(v));let y="Venda finalizada com sucesso!";u>0&&(y+=` Cliente ganhou ${u} pontos!`),g("Sucesso!",y,"success"),De(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await ne()}catch(y){g("Erro no Checkout",y.message,"error")}finally{document.body.contains(h)&&document.body.removeChild(h),x.isProcessing=!1}}async function Qn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,o=t.value,r=document.getElementById("client-search").value,s=t.dataset.phone||"";if(!o)return g("Erro","Selecione um cliente válido.","error");const n=m.professionals.find(d=>d.id===a);if(!n)return g("Erro","Selecione um profissional válido.","error");const i={id:`temp-${Date.now()}`,type:"walk-in",clientId:o,clientName:r.split("(")[0].trim(),clientPhone:s,professionalId:n.id,professionalName:n.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(i),x.selectedComandaId=i.id,x.viewMode="items",document.getElementById("genericModal").style.display="none",vs(i.id)}async function ne(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=x.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=Ln(),o=$n(m.establishmentId,t,x.paging.page,x.paging.limit),r=Ie(m.establishmentId),[s,n,i]=await Promise.all([a,o,r]);if(x.isCashierOpen=!!s,x.activeCashierSessionId=s?s.id:null,Xt(),i&&i.loyaltyProgram&&(x.loyaltySettings=i.loyaltyProgram),!x.isCashierOpen&&x.activeFilter==="atendimento"){ct(),V();return}if(x.allComandas=n.data||n,x.paging.total=n.total||n.length,x.catalog.services.length===0){const[d,l,c,u]=await Promise.all([fe(m.establishmentId),pt(m.establishmentId),qa(m.establishmentId),ee(m.establishmentId)]);x.catalog={services:d,products:l,packages:c},m.professionals=u}ct(),V()}catch(a){g("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function Xn(e={}){Be=document.getElementById("content"),x.selectedComandaId=e.selectedAppointmentId||null,x.viewMode="items",Rn(),Le&&(Be.removeEventListener("click",Le),Be.removeEventListener("change",Le)),Le=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&x.activeFilter==="finalizadas"){x.paging.page=1,await ne();return}if(a){if(a.matches("[data-filter]"))Gn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}vs(a.dataset.comandaId)}else if(a.matches("[data-action]")){const r=a.dataset.action,s=a.dataset.id||x.selectedComandaId,n=x.allComandas.find(i=>i.id===s);switch(r){case"back-to-list":De(),x.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach($=>$.classList.remove("selected")),V();break;case"new-sale":ha();break;case"add-item":Vn();break;case"open-cashier":Jn();break;case"close-cashier":await Wn();break;case"view-sales-report":K("sales-report-section");break;case"go-to-checkout":await go(n,"checkout");break;case"back-to-items":x.viewMode="items",V();break;case"save-comanda":await go(n,"stay");break;case"select-method":x.checkoutState.selectedMethod=a.dataset.method,x.checkoutState.installments=1,V();break;case"add-payment-checkout":const i=document.getElementById("checkout-amount");let d=parseFloat(i.value);const c=$e(n).reduce(($,k)=>$+(k.price||0),0),u=x.checkoutState.discount||{type:"real",value:0};let p=u.type==="percent"?c*u.value/100:u.value;p>c&&(p=c);const b=c-p,v=x.checkoutState.payments.reduce(($,k)=>$+k.value,0),h=b-v;if(isNaN(d)||d<=0){g("Valor inválido","Insira um valor maior que zero.","error");break}if(d>h+.05){g("Valor inválido","Valor excede o restante.","error");break}const y={method:x.checkoutState.selectedMethod,value:d};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(y.installments=x.checkoutState.installments),x.checkoutState.payments.push(y),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",V();break;case"remove-payment-checkout":const w=parseInt(a.dataset.index,10);x.checkoutState.payments.splice(w,1),V();break;case"finalize-checkout":await Yn(n);break;case"increase-qty":{const $=a.dataset.itemId,k=a.dataset.itemType;if(!$||$==="undefined"||$==="null"){g("Erro","Item inválido para adição.","error");return}let T=$e(n).find(q=>q.id==$&&q.type===k);T||(T=(x.catalog[k+"s"]||[]).find(B=>B.id==$));const A=T?{id:T.id,name:T.name,price:Number(T.price),type:T.type}:{id:$,name:"Item Indisponível",price:0,type:k};await hs(A,1);break}case"decrease-qty":{await fo(a.dataset.itemId,a.dataset.itemType);break}case"remove-item":await fo(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await H("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await cr(s);const k=x.allComandas.findIndex(C=>C.id===s);k!==-1&&(x.allComandas[k].status="confirmed",delete x.allComandas[k].transaction),x.selectedComandaId=null,De(),await ne(),g("Sucesso!","Comanda reaberta.","success")}catch(k){g("Erro",k.message,"error")}break}case"go-to-appointment":{const $=a.dataset.id,k=a.dataset.date;K("agenda-section",{scrollToAppointmentId:$,targetDate:new Date(k)});break}case"delete-walk-in":{if(await H("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(s.startsWith("temp-"))x.allComandas=x.allComandas.filter(k=>k.id!==s),x.selectedComandaId=null,ct(),V(),De();else try{await Cn(s),g("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,De(),await ne()}catch(k){g("Erro",k.message,"error")}break}}}}},Be.addEventListener("click",Le),Be.addEventListener("change",Le),e.initialFilter&&(x.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(x.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${x.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",x.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await ne()}const Zt=e=>E(`/api/financial/natures/${e}`),Zn=e=>E("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),Kn=e=>E(`/api/financial/natures/${e}`,{method:"DELETE"}),Na=e=>E(`/api/financial/cost-centers/${e}`),ei=e=>E("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),ti=e=>E(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),xs=(e,t)=>E(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),ys=(e,t={})=>{let a=`/api/financial/${e}`;const o=new URLSearchParams;t.establishmentId&&o.append("establishmentId",t.establishmentId),t.startDate&&o.append("startDate",t.startDate),t.endDate&&o.append("endDate",t.endDate),t.natureId&&o.append("natureId",t.natureId),t.costCenterId&&o.append("costCenterId",t.costCenterId),t.status&&o.append("status",t.status);const r=o.toString();return r&&(a+=`?${r}`),E(a)},ws=(e,t,a)=>E(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),ks=(e,t)=>E(`/api/financial/${e}/${t}`,{method:"DELETE"}),Ss=(e,t)=>{const a=t.map(o=>E(`/api/financial/${e}/${o}`,{method:"DELETE"}));return Promise.all(a)},$s=(e,t,a)=>E(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),ai=e=>xs("payables",e),Es=e=>ys("payables",e),oi=(e,t)=>ws("payables",e,t),si=e=>ks("payables",e),ri=(e,t)=>$s("payables",e,t),ni=e=>xs("receivables",e),Is=e=>ys("receivables",e),ii=(e,t)=>ws("receivables",e,t),li=e=>ks("receivables",e),di=(e,t)=>$s("receivables",e,t),xa=document.getElementById("content");let Z={};const ht={creditRealized:"#10b981",creditProvisioned:"#6ee7b7",debitRealized:"#ef4444",debitProvisioned:"#fca5a5"},ci=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],D={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],naturesList:[],rawPayables:[],rawReceivables:[],processedDRE:null,processedCashFlow:null,processedDailyRevenue:null,backendData:null,appointmentsData:[],currentTab:"dashboards",isFilterOpen:!1};async function ui(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function mi(){xa.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await ui();const[e,t,a]=await Promise.all([ee(m.establishmentId),Kr(m.establishmentId).catch(()=>[]),Zt(m.establishmentId).catch(()=>[])]);D.professionalsList=e||[],D.costCentersList=t||[],D.naturesList=a||[],pi(),await Cs()}catch(e){console.error("Erro no loadReportsPage:",e),xa.innerHTML=`
            ...
            </div>`}}function pi(){const e=D.professionalsList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join(""),t=D.costCentersList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join("");xa.innerHTML=`
    ...
    `,document.getElementById("toggle-filters-btn").onclick=vo,document.getElementById("btn-apply-filters").onclick=()=>{gi(),vo()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{D.currentTab=a.dataset.tab,ho(),Ls(),window.scrollTo({top:0,behavior:"smooth"})}}),ho()}function vo(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");D.isFilterOpen=!D.isFilterOpen,D.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function ho(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===D.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Rt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function gi(){D.startDate=document.getElementById("report-start").value,D.endDate=document.getElementById("report-end").value,D.selectedProfessional=document.getElementById("report-prof").value,D.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Rt(D.startDate)} até ${Rt(D.endDate)}`,await Cs()}function bi(e,t){const a=new Map;D.naturesList.forEach(r=>a.set(r.id,r.name));const o={revenues:{},expenses:{},totalRevenues:0,totalExpenses:0,netResult:0};return t.forEach(r=>{if(r.status==="paid"){const s=r.naturezaId?a.get(r.naturezaId)||"Outras Receitas":"Geral";o.revenues[s]||(o.revenues[s]=0),o.revenues[s]+=r.amount,o.totalRevenues+=r.amount}}),e.forEach(r=>{if(r.status==="paid"){const s=r.naturezaId?a.get(r.naturezaId)||"Outras Despesas":"Geral";o.expenses[s]||(o.expenses[s]=0),o.expenses[s]+=r.amount,o.totalExpenses+=r.amount}}),o.netResult=o.totalRevenues-o.totalExpenses,o}function fi(e,t){const a={},o=l=>{a[l]||(a[l]={realizedCredit:0,provisionedCredit:0,realizedDebit:0,provisionedDebit:0})};let r=new Date(D.startDate);const s=new Date(D.endDate);for(;r<=s;)o(r.toISOString().split("T")[0]),r.setDate(r.getDate()+1);t.forEach(l=>{const c=l.dueDate.split("T")[0];a[c]&&(l.status==="paid"?a[c].realizedCredit+=l.amount:a[c].provisionedCredit+=l.amount)}),e.forEach(l=>{const c=l.dueDate.split("T")[0];a[c]&&(l.status==="paid"?a[c].realizedDebit+=l.amount:a[c].provisionedDebit+=l.amount)});const n=Object.keys(a).sort(),i=[];let d=0;return n.forEach(l=>{const c=a[l],u=c.realizedCredit+c.provisionedCredit-(c.realizedDebit+c.provisionedDebit);d+=u,i.push(d)}),{labels:n,realizedCredit:n.map(l=>a[l].realizedCredit),provisionedCredit:n.map(l=>a[l].provisionedCredit),realizedDebit:n.map(l=>a[l].realizedDebit*-1),provisionedDebit:n.map(l=>a[l].provisionedDebit*-1),balance:i}}function vi(e){const t={};let a=new Date(D.startDate);const o=new Date(D.endDate);for(;a<=o;)t[a.toISOString().split("T")[0]]=0,a.setDate(a.getDate()+1);e.forEach(n=>{if(n.status==="paid"){const i=n.dueDate.split("T")[0];t.hasOwnProperty(i)&&(t[i]+=n.amount)}});const r=Object.keys(t).sort(),s=r.map(n=>t[n]);return{labels:r,data:s}}function hi(e){const t=e.length;if(t<2)return{trendData:Array(t).fill(e[0]||0),color:"#9ca3af"};let a=0,o=0,r=0,s=0;for(let c=0;c<t;c++)a+=c,o+=e[c],r+=c*e[c],s+=c*c;const n=(t*r-a*o)/(t*s-a*a),i=(o-n*a)/t,d=[];for(let c=0;c<t;c++)d.push(n*c+i);const l=n>=0?"#10b981":"#ef4444";return{trendData:d,color:l}}async function Cs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20 w-full"><div class="loader border-t-indigo-600"></div></div>';try{const t={startDate:D.startDate,endDate:D.endDate,establishmentId:m.establishmentId};D.selectedCostCenter!=="all"&&(t.costCenterId=D.selectedCostCenter);const[a,o]=await Promise.all([Es(t),Is(t)]);D.rawPayables=a.entries||[],D.rawReceivables=o.entries||[];const r=await Zr(D.startDate,D.endDate,D.selectedProfessional,D.selectedCostCenter).catch(()=>({charts:{professionals:{labels:[],data:[]},salesMonthly:{labels:[],data:[]}}}));D.backendData=r,D.processedDRE=bi(D.rawPayables,D.rawReceivables),D.processedCashFlow=fi(D.rawPayables,D.rawReceivables),D.processedDailyRevenue=vi(D.rawReceivables);const s=new Date(D.startDate+"T00:00:00").toISOString(),n=new Date(D.endDate+"T23:59:59").toISOString(),i=D.selectedProfessional==="all"?null:D.selectedProfessional,d=await Wo(m.establishmentId,s,n,i).catch(()=>[]);D.appointmentsData=Array.isArray(d)?d:[],Ls()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function Ls(){const e=document.getElementById("report-content");switch(D.currentTab){case"dashboards":xi(e);break;case"appointments":yi(e);break;case"dre":wi(e);break}}function xi(e){const t=D.processedDRE,a=D.processedDailyRevenue,o=D.backendData.charts?.salesMonthly||{labels:[],data:[]},r=D.backendData.charts?.professionals||{labels:[],data:[]};e.innerHTML=`
    ...
    `,ki("chart-cashflow-modern",D.processedCashFlow),xo("chart-daily-revenue","Receita Diária",a.labels.map(s=>s.split("-").reverse().slice(0,2).join("/")),a.data),xo("chart-monthly","Receita Mensal",o.labels,o.data),$i("chart-profs","doughnut","Total Vendas",r.labels,r.data,ci),document.querySelectorAll(".chart-toggle").forEach(s=>{s.addEventListener("change",n=>{const i=Z["chart-cashflow-modern"];if(i){const d=parseInt(n.target.dataset.dataset);i.setDatasetVisibility(d,n.target.checked),i.update()}})})}function yi(e){const t=D.appointmentsData,a=t.length;let o=0,r=0,s=0;const n={},i={};let d=new Date(D.startDate);const l=new Date(D.endDate);for(;d<=l;)n[d.toISOString().split("T")[0]]={active:0,cancelled:0},d.setDate(d.getDate()+1);t.forEach(v=>{const h=parseFloat(v.totalAmount||v.price||0),y=(v.status||"").toLowerCase();let w="";if(v.startTime){const k=v.startTime.toDate?v.startTime.toDate():new Date(v.startTime);isNaN(k)||(w=k.toISOString().split("T")[0])}const $=v.professionalName||"Sem Profissional";i[$]||(i[$]={name:$,count:0,value:0}),["cancelled","cancelado","no-show","cancelada"].includes(y)?(r++,w&&n[w]&&n[w].cancelled++):(["completed","finalized","paid"].includes(y)&&o++,s+=h,w&&n[w]&&n[w].active++,i[$].count++,i[$].value+=h)});const c=Object.keys(n).sort(),u=c.map(v=>n[v].active),p=c.map(v=>n[v].cancelled),b=Object.values(i).sort((v,h)=>h.value-v.value);e.innerHTML=`
    ...
    `,Si("chart-appointments-daily",c,u,p),document.querySelectorAll(".app-chart-toggle").forEach(v=>{v.addEventListener("change",h=>{const y=Z["chart-appointments-daily"];if(y){const w=parseInt(h.target.dataset.dataset);y.setDatasetVisibility(w,h.target.checked),y.update()}})})}function wi(e){const t=D.processedDRE;if(!t)return;const a=t.totalRevenues,o=(i,d,l,c=!1)=>{const u=a>0?d/a*100:0,p=c?"- ":"";return`
    ...
    `}function ki(e,t){const a=document.getElementById(e);if(!a)return;const o=a.getContext("2d");Z[e]&&Z[e].destroy();const r=o.createLinearGradient(0,0,0,400);r.addColorStop(0,"rgba(59, 130, 246, 0.4)"),r.addColorStop(1,"rgba(59, 130, 246, 0.0)");const s=t.labels.map(n=>n.split("-").reverse().slice(0,2).join("/"));Z[e]=new Chart(o,{type:"bar",data:{labels:s,datasets:[{label:"Créd. Realizado",data:t.realizedCredit,backgroundColor:ht.creditRealized,borderRadius:3,barPercentage:.7,order:1},{label:"Créd. Provisionado",data:t.provisionedCredit,backgroundColor:ht.creditProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:2},{label:"Déb. Realizado",data:t.realizedDebit,backgroundColor:ht.debitRealized,borderRadius:3,barPercentage:.7,order:3},{label:"Déb. Provisionado",data:t.provisionedDebit,backgroundColor:ht.debitProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:4},{label:"Saldo Acumulado",data:t.balance,type:"line",borderColor:"#3b82f6",backgroundColor:r,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!0,tension:.4,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10,callbacks:{label:function(n){let i=n.dataset.label||"";return i&&(i+=": "),n.parsed.y!==null&&(i+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(Math.abs(n.parsed.y))),i}}}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{size:10}}},y:{stacked:!0,display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:n=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(Math.abs(n)),font:{size:10}}}}}})}function Si(e,t,a,o){const r=document.getElementById(e);if(!r)return;const s=r.getContext("2d");Z[e]&&Z[e].destroy();const n=t.map(i=>i.split("-").reverse().slice(0,2).join("/"));Z[e]=new Chart(s,{type:"bar",data:{labels:n,datasets:[{label:"Realizados",data:a,backgroundColor:"#4f46e5",borderRadius:3,barPercentage:.6,order:1},{label:"Cancelados",data:o,backgroundColor:"#ef4444",borderRadius:3,barPercentage:.6,order:2}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function xo(e,t,a,o){const r=document.getElementById(e);if(!r)return;const s=r.getContext("2d");Z[e]&&Z[e].destroy();const{trendData:n,color:i}=hi(o),d=n.map((u,p)=>p===n.length-1?"triangle":"circle"),l=n.map((u,p)=>p===n.length-1?6:3),c=n.map((u,p)=>p===n.length-1&&i==="#ef4444"?180:0);Z[e]=new Chart(s,{type:"bar",data:{labels:a,datasets:[{label:t,data:o,backgroundColor:"#4f46e5",borderRadius:4,order:1},{label:"Tendência",data:n,type:"line",borderColor:i,borderWidth:3,pointStyle:d,pointRadius:l,pointRotation:c,pointBackgroundColor:"#fff",pointBorderColor:i,pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!1,tension:0,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9},callback:u=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(u)}}}}})}function $i(e,t,a,o,r,s){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");Z[e]&&Z[e].destroy(),new Chart(i,{type:t,data:{labels:o,datasets:[{label:a,data:r,backgroundColor:s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:{}}})}const Kt=(e,t="products")=>E(`/api/${t}/categories/${e}`),Ts=(e,t="products")=>E(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),Bs=(e,t="products")=>E(`/api/${t}/categories/${e}`,{method:"DELETE"}),Ei="audit_logs",Je=async(e,t,a,o,r,s=null)=>{try{if(!t)return;await Vo(be(J,Ei),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:o,description:r,details:s,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},xe=document.getElementById("content");let de=null,at="services",ke="all";function We(){const e=U.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function Ii(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await Ts({establishmentId:m.establishmentId,name:o},"services"),Je(m.establishmentId,We(),"Categorias (Serviços)","Criou",`Criou categoria: ${o}`),a.value="",g("Sucesso","Categoria criada!","success"),await Ra(),await bt()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Ci(e){if(await H("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Bs(e,"services"),Je(m.establishmentId,We(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Ra(),await bt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ra(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Kt(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Li(){_({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Ii),t.addEventListener("click",o=>{const r=o.target.closest('button[data-action="delete-category"]');r&&(o.preventDefault(),Ci(r.dataset.id))}))}Ra()}async function Ti(e){e.preventDefault();const t=e.target.closest("#serviceModal"),a=t.querySelector("#serviceId").value,o={},r=t.querySelector('input[name="commissionType"]:checked').value;r==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(n=>{const i=n.dataset.profId;if(n.querySelector('input[type="checkbox"]').checked){const l=parseFloat(n.querySelector('input[type="number"]').value);o[i]=isNaN(l)?0:l}});const s={establishmentId:m.establishmentId,name:t.querySelector("#serviceName").value,price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:r,professionalCommissions:o};try{a?(await Cr(a,s),Je(m.establishmentId,We(),"Serviços","Editou",`Editou o serviço: ${s.name}`)):(await Xo(s),Je(m.establishmentId,We(),"Serviços","Criou",`Criou novo serviço: ${s.name}`)),document.getElementById("serviceModal").style.display="none",g("Sucesso",`Serviço ${a?"atualizado":"adicionado"} com sucesso!`,"success"),await bt()}catch(n){g("Erro",n.message,"error")}}function yo(e=null){const t=document.getElementById("serviceModal"),a=m.serviceCategories||[],o=e?.duration||0,r=e?.bufferTime||0,s=f(e?.name||""),n=f(e?.notes||""),i=e?s:"Novo Serviço",d=a.map(C=>`<option value="${C.id}" ${e?.categoryId===C.id?"selected":""}>${f(C.name)}</option>`).join("");t.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),ja(),Pe()}function Di(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function bt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,o,r]=await Promise.all([fe(m.establishmentId),ee(m.establishmentId),Kt(m.establishmentId,"services"),Br(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(o||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(s=>{s.active===void 0&&(s.active=!0)}),Ds(at)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function Ds(e){if(document.getElementById("services-content-container")){if(at===e&&document.getElementById("services-content-container").children.length>1){at==="services"&&(ja(),Pe());return}at=e,ke="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Bi():e==="reports"&&Di()}}function Pi(){de&&(xe.removeEventListener("click",de),xe.removeEventListener("input",de),xe.removeEventListener("change",de)),de=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),s=r.dataset.id,n=r.checked;try{await Tr(s,n);const i=m.services.findIndex(d=>d.id===s);i>-1&&(m.services[i].active=n),Je(m.establishmentId,We(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${n?"Ativo":"Inativo"}`),Pe(),ja()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Pe()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Pe();return}if(!a)return;if(a.hasAttribute("data-view")){Ds(a.dataset.view);return}switch(a.dataset.action){case"new-service":yo();break;case"edit-service":const r=JSON.parse(a.dataset.service);yo(r);break;case"manage-categories":Li();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;ke=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,l=i===ke||i==="total"&&ke==="all";n.classList.toggle("ring-2",l),n.classList.toggle("ring-indigo-500",l),n.classList.toggle("shadow-lg",l)}),Pe();break}},xe.addEventListener("click",de),xe.addEventListener("input",de),xe.addEventListener("change",de)}async function Mi(){xe.innerHTML=`
        ...
        </section>`,Pi();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await ee(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}at="services",ke="all",await bt()}const ea="suppliers",Fa="purchases",Ps="financial_payables",Ha=async e=>{try{const t=Ut(be(J,ea),dt("establishmentId","==",e)),a=await La(t),o=[];return a.forEach(r=>{o.push({id:r.id,...r.data()})}),o}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Ai=async e=>{try{return{id:(await Vo(be(J,ea),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},qi=async(e,t)=>{try{const a=ge(J,ea,e);return await Ca(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Ni=async e=>{try{const t=ge(J,ea,e);return await er(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},Ri=async(e,t=null)=>{try{const a=_o(J),o=ge(be(J,Fa)),r={...e,createdAt:Qa()};if(a.set(o,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const s=ge(be(J,Ps)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:o.id,createdAt:Qa()};a.set(s,i)}return await a.commit(),{id:o.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},ji=async(e,t)=>{try{const a=_o(J),o=ge(J,Fa,e);a.delete(o);const r=Ut(be(J,Ps),dt("purchaseId","==",e),dt("establishmentId","==",t));return(await La(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},Fi=async e=>{try{const t=Ut(be(J,Fa),dt("establishmentId","==",e),Uo("createdAt","desc")),a=await La(t),o=[];return a.forEach(r=>{o.push({id:r.id,...r.data()})}),o}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},ve=document.getElementById("content");let ce=null,ot="products",re="all";async function Hi(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await Ts({establishmentId:m.establishmentId,name:o},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Oa(),await ft()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Oi(e){if(await H("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Bs(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Oa(),await ft()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Oa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Kt(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${f(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function zi(){_({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Hi),t.addEventListener("click",o=>{const r=o.target.closest('button[data-action="delete-category"]');r&&Oi(r.dataset.id)}))}Oa()}async function Vi(e){if(!e)return;if(await H("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await Pr(e),g("Sucesso","Produto apagado com sucesso!","success"),await ft()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function Ui(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),o=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),s=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(s).map(d=>d.dataset.id),i={establishmentId:m.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(o)?0:o,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await Dr(t,i):await Zo(i),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await ft()}catch(d){throw new Error(d.message)}}function wo(e,t=800,a=800,o="image/jpeg",r=.8){return new Promise((s,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=d=>{const l=new Image;l.onload=()=>{let c=l.width,u=l.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const p=document.createElement("canvas");p.width=c,p.height=u,p.getContext("2d").drawImage(l,0,0,c,u);const v=p.toDataURL(o,r);s(v)},l.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),l.src=d.target.result},i.onerror=d=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function ko(e=null){const t=document.getElementById("productModal"),a=m.categories||[],o=m.suppliers||[],r=a.map(B=>`<option value="${B.id}" ${e?.categoryId===B.id?"selected":""}>${f(B.name)}</option>`).join("");let s=new Set(e?.supplierIds||[]);const n=f(e?.name||""),i=e?.price||"",d=e?.costPrice||"",l=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,p=e?.currentStock||0,b=e?n:"Novo Produto";t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const v=t.querySelector("#productCategory"),h=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>h.click()),v.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(B=>`<option value="${B.id}" ${e?.categoryId===B.id?"selected":""}>${f(B.name)}</option>`).join(""),e&&(v.value=e.categoryId||"");const y=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const w=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",$=e?.photo||"";h.onchange=async()=>{const B=h.files[0];if(B){y.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const M=await wo(B,800,800,"image/jpeg",.8),F=M.length*3/4,O=1e3*1024;if(F>O)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=M,base64Input.value=M}catch(M){console.error("Erro ao processar imagem:",M),g("Erro de Imagem",M.message||"Não foi possível processar a imagem.","error"),preview.src=w,base64Input.value=$,q.value=""}}};const k=t.cloneNode(!0);t.parentNode.replaceChild(k,t);const C=()=>{const B=k.querySelector("#modalSupplierSearch"),M=k.querySelector("#supplierSearchResults"),R=k.querySelector("#selectedSuppliersList"),F=B.value.toLowerCase();if(F.length>0){const O=o.filter(j=>j.name.toLowerCase().includes(F)&&!s.has(j.id));O.length>0?(M.classList.remove("hidden"),M.innerHTML=O.map(j=>`
                ...
                `).join("")):(M.classList.remove("hidden"),M.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else M.classList.add("hidden");s.size>0?(R.innerHTML="",s.forEach(O=>{const j=o.find(Q=>Q.id===O);j&&(R.innerHTML+=`
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};k.querySelector("#modalSupplierSearch").addEventListener("input",C),k.addEventListener("click",B=>{const M=B.target.closest("[data-add-supplier]");if(M){const F=M.dataset.addSupplier;s.add(F),k.querySelector("#modalSupplierSearch").value="",C()}const R=B.target.closest("[data-remove-supplier]");if(R){const F=R.dataset.removeSupplier;s.delete(F),C()}}),C(),k.addEventListener("click",async B=>{const M=B.target.closest("button[data-action]");if(!M)return;const R=M.dataset.action,F=k.querySelector("#productId").value;if(R==="close-modal"&&(k.style.display="none"),R==="delete-product"){if(!F)return;k.style.display="none",await Vi(F)}if(R==="save-product-modal"){const O=k.querySelector("#productForm");if(O){if(!O.querySelector("#productName").value||!O.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const j=M.closest('button[data-action="save-product-modal"]');j.disabled=!0,j.textContent="A salvar...";try{await Ui(O)}catch(Q){g("Erro",`Falha ao salvar: ${Q.message}`,"error"),j.disabled=!1,j.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){B.preventDefault();const O=k.querySelector("#stockAdjustmentAmount"),j=k.querySelector("#stockAdjustmentReason"),Q=parseInt(O.value,10),Ce=parseInt(M.dataset.change,10);if(!Q||Q<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const oa=Q*Ce,_s=j.value||(oa>0?"Entrada manual":"Saída manual");try{await Mr(F,{change:oa,reason:_s});const Ye=m.products.findIndex(Qe=>Qe.id===F);if(Ye>-1){const Qe=m.products[Ye].currentStock+oa;m.products[Ye].currentStock=Qe,k.querySelector("#currentStockDisplay").textContent=Qe,k.querySelector("#productCurrentStock").value=Qe,O.value="",j.value="",g("Sucesso","Estoque atualizado!","success"),za(),ut()}}catch(Ye){g("Erro de Stock",Ye.message,"error")}}});const T=k.querySelectorAll(".tab-btn"),A=k.querySelectorAll(".tab-content");T.forEach(B=>{B.addEventListener("click",M=>{M.preventDefault(),T.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),B.classList.add("border-indigo-500","text-indigo-600"),B.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),A.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${B.dataset.tab}`).classList.remove("hidden")})});const q=k.querySelector("#productPhotoInput");k.querySelector("#productPhotoButton").addEventListener("click",()=>q.click()),q.onchange=async()=>{const B=q.files[0];if(!B)return;const M=k.querySelector("#productPhotoPreview"),R=k.querySelector("#productPhotoBase64");M.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await wo(B,800,800,"image/jpeg",.8),j=F.length*3/4,Q=1e3*1024;if(j>Q)throw new Error("A imagem é muito grande mesmo após a compressão.");M.src=F,R.value=F}catch(F){console.error("Erro ao processar imagem:",F),g("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),M.src=w,R.value=$,q.value=""}},k.style.display="flex"}function _i(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),za(),ut()}function Ji(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const o=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join("")),s&&m.categories&&(s.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join(""))}async function Wi(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await Ar(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ft(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,o]=await Promise.all([pt(m.establishmentId),Kt(m.establishmentId,"products"),Ha(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(o||[]).filter(Boolean),Ms(ot)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function Ms(e){if(document.getElementById("products-content-container")){if(ot===e&&document.getElementById("products-content-container").children.length>1){ot==="products"&&(za(),ut());return}ot=e,re="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?_i():e==="movements"&&Ji()}}async function Gi(){ve.innerHTML=`
        ...
        </section>`,ce&&(ve.removeEventListener("click",ce),ve.removeEventListener("input",ce),ve.removeEventListener("change",ce)),ce=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){ut();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){Ms(a.dataset.view);return}switch(a.dataset.action){case"new-product":ko();break;case"edit-product":ko(JSON.parse(a.dataset.product));break;case"manage-product-categories":zi();break;case"generate-report":await Wi();break;case"filter-stock":const r=a.dataset.filterType;re=re===r?"all":r,document.querySelectorAll(".indicator-card").forEach(s=>{s.classList.toggle("ring-2",s.dataset.filterType===re),s.classList.toggle("ring-indigo-500",s.dataset.filterType===re),s.classList.toggle("shadow-lg",s.dataset.filterType===re)}),ut();break}},ve.addEventListener("click",ce),ve.addEventListener("input",ce),ve.addEventListener("change",ce),ot="products",re="all",await ft()}const he=document.getElementById("content");let ue=null,Dt="list",z={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Yi(){Dt==="list"?ta():Dt==="purchases"?(z.step=1,st()):Dt==="history"&&As()}async function Qi(){try{const e=await Ha(m.establishmentId);return m.suppliers=e||[],z.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Xi(e){if(await H("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await Ni(e),g("Sucesso","Fornecedor excluído.","success"),_t("genericModal"),ta()}catch(t){g("Erro","Erro ao excluir: "+t.message,"error")}}async function Zi(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,o={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:m.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await qi(a,o),g("Sucesso","Fornecedor atualizado!","success")):(await Ai(o),g("Sucesso","Fornecedor criado!","success")),_t("genericModal"),ta()}catch(s){g("Erro","Erro ao salvar: "+s.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function ta(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Qi();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=m.suppliers.filter(s=>s.name.toLowerCase().includes(t)||s.contactName&&s.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let o='<div class="flex flex-col gap-2 md:hidden">';a.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=f(s.name),d=f(s.category||"Geral"),l=f(s.contactName||"");o+=`
    ...
    `;a.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=f(s.name),d=f(s.taxId||"Sem doc."),l=f(s.email||"-"),c=f(s.phone||"-"),u=f(s.category||"Geral");r+=`
            <tr class="hover:bg-gray-50">
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=o+r}function Ki(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",o=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),s=f(e.name),n=f(e.category||"Fornecedor"),i=f(e.contactName||""),d=f(e.phone||""),l=`
    ...
    `;_({title:"",contentHTML:l,maxWidth:"max-w-md"})}async function st(){const e=document.getElementById("purchasesContainer");if(e)if(z.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([pt(m.establishmentId),Ha(m.establishmentId)]);z.allSuppliers=a||[];const o=t.filter(l=>{const c=parseInt(l.currentStock||0),u=parseInt(l.minStock||0);return c<=u});if(z.productsToBuy=o,o.length===0){e.innerHTML=`
            ...
            `,ya()}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao calcular compras.</p>'}}else z.step===2&&el(e)}function el(e){if(!z.finalOrders||Object.keys(z.finalOrders).length===0){z.step=1,st();return}const t=z.isQuoteMode;let a="",o=0;const r=t?"border-indigo-100":"border-gray-200",s=t?"bg-indigo-50 border-indigo-100":"bg-gray-50 border-gray-200",n=t?"bg-blue-100 text-blue-700":"bg-green-100 text-green-700",i=t?"hidden":"flex",d=t?"Cotações Prontas":"Pedidos Prontos",l=t?"text-indigo-600":"text-green-600",c=t?"bg-indigo-50 border-indigo-100":"bg-green-50 border-green-100",u=t?"text-indigo-800":"text-green-800";for(const[p,b]of Object.entries(z.finalOrders)){let v=0,h=b.items.map(T=>{const A=T.qty*T.cost;return v+=A,`
    ...
    `}async function As(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await Fi(m.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(s=>{const n=new Date(s.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=f(s.supplierName);a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function tl(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;_({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Zi),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>_t("genericModal"))},50)}function ol(){he.innerHTML=`
    ...
    `,ue&&(he.removeEventListener("click",ue),he.removeEventListener("input",ue),he.removeEventListener("change",ue)),ue=e=>{if(e.target.closest("#tab-btn-list")&&xt("list"),e.target.closest("#tab-btn-purchases")&&xt("purchases"),e.target.closest("#tab-btn-history")&&xt("history"),e.target.id==="toggle-quote-mode"&&(z.isQuoteMode=e.target.checked,st()),e.target.id==="supplierSearchInput"&&ta(),e.target.closest("#btn-new-supplier")&&So(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),o=JSON.parse(a.dataset.supplier);Ki(o)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&Xi(t.dataset.id),a==="edit"&&So(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&ya(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(o=>o.checked=a),ya()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),o={};let r=!1;if(a.forEach(s=>{if(s.offsetParent===null||!s.querySelector(".row-select").checked)return;r=!0;let i="Produto";const d=s.querySelector("td:nth-child(2)"),l=s.querySelector(".font-bold");d?i=d.innerText:l&&(i=l.innerText);const c=parseInt(s.querySelector(".qty-input").value),u=parseFloat(s.dataset.cost),b=s.querySelector(".supplier-select").value;if(b){if(!o[b]){const v=z.allSuppliers.find(h=>h.id===b);o[b]={info:v,items:[]}}o[b].items.push({name:i,qty:c,cost:u})}}),!r){g("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}z.finalOrders=o,z.step=2,st()}if(e.target.closest("#btn-back-step1")&&(z.step=1,st()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),o=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),s=parseFloat(a.dataset.total),n=z.isQuoteMode;if(o.phone){const i=o.phone.replace(/\D/g,"");let d="";n?(d=`Olá *${o.name}*, tudo bem?
...
`,r.forEach(c=>{d+=`- ${c.qty}x ${c.name}
`}),d+=`
Aguardo confirmação.`);const l=`https://wa.me/${i}?text=${encodeURIComponent(d)}`;window.open(l,"_blank"),g("Aberto","WhatsApp aberto.","success")}else if(o.email){const i=n?`Solicitação de Cotação - ${m.establishmentName||"Empresa"}`:`Pedido de Compra - ${m.establishmentName||"Empresa"}`;let d=`Olá ${o.name},
...
Aguardo retorno.`;const l=`mailto:${o.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(d)}`;window.location.href=l}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const o=JSON.parse(decodeURIComponent(a.dataset.order));o.establishmentId=m.establishmentId,a.disabled=!0,a.textContent="A processar...",Ie(m.establishmentId).then(r=>{const s=r.purchaseConfig||null;return Ri(o,s)}).then(()=>{g("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const o=e.target.closest(".btn-delete-purchase").dataset.id;H("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await ji(o,m.establishmentId),g("Sucesso","Compra e financeiro excluídos.","success"),As()}catch(s){g("Erro","Erro ao excluir: "+s.message,"error")}})}if(e.target.closest(".btn-print-order")){const o=e.target.closest(".supplier-order-card").dataset.supplierId,r=z.finalOrders[o];r?al(r,z.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),o=JSON.parse(a.dataset.purchase);tl(o)}},he.addEventListener("click",ue),he.addEventListener("input",ue),he.addEventListener("change",ue),xt("list")}function xt(e){Dt=e,["list","purchases","history"].forEach(a=>{const o=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(o.classList.add("border-indigo-500","text-indigo-600"),o.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(o.classList.remove("border-indigo-500","text-indigo-600"),o.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Yi()}const na=document.getElementById("content"),$o={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ie=new Set,yt=null,Me=null;function sl(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function rl(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",o=f(t.name),r=f(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function ia(){const e=document.getElementById("genericModal");e.style.display="none",Me&&e.removeEventListener("click",Me)}async function nl(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=f(a.name),r=m.services||await fe(m.establishmentId),s=m.professionals||await ee(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",il(a,r),ll(a),dl(a,s),ul(a)}function il(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,w)=>{const $=w+1,k=$==o[1]?"selected":"",C=new Date(0,w).toLocaleString("pt-BR",{month:"long"});return`<option value="${$}" ${k}>${C.charAt(0).toUpperCase()+C.slice(1)}</option>`}).join(""),s=e.status||"active",n=f(e.name||""),i=f(e.specialty||""),d=f(e.phone||""),l=f(e.notes||"");a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${l}</textarea></div>`;const c=document.getElementById("profPhotoInput"),u=document.getElementById("profPhotoButton"),p=document.getElementById("profPhotoPreview"),b=document.getElementById("profPhotoBase64"),v=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,h=e.photo||"";u&&u.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const y=c.files[0];if(y){p.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const w=await ls(y,800,800,.8),k=w.length*3/4,C=1e3*1024;if(k>C)throw new Error("A imagem é muito grande mesmo após a compressão.");p.src=w,b.value=w}catch(w){g("Erro de Imagem",w.message||"Não foi possível processar a imagem.","error"),p.src=v,b.value=h,c.value=""}}})}function ll(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',cl(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function dl(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            </div>`}).join(""),e.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",o=>{const r=o.target.closest(".day-schedule-card"),s=!o.target.checked;r.classList.toggle("bg-white",!s),r.classList.toggle("bg-gray-100",s),r.classList.toggle("disabled",s),r.querySelectorAll(".time-inputs input").forEach(n=>n.disabled=s)})})}async function rt(e,t="future"){const a=document.getElementById("blockagesList");if(a){a.innerHTML='<div class="loader mx-auto"></div>';try{const o=new Date;let r,s;t==="history"?(s=new Date,r=new Date,r.setFullYear(r.getFullYear()-2)):(r=new Date,s=new Date,s.setFullYear(s.getFullYear()+2));let i=(await Wt(m.establishmentId,r.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<o).sort((l,c)=>c.startTime-l.startTime):i=i.filter(l=>l.endTime>=o).sort((l,c)=>l.startTime-c.startTime);const d=i.reduce((l,c)=>{const u=c.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(c),l},{});if(Object.keys(d).length===0){a.innerHTML=`<p class="text-center text-gray-500 text-sm py-4">Nenhum bloqueio ${t==="history"?"no histórico":"futuro"}.</p>`;return}a.innerHTML=Object.entries(d).map(([l,c])=>`
        ...
        `).join("")}catch(o){a.innerHTML=`<p class="text-red-500">${o.message}</p>`}}}function ul(e){const t=document.getElementById("genericModal");Me&&t.removeEventListener("click",Me),Me=async a=>{const o=a.target.closest("button[data-action]");if(!o){const s=a.target.closest(".tab-link");s&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),s.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(s.dataset.tab).classList.remove("hidden"));return}const r=o.dataset.action;switch(a.stopPropagation(),r){case"close-modal":ia();break;case"delete-professional":const s=o.dataset.id;if(await H("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Qo(s),g("Sucesso!","Profissional excluído.","success"),ia(),jt()}catch(h){g("Erro",`Não foi possível excluir: ${h.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),d=o,l=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(h=>h.value),u={};l&&l.querySelectorAll(".day-schedule-card").forEach(h=>{const y=h.querySelector('[data-field="active"]').dataset.day;u[y]={active:h.querySelector('[data-field="active"]').checked,start:h.querySelector('[data-field="start"]').value,end:h.querySelector('[data-field="end"]').value,breakStart:h.querySelector('[data-field="breakStart"]').value,breakEnd:h.querySelector('[data-field="breakEnd"]').value}});const p={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};d.disabled=!0,d.textContent="A salvar...";try{p.id?(await At(p.id,p),g("Sucesso!","Profissional atualizado.","success")):(delete p.id,await Yo(p),g("Sucesso!","Profissional criado.","success")),ia(),jt()}catch(h){g("Erro",h.message,"error"),d.disabled=!1,d.textContent="Salvar"}break;case"delete-blockage":const b=o.dataset.id;if(await H("Apagar Bloqueio","Tem certeza?"))try{await Da(b),g("Bloqueio removido.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";rt(e.id,h)}catch(h){g("Erro",h.message,"error")}break;case"batch-delete-blockage":const v=JSON.parse(o.dataset.ids);if(await H("Apagar em Lote",`Tem certeza que deseja apagar ${v.length} bloqueios com este motivo?`))try{await ss(v),g("Bloqueios removidos.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";rt(e.id,h)}catch(h){g("Erro",h.message,"error")}break}},t.addEventListener("click",Me)}function wa(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ie.size>0?(t.textContent=`${ie.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function ml(){H("Excluir em Lote",`Tem certeza que deseja excluir ${ie.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await Ir(Array.from(ie)),g("Sucesso!",`${ie.size} profissionais foram excluídos.`,"success"),ie.clear(),wa(),jt()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Xe(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=sl();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),o=m.professionals.filter(r=>{const s=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return s&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=rl(o)}async function jt(){ie.clear(),na.innerHTML=`
        ...
        </section>`,yt&&na.removeEventListener("click",yt),yt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),o=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let s={};if(a.dataset.professional)try{s=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}nl(s);return}if(o){ml();return}const r=t.target.closest(".professional-checkbox");if(r){const s=r.dataset.id;r.checked?ie.add(s):ie.delete(s),Xe(),wa();return}},na.addEventListener("click",yt),document.getElementById("profSearchInput").addEventListener("input",Xe),document.getElementById("showInactiveProfToggle").addEventListener("change",Xe);const e=document.getElementById("professionalsList");m.professionals=null,m.services=null,Xe();try{const[t,a]=await Promise.all([ee(m.establishmentId),fe(m.establishmentId)]);m.professionals=t,m.services=a,Xe(),wa()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}let S={clients:[],selectedClient:null,activeTab:"profile",filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},showFilters:!1,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},qs=null;const pl=e=>e?String(e).replace(/\D/g,""):"",gl=e=>{if(!e)return"Nunca";let t;if(typeof e=="object"&&(e.seconds||e._seconds)){const a=e.seconds||e._seconds;t=new Date(a*1e3)}else t=new Date(e);return isNaN(t.getTime())?"Data Inválida":t.toLocaleDateString("pt-BR")};function Va(){qs.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=Sl)}function mt(){if(S.modalOpen)return;Va();const e=document.getElementById("clients-content-area"),t=S.filters.inactiveDays||S.filters.birthMonth||S.filters.hasLoyalty||S.filters.hasDebt,a=`
    ...
    `,o=S.clients.length>0?`
        <div class="px-3 sm:px-4 pb-20 pt-2 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${S.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,p=gl(c.lastVisit);return`
    ...
    `;e.innerHTML=a+o;const r=document.getElementById("client-search"),s=document.getElementById("btn-toggle-filters"),n=document.getElementById("btn-apply-filters"),i=document.getElementById("btn-clear-search");s&&(s.onclick=()=>{S.showFilters=!S.showFilters,mt()});const d=document.getElementById("filter-birth-month");d&&(d.value=S.filters.birthMonth);const l=()=>{const c=document.getElementById("filter-inactive"),u=document.getElementById("filter-loyalty"),p=document.getElementById("filter-debt"),b=document.getElementById("filter-birth-month");S.filters={search:r.value,inactiveDays:c?c.value:"",birthMonth:b?b.value:"",hasLoyalty:u?u.checked:!1,hasDebt:p?p.checked:!1},ka()};n&&(n.onclick=l),i&&(i.onclick=()=>{S.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},S.showFilters=!1,ka()}),r.addEventListener("keypress",c=>{c.key==="Enter"&&l()}),e.querySelectorAll(".client-card").forEach(c=>{c.onclick=()=>Ns(c.dataset.id)})}function bl(e){const t=`
    ...
    `;let a="";return S.activeTab==="profile"?a=hl(e):S.activeTab==="appointments"?a=xl():S.activeTab==="history"?a=yl():S.activeTab==="loyalty"&&(a=wl(e)),`
    ...
    `}function fl(e,t){if(!document.getElementById("tabs-styles")){const s=document.createElement("style");s.id="tabs-styles",s.textContent=`
        ...
        `,e.appendChild(s)}if(e.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const n=s.dataset.tab;if(S.activeTab===n)return;(n==="appointments"||n==="history")&&(S.historyLimit=20,S.historySearchTerm=""),S.activeTab=n,je(),n!=="profile"&&!S.historyLoading&&S.historyData.appointments.length===0&&await Eo(t.id)}}),S.activeTab==="profile"){const s=e.querySelector("#form-edit-client"),n=e.querySelector("#btn-delete-client");s&&(s.onsubmit=$l),n&&(n.onclick=El)}if(S.activeTab==="loyalty"){const s=e.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>kl(t))}const a=e.querySelector("#history-search-input");if(a){const s=a.value;a.value="",a.focus(),a.value=s,a.addEventListener("input",n=>{S.historySearchTerm=n.target.value,je()})}const o=e.querySelector("#btn-load-more");o&&(o.onclick=()=>{S.historyLimit+=20,je(),Eo(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=n=>{Fe(),K("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=n=>{Fe(),K("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const r=e.querySelector("#btn-close-modal");r&&(r.onclick=Fe)}async function je(){const e=S.selectedClient;if(!e){Fe();return}vl(e)}function vl(e){let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 animate-fade-in",t.innerHTML=`
        ...
        `,t.onclick=o=>{o.target===t&&Fe()},document.body.appendChild(t),document.body.classList.add("overflow-hidden"),S.modalOpen=!0);const a=t.querySelector("#client-modal-content");a.innerHTML=bl(e),fl(a,e)}function Fe(){const e=document.getElementById("client-details-modal-overlay");e&&e.remove(),document.body.classList.remove("overflow-hidden"),S.modalOpen=!1,S.selectedClient=null,mt()}function hl(e){return`
    ...
    `}function yl(e){let t=S.historyData.sales||[];if(S.historySearchTerm){const a=S.historySearchTerm.toLowerCase();t=t.filter(o=>o.id.includes(a))}return t.sort((a,o)=>new Date(o.date)-new Date(a.date)),t.length===0&&!S.historySearchTerm?'<div class="text-center py-12 text-gray-400">Nenhum registro financeiro.</div>':`
        <div class="space-y-4 w-full">
            <div class="sticky top-0 bg-gray-50 pt-2 pb-2 z-10 w-full">
                <div class="relative w-full">
                    <input type="text" id="history-search-input" 
    ...
    `}function wl(e){const t=S.historyData.loyaltyLog||[];t.sort((o,r)=>new Date(r.date)-new Date(o.date));const a=t.length>0?t.map(o=>{const r=o.type==="redemption";return`
    ...
    `,{modalElement:o,close:r}=_({title:"Ajuste de Pontos",contentHTML:a,maxWidth:"w-[90%] max-w-xs"});o.querySelector("form").onsubmit=async s=>{s.preventDefault();const n=document.getElementById("redeem-action").value,i=parseInt(document.getElementById("redeem-points").value,10),d=document.getElementById("redeem-reason").value;if(!i||i<=0)return g("Erro","Qtd inválida.","error");if(n==="debit"&&i>t)return g("Erro","Saldo insuficiente.","error");try{let l=t;n==="debit"?(await on(m.establishmentId,e.phone,i,d),l-=i):(l+=i,await is(e.id,{loyaltyPoints:l})),S.selectedClient.loyaltyPoints=l,S.historyData.loyaltyLog.unshift({type:n==="debit"?"redemption":"earn",points:i,date:new Date().toISOString(),description:d+" (Manual)"}),g("Sucesso","Saldo atualizado.","success"),r(),je()}catch(l){g("Erro",l.message,"error")}}}function Ns(e){S.selectedClient=S.clients.find(t=>t.id===e),S.activeTab="profile",S.historyLimit=20,S.historySearchTerm="",S.historyData={appointments:[],sales:[],loyaltyLog:[]},je()}function Sl(){const e=`
    ...
    `,{modalElement:t,close:a}=_({title:"Novo Cliente",contentHTML:e,maxWidth:"w-[90%] max-w-sm"});t.querySelector("form").onsubmit=async o=>{o.preventDefault();const r=document.getElementById("new-name").value,s=document.getElementById("new-phone").value;try{const n=await Ma({establishmentId:m.establishmentId,name:r,phone:s});S.clients.unshift(n),g("Sucesso","Cliente criado!","success"),a(),Ns(n.id)}catch(n){g("Erro",n.message,"error")}}}async function $l(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());a.establishmentId=m.establishmentId;try{await is(S.selectedClient.id,a),Object.assign(S.selectedClient,a);const o=S.clients.findIndex(r=>r.id===S.selectedClient.id);o!==-1&&(S.clients[o]=S.selectedClient),g("Sucesso","Dados salvos!","success")}catch(o){g("Erro",o.message,"error")}}async function El(){if(await H("Excluir Cliente","Tem certeza? O histórico será apagado."))try{await an(S.selectedClient.id),S.clients=S.clients.filter(e=>e.id!==S.selectedClient.id),S.selectedClient=null,g("Sucesso","Cliente removido.","success"),Fe(),mt()}catch(e){g("Erro",e.message,"error")}}async function Il(){qs=document.getElementById("content"),S.selectedClient=null,S.searchTerm="",S.historyLimit=20,S.showFilters=!1,S.modalOpen=!1,S.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},Va(),await ka()}const ye=document.getElementById("content"),la={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},Cl={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function Rs(){let e=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais da Unidade"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"},{id:"support",icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",label:"Suporte e Ajuda"},{id:"cancellation",icon:"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z",label:"Cancelar Assinatura"}];return(m.userRole==="group_admin"||m.userRole==="company_admin")&&e.unshift({id:"manage-network",icon:"M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",label:"Gestão de Múltiplas Filiais e Empresas"}),e}let X=null,He=null;function Io(e,t,a){return new Promise((o,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const d=document.createElement("canvas");let l=i.width,c=i.height;l>t&&(c*=t/l,l=t),d.width=l,d.height=c,d.getContext("2d").drawImage(i,0,0,l,c);const p=e.type==="image/png"&&t<500?"image/png":"image/jpeg";o(d.toDataURL(p,a))},i.onerror=d=>r(d)},s.onerror=n=>r(n)})}function Te(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const o=n=>{const i=new Map,d=[];return n&&(n.forEach(l=>i.set(l.id,{...l,children:[]})),i.forEach(l=>{l.parentId&&i.has(l.parentId)?i.get(l.parentId).children.push(l):d.push(l)})),d},r=(n,i="")=>{const d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${i}${f(n.name)}</option>`,n.children.forEach(l=>r(l,i+"— "))};return o(e).forEach(n=>r(n)),a}async function Ge(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const o=X||await Ie(m.establishmentId),r=[],{ownerName:s,...n}=e;if(s&&s!==m.userName){const d=U.currentUser;d&&r.push(Qs(d,{displayName:s}).then(()=>{m.userName=s}))}const i={...o,...n};r.push(Tt(m.currentViewContext?.id||m.establishmentId,i)),await Promise.all(r),X=i,g("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),n.themeColor&&setTimeout(()=>window.location.reload(),1500)}catch(o){g("Erro",`Não foi possível salvar: ${o.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}async function Ll(){try{const e=await m.getAuthToken?.()||await U.currentUser.getIdToken(),t=await fetch("/api/establishments/hierarchy",{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error("Falha ao obter hierarquia.");He=await t.json()}catch(e){console.error(e),g("Erro","Não foi possível carregar a hierarquia da empresa.","error"),He={companies:[],branches:[]}}}async function Ua(e){e.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>',await Ll();let t=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-6">
    `;He.companies.length===0?t+='<p class="text-gray-500 text-center py-8">Nenhuma empresa registada na sua rede.</p>':He.companies.forEach(a=>{const o=He.branches.filter(r=>r.companyId===a.id);t+=`
            ...
            `}),t+="</div></div>",e.innerHTML=t,e.querySelector('[data-action="new-company"]').addEventListener("click",()=>Tl()),e.querySelector('[data-action="new-branch"]').addEventListener("click",()=>Bl()),e.querySelectorAll('[data-action="switch-context"]').forEach(a=>{a.addEventListener("click",o=>{const{id:r,name:s}=o.target.dataset;m.setContext?(m.setContext("BRANCH",r,s),g("A carregar...",`Mudando o painel para a filial ${s}`,"info")):g("Erro","O mecanismo de multi-empresa ainda está a carregar.","error")})})}function Tl(){_({title:"Adicionar Nova Empresa (Matriz)",contentHTML:`
    ...
    `,maxWidth:"max-w-md"}),document.getElementById("newCompanyForm").addEventListener("submit",async t=>{t.preventDefault();const a=t.target.querySelector('button[type="submit"]');a.disabled=!0,a.textContent="...";try{const o=await m.getAuthToken?.()||await U.currentUser.getIdToken();if(!(await fetch("/api/establishments/companies",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify({name:document.getElementById("compName").value,cnpj:document.getElementById("compCnpj").value,groupId:m.groupId})})).ok)throw new Error("Falha ao criar");g("Sucesso","Nova Matriz criada!","success"),document.getElementById("genericModal").style.display="none",Ua(document.getElementById("settings-content-detail"))}catch(o){g("Erro",o.message,"error"),a.disabled=!1,a.textContent="Criar Matriz"}})}function Bl(){const e=He.companies.map(a=>`<option value="${a.id}">${a.name}</option>`).join("");if(!e)return g("Aviso","Crie uma Empresa (Matriz) primeiro.","error");const t=`
    ...
    `;_({title:"Adicionar Nova Filial",contentHTML:t,maxWidth:"max-w-md"}),document.getElementById("newBranchForm").addEventListener("submit",async a=>{a.preventDefault();const o=a.target.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const r=await m.getAuthToken?.()||await U.currentUser.getIdToken();if(!(await fetch("/api/establishments",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({name:document.getElementById("branchName").value,companyId:document.getElementById("branchCompanyId").value,groupId:m.groupId})})).ok)throw new Error("Falha ao criar");g("Sucesso","Nova Filial criada e configurada!","success"),document.getElementById("genericModal").style.display="none",Ua(document.getElementById("settings-content-detail"))}catch(r){g("Erro",r.message,"error"),o.disabled=!1,o.textContent="Criar Filial"}})}function Dl(e,t){const a=f(e.name||""),o=f(e.phone||""),r=f(e.document||""),s=f(e.email||""),n=f(e.address||""),i=f(e.website||""),d=f(m.userName||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",l=>{l.preventDefault();const c={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,document:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};Ge(c,l)})}function Pl(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!o||!r){g("Erro","Preencha todos os campos.","error");return}const s=t.querySelector('button[form="change-email-form"]');s.disabled=!0,s.textContent="A verificar...";try{const n=U.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=Js.credential(n.email,r);await Ws(n,i),s.textContent="A enviar link...",await Gs(n,o),s.textContent="A atualizar BD...",await $r(m.establishmentId,o),g("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,g("Erro",i,"error")}finally{s.disabled=!1,s.textContent="Salvar Novo E-mail"}})}function Al(e,t){const a=f(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#copyBookingLinkBtn").addEventListener("click",()=>{const l=t.querySelector("#publicBookingLink");navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(l.value).then(()=>g("Sucesso","Link copiado!","success")):(l.select(),document.execCommand("copy"),l.blur(),g("Sucesso","Link copiado!","success"))}),t.querySelector("#publicBookingToggle").addEventListener("change",async l=>{const c=l.target.checked,u=t.querySelector("#publicBookingStatusText");u.textContent=c?"Agendamento Online ATIVO":"Agendamento Online INATIVO",u.className=c?"text-sm font-semibold text-green-600":"text-sm font-semibold text-red-600";try{l.target.disabled=!0,await Sr(m.establishmentId,c),X.publicBookingEnabled=c,g("Sucesso",`Agendamento online ${c?"ativado":"desativado"}!`,"success")}catch(p){g("Erro",`Não foi possível alterar o status: ${p.message}`,"error"),l.target.checked=!c}finally{l.target.disabled=!1}}),zl(e.slotInterval||30,t),t.querySelector("#booking-form").addEventListener("submit",l=>{l.preventDefault();const c={slotInterval:parseInt(t.querySelector("#establishmentSlotInterval").value,10)};Ge(c,l)})}function Nl(e,t){t.innerHTML=`
         <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");if(e.timezone)a.value=e.timezone;else try{const s=Intl.DateTimeFormat().resolvedOptions().timeZone,n=Array.from(a.options).some(i=>i.value===s);a.value=n?s:"America/Sao_Paulo"}catch{a.value="America/Sao_Paulo"}const o=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(la).forEach(s=>{const n=r[s]||{},i=la[s],d=n.active!==!1,l=document.createElement("div");l.className=`day-schedule-card p-4 rounded-lg ${d?"bg-gray-50":"bg-gray-100 disabled"}`,l.innerHTML=`
            ...
            </div>`,o.appendChild(l)}),o.addEventListener("change",s=>{const n=s.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",s=>{s.preventDefault();const n={};Object.keys(la).forEach(d=>{n[d]={active:t.querySelector(`#est-${d}-active`).checked,start:t.querySelector(`#est-${d}-start`).value,end:t.querySelector(`#est-${d}-end`).value,breakStart:t.querySelector(`#est-${d}-breakStart`).value,breakEnd:t.querySelector(`#est-${d}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;Ge({workingHours:n,timezone:i},s)})}async function Rl(e,t){const a=e.loyaltyProgram||{},o=a.pointsPerVisit||1;let r=[],s=[],n=[];try{[r,s,n]=await Promise.all([fe(m.establishmentId),pt(m.establishmentId),qa(m.establishmentId)])}catch(l){console.error("Erro ao carregar dados para fidelidade:",l)}t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#loyaltyEnabled").checked=a.enabled||!1;const i=t.querySelector("#loyaltyTiersContainer"),d=(l={})=>{const c=document.createElement("div");c.className="loyalty-tier-row group bg-white md:bg-transparent p-3 md:p-0 border md:border-0 rounded-lg shadow-sm md:shadow-none relative md:grid md:grid-cols-[0.8fr_1fr_1.5fr_1fr_auto] md:gap-2 md:items-start";const u=l.type||"money",p=l.itemId||"",b=l.reward||"",v=l.discount||"",h=l.points||l.costPoints||"";c.innerHTML=`
    ...
    `;try{const[a,o]=await Promise.all([Zt(m.establishmentId),Na(m.establishmentId)]),r=e.financialIntegration||{},s=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Te(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Te(o,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Te(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Te(o,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Te(a,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Te(o,s.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const o={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Ge(o,a)})}function Fl(e,t){const a="5516997859430",o=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${o}`;t.innerHTML=`
    ...
    `}function Hl(e,t){const a="5516997859430",o=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),r=`https://wa.me/${a}?text=${o}`,s="sistemakairosagenda@gmail.com";t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function Ol(e,t){t.innerHTML=`<div class="bg-white p-4 md:p-6 rounded-lg shadow-md"><h3 class="text-xl font-bold text-gray-800">${e}</h3><p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p></div>`}function js(e="indigo",t){const a=t.querySelector("#color-palette-container"),o=t.querySelector("#establishmentThemeColor");!a||!o||(a.innerHTML="",Object.entries(Cl).forEach(([r,s])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{o.value=r,js(r,t)}),a.appendChild(i)}),o.value=e)}function zl(e,t){const a=t.querySelector("#slotIntervalContainer"),o=t.querySelector("#establishmentSlotInterval");if(!a||!o)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(s=>{const n=s.value===e;return`<button type="button" data-value="${s.value}" 
    ...
    `,ye.querySelector('button[data-action="back-to-list"]').addEventListener("click",r=>{r.preventDefault(),Fs()});const o=document.getElementById("settings-content-detail");switch(e){case"manage-network":await Ua(o);break;case"personal-data":Dl(X,o);break;case"change-password":Pl(X,o);break;case"change-email":Ml(X,o);break;case"branding":Al(X,o);break;case"booking":ql(X,o);break;case"working-hours":Nl(X,o);break;case"loyalty":await Rl(X,o);break;case"financial":await jl(X,o);break;case"support":Fl(X,o);break;case"cancellation":Hl(X,o);break;default:Ol(a.label,o)}}async function Fs(){ye.innerHTML=`
    ...
    `;try{let n=m.currentViewContext?.id||m.establishmentId;m.currentViewContext?.type==="GROUP"&&(n=m.accessibleEstablishments[0]?.id||m.establishmentId),X=await Ie(n)}catch{g("Erro Fatal","Não foi possível carregar as definições.","error"),ye.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados.</p>';return}const e=U.currentUser;e&&e.displayName&&(m.userName=e.displayName);const t=f(m.userName||U.currentUser.email);let o=`https://placehold.co/96x96/E2E8F0/4A5568?text=${t?t.charAt(0).toUpperCase():"U"}`;e&&e.photoURL&&(o=e.photoURL);const r=Rs();ye.innerHTML=`
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-4">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg class="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.096 2.572-1.065z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                Definições
    ...
    `,ye.querySelector("#settings-menu-list").addEventListener("click",n=>{const i=n.target.closest("button[data-section]");i&&(n.preventDefault(),Vl(i.dataset.section))});const s=ye.querySelector('[data-action="go-to-my-profile"]');s&&s.addEventListener("click",n=>{n.preventDefault(),K("my-profile-section")})}const nt=document.getElementById("content");async function Oe(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,o=document.getElementById("filterEndDate")?.value,r=await Wt(m.establishmentId,a||new Date().toISOString().split("T")[0],o||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),n=s?r.filter(d=>d.reason&&d.reason.toLowerCase().includes(s)):r,i=n.reduce((d,l)=>{const c=l.reason||"Sem motivo";return d[c]||(d[c]=[]),d[c].push(l),d},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([d,l])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;c.innerHTML+=k}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Ul(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,o=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||o,s=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${o}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Gt(i),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),Oe(a)}catch(d){g("Erro",`Não foi possível criar o bloqueio: ${d.message}`,"error")}}async function _l(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const o=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||o,s=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="Aguarde...";const l=a.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${o}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Gt(u)});try{await Promise.all(l),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Oe(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Adicionar Bloqueio em Lote"}}function Jl(e){nt.addEventListener("submit",t=>{t.target.id==="blockageForm"&&Ul(t),t.target.id==="batchBlockageForm"&&_l(t)}),nt.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Oe(e)}),nt.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const o=a.dataset.action;if(o==="back-to-professionals")K("profissionais-section");else if(o==="delete-blockage"){if(await H("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Da(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),Oe(e)}catch(s){g("Erro",`Não foi possível remover o bloqueio: ${s.message}`,"error")}}else if(o==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await H("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await ss(r),g("Sucesso",`${r.length} bloqueios removidos.`,"success"),Oe(e)}catch(n){g("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function Wl(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){nt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const o=f(a);nt.innerHTML=`
        <section>
        ...
        </section>`,Jl(t),await Oe(t);const r=document.getElementById("batchProfSelectionContainer");try{const s=await ee(m.establishmentId);r.innerHTML=s.map(n=>`
            <div class="flex items-center">
    ...
    `}).join("")}function Sa(){const t=document.getElementById("showInactiveUsersToggle")?.checked?m.users:m.users.filter(a=>a.status==="active");od(t)}function sd(e={}){return Object.entries(ed).map(([t,a])=>{const o=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,s=Object.entries(td).map(([i,d])=>`
    ...
    `}).join("")}function Co(e){if(!ze||m.userRole==="professional")return"";const t=e?.accessibleEstablishments?.map(s=>s.id)||[],a=e?.accessibleCompanies?.map(s=>s.id)||[];if((e?.role||"professional")==="group_admin")return'<div class="p-3 bg-purple-50 border border-purple-200 rounded-lg text-purple-800 text-sm font-bold">Acesso Total (Global) liberado.</div>';let r='<div class="space-y-3 max-h-48 overflow-y-auto custom-scrollbar p-2 bg-gray-50 rounded border">';return ze.companies.forEach(s=>{const n=a.includes(s.id),i=ze.branches.filter(d=>d.companyId===s.id);r+=`
        ...
        `}),r+="</div>",r}async function Lo(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{a=await ee(m.currentViewContext.id),m.professionals=a}catch{console.warn("Profissionais não carregados")}if(["group_admin","company_admin"].includes(m.userRole)&&!ze)try{const l=await fetch("/api/establishments/hierarchy",{headers:{Authorization:`Bearer ${await m.getAuthToken?.()||""}`}});l.ok&&(ze=await l.json())}catch(l){console.error("Falha ao buscar hierarquia",l),ze={companies:[],branches:[]}}const o=l=>a?.find(c=>c.id===l),r=e?.professionalId;o(r);const s=e!==null;t.querySelector("#userFormTitle").textContent=s?`Editar: ${e.name}`:"Novo Usuário";const n=t.querySelector("#userForm");n.innerHTML=`
    ...
    `;const i=n.querySelector("#userRole"),d=n.querySelector("#hierarchySelectorContainer");if(i&&d){i.addEventListener("change",c=>{const u={...e,role:c.target.value};d.innerHTML=Co(u),l()});const l=()=>{d.querySelectorAll(".company-checkbox").forEach(c=>{c.addEventListener("change",u=>{u.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(v=>v.checked=u.target.checked)})})};l()}if(n.addEventListener("submit",async l=>{l.preventDefault();const c={};n.querySelectorAll("input[data-module]").forEach(y=>{const w=y.dataset.module,$=y.dataset.permission;c[w]||(c[w]={}),c[w][$]=y.checked});const u=n.querySelector("#userProfessionalId").value||null,p=n.querySelector("#userRole")?.value||"professional",b=[],v=[];if(p!=="group_admin"&&n.querySelector(".company-checkbox")&&(n.querySelectorAll(".company-checkbox:checked").forEach(y=>{b.push({id:y.value,name:y.dataset.name})}),n.querySelectorAll(".branch-checkbox:checked").forEach(y=>{v.push({id:y.value,name:y.dataset.name,companyId:y.dataset.companyId})}),v.length===0))return g("Atenção","Você deve selecionar pelo menos uma filial para este usuário.","error");const h={name:n.querySelector("#userName").value,permissions:c,professionalId:u,role:p,accessibleCompanies:b,accessibleEstablishments:v};try{if(s){const y=n.querySelector("#userEmail").value;e?.email!==y&&(h.email=y),await Ql(e.id,h),g("Usuário atualizado com sucesso!","success")}else h.email=n.querySelector("#userEmail").value,h.password=n.querySelector("#userPassword").value,await Yl(h),g("Usuário criado com sucesso!","success");Ft()}catch(y){g(`Erro: ${y.message}`,"error")}}),s){const l=n.querySelector('[data-action="show-password-form"]'),c=n.querySelector("#password-form");l&&c&&(l.addEventListener("click",()=>{l.classList.add("hidden"),c.classList.remove("hidden")}),c.querySelector('[data-action="cancel-password-change"]').addEventListener("click",()=>{l.classList.remove("hidden"),c.classList.add("hidden"),c.querySelector("#userNewPassword").value=""}),c.querySelector('[data-action="save-password"]').addEventListener("click",async u=>{const p=u.target,b=c.querySelector("#userNewPassword").value;if(!b||b.length<6)return g("Aviso","Senha deve ter no mínimo 6 caracteres.","error");if(await H("Alterar Senha","Tem certeza?"))try{p.disabled=!0,p.textContent="...",await Zl(e.id,b),g("Sucesso","Senha alterada.","success"),l.classList.remove("hidden"),c.classList.add("hidden")}catch(v){g("Erro",v.message,"error")}finally{p.disabled=!1,p.textContent="Salvar Senha"}}))}}async function rd(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([Gl(m.currentViewContext.id),ee(m.currentViewContext.id)]);m.users=t,m.professionals=a,Sa()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Falha ao carregar.</p>'}}async function Ft(){Ze.innerHTML=`
        <style>
    ...
    `,wt&&Ze.removeEventListener("click",wt),kt&&Ze.removeEventListener("change",kt),wt=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":Lo();break;case"edit-user":const o=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));Lo(o);break;case"back-to-list":Ft();break;case"delete-user":{if(e.stopPropagation(),await H("Excluir Usuário","Tem certeza? Ação irreversível."))try{await Xl(t.dataset.userId),g("Usuário excluído!","success"),Ft()}catch(r){g(`Erro: ${r.message}`,"error")}break}}},kt=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Sa();else if(t){e.stopPropagation();const a=t.dataset.userId,o=t.checked?"active":"inactive";try{await Kl(a,o);const r=m.users.findIndex(s=>s.id===a);r>-1&&(m.users[r].status=o,Sa())}catch(r){g(`Erro: ${r.message}`,"error"),t.checked=!t.checked}}},Ze.addEventListener("click",wt),Ze.addEventListener("change",kt),await rd()}const nd=document.getElementById("content");let To={},$a=null;function id(){Object.values(To).forEach(e=>e?.destroy()),To={}}function ld(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,o=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(o.setFontSize(18),o.text(e,o.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];o.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=o.lastAutoTable?o.lastAutoTable.finalY+20:60;o.text("Detalhes das Vendas",20,s),o.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),o.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Bo(e){const t=document.getElementById("genericModal"),a=f(e.client),o=f(e.items),r=f(e.responsavelCaixa||"N/A"),s=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function dd(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const o=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,d])=>d-i);o.innerHTML=r.map(([i,d])=>`
        <tr class="border-b">
    ...
    `}).join(""),s.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const d=i.dataset.transactionIndex,l=$a.transactions[d];l&&Bo(l)})}),n.innerHTML=a.map((i,d)=>{const l=f(i.client),c=f(i.items),u=f(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const d=i.dataset.transactionIndex,l=$a.transactions[d];l&&Bo(l)})})}async function Do(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,r=a.value;if(!o||!r)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,n=await en({establishmentId:m.establishmentId,startDate:o,endDate:r,cashierSessionId:s});$a=n,e.innerHTML=`
        ...
        `,dd(n)}catch(s){g("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${f(s.message)}</p>`}}async function cd(){id();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];nd.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Do),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const o=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${o}_a_${r}`;ld(s,"transactionsTable")});try{const o=await Dn(m.establishmentId),r=document.getElementById("cashierSessionFilter");o&&o.length>0&&o.forEach(s=>{const n=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=f(s.closedByName||"N/A");r.innerHTML+=`<option value="${s.id}">${i} - ${n}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Do()}const ud=document.getElementById("content");let P={payables:[],receivables:[],natures:[],costCenters:[],currentTab:"payables",statusFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",isFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1},St=null,$t=null;function _a(e){const t=new Map,a=[];return e&&(e.forEach(o=>t.set(o.id,{...o,children:[]})),t.forEach(o=>{o.parentId&&t.has(o.parentId)?t.get(o.parentId).children.push(o):a.push(o)})),a}function Hs(e){if(!e)return{day:"--",month:"---"};const t=new Date(e+"T00:00:00"),a=t.getDate().toString().padStart(2,"0"),o=t.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:a,month:o,full:t.toLocaleDateString("pt-BR")}}function le(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function md(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const o=(r,s=0)=>`
        ...
        `;e.innerHTML=t.map(r=>o(r)).join("")}async function Ea(e){const t=document.getElementById("genericModal"),a=e==="nature",o=a?"Naturezas Financeiras":"Centros de Custo",r=a?Zt:Na,s=a?Zn:ei,n=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const i=t.querySelector("#hierarchyList"),d=t.querySelector("#itemParent"),l=u=>{const p=_a(u);md(i,p,e);const b=d.value;d.innerHTML='<option value="">-- Categoria Principal --</option>';const v=(h,y=0)=>{const w="  ".repeat(y)+(y>0?"↳ ":"");d.innerHTML+=`<option value="${h.id}">${w}${h.name}</option>`,h.children.forEach($=>v($,y+1))};p.forEach(h=>v(h)),d.value=b};try{const u=await r(m.establishmentId);P[n]=u,l(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const p=t.querySelector("#itemName").value,b=d.value;try{await s({name:p,parentId:b||null,establishmentId:m.establishmentId});const v=await r(m.establishmentId);P[n]=v,l(v),c.reset(),await Ee(),g("Sucesso","Item adicionado.","success")}catch(v){g("Erro",v.message,"error")}})}async function pd(){gd(),bd(),await Ee()}function gd(){ud.innerHTML=`
                    ...
                    <div id="filter-panel" class="hidden overflow-hidden transition-all duration-300 mb-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="date" id="filterStartDate" value="${P.startDate}" class="w-full p-2 border border-gray-200 rounded-lg text-sm bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="text-xs font-semibold text-gray-500 ml-1">Até</label>
                                <input type="date" id="filterEndDate" value="${P.endDate}" class="w-full p-2 border border-gray-200 rounded-lg text-sm bg-white focus:ring-2 focus:ring-indigo-500 outline-none">
                            </div>
                            <div class="col-span-2 md:col-span-1">
    ...
    `}function bd(){document.getElementById("select-all-toggle").addEventListener("change",a=>{const o=a.target.checked,r=document.querySelectorAll(".item-checkbox");P.selectedIds.clear(),r.forEach(s=>{s.checked=o,o&&P.selectedIds.add(s.dataset.id)}),Ae()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{P.selectedIds.clear(),document.getElementById("select-all-toggle").checked=!1,document.querySelectorAll(".item-checkbox").forEach(a=>a.checked=!1),Ae()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const a=P.selectedIds.size;if(a===0)return;if(await H("Excluir Selecionados",`Tem certeza que deseja excluir ${a} itens? Esta ação não pode ser desfeita.`))try{const r=P.currentTab==="payables"?"payables":"receivables";await Ss(r,Array.from(P.selectedIds)),g("Sucesso",`${a} itens excluídos.`,"success"),P.selectedIds.clear(),Ae(),Ee()}catch(r){g("Erro","Falha ao excluir itens.","error"),console.error(r)}}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const a=document.getElementById("filter-panel"),o=document.getElementById("toggle-filter-btn");P.isFilterOpen=!P.isFilterOpen,P.isFilterOpen?(a.classList.remove("hidden"),o.classList.add("bg-indigo-100","text-indigo-600")):(a.classList.add("hidden"),o.classList.remove("bg-indigo-100","text-indigo-600"))}),document.getElementById("settings-btn").addEventListener("click",kd),document.getElementById("fab-add").addEventListener("click",()=>{const a=P.currentTab==="payables"?"payable":"receivable";da(a)});const e=document.getElementById("tab-receivables"),t=document.getElementById("tab-payables");e.addEventListener("click",()=>Po("receivables")),t.addEventListener("click",()=>Po("payables")),document.querySelectorAll(".status-filter-btn").forEach(a=>{a.addEventListener("click",o=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-indigo-100","text-indigo-700"),r.classList.add("text-gray-500")}),o.target.classList.add("bg-indigo-100","text-indigo-700"),o.target.classList.remove("text-gray-500"),P.statusFilter=o.target.dataset.status})}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{P.startDate=document.getElementById("filterStartDate").value,P.endDate=document.getElementById("filterEndDate").value,P.filterNaturezaId=document.getElementById("filterNaturezaId").value,P.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("toggle-filter-btn").click(),Ee()}),St&&document.body.removeEventListener("click",St),St=a=>{const o=a.target;if(o.classList.contains("item-checkbox")){const n=o.dataset.id;o.checked?P.selectedIds.add(n):P.selectedIds.delete(n),Ae(),a.stopPropagation();return}const r=o.closest("button[data-action]");if(r){const{action:n,type:i,id:d}=r.dataset;if(a.stopPropagation(),n==="delete"){const l=r.closest(".financial-card-item").dataset.item.replace(/&apos;/g,"'"),c=JSON.parse(l);xd(i,c);return}if(n==="mark-as-paid"){hd(i,d);return}if(n==="manage-natures"){Ea("nature");return}if(n==="manage-cost-centers"){Ea("cost-center");return}if(n==="edit"){const l=JSON.parse(r.dataset.item.replace(/&apos;/g,"'"));da(i,l);return}}const s=o.closest(".financial-card-item");if(s&&document.getElementById("list-container").contains(s)&&!o.closest(".checkbox-wrapper")){const{type:n}=s.dataset,i=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));da(n,i)}},document.body.addEventListener("click",St),$t&&document.getElementById("genericModal").removeEventListener("click",$t),$t=a=>{if(a.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const r=a.target.closest('button[data-action^="delete-"]');if(r){const s=r.dataset.action.split("-")[1];wd(s,r.dataset.id)}},document.getElementById("genericModal").addEventListener("click",$t)}function Ae(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),o=P.selectedIds.size;t.textContent=o,o>0?(e.classList.remove("hidden"),a.classList.add("hidden")):(e.classList.add("hidden"),a.classList.remove("hidden"))}function Po(e){P.currentTab=e,P.selectedIds.clear(),Ae();const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),o=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-green-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),o.className="fixed bottom-6 right-6 w-14 h-14 bg-green-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-green-700 hover:scale-105 transition-all z-40"):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-green-700","shadow-sm"),t.classList.add("text-gray-500"),o.className="fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-red-700 hover:scale-105 transition-all z-40"),Os()}async function Ee(){const e=document.getElementById("list-container");e.innerHTML='<div class="loader mx-auto my-10"></div>';try{if(P.natures.length===0){const[r,s]=await Promise.all([Zt(m.establishmentId),Na(m.establishmentId)]);P.natures=r,P.costCenters=s,fd()}const t={startDate:P.startDate,endDate:P.endDate,establishmentId:m.establishmentId};P.filterNaturezaId!=="all"&&(t.natureId=P.filterNaturezaId),P.filterCostCenterId!=="all"&&(t.costCenterId=P.filterCostCenterId);const[a,o]=await Promise.all([Es(t),Is(t)]);P.payables=a.entries||[],P.receivables=o.entries||[],vd(),Os()}catch(t){e.innerHTML=`<p class="text-center text-red-500 mt-10">Erro ao carregar: ${t.message}</p>`}}function fd(){const e=o=>{let r='<option value="all">Todas</option>';const s=_a(o),n=(i,d=0)=>{const l="  ".repeat(d)+(d>0?"↳ ":"");r+=`<option value="${i.id}">${l}${i.name}</option>`,i.children.forEach(c=>n(c,d+1))};return s.forEach(i=>n(i)),r},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(P.natures)),a&&(a.innerHTML=e(P.costCenters)),t&&(t.value=P.filterNaturezaId),a&&(a.value=P.filterCostCenterId)}function vd(){const e=document.getElementById("summary-section");if(!e)return;const t=P.receivables.reduce((d,l)=>d+l.amount,0),a=P.receivables.filter(d=>d.status==="paid").reduce((d,l)=>d+l.amount,0),o=t-a,r=P.payables.reduce((d,l)=>d+l.amount,0),s=P.payables.filter(d=>d.status==="paid").reduce((d,l)=>d+l.amount,0),n=r-s,i=a-s;e.innerHTML=`
    ...
    `}function Os(){const e=document.getElementById("list-container");if(!e)return;const t=P.currentTab==="receivables",a=t?P.receivables:P.payables;let o=a;if(P.statusFilter!=="all"&&(o=a.filter(n=>n.status===P.statusFilter)),o.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),o.length===0){e.innerHTML=`
        ...
        `}).join("")}async function hd(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?ri(t,a):di(t,a)),g("Sucesso","Lançamento baixado!","success"),await Ee()}catch(o){g("Erro",o.message,"error")}}async function xd(e,t){if(!!!t.recurrenceId){await H("Excluir Lançamento","Tem certeza? Essa ação não pode ser desfeita.")&&await zs(e,[t.id]);return}yd(e,t)}function yd(e,t){const a=document.getElementById("genericModal"),r=(e==="payable"?P.payables:P.receivables).filter(l=>l.recurrenceId===t.recurrenceId);r.sort((l,c)=>new Date(l.dueDate)-new Date(c.dueDate)),a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-2 space-y-1 custom-scrollbar flex-1">
                ${r.map(l=>{const c=l.id===t.id,u=l.status==="paid",p=Hs(l.dueDate);return`
                    <label class="flex items-center gap-3 p-3 bg-white rounded-xl border ${c?"border-red-300 ring-1 ring-red-100":"border-gray-200"} hover:border-red-300 cursor-pointer transition-all group">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500">${le(l.amount)} ${u?'<span class="text-green-600 font-bold ml-1">(Pago)</span>':'<span class="text-orange-500 ml-1">(Pendente)</span>'}</p>
                        </div>
    ...
    `,a.style.display="flex";const s=a.querySelector("#modal-select-all"),n=a.querySelectorAll(".modal-item-checkbox"),i=a.querySelector("#confirm-batch-delete");s.addEventListener("change",l=>{n.forEach(c=>c.checked=l.target.checked),d()}),n.forEach(l=>{l.addEventListener("change",d)});function d(){const l=Array.from(n).filter(c=>c.checked).length;i.textContent=l>0?`Excluir ${l} Item(ns)`:"Selecione itens para excluir",i.disabled=l===0,l===0?i.classList.add("opacity-50","cursor-not-allowed"):i.classList.remove("opacity-50","cursor-not-allowed")}i.addEventListener("click",async()=>{const l=Array.from(n).filter(u=>u.checked).map(u=>u.value);if(l.length===0)return;a.style.display="none",await H("Confirmar Exclusão",`Tem certeza que deseja apagar ${l.length} itens definitivamente?`)&&await zs(e,l)}),d()}async function zs(e,t){try{t.length===1?e==="payable"?await si(t[0]):await li(t[0]):await Ss(e==="payable"?"payables":"receivables",t),g("Sucesso",`${t.length} item(ns) excluído(s).`,"success"),P.selectedIds.clear(),Ae(),await Ee()}catch(a){g("Erro",a.message,"error")}}async function wd(e,t){const o=e==="nature"?Kn:ti;if(await H("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await o(t),Ea(e==="nature"?"nature":"cost-center")}catch(s){g("Erro",s.message,"error")}}function kd(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function da(e,t=null){const a=document.getElementById("genericModal"),o=e==="payable",r=o?"red":"green",s=t?`Editar ${o?"Despesa":"Receita"}`:`Nova ${o?"Despesa":"Receita"}`,n=($,k)=>{let C='<option value="">-- Selecione --</option>';const T=_a($),A=(q,B=0)=>{const M="  ".repeat(B)+(B>0?"↳ ":""),R=q.id===k?"selected":"";C+=`<option value="${q.id}" ${R}>${M}${q.name}</option>`,q.children.forEach(F=>A(F,B+1))};return T.forEach(q=>A(q)),C};a.innerHTML=`
        <div class="modal-content max-w-xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden m-4 flex flex-col max-h-[90vh]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="centroDeCustoId" class="w-full p-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-${r}-500 outline-none text-sm appearance-none">
                                ${n(P.costCenters,t?.centroDeCustoId)}
                            </select>
                        </div>
                    </div>
        ...
        </div>`,a.style.display="flex";const i=a.querySelector("#financial-form");let d="single",l=2;const c=i.querySelector('[name="amount"]'),u=i.querySelector("#recurrence-options"),p=i.querySelector("#recurrence-summary"),b=i.querySelector("#installments-input"),v=i.querySelector("#status-toggle"),h=i.querySelector("#payment-date-wrapper"),y=i.querySelector('[name="paymentDate"]'),w=()=>{if(d==="single")return;const $=parseFloat(c.value)||0;if(l=parseInt(b.value)||2,$===0){p.innerHTML="Digite um valor para ver a simulação.";return}if(d==="installment"){const k=$/l;p.innerHTML=`
            ...
            `}};t||(a.querySelectorAll(".mode-btn").forEach($=>{$.addEventListener("click",k=>{if(a.querySelectorAll(".mode-btn").forEach(C=>{C.classList.remove("bg-white","text-gray-800","shadow-sm","font-semibold"),C.classList.add("text-gray-500","font-medium")}),k.target.classList.add("bg-white","text-gray-800","shadow-sm","font-semibold"),k.target.classList.remove("text-gray-500","font-medium"),d=k.target.dataset.mode,d==="single")u.classList.add("hidden");else{u.classList.remove("hidden");const C=u.querySelector("label");C.textContent=d==="installment"?"Número de Parcelas":"Repetir por quantos meses?",w()}})}),a.querySelector('[data-mode="single"]').click()),c.addEventListener("input",w),b&&(b.addEventListener("input",w),i.querySelector("#btn-minus").addEventListener("click",()=>{let $=parseInt(b.value)||2;$>2&&(b.value=$-1,w())}),i.querySelector("#btn-plus").addEventListener("click",()=>{let $=parseInt(b.value)||2;$<60&&(b.value=$+1,w())})),v.addEventListener("change",()=>{v.checked?(h.classList.remove("hidden"),y.required=!0):(h.classList.add("hidden"),y.required=!1)}),i.addEventListener("submit",async $=>{$.preventDefault();const k=new FormData(i),C=v.checked,T=parseFloat(k.get("amount"));let A=T,q=1;!t&&d!=="single"?(q=parseInt(k.get("installments")),d==="repeat"&&(A=T*q)):q=1;const B={description:k.get("description"),amount:A,dueDate:k.get("dueDate"),naturezaId:k.get("naturezaId")||null,centroDeCustoId:k.get("centroDeCustoId")||null,notes:k.get("notes"),status:C?"paid":"pending",paymentDate:C?k.get("paymentDate"):null,establishmentId:m.establishmentId,installments:q};q>1&&!t&&(B.recurrenceId=self.crypto.randomUUID());try{t?(await(o?oi(t.id,B):ii(t.id,B)),g("Sucesso","Atualizado com sucesso!","success")):(await(o?ai(B):ni(B)),g("Sucesso","Lançamento criado!","success")),document.getElementById("genericModal").style.display="none",Ee()}catch(M){console.error(M),g("Erro",M.message||"Erro ao salvar","error")}})}const Sd=e=>E("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),$d=e=>E("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),Ed=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return E(`/api/commissions/stats?${a}`)},Id=(e={})=>{Object.keys(e).forEach(o=>(e[o]===void 0||e[o]===null||e[o]==="")&&delete e[o]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return E(a)},Cd=e=>E(`/api/commissions/report/${e}`,{method:"DELETE"}),Ht=new Date,Mo=new Date(Ht.getFullYear(),Ht.getMonth(),1),N={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:Mo.toISOString().split("T")[0],dashEndDate:Ht.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:Mo.toISOString().split("T")[0],histEndDate:Ht.toISOString().split("T")[0],histProfessionalId:"all"};let Et=null;const Ke=document.getElementById("content");async function Ld(){try{N.professionals=await ee(m.establishmentId)}catch(e){console.error("Erro profissionais",e)}Fd(),Td(),aa(),zt("dashboard")}function Td(){Et&&Ke.removeEventListener("click",Et),Et=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,o=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":zt(t.dataset.tab);break;case"toggle-all-profs":Bd();break;case"back-to-filters":N.calculationResult=null,Ot(document.getElementById("commissions-content"));break;case"view-preview-items":jd(r);break;case"save-final-report":Pd();break;case"start-new-calc":zt("calculator");break;case"print-receipt":Md(o);break;case"delete-report":Ad(o);break;case"filter-dashboard":aa();break;case"filter-history":Ja();break}},Ke.addEventListener("click",Et),Ke.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Nd(t)}},Ke.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Dd())}}async function aa(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(N.dashStartDate=e.value),t&&(N.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const o=await Ed(N.dashStartDate,N.dashEndDate);N.dashStats={revenue:o.totalRevenue||0,commissions:o.totalCommissionsPaid||0},N.currentTab==="dashboard"&&Vs(document.getElementById("commissions-content"))}catch(o){console.error(o),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Ja(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(N.histStartDate=e.value),t&&(N.histEndDate=t.value),a&&(N.histProfessionalId=a.value);const o=document.getElementById("history-list-container");if(o){o.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await Id({startDate:N.histStartDate,endDate:N.histEndDate,professionalId:N.histProfessionalId});N.historyData=r,Us(o,r)}catch{o.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Bd(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function Dd(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),o=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");N.periodString=`${a} a ${o}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await Sd(t);N.calculationResult=s.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),Ot(r)}catch(s){g("Erro",s.message,"error"),N.calculationResult=null,Ot(r)}}async function Pd(){const e=N.calculationResult.length;if(await H("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=N.calculationResult.map(o=>{const r=o.items.map(s=>s.originalSaleId).filter(s=>s!=null);return $d({professionalId:o.professionalId,professionalName:o.professionalName,period:N.periodString,processedSalesIds:r,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),N.calculationResult=null,aa(),zt("history")}catch(a){g("Erro",a.message,"error")}}function Md(e){const t=N.historyData.find(a=>a.id===e);t&&qd(t)}async function Ad(e){if(await H("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Cd(e),g("Sucesso","Registro removido.","success"),Ja(),aa()}catch(a){g("Erro",a.message,"error")}}function qd(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,o=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",o,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const s=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Nd(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let o=0,r=0;if(t.forEach(s=>{s.value&&(o=parseFloat(s.value))}),a.forEach(s=>{s.value&&(r=parseFloat(s.value))}),N.calculationResult&&N.calculationResult[e]){const s=N.calculationResult[e];s.extraDebit=o,s.extraCredit=r,s.finalValue=s.summary.totalCommission-o+r,t.forEach(i=>{i!==document.activeElement&&(i.value=o||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${s.finalValue.toFixed(2)}`),Rd()}}function Rd(){const e=N.calculationResult.reduce((a,o)=>a+o.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function jd(e){const t=N.calculationResult[e];if(!t)return;const a=t.items.map(o=>`
    ...
    `}function Hd(e){const t=N.professionals.map(a=>`<option value="${a.id}" ${N.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,N.historyData.length>0?Us(document.getElementById("history-list-container"),N.historyData):Ja()}function Us(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ca=document.getElementById("content");let Se={allPackages:[],catalogForModal:{services:[],products:[]}},It=null,qe=null;function Od(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function zd(){const e=document.getElementById("packagesListContainer");if(e){if(Se.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=Se.allPackages.map(t=>{const a=t.status==="active",o=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,s=t.originalPrice||0,n=s>r?s-r:0,i=s>0?(s-r)/s*100:0,d=f(t.name),l=f(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function Ao(){const e=document.getElementById("genericModal");e.style.display="none",qe&&e.removeEventListener("click",qe)}async function qo(e=null){const t=document.getElementById("genericModal"),a=!!e,o=e?JSON.parse(JSON.stringify(e.items||[])):[],r=f(e?.name||""),s=f(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,d=e?.validityDays||30,l=`
    ...
    `;t.innerHTML=l,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(b,v)=>{const h=v.querySelector("#originalPrice"),y=b.reduce((w,$)=>w+$.price*$.quantity,0);h&&(h.textContent=`R$ ${y.toFixed(2)}`)},p=b=>{b.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=b.map((v,h)=>{const y=v.type==="service",w=y?"Serviço":"Produto",$=y?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(b,t)};p(o),c.addEventListener("change",b=>{if(b.target.classList.contains("quantity-input")){const v=parseInt(b.target.dataset.index,10),h=parseInt(b.target.value,10);h>0&&o[v]&&(o[v].quantity=h,p(o))}}),c.addEventListener("click",b=>{if(b.target.classList.contains("remove-item-btn")){const v=parseInt(b.target.dataset.index,10);o.splice(v,1),p(o)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Vd(b=>{const v=o.find(h=>h.id===b.id&&h.type===b.type);v?v.quantity++:o.push({...b,quantity:1}),p(o)}),qe&&t.removeEventListener("click",qe),qe=async b=>{const v=b.target.closest("button[data-action]");if(!v)return;const h=v.dataset.action;if(b.stopPropagation(),h==="close-modal"&&Ao(),h==="save-package"){const y=v,w={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:o,originalPrice:o.reduce(($,k)=>$+k.price*k.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!w.name||!w.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(w.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}y.disabled=!0,y.textContent="A salvar...";try{a?await An(w.id,w):(delete w.id,await Mn(w)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Ao(),await Wa()}catch($){g("Erro",`Não foi possível salvar o pacote: ${$.message}`,"error"),y.disabled=!1,y.textContent="Salvar Pacote"}}},t.addEventListener("click",qe)}function Vd(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const o={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=d=>{const l=t.toLowerCase(),c=Se.catalogForModal.services.filter(v=>v.name.toLowerCase().includes(l)),u=Se.catalogForModal.products.filter(v=>v.name.toLowerCase().includes(l)),p=c.map(v=>`
    ...
    `,It&&ca.removeEventListener("click",It),It=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const o=e.target.closest('[data-action="delete-package"]');if(o){const r=o.dataset.id;H("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await qn(r),g("Sucesso!","Pacote excluído.","success"),await Wa()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")qo(null);else if(a==="edit-package"){const o=JSON.parse(t.dataset.package);qo(o)}},ca.addEventListener("click",It);try{const[e,t,a]=await Promise.all([qa(m.establishmentId),fe(m.establishmentId),pt(m.establishmentId)]);Se.allPackages=e,Se.catalogForModal={services:t.filter(o=>o.active),products:a},zd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Ud=document.getElementById("content");let _d=null;async function Jd(){const e=f(m.userName||"Usuário"),t=f(U.currentUser?.email||"E-mail não disponível"),a=m.userName?m.userName.charAt(0):"U";Ud.innerHTML=`
    ...
    `,await Wd()}async function Wd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await Er(t);_d=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const o=f(a.name);e.innerHTML=`
            ...
            `,Gd(a.id),document.getElementById("my-blocks-filter").addEventListener("change",s=>Vt(a.id,s.target.value)),Vt(a.id,"future")}else e.innerHTML=`
    ...
    `;try{const t=await kr(),{group:a,companies:o,branches:r}=t;let s=`
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex gap-2">
                    ${a?'<button id="btn-new-company" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm">+ Nova Empresa</button>':""}
                    ${o&&o.length>0?'<button id="btn-new-branch" class="bg-white hover:bg-gray-50 text-indigo-600 border border-indigo-200 px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm">+ Nova Filial</button>':""}
                </div>
            </div>
            <div class="space-y-6">
        `;a?(s+=`
            ...
            `,o&&o.length>0?o.forEach(u=>{const p=r.filter(b=>b.companyId===u.id);s+=`
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            <div class="bg-gray-50 border-b border-gray-200 p-4 flex justify-between items-center">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 class="text-md font-bold text-gray-800">${u.name}</h4>
                                        <p class="text-xs text-gray-500">CNPJ: ${u.cnpj||"Não informado"}</p>
                                    </div>
                                </div>
                                <span class="bg-white text-xs font-medium px-2.5 py-1 rounded-full border border-gray-200 text-gray-600">${p.length} Filial(is)</span>
                            </div>
                            
                            <div class="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    `,p.length>0?p.forEach(b=>{s+=`
                                <div class="border border-gray-100 rounded-lg p-4 hover:border-indigo-300 transition-colors cursor-pointer group relative overflow-hidden">
                                    <div class="absolute top-0 left-0 w-1 h-full ${b.status==="active"?"bg-green-500":"bg-red-500"}"></div>
                                    <div class="flex justify-between items-start mb-2 pl-2">
                                        <h5 class="font-semibold text-gray-800 group-hover:text-indigo-600 transition-colors">${b.name}</h5>
                                    </div>
                                    <p class="text-xs text-gray-500 mb-1 flex items-center gap-1 pl-2">
                                        ...
                                        ${b.address||"Endereço não definido"}
                                    </p>
                            ...
                            `}):s+='<p class="text-sm text-gray-400 italic col-span-full py-2">Nenhuma filial cadastrada nesta empresa.</p>',s+="</div></div>"}):s+=`
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="branch-company" class="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-indigo-500 outline-none">
                                ${(o||[]).map(u=>`<option value="${u.id}">${u.name}</option>`).join("")}
                            </select>
                        </div>
                        <div>
        ...
        `,e.innerHTML=s;const n=document.getElementById("btn-create-group");n&&(n.onclick=async()=>{const u=prompt("Qual o nome da sua Marca ou Grupo Principal? (Ex: Grupo Kairos)");if(u&&u.trim()!==""){n.innerText="Criando...";try{await xr(u.trim()),Pt(e)}catch(p){alert(p.message),n.innerText="Criar Meu Grupo Económico"}}});const i=document.getElementById("btn-new-company"),d=document.getElementById("modal-company");i&&d&&(i.onclick=()=>{d.classList.remove("hidden"),document.getElementById("comp-name").value=""},document.getElementById("btn-close-comp").onclick=()=>d.classList.add("hidden"),document.getElementById("btn-save-comp").onclick=async()=>{const u=document.getElementById("comp-name").value.trim(),p=document.getElementById("comp-cnpj").value.trim();if(!u)return alert("O nome da empresa é obrigatório.");document.getElementById("btn-save-comp").innerText="Salvando...";try{await yr(u,p,a.id),Pt(e)}catch(b){alert(b.message),document.getElementById("btn-save-comp").innerText="Salvar"}});const l=document.getElementById("btn-new-branch"),c=document.getElementById("modal-branch");l&&c&&(l.onclick=()=>{if(!o||o.length===0)return alert("Crie uma empresa primeiro.");c.classList.remove("hidden"),document.getElementById("branch-name").value=""},document.getElementById("btn-close-branch").onclick=()=>c.classList.add("hidden"),document.getElementById("btn-save-branch").onclick=async()=>{const u=document.getElementById("branch-company").value,p=document.getElementById("branch-name").value.trim(),b=document.getElementById("branch-phone").value.trim(),v=document.getElementById("branch-timezone").value;if(!p)return alert("O nome da filial é obrigatório.");document.getElementById("btn-save-branch").innerText="Criando...";try{await wr({name:p,companyId:u,groupId:a.id,phone:b,timezone:v}),Pt(e)}catch(h){alert(h.message),document.getElementById("btn-save-branch").innerText="Criar Filial"}})}catch(t){console.error(t),e.innerHTML=`
            <div class="bg-red-50 text-red-600 p-4 rounded-lg flex items-center gap-3 border border-red-200">
                <span>Erro ao carregar hierarquia: ${t.message}</span>
            </div>
        `}}document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const Ct=document.getElementById("loadingScreen"),ua=document.getElementById("dashboardContent"),Mt=document.getElementById("content"),No=document.getElementById("notificationBell"),ma=document.getElementById("notificationBadge"),Lt=document.getElementById("notificationPanel"),Ro=document.getElementById("notificationList"),pa=document.getElementById("profileMenuButton"),ae=document.getElementById("profileDropdown"),Yd=document.getElementById("profileName"),Qd=document.getElementById("profileEmail"),Xd=document.getElementById("logoutButton"),jo=document.getElementById("myProfileLink"),Fo=document.getElementById("hamburger-menu-btn"),we=document.getElementById("sidebar"),Ne=document.getElementById("mobile-overlay"),Ho={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let it=null,lt=[];const Zd={"agenda-section":bs,"comandas-section":Xn,"relatorios-section":mi,"servicos-section":Mi,"produtos-section":Gi,"suppliers-section":ol,"profissionais-section":jt,"clientes-section":Il,"estabelecimento-section":Fs,"ausencias-section":Wl,"users-section":Ft,"sales-report-section":cd,"financial-section":pd,"commissions-section":Ld,"packages-section":Wa,"my-profile-section":Jd,"hierarquia-section":()=>Pt(Mt)};function Kd(e){const t=Ho[e]||Ho.indigo,o=(s=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function Ia(){const e=lt.filter(t=>!t.read).length;if(e>0?(ma.textContent=e,ma.classList.remove("hidden")):ma.classList.add("hidden"),lt.length===0){Ro.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Ro.innerHTML=lt.map(t=>`
    ...
    `).join("")}function ec(e){it&&it();const t=be(J,"establishments",e,"notifications"),a=Ut(t,dt("timestamp",">=",new Date),Uo("timestamp","desc"));it=ar(a,o=>{o.docChanges().forEach(r=>{if(r.type==="added"){const s=r.doc.data();lt.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(s.title,s.message,"info",!0),Ia();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(s.type==="cancellation"||s.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),bs())}})},o=>{console.error("Erro no listener de notificações em tempo real:",o)})}function K(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=["hierarquia-section","estabelecimento-section"].includes(e),s=m.enabledModules?.[a]!==!1,n=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!r&&(!s||!n)){Mt.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(i=>i.classList.remove("active")),we.classList.contains("absolute")&&(we.classList.add("hidden"),Ne.classList.add("hidden"));return}}const o=Zd[e];o?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),Mt.innerHTML="",window.innerWidth<768&&(we.classList.add("hidden"),Ne.classList.add("hidden")),o(t)):Mt.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`}async function tc(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),o=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(s&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),n&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!s&&!n))try{const i=await tn();s&&o&&(o.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i)}}async function ac(e){try{console.log("[Nativo] Iniciando configuração de Push..."),se.getPlatform()==="android"&&(await G.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let t=await G.checkPermissions();if(t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive!=="granted")return;await G.register(),G.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const o=ge(J,"users",e);await Ca(o,{fcmTokens:tr(a.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(o){console.error("Erro ao salvar token FCM:",o)}}),G.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),G.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),g(a.title,a.body,"info",!0)}),G.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),K("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function oc(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),o=()=>e.style.display="block",r=()=>e.style.display="none",s=()=>e.style.display==="block";e&&(t.addEventListener("click",()=>{r(),se.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{r(),se.isNativePlatform()?io.exitApp():history.back()}),se.isNativePlatform()?io.addListener("backButton",({canGoBack:n})=>{if(s())r();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),d=Array.from(i).filter(u=>u.id!=="exitConfirmationModal");if(d.length>0){d.forEach(u=>u.style.display="none");return}const l=document.getElementById("sidebar");if(l&&!l.classList.contains("hidden")&&window.innerWidth<768){l.classList.add("hidden"),document.getElementById("mobile-overlay").classList.add("hidden");return}const c=document.querySelector(".sidebar-link.active");c&&c.getAttribute("data-target")==="agenda-section"?o():K("agenda-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",n=>{if(s()){r(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),d=Array.from(i).filter(c=>c.id!=="exitConfirmationModal");if(d.length>0){d.forEach(c=>c.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="agenda-section"?o():(K("agenda-section"),history.pushState(null,document.title,location.href))})))}async function sc(){try{await Xs(U,Zs),console.log("Persistência LOCAL configurada na inicialização.")}catch(e){console.error("Erro ao definir persistência no main.js",e)}se.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),gr(),oc(),Fo&&Fo.addEventListener("click",e=>{e.stopPropagation(),we.classList.remove("hidden"),we.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl"),Ne.classList.remove("hidden")}),Ne&&Ne.addEventListener("click",()=>{we.classList.add("hidden"),we.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl"),Ne.classList.add("hidden")}),No.addEventListener("click",e=>{e.stopPropagation(),Lt.classList.toggle("hidden"),Lt.classList.contains("hidden")||(lt.forEach(t=>t.read=!0),Ia())}),pa.addEventListener("click",e=>{e.stopPropagation(),ae.classList.toggle("active"),ae.classList.contains("active")?ae.classList.remove("hidden"):setTimeout(()=>ae.classList.add("hidden"),200)}),jo&&jo.addEventListener("click",e=>{e.preventDefault(),K("my-profile-section"),ae.classList.remove("active"),ae.classList.add("hidden")}),document.addEventListener("click",e=>{!Lt.contains(e.target)&&e.target!==No&&Lt.classList.add("hidden"),!ae.contains(e.target)&&e.target!==pa&&ae.classList.contains("active")&&(ae.classList.remove("active"),setTimeout(()=>ae.classList.add("hidden"),200))}),Oo(U,async e=>{if(e){if(console.log("Usuário detectado:",e.email),!se.isNativePlatform()&&(console.log("Inicializando Web Push (PWA)..."),es(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast"),o=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");setTimeout(()=>{t&&(t.style.display="block")},3500),a&&a.addEventListener("click",async()=>{await ts()&&t&&(t.style.display="none")});const s=()=>{t&&(t.style.display="none")};o&&o.addEventListener("click",s),r&&r.addEventListener("click",s)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const o=await Ie(a.establishmentId);m.enabledModules=o.modules,Kd(o.themeColor||"indigo");let r=null,s=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const l=ge(J,"users",e.uid),c=await zo(l);if(c.exists()){const u=c.data();r=a.role==="employee"?u.permissions||{}:null,s=u.name||s,n=u.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}m.userProfessionalId=n,se.isNativePlatform()&&ac(e.uid);const i=s||e.email;rr(a.establishmentId,o.name,r),pa.textContent=i.charAt(0).toUpperCase(),Yd.textContent=i,Qd.textContent=e.email;const d=()=>{it&&it(),Ya(U).then(()=>window.location.href="/login.html")};Xd.addEventListener("click",l=>{l.preventDefault(),d()}),hr(K,r,m.enabledModules),tc(r),ec(a.establishmentId),Ia(),Ct.classList.add("fade-out"),ua.style.display="flex",setTimeout(()=>{Ct.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{Nr()},1500),K("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),Ct.classList.add("fade-out"),setTimeout(()=>{Ct.style.display="none"},500),ua.innerHTML=`
                ...
                `,ua.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{Ya(U).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}sc();Oo(U,async e=>{if(e){await es();const a="Notification"in window&&Notification.permission==="default",o=window.Capacitor&&window.Capacitor.isNativePlatform();if(a&&!o){const r=document.getElementById("toast-notification-request"),s=document.getElementById("btn-enable-toast"),n=document.getElementById("btn-deny-toast"),i=document.getElementById("btn-close-toast");setTimeout(()=>{r&&(r.style.display="block")},3500),s&&s.addEventListener("click",async()=>{await ts()&&r&&(r.style.display="none")});const d=()=>{r&&(r.style.display="none")};n&&n.addEventListener("click",d),i&&i.addEventListener("click",d)}}});export{Ko as W};
