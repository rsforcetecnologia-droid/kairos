const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-M08-GkaJ.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-CZYPZ0h4.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as ne,d as be,m as Za}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as zs,reauthenticateWithCredential as Vs,verifyBeforeUpdateEmail as _s,updatePassword as Us,updateProfile as Ws,setPersistence as Js,browserLocalPersistence as Gs,onAuthStateChanged as Ys,signOut as Qs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as bt,getDoc as Vo,updateDoc as Ma,setDoc as Xs,addDoc as _o,collection as Yt,query as Uo,where as Wo,getDocs as Zs,deleteDoc as Ks,arrayUnion as er,orderBy as tr,onSnapshot as ar}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as or,onMessage as sr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const p={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function rr(e,t,a){p.establishmentId=e,p.establishmentName=t,p.userPermissions=a,p.currentViewContext={type:"BRANCH",id:e,name:t}}const Jo=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",va=Jo?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${Jo?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",va);async function ir(){const e=ne.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function E(e,t={}){const a=await ir();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=va.replace(/\/$/,""),o=e.startsWith("/")?e:`/${e}`,r=`${s}${o}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${r}`);try{const i=await fetch(r,{...t,headers:{...a,...t.headers}});if(!i.ok){const l=(await i.json().catch(()=>({message:i.statusText}))).message||`Erro na API: ${i.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${va}. Verifique se o servidor backend está rodando.`):i}}const Aa=(e,t,a,s=null)=>{let o=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(o+=`&professionalId=${s}`),E(o)},nr=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const o=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return E(o)},lr=e=>E("/api/appointments",{method:"POST",body:JSON.stringify(e)}),dr=(e,t)=>E(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),cr=e=>E(`/api/appointments/${e}`,{method:"DELETE"}),ur=e=>E(`/api/appointments/${e}/reopen`,{method:"POST"}),pr=(e,t)=>E(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Q;async function mr(){if(!Q)try{Q=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function gr(){if(!Q){console.warn("AudioContext não inicializado. O som não será tocado.");return}Q.state==="suspended"&&Q.resume();const e=Q.createOscillator(),t=Q.createGain();e.connect(t),t.connect(Q.destination),e.type="sine",e.frequency.setValueAtTime(800,Q.currentTime),t.gain.setValueAtTime(0,Q.currentTime),t.gain.linearRampToValueAtTime(.3,Q.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Q.currentTime+.2),e.start(Q.currentTime),e.stop(Q.currentTime+.2)}function g(e,t,a="info",s=!1){const o=document.getElementById("toast-container");if(!o)return;s&&gr();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `,o.appendChild(r),r.querySelector(".toast-close").addEventListener("click",()=>r.remove()),setTimeout(()=>{r.remove()},4e3)}function W(e,t){const a=document.getElementById("genericModal");return new Promise(s=>{a.innerHTML=`
    ...
    `;const l=o.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=o.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),o.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),o.style.display="flex",{modalElement:o,close:i,setContent:n}}function br(){document.body.addEventListener("click",()=>{Q||mr()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const s=t.dataset.target;if(s){const o=document.getElementById(s);o&&(o.style.display="none")}}if(e.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}const Y=document.getElementById("sidebar"),Pe=document.getElementById("sidebarToggle"),ot=document.getElementById("mainContent"),fr=document.querySelectorAll(".sidebar-link"),ya=document.getElementById("menu-search"),Ka=document.getElementById("hamburger-menu-btn"),We=document.getElementById("mobile-overlay");let fe=!0;function $e(e){if(!Y||!ot)return;Y.classList.toggle("collapsed",e),ot.classList.toggle("sidebar-collapsed-shift",e);const t=Y.querySelector(".sidebar-search-container"),a=Y.querySelectorAll(".sidebar-category");e?(t&&(t.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const o=s.getAttribute("data-target-submenu"),r=document.getElementById(o),i=s.querySelector(".submenu-arrow");r&&(r.classList.add("hidden"),r.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(t&&(t.style.display="block"),a.forEach(s=>s.style.display="block"))}function xr(){!Y||!We||(Y.classList.add("mobile-open"),We.classList.add("visible"))}function yt(){!Y||!We||(Y.classList.remove("mobile-open"),We.classList.remove("visible"))}function hr(){$e(!Y.classList.contains("collapsed"))}function vr(e,t){const a=document.getElementById(e);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&Y.classList.contains("collapsed")&&$e(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),t&&t.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),t&&t.classList.remove("rotate-180"))}function yr(){ya&&ya.addEventListener("input",e=>{const t=e.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),o=a.querySelectorAll(".sidebar-category");if(t===""){s.forEach(r=>r.style.display=""),o.forEach(r=>r.style.display="block");return}o.forEach(r=>r.style.display="none"),s.forEach(r=>{if(r.classList.contains("sidebar-category"))return;const i=r.querySelector(".sidebar-link")||r.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(t)){r.style.display="";const d=r.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const c=d.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const c=document.getElementById(d);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(f=>f.textContent.toLowerCase().includes(t))?r.style.display="":r.style.display="none")}else r.style.display="none"}})})}function wr(e,t,a){if(!Y||!ot)return;ot.classList.add("main-content-shift"),window.innerWidth>=1024?(fe=!0,$e(!1)):window.innerWidth>=768?(fe=!1,$e(!0)):(ot.classList.remove("main-content-shift","sidebar-collapsed-shift"),yt()),Pe&&Pe.addEventListener("click",o=>{o.stopPropagation(),window.innerWidth>=768?(fe=!fe,$e(!fe),fe?(Pe.classList.add("text-indigo-400"),Pe.classList.remove("text-gray-400")):(Pe.classList.remove("text-indigo-400"),Pe.classList.add("text-gray-400"))):hr()}),Y.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!fe&&Y.classList.contains("collapsed")&&$e(!1)}),Y.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!fe){const o=!!document.querySelector("#sidebarToggle:hover"),r=document.activeElement===ya;!o&&!r&&$e(!0)}}),Ka&&Ka.addEventListener("click",o=>{o.stopPropagation(),xr()}),We&&We.addEventListener("click",o=>{o.stopPropagation(),yt()});let s=0;Y.addEventListener("touchstart",o=>{s=o.changedTouches[0].screenX},{passive:!0}),Y.addEventListener("touchend",o=>{const r=o.changedTouches[0].screenX;s-r>50&&yt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(o=>{o.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation();const i=o.getAttribute("data-target-submenu"),n=o.querySelector(".submenu-arrow");vr(i,n)})}),yr(),fr.forEach(o=>{const r=o.getAttribute("data-target");if(!r)return;const i=r.replace("-section",""),n=a?.[i]!==!1,l=t===null||t[r]?.view===!0;if(!n||!l){o.parentElement&&o.parentElement.tagName==="LI"?o.parentElement.style.display="none":o.style.display="none";return}o.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),o.classList.add("active"),r&&typeof e=="function"&&e(r),window.innerWidth<768&&yt()})})}const kr=e=>E("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),Qe=()=>E("/api/establishments/hierarchy",{method:"GET"}),Ce=e=>{const t=e||p.establishmentId;return t?E(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},qa=(e,t)=>{const a=e||p.establishmentId;return a?E(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Sr=(e,t)=>{const a=e||p.establishmentId;return a?E(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},$r=(e,t)=>{const a=e||p.establishmentId;return a?E(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))};class Er{constructor(t,a,s){this.steps=t,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(t=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),t&&this.onComplete?this.onComplete():!t&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const t=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",t.onBefore&&(await t.onBefore(),await this.sleep(600));const a=await this.waitForElement(t.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const o=a.getBoundingClientRect(),r=8;this.spotlight.style.top=`${o.top+window.scrollY-r}px`,this.spotlight.style.left=`${o.left+window.scrollX-r}px`,this.spotlight.style.width=`${o.width+r*2}px`,this.spotlight.style.height=`${o.height+r*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(o)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(t){const a=this.popover.getBoundingClientRect(),s=20;let o=t.bottom+window.scrollY+s,r=t.left+window.scrollX;o+a.height>window.scrollY+window.innerHeight&&(o=t.top+window.scrollY-a.height-s),r+a.width>window.innerWidth&&(r=t.right+window.scrollX-a.width),r<s&&(r=s),this.popover.style.top=`${o}px`,this.popover.style.left=`${r}px`}handleResize(){this.isActive&&this.renderStep()}sleep(t){return new Promise(a=>setTimeout(a,t))}async waitForElement(t,a){if(!t)return null;const s=Date.now();for(;Date.now()-s<a;){const o=document.querySelector(t);if(o)return o;await this.sleep(100)}return null}}async function Ir(){try{console.log("A verificar Onboarding interativo...");const e=await Ce(p.establishmentId);if(!e||e.parentId||e.onboardingCompleted)return;const t=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await qa(p.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(o){console.error("Erro ao gravar fim do onboarding",o)}};new Er(t,a,a).start()}catch(e){console.error("Erro fatal ao iniciar onboarding:",e)}}var Je;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Je||(Je={}));class da extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const Lr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Cr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},o=()=>t!==null?t.name:Lr(e),r=()=>o()!=="web",i=u=>{const m=d.get(u);return!!(m?.platforms.has(o())||n(u))},n=u=>{var m;return(m=a.PluginHeaders)===null||m===void 0?void 0:m.find(f=>f.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,m={})=>{const f=d.get(u);if(f)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),f.proxy;const b=o(),y=n(u);let v;const w=async()=>(!v&&b in m?v=typeof m[b]=="function"?v=await m[b]():v=m[b]:t!==null&&!v&&"web"in m&&(v=typeof m.web=="function"?v=await m.web():v=m.web),v),S=(B,M)=>{var R,H;if(y){const z=y?.methods.find(j=>M===j.name);if(z)return z.rtype==="promise"?j=>a.nativePromise(u,M.toString(),j):(j,C)=>a.nativeCallback(u,M.toString(),j,C);if(B)return(R=B[M])===null||R===void 0?void 0:R.bind(B)}else{if(B)return(H=B[M])===null||H===void 0?void 0:H.bind(B);throw new da(`"${u}" plugin is not implemented on ${b}`,Je.Unimplemented)}},I=B=>{let M;const R=(...H)=>{const z=w().then(j=>{const C=S(j,B);if(C){const V=C(...H);return M=V?.remove,V}else throw new da(`"${u}.${B}()" is not implemented on ${b}`,Je.Unimplemented)});return B==="addListener"&&(z.remove=async()=>M()),z};return R.toString=()=>`${B.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:B,writable:!1,configurable:!1}),R},D=I("addListener"),L=I("removeListener"),q=(B,M)=>{const R=D({eventName:B},M),H=async()=>{const j=await R;L({eventName:B,callbackId:j},M)},z=new Promise(j=>R.then(()=>j({remove:H})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await H()},z},O=new Proxy({},{get(B,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return y?q:D;case"removeListener":return L;default:return I(M)}}});return s[u]=O,d.set(u,{name:u,proxy:O,platforms:new Set([...Object.keys(m),...y?[b]:[]])}),O};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=o,a.handleError=l,a.isNativePlatform=r,a.isPluginAvailable=i,a.registerPlugin=c,a.Exception=da,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Dr=e=>e.Capacitor=Cr(e),pe=Dr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Qt=pe.registerPlugin;class Go{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const r=this.windowListeners[t];r&&!r.registered&&this.addWindowListener(r),s&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const o=this.listeners[t];if(!o){if(s){let r=this.retainedEventArguments[t];r||(r=[]),r.push(a),this.retainedEventArguments[t]=r}return}o.forEach(r=>r(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new pe.Exception(t,Je.Unimplemented)}unavailable(t="not available"){return new pe.Exception(t,Je.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const o=s.indexOf(a);this.listeners[t].splice(o,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const eo=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),to=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Tr extends Go{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[o,r]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=to(o).trim(),r=to(r).trim(),a[o]=r}),a}async setCookie(t){try{const a=eo(t.key),s=eo(t.value),o=`; expires=${(t.expires||"").replace("expires=","")}`,r=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${o}; path=${r}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Qt("CapacitorCookies",{web:()=>new Tr});const Br=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const o=s.result;t(o.indexOf(",")>=0?o.split(",")[1]:o)},s.onerror=o=>a(o),s.readAsDataURL(e)}),Pr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(o=>o.toLocaleLowerCase()).reduce((o,r,i)=>(o[r]=e[t[i]],o),{})},Mr=(e,t=!0)=>e?Object.entries(e).reduce((s,o)=>{const[r,i]=o;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=t?encodeURIComponent(d):d,l+=`${r}=${n}&`}),l.slice(0,-1)):(n=t?encodeURIComponent(i):i,l=`${r}=${n}`),`${s}&${l}`},"").substr(1):null,Ar=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),o=Pr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(o.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[i,n]of Object.entries(e.data||{}))r.set(i,n);a.body=r.toString()}else if(o.includes("multipart/form-data")||e.data instanceof FormData){const r=new FormData;if(e.data instanceof FormData)e.data.forEach((n,l)=>{r.append(l,n)});else for(const n of Object.keys(e.data))r.append(n,e.data[n]);a.body=r;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(o.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class qr extends Go{async request(t){const a=Ar(t,t.webFetchExtra),s=Mr(t.params,t.shouldEncodeUrlParams),o=s?`${t.url}?${s}`:t.url,r=await fetch(o,a),i=r.headers.get("content-type")||"";let{responseType:n="text"}=r.ok?t:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await r.blob(),l=await Br(d);break;case"json":l=await r.json();break;case"document":case"text":default:l=await r.text()}const c={};return r.headers.forEach((u,m)=>{c[m]=u}),{data:l,headers:c,status:r.status,url:r.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Qt("CapacitorHttp",{web:()=>new qr});const ee=Qt("PushNotifications",{}),Rr="modulepreload",jr=function(e){return"/"+e},ao={},Nr=function(t,a,s){let o=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");o=l(a.map(d=>{if(d=jr(d),d in ao)return;ao[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":Rr,c||(m.as="script"),m.crossOrigin="",m.href=d,n&&m.setAttribute("nonce",n),document.head.appendChild(m),c)return new Promise((f,b)=>{m.addEventListener("load",f),m.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return o.then(i=>{for(const n of i||[])n.status==="rejected"&&r(n.reason);return t().catch(r)})},oo=Qt("App",{web:()=>Nr(()=>import("./web-M08-GkaJ.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Fr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let so=!1;async function Hr(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await ee.removeAllListeners(),await ee.addListener("registration",async a=>{Qo(a.value,!0)}),await ee.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await ee.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await ee.checkPermissions();t.receive==="prompt"&&(t=await ee.requestPermissions()),t.receive==="granted"&&await ee.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Yo()}async function Or(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Yo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Yo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await or(Za,{vapidKey:Fr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Qo(t,!1)):console.warn("[Push Web] Token veio vazio."),so||(sr(Za,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),so=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Qo(e,t){const a=ne.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=bt(be,"users",a.uid);try{const o=await Vo(s);if(o.exists()){const i=o.data().fcmTokens||[];if(i.length===1&&i[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Ma(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(o){if(o.code==="not-found")try{await Xs(s,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(r){console.error("Erro ao criar user:",r)}else console.error("Erro ao atualizar token:",o)}}const zr=(e,t,a="all",s="all")=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("professionalId",a),s&&s!=="all"&&o.append("costCenterId",s),E(`/api/reports/indicators?${o.toString()}`)},Vr=e=>e?E(`/api/financial/cost-centers/${e}`):Promise.resolve([]),_r=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const o=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&o.append("cashierSessionId",s),e&&o.append("establishmentId",e),E(`/api/reports/sales?${o.toString()}`)},Ur=()=>E("/api/reports/summary",{method:"GET"}),Ra=e=>e?String(e).replace(/\D/g,""):"",Xt=(e,t="",a=20,s={})=>{const o=new URLSearchParams;return t&&o.append("search",t),a&&o.append("limit",a),s&&s.hasLoyalty&&o.append("hasLoyalty","true"),s&&s.birthMonth&&o.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&o.append("inactiveDays",s.inactiveDays),E(`/api/clients/${e}?${o.toString()}`)},Xo=(e,t)=>{const a=encodeURIComponent(t);return E(`/api/clients/details/${e}/${a}`)},Zo=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Ra(t),s={...e,phone:a,id:a};return E(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},Ko=Zo,es=(e,t)=>Zo({...t,id:e}),Wr=e=>{const t=encodeURIComponent(e);return E(`/api/clients/${t}`,{method:"DELETE"})},Jr=(e,t,a,s)=>E("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ra(t),points:a,rewardName:s})}),Gr=(e,t)=>Xo(e,Ra(t));function x(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function ts(e,t=800,a=800,s=.7){return new Promise((o,r)=>{if(!e.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(e),i.onload=n=>{const l=new Image;l.src=n.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const f=u.toDataURL("image/jpeg",s);o(f)},l.onerror=d=>r(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>r(new Error("Erro ao ler o ficheiro."))})}let ca=null;async function Yr(){const e=document.getElementById("content");e.innerHTML=`
    ...
    `;try{const t=new Date,a=new Date(t.getFullYear(),t.getMonth(),t.getDate()),s=new Date(a);s.setHours(23,59,59,999);const o=new Date(a.getFullYear(),a.getMonth(),1),r=new Date(a);r.setDate(a.getDate()-6);const i=p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId],n=i.map(async C=>{const[V,Z]=await Promise.all([Aa(C,o.toISOString(),s.toISOString(),null),Xt(C)]);return{appts:V||[],clients:Z||[]}}),l=await Promise.all(n);let d=[],c=[];l.forEach(C=>{d=d.concat(C.appts),c=c.concat(C.clients)});const u=C=>(C.services||[]).reduce((V,Z)=>V+(Number(Z.price)||0),0)||Number(C.totalPrice||0)||Number(C.servicePrice||0),m=d.filter(C=>{const V=new Date(C.startTime);return V>=a&&V<=s}),f=m.filter(C=>C.status==="completed"),b=d.filter(C=>C.status==="completed"),y=f.reduce((C,V)=>C+u(V),0),v=b.reduce((C,V)=>C+u(V),0),w=m.length,S=b.length>0?v/b.length:0,I=[],D=[],L=["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"];for(let C=0;C<7;C++){const V=new Date(r);V.setDate(r.getDate()+C),I.push(L[V.getDay()]);const Z=new Date(V).setHours(0,0,0,0),se=new Date(V).setHours(23,59,59,999),we=d.filter(ht=>{const vt=new Date(ht.startTime).getTime();return ht.status==="completed"&&vt>=Z&&vt<=se}).reduce((ht,vt)=>ht+u(vt),0);D.push(we)}const q={labels:I,data:D},O=m.filter(C=>new Date(C.startTime).getTime()>=t.getTime()&&C.status!=="completed"&&C.status!=="cancelled").sort((C,V)=>new Date(C.startTime)-new Date(V.startTime)).slice(0,4).map(C=>({client:C.clientName||"Desconhecido",service:C.serviceName||(C.services&&C.services[0]?C.services[0].name:"Serviço"),time:new Date(C.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(C.professionalName||"").split(" ")[0]||"Profissional",id:C.id})),B=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,M=new Map;c.forEach(C=>{C.phone?M.set(C.phone,C):M.set(C.id||Math.random().toString(),C)});const H=Array.from(M.values()).filter(C=>{if(!C.birthDate)return!1;let V,Z;if(C.birthDate.includes("-")){const se=C.birthDate.split("-");se[0].length===4?(V=se[1],Z=se[2]):(Z=se[0],V=se[1])}else if(C.birthDate.includes("/")){const se=C.birthDate.split("/");Z=se[0],V=se[1]}return`${Z}/${V}`===B}).map(C=>{let V="";return C.birthDate&&C.birthDate.includes("-")&&C.birthDate.split("-")[0].length===4&&(V=a.getFullYear()-parseInt(C.birthDate.split("-")[0])),{name:C.name,age:V,phone:C.phone}}),z={receitaHoje:y,agendamentosHoje:w,receitaMes:v,ticketMedio:S},j=i.length>1;Qr(e,z,q,O,H,j),Xr(q),Zr()}catch(t){console.error("Erro ao carregar dashboard:",t),e.innerHTML=`
        ...
        `}}function Qr(e,t,a,s,o,r){const i=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),n=r?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-0.5 rounded-full ml-2 align-middle">CONSOLIDADO</span>':"";e.innerHTML=`
                            ...
                            ${s.length>0?s.map(l=>`
                                <div data-action="goto-agenda" class="flex items-center justify-between p-3.5 rounded-[14px] border border-slate-100/60 bg-slate-50/50 hover:bg-indigo-50/30 hover:border-indigo-100 transition-all cursor-pointer group">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-700 text-sm group-hover:text-indigo-700 transition-colors">${x(l.client)}</p>
                                            <p class="text-[11px] text-slate-500 font-normal mt-0.5">${x(l.service)} <span class="mx-1 text-slate-300">•</span> ${x(l.prof)}</p>
                                        </div>
                                    </div>
                            ...
                            ${o.length>0?o.map(l=>{const c=`https://wa.me/${(l.phone||"").replace(/\D/g,"")}?text=${encodeURIComponent(`Olá ${l.name.split(" ")[0]}! A equipa deseja-lhe um Feliz Aniversário! 🎉`)}`;return`
                                <div class="flex items-center justify-between p-3 rounded-[12px] border border-rose-50 bg-rose-50/30">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-700 text-[0.8rem]">${x(l.name)}</p>
    ...
    `}function Xr(e){const t=document.getElementById("revenueChart");if(!t)return;ca&&ca.destroy();const s=t.getContext("2d").createLinearGradient(0,0,0,240);s.addColorStop(0,"rgba(79, 70, 229, 0.15)"),s.addColorStop(1,"rgba(79, 70, 229, 0.01)"),ca=new Chart(t,{type:"line",data:{labels:e.labels,datasets:[{label:"Receita (R$)",data:e.data,borderColor:"#6366f1",backgroundColor:s,borderWidth:2.5,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.35}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,cornerRadius:8,titleFont:{size:12,family:"Inter",weight:"normal"},bodyFont:{size:13,weight:"bold",family:"Inter"},displayColors:!1,callbacks:{label:function(o){return o.parsed.y!==null?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(o.parsed.y):""}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:10},maxTicksLimit:6,callback:function(o){return"R$ "+o}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function Zr(){document.getElementById("content").addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":J("agenda-section");break;case"new-appointment":J("agenda-section");break;case"goto-pdv":J("comandas-section");break;case"goto-clients":J("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${p.establishmentId||""}`;window.open(o,"_blank");break}})}const Te=e=>E(`/api/services/${e}`),Kr=e=>E("/api/services",{method:"POST",body:JSON.stringify(e)}),ei=(e,t)=>E(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),ti=e=>E(`/api/services/${e}`,{method:"DELETE"}),ai=(e,t)=>E(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),oi=e=>E(`/api/services/stats/most-popular/${e}`),le=e=>E(`/api/professionals/${e}`),si=e=>E(`/api/professionals/details/${e}`),ri=e=>E("/api/professionals",{method:"POST",body:JSON.stringify(e)}),ii=(e,t)=>E(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),as=e=>E(`/api/professionals/${e}`,{method:"DELETE"}),ni=e=>{const t=e.map(a=>as(a));return Promise.all(t)},Zt=(e,t,a,s="all")=>{const o=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return E(o)},Kt=e=>E("/api/blockages",{method:"POST",body:JSON.stringify(e)}),ja=e=>E(`/api/blockages/${e}`,{method:"DELETE"}),os=e=>E("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),ro=document.getElementById("content");let io=!1;const wa=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let ea=[],ka=[],jt={},ss=[],T={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},A={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Na(e){const t=new Date(e),a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return t.setDate(s),t.setHours(0,0,0,0),t}function Fa(){const e=document.getElementById("profSelectorContainer");if(!e||!p.professionals)return;let t=p.professionals.filter(o=>T.showInactiveProfs||o.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=s.map(o=>{const r=T.selectedProfessionalId===o.id,i=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),n=o.id!=="all"?p.professionalColors.get(o.id)||wa[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            <div class="prof-pill ${r?"active":""}"
                ...
                <span>${_(o.name==="Todos"?"Todos":o.name.split(" ")[0])}</span>
            </div>`}).join("")}function _(e){return x(e||"")}function li(e,t,a,s,o){const r=(e||"").replace(/\D/g,""),i=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com ${s} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${r}?text=${encodeURIComponent(l)}`}function di(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=Na(T.currentDate),o=new Date;o.setHours(0,0,0,0);let r='<div class="week-container" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(s);n.setDate(s.getDate()+i);const l=n.toDateString()===o.toDateString(),d=e.filter(u=>new Date(u.startTime).toDateString()===n.toDateString()).sort((u,m)=>new Date(u.startTime)-new Date(m.startTime));let c="";d.length===0?c='<div class="week-empty"><i class="bi bi-dash-lg" style="font-size:1rem;display:block;margin-bottom:4px;"></i>Sem agendamentos</div>':c=d.map(u=>{const f=new Date(u.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),b=p.professionalColors.get(u.professionalId)||{main:"#adb5bd"},y=u.status==="completed",v=T.selectedItems.has(u.id);if(u.type==="blockage")return`<div class="week-event-chip week-blockage">
                    ...
                    </div>`;const w=JSON.stringify(u).replace(/'/g,"&apos;"),S=v?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"",I=T.isSelectionMode?`<div style="position:absolute; top:6px; right:6px; z-index:1;">
                           <input type="checkbox" style="width:16px; height:16px; accent-color:#4f46e5; pointer-events:none;" ${v?"checked":""}>
                       </div>`:"";return`<div class="week-event-chip ${y?"completed":""}" style="--ec: ${b.main}; ${S}"
                    data-action="edit-appointment" data-appointment='${w}'>
                    ${I}
                    <div class="we-time">${f}</div>
                    <div class="we-client" style="${T.isSelectionMode?"padding-right:20px;":""}">${_(u.clientName)}</div>
                    <div class="we-service">${_(u.serviceName)} · ${_((u.professionalName||"").split(" ")[0])}</div>
                    ${T.isSelectionMode?"":`
                    <div class="we-actions">
                        <button class="we-btn" data-action="open-comanda" data-appointment='${w}' title="Comanda">
            ...
            <div class="list-date-label">${o}</div>`,r.forEach(i=>{const n=new Date(i.startTime),l=new Date(i.endTime),d=Math.round((l-n)/6e4),c=n.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=p.professionalColors.get(i.professionalId)||{main:"#adb5bd"},m=i.status==="completed",f=JSON.stringify(i).replace(/'/g,"&apos;"),b=T.selectedItems.has(i.id),y=T.isSelectionMode?`<div style="display:flex; align-items:center; margin-right: 12px; margin-left: 4px;">
                       <input type="checkbox" style="width:20px; height:20px; accent-color:#4f46e5; pointer-events:none;" ${b?"checked":""}>
                   </div>`:"",v=b?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"";if(i.type==="blockage"){s+=`<div class="list-card blockage">
                    ${y}
                ...
                </div>`;return}const w=li(i.clientPhone,i.clientName,i.serviceName,i.professionalName,i.startTime),S=(i.services||[]).reduce((q,O)=>q+(Number(O.price)||0),0)||Number(i.totalPrice||0)||Number(i.servicePrice||0),I=i.paymentStatus||(i.status==="completed"?"Finalizado":"Agendado"),D=_((i.professionalName||"").split(" ")[0]),L=(i.services||[]).length||(i.serviceName?1:0);s+=`<div class="list-card ${m?"completed":""}" style="${v}"
                ...
                <div class="list-card-info">
                    ...
                    <div class="lc-extra" style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 8px;">
                        ...
                        <span style="font-size: 0.65rem; color: ${m?"#059669":"#d97706"}; background: ${m?"#d1fae5":"#fef3c7"}; padding: 2px 8px; border-radius: 6px; font-weight: 600;">${_(I)}</span>
                    </div>
                </div>
                ...
                <div class="list-card-actions">
                    <button class="lc-action-btn wa" data-link="${w}" title="WhatsApp">
            ...
            </div>`}),s+="</div>"}),s+="</div>",t.innerHTML=s}function rs(){const e=p.allEvents.filter(t=>T.selectedProfessionalId==="all"||t.professionalId===T.selectedProfessionalId);T.currentView==="list"?ci(e):di(e),Ha()}function Ha(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(T.isSelectionMode&&T.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
        ...
        </div>`,e.style.display="block",t&&(t.style.transform="scale(0)")):(e.style.display="none",t&&(t.style.transform="scale(1)")))}function ui(){const e=document.getElementById("currentDateDisplay");if(!e)return;const t=new Date;t.setHours(0,0,0,0);const a=new Date(T.currentDate);if(a.setHours(0,0,0,0),T.currentView==="list")a.toDateString()===t.toDateString()?e.textContent="Hoje":e.textContent=a.toLocaleDateString("pt-BR",{day:"numeric",month:"long"});else{const s=Na(a),o=new Date(s);o.setDate(s.getDate()+6);const r=s.toLocaleDateString("pt-BR",{day:"numeric",month:"short"}),i=o.toLocaleDateString("pt-BR",{day:"numeric",month:"short"});e.textContent=`${r} - ${i}`}}async function ve(){const e=document.getElementById("agenda-view");if(!e)return;T.selectedItems.clear(),Ha(),e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;padding:60px 0;"><div style="width:28px;height:28px;border:2.5px solid #e9ecef;border-top:2.5px solid #4f46e5;border-radius:50%;animation:spin 0.7s linear infinite;"></div></div><style>@keyframes spin{to{transform:rotate(360deg)}}</style>',ui();let t,a;if(T.currentView==="list")t=new Date(T.currentDate),t.setHours(0,0,0,0),a=new Date(t),a.setHours(23,59,59,999);else{const s=Na(T.currentDate);t=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const o=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(async d=>{const[c,u]=await Promise.all([Aa(d,t.toISOString(),a.toISOString(),T.selectedProfessionalId==="all"?null:T.selectedProfessionalId),Zt(d,t.toISOString(),a.toISOString(),T.selectedProfessionalId)]);return{appts:c||[],blockages:u||[]}}),r=await Promise.all(o);let i=[],n=[];if(r.forEach(d=>{i=i.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(c=>({...c,type:c.type||"appointment",professionalName:c.professionalName||(()=>{const u=p.professionals?.find(m=>m.id===c.professionalId);return u?u.name:"Indefinido"})()}));p.allEvents=[...l(i),...l(n)],Fa(),rs()}catch(s){console.error(s),document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12" style="color:#868e96;">
                    <i class="bi bi-exclamation-triangle" style="font-size:1.5rem;"></i>
                    <p class="mt-2" style="font-size:0.8rem;">Erro ao carregar agenda.</p>
                </div>`)}}async function pi(){try{const t=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(async i=>{const[n,l,d]=await Promise.all([le(i),Te(i),Ce(i)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(t),s=new Map,o=new Map;let r=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>s.set(n.id,n)),i.services.forEach(n=>o.set(n.id,n))}),p.professionals=Array.from(s.values()),p.services=Array.from(o.values()),ss=[],r&&(jt=r.loyaltyProgram||{enabled:!1}),p.professionals.forEach((i,n)=>{p.professionalColors.set(i.id,wa[n%wa.length])}),Fa()}catch{g("Atenção","Não foi possível carregar os dados da equipa.","error")}}async function is(e={}){T.currentDate=e.targetDate?new Date(e.targetDate):T.currentDate||new Date,T.isSelectionMode=!1,T.selectedItems.clear(),ro.innerHTML=`
        ...
        </div>`,document.getElementById("btnPrevDate").addEventListener("click",()=>{T.currentView==="list"?T.currentDate.setDate(T.currentDate.getDate()-1):T.currentDate.setDate(T.currentDate.getDate()-7),ve()}),document.getElementById("btnNextDate").addEventListener("click",()=>{T.currentView==="list"?T.currentDate.setDate(T.currentDate.getDate()+1):T.currentDate.setDate(T.currentDate.getDate()+7),ve()}),document.getElementById("btnTodayHeader").addEventListener("click",()=>{T.currentDate=new Date,ve()});const t=document.querySelectorAll(".agenda-view-toggle button");t.forEach(a=>{a.addEventListener("click",()=>{t.forEach(s=>{s.classList.remove("active","shadow-sm"),s.style.backgroundColor="transparent"}),a.classList.add("active","shadow-sm"),a.style.backgroundColor="#fff",T.currentView=a.dataset.view,ve()})}),document.getElementById("btnWeekDays").addEventListener("click",()=>{mi()}),io||(ro.addEventListener("click",async a=>{const s=a.target.closest('[data-action="open-comanda"]');if(s){a.stopPropagation();const l=s.dataset.appointment||s.closest("[data-appointment]")?.dataset.appointment;if(!l)return;const d=JSON.parse(l.replace(/&apos;/g,"'")),c=d.status==="completed"?"finalizadas":"em-atendimento",u={selectedAppointmentId:d.id,initialFilter:c};c==="finalizadas"&&d.transaction?.paidAt&&(u.filterDate=typeof d.transaction.paidAt=="object"?new Date(d.transaction.paidAt._seconds*1e3):d.transaction.paidAt),J("comandas-section",u);return}const o=a.target.closest(".lc-action-btn.wa");if(o){a.stopPropagation(),o.dataset.link&&window.open(o.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const l=T.selectedItems.size;await W("Excluir Selecionados",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)&&(await Promise.all(Array.from(T.selectedItems).map(async c=>{try{await cr(c)}catch{}})),g(`${l} agendamento(s) excluído(s).`,"success"),T.selectedItems.clear(),T.isSelectionMode=!1,ve());return}const r=a.target.closest('[data-action="select-professional"]');if(r){const l=r.dataset.profId;T.selectedProfessionalId=T.selectedProfessionalId===l&&l!=="all"?"all":l,ve();return}const i=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(i){if(T.isSelectionMode){a.stopPropagation();const d=i.querySelector('input[type="checkbox"]');if(d){const c=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'")),u=!d.checked;d.checked=u,u?T.selectedItems.add(c.id):T.selectedItems.delete(c.id),(i.classList.contains("week-event-chip")||i.classList.contains("list-card"))&&(u?(i.style.boxShadow="0 0 0 2px #4f46e5",i.style.backgroundColor="#eff6ff"):(i.style.boxShadow="none",i.style.backgroundColor=i.classList.contains("week-event-chip")?"#f8f9fa":"#fff")),Ha()}return}const l=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"));Sa(l);return}if(a.target.closest('[data-action="new-appointment"]')){Sa();return}}),io=!0),await pi(),await ve()}function mi(){const e=document.getElementById("optionsSheet");if(e){e.remove();return}const t=document.createElement("div");t.id="optionsSheet",t.style.cssText="position:fixed;bottom:0;left:50%;right:auto;transform:translateX(-50%) translateY(100%);width:100%;max-width:440px;background:#fff;border-radius:24px 24px 0 0;z-index:10000;box-shadow:0 -8px 40px rgba(0,0,0,0.15);transition:transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);";const a=T.isSelectionMode?"#fee2e2":"#f0fdf4",s=T.isSelectionMode?"#ef4444":"#16a34a",o=T.isSelectionMode?"bi-x-circle":"bi-check2-square";t.innerHTML=`
        ...
        </div>`}}function xi(){const e=A.data.date||new Date().toISOString().split("T")[0];return{title:"Data e Horário",content:`
        <div class="p-5 space-y-5">
        ...
        </div>`}}async function Sa(e=null,t=!1){const a=document.getElementById("appointmentModal");t||(A={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(o=>o.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],time:e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}),ea=p.services||[],ka=(p.professionals||[]).filter(o=>o.status==="active");let s;switch(A.step){case 1:s=gi(e);break;case 2:s=bi();break;case 3:s=fi();break;case 4:s=xi();break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>o.addEventListener("click",()=>{const r=parseInt(o.dataset.currentStep,10);if(r===1&&(A.data.clientName=a.querySelector("#apptClientName").value.trim(),A.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!A.data.clientName))return g("Preencha o nome do cliente.","warning");if(r===2&&A.data.selectedServiceIds.length===0)return g("Selecione um serviço.","warning");if(r===3&&!A.data.professionalId)return g("Escolha um profissional.","warning");no(r+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>o.addEventListener("click",()=>no(parseInt(o.dataset.currentStep,10)-1))),a.querySelector('[data-action="close-modal"]')?.addEventListener("click",()=>{a.style.display="none"}),A.step===4&&a.querySelector("#appointmentForm").addEventListener("submit",hi),a.style.display="flex",A.step===2&&a.querySelectorAll(".service-card").forEach(o=>o.addEventListener("click",()=>{const r=a.querySelector("#multiServiceToggle")?.checked,i=o.classList.contains("selected");r||(a.querySelectorAll(".service-card.selected").forEach(l=>l.classList.remove("selected","border-indigo-500","bg-indigo-50")),A.data.selectedServiceIds=[]);const n=o.dataset.serviceId;i?(o.classList.remove("selected","border-indigo-500","bg-indigo-50"),A.data.selectedServiceIds=A.data.selectedServiceIds.filter(l=>l!==n)):(o.classList.add("selected","border-indigo-500","bg-indigo-50"),A.data.selectedServiceIds.push(n))})),A.step===3&&a.querySelectorAll(".professional-modal-card").forEach(o=>o.addEventListener("click",()=>{a.querySelectorAll(".professional-modal-card.selected").forEach(i=>i.classList.remove("selected","border-indigo-500","bg-indigo-50")),o.classList.add("selected","border-indigo-500","bg-indigo-50"),A.data.professionalId=o.dataset.professionalId;const r=ka.find(i=>i.id===o.dataset.professionalId);A.data.professionalName=r?r.name:""})),A.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",o=>yi(o.target.value)),A.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",lo),lo(),vi())}async function hi(e){e.preventDefault();const a=e.target.querySelector('button[type="submit"]');if(!A.data.time||!A.data.selectedServiceIds.length||!A.data.professionalId)return g("Selecione horário, serviço e profissional.","warning");a.disabled=!0,a.innerHTML="Aguarde...";const s=A.data.selectedServiceIds.map(d=>{const c=ea.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[o,r]=A.data.time.split(":"),i=new Date(`${A.data.date}T${o}:${r}:00`),l={establishmentId:p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments[0]:p.establishmentId,clientName:A.data.clientName,clientPhone:A.data.clientPhone,services:s,professionalId:A.data.professionalId,professionalName:A.data.professionalName,startTime:i.toISOString(),redeemedReward:A.data.redeemedReward};A.data.id&&(l.id=A.data.id);try{A.data.id?await dr(A.data.id,l):await lr(l),g("Agendamento registrado!","success"),document.getElementById("appointmentModal").style.display="none",ve()}catch(d){g(d.message,"error"),a.disabled=!1,a.textContent="Agendar"}}async function lo(){const e=document.getElementById("availableTimesContainer"),t=document.getElementById("apptTotalDuration");if(!e)return;const a=A.data.selectedServiceIds.reduce((i,n)=>{const l=ea.find(d=>d.id===n);return i+(l?l.duration+(l.bufferTime||0):0)},0);t&&(t.textContent=`${a} min`);const{professionalId:s,selectedServiceIds:o,date:r}=A.data;if(!s||!o.length||!r){e.innerHTML='<p class="col-span-full text-center text-xs text-gray-400">Selecione serviço e profissional</p>';return}try{const i=p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments[0]:p.establishmentId;let n=await nr({establishmentId:i,professionalId:s,serviceIds:o,date:r});const l=new Date;if(new Date(r+"T00:00:00").toDateString()===l.toDateString()){const d=l.getHours()*60+l.getMinutes();n=n.filter(c=>{const[u,m]=c.split(":").map(Number);return u*60+m>=d})}e.innerHTML=n.length>0?n.map(d=>`<button type="button" class="p-2 text-sm font-semibold rounded-lg border ${A.data.time===d?"bg-indigo-600 text-white border-indigo-600":"bg-gray-50 text-gray-700 border-gray-200 hover:bg-indigo-50"}" onclick="document.querySelectorAll('#availableTimesContainer button').forEach(b=>{b.classList.remove('bg-indigo-600','text-white','border-indigo-600');b.classList.add('bg-gray-50','text-gray-700','border-gray-200')});this.classList.add('bg-indigo-600','text-white','border-indigo-600');this.classList.remove('bg-gray-50','text-gray-700','border-gray-200');window._selectedTime='${d}';">${d}</button>`).join(""):'<p class="col-span-full text-center text-xs text-gray-400">Sem horários</p>'}catch{e.innerHTML='<p class="col-span-full text-center text-xs text-red-400">Erro</p>'}}function vi(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a}=A.data,{enabled:s,rewards:o}=jt;if(!s||!t||!o?.length){e.innerHTML="";return}const r=o.filter(i=>a>=i.points);if(!r.length){e.innerHTML='<p class="text-xs text-gray-400">Sem recompensas disponíveis.</p>';return}e.innerHTML=`<div class="border-t border-gray-100 pt-4">
        <p class="text-xs font-semibold text-gray-500 mb-2">Resgate fidelidade (${a} pts)</p>
        ${r.map(i=>`<label class="flex items-center gap-3 p-2 bg-gray-50 rounded-lg mb-1 cursor-pointer"><input type="radio" name="loyaltyReward" value="${_(i.reward)}" data-points="${i.points}" class="accent-indigo-600"><span class="text-sm">${_(i.reward)} (-${i.points} pts)</span></label>`).join("")}
    </div>`,e.querySelectorAll('input[name="loyaltyReward"]').forEach(i=>{i.addEventListener("change",n=>{n.target.checked&&(A.data.redeemedReward={reward:n.target.value,points:parseInt(n.target.dataset.points,10)})})})}async function yi(e){const t=document.getElementById("clientSearchResults");if(!t||e.trim().length<3){t&&(t.innerHTML='<p class="text-xs text-gray-400">Digite pelo menos 3 caracteres...</p>');return}t.innerHTML='<div class="text-center py-3"><div class="w-5 h-5 border-2 border-indigo-200 border-t-indigo-600 rounded-full animate-spin mx-auto"></div></div>';try{const s=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(n=>Xt(n,e.trim())),o=await Promise.all(s),r=new Map;o.forEach(n=>{n.forEach(l=>{l.phone?r.set(l.phone,l):r.set(l.id||Math.random().toString(),l)})});const i=Array.from(r.values());if(ss=i,!i.length){t.innerHTML='<p class="text-xs text-gray-400">Nenhum cliente encontrado.</p>';return}t.innerHTML=i.map(n=>`<div class="client-card p-2.5 bg-white rounded-lg border ${A.data.clientName===n.name&&A.data.clientPhone===n.phone?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer flex items-center gap-2" data-client-name="${_(n.name)}" data-client-phone="${_(n.phone)}" data-loyalty-points="${n.loyaltyPoints||0}">
            ...
            </div>`).join(""),t.querySelectorAll(".client-card").forEach(n=>n.addEventListener("click",()=>{A.data.clientName=n.dataset.clientName,A.data.clientPhone=n.dataset.clientPhone,A.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(jt?.rewards||[]).map(d=>d.points));A.data.clientHasRewards=jt.enabled&&l!==1/0&&A.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,t.querySelectorAll(".client-card").forEach(d=>d.classList.remove("border-indigo-500","bg-indigo-50")),n.classList.add("border-indigo-500","bg-indigo-50")}))}catch{t.innerHTML='<p class="text-xs text-red-400">Erro ao buscar.</p>'}}const wi=(e,t=null,a=1,s=12)=>{let o=`/api/comandas/${e}?page=${a}&limit=${s}`;return t&&(o+=`&date=${t}`),E(o)},ki=(e,t)=>E(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),Si=e=>E("/api/sales",{method:"POST",body:JSON.stringify(e)}),$i=e=>E(`/api/sales/${e}`,{method:"DELETE"}),ta=e=>E(`/api/products/${e}`),Ei=e=>E("/api/products",{method:"POST",body:JSON.stringify(e)}),Ii=(e,t)=>E(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),Li=e=>E(`/api/products/${e}`,{method:"DELETE"}),Ci=(e,t)=>E(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),Di=({startDate:e,endDate:t,productId:a,categoryId:s,establishmentId:o})=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("productId",a),s&&s!=="all"&&r.append("categoryId",s),o&&r.append("establishmentId",o),E(`/api/products/stock-history/report?${r.toString()}`)},Ti=()=>E("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),Bi=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),E("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Pi=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),E(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},Mi=()=>E("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),Ai=e=>E(`/api/cashier/report/${e}`),Oa=e=>E(`/api/packages/${e}`),qi=e=>E("/api/packages",{method:"POST",body:JSON.stringify(e)}),Ri=(e,t)=>E(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),ji=e=>E(`/api/packages/${e}`,{method:"DELETE"});let h={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,pendingRedemption:null,paging:{page:1,limit:100,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryDate:!1},Me=null,Re=null,co=null;function ns(e,t){return function(...a){clearTimeout(co),co=setTimeout(()=>e.apply(this,a),t)}}function Ni(){const e=h.allComandas||[],t=e.filter(d=>d.status!=="completed").length,a=e.filter(d=>d.status==="completed"),s=a.reduce((d,c)=>{let u=c.totalAmount!==void 0?Number(c.totalAmount):ye(c).reduce((m,f)=>m+Number(f.price||0),0);return d+u},0),o=a.length>0?s/a.length:0,r=document.getElementById("kpi-abertas"),i=document.getElementById("kpi-pagas"),n=document.getElementById("kpi-vendas"),l=document.getElementById("kpi-ticket");r&&(r.textContent=t),i&&(i.textContent=a.length),n&&(n.textContent=`R$ ${s.toFixed(2).replace(".",",")}`),l&&(l.textContent=`R$ ${o.toFixed(2).replace(".",",")}`)}async function uo(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,sa(),t==="checkout"&&(h.viewMode="checkout",h.checkoutState.payments||(h.checkoutState.payments=[]),h.checkoutState.selectedMethod="dinheiro",h.checkoutState.amountReceived="",h.checkoutState.discount.value||(h.checkoutState.discount={type:"real",value:0},h.checkoutState.discountReason=""),X());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,document.body.appendChild(a);try{const s=(e.comandaItems||[]).filter(o=>o&&o.id&&String(o.id)!=="undefined"&&String(o.id)!=="null").map(o=>{const r={...o};if(r.id=String(o.id),r.type==="product"){const i=r.id;r.productId||(r.productId=i),r.product_id||(r.product_id=i)}if(r.type==="service"){const i=r.id;r.serviceId||(r.serviceId=i),r.service_id||(r.service_id=i)}return r});e.type==="walk-in"&&String(e.id).startsWith("temp-")||await ki(e.id,s),document.body.contains(a)&&document.body.removeChild(a),t!=="checkout"&&(g("Sucesso","Comanda atualizada!","success"),X())}catch(s){document.body.contains(a)&&document.body.removeChild(a),console.error("Erro ao salvar:",s),e._hasUnsavedChanges=!0,X(),g("Erro","Falha ao salvar no servidor: "+s.message,"warning")}}function ye(e){if(!e._cachedItems){let t=[];if(e.status==="completed"){const a=e.comandaItems||e.items||[];t=a.length>0?a:e.services||[]}else{const a=(e.services||[]).map(i=>({...i,_source:"original_service",type:"service"})),s=a.reduce((i,n)=>(i[String(n.id)]=(i[String(n.id)]||0)+1,i),{}),o=[...e.comandaItems||[],...e.items||[]],r=[];o.forEach(i=>{const n=String(i.id);(i.type==="service"||!i.type)&&s[n]>0?s[n]--:r.push({...i,_source:"extra"})}),t=[...a,...r]}return e._cachedItems=t,e._cachedTimestamp=Date.now(),t}return e._cachedItems}function Fi(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function je(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function Hi(){const e=new Date().toISOString().split("T")[0];Re.innerHTML=`
        <section class="h-full flex flex-col pt-1">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-3 px-1">
                <div id="cashier-controls" class="flex items-center gap-2 w-full sm:w-auto">
                    <div class="loader-sm"></div>
                </div>
                
                <div class="flex items-center gap-2 w-full sm:w-auto justify-end">
                    <button data-action="toggle-history" class="py-2 px-3 bg-white border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition shadow-sm flex items-center justify-center gap-2 text-sm flex-1 sm:flex-none whitespace-nowrap">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        Histórico
                    </button>

                    <button id="btn-new-sale" data-action="new-sale" class="py-2 px-4 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-700 transition shadow-md flex items-center justify-center gap-2 text-sm flex-1 sm:flex-none whitespace-nowrap">
                        <span>+</span> Nova Avulsa
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4 px-1">
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-center">
                    <span class="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Abertas</span>
                    <span id="kpi-abertas" class="text-2xl font-extrabold text-indigo-600 mt-1">0</span>
                </div>
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-center">
                    <span class="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Vendas Hoje</span>
                    <span id="kpi-vendas" class="text-2xl font-extrabold text-green-600 mt-1">R$ 0,00</span>
                </div>
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-center">
                    <span class="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Pagas</span>
                    <span id="kpi-pagas" class="text-2xl font-extrabold text-gray-800 mt-1">0</span>
                </div>
                <div class="bg-white p-3 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-center">
                    <span class="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Ticket Médio</span>
                    <span id="kpi-ticket" class="text-2xl font-extrabold text-blue-600 mt-1">R$ 0,00</span>
                </div>
            </div>

            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 px-1 gap-3">
                <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                    <button data-filter="todas" class="filter-btn px-4 py-2 text-xs font-bold rounded-lg border transition">Todas</button>
                    <button data-filter="abertas" class="filter-btn px-4 py-2 text-xs font-bold rounded-lg border transition">Abertas</button>
                    <button data-filter="pagas" class="filter-btn px-4 py-2 text-xs font-bold rounded-lg border transition">Fechadas</button>
                </div>
                
                <div id="finalizadas-datepicker" class="hidden flex items-center gap-2 bg-white p-1.5 rounded-lg border border-gray-200 shadow-sm w-full sm:w-auto">
                    <label for="filter-date" class="text-xs font-bold text-gray-500 uppercase pl-2">Data:</label>
                    <input type="date" id="filter-date" value="${e}" class="w-full sm:w-auto p-1.5 border-0 rounded bg-gray-50 text-sm font-semibold outline-none focus:ring-1 focus:ring-indigo-500">
                </div>
            </div>

            <div id="comandas-layout" class="flex-grow flex gap-4 min-h-0 pb-2">
                <div id="comandas-list-column" class="flex flex-col bg-white border border-gray-200 rounded-xl shadow-sm h-full w-full md:w-2/5 lg:w-1/3">
                    <div id="comandas-list" class="p-2 space-y-2 overflow-y-auto custom-scrollbar flex-grow">
                ...
                <div id="comanda-detail-container" class="bg-white border border-gray-200 rounded-xl shadow-sm h-full w-full md:w-3/5 lg:w-2/3 flex flex-col relative overflow-hidden">
    ...
    `,oa(),aa()}function aa(){document.querySelectorAll(".filter-btn").forEach(a=>{a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-300","shadow-sm"),a.classList.add("bg-white","text-gray-600","border-gray-200")});const e=document.querySelector(`[data-filter="${h.activeFilter}"]`);e&&(e.classList.remove("bg-white","text-gray-600","border-gray-200"),e.classList.add("bg-indigo-50","text-indigo-700","border-indigo-300","shadow-sm"));const t=document.getElementById("finalizadas-datepicker");t&&t.classList.toggle("hidden",!h.showHistoryDate)}function oa(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");h.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4 rounded-r-lg animate-fade-in mx-1">
                <div class="flex"><div class="flex-shrink-0">⚠️</div><div class="ml-3"><p class="text-sm text-yellow-700"><strong>Caixa Fechado!</strong> Abra o caixa para realizar operações e novas vendas.</p></div></div>
            </div>
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),Oi()}function Oi(){const e=document.getElementById("cashier-controls");e&&(h.isCashierOpen?e.innerHTML=`
            ...
            <button data-action="close-cashier" class="py-1.5 px-3 bg-red-50 text-red-700 border border-red-200 font-semibold rounded-lg hover:bg-red-100 text-xs transition whitespace-nowrap">Fechar Caixa</button>
        `:e.innerHTML=`
            ...
            <button data-action="open-cashier" class="py-1.5 px-4 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 text-xs shadow transition whitespace-nowrap">Abrir Caixa</button>
        `)}function sa(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!h.isCashierOpen&&h.activeFilter==="abertas"){e.innerHTML='<div class="text-center py-10 opacity-60"><svg class="w-12 h-12 mx-auto text-gray-300 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg><p class="text-sm font-medium text-gray-700">Caixa Fechado</p><p class="text-xs text-gray-500">Abra o caixa para ver as vendas</p></div>',t&&(t.innerHTML="");return}let a=h.allComandas||[];if(h.activeFilter==="abertas"?a=a.filter(o=>o.status!=="completed"):h.activeFilter==="pagas"&&(a=a.filter(o=>o.status==="completed")),Ni(),a.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada para este filtro.</p>',po(t);return}const s=document.createDocumentFragment();a.forEach(o=>{const r=ye(o);let i=0;o.status==="completed"&&o.totalAmount!==void 0&&o.totalAmount!==null?i=Number(o.totalAmount):i=r.reduce((w,S)=>w+Number(S.price||0),0);const l=o.loyaltyRedemption||o.discount&&o.discount.reason&&String(o.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-2" title="Prémio Resgatado">🎁</span>':"",d=o.id===h.selectedComandaId,c=new Date(o.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=o.type==="walk-in"||typeof o.id=="string"&&o.id.startsWith("temp-"),m=o.status==="completed",f=x(o.clientName||"Cliente sem nome"),b=x(o.professionalName||"Sem profissional");let y="";m?y='<span class="text-[10px] font-bold uppercase text-green-700 bg-green-100 px-2 py-0.5 rounded-md border border-green-200">Paga</span>':u?y='<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':y='<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const v=document.createElement("div");v.className=`comanda-card cursor-pointer p-3 border-b border-gray-100 hover:bg-gray-50 transition-colors flex flex-col gap-1 ${d?"bg-indigo-50/50 border-l-4 border-l-indigo-600":"border-l-4 border-l-transparent"}`,v.dataset.action="select-comanda",v.dataset.comandaId=o.id,v.innerHTML=`
            <div class="flex justify-between items-start pointer-events-none gap-2">
                <p class="font-bold text-gray-800 truncate flex-1 text-sm">${f}</p>
                <div class="flex items-center">
                    <p class="font-bold ${m?"text-green-600":"text-gray-900"} text-sm whitespace-nowrap">R$ ${i.toFixed(2)}</p>
                    ${l}
                </div>
            </div>
            <div class="flex justify-between items-center mt-1 pointer-events-none">
                <div class="flex items-center gap-2 truncate flex-1 mr-2">
                    ${y}
                    <p class="text-xs text-gray-500 truncate">${b}</p>
                </div>
                <p class="text-xs text-gray-400 font-medium whitespace-nowrap">${c}</p> 
            </div>
        `,s.appendChild(v)}),e.innerHTML="",e.appendChild(s),po(t)}function po(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:s}=h.paging,o=Math.ceil((a||0)/s);if(o===0)return;const r=document.createElement("div");r.className="flex gap-2 justify-center items-center w-full",r.innerHTML=`
    ...
    `,e.appendChild(r),r.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=o&&(h.paging.page=l,de())}})}function X(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=h.allComandas.find(w=>w.id===h.selectedComandaId);if(h.viewMode==="checkout"&&t){zi(t,e);return}const a=`
        <div class="mobile-only-header">
            <button data-action="back-to-list" class="btn-back-mobile"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg></button>
    ...
    `;if(!h.isCashierOpen){e.innerHTML=`
        ...
        `;return}const s=ye(t),o=t.status==="completed",r=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),i=s.reduce((w,S)=>{const I=S._source==="original_service",D=S.id||S.name,L=I?`original-${D}`:`${S.type}-${D}`;return w[L]||(w[L]={...S,quantity:0,sources:[]}),w[L].quantity+=1,S._source&&w[L].sources.push(S._source),w},{}),n=Object.values(i).reduce((w,S)=>w+Number(S.price||0)*S.quantity,0),l=x(t.clientName||"Cliente sem nome"),d=x(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,u=c?"bg-amber-500 text-white hover:bg-amber-600 shadow-lg animate-pulse":"bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-300",m=c?"Salvar Alterações*":"Salvar",f=t.clientId?`
        <button data-action="view-client-history" data-client-id="${t.clientId}" data-client-name="${l}" class="text-xs bg-blue-50 text-blue-700 font-semibold py-1.5 px-3 rounded-lg hover:bg-blue-100 transition flex items-center gap-1 border border-blue-100 whitespace-nowrap">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
            Histórico
        </button>
    `:"",b=r?'<span class="inline-block px-2 py-1.5 text-[10px] font-bold bg-blue-100 text-blue-700 rounded border border-blue-200">VENDA AVULSA</span>':`
        <button data-action="go-to-appointment" data-id="${t.id}" data-date="${t.startTime}" class="text-xs bg-indigo-50 text-indigo-700 font-semibold py-1.5 px-3 rounded-lg hover:bg-indigo-100 transition flex items-center gap-1 border border-indigo-100 whitespace-nowrap">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
            Ver na Agenda
        </button>
    `,y=`
        <div class="grid grid-cols-3 gap-3 mobile-hidden pt-2">
            ...
            <button data-action="save-comanda" class="col-span-1 py-3 font-bold rounded-xl transition text-sm ${u}">
                ${m}
            </button>
    ...
    `,v=`
        <div class="mobile-fabs-container">
            <button data-action="add-item" class="fab-btn-secondary" title="Adicionar Item"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg></button>
            <button data-action="save-comanda" class="fab-btn-secondary ${c?"bg-amber-500 text-white hover:bg-amber-600":"bg-gray-600 text-white hover:bg-gray-700"}" title="Salvar Alterações"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4"></path></svg></button>
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            <div class="flex justify-between items-start mb-4 border-b border-gray-100 pb-4">
                <div class="flex-1 mr-4">
                    <h3 class="text-xl font-bold text-gray-800 truncate">${l}</h3>
            ...
            <div class="space-y-3">
                ...
                ${Object.values(i).map(w=>{const S=w.sources&&w.sources.includes("original_service"),I=h.pendingRedemption&&String(h.pendingRedemption.appliedToItemId)===String(w.id),D=w.isReward||I;return`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm ${D?"border-yellow-300 bg-yellow-50 ring-1 ring-yellow-200":""}">
                        <div class="flex items-center gap-3 w-full">
                            <div class="flex-grow min-w-0">
                                <p class="text-sm font-semibold text-gray-800 line-clamp-1">
                                    ${D?"🎁 ":""}${x(w.name)}
                                    ${S?'<span class="text-[10px] text-indigo-600 bg-indigo-50 px-1 rounded border border-indigo-100 ml-1">Original</span>':""}
                                </p>
                                <p class="text-xs text-gray-500">${D?'<span class="text-yellow-700 font-bold bg-yellow-100 px-1 rounded">Prémio Fidelidade</span>':`R$ ${(w.price||0).toFixed(2)} un.`}</p>
                            </div>
                            ${o?`<span class="flex items-center justify-center w-8 h-8 bg-gray-100 text-gray-700 font-bold text-sm rounded-lg">${w.quantity}x</span>`:`
                                <div class="flex items-center bg-gray-100 rounded-lg p-1 gap-2 sm:gap-3">
                                    ${S?`<span class="text-sm font-bold text-gray-500 w-12 sm:w-16 text-center py-1 bg-gray-200 rounded text-[10px] uppercase">Fixo: ${w.quantity}</span>`:`<button data-action="decrease-qty" data-item-id="${w.id}" data-item-type="${w.type}" class="w-6 h-6 flex items-center justify-center rounded bg-white text-gray-600 shadow-sm hover:bg-red-50 hover:text-red-600">-</button><span class="text-sm font-bold text-gray-800 w-4 text-center">${w.quantity}</span><button data-action="increase-qty" data-item-id="${w.id}" data-item-type="${w.type}" class="w-6 h-6 flex items-center justify-center rounded bg-white text-gray-600 shadow-sm hover:bg-green-50 hover:text-green-600">+</button>`}
                                </div>
                            `}
                            <div class="flex items-center justify-end w-16 sm:w-20">
        ...
        <footer class="p-4 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-10">
            ...
            ${o?'<div class="bg-green-50 text-green-700 text-center py-3 rounded-xl font-bold border border-green-200 flex items-center justify-center gap-2"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Venda Finalizada</div>':y}
        </footer>

        ${o?"":v}
    `,!o&&(t.clientId||t.clientName)&&Vi(t,e.querySelector("#loyalty-container"))}function zi(e,t){const s=ye(e).reduce((m,f)=>m+Number(f.price||0)*(f.quantity||1),0),o=h.checkoutState,r=o.discount||{type:"real",value:0};let i=0;r.type==="percent"?i=s*r.value/100:i=r.value,i>s&&(i=s);const n=s-i,l=o.payments.reduce((m,f)=>m+f.value,0),d=Math.max(0,n-l);(!o.amountReceived||d>0)&&(o.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
            <button data-action="back-to-items" class="btn-back-mobile"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg></button>
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar">
            ...
            <div class="space-y-3 mb-6">
                ${o.payments.map((m,f)=>`
                    <div class="flex justify-between items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm animate-fade-in-fast">
                        <div class="flex items-center gap-3">
                             <div class="bg-gray-100 p-2 rounded-lg"><span class="font-bold text-xs uppercase text-gray-600">${m.method}</span></div>
            ...
            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="grid grid-cols-3 gap-2 mb-4">
                    ${["dinheiro","pix","debito","credito","crediario"].map(m=>`<button data-action="select-method" data-method="${m}" class="p-2 rounded-lg border text-xs font-bold uppercase transition ${o.selectedMethod===m?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-gray-50 text-gray-600 border-gray-200 hover:bg-gray-100"}">${m}</button>`).join("")}
                </div>
                ${["credito","crediario"].includes(o.selectedMethod)?`
                    <div class="mb-3">
                        <label class="text-xs text-gray-500">Parcelas</label>
                        <select id="checkout-installments" class="w-full mt-1 p-2 border rounded-lg text-sm bg-gray-50">${Array.from({length:12},(m,f)=>`<option value="${f+1}" ${o.installments===f+1?"selected":""}>${f+1}x</option>`).join("")}</select>
                    </div>
                `:""}
    ...
    `;const u=()=>{const m=h.checkoutState.discount.type,f=h.checkoutState.discount.value;let b=m==="percent"?s*f/100:f;b>s&&(b=s);const y=s-b,v=h.checkoutState.payments.reduce((L,q)=>L+q.value,0),w=Math.max(0,y-v),S=t.querySelector("#checkout-total-display");S&&(S.textContent=`R$ ${y.toFixed(2)}`);const I=t.querySelector("#checkout-status-msg");I&&(w<=.01?I.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':I.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${w.toFixed(2)}</span></p>`);const D=t.querySelector("#checkout-amount");D&&w>0&&document.activeElement!==D&&(D.value=w.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",m=>{h.checkoutState.discount.value=parseFloat(m.target.value)||0,u()}),t.querySelector("#discount-type")?.addEventListener("change",m=>{h.checkoutState.discount.type=m.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",m=>{h.checkoutState.discountReason=m.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",m=>{h.checkoutState.amountReceived=m.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",m=>{h.checkoutState.installments=parseInt(m.target.value,10)})}async function Vi(e,t){if(!t)return;const a=h.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(e.clientId)s=await Xo(p.establishmentId,e.clientId);else if(e.clientName){const n=await Xt(p.establishmentId,e.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const o=Number(s.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&o>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
            <div class="flex items-center gap-3"><div class="bg-yellow-100 p-2 rounded-full text-yellow-600"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg></div><div><p class="text-sm font-bold text-yellow-800">Prémio Disponível!</p><p class="text-xs text-yellow-700">Saldo: <strong>${o} pts</strong></p></div></div>
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>_i(i,e),n.appendChild(l),t.innerHTML="",t.appendChild(n)}}function _i(e,t){const a=`
        <div class="space-y-4">
            <p class="text-sm text-gray-600 mb-4">O cliente possui pontos suficientes para resgatar os seguintes itens:</p>
            <div class="space-y-2 max-h-96 overflow-y-auto custom-scrollbar">
                ${e.map(r=>{const i=r.costPoints||r.points||0,n=r.name||r.reward,l=r.type||"money",d=r.discount?parseFloat(r.discount).toFixed(2):"0.00";let c="",u="bg-gray-100 text-gray-600";switch(l){case"service":c="Serviço",u="bg-indigo-100 text-indigo-700";break;case"product":c="Produto",u="bg-green-100 text-green-700";break;case"package":c="Pacote",u="bg-purple-100 text-purple-700";break;case"money":default:c="Valor Livre",u="bg-yellow-100 text-yellow-700";break}return`<button data-action="select-reward" data-reward-id="${r.id||n}" class="w-full flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl hover:border-yellow-400 hover:bg-yellow-50 transition-all group"><div class="text-left flex-1"><div class="flex items-center gap-2 mb-1"><span class="text-[10px] font-bold uppercase px-2 py-0.5 rounded ${u}">${c}</span><p class="font-bold text-gray-800 group-hover:text-yellow-700">${x(n)}</p></div><p class="text-xs text-gray-500">Custo: ${i} pontos</p></div><div class="text-right"><span class="block text-sm font-bold text-green-600">Desc. R$ ${d}</span></div></button>`}).join("")}
            </div>
        </div>
    `,{modalElement:s,close:o}=re({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",r=>{const i=r.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=e.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(Ui(l,t),o())}})}async function Ui(e,t){const a=Number(e.costPoints||e.points||0),s=e.name||e.reward,o=e.type||"money";if(o==="money"){const l=parseFloat(e.discount)||0;if(l<=0)return g("Erro","O valor do desconto configurado é inválido.","error");h.checkoutState.discount={type:"real",value:l},h.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,h.pendingRedemption={rewardId:e.id||null,name:s,cost:a,type:"money"},g("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),X();return}const r=ye(t),i=e.itemId?String(e.itemId):null;if(!i)return g("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");const n=r.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return o==="service"?d===i||c===i:o==="product"?d===i||u===i:o==="package"?d===i:!1});if(n){let l=parseFloat(e.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),h.checkoutState.discount={type:"real",value:l},h.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,h.pendingRedemption={rewardId:e.id||null,name:s,cost:a,type:o,appliedToItemId:n.id},g("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),X()}else g("Item Não Encontrado",`Para resgatar, o ${o==="service"?"serviço":o==="product"?"produto":"pacote"} deve estar nesta comanda. Adicione primeiro e tente resgatar novamente.`,"warning")}async function Wi(e,t){if(!e)return;const a=h.allComandas.filter(i=>i.clientId===e&&i.status==="completed"),s=`
        <div class="space-y-4">
            <p class="text-sm text-gray-500 text-center mb-4">A exibir as compras recentes em cache para <strong>${x(t)}</strong></p>
            
            <div class="max-h-64 overflow-y-auto custom-scrollbar border rounded-lg bg-gray-50 p-2 space-y-2">
                ${a.length>0?a.map(i=>`
                    <div class="bg-white p-3 rounded shadow-sm flex justify-between items-center text-sm border border-gray-100">
                        <div><span class="font-bold text-gray-700">${new Date(i.startTime).toLocaleDateString("pt-BR")}</span><p class="text-xs text-gray-500">${i.professionalName||"Sem profissional"}</p></div>
                        <span class="font-bold text-green-600">R$ ${Number(i.totalAmount||0).toFixed(2)}</span>
                    </div>`).join(""):'<p class="text-center text-sm text-gray-400 py-4">Nenhuma compra finalizada listada na visualização atual.</p>'}
            </div>

            <div class="pt-4 border-t border-gray-100 text-center">
                <p class="text-xs text-gray-500 mb-2">Para ver todas as marcações, compras e gerir dados:</p>
                <button id="btn-go-to-client" class="w-full py-3 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-700 transition shadow-md">
                    Ir para o Registo do Cliente
                </button>
            </div>
        </div>
    `,{modalElement:o,close:r}=re({title:`Histórico: ${x(t)}`,contentHTML:s,maxWidth:"max-w-md"});o.querySelector("#btn-go-to-client").addEventListener("click",()=>{r(),J("clients-section",{selectedClientId:e})})}function Ji(){if(!h.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=re({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const o=e.querySelector("#add-item-content");o.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{r>1&&(r--,n())},document.getElementById("quantity-plus-btn").onclick=()=>{r++,n()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await ds(o,r),t()}};e.addEventListener("click",o=>{const r=o.target.closest('[data-action="select-item-for-quantity"]'),i=o.target.closest('[data-action="back-to-catalog"]');if(r){const{itemType:n,itemId:l}=r.dataset,c=(h.catalog[n+"s"]||[]).find(u=>u.id===l);c&&s({...c,type:n})}else i&&a()}),a()}async function $a(e=null){if(!h.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!p.professionals||p.professionals.length===0)try{p.professionals=await le(p.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const a=`
        <form id="new-sale-form" class="space-y-4">
            ...
            <div>
                ...
                <select id="new-sale-professional" required class="mt-1 w-full p-2 border rounded-md bg-white"><option value="">Selecione...</option>${p.professionals.map(l=>`<option value="${l.id}">${x(l.name)}</option>`).join("")}</select>
            </div>
    ...
    `,{modalElement:s}=re({title:"Nova Venda Avulsa",contentHTML:a,maxWidth:"max-w-md"}),o=s.querySelector("#client-search"),r=s.querySelector("#client-suggestions"),i=s.querySelector("#selected-client-id");e&&(i.value=e.id,o.value=`${e.name} (${e.phone||"Sem tel"})`,o.classList.add("bg-green-50","border-green-300","text-green-800")),o.addEventListener("input",ns(async l=>{const d=l.target.value.trim();if(i.value="",o.classList.remove("bg-green-50","border-green-300","text-green-800"),d.length<2){r.classList.add("hidden");return}try{r.innerHTML='<li class="p-2 text-xs text-gray-500">Buscando...</li>',r.classList.remove("hidden");const c=await Xt(p.establishmentId,d,10);c.length===0?r.innerHTML='<li class="p-2 text-xs text-gray-500">Nenhum cliente encontrado</li>':r.innerHTML=c.map(u=>`<li data-client-id="${u.id}" data-client-name="${u.name}" data-client-phone="${u.phone}" class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 transition-colors"><div class="font-bold text-sm text-gray-800">${x(u.name)}</div><div class="text-xs text-gray-500">${u.phone||"Sem telefone"}</div></li>`).join("")}catch{r.classList.add("hidden")}},400)),r.addEventListener("click",l=>{const d=l.target.closest("li[data-client-id]");d&&(i.value=d.dataset.clientId,i.dataset.name=d.dataset.clientName,i.dataset.phone=d.dataset.clientPhone,o.value=`${d.dataset.clientName}`,o.classList.add("bg-green-50","border-green-300","text-green-800"),r.classList.add("hidden"))}),document.addEventListener("click",l=>{!o.contains(l.target)&&!r.contains(l.target)&&r.classList.add("hidden")}),s.querySelector("#new-sale-form").addEventListener("submit",tn);const n=s.querySelector('[data-action="new-client-from-sale"]');n&&n.addEventListener("click",l=>{l.preventDefault(),s.style.display="none",Gi()})}function Gi(){re({title:"Cadastrar Novo Cliente",contentHTML:`
        <form id="comandas_clientRegistrationForm" class="flex flex-col h-full">
            ...
            <footer class="p-5 border-t bg-gray-100 flex justify-end gap-3 flex-shrink-0"><button type="submit" class="py-3 px-6 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition shadow-md">Salvar Cliente</button></footer>
        </form>
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Yi)}async function Yi(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),o=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!o)return g("Erro","Nome e Telefone são obrigatórios.","error");try{const r=await Gr(p.establishmentId,o);if(r)g("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",$a(r);else{const i=await Ko({establishmentId:p.establishmentId,name:a.value,phone:o});g("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",$a(i)}}catch(r){g("Erro",r.message,"error")}}async function Qi(){const e=`
        <form id="open-cashier-form" class="space-y-4">
            <div><label for="initial-amount" class="block text-sm font-medium text-gray-700">Valor Inicial do Caixa</label><div class="mt-1 relative"><span class="absolute left-3 top-2 text-gray-500 font-semibold">R$</span><input type="number" step="0.01" min="0" id="initial-amount" required class="w-full p-2 pl-12 border rounded-md text-lg font-semibold" placeholder="0.00" value="0.00"></div></div>
    ...
    `,{modalElement:t}=re({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return g("Valor Inválido","Insira um valor válido.","error");try{const o=await Bi({establishmentId:p.establishmentId,initialAmount:parseFloat(s.toFixed(2))});h.isCashierOpen=!0,h.activeCashierSessionId=o.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),oa(),await de()}catch(o){g("Erro",`Falha ao abrir caixa: ${o.message}`,"error")}})}async function Xi(){const e=h.activeCashierSessionId;if(e)try{const t=await Ai(e),a=`
        ...
        `,{modalElement:s}=re({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const r=parseFloat(document.getElementById("final-amount").value);if(isNaN(r)||r<0)return g("Valor Inválido","Insira um valor final válido.","error");try{await Pi(e,r),h.isCashierOpen=!1,h.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",oa(),await de(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){g("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(t){g("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Zi(e){if(h.activeFilter===e)return;h.activeFilter=e,h.paging.page=1,aa(),je(),h.selectedComandaId=null,h.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await de()}function ls(e){h.selectedComandaId=e,h.viewMode="items",h.pendingRedemption=null,h.checkoutState.discount={type:"real",value:0},h.checkoutState.discountReason="",sa(),Fi(),X()}async function ds(e,t){const a=h.allComandas.find(r=>r.id===h.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){g("Erro","Item sem identificador.","error");return}const s=parseFloat(e.price)||0,o=Array(t).fill(0).map(()=>{const r={id:String(e.id),name:e.name,price:s,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(r.productId=r.id,r.product_id=r.id):e.type==="service"&&(r.serviceId=r.id,r.service_id=r.id),r});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...o),a._cachedItems=null,a._hasUnsavedChanges=!0,X()}async function Ki(e,t){const a=h.allComandas.find(r=>r.id===h.selectedComandaId);if(!a)return;let s=!1,o=(a.comandaItems||[]).findIndex(r=>r.id==e&&r.type===t);o>-1&&(a.comandaItems.splice(o,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,X())}async function en(e){if(h.isProcessing)return;const t=ye(e),a=t.reduce((b,y)=>b+Number(y.price||0)*(y.quantity||1),0),s=h.checkoutState.discount||{type:"real",value:0};let o=s.type==="percent"?a*s.value/100:s.value;o>a&&(o=a);const r=a-o,{payments:i}=h.checkoutState,n=i.reduce((b,y)=>b+y.value,0),l=r-n;if(l>.01){if(!await W("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}h.isProcessing=!0;const d=e.type==="appointment";let c=0;const u=h.loyaltySettings;u&&u.enabled&&(c=parseInt(u.pointsPerVisit||1,10));const m={payments:i,totalAmount:Number(r),items:t,cashierSessionId:h.activeCashierSessionId,loyaltyPointsEarned:c,discount:{...s,reason:h.checkoutState.discountReason||""},loyaltyRedemption:h.pendingRedemption},f=document.createElement("div");f.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",f.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(f);try{d?await pr(e.id,m):(m.establishmentId=p.establishmentId,m.clientId=e.clientId,m.clientName=e.clientName,m.professionalId=e.professionalId,e.clientPhone&&(m.clientPhone=e.clientPhone),await Si(m));let b="Venda finalizada com sucesso!";c>0&&(b+=` Cliente ganhou ${c} pontos!`),g("Sucesso!",b,"success"),je(),h.selectedComandaId=null,h.viewMode="items",h.pendingRedemption=null,await de()}catch(b){g("Erro no Checkout",b.message,"error")}finally{document.body.contains(f)&&document.body.removeChild(f),h.isProcessing=!1}}async function tn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=t.value,o=document.getElementById("client-search").value,r=t.dataset.phone||"";if(!s)return g("Erro","Selecione um cliente válido.","error");const i=p.professionals.find(l=>l.id===a);if(!i)return g("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:o.split("(")[0].trim(),clientPhone:r,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};h.allComandas.unshift(n),h.selectedComandaId=n.id,h.viewMode="items",document.getElementById("genericModal").style.display="none",h.activeFilter==="pagas"&&(h.activeFilter="abertas"),aa(),ls(n.id)}async function de(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=h.showHistoryDate?document.getElementById("filter-date").value:null;try{const[a,s,o]=await Promise.all([Ti(),wi(p.establishmentId,t,h.paging.page,h.paging.limit),Ce(p.establishmentId)]);if(h.isCashierOpen=!!a,h.activeCashierSessionId=a?a.id:null,oa(),o&&o.loyaltyProgram&&(h.loyaltySettings=o.loyaltyProgram),h.allComandas=s.data||s||[],h.paging.total=s.total||h.allComandas.length,h.catalog.services.length===0){const[r,i,n,l]=await Promise.all([Te(p.establishmentId),ta(p.establishmentId),Oa(p.establishmentId),le(p.establishmentId)]);h.catalog={services:r,products:i,packages:n},p.professionals=l}sa(),X()}catch(a){g("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function an(e={}){Re=document.getElementById("content"),h.selectedComandaId=e.selectedAppointmentId||null,h.viewMode="items",Hi(),Me&&(Re.removeEventListener("click",Me),Re.removeEventListener("change",Me)),Me=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"){h.paging.page=1,await de();return}if(a){if(a.matches("[data-filter]"))Zi(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')||t.target.closest('[data-action="view-client-history"]')){t.stopPropagation();return}ls(a.dataset.comandaId)}else if(a.matches("[data-action]")){const s=a.dataset.action,o=a.dataset.id||h.selectedComandaId,r=h.allComandas.find(i=>i.id===o);switch(s){case"go-to-appointment":J("agenda-section",{scrollToAppointmentId:a.dataset.id,targetDate:new Date(a.dataset.date)});break;case"view-client-history":Wi(a.dataset.clientId,a.dataset.clientName);break;case"toggle-history":h.showHistoryDate=!h.showHistoryDate,h.showHistoryDate&&h.activeFilter==="abertas"&&(h.activeFilter="todas"),aa(),h.showHistoryDate||await de();break;case"back-to-list":je(),h.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(i=>i.classList.remove("selected")),X();break;case"new-sale":$a();break;case"add-item":Ji();break;case"open-cashier":Qi();break;case"close-cashier":await Xi();break;case"go-to-checkout":await uo(r,"checkout");break;case"back-to-items":h.viewMode="items",X();break;case"save-comanda":await uo(r,"stay");break;case"select-method":h.checkoutState.selectedMethod=a.dataset.method,h.checkoutState.installments=1,X();break;case"add-payment-checkout":{const i=document.getElementById("checkout-amount");let n=parseFloat(i.value);const d=ye(r).reduce((b,y)=>b+(y.price||0),0),c=h.checkoutState.discount||{type:"real",value:0};let u=c.type==="percent"?d*c.value/100:c.value;u>d&&(u=d);const m=d-u-h.checkoutState.payments.reduce((b,y)=>b+y.value,0);if(isNaN(n)||n<=0){g("Valor inválido","Insira um valor maior que zero.","error");break}if(n>m+.05){g("Valor inválido","Valor excede o restante.","error");break}const f={method:h.checkoutState.selectedMethod,value:n};["credito","crediario"].includes(h.checkoutState.selectedMethod)&&h.checkoutState.installments>1&&(f.installments=h.checkoutState.installments),h.checkoutState.payments.push(f),h.checkoutState.selectedMethod="dinheiro",h.checkoutState.installments=1,h.checkoutState.amountReceived="",X();break}case"remove-payment-checkout":h.checkoutState.payments.splice(parseInt(a.dataset.index,10),1),X();break;case"finalize-checkout":await en(r);break;case"increase-qty":{const i=a.dataset.itemId,n=a.dataset.itemType;if(!i||i==="undefined"||i==="null"){g("Erro","Item inválido.","error");return}let l=ye(r).find(c=>c.id==i&&c.type===n);l||(l=(h.catalog[n+"s"]||[]).find(c=>c.id==i));const d=l?{id:l.id,name:l.name,price:Number(l.price),type:l.type}:{id:i,name:"Item",price:0,type:n};await ds(d,1);break}case"decrease-qty":case"remove-item":await Ki(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await W("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await ur(o);const n=h.allComandas.findIndex(l=>l.id===o);n!==-1&&(h.allComandas[n].status="confirmed",delete h.allComandas[n].transaction),h.selectedComandaId=null,je(),await de(),g("Sucesso!","Comanda reaberta.","success")}catch(n){g("Erro",n.message,"error")}break}case"delete-walk-in":{if(await W("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))h.allComandas=h.allComandas.filter(n=>n.id!==o),h.selectedComandaId=null,sa(),X(),je();else try{await $i(o),g("Sucesso","Venda excluída.","success"),h.selectedComandaId=null,je(),await de()}catch(n){g("Erro",n.message,"error")}break}}}}},Re.addEventListener("click",Me),Re.addEventListener("change",Me),e.initialFilter&&(h.activeFilter=e.initialFilter==="finalizadas"?"pagas":"abertas"),e.selectedAppointmentId&&(h.selectedComandaId=e.selectedAppointmentId),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0],h.showHistoryDate=!0),await de()}const ra=e=>E(`/api/financial/natures/${e}`),on=e=>E("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),sn=e=>E(`/api/financial/natures/${e}`,{method:"DELETE"}),za=e=>E(`/api/financial/cost-centers/${e}`),rn=e=>E("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),nn=e=>E(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),cs=(e,t)=>E(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),us=(e,t={})=>{let a=`/api/financial/${e}`;const s=new URLSearchParams;t.establishmentId&&s.append("establishmentId",t.establishmentId),t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId),t.status&&s.append("status",t.status);const o=s.toString();return o&&(a+=`?${o}`),E(a)},ps=(e,t,a)=>E(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),ms=(e,t)=>E(`/api/financial/${e}/${t}`,{method:"DELETE"}),gs=(e,t)=>{const a=t.map(s=>E(`/api/financial/${e}/${s}`,{method:"DELETE"}));return Promise.all(a)},bs=(e,t,a)=>E(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),ln=e=>cs("payables",e),fs=e=>us("payables",e),dn=(e,t)=>ps("payables",e,t),cn=e=>ms("payables",e),un=(e,t)=>bs("payables",e,t),pn=e=>cs("receivables",e),xs=e=>us("receivables",e),mn=(e,t)=>ps("receivables",e,t),gn=e=>ms("receivables",e),bn=(e,t)=>bs("receivables",e,t),Ea=document.getElementById("content");let oe={};const wt={creditRealized:"#10b981",creditProvisioned:"#6ee7b7",debitRealized:"#ef4444",debitProvisioned:"#fca5a5"},fn=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],P={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],naturesList:[],rawPayables:[],rawReceivables:[],processedDRE:null,processedCashFlow:null,processedDailyRevenue:null,backendData:null,appointmentsData:[],currentTab:"dashboards",isFilterOpen:!1};async function xn(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function hn(){Ea.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await xn();const[e,t,a]=await Promise.all([le(p.establishmentId),Vr(p.establishmentId).catch(()=>[]),ra(p.establishmentId).catch(()=>[])]);P.professionalsList=e||[],P.costCentersList=t||[],P.naturesList=a||[],vn(),await hs()}catch(e){console.error("Erro no loadReportsPage:",e),Ea.innerHTML=`
            ...
            </div>`}}function vn(){const e=P.professionalsList.map(a=>`<option value="${a.id}">${x(a.name)}</option>`).join(""),t=P.costCentersList.map(a=>`<option value="${a.id}">${x(a.name)}</option>`).join("");Ea.innerHTML=`
    ...
    `,document.getElementById("toggle-filters-btn").onclick=mo,document.getElementById("btn-apply-filters").onclick=()=>{yn(),mo()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{P.currentTab=a.dataset.tab,go(),vs(),window.scrollTo({top:0,behavior:"smooth"})}}),go()}function mo(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");P.isFilterOpen=!P.isFilterOpen,P.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function go(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===P.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Nt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function yn(){P.startDate=document.getElementById("report-start").value,P.endDate=document.getElementById("report-end").value,P.selectedProfessional=document.getElementById("report-prof").value,P.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Nt(P.startDate)} até ${Nt(P.endDate)}`,await hs()}function wn(e,t){const a=new Map;P.naturesList.forEach(o=>a.set(o.id,o.name));const s={revenues:{},expenses:{},totalRevenues:0,totalExpenses:0,netResult:0};return t.forEach(o=>{if(o.status==="paid"){const r=o.naturezaId?a.get(o.naturezaId)||"Outras Receitas":"Geral";s.revenues[r]||(s.revenues[r]=0),s.revenues[r]+=o.amount,s.totalRevenues+=o.amount}}),e.forEach(o=>{if(o.status==="paid"){const r=o.naturezaId?a.get(o.naturezaId)||"Outras Despesas":"Geral";s.expenses[r]||(s.expenses[r]=0),s.expenses[r]+=o.amount,s.totalExpenses+=o.amount}}),s.netResult=s.totalRevenues-s.totalExpenses,s}function kn(e,t){const a={},s=d=>{a[d]||(a[d]={realizedCredit:0,provisionedCredit:0,realizedDebit:0,provisionedDebit:0})};let o=new Date(P.startDate);const r=new Date(P.endDate);for(;o<=r;)s(o.toISOString().split("T")[0]),o.setDate(o.getDate()+1);t.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedCredit+=d.amount:a[c].provisionedCredit+=d.amount)}),e.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedDebit+=d.amount:a[c].provisionedDebit+=d.amount)});const i=Object.keys(a).sort(),n=[];let l=0;return i.forEach(d=>{const c=a[d],u=c.realizedCredit+c.provisionedCredit-(c.realizedDebit+c.provisionedDebit);l+=u,n.push(l)}),{labels:i,realizedCredit:i.map(d=>a[d].realizedCredit),provisionedCredit:i.map(d=>a[d].provisionedCredit),realizedDebit:i.map(d=>a[d].realizedDebit*-1),provisionedDebit:i.map(d=>a[d].provisionedDebit*-1),balance:n}}function Sn(e){const t={};let a=new Date(P.startDate);const s=new Date(P.endDate);for(;a<=s;)t[a.toISOString().split("T")[0]]=0,a.setDate(a.getDate()+1);e.forEach(i=>{if(i.status==="paid"){const n=i.dueDate.split("T")[0];t.hasOwnProperty(n)&&(t[n]+=i.amount)}});const o=Object.keys(t).sort(),r=o.map(i=>t[i]);return{labels:o,data:r}}function $n(e){const t=e.length;if(t<2)return{trendData:Array(t).fill(e[0]||0),color:"#9ca3af"};let a=0,s=0,o=0,r=0;for(let c=0;c<t;c++)a+=c,s+=e[c],o+=c*e[c],r+=c*c;const i=(t*o-a*s)/(t*r-a*a),n=(s-i*a)/t,l=[];for(let c=0;c<t;c++)l.push(i*c+n);const d=i>=0?"#10b981":"#ef4444";return{trendData:l,color:d}}async function hs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20 w-full"><div class="loader border-t-indigo-600"></div></div>';try{const t={startDate:P.startDate,endDate:P.endDate,establishmentId:p.establishmentId};P.selectedCostCenter!=="all"&&(t.costCenterId=P.selectedCostCenter);const[a,s]=await Promise.all([fs(t),xs(t)]);P.rawPayables=a.entries||[],P.rawReceivables=s.entries||[];const o=await zr(P.startDate,P.endDate,P.selectedProfessional,P.selectedCostCenter).catch(()=>({charts:{professionals:{labels:[],data:[]},salesMonthly:{labels:[],data:[]}}}));P.backendData=o,P.processedDRE=wn(P.rawPayables,P.rawReceivables),P.processedCashFlow=kn(P.rawPayables,P.rawReceivables),P.processedDailyRevenue=Sn(P.rawReceivables);const r=new Date(P.startDate+"T00:00:00").toISOString(),i=new Date(P.endDate+"T23:59:59").toISOString(),n=P.selectedProfessional==="all"?null:P.selectedProfessional,l=await Aa(p.establishmentId,r,i,n).catch(()=>[]);P.appointmentsData=Array.isArray(l)?l:[],vs()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function vs(){const e=document.getElementById("report-content");switch(P.currentTab){case"dashboards":En(e);break;case"appointments":In(e);break;case"dre":Ln(e);break}}function En(e){const t=P.processedDRE,a=P.processedDailyRevenue,s=P.backendData.charts?.salesMonthly||{labels:[],data:[]},o=P.backendData.charts?.professionals||{labels:[],data:[]};e.innerHTML=`
    ...
    `,Cn("chart-cashflow-modern",P.processedCashFlow),bo("chart-daily-revenue","Receita Diária",a.labels.map(r=>r.split("-").reverse().slice(0,2).join("/")),a.data),bo("chart-monthly","Receita Mensal",s.labels,s.data),Tn("chart-profs","doughnut","Total Vendas",o.labels,o.data,fn),document.querySelectorAll(".chart-toggle").forEach(r=>{r.addEventListener("change",i=>{const n=oe["chart-cashflow-modern"];if(n){const l=parseInt(i.target.dataset.dataset);n.setDatasetVisibility(l,i.target.checked),n.update()}})})}function In(e){const t=P.appointmentsData,a=t.length;let s=0,o=0,r=0;const i={},n={};let l=new Date(P.startDate);const d=new Date(P.endDate);for(;l<=d;)i[l.toISOString().split("T")[0]]={active:0,cancelled:0},l.setDate(l.getDate()+1);t.forEach(b=>{const y=parseFloat(b.totalAmount||b.price||0),v=(b.status||"").toLowerCase();let w="";if(b.startTime){const I=b.startTime.toDate?b.startTime.toDate():new Date(b.startTime);isNaN(I)||(w=I.toISOString().split("T")[0])}const S=b.professionalName||"Sem Profissional";n[S]||(n[S]={name:S,count:0,value:0}),["cancelled","cancelado","no-show","cancelada"].includes(v)?(o++,w&&i[w]&&i[w].cancelled++):(["completed","finalized","paid"].includes(v)&&s++,r+=y,w&&i[w]&&i[w].active++,n[S].count++,n[S].value+=y)});const c=Object.keys(i).sort(),u=c.map(b=>i[b].active),m=c.map(b=>i[b].cancelled),f=Object.values(n).sort((b,y)=>y.value-b.value);e.innerHTML=`
            ...
            <div class="overflow-x-auto no-scrollbar w-full">
                <table class="w-full text-xs md:text-sm min-w-full">
                    <tbody class="divide-y divide-gray-100">
                        ${f.map((b,y)=>{const v=f[0]?.value||1,w=b.value/v*100;return`
                            <tr class="group">
    ...
    `,Dn("chart-appointments-daily",c,u,m),document.querySelectorAll(".app-chart-toggle").forEach(b=>{b.addEventListener("change",y=>{const v=oe["chart-appointments-daily"];if(v){const w=parseInt(y.target.dataset.dataset);v.setDatasetVisibility(w,y.target.checked),v.update()}})})}function Ln(e){const t=P.processedDRE;if(!t)return;const a=t.totalRevenues,s=(n,l,d,c=!1)=>{const u=a>0?l/a*100:0,m=c?"- ":"";return`
    ...
    `}function Cn(e,t){const a=document.getElementById(e);if(!a)return;const s=a.getContext("2d");oe[e]&&oe[e].destroy();const o=s.createLinearGradient(0,0,0,400);o.addColorStop(0,"rgba(59, 130, 246, 0.4)"),o.addColorStop(1,"rgba(59, 130, 246, 0.0)");const r=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));oe[e]=new Chart(s,{type:"bar",data:{labels:r,datasets:[{label:"Créd. Realizado",data:t.realizedCredit,backgroundColor:wt.creditRealized,borderRadius:3,barPercentage:.7,order:1},{label:"Créd. Provisionado",data:t.provisionedCredit,backgroundColor:wt.creditProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:2},{label:"Déb. Realizado",data:t.realizedDebit,backgroundColor:wt.debitRealized,borderRadius:3,barPercentage:.7,order:3},{label:"Déb. Provisionado",data:t.provisionedDebit,backgroundColor:wt.debitProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:4},{label:"Saldo Acumulado",data:t.balance,type:"line",borderColor:"#3b82f6",backgroundColor:o,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!0,tension:.4,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10,callbacks:{label:function(i){let n=i.dataset.label||"";return n&&(n+=": "),i.parsed.y!==null&&(n+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(Math.abs(i.parsed.y))),n}}}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{size:10}}},y:{stacked:!0,display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(Math.abs(i)),font:{size:10}}}}}})}function Dn(e,t,a,s){const o=document.getElementById(e);if(!o)return;const r=o.getContext("2d");oe[e]&&oe[e].destroy();const i=t.map(n=>n.split("-").reverse().slice(0,2).join("/"));oe[e]=new Chart(r,{type:"bar",data:{labels:i,datasets:[{label:"Realizados",data:a,backgroundColor:"#4f46e5",borderRadius:3,barPercentage:.6,order:1},{label:"Cancelados",data:s,backgroundColor:"#ef4444",borderRadius:3,barPercentage:.6,order:2}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function bo(e,t,a,s){const o=document.getElementById(e);if(!o)return;const r=o.getContext("2d");oe[e]&&oe[e].destroy();const{trendData:i,color:n}=$n(s),l=i.map((u,m)=>m===i.length-1?"triangle":"circle"),d=i.map((u,m)=>m===i.length-1?6:3),c=i.map((u,m)=>m===i.length-1&&n==="#ef4444"?180:0);oe[e]=new Chart(r,{type:"bar",data:{labels:a,datasets:[{label:t,data:s,backgroundColor:"#4f46e5",borderRadius:4,order:1},{label:"Tendência",data:i,type:"line",borderColor:n,borderWidth:3,pointStyle:l,pointRadius:d,pointRotation:c,pointBackgroundColor:"#fff",pointBorderColor:n,pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!1,tension:0,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9},callback:u=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(u)}}}}})}function Tn(e,t,a,s,o,r){const i=document.getElementById(e);if(!i)return;const n=i.getContext("2d");oe[e]&&oe[e].destroy(),new Chart(n,{type:t,data:{labels:s,datasets:[{label:a,data:o,backgroundColor:r,borderColor:Array.isArray(r)?"#fff":r,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:{}}})}const ia=(e,t="products")=>E(`/api/${t}/categories/${e}`),ys=(e,t="products")=>E(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),ws=(e,t="products")=>E(`/api/${t}/categories/${e}`,{method:"DELETE"}),Bn="audit_logs",me=async(e,t,a,s,o,r=null)=>{try{if(!t)return;await _o(Yt(be,Bn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:o,details:r,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},Se=document.getElementById("content");let xe=null,st="services",Ie="all",rt=[];function Ge(){const e=ne.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function Pn(e){e.preventDefault();const t=e.target.closest("#categoryForm"),a=t.querySelector("#categoryName"),s=a.value;if(!s)return;const o=t.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const r=rt.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);r.length===0&&r.push(p.establishmentId),await ys({establishmentId:p.establishmentId,name:s,accessibleIn:r},"services"),me(p.establishmentId,Ge(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",g("Sucesso","Categoria criada!","success"),await Va(),await ft()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Adicionar"}}async function Mn(e){if(await W("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ws(e,"services"),me(p.establishmentId,Ge(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Va(),await ft()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Va(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ia(p.establishmentId,"services");p.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function An(){re({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Pn),t.addEventListener("click",s=>{const o=s.target.closest('button[data-action="delete-category"]');o&&(s.preventDefault(),Mn(o.dataset.id))}))}Va()}function qn(e=[]){if(!rt||rt.length===0)return`
            ...
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return rt.forEach(a=>{const s=e.includes(a.id)||e.length===0&&a.id===p.establishmentId;t+=`
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[85vh] my-auto">
        <form id="serviceForm">
            ...
            <div class="mt-6 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-3">
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async D=>{const L=D.target.closest("button[data-action]");if(!L)return;const q=L.dataset.action,O=L.dataset.id;if(q==="close-modal"&&(t.style.display="none"),q==="delete-service"){if(!O)return;if(t.style.display="none",await W("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const M=p.services.find(R=>R.id===O)?.name||"Desconhecido";await ti(O),me(p.establishmentId,Ge(),"Serviços","Excluiu",`Excluiu o serviço: ${M}`),g("Sucesso","Serviço apagado com sucesso!","success"),await ft()}catch(M){g("Erro",`Não foi possível apagar o serviço: ${M.message}`,"error")}else t.style.display="flex"}});const d=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");d.forEach(D=>{D.addEventListener("click",()=>{d.forEach(L=>{L.classList.remove("border-indigo-500","text-indigo-600"),L.classList.add("border-transparent","text-gray-500")}),D.classList.add("border-indigo-500","text-indigo-600"),D.classList.remove("border-transparent","text-gray-500"),c.forEach(L=>L.classList.add("hidden")),document.getElementById(`tab-content-${D.dataset.tab}`).classList.remove("hidden")})});const u=t.querySelectorAll('input[name="commissionType"]'),m=document.getElementById("defaultCommissionRateContainer"),f=document.getElementById("professionalCommissionsContainer");function b(){const D=t.querySelector('input[name="commissionType"]:checked').value;m&&(m.style.display=D==="default"?"block":"none"),f&&(f.style.display=D==="custom"?"block":"none")}u.forEach(D=>D.addEventListener("change",b));const y=document.getElementById("professionalCommissionsList");y&&(y.innerHTML=(p.professionals||[]).map(D=>{const L=e?.professionalCommissions?.[D.id]!==void 0,q=e?.professionalCommissions?.[D.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${L?"bg-blue-50":""}" data-prof-id="${D.id}">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <img src="${D.photo||`https://placehold.co/40x40/E2E8F0/4A5568?text=${x(D.name.charAt(0))}`}" class="w-8 h-8 rounded-full object-cover">
                        <span class="text-sm font-medium">${x(D.name)}</span>
                    </label>
            ...
            `}).join(""),y.querySelectorAll('input[type="checkbox"]').forEach(D=>{D.addEventListener("change",L=>{const q=L.target.closest(".professional-commission-row");q.querySelector('input[type="number"]').disabled=!L.target.checked,q.classList.toggle("bg-blue-50",L.target.checked)})})),b();const v=t.querySelector("#serviceForm"),w=t.querySelector("#servicePhotoInput"),S=t.querySelector("#servicePhotoPreview"),I=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>w.click()),w.onchange=async()=>{const D=w.files[0];if(D){S.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const L=await ts(D,800,800,.8);if(L.length*3/4>1e3*1024)throw new Error("Imagem muito grande.");S.src=L,I.value=L}catch(L){g("Erro de Imagem",L.message,"error"),S.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",I.value=e?.photo||""}}},v.addEventListener("submit",Rn)}function it(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",s=new Map((p.serviceCategories||[]).map(r=>[r.id,r.name]));let o=(p.services||[]).filter(Boolean);if(Ie!=="all"){const r=Ie==="active";o=o.filter(i=>i.active!==!1===r)}o=o.filter(r=>{const i=r.name.toLowerCase().includes(t),n=a==="all"||r.categoryId===a;return i&&n}),e.innerHTML="",o.length>0?o.forEach(r=>{const i=document.createElement("div"),n=JSON.stringify(r).replace(/'/g,"&apos;");i.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:border-indigo-300 border border-transparent ${r.active!==!1?"opacity-100":"opacity-60 bg-gray-100"} sm:flex-col`,i.dataset.action="edit-service",i.dataset.service=n;const l=x(r.name),d=x(s.get(r.categoryId)||"Sem Categoria"),c=r.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(r.name.charAt(0))}`;i.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${x(a.name)}</option>`)),_a(),it()}function Nn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ft(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,o,r]=await Promise.all([Te(p.establishmentId),le(p.establishmentId),ia(p.establishmentId,"services"),oi(p.establishmentId),Qe()]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(s||[]).filter(Boolean),p.mostPopularService=o||{name:"N/A",count:0},rt=r?.matrizes||[],p.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),ks(st)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function ks(e){if(document.getElementById("services-content-container")){if(st===e&&document.getElementById("services-content-container").children.length>1){st==="services"&&(_a(),it());return}st=e,Ie="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?jn():e==="reports"&&Nn()}}function Fn(){xe&&(Se.removeEventListener("click",xe),Se.removeEventListener("input",xe),Se.removeEventListener("change",xe)),xe=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const o=t.closest('[data-action="toggle-service-status"]'),r=o.dataset.id,i=o.checked;try{await ai(r,i);const n=p.services.findIndex(l=>l.id===r);n>-1&&(p.services[n].active=i),me(p.establishmentId,Ge(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${i?"Ativo":"Inativo"}`),it(),_a()}catch(n){g("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),o.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){it();return}if(!a)return;if(a.hasAttribute("data-view")){ks(a.dataset.view);return}switch(a.dataset.action){case"new-service":fo();break;case"edit-service":const o=JSON.parse(a.dataset.service);fo(o);break;case"manage-categories":An();break;case"filter-service":const r=a.dataset.filterType;if(r==="popular")return;Ie=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,d=n===Ie||n==="total"&&Ie==="all";i.classList.toggle("ring-2",d),i.classList.toggle("ring-indigo-500",d),i.classList.toggle("shadow-md",d),i.classList.toggle("bg-white",!d)}),it();break}},Se.addEventListener("click",xe),Se.addEventListener("input",xe),Se.addEventListener("change",xe)}async function Hn(){Se.innerHTML=`
        ...
        </div>`,Fn(),st="services",Ie="all",await ft()}const na="suppliers",Ua=async e=>{try{const t=Uo(Yt(be,na),Wo("establishmentId","==",e)),a=await Zs(t),s=[];return a.forEach(o=>{s.push({id:o.id,...o.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},On=async e=>{try{return{id:(await _o(Yt(be,na),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},zn=async(e,t)=>{try{const a=bt(be,na,e);return await Ma(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Vn=async e=>{try{const t=bt(be,na,e);return await Ks(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},ke=document.getElementById("content");let he=null,nt="products",ge="all";async function _n(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await ys({establishmentId:p.establishmentId,name:s},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Wa(),await xt()}catch(o){g("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function Un(e){if(await W("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ws(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Wa(),await xt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Wa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ia(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${x(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Wn(){re({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                <div class="flex flex-col-reverse sm:flex-row w-full sm:w-auto gap-3">
    ...
    </div>`;const b=t.querySelector("#productCategory"),y=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>y.click()),b.innerHTML='<option value="">Sem categoria</option>'+(p.categories||[]).map(B=>`<option value="${B.id}" ${e?.categoryId===B.id?"selected":""}>${x(B.name)}</option>`).join(""),e&&(b.value=e.categoryId||"");const v=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const w=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",S=e?.photo||"";y.onchange=async()=>{const B=y.files[0];if(B){v.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const M=await xo(B,800,800,"image/jpeg",.8),H=M.length*3/4,z=1e3*1024;if(H>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=M,base64Input.value=M}catch(M){console.error("Erro ao processar imagem:",M),g("Erro de Imagem",M.message||"Não foi possível processar a imagem.","error"),preview.src=w,base64Input.value=S,O.value=""}}};const I=t.cloneNode(!0);t.parentNode.replaceChild(I,t);const D=()=>{const B=I.querySelector("#modalSupplierSearch"),M=I.querySelector("#supplierSearchResults"),R=I.querySelector("#selectedSuppliersList"),H=B.value.toLowerCase();if(H.length>0){const z=s.filter(j=>j.name.toLowerCase().includes(H)&&!r.has(j.id));z.length>0?(M.classList.remove("hidden"),M.innerHTML=z.map(j=>`
                    <div class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 text-sm flex justify-between items-center" data-add-supplier="${j.id}">
                        <span class="font-medium">${x(j.name)}</span>
                        <span class="text-indigo-600 text-xs">+ Adicionar</span>
                    </div>
                `).join("")):(M.classList.remove("hidden"),M.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else M.classList.add("hidden");r.size>0?(R.innerHTML="",r.forEach(z=>{const j=s.find(C=>C.id===z);j&&(R.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border p-2 rounded shadow-sm" data-id="${j.id}">
                            <div class="text-sm">
                                <p class="font-bold text-gray-800">${x(j.name)}</p>
                                <p class="text-xs text-gray-500">${x(j.contactName||"")} - ${x(j.phone||"")}</p>
                            </div>
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};I.querySelector("#modalSupplierSearch").addEventListener("input",D),I.addEventListener("click",B=>{const M=B.target.closest("[data-add-supplier]");if(M){const H=M.dataset.addSupplier;r.add(H),I.querySelector("#modalSupplierSearch").value="",D()}const R=B.target.closest("[data-remove-supplier]");if(R){const H=R.dataset.removeSupplier;r.delete(H),D()}}),D(),I.addEventListener("click",async B=>{const M=B.target.closest("button[data-action]");if(!M)return;const R=M.dataset.action,H=I.querySelector("#productId").value;if(R==="close-modal"&&(I.style.display="none"),R==="delete-product"){if(!H)return;I.style.display="none",await Jn(H)}if(R==="save-product-modal"){const z=I.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const j=M.closest('button[data-action="save-product-modal"]');j.disabled=!0,j.textContent="A salvar...";try{await Gn(z)}catch(C){g("Erro",`Falha ao salvar: ${C.message}`,"error"),j.disabled=!1,j.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){B.preventDefault();const z=I.querySelector("#stockAdjustmentAmount"),j=I.querySelector("#stockAdjustmentReason"),C=parseInt(z.value,10),V=parseInt(M.dataset.change,10);if(!C||C<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Z=C*V,se=j.value||(Z>0?"Entrada manual":"Saída manual");try{await Ci(H,{change:Z,reason:se});const Be=p.products.findIndex(we=>we.id===H);if(Be>-1){const we=p.products[Be].currentStock+Z;p.products[Be].currentStock=we,I.querySelector("#currentStockDisplay").textContent=we,I.querySelector("#productCurrentStock").value=we,z.value="",j.value="",g("Sucesso","Estoque atualizado!","success"),Ja(),mt()}}catch(Be){g("Erro de Stock",Be.message,"error")}}});const L=I.querySelectorAll(".tab-btn"),q=I.querySelectorAll(".tab-content");L.forEach(B=>{B.addEventListener("click",M=>{M.preventDefault(),L.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),B.classList.add("border-indigo-500","text-indigo-600"),B.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),q.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${B.dataset.tab}`).classList.remove("hidden")})});const O=I.querySelector("#productPhotoInput");I.querySelector("#productPhotoButton").addEventListener("click",()=>O.click()),O.onchange=async()=>{const B=O.files[0];if(!B)return;const M=I.querySelector("#productPhotoPreview"),R=I.querySelector("#productPhotoBase64");M.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const H=await xo(B,800,800,"image/jpeg",.8),j=H.length*3/4,C=1e3*1024;if(j>C)throw new Error("A imagem é muito grande mesmo após a compressão.");M.src=H,R.value=H}catch(H){console.error("Erro ao processar imagem:",H),g("Erro de Imagem",H.message||"Não foi possível processar a imagem.","error"),M.src=w,R.value=S,O.value=""}},I.style.display="flex"}function Yn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${x(a.name)}</option>`)),Ja(),mt()}function Qn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const o=document.getElementById("productFilterReport"),r=document.getElementById("categoryFilterReport");o&&p.products&&(o.innerHTML+=p.products.map(i=>`<option value="${i.id}">${x(i.name)}</option>`).join("")),r&&p.categories&&(r.innerHTML+=p.categories.map(i=>`<option value="${i.id}">${x(i.name)}</option>`).join(""))}async function Xn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:p.establishmentId};try{const a=await Di(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function xt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,s]=await Promise.all([ta(p.establishmentId),ia(p.establishmentId,"products"),Ua(p.establishmentId)]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),p.suppliers=(s||[]).filter(Boolean),Ss(nt)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function Ss(e){if(document.getElementById("products-content-container")){if(nt===e&&document.getElementById("products-content-container").children.length>1){nt==="products"&&(Ja(),mt());return}nt=e,ge="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Yn():e==="movements"&&Qn()}}async function Zn(){ke.innerHTML=`
        ...
        </section>`,he&&(ke.removeEventListener("click",he),ke.removeEventListener("input",he),ke.removeEventListener("change",he)),he=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){mt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){Ss(a.dataset.view);return}switch(a.dataset.action){case"new-product":ho();break;case"edit-product":ho(JSON.parse(a.dataset.product));break;case"manage-product-categories":Wn();break;case"generate-report":await Xn();break;case"filter-stock":const o=a.dataset.filterType;ge=ge===o?"all":o,document.querySelectorAll(".indicator-card").forEach(r=>{r.classList.toggle("ring-2",r.dataset.filterType===ge),r.classList.toggle("ring-indigo-500",r.dataset.filterType===ge),r.classList.toggle("shadow-lg",r.dataset.filterType===ge)}),mt();break}},ke.addEventListener("click",he),ke.addEventListener("input",he),ke.addEventListener("change",he),nt="products",ge="all",await xt()}const Mt=document.getElementById("content");let F={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},kt=null;const Ft={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},$s=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function Kn(){try{const t=(await Qe()).matrizes||[];F.establishments=[],t.forEach(a=>{F.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>F.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(e){console.warn("Erro ao buscar lojas",e)}F.viewMode="list",F.editingItem=null,F.hasSearched=!1,F.partners=[],el(),il(),Es()}function el(){Mt.innerHTML=`
    ...
    `}function tl(){const e=Object.entries(Ft).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),t=$s.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function al(e=null){const t=!!e,a=t?"Ficha do Parceiro":"Novo Parceiro de Negócio";let s=e?.category||"";s==="Produtos"&&(s="estoque"),s==="Serviços"&&(s="servicos");const o=Object.entries(Ft).map(([n,l])=>`<option value="${n}" ${s===n?"selected":""}>${l.label}</option>`).join(""),r=$s.map(n=>`<option value="${n}" ${e?.state===n?"selected":""}>${n}</option>`).join(""),i=document.getElementById("form-container-wrapper");i&&(i.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",sl))}function Es(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
        ...
        `)}async function ol(){const e=document.getElementById("partners-grid");if(!F.hasSearched){Es();return}e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="text-sm text-gray-500 mt-4 font-medium">Buscando parceiros...</p></div>';try{const t=await Ua(p.establishmentId);F.partners=t||[],Is()}catch(t){e.innerHTML=`<div class="text-center py-10 text-red-500 font-bold">Erro ao carregar parceiros: ${t.message}</div>`}}function Is(){const e=document.getElementById("partners-grid");if(!e)return;let t=F.partners;if(F.searchQuery){const o=F.searchQuery.toLowerCase();t=t.filter(r=>r.name.toLowerCase().includes(o)||r.document&&r.document.includes(o)||r.taxId&&r.taxId.includes(o)||r.email&&r.email.toLowerCase().includes(o)||r.contactName&&r.contactName.toLowerCase().includes(o))}if(F.categoryFilter!=="all"&&(t=t.filter(o=>o.category===F.categoryFilter)),F.stateFilter!=="all"&&(t=t.filter(o=>o.state===F.stateFilter)),F.cityFilter){const o=F.cityFilter.toLowerCase();t=t.filter(r=>r.city&&r.city.toLowerCase().includes(o))}if(t.sort((o,r)=>{let i="",n="";return F.sortBy==="name_asc"||F.sortBy==="name_desc"?(i=(o.name||"").toLowerCase(),n=(r.name||"").toLowerCase()):F.sortBy==="contact_asc"&&(i=(o.contactName||"").toLowerCase(),n=(r.contactName||"").toLowerCase()),F.sortBy==="name_desc"?n.localeCompare(i):i.localeCompare(n)}),t.length===0){e.innerHTML=`
        ...
        <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
    `,s='<div class="flex flex-col gap-4 md:hidden">';t.forEach(o=>{let r=o.category;r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const i=Ft[r]||Ft.outros,n=o.document||o.taxId?o.document||o.taxId:"-",l=JSON.stringify(o).replace(/'/g,"&apos;"),d=[o.city,o.state].filter(Boolean).join(" - ");a+=`
            <tr class="hover:bg-indigo-50/50 cursor-pointer transition-colors group" data-action="open-form" data-item='${l}'>
                ...
                <td class="p-4">
                    <p class="font-bold text-gray-900 text-sm group-hover:text-indigo-700 transition-colors">${x(o.name)}</p>
                    ${o.email?`<p class="text-xs text-gray-500 mt-0.5"><i class="bi bi-envelope mr-1 opacity-50"></i>${x(o.email)}</p>`:""}
                </td>
                <td class="p-4 text-sm font-medium text-gray-600">${x(n)}</td>
                <td class="p-4">
                    <div class="text-sm font-medium text-gray-800">${x(o.contactName||"-")}</div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex flex-col gap-3 active:scale-[0.98] transition-transform cursor-pointer relative overflow-hidden" data-action="open-form" data-item='${l}'>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <h3 class="font-black text-gray-900 text-base leading-tight truncate">${x(o.name)}</h3>
                    </div>
                </div>
        ...
        `}),a+="</tbody></table></div>",s+="</div>",e.innerHTML=a+s}function lt(e,t=null){const a=document.getElementById("suppliers-list-view"),s=document.getElementById("suppliers-form-view");F.viewMode=e,F.editingItem=t,e==="list"?(a.classList.remove("hidden"),s.classList.add("hidden"),s.innerHTML='<div id="form-container-wrapper" class="max-w-5xl mx-auto px-4 sm:px-6 py-8 pb-24"></div>',F.hasSearched&&Is(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),s.classList.remove("hidden"),al(t),window.scrollTo({top:0,behavior:"smooth"}))}async function sl(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,document:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,state:t.querySelector("#supState").value,city:t.querySelector("#supCity").value,establishmentId:p.establishmentId,notes:t.querySelector("#supNotes")?.value||"",accessibleIn:[p.establishmentId]},o=t.querySelector('button[type="submit"]'),r=o.innerHTML;o.disabled=!0,o.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await zn(a,s),g("Sucesso","Ficha atualizada!","success")):(await On(s),g("Sucesso","Parceiro registado!","success")),F.hasSearched&&(F.partners=await Ua(p.establishmentId)||[]),lt("list")}catch(i){g("Erro","Falha ao gravar: "+i.message,"error"),o.disabled=!1,o.innerHTML=r}}async function rl(e){if(await W("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente? Os lançamentos financeiros antigos não serão apagados."))try{await Vn(e),g("Sucesso","Entidade excluída.","success"),F.partners=F.partners.filter(a=>a.id!==e),lt("list")}catch(a){g("Erro","Erro ao excluir: "+a.message,"error")}}function il(){kt&&Mt.removeEventListener("click",kt),kt=async e=>{const t=e.target;if(t.closest('button[data-action="new-partner"]')){lt("form",null);return}if(t.closest("#btn-search-partners")){F.searchQuery=document.getElementById("filterSearch").value,F.categoryFilter=document.getElementById("filterCategory").value,F.stateFilter=document.getElementById("filterState").value,F.cityFilter=document.getElementById("filterCity").value,F.sortBy=document.getElementById("filterSortBy").value,F.hasSearched=!0,ol();return}if(t.closest('button[data-action="back-to-list"]')){lt("list");return}const a=t.closest('button[data-action="delete-partner"]');if(a){e.preventDefault(),rl(a.dataset.id);return}const s=t.closest('[data-action="open-form"]');if(s&&!t.closest("button")){const o=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));lt("form",o)}},Mt.addEventListener("click",kt),Mt.addEventListener("keypress",e=>{e.key==="Enter"&&(e.target.id==="filterSearch"||e.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const ua=document.getElementById("content"),vo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ce=new Set,St=null,Ne=null,At=[];function qt(){const e=ne.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}function nl(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function ll(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",s=x(t.name),o=x(t.specialty||"Especialidade"),r=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,l=n>1?`<span class="text-[10px] font-bold bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded ml-2 border border-indigo-200" title="Atende em ${n} unidades"><i class="bi bi-diagram-3"></i> ${n} Lojas</span>`:"";return`
            ...
            </div>`}).join("")}function pa(){const e=document.getElementById("genericModal");e.style.display="none",Ne&&e.removeEventListener("click",Ne)}async function dl(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=x(a.name),o=p.services||await Te(p.establishmentId),r=p.professionals||await le(p.establishmentId),i=`
        ...
        </div>`;t.innerHTML=i,t.style.display="flex",ul(a,o),pl(a),ml(a,r),bl(a)}function cl(e=[]){if(!At||At.length===0)return`
            <input type="hidden" name="accessibleIn" value="${p.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Profissional exclusivo desta unidade.
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return At.forEach(a=>{const s=e.includes(a.id)||e.length===0&&a.id===p.establishmentId;t+=`
            <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-white rounded px-2 transition-colors">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${s?"checked":""}>
                <span class="text-sm font-bold text-gray-800">🏢 ${x(a.name)} (Matriz)</span>
            </label>
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const r=e.includes(o.id)||e.length===0&&o.id===p.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function ul(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],o=Array.from({length:12},(v,w)=>{const S=w+1,I=S==s[1]?"selected":"",D=new Date(0,w).toLocaleString("pt-BR",{month:"long"});return`<option value="${S}" ${I}>${D.charAt(0).toUpperCase()+D.slice(1)}</option>`}).join(""),r=e.status||"active",i=x(e.name||""),n=x(e.specialty||""),l=x(e.phone||""),d=x(e.notes||"");a.innerHTML=`
            ...
            <div id="profServicesContainer" class="grid grid-cols-2 md:grid-cols-3 gap-3 p-4 border border-gray-200 rounded-xl bg-gray-50 max-h-64 overflow-y-auto">
                ${t.map(v=>`
                    <label class="flex items-center space-x-3 p-2 hover:bg-white rounded-lg cursor-pointer transition-colors border border-transparent hover:border-gray-200 hover:shadow-sm">
                        <input type="checkbox" value="${v.id}" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4" ${e.services?.includes(v.id)?"checked":""}>
                        <span class="text-sm font-medium text-gray-700">${x(v.name)}</span>
                    </label>
                `).join("")}
            </div>
        </div>
        ...
        </div>`;const c=document.getElementById("profPhotoInput"),u=document.getElementById("profPhotoButton"),m=document.getElementById("profPhotoPreview"),f=document.getElementById("profPhotoBase64"),b=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,y=e.photo||"";u&&u.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const v=c.files[0];if(v){m.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const w=await ts(v,800,800,.8),I=w.length*3/4,D=1e3*1024;if(I>D)throw new Error("A imagem é muito grande mesmo após a compressão.");m.src=w,f.value=w}catch(w){g("Erro de Imagem",w.message||"Não foi possível processar a imagem.","error"),m.src=b,f.value=y,c.value=""}}})}function pl(e){const t=document.getElementById("jornada");t.innerHTML=`
        ...
        </div>`,gl(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function ml(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        </div>`;const s=document.getElementById("batchBlockageForm");s&&s.addEventListener("submit",async r=>{r.preventDefault();const i=s.querySelector('button[type="submit"]'),n=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm"></span> A gravar...';const l=Array.from(r.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(y=>y.value);if(l.length===0)return i.disabled=!1,i.innerHTML=n,g("Atenção","Selecione pelo menos um profissional.","error");const d=r.target.batchBlockageStartDate.value,c=r.target.batchBlockageEndDate.value||d,u=r.target.batchBlockageStartTime.value,m=r.target.batchBlockageEndTime.value,f=r.target.batchBlockageReason.value;if(!d||!u||!m)return i.disabled=!1,i.innerHTML=n,g("Atenção","Preencha Data de Início, Hora de Início e Fim.","error");const b=l.map(y=>{const v={professionalId:y,establishmentId:p.establishmentId,startTime:new Date(`${d}T${u}`).toISOString(),endTime:new Date(`${c}T${m}`).toISOString(),reason:f};return Kt(v)});try{await Promise.all(b),g("Sucesso!",`${l.length} bloqueios foram criados.`),s.reset(),r.target.querySelectorAll('input[name="batch-professionals"]').forEach(v=>{v.checked=v.value===e.id});const y=document.getElementById("prof-blockages-filter").value;dt(e.id,y)}catch(y){g("Erro",y.message,"error")}finally{i.disabled=!1,i.innerHTML=n}}),document.getElementById("prof-blockages-filter").addEventListener("change",r=>dt(e.id,r.target.value)),await dt(e.id,"future")}function gl(e,t){e.innerHTML=Object.keys(vo).map(a=>{const s=t[a]||{},o=s.active!==!1;return`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500 p-4">${s.message}</p>`}}}function bl(e){const t=document.getElementById("genericModal");Ne&&t.removeEventListener("click",Ne),Ne=async a=>{const s=a.target.closest("button[data-action]");if(!s){const r=a.target.closest(".tab-link");r&&(t.querySelectorAll(".tab-link").forEach(i=>{i.classList.remove("active","border-indigo-600","text-indigo-600"),i.classList.add("border-transparent","text-gray-500")}),r.classList.add("active","border-indigo-600","text-indigo-600"),r.classList.remove("border-transparent","text-gray-500"),t.querySelectorAll(".tab-content").forEach(i=>i.classList.add("hidden")),document.getElementById(r.dataset.tab).classList.remove("hidden"));return}const o=s.dataset.action;switch(a.stopPropagation(),o){case"close-modal":pa();break;case"delete-professional":const r=s.dataset.id;if(await W("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita e ele será removido da agenda e de todas as lojas.`))try{await as(r),me(p.establishmentId,qt(),"Equipe","Excluiu",`Excluiu profissional: ${e.name}`),g("Sucesso!","Profissional excluído da rede.","success"),pa(),Ht()}catch(S){g("Erro",`Não foi possível excluir: ${S.message}`,"error")}break;case"save-professional":const n=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),c=Array.from(n.querySelectorAll("#profServicesContainer input:checked")).map(S=>S.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(S=>{const I=S.querySelector('[data-field="active"]').dataset.day;u[I]={active:S.querySelector('[data-field="active"]').checked,start:S.querySelector('[data-field="start"]').value,end:S.querySelector('[data-field="end"]').value,breakStart:S.querySelector('[data-field="breakStart"]').value,breakEnd:S.querySelector('[data-field="breakEnd"]').value}});const m=Array.from(n.querySelectorAll('input[name="accessibleIn"]:checked')).map(S=>S.value),f=m.length>0?m:[p.establishmentId],b={...e,id:n.querySelector("#professionalId").value||void 0,accessibleIn:f,name:n.querySelector("#profName").value.trim(),specialty:n.querySelector("#profSpecialty").value,photo:n.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:n.querySelector("#profPhone").value,dob:`${n.querySelector("#profDobDay").value}/${n.querySelector("#profDobMonth").value}`,receivesCommission:n.querySelector("#profCommission").value==="sim",showOnAgenda:n.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(n.querySelector("#profOrderOnAgenda").value)||1,notes:n.querySelector("#profNotes").value,status:n.querySelector("#profStatus").value,establishmentId:p.establishmentId},y=l.innerHTML;l.disabled=!0,l.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{b.id?(await ii(b.id,b),me(p.establishmentId,qt(),"Equipe","Editou",`Editou o profissional: ${b.name}`),g("Sucesso!","Dados atualizados.","success")):(delete b.id,await ri(b),me(p.establishmentId,qt(),"Equipe","Criou",`Cadastrou o profissional: ${b.name}`),g("Sucesso!","Novo membro adicionado à equipe.","success")),pa(),Ht()}catch(S){g("Erro",S.message,"error"),l.disabled=!1,l.innerHTML=y}break;case"delete-blockage":const v=s.dataset.id;if(await W("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await ja(v),g("Bloqueio removido.","success");const S=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";dt(e.id,S)}catch(S){g("Erro",S.message,"error")}break;case"batch-delete-blockage":const w=JSON.parse(s.dataset.ids);if(await W("Apagar em Lote",`Tem certeza que deseja apagar ${w.length} dias de bloqueio de uma vez?`))try{await os(w),g("Bloqueios removidos.","success");const S=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";dt(e.id,S)}catch(S){g("Erro",S.message,"error")}break}},t.addEventListener("click",Ne)}function Ia(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ce.size>0?(t.textContent=`${ce.size} selecionado(s)`,e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex")))}function fl(){W("Excluir em Lote",`Tem certeza que deseja excluir ${ce.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await ni(Array.from(ce)),me(p.establishmentId,qt(),"Equipe","Excluiu em Lote",`Excluiu ${ce.size} profissionais`),g("Sucesso!",`${ce.size} profissionais foram excluídos.`,"success"),ce.clear(),Ia(),Ht()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ze(){const e=document.getElementById("professionalsList");if(!e)return;if(!p.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=nl();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),s=p.professionals.filter(o=>{const r=o.name.toLowerCase().includes(a),i=t||o.status!=="inactive";return r&&i});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=ll(s)}async function Ht(){ce.clear(),ua.innerHTML=`
        ...
        </section>`,St&&ua.removeEventListener("click",St),St=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),s=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let r={};if(a.dataset.professional)try{r=JSON.parse(a.dataset.professional)}catch(i){console.error("Erro ao fazer parse do professional data:",i);return}dl(r);return}if(s){fl();return}const o=t.target.closest(".professional-checkbox");if(o){const r=o.dataset.id;o.checked?ce.add(r):ce.delete(r),Ze(),Ia();return}},ua.addEventListener("click",St),document.getElementById("profSearchInput").addEventListener("input",Ze),document.getElementById("showInactiveProfToggle").addEventListener("change",Ze);const e=document.getElementById("professionalsList");p.professionals=null,p.services=null,Ze();try{const[t,a,s]=await Promise.all([le(p.establishmentId),Te(p.establishmentId),Qe()]);p.professionals=t,p.services=a,At=s?.matrizes||[],Ze(),Ia()}catch{e.innerHTML='<p class="text-red-500 col-span-full font-bold text-center py-10 bg-red-50 rounded-lg border border-red-100">Erro ao carregar dados do servidor.</p>'}}let k={clients:[],selectedClient:null,activeTab:"profile",filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},showFilters:!1,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},Ls=null;const xl=e=>e?String(e).replace(/\D/g,""):"",hl=e=>{if(!e)return"Nunca";let t;if(typeof e=="object"&&(e.seconds||e._seconds)){const a=e.seconds||e._seconds;t=new Date(a*1e3)}else t=new Date(e);return isNaN(t.getTime())?"Data Inválida":t.toLocaleDateString("pt-BR")};function Ga(){Ls.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=Ll)}function gt(){if(k.modalOpen)return;Ga();const e=document.getElementById("clients-content-area"),t=k.filters.inactiveDays||k.filters.birthMonth||k.filters.hasLoyalty||k.filters.hasDebt,a=`
    ...
    `,s=k.clients.length>0?`
        <div class="px-3 sm:px-4 pb-20 pt-2 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${k.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,m=hl(c.lastVisit);return`
    ...
    `;e.innerHTML=a+s;const o=document.getElementById("client-search"),r=document.getElementById("btn-toggle-filters"),i=document.getElementById("btn-apply-filters"),n=document.getElementById("btn-clear-search");r&&(r.onclick=()=>{k.showFilters=!k.showFilters,gt()});const l=document.getElementById("filter-birth-month");l&&(l.value=k.filters.birthMonth);const d=()=>{const c=document.getElementById("filter-inactive"),u=document.getElementById("filter-loyalty"),m=document.getElementById("filter-debt"),f=document.getElementById("filter-birth-month");k.filters={search:o.value,inactiveDays:c?c.value:"",birthMonth:f?f.value:"",hasLoyalty:u?u.checked:!1,hasDebt:m?m.checked:!1},La()};i&&(i.onclick=d),n&&(n.onclick=()=>{k.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},k.showFilters=!1,La()}),o.addEventListener("keypress",c=>{c.key==="Enter"&&d()}),e.querySelectorAll(".client-card").forEach(c=>{c.onclick=()=>Cs(c.dataset.id)})}function vl(e){const t=`
    ...
    `;let a="";return k.activeTab==="profile"?a=kl(e):k.activeTab==="appointments"?a=Sl():k.activeTab==="history"?a=$l():k.activeTab==="loyalty"&&(a=El(e)),`
    ...
    `}function yl(e,t){if(!document.getElementById("tabs-styles")){const r=document.createElement("style");r.id="tabs-styles",r.textContent=`
        ...
        `,e.appendChild(r)}if(e.querySelectorAll(".tab-btn").forEach(r=>{r.onclick=async()=>{const i=r.dataset.tab;if(k.activeTab===i)return;(i==="appointments"||i==="history")&&(k.historyLimit=20,k.historySearchTerm=""),k.activeTab=i,ze(),i!=="profile"&&!k.historyLoading&&k.historyData.appointments.length===0&&await yo(t.id)}}),k.activeTab==="profile"){const r=e.querySelector("#form-edit-client"),i=e.querySelector("#btn-delete-client");r&&(r.onsubmit=Cl),i&&(i.onclick=Dl)}if(k.activeTab==="loyalty"){const r=e.querySelector("#btn-manual-redeem");r&&(r.onclick=()=>Il(t))}const a=e.querySelector("#history-search-input");if(a){const r=a.value;a.value="",a.focus(),a.value=r,a.addEventListener("input",i=>{k.historySearchTerm=i.target.value,ze()})}const s=e.querySelector("#btn-load-more");s&&(s.onclick=()=>{k.historyLimit+=20,ze(),yo(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(r=>{r.onclick=i=>{Ve(),J("agenda-section",{targetDate:new Date(r.dataset.date),scrollToAppointmentId:r.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(r=>{r.onclick=i=>{Ve(),J("comandas-section",{selectedAppointmentId:r.dataset.id,initialFilter:"finalizadas"})}});const o=e.querySelector("#btn-close-modal");o&&(o.onclick=Ve)}async function ze(){const e=k.selectedClient;if(!e){Ve();return}wl(e)}function wl(e){let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 animate-fade-in",t.innerHTML=`
        ...
        `,t.onclick=s=>{s.target===t&&Ve()},document.body.appendChild(t),document.body.classList.add("overflow-hidden"),k.modalOpen=!0);const a=t.querySelector("#client-modal-content");a.innerHTML=vl(e),yl(a,e)}function Ve(){const e=document.getElementById("client-details-modal-overlay");e&&e.remove(),document.body.classList.remove("overflow-hidden"),k.modalOpen=!1,k.selectedClient=null,gt()}function kl(e){return`
    ...
    `}function Sl(e){let t=k.historyData.appointments||[];if(k.historySearchTerm){const s=k.historySearchTerm.toLowerCase();t=t.filter(o=>o.serviceName&&o.serviceName.toLowerCase().includes(s)||o.professionalName&&o.professionalName.toLowerCase().includes(s))}t.sort((s,o)=>new Date(o.startTime)-new Date(s.startTime));const a=s=>{const o=new Date(s.startTime),r=o.toLocaleDateString("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).replace(".",""),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),n=o<new Date;let l=n?"Concluído":"Agendado",d=n?"bg-gray-200 text-gray-600":"bg-green-100 text-green-700";return s.status==="cancelled"&&(l="Cancelado",d="bg-red-100 text-red-600"),`
            <div class="relative bg-white border rounded-xl p-3 shadow-sm mb-3 flex gap-3 cursor-pointer active:scale-[0.99] transition w-full overflow-hidden"
                ...
                <div class="flex-grow min-w-0 flex flex-col justify-center">
                    <h4 class="font-bold text-gray-800 text-sm truncate">${x(s.serviceName||"Serviço")}</h4>
                    <p class="text-xs text-gray-500 truncate">Prof: ${x(s.professionalName||"N/A")}</p>
                    <div class="mt-1">
    ...
    `}function $l(e){let t=k.historyData.sales||[];if(k.historySearchTerm){const a=k.historySearchTerm.toLowerCase();t=t.filter(s=>s.id.includes(a))}return t.sort((a,s)=>new Date(s.date)-new Date(a.date)),t.length===0&&!k.historySearchTerm?'<div class="text-center py-12 text-gray-400">Nenhum registro financeiro.</div>':`
        <div class="space-y-4 w-full">
            <div class="sticky top-0 bg-gray-50 pt-2 pb-2 z-10 w-full">
                <div class="relative w-full">
                    <input type="text" id="history-search-input" 
    ...
    `}function El(e){const t=k.historyData.loyaltyLog||[];t.sort((s,o)=>new Date(o.date)-new Date(s.date));const a=t.length>0?t.map(s=>{const o=s.type==="redemption";return`
            <div class="flex justify-between items-center py-3 border-b border-gray-100 last:border-0 w-full">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-700">${x(s.description||(o?"Resgate":"Acúmulo"))}</p>
    ...
    `}async function La(){k.loading=!0,Ga();try{let e=`/api/clients/${p.establishmentId}?limit=20`;k.filters.search&&(e+=`&search=${encodeURIComponent(k.filters.search)}`),k.filters.inactiveDays&&(e+=`&inactiveDays=${k.filters.inactiveDays}`),k.filters.hasLoyalty&&(e+="&hasLoyalty=true"),k.filters.hasDebt&&(e+="&hasDebt=true"),k.clients=await E(e),gt()}catch(e){console.error(e),g("Erro","Falha ao carregar clientes.","error"),k.clients=[],gt()}finally{k.loading=!1;const e=document.querySelector(".loader");e&&e.parentElement&&e.parentElement.remove()}}async function yo(e){const t=k.selectedClient;if(!(!t||!t.phone)){k.historyLoading=!0;try{const a=new Date;a.setMonth(a.getMonth()+12);const s=new Date;s.setFullYear(s.getFullYear()-5);let o=`/api/appointments/${p.establishmentId}?startDate=${s.toISOString()}&endDate=${a.toISOString()}`;o+=`&clientPhone=${encodeURIComponent(xl(t.phone))}`,o+=`&limit=${k.historyLimit}`;const r=await E(o);k.historyData.appointments=r,k.historyData.sales=r.filter(n=>n.status==="completed").map(n=>({id:n.id,date:n.startTime,totalAmount:n.totalAmount||0,items:n.comandaItems||n.services||[]}));const i=[];r.forEach(n=>{n.status==="completed"&&n.loyaltyPointsEarned>0&&i.push({type:"earn",points:n.loyaltyPointsEarned,date:n.startTime,description:"Venda finalizada"}),n.loyaltyRedemption&&i.push({type:"redemption",points:n.loyaltyRedemption.cost||0,date:n.startTime,description:`Resgate: ${n.loyaltyRedemption.name}`})}),k.historyData.loyaltyLog=i}catch(a){console.error("Erro ao buscar histórico",a)}finally{k.historyLoading=!1,k.modalOpen&&k.selectedClient&&ze()}}}function Il(e){const t=e.loyaltyPoints||0,a=`
    ...
    `,{modalElement:s,close:o}=re({title:"Ajuste de Pontos",contentHTML:a,maxWidth:"w-[90%] max-w-xs"});s.querySelector("form").onsubmit=async r=>{r.preventDefault();const i=document.getElementById("redeem-action").value,n=parseInt(document.getElementById("redeem-points").value,10),l=document.getElementById("redeem-reason").value;if(!n||n<=0)return g("Erro","Qtd inválida.","error");if(i==="debit"&&n>t)return g("Erro","Saldo insuficiente.","error");try{let d=t;i==="debit"?(await Jr(p.establishmentId,e.phone,n,l),d-=n):(d+=n,await es(e.id,{loyaltyPoints:d})),k.selectedClient.loyaltyPoints=d,k.historyData.loyaltyLog.unshift({type:i==="debit"?"redemption":"earn",points:n,date:new Date().toISOString(),description:l+" (Manual)"}),g("Sucesso","Saldo atualizado.","success"),o(),ze()}catch(d){g("Erro",d.message,"error")}}}function Cs(e){k.selectedClient=k.clients.find(t=>t.id===e),k.activeTab="profile",k.historyLimit=20,k.historySearchTerm="",k.historyData={appointments:[],sales:[],loyaltyLog:[]},ze()}function Ll(){const e=`
    ...
    `,{modalElement:t,close:a}=re({title:"Novo Cliente",contentHTML:e,maxWidth:"w-[90%] max-w-sm"});t.querySelector("form").onsubmit=async s=>{s.preventDefault();const o=document.getElementById("new-name").value,r=document.getElementById("new-phone").value;try{const i=await Ko({establishmentId:p.establishmentId,name:o,phone:r});k.clients.unshift(i),g("Sucesso","Cliente criado!","success"),a(),Cs(i.id)}catch(i){g("Erro",i.message,"error")}}}async function Cl(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());a.establishmentId=p.establishmentId;try{await es(k.selectedClient.id,a),Object.assign(k.selectedClient,a);const s=k.clients.findIndex(o=>o.id===k.selectedClient.id);s!==-1&&(k.clients[s]=k.selectedClient),g("Sucesso","Dados salvos!","success")}catch(s){g("Erro",s.message,"error")}}async function Dl(){if(await W("Excluir Cliente","Tem certeza? O histórico será apagado."))try{await Wr(k.selectedClient.id),k.clients=k.clients.filter(e=>e.id!==k.selectedClient.id),k.selectedClient=null,g("Sucesso","Cliente removido.","success"),Ve(),gt()}catch(e){g("Erro",e.message,"error")}}async function Tl(){Ls=document.getElementById("content"),k.selectedClient=null,k.searchTerm="",k.historyLimit=20,k.showFilters=!1,k.modalOpen=!1,k.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},Ga(),await La()}const Ee=document.getElementById("content"),ma={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},Bl={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};let U=null,G=null;function Ds(){return[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais da Unidade"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"whatsapp-bot",icon:"M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z",label:"Atendente Virtual (WhatsApp)"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"},{id:"support",icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",label:"Suporte e Ajuda"},{id:"cancellation",icon:"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z",label:"Cancelar Assinatura"}]}function wo(e,t,a){return new Promise((s,o)=>{const r=new FileReader;r.readAsDataURL(e),r.onload=i=>{const n=new Image;n.src=i.target.result,n.onload=()=>{const l=document.createElement("canvas");let d=n.width,c=n.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(n,0,0,d,c);const m=e.type==="image/png"&&t<500?"image/png":"image/jpeg";s(l.toDataURL(m,a))},n.onerror=l=>o(l)},r.onerror=i=>o(i)})}function Ae(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const s=i=>{const n=new Map,l=[];return i&&(i.forEach(d=>n.set(d.id,{...d,children:[]})),n.forEach(d=>{d.parentId&&n.has(d.parentId)?n.get(d.parentId).children.push(d):l.push(d)})),l},o=(i,n="")=>{const l=i.id===t?"selected":"";a+=`<option value="${i.id}" ${l}>${n}${x(i.name)}</option>`,i.children.forEach(d=>o(d,n+"— "))};return s(e).forEach(i=>o(i)),a}async function Xe(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const s=[],{ownerName:o,...r}=e;if(o&&o!==p.userName){const n=ne.currentUser;n&&s.push(Ws(n,{displayName:o}).then(()=>{p.userName=o}))}const i={...U,...r};s.push(qa(G,i)),await Promise.all(s),U=i,g("Sucesso","Definições salvas com sucesso!","success"),r.themeColor&&G===p.establishmentId&&setTimeout(()=>window.location.reload(),1500)}catch(s){g("Erro",`Não foi possível salvar: ${s.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function Pl(e,t){const a=x(e.name||""),s=x(e.phone||""),o=x(e.cnpj||""),r=x(e.email||""),i=x(e.address||""),n=x(e.website||""),l=x(p.userName||"");t.innerHTML=`
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#newEmail").value,o=t.querySelector("#currentPassword").value,r=t.querySelector('button[form="change-email-form"]');r.disabled=!0,r.textContent="A verificar...";try{const i=ne.currentUser,n=zs.credential(i.email,o);await Vs(i,n),await _s(i,s),await $r(G,s),g("Sucesso","Link de verificação enviado! Verifique o seu novo e-mail.","success"),a.target.reset()}catch(i){g("Erro",i.message,"error")}finally{r.disabled=!1,r.textContent="Salvar Novo E-mail"}})}function ql(e,t){const a=x(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");e.timezone&&(a.value=e.timezone);const s=t.querySelector("#establishmentWorkingHoursContainer"),o=e.workingHours||{};Object.keys(ma).forEach(r=>{const i=o[r]||{},n=ma[r],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",r=>{const i=r.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),t.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const i={};Object.keys(ma).forEach(l=>{i[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const n=t.querySelector("#establishmentTimezone").value;Xe({workingHours:i,timezone:n},r)})}function Ts(e,t){const a=!!e.whatsappInstance;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;const n=t.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const c=document.createElement("div");c.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const u=d.type||"money",m=d.itemId||"",f=d.reward||"",b=d.discount||"",y=d.points||d.costPoints||"";c.innerHTML=`
            <div>
        ...
        `;const v=c.querySelector(".type-select"),w=c.querySelector(".item-select"),S=c.querySelector(".desc-input"),I=c.querySelector(".discount-input"),D=L=>{w.innerHTML='<option value="">Selecione...</option>';let q=[];L==="service"?q=o:L==="product"?q=r:L==="package"&&(q=i),q.forEach(O=>{const B=O.id===m,M=O.name||O.title||"Sem nome",R=O.price||O.salePrice||0;w.innerHTML+=`<option value="${O.id}" data-price="${R}" ${B?"selected":""}>${x(M)}</option>`})};return u!=="money"&&D(u),v.addEventListener("change",L=>{const q=L.target.value;q==="money"?(w.classList.add("hidden"),S.classList.remove("hidden"),S.value="",I.value=""):(w.classList.remove("hidden"),S.classList.add("hidden"),D(q),I.value="")}),w.addEventListener("change",L=>{const q=L.target.selectedOptions[0];if(q&&q.value){S.value=q.text;const O=q.dataset.price;O&&(I.value=parseFloat(O).toFixed(2))}}),c};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),t.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const c=d.target.closest(".remove-loyalty-tier");c&&c.closest(".loyalty-tier-row").remove()}),t.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const c=Array.from(t.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(m=>{const f=m.querySelector(".type-select").value,b=f==="money"?null:m.querySelector(".item-select").value;let y=f==="money"?m.querySelector(".desc-input").value:m.querySelector(".item-select").options[m.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(m.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(m.querySelector('input[data-field="points"]').value,10)||0,type:f,itemId:b,reward:y,name:y,discount:parseFloat(m.querySelector('input[data-field="discount"]').value)||0}}),u={loyaltyProgram:{enabled:t.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(t.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:c.filter(m=>m.points>0&&m.reward)}};Xe(u,d)})}async function Fl(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([ra(G),za(G)]),o=e.financialIntegration||{},r=e.commissionConfig||{},i=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ae(a,o.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ae(s,o.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ae(a,i.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ae(s,i.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ae(a,r.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ae(s,r.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar o plano de contas da unidade.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Xe(s,a)})}function Hl(e,t){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${e.name}).`;t.innerHTML=`
    ...
    `}function Ol(e,t){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${e.name})`;t.innerHTML=`
    ...
    `}function Bs(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(Bl).forEach(([o,r])=>{const i=o===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
    ...
    `,Ee.querySelector('button[data-action="back-to-menu"]').addEventListener("click",o=>{o.preventDefault(),Ps({id:G})});const s=document.getElementById("settings-content-detail");switch(e){case"personal-data":Pl(U,s);break;case"change-password":Ml(U,s);break;case"change-email":Al(U,s);break;case"branding":ql(U,s);break;case"booking":Rl(U,s);break;case"working-hours":jl(U,s);break;case"whatsapp-bot":Ts(U,s);break;case"loyalty":await Nl(U,s);break;case"financial":await Fl(U,s);break;case"support":Hl(U,s);break;case"cancellation":Ol(U,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Ps(e={}){Ee.innerHTML=`
    ...
    `;try{G=e.id||p.establishmentId,U=await Ce(G);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
               ...
               </button>`:"",a=U.isMatriz||!U.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=Ds();Ee.innerHTML=`
            <div class="max-w-5xl mx-auto w-full pb-20">
                ...
                <div class="bg-gradient-to-r from-indigo-900 to-indigo-700 rounded-xl shadow-lg p-6 mb-8 text-white flex justify-between items-center relative overflow-hidden">
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-1">${x(U.name)} ${a}</h3>
                        <p class="text-indigo-200 text-sm flex items-center gap-2"><i class="bi bi-geo-alt"></i> ${x(U.address||"Morada não definida")}</p>
                    </div>
        ...
        `,Ee.querySelectorAll("div[data-section]").forEach(o=>{o.addEventListener("click",r=>{Vl(o.dataset.section)})}),Ee.querySelectorAll(".module-toggle").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.module;try{const n={...(await Ce(G)).modules,[r]:o.checked};await qa(G,{modules:n}),g("Módulos","Módulos atualizados com sucesso.","success")}catch(i){o.checked=!o.checked,g("Erro",i.message,"error")}})})}catch(t){Ee.innerHTML=`
        ...
        `}}function _l(e){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `).join("")}const ct=document.getElementById("content");async function _e(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,o=await Zt(p.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),r=document.getElementById("filterReason")?.value.toLowerCase(),i=r?o.filter(l=>l.reason&&l.reason.toLowerCase().includes(r)):o,n=i.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",i.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let m=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${x(l)} (${d.length})</h4>`;if(d.length>1){const f=JSON.stringify(d.map(b=>b.id));m+=`<button data-action="batch-delete-blockage" data-ids='${f}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}m+="</div>",c.innerHTML=m,d.forEach(f=>{const b=new Date(f.startTime),y=new Date(f.endTime),v=b.toLocaleDateString("pt-BR"),w=y.toLocaleDateString("pt-BR"),I=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${v===w?`${v} | ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${y.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${v} às ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${w} às ${y.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;c.innerHTML+=I}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Ul(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,o=t.querySelector("#blockageEndDate").value||s,r=t.querySelector("#blockageStartTime").value,i=t.querySelector("#blockageEndTime").value,n={establishmentId:p.establishmentId,professionalId:a,startTime:new Date(`${s}T${r}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Kt(n),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),_e(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Wl(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,o=t.querySelector("#batchBlockageEndDate").value||s,r=t.querySelector("#batchBlockageStartTime").value,i=t.querySelector("#batchBlockageEndTime").value,n=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:p.establishmentId,professionalId:c,startTime:new Date(`${s}T${r}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:n};return Kt(u)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&_e(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Jl(e){ct.addEventListener("submit",t=>{t.target.id==="blockageForm"&&Ul(t),t.target.id==="batchBlockageForm"&&Wl(t)}),ct.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&_e(e)}),ct.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")J("profissionais-section");else if(s==="delete-blockage"){if(await W("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await ja(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),_e(e)}catch(r){g("Erro",`Não foi possível remover o bloqueio: ${r.message}`,"error")}}else if(s==="batch-delete-blockage"){const o=JSON.parse(a.dataset.ids);if(await W("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await os(o),g("Sucesso",`${o.length} bloqueios removidos.`,"success"),_e(e)}catch(i){g("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function Gl(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){ct.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=x(a);ct.innerHTML=`
        <section>
        ...
        </section>`,Jl(t),await _e(t);const o=document.getElementById("batchProfSelectionContainer");try{const r=await le(p.establishmentId);o.innerHTML=r.map(i=>`
            <div class="flex items-center">
    ...
    `}).join("")}function Ca(){const t=document.getElementById("showInactiveUsersToggle")?.checked?p.users:p.users.filter(a=>a.status==="active");sd(t)}function rd(e={}){return Object.entries(td).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",o=e[t]?.view_all_prof===!0,r=Object.entries(ad).map(([n,l])=>`
    ...
    `}).join("")}function ko(e){if(!Ue||p.userRole==="professional")return"";const t=e?.accessibleEstablishments?.map(r=>r.id)||[],a=e?.accessibleCompanies?.map(r=>r.id)||[];if((e?.role||"professional")==="group_admin")return'<div class="p-3 bg-purple-50 border border-purple-200 rounded-lg text-purple-800 text-sm font-bold">Acesso Total (Global) liberado.</div>';let o='<div class="space-y-3 max-h-48 overflow-y-auto custom-scrollbar p-2 bg-gray-50 rounded border">';return Ue.companies.forEach(r=>{const i=a.includes(r.id),n=Ue.branches.filter(l=>l.companyId===r.id);o+=`
        ...
        `}),o+="</div>",o}async function So(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=p.professionals;if(!a||a.length===0)try{a=await le(p.currentViewContext.id),p.professionals=a}catch{console.warn("Profissionais não carregados")}if(["group_admin","company_admin"].includes(p.userRole)&&!Ue)try{const d=await fetch("/api/establishments/hierarchy",{headers:{Authorization:`Bearer ${await p.getAuthToken?.()||""}`}});d.ok&&(Ue=await d.json())}catch(d){console.error("Falha ao buscar hierarquia",d),Ue={companies:[],branches:[]}}const s=d=>a?.find(c=>c.id===d),o=e?.professionalId;s(o);const r=e!==null;t.querySelector("#userFormTitle").textContent=r?`Editar: ${e.name}`:"Novo Usuário";const i=t.querySelector("#userForm");i.innerHTML=`
    ...
    `;const n=i.querySelector("#userRole"),l=i.querySelector("#hierarchySelectorContainer");if(n&&l){n.addEventListener("change",c=>{const u={...e,role:c.target.value};l.innerHTML=ko(u),d()});const d=()=>{l.querySelectorAll(".company-checkbox").forEach(c=>{c.addEventListener("change",u=>{u.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(b=>b.checked=u.target.checked)})})};d()}if(i.addEventListener("submit",async d=>{d.preventDefault();const c={};i.querySelectorAll("input[data-module]").forEach(v=>{const w=v.dataset.module,S=v.dataset.permission;c[w]||(c[w]={}),c[w][S]=v.checked});const u=i.querySelector("#userProfessionalId").value||null,m=i.querySelector("#userRole")?.value||"professional",f=[],b=[];if(m!=="group_admin"&&i.querySelector(".company-checkbox")&&(i.querySelectorAll(".company-checkbox:checked").forEach(v=>{f.push({id:v.value,name:v.dataset.name})}),i.querySelectorAll(".branch-checkbox:checked").forEach(v=>{b.push({id:v.value,name:v.dataset.name,companyId:v.dataset.companyId})}),b.length===0))return g("Atenção","Você deve selecionar pelo menos uma filial para este usuário.","error");const y={name:i.querySelector("#userName").value,permissions:c,professionalId:u,role:m,accessibleCompanies:f,accessibleEstablishments:b};try{if(r){const v=i.querySelector("#userEmail").value;e?.email!==v&&(y.email=v),await Xl(e.id,y),g("Usuário atualizado com sucesso!","success")}else y.email=i.querySelector("#userEmail").value,y.password=i.querySelector("#userPassword").value,await Ql(y),g("Usuário criado com sucesso!","success");Ot()}catch(v){g(`Erro: ${v.message}`,"error")}}),r){const d=i.querySelector('[data-action="show-password-form"]'),c=i.querySelector("#password-form");d&&c&&(d.addEventListener("click",()=>{d.classList.add("hidden"),c.classList.remove("hidden")}),c.querySelector('[data-action="cancel-password-change"]').addEventListener("click",()=>{d.classList.remove("hidden"),c.classList.add("hidden"),c.querySelector("#userNewPassword").value=""}),c.querySelector('[data-action="save-password"]').addEventListener("click",async u=>{const m=u.target,f=c.querySelector("#userNewPassword").value;if(!f||f.length<6)return g("Aviso","Senha deve ter no mínimo 6 caracteres.","error");if(await W("Alterar Senha","Tem certeza?"))try{m.disabled=!0,m.textContent="...",await Kl(e.id,f),g("Sucesso","Senha alterada.","success"),d.classList.remove("hidden"),c.classList.add("hidden")}catch(b){g("Erro",b.message,"error")}finally{m.disabled=!1,m.textContent="Salvar Senha"}}))}}async function id(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([Yl(p.currentViewContext.id),le(p.currentViewContext.id)]);p.users=t,p.professionals=a,Ca()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Falha ao carregar.</p>'}}async function Ot(){Ke.innerHTML=`
        <style>
    ...
    `,$t&&Ke.removeEventListener("click",$t),Et&&Ke.removeEventListener("change",Et),$t=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":So();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));So(s);break;case"back-to-list":Ot();break;case"delete-user":{if(e.stopPropagation(),await W("Excluir Usuário","Tem certeza? Ação irreversível."))try{await Zl(t.dataset.userId),g("Usuário excluído!","success"),Ot()}catch(o){g(`Erro: ${o.message}`,"error")}break}}},Et=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Ca();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await ed(a,s);const o=p.users.findIndex(r=>r.id===a);o>-1&&(p.users[o].status=s,Ca())}catch(o){g(`Erro: ${o.message}`,"error"),t.checked=!t.checked}}},Ke.addEventListener("click",$t),Ke.addEventListener("change",Et),await id()}const nd=document.getElementById("content");let $o={},Da=null;function ld(){Object.values($o).forEach(e=>e?.destroy()),$o={}}function dd(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const i=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,r),s.autoTable({html:`#${t}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Eo(e){const t=document.getElementById("genericModal"),a=x(e.client),s=x(e.items),o=x(e.responsavelCaixa||"N/A"),r=(e.payments||[]).map(i=>`
    ...
    `,t.style.display="flex"}function cd(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),o=Object.entries(t.paymentMethodTotals).sort(([,n],[,l])=>l-n);s.innerHTML=o.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),r.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=Da.transactions[l];d&&Eo(d)})}),i.innerHTML=a.map((n,l)=>{const d=x(n.client),c=x(n.items),u=x(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=Da.transactions[l];d&&Eo(d)})})}async function Io(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,o=a.value;if(!s||!o)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,i=await _r({establishmentId:p.establishmentId,startDate:s,endDate:o,cashierSessionId:r});Da=i,e.innerHTML=`
        ...
        `,cd(i)}catch(r){g("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${x(r.message)}</p>`}}async function ud(){ld();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];nd.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Io),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${s}_a_${o}`;dd(r,"transactionsTable")});try{const s=await Mi(p.establishmentId),o=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(r=>{const i=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=x(r.closedByName||"N/A");o.innerHTML+=`<option value="${r.id}">${n} - ${i}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Io()}const pd=document.getElementById("content");let $={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1},It=null,Lt=null;function Ya(e){const t=new Map,a=[];return e&&(e.forEach(s=>t.set(s.id,{...s,children:[]})),t.forEach(s=>{s.parentId&&t.has(s.parentId)?t.get(s.parentId).children.push(s):a.push(s)})),a}function Ms(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,s]=e.split("-"),o=new Date(t,a-1,s),r=String(o.getDate()).padStart(2,"0"),i=o.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:r,month:i,full:o.toLocaleDateString("pt-BR")}}function ue(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function zt(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,o,r]=e.split("-");return new Date(s,o-1,r)<a}function md(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const s=(o,r=0)=>`
        ...
        `;e.innerHTML=t.map(o=>s(o)).join("")}async function Ta(e){const t=document.getElementById("genericModal"),a=e==="nature",s=a?"Plano de Contas (Naturezas)":"Centros de Custo",o=a?ra:za,r=a?on:rn,i=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const m=Ya(u);md(n,m,e);const f=l.value;l.innerHTML='<option value="">-- Nível Principal --</option>';const b=(y,v=0)=>{const w="  ".repeat(v)+(v>0?"↳ ":"");l.innerHTML+=`<option value="${y.id}">${w}${y.name}</option>`,y.children.forEach(S=>b(S,v+1))};m.forEach(y=>b(y)),l.value=f};try{const u=await o(p.establishmentId);$[i]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const m=t.querySelector("#itemName").value,f=l.value;try{await r({name:m,parentId:f||null,establishmentId:p.establishmentId});const b=await o(p.establishmentId);$[i]=b,d(b),c.reset(),await De(),g("Sucesso","Item adicionado ao plano de contas.","success")}catch(b){g("Erro",b.message,"error")}})}async function gd(){try{const t=(await Qe()).matrizes||[];$.establishments=[],t.forEach(a=>{$.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>$.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(p.establishmentId)}catch(e){console.warn("Erro ao buscar lojas",e)}As(),qs(),await De()}function As(){const e=$.establishments.map(t=>`
    ...
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-100","text-indigo-700"),Rs()}function qs(){const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",s=>{const o=s.target.checked,r=document.querySelectorAll(".item-checkbox");$.selectedIds.clear(),r.forEach(i=>{i.checked=o,o&&$.selectedIds.add(i.dataset.id)}),Fe()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{$.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(s=>s.checked=!1),Fe()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const s=$.selectedIds.size;if(s===0)return;if(await W("Excluir Lançamentos",`Deseja realmente apagar ${s} registros financeiros?`))try{const r=$.currentTab==="payables"?"payables":"receivables";await gs(r,Array.from($.selectedIds)),g("Sucesso",`${s} itens excluídos.`,"success"),$.selectedIds.clear(),Fe(),De()}catch{g("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(s=>{s.addEventListener("change",o=>{const r=o.target.closest("label");o.target.checked?($.filterEstablishmentIds.add(o.target.value),r.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.remove("border-gray-200","text-gray-600")):($.filterEstablishmentIds.delete(o.target.value),r.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.add("border-gray-200","text-gray-600"))})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const s=document.getElementById("filter-panel"),o=document.getElementById("toggle-filter-btn");$.isAdvancedFilterOpen=!$.isAdvancedFilterOpen,$.isAdvancedFilterOpen?(s.classList.remove("hidden"),o.classList.add("bg-indigo-50","text-indigo-700","border-indigo-300")):(s.classList.add("hidden"),o.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-300"))}),document.getElementById("settings-btn").addEventListener("click",vd),document.querySelectorAll('[data-action="new-financial"]').forEach(s=>{s.addEventListener("click",o=>{ga(o.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const s=$.currentTab==="payables"?"payable":"receivable";ga(s)});const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t.addEventListener("click",()=>Lo("receivables")),a.addEventListener("click",()=>Lo("payables")),document.querySelectorAll(".status-filter-btn").forEach(s=>{s.addEventListener("click",o=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-gray-800","text-white","shadow-sm"),r.classList.add("bg-gray-100","text-gray-600")}),o.target.classList.add("bg-gray-800","text-white","shadow-sm"),o.target.classList.remove("bg-gray-100","text-gray-600","hover:bg-gray-200","hover:bg-red-100"),$.statusFilter=o.target.dataset.status,Vt(),js()})}),document.querySelectorAll(".date-preset-btn").forEach(s=>{s.addEventListener("click",o=>{document.querySelectorAll(".date-preset-btn").forEach(d=>d.classList.remove("bg-indigo-100","text-indigo-700")),o.target.classList.add("bg-indigo-100","text-indigo-700");const r=o.target.dataset.preset,i=new Date;let n,l;r==="month"?(n=new Date(i.getFullYear(),i.getMonth(),1),l=new Date(i.getFullYear(),i.getMonth()+1,0)):r==="last_month"?(n=new Date(i.getFullYear(),i.getMonth()-1,1),l=new Date(i.getFullYear(),i.getMonth(),0)):r==="year"&&(n=new Date(i.getFullYear(),0,1),l=new Date(i.getFullYear(),11,31)),document.getElementById("filterStartDate").value=n.toISOString().split("T")[0],document.getElementById("filterEndDate").value=l.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",s=>{$.searchQuery=s.target.value.toLowerCase(),Vt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const s=new Date;document.getElementById("filterStartDate").value=new Date(s.getFullYear(),s.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(s.getFullYear(),s.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",$.filterEstablishmentIds.clear(),$.filterEstablishmentIds.add(p.establishmentId),As(),qs()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{$.startDate=document.getElementById("filterStartDate").value,$.endDate=document.getElementById("filterEndDate").value,$.filterNaturezaId=document.getElementById("filterNaturezaId").value,$.filterCostCenterId=document.getElementById("filterCostCenterId").value,$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(p.establishmentId),document.getElementById("toggle-filter-btn").click(),De()}),It&&document.body.removeEventListener("click",It),It=s=>{const o=s.target;if(o.classList.contains("item-checkbox")||o.classList.contains("modal-item-checkbox")){const n=o.value||o.dataset.id;o.checked?$.selectedIds.add(n):$.selectedIds.delete(n),Fe(),s.stopPropagation();return}const r=o.closest("button[data-action]");if(r){const{action:n,type:l,id:d}=r.dataset;if(s.stopPropagation(),n==="delete"){const c=r.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");fd(l,JSON.parse(c));return}if(n==="mark-as-paid"){bd(l,d);return}if(n==="manage-natures"){Ta("nature");return}if(n==="manage-cost-centers"){Ta("cost-center");return}}const i=o.closest(".financial-row");if(i&&document.getElementById("list-container").contains(i)&&!o.closest("button")&&!o.closest(".item-checkbox")){const{type:n}=i.dataset,l=JSON.parse(i.dataset.item.replace(/&apos;/g,"'"));ga(n,l)}},document.body.addEventListener("click",It),Lt&&document.getElementById("genericModal").removeEventListener("click",Lt),Lt=s=>{if(s.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const r=s.target.closest('button[data-action^="delete-"]');if(r){const i=r.dataset.action.split("-")[1];hd(i,r.dataset.id)}},document.getElementById("genericModal").addEventListener("click",Lt)}function Fe(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),s=$.selectedIds.size;t.textContent=s,s>0?(e.classList.remove("hidden"),e.classList.add("flex"),a&&a.classList.add("hidden")):(e.classList.add("hidden"),e.classList.remove("flex"),a&&a.classList.remove("hidden"))}function Lo(e){$.currentTab=e,$.selectedIds.clear(),Fe(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),s=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-emerald-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),s&&(s.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-emerald-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-emerald-700","shadow-sm"),t.classList.add("text-gray-500"),s&&(s.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")),Vt()}async function De(){const e=document.getElementById("list-container");e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A processar transações...</p></div>';try{if($.natures.length===0){const[r,i]=await Promise.all([ra(p.establishmentId),za(p.establishmentId)]);$.natures=r,$.costCenters=i,Rs()}const t=Array.from($.filterEstablishmentIds).join(","),a={startDate:$.startDate,endDate:$.endDate,establishmentId:t};$.filterNaturezaId!=="all"&&(a.natureId=$.filterNaturezaId),$.filterCostCenterId!=="all"&&(a.costCenterId=$.filterCostCenterId);const[s,o]=await Promise.all([fs(a),xs(a)]);$.payables=s.entries||[],$.receivables=o.entries||[],js(),Vt()}catch(t){e.innerHTML=`
            ...
            </div>`}}function Rs(){const e=s=>{let o='<option value="all">-- Todas as opções --</option>';const r=Ya(s),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");o+=`<option value="${n.id}">${d}${n.name}</option>`,n.children.forEach(c=>i(c,l+1))};return r.forEach(n=>i(n)),o},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e($.natures)),a&&(a.innerHTML=e($.costCenters))}function js(){const e=document.getElementById("summary-section");if(!e)return;const t=$.currentTab==="receivables";let s=t?$.receivables:$.payables;$.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes($.searchQuery)||c.entity&&c.entity.toLowerCase().includes($.searchQuery)||c.notes&&c.notes.toLowerCase().includes($.searchQuery)));const o=s.reduce((c,u)=>c+u.amount,0),r=s.filter(c=>c.status==="paid").reduce((c,u)=>c+u.amount,0),i=s.filter(c=>c.status==="pending"&&!zt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),n=s.filter(c=>zt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),l=t?"emerald":"red",d=t?"Receitas":"Despesas";e.innerHTML=`
        ...
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
            ...
            <p class="text-xl font-bold text-${l}-600">${ue(r)}</p>
        </div>
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
    ...
    `}function Vt(){const e=document.getElementById("list-container");if(!e)return;const t=$.currentTab==="receivables",a=t?$.receivables:$.payables;let s=a;if($.statusFilter!=="all"&&(s=a.filter(l=>{const d=zt(l.dueDate,l.status);return $.statusFilter==="overdue"?d:$.statusFilter==="pending"?l.status==="pending"&&!d:l.status===$.statusFilter})),$.searchQuery&&(s=s.filter(l=>l.description&&l.description.toLowerCase().includes($.searchQuery)||l.entity&&l.entity.toLowerCase().includes($.searchQuery)||l.notes&&l.notes.toLowerCase().includes($.searchQuery))),s.sort((l,d)=>new Date(l.dueDate)-new Date(d.dueDate)),s.length===0){e.innerHTML=`
        ...
        `;return}const o=new Map($.natures.map(l=>[l.id,l.name])),r=new Map($.establishments.map(l=>[l.id,l])),i=t?"receivable":"payable",n=t?"text-emerald-600":"text-red-600";e.innerHTML=s.map(l=>{const d=Ms(l.dueDate),c=l.status==="paid",u=zt(l.dueDate,l.status);let m="";c?m='<span class="bg-gray-100 text-gray-600 border border-gray-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-check2-circle mr-1"></i>Baixado</span>':u?m='<span class="bg-red-50 text-red-600 border border-red-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-exclamation-circle mr-1"></i>Atrasado</span>':m='<span class="bg-blue-50 text-blue-600 border border-blue-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-clock-history mr-1"></i>A Vencer</span>';const f=l.naturezaId?o.get(l.naturezaId)||"Não Categorizado":"Geral",b=r.get(l.establishmentId);let y="";if(b){const L=b.type==="Matriz"?"bi-building":"bi-shop";y=`<span class="text-[9px] px-1.5 py-0.5 rounded bg-slate-100 text-slate-600 font-bold border border-slate-200 flex items-center whitespace-nowrap w-max" title="Unidade: ${b.name}"><i class="bi ${L} mr-1 opacity-60"></i> ${b.name}</span>`}else y='<span class="text-[9px] px-1.5 py-0.5 rounded bg-gray-100 text-gray-600 font-bold border border-gray-200 flex items-center whitespace-nowrap w-max"><i class="bi bi-geo-alt mr-1 opacity-60"></i> Atual</span>';const v=JSON.stringify(l).replace(/'/g,"&apos;"),w=$.selectedIds.has(l.id),I=!!l.recurrenceId?'<i class="bi bi-arrow-repeat text-indigo-400 ml-1.5 text-xs" title="Lançamento Recorrente"></i>':"",D=l.entity?`<span class="text-xs text-gray-500 font-medium truncate block"><i class="bi bi-person mr-1 opacity-50"></i>${l.entity}</span>`:"";return`
        <div class="financial-row md:grid md:grid-cols-12 md:gap-4 md:items-center bg-white p-4 md:p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer relative group flex flex-col gap-3 ${w?"bg-indigo-50/30":""}"
            ...
            <div class="md:col-span-4 hidden md:flex flex-col justify-center">
                ...
                <div class="flex items-center gap-2 mt-1">
                    ...
                    <p class="text-[10px] text-gray-500 flex items-center font-medium">
                        <i class="bi bi-tag mr-1 opacity-50"></i> ${f} ${I}
                    </p>
                </div>
            </div>
            ...
            <div class="md:hidden flex flex-wrap items-center gap-2 mt-1">
                ...
                <span class="text-[10px] px-2 py-1 rounded bg-gray-100 text-gray-600 font-bold border border-gray-200 flex items-center">
                    <i class="bi bi-tag mr-1.5 opacity-50"></i> ${f} ${I}
                </span>
            </div>
        ...
        `}).join("")}async function bd(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?un(t,a):bn(t,a)),g("Baixa Realizada","O lançamento foi registado como pago.","success"),await De()}catch(s){g("Erro",s.message,"error")}}async function fd(e,t){if(!!!t.recurrenceId){await W("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Ns(e,[t.id]);return}xd(e,t)}function xd(e,t){const a=document.getElementById("genericModal"),o=(e==="payable"?$.payables:$.receivables).filter(d=>d.recurrenceId===t.recurrenceId).sort((d,c)=>new Date(d.dueDate)-new Date(c.dueDate));a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${o.map(d=>{const c=d.id===t.id,u=d.status==="paid",m=Ms(d.dueDate);return`
    ...
    `,a.style.display="flex";const r=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");r.addEventListener("change",d=>{i.forEach(c=>c.checked=d.target.checked),l()}),i.forEach(d=>d.addEventListener("change",l));function l(){const d=Array.from(i).filter(c=>c.checked).length;n.innerHTML=d>0?`<i class="bi bi-trash3"></i> Excluir ${d} Parcela(s)`:"Selecione para excluir",n.disabled=d===0,d===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const d=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(d.length===0)return;a.style.display="none",await W("Confirmar Ação",`Tem certeza que deseja apagar estas ${d.length} parcelas permanentemente?`)&&await Ns(e,d)}),l()}async function Ns(e,t){try{t.length===1?e==="payable"?await cn(t[0]):await gn(t[0]):await gs(e==="payable"?"payables":"receivables",t),g("Sucesso",`${t.length} registo(s) limpo(s) do sistema.`,"success"),$.selectedIds.clear(),Fe(),await De()}catch(a){g("Erro",a.message,"error")}}async function hd(e,t){const s=e==="nature"?sn:nn;if(await W("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await s(t),Ta(e==="nature"?"nature":"cost-center")}catch(r){g("Erro",r.message,"error")}}function vd(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ga(e,t=null){const a=document.getElementById("genericModal"),s=e==="payable",o=s?"red":"emerald",r=t?"Editar Lançamento":"Novo Lançamento",i=$.establishments.map(L=>{const q=t?t.establishmentId===L.id:L.id===p.establishmentId;return`<option value="${L.id}" ${q?"selected":""}>${L.type==="Matriz"?"🏢":"📍"} ${L.name}</option>`}).join(""),n=(L,q)=>{let O='<option value="">-- Selecione --</option>';const B=Ya(L),M=(R,H=0)=>{const z="  ".repeat(H)+(H>0?"↳ ":""),j=R.id===q?"selected":"";O+=`<option value="${R.id}" ${j}>${z}${R.name}</option>`,R.children.forEach(C=>M(C,H+1))};return B.forEach(R=>M(R)),O},d=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(L=>`<option value="${L.value}" ${t?.paymentMethod===L.value?"selected":""}>${L.label}</option>`).join("");a.innerHTML=`
        ...
        </div>`,a.style.display="flex";const c=a.querySelector("#financial-form");let u="single",m=2;const f=c.querySelector('[name="amount"]'),b=c.querySelector("#recurrence-options"),y=c.querySelector("#recurrence-summary"),v=c.querySelector("#installments-input"),w=c.querySelector("#status-toggle"),S=c.querySelector("#payment-date-wrapper"),I=c.querySelector('[name="paymentDate"]'),D=()=>{if(u==="single")return;const L=parseFloat(f.value)||0;if(m=parseInt(v.value)||2,L===0){y.innerHTML='<span class="text-xs text-indigo-400 font-medium">Digite o valor total...</span>';return}if(u==="installment"){const q=L/m;y.innerHTML=`
                <div>
                    ...
                    <span class="text-xs text-indigo-500 font-medium">Total: ${ue(L)}</span>
                </div>
            `}else if(u==="repeat"){const q=L*m;y.innerHTML=`
                <div>
                    <span class="block text-[10px] text-indigo-400 uppercase tracking-widest font-bold mb-1">Geração Recorrente Fixa</span>
                    <span class="font-black text-lg text-indigo-700 block leading-tight">${m}x de ${ue(L)}</span>
                    <span class="text-xs text-indigo-500 font-medium">Lançamento Total: ${ue(q)}</span>
                </div>
            `}};t||a.querySelectorAll(".mode-btn").forEach(L=>{L.addEventListener("click",q=>{if(a.querySelectorAll(".mode-btn").forEach(O=>{O.classList.remove("bg-gray-900","text-white","shadow-sm"),O.classList.add("text-gray-500","hover:bg-gray-100")}),q.target.classList.add("bg-gray-900","text-white","shadow-sm"),q.target.classList.remove("text-gray-500","hover:bg-gray-100"),u=q.target.dataset.mode,u==="single")b.classList.add("hidden");else{b.classList.remove("hidden");const O=b.querySelector("label");O.textContent=u==="installment"?"Número de Parcelas":"Repetir por quantos meses?",D()}})}),f.addEventListener("input",D),v&&(v.addEventListener("input",D),c.querySelector("#btn-minus").addEventListener("click",()=>{let L=parseInt(v.value)||2;L>2&&(v.value=L-1,D())}),c.querySelector("#btn-plus").addEventListener("click",()=>{let L=parseInt(v.value)||2;L<60&&(v.value=L+1,D())})),w.addEventListener("change",()=>{w.checked?(S.classList.remove("hidden"),I.required=!0):(S.classList.add("hidden"),I.required=!1)}),c.addEventListener("submit",async L=>{L.preventDefault();const q=c.querySelector('button[type="submit"]'),O=q.innerHTML;q.disabled=!0,q.innerHTML='<div class="loader-small border-white"></div> A gravar...';const B=new FormData(c),M=w.checked,R=parseFloat(B.get("amount"));let H=R,z=1;!t&&u!=="single"&&(z=parseInt(B.get("installments")),u==="repeat"&&(H=R*z));const j={establishmentId:B.get("establishmentId"),description:B.get("description"),amount:H,dueDate:B.get("dueDate"),naturezaId:B.get("naturezaId")||null,centroDeCustoId:B.get("centroDeCustoId")||null,entity:B.get("entity")||null,paymentMethod:B.get("paymentMethod")||null,documentNumber:B.get("documentNumber")||null,notes:B.get("notes"),status:M?"paid":"pending",paymentDate:M?B.get("paymentDate"):null,installments:z};z>1&&!t&&(j.recurrenceId=self.crypto.randomUUID());try{t?(await(s?dn(t.id,j):mn(t.id,j)),g("Sucesso","Atualizado com sucesso!","success")):(await(s?ln(j):pn(j)),g("Sucesso","Lançamento criado!","success")),document.getElementById("genericModal").style.display="none",De()}catch(C){g("Erro",C.message||"Erro ao salvar","error"),q.disabled=!1,q.innerHTML=O}})}const yd=e=>E("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),wd=e=>E("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),kd=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return E(`/api/commissions/stats?${a}`)},Sd=(e={})=>{Object.keys(e).forEach(s=>(e[s]===void 0||e[s]===null||e[s]==="")&&delete e[s]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return E(a)},$d=e=>E(`/api/commissions/report/${e}`,{method:"DELETE"}),_t=new Date,Co=new Date(_t.getFullYear(),_t.getMonth(),1),N={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:Co.toISOString().split("T")[0],dashEndDate:_t.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:Co.toISOString().split("T")[0],histEndDate:_t.toISOString().split("T")[0],histProfessionalId:"all"};let Ct=null;const at=document.getElementById("content");async function Ed(){try{N.professionals=await le(p.establishmentId)}catch(e){console.error("Erro profissionais",e)}Rd(),Id(),la(),Wt("dashboard")}function Id(){Ct&&at.removeEventListener("click",Ct),Ct=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,s=t.dataset.id,o=t.dataset.idx;switch(a){case"tab-nav":Wt(t.dataset.tab);break;case"toggle-all-profs":Ld();break;case"back-to-filters":N.calculationResult=null,Ut(document.getElementById("commissions-content"));break;case"view-preview-items":qd(o);break;case"save-final-report":Dd();break;case"start-new-calc":Wt("calculator");break;case"print-receipt":Td(s);break;case"delete-report":Bd(s);break;case"filter-dashboard":la();break;case"filter-history":Qa();break}},at.addEventListener("click",Ct),at.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Md(t)}},at.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Cd())}}async function la(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(N.dashStartDate=e.value),t&&(N.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const s=await kd(N.dashStartDate,N.dashEndDate);N.dashStats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0},N.currentTab==="dashboard"&&Fs(document.getElementById("commissions-content"))}catch(s){console.error(s),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Qa(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(N.histStartDate=e.value),t&&(N.histEndDate=t.value),a&&(N.histProfessionalId=a.value);const s=document.getElementById("history-list-container");if(s){s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const o=await Sd({startDate:N.histStartDate,endDate:N.histEndDate,professionalId:N.histProfessionalId});N.historyData=o,Hs(s,o)}catch{s.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Ld(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function Cd(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(r=>r.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),s=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");N.periodString=`${a} a ${s}`;const o=document.getElementById("commissions-content");o.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const r=await yd(t);N.calculationResult=r.map(i=>({...i,extraDebit:0,extraCredit:0,finalValue:i.summary.totalCommission,notes:""})),Ut(o)}catch(r){g("Erro",r.message,"error"),N.calculationResult=null,Ut(o)}}async function Dd(){const e=N.calculationResult.length;if(await W("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=N.calculationResult.map(s=>{const o=s.items.map(r=>r.originalSaleId).filter(r=>r!=null);return wd({professionalId:s.professionalId,professionalName:s.professionalName,period:N.periodString,processedSalesIds:o,reportData:{...s,summary:{...s.summary,finalValue:s.finalValue,extraDebit:s.extraDebit||0,extraCredit:s.extraCredit||0,notes:s.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),N.calculationResult=null,la(),Wt("history")}catch(a){g("Erro",a.message,"error")}}function Td(e){const t=N.historyData.find(a=>a.id===e);t&&Pd(t)}async function Bd(e){if(await W("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await $d(e),g("Sucesso","Registro removido.","success"),Qa(),la()}catch(a){g("Erro",a.message,"error")}}function Pd(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,s=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",s,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const o=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&o.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&o.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:o,theme:"grid"});const r=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,r,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Md(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let s=0,o=0;if(t.forEach(r=>{r.value&&(s=parseFloat(r.value))}),a.forEach(r=>{r.value&&(o=parseFloat(r.value))}),N.calculationResult&&N.calculationResult[e]){const r=N.calculationResult[e];r.extraDebit=s,r.extraCredit=o,r.finalValue=r.summary.totalCommission-s+o,t.forEach(n=>{n!==document.activeElement&&(n.value=s||"")}),a.forEach(n=>{n!==document.activeElement&&(n.value=o||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(n=>n.innerText=`R$ ${r.finalValue.toFixed(2)}`),Ad()}}function Ad(){const e=N.calculationResult.reduce((a,s)=>a+s.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function qd(e){const t=N.calculationResult[e];if(!t)return;const a=t.items.map(s=>`
    ...
    `}function jd(e){const t=N.professionals.map(a=>`<option value="${a.id}" ${N.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,N.historyData.length>0?Hs(document.getElementById("history-list-container"),N.historyData):Qa()}function Hs(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ba=document.getElementById("content");let Le={allPackages:[],catalogForModal:{services:[],products:[]}},Dt=null,He=null;function Nd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Fd(){const e=document.getElementById("packagesListContainer");if(e){if(Le.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=Le.allPackages.map(t=>{const a=t.status==="active",s=JSON.stringify(t).replace(/'/g,"&apos;"),o=t.price||0,r=t.originalPrice||0,i=r>o?r-o:0,n=r>0?(r-o)/r*100:0,l=x(t.name),d=x(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function Do(){const e=document.getElementById("genericModal");e.style.display="none",He&&e.removeEventListener("click",He)}async function To(e=null){const t=document.getElementById("genericModal"),a=!!e,s=e?JSON.parse(JSON.stringify(e.items||[])):[],o=x(e?.name||""),r=x(e?.description||""),i=e?.price||"",n=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(f,b)=>{const y=b.querySelector("#originalPrice"),v=f.reduce((w,S)=>w+S.price*S.quantity,0);y&&(y.textContent=`R$ ${v.toFixed(2)}`)},m=f=>{f.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=f.map((b,y)=>{const v=b.type==="service",w=v?"Serviço":"Produto",S=v?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        <input type="number" value="${b.quantity}" min="1" class="w-12 p-1 border rounded-md text-sm quantity-input flex-shrink-0" data-index="${y}">
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                        ...
                        <button type="button" class="text-red-500 hover:text-red-700 remove-item-btn font-bold" data-index="${y}">&times;</button>
                    </div>
                </div>
            `}).join(""),u(f,t)};m(s),c.addEventListener("change",f=>{if(f.target.classList.contains("quantity-input")){const b=parseInt(f.target.dataset.index,10),y=parseInt(f.target.value,10);y>0&&s[b]&&(s[b].quantity=y,m(s))}}),c.addEventListener("click",f=>{if(f.target.classList.contains("remove-item-btn")){const b=parseInt(f.target.dataset.index,10);s.splice(b,1),m(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Hd(f=>{const b=s.find(y=>y.id===f.id&&y.type===f.type);b?b.quantity++:s.push({...f,quantity:1}),m(s)}),He&&t.removeEventListener("click",He),He=async f=>{const b=f.target.closest("button[data-action]");if(!b)return;const y=b.dataset.action;if(f.stopPropagation(),y==="close-modal"&&Do(),y==="save-package"){const v=b,w={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce((S,I)=>S+I.price*I.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:p.establishmentId};if(!w.name||!w.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(w.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}v.disabled=!0,v.textContent="A salvar...";try{a?await Ri(w.id,w):(delete w.id,await qi(w)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Do(),await Xa()}catch(S){g("Erro",`Não foi possível salvar o pacote: ${S.message}`,"error"),v.disabled=!1,v.textContent="Salvar Pacote"}}},t.addEventListener("click",He)}function Hd(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},o=l=>{const d=t.toLowerCase(),c=Le.catalogForModal.services.filter(b=>b.name.toLowerCase().includes(d)),u=Le.catalogForModal.products.filter(b=>b.name.toLowerCase().includes(d)),m=c.map(b=>`
    ...
    `,document.body.appendChild(a);const r=a.querySelector("#item-selection-list"),i=a.querySelector("#item-search-input"),n=()=>{a.remove()};o(r),i.addEventListener("input",()=>{t=i.value,o(r)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:m}=d.dataset,b=(Le.catalogForModal[u+"s"]||[]).find(y=>y.id===m);b&&(e({...b,type:u}),n())}else(c||l.target===a)&&n()})}async function Xa(){ba.innerHTML=`
    ...
    `,Dt&&ba.removeEventListener("click",Dt),Dt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const o=s.dataset.id;W("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async r=>{if(r)try{await ji(o),g("Sucesso!","Pacote excluído.","success"),await Xa()}catch(i){g("Erro",`Não foi possível excluir: ${i.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")To(null);else if(a==="edit-package"){const s=JSON.parse(t.dataset.package);To(s)}},ba.addEventListener("click",Dt);try{const[e,t,a]=await Promise.all([Oa(p.establishmentId),Te(p.establishmentId),ta(p.establishmentId)]);Le.allPackages=e,Le.catalogForModal={services:t.filter(s=>s.active),products:a},Fd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Od=document.getElementById("content");let zd=null;async function Vd(){const e=x(p.userName||"Usuário"),t=x(ne.currentUser?.email||"E-mail não disponível"),a=p.userName?p.userName.charAt(0):"U";Od.innerHTML=`
    ...
    `,await _d()}async function _d(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await si(t);zd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=x(a.name);e.innerHTML=`
            ...
            `,Ud(a.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>Jt(a.id,r.target.value)),Jt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function Ud(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#blockDate").value,o=t.querySelector("#blockStartTime").value,r=t.querySelector("#blockEndTime").value,i=t.querySelector("#blockReason").value;if(!s||!o||!r){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(o>=r){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const n=new Date(`${s}T${o}:00`),l=new Date(`${s}T${r}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Kt({establishmentId:p.establishmentId,professionalId:e,reason:i||"Bloqueado (Meu Perfil)",startTime:n.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;Jt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),g("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function Jt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const s=new Date;let o,r;t==="history"?(r=new Date,o=new Date,o.setFullYear(o.getFullYear()-1)):(o=new Date,r=new Date,r.setFullYear(r.getFullYear()+1));let n=(await Zt(p.establishmentId,o.toISOString(),r.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length>0?(a.innerHTML=n.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,m=x(l.reason||"Sem motivo");return`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const o=(await Qe()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),o.length===0)t.innerHTML=`
            ...
            `;else{let r="";o.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';r+=`
                ...
                `}),t.innerHTML=r}Bo||(Wd(),Bo=!0)}catch(s){console.error("Erro na renderização da rede:",s),t.innerHTML=`
        ...
        `}}function Wd(){const e=document.getElementById("form-create-establishment");e&&e.addEventListener("submit",async t=>{t.preventDefault();const a=e.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const o={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const r=await kr(o);alert(r.message||"Sucesso!"),e.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await Gt(document.getElementById("content"))}catch(r){console.error("Erro ao criar estabelecimento:",r),alert("Erro: "+(r.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>Gt(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const K=document.getElementById("loadingScreen"),et=document.getElementById("dashboardContent"),Oe=document.getElementById("content"),fa=document.getElementById("notificationBell"),Tt=document.getElementById("notificationBadge"),qe=document.getElementById("notificationPanel"),xa=document.getElementById("notificationList"),tt=document.getElementById("profileMenuButton"),ae=document.getElementById("profileDropdown"),Po=document.getElementById("profileName"),Mo=document.getElementById("profileEmail"),Ao=document.getElementById("logoutButton"),qo=document.getElementById("myProfileLink"),Ro=document.getElementById("hamburger-menu-btn"),te=document.getElementById("sidebar"),ie=document.getElementById("mobile-overlay"),jo=document.getElementById("themeToggleBtn"),ha=document.getElementById("themeIcon"),Ba=document.getElementById("mobile-bottom-nav"),Ye=document.getElementById("nav-scroll"),No=document.getElementById("scroll-hint-left"),Fo=document.getElementById("scroll-hint-right"),Jd=document.querySelectorAll(".bottom-nav-item");function Pa(){if(!Ye||!No||!Fo)return;const{scrollLeft:e,scrollWidth:t,clientWidth:a}=Ye;No.classList.toggle("visible",e>5),Fo.classList.toggle("visible",e+a<t-5)}function Gd(){if(!Ye)return;const e=document.querySelector(".bottom-nav-item.active");if(!e)return;const t=Ye,a=t.getBoundingClientRect(),s=e.getBoundingClientRect(),r=s.left+s.width/2-a.left-a.width/2;t.scrollBy({left:r,behavior:"smooth"})}const Yd={"dashboard-section":Yr,"agenda-section":is,"comandas-section":an,"relatorios-section":hn,"servicos-section":Hn,"produtos-section":Zn,"suppliers-section":Kn,"profissionais-section":Ht,"clientes-section":Tl,"estabelecimento-section":e=>Ps(e),"ausencias-section":Gl,"users-section":Ot,"sales-report-section":ud,"financial-section":gd,"commissions-section":Ed,"packages-section":Xa,"my-profile-section":Vd,"hierarquia-section":()=>Gt(Oe),"establishments-section":()=>Gt(Oe)},Ho={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#eef2ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#eff6ff",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#1f2937"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#64748b",hover:"#475569",light:"#f1f5f9",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};function Bt(e){const t=Ho[e]||Ho.indigo,s=(r=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const o=document.getElementById("dynamic-theme-styles");o&&(o.innerHTML=`
            :root {
        ...
        `)}function Rt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("kairos_theme",e),ha&&(e==="dark"?ha.innerHTML="☀️":ha.innerHTML="🌙")}function Qd(){const e=localStorage.getItem("kairos_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;Rt(e||(t?"dark":"light"))}let ut=null,pt=[];function Os(){if(!Tt||!xa)return;const e=pt.filter(t=>!t.read).length;if(e>0?(Tt.textContent=e,Tt.classList.remove("hidden")):Tt.classList.add("hidden"),pt.length===0){xa.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}xa.innerHTML=pt.map(t=>`
    ...
    `).join("")}function Oo(e){ut&&ut();const t=Yt(be,"establishments",e,"notifications"),a=Uo(t,Wo("timestamp",">=",new Date),tr("timestamp","desc"));ut=ar(a,s=>{s.docChanges().forEach(o=>{if(o.type==="added"){const r=o.doc.data();pt.unshift({title:r.title,message:r.message,time:r.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(r.title,r.message,"info",!0),Os();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&is()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Xd(e){const t=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),o=document.getElementById("multi-context-count"),r=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!t||!r))try{const c=(await Qe()).matrizes||[];let u="",m=0;if(c.forEach(f=>{u+=`
                <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors mb-1">
                    <input type="checkbox" value="${f.id}" class="context-checkbox" data-name="${Pt(f.name)}">
                    <span class="text-[13px] sm:text-sm font-bold text-slate-700 truncate">🏢 ${Pt(f.name)}</span>
                </label>
            `,m++,f.branches&&f.branches.length>0&&f.branches.forEach(b=>{u+=`
                    ...
                    `,m++})}),m>0){r.innerHTML=u,t.style.display="block",(!p.selectedEstablishments||p.selectedEstablishments.length===0)&&(p.selectedEstablishments=[e]);const f=Array.from(r.querySelectorAll('input[type="checkbox"]')),b=()=>{const v=f.filter(w=>w.checked);o.textContent=v.length,v.length===0?s.textContent="Nenhuma selecionada":v.length===1?s.textContent=v[0].dataset.name:s.textContent=`${v.length} Unidades`};let y=!1;f.forEach(v=>{p.selectedEstablishments.includes(v.value)&&(v.checked=!0,y=!0)}),!y&&f.length>0&&(f[0].checked=!0,p.selectedEstablishments=[f[0].value],p.establishmentId=f[0].value),b(),a.addEventListener("click",v=>{v.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",v=>{!t.contains(v.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",f.forEach(w=>{w.checked=p.selectedEstablishments.includes(w.value)}),b())}),f.forEach(v=>{v.addEventListener("change",b)}),i.addEventListener("click",async v=>{v.stopPropagation(),K&&(K.classList.remove("hidden","fade-out"),K.style.display="flex");const w=f.filter(I=>I.checked);if(w.length===0){K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500)),g("Atenção","Tem de selecionar pelo menos uma unidade.","warning");return}p.selectedEstablishments=w.map(I=>I.value);const S=p.selectedEstablishments[0];try{const I=await Ce(S);p.establishmentId=S,p.establishmentName=I.name,p.enabledModules=I.modules,p.currentViewContext={id:S,name:I.name,type:I.parentId?"BRANCH":"GROUP"},typeof Bt=="function"&&Bt(I.themeColor||"indigo"),Oo(S),zo(p.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",g("Ambiente Atualizado","Exibindo informações consolidadas.","success");const D=document.querySelector(".sidebar-link.active"),L=D?D.getAttribute("data-target"):"dashboard-section";J(L)}catch(I){console.error("Erro ao aplicar contextos:",I),g("Erro","Ocorreu um problema ao trocar a visualização.","error")}finally{K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500))}});try{const v=await Ce(p.establishmentId);p.establishmentName=v.name,p.enabledModules=v.modules,p.currentViewContext={id:p.establishmentId,name:v.name,type:v.parentId?"BRANCH":"GROUP"},typeof Bt=="function"&&Bt(v.themeColor||"indigo"),Oo(p.establishmentId),zo(p.userPermissions)}catch(v){console.error(v)}}else t.style.display="none"}catch(d){console.error("Erro ao carregar switcher de contexto:",d),t.style.display="none"}}function J(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const o=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(e),r=p.enabledModules?.[a]!==!1,i=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!o&&(!r||!i)){Oe&&(Oe.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),te&&te.classList.contains("absolute")&&(te.classList.add("hidden"),ie&&ie.classList.add("hidden"));return}}const s=Yd[e];s&&Oe&&(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),Ba&&(Jd.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),setTimeout(Gd,50),setTimeout(Pa,100)),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Oe.innerHTML="",window.innerWidth<768&&te&&(te.classList.add("hidden"),ie&&ie.classList.add("hidden")),s(t))}window.navigateTo=J;async function zo(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),r=e===null||e["agenda-section"]?.view===!0,i=e===null||e["financial-section"]?.view===!0;if(r&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!r&&!i))try{const n=await Ur();r&&s&&(s.textContent=n.todayAppointments.toString()),i&&o&&(o.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch(n){console.error("Erro ao carregar KPIs do cabeçalho:",n)}}async function Zd(e){try{pe.getPlatform()==="android"&&await ee.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0});let t=await ee.checkPermissions();if(t.receive==="prompt"&&(t=await ee.requestPermissions()),t.receive!=="granted")return;await ee.register(),ee.addListener("registration",async a=>{try{const s=bt(be,"users",e);await Ma(s,{fcmTokens:er(a.value),platform:"native_mobile"})}catch{}}),ee.addListener("pushNotificationReceived",a=>g(a.title,a.body,"info",!0)),ee.addListener("pushNotificationActionPerformed",()=>J("agenda-section"))}catch{}}function Kd(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>e&&(e.style.display="block"),o=()=>e&&(e.style.display="none"),r=()=>e&&e.style.display==="block";e&&(t.addEventListener("click",()=>{o(),pe.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{o(),pe.isNativePlatform()?oo.exitApp():history.back()}),pe.isNativePlatform()?oo.addListener("backButton",()=>{if(r())o();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(te&&!te.classList.contains("hidden")&&window.innerWidth<768){te.classList.add("hidden"),ie&&ie.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():J("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(r()){o(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():(J("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Pt(e){return e?e.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function ec(){try{await Js(ne,Gs)}catch{}pe.isNativePlatform()&&document.body.classList.add("is-app-native"),br(),Kd(),Qd(),jo&&jo.addEventListener("click",e=>{e.preventDefault();const t=document.documentElement.getAttribute("data-theme");Rt(t==="dark"?"light":"dark")}),Ro&&Ro.addEventListener("click",e=>{e.stopPropagation(),te&&(te.classList.remove("hidden"),te.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),ie&&ie.classList.remove("hidden")}),Ba&&(Ba.addEventListener("click",e=>{const t=e.target.closest(".bottom-nav-item");if(!t)return;e.preventDefault();const a=t.getAttribute("data-target");J(a)}),Ye&&Ye.addEventListener("scroll",Pa),Pa()),ie&&ie.addEventListener("click",()=>{te&&(te.classList.add("hidden"),te.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),ie.classList.add("hidden")}),fa&&fa.addEventListener("click",e=>{e.stopPropagation(),qe&&(qe.classList.toggle("hidden"),qe.classList.contains("hidden")||(pt.forEach(t=>t.read=!0),Os()))}),tt&&tt.addEventListener("click",e=>{e.stopPropagation(),ae&&(ae.classList.toggle("active"),ae.classList.contains("active")?ae.classList.remove("hidden"):setTimeout(()=>ae.classList.add("hidden"),200))}),qo&&qo.addEventListener("click",e=>{e.preventDefault(),J("my-profile-section"),ae&&(ae.classList.remove("active"),ae.classList.add("hidden"))}),document.addEventListener("click",e=>{qe&&!qe.contains(e.target)&&e.target!==fa&&qe.classList.add("hidden"),ae&&!ae.contains(e.target)&&e.target!==tt&&ae.classList.contains("active")&&(ae.classList.remove("active"),setTimeout(()=>ae.classList.add("hidden"),200))}),Ys(ne,async e=>{if(e){if(!pe.isNativePlatform()&&(Hr(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");t&&setTimeout(()=>{t.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Or()&&t&&(t.style.display="none")});const s=()=>{t&&(t.style.display="none")},o=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");o&&o.addEventListener("click",s),r&&r.addEventListener("click",s)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,o=e.displayName,r=null;const i=bt(be,"users",e.uid),n=await Vo(i);if(n.exists()){const d=n.data();s=a.role==="employee"?d.permissions||{}:null,o=d.name||o,r=d.professionalId||null}p.userProfessionalId=r,pe.isNativePlatform()&&Zd(e.uid);const l=o||e.email;rr(a.establishmentId,"Carregando...",s),tt&&(tt.textContent=l.charAt(0).toUpperCase()),Po&&(Po.textContent=l),Mo&&(Mo.textContent=e.email),Ao&&Ao.addEventListener("click",d=>{d.preventDefault(),ut&&ut(),Qs(ne).then(()=>window.location.href="/login.html")}),await Xd(a.establishmentId),wr(J,s,p.enabledModules),K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500)),et&&(et.style.display="flex"),setTimeout(()=>{Ir()},1500),J("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(t){console.error("Erro na inicialização:",t),K&&(K.style.display="none"),et&&(et.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><h2>Erro de Acesso</h2><p>${t.message}</p></div>`,et.style.display="flex")}}else window.location.href="/login.html"})}ec();export{Go as W};
