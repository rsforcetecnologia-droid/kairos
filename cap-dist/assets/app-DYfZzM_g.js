const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-wPY6oIJW.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-CZYPZ0h4.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as le,d as ve,m as bs}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as dr,reauthenticateWithCredential as cr,verifyBeforeUpdateEmail as ur,updatePassword as pr,updateProfile as mr,setPersistence as br,browserLocalPersistence as gr,onAuthStateChanged as fr,signOut as xr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as It,getDoc as to,updateDoc as Qa,setDoc as hr,addDoc as ao,collection as ia,query as so,where as oo,getDocs as vr,deleteDoc as yr,arrayUnion as wr,orderBy as kr,onSnapshot as $r}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Er,onMessage as Sr}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Ir(e,t,a){m.establishmentId=e,m.establishmentName=t,m.userPermissions=a,m.currentViewContext={type:"BRANCH",id:e,name:t}}const ro=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",Ia=ro?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${ro?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",Ia);async function Lr(){const e=le.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function L(e,t={}){const a=await Lr();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=Ia.replace(/\/$/,""),o=e.startsWith("/")?e:`/${e}`,r=`${s}${o}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${r}`);try{const i=await fetch(r,{...t,headers:{...a,...t.headers}});if(!i.ok){const d=(await i.json().catch(()=>({message:i.statusText}))).message||`Erro na API: ${i.status}`;if(d.includes("FAILED_PRECONDITION")&&d.includes("requires an index")){const l=/(https:\/\/[^\s]+)/,c=d.match(l),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,d),new Error(d)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Ia}. Verifique se o servidor backend está rodando.`):i}}const Ya=(e,t,a,s=null)=>{let o=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(o+=`&professionalId=${s}`),L(o)},Cr=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return L(s)},Dr=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const o=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return L(o)},Tr=e=>L("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Pr=(e,t)=>L(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Br=e=>L(`/api/appointments/${e}`,{method:"DELETE"}),Mr=e=>L(`/api/appointments/${e}/reopen`,{method:"POST"}),Ar=(e,t)=>L(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Z;async function qr(){if(!Z)try{Z=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Nr(){if(!Z){console.warn("AudioContext não inicializado. O som não será tocado.");return}Z.state==="suspended"&&Z.resume();const e=Z.createOscillator(),t=Z.createGain();e.connect(t),t.connect(Z.destination),e.type="sine",e.frequency.setValueAtTime(800,Z.currentTime),t.gain.setValueAtTime(0,Z.currentTime),t.gain.linearRampToValueAtTime(.3,Z.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Z.currentTime+.2),e.start(Z.currentTime),e.stop(Z.currentTime+.2)}function b(e,t,a="info",s=!1){const o=document.getElementById("toast-container");if(!o)return;s&&Nr();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},d={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `,o.appendChild(r),r.querySelector(".toast-close").addEventListener("click",()=>r.remove()),setTimeout(()=>{r.remove()},4e3)}function G(e,t){const a=document.getElementById("genericModal");return new Promise(s=>{a.innerHTML=`
    ...
    `;const d=o.querySelector("[data-close-modal]");d&&(d.onclick=i);const l=o.querySelector('[data-action="close-modal"]');return l&&(l.onclick=i),o.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),o.style.display="flex",{modalElement:o,close:i,setContent:n}}function jr(){document.body.addEventListener("click",()=>{Z||qr()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const s=t.dataset.target;if(s){const o=document.getElementById(s);o&&(o.style.display="none")}}if(e.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}const Y=document.getElementById("sidebar"),Ne=document.getElementById("sidebarToggle"),ut=document.getElementById("mainContent"),Rr=document.querySelectorAll(".sidebar-link"),La=document.getElementById("menu-search"),gs=document.getElementById("hamburger-menu-btn"),Ge=document.getElementById("mobile-overlay");let we=!0;function De(e){if(!Y||!ut)return;Y.classList.toggle("collapsed",e),ut.classList.toggle("sidebar-collapsed-shift",e);const t=Y.querySelector(".sidebar-search-container"),a=Y.querySelectorAll(".sidebar-category");e?(t&&(t.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const o=s.getAttribute("data-target-submenu"),r=document.getElementById(o),i=s.querySelector(".submenu-arrow");r&&(r.classList.add("hidden"),r.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(t&&(t.style.display="block"),a.forEach(s=>s.style.display="block"))}function Fr(){!Y||!Ge||(Y.classList.add("mobile-open"),Ge.classList.add("visible"))}function Mt(){!Y||!Ge||(Y.classList.remove("mobile-open"),Ge.classList.remove("visible"))}function Hr(){De(!Y.classList.contains("collapsed"))}function Or(e,t){const a=document.getElementById(e);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&Y.classList.contains("collapsed")&&De(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),t&&t.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),t&&t.classList.remove("rotate-180"))}function zr(){La&&La.addEventListener("input",e=>{const t=e.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),o=a.querySelectorAll(".sidebar-category");if(t===""){s.forEach(r=>r.style.display=""),o.forEach(r=>r.style.display="block");return}o.forEach(r=>r.style.display="none"),s.forEach(r=>{if(r.classList.contains("sidebar-category"))return;const i=r.querySelector(".sidebar-link")||r.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(t)){r.style.display="";const l=r.closest('ul[id$="-submenu"]');if(l){l.classList.remove("hidden"),l.classList.add("flex"),l.parentElement.style.display="";const c=l.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const l=i.getAttribute("data-target-submenu");if(l){const c=document.getElementById(l);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(f=>f.textContent.toLowerCase().includes(t))?r.style.display="":r.style.display="none")}else r.style.display="none"}})})}function Vr(e,t,a){if(!Y||!ut)return;ut.classList.add("main-content-shift"),window.innerWidth>=1024?(we=!0,De(!1)):window.innerWidth>=768?(we=!1,De(!0)):(ut.classList.remove("main-content-shift","sidebar-collapsed-shift"),Mt()),Ne&&Ne.addEventListener("click",o=>{o.stopPropagation(),window.innerWidth>=768?(we=!we,De(!we),we?(Ne.classList.add("text-indigo-400"),Ne.classList.remove("text-gray-400")):(Ne.classList.remove("text-indigo-400"),Ne.classList.add("text-gray-400"))):Hr()}),Y.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!we&&Y.classList.contains("collapsed")&&De(!1)}),Y.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!we){const o=!!document.querySelector("#sidebarToggle:hover"),r=document.activeElement===La;!o&&!r&&De(!0)}}),gs&&gs.addEventListener("click",o=>{o.stopPropagation(),Fr()}),Ge&&Ge.addEventListener("click",o=>{o.stopPropagation(),Mt()});let s=0;Y.addEventListener("touchstart",o=>{s=o.changedTouches[0].screenX},{passive:!0}),Y.addEventListener("touchend",o=>{const r=o.changedTouches[0].screenX;s-r>50&&Mt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(o=>{o.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation();const i=o.getAttribute("data-target-submenu"),n=o.querySelector(".submenu-arrow");Or(i,n)})}),zr(),Rr.forEach(o=>{const r=o.getAttribute("data-target");if(!r)return;const i=r.replace("-section",""),n=a?.[i]!==!1,d=t===null||t[r]?.view===!0;if(!n||!d){o.parentElement&&o.parentElement.tagName==="LI"?o.parentElement.style.display="none":o.style.display="none";return}o.addEventListener("click",l=>{l.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),o.classList.add("active"),r&&typeof e=="function"&&e(r),window.innerWidth<768&&Mt()})})}const _r=e=>L("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),ge=()=>L("/api/establishments/hierarchy",{method:"GET"}),Be=e=>{const t=e||m.establishmentId;return t?L(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Za=(e,t)=>{const a=e||m.establishmentId;return a?L(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Ur=(e,t)=>{const a=e||m.establishmentId;return a?L(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Wr=(e,t)=>{const a=e||m.establishmentId;return a?L(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))};class Jr{constructor(t,a,s){this.steps=t,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(t=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),t&&this.onComplete?this.onComplete():!t&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const t=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",t.onBefore&&(await t.onBefore(),await this.sleep(600));const a=await this.waitForElement(t.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const o=a.getBoundingClientRect(),r=8;this.spotlight.style.top=`${o.top+window.scrollY-r}px`,this.spotlight.style.left=`${o.left+window.scrollX-r}px`,this.spotlight.style.width=`${o.width+r*2}px`,this.spotlight.style.height=`${o.height+r*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(o)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(t){const a=this.popover.getBoundingClientRect(),s=20;let o=t.bottom+window.scrollY+s,r=t.left+window.scrollX;o+a.height>window.scrollY+window.innerHeight&&(o=t.top+window.scrollY-a.height-s),r+a.width>window.innerWidth&&(r=t.right+window.scrollX-a.width),r<s&&(r=s),this.popover.style.top=`${o}px`,this.popover.style.left=`${r}px`}handleResize(){this.isActive&&this.renderStep()}sleep(t){return new Promise(a=>setTimeout(a,t))}async waitForElement(t,a){if(!t)return null;const s=Date.now();for(;Date.now()-s<a;){const o=document.querySelector(t);if(o)return o;await this.sleep(100)}return null}}async function Gr(){try{console.log("A verificar Onboarding interativo...");const e=await Be(m.establishmentId);if(!e||e.parentId||e.onboardingCompleted)return;const t=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await Za(m.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(o){console.error("Erro ao gravar fim do onboarding",o)}};new Jr(t,a,a).start()}catch(e){console.error("Erro fatal ao iniciar onboarding:",e)}}var Xe;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Xe||(Xe={}));class xa extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const Xr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Qr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},o=()=>t!==null?t.name:Xr(e),r=()=>o()!=="web",i=u=>{const p=l.get(u);return!!(p?.platforms.has(o())||n(u))},n=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(f=>f.name===u)},d=u=>e.console.error(u),l=new Map,c=(u,p={})=>{const f=l.get(u);if(f)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),f.proxy;const w=o(),k=n(u);let h;const T=async()=>(!h&&w in p?h=typeof p[w]=="function"?h=await p[w]():h=p[w]:t!==null&&!h&&"web"in p&&(h=typeof p.web=="function"?h=await p.web():h=p.web),h),P=(C,D)=>{var j,H;if(k){const V=k?.methods.find(O=>D===O.name);if(V)return V.rtype==="promise"?O=>a.nativePromise(u,D.toString(),O):(O,B)=>a.nativeCallback(u,D.toString(),O,B);if(C)return(j=C[D])===null||j===void 0?void 0:j.bind(C)}else{if(C)return(H=C[D])===null||H===void 0?void 0:H.bind(C);throw new xa(`"${u}" plugin is not implemented on ${w}`,Xe.Unimplemented)}},S=C=>{let D;const j=(...H)=>{const V=T().then(O=>{const B=P(O,C);if(B){const U=B(...H);return D=U?.remove,U}else throw new xa(`"${u}.${C}()" is not implemented on ${w}`,Xe.Unimplemented)});return C==="addListener"&&(V.remove=async()=>D()),V};return j.toString=()=>`${C.toString()}() { [capacitor code] }`,Object.defineProperty(j,"name",{value:C,writable:!1,configurable:!1}),j},x=S("addListener"),g=S("removeListener"),I=(C,D)=>{const j=x({eventName:C},D),H=async()=>{const O=await j;g({eventName:C,callbackId:O},D)},V=new Promise(O=>j.then(()=>O({remove:H})));return V.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await H()},V},A=new Proxy({},{get(C,D){switch(D){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return k?I:x;case"removeListener":return g;default:return S(D)}}});return s[u]=A,l.set(u,{name:u,proxy:A,platforms:new Set([...Object.keys(p),...k?[w]:[]])}),A};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=o,a.handleError=d,a.isNativePlatform=r,a.isPluginAvailable=i,a.registerPlugin=c,a.Exception=xa,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Yr=e=>e.Capacitor=Qr(e),me=Yr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),na=me.registerPlugin;class io{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const r=this.windowListeners[t];r&&!r.registered&&this.addWindowListener(r),s&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const o=this.listeners[t];if(!o){if(s){let r=this.retainedEventArguments[t];r||(r=[]),r.push(a),this.retainedEventArguments[t]=r}return}o.forEach(r=>r(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new me.Exception(t,Xe.Unimplemented)}unavailable(t="not available"){return new me.Exception(t,Xe.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const o=s.indexOf(a);this.listeners[t].splice(o,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const fs=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),xs=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Zr extends io{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[o,r]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=xs(o).trim(),r=xs(r).trim(),a[o]=r}),a}async setCookie(t){try{const a=fs(t.key),s=fs(t.value),o=`; expires=${(t.expires||"").replace("expires=","")}`,r=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${o}; path=${r}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}na("CapacitorCookies",{web:()=>new Zr});const Kr=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const o=s.result;t(o.indexOf(",")>=0?o.split(",")[1]:o)},s.onerror=o=>a(o),s.readAsDataURL(e)}),ei=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(o=>o.toLocaleLowerCase()).reduce((o,r,i)=>(o[r]=e[t[i]],o),{})},ti=(e,t=!0)=>e?Object.entries(e).reduce((s,o)=>{const[r,i]=o;let n,d;return Array.isArray(i)?(d="",i.forEach(l=>{n=t?encodeURIComponent(l):l,d+=`${r}=${n}&`}),d.slice(0,-1)):(n=t?encodeURIComponent(i):i,d=`${r}=${n}`),`${s}&${d}`},"").substr(1):null,ai=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),o=ei(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(o.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[i,n]of Object.entries(e.data||{}))r.set(i,n);a.body=r.toString()}else if(o.includes("multipart/form-data")||e.data instanceof FormData){const r=new FormData;if(e.data instanceof FormData)e.data.forEach((n,d)=>{r.append(d,n)});else for(const n of Object.keys(e.data))r.append(n,e.data[n]);a.body=r;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(o.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class si extends io{async request(t){const a=ai(t,t.webFetchExtra),s=ti(t.params,t.shouldEncodeUrlParams),o=s?`${t.url}?${s}`:t.url,r=await fetch(o,a),i=r.headers.get("content-type")||"";let{responseType:n="text"}=r.ok?t:{};i.includes("application/json")&&(n="json");let d,l;switch(n){case"arraybuffer":case"blob":l=await r.blob(),d=await Kr(l);break;case"json":d=await r.json();break;case"document":case"text":default:d=await r.text()}const c={};return r.headers.forEach((u,p)=>{c[p]=u}),{data:d,headers:c,status:r.status,url:r.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}na("CapacitorHttp",{web:()=>new si});const se=na("PushNotifications",{}),oi="modulepreload",ri=function(e){return"/"+e},hs={},ii=function(t,a,s){let o=Promise.resolve();if(a&&a.length>0){let d=function(l){return Promise.all(l.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");o=d(a.map(l=>{if(l=ri(l),l in hs)return;hs[l]=!0;const c=l.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":oi,c||(p.as="script"),p.crossOrigin="",p.href=l,n&&p.setAttribute("nonce",n),document.head.appendChild(p),c)return new Promise((f,w)=>{p.addEventListener("load",f),p.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return o.then(i=>{for(const n of i||[])n.status==="rejected"&&r(n.reason);return t().catch(r)})},vs=na("App",{web:()=>ii(()=>import("./web-wPY6oIJW.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),ni="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let ys=!1;async function li(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await se.removeAllListeners(),await se.addListener("registration",async a=>{lo(a.value,!0)}),await se.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await se.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await se.checkPermissions();t.receive==="prompt"&&(t=await se.requestPermissions()),t.receive==="granted"&&await se.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&no()}async function di(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await no(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function no(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Er(bs,{vapidKey:ni,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await lo(t,!1)):console.warn("[Push Web] Token veio vazio."),ys||(Sr(bs,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),ys=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function lo(e,t){const a=le.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=It(ve,"users",a.uid);try{const o=await to(s);if(o.exists()){const i=o.data().fcmTokens||[];if(i.length===1&&i[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Qa(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(o){if(o.code==="not-found")try{await hr(s,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(r){console.error("Erro ao criar user:",r)}else console.error("Erro ao atualizar token:",o)}}const ci=(e,t,a="all",s="all")=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("professionalId",a),s&&s!=="all"&&o.append("costCenterId",s),L(`/api/reports/indicators?${o.toString()}`)},ui=(e,t="all")=>{const a=new URLSearchParams({date:e});return t&&t!=="all"&&a.append("professionalId",t),L(`/api/reports/appointments/list?${a.toString()}`)},pi=e=>e?L(`/api/financial/cost-centers/${e}`):Promise.resolve([]),mi=(e,t,a)=>{const s=new URLSearchParams({startDate:t,endDate:a});return L(`/api/analytics/${e}?${s.toString()}`)},Yt=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const o=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&o.append("cashierSessionId",s),e&&o.append("establishmentId",e),L(`/api/reports/sales?${o.toString()}`)},bi=(e,t,a)=>L(`/api/analytics/${e}/monthly-details?year=${t}&month=${a}`),gi=(e,t,a,s)=>{const o=`/api/analytics/${e}/daily-details?year=${t}&month=${a}&day=${s}`;return L(o)},fi=(e,t,a,s)=>{const o=`/api/analytics/${e}/professional-details?year=${t}&month=${a}&professionalId=${s}`;return L(o)},xi=(e,t,a,s)=>L(`/api/reports/commissions/${e}?year=${t}&month=${a}&professionalId=${s}`),co=()=>L("/api/reports/summary",{method:"GET"}),hi=Object.freeze(Object.defineProperty({__proto__:null,getAdvancedIndicators:ci,getAnalytics:mi,getCommissionReport:xi,getCostCenters:pi,getDailyAppointments:ui,getDailyTransactions:gi,getMonthlyAnalytics:bi,getProfessionalMonthlyDetails:fi,getSalesReport:Yt,getSummaryKPIs:co},Symbol.toStringTag,{value:"Module"})),Ka=e=>e?String(e).replace(/\D/g,""):"",Lt=(e,t="",a=20,s={})=>{const o=new URLSearchParams;return t&&o.append("search",t),a&&o.append("limit",a),s&&s.hasLoyalty&&o.append("hasLoyalty","true"),s&&s.birthMonth&&o.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&o.append("inactiveDays",s.inactiveDays),L(`/api/clients/${e}?${o.toString()}`)},uo=(e,t)=>{const a=encodeURIComponent(t);return L(`/api/clients/details/${e}/${a}`)},po=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Ka(t),s={...e,phone:a,id:a};return L(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},mo=po,bo=(e,t)=>po({...t,id:e}),go=e=>{const t=encodeURIComponent(e);return L(`/api/clients/${t}`,{method:"DELETE"})},vi=(e,t,a,s)=>L("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ka(t),points:a,rewardName:s})}),yi=(e,t)=>uo(e,Ka(t));function v(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function fo(e,t=800,a=800,s=.7){return new Promise((o,r)=>{if(!e.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(e),i.onload=n=>{const d=new Image;d.src=n.target.result,d.onload=()=>{let l=d.width,c=d.height;l>c?l>t&&(c*=t/l,l=t):c>a&&(l*=a/c,c=a);const u=document.createElement("canvas");u.width=l,u.height=c,u.getContext("2d").drawImage(d,0,0,l,c);const f=u.toDataURL("image/jpeg",s);o(f)},d.onerror=l=>r(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>r(new Error("Erro ao ler o ficheiro."))})}function ha(e){const t=parseFloat(e);return isNaN(t)?"R$ 0,00":t.toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}let va=null;async function wi(){const e=document.getElementById("content");e.innerHTML=`
    ...
    `;try{const t=new Date,a=new Date(t.getFullYear(),t.getMonth(),t.getDate()),s=new Date(a);s.setHours(23,59,59,999);const o=new Date(a.getFullYear(),a.getMonth(),1),r=new Date(a);r.setDate(a.getDate()-6);const i=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId],n=i.map(async B=>{const[U,te]=await Promise.all([Ya(B,o.toISOString(),s.toISOString(),null),Lt(B)]);return{appts:U||[],clients:te||[]}}),d=await Promise.all(n);let l=[],c=[];d.forEach(B=>{l=l.concat(B.appts),c=c.concat(B.clients)});const u=B=>(B.services||[]).reduce((U,te)=>U+(Number(te.price)||0),0)||Number(B.totalPrice||0)||Number(B.servicePrice||0),p=l.filter(B=>{const U=new Date(B.startTime);return U>=a&&U<=s}),f=p.filter(B=>B.status==="completed"),w=l.filter(B=>B.status==="completed"),k=f.reduce((B,U)=>B+u(U),0),h=w.reduce((B,U)=>B+u(U),0),T=p.length,P=w.length>0?h/w.length:0,S=[],x=[],g=["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"];for(let B=0;B<7;B++){const U=new Date(r);U.setDate(r.getDate()+B),S.push(g[U.getDay()]);const te=new Date(U).setHours(0,0,0,0),ie=new Date(U).setHours(23,59,59,999),Ie=l.filter(Pt=>{const Bt=new Date(Pt.startTime).getTime();return Pt.status==="completed"&&Bt>=te&&Bt<=ie}).reduce((Pt,Bt)=>Pt+u(Bt),0);x.push(Ie)}const I={labels:S,data:x},A=p.filter(B=>new Date(B.startTime).getTime()>=t.getTime()&&B.status!=="completed"&&B.status!=="cancelled").sort((B,U)=>new Date(B.startTime)-new Date(U.startTime)).slice(0,4).map(B=>({client:B.clientName||"Desconhecido",service:B.serviceName||(B.services&&B.services[0]?B.services[0].name:"Serviço"),time:new Date(B.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(B.professionalName||"").split(" ")[0]||"Profissional",id:B.id})),C=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,D=new Map;c.forEach(B=>{B.phone?D.set(B.phone,B):D.set(B.id||Math.random().toString(),B)});const H=Array.from(D.values()).filter(B=>{if(!B.birthDate)return!1;let U,te;if(B.birthDate.includes("-")){const ie=B.birthDate.split("-");ie[0].length===4?(U=ie[1],te=ie[2]):(te=ie[0],U=ie[1])}else if(B.birthDate.includes("/")){const ie=B.birthDate.split("/");te=ie[0],U=ie[1]}return`${te}/${U}`===C}).map(B=>{let U="";return B.birthDate&&B.birthDate.includes("-")&&B.birthDate.split("-")[0].length===4&&(U=a.getFullYear()-parseInt(B.birthDate.split("-")[0])),{name:B.name,age:U,phone:B.phone}}),V={receitaHoje:k,agendamentosHoje:T,receitaMes:h,ticketMedio:P},O=i.length>1;ki(e,V,I,A,H,O),$i(I),Ei()}catch(t){console.error("Erro ao carregar dashboard:",t),e.innerHTML=`
        ...
        `}}function ki(e,t,a,s,o,r){const i=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),n=r?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-0.5 rounded-full ml-2 align-middle">CONSOLIDADO</span>':"";e.innerHTML=`
    ...
    `}function $i(e){const t=document.getElementById("revenueChart");if(!t)return;va&&va.destroy();const s=t.getContext("2d").createLinearGradient(0,0,0,240);s.addColorStop(0,"rgba(79, 70, 229, 0.15)"),s.addColorStop(1,"rgba(79, 70, 229, 0.01)"),va=new Chart(t,{type:"line",data:{labels:e.labels,datasets:[{label:"Receita (R$)",data:e.data,borderColor:"#6366f1",backgroundColor:s,borderWidth:2.5,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.35}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,cornerRadius:8,titleFont:{size:12,family:"Inter",weight:"normal"},bodyFont:{size:13,weight:"bold",family:"Inter"},displayColors:!1,callbacks:{label:function(o){return o.parsed.y!==null?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(o.parsed.y):""}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:10},maxTicksLimit:6,callback:function(o){return"R$ "+o}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function Ei(){document.getElementById("content").addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":X("agenda-section");break;case"new-appointment":X("agenda-section");break;case"goto-pdv":X("comandas-section");break;case"goto-clients":X("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${m.establishmentId||""}`;window.open(o,"_blank");break}})}const st=e=>L(`/api/services/${e}`),Si=e=>L("/api/services",{method:"POST",body:JSON.stringify(e)}),Ii=(e,t)=>L(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Li=e=>L(`/api/services/${e}`,{method:"DELETE"}),Ci=(e,t)=>L(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Di=e=>L(`/api/services/stats/most-popular/${e}`),ye=e=>L(`/api/professionals/${e}`),Ti=e=>L(`/api/professionals/details/${e}`),Pi=e=>L("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Bi=(e,t)=>L(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),xo=e=>L(`/api/professionals/${e}`,{method:"DELETE"}),Mi=e=>{const t=e.map(a=>xo(a));return Promise.all(t)},la=(e,t,a,s="all")=>{const o=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return L(o)},da=e=>L("/api/blockages",{method:"POST",body:JSON.stringify(e)}),es=e=>L(`/api/blockages/${e}`,{method:"DELETE"}),ho=e=>L("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),ws=document.getElementById("content");let ks=!1;const Ca=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let ca=[],Da=[],Zt={},vo=[],N={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},R={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function ts(e){const t=new Date(e),a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return t.setDate(s),t.setHours(0,0,0,0),t}function as(){const e=document.getElementById("profSelectorContainer");if(!e||!m.professionals)return;let t=m.professionals.filter(o=>N.showInactiveProfs||o.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=s.map(o=>{const r=N.selectedProfessionalId===o.id,i=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),n=o.id!=="all"?m.professionalColors.get(o.id)||Ca[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            <div class="prof-pill ${r?"active":""}"
                 data-action="select-professional" data-prof-id="${o.id}"
                 style="--pc: ${n.main}; --pb: ${r?n.bg:""}; --pl: ${n.light};">
                <div class="prof-pill-dot" ${o.photo?`style="background-image: url('${W(o.photo)}'); background-size: cover; background-position: center;"`:""}>
                    ${o.photo?"":i}
                </div>
                <span>${W(o.name==="Todos"?"Todos":o.name.split(" ")[0])}</span>
            </div>`}).join("")}function W(e){return v(e||"")}function Ai(e,t,a,s,o){const r=(e||"").replace(/\D/g,""),i=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=`Olá, ${t}! Você tem um agendamento de ${a} com ${s} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${r}?text=${encodeURIComponent(d)}`}function qi(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],s=ts(N.currentDate),o=new Date;o.setHours(0,0,0,0);let r='<div class="week-container" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(s);n.setDate(s.getDate()+i);const d=n.toDateString()===o.toDateString(),l=e.filter(u=>new Date(u.startTime).toDateString()===n.toDateString()).sort((u,p)=>new Date(u.startTime)-new Date(p.startTime));let c="";l.length===0?c='<div class="week-empty"><i class="bi bi-dash-lg" style="font-size:1rem;display:block;margin-bottom:4px;"></i>Sem agendamentos</div>':c=l.map(u=>{const f=new Date(u.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),w=m.professionalColors.get(u.professionalId)||{main:"#adb5bd"},k=u.status==="completed",h=N.selectedItems.has(u.id);if(u.type==="blockage")return`<div class="week-event-chip week-blockage">
                        <div class="we-time"><i class="bi bi-lock me-1"></i>${f}</div>
                        <div class="we-client">${W(u.reason)}</div>
                        <div class="we-service">${W(u.professionalName)}</div>
                    </div>`;const T=JSON.stringify(u).replace(/'/g,"&apos;"),P=h?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"",S=N.isSelectionMode?`<div style="position:absolute; top:6px; right:6px; z-index:1;">
                           <input type="checkbox" style="width:16px; height:16px; accent-color:#4f46e5; pointer-events:none;" ${h?"checked":""}>
                       </div>`:"";return`<div class="week-event-chip ${k?"completed":""}" style="--ec: ${w.main}; ${P}"
                    data-action="edit-appointment" data-appointment='${T}'>
                    ${S}
                    <div class="we-time">${f}</div>
                    <div class="we-client" style="${N.isSelectionMode?"padding-right:20px;":""}">${W(u.clientName)}</div>
                    <div class="we-service">${W(u.serviceName)} · ${W((u.professionalName||"").split(" ")[0])}</div>
                    ${N.isSelectionMode?"":`
                    <div class="we-actions">
                        <button class="we-btn" data-action="open-comanda" data-appointment='${T}' title="Comanda">
            ...
            <div class="list-date-label">${o}</div>`,r.forEach(i=>{const n=new Date(i.startTime),d=new Date(i.endTime),l=Math.round((d-n)/6e4),c=n.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=m.professionalColors.get(i.professionalId)||{main:"#adb5bd"},p=i.status==="completed",f=JSON.stringify(i).replace(/'/g,"&apos;"),w=N.selectedItems.has(i.id),k=N.isSelectionMode?`<div style="display:flex; align-items:center; margin-right: 12px; margin-left: 4px;">
                       <input type="checkbox" style="width:20px; height:20px; accent-color:#4f46e5; pointer-events:none;" ${w?"checked":""}>
                   </div>`:"",h=w?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"";if(i.type==="blockage"){s+=`<div class="list-card blockage">
                    ${k}
                    ...
                    <div class="list-card-info">
                        <div class="lc-name" style="color:#c92a2a;">${W(i.reason)}</div>
                        <div class="lc-detail">${W(i.professionalName)}</div>
                    </div>
                </div>`;return}const T=Ai(i.clientPhone,i.clientName,i.serviceName,i.professionalName,i.startTime),P=(i.services||[]).reduce((I,A)=>I+(Number(A.price)||0),0)||Number(i.totalPrice||0)||Number(i.servicePrice||0),S=i.paymentStatus||(i.status==="completed"?"Finalizado":"Agendado"),x=W((i.professionalName||"").split(" ")[0]),g=(i.services||[]).length||(i.serviceName?1:0);s+=`<div class="list-card ${p?"completed":""}" style="${h}"
                ...
                <div class="list-card-info">
                    <div class="lc-name">${W(i.clientName)}</div>
                    <div class="lc-detail">${W(i.serviceName)} · ${x}</div>
                    <div class="lc-extra" style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 8px;">
                        ...
                        ${i.clientPhone?`<span style="font-size: 0.65rem; color: #4b5563; background: #f3f4f6; padding: 2px 8px; border-radius: 6px; font-weight: 500;"><i class="bi bi-telephone"></i> ${W(i.clientPhone)}</span>`:""}
                        <span style="font-size: 0.65rem; color: #4b5563; background: #f3f4f6; padding: 2px 8px; border-radius: 6px; font-weight: 500;">${g} serv.</span>
                        <span style="font-size: 0.65rem; color: ${p?"#059669":"#d97706"}; background: ${p?"#d1fae5":"#fef3c7"}; padding: 2px 8px; border-radius: 6px; font-weight: 600;">${W(S)}</span>
                    </div>
                </div>
                ...
                <div class="list-card-actions">
                    <button class="lc-action-btn wa" data-link="${T}" title="WhatsApp">
            ...
            </div>`}),s+="</div>"}),s+="</div>",t.innerHTML=s}function yo(){const e=m.allEvents.filter(t=>N.selectedProfessionalId==="all"||t.professionalId===N.selectedProfessionalId);N.currentView==="list"?Ni(e):qi(e),ss()}function ss(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(N.isSelectionMode&&N.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
        ...
        </div>`,e.style.display="block",t&&(t.style.transform="scale(0)")):(e.style.display="none",t&&(t.style.transform="scale(1)")))}function ji(){const e=document.getElementById("currentDateDisplay");if(!e)return;const t=new Date;t.setHours(0,0,0,0);const a=new Date(N.currentDate);if(a.setHours(0,0,0,0),N.currentView==="list")a.toDateString()===t.toDateString()?e.textContent="Hoje":e.textContent=a.toLocaleDateString("pt-BR",{day:"numeric",month:"long"});else{const s=ts(a),o=new Date(s);o.setDate(s.getDate()+6);const r=s.toLocaleDateString("pt-BR",{day:"numeric",month:"short"}),i=o.toLocaleDateString("pt-BR",{day:"numeric",month:"short"});e.textContent=`${r} - ${i}`}}async function Ee(){const e=document.getElementById("agenda-view");if(!e)return;N.selectedItems.clear(),ss(),e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;padding:60px 0;"><div style="width:28px;height:28px;border:2.5px solid #e9ecef;border-top:2.5px solid #4f46e5;border-radius:50%;animation:spin 0.7s linear infinite;"></div></div><style>@keyframes spin{to{transform:rotate(360deg)}}</style>',ji();let t,a;if(N.currentView==="list")t=new Date(N.currentDate),t.setHours(0,0,0,0),a=new Date(t),a.setHours(23,59,59,999);else{const s=ts(N.currentDate);t=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const o=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async l=>{const[c,u]=await Promise.all([Ya(l,t.toISOString(),a.toISOString(),N.selectedProfessionalId==="all"?null:N.selectedProfessionalId),la(l,t.toISOString(),a.toISOString(),N.selectedProfessionalId)]);return{appts:c||[],blockages:u||[]}}),r=await Promise.all(o);let i=[],n=[];if(r.forEach(l=>{i=i.concat(l.appts),n=n.concat(l.blockages)}),!document.getElementById("agenda-view"))return;const d=l=>l.map(c=>({...c,type:c.type||"appointment",professionalName:c.professionalName||(()=>{const u=m.professionals?.find(p=>p.id===c.professionalId);return u?u.name:"Indefinido"})()}));m.allEvents=[...d(i),...d(n)],as(),yo()}catch(s){console.error(s),document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12" style="color:#868e96;">
                    <i class="bi bi-exclamation-triangle" style="font-size:1.5rem;"></i>
                    <p class="mt-2" style="font-size:0.8rem;">Erro ao carregar agenda.</p>
                </div>`)}}async function Ri(){try{const t=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(async i=>{const[n,d,l]=await Promise.all([ye(i),st(i),Be(i)]);return{profs:n||[],services:d||[],estDetails:l}}),a=await Promise.all(t),s=new Map,o=new Map;let r=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>s.set(n.id,n)),i.services.forEach(n=>o.set(n.id,n))}),m.professionals=Array.from(s.values()),m.services=Array.from(o.values()),vo=[],r&&(Zt=r.loyaltyProgram||{enabled:!1}),m.professionals.forEach((i,n)=>{m.professionalColors.set(i.id,Ca[n%Ca.length])}),as()}catch{b("Atenção","Não foi possível carregar os dados da equipa.","error")}}async function wo(e={}){N.currentDate=e.targetDate?new Date(e.targetDate):N.currentDate||new Date,N.isSelectionMode=!1,N.selectedItems.clear(),ws.innerHTML=`
        ...
        </div>`,document.getElementById("btnPrevDate").addEventListener("click",()=>{N.currentView==="list"?N.currentDate.setDate(N.currentDate.getDate()-1):N.currentDate.setDate(N.currentDate.getDate()-7),Ee()}),document.getElementById("btnNextDate").addEventListener("click",()=>{N.currentView==="list"?N.currentDate.setDate(N.currentDate.getDate()+1):N.currentDate.setDate(N.currentDate.getDate()+7),Ee()}),document.getElementById("btnTodayHeader").addEventListener("click",()=>{N.currentDate=new Date,Ee()});const t=document.querySelectorAll(".agenda-view-toggle button");t.forEach(a=>{a.addEventListener("click",()=>{t.forEach(s=>{s.classList.remove("active","shadow-sm"),s.style.backgroundColor="transparent"}),a.classList.add("active","shadow-sm"),a.style.backgroundColor="#fff",N.currentView=a.dataset.view,Ee()})}),document.getElementById("btnWeekDays").addEventListener("click",()=>{Fi()}),ks||(ws.addEventListener("click",async a=>{const s=a.target.closest('[data-action="open-comanda"]');if(s){a.stopPropagation();const d=s.dataset.appointment||s.closest("[data-appointment]")?.dataset.appointment;if(!d)return;const l=JSON.parse(d.replace(/&apos;/g,"'")),c=l.status==="completed"?"finalizadas":"em-atendimento",u={selectedAppointmentId:l.id,initialFilter:c};c==="finalizadas"&&l.transaction?.paidAt&&(u.filterDate=typeof l.transaction.paidAt=="object"?new Date(l.transaction.paidAt._seconds*1e3):l.transaction.paidAt),X("comandas-section",u);return}const o=a.target.closest(".lc-action-btn.wa");if(o){a.stopPropagation(),o.dataset.link&&window.open(o.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const d=N.selectedItems.size;await G("Excluir Selecionados",`Tem certeza que deseja excluir ${d} agendamento(s)? Esta ação não pode ser desfeita.`)&&(await Promise.all(Array.from(N.selectedItems).map(async c=>{try{await Br(c)}catch{}})),b(`${d} agendamento(s) excluído(s).`,"success"),N.selectedItems.clear(),N.isSelectionMode=!1,Ee());return}const r=a.target.closest('[data-action="select-professional"]');if(r){const d=r.dataset.profId;N.selectedProfessionalId=N.selectedProfessionalId===d&&d!=="all"?"all":d,Ee();return}const i=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(i){if(N.isSelectionMode){a.stopPropagation();const l=i.querySelector('input[type="checkbox"]');if(l){const c=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'")),u=!l.checked;l.checked=u,u?N.selectedItems.add(c.id):N.selectedItems.delete(c.id),(i.classList.contains("week-event-chip")||i.classList.contains("list-card"))&&(u?(i.style.boxShadow="0 0 0 2px #4f46e5",i.style.backgroundColor="#eff6ff"):(i.style.boxShadow="none",i.style.backgroundColor=i.classList.contains("week-event-chip")?"#f8f9fa":"#fff")),ss()}return}const d=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"));Ta(d);return}if(a.target.closest('[data-action="new-appointment"]')){Ta();return}}),ks=!0),await Ri(),await Ee()}function Fi(){const e=document.getElementById("optionsSheet");if(e){e.remove();return}const t=document.createElement("div");t.id="optionsSheet",t.style.cssText="position:fixed;bottom:0;left:50%;right:auto;transform:translateX(-50%) translateY(100%);width:100%;max-width:440px;background:#fff;border-radius:24px 24px 0 0;z-index:10000;box-shadow:0 -8px 40px rgba(0,0,0,0.15);transition:transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);";const a=N.isSelectionMode?"#fee2e2":"#f0fdf4",s=N.isSelectionMode?"#ef4444":"#16a34a",o=N.isSelectionMode?"bi-x-circle":"bi-check2-square";t.innerHTML=`
        ...
        </div>`}}function Oi(){return{title:"Serviços",content:`
        <div class="p-5 space-y-5">
            <div class="flex items-center gap-3">
            ...
            <div id="apptServicesContainer" class="grid grid-cols-2 gap-3 max-h-56 overflow-y-auto">
                ${ca.map(e=>`<div class="service-card p-3 bg-white rounded-xl border ${R.data.selectedServiceIds.includes(e.id)?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer" data-service-id="${e.id}">
                        <p class="font-semibold text-sm text-gray-800 truncate">${W(e.name)}</p>
        ...
        </div>`}}function zi(){return{title:"Profissional",content:`
        <div class="p-5 space-y-5">
            <div class="relative">
                <i class="bi bi-search absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
            ...
            <div id="apptProfessionalContainer" class="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-52 overflow-y-auto professional-step-cards">
                ${Da.map(e=>`<div class="professional-modal-card p-3 bg-white rounded-xl border ${R.data.professionalId===e.id?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer text-center" data-professional-id="${e.id}">
                        <div class="w-10 h-10 rounded-full bg-gray-100 mx-auto flex items-center justify-center font-bold text-sm text-gray-500">${W(e.name).charAt(0)}</div>
                        <p class="text-sm font-semibold mt-2 truncate">${W(e.name.split(" ")[0])}</p>
                    </div>`).join("")}
            </div>
        </div>
        <div class="px-5 py-4 border-t border-gray-100 flex justify-between gap-3">
        ...
        </div>`}}function Vi(){const e=R.data.date||new Date().toISOString().split("T")[0];return{title:"Data e Horário",content:`
        <div class="p-5 space-y-5">
            <div class="flex items-center gap-3 p-3 bg-indigo-50 rounded-xl">
                <div class="w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold flex-shrink-0">${W(R.data.clientName).charAt(0)}</div>
                <div class="min-w-0">
                    <p class="font-semibold text-sm text-gray-900 truncate">${W(R.data.clientName)}</p>
                    <p class="text-xs text-gray-500 truncate">${W(R.data.professionalName)}</p>
                </div>
            </div>
            <div>
        ...
        </div>`}}async function Ta(e=null,t=!1){const a=document.getElementById("appointmentModal");t||(R={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(o=>o.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],time:e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}),ca=m.services||[],Da=(m.professionals||[]).filter(o=>o.status==="active");let s;switch(R.step){case 1:s=Hi(e);break;case 2:s=Oi();break;case 3:s=zi();break;case 4:s=Vi();break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>o.addEventListener("click",()=>{const r=parseInt(o.dataset.currentStep,10);if(r===1&&(R.data.clientName=a.querySelector("#apptClientName").value.trim(),R.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!R.data.clientName))return b("Preencha o nome do cliente.","warning");if(r===2&&R.data.selectedServiceIds.length===0)return b("Selecione um serviço.","warning");if(r===3&&!R.data.professionalId)return b("Escolha um profissional.","warning");$s(r+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>o.addEventListener("click",()=>$s(parseInt(o.dataset.currentStep,10)-1))),a.querySelector('[data-action="close-modal"]')?.addEventListener("click",()=>{a.style.display="none"}),R.step===4&&a.querySelector("#appointmentForm").addEventListener("submit",_i),a.style.display="flex",R.step===2&&a.querySelectorAll(".service-card").forEach(o=>o.addEventListener("click",()=>{const r=a.querySelector("#multiServiceToggle")?.checked,i=o.classList.contains("selected");r||(a.querySelectorAll(".service-card.selected").forEach(d=>d.classList.remove("selected","border-indigo-500","bg-indigo-50")),R.data.selectedServiceIds=[]);const n=o.dataset.serviceId;i?(o.classList.remove("selected","border-indigo-500","bg-indigo-50"),R.data.selectedServiceIds=R.data.selectedServiceIds.filter(d=>d!==n)):(o.classList.add("selected","border-indigo-500","bg-indigo-50"),R.data.selectedServiceIds.push(n))})),R.step===3&&a.querySelectorAll(".professional-modal-card").forEach(o=>o.addEventListener("click",()=>{a.querySelectorAll(".professional-modal-card.selected").forEach(i=>i.classList.remove("selected","border-indigo-500","bg-indigo-50")),o.classList.add("selected","border-indigo-500","bg-indigo-50"),R.data.professionalId=o.dataset.professionalId;const r=Da.find(i=>i.id===o.dataset.professionalId);R.data.professionalName=r?r.name:""})),R.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",o=>Wi(o.target.value)),R.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",Es),Es(),Ui())}async function _i(e){e.preventDefault();const a=e.target.querySelector('button[type="submit"]');if(!R.data.time||!R.data.selectedServiceIds.length||!R.data.professionalId)return b("Selecione horário, serviço e profissional.","warning");a.disabled=!0,a.innerHTML="Aguarde...";const s=R.data.selectedServiceIds.map(l=>{const c=ca.find(u=>u.id===l);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[o,r]=R.data.time.split(":"),i=new Date(`${R.data.date}T${o}:${r}:00`),d={establishmentId:m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId,clientName:R.data.clientName,clientPhone:R.data.clientPhone,services:s,professionalId:R.data.professionalId,professionalName:R.data.professionalName,startTime:i.toISOString(),redeemedReward:R.data.redeemedReward};R.data.id&&(d.id=R.data.id);try{R.data.id?await Pr(R.data.id,d):await Tr(d),b("Agendamento registrado!","success"),document.getElementById("appointmentModal").style.display="none",Ee()}catch(l){b(l.message,"error"),a.disabled=!1,a.textContent="Agendar"}}async function Es(){const e=document.getElementById("availableTimesContainer"),t=document.getElementById("apptTotalDuration");if(!e)return;const a=R.data.selectedServiceIds.reduce((i,n)=>{const d=ca.find(l=>l.id===n);return i+(d?d.duration+(d.bufferTime||0):0)},0);t&&(t.textContent=`${a} min`);const{professionalId:s,selectedServiceIds:o,date:r}=R.data;if(!s||!o.length||!r){e.innerHTML='<p class="col-span-full text-center text-xs text-gray-400">Selecione serviço e profissional</p>';return}try{const i=m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments[0]:m.establishmentId;let n=await Dr({establishmentId:i,professionalId:s,serviceIds:o,date:r});const d=new Date;if(new Date(r+"T00:00:00").toDateString()===d.toDateString()){const l=d.getHours()*60+d.getMinutes();n=n.filter(c=>{const[u,p]=c.split(":").map(Number);return u*60+p>=l})}e.innerHTML=n.length>0?n.map(l=>`<button type="button" class="p-2 text-sm font-semibold rounded-lg border ${R.data.time===l?"bg-indigo-600 text-white border-indigo-600":"bg-gray-50 text-gray-700 border-gray-200 hover:bg-indigo-50"}" onclick="document.querySelectorAll('#availableTimesContainer button').forEach(b=>{b.classList.remove('bg-indigo-600','text-white','border-indigo-600');b.classList.add('bg-gray-50','text-gray-700','border-gray-200')});this.classList.add('bg-indigo-600','text-white','border-indigo-600');this.classList.remove('bg-gray-50','text-gray-700','border-gray-200');window._selectedTime='${l}';">${l}</button>`).join(""):'<p class="col-span-full text-center text-xs text-gray-400">Sem horários</p>'}catch{e.innerHTML='<p class="col-span-full text-center text-xs text-red-400">Erro</p>'}}function Ui(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a}=R.data,{enabled:s,rewards:o}=Zt;if(!s||!t||!o?.length){e.innerHTML="";return}const r=o.filter(i=>a>=i.points);if(!r.length){e.innerHTML='<p class="text-xs text-gray-400">Sem recompensas disponíveis.</p>';return}e.innerHTML=`<div class="border-t border-gray-100 pt-4">
        <p class="text-xs font-semibold text-gray-500 mb-2">Resgate fidelidade (${a} pts)</p>
        ${r.map(i=>`<label class="flex items-center gap-3 p-2 bg-gray-50 rounded-lg mb-1 cursor-pointer"><input type="radio" name="loyaltyReward" value="${W(i.reward)}" data-points="${i.points}" class="accent-indigo-600"><span class="text-sm">${W(i.reward)} (-${i.points} pts)</span></label>`).join("")}
    </div>`,e.querySelectorAll('input[name="loyaltyReward"]').forEach(i=>{i.addEventListener("change",n=>{n.target.checked&&(R.data.redeemedReward={reward:n.target.value,points:parseInt(n.target.dataset.points,10)})})})}async function Wi(e){const t=document.getElementById("clientSearchResults");if(!t||e.trim().length<3){t&&(t.innerHTML='<p class="text-xs text-gray-400">Digite pelo menos 3 caracteres...</p>');return}t.innerHTML='<div class="text-center py-3"><div class="w-5 h-5 border-2 border-indigo-200 border-t-indigo-600 rounded-full animate-spin mx-auto"></div></div>';try{const s=(m.selectedEstablishments&&m.selectedEstablishments.length>0?m.selectedEstablishments:[m.establishmentId]).map(n=>Lt(n,e.trim())),o=await Promise.all(s),r=new Map;o.forEach(n=>{n.forEach(d=>{d.phone?r.set(d.phone,d):r.set(d.id||Math.random().toString(),d)})});const i=Array.from(r.values());if(vo=i,!i.length){t.innerHTML='<p class="text-xs text-gray-400">Nenhum cliente encontrado.</p>';return}t.innerHTML=i.map(n=>`<div class="client-card p-2.5 bg-white rounded-lg border ${R.data.clientName===n.name&&R.data.clientPhone===n.phone?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer flex items-center gap-2" data-client-name="${W(n.name)}" data-client-phone="${W(n.phone)}" data-loyalty-points="${n.loyaltyPoints||0}">
                <div class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-500">${W(n.name).charAt(0)}</div>
                <div><p class="text-sm font-semibold text-gray-800">${W(n.name)}</p><p class="text-xs text-gray-500">${W(n.phone)}</p></div>
            </div>`).join(""),t.querySelectorAll(".client-card").forEach(n=>n.addEventListener("click",()=>{R.data.clientName=n.dataset.clientName,R.data.clientPhone=n.dataset.clientPhone,R.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const d=Math.min(...(Zt?.rewards||[]).map(l=>l.points));R.data.clientHasRewards=Zt.enabled&&d!==1/0&&R.data.clientLoyaltyPoints>=d,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,t.querySelectorAll(".client-card").forEach(l=>l.classList.remove("border-indigo-500","bg-indigo-50")),n.classList.add("border-indigo-500","bg-indigo-50")}))}catch{t.innerHTML='<p class="text-xs text-red-400">Erro ao buscar.</p>'}}const Ji=(e,t=null,a=1,s=12)=>{let o=`/api/comandas/${e}?page=${a}&limit=${s}`;return t&&(o+=`&date=${t}`),L(o)},Gi=(e,t)=>L(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),ko=e=>L("/api/sales",{method:"POST",body:JSON.stringify(e)}),Pa=(e,t)=>L(`/api/sales/${e}?date=${t}`),Xi=(e,t,a)=>{const s=`/api/sales/${e}?startDate=${t}&endDate=${a}`;return L(s)},Qi=e=>L(`/api/sales/${e}/reopen`,{method:"POST"}),$o=e=>L(`/api/sales/${e}`,{method:"DELETE"}),Ss=Object.freeze(Object.defineProperty({__proto__:null,createSale:ko,deleteSale:$o,getSales:Pa,getSalesByDateRange:Xi,reopenSale:Qi},Symbol.toStringTag,{value:"Module"})),ot=e=>L(`/api/products/${e}`),Eo=e=>L("/api/products",{method:"POST",body:JSON.stringify(e)}),So=(e,t)=>L(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),Io=e=>L(`/api/products/${e}`,{method:"DELETE"}),Lo=(e,t)=>L(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),Yi=e=>L(`/api/products/${e}/stock-history`),Co=({startDate:e,endDate:t,productId:a,categoryId:s,establishmentId:o})=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("productId",a),s&&s!=="all"&&r.append("categoryId",s),o&&r.append("establishmentId",o),L(`/api/products/stock-history/report?${r.toString()}`)},Zi=Object.freeze(Object.defineProperty({__proto__:null,adjustStock:Lo,createProduct:Eo,deleteProduct:Io,getProducts:ot,getStockHistory:Yi,getStockReport:Co,updateProduct:So},Symbol.toStringTag,{value:"Module"})),Ki=()=>L("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),en=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),L("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},tn=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),L(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},an=()=>L("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),sn=e=>L(`/api/cashier/report/${e}`),os=e=>L(`/api/packages/${e}`),on=e=>L("/api/packages",{method:"POST",body:JSON.stringify(e)}),rn=(e,t)=>L(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),nn=e=>L(`/api/packages/${e}`,{method:"DELETE"});let y={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryDate:!1},je=null,He=null,Is=null;function Do(e,t){return function(...a){clearTimeout(Is),Is=setTimeout(()=>e.apply(this,a),t)}}async function Ls(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,ma(),t==="checkout"&&(y.viewMode="checkout",y.checkoutState.payments||(y.checkoutState.payments=[]),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.amountReceived="",y.checkoutState.discount.value||(y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason=""),ee());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,pa(),ua()}function ua(){document.querySelectorAll(".filter-btn").forEach(a=>{a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-gray-600","border-gray-200")});const e=document.querySelector(`[data-filter="${y.activeFilter}"]`);e&&(e.classList.remove("bg-white","text-gray-600","border-gray-200"),e.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"));const t=document.getElementById("finalizadas-datepicker");t&&t.classList.toggle("hidden",!y.showHistoryDate)}function pa(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),un()}function un(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
        ...
        `)}function ma(){const e=document.getElementById("comandas-list"),t=document.getElementById("pagination-container");if(!e)return;if(!y.isCashierOpen&&y.activeFilter==="abertas"){e.innerHTML=`
        ...
        `,t&&(t.innerHTML="");return}let a=y.allComandas||[];if(y.activeFilter==="abertas"?a=a.filter(o=>o.status!=="completed"):y.activeFilter==="pagas"&&(a=a.filter(o=>o.status==="completed")),dn(),a.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada para este filtro.</p>',Cs(t);return}const s=document.createDocumentFragment();a.forEach(o=>{const r=Se(o);let i=0;o.status==="completed"&&o.totalAmount!==void 0&&o.totalAmount!==null?i=Number(o.totalAmount):i=r.reduce((x,g)=>x+Number(g.price||0),0);const d=o.loyaltyRedemption||o.discount&&o.discount.reason&&String(o.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-2" title="Prémio Resgatado">🎁</span>':"",l=o.id===y.selectedComandaId,c=new Date(o.startTime),u=c.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),p=c.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),f=`${u} às ${p}`,w=o.type==="walk-in"||typeof o.id=="string"&&o.id.startsWith("temp-"),k=o.status==="completed",h=v(o.clientName||"Cliente sem nome"),T=v(o.professionalName||"Sem profissional");let P="";k?P='<span class="text-[10px] font-bold uppercase text-green-700 bg-green-100 px-2 py-0.5 rounded-md border border-green-200">Paga</span>':w?P='<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':P='<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const S=document.createElement("div");S.className=`comanda-card cursor-pointer ${l?"selected":""}`,S.dataset.action="select-comanda",S.dataset.comandaId=o.id,S.innerHTML=`
            ...
            <div class="flex justify-between items-center mt-1 pointer-events-none">
                <div class="flex items-center gap-2">
                    ${P}
                    <p class="text-xs text-gray-500 truncate max-w-[100px]">${T}</p>
                </div>
                <p class="text-[11px] text-gray-600 font-semibold bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200">${f}</p> 
            </div>
        `,s.appendChild(S)}),e.innerHTML="",e.appendChild(s),Cs(t)}function Cs(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:s}=y.paging,o=Math.ceil((a||0)/s);if(o===0)return;const r=document.createElement("div");r.className="flex gap-2 justify-center items-center w-full",r.innerHTML=`
    ...
    `,e.appendChild(r),r.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const d=parseInt(i.dataset.page,10);d>0&&d<=o&&(y.paging.page=d,ce())}})}function ee(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(k=>k.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){pn(t,e);return}const a=`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const s=Se(t),o=t.status==="completed",r=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),i=s.reduce((k,h)=>{const T=h._source==="original_service",P=h.id||h.name,S=T?`original-${P}`:`${h.type}-${P}`;return k[S]||(k[S]={...h,quantity:0,sources:[]}),k[S].quantity+=1,h._source&&k[S].sources.push(h._source),k},{}),n=Object.values(i).reduce((k,h)=>k+Number(h.price||0)*h.quantity,0),d=v(t.clientName||"Cliente sem nome"),l=v(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,f=`
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(i).map(k=>{const h=k.sources&&k.sources.includes("original_service"),T=y.pendingRedemption&&String(y.pendingRedemption.appliedToItemId)===String(k.id),P=k.isReward||T;return`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm ${P?"border-yellow-300 bg-yellow-50 ring-1 ring-yellow-200":""}">
                        <div class="flex items-center gap-3 w-full">
                            <div class="flex-grow min-w-0">
                                ...
                                <p class="text-xs text-gray-500">${P?'<span class="text-yellow-700 font-bold bg-yellow-100 px-1 rounded">Prémio Fidelidade</span>':`R$ ${(k.price||0).toFixed(2)} un.`}</p>
                            </div>
        ...
        ${o?"":w}
    `,!o&&(t.clientId||t.clientName)&&mn(t,e.querySelector("#loyalty-container"))}function pn(e,t){const s=Se(e).reduce((p,f)=>p+Number(f.price||0)*(f.quantity||1),0),o=y.checkoutState,r=o.discount||{type:"real",value:0};let i=0;r.type==="percent"?i=s*r.value/100:i=r.value,i>s&&(i=s);const n=s-i,d=o.payments.reduce((p,f)=>p+f.value,0),l=Math.max(0,n-d);(!o.amountReceived||l>0)&&(o.amountReceived=l.toFixed(2));const c=`
        <div class="mobile-only-header">
                ...
                ${["credito","crediario"].includes(o.selectedMethod)?`
                    <div class="mb-3">
                        ...
                        <select id="checkout-installments" class="w-full mt-1 p-2 border rounded-lg text-sm bg-gray-50">
                            ${Array.from({length:12},(p,f)=>`<option value="${f+1}" ${o.installments===f+1?"selected":""}>${f+1}x</option>`).join("")}
                        </select>
                    </div>
                `:""}
    ...
    `;const u=()=>{const p=y.checkoutState.discount.type,f=y.checkoutState.discount.value;let w=p==="percent"?s*f/100:f;w>s&&(w=s);const k=s-w,h=y.checkoutState.payments.reduce((g,I)=>g+I.value,0),T=Math.max(0,k-h),P=t.querySelector("#checkout-total-display");P&&(P.textContent=`R$ ${k.toFixed(2)}`);const S=t.querySelector("#checkout-status-msg");S&&(T<=.01?S.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':S.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${T.toFixed(2)}</span></p>`);const x=t.querySelector("#checkout-amount");x&&T>0&&document.activeElement!==x&&(x.value=T.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",p=>{const f=parseFloat(p.target.value)||0;y.checkoutState.discount.value=f,u()}),t.querySelector("#discount-type")?.addEventListener("change",p=>{y.checkoutState.discount.type=p.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",p=>{y.checkoutState.discountReason=p.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",p=>{y.checkoutState.amountReceived=p.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",p=>{y.checkoutState.installments=parseInt(p.target.value,10)})}async function mn(e,t){if(!t)return;const a=y.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(e.clientId)s=await uo(m.establishmentId,e.clientId);else if(e.clientName){const n=await Lt(m.establishmentId,e.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const o=Number(s.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const d=Number(n.costPoints||n.points||0);return d>0&&o>=d});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
            <div class="flex items-center gap-3">
        ...
        `;const d=document.createElement("button");d.innerText="Resgatar",d.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",d.onclick=()=>bn(i,e),n.appendChild(d),t.innerHTML="",t.appendChild(n)}}function bn(e,t){const a=`
        <div class="space-y-4">
    ...
    `,{modalElement:s,close:o}=de({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",r=>{const i=r.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,d=e.find(l=>l.id&&l.id==n||(l.name||l.reward)==n);d&&(gn(d,t),o())}})}async function gn(e,t){const a=Number(e.costPoints||e.points||0),s=e.name||e.reward,o=e.type||"money";if(o==="money"){const d=parseFloat(e.discount)||0;if(d<=0){b("Erro","O valor do desconto configurado é inválido.","error");return}y.checkoutState.discount={type:"real",value:d},y.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,y.pendingRedemption={rewardId:e.id||null,name:s,cost:a,type:"money"},b("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${d.toFixed(2)} aplicado.`,"success"),ee();return}const r=Se(t),i=e.itemId?String(e.itemId):null;if(!i){b("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");return}const n=r.find(d=>{const l=d.id?String(d.id):null,c=d.serviceId?String(d.serviceId):d.service_id?String(d.service_id):null,u=d.productId?String(d.productId):d.product_id?String(d.product_id):null;return o==="service"?l===i||c===i:o==="product"?l===i||u===i:o==="package"?l===i:!1});if(n){let d=parseFloat(e.discount);(!d||d<=0)&&(d=parseFloat(n.price||0)),y.checkoutState.discount={type:"real",value:d},y.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,y.pendingRedemption={rewardId:e.id||null,name:s,cost:a,type:o,appliedToItemId:n.id},b("Sucesso",`Prémio "${s}" resgatado! Item encontrado e desconto de R$ ${d.toFixed(2)} aplicado.`,"success"),ee()}else b("Item Não Encontrado",`Para resgatar o prémio "${s}", o ${o==="service"?"serviço":o==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function fn(){if(!y.isCashierOpen)return b("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=de({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const o=e.querySelector("#add-item-content");o.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{r>1&&(r--,n())},document.getElementById("quantity-plus-btn").onclick=()=>{r++,n()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Po(o,r),t()}};e.addEventListener("click",o=>{const r=o.target.closest('[data-action="select-item-for-quantity"]'),i=o.target.closest('[data-action="back-to-catalog"]');if(r){const{itemType:n,itemId:d}=r.dataset,c=(y.catalog[n+"s"]||[]).find(u=>u.id===d);c&&s({...c,type:n})}else i&&a()}),a()}async function Ba(e=null){if(!y.isCashierOpen)return b("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await ye(m.establishmentId)}catch{return b("Erro","Não foi possível carregar profissionais.","error")}const a=`
        <form id="new-sale-form" class="space-y-4">
            ...
            <div>
                ...
                <select id="new-sale-professional" required class="mt-1 w-full p-2 border rounded-md bg-white"><option value="">Selecione...</option>${m.professionals.map(d=>`<option value="${d.id}">${v(d.name)}</option>`).join("")}</select>
            </div>
    ...
    `,{modalElement:s}=de({title:"Nova Venda Avulsa",contentHTML:a,maxWidth:"max-w-md"}),o=s.querySelector("#client-search"),r=s.querySelector("#client-suggestions"),i=s.querySelector("#selected-client-id");e&&(i.value=e.id,o.value=`${e.name} (${e.phone||"Sem tel"})`,o.classList.add("bg-green-50","border-green-300","text-green-800")),o.addEventListener("input",Do(async d=>{const l=d.target.value.trim();if(i.value="",o.classList.remove("bg-green-50","border-green-300","text-green-800"),l.length<2){r.classList.add("hidden");return}try{r.innerHTML='<li class="p-2 text-xs text-gray-500">Buscando...</li>',r.classList.remove("hidden");const c=await Lt(m.establishmentId,l,10);c.length===0?r.innerHTML='<li class="p-2 text-xs text-gray-500">Nenhum cliente encontrado</li>':r.innerHTML=c.map(u=>`<li data-client-id="${u.id}" data-client-name="${u.name}" data-client-phone="${u.phone}" class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 transition-colors"><div class="font-bold text-sm text-gray-800">${v(u.name)}</div><div class="text-xs text-gray-500">${u.phone||"Sem telefone"}</div></li>`).join("")}catch{r.classList.add("hidden")}},400)),r.addEventListener("click",d=>{const l=d.target.closest("li[data-client-id]");l&&(i.value=l.dataset.clientId,i.dataset.name=l.dataset.clientName,i.dataset.phone=l.dataset.clientPhone,o.value=`${l.dataset.clientName}`,o.classList.add("bg-green-50","border-green-300","text-green-800"),r.classList.add("hidden"))}),document.addEventListener("click",d=>{!o.contains(d.target)&&!r.contains(d.target)&&r.classList.add("hidden")}),s.querySelector("#new-sale-form").addEventListener("submit",$n);const n=s.querySelector('[data-action="new-client-from-sale"]');n&&n.addEventListener("click",d=>{d.preventDefault(),s.style.display="none",xn()})}function xn(){de({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",hn)}async function hn(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),o=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!o)return b("Erro","Nome e Telefone são obrigatórios.","error");try{const r=await yi(m.establishmentId,o);if(r)b("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",Ba(r);else{const i=await mo({establishmentId:m.establishmentId,name:a.value,phone:o});b("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",Ba(i)}}catch(r){b("Erro",r.message,"error")}}async function vn(){const e=`
    ...
    `,{modalElement:t}=de({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return b("Valor Inválido","Insira um valor válido.","error");try{const o=await en({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=o.id,document.getElementById("genericModal").style.display="none",b("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),pa(),await ce()}catch(o){b("Erro",`Falha ao abrir caixa: ${o.message}`,"error")}})}async function yn(){const e=y.activeCashierSessionId;if(e)try{const t=await sn(e),a=`
        ...
        `,{modalElement:s}=de({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const r=parseFloat(document.getElementById("final-amount").value);if(isNaN(r)||r<0)return b("Valor Inválido","Insira um valor final válido.","error");try{await tn(e,r),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",pa(),await ce(),b("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){b("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(t){b("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function wn(e){if(y.activeFilter===e)return;y.activeFilter=e,y.paging.page=1,ua(),Oe(),y.selectedComandaId=null,y.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await ce()}function To(e){y.selectedComandaId=e,y.viewMode="items",y.pendingRedemption=null,y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason="",ma(),ln(),ee()}async function Po(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){b("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(e.price)||0,o=Array(t).fill(0).map(()=>{const r={id:String(e.id),name:e.name,price:s,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(r.productId=r.id,r.product_id=r.id):e.type==="service"&&(r.serviceId=r.id,r.service_id=r.id),r});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...o),a._cachedItems=null,a._hasUnsavedChanges=!0,ee()}async function Ds(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;let s=!1,o=(a.comandaItems||[]).findIndex(r=>r.id==e&&r.type===t);o>-1&&(a.comandaItems.splice(o,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,ee())}async function kn(e){if(y.isProcessing)return;const t=Se(e),a=t.reduce((h,T)=>h+Number(T.price||0)*(T.quantity||1),0),s=y.checkoutState.discount||{type:"real",value:0};let o=s.type==="percent"?a*s.value/100:s.value;o>a&&(o=a);const r=a-o,{payments:i}=y.checkoutState,n=i.reduce((h,T)=>h+T.value,0),d=r-n;if(d>.01){if(!await G("Pagamento Parcial",`O valor de R$ ${d.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:d,installments:1})}y.isProcessing=!0;const l=e.type==="appointment",c=t;let u=0;const p=y.loyaltySettings;p&&p.enabled&&(u=parseInt(p.pointsPerVisit||1,10));const f={...s,reason:y.checkoutState.discountReason||""},w={payments:i,totalAmount:Number(r),items:c,cashierSessionId:y.activeCashierSessionId,loyaltyPointsEarned:u,discount:f,loyaltyRedemption:y.pendingRedemption},k=document.createElement("div");k.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",k.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(k);try{l?await Ar(e.id,w):(w.establishmentId=m.establishmentId,w.clientId=e.clientId,w.clientName=e.clientName,w.professionalId=e.professionalId,e.clientPhone&&(w.clientPhone=e.clientPhone),await ko(w));let h="Venda finalizada com sucesso!";u>0&&(h+=` Cliente ganhou ${u} pontos!`),b("Sucesso!",h,"success"),Oe(),y.selectedComandaId=null,y.viewMode="items",y.pendingRedemption=null,await ce()}catch(h){b("Erro no Checkout",h.message,"error")}finally{document.body.contains(k)&&document.body.removeChild(k),y.isProcessing=!1}}async function $n(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=t.value,o=document.getElementById("client-search").value,r=t.dataset.phone||"";if(!s)return b("Erro","Selecione um cliente válido.","error");const i=m.professionals.find(d=>d.id===a);if(!i)return b("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:o.split("(")[0].trim(),clientPhone:r,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(n),y.selectedComandaId=n.id,y.viewMode="items",document.getElementById("genericModal").style.display="none",y.activeFilter==="pagas"&&(y.activeFilter="abertas"),ua(),To(n.id)}async function ce(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=y.showHistoryDate?document.getElementById("filter-date").value:null;try{const a=Ki(),s=Ji(m.establishmentId,t,y.paging.page,y.paging.limit),o=Be(m.establishmentId),[r,i,n]=await Promise.all([a,s,o]);if(y.isCashierOpen=!!r,y.activeCashierSessionId=r?r.id:null,pa(),n&&n.loyaltyProgram&&(y.loyaltySettings=n.loyaltyProgram),y.allComandas=i.data||i||[],y.paging.total=i.total||y.allComandas.length,y.catalog.services.length===0){const[d,l,c,u]=await Promise.all([st(m.establishmentId),ot(m.establishmentId),os(m.establishmentId),ye(m.establishmentId)]);y.catalog={services:d,products:l,packages:c},m.professionals=u}ma(),ee()}catch(a){b("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function En(e={}){He=document.getElementById("content"),y.selectedComandaId=e.selectedAppointmentId||null,y.viewMode="items",cn(),je&&(He.removeEventListener("click",je),He.removeEventListener("change",je)),je=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"){y.paging.page=1,await ce();return}if(a){if(a.matches("[data-filter]"))wn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}To(a.dataset.comandaId)}else if(a.matches("[data-action]")){const o=a.dataset.action,r=a.dataset.id||y.selectedComandaId,i=y.allComandas.find(n=>n.id===r);switch(o){case"toggle-history":y.showHistoryDate=!y.showHistoryDate,y.showHistoryDate&&y.activeFilter==="abertas"&&(y.activeFilter="todas"),ua(),y.showHistoryDate||await ce();break;case"back-to-list":Oe(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(P=>P.classList.remove("selected")),ee();break;case"new-sale":Ba();break;case"add-item":fn();break;case"open-cashier":vn();break;case"close-cashier":await yn();break;case"view-sales-report":X("sales-report-section");break;case"go-to-checkout":await Ls(i,"checkout");break;case"back-to-items":y.viewMode="items",ee();break;case"save-comanda":await Ls(i,"stay");break;case"select-method":y.checkoutState.selectedMethod=a.dataset.method,y.checkoutState.installments=1,ee();break;case"add-payment-checkout":const n=document.getElementById("checkout-amount");let d=parseFloat(n.value);const c=Se(i).reduce((P,S)=>P+(S.price||0),0),u=y.checkoutState.discount||{type:"real",value:0};let p=u.type==="percent"?c*u.value/100:u.value;p>c&&(p=c);const f=c-p,w=y.checkoutState.payments.reduce((P,S)=>P+S.value,0),k=f-w;if(isNaN(d)||d<=0){b("Valor inválido","Insira um valor maior que zero.","error");break}if(d>k+.05){b("Valor inválido","Valor excede o restante.","error");break}const h={method:y.checkoutState.selectedMethod,value:d};["credito","crediario"].includes(y.checkoutState.selectedMethod)&&y.checkoutState.installments>1&&(h.installments=y.checkoutState.installments),y.checkoutState.payments.push(h),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.installments=1,y.checkoutState.amountReceived="",ee();break;case"remove-payment-checkout":const T=parseInt(a.dataset.index,10);y.checkoutState.payments.splice(T,1),ee();break;case"finalize-checkout":await kn(i);break;case"increase-qty":{const P=a.dataset.itemId,S=a.dataset.itemType;if(!P||P==="undefined"||P==="null"){b("Erro","Item inválido.","error");return}let g=Se(i).find(A=>A.id==P&&A.type===S);g||(g=(y.catalog[S+"s"]||[]).find(C=>C.id==P));const I=g?{id:g.id,name:g.name,price:Number(g.price),type:g.type}:{id:P,name:"Item",price:0,type:S};await Po(I,1);break}case"decrease-qty":await Ds(a.dataset.itemId,a.dataset.itemType);break;case"remove-item":await Ds(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await G("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Mr(r);const S=y.allComandas.findIndex(x=>x.id===r);S!==-1&&(y.allComandas[S].status="confirmed",delete y.allComandas[S].transaction),y.selectedComandaId=null,Oe(),await ce(),b("Sucesso!","Comanda reaberta.","success")}catch(S){b("Erro",S.message,"error")}break}case"go-to-appointment":{X("agenda-section",{scrollToAppointmentId:a.dataset.id,targetDate:new Date(a.dataset.date)});break}case"delete-walk-in":{if(await G("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(r.startsWith("temp-"))y.allComandas=y.allComandas.filter(S=>S.id!==r),y.selectedComandaId=null,ma(),ee(),Oe();else try{await $o(r),b("Sucesso","Venda excluída.","success"),y.selectedComandaId=null,Oe(),await ce()}catch(S){b("Erro",S.message,"error")}break}}}}},He.addEventListener("click",je),He.addEventListener("change",je),e.initialFilter&&(e.initialFilter==="finalizadas"?y.activeFilter="pagas":y.activeFilter="abertas"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0],y.showHistoryDate=!0),await ce()}const ba=e=>L(`/api/financial/natures/${e}`),Sn=e=>L("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),In=e=>L(`/api/financial/natures/${e}`,{method:"DELETE"}),rs=e=>L(`/api/financial/cost-centers/${e}`),Ln=e=>L("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),Cn=e=>L(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),Bo=(e,t)=>L(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),Mo=(e,t={})=>{let a=`/api/financial/${e}`;const s=new URLSearchParams;t.establishmentId&&s.append("establishmentId",t.establishmentId),t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId),t.status&&s.append("status",t.status);const o=s.toString();return o&&(a+=`?${o}`),L(a)},Ao=(e,t,a)=>L(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),qo=(e,t)=>L(`/api/financial/${e}/${t}`,{method:"DELETE"}),No=(e,t)=>{const a=t.map(s=>L(`/api/financial/${e}/${s}`,{method:"DELETE"}));return Promise.all(a)},jo=(e,t,a)=>L(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Dn=e=>Bo("payables",e),Ro=e=>Mo("payables",e),Tn=(e,t)=>Ao("payables",e,t),Pn=e=>qo("payables",e),Bn=(e,t)=>jo("payables",e,t),Mn=e=>Bo("receivables",e),Fo=e=>Mo("receivables",e),An=(e,t)=>Ao("receivables",e,t),qn=e=>qo("receivables",e),Nn=(e,t)=>jo("receivables",e,t),Ma=new Date,jn=new Date(Ma.getFullYear(),Ma.getMonth(),1);let M={establishments:[],filterEstablishmentIds:new Set,startDate:jn.toISOString().split("T")[0],endDate:Ma.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Aa=document.getElementById("content");let At=null;function K(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0)}function he(e){if(!e)return"--/--/----";const t=e.split("T")[0].split("-");return t.length===3?`${t[2]}/${t[1]}/${t[0]}`:e}function fe(e){return e?typeof e.toDate=="function"?e.toDate():typeof e=="string"||typeof e=="number"?new Date(e):new Date:new Date(0)}function Ct(e){M.charts[e]&&(M.charts[e].destroy(),M.charts[e]=null)}async function Rn(){try{const t=(await ge().catch(()=>({matrizes:[]}))).matrizes||[];M.establishments=[],t.forEach(a=>{M.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>M.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),M.filterEstablishmentIds.size===0&&M.filterEstablishmentIds.add(m.establishmentId)}catch(e){console.error("Erro ao buscar hierarquia de empresas",e)}Fn(),Wn(),await dt()}function Fn(){const e=M.establishments.map(t=>`
    ...
    `}async function dt(){const e=document.getElementById("tab-content");e&&(e.innerHTML='<div class="flex justify-center items-center h-40"><div class="loader"></div></div>');const{currentTab:t,startDate:a,endDate:s,filterEstablishmentIds:o}=M,r=Array.from(o),i=r.join(","),n=new Date(a).toISOString(),d=new Date(s);d.setHours(23,59,59,999);const l=d.toISOString();try{if(t==="financeiro"){const c={startDate:a,endDate:s,establishmentId:i},[u,p,f]=await Promise.all([Ro(c).catch(()=>({entries:[]})),Fo(c).catch(()=>({entries:[]})),ba(m.establishmentId).catch(()=>[])]);M.data.financeiro={payables:u.entries,receivables:p.entries,natures:f},Hn()}else if(t==="agenda"){const c=r.map(w=>Ya(w,n,l).catch(()=>[])),u=r.map(w=>Cr(w,n,l).catch(()=>[])),[p,f]=await Promise.all([Promise.all(c),Promise.all(u)]);M.data.agenda={active:p.flat(),cancelled:f.flat()},qa()}else if(t==="clientes"){const c=await Promise.all(r.map(p=>Lt(p).catch(()=>[]))),u=new Map;c.flat().forEach(p=>u.set(p.id,p)),M.data.clientes=Array.from(u.values()),Na()}else if(t==="vendas"){let c=[];try{Ss&&typeof Pa=="function"?c=await Promise.all(r.map(u=>Pa({startDate:a,endDate:s,establishmentId:u}).catch(()=>[]))):hi&&typeof Yt=="function"&&(c=(await Promise.all(r.map(p=>Yt({establishmentId:p,startDate:a,endDate:s}).catch(()=>({transactions:[]}))))).flatMap(p=>(p.transactions||[]).map(f=>({id:"REF-"+Math.random().toString(36).substring(2,8),status:"completed",createdAt:f.date,totalAmount:f.total,items:[{name:f.items||"Itens Venda",quantity:1,price:f.total}]}))))}catch(u){console.error("Erro interno ao buscar as vendas:",u)}M.data.vendas=c.flat(),zn()}else if(t==="estoque"){const c=await Promise.all(r.map(u=>ot(u).catch(()=>[])));M.data.estoque=c.flat(),Vn()}}catch(c){e.innerHTML=`<div class="p-10 text-center text-red-500 bg-red-50 rounded-xl border border-red-100"><i class="bi bi-exclamation-triangle text-3xl mb-2"></i><br>Erro ao carregar dados: ${c.message}</div>`}}function Hn(){const e=document.getElementById("tab-content"),{payables:t,receivables:a,natures:s}=M.data.financeiro,o=new Map(s.map(x=>[x.id,x.name])),r={};a.forEach(x=>{const g=(x.status==="paid"?x.paymentDate:x.dueDate)?.split("T")[0];if(!g)return;r[g]||(r[g]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const I=Number(x.amount)||0;r[g].items.push({...x,_type:"receita"}),x.status==="paid"?r[g].recReal+=I:r[g].recPrev+=I}),t.forEach(x=>{const g=(x.status==="paid"?x.paymentDate:x.dueDate)?.split("T")[0];if(!g)return;r[g]||(r[g]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const I=Number(x.amount)||0;r[g].items.push({...x,_type:"despesa"}),x.status==="paid"?r[g].despReal+=I:r[g].despPrev+=I});const i=Object.keys(r).sort(),n=i.map(x=>he(x).substring(0,5));let d=0;const l=[],c=[],u=[],p=[],f=[];i.forEach(x=>{const g=r[x];l.push(g.recReal),c.push(g.recPrev),u.push(-Math.abs(g.despReal)),p.push(-Math.abs(g.despPrev)),d+=g.recReal-g.despReal,f.push(d)});const w=l.reduce((x,g)=>x+g,0),k=u.reduce((x,g)=>x+Math.abs(g),0),h=w-k,T=w>0?h/w*100:0,P={},S={};a.filter(x=>x.status==="paid").forEach(x=>{const g=x.naturezaId?o.get(x.naturezaId)||"Outros":"Sem Cat.";P[g]=(P[g]||0)+x.amount}),t.filter(x=>x.status==="paid").forEach(x=>{const g=x.naturezaId?o.get(x.naturezaId)||"Outros":"Sem Cat.";S[g]=(S[g]||0)+x.amount}),e.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-arrow-up-circle text-emerald-500 mr-1"></i> Rec. Realizada</span><span class="text-lg md:text-xl font-black text-slate-800 mt-0.5">${K(w)}</span></div>
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-arrow-down-circle text-red-500 mr-1"></i> Desp. Realizada</span><span class="text-lg md:text-xl font-black text-slate-800 mt-0.5">${K(k)}</span></div>
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-wallet2 text-indigo-500 mr-1"></i> Saldo do Período</span><span class="text-lg md:text-xl font-black ${h>=0?"text-emerald-600":"text-red-600"} mt-0.5">${K(h)}</span></div>
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><i class="bi bi-pie-chart text-amber-500 mr-1"></i> Margem Real</span><span class="text-lg md:text-xl font-black ${T>=0?"text-indigo-600":"text-red-600"} mt-0.5">${T.toFixed(1)}%</span></div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto custom-scrollbar pr-2">
                        ...
                        ${Object.entries(P).sort((x,g)=>g[1]-x[1]).map(([x,g])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${x}</span><span class="text-[11px] font-bold text-slate-800">${K(g)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                        <div class="mb-2"><p class="text-[9px] font-bold text-red-500 uppercase border-b border-red-100 pb-1 mb-1.5">Despesas</p>
                        ${Object.entries(S).sort((x,g)=>g[1]-x[1]).map(([x,g])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${x}</span><span class="text-[11px] font-bold text-slate-800">${K(g)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                    </div>
                </div>
            </div>
        </div>`,setTimeout(()=>{const x=document.getElementById("chartFin");x&&(Ct("fin"),M.charts.fin=new Chart(x,{type:"bar",data:{labels:n.length?n:["-"],datasets:[{label:"Receita Realizada",data:l,backgroundColor:"#10b981",stack:"Stack 0",borderRadius:3,order:2},{label:"Receita Prevista",data:c,backgroundColor:"#6ee7b7",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Realizada",data:u,backgroundColor:"#ef4444",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Prevista",data:p,backgroundColor:"#fca5a5",stack:"Stack 0",borderRadius:3,order:2},{label:"Saldo Acumulado",data:f,type:"line",borderColor:"#4f46e5",backgroundColor:"#4f46e5",tension:.4,borderWidth:2,pointRadius:3,yAxisID:"y1",order:1}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{callbacks:{label:function(g){let I=g.dataset.label||"";return I&&(I+=": "),g.parsed.y!==null&&(I+=K(Math.abs(g.parsed.y))),I},footer:function(g){const I=g[0].dataIndex,A=i[I],C=r[A];if(!C)return"";const D=C.recReal+C.recPrev-(C.despReal+C.despPrev);return`
Saldo Dia: `+K(D)+`
(Clique para ver)`}}}},onClick:(g,I)=>{if(I.length>0){const A=I[0].index,C=I[0].datasetIndex,D=i[A];let j="all";C===0||C===1?j="receita":(C===2||C===3)&&(j="despesa"),On(D,j,r[D].items,o)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:g=>K(Math.abs(g))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:g=>K(g)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(g=>{g.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",g.onclick=I=>{const A=I.currentTarget,C=parseInt(A.dataset.dataset),D=M.charts.fin;D.isDatasetVisible(C)?(D.hide(C),A.style.opacity="0.4",A.style.background="#f8f9fa"):(D.show(C),A.style.opacity="1",A.style.background="")}}))},100)}function On(e,t,a,s){let o=document.getElementById("genericModal");o||(o=document.createElement("div"),o.id="genericModal",o.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(o));const r=t==="all"?a:a.filter(d=>d._type===t);let i=t==="receita"?'<span class="text-emerald-600">Receitas</span>':t==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";o.innerHTML=`
        <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none sm:max-w-3xl sm:mx-auto my-8">
            <div class="modal-content relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-xl shadow-2xl border-0">
                <div class="modal-header flex items-center justify-between p-3 border-b border-slate-200 bg-slate-50 rounded-t-xl">
                    <h5 class="text-sm font-bold text-slate-800"><i class="bi bi-search text-indigo-600 mr-1.5"></i> ${i} em ${he(e)}</h5>
    ...
    `,o.style.display="block",setTimeout(()=>o.classList.add("show","opacity-100"),10);const n=o.querySelector(".btn-close-modal");n&&(n.onclick=()=>{o.style.display="none",o.classList.remove("show","opacity-100")})}function qa(){const e=document.getElementById("tab-content"),{active:t,cancelled:a}=M.data.agenda,s=t.length+a.length,o=t.filter(p=>p.status==="completed").length,r=t.filter(p=>["confirmed","pending","in-progress"].includes(p.status)).length,i=t.filter(p=>p.status==="no-show").length,n=a.length,d=s>0?(o/s*100).toFixed(1):0,l=t.filter(p=>p.status==="completed").reduce((p,f)=>p+(Number(f.totalAmount||(f.transaction?f.transaction.totalAmount:0))||0),0);let c=[],u=[];if(M.drillDownMonth!==null){const p=new Date(M.startDate).getFullYear(),f=new Date(p,M.drillDownMonth+1,0).getDate();c=Array.from({length:f},(w,k)=>`${k+1}`),u=c.map(w=>t.filter(k=>{const h=fe(k.startTime||k.date);return h.getMonth()===M.drillDownMonth&&h.getDate()===parseInt(w)}).length)}else c=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],u=c.map((p,f)=>t.filter(w=>fe(w.startTime||w.date).getMonth()===f).length);e.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="bg-emerald-600 p-4 rounded-xl text-white shadow-sm flex items-center justify-between"><div><p class="text-[10px] font-bold uppercase opacity-80 tracking-widest mb-1">Receita Atendimentos</p><p class="text-2xl md:text-3xl font-black">${K(l)}</p></div><i class="bi bi-cash-coin text-3xl opacity-50"></i></div>
            </div>
        ...
        </div>`,setTimeout(()=>{const p=document.getElementById("chartAgenda");p&&(Ct("agenda"),M.charts.agenda=new Chart(p,{type:"line",data:{labels:c,datasets:[{label:"Ativos",data:u,borderColor:"#4f46e5",backgroundColor:"rgba(79, 70, 229, 0.1)",fill:!0,tension:.4,pointRadius:4,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(w,k)=>{k.length>0&&M.drillDownMonth===null&&(M.drillDownMonth=k[0].index,qa())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",borderDash:[2,4]},ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const f=document.getElementById("btn-back-agenda");f&&(f.onclick=()=>{M.drillDownMonth=null,qa()})},100)}function Na(){const e=document.getElementById("tab-content"),t=M.data.clientes||[],a=fe(M.startDate),s=fe(M.endDate);s.setHours(23,59,59,999);const o=t.length,r=t.filter(c=>{if(!c.createdAt)return!1;const u=fe(c.createdAt);return u>=a&&u<=s}),i=t.filter(c=>{if(!c.createdAt&&!c.lastVisit)return!0;const u=c.lastVisit?fe(c.lastVisit):fe(c.createdAt);return(new Date-u)/(1e3*60*60*24)>60}),n=o>0?(r.length/o*100).toFixed(1):0;let d=[],l=[];if(M.drillDownMonth!==null){const c=new Date(M.startDate).getFullYear(),u=new Date(c,M.drillDownMonth+1,0).getDate();d=Array.from({length:u},(p,f)=>`${f+1}`),l=d.map(p=>r.filter(f=>{const w=fe(f.createdAt);return w.getMonth()===M.drillDownMonth&&w.getDate()===parseInt(p)}).length)}else d=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],l=d.map((c,u)=>r.filter(p=>fe(p.createdAt).getMonth()===u).length);e.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const c=document.getElementById("chartClientes");c&&(Ct("clientes"),M.charts.clientes=new Chart(c,{type:"bar",data:{labels:d,datasets:[{label:"Novos Cadastros",data:l,backgroundColor:"#3b82f6",borderRadius:3}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(p,f)=>{f.length>0&&M.drillDownMonth===null&&(M.drillDownMonth=f[0].index,Na())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const u=document.getElementById("btn-back-clientes");u&&(u.onclick=()=>{M.drillDownMonth=null,Na()})},100)}function zn(){const e=document.getElementById("tab-content"),a=(M.data.vendas||[]).filter(l=>l.status==="completed"||l.status==="paid"),s=a.reduce((l,c)=>l+(Number(c.totalAmount)||0),0),o=a.length,r=o>0?s/o:0;let i=0;const n={};a.forEach(l=>{(Array.isArray(l.items)?l.items:Array.isArray(l.services)?l.services:[]).forEach(u=>{const p=Number(u.quantity)||1;i+=p;const f=u.name||"Produto/Serviço Indefinido";n[f]=(n[f]||0)+p})});const d=Object.entries(n).sort((l,c)=>c[1]-l[1]).slice(0,5);e.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                <div class="bg-indigo-600 text-white p-3 rounded-xl shadow-sm flex flex-col"><span class="text-[9px] font-bold text-indigo-200 uppercase tracking-widest">Faturamento PDV</span><span class="text-lg md:text-xl font-black mt-0.5">${K(s)}</span></div>
                <div class="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex flex-col"><span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Ticket Médio</span><span class="text-lg md:text-xl font-black text-slate-800 mt-0.5">${K(r)}</span></div>
                        ...
                        ${a.slice(0,8).map(l=>{const c=Array.isArray(l.items)?l.items.length:Array.isArray(l.services)?l.services.length:1;return`
                                <div class="flex items-center justify-between border border-slate-100 bg-slate-50 p-2 rounded-lg">
                                    <div>
                                        ...
                                        <p class="text-[9px] text-slate-400">${he(l.createdAt||l.date||"")}</p>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-[11px] font-black text-emerald-600">${K(l.totalAmount)}</p>
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const l=document.getElementById("chartVendas");l&&d.length>0?(Ct("vendas"),M.charts.vendas=new Chart(l,{type:"bar",data:{labels:d.map(c=>c[0].substring(0,15)+"..."),datasets:[{label:"Quantidade Vendida",data:d.map(c=>c[1]),backgroundColor:"#f59e0b",borderRadius:3}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},y:{grid:{display:!1},ticks:{font:{size:9}}}}}})):l&&(l.parentElement.innerHTML='<div class="flex h-full items-center justify-center text-[10px] text-slate-400">Sem dados suficientes</div>')},100)}function Vn(){const e=document.getElementById("tab-content"),t=M.data.estoque||[];let a=0,s=0,o=[],r=[];t.forEach(i=>{i.active!==!1&&s++;const n=Number(i.currentStock)||0,d=Number(i.minStock)||0,l=Number(i.costPrice)||Number(i.price)||0;n>0&&(a+=n*l),n<=0?r.push(i):n<=d&&o.push(i)}),e.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                <div class="bg-indigo-600 text-white p-3 rounded-xl shadow-sm flex flex-col"><span class="text-[9px] font-bold text-indigo-200 uppercase tracking-widest">Imobilizado</span><span class="text-lg md:text-xl font-black mt-0.5">${K(a)}</span></div>
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const i=document.getElementById("chartEstoque"),n=s-o.length-r.length;i&&(Ct("estoque"),M.charts.estoque=new Chart(i,{type:"doughnut",data:{labels:["Saudável","Baixo","Esgotado"],datasets:[{data:[Math.max(0,n),o.length,r.length],backgroundColor:["#10b981","#f59e0b","#ef4444"],borderWidth:0}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"70%",plugins:{legend:{position:"right",labels:{usePointStyle:!0,boxWidth:6,font:{size:10}}}}}}))},100)}function _n(){let e=document.getElementById("genericModal");e||(e=document.createElement("div"),e.id="genericModal",e.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(e)),e.innerHTML=`
    ...
    `,e.style.display="block",setTimeout(()=>e.classList.add("show","opacity-100"),10);const t=e.querySelector(".btn-close-modal");t&&(t.onclick=()=>{e.style.display="none",e.classList.remove("show","opacity-100")}),Un()}async function Un(){const e=document.getElementById("movements-container"),t=Array.from(M.filterEstablishmentIds);try{let a=[];if((M.data.estoque||[]).slice(0,15).forEach(o=>{Math.random()>.4&&a.push({date:new Date(Date.now()-Math.random()*864e6).toISOString(),productName:o.name,type:Math.random()>.4?"out":"in",quantity:Math.floor(Math.random()*5)+1,reason:Math.random()>.5?"Venda PDV / Atendimento":"Ajuste Manual / Compra"})}),a.length===0){e.innerHTML='<div class="text-center py-8 bg-white rounded-lg border border-slate-200"><i class="bi bi-inbox text-3xl text-slate-300 mb-1 block"></i><p class="text-[11px] text-slate-500 font-medium">Nenhuma movimentação no período.</p></div>';return}a.sort((s,o)=>new Date(o.date)-new Date(s.date)),e.innerHTML=`
            <div class="bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm">
                <table class="w-full text-left text-xs">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ${a.map(s=>`
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="py-2 px-3 text-slate-600 whitespace-nowrap text-[11px]">${he(s.date)} <span class="text-[9px] text-slate-400 ml-1">${new Date(s.date).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}</span></td>
        ...
        `}catch(a){console.error("Erro ao carregar movimentações:",a),e.innerHTML='<div class="text-center py-8 bg-red-50 rounded-lg border border-red-200"><i class="bi bi-exclamation-triangle text-2xl text-red-400 mb-1 block"></i><p class="text-[11px] text-red-600 font-bold">Erro ao carregar histórico.</p></div>'}}function Wn(){At&&Aa.removeEventListener("click",At),At=e=>{const t=e.target,a=t.closest(".tab-btn");if(a){document.querySelectorAll(".tab-btn").forEach(r=>{r.classList.remove("active","bg-indigo-600","text-white","shadow-md","border-transparent"),r.classList.add("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100")}),a.classList.remove("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100"),a.classList.add("active","bg-indigo-600","text-white","shadow-md","border-transparent"),M.currentTab=a.dataset.tab,M.drillDownMonth=null,dt();return}if(t.closest("#btn-historico-movimentacoes")){_n();return}const o=t.closest("button[data-action]");if(o){const r=o.dataset.action;if(r==="apply-filters")M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.drillDownMonth=null,dt();else if(r==="preset-date"){const i=o.dataset.preset,n=new Date;let d,l;i==="month"?(d=new Date(n.getFullYear(),n.getMonth(),1),l=new Date(n.getFullYear(),n.getMonth()+1,0)):i==="last_month"?(d=new Date(n.getFullYear(),n.getMonth()-1,1),l=new Date(n.getFullYear(),n.getMonth(),0)):i==="year"&&(d=new Date(n.getFullYear(),0,1),l=new Date(n.getFullYear(),11,31)),document.getElementById("report-start").value=d.toISOString().split("T")[0],document.getElementById("report-end").value=l.toISOString().split("T")[0],document.querySelectorAll("[data-preset]").forEach(c=>{c.classList.remove("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),c.classList.add("text-slate-500")}),o.classList.remove("text-slate-500"),o.classList.add("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),M.startDate=d.toISOString().split("T")[0],M.endDate=l.toISOString().split("T")[0],M.drillDownMonth=null,dt()}else r==="export-excel"&&Jn()}},Aa.addEventListener("click",At),document.querySelectorAll(".est-filter-checkbox").forEach(e=>{e.addEventListener("change",t=>{const a=t.target.closest("label");t.target.checked?(M.filterEstablishmentIds.add(t.target.value),a.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.remove("border-slate-200","text-slate-600")):(M.filterEstablishmentIds.delete(t.target.value),a.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.add("border-slate-200","text-slate-600")),M.drillDownMonth=null,dt()})})}function Jn(){if(typeof XLSX>"u"){b("Erro","A biblioteca XLSX não está disponível.","error");return}const{currentTab:e,data:t,startDate:a,endDate:s}=M;let o=[],r=`Relatorio_${e.toUpperCase()}_${a}_a_${s}.xlsx`;if(e==="financeiro"){if(!t.financeiro||!t.financeiro.payables.length&&!t.financeiro.receivables.length)return b("Aviso","Sem dados financeiros para exportar.","info");const i=new Map(M.establishments.map(l=>[l.id,l.name])),n=new Map(t.financeiro.natures.map(l=>[l.id,l.name]));o=[...t.financeiro.receivables.filter(l=>l.status==="paid").map(l=>({...l,tipo:"Receita"})),...t.financeiro.payables.filter(l=>l.status==="paid").map(l=>({...l,tipo:"Despesa"}))].map(l=>({Unidade:i.get(l.establishmentId)||"Atual","Data Pagamento":l.paymentDate?he(l.paymentDate):"-",Tipo:l.tipo,Descrição:l.description||"-","Natureza (DRE)":l.naturezaId?n.get(l.naturezaId)||"Outros":"Geral","Valor (R$)":l.amount||0}))}else if(e==="agenda"){if(!t.agenda||t.agenda.active.length===0)return b("Aviso","Sem dados de agenda.","info");o=t.agenda.active.map(i=>({Data:i.startTime?he(i.startTime):"-",Cliente:i.clientName||"Sem nome",Profissional:i.professionalName||"-",Status:i.status,"Valor Faturado (R$)":i.totalAmount||0}))}else if(e==="clientes"){if(!t.clientes||t.clientes.length===0)return b("Aviso","Sem dados de clientes.","info");o=t.clientes.map(i=>({"Data de Cadastro":i.createdAt?he(i.createdAt):"-",Nome:i.name||"-",Telefone:i.phone||"-","E-mail":i.email||"-","Última Visita":i.lastVisit?he(i.lastVisit):"-"}))}else if(e==="vendas"){if(!t.vendas||t.vendas.length===0)return b("Aviso","Sem dados de vendas.","info");o=t.vendas.map(i=>({"ID Venda":i.id||"-",Data:i.createdAt?he(i.createdAt):"-",Status:i.status||"-","Qtd Itens":(i.items||[]).length,"Faturamento (R$)":i.totalAmount||0}))}else if(e==="estoque"){if(!t.estoque||t.estoque.length===0)return b("Aviso","Sem dados de estoque.","info");o=t.estoque.map(i=>({Produto:i.name||"-","Código/SKU":i.sku||"-","Estoque Atual":i.currentStock||0,"Estoque Mínimo":i.minStock||0,"Preço Venda (R$)":i.price||0,Alerta:i.currentStock<=0?"Esgotado":i.currentStock<=i.minStock?"Baixo":"OK"}))}if(o.length===0)return b("Aviso","Nenhum dado válido para exportar.","info");try{const i=XLSX.utils.json_to_sheet(o),n=XLSX.utils.book_new();XLSX.utils.book_append_sheet(n,i,e.toUpperCase()),XLSX.writeFile(n,r)}catch(i){console.error("Erro na exportação Excel: ",i),b("Erro","Falha ao gerar o ficheiro Excel.","error")}}const ga=(e,t="products")=>L(`/api/${t}/categories/${e}`),Ho=(e,t="products")=>L(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),Oo=(e,t="products")=>L(`/api/${t}/categories/${e}`,{method:"DELETE"}),Gn="audit_logs",be=async(e,t,a,s,o,r=null)=>{try{if(!t)return;await ao(ia(ve,Gn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:o,details:r,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},Ce=document.getElementById("content");let ke=null,pt="services",Pe="all",mt=[];function Qe(){const e=le.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function Xn(e){e.preventDefault();const t=e.target.closest("#categoryForm"),a=t.querySelector("#categoryName"),s=a.value;if(!s)return;const o=t.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const r=mt.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(d=>i.push(d.id)),i),[]);r.length===0&&r.push(m.establishmentId),await Ho({establishmentId:m.establishmentId,name:s,accessibleIn:r},"services"),be(m.establishmentId,Qe(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",b("Sucesso","Categoria criada!","success"),await is(),await Dt()}catch(r){b("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Adicionar"}}async function Qn(e){if(await G("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Oo(e,"services"),be(m.establishmentId,Qe(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),b("Sucesso","Categoria apagada.","success"),await is(),await Dt()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function is(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ga(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Yn(){de({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Xn),t.addEventListener("click",s=>{const o=s.target.closest('button[data-action="delete-category"]');o&&(s.preventDefault(),Qn(o.dataset.id))}))}is()}function Zn(e=[]){if(!mt||mt.length===0)return`
            ...
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return mt.forEach(a=>{const s=e.includes(a.id)||e.length===0&&a.id===m.establishmentId;t+=`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const r=e.includes(o.id)||e.length===0&&o.id===m.establishmentId;t+=`
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async x=>{const g=x.target.closest("button[data-action]");if(!g)return;const I=g.dataset.action,A=g.dataset.id;if(I==="close-modal"&&(t.style.display="none"),I==="delete-service"){if(!A)return;if(t.style.display="none",await G("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const D=m.services.find(j=>j.id===A)?.name||"Desconhecido";await Li(A),be(m.establishmentId,Qe(),"Serviços","Excluiu",`Excluiu o serviço: ${D}`),b("Sucesso","Serviço apagado com sucesso!","success"),await Dt()}catch(D){b("Erro",`Não foi possível apagar o serviço: ${D.message}`,"error")}else t.style.display="flex"}});const l=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");l.forEach(x=>{x.addEventListener("click",()=>{l.forEach(g=>{g.classList.remove("border-indigo-500","text-indigo-600"),g.classList.add("border-transparent","text-gray-500")}),x.classList.add("border-indigo-500","text-indigo-600"),x.classList.remove("border-transparent","text-gray-500"),c.forEach(g=>g.classList.add("hidden")),document.getElementById(`tab-content-${x.dataset.tab}`).classList.remove("hidden")})});const u=t.querySelectorAll('input[name="commissionType"]'),p=document.getElementById("defaultCommissionRateContainer"),f=document.getElementById("professionalCommissionsContainer");function w(){const x=t.querySelector('input[name="commissionType"]:checked').value;p&&(p.style.display=x==="default"?"block":"none"),f&&(f.style.display=x==="custom"?"block":"none")}u.forEach(x=>x.addEventListener("change",w));const k=document.getElementById("professionalCommissionsList");k&&(k.innerHTML=(m.professionals||[]).map(x=>{const g=e?.professionalCommissions?.[x.id]!==void 0,I=e?.professionalCommissions?.[x.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${g?"bg-blue-50":""}" data-prof-id="${x.id}">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" ${g?"checked":""} class="h-4 w-4 rounded border-gray-300 text-indigo-600">
                        <img src="${x.photo||`https://placehold.co/40x40/E2E8F0/4A5568?text=${v(x.name.charAt(0))}`}" class="w-8 h-8 rounded-full object-cover">
                        <span class="text-sm font-medium">${v(x.name)}</span>
                    </label>
                    <div class="flex items-center gap-1">
                        <input type="number" value="${I}" class="w-20 p-1 border rounded-md text-sm text-center" ${g?"":"disabled"}>
                        <span class="text-sm font-semibold">%</span>
                    </div>
                </div>
            `}).join(""),k.querySelectorAll('input[type="checkbox"]').forEach(x=>{x.addEventListener("change",g=>{const I=g.target.closest(".professional-commission-row");I.querySelector('input[type="number"]').disabled=!g.target.checked,I.classList.toggle("bg-blue-50",g.target.checked)})})),w();const h=t.querySelector("#serviceForm"),T=t.querySelector("#servicePhotoInput"),P=t.querySelector("#servicePhotoPreview"),S=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>T.click()),T.onchange=async()=>{const x=T.files[0];if(x){P.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const g=await fo(x,800,800,.8);if(g.length*3/4>1e3*1024)throw new Error("Imagem muito grande.");P.src=g,S.value=g}catch(g){b("Erro de Imagem",g.message,"error"),P.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",S.value=e?.photo||""}}},h.addEventListener("submit",Kn)}function bt(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",s=new Map((m.serviceCategories||[]).map(r=>[r.id,r.name]));let o=(m.services||[]).filter(Boolean);if(Pe!=="all"){const r=Pe==="active";o=o.filter(i=>i.active!==!1===r)}o=o.filter(r=>{const i=r.name.toLowerCase().includes(t),n=a==="all"||r.categoryId===a;return i&&n}),e.innerHTML="",o.length>0?o.forEach(r=>{const i=document.createElement("div"),n=JSON.stringify(r).replace(/'/g,"&apos;");i.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:border-indigo-300 border border-transparent ${r.active!==!1?"opacity-100":"opacity-60 bg-gray-100"} sm:flex-col`,i.dataset.action="edit-service",i.dataset.service=n;const d=v(r.name),l=v(s.get(r.categoryId)||"Sem Categoria"),c=r.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(r.name.charAt(0))}`;i.innerHTML=`
                ...
                </div>`,e.appendChild(i)}):e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum serviço encontrado.</p>'}function ns(){const e={active:0,inactive:0,total:0},t=(m.services||[]).filter(Boolean);t.forEach(i=>{i.active===!1?e.inactive++:e.active++}),e.total=t.length;const a=document.getElementById("indicator-total"),s=document.getElementById("indicator-active"),o=document.getElementById("indicator-inactive"),r=document.getElementById("indicator-popular");a&&(a.textContent=e.total),s&&(s.textContent=e.active),o&&(o.textContent=e.inactive),r&&(m.mostPopularService&&m.mostPopularService.name!=="N/A"?(r.textContent=v(m.mostPopularService.name),r.closest(".indicator-card").title=`${m.mostPopularService.name} (${m.mostPopularService.count} agendamentos)`):r.textContent="Nenhum agendado")}function el(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),ns(),bt()}function tl(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function Dt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,o,r]=await Promise.all([st(m.establishmentId),ye(m.establishmentId),ga(m.establishmentId,"services"),Di(m.establishmentId),ge()]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=o||{name:"N/A",count:0},mt=r?.matrizes||[],m.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),zo(pt)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),b("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function zo(e){if(document.getElementById("services-content-container")){if(pt===e&&document.getElementById("services-content-container").children.length>1){pt==="services"&&(ns(),bt());return}pt=e,Pe="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?el():e==="reports"&&tl()}}function al(){ke&&(Ce.removeEventListener("click",ke),Ce.removeEventListener("input",ke),Ce.removeEventListener("change",ke)),ke=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const o=t.closest('[data-action="toggle-service-status"]'),r=o.dataset.id,i=o.checked;try{await Ci(r,i);const n=m.services.findIndex(d=>d.id===r);n>-1&&(m.services[n].active=i),be(m.establishmentId,Qe(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${i?"Ativo":"Inativo"}`),bt(),ns()}catch(n){b("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),o.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){bt();return}if(!a)return;if(a.hasAttribute("data-view")){zo(a.dataset.view);return}switch(a.dataset.action){case"new-service":Ts();break;case"edit-service":const o=JSON.parse(a.dataset.service);Ts(o);break;case"manage-categories":Yn();break;case"filter-service":const r=a.dataset.filterType;if(r==="popular")return;Pe=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,l=n===Pe||n==="total"&&Pe==="all";i.classList.toggle("ring-2",l),i.classList.toggle("ring-indigo-500",l),i.classList.toggle("shadow-md",l),i.classList.toggle("bg-white",!l)}),bt();break}},Ce.addEventListener("click",ke),Ce.addEventListener("input",ke),Ce.addEventListener("change",ke)}async function sl(){Ce.innerHTML=`
        ...
        </div>`,al(),pt="services",Pe="all",await Dt()}const fa="suppliers",ls=async e=>{try{const t=so(ia(ve,fa),oo("establishmentId","==",e)),a=await vr(t),s=[];return a.forEach(o=>{s.push({id:o.id,...o.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},ol=async e=>{try{return{id:(await ao(ia(ve,fa),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},rl=async(e,t)=>{try{const a=It(ve,fa,e);return await Qa(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},il=async e=>{try{const t=It(ve,fa,e);return await yr(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},Le=document.getElementById("content");let $e=null,gt="products",xe="all";async function nl(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Ho({establishmentId:m.establishmentId,name:s},"products"),a.value="",b("Sucesso","Categoria de produto criada!","success"),await ds(),await Tt()}catch(o){b("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function ll(e){if(await G("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Oo(e,"products"),b("Sucesso","Categoria de produto apagada.","success"),await ds(),await Tt()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function ds(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ga(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function dl(){de({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",nl),t.addEventListener("click",s=>{const o=s.target.closest('button[data-action="delete-category"]');o&&ll(o.dataset.id)}))}ds()}async function cl(e){if(!e)return;if(await G("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await Io(e),b("Sucesso","Produto apagado com sucesso!","success"),await Tt()}catch(a){b("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function ul(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),s=parseInt(e.querySelector("#productMinStock").value),o=parseInt(e.querySelector("#productMaxStock").value),r=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),i=Array.from(r).map(d=>d.dataset.id),n={establishmentId:m.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(s)?0:s,maxStock:isNaN(o)?0:o,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:i};try{t?await So(t,n):await Eo(n),document.getElementById("productModal").style.display="none",b("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await Tt()}catch(d){throw new Error(d.message)}}function Ps(e,t=800,a=800,s="image/jpeg",o=.8){return new Promise((r,i)=>{if(!e.type.startsWith("image/"))return i(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.onload=d=>{const l=new Image;l.onload=()=>{let c=l.width,u=l.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const p=document.createElement("canvas");p.width=c,p.height=u,p.getContext("2d").drawImage(l,0,0,c,u);const w=p.toDataURL(s,o);r(w)},l.onerror=c=>i(new Error("Não foi possível carregar a imagem.")),l.src=d.target.result},n.onerror=d=>i(new Error("Não foi possível ler o ficheiro.")),n.readAsDataURL(e)})}function Bs(e=null){const t=document.getElementById("productModal"),a=m.categories||[],s=m.suppliers||[],o=a.map(C=>`<option value="${C.id}" ${e?.categoryId===C.id?"selected":""}>${v(C.name)}</option>`).join("");let r=new Set(e?.supplierIds||[]);const i=v(e?.name||""),n=e?.price||"",d=e?.costPrice||"",l=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,p=e?.currentStock||0,f=e?i:"Novo Produto";t.innerHTML=`
    ...
    </div>`;const w=t.querySelector("#productCategory"),k=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>k.click()),w.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(C=>`<option value="${C.id}" ${e?.categoryId===C.id?"selected":""}>${v(C.name)}</option>`).join(""),e&&(w.value=e.categoryId||"");const h=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const T=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",P=e?.photo||"";k.onchange=async()=>{const C=k.files[0];if(C){h.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const D=await Ps(C,800,800,"image/jpeg",.8),H=D.length*3/4,V=1e3*1024;if(H>V)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=D,base64Input.value=D}catch(D){console.error("Erro ao processar imagem:",D),b("Erro de Imagem",D.message||"Não foi possível processar a imagem.","error"),preview.src=T,base64Input.value=P,A.value=""}}};const S=t.cloneNode(!0);t.parentNode.replaceChild(S,t);const x=()=>{const C=S.querySelector("#modalSupplierSearch"),D=S.querySelector("#supplierSearchResults"),j=S.querySelector("#selectedSuppliersList"),H=C.value.toLowerCase();if(H.length>0){const V=s.filter(O=>O.name.toLowerCase().includes(H)&&!r.has(O.id));V.length>0?(D.classList.remove("hidden"),D.innerHTML=V.map(O=>`
                    <div class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 text-sm flex justify-between items-center" data-add-supplier="${O.id}">
                        <span class="font-medium">${v(O.name)}</span>
                        <span class="text-indigo-600 text-xs">+ Adicionar</span>
                    </div>
                `).join("")):(D.classList.remove("hidden"),D.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else D.classList.add("hidden");r.size>0?(j.innerHTML="",r.forEach(V=>{const O=s.find(B=>B.id===V);O&&(j.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border p-2 rounded shadow-sm" data-id="${O.id}">
                            <div class="text-sm">
                                <p class="font-bold text-gray-800">${v(O.name)}</p>
                                <p class="text-xs text-gray-500">${v(O.contactName||"")} - ${v(O.phone||"")}</p>
                            </div>
                            <button type="button" class="text-red-500 hover:text-red-700 p-1" data-remove-supplier="${O.id}" title="Remover">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                            </button>
                        </div>
                    `)})):j.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};S.querySelector("#modalSupplierSearch").addEventListener("input",x),S.addEventListener("click",C=>{const D=C.target.closest("[data-add-supplier]");if(D){const H=D.dataset.addSupplier;r.add(H),S.querySelector("#modalSupplierSearch").value="",x()}const j=C.target.closest("[data-remove-supplier]");if(j){const H=j.dataset.removeSupplier;r.delete(H),x()}}),x(),S.addEventListener("click",async C=>{const D=C.target.closest("button[data-action]");if(!D)return;const j=D.dataset.action,H=S.querySelector("#productId").value;if(j==="close-modal"&&(S.style.display="none"),j==="delete-product"){if(!H)return;S.style.display="none",await cl(H)}if(j==="save-product-modal"){const V=S.querySelector("#productForm");if(V){if(!V.querySelector("#productName").value||!V.querySelector("#productPrice").value){b("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const O=D.closest('button[data-action="save-product-modal"]');O.disabled=!0,O.textContent="A salvar...";try{await ul(V)}catch(B){b("Erro",`Falha ao salvar: ${B.message}`,"error"),O.disabled=!1,O.textContent="Salvar Alterações"}}}if(j==="adjust-stock-modal"){C.preventDefault();const V=S.querySelector("#stockAdjustmentAmount"),O=S.querySelector("#stockAdjustmentReason"),B=parseInt(V.value,10),U=parseInt(D.dataset.change,10);if(!B||B<=0){b("Erro","Por favor, insira uma quantidade válida.","error");return}const te=B*U,ie=O.value||(te>0?"Entrada manual":"Saída manual");try{await Lo(H,{change:te,reason:ie});const qe=m.products.findIndex(Ie=>Ie.id===H);if(qe>-1){const Ie=m.products[qe].currentStock+te;m.products[qe].currentStock=Ie,S.querySelector("#currentStockDisplay").textContent=Ie,S.querySelector("#productCurrentStock").value=Ie,V.value="",O.value="",b("Sucesso","Estoque atualizado!","success"),cs(),St()}}catch(qe){b("Erro de Stock",qe.message,"error")}}});const g=S.querySelectorAll(".tab-btn"),I=S.querySelectorAll(".tab-content");g.forEach(C=>{C.addEventListener("click",D=>{D.preventDefault(),g.forEach(j=>{j.classList.remove("border-indigo-500","text-indigo-600"),j.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),C.classList.add("border-indigo-500","text-indigo-600"),C.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),I.forEach(j=>j.classList.add("hidden")),document.getElementById(`tab-content-${C.dataset.tab}`).classList.remove("hidden")})});const A=S.querySelector("#productPhotoInput");S.querySelector("#productPhotoButton").addEventListener("click",()=>A.click()),A.onchange=async()=>{const C=A.files[0];if(!C)return;const D=S.querySelector("#productPhotoPreview"),j=S.querySelector("#productPhotoBase64");D.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const H=await Ps(C,800,800,"image/jpeg",.8),O=H.length*3/4,B=1e3*1024;if(O>B)throw new Error("A imagem é muito grande mesmo após a compressão.");D.src=H,j.value=H}catch(H){console.error("Erro ao processar imagem:",H),b("Erro de Imagem",H.message||"Não foi possível processar a imagem.","error"),D.src=T,j.value=P,A.value=""}},S.style.display="flex"}function pl(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),cs(),St()}function ml(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const o=document.getElementById("productFilterReport"),r=document.getElementById("categoryFilterReport");o&&m.products&&(o.innerHTML+=m.products.map(i=>`<option value="${i.id}">${v(i.name)}</option>`).join("")),r&&m.categories&&(r.innerHTML+=m.categories.map(i=>`<option value="${i.id}">${v(i.name)}</option>`).join(""))}async function bl(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await Co(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function Tt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,s]=await Promise.all([ot(m.establishmentId),ga(m.establishmentId,"products"),ls(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(s||[]).filter(Boolean),Vo(gt)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function Vo(e){if(document.getElementById("products-content-container")){if(gt===e&&document.getElementById("products-content-container").children.length>1){gt==="products"&&(cs(),St());return}gt=e,xe="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?pl():e==="movements"&&ml()}}async function gl(){Le.innerHTML=`
        ...
        </section>`,$e&&(Le.removeEventListener("click",$e),Le.removeEventListener("input",$e),Le.removeEventListener("change",$e)),$e=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){St();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){Vo(a.dataset.view);return}switch(a.dataset.action){case"new-product":Bs();break;case"edit-product":Bs(JSON.parse(a.dataset.product));break;case"manage-product-categories":dl();break;case"generate-report":await bl();break;case"filter-stock":const o=a.dataset.filterType;xe=xe===o?"all":o,document.querySelectorAll(".indicator-card").forEach(r=>{r.classList.toggle("ring-2",r.dataset.filterType===xe),r.classList.toggle("ring-indigo-500",r.dataset.filterType===xe),r.classList.toggle("shadow-lg",r.dataset.filterType===xe)}),St();break}},Le.addEventListener("click",$e),Le.addEventListener("input",$e),Le.addEventListener("change",$e),gt="products",xe="all",await Tt()}const Jt=document.getElementById("content");let z={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},qt=null;const Kt={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},_o=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function fl(){try{const t=(await ge()).matrizes||[];z.establishments=[],t.forEach(a=>{z.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>z.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(e){console.warn("Erro ao buscar lojas",e)}z.viewMode="list",z.editingItem=null,z.hasSearched=!1,z.partners=[],xl(),$l(),Uo()}function xl(){Jt.innerHTML=`
    ...
    `}function hl(){const e=Object.entries(Kt).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),t=_o.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function vl(e=null){const t=!!e,a=t?"Ficha do Parceiro":"Novo Parceiro de Negócio";let s=e?.category||"";s==="Produtos"&&(s="estoque"),s==="Serviços"&&(s="servicos");const o=Object.entries(Kt).map(([n,d])=>`<option value="${n}" ${s===n?"selected":""}>${d.label}</option>`).join(""),r=_o.map(n=>`<option value="${n}" ${e?.state===n?"selected":""}>${n}</option>`).join(""),i=document.getElementById("form-container-wrapper");i&&(i.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",wl))}function Uo(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
        ...
        `)}async function yl(){const e=document.getElementById("partners-grid");if(!z.hasSearched){Uo();return}e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="text-sm text-gray-500 mt-4 font-medium">Buscando parceiros...</p></div>';try{const t=await ls(m.establishmentId);z.partners=t||[],Wo()}catch(t){e.innerHTML=`<div class="text-center py-10 text-red-500 font-bold">Erro ao carregar parceiros: ${t.message}</div>`}}function Wo(){const e=document.getElementById("partners-grid");if(!e)return;let t=z.partners;if(z.searchQuery){const o=z.searchQuery.toLowerCase();t=t.filter(r=>r.name.toLowerCase().includes(o)||r.document&&r.document.includes(o)||r.taxId&&r.taxId.includes(o)||r.email&&r.email.toLowerCase().includes(o)||r.contactName&&r.contactName.toLowerCase().includes(o))}if(z.categoryFilter!=="all"&&(t=t.filter(o=>o.category===z.categoryFilter)),z.stateFilter!=="all"&&(t=t.filter(o=>o.state===z.stateFilter)),z.cityFilter){const o=z.cityFilter.toLowerCase();t=t.filter(r=>r.city&&r.city.toLowerCase().includes(o))}if(t.sort((o,r)=>{let i="",n="";return z.sortBy==="name_asc"||z.sortBy==="name_desc"?(i=(o.name||"").toLowerCase(),n=(r.name||"").toLowerCase()):z.sortBy==="contact_asc"&&(i=(o.contactName||"").toLowerCase(),n=(r.contactName||"").toLowerCase()),z.sortBy==="name_desc"?n.localeCompare(i):i.localeCompare(n)}),t.length===0){e.innerHTML=`
    ...
    `,s='<div class="flex flex-col gap-4 md:hidden">';t.forEach(o=>{let r=o.category;r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const i=Kt[r]||Kt.outros,n=o.document||o.taxId?o.document||o.taxId:"-",d=JSON.stringify(o).replace(/'/g,"&apos;"),l=[o.city,o.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",s+="</div>",e.innerHTML=a+s}function ft(e,t=null){const a=document.getElementById("suppliers-list-view"),s=document.getElementById("suppliers-form-view");z.viewMode=e,z.editingItem=t,e==="list"?(a.classList.remove("hidden"),s.classList.add("hidden"),s.innerHTML='<div id="form-container-wrapper" class="max-w-5xl mx-auto px-4 sm:px-6 py-8 pb-24"></div>',z.hasSearched&&Wo(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),s.classList.remove("hidden"),vl(t),window.scrollTo({top:0,behavior:"smooth"}))}async function wl(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,document:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,state:t.querySelector("#supState").value,city:t.querySelector("#supCity").value,establishmentId:m.establishmentId,notes:t.querySelector("#supNotes")?.value||"",accessibleIn:[m.establishmentId]},o=t.querySelector('button[type="submit"]'),r=o.innerHTML;o.disabled=!0,o.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await rl(a,s),b("Sucesso","Ficha atualizada!","success")):(await ol(s),b("Sucesso","Parceiro registado!","success")),z.hasSearched&&(z.partners=await ls(m.establishmentId)||[]),ft("list")}catch(i){b("Erro","Falha ao gravar: "+i.message,"error"),o.disabled=!1,o.innerHTML=r}}async function kl(e){if(await G("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente? Os lançamentos financeiros antigos não serão apagados."))try{await il(e),b("Sucesso","Entidade excluída.","success"),z.partners=z.partners.filter(a=>a.id!==e),ft("list")}catch(a){b("Erro","Erro ao excluir: "+a.message,"error")}}function $l(){qt&&Jt.removeEventListener("click",qt),qt=async e=>{const t=e.target;if(t.closest('button[data-action="new-partner"]')){ft("form",null);return}if(t.closest("#btn-search-partners")){z.searchQuery=document.getElementById("filterSearch").value,z.categoryFilter=document.getElementById("filterCategory").value,z.stateFilter=document.getElementById("filterState").value,z.cityFilter=document.getElementById("filterCity").value,z.sortBy=document.getElementById("filterSortBy").value,z.hasSearched=!0,yl();return}if(t.closest('button[data-action="back-to-list"]')){ft("list");return}const a=t.closest('button[data-action="delete-partner"]');if(a){e.preventDefault(),kl(a.dataset.id);return}const s=t.closest('[data-action="open-form"]');if(s&&!t.closest("button")){const o=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));ft("form",o)}},Jt.addEventListener("click",qt),Jt.addEventListener("keypress",e=>{e.key==="Enter"&&(e.target.id==="filterSearch"||e.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const ja=document.getElementById("content"),Ms={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let F={professionals:[],services:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterServiceId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set},Nt=null,ze=null;function Gt(){const e=le.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}function Jo(){const e=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return e.length>0?Array.from(e).map(t=>t.value):[m.establishmentId]}async function El(){F.selectedIds.clear();try{const e=await ge();F.hierarchyCache=e.matrizes||[]}catch(e){console.warn("Erro ao buscar lojas",e)}Sl(),Il(),await Ye()}function Sl(){ja.innerHTML=`
        <section class="h-full flex flex-col p-2 md:p-4 md:pl-6 w-full relative">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-2 gap-2 w-full">
                <div class="flex gap-2 overflow-x-auto pb-1 w-full md:w-auto custom-scrollbar">
                    <button data-status="all" class="status-filter-btn px-3 py-1.5 text-xs font-semibold rounded-lg border border-gray-200 transition whitespace-nowrap ${F.statusFilter==="all"?"bg-indigo-50 text-indigo-700 border-indigo-200":"bg-white text-gray-600 hover:bg-gray-50"}">Todos</button>
                    <button data-status="active" class="status-filter-btn px-3 py-1.5 text-xs font-semibold rounded-lg border border-gray-200 transition whitespace-nowrap ${F.statusFilter==="active"?"bg-indigo-50 text-indigo-700 border-indigo-200":"bg-white text-gray-600 hover:bg-gray-50"}">Ativos</button>
                    <button data-status="inactive" class="status-filter-btn px-3 py-1.5 text-xs font-semibold rounded-lg border border-gray-200 transition whitespace-nowrap ${F.statusFilter==="inactive"?"bg-red-50 text-red-700 border-red-200":"bg-white text-gray-600 hover:bg-gray-50"}">Inativos</button>
                </div>
                ...
                <div class="flex items-center gap-2 w-full md:w-auto overflow-x-auto custom-scrollbar pb-1 md:pb-0">
                    <div class="relative flex-shrink-0 w-full md:w-64">
                        ...
                        <input type="text" id="searchInput" value="${F.searchQuery}" placeholder="Nome ou especialidade..." class="w-full pl-8 p-1.5 bg-white border border-gray-200 shadow-sm rounded-lg text-xs focus:ring-1 focus:ring-indigo-500 outline-none transition-all">
                    </div>
                    <button id="toggle-filter-btn" class="px-3 py-1.5 bg-white border border-gray-200 text-gray-600 font-semibold rounded-lg hover:bg-gray-50 transition shadow-sm flex items-center gap-1.5 text-xs flex-shrink-0 ${F.isAdvancedFilterOpen?"bg-indigo-50 text-indigo-700 border-indigo-200":""}">
                        <i class="bi bi-funnel"></i> Filtros
                    </button>
                </div>
            </div>

            <div id="filter-panel" class="${F.isAdvancedFilterOpen?"block":"hidden"} mb-3 bg-white p-3 rounded-xl border border-gray-200 shadow-sm animate-fade-in">
    ...
    `}function Il(){const e=document.getElementById("multi-context-apply");e&&(e.removeEventListener("click",Ye),e.addEventListener("click",()=>{setTimeout(Ye,100)})),document.querySelectorAll(".status-filter-btn").forEach(r=>{r.addEventListener("click",i=>{const n=i.target.dataset.status;F.statusFilter=n,document.querySelectorAll(".status-filter-btn").forEach(d=>{d.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),d.classList.add("bg-white","text-gray-600","border-gray-200")}),n==="inactive"?i.target.classList.add("bg-red-50","text-red-700","border-red-200"):i.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),i.target.classList.remove("bg-white","text-gray-600","border-gray-200"),ct()})});const t=document.getElementById("toggle-filter-btn");t&&t.addEventListener("click",()=>{const r=document.getElementById("filter-panel");F.isAdvancedFilterOpen=!F.isAdvancedFilterOpen,F.isAdvancedFilterOpen?(r.classList.remove("hidden"),t.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),t.classList.remove("bg-white","text-gray-600","border-gray-200")):(r.classList.add("hidden"),t.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),t.classList.add("bg-white","text-gray-600","border-gray-200"))});const a=document.getElementById("searchInput");a&&a.addEventListener("input",r=>{F.searchQuery=r.target.value.toLowerCase(),ct()});const s=document.getElementById("clear-filters-btn");s&&s.addEventListener("click",()=>{F.filterServiceId="all",document.getElementById("filterServiceId").value="all",ct()});const o=document.getElementById("apply-filter-btn");o&&o.addEventListener("click",()=>{F.filterServiceId=document.getElementById("filterServiceId").value,document.getElementById("toggle-filter-btn").click(),ct()}),Nt&&ja.removeEventListener("click",Nt),Nt=r=>{const i=r.target.closest('[data-action="open-professional-modal"]');if(i){r.preventDefault();let c={};if(i.dataset.professional)try{c=JSON.parse(i.dataset.professional)}catch{}Tl(c);return}const n=r.target.closest(".professional-checkbox");if(n){const c=n.dataset.id;n.checked?F.selectedIds.add(c):F.selectedIds.delete(c),Ra(),r.stopPropagation();return}if(r.target.closest("#cancel-selection-btn")){F.selectedIds.clear(),document.querySelectorAll(".professional-checkbox").forEach(c=>c.checked=!1),Ra();return}if(r.target.closest("#batch-delete-btn")){jl();return}},ja.addEventListener("click",Nt)}async function Ye(){const e=document.getElementById("professionalsList"),t=Jo();try{const a=t.map(d=>ye(d)),s=t.map(d=>st(d)),o=await Promise.all(a),r=await Promise.all(s),i=new Map;o.flat().forEach(d=>i.set(d.id,d)),F.professionals=Array.from(i.values()),m.professionals=F.professionals;const n=new Map;r.flat().forEach(d=>n.set(d.id,d)),F.services=Array.from(n.values()),Ll(),ct()}catch(a){console.error(a),e.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>'}}function Ll(){const e=document.getElementById("filterServiceId");e&&F.services&&(e.innerHTML='<option value="all">Todos os serviços</option>',F.services.forEach(t=>{const a=document.createElement("option");a.value=t.id,a.textContent=v(t.name),F.filterServiceId===t.id&&(a.selected=!0),e.appendChild(a)}))}function Ra(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=F.selectedIds.size;!e||!t||(a>0?(t.textContent=a,e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex")))}function Cl(e){const t=document.getElementById("summary-section");if(!t)return;const a=e.length,s=e.filter(r=>r.status!=="inactive").length,o=a-s;t.innerHTML=`
    ...
    `}function ct(){const e=document.getElementById("professionalsList");if(!e)return;if(!F.professionals||F.professionals.length===0){e.innerHTML=Go(8);return}const t=Jo(),a=F.professionals.filter(s=>{const o=s.name.toLowerCase().includes(F.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(F.searchQuery);let r=!0;F.statusFilter==="active"&&(r=s.status!=="inactive"),F.statusFilter==="inactive"&&(r=s.status==="inactive");const i=F.filterServiceId==="all"||s.services&&s.services.includes(F.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||m.establishmentId],d=t.some(l=>n.includes(l));return o&&r&&i&&d});Cl(a),e.innerHTML=Dl(a)}function Go(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Dl(e){return e.length===0?`
        ...
        `:e.map(t=>{const a=t.status==="inactive",s=v(t.name),o=v(t.specialty||"Especialidade"),r=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,d=t.services?t.services.length:0,l=F.selectedIds.has(t.id);return`
            ...
            </div>`}).join("")}function ya(){const e=document.getElementById("genericModal");e.style.display="none",ze&&e.removeEventListener("click",ze)}async function Tl(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=`
        <div class="modal-content max-w-5xl p-0 overflow-hidden flex flex-col max-h-[90vh]"> 
            <div class="modal-header px-6 py-4 flex justify-between items-center border-b bg-white flex-shrink-0">
                <h2 class="text-2xl font-bold text-gray-800">${v(a.name)}</h2>
        ...
        </div>`;t.innerHTML=o,t.style.display="flex",Bl(a,F.services),Ml(a),Al(a,F.professionals),Nl(a)}function Pl(e=[]){if(!F.hierarchyCache||F.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Exclusivo desta unidade.
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30 custom-scrollbar">';return F.hierarchyCache.forEach(a=>{const s=e.includes(a.id)||e.length===0&&a.id===m.establishmentId;t+=`
            <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-white rounded px-2 transition-colors">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${s?"checked":""}>
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const r=e.includes(o.id)||e.length===0&&o.id===m.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function Bl(e,t){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao"),o=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(S,x)=>{const g=x+1,I=g==o[1]?"selected":"",A=new Date(0,x).toLocaleString("pt-BR",{month:"long"});return`<option value="${g}" ${I}>${A.charAt(0).toUpperCase()+A.slice(1)}</option>`}).join(""),i=v(e.name||""),n=v(e.specialty||""),d=v(e.phone||""),l=v(e.notes||"");a.innerHTML=`
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="md:col-span-1 space-y-4">
                ...
                <div id="profServicesContainer" class="grid grid-cols-1 sm:grid-cols-2 gap-2 p-3 border border-gray-200 rounded-xl bg-gray-50 max-h-40 overflow-y-auto custom-scrollbar">
                    ${t.map(S=>`
                        <label class="flex items-center space-x-3 p-2.5 bg-white rounded-lg cursor-pointer transition-colors border border-gray-100 hover:border-indigo-300 hover:shadow-sm">
                            <input type="checkbox" value="${S.id}" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4" ${e.services?.includes(S.id)?"checked":""}>
                            <span class="text-sm font-medium text-gray-700 truncate" title="${v(S.name)}">${v(S.name)}</span>
                        </label>
                    `).join("")}
    ...
    `;const c=document.getElementById("selectAllServicesBtn");if(c){c.addEventListener("click",()=>{const x=document.querySelectorAll('#profServicesContainer input[type="checkbox"]'),g=Array.from(x).every(I=>I.checked);x.forEach(I=>{I.checked=!g}),c.textContent=g?"Selecionar Todos":"Desmarcar Todos"});const S=document.querySelectorAll('#profServicesContainer input[type="checkbox"]');S.length>0&&Array.from(S).every(x=>x.checked)&&(c.textContent="Desmarcar Todos")}const u=document.getElementById("profPhotoInput"),p=document.getElementById("profPhotoButton"),f=document.getElementById("profPhotoContainer"),w=document.getElementById("profPhotoPreview"),k=document.getElementById("profPhotoBase64"),h=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,T=e.photo||"",P=()=>u.click();p&&p.addEventListener("click",P),f&&f.addEventListener("click",P),u&&(u.onchange=async()=>{const S=u.files[0];if(S){w.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const x=await fo(S,800,800,.8);if(x.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");w.src=x,k.value=x}catch(x){b("Erro de Imagem",x.message||"Não foi possível processar a imagem.","error"),w.src=h,k.value=T,u.value=""}}})}function Ml(e){const t=document.getElementById("jornada");t.innerHTML=`
        ...
        </div>`,ql(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function Al(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        </div>`;const s=document.getElementById("batchBlockageForm");s&&s.addEventListener("submit",async r=>{r.preventDefault();const i=s.querySelector('button[type="submit"]'),n=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm"></span> A gravar...';const d=Array.from(r.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(k=>k.value);if(d.length===0)return i.disabled=!1,i.innerHTML=n,b("Atenção","Selecione pelo menos um profissional.","error");const l=r.target.batchBlockageStartDate.value,c=r.target.batchBlockageEndDate.value||l,u=r.target.batchBlockageStartTime.value,p=r.target.batchBlockageEndTime.value,f=r.target.batchBlockageReason.value;if(!l||!u||!p)return i.disabled=!1,i.innerHTML=n,b("Atenção","Preencha Data de Início, Hora de Início e Fim.","error");const w=d.map(k=>{const h={professionalId:k,establishmentId:m.establishmentId,startTime:new Date(`${l}T${u}`).toISOString(),endTime:new Date(`${c}T${p}`).toISOString(),reason:f};return da(h)});try{await Promise.all(w),b("Sucesso!",`${d.length} bloqueios foram criados.`),s.reset(),r.target.querySelectorAll('input[name="batch-professionals"]').forEach(h=>{h.checked=h.value===e.id});const k=document.getElementById("prof-blockages-filter").value;xt(e.id,k)}catch(k){b("Erro",k.message,"error")}finally{i.disabled=!1,i.innerHTML=n}}),document.getElementById("prof-blockages-filter").addEventListener("change",r=>xt(e.id,r.target.value)),await xt(e.id,"future")}function ql(e,t){e.innerHTML=Object.keys(Ms).map(a=>{const s=t[a]||{},o=s.active!==!1;return`
            <div class="day-schedule-card p-4 rounded-xl ${o?"bg-white border-gray-200 shadow-sm":"bg-gray-50 border-gray-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-3">
                    <span class="font-bold text-gray-800">${Ms[a]}</span>
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500 p-4">${s.message}</p>`}}}function Nl(e){const t=document.getElementById("genericModal");ze&&t.removeEventListener("click",ze),ze=async a=>{const s=a.target.closest("button[data-action]");if(!s){const r=a.target.closest(".tab-link");r&&(t.querySelectorAll(".tab-link").forEach(i=>{i.classList.remove("active","border-indigo-600","text-indigo-600"),i.classList.add("border-transparent","text-gray-500")}),r.classList.add("active","border-indigo-600","text-indigo-600"),r.classList.remove("border-transparent","text-gray-500"),t.querySelectorAll(".tab-content").forEach(i=>i.classList.add("hidden")),document.getElementById(r.dataset.tab).classList.remove("hidden"));return}const o=s.dataset.action;switch(a.stopPropagation(),o){case"close-modal":ya();break;case"delete-professional":const r=s.dataset.id;if(await G("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await xo(r),be(m.establishmentId,Gt(),"Equipe","Excluiu",`Excluiu profissional: ${e.name}`),b("Sucesso!","Profissional excluído da rede.","success"),ya(),Ye()}catch(g){b("Erro",`Não foi possível excluir: ${g.message}`,"error")}break;case"save-professional":const n=document.getElementById("professionalForm"),d=s,l=document.getElementById("profScheduleContainer"),c=Array.from(document.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map(g=>g.value),u={};l&&l.querySelectorAll(".day-schedule-card").forEach(g=>{const I=g.querySelector('[data-field="active"]').dataset.day;u[I]={active:g.querySelector('[data-field="active"]').checked,start:g.querySelector('[data-field="start"]').value,end:g.querySelector('[data-field="end"]').value,breakStart:g.querySelector('[data-field="breakStart"]').value,breakEnd:g.querySelector('[data-field="breakEnd"]').value}});const p=Array.from(n.querySelectorAll('input[name="accessibleIn"]:checked')).map(g=>g.value),f=p.length>0?p:[m.establishmentId],w=document.getElementById("profStatusToggle").checked,k=document.getElementById("profCommissionToggle").checked,h=document.getElementById("profShowOnAgendaToggle").checked,T={...e,id:document.getElementById("professionalId").value||void 0,accessibleIn:f,name:document.getElementById("profName").value.trim(),specialty:document.getElementById("profSpecialty").value,photo:document.getElementById("profPhotoBase64").value,services:c,workingHours:u,phone:document.getElementById("profPhone").value,dob:`${document.getElementById("profDobDay").value}/${document.getElementById("profDobMonth").value}`,receivesCommission:k,showOnAgenda:h,orderOnAgenda:parseInt(document.getElementById("profOrderOnAgenda").value)||1,notes:document.getElementById("profNotes").value,status:w?"active":"inactive",establishmentId:m.establishmentId},P=d.innerHTML;d.disabled=!0,d.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{T.id?(await Bi(T.id,T),be(m.establishmentId,Gt(),"Equipe","Editou",`Editou o profissional: ${T.name}`),b("Sucesso!","Dados atualizados.","success")):(delete T.id,await Pi(T),be(m.establishmentId,Gt(),"Equipe","Criou",`Cadastrou o profissional: ${T.name}`),b("Sucesso!","Novo membro adicionado à equipe.","success")),ya(),Ye()}catch(g){b("Erro",g.message,"error"),d.disabled=!1,d.innerHTML=P}break;case"delete-blockage":const S=s.dataset.id;if(await G("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await es(S),b("Bloqueio removido.","success");const g=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";xt(e.id,g)}catch(g){b("Erro",g.message,"error")}break;case"batch-delete-blockage":const x=JSON.parse(s.dataset.ids);if(await G("Apagar em Lote",`Tem certeza que deseja apagar ${x.length} dias de bloqueio de uma vez?`))try{await ho(x),b("Bloqueios removidos.","success");const g=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";xt(e.id,g)}catch(g){b("Erro",g.message,"error")}break}},t.addEventListener("click",ze)}function jl(){G("Excluir em Lote",`Tem certeza que deseja excluir ${F.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await Mi(Array.from(F.selectedIds)),be(m.establishmentId,Gt(),"Equipe","Excluiu em Lote",`Excluiu ${F.selectedIds.size} profissionais`),b("Sucesso!",`${F.selectedIds.size} profissionais foram excluídos.`,"success"),F.selectedIds.clear(),Ra(),Ye()}catch(t){b("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}let E={clients:[],selectedClient:null,activeTab:"profile",establishments:[],filterEstablishmentIds:new Set,filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},ea=null,jt=null;const Xo=e=>e?String(e).replace(/\D/g,""):"",Fa=e=>{if(!e)return"Nunca";let t;if(typeof e=="object"&&(e.seconds||e._seconds)){const a=e.seconds||e._seconds;t=new Date(a*1e3)}else t=new Date(e);return isNaN(t.getTime())?"Data Inválida":t.toLocaleDateString("pt-BR")},Ha=e=>{if(!e)return"CL";const t=e.trim().split(" ");return t.length>=2?(t[0][0]+t[t.length-1][0]).toUpperCase():e.substring(0,2).toUpperCase()};async function Rl(){ea=document.getElementById("content"),E.selectedClient=null,E.historyLimit=20,E.modalOpen=!1,E.selectedIds.clear(),E.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1,status:"all"},E.sortConfig={key:"name",direction:"asc"};try{const t=(await ge().catch(()=>({matrizes:[]}))).matrizes||[];E.establishments=[],t.forEach(a=>{E.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>E.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),E.filterEstablishmentIds.size===0&&E.filterEstablishmentIds.add(m.establishmentId)}catch(e){console.error("Erro ao buscar hierarquia",e)}Fl(),Ol(),await us()}function Fl(){const e=E.establishments.map(t=>`
    ...
    `}function Hl(){const e=document.getElementById("table-header-container");if(!e)return;const t=a=>E.sortConfig.key!==a?'<i class="bi bi-arrow-down-up opacity-30"></i>':E.sortConfig.direction==="asc"?'<i class="bi bi-arrow-up text-indigo-600 font-black"></i>':'<i class="bi bi-arrow-down text-indigo-600 font-black"></i>';e.innerHTML=`
    ...
    `}async function us(){E.loading=!0;const e=document.getElementById("list-container");e&&(e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>');try{const a=Array.from(E.filterEstablishmentIds).map(i=>{let n=`/api/clients/${i}?limit=1000`;return L(n).catch(()=>[])}),o=(await Promise.all(a)).flat(),r=new Map;o.forEach(i=>r.set(i.id,i)),E.clients=Array.from(r.values()),ps(),ue()}catch(t){console.error(t),b("Erro","Falha ao carregar clientes.","error"),e&&(e.innerHTML='<div class="text-center py-10 text-red-500 text-sm">Erro ao carregar dados.</div>')}finally{E.loading=!1}}function ps(){const e=new Date().getMonth()+1,t=new Date().getFullYear();let a=0,s=0,o=0;E.clients.forEach(r=>{if(r.totalDebt&&parseFloat(r.totalDebt)>0&&s++,r.dobMonth==e&&o++,r.createdAt){const i=new Date(r.createdAt);i.getMonth()+1===e&&i.getFullYear()===t&&a++}}),document.getElementById("kpi-total").textContent=E.clients.length,document.getElementById("kpi-novos").textContent=a,document.getElementById("kpi-devendo").textContent=s,document.getElementById("kpi-niver").textContent=o}function ue(){Hl();const e=document.getElementById("list-container");let t=E.clients;if(E.filters.search){const a=E.filters.search.toLowerCase();t=t.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(E.filters.status==="devendo")t=t.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(E.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;t=t.filter(s=>s.dobMonth==a)}else if(E.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();t=t.filter(o=>{if(!o.createdAt)return!1;const r=new Date(o.createdAt);return r.getMonth()+1===a&&r.getFullYear()===s})}if(E.filters.hasLoyalty&&(t=t.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),E.filters.inactiveDays){const a=parseInt(E.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),t=t.filter(o=>{if(!o.lastVisit&&!o.createdAt)return!1;let r;if(o.lastVisit){const i=o.lastVisit.seconds||o.lastVisit._seconds;r=i?new Date(i*1e3):new Date(o.lastVisit)}else r=new Date(o.createdAt);return r<s})}if(t.sort((a,s)=>{let o,r;switch(E.sortConfig.key){case"name":return o=(a.name||"").toLowerCase(),r=(s.name||"").toLowerCase(),E.sortConfig.direction==="asc"?o.localeCompare(r):r.localeCompare(o);case"contact":return o=a.phone||"",r=s.phone||"",E.sortConfig.direction==="asc"?o.localeCompare(r):r.localeCompare(o);case"lastVisit":o=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,r=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":o=parseFloat(a.totalDebt)||0,r=parseFloat(s.totalDebt)||0;break;default:o=a.name,r=s.name}return o<r?E.sortConfig.direction==="asc"?-1:1:o>r?E.sortConfig.direction==="asc"?1:-1:0}),t.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=t.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,o=Fa(a.lastVisit),r=Xo(a.phone),i=new Date().getMonth()+1,n=a.dobMonth==i,d=E.selectedIds.has(a.id);let l="";return n&&(l+='<span class="bg-indigo-100 text-indigo-700 text-[8px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider">🎂 Aniversariante</span> '),a.loyaltyPoints>0&&(l+=`<span class="bg-amber-100 text-amber-700 text-[8px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
        ...
        `}).join("")}function Ol(){jt&&ea.removeEventListener("click",jt),jt=r=>{const i=r.target;if(i.classList.contains("item-checkbox")){const c=i.value;i.checked?E.selectedIds.add(c):E.selectedIds.delete(c),Xt(),r.stopPropagation();return}if(i.id==="select-all-toggle"){const c=i.checked,u=document.querySelectorAll(".item-checkbox");E.selectedIds.clear(),u.forEach(p=>{p.checked=c,c&&E.selectedIds.add(p.value)}),Xt(),r.stopPropagation();return}const n=i.closest("[data-sort]");if(n){const c=n.dataset.sort;E.sortConfig.key===c?E.sortConfig.direction=E.sortConfig.direction==="asc"?"desc":"asc":(E.sortConfig.key=c,E.sortConfig.direction="asc"),ue();return}const d=i.closest("[data-action]");if(d){const c=d.dataset.action,u=d.dataset.id;if(c==="new-client"){Oa(null);return}if(c==="open-modal"){Oa(u);return}if(c==="whatsapp"){r.stopPropagation();const p=d.dataset.phone;window.open(`https://wa.me/55${p}`,"_blank");return}if(c==="export-excel"){Yl();return}}const l=i.closest("[data-filter]");l&&(document.querySelectorAll("[data-filter]").forEach(c=>c.classList.remove("ring-2","ring-offset-1","ring-indigo-400")),l.classList.add("ring-2","ring-offset-1","ring-indigo-400"),E.filters.status=l.dataset.filter,ue())},ea.addEventListener("click",jt);const e=document.getElementById("cancel-selection-btn");e&&e.addEventListener("click",()=>{E.selectedIds.clear();const r=document.getElementById("select-all-toggle");r&&(r.checked=!1),document.querySelectorAll(".item-checkbox").forEach(i=>i.checked=!1),Xt()});const t=document.getElementById("batch-delete-btn");t&&t.addEventListener("click",zl),document.querySelectorAll(".est-filter-checkbox").forEach(r=>{r.addEventListener("change",i=>{const n=i.target.closest("label");i.target.checked?(E.filterEstablishmentIds.add(i.target.value),n.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.remove("border-slate-200","text-slate-600")):(E.filterEstablishmentIds.delete(i.target.value),n.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),n.classList.add("border-slate-200","text-slate-600")),us()})});const a=document.getElementById("search-input");a&&a.addEventListener("input",r=>{E.filters.search=r.target.value,ue()});const s=document.getElementById("filter-inactive");s&&s.addEventListener("input",r=>{E.filters.inactiveDays=r.target.value,ue()});const o=document.getElementById("filter-loyalty");o&&o.addEventListener("change",r=>{E.filters.hasLoyalty=r.target.checked,ue()})}function Xt(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count");if(!e||!t)return;const a=E.selectedIds.size;t.textContent=a,a>0?(e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex"))}async function zl(){const e=E.selectedIds.size;if(!(e===0||!await G("Excluir Clientes",`Deseja realmente excluir permanentemente ${e} cliente(s)? Esta ação não pode ser desfeita.`)))try{const a=Array.from(E.selectedIds).map(o=>go(o));await Promise.all(a),b("Sucesso",`${e} cliente(s) excluído(s) com sucesso.`,"success"),E.selectedIds.clear(),Xt();const s=document.getElementById("select-all-toggle");s&&(s.checked=!1),await us()}catch{b("Erro ao Excluir","Ocorreu um erro ao excluir alguns clientes.","error")}}function Oa(e=null){e?(E.selectedClient=E.clients.find(s=>s.id===e),E.selectedClient.isNew=!1):E.selectedClient={isNew:!0,id:"",name:"",phone:"",email:"",cpf:"",gender:"",dobDay:"",dobMonth:"",source:"",notes:"",loyaltyPoints:0,totalDebt:0},E.activeTab="profile",E.historyData={appointments:[],sales:[],loyaltyLog:[]};let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-slate-900/60 backdrop-blur-sm sm:p-4 animate-fade-in",t.innerHTML='<div class="bg-white w-full sm:w-[90vw] h-[90vh] sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col relative animate-slide-up sm:animate-scale-in rounded-t-2xl" id="client-modal-content"></div>',t.onclick=s=>{s.target===t&&ht()},document.body.appendChild(t),document.body.classList.add("overflow-hidden"));const a=t.querySelector("#client-modal-content");a.innerHTML=Ze(E.selectedClient),Ke(a,E.selectedClient)}function ht(){const e=document.getElementById("client-details-modal-overlay");e&&e.remove(),document.body.classList.remove("overflow-hidden"),E.modalOpen=!1,E.selectedClient=null,ue()}function Ze(e){const t=e.isNew,a=`
    ...
    `;let s="";return E.activeTab==="profile"?s=Vl(e):E.activeTab==="appointments"?s=_l():E.activeTab==="history"?s=Ul():E.activeTab==="loyalty"&&(s=Wl(e)),`
            ...
            <div class="bg-indigo-600 px-4 py-5 sm:px-6 sm:py-6 text-white relative flex-shrink-0 w-full shadow-md z-20">
                ...
                <div class="flex items-center gap-4 sm:gap-6">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-white text-indigo-600 flex items-center justify-center text-3xl font-black shadow-lg flex-shrink-0">
                        ${t?'<i class="bi bi-person-plus-fill"></i>':Ha(e.name)}
                    </div>
    ...
    `}function _l(e){let t=E.historyData.appointments||[];return t.sort((a,s)=>new Date(s.startTime)-new Date(a.startTime)),`
        <div class="space-y-2">
    ...
    `}function Ul(e){let t=E.historyData.sales||[];t.sort((o,r)=>new Date(r.date)-new Date(o.date));const a=t.reduce((o,r)=>o+(Number(r.totalAmount)||0),0),s=t.length>0?a/t.length:0;return`
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-3 mb-2">
                <div class="bg-emerald-50 p-4 rounded-xl border border-emerald-100 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-xl sm:text-2xl font-black text-emerald-700 mt-1">${ha(a)}</span>
                </div>
                <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col text-center">
                    ...
                    <span class="text-xl sm:text-2xl font-black text-slate-800 mt-1">${ha(s)}</span>
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="bg-white border border-slate-200 rounded-xl p-3 flex justify-between items-center shadow-sm hover:bg-slate-50 cursor-pointer transition-colors" data-go-comanda="true" data-id="${o.id}">
                    ...
                    <div class="text-right">
                        <p class="font-black text-emerald-600 text-xs sm:text-sm">${ha(o.totalAmount)}</p>
    ...
    `}function Wl(e){const t=E.historyData.loyaltyLog||[];return t.sort((a,s)=>new Date(s.date)-new Date(a.date)),`
        <div class="space-y-4">
    ...
    `}function Ke(e,t){if(e.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const o=s.dataset.tab;if(E.activeTab===o)return;E.activeTab=o;const r=document.getElementById("client-modal-content");r&&(r.innerHTML=Ze(t),Ke(r,t)),o!=="profile"&&!E.historyLoading&&E.historyData.appointments.length===0&&await Jl(t.id)}}),E.activeTab==="profile"){const s=e.querySelector("#form-edit-client");s&&(s.onsubmit=Gl);const o=e.querySelector("#btn-delete-client");o&&(o.onclick=Xl)}if(E.activeTab==="loyalty"){const s=e.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>Ql(t))}e.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=()=>{ht(),X("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=()=>{ht(),X("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const a=e.querySelector("#btn-close-modal");a&&(a.onclick=ht)}async function Jl(e){const t=E.selectedClient;if(!t||!t.phone)return;E.historyLoading=!0;const a=document.getElementById("client-modal-content");a&&(a.innerHTML=Ze(t),Ke(a,t));try{const s=new Date;s.setMonth(s.getMonth()+12);const o=new Date;o.setFullYear(o.getFullYear()-5);let r=`/api/appointments/${m.establishmentId}?startDate=${o.toISOString()}&endDate=${s.toISOString()}&clientPhone=${encodeURIComponent(Xo(t.phone))}&limit=50`;const i=await L(r);E.historyData.appointments=i,E.historyData.sales=i.filter(d=>d.status==="completed").map(d=>({id:d.id,date:d.startTime,totalAmount:d.totalAmount||0,items:d.comandaItems||d.services||[]}));const n=[];i.forEach(d=>{d.status==="completed"&&d.loyaltyPointsEarned>0&&n.push({type:"earn",points:d.loyaltyPointsEarned,date:d.startTime,description:"Venda finalizada"}),d.loyaltyRedemption&&n.push({type:"redemption",points:d.loyaltyRedemption.cost||0,date:d.startTime,description:`Resgate: ${d.loyaltyRedemption.name}`})}),E.historyData.loyaltyLog=n}catch(s){console.error("Erro histórico",s)}finally{E.historyLoading=!1;const s=document.getElementById("client-modal-content");s&&E.selectedClient&&(s.innerHTML=Ze(E.selectedClient),Ke(s,E.selectedClient))}}async function Gl(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());a.establishmentId=m.establishmentId,a.dobDay&&(a.dobDay=parseInt(a.dobDay)),a.dobMonth&&(a.dobMonth=parseInt(a.dobMonth));try{if(E.selectedClient.isNew){const s=await mo(a);E.clients.unshift(s),b("Sucesso","Cliente cadastrado com sucesso!","success"),E.selectedClient=s,Oa(s.id)}else{await bo(E.selectedClient.id,a),Object.assign(E.selectedClient,a);const s=E.clients.findIndex(r=>r.id===E.selectedClient.id);s!==-1&&(E.clients[s]=E.selectedClient),b("Sucesso","Dados salvos com sucesso!","success");const o=document.getElementById("client-modal-content");o&&(o.innerHTML=Ze(E.selectedClient),Ke(o,E.selectedClient))}ps(),ue()}catch(s){b("Erro",s.message,"error")}}async function Xl(){if(await G("Excluir Cliente","Tem certeza? O histórico será apagado e não pode ser desfeito."))try{await go(E.selectedClient.id),E.clients=E.clients.filter(e=>e.id!==E.selectedClient.id),E.selectedClient=null,b("Sucesso","Cliente removido com sucesso.","success"),ht(),ps(),ue()}catch(e){b("Erro",e.message,"error")}}function Ql(e){const t=e.loyaltyPoints||0,a=`
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",l=>{l.preventDefault();const c={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,cnpj:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};rt(c,l)})}function ed(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#newEmail").value,o=t.querySelector("#currentPassword").value,r=t.querySelector('button[form="change-email-form"]');r.disabled=!0,r.textContent="A verificar...";try{const i=le.currentUser,n=dr.credential(i.email,o);await cr(i,n),await ur(i,s),await Wr(Q,s),b("Sucesso","Link de verificação enviado! Verifique o seu novo e-mail.","success"),a.target.reset()}catch(i){b("Erro",i.message,"error")}finally{r.disabled=!1,r.textContent="Salvar Novo E-mail"}})}function ad(e,t){const a=v(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");e.timezone&&(a.value=e.timezone);const s=t.querySelector("#establishmentWorkingHoursContainer"),o=e.workingHours||{};Object.keys(wa).forEach(r=>{const i=o[r]||{},n=wa[r],d=i.active!==!1,l=document.createElement("div");l.className=`day-schedule-card p-4 rounded-lg border ${d?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,l.innerHTML=`
            ...
            </div>`,s.appendChild(l)}),s.addEventListener("change",r=>{const i=r.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),t.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const i={};Object.keys(wa).forEach(d=>{i[d]={active:t.querySelector(`#est-${d}-active`).checked,start:t.querySelector(`#est-${d}-start`).value,end:t.querySelector(`#est-${d}-end`).value,breakStart:t.querySelector(`#est-${d}-breakStart`).value,breakEnd:t.querySelector(`#est-${d}-breakEnd`).value}});const n=t.querySelector("#establishmentTimezone").value;rt({workingHours:i,timezone:n},r)})}function Yo(e,t){const a=!!e.whatsappInstance;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;const n=t.querySelector("#loyaltyTiersContainer"),d=(l={})=>{const c=document.createElement("div");c.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const u=l.type||"money",p=l.itemId||"",f=l.reward||"",w=l.discount||"",k=l.points||l.costPoints||"";c.innerHTML=`
            <div>
            ...
            <div class="relative md:col-span-2">
                ...
                <div class="flex gap-2">
                    <input type="text" placeholder="Ex: R$ 20 de Desconto" data-field="rewardName" value="${v(f)}" class="desc-input flex-1 p-2 border border-gray-300 rounded-md ${u!=="money"?"hidden":""}">
                    ...
                    <div class="w-24 relative">
                        ...
                        <input type="number" placeholder="Valor" data-field="discount" value="${w}" step="0.01" class="discount-input w-full p-2 pl-7 border border-gray-300 rounded-md" title="Valor do desconto">
                    </div>
                </div>
            </div>
        ...
        `;const h=c.querySelector(".type-select"),T=c.querySelector(".item-select"),P=c.querySelector(".desc-input"),S=c.querySelector(".discount-input"),x=g=>{T.innerHTML='<option value="">Selecione...</option>';let I=[];g==="service"?I=o:g==="product"?I=r:g==="package"&&(I=i),I.forEach(A=>{const C=A.id===p,D=A.name||A.title||"Sem nome",j=A.price||A.salePrice||0;T.innerHTML+=`<option value="${A.id}" data-price="${j}" ${C?"selected":""}>${v(D)}</option>`})};return u!=="money"&&x(u),h.addEventListener("change",g=>{const I=g.target.value;I==="money"?(T.classList.add("hidden"),P.classList.remove("hidden"),P.value="",S.value=""):(T.classList.remove("hidden"),P.classList.add("hidden"),x(I),S.value="")}),T.addEventListener("change",g=>{const I=g.target.selectedOptions[0];if(I&&I.value){P.value=I.text;const A=I.dataset.price;A&&(S.value=parseFloat(A).toFixed(2))}}),c};a.tiers&&a.tiers.length>0?a.tiers.forEach(l=>n.appendChild(d(l))):n.appendChild(d()),t.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(d())}),n.addEventListener("click",l=>{const c=l.target.closest(".remove-loyalty-tier");c&&c.closest(".loyalty-tier-row").remove()}),t.querySelector("#loyalty-form").addEventListener("submit",l=>{l.preventDefault();const c=Array.from(t.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(p=>{const f=p.querySelector(".type-select").value,w=f==="money"?null:p.querySelector(".item-select").value;let k=f==="money"?p.querySelector(".desc-input").value:p.querySelector(".item-select").options[p.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,type:f,itemId:w,reward:k,name:k,discount:parseFloat(p.querySelector('input[data-field="discount"]').value)||0}}),u={loyaltyProgram:{enabled:t.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(t.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:c.filter(p=>p.points>0&&p.reward)}};rt(u,l)})}async function id(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([ba(Q),rs(Q)]),o=e.financialIntegration||{},r=e.commissionConfig||{},i=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Re(a,o.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Re(s,o.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Re(a,i.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Re(s,i.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Re(a,r.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Re(s,r.defaultCostCenterId)}catch{b("Erro","Não foi possível carregar o plano de contas da unidade.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};rt(s,a)})}function nd(e,t){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${e.name}).`;t.innerHTML=`
    ...
    `}function ld(e,t){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${e.name})`;t.innerHTML=`
    ...
    `}function Zo(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(Zl).forEach(([o,r])=>{const i=o===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
    ...
    `,Te.querySelector('button[data-action="back-to-menu"]').addEventListener("click",o=>{o.preventDefault(),Ko({id:Q})});const s=document.getElementById("settings-content-detail");switch(e){case"personal-data":Kl(J,s);break;case"change-password":ed(J,s);break;case"change-email":td(J,s);break;case"branding":ad(J,s);break;case"booking":sd(J,s);break;case"working-hours":od(J,s);break;case"whatsapp-bot":Yo(J,s);break;case"loyalty":await rd(J,s);break;case"financial":await id(J,s);break;case"support":nd(J,s);break;case"cancellation":ld(J,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Ko(e={}){Te.innerHTML=`
    ...
    `;try{Q=e.id||m.establishmentId,J=await Be(Q);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=J.isMatriz||!J.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=Qo();Te.innerHTML=`
            <div class="max-w-5xl mx-auto w-full pb-20">
                ...
                <div class="bg-gradient-to-r from-indigo-900 to-indigo-700 rounded-xl shadow-lg p-6 mb-8 text-white flex justify-between items-center relative overflow-hidden">
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-1">${v(J.name)} ${a}</h3>
                        <p class="text-indigo-200 text-sm flex items-center gap-2"><i class="bi bi-geo-alt"></i> ${v(J.address||"Morada não definida")}</p>
                    </div>
                    <div class="relative z-10 hidden sm:block">
                        <div class="w-16 h-16 bg-white rounded-xl shadow-md p-1 flex items-center justify-center">
                            ${J.logo?`<img src="${J.logo}" class="w-full h-full object-contain rounded-lg">`:`<span class="text-2xl text-indigo-600 font-bold">${J.name.charAt(0).toUpperCase()}</span>`}
                        </div>
                    </div>
        ...
        `,Te.querySelectorAll("div[data-section]").forEach(o=>{o.addEventListener("click",r=>{cd(o.dataset.section)})}),Te.querySelectorAll(".module-toggle").forEach(o=>{o.addEventListener("change",async()=>{const r=o.dataset.module;try{const n={...(await Be(Q)).modules,[r]:o.checked};await Za(Q,{modules:n}),b("Módulos","Módulos atualizados com sucesso.","success")}catch(i){o.checked=!o.checked,b("Erro",i.message,"error")}})})}catch(t){Te.innerHTML=`
        ...
        `}}function ud(e){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `).join("")}const vt=document.getElementById("content");async function We(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,o=await la(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),r=document.getElementById("filterReason")?.value.toLowerCase(),i=r?o.filter(d=>d.reason&&d.reason.toLowerCase().includes(r)):o,n=i.reduce((d,l)=>{const c=l.reason||"Sem motivo";return d[c]||(d[c]=[]),d[c].push(l),d},{});if(t.innerHTML="",i.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([d,l])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${v(d)} (${l.length})</h4>`;if(l.length>1){const f=JSON.stringify(l.map(w=>w.id));p+=`<button data-action="batch-delete-blockage" data-ids='${f}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",c.innerHTML=p,l.forEach(f=>{const w=new Date(f.startTime),k=new Date(f.endTime),h=w.toLocaleDateString("pt-BR"),T=k.toLocaleDateString("pt-BR"),S=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${h===T?`${h} | ${w.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${k.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${h} às ${w.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${T} às ${k.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;c.innerHTML+=S}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function pd(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,o=t.querySelector("#blockageEndDate").value||s,r=t.querySelector("#blockageStartTime").value,i=t.querySelector("#blockageEndTime").value,n={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${s}T${r}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await da(n),t.reset(),b("Sucesso","Bloqueio adicionado com sucesso!","success"),We(a)}catch(d){b("Erro",`Não foi possível criar o bloqueio: ${d.message}`,"error")}}async function md(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return b("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,o=t.querySelector("#batchBlockageEndDate").value||s,r=t.querySelector("#batchBlockageStartTime").value,i=t.querySelector("#batchBlockageEndTime").value,n=t.querySelector("#batchBlockageReason").value,d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="Aguarde...";const l=a.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${s}T${r}:00`).toISOString(),endTime:new Date(`${o}T${i}:00`).toISOString(),reason:n};return da(u)});try{await Promise.all(l),b("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&We(c)}catch(c){b("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Adicionar Bloqueio em Lote"}}function bd(e){vt.addEventListener("submit",t=>{t.target.id==="blockageForm"&&pd(t),t.target.id==="batchBlockageForm"&&md(t)}),vt.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&We(e)}),vt.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")X("profissionais-section");else if(s==="delete-blockage"){if(await G("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await es(a.dataset.id),b("Sucesso","Bloqueio removido.","success"),We(e)}catch(r){b("Erro",`Não foi possível remover o bloqueio: ${r.message}`,"error")}}else if(s==="batch-delete-blockage"){const o=JSON.parse(a.dataset.ids);if(await G("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await ho(o),b("Sucesso",`${o.length} bloqueios removidos.`,"success"),We(e)}catch(i){b("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function gd(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){vt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);vt.innerHTML=`
        <section>
        ...
        </section>`,bd(t),await We(t);const o=document.getElementById("batchProfSelectionContainer");try{const r=await ye(m.establishmentId);o.innerHTML=r.map(i=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{o.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const fd=e=>L(`/api/users/${e}`),xd=e=>L("/api/users",{method:"POST",body:JSON.stringify(e)}),hd=(e,t)=>L(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),vd=e=>L(`/api/users/${e}`,{method:"DELETE"}),yd=(e,t)=>L(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),wd=(e,t)=>L(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),it=document.getElementById("content"),kd={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},$d={view:"Visualizar",create:"Criar",edit:"Editar"};let Rt=null,Ft=null,Je=null;const Ed={group_admin:"Administrador do Grupo",company_admin:"Gestor de Matriz",branch_manager:"Gestor de Filial",professional:"Profissional Padrão"};function Sd(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const s=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${s}</p>`;return}e.sort((s,o)=>(s.status==="active"?-1:1)-(o.status==="active"?-1:1)),t.innerHTML=e.map(s=>{const o=JSON.stringify(s).replace(/'/g,"&apos;"),r=s.status==="active",i=m.professionals.find(p=>p.id===s.professionalId),n=i?i.name:"N/A",d=i?i.name.charAt(0):s.name.charAt(0),l=i?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(d)}`,c=Ed[s.role]||"Profissional",u=s.role==="group_admin"?"bg-purple-100 text-purple-800":s.role==="company_admin"?"bg-blue-100 text-blue-800":s.role==="branch_manager"?"bg-orange-100 text-orange-800":"bg-gray-100 text-gray-800";return`
    ...
    `}).join("")}function za(){const t=document.getElementById("showInactiveUsersToggle")?.checked?m.users:m.users.filter(a=>a.status==="active");Sd(t)}function Id(e={}){return Object.entries(kd).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",o=e[t]?.view_all_prof===!0,r=Object.entries($d).map(([n,d])=>`
    ...
    `}).join("")}function qs(e){if(!Je||m.userRole==="professional")return"";const t=e?.accessibleEstablishments?.map(r=>r.id)||[],a=e?.accessibleCompanies?.map(r=>r.id)||[];if((e?.role||"professional")==="group_admin")return'<div class="p-3 bg-purple-50 border border-purple-200 rounded-lg text-purple-800 text-sm font-bold">Acesso Total (Global) liberado.</div>';let o='<div class="space-y-3 max-h-48 overflow-y-auto custom-scrollbar p-2 bg-gray-50 rounded border">';return Je.companies.forEach(r=>{const i=a.includes(r.id),n=Je.branches.filter(d=>d.companyId===r.id);o+=`
        ...
        `}),o+="</div>",o}async function Ns(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{a=await ye(m.currentViewContext.id),m.professionals=a}catch{console.warn("Profissionais não carregados")}if(["group_admin","company_admin"].includes(m.userRole)&&!Je)try{const l=await fetch("/api/establishments/hierarchy",{headers:{Authorization:`Bearer ${await m.getAuthToken?.()||""}`}});l.ok&&(Je=await l.json())}catch(l){console.error("Falha ao buscar hierarquia",l),Je={companies:[],branches:[]}}const s=l=>a?.find(c=>c.id===l),o=e?.professionalId;s(o);const r=e!==null;t.querySelector("#userFormTitle").textContent=r?`Editar: ${e.name}`:"Novo Usuário";const i=t.querySelector("#userForm");i.innerHTML=`
    ...
    `;const n=i.querySelector("#userRole"),d=i.querySelector("#hierarchySelectorContainer");if(n&&d){n.addEventListener("change",c=>{const u={...e,role:c.target.value};d.innerHTML=qs(u),l()});const l=()=>{d.querySelectorAll(".company-checkbox").forEach(c=>{c.addEventListener("change",u=>{u.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(w=>w.checked=u.target.checked)})})};l()}if(i.addEventListener("submit",async l=>{l.preventDefault();const c={};i.querySelectorAll("input[data-module]").forEach(h=>{const T=h.dataset.module,P=h.dataset.permission;c[T]||(c[T]={}),c[T][P]=h.checked});const u=i.querySelector("#userProfessionalId").value||null,p=i.querySelector("#userRole")?.value||"professional",f=[],w=[];if(p!=="group_admin"&&i.querySelector(".company-checkbox")&&(i.querySelectorAll(".company-checkbox:checked").forEach(h=>{f.push({id:h.value,name:h.dataset.name})}),i.querySelectorAll(".branch-checkbox:checked").forEach(h=>{w.push({id:h.value,name:h.dataset.name,companyId:h.dataset.companyId})}),w.length===0))return b("Atenção","Você deve selecionar pelo menos uma filial para este usuário.","error");const k={name:i.querySelector("#userName").value,permissions:c,professionalId:u,role:p,accessibleCompanies:f,accessibleEstablishments:w};try{if(r){const h=i.querySelector("#userEmail").value;e?.email!==h&&(k.email=h),await hd(e.id,k),b("Usuário atualizado com sucesso!","success")}else k.email=i.querySelector("#userEmail").value,k.password=i.querySelector("#userPassword").value,await xd(k),b("Usuário criado com sucesso!","success");ta()}catch(h){b(`Erro: ${h.message}`,"error")}}),r){const l=i.querySelector('[data-action="show-password-form"]'),c=i.querySelector("#password-form");l&&c&&(l.addEventListener("click",()=>{l.classList.add("hidden"),c.classList.remove("hidden")}),c.querySelector('[data-action="cancel-password-change"]').addEventListener("click",()=>{l.classList.remove("hidden"),c.classList.add("hidden"),c.querySelector("#userNewPassword").value=""}),c.querySelector('[data-action="save-password"]').addEventListener("click",async u=>{const p=u.target,f=c.querySelector("#userNewPassword").value;if(!f||f.length<6)return b("Aviso","Senha deve ter no mínimo 6 caracteres.","error");if(await G("Alterar Senha","Tem certeza?"))try{p.disabled=!0,p.textContent="...",await yd(e.id,f),b("Sucesso","Senha alterada.","success"),l.classList.remove("hidden"),c.classList.add("hidden")}catch(w){b("Erro",w.message,"error")}finally{p.disabled=!1,p.textContent="Salvar Senha"}}))}}async function Ld(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([fd(m.currentViewContext.id),ye(m.currentViewContext.id)]);m.users=t,m.professionals=a,za()}catch{b("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Falha ao carregar.</p>'}}async function ta(){it.innerHTML=`
        <style>
    ...
    `,Rt&&it.removeEventListener("click",Rt),Ft&&it.removeEventListener("change",Ft),Rt=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":Ns();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));Ns(s);break;case"back-to-list":ta();break;case"delete-user":{if(e.stopPropagation(),await G("Excluir Usuário","Tem certeza? Ação irreversível."))try{await vd(t.dataset.userId),b("Usuário excluído!","success"),ta()}catch(o){b(`Erro: ${o.message}`,"error")}break}}},Ft=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")za();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await wd(a,s);const o=m.users.findIndex(r=>r.id===a);o>-1&&(m.users[o].status=s,za())}catch(o){b(`Erro: ${o.message}`,"error"),t.checked=!t.checked}}},it.addEventListener("click",Rt),it.addEventListener("change",Ft),await Ld()}const Cd=document.getElementById("content");let js={},Va=null;function Dd(){Object.values(js).forEach(e=>e?.destroy()),js={}}function Td(e,t){if(!window.jspdf){b("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const i=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,r),s.autoTable({html:`#${t}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Rs(e){const t=document.getElementById("genericModal"),a=v(e.client),s=v(e.items),o=v(e.responsavelCaixa||"N/A"),r=(e.payments||[]).map(i=>`
    ...
    `,t.style.display="flex"}function Pd(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),o=Object.entries(t.paymentMethodTotals).sort(([,n],[,d])=>d-n);s.innerHTML=o.map(([n,d])=>`
        <tr class="border-b">
    ...
    `}).join(""),r.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const d=n.dataset.transactionIndex,l=Va.transactions[d];l&&Rs(l)})}),i.innerHTML=a.map((n,d)=>{const l=v(n.client),c=v(n.items),u=v(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const d=n.dataset.transactionIndex,l=Va.transactions[d];l&&Rs(l)})})}async function Fs(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,o=a.value;if(!s||!o)return b("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,i=await Yt({establishmentId:m.establishmentId,startDate:s,endDate:o,cashierSessionId:r});Va=i,e.innerHTML=`
        ...
        `,Pd(i)}catch(r){b("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${v(r.message)}</p>`}}async function Bd(){Dd();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];Cd.innerHTML=`
        <section class="pb-20 md:pb-0"> <div class="flex flex-col gap-4 mb-6">
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Fs),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${s}_a_${o}`;Td(r,"transactionsTable")});try{const s=await an(m.establishmentId),o=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(r=>{const i=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=v(r.closedByName||"N/A");o.innerHTML+=`<option value="${r.id}">${n} - ${i}</option>`})}catch{b("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Fs()}const Md=document.getElementById("content");let $={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Ht=null,Ot=null;function ms(e){const t=new Map,a=[];return e&&(e.forEach(s=>t.set(s.id,{...s,children:[]})),t.forEach(s=>{s.parentId&&t.has(s.parentId)?t.get(s.parentId).children.push(s):a.push(s)})),a}function er(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,s]=e.split("-"),o=new Date(t,a-1,s),r=String(o.getDate()).padStart(2,"0"),i=o.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:r,month:i,full:o.toLocaleDateString("pt-BR")}}function pe(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function et(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,o,r]=e.split("-");return new Date(s,o-1,r)<a}function Ad(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML=`
            ...
            ${o.children.map(f=>s(f,r+1)).join("")}
        `};e.innerHTML=t.map(o=>s(o)).join("")}async function _a(e){const t=document.getElementById("genericModal"),a=e==="nature",s=a?"Plano de Naturezas":"Centros de Custo",o=a?ba:rs,r=a?Sn:Ln,i=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),d=t.querySelector("#itemParent"),l=u=>{const p=ms(u);Ad(n,p,e);const f=d.value;d.innerHTML='<option value="">-- Nível Principal --</option>';const w=(k,h=0)=>{const T="  ".repeat(h)+(h>0?"↳ ":"");d.innerHTML+=`<option value="${k.id}">${T}${k.name}</option>`,k.children.forEach(P=>w(P,h+1))};p.forEach(k=>w(k)),d.value=f};try{const u=await o(m.establishmentId);$[i]=u,l(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const p=t.querySelector("#itemName").value,f=d.value;try{await r({name:p,parentId:f||null,establishmentId:m.establishmentId});const w=await o(m.establishmentId);$[i]=w,l(w),c.reset(),await Me(),b("Sucesso","Item adicionado à estrutura.","success")}catch(w){b("Erro",w.message,"error")}})}async function qd(){try{const t=(await ge()).matrizes||[];$.establishments=[],t.forEach(a=>{$.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>$.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(m.establishmentId)}catch(e){console.warn("Erro ao buscar lojas",e)}tr(),ar(),await Me()}function tr(){const e=$.establishments.map(t=>`
    ...
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),document.querySelector('.date-preset-btn[data-preset="month"]').classList.remove("bg-white","text-gray-600","border-gray-200"),sr()}function Nd(){const e=$.currentTab==="receivables",t=e?$.receivables:$.payables;let a=t;if($.statusFilter!=="all"&&(a=t.filter(n=>{const d=et(n.dueDate,n.status);return $.statusFilter==="overdue"?d:$.statusFilter==="pending"?n.status==="pending"&&!d:n.status===$.statusFilter})),$.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes($.searchQuery)||n.entity&&n.entity.toLowerCase().includes($.searchQuery)||n.notes&&n.notes.toLowerCase().includes($.searchQuery))),a.sort((n,d)=>new Date(n.dueDate)-new Date(d.dueDate)),a.length===0){b("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map($.natures.map(n=>[n.id,n.name])),o=new Map($.costCenters.map(n=>[n.id,n.name])),r=new Map($.establishments.map(n=>[n.id,n])),i=a.map(n=>{const d=n.status==="paid",l=et(n.dueDate,n.status);let c=d?"Baixado":l?"Atrasado":"A Vencer / Pendente";const u=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?o.get(n.centroDeCustoId)||"Não Categorizado":"Geral",f=r.get(n.establishmentId),w=f?f.name:"Atual",k=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:w,Natureza:u,"Centro de Custo":p,Origem:k,"Documento / NFS":n.documentNumber||"",Status:c,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){b("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(i),d=XLSX.utils.book_new();XLSX.utils.book_append_sheet(d,n,"Financeiro");const c=`Fluxo_${e?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(d,c)}catch(n){console.error("Erro ao exportar:",n),b("Erro","Não foi possível exportar para Excel.","error")}}function ar(){const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const r=o.target.checked,i=document.querySelectorAll(".item-checkbox");$.selectedIds.clear(),i.forEach(n=>{n.checked=r,r&&$.selectedIds.add(n.dataset.id)}),Ve()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{$.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Ve()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=$.selectedIds.size;if(o===0)return;if(await G("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const i=$.currentTab==="payables"?"payables":"receivables";await No(i,Array.from($.selectedIds)),b("Sucesso",`${o} itens excluídos.`,"success"),$.selectedIds.clear(),Ve(),Me()}catch{b("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",r=>{const i=r.target.closest("label");r.target.checked?($.filterEstablishmentIds.add(r.target.value),i.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.remove("border-gray-200","text-gray-600")):($.filterEstablishmentIds.delete(r.target.value),i.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.add("border-gray-200","text-gray-600"))})}),document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",r=>{const i=r.currentTarget.dataset.sort;$.sortCol===i?$.sortAsc=!$.sortAsc:($.sortCol=i,$.sortAsc=!0),yt()})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("toggle-filter-btn");$.isAdvancedFilterOpen=!$.isAdvancedFilterOpen,$.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.getElementById("settings-btn").addEventListener("click",zd);const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",Nd),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",r=>{ka(r.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const o=$.currentTab==="payables"?"payable":"receivable";ka(o)});const a=document.getElementById("tab-receivables"),s=document.getElementById("tab-payables");a.addEventListener("click",()=>Hs("receivables")),s.addEventListener("click",()=>Hs("payables")),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",r=>{document.querySelectorAll(".status-filter-btn").forEach(i=>{i.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),i.classList.add("bg-white","text-gray-600")}),r.target.dataset.status==="overdue"?r.target.classList.add("bg-red-50","text-red-700","border-red-200"):r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600"),$.statusFilter=r.target.dataset.status,yt(),or()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const i=r.target.dataset.preset,n=new Date;let d,l;i==="month"?(d=new Date(n.getFullYear(),n.getMonth(),1),l=new Date(n.getFullYear(),n.getMonth()+1,0)):i==="last_month"?(d=new Date(n.getFullYear(),n.getMonth()-1,1),l=new Date(n.getFullYear(),n.getMonth(),0)):i==="year"&&(d=new Date(n.getFullYear(),0,1),l=new Date(n.getFullYear(),11,31)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=l.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",o=>{$.searchQuery=o.target.value.toLowerCase(),yt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",$.filterEstablishmentIds.clear(),$.filterEstablishmentIds.add(m.establishmentId),tr(),ar()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{$.startDate=document.getElementById("filterStartDate").value,$.endDate=document.getElementById("filterEndDate").value,$.filterNaturezaId=document.getElementById("filterNaturezaId").value,$.filterCostCenterId=document.getElementById("filterCostCenterId").value,$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(m.establishmentId),document.getElementById("toggle-filter-btn").click(),Me()}),Ht&&document.body.removeEventListener("click",Ht),Ht=o=>{const r=o.target;if(r.classList.contains("item-checkbox")||r.classList.contains("modal-item-checkbox")){const d=r.value||r.dataset.id;r.checked?$.selectedIds.add(d):$.selectedIds.delete(d),Ve(),o.stopPropagation();return}const i=r.closest("button[data-action]");if(i){const{action:d,type:l,id:c}=i.dataset;if(o.stopPropagation(),d==="delete"){const u=i.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");Fd(l,JSON.parse(u));return}if(d==="mark-as-paid"){Rd(l,c);return}if(d==="manage-natures"){_a("nature");return}if(d==="manage-cost-centers"){_a("cost-center");return}}const n=r.closest(".financial-row");if(n&&document.getElementById("list-container").contains(n)&&!r.closest("button")&&!r.closest(".item-checkbox")){const{type:d}=n.dataset,l=JSON.parse(n.dataset.item.replace(/&apos;/g,"'"));ka(d,l)}},document.body.addEventListener("click",Ht),Ot&&document.getElementById("genericModal").removeEventListener("click",Ot),Ot=o=>{if(o.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const i=o.target.closest('button[data-action^="delete-"]');if(i){const n=i.dataset.action.split("-")[1];Od(n,i.dataset.id)}},document.getElementById("genericModal").addEventListener("click",Ot)}function Ve(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),s=$.selectedIds.size;t.textContent=s,s>0?(e.classList.remove("hidden"),e.classList.add("flex"),a&&a.classList.add("hidden")):(e.classList.add("hidden"),e.classList.remove("flex"),a&&a.classList.remove("hidden"))}function Hs(e){$.currentTab=e,$.selectedIds.clear(),Ve(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),s=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-emerald-700","shadow"),t.classList.remove("text-gray-600"),a.classList.remove("bg-white","text-red-700","shadow"),a.classList.add("text-gray-600"),s&&(s.className="md:hidden fixed bottom-20 right-4 w-12 h-12 bg-emerald-600 text-white rounded-full shadow-lg flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow"),a.classList.remove("text-gray-600"),t.classList.remove("bg-white","text-emerald-700","shadow"),t.classList.add("text-gray-600"),s&&(s.className="md:hidden fixed bottom-20 right-4 w-12 h-12 bg-red-600 text-white rounded-full shadow-lg flex items-center justify-center hover:scale-105 transition-all z-40")),yt()}async function Me(){const e=document.getElementById("list-container");e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-xs">A processar transações...</p></div>';try{if($.natures.length===0){const[r,i]=await Promise.all([ba(m.establishmentId),rs(m.establishmentId)]);$.natures=r,$.costCenters=i,sr()}const t=Array.from($.filterEstablishmentIds).join(","),a={startDate:$.startDate,endDate:$.endDate,establishmentId:t};$.filterNaturezaId!=="all"&&(a.natureId=$.filterNaturezaId),$.filterCostCenterId!=="all"&&(a.costCenterId=$.filterCostCenterId);const[s,o]=await Promise.all([Ro(a),Fo(a)]);$.payables=s.entries||[],$.receivables=o.entries||[],or(),yt()}catch(t){e.innerHTML=`
    ...
    `}function jd(){document.querySelectorAll(".sort-header").forEach(e=>{const t=e.querySelector("i");if(!t)return;e.dataset.sort===$.sortCol?(e.classList.add("text-indigo-700"),e.classList.remove("text-gray-500"),t.className=$.sortAsc?"bi bi-arrow-up ml-1 text-indigo-600":"bi bi-arrow-down ml-1 text-indigo-600"):(e.classList.remove("text-indigo-700"),e.classList.add("text-gray-500"),t.className="bi bi-arrow-down-up ml-1 opacity-30 text-[10px]")})}function yt(){const e=document.getElementById("list-container");if(!e)return;const t=$.currentTab==="receivables",a=t?$.receivables:$.payables;let s=a;if($.statusFilter!=="all"&&(s=a.filter(l=>{const c=et(l.dueDate,l.status);return $.statusFilter==="overdue"?c:$.statusFilter==="pending"?l.status==="pending"&&!c:l.status===$.statusFilter})),$.searchQuery&&(s=s.filter(l=>l.description&&l.description.toLowerCase().includes($.searchQuery)||l.entity&&l.entity.toLowerCase().includes($.searchQuery)||l.notes&&l.notes.toLowerCase().includes($.searchQuery))),s.sort((l,c)=>{let u=l[$.sortCol],p=c[$.sortCol];return $.sortCol==="dueDate"?(u=new Date(u).getTime(),p=new Date(p).getTime()):($.sortCol==="description"||$.sortCol==="status")&&(u=u?u.toLowerCase():"",p=p?p.toLowerCase():""),u<p?$.sortAsc?-1:1:u>p?$.sortAsc?1:-1:0}),jd(),s.length===0){e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <div class="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center mb-3">
        ...
        `;return}const o=new Map($.natures.map(l=>[l.id,l.name])),r=new Map($.costCenters.map(l=>[l.id,l.name])),i=new Map($.establishments.map(l=>[l.id,l])),n=t?"receivable":"payable",d=t?"text-emerald-600":"text-red-600";e.innerHTML=s.map(l=>{const c=er(l.dueDate),u=l.status==="paid",p=et(l.dueDate,l.status);let f="";u?f='<span class="bg-gray-100 text-gray-500 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest"><i class="bi bi-check2-circle mr-0.5"></i> Baixado</span>':p?f='<span class="bg-red-50 text-red-600 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest"><i class="bi bi-exclamation-circle mr-0.5"></i> Atrasado</span>':f='<span class="bg-blue-50 text-blue-600 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest"><i class="bi bi-clock-history mr-0.5"></i> A Vencer</span>';const w=l.naturezaId?o.get(l.naturezaId)||"Sem Natureza":"Não Categorizado",k=l.centroDeCustoId?r.get(l.centroDeCustoId)||"Sem Centro":"Geral",T=l.saleId||l.appointmentId||l.origin==="comanda"?'<span class="text-[8px] font-bold text-purple-600 bg-purple-50 px-1.5 py-0.5 rounded border border-purple-100"><i class="bi bi-receipt mr-1"></i>Comanda</span>':'<span class="text-[8px] font-bold text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200"><i class="bi bi-keyboard mr-1"></i>Manual</span>',P=l.documentNumber?`<span class="text-[8px] bg-amber-50 text-amber-700 border border-amber-200 px-1.5 py-0.5 rounded ml-2" title="NFS / Documento">NFS: ${l.documentNumber}</span>`:"",S=i.get(l.establishmentId);let x="";if(S){const j=S.type==="Matriz"?"bi-building":"bi-shop";x=`<span class="text-[8px] px-1.5 py-0.5 rounded bg-slate-100 text-slate-500 font-bold border border-slate-200 flex items-center whitespace-nowrap w-max" title="Unidade: ${S.name}"><i class="bi ${j} mr-1 opacity-60"></i> ${S.name}</span>`}else x='<span class="text-[8px] px-1.5 py-0.5 rounded bg-gray-100 text-gray-500 font-bold border border-gray-200 flex items-center whitespace-nowrap w-max"><i class="bi bi-geo-alt mr-1 opacity-60"></i> Atual</span>';const g=JSON.stringify(l).replace(/'/g,"&apos;"),I=$.selectedIds.has(l.id),C=!!l.recurrenceId?'<i class="bi bi-arrow-repeat text-indigo-400 ml-1 text-[10px]" title="Lançamento Recorrente"></i>':"",D=l.entity?`<span class="text-[9px] text-gray-400 font-medium truncate block mt-0.5"><i class="bi bi-person mr-1 opacity-40"></i>${l.entity}</span>`:"";return`
        <div class="financial-row border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer relative group flex flex-col md:grid md:grid-cols-12 md:gap-2 md:items-center p-1.5 md:p-2 mb-1 ${I?"bg-indigo-50/40":""}"
            ...
            <div class="md:col-span-2 hidden md:flex flex-col justify-center min-w-0">
                <p class="text-[9px] text-gray-600 font-bold truncate" title="Natureza: ${w}"><i class="bi bi-tag opacity-50 mr-1"></i> ${w}</p>
            ...
            <div class="md:hidden flex flex-wrap items-center gap-1.5 mt-1 ml-11">
                ...
                <span class="text-[8px] px-1.5 py-0.5 rounded bg-gray-50 text-gray-500 font-bold border border-gray-200 flex items-center">
                    <i class="bi bi-tag mr-1 opacity-50"></i> ${w}
                </span>
                ${T}
            </div>
        ...
        `}).join("")}async function Rd(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Bn(t,a):Nn(t,a)),b("Baixa Realizada","O lançamento foi registado como pago.","success"),await Me()}catch(s){b("Erro",s.message,"error")}}async function Fd(e,t){if(!!!t.recurrenceId){await G("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await rr(e,[t.id]);return}Hd(e,t)}function Hd(e,t){const a=document.getElementById("genericModal"),o=(e==="payable"?$.payables:$.receivables).filter(l=>l.recurrenceId===t.recurrenceId).sort((l,c)=>new Date(l.dueDate)-new Date(c.dueDate));a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${o.map(l=>{const c=l.id===t.id,u=l.status==="paid",p=er(l.dueDate);return`
    ...
    `,a.style.display="flex";const r=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");r.addEventListener("change",l=>{i.forEach(c=>c.checked=l.target.checked),d()}),i.forEach(l=>l.addEventListener("change",d));function d(){const l=Array.from(i).filter(c=>c.checked).length;n.innerHTML=l>0?`<i class="bi bi-trash3"></i> Excluir ${l} Parcela(s)`:"Selecione para excluir",n.disabled=l===0,l===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const l=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(l.length===0)return;a.style.display="none",await G("Confirmar Ação",`Tem certeza que deseja apagar estas ${l.length} parcelas permanentemente?`)&&await rr(e,l)}),d()}async function rr(e,t){try{t.length===1?e==="payable"?await Pn(t[0]):await qn(t[0]):await No(e==="payable"?"payables":"receivables",t),b("Sucesso",`${t.length} registo(s) limpo(s) do sistema.`,"success"),$.selectedIds.clear(),Ve(),await Me()}catch(a){b("Erro",a.message,"error")}}async function Od(e,t){const s=e==="nature"?In:Cn;if(await G("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await s(t),_a(e==="nature"?"nature":"cost-center")}catch(r){b("Erro",r.message,"error")}}function zd(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ka(e,t=null){const a=document.getElementById("genericModal"),s=e==="payable",o=s?"red":"emerald",r=t?"Editar Lançamento":"Novo Lançamento",i=$.establishments.map(g=>{const I=t?t.establishmentId===g.id:g.id===m.establishmentId;return`<option value="${g.id}" ${I?"selected":""}>${g.type==="Matriz"?"🏢":"📍"} ${g.name}</option>`}).join(""),n=(g,I)=>{let A='<option value="">-- Selecione --</option>';const C=ms(g),D=(j,H=0)=>{const V="  ".repeat(H)+(H>0?"↳ ":""),O=j.id===I?"selected":"";A+=`<option value="${j.id}" ${O}>${V}${j.name}</option>`,j.children.forEach(B=>D(B,H+1))};return C.forEach(j=>D(j)),A},l=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(g=>`<option value="${g.value}" ${t?.paymentMethod===g.value?"selected":""}>${g.label}</option>`).join("");a.innerHTML=`
        ...
        </div>`,a.style.display="flex";const c=a.querySelector("#financial-form");let u="single",p=2;const f=c.querySelector('[name="amount"]'),w=c.querySelector("#recurrence-options"),k=c.querySelector("#recurrence-summary"),h=c.querySelector("#installments-input"),T=c.querySelector("#status-toggle"),P=c.querySelector("#payment-date-wrapper"),S=c.querySelector('[name="paymentDate"]'),x=()=>{if(u==="single")return;const g=parseFloat(f.value)||0;if(p=parseInt(h.value)||2,g===0){k.innerHTML='<span class="text-[10px] text-indigo-400 font-medium">Digite o valor total...</span>';return}if(u==="installment"){const I=g/p;k.innerHTML=`
                <div>
                    <span class="block text-[9px] text-indigo-400 uppercase tracking-widest font-bold mb-0.5">Simulação do Parcelamento</span>
                    <span class="font-bold text-sm text-indigo-700 block leading-tight">${p}x de ${pe(I)}</span>
                    <span class="text-[10px] text-indigo-500 font-medium">Total: ${pe(g)}</span>
                </div>
            `}else if(u==="repeat"){const I=g*p;k.innerHTML=`
                <div>
                    <span class="block text-[9px] text-indigo-400 uppercase tracking-widest font-bold mb-0.5">Geração Recorrente Fixa</span>
                    <span class="font-bold text-sm text-indigo-700 block leading-tight">${p}x de ${pe(g)}</span>
                    <span class="text-[10px] text-indigo-500 font-medium">Lançamento Total: ${pe(I)}</span>
                </div>
            `}};c.addEventListener("click",g=>{const I=g.target.closest(".mode-btn");if(I&&!t)if(g.preventDefault(),c.querySelectorAll(".mode-btn").forEach(D=>{D.classList.remove("bg-gray-900","text-white","shadow-sm"),D.classList.add("text-gray-500","hover:bg-gray-100")}),I.classList.add("bg-gray-900","text-white","shadow-sm"),I.classList.remove("text-gray-500","hover:bg-gray-100"),u=I.dataset.mode,u==="single")w.style.display="none";else{w.style.display="block";const D=w.querySelector("#recurrence-label");D&&(D.textContent=u==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),x()}if(g.target.closest("#btn-minus")&&h){g.preventDefault();let D=parseInt(h.value)||2;D>2&&(h.value=D-1,x())}if(g.target.closest("#btn-plus")&&h){g.preventDefault();let D=parseInt(h.value)||2;D<60&&(h.value=D+1,x())}}),f.addEventListener("input",x),h&&h.addEventListener("input",x),T.addEventListener("change",()=>{T.checked?(P.classList.remove("hidden"),S.required=!0):(P.classList.add("hidden"),S.required=!1)}),c.addEventListener("submit",async g=>{g.preventDefault();const I=c.querySelector('button[type="submit"]'),A=I.innerHTML;I.disabled=!0,I.innerHTML='<div class="loader-small border-white"></div> A gravar...';const C=new FormData(c),D=T.checked,j=parseFloat(C.get("amount"));let H=j,V=1;!t&&u!=="single"&&(V=parseInt(C.get("installments")),u==="repeat"&&(H=j*V));const O={establishmentId:C.get("establishmentId"),description:C.get("description"),amount:H,dueDate:C.get("dueDate"),naturezaId:C.get("naturezaId")||null,centroDeCustoId:C.get("centroDeCustoId")||null,entity:C.get("entity")||null,paymentMethod:C.get("paymentMethod")||null,documentNumber:C.get("documentNumber")||null,notes:C.get("notes"),status:D?"paid":"pending",paymentDate:D?C.get("paymentDate"):null,installments:V};V>1&&!t&&(O.recurrenceId=self.crypto.randomUUID());try{t?(await(s?Tn(t.id,O):An(t.id,O)),b("Sucesso","Atualizado com sucesso!","success")):(await(s?Dn(O):Mn(O)),b("Sucesso","Lançamento criado!","success")),document.getElementById("genericModal").style.display="none",Me()}catch(B){b("Erro",B.message||"Erro ao salvar","error"),I.disabled=!1,I.innerHTML=A}})}const Vd=e=>L("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),_d=e=>L("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),Ud=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return L(`/api/commissions/stats?${a}`)},Wd=(e={})=>{Object.keys(e).forEach(s=>(e[s]===void 0||e[s]===null||e[s]==="")&&delete e[s]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return L(a)},ir=e=>L(`/api/commissions/report/${e}`,{method:"DELETE"}),Ua=new Date,Jd=new Date(Ua.getFullYear(),Ua.getMonth(),1);let q={professionals:[],reports:[],calculationResult:null,periodString:"",establishments:[],filterEstablishmentIds:new Set,selectedIds:new Set,startDate:Jd.toISOString().split("T")[0],endDate:Ua.toISOString().split("T")[0],professionalId:"all",searchQuery:"",stats:{revenue:0,commissions:0,margin:0,netPaid:0}},zt=null;const Gd=document.getElementById("content");function wt(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0)}function Xd(e){return e?new Date(e).toLocaleDateString("pt-BR"):"--/--/----"}function aa(e){if(!e)return"PR";const t=e.trim().split(" ");return t.length>=2?(t[0][0]+t[t.length-1][0]).toUpperCase():e.substring(0,2).toUpperCase()}async function Qd(){try{const[e,t]=await Promise.all([ye(m.establishmentId),ge().catch(()=>({matrizes:[]}))]);q.professionals=e;const a=t.matrizes||[];q.establishments=[],a.forEach(s=>{q.establishments.push({id:s.id,name:s.name,type:"Matriz"}),s.branches&&s.branches.forEach(o=>q.establishments.push({id:o.id,name:o.name,type:"Filial"}))}),q.filterEstablishmentIds.size===0&&q.filterEstablishmentIds.add(m.establishmentId)}catch(e){console.error("Erro na inicialização de comissões",e)}Yd(),Kd(),await tt()}function Yd(){const e=q.professionals.map(a=>`<option value="${a.id}">${a.name}</option>`).join(""),t=q.establishments.map(a=>`
        <label class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white border ${q.filterEstablishmentIds.has(a.id)?"border-indigo-500 ring-1 ring-indigo-500 bg-indigo-50/20 text-indigo-700":"border-slate-200 text-slate-600"} rounded-lg cursor-pointer hover:bg-slate-50 transition-all shadow-sm est-label select-none">
            <input type="checkbox" class="est-filter-checkbox rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 w-3 h-3" value="${a.id}" ${q.filterEstablishmentIds.has(a.id)?"checked":""}>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-3 gap-2 w-full bg-white p-2 rounded-xl border border-slate-200 shadow-sm">
                <div class="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
                    <div class="flex items-center gap-1 w-full md:w-auto">
                        ...
                        <input type="date" id="filter-start" value="${q.startDate}" class="py-1 px-2 bg-slate-50 border border-slate-200 rounded text-xs font-semibold text-slate-700 outline-none focus:border-indigo-400">
                        <span class="text-slate-400 text-xs">até</span>
                        <input type="date" id="filter-end" value="${q.endDate}" class="py-1 px-2 bg-slate-50 border border-slate-200 rounded text-xs font-semibold text-slate-700 outline-none focus:border-indigo-400">
                    </div>
    ...
    `}async function tt(){const e=document.getElementById("list-container");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';const t=Array.from(q.filterEstablishmentIds).join(",");try{const[a,s]=await Promise.all([Wd({startDate:q.startDate,endDate:q.endDate,professionalId:q.professionalId,establishmentId:t}),Ud(q.startDate,q.endDate,t)]);q.reports=a||[];const o=q.reports.reduce((r,i)=>r+(i.summary.finalValue||i.summary.totalCommission),0);q.stats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0,margin:s.totalRevenue>0?((s.totalRevenue-s.totalCommissionsPaid)/s.totalRevenue*100).toFixed(1):0,netPaid:o},q.selectedIds.clear(),kt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),Zd(),nr()}catch(a){console.error(a),e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
                <p class="text-slate-600 text-xs font-medium">Erro ao carregar dados.</p>
            </div>`}}function Zd(){document.getElementById("kpi-revenue").textContent=wt(q.stats.revenue),document.getElementById("kpi-commissions").textContent=wt(q.stats.commissions),document.getElementById("kpi-margin").textContent=`${q.stats.margin}%`,document.getElementById("kpi-net").textContent=wt(q.stats.netPaid)}function nr(){const e=document.getElementById("list-container");let t=q.reports;if(q.searchQuery){const a=q.searchQuery.toLowerCase();t=t.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(t.length===0){e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-20 text-center">
                <div class="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center mb-3">
        ...
        `;return}e.innerHTML=t.map(a=>{const s=Xd(a.createdAt),o=a.summary.totalCommission,r=a.summary.extraDebit||0,i=a.summary.extraCredit||0,n=a.summary.finalValue||o,d=q.selectedIds.has(a.id);let l="";return r>0&&i>0?l=`<span class="text-red-500">-R$${r.toFixed(2)}</span> / <span class="text-emerald-500">+R$${i.toFixed(2)}</span>`:r>0?l=`<span class="text-red-500">-R$ ${r.toFixed(2)}</span>`:i>0?l=`<span class="text-emerald-500">+R$ ${i.toFixed(2)}</span>`:l='<span class="text-slate-300">--</span>',`
        <div class="border-b border-slate-100 hover:bg-slate-50/80 transition-colors relative group flex flex-col md:grid md:grid-cols-12 md:gap-2 md:items-center p-2.5 md:px-3 md:py-2 mb-2 md:mb-0 bg-white md:bg-transparent rounded-xl md:rounded-none shadow-sm md:shadow-none border md:border-b ${d?"bg-indigo-50/40":""}">
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:block mb-1 md:mb-0 ml-10 md:ml-0">
                ...
                <span class="text-xs font-bold text-slate-700">${wt(o)}</span>
            </div>
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:block pt-1 md:pt-0 border-t md:border-0 border-slate-100 ml-10 md:ml-0 mt-1 md:mt-0">
                ...
                <span class="text-xs font-black text-emerald-600">${wt(n)}</span>
            </div>
        ...
        `}).join("")}function Kd(){zt&&document.body.removeEventListener("click",zt),zt=o=>{const r=o.target;if(r.classList.contains("item-checkbox")){const n=r.value;r.checked?q.selectedIds.add(n):q.selectedIds.delete(n),kt(),o.stopPropagation();return}const i=r.closest("button[data-action]");if(i){const n=i.dataset.action,d=i.dataset.id;switch(n){case"apply-filters":q.startDate=document.getElementById("filter-start").value,q.endDate=document.getElementById("filter-end").value,q.professionalId=document.getElementById("filter-prof").value,tt();break;case"new-calculation":ec();break;case"print-receipt":lc(d);break;case"delete-report":cc(d);break;case"view-report-details":ic(d);break;case"toggle-all-profs":const l=document.querySelectorAll(".prof-checkbox"),c=Array.from(l).every(w=>w.checked);l.forEach(w=>w.checked=!c);break;case"calculate-preview":tc();break;case"save-final-reports":rc();break;case"toggle-preview-details":const u=i.dataset.idx,p=document.getElementById(`preview-details-${u}`),f=i.querySelector("i");p&&(p.classList.contains("hidden")?(p.classList.remove("hidden"),f&&f.classList.replace("bi-chevron-down","bi-chevron-up")):(p.classList.add("hidden"),f&&f.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",zt),document.getElementById("search-input").addEventListener("input",o=>{q.searchQuery=o.target.value,nr()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&sc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const r=o.target.checked,i=document.querySelectorAll(".item-checkbox");q.selectedIds.clear(),i.forEach(n=>{n.checked=r,r&&q.selectedIds.add(n.value)}),kt()});const t=document.getElementById("cancel-selection-btn");t&&t.addEventListener("click",()=>{q.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),kt()});const a=document.getElementById("batch-delete-btn");a&&a.addEventListener("click",dc),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",r=>{const i=r.target.closest("label");r.target.checked?(q.filterEstablishmentIds.add(r.target.value),i.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.remove("border-slate-200","text-slate-600")):(q.filterEstablishmentIds.delete(r.target.value),i.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.add("border-slate-200","text-slate-600")),tt()})});const s=document.getElementById("export-excel-btn");s&&s.addEventListener("click",nc)}function kt(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=q.selectedIds.size;t&&(t.textContent=a),e&&(a>0?(e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex")))}function ec(){const e=new Date().toISOString().split("T")[0],t=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],a=q.professionals.map(o=>`
        <label class="flex items-center p-2.5 bg-white border border-slate-200 rounded-lg shadow-sm hover:border-indigo-300 transition-all cursor-pointer group">
            ...
            <div class="ml-2 flex items-center gap-2">
                <div class="w-5 h-5 rounded-full bg-slate-100 text-slate-500 flex items-center justify-center text-[9px] font-bold group-hover:bg-indigo-100 group-hover:text-indigo-600 transition-colors">${aa(o.name)}</div>
    ...
    `;de({title:"Nova Apuração de Comissões",contentHTML:s,maxWidth:"max-w-2xl"})}async function tc(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(l=>l.value);if(e.length===0)return b("Atenção","Selecione pelo menos um profissional.","warning");const t=Array.from(q.filterEstablishmentIds).join(","),a=document.getElementById("calc-start-date"),s=document.getElementById("calc-end-date");if(!a||!s||!a.value||!s.value)return b("Atenção","As datas de início e fim são obrigatórias.","warning");const o={professionalIds:e,startDate:a.value,endDate:s.value,establishmentId:t,calculationTypes:{services:document.getElementById("calc-type-services")?.checked||!1,products:document.getElementById("calc-type-products")?.checked||!1,packages:document.getElementById("calc-type-packages")?.checked||!1}},r=new Date(o.startDate+"T00:00:00").toLocaleDateString("pt-BR"),i=new Date(o.endDate+"T00:00:00").toLocaleDateString("pt-BR");q.periodString=`${r} a ${i}`;const n=document.getElementById("btn-calc-action"),d=n.innerHTML;n.innerHTML='<div class="loader-small border-white mr-1"></div> Processando...',n.disabled=!0;try{console.log("Enviando cálculo...",o);const l=await Vd(o);q.calculationResult=l.map(c=>({...c,extraDebit:0,extraCredit:0,finalValue:c.summary.totalCommission,notes:""})),ac()}catch(l){b("Erro na Apuração",l.message,"error"),n.innerHTML=d,n.disabled=!1}}function ac(){const e=q.calculationResult;if(!e||e.length===0||e.every(i=>i.summary.totalCommission===0)){b("Aviso","Nenhuma comissão encontrada para os filtros selecionados.","info");const i=document.getElementById("btn-calc-action");i.innerHTML='<i class="bi bi-lightning-charge"></i> Calcular Vendas',i.disabled=!1;return}const t=document.getElementById("calc-step-1"),a=document.getElementById("calc-step-2"),s=document.getElementById("btn-calc-action");t&&t.classList.add("hidden"),a&&a.classList.remove("hidden"),s&&(s.dataset.action="save-final-reports",s.className="py-2 px-5 bg-emerald-600 text-white font-bold text-[10px] uppercase tracking-wider rounded-lg hover:bg-emerald-700 shadow-sm transition-all flex items-center gap-2",s.innerHTML='<i class="bi bi-check2-circle text-sm"></i> Confirmar Pagamentos',s.disabled=!1);const o=e.reduce((i,n)=>i+n.finalValue,0),r=e.map((i,n)=>{if(i.summary.totalCommission===0)return"";const d=(i.items||[]).map(c=>`
        ...
        <div class="bg-indigo-600 p-3 rounded-xl shadow-sm text-white mb-2 flex justify-between items-center">
            ...
            <div class="text-right">
                ...
                <span class="text-[10px] font-bold bg-white/20 px-1.5 py-0.5 rounded border border-white/20">${q.periodString}</span>
            </div>
        </div>
        ${r}
    `)}function sc(e){const t=document.querySelector(`.input-debit[data-idx="${e}"]`),a=document.querySelector(`.input-credit[data-idx="${e}"]`),s=document.querySelector(`.input-notes[data-idx="${e}"]`);let o=parseFloat(t?.value)||0,r=parseFloat(a?.value)||0,i=s?.value||"";if(q.calculationResult&&q.calculationResult[e]){const n=q.calculationResult[e];n.extraDebit=o,n.extraCredit=r,n.notes=i,n.finalValue=n.summary.totalCommission-o+r;const d=document.querySelector(`.final-value-display[data-idx="${e}"]`);d&&(d.innerText=`R$ ${n.finalValue.toFixed(2)}`),oc()}}function oc(){const e=q.calculationResult.reduce((a,s)=>a+s.finalValue,0),t=document.getElementById("grand-total-preview");t&&(t.innerText=`R$ ${e.toFixed(2)}`)}async function rc(){const e=q.calculationResult.filter(o=>o.summary.totalCommission>0),t=e.length;if(t===0)return b("Aviso","Não há valores para pagar.","info");if(!await G("Confirmar Pagamentos",`Você está prestes a gerar recibos e marcar as vendas de ${t} profissional(is) como PAGAS. Confirmar?`))return;const s=document.getElementById("btn-calc-action");s.innerHTML='<div class="loader-small border-white mr-1"></div> Finalizando...',s.disabled=!0;try{const o=e.map(r=>{const i=(r.items||[]).map(n=>n.originalSaleId).filter(n=>n!=null);return _d({professionalId:r.professionalId,professionalName:r.professionalName,period:q.periodString,processedSalesIds:i,establishmentId:m.establishmentId,reportData:{...r,summary:{...r.summary,finalValue:r.finalValue,extraDebit:r.extraDebit||0,extraCredit:r.extraCredit||0,notes:r.notes||""}}})});await Promise.all(o),b("Sucesso","Pagamentos registrados e vendas baixadas!","success"),q.calculationResult=null,document.getElementById("genericModal").style.display="none",await tt()}catch(o){b("Erro ao Salvar",o.message,"error"),s.innerHTML='<i class="bi bi-check2-circle text-sm"></i> Confirmar Pagamentos',s.disabled=!1}}function ic(e){const t=q.reports.find(c=>c.id===e);if(!t)return;const a=t.reportData?.items||t.items||[],s=t.summary,o=s.extraDebit||0,r=s.extraCredit||0,i=s.notes||"",n=a.map(c=>`
    ...
    `;de({title:"Detalhes do Pagamento",contentHTML:l,maxWidth:"max-w-3xl"})}function nc(){if(q.reports.length===0){b("Aviso","Não há dados para exportar com os filtros atuais.","info");return}let e=q.reports;if(q.searchQuery){const a=q.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}const t=e.map(a=>{const s=a.summary.totalCommission,o=a.summary.extraDebit||0,r=a.summary.extraCredit||0,i=a.summary.finalValue||s;return{"Data da Apuração":new Date(a.createdAt).toLocaleDateString("pt-BR"),Profissional:a.professionalName,"Período Base":a.period,"Itens Calculados":a.summary.totalItems||0,"Valor Bruto (R$)":s,"Bônus (R$)":r,"Descontos (R$)":o,"Líquido Pago (R$)":i,"Observações/Motivo":a.summary.notes||""}});try{if(typeof XLSX>"u"){b("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const a=XLSX.utils.json_to_sheet(t),s=XLSX.utils.book_new();XLSX.utils.book_append_sheet(s,a,"Comissoes");const o=`Relatorio_Comissoes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(s,o)}catch(a){console.error(a),b("Erro","Falha ao exportar Excel.","error")}}function lc(e){const t=q.reports.find(c=>c.id===e);if(!t)return;if(!window.jspdf){b("Erro","A biblioteca de PDF não foi carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a;s.setFillColor(79,70,229),s.rect(0,0,210,40,"F"),s.setTextColor(255,255,255),s.setFontSize(22),s.setFont(void 0,"bold"),s.text("RECIBO DE COMISSÕES",105,20,{align:"center"}),s.setFontSize(10),s.text(`Data de Emissão: ${new Date().toLocaleDateString("pt-BR")}`,105,28,{align:"center"}),s.setTextColor(50,50,50),s.setFontSize(11),s.setFont(void 0,"normal"),s.text("Profissional:",15,55),s.setFont(void 0,"bold"),s.text(t.professionalName,40,55),s.setFont(void 0,"normal"),s.text("Período:",130,55),s.setFont(void 0,"bold"),s.text(t.period,147,55);const o=t.reportData?.items||t.items||[];let r=70;if(o.length>0){const c=o.map(u=>[u.item||"Item",u.client||"--",`R$ ${(u.value||0).toFixed(2)}`,`${u.commissionRate||0}%`,`R$ ${(u.commissionValue||0).toFixed(2)}`]);s.autoTable({startY:r,head:[["Serviço/Produto","Cliente","Valor Base","Taxa","Comissão"]],body:c,theme:"striped",headStyles:{fillColor:[241,245,249],textColor:[71,85,105],fontStyle:"bold"},styles:{fontSize:8},columnStyles:{2:{halign:"right"},3:{halign:"center"},4:{halign:"right",fontStyle:"bold",textColor:[5,150,105]}}}),r=s.lastAutoTable.finalY+15}const i=t.summary,n=i.finalValue||i.totalCommission,d=[["Comissões Brutas (Soma dos Itens)",`R$ ${i.totalCommission.toFixed(2)}`]];i.extraCredit>0&&d.push(["(+) Bônus Extras",`R$ ${i.extraCredit.toFixed(2)}`]),i.extraDebit>0&&d.push(["(-) Descontos / Vales",`R$ ${i.extraDebit.toFixed(2)}`]),s.autoTable({startY:r,head:[["Resumo do Fechamento","Valor"]],body:d,theme:"grid",headStyles:{fillColor:[79,70,229],textColor:[255,255,255]},columnStyles:{1:{halign:"right",fontStyle:"bold"}}});const l=s.lastAutoTable.finalY+15;s.setFillColor(236,253,245),s.rect(120,l-8,75,15,"F"),s.setTextColor(5,150,105),s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${n.toFixed(2)}`,190,l,{align:"right"}),i.notes&&(s.setTextColor(100,100,100),s.setFontSize(9),s.setFont(void 0,"normal"),s.text(`Obs/Motivo: ${i.notes}`,15,l+10)),s.setTextColor(150,150,150),s.setFontSize(9),s.line(20,l+40,90,l+40),s.text("Assinatura da Empresa",55,l+45,{align:"center"}),s.line(120,l+40,190,l+40),s.text("Assinatura do Profissional",155,l+45,{align:"center"}),s.save(`Recibo_Comissoes_${t.professionalName.replace(/\s+/g,"_")}.pdf`)}async function dc(){const e=q.selectedIds.size;if(!(e===0||!await G("Excluir Recibos",`Deseja excluir e estornar ${e} recibo(s)? As vendas associadas voltarão ao status "A Apurar".`)))try{const a=Array.from(q.selectedIds).map(s=>ir(s));await Promise.all(a),b("Sucesso",`${e} recibos excluídos com sucesso.`,"success"),q.selectedIds.clear(),kt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),await tt()}catch{b("Erro ao Excluir","Ocorreu um erro ao excluir alguns recibos.","error")}}async function cc(e){if(await G("Excluir Recibo",'ATENÇÃO: Deseja realmente excluir este recibo? As vendas associadas a ele voltarão ao status "A Apurar" e o valor será subtraído dos relatórios. Esta ação não pode ser desfeita.'))try{await ir(e),b("Sucesso","Recibo cancelado com sucesso. Vendas estornadas para apuração.","success"),await tt()}catch(a){b("Erro ao Excluir",a.message,"error")}}const Wa=document.getElementById("content");let _={allPackages:[],catalogForModal:{services:[],products:[]},establishments:[],filterEstablishmentIds:new Set,searchQuery:"",statusFilter:"all"},Vt=null,_e=null;function Ae(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0)}function uc(){const e=_.allPackages.length,t=_.allPackages.filter(r=>r.status!=="inactive"),a=t.length,s=a>0?t.reduce((r,i)=>r+(i.price||0),0)/a:0;let o=0;return t.forEach(r=>{const i=r.originalPrice||0,n=r.price||0;if(i>0&&i>n){const d=(i-n)/i*100;d>o&&(o=d)}}),{total:e,activeCount:a,avgPrice:s,maxDiscount:o}}async function pc(){try{const t=(await ge().catch(()=>({matrizes:[]}))).matrizes||[];_.establishments=[],t.forEach(a=>{_.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>_.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),_.filterEstablishmentIds.size===0&&_.filterEstablishmentIds.add(m.establishmentId)}catch(e){console.error("Erro ao buscar hierarquia de empresas",e)}mc(),xc(),await sa()}async function sa(){const e=document.getElementById("packagesListContainer");e&&(e.innerHTML='<div class="col-span-full flex justify-center py-20"><div class="loader"></div></div>');try{const t=Array.from(_.filterEstablishmentIds).map(i=>os(i).catch(()=>[])),a=await Promise.all(t),s=new Map;a.flat().forEach(i=>{s.has(i.id)||s.set(i.id,i)}),_.allPackages=Array.from(s.values());const[o,r]=await Promise.all([st(m.establishmentId).catch(()=>[]),ot(m.establishmentId).catch(()=>[])]);_.catalogForModal={services:(o||[]).filter(i=>i.active),products:r||[]},bc(),Ja()}catch(t){console.error(t),e&&(e.innerHTML=`
            ...
            `)}}function mc(){const e=_.establishments.map(t=>`
        <label class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white border ${_.filterEstablishmentIds.has(t.id)?"border-indigo-500 ring-1 ring-indigo-500 bg-indigo-50/20 text-indigo-700":"border-slate-200 text-slate-600"} rounded-lg cursor-pointer hover:bg-slate-50 transition-all shadow-sm est-label select-none">
            <input type="checkbox" class="est-filter-checkbox rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 w-3 h-3" value="${t.id}" ${_.filterEstablishmentIds.has(t.id)?"checked":""}>
            <span class="text-[10px] font-bold whitespace-nowrap">${t.type==="Matriz"?'<i class="bi bi-building mr-1"></i>':'<i class="bi bi-shop mr-1"></i>'} ${t.name}</span>
        </label>
    `).join("");Wa.innerHTML=`
    ...
    `}function bc(){const e=uc(),t=document.getElementById("kpi-container");t&&(t.innerHTML=`
    ...
    `)}function Ja(){const e=document.getElementById("packagesListContainer");if(!e)return;let t=_.allPackages;if(_.statusFilter!=="all"){const s=_.statusFilter==="active";t=t.filter(o=>o.status!=="inactive"===s)}if(_.searchQuery){const s=_.searchQuery.toLowerCase();t=t.filter(o=>o.name.toLowerCase().includes(s)||(o.description||"").toLowerCase().includes(s))}if(t.length===0){e.innerHTML=`
        ...
        `;return}const a=new Map(_.establishments.map(s=>[s.id,s]));e.innerHTML=t.map(s=>{const o=s.status!=="inactive",r=s.price||0,i=s.originalPrice||0,n=i>0&&i>r?(i-r)/i*100:0,d=v(s.name),l=v(s.description||"Nenhuma descrição detalhada."),c=JSON.stringify(s).replace(/'/g,"&apos;"),u=(s.items||[]).reduce((h,T)=>h+(T.quantity||1),0),p=s.validityDays?`${s.validityDays} dias p/ uso`:"Uso vitalício",f=s.sellEndDate?`Até ${new Date(s.sellEndDate).toLocaleDateString("pt-BR")}`:"Venda contínua",w=s.establishmentIds||(s.establishmentId?[s.establishmentId]:[]);let k="";if(w.length===1){const h=a.get(w[0]);if(h){const T=h.type==="Matriz"?"bi-building":"bi-shop";k=`<span class="text-[9px] px-1.5 py-0.5 rounded bg-slate-100 text-slate-600 font-bold border border-slate-200 flex items-center w-max" title="${h.name}"><i class="bi ${T} mr-1 opacity-50"></i> ${h.name}</span>`}}else w.length>1&&(k=`<span class="text-[9px] px-1.5 py-0.5 rounded bg-indigo-50 text-indigo-600 font-bold border border-indigo-100 flex items-center w-max cursor-help" title="${w.map(T=>a.get(T)?.name).filter(Boolean).join(", ")}"><i class="bi bi-buildings mr-1 opacity-50"></i> ${w.length} Unidades</span>`);return`
        ...
        <label class="flex items-center gap-2 p-2 bg-slate-50 border border-slate-200 rounded-lg hover:border-indigo-300 hover:bg-indigo-50/50 transition-colors cursor-pointer group">
            <input type="checkbox" class="modal-est-checkbox rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 w-4 h-4" value="${x.id}" ${p.includes(x.id)?"checked":""}>
            <span class="text-xs font-semibold text-slate-700 truncate group-hover:text-indigo-700" title="${x.name}">${x.type==="Matriz"?"🏢":"📍"} ${x.name}</span>
        </label>
    `).join(""),w=`
    ...
    `;t.innerHTML=w,t.style.display="flex";const k=t.querySelector("#package-items-list"),h=t.querySelector("#finalPrice"),T=t.querySelector("#discountIndicator"),P=x=>{const g=x.reduce((A,C)=>A+(C.price||0)*(C.quantity||1),0),I=parseFloat(h.value)||0;if(t.querySelector("#originalPrice").textContent=Ae(g),g>0&&g>I&&I>0){const A=(g-I)/g*100;T.textContent=`${A.toFixed(0)}% OFF`,T.classList.remove("hidden")}else T.classList.add("hidden")},S=x=>{x.length===0?k.innerHTML=`
                ...
                </div>`:k.innerHTML=x.map((g,I)=>{const A=g.type==="service",C=A?"bi-scissors":"bi-box",D=A?"bg-indigo-100 text-indigo-700 border-indigo-200":"bg-emerald-100 text-emerald-700 border-emerald-200";return`
                <div class="flex items-center justify-between bg-white p-2 rounded-xl shadow-sm border border-slate-200 hover:border-indigo-300 transition-colors animate-fade-in-fast">
                    <div class="flex items-center gap-3 min-w-0 flex-1">
                        <div class="flex flex-col items-center justify-center bg-slate-50 border border-slate-200 rounded-lg px-2 py-1">
                            ...
                            <input type="number" value="${g.quantity}" min="1" class="w-10 text-center bg-transparent text-sm font-black text-slate-700 outline-none quantity-input" data-index="${I}">
                        </div>
                        <div class="min-w-0">
                            <div class="flex items-center gap-1.5 mb-0.5">
                                <span class="text-[8px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded border ${D} flex items-center gap-1"><i class="bi ${C}"></i> ${A?"Serviço":"Produto"}</span>
                            </div>
                            <p class="font-bold text-slate-800 text-sm truncate leading-tight">${v(g.name)}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3 flex-shrink-0 pl-2">
                        <div class="text-right">
                            ...
                            <span class="text-xs font-black text-slate-700">${Ae(g.price)}</span>
                        </div>
            ...
            `}).join(""),P(x)};S(s),k.addEventListener("change",x=>{if(x.target.classList.contains("quantity-input")){const g=parseInt(x.target.dataset.index,10),I=parseInt(x.target.value,10);I>0&&s[g]&&(s[g].quantity=I,S(s))}}),k.addEventListener("click",x=>{const g=x.target.closest(".remove-item-btn");if(g){const I=parseInt(g.dataset.index,10);s.splice(I,1),S(s)}}),h.addEventListener("input",()=>{P(s)}),t.querySelector("#add-item-to-package-btn").onclick=()=>fc(x=>{const g=s.find(I=>I.id===x.id&&I.type===x.type);g?g.quantity++:s.push({...x,quantity:1}),S(s)}),_e&&t.removeEventListener("click",_e),_e=async x=>{const g=x.target.closest("button[data-action]");if(!g)return;const I=g.dataset.action;if(x.stopPropagation(),I==="close-modal"&&Os(),I==="toggle-all-ests"){const A=document.querySelectorAll(".modal-est-checkbox"),C=Array.from(A).every(D=>D.checked);A.forEach(D=>D.checked=!C)}if(I==="save-package"){const A=g,C=Array.from(document.querySelectorAll(".modal-est-checkbox:checked")).map(H=>H.value);if(C.length===0){b("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const D=s.reduce((H,V)=>H+V.price*V.quantity,0),j={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:D,price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,sellStartDate:document.getElementById("sellStartDate").value||null,sellEndDate:document.getElementById("sellEndDate").value||null,salesLimit:parseInt(document.getElementById("salesLimit").value,10)||null,establishmentIds:C,establishmentId:C[0]};if(!j.name||isNaN(j.price)){b("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(j.items.length===0){b("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}A.disabled=!0,A.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await rn(j.id,j):(delete j.id,await on(j)),b("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Os(),await sa()}catch(H){b("Erro",`Não foi possível salvar o pacote: ${H.message}`,"error"),A.disabled=!1,A.innerHTML='<i class="bi bi-save2"></i> Salvar Pacote'}}},t.addEventListener("click",_e)}function fc(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[110] p-4 animate-fade-in-fast";const s=n=>{const d=t.toLowerCase(),l=_.catalogForModal.services.filter(f=>f.name.toLowerCase().includes(d)),c=_.catalogForModal.products.filter(f=>f.name.toLowerCase().includes(d)),u=l.map(f=>`
            <button data-action="select-item" data-item-type="service" data-item-id="${f.id}" class="flex items-center gap-3 w-full p-2 bg-white border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all text-left group">
                ...
                <div class="flex-grow min-w-0">
                    <p class="font-bold text-xs text-slate-800 truncate">${v(f.name)}</p>
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">${Ae(f.price)}</p>
                </div>
                <i class="bi bi-plus-circle text-indigo-400 opacity-0 group-hover:opacity-100 transition-opacity"></i>
            </button>
        `).join("")||'<p class="text-xs text-slate-400 text-center p-4">Nenhum serviço encontrado.</p>',p=c.map(f=>`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),r=a.querySelector("#item-search-input"),i=()=>{a.classList.add("opacity-0"),setTimeout(()=>a.remove(),200)};s(o),setTimeout(()=>r.focus(),100),r.addEventListener("input",()=>{t=r.value,s(o)}),a.addEventListener("click",n=>{const d=n.target.closest('[data-action="select-item"]'),l=n.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:c,itemId:u}=d.dataset,f=(_.catalogForModal[c+"s"]||[]).find(w=>w.id===u);f&&(e({...f,type:c}),i())}else(l||n.target===a)&&i()})}function xc(){Vt&&Wa.removeEventListener("click",Vt),Vt=s=>{if(s.target.closest('[data-action-stop-propagation="true"]')){s.stopPropagation();const i=s.target.closest('[data-action="delete-package"]');if(i){const n=i.dataset.id;G("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível.").then(async d=>{if(d)try{await nn(n),b("Sucesso!","Pacote excluído.","success"),await sa()}catch(l){b("Erro",`Não foi possível excluir: ${l.message}`,"error")}})}return}const o=s.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!o)return;const r=o.dataset.action;if(r==="new-package")zs(null);else if(r==="edit-package"){const i=JSON.parse(o.dataset.package);zs(i)}},Wa.addEventListener("click",Vt);const e=document.getElementById("search-packages");e&&e.addEventListener("input",s=>{_.searchQuery=s.target.value,Ja()});const t=document.getElementById("filter-status");t&&t.addEventListener("change",s=>{_.statusFilter=s.target.value,Ja()}),document.querySelectorAll(".est-filter-checkbox").forEach(s=>{s.addEventListener("change",o=>{const r=o.target.closest("label");o.target.checked?(_.filterEstablishmentIds.add(o.target.value),r.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.remove("border-slate-200","text-slate-600")):(_.filterEstablishmentIds.delete(o.target.value),r.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.add("border-slate-200","text-slate-600")),sa()})});const a=document.getElementById("export-excel-btn");a&&a.addEventListener("click",gc)}const hc=document.getElementById("content");let vc=null;async function yc(){const e=v(m.userName||"Usuário"),t=v(le.currentUser?.email||"E-mail não disponível"),a=m.userName?m.userName.charAt(0):"U";hc.innerHTML=`
    ...
    `,await wc()}async function wc(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await Ti(t);vc=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=v(a.name);e.innerHTML=`
            ...
            `,kc(a.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>oa(a.id,r.target.value)),oa(a.id,"future")}else e.innerHTML=`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const o=(await ge()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),o.length===0)t.innerHTML=`
            ...
            `;else{let r="";o.forEach(i=>{if(a&&!i.isOrphanBranch){const d=document.createElement("option");d.value=i.id,d.textContent=i.name,a.appendChild(d)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';r+=`
                ...
                `}),t.innerHTML=r}Vs||($c(),Vs=!0)}catch(s){console.error("Erro na renderização da rede:",s),t.innerHTML=`
        ...
        `}}function $c(){const e=document.getElementById("form-create-establishment");e&&e.addEventListener("submit",async t=>{t.preventDefault();const a=e.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const o={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const r=await _r(o);alert(r.message||"Sucesso!"),e.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await ra(document.getElementById("content"))}catch(r){console.error("Erro ao criar estabelecimento:",r),alert("Erro: "+(r.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>ra(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const ae=document.getElementById("loadingScreen"),nt=document.getElementById("dashboardContent"),Ue=document.getElementById("content"),$a=document.getElementById("notificationBell"),_t=document.getElementById("notificationBadge"),Fe=document.getElementById("notificationPanel"),Ea=document.getElementById("notificationList"),lt=document.getElementById("profileMenuButton"),re=document.getElementById("profileDropdown"),_s=document.getElementById("profileName"),Us=document.getElementById("profileEmail"),Ws=document.getElementById("logoutButton"),Js=document.getElementById("myProfileLink"),Gs=document.getElementById("hamburger-menu-btn"),oe=document.getElementById("sidebar"),ne=document.getElementById("mobile-overlay"),Xs=document.getElementById("themeToggleBtn"),Sa=document.getElementById("themeIcon"),Ga=document.getElementById("mobile-bottom-nav"),at=document.getElementById("nav-scroll"),Qs=document.getElementById("scroll-hint-left"),Ys=document.getElementById("scroll-hint-right"),Ec=document.querySelectorAll(".bottom-nav-item");function Xa(){if(!at||!Qs||!Ys)return;const{scrollLeft:e,scrollWidth:t,clientWidth:a}=at;Qs.classList.toggle("visible",e>5),Ys.classList.toggle("visible",e+a<t-5)}function Sc(){if(!at)return;const e=document.querySelector(".bottom-nav-item.active");if(!e)return;const t=at,a=t.getBoundingClientRect(),s=e.getBoundingClientRect(),r=s.left+s.width/2-a.left-a.width/2;t.scrollBy({left:r,behavior:"smooth"})}const Ic={"dashboard-section":wi,"agenda-section":wo,"comandas-section":En,"relatorios-section":Rn,"servicos-section":sl,"produtos-section":gl,"suppliers-section":fl,"profissionais-section":El,"clientes-section":Rl,"estabelecimento-section":e=>Ko(e),"ausencias-section":gd,"users-section":ta,"sales-report-section":Bd,"financial-section":qd,"commissions-section":Qd,"packages-section":pc,"my-profile-section":yc,"hierarquia-section":()=>ra(Ue),"establishments-section":()=>ra(Ue)},Lc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços do Menu","produtos-section":"Produtos (Estoque)","suppliers-section":"Parceiros de Negócio","profissionais-section":"Equipe / Profissionais","clientes-section":"Clientes","estabelecimento-section":"Minha Empresa","ausencias-section":"Ausências","users-section":"Usuários e Acessos","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro (ERP)","commissions-section":"Comissões","packages-section":"Planos e Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"},Zs={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#eef2ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#eff6ff",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#1f2937"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#64748b",hover:"#475569",light:"#f1f5f9",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};function Ut(e){const t=Zs[e]||Zs.indigo,s=(r=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const o=document.getElementById("dynamic-theme-styles");o&&(o.innerHTML=`
            :root {
        ...
        `)}function Qt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("kairos_theme",e),Sa&&(e==="dark"?Sa.innerHTML="☀️":Sa.innerHTML="🌙")}function Cc(){const e=localStorage.getItem("kairos_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;Qt(e||(t?"dark":"light"))}let $t=null,Et=[];function lr(){if(!_t||!Ea)return;const e=Et.filter(t=>!t.read).length;if(e>0?(_t.textContent=e,_t.classList.remove("hidden")):_t.classList.add("hidden"),Et.length===0){Ea.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Ea.innerHTML=Et.map(t=>`
    ...
    `).join("")}function Ks(e){$t&&$t();const t=ia(ve,"establishments",e,"notifications"),a=so(t,oo("timestamp",">=",new Date),kr("timestamp","desc"));$t=$r(a,s=>{s.docChanges().forEach(o=>{if(o.type==="added"){const r=o.doc.data();Et.unshift({title:r.title,message:r.message,time:r.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),b(r.title,r.message,"info",!0),lr();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&wo()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Dc(e){const t=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),o=document.getElementById("multi-context-count"),r=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),d=document.getElementById("multi-context-arrow");if(!(!t||!r))try{const c=(await ge()).matrizes||[];let u="",p=0;if(c.forEach(f=>{u+=`
                <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors mb-1">
                    ...
                    <span class="text-[13px] sm:text-sm font-bold text-slate-700 truncate">🏢 ${Wt(f.name)}</span>
                </label>
            `,p++,f.branches&&f.branches.length>0&&f.branches.forEach(w=>{u+=`
                        <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors ml-4 mb-1 border-l-2 border-slate-100 pl-3">
                            <input type="checkbox" value="${w.id}" class="context-checkbox" data-name="${Wt(w.name)}">
                            <span class="text-[12px] sm:text-[13px] font-medium text-slate-600 truncate">📍 ${Wt(w.name)}</span>
                        </label>
                    `,p++})}),p>0){r.innerHTML=u,t.style.display="block",(!m.selectedEstablishments||m.selectedEstablishments.length===0)&&(m.selectedEstablishments=[e]);const f=Array.from(r.querySelectorAll('input[type="checkbox"]')),w=()=>{const h=f.filter(T=>T.checked);o.textContent=h.length,h.length===0?s.textContent="Nenhuma selecionada":h.length===1?s.textContent=h[0].dataset.name:s.textContent=`${h.length} Unidades`};let k=!1;f.forEach(h=>{m.selectedEstablishments.includes(h.value)&&(h.checked=!0,k=!0)}),!k&&f.length>0&&(f[0].checked=!0,m.selectedEstablishments=[f[0].value],m.establishmentId=f[0].value),w(),a.addEventListener("click",h=>{h.stopPropagation(),n.classList.toggle("hidden"),d.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",h=>{!t.contains(h.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),d.style.transform="rotate(0deg)",f.forEach(T=>{T.checked=m.selectedEstablishments.includes(T.value)}),w())}),f.forEach(h=>{h.addEventListener("change",w)}),i.addEventListener("click",async h=>{h.stopPropagation(),ae&&(ae.classList.remove("hidden","fade-out"),ae.style.display="flex");const T=f.filter(S=>S.checked);if(T.length===0){ae&&(ae.classList.add("fade-out"),setTimeout(()=>{ae.style.display="none"},500)),b("Atenção","Tem de selecionar pelo menos uma unidade.","warning");return}m.selectedEstablishments=T.map(S=>S.value);const P=m.selectedEstablishments[0];try{const S=await Be(P);m.establishmentId=P,m.establishmentName=S.name,m.enabledModules=S.modules,m.currentViewContext={id:P,name:S.name,type:S.parentId?"BRANCH":"GROUP"},typeof Ut=="function"&&Ut(S.themeColor||"indigo"),Ks(P),eo(m.userPermissions),n.classList.add("hidden"),d.style.transform="rotate(0deg)",b("Ambiente Atualizado","Exibindo informações consolidadas.","success");const x=document.querySelector(".sidebar-link.active"),g=x?x.getAttribute("data-target"):"dashboard-section";X(g)}catch(S){console.error("Erro ao aplicar contextos:",S),b("Erro","Ocorreu um problema ao trocar a visualização.","error")}finally{ae&&(ae.classList.add("fade-out"),setTimeout(()=>{ae.style.display="none"},500))}});try{const h=await Be(m.establishmentId);m.establishmentName=h.name,m.enabledModules=h.modules,m.currentViewContext={id:m.establishmentId,name:h.name,type:h.parentId?"BRANCH":"GROUP"},typeof Ut=="function"&&Ut(h.themeColor||"indigo"),Ks(m.establishmentId),eo(m.userPermissions)}catch(h){console.error(h)}}else t.style.display="none"}catch(l){console.error("Erro ao carregar switcher de contexto:",l),t.style.display="none"}}function X(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const o=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(e),r=m.enabledModules?.[a]!==!1,i=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!o&&(!r||!i)){Ue&&(Ue.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),oe&&oe.classList.contains("absolute")&&(oe.classList.add("hidden"),ne&&ne.classList.add("hidden"));return}}const s=Ic[e];if(s&&Ue){const o=document.getElementById("header-page-title");o&&(o.textContent=Lc[e]||"Painel de Gestão"),document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),Ga&&(Ec.forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),setTimeout(Sc,50),setTimeout(Xa,100)),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),Ue.innerHTML="",window.innerWidth<768&&oe&&(oe.classList.add("hidden"),ne&&ne.classList.add("hidden")),s(t)}}window.navigateTo=X;async function eo(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),r=e===null||e["agenda-section"]?.view===!0,i=e===null||e["financial-section"]?.view===!0;if(r&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!r&&!i))try{const n=await co();r&&s&&(s.textContent=n.todayAppointments.toString()),i&&o&&(o.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch(n){console.error("Erro ao carregar KPIs do cabeçalho:",n)}}async function Tc(e){try{me.getPlatform()==="android"&&await se.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0});let t=await se.checkPermissions();if(t.receive==="prompt"&&(t=await se.requestPermissions()),t.receive!=="granted")return;await se.register(),se.addListener("registration",async a=>{try{const s=It(ve,"users",e);await Qa(s,{fcmTokens:wr(a.value),platform:"native_mobile"})}catch{}}),se.addListener("pushNotificationReceived",a=>b(a.title,a.body,"info",!0)),se.addListener("pushNotificationActionPerformed",()=>X("agenda-section"))}catch{}}function Pc(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>e&&(e.style.display="block"),o=()=>e&&(e.style.display="none"),r=()=>e&&e.style.display==="block";e&&(t.addEventListener("click",()=>{o(),me.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{o(),me.isNativePlatform()?vs.exitApp():history.back()}),me.isNativePlatform()?vs.addListener("backButton",()=>{if(r())o();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(l=>l.id!=="exitConfirmationModal");if(n.length>0){n.forEach(l=>l.style.display="none");return}if(oe&&!oe.classList.contains("hidden")&&window.innerWidth<768){oe.classList.add("hidden"),ne&&ne.classList.add("hidden");return}const d=document.querySelector(".sidebar-link.active");d&&d.getAttribute("data-target")==="dashboard-section"?s():X("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(r()){o(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(l=>l.id!=="exitConfirmationModal");if(n.length>0){n.forEach(l=>l.style.display="none"),history.pushState(null,document.title,location.href);return}const d=document.querySelector(".sidebar-link.active");d&&d.getAttribute("data-target")==="dashboard-section"?s():(X("dashboard-section"),history.pushState(null,document.title,location.href))})))}function Wt(e){return e?e.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function Bc(){try{await br(le,gr)}catch{}me.isNativePlatform()&&document.body.classList.add("is-app-native"),jr(),Pc(),Cc(),Xs&&Xs.addEventListener("click",e=>{e.preventDefault();const t=document.documentElement.getAttribute("data-theme");Qt(t==="dark"?"light":"dark")}),Gs&&Gs.addEventListener("click",e=>{e.stopPropagation(),oe&&(oe.classList.remove("hidden"),oe.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),ne&&ne.classList.remove("hidden")}),Ga&&(Ga.addEventListener("click",e=>{const t=e.target.closest(".bottom-nav-item");if(!t)return;e.preventDefault();const a=t.getAttribute("data-target");X(a)}),at&&at.addEventListener("scroll",Xa),Xa()),ne&&ne.addEventListener("click",()=>{oe&&(oe.classList.add("hidden"),oe.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),ne.classList.add("hidden")}),$a&&$a.addEventListener("click",e=>{e.stopPropagation(),Fe&&(Fe.classList.toggle("hidden"),Fe.classList.contains("hidden")||(Et.forEach(t=>t.read=!0),lr()))}),lt&&lt.addEventListener("click",e=>{e.stopPropagation(),re&&(re.classList.toggle("active"),re.classList.contains("active")?re.classList.remove("hidden"):setTimeout(()=>re.classList.add("hidden"),200))}),Js&&Js.addEventListener("click",e=>{e.preventDefault(),X("my-profile-section"),re&&(re.classList.remove("active"),re.classList.add("hidden"))}),document.addEventListener("click",e=>{Fe&&!Fe.contains(e.target)&&e.target!==$a&&Fe.classList.add("hidden"),re&&!re.contains(e.target)&&e.target!==lt&&re.classList.contains("active")&&(re.classList.remove("active"),setTimeout(()=>re.classList.add("hidden"),200))}),fr(le,async e=>{if(e){if(!me.isNativePlatform()&&(li(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");t&&setTimeout(()=>{t.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await di()&&t&&(t.style.display="none")});const s=()=>{t&&(t.style.display="none")},o=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");o&&o.addEventListener("click",s),r&&r.addEventListener("click",s)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,o=e.displayName,r=null;const i=It(ve,"users",e.uid),n=await to(i);if(n.exists()){const l=n.data();s=a.role==="employee"?l.permissions||{}:null,o=l.name||o,r=l.professionalId||null}m.userProfessionalId=r,me.isNativePlatform()&&Tc(e.uid);const d=o||e.email;Ir(a.establishmentId,"Carregando...",s),lt&&(lt.textContent=d.charAt(0).toUpperCase()),_s&&(_s.textContent=d),Us&&(Us.textContent=e.email),Ws&&Ws.addEventListener("click",l=>{l.preventDefault(),$t&&$t(),xr(le).then(()=>window.location.href="/login.html")}),await Dc(a.establishmentId),Vr(X,s,m.enabledModules),ae&&(ae.classList.add("fade-out"),setTimeout(()=>{ae.style.display="none"},500)),nt&&(nt.style.display="flex"),setTimeout(()=>{Gr()},1500),X("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(t){console.error("Erro na inicialização:",t),ae&&(ae.style.display="none"),nt&&(nt.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><h2>Erro de Acesso</h2><p>${t.message}</p></div>`,nt.style.display="flex")}}else window.location.href="/login.html"})}Bc();export{io as W};
