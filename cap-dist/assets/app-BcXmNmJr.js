const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-DF2lqDjg.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-CZYPZ0h4.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as oe,d as pe,m as _a}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as js,reauthenticateWithCredential as Ns,verifyBeforeUpdateEmail as Fs,updatePassword as Hs,updateProfile as Os,setPersistence as zs,browserLocalPersistence as Vs,onAuthStateChanged as Us,signOut as _s}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as gt,getDoc as Ro,updateDoc as Ia,setDoc as Ws,addDoc as jo,collection as Ut,query as No,where as Fo,getDocs as Js,deleteDoc as Gs,arrayUnion as Ys,orderBy as Qs,onSnapshot as Xs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Zs,onMessage as Ks}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const p={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function er(e,t,a){p.establishmentId=e,p.establishmentName=t,p.userPermissions=a,p.currentViewContext={type:"BRANCH",id:e,name:t}}const Ho=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",pa=Ho?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${Ho?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",pa);async function tr(){const e=oe.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function I(e,t={}){const a=await tr();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const r=pa.replace(/\/$/,""),o=e.startsWith("/")?e:`/${e}`,s=`${r}${o}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${s}`);try{const i=await fetch(s,{...t,headers:{...a,...t.headers}});if(!i.ok){const l=(await i.json().catch(()=>({message:i.statusText}))).message||`Erro na API: ${i.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${s}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${s}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${pa}. Verifique se o servidor backend está rodando.`):i}}const Oo=(e,t,a,r=null)=>{let o=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return r&&(o+=`&professionalId=${r}`),I(o)},ar=({establishmentId:e,professionalId:t,serviceIds:a,date:r})=>{const o=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${r}`;return I(o)},or=e=>I("/api/appointments",{method:"POST",body:JSON.stringify(e)}),sr=(e,t)=>I(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),rr=e=>I(`/api/appointments/${e}`,{method:"DELETE"}),ir=e=>I(`/api/appointments/${e}/reopen`,{method:"POST"}),nr=(e,t)=>I(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Q;async function lr(){if(!Q)try{Q=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function dr(){if(!Q){console.warn("AudioContext não inicializado. O som não será tocado.");return}Q.state==="suspended"&&Q.resume();const e=Q.createOscillator(),t=Q.createGain();e.connect(t),t.connect(Q.destination),e.type="sine",e.frequency.setValueAtTime(800,Q.currentTime),t.gain.setValueAtTime(0,Q.currentTime),t.gain.linearRampToValueAtTime(.3,Q.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Q.currentTime+.2),e.start(Q.currentTime),e.stop(Q.currentTime+.2)}function g(e,t,a="info",r=!1){const o=document.getElementById("toast-container");if(!o)return;r&&dr();const s=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${i[a]||i.info}`,s.innerHTML=`
    ...
    `,o.appendChild(s),s.querySelector(".toast-close").addEventListener("click",()=>s.remove()),setTimeout(()=>{s.remove()},4e3)}function U(e,t){const a=document.getElementById("genericModal");return new Promise(r=>{a.innerHTML=`
    ...
    `;const l=o.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=o.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),o.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),o.style.display="flex",{modalElement:o,close:i,setContent:n}}function cr(){document.body.addEventListener("click",()=>{Q||lr()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const r=t.dataset.target;if(r){const o=document.getElementById(r);o&&(o.style.display="none")}}if(e.target.closest("[data-close-modal]")){const r=document.getElementById("genericModal");r&&(r.style.display="none")}})}const Y=document.getElementById("sidebar"),Ce=document.getElementById("sidebarToggle"),tt=document.getElementById("mainContent"),ur=document.querySelectorAll(".sidebar-link"),ma=document.getElementById("menu-search"),Wa=document.getElementById("hamburger-menu-btn"),ze=document.getElementById("mobile-overlay");let me=!0;function he(e){if(!Y||!tt)return;Y.classList.toggle("collapsed",e),tt.classList.toggle("sidebar-collapsed-shift",e);const t=Y.querySelector(".sidebar-search-container"),a=Y.querySelectorAll(".sidebar-category");e?(t&&(t.style.display="none"),a.forEach(r=>r.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(r=>{const o=r.getAttribute("data-target-submenu"),s=document.getElementById(o),i=r.querySelector(".submenu-arrow");s&&(s.classList.add("hidden"),s.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(t&&(t.style.display="block"),a.forEach(r=>r.style.display="block"))}function pr(){!Y||!ze||(Y.classList.add("mobile-open"),ze.classList.add("visible"))}function xt(){!Y||!ze||(Y.classList.remove("mobile-open"),ze.classList.remove("visible"))}function mr(){he(!Y.classList.contains("collapsed"))}function gr(e,t){const a=document.getElementById(e);if(!a)return;const r=a.classList.contains("hidden");r&&window.innerWidth>=1024&&Y.classList.contains("collapsed")&&he(!1),r?(a.classList.remove("hidden"),a.classList.add("flex"),t&&t.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),t&&t.classList.remove("rotate-180"))}function br(){ma&&ma.addEventListener("input",e=>{const t=e.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const r=a.querySelectorAll("li"),o=a.querySelectorAll(".sidebar-category");if(t===""){r.forEach(s=>s.style.display=""),o.forEach(s=>s.style.display="block");return}o.forEach(s=>s.style.display="none"),r.forEach(s=>{if(s.classList.contains("sidebar-category"))return;const i=s.querySelector(".sidebar-link")||s.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(t)){s.style.display="";const d=s.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const c=d.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const c=document.getElementById(d);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(v=>v.textContent.toLowerCase().includes(t))?s.style.display="":s.style.display="none")}else s.style.display="none"}})})}function fr(e,t,a){if(!Y||!tt)return;tt.classList.add("main-content-shift"),window.innerWidth>=1024?(me=!0,he(!1)):window.innerWidth>=768?(me=!1,he(!0)):(tt.classList.remove("main-content-shift","sidebar-collapsed-shift"),xt()),Ce&&Ce.addEventListener("click",o=>{o.stopPropagation(),window.innerWidth>=768?(me=!me,he(!me),me?(Ce.classList.add("text-indigo-400"),Ce.classList.remove("text-gray-400")):(Ce.classList.remove("text-indigo-400"),Ce.classList.add("text-gray-400"))):mr()}),Y.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!me&&Y.classList.contains("collapsed")&&he(!1)}),Y.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!me){const o=!!document.querySelector("#sidebarToggle:hover"),s=document.activeElement===ma;!o&&!s&&he(!0)}}),Wa&&Wa.addEventListener("click",o=>{o.stopPropagation(),pr()}),ze&&ze.addEventListener("click",o=>{o.stopPropagation(),xt()});let r=0;Y.addEventListener("touchstart",o=>{r=o.changedTouches[0].screenX},{passive:!0}),Y.addEventListener("touchend",o=>{const s=o.changedTouches[0].screenX;r-s>50&&xt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(o=>{o.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation();const i=o.getAttribute("data-target-submenu"),n=o.querySelector(".submenu-arrow");gr(i,n)})}),br(),ur.forEach(o=>{const s=o.getAttribute("data-target");if(!s)return;const i=s.replace("-section",""),n=a?.[i]!==!1,l=t===null||t[s]?.view===!0;if(!n||!l){o.parentElement&&o.parentElement.tagName==="LI"?o.parentElement.style.display="none":o.style.display="none";return}o.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),o.classList.add("active"),s&&typeof e=="function"&&e(s),window.innerWidth<768&&xt()})})}const xr=e=>I("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),We=()=>I("/api/establishments/hierarchy",{method:"GET"}),Se=e=>{const t=e||p.establishmentId;return t?I(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},La=(e,t)=>{const a=e||p.establishmentId;return a?I(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},vr=(e,t)=>{const a=e||p.establishmentId;return a?I(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},hr=(e,t)=>{const a=e||p.establishmentId;return a?I(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))};class yr{constructor(t,a,r){this.steps=t,this.currentStep=0,this.onComplete=a,this.onSkip=r,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(t=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),t&&this.onComplete?this.onComplete():!t&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const t=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",t.onBefore&&(await t.onBefore(),await this.sleep(600));const a=await this.waitForElement(t.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const o=a.getBoundingClientRect(),s=8;this.spotlight.style.top=`${o.top+window.scrollY-s}px`,this.spotlight.style.left=`${o.left+window.scrollX-s}px`,this.spotlight.style.width=`${o.width+s*2}px`,this.spotlight.style.height=`${o.height+s*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(o)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const r=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(t){const a=this.popover.getBoundingClientRect(),r=20;let o=t.bottom+window.scrollY+r,s=t.left+window.scrollX;o+a.height>window.scrollY+window.innerHeight&&(o=t.top+window.scrollY-a.height-r),s+a.width>window.innerWidth&&(s=t.right+window.scrollX-a.width),s<r&&(s=r),this.popover.style.top=`${o}px`,this.popover.style.left=`${s}px`}handleResize(){this.isActive&&this.renderStep()}sleep(t){return new Promise(a=>setTimeout(a,t))}async waitForElement(t,a){if(!t)return null;const r=Date.now();for(;Date.now()-r<a;){const o=document.querySelector(t);if(o)return o;await this.sleep(100)}return null}}async function wr(){try{console.log("A verificar Onboarding interativo...");const e=await Se(p.establishmentId);if(!e||e.parentId||e.onboardingCompleted)return;const t=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await La(p.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(o){console.error("Erro ao gravar fim do onboarding",o)}};new yr(t,a,a).start()}catch(e){console.error("Erro fatal ao iniciar onboarding:",e)}}var Ve;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ve||(Ve={}));class aa extends Error{constructor(t,a,r){super(t),this.message=t,this.code=a,this.data=r}}const kr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Sr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},r=a.Plugins=a.Plugins||{},o=()=>t!==null?t.name:kr(e),s=()=>o()!=="web",i=u=>{const m=d.get(u);return!!(m?.platforms.has(o())||n(u))},n=u=>{var m;return(m=a.PluginHeaders)===null||m===void 0?void 0:m.find(v=>v.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,m={})=>{const v=d.get(u);if(v)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),v.proxy;const b=o(),x=n(u);let h;const S=async()=>(!h&&b in m?h=typeof m[b]=="function"?h=await m[b]():h=m[b]:t!==null&&!h&&"web"in m&&(h=typeof m.web=="function"?h=await m.web():h=m.web),h),k=(T,M)=>{var q,H;if(x){const O=x?.methods.find(R=>M===R.name);if(O)return O.rtype==="promise"?R=>a.nativePromise(u,M.toString(),R):(R,W)=>a.nativeCallback(u,M.toString(),R,W);if(T)return(q=T[M])===null||q===void 0?void 0:q.bind(T)}else{if(T)return(H=T[M])===null||H===void 0?void 0:H.bind(T);throw new aa(`"${u}" plugin is not implemented on ${b}`,Ve.Unimplemented)}},E=T=>{let M;const q=(...H)=>{const O=S().then(R=>{const W=k(R,T);if(W){const Le=W(...H);return M=Le?.remove,Le}else throw new aa(`"${u}.${T}()" is not implemented on ${b}`,Ve.Unimplemented)});return T==="addListener"&&(O.remove=async()=>M()),O};return q.toString=()=>`${T.toString()}() { [capacitor code] }`,Object.defineProperty(q,"name",{value:T,writable:!1,configurable:!1}),q},D=E("addListener"),L=E("removeListener"),A=(T,M)=>{const q=D({eventName:T},M),H=async()=>{const R=await q;L({eventName:T,callbackId:R},M)},O=new Promise(R=>q.then(()=>R({remove:H})));return O.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await H()},O},N=new Proxy({},{get(T,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return x?A:D;case"removeListener":return L;default:return E(M)}}});return r[u]=N,d.set(u,{name:u,proxy:N,platforms:new Set([...Object.keys(m),...x?[b]:[]])}),N};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=o,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=i,a.registerPlugin=c,a.Exception=aa,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},$r=e=>e.Capacitor=Sr(e),le=$r(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),_t=le.registerPlugin;class zo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let r=!1;this.listeners[t]||(this.listeners[t]=[],r=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),r&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,r){const o=this.listeners[t];if(!o){if(r){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}o.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:r=>{this.notifyListeners(a,r)}}}unimplemented(t="not implemented"){return new le.Exception(t,Ve.Unimplemented)}unavailable(t="not available"){return new le.Exception(t,Ve.Unavailable)}async removeListener(t,a){const r=this.listeners[t];if(!r)return;const o=r.indexOf(a);this.listeners[t].splice(o,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(r=>{this.notifyListeners(t,r)}))}}const Ja=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ga=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Er extends zo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(r=>{if(r.length<=0)return;let[o,s]=r.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");o=Ga(o).trim(),s=Ga(s).trim(),a[o]=s}),a}async setCookie(t){try{const a=Ja(t.key),r=Ja(t.value),o=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${r||""}${o}; path=${s}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}_t("CapacitorCookies",{web:()=>new Er});const Ir=async e=>new Promise((t,a)=>{const r=new FileReader;r.onload=()=>{const o=r.result;t(o.indexOf(",")>=0?o.split(",")[1]:o)},r.onerror=o=>a(o),r.readAsDataURL(e)}),Lr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(o=>o.toLocaleLowerCase()).reduce((o,s,i)=>(o[s]=e[t[i]],o),{})},Cr=(e,t=!0)=>e?Object.entries(e).reduce((r,o)=>{const[s,i]=o;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=t?encodeURIComponent(d):d,l+=`${s}=${n}&`}),l.slice(0,-1)):(n=t?encodeURIComponent(i):i,l=`${s}=${n}`),`${r}&${l}`},"").substr(1):null,Tr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),o=Lr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(o.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[i,n]of Object.entries(e.data||{}))s.set(i,n);a.body=s.toString()}else if(o.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((n,l)=>{s.append(l,n)});else for(const n of Object.keys(e.data))s.append(n,e.data[n]);a.body=s;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(o.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Dr extends zo{async request(t){const a=Tr(t,t.webFetchExtra),r=Cr(t.params,t.shouldEncodeUrlParams),o=r?`${t.url}?${r}`:t.url,s=await fetch(o,a),i=s.headers.get("content-type")||"";let{responseType:n="text"}=s.ok?t:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await s.blob(),l=await Ir(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const c={};return s.headers.forEach((u,m)=>{c[m]=u}),{data:l,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}_t("CapacitorHttp",{web:()=>new Dr});const X=_t("PushNotifications",{}),Br="modulepreload",Pr=function(e){return"/"+e},Ya={},Mr=function(t,a,r){let o=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");o=l(a.map(d=>{if(d=Pr(d),d in Ya)return;Ya[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":Br,c||(m.as="script"),m.crossOrigin="",m.href=d,n&&m.setAttribute("nonce",n),document.head.appendChild(m),c)return new Promise((v,b)=>{m.addEventListener("load",v),m.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return o.then(i=>{for(const n of i||[])n.status==="rejected"&&s(n.reason);return t().catch(s)})},Qa=_t("App",{web:()=>Mr(()=>import("./web-DF2lqDjg.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Ar="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Xa=!1;async function qr(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await X.removeAllListeners(),await X.addListener("registration",async a=>{Uo(a.value,!0)}),await X.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await X.addListener("pushNotificationActionPerformed",a=>{const r=a.notification.data;console.log("Notificação clicada (Ação):",r)});let t=await X.checkPermissions();t.receive==="prompt"&&(t=await X.requestPermissions()),t.receive==="granted"&&await X.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Vo()}async function Rr(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Vo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Vo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Zs(_a,{vapidKey:Ar,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Uo(t,!1)):console.warn("[Push Web] Token veio vazio."),Xa||(Ks(_a,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Xa=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Uo(e,t){const a=oe.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const r=gt(pe,"users",a.uid);try{const o=await Ro(r);if(o.exists()){const i=o.data().fcmTokens||[];if(i.length===1&&i[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Ia(r,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(o){if(o.code==="not-found")try{await Ws(r,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(s){console.error("Erro ao criar user:",s)}else console.error("Erro ao atualizar token:",o)}}const jr=(e,t,a="all",r="all")=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("professionalId",a),r&&r!=="all"&&o.append("costCenterId",r),I(`/api/reports/indicators?${o.toString()}`)},Nr=e=>e?I(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Fr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:r})=>{const o=new URLSearchParams({startDate:t,endDate:a});return r&&r!=="all"&&o.append("cashierSessionId",r),e&&o.append("establishmentId",e),I(`/api/reports/sales?${o.toString()}`)},Hr=()=>I("/api/reports/summary",{method:"GET"}),Or=e=>I("/api/sales",{method:"POST",body:JSON.stringify(e)}),zr=e=>I(`/api/sales/${e}`,{method:"DELETE"}),Ca=e=>e?String(e).replace(/\D/g,""):"",Ta=(e,t="",a=20,r={})=>{const o=new URLSearchParams;return t&&o.append("search",t),a&&o.append("limit",a),r&&r.hasLoyalty&&o.append("hasLoyalty","true"),r&&r.birthMonth&&o.append("birthMonth",r.birthMonth),r&&r.inactiveDays&&o.append("inactiveDays",r.inactiveDays),I(`/api/clients/${e}?${o.toString()}`)},_o=(e,t)=>{const a=encodeURIComponent(t);return I(`/api/clients/details/${e}/${a}`)},Wo=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Ca(t),r={...e,phone:a,id:a};return I(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(r)})},Jo=Wo,Go=(e,t)=>Wo({...t,id:e}),Vr=e=>{const t=encodeURIComponent(e);return I(`/api/clients/${t}`,{method:"DELETE"})},Ur=(e,t,a,r)=>I("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ca(t),points:a,rewardName:r})}),_r=(e,t)=>_o(e,Ca(t));function f(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Yo(e,t=800,a=800,r=.7){return new Promise((o,s)=>{if(!e.type.match(/image.*/))return s(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(e),i.onload=n=>{const l=new Image;l.src=n.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const v=u.toDataURL("image/jpeg",r);o(v)},l.onerror=d=>s(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>s(new Error("Erro ao ler o ficheiro."))})}let oa=null;async function Wr(){const e=document.getElementById("content");e.innerHTML=`
    ...
    `;try{const t=new Date,a=new Date(t.setHours(0,0,0,0)).toISOString(),r=new Date(t.setHours(23,59,59,999)).toISOString(),o={receitaHoje:850.5,agendamentosHoje:12,receitaMes:15420,ticketMedio:70.87},s={labels:["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],data:[450,600,300,850,1200,1500,200]};Jr(e,o,s,[{client:"Ana Silva",service:"Corte Feminino",time:"14:30",prof:"João",status:"pending"},{client:"Carlos Santos",service:"Barba e Cabelo",time:"15:00",prof:"Miguel",status:"confirmed"},{client:"Beatriz Costa",service:"Manicure",time:"15:45",prof:"Sara",status:"pending"}],[{name:"Maria Fernandes",age:34,phone:"912345678"}]),Gr(s),Yr()}catch(t){console.error("Erro ao carregar dashboard:",t),e.innerHTML=`
        ...
        `}}function Jr(e,t,a,r,o){const s=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"});e.innerHTML=`
        <div class="p-4 md:p-6 max-w-7xl mx-auto space-y-6 pb-24 font-sans animate-fade-in">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-center hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-2xl font-black text-slate-800">${s.format(t.receitaHoje)}</h3>
                </div>
                ...
                <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-center hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-2xl font-black text-slate-800">${t.agendamentosHoje}</h3>
                </div>
                ...
                <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-center hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-2xl font-black text-slate-800">${s.format(t.receitaMes)}</h3>
                </div>
                ...
                <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-center hover:shadow-md transition-shadow">
                    ...
                    <h3 class="text-2xl font-black text-slate-800">${s.format(t.ticketMedio)}</h3>
                </div>
                                ...
                                <div class="flex items-center justify-between p-3 md:p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-md transition-all cursor-pointer">
                                    <div class="flex items-center gap-4">
                                        <div class="w-12 h-12 rounded-full bg-white border border-slate-200 flex flex-col items-center justify-center flex-shrink-0 text-indigo-600 font-black shadow-sm">
                                            ${i.time.split(":")[0]}<span class="text-[9px] leading-none">${i.time.split(":")[1]}</span>
                                        </div>
                                        <div>
                                            <p class="font-bold text-slate-800 text-sm">${f(i.client)}</p>
                                            <p class="text-xs text-slate-500 font-medium mt-0.5">${f(i.service)} · <i class="bi bi-person-badge"></i> ${f(i.prof)}</p>
                                        </div>
                                    </div>
                            ...
                            ${o.length>0?o.map(i=>`
                                <div class="flex items-center justify-between p-3 rounded-xl border border-rose-100 bg-rose-50/50">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-bold text-slate-800 text-sm">${f(i.name)}</p>
                                            <p class="text-[11px] font-bold text-rose-500 uppercase tracking-wide">${i.age} anos</p>
                                        </div>
                                    </div>
    ...
    `}function Gr(e){const t=document.getElementById("revenueChart");if(!t)return;oa&&oa.destroy();const r=t.getContext("2d").createLinearGradient(0,0,0,300);r.addColorStop(0,"rgba(79, 70, 229, 0.2)"),r.addColorStop(1,"rgba(79, 70, 229, 0)"),oa=new Chart(t,{type:"line",data:{labels:e.labels,datasets:[{label:"Receita Diária (R$)",data:e.data,borderColor:"#4f46e5",backgroundColor:r,borderWidth:3,pointBackgroundColor:"#ffffff",pointBorderColor:"#4f46e5",pointBorderWidth:2,pointRadius:4,pointHoverRadius:6,fill:!0,tension:.4}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,titleFont:{size:13,family:"Inter"},bodyFont:{size:14,weight:"bold",family:"Inter"},callbacks:{label:function(o){let s=o.dataset.label||"";return s&&(s+=": "),o.parsed.y!==null&&(s+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(o.parsed.y)),s}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f1f5f9",drawBorder:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11},callback:function(o){return"R$ "+o}}},x:{grid:{display:!1,drawBorder:!1},ticks:{color:"#64748b",font:{family:"Inter",size:12,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function Yr(){document.getElementById("content").addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":_("agenda-section");break;case"new-appointment":_("agenda-section");break;case"goto-pdv":_("comandas-section");break;case"goto-clients":_("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${p.establishmentId||""}`;window.open(o,"_blank");break}})}const Ie=e=>I(`/api/services/${e}`),Qr=e=>I("/api/services",{method:"POST",body:JSON.stringify(e)}),Xr=(e,t)=>I(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Zr=e=>I(`/api/services/${e}`,{method:"DELETE"}),Kr=(e,t)=>I(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),ei=e=>I(`/api/services/stats/most-popular/${e}`),re=e=>I(`/api/professionals/${e}`),ti=e=>I(`/api/professionals/details/${e}`),ai=e=>I("/api/professionals",{method:"POST",body:JSON.stringify(e)}),oi=(e,t)=>I(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Qo=e=>I(`/api/professionals/${e}`,{method:"DELETE"}),si=e=>{const t=e.map(a=>Qo(a));return Promise.all(t)},Wt=(e,t,a,r="all")=>{const o=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${r}`;return I(o)},Jt=e=>I("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Da=e=>I(`/api/blockages/${e}`,{method:"DELETE"}),Xo=e=>I("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Za=document.getElementById("content");let Ka=!1;const ga=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Gt=[],ba=[],Pt={},Zo=[],C={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},P={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Ba(e){const t=new Date(e),a=t.getDay(),r=t.getDate()-a+(a===0?-6:1);return t.setDate(r),t.setHours(0,0,0,0),t}function Pa(){const e=document.getElementById("profSelectorContainer");if(!e||!p.professionals)return;let t=p.professionals.filter(o=>C.showInactiveProfs||o.status!=="inactive");const r=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=r.map(o=>{const s=C.selectedProfessionalId===o.id,i=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),n=o.id!=="all"?p.professionalColors.get(o.id)||ga[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            <div class="prof-pill ${s?"active":""}"
                ...
                <span>${z(o.name==="Todos"?"Todos":o.name.split(" ")[0])}</span>
            </div>`}).join("")}function z(e){return f(e||"")}function ri(e,t,a,r,o){const s=(e||"").replace(/\D/g,""),i=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com ${r} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${s}?text=${encodeURIComponent(l)}`}function ii(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],r=Ba(C.currentDate),o=new Date;o.setHours(0,0,0,0);let s='<div class="week-container" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(r);n.setDate(r.getDate()+i);const l=n.toDateString()===o.toDateString(),d=e.filter(u=>new Date(u.startTime).toDateString()===n.toDateString()).sort((u,m)=>new Date(u.startTime)-new Date(m.startTime));let c="";d.length===0?c='<div class="week-empty"><i class="bi bi-dash-lg" style="font-size:1rem;display:block;margin-bottom:4px;"></i>Sem agendamentos</div>':c=d.map(u=>{const v=new Date(u.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),b=p.professionalColors.get(u.professionalId)||{main:"#adb5bd"},x=u.status==="completed",h=C.selectedItems.has(u.id);if(u.type==="blockage")return`<div class="week-event-chip week-blockage">
                    ...
                    </div>`;const S=JSON.stringify(u).replace(/'/g,"&apos;"),k=h?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"",E=C.isSelectionMode?`<div style="position:absolute; top:6px; right:6px; z-index:1;">
                           <input type="checkbox" style="width:16px; height:16px; accent-color:#4f46e5; pointer-events:none;" ${h?"checked":""}>
                       </div>`:"";return`<div class="week-event-chip ${x?"completed":""}" style="--ec: ${b.main}; ${k}"
                    data-action="edit-appointment" data-appointment='${S}'>
                    ${E}
                    <div class="we-time">${v}</div>
                    <div class="we-client" style="${C.isSelectionMode?"padding-right:20px;":""}">${z(u.clientName)}</div>
            ...
            <div class="list-date-label">${o}</div>`,s.forEach(i=>{const n=new Date(i.startTime),l=new Date(i.endTime),d=Math.round((l-n)/6e4),c=n.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=p.professionalColors.get(i.professionalId)||{main:"#adb5bd"},m=i.status==="completed",v=JSON.stringify(i).replace(/'/g,"&apos;"),b=C.selectedItems.has(i.id),x=C.isSelectionMode?`<div style="display:flex; align-items:center; margin-right: 12px; margin-left: 4px;">
                       <input type="checkbox" style="width:20px; height:20px; accent-color:#4f46e5; pointer-events:none;" ${b?"checked":""}>
                   </div>`:"",h=b?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"";if(i.type==="blockage"){r+=`<div class="list-card blockage">
                    ${x}
                ...
                </div>`;return}const S=ri(i.clientPhone,i.clientName,i.serviceName,i.professionalName,i.startTime),k=(i.services||[]).reduce((A,N)=>A+(Number(N.price)||0),0)||Number(i.totalPrice||0)||Number(i.servicePrice||0),E=i.paymentStatus||(i.status==="completed"?"Finalizado":"Agendado"),D=z((i.professionalName||"").split(" ")[0]),L=(i.services||[]).length||(i.serviceName?1:0);r+=`<div class="list-card ${m?"completed":""}" style="${h}"
                ...
                <div class="list-card-info">
                    ...
                    <div class="lc-detail">${z(i.serviceName)} · ${D}</div>
            ...
            </div>`}),r+="</div>"}),r+="</div>",t.innerHTML=r}function Ko(){const e=p.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?ni(e):ii(e),Ma()}function Ma(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(C.isSelectionMode&&C.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
            <span class="font-semibold text-sm"><span style="color:#7c3aed; font-size:1.1rem; margin-right:4px;">${C.selectedItems.size}</span> selecionados</span>
        ...
        </div>`,e.style.display="block",t&&(t.style.transform="scale(0)")):(e.style.display="none",t&&(t.style.transform="scale(1)")))}function li(){const e=document.getElementById("currentDateDisplay");if(!e)return;const t=new Date;t.setHours(0,0,0,0);const a=new Date(C.currentDate);if(a.setHours(0,0,0,0),C.currentView==="list")a.toDateString()===t.toDateString()?e.textContent="Hoje":e.textContent=a.toLocaleDateString("pt-BR",{day:"numeric",month:"long"});else{const r=Ba(a),o=new Date(r);o.setDate(r.getDate()+6);const s=r.toLocaleDateString("pt-BR",{day:"numeric",month:"short"}),i=o.toLocaleDateString("pt-BR",{day:"numeric",month:"short"});e.textContent=`${s} - ${i}`}}async function fe(){const e=document.getElementById("agenda-view");if(!e)return;C.selectedItems.clear(),Ma(),e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;padding:60px 0;"><div style="width:28px;height:28px;border:2.5px solid #e9ecef;border-top:2.5px solid #4f46e5;border-radius:50%;animation:spin 0.7s linear infinite;"></div></div><style>@keyframes spin{to{transform:rotate(360deg)}}</style>',li();let t,a;if(C.currentView==="list")t=new Date(C.currentDate),t.setHours(0,0,0,0),a=new Date(t),a.setHours(23,59,59,999);else{const r=Ba(C.currentDate);t=new Date(r),a=new Date(r),a.setDate(r.getDate()+6),a.setHours(23,59,59,999)}try{const[r,o]=await Promise.all([Oo(p.establishmentId,t.toISOString(),a.toISOString(),C.selectedProfessionalId==="all"?null:C.selectedProfessionalId),Wt(p.establishmentId,t.toISOString(),a.toISOString(),C.selectedProfessionalId)]);if(!document.getElementById("agenda-view"))return;const s=i=>i.map(n=>({...n,type:n.type||"appointment",professionalName:n.professionalName||(()=>{const l=p.professionals?.find(d=>d.id===n.professionalId);return l?l.name:"Indefinido"})()}));p.allEvents=[...s(r||[]),...s(o||[])],Pa(),Ko()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12" style="color:#868e96;">
                    <i class="bi bi-exclamation-triangle" style="font-size:1.5rem;"></i>
                    <p class="mt-2" style="font-size:0.8rem;">Erro ao carregar agenda.</p>
                </div>`)}}async function di(){try{const[e,t,a]=await Promise.all([re(p.establishmentId),Ie(p.establishmentId),Se(p.establishmentId)]);p.professionals=e||[],p.services=t||[],Zo=[],a&&(Pt=a.loyaltyProgram||{enabled:!1}),p.professionals.forEach((r,o)=>{p.professionalColors.set(r.id,ga[o%ga.length])}),Pa()}catch{g("Atenção","Não foi possível carregar os dados da equipa.","error")}}async function es(e={}){C.currentDate=e.targetDate?new Date(e.targetDate):C.currentDate||new Date,C.isSelectionMode=!1,C.selectedItems.clear(),Za.innerHTML=`
            ...
            <div style="background: #fff; padding: 14px 16px; border-bottom: 1px solid #f1f3f5; position: sticky; top: 0; z-index: 30; display:flex; flex-direction:column; gap:16px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div class="agenda-view-toggle" style="background: #f1f3f5; padding: 4px; border-radius: 12px; display:flex; gap:4px; margin:0;">
                        <button class="${C.currentView==="list"?"active shadow-sm":""}" data-action="setView" data-view="list" style="border-radius: 8px; padding: 6px 16px; font-weight:600;">Lista</button>
                        <button class="${C.currentView==="week"?"active shadow-sm":""}" data-action="setView" data-view="week" style="border-radius: 8px; padding: 6px 16px; font-weight:600;">Semana</button>
                    </div>
        ...
        </div>`,document.getElementById("btnPrevDate").addEventListener("click",()=>{C.currentView==="list"?C.currentDate.setDate(C.currentDate.getDate()-1):C.currentDate.setDate(C.currentDate.getDate()-7),fe()}),document.getElementById("btnNextDate").addEventListener("click",()=>{C.currentView==="list"?C.currentDate.setDate(C.currentDate.getDate()+1):C.currentDate.setDate(C.currentDate.getDate()+7),fe()}),document.getElementById("btnTodayHeader").addEventListener("click",()=>{C.currentDate=new Date,fe()});const t=document.querySelectorAll(".agenda-view-toggle button");t.forEach(a=>{a.addEventListener("click",()=>{t.forEach(r=>{r.classList.remove("active","shadow-sm"),r.style.backgroundColor="transparent"}),a.classList.add("active","shadow-sm"),a.style.backgroundColor="#fff",C.currentView=a.dataset.view,fe()})}),document.getElementById("btnWeekDays").addEventListener("click",()=>{ci()}),Ka||(Za.addEventListener("click",async a=>{const r=a.target.closest('[data-action="open-comanda"]');if(r){a.stopPropagation();const l=r.dataset.appointment||r.closest("[data-appointment]")?.dataset.appointment;if(!l)return;const d=JSON.parse(l.replace(/&apos;/g,"'")),c=d.status==="completed"?"finalizadas":"em-atendimento",u={selectedAppointmentId:d.id,initialFilter:c};c==="finalizadas"&&d.transaction?.paidAt&&(u.filterDate=typeof d.transaction.paidAt=="object"?new Date(d.transaction.paidAt._seconds*1e3):d.transaction.paidAt),_("comandas-section",u);return}const o=a.target.closest(".lc-action-btn.wa");if(o){a.stopPropagation(),o.dataset.link&&window.open(o.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const l=C.selectedItems.size;await U("Excluir Selecionados",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)&&(await Promise.all(Array.from(C.selectedItems).map(async c=>{try{await rr(c)}catch{}})),g(`${l} agendamento(s) excluído(s).`,"success"),C.selectedItems.clear(),C.isSelectionMode=!1,fe());return}const s=a.target.closest('[data-action="select-professional"]');if(s){const l=s.dataset.profId;C.selectedProfessionalId=C.selectedProfessionalId===l&&l!=="all"?"all":l,fe();return}const i=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(i){if(C.isSelectionMode){a.stopPropagation();const d=i.querySelector('input[type="checkbox"]');if(d){const c=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'")),u=!d.checked;d.checked=u,u?C.selectedItems.add(c.id):C.selectedItems.delete(c.id),(i.classList.contains("week-event-chip")||i.classList.contains("list-card"))&&(u?(i.style.boxShadow="0 0 0 2px #4f46e5",i.style.backgroundColor="#eff6ff"):(i.style.boxShadow="none",i.style.backgroundColor=i.classList.contains("week-event-chip")?"#f8f9fa":"#fff")),Ma()}return}const l=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"));fa(l);return}if(a.target.closest('[data-action="new-appointment"]')){fa();return}}),Ka=!0),await di(),await fe()}function ci(){const e=document.getElementById("optionsSheet");if(e){e.remove();return}const t=document.createElement("div");t.id="optionsSheet",t.style.cssText="position:fixed;bottom:0;left:50%;right:auto;transform:translateX(-50%) translateY(100%);width:100%;max-width:440px;background:#fff;border-radius:24px 24px 0 0;z-index:10000;box-shadow:0 -8px 40px rgba(0,0,0,0.15);transition:transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);";const a=C.isSelectionMode?"#fee2e2":"#f0fdf4",r=C.isSelectionMode?"#ef4444":"#16a34a",o=C.isSelectionMode?"bi-x-circle":"bi-check2-square";t.innerHTML=`
        <div style="padding:20px 24px;">
            ...
            <div style="margin-bottom:20px;">
                ...
                <button id="optSelectMode" style="width:100%;padding:12px 16px;border:none;background:${a};border-radius:12px;font-size:0.9rem;font-weight:600;color:${r};cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:background 0.2s;">
                    <i class="bi ${o}"></i> ${C.isSelectionMode?"Desativar Modo de Exclusão":"Ativar Seleção para Excluir"}
                </button>
                <p style="font-size:0.75rem; color:#6b7280; text-align:center; margin-top:8px;">${C.isSelectionMode?"Toque num card para desmarcar.":"Permite selecionar vários agendamentos para apagar de uma vez."}</p>
            </div>
        ...
        </div>`}}function pi(){return{title:"Serviços",content:`
        <div class="p-5 space-y-5">
            <div class="flex items-center gap-3">
            ...
            <div id="apptServicesContainer" class="grid grid-cols-2 gap-3 max-h-56 overflow-y-auto">
                ${Gt.map(e=>`<div class="service-card p-3 bg-white rounded-xl border ${P.data.selectedServiceIds.includes(e.id)?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer" data-service-id="${e.id}">
        ...
        </div>`}}function mi(){return{title:"Profissional",content:`
        <div class="p-5 space-y-5">
            <div class="relative">
                <i class="bi bi-search absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
            ...
            <div id="apptProfessionalContainer" class="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-52 overflow-y-auto professional-step-cards">
                ${ba.map(e=>`<div class="professional-modal-card p-3 bg-white rounded-xl border ${P.data.professionalId===e.id?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer text-center" data-professional-id="${e.id}">
        ...
        </div>`}}function gi(){const e=P.data.date||new Date().toISOString().split("T")[0];return{title:"Data e Horário",content:`
        <div class="p-5 space-y-5">
        ...
        </div>`}}async function fa(e=null,t=!1){const a=document.getElementById("appointmentModal");t||(P={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(o=>o.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],time:e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}),Gt=p.services||[],ba=(p.professionals||[]).filter(o=>o.status==="active");let r;switch(P.step){case 1:r=ui(e);break;case 2:r=pi();break;case 3:r=mi();break;case 4:r=gi();break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>o.addEventListener("click",()=>{const s=parseInt(o.dataset.currentStep,10);if(s===1&&(P.data.clientName=a.querySelector("#apptClientName").value.trim(),P.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!P.data.clientName))return g("Preencha o nome do cliente.","warning");if(s===2&&P.data.selectedServiceIds.length===0)return g("Selecione um serviço.","warning");if(s===3&&!P.data.professionalId)return g("Escolha um profissional.","warning");eo(s+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>o.addEventListener("click",()=>eo(parseInt(o.dataset.currentStep,10)-1))),a.querySelector('[data-action="close-modal"]')?.addEventListener("click",()=>{a.style.display="none"}),P.step===4&&a.querySelector("#appointmentForm").addEventListener("submit",bi),a.style.display="flex",P.step===2&&a.querySelectorAll(".service-card").forEach(o=>o.addEventListener("click",()=>{const s=a.querySelector("#multiServiceToggle")?.checked,i=o.classList.contains("selected");s||(a.querySelectorAll(".service-card.selected").forEach(l=>l.classList.remove("selected","border-indigo-500","bg-indigo-50")),P.data.selectedServiceIds=[]);const n=o.dataset.serviceId;i?(o.classList.remove("selected","border-indigo-500","bg-indigo-50"),P.data.selectedServiceIds=P.data.selectedServiceIds.filter(l=>l!==n)):(o.classList.add("selected","border-indigo-500","bg-indigo-50"),P.data.selectedServiceIds.push(n))})),P.step===3&&a.querySelectorAll(".professional-modal-card").forEach(o=>o.addEventListener("click",()=>{a.querySelectorAll(".professional-modal-card.selected").forEach(i=>i.classList.remove("selected","border-indigo-500","bg-indigo-50")),o.classList.add("selected","border-indigo-500","bg-indigo-50"),P.data.professionalId=o.dataset.professionalId;const s=ba.find(i=>i.id===o.dataset.professionalId);P.data.professionalName=s?s.name:""})),P.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",o=>xi(o.target.value)),P.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",to),to(),fi())}async function bi(e){e.preventDefault();const a=e.target.querySelector('button[type="submit"]');if(!P.data.time||!P.data.selectedServiceIds.length||!P.data.professionalId)return g("Selecione horário, serviço e profissional.","warning");a.disabled=!0,a.innerHTML="Aguarde...";const r=P.data.selectedServiceIds.map(l=>{const d=Gt.find(c=>c.id===l);return{id:d.id,name:d.name,price:d.price,duration:d.duration,bufferTime:d.bufferTime||0,photo:d.photo||null}}),[o,s]=P.data.time.split(":"),i=new Date(`${P.data.date}T${o}:${s}:00`),n={establishmentId:p.establishmentId,clientName:P.data.clientName,clientPhone:P.data.clientPhone,services:r,professionalId:P.data.professionalId,professionalName:P.data.professionalName,startTime:i.toISOString(),redeemedReward:P.data.redeemedReward};P.data.id&&(n.id=P.data.id);try{P.data.id?await sr(P.data.id,n):await or(n),g("Agendamento registrado!","success"),document.getElementById("appointmentModal").style.display="none",fe()}catch(l){g(l.message,"error"),a.disabled=!1,a.textContent="Agendar"}}async function to(){const e=document.getElementById("availableTimesContainer"),t=document.getElementById("apptTotalDuration");if(!e)return;const a=P.data.selectedServiceIds.reduce((i,n)=>{const l=Gt.find(d=>d.id===n);return i+(l?l.duration+(l.bufferTime||0):0)},0);t&&(t.textContent=`${a} min`);const{professionalId:r,selectedServiceIds:o,date:s}=P.data;if(!r||!o.length||!s){e.innerHTML='<p class="col-span-full text-center text-xs text-gray-400">Selecione serviço e profissional</p>';return}try{let i=await ar({establishmentId:p.establishmentId,professionalId:r,serviceIds:o,date:s});const n=new Date;if(new Date(s+"T00:00:00").toDateString()===n.toDateString()){const l=n.getHours()*60+n.getMinutes();i=i.filter(d=>{const[c,u]=d.split(":").map(Number);return c*60+u>=l})}e.innerHTML=i.length>0?i.map(l=>`<button type="button" class="p-2 text-sm font-semibold rounded-lg border ${P.data.time===l?"bg-indigo-600 text-white border-indigo-600":"bg-gray-50 text-gray-700 border-gray-200 hover:bg-indigo-50"}" onclick="document.querySelectorAll('#availableTimesContainer button').forEach(b=>{b.classList.remove('bg-indigo-600','text-white','border-indigo-600');b.classList.add('bg-gray-50','text-gray-700','border-gray-200')});this.classList.add('bg-indigo-600','text-white','border-indigo-600');this.classList.remove('bg-gray-50','text-gray-700','border-gray-200');window._selectedTime='${l}';">${l}</button>`).join(""):'<p class="col-span-full text-center text-xs text-gray-400">Sem horários</p>'}catch{e.innerHTML='<p class="col-span-full text-center text-xs text-red-400">Erro</p>'}}function fi(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a}=P.data,{enabled:r,rewards:o}=Pt;if(!r||!t||!o?.length){e.innerHTML="";return}const s=o.filter(i=>a>=i.points);if(!s.length){e.innerHTML='<p class="text-xs text-gray-400">Sem recompensas disponíveis.</p>';return}e.innerHTML=`<div class="border-t border-gray-100 pt-4">
        <p class="text-xs font-semibold text-gray-500 mb-2">Resgate fidelidade (${a} pts)</p>
        ${s.map(i=>`<label class="flex items-center gap-3 p-2 bg-gray-50 rounded-lg mb-1 cursor-pointer"><input type="radio" name="loyaltyReward" value="${z(i.reward)}" data-points="${i.points}" class="accent-indigo-600"><span class="text-sm">${z(i.reward)} (-${i.points} pts)</span></label>`).join("")}
    </div>`,e.querySelectorAll('input[name="loyaltyReward"]').forEach(i=>{i.addEventListener("change",n=>{n.target.checked&&(P.data.redeemedReward={reward:n.target.value,points:parseInt(n.target.dataset.points,10)})})})}async function xi(e){const t=document.getElementById("clientSearchResults");if(!t||e.trim().length<3){t&&(t.innerHTML='<p class="text-xs text-gray-400">Digite pelo menos 3 caracteres...</p>');return}t.innerHTML='<div class="text-center py-3"><div class="w-5 h-5 border-2 border-indigo-200 border-t-indigo-600 rounded-full animate-spin mx-auto"></div></div>';try{const a=await Ta(p.establishmentId,e.trim());if(Zo=a,!a.length){t.innerHTML='<p class="text-xs text-gray-400">Nenhum cliente encontrado.</p>';return}t.innerHTML=a.map(r=>`<div class="client-card p-2.5 bg-white rounded-lg border ${P.data.clientName===r.name&&P.data.clientPhone===r.phone?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer flex items-center gap-2" data-client-name="${z(r.name)}" data-client-phone="${z(r.phone)}" data-loyalty-points="${r.loyaltyPoints||0}">
                <div class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-500">${z(r.name).charAt(0)}</div>
                <div><p class="text-sm font-semibold text-gray-800">${z(r.name)}</p><p class="text-xs text-gray-500">${z(r.phone)}</p></div>
            </div>`).join(""),t.querySelectorAll(".client-card").forEach(r=>r.addEventListener("click",()=>{P.data.clientName=r.dataset.clientName,P.data.clientPhone=r.dataset.clientPhone,P.data.clientLoyaltyPoints=parseInt(r.dataset.loyaltyPoints||"0",10);const o=Math.min(...(Pt?.rewards||[]).map(s=>s.points));P.data.clientHasRewards=Pt.enabled&&o!==1/0&&P.data.clientLoyaltyPoints>=o,document.getElementById("apptClientName").value=r.dataset.clientName,document.getElementById("apptClientPhone").value=r.dataset.clientPhone,t.querySelectorAll(".client-card").forEach(s=>s.classList.remove("border-indigo-500","bg-indigo-50")),r.classList.add("border-indigo-500","bg-indigo-50")}))}catch{t.innerHTML='<p class="text-xs text-red-400">Erro ao buscar.</p>'}}const vi=(e,t=null,a=1,r=12)=>{let o=`/api/comandas/${e}?page=${a}&limit=${r}`;return t&&(o+=`&date=${t}`),I(o)},hi=(e,t)=>I(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),Yt=e=>I(`/api/products/${e}`),yi=e=>I("/api/products",{method:"POST",body:JSON.stringify(e)}),wi=(e,t)=>I(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),ki=e=>I(`/api/products/${e}`,{method:"DELETE"}),Si=(e,t)=>I(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),$i=({startDate:e,endDate:t,productId:a,categoryId:r,establishmentId:o})=>{const s=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&s.append("productId",a),r&&r!=="all"&&s.append("categoryId",r),o&&s.append("establishmentId",o),I(`/api/products/stock-history/report?${s.toString()}`)},Ei=()=>I("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),Ii=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),I("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Li=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),I(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},Ci=()=>I("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),Ti=e=>I(`/api/cashier/report/${e}`),Aa=e=>I(`/api/packages/${e}`),Di=e=>I("/api/packages",{method:"POST",body:JSON.stringify(e)}),Bi=(e,t)=>I(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),Pi=e=>I(`/api/packages/${e}`,{method:"DELETE"});let y={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"atendimento",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,pendingRedemption:null,paging:{page:1,limit:10,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1},Te=null,Pe=null,ao=null;function ts(e,t){return function(...a){clearTimeout(ao),ao=setTimeout(()=>e.apply(this,a),t)}}async function oo(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,ut(),t==="checkout"&&(y.viewMode="checkout",y.checkoutState.payments||(y.checkoutState.payments=[]),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.amountReceived="",y.checkoutState.discount.value||(y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason=""),G());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,Qt()}function Qt(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `,t&&(t.innerHTML="");return}const r={atendimento:"confirmed",finalizadas:"completed"}[y.activeFilter],o=y.allComandas.filter(i=>i.status===r);if(o.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',so(t);return}const s=document.createDocumentFragment();o.forEach(i=>{const n=$e(i);let l=0;i.status==="completed"&&i.totalAmount!==void 0&&i.totalAmount!==null?l=Number(i.totalAmount):l=n.reduce((k,E)=>k+Number(E.price||0),0);const c=i.loyaltyRedemption||i.discount&&i.discount.reason&&String(i.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-2" title="Prémio Resgatado">🎁</span>':"",u=i.id===y.selectedComandaId,m=new Date(i.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),v=i.type==="walk-in"||typeof i.id=="string"&&i.id.startsWith("temp-"),b=f(i.clientName||"Cliente sem nome"),x=f(i.professionalName||"Sem profissional"),h=v?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>',S=document.createElement("div");S.className=`comanda-card cursor-pointer ${u?"selected":""}`,S.dataset.action="select-comanda",S.dataset.comandaId=i.id,S.innerHTML=`
        ...
        `,s.appendChild(S)}),e.innerHTML="",e.appendChild(s),so(t)}function so(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:r}=y.paging,o=Math.ceil((a||0)/r);if(o===0)return;const s=document.createElement("div");s.className="flex gap-2 justify-center items-center w-full",s.innerHTML=`
    ...
    `,e.appendChild(s),s.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=o&&(y.paging.page=l,ue())}})}function G(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(x=>x.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){Ri(t,e);return}const a=`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const r=$e(t),o=t.status==="completed",s=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),i=r.reduce((x,h)=>{const S=h._source==="original_service",k=h.id||h.name,E=S?`original-${k}`:`${h.type}-${k}`;return x[E]||(x[E]={...h,quantity:0,sources:[]}),x[E].quantity+=1,h._source&&x[E].sources.push(h._source),x},{}),n=Object.values(i).reduce((x,h)=>x+Number(h.price||0)*h.quantity,0),l=f(t.clientName||"Cliente sem nome"),d=f(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,v=`
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(i).map(x=>{const h=x.sources&&x.sources.includes("original_service"),S=y.pendingRedemption&&String(y.pendingRedemption.appliedToItemId)===String(x.id),k=x.isReward||S;return`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm ${k?"border-yellow-300 bg-yellow-50 ring-1 ring-yellow-200":""}">
                        <div class="flex items-center gap-3 w-full">
                            <div class="flex-grow min-w-0">
                                ...
                                <p class="text-xs text-gray-500">${k?'<span class="text-yellow-700 font-bold bg-yellow-100 px-1 rounded">Prémio Fidelidade</span>':`R$ ${(x.price||0).toFixed(2)} un.`}</p>
                            </div>
        ...
        ${o?"":b}
    `,!o&&(t.clientId||t.clientName)&&ji(t,e.querySelector("#loyalty-container"))}function Ri(e,t){const r=$e(e).reduce((m,v)=>m+Number(v.price||0)*(v.quantity||1),0),o=y.checkoutState,s=o.discount||{type:"real",value:0};let i=0;s.type==="percent"?i=r*s.value/100:i=s.value,i>r&&(i=r);const n=r-i,l=o.payments.reduce((m,v)=>m+v.value,0),d=Math.max(0,n-l);(!o.amountReceived||d>0)&&(o.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;const u=()=>{const m=y.checkoutState.discount.type,v=y.checkoutState.discount.value;let b=m==="percent"?r*v/100:v;b>r&&(b=r);const x=r-b,h=y.checkoutState.payments.reduce((L,A)=>L+A.value,0),S=Math.max(0,x-h),k=t.querySelector("#checkout-total-display");k&&(k.textContent=`R$ ${x.toFixed(2)}`);const E=t.querySelector("#checkout-status-msg");E&&(S<=.01?E.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':E.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${S.toFixed(2)}</span></p>`);const D=t.querySelector("#checkout-amount");D&&S>0&&document.activeElement!==D&&(D.value=S.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",m=>{const v=parseFloat(m.target.value)||0;y.checkoutState.discount.value=v,u()}),t.querySelector("#discount-type")?.addEventListener("change",m=>{y.checkoutState.discount.type=m.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",m=>{y.checkoutState.discountReason=m.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",m=>{y.checkoutState.amountReceived=m.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",m=>{y.checkoutState.installments=parseInt(m.target.value,10)})}async function ji(e,t){if(!t)return;const a=y.loyaltySettings;if(!a||!a.enabled)return;let r=null;try{if(e.clientId)r=await _o(p.establishmentId,e.clientId);else if(e.clientName){const n=await Ta(p.establishmentId,e.clientName,1);n&&n.length>0&&(r=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!r||r.loyaltyPoints===void 0)return;const o=Number(r.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&o>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
            <div class="flex items-center gap-3">
    ...
    `,{modalElement:r,close:o}=se({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});r.addEventListener("click",s=>{const i=s.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=e.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(Fi(l,t),o())}})}async function Fi(e,t){const a=Number(e.costPoints||e.points||0),r=e.name||e.reward,o=e.type||"money";if(o==="money"){const l=parseFloat(e.discount)||0;if(l<=0){g("Erro","O valor do desconto configurado é inválido.","error");return}y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${r}`,y.pendingRedemption={rewardId:e.id||null,name:r,cost:a,type:"money"},g("Sucesso",`Prémio "${r}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),G();return}const s=$e(t),i=e.itemId?String(e.itemId):null;if(!i){g("Erro de Configuração",`O prémio "${r}" não tem um item vinculado nas configurações.`,"error");return}const n=s.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return o==="service"?d===i||c===i:o==="product"?d===i||u===i:o==="package"?d===i:!1});if(n){let l=parseFloat(e.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${r}`,y.pendingRedemption={rewardId:e.id||null,name:r,cost:a,type:o,appliedToItemId:n.id},g("Sucesso",`Prémio "${r}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),G()}else g("Item Não Encontrado",`Para resgatar o prémio "${r}", o ${o==="service"?"serviço":o==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function Hi(){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=se({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const o=e.querySelector("#add-item-content");o.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,n())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,n()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await os(o,s),t()}};e.addEventListener("click",o=>{const s=o.target.closest('[data-action="select-item-for-quantity"]'),i=o.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:n,itemId:l}=s.dataset,c=(y.catalog[n+"s"]||[]).find(u=>u.id===l);c&&r({...c,type:n})}else i&&a()}),a()}async function xa(e=null){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!p.professionals||p.professionals.length===0)try{p.professionals=await re(p.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,{modalElement:r}=se({title:"Nova Venda Avulsa",contentHTML:a,maxWidth:"max-w-md"}),o=r.querySelector("#client-search"),s=r.querySelector("#client-suggestions"),i=r.querySelector("#selected-client-id");e&&(i.value=e.id,o.value=`${e.name} (${e.phone||"Sem tel"})`,o.classList.add("bg-green-50","border-green-300","text-green-800")),o.addEventListener("input",ts(async l=>{const d=l.target.value.trim();if(i.value="",o.classList.remove("bg-green-50","border-green-300","text-green-800"),d.length<2){s.classList.add("hidden");return}try{s.innerHTML='<li class="p-2 text-xs text-gray-500">Buscando...</li>',s.classList.remove("hidden");const c=await Ta(p.establishmentId,d,10);c.length===0?s.innerHTML='<li class="p-2 text-xs text-gray-500">Nenhum cliente encontrado</li>':s.innerHTML=c.map(u=>`<li data-client-id="${u.id}" data-client-name="${u.name}" data-client-phone="${u.phone}" class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 transition-colors"><div class="font-bold text-sm text-gray-800">${f(u.name)}</div><div class="text-xs text-gray-500">${u.phone||"Sem telefone"}</div></li>`).join("")}catch{s.classList.add("hidden")}},400)),s.addEventListener("click",l=>{const d=l.target.closest("li[data-client-id]");d&&(i.value=d.dataset.clientId,i.dataset.name=d.dataset.clientName,i.dataset.phone=d.dataset.clientPhone,o.value=`${d.dataset.clientName}`,o.classList.add("bg-green-50","border-green-300","text-green-800"),s.classList.add("hidden"))}),document.addEventListener("click",l=>{!o.contains(l.target)&&!s.contains(l.target)&&s.classList.add("hidden")}),r.querySelector("#new-sale-form").addEventListener("submit",Ji);const n=r.querySelector('[data-action="new-client-from-sale"]');n&&n.addEventListener("click",l=>{l.preventDefault(),r.style.display="none",Oi()})}function Oi(){se({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",zi)}async function zi(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),o=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!o)return g("Erro","Nome e Telefone são obrigatórios.","error");try{const s=await _r(p.establishmentId,o);if(s)g("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",xa(s);else{const i=await Jo({establishmentId:p.establishmentId,name:a.value,phone:o});g("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",xa(i)}}catch(s){g("Erro",s.message,"error")}}async function Vi(){const e=`
    ...
    `,{modalElement:t}=se({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const r=parseFloat(document.getElementById("initial-amount").value);if(isNaN(r)||r<0)return g("Valor Inválido","Insira um valor válido.","error");try{const o=await Ii({establishmentId:p.establishmentId,initialAmount:parseFloat(r.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=o.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${r.toFixed(2)})`,"success"),Qt(),await ue()}catch(o){g("Erro",`Falha ao abrir caixa: ${o.message}`,"error")}})}async function Ui(){const e=y.activeCashierSessionId;if(e)try{const t=await Ti(e),a=`
        ...
        `,{modalElement:r}=se({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});r.querySelector("#close-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const s=parseFloat(document.getElementById("final-amount").value);if(isNaN(s)||s<0)return g("Valor Inválido","Insira um valor final válido.","error");try{await Li(e,s),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Qt(),await ue(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){g("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(t){g("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function _i(e){if(y.activeFilter===e)return;y.activeFilter=e,y.paging.page=1,document.querySelectorAll(".filter-btn").forEach(a=>a.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),Me(),y.selectedComandaId=null,y.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await ue(),G()}function as(e){y.selectedComandaId=e,y.viewMode="items",y.pendingRedemption=null,y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason="",ut(),Mi(),G()}async function os(e,t){const a=y.allComandas.find(s=>s.id===y.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),g("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const r=parseFloat(e.price)||0,o=Array(t).fill(0).map(()=>{const s={id:String(e.id),name:e.name,price:r,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(s.productId=s.id,s.product_id=s.id):e.type==="service"&&(s.serviceId=s.id,s.service_id=s.id),s});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...o),a._cachedItems=null,a._hasUnsavedChanges=!0,G()}async function ro(e,t){const a=y.allComandas.find(s=>s.id===y.selectedComandaId);if(!a)return;let r=!1,o=(a.comandaItems||[]).findIndex(s=>s.id==e&&s.type===t);o>-1&&(a.comandaItems.splice(o,1),r=!0),r&&(a._cachedItems=null,a._hasUnsavedChanges=!0,G())}async function Wi(e){if(y.isProcessing)return;const t=$e(e),a=t.reduce((h,S)=>h+Number(S.price||0)*(S.quantity||1),0),r=y.checkoutState.discount||{type:"real",value:0};let o=r.type==="percent"?a*r.value/100:r.value;o>a&&(o=a);const s=a-o,{payments:i}=y.checkoutState,n=i.reduce((h,S)=>h+S.value,0),l=s-n;if(l>.01){if(!await U("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}y.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const m=y.loyaltySettings;m&&m.enabled&&(u=parseInt(m.pointsPerVisit||1,10),console.log(`Fidelidade: Cliente ganhou ${u} pontos fixos pela visita.`));const v={...r,reason:y.checkoutState.discountReason||""},b={payments:i,totalAmount:Number(s),items:c,cashierSessionId:y.activeCashierSessionId,loyaltyPointsEarned:u,discount:v,loyaltyRedemption:y.pendingRedemption},x=document.createElement("div");x.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",x.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(x);try{d?await nr(e.id,b):(b.establishmentId=p.establishmentId,b.clientId=e.clientId,b.clientName=e.clientName,b.professionalId=e.professionalId,e.clientPhone&&(b.clientPhone=e.clientPhone),await Or(b));let h="Venda finalizada com sucesso!";u>0&&(h+=` Cliente ganhou ${u} pontos!`),g("Sucesso!",h,"success"),Me(),y.selectedComandaId=null,y.viewMode="items",y.pendingRedemption=null,await ue()}catch(h){g("Erro no Checkout",h.message,"error")}finally{document.body.contains(x)&&document.body.removeChild(x),y.isProcessing=!1}}async function Ji(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,r=t.value,o=document.getElementById("client-search").value,s=t.dataset.phone||"";if(!r)return g("Erro","Selecione um cliente válido.","error");const i=p.professionals.find(l=>l.id===a);if(!i)return g("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:r,clientName:o.split("(")[0].trim(),clientPhone:s,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(n),y.selectedComandaId=n.id,y.viewMode="items",document.getElementById("genericModal").style.display="none",as(n.id)}async function ue(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=y.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=Ei(),r=vi(p.establishmentId,t,y.paging.page,y.paging.limit),o=Se(p.establishmentId),[s,i,n]=await Promise.all([a,r,o]);if(y.isCashierOpen=!!s,y.activeCashierSessionId=s?s.id:null,Qt(),n&&n.loyaltyProgram&&(y.loyaltySettings=n.loyaltyProgram),!y.isCashierOpen&&y.activeFilter==="atendimento"){ut(),G();return}if(y.allComandas=i.data||i,y.paging.total=i.total||i.length,y.catalog.services.length===0){const[l,d,c,u]=await Promise.all([Ie(p.establishmentId),Yt(p.establishmentId),Aa(p.establishmentId),re(p.establishmentId)]);y.catalog={services:l,products:d,packages:c},p.professionals=u}ut(),G()}catch(a){g("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function Gi(e={}){Pe=document.getElementById("content"),y.selectedComandaId=e.selectedAppointmentId||null,y.viewMode="items",Ai(),Te&&(Pe.removeEventListener("click",Te),Pe.removeEventListener("change",Te)),Te=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&y.activeFilter==="finalizadas"){y.paging.page=1,await ue();return}if(a){if(a.matches("[data-filter]"))_i(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}as(a.dataset.comandaId)}else if(a.matches("[data-action]")){const o=a.dataset.action,s=a.dataset.id||y.selectedComandaId,i=y.allComandas.find(n=>n.id===s);switch(o){case"back-to-list":Me(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(k=>k.classList.remove("selected")),G();break;case"new-sale":xa();break;case"add-item":Hi();break;case"open-cashier":Vi();break;case"close-cashier":await Ui();break;case"view-sales-report":_("sales-report-section");break;case"go-to-checkout":await oo(i,"checkout");break;case"back-to-items":y.viewMode="items",G();break;case"save-comanda":await oo(i,"stay");break;case"select-method":y.checkoutState.selectedMethod=a.dataset.method,y.checkoutState.installments=1,G();break;case"add-payment-checkout":const n=document.getElementById("checkout-amount");let l=parseFloat(n.value);const c=$e(i).reduce((k,E)=>k+(E.price||0),0),u=y.checkoutState.discount||{type:"real",value:0};let m=u.type==="percent"?c*u.value/100:u.value;m>c&&(m=c);const v=c-m,b=y.checkoutState.payments.reduce((k,E)=>k+E.value,0),x=v-b;if(isNaN(l)||l<=0){g("Valor inválido","Insira um valor maior que zero.","error");break}if(l>x+.05){g("Valor inválido","Valor excede o restante.","error");break}const h={method:y.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(y.checkoutState.selectedMethod)&&y.checkoutState.installments>1&&(h.installments=y.checkoutState.installments),y.checkoutState.payments.push(h),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.installments=1,y.checkoutState.amountReceived="",G();break;case"remove-payment-checkout":const S=parseInt(a.dataset.index,10);y.checkoutState.payments.splice(S,1),G();break;case"finalize-checkout":await Wi(i);break;case"increase-qty":{const k=a.dataset.itemId,E=a.dataset.itemType;if(!k||k==="undefined"||k==="null"){g("Erro","Item inválido para adição.","error");return}let L=$e(i).find(N=>N.id==k&&N.type===E);L||(L=(y.catalog[E+"s"]||[]).find(T=>T.id==k));const A=L?{id:L.id,name:L.name,price:Number(L.price),type:L.type}:{id:k,name:"Item Indisponível",price:0,type:E};await os(A,1);break}case"decrease-qty":{await ro(a.dataset.itemId,a.dataset.itemType);break}case"remove-item":await ro(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await U("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await ir(s);const E=y.allComandas.findIndex(D=>D.id===s);E!==-1&&(y.allComandas[E].status="confirmed",delete y.allComandas[E].transaction),y.selectedComandaId=null,Me(),await ue(),g("Sucesso!","Comanda reaberta.","success")}catch(E){g("Erro",E.message,"error")}break}case"go-to-appointment":{const k=a.dataset.id,E=a.dataset.date;_("agenda-section",{scrollToAppointmentId:k,targetDate:new Date(E)});break}case"delete-walk-in":{if(await U("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(s.startsWith("temp-"))y.allComandas=y.allComandas.filter(E=>E.id!==s),y.selectedComandaId=null,ut(),G(),Me();else try{await zr(s),g("Sucesso","Venda excluída.","success"),y.selectedComandaId=null,Me(),await ue()}catch(E){g("Erro",E.message,"error")}break}}}}},Pe.addEventListener("click",Te),Pe.addEventListener("change",Te),e.initialFilter&&(y.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${y.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",y.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await ue()}const Xt=e=>I(`/api/financial/natures/${e}`),Yi=e=>I("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),Qi=e=>I(`/api/financial/natures/${e}`,{method:"DELETE"}),qa=e=>I(`/api/financial/cost-centers/${e}`),Xi=e=>I("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),Zi=e=>I(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),ss=(e,t)=>I(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),rs=(e,t={})=>{let a=`/api/financial/${e}`;const r=new URLSearchParams;t.establishmentId&&r.append("establishmentId",t.establishmentId),t.startDate&&r.append("startDate",t.startDate),t.endDate&&r.append("endDate",t.endDate),t.natureId&&r.append("natureId",t.natureId),t.costCenterId&&r.append("costCenterId",t.costCenterId),t.status&&r.append("status",t.status);const o=r.toString();return o&&(a+=`?${o}`),I(a)},is=(e,t,a)=>I(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),ns=(e,t)=>I(`/api/financial/${e}/${t}`,{method:"DELETE"}),ls=(e,t)=>{const a=t.map(r=>I(`/api/financial/${e}/${r}`,{method:"DELETE"}));return Promise.all(a)},ds=(e,t,a)=>I(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Ki=e=>ss("payables",e),cs=e=>rs("payables",e),en=(e,t)=>is("payables",e,t),tn=e=>ns("payables",e),an=(e,t)=>ds("payables",e,t),on=e=>ss("receivables",e),us=e=>rs("receivables",e),sn=(e,t)=>is("receivables",e,t),rn=e=>ns("receivables",e),nn=(e,t)=>ds("receivables",e,t),va=document.getElementById("content");let ee={};const vt={creditRealized:"#10b981",creditProvisioned:"#6ee7b7",debitRealized:"#ef4444",debitProvisioned:"#fca5a5"},ln=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],B={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],naturesList:[],rawPayables:[],rawReceivables:[],processedDRE:null,processedCashFlow:null,processedDailyRevenue:null,backendData:null,appointmentsData:[],currentTab:"dashboards",isFilterOpen:!1};async function dn(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function cn(){va.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await dn();const[e,t,a]=await Promise.all([re(p.establishmentId),Nr(p.establishmentId).catch(()=>[]),Xt(p.establishmentId).catch(()=>[])]);B.professionalsList=e||[],B.costCentersList=t||[],B.naturesList=a||[],un(),await ps()}catch(e){console.error("Erro no loadReportsPage:",e),va.innerHTML=`
            ...
            </div>`}}function un(){const e=B.professionalsList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join(""),t=B.costCentersList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join("");va.innerHTML=`
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex-1 min-w-0 mr-2">
                            ...
                            <p class="text-[10px] md:text-xs text-gray-500 mt-0.5 ml-1 truncate" id="date-range-display">
                                ${Mt(B.startDate)} até ${Mt(B.endDate)}
                            </p>
                        </div>
    ...
    `,document.getElementById("toggle-filters-btn").onclick=io,document.getElementById("btn-apply-filters").onclick=()=>{pn(),io()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{B.currentTab=a.dataset.tab,no(),ms(),window.scrollTo({top:0,behavior:"smooth"})}}),no()}function io(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");B.isFilterOpen=!B.isFilterOpen,B.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function no(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===B.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Mt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function pn(){B.startDate=document.getElementById("report-start").value,B.endDate=document.getElementById("report-end").value,B.selectedProfessional=document.getElementById("report-prof").value,B.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Mt(B.startDate)} até ${Mt(B.endDate)}`,await ps()}function mn(e,t){const a=new Map;B.naturesList.forEach(o=>a.set(o.id,o.name));const r={revenues:{},expenses:{},totalRevenues:0,totalExpenses:0,netResult:0};return t.forEach(o=>{if(o.status==="paid"){const s=o.naturezaId?a.get(o.naturezaId)||"Outras Receitas":"Geral";r.revenues[s]||(r.revenues[s]=0),r.revenues[s]+=o.amount,r.totalRevenues+=o.amount}}),e.forEach(o=>{if(o.status==="paid"){const s=o.naturezaId?a.get(o.naturezaId)||"Outras Despesas":"Geral";r.expenses[s]||(r.expenses[s]=0),r.expenses[s]+=o.amount,r.totalExpenses+=o.amount}}),r.netResult=r.totalRevenues-r.totalExpenses,r}function gn(e,t){const a={},r=d=>{a[d]||(a[d]={realizedCredit:0,provisionedCredit:0,realizedDebit:0,provisionedDebit:0})};let o=new Date(B.startDate);const s=new Date(B.endDate);for(;o<=s;)r(o.toISOString().split("T")[0]),o.setDate(o.getDate()+1);t.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedCredit+=d.amount:a[c].provisionedCredit+=d.amount)}),e.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedDebit+=d.amount:a[c].provisionedDebit+=d.amount)});const i=Object.keys(a).sort(),n=[];let l=0;return i.forEach(d=>{const c=a[d],u=c.realizedCredit+c.provisionedCredit-(c.realizedDebit+c.provisionedDebit);l+=u,n.push(l)}),{labels:i,realizedCredit:i.map(d=>a[d].realizedCredit),provisionedCredit:i.map(d=>a[d].provisionedCredit),realizedDebit:i.map(d=>a[d].realizedDebit*-1),provisionedDebit:i.map(d=>a[d].provisionedDebit*-1),balance:n}}function bn(e){const t={};let a=new Date(B.startDate);const r=new Date(B.endDate);for(;a<=r;)t[a.toISOString().split("T")[0]]=0,a.setDate(a.getDate()+1);e.forEach(i=>{if(i.status==="paid"){const n=i.dueDate.split("T")[0];t.hasOwnProperty(n)&&(t[n]+=i.amount)}});const o=Object.keys(t).sort(),s=o.map(i=>t[i]);return{labels:o,data:s}}function fn(e){const t=e.length;if(t<2)return{trendData:Array(t).fill(e[0]||0),color:"#9ca3af"};let a=0,r=0,o=0,s=0;for(let c=0;c<t;c++)a+=c,r+=e[c],o+=c*e[c],s+=c*c;const i=(t*o-a*r)/(t*s-a*a),n=(r-i*a)/t,l=[];for(let c=0;c<t;c++)l.push(i*c+n);const d=i>=0?"#10b981":"#ef4444";return{trendData:l,color:d}}async function ps(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20 w-full"><div class="loader border-t-indigo-600"></div></div>';try{const t={startDate:B.startDate,endDate:B.endDate,establishmentId:p.establishmentId};B.selectedCostCenter!=="all"&&(t.costCenterId=B.selectedCostCenter);const[a,r]=await Promise.all([cs(t),us(t)]);B.rawPayables=a.entries||[],B.rawReceivables=r.entries||[];const o=await jr(B.startDate,B.endDate,B.selectedProfessional,B.selectedCostCenter).catch(()=>({charts:{professionals:{labels:[],data:[]},salesMonthly:{labels:[],data:[]}}}));B.backendData=o,B.processedDRE=mn(B.rawPayables,B.rawReceivables),B.processedCashFlow=gn(B.rawPayables,B.rawReceivables),B.processedDailyRevenue=bn(B.rawReceivables);const s=new Date(B.startDate+"T00:00:00").toISOString(),i=new Date(B.endDate+"T23:59:59").toISOString(),n=B.selectedProfessional==="all"?null:B.selectedProfessional,l=await Oo(p.establishmentId,s,i,n).catch(()=>[]);B.appointmentsData=Array.isArray(l)?l:[],ms()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ms(){const e=document.getElementById("report-content");switch(B.currentTab){case"dashboards":xn(e);break;case"appointments":vn(e);break;case"dre":hn(e);break}}function xn(e){const t=B.processedDRE,a=B.processedDailyRevenue,r=B.backendData.charts?.salesMonthly||{labels:[],data:[]},o=B.backendData.charts?.professionals||{labels:[],data:[]};e.innerHTML=`
    ...
    `,yn("chart-cashflow-modern",B.processedCashFlow),lo("chart-daily-revenue","Receita Diária",a.labels.map(s=>s.split("-").reverse().slice(0,2).join("/")),a.data),lo("chart-monthly","Receita Mensal",r.labels,r.data),kn("chart-profs","doughnut","Total Vendas",o.labels,o.data,ln),document.querySelectorAll(".chart-toggle").forEach(s=>{s.addEventListener("change",i=>{const n=ee["chart-cashflow-modern"];if(n){const l=parseInt(i.target.dataset.dataset);n.setDatasetVisibility(l,i.target.checked),n.update()}})})}function vn(e){const t=B.appointmentsData,a=t.length;let r=0,o=0,s=0;const i={},n={};let l=new Date(B.startDate);const d=new Date(B.endDate);for(;l<=d;)i[l.toISOString().split("T")[0]]={active:0,cancelled:0},l.setDate(l.getDate()+1);t.forEach(b=>{const x=parseFloat(b.totalAmount||b.price||0),h=(b.status||"").toLowerCase();let S="";if(b.startTime){const E=b.startTime.toDate?b.startTime.toDate():new Date(b.startTime);isNaN(E)||(S=E.toISOString().split("T")[0])}const k=b.professionalName||"Sem Profissional";n[k]||(n[k]={name:k,count:0,value:0}),["cancelled","cancelado","no-show","cancelada"].includes(h)?(o++,S&&i[S]&&i[S].cancelled++):(["completed","finalized","paid"].includes(h)&&r++,s+=x,S&&i[S]&&i[S].active++,n[k].count++,n[k].value+=x)});const c=Object.keys(i).sort(),u=c.map(b=>i[b].active),m=c.map(b=>i[b].cancelled),v=Object.values(n).sort((b,x)=>x.value-b.value);e.innerHTML=`
            ...
            <div class="overflow-x-auto no-scrollbar w-full">
                <table class="w-full text-xs md:text-sm min-w-full">
                    <tbody class="divide-y divide-gray-100">
                        ${v.map((b,x)=>{const h=v[0]?.value||1,S=b.value/h*100;return`
                            <tr class="group">
                                ...
                                <td class="p-3 md:p-4 pl-0 min-w-[100px]">
                                    ...
                                    <div class="w-full h-1.5 bg-gray-100 rounded-full mt-2 overflow-hidden">
                                        <div class="h-full bg-indigo-500 rounded-full" style="width: ${S}%"></div>
                                    </div>
                                </td>
    ...
    `,wn("chart-appointments-daily",c,u,m),document.querySelectorAll(".app-chart-toggle").forEach(b=>{b.addEventListener("change",x=>{const h=ee["chart-appointments-daily"];if(h){const S=parseInt(x.target.dataset.dataset);h.setDatasetVisibility(S,x.target.checked),h.update()}})})}function hn(e){const t=B.processedDRE;if(!t)return;const a=t.totalRevenues,r=(n,l,d,c=!1)=>{const u=a>0?l/a*100:0,m=c?"- ":"";return`
    ...
    `}function yn(e,t){const a=document.getElementById(e);if(!a)return;const r=a.getContext("2d");ee[e]&&ee[e].destroy();const o=r.createLinearGradient(0,0,0,400);o.addColorStop(0,"rgba(59, 130, 246, 0.4)"),o.addColorStop(1,"rgba(59, 130, 246, 0.0)");const s=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));ee[e]=new Chart(r,{type:"bar",data:{labels:s,datasets:[{label:"Créd. Realizado",data:t.realizedCredit,backgroundColor:vt.creditRealized,borderRadius:3,barPercentage:.7,order:1},{label:"Créd. Provisionado",data:t.provisionedCredit,backgroundColor:vt.creditProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:2},{label:"Déb. Realizado",data:t.realizedDebit,backgroundColor:vt.debitRealized,borderRadius:3,barPercentage:.7,order:3},{label:"Déb. Provisionado",data:t.provisionedDebit,backgroundColor:vt.debitProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:4},{label:"Saldo Acumulado",data:t.balance,type:"line",borderColor:"#3b82f6",backgroundColor:o,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!0,tension:.4,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10,callbacks:{label:function(i){let n=i.dataset.label||"";return n&&(n+=": "),i.parsed.y!==null&&(n+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(Math.abs(i.parsed.y))),n}}}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{size:10}}},y:{stacked:!0,display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(Math.abs(i)),font:{size:10}}}}}})}function wn(e,t,a,r){const o=document.getElementById(e);if(!o)return;const s=o.getContext("2d");ee[e]&&ee[e].destroy();const i=t.map(n=>n.split("-").reverse().slice(0,2).join("/"));ee[e]=new Chart(s,{type:"bar",data:{labels:i,datasets:[{label:"Realizados",data:a,backgroundColor:"#4f46e5",borderRadius:3,barPercentage:.6,order:1},{label:"Cancelados",data:r,backgroundColor:"#ef4444",borderRadius:3,barPercentage:.6,order:2}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function lo(e,t,a,r){const o=document.getElementById(e);if(!o)return;const s=o.getContext("2d");ee[e]&&ee[e].destroy();const{trendData:i,color:n}=fn(r),l=i.map((u,m)=>m===i.length-1?"triangle":"circle"),d=i.map((u,m)=>m===i.length-1?6:3),c=i.map((u,m)=>m===i.length-1&&n==="#ef4444"?180:0);ee[e]=new Chart(s,{type:"bar",data:{labels:a,datasets:[{label:t,data:r,backgroundColor:"#4f46e5",borderRadius:4,order:1},{label:"Tendência",data:i,type:"line",borderColor:n,borderWidth:3,pointStyle:l,pointRadius:d,pointRotation:c,pointBackgroundColor:"#fff",pointBorderColor:n,pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!1,tension:0,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9},callback:u=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(u)}}}}})}function kn(e,t,a,r,o,s){const i=document.getElementById(e);if(!i)return;const n=i.getContext("2d");ee[e]&&ee[e].destroy(),new Chart(n,{type:t,data:{labels:r,datasets:[{label:a,data:o,backgroundColor:s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:{}}})}const Zt=(e,t="products")=>I(`/api/${t}/categories/${e}`),gs=(e,t="products")=>I(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),bs=(e,t="products")=>I(`/api/${t}/categories/${e}`,{method:"DELETE"}),Sn="audit_logs",de=async(e,t,a,r,o,s=null)=>{try{if(!t)return;await jo(Ut(pe,Sn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:r,description:o,details:s,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},ve=document.getElementById("content");let ge=null,at="services",we="all",ot=[];function Ue(){const e=oe.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function $n(e){e.preventDefault();const t=e.target.closest("#categoryForm"),a=t.querySelector("#categoryName"),r=a.value;if(!r)return;const o=t.querySelector('button[type="submit"]');o.disabled=!0,o.textContent="...";try{const s=ot.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);s.length===0&&s.push(p.establishmentId),await gs({establishmentId:p.establishmentId,name:r,accessibleIn:s},"services"),de(p.establishmentId,Ue(),"Categorias (Serviços)","Criou",`Criou categoria: ${r}`),a.value="",g("Sucesso","Categoria criada!","success"),await Ra(),await bt()}catch(s){g("Erro",`Não foi possível criar a categoria: ${s.message}`,"error")}finally{o.disabled=!1,o.textContent="Adicionar"}}async function En(e){if(await U("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await bs(e,"services"),de(p.establishmentId,Ue(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Ra(),await bt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ra(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Zt(p.establishmentId,"services");p.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function In(){se({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",$n),t.addEventListener("click",r=>{const o=r.target.closest('button[data-action="delete-category"]');o&&(r.preventDefault(),En(o.dataset.id))}))}Ra()}function Ln(e=[]){if(!ot||ot.length===0)return`
            ...
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return ot.forEach(a=>{const r=e.includes(a.id)||e.length===0&&a.id===p.establishmentId;t+=`
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[85vh] my-auto">
        <form id="serviceForm">
            ...
            <div class="mt-6 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-3">
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async D=>{const L=D.target.closest("button[data-action]");if(!L)return;const A=L.dataset.action,N=L.dataset.id;if(A==="close-modal"&&(t.style.display="none"),A==="delete-service"){if(!N)return;if(t.style.display="none",await U("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const M=p.services.find(q=>q.id===N)?.name||"Desconhecido";await Zr(N),de(p.establishmentId,Ue(),"Serviços","Excluiu",`Excluiu o serviço: ${M}`),g("Sucesso","Serviço apagado com sucesso!","success"),await bt()}catch(M){g("Erro",`Não foi possível apagar o serviço: ${M.message}`,"error")}else t.style.display="flex"}});const d=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");d.forEach(D=>{D.addEventListener("click",()=>{d.forEach(L=>{L.classList.remove("border-indigo-500","text-indigo-600"),L.classList.add("border-transparent","text-gray-500")}),D.classList.add("border-indigo-500","text-indigo-600"),D.classList.remove("border-transparent","text-gray-500"),c.forEach(L=>L.classList.add("hidden")),document.getElementById(`tab-content-${D.dataset.tab}`).classList.remove("hidden")})});const u=t.querySelectorAll('input[name="commissionType"]'),m=document.getElementById("defaultCommissionRateContainer"),v=document.getElementById("professionalCommissionsContainer");function b(){const D=t.querySelector('input[name="commissionType"]:checked').value;m&&(m.style.display=D==="default"?"block":"none"),v&&(v.style.display=D==="custom"?"block":"none")}u.forEach(D=>D.addEventListener("change",b));const x=document.getElementById("professionalCommissionsList");x&&(x.innerHTML=(p.professionals||[]).map(D=>{const L=e?.professionalCommissions?.[D.id]!==void 0,A=e?.professionalCommissions?.[D.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${L?"bg-blue-50":""}" data-prof-id="${D.id}">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <img src="${D.photo||`https://placehold.co/40x40/E2E8F0/4A5568?text=${f(D.name.charAt(0))}`}" class="w-8 h-8 rounded-full object-cover">
                        <span class="text-sm font-medium">${f(D.name)}</span>
                    </label>
            ...
            `}).join(""),x.querySelectorAll('input[type="checkbox"]').forEach(D=>{D.addEventListener("change",L=>{const A=L.target.closest(".professional-commission-row");A.querySelector('input[type="number"]').disabled=!L.target.checked,A.classList.toggle("bg-blue-50",L.target.checked)})})),b();const h=t.querySelector("#serviceForm"),S=t.querySelector("#servicePhotoInput"),k=t.querySelector("#servicePhotoPreview"),E=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>S.click()),S.onchange=async()=>{const D=S.files[0];if(D){k.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const L=await Yo(D,800,800,.8);if(L.length*3/4>1e3*1024)throw new Error("Imagem muito grande.");k.src=L,E.value=L}catch(L){g("Erro de Imagem",L.message,"error"),k.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",E.value=e?.photo||""}}},h.addEventListener("submit",Cn)}function st(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",r=new Map((p.serviceCategories||[]).map(s=>[s.id,s.name]));let o=(p.services||[]).filter(Boolean);if(we!=="all"){const s=we==="active";o=o.filter(i=>i.active!==!1===s)}o=o.filter(s=>{const i=s.name.toLowerCase().includes(t),n=a==="all"||s.categoryId===a;return i&&n}),e.innerHTML="",o.length>0?o.forEach(s=>{const i=document.createElement("div"),n=JSON.stringify(s).replace(/'/g,"&apos;");i.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:border-indigo-300 border border-transparent ${s.active!==!1?"opacity-100":"opacity-60 bg-gray-100"} sm:flex-col`,i.dataset.action="edit-service",i.dataset.service=n;const l=f(s.name),d=f(r.get(s.categoryId)||"Sem Categoria"),c=s.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(s.name.charAt(0))}`;i.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),ja(),st()}function Dn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function bt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,r,o,s]=await Promise.all([Ie(p.establishmentId),re(p.establishmentId),Zt(p.establishmentId,"services"),ei(p.establishmentId),We()]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(r||[]).filter(Boolean),p.mostPopularService=o||{name:"N/A",count:0},ot=s?.matrizes||[],p.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),fs(at)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function fs(e){if(document.getElementById("services-content-container")){if(at===e&&document.getElementById("services-content-container").children.length>1){at==="services"&&(ja(),st());return}at=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Tn():e==="reports"&&Dn()}}function Bn(){ge&&(ve.removeEventListener("click",ge),ve.removeEventListener("input",ge),ve.removeEventListener("change",ge)),ge=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const o=t.closest('[data-action="toggle-service-status"]'),s=o.dataset.id,i=o.checked;try{await Kr(s,i);const n=p.services.findIndex(l=>l.id===s);n>-1&&(p.services[n].active=i),de(p.establishmentId,Ue(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${i?"Ativo":"Inativo"}`),st(),ja()}catch(n){g("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),o.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){st();return}if(!a)return;if(a.hasAttribute("data-view")){fs(a.dataset.view);return}switch(a.dataset.action){case"new-service":co();break;case"edit-service":const o=JSON.parse(a.dataset.service);co(o);break;case"manage-categories":In();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;we=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,d=n===we||n==="total"&&we==="all";i.classList.toggle("ring-2",d),i.classList.toggle("ring-indigo-500",d),i.classList.toggle("shadow-md",d),i.classList.toggle("bg-white",!d)}),st();break}},ve.addEventListener("click",ge),ve.addEventListener("input",ge),ve.addEventListener("change",ge)}async function Pn(){ve.innerHTML=`
        ...
        </div>`,Bn(),at="services",we="all",await bt()}const Kt="suppliers",Na=async e=>{try{const t=No(Ut(pe,Kt),Fo("establishmentId","==",e)),a=await Js(t),r=[];return a.forEach(o=>{r.push({id:o.id,...o.data()})}),r}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Mn=async e=>{try{return{id:(await jo(Ut(pe,Kt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},An=async(e,t)=>{try{const a=gt(pe,Kt,e);return await Ia(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},qn=async e=>{try{const t=gt(pe,Kt,e);return await Gs(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},xe=document.getElementById("content");let be=null,rt="products",ce="all";async function Rn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),r=a.value;if(r)try{await gs({establishmentId:p.establishmentId,name:r},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Fa(),await ft()}catch(o){g("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function jn(e){if(await U("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await bs(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Fa(),await ft()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Fa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Zt(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${f(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Nn(){se({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const b=t.querySelector("#productCategory"),x=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>x.click()),b.innerHTML='<option value="">Sem categoria</option>'+(p.categories||[]).map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${f(T.name)}</option>`).join(""),e&&(b.value=e.categoryId||"");const h=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const S=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",k=e?.photo||"";x.onchange=async()=>{const T=x.files[0];if(T){h.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const M=await uo(T,800,800,"image/jpeg",.8),H=M.length*3/4,O=1e3*1024;if(H>O)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=M,base64Input.value=M}catch(M){console.error("Erro ao processar imagem:",M),g("Erro de Imagem",M.message||"Não foi possível processar a imagem.","error"),preview.src=S,base64Input.value=k,N.value=""}}};const E=t.cloneNode(!0);t.parentNode.replaceChild(E,t);const D=()=>{const T=E.querySelector("#modalSupplierSearch"),M=E.querySelector("#supplierSearchResults"),q=E.querySelector("#selectedSuppliersList"),H=T.value.toLowerCase();if(H.length>0){const O=r.filter(R=>R.name.toLowerCase().includes(H)&&!s.has(R.id));O.length>0?(M.classList.remove("hidden"),M.innerHTML=O.map(R=>`
                ...
                `).join("")):(M.classList.remove("hidden"),M.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else M.classList.add("hidden");s.size>0?(q.innerHTML="",s.forEach(O=>{const R=r.find(W=>W.id===O);R&&(q.innerHTML+=`
                    ...
                    `)})):q.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};E.querySelector("#modalSupplierSearch").addEventListener("input",D),E.addEventListener("click",T=>{const M=T.target.closest("[data-add-supplier]");if(M){const H=M.dataset.addSupplier;s.add(H),E.querySelector("#modalSupplierSearch").value="",D()}const q=T.target.closest("[data-remove-supplier]");if(q){const H=q.dataset.removeSupplier;s.delete(H),D()}}),D(),E.addEventListener("click",async T=>{const M=T.target.closest("button[data-action]");if(!M)return;const q=M.dataset.action,H=E.querySelector("#productId").value;if(q==="close-modal"&&(E.style.display="none"),q==="delete-product"){if(!H)return;E.style.display="none",await Fn(H)}if(q==="save-product-modal"){const O=E.querySelector("#productForm");if(O){if(!O.querySelector("#productName").value||!O.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const R=M.closest('button[data-action="save-product-modal"]');R.disabled=!0,R.textContent="A salvar...";try{await Hn(O)}catch(W){g("Erro",`Falha ao salvar: ${W.message}`,"error"),R.disabled=!1,R.textContent="Salvar Alterações"}}}if(q==="adjust-stock-modal"){T.preventDefault();const O=E.querySelector("#stockAdjustmentAmount"),R=E.querySelector("#stockAdjustmentReason"),W=parseInt(O.value,10),Le=parseInt(M.dataset.change,10);if(!W||W<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const ta=W*Le,Rs=R.value||(ta>0?"Entrada manual":"Saída manual");try{await Si(H,{change:ta,reason:Rs});const Ge=p.products.findIndex(Ye=>Ye.id===H);if(Ge>-1){const Ye=p.products[Ge].currentStock+ta;p.products[Ge].currentStock=Ye,E.querySelector("#currentStockDisplay").textContent=Ye,E.querySelector("#productCurrentStock").value=Ye,O.value="",R.value="",g("Sucesso","Estoque atualizado!","success"),Ha(),pt()}}catch(Ge){g("Erro de Stock",Ge.message,"error")}}});const L=E.querySelectorAll(".tab-btn"),A=E.querySelectorAll(".tab-content");L.forEach(T=>{T.addEventListener("click",M=>{M.preventDefault(),L.forEach(q=>{q.classList.remove("border-indigo-500","text-indigo-600"),q.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),T.classList.add("border-indigo-500","text-indigo-600"),T.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),A.forEach(q=>q.classList.add("hidden")),document.getElementById(`tab-content-${T.dataset.tab}`).classList.remove("hidden")})});const N=E.querySelector("#productPhotoInput");E.querySelector("#productPhotoButton").addEventListener("click",()=>N.click()),N.onchange=async()=>{const T=N.files[0];if(!T)return;const M=E.querySelector("#productPhotoPreview"),q=E.querySelector("#productPhotoBase64");M.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const H=await uo(T,800,800,"image/jpeg",.8),R=H.length*3/4,W=1e3*1024;if(R>W)throw new Error("A imagem é muito grande mesmo após a compressão.");M.src=H,q.value=H}catch(H){console.error("Erro ao processar imagem:",H),g("Erro de Imagem",H.message||"Não foi possível processar a imagem.","error"),M.src=S,q.value=k,N.value=""}},E.style.display="flex"}function On(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),Ha(),pt()}function zn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const r=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const o=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");o&&p.products&&(o.innerHTML+=p.products.map(i=>`<option value="${i.id}">${f(i.name)}</option>`).join("")),s&&p.categories&&(s.innerHTML+=p.categories.map(i=>`<option value="${i.id}">${f(i.name)}</option>`).join(""))}async function Vn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:p.establishmentId};try{const a=await $i(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ft(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,r]=await Promise.all([Yt(p.establishmentId),Zt(p.establishmentId,"products"),Na(p.establishmentId)]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),p.suppliers=(r||[]).filter(Boolean),xs(rt)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function xs(e){if(document.getElementById("products-content-container")){if(rt===e&&document.getElementById("products-content-container").children.length>1){rt==="products"&&(Ha(),pt());return}rt=e,ce="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?On():e==="movements"&&zn()}}async function Un(){xe.innerHTML=`
        ...
        </section>`,be&&(xe.removeEventListener("click",be),xe.removeEventListener("input",be),xe.removeEventListener("change",be)),be=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){pt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){xs(a.dataset.view);return}switch(a.dataset.action){case"new-product":po();break;case"edit-product":po(JSON.parse(a.dataset.product));break;case"manage-product-categories":Nn();break;case"generate-report":await Vn();break;case"filter-stock":const o=a.dataset.filterType;ce=ce===o?"all":o,document.querySelectorAll(".indicator-card").forEach(s=>{s.classList.toggle("ring-2",s.dataset.filterType===ce),s.classList.toggle("ring-indigo-500",s.dataset.filterType===ce),s.classList.toggle("shadow-lg",s.dataset.filterType===ce)}),pt();break}},xe.addEventListener("click",be),xe.addEventListener("input",be),xe.addEventListener("change",be),rt="products",ce="all",await ft()}const Ct=document.getElementById("content");let F={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},ht=null;const At={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},vs=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function _n(){try{const t=(await We()).matrizes||[];F.establishments=[],t.forEach(a=>{F.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(r=>F.establishments.push({id:r.id,name:r.name,type:"Filial"}))})}catch(e){console.warn("Erro ao buscar lojas",e)}F.viewMode="list",F.editingItem=null,F.hasSearched=!1,F.partners=[],Wn(),Zn(),hs()}function Wn(){Ct.innerHTML=`
    ...
    `}function Jn(){const e=Object.entries(At).map(([a,r])=>`<option value="${a}">${r.label}</option>`).join(""),t=vs.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Gn(e=null){const t=!!e,a=t?"Ficha do Parceiro":"Novo Parceiro de Negócio";let r=e?.category||"";r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const o=Object.entries(At).map(([n,l])=>`<option value="${n}" ${r===n?"selected":""}>${l.label}</option>`).join(""),s=vs.map(n=>`<option value="${n}" ${e?.state===n?"selected":""}>${n}</option>`).join(""),i=document.getElementById("form-container-wrapper");i&&(i.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Qn))}function hs(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
        ...
        <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
    `,r='<div class="flex flex-col gap-4 md:hidden">';t.forEach(o=>{let s=o.category;s==="Produtos"&&(s="estoque"),s==="Serviços"&&(s="servicos");const i=At[s]||At.outros,n=o.document||o.taxId?o.document||o.taxId:"-",l=JSON.stringify(o).replace(/'/g,"&apos;"),d=[o.city,o.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",r+="</div>",e.innerHTML=a+r}function it(e,t=null){const a=document.getElementById("suppliers-list-view"),r=document.getElementById("suppliers-form-view");F.viewMode=e,F.editingItem=t,e==="list"?(a.classList.remove("hidden"),r.classList.add("hidden"),r.innerHTML='<div id="form-container-wrapper" class="max-w-5xl mx-auto px-4 sm:px-6 py-8 pb-24"></div>',F.hasSearched&&ys(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),r.classList.remove("hidden"),Gn(t),window.scrollTo({top:0,behavior:"smooth"}))}async function Qn(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,r={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,document:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,state:t.querySelector("#supState").value,city:t.querySelector("#supCity").value,establishmentId:p.establishmentId,notes:t.querySelector("#supNotes")?.value||"",accessibleIn:[p.establishmentId]},o=t.querySelector('button[type="submit"]'),s=o.innerHTML;o.disabled=!0,o.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await An(a,r),g("Sucesso","Ficha atualizada!","success")):(await Mn(r),g("Sucesso","Parceiro registado!","success")),F.hasSearched&&(F.partners=await Na(p.establishmentId)||[]),it("list")}catch(i){g("Erro","Falha ao gravar: "+i.message,"error"),o.disabled=!1,o.innerHTML=s}}async function Xn(e){if(await U("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente? Os lançamentos financeiros antigos não serão apagados."))try{await qn(e),g("Sucesso","Entidade excluída.","success"),F.partners=F.partners.filter(a=>a.id!==e),it("list")}catch(a){g("Erro","Erro ao excluir: "+a.message,"error")}}function Zn(){ht&&Ct.removeEventListener("click",ht),ht=async e=>{const t=e.target;if(t.closest('button[data-action="new-partner"]')){it("form",null);return}if(t.closest("#btn-search-partners")){F.searchQuery=document.getElementById("filterSearch").value,F.categoryFilter=document.getElementById("filterCategory").value,F.stateFilter=document.getElementById("filterState").value,F.cityFilter=document.getElementById("filterCity").value,F.sortBy=document.getElementById("filterSortBy").value,F.hasSearched=!0,Yn();return}if(t.closest('button[data-action="back-to-list"]')){it("list");return}const a=t.closest('button[data-action="delete-partner"]');if(a){e.preventDefault(),Xn(a.dataset.id);return}const r=t.closest('[data-action="open-form"]');if(r&&!t.closest("button")){const o=JSON.parse(r.dataset.item.replace(/&apos;/g,"'"));it("form",o)}},Ct.addEventListener("click",ht),Ct.addEventListener("keypress",e=>{e.key==="Enter"&&(e.target.id==="filterSearch"||e.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const sa=document.getElementById("content"),mo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ie=new Set,yt=null,Ae=null,Tt=[];function Dt(){const e=oe.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}function Kn(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function el(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",r=f(t.name),o=f(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,l=n>1?`<span class="text-[10px] font-bold bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded ml-2 border border-indigo-200" title="Atende em ${n} unidades"><i class="bi bi-diagram-3"></i> ${n} Lojas</span>`:"";return`
            ...
            </div>`}).join("")}function ra(){const e=document.getElementById("genericModal");e.style.display="none",Ae&&e.removeEventListener("click",Ae)}async function tl(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},r=f(a.name),o=p.services||await Ie(p.establishmentId),s=p.professionals||await re(p.establishmentId),i=`
        ...
        </div>`;t.innerHTML=i,t.style.display="flex",ol(a,o),sl(a),rl(a,s),nl(a)}function al(e=[]){if(!Tt||Tt.length===0)return`
            <input type="hidden" name="accessibleIn" value="${p.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Profissional exclusivo desta unidade.
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return Tt.forEach(a=>{const r=e.includes(a.id)||e.length===0&&a.id===p.establishmentId;t+=`
            <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-white rounded px-2 transition-colors">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${r?"checked":""}>
                <span class="text-sm font-bold text-gray-800">🏢 ${f(a.name)} (Matriz)</span>
            </label>
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const s=e.includes(o.id)||e.length===0&&o.id===p.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function ol(e,t){const a=document.getElementById("professionalForm"),r=e.dob?e.dob.split("/"):["",""],o=Array.from({length:12},(h,S)=>{const k=S+1,E=k==r[1]?"selected":"",D=new Date(0,S).toLocaleString("pt-BR",{month:"long"});return`<option value="${k}" ${E}>${D.charAt(0).toUpperCase()+D.slice(1)}</option>`}).join(""),s=e.status||"active",i=f(e.name||""),n=f(e.specialty||""),l=f(e.phone||""),d=f(e.notes||"");a.innerHTML=`
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        ...
                        <div id="batchProfSelectionContainer" class="max-h-40 overflow-y-auto p-3 border border-orange-200 rounded-lg bg-white space-y-2 shadow-sm">
                            ${t.map(s=>`
                                <label class="flex items-center space-x-3 hover:bg-orange-50 p-1 rounded cursor-pointer transition-colors">
                                    ...
                                    <span class="text-sm font-medium text-gray-700">${f(s.name)}</span>
                                </label>`).join("")}
                        </div>
                    </div>
        ...
        </div>`;const r=document.getElementById("batchBlockageForm");r&&r.addEventListener("submit",async s=>{s.preventDefault();const i=r.querySelector('button[type="submit"]'),n=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm"></span> A gravar...';const l=Array.from(s.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(x=>x.value);if(l.length===0)return i.disabled=!1,i.innerHTML=n,g("Atenção","Selecione pelo menos um profissional.","error");const d=s.target.batchBlockageStartDate.value,c=s.target.batchBlockageEndDate.value||d,u=s.target.batchBlockageStartTime.value,m=s.target.batchBlockageEndTime.value,v=s.target.batchBlockageReason.value;if(!d||!u||!m)return i.disabled=!1,i.innerHTML=n,g("Atenção","Preencha Data de Início, Hora de Início e Fim.","error");const b=l.map(x=>{const h={professionalId:x,establishmentId:p.establishmentId,startTime:new Date(`${d}T${u}`).toISOString(),endTime:new Date(`${c}T${m}`).toISOString(),reason:v};return Jt(h)});try{await Promise.all(b),g("Sucesso!",`${l.length} bloqueios foram criados.`),r.reset(),s.target.querySelectorAll('input[name="batch-professionals"]').forEach(h=>{h.checked=h.value===e.id});const x=document.getElementById("prof-blockages-filter").value;nt(e.id,x)}catch(x){g("Erro",x.message,"error")}finally{i.disabled=!1,i.innerHTML=n}}),document.getElementById("prof-blockages-filter").addEventListener("change",s=>nt(e.id,s.target.value)),await nt(e.id,"future")}function il(e,t){e.innerHTML=Object.keys(mo).map(a=>{const r=t[a]||{},o=r.active!==!1;return`
            <div class="day-schedule-card p-4 rounded-xl ${o?"bg-white border-gray-200 shadow-sm":"bg-gray-50 border-gray-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-3">
                    <span class="font-bold text-gray-800">${mo[a]}</span>
        ...
        `).join("")}catch(r){a.innerHTML=`<p class="text-red-500 p-4">${r.message}</p>`}}}function nl(e){const t=document.getElementById("genericModal");Ae&&t.removeEventListener("click",Ae),Ae=async a=>{const r=a.target.closest("button[data-action]");if(!r){const s=a.target.closest(".tab-link");s&&(t.querySelectorAll(".tab-link").forEach(i=>{i.classList.remove("active","border-indigo-600","text-indigo-600"),i.classList.add("border-transparent","text-gray-500")}),s.classList.add("active","border-indigo-600","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),t.querySelectorAll(".tab-content").forEach(i=>i.classList.add("hidden")),document.getElementById(s.dataset.tab).classList.remove("hidden"));return}const o=r.dataset.action;switch(a.stopPropagation(),o){case"close-modal":ra();break;case"delete-professional":const s=r.dataset.id;if(await U("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita e ele será removido da agenda e de todas as lojas.`))try{await Qo(s),de(p.establishmentId,Dt(),"Equipe","Excluiu",`Excluiu profissional: ${e.name}`),g("Sucesso!","Profissional excluído da rede.","success"),ra(),qt()}catch(k){g("Erro",`Não foi possível excluir: ${k.message}`,"error")}break;case"save-professional":const n=document.getElementById("professionalForm"),l=r,d=document.getElementById("profScheduleContainer"),c=Array.from(n.querySelectorAll("#profServicesContainer input:checked")).map(k=>k.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(k=>{const E=k.querySelector('[data-field="active"]').dataset.day;u[E]={active:k.querySelector('[data-field="active"]').checked,start:k.querySelector('[data-field="start"]').value,end:k.querySelector('[data-field="end"]').value,breakStart:k.querySelector('[data-field="breakStart"]').value,breakEnd:k.querySelector('[data-field="breakEnd"]').value}});const m=Array.from(n.querySelectorAll('input[name="accessibleIn"]:checked')).map(k=>k.value),v=m.length>0?m:[p.establishmentId],b={...e,id:n.querySelector("#professionalId").value||void 0,accessibleIn:v,name:n.querySelector("#profName").value.trim(),specialty:n.querySelector("#profSpecialty").value,photo:n.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:n.querySelector("#profPhone").value,dob:`${n.querySelector("#profDobDay").value}/${n.querySelector("#profDobMonth").value}`,receivesCommission:n.querySelector("#profCommission").value==="sim",showOnAgenda:n.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(n.querySelector("#profOrderOnAgenda").value)||1,notes:n.querySelector("#profNotes").value,status:n.querySelector("#profStatus").value,establishmentId:p.establishmentId},x=l.innerHTML;l.disabled=!0,l.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{b.id?(await oi(b.id,b),de(p.establishmentId,Dt(),"Equipe","Editou",`Editou o profissional: ${b.name}`),g("Sucesso!","Dados atualizados.","success")):(delete b.id,await ai(b),de(p.establishmentId,Dt(),"Equipe","Criou",`Cadastrou o profissional: ${b.name}`),g("Sucesso!","Novo membro adicionado à equipe.","success")),ra(),qt()}catch(k){g("Erro",k.message,"error"),l.disabled=!1,l.innerHTML=x}break;case"delete-blockage":const h=r.dataset.id;if(await U("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await Da(h),g("Bloqueio removido.","success");const k=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";nt(e.id,k)}catch(k){g("Erro",k.message,"error")}break;case"batch-delete-blockage":const S=JSON.parse(r.dataset.ids);if(await U("Apagar em Lote",`Tem certeza que deseja apagar ${S.length} dias de bloqueio de uma vez?`))try{await Xo(S),g("Bloqueios removidos.","success");const k=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";nt(e.id,k)}catch(k){g("Erro",k.message,"error")}break}},t.addEventListener("click",Ae)}function ha(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ie.size>0?(t.textContent=`${ie.size} selecionado(s)`,e.classList.remove("hidden"),e.classList.add("flex")):(e.classList.add("hidden"),e.classList.remove("flex")))}function ll(){U("Excluir em Lote",`Tem certeza que deseja excluir ${ie.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await si(Array.from(ie)),de(p.establishmentId,Dt(),"Equipe","Excluiu em Lote",`Excluiu ${ie.size} profissionais`),g("Sucesso!",`${ie.size} profissionais foram excluídos.`,"success"),ie.clear(),ha(),qt()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Qe(){const e=document.getElementById("professionalsList");if(!e)return;if(!p.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Kn();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),r=p.professionals.filter(o=>{const s=o.name.toLowerCase().includes(a),i=t||o.status!=="inactive";return s&&i});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=el(r)}async function qt(){ie.clear(),sa.innerHTML=`
        ...
        </section>`,yt&&sa.removeEventListener("click",yt),yt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),r=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let s={};if(a.dataset.professional)try{s=JSON.parse(a.dataset.professional)}catch(i){console.error("Erro ao fazer parse do professional data:",i);return}tl(s);return}if(r){ll();return}const o=t.target.closest(".professional-checkbox");if(o){const s=o.dataset.id;o.checked?ie.add(s):ie.delete(s),Qe(),ha();return}},sa.addEventListener("click",yt),document.getElementById("profSearchInput").addEventListener("input",Qe),document.getElementById("showInactiveProfToggle").addEventListener("change",Qe);const e=document.getElementById("professionalsList");p.professionals=null,p.services=null,Qe();try{const[t,a,r]=await Promise.all([re(p.establishmentId),Ie(p.establishmentId),We()]);p.professionals=t,p.services=a,Tt=r?.matrizes||[],Qe(),ha()}catch{e.innerHTML='<p class="text-red-500 col-span-full font-bold text-center py-10 bg-red-50 rounded-lg border border-red-100">Erro ao carregar dados do servidor.</p>'}}let w={clients:[],selectedClient:null,activeTab:"profile",filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},showFilters:!1,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},ws=null;const dl=e=>e?String(e).replace(/\D/g,""):"",cl=e=>{if(!e)return"Nunca";let t;if(typeof e=="object"&&(e.seconds||e._seconds)){const a=e.seconds||e._seconds;t=new Date(a*1e3)}else t=new Date(e);return isNaN(t.getTime())?"Data Inválida":t.toLocaleDateString("pt-BR")};function Oa(){ws.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=hl)}function mt(){if(w.modalOpen)return;Oa();const e=document.getElementById("clients-content-area"),t=w.filters.inactiveDays||w.filters.birthMonth||w.filters.hasLoyalty||w.filters.hasDebt,a=`
    ...
    `,r=w.clients.length>0?`
        <div class="px-3 sm:px-4 pb-20 pt-2 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${w.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,m=cl(c.lastVisit);return`
    ...
    `;e.innerHTML=a+r;const o=document.getElementById("client-search"),s=document.getElementById("btn-toggle-filters"),i=document.getElementById("btn-apply-filters"),n=document.getElementById("btn-clear-search");s&&(s.onclick=()=>{w.showFilters=!w.showFilters,mt()});const l=document.getElementById("filter-birth-month");l&&(l.value=w.filters.birthMonth);const d=()=>{const c=document.getElementById("filter-inactive"),u=document.getElementById("filter-loyalty"),m=document.getElementById("filter-debt"),v=document.getElementById("filter-birth-month");w.filters={search:o.value,inactiveDays:c?c.value:"",birthMonth:v?v.value:"",hasLoyalty:u?u.checked:!1,hasDebt:m?m.checked:!1},ya()};i&&(i.onclick=d),n&&(n.onclick=()=>{w.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},w.showFilters=!1,ya()}),o.addEventListener("keypress",c=>{c.key==="Enter"&&d()}),e.querySelectorAll(".client-card").forEach(c=>{c.onclick=()=>ks(c.dataset.id)})}function ul(e){const t=`
    ...
    `;let a="";return w.activeTab==="profile"?a=gl(e):w.activeTab==="appointments"?a=bl():w.activeTab==="history"?a=fl():w.activeTab==="loyalty"&&(a=xl(e)),`
    ...
    `}function pl(e,t){if(!document.getElementById("tabs-styles")){const s=document.createElement("style");s.id="tabs-styles",s.textContent=`
        ...
        `,e.appendChild(s)}if(e.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const i=s.dataset.tab;if(w.activeTab===i)return;(i==="appointments"||i==="history")&&(w.historyLimit=20,w.historySearchTerm=""),w.activeTab=i,Ne(),i!=="profile"&&!w.historyLoading&&w.historyData.appointments.length===0&&await go(t.id)}}),w.activeTab==="profile"){const s=e.querySelector("#form-edit-client"),i=e.querySelector("#btn-delete-client");s&&(s.onsubmit=yl),i&&(i.onclick=wl)}if(w.activeTab==="loyalty"){const s=e.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>vl(t))}const a=e.querySelector("#history-search-input");if(a){const s=a.value;a.value="",a.focus(),a.value=s,a.addEventListener("input",i=>{w.historySearchTerm=i.target.value,Ne()})}const r=e.querySelector("#btn-load-more");r&&(r.onclick=()=>{w.historyLimit+=20,Ne(),go(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=i=>{Fe(),_("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=i=>{Fe(),_("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const o=e.querySelector("#btn-close-modal");o&&(o.onclick=Fe)}async function Ne(){const e=w.selectedClient;if(!e){Fe();return}ml(e)}function ml(e){let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 animate-fade-in",t.innerHTML=`
    ...
    `}function fl(e){let t=w.historyData.sales||[];if(w.historySearchTerm){const a=w.historySearchTerm.toLowerCase();t=t.filter(r=>r.id.includes(a))}return t.sort((a,r)=>new Date(r.date)-new Date(a.date)),t.length===0&&!w.historySearchTerm?'<div class="text-center py-12 text-gray-400">Nenhum registro financeiro.</div>':`
        <div class="space-y-4 w-full">
            <div class="sticky top-0 bg-gray-50 pt-2 pb-2 z-10 w-full">
                <div class="relative w-full">
                    <input type="text" id="history-search-input" 
    ...
    `}function xl(e){const t=w.historyData.loyaltyLog||[];t.sort((r,o)=>new Date(o.date)-new Date(r.date));const a=t.length>0?t.map(r=>{const o=r.type==="redemption";return`
            <div class="flex justify-between items-center py-3 border-b border-gray-100 last:border-0 w-full">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-700">${f(r.description||(o?"Resgate":"Acúmulo"))}</p>
    ...
    `}async function ya(){w.loading=!0,Oa();try{let e=`/api/clients/${p.establishmentId}?limit=20`;w.filters.search&&(e+=`&search=${encodeURIComponent(w.filters.search)}`),w.filters.inactiveDays&&(e+=`&inactiveDays=${w.filters.inactiveDays}`),w.filters.hasLoyalty&&(e+="&hasLoyalty=true"),w.filters.hasDebt&&(e+="&hasDebt=true"),w.clients=await I(e),mt()}catch(e){console.error(e),g("Erro","Falha ao carregar clientes.","error"),w.clients=[],mt()}finally{w.loading=!1;const e=document.querySelector(".loader");e&&e.parentElement&&e.parentElement.remove()}}async function go(e){const t=w.selectedClient;if(!(!t||!t.phone)){w.historyLoading=!0;try{const a=new Date;a.setMonth(a.getMonth()+12);const r=new Date;r.setFullYear(r.getFullYear()-5);let o=`/api/appointments/${p.establishmentId}?startDate=${r.toISOString()}&endDate=${a.toISOString()}`;o+=`&clientPhone=${encodeURIComponent(dl(t.phone))}`,o+=`&limit=${w.historyLimit}`;const s=await I(o);w.historyData.appointments=s,w.historyData.sales=s.filter(n=>n.status==="completed").map(n=>({id:n.id,date:n.startTime,totalAmount:n.totalAmount||0,items:n.comandaItems||n.services||[]}));const i=[];s.forEach(n=>{n.status==="completed"&&n.loyaltyPointsEarned>0&&i.push({type:"earn",points:n.loyaltyPointsEarned,date:n.startTime,description:"Venda finalizada"}),n.loyaltyRedemption&&i.push({type:"redemption",points:n.loyaltyRedemption.cost||0,date:n.startTime,description:`Resgate: ${n.loyaltyRedemption.name}`})}),w.historyData.loyaltyLog=i}catch(a){console.error("Erro ao buscar histórico",a)}finally{w.historyLoading=!1,w.modalOpen&&w.selectedClient&&Ne()}}}function vl(e){const t=e.loyaltyPoints||0,a=`
    ...
    `,{modalElement:r,close:o}=se({title:"Ajuste de Pontos",contentHTML:a,maxWidth:"w-[90%] max-w-xs"});r.querySelector("form").onsubmit=async s=>{s.preventDefault();const i=document.getElementById("redeem-action").value,n=parseInt(document.getElementById("redeem-points").value,10),l=document.getElementById("redeem-reason").value;if(!n||n<=0)return g("Erro","Qtd inválida.","error");if(i==="debit"&&n>t)return g("Erro","Saldo insuficiente.","error");try{let d=t;i==="debit"?(await Ur(p.establishmentId,e.phone,n,l),d-=n):(d+=n,await Go(e.id,{loyaltyPoints:d})),w.selectedClient.loyaltyPoints=d,w.historyData.loyaltyLog.unshift({type:i==="debit"?"redemption":"earn",points:n,date:new Date().toISOString(),description:l+" (Manual)"}),g("Sucesso","Saldo atualizado.","success"),o(),Ne()}catch(d){g("Erro",d.message,"error")}}}function ks(e){w.selectedClient=w.clients.find(t=>t.id===e),w.activeTab="profile",w.historyLimit=20,w.historySearchTerm="",w.historyData={appointments:[],sales:[],loyaltyLog:[]},Ne()}function hl(){const e=`
    ...
    `;const a=t.querySelector("#establishmentTimezone");e.timezone&&(a.value=e.timezone);const r=t.querySelector("#establishmentWorkingHoursContainer"),o=e.workingHours||{};Object.keys(ia).forEach(s=>{const i=o[s]||{},n=ia[s],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,r.appendChild(d)}),r.addEventListener("change",s=>{const i=s.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),t.querySelector("#working-hours-form").addEventListener("submit",s=>{s.preventDefault();const i={};Object.keys(ia).forEach(l=>{i[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const n=t.querySelector("#establishmentTimezone").value;Je({workingHours:i,timezone:n},s)})}function $s(e,t){const a=!!e.whatsappInstance;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;try{const[a,r]=await Promise.all([Xt(J),qa(J)]),o=e.financialIntegration||{},s=e.commissionConfig||{},i=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=De(a,o.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=De(r,o.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=De(a,i.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=De(r,i.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=De(a,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=De(r,s.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar o plano de contas da unidade.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const r={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Je(r,a)})}function Pl(e,t){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${e.name}).`;t.innerHTML=`
    ...
    `}function Es(e="indigo",t){const a=t.querySelector("#color-palette-container"),r=t.querySelector("#establishmentThemeColor");!a||!r||(a.innerHTML="",Object.entries(Sl).forEach(([o,s])=>{const i=o===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
    ...
    `,ye.querySelector('button[data-action="back-to-menu"]').addEventListener("click",o=>{o.preventDefault(),Is({id:J})});const r=document.getElementById("settings-content-detail");switch(e){case"personal-data":$l(V,r);break;case"change-password":El(V,r);break;case"change-email":Il(V,r);break;case"branding":Ll(V,r);break;case"booking":Cl(V,r);break;case"working-hours":Tl(V,r);break;case"whatsapp-bot":$s(V,r);break;case"loyalty":await Dl(V,r);break;case"financial":await Bl(V,r);break;case"support":Pl(V,r);break;case"cancellation":Ml(V,r);break;default:r.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Is(e={}){ye.innerHTML=`
    ...
    `;try{J=e.id||p.establishmentId,V=await Se(J);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=V.isMatriz||!V.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',r=Ss();ye.innerHTML=`
        ...
        `,ye.querySelectorAll("div[data-section]").forEach(o=>{o.addEventListener("click",s=>{ql(o.dataset.section)})}),ye.querySelectorAll(".module-toggle").forEach(o=>{o.addEventListener("change",async()=>{const s=o.dataset.module;try{const n={...(await Se(J)).modules,[s]:o.checked};await La(J,{modules:n}),g("Módulos","Módulos atualizados com sucesso.","success")}catch(i){o.checked=!o.checked,g("Erro",i.message,"error")}})})}catch(t){ye.innerHTML=`
    ...
    `).join("")}const lt=document.getElementById("content");async function He(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,r=document.getElementById("filterEndDate")?.value,o=await Wt(p.establishmentId,a||new Date().toISOString().split("T")[0],r||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),i=s?o.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):o,n=i.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",i.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let m=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${f(l)} (${d.length})</h4>`;if(d.length>1){const v=JSON.stringify(d.map(b=>b.id));m+=`<button data-action="batch-delete-blockage" data-ids='${v}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}m+="</div>",c.innerHTML=m,d.forEach(v=>{const b=new Date(v.startTime),x=new Date(v.endTime),h=b.toLocaleDateString("pt-BR"),S=x.toLocaleDateString("pt-BR"),E=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${h===S?`${h} | ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${x.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${h} às ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${S} às ${x.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
        ...
        </section>`,Fl(t),await He(t);const o=document.getElementById("batchProfSelectionContainer");try{const s=await re(p.establishmentId);o.innerHTML=s.map(i=>`
            <div class="flex items-center">
    ...
    `}).join("")}function wa(){const t=document.getElementById("showInactiveUsersToggle")?.checked?p.users:p.users.filter(a=>a.status==="active");Ql(t)}function Xl(e={}){return Object.entries(Jl).map(([t,a])=>{const r=t==="agenda-section"||t==="comandas-section",o=e[t]?.view_all_prof===!0,s=Object.entries(Gl).map(([n,l])=>`
    ...
    `}).join("")}function fo(e){if(!Oe||p.userRole==="professional")return"";const t=e?.accessibleEstablishments?.map(s=>s.id)||[],a=e?.accessibleCompanies?.map(s=>s.id)||[];if((e?.role||"professional")==="group_admin")return'<div class="p-3 bg-purple-50 border border-purple-200 rounded-lg text-purple-800 text-sm font-bold">Acesso Total (Global) liberado.</div>';let o='<div class="space-y-3 max-h-48 overflow-y-auto custom-scrollbar p-2 bg-gray-50 rounded border">';return Oe.companies.forEach(s=>{const i=a.includes(s.id),n=Oe.branches.filter(l=>l.companyId===s.id);o+=`
        ...
        `}),o+="</div>",o}async function xo(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=p.professionals;if(!a||a.length===0)try{a=await re(p.currentViewContext.id),p.professionals=a}catch{console.warn("Profissionais não carregados")}if(["group_admin","company_admin"].includes(p.userRole)&&!Oe)try{const d=await fetch("/api/establishments/hierarchy",{headers:{Authorization:`Bearer ${await p.getAuthToken?.()||""}`}});d.ok&&(Oe=await d.json())}catch(d){console.error("Falha ao buscar hierarquia",d),Oe={companies:[],branches:[]}}const r=d=>a?.find(c=>c.id===d),o=e?.professionalId;r(o);const s=e!==null;t.querySelector("#userFormTitle").textContent=s?`Editar: ${e.name}`:"Novo Usuário";const i=t.querySelector("#userForm");i.innerHTML=`
    ...
    `,wt&&Xe.removeEventListener("click",wt),kt&&Xe.removeEventListener("change",kt),wt=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":xo();break;case"edit-user":const r=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));xo(r);break;case"back-to-list":Rt();break;case"delete-user":{if(e.stopPropagation(),await U("Excluir Usuário","Tem certeza? Ação irreversível."))try{await Ul(t.dataset.userId),g("Usuário excluído!","success"),Rt()}catch(o){g(`Erro: ${o.message}`,"error")}break}}},kt=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")wa();else if(t){e.stopPropagation();const a=t.dataset.userId,r=t.checked?"active":"inactive";try{await Wl(a,r);const o=p.users.findIndex(s=>s.id===a);o>-1&&(p.users[o].status=r,wa())}catch(o){g(`Erro: ${o.message}`,"error"),t.checked=!t.checked}}},Xe.addEventListener("click",wt),Xe.addEventListener("change",kt),await Zl()}const Kl=document.getElementById("content");let vo={},ka=null;function ed(){Object.values(vo).forEach(e=>e?.destroy()),vo={}}function td(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,r=new a({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(r.setFontSize(18),r.text(e,r.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const i=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];r.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=r.lastAutoTable?r.lastAutoTable.finalY+20:60;r.text("Detalhes das Vendas",20,s),r.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),r.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function ho(e){const t=document.getElementById("genericModal"),a=f(e.client),r=f(e.items),o=f(e.responsavelCaixa||"N/A"),s=(e.payments||[]).map(i=>`
    ...
    `,t.style.display="flex"}function ad(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const r=document.getElementById("paymentSummaryTableBody"),o=Object.entries(t.paymentMethodTotals).sort(([,n],[,l])=>l-n);r.innerHTML=o.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),s.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=ka.transactions[l];d&&ho(d)})}),i.innerHTML=a.map((n,l)=>{const d=f(n.client),c=f(n.items),u=f(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ka.transactions[l];d&&ho(d)})})}async function yo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const r=t.value,o=a.value;if(!r||!o)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,i=await Fr({establishmentId:p.establishmentId,startDate:r,endDate:o,cashierSessionId:s});ka=i,e.innerHTML=`
        ...
        `,ad(i)}catch(s){g("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${f(s.message)}</p>`}}async function od(){ed();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];Kl.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",yo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const r=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${r}_a_${o}`;td(s,"transactionsTable")});try{const r=await Ci(p.establishmentId),o=document.getElementById("cashierSessionFilter");r&&r.length>0&&r.forEach(s=>{const i=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=f(s.closedByName||"N/A");o.innerHTML+=`<option value="${s.id}">${n} - ${i}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await yo()}const sd=document.getElementById("content");let $={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1},St=null,$t=null;function za(e){const t=new Map,a=[];return e&&(e.forEach(r=>t.set(r.id,{...r,children:[]})),t.forEach(r=>{r.parentId&&t.has(r.parentId)?t.get(r.parentId).children.push(r):a.push(r)})),a}function Ls(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,r]=e.split("-"),o=new Date(t,a-1,r),s=String(o.getDate()).padStart(2,"0"),i=o.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:s,month:i,full:o.toLocaleDateString("pt-BR")}}function ne(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function jt(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[r,o,s]=e.split("-");return new Date(r,o-1,s)<a}function rd(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const r=(o,s=0)=>`
        ...
        `;e.innerHTML=t.map(o=>r(o)).join("")}async function Sa(e){const t=document.getElementById("genericModal"),a=e==="nature",r=a?"Plano de Contas (Naturezas)":"Centros de Custo",o=a?Xt:qa,s=a?Yi:Xi,i=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const m=za(u);rd(n,m,e);const v=l.value;l.innerHTML='<option value="">-- Nível Principal --</option>';const b=(x,h=0)=>{const S="  ".repeat(h)+(h>0?"↳ ":"");l.innerHTML+=`<option value="${x.id}">${S}${x.name}</option>`,x.children.forEach(k=>b(k,h+1))};m.forEach(x=>b(x)),l.value=v};try{const u=await o(p.establishmentId);$[i]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const m=t.querySelector("#itemName").value,v=l.value;try{await s({name:m,parentId:v||null,establishmentId:p.establishmentId});const b=await o(p.establishmentId);$[i]=b,d(b),c.reset(),await Ee(),g("Sucesso","Item adicionado ao plano de contas.","success")}catch(b){g("Erro",b.message,"error")}})}async function id(){try{const t=(await We()).matrizes||[];$.establishments=[],t.forEach(a=>{$.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(r=>$.establishments.push({id:r.id,name:r.name,type:"Filial"}))}),$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(p.establishmentId)}catch(e){console.warn("Erro ao buscar lojas",e)}Cs(),Ts(),await Ee()}function Cs(){const e=$.establishments.map(t=>`
    ...
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-100","text-indigo-700"),Ds()}function Ts(){const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",r=>{const o=r.target.checked,s=document.querySelectorAll(".item-checkbox");$.selectedIds.clear(),s.forEach(i=>{i.checked=o,o&&$.selectedIds.add(i.dataset.id)}),qe()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{$.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(r=>r.checked=!1),qe()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const r=$.selectedIds.size;if(r===0)return;if(await U("Excluir Lançamentos",`Deseja realmente apagar ${r} registros financeiros?`))try{const s=$.currentTab==="payables"?"payables":"receivables";await ls(s,Array.from($.selectedIds)),g("Sucesso",`${r} itens excluídos.`,"success"),$.selectedIds.clear(),qe(),Ee()}catch{g("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(r=>{r.addEventListener("change",o=>{const s=o.target.closest("label");o.target.checked?($.filterEstablishmentIds.add(o.target.value),s.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),s.classList.remove("border-gray-200","text-gray-600")):($.filterEstablishmentIds.delete(o.target.value),s.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),s.classList.add("border-gray-200","text-gray-600"))})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const r=document.getElementById("filter-panel"),o=document.getElementById("toggle-filter-btn");$.isAdvancedFilterOpen=!$.isAdvancedFilterOpen,$.isAdvancedFilterOpen?(r.classList.remove("hidden"),o.classList.add("bg-indigo-50","text-indigo-700","border-indigo-300")):(r.classList.add("hidden"),o.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-300"))}),document.getElementById("settings-btn").addEventListener("click",ud),document.querySelectorAll('[data-action="new-financial"]').forEach(r=>{r.addEventListener("click",o=>{na(o.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const r=$.currentTab==="payables"?"payable":"receivable";na(r)});const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t.addEventListener("click",()=>wo("receivables")),a.addEventListener("click",()=>wo("payables")),document.querySelectorAll(".status-filter-btn").forEach(r=>{r.addEventListener("click",o=>{document.querySelectorAll(".status-filter-btn").forEach(s=>{s.classList.remove("bg-gray-800","text-white","shadow-sm"),s.classList.add("bg-gray-100","text-gray-600")}),o.target.classList.add("bg-gray-800","text-white","shadow-sm"),o.target.classList.remove("bg-gray-100","text-gray-600","hover:bg-gray-200","hover:bg-red-100"),$.statusFilter=o.target.dataset.status,Nt(),Bs()})}),document.querySelectorAll(".date-preset-btn").forEach(r=>{r.addEventListener("click",o=>{document.querySelectorAll(".date-preset-btn").forEach(d=>d.classList.remove("bg-indigo-100","text-indigo-700")),o.target.classList.add("bg-indigo-100","text-indigo-700");const s=o.target.dataset.preset,i=new Date;let n,l;s==="month"?(n=new Date(i.getFullYear(),i.getMonth(),1),l=new Date(i.getFullYear(),i.getMonth()+1,0)):s==="last_month"?(n=new Date(i.getFullYear(),i.getMonth()-1,1),l=new Date(i.getFullYear(),i.getMonth(),0)):s==="year"&&(n=new Date(i.getFullYear(),0,1),l=new Date(i.getFullYear(),11,31)),document.getElementById("filterStartDate").value=n.toISOString().split("T")[0],document.getElementById("filterEndDate").value=l.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",r=>{$.searchQuery=r.target.value.toLowerCase(),Nt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const r=new Date;document.getElementById("filterStartDate").value=new Date(r.getFullYear(),r.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(r.getFullYear(),r.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",$.filterEstablishmentIds.clear(),$.filterEstablishmentIds.add(p.establishmentId),Cs(),Ts()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{$.startDate=document.getElementById("filterStartDate").value,$.endDate=document.getElementById("filterEndDate").value,$.filterNaturezaId=document.getElementById("filterNaturezaId").value,$.filterCostCenterId=document.getElementById("filterCostCenterId").value,$.filterEstablishmentIds.size===0&&$.filterEstablishmentIds.add(p.establishmentId),document.getElementById("toggle-filter-btn").click(),Ee()}),St&&document.body.removeEventListener("click",St),St=r=>{const o=r.target;if(o.classList.contains("item-checkbox")||o.classList.contains("modal-item-checkbox")){const n=o.value||o.dataset.id;o.checked?$.selectedIds.add(n):$.selectedIds.delete(n),qe(),r.stopPropagation();return}const s=o.closest("button[data-action]");if(s){const{action:n,type:l,id:d}=s.dataset;if(r.stopPropagation(),n==="delete"){const c=s.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");ld(l,JSON.parse(c));return}if(n==="mark-as-paid"){nd(l,d);return}if(n==="manage-natures"){Sa("nature");return}if(n==="manage-cost-centers"){Sa("cost-center");return}}const i=o.closest(".financial-row");if(i&&document.getElementById("list-container").contains(i)&&!o.closest("button")&&!o.closest(".item-checkbox")){const{type:n}=i.dataset,l=JSON.parse(i.dataset.item.replace(/&apos;/g,"'"));na(n,l)}},document.body.addEventListener("click",St),$t&&document.getElementById("genericModal").removeEventListener("click",$t),$t=r=>{if(r.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const s=r.target.closest('button[data-action^="delete-"]');if(s){const i=s.dataset.action.split("-")[1];cd(i,s.dataset.id)}},document.getElementById("genericModal").addEventListener("click",$t)}function qe(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),r=$.selectedIds.size;t.textContent=r,r>0?(e.classList.remove("hidden"),e.classList.add("flex"),a&&a.classList.add("hidden")):(e.classList.add("hidden"),e.classList.remove("flex"),a&&a.classList.remove("hidden"))}function wo(e){$.currentTab=e,$.selectedIds.clear(),qe(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),r=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-emerald-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),r&&(r.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-emerald-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-emerald-700","shadow-sm"),t.classList.add("text-gray-500"),r&&(r.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")),Nt()}async function Ee(){const e=document.getElementById("list-container");e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A processar transações...</p></div>';try{if($.natures.length===0){const[s,i]=await Promise.all([Xt(p.establishmentId),qa(p.establishmentId)]);$.natures=s,$.costCenters=i,Ds()}const t=Array.from($.filterEstablishmentIds).join(","),a={startDate:$.startDate,endDate:$.endDate,establishmentId:t};$.filterNaturezaId!=="all"&&(a.natureId=$.filterNaturezaId),$.filterCostCenterId!=="all"&&(a.costCenterId=$.filterCostCenterId);const[r,o]=await Promise.all([cs(a),us(a)]);$.payables=r.entries||[],$.receivables=o.entries||[],Bs(),Nt()}catch(t){e.innerHTML=`
            ...
            </div>`}}function Ds(){const e=r=>{let o='<option value="all">-- Todas as opções --</option>';const s=za(r),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");o+=`<option value="${n.id}">${d}${n.name}</option>`,n.children.forEach(c=>i(c,l+1))};return s.forEach(n=>i(n)),o},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e($.natures)),a&&(a.innerHTML=e($.costCenters))}function Bs(){const e=document.getElementById("summary-section");if(!e)return;const t=$.currentTab==="receivables";let r=t?$.receivables:$.payables;$.searchQuery&&(r=r.filter(c=>c.description&&c.description.toLowerCase().includes($.searchQuery)||c.entity&&c.entity.toLowerCase().includes($.searchQuery)||c.notes&&c.notes.toLowerCase().includes($.searchQuery)));const o=r.reduce((c,u)=>c+u.amount,0),s=r.filter(c=>c.status==="paid").reduce((c,u)=>c+u.amount,0),i=r.filter(c=>c.status==="pending"&&!jt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),n=r.filter(c=>jt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),l=t?"emerald":"red",d=t?"Receitas":"Despesas";e.innerHTML=`
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
            ...
            <p class="text-2xl font-black text-gray-900">${ne(o)}</p>
        </div>
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
        ...
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
            ...
            <p class="text-xl font-bold text-${l}-600">${ne(s)}</p>
        </div>
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-center relative overflow-hidden">
    ...
    `}function Nt(){const e=document.getElementById("list-container");if(!e)return;const t=$.currentTab==="receivables",a=t?$.receivables:$.payables;let r=a;if($.statusFilter!=="all"&&(r=a.filter(l=>{const d=jt(l.dueDate,l.status);return $.statusFilter==="overdue"?d:$.statusFilter==="pending"?l.status==="pending"&&!d:l.status===$.statusFilter})),$.searchQuery&&(r=r.filter(l=>l.description&&l.description.toLowerCase().includes($.searchQuery)||l.entity&&l.entity.toLowerCase().includes($.searchQuery)||l.notes&&l.notes.toLowerCase().includes($.searchQuery))),r.sort((l,d)=>new Date(l.dueDate)-new Date(d.dueDate)),r.length===0){e.innerHTML=`
        ...
        `;return}const o=new Map($.natures.map(l=>[l.id,l.name])),s=new Map($.establishments.map(l=>[l.id,l])),i=t?"receivable":"payable",n=t?"text-emerald-600":"text-red-600";e.innerHTML=r.map(l=>{const d=Ls(l.dueDate),c=l.status==="paid",u=jt(l.dueDate,l.status);let m="";c?m='<span class="bg-gray-100 text-gray-600 border border-gray-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-check2-circle mr-1"></i>Baixado</span>':u?m='<span class="bg-red-50 text-red-600 border border-red-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-exclamation-circle mr-1"></i>Atrasado</span>':m='<span class="bg-blue-50 text-blue-600 border border-blue-200 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wide"><i class="bi bi-clock-history mr-1"></i>A Vencer</span>';const v=l.naturezaId?o.get(l.naturezaId)||"Não Categorizado":"Geral",b=s.get(l.establishmentId);let x="";if(b){const L=b.type==="Matriz"?"bi-building":"bi-shop";x=`<span class="text-[9px] px-1.5 py-0.5 rounded bg-slate-100 text-slate-600 font-bold border border-slate-200 flex items-center whitespace-nowrap w-max" title="Unidade: ${b.name}"><i class="bi ${L} mr-1 opacity-60"></i> ${b.name}</span>`}else x='<span class="text-[9px] px-1.5 py-0.5 rounded bg-gray-100 text-gray-600 font-bold border border-gray-200 flex items-center whitespace-nowrap w-max"><i class="bi bi-geo-alt mr-1 opacity-60"></i> Atual</span>';const h=JSON.stringify(l).replace(/'/g,"&apos;"),S=$.selectedIds.has(l.id),E=!!l.recurrenceId?'<i class="bi bi-arrow-repeat text-indigo-400 ml-1.5 text-xs" title="Lançamento Recorrente"></i>':"",D=l.entity?`<span class="text-xs text-gray-500 font-medium truncate block"><i class="bi bi-person mr-1 opacity-50"></i>${l.entity}</span>`:"";return`
        <div class="financial-row md:grid md:grid-cols-12 md:gap-4 md:items-center bg-white p-4 md:p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer relative group flex flex-col gap-3 ${S?"bg-indigo-50/30":""}"
             data-type="${i}"
             data-item='${h}'>
            ...
            <div class="absolute right-4 top-4 md:relative md:right-auto md:top-auto md:col-span-1 md:flex md:justify-center z-10">
                <input type="checkbox" value="${l.id}" class="item-checkbox w-5 h-5 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 cursor-pointer shadow-sm" ${S?"checked":""}>
            </div>
        ...
        `}).join("")}async function nd(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?an(t,a):nn(t,a)),g("Baixa Realizada","O lançamento foi registado como pago.","success"),await Ee()}catch(r){g("Erro",r.message,"error")}}async function ld(e,t){if(!!!t.recurrenceId){await U("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Ps(e,[t.id]);return}dd(e,t)}function dd(e,t){const a=document.getElementById("genericModal"),o=(e==="payable"?$.payables:$.receivables).filter(d=>d.recurrenceId===t.recurrenceId).sort((d,c)=>new Date(d.dueDate)-new Date(c.dueDate));a.innerHTML=`
    ...
    `,a.style.display="flex";const s=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");s.addEventListener("change",d=>{i.forEach(c=>c.checked=d.target.checked),l()}),i.forEach(d=>d.addEventListener("change",l));function l(){const d=Array.from(i).filter(c=>c.checked).length;n.innerHTML=d>0?`<i class="bi bi-trash3"></i> Excluir ${d} Parcela(s)`:"Selecione para excluir",n.disabled=d===0,d===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const d=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(d.length===0)return;a.style.display="none",await U("Confirmar Ação",`Tem certeza que deseja apagar estas ${d.length} parcelas permanentemente?`)&&await Ps(e,d)}),l()}async function Ps(e,t){try{t.length===1?e==="payable"?await tn(t[0]):await rn(t[0]):await ls(e==="payable"?"payables":"receivables",t),g("Sucesso",`${t.length} registo(s) limpo(s) do sistema.`,"success"),$.selectedIds.clear(),qe(),await Ee()}catch(a){g("Erro",a.message,"error")}}async function cd(e,t){const r=e==="nature"?Qi:Zi;if(await U("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await r(t),Sa(e==="nature"?"nature":"cost-center")}catch(s){g("Erro",s.message,"error")}}function ud(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function na(e,t=null){const a=document.getElementById("genericModal"),r=e==="payable",o=r?"red":"emerald",s=t?"Editar Lançamento":"Novo Lançamento",i=$.establishments.map(L=>{const A=t?t.establishmentId===L.id:L.id===p.establishmentId;return`<option value="${L.id}" ${A?"selected":""}>${L.type==="Matriz"?"🏢":"📍"} ${L.name}</option>`}).join(""),n=(L,A)=>{let N='<option value="">-- Selecione --</option>';const T=za(L),M=(q,H=0)=>{const O="  ".repeat(H)+(H>0?"↳ ":""),R=q.id===A?"selected":"";N+=`<option value="${q.id}" ${R}>${O}${q.name}</option>`,q.children.forEach(W=>M(W,H+1))};return T.forEach(q=>M(q)),N},d=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(L=>`<option value="${L.value}" ${t?.paymentMethod===L.value?"selected":""}>${L.label}</option>`).join("");a.innerHTML=`
        ...
        </div>`,a.style.display="flex";const c=a.querySelector("#financial-form");let u="single",m=2;const v=c.querySelector('[name="amount"]'),b=c.querySelector("#recurrence-options"),x=c.querySelector("#recurrence-summary"),h=c.querySelector("#installments-input"),S=c.querySelector("#status-toggle"),k=c.querySelector("#payment-date-wrapper"),E=c.querySelector('[name="paymentDate"]'),D=()=>{if(u==="single")return;const L=parseFloat(v.value)||0;if(m=parseInt(h.value)||2,L===0){x.innerHTML='<span class="text-xs text-indigo-400 font-medium">Digite o valor total...</span>';return}if(u==="installment"){const A=L/m;x.innerHTML=`
                <div>
                    <span class="block text-[10px] text-indigo-400 uppercase tracking-widest font-bold mb-1">Simulação do Parcelamento</span>
                    <span class="font-black text-lg text-indigo-700 block leading-tight">${m}x de ${ne(A)}</span>
                    <span class="text-xs text-indigo-500 font-medium">Total: ${ne(L)}</span>
                </div>
            `}else if(u==="repeat"){const A=L*m;x.innerHTML=`
                <div>
                    <span class="block text-[10px] text-indigo-400 uppercase tracking-widest font-bold mb-1">Geração Recorrente Fixa</span>
                    <span class="font-black text-lg text-indigo-700 block leading-tight">${m}x de ${ne(L)}</span>
                    <span class="text-xs text-indigo-500 font-medium">Lançamento Total: ${ne(A)}</span>
                </div>
            `}};t||a.querySelectorAll(".mode-btn").forEach(L=>{L.addEventListener("click",A=>{if(a.querySelectorAll(".mode-btn").forEach(N=>{N.classList.remove("bg-gray-900","text-white","shadow-sm"),N.classList.add("text-gray-500","hover:bg-gray-100")}),A.target.classList.add("bg-gray-900","text-white","shadow-sm"),A.target.classList.remove("text-gray-500","hover:bg-gray-100"),u=A.target.dataset.mode,u==="single")b.classList.add("hidden");else{b.classList.remove("hidden");const N=b.querySelector("label");N.textContent=u==="installment"?"Número de Parcelas":"Repetir por quantos meses?",D()}})}),v.addEventListener("input",D),h&&(h.addEventListener("input",D),c.querySelector("#btn-minus").addEventListener("click",()=>{let L=parseInt(h.value)||2;L>2&&(h.value=L-1,D())}),c.querySelector("#btn-plus").addEventListener("click",()=>{let L=parseInt(h.value)||2;L<60&&(h.value=L+1,D())})),S.addEventListener("change",()=>{S.checked?(k.classList.remove("hidden"),E.required=!0):(k.classList.add("hidden"),E.required=!1)}),c.addEventListener("submit",async L=>{L.preventDefault();const A=c.querySelector('button[type="submit"]'),N=A.innerHTML;A.disabled=!0,A.innerHTML='<div class="loader-small border-white"></div> A gravar...';const T=new FormData(c),M=S.checked,q=parseFloat(T.get("amount"));let H=q,O=1;!t&&u!=="single"&&(O=parseInt(T.get("installments")),u==="repeat"&&(H=q*O));const R={establishmentId:T.get("establishmentId"),description:T.get("description"),amount:H,dueDate:T.get("dueDate"),naturezaId:T.get("naturezaId")||null,centroDeCustoId:T.get("centroDeCustoId")||null,entity:T.get("entity")||null,paymentMethod:T.get("paymentMethod")||null,documentNumber:T.get("documentNumber")||null,notes:T.get("notes"),status:M?"paid":"pending",paymentDate:M?T.get("paymentDate"):null,installments:O};O>1&&!t&&(R.recurrenceId=self.crypto.randomUUID());try{t?(await(r?en(t.id,R):sn(t.id,R)),g("Sucesso","Atualizado com sucesso!","success")):(await(r?Ki(R):on(R)),g("Sucesso","Lançamento criado!","success")),document.getElementById("genericModal").style.display="none",Ee()}catch(W){g("Erro",W.message||"Erro ao salvar","error"),A.disabled=!1,A.innerHTML=N}})}const pd=e=>I("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),md=e=>I("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),gd=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return I(`/api/commissions/stats?${a}`)},bd=(e={})=>{Object.keys(e).forEach(r=>(e[r]===void 0||e[r]===null||e[r]==="")&&delete e[r]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return I(a)},fd=e=>I(`/api/commissions/report/${e}`,{method:"DELETE"}),Ft=new Date,ko=new Date(Ft.getFullYear(),Ft.getMonth(),1),j={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:ko.toISOString().split("T")[0],dashEndDate:Ft.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:ko.toISOString().split("T")[0],histEndDate:Ft.toISOString().split("T")[0],histProfessionalId:"all"};let Et=null;const et=document.getElementById("content");async function xd(){try{j.professionals=await re(p.establishmentId)}catch(e){console.error("Erro profissionais",e)}Cd(),vd(),ea(),Ot("dashboard")}function vd(){Et&&et.removeEventListener("click",Et),Et=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,r=t.dataset.id,o=t.dataset.idx;switch(a){case"tab-nav":Ot(t.dataset.tab);break;case"toggle-all-profs":hd();break;case"back-to-filters":j.calculationResult=null,Ht(document.getElementById("commissions-content"));break;case"view-preview-items":Ld(o);break;case"save-final-report":wd();break;case"start-new-calc":Ot("calculator");break;case"print-receipt":kd(r);break;case"delete-report":Sd(r);break;case"filter-dashboard":ea();break;case"filter-history":Va();break}},et.addEventListener("click",Et),et.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Ed(t)}},et.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),yd())}}async function ea(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(j.dashStartDate=e.value),t&&(j.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const r=await gd(j.dashStartDate,j.dashEndDate);j.dashStats={revenue:r.totalRevenue||0,commissions:r.totalCommissionsPaid||0},j.currentTab==="dashboard"&&Ms(document.getElementById("commissions-content"))}catch(r){console.error(r),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Va(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(j.histStartDate=e.value),t&&(j.histEndDate=t.value),a&&(j.histProfessionalId=a.value);const r=document.getElementById("history-list-container");if(r){r.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const o=await bd({startDate:j.histStartDate,endDate:j.histEndDate,professionalId:j.histProfessionalId});j.historyData=o,As(r,o)}catch{r.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function hd(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function yd(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),r=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");j.periodString=`${a} a ${r}`;const o=document.getElementById("commissions-content");o.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await pd(t);j.calculationResult=s.map(i=>({...i,extraDebit:0,extraCredit:0,finalValue:i.summary.totalCommission,notes:""})),Ht(o)}catch(s){g("Erro",s.message,"error"),j.calculationResult=null,Ht(o)}}async function wd(){const e=j.calculationResult.length;if(await U("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=j.calculationResult.map(r=>{const o=r.items.map(s=>s.originalSaleId).filter(s=>s!=null);return md({professionalId:r.professionalId,professionalName:r.professionalName,period:j.periodString,processedSalesIds:o,reportData:{...r,summary:{...r.summary,finalValue:r.finalValue,extraDebit:r.extraDebit||0,extraCredit:r.extraCredit||0,notes:r.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),j.calculationResult=null,ea(),Ot("history")}catch(a){g("Erro",a.message,"error")}}function kd(e){const t=j.historyData.find(a=>a.id===e);t&&$d(t)}async function Sd(e){if(await U("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await fd(e),g("Sucesso","Registro removido.","success"),Va(),ea()}catch(a){g("Erro",a.message,"error")}}function $d(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,r=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",r,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const o=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&o.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&o.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:o,theme:"grid"});const s=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Ed(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let r=0,o=0;if(t.forEach(s=>{s.value&&(r=parseFloat(s.value))}),a.forEach(s=>{s.value&&(o=parseFloat(s.value))}),j.calculationResult&&j.calculationResult[e]){const s=j.calculationResult[e];s.extraDebit=r,s.extraCredit=o,s.finalValue=s.summary.totalCommission-r+o,t.forEach(n=>{n!==document.activeElement&&(n.value=r||"")}),a.forEach(n=>{n!==document.activeElement&&(n.value=o||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(n=>n.innerText=`R$ ${s.finalValue.toFixed(2)}`),Id()}}function Id(){const e=j.calculationResult.reduce((a,r)=>a+r.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function Ld(e){const t=j.calculationResult[e];if(!t)return;const a=t.items.map(r=>`
    ...
    `}function Td(e){const t=j.professionals.map(a=>`<option value="${a.id}" ${j.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,j.historyData.length>0?As(document.getElementById("history-list-container"),j.historyData):Va()}function As(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const la=document.getElementById("content");let ke={allPackages:[],catalogForModal:{services:[],products:[]}},It=null,Re=null;function Dd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Bd(){const e=document.getElementById("packagesListContainer");if(e){if(ke.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=ke.allPackages.map(t=>{const a=t.status==="active",r=JSON.stringify(t).replace(/'/g,"&apos;"),o=t.price||0,s=t.originalPrice||0,i=s>o?s-o:0,n=s>0?(s-o)/s*100:0,l=f(t.name),d=f(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function So(){const e=document.getElementById("genericModal");e.style.display="none",Re&&e.removeEventListener("click",Re)}async function $o(e=null){const t=document.getElementById("genericModal"),a=!!e,r=e?JSON.parse(JSON.stringify(e.items||[])):[],o=f(e?.name||""),s=f(e?.description||""),i=e?.price||"",n=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(v,b)=>{const x=b.querySelector("#originalPrice"),h=v.reduce((S,k)=>S+k.price*k.quantity,0);x&&(x.textContent=`R$ ${h.toFixed(2)}`)},m=v=>{v.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=v.map((b,x)=>{const h=b.type==="service",S=h?"Serviço":"Produto",k=h?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <span class="text-xs font-medium px-2 py-0.5 rounded-full ${k}">${S}</span>
            ...
            `}).join(""),u(v,t)};m(r),c.addEventListener("change",v=>{if(v.target.classList.contains("quantity-input")){const b=parseInt(v.target.dataset.index,10),x=parseInt(v.target.value,10);x>0&&r[b]&&(r[b].quantity=x,m(r))}}),c.addEventListener("click",v=>{if(v.target.classList.contains("remove-item-btn")){const b=parseInt(v.target.dataset.index,10);r.splice(b,1),m(r)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Pd(v=>{const b=r.find(x=>x.id===v.id&&x.type===v.type);b?b.quantity++:r.push({...v,quantity:1}),m(r)}),Re&&t.removeEventListener("click",Re),Re=async v=>{const b=v.target.closest("button[data-action]");if(!b)return;const x=b.dataset.action;if(v.stopPropagation(),x==="close-modal"&&So(),x==="save-package"){const h=b,S={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:r,originalPrice:r.reduce((k,E)=>k+E.price*E.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:p.establishmentId};if(!S.name||!S.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(S.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}h.disabled=!0,h.textContent="A salvar...";try{a?await Bi(S.id,S):(delete S.id,await Di(S)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),So(),await Ua()}catch(k){g("Erro",`Não foi possível salvar o pacote: ${k.message}`,"error"),h.disabled=!1,h.textContent="Salvar Pacote"}}},t.addEventListener("click",Re)}function Pd(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const r={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},o=l=>{const d=t.toLowerCase(),c=ke.catalogForModal.services.filter(b=>b.name.toLowerCase().includes(d)),u=ke.catalogForModal.products.filter(b=>b.name.toLowerCase().includes(d)),m=c.map(b=>`
    ...
    `,document.body.appendChild(a);const s=a.querySelector("#item-selection-list"),i=a.querySelector("#item-search-input"),n=()=>{a.remove()};o(s),i.addEventListener("input",()=>{t=i.value,o(s)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:m}=d.dataset,b=(ke.catalogForModal[u+"s"]||[]).find(x=>x.id===m);b&&(e({...b,type:u}),n())}else(c||l.target===a)&&n()})}async function Ua(){la.innerHTML=`
    ...
    `,It&&la.removeEventListener("click",It),It=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const r=e.target.closest('[data-action="delete-package"]');if(r){const o=r.dataset.id;U("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await Pi(o),g("Sucesso!","Pacote excluído.","success"),await Ua()}catch(i){g("Erro",`Não foi possível excluir: ${i.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")$o(null);else if(a==="edit-package"){const r=JSON.parse(t.dataset.package);$o(r)}},la.addEventListener("click",It);try{const[e,t,a]=await Promise.all([Aa(p.establishmentId),Ie(p.establishmentId),Yt(p.establishmentId)]);ke.allPackages=e,ke.catalogForModal={services:t.filter(r=>r.active),products:a},Bd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Md=document.getElementById("content");let Ad=null;async function qd(){const e=f(p.userName||"Usuário"),t=f(oe.currentUser?.email||"E-mail não disponível"),a=p.userName?p.userName.charAt(0):"U";Md.innerHTML=`
    ...
    `,await Rd()}async function Rd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await ti(t);Ad=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const r=f(a.name);e.innerHTML=`
            ...
            `,jd(a.id),document.getElementById("my-blocks-filter").addEventListener("change",s=>zt(a.id,s.target.value)),zt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function jd(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const r=t.querySelector("#blockDate").value,o=t.querySelector("#blockStartTime").value,s=t.querySelector("#blockEndTime").value,i=t.querySelector("#blockReason").value;if(!r||!o||!s){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(o>=s){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const n=new Date(`${r}T${o}:00`),l=new Date(`${r}T${s}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Jt({establishmentId:p.establishmentId,professionalId:e,reason:i||"Bloqueado (Meu Perfil)",startTime:n.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;zt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),g("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function zt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const r=new Date;let o,s;t==="history"?(s=new Date,o=new Date,o.setFullYear(o.getFullYear()-1)):(o=new Date,s=new Date,s.setFullYear(s.getFullYear()+1));let n=(await Wt(p.establishmentId,o.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?n=n.filter(l=>l.endTime<r).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=r).sort((l,d)=>l.startTime-d.startTime),n.length>0?(a.innerHTML=n.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,m=f(l.reason||"Sem motivo");return`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const o=(await We()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),o.length===0)t.innerHTML=`
            ...
            `;else{let s="";o.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';s+=`
                ...
                `}),t.innerHTML=s}Eo||(Nd(),Eo=!0)}catch(r){console.error("Erro na renderização da rede:",r),t.innerHTML=`
        ...
        `}}function Nd(){const e=document.getElementById("form-create-establishment");e&&e.addEventListener("submit",async t=>{t.preventDefault();const a=e.querySelector('button[type="submit"]'),r=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const o={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const s=await xr(o);alert(s.message||"Sucesso!"),e.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await Vt(document.getElementById("content"))}catch(s){console.error("Erro ao criar estabelecimento:",s),alert("Erro: "+(s.message||"Falha ao gravar dados."))}finally{a.innerHTML=r,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>Vt(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const te=document.getElementById("loadingScreen"),Ze=document.getElementById("dashboardContent"),je=document.getElementById("content"),da=document.getElementById("notificationBell"),Lt=document.getElementById("notificationBadge"),Be=document.getElementById("notificationPanel"),ca=document.getElementById("notificationList"),Ke=document.getElementById("profileMenuButton"),K=document.getElementById("profileDropdown"),Io=document.getElementById("profileName"),Lo=document.getElementById("profileEmail"),Co=document.getElementById("logoutButton"),To=document.getElementById("myProfileLink"),Do=document.getElementById("hamburger-menu-btn"),Z=document.getElementById("sidebar"),ae=document.getElementById("mobile-overlay"),Bo=document.getElementById("themeToggleBtn"),ua=document.getElementById("themeIcon"),$a=document.getElementById("mobile-bottom-nav"),_e=document.getElementById("nav-scroll"),Po=document.getElementById("scroll-hint-left"),Mo=document.getElementById("scroll-hint-right"),Fd=document.querySelectorAll(".bottom-nav-item");function Ea(){if(!_e||!Po||!Mo)return;const{scrollLeft:e,scrollWidth:t,clientWidth:a}=_e;Po.classList.toggle("visible",e>5),Mo.classList.toggle("visible",e+a<t-5)}function Hd(){if(!_e)return;const e=document.querySelector(".bottom-nav-item.active");if(!e)return;const t=_e,a=t.getBoundingClientRect(),r=e.getBoundingClientRect(),s=r.left+r.width/2-a.left-a.width/2;t.scrollBy({left:s,behavior:"smooth"})}const Od={"dashboard-section":Wr,"agenda-section":es,"comandas-section":Gi,"relatorios-section":cn,"servicos-section":Pn,"produtos-section":Un,"suppliers-section":_n,"profissionais-section":qt,"clientes-section":kl,"estabelecimento-section":e=>Is(e),"ausencias-section":Hl,"users-section":Rt,"sales-report-section":od,"financial-section":id,"commissions-section":xd,"packages-section":Ua,"my-profile-section":qd,"hierarquia-section":()=>Vt(je),"establishments-section":()=>Vt(je)},Ao={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#eef2ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#eff6ff",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#1f2937"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#64748b",hover:"#475569",light:"#f1f5f9",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};function qo(e){const t=Ao[e]||Ao.indigo,r=(s=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const o=document.getElementById("dynamic-theme-styles");o&&(o.innerHTML=`
            :root {
        ...
        `)}function Bt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("kairos_theme",e),ua&&(e==="dark"?ua.innerHTML="☀️":ua.innerHTML="🌙")}function zd(){const e=localStorage.getItem("kairos_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;Bt(e||(t?"dark":"light"))}let dt=null,ct=[];function qs(){if(!Lt||!ca)return;const e=ct.filter(t=>!t.read).length;if(e>0?(Lt.textContent=e,Lt.classList.remove("hidden")):Lt.classList.add("hidden"),ct.length===0){ca.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}ca.innerHTML=ct.map(t=>`
    ...
    `).join("")}function Vd(e){dt&&dt();const t=Ut(pe,"establishments",e,"notifications"),a=No(t,Fo("timestamp",">=",new Date),Qs("timestamp","desc"));dt=Xs(a,r=>{r.docChanges().forEach(o=>{if(o.type==="added"){const s=o.doc.data();ct.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(s.title,s.message,"info",!0),qs();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&es()}})},r=>{console.error("Erro no listener de notificações:",r)})}async function Ud(e){const t=document.getElementById("global-context-switcher"),a=t?.parentElement;if(!(!t||!a))try{const o=(await We()).matrizes||[];let s="",i=0;if(o.forEach(n=>{s+=`<option value="${n.id}" class="font-bold">🏢 ${n.name}</option>`,i++,n.branches&&n.branches.length>0&&n.branches.forEach(l=>{s+=`<option value="${l.id}">&nbsp;&nbsp;&nbsp;📍 ${l.name}</option>`,i++})}),i>0){t.innerHTML=s,a.classList.remove("hidden"),a.classList.add("flex");let n=e;Array.from(t.options).some(u=>u.value===e)||(n=t.options[0].value),t.value=n;const l=t.cloneNode(!0);t.parentNode.replaceChild(l,t);const d=async(u,m,v=!1)=>{te&&!v&&(te.classList.remove("hidden","fade-out"),te.style.display="flex");try{const b=await Se(u);if(p.establishmentId=u,p.establishmentName=m,p.enabledModules=b.modules,p.currentViewContext={id:u,name:m,type:b.parentId?"BRANCH":"GROUP"},typeof qo=="function"&&qo(b.themeColor||"indigo"),Vd(u),_d(p.userPermissions),!v){g("Unidade Alterada",`Agora a gerir: ${m}`,"info");const x=document.querySelector(".sidebar-link.active"),h=x?x.getAttribute("data-target"):"dashboard-section";_(h)}}catch(b){console.error("Erro ao trocar de contexto:",b),v||g("Erro","Falha ao aceder aos dados desta unidade.","error")}finally{te&&!v&&(te.classList.add("fade-out"),setTimeout(()=>{te.style.display="none"},500))}},c=l.options[l.selectedIndex].text.replace(/🏢 |📍 |&nbsp;/g,"").trim();await d(n,c,!0),l.addEventListener("change",async u=>{const m=u.target.value,v=u.target.options[u.target.selectedIndex].text.replace(/🏢 |📍 |&nbsp;/g,"").trim();await d(m,v,!1)})}else a.classList.add("hidden"),a.classList.remove("flex")}catch(r){console.error("Erro ao carregar switcher de contexto:",r),a.classList.add("hidden")}}function _(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const o=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(e),s=p.enabledModules?.[a]!==!1,i=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!o&&(!s||!i)){je&&(je.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),Z&&Z.classList.contains("absolute")&&(Z.classList.add("hidden"),ae&&ae.classList.add("hidden"));return}}const r=Od[e];r&&je&&(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),$a&&(Fd.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),setTimeout(Hd,50),setTimeout(Ea,100)),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),je.innerHTML="",window.innerWidth<768&&Z&&(Z.classList.add("hidden"),ae&&ae.classList.add("hidden")),r(t))}window.navigateTo=_;async function _d(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),r=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,i=e===null||e["financial-section"]?.view===!0;if(s&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!s&&!i))try{const n=await Hr();s&&r&&(r.textContent=n.todayAppointments.toString()),i&&o&&(o.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch(n){console.error("Erro ao carregar KPIs do cabeçalho:",n)}}async function Wd(e){try{le.getPlatform()==="android"&&await X.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0});let t=await X.checkPermissions();if(t.receive==="prompt"&&(t=await X.requestPermissions()),t.receive!=="granted")return;await X.register(),X.addListener("registration",async a=>{try{const r=gt(pe,"users",e);await Ia(r,{fcmTokens:Ys(a.value),platform:"native_mobile"})}catch{}}),X.addListener("pushNotificationReceived",a=>g(a.title,a.body,"info",!0)),X.addListener("pushNotificationActionPerformed",()=>_("agenda-section"))}catch{}}function Jd(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),r=()=>e&&(e.style.display="block"),o=()=>e&&(e.style.display="none"),s=()=>e&&e.style.display==="block";e&&(t.addEventListener("click",()=>{o(),le.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{o(),le.isNativePlatform()?Qa.exitApp():history.back()}),le.isNativePlatform()?Qa.addListener("backButton",()=>{if(s())o();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(Z&&!Z.classList.contains("hidden")&&window.innerWidth<768){Z.classList.add("hidden"),ae&&ae.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?r():_("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(s()){o(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?r():(_("dashboard-section"),history.pushState(null,document.title,location.href))})))}async function Gd(){try{await zs(oe,Vs)}catch{}le.isNativePlatform()&&document.body.classList.add("is-app-native"),cr(),Jd(),zd(),Bo&&Bo.addEventListener("click",e=>{e.preventDefault();const t=document.documentElement.getAttribute("data-theme");Bt(t==="dark"?"light":"dark")}),Do&&Do.addEventListener("click",e=>{e.stopPropagation(),Z&&(Z.classList.remove("hidden"),Z.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),ae&&ae.classList.remove("hidden")}),$a&&($a.addEventListener("click",e=>{const t=e.target.closest(".bottom-nav-item");if(!t)return;e.preventDefault();const a=t.getAttribute("data-target");_(a)}),_e&&_e.addEventListener("scroll",Ea),Ea()),ae&&ae.addEventListener("click",()=>{Z&&(Z.classList.add("hidden"),Z.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),ae.classList.add("hidden")}),da&&da.addEventListener("click",e=>{e.stopPropagation(),Be&&(Be.classList.toggle("hidden"),Be.classList.contains("hidden")||(ct.forEach(t=>t.read=!0),qs()))}),Ke&&Ke.addEventListener("click",e=>{e.stopPropagation(),K&&(K.classList.toggle("active"),K.classList.contains("active")?K.classList.remove("hidden"):setTimeout(()=>K.classList.add("hidden"),200))}),To&&To.addEventListener("click",e=>{e.preventDefault(),_("my-profile-section"),K&&(K.classList.remove("active"),K.classList.add("hidden"))}),document.addEventListener("click",e=>{Be&&!Be.contains(e.target)&&e.target!==da&&Be.classList.add("hidden"),K&&!K.contains(e.target)&&e.target!==Ke&&K.classList.contains("active")&&(K.classList.remove("active"),setTimeout(()=>K.classList.add("hidden"),200))}),Us(oe,async e=>{if(e){if(!le.isNativePlatform()&&(qr(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");t&&setTimeout(()=>{t.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Rr()&&t&&(t.style.display="none")});const r=()=>{t&&(t.style.display="none")},o=document.getElementById("btn-deny-toast"),s=document.getElementById("btn-close-toast");o&&o.addEventListener("click",r),s&&s.addEventListener("click",r)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){const r=await Se(a.establishmentId);let o=null,s=e.displayName,i=null;const n=gt(pe,"users",e.uid),l=await Ro(n);if(l.exists()){const c=l.data();o=a.role==="employee"?c.permissions||{}:null,s=c.name||s,i=c.professionalId||null}p.userProfessionalId=i,le.isNativePlatform()&&Wd(e.uid);const d=s||e.email;er(a.establishmentId,r.name,o),Ke&&(Ke.textContent=d.charAt(0).toUpperCase()),Io&&(Io.textContent=d),Lo&&(Lo.textContent=e.email),Co&&Co.addEventListener("click",c=>{c.preventDefault(),dt&&dt(),_s(oe).then(()=>window.location.href="/login.html")}),await Ud(a.establishmentId),fr(_,o,p.enabledModules),te&&(te.classList.add("fade-out"),setTimeout(()=>{te.style.display="none"},500)),Ze&&(Ze.style.display="flex"),setTimeout(()=>{wr()},1500),_("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(t){console.error("Erro na inicialização:",t),te&&(te.style.display="none"),Ze&&(Ze.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><h2>Erro de Acesso</h2><p>${t.message}</p></div>`,Ze.style.display="flex")}}else window.location.href="/login.html"})}Gd();export{zo as W};
