...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${s}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${s}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${la}. Verifique se o servidor backend está rodando.`):n}}const Ro=(e,t,a,o=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(r+=`&professionalId=${o}`),w(r)},Js=(e,t,a)=>{const o=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return w(o)},Ws=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return w(r)},Gs=e=>w("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Fo=(e,t)=>w(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ua=e=>w(`/api/appointments/${e}`,{method:"DELETE"}),Ys=e=>w(`/api/appointments/${e}/reopen`,{method:"POST"}),Qs=(e,t)=>w(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let _;async function Xs(){if(!_)try{_=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Zs(){if(!_){console.warn("AudioContext não inicializado. O som não será tocado.");return}_.state==="suspended"&&_.resume();const e=_.createOscillator(),t=_.createGain();e.connect(t),t.connect(_.destination),e.type="sine",e.frequency.setValueAtTime(800,_.currentTime),t.gain.setValueAtTime(0,_.currentTime),t.gain.linearRampToValueAtTime(.3,_.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,_.currentTime+.2),e.start(_.currentTime),e.stop(_.currentTime+.2)}function p(e,t,a="info",o=!1){const r=document.getElementById("toast-container");if(!r)return;o&&Zs();const s=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${n[a]||n.info}`,s.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{de&&de.remove(),window.location.reload()}}async function yr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),o=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),s=Object.fromEntries(r.entries());try{if(e==="company_data")await St(u.establishmentId,{name:s.name,phone:s.phone,email:s.email,address:s.address,zipCode:s.zipCode});else if(e==="branding"){const n={};s.logoBase64&&(n.logo=s.logoBase64),s.bgBase64&&(n.backgroundImage=s.bgBase64),s.themeColor&&(n.themeColor=s.themeColor),s.primaryColor&&(n.primaryColor=s.primaryColor),Object.keys(n).length>0&&await St(u.establishmentId,n)}else if(e==="time_config"){const n=parseInt(s.slotInterval);await St(u.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Oo({establishmentId:u.establishmentId,name:s.name,price:parseFloat(s.price),duration:parseInt(s.duration),active:!0});n&&Tt.push(n)}else if(e==="first_prof"){const n=await jo({establishmentId:u.establishmentId,name:s.name,specialty:s.role,active:!0,commissionRate:0});if(s.serviceId&&n&&n.id)try{Ga?await Ga(n.id,[s.serviceId]):Lt&&await Lt(n.id,{services:[s.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await zo({establishmentId:u.establishmentId,name:s.name,price:parseFloat(s.salePrice),stock:parseInt(s.stock),active:!0});p("Sucesso","Passo concluído!","success"),K++,Sa(),$a(K)}catch(n){p("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=o}}var Ne;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ne||(Ne={}));class Qt extends Error{constructor(t,a,o){super(t),this.message=t,this.code=a,this.data=o}}const wr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},kr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},o=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:wr(e),s=()=>r()!=="web",n=m=>{const b=d.get(m);return!!(b?.platforms.has(r())||i(m))},i=m=>{var b;return(b=a.PluginHeaders)===null||b===void 0?void 0:b.find(f=>f.name===m)},l=m=>e.console.error(m),d=new Map,c=(m,b={})=>{const f=d.get(m);if(f)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),f.proxy;const v=r(),g=i(m);let x;const k=async()=>(!x&&v in b?x=typeof b[v]=="function"?x=await b[v]():x=b[v]:t!==null&&!x&&"web"in b&&(x=typeof b.web=="function"?x=await b.web():x=b.web),x),S=(T,B)=>{var N,F;if(g){const z=g?.methods.find(A=>B===A.name);if(z)return z.rtype==="promise"?A=>a.nativePromise(m,B.toString(),A):(A,Q)=>a.nativeCallback(m,B.toString(),A,Q);if(T)return(N=T[B])===null||N===void 0?void 0:N.bind(T)}else{if(T)return(F=T[B])===null||F===void 0?void 0:F.bind(T);throw new Qt(`"${m}" plugin is not implemented on ${v}`,Ne.Unimplemented)}},E=T=>{let B;const N=(...F)=>{const z=k().then(A=>{const Q=S(A,T);if(Q){const $e=Q(...F);return B=$e?.remove,$e}else throw new Qt(`"${m}.${T}()" is not implemented on ${v}`,Ne.Unimplemented)});return T==="addListener"&&(z.remove=async()=>B()),z};return N.toString=()=>`${T.toString()}() { [capacitor code] }`,Object.defineProperty(N,"name",{value:T,writable:!1,configurable:!1}),N},$=E("addListener"),L=E("removeListener"),R=(T,B)=>{const N=$({eventName:T},B),F=async()=>{const A=await N;L({eventName:T,callbackId:A},B)},z=new Promise(A=>N.then(()=>A({remove:F})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},z},O=new Proxy({},{get(T,B){switch(B){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return g?R:$;case"removeListener":return L;default:return E(B)}}});return o[m]=O,d.set(m,{name:m,proxy:O,platforms:new Set([...Object.keys(b),...g?[v]:[]])}),O};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=r,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Qt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Sr=e=>e.Capacitor=kr(e),he=Sr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ea=he.registerPlugin;class Vo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let o=!1;this.listeners[t]||(this.listeners[t]=[],o=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),o&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,o){const r=this.listeners[t];if(!r){if(o){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}r.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:o=>{this.notifyListeners(a,o)}}}unimplemented(t="not implemented"){return new he.Exception(t,Ne.Unimplemented)}unavailable(t="not available"){return new he.Exception(t,Ne.Unavailable)}async removeListener(t,a){const o=this.listeners[t];if(!o)return;const r=o.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(o=>{this.notifyListeners(t,o)}))}}const Xa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Za=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class $r extends Vo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(o=>{if(o.length<=0)return;let[r,s]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Za(r).trim(),s=Za(s).trim(),a[r]=s}),a}async setCookie(t){try{const a=Xa(t.key),o=Xa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${o||""}${r}; path=${s}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ea("CapacitorCookies",{web:()=>new $r});const Er=async e=>new Promise((t,a)=>{const o=new FileReader;o.onload=()=>{const r=o.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},o.onerror=r=>a(r),o.readAsDataURL(e)}),Ir=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,s,n)=>(r[s]=e[t[n]],r),{})},Cr=(e,t=!0)=>e?Object.entries(e).reduce((o,r)=>{const[s,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${s}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${s}=${i}`),`${o}&${l}`},"").substr(1):null,Lr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Ir(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))s.set(n,i);a.body=s.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{s.append(l,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);a.body=s;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Tr extends Vo{async request(t){const a=Lr(t,t.webFetchExtra),o=Cr(t.params,t.shouldEncodeUrlParams),r=o?`${t.url}?${o}`:t.url,s=await fetch(r,a),n=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await s.blob(),l=await Er(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const c={};return s.headers.forEach((m,b)=>{c[b]=m}),{data:l,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ea("CapacitorHttp",{web:()=>new Tr});const W=Ea("PushNotifications",{}),Pr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ka=!1;async function Uo(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await W.removeAllListeners(),await W.addListener("registration",async a=>{Wo(a.value,!0)}),await W.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await W.addListener("pushNotificationActionPerformed",a=>{const o=a.notification.data;console.log("Notificação clicada (Ação):",o)});let t=await W.checkPermissions();t.receive==="prompt"&&(t=await W.requestPermissions()),t.receive==="granted"&&await W.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Jo()}async function _o(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Jo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Jo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await zs(Oa,{vapidKey:Pr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Wo(t,!1)):console.warn("[Push Web] Token veio vazio."),Ka||(Vs(Oa,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Ka=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Wo(e,t){const a=V.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const o=ce(U,"users",a.uid);try{const r=await Do(o);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await wa(o,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Fs(o,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(s){console.error("Erro ao criar user:",s)}else console.error("Erro ao atualizar token:",r)}}const Br=(e,t,a="all",o="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),o&&o!=="all"&&r.append("costCenterId",o),w(`/api/reports/indicators?${r.toString()}`)},Dr=e=>e?w(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Mr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:o})=>{const r=new URLSearchParams({startDate:t,endDate:a});return o&&o!=="all"&&r.append("cashierSessionId",o),e&&r.append("establishmentId",e),w(`/api/reports/sales?${r.toString()}`)},Ar=()=>w("/api/reports/summary",{method:"GET"}),Ot=(e,t,a,o="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${o}`;return w(r)},zt=e=>w("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Ia=e=>w(`/api/blockages/${e}`,{method:"DELETE"}),Go=e=>w("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Ca=e=>e?String(e).replace(/\D/g,""):"",it=(e,t="",a=20,o={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),o.hasLoyalty&&r.append("hasLoyalty","true"),o.birthMonth&&r.append("birthMonth",o.birthMonth),o.inactiveDays&&r.append("inactiveDays",o.inactiveDays),w(`/api/clients/${e}?${r.toString()}`)},da=(e,t)=>{const a=encodeURIComponent(t);return w(`/api/clients/details/${e}/${a}`)},Nr=e=>{if(!e.phone)throw new Error("Telefone é obrigatório");const t=Ca(e.phone),a={...e,phone:t,id:t};return w(`/api/clients/${t}`,{method:"PUT",body:JSON.stringify(a)})},qr=(e,t)=>{const a=Ca(t);return w(`/api/clients/full-history/${e}?phone=${a}`)},Yo=e=>{const t=encodeURIComponent(e);return w(`/api/clients/${t}`,{method:"DELETE"})},Rr=(e,t,a,o)=>w("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ca(t),points:a,rewardName:o})});function h(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Qo(e,t=800,a=800,o=.7){return new Promise((r,s)=>{if(!e.type.match(/image.*/))return s(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const m=document.createElement("canvas");m.width=d,m.height=c,m.getContext("2d").drawImage(l,0,0,d,c);const f=m.toDataURL("image/jpeg",o);r(f)},l.onerror=d=>s(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>s(new Error("Erro ao ler o ficheiro."))})}const eo=document.getElementById("content");let to=!1;const ca=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let lt=[],Vt=[],qe={},De=[],C={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},I={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Fr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Xo(e){const t=new Date(e);if(t.setHours(0,0,0,0),C.currentView==="week"&&C.weekViewDays===7){const a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(o))}return t}function Pt(){const e=document.getElementById("profSelectorContainer"),t=C.profSearchTerm.toLowerCase();if(!e||!u.professionals)return;let a=u.professionals.filter(s=>C.showInactiveProfs||s.status!=="inactive");t&&(a=a.filter(s=>s.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(s=>{const n=C.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],l=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),d=s.status!=="inactive",c=h(i),m=ca[0],b=s.id!=="all"&&u.professionalColors.get(s.id)||m,f=s.photo||`https://placehold.co/64x64/${b.main?.replace("#","")||"E0E7FF"}/${b.light?.replace("#","")||"4F46E5"}?text=${l}`,v=s.id==="all"?"#e0e7ff":b.light,g=s.id==="all"?"#4f46e5":b.main,k=`border: 3px solid ${n?b.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+b.border:"none"};`;return`
        ...
        `}).join("")}function jr(e,t,a,o,r){const s=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${o} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${s}?text=${d}`}function Hr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((o,r)=>new Date(o.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(o=>{const r=new Date(o.startTime),s=new Date(o.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=u.professionalColors.get(o.professionalId)||{},d=h(o.reason),c=h(o.professionalName),m=h(o.clientName),b=h(o.serviceName),f=C.selectedItems.has(o.id),v=C.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const g=o.status==="completed",x=g?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",k=g?"Finalizado":"Aberto",S=JSON.stringify(o).replace(/'/g,"&apos;"),E=o.redeemedReward?.points>0,$=o.hasRewards&&!E,L=jr(o.clientPhone,o.clientName,o.serviceName,o.professionalName,o.startTime),R=C.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${S}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
            ...
            </div>`}).join("");t.innerHTML=`<div class="list-view-container space-y-2 pb-24">${a}</div>`}function La(){return window.innerWidth<768&&C.currentView==="week"?3:C.weekViewDays}function Or(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"],o=Xo(C.currentDate),r=La();let s=`<div class="grid divide-x divide-gray-200 min-h-[60vh]" style="grid-template-columns: repeat(${r}, minmax(0, 1fr));">`;for(let n=0;n<r;n++){const i=new Date(o);i.setDate(i.getDate()+n);const l=new Date,d=i.toDateString()===l.toDateString(),c=e.filter(b=>new Date(b.startTime).toDateString()===i.toDateString()).sort((b,f)=>new Date(b.startTime)-new Date(f.startTime));let m='<div class="p-1 space-y-2">';c.length>0?m+=c.map(b=>{const v=new Date(b.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),g=u.professionalColors.get(b.professionalId)||{bg:"#e5e7eb",border:"#9ca3af"},x=h(b.reason),k=h(b.professionalName),S=h(b.clientName),E=h(b.serviceName);if(b.type==="blockage")return`
                        <div class="p-2 rounded-lg border-l-4 flex flex-col bg-red-100" style="border-left-color: ${g.border};">
                    ...
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                         style="background-color: ${g.bg}; border-left-color: ${g.border};"
                        ...
                        <div class="mt-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-800 truncate">${R?"🎁 ":""}${S}</p>
        ...
        `}s+="</div>",t.innerHTML=s}function Zo(){const e=u.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?Hr(e):Or(e),Ta()}function Ta(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(C.isSelectionMode&&C.selectedItems.size>0?(e.innerHTML=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(I.data.redeemedReward=null)})}async function _r(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!I.data.time||I.data.selectedServiceIds.length===0||!I.data.professionalId)return p("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const o=I.data.selectedServiceIds.map(d=>{const c=lt.find(m=>m.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,s]=I.data.time.split(":"),n=new Date(`${I.data.date}T${r}:${s}:00`),i={establishmentId:u.establishmentId,clientName:I.data.clientName,clientPhone:I.data.clientPhone,services:o,professionalId:I.data.professionalId,startTime:n.toISOString(),redeemedReward:I.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Fo(l,i):await Gs(i),p(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",te()}catch(d){p(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function ts(e){const t=I.data.clientName===e.name&&I.data.clientPhone===e.phone,a=h(e.name),o=h(e.phone);return`
    ...
    `}async function Jr(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}t.innerHTML='<div class="loader-small mx-auto my-2"></div>';try{const o=await it(u.establishmentId,a);if(De=o,o.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=o.map(ts).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(r=>{r.addEventListener("click",s=>{const n=r.dataset.clientName,i=r.dataset.clientPhone,l=parseInt(r.dataset.loyaltyPoints||"0",10);I.data.clientName=n,I.data.clientPhone=i,I.data.clientLoyaltyPoints=l;const d=qe,c=Math.min(...(d?.rewards||[]).map(m=>m.points));I.data.clientHasRewards=d.enabled&&c!==1/0&&I.data.clientLoyaltyPoints>=c,document.getElementById("apptClientName").value=n,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(m=>m.classList.remove("selected","border-blue-500")),r.classList.add("selected","border-blue-500")})})}catch(o){console.error("Erro na busca de clientes:",o),t.innerHTML='<p class="text-sm text-red-500">Erro ao buscar clientes.</p>'}}async function Wr(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),o={establishmentId:u.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!o.name||!o.phone)return p("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await(void 0)(o),De.push({name:o.name,phone:o.phone,loyaltyPoints:0}),I.data.clientName=o.name,I.data.clientPhone=o.phone,I.data.clientHasRewards=!1,I.data.clientLoyaltyPoints=0,p("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",ua(1)}catch(r){p(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function Gr(){Y({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `;return{title:a,content:o}}function Xr(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${lt.map(o=>{const r=I.data.selectedServiceIds.includes(o.id),s=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=h(o.name);return`
    ...
    `;return{title:e,content:a}}function Zr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Vt.map(a=>{const o=I.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",s=h(a.name);return`
    ...
    `;return{title:e,content:t}}function Kr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=I.data.date||o,s=h(I.data.clientName),n=h(I.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function en(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),o=lt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=I.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Ko(r.dataset.serviceId,r))})}function tn(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),o=Vt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=I.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=h(r.name);return`
    ...
    `,Ut()}function Ut(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `,t&&(t.innerHTML="");return}const o={atendimento:"confirmed",finalizadas:"completed"}[y.activeFilter],r=y.allComandas.filter(n=>n.status===o);if(r.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda nesta página.</p>',ro(t);return}const s=document.createDocumentFragment();r.forEach(n=>{const l=Re(n).reduce((x,k)=>x+Number(k.price||0),0),d=n.id===y.selectedComandaId,c=new Date(n.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),m=n.type==="walk-in"||typeof n.id=="string"&&n.id.startsWith("temp-"),b=h(n.clientName||"Cliente sem nome"),f=h(n.professionalName||"Sem profissional"),v=m?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>',g=document.createElement("div");g.className=`comanda-card cursor-pointer ${d?"selected":""}`,g.dataset.action="select-comanda",g.dataset.comandaId=n.id,g.innerHTML=`
        ...
        `,s.appendChild(g)}),e.innerHTML="",e.appendChild(s),ro(t)}function ro(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:o}=y.paging,r=Math.ceil((a||0)/o);if(r===0)return;const s=document.createElement("div");s.className="flex gap-2 justify-center items-center w-full",s.innerHTML=`
    ...
    `,e.appendChild(s),s.querySelectorAll("button[data-page]").forEach(n=>{n.onclick=i=>{i.stopPropagation();const l=parseInt(n.dataset.page,10);l>0&&l<=r&&(y.paging.page=l,se())}})}function G(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(g=>g.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){vn(t,e);return}const a=`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const o=Re(t),r=t.status==="completed",s=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),n=o.reduce((g,x)=>{const S=x._source==="original_service"?`original-${x.id}`:`${x.type}-${x.id||x.name}`;return g[S]||(g[S]={...x,quantity:0,sources:[]}),g[S].quantity+=1,x._source&&g[S].sources.push(x._source),g},{}),i=Object.values(n).reduce((g,x)=>g+(x.price||0)*x.quantity,0),l=h(t.clientName||"Cliente sem nome"),d=h(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,f=`
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(n).map(g=>{const x=g.sources&&g.sources.includes("original_service");return`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm ${g.isReward?"border-yellow-200 bg-yellow-50":""}">
                        <div class="flex items-center gap-3 w-full">
                            <div class="flex-grow min-w-0">
                                ...
                                <p class="text-xs text-gray-500">${g.isReward?'<span class="text-yellow-700 font-bold">Prémio Fidelidade</span>':`R$ ${(g.price||0).toFixed(2)} un.`}</p>
                            </div>
                            ${r?`<span class="flex items-center justify-center w-8 h-8 bg-gray-100 text-gray-700 font-bold text-sm rounded-lg">${g.quantity}x</span>`:`
                                <div class="flex items-center bg-gray-100 rounded-lg p-1 gap-3">
                                    ${x?`<span class="text-sm font-bold text-gray-500 w-16 text-center py-1 bg-gray-200 rounded text-[10px] uppercase">Fixo: ${g.quantity}</span>`:`<button data-action="decrease-qty" data-item-id="${g.id}" data-item-type="${g.type}" class="w-6 h-6 flex items-center justify-center rounded bg-white text-gray-600 shadow-sm hover:bg-red-50 hover:text-red-600 disabled:opacity-30 disabled:hover:bg-white disabled:hover:text-gray-600">-</button>
                                         <span class="text-sm font-bold text-gray-800 w-4 text-center">${g.quantity}</span>
                                         <button data-action="increase-qty" data-item-id="${g.id}" data-item-type="${g.type}" class="w-6 h-6 flex items-center justify-center rounded bg-white text-gray-600 shadow-sm hover:bg-green-50 hover:text-green-600">+</button>`}
                                </div>
                            `}
                            <div class="flex items-center justify-end w-20">
                                <span class="font-bold text-gray-900 whitespace-nowrap">R$ ${(g.price*g.quantity).toFixed(2)}</span>
                            </div>
                        </div>
                    </div>
                `}).join("")}
        ...
        ${r?"":v}
    `,!r&&(t.clientId||t.clientName)&&hn(t,e.querySelector("#loyalty-container"))}function vn(e,t){const o=Re(e).reduce((l,d)=>l+Number(d.price||0),0),r=y.checkoutState,s=r.payments.reduce((l,d)=>l+d.value,0),n=Math.max(0,o-s);(!r.amountReceived||n>0)&&(r.amountReceived=n.toFixed(2));const i=`
        <div class="mobile-only-header">
    ...
    `,{modalElement:o,close:r}=Y({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});o.addEventListener("click",s=>{const n=s.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,l=e.find(d=>d.id&&d.id==i||(d.name||d.reward)==i);l&&(yn(l),r())}})}async function yn(e,t){const a=Number(e.costPoints||e.points||0),o=e.name||e.reward,r={id:e.serviceId||e.productId||`reward-${Date.now()}`,name:`${o}`,price:0,type:e.serviceId?"service":"product",isReward:!0,pointsCost:a};await Pa(r,1)}function wn(){if(!y.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=Y({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const r=e.querySelector("#add-item-content");r.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Pa(r,s),t()}};e.addEventListener("click",r=>{const s=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:i,itemId:l}=s.dataset,c=(y.catalog[i+"s"]||[]).find(m=>m.id===l);c&&o({...c,type:i})}else n&&a()}),a()}async function pa(e=null){if(!y.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!u.professionals||u.professionals.length===0)try{u.professionals=await Z(u.establishmentId)}catch{return p("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,{modalElement:o}=Y({title:"Nova Venda Avulsa",contentHTML:a,maxWidth:"max-w-md"}),r=o.querySelector("#client-search"),s=o.querySelector("#client-suggestions"),n=o.querySelector("#selected-client-id");e&&(n.value=e.id,r.value=`${e.name} (${e.phone||"Sem tel"})`,r.classList.add("bg-green-50","border-green-300","text-green-800")),r.addEventListener("input",ss(async l=>{const d=l.target.value.trim();if(n.value="",r.classList.remove("bg-green-50","border-green-300","text-green-800"),d.length<2){s.classList.add("hidden");return}try{s.innerHTML='<li class="p-2 text-xs text-gray-500">Buscando...</li>',s.classList.remove("hidden");const c=await it(u.establishmentId,d,10);c.length===0?s.innerHTML='<li class="p-2 text-xs text-gray-500">Nenhum cliente encontrado</li>':s.innerHTML=c.map(m=>`<li data-client-id="${m.id}" data-client-name="${m.name}" data-client-phone="${m.phone}" class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 transition-colors"><div class="font-bold text-sm text-gray-800">${h(m.name)}</div><div class="text-xs text-gray-500">${m.phone||"Sem telefone"}</div></li>`).join("")}catch{s.classList.add("hidden")}},400)),s.addEventListener("click",l=>{const d=l.target.closest("li[data-client-id]");d&&(n.value=d.dataset.clientId,n.dataset.name=d.dataset.clientName,n.dataset.phone=d.dataset.clientPhone,r.value=`${d.dataset.clientName}`,r.classList.add("bg-green-50","border-green-300","text-green-800"),s.classList.add("hidden"))}),document.addEventListener("click",l=>{!r.contains(l.target)&&!s.contains(l.target)&&s.classList.add("hidden")}),o.querySelector("#new-sale-form").addEventListener("submit",Ln);const i=o.querySelector('[data-action="new-client-from-sale"]');i&&i.addEventListener("click",l=>{l.preventDefault(),o.style.display="none",kn()})}function kn(){Y({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,{modalElement:t}=Y({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const o=parseFloat(document.getElementById("initial-amount").value);if(isNaN(o)||o<0)return p("Valor Inválido","Insira um valor válido.","error");try{const r=await nn({establishmentId:u.establishmentId,initialAmount:parseFloat(o.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",p("Sucesso!",`Caixa aberto (R$ ${o.toFixed(2)})`,"success"),Ut(),await se()}catch(r){p("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function En(){const e=y.activeCashierSessionId;if(e)try{const t=await cn(e),a=`
    ...
    `,Je("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,mt[0]);const n=a.professionals.labels.map(l=>h(l));Je("chart-profs","doughnut","Total Vendas",n,a.professionals.data,mt),Je("chart-daily","line","Vendas Diárias",a.salesDaily.labels,a.salesDaily.data,mt[4]);const i=a.products.labels.map(l=>h(l));Je("chart-products","bar","Total Vendido",i,a.products.data,mt[1])}function Nn(e){const t=q.appointmentsData,a=t.length;let o=0,r=0,s=0,n=0;const i={},l={};let d=new Date(q.startDate);const c=new Date(q.endDate);for(;d<=c;)i[d.toISOString().split("T")[0]]=0,d.setDate(d.getDate()+1);t.forEach(v=>{const g=parseFloat(v.totalAmount||v.price||0),x=(v.status||"").toLowerCase();let k=v.startTime?(v.startTime.toDate?v.startTime.toDate():new Date(v.startTime)).toISOString().split("T")[0]:"";const S=v.professionalName||"Sem Profissional";l[S]||(l[S]={name:S,count:0,value:0}),["cancelled","cancelado","no-show"].includes(x)?(r++,n+=g):(["completed","finalized","paid"].includes(x)&&o++,s+=g,k&&i.hasOwnProperty(k)&&i[k]++,l[S].count++,l[S].value+=g)});const m=Object.keys(i).sort(),b=m.map(v=>i[v]),f=Object.values(l).sort((v,g)=>g.count-v.count);e.innerHTML=`
    ...
    `,Je("dailyApptChart","line","Agendamentos",m.map(v=>v.split("-").reverse().slice(0,2).join("/")),b,"#4f46e5")}function qn(e){const{dreFinancial:t}=q.data,a=Object.entries(t.revenues).map(([r,s])=>`
    ...
    `}function Je(e,t,a,o,r,s){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");Xt[e]&&Xt[e].destroy();const l={type:t,data:{labels:o,datasets:[{label:a,data:r,backgroundColor:Array.isArray(s)?s:t==="line"?"rgba(79, 70, 229, 0.1)":s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:2,fill:t==="line",tension:.3,borderRadius:t==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:s,pointHoverBackgroundColor:s}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let c=d.dataset.label||"";return c&&(c+=": "),d.parsed.y!==null?c+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):c+=d.raw,c}}}},scales:t==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};Xt[e]=new Chart(i,l)}const _t=(e,t="products")=>w(`/api/${t}/categories/${e}`),ls=(e,t="products")=>w(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),ds=(e,t="products")=>w(`/api/${t}/categories/${e}`,{method:"DELETE"}),Rn="audit_logs",Fe=async(e,t,a,o,r,s=null)=>{try{if(!t)return;await Mo(ue(U,Rn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:o,description:r,details:s,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},fe=document.getElementById("content");let ne=null,Ye="services",xe="all";function je(){const e=V.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function Fn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await ls({establishmentId:u.establishmentId,name:o},"services"),Fe(u.establishmentId,je(),"Categorias (Serviços)","Criou",`Criou categoria: ${o}`),a.value="",p("Sucesso","Categoria criada!","success"),await Ba(),await dt()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function jn(e){if(await j("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ds(e,"services"),Fe(u.establishmentId,je(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),p("Sucesso","Categoria apagada.","success"),await Ba(),await dt()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Ba(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(u.establishmentId,"services");u.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Hn(){Y({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(u.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),Da(),Te()}function Vn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const v=t.querySelector("#productCategory"),g=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>g.click()),v.innerHTML='<option value="">Sem categoria</option>'+(u.categories||[]).map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${h(T.name)}</option>`).join(""),e&&(v.value=e.categoryId||"");const x=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const k=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",S=e?.photo||"";g.onchange=async()=>{const T=g.files[0];if(T){x.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const B=await co(T,800,800,"image/jpeg",.8),F=B.length*3/4,z=1e3*1024;if(F>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=B,base64Input.value=B}catch(B){console.error("Erro ao processar imagem:",B),p("Erro de Imagem",B.message||"Não foi possível processar a imagem.","error"),preview.src=k,base64Input.value=S,O.value=""}}};const E=t.cloneNode(!0);t.parentNode.replaceChild(E,t);const $=()=>{const T=E.querySelector("#modalSupplierSearch"),B=E.querySelector("#supplierSearchResults"),N=E.querySelector("#selectedSuppliersList"),F=T.value.toLowerCase();if(F.length>0){const z=o.filter(A=>A.name.toLowerCase().includes(F)&&!s.has(A.id));z.length>0?(B.classList.remove("hidden"),B.innerHTML=z.map(A=>`
                ...
                `).join("")):(B.classList.remove("hidden"),B.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else B.classList.add("hidden");s.size>0?(N.innerHTML="",s.forEach(z=>{const A=o.find(Q=>Q.id===z);A&&(N.innerHTML+=`
                    ...
                    `)})):N.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};E.querySelector("#modalSupplierSearch").addEventListener("input",$),E.addEventListener("click",T=>{const B=T.target.closest("[data-add-supplier]");if(B){const F=B.dataset.addSupplier;s.add(F),E.querySelector("#modalSupplierSearch").value="",$()}const N=T.target.closest("[data-remove-supplier]");if(N){const F=N.dataset.removeSupplier;s.delete(F),$()}}),$(),E.addEventListener("click",async T=>{const B=T.target.closest("button[data-action]");if(!B)return;const N=B.dataset.action,F=E.querySelector("#productId").value;if(N==="close-modal"&&(E.style.display="none"),N==="delete-product"){if(!F)return;E.style.display="none",await ti(F)}if(N==="save-product-modal"){const z=E.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){p("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const A=B.closest('button[data-action="save-product-modal"]');A.disabled=!0,A.textContent="A salvar...";try{await ai(z)}catch(Q){p("Erro",`Falha ao salvar: ${Q.message}`,"error"),A.disabled=!1,A.textContent="Salvar Alterações"}}}if(N==="adjust-stock-modal"){T.preventDefault();const z=E.querySelector("#stockAdjustmentAmount"),A=E.querySelector("#stockAdjustmentReason"),Q=parseInt(z.value,10),$e=parseInt(B.dataset.change,10);if(!Q||Q<=0){p("Erro","Por favor, insira uma quantidade válida.","error");return}const Yt=Q*$e,Ps=A.value||(Yt>0?"Entrada manual":"Saída manual");try{await br(F,{change:Yt,reason:Ps});const Oe=u.products.findIndex(ze=>ze.id===F);if(Oe>-1){const ze=u.products[Oe].currentStock+Yt;u.products[Oe].currentStock=ze,E.querySelector("#currentStockDisplay").textContent=ze,E.querySelector("#productCurrentStock").value=ze,z.value="",A.value="",p("Sucesso","Estoque atualizado!","success"),qa(),st()}}catch(Oe){p("Erro de Stock",Oe.message,"error")}}});const L=E.querySelectorAll(".tab-btn"),R=E.querySelectorAll(".tab-content");L.forEach(T=>{T.addEventListener("click",B=>{B.preventDefault(),L.forEach(N=>{N.classList.remove("border-indigo-500","text-indigo-600"),N.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),T.classList.add("border-indigo-500","text-indigo-600"),T.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),R.forEach(N=>N.classList.add("hidden")),document.getElementById(`tab-content-${T.dataset.tab}`).classList.remove("hidden")})});const O=E.querySelector("#productPhotoInput");E.querySelector("#productPhotoButton").addEventListener("click",()=>O.click()),O.onchange=async()=>{const T=O.files[0];if(!T)return;const B=E.querySelector("#productPhotoPreview"),N=E.querySelector("#productPhotoBase64");B.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await co(T,800,800,"image/jpeg",.8),A=F.length*3/4,Q=1e3*1024;if(A>Q)throw new Error("A imagem é muito grande mesmo após a compressão.");B.src=F,N.value=F}catch(F){console.error("Erro ao processar imagem:",F),p("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),B.src=k,N.value=S,O.value=""}},E.style.display="flex"}function oi(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;Y({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Xe(){const e=document.getElementById("purchasesContainer");if(e)if(H.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([Ht(u.establishmentId),Aa(u.establishmentId)]);H.allSuppliers=a||[];const o=t.filter(d=>{const c=parseInt(d.currentStock||0),m=parseInt(d.minStock||0);return c<=m});if(H.productsToBuy=o,o.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',s="";o.forEach(d=>{const c=parseInt(d.minStock)||0,m=parseInt(d.currentStock)||0,b=Math.max(c-m,1),f=parseFloat(d.costPrice||0),v=h(d.name);let g='<option value="">Selecione...</option>';H.allSuppliers.length>0?H.allSuppliers.forEach(x=>{const S=d.supplierIds&&d.supplierIds.includes(x.id)?"selected":"";g+=`<option value="${x.id}" ${S}>${h(x.name)}</option>`}):g='<option value="">Sem fornecedores</option>',r+=`
        ...
        `}).join("");o+=v;const x=encodeURIComponent(JSON.stringify({supplierId:b,supplierName:f.info.name,totalAmount:v,items:f.items})),k=encodeURIComponent(JSON.stringify({name:f.info.name,phone:f.info.phone,email:f.info.email})),S=encodeURIComponent(JSON.stringify(f.items)),E=h(f.info.name),$=h(f.info.email||"");a+=`
    ...
    `;Y({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",ci),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>jt("genericModal"))},50)}function bi(){ge.innerHTML=`
...
`,r.forEach(c=>{l+=`- ${c.qty}x ${c.name}
`}),l+=`
Aguardo confirmação.`);const d=`https://wa.me/${i}?text=${encodeURIComponent(l)}`;window.open(d,"_blank"),p("Aberto","WhatsApp aberto.","success")}else if(o.email){const i=n?`Solicitação de Cotação - ${u.establishmentName||"Empresa"}`:`Pedido de Compra - ${u.establishmentName||"Empresa"}`;let l=`Olá ${o.name},
...
Aguardo retorno.`;const d=`mailto:${o.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else p("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const o=JSON.parse(decodeURIComponent(a.dataset.order));o.establishmentId=u.establishmentId,a.disabled=!0,a.textContent="A processar...",ke(u.establishmentId).then(r=>{const s=r.purchaseConfig||null;return Yn(o,s)}).then(()=>{p("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',p("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const o=e.target.closest(".btn-delete-purchase").dataset.id;j("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await Qn(o,u.establishmentId),p("Sucesso","Compra e financeiro excluídos.","success"),ps()}catch(s){p("Erro","Erro ao excluir: "+s.message,"error")}})}if(e.target.closest(".btn-print-order")){const o=e.target.closest(".supplier-order-card").dataset.supplierId,r=H.finalOrders[o];r?gi(r,H.isQuoteMode):p("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),o=JSON.parse(a.dataset.purchase);pi(o)}},ge.addEventListener("click",le),ge.addEventListener("input",le),ge.addEventListener("change",le),pt("list")}function pt(e){Et=e,["list","purchases","history"].forEach(a=>{const o=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(o.classList.add("border-indigo-500","text-indigo-600"),o.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(o.classList.remove("border-indigo-500","text-indigo-600"),o.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),ii()}const Zt=document.getElementById("content"),po={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let re=new Set,gt=null,Pe=null;function fi(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function vi(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",o=h(t.name),r=h(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Kt(){const e=document.getElementById("genericModal");e.style.display="none",Pe&&e.removeEventListener("click",Pe)}async function hi(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=h(a.name),r=u.services||await Se(u.establishmentId),s=u.professionals||await Z(u.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",xi(a,r),yi(a),wi(a,s),Si(a)}function xi(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(x,k)=>{const S=k+1,E=S==o[1]?"selected":"",$=new Date(0,k).toLocaleString("pt-BR",{month:"long"});return`<option value="${S}" ${E}>${$.charAt(0).toUpperCase()+$.slice(1)}</option>`}).join(""),s=e.status||"active",n=h(e.name||""),i=h(e.specialty||""),l=h(e.phone||""),d=h(e.notes||"");a.innerHTML=`
        ...
        </div>`;const o=document.getElementById("batchBlockageForm");o&&o.addEventListener("submit",async s=>{s.preventDefault();const n=Array.from(s.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(f=>f.value);if(n.length===0)return p("Atenção","Selecione pelo menos um profissional.","error");const i=s.target.batchBlockageStartDate.value,l=s.target.batchBlockageEndDate.value||i,d=s.target.batchBlockageStartTime.value,c=s.target.batchBlockageEndTime.value,m=s.target.batchBlockageReason.value;if(!i||!d||!c)return p("Atenção","Preencha Data de Início, Início e Fim.","error");const b=n.map(f=>{const v={professionalId:f,establishmentId:u.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${c}`).toISOString(),reason:m};return zt(v)});try{await Promise.all(b),p("Sucesso!",`${n.length} bloqueios foram criados.`);const f=document.getElementById("prof-blockages-filter").value;Ze(e.id,f)}catch(f){p("Erro",f.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",s=>Ze(e.id,s.target.value)),await Ze(e.id,"future")}function ki(e,t){e.innerHTML=Object.keys(po).map(a=>{const o=t[a]||{},r=o.active!==!1;return`
    ...
    `)(e||{}),maxWidth:"max-w-3xl"}),window.switchTab=o=>It(o,t),window.handleSave=Pi,window.handleDelete=Bi,window.loadMoreHistory=()=>{P.historyLimit+=10,It("history",t)},!t&&e.id)try{if(typeof da=="function"){const o=await da(u.establishmentId,e.id);if(o){P.currentClient=o;const r=document.querySelector(".bg-indigo-100.text-indigo-700");r&&(r.textContent=`${o.loyaltyPoints||0} pts`)}}P.history=await qr(u.establishmentId,e.phone)}catch(o){console.error("Aviso: Não foi possível atualizar detalhes do cliente",o),P.history=[]}It("details",t)},It=(e,t)=>{const a=document.getElementById("modal-body");if(!a)return;document.querySelectorAll('[id^="tab-btn-"]').forEach(s=>{s.classList.remove("border-indigo-600","text-indigo-600"),s.classList.add("border-transparent","text-gray-500")});const o=document.getElementById(`tab-btn-${e}`);o&&(o.classList.add("border-indigo-600","text-indigo-600"),o.classList.remove("border-transparent","text-gray-500"));const r=P.currentClient||{};if(e==="details"){if(a.innerHTML=`
        ...
        `,window.handleRedeem=async(d,c)=>{if(await j("Resgatar",`Trocar ${d} pontos por "${c}"?`))try{await Rr(u.establishmentId,r.phone,d,c),p("Sucesso","Resgate realizado!","success"),r.loyaltyPoints=(r.loyaltyPoints||0)-parseInt(d),P.history.unshift({type:"loyalty",description:`Resgate: ${c}`,date:new Date().toISOString(),value:-d,isPoints:!0,status:"completed"}),It("loyalty",!1),me()}catch(m){p("Erro",m.message||"Erro ao resgatar","error")}}}},Pi=async()=>{const e=document.getElementById("form-client"),t=new FormData(e),a=t.get("phone").replace(/\D/g,"");if(a.length<10){p("Erro","Telefone inválido","error");return}const o={name:t.get("name"),phone:a,email:t.get("email"),birthDate:t.get("birthDate"),notes:t.get("notes"),establishmentId:u.establishmentId};try{await Nr(o),p("Sucesso","Cliente salvo!","success"),document.getElementById("genericModal").style.display="none",me()}catch(r){p("Erro","Erro ao salvar cliente","error"),console.error(r)}},Bi=async()=>{if(await j("Excluir","Tem certeza? Isso apagará o histórico deste cliente."))try{const e=P.currentClient.id||gs(P.currentClient.phone);await Yo(e),p("Sucesso","Cliente removido","success"),document.getElementById("genericModal").style.display="none",setTimeout(()=>me(),500)}catch(e){p("Erro","Erro ao remover","error"),console.error(e)}},hs=()=>{const e=document.getElementById("clients-grid");if(e){if(e.innerHTML="",P.clients.length===0){e.innerHTML=`
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!o||!r){p("Erro","Preencha todos os campos.","error");return}const s=t.querySelector('button[form="change-email-form"]');s.disabled=!0,s.textContent="A verificar...";try{const n=V.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=Bs.credential(n.email,r);await Ds(n,i),s.textContent="A enviar link...",await Ms(n,o),s.textContent="A atualizar BD...",await nr(u.establishmentId,o),p("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,p("Erro",i,"error")}finally{s.disabled=!1,s.textContent="Salvar Novo E-mail"}})}function Ki(e,t){const a=h(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,o]=await Promise.all([rt(u.establishmentId),nt(u.establishmentId)]),r=e.financialIntegration||{},s=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ie(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ie(o,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ie(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ie(o,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ie(a,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ie(o,s.defaultCostCenterId)}catch{p("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const o={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};He(o,a)})}function sl(e,t){const a="5516997859430",o=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${o}`;t.innerHTML=`
    ...
    `,ve.querySelector("#settings-menu-list").addEventListener("click",s=>{const n=s.target.closest("button[data-section]");n&&(s.preventDefault(),ll(n.dataset.section))});const r=ve.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",s=>{s.preventDefault(),ae("my-profile-section")})}const Ke=document.getElementById("content");async function Me(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,o=document.getElementById("filterEndDate")?.value,r=await Ot(u.establishmentId,a||new Date().toISOString().split("T")[0],o||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),n=s?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let b=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${h(l)} (${d.length})</h4>`;if(d.length>1){const f=JSON.stringify(d.map(v=>v.id));b+=`<button data-action="batch-delete-blockage" data-ids='${f}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}b+="</div>",c.innerHTML=b,d.forEach(f=>{const v=new Date(f.startTime),g=new Date(f.endTime),x=v.toLocaleDateString("pt-BR"),k=g.toLocaleDateString("pt-BR"),E=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${x===k?`${x} | ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${g.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${x} às ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${k} às ${g.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
        ...
        </section>`,ul(t),await Me(t);const r=document.getElementById("batchProfSelectionContainer");try{const s=await Z(u.establishmentId);r.innerHTML=s.map(n=>`
            <div class="flex items-center">
    ...
    `}).join("")}async function bo(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=u.professionals;if(!a||a.length===0)try{a=await Z(u.establishmentId),u.professionals=a}catch{p("Erro","Não foi possível carregar a lista de profissionais.","error")}const o=k=>a.find(S=>S.id===k),r=(k,S)=>{const $=o(k)?.photo,L=S.charAt(0).toUpperCase();return{photoSrc:$||`https://placehold.co/128x128/E2E8F0/4A5568?text=${L}`,initials:L,photoUrl:$||""}},s=e?.professionalId,n=e?.name||"Novo Usuário",i=r(s,n),l=o(s),d=k=>{let S='<option value="">-- Não Associado a um Profissional --</option>';return S+=a.map(E=>`<option value="${E.id}" ${E.id===k?"selected":""}>${E.name} (${E.specialty||"N/A"})</option>`).join(""),S},c=e!==null;t.querySelector("#userFormTitle").textContent=c?`Editar Usuário: ${e.name}`:"Novo Usuário";const m=t.querySelector("#userForm");m.innerHTML=`
    ...
    `;const b=window.innerWidth<768,f=m.querySelector(".bg-white");if(b&&f){f.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const k=m.closest("section");k&&(k.style.padding="0",k.style.margin="0"),f.classList.add("p-4")}const v=m.querySelector("#userProfessionalId"),g=m.querySelector("#userPhotoPreview"),x=m.querySelector("#profPhotoName");if(v.addEventListener("change",k=>{const S=k.target.value,E=o(S),$=E?E.name:"Selecione um profissional",L=r(S,n);g.src=L.photoSrc,x.textContent=$,m.querySelector("#professionalPhotoUrl").value=L.photoUrl}),m.addEventListener("submit",async k=>{k.preventDefault();const S=e?.email,E=m.querySelector("#userEmail").value,$={};m.querySelectorAll('input[type="checkbox"]').forEach(O=>{const T=O.dataset.module,B=O.dataset.permission;$[T]||($[T]={}),$[T][B]=O.checked});const L=m.querySelector("#userProfessionalId").value||null,R={name:m.querySelector("#userName").value,permissions:$,professionalId:L,establishmentId:u.establishmentId};try{c?(S!==E&&(R.email=E),await bl(e.id,R),p("Usuário atualizado com sucesso!","success")):(R.email=m.querySelector("#userEmail").value,R.password=m.querySelector("#userPassword").value,await gl(R),p("Usuário criado com sucesso!","success")),Mt()}catch(O){p(`Erro: ${O.message}`,"error")}}),c){const k=m.querySelector("#password-change-container"),S=k.querySelector('[data-action="show-password-form"]'),E=k.querySelector("#password-form"),$=E.querySelector('[data-action="save-password"]'),L=E.querySelector('[data-action="cancel-password-change"]');S.addEventListener("click",()=>{S.classList.add("hidden"),E.classList.remove("hidden")}),L.addEventListener("click",()=>{S.classList.remove("hidden"),E.classList.add("hidden"),E.querySelector("#userNewPassword").value=""}),$.addEventListener("click",async()=>{const R=E.querySelector("#userNewPassword").value;if(!R||R.length<6){p("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await j("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{$.disabled=!0,$.textContent="Aguarde...",await vl(e.id,R),p("Sucesso!","A senha do usuário foi alterada.","success"),S.classList.remove("hidden"),E.classList.add("hidden"),E.querySelector("#userNewPassword").value=""}catch(T){p("Erro",`Não foi possível alterar a senha: ${T.message}`,"error")}finally{$.disabled=!1,$.textContent="Salvar Nova Senha"}})}}async function Sl(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([pl(u.establishmentId),Z(u.establishmentId)]);u.users=t,u.professionals=a,Ct()}catch{p("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Mt(){be.innerHTML=`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ha.transactions[l];d&&vo(d)})})}async function ho(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,r=a.value;if(!o||!r)return p("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,n=await Mr({establishmentId:u.establishmentId,startDate:o,endDate:r,cashierSessionId:s});ha=n,e.innerHTML=`
        ...
        `,Cl(n)}catch(s){p("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${h(s.message)}</p>`}}async function Ll(){El();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];$l.innerHTML=`
    ...
    `,e.style.display="flex";const r=e.querySelector("#generateCashFlowBtn");r&&(r.addEventListener("click",yo),yo())}function Bl(){const e=document.getElementById("genericModal"),t=D.payables.filter(m=>m.status==="pending").reduce((m,b)=>m+b.amount,0),a=D.receivables.filter(m=>m.status==="pending").reduce((m,b)=>m+b.amount,0),o=a-t,r=D.payables.filter(m=>m.status==="paid").reduce((m,b)=>m+b.amount,0),s=D.receivables.filter(m=>m.status==="paid").reduce((m,b)=>m+b.amount,0),n=s-r,i=D.previousBalance||0,l=i+n,d=m=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(m),c=m=>m>=0?"text-green-600":"text-red-600";e.innerHTML=`
    ...
    `,e.style.display="flex"}function vt(e,t="all"){let a='<option value="all">Todos</option>';const o=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i=0)=>{const l=i>0?"— ".repeat(i):"",d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${l}${n.name}</option>`,n.children.forEach(c=>r(c,i+1))};return o(e).forEach(n=>r(n)),a}async function ye(){const e=document.getElementById("financial-content");if(!e)return;const t=document.getElementById("filterStartDate"),a=document.getElementById("filterEndDate");if(!t||!a)return;const o=t.value,r=a.value,s=document.getElementById("filterNaturezaId")?.value,n=document.getElementById("filterCostCenterId")?.value;if(!o||!r){try{const[d,c]=await Promise.all([rt(u.establishmentId),nt(u.establishmentId)]);if(!document.getElementById("financial-content"))return;D={...D,natures:d,costCenters:c},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=vt(D.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=vt(D.costCenters))}catch(d){p("Erro",`Não foi possível carregar os dados base: ${d.message}`,"error")}xa(),So();return}const i=document.getElementById("payables-list"),l=document.getElementById("receivables-list");i&&(i.innerHTML='<div class="loader mx-auto"></div>'),l&&(l.innerHTML='<div class="loader mx-auto"></div>');try{const d={startDate:o,endDate:r,establishmentId:u.establishmentId};s&&s!=="all"&&(d.natureId=s),n&&n!=="all"&&(d.costCenterId=n);const[c,m,b,f]=await Promise.all([Fi(d),Vi(d),rt(u.establishmentId),nt(u.establishmentId)]);if(!document.getElementById("financial-content"))return;const v=(m.previousBalance||0)-(c.previousBalance||0);D={...D,payables:c.entries||[],receivables:m.entries||[],natures:b||[],costCenters:f||[],previousBalance:v,filterNaturezaId:s,filterCostCenterId:n},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=vt(D.natures,D.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=vt(D.costCenters,D.filterCostCenterId)),xa(),So()}catch(d){document.getElementById("financial-content")&&(p("Erro",`Não foi possível carregar os dados: ${d.message}`,"error"),e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function Ml(e,t,a=null){e.preventDefault();const o=e.target,r=o.querySelector('[name="status"]').checked,s=o.querySelector('[name="paymentDate"]').value,n=parseFloat(o.querySelector('[name="amount"]').value),i=parseInt(o.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(n)){p("Erro de Validação","O valor inserido é inválido.","error");return}if(r&&!s){p("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:o.querySelector('[name="description"]').value,amount:n,dueDate:o.querySelector('[name="dueDate"]').value,naturezaId:o.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:o.querySelector('[name="centroDeCustoId"]').value||null,notes:o.querySelector('[name="notes"]').value,status:r?"paid":"pending",paymentDate:r?s:null,installments:a?1:i,establishmentId:u.establishmentId};try{a?(await(t==="payable"?ji(a,l):Ui(a,l)),p("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?Ri(l):zi(l)),p("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await ye()}catch(d){p("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function Al(e,t){if(await j("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?Hi(t):_i(t)),p("Sucesso","Lançamento excluído!","success"),await ye()}catch(o){p("Erro",`Falha ao excluir: ${o.message}`,"error")}}async function Nl(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Oi(t,a):Ji(t,a)),p("Sucesso","Lançamento atualizado!","success"),await ye()}catch(o){p("Erro",`Falha ao atualizar status: ${o.message}`,"error")}}function ko(e){const t=D.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function xa(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(D.natures.map(i=>[i.id,i.name])),o=new Map(D.costCenters.map(i=>[i.id,i.name])),r=ko(D.payables),s=ko(D.receivables),n=(i,l)=>{const d=i.status==="paid",c=JSON.stringify(i).replace(/'/g,"&apos;"),m=i.naturezaId?a.get(i.naturezaId):"N/A",b=i.centroDeCustoId?o.get(i.centroDeCustoId):"N/A";let f=l==="payable"?"text-red-600":"text-green-600";const v=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",g=d?"Finalizado":"Pendente";return d&&(f="text-gray-500"),`
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2 text-right">
                    ...
                    <div class="flex flex-col items-center gap-1">
                        <span class="text-xs font-semibold px-2 py-1 rounded-full ${v}">${g}</span>
                        <div class="flex">
    ...
    `}const oa=document.getElementById("content");let we={allPackages:[],catalogForModal:{services:[],products:[]}},xt=null,Be=null;function td(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `}).join("")}}function Eo(){const e=document.getElementById("genericModal");e.style.display="none",Be&&e.removeEventListener("click",Be)}async function Io(e=null){const t=document.getElementById("genericModal"),a=!!e,o=e?JSON.parse(JSON.stringify(e.items||[])):[],r=h(e?.name||""),s=h(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),m=(f,v)=>{const g=v.querySelector("#originalPrice"),x=f.reduce((k,S)=>k+S.price*S.quantity,0);g&&(g.textContent=`R$ ${x.toFixed(2)}`)},b=f=>{f.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=f.map((v,g)=>{const x=v.type==="service",k=x?"Serviço":"Produto",S=x?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        <input type="number" value="${v.quantity}" min="1" class="w-12 p-1 border rounded-md text-sm quantity-input flex-shrink-0" data-index="${g}">
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                        ...
                        <button type="button" class="text-red-500 hover:text-red-700 remove-item-btn font-bold" data-index="${g}">&times;</button>
                    </div>
                </div>
            `}).join(""),m(f,t)};b(o),c.addEventListener("change",f=>{if(f.target.classList.contains("quantity-input")){const v=parseInt(f.target.dataset.index,10),g=parseInt(f.target.value,10);g>0&&o[v]&&(o[v].quantity=g,b(o))}}),c.addEventListener("click",f=>{if(f.target.classList.contains("remove-item-btn")){const v=parseInt(f.target.dataset.index,10);o.splice(v,1),b(o)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>od(f=>{const v=o.find(g=>g.id===f.id&&g.type===f.type);v?v.quantity++:o.push({...f,quantity:1}),b(o)}),Be&&t.removeEventListener("click",Be),Be=async f=>{const v=f.target.closest("button[data-action]");if(!v)return;const g=v.dataset.action;if(f.stopPropagation(),g==="close-modal"&&Eo(),g==="save-package"){const x=v,k={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:o,originalPrice:o.reduce((S,E)=>S+E.price*E.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:u.establishmentId};if(!k.name||!k.price){p("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(k.items.length===0){p("Erro","Adicione pelo menos um item ao pacote.","error");return}x.disabled=!0,x.textContent="A salvar...";try{a?await mn(k.id,k):(delete k.id,await un(k)),p("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Eo(),await Ha()}catch(S){p("Erro",`Não foi possível salvar o pacote: ${S.message}`,"error"),x.disabled=!1,x.textContent="Salvar Pacote"}}},t.addEventListener("click",Be)}function od(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const o={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=we.catalogForModal.services.filter(v=>v.name.toLowerCase().includes(d)),m=we.catalogForModal.products.filter(v=>v.name.toLowerCase().includes(d)),b=c.map(v=>`
    ...
    `,document.body.appendChild(a);const s=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(s),n.addEventListener("input",()=>{t=n.value,r(s)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:m,itemId:b}=d.dataset,v=(we.catalogForModal[m+"s"]||[]).find(g=>g.id===b);v&&(e({...v,type:m}),i())}else(c||l.target===a)&&i()})}async function Ha(){oa.innerHTML=`
    ...
    `,xt&&oa.removeEventListener("click",xt),xt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const o=e.target.closest('[data-action="delete-package"]');if(o){const r=o.dataset.id;j("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await pn(r),p("Sucesso!","Pacote excluído.","success"),await Ha()}catch(n){p("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")Io(null);else if(a==="edit-package"){const o=JSON.parse(t.dataset.package);Io(o)}},oa.addEventListener("click",xt);try{const[e,t,a]=await Promise.all([os(u.establishmentId),Se(u.establishmentId),Ht(u.establishmentId)]);we.allPackages=e,we.catalogForModal={services:t.filter(o=>o.active),products:a},ad()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const sd=document.getElementById("content");let rd=null;async function nd(){const e=h(u.userName||"Usuário"),t=h(V.currentUser?.email||"E-mail não disponível"),a=u.userName?u.userName.charAt(0):"U";sd.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
