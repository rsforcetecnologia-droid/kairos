const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-DfQAjs79.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-C2XZ_b0c.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as U,d as _,m as Oa}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Bs,reauthenticateWithCredential as Ms,verifyBeforeUpdateEmail as As,updatePassword as Ns,updateProfile as qs,setPersistence as Rs,browserLocalPersistence as js,onAuthStateChanged as Po,signOut as za}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as me,getDoc as Bo,updateDoc as xa,setDoc as Fs,addDoc as Mo,collection as pe,query as Rt,where as at,getDocs as ya,orderBy as Ao,writeBatch as No,serverTimestamp as Va,deleteDoc as Hs,arrayUnion as Os,onSnapshot as zs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Vs,onMessage as Us}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const u={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function _s(e,t,a){u.establishmentId=e,u.establishmentName=t,u.userPermissions=a}const qo=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",na=qo?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${qo?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",na);async function Ws(){const e=U.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function $(e,t={}){const a=await Ws();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const o=na.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,s=`${o}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${s}`);try{const n=await fetch(s,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),m=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${s}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${s}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${na}. Verifique se o servidor backend está rodando.`):n}}const jt=(e,t,a,o=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(r+=`&professionalId=${o}`),$(r)},Ro=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return $(r)},jo=e=>$("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Fo=(e,t)=>$(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Et=e=>$(`/api/appointments/${e}`,{method:"DELETE"});let W;async function Js(){if(!W)try{W=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Gs(){if(!W){console.warn("AudioContext não inicializado. O som não será tocado.");return}W.state==="suspended"&&W.resume();const e=W.createOscillator(),t=W.createGain();e.connect(t),t.connect(W.destination),e.type="sine",e.frequency.setValueAtTime(800,W.currentTime),t.gain.setValueAtTime(0,W.currentTime),t.gain.linearRampToValueAtTime(.3,W.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,W.currentTime+.2),e.start(W.currentTime),e.stop(W.currentTime+.2)}function g(e,t,a="info",o=!1){const r=document.getElementById("toast-container");if(!r)return;o&&Gs();const s=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${n[a]||n.info}`,s.innerHTML=`
    ...
    `,r.appendChild(s),s.querySelector(".toast-close").addEventListener("click",()=>s.remove()),setTimeout(()=>{s.remove()},4e3)}function V(e,t){const a=document.getElementById("genericModal");return new Promise(o=>{a.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function Ft(e){const t=document.getElementById(e);t&&(t.style.display="none")}function Xs(){document.body.addEventListener("click",()=>{W||Js()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const o=t.dataset.target;if(o){const r=document.getElementById(o);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const o=document.getElementById("genericModal");o&&(o.style.display="none")}})}const Y=document.getElementById("sidebar"),Ua=document.getElementById("sidebarToggle"),Ge=document.getElementById("mainContent"),Ys=document.querySelectorAll(".sidebar-link"),_a=document.getElementById("hamburger-menu-btn"),Me=document.getElementById("mobile-overlay");function xt(e){!Y||!Ge||(Y.classList.toggle("collapsed",e),Ge.classList.toggle("sidebar-collapsed-shift",e))}function Qs(){!Y||!Me||(Y.classList.add("mobile-open"),Me.classList.add("visible"))}function ct(){!Y||!Me||(Y.classList.remove("mobile-open"),Me.classList.remove("visible"))}function Zs(){xt(!Y.classList.contains("collapsed"))}function Ks(e,t,a){if(!Y||!Ge)return;Ge.classList.add("main-content-shift"),window.innerWidth>=768?xt(Y.classList.contains("collapsed")):(Ge.classList.remove("main-content-shift","sidebar-collapsed-shift"),ct()),Ua&&Ua.addEventListener("click",r=>{r.stopPropagation(),Zs()}),Y.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&Y.classList.contains("collapsed")&&xt(!1)}),Y.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||xt(!0))}),_a&&_a.addEventListener("click",r=>{r.stopPropagation(),Qs()}),Me&&Me.addEventListener("click",r=>{r.stopPropagation(),ct()});let o=0;Y.addEventListener("touchstart",r=>{o=r.changedTouches[0].screenX},{passive:!0}),Y.addEventListener("touchend",r=>{const s=r.changedTouches[0].screenX;o-s>50&&ct()},{passive:!0}),Ys.forEach(r=>{const s=r.getAttribute("data-target"),n=s.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[s]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),s&&typeof e=="function"&&e(s),window.innerWidth<768&&ct()})})}const ke=e=>{const t=e||u.establishmentId;return t?$(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},yt=(e,t)=>{const a=e||u.establishmentId;return a?$(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},er=(e,t)=>{const a=e||u.establishmentId;return a?$(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},tr=(e,t)=>{const a=e||u.establishmentId;return a?$(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},K=e=>$(`/api/professionals/${e}`),ar=e=>$(`/api/professionals/details/${e}`),Ho=e=>$("/api/professionals",{method:"POST",body:JSON.stringify(e)}),It=(e,t)=>$(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Wa=(e,t)=>It(e,{services:t}),Oo=e=>$(`/api/professionals/${e}`,{method:"DELETE"}),or=e=>{const t=e.map(a=>Oo(a));return Promise.all(t)},Se=e=>$(`/api/services/${e}`),zo=e=>$("/api/services",{method:"POST",body:JSON.stringify(e)}),sr=(e,t)=>$(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),rr=e=>$(`/api/services/${e}`,{method:"DELETE"}),nr=(e,t)=>$(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),ir=e=>$(`/api/services/stats/most-popular/${e}`),wa=e=>$(`/api/products/${e}`),Vo=e=>$("/api/products",{method:"POST",body:JSON.stringify(e)}),lr=(e,t)=>$(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),dr=e=>$(`/api/products/${e}`,{method:"DELETE"}),cr=(e,t)=>$(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),ur=({startDate:e,endDate:t,productId:a,categoryId:o,establishmentId:r})=>{const s=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&s.append("productId",a),o&&o!=="all"&&s.append("categoryId",o),r&&s.append("establishmentId",r),$(`/api/products/stock-history/report?${s.toString()}`)},mr={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function Ja(e,t,a){return new Promise((o,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const p=e.type==="image/png"&&t<500?"image/png":"image/jpeg";o(l.toDataURL(p,a))},i.onerror=l=>r(l)},s.onerror=n=>r(n)})}let ce=null;const wt=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let Q=0,Ct=[];async function pr(){try{console.log("Iniciando verificação de Onboarding para ID:",u.establishmentId);const e=await ke(u.establishmentId),t=await K(u.establishmentId),a=await Se(u.establishmentId);Ct=a||[];const o=e&&e.name&&(e.phone||e.address),r=e&&(e.logo||e.themeColor&&e.themeColor!=="indigo"),s=e&&e.slotInterval>0,n=a&&a.length>0,i=t&&t.length>0;if(console.log("Status Onboarding:",{hasCompanyData:o,hasBranding:r,hasTimeConfig:s,hasService:n,hasProf:i}),o&&s&&i&&n)return;if(!o)Q=0;else if(!r&&!s)Q=1;else if(!s)Q=2;else if(!n)Q=3;else if(!i)Q=4;else if(Q===0)return;gr(),Sa(Q)}catch(e){console.error("Erro ao verificar onboarding:",e)}}function gr(){document.getElementById("onboarding-overlay")||(ce=document.createElement("div"),ce.id="onboarding-overlay",ce.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",ce.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",ce.innerHTML=`
    ...
    `,document.body.appendChild(ce),ka())}function ka(){const e=Math.round(Q/wt.length*100),t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width=`${e}%`),a&&(a.innerText=`${e}%`)}function Sa(e){const t=document.getElementById("onboarding-step-content"),a=wt[e];if(!a){Ga(t);return}let o="";if(a.id==="company_data")o=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(mr).map(([s,n])=>`<option value="${s}">${n.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
        ...
        `;else if(a.id==="first_prof"){const r=Ct.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""),s=Ct.length>0;o=`
            <form id="step-form" class="space-y-3">
        ...
        <div class="mt-6 flex justify-end gap-2">
            ...
            <button type="button" id="next-step-btn" class="bg-indigo-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-indigo-700 transition flex items-center gap-2 text-sm">
                ${e===wt.length-1?"Concluir":"Próximo"}
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
            </button>
        </div>
    `,document.getElementById("next-step-btn").addEventListener("click",()=>fr(a.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===wt.length-1?Ga(t):(Q++,ka(),Sa(Q))}),a.id==="branding"){const r=document.getElementById("logo-input"),s=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Ja(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),s&&(s.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Ja(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Ga(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{ce&&ce.remove(),window.location.reload()}}async function fr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),o=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),s=Object.fromEntries(r.entries());try{if(e==="company_data")await yt(u.establishmentId,{name:s.name,phone:s.phone,email:s.email,address:s.address,zipCode:s.zipCode});else if(e==="branding"){const n={};s.logoBase64&&(n.logo=s.logoBase64),s.bgBase64&&(n.backgroundImage=s.bgBase64),s.themeColor&&(n.themeColor=s.themeColor),s.primaryColor&&(n.primaryColor=s.primaryColor),Object.keys(n).length>0&&await yt(u.establishmentId,n)}else if(e==="time_config"){const n=parseInt(s.slotInterval);await yt(u.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await zo({establishmentId:u.establishmentId,name:s.name,price:parseFloat(s.price),duration:parseInt(s.duration),active:!0});n&&Ct.push(n)}else if(e==="first_prof"){const n=await Ho({establishmentId:u.establishmentId,name:s.name,specialty:s.role,active:!0,commissionRate:0});if(s.serviceId&&n&&n.id)try{Wa?await Wa(n.id,[s.serviceId]):It&&await It(n.id,{services:[s.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Vo({establishmentId:u.establishmentId,name:s.name,price:parseFloat(s.salePrice),stock:parseInt(s.stock),active:!0});g("Sucesso","Passo concluído!","success"),Q++,ka(),Sa(Q)}catch(n){g("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=o}}var Ae;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ae||(Ae={}));class Yt extends Error{constructor(t,a,o){super(t),this.message=t,this.code=a,this.data=o}}const br=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},vr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},o=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:br(e),s=()=>r()!=="web",n=m=>{const p=d.get(m);return!!(p?.platforms.has(r())||i(m))},i=m=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===m)},l=m=>e.console.error(m),d=new Map,c=(m,p={})=>{const b=d.get(m);if(b)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),b.proxy;const v=r(),h=i(m);let y;const x=async()=>(!y&&v in p?y=typeof p[v]=="function"?y=await p[v]():y=p[v]:t!==null&&!y&&"web"in p&&(y=typeof p.web=="function"?y=await p.web():y=p.web),y),L=(D,P)=>{var j,F;if(h){const z=h?.methods.find(R=>P===R.name);if(z)return z.rtype==="promise"?R=>a.nativePromise(m,P.toString(),R):(R,X)=>a.nativeCallback(m,P.toString(),R,X);if(D)return(j=D[P])===null||j===void 0?void 0:j.bind(D)}else{if(D)return(F=D[P])===null||F===void 0?void 0:F.bind(D);throw new Yt(`"${m}" plugin is not implemented on ${v}`,Ae.Unimplemented)}},w=D=>{let P;const j=(...F)=>{const z=x().then(R=>{const X=L(R,D);if(X){const $e=X(...F);return P=$e?.remove,$e}else throw new Yt(`"${m}.${D}()" is not implemented on ${v}`,Ae.Unimplemented)});return D==="addListener"&&(z.remove=async()=>P()),z};return j.toString=()=>`${D.toString()}() { [capacitor code] }`,Object.defineProperty(j,"name",{value:D,writable:!1,configurable:!1}),j},E=w("addListener"),T=w("removeListener"),q=(D,P)=>{const j=E({eventName:D},P),F=async()=>{const R=await j;T({eventName:D,callbackId:R},P)},z=new Promise(R=>j.then(()=>R({remove:F})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},z},H=new Proxy({},{get(D,P){switch(P){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?q:E;case"removeListener":return T;default:return w(P)}}});return o[m]=H,d.set(m,{name:m,proxy:H,platforms:new Set([...Object.keys(p),...h?[v]:[]])}),H};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=r,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Yt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},hr=e=>e.Capacitor=vr(e),oe=hr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ht=oe.registerPlugin;class Uo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let o=!1;this.listeners[t]||(this.listeners[t]=[],o=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),o&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,o){const r=this.listeners[t];if(!r){if(o){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}r.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:o=>{this.notifyListeners(a,o)}}}unimplemented(t="not implemented"){return new oe.Exception(t,Ae.Unimplemented)}unavailable(t="not available"){return new oe.Exception(t,Ae.Unavailable)}async removeListener(t,a){const o=this.listeners[t];if(!o)return;const r=o.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(o=>{this.notifyListeners(t,o)}))}}const Xa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ya=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class xr extends Uo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(o=>{if(o.length<=0)return;let[r,s]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Ya(r).trim(),s=Ya(s).trim(),a[r]=s}),a}async setCookie(t){try{const a=Xa(t.key),o=Xa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${o||""}${r}; path=${s}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ht("CapacitorCookies",{web:()=>new xr});const yr=async e=>new Promise((t,a)=>{const o=new FileReader;o.onload=()=>{const r=o.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},o.onerror=r=>a(r),o.readAsDataURL(e)}),wr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,s,n)=>(r[s]=e[t[n]],r),{})},kr=(e,t=!0)=>e?Object.entries(e).reduce((o,r)=>{const[s,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${s}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${s}=${i}`),`${o}&${l}`},"").substr(1):null,Sr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=wr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))s.set(n,i);a.body=s.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{s.append(l,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);a.body=s;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class $r extends Uo{async request(t){const a=Sr(t,t.webFetchExtra),o=kr(t.params,t.shouldEncodeUrlParams),r=o?`${t.url}?${o}`:t.url,s=await fetch(r,a),n=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await s.blob(),l=await yr(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const c={};return s.headers.forEach((m,p)=>{c[p]=m}),{data:l,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ht("CapacitorHttp",{web:()=>new $r});const G=Ht("PushNotifications",{}),Er="modulepreload",Ir=function(e){return"/"+e},Qa={},Cr=function(t,a,o){let r=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");r=l(a.map(d=>{if(d=Ir(d),d in Qa)return;Qa[d]=!0;const c=d.endsWith(".css"),m=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${m}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Er,c||(p.as="script"),p.crossOrigin="",p.href=d,i&&p.setAttribute("nonce",i),document.head.appendChild(p),c)return new Promise((b,v)=>{p.addEventListener("load",b),p.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return r.then(n=>{for(const i of n||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})},Za=Ht("App",{web:()=>Cr(()=>import("./web-DfQAjs79.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Lr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ka=!1;async function _o(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{Go(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const o=a.notification.data;console.log("Notificação clicada (Ação):",o)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Jo()}async function Wo(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Jo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Jo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Vs(Oa,{vapidKey:Lr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Go(t,!1)):console.warn("[Push Web] Token veio vazio."),Ka||(Us(Oa,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Ka=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Go(e,t){const a=U.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const o=me(_,"users",a.uid);try{const r=await Bo(o);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await xa(o,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Fs(o,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(s){console.error("Erro ao criar user:",s)}else console.error("Erro ao atualizar token:",r)}}const Tr=(e,t,a="all",o="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),o&&o!=="all"&&r.append("costCenterId",o),$(`/api/reports/indicators?${r.toString()}`)},Dr=e=>e?$(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Pr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:o})=>{const r=new URLSearchParams({startDate:t,endDate:a});return o&&o!=="all"&&r.append("cashierSessionId",o),e&&r.append("establishmentId",e),$(`/api/reports/sales?${r.toString()}`)},Br=()=>$("/api/reports/summary",{method:"GET"}),st=(e,t,a,o="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${o}`;return $(r)},Ot=e=>$("/api/blockages",{method:"POST",body:JSON.stringify(e)}),$a=e=>$(`/api/blockages/${e}`,{method:"DELETE"}),Xo=e=>$("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Mr=e=>e?String(e).replace(/\D/g,""):"",rt=(e,t="",a=20,o={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),o&&o.hasLoyalty&&r.append("hasLoyalty","true"),o&&o.birthMonth&&r.append("birthMonth",o.birthMonth),o&&o.inactiveDays&&r.append("inactiveDays",o.inactiveDays),$(`/api/clients/${e}?${r.toString()}`)},Yo=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Mr(t),o={...e,phone:a,id:a};return $(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(o)})},Ea=Yo,Ar=(e,t)=>Yo({...t,id:e}),Nr=e=>{const t=encodeURIComponent(e);return $(`/api/clients/${t}`,{method:"DELETE"})};function f(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Qo(e,t=800,a=800,o=.7){return new Promise((r,s)=>{if(!e.type.match(/image.*/))return s(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const m=document.createElement("canvas");m.width=d,m.height=c,m.getContext("2d").drawImage(l,0,0,d,c);const b=m.toDataURL("image/jpeg",o);r(b)},l.onerror=d=>s(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>s(new Error("Erro ao ler o ficheiro."))})}const eo=document.getElementById("content");let to=!1;const ia=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let nt=[],zt=[],Ne={},De=[],I={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},k={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function qr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Zo(e){const t=new Date(e);if(t.setHours(0,0,0,0),I.currentView==="week"&&I.weekViewDays===7){const a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(o))}return t}function Lt(){const e=document.getElementById("profSelectorContainer"),t=I.profSearchTerm.toLowerCase();if(!e||!u.professionals)return;let a=u.professionals.filter(s=>I.showInactiveProfs||s.status!=="inactive");t&&(a=a.filter(s=>s.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(s=>{const n=I.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],l=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),d=s.status!=="inactive",c=f(i),m=ia[0],p=s.id!=="all"&&u.professionalColors.get(s.id)||m,b=s.photo||`https://placehold.co/64x64/${p.main?.replace("#","")||"E0E7FF"}/${p.light?.replace("#","")||"4F46E5"}?text=${l}`,v=s.id==="all"?"#e0e7ff":p.light,h=s.id==="all"?"#4f46e5":p.main,x=`border: 3px solid ${n?p.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+p.border:"none"};`;return`
            <div class="prof-card ${n?"selected":""} ${d?"":"opacity-50"}" 
                 data-action="select-professional" 
                 data-prof-id="${s.id}">
                ${s.id==="all"?`<div class="prof-card-all-placeholder" style="background-color: ${v}; color: ${h}; ${x}">
                           ${l}
                          </div>`:`<img src="${b}" alt="${c}" class="prof-card-photo" style="${x}" />`}
                <span class="prof-card-name">${c}</span>
            </div>
        `}).join("")}function Rr(e,t,a,o,r){const s=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${o} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${s}?text=${d}`}function jr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((o,r)=>new Date(o.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(o=>{const r=new Date(o.startTime),s=new Date(o.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=u.professionalColors.get(o.professionalId)||{},d=f(o.reason),c=f(o.professionalName),m=f(o.clientName),p=f(o.serviceName),b=I.selectedItems.has(o.id),v=I.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const h=o.status==="completed",y=h?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",x=h?"Finalizado":"Aberto",L=JSON.stringify(o).replace(/'/g,"&apos;"),w=o.redeemedReward?.points>0,E=o.hasRewards&&!w,T=Rr(o.clientPhone,o.clientName,o.serviceName,o.professionalName,o.startTime),q=I.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${L}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
                    <span class="status-badge ${y} mb-1">${x}</span>
                    <div class="card-actions flex gap-1 items-center">
                        ${h?`
                            <button data-action="edit-appointment" data-appointment='${L}' class="action-btn opacity-40 cursor-not-allowed" title="Finalizado - Não editável" disabled><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L16.732 3.732z"></path></svg></button>
                        `:`
                            ...
                            <button data-action="edit-appointment" data-appointment='${L}' class="action-btn" title="Editar Agendamento"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L16.732 3.732z"></path></svg></button>
                        `}
            ...
            </div>`}).join("");t.innerHTML=`<div class="list-view-container space-y-2 pb-24">${a}</div>`}function Ia(){return window.innerWidth<768&&I.currentView==="week"?3:I.weekViewDays}function Fr(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"],o=Zo(I.currentDate),r=Ia();let s=`<div class="grid divide-x divide-gray-200 min-h-[60vh]" style="grid-template-columns: repeat(${r}, minmax(0, 1fr));">`;for(let n=0;n<r;n++){const i=new Date(o);i.setDate(i.getDate()+n);const l=new Date,d=i.toDateString()===l.toDateString(),c=e.filter(p=>new Date(p.startTime).toDateString()===i.toDateString()).sort((p,b)=>new Date(p.startTime)-new Date(b.startTime));let m='<div class="p-1 space-y-2">';c.length>0?m+=c.map(p=>{const v=new Date(p.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),h=u.professionalColors.get(p.professionalId)||{bg:"#e5e7eb",border:"#9ca3af"},y=f(p.reason),x=f(p.professionalName),L=f(p.clientName),w=f(p.serviceName);if(p.type==="blockage")return`
                        <div class="p-2 rounded-lg border-l-4 flex flex-col bg-red-100" style="border-left-color: ${h.border};">
                            ...
                            <div class="mt-1 min-w-0">
                                ...
                                <p class="text-xs text-red-600 truncate">com ${x}</p>
                            </div>
                        </div>
                    `;const E=JSON.stringify(p).replace(/'/g,"&apos;"),T=p.redeemedReward?.points>0,q=p.hasRewards&&!T,H=p.status==="completed";return`
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                        ...
                        <div class="mt-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-800 truncate">${q?"🎁 ":""}${L}</p>
                            <p class="text-xs text-gray-600 truncate">${w}</p>
                            <p class="text-xs text-gray-500 truncate">com ${x||"Indefinido"}</p>
        ...
        `}s+="</div>",t.innerHTML=s}function Ko(){const e=u.allEvents.filter(t=>I.selectedProfessionalId==="all"||t.professionalId===I.selectedProfessionalId);I.currentView==="list"?jr(e):Fr(e),Ca()}function Ca(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(I.isSelectionMode&&I.selectedItems.size>0?(e.innerHTML=`
            <div class="bg-white p-4 rounded-xl shadow-2xl border border-red-100 flex items-center justify-between gap-4">
                <span class="font-bold text-gray-800">${I.selectedItems.size} selecionado(s)</span>
        ...
        `,e.style.display="block",t&&(t.style.display="none")):(e.style.display="none",t&&(t.style.display="flex")))}async function te(){const e=document.getElementById("agenda-view");if(!e)return;I.selectedItems.clear(),Ca(),e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const o=document.getElementById("weekRange");if(o){if(I.currentView==="list")t=new Date(I.currentDate),t.setHours(0,0,0,0),a=new Date(I.currentDate),a.setHours(23,59,59,999),o.textContent=qr(t);else{const r=Ia();t=Zo(new Date(I.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),o.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await jt(u.establishmentId,t.toISOString(),a.toISOString(),I.selectedProfessionalId==="all"?null:I.selectedProfessionalId),s=await st(u.establishmentId,t.toISOString(),a.toISOString(),I.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const n=s.map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=u.professionals?u.professionals.find(m=>m.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(u.allEvents=i,Lt(),Ko(),I.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${I.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),I.scrollToAppointmentId=null}}catch(r){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',g("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"))}}}async function Hr(){try{const[e,t,a]=await Promise.all([u.professionals&&u.professionals.length>0?Promise.resolve(u.professionals):K(u.establishmentId),u.services&&u.services.length>0?Promise.resolve(u.services):Se(u.establishmentId),Ne.enabled!==void 0?Promise.resolve(null):ke(u.establishmentId)]);(!u.professionals||u.professionals.length===0)&&(u.professionals=e||[]),(!u.services||u.services.length===0)&&(u.services=t||[]),De=[],a&&(Ne=a.loyaltyProgram||{enabled:!1}),u.professionals.forEach((o,r)=>{u.professionalColors.set(o.id,ia[r%ia.length])}),Lt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function la(e){e<1||e>4||(k.step=e,da(null,!0))}function es(e,t){const a=document.getElementById("multiServiceToggle"),o=a&&a.checked,r=t.classList.contains("selected"),s=k.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),s>-1&&k.data.selectedServiceIds.splice(s,1);else{if(!o){k.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),k.data.selectedServiceIds.push(e)}}function ts(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const o=zt.find(r=>r.id===e);k.data.professionalId=e,k.data.professionalName=o?o.name:"N/A"}function Or(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(o=>o.classList.remove("selected")),t.classList.add("selected"),k.data.time=e)}async function ao(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=k.data.professionalId,o=k.data.selectedServiceIds,r=document.getElementById("apptDate").value;k.data.date=r;const s=o.reduce((n,i)=>{const l=nt.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${s} min`,s===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await Ro({establishmentId:u.establishmentId,professionalId:a,serviceIds:o,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[m,p]=c.split(":").map(Number);return m*60+p>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${k.data.time===d?"selected":""}`,c.textContent=d,c.addEventListener("click",()=>Or(d,c)),t.appendChild(c)}),k.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${k.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function zr(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:o}=k.data,{enabled:r,rewards:s}=Ne;if(!r||!t||!s||s.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const n=s.filter(l=>a>=l.points);let i=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(k.data.redeemedReward=null)})}async function Vr(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!k.data.time||k.data.selectedServiceIds.length===0||!k.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const o=k.data.selectedServiceIds.map(d=>{const c=nt.find(m=>m.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,s]=k.data.time.split(":"),n=new Date(`${k.data.date}T${r}:${s}:00`),i={establishmentId:u.establishmentId,clientName:k.data.clientName,clientPhone:k.data.clientPhone,services:o,professionalId:k.data.professionalId,startTime:n.toISOString(),redeemedReward:k.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Fo(l,i):await jo(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",te()}catch(d){g(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function as(e){const t=k.data.clientName===e.name&&k.data.clientPhone===e.phone,a=f(e.name),o=f(e.phone);return`
    ...
    `}async function Ur(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}t.innerHTML='<div class="loader-small mx-auto my-2"></div>';try{const o=await rt(u.establishmentId,a);if(De=o,o.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=o.map(as).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(r=>{r.addEventListener("click",s=>{const n=r.dataset.clientName,i=r.dataset.clientPhone,l=parseInt(r.dataset.loyaltyPoints||"0",10);k.data.clientName=n,k.data.clientPhone=i,k.data.clientLoyaltyPoints=l;const d=Ne,c=Math.min(...(d?.rewards||[]).map(m=>m.points));k.data.clientHasRewards=d.enabled&&c!==1/0&&k.data.clientLoyaltyPoints>=c,document.getElementById("apptClientName").value=n,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(m=>m.classList.remove("selected","border-blue-500")),r.classList.add("selected","border-blue-500")})})}catch(o){console.error("Erro na busca de clientes:",o),t.innerHTML='<p class="text-sm text-red-500">Erro ao buscar clientes.</p>'}}async function _r(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),o={establishmentId:u.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!o.name||!o.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await Ea(o),De.push({name:o.name,phone:o.phone,loyaltyPoints:0}),k.data.clientName=o.name,k.data.clientPhone=o.phone,k.data.clientHasRewards=!1,k.data.clientLoyaltyPoints=0,g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",la(1)}catch(r){g(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function Wr(){ne({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",_r)}function Jr(){Wr()}function Gr(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",o=`
        <div class="p-5 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="apptClientName" required class="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm" placeholder="Nome Completo" value="${f(k.data.clientName)}">
                </div>
                <div>
                    <label for="apptClientPhone" class="block text-sm font-medium text-gray-700">Telemóvel</label>
                    <input type="tel" id="apptClientPhone" required class="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm" placeholder="(XX) XXXXX-XXXX" value="${f(k.data.clientPhone)}">
                </div>
            </div>
    ...
    `;return{title:a,content:o}}function Xr(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${nt.map(o=>{const r=k.data.selectedServiceIds.includes(o.id),s=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=f(o.name);return`
    ...
    `;return{title:e,content:a}}function Yr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${zt.map(a=>{const o=k.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",s=f(a.name);return`
    ...
    `;return{title:e,content:t}}function Qr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=k.data.date||o,s=f(k.data.clientName),n=f(k.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function Zr(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),o=nt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=k.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${s?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>es(r.dataset.serviceId,r))})}function Kr(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),o=zt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=k.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=f(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>ts(r.dataset.professionalId,r))})}async function da(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const s=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(k={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:s,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}},e&&e.clientName)try{const i=await rt(u.establishmentId,e.clientName),l=i.find(d=>d.phone===e.clientPhone);l&&(k.data.clientLoyaltyPoints=l.loyaltyPoints||0,De=i)}catch(i){console.warn("Não foi possível carregar pontos do cliente para edição:",i)}}if(!u.services||!u.professionals||Ne.enabled===void 0){g("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(nt=u.services,zt=u.professionals.filter(s=>s.status==="active"),k.data.clientLoyaltyPoints>0){const s=Ne,n=Math.min(...(s?.rewards||[]).map(i=>i.points));k.data.clientHasRewards=s.enabled&&n!==1/0&&k.data.clientLoyaltyPoints>=n}let o={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(k.step){case 1:o=Gr(e);break;case 2:o=Xr();break;case 3:o=Yr();break;case 4:o=Qr(e);break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(k.data.clientName=i.value.trim(),k.data.clientPhone=l.value.trim(),!k.data.clientName||!k.data.clientPhone)return g("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(k.data.selectedServiceIds.length===0)return g("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!k.data.professionalId)return g("Atenção","Selecione um profissional.","error");la(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(s=>{s.addEventListener("click",()=>la(parseInt(s.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if(k.step===4&&r&&r.addEventListener("submit",Vr),a.style.display="flex",k.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>es(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>Zr(i.target.value))}if(k.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>ts(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>Kr(i.target.value))}if(k.step===1){const s=a.querySelector("#clientSearchInput");if(s&&(s.addEventListener("input",i=>Ur(i.target.value)),k.data.clientName&&k.data.clientPhone&&De.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=De.map(as).join(""))}const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Jr)}if(k.step===4){const s=a.querySelector("#apptDate");s&&s.addEventListener("change",ao),ao(),zr()}}async function os(e={}){I.currentDate=e.targetDate?new Date(e.targetDate):I.currentDate||new Date,I.scrollToAppointmentId=e.scrollToAppointmentId||null,I.profSearchTerm="",I.isSelectionMode=!1,I.selectedItems.clear(),window.innerWidth<768&&(I.currentView="list"),eo.innerHTML=`
        <section>
        ...
        </section>`;const t=document.getElementById("btn-toggle-select");t.addEventListener("click",()=>{I.isSelectionMode=!I.isSelectionMode,I.isSelectionMode||I.selectedItems.clear(),t.classList.toggle("bg-blue-100",I.isSelectionMode),t.classList.toggle("text-blue-700",I.isSelectionMode),Ko()}),document.querySelectorAll(".view-btn[data-view]").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(s=>s.classList.remove("active")),o.classList.add("active"),I.currentView=o.dataset.view;const r=document.getElementById("week-days-toggle");if(I.currentView==="week"){if(r.style.display="flex",window.innerWidth<768){I.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(n=>n.classList.remove("active"));const s=document.querySelector('.week-days-btn[data-days="3"]');s&&s.classList.add("active")}}else r.style.display="none";te()})}),document.querySelectorAll(".week-days-btn").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(r=>r.classList.remove("active")),o.classList.add("active"),I.weekViewDays=parseInt(o.dataset.days,10),te()})}),document.getElementById("todayBtn").addEventListener("click",()=>{I.currentDate=new Date,te()});const a=o=>{const r=parseInt(o.currentTarget.dataset.amount,10),s=I.currentView==="week"?Ia():1,n=new Date(I.currentDate);n.setDate(n.getDate()+r*s),I.currentDate=n,te()};document.getElementById("prevBtn").addEventListener("click",a),document.getElementById("nextBtn").addEventListener("click",a),document.getElementById("profSearchInput").addEventListener("input",o=>{I.profSearchTerm=o.target.value,Lt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",o=>{I.showInactiveProfs=o.target.checked,Lt(),te()}),to||(eo.addEventListener("click",async o=>{const r=o.target.closest("[data-action]");if(o.target.dataset.action==="toggle-select-item"){const l=o.target.dataset.id;o.target.checked?I.selectedItems.add(l):I.selectedItems.delete(l),Ca();return}if(r&&r.dataset.action==="batch-delete"){const l=I.selectedItems.size;if(await V("Excluir em Lote",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)){const c=Array.from(I.selectedItems);let m=0;try{await Promise.all(c.map(async p=>{try{await Et(p),m++}catch(b){console.error(`Falha ao excluir ${p}`,b)}})),g(`${m} agendamento(s) excluído(s).`,"success"),I.selectedItems.clear(),I.isSelectionMode=!1,document.getElementById("btn-toggle-select").classList.remove("bg-blue-100","text-blue-700"),te()}catch{g("Erro ao processar exclusão em lote.","error")}}return}if(o.target.closest('[data-action="select-professional"]')){const d=o.target.closest('[data-action="select-professional"]').dataset.profId,c=I.selectedProfessionalId===d&&d!=="all";if(I.selectedProfessionalId=c?"all":d,d!=="all"){const m=document.getElementById("profSearchInput");m&&(m.value=""),I.profSearchTerm=""}await te();return}if(!r)return;const s=r.dataset.action;let n=null;const i=o.target.closest("[data-appointment]");switch(i&&(n=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"))),s){case"new-appointment":da();break;case"edit-appointment":if(I.isSelectionMode||!n)return;if(n.status==="completed"){g("Atenção","Agendamentos finalizados não podem ser editados.","error");return}n.hasRewards&&!n.redeemedReward&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),da(n);break;case"delete-appointment":{if(I.isSelectionMode)return;const l=r.dataset.id;if(await V("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Et(l),g("Agendamento apagado!","success"),te()}catch(c){g(`Não foi possível apagar: ${c.message}`,"error")}break}case"open-comanda":if(I.isSelectionMode)return;if(n){n.hasRewards&&!n.redeemedReward&&n.status!=="completed"&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const l=n.status==="completed"?"finalizadas":"em-atendimento",d={selectedAppointmentId:n.id,initialFilter:l};if(l==="finalizadas"){let c=n.startTime;if(n.transaction&&n.transaction.paidAt){const m=n.transaction.paidAt;typeof m=="object"&&m._seconds?c=new Date(m._seconds*1e3):c=m}d.filterDate=c}Z("comandas-section",d)}break}}),to=!0),await Hr(),await te()}const oo=document.getElementById("content");let so=!1;const ca=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let it=[],Vt=[],qe={},Pe=[],C={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},S={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function en(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function ss(e){const t=new Date(e);if(t.setHours(0,0,0,0),C.currentView==="week"&&C.weekViewDays===7){const a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(o))}return t}function Tt(){const e=document.getElementById("profSelectorContainer"),t=C.profSearchTerm.toLowerCase();if(!e||!u.professionals)return;let a=u.professionals.filter(s=>C.showInactiveProfs||s.status!=="inactive");t&&(a=a.filter(s=>s.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(s=>{const n=C.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],l=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),d=s.status!=="inactive",c=f(i),m=ca[0],p=s.id!=="all"&&u.professionalColors.get(s.id)||m,b=s.photo||`https://placehold.co/64x64/${p.main?.replace("#","")||"E0E7FF"}/${p.light?.replace("#","")||"4F46E5"}?text=${l}`,v=s.id==="all"?"#e0e7ff":p.light,h=s.id==="all"?"#4f46e5":p.main,x=`border: 3px solid ${n?p.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+p.border:"none"};`;return`
            <div class="prof-card ${n?"selected":""} ${d?"":"opacity-50"}" 
                 data-action="select-professional" 
                 data-prof-id="${s.id}">
                ${s.id==="all"?`<div class="prof-card-all-placeholder" style="background-color: ${v}; color: ${h}; ${x}">
        ...
        `}).join("")}function tn(e,t,a,o,r){const s=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${o} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${s}?text=${d}`}function an(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((o,r)=>new Date(o.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(o=>{const r=new Date(o.startTime),s=new Date(o.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=u.professionalColors.get(o.professionalId)||{},d=f(o.reason),c=f(o.professionalName),m=f(o.clientName),p=f(o.serviceName),b=C.selectedItems.has(o.id),v=C.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                 <input type="checkbox" class="w-5 h-5 text-indigo-600 rounded focus:ring-indigo-500 cursor-pointer" 
                        data-action="toggle-select-item" 
                        data-id="${o.id}" 
                        ${b?"checked":""}>
                ...
                </div>`;const h=o.status==="completed",y=h?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",x=h?"Finalizado":"Aberto",L=JSON.stringify(o).replace(/'/g,"&apos;"),w=o.redeemedReward?.points>0,E=o.hasRewards&&!w,T=tn(o.clientPhone,o.clientName,o.serviceName,o.professionalName,o.startTime),q=C.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${L}' style="border-left-color: ${l.border};">
            ...
            </div>`}).join("");t.innerHTML=`<div class="list-view-container space-y-2 pb-24">${a}</div>`}function La(){return window.innerWidth<768&&C.currentView==="week"?3:C.weekViewDays}function on(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"],o=ss(C.currentDate),r=La();let s=`<div class="grid divide-x divide-gray-200 min-h-[60vh]" style="grid-template-columns: repeat(${r}, minmax(0, 1fr));">`;for(let n=0;n<r;n++){const i=new Date(o);i.setDate(i.getDate()+n);const l=new Date,d=i.toDateString()===l.toDateString(),c=e.filter(p=>new Date(p.startTime).toDateString()===i.toDateString()).sort((p,b)=>new Date(p.startTime)-new Date(b.startTime));let m='<div class="p-1 space-y-2">';c.length>0?m+=c.map(p=>{const v=new Date(p.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),h=u.professionalColors.get(p.professionalId)||{bg:"#e5e7eb",border:"#9ca3af"},y=f(p.reason),x=f(p.professionalName),L=f(p.clientName),w=f(p.serviceName);if(p.type==="blockage")return`
                        <div class="p-2 rounded-lg border-l-4 flex flex-col bg-red-100" style="border-left-color: ${h.border};">
                            <span class="font-bold text-xs text-red-900">${v}</span>
                            <div class="mt-1 min-w-0">
                                <p class="font-semibold text-sm text-red-800 truncate">${y}</p>
        ...
        `}s+="</div>",t.innerHTML=s}function rs(){const e=u.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?an(e):on(e),Ta()}function Ta(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(C.isSelectionMode&&C.selectedItems.size>0?(e.innerHTML=`
            <div class="bg-white p-4 rounded-xl shadow-2xl border border-red-100 flex items-center justify-between gap-4">
        ...
        `,e.style.display="block",t&&(t.style.display="none")):(e.style.display="none",t&&(t.style.display="flex")))}async function ae(){const e=document.getElementById("agenda-view");if(!e)return;C.selectedItems.clear(),Ta(),e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const o=document.getElementById("weekRange");if(o){if(C.currentView==="list")t=new Date(C.currentDate),t.setHours(0,0,0,0),a=new Date(C.currentDate),a.setHours(23,59,59,999),o.textContent=en(t);else{const r=La();t=ss(new Date(C.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),o.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await jt(u.establishmentId,t.toISOString(),a.toISOString(),C.selectedProfessionalId==="all"?null:C.selectedProfessionalId),s=await st(u.establishmentId,t.toISOString(),a.toISOString(),C.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const n=s.map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=u.professionals?u.professionals.find(m=>m.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(u.allEvents=i,Tt(),rs(),C.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${C.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),C.scrollToAppointmentId=null}}catch(r){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',g("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"))}}}async function sn(){try{const[e,t,a]=await Promise.all([u.professionals&&u.professionals.length>0?Promise.resolve(u.professionals):K(u.establishmentId),u.services&&u.services.length>0?Promise.resolve(u.services):Se(u.establishmentId),qe.enabled!==void 0?Promise.resolve(null):ke(u.establishmentId)]);(!u.professionals||u.professionals.length===0)&&(u.professionals=e||[]),(!u.services||u.services.length===0)&&(u.services=t||[]),Pe=[],a&&(qe=a.loyaltyProgram||{enabled:!1}),u.professionals.forEach((o,r)=>{u.professionalColors.set(o.id,ca[r%ca.length])}),Tt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function ua(e){e<1||e>4||(S.step=e,ma(null,!0))}function ns(e,t){const a=document.getElementById("multiServiceToggle"),o=a&&a.checked,r=t.classList.contains("selected"),s=S.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),s>-1&&S.data.selectedServiceIds.splice(s,1);else{if(!o){S.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),S.data.selectedServiceIds.push(e)}}function is(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const o=Vt.find(r=>r.id===e);S.data.professionalId=e,S.data.professionalName=o?o.name:"N/A"}function rn(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(o=>o.classList.remove("selected")),t.classList.add("selected"),S.data.time=e)}async function ro(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=S.data.professionalId,o=S.data.selectedServiceIds,r=document.getElementById("apptDate").value;S.data.date=r;const s=o.reduce((n,i)=>{const l=it.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${s} min`,s===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await Ro({establishmentId:u.establishmentId,professionalId:a,serviceIds:o,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[m,p]=c.split(":").map(Number);return m*60+p>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${S.data.time===d?"selected":""}`,c.textContent=d,c.addEventListener("click",()=>rn(d,c)),t.appendChild(c)}),S.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${S.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function nn(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:o}=S.data,{enabled:r,rewards:s}=qe;if(!r||!t||!s||s.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const n=s.filter(l=>a>=l.points);let i=`
        <h4 class="text-md font-semibold text-gray-700 mb-2">🎁 Prêmios Disponíveis (${a} pontos)</h4>
    `;n.length>0?(i+='<div class="space-y-2">',i+=n.map(l=>{const d=o?.reward===l.reward,c=f(l.reward);return`
                <label class="flex items-center p-3 bg-white rounded-lg border border-gray-300 cursor-pointer hover:bg-gray-50">
                    <input type="radio" name="loyaltyReward" class="form-radio text-indigo-600" 
            ...
            `}).join(""),i+="</div>"):i+='<p class="text-sm text-gray-600">Pontos insuficientes para resgatar os prêmios disponíveis.</p>',e.innerHTML=i,e.querySelectorAll('input[name="loyaltyReward"]').forEach(l=>{l.addEventListener("change",d=>{d.target.checked&&(S.data.redeemedReward={reward:d.target.value,points:parseInt(d.target.dataset.points,10)})})}),e.insertAdjacentHTML("beforeend",`
        <label class="flex items-center p-3 mt-2 bg-white rounded-lg border border-gray-300 cursor-pointer hover:bg-gray-50">
            <input type="radio" name="loyaltyReward" class="form-radio text-gray-400" 
                   value="none" 
                   ${o?"":"checked"}>
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(S.data.redeemedReward=null)})}async function ln(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!S.data.time||S.data.selectedServiceIds.length===0||!S.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const o=S.data.selectedServiceIds.map(d=>{const c=it.find(m=>m.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,s]=S.data.time.split(":"),n=new Date(`${S.data.date}T${r}:${s}:00`),i={establishmentId:u.establishmentId,clientName:S.data.clientName,clientPhone:S.data.clientPhone,services:o,professionalId:S.data.professionalId,startTime:n.toISOString(),redeemedReward:S.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Fo(l,i):await jo(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",ae()}catch(d){g(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function ls(e){const t=S.data.clientName===e.name&&S.data.clientPhone===e.phone,a=f(e.name),o=f(e.phone);return`
        <div class="client-search-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-blue-50 ${t?"selected border-blue-500":""}" 
             data-action="select-client" 
             data-client-name="${a}" 
             data-client-phone="${o}"
    ...
    `}async function dn(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}t.innerHTML='<div class="loader-small mx-auto my-2"></div>';try{const o=await rt(u.establishmentId,a);if(Pe=o,o.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=o.map(ls).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(r=>{r.addEventListener("click",s=>{const n=r.dataset.clientName,i=r.dataset.clientPhone,l=parseInt(r.dataset.loyaltyPoints||"0",10);S.data.clientName=n,S.data.clientPhone=i,S.data.clientLoyaltyPoints=l;const d=qe,c=Math.min(...(d?.rewards||[]).map(m=>m.points));S.data.clientHasRewards=d.enabled&&c!==1/0&&S.data.clientLoyaltyPoints>=c,document.getElementById("apptClientName").value=n,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(m=>m.classList.remove("selected","border-blue-500")),r.classList.add("selected","border-blue-500")})})}catch(o){console.error("Erro na busca de clientes:",o),t.innerHTML='<p class="text-sm text-red-500">Erro ao buscar clientes.</p>'}}async function cn(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),o={establishmentId:u.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!o.name||!o.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await Ea(o),Pe.push({name:o.name,phone:o.phone,loyaltyPoints:0}),S.data.clientName=o.name,S.data.clientPhone=o.phone,S.data.clientHasRewards=!1,S.data.clientLoyaltyPoints=0,g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",ua(1)}catch(r){g(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function un(){ne({title:"Cadastrar Novo Cliente",contentHTML:`
        <form id="clientRegistrationForm" class="flex flex-col h-full">
            <div class="flex-1 overflow-y-auto p-5 space-y-6" style="max-height: 80vh;">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div><label for="regClientName" class="block text-sm font-medium text-gray-700">Nome</label><input type="text" id="regClientName" required class="mt-1 block w-full p-3 rounded-lg border-gray-300 shadow-sm"></div>
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",cn)}function mn(){un()}function pn(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",o=`
        <div class="p-5 space-y-6">
            <h3 class="text-xl font-bold text-gray-800">1. Dados do Cliente</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
    ...
    `;return{title:a,content:o}}function gn(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            <h3 class="text-xl font-bold text-gray-800">2. Serviços</h3>
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${it.map(o=>{const r=S.data.selectedServiceIds.includes(o.id),s=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=f(o.name);return`
                         <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${r?"selected border-blue-500":""}" data-service-id="${o.id}">
                             <div class="flex items-center">
                                 <img src="${s}" class="w-8 h-8 rounded-full object-cover mr-3 flex-shrink-0">
                                 <div class="flex-1">
    ...
    `;return{title:e,content:a}}function fn(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             <h3 class="text-xl font-bold text-gray-800">3. Profissional</h3>
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Vt.map(a=>{const o=S.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",s=f(a.name);return`
                         <div class="professional-modal-card p-3 bg-white rounded-lg border-2 border-gray-200 text-center cursor-pointer transition-all hover:bg-gray-50 ${o?"selected border-blue-500":""}" data-professional-id="${a.id}">
                             <img src="${r}" class="w-12 h-12 rounded-full object-cover mx-auto mb-1">
                             <p class="text-xs font-semibold text-gray-800">${s.split(" ")[0]}</p>
                             <p class="text-[10px] text-gray-500">${f(a.specialty||"Profissional")}</p>
    ...
    `;return{title:e,content:t}}function bn(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=S.data.date||o,s=f(S.data.clientName),n=f(S.data.professionalName),i=`
        <div class="p-5 space-y-6">
            <h3 class="text-xl font-bold text-gray-800">4. ${t}</h3>
    ...
    `;return{title:t,content:i}}function vn(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),o=it.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=S.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${s?"selected border-blue-500":""}" data-service-id="${r.id}">
                <div class="flex items-center">
                    <img src="${n}" class="w-8 h-8 rounded-full object-cover mr-3 flex-shrink-0">
                    <div class="flex-1">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>ns(r.dataset.serviceId,r))})}function hn(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),o=Vt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=S.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=f(r.name);return`
             <div class="professional-modal-card p-3 bg-white rounded-lg border-2 border-gray-200 text-center cursor-pointer transition-all hover:bg-gray-50 ${s?"selected border-blue-500":""}" data-professional-id="${r.id}">
                 <img src="${n}" class="w-12 h-12 rounded-full object-cover mx-auto mb-1">
                 <p class="text-xs font-semibold text-gray-800">${i.split(" ")[0]}</p>
                 <p class="text-[10px] text-gray-500">${f(r.specialty||"Profissional")}</p>
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>is(r.dataset.professionalId,r))})}async function ma(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const s=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(S={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:s,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}},e&&e.clientName)try{const i=await rt(u.establishmentId,e.clientName),l=i.find(d=>d.phone===e.clientPhone);l&&(S.data.clientLoyaltyPoints=l.loyaltyPoints||0,Pe=i)}catch(i){console.warn("Não foi possível carregar pontos do cliente para edição:",i)}}if(!u.services||!u.professionals||qe.enabled===void 0){g("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(it=u.services,Vt=u.professionals.filter(s=>s.status==="active"),S.data.clientLoyaltyPoints>0){const s=qe,n=Math.min(...(s?.rewards||[]).map(i=>i.points));S.data.clientHasRewards=s.enabled&&n!==1/0&&S.data.clientLoyaltyPoints>=n}let o={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(S.step){case 1:o=pn(e);break;case 2:o=gn();break;case 3:o=fn();break;case 4:o=bn(e);break}a.innerHTML=`
        <div class="modal-content max-w-4xl p-0 rounded-xl overflow-hidden shadow-2xl">
            <header class="p-5 border-b flex justify-between items-center bg-gray-50">
                <h2 class="text-xl font-bold text-gray-800">${o.title}</h2>
                <button type="button" data-action="close-modal" data-target="appointmentModal" class="text-2xl font-bold text-gray-500 hover:text-gray-900">&times;</button>
        ...
        </div>`,a.querySelectorAll('[data-action="close-modal"]').forEach(s=>{s.addEventListener("click",()=>{a.style.display="none"})}),a.querySelectorAll('[data-action="next-step"]').forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if(S.data.clientName=i.value.trim(),S.data.clientPhone=l.value.trim(),!S.data.clientName||!S.data.clientPhone)return g("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(S.data.selectedServiceIds.length===0)return g("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!S.data.professionalId)return g("Atenção","Selecione um profissional.","error");ua(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(s=>{s.addEventListener("click",()=>ua(parseInt(s.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if(S.step===4&&r&&r.addEventListener("submit",ln),a.style.display="flex",S.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>ns(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>vn(i.target.value))}if(S.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>is(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>hn(i.target.value))}if(S.step===1){const s=a.querySelector("#clientSearchInput");if(s&&(s.addEventListener("input",i=>dn(i.target.value)),S.data.clientName&&S.data.clientPhone&&Pe.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=Pe.map(ls).join(""))}const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",mn)}if(S.step===4){const s=a.querySelector("#apptDate");s&&s.addEventListener("change",ro),ro(),nn()}}async function xn(e={}){C.currentDate=e.targetDate?new Date(e.targetDate):C.currentDate||new Date,C.scrollToAppointmentId=e.scrollToAppointmentId||null,C.profSearchTerm="",C.isSelectionMode=!1,C.selectedItems.clear(),window.innerWidth<768&&(C.currentView="list"),oo.innerHTML=`
        <section>
            <div class="bg-white p-4 rounded-xl shadow-lg mb-4">
            ...
            <div id="batch-delete-container" class="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 hidden w-[90%] max-w-md"></div>
        </section>`;const t=document.getElementById("btn-toggle-select");t.addEventListener("click",()=>{C.isSelectionMode=!C.isSelectionMode,C.isSelectionMode||C.selectedItems.clear(),t.classList.toggle("bg-blue-100",C.isSelectionMode),t.classList.toggle("text-blue-700",C.isSelectionMode),rs()}),document.querySelectorAll(".view-btn[data-view]").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(s=>s.classList.remove("active")),o.classList.add("active"),C.currentView=o.dataset.view;const r=document.getElementById("week-days-toggle");if(C.currentView==="week"){if(r.style.display="flex",window.innerWidth<768){C.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(n=>n.classList.remove("active"));const s=document.querySelector('.week-days-btn[data-days="3"]');s&&s.classList.add("active")}}else r.style.display="none";ae()})}),document.querySelectorAll(".week-days-btn").forEach(o=>{o.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(r=>r.classList.remove("active")),o.classList.add("active"),C.weekViewDays=parseInt(o.dataset.days,10),ae()})}),document.getElementById("todayBtn").addEventListener("click",()=>{C.currentDate=new Date,ae()});const a=o=>{const r=parseInt(o.currentTarget.dataset.amount,10),s=C.currentView==="week"?La():1,n=new Date(C.currentDate);n.setDate(n.getDate()+r*s),C.currentDate=n,ae()};document.getElementById("prevBtn").addEventListener("click",a),document.getElementById("nextBtn").addEventListener("click",a),document.getElementById("profSearchInput").addEventListener("input",o=>{C.profSearchTerm=o.target.value,Tt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",o=>{C.showInactiveProfs=o.target.checked,Tt(),ae()}),so||(oo.addEventListener("click",async o=>{const r=o.target.closest("[data-action]");if(o.target.dataset.action==="toggle-select-item"){const l=o.target.dataset.id;o.target.checked?C.selectedItems.add(l):C.selectedItems.delete(l),Ta();return}if(r&&r.dataset.action==="batch-delete"){const l=C.selectedItems.size;if(await V("Excluir em Lote",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)){const c=Array.from(C.selectedItems);let m=0;try{await Promise.all(c.map(async p=>{try{await Et(p),m++}catch(b){console.error(`Falha ao excluir ${p}`,b)}})),g(`${m} agendamento(s) excluído(s).`,"success"),C.selectedItems.clear(),C.isSelectionMode=!1,document.getElementById("btn-toggle-select").classList.remove("bg-blue-100","text-blue-700"),ae()}catch{g("Erro ao processar exclusão em lote.","error")}}return}if(o.target.closest('[data-action="select-professional"]')){const d=o.target.closest('[data-action="select-professional"]').dataset.profId,c=C.selectedProfessionalId===d&&d!=="all";if(C.selectedProfessionalId=c?"all":d,d!=="all"){const m=document.getElementById("profSearchInput");m&&(m.value=""),C.profSearchTerm=""}await ae();return}if(!r)return;const s=r.dataset.action;let n=null;const i=o.target.closest("[data-appointment]");switch(i&&(n=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"))),s){case"new-appointment":ma();break;case"edit-appointment":if(C.isSelectionMode||!n)return;if(n.status==="completed"){g("Atenção","Agendamentos finalizados não podem ser editados.","error");return}n.hasRewards&&!n.redeemedReward&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),ma(n);break;case"delete-appointment":{if(C.isSelectionMode)return;const l=r.dataset.id;if(await V("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Et(l),g("Agendamento apagado!","success"),ae()}catch(c){g(`Não foi possível apagar: ${c.message}`,"error")}break}case"open-comanda":if(C.isSelectionMode)return;if(n){n.hasRewards&&!n.redeemedReward&&n.status!=="completed"&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const l=n.status==="completed"?"finalizadas":"em-atendimento",d={selectedAppointmentId:n.id,initialFilter:l};if(l==="finalizadas"){let c=n.startTime;if(n.transaction&&n.transaction.paidAt){const m=n.transaction.paidAt;typeof m=="object"&&m._seconds?c=new Date(m._seconds*1e3):c=m}d.filterDate=c}Z("comandas-section",d)}break}}),so=!0),await sn(),await ae()}const Da=e=>$(`/api/financial/natures/${e}`),yn=e=>$("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),wn=e=>$(`/api/financial/natures/${e}`,{method:"DELETE"}),Pa=e=>$(`/api/financial/cost-centers/${e}`),kn=e=>$("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),Sn=e=>$(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),ds=(e,t)=>$(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),cs=(e,t={})=>{let a=`/api/financial/${e}`;const o=new URLSearchParams;t.establishmentId&&o.append("establishmentId",t.establishmentId),t.startDate&&o.append("startDate",t.startDate),t.endDate&&o.append("endDate",t.endDate),t.natureId&&o.append("natureId",t.natureId),t.costCenterId&&o.append("costCenterId",t.costCenterId),t.status&&o.append("status",t.status);const r=o.toString();return r&&(a+=`?${r}`),$(a)},us=(e,t,a)=>$(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),ms=(e,t)=>$(`/api/financial/${e}/${t}`,{method:"DELETE"}),ps=(e,t,a)=>$(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),$n=e=>ds("payables",e),En=e=>cs("payables",e),In=(e,t)=>us("payables",e,t),Cn=e=>ms("payables",e),Ln=(e,t)=>ps("payables",e,t),Tn=e=>ds("receivables",e),Dn=e=>cs("receivables",e),Pn=(e,t)=>us("receivables",e,t),Bn=e=>ms("receivables",e),Mn=(e,t)=>ps("receivables",e,t),An=(e,t,a)=>$(`/api/financial/cash-flow?establishmentId=${e}&startDate=${t}&endDate=${a}`),pa=document.getElementById("content");let ue={};const no=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],M={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],cashFlowData:null,currentTab:"dashboards",isFilterOpen:!1};async function Nn(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function qn(){pa.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
        ...
        </div>`;try{await Nn();const[e,t]=await Promise.all([K(u.establishmentId),Dr(u.establishmentId).catch(()=>[])]);M.professionalsList=e||[],M.costCentersList=t||[],Rn(),await gs()}catch(e){console.error("Erro no loadReportsPage:",e),pa.innerHTML=`
            ...
            </div>`}}function Rn(){const e=M.professionalsList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join(""),t=M.costCentersList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join("");pa.innerHTML=`
    ...
    `,document.getElementById("toggle-filters-btn").onclick=io,document.getElementById("btn-apply-filters").onclick=()=>{jn(),io()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{M.currentTab=a.dataset.tab,lo(),fs(),window.scrollTo({top:0,behavior:"smooth"})}}),lo()}function io(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");M.isFilterOpen=!M.isFilterOpen,M.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function lo(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===M.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Dt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function jn(){M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.selectedProfessional=document.getElementById("report-prof").value,M.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Dt(M.startDate)} até ${Dt(M.endDate)}`,await gs()}async function gs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader border-t-indigo-600"></div></div>';try{const t=M.selectedProfessional==="all"?null:M.selectedProfessional,a=Tr(M.startDate,M.endDate,M.selectedProfessional,M.selectedCostCenter),o=An(u.establishmentId,M.startDate,M.endDate).catch(()=>({labels:[],payables:[],receivables:[],expectedBalance:[]})),r=new Date(M.startDate+"T00:00:00").toISOString(),s=new Date(M.endDate+"T23:59:59").toISOString(),n=jt(u.establishmentId,r,s,t).catch(()=>[]),[i,l,d]=await Promise.all([a,o,n]);M.data=i,M.cashFlowData=l,M.appointmentsData=Array.isArray(d)?d:[],fs()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function fs(){const e=document.getElementById("report-content");if(M.data)switch(M.currentTab){case"dashboards":Fn(e);break;case"appointments":Hn(e);break;case"dre":On(e);break}}function Fn(e){const{dreSimple:t,charts:a}=M.data,o=t||{grossRevenue:0,netProfit:0,variableCosts:0};e.innerHTML=`
    ...
    `,M.cashFlowData&&zn("chart-cashflow-modern",M.cashFlowData),co("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,no[0]),co("chart-profs","doughnut","Total Vendas",a.professionals.labels,a.professionals.data,no)}function Hn(e){const t=M.appointmentsData,a=t.length;let o=0,r=0,s=0;const n={},i={};let l=new Date(M.startDate);const d=new Date(M.endDate);for(;l<=d;)n[l.toISOString().split("T")[0]]=0,l.setDate(l.getDate()+1);t.forEach(b=>{const v=parseFloat(b.totalAmount||b.price||0),h=(b.status||"").toLowerCase();let y=b.startTime?(b.startTime.toDate?b.startTime.toDate():new Date(b.startTime)).toISOString().split("T")[0]:"";const x=b.professionalName||"Sem Profissional";i[x]||(i[x]={name:x,count:0,value:0}),["cancelled","cancelado","no-show"].includes(h)?r++:(["completed","finalized","paid"].includes(h)&&o++,s+=v,y&&n.hasOwnProperty(y)&&n[y]++,i[x].count++,i[x].value+=v)});const c=Object.keys(n).sort(),m=c.map(b=>n[b]),p=Object.values(i).sort((b,v)=>v.value-b.value);e.innerHTML=`
            ...
            <div class="overflow-x-auto no-scrollbar w-full">
                <table class="w-full text-xs md:text-sm min-w-full">
                    <tbody class="divide-y divide-gray-100">
                        ${p.map((b,v)=>{const h=p[0]?.value||1,y=b.value/h*100;return`
                            <tr class="group">
                        ...
                        `}).join("")}
                        ${p.length===0?'<tr><td colspan="4" class="p-8 text-center text-gray-400">Sem dados.</td></tr>':""}
                    </tbody>
                </table>
            </div>
        </div>
    `,Vn("chart-appointments-daily",c,m)}function On(e){const{dreFinancial:t}=M.data;if(!t)return;const a=t.totalRevenues,o=(i,l,d,c=!1)=>{const m=a>0?l/a*100:0,p=c?"- ":"";return`
    ...
    `}function zn(e,t){const a=document.getElementById(e);if(!a)return;const o=a.getContext("2d");ue[e]&&ue[e].destroy();const r=o.createLinearGradient(0,0,0,400);r.addColorStop(0,"rgba(59, 130, 246, 0.4)"),r.addColorStop(1,"rgba(59, 130, 246, 0.0)");const s=t.payables.map(i=>i*-1),n=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));ue[e]=new Chart(o,{type:"bar",data:{labels:n,datasets:[{label:"Saldo",data:t.expectedBalance,type:"line",borderColor:"#3b82f6",backgroundColor:r,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:6,hitRadius:30,fill:!0,tension:.4,order:0,yAxisID:"y"},{label:"Entradas",data:t.receivables,backgroundColor:"#34d399",borderRadius:4,barPercentage:.6,order:1,yAxisID:"y"},{label:"Saídas",data:s,backgroundColor:"#f87171",borderRadius:4,barPercentage:.6,order:2,yAxisID:"y"}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,font:{family:"'Inter', sans-serif",size:10}}},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(i),font:{size:10}}}}}})}function Vn(e,t,a){const o=document.getElementById(e);if(!o)return;const r=o.getContext("2d");ue[e]&&ue[e].destroy();const s=r.createLinearGradient(0,0,0,300);s.addColorStop(0,"rgba(99, 102, 241, 0.5)"),s.addColorStop(1,"rgba(99, 102, 241, 0.0)");const n=t.map(i=>i.split("-").reverse().slice(0,2).join("/"));ue[e]=new Chart(r,{type:"line",data:{labels:n,datasets:[{label:"Agendamentos",data:a,borderColor:"#6366f1",backgroundColor:s,borderWidth:2,fill:!0,tension:.4,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointHoverRadius:5,hitRadius:30}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#6366f1",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function co(e,t,a,o,r,s){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");ue[e]&&ue[e].destroy(),new Chart(i,{type:t,data:{labels:o,datasets:[{label:a,data:r,backgroundColor:s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:t==="doughnut"?{}:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9}}}}}})}const Ut=(e,t="products")=>$(`/api/${t}/categories/${e}`),bs=(e,t="products")=>$(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),vs=(e,t="products")=>$(`/api/${t}/categories/${e}`,{method:"DELETE"}),Un="audit_logs",Re=async(e,t,a,o,r,s=null)=>{try{if(!t)return;await Mo(pe(_,Un),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:o,description:r,details:s,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},ve=document.getElementById("content");let ie=null,Xe="services",ye="all";function je(){const e=U.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function _n(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await bs({establishmentId:u.establishmentId,name:o},"services"),Re(u.establishmentId,je(),"Categorias (Serviços)","Criou",`Criou categoria: ${o}`),a.value="",g("Sucesso","Categoria criada!","success"),await Ba(),await lt()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Wn(e){if(await V("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await vs(e,"services"),Re(u.establishmentId,je(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Ba(),await lt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ba(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Ut(u.establishmentId,"services");u.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Jn(){ne({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async E=>{const T=E.target.closest("button[data-action]");if(!T)return;const q=T.dataset.action,H=T.dataset.id;if(q==="close-modal"&&(t.style.display="none"),q==="delete-service"){if(!H)return;if(t.style.display="none",await V("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const P=u.services.find(j=>j.id===H)?.name||"Desconhecido";await rr(H),Re(u.establishmentId,je(),"Serviços","Excluiu",`Excluiu o serviço: ${P}`),g("Sucesso","Serviço apagado com sucesso!","success"),await lt()}catch(P){g("Erro",`Não foi possível apagar o serviço: ${P.message}`,"error")}else t.style.display="flex"}});const d=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");d.forEach(E=>{E.addEventListener("click",()=>{d.forEach(T=>{T.classList.remove("border-indigo-500","text-indigo-600"),T.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),E.classList.add("border-indigo-500","text-indigo-600"),E.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),c.forEach(T=>T.classList.add("hidden")),document.getElementById(`tab-content-${E.dataset.tab}`).classList.remove("hidden")})});const m=t.querySelectorAll('input[name="commissionType"]'),p=document.getElementById("defaultCommissionRateContainer"),b=document.getElementById("professionalCommissionsContainer");function v(){const E=t.querySelector('input[name="commissionType"]:checked').value;p&&(p.style.display=E==="default"?"block":"none"),b&&(b.style.display=E==="custom"?"block":"none")}m.forEach(E=>E.addEventListener("change",v));const h=document.getElementById("professionalCommissionsList");h&&(h.innerHTML=(u.professionals||[]).map(E=>{const T=e?.professionalCommissions?.[E.id]!==void 0,q=e?.professionalCommissions?.[E.id]||0;return`
                <div class="professional-commission-row flex items-center justify-between p-2 rounded-md ${T?"bg-blue-50":""}" data-prof-id="${E.id}">
                    ...
                    <div class="flex items-center gap-1">
                        <input type="number" value="${q}" class="w-20 p-1 border rounded-md text-sm text-center" ${T?"":"disabled"}>
                        <span class="text-sm font-semibold">%</span>
                    </div>
                </div>
            `}).join(""),h.querySelectorAll('input[type="checkbox"]').forEach(E=>{E.addEventListener("change",T=>{const q=T.target.closest(".professional-commission-row");q.querySelector('input[type="number"]').disabled=!T.target.checked,q.classList.toggle("bg-blue-50",T.target.checked)})})),v();const y=t.querySelector("#serviceForm"),x=t.querySelector("#servicePhotoInput"),L=t.querySelector("#servicePhotoPreview"),w=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>x.click()),x.onchange=async()=>{const E=x.files[0];if(E){L.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const T=await Qo(E,800,800,.8),H=T.length*3/4,D=1e3*1024;if(H>D)throw new Error("A imagem é muito grande mesmo após a compressão.");L.src=T,w.value=T}catch(T){console.error("Erro ao processar imagem:",T),g("Erro de Imagem",T.message||"Não foi possível processar a imagem.","error"),L.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",w.value=e?.photo||"",x.value=""}}},y.addEventListener("submit",Gn)}function Ie(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",o=new Map((u.serviceCategories||[]).map(s=>[s.id,s.name]));let r=(u.services||[]).filter(Boolean);if(ye!=="all"){const s=ye==="active";r=r.filter(n=>n.active!==!1===s)}r=r.filter(s=>{const n=s.name.toLowerCase().includes(t),i=a==="all"||s.categoryId===a;return n&&i}),e.innerHTML="",r.length>0?r.forEach(s=>{const n=document.createElement("div"),i=JSON.stringify(s).replace(/'/g,"&apos;");n.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:bg-gray-50 ${s.active!==!1?"opacity-100":"opacity-50 bg-gray-100"} sm:flex-col`,n.dataset.action="edit-service",n.dataset.service=i;const l=f(s.name),d=f(o.get(s.categoryId)||"N/A"),c=s.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(s.name.charAt(0))}`;n.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(u.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),Ma(),Ie()}function Yn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function lt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,o,r]=await Promise.all([Se(u.establishmentId),K(u.establishmentId),Ut(u.establishmentId,"services"),ir(u.establishmentId)]);u.services=(t||[]).filter(Boolean),u.professionals=(a||[]).filter(Boolean),u.serviceCategories=(o||[]).filter(Boolean),u.mostPopularService=r||{name:"N/A",count:0},u.services.forEach(s=>{s.active===void 0&&(s.active=!0)}),hs(Xe)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function hs(e){if(document.getElementById("services-content-container")){if(Xe===e&&document.getElementById("services-content-container").children.length>1){Xe==="services"&&(Ma(),Ie());return}Xe=e,ye="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Xn():e==="reports"&&Yn()}}function Qn(){ie&&(ve.removeEventListener("click",ie),ve.removeEventListener("input",ie),ve.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),s=r.dataset.id,n=r.checked;try{await nr(s,n);const i=u.services.findIndex(l=>l.id===s);i>-1&&(u.services[i].active=n),Re(u.establishmentId,je(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${n?"Ativo":"Inativo"}`),Ie(),Ma()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Ie()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Ie();return}if(!a)return;if(a.hasAttribute("data-view")){hs(a.dataset.view);return}switch(a.dataset.action){case"new-service":uo();break;case"edit-service":const r=JSON.parse(a.dataset.service);uo(r);break;case"manage-categories":Jn();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;ye=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===ye||i==="total"&&ye==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Ie();break}},ve.addEventListener("click",ie),ve.addEventListener("input",ie),ve.addEventListener("change",ie)}async function Zn(){ve.innerHTML=`
        ...
        </section>`,Qn();try{(!u.professionals||u.professionals.length===0)&&(u.professionals=await K(u.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),u.professionals=[]}Xe="services",ye="all",await lt()}const _t="suppliers",Aa="purchases",xs="financial_payables",Na=async e=>{try{const t=Rt(pe(_,_t),at("establishmentId","==",e)),a=await ya(t),o=[];return a.forEach(r=>{o.push({id:r.id,...r.data()})}),o}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Kn=async e=>{try{return{id:(await Mo(pe(_,_t),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},ei=async(e,t)=>{try{const a=me(_,_t,e);return await xa(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},ti=async e=>{try{const t=me(_,_t,e);return await Hs(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},ai=async(e,t=null)=>{try{const a=No(_),o=me(pe(_,Aa)),r={...e,createdAt:Va()};if(a.set(o,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const s=me(pe(_,xs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:o.id,createdAt:Va()};a.set(s,i)}return await a.commit(),{id:o.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},oi=async(e,t)=>{try{const a=No(_),o=me(_,Aa,e);a.delete(o);const r=Rt(pe(_,xs),at("purchaseId","==",e),at("establishmentId","==",t));return(await ya(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},si=async e=>{try{const t=Rt(pe(_,Aa),at("establishmentId","==",e),Ao("createdAt","desc")),a=await ya(t),o=[];return a.forEach(r=>{o.push({id:r.id,...r.data()})}),o}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},ge=document.getElementById("content");let le=null,Ye="products",se="all";async function ri(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await bs({establishmentId:u.establishmentId,name:o},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await qa(),await dt()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function ni(e){if(await V("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await vs(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await qa(),await dt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function qa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Ut(u.establishmentId,"products");u.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${f(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function ii(){ne({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",ri),t.addEventListener("click",o=>{const r=o.target.closest('button[data-action="delete-category"]');r&&ni(r.dataset.id)}))}qa()}async function li(e){if(!e)return;if(await V("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await dr(e),g("Sucesso","Produto apagado com sucesso!","success"),await dt()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function di(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),o=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),s=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(s).map(l=>l.dataset.id),i={establishmentId:u.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(o)?0:o,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await lr(t,i):await Vo(i),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await dt()}catch(l){throw new Error(l.message)}}function mo(e,t=800,a=800,o="image/jpeg",r=.8){return new Promise((s,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,m=d.height;c>m?c>t&&(m*=t/c,c=t):m>a&&(c*=a/m,m=a);const p=document.createElement("canvas");p.width=c,p.height=m,p.getContext("2d").drawImage(d,0,0,c,m);const v=p.toDataURL(o,r);s(v)},d.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function po(e=null){const t=document.getElementById("productModal"),a=u.categories||[],o=u.suppliers||[],r=a.map(D=>`<option value="${D.id}" ${e?.categoryId===D.id?"selected":""}>${f(D.name)}</option>`).join("");let s=new Set(e?.supplierIds||[]);const n=f(e?.name||""),i=e?.price||"",l=e?.costPrice||"",d=e?.commissionRate||"",c=e?.minStock||0,m=e?.maxStock||0,p=e?.currentStock||0,b=e?n:"Novo Produto";t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const v=t.querySelector("#productCategory"),h=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>h.click()),v.innerHTML='<option value="">Sem categoria</option>'+(u.categories||[]).map(D=>`<option value="${D.id}" ${e?.categoryId===D.id?"selected":""}>${f(D.name)}</option>`).join(""),e&&(v.value=e.categoryId||"");const y=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const x=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",L=e?.photo||"";h.onchange=async()=>{const D=h.files[0];if(D){y.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const P=await mo(D,800,800,"image/jpeg",.8),F=P.length*3/4,z=1e3*1024;if(F>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=P,base64Input.value=P}catch(P){console.error("Erro ao processar imagem:",P),g("Erro de Imagem",P.message||"Não foi possível processar a imagem.","error"),preview.src=x,base64Input.value=L,H.value=""}}};const w=t.cloneNode(!0);t.parentNode.replaceChild(w,t);const E=()=>{const D=w.querySelector("#modalSupplierSearch"),P=w.querySelector("#supplierSearchResults"),j=w.querySelector("#selectedSuppliersList"),F=D.value.toLowerCase();if(F.length>0){const z=o.filter(R=>R.name.toLowerCase().includes(F)&&!s.has(R.id));z.length>0?(P.classList.remove("hidden"),P.innerHTML=z.map(R=>`
                ...
                `).join("")):(P.classList.remove("hidden"),P.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else P.classList.add("hidden");s.size>0?(j.innerHTML="",s.forEach(z=>{const R=o.find(X=>X.id===z);R&&(j.innerHTML+=`
                    ...
                    `)})):j.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};w.querySelector("#modalSupplierSearch").addEventListener("input",E),w.addEventListener("click",D=>{const P=D.target.closest("[data-add-supplier]");if(P){const F=P.dataset.addSupplier;s.add(F),w.querySelector("#modalSupplierSearch").value="",E()}const j=D.target.closest("[data-remove-supplier]");if(j){const F=j.dataset.removeSupplier;s.delete(F),E()}}),E(),w.addEventListener("click",async D=>{const P=D.target.closest("button[data-action]");if(!P)return;const j=P.dataset.action,F=w.querySelector("#productId").value;if(j==="close-modal"&&(w.style.display="none"),j==="delete-product"){if(!F)return;w.style.display="none",await li(F)}if(j==="save-product-modal"){const z=w.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const R=P.closest('button[data-action="save-product-modal"]');R.disabled=!0,R.textContent="A salvar...";try{await di(z)}catch(X){g("Erro",`Falha ao salvar: ${X.message}`,"error"),R.disabled=!1,R.textContent="Salvar Alterações"}}}if(j==="adjust-stock-modal"){D.preventDefault();const z=w.querySelector("#stockAdjustmentAmount"),R=w.querySelector("#stockAdjustmentReason"),X=parseInt(z.value,10),$e=parseInt(P.dataset.change,10);if(!X||X<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Xt=X*$e,Ps=R.value||(Xt>0?"Entrada manual":"Saída manual");try{await cr(F,{change:Xt,reason:Ps});const ze=u.products.findIndex(Ve=>Ve.id===F);if(ze>-1){const Ve=u.products[ze].currentStock+Xt;u.products[ze].currentStock=Ve,w.querySelector("#currentStockDisplay").textContent=Ve,w.querySelector("#productCurrentStock").value=Ve,z.value="",R.value="",g("Sucesso","Estoque atualizado!","success"),Ra(),ot()}}catch(ze){g("Erro de Stock",ze.message,"error")}}});const T=w.querySelectorAll(".tab-btn"),q=w.querySelectorAll(".tab-content");T.forEach(D=>{D.addEventListener("click",P=>{P.preventDefault(),T.forEach(j=>{j.classList.remove("border-indigo-500","text-indigo-600"),j.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),D.classList.add("border-indigo-500","text-indigo-600"),D.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),q.forEach(j=>j.classList.add("hidden")),document.getElementById(`tab-content-${D.dataset.tab}`).classList.remove("hidden")})});const H=w.querySelector("#productPhotoInput");w.querySelector("#productPhotoButton").addEventListener("click",()=>H.click()),H.onchange=async()=>{const D=H.files[0];if(!D)return;const P=w.querySelector("#productPhotoPreview"),j=w.querySelector("#productPhotoBase64");P.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await mo(D,800,800,"image/jpeg",.8),R=F.length*3/4,X=1e3*1024;if(R>X)throw new Error("A imagem é muito grande mesmo após a compressão.");P.src=F,j.value=F}catch(F){console.error("Erro ao processar imagem:",F),g("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),P.src=x,j.value=L,H.value=""}},w.style.display="flex"}function ci(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(u.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),Ra(),ot()}function ui(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const o=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");r&&u.products&&(r.innerHTML+=u.products.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join("")),s&&u.categories&&(s.innerHTML+=u.categories.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join(""))}async function mi(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:u.establishmentId};try{const a=await ur(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function dt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,o]=await Promise.all([wa(u.establishmentId),Ut(u.establishmentId,"products"),Na(u.establishmentId)]);u.products=(t||[]).filter(Boolean),u.categories=(a||[]).filter(Boolean),u.suppliers=(o||[]).filter(Boolean),ys(Ye)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function ys(e){if(document.getElementById("products-content-container")){if(Ye===e&&document.getElementById("products-content-container").children.length>1){Ye==="products"&&(Ra(),ot());return}Ye=e,se="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?ci():e==="movements"&&ui()}}async function pi(){ge.innerHTML=`
        ...
        </section>`,le&&(ge.removeEventListener("click",le),ge.removeEventListener("input",le),ge.removeEventListener("change",le)),le=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){ot();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){ys(a.dataset.view);return}switch(a.dataset.action){case"new-product":po();break;case"edit-product":po(JSON.parse(a.dataset.product));break;case"manage-product-categories":ii();break;case"generate-report":await mi();break;case"filter-stock":const r=a.dataset.filterType;se=se===r?"all":r,document.querySelectorAll(".indicator-card").forEach(s=>{s.classList.toggle("ring-2",s.dataset.filterType===se),s.classList.toggle("ring-indigo-500",s.dataset.filterType===se),s.classList.toggle("shadow-lg",s.dataset.filterType===se)}),ot();break}},ge.addEventListener("click",le),ge.addEventListener("input",le),ge.addEventListener("change",le),Ye="products",se="all",await dt()}const fe=document.getElementById("content");let de=null,kt="list",O={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function gi(){kt==="list"?Wt():kt==="purchases"?(O.step=1,Qe()):kt==="history"&&ws()}async function fi(){try{const e=await Na(u.establishmentId);return u.suppliers=e||[],O.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function bi(e){if(await V("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await ti(e),g("Sucesso","Fornecedor excluído.","success"),Ft("genericModal"),Wt()}catch(t){g("Erro","Erro ao excluir: "+t.message,"error")}}async function vi(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,o={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:u.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await ei(a,o),g("Sucesso","Fornecedor atualizado!","success")):(await Kn(o),g("Sucesso","Fornecedor criado!","success")),Ft("genericModal"),Wt()}catch(s){g("Erro","Erro ao salvar: "+s.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Wt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await fi();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=u.suppliers.filter(s=>s.name.toLowerCase().includes(t)||s.contactName&&s.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let o='<div class="flex flex-col gap-2 md:hidden">';a.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=f(s.name),l=f(s.category||"Geral"),d=f(s.contactName||"");o+=`
    ...
    `;a.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=f(s.name),l=f(s.taxId||"Sem doc."),d=f(s.email||"-"),c=f(s.phone||"-"),m=f(s.category||"Geral");r+=`
            <tr class="hover:bg-gray-50">
    ...
    `;ne({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Qe(){const e=document.getElementById("purchasesContainer");if(e)if(O.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([wa(u.establishmentId),Na(u.establishmentId)]);O.allSuppliers=a||[];const o=t.filter(d=>{const c=parseInt(d.currentStock||0),m=parseInt(d.minStock||0);return c<=m});if(O.productsToBuy=o,o.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',s="";o.forEach(d=>{const c=parseInt(d.minStock)||0,m=parseInt(d.currentStock)||0,p=Math.max(c-m,1),b=parseFloat(d.costPrice||0),v=f(d.name);let h='<option value="">Selecione...</option>';O.allSuppliers.length>0?O.allSuppliers.forEach(y=>{const L=d.supplierIds&&d.supplierIds.includes(y.id)?"selected":"";h+=`<option value="${y.id}" ${L}>${f(y.name)}</option>`}):h='<option value="">Sem fornecedores</option>',r+=`
            ...
            `,ga()}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao calcular compras.</p>'}}else O.step===2&&xi(e)}function xi(e){if(!O.finalOrders||Object.keys(O.finalOrders).length===0){O.step=1,Qe();return}const t=O.isQuoteMode;let a="",o=0;const r=t?"border-indigo-100":"border-gray-200",s=t?"bg-indigo-50 border-indigo-100":"bg-gray-50 border-gray-200",n=t?"bg-blue-100 text-blue-700":"bg-green-100 text-green-700",i=t?"hidden":"flex",l=t?"Cotações Prontas":"Pedidos Prontos",d=t?"text-indigo-600":"text-green-600",c=t?"bg-indigo-50 border-indigo-100":"bg-green-50 border-green-100",m=t?"text-indigo-800":"text-green-800";for(const[p,b]of Object.entries(O.finalOrders)){let v=0,h=b.items.map(T=>{const q=T.qty*T.cost;return v+=q,`
        ...
        `}).join("");o+=v;const y=encodeURIComponent(JSON.stringify({supplierId:p,supplierName:b.info.name,totalAmount:v,items:b.items})),x=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),L=encodeURIComponent(JSON.stringify(b.items)),w=f(b.info.name),E=f(b.info.email||"");a+=`
    ...
    `}async function ws(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await si(u.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(s=>{const n=new Date(s.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=f(s.supplierName);a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function yi(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;ne({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",vi),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Ft("genericModal"))},50)}function ki(){fe.innerHTML=`
    ...
    `,de&&(fe.removeEventListener("click",de),fe.removeEventListener("input",de),fe.removeEventListener("change",de)),de=e=>{if(e.target.closest("#tab-btn-list")&&ut("list"),e.target.closest("#tab-btn-purchases")&&ut("purchases"),e.target.closest("#tab-btn-history")&&ut("history"),e.target.id==="toggle-quote-mode"&&(O.isQuoteMode=e.target.checked,Qe()),e.target.id==="supplierSearchInput"&&Wt(),e.target.closest("#btn-new-supplier")&&go(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),o=JSON.parse(a.dataset.supplier);hi(o)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&bi(t.dataset.id),a==="edit"&&go(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&ga(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(o=>o.checked=a),ga()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),o={};let r=!1;if(a.forEach(s=>{if(s.offsetParent===null||!s.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=s.querySelector("td:nth-child(2)"),d=s.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(s.querySelector(".qty-input").value),m=parseFloat(s.dataset.cost),b=s.querySelector(".supplier-select").value;if(b){if(!o[b]){const v=O.allSuppliers.find(h=>h.id===b);o[b]={info:v,items:[]}}o[b].items.push({name:i,qty:c,cost:m})}}),!r){g("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}O.finalOrders=o,O.step=2,Qe()}if(e.target.closest("#btn-back-step1")&&(O.step=1,Qe()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),o=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),s=parseFloat(a.dataset.total),n=O.isQuoteMode;if(o.phone){const i=o.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${o.name}*, tudo bem?
...
`,r.forEach(c=>{l+=`- ${c.qty}x ${c.name}
`}),l+=`
Aguardo confirmação.`);const d=`https://wa.me/${i}?text=${encodeURIComponent(l)}`;window.open(d,"_blank"),g("Aberto","WhatsApp aberto.","success")}else if(o.email){const i=n?`Solicitação de Cotação - ${u.establishmentName||"Empresa"}`:`Pedido de Compra - ${u.establishmentName||"Empresa"}`;let l=`Olá ${o.name},
...
Aguardo retorno.`;const d=`mailto:${o.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const o=JSON.parse(decodeURIComponent(a.dataset.order));o.establishmentId=u.establishmentId,a.disabled=!0,a.textContent="A processar...",ke(u.establishmentId).then(r=>{const s=r.purchaseConfig||null;return ai(o,s)}).then(()=>{g("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const o=e.target.closest(".btn-delete-purchase").dataset.id;V("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await oi(o,u.establishmentId),g("Sucesso","Compra e financeiro excluídos.","success"),ws()}catch(s){g("Erro","Erro ao excluir: "+s.message,"error")}})}if(e.target.closest(".btn-print-order")){const o=e.target.closest(".supplier-order-card").dataset.supplierId,r=O.finalOrders[o];r?wi(r,O.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),o=JSON.parse(a.dataset.purchase);yi(o)}},fe.addEventListener("click",de),fe.addEventListener("input",de),fe.addEventListener("change",de),ut("list")}function ut(e){kt=e,["list","purchases","history"].forEach(a=>{const o=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(o.classList.add("border-indigo-500","text-indigo-600"),o.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(o.classList.remove("border-indigo-500","text-indigo-600"),o.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),gi()}const Qt=document.getElementById("content"),fo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let re=new Set,mt=null,Ce=null;function Si(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function $i(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",o=f(t.name),r=f(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Zt(){const e=document.getElementById("genericModal");e.style.display="none",Ce&&e.removeEventListener("click",Ce)}async function Ei(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=f(a.name),r=u.services||await Se(u.establishmentId),s=u.professionals||await K(u.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",Ii(a,r),Ci(a),Li(a,s),Di(a)}function Ii(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,x)=>{const L=x+1,w=L==o[1]?"selected":"",E=new Date(0,x).toLocaleString("pt-BR",{month:"long"});return`<option value="${L}" ${w}>${E.charAt(0).toUpperCase()+E.slice(1)}</option>`}).join(""),s=e.status||"active",n=f(e.name||""),i=f(e.specialty||""),l=f(e.phone||""),d=f(e.notes||"");a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${d}</textarea></div>`;const c=document.getElementById("profPhotoInput"),m=document.getElementById("profPhotoButton"),p=document.getElementById("profPhotoPreview"),b=document.getElementById("profPhotoBase64"),v=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,h=e.photo||"";m&&m.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const y=c.files[0];if(y){p.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const x=await Qo(y,800,800,.8),w=x.length*3/4,E=1e3*1024;if(w>E)throw new Error("A imagem é muito grande mesmo após a compressão.");p.src=x,b.value=x}catch(x){g("Erro de Imagem",x.message||"Não foi possível processar a imagem.","error"),p.src=v,b.value=h,c.value=""}}})}function Ci(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',Ti(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function Li(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        </div>`;const o=document.getElementById("batchBlockageForm");o&&o.addEventListener("submit",async s=>{s.preventDefault();const n=Array.from(s.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(b=>b.value);if(n.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const i=s.target.batchBlockageStartDate.value,l=s.target.batchBlockageEndDate.value||i,d=s.target.batchBlockageStartTime.value,c=s.target.batchBlockageEndTime.value,m=s.target.batchBlockageReason.value;if(!i||!d||!c)return g("Atenção","Preencha Data de Início, Início e Fim.","error");const p=n.map(b=>{const v={professionalId:b,establishmentId:u.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${c}`).toISOString(),reason:m};return Ot(v)});try{await Promise.all(p),g("Sucesso!",`${n.length} bloqueios foram criados.`);const b=document.getElementById("prof-blockages-filter").value;Ze(e.id,b)}catch(b){g("Erro",b.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",s=>Ze(e.id,s.target.value)),await Ze(e.id,"future")}function Ti(e,t){e.innerHTML=Object.keys(fo).map(a=>{const o=t[a]||{},r=o.active!==!1;return`
            <div class="day-schedule-card p-3 rounded-lg ${r?"bg-white":"bg-gray-100 disabled"} border">
                 <div class="flex justify-between items-center"><span class="font-semibold text-gray-800">${fo[a]}</span><label class="flex items-center cursor-pointer"><div class="relative"><input type="checkbox" data-day="${a}" data-field="active" class="sr-only" ${r?"checked":""}><div class="toggle-bg block bg-gray-300 w-10 h-6 rounded-full"></div></div></label></div>
        ...
        `).join("")}catch(o){a.innerHTML=`<p class="text-red-500">${o.message}</p>`}}}function Di(e){const t=document.getElementById("genericModal");Ce&&t.removeEventListener("click",Ce),Ce=async a=>{const o=a.target.closest("button[data-action]");if(!o){const s=a.target.closest(".tab-link");s&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),s.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(s.dataset.tab).classList.remove("hidden"));return}const r=o.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Zt();break;case"delete-professional":const s=o.dataset.id;if(await V("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Oo(s),g("Sucesso!","Profissional excluído.","success"),Zt(),Pt()}catch(h){g("Erro",`Não foi possível excluir: ${h.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=o,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(h=>h.value),m={};d&&d.querySelectorAll(".day-schedule-card").forEach(h=>{const y=h.querySelector('[data-field="active"]').dataset.day;m[y]={active:h.querySelector('[data-field="active"]').checked,start:h.querySelector('[data-field="start"]').value,end:h.querySelector('[data-field="end"]').value,breakStart:h.querySelector('[data-field="breakStart"]').value,breakEnd:h.querySelector('[data-field="breakEnd"]').value}});const p={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:m,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:u.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{p.id?(await It(p.id,p),g("Sucesso!","Profissional atualizado.","success")):(delete p.id,await Ho(p),g("Sucesso!","Profissional criado.","success")),Zt(),Pt()}catch(h){g("Erro",h.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=o.dataset.id;if(await V("Apagar Bloqueio","Tem certeza?"))try{await $a(b),g("Bloqueio removido.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ze(e.id,h)}catch(h){g("Erro",h.message,"error")}break;case"batch-delete-blockage":const v=JSON.parse(o.dataset.ids);if(await V("Apagar em Lote",`Tem certeza que deseja apagar ${v.length} bloqueios com este motivo?`))try{await Xo(v),g("Bloqueios removidos.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ze(e.id,h)}catch(h){g("Erro",h.message,"error")}break}},t.addEventListener("click",Ce)}function fa(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(re.size>0?(t.textContent=`${re.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function Pi(){V("Excluir em Lote",`Tem certeza que deseja excluir ${re.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await or(Array.from(re)),g("Sucesso!",`${re.size} profissionais foram excluídos.`,"success"),re.clear(),fa(),Pt()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ue(){const e=document.getElementById("professionalsList");if(!e)return;if(!u.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Si();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),o=u.professionals.filter(r=>{const s=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return s&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=$i(o)}async function Pt(){re.clear(),Qt.innerHTML=`
        ...
        </section>`,mt&&Qt.removeEventListener("click",mt),mt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),o=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let s={};if(a.dataset.professional)try{s=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}Ei(s);return}if(o){Pi();return}const r=t.target.closest(".professional-checkbox");if(r){const s=r.dataset.id;r.checked?re.add(s):re.delete(s),Ue(),fa();return}},Qt.addEventListener("click",mt),document.getElementById("profSearchInput").addEventListener("input",Ue),document.getElementById("showInactiveProfToggle").addEventListener("change",Ue);const e=document.getElementById("professionalsList");u.professionals=null,u.services=null,Ue();try{const[t,a]=await Promise.all([K(u.establishmentId),Se(u.establishmentId)]);u.professionals=t,u.services=a,Ue(),fa()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const bo=e=>$(`/api/sales?clientId=${e}`);let B={clients:[],selectedClient:null,activeTab:"profile",searchTerm:"",loading:!1,historyData:{appointments:[],sales:[]}},ks=null;function Jt(){ks.innerHTML=`
        <section class="h-full flex flex-col bg-gray-50">
            ...
            <div id="clients-content-area" class="flex-grow overflow-y-auto p-4 custom-scrollbar">
                ${B.loading?'<div class="loader mx-auto mt-10"></div>':""}
            </div>
        </section>
    `;const e=document.getElementById("btn-new-client"),t=document.getElementById("btn-back-list");e&&(e.onclick=Ri),t&&(t.onclick=()=>{B.selectedClient=null,Fe()})}function Fe(){Jt();const e=document.getElementById("clients-content-area"),t=B.clients.filter(s=>s.name.toLowerCase().includes(B.searchTerm.toLowerCase())||s.phone&&s.phone.includes(B.searchTerm)),a=`
    ...
    `,o=t.length>0?`
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
            ${t.map(s=>`
                <div class="client-card bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition cursor-pointer group relative overflow-hidden" data-id="${s.id}">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-grow min-w-0">
                            <h3 class="font-bold text-gray-800 truncate text-lg">${f(s.name)}</h3>
    ...
    `;e.innerHTML=a+o;const r=document.getElementById("client-search");r.focus(),r.setSelectionRange(r.value.length,r.value.length),r.addEventListener("input",s=>{B.searchTerm=s.target.value,Fe()}),e.querySelectorAll(".client-card").forEach(s=>{s.onclick=()=>$s(s.dataset.id)})}async function Ss(){Jt();const e=document.getElementById("clients-content-area"),t=B.selectedClient;if(!t)return Fe();B.activeTab!=="profile"&&await qi(t.id);const a=`
        <div class="flex gap-2 mb-6 border-b overflow-x-auto pb-1">
            <button class="tab-btn ${B.activeTab==="profile"?"active-tab":""}" data-tab="profile">
                👤 Perfil
            </button>
            <button class="tab-btn ${B.activeTab==="appointments"?"active-tab":""}" data-tab="appointments">
                📅 Agendamentos
            </button>
            <button class="tab-btn ${B.activeTab==="history"?"active-tab":""}" data-tab="history">
                💰 Histórico / Comandas
            </button>
        </div>
    `;let o="";B.activeTab==="profile"?o=Bi(t):B.activeTab==="appointments"?o=Mi():B.activeTab==="history"&&(o=Ai()),e.innerHTML=`
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-white">
                <div class="flex flex-col md:flex-row items-center gap-4">
                    ...
                    <div class="text-center md:text-left">
                        <h2 class="text-2xl font-bold">${f(t.name)}</h2>
                        <p class="opacity-90 text-sm">${t.phone||"Sem telefone"}</p>
    ...
    `,e.appendChild(r),e.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=()=>{B.activeTab=s.dataset.tab,Ss()}}),B.activeTab==="profile"&&(document.getElementById("form-edit-client").onsubmit=ji,document.getElementById("btn-delete-client").onclick=Fi),e.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=n=>{const i=s.dataset.date,l=s.dataset.id;Z("agenda-section",{targetDate:new Date(i),scrollToAppointmentId:l})}}),e.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=n=>{const i=s.dataset.id;Z("comandas-section",{selectedAppointmentId:i,initialFilter:"finalizadas"})}})}function Bi(e){return`
        <form id="form-edit-client" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nome Completo</label>
                    <input type="text" name="name" value="${f(e.name)}" required class="mt-1 block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Telefone</label>
                    <input type="tel" name="phone" value="${f(e.phone||"")}" class="mt-1 block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">E-mail</label>
                    <input type="email" name="email" value="${f(e.email||"")}" class="mt-1 block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                </div>
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Aniversário (Dia)</label>
                        <input type="number" name="dobDay" min="1" max="31" value="${e.dobDay||""}" class="mt-1 block w-full p-3 rounded-lg border border-gray-300">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Mês</label>
                        <input type="number" name="dobMonth" min="1" max="12" value="${e.dobMonth||""}" class="mt-1 block w-full p-3 rounded-lg border border-gray-300">
                    </div>
                </div>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Observações</label>
                <textarea name="notes" rows="3" class="mt-1 block w-full p-3 rounded-lg border border-gray-300 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">${f(e.notes||"")}</textarea>
            </div>
    ...
    `}function Mi(e){const t=B.historyData.appointments||[],a=new Date,o=t.filter(n=>new Date(n.startTime)>=a).sort((n,i)=>new Date(n.startTime)-new Date(i.startTime)),r=t.filter(n=>new Date(n.startTime)<a).sort((n,i)=>new Date(i.startTime)-new Date(n.startTime)),s=(n,i)=>{const l=new Date(n.startTime),d=l.toLocaleDateString("pt-BR",{weekday:"short",day:"2-digit",month:"long"}),c=l.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`
            <div class="history-card bg-white border border-gray-200 rounded-lg p-4 mb-3 transition-all cursor-pointer relative overflow-hidden group"
                 data-go-agenda="true" data-id="${n.id}" data-date="${n.startTime}">
                <div class="absolute left-0 top-0 bottom-0 w-1 ${i?"bg-gray-400":"bg-green-500"}"></div>
                <div class="flex justify-between items-start">
                    <div>
                        <p class="font-bold text-gray-800 flex items-center gap-2">
                            ${d} <span class="text-sm font-normal text-gray-500">às ${c}</span>
                        </p>
                        <p class="text-sm text-gray-600 mt-1 font-medium">${f(n.serviceName||"Serviço")}</p>
                        <p class="text-xs text-gray-500">Profissional: ${f(n.professionalName||"N/A")}</p>
                    </div>
                    <div class="text-right">
                        <span class="text-xs px-2 py-1 rounded-full ${i?"bg-gray-100 text-gray-600":"bg-green-100 text-green-700 font-bold"}">
                            ${i?"Concluído":"Agendado"}
                        </span>
        ...
        <div class="space-y-6">
            <div>
                ...
                ${o.length?o.map(n=>s(n,!1)).join(""):'<p class="text-sm text-gray-400 italic bg-gray-50 p-3 rounded">Nenhum agendamento futuro.</p>'}
            </div>
            ...
            <div>
                ...
                ${r.length?r.slice(0,5).map(n=>s(n,!0)).join(""):'<p class="text-sm text-gray-400 italic bg-gray-50 p-3 rounded">Nenhum histórico.</p>'}
            </div>
        </div>
    `}function Ai(e){const t=B.historyData.sales||[];return t.length===0?`
            <div class="text-center py-10">
                <p class="text-gray-400">Nenhum registro financeiro encontrado.</p>
            </div>
        `:`
        <div class="space-y-3">
            ${t.map(a=>{const o=new Date(a.date||a.createdAt),r=a.totalAmount||a.total||0,s=(a.items||[]).length;return`
                <div class="history-card bg-white border border-gray-200 rounded-lg p-4 flex justify-between items-center cursor-pointer transition group"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-bold text-gray-800">Venda #${a.id.slice(-4)}</p>
                            <p class="text-xs text-gray-500">${o.toLocaleDateString()} • ${s} iten(s)</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="font-bold text-green-600">R$ ${parseFloat(r).toFixed(2)}</p>
                        <span class="text-[10px] text-indigo-500 font-bold opacity-0 group-hover:opacity-100 transition">Ver Detalhes &rarr;</span>
                    </div>
                </div>
                `}).join("")}
        </div>
    `}async function Ni(){B.loading=!0,Jt();try{B.clients=await rt(u.establishmentId,""),Fe()}catch{g("Erro","Falha ao carregar clientes.","error")}finally{B.loading=!1,Fe()}}async function qi(e){try{const t=new Date,a=new Date;a.setMonth(a.getMonth()-6);const o=new Date;o.setMonth(o.getMonth()+6);const r=await jt(u.establishmentId,a.toISOString(),o.toISOString()),s=B.selectedClient,n=r.filter(i=>i.clientId&&i.clientId===s.id||i.clientPhone===s.phone||i.clientName.toLowerCase()===s.name.toLowerCase());B.historyData.appointments=n,bo?B.historyData.sales=await bo(s.id):B.historyData.sales=n.filter(i=>i.status==="completed").map(i=>({id:i.id,date:i.startTime,totalAmount:i.totalAmount||0,items:i.services||[]}))}catch(t){console.error("Erro ao buscar histórico",t)}}function $s(e){B.selectedClient=B.clients.find(t=>t.id===e),B.activeTab="profile",Ss()}function Ri(){const e=`
    ...
    `,{modalElement:t,close:a}=ne({title:"Novo Cliente",contentHTML:e});t.querySelector("form").onsubmit=async o=>{o.preventDefault();const r=document.getElementById("new-name").value,s=document.getElementById("new-phone").value;try{const n=await Ea({establishmentId:u.establishmentId,name:r,phone:s});B.clients.unshift(n),g("Sucesso","Cliente criado!","success"),a(),$s(n.id)}catch(n){g("Erro",n.message,"error")}}}async function ji(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());try{await Ar(B.selectedClient.id,a),Object.assign(B.selectedClient,a);const o=B.clients.findIndex(r=>r.id===B.selectedClient.id);o!==-1&&(B.clients[o]=B.selectedClient),g("Sucesso","Dados atualizados!","success")}catch(o){g("Erro","Falha ao salvar: "+o.message,"error")}}async function Fi(){if(await V("Excluir Cliente","Tem certeza? Todo o histórico será perdido."))try{await Nr(B.selectedClient.id),B.clients=B.clients.filter(e=>e.id!==B.selectedClient.id),B.selectedClient=null,g("Sucesso","Cliente removido.","success"),Fe()}catch(e){g("Erro",e.message,"error")}}async function Hi(){ks=document.getElementById("content"),B.selectedClient=null,B.searchTerm="",Jt(),await Ni()}const he=document.getElementById("content"),Kt={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},Oi={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}},Es=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"},{id:"support",icon:"M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",label:"Suporte e Ajuda"},{id:"cancellation",icon:"M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z",label:"Cancelar Assinatura"}];let J=null;function vo(e,t,a){return new Promise((o,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const p=e.type==="image/png"&&t<500?"image/png":"image/jpeg";o(l.toDataURL(p,a))},i.onerror=l=>r(l)},s.onerror=n=>r(n)})}function Ee(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const o=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i="")=>{const l=n.id===t?"selected":"";a+=`<option value="${n.id}" ${l}>${i}${f(n.name)}</option>`,n.children.forEach(d=>r(d,i+"— "))};return o(e).forEach(n=>r(n)),a}async function He(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const o=J||await ke(u.establishmentId),r=[],{ownerName:s,...n}=e;if(s&&s!==u.userName){const l=U.currentUser;l&&r.push(qs(l,{displayName:s}).then(()=>{u.userName=s}))}const i={...o,...n};if(r.push(yt(u.establishmentId,i)),await Promise.all(r),J=i,g("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),n.themeColor)setTimeout(()=>window.location.reload(),1500);else{const l=document.getElementById("panelEstablishmentName");n.name&&l&&(l.textContent=n.name,u.establishmentName=n.name)}}catch(o){g("Erro",`Não foi possível salvar: ${o.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function zi(e,t){const a=f(e.name||""),o=f(e.phone||""),r=f(e.document||""),s=f(e.email||""),n=f(e.address||""),i=f(e.website||""),l=f(u.userName||"");t.innerHTML=`
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!o||!r){g("Erro","Preencha todos os campos.","error");return}const s=t.querySelector('button[form="change-email-form"]');s.disabled=!0,s.textContent="A verificar...";try{const n=U.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=Bs.credential(n.email,r);await Ms(n,i),s.textContent="A enviar link...",await As(n,o),s.textContent="A atualizar BD...",await tr(u.establishmentId,o),g("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,g("Erro",i,"error")}finally{s.disabled=!1,s.textContent="Salvar Novo E-mail"}})}function _i(e,t){const a=f(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");if(e.timezone)a.value=e.timezone;else try{const s=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(a.options).some(i=>i.value===s)?a.value=s:a.value="America/Sao_Paulo"}catch{a.value="America/Sao_Paulo"}const o=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(Kt).forEach(s=>{const n=r[s]||{},i=Kt[s],l=n.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${l?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,o.appendChild(d)}),o.addEventListener("change",s=>{const n=s.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",s=>{s.preventDefault();const n={};Object.keys(Kt).forEach(l=>{n[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;He({workingHours:n,timezone:i},s)})}function Gi(e,t){const a=e.loyaltyProgram||{},o=a.type||"amount",r=a.pointsPerCurrency||10,s=a.pointsPerVisit||1;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#loyaltyEnabled").checked=a.enabled||!1;const n=t.querySelectorAll('input[name="loyaltyType"]'),i=t.querySelector("#loyalty-config-amount"),l=t.querySelector("#loyalty-config-visit");n.forEach(m=>{m.addEventListener("change",p=>{const b=p.target.value;n.forEach(v=>{const h=v.closest("label");v.checked?h.classList.add("border-indigo-500","bg-indigo-50","ring-1","ring-indigo-500"):h.classList.remove("border-indigo-500","bg-indigo-50","ring-1","ring-indigo-500")}),b==="amount"?(i.classList.remove("hidden"),l.classList.add("hidden")):(i.classList.add("hidden"),l.classList.remove("hidden"))})});const d=t.querySelector("#loyaltyTiersContainer"),c=(m={})=>{const p=document.createElement("div"),b=f(m.reward||"");return p.className="loyalty-tier-row group bg-white md:bg-transparent p-3 md:p-0 border md:border-0 rounded-lg shadow-sm md:shadow-none relative",p.innerHTML=`
    ...
    `;try{const[a,o]=await Promise.all([Da(u.establishmentId),Pa(u.establishmentId)]),r=e.financialIntegration||{},s=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ee(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ee(o,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ee(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ee(o,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ee(a,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ee(o,s.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const o={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};He(o,a)})}function Yi(e,t){const a="5516997859430",o=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${o}`;t.innerHTML=`
    ...
    `}function Qi(e,t){const a="5516997859430",o=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),r=`https://wa.me/${a}?text=${o}`,s="sistemakairosagenda@gmail.com";t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function Is(e="indigo",t){const a=t.querySelector("#color-palette-container"),o=t.querySelector("#establishmentThemeColor");!a||!o||(a.innerHTML="",Object.entries(Oi).forEach(([r,s])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{o.value=r,Is(r,t)}),a.appendChild(i)}),o.value=e)}function Ki(e,t){const a=t.querySelector("#slotIntervalContainer"),o=t.querySelector("#establishmentSlotInterval");if(!a||!o)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(s=>{const n=s.value===e;return`<button type="button" data-value="${s.value}" 
    ...
    `,he.querySelector('button[data-action="back-to-list"]').addEventListener("click",o=>{o.preventDefault(),Cs()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":zi(J,a);break;case"change-password":Vi(J,a);break;case"change-email":Ui(J,a);break;case"branding":_i(J,a);break;case"booking":Wi(J,a);break;case"working-hours":Ji(J,a);break;case"loyalty":Gi(J,a);break;case"financial":await Xi(J,a);break;case"support":Yi(J,a);break;case"cancellation":Qi(J,a);break;default:Zi(t?t.label:"Definições",a)}}async function Cs(){if(he.innerHTML=`
    ...
    `,!J)try{J=await ke(u.establishmentId)}catch{g("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),he.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const e=U.currentUser;e&&e.displayName&&(u.userName=e.displayName);const t=f(u.userName||U.currentUser.email);let o=`https://placehold.co/96x96/E2E8F0/4A5568?text=${t?t.charAt(0).toUpperCase():"U"}`;e&&e.photoURL&&(o=e.photoURL),he.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
        ...
        <div data-action="go-to-my-profile" class="bg-white p-4 rounded-lg shadow-md mb-6 cursor-pointer hover:bg-gray-50 transition-all">
            <div class="text-center relative">
                ...
                <div class="absolute top-0 right-0 p-2 text-gray-400 hover:text-indigo-600" title="Ver Meu Perfil">
                 ...
                 ${u.userName&&u.userName!==U.currentUser.email?`<p class="text-sm text-gray-500">${f(U.currentUser.email)}</p>`:""}
    ...
    `,he.querySelector("#settings-menu-list").addEventListener("click",s=>{const n=s.target.closest("button[data-section]");n&&(s.preventDefault(),el(n.dataset.section))});const r=he.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",s=>{s.preventDefault(),Z("my-profile-section")})}const Ke=document.getElementById("content");async function Be(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,o=document.getElementById("filterEndDate")?.value,r=await st(u.establishmentId,a||new Date().toISOString().split("T")[0],o||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),n=s?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${f(l)} (${d.length})</h4>`;if(d.length>1){const b=JSON.stringify(d.map(v=>v.id));p+=`<button data-action="batch-delete-blockage" data-ids='${b}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",c.innerHTML=p,d.forEach(b=>{const v=new Date(b.startTime),h=new Date(b.endTime),y=v.toLocaleDateString("pt-BR"),x=h.toLocaleDateString("pt-BR"),w=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${y===x?`${y} | ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${h.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${y} às ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${x} às ${h.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
                    ...
                    </div>`;c.innerHTML+=w}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function tl(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,o=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||o,s=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:u.establishmentId,professionalId:a,startTime:new Date(`${o}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Ot(i),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),Be(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function al(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const o=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||o,s=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const m={establishmentId:u.establishmentId,professionalId:c,startTime:new Date(`${o}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Ot(m)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(m=>m.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Be(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function ol(e){Ke.addEventListener("submit",t=>{t.target.id==="blockageForm"&&tl(t),t.target.id==="batchBlockageForm"&&al(t)}),Ke.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Be(e)}),Ke.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const o=a.dataset.action;if(o==="back-to-professionals")Z("profissionais-section");else if(o==="delete-blockage"){if(await V("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await $a(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),Be(e)}catch(s){g("Erro",`Não foi possível remover o bloqueio: ${s.message}`,"error")}}else if(o==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await V("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Xo(r),g("Sucesso",`${r.length} bloqueios removidos.`,"success"),Be(e)}catch(n){g("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function sl(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){Ke.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const o=f(a);Ke.innerHTML=`
        <section>
        ...
        </section>`,ol(t),await Be(t);const r=document.getElementById("batchProfSelectionContainer");try{const s=await K(u.establishmentId);r.innerHTML=s.map(n=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const rl=e=>$(`/api/users/${e}`),nl=e=>$("/api/users",{method:"POST",body:JSON.stringify(e)}),il=(e,t)=>$(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),ll=e=>$(`/api/users/${e}`,{method:"DELETE"}),dl=(e,t)=>$(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),cl=(e,t)=>$(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),be=document.getElementById("content"),ul={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},ml={view:"Visualizar",create:"Criar",edit:"Editar"};let _e=null,We=null;function pl(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const o=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${o}</p>`;return}e.sort((o,r)=>(o.status==="active"?-1:1)-(r.status==="active"?-1:1)),t.innerHTML=e.map(o=>{const r=JSON.stringify(o).replace(/'/g,"&apos;"),s=o.status==="active",n=u.professionals.find(c=>c.id===o.professionalId),i=n?n.name:"N/A",l=n?n.name.charAt(0):o.name.charAt(0),d=n?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function St(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=u.users:t=u.users.filter(a=>a.status==="active"),pl(t)}function gl(e={}){return Object.entries(ul).map(([t,a])=>{const o=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,s=Object.entries(ml).map(([i,l])=>`
    ...
    `}).join("")}async function ho(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=u.professionals;if(!a||a.length===0)try{a=await K(u.establishmentId),u.professionals=a}catch{g("Erro","Não foi possível carregar a lista de profissionais.","error")}const o=x=>a.find(L=>L.id===x),r=(x,L)=>{const E=o(x)?.photo,T=L.charAt(0).toUpperCase();return{photoSrc:E||`https://placehold.co/128x128/E2E8F0/4A5568?text=${T}`,initials:T,photoUrl:E||""}},s=e?.professionalId,n=e?.name||"Novo Usuário",i=r(s,n),l=o(s),d=x=>{let L='<option value="">-- Não Associado a um Profissional --</option>';return L+=a.map(w=>`<option value="${w.id}" ${w.id===x?"selected":""}>${w.name} (${w.specialty||"N/A"})</option>`).join(""),L},c=e!==null;t.querySelector("#userFormTitle").textContent=c?`Editar Usuário: ${e.name}`:"Novo Usuário";const m=t.querySelector("#userForm");m.innerHTML=`
    ...
    `;const p=window.innerWidth<768,b=m.querySelector(".bg-white");if(p&&b){b.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const x=m.closest("section");x&&(x.style.padding="0",x.style.margin="0"),b.classList.add("p-4")}const v=m.querySelector("#userProfessionalId"),h=m.querySelector("#userPhotoPreview"),y=m.querySelector("#profPhotoName");if(v.addEventListener("change",x=>{const L=x.target.value,w=o(L),E=w?w.name:"Selecione um profissional",T=r(L,n);h.src=T.photoSrc,y.textContent=E,m.querySelector("#professionalPhotoUrl").value=T.photoUrl}),m.addEventListener("submit",async x=>{x.preventDefault();const L=e?.email,w=m.querySelector("#userEmail").value,E={};m.querySelectorAll('input[type="checkbox"]').forEach(H=>{const D=H.dataset.module,P=H.dataset.permission;E[D]||(E[D]={}),E[D][P]=H.checked});const T=m.querySelector("#userProfessionalId").value||null,q={name:m.querySelector("#userName").value,permissions:E,professionalId:T,establishmentId:u.establishmentId};try{c?(L!==w&&(q.email=w),await il(e.id,q),g("Usuário atualizado com sucesso!","success")):(q.email=m.querySelector("#userEmail").value,q.password=m.querySelector("#userPassword").value,await nl(q),g("Usuário criado com sucesso!","success")),Bt()}catch(H){g(`Erro: ${H.message}`,"error")}}),c){const x=m.querySelector("#password-change-container"),L=x.querySelector('[data-action="show-password-form"]'),w=x.querySelector("#password-form"),E=w.querySelector('[data-action="save-password"]'),T=w.querySelector('[data-action="cancel-password-change"]');L.addEventListener("click",()=>{L.classList.add("hidden"),w.classList.remove("hidden")}),T.addEventListener("click",()=>{L.classList.remove("hidden"),w.classList.add("hidden"),w.querySelector("#userNewPassword").value=""}),E.addEventListener("click",async()=>{const q=w.querySelector("#userNewPassword").value;if(!q||q.length<6){g("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await V("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{E.disabled=!0,E.textContent="Aguarde...",await dl(e.id,q),g("Sucesso!","A senha do usuário foi alterada.","success"),L.classList.remove("hidden"),w.classList.add("hidden"),w.querySelector("#userNewPassword").value=""}catch(D){g("Erro",`Não foi possível alterar a senha: ${D.message}`,"error")}finally{E.disabled=!1,E.textContent="Salvar Nova Senha"}})}}async function fl(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([rl(u.establishmentId),K(u.establishmentId)]);u.users=t,u.professionals=a,St()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Bt(){be.innerHTML=`
    ...
    `,_e&&be.removeEventListener("click",_e),We&&be.removeEventListener("change",We),_e=async e=>{if(!document.getElementById("user-list-view")){be.removeEventListener("click",_e);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":ho();break;case"edit-user":const o=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));ho(o);break;case"back-to-list":Bt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await V("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await ll(r),g("Usuário excluído com sucesso!","success"),Bt()}catch(n){g(`Erro ao excluir: ${n.message}`,"error")}break}}},We=async e=>{if(!document.getElementById("user-list-view")){be.removeEventListener("change",We);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")St();else if(t){e.stopPropagation();const a=t.dataset.userId,o=t.checked?"active":"inactive";try{await cl(a,o),g(`Usuário ${o==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=u.users.findIndex(s=>s.id===a);r>-1&&(u.users[r].status=o,St())}catch(r){g(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,St()}}},be.addEventListener("click",_e),be.addEventListener("change",We),await fl()}const bl=()=>$("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),vl=document.getElementById("content");let xo={},ba=null;function hl(){Object.values(xo).forEach(e=>e?.destroy()),xo={}}function xl(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,o=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(o.setFontSize(18),o.text(e,o.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];o.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=o.lastAutoTable?o.lastAutoTable.finalY+20:60;o.text("Detalhes das Vendas",20,s),o.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),o.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function yo(e){const t=document.getElementById("genericModal"),a=f(e.client),o=f(e.items),r=f(e.responsavelCaixa||"N/A"),s=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function yl(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const o=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);o.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),s.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&yo(d)})}),n.innerHTML=a.map((i,l)=>{const d=f(i.client),c=f(i.items),m=f(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&yo(d)})})}async function wo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,r=a.value;if(!o||!r)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,n=await Pr({establishmentId:u.establishmentId,startDate:o,endDate:r,cashierSessionId:s});ba=n,e.innerHTML=`
        ...
        `,yl(n)}catch(s){g("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${f(s.message)}</p>`}}async function wl(){hl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];vl.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",wo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const o=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${o}_a_${r}`;xl(s,"transactionsTable")});try{const o=await bl(u.establishmentId),r=document.getElementById("cashierSessionFilter");o&&o.length>0&&o.forEach(s=>{const n=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=f(s.closedByName||"N/A");r.innerHTML+=`<option value="${s.id}">${i} - ${n}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await wo()}const kl=document.getElementById("content");let A={payables:[],receivables:[],natures:[],costCenters:[],currentTab:"payables",statusFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",isFilterOpen:!1},pt=null,gt=null;function ja(e){const t=new Map,a=[];return e&&(e.forEach(o=>t.set(o.id,{...o,children:[]})),t.forEach(o=>{o.parentId&&t.has(o.parentId)?t.get(o.parentId).children.push(o):a.push(o)})),a}function Sl(e){if(!e)return{day:"--",month:"---"};const t=new Date(e+"T00:00:00"),a=t.getDate().toString().padStart(2,"0"),o=t.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:a,month:o,full:t.toLocaleDateString("pt-BR")}}function $t(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function $l(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const o=(r,s=0)=>`
        ...
        `;e.innerHTML=t.map(r=>o(r)).join("")}async function va(e){const t=document.getElementById("genericModal"),a=e==="nature",o=a?"Naturezas Financeiras":"Centros de Custo",r=a?Da:Pa,s=a?yn:kn,n=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const i=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=m=>{const p=ja(m);$l(i,p,e);const b=l.value;l.innerHTML='<option value="">-- Categoria Principal --</option>';const v=(h,y=0)=>{const x="  ".repeat(y)+(y>0?"↳ ":"");l.innerHTML+=`<option value="${h.id}">${x}${h.name}</option>`,h.children.forEach(L=>v(L,y+1))};p.forEach(h=>v(h)),l.value=b};try{const m=await r(u.establishmentId);A[n]=m,d(m)}catch(m){console.error(m)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async m=>{m.preventDefault();const p=t.querySelector("#itemName").value,b=l.value;try{await s({name:p,parentId:b||null,establishmentId:u.establishmentId});const v=await r(u.establishmentId);A[n]=v,d(v),c.reset(),await Oe(),g("Sucesso","Item adicionado.","success")}catch(v){g("Erro",v.message,"error")}})}async function El(){Il(),Cl(),await Oe()}function Il(){kl.innerHTML=`
    ...
    `}function Cl(){document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const a=document.getElementById("filter-panel"),o=document.getElementById("toggle-filter-btn");A.isFilterOpen=!A.isFilterOpen,A.isFilterOpen?(a.classList.remove("hidden"),o.classList.add("bg-indigo-100","text-indigo-600")):(a.classList.add("hidden"),o.classList.remove("bg-indigo-100","text-indigo-600"))}),document.getElementById("settings-btn").addEventListener("click",Ml),document.getElementById("fab-add").addEventListener("click",()=>{const a=A.currentTab==="payables"?"payable":"receivable";ea(a)});const e=document.getElementById("tab-receivables"),t=document.getElementById("tab-payables");e.addEventListener("click",()=>ko("receivables")),t.addEventListener("click",()=>ko("payables")),document.querySelectorAll(".status-filter-btn").forEach(a=>{a.addEventListener("click",o=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-indigo-100","text-indigo-700"),r.classList.add("text-gray-500")}),o.target.classList.add("bg-indigo-100","text-indigo-700"),o.target.classList.remove("text-gray-500"),A.statusFilter=o.target.dataset.status})}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{A.startDate=document.getElementById("filterStartDate").value,A.endDate=document.getElementById("filterEndDate").value,A.filterNaturezaId=document.getElementById("filterNaturezaId").value,A.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("toggle-filter-btn").click(),Oe()}),pt&&document.body.removeEventListener("click",pt),pt=a=>{const o=a.target,r=o.closest("button[data-action]");if(r){const{action:n,type:i,id:l}=r.dataset;if(a.stopPropagation(),n==="delete"){Pl(i,l);return}if(n==="mark-as-paid"){Dl(i,l);return}if(n==="manage-natures"){va("nature");return}if(n==="manage-cost-centers"){va("cost-center");return}if(n==="edit"){const d=JSON.parse(r.dataset.item.replace(/&apos;/g,"'"));ea(i,d);return}}const s=o.closest(".financial-card-item");if(s&&document.getElementById("list-container").contains(s)){const{type:n}=s.dataset,i=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));ea(n,i)}},document.body.addEventListener("click",pt),gt&&document.getElementById("genericModal").removeEventListener("click",gt),gt=a=>{if(a.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const r=a.target.closest('button[data-action^="delete-"]');if(r){const s=r.dataset.action.split("-")[1];Bl(s,r.dataset.id)}},document.getElementById("genericModal").addEventListener("click",gt)}function ko(e){A.currentTab=e;const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),o=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-green-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),o.className="fixed bottom-6 right-6 w-14 h-14 bg-green-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-green-700 hover:scale-105 transition-all z-40"):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-green-700","shadow-sm"),t.classList.add("text-gray-500"),o.className="fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-red-700 hover:scale-105 transition-all z-40"),Ls()}async function Oe(){const e=document.getElementById("list-container");e.innerHTML='<div class="loader mx-auto my-10"></div>';try{if(A.natures.length===0){const[r,s]=await Promise.all([Da(u.establishmentId),Pa(u.establishmentId)]);A.natures=r,A.costCenters=s,Ll()}const t={startDate:A.startDate,endDate:A.endDate,establishmentId:u.establishmentId};A.filterNaturezaId!=="all"&&(t.natureId=A.filterNaturezaId),A.filterCostCenterId!=="all"&&(t.costCenterId=A.filterCostCenterId);const[a,o]=await Promise.all([En(t),Dn(t)]);A.payables=a.entries||[],A.receivables=o.entries||[],Tl(),Ls()}catch(t){e.innerHTML=`<p class="text-center text-red-500 mt-10">Erro ao carregar: ${t.message}</p>`}}function Ll(){const e=o=>{let r='<option value="all">Todas</option>';const s=ja(o),n=(i,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");r+=`<option value="${i.id}">${d}${i.name}</option>`,i.children.forEach(c=>n(c,l+1))};return s.forEach(i=>n(i)),r},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(A.natures)),a&&(a.innerHTML=e(A.costCenters)),t&&(t.value=A.filterNaturezaId),a&&(a.value=A.filterCostCenterId)}function Tl(){const e=document.getElementById("summary-section");if(!e)return;const t=A.receivables.reduce((l,d)=>l+d.amount,0),a=A.receivables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),o=t-a,r=A.payables.reduce((l,d)=>l+d.amount,0),s=A.payables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),n=r-s,i=a-s;e.innerHTML=`
        <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
            ...
            <p class="text-xl font-bold text-green-600">${$t(o)}</p>
        </div>
        <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-wider">A Pagar</p>
            <p class="text-xl font-bold text-red-500">${$t(n)}</p>
        </div>
        <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Realizado</p>
            <p class="text-xl font-bold ${i>=0?"text-indigo-600":"text-orange-500"}">${$t(i)}</p>
        </div>
    `}function Ls(){const e=document.getElementById("list-container");if(!e)return;const t=A.currentTab==="receivables",a=t?A.receivables:A.payables;let o=a;if(A.statusFilter!=="all"&&(o=a.filter(n=>n.status===A.statusFilter)),o.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),o.length===0){e.innerHTML=`
        ...
        `;return}const r=new Map(A.natures.map(n=>[n.id,n.name])),s=t?"receivable":"payable";e.innerHTML=o.map(n=>{const i=Sl(n.dueDate),l=n.status==="paid",d=l?"text-gray-400":t?"text-green-600":"text-red-500",c=n.naturezaId&&r.get(n.naturezaId)||"Geral",m=JSON.stringify(n).replace(/'/g,"&apos;");return`
        <div class="financial-card-item w-full max-w-full bg-white p-3 rounded-xl shadow-sm border border-gray-100 flex items-start gap-3 relative overflow-hidden cursor-pointer hover:shadow-md transition-all active:scale-[0.99]"
            ...
            <div class="flex-shrink-0 text-right pl-1 flex flex-col items-end">
                <p class="font-bold text-sm ${d} whitespace-nowrap">${$t(n.amount)}</p>
        ...
        `}).join("")}async function Dl(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Ln(t,a):Mn(t,a)),g("Sucesso","Lançamento baixado!","success"),await Oe()}catch(o){g("Erro",o.message,"error")}}async function Pl(e,t){if(await V("Excluir Lançamento","Tem certeza? Essa ação não pode ser desfeita."))try{await(e==="payable"?Cn(t):Bn(t)),g("Sucesso","Lançamento excluído.","success"),await Oe()}catch(o){g("Erro",o.message,"error")}}async function Bl(e,t){const o=e==="nature"?wn:Sn;if(await V("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await o(t),va(e==="nature"?"nature":"cost-center")}catch(s){g("Erro",s.message,"error")}}function Ml(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ea(e,t=null){const a=document.getElementById("genericModal"),o=e==="payable",r=`${t?"Editar":"Nova"} ${o?"Despesa":"Receita"}`,s=o?"red":"green",n=(m,p)=>{let b='<option value="">-- Selecione --</option>';const v=ja(m),h=(y,x=0)=>{const L="  ".repeat(x)+(x>0?"↳ ":""),w=y.id===p?"selected":"";b+=`<option value="${y.id}" ${w}>${L}${y.name}</option>`,y.children.forEach(E=>h(E,x+1))};return v.forEach(y=>h(y)),b};a.innerHTML=`
        ...
        </div>`,a.style.display="flex";const i=a.querySelector("#financial-form"),l=i.querySelector("#status-toggle"),d=i.querySelector("#payment-date-wrapper"),c=i.querySelector('[name="paymentDate"]');if(!t){const m=i.querySelector("#toggle-installments"),p=i.querySelector("#installments-container");m.addEventListener("change",()=>{p.classList.toggle("hidden",!m.checked)})}l.addEventListener("change",()=>{l.checked?(d.classList.remove("hidden"),c.required=!0):(d.classList.add("hidden"),c.required=!1)}),i.addEventListener("submit",async m=>{m.preventDefault();const p=new FormData(i),b=l.checked,v={description:p.get("description"),amount:parseFloat(p.get("amount")),dueDate:p.get("dueDate"),naturezaId:p.get("naturezaId")||null,centroDeCustoId:p.get("centroDeCustoId")||null,notes:p.get("notes"),status:b?"paid":"pending",paymentDate:b?p.get("paymentDate"):null,establishmentId:u.establishmentId},h=p.get("installments");!t&&h&&parseInt(h)>1?v.installments=parseInt(h):v.installments=1;try{t?(await(o?In(t.id,v):Pn(t.id,v)),g("Sucesso","Atualizado com sucesso!","success")):(await(o?$n(v):Tn(v)),g("Sucesso","Criado com sucesso!","success")),document.getElementById("genericModal").style.display="none",Oe()}catch(y){g("Erro",y.message,"error")}})}const Al=e=>$("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),Nl=e=>$("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),ql=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return $(`/api/commissions/stats?${a}`)},Rl=(e={})=>{Object.keys(e).forEach(o=>(e[o]===void 0||e[o]===null||e[o]==="")&&delete e[o]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return $(a)},jl=e=>$(`/api/commissions/report/${e}`,{method:"DELETE"}),Mt=new Date,So=new Date(Mt.getFullYear(),Mt.getMonth(),1),N={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:So.toISOString().split("T")[0],dashEndDate:Mt.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:So.toISOString().split("T")[0],histEndDate:Mt.toISOString().split("T")[0],histProfessionalId:"all"};let ft=null;const Je=document.getElementById("content");async function Fl(){try{N.professionals=await K(u.establishmentId)}catch(e){console.error("Erro profissionais",e)}Yl(),Hl(),Gt(),Nt("dashboard")}function Hl(){ft&&Je.removeEventListener("click",ft),ft=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,o=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":Nt(t.dataset.tab);break;case"toggle-all-profs":Ol();break;case"back-to-filters":N.calculationResult=null,At(document.getElementById("commissions-content"));break;case"view-preview-items":Xl(r);break;case"save-final-report":Vl();break;case"start-new-calc":Nt("calculator");break;case"print-receipt":Ul(o);break;case"delete-report":_l(o);break;case"filter-dashboard":Gt();break;case"filter-history":Fa();break}},Je.addEventListener("click",ft),Je.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Jl(t)}},Je.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),zl())}}async function Gt(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(N.dashStartDate=e.value),t&&(N.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const o=await ql(N.dashStartDate,N.dashEndDate);N.dashStats={revenue:o.totalRevenue||0,commissions:o.totalCommissionsPaid||0},N.currentTab==="dashboard"&&Ts(document.getElementById("commissions-content"))}catch(o){console.error(o),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Fa(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(N.histStartDate=e.value),t&&(N.histEndDate=t.value),a&&(N.histProfessionalId=a.value);const o=document.getElementById("history-list-container");if(o){o.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await Rl({startDate:N.histStartDate,endDate:N.histEndDate,professionalId:N.histProfessionalId});N.historyData=r,Ds(o,r)}catch{o.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Ol(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function zl(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),o=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");N.periodString=`${a} a ${o}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await Al(t);N.calculationResult=s.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),At(r)}catch(s){g("Erro",s.message,"error"),N.calculationResult=null,At(r)}}async function Vl(){const e=N.calculationResult.length;if(await V("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=N.calculationResult.map(o=>{const r=o.items.map(s=>s.originalSaleId).filter(s=>s!=null);return Nl({professionalId:o.professionalId,professionalName:o.professionalName,period:N.periodString,processedSalesIds:r,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),N.calculationResult=null,Gt(),Nt("history")}catch(a){g("Erro",a.message,"error")}}function Ul(e){const t=N.historyData.find(a=>a.id===e);t&&Wl(t)}async function _l(e){if(await V("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await jl(e),g("Sucesso","Registro removido.","success"),Fa(),Gt()}catch(a){g("Erro",a.message,"error")}}function Wl(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,o=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",o,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const s=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Jl(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let o=0,r=0;if(t.forEach(s=>{s.value&&(o=parseFloat(s.value))}),a.forEach(s=>{s.value&&(r=parseFloat(s.value))}),N.calculationResult&&N.calculationResult[e]){const s=N.calculationResult[e];s.extraDebit=o,s.extraCredit=r,s.finalValue=s.summary.totalCommission-o+r,t.forEach(i=>{i!==document.activeElement&&(i.value=o||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${s.finalValue.toFixed(2)}`),Gl()}}function Gl(){const e=N.calculationResult.reduce((a,o)=>a+o.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function Xl(e){const t=N.calculationResult[e];if(!t)return;const a=t.items.map(o=>`
    ...
    `}function Ql(e){const t=N.professionals.map(a=>`<option value="${a.id}" ${N.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,N.historyData.length>0?Ds(document.getElementById("history-list-container"),N.historyData):Fa()}function Ds(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const Zl=e=>$(`/api/packages/${e}`),Kl=e=>$("/api/packages",{method:"POST",body:JSON.stringify(e)}),ed=(e,t)=>$(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),td=e=>$(`/api/packages/${e}`,{method:"DELETE"}),ta=document.getElementById("content");let we={allPackages:[],catalogForModal:{services:[],products:[]}},bt=null,Le=null;function ad(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function od(){const e=document.getElementById("packagesListContainer");if(e){if(we.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=we.allPackages.map(t=>{const a=t.status==="active",o=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,s=t.originalPrice||0,n=s>r?s-r:0,i=s>0?(s-r)/s*100:0,l=f(t.name),d=f(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function $o(){const e=document.getElementById("genericModal");e.style.display="none",Le&&e.removeEventListener("click",Le)}async function Eo(e=null){const t=document.getElementById("genericModal"),a=!!e,o=e?JSON.parse(JSON.stringify(e.items||[])):[],r=f(e?.name||""),s=f(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),m=(b,v)=>{const h=v.querySelector("#originalPrice"),y=b.reduce((x,L)=>x+L.price*L.quantity,0);h&&(h.textContent=`R$ ${y.toFixed(2)}`)},p=b=>{b.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=b.map((v,h)=>{const y=v.type==="service",x=y?"Serviço":"Produto",L=y?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <span class="text-xs font-medium px-2 py-0.5 rounded-full ${L}">${x}</span>
            ...
            `}).join(""),m(b,t)};p(o),c.addEventListener("change",b=>{if(b.target.classList.contains("quantity-input")){const v=parseInt(b.target.dataset.index,10),h=parseInt(b.target.value,10);h>0&&o[v]&&(o[v].quantity=h,p(o))}}),c.addEventListener("click",b=>{if(b.target.classList.contains("remove-item-btn")){const v=parseInt(b.target.dataset.index,10);o.splice(v,1),p(o)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>sd(b=>{const v=o.find(h=>h.id===b.id&&h.type===b.type);v?v.quantity++:o.push({...b,quantity:1}),p(o)}),Le&&t.removeEventListener("click",Le),Le=async b=>{const v=b.target.closest("button[data-action]");if(!v)return;const h=v.dataset.action;if(b.stopPropagation(),h==="close-modal"&&$o(),h==="save-package"){const y=v,x={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:o,originalPrice:o.reduce((L,w)=>L+w.price*w.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:u.establishmentId};if(!x.name||!x.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(x.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}y.disabled=!0,y.textContent="A salvar...";try{a?await ed(x.id,x):(delete x.id,await Kl(x)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),$o(),await Ha()}catch(L){g("Erro",`Não foi possível salvar o pacote: ${L.message}`,"error"),y.disabled=!1,y.textContent="Salvar Pacote"}}},t.addEventListener("click",Le)}function sd(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const o={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=we.catalogForModal.services.filter(v=>v.name.toLowerCase().includes(d)),m=we.catalogForModal.products.filter(v=>v.name.toLowerCase().includes(d)),p=c.map(v=>`
    ...
    `,document.body.appendChild(a);const s=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(s),n.addEventListener("input",()=>{t=n.value,r(s)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:m,itemId:p}=d.dataset,v=(we.catalogForModal[m+"s"]||[]).find(h=>h.id===p);v&&(e({...v,type:m}),i())}else(c||l.target===a)&&i()})}async function Ha(){ta.innerHTML=`
    ...
    `,bt&&ta.removeEventListener("click",bt),bt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const o=e.target.closest('[data-action="delete-package"]');if(o){const r=o.dataset.id;V("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await td(r),g("Sucesso!","Pacote excluído.","success"),await Ha()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")Eo(null);else if(a==="edit-package"){const o=JSON.parse(t.dataset.package);Eo(o)}},ta.addEventListener("click",bt);try{const[e,t,a]=await Promise.all([Zl(u.establishmentId),Se(u.establishmentId),wa(u.establishmentId)]);we.allPackages=e,we.catalogForModal={services:t.filter(o=>o.active),products:a},od()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const rd=document.getElementById("content");let nd=null;async function id(){const e=f(u.userName||"Usuário"),t=f(U.currentUser?.email||"E-mail não disponível"),a=u.userName?u.userName.charAt(0):"U";rd.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await ld()}async function ld(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=u.userProfessionalId;if(t){const a=await ar(t);nd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const o=f(a.name);e.innerHTML=`
            ...
            `,dd(a.id),document.getElementById("my-blocks-filter").addEventListener("change",s=>qt(a.id,s.target.value)),qt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function dd(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#blockDate").value,r=t.querySelector("#blockStartTime").value,s=t.querySelector("#blockEndTime").value,n=t.querySelector("#blockReason").value;if(!o||!r||!s){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(r>=s){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${o}T${r}:00`),l=new Date(`${o}T${s}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Ot({establishmentId:u.establishmentId,professionalId:e,reason:n||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;qt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),g("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function qt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const o=new Date;let r,s;t==="history"?(s=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,s=new Date,s.setFullYear(s.getFullYear()+1));let i=(await st(u.establishmentId,r.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<o).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=o).sort((l,d)=>l.startTime-d.startTime),i.length>0?(a.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,m=l.endTime<new Date,p=f(l.reason||"Sem motivo");return`
                ...
                `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const c=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await $a(c),g("Sucesso","Bloqueio removido.","success"),qt(e,t)}catch(m){console.error("Erro ao remover bloqueio:",m),g("Erro",`Não foi possível remover o bloqueio: ${m.message}`,"error")}})})):a.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(o){console.error("Erro ao carregar bloqueios:",o),a.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${f(o.message)}</p>`}}document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const vt=document.getElementById("loadingScreen"),aa=document.getElementById("dashboardContent"),oa=document.getElementById("content"),Io=document.getElementById("notificationBell"),sa=document.getElementById("notificationBadge"),ht=document.getElementById("notificationPanel"),Co=document.getElementById("notificationList"),ra=document.getElementById("profileMenuButton"),ee=document.getElementById("profileDropdown"),cd=document.getElementById("profileName"),ud=document.getElementById("profileEmail"),md=document.getElementById("logoutButton"),Lo=document.getElementById("myProfileLink"),To=document.getElementById("hamburger-menu-btn"),xe=document.getElementById("sidebar"),Te=document.getElementById("mobile-overlay"),Do={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let et=null,tt=[];const pd={"agenda-section":os,"comandas-section":xn,"relatorios-section":qn,"servicos-section":Zn,"produtos-section":pi,"suppliers-section":ki,"profissionais-section":Pt,"clientes-section":Hi,"estabelecimento-section":Cs,"ausencias-section":sl,"users-section":Bt,"sales-report-section":wl,"financial-section":El,"commissions-section":Fl,"packages-section":Ha,"my-profile-section":id};function gd(e){const t=Do[e]||Do.indigo,o=(s=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function ha(){const e=tt.filter(t=>!t.read).length;if(e>0?(sa.textContent=e,sa.classList.remove("hidden")):sa.classList.add("hidden"),tt.length===0){Co.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Co.innerHTML=tt.map(t=>`
    ...
    `).join("")}function fd(e){et&&et();const t=pe(_,"establishments",e,"notifications"),a=Rt(t,at("timestamp",">=",new Date),Ao("timestamp","desc"));et=zs(a,o=>{o.docChanges().forEach(r=>{if(r.type==="added"){const s=r.doc.data();tt.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(s.title,s.message,"info",!0),ha();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(s.type==="cancellation"||s.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),os())}})},o=>{console.error("Erro no listener de notificações em tempo real:",o)})}function Z(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=u.enabledModules?.[a]!==!1,s=u.userPermissions===null||u.userPermissions[e]?.view===!0;if(!r||!s){oa.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),xe.classList.contains("absolute")&&(xe.classList.add("hidden"),Te.classList.add("hidden"));return}}const o=pd[e];o?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),oa.innerHTML="",window.innerWidth<768&&(xe.classList.add("hidden"),Te.classList.add("hidden")),o(t)):oa.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`}async function bd(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),o=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(s&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),n&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!s&&!n))try{const i=await Br();s&&o&&(o.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i)}}async function vd(e){try{console.log("[Nativo] Iniciando configuração de Push..."),oe.getPlatform()==="android"&&(await G.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let t=await G.checkPermissions();if(t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive!=="granted")return;await G.register(),G.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const o=me(_,"users",e);await xa(o,{fcmTokens:Os(a.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(o){console.error("Erro ao salvar token FCM:",o)}}),G.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),G.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),g(a.title,a.body,"info",!0)}),G.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),Z("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function hd(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),o=()=>e.style.display="block",r=()=>e.style.display="none",s=()=>e.style.display==="block";e&&(t.addEventListener("click",()=>{r(),oe.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{r(),oe.isNativePlatform()?Za.exitApp():history.back()}),oe.isNativePlatform()?Za.addListener("backButton",({canGoBack:n})=>{if(s())r();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),l=Array.from(i).filter(m=>m.id!=="exitConfirmationModal");if(l.length>0){l.forEach(m=>m.style.display="none");return}const d=document.getElementById("sidebar");if(d&&!d.classList.contains("hidden")&&window.innerWidth<768){d.classList.add("hidden"),document.getElementById("mobile-overlay").classList.add("hidden");return}const c=document.querySelector(".sidebar-link.active");c&&c.getAttribute("data-target")==="agenda-section"?o():Z("agenda-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",n=>{if(s()){r(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),l=Array.from(i).filter(c=>c.id!=="exitConfirmationModal");if(l.length>0){l.forEach(c=>c.style.display="none"),history.pushState(null,document.title,location.href);return}const d=document.querySelector(".sidebar-link.active");d&&d.getAttribute("data-target")==="agenda-section"?o():(Z("agenda-section"),history.pushState(null,document.title,location.href))})))}async function xd(){try{await Rs(U,js),console.log("Persistência LOCAL configurada na inicialização.")}catch(e){console.error("Erro ao definir persistência no main.js",e)}oe.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Xs(),hd(),To&&To.addEventListener("click",e=>{e.stopPropagation(),xe.classList.remove("hidden"),xe.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl"),Te.classList.remove("hidden")}),Te&&Te.addEventListener("click",()=>{xe.classList.add("hidden"),xe.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl"),Te.classList.add("hidden")}),Io.addEventListener("click",e=>{e.stopPropagation(),ht.classList.toggle("hidden"),ht.classList.contains("hidden")||(tt.forEach(t=>t.read=!0),ha())}),ra.addEventListener("click",e=>{e.stopPropagation(),ee.classList.toggle("active"),ee.classList.contains("active")?ee.classList.remove("hidden"):setTimeout(()=>ee.classList.add("hidden"),200)}),Lo&&Lo.addEventListener("click",e=>{e.preventDefault(),Z("my-profile-section"),ee.classList.remove("active"),ee.classList.add("hidden")}),document.addEventListener("click",e=>{!ht.contains(e.target)&&e.target!==Io&&ht.classList.add("hidden"),!ee.contains(e.target)&&e.target!==ra&&ee.classList.contains("active")&&(ee.classList.remove("active"),setTimeout(()=>ee.classList.add("hidden"),200))}),Po(U,async e=>{if(e){if(console.log("Usuário detectado:",e.email),!oe.isNativePlatform()&&(console.log("Inicializando Web Push (PWA)..."),_o(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast"),o=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");setTimeout(()=>{t&&(t.style.display="block")},3500),a&&a.addEventListener("click",async()=>{await Wo()&&t&&(t.style.display="none")});const s=()=>{t&&(t.style.display="none")};o&&o.addEventListener("click",s),r&&r.addEventListener("click",s)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const o=await ke(a.establishmentId);u.enabledModules=o.modules,gd(o.themeColor||"indigo");let r=null,s=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=me(_,"users",e.uid),c=await Bo(d);if(c.exists()){const m=c.data();r=a.role==="employee"?m.permissions||{}:null,s=m.name||s,n=m.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}u.userProfessionalId=n,oe.isNativePlatform()&&vd(e.uid);const i=s||e.email;_s(a.establishmentId,o.name,r),ra.textContent=i.charAt(0).toUpperCase(),cd.textContent=i,ud.textContent=e.email;const l=()=>{et&&et(),za(U).then(()=>window.location.href="/login.html")};md.addEventListener("click",d=>{d.preventDefault(),l()}),Ks(Z,r,u.enabledModules),bd(r),fd(a.establishmentId),ha(),vt.classList.add("fade-out"),aa.style.display="flex",setTimeout(()=>{vt.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{pr()},1500),Z("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),vt.classList.add("fade-out"),setTimeout(()=>{vt.style.display="none"},500),aa.innerHTML=`
                ...
                `,aa.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{za(U).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}xd();Po(U,async e=>{if(e){await _o();const a="Notification"in window&&Notification.permission==="default",o=window.Capacitor&&window.Capacitor.isNativePlatform();if(a&&!o){const r=document.getElementById("toast-notification-request"),s=document.getElementById("btn-enable-toast"),n=document.getElementById("btn-deny-toast"),i=document.getElementById("btn-close-toast");setTimeout(()=>{r&&(r.style.display="block")},3500),s&&s.addEventListener("click",async()=>{await Wo()&&r&&(r.style.display="none")});const l=()=>{r&&(r.style.display="none")};n&&n.addEventListener("click",l),i&&i.addEventListener("click",l)}}});export{Uo as W};
