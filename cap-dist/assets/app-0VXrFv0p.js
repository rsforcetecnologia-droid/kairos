...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ra}. Verifique se o servidor backend está rodando.`):i}}const Do=(e,t,a,o=null)=>{let s=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(s+=`&professionalId=${o}`),I(s)},Js=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const s=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return I(s)},Gs=e=>I("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Qs=(e,t)=>I(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ra=e=>I(`/api/appointments/${e}`,{method:"DELETE"}),Ys=e=>I(`/api/appointments/${e}/reopen`,{method:"POST"}),Xs=(e,t)=>I(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let G;async function Zs(){if(!G)try{G=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Ks(){if(!G){console.warn("AudioContext não inicializado. O som não será tocado.");return}G.state==="suspended"&&G.resume();const e=G.createOscillator(),t=G.createGain();e.connect(t),t.connect(G.destination),e.type="sine",e.frequency.setValueAtTime(800,G.currentTime),t.gain.setValueAtTime(0,G.currentTime),t.gain.linearRampToValueAtTime(.3,G.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,G.currentTime+.2),e.start(G.currentTime),e.stop(G.currentTime+.2)}function g(e,t,a="info",o=!1){const s=document.getElementById("toast-container");if(!s)return;o&&Ks();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `;const l=s.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=s.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),s.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),s.style.display="flex",{modalElement:s,close:i,setContent:n}}function er(){document.body.addEventListener("click",()=>{G||Zs()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const o=t.dataset.target;if(o){const s=document.getElementById(o);s&&(s.style.display="none")}}if(e.target.closest("[data-close-modal]")){const o=document.getElementById("genericModal");o&&(o.style.display="none")}})}const W=document.getElementById("sidebar"),Na=document.getElementById("sidebarToggle"),Ye=document.getElementById("mainContent"),tr=document.querySelectorAll(".sidebar-link"),ia=document.getElementById("menu-search"),ja=document.getElementById("hamburger-menu-btn"),je=document.getElementById("mobile-overlay");function Xe(e){if(!W||!Ye)return;W.classList.toggle("collapsed",e),Ye.classList.toggle("sidebar-collapsed-shift",e);const t=W.querySelector(".sidebar-search-container"),a=W.querySelectorAll(".sidebar-category");e?(t&&(t.style.display="none"),a.forEach(o=>o.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(o=>{const s=o.getAttribute("data-target-submenu"),r=document.getElementById(s),i=o.querySelector(".submenu-arrow");r&&(r.classList.add("hidden"),r.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(t&&(t.style.display="block"),a.forEach(o=>o.style.display="block"))}function ar(){!W||!je||(W.classList.add("mobile-open"),je.classList.add("visible"))}function pt(){!W||!je||(W.classList.remove("mobile-open"),je.classList.remove("visible"))}function or(){Xe(!W.classList.contains("collapsed"))}function sr(e,t){const a=document.getElementById(e);if(!a)return;const o=a.classList.contains("hidden");o&&window.innerWidth>=1024&&W.classList.contains("collapsed")&&Xe(!1),o?(a.classList.remove("hidden"),a.classList.add("flex"),t&&t.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),t&&t.classList.remove("rotate-180"))}function rr(){ia&&ia.addEventListener("input",e=>{const t=e.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const o=a.querySelectorAll("li"),s=a.querySelectorAll(".sidebar-category");if(t===""){o.forEach(r=>r.style.display=""),s.forEach(r=>r.style.display="block");return}s.forEach(r=>r.style.display="none"),o.forEach(r=>{if(r.classList.contains("sidebar-category"))return;const i=r.querySelector(".sidebar-link")||r.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(t)){r.style.display="";const d=r.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const c=d.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const c=document.getElementById(d);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(v=>v.textContent.toLowerCase().includes(t))?r.style.display="":r.style.display="none")}else r.style.display="none"}})})}function ir(e,t,a){if(!W||!Ye)return;Ye.classList.add("main-content-shift"),window.innerWidth>=768?Xe(W.classList.contains("collapsed")):(Ye.classList.remove("main-content-shift","sidebar-collapsed-shift"),pt()),Na&&Na.addEventListener("click",s=>{s.stopPropagation(),or()}),W.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&W.classList.contains("collapsed")&&Xe(!1)}),W.addEventListener("mouseleave",()=>{if(window.innerWidth>=1024){const s=!!document.querySelector("#sidebarToggle:hover"),r=document.activeElement===ia;!s&&!r&&Xe(!0)}}),ja&&ja.addEventListener("click",s=>{s.stopPropagation(),ar()}),je&&je.addEventListener("click",s=>{s.stopPropagation(),pt()});let o=0;W.addEventListener("touchstart",s=>{o=s.changedTouches[0].screenX},{passive:!0}),W.addEventListener("touchend",s=>{const r=s.changedTouches[0].screenX;o-r>50&&pt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation();const i=s.getAttribute("data-target-submenu"),n=s.querySelector(".submenu-arrow");sr(i,n)})}),rr(),tr.forEach(s=>{const r=s.getAttribute("data-target");if(!r)return;const i=r.replace("-section",""),n=a?.[i]!==!1,l=t===null||t[r]?.view===!0;if(!n||!l){s.parentElement&&s.parentElement.tagName==="LI"?s.parentElement.style.display="none":s.style.display="none";return}s.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),s.classList.add("active"),r&&typeof e=="function"&&e(r),window.innerWidth<768&&pt()})})}const nr=e=>I("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),Oe=()=>I("/api/establishments/hierarchy",{method:"GET"}),ye=e=>{const t=e||m.establishmentId;return t?I(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},xa=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},lr=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},dr=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))};class cr{constructor(t,a,o){this.steps=t,this.currentStep=0,this.onComplete=a,this.onSkip=o,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(t=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),t&&this.onComplete?this.onComplete():!t&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const t=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",t.onBefore&&(await t.onBefore(),await this.sleep(600));const a=await this.waitForElement(t.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const s=a.getBoundingClientRect(),r=8;this.spotlight.style.top=`${s.top+window.scrollY-r}px`,this.spotlight.style.left=`${s.left+window.scrollX-r}px`,this.spotlight.style.width=`${s.width+r*2}px`,this.spotlight.style.height=`${s.height+r*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(s)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const o=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
        ...
        `}).join("")}function Vr(e,t,a,o,s){const r=(e||"").replace(/\D/g,""),i=new Date(s).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(s).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${o} para o dia ${i} às ${n}. Podemos confirmar? Agradecemos a preferência!`;return`https://wa.me/${r}?text=${encodeURIComponent(l)}`}function Ur(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((o,s)=>new Date(o.startTime)-new Date(s.startTime)),e.length===0){t.innerHTML=`
        ...
        `;return}const a=e.map(o=>{const s=new Date(o.startTime),r=new Date(o.endTime),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(o.professionalId)||{border:"#cbd5e1"},d=C.selectedItems.has(o.id),c=C.isSelectionMode?`
            <div class="flex items-center justify-center pr-4 border-r border-gray-100 mr-4">
                ...
                </div>`;const u=o.status==="completed",p=o.redeemedReward?.points>0,v=o.hasRewards&&!p,f=JSON.stringify(o).replace(/'/g,"&apos;"),x=Vr(o.clientPhone,o.clientName,o.serviceName,o.professionalName,o.startTime),h=C.isSelectionMode?"":'data-action="open-comanda"';return`
            ...
            </div>`}).join("");t.innerHTML=`<div class="w-full px-4 pt-4 pb-24 space-y-3 bg-white min-h-[50vh]">${a}</div>`}function _r(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"],o=Vo(C.currentDate),s=zo(),n=100/(window.innerWidth<768?3:s),l=`flex: 0 0 ${n}%; width: ${n}%; max-width: ${n}%;`;let d=`
        <style>
    ...
    `;for(let c=0;c<s;c++){const u=new Date(o);u.setDate(u.getDate()+c);const p=new Date,v=u.toDateString()===p.toDateString(),f=e.filter(k=>new Date(k.startTime).toDateString()===u.toDateString()).sort((k,D)=>new Date(k.startTime)-new Date(D.startTime));let x='<div class="flex-grow overflow-y-auto px-2 py-3 space-y-2 pb-24 custom-scrollbar bg-white">';f.length>0?x+=f.map(k=>{const D=new Date(k.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),L=m.professionalColors.get(k.professionalId)||{main:"#9ca3af"},A=b(k.professionalName||"Indefinido");if(k.type==="blockage")return`
        ...
        `}d+="</div>",t.innerHTML=d}function Uo(){const e=m.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?Ur(e):_r(e),Sa()}function Sa(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(C.isSelectionMode&&C.selectedItems.size>0?(e.innerHTML=`
    ...
    `}}function ei(){return{title:"Quais serviços deseja?",content:`
        <div class="p-6 space-y-6">
    ...
    `}}function ti(){return{title:"Quem fará o atendimento?",content:`
        <div class="p-6 space-y-6">
             <div class="relative w-full">
                 <i class="bi bi-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
    ...
    `}}function ai(e){const t=e?"Revisão e Data":"Agendar Data e Horário",a=B.data.date||new Date().toISOString().split("T")[0];return{title:t,content:`
        <div class="p-6 space-y-6">
    ...
    `}}async function la(e=null,t=!1){const a=document.getElementById("appointmentModal");t||(B={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(s=>s.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],time:e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}),Vt=m.services,wa=m.professionals.filter(s=>s.status==="active");let o={title:"Erro",content:""};switch(B.step){case 1:o=Kr(e);break;case 2:o=ei();break;case 3:o=ti();break;case 4:o=ai(e);break}a.innerHTML=`
    ...
    `,_t()}function _t(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),ki()}function ki(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
    ...
    `,e.appendChild(r),r.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=s&&(y.paging.page=l,ue())}})}function J(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(x=>x.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){Si(t,e);return}const a=`
    ...
    `;const u=()=>{const p=y.checkoutState.discount.type,v=y.checkoutState.discount.value;let f=p==="percent"?o*v/100:v;f>o&&(f=o);const x=o-f,h=y.checkoutState.payments.reduce((L,A)=>L+A.value,0),E=Math.max(0,x-h),S=t.querySelector("#checkout-total-display");S&&(S.textContent=`R$ ${x.toFixed(2)}`);const k=t.querySelector("#checkout-status-msg");k&&(E<=.01?k.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':k.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${E.toFixed(2)}</span></p>`);const D=t.querySelector("#checkout-amount");D&&E>0&&document.activeElement!==D&&(D.value=E.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",p=>{const v=parseFloat(p.target.value)||0;y.checkoutState.discount.value=v,u()}),t.querySelector("#discount-type")?.addEventListener("change",p=>{y.checkoutState.discount.type=p.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",p=>{y.checkoutState.discountReason=p.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",p=>{y.checkoutState.amountReceived=p.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",p=>{y.checkoutState.installments=parseInt(p.target.value,10)})}async function $i(e,t){if(!t)return;const a=y.loyaltySettings;if(!a||!a.enabled)return;let o=null;try{if(e.clientId)o=await Ro(m.establishmentId,e.clientId);else if(e.clientName){const n=await ya(m.establishmentId,e.clientName,1);n&&n.length>0&&(o=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!o||o.loyaltyPoints===void 0)return;const s=Number(o.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&s>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>Ei(i,e),n.appendChild(l),t.innerHTML="",t.appendChild(n)}}function Ei(e,t){const a=`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Ti)}async function Ti(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),s=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!s)return g("Erro","Nome e Telefone são obrigatórios.","error");try{const r=await zr(m.establishmentId,s);if(r)g("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",da(r);else{const i=await jo({establishmentId:m.establishmentId,name:a.value,phone:s});g("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",da(i)}}catch(r){g("Erro",r.message,"error")}}async function Di(){const e=`
    ...
    `,{modalElement:t}=se({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const o=parseFloat(document.getElementById("initial-amount").value);if(isNaN(o)||o<0)return g("Valor Inválido","Insira um valor válido.","error");try{const s=await pi({establishmentId:m.establishmentId,initialAmount:parseFloat(o.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=s.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${o.toFixed(2)})`,"success"),_t(),await ue()}catch(s){g("Erro",`Falha ao abrir caixa: ${s.message}`,"error")}})}async function Pi(){const e=y.activeCashierSessionId;if(e)try{const t=await fi(e),a=`
        ...
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await Qi();const[e,t,a]=await Promise.all([re(m.establishmentId),Cr(m.establishmentId).catch(()=>[]),Wt(m.establishmentId).catch(()=>[])]);P.professionalsList=e||[],P.costCentersList=t||[],P.naturesList=a||[],Xi(),await os()}catch(e){console.error("Erro no loadReportsPage:",e),ca.innerHTML=`
            ...
            </div>`}}function Xi(){const e=P.professionalsList.map(a=>`<option value="${a.id}">${b(a.name)}</option>`).join(""),t=P.costCentersList.map(a=>`<option value="${a.id}">${b(a.name)}</option>`).join("");ca.innerHTML=`
    ...
    `,document.getElementById("toggle-filters-btn").onclick=Za,document.getElementById("btn-apply-filters").onclick=()=>{Zi(),Za()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{P.currentTab=a.dataset.tab,Ka(),ss(),window.scrollTo({top:0,behavior:"smooth"})}}),Ka()}function Za(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");P.isFilterOpen=!P.isFilterOpen,P.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function Ka(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===P.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Ct(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function Zi(){P.startDate=document.getElementById("report-start").value,P.endDate=document.getElementById("report-end").value,P.selectedProfessional=document.getElementById("report-prof").value,P.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Ct(P.startDate)} até ${Ct(P.endDate)}`,await os()}function Ki(e,t){const a=new Map;P.naturesList.forEach(s=>a.set(s.id,s.name));const o={revenues:{},expenses:{},totalRevenues:0,totalExpenses:0,netResult:0};return t.forEach(s=>{if(s.status==="paid"){const r=s.naturezaId?a.get(s.naturezaId)||"Outras Receitas":"Geral";o.revenues[r]||(o.revenues[r]=0),o.revenues[r]+=s.amount,o.totalRevenues+=s.amount}}),e.forEach(s=>{if(s.status==="paid"){const r=s.naturezaId?a.get(s.naturezaId)||"Outras Despesas":"Geral";o.expenses[r]||(o.expenses[r]=0),o.expenses[r]+=s.amount,o.totalExpenses+=s.amount}}),o.netResult=o.totalRevenues-o.totalExpenses,o}function en(e,t){const a={},o=d=>{a[d]||(a[d]={realizedCredit:0,provisionedCredit:0,realizedDebit:0,provisionedDebit:0})};let s=new Date(P.startDate);const r=new Date(P.endDate);for(;s<=r;)o(s.toISOString().split("T")[0]),s.setDate(s.getDate()+1);t.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedCredit+=d.amount:a[c].provisionedCredit+=d.amount)}),e.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedDebit+=d.amount:a[c].provisionedDebit+=d.amount)});const i=Object.keys(a).sort(),n=[];let l=0;return i.forEach(d=>{const c=a[d],u=c.realizedCredit+c.provisionedCredit-(c.realizedDebit+c.provisionedDebit);l+=u,n.push(l)}),{labels:i,realizedCredit:i.map(d=>a[d].realizedCredit),provisionedCredit:i.map(d=>a[d].provisionedCredit),realizedDebit:i.map(d=>a[d].realizedDebit*-1),provisionedDebit:i.map(d=>a[d].provisionedDebit*-1),balance:n}}function tn(e){const t={};let a=new Date(P.startDate);const o=new Date(P.endDate);for(;a<=o;)t[a.toISOString().split("T")[0]]=0,a.setDate(a.getDate()+1);e.forEach(i=>{if(i.status==="paid"){const n=i.dueDate.split("T")[0];t.hasOwnProperty(n)&&(t[n]+=i.amount)}});const s=Object.keys(t).sort(),r=s.map(i=>t[i]);return{labels:s,data:r}}function an(e){const t=e.length;if(t<2)return{trendData:Array(t).fill(e[0]||0),color:"#9ca3af"};let a=0,o=0,s=0,r=0;for(let c=0;c<t;c++)a+=c,o+=e[c],s+=c*e[c],r+=c*c;const i=(t*s-a*o)/(t*r-a*a),n=(o-i*a)/t,l=[];for(let c=0;c<t;c++)l.push(i*c+n);const d=i>=0?"#10b981":"#ef4444";return{trendData:l,color:d}}async function os(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20 w-full"><div class="loader border-t-indigo-600"></div></div>';try{const t={startDate:P.startDate,endDate:P.endDate,establishmentId:m.establishmentId};P.selectedCostCenter!=="all"&&(t.costCenterId=P.selectedCostCenter);const[a,o]=await Promise.all([ts(t),as(t)]);P.rawPayables=a.entries||[],P.rawReceivables=o.entries||[];const s=await Lr(P.startDate,P.endDate,P.selectedProfessional,P.selectedCostCenter).catch(()=>({charts:{professionals:{labels:[],data:[]},salesMonthly:{labels:[],data:[]}}}));P.backendData=s,P.processedDRE=Ki(P.rawPayables,P.rawReceivables),P.processedCashFlow=en(P.rawPayables,P.rawReceivables),P.processedDailyRevenue=tn(P.rawReceivables);const r=new Date(P.startDate+"T00:00:00").toISOString(),i=new Date(P.endDate+"T23:59:59").toISOString(),n=P.selectedProfessional==="all"?null:P.selectedProfessional,l=await Do(m.establishmentId,r,i,n).catch(()=>[]);P.appointmentsData=Array.isArray(l)?l:[],ss()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ss(){const e=document.getElementById("report-content");switch(P.currentTab){case"dashboards":on(e);break;case"appointments":sn(e);break;case"dre":rn(e);break}}function on(e){const t=P.processedDRE,a=P.processedDailyRevenue,o=P.backendData.charts?.salesMonthly||{labels:[],data:[]},s=P.backendData.charts?.professionals||{labels:[],data:[]};e.innerHTML=`
    ...
    `,ln("chart-appointments-daily",c,u,p),document.querySelectorAll(".app-chart-toggle").forEach(f=>{f.addEventListener("change",x=>{const h=K["chart-appointments-daily"];if(h){const E=parseInt(x.target.dataset.dataset);h.setDatasetVisibility(E,x.target.checked),h.update()}})})}function rn(e){const t=P.processedDRE;if(!t)return;const a=t.totalRevenues,o=(n,l,d,c=!1)=>{const u=a>0?l/a*100:0,p=c?"- ":"";return`
    ...
    `}function nn(e,t){const a=document.getElementById(e);if(!a)return;const o=a.getContext("2d");K[e]&&K[e].destroy();const s=o.createLinearGradient(0,0,0,400);s.addColorStop(0,"rgba(59, 130, 246, 0.4)"),s.addColorStop(1,"rgba(59, 130, 246, 0.0)");const r=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));K[e]=new Chart(o,{type:"bar",data:{labels:r,datasets:[{label:"Créd. Realizado",data:t.realizedCredit,backgroundColor:gt.creditRealized,borderRadius:3,barPercentage:.7,order:1},{label:"Créd. Provisionado",data:t.provisionedCredit,backgroundColor:gt.creditProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:2},{label:"Déb. Realizado",data:t.realizedDebit,backgroundColor:gt.debitRealized,borderRadius:3,barPercentage:.7,order:3},{label:"Déb. Provisionado",data:t.provisionedDebit,backgroundColor:gt.debitProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:4},{label:"Saldo Acumulado",data:t.balance,type:"line",borderColor:"#3b82f6",backgroundColor:s,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!0,tension:.4,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10,callbacks:{label:function(i){let n=i.dataset.label||"";return n&&(n+=": "),i.parsed.y!==null&&(n+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(Math.abs(i.parsed.y))),n}}}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{size:10}}},y:{stacked:!0,display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(Math.abs(i)),font:{size:10}}}}}})}function ln(e,t,a,o){const s=document.getElementById(e);if(!s)return;const r=s.getContext("2d");K[e]&&K[e].destroy();const i=t.map(n=>n.split("-").reverse().slice(0,2).join("/"));K[e]=new Chart(r,{type:"bar",data:{labels:i,datasets:[{label:"Realizados",data:a,backgroundColor:"#4f46e5",borderRadius:3,barPercentage:.6,order:1},{label:"Cancelados",data:o,backgroundColor:"#ef4444",borderRadius:3,barPercentage:.6,order:2}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function eo(e,t,a,o){const s=document.getElementById(e);if(!s)return;const r=s.getContext("2d");K[e]&&K[e].destroy();const{trendData:i,color:n}=an(o),l=i.map((u,p)=>p===i.length-1?"triangle":"circle"),d=i.map((u,p)=>p===i.length-1?6:3),c=i.map((u,p)=>p===i.length-1&&n==="#ef4444"?180:0);K[e]=new Chart(r,{type:"bar",data:{labels:a,datasets:[{label:t,data:o,backgroundColor:"#4f46e5",borderRadius:4,order:1},{label:"Tendência",data:i,type:"line",borderColor:n,borderWidth:3,pointStyle:l,pointRadius:d,pointRotation:c,pointBackgroundColor:"#fff",pointBorderColor:n,pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!1,tension:0,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9},callback:u=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(u)}}}}})}function dn(e,t,a,o,s,r){const i=document.getElementById(e);if(!i)return;const n=i.getContext("2d");K[e]&&K[e].destroy(),new Chart(n,{type:t,data:{labels:o,datasets:[{label:a,data:s,backgroundColor:r,borderColor:Array.isArray(r)?"#fff":r,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:{}}})}const Jt=(e,t="products")=>I(`/api/${t}/categories/${e}`),rs=(e,t="products")=>I(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),is=(e,t="products")=>I(`/api/${t}/categories/${e}`,{method:"DELETE"}),cn="audit_logs",de=async(e,t,a,o,s,r=null)=>{try{if(!t)return;await Io(Ft(me,cn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:o,description:s,details:r,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},fe=document.getElementById("content");let pe=null,Ze="services",ve="all",Ke=[];function He(){const e=oe.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function un(e){e.preventDefault();const t=e.target.closest("#categoryForm"),a=t.querySelector("#categoryName"),o=a.value;if(!o)return;const s=t.querySelector('button[type="submit"]');s.disabled=!0,s.textContent="...";try{const r=Ke.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);r.length===0&&r.push(m.establishmentId),await rs({establishmentId:m.establishmentId,name:o,accessibleIn:r},"services"),de(m.establishmentId,He(),"Categorias (Serviços)","Criou",`Criou categoria: ${o}`),a.value="",g("Sucesso","Categoria criada!","success"),await Ia(),await ut()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}finally{s.disabled=!1,s.textContent="Adicionar"}}async function mn(e){if(await V("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await is(e,"services"),de(m.establishmentId,He(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Ia(),await ut()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ia(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Jt(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function pn(){se({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",un),t.addEventListener("click",o=>{const s=o.target.closest('button[data-action="delete-category"]');s&&(o.preventDefault(),mn(s.dataset.id))}))}Ia()}function gn(e=[]){if(!Ke||Ke.length===0)return`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${b(a.name)}</option>`)),La(),et()}function xn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ut(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,o,s,r]=await Promise.all([Se(m.establishmentId),re(m.establishmentId),Jt(m.establishmentId,"services"),qr(m.establishmentId),Oe()]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(o||[]).filter(Boolean),m.mostPopularService=s||{name:"N/A",count:0},Ke=r?.matrizes||[],m.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),ns(Ze)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function ns(e){if(document.getElementById("services-content-container")){if(Ze===e&&document.getElementById("services-content-container").children.length>1){Ze==="services"&&(La(),et());return}Ze=e,ve="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?fn():e==="reports"&&xn()}}function vn(){pe&&(fe.removeEventListener("click",pe),fe.removeEventListener("input",pe),fe.removeEventListener("change",pe)),pe=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const s=t.closest('[data-action="toggle-service-status"]'),r=s.dataset.id,i=s.checked;try{await Ar(r,i);const n=m.services.findIndex(l=>l.id===r);n>-1&&(m.services[n].active=i),de(m.establishmentId,He(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${i?"Ativo":"Inativo"}`),et(),La()}catch(n){g("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),s.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){et();return}if(!a)return;if(a.hasAttribute("data-view")){ns(a.dataset.view);return}switch(a.dataset.action){case"new-service":to();break;case"edit-service":const s=JSON.parse(a.dataset.service);to(s);break;case"manage-categories":pn();break;case"filter-service":const r=a.dataset.filterType;if(r==="popular")return;ve=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,d=n===ve||n==="total"&&ve==="all";i.classList.toggle("ring-2",d),i.classList.toggle("ring-indigo-500",d),i.classList.toggle("shadow-md",d),i.classList.toggle("bg-white",!d)}),et();break}},fe.addEventListener("click",pe),fe.addEventListener("input",pe),fe.addEventListener("change",pe)}async function hn(){fe.innerHTML=`
        ...
        </div>`,vn(),Ze="services",ve="all",await ut()}const Gt="suppliers",Ca=async e=>{try{const t=Lo(Ft(me,Gt),Co("establishmentId","==",e)),a=await js(t),o=[];return a.forEach(s=>{o.push({id:s.id,...s.data()})}),o}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},yn=async e=>{try{return{id:(await Io(Ft(me,Gt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},wn=async(e,t)=>{try{const a=ct(me,Gt,e);return await fa(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},kn=async e=>{try{const t=ct(me,Gt,e);return await Fs(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},be=document.getElementById("content");let ge=null,tt="products",ce="all";async function Sn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await rs({establishmentId:m.establishmentId,name:o},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Ta(),await mt()}catch(s){g("Erro",`Não foi possível criar a categoria: ${s.message}`,"error")}}async function $n(e){if(await V("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await is(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Ta(),await mt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ta(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Jt(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${b(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function En(){se({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${b(a.name)}</option>`)),Da(),lt()}function Tn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const o=a.toISOString().split("T")[0];e.innerHTML=`
        ...
        </div>`;const s=document.getElementById("productFilterReport"),r=document.getElementById("categoryFilterReport");s&&m.products&&(s.innerHTML+=m.products.map(i=>`<option value="${i.id}">${b(i.name)}</option>`).join("")),r&&m.categories&&(r.innerHTML+=m.categories.map(i=>`<option value="${i.id}">${b(i.name)}</option>`).join(""))}async function Dn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await ui(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
    ...
    `}function An(){const e=Object.entries(Tt).map(([a,o])=>`<option value="${a}">${o.label}</option>`).join(""),t=ds.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Nn))}function cs(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
    ...
    `,o='<div class="flex flex-col gap-4 md:hidden">';t.forEach(s=>{let r=s.category;r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const i=Tt[r]||Tt.outros,n=s.document||s.taxId?s.document||s.taxId:"-",l=JSON.stringify(s).replace(/'/g,"&apos;"),d=[s.city,s.state].filter(Boolean).join(" - ");a+=`
        ...
        `;return t}function On(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",o=b(t.name),s=b(t.specialty||"Especialidade"),r=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,l=n>1?`<span class="text-[10px] font-bold bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded ml-2 border border-indigo-200" title="Atende em ${n} unidades"><i class="bi bi-diagram-3"></i> ${n} Lojas</span>`:"";return`
            ...
            </div>`}).join("")}function Kt(){const e=document.getElementById("genericModal");e.style.display="none",De&&e.removeEventListener("click",De)}async function zn(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=b(a.name),s=m.services||await Se(m.establishmentId),r=m.professionals||await re(m.establishmentId),i=`
        ...
        </div>`;t.innerHTML=i,t.style.display="flex",Un(a,s),_n(a),Wn(a,r),Gn(a)}function Vn(e=[]){if(!Et||Et.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(s=>{const r=e.includes(s.id)||e.length===0&&s.id===m.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function Un(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],s=Array.from({length:12},(h,E)=>{const S=E+1,k=S==o[1]?"selected":"",D=new Date(0,E).toLocaleString("pt-BR",{month:"long"});return`<option value="${S}" ${k}>${D.charAt(0).toUpperCase()+D.slice(1)}</option>`}).join(""),r=e.status||"active",i=b(e.name||""),n=b(e.specialty||""),l=b(e.phone||""),d=b(e.notes||"");a.innerHTML=`
        ...
        </div>`,Jn(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function Wn(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=il)}function dt(){if(w.modalOpen)return;Pa();const e=document.getElementById("clients-content-area"),t=w.filters.inactiveDays||w.filters.birthMonth||w.filters.hasLoyalty||w.filters.hasDebt,a=`
    ...
    `,o=w.clients.length>0?`
        <div class="px-3 sm:px-4 pb-20 pt-2 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${w.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,p=Xn(c.lastVisit);return`
    ...
    `;let a="";return w.activeTab==="profile"?a=tl(e):w.activeTab==="appointments"?a=al():w.activeTab==="history"?a=ol():w.activeTab==="loyalty"&&(a=sl(e)),`
    ...
    `}function Kn(e,t){if(!document.getElementById("tabs-styles")){const r=document.createElement("style");r.id="tabs-styles",r.textContent=`
        ...
        `,e.appendChild(r)}if(e.querySelectorAll(".tab-btn").forEach(r=>{r.onclick=async()=>{const i=r.dataset.tab;if(w.activeTab===i)return;(i==="appointments"||i==="history")&&(w.historyLimit=20,w.historySearchTerm=""),w.activeTab=i,Ae(),i!=="profile"&&!w.historyLoading&&w.historyData.appointments.length===0&&await ro(t.id)}}),w.activeTab==="profile"){const r=e.querySelector("#form-edit-client"),i=e.querySelector("#btn-delete-client");r&&(r.onsubmit=nl),i&&(i.onclick=ll)}if(w.activeTab==="loyalty"){const r=e.querySelector("#btn-manual-redeem");r&&(r.onclick=()=>rl(t))}const a=e.querySelector("#history-search-input");if(a){const r=a.value;a.value="",a.focus(),a.value=r,a.addEventListener("input",i=>{w.historySearchTerm=i.target.value,Ae()})}const o=e.querySelector("#btn-load-more");o&&(o.onclick=()=>{w.historyLimit+=20,Ae(),ro(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(r=>{r.onclick=i=>{qe(),X("agenda-section",{targetDate:new Date(r.dataset.date),scrollToAppointmentId:r.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(r=>{r.onclick=i=>{qe(),X("comandas-section",{selectedAppointmentId:r.dataset.id,initialFilter:"finalizadas"})}});const s=e.querySelector("#btn-close-modal");s&&(s.onclick=qe)}async function Ae(){const e=w.selectedClient;if(!e){qe();return}el(e)}function el(e){let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 animate-fade-in",t.innerHTML=`
        ...
        `,t.onclick=o=>{o.target===t&&qe()},document.body.appendChild(t),document.body.classList.add("overflow-hidden"),w.modalOpen=!0);const a=t.querySelector("#client-modal-content");a.innerHTML=Zn(e),Kn(a,e)}function qe(){const e=document.getElementById("client-details-modal-overlay");e&&e.remove(),document.body.classList.remove("overflow-hidden"),w.modalOpen=!1,w.selectedClient=null,dt()}function tl(e){return`
    ...
    `}function ol(e){let t=w.historyData.sales||[];if(w.historySearchTerm){const a=w.historySearchTerm.toLowerCase();t=t.filter(o=>o.id.includes(a))}return t.sort((a,o)=>new Date(o.date)-new Date(a.date)),t.length===0&&!w.historySearchTerm?'<div class="text-center py-12 text-gray-400">Nenhum registro financeiro.</div>':`
        <div class="space-y-4 w-full">
            <div class="sticky top-0 bg-gray-50 pt-2 pb-2 z-10 w-full">
                <div class="relative w-full">
                    <input type="text" id="history-search-input" 
    ...
    `}function sl(e){const t=w.historyData.loyaltyLog||[];t.sort((o,s)=>new Date(s.date)-new Date(o.date));const a=t.length>0?t.map(o=>{const s=o.type==="redemption";return`
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newEmail").value,s=t.querySelector("#currentPassword").value,r=t.querySelector('button[form="change-email-form"]');r.disabled=!0,r.textContent="A verificar...";try{const i=oe.currentUser,n=Cs.credential(i.email,s);await Ts(i,n),await Ds(i,o),await dr(_,o),g("Sucesso","Link de verificação enviado! Verifique o seu novo e-mail.","success"),a.target.reset()}catch(i){g("Erro",i.message,"error")}finally{r.disabled=!1,r.textContent="Salvar Novo E-mail"}})}function gl(e,t){const a=b(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `}function fs(e="indigo",t){const a=t.querySelector("#color-palette-container"),o=t.querySelector("#establishmentThemeColor");!a||!o||(a.innerHTML="",Object.entries(cl).forEach(([s,r])=>{const i=s===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
        ...
        `,n.addEventListener("click",()=>{o.value=s,fs(s,t)}),a.appendChild(n)}),o.value=e)}function wl(e,t){const a=t.querySelector("#slotIntervalContainer"),o=t.querySelector("#establishmentSlotInterval");if(!a||!o)return;const s=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=s.map(r=>{const i=r.value===e;return`<button type="button" data-value="${r.value}" 
    ...
    `,xe.querySelector('button[data-action="back-to-menu"]').addEventListener("click",s=>{s.preventDefault(),xs({id:_})});const o=document.getElementById("settings-content-detail");switch(e){case"personal-data":ul(z,o);break;case"change-password":ml(z,o);break;case"change-email":pl(z,o);break;case"branding":gl(z,o);break;case"booking":bl(z,o);break;case"working-hours":fl(z,o);break;case"whatsapp-bot":bs(z,o);break;case"loyalty":await xl(z,o);break;case"financial":await vl(z,o);break;case"support":hl(z,o);break;case"cancellation":yl(z,o);break;default:o.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function xs(e={}){xe.innerHTML=`
    ...
    `;try{_=e.id||m.establishmentId,z=await ye(_);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=z.isMatriz||!z.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',o=gs();xe.innerHTML=`
        ...
        `,xe.querySelectorAll("div[data-section]").forEach(s=>{s.addEventListener("click",r=>{kl(s.dataset.section)})}),xe.querySelectorAll(".module-toggle").forEach(s=>{s.addEventListener("change",async()=>{const r=s.dataset.module;try{const n={...(await ye(_)).modules,[r]:s.checked};await xa(_,{modules:n}),g("Módulos","Módulos atualizados com sucesso.","success")}catch(i){s.checked=!s.checked,g("Erro",i.message,"error")}})})}catch(t){xe.innerHTML=`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ga.transactions[l];d&&uo(d)})})}async function mo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,s=a.value;if(!o||!s)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,i=await Tr({establishmentId:m.establishmentId,startDate:o,endDate:s,cashierSessionId:r});ga=i,e.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",mo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const o=document.getElementById("reportStartDate").value,s=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${o}_a_${s}`;zl(r,"transactionsTable")});try{const o=await bi(m.establishmentId),s=document.getElementById("cashierSessionFilter");o&&o.length>0&&o.forEach(r=>{const i=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=b(r.closedByName||"N/A");s.innerHTML+=`<option value="${r.id}">${n} - ${i}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await mo()}const _l=document.getElementById("content");let $={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1},ht=null,yt=null;function Ba(e){const t=new Map,a=[];return e&&(e.forEach(o=>t.set(o.id,{...o,children:[]})),t.forEach(o=>{o.parentId&&t.has(o.parentId)?t.get(o.parentId).children.push(o):a.push(o)})),a}function vs(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,o]=e.split("-"),s=new Date(t,a-1,o),r=String(s.getDate()).padStart(2,"0"),i=s.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:r,month:i,full:s.toLocaleDateString("pt-BR")}}function ne(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function Bt(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[o,s,r]=e.split("-");return new Date(o,s-1,r)<a}function Wl(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const o=(s,r=0)=>`
        ...
        `;e.innerHTML=t.map(s=>o(s)).join("")}async function ba(e){const t=document.getElementById("genericModal"),a=e==="nature",o=a?"Plano de Contas (Naturezas)":"Centros de Custo",s=a?Wt:Ea,r=a?Ri:ji,i=a?"natures":"costCenters";t.innerHTML=`
    ...
    `}function Mt(){const e=document.getElementById("list-container");if(!e)return;const t=$.currentTab==="receivables",a=t?$.receivables:$.payables;let o=a;if($.statusFilter!=="all"&&(o=a.filter(l=>{const d=Bt(l.dueDate,l.status);return $.statusFilter==="overdue"?d:$.statusFilter==="pending"?l.status==="pending"&&!d:l.status===$.statusFilter})),$.searchQuery&&(o=o.filter(l=>l.description&&l.description.toLowerCase().includes($.searchQuery)||l.entity&&l.entity.toLowerCase().includes($.searchQuery)||l.notes&&l.notes.toLowerCase().includes($.searchQuery))),o.sort((l,d)=>new Date(l.dueDate)-new Date(d.dueDate)),o.length===0){e.innerHTML=`
        ...
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${s.map(d=>{const c=d.id===t.id,u=d.status==="paid",p=vs(d.dueDate);return`
    ...
    `,N.historyData.length>0?Es(document.getElementById("history-list-container"),N.historyData):Ma()}function Es(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const aa=document.getElementById("content");let he={allPackages:[],catalogForModal:{services:[],products:[]}},kt=null,Be=null;function xd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function vd(){const e=document.getElementById("packagesListContainer");if(e){if(he.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=he.allPackages.map(t=>{const a=t.status==="active",o=JSON.stringify(t).replace(/'/g,"&apos;"),s=t.price||0,r=t.originalPrice||0,i=r>s?r-s:0,n=r>0?(r-s)/r*100:0,l=b(t.name),d=b(t.description||"Sem descrição");return`
    ...
    `,document.body.appendChild(a);const r=a.querySelector("#item-selection-list"),i=a.querySelector("#item-search-input"),n=()=>{a.remove()};s(r),i.addEventListener("input",()=>{t=i.value,s(r)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:p}=d.dataset,f=(he.catalogForModal[u+"s"]||[]).find(x=>x.id===p);f&&(e({...f,type:u}),n())}else(c||l.target===a)&&n()})}async function Aa(){aa.innerHTML=`
    ...
    `,await Sd()}async function Sd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await Rr(t);wd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const o=b(a.name);e.innerHTML=`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const s=(await Oe()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),s.length===0)t.innerHTML=`
        ...
        `)}let rt=null,it=[];function Is(){if(!St||!sa)return;const e=it.filter(t=>!t.read).length;if(e>0?(St.textContent=e,St.classList.remove("hidden")):St.classList.add("hidden"),it.length===0){sa.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}sa.innerHTML=it.map(t=>`
