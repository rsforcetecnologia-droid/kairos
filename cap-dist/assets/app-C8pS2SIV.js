const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-D2ZZ8myh.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/utils-JfzC6GFr.js","assets/styles-CQhY7Cv2.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as we,d as xe,m as Ts}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as qi,reauthenticateWithCredential as Ni,verifyBeforeUpdateEmail as Fi,updatePassword as Ri,updateProfile as Hi,setPersistence as Oi,browserLocalPersistence as zi,onAuthStateChanged as _i,signOut as Vi}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as Be,getDoc as bs,updateDoc as Mt,setDoc as Ui,addDoc as vo,collection as Sa,query as yo,where as wo,getDocs as Wi,deleteDoc as Ji,arrayUnion as Gi,orderBy as Qi,onSnapshot as Xi}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{a as L,e as v,s as G,b as f,c as Ne,r as $a,f as Na,i as Yi}from"./utils-JfzC6GFr.js";import{getToken as Zi,onMessage as Ki}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const g={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function er(t,e,a){g.establishmentId=t,g.establishmentName=e,g.userPermissions=a,g.currentViewContext={type:"BRANCH",id:t,name:e}}const Ia=(t,e,a,s=null)=>{let i=`/api/appointments/${t}?startDate=${e}&endDate=${a}`;return s&&(i+=`&professionalId=${s}`),L(i)},tr=(t,e,a)=>{const s=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${a}`;return L(s)},ar=({establishmentId:t,professionalId:e,serviceIds:a,date:s})=>{const i=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${a.join(",")}&date=${s}`;return L(i)},sr=t=>L("/api/appointments",{method:"POST",body:JSON.stringify(t)}),or=(t,e)=>L(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),ir=t=>L(`/api/appointments/${t}`,{method:"DELETE"}),rr=t=>L(`/api/appointments/${t}/reopen`,{method:"POST"}),nr=(t,e)=>L(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)}),ne=document.getElementById("sidebar"),Ve=document.getElementById("sidebarToggle"),kt=document.getElementById("mainContent"),lr=document.querySelectorAll(".sidebar-link"),Wa=document.getElementById("menu-search"),Ms=document.getElementById("hamburger-menu-btn"),it=document.getElementById("mobile-overlay");let Ae=!0;function He(t){if(!ne||!kt)return;ne.classList.toggle("collapsed",t),kt.classList.toggle("sidebar-collapsed-shift",t);const e=ne.querySelector(".sidebar-search-container"),a=ne.querySelectorAll(".sidebar-category");t?(e&&(e.style.display="none"),a.forEach(s=>s.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(s=>{const i=s.getAttribute("data-target-submenu"),o=document.getElementById(i),r=s.querySelector(".submenu-arrow");o&&(o.classList.add("hidden"),o.classList.remove("flex")),r&&r.classList.remove("rotate-180")})):(e&&(e.style.display="block"),a.forEach(s=>s.style.display="block"))}function dr(){!ne||!it||(ne.classList.add("mobile-open"),it.classList.add("visible"))}function Nt(){!ne||!it||(ne.classList.remove("mobile-open"),it.classList.remove("visible"))}function cr(){He(!ne.classList.contains("collapsed"))}function ur(t,e){const a=document.getElementById(t);if(!a)return;const s=a.classList.contains("hidden");s&&window.innerWidth>=1024&&ne.classList.contains("collapsed")&&He(!1),s?(a.classList.remove("hidden"),a.classList.add("flex"),e&&e.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),e&&e.classList.remove("rotate-180"))}function pr(){Wa&&Wa.addEventListener("input",t=>{const e=t.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const s=a.querySelectorAll("li"),i=a.querySelectorAll(".sidebar-category");if(e===""){s.forEach(o=>o.style.display=""),i.forEach(o=>o.style.display="block");return}i.forEach(o=>o.style.display="none"),s.forEach(o=>{if(o.classList.contains("sidebar-category"))return;const r=o.querySelector(".sidebar-link")||o.querySelector(".submenu-toggle");if(!r)return;if(r.textContent.toLowerCase().includes(e)){o.style.display="";const d=o.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const u=d.parentElement.querySelector(".submenu-toggle");if(u){const c=u.querySelector(".submenu-arrow");c&&c.classList.add("rotate-180")}}}else{const d=r.getAttribute("data-target-submenu");if(d){const u=document.getElementById(d);u&&(Array.from(u.querySelectorAll(".sidebar-link")).some(b=>b.textContent.toLowerCase().includes(e))?o.style.display="":o.style.display="none")}else o.style.display="none"}})})}function br(t,e,a){if(!ne||!kt)return;kt.classList.add("main-content-shift"),window.innerWidth>=1024?(Ae=!0,He(!1)):window.innerWidth>=768?(Ae=!1,He(!0)):(kt.classList.remove("main-content-shift","sidebar-collapsed-shift"),Nt()),Ve&&Ve.addEventListener("click",i=>{i.stopPropagation(),window.innerWidth>=768?(Ae=!Ae,He(!Ae),Ae?(Ve.classList.add("text-indigo-400"),Ve.classList.remove("text-gray-400")):(Ve.classList.remove("text-indigo-400"),Ve.classList.add("text-gray-400"))):cr()}),ne.addEventListener("mouseenter",()=>{window.innerWidth>=768&&!Ae&&ne.classList.contains("collapsed")&&He(!1)}),ne.addEventListener("mouseleave",()=>{if(window.innerWidth>=768&&!Ae){const i=!!document.querySelector("#sidebarToggle:hover"),o=document.activeElement===Wa;!i&&!o&&He(!0)}}),Ms&&Ms.addEventListener("click",i=>{i.stopPropagation(),dr()}),it&&it.addEventListener("click",i=>{i.stopPropagation(),Nt()});let s=0;ne.addEventListener("touchstart",i=>{s=i.changedTouches[0].screenX},{passive:!0}),ne.addEventListener("touchend",i=>{const o=i.changedTouches[0].screenX;s-o>50&&Nt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(i=>{i.addEventListener("click",o=>{o.preventDefault(),o.stopPropagation();const r=i.getAttribute("data-target-submenu"),n=i.querySelector(".submenu-arrow");ur(r,n)})}),pr(),lr.forEach(i=>{const o=i.getAttribute("data-target");if(!o)return;const r=o.replace("-section",""),n=a?.[r]!==!1,l=e===null||e[o]?.view===!0;if(!n||!l){i.parentElement&&i.parentElement.tagName==="LI"?i.parentElement.style.display="none":i.style.display="none";return}i.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(u=>u.classList.remove("active")),i.classList.add("active"),o&&typeof t=="function"&&t(o),window.innerWidth<768&&Nt()})})}const mr=t=>L("/api/establishments/",{method:"POST",body:JSON.stringify(t)}),ke=()=>L("/api/establishments/hierarchy",{method:"GET"}),je=t=>{const e=t||g.establishmentId;return e?L(`/api/establishments/${e}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},ms=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(e)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},gr=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},fr=(t,e)=>{const a=t||g.establishmentId;return a?L(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:e})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Le=t=>L(`/api/professionals/${t}`),ko=t=>L(`/api/professionals/details/${t}`),xr=t=>L("/api/professionals",{method:"POST",body:JSON.stringify(t)}),Ja=(t,e)=>L(`/api/professionals/${t}`,{method:"PUT",body:JSON.stringify(e)}),So=t=>L(`/api/professionals/${t}`,{method:"DELETE"}),hr=t=>{const e=t.map(a=>So(a));return Promise.all(e)};class vr{constructor(e,a,s){this.steps=e,this.currentStep=0,this.onComplete=a,this.onSkip=s,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(e=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),e&&this.onComplete?this.onComplete():!e&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const e=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",e.onBefore&&(await e.onBefore(),await this.sleep(600));const a=await this.waitForElement(e.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const i=a.getBoundingClientRect(),o=8;this.spotlight.style.top=`${i.top+window.scrollY-o}px`,this.spotlight.style.left=`${i.left+window.scrollX-o}px`,this.spotlight.style.width=`${i.width+o*2}px`,this.spotlight.style.height=`${i.height+o*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(i)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const s=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
            <div class="p-5">
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(e){const a=this.popover.getBoundingClientRect(),s=20;let i=e.bottom+window.scrollY+s,o=e.left+window.scrollX;i+a.height>window.scrollY+window.innerHeight&&(i=e.top+window.scrollY-a.height-s),o+a.width>window.innerWidth&&(o=e.right+window.scrollX-a.width),o<s&&(o=s),this.popover.style.top=`${i}px`,this.popover.style.left=`${o}px`}handleResize(){this.isActive&&this.renderStep()}sleep(e){return new Promise(a=>setTimeout(a,e))}async waitForElement(e,a){if(!e)return null;const s=Date.now();for(;Date.now()-s<a;){const i=document.querySelector(e);if(i)return i;await this.sleep(100)}return null}}async function yr(){try{console.log("A verificar Onboarding interativo...");const t=await je(g.establishmentId);if(!t||t.parentId||t.onboardingCompleted)return;const e=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await ms(g.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(i){console.error("Erro ao gravar fim do onboarding",i)}};new vr(e,a,a).start()}catch(t){console.error("Erro fatal ao iniciar onboarding:",t)}}var rt;(function(t){t.Unimplemented="UNIMPLEMENTED",t.Unavailable="UNAVAILABLE"})(rt||(rt={}));class Fa extends Error{constructor(e,a,s){super(e),this.message=e,this.code=a,this.data=s}}const wr=t=>{var e,a;return t?.androidBridge?"android":!((a=(e=t?.webkit)===null||e===void 0?void 0:e.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},kr=t=>{const e=t.CapacitorCustomPlatform||null,a=t.Capacitor||{},s=a.Plugins=a.Plugins||{},i=()=>e!==null?e.name:wr(t),o=()=>i()!=="web",r=c=>{const p=d.get(c);return!!(p?.platforms.has(i())||n(c))},n=c=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===c)},l=c=>t.console.error(c),d=new Map,u=(c,p={})=>{const b=d.get(c);if(b)return console.warn(`Capacitor plugin "${c}" already registered. Cannot register plugins twice.`),b.proxy;const m=i(),h=n(c);let y;const k=async()=>(!y&&m in p?y=typeof p[m]=="function"?y=await p[m]():y=p[m]:e!==null&&!y&&"web"in p&&(y=typeof p.web=="function"?y=await p.web():y=p.web),y),A=(C,D)=>{var V,T;if(h){const M=h?.methods.find(R=>D===R.name);if(M)return M.rtype==="promise"?R=>a.nativePromise(c,D.toString(),R):(R,Y)=>a.nativeCallback(c,D.toString(),R,Y);if(C)return(V=C[D])===null||V===void 0?void 0:V.bind(C)}else{if(C)return(T=C[D])===null||T===void 0?void 0:T.bind(C);throw new Fa(`"${c}" plugin is not implemented on ${m}`,rt.Unimplemented)}},P=C=>{let D;const V=(...T)=>{const M=k().then(R=>{const Y=A(R,C);if(Y){const te=Y(...T);return D=te?.remove,te}else throw new Fa(`"${c}.${C}()" is not implemented on ${m}`,rt.Unimplemented)});return C==="addListener"&&(M.remove=async()=>D()),M};return V.toString=()=>`${C.toString()}() { [capacitor code] }`,Object.defineProperty(V,"name",{value:C,writable:!1,configurable:!1}),V},$=P("addListener"),E=P("removeListener"),N=(C,D)=>{const V=$({eventName:C},D),T=async()=>{const R=await V;E({eventName:C,callbackId:R},D)},M=new Promise(R=>V.then(()=>R({remove:T})));return M.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await T()},M},U=new Proxy({},{get(C,D){switch(D){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?N:$;case"removeListener":return E;default:return P(D)}}});return s[c]=U,d.set(c,{name:c,proxy:U,platforms:new Set([...Object.keys(p),...h?[m]:[]])}),U};return a.convertFileSrc||(a.convertFileSrc=c=>c),a.getPlatform=i,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=r,a.registerPlugin=u,a.Exception=Fa,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Sr=t=>t.Capacitor=kr(t),Ee=Sr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ea=Ee.registerPlugin;class $o{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(e,a){let s=!1;this.listeners[e]||(this.listeners[e]=[],s=!0),this.listeners[e].push(a);const o=this.windowListeners[e];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(e);const r=async()=>this.removeListener(e,a);return Promise.resolve({remove:r})}async removeAllListeners(){this.listeners={};for(const e in this.windowListeners)this.removeWindowListener(this.windowListeners[e]);this.windowListeners={}}notifyListeners(e,a,s){const i=this.listeners[e];if(!i){if(s){let o=this.retainedEventArguments[e];o||(o=[]),o.push(a),this.retainedEventArguments[e]=o}return}i.forEach(o=>o(a))}hasListeners(e){var a;return!!(!((a=this.listeners[e])===null||a===void 0)&&a.length)}registerWindowListener(e,a){this.windowListeners[a]={registered:!1,windowEventName:e,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(e="not implemented"){return new Ee.Exception(e,rt.Unimplemented)}unavailable(e="not available"){return new Ee.Exception(e,rt.Unavailable)}async removeListener(e,a){const s=this.listeners[e];if(!s)return;const i=s.indexOf(a);this.listeners[e].splice(i,1),this.listeners[e].length||this.removeWindowListener(this.windowListeners[e])}addWindowListener(e){window.addEventListener(e.windowEventName,e.handler),e.registered=!0}removeWindowListener(e){e&&(window.removeEventListener(e.windowEventName,e.handler),e.registered=!1)}sendRetainedArgumentsForEvent(e){const a=this.retainedEventArguments[e];a&&(delete this.retainedEventArguments[e],a.forEach(s=>{this.notifyListeners(e,s)}))}}const As=t=>encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Bs=t=>t.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class $r extends $o{async getCookies(){const e=document.cookie,a={};return e.split(";").forEach(s=>{if(s.length<=0)return;let[i,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");i=Bs(i).trim(),o=Bs(o).trim(),a[i]=o}),a}async setCookie(e){try{const a=As(e.key),s=As(e.value),i=`; expires=${(e.expires||"").replace("expires=","")}`,o=(e.path||"/").replace("path=",""),r=e.url!=null&&e.url.length>0?`domain=${e.url}`:"";document.cookie=`${a}=${s||""}${i}; path=${o}; ${r};`}catch(a){return Promise.reject(a)}}async deleteCookie(e){try{document.cookie=`${e.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const e=document.cookie.split(";")||[];for(const a of e)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(e){return Promise.reject(e)}}async clearAllCookies(){try{await this.clearCookies()}catch(e){return Promise.reject(e)}}}Ea("CapacitorCookies",{web:()=>new $r});const Ir=async t=>new Promise((e,a)=>{const s=new FileReader;s.onload=()=>{const i=s.result;e(i.indexOf(",")>=0?i.split(",")[1]:i)},s.onerror=i=>a(i),s.readAsDataURL(t)}),Er=(t={})=>{const e=Object.keys(t);return Object.keys(t).map(i=>i.toLocaleLowerCase()).reduce((i,o,r)=>(i[o]=t[e[r]],i),{})},Lr=(t,e=!0)=>t?Object.entries(t).reduce((s,i)=>{const[o,r]=i;let n,l;return Array.isArray(r)?(l="",r.forEach(d=>{n=e?encodeURIComponent(d):d,l+=`${o}=${n}&`}),l.slice(0,-1)):(n=e?encodeURIComponent(r):r,l=`${o}=${n}`),`${s}&${l}`},"").substr(1):null,Cr=(t,e={})=>{const a=Object.assign({method:t.method||"GET",headers:t.headers},e),i=Er(t.headers)["content-type"]||"";if(typeof t.data=="string")a.body=t.data;else if(i.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[r,n]of Object.entries(t.data||{}))o.set(r,n);a.body=o.toString()}else if(i.includes("multipart/form-data")||t.data instanceof FormData){const o=new FormData;if(t.data instanceof FormData)t.data.forEach((n,l)=>{o.append(l,n)});else for(const n of Object.keys(t.data))o.append(n,t.data[n]);a.body=o;const r=new Headers(a.headers);r.delete("content-type"),a.headers=r}else(i.includes("application/json")||typeof t.data=="object")&&(a.body=JSON.stringify(t.data));return a};class Dr extends $o{async request(e){const a=Cr(e,e.webFetchExtra),s=Lr(e.params,e.shouldEncodeUrlParams),i=s?`${e.url}?${s}`:e.url,o=await fetch(i,a),r=o.headers.get("content-type")||"";let{responseType:n="text"}=o.ok?e:{};r.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await o.blob(),l=await Ir(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const u={};return o.headers.forEach((c,p)=>{u[p]=c}),{data:l,headers:u,status:o.status,url:o.url}}async get(e){return this.request(Object.assign(Object.assign({},e),{method:"GET"}))}async post(e){return this.request(Object.assign(Object.assign({},e),{method:"POST"}))}async put(e){return this.request(Object.assign(Object.assign({},e),{method:"PUT"}))}async patch(e){return this.request(Object.assign(Object.assign({},e),{method:"PATCH"}))}async delete(e){return this.request(Object.assign(Object.assign({},e),{method:"DELETE"}))}}Ea("CapacitorHttp",{web:()=>new Dr});const pe=Ea("PushNotifications",{}),Pr="modulepreload",Tr=function(t){return"/"+t},js={},Mr=function(e,a,s){let i=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),n=r?.nonce||r?.getAttribute("nonce");i=l(a.map(d=>{if(d=Tr(d),d in js)return;js[d]=!0;const u=d.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":Pr,u||(p.as="script"),p.crossOrigin="",p.href=d,n&&p.setAttribute("nonce",n),document.head.appendChild(p),u)return new Promise((b,m)=>{p.addEventListener("load",b),p.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(r){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=r,window.dispatchEvent(n),!n.defaultPrevented)throw r}return i.then(r=>{for(const n of r||[])n.status==="rejected"&&o(n.reason);return e().catch(o)})},qs=Ea("App",{web:()=>Mr(()=>import("./web-D2ZZ8myh.js"),__vite__mapDeps([0,1,2,3,4])).then(t=>new t.AppWeb)}),Ar="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ns=!1;async function Br(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await pe.removeAllListeners(),await pe.addListener("registration",async a=>{Eo(a.value,!0)}),await pe.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await pe.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let e=await pe.checkPermissions();e.receive==="prompt"&&(e=await pe.requestPermissions()),e.receive==="granted"&&await pe.register()}catch(e){console.error("[Push Nativo] Erro:",e)}return}"Notification"in window&&Notification.permission==="granted"&&Io()}async function jr(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Io(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(t){return console.error("Erro ao pedir permissão Web:",t),!1}}async function Io(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await t.update();const e=await Zi(Ts,{vapidKey:Ar,serviceWorkerRegistration:t});e?(console.log("[Push Web] Token validado."),await Eo(e,!1)):console.warn("[Push Web] Token veio vazio."),Ns||(Ki(Ts,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Ns=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}else console.warn("Navegador sem suporte a Service Worker.")}async function Eo(t,e){const a=we.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=Be(xe,"users",a.uid);try{const i=await bs(s);if(i.exists()){const r=i.data().fcmTokens||[];if(r.length===1&&r[0]===t){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await Mt(s,{fcmTokens:[t],lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(i){if(i.code==="not-found")try{await Ui(s,{email:a.email,fcmTokens:[t],platform:e?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",i)}}const qr=(t,e,a="all",s="all")=>{const i=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&i.append("professionalId",a),s&&s!=="all"&&i.append("costCenterId",s),L(`/api/reports/indicators?${i.toString()}`)},Nr=(t,e="all")=>{const a=new URLSearchParams({date:t});return e&&e!=="all"&&a.append("professionalId",e),L(`/api/reports/appointments/list?${a.toString()}`)},Fr=t=>t?L(`/api/financial/cost-centers/${t}`):Promise.resolve([]),Rr=(t,e,a)=>{const s=new URLSearchParams({startDate:e,endDate:a});return L(`/api/analytics/${t}?${s.toString()}`)},pa=({establishmentId:t,startDate:e,endDate:a,cashierSessionId:s})=>{const i=new URLSearchParams({startDate:e,endDate:a});return s&&s!=="all"&&i.append("cashierSessionId",s),t&&i.append("establishmentId",t),L(`/api/reports/sales?${i.toString()}`)},Hr=(t,e,a)=>L(`/api/analytics/${t}/monthly-details?year=${e}&month=${a}`),Or=(t,e,a,s)=>{const i=`/api/analytics/${t}/daily-details?year=${e}&month=${a}&day=${s}`;return L(i)},zr=(t,e,a,s)=>{const i=`/api/analytics/${t}/professional-details?year=${e}&month=${a}&professionalId=${s}`;return L(i)},_r=(t,e,a,s)=>L(`/api/reports/commissions/${t}?year=${e}&month=${a}&professionalId=${s}`),Lo=()=>L("/api/reports/summary",{method:"GET"}),Vr=Object.freeze(Object.defineProperty({__proto__:null,getAdvancedIndicators:qr,getAnalytics:Rr,getCommissionReport:_r,getCostCenters:Fr,getDailyAppointments:Nr,getDailyTransactions:Or,getMonthlyAnalytics:Hr,getProfessionalMonthlyDetails:zr,getSalesReport:pa,getSummaryKPIs:Lo},Symbol.toStringTag,{value:"Module"})),La=t=>t?String(t).replace(/\D/g,""):"",ut=(t,e="",a=20,s={})=>{const i=new URLSearchParams;return e&&i.append("search",e),a&&i.append("limit",a),s&&s.hasLoyalty&&i.append("hasLoyalty","true"),s&&s.birthMonth&&i.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&i.append("inactiveDays",s.inactiveDays),L(`/api/clients/${t}?${i.toString()}`)},Co=(t,e)=>{const a=encodeURIComponent(e);return L(`/api/clients/details/${t}/${a}`)},Do=t=>{const e=t.phone||t.id;if(!e)throw new Error("Telefone é obrigatório");const a=La(e),s={...t,phone:a,id:a};return L(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},Po=Do,gs=(t,e)=>Do({...e,id:t}),Ur=(t,e)=>{const a=La(e),s=Array.isArray(t)||t instanceof Set?Array.from(t).join(","):t;return L(`/api/clients/full-history/${s}?phone=${a}`)},To=t=>{const e=encodeURIComponent(t);return L(`/api/clients/${e}`,{method:"DELETE"})},Mo=(t,e,a,s)=>L("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientPhone:La(e),points:a,rewardName:s})}),Wr=(t,e)=>Co(t,La(e)),Ca=t=>L(`/api/financial/natures/${t}`),Jr=t=>L("/api/financial/natures",{method:"POST",body:JSON.stringify(t)}),fs=t=>L(`/api/financial/cost-centers/${t}`),Gr=t=>L("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(t)}),Ao=(t,e)=>L(`/api/financial/${t}`,{method:"POST",body:JSON.stringify(e)}),Bo=(t,e={})=>{let a=`/api/financial/${t}`;const s=new URLSearchParams;e.establishmentId&&s.append("establishmentId",e.establishmentId),e.startDate&&s.append("startDate",e.startDate),e.endDate&&s.append("endDate",e.endDate),e.natureId&&s.append("natureId",e.natureId),e.costCenterId&&s.append("costCenterId",e.costCenterId),e.status&&s.append("status",e.status);const i=s.toString();return i&&(a+=`?${i}`),L(a)},jo=(t,e,a)=>L(`/api/financial/${t}/${e}`,{method:"PUT",body:JSON.stringify(a)}),qo=(t,e)=>L(`/api/financial/${t}/${e}`,{method:"DELETE"}),No=(t,e)=>{const a=e.map(s=>L(`/api/financial/${t}/${s}`,{method:"DELETE"}));return Promise.all(a)},Fo=(t,e,a)=>L(`/api/financial/${t}/${e}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Ro=t=>Ao("payables",t),xs=t=>Bo("payables",t),Qr=(t,e)=>jo("payables",t,e),Xr=t=>qo("payables",t),Yr=(t,e)=>Fo("payables",t,e),Zr=t=>Ao("receivables",t),Da=t=>Bo("receivables",t),Kr=(t,e)=>jo("receivables",t,e),en=t=>qo("receivables",t),tn=(t,e)=>Fo("receivables",t,e);let Ra=null;function Se(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${s}`}async function an(){const t=document.getElementById("content");t.innerHTML=`
    ...
    `;try{const e=new Date,a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),s=new Date(a);s.setHours(23,59,59,999);const i=new Date(a.getFullYear(),a.getMonth(),1),o=new Date(a.getFullYear(),a.getMonth()+1,0),r=new Date(a);r.setDate(a.getDate()-6);const n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=n.map(async q=>{const[ee,le]=await Promise.all([Ia(q,i.toISOString(),s.toISOString(),null).catch(()=>[]),ut(q).catch(()=>[])]);return{appts:ee,clients:le}}),u=Promise.all([Da({startDate:Se(i),endDate:Se(o),establishmentId:l}).catch(()=>({entries:[]})),xs({startDate:Se(i),endDate:Se(o),establishmentId:l}).catch(()=>({entries:[]}))]),[c,[p,b]]=await Promise.all([Promise.all(d),u]);let m=[],h=[];c.forEach(q=>{m=m.concat(q.appts),h=h.concat(q.clients)});const y=p.entries||[],k=b.entries||[],A=Se(a),P=y.filter(q=>q.status==="paid").reduce((q,ee)=>q+ee.amount,0),$=k.filter(q=>q.status==="paid").reduce((q,ee)=>q+ee.amount,0),E=P-$,N=y.filter(q=>q.status==="paid"&&(q.paymentDate===A||!q.paymentDate&&q.dueDate.startsWith(A))).reduce((q,ee)=>q+ee.amount,0),U=m.filter(q=>{const ee=new Date(q.startTime);return ee>=a&&ee<=s}),C=U.length,D=m.filter(q=>q.status==="completed"),V=D.length>0?P/D.length:0,T=U.filter(q=>new Date(q.startTime).getTime()>=e.getTime()&&q.status!=="completed"&&q.status!=="cancelled").sort((q,ee)=>new Date(q.startTime)-new Date(ee.startTime)).slice(0,4).map(q=>({client:q.clientName||"Desconhecido",service:q.serviceName||(q.services&&q.services[0]?q.services[0].name:"Serviço"),time:new Date(q.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),prof:(q.professionalName||"").split(" ")[0]||"Profissionais",id:q.id})),M=`${String(a.getDate()).padStart(2,"0")}/${String(a.getMonth()+1).padStart(2,"0")}`,R=new Map;h.forEach(q=>{q.phone?R.set(q.phone,q):R.set(q.id||Math.random().toString(),q)});const te=Array.from(R.values()).filter(q=>{if(!q.birthDate)return!1;let ee,le;if(q.birthDate.includes("-")){const W=q.birthDate.split("-");W[0].length===4?(ee=W[1],le=W[2]):(le=W[0],ee=W[1])}else if(q.birthDate.includes("/")){const W=q.birthDate.split("/");le=W[0],ee=W[1]}return`${le}/${ee}`===M}).map(q=>{let ee="";return q.birthDate&&q.birthDate.includes("-")&&q.birthDate.split("-")[0].length===4&&(ee=a.getFullYear()-parseInt(q.birthDate.split("-")[0])),{name:q.name,age:ee,phone:q.phone}}),re={receitaHoje:N,agendamentosHoje:C,receitaMes:P,despesaMes:$,saldoMes:E,ticketMedio:V},Z=n.length>1;sn(t,re,T,te,Z,Se(r),Se(a)),await Ho(r,a),rn()}catch(e){console.error("Erro ao carregar dashboard:",e),t.innerHTML=`
        ...
        `}}function sn(t,e,a,s,i,o,r){const n=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),l=i?`
    ...
    `}async function Ho(t,e){const a=document.getElementById("chart-container"),s=document.getElementById("chart-start-date"),i=document.getElementById("chart-end-date");if(a){const o=document.createElement("div");o.id="chart-loading-overlay",o.className="absolute inset-0 bg-white/70 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-xl",o.innerHTML='<div class="w-8 h-8 border-[3px] border-indigo-100 border-t-indigo-500 rounded-full animate-spin"></div>',a.appendChild(o)}try{const o=Se(t),r=Se(e),n=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId],l=n.join(","),d=await Da({startDate:o,endDate:r,establishmentId:l}).catch(()=>({entries:[]})),u=n.map(P=>Ia(P,o+"T00:00:00.000Z",r+"T23:59:59.999Z",null).catch(()=>[])),p=(await Promise.all(u)).flat(),b=d.entries||[],m=[],h=[],y=[];let k=new Date(t);k.setHours(0,0,0,0);const A=new Date(e);for(A.setHours(23,59,59,999);k<=A;){const P=Se(k);m.push(k.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}));const $=b.filter(N=>N.status==="paid"&&(N.paymentDate===P||!N.paymentDate&&N.dueDate.startsWith(P))).reduce((N,U)=>N+U.amount,0),E=p.filter(N=>N.status==="completed"&&N.startTime&&N.startTime.startsWith(P)).length;h.push($),y.push(E),k.setDate(k.getDate()+1)}on(m,h,y),s&&(s.value=o),i&&(i.value=r)}catch(o){console.error("Erro ao recarregar grafico:",o)}finally{const o=document.getElementById("chart-loading-overlay");o&&o.remove()}}function on(t,e,a){const s=document.getElementById("revenueChart");if(!s)return;Ra&&Ra.destroy();const o=s.getContext("2d").createLinearGradient(0,0,0,240);o.addColorStop(0,"rgba(99, 102, 241, 0.2)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)"),Ra=new Chart(s,{type:"line",data:{labels:t,datasets:[{label:"Receita Real (R$)",data:e,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.3,yAxisID:"y"},{label:"Agendamentos Feitos",data:a,borderColor:"#10b981",backgroundColor:"transparent",borderWidth:2,borderDash:[5,5],pointBackgroundColor:"#10b981",pointBorderColor:"#ffffff",pointBorderWidth:1,pointRadius:3,pointHoverRadius:5,fill:!1,tension:.3,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,boxHeight:6,font:{family:"Nunito, sans-serif",size:10,weight:"bold"},color:"#64748b"}},tooltip:{backgroundColor:"#1e293b",padding:10,cornerRadius:8,titleFont:{size:11,family:"Nunito, sans-serif",weight:"normal"},bodyFont:{size:12,weight:"bold",family:"Nunito, sans-serif"},displayColors:!0,usePointStyle:!0,callbacks:{label:function(r){return r.datasetIndex===0?"Receita: "+new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(r.parsed.y):"Concluídos: "+r.parsed.y}}}},scales:{y:{type:"linear",display:!0,position:"left",beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"},maxTicksLimit:6,callback:function(r){return"R$ "+r}}},y1:{type:"linear",display:!0,position:"right",beginAtZero:!0,grid:{drawOnChartArea:!1},border:{display:!1},ticks:{color:"#10b981",font:{family:"Nunito, sans-serif",size:9,weight:"600"},stepSize:1,callback:function(r){if(Math.floor(r)===r)return r}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Nunito, sans-serif",size:9,weight:"600"}}}},interaction:{intersect:!1,mode:"index"}}})}function rn(){document.getElementById("content").addEventListener("click",e=>{if(e.target.closest("#btn-update-chart")){const o=document.getElementById("chart-start-date"),r=document.getElementById("chart-end-date");if(o&&r&&o.value&&r.value){const n=new Date(o.value+"T00:00:00"),l=new Date(r.value+"T00:00:00");Ho(n,l)}return}const s=e.target.closest("[data-action]");if(!s)return;switch(s.dataset.action){case"goto-agenda":case"new-appointment":oe("agenda-section");break;case"goto-pdv":oe("comandas-section");break;case"goto-clients":oe("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${g.establishmentId||""}`;window.open(o,"_blank");break}})}const pt=t=>L(`/api/services/${t}`),nn=t=>L("/api/services",{method:"POST",body:JSON.stringify(t)}),ln=(t,e)=>L(`/api/services/${t}`,{method:"PUT",body:JSON.stringify(e)}),Oo=t=>L(`/api/services/${t}`,{method:"DELETE"}),Pa=(t,e,a,s="all")=>{const i=`/api/blockages/${t}?startDate=${e}&endDate=${a}&professionalId=${s}`;return L(i)},Ta=t=>L("/api/blockages",{method:"POST",body:JSON.stringify(t)}),hs=t=>L(`/api/blockages/${t}`,{method:"DELETE"}),zo=t=>L("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Fs=document.getElementById("content");let Rs=!1;const ba=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Ma=[],Ga=[],ma={},_o=[],O={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},H={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,originalDate:null,originalTime:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Vo(t){const e=new Date(t),a=e.getDay(),s=e.getDate()-a+(a===0?-6:1);return e.setDate(s),e.setHours(0,0,0,0),e}function oa(t){const e=t||new Date,a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}function vs(){const t=document.getElementById("profSelectorContainer");if(!t||!g.professionals)return;let e=g.professionals.filter(i=>O.showInactiveProfs||i.status!=="inactive");const s=[...[{id:"all",name:"Todos",photo:null}],...e];t.innerHTML=s.map(i=>{const o=O.selectedProfessionalId===i.id,r=i.name==="Todos"?"T":i.name.charAt(0).toUpperCase(),n=i.id!=="all"?g.professionalColors.get(i.id)||ba[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
        ...
        </div>`}o+="</div>",e.innerHTML=o,requestAnimationFrame(()=>{const r=document.getElementById("weekScroller");if(r&&window.innerWidth<768){const n=r.querySelector(".is-today");n&&n.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})}})}function pn(t){const e=document.getElementById("agenda-view");if(!e)return;if(t.sort((s,i)=>new Date(s.startTime)-new Date(i.startTime)),t.length===0){e.innerHTML=`
        ...
        </div>`}),a+="</div>",e.innerHTML=a}function Uo(){const t=g.allEvents.filter(e=>O.selectedProfessionalId==="all"||e.professionalId===O.selectedProfessionalId);O.currentView==="list"?pn(t):un(t),ys()}function ys(){const t=document.getElementById("batch-delete-container"),e=document.getElementById("agendaFab");t&&(O.isSelectionMode&&O.selectedItems.size>0?(t.innerHTML=`<div class="bg-gray-900 text-white p-3 mx-4 rounded-2xl shadow-xl flex items-center justify-between">
        ...
        </div>`,t.style.display="block",e&&(e.style.transform="scale(0)")):(t.style.display="none",e&&(e.style.transform="scale(1)")))}function bn(){const t=document.getElementById("currentMonthYearDisplay");if(t){const a=new Date(O.currentDate).toLocaleDateString("pt-BR",{month:"long",year:"numeric"});t.textContent=a.charAt(0).toUpperCase()+a.slice(1)}if(O.currentView==="list"){dn();const e=document.getElementById("calendarStripContainer");e&&(e.style.display="flex")}else{const e=document.getElementById("calendarStripContainer");e&&(e.style.display="none")}}async function De(){const t=document.getElementById("agenda-view");if(!t)return;O.selectedItems.clear(),ys(),t.innerHTML='<div class="flex items-center justify-center h-40"><div class="w-8 h-8 border-4 border-indigo-100 border-t-indigo-600 rounded-full animate-spin"></div></div>',bn();let e,a;if(O.currentView==="list")e=new Date(O.currentDate),e.setHours(0,0,0,0),a=new Date(e),a.setHours(23,59,59,999);else{const s=Vo(O.currentDate);e=new Date(s),a=new Date(s),a.setDate(s.getDate()+6),a.setHours(23,59,59,999)}try{const i=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async d=>{const[u,c]=await Promise.all([Ia(d,e.toISOString(),a.toISOString(),O.selectedProfessionalId==="all"?null:O.selectedProfessionalId),Pa(d,e.toISOString(),a.toISOString(),O.selectedProfessionalId)]);return{appts:u||[],blockages:c||[]}}),o=await Promise.all(i);let r=[],n=[];if(o.forEach(d=>{r=r.concat(d.appts),n=n.concat(d.blockages)}),!document.getElementById("agenda-view"))return;const l=d=>d.map(u=>({...u,type:u.type||"appointment",professionalName:u.professionalName||(()=>{const c=g.professionals?.find(p=>p.id===u.professionalId);return c?c.name:"Indefinido"})()}));g.allEvents=[...l(r),...l(n)],vs(),Uo()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12 text-gray-500">
                    <i class="bi bi-exclamation-triangle text-3xl mb-2"></i>
                    <p class="text-sm font-medium">Erro ao carregar a agenda.</p>
                </div>`)}}async function mn(){try{const e=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).map(async r=>{const[n,l,d]=await Promise.all([Le(r),pt(r),je(r)]);return{profs:n||[],services:l||[],estDetails:d}}),a=await Promise.all(e),s=new Map,i=new Map;let o=a[0]?.estDetails;a.forEach(r=>{r.profs.forEach(n=>s.set(n.id,n)),r.services.forEach(n=>i.set(n.id,n))}),g.professionals=Array.from(s.values()),g.services=Array.from(i.values()),_o=[],o&&(ma=o.loyaltyProgram||{enabled:!1}),g.professionals.forEach((r,n)=>{g.professionalColors.set(r.id,ba[n%ba.length])}),vs()}catch{f("Atenção","Não foi possível carregar os dados da equipe.","error")}}async function Wo(t={}){O.currentDate=t.targetDate?new Date(t.targetDate):O.currentDate||new Date,O.isSelectionMode=!1,O.selectedItems.clear(),Fs.innerHTML=`
        ...
        </div>`,document.getElementById("btnTodayHeader").addEventListener("click",()=>{O.currentDate=new Date,navigator.vibrate&&navigator.vibrate(30),De()}),document.getElementById("btnPrevDate").addEventListener("click",()=>{const a=O.currentView==="week"?7:1;O.currentDate.setDate(O.currentDate.getDate()-a),navigator.vibrate&&navigator.vibrate(20),De()}),document.getElementById("btnNextDate").addEventListener("click",()=>{const a=O.currentView==="week"?7:1;O.currentDate.setDate(O.currentDate.getDate()+a),navigator.vibrate&&navigator.vibrate(20),De()});const e=document.querySelectorAll(".agenda-view-toggle button");e.forEach(a=>{a.addEventListener("click",()=>{e.forEach(s=>{s.classList.remove("bg-white","shadow-sm"),s.classList.add("text-gray-500")}),a.classList.add("bg-white","shadow-sm"),a.classList.remove("text-gray-500"),O.currentView=a.dataset.view,navigator.vibrate&&navigator.vibrate(20),De()})}),document.getElementById("btnWeekDays").addEventListener("click",gn),Rs||(Fs.addEventListener("click",async a=>{const s=a.target.closest('[data-action="open-comanda"]');if(s){a.stopPropagation(),navigator.vibrate&&navigator.vibrate(20);const l=s.dataset.appointment||s.closest("[data-appointment]")?.dataset.appointment;if(!l)return;const d=JSON.parse(l.replace(/&apos;/g,"'")),u=d.status==="completed"?"finalizadas":"em-atendimento",c={selectedAppointmentId:d.id,initialFilter:u};u==="finalizadas"&&d.transaction?.paidAt&&(c.filterDate=typeof d.transaction.paidAt=="object"?new Date(d.transaction.paidAt._seconds*1e3):d.transaction.paidAt),oe("comandas-section",c);return}const i=a.target.closest(".lc-action-btn.wa");if(i){a.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),i.dataset.link&&window.open(i.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const l=O.selectedItems.size;await G("Apagar Selecionados",`Deseja apagar ${l} registro(s)? Esta ação é irreversível.`)&&(await Promise.all(Array.from(O.selectedItems).map(async u=>{try{await ir(u)}catch{}})),f(`${l} registro(s) apagado(s).`,"success"),O.selectedItems.clear(),O.isSelectionMode=!1,De());return}const o=a.target.closest('[data-action="select-professional"]');if(o){navigator.vibrate&&navigator.vibrate(20);const l=o.dataset.profId;O.selectedProfessionalId=O.selectedProfessionalId===l&&l!=="all"?"all":l,De();return}const r=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(r){if(O.isSelectionMode){a.stopPropagation();const d=r.querySelector('input[type="checkbox"]');if(d){const u=JSON.parse(r.dataset.appointment.replace(/&apos;/g,"'")),c=!d.checked;d.checked=c,c?O.selectedItems.add(u.id):O.selectedItems.delete(u.id),(r.classList.contains("week-event-chip")||r.classList.contains("list-card"))&&(c?(r.classList.add("ring-2","ring-indigo-500","bg-indigo-50"),r.classList.remove("bg-white")):(r.classList.remove("ring-2","ring-indigo-500","bg-indigo-50"),r.classList.add("bg-white"))),navigator.vibrate&&navigator.vibrate(15),ys()}return}const l=JSON.parse(r.dataset.appointment.replace(/&apos;/g,"'"));navigator.vibrate&&navigator.vibrate(20),Qa(l);return}if(a.target.closest('[data-action="new-appointment"]')){navigator.vibrate&&navigator.vibrate(30),Qa();return}}),Rs=!0),await mn(),await De()}function gn(){const t=document.getElementById("optionsSheet");if(t){t.remove();return}const e=document.createElement("div");e.id="optionsSheet",e.className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white rounded-t-3xl z-[10000] shadow-[0_-8px_40px_rgba(0,0,0,0.15)] transition-transform duration-300 translate-y-full";const a=O.isSelectionMode?"bg-red-50 text-red-600":"bg-green-50 text-green-700",s=O.isSelectionMode?"bi-x-circle":"bi-check2-square";e.innerHTML=`
        <div class="px-6 py-5">
        ...
        </div>`}}function xn(){return{title:"Serviços",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            ...
            <div id="apptServicesContainer" class="flex-1 overflow-y-auto grid grid-cols-2 gap-3 content-start pb-4">
                ${Ma.map(t=>`<div class="service-card p-3 bg-white rounded-xl border-2 transition-all active:scale-95 ${H.data.selectedServiceIds.includes(t.id)?"border-indigo-500 bg-indigo-50 shadow-md":"border-gray-100 hover:border-gray-200 shadow-sm"} cursor-pointer flex flex-col justify-between gap-2" data-service-id="${t.id}">
                        <div>
        ...
        </div>`}}function hn(){return{title:"Equipe",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
            <div class="relative">
                <i class="bi bi-search absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-base"></i>
        ...
        </div>`}}function vn(){const t=H.data.date||oa();return{title:"Horário",content:`
        <div class="p-4 space-y-4 flex-1 flex flex-col">
        ...
        </div>`}}async function Qa(t=null,e=!1){const a=document.getElementById("appointmentModal");e||(H={step:1,data:{id:t?.id||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(r=>r.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:t?.startTime?oa(new Date(t.startTime)):oa(),time:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,originalDate:t?.startTime?oa(new Date(t.startTime)):null,originalTime:t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}}),Ma=g.services||[],Ga=(g.professionals||[]).filter(r=>r.status==="active");let s;switch(H.step){case 1:s=fn(t);break;case 2:s=xn();break;case 3:s=hn();break;case 4:s=vn();break}a.className="fixed inset-0 z-[10000] hidden flex items-end md:items-center justify-center bg-gray-900/50 backdrop-blur-sm transition-opacity duration-300 opacity-0",a.innerHTML=`
    ...
    `;const i=()=>{const r=a.querySelector("#appointmentModalContent");r&&(r.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),r.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),a.classList.add("opacity-0"),setTimeout(()=>{a.classList.add("hidden")},300)};a.querySelectorAll('[data-action="next-step"]').forEach(r=>r.addEventListener("click",()=>{const n=parseInt(r.dataset.currentStep,10);if(n===1&&(H.data.clientName=a.querySelector("#apptClientName").value.trim(),H.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!H.data.clientName))return f("Preencha o nome do cliente.","warning");if(n===2&&H.data.selectedServiceIds.length===0)return f("Selecione um serviço.","warning");if(n===3&&!H.data.professionalId)return f("Escolha um membro da equipe.","warning");xt(n+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(r=>r.addEventListener("click",()=>xt(parseInt(r.dataset.currentStep,10)-1))),a.querySelectorAll('[data-action="close-modal"]').forEach(r=>{r.addEventListener("click",i)}),a.classList.remove("hidden"),a.offsetWidth,a.classList.remove("opacity-0");const o=a.querySelector("#appointmentModalContent");o&&(o.classList.remove("translate-y-full","md:translate-y-8","md:scale-95"),o.classList.add("translate-y-0","md:translate-y-0","md:scale-100")),H.step===2&&a.querySelectorAll(".service-card").forEach(r=>r.addEventListener("click",()=>{const n=a.querySelector("#multiServiceToggle")?.checked,l=r.classList.contains("bg-indigo-50"),d=r.dataset.serviceId;navigator.vibrate&&navigator.vibrate(15),n?l?(r.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.add("border-gray-100","shadow-sm"),H.data.selectedServiceIds=H.data.selectedServiceIds.filter(u=>u!==d)):(r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds.includes(d)||H.data.selectedServiceIds.push(d)):(a.querySelectorAll(".service-card.bg-indigo-50").forEach(u=>{u.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),u.classList.add("border-gray-100","shadow-sm")}),r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),H.data.selectedServiceIds=[d],setTimeout(()=>xt(3),250))})),H.step===3&&a.querySelectorAll(".professional-modal-card").forEach(r=>r.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),a.querySelectorAll(".professional-modal-card.bg-indigo-50").forEach(l=>{l.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),l.classList.add("border-gray-100","shadow-sm")}),r.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),r.classList.remove("border-gray-100","shadow-sm"),H.data.professionalId=r.dataset.professionalId;const n=Ga.find(l=>l.id===r.dataset.professionalId);H.data.professionalName=n?n.name:"",setTimeout(()=>xt(4),250)})),H.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",r=>kn(r.target.value)),H.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",Hs),a.querySelector("#availableTimesContainer")?.addEventListener("click",r=>{const n=r.target.closest("button[data-time-slot]");n&&(navigator.vibrate&&navigator.vibrate(10),a.querySelectorAll("#availableTimesContainer button").forEach(l=>{l.classList.remove("bg-indigo-600","text-white","border-indigo-600","shadow-md"),l.classList.add("bg-white","text-gray-700","border-gray-200","shadow-sm")}),n.classList.add("bg-indigo-600","text-white","border-indigo-600","shadow-md"),n.classList.remove("bg-white","text-gray-700","border-gray-200","shadow-sm"),H.data.time=n.dataset.timeSlot)}),a.querySelector("#btnSubmitAppointment")?.addEventListener("click",yn),Hs(),wn())}async function yn(t){t.preventDefault();const e=document.getElementById("btnSubmitAppointment");if(!H.data.time||!H.data.selectedServiceIds.length||!H.data.professionalId)return f("Selecione horário, serviço e profissional.","warning");e.disabled=!0,e.innerHTML='<i class="bi bi-hourglass-split"></i> Processando...';const a=H.data.selectedServiceIds.map(u=>{const c=Ma.find(p=>p.id===u);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[s,i]=H.data.time.split(":"),o=new Date(`${H.data.date}T${s}:${i}:00`),r=a.reduce((u,c)=>u+(c.duration+(c.bufferTime||0)),0),n=new Date(o.getTime()+r*6e4),d={establishmentId:g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId,clientName:H.data.clientName,clientPhone:H.data.clientPhone,services:a,professionalId:H.data.professionalId,professionalName:H.data.professionalName,startTime:o.toISOString(),endTime:n.toISOString(),redeemedReward:H.data.redeemedReward};H.data.id&&(d.id=H.data.id);try{H.data.id?await or(H.data.id,d):await sr(d),f("Registro salvo!","success");const u=document.getElementById("appointmentModal"),c=u.querySelector("#appointmentModalContent");c&&(c.classList.remove("translate-y-0","md:translate-y-0","md:scale-100"),c.classList.add("translate-y-full","md:translate-y-8","md:scale-95")),u.classList.add("opacity-0"),setTimeout(()=>{u.classList.add("hidden")},300),De()}catch(u){f(u.message,"error"),e.disabled=!1,e.innerHTML=`<i class="bi bi-check-circle-fill"></i> ${H.data.id?"Salvar Edição":"Confirmar"}`}}async function Hs(){const t=document.getElementById("availableTimesContainer"),e=document.getElementById("apptTotalDuration");if(!t)return;const a=document.getElementById("apptDate");a&&a.value&&(H.data.date=a.value);const s=H.data.selectedServiceIds.reduce((u,c)=>{const p=Ma.find(b=>b.id===c);return u+(p?p.duration+(p.bufferTime||0):0)},0);e&&(e.innerHTML=`<strong>${s}</strong> min`);const{professionalId:i,selectedServiceIds:o,date:r,originalDate:n,originalTime:l,id:d}=H.data;if(!i||!o.length||!r){t.innerHTML='<p class="col-span-full text-center text-xs text-gray-500 font-bold py-4 bg-white rounded-xl shadow-sm border border-gray-100">Preencha os passos anteriores.</p>';return}t.innerHTML='<div class="col-span-full flex justify-center py-4"><div class="w-6 h-6 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div></div>';try{const u=g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments[0]:g.establishmentId;let c=await ar({establishmentId:u,professionalId:i,serviceIds:o,date:r});const p=new Date;if(new Date(r+"T00:00:00").toDateString()===p.toDateString()){const b=p.getHours()*60+p.getMinutes();c=c.filter(m=>{const[h,y]=m.split(":").map(Number);return h*60+y>=b})}d&&r===n&&l&&(c.includes(l)||(c.push(l),c.sort())),t.innerHTML=c.length>0?c.map(b=>{const m=H.data.time===b;return`<button type="button" data-time-slot="${b}" class="py-3 text-sm font-bold rounded-xl border-2 transition-transform active:scale-95 ${m?"bg-indigo-600 text-white border-indigo-600 shadow-md":"bg-white text-gray-700 border-gray-200 hover:border-indigo-300 shadow-sm"}">${b}</button>`}).join(""):'<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl border border-red-100 shadow-sm">Nenhum horário livre.</p>'}catch{t.innerHTML='<p class="col-span-full text-center text-sm font-bold text-red-500 bg-white py-4 rounded-xl">Erro ao pesquisar.</p>'}}function wn(){const t=document.getElementById("loyaltyRewardsContainer");if(!t)return;const{clientHasRewards:e,clientLoyaltyPoints:a}=H.data,{enabled:s,rewards:i}=ma;if(!s||!e||!i?.length){t.innerHTML="";return}const o=i.filter(r=>a>=r.points);if(!o.length){t.innerHTML='<p class="text-xs font-bold text-gray-400 mt-3 text-center">Nenhuma recompensa atingida ainda.</p>';return}t.innerHTML=`<div class="border border-indigo-100 bg-indigo-50/80 rounded-xl p-3 mt-3 shadow-sm">
        ...
        ${o.map(r=>`<label class="flex items-center gap-2 p-2 bg-white border border-indigo-100 rounded-lg mb-1.5 cursor-pointer shadow-sm active:scale-95 transition-transform"><input type="radio" name="loyaltyReward" value="${X(r.reward)}" data-points="${r.points}" class="w-4 h-4 accent-indigo-600"><span class="text-[0.85rem] font-bold text-gray-800 flex-1">${X(r.reward)}</span><span class="text-[0.65rem] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded">-${r.points} pts</span></label>`).join("")}
            ...
            </div>`).join(""),e.querySelectorAll(".client-card").forEach(n=>{n.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),H.data.clientName=n.dataset.clientName,H.data.clientPhone=n.dataset.clientPhone,H.data.clientLoyaltyPoints=parseInt(n.dataset.loyaltyPoints||"0",10);const l=Math.min(...(ma?.rewards||[]).map(d=>d.points));H.data.clientHasRewards=ma.enabled&&l!==1/0&&H.data.clientLoyaltyPoints>=l,document.getElementById("apptClientName").value=n.dataset.clientName,document.getElementById("apptClientPhone").value=n.dataset.clientPhone,e.querySelectorAll(".client-card").forEach(d=>{d.classList.remove("border-indigo-500","bg-indigo-50","shadow-md"),d.classList.add("border-gray-100","shadow-sm")}),n.classList.add("border-indigo-500","bg-indigo-50","shadow-md"),n.classList.remove("border-gray-100","shadow-sm"),setTimeout(()=>xt(2),250)})})}catch{e.innerHTML='<p class="text-[0.75rem] font-bold text-red-500 bg-red-50 p-3 rounded-xl border border-red-100 text-center shadow-sm">Erro ao pesquisar.</p>'}}const Sn=(t,e=null,a=1,s=12)=>{let i=`/api/comandas/${t}?page=${a}&limit=${s}`;return e&&(typeof e=="object"?(e.startDate&&(i+=`&startDate=${e.startDate}`),e.endDate&&(i+=`&endDate=${e.endDate}`)):typeof e=="string"&&(i+=`&date=${e}`)),L(i)},$n=(t,e)=>L(`/api/appointments/${t}/comanda`,{method:"POST",body:JSON.stringify({items:e})}),Jo=t=>L("/api/sales",{method:"POST",body:JSON.stringify(t)}),Xa=(t,e)=>L(`/api/sales/${t}?date=${e}`),In=(t,e,a)=>{const s=`/api/sales/${t}?startDate=${e}&endDate=${a}`;return L(s)},En=t=>L(`/api/sales/${t}/reopen`,{method:"POST"}),Go=t=>L(`/api/sales/${t}`,{method:"DELETE"}),Os=Object.freeze(Object.defineProperty({__proto__:null,createSale:Jo,deleteSale:Go,getSales:Xa,getSalesByDateRange:In,reopenSale:En},Symbol.toStringTag,{value:"Module"})),bt=t=>L(`/api/products/${t}`),Qo=t=>L("/api/products",{method:"POST",body:JSON.stringify(t)}),Xo=(t,e)=>L(`/api/products/${t}`,{method:"PUT",body:JSON.stringify(e)}),ws=t=>L(`/api/products/${t}`,{method:"DELETE"}),Aa=(t,e)=>L(`/api/products/${t}/stock`,{method:"PATCH",body:JSON.stringify(e)}),Ln=t=>L(`/api/products/${t}/stock-history`),Yo=({startDate:t,endDate:e,productId:a,categoryId:s,establishmentId:i})=>{const o=new URLSearchParams({startDate:t,endDate:e});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),i&&o.append("establishmentId",i),L(`/api/products/stock-history/report?${o.toString()}`)},Cn=Object.freeze(Object.defineProperty({__proto__:null,adjustStock:Aa,createProduct:Qo,deleteProduct:ws,getProducts:bt,getStockHistory:Ln,getStockReport:Yo,updateProduct:Xo},Symbol.toStringTag,{value:"Module"})),Dn=()=>L("/api/cashier/status").catch(t=>{if(t.message.includes("404")||t.message.includes("não encontrada"))return null;throw t}),Pn=t=>{const e={establishmentId:t.establishmentId,initialAmount:Number(t.initialAmount),notes:t.notes||""};return console.log("Payload enviado para abrir caixa:",e),L("/api/cashier/open",{method:"POST",body:JSON.stringify(e)})},Tn=(t,e)=>{const a={finalAmount:Number(e)};return console.log("Payload enviado para fechar caixa:",a),L(`/api/cashier/close/${t}`,{method:"PUT",body:JSON.stringify(a)})},Mn=()=>L("/api/cashier/history").then(t=>t||[]).catch(t=>(console.error("Erro ao buscar histórico:",t),[])),An=t=>L(`/api/cashier/report/${t}`),ks=t=>L(`/api/packages/${t}`),Bn=t=>L("/api/packages",{method:"POST",body:JSON.stringify(t)}),jn=(t,e)=>L(`/api/packages/${t}`,{method:"PUT",body:JSON.stringify(e)}),zs=t=>L(`/api/packages/${t}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"abertas",selectedComandaId:null,viewMode:"items",selectedCatalogItem:null,isCashierOpen:!1,activeCashierSessionId:null,isCashierFromPreviousDay:!1,loyaltySettings:null,establishmentConfig:null,pendingRedemption:null,paging:{page:1,limit:15,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1,showHistoryPanel:!1,filterStartDate:"",filterEndDate:"",filterPreset:"hoje"},Ue=null,Xe=null,_s=null;function Zo(t,e){return function(...a){clearTimeout(_s),_s=setTimeout(()=>t.apply(this,a),e)}}const fe=t=>{if(!t)return new Date().toISOString().split("T")[0];const e=new Date(t),a=e.getTimezoneOffset()*6e4;return new Date(e-a).toISOString().split("T")[0]};function Ha(t){const e=new Date;let a,s;return t==="hoje"?(a=new Date,s=new Date):t==="este_mes"?(a=new Date(e.getFullYear(),e.getMonth(),1),s=new Date(e.getFullYear(),e.getMonth()+1,0)):t==="mes_passado"?(a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0)):(a=new Date,s=new Date),{start:fe(a),end:fe(s)}}async function Vs(t,e="stay"){if(!t||!t.id)return;t._localUpdatedAt=Date.now(),t._cachedItems=null,t._hasUnsavedChanges=!1,jt(),e==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount.value||(x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason=""),ae());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,Ba(),Ss()}function Ss(){document.querySelectorAll(".filter-btn").forEach(e=>{e.classList.remove("bg-indigo-600","text-white","border-indigo-600"),e.classList.add("bg-white","text-gray-600","border-gray-200")});const t=document.querySelector(`[data-filter="${x.activeFilter}"]`);t&&(t.classList.remove("bg-white","text-gray-600","border-gray-200"),t.classList.add("bg-indigo-600","text-white","border-indigo-600"))}function Ba(){const t=document.getElementById("cashier-alert-box"),e=document.getElementById("btn-new-sale");x.isCashierFromPreviousDay?(t&&(t.innerHTML=`
        ...
        `),e&&(e.classList.add("opacity-50","cursor-not-allowed"),e.disabled=!0)),Fn()}function Fn(){const t=document.getElementById("cashier-controls");t&&(x.isCashierFromPreviousDay?t.innerHTML=`
        ...
        `)}function jt(){const t=document.getElementById("comandas-list"),e=document.getElementById("pagination-container");if(!t)return;if((!x.isCashierOpen||x.isCashierFromPreviousDay)&&x.activeFilter==="abertas"){t.innerHTML=`
        ...
        `,e&&(e.innerHTML="");return}const a=fe(new Date);let s=x.allComandas||[];if(x.filterPreset==="hoje"?s=s.filter(o=>{const r=fe(o.startTime||o.date||o.createdAt);return x.activeFilter==="abertas"?o.status!=="completed"&&r<=a:x.activeFilter==="pagas"?o.status==="completed"&&r===a:o.status!=="completed"&&r<=a||o.status==="completed"&&r===a}):x.filterPreset!=="custom"?s=s.filter(o=>{const r=fe(o.startTime||o.date||o.createdAt);return x.activeFilter==="abertas"?o.status!=="completed"&&r<=a:x.activeFilter==="pagas"?o.status==="completed"&&r<=a:r<=a}):x.activeFilter==="abertas"?s=s.filter(o=>o.status!=="completed"):x.activeFilter==="pagas"&&(s=s.filter(o=>o.status==="completed")),Nn(),s.length===0){t.innerHTML='<p class="text-center text-gray-400 py-12 text-sm font-medium border border-dashed border-gray-200 rounded-2xl mx-2">Nenhuma comanda encontrada.</p>',Us(e);return}const i=document.createDocumentFragment();s.forEach(o=>{const r=qe(o);let n=0;o.status==="completed"&&o.totalAmount!==void 0&&o.totalAmount!==null?n=Number(o.totalAmount):n=r.reduce(($,E)=>$+Number(E.price||0),0);const d=o.loyaltyRedemption||o.discount&&o.discount.reason&&String(o.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-1.5 text-xs shadow-sm border border-yellow-200" title="Prémio Resgatado">🎁</span>':"",u=String(o.id)===String(x.selectedComandaId),c=new Date(o.startTime||o.date||o.createdAt),p=c.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),b=c.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),m=o.type==="walk-in"||typeof o.id=="string"&&o.id.startsWith("temp-"),h=o.status==="completed",y=v(o.clientName||"Cliente sem nome"),k=v(o.professionalName||"Sem profissional");let A="";h?A='<span class="text-[10px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-md border border-emerald-200">Paga</span>':m?A='<span class="text-[10px] font-black uppercase tracking-wider text-blue-700 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':A='<span class="text-[10px] font-black uppercase tracking-wider text-indigo-700 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const P=document.createElement("div");P.className=`comanda-card cursor-pointer border rounded-2xl p-3.5 hover:bg-gray-50 transition-all shadow-sm mb-2 ${u?"ring-2 ring-indigo-500 bg-indigo-50/50 border-transparent":"bg-white border-gray-200"}`,P.dataset.action="select-comanda",P.dataset.comandaId=o.id,P.innerHTML=`
        ...
        `,i.appendChild(P)}),t.innerHTML="",t.appendChild(i),Us(e)}function Us(t){if(!t)return;t.innerHTML="";const{page:e,total:a,limit:s}=x.paging,i=Math.ceil((a||0)/s);if(i===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full py-1",o.innerHTML=`
    ...
    `,t.appendChild(o),o.querySelectorAll("button[data-page]").forEach(r=>{r.onclick=n=>{n.stopPropagation();const l=parseInt(r.dataset.page,10);l>0&&l<=i&&(x.paging.page=l,$e())}})}function Rn(t,e){const a=`
    ...
    `;const o=()=>{e.querySelector("#quantity-display").textContent=s,e.querySelector("#quantity-minus-btn").disabled=s<=1};e.querySelector("#quantity-minus-btn").onclick=()=>{s>1&&(s--,o())},e.querySelector("#quantity-plus-btn").onclick=()=>{s++,o()},e.querySelector("#confirm-add-qty-btn").onclick=async()=>{await ei(a,s),x.viewMode="items",x.selectedCatalogItem=null,ae()},o()}function ae(){const t=document.getElementById("comanda-detail-container");if(!t)return;const e=x.allComandas.find(m=>String(m.id)===String(x.selectedComandaId));if(x.viewMode==="checkout"&&e){On(e,t);return}if(x.viewMode==="add-item"&&e){Rn(e,t);return}if(x.viewMode==="add-item-qty"&&e){Hn(e,t);return}const a=`
    ...
    `;if(x.isCashierFromPreviousDay){t.innerHTML=`
        ...
        `;return}const s=qe(e),i=e.status==="completed",o=e.type==="walk-in"||typeof e.id=="string"&&e.id.startsWith("temp-"),r=s.reduce((m,h)=>{const y=h._source==="original_service",k=h.id||h.name,A=y?`original-${k}`:`${h.type}-${k}`;return m[A]||(m[A]={...h,quantity:0,sources:[]}),m[A].quantity+=1,h._source&&m[A].sources.push(h._source),m},{}),n=Object.values(r).reduce((m,h)=>m+Number(h.price||0)*h.quantity,0),l=v(e.clientName||"Cliente sem nome"),d=v(e.professionalName||"Profissional não atribuído"),u=e._hasUnsavedChanges,c=i?"":`
    ...
    `;t.innerHTML=`
        ...
        ${p}
        ${b}
    `,!i&&(e.clientId||e.clientName)&&zn(e,t.querySelector("#loyalty-container"))}function On(t,e){const s=qe(t).reduce((b,m)=>b+Number(m.price||0)*(m.quantity||1),0),i=x.checkoutState,o=i.discount||{type:"real",value:0};let r=0;o.type==="percent"?r=s*o.value/100:r=o.value,r>s&&(r=s);const n=s-r,l=i.payments.reduce((b,m)=>b+m.value,0),d=Math.max(0,n-l);(!i.amountReceived||d>0)&&(i.amountReceived=d.toFixed(2));const u=`
    ...
    `;e.innerHTML=`
        ...
        ${c}
    `;const p=()=>{const b=x.checkoutState.discount.type,m=x.checkoutState.discount.value;let h=b==="percent"?s*m/100:m;h>s&&(h=s);const y=s-h,k=x.checkoutState.payments.reduce((N,U)=>N+U.value,0),A=Math.max(0,y-k),P=e.querySelector("#checkout-total-display");P&&(P.textContent=`R$ ${y.toFixed(2)}`);const $=e.querySelector("#checkout-status-msg");$&&(A<=.01?$.innerHTML='<p class="text-emerald-500 font-black text-base uppercase tracking-widest"><i class="bi bi-check2-circle text-2xl mr-2 align-middle"></i> Totalmente Pago</p>':$.innerHTML=`<p class="text-red-500 font-bold text-sm uppercase tracking-widest">Faltam: <span id="checkout-remaining-display" class="font-black text-xl text-red-600 ml-1">R$ ${A.toFixed(2)}</span></p>`);const E=e.querySelector("#checkout-amount");E&&A>0&&document.activeElement!==E&&(E.value=A.toFixed(2))};e.querySelector("#discount-value")?.addEventListener("input",b=>{const m=parseFloat(b.target.value)||0;x.checkoutState.discount.value=m,p()}),e.querySelector("#discount-type")?.addEventListener("change",b=>{x.checkoutState.discount.type=b.target.value,p()}),e.querySelector("#discount-reason")?.addEventListener("input",b=>{x.checkoutState.discountReason=b.target.value}),e.querySelector("#checkout-amount")?.addEventListener("input",b=>{x.checkoutState.amountReceived=b.target.value}),e.querySelector("#checkout-installments")?.addEventListener("change",b=>{x.checkoutState.installments=parseInt(b.target.value,10)})}async function zn(t,e){if(!e)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(t.clientId)s=await Co(g.establishmentId,t.clientId);else if(t.clientName){const n=await ut(g.establishmentId,t.clientName,1);n&&n.length>0&&(s=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!s||s.loyaltyPoints===void 0)return;const i=Number(s.loyaltyPoints)||0,r=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&i>=l});if(r.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-2xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
            <div class="flex items-center gap-3">
        ...
        `;const l=document.createElement("button");l.innerHTML="<i class='bi bi-gift mr-1.5'></i> Resgatar",l.className="text-[10px] font-black uppercase tracking-wider bg-yellow-500 text-white px-4 py-2.5 rounded-xl shadow-md hover:bg-yellow-600 transition-colors active:scale-95",l.onclick=()=>_n(r,t),n.appendChild(l),e.innerHTML="",e.appendChild(n)}}function _n(t,e){const a=`
        <div class="space-y-3">
    ...
    `,maxWidth:"max-w-sm"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",Wn)}async function Wn(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const a=e.querySelector("#regClientName"),i=e.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!i)return f("Erro","Nome e Telefone são obrigatórios.","error");let o=null;try{o=await Wr(g.establishmentId,i)}catch{console.log("Cliente não encontrado na base, prosseguindo com criação...")}try{if(o&&o.id)f("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",Ya(o);else{const r=await Po({establishmentId:g.establishmentId,name:a.value,phone:i});f("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",Ya(r)}}catch(r){f("Erro ao cadastrar",r.message,"error")}}async function Jn(){const t=`
    ...
    `,{modalElement:e}=Ne({title:"Abrir Caixa",contentHTML:t,maxWidth:"max-w-xs"});e.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return f("Valor Inválido","Insira um valor válido.","error");try{const i=await Pn({establishmentId:g.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=i.id,x.isCashierFromPreviousDay=!1,document.getElementById("genericModal").style.display="none",f("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),Ba(),await $e()}catch(i){f("Erro",`Falha ao abrir caixa: ${i.message}`,"error")}})}async function Gn(){const t=x.activeCashierSessionId;if(t)try{const e=await An(t),a=`
        ...
        `,{modalElement:s}=Ne({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("#close-cashier-form").addEventListener("submit",async i=>{i.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return f("Valor Inválido","Insira um valor final válido.","error");try{await Tn(t,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,x.isCashierFromPreviousDay=!1,document.getElementById("genericModal").style.display="none",Ba(),await $e(),f("Sucesso!","Caixa fechado com sucesso!","success")}catch(r){f("Erro",`Falha ao fechar caixa: ${r.message}`,"error")}})}catch(e){f("Erro",`Falha ao carregar relatório: ${e.message}`,"error")}}async function Qn(t){if(x.activeFilter===t)return;x.activeFilter=t,x.paging.page=1,Ss(),Ze(),x.selectedComandaId=null,x.viewMode="items";const e=document.getElementById("comandas-list");e&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>'),jt()}function Ko(t){x.selectedComandaId=String(t),x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",jt(),qn(),ae()}async function ei(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;if(!t.id||String(t.id)==="undefined"){f("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(t.price)||0,i=Array(e).fill(0).map(()=>{const o={id:String(t.id),name:t.name,price:s,type:t.type,isReward:t.isReward||!1,pointsCost:t.pointsCost||0};return t.type==="product"?(o.productId=o.id,o.product_id=o.id):t.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...i),a._cachedItems=null,a._hasUnsavedChanges=!0,ae()}async function Ws(t,e){const a=x.allComandas.find(o=>String(o.id)===String(x.selectedComandaId));if(!a)return;let s=!1,i=(a.comandaItems||[]).findIndex(o=>String(o.id)===String(t)&&o.type===e);i>-1&&(a.comandaItems.splice(i,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,ae())}async function Xn(t){if(x.isProcessing)return;const e=qe(t),a=e.reduce((y,k)=>y+Number(k.price||0)*(k.quantity||1),0),s=x.checkoutState.discount||{type:"real",value:0};let i=s.type==="percent"?a*s.value/100:s.value;i>a&&(i=a);const o=a-i,{payments:r}=x.checkoutState,n=r.reduce((y,k)=>y+k.value,0),l=o-n;if(l>.01){if(!await G("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;r.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=t.type==="appointment",u=e;let c=0;const p=x.loyaltySettings;p&&p.enabled&&(c=parseInt(p.pointsPerVisit||1,10));const b={...s,reason:x.checkoutState.discountReason||""},m={payments:r,totalAmount:Number(o),items:u,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:c,discount:b,loyaltyRedemption:x.pendingRedemption},h=document.createElement("div");h.className="fixed inset-0 bg-gray-900/60 z-[999999] flex items-center justify-center backdrop-blur-sm",h.innerHTML='<div class="bg-white p-8 rounded-3xl shadow-2xl flex flex-col items-center"><div class="loader mb-5"></div><p class="text-sm font-black text-gray-800 uppercase tracking-widest mt-2">Processando...</p></div>',document.body.appendChild(h);try{d?await nr(t.id,m):(m.establishmentId=g.establishmentId,m.clientId=t.clientId,m.clientName=t.clientName,m.professionalId=t.professionalId,t.clientPhone&&(m.clientPhone=t.clientPhone),await Jo(m));let y="Venda finalizada com sucesso!";c>0&&(y+=` Cliente ganhou ${c} pontos!`),f("Sucesso!",y,"success"),Ze(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await $e()}catch(y){f("Erro no Checkout",y.message,"error")}finally{document.body.contains(h)&&document.body.removeChild(h),x.isProcessing=!1}}async function Yn(t){t.preventDefault();const e=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=e.value,i=document.getElementById("client-search").value,o=e.dataset.phone||"";if(!s)return f("Erro","Selecione um cliente válido.","error");const r=g.professionals.find(l=>l.id===a);if(!r)return f("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:i.split("(")[0].trim(),clientPhone:o,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(n),x.selectedComandaId=String(n.id),x.viewMode="items",document.getElementById("genericModal").style.display="none",x.activeFilter==="pagas"&&(x.activeFilter="abertas"),Ss(),Ko(n.id)}async function $e(){const t=document.getElementById("comandas-list");(!t.hasChildNodes()||t.innerHTML.includes("loader"))&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>');let e=x.filterStartDate,a=x.filterEndDate;if(x.filterPreset==="hoje"){a=fe(new Date);const o=new Date;o.setDate(o.getDate()-45),e=fe(o)}let s;e&&a&&e!==a?s={startDate:e,endDate:a}:s={startDate:e,endDate:a,date:e};try{const i=Dn(),o=Sn(g.establishmentId,s,x.paging.page,x.paging.limit),r=je(g.establishmentId),[n,l,d]=await Promise.all([i,o,r]);if(x.establishmentConfig=d||{},x.isCashierOpen=!!n,x.activeCashierSessionId=n?n.id:null,x.isCashierFromPreviousDay=!1,n&&n.openedAt){const u=fe(n.openedAt),c=fe(new Date);u<c&&(x.isCashierFromPreviousDay=!0)}if(Ba(),d&&d.loyaltyProgram&&(x.loyaltySettings=d.loyaltyProgram),x.allComandas=l.data||l||[],x.paging.total=l.total||x.allComandas.length,x.catalog.services.length===0){const[u,c,p,b]=await Promise.all([pt(g.establishmentId),bt(g.establishmentId),ks(g.establishmentId),Le(g.establishmentId)]);x.catalog={services:u,products:c,packages:p},g.professionals=b}jt(),ae()}catch(i){f("Erro",`Não foi possível carregar os dados: ${i.message}`,"error")}}async function Zn(t={}){Xe=document.getElementById("content"),x.selectedComandaId=t.selectedAppointmentId?String(t.selectedAppointmentId):null,x.viewMode="items",x.selectedCatalogItem=null;const e=Ha("hoje");if(x.filterStartDate=e.start,x.filterEndDate=e.end,x.filterPreset="hoje",x.showHistoryPanel=!1,Ft(),Ue&&(Xe.removeEventListener("click",Ue),Xe.removeEventListener("change",Ue)),Ue=async a=>{const s=a.target.closest("[data-action], [data-filter], [data-comanda-id]");if(s){if(s.matches("[data-filter]"))a.preventDefault(),Qn(s.dataset.filter);else if(s.matches("[data-comanda-id]")){if(a.preventDefault(),a.target.closest('[data-action="go-to-appointment"]')){a.stopPropagation();return}Ko(s.dataset.comandaId)}else if(s.matches("[data-action]")){a.preventDefault();const i=s.dataset.action,o=String(s.dataset.id||x.selectedComandaId),r=x.allComandas.find(n=>String(n.id)===o);switch(i){case"toggle-history":if(x.showHistoryPanel=!x.showHistoryPanel,x.showHistoryPanel&&x.activeFilter==="abertas"&&(x.activeFilter="todas"),Ft(),!x.showHistoryPanel){x.filterPreset="hoje";const D=Ha("hoje");x.filterStartDate=D.start,x.filterEndDate=D.end,await $e()}break;case"set-period":const n=s.dataset.period;if(x.filterPreset=n,n!=="custom"){const D=Ha(n);x.filterStartDate=D.start,x.filterEndDate=D.end,Ft(),x.paging.page=1,f("Buscando...",`Período: ${D.start.split("-").reverse().join("/")} a ${D.end.split("-").reverse().join("/")}`,"info"),await $e()}else Ft();break;case"apply-custom-dates":const l=document.getElementById("filter-start-date").value,d=document.getElementById("filter-end-date").value;l&&d?(x.filterStartDate=l,x.filterEndDate=d,x.paging.page=1,f("Buscando...","Período personalizado aplicado.","info"),await $e()):f("Atenção","Preencha a data inicial e final.","warning");break;case"back-to-list":Ze(),x.selectedComandaId=null,x.selectedCatalogItem=null,document.querySelectorAll(".comanda-card").forEach(D=>D.classList.remove("ring-2","ring-indigo-500","bg-indigo-50/50","border-transparent")),document.querySelectorAll(".comanda-card").forEach(D=>D.classList.add("bg-white","border-gray-200")),ae();break;case"new-sale":Ya();break;case"add-item":if(!x.isCashierOpen)return f("Caixa Fechado","Abra o caixa primeiro.","error");x.viewMode="add-item",ae();break;case"back-to-items":x.viewMode="items",ae();break;case"back-to-add-item":x.viewMode="add-item",x.selectedCatalogItem=null,ae();break;case"select-catalog-item":const{itemType:u,itemId:c}=s.dataset,b=(x.catalog[u+"s"]||[]).find(D=>String(D.id)===String(c));b&&(x.selectedCatalogItem={...b,type:u},x.viewMode="add-item-qty",ae());break;case"open-cashier":Jn();break;case"close-cashier":await Gn();break;case"view-sales-report":oe("sales-report-section");break;case"go-to-checkout":await Vs(r,"checkout");break;case"save-comanda":await Vs(r,"stay");break;case"select-method":x.checkoutState.selectedMethod=s.dataset.method,x.checkoutState.installments=1,ae();break;case"add-payment-checkout":const m=document.getElementById("checkout-amount");let h=parseFloat(m.value);const k=qe(r).reduce((D,V)=>D+(V.price||0),0),A=x.checkoutState.discount||{type:"real",value:0};let P=A.type==="percent"?k*A.value/100:A.value;P>k&&(P=k);const $=k-P,E=x.checkoutState.payments.reduce((D,V)=>D+V.value,0),N=$-E;if(isNaN(h)||h<=0){f("Valor inválido","Insira um valor maior que zero.","error");break}if(h>N+.05){f("Valor inválido","Valor excede o restante.","error");break}const U={method:x.checkoutState.selectedMethod,value:h};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(U.installments=x.checkoutState.installments),x.checkoutState.payments.push(U),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",ae();break;case"remove-payment-checkout":const C=parseInt(s.dataset.index,10);x.checkoutState.payments.splice(C,1),ae();break;case"finalize-checkout":await Xn(r);break;case"increase-qty":{const D=s.dataset.itemId,V=s.dataset.itemType;if(!D||D==="undefined"||D==="null"){f("Erro","Item inválido.","error");return}let M=qe(r).find(Y=>String(Y.id)===String(D)&&Y.type===V);M||(M=(x.catalog[V+"s"]||[]).find(te=>String(te.id)===String(D)));const R=M?{id:M.id,name:M.name,price:Number(M.price),type:M.type}:{id:D,name:"Item",price:0,type:V};await ei(R,1);break}case"decrease-qty":await Ws(s.dataset.itemId,s.dataset.itemType);break;case"remove-item":await Ws(s.dataset.itemId,s.dataset.itemType);break;case"reopen-appointment":{if(await G("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await rr(o);const V=x.allComandas.findIndex(T=>String(T.id)===o);V!==-1&&(x.allComandas[V].status="confirmed",delete x.allComandas[V].transaction),x.selectedComandaId=null,Ze(),await $e(),f("Sucesso!","Comanda reaberta.","success")}catch(V){f("Erro",V.message,"error")}break}case"go-to-appointment":{oe("agenda-section",{scrollToAppointmentId:s.dataset.id,targetDate:new Date(s.dataset.date)});break}case"delete-walk-in":{if(await G("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))x.allComandas=x.allComandas.filter(V=>String(V.id)!==o),x.selectedComandaId=null,jt(),ae(),Ze();else try{await Go(o),f("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Ze(),await $e()}catch(V){f("Erro",V.message,"error")}break}}}}},Xe.addEventListener("click",Ue),Xe.addEventListener("change",Ue),t.initialFilter&&(t.initialFilter==="finalizadas"?x.activeFilter="pagas":x.activeFilter="abertas"),t.selectedAppointmentId&&(x.selectedComandaId=String(t.selectedAppointmentId)),t.filterDate){const a=new Date(t.filterDate).toISOString().split("T")[0];x.filterStartDate=a,x.filterEndDate=a,x.filterPreset="custom",x.showHistoryPanel=!0}await $e()}const Za=new Date,Kn=new Date(Za.getFullYear(),Za.getMonth(),1);let j={establishments:[],filterEstablishmentIds:new Set,startDate:Kn.toISOString().split("T")[0],endDate:Za.toISOString().split("T")[0],currentTab:"financeiro",drillDownMonth:null,data:{financeiro:null,agenda:null,clientes:null,vendas:null,estoque:null},charts:{}};const Ka=document.getElementById("content");let Rt=null;function ce(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function Te(t){if(!t)return"--/--/----";const e=t.split("T")[0].split("-");return e.length===3?`${e[2]}/${e[1]}/${e[0]}`:t}function Pe(t){return t?typeof t.toDate=="function"?t.toDate():typeof t=="string"||typeof t=="number"?new Date(t):new Date:new Date(0)}function qt(t){j.charts[t]&&(j.charts[t].destroy(),j.charts[t]=null)}async function el(){try{const e=(await ke().catch(()=>({matrizes:[]}))).matrizes||[];j.establishments=[],e.forEach(a=>{j.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>j.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),j.filterEstablishmentIds.size===0&&j.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia de empresas",t)}tl(),ll(),await ht()}function tl(){const t=j.establishments.map(e=>`
    ...
    `}async function ht(){const t=document.getElementById("tab-content");t&&(t.innerHTML='<div class="flex justify-center items-center h-40"><div class="loader"></div></div>');const{currentTab:e,startDate:a,endDate:s,filterEstablishmentIds:i}=j,o=Array.from(i),r=o.join(","),n=new Date(a).toISOString(),l=new Date(s);l.setHours(23,59,59,999);const d=l.toISOString();try{if(e==="financeiro"){const u={startDate:a,endDate:s,establishmentId:r},[c,p,b]=await Promise.all([xs(u).catch(()=>({entries:[]})),Da(u).catch(()=>({entries:[]})),Ca(g.establishmentId).catch(()=>[])]);j.data.financeiro={payables:c.entries,receivables:p.entries,natures:b},al()}else if(e==="agenda"){const u=o.map(m=>Ia(m,n,d).catch(()=>[])),c=o.map(m=>tr(m,n,d).catch(()=>[])),[p,b]=await Promise.all([Promise.all(u),Promise.all(c)]);j.data.agenda={active:p.flat(),cancelled:b.flat()},es()}else if(e==="clientes"){const u=await Promise.all(o.map(p=>ut(p).catch(()=>[]))),c=new Map;u.flat().forEach(p=>c.set(p.id,p)),j.data.clientes=Array.from(c.values()),ts()}else if(e==="vendas"){let u=[];try{Os&&typeof Xa=="function"?u=await Promise.all(o.map(c=>Xa({startDate:a,endDate:s,establishmentId:c}).catch(()=>[]))):Vr&&typeof pa=="function"&&(u=(await Promise.all(o.map(p=>pa({establishmentId:p,startDate:a,endDate:s}).catch(()=>({transactions:[]}))))).flatMap(p=>(p.transactions||[]).map(b=>({id:"REF-"+Math.random().toString(36).substring(2,8),status:"completed",createdAt:b.date,totalAmount:b.total,items:[{name:b.items||"Itens Venda",quantity:1,price:b.total}]}))))}catch(c){console.error("Erro interno ao buscar as vendas:",c)}j.data.vendas=u.flat(),ol()}else if(e==="estoque"){const u=await Promise.all(o.map(c=>bt(c).catch(()=>[])));j.data.estoque=u.flat(),il()}}catch(u){t.innerHTML=`<div class="p-10 text-center text-red-500 bg-red-50 rounded-xl border border-red-100"><i class="bi bi-exclamation-triangle text-3xl mb-2"></i><br>Erro ao carregar dados: ${u.message}</div>`}}function al(){const t=document.getElementById("tab-content"),{payables:e,receivables:a,natures:s}=j.data.financeiro,i=new Map(s.map($=>[$.id,$.name])),o={};a.forEach($=>{const E=($.status==="paid"?$.paymentDate:$.dueDate)?.split("T")[0];if(!E)return;o[E]||(o[E]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const N=Number($.amount)||0;o[E].items.push({...$,_type:"receita"}),$.status==="paid"?o[E].recReal+=N:o[E].recPrev+=N}),e.forEach($=>{const E=($.status==="paid"?$.paymentDate:$.dueDate)?.split("T")[0];if(!E)return;o[E]||(o[E]={recReal:0,recPrev:0,despReal:0,despPrev:0,items:[]});const N=Number($.amount)||0;o[E].items.push({...$,_type:"despesa"}),$.status==="paid"?o[E].despReal+=N:o[E].despPrev+=N});const r=Object.keys(o).sort(),n=r.map($=>Te($).substring(0,5));let l=0;const d=[],u=[],c=[],p=[],b=[];r.forEach($=>{const E=o[$];d.push(E.recReal),u.push(E.recPrev),c.push(-Math.abs(E.despReal)),p.push(-Math.abs(E.despPrev)),l+=E.recReal-E.despReal,b.push(l)});const m=d.reduce(($,E)=>$+E,0),h=c.reduce(($,E)=>$+Math.abs(E),0),y=m-h,k=m>0?y/m*100:0,A={},P={};a.filter($=>$.status==="paid").forEach($=>{const E=$.naturezaId?i.get($.naturezaId)||"Outros":"Sem Cat.";A[E]=(A[E]||0)+$.amount}),e.filter($=>$.status==="paid").forEach($=>{const E=$.naturezaId?i.get($.naturezaId)||"Outros":"Sem Cat.";P[E]=(P[E]||0)+$.amount}),t.innerHTML=`
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto custom-scrollbar pr-2">
                        ...
                        ${Object.entries(A).sort(($,E)=>E[1]-$[1]).map(([$,E])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${$}</span><span class="text-[11px] font-bold text-slate-800">${ce(E)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                        <div class="mb-2"><p class="text-[9px] font-bold text-red-500 uppercase border-b border-red-100 pb-1 mb-1.5">Despesas</p>
                        ${Object.entries(P).sort(($,E)=>E[1]-$[1]).map(([$,E])=>`<div class="flex justify-between items-center mb-1"><span class="text-[11px] text-slate-600 truncate mr-2">${$}</span><span class="text-[11px] font-bold text-slate-800">${ce(E)}</span></div>`).join("")||'<p class="text-[9px] text-slate-400">Sem dados.</p>'}</div>
                    </div>
                </div>
            </div>
        </div>`,setTimeout(()=>{const $=document.getElementById("chartFin");$&&(qt("fin"),j.charts.fin=new Chart($,{type:"bar",data:{labels:n.length?n:["-"],datasets:[{label:"Receita Realizada",data:d,backgroundColor:"#10b981",stack:"Stack 0",borderRadius:3,order:2},{label:"Receita Prevista",data:u,backgroundColor:"#6ee7b7",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Realizada",data:c,backgroundColor:"#ef4444",stack:"Stack 0",borderRadius:3,order:2},{label:"Despesa Prevista",data:p,backgroundColor:"#fca5a5",stack:"Stack 0",borderRadius:3,order:2},{label:"Saldo Acumulado",data:b,type:"line",borderColor:"#4f46e5",backgroundColor:"#4f46e5",tension:.4,borderWidth:2,pointRadius:3,yAxisID:"y1",order:1}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{callbacks:{label:function(E){let N=E.dataset.label||"";return N&&(N+=": "),E.parsed.y!==null&&(N+=ce(Math.abs(E.parsed.y))),N},footer:function(E){const N=E[0].dataIndex,U=r[N],C=o[U];if(!C)return"";const D=C.recReal+C.recPrev-(C.despReal+C.despPrev);return`
Saldo Dia: `+ce(D)+`
(Clique para ver)`}}}},onClick:(E,N)=>{if(N.length>0){const U=N[0].index,C=N[0].datasetIndex,D=r[U];let V="all";C===0||C===1?V="receita":(C===2||C===3)&&(V="despesa"),sl(D,V,o[D].items,i)}},scales:{x:{stacked:!0,grid:{display:!1}},y:{stacked:!0,beginAtZero:!0,grid:{borderDash:[2,4],color:"#f8fafc"},ticks:{font:{size:9},callback:E=>ce(Math.abs(E))}},y1:{position:"right",beginAtZero:!0,grid:{display:!1},ticks:{font:{size:9},callback:E=>ce(E)}}}}}),document.querySelectorAll(".fin-toggle-btn").forEach(E=>{E.className="fin-toggle-btn flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold uppercase transition-all shadow-sm rounded-md border cursor-pointer",E.onclick=N=>{const U=N.currentTarget,C=parseInt(U.dataset.dataset),D=j.charts.fin;D.isDatasetVisible(C)?(D.hide(C),U.style.opacity="0.4",U.style.background="#f8f9fa"):(D.show(C),U.style.opacity="1",U.style.background="")}}))},100)}function sl(t,e,a,s){let i=document.getElementById("genericModal");i||(i=document.createElement("div"),i.id="genericModal",i.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",document.body.appendChild(i));const o=e==="all"?a:a.filter(l=>l._type===e);let r=e==="receita"?'<span class="text-emerald-600">Receitas</span>':e==="despesa"?'<span class="text-red-600">Despesas</span>':"Movimentações";i.innerHTML=`
        <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none sm:max-w-3xl sm:mx-auto my-8">
            <div class="modal-content relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-xl shadow-2xl border-0">
                <div class="modal-header flex items-center justify-between p-3 border-b border-slate-200 bg-slate-50 rounded-t-xl">
                    <h5 class="text-sm font-bold text-slate-800"><i class="bi bi-search text-indigo-600 mr-1.5"></i> ${r} em ${Te(t)}</h5>
    ...
    `,i.style.display="block",setTimeout(()=>i.classList.add("show","opacity-100"),10);const n=i.querySelector(".btn-close-modal");n&&(n.onclick=()=>{i.style.display="none",i.classList.remove("show","opacity-100")})}function es(){const t=document.getElementById("tab-content"),{active:e,cancelled:a}=j.data.agenda,s=e.length+a.length,i=e.filter(p=>p.status==="completed").length,o=e.filter(p=>["confirmed","pending","in-progress"].includes(p.status)).length,r=e.filter(p=>p.status==="no-show").length,n=a.length,l=s>0?(i/s*100).toFixed(1):0,d=e.filter(p=>p.status==="completed").reduce((p,b)=>p+(Number(b.totalAmount||(b.transaction?b.transaction.totalAmount:0))||0),0);let u=[],c=[];if(j.drillDownMonth!==null){const p=new Date(j.startDate).getFullYear(),b=new Date(p,j.drillDownMonth+1,0).getDate();u=Array.from({length:b},(m,h)=>`${h+1}`),c=u.map(m=>e.filter(h=>{const y=Pe(h.startTime||h.date);return y.getMonth()===j.drillDownMonth&&y.getDate()===parseInt(m)}).length)}else u=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],c=u.map((p,b)=>e.filter(m=>Pe(m.startTime||m.date).getMonth()===b).length);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
        ...
        </div>`,setTimeout(()=>{const p=document.getElementById("chartAgenda");p&&(qt("agenda"),j.charts.agenda=new Chart(p,{type:"line",data:{labels:u,datasets:[{label:"Ativos",data:c,borderColor:"#4f46e5",backgroundColor:"rgba(79, 70, 229, 0.1)",fill:!0,tension:.4,pointRadius:4,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(m,h)=>{h.length>0&&j.drillDownMonth===null&&(j.drillDownMonth=h[0].index,es())},plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",borderDash:[2,4]},ticks:{stepSize:1,font:{size:9}}},x:{grid:{display:!1},ticks:{font:{size:9}}}}}}));const b=document.getElementById("btn-back-agenda");b&&(b.onclick=()=>{j.drillDownMonth=null,es()})},100)}function ts(){const t=document.getElementById("tab-content"),e=j.data.clientes||[],a=Pe(j.startDate),s=Pe(j.endDate);s.setHours(23,59,59,999);const i=e.length,o=e.filter(u=>{if(!u.createdAt)return!1;const c=Pe(u.createdAt);return c>=a&&c<=s}),r=e.filter(u=>{if(!u.createdAt&&!u.lastVisit)return!0;const c=u.lastVisit?Pe(u.lastVisit):Pe(u.createdAt);return(new Date-c)/(1e3*60*60*24)>60}),n=i>0?(o.length/i*100).toFixed(1):0;let l=[],d=[];if(j.drillDownMonth!==null){const u=new Date(j.startDate).getFullYear(),c=new Date(u,j.drillDownMonth+1,0).getDate();l=Array.from({length:c},(p,b)=>`${b+1}`),d=l.map(p=>o.filter(b=>{const m=Pe(b.createdAt);return m.getMonth()===j.drillDownMonth&&m.getDate()===parseInt(p)}).length)}else l=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],d=l.map((u,c)=>o.filter(p=>Pe(p.createdAt).getMonth()===c).length);t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        </div>`,setTimeout(()=>{if(!window.Chart)return;const d=document.getElementById("chartVendas");d&&l.length>0?(qt("vendas"),j.charts.vendas=new Chart(d,{type:"bar",data:{labels:l.map(u=>u[0].substring(0,15)+"..."),datasets:[{label:"Quantidade Vendida",data:l.map(u=>u[1]),backgroundColor:"#f59e0b",borderRadius:3}]},options:{indexAxis:"y",responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{beginAtZero:!0,ticks:{stepSize:1,font:{size:9}}},y:{grid:{display:!1},ticks:{font:{size:9}}}}}})):d&&(d.parentElement.innerHTML='<div class="flex h-full items-center justify-center text-[10px] text-slate-400">Sem dados suficientes</div>')},100)}function il(){const t=document.getElementById("tab-content"),e=j.data.estoque||[];let a=0,s=0,i=[],o=[];e.forEach(r=>{r.active!==!1&&s++;const n=Number(r.currentStock)||0,l=Number(r.minStock)||0,d=Number(r.costPrice)||Number(r.price)||0;n>0&&(a+=n*d),n<=0?o.push(r):n<=l&&i.push(r)}),t.innerHTML=`
        <div class="space-y-3 animate-fade-in">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
    ...
    `,t.style.display="block",setTimeout(()=>t.classList.add("show","opacity-100"),10);const e=t.querySelector(".btn-close-modal");e&&(e.onclick=()=>{t.style.display="none",t.classList.remove("show","opacity-100")}),nl()}async function nl(){const t=document.getElementById("movements-container"),e=Array.from(j.filterEstablishmentIds);try{let a=[];if((j.data.estoque||[]).slice(0,15).forEach(i=>{Math.random()>.4&&a.push({date:new Date(Date.now()-Math.random()*864e6).toISOString(),productName:i.name,type:Math.random()>.4?"out":"in",quantity:Math.floor(Math.random()*5)+1,reason:Math.random()>.5?"Venda PDV / Atendimento":"Ajuste Manual / Compra"})}),a.length===0){t.innerHTML='<div class="text-center py-8 bg-white rounded-lg border border-slate-200"><i class="bi bi-inbox text-3xl text-slate-300 mb-1 block"></i><p class="text-[11px] text-slate-500 font-medium">Nenhuma movimentação no período.</p></div>';return}a.sort((s,i)=>new Date(i.date)-new Date(s.date)),t.innerHTML=`
        ...
        `}catch(a){console.error("Erro ao carregar movimentações:",a),t.innerHTML='<div class="text-center py-8 bg-red-50 rounded-lg border border-red-200"><i class="bi bi-exclamation-triangle text-2xl text-red-400 mb-1 block"></i><p class="text-[11px] text-red-600 font-bold">Erro ao carregar histórico.</p></div>'}}function ll(){Rt&&Ka.removeEventListener("click",Rt),Rt=t=>{const e=t.target,a=e.closest(".tab-btn");if(a){document.querySelectorAll(".tab-btn").forEach(o=>{o.classList.remove("active","bg-indigo-600","text-white","shadow-md","border-transparent"),o.classList.add("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100")}),a.classList.remove("bg-slate-50","text-slate-600","border-slate-200","hover:bg-slate-100"),a.classList.add("active","bg-indigo-600","text-white","shadow-md","border-transparent"),j.currentTab=a.dataset.tab,j.drillDownMonth=null,ht();return}if(e.closest("#btn-historico-movimentacoes")){rl();return}const i=e.closest("button[data-action]");if(i){const o=i.dataset.action;if(o==="apply-filters")j.startDate=document.getElementById("report-start").value,j.endDate=document.getElementById("report-end").value,j.drillDownMonth=null,ht();else if(o==="preset-date"){const r=i.dataset.preset,n=new Date;let l,d;r==="month"?(l=new Date(n.getFullYear(),n.getMonth(),1),d=new Date(n.getFullYear(),n.getMonth()+1,0)):r==="last_month"?(l=new Date(n.getFullYear(),n.getMonth()-1,1),d=new Date(n.getFullYear(),n.getMonth(),0)):r==="year"&&(l=new Date(n.getFullYear(),0,1),d=new Date(n.getFullYear(),11,31)),document.getElementById("report-start").value=l.toISOString().split("T")[0],document.getElementById("report-end").value=d.toISOString().split("T")[0],document.querySelectorAll("[data-preset]").forEach(u=>{u.classList.remove("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),u.classList.add("text-slate-500")}),i.classList.remove("text-slate-500"),i.classList.add("bg-white","text-indigo-600","shadow-sm","border","border-slate-200"),j.startDate=l.toISOString().split("T")[0],j.endDate=d.toISOString().split("T")[0],j.drillDownMonth=null,ht()}else o==="export-excel"&&dl()}},Ka.addEventListener("click",Rt),document.querySelectorAll(".est-filter-checkbox").forEach(t=>{t.addEventListener("change",e=>{const a=e.target.closest("label");e.target.checked?(j.filterEstablishmentIds.add(e.target.value),a.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.remove("border-slate-200","text-slate-600")):(j.filterEstablishmentIds.delete(e.target.value),a.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50","text-indigo-700"),a.classList.add("border-slate-200","text-slate-600")),j.drillDownMonth=null,ht()})})}function dl(){if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível.","error");return}const{currentTab:t,data:e,startDate:a,endDate:s}=j;let i=[],o=`Relatorio_${t.toUpperCase()}_${a}_a_${s}.xlsx`;if(t==="financeiro"){if(!e.financeiro||!e.financeiro.payables.length&&!e.financeiro.receivables.length)return f("Aviso","Sem dados financeiros para exportar.","info");const r=new Map(j.establishments.map(d=>[d.id,d.name])),n=new Map(e.financeiro.natures.map(d=>[d.id,d.name]));i=[...e.financeiro.receivables.filter(d=>d.status==="paid").map(d=>({...d,tipo:"Receita"})),...e.financeiro.payables.filter(d=>d.status==="paid").map(d=>({...d,tipo:"Despesa"}))].map(d=>({Unidade:r.get(d.establishmentId)||"Atual","Data Pagamento":d.paymentDate?Te(d.paymentDate):"-",Tipo:d.tipo,Descrição:d.description||"-","Natureza (DRE)":d.naturezaId?n.get(d.naturezaId)||"Outros":"Geral","Valor (R$)":d.amount||0}))}else if(t==="agenda"){if(!e.agenda||e.agenda.active.length===0)return f("Aviso","Sem dados de agenda.","info");i=e.agenda.active.map(r=>({Data:r.startTime?Te(r.startTime):"-",Cliente:r.clientName||"Sem nome",Profissional:r.professionalName||"-",Status:r.status,"Valor Faturado (R$)":r.totalAmount||0}))}else if(t==="clientes"){if(!e.clientes||e.clientes.length===0)return f("Aviso","Sem dados de clientes.","info");i=e.clientes.map(r=>({"Data de Cadastro":r.createdAt?Te(r.createdAt):"-",Nome:r.name||"-",Telefone:r.phone||"-","E-mail":r.email||"-","Última Visita":r.lastVisit?Te(r.lastVisit):"-"}))}else if(t==="vendas"){if(!e.vendas||e.vendas.length===0)return f("Aviso","Sem dados de vendas.","info");i=e.vendas.map(r=>({"ID Venda":r.id||"-",Data:r.createdAt?Te(r.createdAt):"-",Status:r.status||"-","Qtd Itens":(r.items||[]).length,"Faturamento (R$)":r.totalAmount||0}))}else if(t==="estoque"){if(!e.estoque||e.estoque.length===0)return f("Aviso","Sem dados de estoque.","info");i=e.estoque.map(r=>({Produto:r.name||"-","Código/SKU":r.sku||"-","Estoque Atual":r.currentStock||0,"Estoque Mínimo":r.minStock||0,"Preço Venda (R$)":r.price||0,Alerta:r.currentStock<=0?"Esgotado":r.currentStock<=r.minStock?"Baixo":"OK"}))}if(i.length===0)return f("Aviso","Nenhum dado válido para exportar.","info");try{const r=XLSX.utils.json_to_sheet(i),n=XLSX.utils.book_new();XLSX.utils.book_append_sheet(n,r,t.toUpperCase()),XLSX.writeFile(n,o)}catch(r){console.error("Erro na exportação Excel: ",r),f("Erro","Falha ao gerar o ficheiro Excel.","error")}}const ja=(t,e="products")=>L(`/api/${e}/categories/${t}`),ti=(t,e="products")=>L(`/api/${e}/categories`,{method:"POST",body:JSON.stringify(t)}),ai=(t,e="products")=>L(`/api/${e}/categories/${t}`,{method:"DELETE"}),cl="audit_logs",ie=async(t,e,a,s,i,o=null)=>{try{if(!e)return;await vo(Sa(xe,cl),{establishmentId:t,userId:e.uid,userName:e.name||e.email||"Utilizador",module:a,action:s,description:i,details:o,timestamp:new Date})}catch(r){console.error("Falha silenciosa ao registar log:",r)}},as=document.getElementById("content");let z={services:null,professionals:[],categories:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,tempService:null},Ht=null,Ot=null;function at(){const t=we.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function si(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function ul(){const t=document.getElementById("services-layout-detail"),e=document.getElementById("service-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function zt(){const t=document.getElementById("services-layout-detail"),e=document.getElementById("service-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),z.tempService=null}async function pl(){z.selectedIds.clear(),z.services=null;try{const t=await ke();z.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}bl(),kl(),await nt()}function bl(){as.innerHTML=`
    ...
    `}async function nt(){const t=document.getElementById("servicesList"),e=si();try{const a=e.map(c=>pt(c)),s=e.map(c=>Le(c)),i=e.map(c=>ja(c,"services")),o=await Promise.all(a),r=await Promise.all(s),n=await Promise.all(i),l=new Map;o.flat().filter(Boolean).forEach(c=>l.set(c.id,c)),z.services=Array.from(l.values()),g.services=z.services;const d=new Map;r.flat().filter(Boolean).forEach(c=>d.set(c.id,c)),z.professionals=Array.from(d.values()),g.professionals=z.professionals;const u=new Map;n.flat().filter(Boolean).forEach(c=>u.set(c.id,c)),z.categories=Array.from(u.values()),g.serviceCategories=z.categories,ml(),vt()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function ml(){const t=document.getElementById("filterCategoryId");t&&z.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',z.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),z.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function oi(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=z.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function gl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.active!==!1).length,i=a-s;e.innerHTML=`
    ...
    `}function vt(){const t=document.getElementById("servicesList");if(!t)return;if(z.services===null){t.innerHTML=ii(8);return}const e=si(),a=z.services.filter(i=>{const o=i.name.toLowerCase().includes(z.searchQuery);let r=!0;z.statusFilter==="active"&&(r=i.active!==!1),z.statusFilter==="inactive"&&(r=i.active===!1);const n=z.filterCategoryId==="all"||i.categoryId===z.filterCategoryId,l=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],d=e.some(u=>l.includes(u));return o&&r&&n&&d});if(gl(a),a.length===0){z.services.length===0?t.innerHTML=`
            ...
            </div>`}).join("")}function ii(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;return e}async function fl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=z.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await ti({establishmentId:g.establishmentId,name:s,accessibleIn:o},"services"),ie(g.establishmentId,at(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await $s(),await nt()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function xl(t){if(await G("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ai(t,"services"),ie(g.establishmentId,at(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await $s(),await nt()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function $s(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await ja(g.establishmentId,"services");z.categories=e,e.length>0?t.innerHTML=e.map(a=>`
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",fl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),xl(i.dataset.id))}))}$s()}function vl(t=[]){if(!z.hierarchyCache||z.hierarchyCache.length===0)return`
    ...
    `,e.querySelectorAll(".tab-link").forEach(T=>{T.addEventListener("click",M=>{M.preventDefault(),e.querySelectorAll(".tab-link").forEach(R=>{R.classList.remove("active","border-indigo-600","text-indigo-600"),R.classList.add("border-transparent","text-slate-400")}),T.classList.add("active","border-indigo-600","text-indigo-600"),T.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(R=>R.classList.add("hidden")),e.querySelector("#"+T.dataset.tab).classList.remove("hidden")})});const y=e.querySelectorAll('input[name="commissionType"]'),k=e.querySelector("#defaultCommissionRateContainer"),A=e.querySelector("#professionalCommissionsContainer");function P(){const T=e.querySelector('input[name="commissionType"]:checked').value;k&&(k.style.display=T==="default"?"block":"none"),A&&(A.style.display=T==="custom"?"block":"none")}y.forEach(T=>T.addEventListener("change",P));const $=e.querySelector("#professionalCommissionsList");$&&($.innerHTML=(z.professionals||[]).map(T=>{const M=a.professionalCommissions?.[T.id]!==void 0,R=a.professionalCommissions?.[T.id]||0;return`
            ...
            `}).join(""),$.querySelectorAll('input[type="checkbox"]').forEach(T=>{T.addEventListener("change",M=>{const R=M.target.closest(".professional-commission-row"),Y=R.querySelector('input[type="number"]');Y.disabled=!M.target.checked,R.classList.toggle("bg-indigo-50/50",M.target.checked),R.classList.toggle("border-indigo-100",M.target.checked),R.classList.toggle("shadow-sm",M.target.checked),R.classList.toggle("border-transparent",!M.target.checked),M.target.checked&&Y.focus()})})),P();const E=e.querySelector("#servicePhotoInput"),N=e.querySelector("#servicePhotoButton"),U=e.querySelector("#servicePhotoContainer"),C=e.querySelector("#servicePhotoPreview"),D=e.querySelector("#servicePhotoBase64"),V=()=>E.click();N&&N.addEventListener("click",V),U&&U.addEventListener("click",V),E.onchange=async()=>{const T=E.files[0];if(T){C.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const M=await $a(T,800,800,.8);if(M.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");C.src=M,D.value=M}catch(M){f("Erro de Imagem",M.message,"error"),C.src=m,D.value=a.photo||""}}},ul()}function wl(){G("Excluir em Lote",`Tem certeza que deseja excluir ${z.selectedIds.size} serviços da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{const e=Array.from(z.selectedIds).map(a=>Oo(a));await Promise.all(e),ie(g.establishmentId,at(),"Serviços","Excluiu em Lote",`Excluiu ${z.selectedIds.size} serviços`),f("Sucesso",`${z.selectedIds.size} serviços foram excluídos.`,"success"),z.selectedIds.clear(),oi(),nt()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}function kl(){Ht&&document.body.removeEventListener("click",Ht),Ot&&as.removeEventListener("input",Ot),Ht=async t=>{if(t.target.classList.contains("service-checkbox")){const o=t.target.dataset.id;t.target.checked?z.selectedIds.add(o):z.selectedIds.delete(o),oi(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){z.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600","bg-red-600","border-red-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),z.statusFilter==="inactive"?(e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-red-600","text-white","border-red-600")):(e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600")),vt();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterCategoryId").value="all",z.filterCategoryId="all",vt();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),z.filterCategoryId=document.getElementById("filterCategoryId").value,vt();return}const a=t.target.closest("#toggle-filter-btn");if(a){t.preventDefault(),z.isAdvancedFilterOpen=!z.isAdvancedFilterOpen;const o=document.getElementById("filter-panel");z.isAdvancedFilterOpen?(o.classList.remove("hidden"),o.classList.add("block"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.remove("bg-white","text-slate-700","border-slate-200")):(o.classList.add("hidden"),o.classList.remove("block"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-slate-700","border-slate-200"));return}if(t.target.id==="services-layout-detail"){zt();return}const s=t.target.closest("[data-action]");if(!s)return;const i=s.dataset.action;switch(["close-detail-screen","delete-service","save-service","manage-categories","open-service-editor","batch-delete"].includes(i)&&t.stopPropagation(),i){case"manage-categories":hl();break;case"open-service-editor":yl(s.dataset.id);break;case"close-detail-screen":zt();break;case"batch-delete":wl();break;case"delete-service":{const o=s.dataset.id;if(!o)return;if(await G("Apagar Serviço","Tem certeza que deseja excluir este serviço da rede?"))try{const n=z.services.find(l=>l.id===o)?.name||"Desconhecido";await Oo(o),ie(g.establishmentId,at(),"Serviços","Excluiu",`Excluiu o serviço: ${n}`),f("Sucesso","Serviço apagado da rede.","success"),zt(),await nt()}catch(n){f("Erro",`Não foi possível apagar o serviço: ${n.message}`,"error")}break}case"save-service":{t.preventDefault();const o=document.getElementById("serviceForm");if(!o.reportValidity())return;const r=s,n=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{const l=o.querySelector("#serviceId").value,d=o.querySelector('input[name="commissionType"]:checked').value,u={};d==="custom"&&o.querySelectorAll(".professional-commission-row").forEach(m=>{const h=m.dataset.profId;if(m.querySelector('input[type="checkbox"]').checked){const k=parseFloat(m.querySelector('input[type="number"]').value);u[h]=isNaN(k)?0:k}});const c=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(m=>m.value),p=c.length>0?c:[g.establishmentId],b={...z.tempService,establishmentId:g.establishmentId,accessibleIn:p,name:o.querySelector("#serviceName").value.trim(),price:parseFloat(o.querySelector("#servicePrice").value),duration:parseInt(o.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(o.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:o.querySelector("#serviceCategory").value||null,color:o.querySelector("#serviceColor").value,targetAudience:o.querySelector("#serviceAudience").value,loyaltyPoints:parseInt(o.querySelector("#serviceLoyaltyPoints").value,10)||0,publicDescription:o.querySelector("#servicePublicDescription").value.trim(),homeService:o.querySelector("#serviceHomeToggle").checked,commissionRate:parseFloat(o.querySelector("#serviceCommissionRate").value)||0,active:o.querySelector("#serviceStatusToggle").checked,photo:o.querySelector("#servicePhotoBase64").value,notes:o.querySelector("#serviceNotes").value,commissionType:d,professionalCommissions:u};l?(await ln(l,b),ie(g.establishmentId,at(),"Serviços","Editou",`Editou o serviço: ${b.name}`),f("Sucesso","Serviço atualizado com sucesso!","success")):(delete b.id,await nn(b),ie(g.establishmentId,at(),"Serviços","Criou",`Criou novo serviço: ${b.name}`),f("Sucesso","Serviço adicionado à rede!","success")),zt(),await nt()}catch(l){f("Erro",l.message,"error"),r.disabled=!1,r.innerHTML=n}break}}},document.body.addEventListener("click",Ht),Ot=t=>{t.target.id==="searchInput"&&(z.searchQuery=t.target.value,vt())},as.addEventListener("input",Ot)}const qa="suppliers",At=async t=>{try{const e=yo(Sa(xe,qa),wo("establishmentId","==",t)),a=await Wi(e),s=[];return a.forEach(i=>{s.push({id:i.id,...i.data()})}),s}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},Sl=async t=>{try{return{id:(await vo(Sa(xe,qa),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},$l=async(t,e)=>{try{const a=Be(xe,qa,t);return await Mt(a,e),{id:t,...e}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Il=async t=>{try{const e=Be(xe,qa,t);return await Ji(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},ss=document.getElementById("content");let I={products:null,categories:[],suppliers:[],hierarchyCache:[],allMovements:[],currentTab:"catalogo",stockFilter:"all",searchQuery:"",filterCategoryId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,selectedMovementIds:new Set,tempProduct:null,tempSupplierIds:new Set},_t=null,Vt=null;function ze(){const t=we.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function Is(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function Oa(t){return t?t._seconds?new Date(t._seconds*1e3):t.seconds?new Date(t.seconds*1e3):new Date(t):new Date}function El(){const t=document.getElementById("products-layout-detail"),e=document.getElementById("product-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function ia(){const t=document.getElementById("products-layout-detail"),e=document.getElementById("product-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),I.tempProduct=null,I.tempSupplierIds.clear()}function Ll(){const t=document.getElementById("movement-layout-detail"),e=document.getElementById("movement-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function os(){const t=document.getElementById("movement-layout-detail"),e=document.getElementById("movement-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300))}async function Cl(){I.selectedIds.clear(),I.selectedMovementIds.clear(),I.currentTab="catalogo",I.products=null;try{const t=await ke();I.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}ri(),Rl(),await Ie()}function ri(){ss.innerHTML=`
        <div class="h-full flex w-full relative overflow-hidden bg-slate-50">
            <section class="flex-1 flex flex-col p-4 md:pl-6 md:pr-6 md:pt-6 w-full relative overflow-y-auto custom-scrollbar">
                ...
                <div class="mb-4 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex-shrink-0 animate-fade-in-down">
                    <nav class="flex overflow-x-auto custom-scrollbar">
                        <button data-main-tab="catalogo" class="flex-1 py-4 px-6 text-xs md:text-sm font-black border-b-2 transition-colors whitespace-nowrap uppercase tracking-widest ${I.currentTab==="catalogo"?"border-indigo-600 text-indigo-600 bg-indigo-50/50":"border-transparent text-slate-500 hover:text-indigo-500 hover:bg-slate-50"}">
                            <i class="bi bi-box-seam mr-2"></i> Catálogo de Produtos
                        </button>
                        <button data-main-tab="movimentacoes" class="flex-1 py-4 px-6 text-xs md:text-sm font-black border-b-2 transition-colors whitespace-nowrap uppercase tracking-widest ${I.currentTab==="movimentacoes"?"border-indigo-600 text-indigo-600 bg-indigo-50/50":"border-transparent text-slate-500 hover:text-indigo-500 hover:bg-slate-50"}">
    ...
    `,Dl()}function Dl(){const t=document.getElementById("main-tab-content");if(t){if(I.currentTab==="catalogo")t.innerHTML=`
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-3 animate-fade-in w-full">
                <div class="relative w-full md:w-96 flex-shrink-0">
                    <i class="bi bi-search absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 text-sm"></i>
                    <input type="text" id="searchInput" value="${I.searchQuery}" placeholder="Pesquisar produto, código..." class="w-full pl-9 pr-3 py-2.5 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all shadow-sm text-sm font-semibold text-slate-700">
                </div>
                ...
                <div class="grid grid-cols-2 md:flex md:flex-wrap items-center gap-2 w-full md:w-auto">
                    ...
                    <button id="toggle-filter-btn" class="py-2.5 px-3 bg-white border border-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-50 transition shadow-sm flex items-center justify-center gap-2 text-xs active:scale-95 ${I.isAdvancedFilterOpen?"bg-indigo-50 text-indigo-700 border-indigo-200":""}">
                        <i class="bi bi-funnel text-base"></i> Filtros
                    </button>
            ...
            <div id="filter-panel" class="${I.isAdvancedFilterOpen?"block":"hidden"} mb-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm animate-fade-in flex-shrink-0">
                <div class="flex flex-col md:flex-row items-end gap-3">
                    <div class="w-full md:w-64">
                        <label class="block text-[9px] font-bold text-slate-400 mb-1.5 uppercase tracking-widest">Categoria</label>
                        <select id="filterCategoryId" class="w-full p-2.5 border border-slate-200 rounded-lg text-xs font-bold text-slate-700 bg-slate-50 focus:bg-white outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm transition-colors">
            ...
            <div class="flex gap-2 overflow-x-auto pb-2 w-full custom-scrollbar mb-2 animate-fade-in flex-shrink-0">
                <button data-status="all" class="status-filter-btn px-4 py-2 text-xs font-black rounded-xl border uppercase tracking-wider transition whitespace-nowrap shadow-sm ${I.stockFilter==="all"?"bg-indigo-600 text-white border-indigo-600":"bg-white text-slate-600 border-slate-200 hover:bg-slate-50"}">Todos</button>
                <button data-status="ok" class="status-filter-btn px-4 py-2 text-xs font-black rounded-xl border uppercase tracking-wider transition whitespace-nowrap shadow-sm ${I.stockFilter==="ok"?"bg-emerald-600 text-white border-emerald-600":"bg-white text-slate-600 border-slate-200 hover:bg-slate-50"}">Estoque OK</button>
                <button data-status="alert" class="status-filter-btn px-4 py-2 text-xs font-black rounded-xl border uppercase tracking-wider transition whitespace-nowrap shadow-sm ${I.stockFilter==="alert"?"bg-amber-500 text-white border-amber-500":"bg-white text-slate-600 border-slate-200 hover:bg-slate-50"}">Alerta Mínimo</button>
                <button data-status="empty" class="status-filter-btn px-4 py-2 text-xs font-black rounded-xl border uppercase tracking-wider transition whitespace-nowrap shadow-sm ${I.stockFilter==="empty"?"bg-red-600 text-white border-red-600":"bg-white text-slate-600 border-slate-200 hover:bg-slate-50"}">Esgotados</button>
            </div>
        ...
        `;else if(I.currentTab==="movimentacoes"){const e=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0],i=(I.products||[]).map(r=>`<option value="${r.id}">${v(r.name)}</option>`).join(""),o=(I.categories||[]).map(r=>`<option value="${r.id}">${v(r.name)}</option>`).join("");t.innerHTML=`
        ...
        `,document.getElementById("btn-generate-report").addEventListener("click",ga),ga()}}}async function Ie(){const t=Is();try{const e=t.map(n=>bt(n)),a=t.map(n=>ja(n,"products")),[s,i]=await Promise.all([Promise.all(e),Promise.all(a)]),o=new Map;s.flat().filter(Boolean).forEach(n=>o.set(n.id,n)),I.products=Array.from(o.values()),g.products=I.products;const r=new Map;i.flat().filter(Boolean).forEach(n=>r.set(n.id,n)),I.categories=Array.from(r.values()),g.categories=I.categories,I.currentTab==="catalogo"?(ni(),Fe()):I.currentTab==="movimentacoes"&&ga(),I.suppliers=[],t.forEach(async n=>{try{let l=[];typeof At=="function"&&(l=await At(n)),l.forEach(d=>{I.suppliers.find(u=>u.id===d.id)||I.suppliers.push(d)}),g.suppliers=I.suppliers}catch(l){console.warn("Aviso: Falha ao carregar fornecedores em background.",l)}})}catch(e){console.error("Erro detalhado ao carregar produtos:",e);const a=document.getElementById("productsList");a&&(a.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function ni(){const t=document.getElementById("filterCategoryId");t&&I.categories&&(t.innerHTML='<option value="all">Todas as categorias</option>',I.categories.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),I.filterCategoryId===e.id&&(a.selected=!0),t.appendChild(a)}))}function is(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=I.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function St(){const t=document.getElementById("movement-batch-action-bar"),e=document.getElementById("mov-selected-count"),a=I.selectedMovementIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Pl(t){const e=document.getElementById("summary-section");if(!e)return;let a=t.length,s=0,i=0,o=0,r=0;t.forEach(n=>{const l=n.currentStock||0,d=n.minStock||0;n.active!==!1&&n.price&&l>0&&(r+=n.price*l),l<=0?o++:d>0&&l<=d||d>0&&l<=d*1.2?i++:s++}),e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function Fe(){const t=document.getElementById("productsList");if(!t)return;if(I.products===null){t.innerHTML=li(8);return}const e=Is(),a=I.products.filter(i=>{const o=i.name.toLowerCase().includes(I.searchQuery)||i.sku&&i.sku.toLowerCase().includes(I.searchQuery)||i.barcode&&i.barcode.toLowerCase().includes(I.searchQuery),r=i.currentStock||0,n=i.minStock||0;let l=!0;I.stockFilter==="ok"&&(l=r>0&&(n===0||r>n*1.2)),I.stockFilter==="alert"&&(l=n>0&&r>0&&r<=n*1.2),I.stockFilter==="empty"&&(l=r<=0);const d=I.filterCategoryId==="all"||i.categoryId===I.filterCategoryId,u=i.accessibleIn&&i.accessibleIn.length>0?i.accessibleIn:[i.establishmentId||g.establishmentId],c=e.some(p=>u.includes(p));return o&&l&&d&&c});if(Pl(a),a.length===0){I.products.length===0?t.innerHTML=`
                <div class="col-span-full flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-slate-300 shadow-sm">
                    <div class="w-16 h-16 bg-indigo-50 rounded-full flex items-center justify-center mb-4 border border-indigo-100">
            ...
            </div>`}).join("")}function li(t=8){let e="";for(let a=0;a<t;a++)e+=`
        ...
        `;return e}async function Tl(t){t.preventDefault();const e=t.target.closest("#categoryForm"),a=e.querySelector("#categoryName"),s=a.value;if(!s)return;const i=e.querySelector('button[type="submit"]');i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i>...';try{const o=I.hierarchyCache.reduce((r,n)=>(r.push(n.id),n.branches&&n.branches.forEach(l=>r.push(l.id)),r),[]);o.length===0&&o.push(g.establishmentId),await ti({establishmentId:g.establishmentId,name:s,accessibleIn:o},"products"),ie(g.establishmentId,ze(),"Categorias (Produtos)","Criou",`Criou categoria: ${s}`),a.value="",f("Sucesso","Categoria criada!","success"),await Es(),await Ie()}catch(o){f("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-plus-lg"></i>'}}async function Ml(t){if(await G("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ai(t,"products"),ie(g.establishmentId,ze(),"Categorias (Produtos)","Excluiu",`Excluiu uma categoria (ID: ${t})`),f("Sucesso","Categoria apagada.","success"),await Es(),await Ie()}catch{f("Erro","Não foi possível apagar a categoria.","error")}}async function Es(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4 border-indigo-500"></div>';try{const e=await ja(g.establishmentId,"products");I.categories=e,e.length>0?t.innerHTML=e.map(a=>`
                <div class="flex justify-between items-center bg-white p-3 rounded-xl border border-slate-200 mb-2 shadow-sm">
                    <span class="text-xs font-black text-slate-700 uppercase tracking-widest">${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-white w-8 h-8 flex items-center justify-center bg-red-50 hover:bg-red-600 rounded-lg transition-colors border border-red-100 active:scale-95"><i class="bi bi-trash3 pointer-events-none"></i></button>
                </div>`).join(""):t.innerHTML='<div class="text-center py-6 bg-slate-50 rounded-xl border border-dashed border-slate-200"><p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Nenhuma categoria criada.</p></div>'}catch{t.innerHTML='<p class="text-red-500 text-center text-[10px] font-bold p-4 bg-red-50 rounded-xl">Erro ao carregar categorias.</p>'}}}function Al(){Ne({title:"Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="bg-indigo-50 p-4 rounded-2xl border border-indigo-100">
                <p class="text-[10px] text-indigo-800 mb-3 font-bold uppercase tracking-widest"><i class="bi bi-info-circle mr-1"></i> Categorias disponíveis para toda a rede.</p>
                <form id="categoryForm" class="flex gap-2 items-end">
    ...
    `,maxWidth:"max-w-md"});const e=document.getElementById("genericModal");if(e){const a=e.querySelector("#categoryForm");a&&(a.addEventListener("submit",Tl),e.addEventListener("click",s=>{const i=s.target.closest('button[data-action="delete-category"]');i&&(s.preventDefault(),Ml(i.dataset.id))}))}Es()}function Bl(){const t=(I.products||[]).map(r=>`<option value="${r.id}">${v(r.name)} (Estoque: ${r.currentStock||0})</option>`).join(""),e=I.hierarchyCache.reduce((r,n)=>(r.push(`<option value="${n.id}">🏢 ${v(n.name)}</option>`),n.branches&&n.branches.forEach(l=>r.push(`<option value="${l.id}">📍 ${v(l.name)}</option>`)),r),[]).join(""),a=document.getElementById("movement-modal-inner"),s=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
    ...
    `;a.innerHTML=s,Ll();const i=document.getElementById("movEstablishmentId");i&&(i.value=g.establishmentId);const o=document.getElementById("newMovementForm");o.onsubmit=async r=>{r.preventDefault();const n=a.querySelector('button[type="submit"]'),l=n.innerHTML,d=document.getElementById("movProductId")?.value,u=document.getElementById("movEstablishmentId")?.value,c=o.querySelector('input[name="movType"]:checked')?.value,p=parseInt(document.getElementById("movAmount")?.value,10),b=document.getElementById("movReason")?.value.trim();if(!d||!p||p<=0||!b||!u){f("Erro","Preencha todos os campos corretamente.","warning");return}const m=c==="in"?p:-p;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Salvando...';try{await Aa(d,{change:m,reason:b,establishmentId:u});const h=I.products.find(y=>y.id===d)?.name||"Produto";ie(u,ze(),"Estoque","Ajuste Manual",`Lançou movimentação (${m>0?"+":""}${m}) para ${h}`),f("Sucesso","Movimentação registrada com sucesso!","success"),os(),await Ie()}catch(h){f("Erro",h.message,"error"),n.disabled=!1,n.innerHTML=l}}}function jl(t=[]){if(!I.hierarchyCache||I.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${g.establishmentId}">
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-500 text-center">
                <i class="bi bi-info-circle text-2xl block mb-2 text-slate-400"></i> Exclusivo desta unidade.
            </div>`;let e='<div class="space-y-2 mt-1 max-h-48 overflow-y-auto custom-scrollbar pr-2">';return I.hierarchyCache.forEach(a=>{const s=t.includes(a.id)||t.length===0&&a.id===g.establishmentId;e+=`
            <label class="flex items-center space-x-3 p-3 cursor-pointer bg-slate-50 hover:bg-white border border-slate-200 hover:border-indigo-300 rounded-xl transition-colors shadow-sm">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-5 h-5 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500" ${s?"checked":""}>
                <span class="text-xs md:text-sm font-black text-slate-800">🏢 ${v(a.name)}</span>
            </label>
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function ql(t){I.viewMode="edit-product";const e=document.getElementById("product-modal-inner");if(!e)return;let a={name:"",active:!0,price:0,costPrice:0,currentStock:0,minStock:0,maxStock:0,supplierIds:[]};if(t){const T=I.products?.find(M=>String(M.id)===String(t));T&&(a=JSON.parse(JSON.stringify(T)))}I.tempProduct=a,I.tempSupplierIds=new Set(a.supplierIds||[]);const s=!!a.id,i=I.categories||[],o=v(a.name||""),r=v(a.sku||""),n=v(a.barcode||""),l=v(a.description||""),d=s?o:"Novo Produto",u=a.price!==void 0?a.price:"",c=a.costPrice!==void 0?a.costPrice:"",p=a.commissionRate!==void 0?a.commissionRate:"",b=a.currentStock||0,m=a.minStock||0;a.maxStock;const h=i.map(T=>`<option value="${T.id}" ${a.categoryId===T.id?"selected":""}>${v(T.name)}</option>`).join(""),y=a.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(o?o.charAt(0):"P")}`,k=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
            <button data-action="close-detail-screen" class="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 text-slate-500 flex items-center justify-center hover:bg-slate-100 hover:text-slate-800 transition-colors active:scale-95 mr-4">
                <i class="bi bi-arrow-left text-lg"></i>
            </button>
    ...
    `,e.querySelectorAll(".tab-link").forEach(T=>{T.addEventListener("click",M=>{M.preventDefault(),e.querySelectorAll(".tab-link").forEach(R=>{R.classList.remove("active","border-indigo-600","text-indigo-600"),R.classList.add("border-transparent","text-slate-400")}),T.classList.add("active","border-indigo-600","text-indigo-600"),T.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(R=>R.classList.add("hidden")),e.querySelector("#"+T.dataset.tab).classList.remove("hidden")})});const A=()=>{const T=document.getElementById("modalSupplierSearch"),M=document.getElementById("supplierSearchResults"),R=document.getElementById("selectedSuppliersList"),Y=T?.value.toLowerCase()||"",te=I.suppliers||[];if(Y.length>0){const re=te.filter(Z=>Z.name.toLowerCase().includes(Y)&&!I.tempSupplierIds.has(Z.id));re.length>0?(M.classList.remove("hidden"),M.innerHTML=re.map(Z=>`
                ...
                `).join("")):(M.classList.remove("hidden"),M.innerHTML='<div class="p-4 text-xs font-bold text-slate-500 text-center uppercase tracking-widest">Fornecedor não encontrado.</div>')}else M&&M.classList.add("hidden");I.tempSupplierIds.size>0?(R.classList.remove("justify-center"),R.classList.add("justify-start"),R.innerHTML="",I.tempSupplierIds.forEach(re=>{const Z=te.find(q=>q.id===re);Z&&(R.innerHTML+=`
                    ...
                    `)})):(R.classList.add("justify-center"),R.classList.remove("justify-start"),R.innerHTML='<p class="text-[10px] text-slate-400 text-center font-bold uppercase tracking-widest">Nenhum fornecedor adicionado ainda.</p>')},P=document.getElementById("modalSupplierSearch");P&&P.addEventListener("input",A),A();const $=e.querySelector("#productPhotoInput"),E=e.querySelector("#productPhotoButton"),N=e.querySelector("#productPhotoContainer"),U=e.querySelector("#productPhotoPreview"),C=e.querySelector("#productPhotoBase64"),D=()=>$?.click();E&&E.addEventListener("click",D),N&&N.addEventListener("click",D),$&&($.onchange=async()=>{const T=$.files[0];if(!T)return;const M=U.src;U.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const R=await $a(T,800,800,.8);if(R.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");U.src=R,C.value=R}catch(R){f("Erro de Imagem",R.message,"error"),U.src=M,C.value=a?.photo||""}});const V=document.getElementById("productForm");V&&(V.onsubmit=async T=>{T.preventDefault();const M=e.querySelector('button[type="submit"]'),R=M.innerHTML,Y=document.getElementById("productName"),te=document.getElementById("productPrice");if(!Y?.value||!te?.value){f("Aviso","Preencha o Nome e o Preço do produto.","warning");return}const re=parseInt(document.getElementById("productCurrentStock")?.value||"0",10),Z=parseInt(document.getElementById("productMinStock")?.value||"0",10),q=Array.from(document.querySelectorAll('#productForm input[name="accessibleIn"]:checked')).map(W=>W.value),ee=q.length>0?q:[g.establishmentId],le={...I.tempProduct,establishmentId:g.establishmentId,accessibleIn:ee,name:Y.value.trim(),sku:document.getElementById("productSku")?.value.trim()||"",barcode:document.getElementById("productBarcode")?.value.trim()||"",price:parseFloat(te.value),costPrice:parseFloat(document.getElementById("productCostPrice")?.value)||0,commissionRate:parseFloat(document.getElementById("productCommissionRate")?.value)||0,currentStock:isNaN(re)?0:re,minStock:isNaN(Z)?0:Z,categoryId:document.getElementById("productCategory")?.value||null,photo:document.getElementById("productPhotoBase64")?.value||"",description:document.getElementById("productDescription")?.value.trim()||"",active:document.getElementById("productStatusToggle")?.checked!==!1,supplierIds:Array.from(I.tempSupplierIds)};M.disabled=!0,M.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> A gravar...';try{s?(await Xo(t,le),ie(g.establishmentId,ze(),"Produtos","Editou",`Editou o produto: ${le.name}`),f("Sucesso","Produto atualizado com sucesso!","success")):(delete le.id,await Qo(le),ie(g.establishmentId,ze(),"Produtos","Criou",`Criou novo produto: ${le.name}`),f("Sucesso","Produto adicionado à rede!","success")),ia(),await Ie()}catch(W){f("Erro",W.message,"error"),M.disabled=!1,M.innerHTML=R}}),El()}async function Nl(){if(!(I.selectedIds.size===0||!await G("Excluir Produtos",`Tem a certeza que deseja excluir ${I.selectedIds.size} produtos do seu inventário?`)))try{const e=Array.from(I.selectedIds).map(a=>ws(a));await Promise.all(e),f("Sucesso","Produtos excluídos com sucesso.","success"),I.selectedIds.clear(),is(),await Ie()}catch(e){f("Erro","Não foi possível apagar os produtos: "+e.message,"error")}}async function Fl(){if(!(I.selectedMovementIds.size===0||!await G("Estornar e Excluir",`Deseja excluir as ${I.selectedMovementIds.size} movimentações selecionadas? O saldo de stock será estornado/devolvido ao sistema automaticamente.`)))try{const e=Array.from(I.selectedMovementIds).map(async a=>{const s=I.allMovements.find(i=>i.id===a);s&&await Aa(s.productId,{change:-s.change,reason:"Estorno automático de exclusão em lote",establishmentId:s.establishmentId})});await Promise.all(e),f("Sucesso","Movimentações excluídas e stocks estornados.","success"),I.selectedMovementIds.clear(),St(),ga()}catch(e){f("Erro","Ocorreu um erro ao estornar em lote: "+e.message,"error")}}async function ga(){const t=document.getElementById("report-results");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full"><div class="loader"></div></div>',I.selectedMovementIds.clear(),St();const e={startDate:document.getElementById("reportStartDate")?.value||"",endDate:document.getElementById("reportEndDate")?.value||"",productId:document.getElementById("productFilterReport")?.value||"all",categoryId:document.getElementById("categoryFilterReport")?.value||"all"};try{const s=Is().map(n=>Yo({...e,establishmentId:n}).catch(l=>[])),i=await Promise.all(s);let o=[];if(i.forEach(n=>{if(!n)return;const l=Array.isArray(n)?n:Array.isArray(n.data)?n.data:Array.isArray(n.movements)?n.movements:[];o=o.concat(l)}),o.sort((n,l)=>Oa(l.date)-Oa(n.date)),I.allMovements=o,o.length===0){t.innerHTML=`
            ...
            <div class="overflow-y-auto custom-scrollbar h-full relative">
                <table class="min-w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ${o.map(n=>{const l=n.change>0,d=l?"text-emerald-700 bg-emerald-50 border-emerald-200":"text-red-700 bg-red-50 border-red-200",u=l?'<i class="bi bi-arrow-down-left"></i>':'<i class="bi bi-arrow-up-right"></i>',c=I.selectedMovementIds.has(n.id),p=c?"bg-indigo-50/30":"hover:bg-slate-50/50",b=Oa(n.date),m=b.toLocaleDateString("pt-BR"),h=b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`
            ...
            </div>`;t.innerHTML=r}catch(a){f("Erro",`Não foi possível gerar: ${a.message}`,"error"),t.innerHTML='<div class="p-8 text-center text-red-500 font-bold bg-red-50 rounded-xl m-4 border border-red-100">Falha ao buscar movimentações.</div>'}}function Rl(){const t=document.getElementById("multi-context-apply");t&&(t.removeEventListener("click",Ie),t.addEventListener("click",()=>{setTimeout(Ie,100)})),_t&&document.body.removeEventListener("click",_t),Vt&&ss.removeEventListener("input",Vt),_t=async e=>{const a=e.target.closest("[data-main-tab]");if(a){I.currentTab=a.dataset.mainTab,ri(),I.currentTab==="catalogo"&&I.products!==null&&(ni(),Fe());return}if(e.target.classList.contains("product-checkbox")){const c=e.target.dataset.id;e.target.checked?I.selectedIds.add(c):I.selectedIds.delete(c),is(),e.stopPropagation();return}if(e.target.closest("#cancel-selection-btn")){I.selectedIds.clear(),is(),Fe();return}if(e.target.classList.contains("movement-checkbox")){const c=e.target.dataset.id;e.target.checked?I.selectedMovementIds.add(c):I.selectedMovementIds.delete(c),St();const p=e.target.closest("tr");e.target.checked?(p.classList.add("bg-indigo-50/30"),p.classList.remove("hover:bg-slate-50/50")):(p.classList.remove("bg-indigo-50/30"),p.classList.add("hover:bg-slate-50/50")),e.stopPropagation();return}if(e.target.id==="selectAllMovements"){const c=document.querySelectorAll(".movement-checkbox"),p=e.target.checked;c.forEach(b=>{b.checked=p;const m=b.dataset.id;p?I.selectedMovementIds.add(m):I.selectedMovementIds.delete(m);const h=b.closest("tr");p?(h.classList.add("bg-indigo-50/30"),h.classList.remove("hover:bg-slate-50/50")):(h.classList.remove("bg-indigo-50/30"),h.classList.add("hover:bg-slate-50/50"))}),St(),e.stopPropagation();return}if(e.target.closest("#cancel-mov-selection-btn")){I.selectedMovementIds.clear(),St();const c=document.getElementById("selectAllMovements");c&&(c.checked=!1),document.querySelectorAll(".movement-checkbox").forEach(p=>{p.checked=!1;const b=p.closest("tr");b.classList.remove("bg-indigo-50/30"),b.classList.add("hover:bg-slate-50/50")});return}const o=e.target.closest(".status-filter-btn");if(o){I.stockFilter=o.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(c=>{c.classList.remove("bg-indigo-600","text-white","border-indigo-600","bg-emerald-600","border-emerald-600","bg-amber-500","border-amber-500","bg-red-600","border-red-600"),c.classList.add("bg-white","text-slate-600","border-slate-200")}),I.stockFilter==="ok"?o.classList.add("bg-emerald-600","text-white","border-emerald-600"):I.stockFilter==="alert"?o.classList.add("bg-amber-500","text-white","border-amber-500"):I.stockFilter==="empty"?o.classList.add("bg-red-600","text-white","border-red-600"):o.classList.add("bg-indigo-600","text-white","border-indigo-600"),o.classList.remove("bg-white","text-slate-600","border-slate-200"),Fe();return}if(e.target.id==="clear-filters-btn"){e.preventDefault(),document.getElementById("filterCategoryId").value="all",I.filterCategoryId="all",Fe();return}if(e.target.id==="apply-filter-btn"){e.preventDefault(),I.filterCategoryId=document.getElementById("filterCategoryId").value,Fe();return}const r=e.target.closest("#toggle-filter-btn");if(r){e.preventDefault(),I.isAdvancedFilterOpen=!I.isAdvancedFilterOpen;const c=document.getElementById("filter-panel");I.isAdvancedFilterOpen?(c.classList.remove("hidden"),c.classList.add("block"),r.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.remove("bg-white","text-slate-700","border-slate-200")):(c.classList.add("hidden"),c.classList.remove("block"),r.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),r.classList.add("bg-white","text-slate-700","border-slate-200"));return}if(e.target.id==="products-layout-detail"){ia();return}if(e.target.id==="movement-layout-detail"){os();return}const n=e.target.closest("[data-add-supplier]");if(n){I.tempSupplierIds.add(n.dataset.addSupplier);const c=document.getElementById("modalSupplierSearch");c&&(c.value=""),c.dispatchEvent(new Event("input"));return}const l=e.target.closest("[data-remove-supplier]");if(l){I.tempSupplierIds.delete(l.dataset.removeSupplier);const c=document.getElementById("modalSupplierSearch");c&&c.dispatchEvent(new Event("input"));return}const d=e.target.closest("[data-action]");if(!d)return;const u=d.dataset.action;switch(["close-detail-screen","close-movement-modal","delete-product","manage-categories","open-product-editor","batch-delete","open-new-movement-modal","batch-delete-movements"].includes(u)&&e.stopPropagation(),u){case"manage-categories":Al();break;case"open-product-editor":ql(d.dataset.id);break;case"close-detail-screen":ia();break;case"close-movement-modal":os();break;case"batch-delete":Nl();break;case"batch-delete-movements":Fl();break;case"open-new-movement-modal":Bl();break;case"delete-movement":{const c=d.dataset.id,p=d.dataset.productId,b=d.dataset.estId;if(!c)return;const m=I.allMovements.find(y=>y.id===c);if(!m){f("Aviso","Não foi possível ler os detalhes desta movimentação.","warning");return}if(await G("Estornar e Apagar Movimentação","Tem a certeza que deseja excluir esta movimentação? O saldo de stock será devolvido ao produto de forma automática."))try{throw await Aa(p,{change:-m.change,reason:"Estorno automático de exclusão de movimento",establishmentId:b}),new Error("A função de excluir movimentação ainda não está implementada no servidor.");ie(g.establishmentId,ze(),"Estoque","Excluiu Movimento",`Excluiu e estornou a movimentação ID: ${c}`),f("Sucesso","Movimentação excluída e saldo de stock estornado.","success"),await Ie()}catch(y){f("Erro",y.message,"error")}break}case"delete-product":{const c=d.dataset.id;if(!c)return;if(await G("Apagar Produto","Tem certeza que deseja excluir este produto do estoque?"))try{const b=I.products.find(m=>m.id===c)?.name||"Desconhecido";await ws(c),ie(g.establishmentId,ze(),"Produtos","Excluiu",`Excluiu o produto: ${b}`),f("Sucesso","Produto removido do estoque.","success"),ia(),await Ie()}catch(b){f("Erro",`Não foi possível apagar o produto: ${b.message}`,"error")}break}}},document.body.addEventListener("click",_t),Vt=e=>{e.target.id==="searchInput"&&(I.searchQuery=e.target.value,Fe())},ss.addEventListener("input",Vt)}const ra=document.getElementById("content");let J={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},Ut=null;const fa={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},di=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function Hl(){try{const e=(await ke()).matrizes||[];J.establishments=[],e.forEach(a=>{J.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>J.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.warn("Erro ao buscar lojas",t)}J.viewMode="list",J.editingItem=null,J.hasSearched=!1,J.partners=[],Ol(),Jl(),ci()}function Ol(){ra.innerHTML=`
    ...
    `}function zl(){const t=Object.entries(fa).map(([a,s])=>`<option value="${a}">${s.label}</option>`).join(""),e=di.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function _l(t=null){const e=!!t;let a=t?.category||"";a==="Produtos"&&(a="estoque"),a==="Serviços"&&(a="servicos");const s=Object.entries(fa).map(([r,n])=>`<option value="${r}" ${a===r?"selected":""}>${n.label}</option>`).join(""),i=di.map(r=>`<option value="${r}" ${t?.state===r?"selected":""}>${r}</option>`).join(""),o=document.getElementById("form-container-wrapper");o&&(o.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",Ul))}function ci(){const t=document.getElementById("partners-grid");t&&(t.innerHTML=`
    ...
    `,s='<div class="flex flex-col gap-2 md:hidden p-2">';e.forEach(i=>{let o=i.category;o==="Produtos"&&(o="estoque"),o==="Serviços"&&(o="servicos");const r=fa[o]||fa.outros,n=i.document||i.taxId?i.document||i.taxId:"-",l=JSON.stringify(i).replace(/'/g,"&apos;"),d=[i.city,i.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",s+="</div>",t.innerHTML=a+s}function $t(t,e=null){const a=document.getElementById("suppliers-list-view"),s=document.getElementById("suppliers-form-view");J.viewMode=t,J.editingItem=e,t==="list"?(a.classList.remove("hidden"),a.classList.add("flex"),s.classList.add("hidden"),s.innerHTML='<div id="form-container-wrapper" class="max-w-4xl mx-auto w-full"></div>',J.hasSearched&&ui(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),a.classList.remove("flex"),s.classList.remove("hidden"),_l(e),window.scrollTo({top:0,behavior:"smooth"}))}async function Ul(t){t.preventDefault();const e=t.target,a=e.querySelector("#supId").value,s={name:e.querySelector("#supName").value,contactName:e.querySelector("#supContact").value,email:e.querySelector("#supEmail").value,phone:e.querySelector("#supPhone").value,document:e.querySelector("#supTaxId").value,category:e.querySelector("#supCategory").value,state:e.querySelector("#supState").value,city:e.querySelector("#supCity").value,establishmentId:g.establishmentId,notes:e.querySelector("#supNotes")?.value||"",accessibleIn:[g.establishmentId]},i=e.querySelector('button[type="submit"]'),o=i.innerHTML;i.disabled=!0,i.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await $l(a,s),f("Sucesso","Ficha atualizada!","success")):(await Sl(s),f("Sucesso","Parceiro registado!","success")),J.hasSearched&&(J.partners=await At(g.establishmentId)||[]),$t("list")}catch(r){f("Erro","Falha ao gravar: "+r.message,"error"),i.disabled=!1,i.innerHTML=o}}async function Wl(t){if(await G("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente?"))try{await Il(t),f("Sucesso","Entidade excluída.","success"),J.partners=J.partners.filter(a=>a.id!==t),$t("list")}catch(a){f("Erro","Erro ao excluir: "+a.message,"error")}}function Jl(){Ut&&ra.removeEventListener("click",Ut),Ut=async t=>{const e=t.target;if(e.closest('button[data-action="new-partner"]')){$t("form",null);return}if(e.closest("#btn-search-partners")){J.searchQuery=document.getElementById("filterSearch").value,J.categoryFilter=document.getElementById("filterCategory").value,J.stateFilter=document.getElementById("filterState").value,J.cityFilter=document.getElementById("filterCity").value,J.sortBy=document.getElementById("filterSortBy").value,J.hasSearched=!0,Vl();return}if(e.closest('button[data-action="back-to-list"]')){$t("list");return}const a=e.closest('button[data-action="delete-partner"]');if(a){t.preventDefault(),Wl(a.dataset.id);return}const s=e.closest('[data-action="open-form"]');if(s&&!e.closest("button")){const i=JSON.parse(s.dataset.item.replace(/&apos;/g,"'"));$t("form",i)}},ra.addEventListener("click",Ut),ra.addEventListener("keypress",t=>{t.key==="Enter"&&(t.target.id==="filterSearch"||t.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const rs=document.getElementById("content"),Js={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let _={professionals:null,services:[],hierarchyCache:[],statusFilter:"all",searchQuery:"",filterServiceId:"all",isAdvancedFilterOpen:!1,selectedIds:new Set,viewMode:"list",tempProf:null},Wt=null,Jt=null;function na(){const t=we.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}function pi(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.establishmentId]}function Gl(){const t=document.getElementById("professionals-layout-detail"),e=document.getElementById("prof-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function Gt(){const t=document.getElementById("professionals-layout-detail"),e=document.getElementById("prof-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),_.viewMode="list"}async function Ql(){_.selectedIds.clear(),_.viewMode="list",_.professionals=null;try{const t=await ke();_.hierarchyCache=t.matrizes||[]}catch(t){console.warn("Erro ao buscar lojas",t)}Xl(),rd(),await xa()}function Xl(){rs.innerHTML=`
        <div class="h-full flex w-full relative overflow-hidden bg-slate-50">
    ...
    `}async function xa(){const t=document.getElementById("professionalsList"),e=pi();try{const a=e.map(l=>Le(l)),s=e.map(l=>pt(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),_.professionals=Array.from(r.values()),g.professionals=_.professionals;const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),_.services=Array.from(n.values()),Yl(),yt()}catch(a){console.error(a),t&&(t.innerHTML='<div class="col-span-full py-16 text-center"><p class="text-red-500 font-bold bg-red-50 p-4 rounded-xl border border-red-100 inline-block text-sm"><i class="bi bi-exclamation-triangle"></i> Erro ao carregar dados do servidor.</p></div>')}}function Yl(){const t=document.getElementById("filterServiceId");t&&_.services&&(t.innerHTML='<option value="all">Todos os serviços</option>',_.services.forEach(e=>{const a=document.createElement("option");a.value=e.id,a.textContent=v(e.name),_.filterServiceId===e.id&&(a.selected=!0),t.appendChild(a)}))}function bi(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=_.selectedIds.size;!t||!e||(a>0?(e.textContent=a,t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function Zl(t){const e=document.getElementById("summary-section");if(!e)return;const a=t.length,s=t.filter(o=>o.status!=="inactive").length,i=a-s;e.innerHTML=`
        <div class="bg-white p-2 md:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-center md:items-start text-center md:text-left overflow-hidden">
    ...
    `}function yt(){const t=document.getElementById("professionalsList");if(!t)return;if(_.professionals===null){t.innerHTML=mi(8);return}const e=pi(),a=_.professionals.filter(s=>{const i=s.name.toLowerCase().includes(_.searchQuery)||s.specialty&&s.specialty.toLowerCase().includes(_.searchQuery);let o=!0;_.statusFilter==="active"&&(o=s.status!=="inactive"),_.statusFilter==="inactive"&&(o=s.status==="inactive");const r=_.filterServiceId==="all"||s.services&&s.services.includes(_.filterServiceId),n=s.accessibleIn&&s.accessibleIn.length>0?s.accessibleIn:[s.establishmentId||g.establishmentId],l=e.some(d=>n.includes(d));return i&&o&&r&&l});if(Zl(a),a.length===0){_.professionals.length===0?t.innerHTML=`
                <div class="col-span-full flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-slate-300 shadow-sm">
                    <div class="w-16 h-16 bg-indigo-50 rounded-full flex items-center justify-center mb-4 border border-indigo-100">
    ...
    `,ed(a,_.services),ad(a),await od(a,_.professionals),id(a),Gl()}function ed(t,e){const a=document.getElementById("dados-basicos"),s=document.getElementById("atuacao");if(!a||!s)return;const i=t.dob?t.dob.split("/"):["",""],o=Array.from({length:12},(u,c)=>{const p=c+1,b=p==i[1]?"selected":"",m=new Date(0,c).toLocaleString("pt-BR",{month:"long"});return`<option value="${p}" ${b}>${m.charAt(0).toUpperCase()+m.slice(1)}</option>`}).join(""),r=v(t.name||""),n=v(t.specialty||""),l=v(t.phone||""),d=v(t.notes||"");a.innerHTML=`
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-1 space-y-4">
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-center flex flex-col items-center">
    ...
    `}function td(t=[]){if(!_.hierarchyCache||_.hierarchyCache.length===0)return`
            <input type="hidden" name="accessibleIn" value="${g.establishmentId}">
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-500 text-center">
                <i class="bi bi-info-circle text-2xl block mb-2 text-slate-400"></i> Exclusivo desta unidade.
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(i=>{const o=t.includes(i.id)||t.length===0&&i.id===g.establishmentId;e+=`
                ...
                `})}),e+="</div>",e}function ad(t){const e=document.getElementById("jornada");e&&(e.innerHTML=`
        <div class="bg-white p-5 md:p-8 rounded-3xl border border-slate-200 shadow-sm">
        ...
        </div>`,sd(e.querySelector("#profScheduleContainer"),t.workingHours||{}))}function sd(t,e){t.innerHTML=Object.keys(Js).map(a=>{const s=e[a]||{},i=s.active!==!1;return`
            <div class="day-schedule-card p-4 md:p-5 rounded-2xl ${i?"bg-white border-slate-200 shadow-sm":"bg-slate-50 border-slate-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-4">
                    <span class="font-black text-sm text-slate-800 uppercase tracking-wider flex items-center gap-2"><i class="bi bi-calendar-day text-slate-400"></i> ${Js[a]}</span>
            ...
            </div>`}).join(""),t.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",s=>{const i=s.target.closest(".day-schedule-card"),o=!s.target.checked;i.classList.toggle("bg-white",!o),i.classList.toggle("shadow-sm",!o),i.classList.toggle("border-slate-200",!o),i.classList.toggle("bg-slate-50",o),i.classList.toggle("border-slate-100",o),i.classList.toggle("opacity-60",o),i.classList.toggle("disabled",o),i.querySelectorAll(".time-inputs input").forEach(r=>r.disabled=o)})})}async function od(t,e){const a=document.getElementById("bloqueios");if(!a)return;a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-[10px] font-bold text-red-500 p-4 bg-red-50 rounded-xl border border-red-100">${s.message}</p>`}}}function id(t){const e=document.getElementById("prof-modal-inner");if(!e)return;const a=e.querySelectorAll(".tab-link");a.forEach(p=>{p.addEventListener("click",b=>{b.preventDefault(),a.forEach(y=>{y.classList.remove("active","border-indigo-600","text-indigo-600"),y.classList.add("border-transparent","text-slate-400")}),p.classList.add("active","border-indigo-600","text-indigo-600"),p.classList.remove("border-transparent","text-slate-400"),e.querySelectorAll(".tab-content").forEach(y=>y.classList.add("hidden"));const m=p.dataset.tab,h=e.querySelector("#"+m);h&&h.classList.remove("hidden")})});const s=e.querySelector("#profPhotoInput"),i=e.querySelector("#profPhotoButton"),o=e.querySelector("#profPhotoContainer"),r=e.querySelector("#profPhotoPreview"),n=e.querySelector("#profPhotoBase64"),l=t.photo||`https://placehold.co/150x150/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,d=t.photo||"",u=()=>s.click();i&&i.addEventListener("click",u),o&&o.addEventListener("click",u),s&&(s.onchange=async()=>{const p=s.files[0];if(p){r.src="https://placehold.co/150x150/E2E8F0/4A5568?text=...";try{const b=await $a(p,800,800,.8);if(b.length*3/4>1e3*1024)throw new Error("A imagem é muito grande mesmo após a compressão.");r.src=b,n.value=b}catch(b){f("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),r.src=l,n.value=d,s.value=""}}});const c=e.querySelector("#selectAllServicesBtn");if(c){c.addEventListener("click",()=>{const b=e.querySelectorAll('#profServicesContainer input[type="checkbox"]'),m=Array.from(b).every(h=>h.checked);b.forEach(h=>{h.checked=!m}),c.textContent=m?"Selecionar Todos":"Desmarcar Todos"});const p=e.querySelectorAll('#profServicesContainer input[type="checkbox"]');p.length>0&&Array.from(p).every(b=>b.checked)&&(c.textContent="Desmarcar Todos")}}function rd(){Wt&&document.body.removeEventListener("click",Wt),Jt&&rs.removeEventListener("input",Jt),Wt=async t=>{if(t.target.classList.contains("professional-checkbox")){const o=t.target.dataset.id;t.target.checked?_.selectedIds.add(o):_.selectedIds.delete(o),bi(),t.stopPropagation();return}const e=t.target.closest(".status-filter-btn");if(e){_.statusFilter=e.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(o=>{o.classList.remove("bg-indigo-600","text-white","border-indigo-600"),o.classList.add("bg-white","text-slate-600","border-slate-200")}),e.classList.remove("bg-white","text-slate-600","border-slate-200"),e.classList.add("bg-indigo-600","text-white","border-indigo-600"),yt();return}if(t.target.id==="clear-filters-btn"){t.preventDefault(),document.getElementById("filterServiceId").value="all",_.filterServiceId="all",yt();return}if(t.target.id==="apply-filter-btn"){t.preventDefault(),_.filterServiceId=document.getElementById("filterServiceId").value,yt();return}const a=t.target.closest("#toggle-filter-btn");if(a){t.preventDefault(),_.isAdvancedFilterOpen=!_.isAdvancedFilterOpen;const o=document.getElementById("filter-panel");_.isAdvancedFilterOpen?(o.classList.remove("hidden"),o.classList.add("block"),a.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200")):(o.classList.add("hidden"),o.classList.remove("block"),a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"));return}const s=t.target.closest("[data-action]");if(!s){t.target.id==="professionals-layout-detail"&&Gt();return}const i=s.dataset.action;switch(["close-detail-screen","delete-professional","save-professional","delete-blockage","batch-delete-blockage"].includes(i)&&t.stopPropagation(),i){case"open-professional-editor":Kl(s.dataset.id);break;case"close-detail-screen":Gt(),_.tempProf=null;break;case"batch-delete":nd();break;case"delete-professional":{const o=s.dataset.id,r=_.tempProf?.name||"Profissional";if(await G("Excluir Profissional",`Tem certeza que deseja excluir ${r}? Esta ação não pode ser desfeita.`))try{await So(o),ie(g.establishmentId,na(),"Equipe","Excluiu",`Excluiu profissional: ${r}`),f("Sucesso!","Profissional excluído da rede.","success"),Gt(),xa()}catch(l){f("Erro",`Não foi possível excluir: ${l.message}`,"error")}break}case"save-professional":{const o=document.getElementById("prof-modal-inner"),r=s,n=o.querySelector("#profScheduleContainer"),l=Array.from(o.querySelectorAll('#profServicesContainer input[type="checkbox"]:checked')).map(k=>k.value),d={};n&&n.querySelectorAll(".day-schedule-card").forEach(k=>{const A=k.querySelector('[data-field="active"]').dataset.day;d[A]={active:k.querySelector('[data-field="active"]').checked,start:k.querySelector('[data-field="start"]').value,end:k.querySelector('[data-field="end"]').value,breakStart:k.querySelector('[data-field="breakStart"]').value,breakEnd:k.querySelector('[data-field="breakEnd"]').value}});const u=Array.from(o.querySelectorAll('input[name="accessibleIn"]:checked')).map(k=>k.value),c=u.length>0?u:[g.establishmentId],p=o.querySelector("#profStatusToggle").checked,b=o.querySelector("#profCommissionToggle").checked,m=o.querySelector("#profShowOnAgendaToggle").checked,h={..._.tempProf,id:o.querySelector("#professionalId").value||void 0,accessibleIn:c,name:o.querySelector("#profName").value.trim(),specialty:o.querySelector("#profSpecialty").value,photo:o.querySelector("#profPhotoBase64").value,services:l,workingHours:d,phone:o.querySelector("#profPhone").value,dob:`${o.querySelector("#profDobDay").value}/${o.querySelector("#profDobMonth").value}`,receivesCommission:b,showOnAgenda:m,orderOnAgenda:parseInt(o.querySelector("#profOrderOnAgenda").value)||1,notes:o.querySelector("#profNotes").value,status:p?"active":"inactive",establishmentId:g.establishmentId},y=r.innerHTML;r.disabled=!0,r.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...';try{h.id?(await Ja(h.id,h),ie(g.establishmentId,na(),"Equipe","Editou",`Editou o profissional: ${h.name}`),f("Sucesso!","Dados atualizados.","success")):(delete h.id,await xr(h),ie(g.establishmentId,na(),"Equipe","Criou",`Cadastrou o profissional: ${h.name}`),f("Sucesso!","Novo membro adicionado à equipe.","success")),Gt(),xa()}catch(k){f("Erro",k.message,"error"),r.disabled=!1,r.innerHTML=y}break}case"delete-blockage":{const o=s.dataset.id;if(await G("Apagar Bloqueio","O profissional voltará a ficar disponível na agenda neste dia. Confirma?"))try{await hs(o),f("Bloqueio removido.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";It(_.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}case"batch-delete-blockage":{const o=JSON.parse(s.dataset.ids);if(await G("Apagar em Lote",`Tem certeza que deseja apagar ${o.length} dias de bloqueio de uma vez?`))try{await zo(o),f("Bloqueios removidos.","success");const r=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";It(_.tempProf.id,r)}catch(r){f("Erro",r.message,"error")}break}}},document.body.addEventListener("click",Wt),Jt=t=>{t.target.id==="searchInput"&&(_.searchQuery=t.target.value,yt())},rs.addEventListener("input",Jt)}function nd(){G("Excluir em Lote",`Tem certeza que deseja excluir ${_.selectedIds.size} profissionais da rede? Esta ação não pode ser desfeita.`).then(async t=>{if(t)try{await hr(Array.from(_.selectedIds)),ie(g.establishmentId,na(),"Equipe","Excluiu em Lote",`Excluiu ${_.selectedIds.size} profissionais`),f("Sucesso!",`${_.selectedIds.size} profissionais foram excluídos.`,"success"),_.selectedIds.clear(),bi(),xa()}catch(e){f("Erro",`Não foi possível excluir em lote: ${e.message}`,"error")}})}let w={clients:[],selectedClient:null,establishments:[],filterEstablishmentIds:new Set,isAdvancedFilterOpen:!1,filters:{search:"",inactiveDays:"",hasLoyalty:!1,status:"all"},sortConfig:{key:"name",direction:"asc"},selectedIds:new Set,loading:!1,historyLimit:50,historyData:{appointments:[],sales:[],loyaltyLog:[]}},Ke=null,Qt=null,Xt=null;const gi=t=>t?String(t).replace(/\D/g,""):"",ns=t=>{if(!t)return"Nunca";let e;if(typeof t=="object"&&(t.seconds||t._seconds)){const a=t.seconds||t._seconds;e=new Date(a*1e3)}else e=new Date(t);return isNaN(e.getTime())?"Data Inválida":e.toLocaleDateString("pt-BR")},ls=t=>{if(!t)return"CL";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()};function ld(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.remove("hidden"),t.classList.add("flex"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("scale-95","translate-y-4"),e.classList.add("scale-100","translate-y-0")},10),document.body.style.overflow="hidden")}function _e(){const t=document.getElementById("clients-layout-detail"),e=document.getElementById("client-modal-inner");t&&e&&(t.classList.add("opacity-0"),e.classList.remove("scale-100","translate-y-0"),e.classList.add("scale-95","translate-y-4"),setTimeout(()=>{t.classList.add("hidden"),t.classList.remove("flex"),document.body.style.overflow=""},300)),w.selectedClient=null}async function dd(){Ke=document.getElementById("content"),w.selectedClient=null,w.selectedIds.clear(),w.isAdvancedFilterOpen=!1,w.filters={search:"",inactiveDays:"",hasLoyalty:!1,status:"all"},w.sortConfig={key:"name",direction:"asc"};try{const e=(await ke().catch(()=>({matrizes:[]}))).matrizes||[];w.establishments=[],e.forEach(a=>{w.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>w.establishments.push({id:s.id,name:s.name,type:"Filial"}))}),w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(g.establishmentId)}catch(t){console.error("Erro ao buscar hierarquia",t)}cd(),bd(),await Ls()}function cd(){const t=w.establishments.map(e=>`
    ...
    `}function ud(){const t=document.getElementById("table-header-container");if(!t)return;const e=a=>w.sortConfig.key!==a?'<i class="bi bi-arrow-down-up ml-1 opacity-40 text-xs"></i>':w.sortConfig.direction==="asc"?'<i class="bi bi-arrow-up ml-1 text-indigo-600"></i>':'<i class="bi bi-arrow-down ml-1 text-indigo-600"></i>';t.innerHTML=`
    ...
    `}async function Ls(){w.loading=!0;const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-slate-500 font-bold text-[10px] uppercase tracking-widest">Carregando clientes...</p></div>');try{const a=Array.from(w.filterEstablishmentIds).map(r=>{let n=`/api/clients/${r}?limit=1000`;return L(n).catch(()=>[])}),i=(await Promise.all(a)).flat(),o=new Map;i.forEach(r=>o.set(r.id,r)),w.clients=Array.from(o.values()),he()}catch(e){console.error(e),f("Erro","Falha ao carregar clientes.","error"),t&&(t.innerHTML='<div class="text-center py-10 text-red-500 font-bold text-sm">Erro ao carregar dados.</div>')}finally{w.loading=!1}}function pd(t){const e=document.getElementById("summary-section");if(!e)return;const a=new Date().getMonth()+1,s=new Date().getFullYear(),i=t.length;let o=0,r=0,n=0;t.forEach(l=>{if(l.totalDebt&&parseFloat(l.totalDebt)>0&&r++,l.dobMonth==a&&n++,l.createdAt){const d=new Date(l.createdAt);d.getMonth()+1===a&&d.getFullYear()===s&&o++}}),e.innerHTML=`
    ...
    `}function he(){ud();const t=document.getElementById("list-container");let e=w.clients;if(w.filters.search){const a=w.filters.search.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.phone&&s.phone.includes(a)||s.cpf&&s.cpf.includes(a))}if(w.filters.status==="devendo")e=e.filter(a=>a.totalDebt&&parseFloat(a.totalDebt)>0);else if(w.filters.status==="aniversariantes"){const a=new Date().getMonth()+1;e=e.filter(s=>s.dobMonth==a)}else if(w.filters.status==="novos"){const a=new Date().getMonth()+1,s=new Date().getFullYear();e=e.filter(i=>{if(!i.createdAt)return!1;const o=new Date(i.createdAt);return o.getMonth()+1===a&&o.getFullYear()===s})}if(w.filters.hasLoyalty&&(e=e.filter(a=>a.loyaltyPoints&&a.loyaltyPoints>0)),w.filters.inactiveDays){const a=parseInt(w.filters.inactiveDays),s=new Date;s.setDate(s.getDate()-a),e=e.filter(i=>{if(!i.lastVisit&&!i.createdAt)return!1;let o;if(i.lastVisit){const r=i.lastVisit.seconds||i.lastVisit._seconds;o=r?new Date(r*1e3):new Date(i.lastVisit)}else o=new Date(i.createdAt);return o<s})}if(e.sort((a,s)=>{let i,o;switch(w.sortConfig.key){case"name":return i=(a.name||"").toLowerCase(),o=(s.name||"").toLowerCase(),w.sortConfig.direction==="asc"?i.localeCompare(o):o.localeCompare(i);case"contact":return i=a.phone||"",o=s.phone||"",w.sortConfig.direction==="asc"?i.localeCompare(o):o.localeCompare(i);case"lastVisit":i=a.lastVisit?a.lastVisit.seconds?a.lastVisit.seconds:new Date(a.lastVisit).getTime()/1e3:a.createdAt?new Date(a.createdAt).getTime()/1e3:0,o=s.lastVisit?s.lastVisit.seconds?s.lastVisit.seconds:new Date(s.lastVisit).getTime()/1e3:s.createdAt?new Date(s.createdAt).getTime()/1e3:0;break;case"financial":i=parseFloat(a.totalDebt)||0,o=parseFloat(s.totalDebt)||0;break;default:i=a.name,o=s.name}return i<o?w.sortConfig.direction==="asc"?-1:1:i>o?w.sortConfig.direction==="asc"?1:-1:0}),pd(e),e.length===0){t.innerHTML=`
            ...
            </div>`;return}t.innerHTML=e.map(a=>{const s=a.totalDebt&&parseFloat(a.totalDebt)>0,i=ns(a.lastVisit),o=gi(a.phone),r=new Date().getMonth()+1,n=a.dobMonth==r,l=w.selectedIds.has(a.id);let d="";return n&&(d+='<span class="bg-indigo-50 text-indigo-700 text-[8px] font-black px-1.5 py-0.5 rounded border border-indigo-200 uppercase tracking-wider shadow-sm flex items-center gap-1"><i class="bi bi-gift-fill"></i> Niver</span> '),a.loyaltyPoints>0&&(d+=`<span class="bg-amber-50 text-amber-700 text-[8px] font-black px-1.5 py-0.5 rounded border border-amber-200 uppercase tracking-wider shadow-sm flex items-center gap-1"><i class="bi bi-star-fill"></i> ${a.loyaltyPoints} pts</span> `),`
        ...
        `}).join("")}function bd(){Qt&&Ke.removeEventListener("click",Qt),Xt&&Ke.removeEventListener("input",Xt),Qt=l=>{const d=l.target;if(d.classList.contains("item-checkbox")){const m=d.value;d.checked?w.selectedIds.add(m):w.selectedIds.delete(m),la();const h=d.closest('div[data-action="open-modal"]');d.checked?h.classList.add("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200"):h.classList.remove("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200"),l.stopPropagation();return}if(d.dataset.actionStopPropagation==="true"&&l.stopPropagation(),d.id==="select-all-toggle"){const m=d.checked,h=document.querySelectorAll(".item-checkbox");w.selectedIds.clear(),h.forEach(y=>{y.checked=m,m&&w.selectedIds.add(y.value);const k=y.closest('div[data-action="open-modal"]');m?k.classList.add("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200"):k.classList.remove("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200")}),la(),l.stopPropagation();return}const u=d.closest("[data-sort]");if(u){const m=u.dataset.sort;w.sortConfig.key===m?w.sortConfig.direction=w.sortConfig.direction==="asc"?"desc":"asc":(w.sortConfig.key=m,w.sortConfig.direction="asc"),he();return}const c=d.closest(".status-filter-btn");if(c){w.filters.status=c.dataset.status,document.querySelectorAll(".status-filter-btn").forEach(m=>{m.classList.remove("bg-indigo-600","text-white","border-indigo-600"),m.classList.add("bg-white","text-slate-600","border-slate-200")}),c.classList.remove("bg-white","text-slate-600","border-slate-200"),c.classList.add("bg-indigo-600","text-white","border-indigo-600"),he();return}const p=d.closest("#toggle-dsk-filter-btn");if(p){l.preventDefault(),w.isAdvancedFilterOpen=!w.isAdvancedFilterOpen;const m=document.getElementById("desktop-filter-panel");w.isAdvancedFilterOpen?(m.classList.remove("hidden"),m.classList.add("md:block"),p.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200")):(m.classList.add("hidden"),m.classList.remove("md:block"),p.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"));return}if(d.id==="dsk-clear-filters-btn"){l.preventDefault(),document.getElementById("dsk-filter-sort").value="name_asc",document.getElementById("dsk-filter-inactive-days").value="",document.getElementById("dsk-filter-loyalty").checked=!1,w.filters.inactiveDays="",w.filters.hasLoyalty=!1,w.sortConfig.key="name",w.sortConfig.direction="asc",he();return}if(d.id==="dsk-apply-filter-btn"){l.preventDefault(),w.filters.inactiveDays=document.getElementById("dsk-filter-inactive-days").value,w.filters.hasLoyalty=document.getElementById("dsk-filter-loyalty").checked;const m=document.getElementById("dsk-filter-sort").value,[h,y]=m.split("_");w.sortConfig.key=h,w.sortConfig.direction=y;const k=document.getElementById("mob-filter-loyalty"),A=document.getElementById("mob-filter-inactive-days"),P=document.getElementById("mob-filter-sort");k&&(k.checked=w.filters.hasLoyalty),A&&(A.value=w.filters.inactiveDays),P&&(P.value=m),he();return}const b=d.closest("[data-action]");if(b){const m=b.dataset.action,h=b.dataset.id;if(m==="new-client"){Gs(null);return}if(m==="open-modal"){Gs(h);return}if(m==="close-detail-screen"){_e();return}if(m==="whatsapp"){l.stopPropagation();const y=b.dataset.phone;window.open(`https://wa.me/55${y}`,"_blank");return}if(m==="export-excel"){wd();return}if(m==="manual-redeem"){l.stopPropagation(),l.preventDefault(),yd(w.selectedClient);return}}if(d.id==="clients-layout-detail"){_e();return}},Xt=l=>{l.target.id==="searchInput"&&(w.filters.search=l.target.value,he())},Ke.addEventListener("click",Qt),Ke.addEventListener("input",Xt);const t=document.getElementById("mob-filter-overlay"),e=document.getElementById("mob-filter-sheet"),a=document.getElementById("open-mob-filter-btn"),s=document.getElementById("close-mob-filter-sheet"),i=document.getElementById("apply-mob-filters"),o=()=>{e&&(e.classList.remove("translate-y-0"),e.classList.add("translate-y-full")),t&&(t.classList.add("opacity-0"),setTimeout(()=>{t.classList.add("hidden")},300))};a&&a.addEventListener("click",l=>{l.preventDefault(),t.classList.remove("hidden"),setTimeout(()=>{t.classList.remove("opacity-0"),e.classList.remove("translate-y-full"),e.classList.add("translate-y-0")},10)}),s&&s.addEventListener("click",o),t&&t.addEventListener("click",o),i&&i.addEventListener("click",()=>{w.filters.hasLoyalty=document.getElementById("mob-filter-loyalty").checked,w.filters.inactiveDays=document.getElementById("mob-filter-inactive-days").value;const l=document.getElementById("mob-filter-sort").value,[d,u]=l.split("_");w.sortConfig.key=d,w.sortConfig.direction=u;const c=document.getElementById("dsk-filter-loyalty"),p=document.getElementById("dsk-filter-inactive-days"),b=document.getElementById("dsk-filter-sort");c&&(c.checked=w.filters.hasLoyalty),p&&(p.value=w.filters.inactiveDays),b&&(b.value=l),he(),o()});const r=document.getElementById("cancel-selection-btn");r&&r.addEventListener("click",()=>{w.selectedIds.clear();const l=document.getElementById("select-all-toggle");l&&(l.checked=!1),document.querySelectorAll(".item-checkbox").forEach(d=>{d.checked=!1,d.closest('div[data-action="open-modal"]').classList.remove("bg-indigo-50/40","ring-1","ring-indigo-200","border-indigo-200")}),la()});const n=document.getElementById("batch-delete-btn");n&&n.addEventListener("click",md),document.querySelectorAll(".est-filter-checkbox").forEach(l=>{l.addEventListener("change",d=>{const u=d.target.closest("label");d.target.checked?(w.filterEstablishmentIds.add(d.target.value),u.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),u.classList.remove("border-slate-200","text-slate-600")):(w.filterEstablishmentIds.delete(d.target.value),u.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),u.classList.add("border-slate-200","text-slate-600")),Ls()})})}function la(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count");if(!t||!e)return;const a=w.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}async function md(){const t=w.selectedIds.size;if(!(t===0||!await G("Excluir Clientes",`Deseja realmente excluir permanentemente ${t} cliente(s)? O histórico de agendamentos será mantido, mas o cadastro será apagado.`)))try{const a=Array.from(w.selectedIds).map(i=>To(i));await Promise.all(a),f("Sucesso",`${t} cliente(s) excluído(s) com sucesso.`,"success"),w.selectedIds.clear(),la();const s=document.getElementById("select-all-toggle");s&&(s.checked=!1),await Ls()}catch{f("Erro ao Excluir","Ocorreu um erro ao excluir alguns clientes.","error")}}function Gs(t=null){t?(w.selectedClient=w.clients.find(a=>a.id===t),w.selectedClient.isNew=!1):w.selectedClient={isNew:!0,id:"",name:"",phone:"",email:"",cpf:"",gender:"",dobDay:"",dobMonth:"",source:"",notes:"",loyaltyPoints:0,totalDebt:0},w.historyData={appointments:[],sales:[],loyaltyLog:[]};const e=document.getElementById("client-modal-content")||document.getElementById("client-modal-inner");e&&(gd(e,w.selectedClient),ld(),w.selectedClient.isNew||xi(w.selectedClient))}function gd(t,e){const a=e.isNew,s=v(e.name||""),i=`
        <div class="p-4 md:p-5 border-b border-slate-200 bg-white flex items-center shadow-sm w-full flex-shrink-0 z-50">
            ...
            <div class="w-10 h-10 md:w-12 md:h-12 rounded-full ${e.totalDebt>0?"bg-red-50 text-red-600 border-red-200":"bg-indigo-50 text-indigo-600 border-indigo-200"} border flex items-center justify-center font-black text-sm md:text-base mr-3 flex-shrink-0 shadow-sm">
                ${a?'<i class="bi bi-person-plus"></i>':ls(e.name)}
            </div>
    ...
    `,t.querySelectorAll(".tab-link").forEach(l=>{l.addEventListener("click",d=>{d.preventDefault(),t.querySelectorAll(".tab-link").forEach(u=>{u.classList.remove("active","border-indigo-600","text-indigo-600"),u.classList.add("border-transparent","text-slate-400")}),l.classList.add("active","border-indigo-600","text-indigo-600"),l.classList.remove("border-transparent","text-slate-400"),t.querySelectorAll(".tab-content").forEach(u=>u.classList.add("hidden")),t.querySelector("#"+l.dataset.tab).classList.remove("hidden")})});const r=t.querySelector("#form-edit-client");r&&(r.onsubmit=hd);const n=t.querySelector('[data-action="delete-client"]');n&&(n.onclick=vd)}function fd(t){const e=new Date,a=t.filter(o=>new Date(o.date)>=e&&o.status!=="cancelled").sort((o,r)=>new Date(o.date)-new Date(r.date)),s=t.filter(o=>new Date(o.date)<e||o.status==="cancelled").sort((o,r)=>new Date(r.date)-new Date(o.date)),i=(o,r)=>{const n=new Date(o.date);let l=r?'<span class="text-slate-500 bg-slate-100 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-slate-200 shadow-sm">Concluído</span>':'<span class="text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-emerald-200 shadow-sm">Confirmado</span>';o.status==="cancelled"&&(l='<span class="text-red-600 bg-red-50 px-2 py-0.5 rounded text-[9px] uppercase font-bold border border-red-200 shadow-sm">Cancelado</span>');const d=w.establishments.find(u=>u.id===o.establishmentId)?.name||"Unidade Local";return`
    ...
    `}function xd(t){t.sort((s,i)=>new Date(i.date)-new Date(s.date));const e=t.reduce((s,i)=>s+(Number(i.value)||0),0),a=t.length>0?e/t.length:0;return`
        <div class="space-y-6">
            <div class="grid grid-cols-2 gap-3">
                <div class="bg-emerald-50 p-4 md:p-5 rounded-2xl border border-emerald-100 shadow-sm flex flex-col text-center justify-center">
                    ...
                    <span class="text-2xl md:text-3xl font-black text-emerald-700 mt-1 truncate">${Na(e)}</span>
                </div>
                <div class="bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col text-center justify-center">
                    ...
                    <span class="text-2xl md:text-3xl font-black text-slate-800 mt-1 truncate">${Na(a)}</span>
                </div>
            </div>
                    ...
                    ${t.length?t.map(s=>{const i=w.establishments.find(r=>r.id===s.establishmentId)?.name||"Unidade Local",o=s.type==="sale";return`
                        <div class="bg-white border border-slate-100 rounded-xl p-3 flex justify-between items-center shadow-sm hover:border-indigo-200 cursor-pointer transition-all active:scale-[0.98]" data-go-comanda="true" data-id="${s.id}" data-est="${s.establishmentId}">
                            ...
                            <div class="text-right flex-shrink-0">
                                <p class="font-black text-emerald-600 text-sm md:text-base">${Na(s.value)}</p>
    ...
    `}function fi(t,e){return e.sort((a,s)=>new Date(s.date)-new Date(a.date)),`
        <div class="space-y-6">
    ...
    `}async function xi(t){if(!t||!t.phone)return;const e=gi(t.phone);try{const a=Array.from(w.filterEstablishmentIds),s=await Ur(a,e),i=s.filter(u=>u.type==="appointment"),o=s.filter(u=>u.type==="sale"),r=s.filter(u=>u.type==="loyalty");w.historyData.appointments=i,w.historyData.sales=o,w.historyData.loyaltyLog=r;const n=document.getElementById("historico-agendamentos-container");n&&(n.innerHTML=fd(i));const l=document.getElementById("historico-financeiro-container");l&&(l.innerHTML=xd(o));const d=document.getElementById("historico-fidelidade-container");d&&(d.innerHTML=fi(t,r)),hi(t)}catch(a){console.error("Erro ao buscar histórico via telefone",a);const s='<div class="text-center py-6 text-red-500 font-bold text-[10px] uppercase bg-red-50 rounded-xl m-2 border border-red-100">Falha na busca. O Telefone está preenchido corretamente?</div>',i=document.getElementById("historico-agendamentos-container");i&&(i.innerHTML=s);const o=document.getElementById("historico-financeiro-container");o&&(o.innerHTML=s);const r=document.getElementById("historico-fidelidade-container");r&&(r.innerHTML=s)}}function hi(t){const e=document.getElementById("client-modal-inner");if(!e)return;e.querySelectorAll("[data-go-agenda]").forEach(o=>{o.onclick=()=>{_e(),oe("agenda-section",{targetDate:new Date(o.dataset.date),scrollToAppointmentId:o.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(o=>{o.onclick=()=>{_e(),oe("comandas-section",{selectedAppointmentId:o.dataset.id,initialFilter:"finalizadas"})}});const a=e.querySelectorAll('[data-action="toggle-adjustment"]'),s=e.querySelector("#inline-adjustment-container"),i=e.querySelector("#confirm-adjustment-btn");a.forEach(o=>{o.onclick=r=>{r.preventDefault(),s.classList.toggle("hidden"),s.classList.contains("hidden")||s.scrollIntoView({behavior:"smooth",block:"center"})}}),i&&(i.onclick=async o=>{o.preventDefault();const r=e.querySelector("#redeem-action").value,n=parseInt(e.querySelector("#redeem-points").value,10),l=e.querySelector("#redeem-reason").value,d=t.loyaltyPoints||0;if(!n||n<=0)return f("Aviso","Indique a quantidade de pontos.","info");if(r==="debit"&&n>d)return f("Erro","Saldo insuficiente.","error");if(!l)return f("Aviso","Indique o motivo do ajuste.","info");i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm"></span> Gravando...';try{let u=d;r==="debit"?(await Mo(g.establishmentId,t.phone,n,l),u-=n):(u+=n,await gs(t.id,{loyaltyPoints:u})),w.selectedClient.loyaltyPoints=u,f("Sucesso","Pontos atualizados com sucesso!","success"),xi(w.selectedClient),he()}catch(u){f("Erro",u.message,"error"),i.disabled=!1,i.innerHTML="Confirmar Movimentação"}})}async function hd(t){t.preventDefault();const e=t.target.querySelector('button[type="submit"]'),a=e.innerHTML;e.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Gravando...',e.disabled=!0;const s=new FormData(t.target),i=Object.fromEntries(s.entries());i.establishmentId=g.establishmentId,i.dobDay&&(i.dobDay=parseInt(i.dobDay)),i.dobMonth&&(i.dobMonth=parseInt(i.dobMonth));try{if(w.selectedClient.isNew){const o=await Po(i);w.clients.unshift(o),f("Sucesso","Cliente cadastrado com sucesso!","success"),_e()}else{await gs(w.selectedClient.id,i),Object.assign(w.selectedClient,i);const o=w.clients.findIndex(r=>r.id===w.selectedClient.id);o!==-1&&(w.clients[o]=w.selectedClient),f("Sucesso","Dados salvos com sucesso!","success"),_e()}he()}catch(o){f("Erro",o.message,"error"),e.innerHTML=a,e.disabled=!1}}async function vd(t){if(t.preventDefault(),!!await G("Excluir Cliente","Tem certeza? O histórico financeiro será mantido de forma anônima, mas a ficha cadastral será perdida permanentemente."))try{await To(w.selectedClient.id),w.clients=w.clients.filter(a=>a.id!==w.selectedClient.id),f("Sucesso","Cliente removido com sucesso.","success"),_e(),he()}catch(a){f("Erro",a.message,"error")}}function yd(t){const e=t.loyaltyPoints||0,a=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const u={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,cnpj:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};mt(u,d)})}function Sd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-password-form").addEventListener("submit",async a=>{a.preventDefault();const s=e.querySelector("#newPassword").value,i=e.querySelector("#confirmPassword").value;if(s!==i){f("Erro","As senhas não coincidem.","error");return}const o=e.querySelector('button[form="change-password-form"]');o.disabled=!0,o.textContent="A Salvar...";try{const r=we.currentUser;if(r)await Ri(r,s),f("Sucesso","Senha alterada com sucesso!","success"),a.target.reset();else throw new Error("Nenhum utilizador logado encontrado.")}catch(r){f("Erro",`Não foi possível alterar a senha: ${r.message}`,"error")}finally{o.disabled=!1,o.textContent="Salvar Nova Senha"}})}function $d(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=e.querySelector("#establishmentTimezone");t.timezone&&(a.value=t.timezone);const s=e.querySelector("#establishmentWorkingHoursContainer"),i=t.workingHours||{};Object.keys(za).forEach(o=>{const r=i[o]||{},n=za[o],l=r.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",o=>{const r=o.target.closest('.day-schedule-card input[type="checkbox"]');if(r){const n=r.closest(".day-schedule-card");n.classList.toggle("disabled",!r.checked),n.classList.toggle("opacity-60",!r.checked),n.classList.toggle("bg-gray-50",r.checked),n.classList.toggle("bg-gray-100",!r.checked)}}),e.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const r={};Object.keys(za).forEach(l=>{r[l]={active:e.querySelector(`#est-${l}-active`).checked,start:e.querySelector(`#est-${l}-start`).value,end:e.querySelector(`#est-${l}-end`).value,breakStart:e.querySelector(`#est-${l}-breakStart`).value,breakEnd:e.querySelector(`#est-${l}-breakEnd`).value}});const n=e.querySelector("#establishmentTimezone").value;mt({workingHours:r,timezone:n},o)})}function yi(t,e){const a=!!t.whatsappInstance;e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;const n=e.querySelector("#loyaltyTiersContainer"),l=(d={})=>{const u=document.createElement("div");u.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const c=d.type||"money",p=d.itemId||"",b=d.reward||"",m=d.discount||"",h=d.points||d.costPoints||"";u.innerHTML=`
        ...
        `;const y=u.querySelector(".type-select"),k=u.querySelector(".item-select"),A=u.querySelector(".desc-input"),P=u.querySelector(".discount-input"),$=E=>{k.innerHTML='<option value="">Selecione...</option>';let N=[];E==="service"?N=i:E==="product"?N=o:E==="package"&&(N=r),N.forEach(U=>{const C=U.id===p,D=U.name||U.title||"Sem nome",V=U.price||U.salePrice||0;k.innerHTML+=`<option value="${U.id}" data-price="${V}" ${C?"selected":""}>${v(D)}</option>`})};return c!=="money"&&$(c),y.addEventListener("change",E=>{const N=E.target.value;N==="money"?(k.classList.add("hidden"),A.classList.remove("hidden"),A.value="",P.value=""):(k.classList.remove("hidden"),A.classList.add("hidden"),$(N),P.value="")}),k.addEventListener("change",E=>{const N=E.target.selectedOptions[0];if(N&&N.value){A.value=N.text;const U=N.dataset.price;U&&(P.value=parseFloat(U).toFixed(2))}}),u};a.tiers&&a.tiers.length>0?a.tiers.forEach(d=>n.appendChild(l(d))):n.appendChild(l()),e.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(l())}),n.addEventListener("click",d=>{const u=d.target.closest(".remove-loyalty-tier");u&&u.closest(".loyalty-tier-row").remove()}),e.querySelector("#loyalty-form").addEventListener("submit",d=>{d.preventDefault();const u=Array.from(e.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(p=>{const b=p.querySelector(".type-select").value,m=b==="money"?null:p.querySelector(".item-select").value;let h=b==="money"?p.querySelector(".desc-input").value:p.querySelector(".item-select").options[p.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(p.querySelector('input[data-field="points"]').value,10)||0,type:b,itemId:m,reward:h,name:h,discount:parseFloat(p.querySelector('input[data-field="discount"]').value)||0}}),c={loyaltyProgram:{enabled:e.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(e.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:u.filter(p=>p.points>0&&p.reward)}};mt(c,d)})}async function Dd(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([Ca(se),fs(se)]),i=t.financialIntegration||{},o=t.commissionConfig||{},r=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=We(a,i.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=We(s,i.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=We(a,r.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=We(s,r.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=We(a,o.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=We(s,o.defaultCostCenterId)}catch{f("Erro","Não foi possível carregar o plano de contas da unidade.","error")}e.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};mt(s,a)})}function Pd(t,e){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${t.name}).`;e.innerHTML=`
    ...
    `}function Td(t,e){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${t.name})`;e.innerHTML=`
    ...
    `}function Md(t,e){const a=e.querySelector("#slotIntervalContainer"),s=e.querySelector("#establishmentSlotInterval");if(!a||!s)return;const i=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=i.map(o=>{const r=o.value===t;return`<button type="button" data-value="${o.value}" 
    ...
    `,Oe.querySelector('button[data-action="back-to-menu"]').addEventListener("click",i=>{i.preventDefault(),wi({id:se})});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":kd(K,s);break;case"change-password":Sd(K,s);break;case"change-email":$d(K,s);break;case"branding":Id(K,s);break;case"booking":Ed(K,s);break;case"working-hours":Ld(K,s);break;case"whatsapp-bot":yi(K,s);break;case"loyalty":await Cd(K,s);break;case"financial":await Dd(K,s);break;case"support":Pd(K,s);break;case"cancellation":Td(K,s);break;default:s.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function wi(t={}){Oe.innerHTML=`
    ...
    `;try{se=t.id||g.establishmentId,K=await je(se);const e=t.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
               ...
               </button>`:"",a=K.isMatriz||!K.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',s=vi();Oe.innerHTML=`
        ...
        `,Oe.querySelectorAll("div[data-section]").forEach(i=>{i.addEventListener("click",o=>{Ad(i.dataset.section)})}),Oe.querySelectorAll(".module-toggle").forEach(i=>{i.addEventListener("change",async()=>{const o=i.dataset.module;try{const n={...(await je(se)).modules,[o]:i.checked};await ms(se,{modules:n}),f("Módulos","Módulos atualizados com sucesso.","success")}catch(r){i.checked=!i.checked,f("Erro",r.message,"error")}})})}catch(e){Oe.innerHTML=`
        ...
        `}}function Bd(t){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `).join("")}const Et=document.getElementById("content");async function st(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,i=await Pa(g.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],t),o=document.getElementById("filterReason")?.value.toLowerCase(),r=o?i.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):i,n=r.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(e.innerHTML="",r.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;u.innerHTML+=P}),e.appendChild(u)})}catch(a){e.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function jd(t){t.preventDefault();const e=t.target,a=e.querySelector("#blockageProfId").value,s=e.querySelector("#blockageDate").value,i=e.querySelector("#blockageEndDate").value||s,o=e.querySelector("#blockageStartTime").value,r=e.querySelector("#blockageEndTime").value,n={establishmentId:g.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Ta(n),e.reset(),f("Sucesso","Bloqueio adicionado com sucesso!","success"),st(a)}catch(l){f("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function qd(t){t.preventDefault();const e=t.target,a=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(u=>u.value);if(a.length===0)return f("Atenção","Selecione pelo menos um profissional.","error");const s=e.querySelector("#batchBlockageDate").value,i=e.querySelector("#batchBlockageEndDate").value||s,o=e.querySelector("#batchBlockageStartTime").value,r=e.querySelector("#batchBlockageEndTime").value,n=e.querySelector("#batchBlockageReason").value,l=e.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(u=>{const c={establishmentId:g.establishmentId,professionalId:u,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${i}T${r}:00`).toISOString(),reason:n};return Ta(c)});try{await Promise.all(d),f("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(c=>c.checked=!1);const u=document.getElementById("blockageProfId").value;u&&st(u)}catch(u){f("Erro",`Ocorreu um erro: ${u.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Nd(t){Et.addEventListener("submit",e=>{e.target.id==="blockageForm"&&jd(e),e.target.id==="batchBlockageForm"&&qd(e)}),Et.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&st(t)}),Et.addEventListener("click",async e=>{const a=e.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")oe("profissionais-section");else if(s==="delete-blockage"){if(await G("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await hs(a.dataset.id),f("Sucesso","Bloqueio removido.","success"),st(t)}catch(o){f("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const i=JSON.parse(a.dataset.ids);if(await G("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${i.length} bloqueios de uma vez?`))try{await zo(i),f("Sucesso",`${i.length} bloqueios removidos.`,"success"),st(t)}catch(r){f("Erro",`Não foi possível apagar os bloqueios: ${r.message}`,"error")}}})}async function Fd(t){const{professionalId:e,professionalName:a}=t;if(!e||!a){Et.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);Et.innerHTML=`
        <section>
        ...
        </section>`,Nd(e),await st(e);const i=document.getElementById("batchProfSelectionContainer");try{const o=await Le(g.establishmentId);i.innerHTML=o.map(r=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{i.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const Rd=t=>L(`/api/users/${t}`),Hd=t=>L("/api/users",{method:"POST",body:JSON.stringify(t)}),Od=(t,e)=>L(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),zd=t=>L(`/api/users/${t}`,{method:"DELETE"}),_d=(t,e)=>L(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),Vd=(t,e)=>L(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),gt=document.getElementById("content"),Ud={"Operação & Atendimento":{"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas","ausencias-section":"Ausências e Bloqueios"},"Financeiro & Vendas":{"financial-section":"Financeiro (ERP)","sales-report-section":"Relatório de Vendas","commissions-section":"Comissões","packages-section":"Planos e Pacotes"},"Cadastros Base":{"clientes-section":"Clientes","profissionais-section":"Profissionais","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores"},Administração:{"relatorios-section":"Relatórios Gerais","estabelecimento-section":"Configurações da Empresa","users-section":"Usuários e Acessos"}},Wd={view:"Visualizar",create:"Criar",edit:"Editar"},Xs={owner:{label:"Proprietário",color:"bg-rose-100 text-rose-700 border-rose-200"},group_admin:{label:"Admin da Rede",color:"bg-purple-100 text-purple-700 border-purple-200"},company_admin:{label:"Gestor Matriz",color:"bg-blue-100 text-blue-700 border-blue-200"},branch_manager:{label:"Gestor Filial",color:"bg-orange-100 text-orange-700 border-orange-200"},professional:{label:"Profissional",color:"bg-slate-100 text-slate-600 border-slate-200"}};let Yt=null,Zt=null,Je=null,ot=null;function ki(){const t=document.querySelectorAll('#multi-context-list input[type="checkbox"]:checked');return t.length>0?Array.from(t).map(e=>e.value):[g.currentViewContext?.id||g.establishmentId]}function Jd(t){const e=document.getElementById("usersListContainer");if(!e)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const s=a?"Nenhum usuário encontrado na base.":"Nenhum usuário ativo neste contexto.";e.innerHTML=`
        ...
        `}).join("")}function Si(){const e=document.getElementById("showInactiveUsersToggle")?.checked?g.users:g.users.filter(a=>a.status==="active");Jd(e)}function Gd(t={}){let e="",a=!1;for(const[s,i]of Object.entries(Ud)){const o=Object.entries(i).filter(([r,n])=>{const l=r.replace("-section","");return!(g.enabledModules&&g.enabledModules[l]===!1)});o.length!==0&&(a=!0,e+=`
        ...
        `,o.forEach(([r,n])=>{const l=r==="agenda-section"||r==="comandas-section",d=t[r]?.view_all_prof===!0,u=Object.entries(Wd).map(([p,b])=>`
        ...
        `}),i+="</div>",i}async function Zs(t=null){document.getElementById("user-list-view").classList.add("hidden");const e=document.getElementById("user-form-view");e.classList.remove("hidden");let a=g.professionals;if(!a||a.length===0)try{const p=ki().map(h=>Le(h)),b=await Promise.all(p),m=new Map;b.flat().forEach(h=>m.set(h.id,h)),a=Array.from(m.values()),g.professionals=a}catch(c){console.warn("Profissionais não carregados",c)}if(["owner","group_admin","company_admin"].includes(g.userRole)&&!ot)try{const c=await ke();c&&(ot=c)}catch(c){console.error("Falha ao buscar hierarquia",c),ot={companies:[],branches:[]}}const s=t!==null,i=s&&t.role==="owner",o=e.querySelector("#userFormTitle");o.innerHTML=s?`<i class="bi bi-person-lines-fill mr-2 text-indigo-600"></i>Editar Perfil: ${t.name}`:'<i class="bi bi-person-plus-fill mr-2 text-indigo-600"></i>Novo Acesso';const r=e.querySelector("#userForm");r.innerHTML=`
    ...
    `;const n=e.querySelectorAll(".tab-btn"),l=e.querySelectorAll(".tab-content");n.forEach(c=>{c.addEventListener("click",()=>{n.forEach(b=>{b.classList.remove("active","text-indigo-600","border-indigo-600"),b.classList.add("text-slate-400","border-transparent")}),l.forEach(b=>b.classList.add("hidden")),c.classList.add("active","text-indigo-600","border-indigo-600"),c.classList.remove("text-slate-400","border-transparent");const p=c.getAttribute("data-tab");e.querySelector(`#${p}`).classList.remove("hidden")})});const d=r.querySelector("#userRole"),u=r.querySelector("#hierarchySelectorContainer");if(d&&u){d.addEventListener("change",p=>{const b={...t,role:p.target.value};u.innerHTML=Ys(b),c()});const c=()=>{u.querySelectorAll(".company-checkbox").forEach(p=>{p.addEventListener("change",b=>{b.target.closest(".company-block").querySelectorAll(".branch-checkbox").forEach(y=>{y.checked=b.target.checked;const k=y.nextElementSibling.querySelector(".dot");k&&(b.target.checked?k.classList.add("transform","translate-x-4"):k.classList.remove("transform","translate-x-4"))})})})};c()}if(r.querySelectorAll(".permission-checkbox").forEach(c=>{if(c.addEventListener("change",p=>{const b=p.target.nextElementSibling,m=b.nextElementSibling;p.target.checked?(b.classList.replace("bg-slate-200","bg-indigo-500"),m.classList.add("transform","translate-x-4")):(b.classList.replace("bg-indigo-500","bg-slate-200"),m.classList.remove("transform","translate-x-4"))}),c.checked){const p=c.nextElementSibling,b=p.nextElementSibling;p.classList.replace("bg-slate-200","bg-indigo-500"),b.classList.add("transform","translate-x-4")}}),r.onsubmit=async c=>{c.preventDefault();const p=r.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML='<span class="spinner-border spinner-border-sm mr-2"></span> Processando...';const m={};r.querySelectorAll(".permission-checkbox").forEach($=>{const E=$.dataset.module,N=$.dataset.permission;m[E]||(m[E]={}),m[E][N]=$.checked});const h=r.querySelector("#userProfessionalId").value||null,y=r.querySelector("#userRole")?.value||"professional",k=[],A=[];if(y!=="group_admin"&&y!=="owner"&&r.querySelector(".company-checkbox")&&(r.querySelectorAll(".company-checkbox:checked").forEach($=>{k.push({id:$.value,name:$.dataset.name})}),r.querySelectorAll(".branch-checkbox:checked").forEach($=>{A.push({id:$.value,name:$.dataset.name,companyId:$.dataset.companyId})}),A.length===0))return p.disabled=!1,p.innerHTML=b,f("Atenção","Selecione pelo menos uma filial na aba de Acesso.","warning");const P={name:r.querySelector("#userName").value,permissions:m,professionalId:h,role:y,accessibleCompanies:k,accessibleEstablishments:A};try{if(s){const $=r.querySelector("#userEmail").value;t?.email!==$&&!i&&(P.email=$),await Od(t.id,P),f("Sucesso","Usuário atualizado.","success")}else P.email=r.querySelector("#userEmail").value,P.password=r.querySelector("#userPassword").value,await Hd(P),f("Sucesso","Novo usuário cadastrado na plataforma.","success");ha()}catch($){f(`Erro: ${$.message}`,"error"),p.disabled=!1,p.innerHTML=b}},s){const c=r.querySelector("#btn-show-password"),p=r.querySelector("#password-form");c&&p&&(c.onclick=()=>{c.classList.add("hidden"),p.classList.remove("hidden")},r.querySelector("#btn-cancel-pwd").onclick=()=>{c.classList.remove("hidden"),p.classList.add("hidden"),p.querySelector("#userNewPassword").value=""},r.querySelector("#btn-save-pwd").onclick=async b=>{const m=b.target,h=p.querySelector("#userNewPassword").value;if(!h||h.length<6)return f("Aviso","Senha deve ter no mínimo 6 caracteres.","warning");if(await G("Alterar Senha","O usuário usará esta nova senha no próximo acesso. Confirma?"))try{m.disabled=!0,m.textContent="Aguarde...",await _d(t.id,h),f("Sucesso","Senha alterada com segurança.","success"),c.classList.remove("hidden"),p.classList.add("hidden")}catch(y){f("Erro",y.message,"error")}finally{m.disabled=!1,m.textContent="Salvar Senha"}})}}async function Ks(){const t=document.getElementById("usersListContainer");if(t){t.innerHTML='<div class="col-span-full py-16 flex justify-center"><div class="loader"></div></div>';try{const e=ki(),a=e.map(l=>Rd(l)),s=e.map(l=>Le(l)),i=await Promise.all(a),o=await Promise.all(s),r=new Map;i.flat().forEach(l=>r.set(l.id,l)),g.users=Array.from(r.values());const n=new Map;o.flat().forEach(l=>n.set(l.id,l)),g.professionals=Array.from(n.values()),Si()}catch{f("Erro ao carregar base de usuários.","error"),t.innerHTML='<p class="col-span-full text-center font-bold text-red-500 bg-red-50 p-6 rounded-2xl">Falha de comunicação com o servidor de acessos.</p>'}}}async function ha(){gt.innerHTML=`
    ...
    `,Yt&&gt.removeEventListener("click",Yt),Zt&&gt.removeEventListener("change",Zt),Je&&(window.removeEventListener("kairos:contextChanged",Je),document.removeEventListener("change",Je)),Je=t=>{(t.type==="kairos:contextChanged"||t.target.closest("#multi-context-list"))&&document.getElementById("user-list-view")&&!document.getElementById("user-list-view").classList.contains("hidden")&&Ks()},window.addEventListener("kairos:contextChanged",Je),document.addEventListener("change",Je),Yt=async t=>{const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":Zs();break;case"edit-user":const s=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));Zs(s);break;case"back-to-list":ha();break;case"delete-user":{if(t.stopPropagation(),await G("Excluir Usuário","O usuário perderá totalmente o acesso ao sistema. Confirma?"))try{await zd(e.dataset.userId),f("Usuário excluído com sucesso.","success"),ha()}catch(i){f(`Erro: ${i.message}`,"error")}break}}},Zt=async t=>{if(t.target.id==="showInactiveUsersToggle"){const e=t.target.nextElementSibling,a=e.nextElementSibling;t.target.checked?(e.classList.replace("bg-slate-200","bg-indigo-500"),a.classList.add("transform","translate-x-5")):(e.classList.replace("bg-indigo-500","bg-slate-200"),a.classList.remove("transform","translate-x-5")),Si()}else{const e=t.target.closest('input[data-action="toggle-user-status"]');if(e){t.stopPropagation();const a=e.dataset.userId,s=e.checked?"active":"inactive",i=e.nextElementSibling,o=i.nextElementSibling;e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"));try{await Vd(a,s);const r=g.users.findIndex(n=>n.id===a);if(r>-1){g.users[r].status=s;const n=e.closest(".user-card-clickable");s==="inactive"?n.classList.add("opacity-60","bg-slate-50"):n.classList.remove("opacity-60","bg-slate-50")}}catch(r){f(`Erro: ${r.message}`,"error"),e.checked=!e.checked,e.checked?(i.classList.replace("bg-slate-300","bg-emerald-500"),o.classList.add("transform","translate-x-5")):(i.classList.replace("bg-emerald-500","bg-slate-300"),o.classList.remove("transform","translate-x-5"))}}}},gt.addEventListener("click",Yt),gt.addEventListener("change",Zt),await Ks()}const Qd=document.getElementById("content");let eo={},ds=null;function Xd(){Object.values(eo).forEach(t=>t?.destroy()),eo={}}function Yd(t,e){if(!window.jspdf){f("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),i=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(t,s.internal.pageSize.getWidth()/2,40,{align:"center"}),i){const r=[["Receita Total",i.querySelector("#summary-revenue").textContent],["Vendas Totais",i.querySelector("#summary-transactions").textContent],["Ticket Médio",i.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:r,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${e}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function to(t){const e=document.getElementById("genericModal"),a=v(t.client),s=v(t.items),i=v(t.responsavelCaixa||"N/A"),o=(t.payments||[]).map(r=>`
    ...
    `,e.style.display="flex"}function Zd(t){const{summary:e,transactions:a}=t;document.getElementById("summary-revenue").textContent=`R$ ${e.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=e.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${e.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),i=Object.entries(e.paymentMethodTotals).sort(([,n],[,l])=>l-n);s.innerHTML=i.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=ds.transactions[l];d&&to(d)})}),r.innerHTML=a.map((n,l)=>{const d=v(n.client),u=v(n.items),c=v(n.type);return`
    ...
    `}).join(""),r.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=ds.transactions[l];d&&to(d)})})}async function ao(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!t||!e||!a)return;const s=e.value,i=a.value;if(!s||!i)return f("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,r=await pa({establishmentId:g.establishmentId,startDate:s,endDate:i,cashierSessionId:o});ds=r,t.innerHTML=`
        ...
        `,Zd(r)}catch(o){f("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function Kd(){Xd();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const a=e.toISOString().split("T")[0];Qd.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",ao),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,i=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${i}`;Yd(o,"transactionsTable")});try{const s=await Mn(g.establishmentId),i=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const r=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=v(o.closedByName||"N/A");i.innerHTML+=`<option value="${o.id}">${n} - ${r}</option>`})}catch{f("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await ao()}const ec=document.getElementById("content");let S={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],suppliers:[],clients:[],professionals:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Kt=null,ea=null;function Cs(t){const e=new Map,a=[];return t&&(t.forEach(s=>e.set(s.id,{...s,children:[]})),e.forEach(s=>{s.parentId&&e.has(s.parentId)?e.get(s.parentId).children.push(s):a.push(s)})),a}function $i(t){if(!t)return{day:"--",month:"---",full:"--/--/----"};const[e,a,s]=t.split("-"),i=new Date(e,a-1,s),o=String(i.getDate()).padStart(2,"0"),r=i.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:o,month:r,full:i.toLocaleDateString("pt-BR")}}function ye(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t)}function lt(t,e){if(e==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[s,i,o]=t.split("-");return new Date(s,i-1,o)<a}function tc(t,e,a){if(!t)return;if(!e||e.length===0){t.innerHTML=`
        ...
        `};t.innerHTML=e.map(i=>s(i)).join("")}async function so(t){const e=document.getElementById("genericModal"),a=t==="nature",s=a?"Plano de Naturezas":"Centros de Custo",i=a?Ca:fs,o=a?Jr:Gr,r=a?"natures":"costCenters";e.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",e.innerHTML=`
        ...
        </div>`,e.style.display="flex",requestAnimationFrame(()=>{e.classList.remove("opacity-0");const c=e.querySelector("#modal-content-wrapper");c&&(c.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),c.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const n=e.querySelector("#hierarchyList"),l=e.querySelector("#itemParent"),d=c=>{const p=Cs(c);tc(n,p,t);const b=l.value;l.innerHTML='<option value="">-- Nível Principal --</option>';const m=(h,y=0)=>{const k="  ".repeat(y)+(y>0?"↳ ":"");l.innerHTML+=`<option value="${h.id}">${k}${v(h.name)}</option>`,h.children.forEach(A=>m(A,y+1))};p.forEach(h=>m(h)),l.value=b};try{const c=await i(g.establishmentId);S[r]=c,d(c)}catch(c){console.error(c)}const u=e.querySelector("#hierarchyForm");u.addEventListener("submit",async c=>{c.preventDefault();const p=e.querySelector("#itemName").value,b=l.value;try{await o({name:p,parentId:b||null,establishmentId:g.establishmentId});const m=await i(g.establishmentId);S[r]=m,d(m),u.reset(),await Me(),f("Sucesso","Item adicionado à estrutura.","success")}catch(m){f("Erro",m.message,"error")}})}function Bt(){const t=document.getElementById("genericModal");t.classList.add("opacity-0");const e=t.querySelector("#modal-content-wrapper");e&&(e.classList.remove("translate-y-0","md:scale-100","md:opacity-100"),e.classList.add("translate-y-full","md:scale-95","md:opacity-0")),setTimeout(()=>{t.style.display="none",t.className="modal fade fixed inset-0 z-[9999] overflow-y-auto",t.innerHTML=""},300)}async function ac(){try{const e=(await ke()).matrizes||[];S.establishments=[],e.forEach(a=>{S.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(s=>S.establishments.push({id:s.id,name:s.name,type:"Filial"}))})}catch(t){console.warn("Erro ao buscar lojas",t)}Ii(),Ei(),await Me()}function Ii(){ec.innerHTML=`
    ...
    `,Li()}function sc(){const t=S.currentTab==="receivables",e=t?S.receivables:S.payables;let a=e;if(S.statusFilter!=="all"&&(a=e.filter(n=>{const l=lt(n.dueDate,n.status);return S.statusFilter==="overdue"?l:S.statusFilter==="pending"?n.status==="pending"&&!l:n.status===S.statusFilter})),S.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(S.searchQuery)||n.entity&&n.entity.toLowerCase().includes(S.searchQuery)||n.notes&&n.notes.toLowerCase().includes(S.searchQuery))),a.sort((n,l)=>new Date(n.dueDate)-new Date(l.dueDate)),a.length===0){f("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const s=new Map(S.natures.map(n=>[n.id,n.name])),i=new Map(S.costCenters.map(n=>[n.id,n.name])),o=new Map(S.establishments.map(n=>[n.id,n])),r=a.map(n=>{const l=n.status==="paid",d=lt(n.dueDate,n.status);let u=l?"Baixado":d?"Atrasado":"A Vencer / Pendente";const c=n.naturezaId?s.get(n.naturezaId)||"Não Categorizado":"Geral",p=n.centroDeCustoId?i.get(n.centroDeCustoId)||"Não Categorizado":"Geral",b=o.get(n.establishmentId),m=b?b.name:"Atual",h=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":n.origin==="commission"?"Comissões":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:m,Natureza:c,"Centro de Custo":p,Origem:h,"Documento / NFS":n.documentNumber||"",Status:u,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(r),l=XLSX.utils.book_new();XLSX.utils.book_append_sheet(l,n,"Financeiro");const u=`Fluxo_${t?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(l,u)}catch(n){console.error("Erro ao exportar:",n),f("Erro","Não foi possível exportar para Excel.","error")}}function oc(){document.querySelectorAll(".sort-header").forEach(t=>{const e=t.querySelector("i.bi-chevron-expand, i.bi-chevron-up, i.bi-chevron-down");if(!e)return;t.dataset.sort===S.sortCol?(t.classList.add("text-indigo-700"),t.classList.remove("text-gray-500"),e.className=S.sortAsc?"bi bi-chevron-up ml-1 text-indigo-600 text-[11px] font-black":"bi bi-chevron-down ml-1 text-indigo-600 text-[11px] font-black"):(t.classList.remove("text-indigo-700"),t.classList.add("text-gray-500"),e.className="bi bi-chevron-expand ml-1 opacity-40 text-[10px] font-black")})}function Ei(){document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",r=>{const n=r.currentTarget.dataset.sort;S.sortCol===n?S.sortAsc=!S.sortAsc:(S.sortCol=n,S.sortAsc=!0),Lt()})});const t=document.getElementById("select-all-toggle");t&&t.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");S.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&S.selectedIds.add(l.value)}),et()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{S.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),et()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=S.selectedIds.size;if(o===0)return;if(await G("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const n=S.currentTab==="payables"?"payables":"receivables";await No(n,Array.from(S.selectedIds)),f("Sucesso",`${o} itens excluídos.`,"success"),S.selectedIds.clear(),et(),Me()}catch{f("Erro","Falha ao excluir itens.","error")}}),document.getElementById("custom-date-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");S.isAdvancedFilterOpen=!S.isAdvancedFilterOpen,S.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))});const e=document.getElementById("export-excel-btn");e&&e.addEventListener("click",sc);const a=document.getElementById("settings-btn");a&&a.addEventListener("click",nc),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(20),io(r.target.closest("button").dataset.type)})});const s=document.getElementById("tab-receivables"),i=document.getElementById("tab-payables");s.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),oo("receivables")}),i.addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15),oo("payables")}),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".status-filter-btn").forEach(l=>{l.classList.remove("bg-gray-900","bg-blue-600","bg-emerald-600","bg-red-600","text-white"),l.classList.add("bg-white","text-gray-600")});const n=r.target.dataset.status;n==="all"?r.target.classList.add("bg-gray-900","text-white"):n==="pending"?r.target.classList.add("bg-blue-600","text-white"):n==="paid"?r.target.classList.add("bg-emerald-600","text-white"):n==="overdue"&&r.target.classList.add("bg-red-600","text-white"),r.target.classList.remove("bg-white","text-gray-600"),S.statusFilter=n,Lt()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=u.toISOString().split("T")[0],S.startDate=d.toISOString().split("T")[0],S.endDate=u.toISOString().split("T")[0],Me()})}),document.getElementById("searchInput").addEventListener("input",o=>{S.searchQuery=o.target.value.toLowerCase(),Lt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(15);const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",Ii(),Ei(),Me()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{navigator.vibrate&&navigator.vibrate(20),S.startDate=document.getElementById("filterStartDate").value,S.endDate=document.getElementById("filterEndDate").value,S.filterNaturezaId=document.getElementById("filterNaturezaId").value,S.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("custom-date-btn").click(),Me()}),Kt&&document.body.removeEventListener("click",Kt),Kt=o=>{const r=o.target;if(r.classList.contains("item-checkbox")||r.classList.contains("modal-item-checkbox")){const d=r.value||r.dataset.id;r.checked?S.selectedIds.add(d):S.selectedIds.delete(d),et(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){const{action:d,type:u,id:c}=n.dataset;if(d==="mark-as-paid"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(20),ic(u,c);return}if(d==="delete"){o.stopPropagation(),navigator.vibrate&&navigator.vibrate(30);const p=n.closest(".financial-row").dataset.item;try{Di(u,JSON.parse(decodeURIComponent(p)))}catch(b){console.error("Parse error on delete",b)}return}if(d==="manage-natures"){o.stopPropagation(),so("nature");return}if(d==="manage-cost-centers"){o.stopPropagation(),so("cost-center");return}if(d==="close-modal"){o.stopPropagation(),Bt();return}}const l=r.closest(".financial-row");if(l&&document.getElementById("list-container").contains(l)&&!r.closest("button")&&!r.closest(".item-checkbox")){navigator.vibrate&&navigator.vibrate(15);const{type:d}=l.dataset;try{const u=JSON.parse(decodeURIComponent(l.dataset.item));io(d,u)}catch(u){console.error("Parse error on card click",u),f("Erro","Os dados deste lançamento não puderam ser lidos corretamente.","error")}}},document.body.addEventListener("click",Kt),ea&&document.getElementById("genericModal").removeEventListener("click",ea),ea=o=>{const r=o.target.closest('button[data-action^="delete-"]');if(r){const n=r.dataset.action.split("-")[1];handleDeleteHierarchyItem(n,r.dataset.id)}o.target===document.getElementById("genericModal")&&Bt()},document.getElementById("genericModal").addEventListener("click",ea)}function et(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=S.selectedIds.size;e.textContent=a,a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex"))}function oo(t){S.currentTab=t,S.selectedIds.clear(),et(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const e=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t==="receivables"?(e.classList.add("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.remove("text-gray-500"),a.classList.remove("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.add("text-gray-500")):(a.classList.add("bg-white","md:bg-red-50","text-red-700","shadow-sm","md:shadow-none"),a.classList.remove("text-gray-500"),e.classList.remove("bg-white","md:bg-emerald-50","text-emerald-700","shadow-sm","md:shadow-none"),e.classList.add("text-gray-500")),Lt(),Ci()}async function Me(){const t=document.getElementById("list-container");t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A sincronizar carteira...</p></div>';try{if(S.natures.length===0){const[r,n,l,d,u]=await Promise.all([Ca(g.establishmentId),fs(g.establishmentId),At(g.establishmentId).catch(()=>[]),ut(g.establishmentId,"",1e3).catch(()=>[]),Le(g.establishmentId).catch(()=>[])]);S.natures=r||[],S.costCenters=n||[],S.suppliers=l||[],S.clients=d||[],S.professionals=u||[],Li()}const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(","),s={startDate:S.startDate,endDate:S.endDate,establishmentId:a};S.filterNaturezaId!=="all"&&(s.natureId=S.filterNaturezaId),S.filterCostCenterId!=="all"&&(s.costCenterId=S.filterCostCenterId);const[i,o]=await Promise.all([xs(s),Da(s)]);S.payables=i.entries||[],S.receivables=o.entries||[],Ci(),Lt()}catch(e){t.innerHTML=`
            ...
            </div>`}}function Li(){const t=s=>{let i='<option value="all">Todas as categorias</option>';const o=Cs(s),r=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");i+=`<option value="${n.id}">${d}${v(n.name)}</option>`,n.children.forEach(u=>r(u,l+1))};return o.forEach(n=>r(n)),i},e=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");e&&(e.innerHTML=t(S.natures)),a&&(a.innerHTML=t(S.costCenters))}function Ci(){const t=document.getElementById("summary-section");if(!t)return;const e=S.currentTab==="receivables";let s=e?S.receivables:S.payables;S.searchQuery&&(s=s.filter(u=>u.description&&u.description.toLowerCase().includes(S.searchQuery)||u.entity&&u.entity.toLowerCase().includes(S.searchQuery)||u.notes&&u.notes.toLowerCase().includes(S.searchQuery)));const i=s.reduce((u,c)=>u+c.amount,0),o=s.filter(u=>u.status==="paid").reduce((u,c)=>u+c.amount,0),r=s.filter(u=>u.status==="pending"&&!lt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),n=s.filter(u=>lt(u.dueDate,u.status)).reduce((u,c)=>u+c.amount,0),l=e?"emerald":"red",d=e?"bi-arrow-down-left-circle-fill text-emerald-500":"bi-arrow-up-right-circle-fill text-red-500";t.innerHTML=`
    ...
    `}function Lt(){const t=document.getElementById("list-container");if(!t)return;const e=S.currentTab==="receivables",a=e?S.receivables:S.payables;let s=a;if(S.statusFilter!=="all"&&(s=a.filter(c=>{const p=lt(c.dueDate,c.status);return S.statusFilter==="overdue"?p:S.statusFilter==="pending"?c.status==="pending"&&!p:c.status===S.statusFilter})),S.searchQuery&&(s=s.filter(c=>c.description&&c.description.toLowerCase().includes(S.searchQuery)||c.entity&&c.entity.toLowerCase().includes(S.searchQuery)||c.notes&&c.notes.toLowerCase().includes(S.searchQuery))),s.sort((c,p)=>{let b=c[S.sortCol],m=p[S.sortCol];return S.sortCol==="dueDate"?(b=new Date(b).getTime(),m=new Date(m).getTime()):(S.sortCol==="description"||S.sortCol==="status")&&(b=b?b.toLowerCase():"",m=m?m.toLowerCase():""),b<m?S.sortAsc?-1:1:b>m?S.sortAsc?1:-1:0}),oc(),s.length===0){t.innerHTML=`
        ...
        `}).join("")}async function ic(t,e){const a=new Date().toISOString().split("T")[0];try{await(t==="payable"?Yr(e,a):tn(e,a)),f("Baixa Realizada","O lançamento foi registado como pago.","success"),await Me()}catch(s){f("Erro",s.message,"error")}}async function Di(t,e){if(!!!e.recurrenceId){await G("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Pi(t,[e.id]);return}rc(t,e)}function rc(t,e){const a=document.getElementById("genericModal"),i=(t==="payable"?S.payables:S.receivables).filter(d=>d.recurrenceId===e.recurrenceId).sort((d,u)=>new Date(d.dueDate)-new Date(u.dueDate));a.className="fixed inset-0 z-[10000] bg-slate-900/60 backdrop-blur-sm flex items-end md:items-center justify-center opacity-0 transition-opacity duration-300 p-0 md:p-6",a.innerHTML=`
        <div id="modal-content-wrapper" class="w-full md:max-w-2xl bg-gray-50 md:bg-white flex flex-col transform transition-all duration-300 translate-y-full md:translate-y-0 md:scale-95 md:opacity-0 h-full md:h-auto md:max-h-[90vh] rounded-t-3xl md:rounded-3xl overflow-hidden shadow-2xl relative" style="font-family: 'Plus Jakarta Sans', 'Nunito', sans-serif;">
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar bg-gray-50 pb-safe md:pb-4">
                ${i.map(d=>{const u=d.id===e.id,c=d.status==="paid",p=$i(d.dueDate);return`
    ...
    `,a.style.display="flex",requestAnimationFrame(()=>{a.classList.remove("opacity-0");const C=a.querySelector("#modal-content-wrapper");C&&(C.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),C.classList.add("translate-y-0","md:scale-100","md:opacity-100"))});const p=a.querySelector("#financial-form");let b="single",m=2;const h=p.querySelector("#modal-delete-btn");h&&h.addEventListener("click",C=>{C.preventDefault(),navigator.vibrate&&navigator.vibrate(30),Bt(),setTimeout(()=>Di(t,e),300)});const y=p.querySelector('[name="amount"]'),k=p.querySelector("#recurrence-options"),A=p.querySelector("#recurrence-summary"),P=p.querySelector("#installments-input"),$=p.querySelector("#status-toggle"),E=p.querySelector("#payment-date-wrapper"),N=p.querySelector('[name="paymentDate"]'),U=()=>{if(b==="single")return;const C=parseFloat(y.value)||0;if(m=parseInt(P.value)||2,C===0){A.innerHTML='<span class="text-[10px] md:text-xs text-indigo-400 font-bold">Digite o valor total...</span>';return}if(b==="installment"){const D=C/m;A.innerHTML=`
                <div>
            ...
            `}};p.addEventListener("click",C=>{const D=C.target.closest(".mode-btn");if(D&&!e)if(C.preventDefault(),navigator.vibrate&&navigator.vibrate(15),p.querySelectorAll(".mode-btn").forEach(M=>{M.classList.remove("bg-white","text-gray-900","shadow-sm"),M.classList.add("text-gray-500")}),D.classList.add("bg-white","text-gray-900","shadow-sm"),D.classList.remove("text-gray-500"),b=D.dataset.mode,b==="single")k.style.display="none";else{k.style.display="block";const M=k.querySelector("#recurrence-label");M&&(M.textContent=b==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),U()}if(C.target.closest("#btn-minus")&&P){C.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let M=parseInt(P.value)||2;M>2&&(P.value=M-1,U())}if(C.target.closest("#btn-plus")&&P){C.preventDefault(),navigator.vibrate&&navigator.vibrate(10);let M=parseInt(P.value)||2;M<60&&(P.value=M+1,U())}}),y.addEventListener("input",U),P&&P.addEventListener("input",U),$.addEventListener("change",()=>{navigator.vibrate&&navigator.vibrate(20),$.checked?(E.classList.remove("hidden"),N.required=!0):(E.classList.add("hidden"),N.required=!1)}),p.addEventListener("submit",async C=>{C.preventDefault();const D=p.querySelector('button[type="submit"]'),V=D.innerHTML;D.disabled=!0,D.innerHTML='<div class="loader mx-auto h-5 w-5 border-2 border-white border-t-transparent"></div>';const T=new FormData(p),M=$.checked,R=parseFloat(T.get("amount"));let Y=R,te=1;!e&&b!=="single"&&(te=parseInt(T.get("installments")),b==="repeat"&&(Y=R*te));const re=T.get("establishmentId");if(!re){f("Atenção","Selecione uma Unidade válida para o lançamento.","warning"),D.disabled=!1,D.innerHTML=V;return}const Z={companyId:g.companyId,establishmentId:re,description:T.get("description"),amount:Y,dueDate:T.get("dueDate"),naturezaId:T.get("naturezaId")||null,centroDeCustoId:T.get("centroDeCustoId")||null,entity:T.get("entity")||null,paymentMethod:T.get("paymentMethod")||null,documentNumber:T.get("documentNumber")||null,notes:T.get("notes"),status:M?"paid":"pending",paymentDate:M?T.get("paymentDate"):null,installments:te};te>1&&!e&&(Z.recurrenceId=self.crypto.randomUUID());try{e?(await(s?Qr(e.id,Z):Kr(e.id,Z)),f("Sucesso","Atualizado com sucesso!","success")):(await(s?Ro(Z):Zr(Z)),f("Sucesso","Lançamento criado!","success")),Bt(),Me()}catch(q){f("Erro",q.message||"Erro ao salvar","error"),D.disabled=!1,D.innerHTML=V}})}const lc=t=>L("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),dc=t=>L("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),cc=(t,e)=>{const a=new URLSearchParams({startDate:t,endDate:e}).toString();return L(`/api/commissions/stats?${a}`)},uc=(t={})=>{Object.keys(t).forEach(s=>(t[s]===void 0||t[s]===null||t[s]==="")&&delete t[s]);const e=new URLSearchParams(t).toString(),a=`/api/commissions/history${e?"?"+e:""}`;return L(a)},Ti=t=>L(`/api/commissions/report/${t}`,{method:"DELETE"}),va=new Date,pc=new Date(va.getFullYear(),va.getMonth(),1);let F={professionals:[],reports:[],calculationResult:null,periodString:"",establishmentConfig:null,selectedIds:new Set,isAdvancedFilterOpen:!1,startDate:pc.toISOString().split("T")[0],endDate:new Date(va.getFullYear(),va.getMonth()+1,0).toISOString().split("T")[0],professionalId:"all",searchQuery:"",stats:{revenue:0,commissions:0,margin:0,netPaid:0},viewMode:"list"},ta=null;const bc=document.getElementById("content");function Ct(t){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0)}function mc(t){return t?new Date(t).toLocaleDateString("pt-BR"):"--/--/----"}function ya(t){if(!t)return"PR";const e=t.trim().split(" ");return e.length>=2?(e[0][0]+e[e.length-1][0]).toUpperCase():t.substring(0,2).toUpperCase()}function Mi(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="none"),e&&(e.classList.remove("hidden"),e.classList.add("flex")),a&&window.innerWidth<768&&(a.style.display="none")}function Ds(){const t=document.getElementById("commissions-layout-main"),e=document.getElementById("commissions-layout-detail"),a=document.getElementById("mobile-bottom-nav");t&&(t.style.display="flex"),e&&(e.classList.add("hidden"),e.classList.remove("flex")),a&&window.innerWidth<768&&(a.style.display=""),F.viewMode="list"}async function gc(){try{const[t,e]=await Promise.all([Le(g.establishmentId),je(g.establishmentId).catch(()=>({}))]);F.professionals=t,F.establishmentConfig=e||{}}catch(t){console.error("Erro na inicialização de comissões",t)}F.viewMode="list",fc(),hc(),await dt()}function fc(){const t=F.professionals.map(e=>`<option value="${e.id}">${e.name}</option>`).join("");bc.innerHTML=`
        <style>
    ...
    `}async function dt(){const t=document.getElementById("list-container");t&&(t.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">Carregando comissões...</p></div>');const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(",");try{const[s,i]=await Promise.all([uc({startDate:F.startDate,endDate:F.endDate,professionalId:F.professionalId,establishmentId:a}),cc(F.startDate,F.endDate,a)]);F.reports=s||[];const o=F.reports.reduce((r,n)=>r+(n.summary.finalValue||n.summary.totalCommission),0);F.stats={revenue:i.totalRevenue||0,commissions:i.totalCommissionsPaid||0,margin:i.totalRevenue>0?((i.totalRevenue-i.totalCommissionsPaid)/i.totalRevenue*100).toFixed(1):0,netPaid:o},F.selectedIds.clear(),Dt(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),xc(),Ai()}catch(s){console.error(s),t&&(t.innerHTML=`
            <div class="flex flex-col items-center justify-center py-16">
                <i class="bi bi-exclamation-octagon text-3xl text-red-400 mb-2"></i>
                <p class="text-gray-600 text-sm font-medium">Erro ao carregar dados.</p>
            </div>`)}}function xc(){const t=document.getElementById("kpi-section");t&&(t.innerHTML=`
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-gray-900">${Ct(F.stats.revenue)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-amber-600">${Ct(F.stats.commissions)}</span>
        </div>
        ...
        <div class="snap-center shrink-0 w-[140px] md:w-full bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            ...
            <span class="text-xl md:text-2xl font-black text-emerald-600">${Ct(F.stats.netPaid)}</span>
        </div>
    `)}function Ai(){const t=document.getElementById("list-container");if(!t)return;let e=F.reports;if(F.searchQuery){const a=F.searchQuery.toLowerCase();e=e.filter(s=>s.professionalName.toLowerCase().includes(a)||s.period.toLowerCase().includes(a))}if(e.length===0){t.innerHTML=`
        ...
        `;return}t.innerHTML=e.map(a=>{const s=mc(a.createdAt),i=a.summary.totalCommission,o=a.summary.extraDebit||0,r=a.summary.extraCredit||0,n=a.summary.finalValue||i,l=F.selectedIds.has(a.id);let d="";return o>0&&r>0?d=`<span class="text-red-500">-R$${o.toFixed(2)}</span> / <span class="text-emerald-500">+R$${r.toFixed(2)}</span>`:o>0?d=`<span class="text-red-500">-R$ ${o.toFixed(2)}</span>`:r>0?d=`<span class="text-emerald-500">+R$ ${r.toFixed(2)}</span>`:d='<span class="text-gray-300">--</span>',`
        <div class="bg-white border border-gray-100 md:border-0 md:border-b md:border-gray-100 hover:bg-gray-50 transition-all cursor-pointer relative flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center p-4 md:px-6 md:py-4 mb-3 md:mb-0 rounded-2xl md:rounded-none ${l?"ring-2 md:ring-0 ring-indigo-500 bg-indigo-50/50 md:bg-indigo-50/50":""}">
            ...
            <div class="md:col-span-2 md:text-right flex items-center justify-between md:block mb-1.5 md:mb-0">
                ...
                <span class="text-sm font-bold text-gray-700">${Ct(i)}</span>
            </div>
        ...
        `}).join("")}function hc(){ta&&document.body.removeEventListener("click",ta),ta=o=>{const r=o.target;if(r.classList.contains("item-checkbox")){const l=r.value;r.checked?F.selectedIds.add(l):F.selectedIds.delete(l),Dt(),o.stopPropagation();return}const n=r.closest("button[data-action]");if(n){o.preventDefault();const l=n.dataset.action,d=n.dataset.id;switch(l){case"apply-filters":F.startDate=document.getElementById("filter-start").value,F.endDate=document.getElementById("filter-end").value,F.professionalId=document.getElementById("filter-prof").value,document.getElementById("custom-date-btn")?.click(),dt();break;case"new-calculation":vc();break;case"print-receipt":Lc(d);break;case"delete-report":Dc(d);break;case"view-report-details":Ic(d);break;case"close-detail-screen":Ds();break;case"toggle-all-profs":const u=document.querySelectorAll(".prof-checkbox"),c=Array.from(u).every(h=>h.checked);u.forEach(h=>h.checked=!c);break;case"calculate-preview":yc();break;case"save-final-reports":$c();break;case"toggle-preview-details":const p=n.dataset.idx,b=document.getElementById(`preview-details-${p}`),m=n.querySelector("i");b&&(b.classList.contains("hidden")?(b.classList.remove("hidden"),m&&m.classList.replace("bi-chevron-down","bi-chevron-up")):(b.classList.add("hidden"),m&&m.classList.replace("bi-chevron-up","bi-chevron-down")));break}}},document.body.addEventListener("click",ta);const t=document.getElementById("search-input");t&&t.addEventListener("input",o=>{F.searchQuery=o.target.value,Ai()}),document.body.addEventListener("input",o=>{(o.target.classList.contains("input-debit")||o.target.classList.contains("input-credit")||o.target.classList.contains("input-notes"))&&kc(o.target.dataset.idx)});const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const r=o.target.checked,n=document.querySelectorAll(".item-checkbox");F.selectedIds.clear(),n.forEach(l=>{l.checked=r,r&&F.selectedIds.add(l.value)}),Dt()});const a=document.getElementById("cancel-selection-btn");a&&a.addEventListener("click",()=>{F.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Dt()});const s=document.getElementById("batch-delete-btn");s&&s.addEventListener("click",Cc);const i=document.getElementById("export-excel-btn");i&&i.addEventListener("click",Ec),document.getElementById("custom-date-btn")?.addEventListener("click",()=>{const o=document.getElementById("filter-panel"),r=document.getElementById("custom-date-btn");F.isAdvancedFilterOpen=!F.isAdvancedFilterOpen,F.isAdvancedFilterOpen?(o.classList.remove("hidden"),r.classList.add("bg-gray-900","text-white","border-gray-900"),r.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),r.classList.remove("bg-gray-900","text-white","border-gray-900"),r.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",r=>{navigator.vibrate&&navigator.vibrate(15),document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),r.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),r.target.classList.remove("bg-white","text-gray-600","border-gray-200");const n=r.target.dataset.preset,l=new Date;let d,u;n==="month"?(d=new Date(l.getFullYear(),l.getMonth(),1),u=new Date(l.getFullYear(),l.getMonth()+1,0)):n==="last_month"&&(d=new Date(l.getFullYear(),l.getMonth()-1,1),u=new Date(l.getFullYear(),l.getMonth(),0)),document.getElementById("filter-start").value=d.toISOString().split("T")[0],document.getElementById("filter-end").value=u.toISOString().split("T")[0],F.startDate=d.toISOString().split("T")[0],F.endDate=u.toISOString().split("T")[0],dt()})})}function Dt(){const t=document.getElementById("batch-action-bar"),e=document.getElementById("selected-count"),a=F.selectedIds.size;e&&(e.textContent=a),t&&(a>0?(t.classList.remove("hidden"),t.classList.add("flex")):(t.classList.add("hidden"),t.classList.remove("flex")))}function vc(){F.viewMode="new-calc";const t=document.getElementById("commissions-layout-detail");if(!t)return;const e=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=F.professionals.map(o=>`
        <label class="flex items-center p-2.5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-indigo-300 transition-all cursor-pointer group mb-1.5">
            ...
            <div class="ml-3 flex items-center gap-2">
                <div class="w-8 h-8 rounded-lg border border-gray-100 bg-gray-50 text-gray-500 flex items-center justify-center text-[10px] font-black group-hover:bg-indigo-50 group-hover:text-indigo-600 transition-colors shadow-sm">${ya(o.name)}</div>
    ...
    `,Mi()}async function yc(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(u=>u.value);if(t.length===0)return f("Atenção","Selecione pelo menos um profissional.","warning");const a=(g.selectedEstablishments&&g.selectedEstablishments.length>0?g.selectedEstablishments:[g.establishmentId]).join(","),s=document.getElementById("calc-start-date"),i=document.getElementById("calc-end-date");if(!s||!i||!s.value||!i.value)return f("Atenção","As datas de início e fim são obrigatórias.","warning");const o={professionalIds:t,startDate:s.value,endDate:i.value,establishmentId:a,calculationTypes:{services:document.getElementById("calc-type-services")?.checked||!1,products:document.getElementById("calc-type-products")?.checked||!1,packages:document.getElementById("calc-type-packages")?.checked||!1}},r=new Date(o.startDate+"T00:00:00").toLocaleDateString("pt-BR"),n=new Date(o.endDate+"T00:00:00").toLocaleDateString("pt-BR");F.periodString=`${r} a ${n}`;const l=document.getElementById("btn-calc-action"),d=l.innerHTML;l.innerHTML='<div class="loader-small border-white mr-2"></div> Processando...',l.disabled=!0;try{const u=await lc(o);F.calculationResult=u.map(c=>({...c,extraDebit:0,extraCredit:0,finalValue:c.summary.totalCommission,notes:""})),wc()}catch(u){f("Erro na Apuração",u.message,"error"),l.innerHTML=d,l.disabled=!1}}function wc(){F.viewMode="preview-calc";const t=F.calculationResult;if(!t||t.length===0||t.every(r=>r.summary.totalCommission===0)){f("Aviso","Nenhuma comissão encontrada para os filtros selecionados.","info");const r=document.getElementById("btn-calc-action");r.innerHTML='<i class="bi bi-calculator text-lg"></i> Calcular Vendas',r.disabled=!1;return}const e=document.getElementById("calc-step-1"),a=document.getElementById("calc-step-2"),s=document.getElementById("btn-calc-action");e&&e.classList.add("hidden"),a&&a.classList.remove("hidden"),s&&(s.dataset.action="save-final-reports",s.className="w-full md:w-auto py-3.5 px-8 bg-emerald-600 text-white font-black text-sm rounded-xl hover:bg-emerald-700 shadow-md transition-transform active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider",s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1);const i=t.reduce((r,n)=>r+n.finalValue,0),o=t.map((r,n)=>{if(r.summary.totalCommission===0)return"";const l=(r.items||[]).map(u=>`
        ...
        ${o}
    `)}function kc(t){const e=document.querySelector(`.input-debit[data-idx="${t}"]`),a=document.querySelector(`.input-credit[data-idx="${t}"]`),s=document.querySelector(`.input-notes[data-idx="${t}"]`);let i=parseFloat(e?.value)||0,o=parseFloat(a?.value)||0,r=s?.value||"";if(F.calculationResult&&F.calculationResult[t]){const n=F.calculationResult[t];n.extraDebit=i,n.extraCredit=o,n.notes=r,n.finalValue=n.summary.totalCommission-i+o;const l=document.querySelector(`.final-value-display[data-idx="${t}"]`);l&&(l.innerText=`R$ ${n.finalValue.toFixed(2)}`),Sc()}}function Sc(){const t=F.calculationResult.reduce((a,s)=>a+s.finalValue,0),e=document.getElementById("grand-total-preview");e&&(e.innerText=`R$ ${t.toFixed(2)}`)}async function $c(){const t=F.calculationResult.filter(i=>i.summary.totalCommission>0),e=t.length;if(e===0)return f("Aviso","Não há valores para pagar.","info");if(!await G("Confirmar Pagamentos",`Você está prestes a gerar recibos e marcar as vendas de ${e} profissional(is) como PAGAS. Essa ação lançará a despesa correspondente no Financeiro. Confirmar?`))return;const s=document.getElementById("btn-calc-action");s.innerHTML='<div class="loader-small border-white mr-2"></div> Finalizando...',s.disabled=!0;try{const i=t.map(async o=>{const r=(o.items||[]).map(n=>n.originalSaleId).filter(n=>n!=null);await dc({professionalId:o.professionalId,professionalName:o.professionalName,period:F.periodString,processedSalesIds:r,establishmentId:g.establishmentId,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}});try{if(o.finalValue>0){const n=F.establishmentConfig||{},l=n.defaultDespesaNaturezaId||n.financeConfig?.despesaNaturezaId||null,d=n.defaultDespesaCentroCustoId||n.financeConfig?.despesaCentroCustoId||null;await Ro({establishmentId:g.establishmentId,description:`Comissões - ${o.period}`,amount:o.finalValue,dueDate:new Date().toISOString().split("T")[0],naturezaId:l,centroDeCustoId:d,entity:o.professionalName,paymentMethod:"dinheiro",status:"paid",paymentDate:new Date().toISOString().split("T")[0],origin:"commission"})}}catch(n){console.error("Erro ao integrar com financeiro (Despesa):",n)}});await Promise.all(i),f("Sucesso","Pagamentos registrados e integrados ao financeiro!","success"),F.calculationResult=null,Ds(),await dt()}catch(i){f("Erro ao Salvar",i.message,"error"),s.innerHTML='<i class="bi bi-check2-circle text-lg"></i> Confirmar Pagtos.',s.disabled=!1}}function Ic(t){F.viewMode="report-details";const e=document.getElementById("commissions-layout-detail");if(!e)return;const a=F.reports.find(c=>c.id===t);if(!a)return;const s=a.reportData?.items||a.items||[],i=a.summary,o=i.extraDebit||0,r=i.extraCredit||0,n=i.notes||"",l=`
    ...
    `}function jc(){const t=Pc(),e=document.getElementById("kpi-container");e&&(e.innerHTML=`
    ...
    `)}function Ye(){const t=document.getElementById("packagesListContainer");if(!t)return;let e=B.allPackages;if(B.statusFilter!=="all"){const s=B.statusFilter==="active";e=e.filter(i=>i.status!=="inactive"===s)}if(B.searchQuery){const s=B.searchQuery.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(e.length===0){t.innerHTML=`
                ...
                <div class="p-5 pt-5 flex-grow flex flex-col">
                    ...
                    <div class="flex justify-between items-end border-t border-slate-100 pt-4">
                        <div class="flex flex-col">
                            ...
                            <span class="text-2xl font-black text-slate-900 leading-none drop-shadow-sm">${ct(r)}</span>
                        </div>
                        <div class="text-right">
        ...
        `}).join("")}function qc(){if(B.allPackages.length===0){f("Aviso","Não há pacotes carregados para exportar.","info");return}let t=B.allPackages;if(B.statusFilter!=="all"){const s=B.statusFilter==="active";t=t.filter(i=>i.status!=="inactive"===s)}if(B.searchQuery){const s=B.searchQuery.toLowerCase();t=t.filter(i=>i.name.toLowerCase().includes(s)||(i.description||"").toLowerCase().includes(s))}if(t.length===0){f("Aviso","Nenhum pacote corresponde aos filtros atuais.","info");return}const e=new Map(B.establishments.map(s=>[s.id,s.name])),a=t.map(s=>{const i=s.originalPrice||0,o=s.price||0,r=i>0?(i-o)/i*100:0,n=(s.items||[]).map(u=>`${u.quantity}x ${u.name}`).join(" | ");return{"Unidade(s)":(s.establishmentIds||(s.establishmentId?[s.establishmentId]:[])).map(u=>e.get(u)).filter(Boolean).join(", ")||"Não identificada","Nome do Pacote":s.name,Status:s.status!=="inactive"?"Ativo":"Inativo",Descrição:s.description||"","Itens Incluídos":n,"Valor Original (R$)":i,"Preço de Venda (R$)":o,"Desconto (%)":r.toFixed(1)+"%","Comissão (%)":s.commissionRate||0,"Validade de Uso (Dias)":s.validityDays||"Vitalício","Vendas Início":s.sellStartDate?new Date(s.sellStartDate).toLocaleDateString("pt-BR"):"-","Vendas Fim":s.sellEndDate?new Date(s.sellEndDate).toLocaleDateString("pt-BR"):"-"}});try{if(typeof XLSX>"u"){f("Erro","A biblioteca XLSX não está disponível no momento.","error");return}const s=XLSX.utils.json_to_sheet(a),i=XLSX.utils.book_new();XLSX.utils.book_append_sheet(i,s,"Pacotes");const o=`Relatorio_Pacotes_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(i,o)}catch(s){console.error(s),f("Erro","Falha ao exportar Excel.","error")}}function ro(t=null){B.viewMode="edit-package",B.tempPackage=t?JSON.parse(JSON.stringify(t)):{id:"",name:"",description:"",status:"active",items:[],price:"",originalPrice:0,commissionRate:0,validityDays:"",sellStartDate:"",sellEndDate:"",salesLimit:"",establishmentIds:[g.establishmentId]},us(),Tc()}function Bi(){const t=document.getElementById("packages-layout-detail");if(!t)return;const a=(B.tempPackage.items||[]).reduce((n,l)=>n+(l.price||0)*(l.quantity||1),0),s=t.querySelector("#finalPrice"),i=t.querySelector("#discountIndicator"),o=t.querySelector("#originalPrice"),r=parseFloat(s?.value)||0;if(o&&(o.textContent=ct(a)),i)if(a>0&&a>r&&r>0){const n=(a-r)/a*100;i.textContent=`${n.toFixed(0)}% OFF`,i.classList.remove("hidden")}else i.classList.add("hidden")}function cs(){const t=document.getElementById("package-items-list");if(!t)return;const e=B.tempPackage.items||[];e.length===0?t.innerHTML=`
    ...
    `,cs(),requestAnimationFrame(()=>{const m=t.querySelector("#modal-content-wrapper");m&&(m.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),m.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Nc(){B.viewMode="select-item";const t=document.getElementById("packages-layout-detail");if(!t)return;const e=`
    ...
    `;let a;const s=(o="")=>{const r=o.toLowerCase(),n={service:'<i class="bi bi-scissors text-indigo-600 text-lg"></i>',product:'<i class="bi bi-box-seam text-emerald-600 text-lg"></i>'},l={"catalog-service-list":{items:B.catalogForModal.services,type:"service"},"catalog-product-list":{items:B.catalogForModal.products,type:"product"}};Object.entries(l).forEach(([d,{items:u,type:c}])=>{const p=t.querySelector("#"+d);if(!p)return;const b=u.filter(y=>y.name.toLowerCase().includes(r)).slice(0,50),m=c==="service"?"hover:border-indigo-400 hover:bg-indigo-50/80 hover:shadow-md":"hover:border-emerald-400 hover:bg-emerald-50/80 hover:shadow-md",h=c==="service"?"bg-indigo-100 border-indigo-200 shadow-sm":"bg-emerald-100 border-emerald-200 shadow-sm";p.innerHTML=b.map(y=>y.id?`
            ...
            `:"").join("")||'<div class="flex flex-col items-center justify-center py-8 text-slate-400 border border-dashed border-slate-200 rounded-2xl bg-slate-50"><i class="bi bi-inbox text-3xl mb-2"></i><p class="text-[10px] font-bold uppercase tracking-widest">Nenhum resultado</p></div>'})};s();const i=t.querySelector("#item-search-input");i&&(i.addEventListener("input",o=>{clearTimeout(a),a=setTimeout(()=>s(o.target.value),300)}),setTimeout(()=>i.focus(),100)),requestAnimationFrame(()=>{const o=t.querySelector("#modal-content-wrapper");o&&(o.classList.remove("translate-y-full","md:scale-95","md:opacity-0"),o.classList.add("translate-y-0","md:scale-100","md:opacity-100"))})}function Fc(){Ge&&(Re.removeEventListener("click",Ge),Re.removeEventListener("input",Ge),Re.removeEventListener("change",Ge)),Ge=async e=>{if(e.target.classList.contains("item-checkbox")){const r=e.target.value;e.target.checked?B.selectedIds.add(r):B.selectedIds.delete(r),wt(),Ye(),e.stopPropagation();return}if(e.target.id==="packages-layout-detail"){da(),B.viewMode="list",B.tempPackage=null;return}if(e.target.closest("#batch-delete-btn")){const r=B.selectedIds.size;if(r===0)return;if(await G("Excluir Pacotes",`Deseja realmente apagar ${r} pacotes selecionados?`))try{const l=Array.from(B.selectedIds).map(d=>zs(d));await Promise.all(l),f("Sucesso",`${r} pacote(s) excluído(s).`,"success"),B.selectedIds.clear(),wt(),await wa()}catch{f("Erro","Ocorreu um erro ao excluir pacotes.","error")}return}if(e.target.closest("#cancel-selection-btn")){B.selectedIds.clear();const r=document.getElementById("select-all-toggle");r&&(r.checked=!1),wt(),Ye();return}const i=e.target.closest("[data-action]");if(!i)return;switch(i.dataset.action){case"new-package":navigator.vibrate&&navigator.vibrate(20),ro(null);break;case"edit-package":navigator.vibrate&&navigator.vibrate(15);const r=i.dataset.id,n=B.allPackages.find(k=>k.id===r);n&&ro(n);break;case"delete-package":e.stopPropagation(),e.preventDefault();const l=i.dataset.id;if(await G("Excluir Pacote","Tem a certeza que deseja excluir este pacote promocional? Esta ação é irreversível."))try{await zs(l),f("Sucesso!","Pacote excluído.","success"),B.viewMode==="edit-package"&&B.tempPackage?.id===l&&(da(),B.viewMode="list"),await wa()}catch(k){f("Erro",`Não foi possível excluir: ${k.message}`,"error")}break;case"back-to-main":da(),B.viewMode="list",B.tempPackage=null;break;case"add-item-to-package-btn":Mc(),Nc();break;case"back-to-editor":us();break;case"select-catalog-item":navigator.vibrate&&navigator.vibrate(10);const{itemType:u,itemId:c}=i.dataset,b=(B.catalogForModal[u+"s"]||[]).find(k=>k.id===c);if(b){const k=B.tempPackage.items.find(A=>A.id===b.id&&A.type===u);k?k.quantity++:B.tempPackage.items.push({...b,type:u,quantity:1}),us()}break;case"remove-item":navigator.vibrate&&navigator.vibrate(10);const m=parseInt(i.dataset.index,10);B.tempPackage.items.splice(m,1),cs();break;case"toggle-all-ests":const h=document.querySelectorAll(".modal-est-checkbox"),y=Array.from(h).every(k=>k.checked);h.forEach(k=>k.checked=!y);break;case"save-package":await Rc(i);break}},Re.addEventListener("click",Ge),Re.addEventListener("input",e=>{e.target.id==="search-packages"&&(B.searchQuery=e.target.value,Ye()),e.target.id==="finalPrice"&&Bi()}),Re.addEventListener("change",e=>{if(e.target.id==="select-all-toggle"){const a=e.target.checked;B.selectedIds.clear(),a&&B.allPackages.forEach(s=>B.selectedIds.add(s.id)),wt(),Ye()}if(e.target.id==="filter-status"&&(B.statusFilter=e.target.value,Ye()),e.target.classList.contains("quantity-input")){const a=parseInt(e.target.dataset.index,10),s=parseInt(e.target.value,10);s>0&&B.tempPackage.items[a]&&(B.tempPackage.items[a].quantity=s,cs())}});const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",qc)}async function Rc(t){const e=B.tempPackage,a=!!e.id,s=document.getElementById("packages-layout-detail");if(!s)return;const i=Array.from(s.querySelectorAll(".modal-est-checkbox:checked")).map(l=>l.value);if(i.length===0){f("Atenção","Selecione pelo menos uma unidade para o pacote.","warning");return}const o=e.items.reduce((l,d)=>l+d.price*d.quantity,0),r={id:e.id||null,companyId:g.companyId,name:s.querySelector("#packageName").value,description:s.querySelector("#packageDescription").value,status:s.querySelector("#packageStatus").value,items:e.items,originalPrice:o,price:parseFloat(s.querySelector("#finalPrice").value),commissionRate:parseFloat(s.querySelector("#commissionRate").value)||0,validityDays:parseInt(s.querySelector("#validityDays").value,10)||null,sellStartDate:s.querySelector("#sellStartDate").value||null,sellEndDate:s.querySelector("#sellEndDate").value||null,salesLimit:parseInt(s.querySelector("#salesLimit").value,10)||null,establishmentIds:i,establishmentId:i[0]};if(!r.name||isNaN(r.price)){f("Erro","Nome do Pacote e Preço Final são obrigatórios.","warning");return}if(r.items.length===0){f("Erro","Adicione pelo menos um serviço ou produto ao pacote.","warning");return}const n=t.innerHTML;t.disabled=!0,t.innerHTML='<div class="loader-small border-white mr-2"></div> Salvando...';try{a?await jn(r.id,r):(delete r.id,await Bn(r)),f("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),da(),B.viewMode="list",B.tempPackage=null,await wa()}catch(l){f("Erro",`Não foi possível salvar o pacote: ${l.message}`,"error"),t.disabled=!1,t.innerHTML=n}}const Hc=document.getElementById("content");async function Oc(){const t=we.currentUser;if(!t)return;let e={};try{const l=await bs(Be(xe,"users",t.uid));l.exists()&&(e=l.data())}catch(l){console.error("Erro ao buscar usuário",l)}let a=null;if(g.userProfessionalId)try{a=await ko(g.userProfessionalId)}catch(l){console.error("Erro ao buscar profissional",l)}const s=v(e.name||t.displayName||"Usuário"),i=v(t.email||"E-mail não disponível"),o=v(e.phone||"");let r=e.photo||"";a&&a.photo&&(r=a.photo);const n=r||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(s.charAt(0))}`;Hc.innerHTML=`
    ...
    `,zc(t),_c(a)}function zc(t,e){const a=document.getElementById("profile-photo-wrapper"),s=document.getElementById("profile-photo-input"),i=document.getElementById("profile-avatar"),o=document.getElementById("form-user-details");a.addEventListener("click",()=>s.click()),s.addEventListener("change",async r=>{const n=r.target.files[0];if(n)try{const l=await $a(n,800,800,.8);i.src=l,await Mt(Be(xe,"users",t.uid),{photo:l}),g.userProfessionalId&&await Ja(g.userProfessionalId,{photo:l}),window.dispatchEvent(new CustomEvent("userPhotoUpdated",{detail:l})),f("Sucesso!","Sua foto de perfil foi atualizada.","success")}catch{f("Erro","Não foi possível salvar a imagem. Tente uma menor.","error")}}),o.addEventListener("submit",async r=>{r.preventDefault();const n=o.querySelector("button"),l=n.innerHTML;n.disabled=!0,n.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> Salvando...';const d=document.getElementById("input-name").value.trim(),u=document.getElementById("input-phone").value.trim();try{await Mt(Be(xe,"users",t.uid),{name:d,phone:u}),g.userProfessionalId&&await Ja(g.userProfessionalId,{name:d,phone:u}),g.userName=d,document.getElementById("display-name").textContent=d,f("Atualizado!","Seus dados foram salvos com sucesso.","success")}catch{f("Erro","Ocorreu um problema na hora de salvar.","error")}finally{n.disabled=!1,n.innerHTML=l}})}function _c(t){const e=document.getElementById("professional-section");if(!t){e.innerHTML=`
    ...
    `;const a=document.getElementById("form-my-blockage");a.addEventListener("submit",async i=>{i.preventDefault();const o=a.querySelector("#b-date-start").value,r=a.querySelector("#b-date-end").value||o,n=a.querySelector("#b-time-start").value,l=a.querySelector("#b-time-end").value,d=a.querySelector("#b-reason").value;if(!o||!n||!l)return f("Atenção","Preencha Data e Horários corretamente.","error");const u=new Date(`${o}T${n}:00`),c=new Date(`${r}T${l}:00`);if(c<=u)return f("Atenção","A data e hora de fim deve ser superior ao início.","warning");const p=a.querySelector('button[type="submit"]'),b=p.innerHTML;p.disabled=!0,p.innerHTML="A bloquear...";try{await Ta({establishmentId:g.establishmentId,professionalId:t.id,reason:d||"Indisponível",startTime:u.toISOString(),endTime:c.toISOString()}),f("Sucesso","Agenda bloqueada com êxito.","success"),a.reset();const m=document.getElementById("my-blocks-filter").value;ca(t.id,m)}catch(m){f("Erro",`Falha ao bloquear: ${m.message}`,"error")}finally{p.disabled=!1,p.innerHTML=b}}),document.getElementById("my-blocks-filter").addEventListener("change",i=>ca(t.id,i.target.value)),ca(t.id,"future")}async function ca(t,e="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const s=new Date;let i,o;e==="history"?(o=new Date,i=new Date,i.setFullYear(i.getFullYear()-1)):(i=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let n=(await Pa(g.establishmentId,i.toISOString(),o.toISOString(),t)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));if(e==="history"?n=n.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):n=n.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),n.length===0){a.innerHTML=`
            ...
            `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Deletar e deixar a agenda livre neste horário?"))try{await hs(u),f("Removido","O bloqueio foi deletado.","success"),ca(t,e)}catch(c){f("Erro",`Não foi possível remover: ${c.message}`,"error")}})})}catch(s){a.innerHTML=`<p class="text-xs text-red-500 font-bold p-3 bg-red-50 rounded-xl">Erro: ${v(s.message)}</p>`}}let lo=!1;async function ka(t){if(!t)return;t.innerHTML=`
    ...
    `;const e=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const i=(await ke()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),i.length===0)e.innerHTML=`
            ...
            `;else{let o="";i.forEach(r=>{if(a&&!r.isOrphanBranch){const l=document.createElement("option");l.value=r.id,l.textContent=r.name,a.appendChild(l)}const n=r.isMatriz||!r.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';o+=`
                ...
                `}),e.innerHTML=o}lo||(Vc(),lo=!0)}catch(s){console.error("Erro na renderização da rede:",s),e.innerHTML=`
        ...
        `}}function Vc(){const t=document.getElementById("form-create-establishment");t&&t.addEventListener("submit",async e=>{e.preventDefault();const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const i={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const o=await mr(i);alert(o.message||"Sucesso!"),t.reset();const r=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(r);n&&n.hide(),await ka(document.getElementById("content"))}catch(o){console.error("Erro ao criar estabelecimento:",o),alert("Erro: "+(o.message||"Falha ao gravar dados."))}finally{a.innerHTML=s,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>ka(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",e=>e.preventDefault()),document.addEventListener("gesturechange",e=>e.preventDefault()),document.addEventListener("gestureend",e=>e.preventDefault());let t=0;document.addEventListener("touchend",function(e){const a=new Date().getTime();a-t<=300&&e.preventDefault(),t=a},!1)});const ue=document.getElementById("loadingScreen"),ft=document.getElementById("dashboardContent"),tt=document.getElementById("content"),_a=document.getElementById("notificationBell"),aa=document.getElementById("notificationBadge"),Qe=document.getElementById("notificationPanel"),Va=document.getElementById("notificationList"),Ce=document.getElementById("profileMenuButton"),me=document.getElementById("profileDropdown"),co=document.getElementById("profileName"),uo=document.getElementById("profileEmail"),po=document.getElementById("logoutButton"),bo=document.getElementById("myProfileLink"),mo=document.getElementById("hamburger-menu-btn"),be=document.getElementById("sidebar"),ve=document.getElementById("mobile-overlay"),go=document.getElementById("themeToggleBtn"),Ua=document.getElementById("themeIcon"),ps=document.getElementById("mobile-bottom-nav"),fo=document.getElementById("nav-scroll"),Uc=document.querySelectorAll(".bottom-nav-item");function Wc(){if(!fo)return;const t=document.querySelector(".bottom-nav-item.active");if(!t)return;const e=fo,a=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=s.left+s.width/2-a.left-a.width/2;e.scrollBy({left:o,behavior:"smooth"})}const Jc={"dashboard-section":an,"agenda-section":Wo,"comandas-section":Zn,"relatorios-section":el,"servicos-section":pl,"produtos-section":Cl,"suppliers-section":Hl,"profissionais-section":Ql,"clientes-section":dd,"estabelecimento-section":t=>wi(t),"ausencias-section":Fd,"users-section":ha,"sales-report-section":Kd,"financial-section":ac,"commissions-section":gc,"packages-section":Ac,"my-profile-section":Oc,"hierarquia-section":()=>ka(tt),"establishments-section":()=>ka(tt)},Gc={"dashboard-section":"Dashboard","agenda-section":"Agenda","comandas-section":"Comandas / PDV","relatorios-section":"Relatórios","servicos-section":"Serviços","produtos-section":"Estoque","suppliers-section":"Parceiros","profissionais-section":"Equipe","clientes-section":"Clientes","estabelecimento-section":"Empresa","ausencias-section":"Ausências","users-section":"Usuários","sales-report-section":"Relatório de Vendas","financial-section":"Financeiro","commissions-section":"Comissões","packages-section":"Pacotes","my-profile-section":"Meu Perfil","hierarquia-section":"Rede / Filiais","establishments-section":"Rede / Filiais"};function ua(t){document.documentElement.setAttribute("data-theme",t),localStorage.setItem("kairos_theme",t),Ua&&(t==="dark"?Ua.className="bi bi-sun-fill text-lg sm:text-xl text-amber-400":Ua.className="bi bi-moon-fill text-lg sm:text-xl text-slate-500")}function Qc(){const t=localStorage.getItem("kairos_theme"),e=window.matchMedia("(prefers-color-scheme: dark)").matches;ua(t||(e?"dark":"light"))}let Pt=null,Tt=[];function ji(){if(!aa||!Va)return;const t=Tt.filter(e=>!e.read).length;if(t>0?(aa.textContent=t,aa.classList.remove("hidden")):aa.classList.add("hidden"),Tt.length===0){Va.innerHTML='<p class="text-center text-slate-500 p-4 text-sm">Nenhuma notificação.</p>';return}Va.innerHTML=Tt.map(e=>`
    ...
    `).join("")}function xo(t){Pt&&Pt();const e=Sa(xe,"establishments",t,"notifications"),a=yo(e,wo("timestamp",">=",new Date),Qi("timestamp","desc"));Pt=Xi(a,s=>{s.docChanges().forEach(i=>{if(i.type==="added"){const o=i.doc.data();Tt.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),f(o.title,o.message,"info",!0),ji();const r=document.querySelector(".sidebar-link.active");r&&r.dataset.target==="agenda-section"&&Wo()}})},s=>{console.error("Erro no listener de notificações:",s)})}async function Xc(t){const e=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),s=document.getElementById("multi-context-label"),i=document.getElementById("multi-context-count"),o=document.getElementById("multi-context-list"),r=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),l=document.getElementById("multi-context-arrow");if(!(!e||!o))try{const u=(await ke()).matrizes||[];let c="",p=0;if(u.forEach(b=>{c+=`
                <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors mb-1">
                    <input type="checkbox" value="${b.id}" class="context-checkbox" data-name="${sa(b.name)}">
                    <span class="text-[13px] sm:text-sm font-bold text-slate-700 truncate">🏢 ${sa(b.name)}</span>
                </label>
            `,p++,b.branches&&b.branches.length>0&&b.branches.forEach(m=>{c+=`
                        <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors ml-4 mb-1 border-l-2 border-slate-100 pl-3">
                            <input type="checkbox" value="${m.id}" class="context-checkbox" data-name="${sa(m.name)}">
                            <span class="text-[12px] sm:text-[13px] font-medium text-slate-600 truncate">📍 ${sa(m.name)}</span>
                        </label>
                    `,p++})}),p>0){o.innerHTML=c,e.style.display="block",(!g.selectedEstablishments||g.selectedEstablishments.length===0)&&(g.selectedEstablishments=[t]);const b=Array.from(o.querySelectorAll('input[type="checkbox"]')),m=()=>{const y=b.filter(k=>k.checked);i.textContent=y.length,y.length===0?s.textContent="Nenhuma selecionada":y.length===1?s.textContent=y[0].dataset.name:s.textContent=`${y.length} Unidades`};let h=!1;b.forEach(y=>{g.selectedEstablishments.includes(y.value)&&(y.checked=!0,h=!0)}),!h&&b.length>0&&(b[0].checked=!0,g.selectedEstablishments=[b[0].value],g.establishmentId=b[0].value),m(),a.addEventListener("click",y=>{y.stopPropagation(),n.classList.toggle("hidden"),l.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",y=>{!e.contains(y.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),l.style.transform="rotate(0deg)",b.forEach(k=>{k.checked=g.selectedEstablishments.includes(k.value)}),m())}),b.forEach(y=>y.addEventListener("change",m)),r.addEventListener("click",async y=>{y.stopPropagation(),ue&&(ue.classList.remove("hidden","fade-out"),ue.style.display="flex");const k=b.filter(P=>P.checked);if(k.length===0){ue&&(ue.classList.add("fade-out"),setTimeout(()=>{ue.style.display="none"},500)),f("Atenção","Selecione pelo menos uma unidade.","warning");return}g.selectedEstablishments=k.map(P=>P.value);const A=g.selectedEstablishments[0];try{const P=await je(A);g.establishmentId=A,g.establishmentName=P.name,g.enabledModules=P.modules,g.currentViewContext={id:A,name:P.name,type:P.parentId?"BRANCH":"GROUP"},xo(A),ho(g.userPermissions),n.classList.add("hidden"),l.style.transform="rotate(0deg)",f("Ambiente Atualizado","Exibindo dados consolidados.","success");const $=document.querySelector(".sidebar-link.active"),E=$?$.getAttribute("data-target"):"dashboard-section";oe(E)}catch{f("Erro","Problema ao trocar a visualização.","error")}finally{ue&&(ue.classList.add("fade-out"),setTimeout(()=>{ue.style.display="none"},500))}});try{const y=await je(g.establishmentId);g.establishmentName=y.name,g.enabledModules=y.modules,g.currentViewContext={id:g.establishmentId,name:y.name,type:y.parentId?"BRANCH":"GROUP"},xo(g.establishmentId),ho(g.userPermissions)}catch{}}else e.style.display="none"}catch{e.style.display="none"}}function oe(t,e={}){const a=t.replace("-section","");if(t!=="my-profile-section"){const i=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(t),o=g.enabledModules?.[a]!==!1,r=g.userPermissions===null||g.userPermissions[t]?.view===!0;if(!i&&(!o||!r)){tt&&(tt.innerHTML='<div class="p-8 text-center mt-10"><i class="bi bi-shield-lock text-5xl text-rose-500 mb-4 block"></i><h2 class="text-2xl font-bold text-slate-800">Acesso Negado</h2><p class="text-slate-500 mt-2">Você não possui permissão para visualizar esta tela.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),be&&be.classList.contains("absolute")&&(be.classList.add("hidden"),ve&&ve.classList.add("hidden"));return}}const s=Jc[t];if(s&&tt){const i=document.getElementById("header-page-title");i&&(i.textContent=Gc[t]||"Painel"),document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),ps&&(Uc.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),setTimeout(Wc,50)),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),tt.innerHTML="",window.innerWidth<768&&be&&(be.classList.add("hidden"),ve&&ve.classList.add("hidden")),s(e)}}window.navigateTo=oe;async function ho(t){const e=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),i=document.getElementById("kpi-today-revenue"),o=t===null||t["agenda-section"]?.view===!0,r=t===null||t["financial-section"]?.view===!0;if(o&&e&&(e.classList.remove("hidden"),e.classList.add("inline-flex")),r&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!o&&!r))try{const n=await Lo();o&&s&&(s.textContent=n.todayAppointments.toString()),r&&i&&(i.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch{}}async function Yc(t){try{Ee.getPlatform()==="android"&&await pe.createChannel({id:"default",name:"Notificações",description:"Alertas",importance:5,visibility:1,vibration:!0});let e=await pe.checkPermissions();if(e.receive==="prompt"&&(e=await pe.requestPermissions()),e.receive!=="granted")return;await pe.register(),pe.addListener("registration",async a=>{try{const s=Be(xe,"users",t);await Mt(s,{fcmTokens:Gi(a.value),platform:"native_mobile"})}catch{}}),pe.addListener("pushNotificationReceived",a=>f(a.title,a.body,"info",!0)),pe.addListener("pushNotificationActionPerformed",()=>oe("agenda-section"))}catch{}}function Zc(){const t=document.getElementById("exitConfirmationModal"),e=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),s=()=>t&&(t.style.display="block"),i=()=>t&&(t.style.display="none"),o=()=>t&&t.style.display==="block";t&&(e.addEventListener("click",()=>{i(),Ee.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{i(),Ee.isNativePlatform()?qs.exitApp():history.back()}),Ee.isNativePlatform()?qs.addListener("backButton",()=>{if(o())i();else{const r=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(r).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(be&&!be.classList.contains("hidden")&&window.innerWidth<768){be.classList.add("hidden"),ve&&ve.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():oe("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(o()){i(),history.pushState(null,document.title,location.href);return}const r=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(r).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="dashboard-section"?s():(oe("dashboard-section"),history.pushState(null,document.title,location.href))})))}function sa(t){return t?t.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function Kc(){try{await Oi(we,zi)}catch{}Ee.isNativePlatform()&&document.body.classList.add("is-app-native"),Yi(),Zc(),Qc(),go&&go.addEventListener("click",t=>{t.preventDefault();const e=document.documentElement.getAttribute("data-theme")||"light";ua(e==="dark"?"light":"dark")}),mo&&mo.addEventListener("click",t=>{t.stopPropagation(),be&&(be.classList.remove("hidden"),be.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),ve&&ve.classList.remove("hidden")}),ps&&ps.addEventListener("click",t=>{const e=t.target.closest(".bottom-nav-item");if(!e)return;t.preventDefault();const a=e.getAttribute("data-target");oe(a)}),ve&&ve.addEventListener("click",()=>{be&&(be.classList.add("hidden"),be.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),ve.classList.add("hidden")}),_a&&_a.addEventListener("click",t=>{t.stopPropagation(),Qe&&(Qe.classList.toggle("hidden"),Qe.classList.contains("hidden")||(Tt.forEach(e=>e.read=!0),ji()))}),Ce&&Ce.addEventListener("click",t=>{t.stopPropagation(),me&&(me.classList.toggle("active"),me.classList.contains("active")?me.classList.remove("hidden"):setTimeout(()=>me.classList.add("hidden"),200))}),bo&&bo.addEventListener("click",t=>{t.preventDefault(),oe("my-profile-section"),me&&(me.classList.remove("active"),me.classList.add("hidden"))}),window.addEventListener("userPhotoUpdated",t=>{const e=t.detail;Ce&&e&&(Ce.innerHTML=`<img src="${e}" alt="Avatar" class="w-full h-full rounded-full object-cover">`)}),document.addEventListener("click",t=>{Qe&&!Qe.contains(t.target)&&t.target!==_a&&Qe.classList.add("hidden"),me&&!me.contains(t.target)&&t.target!==Ce&&me.classList.contains("active")&&(me.classList.remove("active"),setTimeout(()=>me.classList.add("hidden"),200))}),_i(we,async t=>{if(t){if(!Ee.isNativePlatform()&&(Br(),"Notification"in window&&Notification.permission==="default")){const e=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");e&&setTimeout(()=>{e.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await jr()&&e&&(e.style.display="none")});const s=()=>{e&&(e.style.display="none")},i=document.getElementById("btn-deny-toast"),o=document.getElementById("btn-close-toast");i&&i.addEventListener("click",s),o&&o.addEventListener("click",s)}try{const a=(await t.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let s=null,i=t.displayName,o=null,r=null;const n=Be(xe,"users",t.uid),l=await bs(n);if(l.exists()){const u=l.data();s=a.role==="employee"?u.permissions||{}:null,i=u.name||i,o=u.professionalId||null,r=u.photo||null}if(g.userProfessionalId=o,o&&!r)try{const u=await ko(o);u&&u.photo&&(r=u.photo)}catch{}Ee.isNativePlatform()&&Yc(t.uid);const d=i||t.email;er(a.establishmentId,"Carregando...",s),r?Ce&&(Ce.innerHTML=`<img src="${r}" class="w-full h-full rounded-full object-cover">`):Ce&&(Ce.textContent=d.charAt(0).toUpperCase()),co&&(co.textContent=d),uo&&(uo.textContent=t.email),po&&po.addEventListener("click",u=>{u.preventDefault(),Pt&&Pt(),Vi(we).then(()=>window.location.href="/login.html")}),await Xc(a.establishmentId),br(oe,s,g.enabledModules),ue&&(ue.classList.add("fade-out"),setTimeout(()=>{ue.style.display="none"},500)),ft&&(ft.style.display="flex"),setTimeout(()=>{yr()},1500),oe("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(e){ue&&(ue.style.display="none"),ft&&(ft.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><i class="bi bi-x-circle text-5xl text-rose-500 mb-4"></i><h2 class="text-xl font-bold">Erro de Acesso</h2><p class="text-slate-500 mt-2">${e.message}</p></div>`,ft.style.display="flex")}}else window.location.href="/login.html"})}Kc();export{$o as W};
