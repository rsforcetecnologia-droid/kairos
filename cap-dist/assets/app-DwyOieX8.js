...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${s}:`,d),new Error(d)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${s}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${va}. Verifique se o servidor backend está rodando.`):i}}const Aa=(e,t,a,r=null)=>{let o=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return r&&(o+=`&professionalId=${r}`),I(o)},lr=({establishmentId:e,professionalId:t,serviceIds:a,date:r})=>{const o=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${r}`;return I(o)},dr=e=>I("/api/appointments",{method:"POST",body:JSON.stringify(e)}),cr=(e,t)=>I(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),ur=e=>I(`/api/appointments/${e}`,{method:"DELETE"}),pr=e=>I(`/api/appointments/${e}/reopen`,{method:"POST"}),mr=(e,t)=>I(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Q;async function gr(){if(!Q)try{Q=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function br(){if(!Q){console.warn("AudioContext não inicializado. O som não será tocado.");return}Q.state==="suspended"&&Q.resume();const e=Q.createOscillator(),t=Q.createGain();e.connect(t),t.connect(Q.destination),e.type="sine",e.frequency.setValueAtTime(800,Q.currentTime),t.gain.setValueAtTime(0,Q.currentTime),t.gain.linearRampToValueAtTime(.3,Q.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Q.currentTime+.2),e.start(Q.currentTime),e.stop(Q.currentTime+.2)}function g(e,t,a="info",r=!1){const o=document.getElementById("toast-container");if(!o)return;r&&br();const s=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},d={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${i[a]||i.info}`,s.innerHTML=`
    ...
    `}function Zr(e){const t=document.getElementById("revenueChart");if(!t)return;ca&&ca.destroy();const r=t.getContext("2d").createLinearGradient(0,0,0,240);r.addColorStop(0,"rgba(79, 70, 229, 0.15)"),r.addColorStop(1,"rgba(79, 70, 229, 0.01)"),ca=new Chart(t,{type:"line",data:{labels:e.labels,datasets:[{label:"Receita (R$)",data:e.data,borderColor:"#6366f1",backgroundColor:r,borderWidth:2.5,pointBackgroundColor:"#ffffff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointRadius:3,pointHoverRadius:5,fill:!0,tension:.35}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#1e293b",padding:12,cornerRadius:8,titleFont:{size:12,family:"Inter",weight:"normal"},bodyFont:{size:13,weight:"bold",family:"Inter"},displayColors:!1,callbacks:{label:function(o){return o.parsed.y!==null?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(o.parsed.y):""}}}},scales:{y:{beginAtZero:!0,grid:{color:"#f8fafc",drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:10},maxTicksLimit:6,callback:function(o){return"R$ "+o}}},x:{grid:{display:!1,drawBorder:!1},border:{display:!1},ticks:{color:"#94a3b8",font:{family:"Inter",size:11,weight:"500"}}}},interaction:{intersect:!1,mode:"index"}}})}function Kr(){document.getElementById("content").addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(!a)return;switch(a.dataset.action){case"goto-agenda":J("agenda-section");break;case"new-appointment":J("agenda-section");break;case"goto-pdv":J("comandas-section");break;case"goto-clients":J("clientes-section");break;case"open-link":const o=`${window.location.origin}/cliente.html?id=${p.establishmentId||""}`;window.open(o,"_blank");break}})}const Te=e=>I(`/api/services/${e}`),ei=e=>I("/api/services",{method:"POST",body:JSON.stringify(e)}),ti=(e,t)=>I(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),ai=e=>I(`/api/services/${e}`,{method:"DELETE"}),oi=(e,t)=>I(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),si=e=>I(`/api/services/stats/most-popular/${e}`),le=e=>I(`/api/professionals/${e}`),ri=e=>I(`/api/professionals/details/${e}`),ii=e=>I("/api/professionals",{method:"POST",body:JSON.stringify(e)}),ni=(e,t)=>I(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),os=e=>I(`/api/professionals/${e}`,{method:"DELETE"}),li=e=>{const t=e.map(a=>os(a));return Promise.all(t)},Zt=(e,t,a,r="all")=>{const o=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${r}`;return I(o)},Kt=e=>I("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Na=e=>I(`/api/blockages/${e}`,{method:"DELETE"}),ss=e=>I("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),ro=document.getElementById("content");let io=!1;const wa=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let ea=[],ka=[],Ft={},rs=[],P={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},A={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function ja(e){const t=new Date(e),a=t.getDay(),r=t.getDate()-a+(a===0?-6:1);return t.setDate(r),t.setHours(0,0,0,0),t}function Fa(){const e=document.getElementById("profSelectorContainer");if(!e||!p.professionals)return;let t=p.professionals.filter(o=>P.showInactiveProfs||o.status!=="inactive");const r=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=r.map(o=>{const s=P.selectedProfessionalId===o.id,i=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),n=o.id!=="all"?p.professionalColors.get(o.id)||wa[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            <div class="prof-pill ${s?"active":""}"
                ...
                <span>${_(o.name==="Todos"?"Todos":o.name.split(" ")[0])}</span>
            </div>`}).join("")}function _(e){return h(e||"")}function di(e,t,a,r,o){const s=(e||"").replace(/\D/g,""),i=new Date(o).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(o).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=`Olá, ${t}! Você tem um agendamento de ${a} com ${r} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${s}?text=${encodeURIComponent(d)}`}function ci(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],r=ja(P.currentDate),o=new Date;o.setHours(0,0,0,0);let s='<div class="week-container" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(r);n.setDate(r.getDate()+i);const d=n.toDateString()===o.toDateString(),l=e.filter(u=>new Date(u.startTime).toDateString()===n.toDateString()).sort((u,m)=>new Date(u.startTime)-new Date(m.startTime));let c="";l.length===0?c='<div class="week-empty"><i class="bi bi-dash-lg" style="font-size:1rem;display:block;margin-bottom:4px;"></i>Sem agendamentos</div>':c=l.map(u=>{const x=new Date(u.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),b=p.professionalColors.get(u.professionalId)||{main:"#adb5bd"},v=u.status==="completed",f=P.selectedItems.has(u.id);if(u.type==="blockage")return`<div class="week-event-chip week-blockage">
                    ...
                    </div>`;const E=JSON.stringify(u).replace(/'/g,"&apos;"),S=f?"box-shadow: 0 0 0 2px #4f46e5; background-color: #eff6ff;":"",k=P.isSelectionMode?`<div style="position:absolute; top:6px; right:6px; z-index:1;">
                    ...
                    <div class="we-client" style="${P.isSelectionMode?"padding-right:20px;":""}">${_(u.clientName)}</div>
            ...
            <div class="list-date-label">${o}</div>`,s.forEach(i=>{const n=new Date(i.startTime),d=new Date(i.endTime),l=Math.round((d-n)/6e4),c=n.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=p.professionalColors.get(i.professionalId)||{main:"#adb5bd"},m=i.status==="completed",x=JSON.stringify(i).replace(/'/g,"&apos;"),b=P.selectedItems.has(i.id),v=P.isSelectionMode?`<div style="display:flex; align-items:center; margin-right: 12px; margin-left: 4px;">
                ...
                </div>`;return}const E=di(i.clientPhone,i.clientName,i.serviceName,i.professionalName,i.startTime),S=(i.services||[]).reduce((q,H)=>q+(Number(H.price)||0),0)||Number(i.totalPrice||0)||Number(i.servicePrice||0),k=i.paymentStatus||(i.status==="completed"?"Finalizado":"Agendado"),T=_((i.professionalName||"").split(" ")[0]),L=(i.services||[]).length||(i.serviceName?1:0);r+=`<div class="list-card ${m?"completed":""}" style="${f}"
            ...
            </div>`}),r+="</div>"}),r+="</div>",t.innerHTML=r}function is(){const e=p.allEvents.filter(t=>P.selectedProfessionalId==="all"||t.professionalId===P.selectedProfessionalId);P.currentView==="list"?ui(e):ci(e),Ha()}function Ha(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(P.isSelectionMode&&P.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
            <span class="font-semibold text-sm"><span style="color:#7c3aed; font-size:1.1rem; margin-right:4px;">${P.selectedItems.size}</span> selecionados</span>
        ...
        </div>`,e.style.display="block",t&&(t.style.transform="scale(0)")):(e.style.display="none",t&&(t.style.transform="scale(1)")))}function pi(){const e=document.getElementById("currentDateDisplay");if(!e)return;const t=new Date;t.setHours(0,0,0,0);const a=new Date(P.currentDate);if(a.setHours(0,0,0,0),P.currentView==="list")a.toDateString()===t.toDateString()?e.textContent="Hoje":e.textContent=a.toLocaleDateString("pt-BR",{day:"numeric",month:"long"});else{const r=ja(a),o=new Date(r);o.setDate(r.getDate()+6);const s=r.toLocaleDateString("pt-BR",{day:"numeric",month:"short"}),i=o.toLocaleDateString("pt-BR",{day:"numeric",month:"short"});e.textContent=`${s} - ${i}`}}async function ve(){const e=document.getElementById("agenda-view");if(!e)return;P.selectedItems.clear(),Ha(),e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;padding:60px 0;"><div style="width:28px;height:28px;border:2.5px solid #e9ecef;border-top:2.5px solid #4f46e5;border-radius:50%;animation:spin 0.7s linear infinite;"></div></div><style>@keyframes spin{to{transform:rotate(360deg)}}</style>',pi();let t,a;if(P.currentView==="list")t=new Date(P.currentDate),t.setHours(0,0,0,0),a=new Date(t),a.setHours(23,59,59,999);else{const r=ja(P.currentDate);t=new Date(r),a=new Date(r),a.setDate(r.getDate()+6),a.setHours(23,59,59,999)}try{const o=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(async l=>{const[c,u]=await Promise.all([Aa(l,t.toISOString(),a.toISOString(),P.selectedProfessionalId==="all"?null:P.selectedProfessionalId),Zt(l,t.toISOString(),a.toISOString(),P.selectedProfessionalId)]);return{appts:c||[],blockages:u||[]}}),s=await Promise.all(o);let i=[],n=[];if(s.forEach(l=>{i=i.concat(l.appts),n=n.concat(l.blockages)}),!document.getElementById("agenda-view"))return;const d=l=>l.map(c=>({...c,type:c.type||"appointment",professionalName:c.professionalName||(()=>{const u=p.professionals?.find(m=>m.id===c.professionalId);return u?u.name:"Indefinido"})()}));p.allEvents=[...d(i),...d(n)],Fa(),is()}catch(r){console.error(r),document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12" style="color:#868e96;">
                    <i class="bi bi-exclamation-triangle" style="font-size:1.5rem;"></i>
                    <p class="mt-2" style="font-size:0.8rem;">Erro ao carregar agenda.</p>
                </div>`)}}async function mi(){try{const t=(p.selectedEstablishments&&p.selectedEstablishments.length>0?p.selectedEstablishments:[p.establishmentId]).map(async i=>{const[n,d,l]=await Promise.all([le(i),Te(i),Ce(i)]);return{profs:n||[],services:d||[],estDetails:l}}),a=await Promise.all(t),r=new Map,o=new Map;let s=a[0]?.estDetails;a.forEach(i=>{i.profs.forEach(n=>r.set(n.id,n)),i.services.forEach(n=>o.set(n.id,n))}),p.professionals=Array.from(r.values()),p.services=Array.from(o.values()),rs=[],s&&(Ft=s.loyaltyProgram||{enabled:!1}),p.professionals.forEach((i,n)=>{p.professionalColors.set(i.id,wa[n%wa.length])}),Fa()}catch{g("Atenção","Não foi possível carregar os dados da equipa.","error")}}async function ns(e={}){P.currentDate=e.targetDate?new Date(e.targetDate):P.currentDate||new Date,P.isSelectionMode=!1,P.selectedItems.clear(),ro.innerHTML=`
            ...
            <div style="background: #fff; padding: 14px 16px; border-bottom: 1px solid #f1f3f5; position: sticky; top: 0; z-index: 10; display:flex; flex-direction:column; gap:16px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div class="agenda-view-toggle" style="background: #f1f3f5; padding: 4px; border-radius: 12px; display:flex; gap:4px; margin:0;">
                        <button class="${P.currentView==="list"?"active shadow-sm":""}" data-action="setView" data-view="list" style="border-radius: 8px; padding: 6px 16px; font-weight:600;">Lista</button>
                        <button class="${P.currentView==="week"?"active shadow-sm":""}" data-action="setView" data-view="week" style="border-radius: 8px; padding: 6px 16px; font-weight:600;">Semana</button>
                    </div>
        ...
        </div>`,document.getElementById("btnPrevDate").addEventListener("click",()=>{P.currentView==="list"?P.currentDate.setDate(P.currentDate.getDate()-1):P.currentDate.setDate(P.currentDate.getDate()-7),ve()}),document.getElementById("btnNextDate").addEventListener("click",()=>{P.currentView==="list"?P.currentDate.setDate(P.currentDate.getDate()+1):P.currentDate.setDate(P.currentDate.getDate()+7),ve()}),document.getElementById("btnTodayHeader").addEventListener("click",()=>{P.currentDate=new Date,ve()});const t=document.querySelectorAll(".agenda-view-toggle button");t.forEach(a=>{a.addEventListener("click",()=>{t.forEach(r=>{r.classList.remove("active","shadow-sm"),r.style.backgroundColor="transparent"}),a.classList.add("active","shadow-sm"),a.style.backgroundColor="#fff",P.currentView=a.dataset.view,ve()})}),document.getElementById("btnWeekDays").addEventListener("click",()=>{gi()}),io||(ro.addEventListener("click",async a=>{const r=a.target.closest('[data-action="open-comanda"]');if(r){a.stopPropagation();const d=r.dataset.appointment||r.closest("[data-appointment]")?.dataset.appointment;if(!d)return;const l=JSON.parse(d.replace(/&apos;/g,"'")),c=l.status==="completed"?"finalizadas":"em-atendimento",u={selectedAppointmentId:l.id,initialFilter:c};c==="finalizadas"&&l.transaction?.paidAt&&(u.filterDate=typeof l.transaction.paidAt=="object"?new Date(l.transaction.paidAt._seconds*1e3):l.transaction.paidAt),J("comandas-section",u);return}const o=a.target.closest(".lc-action-btn.wa");if(o){a.stopPropagation(),o.dataset.link&&window.open(o.dataset.link,"_blank");return}if(a.target.closest('[data-action="batch-delete"]')){const d=P.selectedItems.size;await W("Excluir Selecionados",`Tem certeza que deseja excluir ${d} agendamento(s)? Esta ação não pode ser desfeita.`)&&(await Promise.all(Array.from(P.selectedItems).map(async c=>{try{await ur(c)}catch{}})),g(`${d} agendamento(s) excluído(s).`,"success"),P.selectedItems.clear(),P.isSelectionMode=!1,ve());return}const s=a.target.closest('[data-action="select-professional"]');if(s){const d=s.dataset.profId;P.selectedProfessionalId=P.selectedProfessionalId===d&&d!=="all"?"all":d,ve();return}const i=a.target.closest(".list-card[data-appointment], .week-event-chip[data-appointment]");if(i){if(P.isSelectionMode){a.stopPropagation();const l=i.querySelector('input[type="checkbox"]');if(l){const c=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'")),u=!l.checked;l.checked=u,u?P.selectedItems.add(c.id):P.selectedItems.delete(c.id),(i.classList.contains("week-event-chip")||i.classList.contains("list-card"))&&(u?(i.style.boxShadow="0 0 0 2px #4f46e5",i.style.backgroundColor="#eff6ff"):(i.style.boxShadow="none",i.style.backgroundColor=i.classList.contains("week-event-chip")?"#f8f9fa":"#fff")),Ha()}return}const d=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"));Sa(d);return}if(a.target.closest('[data-action="new-appointment"]')){Sa();return}}),io=!0),await mi(),await ve()}function gi(){const e=document.getElementById("optionsSheet");if(e){e.remove();return}const t=document.createElement("div");t.id="optionsSheet",t.style.cssText="position:fixed;bottom:0;left:50%;right:auto;transform:translateX(-50%) translateY(100%);width:100%;max-width:440px;background:#fff;border-radius:24px 24px 0 0;z-index:10000;box-shadow:0 -8px 40px rgba(0,0,0,0.15);transition:transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);";const a=P.isSelectionMode?"#fee2e2":"#f0fdf4",r=P.isSelectionMode?"#ef4444":"#16a34a",o=P.isSelectionMode?"bi-x-circle":"bi-check2-square";t.innerHTML=`
        <div style="padding:20px 24px;">
            ...
            <div style="margin-bottom:20px;">
                ...
                <button id="optSelectMode" style="width:100%;padding:12px 16px;border:none;background:${a};border-radius:12px;font-size:0.9rem;font-weight:600;color:${r};cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:background 0.2s;">
                    <i class="bi ${o}"></i> ${P.isSelectionMode?"Desativar Modo de Exclusão":"Ativar Seleção para Excluir"}
                </button>
                <p style="font-size:0.75rem; color:#6b7280; text-align:center; margin-top:8px;">${P.isSelectionMode?"Toque num card para desmarcar.":"Permite selecionar vários agendamentos para apagar de uma vez."}</p>
            </div>
    ...
    `,oa(),aa()}function aa(){document.querySelectorAll(".filter-btn").forEach(a=>{a.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),a.classList.add("bg-white","text-gray-600","border-gray-200")});const e=document.querySelector(`[data-filter="${y.activeFilter}"]`);e&&(e.classList.remove("bg-white","text-gray-600","border-gray-200"),e.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"));const t=document.getElementById("finalizadas-datepicker");t&&t.classList.toggle("hidden",!y.showHistoryDate)}function oa(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `,t&&(t.innerHTML="");return}let a=y.allComandas||[];if(y.activeFilter==="abertas"?a=a.filter(o=>o.status!=="completed"):y.activeFilter==="pagas"&&(a=a.filter(o=>o.status==="completed")),Hi(),a.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada para este filtro.</p>',po(t);return}const r=document.createDocumentFragment();a.forEach(o=>{const s=ye(o);let i=0;o.status==="completed"&&o.totalAmount!==void 0&&o.totalAmount!==null?i=Number(o.totalAmount):i=s.reduce((T,L)=>T+Number(L.price||0),0);const d=o.loyaltyRedemption||o.discount&&o.discount.reason&&String(o.discount.reason).toLowerCase().includes("fidelidade")?'<span class="inline-flex items-center justify-center bg-yellow-100 text-yellow-700 rounded-full w-5 h-5 ml-2" title="Prémio Resgatado">🎁</span>':"",l=o.id===y.selectedComandaId,c=new Date(o.startTime),u=c.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),m=c.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),x=`${u} às ${m}`,b=o.type==="walk-in"||typeof o.id=="string"&&o.id.startsWith("temp-"),v=o.status==="completed",f=h(o.clientName||"Cliente sem nome"),E=h(o.professionalName||"Sem profissional");let S="";v?S='<span class="text-[10px] font-bold uppercase text-green-700 bg-green-100 px-2 py-0.5 rounded-md border border-green-200">Paga</span>':b?S='<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulsa</span>':S='<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>';const k=document.createElement("div");k.className=`comanda-card cursor-pointer ${l?"selected":""}`,k.dataset.action="select-comanda",k.dataset.comandaId=o.id,k.innerHTML=`
        ...
        `,r.appendChild(k)}),e.innerHTML="",e.appendChild(r),po(t)}function po(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:r}=y.paging,o=Math.ceil((a||0)/r);if(o===0)return;const s=document.createElement("div");s.className="flex gap-2 justify-center items-center w-full",s.innerHTML=`
    ...
    `,e.appendChild(s),s.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const d=parseInt(i.dataset.page,10);d>0&&d<=o&&(y.paging.page=d,de())}})}function X(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(v=>v.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){Vi(t,e);return}const a=`
    ...
    `;e.innerHTML=`
        ...
        ${o?"":b}
    `,!o&&(t.clientId||t.clientName)&&_i(t,e.querySelector("#loyalty-container"))}function Vi(e,t){const r=ye(e).reduce((m,x)=>m+Number(x.price||0)*(x.quantity||1),0),o=y.checkoutState,s=o.discount||{type:"real",value:0};let i=0;s.type==="percent"?i=r*s.value/100:i=s.value,i>r&&(i=r);const n=r-i,d=o.payments.reduce((m,x)=>m+x.value,0),l=Math.max(0,n-d);(!o.amountReceived||l>0)&&(o.amountReceived=l.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;const u=()=>{const m=y.checkoutState.discount.type,x=y.checkoutState.discount.value;let b=m==="percent"?r*x/100:x;b>r&&(b=r);const v=r-b,f=y.checkoutState.payments.reduce((L,q)=>L+q.value,0),E=Math.max(0,v-f),S=t.querySelector("#checkout-total-display");S&&(S.textContent=`R$ ${v.toFixed(2)}`);const k=t.querySelector("#checkout-status-msg");k&&(E<=.01?k.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':k.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${E.toFixed(2)}</span></p>`);const T=t.querySelector("#checkout-amount");T&&E>0&&document.activeElement!==T&&(T.value=E.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",m=>{const x=parseFloat(m.target.value)||0;y.checkoutState.discount.value=x,u()}),t.querySelector("#discount-type")?.addEventListener("change",m=>{y.checkoutState.discount.type=m.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",m=>{y.checkoutState.discountReason=m.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",m=>{y.checkoutState.amountReceived=m.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",m=>{y.checkoutState.installments=parseInt(m.target.value,10)})}async function _i(e,t){if(!t)return;const a=y.loyaltySettings;if(!a||!a.enabled)return;let r=null;try{if(e.clientId)r=await Zo(p.establishmentId,e.clientId);else if(e.clientName){const n=await Xt(p.establishmentId,e.clientName,1);n&&n.length>0&&(r=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!r||r.loyaltyPoints===void 0)return;const o=Number(r.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const d=Number(n.costPoints||n.points||0);return d>0&&o>=d});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-2 max-h-96 overflow-y-auto custom-scrollbar">
                ${e.map(s=>{const i=s.costPoints||s.points||0,n=s.name||s.reward,d=s.type||"money",l=s.discount?parseFloat(s.discount).toFixed(2):"0.00";let c="",u="bg-gray-100 text-gray-600";switch(d){case"service":c="Serviço",u="bg-indigo-100 text-indigo-700";break;case"product":c="Produto",u="bg-green-100 text-green-700";break;case"package":c="Pacote",u="bg-purple-100 text-purple-700";break;case"money":default:c="Valor Livre",u="bg-yellow-100 text-yellow-700";break}return`
    ...
    `,{modalElement:r,close:o}=ne({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});r.addEventListener("click",s=>{const i=s.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,d=e.find(l=>l.id&&l.id==n||(l.name||l.reward)==n);d&&(Wi(d,t),o())}})}async function Wi(e,t){const a=Number(e.costPoints||e.points||0),r=e.name||e.reward,o=e.type||"money";if(o==="money"){const d=parseFloat(e.discount)||0;if(d<=0){g("Erro","O valor do desconto configurado é inválido.","error");return}y.checkoutState.discount={type:"real",value:d},y.checkoutState.discountReason=`Resgate Fidelidade: ${r}`,y.pendingRedemption={rewardId:e.id||null,name:r,cost:a,type:"money"},g("Sucesso",`Prémio "${r}" resgatado! Desconto de R$ ${d.toFixed(2)} aplicado.`,"success"),X();return}const s=ye(t),i=e.itemId?String(e.itemId):null;if(!i){g("Erro de Configuração",`O prémio "${r}" não tem um item vinculado nas configurações.`,"error");return}const n=s.find(d=>{const l=d.id?String(d.id):null,c=d.serviceId?String(d.serviceId):d.service_id?String(d.service_id):null,u=d.productId?String(d.productId):d.product_id?String(d.product_id):null;return o==="service"?l===i||c===i:o==="product"?l===i||u===i:o==="package"?l===i:!1});if(n){let d=parseFloat(e.discount);(!d||d<=0)&&(d=parseFloat(n.price||0)),y.checkoutState.discount={type:"real",value:d},y.checkoutState.discountReason=`Resgate Fidelidade: ${r}`,y.pendingRedemption={rewardId:e.id||null,name:r,cost:a,type:o,appliedToItemId:n.id},g("Sucesso",`Prémio "${r}" resgatado! Item encontrado e desconto de R$ ${d.toFixed(2)} aplicado.`,"success"),X()}else g("Item Não Encontrado",`Para resgatar o prémio "${r}", o ${o==="service"?"serviço":o==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function Ji(){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=ne({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const o=e.querySelector("#add-item-content");o.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,n())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,n()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await cs(o,s),t()}};e.addEventListener("click",o=>{const s=o.target.closest('[data-action="select-item-for-quantity"]'),i=o.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:n,itemId:d}=s.dataset,c=(y.catalog[n+"s"]||[]).find(u=>u.id===d);c&&r({...c,type:n})}else i&&a()}),a()}async function $a(e=null){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!p.professionals||p.professionals.length===0)try{p.professionals=await le(p.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,{modalElement:r}=ne({title:"Nova Venda Avulsa",contentHTML:a,maxWidth:"max-w-md"}),o=r.querySelector("#client-search"),s=r.querySelector("#client-suggestions"),i=r.querySelector("#selected-client-id");e&&(i.value=e.id,o.value=`${e.name} (${e.phone||"Sem tel"})`,o.classList.add("bg-green-50","border-green-300","text-green-800")),o.addEventListener("input",ls(async d=>{const l=d.target.value.trim();if(i.value="",o.classList.remove("bg-green-50","border-green-300","text-green-800"),l.length<2){s.classList.add("hidden");return}try{s.innerHTML='<li class="p-2 text-xs text-gray-500">Buscando...</li>',s.classList.remove("hidden");const c=await Xt(p.establishmentId,l,10);c.length===0?s.innerHTML='<li class="p-2 text-xs text-gray-500">Nenhum cliente encontrado</li>':s.innerHTML=c.map(u=>`<li data-client-id="${u.id}" data-client-name="${u.name}" data-client-phone="${u.phone}" class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 transition-colors"><div class="font-bold text-sm text-gray-800">${h(u.name)}</div><div class="text-xs text-gray-500">${u.phone||"Sem telefone"}</div></li>`).join("")}catch{s.classList.add("hidden")}},400)),s.addEventListener("click",d=>{const l=d.target.closest("li[data-client-id]");l&&(i.value=l.dataset.clientId,i.dataset.name=l.dataset.clientName,i.dataset.phone=l.dataset.clientPhone,o.value=`${l.dataset.clientName}`,o.classList.add("bg-green-50","border-green-300","text-green-800"),s.classList.add("hidden"))}),document.addEventListener("click",d=>{!o.contains(d.target)&&!s.contains(d.target)&&s.classList.add("hidden")}),r.querySelector("#new-sale-form").addEventListener("submit",en);const n=r.querySelector('[data-action="new-client-from-sale"]');n&&n.addEventListener("click",d=>{d.preventDefault(),r.style.display="none",Gi()})}function Gi(){ne({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,{modalElement:t}=ne({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const r=parseFloat(document.getElementById("initial-amount").value);if(isNaN(r)||r<0)return g("Valor Inválido","Insira um valor válido.","error");try{const o=await Pi({establishmentId:p.establishmentId,initialAmount:parseFloat(r.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=o.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${r.toFixed(2)})`,"success"),oa(),await de()}catch(o){g("Erro",`Falha ao abrir caixa: ${o.message}`,"error")}})}async function Xi(){const e=y.activeCashierSessionId;if(e)try{const t=await qi(e),a=`
        ...
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await fn();const[e,t,a]=await Promise.all([le(p.establishmentId),_r(p.establishmentId).catch(()=>[]),ra(p.establishmentId).catch(()=>[])]);M.professionalsList=e||[],M.costCentersList=t||[],M.naturesList=a||[],hn(),await vs()}catch(e){console.error("Erro no loadReportsPage:",e),Ea.innerHTML=`
            ...
            </div>`}}function hn(){const e=M.professionalsList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join(""),t=M.costCentersList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join("");Ea.innerHTML=`
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex-1 min-w-0 mr-2">
                            ...
                            <p class="text-[10px] md:text-xs text-gray-500 mt-0.5 ml-1 truncate" id="date-range-display">
                                ${Ht(M.startDate)} até ${Ht(M.endDate)}
                            </p>
                        </div>
    ...
    `,document.getElementById("toggle-filters-btn").onclick=go,document.getElementById("btn-apply-filters").onclick=()=>{vn(),go()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{M.currentTab=a.dataset.tab,bo(),ys(),window.scrollTo({top:0,behavior:"smooth"})}}),bo()}function go(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");M.isFilterOpen=!M.isFilterOpen,M.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function bo(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===M.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Ht(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function vn(){M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.selectedProfessional=document.getElementById("report-prof").value,M.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Ht(M.startDate)} até ${Ht(M.endDate)}`,await vs()}function yn(e,t){const a=new Map;M.naturesList.forEach(o=>a.set(o.id,o.name));const r={revenues:{},expenses:{},totalRevenues:0,totalExpenses:0,netResult:0};return t.forEach(o=>{if(o.status==="paid"){const s=o.naturezaId?a.get(o.naturezaId)||"Outras Receitas":"Geral";r.revenues[s]||(r.revenues[s]=0),r.revenues[s]+=o.amount,r.totalRevenues+=o.amount}}),e.forEach(o=>{if(o.status==="paid"){const s=o.naturezaId?a.get(o.naturezaId)||"Outras Despesas":"Geral";r.expenses[s]||(r.expenses[s]=0),r.expenses[s]+=o.amount,r.totalExpenses+=o.amount}}),r.netResult=r.totalRevenues-r.totalExpenses,r}function wn(e,t){const a={},r=l=>{a[l]||(a[l]={realizedCredit:0,provisionedCredit:0,realizedDebit:0,provisionedDebit:0})};let o=new Date(M.startDate);const s=new Date(M.endDate);for(;o<=s;)r(o.toISOString().split("T")[0]),o.setDate(o.getDate()+1);t.forEach(l=>{const c=l.dueDate.split("T")[0];a[c]&&(l.status==="paid"?a[c].realizedCredit+=l.amount:a[c].provisionedCredit+=l.amount)}),e.forEach(l=>{const c=l.dueDate.split("T")[0];a[c]&&(l.status==="paid"?a[c].realizedDebit+=l.amount:a[c].provisionedDebit+=l.amount)});const i=Object.keys(a).sort(),n=[];let d=0;return i.forEach(l=>{const c=a[l],u=c.realizedCredit+c.provisionedCredit-(c.realizedDebit+c.provisionedDebit);d+=u,n.push(d)}),{labels:i,realizedCredit:i.map(l=>a[l].realizedCredit),provisionedCredit:i.map(l=>a[l].provisionedCredit),realizedDebit:i.map(l=>a[l].realizedDebit*-1),provisionedDebit:i.map(l=>a[l].provisionedDebit*-1),balance:n}}function kn(e){const t={};let a=new Date(M.startDate);const r=new Date(M.endDate);for(;a<=r;)t[a.toISOString().split("T")[0]]=0,a.setDate(a.getDate()+1);e.forEach(i=>{if(i.status==="paid"){const n=i.dueDate.split("T")[0];t.hasOwnProperty(n)&&(t[n]+=i.amount)}});const o=Object.keys(t).sort(),s=o.map(i=>t[i]);return{labels:o,data:s}}function Sn(e){const t=e.length;if(t<2)return{trendData:Array(t).fill(e[0]||0),color:"#9ca3af"};let a=0,r=0,o=0,s=0;for(let c=0;c<t;c++)a+=c,r+=e[c],o+=c*e[c],s+=c*c;const i=(t*o-a*r)/(t*s-a*a),n=(r-i*a)/t,d=[];for(let c=0;c<t;c++)d.push(i*c+n);const l=i>=0?"#10b981":"#ef4444";return{trendData:d,color:l}}async function vs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20 w-full"><div class="loader border-t-indigo-600"></div></div>';try{const t={startDate:M.startDate,endDate:M.endDate,establishmentId:p.establishmentId};M.selectedCostCenter!=="all"&&(t.costCenterId=M.selectedCostCenter);const[a,r]=await Promise.all([xs(t),hs(t)]);M.rawPayables=a.entries||[],M.rawReceivables=r.entries||[];const o=await Vr(M.startDate,M.endDate,M.selectedProfessional,M.selectedCostCenter).catch(()=>({charts:{professionals:{labels:[],data:[]},salesMonthly:{labels:[],data:[]}}}));M.backendData=o,M.processedDRE=yn(M.rawPayables,M.rawReceivables),M.processedCashFlow=wn(M.rawPayables,M.rawReceivables),M.processedDailyRevenue=kn(M.rawReceivables);const s=new Date(M.startDate+"T00:00:00").toISOString(),i=new Date(M.endDate+"T23:59:59").toISOString(),n=M.selectedProfessional==="all"?null:M.selectedProfessional,d=await Aa(p.establishmentId,s,i,n).catch(()=>[]);M.appointmentsData=Array.isArray(d)?d:[],ys()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ys(){const e=document.getElementById("report-content");switch(M.currentTab){case"dashboards":$n(e);break;case"appointments":En(e);break;case"dre":In(e);break}}function $n(e){const t=M.processedDRE,a=M.processedDailyRevenue,r=M.backendData.charts?.salesMonthly||{labels:[],data:[]},o=M.backendData.charts?.professionals||{labels:[],data:[]};e.innerHTML=`
    ...
    `,Ln("chart-cashflow-modern",M.processedCashFlow),fo("chart-daily-revenue","Receita Diária",a.labels.map(s=>s.split("-").reverse().slice(0,2).join("/")),a.data),fo("chart-monthly","Receita Mensal",r.labels,r.data),Dn("chart-profs","doughnut","Total Vendas",o.labels,o.data,bn),document.querySelectorAll(".chart-toggle").forEach(s=>{s.addEventListener("change",i=>{const n=oe["chart-cashflow-modern"];if(n){const d=parseInt(i.target.dataset.dataset);n.setDatasetVisibility(d,i.target.checked),n.update()}})})}function En(e){const t=M.appointmentsData,a=t.length;let r=0,o=0,s=0;const i={},n={};let d=new Date(M.startDate);const l=new Date(M.endDate);for(;d<=l;)i[d.toISOString().split("T")[0]]={active:0,cancelled:0},d.setDate(d.getDate()+1);t.forEach(b=>{const v=parseFloat(b.totalAmount||b.price||0),f=(b.status||"").toLowerCase();let E="";if(b.startTime){const k=b.startTime.toDate?b.startTime.toDate():new Date(b.startTime);isNaN(k)||(E=k.toISOString().split("T")[0])}const S=b.professionalName||"Sem Profissional";n[S]||(n[S]={name:S,count:0,value:0}),["cancelled","cancelado","no-show","cancelada"].includes(f)?(o++,E&&i[E]&&i[E].cancelled++):(["completed","finalized","paid"].includes(f)&&r++,s+=v,E&&i[E]&&i[E].active++,n[S].count++,n[S].value+=v)});const c=Object.keys(i).sort(),u=c.map(b=>i[b].active),m=c.map(b=>i[b].cancelled),x=Object.values(n).sort((b,v)=>v.value-b.value);e.innerHTML=`
    ...
    `,Cn("chart-appointments-daily",c,u,m),document.querySelectorAll(".app-chart-toggle").forEach(b=>{b.addEventListener("change",v=>{const f=oe["chart-appointments-daily"];if(f){const E=parseInt(v.target.dataset.dataset);f.setDatasetVisibility(E,v.target.checked),f.update()}})})}function In(e){const t=M.processedDRE;if(!t)return;const a=t.totalRevenues,r=(n,d,l,c=!1)=>{const u=a>0?d/a*100:0,m=c?"- ":"";return`
        ...
        </div>`},o=Object.entries(t.revenues).map(([n,d])=>r(n,d,"text-emerald-600",!1)).join(""),s=Object.entries(t.expenses).map(([n,d])=>r(n,d,"text-red-500",!0)).join(""),i=t.netResult>=0?"Lucro Real":"Prejuízo Real";e.innerHTML=`
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Bn),t.addEventListener("click",r=>{const o=r.target.closest('button[data-action="delete-category"]');o&&(r.preventDefault(),Pn(o.dataset.id))}))}Va()}function An(e=[]){if(!it||it.length===0)return`
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const s=e.includes(o.id)||e.length===0&&o.id===p.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}async function qn(e){e.preventDefault();const t=e.target.closest("#serviceModal"),a=t.querySelector("#serviceId").value,r={},o=t.querySelector('input[name="commissionType"]:checked').value;o==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(d=>{const l=d.dataset.profId;if(d.querySelector('input[type="checkbox"]').checked){const u=parseFloat(d.querySelector('input[type="number"]').value);r[l]=isNaN(u)?0:u}});const s=Array.from(t.querySelectorAll('input[name="accessibleIn"]:checked')).map(d=>d.value),i=s.length>0?s:[p.establishmentId],n={establishmentId:p.establishmentId,accessibleIn:i,name:t.querySelector("#serviceName").value.trim(),price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:o,professionalCommissions:r};try{a?(await ti(a,n),me(p.establishmentId,Ge(),"Serviços","Editou",`Editou o serviço: ${n.name}`)):(await ei(n),me(p.establishmentId,Ge(),"Serviços","Criou",`Criou novo serviço: ${n.name}`)),document.getElementById("serviceModal").style.display="none",g("Sucesso",`Serviço ${a?"atualizado":"adicionado"} com sucesso!`,"success"),await ht()}catch(d){g("Erro",d.message,"error")}}function xo(e=null){const t=document.getElementById("serviceModal"),a=p.serviceCategories||[],r=e?.duration||0,o=e?.bufferTime||0,s=h(e?.name||""),i=h(e?.notes||""),n=e?s:"Novo Serviço",d=a.map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${h(T.name)}</option>`).join("");t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[85vh] my-auto">
        <form id="serviceForm">
            ...
            `}).join(""),v.querySelectorAll('input[type="checkbox"]').forEach(T=>{T.addEventListener("change",L=>{const q=L.target.closest(".professional-commission-row");q.querySelector('input[type="number"]').disabled=!L.target.checked,q.classList.toggle("bg-blue-50",L.target.checked)})})),b();const f=t.querySelector("#serviceForm"),E=t.querySelector("#servicePhotoInput"),S=t.querySelector("#servicePhotoPreview"),k=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>E.click()),E.onchange=async()=>{const T=E.files[0];if(T){S.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const L=await as(T,800,800,.8);if(L.length*3/4>1e3*1024)throw new Error("Imagem muito grande.");S.src=L,k.value=L}catch(L){g("Erro de Imagem",L.message,"error"),S.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",k.value=e?.photo||""}}},f.addEventListener("submit",qn)}function nt(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",r=new Map((p.serviceCategories||[]).map(s=>[s.id,s.name]));let o=(p.services||[]).filter(Boolean);if(Ie!=="all"){const s=Ie==="active";o=o.filter(i=>i.active!==!1===s)}o=o.filter(s=>{const i=s.name.toLowerCase().includes(t),n=a==="all"||s.categoryId===a;return i&&n}),e.innerHTML="",o.length>0?o.forEach(s=>{const i=document.createElement("div"),n=JSON.stringify(s).replace(/'/g,"&apos;");i.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:border-indigo-300 border border-transparent ${s.active!==!1?"opacity-100":"opacity-60 bg-gray-100"} sm:flex-col`,i.dataset.action="edit-service",i.dataset.service=n;const d=h(s.name),l=h(r.get(s.categoryId)||"Sem Categoria"),c=s.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(s.name.charAt(0))}`;i.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),_a(),nt()}function Nn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ht(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,r,o,s]=await Promise.all([Te(p.establishmentId),le(p.establishmentId),ia(p.establishmentId,"services"),si(p.establishmentId),Xe()]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(r||[]).filter(Boolean),p.mostPopularService=o||{name:"N/A",count:0},it=s?.matrizes||[],p.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),Ss(rt)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function Ss(e){if(document.getElementById("services-content-container")){if(rt===e&&document.getElementById("services-content-container").children.length>1){rt==="services"&&(_a(),nt());return}rt=e,Ie="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Rn():e==="reports"&&Nn()}}function jn(){xe&&(Se.removeEventListener("click",xe),Se.removeEventListener("input",xe),Se.removeEventListener("change",xe)),xe=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const o=t.closest('[data-action="toggle-service-status"]'),s=o.dataset.id,i=o.checked;try{await oi(s,i);const n=p.services.findIndex(d=>d.id===s);n>-1&&(p.services[n].active=i),me(p.establishmentId,Ge(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${i?"Ativo":"Inativo"}`),nt(),_a()}catch(n){g("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),o.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){nt();return}if(!a)return;if(a.hasAttribute("data-view")){Ss(a.dataset.view);return}switch(a.dataset.action){case"new-service":xo();break;case"edit-service":const o=JSON.parse(a.dataset.service);xo(o);break;case"manage-categories":Mn();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;Ie=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,l=n===Ie||n==="total"&&Ie==="all";i.classList.toggle("ring-2",l),i.classList.toggle("ring-indigo-500",l),i.classList.toggle("shadow-md",l),i.classList.toggle("bg-white",!l)}),nt();break}},Se.addEventListener("click",xe),Se.addEventListener("input",xe),Se.addEventListener("change",xe)}async function Fn(){Se.innerHTML=`
        ...
        </div>`,jn(),rt="services",Ie="all",await ht()}const na="suppliers",Ua=async e=>{try{const t=Wo(Yt(be,na),Jo("establishmentId","==",e)),a=await Ks(t),r=[];return a.forEach(o=>{r.push({id:o.id,...o.data()})}),r}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Hn=async e=>{try{return{id:(await Uo(Yt(be,na),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},On=async(e,t)=>{try{const a=xt(be,na,e);return await Ma(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},zn=async e=>{try{const t=xt(be,na,e);return await er(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},ke=document.getElementById("content");let he=null,lt="products",ge="all";async function Vn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),r=a.value;if(r)try{await ws({establishmentId:p.establishmentId,name:r},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Wa(),await vt()}catch(o){g("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function _n(e){if(await W("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ks(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Wa(),await vt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Wa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await ia(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${h(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",Vn),t.addEventListener("click",r=>{const o=r.target.closest('button[data-action="delete-category"]');o&&_n(o.dataset.id)}))}Wa()}async function Wn(e){if(!e)return;if(await W("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await Ci(e),g("Sucesso","Produto apagado com sucesso!","success"),await vt()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function Jn(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),r=parseInt(e.querySelector("#productMinStock").value),o=parseInt(e.querySelector("#productMaxStock").value),s=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),i=Array.from(s).map(d=>d.dataset.id),n={establishmentId:p.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(r)?0:r,maxStock:isNaN(o)?0:o,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:i};try{t?await Li(t,n):await Ii(n),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await vt()}catch(d){throw new Error(d.message)}}function ho(e,t=800,a=800,r="image/jpeg",o=.8){return new Promise((s,i)=>{if(!e.type.startsWith("image/"))return i(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.onload=d=>{const l=new Image;l.onload=()=>{let c=l.width,u=l.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const m=document.createElement("canvas");m.width=c,m.height=u,m.getContext("2d").drawImage(l,0,0,c,u);const b=m.toDataURL(r,o);s(b)},l.onerror=c=>i(new Error("Não foi possível carregar a imagem.")),l.src=d.target.result},n.onerror=d=>i(new Error("Não foi possível ler o ficheiro.")),n.readAsDataURL(e)})}function vo(e=null){const t=document.getElementById("productModal"),a=p.categories||[],r=p.suppliers||[],o=a.map(B=>`<option value="${B.id}" ${e?.categoryId===B.id?"selected":""}>${h(B.name)}</option>`).join("");let s=new Set(e?.supplierIds||[]);const i=h(e?.name||""),n=e?.price||"",d=e?.costPrice||"",l=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,m=e?.currentStock||0,x=e?i:"Novo Produto";t.innerHTML=`
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                <div class="flex flex-col-reverse sm:flex-row w-full sm:w-auto gap-3">
                    ...
                    <div class="p-2 hover:bg-indigo-50 cursor-pointer border-b last:border-0 text-sm flex justify-between items-center" data-add-supplier="${N.id}">
                        <span class="font-medium">${h(N.name)}</span>
                        <span class="text-indigo-600 text-xs">+ Adicionar</span>
                    </div>
                `).join("")):(D.classList.remove("hidden"),D.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else D.classList.add("hidden");s.size>0?(R.innerHTML="",s.forEach(z=>{const N=r.find(C=>C.id===z);N&&(R.innerHTML+=`
                        <div class="selected-supplier-item flex items-center justify-between bg-white border p-2 rounded shadow-sm" data-id="${N.id}">
                            <div class="text-sm">
                                <p class="font-bold text-gray-800">${h(N.name)}</p>
                                <p class="text-xs text-gray-500">${h(N.contactName||"")} - ${h(N.phone||"")}</p>
                            </div>
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};k.querySelector("#modalSupplierSearch").addEventListener("input",T),k.addEventListener("click",B=>{const D=B.target.closest("[data-add-supplier]");if(D){const O=D.dataset.addSupplier;s.add(O),k.querySelector("#modalSupplierSearch").value="",T()}const R=B.target.closest("[data-remove-supplier]");if(R){const O=R.dataset.removeSupplier;s.delete(O),T()}}),T(),k.addEventListener("click",async B=>{const D=B.target.closest("button[data-action]");if(!D)return;const R=D.dataset.action,O=k.querySelector("#productId").value;if(R==="close-modal"&&(k.style.display="none"),R==="delete-product"){if(!O)return;k.style.display="none",await Wn(O)}if(R==="save-product-modal"){const z=k.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const N=D.closest('button[data-action="save-product-modal"]');N.disabled=!0,N.textContent="A salvar...";try{await Jn(z)}catch(C){g("Erro",`Falha ao salvar: ${C.message}`,"error"),N.disabled=!1,N.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){B.preventDefault();const z=k.querySelector("#stockAdjustmentAmount"),N=k.querySelector("#stockAdjustmentReason"),C=parseInt(z.value,10),V=parseInt(D.dataset.change,10);if(!C||C<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Z=C*V,se=N.value||(Z>0?"Entrada manual":"Saída manual");try{await Di(O,{change:Z,reason:se});const Be=p.products.findIndex(we=>we.id===O);if(Be>-1){const we=p.products[Be].currentStock+Z;p.products[Be].currentStock=we,k.querySelector("#currentStockDisplay").textContent=we,k.querySelector("#productCurrentStock").value=we,z.value="",N.value="",g("Sucesso","Estoque atualizado!","success"),Ja(),bt()}}catch(Be){g("Erro de Stock",Be.message,"error")}}});const L=k.querySelectorAll(".tab-btn"),q=k.querySelectorAll(".tab-content");L.forEach(B=>{B.addEventListener("click",D=>{D.preventDefault(),L.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),B.classList.add("border-indigo-500","text-indigo-600"),B.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),q.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${B.dataset.tab}`).classList.remove("hidden")})});const H=k.querySelector("#productPhotoInput");k.querySelector("#productPhotoButton").addEventListener("click",()=>H.click()),H.onchange=async()=>{const B=H.files[0];if(!B)return;const D=k.querySelector("#productPhotoPreview"),R=k.querySelector("#productPhotoBase64");D.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const O=await ho(B,800,800,"image/jpeg",.8),N=O.length*3/4,C=1e3*1024;if(N>C)throw new Error("A imagem é muito grande mesmo após a compressão.");D.src=O,R.value=O}catch(O){console.error("Erro ao processar imagem:",O),g("Erro de Imagem",O.message||"Não foi possível processar a imagem.","error"),D.src=E,R.value=S,H.value=""}},k.style.display="flex"}function Gn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),Ja(),bt()}function Yn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const r=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function vt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,r]=await Promise.all([ta(p.establishmentId),ia(p.establishmentId,"products"),Ua(p.establishmentId)]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),p.suppliers=(r||[]).filter(Boolean),$s(lt)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function $s(e){if(document.getElementById("products-content-container")){if(lt===e&&document.getElementById("products-content-container").children.length>1){lt==="products"&&(Ja(),bt());return}lt=e,ge="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Gn():e==="movements"&&Yn()}}async function Xn(){ke.innerHTML=`
    ...
    `}function el(){const e=Object.entries(Ot).map(([a,r])=>`<option value="${a}">${r.label}</option>`).join(""),t=Es.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",ol))}function Is(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
        ...
        `)}async function al(){const e=document.getElementById("partners-grid");if(!F.hasSearched){Is();return}e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="text-sm text-gray-500 mt-4 font-medium">Buscando parceiros...</p></div>';try{const t=await Ua(p.establishmentId);F.partners=t||[],Ls()}catch(t){e.innerHTML=`<div class="text-center py-10 text-red-500 font-bold">Erro ao carregar parceiros: ${t.message}</div>`}}function Ls(){const e=document.getElementById("partners-grid");if(!e)return;let t=F.partners;if(F.searchQuery){const o=F.searchQuery.toLowerCase();t=t.filter(s=>s.name.toLowerCase().includes(o)||s.document&&s.document.includes(o)||s.taxId&&s.taxId.includes(o)||s.email&&s.email.toLowerCase().includes(o)||s.contactName&&s.contactName.toLowerCase().includes(o))}if(F.categoryFilter!=="all"&&(t=t.filter(o=>o.category===F.categoryFilter)),F.stateFilter!=="all"&&(t=t.filter(o=>o.state===F.stateFilter)),F.cityFilter){const o=F.cityFilter.toLowerCase();t=t.filter(s=>s.city&&s.city.toLowerCase().includes(o))}if(t.sort((o,s)=>{let i="",n="";return F.sortBy==="name_asc"||F.sortBy==="name_desc"?(i=(o.name||"").toLowerCase(),n=(s.name||"").toLowerCase()):F.sortBy==="contact_asc"&&(i=(o.contactName||"").toLowerCase(),n=(s.contactName||"").toLowerCase()),F.sortBy==="name_desc"?n.localeCompare(i):i.localeCompare(n)}),t.length===0){e.innerHTML=`
        ...
        <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
    `,r='<div class="flex flex-col gap-4 md:hidden">';t.forEach(o=>{let s=o.category;s==="Produtos"&&(s="estoque"),s==="Serviços"&&(s="servicos");const i=Ot[s]||Ot.outros,n=o.document||o.taxId?o.document||o.taxId:"-",d=JSON.stringify(o).replace(/'/g,"&apos;"),l=[o.city,o.state].filter(Boolean).join(" - ");a+=`
        ...
        `;return t}function nl(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",r=h(t.name),o=h(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,d=n>1?`<span class="text-[10px] font-bold bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded ml-2 border border-indigo-200" title="Atende em ${n} unidades"><i class="bi bi-diagram-3"></i> ${n} Lojas</span>`:"";return`
            ...
            </div>`}).join("")}function pa(){const e=document.getElementById("genericModal");e.style.display="none",je&&e.removeEventListener("click",je)}async function ll(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},r=h(a.name),o=p.services||await Te(p.establishmentId),s=p.professionals||await le(p.establishmentId),i=`
        ...
        </div>`;t.innerHTML=i,t.style.display="flex",cl(a,o),ul(a),pl(a,s),gl(a)}function dl(e=[]){if(!Rt||Rt.length===0)return`
            <input type="hidden" name="accessibleIn" value="${p.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
        ...
        `,a.branches&&a.branches.length>0&&a.branches.forEach(o=>{const s=e.includes(o.id)||e.length===0&&o.id===p.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function cl(e,t){const a=document.getElementById("professionalForm"),r=e.dob?e.dob.split("/"):["",""],o=Array.from({length:12},(f,E)=>{const S=E+1,k=S==r[1]?"selected":"",T=new Date(0,E).toLocaleString("pt-BR",{month:"long"});return`<option value="${S}" ${k}>${T.charAt(0).toUpperCase()+T.slice(1)}</option>`}).join(""),s=e.status||"active",i=h(e.name||""),n=h(e.specialty||""),d=h(e.phone||""),l=h(e.notes||"");a.innerHTML=`
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        </div>`;const r=document.getElementById("batchBlockageForm");r&&r.addEventListener("submit",async s=>{s.preventDefault();const i=r.querySelector('button[type="submit"]'),n=i.innerHTML;i.disabled=!0,i.innerHTML='<span class="spinner-border spinner-border-sm"></span> A gravar...';const d=Array.from(s.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(v=>v.value);if(d.length===0)return i.disabled=!1,i.innerHTML=n,g("Atenção","Selecione pelo menos um profissional.","error");const l=s.target.batchBlockageStartDate.value,c=s.target.batchBlockageEndDate.value||l,u=s.target.batchBlockageStartTime.value,m=s.target.batchBlockageEndTime.value,x=s.target.batchBlockageReason.value;if(!l||!u||!m)return i.disabled=!1,i.innerHTML=n,g("Atenção","Preencha Data de Início, Hora de Início e Fim.","error");const b=d.map(v=>{const f={professionalId:v,establishmentId:p.establishmentId,startTime:new Date(`${l}T${u}`).toISOString(),endTime:new Date(`${c}T${m}`).toISOString(),reason:x};return Kt(f)});try{await Promise.all(b),g("Sucesso!",`${d.length} bloqueios foram criados.`),r.reset(),s.target.querySelectorAll('input[name="batch-professionals"]').forEach(f=>{f.checked=f.value===e.id});const v=document.getElementById("prof-blockages-filter").value;ct(e.id,v)}catch(v){g("Erro",v.message,"error")}finally{i.disabled=!1,i.innerHTML=n}}),document.getElementById("prof-blockages-filter").addEventListener("change",s=>ct(e.id,s.target.value)),await ct(e.id,"future")}function ml(e,t){e.innerHTML=Object.keys(yo).map(a=>{const r=t[a]||{},o=r.active!==!1;return`
            ...
            </div>`}).join(""),e.querySelectorAll('input[type="checkbox"][data-field="active"]').forEach(a=>{a.addEventListener("change",r=>{const o=r.target.closest(".day-schedule-card"),s=!r.target.checked;o.classList.toggle("bg-white",!s),o.classList.toggle("shadow-sm",!s),o.classList.toggle("border-gray-200",!s),o.classList.toggle("bg-gray-50",s),o.classList.toggle("border-gray-100",s),o.classList.toggle("opacity-60",s),o.classList.toggle("disabled",s),o.querySelectorAll(".time-inputs input").forEach(i=>i.disabled=s)})})}async function ct(e,t="future"){const a=document.getElementById("blockagesList");if(a){a.innerHTML='<div class="loader mx-auto mt-6"></div>';try{const r=new Date;let o,s;t==="history"?(s=new Date,o=new Date,o.setFullYear(o.getFullYear()-2)):(o=new Date,s=new Date,s.setFullYear(s.getFullYear()+2));let n=(await Zt(p.establishmentId,o.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?n=n.filter(l=>l.endTime<r).sort((l,c)=>c.startTime-l.startTime):n=n.filter(l=>l.endTime>=r).sort((l,c)=>l.startTime-c.startTime);const d=n.reduce((l,c)=>{const u=c.reason||"Sem motivo detalhado";return l[u]||(l[u]=[]),l[u].push(c),l},{});if(Object.keys(d).length===0){a.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=Il)}function ft(){if($.modalOpen)return;Ga();const e=document.getElementById("clients-content-area"),t=$.filters.inactiveDays||$.filters.birthMonth||$.filters.hasLoyalty||$.filters.hasDebt,a=`
    ...
    `,r=$.clients.length>0?`
        <div class="px-3 sm:px-4 pb-20 pt-2 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${$.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,m=xl(c.lastVisit);return`
    ...
    `;e.innerHTML=a+r;const o=document.getElementById("client-search"),s=document.getElementById("btn-toggle-filters"),i=document.getElementById("btn-apply-filters"),n=document.getElementById("btn-clear-search");s&&(s.onclick=()=>{$.showFilters=!$.showFilters,ft()});const d=document.getElementById("filter-birth-month");d&&(d.value=$.filters.birthMonth);const l=()=>{const c=document.getElementById("filter-inactive"),u=document.getElementById("filter-loyalty"),m=document.getElementById("filter-debt"),x=document.getElementById("filter-birth-month");$.filters={search:o.value,inactiveDays:c?c.value:"",birthMonth:x?x.value:"",hasLoyalty:u?u.checked:!1,hasDebt:m?m.checked:!1},La()};i&&(i.onclick=l),n&&(n.onclick=()=>{$.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},$.showFilters=!1,La()}),o.addEventListener("keypress",c=>{c.key==="Enter"&&l()}),e.querySelectorAll(".client-card").forEach(c=>{c.onclick=()=>Ds(c.dataset.id)})}function hl(e){const t=`
    ...
    `;let a="";return $.activeTab==="profile"?a=wl(e):$.activeTab==="appointments"?a=kl():$.activeTab==="history"?a=Sl():$.activeTab==="loyalty"&&(a=$l(e)),`
    ...
    `}function vl(e,t){if(!document.getElementById("tabs-styles")){const s=document.createElement("style");s.id="tabs-styles",s.textContent=`
        ...
        `,e.appendChild(s)}if(e.querySelectorAll(".tab-btn").forEach(s=>{s.onclick=async()=>{const i=s.dataset.tab;if($.activeTab===i)return;(i==="appointments"||i==="history")&&($.historyLimit=20,$.historySearchTerm=""),$.activeTab=i,ze(),i!=="profile"&&!$.historyLoading&&$.historyData.appointments.length===0&&await wo(t.id)}}),$.activeTab==="profile"){const s=e.querySelector("#form-edit-client"),i=e.querySelector("#btn-delete-client");s&&(s.onsubmit=Ll),i&&(i.onclick=Cl)}if($.activeTab==="loyalty"){const s=e.querySelector("#btn-manual-redeem");s&&(s.onclick=()=>El(t))}const a=e.querySelector("#history-search-input");if(a){const s=a.value;a.value="",a.focus(),a.value=s,a.addEventListener("input",i=>{$.historySearchTerm=i.target.value,ze()})}const r=e.querySelector("#btn-load-more");r&&(r.onclick=()=>{$.historyLimit+=20,ze(),wo(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(s=>{s.onclick=i=>{Ve(),J("agenda-section",{targetDate:new Date(s.dataset.date),scrollToAppointmentId:s.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(s=>{s.onclick=i=>{Ve(),J("comandas-section",{selectedAppointmentId:s.dataset.id,initialFilter:"finalizadas"})}});const o=e.querySelector("#btn-close-modal");o&&(o.onclick=Ve)}async function ze(){const e=$.selectedClient;if(!e){Ve();return}yl(e)}function yl(e){let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 animate-fade-in",t.innerHTML=`
    ...
    `}function Sl(e){let t=$.historyData.sales||[];if($.historySearchTerm){const a=$.historySearchTerm.toLowerCase();t=t.filter(r=>r.id.includes(a))}return t.sort((a,r)=>new Date(r.date)-new Date(a.date)),t.length===0&&!$.historySearchTerm?'<div class="text-center py-12 text-gray-400">Nenhum registro financeiro.</div>':`
        <div class="space-y-4 w-full">
            <div class="sticky top-0 bg-gray-50 pt-2 pb-2 z-10 w-full">
                <div class="relative w-full">
                    <input type="text" id="history-search-input" 
    ...
    `}function $l(e){const t=$.historyData.loyaltyLog||[];t.sort((r,o)=>new Date(o.date)-new Date(r.date));const a=t.length>0?t.map(r=>{const o=r.type==="redemption";return`
    ...
    `}async function La(){$.loading=!0,Ga();try{let e=`/api/clients/${p.establishmentId}?limit=20`;$.filters.search&&(e+=`&search=${encodeURIComponent($.filters.search)}`),$.filters.inactiveDays&&(e+=`&inactiveDays=${$.filters.inactiveDays}`),$.filters.hasLoyalty&&(e+="&hasLoyalty=true"),$.filters.hasDebt&&(e+="&hasDebt=true"),$.clients=await I(e),ft()}catch(e){console.error(e),g("Erro","Falha ao carregar clientes.","error"),$.clients=[],ft()}finally{$.loading=!1;const e=document.querySelector(".loader");e&&e.parentElement&&e.parentElement.remove()}}async function wo(e){const t=$.selectedClient;if(!(!t||!t.phone)){$.historyLoading=!0;try{const a=new Date;a.setMonth(a.getMonth()+12);const r=new Date;r.setFullYear(r.getFullYear()-5);let o=`/api/appointments/${p.establishmentId}?startDate=${r.toISOString()}&endDate=${a.toISOString()}`;o+=`&clientPhone=${encodeURIComponent(fl(t.phone))}`,o+=`&limit=${$.historyLimit}`;const s=await I(o);$.historyData.appointments=s,$.historyData.sales=s.filter(n=>n.status==="completed").map(n=>({id:n.id,date:n.startTime,totalAmount:n.totalAmount||0,items:n.comandaItems||n.services||[]}));const i=[];s.forEach(n=>{n.status==="completed"&&n.loyaltyPointsEarned>0&&i.push({type:"earn",points:n.loyaltyPointsEarned,date:n.startTime,description:"Venda finalizada"}),n.loyaltyRedemption&&i.push({type:"redemption",points:n.loyaltyRedemption.cost||0,date:n.startTime,description:`Resgate: ${n.loyaltyRedemption.name}`})}),$.historyData.loyaltyLog=i}catch(a){console.error("Erro ao buscar histórico",a)}finally{$.historyLoading=!1,$.modalOpen&&$.selectedClient&&ze()}}}function El(e){const t=e.loyaltyPoints||0,a=`
    ...
    `,{modalElement:r,close:o}=ne({title:"Ajuste de Pontos",contentHTML:a,maxWidth:"w-[90%] max-w-xs"});r.querySelector("form").onsubmit=async s=>{s.preventDefault();const i=document.getElementById("redeem-action").value,n=parseInt(document.getElementById("redeem-points").value,10),d=document.getElementById("redeem-reason").value;if(!n||n<=0)return g("Erro","Qtd inválida.","error");if(i==="debit"&&n>t)return g("Erro","Saldo insuficiente.","error");try{let l=t;i==="debit"?(await Gr(p.establishmentId,e.phone,n,d),l-=n):(l+=n,await ts(e.id,{loyaltyPoints:l})),$.selectedClient.loyaltyPoints=l,$.historyData.loyaltyLog.unshift({type:i==="debit"?"redemption":"earn",points:n,date:new Date().toISOString(),description:d+" (Manual)"}),g("Sucesso","Saldo atualizado.","success"),o(),ze()}catch(l){g("Erro",l.message,"error")}}}function Ds(e){$.selectedClient=$.clients.find(t=>t.id===e),$.activeTab="profile",$.historyLimit=20,$.historySearchTerm="",$.historyData={appointments:[],sales:[],loyaltyLog:[]},ze()}function Il(){const e=`
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",l=>{l.preventDefault();const c={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,cnpj:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};Ze(c,l)})}function Pl(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");e.timezone&&(a.value=e.timezone);const r=t.querySelector("#establishmentWorkingHoursContainer"),o=e.workingHours||{};Object.keys(ma).forEach(s=>{const i=o[s]||{},n=ma[s],d=i.active!==!1,l=document.createElement("div");l.className=`day-schedule-card p-4 rounded-lg border ${d?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,l.innerHTML=`
            ...
            </div>`,r.appendChild(l)}),r.addEventListener("change",s=>{const i=s.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),t.querySelector("#working-hours-form").addEventListener("submit",s=>{s.preventDefault();const i={};Object.keys(ma).forEach(d=>{i[d]={active:t.querySelector(`#est-${d}-active`).checked,start:t.querySelector(`#est-${d}-start`).value,end:t.querySelector(`#est-${d}-end`).value,breakStart:t.querySelector(`#est-${d}-breakStart`).value,breakEnd:t.querySelector(`#est-${d}-breakEnd`).value}});const n=t.querySelector("#establishmentTimezone").value;Ze({workingHours:i,timezone:n},s)})}function Bs(e,t){const a=!!e.whatsappInstance;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;const n=t.querySelector("#loyaltyTiersContainer"),d=(l={})=>{const c=document.createElement("div");c.className="loyalty-tier-row bg-white p-4 border border-gray-200 rounded-lg shadow-sm relative grid grid-cols-1 md:grid-cols-4 gap-4 items-end";const u=l.type||"money",m=l.itemId||"",x=l.reward||"",b=l.discount||"",v=l.points||l.costPoints||"";c.innerHTML=`
        ...
        `;const f=c.querySelector(".type-select"),E=c.querySelector(".item-select"),S=c.querySelector(".desc-input"),k=c.querySelector(".discount-input"),T=L=>{E.innerHTML='<option value="">Selecione...</option>';let q=[];L==="service"?q=o:L==="product"?q=s:L==="package"&&(q=i),q.forEach(H=>{const B=H.id===m,D=H.name||H.title||"Sem nome",R=H.price||H.salePrice||0;E.innerHTML+=`<option value="${H.id}" data-price="${R}" ${B?"selected":""}>${h(D)}</option>`})};return u!=="money"&&T(u),f.addEventListener("change",L=>{const q=L.target.value;q==="money"?(E.classList.add("hidden"),S.classList.remove("hidden"),S.value="",k.value=""):(E.classList.remove("hidden"),S.classList.add("hidden"),T(q),k.value="")}),E.addEventListener("change",L=>{const q=L.target.selectedOptions[0];if(q&&q.value){S.value=q.text;const H=q.dataset.price;H&&(k.value=parseFloat(H).toFixed(2))}}),c};a.tiers&&a.tiers.length>0?a.tiers.forEach(l=>n.appendChild(d(l))):n.appendChild(d()),t.querySelector("#add-loyalty-tier").addEventListener("click",()=>{n.appendChild(d())}),n.addEventListener("click",l=>{const c=l.target.closest(".remove-loyalty-tier");c&&c.closest(".loyalty-tier-row").remove()}),t.querySelector("#loyalty-form").addEventListener("submit",l=>{l.preventDefault();const c=Array.from(t.querySelectorAll("#loyaltyTiersContainer .loyalty-tier-row")).map(m=>{const x=m.querySelector(".type-select").value,b=x==="money"?null:m.querySelector(".item-select").value;let v=x==="money"?m.querySelector(".desc-input").value:m.querySelector(".item-select").options[m.querySelector(".item-select").selectedIndex]?.text;return{points:parseInt(m.querySelector('input[data-field="points"]').value,10)||0,costPoints:parseInt(m.querySelector('input[data-field="points"]').value,10)||0,type:x,itemId:b,reward:v,name:v,discount:parseFloat(m.querySelector('input[data-field="discount"]').value)||0}}),u={loyaltyProgram:{enabled:t.querySelector("#loyaltyEnabled").checked,type:"visit",pointsPerVisit:parseInt(t.querySelector("#loyaltyPointsPerVisit").value,10)||1,pointsPerCurrency:0,tiers:c.filter(m=>m.points>0&&m.reward)}};Ze(u,l)})}async function jl(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,Ee.querySelector('button[data-action="back-to-menu"]').addEventListener("click",o=>{o.preventDefault(),Ms({id:G})});const r=document.getElementById("settings-content-detail");switch(e){case"personal-data":Bl(U,r);break;case"change-password":Pl(U,r);break;case"change-email":Ml(U,r);break;case"branding":Al(U,r);break;case"booking":ql(U,r);break;case"working-hours":Rl(U,r);break;case"whatsapp-bot":Bs(U,r);break;case"loyalty":await Nl(U,r);break;case"financial":await jl(U,r);break;case"support":Fl(U,r);break;case"cancellation":Hl(U,r);break;default:r.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function Ms(e={}){Ee.innerHTML=`
    ...
    `).join("")}const ut=document.getElementById("content");async function _e(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,r=document.getElementById("filterEndDate")?.value,o=await Zt(p.establishmentId,a||new Date().toISOString().split("T")[0],r||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),i=s?o.filter(d=>d.reason&&d.reason.toLowerCase().includes(s)):o,n=i.reduce((d,l)=>{const c=l.reason||"Sem motivo";return d[c]||(d[c]=[]),d[c].push(l),d},{});if(t.innerHTML="",i.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([d,l])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let m=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
    ...
    `}).join("")}function Ca(){const t=document.getElementById("showInactiveUsersToggle")?.checked?p.users:p.users.filter(a=>a.status==="active");od(t)}function sd(e={}){return Object.entries(ed).map(([t,a])=>{const r=t==="agenda-section"||t==="comandas-section",o=e[t]?.view_all_prof===!0,s=Object.entries(td).map(([n,d])=>`
    ...
    `,It&&et.removeEventListener("click",It),Lt&&et.removeEventListener("change",Lt),It=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":$o();break;case"edit-user":const r=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));$o(r);break;case"back-to-list":Vt();break;case"delete-user":{if(e.stopPropagation(),await W("Excluir Usuário","Tem certeza? Ação irreversível."))try{await Xl(t.dataset.userId),g("Usuário excluído!","success"),Vt()}catch(o){g(`Erro: ${o.message}`,"error")}break}}},Lt=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Ca();else if(t){e.stopPropagation();const a=t.dataset.userId,r=t.checked?"active":"inactive";try{await Kl(a,r);const o=p.users.findIndex(s=>s.id===a);o>-1&&(p.users[o].status=r,Ca())}catch(o){g(`Erro: ${o.message}`,"error"),t.checked=!t.checked}}},et.addEventListener("click",It),et.addEventListener("change",Lt),await rd()}const id=document.getElementById("content");let Eo={},Da=null;function nd(){Object.values(Eo).forEach(e=>e?.destroy()),Eo={}}function ld(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,r=new a({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(r.setFontSize(18),r.text(e,r.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const i=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];r.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=r.lastAutoTable?r.lastAutoTable.finalY+20:60;r.text("Detalhes das Vendas",20,s),r.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),r.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Io(e){const t=document.getElementById("genericModal"),a=h(e.client),r=h(e.items),o=h(e.responsavelCaixa||"N/A"),s=(e.payments||[]).map(i=>`
    ...
    `}).join(""),s.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const d=n.dataset.transactionIndex,l=Da.transactions[d];l&&Io(l)})}),i.innerHTML=a.map((n,d)=>{const l=h(n.client),c=h(n.items),u=h(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const d=n.dataset.transactionIndex,l=Da.transactions[d];l&&Io(l)})})}async function Lo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const r=t.value,o=a.value;if(!r||!o)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,i=await Ur({establishmentId:p.establishmentId,startDate:r,endDate:o,cashierSessionId:s});Da=i,e.innerHTML=`
        ...
        <section class="pb-20 md:pb-0"> <div class="flex flex-col gap-4 mb-6">
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Lo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const r=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${r}_a_${o}`;ld(s,"transactionsTable")});try{const r=await Ai(p.establishmentId),o=document.getElementById("cashierSessionFilter");r&&r.length>0&&r.forEach(s=>{const i=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=h(s.closedByName||"N/A");o.innerHTML+=`<option value="${s.id}">${n} - ${i}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Lo()}const ud=document.getElementById("content");let w={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1,sortCol:"dueDate",sortAsc:!0},Ct=null,Dt=null;function Ya(e){const t=new Map,a=[];return e&&(e.forEach(r=>t.set(r.id,{...r,children:[]})),t.forEach(r=>{r.parentId&&t.has(r.parentId)?t.get(r.parentId).children.push(r):a.push(r)})),a}function As(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,r]=e.split("-"),o=new Date(t,a-1,r),s=String(o.getDate()).padStart(2,"0"),i=o.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:s,month:i,full:o.toLocaleDateString("pt-BR")}}function ue(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function Ye(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[r,o,s]=e.split("-");return new Date(r,o-1,s)<a}function pd(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML=`
            ...
            </div>`;return}const r=(o,s=0)=>{const i=s*16,n=s===0,d=n?"bi-folder-fill text-indigo-500":"bi-file-earmark-text text-gray-400",l=n?"bg-white shadow-sm border border-gray-200":"bg-gray-50 border border-gray-100/50",c=n?"text-sm font-bold text-gray-800":"text-xs font-semibold text-gray-600",u=s>0?'<div class="absolute left-0 top-1/2 w-3 border-t-2 border-gray-200" style="margin-left: -12px;"></div>':"",m=s>0?"border-left: 2px solid #e5e7eb;":"";return`
            ...
            ${o.children.map(x=>r(x,s+1)).join("")}
        `};e.innerHTML=t.map(o=>r(o)).join("")}async function Ta(e){const t=document.getElementById("genericModal"),a=e==="nature",r=a?"Plano de Naturezas":"Centros de Custo",o=a?ra:za,s=a?an:sn,i=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),d=t.querySelector("#itemParent"),l=u=>{const m=Ya(u);pd(n,m,e);const x=d.value;d.innerHTML='<option value="">-- Nível Principal --</option>';const b=(v,f=0)=>{const E="  ".repeat(f)+(f>0?"↳ ":"");d.innerHTML+=`<option value="${v.id}">${E}${v.name}</option>`,v.children.forEach(S=>b(S,f+1))};m.forEach(v=>b(v)),d.value=x};try{const u=await o(p.establishmentId);w[i]=u,l(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const m=t.querySelector("#itemName").value,x=d.value;try{await s({name:m,parentId:x||null,establishmentId:p.establishmentId});const b=await o(p.establishmentId);w[i]=b,l(b),c.reset(),await De(),g("Sucesso","Item adicionado à estrutura.","success")}catch(b){g("Erro",b.message,"error")}})}async function md(){try{const t=(await Xe()).matrizes||[];w.establishments=[],t.forEach(a=>{w.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(r=>w.establishments.push({id:r.id,name:r.name,type:"Filial"}))}),w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(p.establishmentId)}catch(e){console.warn("Erro ao buscar lojas",e)}qs(),Rs(),await De()}function qs(){const e=w.establishments.map(t=>`
    ...
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),document.querySelector('.date-preset-btn[data-preset="month"]').classList.remove("bg-white","text-gray-600","border-gray-200"),Ns()}function gd(){const e=w.currentTab==="receivables",t=e?w.receivables:w.payables;let a=t;if(w.statusFilter!=="all"&&(a=t.filter(n=>{const d=Ye(n.dueDate,n.status);return w.statusFilter==="overdue"?d:w.statusFilter==="pending"?n.status==="pending"&&!d:n.status===w.statusFilter})),w.searchQuery&&(a=a.filter(n=>n.description&&n.description.toLowerCase().includes(w.searchQuery)||n.entity&&n.entity.toLowerCase().includes(w.searchQuery)||n.notes&&n.notes.toLowerCase().includes(w.searchQuery))),a.sort((n,d)=>new Date(n.dueDate)-new Date(d.dueDate)),a.length===0){g("Aviso","Não há dados para exportar com os filtros atuais.","info");return}const r=new Map(w.natures.map(n=>[n.id,n.name])),o=new Map(w.costCenters.map(n=>[n.id,n.name])),s=new Map(w.establishments.map(n=>[n.id,n])),i=a.map(n=>{const d=n.status==="paid",l=Ye(n.dueDate,n.status);let c=d?"Baixado":l?"Atrasado":"A Vencer / Pendente";const u=n.naturezaId?r.get(n.naturezaId)||"Não Categorizado":"Geral",m=n.centroDeCustoId?o.get(n.centroDeCustoId)||"Não Categorizado":"Geral",x=s.get(n.establishmentId),b=x?x.name:"Atual",v=n.saleId||n.appointmentId||n.origin==="comanda"?"Comanda / PDV":"Manual";return{"Data de Vencimento":new Date(n.dueDate).toLocaleDateString("pt-BR"),"Data de Pagamento":n.paymentDate?new Date(n.paymentDate).toLocaleDateString("pt-BR"):"-",Descrição:n.description||"","Favorecido / Pagador":n.entity||"",Unidade:b,Natureza:u,"Centro de Custo":m,Origem:v,"Documento / NFS":n.documentNumber||"",Status:c,"Valor (R$)":n.amount}});try{if(typeof XLSX>"u"){g("Erro","A biblioteca de exportação (XLSX) não foi carregada no sistema.","error");return}const n=XLSX.utils.json_to_sheet(i),d=XLSX.utils.book_new();XLSX.utils.book_append_sheet(d,n,"Financeiro");const c=`Fluxo_${e?"Receitas":"Despesas"}_${new Date().toISOString().split("T")[0]}.xlsx`;XLSX.writeFile(d,c)}catch(n){console.error("Erro ao exportar:",n),g("Erro","Não foi possível exportar para Excel.","error")}}function Rs(){const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const s=o.target.checked,i=document.querySelectorAll(".item-checkbox");w.selectedIds.clear(),i.forEach(n=>{n.checked=s,s&&w.selectedIds.add(n.dataset.id)}),Fe()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{w.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Fe()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=w.selectedIds.size;if(o===0)return;if(await W("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const i=w.currentTab==="payables"?"payables":"receivables";await bs(i,Array.from(w.selectedIds)),g("Sucesso",`${o} itens excluídos.`,"success"),w.selectedIds.clear(),Fe(),De()}catch{g("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",s=>{const i=s.target.closest("label");s.target.checked?(w.filterEstablishmentIds.add(s.target.value),i.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.remove("border-gray-200","text-gray-600")):(w.filterEstablishmentIds.delete(s.target.value),i.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),i.classList.add("border-gray-200","text-gray-600"))})}),document.querySelectorAll(".sort-header").forEach(o=>{o.addEventListener("click",s=>{const i=s.currentTarget.dataset.sort;w.sortCol===i?w.sortAsc=!w.sortAsc:(w.sortCol=i,w.sortAsc=!0),pt()})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),s=document.getElementById("toggle-filter-btn");w.isAdvancedFilterOpen=!w.isAdvancedFilterOpen,w.isAdvancedFilterOpen?(o.classList.remove("hidden"),s.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),s.classList.remove("bg-white","text-gray-600","border-gray-200")):(o.classList.add("hidden"),s.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),s.classList.add("bg-white","text-gray-600","border-gray-200"))}),document.getElementById("settings-btn").addEventListener("click",yd);const t=document.getElementById("export-excel-btn");t&&t.addEventListener("click",gd),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",s=>{ga(s.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const o=w.currentTab==="payables"?"payable":"receivable";ga(o)});const a=document.getElementById("tab-receivables"),r=document.getElementById("tab-payables");a.addEventListener("click",()=>Co("receivables")),r.addEventListener("click",()=>Co("payables")),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",s=>{document.querySelectorAll(".status-filter-btn").forEach(i=>{i.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200","bg-red-50","text-red-700","border-red-200"),i.classList.add("bg-white","text-gray-600")}),s.target.dataset.status==="overdue"?s.target.classList.add("bg-red-50","text-red-700","border-red-200"):s.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),s.target.classList.remove("bg-white","text-gray-600"),w.statusFilter=s.target.dataset.status,pt(),js()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",s=>{document.querySelectorAll(".date-preset-btn").forEach(c=>{c.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-200"),c.classList.add("bg-white","text-gray-600","border-gray-200")}),s.target.classList.add("bg-indigo-50","text-indigo-700","border-indigo-200"),s.target.classList.remove("bg-white","text-gray-600","border-gray-200");const i=s.target.dataset.preset,n=new Date;let d,l;i==="month"?(d=new Date(n.getFullYear(),n.getMonth(),1),l=new Date(n.getFullYear(),n.getMonth()+1,0)):i==="last_month"?(d=new Date(n.getFullYear(),n.getMonth()-1,1),l=new Date(n.getFullYear(),n.getMonth(),0)):i==="year"&&(d=new Date(n.getFullYear(),0,1),l=new Date(n.getFullYear(),11,31)),document.getElementById("filterStartDate").value=d.toISOString().split("T")[0],document.getElementById("filterEndDate").value=l.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",o=>{w.searchQuery=o.target.value.toLowerCase(),pt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",w.filterEstablishmentIds.clear(),w.filterEstablishmentIds.add(p.establishmentId),qs(),Rs()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{w.startDate=document.getElementById("filterStartDate").value,w.endDate=document.getElementById("filterEndDate").value,w.filterNaturezaId=document.getElementById("filterNaturezaId").value,w.filterCostCenterId=document.getElementById("filterCostCenterId").value,w.filterEstablishmentIds.size===0&&w.filterEstablishmentIds.add(p.establishmentId),document.getElementById("toggle-filter-btn").click(),De()}),Ct&&document.body.removeEventListener("click",Ct),Ct=o=>{const s=o.target;if(s.classList.contains("item-checkbox")||s.classList.contains("modal-item-checkbox")){const d=s.value||s.dataset.id;s.checked?w.selectedIds.add(d):w.selectedIds.delete(d),Fe(),o.stopPropagation();return}const i=s.closest("button[data-action]");if(i){const{action:d,type:l,id:c}=i.dataset;if(o.stopPropagation(),d==="delete"){const u=i.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");xd(l,JSON.parse(u));return}if(d==="mark-as-paid"){fd(l,c);return}if(d==="manage-natures"){Ta("nature");return}if(d==="manage-cost-centers"){Ta("cost-center");return}}const n=s.closest(".financial-row");if(n&&document.getElementById("list-container").contains(n)&&!s.closest("button")&&!s.closest(".item-checkbox")){const{type:d}=n.dataset,l=JSON.parse(n.dataset.item.replace(/&apos;/g,"'"));ga(d,l)}},document.body.addEventListener("click",Ct),Dt&&document.getElementById("genericModal").removeEventListener("click",Dt),Dt=o=>{if(o.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const i=o.target.closest('button[data-action^="delete-"]');if(i){const n=i.dataset.action.split("-")[1];vd(n,i.dataset.id)}},document.getElementById("genericModal").addEventListener("click",Dt)}function Fe(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),r=w.selectedIds.size;t.textContent=r,r>0?(e.classList.remove("hidden"),e.classList.add("flex"),a&&a.classList.add("hidden")):(e.classList.add("hidden"),e.classList.remove("flex"),a&&a.classList.remove("hidden"))}function Co(e){w.currentTab=e,w.selectedIds.clear(),Fe(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),r=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-emerald-700","shadow"),t.classList.remove("text-gray-600"),a.classList.remove("bg-white","text-red-700","shadow"),a.classList.add("text-gray-600"),r&&(r.className="md:hidden fixed bottom-20 right-4 w-12 h-12 bg-emerald-600 text-white rounded-full shadow-lg flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow"),a.classList.remove("text-gray-600"),t.classList.remove("bg-white","text-emerald-700","shadow"),t.classList.add("text-gray-600"),r&&(r.className="md:hidden fixed bottom-20 right-4 w-12 h-12 bg-red-600 text-white rounded-full shadow-lg flex items-center justify-center hover:scale-105 transition-all z-40")),pt()}async function De(){const e=document.getElementById("list-container");e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-xs">A processar transações...</p></div>';try{if(w.natures.length===0){const[s,i]=await Promise.all([ra(p.establishmentId),za(p.establishmentId)]);w.natures=s,w.costCenters=i,Ns()}const t=Array.from(w.filterEstablishmentIds).join(","),a={startDate:w.startDate,endDate:w.endDate,establishmentId:t};w.filterNaturezaId!=="all"&&(a.natureId=w.filterNaturezaId),w.filterCostCenterId!=="all"&&(a.costCenterId=w.filterCostCenterId);const[r,o]=await Promise.all([xs(a),hs(a)]);w.payables=r.entries||[],w.receivables=o.entries||[],js(),pt()}catch(t){e.innerHTML=`
            ...
            </div>`}}function Ns(){const e=r=>{let o='<option value="all">-- Todas as opções --</option>';const s=Ya(r),i=(n,d=0)=>{const l="  ".repeat(d)+(d>0?"↳ ":"");o+=`<option value="${n.id}">${l}${n.name}</option>`,n.children.forEach(c=>i(c,d+1))};return s.forEach(n=>i(n)),o},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(w.natures)),a&&(a.innerHTML=e(w.costCenters))}function js(){const e=document.getElementById("summary-section");if(!e)return;const t=w.currentTab==="receivables";let r=t?w.receivables:w.payables;w.searchQuery&&(r=r.filter(c=>c.description&&c.description.toLowerCase().includes(w.searchQuery)||c.entity&&c.entity.toLowerCase().includes(w.searchQuery)||c.notes&&c.notes.toLowerCase().includes(w.searchQuery)));const o=r.reduce((c,u)=>c+u.amount,0),s=r.filter(c=>c.status==="paid").reduce((c,u)=>c+u.amount,0),i=r.filter(c=>c.status==="pending"&&!Ye(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),n=r.filter(c=>Ye(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),d=t?"emerald":"red",l=t?"Receitas":"Despesas";e.innerHTML=`
        ...
        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
            ...
            <span class="text-xl font-bold text-${d}-600 mt-0.5">${ue(s)}</span>
        </div>
        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col">
    ...
    `}function bd(){document.querySelectorAll(".sort-header").forEach(e=>{const t=e.querySelector("i");if(!t)return;e.dataset.sort===w.sortCol?(e.classList.add("text-indigo-700"),e.classList.remove("text-gray-500"),t.className=w.sortAsc?"bi bi-arrow-up ml-1 text-indigo-600":"bi bi-arrow-down ml-1 text-indigo-600"):(e.classList.remove("text-indigo-700"),e.classList.add("text-gray-500"),t.className="bi bi-arrow-down-up ml-1 opacity-30 text-[10px]")})}function pt(){const e=document.getElementById("list-container");if(!e)return;const t=w.currentTab==="receivables",a=t?w.receivables:w.payables;let r=a;if(w.statusFilter!=="all"&&(r=a.filter(l=>{const c=Ye(l.dueDate,l.status);return w.statusFilter==="overdue"?c:w.statusFilter==="pending"?l.status==="pending"&&!c:l.status===w.statusFilter})),w.searchQuery&&(r=r.filter(l=>l.description&&l.description.toLowerCase().includes(w.searchQuery)||l.entity&&l.entity.toLowerCase().includes(w.searchQuery)||l.notes&&l.notes.toLowerCase().includes(w.searchQuery))),r.sort((l,c)=>{let u=l[w.sortCol],m=c[w.sortCol];return w.sortCol==="dueDate"?(u=new Date(u).getTime(),m=new Date(m).getTime()):(w.sortCol==="description"||w.sortCol==="status")&&(u=u?u.toLowerCase():"",m=m?m.toLowerCase():""),u<m?w.sortAsc?-1:1:u>m?w.sortAsc?1:-1:0}),bd(),r.length===0){e.innerHTML=`
        ...
        `;return}const o=new Map(w.natures.map(l=>[l.id,l.name])),s=new Map(w.costCenters.map(l=>[l.id,l.name])),i=new Map(w.establishments.map(l=>[l.id,l])),n=t?"receivable":"payable",d=t?"text-emerald-600":"text-red-600";e.innerHTML=r.map(l=>{const c=As(l.dueDate),u=l.status==="paid",m=Ye(l.dueDate,l.status);let x="";u?x='<span class="bg-gray-100 text-gray-500 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest"><i class="bi bi-check2-circle mr-0.5"></i> Baixado</span>':m?x='<span class="bg-red-50 text-red-600 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest"><i class="bi bi-exclamation-circle mr-0.5"></i> Atrasado</span>':x='<span class="bg-blue-50 text-blue-600 px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest"><i class="bi bi-clock-history mr-0.5"></i> A Vencer</span>';const b=l.naturezaId?o.get(l.naturezaId)||"Sem Natureza":"Não Categorizado",v=l.centroDeCustoId?s.get(l.centroDeCustoId)||"Sem Centro":"Geral",E=l.saleId||l.appointmentId||l.origin==="comanda"?'<span class="text-[8px] font-bold text-purple-600 bg-purple-50 px-1.5 py-0.5 rounded border border-purple-100"><i class="bi bi-receipt mr-1"></i>Comanda</span>':'<span class="text-[8px] font-bold text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200"><i class="bi bi-keyboard mr-1"></i>Manual</span>',S=l.documentNumber?`<span class="text-[8px] bg-amber-50 text-amber-700 border border-amber-200 px-1.5 py-0.5 rounded ml-2" title="NFS / Documento">NFS: ${l.documentNumber}</span>`:"",k=i.get(l.establishmentId);let T="";if(k){const R=k.type==="Matriz"?"bi-building":"bi-shop";T=`<span class="text-[8px] px-1.5 py-0.5 rounded bg-slate-100 text-slate-500 font-bold border border-slate-200 flex items-center whitespace-nowrap w-max" title="Unidade: ${k.name}"><i class="bi ${R} mr-1 opacity-60"></i> ${k.name}</span>`}else T='<span class="text-[8px] px-1.5 py-0.5 rounded bg-gray-100 text-gray-500 font-bold border border-gray-200 flex items-center whitespace-nowrap w-max"><i class="bi bi-geo-alt mr-1 opacity-60"></i> Atual</span>';const L=JSON.stringify(l).replace(/'/g,"&apos;"),q=w.selectedIds.has(l.id),B=!!l.recurrenceId?'<i class="bi bi-arrow-repeat text-indigo-400 ml-1 text-[10px]" title="Lançamento Recorrente"></i>':"",D=l.entity?`<span class="text-[9px] text-gray-400 font-medium truncate block mt-0.5"><i class="bi bi-person mr-1 opacity-40"></i>${l.entity}</span>`:"";return`
        <div class="financial-row border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer relative group flex flex-col md:grid md:grid-cols-12 md:gap-2 md:items-center p-1.5 md:p-2 mb-1 ${q?"bg-indigo-50/40":""}"
             data-type="${n}"
             data-item='${L}'>
            ...
            <div class="absolute right-2 top-2 md:relative md:right-auto md:top-auto md:col-span-1 md:flex md:justify-center z-10">
                <input type="checkbox" value="${l.id}" class="item-checkbox w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 cursor-pointer shadow-sm" ${q?"checked":""}>
            </div>
        ...
        `}).join("")}async function fd(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?cn(t,a):gn(t,a)),g("Baixa Realizada","O lançamento foi registado como pago.","success"),await De()}catch(r){g("Erro",r.message,"error")}}async function xd(e,t){if(!!!t.recurrenceId){await W("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Fs(e,[t.id]);return}hd(e,t)}function hd(e,t){const a=document.getElementById("genericModal"),o=(e==="payable"?w.payables:w.receivables).filter(l=>l.recurrenceId===t.recurrenceId).sort((l,c)=>new Date(l.dueDate)-new Date(c.dueDate));a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${o.map(l=>{const c=l.id===t.id,u=l.status==="paid",m=As(l.dueDate);return`
    ...
    `,a.style.display="flex";const s=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");s.addEventListener("change",l=>{i.forEach(c=>c.checked=l.target.checked),d()}),i.forEach(l=>l.addEventListener("change",d));function d(){const l=Array.from(i).filter(c=>c.checked).length;n.innerHTML=l>0?`<i class="bi bi-trash3"></i> Excluir ${l} Parcela(s)`:"Selecione para excluir",n.disabled=l===0,l===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const l=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(l.length===0)return;a.style.display="none",await W("Confirmar Ação",`Tem certeza que deseja apagar estas ${l.length} parcelas permanentemente?`)&&await Fs(e,l)}),d()}async function Fs(e,t){try{t.length===1?e==="payable"?await dn(t[0]):await mn(t[0]):await bs(e==="payable"?"payables":"receivables",t),g("Sucesso",`${t.length} registo(s) limpo(s) do sistema.`,"success"),w.selectedIds.clear(),Fe(),await De()}catch(a){g("Erro",a.message,"error")}}async function vd(e,t){const r=e==="nature"?on:rn;if(await W("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await r(t),Ta(e==="nature"?"nature":"cost-center")}catch(s){g("Erro",s.message,"error")}}function yd(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ga(e,t=null){const a=document.getElementById("genericModal"),r=e==="payable",o=r?"red":"emerald",s=t?"Editar Lançamento":"Novo Lançamento",i=w.establishments.map(L=>{const q=t?t.establishmentId===L.id:L.id===p.establishmentId;return`<option value="${L.id}" ${q?"selected":""}>${L.type==="Matriz"?"🏢":"📍"} ${L.name}</option>`}).join(""),n=(L,q)=>{let H='<option value="">-- Selecione --</option>';const B=Ya(L),D=(R,O=0)=>{const z="  ".repeat(O)+(O>0?"↳ ":""),N=R.id===q?"selected":"";H+=`<option value="${R.id}" ${N}>${z}${R.name}</option>`,R.children.forEach(C=>D(C,O+1))};return B.forEach(R=>D(R)),H},l=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(L=>`<option value="${L.value}" ${t?.paymentMethod===L.value?"selected":""}>${L.label}</option>`).join("");a.innerHTML=`
        <div class="modal-content max-w-3xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden m-4 flex flex-col max-h-[90vh]">
            ...
            <div class="bg-${o}-600 px-5 py-4 flex justify-between items-center flex-shrink-0 relative overflow-hidden">
                ...
                <div class="flex items-center gap-3 relative z-10">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-white tracking-wide">${s}</h2>
                        <p class="text-[10px] text-${o}-100 font-medium uppercase tracking-widest mt-0.5">${r?"Despesa":"Receita"}</p>
                    </div>
                </div>
                ...
                <div class="p-5 space-y-4">
                    ...
                    <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <div>
                                <span class="block text-xs font-bold text-gray-800 group-hover:text-${o}-700 transition-colors uppercase tracking-wide">Marcar como ${r?"Pago":"Recebido"}</span>
            ...
            `}else if(u==="repeat"){const q=L*m;v.innerHTML=`
                <div>
                    ...
                    <span class="text-[10px] text-indigo-500 font-medium">Lançamento Total: ${ue(q)}</span>
                </div>
            `}};c.addEventListener("click",L=>{const q=L.target.closest(".mode-btn");if(q&&!t)if(L.preventDefault(),c.querySelectorAll(".mode-btn").forEach(D=>{D.classList.remove("bg-gray-900","text-white","shadow-sm"),D.classList.add("text-gray-500","hover:bg-gray-100")}),q.classList.add("bg-gray-900","text-white","shadow-sm"),q.classList.remove("text-gray-500","hover:bg-gray-100"),u=q.dataset.mode,u==="single")b.style.display="none";else{b.style.display="block";const D=b.querySelector("#recurrence-label");D&&(D.textContent=u==="installment"?"Número de Parcelas":"Repetir por quantos meses?"),T()}if(L.target.closest("#btn-minus")&&f){L.preventDefault();let D=parseInt(f.value)||2;D>2&&(f.value=D-1,T())}if(L.target.closest("#btn-plus")&&f){L.preventDefault();let D=parseInt(f.value)||2;D<60&&(f.value=D+1,T())}}),x.addEventListener("input",T),f&&f.addEventListener("input",T),E.addEventListener("change",()=>{E.checked?(S.classList.remove("hidden"),k.required=!0):(S.classList.add("hidden"),k.required=!1)}),c.addEventListener("submit",async L=>{L.preventDefault();const q=c.querySelector('button[type="submit"]'),H=q.innerHTML;q.disabled=!0,q.innerHTML='<div class="loader-small border-white"></div> A gravar...';const B=new FormData(c),D=E.checked,R=parseFloat(B.get("amount"));let O=R,z=1;!t&&u!=="single"&&(z=parseInt(B.get("installments")),u==="repeat"&&(O=R*z));const N={establishmentId:B.get("establishmentId"),description:B.get("description"),amount:O,dueDate:B.get("dueDate"),naturezaId:B.get("naturezaId")||null,centroDeCustoId:B.get("centroDeCustoId")||null,entity:B.get("entity")||null,paymentMethod:B.get("paymentMethod")||null,documentNumber:B.get("documentNumber")||null,notes:B.get("notes"),status:D?"paid":"pending",paymentDate:D?B.get("paymentDate"):null,installments:z};z>1&&!t&&(N.recurrenceId=self.crypto.randomUUID());try{t?(await(r?ln(t.id,N):pn(t.id,N)),g("Sucesso","Atualizado com sucesso!","success")):(await(r?nn(N):un(N)),g("Sucesso","Lançamento criado!","success")),document.getElementById("genericModal").style.display="none",De()}catch(C){g("Erro",C.message||"Erro ao salvar","error"),q.disabled=!1,q.innerHTML=H}})}const wd=e=>I("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),kd=e=>I("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),Sd=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return I(`/api/commissions/stats?${a}`)},$d=(e={})=>{Object.keys(e).forEach(r=>(e[r]===void 0||e[r]===null||e[r]==="")&&delete e[r]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return I(a)},Ed=e=>I(`/api/commissions/report/${e}`,{method:"DELETE"}),_t=new Date,Do=new Date(_t.getFullYear(),_t.getMonth(),1),j={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:Do.toISOString().split("T")[0],dashEndDate:_t.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:Do.toISOString().split("T")[0],histEndDate:_t.toISOString().split("T")[0],histProfessionalId:"all"};let Tt=null;const ot=document.getElementById("content");async function Id(){try{j.professionals=await le(p.establishmentId)}catch(e){console.error("Erro profissionais",e)}Nd(),Ld(),la(),Wt("dashboard")}function Ld(){Tt&&ot.removeEventListener("click",Tt),Tt=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,r=t.dataset.id,o=t.dataset.idx;switch(a){case"tab-nav":Wt(t.dataset.tab);break;case"toggle-all-profs":Cd();break;case"back-to-filters":j.calculationResult=null,Ut(document.getElementById("commissions-content"));break;case"view-preview-items":Rd(o);break;case"save-final-report":Td();break;case"start-new-calc":Wt("calculator");break;case"print-receipt":Bd(r);break;case"delete-report":Pd(r);break;case"filter-dashboard":la();break;case"filter-history":Qa();break}},ot.addEventListener("click",Tt),ot.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Ad(t)}},ot.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Dd())}}async function la(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(j.dashStartDate=e.value),t&&(j.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const r=await Sd(j.dashStartDate,j.dashEndDate);j.dashStats={revenue:r.totalRevenue||0,commissions:r.totalCommissionsPaid||0},j.currentTab==="dashboard"&&Hs(document.getElementById("commissions-content"))}catch(r){console.error(r),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Qa(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(j.histStartDate=e.value),t&&(j.histEndDate=t.value),a&&(j.histProfessionalId=a.value);const r=document.getElementById("history-list-container");if(r){r.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const o=await $d({startDate:j.histStartDate,endDate:j.histEndDate,professionalId:j.histProfessionalId});j.historyData=o,Os(r,o)}catch{r.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Cd(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function Dd(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),r=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");j.periodString=`${a} a ${r}`;const o=document.getElementById("commissions-content");o.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await wd(t);j.calculationResult=s.map(i=>({...i,extraDebit:0,extraCredit:0,finalValue:i.summary.totalCommission,notes:""})),Ut(o)}catch(s){g("Erro",s.message,"error"),j.calculationResult=null,Ut(o)}}async function Td(){const e=j.calculationResult.length;if(await W("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=j.calculationResult.map(r=>{const o=r.items.map(s=>s.originalSaleId).filter(s=>s!=null);return kd({professionalId:r.professionalId,professionalName:r.professionalName,period:j.periodString,processedSalesIds:o,reportData:{...r,summary:{...r.summary,finalValue:r.finalValue,extraDebit:r.extraDebit||0,extraCredit:r.extraCredit||0,notes:r.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),j.calculationResult=null,la(),Wt("history")}catch(a){g("Erro",a.message,"error")}}function Bd(e){const t=j.historyData.find(a=>a.id===e);t&&Md(t)}async function Pd(e){if(await W("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Ed(e),g("Sucesso","Registro removido.","success"),Qa(),la()}catch(a){g("Erro",a.message,"error")}}function Md(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,r=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",r,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const o=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&o.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&o.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:o,theme:"grid"});const s=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Ad(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let r=0,o=0;if(t.forEach(s=>{s.value&&(r=parseFloat(s.value))}),a.forEach(s=>{s.value&&(o=parseFloat(s.value))}),j.calculationResult&&j.calculationResult[e]){const s=j.calculationResult[e];s.extraDebit=r,s.extraCredit=o,s.finalValue=s.summary.totalCommission-r+o,t.forEach(n=>{n!==document.activeElement&&(n.value=r||"")}),a.forEach(n=>{n!==document.activeElement&&(n.value=o||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(n=>n.innerText=`R$ ${s.finalValue.toFixed(2)}`),qd()}}function qd(){const e=j.calculationResult.reduce((a,r)=>a+r.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function Rd(e){const t=j.calculationResult[e];if(!t)return;const a=t.items.map(r=>`
    ...
    `).join("");ne({title:"Detalhes da Comissão",contentHTML:`<div class="bg-gray-50 p-3 rounded-lg mb-4 flex justify-between items-center"><div><p class="text-xs text-gray-500">Profissional</p><p class="font-bold text-gray-800">${t.professionalName}</p></div><div class="text-right"><p class="text-xs text-gray-500">Total Itens</p><p class="font-bold text-gray-800">${t.items.length}</p></div></div><div class="border rounded-lg overflow-hidden max-h-[60vh] overflow-y-auto">${a}</div>`,maxWidth:"max-w-md"})}function Ut(e){if(j.calculationResult){const t=j.calculationResult,a=t.reduce((s,i)=>s+i.finalValue,0),r=t.map((s,i)=>`
            ...
            </div>`}else{const t=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],r=j.professionals.map(o=>`
    ...
    `}function jd(e){const t=j.professionals.map(a=>`<option value="${a.id}" ${j.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,j.historyData.length>0?Os(document.getElementById("history-list-container"),j.historyData):Qa()}function Os(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ba=document.getElementById("content");let Le={allPackages:[],catalogForModal:{services:[],products:[]}},Bt=null,He=null;function Fd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Hd(){const e=document.getElementById("packagesListContainer");if(e){if(Le.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=Le.allPackages.map(t=>{const a=t.status==="active",r=JSON.stringify(t).replace(/'/g,"&apos;"),o=t.price||0,s=t.originalPrice||0,i=s>o?s-o:0,n=s>0?(s-o)/s*100:0,d=h(t.name),l=h(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function To(){const e=document.getElementById("genericModal");e.style.display="none",He&&e.removeEventListener("click",He)}async function Bo(e=null){const t=document.getElementById("genericModal"),a=!!e,r=e?JSON.parse(JSON.stringify(e.items||[])):[],o=h(e?.name||""),s=h(e?.description||""),i=e?.price||"",n=e?.commissionRate||0,d=e?.validityDays||30,l=`
    ...
    `;t.innerHTML=l,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(x,b)=>{const v=b.querySelector("#originalPrice"),f=x.reduce((E,S)=>E+S.price*S.quantity,0);v&&(v.textContent=`R$ ${f.toFixed(2)}`)},m=x=>{x.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=x.map((b,v)=>{const f=b.type==="service",E=f?"Serviço":"Produto",S=f?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(x,t)};m(r),c.addEventListener("change",x=>{if(x.target.classList.contains("quantity-input")){const b=parseInt(x.target.dataset.index,10),v=parseInt(x.target.value,10);v>0&&r[b]&&(r[b].quantity=v,m(r))}}),c.addEventListener("click",x=>{if(x.target.classList.contains("remove-item-btn")){const b=parseInt(x.target.dataset.index,10);r.splice(b,1),m(r)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Od(x=>{const b=r.find(v=>v.id===x.id&&v.type===x.type);b?b.quantity++:r.push({...x,quantity:1}),m(r)}),He&&t.removeEventListener("click",He),He=async x=>{const b=x.target.closest("button[data-action]");if(!b)return;const v=b.dataset.action;if(x.stopPropagation(),v==="close-modal"&&To(),v==="save-package"){const f=b,E={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:r,originalPrice:r.reduce((S,k)=>S+k.price*k.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:p.establishmentId};if(!E.name||!E.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(E.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}f.disabled=!0,f.textContent="A salvar...";try{a?await Ni(E.id,E):(delete E.id,await Ri(E)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),To(),await Xa()}catch(S){g("Erro",`Não foi possível salvar o pacote: ${S.message}`,"error"),f.disabled=!1,f.textContent="Salvar Pacote"}}},t.addEventListener("click",He)}function Od(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const r={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},o=d=>{const l=t.toLowerCase(),c=Le.catalogForModal.services.filter(b=>b.name.toLowerCase().includes(l)),u=Le.catalogForModal.products.filter(b=>b.name.toLowerCase().includes(l)),m=c.map(b=>`
    ...
    `,Bt&&ba.removeEventListener("click",Bt),Bt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const r=e.target.closest('[data-action="delete-package"]');if(r){const o=r.dataset.id;W("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await ji(o),g("Sucesso!","Pacote excluído.","success"),await Xa()}catch(i){g("Erro",`Não foi possível excluir: ${i.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")Bo(null);else if(a==="edit-package"){const r=JSON.parse(t.dataset.package);Bo(r)}},ba.addEventListener("click",Bt);try{const[e,t,a]=await Promise.all([Oa(p.establishmentId),Te(p.establishmentId),ta(p.establishmentId)]);Le.allPackages=e,Le.catalogForModal={services:t.filter(r=>r.active),products:a},Hd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const zd=document.getElementById("content");let Vd=null;async function _d(){const e=h(p.userName||"Usuário"),t=h(ie.currentUser?.email||"E-mail não disponível"),a=p.userName?p.userName.charAt(0):"U";zd.innerHTML=`
    ...
    `,await Ud()}async function Ud(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await ri(t);Vd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const r=h(a.name);e.innerHTML=`
            ...
            `,Wd(a.id),document.getElementById("my-blocks-filter").addEventListener("change",s=>Jt(a.id,s.target.value)),Jt(a.id,"future")}else e.innerHTML=`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const o=(await Xe()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),o.length===0)t.innerHTML=`
            ...
            `;else{let s="";o.forEach(i=>{if(a&&!i.isOrphanBranch){const d=document.createElement("option");d.value=i.id,d.textContent=i.name,a.appendChild(d)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';s+=`
                ...
                `,i.branches&&i.branches.length>0?i.branches.forEach(d=>{s+=`
                ...
                `}),t.innerHTML=s}Po||(Jd(),Po=!0)}catch(r){console.error("Erro na renderização da rede:",r),t.innerHTML=`
        ...
        `}}function Jd(){const e=document.getElementById("form-create-establishment");e&&e.addEventListener("submit",async t=>{t.preventDefault();const a=e.querySelector('button[type="submit"]'),r=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const o={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const s=await Sr(o);alert(s.message||"Sucesso!"),e.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await Gt(document.getElementById("content"))}catch(s){console.error("Erro ao criar estabelecimento:",s),alert("Erro: "+(s.message||"Falha ao gravar dados."))}finally{a.innerHTML=r,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>Gt(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const K=document.getElementById("loadingScreen"),tt=document.getElementById("dashboardContent"),Oe=document.getElementById("content"),fa=document.getElementById("notificationBell"),Pt=document.getElementById("notificationBadge"),qe=document.getElementById("notificationPanel"),xa=document.getElementById("notificationList"),at=document.getElementById("profileMenuButton"),ae=document.getElementById("profileDropdown"),Mo=document.getElementById("profileName"),Ao=document.getElementById("profileEmail"),qo=document.getElementById("logoutButton"),Ro=document.getElementById("myProfileLink"),No=document.getElementById("hamburger-menu-btn"),te=document.getElementById("sidebar"),re=document.getElementById("mobile-overlay"),jo=document.getElementById("themeToggleBtn"),ha=document.getElementById("themeIcon"),Ba=document.getElementById("mobile-bottom-nav"),Qe=document.getElementById("nav-scroll"),Fo=document.getElementById("scroll-hint-left"),Ho=document.getElementById("scroll-hint-right"),Gd=document.querySelectorAll(".bottom-nav-item");function Pa(){if(!Qe||!Fo||!Ho)return;const{scrollLeft:e,scrollWidth:t,clientWidth:a}=Qe;Fo.classList.toggle("visible",e>5),Ho.classList.toggle("visible",e+a<t-5)}function Yd(){if(!Qe)return;const e=document.querySelector(".bottom-nav-item.active");if(!e)return;const t=Qe,a=t.getBoundingClientRect(),r=e.getBoundingClientRect(),s=r.left+r.width/2-a.left-a.width/2;t.scrollBy({left:s,behavior:"smooth"})}const Qd={"dashboard-section":Qr,"agenda-section":ns,"comandas-section":tn,"relatorios-section":xn,"servicos-section":Fn,"produtos-section":Xn,"suppliers-section":Zn,"profissionais-section":zt,"clientes-section":Dl,"estabelecimento-section":e=>Ms(e),"ausencias-section":Jl,"users-section":Vt,"sales-report-section":cd,"financial-section":md,"commissions-section":Id,"packages-section":Xa,"my-profile-section":_d,"hierarquia-section":()=>Gt(Oe),"establishments-section":()=>Gt(Oe)},Oo={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#eef2ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#eff6ff",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#1f2937"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#64748b",hover:"#475569",light:"#f1f5f9",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};function Mt(e){const t=Oo[e]||Oo.indigo,r=(s=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const o=document.getElementById("dynamic-theme-styles");o&&(o.innerHTML=`
            :root {
        ...
        `)}function jt(e){document.documentElement.setAttribute("data-theme",e),localStorage.setItem("kairos_theme",e),ha&&(e==="dark"?ha.innerHTML="☀️":ha.innerHTML="🌙")}function Xd(){const e=localStorage.getItem("kairos_theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches;jt(e||(t?"dark":"light"))}let mt=null,gt=[];function zs(){if(!Pt||!xa)return;const e=gt.filter(t=>!t.read).length;if(e>0?(Pt.textContent=e,Pt.classList.remove("hidden")):Pt.classList.add("hidden"),gt.length===0){xa.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}xa.innerHTML=gt.map(t=>`
    ...
    `).join("")}function zo(e){mt&&mt();const t=Yt(be,"establishments",e,"notifications"),a=Wo(t,Jo("timestamp",">=",new Date),ar("timestamp","desc"));mt=or(a,r=>{r.docChanges().forEach(o=>{if(o.type==="added"){const s=o.doc.data();gt.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(s.title,s.message,"info",!0),zs();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&ns()}})},r=>{console.error("Erro no listener de notificações:",r)})}async function Zd(e){const t=document.getElementById("multi-context-container"),a=document.getElementById("multi-context-btn"),r=document.getElementById("multi-context-label"),o=document.getElementById("multi-context-count"),s=document.getElementById("multi-context-list"),i=document.getElementById("multi-context-apply"),n=document.getElementById("multi-context-dropdown"),d=document.getElementById("multi-context-arrow");if(!(!t||!s))try{const c=(await Xe()).matrizes||[];let u="",m=0;if(c.forEach(x=>{u+=`
                <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors mb-1">
                    <input type="checkbox" value="${x.id}" class="context-checkbox" data-name="${At(x.name)}">
                    <span class="text-[13px] sm:text-sm font-bold text-slate-700 truncate">🏢 ${At(x.name)}</span>
                </label>
            `,m++,x.branches&&x.branches.length>0&&x.branches.forEach(b=>{u+=`
                        <label class="flex items-center gap-3 p-2 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors ml-4 mb-1 border-l-2 border-slate-100 pl-3">
                            <input type="checkbox" value="${b.id}" class="context-checkbox" data-name="${At(b.name)}">
                            <span class="text-[12px] sm:text-[13px] font-medium text-slate-600 truncate">📍 ${At(b.name)}</span>
                        </label>
                    `,m++})}),m>0){s.innerHTML=u,t.style.display="block",(!p.selectedEstablishments||p.selectedEstablishments.length===0)&&(p.selectedEstablishments=[e]);const x=Array.from(s.querySelectorAll('input[type="checkbox"]')),b=()=>{const f=x.filter(E=>E.checked);o.textContent=f.length,f.length===0?r.textContent="Nenhuma selecionada":f.length===1?r.textContent=f[0].dataset.name:r.textContent=`${f.length} Unidades`};let v=!1;x.forEach(f=>{p.selectedEstablishments.includes(f.value)&&(f.checked=!0,v=!0)}),!v&&x.length>0&&(x[0].checked=!0,p.selectedEstablishments=[x[0].value],p.establishmentId=x[0].value),b(),a.addEventListener("click",f=>{f.stopPropagation(),n.classList.toggle("hidden"),d.style.transform=n.classList.contains("hidden")?"rotate(0deg)":"rotate(180deg)"}),document.addEventListener("click",f=>{!t.contains(f.target)&&!n.classList.contains("hidden")&&(n.classList.add("hidden"),d.style.transform="rotate(0deg)",x.forEach(E=>{E.checked=p.selectedEstablishments.includes(E.value)}),b())}),x.forEach(f=>{f.addEventListener("change",b)}),i.addEventListener("click",async f=>{f.stopPropagation(),K&&(K.classList.remove("hidden","fade-out"),K.style.display="flex");const E=x.filter(k=>k.checked);if(E.length===0){K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500)),g("Atenção","Tem de selecionar pelo menos uma unidade.","warning");return}p.selectedEstablishments=E.map(k=>k.value);const S=p.selectedEstablishments[0];try{const k=await Ce(S);p.establishmentId=S,p.establishmentName=k.name,p.enabledModules=k.modules,p.currentViewContext={id:S,name:k.name,type:k.parentId?"BRANCH":"GROUP"},typeof Mt=="function"&&Mt(k.themeColor||"indigo"),zo(S),Vo(p.userPermissions),n.classList.add("hidden"),d.style.transform="rotate(0deg)",g("Ambiente Atualizado","Exibindo informações consolidadas.","success");const T=document.querySelector(".sidebar-link.active"),L=T?T.getAttribute("data-target"):"dashboard-section";J(L)}catch(k){console.error("Erro ao aplicar contextos:",k),g("Erro","Ocorreu um problema ao trocar a visualização.","error")}finally{K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500))}});try{const f=await Ce(p.establishmentId);p.establishmentName=f.name,p.enabledModules=f.modules,p.currentViewContext={id:p.establishmentId,name:f.name,type:f.parentId?"BRANCH":"GROUP"},typeof Mt=="function"&&Mt(f.themeColor||"indigo"),zo(p.establishmentId),Vo(p.userPermissions)}catch(f){console.error(f)}}else t.style.display="none"}catch(l){console.error("Erro ao carregar switcher de contexto:",l),t.style.display="none"}}function J(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const o=["hierarquia-section","establishments-section","estabelecimento-section","dashboard-section"].includes(e),s=p.enabledModules?.[a]!==!1,i=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!o&&(!s||!i)){Oe&&(Oe.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),te&&te.classList.contains("absolute")&&(te.classList.add("hidden"),re&&re.classList.add("hidden"));return}}const r=Qd[e];r&&Oe&&(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),Ba&&(Gd.forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===e)}),setTimeout(Yd,50),setTimeout(Pa,100)),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),Oe.innerHTML="",window.innerWidth<768&&te&&(te.classList.add("hidden"),re&&re.classList.add("hidden")),r(t))}window.navigateTo=J;async function Vo(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),r=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,i=e===null||e["financial-section"]?.view===!0;if(s&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!s&&!i))try{const n=await Wr();s&&r&&(r.textContent=n.todayAppointments.toString()),i&&o&&(o.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch(n){console.error("Erro ao carregar KPIs do cabeçalho:",n)}}async function Kd(e){try{pe.getPlatform()==="android"&&await ee.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0});let t=await ee.checkPermissions();if(t.receive==="prompt"&&(t=await ee.requestPermissions()),t.receive!=="granted")return;await ee.register(),ee.addListener("registration",async a=>{try{const r=xt(be,"users",e);await Ma(r,{fcmTokens:tr(a.value),platform:"native_mobile"})}catch{}}),ee.addListener("pushNotificationReceived",a=>g(a.title,a.body,"info",!0)),ee.addListener("pushNotificationActionPerformed",()=>J("agenda-section"))}catch{}}function ec(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),r=()=>e&&(e.style.display="block"),o=()=>e&&(e.style.display="none"),s=()=>e&&e.style.display==="block";e&&(t.addEventListener("click",()=>{o(),pe.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{o(),pe.isNativePlatform()?oo.exitApp():history.back()}),pe.isNativePlatform()?oo.addListener("backButton",()=>{if(s())o();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(l=>l.id!=="exitConfirmationModal");if(n.length>0){n.forEach(l=>l.style.display="none");return}if(te&&!te.classList.contains("hidden")&&window.innerWidth<768){te.classList.add("hidden"),re&&re.classList.add("hidden");return}const d=document.querySelector(".sidebar-link.active");d&&d.getAttribute("data-target")==="dashboard-section"?r():J("dashboard-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(s()){o(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(l=>l.id!=="exitConfirmationModal");if(n.length>0){n.forEach(l=>l.style.display="none"),history.pushState(null,document.title,location.href);return}const d=document.querySelector(".sidebar-link.active");d&&d.getAttribute("data-target")==="dashboard-section"?r():(J("dashboard-section"),history.pushState(null,document.title,location.href))})))}function At(e){return e?e.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}async function tc(){try{await Gs(ie,Ys)}catch{}pe.isNativePlatform()&&document.body.classList.add("is-app-native"),fr(),ec(),Xd(),jo&&jo.addEventListener("click",e=>{e.preventDefault();const t=document.documentElement.getAttribute("data-theme");jt(t==="dark"?"light":"dark")}),No&&No.addEventListener("click",e=>{e.stopPropagation(),te&&(te.classList.remove("hidden"),te.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),re&&re.classList.remove("hidden")}),Ba&&(Ba.addEventListener("click",e=>{const t=e.target.closest(".bottom-nav-item");if(!t)return;e.preventDefault();const a=t.getAttribute("data-target");J(a)}),Qe&&Qe.addEventListener("scroll",Pa),Pa()),re&&re.addEventListener("click",()=>{te&&(te.classList.add("hidden"),te.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),re.classList.add("hidden")}),fa&&fa.addEventListener("click",e=>{e.stopPropagation(),qe&&(qe.classList.toggle("hidden"),qe.classList.contains("hidden")||(gt.forEach(t=>t.read=!0),zs()))}),at&&at.addEventListener("click",e=>{e.stopPropagation(),ae&&(ae.classList.toggle("active"),ae.classList.contains("active")?ae.classList.remove("hidden"):setTimeout(()=>ae.classList.add("hidden"),200))}),Ro&&Ro.addEventListener("click",e=>{e.preventDefault(),J("my-profile-section"),ae&&(ae.classList.remove("active"),ae.classList.add("hidden"))}),document.addEventListener("click",e=>{qe&&!qe.contains(e.target)&&e.target!==fa&&qe.classList.add("hidden"),ae&&!ae.contains(e.target)&&e.target!==at&&ae.classList.contains("active")&&(ae.classList.remove("active"),setTimeout(()=>ae.classList.add("hidden"),200))}),Qs(ie,async e=>{if(e){if(!pe.isNativePlatform()&&(Or(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");t&&setTimeout(()=>{t.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await zr()&&t&&(t.style.display="none")});const r=()=>{t&&(t.style.display="none")},o=document.getElementById("btn-deny-toast"),s=document.getElementById("btn-close-toast");o&&o.addEventListener("click",r),s&&s.addEventListener("click",r)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){let r=null,o=e.displayName,s=null;const i=xt(be,"users",e.uid),n=await _o(i);if(n.exists()){const l=n.data();r=a.role==="employee"?l.permissions||{}:null,o=l.name||o,s=l.professionalId||null}p.userProfessionalId=s,pe.isNativePlatform()&&Kd(e.uid);const d=o||e.email;ir(a.establishmentId,"Carregando...",r),at&&(at.textContent=d.charAt(0).toUpperCase()),Mo&&(Mo.textContent=d),Ao&&(Ao.textContent=e.email),qo&&qo.addEventListener("click",l=>{l.preventDefault(),mt&&mt(),Xs(ie).then(()=>window.location.href="/login.html")}),await Zd(a.establishmentId),kr(J,r,p.enabledModules),K&&(K.classList.add("fade-out"),setTimeout(()=>{K.style.display="none"},500)),tt&&(tt.style.display="flex"),setTimeout(()=>{Lr()},1500),J("dashboard-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(t){console.error("Erro na inicialização:",t),K&&(K.style.display="none"),tt&&(tt.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><h2>Erro de Acesso</h2><p>${t.message}</p></div>`,tt.style.display="flex")}}else window.location.href="/login.html"})}tc();export{Yo as W};
