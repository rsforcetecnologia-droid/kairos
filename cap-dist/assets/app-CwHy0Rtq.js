...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${a.status}) em ${r}:`,c),new Error(c)}return a.json()}catch(a){throw console.error(`Falha de rede ao tentar acessar ${r}:`,a.message),a.message.includes("Failed to fetch")||a.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Aa}. Verifique sua conexão com a internet.`):a}}const nu=(t,e,s,n=null)=>{let o=`/api/appointments/${t}?startDate=${e}&endDate=${s}`;return n&&(o+=`&professionalId=${n}`),F(o)},gh=(t,e,s)=>{const n=`/api/appointments/cancelled/${t}?startDate=${e}&endDate=${s}`;return F(n)},fh=({establishmentId:t,professionalId:e,serviceIds:s,date:n})=>{const o=`/api/availability?establishmentId=${t}&professionalId=${e}&serviceIds=${s.join(",")}&date=${n}`;return F(o)},bh=t=>F("/api/appointments",{method:"POST",body:JSON.stringify(t)}),ii=(t,e)=>F(`/api/appointments/${t}`,{method:"PUT",body:JSON.stringify(e)}),vh=t=>F(`/api/appointments/${t}`,{method:"DELETE"}),yh=t=>F(`/api/appointments/${t}/reopen`,{method:"POST"}),xh=(t,e)=>F(`/api/appointments/${t}/checkout`,{method:"POST",body:JSON.stringify(e)});let Re;async function wh(){if(!Re)try{Re=new(window.AudioContext||window.webkitAudioContext)}catch(t){console.error("Não foi possível inicializar o áudio:",t)}}function Eh(){if(!Re){console.warn("AudioContext não inicializado. O som não será tocado.");return}Re.state==="suspended"&&Re.resume();const t=Re.createOscillator(),e=Re.createGain();t.connect(e),e.connect(Re.destination),t.type="sine",t.frequency.setValueAtTime(800,Re.currentTime),e.gain.setValueAtTime(0,Re.currentTime),e.gain.linearRampToValueAtTime(.3,Re.currentTime+.01),e.gain.exponentialRampToValueAtTime(1e-4,Re.currentTime+.2),t.start(Re.currentTime),t.stop(Re.currentTime+.2)}function k(t,e,s="info",n=!1){const o=document.getElementById("toast-container");if(!o)return;n&&Eh();const r=document.createElement("div"),a={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},l={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},c={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${a[s]||a.info}`,r.innerHTML=`
    ...
    `,o.appendChild(r),r.querySelector(".toast-close").addEventListener("click",()=>r.remove()),setTimeout(()=>{r.remove()},4e3)}function ce(t,e){const s=document.getElementById("genericModal");return new Promise(n=>{s.innerHTML=`
    ...
    `,document.body.appendChild(Ct),li())}function li(){const t=Math.round(Ge/_o.length*100),e=document.getElementById("progress-bar"),s=document.getElementById("progress-text");e&&(e.style.width=`${t}%`),s&&(s.innerText=`${t}%`)}function ci(t){const e=document.getElementById("onboarding-step-content"),s=_o[t];if(!s){pc(e);return}let n="";if(s.id==="company_data")n=`
        ...
        `;else if(s.id==="first_prof"){const o=Bo.map(a=>`<option value="${a.id}">${a.name}</option>`).join(""),r=Bo.length>0;n=`
            <form id="step-form" class="space-y-3">
        ...
        <div class="mt-6 flex justify-end gap-2">
            ...
            <button type="button" id="next-step-btn" class="bg-indigo-600 text-white font-bold py-2 px-5 rounded-lg hover:bg-indigo-700 transition flex items-center gap-2 text-sm">
                ${t===_o.length-1?"Concluir":"Próximo"}
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
            </button>
        </div>
    `,document.getElementById("next-step-btn").addEventListener("click",()=>Uh(s.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{t===_o.length-1?pc(e):(Ge++,li(),ci(Ge))}),s.id==="branding"){const o=document.getElementById("logo-input"),r=document.getElementById("bg-input");o&&(o.onchange=async a=>{const l=a.target.files[0];if(l)try{const c=await mc(l,200,.8);document.getElementById("logo-base64").value=c,document.getElementById("logo-preview").innerHTML=`<img src="${c}" class="w-full h-full object-contain rounded">`}catch(c){console.error("Erro logo",c)}}),r&&(r.onchange=async a=>{const l=a.target.files[0];if(l)try{const c=await mc(l,1024,.7);document.getElementById("bg-base64").value=c}catch(c){console.error("Erro bg",c)}})}}function pc(t){t.innerHTML=`
...
`+t.stack),e}class Mi extends hm{constructor(e,s,n,o){super(e,s,n,o),this.type="firestore",this._queue=new md,this._persistenceKey=o?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new md(e),this._firestoreClient=void 0,await e}}}function Zb(t){if(t._terminated)throw new z(M.FAILED_PRECONDITION,"The client has already been terminated.");return t._firestoreClient||ev(t),t._firestoreClient}function ev(t){const e=t._freezeSettings(),s=(function(o,r,a,l){return new Kf(o,r,a,l.host,l.ssl,l.experimentalForceLongPolling,l.experimentalAutoDetectLongPolling,pm(l.experimentalLongPollingOptions),l.useFetchStreams,l.isUsingEmulator)})(t._databaseId,t._app?.options.appId||"",t._persistenceKey,e);t._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(t._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),t._firestoreClient=new Gb(t._authCredentials,t._appCheckCredentials,t._queue,s,t._componentsProvider&&(function(o){const r=o?._online.build();return{_offline:o?._offline.build(r),_online:r}})(t._componentsProvider))}class Je{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Je(ot.fromBase64String(e))}catch(s){throw new z(M.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+s)}}static fromUint8Array(e){return new Je(ot.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:Je._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Fn(e,Je._jsonSchema))return Je.fromBase64String(e.bytes)}}Je._jsonSchemaVersion="firestore/bytes/1.0",Je._jsonSchema={type:fe("string",Je._jsonSchemaVersion),bytes:fe("string")};class br{constructor(...e){for(let s=0;s<e.length;++s)if(e[s].length===0)throw new z(M.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ie(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}class vr{constructor(e){this._methodName=e}}class pt{constructor(e,s){if(!isFinite(e)||e<-90||e>90)throw new z(M.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(s)||s<-180||s>180)throw new z(M.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+s);this._lat=e,this._long=s}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return se(this._lat,e._lat)||se(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:pt._jsonSchemaVersion}}static fromJSON(e){if(Fn(e,pt._jsonSchema))return new pt(e.latitude,e.longitude)}}pt._jsonSchemaVersion="firestore/geoPoint/1.0",pt._jsonSchema={type:fe("string",pt._jsonSchemaVersion),latitude:fe("number"),longitude:fe("number")};class ht{constructor(e){this._values=(e||[]).map((s=>s))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(n,o){if(n.length!==o.length)return!1;for(let r=0;r<n.length;++r)if(n[r]!==o[r])return!1;return!0})(this._values,e._values)}toJSON(){return{type:ht._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Fn(e,ht._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((s=>typeof s=="number")))return new ht(e.vectorValues);throw new z(M.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}ht._jsonSchemaVersion="firestore/vectorValue/1.0",ht._jsonSchema={type:fe("string",ht._jsonSchemaVersion),vectorValues:fe("object")};const tv=/^__.*__$/;class sv{constructor(e,s,n){this.data=e,this.fieldMask=s,this.fieldTransforms=n}toMutation(e,s){return this.fieldMask!==null?new Nt(e,this.data,this.fieldMask,s,this.fieldTransforms):new qn(e,this.data,s,this.fieldTransforms)}}class gm{constructor(e,s,n){this.data=e,this.fieldMask=s,this.fieldTransforms=n}toMutation(e,s){return new Nt(e,this.data,this.fieldMask,s,this.fieldTransforms)}}function fm(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Y(40011,{Ac:t})}}class yr{constructor(e,s,n,o,r,a){this.settings=e,this.databaseId=s,this.serializer=n,this.ignoreUndefinedProperties=o,r===void 0&&this.Rc(),this.fieldTransforms=r||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new yr({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){const s=this.path?.child(e),n=this.Vc({path:s,fc:!1});return n.gc(e),n}yc(e){const s=this.path?.child(e),n=this.Vc({path:s,fc:!1});return n.Rc(),n}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return Jo(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return this.fieldMask.find((s=>e.isPrefixOf(s)))!==void 0||this.fieldTransforms.find((s=>e.isPrefixOf(s.field)))!==void 0}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(e.length===0)throw this.Sc("Document fields must not be empty");if(fm(this.Ac)&&tv.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class nv{constructor(e,s,n){this.databaseId=e,this.ignoreUndefinedProperties=s,this.serializer=n||pr(e)}Cc(e,s,n,o=!1){return new yr({Ac:e,methodName:s,Dc:n,path:Ie.emptyPath(),fc:!1,bc:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function bm(t){const e=t._freezeSettings(),s=pr(t._databaseId);return new nv(t._databaseId,!!e.ignoreUndefinedProperties,s)}function ov(t,e,s,n,o,r={}){const a=t.Cc(r.merge||r.mergeFields?2:0,e,s,o);Bi("Data must be an object, but it was:",a,n);const l=vm(n,a);let c,d;if(r.merge)c=new ze(a.fieldMask),d=a.fieldTransforms;else if(r.mergeFields){const p=[];for(const h of r.mergeFields){const b=Wa(e,h,s);if(!a.contains(b))throw new z(M.INVALID_ARGUMENT,`Field '${b}' is specified in your field mask but missing from your input data.`);xm(p,b)||p.push(b)}c=new ze(p),d=a.fieldTransforms.filter((h=>c.covers(h.field)))}else c=null,d=a.fieldTransforms;return new sv(new Ue(l),c,d)}class xr extends vr{_toFieldTransform(e){if(e.Ac!==2)throw e.Ac===1?e.Sc(`${this._methodName}() can only appear at the top level of your update data`):e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof xr}}function rv(t,e,s){return new yr({Ac:3,Dc:e.settings.Dc,methodName:t._methodName,fc:s},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class Ni extends vr{constructor(e,s){super(e),this.vc=s}_toFieldTransform(e){const s=rv(this,e,!0),n=this.vc.map((r=>zn(r,s))),o=new Ms(n);return new E0(e.path,o)}isEqual(e){return e instanceof Ni&&mu(this.vc,e.vc)}}function av(t,e,s,n){const o=t.Cc(1,e,s);Bi("Data must be an object, but it was:",o,n);const r=[],a=Ue.empty();ms(n,((c,d)=>{const p=Vi(e,c,s);d=ft(d);const h=o.yc(p);if(d instanceof xr)r.push(p);else{const b=zn(d,h);b!=null&&(r.push(p),a.set(p,b))}}));const l=new ze(r);return new gm(a,l,o.fieldTransforms)}function iv(t,e,s,n,o,r){const a=t.Cc(1,e,s),l=[Wa(e,n,s)],c=[o];if(r.length%2!=0)throw new z(M.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let b=0;b<r.length;b+=2)l.push(Wa(e,r[b])),c.push(r[b+1]);const d=[],p=Ue.empty();for(let b=l.length-1;b>=0;--b)if(!xm(d,l[b])){const w=l[b];let S=c[b];S=ft(S);const _=a.yc(w);if(S instanceof xr)d.push(w);else{const D=zn(S,_);D!=null&&(d.push(w),p.set(w,D))}}const h=new ze(d);return new gm(p,h,a.fieldTransforms)}function zn(t,e){if(ym(t=ft(t)))return Bi("Unsupported field value:",e,t),vm(t,e);if(t instanceof vr)return(function(n,o){if(!fm(o.Ac))throw o.Sc(`${n._methodName}() can only be used with update() and set()`);if(!o.path)throw o.Sc(`${n._methodName}() is not currently supported inside arrays`);const r=n._toFieldTransform(o);r&&o.fieldTransforms.push(r)})(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.fc&&e.Ac!==4)throw e.Sc("Nested arrays are not supported");return(function(n,o){const r=[];let a=0;for(const l of n){let c=zn(l,o.wc(a));c==null&&(c={nullValue:"NULL_VALUE"}),r.push(c),a++}return{arrayValue:{values:r}}})(t,e)}return(function(n,o){if((n=ft(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return y0(o.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const r=ue.fromDate(n);return{timestampValue:qa(o.serializer,r)}}if(n instanceof ue){const r=new ue(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:qa(o.serializer,r)}}if(n instanceof pt)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof Je)return{bytesValue:L0(o.serializer,n._byteString)};if(n instanceof Se){const r=o.databaseId,a=n.firestore._databaseId;if(!a.isEqual(r))throw o.Sc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:em(n.firestore._databaseId||o.databaseId,n._key.path)}}if(n instanceof ht)return(function(a,l){return{mapValue:{fields:{[Du]:{stringValue:Lu},[Na]:{arrayValue:{values:a.toArray().map((d=>{if(typeof d!="number")throw l.Sc("VectorValues must only contain numeric values.");return _i(l.serializer,d)}))}}}}}})(n,o);throw o.Sc(`Unsupported field value: ${bi(n)}`)})(t,e)}function vm(t,e){const s={};return Cu(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):ms(t,((n,o)=>{const r=zn(o,e.mc(n));r!=null&&(s[n]=r)})),{mapValue:{fields:s}}}function ym(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof ue||t instanceof pt||t instanceof Je||t instanceof Se||t instanceof vr||t instanceof ht)}function Bi(t,e,s){if(!ym(s)||!Tu(s)){const n=bi(s);throw n==="an object"?e.Sc(t+" a custom object"):e.Sc(t+" "+n)}}function Wa(t,e,s){if((e=ft(e))instanceof br)return e._internalPath;if(typeof e=="string")return Vi(t,e);throw Jo("Field path arguments must be of type string or ",t,!1,void 0,s)}const lv=new RegExp("[~\\*/\\[\\]]");function Vi(t,e,s){if(e.search(lv)>=0)throw Jo(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,s);try{return new br(...e.split("."))._internalPath}catch{throw Jo(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,s)}}function Jo(t,e,s,n,o){const r=n&&!n.isEmpty(),a=o!==void 0;let l=`Function ${e}() called with invalid data`;s&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(r||a)&&(c+=" (found",r&&(c+=` in field ${n}`),a&&(c+=` in document ${o}`),c+=")"),new z(M.INVALID_ARGUMENT,l+t+c)}function xm(t,e){return t.some((s=>s.isEqual(e)))}class wm{constructor(e,s,n,o,r){this._firestore=e,this._userDataWriter=s,this._key=n,this._document=o,this._converter=r}get id(){return this._key.path.lastSegment()}get ref(){return new Se(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new cv(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const s=this._document.data.field(Em("DocumentSnapshot.get",e));if(s!==null)return this._userDataWriter.convertValue(s)}}}class cv extends wm{data(){return super.data()}}function Em(t,e){return typeof e=="string"?Vi(t,e):e instanceof br?e._internalPath:e._delegate._internalPath}function dv(t,e,s){let n;return n=t?s&&(s.merge||s.mergeFields)?t.toFirestore(e,s):t.toFirestore(e):e,n}class go{constructor(e,s){this.hasPendingWrites=e,this.fromCache=s}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class ks extends wm{constructor(e,s,n,o,r,a){super(e,s,n,o,a),this._firestore=e,this._firestoreImpl=e,this.metadata=r}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const s=new Lo(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(s,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,s={}){if(this._document){const n=this._document.data.field(Em("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n,s.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new z(M.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e=this._document,s={};return s.type=ks._jsonSchemaVersion,s.bundle="",s.bundleSource="DocumentSnapshot",s.bundleName=this._key.toString(),!e||!e.isValidDocument()||!e.isFoundDocument()?s:(this._userDataWriter.convertObjectMap(e.data.value.mapValue.fields,"previous"),s.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),s)}}ks._jsonSchemaVersion="firestore/documentSnapshot/1.0",ks._jsonSchema={type:fe("string",ks._jsonSchemaVersion),bundleSource:fe("string","DocumentSnapshot"),bundleName:fe("string"),bundle:fe("string")};class Lo extends ks{data(e={}){return super.data(e)}}class xn{constructor(e,s,n,o){this._firestore=e,this._userDataWriter=s,this._snapshot=o,this.metadata=new go(o.hasPendingWrites,o.fromCache),this.query=n}get docs(){const e=[];return this.forEach((s=>e.push(s))),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,s){this._snapshot.docs.forEach((n=>{e.call(s,new Lo(this._firestore,this._userDataWriter,n.key,n,new go(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const s=!!e.includeMetadataChanges;if(s&&this._snapshot.excludesMetadataChanges)throw new z(M.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===s||(this._cachedChanges=(function(o,r){if(o._snapshot.oldDocs.isEmpty()){let a=0;return o._snapshot.docChanges.map((l=>{const c=new Lo(o._firestore,o._userDataWriter,l.doc.key,l.doc,new go(o._snapshot.mutatedKeys.has(l.doc.key),o._snapshot.fromCache),o.query.converter);return l.doc,{type:"added",doc:c,oldIndex:-1,newIndex:a++}}))}{let a=o._snapshot.oldDocs;return o._snapshot.docChanges.filter((l=>r||l.type!==3)).map((l=>{const c=new Lo(o._firestore,o._userDataWriter,l.doc.key,l.doc,new go(o._snapshot.mutatedKeys.has(l.doc.key),o._snapshot.fromCache),o.query.converter);let d=-1,p=-1;return l.type!==0&&(d=a.indexOf(l.doc.key),a=a.delete(l.doc.key)),l.type!==1&&(a=a.add(l.doc),p=a.indexOf(l.doc.key)),{type:uv(l.type),doc:c,oldIndex:d,newIndex:p}}))}})(this,s),this._cachedChangesIncludeMetadataChanges=s),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new z(M.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const e={};e.type=xn._jsonSchemaVersion,e.bundleSource="QuerySnapshot",e.bundleName=fi.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const s=[],n=[],o=[];return this.docs.forEach((r=>{r._document!==null&&(s.push(r._document),n.push(this._userDataWriter.convertObjectMap(r._document.data.value.mapValue.fields,"previous")),o.push(r.ref.path))})),e.bundle=(this._firestore,this.query._query,e.bundleName,"NOT SUPPORTED"),e}}function uv(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Y(61501,{type:t})}}xn._jsonSchemaVersion="firestore/querySnapshot/1.0",xn._jsonSchema={type:fe("string",xn._jsonSchemaVersion),bundleSource:fe("string","QuerySnapshot"),bundleName:fe("string"),bundle:fe("string")};function mv(t,e,s){t=Vo(t,Se);const n=Vo(t.firestore,Mi),o=dv(t.converter,e,s);return Im(n,[ov(bm(n),"setDoc",t._key,o,t.converter!==null,s).toMutation(t._key,nt.none())])}function pv(t,e,s,...n){t=Vo(t,Se);const o=Vo(t.firestore,Mi),r=bm(o);let a;return a=typeof(e=ft(e))=="string"||e instanceof br?iv(r,"updateDoc",t._key,e,s,n):av(r,"updateDoc",t._key,e),Im(o,[a.toMutation(t._key,nt.exists(!0))])}function Im(t,e){return(function(n,o){const r=new Xt;return n.asyncQueue.enqueueAndForget((async()=>qb(await Qb(n),o,r))),r.promise})(Zb(t),e)}function hv(...t){return new Ni("arrayUnion",t)}(function(e,s=!0){(function(o){qs=o})(hf),Pt(new At("firestore",((n,{instanceIdentifier:o,options:r})=>{const a=n.getProvider("app").getImmediate(),l=new Mi(new Cf(n.getProvider("auth-internal")),new Pf(a,n.getProvider("app-check-internal")),(function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new z(M.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new qo(d.options.projectId,p)})(a,o),a);return r={useFetchStreams:s,...r},l._setSettings(r),l}),"PUBLIC").setMultipleInstances(!0)),mt(_c,Ac,e),mt(_c,Ac,"esm2020")})();const Sm="@firebase/installations",Fi="0.6.19";const Tm=1e4,km=`w:${Fi}`,Cm="FIS_v2",gv="https://firebaseinstallations.googleapis.com/v1",fv=3600*1e3,bv="installations",vv="Installations";const yv={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},is=new lr(bv,vv,yv);function _m(t){return t instanceof us&&t.code.includes("request-failed")}function Am({projectId:t}){return`${gv}/projects/${t}/installations`}function Pm(t){return{token:t.token,requestStatus:2,expiresIn:wv(t.expiresIn),creationTime:Date.now()}}async function $m(t,e){const n=(await e.json()).error;return is.create("request-failed",{requestName:t,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function Dm({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function xv(t,{refreshToken:e}){const s=Dm(t);return s.append("Authorization",Ev(e)),s}async function Lm(t){const e=await t();return e.status>=500&&e.status<600?t():e}function wv(t){return Number(t.replace("s","000"))}function Ev(t){return`${Cm} ${t}`}async function Iv({appConfig:t,heartbeatServiceProvider:e},{fid:s}){const n=Am(t),o=Dm(t),r=e.getImmediate({optional:!0});if(r){const d=await r.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const a={fid:s,authVersion:Cm,appId:t.appId,sdkVersion:km},l={method:"POST",headers:o,body:JSON.stringify(a)},c=await Lm(()=>fetch(n,l));if(c.ok){const d=await c.json();return{fid:d.fid||s,registrationStatus:2,refreshToken:d.refreshToken,authToken:Pm(d.authToken)}}else throw await $m("Create Installation",c)}function Rm(t){return new Promise(e=>{setTimeout(e,t)})}function Sv(t){return btoa(String.fromCharCode(...t)).replace(/\+/g,"-").replace(/\//g,"_")}const Tv=/^[cdef][\w-]{21}$/,Ga="";function kv(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const s=Cv(t);return Tv.test(s)?s:Ga}catch{return Ga}}function Cv(t){return Sv(t).substr(0,22)}function wr(t){return`${t.appName}!${t.appId}`}const Mm=new Map;function Nm(t,e){const s=wr(t);Bm(s,e),_v(s,e)}function Bm(t,e){const s=Mm.get(t);if(s)for(const n of s)n(e)}function _v(t,e){const s=Av();s&&s.postMessage({key:t,fid:e}),Pv()}let Jt=null;function Av(){return!Jt&&"BroadcastChannel"in self&&(Jt=new BroadcastChannel("[Firebase] FID Change"),Jt.onmessage=t=>{Bm(t.data.key,t.data.fid)}),Jt}function Pv(){Mm.size===0&&Jt&&(Jt.close(),Jt=null)}const $v="firebase-installations-database",Dv=1,ls="firebase-installations-store";let pa=null;function Oi(){return pa||(pa=cr($v,Dv,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(ls)}}})),pa}async function Qo(t,e){const s=wr(t),o=(await Oi()).transaction(ls,"readwrite"),r=o.objectStore(ls),a=await r.get(s);return await r.put(e,s),await o.done,(!a||a.fid!==e.fid)&&Nm(t,e.fid),e}async function Vm(t){const e=wr(t),n=(await Oi()).transaction(ls,"readwrite");await n.objectStore(ls).delete(e),await n.done}async function Er(t,e){const s=wr(t),o=(await Oi()).transaction(ls,"readwrite"),r=o.objectStore(ls),a=await r.get(s),l=e(a);return l===void 0?await r.delete(s):await r.put(l,s),await o.done,l&&(!a||a.fid!==l.fid)&&Nm(t,l.fid),l}async function qi(t){let e;const s=await Er(t.appConfig,n=>{const o=Lv(n),r=Rv(t,o);return e=r.registrationPromise,r.installationEntry});return s.fid===Ga?{installationEntry:await e}:{installationEntry:s,registrationPromise:e}}function Lv(t){const e=t||{fid:kv(),registrationStatus:0};return Fm(e)}function Rv(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(is.create("app-offline"));return{installationEntry:e,registrationPromise:o}}const s={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},n=Mv(t,s);return{installationEntry:s,registrationPromise:n}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:Nv(t)}:{installationEntry:e}}async function Mv(t,e){try{const s=await Iv(t,e);return Qo(t.appConfig,s)}catch(s){throw _m(s)&&s.customData.serverCode===409?await Vm(t.appConfig):await Qo(t.appConfig,{fid:e.fid,registrationStatus:0}),s}}async function Nv(t){let e=await hd(t.appConfig);for(;e.registrationStatus===1;)await Rm(100),e=await hd(t.appConfig);if(e.registrationStatus===0){const{installationEntry:s,registrationPromise:n}=await qi(t);return n||s}return e}function hd(t){return Er(t,e=>{if(!e)throw is.create("installation-not-found");return Fm(e)})}function Fm(t){return Bv(t)?{fid:t.fid,registrationStatus:0}:t}function Bv(t){return t.registrationStatus===1&&t.registrationTime+Tm<Date.now()}async function Vv({appConfig:t,heartbeatServiceProvider:e},s){const n=Fv(t,s),o=xv(t,s),r=e.getImmediate({optional:!0});if(r){const d=await r.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const a={installation:{sdkVersion:km,appId:t.appId}},l={method:"POST",headers:o,body:JSON.stringify(a)},c=await Lm(()=>fetch(n,l));if(c.ok){const d=await c.json();return Pm(d)}else throw await $m("Generate Auth Token",c)}function Fv(t,{fid:e}){return`${Am(t)}/${e}/authTokens:generate`}async function ji(t,e=!1){let s;const n=await Er(t.appConfig,r=>{if(!Om(r))throw is.create("not-registered");const a=r.authToken;if(!e&&jv(a))return r;if(a.requestStatus===1)return s=Ov(t,e),r;{if(!navigator.onLine)throw is.create("app-offline");const l=Uv(r);return s=qv(t,l),l}});return s?await s:n.authToken}async function Ov(t,e){let s=await gd(t.appConfig);for(;s.authToken.requestStatus===1;)await Rm(100),s=await gd(t.appConfig);const n=s.authToken;return n.requestStatus===0?ji(t,e):n}function gd(t){return Er(t,e=>{if(!Om(e))throw is.create("not-registered");const s=e.authToken;return zv(s)?{...e,authToken:{requestStatus:0}}:e})}async function qv(t,e){try{const s=await Vv(t,e),n={...e,authToken:s};return await Qo(t.appConfig,n),s}catch(s){if(_m(s)&&(s.customData.serverCode===401||s.customData.serverCode===404))await Vm(t.appConfig);else{const n={...e,authToken:{requestStatus:0}};await Qo(t.appConfig,n)}throw s}}function Om(t){return t!==void 0&&t.registrationStatus===2}function jv(t){return t.requestStatus===2&&!Hv(t)}function Hv(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+fv}function Uv(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function zv(t){return t.requestStatus===1&&t.requestTime+Tm<Date.now()}async function Wv(t){const e=t,{installationEntry:s,registrationPromise:n}=await qi(e);return n?n.catch(console.error):ji(e).catch(console.error),s.fid}async function Gv(t,e=!1){const s=t;return await Kv(s),(await ji(s,e)).token}async function Kv(t){const{registrationPromise:e}=await qi(t);e&&await e}function Jv(t){if(!t||!t.options)throw ha("App Configuration");if(!t.name)throw ha("App Name");const e=["projectId","apiKey","appId"];for(const s of e)if(!t.options[s])throw ha(s);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function ha(t){return is.create("missing-app-config-values",{valueName:t})}const qm="installations",Qv="installations-internal",Xv=t=>{const e=t.getProvider("app").getImmediate(),s=Jv(e),n=fu(e,"heartbeat");return{app:e,appConfig:s,heartbeatServiceProvider:n,_delete:()=>Promise.resolve()}},Yv=t=>{const e=t.getProvider("app").getImmediate(),s=fu(e,qm).getImmediate();return{getId:()=>Wv(s),getToken:o=>Gv(s,o)}};function Zv(){Pt(new At(qm,Xv,"PUBLIC")),Pt(new At(Qv,Yv,"PRIVATE"))}Zv();mt(Sm,Fi);mt(Sm,Fi,"esm2020");const ey="/firebase-messaging-sw.js",ty="/firebase-cloud-messaging-push-scope",jm="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",sy="https://fcmregistrations.googleapis.com/v1",Hm="google.c.a.c_id",ny="google.c.a.c_l",oy="google.c.a.ts",ry="google.c.a.e",fd=1e4;var bd;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(bd||(bd={}));var Rn;(function(t){t.PUSH_RECEIVED="push-received",t.NOTIFICATION_CLICKED="notification-clicked"})(Rn||(Rn={}));function it(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function ay(t){const e="=".repeat((4-t.length%4)%4),s=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),n=atob(s),o=new Uint8Array(n.length);for(let r=0;r<n.length;++r)o[r]=n.charCodeAt(r);return o}const ga="fcm_token_details_db",iy=5,vd="fcm_token_object_Store";async function ly(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(ga))return null;let e=null;return(await cr(ga,iy,{upgrade:async(n,o,r,a)=>{if(o<2||!n.objectStoreNames.contains(vd))return;const l=a.objectStore(vd),c=await l.index("fcmSenderId").get(t);if(await l.clear(),!!c){if(o===2){const d=c;if(!d.auth||!d.p256dh||!d.endpoint)return;e={token:d.fcmToken,createTime:d.createTime??Date.now(),subscriptionOptions:{auth:d.auth,p256dh:d.p256dh,endpoint:d.endpoint,swScope:d.swScope,vapidKey:typeof d.vapidKey=="string"?d.vapidKey:it(d.vapidKey)}}}else if(o===3){const d=c;e={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:it(d.auth),p256dh:it(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:it(d.vapidKey)}}}else if(o===4){const d=c;e={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:it(d.auth),p256dh:it(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:it(d.vapidKey)}}}}}})).close(),await aa(ga),await aa("fcm_vapid_details_db"),await aa("undefined"),cy(e)?e:null}function cy(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}const dy="firebase-messaging-database",uy=1,Mn="firebase-messaging-store";let fa=null;function Um(){return fa||(fa=cr(dy,uy,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Mn)}}})),fa}async function my(t){const e=zm(t),n=await(await Um()).transaction(Mn).objectStore(Mn).get(e);if(n)return n;{const o=await ly(t.appConfig.senderId);if(o)return await Hi(t,o),o}}async function Hi(t,e){const s=zm(t),o=(await Um()).transaction(Mn,"readwrite");return await o.objectStore(Mn).put(e,s),await o.done,e}function zm({appConfig:t}){return t.appId}const py={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"only-available-in-window":"This method is available in a Window context.","only-available-in-sw":"This method is available in a service worker context.","permission-default":"The notification permission was not granted and dismissed instead.","permission-blocked":"The notification permission was not granted and blocked instead.","unsupported-browser":"This browser doesn't support the API's required to use the Firebase SDK.","indexed-db-unsupported":"This browser doesn't support indexedDb.open() (ex. Safari iFrame, Firefox Private Browsing, etc)","failed-service-worker-registration":"We are unable to register the default service worker. {$browserErrorMessage}","token-subscribe-failed":"A problem occurred while subscribing the user to FCM: {$errorInfo}","token-subscribe-no-token":"FCM returned no token when subscribing the user to push.","token-unsubscribe-failed":"A problem occurred while unsubscribing the user from FCM: {$errorInfo}","token-update-failed":"A problem occurred while updating the user from FCM: {$errorInfo}","token-update-no-token":"FCM returned no token when updating the user to push.","use-sw-after-get-token":"The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.","invalid-sw-registration":"The input to useServiceWorker() must be a ServiceWorkerRegistration.","invalid-bg-handler":"The input to setBackgroundMessageHandler() must be a function.","invalid-vapid-key":"The public VAPID key must be a string.","use-vapid-key-after-get-token":"The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."},qe=new lr("messaging","Messaging",py);async function hy(t,e){const s=await zi(t),n=Wm(e),o={method:"POST",headers:s,body:JSON.stringify(n)};let r;try{r=await(await fetch(Ui(t.appConfig),o)).json()}catch(a){throw qe.create("token-subscribe-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw qe.create("token-subscribe-failed",{errorInfo:a})}if(!r.token)throw qe.create("token-subscribe-no-token");return r.token}async function gy(t,e){const s=await zi(t),n=Wm(e.subscriptionOptions),o={method:"PATCH",headers:s,body:JSON.stringify(n)};let r;try{r=await(await fetch(`${Ui(t.appConfig)}/${e.token}`,o)).json()}catch(a){throw qe.create("token-update-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw qe.create("token-update-failed",{errorInfo:a})}if(!r.token)throw qe.create("token-update-no-token");return r.token}async function fy(t,e){const n={method:"DELETE",headers:await zi(t)};try{const r=await(await fetch(`${Ui(t.appConfig)}/${e}`,n)).json();if(r.error){const a=r.error.message;throw qe.create("token-unsubscribe-failed",{errorInfo:a})}}catch(o){throw qe.create("token-unsubscribe-failed",{errorInfo:o?.toString()})}}function Ui({projectId:t}){return`${sy}/projects/${t}/registrations`}async function zi({appConfig:t,installations:e}){const s=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":`FIS ${s}`})}function Wm({p256dh:t,auth:e,endpoint:s,vapidKey:n}){const o={web:{endpoint:s,auth:e,p256dh:t}};return n!==jm&&(o.web.applicationPubKey=n),o}const by=10080*60*1e3;async function vy(t){const e=await xy(t.swRegistration,t.vapidKey),s={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:it(e.getKey("auth")),p256dh:it(e.getKey("p256dh"))},n=await my(t.firebaseDependencies);if(n){if(wy(n.subscriptionOptions,s))return Date.now()>=n.createTime+by?yy(t,{token:n.token,createTime:Date.now(),subscriptionOptions:s}):n.token;try{await fy(t.firebaseDependencies,n.token)}catch(o){console.warn(o)}return yd(t.firebaseDependencies,s)}else return yd(t.firebaseDependencies,s)}async function yy(t,e){try{const s=await gy(t.firebaseDependencies,e),n={...e,token:s,createTime:Date.now()};return await Hi(t.firebaseDependencies,n),s}catch(s){throw s}}async function yd(t,e){const n={token:await hy(t,e),createTime:Date.now(),subscriptionOptions:e};return await Hi(t,n),n.token}async function xy(t,e){const s=await t.pushManager.getSubscription();return s||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:ay(e)})}function wy(t,e){const s=e.vapidKey===t.vapidKey,n=e.endpoint===t.endpoint,o=e.auth===t.auth,r=e.p256dh===t.p256dh;return s&&n&&o&&r}function xd(t){const e={from:t.from,collapseKey:t.collapse_key,messageId:t.fcmMessageId};return Ey(e,t),Iy(e,t),Sy(e,t),e}function Ey(t,e){if(!e.notification)return;t.notification={};const s=e.notification.title;s&&(t.notification.title=s);const n=e.notification.body;n&&(t.notification.body=n);const o=e.notification.image;o&&(t.notification.image=o);const r=e.notification.icon;r&&(t.notification.icon=r)}function Iy(t,e){e.data&&(t.data=e.data)}function Sy(t,e){if(!e.fcmOptions&&!e.notification?.click_action)return;t.fcmOptions={};const s=e.fcmOptions?.link??e.notification?.click_action;s&&(t.fcmOptions.link=s);const n=e.fcmOptions?.analytics_label;n&&(t.fcmOptions.analyticsLabel=n)}function Ty(t){return typeof t=="object"&&!!t&&Hm in t}function ky(t){if(!t||!t.options)throw ba("App Configuration Object");if(!t.name)throw ba("App Name");const e=["projectId","apiKey","appId","messagingSenderId"],{options:s}=t;for(const n of e)if(!s[n])throw ba(n);return{appName:t.name,projectId:s.projectId,apiKey:s.apiKey,appId:s.appId,senderId:s.messagingSenderId}}function ba(t){return qe.create("missing-app-config-values",{valueName:t})}class Cy{constructor(e,s,n){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const o=ky(e);this.firebaseDependencies={app:e,appConfig:o,installations:s,analyticsProvider:n}}_delete(){return Promise.resolve()}}async function _y(t){try{t.swRegistration=await navigator.serviceWorker.register(ey,{scope:ty}),t.swRegistration.update().catch(()=>{}),await Ay(t.swRegistration)}catch(e){throw qe.create("failed-service-worker-registration",{browserErrorMessage:e?.message})}}async function Ay(t){return new Promise((e,s)=>{const n=setTimeout(()=>s(new Error(`Service worker not registered after ${fd} ms`)),fd),o=t.installing||t.waiting;t.active?(clearTimeout(n),e()):o?o.onstatechange=r=>{r.target?.state==="activated"&&(o.onstatechange=null,clearTimeout(n),e())}:(clearTimeout(n),s(new Error("No incoming service worker found.")))})}async function Py(t,e){if(!e&&!t.swRegistration&&await _y(t),!(!e&&t.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw qe.create("invalid-sw-registration");t.swRegistration=e}}async function $y(t,e){e?t.vapidKey=e:t.vapidKey||(t.vapidKey=jm)}async function Gm(t,e){if(!navigator)throw qe.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw qe.create("permission-blocked");return await $y(t,e?.vapidKey),await Py(t,e?.serviceWorkerRegistration),vy(t)}async function Dy(t,e,s){const n=Ly(e);(await t.firebaseDependencies.analyticsProvider.get()).logEvent(n,{message_id:s[Hm],message_name:s[ny],message_time:s[oy],message_device_time:Math.floor(Date.now()/1e3)})}function Ly(t){switch(t){case Rn.NOTIFICATION_CLICKED:return"notification_open";case Rn.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}async function Ry(t,e){const s=e.data;if(!s.isFirebaseMessaging)return;t.onMessageHandler&&s.messageType===Rn.PUSH_RECEIVED&&(typeof t.onMessageHandler=="function"?t.onMessageHandler(xd(s)):t.onMessageHandler.next(xd(s)));const n=s.data;Ty(n)&&n[ry]==="1"&&await Dy(t,s.messageType,n)}const wd="@firebase/messaging",Ed="0.12.23";const My=t=>{const e=new Cy(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",s=>Ry(e,s)),e},Ny=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:n=>Gm(e,n)}};function By(){Pt(new At("messaging",My,"PUBLIC")),Pt(new At("messaging-internal",Ny,"PRIVATE")),mt(wd,Ed),mt(wd,Ed,"esm2020")}function Vy(t,e){if(!navigator)throw qe.create("only-available-in-window");return t.onMessageHandler=e,()=>{t.onMessageHandler=null}}async function Fy(t,e){return t=ft(t),Gm(t,e)}function Oy(t,e){return t=ft(t),Vy(t,e)}By();const qy="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Id=!1;async function Km(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await Be.removeAllListeners(),await Be.addListener("registration",async s=>{Jm(s.value,!0)}),await Be.addListener("pushNotificationReceived",s=>{});let e=await Be.checkPermissions();e.receive==="prompt"&&(e=await Be.requestPermissions()),e.receive==="granted"&&await Be.register()}catch(e){console.error(e)}return}"Notification"in window&&(Notification.permission==="granted"?jy():Notification.permission==="default"&&console.log("[Push Web] Aguardando interação do utilizador para pedir permissão (iOS Requirement)."))}async function jy(){if("serviceWorker"in navigator)try{const t=await navigator.serviceWorker.register("/firebase-messaging-sw.js"),e=await Fy(rc,{vapidKey:qy,serviceWorkerRegistration:t});e&&(console.log("[Push Web] Token:",e),await Jm(e,!1)),Id||(Oy(rc,s=>{console.log("[Push Web] Foreground:",s),s.notification&&k(s.notification.title,s.notification.body,"info",!0)}),Id=!0)}catch(t){console.error("[Push Web] Falha no registo:",t)}}async function Jm(t,e){const s=Ae.currentUser;if(s)try{const n=Yb(Pe,"users",s.uid);try{await pv(n,{fcmTokens:hv(t),lastLoginAt:new Date().toISOString(),platform:e?"android_native":"pwa_web"})}catch(o){o.code==="not-found"&&await mv(n,{email:s.email,fcmTokens:[t],platform:e?"android_native":"pwa_web"},{merge:!0})}}catch(n){console.error(n)}}const Hy=(t,e,s="all",n="all")=>{const o=new URLSearchParams({startDate:t,endDate:e});return s&&s!=="all"&&o.append("professionalId",s),n&&n!=="all"&&o.append("costCenterId",n),F(`/api/reports/indicators?${o.toString()}`)},Uy=t=>t?F(`/api/financial/cost-centers/${t}`):Promise.resolve([]),zy=({establishmentId:t,startDate:e,endDate:s,cashierSessionId:n})=>{const o=new URLSearchParams({startDate:e,endDate:s});return n&&n!=="all"&&o.append("cashierSessionId",n),t&&o.append("establishmentId",t),F(`/api/reports/sales?${o.toString()}`)},Wy=()=>F("/api/reports/summary",{method:"GET"}),Ir=(t,e,s,n="all")=>{const o=`/api/blockages/${t}?startDate=${e}&endDate=${s}&professionalId=${n}`;return F(o)},Sr=t=>F("/api/blockages",{method:"POST",body:JSON.stringify(t)}),Wi=t=>F(`/api/blockages/${t}`,{method:"DELETE"}),Qm=t=>F("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:t})}),Tr=t=>t?String(t).replace(/\D/g,""):"",js=(t,e="",s=20,n={})=>{const o=new URLSearchParams;return e&&o.append("search",e),s&&o.append("limit",s),n.hasLoyalty&&o.append("hasLoyalty","true"),n.birthMonth&&o.append("birthMonth",n.birthMonth),n.inactiveDays&&o.append("inactiveDays",n.inactiveDays),F(`/api/clients/${t}?${o.toString()}`)},Gy=t=>{if(!t.phone)throw new Error("Telefone é obrigatório");const e=Tr(t.phone),s={...t,phone:e,id:e};return F(`/api/clients/${e}`,{method:"PUT",body:JSON.stringify(s)})},Ky=(t,e)=>{const s=Tr(e);return F(`/api/clients/full-history/${t}?phone=${s}`)},Jy=t=>{const e=Tr(t);return F(`/api/clients/${e}`,{method:"DELETE"})},Qy=(t,e,s,n)=>F("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:t,clientPhone:Tr(e),points:s,rewardName:n})});function P(t){return t==null?"":String(t).replace(/[&<>'"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[e])}function Xm(t,e=800,s=800,n=.7){return new Promise((o,r)=>{if(!t.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const a=new FileReader;a.readAsDataURL(t),a.onload=l=>{const c=new Image;c.src=l.target.result,c.onload=()=>{let d=c.width,p=c.height;d>p?d>e&&(p*=e/d,d=e):p>s&&(d*=s/p,p=s);const h=document.createElement("canvas");h.width=d,h.height=p,h.getContext("2d").drawImage(c,0,0,d,p);const w=h.toDataURL("image/jpeg",n);o(w)},c.onerror=d=>r(new Error("Erro ao carregar a imagem para processamento."))},a.onerror=l=>r(new Error("Erro ao ler o ficheiro."))})}const Sd=document.getElementById("content");let Td=!1;const Ka=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let Wn=[],kr=[],Bs={},Cs=[],K={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},j={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Xy(t){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(t).replace(/\./g,"")}function Ym(t){const e=new Date(t);if(e.setHours(0,0,0,0),K.currentView==="week"&&K.weekViewDays===7){const s=e.getDay(),n=e.getDate()-s+(s===0?-6:1);return new Date(e.setDate(n))}return e}function Xo(){const t=document.getElementById("profSelectorContainer"),e=K.profSearchTerm.toLowerCase();if(!t||!x.professionals)return;let s=x.professionals.filter(r=>K.showInactiveProfs||r.status!=="inactive");e&&(s=s.filter(r=>r.name.toLowerCase().includes(e)));const o=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...s];t.innerHTML=o.map(r=>{const a=K.selectedProfessionalId===r.id,l=r.name==="Todos"?"Todos":r.name.split(" ")[0],c=r.name==="Todos"?"T":r.name.charAt(0).toUpperCase(),d=r.status!=="inactive",p=P(l),h=Ka[0],b=r.id!=="all"&&x.professionalColors.get(r.id)||h,w=r.photo||`https://placehold.co/64x64/${b.main?.replace("#","")||"E0E7FF"}/${b.light?.replace("#","")||"4F46E5"}?text=${c}`,S=r.id==="all"?"#e0e7ff":b.light,_=r.id==="all"?"#4f46e5":b.main,R=`border: 3px solid ${a?b.border:"transparent"}; box-shadow: ${a?"0 0 0 2px "+b.border:"none"};`;return`
    ...
    `;return{title:s,content:n}}function ux(){const t="Selecionar Serviço",s=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${Wn.map(n=>{const o=j.data.selectedServiceIds.includes(n.id),r=n.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",a=P(n.name);return`
    ...
    `;return{title:e,content:l}}function hx(t){const e=document.getElementById("apptServicesContainer");if(!e)return;const s=t.toLowerCase(),n=Wn.filter(o=>o.name.toLowerCase().includes(s));e.innerHTML=n.map(o=>{const r=j.data.selectedServiceIds.includes(o.id),a=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${r?"selected border-blue-500":""}" data-service-id="${o.id}">
             ...
             </div>`}).join(""),e.querySelectorAll(".professional-modal-card").forEach(o=>{o.addEventListener("click",()=>ep(o.dataset.professionalId,o))})}async function Qa(t=null,e=!1){const s=document.getElementById("appointmentModal");if(!e){const r=t?.startTime?new Date(t.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],a=t?.startTime?new Date(t.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(j={step:1,data:{id:t?.id||null,clientName:t?.clientName||"",clientPhone:t?.clientPhone||"",selectedServiceIds:t?.services?.map(l=>l.id)||[],professionalId:t?.professionalId||null,professionalName:t?.professionalName||"",date:r,time:a,redeemedReward:t?.redeemedReward||null,clientHasRewards:t?.hasRewards||!1,clientLoyaltyPoints:0}},t&&t.clientName)try{const l=await js(x.establishmentId,t.clientName),c=l.find(d=>d.phone===t.clientPhone);c&&(j.data.clientLoyaltyPoints=c.loyaltyPoints||0,Cs=l)}catch(l){console.warn("Não foi possível carregar pontos do cliente para edição:",l)}}if(!x.services||!x.professionals||Bs.enabled===void 0){k("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(Wn=x.services,kr=x.professionals.filter(r=>r.status==="active"),j.data.clientLoyaltyPoints>0){const r=Bs,a=Math.min(...(r?.rewards||[]).map(l=>l.points));j.data.clientHasRewards=r.enabled&&a!==1/0&&j.data.clientLoyaltyPoints>=a}let n={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(j.step){case 1:n=dx(t);break;case 2:n=ux();break;case 3:n=mx();break;case 4:n=px(t);break}s.innerHTML=`
    ...
    `,{modalElement:n,close:o}=$e({title:"🎁 Resgatar Prémio",contentHTML:s,maxWidth:"max-w-md"});n.addEventListener("click",r=>{const a=r.target.closest('[data-action="select-reward"]');if(a){const l=a.dataset.rewardId,c=t.find(d=>d.id==l);c&&(Dx(c),o())}})}async function Dx(t,e){const s={id:t.serviceId||t.productId||`reward-${Date.now()}`,name:`${t.name}`,price:0,type:t.serviceId?"service":"product",isReward:!0,pointsCost:t.costPoints};await rp(s,1)}function Lx(){$e({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const e=document.getElementById("comandas_clientRegistrationForm");e&&e.addEventListener("submit",Rx)}async function Rx(t){t.preventDefault();const e=document.getElementById("comandas_clientRegistrationForm");if(!e)return;const s=e.querySelector('button[type="submit"]'),n=e.querySelector("#regClientName"),a=e.querySelector("#regClientPhone").value.trim().replace(/\D/g,""),l={establishmentId:x.establishmentId,name:n.value.trim(),email:e.querySelector("#regClientEmail").value.trim()||null,phone:a,dob:`${e.querySelector("#regClientDobDay").value.trim()}/${e.querySelector("#regClientDobMonth").value.trim()}`,notes:e.querySelector("#regClientNotes").value.trim()||null};if(!l.name||!a)return k("Erro de Validação","Nome e Telefone (apenas números) são obrigatórios.","error");s.disabled=!0,s.textContent="Verificando...";try{const c=await(void 0)(x.establishmentId,a);if(c)k("Atenção",`Cliente já cadastrado: ${c.name}. Selecionando existente...`,"info"),V.clients.find(p=>p.id===c.id)||V.clients.push(c),document.getElementById("genericModal").style.display="none",Xa(c.id);else{s.textContent="A salvar...";const d=await(void 0)(l);V.clients.push({id:d.id,...l}),k("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",Xa(d.id)}}catch(c){k(`Erro ao processar: ${c.message}`,"error")}finally{s&&(s.disabled=!1,s.textContent="Salvar Cliente")}}function Mx(){if(!V.isCashierOpen){k("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:t,close:e}=$e({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),s=()=>{let o="";const r=t.querySelector("#add-item-content"),a={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},l=()=>{const c=o.toLowerCase(),d=h=>h.filter(b=>b.name.toLowerCase().includes(c)),p={"modal-service-list":{items:d(V.catalog.services),type:"service"},"modal-product-list":{items:d(V.catalog.products),type:"product"},"modal-package-list":{items:d(V.catalog.packages),type:"package"}};for(const[h,{items:b,type:w}]of Object.entries(p)){const S=r.querySelector(`#${h}`);S&&(S.innerHTML=b.map(_=>`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{r>1&&(r--,l())},document.getElementById("quantity-plus-btn").onclick=()=>{r++,l()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await rp(o,r),e()}};t.addEventListener("click",o=>{const r=o.target.closest('[data-action="select-item-for-quantity"]'),a=o.target.closest('[data-action="back-to-catalog"]');if(r){const{itemType:l,itemId:c}=r.dataset,p=(V.catalog[l+"s"]||[]).find(h=>h.id===c);p&&n({...p,type:l})}else a&&s()}),s()}async function Xa(t=null){if(!V.isCashierOpen){k("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!V.clients||V.clients.length===0)try{V.clients=await js(x.establishmentId)}catch{k("Erro","Não foi possível carregar dados de clientes.","error");return}if(!x.professionals||x.professionals.length===0)try{x.professionals=await We(x.establishmentId)}catch{k("Erro","Não foi possível carregar dados de profissionais.","error");return}const e=V.clients.map(a=>{const l=a.id===t?"selected":"";return`<option value="${a.id}" ${l}>${P(a.name)} - ${P(a.phone)}</option>`}).join(""),s=x.professionals.map(a=>`<option value="${a.id}">${P(a.name)}</option>`).join(""),n=`
    ...
    `,pn("dailyApptChart","line","Agendamentos",h.map(S=>S.split("-").reverse().slice(0,2).join("/")),b,"#4f46e5")}function Jx(t){const{dreFinancial:e}=te.data,s=Object.entries(e.revenues).map(([o,r])=>`
    ...
    `}function pn(t,e,s,n,o,r){const a=document.getElementById(t);if(!a)return;const l=a.getContext("2d");va[t]&&va[t].destroy();const c={type:e,data:{labels:n,datasets:[{label:s,data:o,backgroundColor:Array.isArray(r)?r:e==="line"?"rgba(79, 70, 229, 0.1)":r,borderColor:Array.isArray(r)?"#fff":r,borderWidth:2,fill:e==="line",tension:.3,borderRadius:e==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:r,pointHoverBackgroundColor:r}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:e==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let p=d.dataset.label||"";return p&&(p+=": "),d.parsed.y!==null?p+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):p+=d.raw,p}}}},scales:e==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};va[t]=new Chart(l,c)}const _r=(t,e="products")=>F(`/api/${e}/categories/${t}`),lp=(t,e="products")=>F(`/api/${e}/categories`,{method:"POST",body:JSON.stringify(t)}),cp=(t,e="products")=>F(`/api/${e}/categories/${t}`,{method:"DELETE"}),Qx="audit_logs",Vs=async(t,e,s,n,o,r=null)=>{try{if(!e)return;await Zd(_t(Pe,Qx),{establishmentId:t,userId:e.uid,userName:e.name||e.email||"Utilizador",module:s,action:n,description:o,details:r,timestamp:new Date})}catch(a){console.error("Falha silenciosa ao registar log:",a)}},zt=document.getElementById("content");let St=null,wn="services",Zt="all";function Fs(){const t=Ae.currentUser;return t?{uid:t.uid,name:t.displayName||t.email}:{uid:"unknown",name:"Desconhecido"}}async function Xx(t){t.preventDefault();const s=t.target.closest("#categoryForm").querySelector("#categoryName"),n=s.value;if(n)try{await lp({establishmentId:x.establishmentId,name:n},"services"),Vs(x.establishmentId,Fs(),"Categorias (Serviços)","Criou",`Criou categoria: ${n}`),s.value="",k("Sucesso","Categoria criada!","success"),await Ji(),await Gn()}catch(o){k("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function Yx(t){if(await ce("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await cp(t,"services"),Vs(x.establishmentId,Fs(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${t})`),k("Sucesso","Categoria apagada.","success"),await Ji(),await Gn()}catch{k("Erro","Não foi possível apagar a categoria.","error")}}async function Ji(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await _r(x.establishmentId,"services");x.serviceCategories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(s=>`
                ...
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Zx(){$e({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `}async function Gn(){const t=document.getElementById("services-content-container");if(t){const e=t.querySelector(".loader");e&&(e.style.display="block")}try{const[e,s,n,o]=await Promise.all([ds(x.establishmentId),We(x.establishmentId),_r(x.establishmentId,"services"),Nh(x.establishmentId)]);x.services=(e||[]).filter(Boolean),x.professionals=(s||[]).filter(Boolean),x.serviceCategories=(n||[]).filter(Boolean),x.mostPopularService=o||{name:"N/A",count:0},x.services.forEach(r=>{r.active===void 0&&(r.active=!0)}),dp(wn)}catch(e){t&&(t.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),k("Erro",`Não foi possível carregar os dados: ${e.message}`,"error")}}function dp(t){if(document.getElementById("services-content-container")){if(wn===t&&document.getElementById("services-content-container").children.length>1){wn==="services"&&(Qi(),Es());return}wn=t,Zt="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(e=>{const s=e.dataset.view===t;e.classList.toggle("border-indigo-500",s),e.classList.toggle("text-indigo-600",s),e.classList.toggle("border-transparent",!s),e.classList.toggle("text-gray-500",!s)}),t==="services"?tw():t==="reports"&&sw()}}function nw(){St&&(zt.removeEventListener("click",St),zt.removeEventListener("input",St),zt.removeEventListener("change",St)),St=async t=>{const e=t.target;if(e.closest('[data-action="toggle-service-status"]')){t.stopPropagation();const o=e.closest('[data-action="toggle-service-status"]'),r=o.dataset.id,a=o.checked;try{await Mh(r,a);const l=x.services.findIndex(c=>c.id===r);l>-1&&(x.services[l].active=a),Vs(x.establishmentId,Fs(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${a?"Ativo":"Inativo"}`),Es(),Qi()}catch(l){k("Erro",`Não foi possível atualizar o status: ${l.message}`,"error"),o.checked=!a,Es()}return}const s=e.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(e.id==="serviceSearchInput"||e.id==="serviceCategoryFilter"){Es();return}if(!s)return;if(s.hasAttribute("data-view")){dp(s.dataset.view);return}switch(s.dataset.action){case"new-service":Ad();break;case"edit-service":const o=JSON.parse(s.dataset.service);Ad(o);break;case"manage-categories":Zx();break;case"filter-service":const r=s.dataset.filterType;if(r==="popular")return;Zt=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(a=>{const l=a.dataset.filterType,d=l===Zt||l==="total"&&Zt==="all";a.classList.toggle("ring-2",d),a.classList.toggle("ring-indigo-500",d),a.classList.toggle("shadow-lg",d)}),Es();break}},zt.addEventListener("click",St),zt.addEventListener("input",St),zt.addEventListener("change",St)}async function ow(){zt.innerHTML=`
        ...
        </section>`,nw();try{(!x.professionals||x.professionals.length===0)&&(x.professionals=await We(x.establishmentId)||[])}catch(t){console.error("Falha ao carregar profissionais:",t),k("Erro","Não foi possível carregar a lista de profissionais.","error"),x.professionals=[]}wn="services",Zt="all",await Gn()}const Ar="suppliers",Xi="purchases",up="financial_payables",Yi=async t=>{try{const e=rr(_t(Pe,Ar),_n("establishmentId","==",t)),s=await ai(e),n=[];return s.forEach(o=>{n.push({id:o.id,...o.data()})}),n}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},rw=async t=>{try{return{id:(await Zd(_t(Pe,Ar),t)).id,...t}}catch(e){throw console.error("Erro ao criar fornecedor:",e),e}},aw=async(t,e)=>{try{const s=ss(Pe,Ar,t);return await su(s,e),{id:t,...e}}catch(s){throw console.error("Erro ao atualizar fornecedor:",s),s}},iw=async t=>{try{const e=ss(Pe,Ar,t);return await ch(e),!0}catch(e){throw console.error("Erro ao excluir fornecedor:",e),e}},lw=async(t,e=null)=>{try{const s=tu(Pe),n=ss(_t(Pe,Xi)),o={...t,createdAt:ic()};if(s.set(n,o),e&&e.defaultNatureId&&e.defaultCostCenterId){const r=ss(_t(Pe,up)),a=new Date().toISOString().split("T")[0],l={establishmentId:t.establishmentId,description:`Compra - ${t.supplierName}`,amount:parseFloat(t.totalAmount),dueDate:a,naturezaId:e.defaultNatureId,centroDeCustoId:e.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${t.items.length}`,status:"pending",paymentDate:null,purchaseId:n.id,createdAt:ic()};s.set(r,l)}return await s.commit(),{id:n.id,...o}}catch(s){throw console.error("Erro ao registrar compra com integração:",s),s}},cw=async(t,e)=>{try{const s=tu(Pe),n=ss(Pe,Xi,t);s.delete(n);const o=rr(_t(Pe,up),_n("purchaseId","==",t),_n("establishmentId","==",e));return(await ai(o)).forEach(a=>{s.delete(a.ref)}),await s.commit(),!0}catch(s){throw console.error("Erro ao excluir compra e financeiro:",s),s}},dw=async t=>{try{const e=rr(_t(Pe,Xi),_n("establishmentId","==",t),eu("createdAt","desc")),s=await ai(e),n=[];return s.forEach(o=>{n.push({id:o.id,...o.data()})}),n}catch(e){throw console.error("Erro ao buscar histórico de compras:",e),e}},jt=document.getElementById("content");let Tt=null,En="products",lt="all";async function uw(t){t.preventDefault();const s=t.target.closest("#categoryForm").querySelector("#categoryName"),n=s.value;if(n)try{await lp({establishmentId:x.establishmentId,name:n},"products"),s.value="",k("Sucesso","Categoria de produto criada!","success"),await Zi(),await Kn()}catch(o){k("Erro",`Não foi possível criar a categoria: ${o.message}`,"error")}}async function mw(t){if(await ce("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await cp(t,"products"),k("Sucesso","Categoria de produto apagada.","success"),await Zi(),await Kn()}catch{k("Erro","Não foi possível apagar a categoria.","error")}}async function Zi(){const t=document.getElementById("categoryList");if(t){t.innerHTML='<div class="loader mx-auto my-4"></div>';try{const e=await _r(x.establishmentId,"products");x.categories=e,t.innerHTML="",e.length>0?t.innerHTML=e.map(s=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${P(s.name)}</span>
                    <button data-action="delete-category" data-id="${s.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):t.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{t.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function pw(){$e({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `;const e=document.getElementById("productCategoryFilter");e&&(e.innerHTML='<option value="all">Todas as categorias</option>',(x.categories||[]).forEach(s=>e.innerHTML+=`<option value="${s.id}">${P(s.name)}</option>`)),el(),Nn()}function bw(){const t=document.getElementById("products-content-container"),e=new Date().toISOString().split("T")[0],s=new Date;s.setDate(s.getDate()-30);const n=s.toISOString().split("T")[0];t.innerHTML=`
        <div class="space-y-6">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,t.appendChild(a)})):(t.className="",t.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function Kn(){const t=document.getElementById("products-content-container");t&&(t.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[e,s,n]=await Promise.all([ir(x.establishmentId),_r(x.establishmentId,"products"),Yi(x.establishmentId)]);x.products=(e||[]).filter(Boolean),x.categories=(s||[]).filter(Boolean),x.suppliers=(n||[]).filter(Boolean),mp(En)}catch(e){t&&(t.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${e.message}</p>`)}}function mp(t){if(document.getElementById("products-content-container")){if(En===t&&document.getElementById("products-content-container").children.length>1){En==="products"&&(el(),Nn());return}En=t,lt="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(e=>{const s=e.dataset.view===t;e.classList.toggle("border-indigo-500",s),e.classList.toggle("text-indigo-600",s),e.classList.toggle("border-transparent",!s),e.classList.toggle("text-gray-500",!s)}),t==="products"?fw():t==="movements"&&bw()}}async function yw(){jt.innerHTML=`
    ...
    `;$e({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function In(){const t=document.getElementById("purchasesContainer");if(t)if(le.step===1){t.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[e,s]=await Promise.all([ir(x.establishmentId),Yi(x.establishmentId)]);le.allSuppliers=s||[];const n=e.filter(d=>{const p=parseInt(d.currentStock||0),h=parseInt(d.minStock||0);return p<=h});if(le.productsToBuy=n,n.length===0){t.innerHTML=`
    ...
    `;$e({title:t?"Editar Fornecedor":"Novo Fornecedor",contentHTML:e,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Iw),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>ar("genericModal"))},50)}function _w(){Ht.innerHTML=`
    ...
    `,kt&&(Ht.removeEventListener("click",kt),Ht.removeEventListener("input",kt),Ht.removeEventListener("change",kt)),kt=t=>{if(t.target.closest("#tab-btn-list")&&bo("list"),t.target.closest("#tab-btn-purchases")&&bo("purchases"),t.target.closest("#tab-btn-history")&&bo("history"),t.target.id==="toggle-quote-mode"&&(le.isQuoteMode=t.target.checked,In()),t.target.id==="supplierSearchInput"&&Pr(),t.target.closest("#btn-new-supplier")&&Dd(),t.target.closest(".supplier-item-mobile")){const s=t.target.closest(".supplier-item-mobile"),n=JSON.parse(s.dataset.supplier);Sw(n)}const e=t.target.closest("button[data-action]");if(e){const s=e.dataset.action;s==="delete"&&Ew(e.dataset.id),s==="edit"&&Dd(JSON.parse(e.dataset.supplier))}if((t.target.classList.contains("qty-input")||t.target.classList.contains("row-select"))&&ei(),t.target.id==="check-all-rows"){const s=t.target.checked;document.querySelectorAll(".row-select").forEach(n=>n.checked=s),ei()}if(t.target.closest("#btn-go-to-orders")){const s=document.querySelectorAll(".product-row"),n={};let o=!1;if(s.forEach(r=>{if(r.offsetParent===null||!r.querySelector(".row-select").checked)return;o=!0;let l="Produto";const c=r.querySelector("td:nth-child(2)"),d=r.querySelector(".font-bold");c?l=c.innerText:d&&(l=d.innerText);const p=parseInt(r.querySelector(".qty-input").value),h=parseFloat(r.dataset.cost),w=r.querySelector(".supplier-select").value;if(w){if(!n[w]){const S=le.allSuppliers.find(_=>_.id===w);n[w]={info:S,items:[]}}n[w].items.push({name:l,qty:p,cost:h})}}),!o){k("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}le.finalOrders=n,le.step=2,In()}if(t.target.closest("#btn-back-step1")&&(le.step=1,In()),t.target.closest(".btn-send-order")){const s=t.target.closest(".btn-send-order"),n=JSON.parse(decodeURIComponent(s.dataset.supplierInfo)),o=JSON.parse(decodeURIComponent(s.dataset.orderItems)),r=parseFloat(s.dataset.total),a=le.isQuoteMode;if(n.phone){const l=n.phone.replace(/\D/g,"");let c="";a?(c=`Olá *${n.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${n.email}?subject=${encodeURIComponent(l)}&body=${encodeURIComponent(c)}`;window.location.href=d}else k("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(t.target.closest(".btn-register-order")){const s=t.target.closest(".btn-register-order");if(s.disabled)return;const n=JSON.parse(decodeURIComponent(s.dataset.order));n.establishmentId=x.establishmentId,s.disabled=!0,s.textContent="A processar...",cs(x.establishmentId).then(o=>{const r=o.purchaseConfig||null;return lw(n,r)}).then(()=>{k("Sucesso","Compra registrada e integrada ao financeiro!","success"),s.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',s.classList.replace("bg-blue-600","bg-green-600"),s.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(o=>{s.disabled=!1,s.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',k("Erro","Falha ao registrar compra: "+o.message,"error")})}if(t.target.closest(".btn-delete-purchase")){const n=t.target.closest(".btn-delete-purchase").dataset.id;ce("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async o=>{if(o)try{await cw(n,x.establishmentId),k("Sucesso","Compra e financeiro excluídos.","success"),pp()}catch(r){k("Erro","Erro ao excluir: "+r.message,"error")}})}if(t.target.closest(".btn-print-order")){const n=t.target.closest(".supplier-order-card").dataset.supplierId,o=le.finalOrders[n];o?Cw(o,le.isQuoteMode):k("Erro","Dados do pedido não encontrados.","error")}if(t.target.closest(".btn-view-purchase")){const s=t.target.closest(".btn-view-purchase"),n=JSON.parse(s.dataset.purchase);kw(n)}},Ht.addEventListener("click",kt),Ht.addEventListener("input",kt),Ht.addEventListener("change",kt),bo("list")}function bo(t){Ro=t,["list","purchases","history"].forEach(s=>{const n=document.getElementById(`tab-btn-${s}`),o=document.getElementById(`tab-content-${s}`);s===t?(n.classList.add("border-indigo-500","text-indigo-600"),n.classList.remove("border-transparent","text-gray-500"),o.classList.remove("hidden")):(n.classList.remove("border-indigo-500","text-indigo-600"),n.classList.add("border-transparent","text-gray-500"),o.classList.add("hidden"))});const e=document.getElementById("btn-new-supplier");e&&(t==="list"?e.classList.remove("hidden"):e.classList.add("hidden")),xw()}const ya=document.getElementById("content"),Ld={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let dt=new Set,vo=null,Is=null;function Aw(t=8){let e="";for(let s=0;s<t;s++)e+=`
        ...
        </section>`,vo&&ya.removeEventListener("click",vo),vo=e=>{const s=e.target.closest('[data-action="open-professional-modal"]'),n=e.target.closest('[data-action="batch-delete"]');if(s){e.preventDefault();let r={};if(s.dataset.professional)try{r=JSON.parse(s.dataset.professional)}catch(a){console.error("Erro ao fazer parse do professional data:",a);return}$w(r);return}if(n){Bw();return}const o=e.target.closest(".professional-checkbox");if(o){const r=o.dataset.id;o.checked?dt.add(r):dt.delete(r),cn(),ti();return}},ya.addEventListener("click",vo),document.getElementById("profSearchInput").addEventListener("input",cn),document.getElementById("showInactiveProfToggle").addEventListener("change",cn);const t=document.getElementById("professionalsList");x.professionals=null,x.services=null,cn();try{const[e,s]=await Promise.all([We(x.establishmentId),ds(x.establishmentId)]);x.professionals=e,x.services=s,cn(),ti()}catch{t.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}let re={clients:[],establishment:null,searchTimeout:null,currentClient:null,history:[],filters:{hasLoyalty:!1,birthMonth:"",inactiveDays:""},showFilters:!1};const Zo=t=>{if(!t)return"";const e=t.replace(/\D/g,"");return e.length>10?e.replace(/^(\d\d)(\d{5})(\d{4}).*/,"($1) $2-$3"):e.replace(/^(\d\d)(\d{4})(\d{0,4}).*/,"($1) $2-$3")},Vw=t=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(t||0),Rd=t=>t?new Date(t).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"}):"-",Fw=()=>{re.showFilters=!re.showFilters;const t=document.getElementById("filter-panel");t&&(re.showFilters?t.classList.remove("hidden"):t.classList.add("hidden"))},Ow=()=>{const t=document.getElementById("filter-loyalty"),e=document.getElementById("filter-month"),s=document.getElementById("filter-inactive");re.filters.hasLoyalty=t?t.checked:!1,re.filters.birthMonth=e?e.value:"",re.filters.inactiveDays=s?s.value:"",Os()},qw=()=>{const t=document.getElementById("filter-loyalty"),e=document.getElementById("filter-month"),s=document.getElementById("filter-inactive");t&&(t.checked=!1),e&&(e.value=""),s&&(s.value=""),re.filters={hasLoyalty:!1,birthMonth:"",inactiveDays:""},Os()},hp=async(t=null)=>{re.currentClient=t;const e=!t,s=`
        <div class="h-[80vh] flex flex-col bg-gray-50 rounded-lg overflow-hidden">
            <div class="bg-white border-b px-6 py-4 flex justify-between items-center shrink-0">
                <div>
                    ...
                    ${e?"":`<p class="text-sm text-gray-500">${Zo(t.phone)}</p>`}
                </div>
                ${e?"":`
    ...
    `;if($e({title:"",contentHTML:s,maxWidth:"max-w-3xl"}),window.switchTab=n=>si(n,e),window.handleSave=jw,window.handleDelete=Hw,!e)try{re.history=await Ky(x.establishmentId,t.phone)}catch(n){console.error("Erro ao carregar histórico",n),re.history=[]}si("details",e)},si=(t,e)=>{const s=document.getElementById("modal-body");if(!s)return;document.querySelectorAll('[id^="tab-btn-"]').forEach(r=>{r.classList.remove("border-indigo-600","text-indigo-600"),r.classList.add("border-transparent","text-gray-500")});const n=document.getElementById(`tab-btn-${t}`);n&&(n.classList.add("border-indigo-600","text-indigo-600"),n.classList.remove("border-transparent","text-gray-500"));const o=re.currentClient||{};if(t==="details"){if(s.innerHTML=`
            <form id="form-client" class="space-y-4 max-w-lg mx-auto">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Telefone (WhatsApp)</label>
                    <input type="tel" name="phone" id="input-phone" value="${Zo(o.phone)}" 
        ...
        `,e){const r=document.getElementById("input-phone");r&&(r.oninput=a=>a.target.value=Zo(a.target.value))}}else if(t==="appointments"){const r=new Date,a=re.history.filter(l=>{const c=new Date(l.date);return l.type==="appointment"&&c>=r&&l.status!=="cancelled"});if(a.sort((l,c)=>new Date(l.date)-new Date(c.date)),!a.length){s.innerHTML=`<div class="text-center py-10">
        ...
        `}else if(t==="history"){const r=re.history;if(!r.length){s.innerHTML='<div class="text-center text-gray-400 mt-10">Histórico vazio.</div>';return}s.innerHTML=`
            <div class="space-y-3">
                ${r.map(a=>`
        ...
        `}else if(t==="loyalty"){const r=re.establishment.loyaltyProgram;if(!r||!r.enabled){s.innerHTML='<div class="text-center text-gray-400 mt-10">Programa de fidelidade não ativo neste estabelecimento.</div>';return}const a=o.loyaltyPoints||0;s.innerHTML=`
        ...
        `,window.handleRedeem=async(l,c)=>{if(await ce("Resgatar",`Trocar ${l} pontos por "${c}"?`))try{await Qy(x.establishmentId,o.phone,l,c),k("Sucesso","Resgate realizado!","success"),o.loyaltyPoints=(o.loyaltyPoints||0)-parseInt(l),re.history.unshift({type:"loyalty",description:`Resgate: ${c}`,date:new Date().toISOString(),value:-l,isPoints:!0,status:"completed"}),si("loyalty",!1)}catch(d){k("Erro",d.message||"Erro ao resgatar","error")}}}},jw=async()=>{const t=document.getElementById("form-client"),e=new FormData(t),s=e.get("phone").replace(/\D/g,"");if(s.length<10){k("Erro","Telefone inválido","error");return}const n={name:e.get("name"),phone:s,email:e.get("email"),birthDate:e.get("birthDate"),notes:e.get("notes"),establishmentId:x.establishmentId};try{await Gy(n),k("Sucesso","Cliente salvo!","success"),document.getElementById("genericModal").style.display="none",Os()}catch(o){k("Erro","Erro ao salvar cliente","error"),console.error(o)}},Hw=async()=>{if(await ce("Excluir","Tem certeza? Isso apagará o histórico deste cliente."))try{await Jy(re.currentClient.phone),k("Sucesso","Cliente removido","success"),document.getElementById("genericModal").style.display="none",Os()}catch{k("Erro","Erro ao remover","error")}},Uw=()=>{const t=document.getElementById("clients-grid");if(t){if(t.innerHTML="",re.clients.length===0){t.innerHTML=`
            <div class="col-span-full flex flex-col items-center justify-center py-20 text-gray-400">
                ...
                <div class="mt-2 text-sm text-gray-500">
                    ${re.filters.hasLoyalty||re.filters.birthMonth||re.filters.inactiveDays?'<button onclick="window.clearFilters()" class="text-indigo-600 font-bold hover:underline">Limpar Filtros</button>':'<button onclick="window.openNewClient()" class="text-indigo-600 font-bold hover:underline">Cadastrar novo</button>'}
                </div>
            </div>
        `;return}re.clients.forEach(e=>{const s=document.createElement("div");s.className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-all cursor-pointer flex items-center justify-between group",s.onclick=()=>hp(e),s.innerHTML=`
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">${Zo(e.phone)}</p>
                </div>
            </div>
            <div class="text-right">
        ...
        `,t.appendChild(s)})}},Os=async(t="")=>{const e=document.getElementById("clients-grid");e&&(e.innerHTML='<div class="col-span-full flex justify-center py-10"><div class="loader"></div></div>');const s=t||document.getElementById("search-input")?.value||"";try{re.clients=await js(x.establishmentId,s,20,re.filters),Uw()}catch(n){console.error(n),e&&(e.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao carregar lista.</p>')}},zw=async()=>{const t=document.getElementById("content");t.innerHTML=`
    ...
    `,e.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const p={ownerName:e.querySelector("#ownerName").value,name:e.querySelector("#establishmentName").value,phone:e.querySelector("#establishmentPhone").value,document:e.querySelector("#establishmentCnpjCpf").value,email:e.querySelector("#establishmentEmail").value,address:e.querySelector("#establishmentAddress").value,website:e.querySelector("#establishmentWebsite").value};Hs(p,d)})}function d2(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.querySelector("#change-email-form").addEventListener("submit",async s=>{s.preventDefault();const n=e.querySelector("#newEmail").value,o=e.querySelector("#currentPassword").value;if(!n||!o){k("Erro","Preencha todos os campos.","error");return}const r=e.querySelector('button[form="change-email-form"]');r.disabled=!0,r.textContent="A verificar...";try{const a=Ae.currentUser;if(!a)throw new Error("Usuário não autenticado.");const l=sh.credential(a.email,o);await nh(a,l),r.textContent="A enviar link...",await oh(a,n),r.textContent="A atualizar BD...",await Ph(x.establishmentId,n),k("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),s.target.reset()}catch(a){let l="Não foi possível alterar o e-mail.";a.code==="auth/wrong-password"?l="A senha atual está incorreta.":a.code==="auth/email-already-in-use"?l="Este e-mail já está sendo usado por outra conta.":a.code==="auth/operation-not-allowed"?l="A troca de e-mail precisa ser habilitada no console do Firebase.":l=a.message,k("Erro",l,"error")}finally{r.disabled=!1,r.textContent="Salvar Novo E-mail"}})}function m2(t,e){const s=P(t.welcomeMessage||"");e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const s=e.querySelector("#establishmentTimezone");if(t.timezone)s.value=t.timezone;else try{const r=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(s.options).some(l=>l.value===r)?s.value=r:s.value="America/Sao_Paulo"}catch{s.value="America/Sao_Paulo"}const n=e.querySelector("#establishmentWorkingHoursContainer"),o=t.workingHours||{};Object.keys(wa).forEach(r=>{const a=o[r]||{},l=wa[r],c=a.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${c?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,n.appendChild(d)}),n.addEventListener("change",r=>{const a=r.target.closest('.day-schedule-card input[type="checkbox"]');a&&a.closest(".day-schedule-card").classList.toggle("disabled",!a.checked)}),e.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const a={};Object.keys(wa).forEach(c=>{a[c]={active:e.querySelector(`#est-${c}-active`).checked,start:e.querySelector(`#est-${c}-start`).value,end:e.querySelector(`#est-${c}-end`).value,breakStart:e.querySelector(`#est-${c}-breakStart`).value,breakEnd:e.querySelector(`#est-${c}-breakEnd`).value}});const l=e.querySelector("#establishmentTimezone").value;Hs({workingHours:a,timezone:l},r)})}function g2(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[s,n]=await Promise.all([Bn(x.establishmentId),Vn(x.establishmentId)]),o=t.financialIntegration||{},r=t.commissionConfig||{},a=t.purchaseConfig||{};e.querySelector("#financialNatureId").innerHTML=vs(s,o.defaultNaturezaId),e.querySelector("#financialCostCenterId").innerHTML=vs(n,o.defaultCentroDeCustoId),e.querySelector("#purchaseNatureId").innerHTML=vs(s,a.defaultNatureId),e.querySelector("#purchaseCostCenterId").innerHTML=vs(n,a.defaultCostCenterId),e.querySelector("#commissionNatureId").innerHTML=vs(s,r.defaultNatureId),e.querySelector("#commissionCostCenterId").innerHTML=vs(n,r.defaultCostCenterId)}catch{k("Erro","Não foi possível carregar os dados para a integração financeira.","error")}e.querySelector("#financial-form").addEventListener("submit",s=>{s.preventDefault();const n={financialIntegration:{defaultNaturezaId:e.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:e.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:e.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:e.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:e.querySelector("#commissionNatureId").value||null,defaultCostCenterId:e.querySelector("#commissionCostCenterId").value||null}};Hs(n,s)})}function b2(t,e){const s="5516997859430",n=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),o=`https://wa.me/${s}?text=${n}`;e.innerHTML=`
    ...
    `}function v2(t,e){const s="5516997859430",n=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),o=`https://wa.me/${s}?text=${n}`,r="sistemakairosagenda@gmail.com";e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function y2(t,e){e.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${t}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function wp(t="indigo",e){const s=e.querySelector("#color-palette-container"),n=e.querySelector("#establishmentThemeColor");!s||!n||(s.innerHTML="",Object.entries(l2).forEach(([o,r])=>{const a=o===t,l=document.createElement("div");l.className="w-24 text-center cursor-pointer mb-4",l.innerHTML=`
    ...
    `,Gt.querySelector('button[data-action="back-to-list"]').addEventListener("click",n=>{n.preventDefault(),Ep()});const s=document.getElementById("settings-content-detail");switch(t){case"personal-data":c2(Me,s);break;case"change-password":d2(Me,s);break;case"change-email":u2(Me,s);break;case"branding":m2(Me,s);break;case"booking":p2(Me,s);break;case"working-hours":h2(Me,s);break;case"loyalty":g2(Me,s);break;case"financial":await f2(Me,s);break;case"support":b2(Me,s);break;case"cancellation":v2(Me,s);break;default:y2(e?e.label:"Definições",s)}}async function Ep(){if(Gt.innerHTML=`
    ...
    `,!Me)try{Me=await cs(x.establishmentId)}catch{k("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),Gt.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const t=Ae.currentUser;t&&t.displayName&&(x.userName=t.displayName);const e=P(x.userName||Ae.currentUser.email);let n=`https://placehold.co/96x96/E2E8F0/4A5568?text=${e?e.charAt(0).toUpperCase():"U"}`;t&&t.photoURL&&(n=t.photoURL),Gt.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
        ...
        <div data-action="go-to-my-profile" class="bg-white p-4 rounded-lg shadow-md mb-6 cursor-pointer hover:bg-gray-50 transition-all">
            <div class="text-center relative">
                ...
                <div class="absolute top-0 right-0 p-2 text-gray-400 hover:text-indigo-600" title="Ver Meu Perfil">
                 ...
                 ${x.userName&&x.userName!==Ae.currentUser.email?`<p class="text-sm text-gray-500">${P(Ae.currentUser.email)}</p>`:""}
    ...
    `,Gt.querySelector("#settings-menu-list").addEventListener("click",r=>{const a=r.target.closest("button[data-section]");a&&(r.preventDefault(),w2(a.dataset.section))});const o=Gt.querySelector('[data-action="go-to-my-profile"]');o&&o.addEventListener("click",r=>{r.preventDefault(),gt("my-profile-section")})}const Tn=document.getElementById("content");async function _s(t){const e=document.getElementById("blockagesList");if(e){e.innerHTML='<div class="loader mx-auto"></div>';try{const s=document.getElementById("filterStartDate")?.value,n=document.getElementById("filterEndDate")?.value,o=await Ir(x.establishmentId,s||new Date().toISOString().split("T")[0],n||new Date().toISOString().split("T")[0],t),r=document.getElementById("filterReason")?.value.toLowerCase(),a=r?o.filter(c=>c.reason&&c.reason.toLowerCase().includes(r)):o,l=a.reduce((c,d)=>{const p=d.reason||"Sem motivo";return c[p]||(c[p]=[]),c[p].push(d),c},{});if(e.innerHTML="",a.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(l).forEach(([c,d])=>{const p=document.createElement("div");p.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let b=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;p.innerHTML+=N}),e.appendChild(p)})}catch(s){e.innerHTML=`<p class="text-center text-red-500">Erro: ${s.message}</p>`}}}async function E2(t){t.preventDefault();const e=t.target,s=e.querySelector("#blockageProfId").value,n=e.querySelector("#blockageDate").value,o=e.querySelector("#blockageEndDate").value||n,r=e.querySelector("#blockageStartTime").value,a=e.querySelector("#blockageEndTime").value,l={establishmentId:x.establishmentId,professionalId:s,startTime:new Date(`${n}T${r}:00`).toISOString(),endTime:new Date(`${o}T${a}:00`).toISOString(),reason:e.querySelector("#blockageReason").value};try{await Sr(l),e.reset(),k("Sucesso","Bloqueio adicionado com sucesso!","success"),_s(s)}catch(c){k("Erro",`Não foi possível criar o bloqueio: ${c.message}`,"error")}}async function I2(t){t.preventDefault();const e=t.target,s=Array.from(e.querySelectorAll('input[name="batch-professionals"]:checked')).map(p=>p.value);if(s.length===0)return k("Atenção","Selecione pelo menos um profissional.","error");const n=e.querySelector("#batchBlockageDate").value,o=e.querySelector("#batchBlockageEndDate").value||n,r=e.querySelector("#batchBlockageStartTime").value,a=e.querySelector("#batchBlockageEndTime").value,l=e.querySelector("#batchBlockageReason").value,c=e.querySelector('button[type="submit"]');c.disabled=!0,c.textContent="Aguarde...";const d=s.map(p=>{const h={establishmentId:x.establishmentId,professionalId:p,startTime:new Date(`${n}T${r}:00`).toISOString(),endTime:new Date(`${o}T${a}:00`).toISOString(),reason:l};return Sr(h)});try{await Promise.all(d),k("Sucesso",`${s.length} bloqueios foram criados com sucesso!`,"success"),e.reset(),e.querySelectorAll('input[name="batch-professionals"]:checked').forEach(h=>h.checked=!1);const p=document.getElementById("blockageProfId").value;p&&_s(p)}catch(p){k("Erro",`Ocorreu um erro: ${p.message}`,"error")}finally{c.disabled=!1,c.textContent="Adicionar Bloqueio em Lote"}}function S2(t){Tn.addEventListener("submit",e=>{e.target.id==="blockageForm"&&E2(e),e.target.id==="batchBlockageForm"&&I2(e)}),Tn.addEventListener("input",e=>{e.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&_s(t)}),Tn.addEventListener("click",async e=>{const s=e.target.closest("button[data-action]");if(!s)return;const n=s.dataset.action;if(n==="back-to-professionals")gt("profissionais-section");else if(n==="delete-blockage"){if(await ce("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await Wi(s.dataset.id),k("Sucesso","Bloqueio removido.","success"),_s(t)}catch(r){k("Erro",`Não foi possível remover o bloqueio: ${r.message}`,"error")}}else if(n==="batch-delete-blockage"){const o=JSON.parse(s.dataset.ids);if(await ce("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${o.length} bloqueios de uma vez?`))try{await Qm(o),k("Sucesso",`${o.length} bloqueios removidos.`,"success"),_s(t)}catch(a){k("Erro",`Não foi possível apagar os bloqueios: ${a.message}`,"error")}}})}async function T2(t){const{professionalId:e,professionalName:s}=t;if(!e||!s){Tn.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const n=P(s);Tn.innerHTML=`
        <section>
        ...
        </section>`,S2(e),await _s(e);const o=document.getElementById("batchProfSelectionContainer");try{const r=await We(x.establishmentId);o.innerHTML=r.map(a=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{o.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const k2=t=>F(`/api/users/${t}`),C2=t=>F("/api/users",{method:"POST",body:JSON.stringify(t)}),_2=(t,e)=>F(`/api/users/${t}`,{method:"PUT",body:JSON.stringify(e)}),A2=t=>F(`/api/users/${t}`,{method:"DELETE"}),P2=(t,e)=>F(`/api/users/${t}/password`,{method:"PUT",body:JSON.stringify({password:e})}),$2=(t,e)=>F(`/api/users/${t}/status`,{method:"PATCH",body:JSON.stringify({status:e})}),Ut=document.getElementById("content"),D2={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},L2={view:"Visualizar",create:"Criar",edit:"Editar"};let dn=null,un=null;function R2(t){const e=document.getElementById("usersListContainer");if(!e)return;const s=document.getElementById("showInactiveUsersToggle")?.checked;if(t.length===0){const n=s?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";e.innerHTML=`<p class="col-span-full text-center text-gray-500">${n}</p>`;return}t.sort((n,o)=>(n.status==="active"?-1:1)-(o.status==="active"?-1:1)),e.innerHTML=t.map(n=>{const o=JSON.stringify(n).replace(/'/g,"&apos;"),r=n.status==="active",a=x.professionals.find(p=>p.id===n.professionalId),l=a?a.name:"N/A",c=a?a.name.charAt(0):n.name.charAt(0),d=a?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(c)}`;return`
    ...
    `}).join("")}function Mo(){const t=document.getElementById("showInactiveUsersToggle")?.checked;let e;t?e=x.users:e=x.users.filter(s=>s.status==="active"),R2(e)}function M2(t={}){return Object.entries(D2).map(([e,s])=>{const n=e==="agenda-section"||e==="comandas-section",o=t[e]?.view_all_prof===!0,r=Object.entries(L2).map(([l,c])=>`
    ...
    `,dn&&Ut.removeEventListener("click",dn),un&&Ut.removeEventListener("change",un),dn=async t=>{if(!document.getElementById("user-list-view")){Ut.removeEventListener("click",dn);return}const e=t.target.closest("[data-action]");if(!e)return;switch(e.dataset.action){case"new-user":Nd();break;case"edit-user":const n=JSON.parse(e.dataset.user.replace(/&apos;/g,"'"));Nd(n);break;case"back-to-list":er();break;case"delete-user":{t.stopPropagation();const o=e.dataset.userId;if(await ce("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await A2(o),k("Usuário excluído com sucesso!","success"),er()}catch(a){k(`Erro ao excluir: ${a.message}`,"error")}break}}},un=async t=>{if(!document.getElementById("user-list-view")){Ut.removeEventListener("change",un);return}const e=t.target.closest('input[data-action="toggle-user-status"]');if(t.target.id==="showInactiveUsersToggle")Mo();else if(e){t.stopPropagation();const s=e.dataset.userId,n=e.checked?"active":"inactive";try{await $2(s,n),k(`Usuário ${n==="active"?"ativado":"inativado"} com sucesso.`,"success");const o=x.users.findIndex(r=>r.id===s);o>-1&&(x.users[o].status=n,Mo())}catch(o){k(`Erro ao atualizar status: ${o.message}`,"error"),e.checked=!e.checked,Mo()}}},Ut.addEventListener("click",dn),Ut.addEventListener("change",un),await N2()}const B2=document.getElementById("content");let Bd={},ni=null;function V2(){Object.values(Bd).forEach(t=>t?.destroy()),Bd={}}function F2(t,e){if(!window.jspdf){k("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:s}=window.jspdf,n=new s({orientation:"landscape",unit:"px",format:"a4"}),o=document.getElementById("salesReportSummaryCards");if(n.setFontSize(18),n.text(t,n.internal.pageSize.getWidth()/2,40,{align:"center"}),o){const a=[["Receita Total",o.querySelector("#summary-revenue").textContent],["Vendas Totais",o.querySelector("#summary-transactions").textContent],["Ticket Médio",o.querySelector("#summary-avg-ticket").textContent]];n.autoTable({startY:60,head:[["Métrica","Valor"]],body:a,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=n.lastAutoTable?n.lastAutoTable.finalY+20:60;n.text("Detalhes das Vendas",20,r),n.autoTable({html:`#${e}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),n.save(`${t.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Vd(t){const e=document.getElementById("genericModal"),s=P(t.client),n=P(t.items),o=P(t.responsavelCaixa||"N/A"),r=(t.payments||[]).map(a=>`
    ...
    `}).join(""),a.querySelectorAll("div[data-transaction-index]").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.transactionIndex,d=ni.transactions[c];d&&Vd(d)})})}async function Fd(){const t=document.getElementById("main-reports-view"),e=document.getElementById("reportStartDate"),s=document.getElementById("reportEndDate");if(!t||!e||!s)return;const n=e.value,o=s.value;if(!n||!o)return k("Atenção","Por favor, selecione as datas de início e fim.","error");t.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,a=await zy({establishmentId:x.establishmentId,startDate:n,endDate:o,cashierSessionId:r});ni=a,t.innerHTML=`
        ...
        `,O2(a)}catch(r){k("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),t.innerHTML=`<p class="p-8 text-center text-red-500">${P(r.message)}</p>`}}async function q2(){V2();const t=new Date().toISOString().split("T")[0],e=new Date;e.setDate(e.getDate()-30);const s=e.toISOString().split("T")[0];B2.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Fd),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const n=document.getElementById("reportStartDate").value,o=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${n}_a_${o}`;F2(r,"transactionsTable")});try{const n=await Ex(x.establishmentId),o=document.getElementById("cashierSessionFilter");n&&n.length>0&&n.forEach(r=>{const a=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),l=P(r.closedByName||"N/A");o.innerHTML+=`<option value="${r.id}">${l} - ${a}</option>`})}catch{k("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Fd()}const j2=document.getElementById("content");let W={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},Ea=null,yo=null,xo=null;function tl(t){const e=new Map,s=[];return t&&(t.forEach(n=>e.set(n.id,{...n,children:[]})),e.forEach(n=>{n.parentId&&e.has(n.parentId)?e.get(n.parentId).children.push(n):s.push(n)})),s}function Ip(t,e,s){if(!t)return;if(!e||e.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const n=(o,r=0)=>{const a="— ".repeat(r);return`
    ...
    `,t.style.display="flex"}function z2(){const t=document.getElementById("genericModal");t.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.style.display="flex"}function wo(t,e="all"){let s='<option value="all">Todos</option>';const n=a=>{const l=new Map,c=[];return a&&(a.forEach(d=>l.set(d.id,{...d,children:[]})),l.forEach(d=>{d.parentId&&l.has(d.parentId)?l.get(d.parentId).children.push(d):c.push(d)})),c},o=(a,l=0)=>{const c=l>0?"— ".repeat(l):"",d=a.id===e?"selected":"";s+=`<option value="${a.id}" ${d}>${c}${a.name}</option>`,a.children.forEach(p=>o(p,l+1))};return n(t).forEach(a=>o(a)),s}async function es(){const t=document.getElementById("financial-content");if(!t)return;const e=document.getElementById("filterStartDate"),s=document.getElementById("filterEndDate");if(!e||!s)return;const n=e.value,o=s.value,r=document.getElementById("filterNaturezaId")?.value,a=document.getElementById("filterCostCenterId")?.value;if(!n||!o){try{const[d,p]=await Promise.all([Bn(x.establishmentId),Vn(x.establishmentId)]);if(!document.getElementById("financial-content"))return;W={...W,natures:d,costCenters:p},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=wo(W.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=wo(W.costCenters))}catch(d){k("Erro",`Não foi possível carregar os dados base: ${d.message}`,"error")}oi(),Ud();return}const l=document.getElementById("payables-list"),c=document.getElementById("receivables-list");l&&(l.innerHTML='<div class="loader mx-auto"></div>'),c&&(c.innerHTML='<div class="loader mx-auto"></div>');try{const d={startDate:n,endDate:o,establishmentId:x.establishmentId};r&&r!=="all"&&(d.natureId=r),a&&a!=="all"&&(d.costCenterId=a);const[p,h,b,w]=await Promise.all([Xw(d),s2(d),Bn(x.establishmentId),Vn(x.establishmentId)]);if(!document.getElementById("financial-content"))return;const S=(h.previousBalance||0)-(p.previousBalance||0);W={...W,payables:p.entries||[],receivables:h.entries||[],natures:b||[],costCenters:w||[],previousBalance:S,filterNaturezaId:r,filterCostCenterId:a},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=wo(W.natures,W.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=wo(W.costCenters,W.filterCostCenterId)),oi(),Ud()}catch(d){document.getElementById("financial-content")&&(k("Erro",`Não foi possível carregar os dados: ${d.message}`,"error"),t.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function W2(t,e,s=null){t.preventDefault();const n=t.target,o=n.querySelector('[name="status"]').checked,r=n.querySelector('[name="paymentDate"]').value,a=parseFloat(n.querySelector('[name="amount"]').value),l=parseInt(n.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(a)){k("Erro de Validação","O valor inserido é inválido.","error");return}if(o&&!r){k("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const c={description:n.querySelector('[name="description"]').value,amount:a,dueDate:n.querySelector('[name="dueDate"]').value,naturezaId:n.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:n.querySelector('[name="centroDeCustoId"]').value||null,notes:n.querySelector('[name="notes"]').value,status:o?"paid":"pending",paymentDate:o?r:null,installments:s?1:l,establishmentId:x.establishmentId};try{s?(await(e==="payable"?Yw(s,c):n2(s,c)),k("Sucesso","Lançamento atualizado!","success")):(await(e==="payable"?Qw(c):t2(c)),k("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await es()}catch(d){k("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function G2(t,e){if(await ce("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(t==="payable"?Zw(e):o2(e)),k("Sucesso","Lançamento excluído!","success"),await es()}catch(n){k("Erro",`Falha ao excluir: ${n.message}`,"error")}}async function K2(t,e){const s=new Date().toISOString().split("T")[0];try{await(t==="payable"?e2(e,s):r2(e,s)),k("Sucesso","Lançamento atualizado!","success"),await es()}catch(n){k("Erro",`Falha ao atualizar status: ${n.message}`,"error")}}function Hd(t){const e=W.currentFilter;return e==="all"?t:t.filter(s=>s.status===e)}function oi(){const t=document.getElementById("payables-list"),e=document.getElementById("receivables-list");if(!t||!e)return;const s=new Map(W.natures.map(l=>[l.id,l.name])),n=new Map(W.costCenters.map(l=>[l.id,l.name])),o=Hd(W.payables),r=Hd(W.receivables),a=(l,c)=>{const d=l.status==="paid",p=JSON.stringify(l).replace(/'/g,"&apos;"),h=l.naturezaId?s.get(l.naturezaId):"N/A",b=l.centroDeCustoId?n.get(l.centroDeCustoId):"N/A";let w=c==="payable"?"text-red-600":"text-green-600";const S=d?"bg-gray-200 text-gray-600":c==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",_=d?"Finalizado":"Pendente";return d&&(w="text-gray-500"),`
    ...
    `;if(s.innerHTML=`
        ...
        </div>`,s.style.display="flex",e){const b=s.querySelector('[name="naturezaId"]');b&&(b.value=e.naturezaId||"");const w=s.querySelector('[name="centroDeCustoId"]');w&&(w.value=e.centroDeCustoId||"")}const d=s.querySelector("#status"),p=s.querySelector("#payment-date-container"),h=s.querySelector('[name="paymentDate"]');e?.status==="paid"&&(d.checked=!0,p.classList.remove("hidden"),h.value=e.paymentDate||new Date().toISOString().split("T")[0]),d.addEventListener("change",()=>{p.classList.toggle("hidden",!d.checked),h.required=d.checked}),s.querySelector("#financial-form").addEventListener("submit",b=>W2(b,t,e?.id))}async function J2(){const t=new Date,s=new Date(t.getFullYear(),t.getMonth()-1,1).toISOString().split("T")[0],n=t.toISOString().split("T")[0];W.startDate=s,W.endDate=n,W.currentFilter="pending",W.filterNaturezaId="all",W.filterCostCenterId="all",j2.innerHTML=`
        <section>
    ...
    `;const o=document.getElementById("main-fab-btn"),r=document.getElementById("fab-menu");if(o&&r){o.addEventListener("click",_=>{_.stopPropagation(),r.classList.toggle("hidden"),o.classList.toggle("rotate-45")});const b=r.querySelector('button[data-action="open-modal"][data-type="receivable"]'),w=r.querySelector('button[data-action="open-modal"][data-type="payable"]'),S=r.querySelector('button[data-action="open-cash-flow-modal"]');b&&b.addEventListener("click",_=>{_.stopPropagation(),Ia("receivable")}),w&&w.addEventListener("click",_=>{_.stopPropagation(),Ia("payable")}),S&&S.addEventListener("click",_=>{_.stopPropagation(),jd()})}yo&&document.body.removeEventListener("click",yo),xo&&document.getElementById("genericModal").removeEventListener("click",xo);const a=()=>{const b=document.getElementById("filterStartDate"),w=document.getElementById("filterEndDate"),S=document.getElementById("filterNaturezaId"),_=document.getElementById("filterCostCenterId");if(!b)return;W.startDate=b.value,W.endDate=w.value,W.filterNaturezaId=S.value,W.filterCostCenterId=_.value;const D=document.getElementById("advanced-filters");D&&D.classList.contains("hidden")===!1&&window.innerWidth<768&&D.classList.add("hidden"),es()},l=b=>{const w=b.target.closest("[data-status-filter]");if(!w)return;const S=w.dataset.statusFilter;W.currentFilter=S,document.querySelectorAll("[data-status-filter]").forEach(_=>{_.classList.remove("bg-blue-100","text-blue-800"),_.classList.add("bg-gray-100","text-gray-600")}),w.classList.remove("bg-gray-100","text-gray-600"),w.classList.add("bg-blue-100","text-blue-800"),oi()},c=b=>{const w=document.getElementById("payables-container"),S=document.getElementById("receivables-container"),_=document.getElementById("btn-payables-view"),D=document.getElementById("btn-receivables-view");w&&(window.innerWidth>=1024&&W.currentListView===b||(b==="payables"?(w.classList.remove("hidden"),S.classList.add("hidden"),_&&(_.classList.remove("bg-gray-200"),_.classList.add("bg-red-100","border","border-red-500")),D&&(D.classList.remove("bg-green-100","border","border-green-500"),D.classList.add("bg-gray-200"))):(w.classList.add("hidden"),S.classList.remove("hidden"),_&&(_.classList.remove("bg-red-100","border","border-red-500"),_.classList.add("bg-gray-200")),D&&(D.classList.remove("bg-gray-200"),D.classList.add("bg-green-100","border","border-green-500"))),W.currentListView=b))};document.getElementById("applyDateFilterBtn").addEventListener("click",a),document.getElementById("filterNaturezaId").addEventListener("change",()=>{W.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{W.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(b=>{b.addEventListener("click",l)}),yo=b=>{const w=b.target.closest("button[data-action]");if(!w)return;const{action:S,type:_,id:D}=w.dataset;S==="edit"?Ia(_,JSON.parse(w.dataset.item.replace(/&apos;/g,"'"))):S==="delete"?G2(_,D):S==="mark-as-paid"?K2(_,D):S==="manage-natures"?Od("nature"):S==="manage-cost-centers"?Od("cost-center"):S==="open-cash-flow-modal"?jd():S==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):S==="open-indicators-modal"?U2():S==="open-settings-modal"?z2():S==="toggle-list-view"&&c(w.dataset.list)},xo=b=>{const w=b.target.closest('button[data-action^="delete-"]');if(w){const S=w.dataset.action.split("-")[1];d(S,w.dataset.id)}},document.body.addEventListener("click",yo),document.getElementById("genericModal").addEventListener("click",xo);async function d(b,w){const S=b==="nature",_=S?Gw:Jw,D=S?Bn:Vn,R=S?"natures":"costCenters",O=document.getElementById("hierarchyList");if(await ce("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await _(w);const B=await D(x.establishmentId);W[R]=B,Ip(O,tl(B),b),await es()}catch(B){k("Erro",`Não foi possível apagar: ${B.message}`,"error")}}const p=()=>{const b=window.innerWidth<1024,w=document.getElementById("payables-container"),S=document.getElementById("receivables-container"),_=document.getElementById("list-toggle-buttons");w&&S&&(w.classList.remove("hidden"),S.classList.remove("hidden"),b?(w.classList.remove("lg:col-span-1"),S.classList.remove("lg:col-span-1"),_?.classList.remove("hidden"),c(W.currentListView)):(w.classList.add("lg:col-span-1"),S.classList.add("lg:col-span-1"),_?.classList.add("hidden"),w.classList.remove("hidden"),S.classList.remove("hidden")))};p(),window.addEventListener("resize",p);const h=document.querySelector(`[data-status-filter="${W.currentFilter}"]`);h&&(document.querySelectorAll("[data-status-filter]").forEach(b=>{b.classList.remove("bg-blue-100","text-blue-800"),b.classList.add("bg-gray-100","text-gray-600")}),h.classList.remove("bg-gray-100","text-gray-600"),h.classList.add("bg-blue-100","text-blue-800"));try{const b=await i2(x.establishmentId),w=document.getElementById("summary-today-payables");w&&(w.textContent=`R$ ${b.totalPayables.toFixed(2)}`);const S=document.getElementById("summary-today-receivables");S&&(S.textContent=`R$ ${b.totalReceivables.toFixed(2)}`)}catch{}await es()}const Q2=t=>F("/api/commissions/calculate",{method:"POST",body:JSON.stringify(t)}),X2=t=>F("/api/commissions/save",{method:"POST",body:JSON.stringify(t)}),Y2=(t,e)=>{const s=new URLSearchParams({startDate:t,endDate:e}).toString();return F(`/api/commissions/stats?${s}`)},Z2=(t={})=>{Object.keys(t).forEach(n=>(t[n]===void 0||t[n]===null||t[n]==="")&&delete t[n]);const e=new URLSearchParams(t).toString(),s=`/api/commissions/history${e?"?"+e:""}`;return F(s)},e1=t=>F(`/api/commissions/report/${t}`,{method:"DELETE"}),tr=new Date,zd=new Date(tr.getFullYear(),tr.getMonth(),1),J={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:zd.toISOString().split("T")[0],dashEndDate:tr.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:zd.toISOString().split("T")[0],histEndDate:tr.toISOString().split("T")[0],histProfessionalId:"all"};let Eo=null;const hn=document.getElementById("content");async function t1(){try{J.professionals=await We(x.establishmentId)}catch(t){console.error("Erro profissionais",t)}m1(),s1(),$r(),nr("dashboard")}function s1(){Eo&&hn.removeEventListener("click",Eo),Eo=t=>{const e=t.target.closest("button");if(!e)return;const s=e.dataset.action,n=e.dataset.id,o=e.dataset.idx;switch(s){case"tab-nav":nr(e.dataset.tab);break;case"toggle-all-profs":n1();break;case"back-to-filters":J.calculationResult=null,sr(document.getElementById("commissions-content"));break;case"view-preview-items":u1(o);break;case"save-final-report":r1();break;case"start-new-calc":nr("calculator");break;case"print-receipt":a1(n);break;case"delete-report":i1(n);break;case"filter-dashboard":$r();break;case"filter-history":sl();break}},hn.addEventListener("click",Eo),hn.oninput=t=>{if(t.target.classList.contains("input-debit")||t.target.classList.contains("input-credit")){const e=t.target.dataset.idx;c1(e)}},hn.onsubmit=t=>{t.target.id==="calc-form"&&(t.preventDefault(),o1())}}async function $r(){const t=document.getElementById("dash-start"),e=document.getElementById("dash-end");t&&(J.dashStartDate=t.value),e&&(J.dashEndDate=e.value);const s=document.getElementById("dashboard-stats-container");s&&(s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const n=await Y2(J.dashStartDate,J.dashEndDate);J.dashStats={revenue:n.totalRevenue||0,commissions:n.totalCommissionsPaid||0},J.currentTab==="dashboard"&&Sp(document.getElementById("commissions-content"))}catch(n){console.error(n),s&&(s.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function sl(){const t=document.getElementById("hist-start"),e=document.getElementById("hist-end"),s=document.getElementById("hist-prof");t&&(J.histStartDate=t.value),e&&(J.histEndDate=e.value),s&&(J.histProfessionalId=s.value);const n=document.getElementById("history-list-container");if(n){n.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const o=await Z2({startDate:J.histStartDate,endDate:J.histEndDate,professionalId:J.histProfessionalId});J.historyData=o,Tp(n,o)}catch{n.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function n1(){const t=document.querySelectorAll(".prof-checkbox"),e=Array.from(t).every(s=>s.checked);t.forEach(s=>s.checked=!e)}async function o1(){const t=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(r=>r.value);if(t.length===0)return k("Atenção","Selecione profissionais","error");const e={professionalIds:t,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},s=new Date(e.startDate+"T00:00:00").toLocaleDateString("pt-BR"),n=new Date(e.endDate+"T00:00:00").toLocaleDateString("pt-BR");J.periodString=`${s} a ${n}`;const o=document.getElementById("commissions-content");o.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const r=await Q2(e);J.calculationResult=r.map(a=>({...a,extraDebit:0,extraCredit:0,finalValue:a.summary.totalCommission,notes:""})),sr(o)}catch(r){k("Erro",r.message,"error"),J.calculationResult=null,sr(o)}}async function r1(){const t=J.calculationResult.length;if(await ce("Confirmar",`Gerar ${t} relatórios? Isso marcará as vendas como pagas.`))try{const s=J.calculationResult.map(n=>{const o=n.items.map(r=>r.originalSaleId).filter(r=>r!=null);return X2({professionalId:n.professionalId,professionalName:n.professionalName,period:J.periodString,processedSalesIds:o,reportData:{...n,summary:{...n.summary,finalValue:n.finalValue,extraDebit:n.extraDebit||0,extraCredit:n.extraCredit||0,notes:n.notes||""}}})});await Promise.all(s),k("Sucesso","Pagamentos registrados!","success"),J.calculationResult=null,$r(),nr("history")}catch(s){k("Erro",s.message,"error")}}function a1(t){const e=J.historyData.find(s=>s.id===t);e&&l1(e)}async function i1(t){if(await ce("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await e1(t),k("Sucesso","Registro removido.","success"),sl(),$r()}catch(s){k("Erro",s.message,"error")}}function l1(t){const{jsPDF:e}=window.jspdf;if(!e)return k("Erro","PDF lib não carregada.","error");const s=new e,n=s.internal.pageSize.getWidth()/2;s.setFontSize(18),s.setFont(void 0,"bold"),s.text("RECIBO DE PAGAMENTO DE COMISSÃO",n,20,{align:"center"}),s.setFontSize(12),s.setFont(void 0,"normal"),s.text(`Profissional: ${t.professionalName}`,15,40),s.text(`Período: ${t.period}`,15,48);const o=[["Comissão Bruta",`R$ ${t.summary.totalCommission.toFixed(2)}`]];t.summary.extraCredit>0&&o.push(["(+) Bônus",`R$ ${t.summary.extraCredit.toFixed(2)}`]),t.summary.extraDebit>0&&o.push(["(-) Descontos",`R$ ${t.summary.extraDebit.toFixed(2)}`]),s.autoTable({startY:60,head:[["Descrição","Valor"]],body:o,theme:"grid"});const r=s.lastAutoTable.finalY+10;s.setFontSize(14),s.setFont(void 0,"bold"),s.text(`Total Líquido: R$ ${(t.summary.finalValue||t.summary.totalCommission).toFixed(2)}`,190,r,{align:"right"}),s.save(`Recibo_${t.professionalName}.pdf`)}function c1(t){const e=document.querySelectorAll(`.input-debit[data-idx="${t}"]`),s=document.querySelectorAll(`.input-credit[data-idx="${t}"]`);let n=0,o=0;if(e.forEach(r=>{r.value&&(n=parseFloat(r.value))}),s.forEach(r=>{r.value&&(o=parseFloat(r.value))}),J.calculationResult&&J.calculationResult[t]){const r=J.calculationResult[t];r.extraDebit=n,r.extraCredit=o,r.finalValue=r.summary.totalCommission-n+o,e.forEach(l=>{l!==document.activeElement&&(l.value=n||"")}),s.forEach(l=>{l!==document.activeElement&&(l.value=o||"")}),document.querySelectorAll(`.final-value-display[data-idx="${t}"]`).forEach(l=>l.innerText=`R$ ${r.finalValue.toFixed(2)}`),d1()}}function d1(){const t=J.calculationResult.reduce((s,n)=>s+n.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(s=>s.innerText=`R$ ${t.toFixed(2)}`)}function u1(t){const e=J.calculationResult[t];if(!e)return;const s=e.items.map(n=>`
    ...
    `}function p1(t){const e=J.professionals.map(s=>`<option value="${s.id}" ${J.histProfessionalId===s.id?"selected":""}>${s.name}</option>`).join("");t.innerHTML=`
        <div class="space-y-6">
    ...
    `}const Sa=document.getElementById("content");let ts={allPackages:[],catalogForModal:{services:[],products:[]}},Io=null,Ss=null;function h1(t=6){let e="";for(let s=0;s<t;s++)e+=`
        ...
        `;return e}function g1(){const t=document.getElementById("packagesListContainer");if(t){if(ts.allPackages.length===0){t.innerHTML=`
    ...
    `,Io&&Sa.removeEventListener("click",Io),Io=t=>{if(t.target.closest('[data-action-stop-propagation="true"]')){t.stopPropagation();const n=t.target.closest('[data-action="delete-package"]');if(n){const o=n.dataset.id;ce("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async r=>{if(r)try{await kx(o),k("Sucesso!","Pacote excluído.","success"),await nl()}catch(a){k("Erro",`Não foi possível excluir: ${a.message}`,"error")}})}return}const e=t.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!e)return;const s=e.dataset.action;if(s==="new-package")Gd(null);else if(s==="edit-package"){const n=JSON.parse(e.dataset.package);Gd(n)}},Sa.addEventListener("click",Io);try{const[t,e,s]=await Promise.all([op(x.establishmentId),ds(x.establishmentId),ir(x.establishmentId)]);ts.allPackages=t,ts.catalogForModal={services:e.filter(n=>n.active),products:s},g1()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const b1=document.getElementById("content");let v1=null;async function y1(){const t=P(x.userName||"Usuário"),e=P(Ae.currentUser?.email||"E-mail não disponível"),s=x.userName?x.userName.charAt(0):"U";b1.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await x1()}async function x1(){const t=document.getElementById("professional-agenda-block");t.innerHTML="";try{const e=x.userProfessionalId;if(e){const s=await $h(e);v1=s,s.photo&&(document.getElementById("user-profile-avatar").src=s.photo);const n=P(s.name);t.innerHTML=`
            ...
            `,w1(s.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>or(s.id,r.target.value)),or(s.id,"future")}else t.innerHTML=`
    ...
    `}function ri(){const t=Cn.filter(e=>!e.read).length;if(t>0?(Ca.textContent=t,Ca.classList.remove("hidden")):Ca.classList.add("hidden"),Cn.length===0){Jd.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Jd.innerHTML=Cn.map(e=>`
    ...
    `).join("")}function _1(t){kn&&kn();const e=_t(Pe,"establishments",t,"notifications"),s=rr(e,_n("timestamp",">=",new Date),eu("timestamp","desc"));kn=mh(s,n=>{n.docChanges().forEach(o=>{if(o.type==="added"){const r=o.doc.data();Cn.unshift({title:r.title,message:r.message,time:r.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),k(r.title,r.message,"info",!0),ri();const a=document.querySelector(".sidebar-link.active");a&&a.dataset.target==="agenda-section"&&(r.type==="cancellation"||r.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),sp())}})},n=>{console.error("Erro no listener de notificações em tempo real:",n)})}function gt(t,e={}){const s=t.replace("-section","");if(t!=="my-profile-section"){const o=x.enabledModules?.[s]!==!1,r=x.userPermissions===null||x.userPermissions[t]?.view===!0;if(!o||!r){ka.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(a=>a.classList.remove("active"));return}}const n=k1[t];n?(document.querySelectorAll(".sidebar-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("data-target")===t)}),t==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(o=>o.classList.remove("active")),ka.innerHTML="",n(e)):ka.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${t}" ainda não foi implementado.</p></div>`}async function A1(t){const e=document.getElementById("kpi-appointments-wrapper"),s=document.getElementById("kpi-financial-wrapper"),n=document.getElementById("kpi-today-appointments"),o=document.getElementById("kpi-today-revenue"),r=t===null||t["agenda-section"]?.view===!0,a=t===null||t["financial-section"]?.view===!0;if(r&&e&&e.classList.remove("hidden"),a&&s&&s.classList.remove("hidden"),!(!r&&!a))try{const l=await Wy();r&&n&&(n.textContent=l.todayAppointments.toString()),a&&o&&(o.textContent=`R$ ${l.todayRevenue.toFixed(2).replace(".",",")}`)}catch(l){console.error("Erro ao carregar KPIs do cabeçalho:",l)}}async function P1(t){try{console.log("[Nativo] Iniciando configuração de Push..."),Qt.getPlatform()==="android"&&(await Be.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let e=await Be.checkPermissions();if(e.receive==="prompt"&&(e=await Be.requestPermissions()),e.receive!=="granted"){alert("ERRO: Permissão de notificações negada!");return}await Be.register(),Be.addListener("registration",async s=>{console.log("Push Token gerado:",s.value),alert("SUCESSO: Token gerado! "+s.value.substring(0,10)+"...");try{const n=ss(Pe,"users",t);await su(n,{fcmTokens:uh(s.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(n){alert("Erro ao salvar no Banco: "+n.message),console.error("Erro ao salvar token FCM:",n)}}),Be.addListener("registrationError",s=>{alert("FALHA DE REGISTO: "+JSON.stringify(s)),console.error("Erro no registo de push notifications:",s)}),Be.addListener("pushNotificationReceived",s=>{console.log("Notificação Push recebida:",s),k(s.title,s.body,"info",!0)}),Be.addListener("pushNotificationActionPerformed",s=>{console.log("Ação na notificação push:",s),gt("agenda-section")})}catch(e){alert("Erro Fatal Push: "+e.message),console.log("Push Notifications não suportado/inicializado:",e)}}async function $1(){try{await ih(Ae,lh),console.log("Persistência LOCAL configurada na inicialização.")}catch(t){console.error("Erro ao definir persistência no main.js",t)}Qt.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Ih(),Kd.addEventListener("click",t=>{t.stopPropagation(),To.classList.toggle("hidden"),To.classList.contains("hidden")||(Cn.forEach(e=>e.read=!0),ri())}),T1.addEventListener("click",()=>{Sh()}),_a.addEventListener("click",t=>{t.stopPropagation(),tt.classList.toggle("active"),tt.classList.contains("active")?tt.classList.remove("hidden"):setTimeout(()=>tt.classList.add("hidden"),200)}),Qd&&Qd.addEventListener("click",t=>{t.preventDefault(),gt("my-profile-section"),tt.classList.remove("active"),tt.classList.add("hidden")}),document.addEventListener("click",t=>{!To.contains(t.target)&&t.target!==Kd&&To.classList.add("hidden"),!tt.contains(t.target)&&t.target!==_a&&tt.classList.contains("active")&&(tt.classList.remove("active"),setTimeout(()=>tt.classList.add("hidden"),200))}),Yd(Ae,async t=>{if(t){console.log("Usuário detectado:",t.email),Qt.isNativePlatform()||(console.log("Inicializando Web Push (PWA)..."),Km());try{const s=(await t.getIdTokenResult(!0)).claims;if((s.role==="owner"||s.role==="employee")&&s.establishmentId){const n=await cs(s.establishmentId);x.enabledModules=n.modules,C1(n.themeColor||"indigo");let o=null,r=t.displayName,a=null;if(s.role==="employee"||s.role==="owner"){const d=ss(Pe,"users",t.uid),p=await dh(d);if(p.exists()){const h=p.data();o=s.role==="employee"?h.permissions||{}:null,r=h.name||r,a=h.professionalId||null}else if(s.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}x.userProfessionalId=a,Qt.isNativePlatform()&&P1(t.uid);const l=r||t.email;ph(s.establishmentId,n.name,o),_a.textContent=l.charAt(0).toUpperCase(),E1.textContent=l,I1.textContent=t.email;const c=()=>{kn&&kn(),ac(Ae).then(()=>window.location.href="/login.html")};S1.addEventListener("click",d=>{d.preventDefault(),c()}),_h(gt,o,x.enabledModules),A1(o),_1(s.establishmentId),ri(),So.classList.add("fade-out"),Ta.style.display="flex",setTimeout(()=>{So.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{jh()},1500),gt("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(e){console.error("Erro crítico na inicialização do painel:",e),So.classList.add("fade-out"),setTimeout(()=>{So.style.display="none"},500),Ta.innerHTML=`
                ...
                `,Ta.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{ac(Ae).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}$1();Yd(Ae,t=>{t&&Km()});
