import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as U,d as _,m as Oo}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Ps,reauthenticateWithCredential as Bs,verifyBeforeUpdateEmail as Ds,updatePassword as Ms,updateProfile as As,setPersistence as Ns,browserLocalPersistence as qs,onAuthStateChanged as Ba,signOut as zo}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as ue,getDoc as Da,updateDoc as xo,setDoc as Rs,addDoc as Ma,collection as me,query as jt,where as st,getDocs as yo,orderBy as Aa,writeBatch as Na,serverTimestamp as Vo,deleteDoc as js,arrayUnion as Fs,onSnapshot as Hs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Os,onMessage as zs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Vs(e,t,o){m.establishmentId=e,m.establishmentName=t,m.userPermissions=o}const qa=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ro=qa?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${qa?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",ro);async function Us(){const e=U.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function k(e,t={}){const o=await Us();if(!o)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const a=ro.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,s=`${a}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${s}`);try{const n=await fetch(s,{...t,headers:{...o,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${s}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${s}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ro}. Verifique se o servidor backend está rodando.`):n}}const Ra=(e,t,o,a=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${o}`;return a&&(r+=`&professionalId=${a}`),k(r)},_s=(e,t,o)=>{const a=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${o}`;return k(a)},Js=({establishmentId:e,professionalId:t,serviceIds:o,date:a})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${o.join(",")}&date=${a}`;return k(r)},Ws=e=>k("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Gs=(e,t)=>k(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Uo=e=>k(`/api/appointments/${e}`,{method:"DELETE"}),Ys=e=>k(`/api/appointments/${e}/reopen`,{method:"POST"}),Qs=(e,t)=>k(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let J;async function Xs(){if(!J)try{J=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Zs(){if(!J){console.warn("AudioContext não inicializado. O som não será tocado.");return}J.state==="suspended"&&J.resume();const e=J.createOscillator(),t=J.createGain();e.connect(t),t.connect(J.destination),e.type="sine",e.frequency.setValueAtTime(800,J.currentTime),t.gain.setValueAtTime(0,J.currentTime),t.gain.linearRampToValueAtTime(.3,J.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,J.currentTime+.2),e.start(J.currentTime),e.stop(J.currentTime+.2)}function p(e,t,o="info",a=!1){const r=document.getElementById("toast-container");if(!r)return;a&&Zs();const s=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${n[o]||n.info}`,s.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function Ft(e){const t=document.getElementById(e);t&&(t.style.display="none")}function Ks(){document.body.addEventListener("click",()=>{J||Xs()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const a=t.dataset.target;if(a){const r=document.getElementById(a);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const a=document.getElementById("genericModal");a&&(a.style.display="none")}})}async function _o(){const e=document.getElementById("cancellationListContainer");if(!e)return;e.innerHTML='<div class="loader mx-auto"></div>';const t=document.getElementById("cancelStartDate").value,o=document.getElementById("cancelEndDate").value;try{const a=await _s(m.establishmentId,t,o);if(a.length===0){e.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}e.innerHTML=a.map(r=>`
        ...
        `).join("")}catch(a){e.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${a.message}</p>`}}function er(){const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=`
    ...
    `,{modalElement:r}=Y({title:"Histórico de Cancelamentos",contentHTML:a,maxWidth:"max-w-3xl"});r.querySelector("#searchCancellationsBtn").addEventListener("click",_o),_o()}const X=document.getElementById("sidebar"),Jo=document.getElementById("sidebarToggle"),Qe=document.getElementById("mainContent"),tr=document.querySelectorAll(".sidebar-link"),Wo=document.getElementById("hamburger-menu-btn"),qe=document.getElementById("mobile-overlay");function yt(e){!X||!Qe||(X.classList.toggle("collapsed",e),Qe.classList.toggle("sidebar-collapsed-shift",e))}function or(){!X||!qe||(X.classList.add("mobile-open"),qe.classList.add("visible"))}function ut(){!X||!qe||(X.classList.remove("mobile-open"),qe.classList.remove("visible"))}function ar(){yt(!X.classList.contains("collapsed"))}function sr(e,t,o){if(!X||!Qe)return;Qe.classList.add("main-content-shift"),window.innerWidth>=768?yt(X.classList.contains("collapsed")):(Qe.classList.remove("main-content-shift","sidebar-collapsed-shift"),ut()),Jo&&Jo.addEventListener("click",r=>{r.stopPropagation(),ar()}),X.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&X.classList.contains("collapsed")&&yt(!1)}),X.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||yt(!0))}),Wo&&Wo.addEventListener("click",r=>{r.stopPropagation(),or()}),qe&&qe.addEventListener("click",r=>{r.stopPropagation(),ut()});let a=0;X.addEventListener("touchstart",r=>{a=r.changedTouches[0].screenX},{passive:!0}),X.addEventListener("touchend",r=>{const s=r.changedTouches[0].screenX;a-s>50&&ut()},{passive:!0}),tr.forEach(r=>{const s=r.getAttribute("data-target"),n=s.replace("-section",""),i=o?.[n]!==!1,l=t===null||t[s]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),s&&typeof e=="function"&&e(s),window.innerWidth<768&&ut()})})}const Se=e=>{const t=e||m.establishmentId;return t?k(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},wt=(e,t)=>{const o=e||m.establishmentId;return o?k(`/api/establishments/${o}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},rr=(e,t)=>{const o=e||m.establishmentId;return o?k(`/api/establishments/${o}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},nr=(e,t)=>{const o=e||m.establishmentId;return o?k(`/api/establishments/${o}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Z=e=>k(`/api/professionals/${e}`),ir=e=>k(`/api/professionals/details/${e}`),ja=e=>k("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Ct=(e,t)=>k(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Go=(e,t)=>Ct(e,{services:t}),Fa=e=>k(`/api/professionals/${e}`,{method:"DELETE"}),lr=e=>{const t=e.map(o=>Fa(o));return Promise.all(t)},$e=e=>k(`/api/services/${e}`),Ha=e=>k("/api/services",{method:"POST",body:JSON.stringify(e)}),dr=(e,t)=>k(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),cr=e=>k(`/api/services/${e}`,{method:"DELETE"}),ur=(e,t)=>k(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),mr=e=>k(`/api/services/stats/most-popular/${e}`),Ht=e=>k(`/api/products/${e}`),Oa=e=>k("/api/products",{method:"POST",body:JSON.stringify(e)}),pr=(e,t)=>k(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),gr=e=>k(`/api/products/${e}`,{method:"DELETE"}),br=(e,t)=>k(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),fr=({startDate:e,endDate:t,productId:o,categoryId:a,establishmentId:r})=>{const s=new URLSearchParams({startDate:e,endDate:t});return o&&o!=="all"&&s.append("productId",o),a&&a!=="all"&&s.append("categoryId",a),r&&s.append("establishmentId",r),k(`/api/products/stock-history/report?${s.toString()}`)},vr={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function Yo(e,t,o){return new Promise((a,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const g=e.type==="image/png"&&t<500?"image/png":"image/jpeg";a(l.toDataURL(g,o))},i.onerror=l=>r(l)},s.onerror=n=>r(n)})}let de=null;const kt=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let K=0,Lt=[];async function hr(){try{console.log("Iniciando verificação de Onboarding para ID:",m.establishmentId);const e=await Se(m.establishmentId),t=await Z(m.establishmentId),o=await $e(m.establishmentId);Lt=o||[];const a=e&&e.name&&(e.phone||e.address),r=e&&(e.logo||e.themeColor&&e.themeColor!=="indigo"),s=e&&e.slotInterval>0,n=o&&o.length>0,i=t&&t.length>0;if(console.log("Status Onboarding:",{hasCompanyData:a,hasBranding:r,hasTimeConfig:s,hasService:n,hasProf:i}),a&&s&&i&&n)return;if(!a)K=0;else if(!r&&!s)K=1;else if(!s)K=2;else if(!n)K=3;else if(!i)K=4;else if(K===0)return;xr(),ko(K)}catch(e){console.error("Erro ao verificar onboarding:",e)}}function xr(){document.getElementById("onboarding-overlay")||(de=document.createElement("div"),de.id="onboarding-overlay",de.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",de.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",de.innerHTML=`
    ...
    `,document.body.appendChild(de),wo())}function wo(){const e=Math.round(K/kt.length*100),t=document.getElementById("progress-bar"),o=document.getElementById("progress-text");t&&(t.style.width=`${e}%`),o&&(o.innerText=`${e}%`)}function ko(e){const t=document.getElementById("onboarding-step-content"),o=kt[e];if(!o){Qo(t);return}let a="";if(o.id==="company_data")a=`
        ...
        `;else if(o.id==="first_prof"){const r=Lt.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""),s=Lt.length>0;a=`
            <form id="step-form" class="space-y-3">
    ...
    `,document.getElementById("next-step-btn").addEventListener("click",()=>yr(o.id)),document.getElementById("skip-btn")&&document.getElementById("skip-btn").addEventListener("click",()=>{e===kt.length-1?Qo(t):(K++,wo(),ko(K))}),o.id==="branding"){const r=document.getElementById("logo-input"),s=document.getElementById("bg-input");r&&(r.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Yo(i,200,.8);document.getElementById("logo-base64").value=l,document.getElementById("logo-preview").innerHTML=`<img src="${l}" class="w-full h-full object-contain rounded">`}catch(l){console.error("Erro logo",l)}}),s&&(s.onchange=async n=>{const i=n.target.files[0];if(i)try{const l=await Yo(i,1024,.7);document.getElementById("bg-base64").value=l}catch(l){console.error("Erro bg",l)}})}}function Qo(e){e.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),o=document.getElementById("progress-text");t&&(t.style.width="100%"),o&&(o.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{de&&de.remove(),window.location.reload()}}async function yr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const o=document.getElementById("next-step-btn"),a=o.innerHTML;o.disabled=!0,o.innerHTML="Salvando...";const r=new FormData(t),s=Object.fromEntries(r.entries());try{if(e==="company_data")await wt(m.establishmentId,{name:s.name,phone:s.phone,email:s.email,address:s.address,zipCode:s.zipCode});else if(e==="branding"){const n={};s.logoBase64&&(n.logo=s.logoBase64),s.bgBase64&&(n.backgroundImage=s.bgBase64),s.themeColor&&(n.themeColor=s.themeColor),s.primaryColor&&(n.primaryColor=s.primaryColor),Object.keys(n).length>0&&await wt(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(s.slotInterval);await wt(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Ha({establishmentId:m.establishmentId,name:s.name,price:parseFloat(s.price),duration:parseInt(s.duration),active:!0});n&&Lt.push(n)}else if(e==="first_prof"){const n=await ja({establishmentId:m.establishmentId,name:s.name,specialty:s.role,active:!0,commissionRate:0});if(s.serviceId&&n&&n.id)try{Go?await Go(n.id,[s.serviceId]):Ct&&await Ct(n.id,{services:[s.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Oa({establishmentId:m.establishmentId,name:s.name,price:parseFloat(s.salePrice),stock:parseInt(s.stock),active:!0});p("Sucesso","Passo concluído!","success"),K++,wo(),ko(K)}catch(n){p("Erro","Erro ao salvar: "+n.message,"error"),o.disabled=!1,o.innerHTML=a}}var Re;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Re||(Re={}));class Qt extends Error{constructor(t,o,a){super(t),this.message=t,this.code=o,this.data=a}}const wr=e=>{var t,o;return e?.androidBridge?"android":!((o=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||o===void 0)&&o.bridge?"ios":"web"},kr=e=>{const t=e.CapacitorCustomPlatform||null,o=e.Capacitor||{},a=o.Plugins=o.Plugins||{},r=()=>t!==null?t.name:wr(e),s=()=>r()!=="web",n=u=>{const g=d.get(u);return!!(g?.platforms.has(r())||i(u))},i=u=>{var g;return(g=o.PluginHeaders)===null||g===void 0?void 0:g.find(b=>b.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,g={})=>{const b=d.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const h=r(),f=i(u);let y;const S=async()=>(!y&&h in g?y=typeof g[h]=="function"?y=await g[h]():y=g[h]:t!==null&&!y&&"web"in g&&(y=typeof g.web=="function"?y=await g.web():y=g.web),y),$=(T,B)=>{var R,j;if(f){const z=f?.methods.find(N=>B===N.name);if(z)return z.rtype==="promise"?N=>o.nativePromise(u,B.toString(),N):(N,Q)=>o.nativeCallback(u,B.toString(),N,Q);if(T)return(R=T[B])===null||R===void 0?void 0:R.bind(T)}else{if(T)return(j=T[B])===null||j===void 0?void 0:j.bind(T);throw new Qt(`"${u}" plugin is not implemented on ${h}`,Re.Unimplemented)}},w=T=>{let B;const R=(...j)=>{const z=S().then(N=>{const Q=$(N,T);if(Q){const Ee=Q(...j);return B=Ee?.remove,Ee}else throw new Qt(`"${u}.${T}()" is not implemented on ${h}`,Re.Unimplemented)});return T==="addListener"&&(z.remove=async()=>B()),z};return R.toString=()=>`${T.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:T,writable:!1,configurable:!1}),R},I=w("addListener"),L=w("removeListener"),q=(T,B)=>{const R=I({eventName:T},B),j=async()=>{const N=await R;L({eventName:T,callbackId:N},B)},z=new Promise(N=>R.then(()=>N({remove:j})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await j()},z},F=new Proxy({},{get(T,B){switch(B){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return f?q:I;case"removeListener":return L;default:return w(B)}}});return a[u]=F,d.set(u,{name:u,proxy:F,platforms:new Set([...Object.keys(g),...f?[h]:[]])}),F};return o.convertFileSrc||(o.convertFileSrc=u=>u),o.getPlatform=r,o.handleError=l,o.isNativePlatform=s,o.isPluginAvailable=n,o.registerPlugin=c,o.Exception=Qt,o.DEBUG=!!o.DEBUG,o.isLoggingEnabled=!!o.isLoggingEnabled,o},Sr=e=>e.Capacitor=kr(e),ye=Sr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),So=ye.registerPlugin;class za{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,o){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(o);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),a&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,o);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,o,a){const r=this.listeners[t];if(!r){if(a){let s=this.retainedEventArguments[t];s||(s=[]),s.push(o),this.retainedEventArguments[t]=s}return}r.forEach(s=>s(o))}hasListeners(t){var o;return!!(!((o=this.listeners[t])===null||o===void 0)&&o.length)}registerWindowListener(t,o){this.windowListeners[o]={registered:!1,windowEventName:t,pluginEventName:o,handler:a=>{this.notifyListeners(o,a)}}}unimplemented(t="not implemented"){return new ye.Exception(t,Re.Unimplemented)}unavailable(t="not available"){return new ye.Exception(t,Re.Unavailable)}async removeListener(t,o){const a=this.listeners[t];if(!a)return;const r=a.indexOf(o);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const o=this.retainedEventArguments[t];o&&(delete this.retainedEventArguments[t],o.forEach(a=>{this.notifyListeners(t,a)}))}}const Xo=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Zo=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class $r extends za{async getCookies(){const t=document.cookie,o={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[r,s]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Zo(r).trim(),s=Zo(s).trim(),o[r]=s}),o}async setCookie(t){try{const o=Xo(t.key),a=Xo(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${o}=${a||""}${r}; path=${s}; ${n};`}catch(o){return Promise.reject(o)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(o){return Promise.reject(o)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const o of t)document.cookie=o.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}So("CapacitorCookies",{web:()=>new $r});const Er=async e=>new Promise((t,o)=>{const a=new FileReader;a.onload=()=>{const r=a.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},a.onerror=r=>o(r),a.readAsDataURL(e)}),Ir=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,s,n)=>(r[s]=e[t[n]],r),{})},Cr=(e,t=!0)=>e?Object.entries(e).reduce((a,r)=>{const[s,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${s}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${s}=${i}`),`${a}&${l}`},"").substr(1):null,Lr=(e,t={})=>{const o=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Ir(e.headers)["content-type"]||"";if(typeof e.data=="string")o.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))s.set(n,i);o.body=s.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{s.append(l,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);o.body=s;const n=new Headers(o.headers);n.delete("content-type"),o.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(o.body=JSON.stringify(e.data));return o};class Tr extends za{async request(t){const o=Lr(t,t.webFetchExtra),a=Cr(t.params,t.shouldEncodeUrlParams),r=a?`${t.url}?${a}`:t.url,s=await fetch(r,o),n=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await s.blob(),l=await Er(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const c={};return s.headers.forEach((u,g)=>{c[g]=u}),{data:l,headers:c,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}So("CapacitorHttp",{web:()=>new Tr});const G=So("PushNotifications",{}),Pr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ko=!1;async function Va(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async o=>{Ja(o.value,!0)}),await G.addListener("pushNotificationReceived",o=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",o)}),await G.addListener("pushNotificationActionPerformed",o=>{const a=o.notification.data;console.log("Notificação clicada (Ação):",a)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&_a()}async function Ua(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await _a(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function _a(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Os(Oo,{vapidKey:Pr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Ja(t,!1)):console.warn("[Push Web] Token veio vazio."),Ko||(zs(Oo,o=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",o)}),Ko=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Ja(e,t){const o=U.currentUser;if(!o){console.warn("Usuário não logado. Token não salvo.");return}const a=ue(_,"users",o.uid);try{const r=await Da(a);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await xo(a,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Rs(a,{email:o.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(s){console.error("Erro ao criar user:",s)}else console.error("Erro ao atualizar token:",r)}}const Br=(e,t,o="all",a="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return o&&o!=="all"&&r.append("professionalId",o),a&&a!=="all"&&r.append("costCenterId",a),k(`/api/reports/indicators?${r.toString()}`)},Dr=e=>e?k(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Mr=({establishmentId:e,startDate:t,endDate:o,cashierSessionId:a})=>{const r=new URLSearchParams({startDate:t,endDate:o});return a&&a!=="all"&&r.append("cashierSessionId",a),e&&r.append("establishmentId",e),k(`/api/reports/sales?${r.toString()}`)},Ar=()=>k("/api/reports/summary",{method:"GET"}),Ot=(e,t,o,a="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${o}&professionalId=${a}`;return k(r)},zt=e=>k("/api/blockages",{method:"POST",body:JSON.stringify(e)}),$o=e=>k(`/api/blockages/${e}`,{method:"DELETE"}),Wa=e=>k("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Eo=e=>e?String(e).replace(/\D/g,""):"",it=(e,t="",o=20,a={})=>{const r=new URLSearchParams;return t&&r.append("search",t),o&&r.append("limit",o),a.hasLoyalty&&r.append("hasLoyalty","true"),a.birthMonth&&r.append("birthMonth",a.birthMonth),a.inactiveDays&&r.append("inactiveDays",a.inactiveDays),k(`/api/clients/${e}?${r.toString()}`)},no=(e,t)=>{const o=encodeURIComponent(t);return k(`/api/clients/details/${e}/${o}`)},Nr=e=>{if(!e.phone)throw new Error("Telefone é obrigatório");const t=Eo(e.phone),o={...e,phone:t,id:t};return k(`/api/clients/${t}`,{method:"PUT",body:JSON.stringify(o)})},qr=(e,t)=>{const o=Eo(t);return k(`/api/clients/full-history/${e}?phone=${o}`)},Ga=e=>{const t=encodeURIComponent(e);return k(`/api/clients/${t}`,{method:"DELETE"})},Rr=(e,t,o,a)=>k("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Eo(t),points:o,rewardName:a})});function v(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Ya(e,t=800,o=800,a=.7){return new Promise((r,s)=>{if(!e.type.match(/image.*/))return s(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>o&&(d*=o/c,c=o);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const b=u.toDataURL("image/jpeg",a);r(b)},l.onerror=d=>s(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>s(new Error("Erro ao ler o ficheiro."))})}const ea=document.getElementById("content");let ta=!1;const io=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let lt=[],Vt=[],je={},Ae=[],C={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},E={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function jr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Qa(e){const t=new Date(e);if(t.setHours(0,0,0,0),C.currentView==="week"&&C.weekViewDays===7){const o=t.getDay(),a=t.getDate()-o+(o===0?-6:1);return new Date(t.setDate(a))}return t}function Tt(){const e=document.getElementById("profSelectorContainer"),t=C.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let o=m.professionals.filter(s=>C.showInactiveProfs||s.status!=="inactive");t&&(o=o.filter(s=>s.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...o];e.innerHTML=r.map(s=>{const n=C.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],l=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),d=s.status!=="inactive",c=v(i),u=io[0],g=s.id!=="all"&&m.professionalColors.get(s.id)||u,b=s.photo||`https://placehold.co/64x64/${g.main?.replace("#","")||"E0E7FF"}/${g.light?.replace("#","")||"4F46E5"}?text=${l}`,h=s.id==="all"?"#e0e7ff":g.light,f=s.id==="all"?"#4f46e5":g.main,S=`border: 3px solid ${n?g.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+g.border:"none"};`;return`
            <div class="prof-card ${n?"selected":""} ${d?"":"opacity-50"}" 
                 data-action="select-professional" 
                 data-prof-id="${s.id}">
                ${s.id==="all"?`<div class="prof-card-all-placeholder" style="background-color: ${h}; color: ${f}; ${S}">
                           ${l}
                          </div>`:`<img src="${b}" alt="${c}" class="prof-card-photo" style="${S}" />`}
                <span class="prof-card-name">${c}</span>
            </div>
        `}).join("")}function Fr(e,t,o,a,r){const s=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${o} com o(a) profissional ${a} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${s}?text=${d}`}function Hr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((a,r)=>new Date(a.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const o=e.map(a=>{const r=new Date(a.startTime),s=new Date(a.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(a.professionalId)||{},d=v(a.reason),c=v(a.professionalName),u=v(a.clientName),g=v(a.serviceName),b=C.selectedItems.has(a.id),h=C.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const f=a.status==="completed",y=f?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",S=f?"Finalizado":"Aberto",$=JSON.stringify(a).replace(/'/g,"&apos;"),w=a.redeemedReward?.points>0,I=a.hasRewards&&!w,L=Fr(a.clientPhone,a.clientName,a.serviceName,a.professionalName,a.startTime),q=C.isSelectionMode?"":'data-action="open-comanda"';return`
        ...
        `}s+="</div>",t.innerHTML=s}function Xa(){const e=m.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?Hr(e):Or(e),Co()}function Co(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(C.isSelectionMode&&C.selectedItems.size>0?(e.innerHTML=`
        ...
        `,e.style.display="block",t&&(t.style.display="none")):(e.style.display="none",t&&(t.style.display="flex")))}async function te(){const e=document.getElementById("agenda-view");if(!e)return;C.selectedItems.clear(),Co(),e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,o;const a=document.getElementById("weekRange");if(a){if(C.currentView==="list")t=new Date(C.currentDate),t.setHours(0,0,0,0),o=new Date(C.currentDate),o.setHours(23,59,59,999),a.textContent=jr(t);else{const r=Io();t=Qa(new Date(C.currentDate)),o=new Date(t),o.setDate(t.getDate()+(r-1)),o.setHours(23,59,59,999),a.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${o.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await Ra(m.establishmentId,t.toISOString(),o.toISOString(),C.selectedProfessionalId==="all"?null:C.selectedProfessionalId),s=await Ot(m.establishmentId,t.toISOString(),o.toISOString(),C.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const n=s.map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=m.professionals?m.professionals.find(u=>u.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(m.allEvents=i,Tt(),Xa(),C.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${C.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),C.scrollToAppointmentId=null}}catch(r){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',p("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"))}}}async function zr(){try{const[e,t,o]=await Promise.all([m.professionals&&m.professionals.length>0?Promise.resolve(m.professionals):Z(m.establishmentId),m.services&&m.services.length>0?Promise.resolve(m.services):$e(m.establishmentId),je.enabled!==void 0?Promise.resolve(null):Se(m.establishmentId)]);(!m.professionals||m.professionals.length===0)&&(m.professionals=e||[]),(!m.services||m.services.length===0)&&(m.services=t||[]),Ae=[],o&&(je=o.loyaltyProgram||{enabled:!1}),m.professionals.forEach((a,r)=>{m.professionalColors.set(a.id,io[r%io.length])}),Tt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),p("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function lo(e){e<1||e>4||(E.step=e,co(null,!0))}function Za(e,t){const o=document.getElementById("multiServiceToggle"),a=o&&o.checked,r=t.classList.contains("selected"),s=E.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),s>-1&&E.data.selectedServiceIds.splice(s,1);else{if(!a){E.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),E.data.selectedServiceIds.push(e)}}function Ka(e,t){const o=document.querySelector(".professional-step-cards");if(!o)return;o.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const a=Vt.find(r=>r.id===e);E.data.professionalId=e,E.data.professionalName=a?a.name:"N/A"}function Vr(e,t){const o=document.getElementById("availableTimesContainer");o&&(o.querySelectorAll(".time-slot-card").forEach(a=>a.classList.remove("selected")),t.classList.add("selected"),E.data.time=e)}async function oa(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const o=E.data.professionalId,a=E.data.selectedServiceIds,r=document.getElementById("apptDate").value;E.data.date=r;const s=a.reduce((n,i)=>{const l=lt.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${s} min`,s===0||!o||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await Js({establishmentId:m.establishmentId,professionalId:o,serviceIds:a,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[u,g]=c.split(":").map(Number);return u*60+g>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${E.data.time===d?"selected":""}`,c.textContent=d,c.addEventListener("click",()=>Vr(d,c)),t.appendChild(c)}),E.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${E.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function Ur(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:o,redeemedReward:a}=E.data,{enabled:r,rewards:s}=je;if(!r||!t||!s||s.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const n=s.filter(l=>o>=l.points);let i=`
        <h4 class="text-md font-semibold text-gray-700 mb-2">🎁 Prêmios Disponíveis (${o} pontos)</h4>
    `;n.length>0?(i+='<div class="space-y-2">',i+=n.map(l=>{const d=a?.reward===l.reward,c=v(l.reward);return`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(E.data.redeemedReward=null)})}async function _r(e){e.preventDefault();const t=e.target,o=t.querySelector('button[type="submit"]');if(!E.data.time||E.data.selectedServiceIds.length===0||!E.data.professionalId)return p("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");o.disabled=!0,o.textContent="A confirmar...";const a=E.data.selectedServiceIds.map(d=>{const c=lt.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,s]=E.data.time.split(":"),n=new Date(`${E.data.date}T${r}:${s}:00`),i={establishmentId:m.establishmentId,clientName:E.data.clientName,clientPhone:E.data.clientPhone,services:a,professionalId:E.data.professionalId,startTime:n.toISOString(),redeemedReward:E.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Gs(l,i):await Ws(i),p(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",te()}catch(d){p(d.message,"error")}finally{o.disabled=!1,o.textContent="Confirmar Agendamento"}}function es(e){const t=E.data.clientName===e.name&&E.data.clientPhone===e.phone,o=v(e.name),a=v(e.phone);return`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",Wr)}function Yr(){Gr()}function Qr(e,t){const o=e?"Editar Agendamento":"Selecionar Cliente",a=`
    ...
    `;return{title:o,content:a}}function Xr(){const e="Selecionar Serviço",o=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${lt.map(a=>{const r=E.data.selectedServiceIds.includes(a.id),s=a.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=v(a.name);return`
    ...
    `;return{title:e,content:o}}function Zr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Vt.map(o=>{const a=E.data.professionalId===o.id,r=o.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",s=v(o.name);return`
    ...
    `;return{title:e,content:t}}function Kr(e){const t=e?"Confirmar Edição":"Data e Horário",o=new Date,a=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}-${String(o.getDate()).padStart(2,"0")}`,r=E.data.date||a,s=v(E.data.clientName),n=v(E.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function en(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const o=e.toLowerCase(),a=lt.filter(r=>r.name.toLowerCase().includes(o));t.innerHTML=a.map(r=>{const s=E.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${s?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Za(r.dataset.serviceId,r))})}function tn(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const o=e.toLowerCase(),a=Vt.filter(r=>r.name.toLowerCase().includes(o));t.innerHTML=a.map(r=>{const s=E.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=v(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>Ka(r.dataset.professionalId,r))})}async function co(e=null,t=!1){const o=document.getElementById("appointmentModal");if(!t){const s=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;if(E={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:s,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}},e&&e.clientName)try{const i=await it(m.establishmentId,e.clientName),l=i.find(d=>d.phone===e.clientPhone);l&&(E.data.clientLoyaltyPoints=l.loyaltyPoints||0,Ae=i)}catch(i){console.warn("Não foi possível carregar pontos do cliente para edição:",i)}}if(!m.services||!m.professionals||je.enabled===void 0){p("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(lt=m.services,Vt=m.professionals.filter(s=>s.status==="active"),E.data.clientLoyaltyPoints>0){const s=je,n=Math.min(...(s?.rewards||[]).map(i=>i.points));E.data.clientHasRewards=s.enabled&&n!==1/0&&E.data.clientLoyaltyPoints>=n}let a={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch(E.step){case 1:a=Qr(e);break;case 2:a=Xr();break;case 3:a=Zr();break;case 4:a=Kr(e);break}o.innerHTML=`
        ...
        </div>`,o.querySelectorAll('[data-action="next-step"]').forEach(s=>{s.addEventListener("click",()=>{const n=parseInt(s.dataset.currentStep,10);if(n===1){const i=o.querySelector("#apptClientName"),l=o.querySelector("#apptClientPhone");if(E.data.clientName=i.value.trim(),E.data.clientPhone=l.value.trim(),!E.data.clientName||!E.data.clientPhone)return p("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if(E.data.selectedServiceIds.length===0)return p("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!E.data.professionalId)return p("Atenção","Selecione um profissional.","error");lo(n+1)})}),o.querySelectorAll('[data-action="prev-step"]').forEach(s=>{s.addEventListener("click",()=>lo(parseInt(s.dataset.currentStep,10)-1))});const r=o.querySelector("#appointmentForm");if(E.step===4&&r&&r.addEventListener("submit",_r),o.style.display="flex",E.step===2){o.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Za(i.dataset.serviceId,i))});const n=o.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>en(i.target.value))}if(E.step===3){o.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>Ka(i.dataset.professionalId,i))});const n=o.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>tn(i.target.value))}if(E.step===1){const s=o.querySelector("#clientSearchInput");if(s&&(s.addEventListener("input",i=>Jr(i.target.value)),E.data.clientName&&E.data.clientPhone&&Ae.length>0)){const i=document.getElementById("clientSearchResults");i&&(i.innerHTML=Ae.map(es).join(""))}const n=o.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",Yr)}if(E.step===4){const s=o.querySelector("#apptDate");s&&s.addEventListener("change",oa),oa(),Ur()}}async function ts(e={}){C.currentDate=e.targetDate?new Date(e.targetDate):C.currentDate||new Date,C.scrollToAppointmentId=e.scrollToAppointmentId||null,C.profSearchTerm="",C.isSelectionMode=!1,C.selectedItems.clear(),window.innerWidth<768&&(C.currentView="list"),ea.innerHTML=`
        <section>
        ...
        </section>`;const t=document.getElementById("btn-toggle-select");t.addEventListener("click",()=>{C.isSelectionMode=!C.isSelectionMode,C.isSelectionMode||C.selectedItems.clear(),t.classList.toggle("bg-blue-100",C.isSelectionMode),t.classList.toggle("text-blue-700",C.isSelectionMode),Xa()}),document.querySelectorAll(".view-btn[data-view]").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(s=>s.classList.remove("active")),a.classList.add("active"),C.currentView=a.dataset.view;const r=document.getElementById("week-days-toggle");if(C.currentView==="week"){if(r.style.display="flex",window.innerWidth<768){C.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(n=>n.classList.remove("active"));const s=document.querySelector('.week-days-btn[data-days="3"]');s&&s.classList.add("active")}}else r.style.display="none";te()})}),document.querySelectorAll(".week-days-btn").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(r=>r.classList.remove("active")),a.classList.add("active"),C.weekViewDays=parseInt(a.dataset.days,10),te()})}),document.getElementById("todayBtn").addEventListener("click",()=>{C.currentDate=new Date,te()});const o=a=>{const r=parseInt(a.currentTarget.dataset.amount,10),s=C.currentView==="week"?Io():1,n=new Date(C.currentDate);n.setDate(n.getDate()+r*s),C.currentDate=n,te()};document.getElementById("prevBtn").addEventListener("click",o),document.getElementById("nextBtn").addEventListener("click",o),document.getElementById("profSearchInput").addEventListener("input",a=>{C.profSearchTerm=a.target.value,Tt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",a=>{C.showInactiveProfs=a.target.checked,Tt(),te()}),ta||(ea.addEventListener("click",async a=>{const r=a.target.closest("[data-action]");if(a.target.dataset.action==="toggle-select-item"){const l=a.target.dataset.id;a.target.checked?C.selectedItems.add(l):C.selectedItems.delete(l),Co();return}if(r&&r.dataset.action==="batch-delete"){const l=C.selectedItems.size;if(await H("Excluir em Lote",`Tem certeza que deseja excluir ${l} agendamento(s)? Esta ação não pode ser desfeita.`)){const c=Array.from(C.selectedItems);let u=0;try{await Promise.all(c.map(async g=>{try{await Uo(g),u++}catch(b){console.error(`Falha ao excluir ${g}`,b)}})),p(`${u} agendamento(s) excluído(s).`,"success"),C.selectedItems.clear(),C.isSelectionMode=!1,document.getElementById("btn-toggle-select").classList.remove("bg-blue-100","text-blue-700"),te()}catch{p("Erro ao processar exclusão em lote.","error")}}return}if(a.target.closest('[data-action="select-professional"]')){const d=a.target.closest('[data-action="select-professional"]').dataset.profId,c=C.selectedProfessionalId===d&&d!=="all";if(C.selectedProfessionalId=c?"all":d,d!=="all"){const u=document.getElementById("profSearchInput");u&&(u.value=""),C.profSearchTerm=""}await te();return}if(!r)return;const s=r.dataset.action;let n=null;const i=a.target.closest("[data-appointment]");switch(i&&(n=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"))),s){case"new-appointment":co();break;case"edit-appointment":if(C.isSelectionMode||!n)return;if(n.status==="completed"){p("Atenção","Agendamentos finalizados não podem ser editados.","error");return}n.hasRewards&&!n.redeemedReward&&p("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),co(n);break;case"delete-appointment":{if(C.isSelectionMode)return;const l=r.dataset.id;if(await H("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await Uo(l),p("Agendamento apagado!","success"),te()}catch(c){p(`Não foi possível apagar: ${c.message}`,"error")}break}case"open-comanda":if(C.isSelectionMode)return;if(n){n.hasRewards&&!n.redeemedReward&&n.status!=="completed"&&p("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const l=n.status==="completed"?"finalizadas":"em-atendimento",d={selectedAppointmentId:n.id,initialFilter:l};if(l==="finalizadas"){let c=n.startTime;if(n.transaction&&n.transaction.paidAt){const u=n.transaction.paidAt;typeof u=="object"&&u._seconds?c=new Date(u._seconds*1e3):c=u}d.filterDate=c}oe("comandas-section",d)}break}}),ta=!0),await zr(),await te()}const on=(e,t=null,o=1,a=12)=>{let r=`/api/comandas/${e}?page=${o}&limit=${a}`;return t&&(r+=`&date=${t}`),k(r)},an=(e,t)=>k(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),sn=e=>k("/api/sales",{method:"POST",body:JSON.stringify(e)}),rn=e=>k(`/api/sales/${e}`,{method:"DELETE"}),nn=()=>k("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),ln=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),k("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},dn=(e,t)=>{const o={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",o),k(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(o)})},cn=()=>k("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),un=e=>k(`/api/cashier/report/${e}`),os=e=>k(`/api/packages/${e}`),mn=e=>k("/api/packages",{method:"POST",body:JSON.stringify(e)}),pn=(e,t)=>k(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),gn=e=>k(`/api/packages/${e}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"atendimento",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,paging:{page:1,limit:10,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0}}},Ie=null,Le=null,aa=null;function as(e,t){return function(...o){clearTimeout(aa),aa=setTimeout(()=>e.apply(this,o),t)}}async function sa(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,rt(),t==="checkout"&&(x.viewMode="checkout",x.checkoutState.payments||(x.checkoutState.payments=[]),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.amountReceived="",x.checkoutState.discount={type:"real",value:0},V());const o=document.createElement("div");o.id="saving-overlay",o.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",o.innerHTML=`
    ...
    `,Ut()}function Ut(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");x.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),vn()}function vn(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `,s.appendChild(f)}),e.innerHTML="",e.appendChild(s),ra(t)}function ra(e){if(!e)return;e.innerHTML="";const{page:t,total:o,limit:a}=x.paging,r=Math.ceil((o||0)/a);if(r===0)return;const s=document.createElement("div");s.className="flex gap-2 justify-center items-center w-full",s.innerHTML=`
    ...
    `,e.appendChild(s),s.querySelectorAll("button[data-page]").forEach(n=>{n.onclick=i=>{i.stopPropagation();const l=parseInt(n.dataset.page,10);l>0&&l<=r&&(x.paging.page=l,se())}})}function V(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=x.allComandas.find(f=>f.id===x.selectedComandaId);if(x.viewMode==="checkout"&&t){hn(t,e);return}const o=`
    ...
    `;if(!x.isCashierOpen){e.innerHTML=`
        ...
        `;return}const a=Fe(t),r=t.status==="completed",s=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),n=a.reduce((f,y)=>{const S=y._source==="original_service",$=y.id||y.name,w=S?`original-${$}`:`${y.type}-${$}`;return f[w]||(f[w]={...y,quantity:0,sources:[]}),f[w].quantity+=1,y._source&&f[w].sources.push(y._source),f},{}),i=Object.values(n).reduce((f,y)=>f+Number(y.price||0)*y.quantity,0),l=v(t.clientName||"Cliente sem nome"),d=v(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,b=`
    ...
    `;e.innerHTML=`
        ...
        ${r?"":h}
    `,!r&&(t.clientId||t.clientName)&&xn(t,e.querySelector("#loyalty-container"))}function hn(e,t){const a=Fe(e).reduce((u,g)=>u+Number(g.price||0)*(g.quantity||1),0),r=x.checkoutState,s=r.discount||{type:"real",value:0};let n=0;s.type==="percent"?n=a*s.value/100:n=s.value,n>a&&(n=a);const i=a-n,l=r.payments.reduce((u,g)=>u+g.value,0),d=Math.max(0,i-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;t.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar">
            ...
            <div class="text-center mb-6 bg-gray-50 p-6 rounded-xl border border-gray-100">
                <p class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Subtotal: R$ ${a.toFixed(2)}</p>
    ...
    `,t.querySelector("#discount-value")?.addEventListener("input",u=>{const g=parseFloat(u.target.value)||0;x.checkoutState.discount.value=g,V()}),t.querySelector("#discount-type")?.addEventListener("change",u=>{x.checkoutState.discount.type=u.target.value,V()}),t.querySelector("#checkout-amount")?.addEventListener("input",u=>{r.amountReceived=u.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",u=>{r.installments=parseInt(u.target.value,10)})}async function xn(e,t){if(!t)return;const o=x.loyaltySettings;if(!o||!o.enabled)return;let a=null;try{if(e.clientId)a=await no(m.establishmentId,e.clientId);else if(e.clientName){const i=await it(m.establishmentId,e.clientName,1);i&&i.length>0&&(a=i[0])}}catch(i){console.warn("Erro ao buscar dados de fidelidade",i)}if(!a||a.loyaltyPoints===void 0)return;const r=Number(a.loyaltyPoints)||0,n=(o.tiers||o.rewards||[]).filter(i=>{const l=Number(i.costPoints||i.points||0);return l>0&&r>=l});if(n.length>0){const i=document.createElement("div");i.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",i.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>yn(n),i.appendChild(l),t.innerHTML="",t.appendChild(i)}}function yn(e,t){const o=`
        <div class="space-y-4">
    ...
    `,{modalElement:a,close:r}=Y({title:"🎁 Resgatar Prémio",contentHTML:o,maxWidth:"max-w-md"});a.addEventListener("click",s=>{const n=s.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,l=e.find(d=>d.id&&d.id==i||(d.name||d.reward)==i);l&&(wn(l),r())}})}async function wn(e,t){const o=Number(e.costPoints||e.points||0),a=e.name||e.reward,r={id:e.serviceId||e.productId||`reward-${Date.now()}`,name:`${a}`,price:0,type:e.serviceId?"service":"product",isReward:!0,pointsCost:o};await Lo(r,1)}function kn(){if(!x.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=Y({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),o=()=>{const r=e.querySelector("#add-item-content");r.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Lo(r,s),t()}};e.addEventListener("click",r=>{const s=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:i,itemId:l}=s.dataset,c=(x.catalog[i+"s"]||[]).find(u=>u.id===l);c&&a({...c,type:i})}else n&&o()}),o()}async function uo(e=null){if(!x.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await Z(m.establishmentId)}catch{return p("Erro","Não foi possível carregar profissionais.","error")}const o=`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",$n)}async function $n(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const o=t.querySelector("#regClientName"),r=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!o.value||!r)return p("Erro","Nome e Telefone são obrigatórios.","error");try{const s=await(void 0)(m.establishmentId,r);if(s)p("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",uo(s);else{const n=await(void 0)({establishmentId:m.establishmentId,name:o.value,phone:r});p("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",uo(n)}}catch(s){p("Erro",s.message,"error")}}async function En(){const e=`
    ...
    `,{modalElement:t}=Y({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const a=parseFloat(document.getElementById("initial-amount").value);if(isNaN(a)||a<0)return p("Valor Inválido","Insira um valor válido.","error");try{const r=await ln({establishmentId:m.establishmentId,initialAmount:parseFloat(a.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",p("Sucesso!",`Caixa aberto (R$ ${a.toFixed(2)})`,"success"),Ut(),await se()}catch(r){p("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function In(){const e=x.activeCashierSessionId;if(e)try{const t=await un(e),o=`
        ...
        `,{modalElement:a}=Y({title:"Fechar Caixa",contentHTML:o,maxWidth:"max-w-md"});a.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const s=parseFloat(document.getElementById("final-amount").value);if(isNaN(s)||s<0)return p("Valor Inválido","Insira um valor final válido.","error");try{await dn(e,s),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Ut(),await se(),p("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){p("Erro",`Falha ao fechar caixa: ${n.message}`,"error")}})}catch(t){p("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Cn(e){x.activeFilter!==e&&(x.activeFilter=e,x.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),Te(),await se(),x.selectedComandaId=null,x.viewMode="items",V())}function ss(e){x.selectedComandaId=e,x.viewMode="items",rt(),bn(),V()}async function Lo(e,t){const o=x.allComandas.find(s=>s.id===x.selectedComandaId);if(!o)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),p("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const a=parseFloat(e.price)||0,r=Array(t).fill(0).map(()=>{const s={id:String(e.id),name:e.name,price:a,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(s.productId=s.id,s.product_id=s.id):e.type==="service"&&(s.serviceId=s.id,s.service_id=s.id),s});o.comandaItems=o.comandaItems||[],o.comandaItems.push(...r),o._cachedItems=null,o._hasUnsavedChanges=!0,V()}async function na(e,t){const o=x.allComandas.find(s=>s.id===x.selectedComandaId);if(!o)return;let a=!1,r=(o.comandaItems||[]).findIndex(s=>s.id==e&&s.type===t);r>-1&&(o.comandaItems.splice(r,1),a=!0),a&&(o._cachedItems=null,o._hasUnsavedChanges=!0,V())}async function Ln(e){if(x.isProcessing)return;const t=Fe(e),o=t.reduce((f,y)=>f+Number(y.price||0)*(y.quantity||1),0),a=x.checkoutState.discount||{type:"real",value:0};let r=a.type==="percent"?o*a.value/100:a.value;r>o&&(r=o);const s=o-r,{payments:n}=x.checkoutState,i=n.reduce((f,y)=>f+y.value,0),l=s-i;if(l>.01){if(!await H("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;n.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const g=x.loyaltySettings;if(g&&g.enabled)if(g.type==="visit")u=Number(g.pointsPerVisit)||1;else{const f=Number(g.pointsPerCurrency)||10;f>0&&(u=Math.floor(s/f))}const b={payments:n,totalAmount:Number(s),items:c,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:u,discount:a},h=document.createElement("div");h.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",h.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(h);try{d?await Qs(e.id,b):(b.establishmentId=m.establishmentId,b.clientId=e.clientId,b.clientName=e.clientName,b.professionalId=e.professionalId,e.clientPhone&&(b.clientPhone=e.clientPhone),await sn(b));let f="Venda finalizada com sucesso!";u>0&&(f+=` Cliente ganhou ${u} pontos!`),p("Sucesso!",f,"success"),Te(),x.selectedComandaId=null,x.viewMode="items",await se()}catch(f){p("Erro no Checkout",f.message,"error")}finally{document.body.contains(h)&&document.body.removeChild(h),x.isProcessing=!1}}async function Tn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),o=document.getElementById("new-sale-professional").value,a=t.value,r=document.getElementById("client-search").value,s=t.dataset.phone||"";if(!a)return p("Erro","Selecione um cliente válido.","error");const n=m.professionals.find(l=>l.id===o);if(!n)return p("Erro","Selecione um profissional válido.","error");const i={id:`temp-${Date.now()}`,type:"walk-in",clientId:a,clientName:r.split("(")[0].trim(),clientPhone:s,professionalId:n.id,professionalName:n.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(i),x.selectedComandaId=i.id,x.viewMode="items",document.getElementById("genericModal").style.display="none",ss(i.id)}async function se(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=x.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const o=await nn();if(x.isCashierOpen=!!o,x.activeCashierSessionId=o?o.id:null,Ut(),!x.isCashierOpen&&x.activeFilter==="atendimento"){rt(),V();return}try{const r=await(void 0)(m.establishmentId);r&&r.loyaltyProgram&&(x.loyaltySettings=r.loyaltyProgram)}catch{}const a=await on(m.establishmentId,t,x.paging.page,x.paging.limit);if(x.allComandas=a.data||a,x.paging.total=a.total||a.length,x.catalog.services.length===0){const[r,s,n,i]=await Promise.all([$e(m.establishmentId),Ht(m.establishmentId),os(m.establishmentId),Z(m.establishmentId)]);x.catalog={services:r,products:s,packages:n},m.professionals=i}rt(),V()}catch(o){p("Erro",`Não foi possível carregar os dados: ${o.message}`,"error")}}async function Pn(e={}){Le=document.getElementById("content"),x.selectedComandaId=e.selectedAppointmentId||null,x.viewMode="items",fn(),Ie&&(Le.removeEventListener("click",Ie),Le.removeEventListener("change",Ie)),Ie=async t=>{const o=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&x.activeFilter==="finalizadas"){x.paging.page=1,await se();return}if(o){if(o.matches("[data-filter]"))Cn(o.dataset.filter);else if(o.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}ss(o.dataset.comandaId)}else if(o.matches("[data-action]")){const r=o.dataset.action,s=o.dataset.id||x.selectedComandaId,n=x.allComandas.find(i=>i.id===s);switch(r){case"back-to-list":Te(),x.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach($=>$.classList.remove("selected")),V();break;case"new-sale":uo();break;case"add-item":kn();break;case"open-cashier":En();break;case"close-cashier":await In();break;case"view-sales-report":oe("sales-report-section");break;case"go-to-checkout":await sa(n,"checkout");break;case"back-to-items":x.viewMode="items",V();break;case"save-comanda":await sa(n,"stay");break;case"select-method":x.checkoutState.selectedMethod=o.dataset.method,x.checkoutState.installments=1,V();break;case"add-payment-checkout":const i=document.getElementById("checkout-amount");let l=parseFloat(i.value);const c=Fe(n).reduce(($,w)=>$+(w.price||0),0),u=x.checkoutState.discount||{type:"real",value:0};let g=u.type==="percent"?c*u.value/100:u.value;g>c&&(g=c);const b=c-g,h=x.checkoutState.payments.reduce(($,w)=>$+w.value,0),f=b-h;if(isNaN(l)||l<=0){p("Valor inválido","Insira um valor maior que zero.","error");break}if(l>f+.05){p("Valor inválido","Valor excede o restante.","error");break}const y={method:x.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(y.installments=x.checkoutState.installments),x.checkoutState.payments.push(y),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",V();break;case"remove-payment-checkout":const S=parseInt(o.dataset.index,10);x.checkoutState.payments.splice(S,1),V();break;case"finalize-checkout":await Ln(n);break;case"increase-qty":{const $=o.dataset.itemId,w=o.dataset.itemType;if(!$||$==="undefined"||$==="null"){p("Erro","Item inválido para adição.","error");return}let L=Fe(n).find(F=>F.id==$&&F.type===w);L||(L=(x.catalog[w+"s"]||[]).find(T=>T.id==$));const q=L?{id:L.id,name:L.name,price:Number(L.price),type:L.type}:{id:$,name:"Item Indisponível",price:0,type:w};await Lo(q,1);break}case"decrease-qty":{await na(o.dataset.itemId,o.dataset.itemType);break}case"remove-item":await na(o.dataset.itemId,o.dataset.itemType);break;case"reopen-appointment":{if(await H("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Ys(s);const w=x.allComandas.findIndex(I=>I.id===s);w!==-1&&(x.allComandas[w].status="confirmed",delete x.allComandas[w].transaction),x.selectedComandaId=null,Te(),await se(),p("Sucesso!","Comanda reaberta.","success")}catch(w){p("Erro",w.message,"error")}break}case"go-to-appointment":{const $=o.dataset.id,w=o.dataset.date;oe("agenda-section",{scrollToAppointmentId:$,targetDate:new Date(w)});break}case"delete-walk-in":{if(await H("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(s.startsWith("temp-"))x.allComandas=x.allComandas.filter(w=>w.id!==s),x.selectedComandaId=null,rt(),V(),Te();else try{await rn(s),p("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Te(),await se()}catch(w){p("Erro",w.message,"error")}break}}}}},Le.addEventListener("click",Ie),Le.addEventListener("change",Ie),e.initialFilter&&(x.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(x.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${x.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",x.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await se()}const To=e=>k(`/api/financial/natures/${e}`),Bn=e=>k("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),Dn=e=>k(`/api/financial/natures/${e}`,{method:"DELETE"}),Po=e=>k(`/api/financial/cost-centers/${e}`),Mn=e=>k("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),An=e=>k(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),rs=(e,t)=>k(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),ns=(e,t={})=>{let o=`/api/financial/${e}`;const a=new URLSearchParams;t.establishmentId&&a.append("establishmentId",t.establishmentId),t.startDate&&a.append("startDate",t.startDate),t.endDate&&a.append("endDate",t.endDate),t.natureId&&a.append("natureId",t.natureId),t.costCenterId&&a.append("costCenterId",t.costCenterId),t.status&&a.append("status",t.status);const r=a.toString();return r&&(o+=`?${r}`),k(o)},is=(e,t,o)=>k(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(o)}),ls=(e,t)=>k(`/api/financial/${e}/${t}`,{method:"DELETE"}),ds=(e,t,o)=>k(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:o})}),Nn=e=>rs("payables",e),qn=e=>ns("payables",e),Rn=(e,t)=>is("payables",e,t),jn=e=>ls("payables",e),Fn=(e,t)=>ds("payables",e,t),Hn=e=>rs("receivables",e),On=e=>ns("receivables",e),zn=(e,t)=>is("receivables",e,t),Vn=e=>ls("receivables",e),Un=(e,t)=>ds("receivables",e,t),_n=(e,t,o)=>k(`/api/financial/cash-flow?establishmentId=${e}&startDate=${t}&endDate=${o}`),mo=document.getElementById("content");let ce={};const ia=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],D={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],cashFlowData:null,currentTab:"dashboards",isFilterOpen:!1};async function Jn(){if(!window.Chart)return new Promise((e,t)=>{const o=document.createElement("script");o.src="https://cdn.jsdelivr.net/npm/chart.js",o.onload=e,o.onerror=t,document.head.appendChild(o)})}async function Wn(){mo.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
        ...
        </div>`;try{await Jn();const[e,t]=await Promise.all([Z(m.establishmentId),Dr(m.establishmentId).catch(()=>[])]);D.professionalsList=e||[],D.costCentersList=t||[],Gn(),await cs()}catch(e){console.error("Erro no loadReportsPage:",e),mo.innerHTML=`
            ...
            </div>`}}function Gn(){const e=D.professionalsList.map(o=>`<option value="${o.id}">${v(o.name)}</option>`).join(""),t=D.costCentersList.map(o=>`<option value="${o.id}">${v(o.name)}</option>`).join("");mo.innerHTML=`
    ...
    `,document.getElementById("toggle-filters-btn").onclick=la,document.getElementById("btn-apply-filters").onclick=()=>{Yn(),la()},document.querySelectorAll(".tab-btn").forEach(o=>{o.onclick=()=>{D.currentTab=o.dataset.tab,da(),us(),window.scrollTo({top:0,behavior:"smooth"})}}),da()}function la(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");D.isFilterOpen=!D.isFilterOpen,D.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function da(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===D.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Pt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function Yn(){D.startDate=document.getElementById("report-start").value,D.endDate=document.getElementById("report-end").value,D.selectedProfessional=document.getElementById("report-prof").value,D.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Pt(D.startDate)} até ${Pt(D.endDate)}`,await cs()}async function cs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader border-t-indigo-600"></div></div>';try{const t=D.selectedProfessional==="all"?null:D.selectedProfessional,o=Br(D.startDate,D.endDate,D.selectedProfessional,D.selectedCostCenter),a=_n(m.establishmentId,D.startDate,D.endDate).catch(()=>({labels:[],payables:[],receivables:[],expectedBalance:[]})),r=new Date(D.startDate+"T00:00:00").toISOString(),s=new Date(D.endDate+"T23:59:59").toISOString(),n=Ra(m.establishmentId,r,s,t).catch(()=>[]),[i,l,d]=await Promise.all([o,a,n]);D.data=i,D.cashFlowData=l,D.appointmentsData=Array.isArray(d)?d:[],us()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function us(){const e=document.getElementById("report-content");if(D.data)switch(D.currentTab){case"dashboards":Qn(e);break;case"appointments":Xn(e);break;case"dre":Zn(e);break}}function Qn(e){const{dreSimple:t,charts:o}=D.data,a=t||{grossRevenue:0,netProfit:0,variableCosts:0};e.innerHTML=`
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-slide-up">
            <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <p class="text-2xl font-black text-gray-800 tracking-tight">R$ ${a.grossRevenue.toLocaleString("pt-BR",{minimumFractionDigits:2})}</p>
            ...
            <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-2xl font-black text-red-500 tracking-tight">R$ ${a.variableCosts.toLocaleString("pt-BR",{minimumFractionDigits:2})}</p>
                <div class="mt-4 h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
            ...
            <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden">
                ...
                <p class="text-2xl font-black text-emerald-600 tracking-tight">R$ ${a.netProfit.toLocaleString("pt-BR",{minimumFractionDigits:2})}</p>
                 <div class="mt-4 h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
    ...
    `,D.cashFlowData&&Kn("chart-cashflow-modern",D.cashFlowData),ca("chart-monthly","bar","Receita Mensal",o.salesMonthly.labels,o.salesMonthly.data,ia[0]),ca("chart-profs","doughnut","Total Vendas",o.professionals.labels,o.professionals.data,ia)}function Xn(e){const t=D.appointmentsData,o=t.length;let a=0,r=0,s=0;const n={},i={};let l=new Date(D.startDate);const d=new Date(D.endDate);for(;l<=d;)n[l.toISOString().split("T")[0]]=0,l.setDate(l.getDate()+1);t.forEach(b=>{const h=parseFloat(b.totalAmount||b.price||0),f=(b.status||"").toLowerCase();let y=b.startTime?(b.startTime.toDate?b.startTime.toDate():new Date(b.startTime)).toISOString().split("T")[0]:"";const S=b.professionalName||"Sem Profissional";i[S]||(i[S]={name:S,count:0,value:0}),["cancelled","cancelado","no-show"].includes(f)?r++:(["completed","finalized","paid"].includes(f)&&a++,s+=h,y&&n.hasOwnProperty(y)&&n[y]++,i[S].count++,i[S].value+=h)});const c=Object.keys(n).sort(),u=c.map(b=>n[b]),g=Object.values(i).sort((b,h)=>h.value-b.value);e.innerHTML=`
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 animate-slide-up">
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
                ...
                <div class="flex items-end gap-2 mt-1">
                    <p class="text-3xl font-black text-gray-800">${o}</p>
                </div>
            </div>
            
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                <p class="text-[10px] text-gray-500 font-bold uppercase">Concluídos</p>
                <p class="text-xl font-black text-indigo-600 mt-1">${o>0?Math.round(a/o*100):0}%</p>
            </div>
             <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                <p class="text-[10px] text-gray-500 font-bold uppercase">Cancelados</p>
                <p class="text-xl font-black text-red-500 mt-1">${r}</p>
            </div>

            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
                <p class="text-[10px] text-gray-500 font-bold uppercase">Valor Estimado</p>
                 <p class="text-2xl font-black text-gray-800 mt-1">R$ ${s.toLocaleString("pt-BR",{minimumFractionDigits:0})}</p>
            </div>
        </div>
                ...
                <table class="w-full text-sm">
                    <tbody class="divide-y divide-gray-100">
                        ${g.map((b,h)=>{const f=g[0]?.value||1,y=b.value/f*100;return`
                            <tr class="group">
                                <td class="p-4 w-12 text-center font-bold text-gray-300 text-xs">${h+1}</td>
                                <td class="p-4 pl-0">
                                    <p class="font-bold text-gray-800">${v(b.name)}</p>
                                ...
                                <td class="p-4 text-center">
                                    <span class="bg-indigo-50 text-indigo-700 px-2.5 py-1 rounded-lg font-bold text-xs">${b.count}</span>
                                </td>
                                <td class="p-4 text-right font-bold text-gray-700 whitespace-nowrap">R$ ${b.value.toLocaleString("pt-BR",{minimumFractionDigits:0})}</td>
                            </tr>
                        `}).join("")}
    ...
    `,ei("chart-appointments-daily",c,u)}function Zn(e){const{dreFinancial:t}=D.data;if(!t)return;const o=t.totalRevenues,a=(i,l,d,c=!1)=>{const u=o>0?l/o*100:0,g=c?"- ":"";return`
        <div class="flex items-center justify-between py-3 px-4 border-b border-dashed border-gray-100 last:border-0">
            <div class="flex-1 pr-4">
                <p class="text-xs font-semibold text-gray-600 truncate">${v(i)}</p>
            ...
            <div class="text-right">
                <p class="text-sm font-bold ${d}">${g}R$ ${l.toLocaleString("pt-BR",{minimumFractionDigits:2})}</p>
                <p class="text-[10px] text-gray-400 font-medium">${u.toFixed(1)}%</p>
            </div>
        ...
        <div class="max-w-xl mx-auto animate-slide-up pb-10">
            <div class="bg-gray-900 text-white rounded-3xl p-6 shadow-xl relative overflow-hidden mb-6">
                ...
                <h2 class="text-4xl font-black mb-2">R$ ${t.netResult.toLocaleString("pt-BR",{minimumFractionDigits:2})}</h2>
            ...
            <div class="space-y-4">
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="bg-gray-50/50 p-3 border-b border-gray-100 flex justify-between items-center">
                        ...
                        <span class="text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md">Total: R$ ${t.totalRevenues.toLocaleString("pt-BR",{minimumFractionDigits:0})}</span>
                    </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="bg-gray-50/50 p-3 border-b border-gray-100 flex justify-between items-center">
                        ...
                        <span class="text-xs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-md">Total: R$ ${t.totalExpenses.toLocaleString("pt-BR",{minimumFractionDigits:0})}</span>
                    </div>
                    <div>${s||'<p class="text-xs text-gray-400 p-4 text-center">Nenhuma despesa.</p>'}</div>
                </div>
            </div>
        </div>
    `}function Kn(e,t){const o=document.getElementById(e);if(!o)return;const a=o.getContext("2d");ce[e]&&ce[e].destroy();const r=a.createLinearGradient(0,0,0,400);r.addColorStop(0,"rgba(59, 130, 246, 0.4)"),r.addColorStop(1,"rgba(59, 130, 246, 0.0)");const s=t.payables.map(i=>i*-1),n=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));ce[e]=new Chart(a,{type:"bar",data:{labels:n,datasets:[{label:"Saldo",data:t.expectedBalance,type:"line",borderColor:"#3b82f6",backgroundColor:r,borderWidth:3,pointRadius:0,pointHoverRadius:6,fill:!0,tension:.4,order:0,yAxisID:"y"},{label:"Entradas",data:t.receivables,backgroundColor:"#34d399",borderRadius:4,barPercentage:.6,order:1,yAxisID:"y"},{label:"Saídas",data:s,backgroundColor:"#f87171",borderRadius:4,barPercentage:.6,order:2,yAxisID:"y"}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,font:{family:"'Inter', sans-serif",size:10}}},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(i),font:{size:10}}}}}})}function ei(e,t,o){const a=document.getElementById(e);if(!a)return;const r=a.getContext("2d");ce[e]&&ce[e].destroy();const s=r.createLinearGradient(0,0,0,300);s.addColorStop(0,"rgba(99, 102, 241, 0.5)"),s.addColorStop(1,"rgba(99, 102, 241, 0.0)");const n=t.map(i=>i.split("-").reverse().slice(0,2).join("/"));ce[e]=new Chart(r,{type:"line",data:{labels:n,datasets:[{label:"Qtd",data:o,borderColor:"#6366f1",backgroundColor:s,borderWidth:2,fill:!0,tension:.4,pointRadius:0,pointHoverRadius:4}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#6366f1",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function ca(e,t,o,a,r,s){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");ce[e]&&ce[e].destroy(),new Chart(i,{type:t,data:{labels:a,datasets:[{label:o,data:r,backgroundColor:s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:t==="doughnut"?{}:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9}}}}}})}const _t=(e,t="products")=>k(`/api/${t}/categories/${e}`),ms=(e,t="products")=>k(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),ps=(e,t="products")=>k(`/api/${t}/categories/${e}`,{method:"DELETE"}),ti="audit_logs",He=async(e,t,o,a,r,s=null)=>{try{if(!t)return;await Ma(me(_,ti),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:o,action:a,description:r,details:s,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},ve=document.getElementById("content");let ne=null,Xe="services",we="all";function Oe(){const e=U.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function oi(e){e.preventDefault();const o=e.target.closest("#categoryForm").querySelector("#categoryName"),a=o.value;if(a)try{await ms({establishmentId:m.establishmentId,name:a},"services"),He(m.establishmentId,Oe(),"Categorias (Serviços)","Criou",`Criou categoria: ${a}`),o.value="",p("Sucesso","Categoria criada!","success"),await Bo(),await dt()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function ai(e){if(await H("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ps(e,"services"),He(m.establishmentId,Oe(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),p("Sucesso","Categoria apagada.","success"),await Bo(),await dt()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Bo(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(o=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function si(){Y({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const o=t.querySelector("#categoryForm");o&&(o.addEventListener("submit",oi),t.addEventListener("click",a=>{const r=a.target.closest('button[data-action="delete-category"]');r&&(a.preventDefault(),ai(r.dataset.id))}))}Bo()}async function ri(e){e.preventDefault();const t=e.target.closest("#serviceModal"),o=t.querySelector("#serviceId").value,a={},r=t.querySelector('input[name="commissionType"]:checked').value;r==="custom"&&t.querySelectorAll(".professional-commission-row").forEach(n=>{const i=n.dataset.profId;if(n.querySelector('input[type="checkbox"]').checked){const d=parseFloat(n.querySelector('input[type="number"]').value);a[i]=isNaN(d)?0:d}});const s={establishmentId:m.establishmentId,name:t.querySelector("#serviceName").value,price:parseFloat(t.querySelector("#servicePrice").value),duration:parseInt(t.querySelector("#serviceDurationMinutes").value,10),bufferTime:parseInt(t.querySelector("#serviceBufferTimeMinutes").value,10)||0,categoryId:t.querySelector("#serviceCategory").value||null,commissionRate:parseFloat(t.querySelector("#serviceCommissionRate").value)||0,active:t.querySelector("#serviceStatus").value==="true",photo:t.querySelector("#servicePhotoBase64").value,notes:t.querySelector("#serviceNotes").value,commissionType:r,professionalCommissions:a};try{o?(await dr(o,s),He(m.establishmentId,Oe(),"Serviços","Editou",`Editou o serviço: ${s.name}`)):(await Ha(s),He(m.establishmentId,Oe(),"Serviços","Criou",`Criou novo serviço: ${s.name}`)),document.getElementById("serviceModal").style.display="none",p("Sucesso",`Serviço ${o?"atualizado":"adicionado"} com sucesso!`,"success"),await dt()}catch(n){p("Erro",n.message,"error")}}function ua(e=null){const t=document.getElementById("serviceModal"),o=m.serviceCategories||[],a=e?.duration||0,r=e?.bufferTime||0,s=v(e?.name||""),n=v(e?.notes||""),i=e?s:"Novo Serviço",l=o.map(I=>`<option value="${I.id}" ${e?.categoryId===I.id?"selected":""}>${v(I.name)}</option>`).join("");t.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(o=>t.innerHTML+=`<option value="${o.id}">${v(o.name)}</option>`)),Do(),Pe()}function ii(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function dt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,o,a,r]=await Promise.all([$e(m.establishmentId),Z(m.establishmentId),_t(m.establishmentId,"services"),mr(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(o||[]).filter(Boolean),m.serviceCategories=(a||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(s=>{s.active===void 0&&(s.active=!0)}),gs(Xe)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),p("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function gs(e){if(document.getElementById("services-content-container")){if(Xe===e&&document.getElementById("services-content-container").children.length>1){Xe==="services"&&(Do(),Pe());return}Xe=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const o=t.dataset.view===e;t.classList.toggle("border-indigo-500",o),t.classList.toggle("text-indigo-600",o),t.classList.toggle("border-transparent",!o),t.classList.toggle("text-gray-500",!o)}),e==="services"?ni():e==="reports"&&ii()}}function li(){ne&&(ve.removeEventListener("click",ne),ve.removeEventListener("input",ne),ve.removeEventListener("change",ne)),ne=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),s=r.dataset.id,n=r.checked;try{await ur(s,n);const i=m.services.findIndex(l=>l.id===s);i>-1&&(m.services[i].active=n),He(m.establishmentId,Oe(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${n?"Ativo":"Inativo"}`),Pe(),Do()}catch(i){p("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Pe()}return}const o=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Pe();return}if(!o)return;if(o.hasAttribute("data-view")){gs(o.dataset.view);return}switch(o.dataset.action){case"new-service":ua();break;case"edit-service":const r=JSON.parse(o.dataset.service);ua(r);break;case"manage-categories":si();break;case"filter-service":const s=o.dataset.filterType;if(s==="popular")return;we=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===we||i==="total"&&we==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Pe();break}},ve.addEventListener("click",ne),ve.addEventListener("input",ne),ve.addEventListener("change",ne)}async function di(){ve.innerHTML=`
        ...
        </section>`,li();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await Z(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),p("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Xe="services",we="all",await dt()}const Jt="suppliers",Mo="purchases",bs="financial_payables",Ao=async e=>{try{const t=jt(me(_,Jt),st("establishmentId","==",e)),o=await yo(t),a=[];return o.forEach(r=>{a.push({id:r.id,...r.data()})}),a}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},ci=async e=>{try{return{id:(await Ma(me(_,Jt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},ui=async(e,t)=>{try{const o=ue(_,Jt,e);return await xo(o,t),{id:e,...t}}catch(o){throw console.error("Erro ao atualizar fornecedor:",o),o}},mi=async e=>{try{const t=ue(_,Jt,e);return await js(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},pi=async(e,t=null)=>{try{const o=Na(_),a=ue(me(_,Mo)),r={...e,createdAt:Vo()};if(o.set(a,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const s=ue(me(_,bs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:a.id,createdAt:Vo()};o.set(s,i)}return await o.commit(),{id:a.id,...r}}catch(o){throw console.error("Erro ao registrar compra com integração:",o),o}},gi=async(e,t)=>{try{const o=Na(_),a=ue(_,Mo,e);o.delete(a);const r=jt(me(_,bs),st("purchaseId","==",e),st("establishmentId","==",t));return(await yo(r)).forEach(n=>{o.delete(n.ref)}),await o.commit(),!0}catch(o){throw console.error("Erro ao excluir compra e financeiro:",o),o}},bi=async e=>{try{const t=jt(me(_,Mo),st("establishmentId","==",e),Aa("createdAt","desc")),o=await yo(t),a=[];return o.forEach(r=>{a.push({id:r.id,...r.data()})}),a}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},ge=document.getElementById("content");let ie=null,Ze="products",ae="all";async function fi(e){e.preventDefault();const o=e.target.closest("#categoryForm").querySelector("#categoryName"),a=o.value;if(a)try{await ms({establishmentId:m.establishmentId,name:a},"products"),o.value="",p("Sucesso","Categoria de produto criada!","success"),await No(),await ct()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function vi(e){if(await H("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ps(e,"products"),p("Sucesso","Categoria de produto apagada.","success"),await No(),await ct()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function No(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(o=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${v(o.name)}</span>
                    <button data-action="delete-category" data-id="${o.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function hi(){Y({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const o=t.querySelector("#categoryForm");o&&(o.addEventListener("submit",fi),t.addEventListener("click",a=>{const r=a.target.closest('button[data-action="delete-category"]');r&&vi(r.dataset.id)}))}No()}async function xi(e){if(!e)return;if(await H("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await gr(e),p("Sucesso","Produto apagado com sucesso!","success"),await ct()}catch(o){p("Erro",`Não foi possível apagar o produto: ${o.message}`,"error")}}async function yi(e){const t=e.querySelector("#productId").value,o=parseInt(e.querySelector("#productCurrentStock").value),a=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),s=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(s).map(l=>l.dataset.id),i={establishmentId:m.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(o)?0:o,minStock:isNaN(a)?0:a,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await pr(t,i):await Oa(i),document.getElementById("productModal").style.display="none",p("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await ct()}catch(l){throw new Error(l.message)}}function ma(e,t=800,o=800,a="image/jpeg",r=.8){return new Promise((s,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,u=d.height;c>u?c>t&&(u*=t/c,c=t):u>o&&(c*=o/u,u=o);const g=document.createElement("canvas");g.width=c,g.height=u,g.getContext("2d").drawImage(d,0,0,c,u);const h=g.toDataURL(a,r);s(h)},d.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function pa(e=null){const t=document.getElementById("productModal"),o=m.categories||[],a=m.suppliers||[],r=o.map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${v(T.name)}</option>`).join("");let s=new Set(e?.supplierIds||[]);const n=v(e?.name||""),i=e?.price||"",l=e?.costPrice||"",d=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,g=e?.currentStock||0,b=e?n:"Novo Produto";t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                `).join("")):(B.classList.remove("hidden"),B.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else B.classList.add("hidden");s.size>0?(R.innerHTML="",s.forEach(z=>{const N=a.find(Q=>Q.id===z);N&&(R.innerHTML+=`
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};w.querySelector("#modalSupplierSearch").addEventListener("input",I),w.addEventListener("click",T=>{const B=T.target.closest("[data-add-supplier]");if(B){const j=B.dataset.addSupplier;s.add(j),w.querySelector("#modalSupplierSearch").value="",I()}const R=T.target.closest("[data-remove-supplier]");if(R){const j=R.dataset.removeSupplier;s.delete(j),I()}}),I(),w.addEventListener("click",async T=>{const B=T.target.closest("button[data-action]");if(!B)return;const R=B.dataset.action,j=w.querySelector("#productId").value;if(R==="close-modal"&&(w.style.display="none"),R==="delete-product"){if(!j)return;w.style.display="none",await xi(j)}if(R==="save-product-modal"){const z=w.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){p("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const N=B.closest('button[data-action="save-product-modal"]');N.disabled=!0,N.textContent="A salvar...";try{await yi(z)}catch(Q){p("Erro",`Falha ao salvar: ${Q.message}`,"error"),N.disabled=!1,N.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){T.preventDefault();const z=w.querySelector("#stockAdjustmentAmount"),N=w.querySelector("#stockAdjustmentReason"),Q=parseInt(z.value,10),Ee=parseInt(B.dataset.change,10);if(!Q||Q<=0){p("Erro","Por favor, insira uma quantidade válida.","error");return}const Yt=Q*Ee,Ts=N.value||(Yt>0?"Entrada manual":"Saída manual");try{await br(j,{change:Yt,reason:Ts});const Ue=m.products.findIndex(_e=>_e.id===j);if(Ue>-1){const _e=m.products[Ue].currentStock+Yt;m.products[Ue].currentStock=_e,w.querySelector("#currentStockDisplay").textContent=_e,w.querySelector("#productCurrentStock").value=_e,z.value="",N.value="",p("Sucesso","Estoque atualizado!","success"),qo(),nt()}}catch(Ue){p("Erro de Stock",Ue.message,"error")}}});const L=w.querySelectorAll(".tab-btn"),q=w.querySelectorAll(".tab-content");L.forEach(T=>{T.addEventListener("click",B=>{B.preventDefault(),L.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),T.classList.add("border-indigo-500","text-indigo-600"),T.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),q.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${T.dataset.tab}`).classList.remove("hidden")})});const F=w.querySelector("#productPhotoInput");w.querySelector("#productPhotoButton").addEventListener("click",()=>F.click()),F.onchange=async()=>{const T=F.files[0];if(!T)return;const B=w.querySelector("#productPhotoPreview"),R=w.querySelector("#productPhotoBase64");B.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const j=await ma(T,800,800,"image/jpeg",.8),N=j.length*3/4,Q=1e3*1024;if(N>Q)throw new Error("A imagem é muito grande mesmo após a compressão.");B.src=j,R.value=j}catch(j){console.error("Erro ao processar imagem:",j),p("Erro de Imagem",j.message||"Não foi possível processar a imagem.","error"),B.src=S,R.value=$,F.value=""}},w.style.display="flex"}function wi(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(o=>t.innerHTML+=`<option value="${o.id}">${v(o.name)}</option>`)),qo(),nt()}function ki(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],o=new Date;o.setDate(o.getDate()-30);const a=o.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join("")),s&&m.categories&&(s.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""))}async function Si(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const o=await fr(t);if(o.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ct(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,o,a]=await Promise.all([Ht(m.establishmentId),_t(m.establishmentId,"products"),Ao(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(o||[]).filter(Boolean),m.suppliers=(a||[]).filter(Boolean),fs(Ze)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function fs(e){if(document.getElementById("products-content-container")){if(Ze===e&&document.getElementById("products-content-container").children.length>1){Ze==="products"&&(qo(),nt());return}Ze=e,ae="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const o=t.dataset.view===e;t.classList.toggle("border-indigo-500",o),t.classList.toggle("text-indigo-600",o),t.classList.toggle("border-transparent",!o),t.classList.toggle("text-gray-500",!o)}),e==="products"?wi():e==="movements"&&ki()}}async function $i(){ge.innerHTML=`
        ...
        </section>`,ie&&(ge.removeEventListener("click",ie),ge.removeEventListener("input",ie),ge.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){nt();return}const o=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!o||e.target.closest('[data-action-stop-propagation="true"]'))return;if(o.hasAttribute("data-view")){fs(o.dataset.view);return}switch(o.dataset.action){case"new-product":pa();break;case"edit-product":pa(JSON.parse(o.dataset.product));break;case"manage-product-categories":hi();break;case"generate-report":await Si();break;case"filter-stock":const r=o.dataset.filterType;ae=ae===r?"all":r,document.querySelectorAll(".indicator-card").forEach(s=>{s.classList.toggle("ring-2",s.dataset.filterType===ae),s.classList.toggle("ring-indigo-500",s.dataset.filterType===ae),s.classList.toggle("shadow-lg",s.dataset.filterType===ae)}),nt();break}},ge.addEventListener("click",ie),ge.addEventListener("input",ie),ge.addEventListener("change",ie),Ze="products",ae="all",await ct()}const be=document.getElementById("content");let le=null,St="list",O={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Ei(){St==="list"?Wt():St==="purchases"?(O.step=1,Ke()):St==="history"&&vs()}async function Ii(){try{const e=await Ao(m.establishmentId);return m.suppliers=e||[],O.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Ci(e){if(await H("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await mi(e),p("Sucesso","Fornecedor excluído.","success"),Ft("genericModal"),Wt()}catch(t){p("Erro","Erro ao excluir: "+t.message,"error")}}async function Li(e){e.preventDefault();const t=e.target,o=t.querySelector("#supId").value,a={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:m.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{o?(await ui(o,a),p("Sucesso","Fornecedor atualizado!","success")):(await ci(a),p("Sucesso","Fornecedor criado!","success")),Ft("genericModal"),Wt()}catch(s){p("Erro","Erro ao salvar: "+s.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Wt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Ii();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",o=m.suppliers.filter(s=>s.name.toLowerCase().includes(t)||s.contactName&&s.contactName.toLowerCase().includes(t));if(e.innerHTML="",o.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let a='<div class="flex flex-col gap-2 md:hidden">';o.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=v(s.name),l=v(s.category||"Geral"),d=v(s.contactName||"");a+=`
    ...
    `;o.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;"),i=v(s.name),l=v(s.taxId||"Sem doc."),d=v(s.email||"-"),c=v(s.phone||"-"),u=v(s.category||"Geral");r+=`
            <tr class="hover:bg-gray-50">
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=a+r}function Ti(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",o=e.phone?`tel:${e.phone}`:"#",a=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),s=v(e.name),n=v(e.category||"Fornecedor"),i=v(e.contactName||""),l=v(e.phone||""),d=`
    ...
    `;Y({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Ke(){const e=document.getElementById("purchasesContainer");if(e)if(O.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,o]=await Promise.all([Ht(m.establishmentId),Ao(m.establishmentId)]);O.allSuppliers=o||[];const a=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(O.productsToBuy=a,a.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',s="";a.forEach(d=>{const c=parseInt(d.minStock)||0,u=parseInt(d.currentStock)||0,g=Math.max(c-u,1),b=parseFloat(d.costPrice||0),h=v(d.name);let f='<option value="">Selecione...</option>';O.allSuppliers.length>0?O.allSuppliers.forEach(y=>{const $=d.supplierIds&&d.supplierIds.includes(y.id)?"selected":"";f+=`<option value="${y.id}" ${$}>${v(y.name)}</option>`}):f='<option value="">Sem fornecedores</option>',r+=`
            ...
            `,po()}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao calcular compras.</p>'}}else O.step===2&&Pi(e)}function Pi(e){if(!O.finalOrders||Object.keys(O.finalOrders).length===0){O.step=1,Ke();return}const t=O.isQuoteMode;let o="",a=0;const r=t?"border-indigo-100":"border-gray-200",s=t?"bg-indigo-50 border-indigo-100":"bg-gray-50 border-gray-200",n=t?"bg-blue-100 text-blue-700":"bg-green-100 text-green-700",i=t?"hidden":"flex",l=t?"Cotações Prontas":"Pedidos Prontos",d=t?"text-indigo-600":"text-green-600",c=t?"bg-indigo-50 border-indigo-100":"bg-green-50 border-green-100",u=t?"text-indigo-800":"text-green-800";for(const[g,b]of Object.entries(O.finalOrders)){let h=0,f=b.items.map(L=>{const q=L.qty*L.cost;return h+=q,`
        ...
        `}).join("");a+=h;const y=encodeURIComponent(JSON.stringify({supplierId:g,supplierName:b.info.name,totalAmount:h,items:b.items})),S=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),$=encodeURIComponent(JSON.stringify(b.items)),w=v(b.info.name),I=v(b.info.email||"");o+=`
    ...
    `}async function vs(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await bi(m.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let o='<div class="flex flex-col gap-3 md:hidden">';t.forEach(s=>{const n=new Date(s.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=v(s.supplierName);o+=`
        ...
        `;e.innerHTML=o+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function Bi(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),o=e.items.map(r=>`
    ...
    `;Y({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Li),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Ft("genericModal"))},50)}function Mi(){be.innerHTML=`
    ...
    `,le&&(be.removeEventListener("click",le),be.removeEventListener("input",le),be.removeEventListener("change",le)),le=e=>{if(e.target.closest("#tab-btn-list")&&mt("list"),e.target.closest("#tab-btn-purchases")&&mt("purchases"),e.target.closest("#tab-btn-history")&&mt("history"),e.target.id==="toggle-quote-mode"&&(O.isQuoteMode=e.target.checked,Ke()),e.target.id==="supplierSearchInput"&&Wt(),e.target.closest("#btn-new-supplier")&&ga(),e.target.closest(".supplier-item-mobile")){const o=e.target.closest(".supplier-item-mobile"),a=JSON.parse(o.dataset.supplier);Ti(a)}const t=e.target.closest("button[data-action]");if(t){const o=t.dataset.action;o==="delete"&&Ci(t.dataset.id),o==="edit"&&ga(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&po(),e.target.id==="check-all-rows"){const o=e.target.checked;document.querySelectorAll(".row-select").forEach(a=>a.checked=o),po()}if(e.target.closest("#btn-go-to-orders")){const o=document.querySelectorAll(".product-row"),a={};let r=!1;if(o.forEach(s=>{if(s.offsetParent===null||!s.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=s.querySelector("td:nth-child(2)"),d=s.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(s.querySelector(".qty-input").value),u=parseFloat(s.dataset.cost),b=s.querySelector(".supplier-select").value;if(b){if(!a[b]){const h=O.allSuppliers.find(f=>f.id===b);a[b]={info:h,items:[]}}a[b].items.push({name:i,qty:c,cost:u})}}),!r){p("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}O.finalOrders=a,O.step=2,Ke()}if(e.target.closest("#btn-back-step1")&&(O.step=1,Ke()),e.target.closest(".btn-send-order")){const o=e.target.closest(".btn-send-order"),a=JSON.parse(decodeURIComponent(o.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(o.dataset.orderItems)),s=parseFloat(o.dataset.total),n=O.isQuoteMode;if(a.phone){const i=a.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${a.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${a.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else p("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const o=e.target.closest(".btn-register-order");if(o.disabled)return;const a=JSON.parse(decodeURIComponent(o.dataset.order));a.establishmentId=m.establishmentId,o.disabled=!0,o.textContent="A processar...",Se(m.establishmentId).then(r=>{const s=r.purchaseConfig||null;return pi(a,s)}).then(()=>{p("Sucesso","Compra registrada e integrada ao financeiro!","success"),o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',o.classList.replace("bg-blue-600","bg-green-600"),o.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{o.disabled=!1,o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',p("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const a=e.target.closest(".btn-delete-purchase").dataset.id;H("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await gi(a,m.establishmentId),p("Sucesso","Compra e financeiro excluídos.","success"),vs()}catch(s){p("Erro","Erro ao excluir: "+s.message,"error")}})}if(e.target.closest(".btn-print-order")){const a=e.target.closest(".supplier-order-card").dataset.supplierId,r=O.finalOrders[a];r?Di(r,O.isQuoteMode):p("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const o=e.target.closest(".btn-view-purchase"),a=JSON.parse(o.dataset.purchase);Bi(a)}},be.addEventListener("click",le),be.addEventListener("input",le),be.addEventListener("change",le),mt("list")}function mt(e){St=e,["list","purchases","history"].forEach(o=>{const a=document.getElementById(`tab-btn-${o}`),r=document.getElementById(`tab-content-${o}`);o===e?(a.classList.add("border-indigo-500","text-indigo-600"),a.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(a.classList.remove("border-indigo-500","text-indigo-600"),a.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Ei()}const Xt=document.getElementById("content"),ba={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let re=new Set,pt=null,Be=null;function Ai(e=8){let t="";for(let o=0;o<e;o++)t+=`
        ...
        `;return t}function Ni(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const o=t.status==="inactive",a=v(t.name),r=v(t.specialty||"Especialidade"),s=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Zt(){const e=document.getElementById("genericModal");e.style.display="none",Be&&e.removeEventListener("click",Be)}async function qi(e){const t=document.getElementById("genericModal"),o=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},a=v(o.name),r=m.services||await $e(m.establishmentId),s=m.professionals||await Z(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",Ri(o,r),ji(o),Fi(o,s),Oi(o)}function Ri(e,t){const o=document.getElementById("professionalForm"),a=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,S)=>{const $=S+1,w=$==a[1]?"selected":"",I=new Date(0,S).toLocaleString("pt-BR",{month:"long"});return`<option value="${$}" ${w}>${I.charAt(0).toUpperCase()+I.slice(1)}</option>`}).join(""),s=e.status||"active",n=v(e.name||""),i=v(e.specialty||""),l=v(e.phone||""),d=v(e.notes||"");o.innerHTML=`
        ...
        `).join("")}catch(a){o.innerHTML=`<p class="text-red-500">${a.message}</p>`}}}function Oi(e){const t=document.getElementById("genericModal");Be&&t.removeEventListener("click",Be),Be=async o=>{const a=o.target.closest("button[data-action]");if(!a){const s=o.target.closest(".tab-link");s&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),s.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(s.dataset.tab).classList.remove("hidden"));return}const r=a.dataset.action;switch(o.stopPropagation(),r){case"close-modal":Zt();break;case"delete-professional":const s=a.dataset.id;if(await H("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Fa(s),p("Sucesso!","Profissional excluído.","success"),Zt(),Bt()}catch(f){p("Erro",`Não foi possível excluir: ${f.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=a,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(f=>f.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(f=>{const y=f.querySelector('[data-field="active"]').dataset.day;u[y]={active:f.querySelector('[data-field="active"]').checked,start:f.querySelector('[data-field="start"]').value,end:f.querySelector('[data-field="end"]').value,breakStart:f.querySelector('[data-field="breakStart"]').value,breakEnd:f.querySelector('[data-field="breakEnd"]').value}});const g={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{g.id?(await Ct(g.id,g),p("Sucesso!","Profissional atualizado.","success")):(delete g.id,await ja(g),p("Sucesso!","Profissional criado.","success")),Zt(),Bt()}catch(f){p("Erro",f.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=a.dataset.id;if(await H("Apagar Bloqueio","Tem certeza?"))try{await $o(b),p("Bloqueio removido.","success");const f=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";et(e.id,f)}catch(f){p("Erro",f.message,"error")}break;case"batch-delete-blockage":const h=JSON.parse(a.dataset.ids);if(await H("Apagar em Lote",`Tem certeza que deseja apagar ${h.length} bloqueios com este motivo?`))try{await Wa(h),p("Bloqueios removidos.","success");const f=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";et(e.id,f)}catch(f){p("Erro",f.message,"error")}break}},t.addEventListener("click",Be)}function go(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(re.size>0?(t.textContent=`${re.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function zi(){H("Excluir em Lote",`Tem certeza que deseja excluir ${re.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await lr(Array.from(re)),p("Sucesso!",`${re.size} profissionais foram excluídos.`,"success"),re.clear(),go(),Bt()}catch(t){p("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Je(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Ai();return}const t=document.getElementById("showInactiveProfToggle").checked,o=document.getElementById("profSearchInput").value.toLowerCase(),a=m.professionals.filter(r=>{const s=r.name.toLowerCase().includes(o),n=t||r.status!=="inactive";return s&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Ni(a)}async function Bt(){re.clear(),Xt.innerHTML=`
        ...
        </section>`,pt&&Xt.removeEventListener("click",pt),pt=t=>{const o=t.target.closest('[data-action="open-professional-modal"]'),a=t.target.closest('[data-action="batch-delete"]');if(o){t.preventDefault();let s={};if(o.dataset.professional)try{s=JSON.parse(o.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}qi(s);return}if(a){zi();return}const r=t.target.closest(".professional-checkbox");if(r){const s=r.dataset.id;r.checked?re.add(s):re.delete(s),Je(),go();return}},Xt.addEventListener("click",pt),document.getElementById("profSearchInput").addEventListener("input",Je),document.getElementById("showInactiveProfToggle").addEventListener("change",Je);const e=document.getElementById("professionalsList");m.professionals=null,m.services=null,Je();try{const[t,o]=await Promise.all([Z(m.establishmentId),$e(m.establishmentId)]);m.professionals=t,m.services=o,Je(),go()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}let P={clients:[],establishment:null,searchTimeout:null,currentClient:null,history:[],historyLimit:10,filters:{hasLoyalty:!1,birthMonth:"",inactiveDays:""},showFilters:!1,selectionMode:!1,selectedClients:new Set};const hs=e=>e?e.replace(/\D/g,""):"",Dt=e=>{if(!e)return"";const t=e.replace(/\D/g,"");return t.length>10?t.replace(/^(\d\d)(\d{5})(\d{4}).*/,"($1) $2-$3"):t.replace(/^(\d\d)(\d{4})(\d{0,4}).*/,"($1) $2-$3")},Vi=e=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e||0),bo=e=>{if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?"-":t.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return"-"}},Ui=()=>{P.showFilters=!P.showFilters;const e=document.getElementById("filter-panel");e&&e.classList.toggle("hidden",!P.showFilters)},xs=()=>{P.selectionMode=!P.selectionMode,P.selectedClients.clear(),ks(),Ro()},ys=e=>{P.selectedClients.has(e)?P.selectedClients.delete(e):P.selectedClients.add(e),Ro();const t=document.getElementById(`card-${e}`);if(t){const o=t.querySelector(".client-checkbox");o&&(o.checked=P.selectedClients.has(e)),P.selectedClients.has(e)?t.classList.add("ring-2","ring-indigo-500","bg-indigo-50"):t.classList.remove("ring-2","ring-indigo-500","bg-indigo-50")}},Ro=()=>{const e=document.getElementById("header-normal"),t=document.getElementById("header-selection"),o=document.getElementById("selected-count");P.selectionMode?(e.classList.add("hidden"),t.classList.remove("hidden"),o&&(o.textContent=`${P.selectedClients.size} selecionado(s)`)):(e.classList.remove("hidden"),t.classList.add("hidden"))},_i=async()=>{const e=P.selectedClients.size;if(e!==0&&await H("Excluir Clientes",`Tem certeza que deseja excluir ${e} clientes selecionados? Esta ação não pode ser desfeita.`)){const t=document.getElementById("btn-bulk-delete");t&&(t.disabled=!0,t.textContent="Excluindo...");try{const o=Array.from(P.selectedClients).map(a=>Ga(a));await Promise.all(o),p("Sucesso",`${e} clientes excluídos com sucesso!`,"success"),xs(),setTimeout(()=>pe(),500)}catch(o){console.error(o),p("Erro","Ocorreu um erro ao excluir alguns clientes.","error"),t&&(t.disabled=!1,t.textContent="Excluir")}}},Ji=()=>{const e=document.getElementById("filter-loyalty"),t=document.getElementById("filter-month"),o=document.getElementById("filter-inactive");P.filters.hasLoyalty=e?e.checked:!1,P.filters.birthMonth=t?t.value:"",P.filters.inactiveDays=o?o.value:"",pe()},Wi=()=>{const e=document.getElementById("filter-loyalty"),t=document.getElementById("filter-month"),o=document.getElementById("filter-inactive");e&&(e.checked=!1),t&&(t.value=""),o&&(o.value=""),P.filters={hasLoyalty:!1,birthMonth:"",inactiveDays:""},pe()},ws=async(e=null)=>{P.currentClient=e,P.historyLimit=10;const t=!e;if(Y({title:"",contentHTML:(a=>`
        <div class="h-[80vh] flex flex-col bg-gray-50 rounded-lg overflow-hidden">
            <div class="bg-white border-b px-6 py-4 flex justify-between items-center shrink-0">
                <div>
                    <h2 class="text-xl font-bold text-gray-800">${t?"Novo Cliente":a.name||"Cliente"}</h2>
                    ${t?"":`<p class="text-sm text-gray-500">${Dt(a.phone)}</p>`}
                </div>
                ${t?"":`
                <div class="bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-xs font-bold">
                    ${a.loyaltyPoints||0} pts
                </div>`}
            </div>
    ...
    `)(e||{}),maxWidth:"max-w-3xl"}),window.switchTab=a=>$t(a,t),window.handleSave=Gi,window.handleDelete=Yi,window.loadMoreHistory=()=>{P.historyLimit+=10,$t("history",t)},!t&&e.id)try{if(typeof no=="function"){const a=await no(m.establishmentId,e.id);if(a){P.currentClient=a;const r=document.querySelector(".bg-indigo-100.text-indigo-700");r&&(r.textContent=`${a.loyaltyPoints||0} pts`)}}P.history=await qr(m.establishmentId,e.phone)}catch(a){console.error("Aviso: Não foi possível atualizar detalhes do cliente",a),P.history=[]}$t("details",t)},$t=(e,t)=>{const o=document.getElementById("modal-body");if(!o)return;document.querySelectorAll('[id^="tab-btn-"]').forEach(s=>{s.classList.remove("border-indigo-600","text-indigo-600"),s.classList.add("border-transparent","text-gray-500")});const a=document.getElementById(`tab-btn-${e}`);a&&(a.classList.add("border-indigo-600","text-indigo-600"),a.classList.remove("border-transparent","text-gray-500"));const r=P.currentClient||{};if(e==="details"){if(o.innerHTML=`
        ...
        `,t){const s=document.getElementById("input-phone");s&&(s.oninput=n=>n.target.value=Dt(n.target.value))}}else if(e==="appointments"){const s=new Date,n=P.history.filter(i=>{const l=new Date(i.date);return i.type==="appointment"&&l>=s&&i.status!=="cancelled"&&i.status!=="cancelado"&&i.status!=="completed"&&i.status!=="finalizado"});if(n.sort((i,l)=>new Date(i.date)-new Date(l.date)),!n.length){o.innerHTML=`<div class="text-center py-10">
        ...
        `}else if(e==="history"){const s=[...P.history].filter(l=>l.type==="appointment"&&(l.status==="completed"||l.status==="finalizado")).sort((l,d)=>new Date(d.date)-new Date(l.date)),n=s.slice(0,P.historyLimit),i=s.length>P.historyLimit;if(!n.length){o.innerHTML='<div class="text-center text-gray-400 mt-10">Nenhum histórico de agendamento finalizado.</div>';return}o.innerHTML=`
            <div class="space-y-3">
                ${n.map(l=>`
            ...
            `:""}
        `}else if(e==="loyalty"){const s=P.establishment.loyaltyProgram;if(!s||!s.enabled){o.innerHTML='<div class="text-center text-gray-400 mt-10">Programa de fidelidade não ativo neste estabelecimento.</div>';return}const n=r.loyaltyPoints||0,i=s.type==="visit"?`Regra: Ganhe ${s.pointsPerVisit||1} pontos a cada visita`:`Regra: Ganhe 1 ponto a cada R$ ${s.pointsPerCurrency||10}`,l=s.tiers||s.rewards||[];o.innerHTML=`
        ...
        `,window.handleRedeem=async(d,c)=>{if(await H("Resgatar",`Trocar ${d} pontos por "${c}"?`))try{await Rr(m.establishmentId,r.phone,d,c),p("Sucesso","Resgate realizado!","success"),r.loyaltyPoints=(r.loyaltyPoints||0)-parseInt(d),P.history.unshift({type:"loyalty",description:`Resgate: ${c}`,date:new Date().toISOString(),value:-d,isPoints:!0,status:"completed"}),$t("loyalty",!1),pe()}catch(u){p("Erro",u.message||"Erro ao resgatar","error")}}}},Gi=async()=>{const e=document.getElementById("form-client"),t=new FormData(e),o=t.get("phone").replace(/\D/g,"");if(o.length<10){p("Erro","Telefone inválido","error");return}const a={name:t.get("name"),phone:o,email:t.get("email"),birthDate:t.get("birthDate"),notes:t.get("notes"),establishmentId:m.establishmentId};try{await Nr(a),p("Sucesso","Cliente salvo!","success"),document.getElementById("genericModal").style.display="none",pe()}catch(r){p("Erro","Erro ao salvar cliente","error"),console.error(r)}},Yi=async()=>{if(await H("Excluir","Tem certeza? Isso apagará o histórico deste cliente."))try{const e=P.currentClient.id||hs(P.currentClient.phone);await Ga(e),p("Sucesso","Cliente removido","success"),document.getElementById("genericModal").style.display="none",setTimeout(()=>pe(),500)}catch(e){p("Erro","Erro ao remover","error"),console.error(e)}},ks=()=>{const e=document.getElementById("clients-grid");if(e){if(e.innerHTML="",P.clients.length===0){e.innerHTML=`
        ...
        `;return}P.clients.forEach(t=>{const o=document.createElement("div"),a=t.id||hs(t.phone),r=P.selectedClients.has(a);o.id=`card-${a}`,o.className=`bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-all cursor-pointer flex items-center justify-between group relative ${r?"ring-2 ring-indigo-500 bg-indigo-50":""}`,o.onclick=l=>{l.target.type!=="checkbox"&&(P.selectionMode?ys(a):ws(t))};const s=t.lastVisit||t.lastServiceDate||t.lastAppointmentDate;let n="Nunca visitou";if(s){const l=bo(s);l&&l!=="-"&&(n=`Última visita: ${l.split(" ")[0]}`)}const i=P.selectionMode?`
            <div class="absolute top-2 left-2 z-10" onclick="event.stopPropagation()">
                <input type="checkbox" class="client-checkbox w-5 h-5 text-indigo-600 rounded focus:ring-indigo-500" 
                    ${r?"checked":""} 
                    onchange="window.toggleClientSelection('${a}')">
            </div>
        `:"";o.innerHTML=`
            ${i}
        ...
        `,e.appendChild(o)})}},pe=async(e="")=>{const t=document.getElementById("clients-grid");t&&(t.innerHTML='<div class="col-span-full flex justify-center py-10"><div class="loader"></div></div>');const o=e||document.getElementById("search-input")?.value||"";try{if(P.clients=await it(m.establishmentId,o,100,P.filters),P.filters.inactiveDays){const a=parseInt(P.filters.inactiveDays,10);if(!isNaN(a)&&a>0){const r=new Date,s=new Date(r.setDate(r.getDate()-a));P.clients=P.clients.filter(n=>{const i=n.lastVisit||n.lastServiceDate;if(!i)return!0;const l=new Date(i);return isNaN(l.getTime())?!0:l<s})}}ks(),Ro()}catch(a){console.error(a),t&&(t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao carregar lista.</p>')}},Qi=async()=>{const e=document.getElementById("content");e.innerHTML=`
    ...
    `;const o=t.querySelector("#establishmentTimezone");if(e.timezone)o.value=e.timezone;else try{const s=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(o.options).some(i=>i.value===s)?o.value=s:o.value="America/Sao_Paulo"}catch{o.value="America/Sao_Paulo"}const a=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(Kt).forEach(s=>{const n=r[s]||{},i=Kt[s],l=n.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${l?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,a.appendChild(d)}),a.addEventListener("change",s=>{const n=s.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",s=>{s.preventDefault();const n={};Object.keys(Kt).forEach(l=>{n[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;ze({workingHours:n,timezone:i},s)})}function sl(e,t){const o=e.loyaltyProgram||{},a=o.type||"amount",r=o.pointsPerCurrency||10,s=o.pointsPerVisit||1;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
             ...
             <form id="loyalty-form" class="space-y-6">
                 ...
                 <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-indigo-50 transition-colors ${a==="amount"?"border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500":""}">
                            <input type="radio" name="loyaltyType" value="amount" class="form-radio text-indigo-600 h-4 w-4" ${a==="amount"?"checked":""}>
                            <div class="ml-3">
                        ...
                        <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-indigo-50 transition-colors ${a==="visit"?"border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500":""}">
                            <input type="radio" name="loyaltyType" value="visit" class="form-radio text-indigo-600 h-4 w-4" ${a==="visit"?"checked":""}>
                            <div class="ml-3">
                 ...
                 <div id="loyalty-config-amount" class="${a==="amount"?"":"hidden"} p-4 bg-blue-50 rounded-lg border border-blue-100">
                 ...
                 <div id="loyalty-config-visit" class="${a==="visit"?"":"hidden"} p-4 bg-purple-50 rounded-lg border border-purple-100">
    ...
    `;try{const[o,a]=await Promise.all([To(m.establishmentId),Po(m.establishmentId)]),r=e.financialIntegration||{},s=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ce(o,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ce(a,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ce(o,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ce(a,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ce(o,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ce(a,s.defaultCostCenterId)}catch{p("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",o=>{o.preventDefault();const a={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};ze(a,o)})}function nl(e,t){const o="5516997859430",a=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${o}?text=${a}`;t.innerHTML=`
    ...
    `}function il(e,t){const o="5516997859430",a=encodeURIComponent("Olá, gostaria de solicitar o cancelamento da minha assinatura."),r=`https://wa.me/${o}?text=${a}`,s="sistemakairosagenda@gmail.com";t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex flex-col md:flex-row items-center justify-between mb-6 border-b pb-4">
                <div>
    ...
    `}function ll(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${e}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function $s(e="indigo",t){const o=t.querySelector("#color-palette-container"),a=t.querySelector("#establishmentThemeColor");!o||!a||(o.innerHTML="",Object.entries(Xi).forEach(([r,s])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{a.value=r,$s(r,t)}),o.appendChild(i)}),a.value=e)}function dl(e,t){const o=t.querySelector("#slotIntervalContainer"),a=t.querySelector("#establishmentSlotInterval");if(!o||!a)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];o.innerHTML=r.map(s=>{const n=s.value===e;return`<button type="button" data-value="${s.value}" 
    ...
    `,he.querySelector('button[data-action="back-to-list"]').addEventListener("click",a=>{a.preventDefault(),Es()});const o=document.getElementById("settings-content-detail");switch(e){case"personal-data":Zi(W,o);break;case"change-password":Ki(W,o);break;case"change-email":el(W,o);break;case"branding":tl(W,o);break;case"booking":ol(W,o);break;case"working-hours":al(W,o);break;case"loyalty":sl(W,o);break;case"financial":await rl(W,o);break;case"support":nl(W,o);break;case"cancellation":il(W,o);break;default:ll(t?t.label:"Definições",o)}}async function Es(){if(he.innerHTML=`
    ...
    `,!W)try{W=await Se(m.establishmentId)}catch{p("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),he.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const e=U.currentUser;e&&e.displayName&&(m.userName=e.displayName);const t=v(m.userName||U.currentUser.email);let a=`https://placehold.co/96x96/E2E8F0/4A5568?text=${t?t.charAt(0).toUpperCase():"U"}`;e&&e.photoURL&&(a=e.photoURL),he.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
    ...
    `,he.querySelector("#settings-menu-list").addEventListener("click",s=>{const n=s.target.closest("button[data-section]");n&&(s.preventDefault(),cl(n.dataset.section))});const r=he.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",s=>{s.preventDefault(),oe("my-profile-section")})}const tt=document.getElementById("content");async function Ne(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const o=document.getElementById("filterStartDate")?.value,a=document.getElementById("filterEndDate")?.value,r=await Ot(m.establishmentId,o||new Date().toISOString().split("T")[0],a||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),n=s?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let g=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;c.innerHTML+=w}),t.appendChild(c)})}catch(o){t.innerHTML=`<p class="text-center text-red-500">Erro: ${o.message}</p>`}}}async function ul(e){e.preventDefault();const t=e.target,o=t.querySelector("#blockageProfId").value,a=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||a,s=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:m.establishmentId,professionalId:o,startTime:new Date(`${a}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await zt(i),t.reset(),p("Sucesso","Bloqueio adicionado com sucesso!","success"),Ne(o)}catch(l){p("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function ml(e){e.preventDefault();const t=e.target,o=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(o.length===0)return p("Atenção","Selecione pelo menos um profissional.","error");const a=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||a,s=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=o.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${a}T${s}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return zt(u)});try{await Promise.all(d),p("Sucesso",`${o.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&Ne(c)}catch(c){p("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function pl(e){tt.addEventListener("submit",t=>{t.target.id==="blockageForm"&&ul(t),t.target.id==="batchBlockageForm"&&ml(t)}),tt.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&Ne(e)}),tt.addEventListener("click",async t=>{const o=t.target.closest("button[data-action]");if(!o)return;const a=o.dataset.action;if(a==="back-to-professionals")oe("profissionais-section");else if(a==="delete-blockage"){if(await H("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await $o(o.dataset.id),p("Sucesso","Bloqueio removido.","success"),Ne(e)}catch(s){p("Erro",`Não foi possível remover o bloqueio: ${s.message}`,"error")}}else if(a==="batch-delete-blockage"){const r=JSON.parse(o.dataset.ids);if(await H("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Wa(r),p("Sucesso",`${r.length} bloqueios removidos.`,"success"),Ne(e)}catch(n){p("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function gl(e){const{professionalId:t,professionalName:o}=e;if(!t||!o){tt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const a=v(o);tt.innerHTML=`
        <section>
        ...
        </section>`,pl(t),await Ne(t);const r=document.getElementById("batchProfSelectionContainer");try{const s=await Z(m.establishmentId);r.innerHTML=s.map(n=>`
            <div class="flex items-center">
    ...
    `}).join("")}function Et(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=m.users:t=m.users.filter(o=>o.status==="active"),Sl(t)}function $l(e={}){return Object.entries(wl).map(([t,o])=>{const a=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,s=Object.entries(kl).map(([i,l])=>`
    ...
    `}).join("")}async function va(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let o=m.professionals;if(!o||o.length===0)try{o=await Z(m.establishmentId),m.professionals=o}catch{p("Erro","Não foi possível carregar a lista de profissionais.","error")}const a=S=>o.find($=>$.id===S),r=(S,$)=>{const I=a(S)?.photo,L=$.charAt(0).toUpperCase();return{photoSrc:I||`https://placehold.co/128x128/E2E8F0/4A5568?text=${L}`,initials:L,photoUrl:I||""}},s=e?.professionalId,n=e?.name||"Novo Usuário",i=r(s,n),l=a(s),d=S=>{let $='<option value="">-- Não Associado a um Profissional --</option>';return $+=o.map(w=>`<option value="${w.id}" ${w.id===S?"selected":""}>${w.name} (${w.specialty||"N/A"})</option>`).join(""),$},c=e!==null;t.querySelector("#userFormTitle").textContent=c?`Editar Usuário: ${e.name}`:"Novo Usuário";const u=t.querySelector("#userForm");u.innerHTML=`
    ...
    `,We&&fe.removeEventListener("click",We),Ge&&fe.removeEventListener("change",Ge),We=async e=>{if(!document.getElementById("user-list-view")){fe.removeEventListener("click",We);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":va();break;case"edit-user":const a=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));va(a);break;case"back-to-list":Mt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await H("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await hl(r),p("Usuário excluído com sucesso!","success"),Mt()}catch(n){p(`Erro ao excluir: ${n.message}`,"error")}break}}},Ge=async e=>{if(!document.getElementById("user-list-view")){fe.removeEventListener("change",Ge);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Et();else if(t){e.stopPropagation();const o=t.dataset.userId,a=t.checked?"active":"inactive";try{await yl(o,a),p(`Usuário ${a==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=m.users.findIndex(s=>s.id===o);r>-1&&(m.users[r].status=a,Et())}catch(r){p(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,Et()}}},fe.addEventListener("click",We),fe.addEventListener("change",Ge),await El()}const Il=document.getElementById("content");let ha={},fo=null;function Cl(){Object.values(ha).forEach(e=>e?.destroy()),ha={}}function Ll(e,t){if(!window.jspdf){p("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:o}=window.jspdf,a=new o({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(a.setFontSize(18),a.text(e,a.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];a.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=a.lastAutoTable?a.lastAutoTable.finalY+20:60;a.text("Detalhes das Vendas",20,s),a.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),a.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function xa(e){const t=document.getElementById("genericModal"),o=v(e.client),a=v(e.items),r=v(e.responsavelCaixa||"N/A"),s=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function Tl(e){const{summary:t,transactions:o}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const a=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);a.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),s.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=fo.transactions[l];d&&xa(d)})}),n.innerHTML=o.map((i,l)=>{const d=v(i.client),c=v(i.items),u=v(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=fo.transactions[l];d&&xa(d)})})}async function ya(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),o=document.getElementById("reportEndDate");if(!e||!t||!o)return;const a=t.value,r=o.value;if(!a||!r)return p("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,n=await Mr({establishmentId:m.establishmentId,startDate:a,endDate:r,cashierSessionId:s});fo=n,e.innerHTML=`
        ...
        `,Tl(n)}catch(s){p("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${v(s.message)}</p>`}}async function Pl(){Cl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const o=t.toISOString().split("T")[0];Il.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",ya),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const a=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${a}_a_${r}`;Ll(s,"transactionsTable")});try{const a=await cn(m.establishmentId),r=document.getElementById("cashierSessionFilter");a&&a.length>0&&a.forEach(s=>{const n=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=v(s.closedByName||"N/A");r.innerHTML+=`<option value="${s.id}">${i} - ${n}</option>`})}catch{p("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await ya()}const Bl=document.getElementById("content");let M={payables:[],receivables:[],natures:[],costCenters:[],currentTab:"payables",statusFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",isFilterOpen:!1},gt=null,bt=null;function jo(e){const t=new Map,o=[];return e&&(e.forEach(a=>t.set(a.id,{...a,children:[]})),t.forEach(a=>{a.parentId&&t.has(a.parentId)?t.get(a.parentId).children.push(a):o.push(a)})),o}function Dl(e){if(!e)return{day:"--",month:"---"};const t=new Date(e+"T00:00:00"),o=t.getDate().toString().padStart(2,"0"),a=t.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:o,month:a,full:t.toLocaleDateString("pt-BR")}}function It(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function Ml(e,t,o){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const a=(r,s=0)=>`
        ...
        `;e.innerHTML=t.map(r=>a(r)).join("")}async function vo(e){const t=document.getElementById("genericModal"),o=e==="nature",a=o?"Naturezas Financeiras":"Centros de Custo",r=o?To:Po,s=o?Bn:Mn,n=o?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const i=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const g=jo(u);Ml(i,g,e);const b=l.value;l.innerHTML='<option value="">-- Categoria Principal --</option>';const h=(f,y=0)=>{const S="  ".repeat(y)+(y>0?"↳ ":"");l.innerHTML+=`<option value="${f.id}">${S}${f.name}</option>`,f.children.forEach($=>h($,y+1))};g.forEach(f=>h(f)),l.value=b};try{const u=await r(m.establishmentId);M[n]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const g=t.querySelector("#itemName").value,b=l.value;try{await s({name:g,parentId:b||null,establishmentId:m.establishmentId});const h=await r(m.establishmentId);M[n]=h,d(h),c.reset(),await Ve(),p("Sucesso","Item adicionado.","success")}catch(h){p("Erro",h.message,"error")}})}async function Al(){Nl(),ql(),await Ve()}function Nl(){Bl.innerHTML=`
    ...
    `}function ql(){document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),a=document.getElementById("toggle-filter-btn");M.isFilterOpen=!M.isFilterOpen,M.isFilterOpen?(o.classList.remove("hidden"),a.classList.add("bg-indigo-100","text-indigo-600")):(o.classList.add("hidden"),a.classList.remove("bg-indigo-100","text-indigo-600"))}),document.getElementById("settings-btn").addEventListener("click",zl),document.getElementById("fab-add").addEventListener("click",()=>{const o=M.currentTab==="payables"?"payable":"receivable";ka(o)});const e=document.getElementById("tab-receivables"),t=document.getElementById("tab-payables");e.addEventListener("click",()=>wa("receivables")),t.addEventListener("click",()=>wa("payables")),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",a=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-indigo-100","text-indigo-700"),r.classList.add("text-gray-500")}),a.target.classList.add("bg-indigo-100","text-indigo-700"),a.target.classList.remove("text-gray-500"),M.statusFilter=a.target.dataset.status})}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{M.startDate=document.getElementById("filterStartDate").value,M.endDate=document.getElementById("filterEndDate").value,M.filterNaturezaId=document.getElementById("filterNaturezaId").value,M.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("toggle-filter-btn").click(),Ve()}),gt&&document.body.removeEventListener("click",gt),gt=o=>{const a=o.target.closest("button[data-action]");if(!a)return;const{action:r,type:s,id:n}=a.dataset;if(document.getElementById("list-container"))if(r==="edit"){const i=JSON.parse(a.dataset.item.replace(/&apos;/g,"'"));ka(s,i)}else r==="delete"?Hl(s,n):r==="mark-as-paid"?Fl(s,n):r==="manage-natures"?vo("nature"):r==="manage-cost-centers"&&vo("cost-center")},document.body.addEventListener("click",gt),bt&&document.getElementById("genericModal").removeEventListener("click",bt),bt=o=>{const a=o.target.closest('button[data-action^="delete-"]');if(a){const r=a.dataset.action.split("-")[1];Ol(r,a.dataset.id)}},document.getElementById("genericModal").addEventListener("click",bt)}function wa(e){M.currentTab=e;const t=document.getElementById("tab-receivables"),o=document.getElementById("tab-payables"),a=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-green-700","shadow-sm"),t.classList.remove("text-gray-500"),o.classList.remove("bg-white","text-red-700","shadow-sm"),o.classList.add("text-gray-500"),a.className="fixed bottom-6 right-6 w-14 h-14 bg-green-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-green-700 hover:scale-105 transition-all z-40"):(o.classList.add("bg-white","text-red-700","shadow-sm"),o.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-green-700","shadow-sm"),t.classList.add("text-gray-500"),a.className="fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-red-700 hover:scale-105 transition-all z-40"),Is()}async function Ve(){const e=document.getElementById("list-container");e.innerHTML='<div class="loader mx-auto my-10"></div>';try{if(M.natures.length===0){const[r,s]=await Promise.all([To(m.establishmentId),Po(m.establishmentId)]);M.natures=r,M.costCenters=s,Rl()}const t={startDate:M.startDate,endDate:M.endDate,establishmentId:m.establishmentId};M.filterNaturezaId!=="all"&&(t.natureId=M.filterNaturezaId),M.filterCostCenterId!=="all"&&(t.costCenterId=M.filterCostCenterId);const[o,a]=await Promise.all([qn(t),On(t)]);M.payables=o.entries||[],M.receivables=a.entries||[],jl(),Is()}catch(t){e.innerHTML=`<p class="text-center text-red-500 mt-10">Erro ao carregar: ${t.message}</p>`}}function Rl(){const e=a=>{let r='<option value="all">Todas</option>';const s=jo(a),n=(i,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");r+=`<option value="${i.id}">${d}${i.name}</option>`,i.children.forEach(c=>n(c,l+1))};return s.forEach(i=>n(i)),r},t=document.getElementById("filterNaturezaId"),o=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(M.natures)),o&&(o.innerHTML=e(M.costCenters)),t&&(t.value=M.filterNaturezaId),o&&(o.value=M.filterCostCenterId)}function jl(){const e=document.getElementById("summary-section");if(!e)return;const t=M.receivables.reduce((l,d)=>l+d.amount,0),o=M.receivables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),a=t-o,r=M.payables.reduce((l,d)=>l+d.amount,0),s=M.payables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),n=r-s,i=o-s;e.innerHTML=`
        <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
            ...
            <p class="text-xl font-bold text-green-600">${It(a)}</p>
        </div>
        <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 col-span-2 md:col-span-1">
    ...
    `}function Is(){const e=document.getElementById("list-container");if(!e)return;const t=M.currentTab==="receivables",o=t?M.receivables:M.payables;let a=o;if(M.statusFilter!=="all"&&(a=o.filter(n=>n.status===M.statusFilter)),a.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),a.length===0){e.innerHTML=`
        ...
        `;return}const r=new Map(M.natures.map(n=>[n.id,n.name])),s=t?"receivable":"payable";e.innerHTML=a.map(n=>{const i=Dl(n.dueDate),l=n.status==="paid",d=l?"text-gray-400":t?"text-green-600":"text-red-500",c=n.naturezaId&&r.get(n.naturezaId)||"Geral",u=JSON.stringify(n).replace(/'/g,"&apos;");return`
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 relative overflow-hidden group transition-all hover:shadow-md">
            ...
            <div class="flex-shrink-0 flex flex-col items-center justify-center bg-gray-50 rounded-xl w-14 h-14 border border-gray-100">
                <span class="text-lg font-bold text-gray-800 leading-none">${i.day}</span>
                <span class="text-[10px] font-bold text-gray-400 uppercase leading-none mt-1">${i.month}</span>
            </div>

            <div class="flex-1 min-w-0">
                <h3 class="font-bold text-gray-800 truncate text-sm md:text-base ${l?"line-through text-gray-400":""}">${n.description}</h3>
                <div class="flex items-center gap-2 mt-1">
                    <span class="text-[10px] px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-600 font-medium truncate max-w-[120px]">
                        ${c}
                    </span>
                    ${l?'<span class="text-[10px] px-2 py-0.5 rounded-full bg-gray-100 text-gray-500 font-medium">Baixado</span>':""}
                </div>
            </div>

            <div class="text-right">
                <p class="font-bold text-sm md:text-lg ${d}">${It(n.amount)}</p>
                
                <div class="flex justify-end gap-3 mt-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                    ${l?"":`
                        <button data-action="mark-as-paid" data-type="${s}" data-id="${n.id}" class="text-gray-400 hover:text-green-500" title="Baixar">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </button>
                    `}
                    <button data-action="edit" data-type="${s}" data-item='${u}' class="text-gray-400 hover:text-blue-500" title="Editar">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                    </button>
                    <button data-action="delete" data-type="${s}" data-id="${n.id}" class="text-gray-400 hover:text-red-500" title="Excluir">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                    </button>
                </div>
            </div>
        </div>
        `}).join("")}async function Fl(e,t){const o=new Date().toISOString().split("T")[0];try{await(e==="payable"?Fn(t,o):Un(t,o)),p("Sucesso","Lançamento baixado!","success"),await Ve()}catch(a){p("Erro",a.message,"error")}}async function Hl(e,t){if(await H("Excluir Lançamento","Tem certeza? Essa ação não pode ser desfeita."))try{await(e==="payable"?jn(t):Vn(t)),p("Sucesso","Lançamento excluído.","success"),await Ve()}catch(a){p("Erro",a.message,"error")}}async function Ol(e,t){const a=e==="nature"?Dn:An;if(await H("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await a(t),vo(e==="nature"?"nature":"cost-center")}catch(s){p("Erro",s.message,"error")}}function zl(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ka(e,t=null){const o=document.getElementById("genericModal"),a=e==="payable",r=`${t?"Editar":"Nova"} ${a?"Despesa":"Receita"}`,s=a?"red":"green",n=(u,g)=>{let b='<option value="">-- Selecione --</option>';const h=jo(u),f=(y,S=0)=>{const $="  ".repeat(S)+(S>0?"↳ ":""),w=y.id===g?"selected":"";b+=`<option value="${y.id}" ${w}>${$}${y.name}</option>`,y.children.forEach(I=>f(I,S+1))};return h.forEach(y=>f(y)),b};o.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden w-full m-4">
            <div class="bg-${s}-50 px-6 py-4 border-b border-${s}-100 flex justify-between items-center">
                ...
                <button type="button" data-action="close-modal" data-target="genericModal" class="text-${s}-400 hover:text-${s}-600 text-2xl">&times;</button>
            </div>
        ...
        </div>`,o.style.display="flex";const i=o.querySelector("#financial-form"),l=i.querySelector("#status-toggle"),d=i.querySelector("#payment-date-wrapper"),c=i.querySelector('[name="paymentDate"]');if(!t){const u=i.querySelector("#toggle-installments"),g=i.querySelector("#installments-container");u.addEventListener("change",()=>{g.classList.toggle("hidden",!u.checked)})}l.addEventListener("change",()=>{l.checked?(d.classList.remove("hidden"),c.required=!0):(d.classList.add("hidden"),c.required=!1)}),i.addEventListener("submit",async u=>{u.preventDefault();const g=new FormData(i),b=l.checked,h={description:g.get("description"),amount:parseFloat(g.get("amount")),dueDate:g.get("dueDate"),naturezaId:g.get("naturezaId")||null,centroDeCustoId:g.get("centroDeCustoId")||null,notes:g.get("notes"),status:b?"paid":"pending",paymentDate:b?g.get("paymentDate"):null,establishmentId:m.establishmentId},f=g.get("installments");!t&&f&&parseInt(f)>1?h.installments=parseInt(f):h.installments=1;try{t?(await(a?Rn(t.id,h):zn(t.id,h)),p("Sucesso","Atualizado com sucesso!","success")):(await(a?Nn(h):Hn(h)),p("Sucesso","Criado com sucesso!","success")),document.getElementById("genericModal").style.display="none",Ve()}catch(y){p("Erro",y.message,"error")}})}const Vl=e=>k("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),Ul=e=>k("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),_l=(e,t)=>{const o=new URLSearchParams({startDate:e,endDate:t}).toString();return k(`/api/commissions/stats?${o}`)},Jl=(e={})=>{Object.keys(e).forEach(a=>(e[a]===void 0||e[a]===null||e[a]==="")&&delete e[a]);const t=new URLSearchParams(e).toString(),o=`/api/commissions/history${t?"?"+t:""}`;return k(o)},Wl=e=>k(`/api/commissions/report/${e}`,{method:"DELETE"}),At=new Date,Sa=new Date(At.getFullYear(),At.getMonth(),1),A={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:Sa.toISOString().split("T")[0],dashEndDate:At.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:Sa.toISOString().split("T")[0],histEndDate:At.toISOString().split("T")[0],histProfessionalId:"all"};let ft=null;const Ye=document.getElementById("content");async function Gl(){try{A.professionals=await Z(m.establishmentId)}catch(e){console.error("Erro profissionais",e)}rd(),Yl(),Gt(),qt("dashboard")}function Yl(){ft&&Ye.removeEventListener("click",ft),ft=e=>{const t=e.target.closest("button");if(!t)return;const o=t.dataset.action,a=t.dataset.id,r=t.dataset.idx;switch(o){case"tab-nav":qt(t.dataset.tab);break;case"toggle-all-profs":Ql();break;case"back-to-filters":A.calculationResult=null,Nt(document.getElementById("commissions-content"));break;case"view-preview-items":sd(r);break;case"save-final-report":Zl();break;case"start-new-calc":qt("calculator");break;case"print-receipt":Kl(a);break;case"delete-report":ed(a);break;case"filter-dashboard":Gt();break;case"filter-history":Fo();break}},Ye.addEventListener("click",ft),Ye.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;od(t)}},Ye.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Xl())}}async function Gt(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(A.dashStartDate=e.value),t&&(A.dashEndDate=t.value);const o=document.getElementById("dashboard-stats-container");o&&(o.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const a=await _l(A.dashStartDate,A.dashEndDate);A.dashStats={revenue:a.totalRevenue||0,commissions:a.totalCommissionsPaid||0},A.currentTab==="dashboard"&&Cs(document.getElementById("commissions-content"))}catch(a){console.error(a),o&&(o.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Fo(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),o=document.getElementById("hist-prof");e&&(A.histStartDate=e.value),t&&(A.histEndDate=t.value),o&&(A.histProfessionalId=o.value);const a=document.getElementById("history-list-container");if(a){a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await Jl({startDate:A.histStartDate,endDate:A.histEndDate,professionalId:A.histProfessionalId});A.historyData=r,Ls(a,r)}catch{a.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Ql(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(o=>o.checked);e.forEach(o=>o.checked=!t)}async function Xl(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return p("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},o=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),a=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");A.periodString=`${o} a ${a}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await Vl(t);A.calculationResult=s.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),Nt(r)}catch(s){p("Erro",s.message,"error"),A.calculationResult=null,Nt(r)}}async function Zl(){const e=A.calculationResult.length;if(await H("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const o=A.calculationResult.map(a=>{const r=a.items.map(s=>s.originalSaleId).filter(s=>s!=null);return Ul({professionalId:a.professionalId,professionalName:a.professionalName,period:A.periodString,processedSalesIds:r,reportData:{...a,summary:{...a.summary,finalValue:a.finalValue,extraDebit:a.extraDebit||0,extraCredit:a.extraCredit||0,notes:a.notes||""}}})});await Promise.all(o),p("Sucesso","Pagamentos registrados!","success"),A.calculationResult=null,Gt(),qt("history")}catch(o){p("Erro",o.message,"error")}}function Kl(e){const t=A.historyData.find(o=>o.id===e);t&&td(t)}async function ed(e){if(await H("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Wl(e),p("Sucesso","Registro removido.","success"),Fo(),Gt()}catch(o){p("Erro",o.message,"error")}}function td(e){const{jsPDF:t}=window.jspdf;if(!t)return p("Erro","PDF lib não carregada.","error");const o=new t,a=o.internal.pageSize.getWidth()/2;o.setFontSize(18),o.setFont(void 0,"bold"),o.text("RECIBO DE PAGAMENTO DE COMISSÃO",a,20,{align:"center"}),o.setFontSize(12),o.setFont(void 0,"normal"),o.text(`Profissional: ${e.professionalName}`,15,40),o.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),o.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const s=o.lastAutoTable.finalY+10;o.setFontSize(14),o.setFont(void 0,"bold"),o.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),o.save(`Recibo_${e.professionalName}.pdf`)}function od(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),o=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let a=0,r=0;if(t.forEach(s=>{s.value&&(a=parseFloat(s.value))}),o.forEach(s=>{s.value&&(r=parseFloat(s.value))}),A.calculationResult&&A.calculationResult[e]){const s=A.calculationResult[e];s.extraDebit=a,s.extraCredit=r,s.finalValue=s.summary.totalCommission-a+r,t.forEach(i=>{i!==document.activeElement&&(i.value=a||"")}),o.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${s.finalValue.toFixed(2)}`),ad()}}function ad(){const e=A.calculationResult.reduce((o,a)=>o+a.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(o=>o.innerText=`R$ ${e.toFixed(2)}`)}function sd(e){const t=A.calculationResult[e];if(!t)return;const o=t.items.map(a=>`
    ...
    `).join("");Y({title:"Detalhes da Comissão",contentHTML:`<div class="bg-gray-50 p-3 rounded-lg mb-4 flex justify-between items-center"><div><p class="text-xs text-gray-500">Profissional</p><p class="font-bold text-gray-800">${t.professionalName}</p></div><div class="text-right"><p class="text-xs text-gray-500">Total Itens</p><p class="font-bold text-gray-800">${t.items.length}</p></div></div><div class="border rounded-lg overflow-hidden max-h-[60vh] overflow-y-auto">${o}</div>`,maxWidth:"max-w-md"})}function Nt(e){if(A.calculationResult){const t=A.calculationResult,o=t.reduce((s,n)=>s+n.finalValue,0),a=t.map((s,n)=>`
            ...
            </div>`}else{const t=new Date().toISOString().split("T")[0],o=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],a=A.professionals.map(r=>`
    ...
    `}function nd(e){const t=A.professionals.map(o=>`<option value="${o.id}" ${A.histProfessionalId===o.id?"selected":""}>${o.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,A.historyData.length>0?Ls(document.getElementById("history-list-container"),A.historyData):Fo()}function Ls(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const eo=document.getElementById("content");let ke={allPackages:[],catalogForModal:{services:[],products:[]}},vt=null,De=null;function id(e=6){let t="";for(let o=0;o<e;o++)t+=`
        ...
        `;return t}function ld(){const e=document.getElementById("packagesListContainer");if(e){if(ke.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=ke.allPackages.map(t=>{const o=t.status==="active",a=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,s=t.originalPrice||0,n=s>r?s-r:0,i=s>0?(s-r)/s*100:0,l=v(t.name),d=v(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function $a(){const e=document.getElementById("genericModal");e.style.display="none",De&&e.removeEventListener("click",De)}async function Ea(e=null){const t=document.getElementById("genericModal"),o=!!e,a=e?JSON.parse(JSON.stringify(e.items||[])):[],r=v(e?.name||""),s=v(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(b,h)=>{const f=h.querySelector("#originalPrice"),y=b.reduce((S,$)=>S+$.price*$.quantity,0);f&&(f.textContent=`R$ ${y.toFixed(2)}`)},g=b=>{b.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=b.map((h,f)=>{const y=h.type==="service",S=y?"Serviço":"Produto",$=y?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(b,t)};g(a),c.addEventListener("change",b=>{if(b.target.classList.contains("quantity-input")){const h=parseInt(b.target.dataset.index,10),f=parseInt(b.target.value,10);f>0&&a[h]&&(a[h].quantity=f,g(a))}}),c.addEventListener("click",b=>{if(b.target.classList.contains("remove-item-btn")){const h=parseInt(b.target.dataset.index,10);a.splice(h,1),g(a)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>dd(b=>{const h=a.find(f=>f.id===b.id&&f.type===b.type);h?h.quantity++:a.push({...b,quantity:1}),g(a)}),De&&t.removeEventListener("click",De),De=async b=>{const h=b.target.closest("button[data-action]");if(!h)return;const f=h.dataset.action;if(b.stopPropagation(),f==="close-modal"&&$a(),f==="save-package"){const y=h,S={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:a,originalPrice:a.reduce(($,w)=>$+w.price*w.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!S.name||!S.price){p("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(S.items.length===0){p("Erro","Adicione pelo menos um item ao pacote.","error");return}y.disabled=!0,y.textContent="A salvar...";try{o?await pn(S.id,S):(delete S.id,await mn(S)),p("Sucesso!",`Pacote ${o?"atualizado":"criado"} com sucesso.`,"success"),$a(),await Ho()}catch($){p("Erro",`Não foi possível salvar o pacote: ${$.message}`,"error"),y.disabled=!1,y.textContent="Salvar Pacote"}}},t.addEventListener("click",De)}function dd(e){let t="";const o=document.createElement("div");o.id="item-selection-modal",o.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const a={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=ke.catalogForModal.services.filter(h=>h.name.toLowerCase().includes(d)),u=ke.catalogForModal.products.filter(h=>h.name.toLowerCase().includes(d)),g=c.map(h=>`
    ...
    `,document.body.appendChild(o);const s=o.querySelector("#item-selection-list"),n=o.querySelector("#item-search-input"),i=()=>{o.remove()};r(s),n.addEventListener("input",()=>{t=n.value,r(s)}),o.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:g}=d.dataset,h=(ke.catalogForModal[u+"s"]||[]).find(f=>f.id===g);h&&(e({...h,type:u}),i())}else(c||l.target===o)&&i()})}async function Ho(){eo.innerHTML=`
    ...
    `,vt&&eo.removeEventListener("click",vt),vt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const a=e.target.closest('[data-action="delete-package"]');if(a){const r=a.dataset.id;H("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await gn(r),p("Sucesso!","Pacote excluído.","success"),await Ho()}catch(n){p("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const o=t.dataset.action;if(o==="new-package")Ea(null);else if(o==="edit-package"){const a=JSON.parse(t.dataset.package);Ea(a)}},eo.addEventListener("click",vt);try{const[e,t,o]=await Promise.all([os(m.establishmentId),$e(m.establishmentId),Ht(m.establishmentId)]);ke.allPackages=e,ke.catalogForModal={services:t.filter(a=>a.active),products:o},ld()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const cd=document.getElementById("content");let ud=null;async function md(){const e=v(m.userName||"Usuário"),t=v(U.currentUser?.email||"E-mail não disponível"),o=m.userName?m.userName.charAt(0):"U";cd.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await pd()}async function pd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const o=await ir(t);ud=o,o.photo&&(document.getElementById("user-profile-avatar").src=o.photo);const a=v(o.name);e.innerHTML=`
            ...
            `,gd(o.id),document.getElementById("my-blocks-filter").addEventListener("change",s=>Rt(o.id,s.target.value)),Rt(o.id,"future")}else e.innerHTML=`
        ...
        `}}function gd(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async o=>{o.preventDefault();const a=t.querySelector("#blockDate").value,r=t.querySelector("#blockStartTime").value,s=t.querySelector("#blockEndTime").value,n=t.querySelector("#blockReason").value;if(!a||!r||!s){p("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(r>=s){p("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${a}T${r}:00`),l=new Date(`${a}T${s}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await zt({establishmentId:m.establishmentId,professionalId:e,reason:n||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),p("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;Rt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),p("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function Rt(e,t="future"){const o=document.getElementById("my-blocks-list");o.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const a=new Date;let r,s;t==="history"?(s=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,s=new Date,s.setFullYear(s.getFullYear()+1));let i=(await Ot(m.establishmentId,r.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<a).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=a).sort((l,d)=>l.startTime-d.startTime),i.length>0?(o.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,g=v(l.reason||"Sem motivo");return`
                ...
                `}).join(""),o.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const c=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await $o(c),p("Sucesso","Bloqueio removido.","success"),Rt(e,t)}catch(u){console.error("Erro ao remover bloqueio:",u),p("Erro",`Não foi possível remover o bloqueio: ${u.message}`,"error")}})})):o.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(a){console.error("Erro ao carregar bloqueios:",a),o.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${v(a.message)}</p>`}}const ht=document.getElementById("loadingScreen"),to=document.getElementById("dashboardContent"),oo=document.getElementById("content"),Ia=document.getElementById("notificationBell"),ao=document.getElementById("notificationBadge"),xt=document.getElementById("notificationPanel"),Ca=document.getElementById("notificationList"),so=document.getElementById("profileMenuButton"),ee=document.getElementById("profileDropdown"),bd=document.getElementById("profileName"),fd=document.getElementById("profileEmail"),vd=document.getElementById("logoutButton"),hd=document.getElementById("cancellationHistoryBtn"),La=document.getElementById("myProfileLink"),Ta=document.getElementById("hamburger-menu-btn"),xe=document.getElementById("sidebar"),Me=document.getElementById("mobile-overlay"),Pa={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let ot=null,at=[];const xd={"agenda-section":ts,"comandas-section":Pn,"relatorios-section":Wn,"servicos-section":di,"produtos-section":$i,"suppliers-section":Mi,"profissionais-section":Bt,"clientes-section":Qi,"estabelecimento-section":Es,"ausencias-section":gl,"users-section":Mt,"sales-report-section":Pl,"financial-section":Al,"commissions-section":Gl,"packages-section":Ho,"my-profile-section":md};function yd(e){const t=Pa[e]||Pa.indigo,a=(s=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function ho(){const e=at.filter(t=>!t.read).length;if(e>0?(ao.textContent=e,ao.classList.remove("hidden")):ao.classList.add("hidden"),at.length===0){Ca.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Ca.innerHTML=at.map(t=>`
    ...
    `).join("")}function wd(e){ot&&ot();const t=me(_,"establishments",e,"notifications"),o=jt(t,st("timestamp",">=",new Date),Aa("timestamp","desc"));ot=Hs(o,a=>{a.docChanges().forEach(r=>{if(r.type==="added"){const s=r.doc.data();at.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),p(s.title,s.message,"info",!0),ho();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(s.type==="cancellation"||s.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),ts())}})},a=>{console.error("Erro no listener de notificações em tempo real:",a)})}function oe(e,t={}){const o=e.replace("-section","");if(e!=="my-profile-section"){const r=m.enabledModules?.[o]!==!1,s=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!r||!s){oo.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),xe.classList.contains("absolute")&&(xe.classList.add("hidden"),Me.classList.add("hidden"));return}}const a=xd[e];a?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),oo.innerHTML="",window.innerWidth<768&&(xe.classList.add("hidden"),Me.classList.add("hidden")),a(t)):oo.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`}async function kd(e){const t=document.getElementById("kpi-appointments-wrapper"),o=document.getElementById("kpi-financial-wrapper"),a=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(s&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),n&&o&&(o.classList.remove("hidden"),o.classList.add("inline-flex")),!(!s&&!n))try{const i=await Ar();s&&a&&(a.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i)}}async function Sd(e){try{console.log("[Nativo] Iniciando configuração de Push..."),ye.getPlatform()==="android"&&(await G.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal Android criado."));let t=await G.checkPermissions();if(t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive!=="granted")return;await G.register(),G.addListener("registration",async o=>{console.log("Push Token gerado:",o.value);try{const a=ue(_,"users",e);await xo(a,{fcmTokens:Fs(o.value),platform:"native_mobile"}),console.log("Token FCM salvo no perfil do utilizador (Nativo).")}catch(a){console.error("Erro ao salvar token FCM:",a)}}),G.addListener("registrationError",o=>{console.error("Erro no registo de push notifications:",o)}),G.addListener("pushNotificationReceived",o=>{console.log("Notificação Push recebida:",o),p(o.title,o.body,"info",!0)}),G.addListener("pushNotificationActionPerformed",o=>{console.log("Ação na notificação push:",o),oe("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}async function $d(){try{await Ns(U,qs),console.log("Persistência LOCAL configurada na inicialização.")}catch(e){console.error("Erro ao definir persistência no main.js",e)}ye.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),Ks(),Ta&&Ta.addEventListener("click",e=>{e.stopPropagation(),xe.classList.remove("hidden"),xe.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl"),Me.classList.remove("hidden")}),Me&&Me.addEventListener("click",()=>{xe.classList.add("hidden"),xe.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl"),Me.classList.add("hidden")}),Ia.addEventListener("click",e=>{e.stopPropagation(),xt.classList.toggle("hidden"),xt.classList.contains("hidden")||(at.forEach(t=>t.read=!0),ho())}),hd.addEventListener("click",()=>{er()}),so.addEventListener("click",e=>{e.stopPropagation(),ee.classList.toggle("active"),ee.classList.contains("active")?ee.classList.remove("hidden"):setTimeout(()=>ee.classList.add("hidden"),200)}),La&&La.addEventListener("click",e=>{e.preventDefault(),oe("my-profile-section"),ee.classList.remove("active"),ee.classList.add("hidden")}),document.addEventListener("click",e=>{!xt.contains(e.target)&&e.target!==Ia&&xt.classList.add("hidden"),!ee.contains(e.target)&&e.target!==so&&ee.classList.contains("active")&&(ee.classList.remove("active"),setTimeout(()=>ee.classList.add("hidden"),200))}),Ba(U,async e=>{if(e){if(console.log("Usuário detectado:",e.email),!ye.isNativePlatform()&&(console.log("Inicializando Web Push (PWA)..."),Va(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),o=document.getElementById("btn-enable-toast"),a=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");setTimeout(()=>{t&&(t.style.display="block")},3500),o&&o.addEventListener("click",async()=>{await Ua()&&t&&(t.style.display="none")});const s=()=>{t&&(t.style.display="none")};a&&a.addEventListener("click",s),r&&r.addEventListener("click",s)}try{const o=(await e.getIdTokenResult(!0)).claims;if((o.role==="owner"||o.role==="employee")&&o.establishmentId){const a=await Se(o.establishmentId);m.enabledModules=a.modules,yd(a.themeColor||"indigo");let r=null,s=e.displayName,n=null;if(o.role==="employee"||o.role==="owner"){const d=ue(_,"users",e.uid),c=await Da(d);if(c.exists()){const u=c.data();r=o.role==="employee"?u.permissions||{}:null,s=u.name||s,n=u.professionalId||null}else if(o.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}m.userProfessionalId=n,ye.isNativePlatform()&&Sd(e.uid);const i=s||e.email;Vs(o.establishmentId,a.name,r),so.textContent=i.charAt(0).toUpperCase(),bd.textContent=i,fd.textContent=e.email;const l=()=>{ot&&ot(),zo(U).then(()=>window.location.href="/login.html")};vd.addEventListener("click",d=>{d.preventDefault(),l()}),sr(oe,r,m.enabledModules),kd(r),wd(o.establishmentId),ho(),ht.classList.add("fade-out"),to.style.display="flex",setTimeout(()=>{ht.style.display="none"},500),console.log("Verificando Onboarding..."),setTimeout(()=>{hr()},1500),oe("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),ht.classList.add("fade-out"),setTimeout(()=>{ht.style.display="none"},500),to.innerHTML=`
                ...
                `,to.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{zo(U).then(()=>window.location.href="/login.html")})}}else window.location.href="/login.html"})}$d();Ba(U,async e=>{if(e){await Va();const o="Notification"in window&&Notification.permission==="default",a=window.Capacitor&&window.Capacitor.isNativePlatform();if(o&&!a){const r=document.getElementById("toast-notification-request"),s=document.getElementById("btn-enable-toast"),n=document.getElementById("btn-deny-toast"),i=document.getElementById("btn-close-toast");setTimeout(()=>{r&&(r.style.display="block")},3500),s&&s.addEventListener("click",async()=>{await Ua()&&r&&(r.style.display="none")});const l=()=>{r&&(r.style.display="none")};n&&n.addEventListener("click",l),i&&i.addEventListener("click",l)}}});
