const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-CrzbszEU.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-vhIfPenq.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as oe,d as pe,m as Ha}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Ms,reauthenticateWithCredential as As,verifyBeforeUpdateEmail as qs,updatePassword as Rs,updateProfile as Ns,setPersistence as js,browserLocalPersistence as Fs,onAuthStateChanged as Hs,signOut as Os}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as gt,getDoc as Bo,updateDoc as ka,setDoc as zs,addDoc as Mo,collection as Vt,query as Ao,where as qo,getDocs as Vs,deleteDoc as Us,arrayUnion as _s,orderBy as Ws,onSnapshot as Js}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Gs,onMessage as Ys}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={userName:null,userProfessionalId:null,userPermissions:null,userRole:null,groupId:null,groupName:null,accessibleCompanies:[],accessibleEstablishments:[],currentViewContext:{type:null,id:null,name:null},establishmentId:null,establishmentName:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Qs(e,t,a){m.establishmentId=e,m.establishmentName=t,m.userPermissions=a,m.currentViewContext={type:"BRANCH",id:e,name:t}}const Ro=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",da=Ro?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${Ro?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",da);async function Xs(){const e=oe.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function I(e,t={}){const a=await Xs();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const o=da.replace(/\/$/,""),s=e.startsWith("/")?e:`/${e}`,r=`${o}${s}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${r}`);try{const i=await fetch(r,{...t,headers:{...a,...t.headers}});if(!i.ok){const l=(await i.json().catch(()=>({message:i.statusText}))).message||`Erro na API: ${i.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${i.status}) em ${r}:`,l),new Error(l)}return i.json()}catch(i){throw console.error(`Falha de rede ao tentar acessar ${r}:`,i.message),i.message.includes("Failed to fetch")||i.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${da}. Verifique se o servidor backend está rodando.`):i}}const No=(e,t,a,o=null)=>{let s=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(s+=`&professionalId=${o}`),I(s)},Zs=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const s=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return I(s)},Ks=e=>I("/api/appointments",{method:"POST",body:JSON.stringify(e)}),er=(e,t)=>I(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Oa=e=>I(`/api/appointments/${e}`,{method:"DELETE"}),tr=e=>I(`/api/appointments/${e}/reopen`,{method:"POST"}),ar=(e,t)=>I(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let Q;async function or(){if(!Q)try{Q=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function sr(){if(!Q){console.warn("AudioContext não inicializado. O som não será tocado.");return}Q.state==="suspended"&&Q.resume();const e=Q.createOscillator(),t=Q.createGain();e.connect(t),t.connect(Q.destination),e.type="sine",e.frequency.setValueAtTime(800,Q.currentTime),t.gain.setValueAtTime(0,Q.currentTime),t.gain.linearRampToValueAtTime(.3,Q.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,Q.currentTime+.2),e.start(Q.currentTime),e.stop(Q.currentTime+.2)}function g(e,t,a="info",o=!1){const s=document.getElementById("toast-container");if(!s)return;o&&sr();const r=document.createElement("div"),i={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},n={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};r.className=`toast ${i[a]||i.info}`,r.innerHTML=`
    ...
    `;const l=s.querySelector("[data-close-modal]");l&&(l.onclick=i);const d=s.querySelector('[data-action="close-modal"]');return d&&(d.onclick=i),s.addEventListener("click",c=>{c.target.closest(".modal-content")||i()}),s.style.display="flex",{modalElement:s,close:i,setContent:n}}function rr(){document.body.addEventListener("click",()=>{Q||or()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const o=t.dataset.target;if(o){const s=document.getElementById(o);s&&(s.style.display="none")}}if(e.target.closest("[data-close-modal]")){const o=document.getElementById("genericModal");o&&(o.style.display="none")}})}const J=document.getElementById("sidebar"),za=document.getElementById("sidebarToggle"),Ke=document.getElementById("mainContent"),ir=document.querySelectorAll(".sidebar-link"),ca=document.getElementById("menu-search"),Va=document.getElementById("hamburger-menu-btn"),He=document.getElementById("mobile-overlay");function et(e){if(!J||!Ke)return;J.classList.toggle("collapsed",e),Ke.classList.toggle("sidebar-collapsed-shift",e);const t=J.querySelector(".sidebar-search-container"),a=J.querySelectorAll(".sidebar-category");e?(t&&(t.style.display="none"),a.forEach(o=>o.style.display="none"),document.querySelectorAll(".submenu-toggle").forEach(o=>{const s=o.getAttribute("data-target-submenu"),r=document.getElementById(s),i=o.querySelector(".submenu-arrow");r&&(r.classList.add("hidden"),r.classList.remove("flex")),i&&i.classList.remove("rotate-180")})):(t&&(t.style.display="block"),a.forEach(o=>o.style.display="block"))}function nr(){!J||!He||(J.classList.add("mobile-open"),He.classList.add("visible"))}function vt(){!J||!He||(J.classList.remove("mobile-open"),He.classList.remove("visible"))}function lr(){et(!J.classList.contains("collapsed"))}function dr(e,t){const a=document.getElementById(e);if(!a)return;const o=a.classList.contains("hidden");o&&window.innerWidth>=1024&&J.classList.contains("collapsed")&&et(!1),o?(a.classList.remove("hidden"),a.classList.add("flex"),t&&t.classList.add("rotate-180")):(a.classList.add("hidden"),a.classList.remove("flex"),t&&t.classList.remove("rotate-180"))}function cr(){ca&&ca.addEventListener("input",e=>{const t=e.target.value.toLowerCase().trim(),a=document.getElementById("sidebar-nav");if(!a)return;const o=a.querySelectorAll("li"),s=a.querySelectorAll(".sidebar-category");if(t===""){o.forEach(r=>r.style.display=""),s.forEach(r=>r.style.display="block");return}s.forEach(r=>r.style.display="none"),o.forEach(r=>{if(r.classList.contains("sidebar-category"))return;const i=r.querySelector(".sidebar-link")||r.querySelector(".submenu-toggle");if(!i)return;if(i.textContent.toLowerCase().includes(t)){r.style.display="";const d=r.closest('ul[id$="-submenu"]');if(d){d.classList.remove("hidden"),d.classList.add("flex"),d.parentElement.style.display="";const c=d.parentElement.querySelector(".submenu-toggle");if(c){const u=c.querySelector(".submenu-arrow");u&&u.classList.add("rotate-180")}}}else{const d=i.getAttribute("data-target-submenu");if(d){const c=document.getElementById(d);c&&(Array.from(c.querySelectorAll(".sidebar-link")).some(f=>f.textContent.toLowerCase().includes(t))?r.style.display="":r.style.display="none")}else r.style.display="none"}})})}function ur(e,t,a){if(!J||!Ke)return;Ke.classList.add("main-content-shift"),window.innerWidth>=768?et(J.classList.contains("collapsed")):(Ke.classList.remove("main-content-shift","sidebar-collapsed-shift"),vt()),za&&za.addEventListener("click",s=>{s.stopPropagation(),lr()}),J.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&J.classList.contains("collapsed")&&et(!1)}),J.addEventListener("mouseleave",()=>{if(window.innerWidth>=1024){const s=!!document.querySelector("#sidebarToggle:hover"),r=document.activeElement===ca;!s&&!r&&et(!0)}}),Va&&Va.addEventListener("click",s=>{s.stopPropagation(),nr()}),He&&He.addEventListener("click",s=>{s.stopPropagation(),vt()});let o=0;J.addEventListener("touchstart",s=>{o=s.changedTouches[0].screenX},{passive:!0}),J.addEventListener("touchend",s=>{const r=s.changedTouches[0].screenX;o-r>50&&vt()},{passive:!0}),document.querySelectorAll(".submenu-toggle").forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation();const i=s.getAttribute("data-target-submenu"),n=s.querySelector(".submenu-arrow");dr(i,n)})}),cr(),ir.forEach(s=>{const r=s.getAttribute("data-target");if(!r)return;const i=r.replace("-section",""),n=a?.[i]!==!1,l=t===null||t[r]?.view===!0;if(!n||!l){s.parentElement&&s.parentElement.tagName==="LI"?s.parentElement.style.display="none":s.style.display="none";return}s.addEventListener("click",d=>{d.preventDefault(),document.querySelectorAll(".sidebar-link").forEach(c=>c.classList.remove("active")),s.classList.add("active"),r&&typeof e=="function"&&e(r),window.innerWidth<768&&vt()})})}const mr=e=>I("/api/establishments/",{method:"POST",body:JSON.stringify(e)}),Ue=()=>I("/api/establishments/hierarchy",{method:"GET"}),we=e=>{const t=e||m.establishmentId;return t?I(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Sa=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},pr=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},gr=(e,t)=>{const a=e||m.establishmentId;return a?I(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))};class br{constructor(t,a,o){this.steps=t,this.currentStep=0,this.onComplete=a,this.onSkip=o,this.isActive=!1,this.overlay=null,this.spotlight=null,this.popover=null,this.handleResize=this.handleResize.bind(this)}start(){this.isActive||(this.isActive=!0,this.createElements(),window.addEventListener("resize",this.handleResize),this.renderStep())}stop(t=!1){this.isActive=!1,window.removeEventListener("resize",this.handleResize),this.overlay&&this.overlay.remove(),this.spotlight&&this.spotlight.remove(),this.popover&&this.popover.remove(),t&&this.onComplete?this.onComplete():!t&&this.onSkip&&this.onSkip()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="fixed inset-0 bg-black/60 z-[99990] transition-opacity duration-300",document.body.appendChild(this.overlay),this.spotlight=document.createElement("div"),this.spotlight.className="absolute rounded-xl z-[99991] transition-all duration-500 ease-in-out pointer-events-none bg-transparent",this.spotlight.style.boxShadow="0 0 0 9999px rgba(0, 0, 0, 0.6), 0 0 15px rgba(255,255,255,0.5) inset",document.body.appendChild(this.spotlight),this.popover=document.createElement("div"),this.popover.className="absolute z-[99992] bg-white rounded-2xl shadow-2xl w-[320px] transition-all duration-500 ease-in-out opacity-0 transform scale-95 border border-gray-100 flex flex-col",document.body.appendChild(this.popover)}async renderStep(){if(this.currentStep>=this.steps.length){this.stop(!0);return}const t=this.steps[this.currentStep];this.popover.style.opacity="0",this.popover.style.transform="scale(0.95)",t.onBefore&&(await t.onBefore(),await this.sleep(600));const a=await this.waitForElement(t.targetSelector,3e3);if(a){a.scrollIntoView({behavior:"smooth",block:"center"}),await this.sleep(300);const s=a.getBoundingClientRect(),r=8;this.spotlight.style.top=`${s.top+window.scrollY-r}px`,this.spotlight.style.left=`${s.left+window.scrollX-r}px`,this.spotlight.style.width=`${s.width+r*2}px`,this.spotlight.style.height=`${s.height+r*2}px`,this.spotlight.style.display="block",this.overlay.style.display="none",this.positionPopover(s)}else this.spotlight.style.display="none",this.overlay.style.display="block",this.popover.style.top="50%",this.popover.style.left="50%",this.popover.style.transform="translate(-50%, -50%) scale(1)";const o=this.currentStep===this.steps.length-1;this.popover.innerHTML=`
        ...
        `,setTimeout(()=>{a&&(this.popover.style.transform="scale(1)"),this.popover.style.opacity="1"},50),document.getElementById("tour-next-btn").onclick=()=>{this.currentStep++,this.renderStep()},document.getElementById("tour-prev-btn")&&(document.getElementById("tour-prev-btn").onclick=()=>{this.currentStep--,this.renderStep()}),document.getElementById("tour-skip-btn").onclick=()=>this.stop(!1)}positionPopover(t){const a=this.popover.getBoundingClientRect(),o=20;let s=t.bottom+window.scrollY+o,r=t.left+window.scrollX;s+a.height>window.scrollY+window.innerHeight&&(s=t.top+window.scrollY-a.height-o),r+a.width>window.innerWidth&&(r=t.right+window.scrollX-a.width),r<o&&(r=o),this.popover.style.top=`${s}px`,this.popover.style.left=`${r}px`}handleResize(){this.isActive&&this.renderStep()}sleep(t){return new Promise(a=>setTimeout(a,t))}async waitForElement(t,a){if(!t)return null;const o=Date.now();for(;Date.now()-o<a;){const s=document.querySelector(t);if(s)return s;await this.sleep(100)}return null}}async function fr(){try{console.log("A verificar Onboarding interativo...");const e=await we(m.establishmentId);if(!e||e.parentId||e.onboardingCompleted)return;const t=[{title:"Bem-vindo ao Kairos!",icon:"👋",content:"Preparei um tour rápido para lhe mostrar onde deve configurar as 3 coisas mais importantes antes de receber agendamentos. Vamos a isso?",targetSelector:null},{title:"Perfil e Dados da Loja",icon:"🏢",content:"É aqui em 'Minha Empresa' que você define o nome do Salão, telefone, endereço e faz o upload da sua Logomarca.",targetSelector:'[data-target="estabelecimento-section"]',onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Cores e Personalização",icon:"🎨",content:"Nesta área você pode mudar a cor principal do sistema para ficar com a cara da sua marca. O link do seu cliente vai usar esta cor!",targetSelector:"#themeColor",onBefore:async()=>{window.navigateTo("estabelecimento-section")}},{title:"Criação de Serviços",icon:"✂️",content:"Na aba 'Serviços' é onde a mágica acontece. Crie os serviços que os seus clientes vão poder agendar, informando o preço e a duração de cada um.",targetSelector:'[data-target="servicos-section"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Novo Serviço",icon:"➕",content:"Sempre que precisar adicionar um novo serviço ao menu, basta clicar neste botão verde.",targetSelector:'[data-action="new-service"]',onBefore:async()=>{window.navigateTo("servicos-section")}},{title:"Gestão da Equipe",icon:"👥",content:"E para terminar: a 'Equipa'. Aqui você cadastra os profissionais, define quem faz qual serviço e ajusta a jornada de trabalho semanal de cada um.",targetSelector:'[data-target="profissionais-section"]',onBefore:async()=>{window.navigateTo("profissionais-section")}},{title:"Tudo Pronto!",icon:"🚀",content:"Você já conhece o caminho! Preencha as informações do seu negócio com calma. Quando terminar, volte à Agenda e partilhe o seu Link de Agendamento com os clientes!",targetSelector:null,onBefore:async()=>{window.navigateTo("agenda-section")}}],a=async()=>{try{await Sa(m.establishmentId,{onboardingCompleted:!0}),showNotification("Tour Concluído","Você já pode configurar o seu sistema livremente!","success")}catch(s){console.error("Erro ao gravar fim do onboarding",s)}};new br(t,a,a).start()}catch(e){console.error("Erro fatal ao iniciar onboarding:",e)}}var Oe;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Oe||(Oe={}));class ta extends Error{constructor(t,a,o){super(t),this.message=t,this.code=a,this.data=o}}const vr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},xr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},o=a.Plugins=a.Plugins||{},s=()=>t!==null?t.name:vr(e),r=()=>s()!=="web",i=u=>{const p=d.get(u);return!!(p?.platforms.has(s())||n(u))},n=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(f=>f.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,p={})=>{const f=d.get(u);if(f)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),f.proxy;const b=s(),v=n(u);let h;const $=async()=>(!h&&b in p?h=typeof p[b]=="function"?h=await p[b]():h=p[b]:t!==null&&!h&&"web"in p&&(h=typeof p.web=="function"?h=await p.web():h=p.web),h),k=(C,M)=>{var q,H;if(v){const O=v?.methods.find(R=>M===R.name);if(O)return O.rtype==="promise"?R=>a.nativePromise(u,M.toString(),R):(R,_)=>a.nativeCallback(u,M.toString(),R,_);if(C)return(q=C[M])===null||q===void 0?void 0:q.bind(C)}else{if(C)return(H=C[M])===null||H===void 0?void 0:H.bind(C);throw new ta(`"${u}" plugin is not implemented on ${b}`,Oe.Unimplemented)}},E=C=>{let M;const q=(...H)=>{const O=$().then(R=>{const _=k(R,C);if(_){const Ee=_(...H);return M=Ee?.remove,Ee}else throw new ta(`"${u}.${C}()" is not implemented on ${b}`,Oe.Unimplemented)});return C==="addListener"&&(O.remove=async()=>M()),O};return q.toString=()=>`${C.toString()}() { [capacitor code] }`,Object.defineProperty(q,"name",{value:C,writable:!1,configurable:!1}),q},T=E("addListener"),L=E("removeListener"),A=(C,M)=>{const q=T({eventName:C},M),H=async()=>{const R=await q;L({eventName:C,callbackId:R},M)},O=new Promise(R=>q.then(()=>R({remove:H})));return O.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await H()},O},F=new Proxy({},{get(C,M){switch(M){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?A:T;case"removeListener":return L;default:return E(M)}}});return o[u]=F,d.set(u,{name:u,proxy:F,platforms:new Set([...Object.keys(p),...v?[b]:[]])}),F};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=s,a.handleError=l,a.isNativePlatform=r,a.isPluginAvailable=i,a.registerPlugin=c,a.Exception=ta,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},hr=e=>e.Capacitor=xr(e),le=hr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ut=le.registerPlugin;class jo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let o=!1;this.listeners[t]||(this.listeners[t]=[],o=!0),this.listeners[t].push(a);const r=this.windowListeners[t];r&&!r.registered&&this.addWindowListener(r),o&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,o){const s=this.listeners[t];if(!s){if(o){let r=this.retainedEventArguments[t];r||(r=[]),r.push(a),this.retainedEventArguments[t]=r}return}s.forEach(r=>r(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:o=>{this.notifyListeners(a,o)}}}unimplemented(t="not implemented"){return new le.Exception(t,Oe.Unimplemented)}unavailable(t="not available"){return new le.Exception(t,Oe.Unavailable)}async removeListener(t,a){const o=this.listeners[t];if(!o)return;const s=o.indexOf(a);this.listeners[t].splice(s,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(o=>{this.notifyListeners(t,o)}))}}const Ua=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),_a=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class yr extends jo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(o=>{if(o.length<=0)return;let[s,r]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");s=_a(s).trim(),r=_a(r).trim(),a[s]=r}),a}async setCookie(t){try{const a=Ua(t.key),o=Ua(t.value),s=`; expires=${(t.expires||"").replace("expires=","")}`,r=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${o||""}${s}; path=${r}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ut("CapacitorCookies",{web:()=>new yr});const wr=async e=>new Promise((t,a)=>{const o=new FileReader;o.onload=()=>{const s=o.result;t(s.indexOf(",")>=0?s.split(",")[1]:s)},o.onerror=s=>a(s),o.readAsDataURL(e)}),kr=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(s=>s.toLocaleLowerCase()).reduce((s,r,i)=>(s[r]=e[t[i]],s),{})},Sr=(e,t=!0)=>e?Object.entries(e).reduce((o,s)=>{const[r,i]=s;let n,l;return Array.isArray(i)?(l="",i.forEach(d=>{n=t?encodeURIComponent(d):d,l+=`${r}=${n}&`}),l.slice(0,-1)):(n=t?encodeURIComponent(i):i,l=`${r}=${n}`),`${o}&${l}`},"").substr(1):null,$r=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),s=kr(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(s.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[i,n]of Object.entries(e.data||{}))r.set(i,n);a.body=r.toString()}else if(s.includes("multipart/form-data")||e.data instanceof FormData){const r=new FormData;if(e.data instanceof FormData)e.data.forEach((n,l)=>{r.append(l,n)});else for(const n of Object.keys(e.data))r.append(n,e.data[n]);a.body=r;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(s.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Er extends jo{async request(t){const a=$r(t,t.webFetchExtra),o=Sr(t.params,t.shouldEncodeUrlParams),s=o?`${t.url}?${o}`:t.url,r=await fetch(s,a),i=r.headers.get("content-type")||"";let{responseType:n="text"}=r.ok?t:{};i.includes("application/json")&&(n="json");let l,d;switch(n){case"arraybuffer":case"blob":d=await r.blob(),l=await wr(d);break;case"json":l=await r.json();break;case"document":case"text":default:l=await r.text()}const c={};return r.headers.forEach((u,p)=>{c[p]=u}),{data:l,headers:c,status:r.status,url:r.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ut("CapacitorHttp",{web:()=>new Er});const X=Ut("PushNotifications",{}),Ir="modulepreload",Lr=function(e){return"/"+e},Wa={},Cr=function(t,a,o){let s=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),n=i?.nonce||i?.getAttribute("nonce");s=l(a.map(d=>{if(d=Lr(d),d in Wa)return;Wa[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":Ir,c||(p.as="script"),p.crossOrigin="",p.href=d,n&&p.setAttribute("nonce",n),document.head.appendChild(p),c)return new Promise((f,b)=>{p.addEventListener("load",f),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return s.then(i=>{for(const n of i||[])n.status==="rejected"&&r(n.reason);return t().catch(r)})},Ja=Ut("App",{web:()=>Cr(()=>import("./web-CrzbszEU.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Tr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ga=!1;async function Dr(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await X.removeAllListeners(),await X.addListener("registration",async a=>{Ho(a.value,!0)}),await X.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await X.addListener("pushNotificationActionPerformed",a=>{const o=a.notification.data;console.log("Notificação clicada (Ação):",o)});let t=await X.checkPermissions();t.receive==="prompt"&&(t=await X.requestPermissions()),t.receive==="granted"&&await X.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&Fo()}async function Pr(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await Fo(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function Fo(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Gs(Ha,{vapidKey:Tr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Ho(t,!1)):console.warn("[Push Web] Token veio vazio."),Ga||(Ys(Ha,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Ga=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Ho(e,t){const a=oe.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const o=gt(pe,"users",a.uid);try{const s=await Bo(o);if(s.exists()){const i=s.data().fcmTokens||[];if(i.length===1&&i[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await ka(o,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(s){if(s.code==="not-found")try{await zs(o,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(r){console.error("Erro ao criar user:",r)}else console.error("Erro ao atualizar token:",s)}}const Br=(e,t,a="all",o="all")=>{const s=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&s.append("professionalId",a),o&&o!=="all"&&s.append("costCenterId",o),I(`/api/reports/indicators?${s.toString()}`)},Mr=e=>e?I(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Ar=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:o})=>{const s=new URLSearchParams({startDate:t,endDate:a});return o&&o!=="all"&&s.append("cashierSessionId",o),e&&s.append("establishmentId",e),I(`/api/reports/sales?${s.toString()}`)},qr=()=>I("/api/reports/summary",{method:"GET"}),$e=e=>I(`/api/services/${e}`),Rr=e=>I("/api/services",{method:"POST",body:JSON.stringify(e)}),Nr=(e,t)=>I(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),jr=e=>I(`/api/services/${e}`,{method:"DELETE"}),Fr=(e,t)=>I(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Hr=e=>I(`/api/services/stats/most-popular/${e}`),re=e=>I(`/api/professionals/${e}`),Or=e=>I(`/api/professionals/details/${e}`),zr=e=>I("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Vr=(e,t)=>I(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Oo=e=>I(`/api/professionals/${e}`,{method:"DELETE"}),Ur=e=>{const t=e.map(a=>Oo(a));return Promise.all(t)},_t=(e,t,a,o="all")=>{const s=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${o}`;return I(s)},Wt=e=>I("/api/blockages",{method:"POST",body:JSON.stringify(e)}),$a=e=>I(`/api/blockages/${e}`,{method:"DELETE"}),zo=e=>I("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Ea=e=>e?String(e).replace(/\D/g,""):"",Ia=(e,t="",a=20,o={})=>{const s=new URLSearchParams;return t&&s.append("search",t),a&&s.append("limit",a),o&&o.hasLoyalty&&s.append("hasLoyalty","true"),o&&o.birthMonth&&s.append("birthMonth",o.birthMonth),o&&o.inactiveDays&&s.append("inactiveDays",o.inactiveDays),I(`/api/clients/${e}?${s.toString()}`)},Vo=(e,t)=>{const a=encodeURIComponent(t);return I(`/api/clients/details/${e}/${a}`)},Uo=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Ea(t),o={...e,phone:a,id:a};return I(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(o)})},_o=Uo,Wo=(e,t)=>Uo({...t,id:e}),_r=e=>{const t=encodeURIComponent(e);return I(`/api/clients/${t}`,{method:"DELETE"})},Wr=(e,t,a,o)=>I("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ea(t),points:a,rewardName:o})}),Jr=(e,t)=>Vo(e,Ea(t));function x(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Jo(e,t=800,a=800,o=.7){return new Promise((s,r)=>{if(!e.type.match(/image.*/))return r(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.readAsDataURL(e),i.onload=n=>{const l=new Image;l.src=n.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const f=u.toDataURL("image/jpeg",o);s(f)},l.onerror=d=>r(new Error("Erro ao carregar a imagem para processamento."))},i.onerror=n=>r(new Error("Erro ao ler o ficheiro."))})}const Ya=document.getElementById("content");let Qa=!1;const ua=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5",light:"#c7d2fe"},{bg:"#d1fae5",border:"#059669",main:"#059669",light:"#a7f3d0"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48",light:"#fecdd3"},{bg:"#fef3c7",border:"#d97706",main:"#d97706",light:"#fde68a"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490",light:"#a5f3fc"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7",light:"#bae6fd"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed",light:"#ddd6fe"},{bg:"#fce7f3",border:"#db2777",main:"#db2777",light:"#fbcfe8"}];let Jt=[],ma=[],Pt={},Go=[],B={currentView:window.innerWidth<768?"list":"week",currentDate:new Date,selectedProfessionalId:"all",showInactiveProfs:!1,isSelectionMode:!1,selectedItems:new Set},P={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function ct(e){const t=new Date(e),a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return t.setDate(o),t.setHours(0,0,0,0),t}function La(){const e=document.getElementById("profSelectorContainer");if(!e||!m.professionals)return;let t=m.professionals.filter(s=>B.showInactiveProfs||s.status!=="inactive");const o=[...[{id:"all",name:"Todos",photo:null}],...t];e.innerHTML=o.map(s=>{const r=B.selectedProfessionalId===s.id,i=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),n=s.id!=="all"?m.professionalColors.get(s.id)||ua[0]:{main:"#adb5bd",light:"#f1f3f5"};return`
            <div class="prof-pill ${r?"active":""}"
                 data-action="select-professional" data-prof-id="${s.id}"
                 style="--pc: ${n.main}; --pb: ${r?n.bg:""}; --pl: ${n.light};">
                <div class="prof-pill-dot" ${s.photo?`style="background-image: url('${V(s.photo)}'); background-size: cover; background-position: center;"`:""}>
                    ${s.photo?"":i}
                </div>
                <span>${V(s.name==="Todos"?"Todos":s.name.split(" ")[0])}</span>
            </div>`}).join("")}function V(e){return x(e||"")}function Gr(e,t,a,o,s){const r=(e||"").replace(/\D/g,""),i=new Date(s).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),n=new Date(s).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com ${o} para ${i} às ${n}. Podemos confirmar?`;return`https://wa.me/${r}?text=${encodeURIComponent(l)}`}function Yr(e){const t=document.getElementById("agenda-view");if(!t)return;const a=["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"],o=ct(B.currentDate),s=new Date;s.setHours(0,0,0,0);let r='<div class="week-container" id="weekScroller">';for(let i=0;i<7;i++){const n=new Date(o);n.setDate(o.getDate()+i);const l=n.toDateString()===s.toDateString(),d=e.filter(u=>new Date(u.startTime).toDateString()===n.toDateString()).sort((u,p)=>new Date(u.startTime)-new Date(p.startTime));let c="";d.length===0?c='<div class="week-empty"><i class="bi bi-dash-lg" style="font-size:1rem;display:block;margin-bottom:4px;"></i>Sem agendamentos</div>':c=d.map(u=>{const p=new Date(u.startTime);new Date(u.endTime);const f=p.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),b=m.professionalColors.get(u.professionalId)||{main:"#adb5bd"},v=u.status==="completed";if(u.type==="blockage")return`<div class="week-event-chip week-blockage">
                        <div class="we-time"><i class="bi bi-lock me-1"></i>${f}</div>
                        <div class="we-client">${V(u.reason)}</div>
                        <div class="we-service">${V(u.professionalName)}</div>
                    </div>`;const h=JSON.stringify(u).replace(/'/g,"&apos;");return`<div class="week-event-chip ${v?"completed":""}" style="--ec: ${b.main};"
                    ${v?"":`data-action="edit-appointment" data-appointment="${h}"`}>
                    <div class="we-time">${f}</div>
                    <div class="we-client">${V(u.clientName)}</div>
                    <div class="we-service">${V(u.serviceName)} · ${V((u.professionalName||"").split(" ")[0])}</div>
                    <div class="we-actions">
                        <button class="we-btn" data-action="open-comanda" data-appointment="${h}" title="Comanda" onclick="event.stopPropagation();">
            ...
            <div class="list-date-label">${s}</div>`,r.forEach(i=>{const n=new Date(i.startTime),l=new Date(i.endTime),d=Math.round((l-n)/6e4),c=n.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=m.professionalColors.get(i.professionalId)||{main:"#adb5bd"},p=i.status==="completed";i.clientName&&i.clientName.charAt(0).toUpperCase();const f=JSON.stringify(i).replace(/'/g,"&apos;"),b=B.selectedItems.has(i.id),v=B.isSelectionMode?`<input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-indigo-600" data-action="toggle-select-item" data-id="${i.id}" ${b?"checked":""} onclick="event.stopPropagation()">`:"";if(i.type==="blockage"){o+=`<div class="list-card blockage">
                    ${v}
                    ...
                    <div class="list-card-info">
                        <div class="lc-name" style="color:#c92a2a;">${V(i.reason)}</div>
                        <div class="lc-detail">${V(i.professionalName)}</div>
                    </div>
                </div>`;return}const h=Gr(i.clientPhone,i.clientName,i.serviceName,i.professionalName,i.startTime);o+=`<div class="list-card ${p?"completed":""}"
                ...
                <div class="list-card-info">
                    <div class="lc-name">${V(i.clientName)}</div>
                    <div class="lc-detail">${V(i.serviceName)} · ${V((i.professionalName||"").split(" ")[0])}</div>
                </div>
                ...
                <div class="list-card-actions">
                    <button class="lc-action-btn wa" onclick="event.stopPropagation(); window.open('${h}', '_blank')" title="WhatsApp">
                        <i class="bi bi-whatsapp" style="font-size:0.85rem;"></i>
                    </button>
                    <button class="lc-action-btn comanda" data-action="open-comanda" data-appointment="${f}" title="Comanda" onclick="event.stopPropagation();">
                        <i class="bi bi-receipt" style="font-size:0.8rem;"></i>
                    </button>
                </div>`:""}
            </div>`}),o+="</div>"}),o+="</div>",t.innerHTML=o}function Yo(){const e=m.allEvents.filter(t=>B.selectedProfessionalId==="all"||t.professionalId===B.selectedProfessionalId);B.currentView==="list"?Qr(e):Yr(e),Ca()}function Ca(){const e=document.getElementById("batch-delete-container"),t=document.getElementById("agendaFab");e&&(B.isSelectionMode&&B.selectedItems.size>0?(e.innerHTML=`<div class="bg-gray-900 text-white p-3 rounded-xl shadow-xl flex items-center justify-between gap-4 w-full mx-4" style="background:#212529;color:#fff;padding:12px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;">
        ...
        </div>`,e.style.display="block",t&&(t.style.display="none")):(e.style.display="none",t&&(t.style.display="flex")))}function Xr(){const e=document.getElementById("currentDateDisplay");if(!e)return;const t=new Date;t.setHours(0,0,0,0);const a=new Date(B.currentDate);if(a.setHours(0,0,0,0),Zr(t,a),B.currentView==="list")a.toDateString()===t.toDateString()?e.textContent="Hoje":e.textContent=a.toLocaleDateString("pt-BR",{day:"numeric",month:"short",year:"numeric"});else{const o=ct(a),s=new Date(o);s.setDate(o.getDate()+6);const r=o.toLocaleDateString("pt-BR",{day:"numeric",month:"short"}),i=s.toLocaleDateString("pt-BR",{day:"numeric",month:"short",year:"numeric"});e.textContent=`${r} — ${i}`}}function Zr(e,t){const a=ct(e),o=ct(t);return a.toDateString()===o.toDateString()}async function ce(){const e=document.getElementById("agenda-view");if(!e)return;B.selectedItems.clear(),Ca(),e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;padding:60px 0;"><div style="width:28px;height:28px;border:2.5px solid #e9ecef;border-top:2.5px solid #4f46e5;border-radius:50%;animation:spin 0.7s linear infinite;"></div></div><style>@keyframes spin{to{transform:rotate(360deg)}}</style>',Xr();let t,a;if(B.currentView==="list")t=new Date(B.currentDate),t.setHours(0,0,0,0),a=new Date(t),a.setHours(23,59,59,999);else{const o=ct(B.currentDate);t=new Date(o),a=new Date(o),a.setDate(o.getDate()+6),a.setHours(23,59,59,999)}try{const[o,s]=await Promise.all([No(m.establishmentId,t.toISOString(),a.toISOString(),B.selectedProfessionalId==="all"?null:B.selectedProfessionalId),_t(m.establishmentId,t.toISOString(),a.toISOString(),B.selectedProfessionalId)]);if(!document.getElementById("agenda-view"))return;const r=i=>i.map(n=>({...n,type:n.type||"appointment",professionalName:n.professionalName||(()=>{const l=m.professionals?.find(d=>d.id===n.professionalId);return l?l.name:"Indefinido"})()}));m.allEvents=[...r(o||[]),...r(s||[])],La(),Yo()}catch{document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML=`
                <div class="text-center py-12" style="color:#868e96;">
                    <i class="bi bi-exclamation-triangle" style="font-size:1.5rem;"></i>
                    <p class="mt-2" style="font-size:0.8rem;">Erro ao carregar agenda.</p>
                </div>`)}}async function Kr(){try{const[e,t,a]=await Promise.all([re(m.establishmentId),$e(m.establishmentId),we(m.establishmentId)]);m.professionals=e||[],m.services=t||[],Go=[],a&&(Pt=a.loyaltyProgram||{enabled:!1}),m.professionals.forEach((o,s)=>{m.professionalColors.set(o.id,ua[s%ua.length])}),La()}catch{g("Atenção","Não foi possível carregar os dados da equipa.","error")}}async function Qo(e={}){B.currentDate=e.targetDate?new Date(e.targetDate):B.currentDate||new Date,B.isSelectionMode=!1,B.selectedItems.clear(),Ya.innerHTML=`
        ...
        </div>`,document.getElementById("agendaFab").style.display="flex",document.getElementById("btnPrevDate").addEventListener("click",()=>{B.currentView==="list"?B.currentDate.setDate(B.currentDate.getDate()-1):B.currentDate.setDate(B.currentDate.getDate()-7),ce()}),document.getElementById("btnNextDate").addEventListener("click",()=>{B.currentView==="list"?B.currentDate.setDate(B.currentDate.getDate()+1):B.currentDate.setDate(B.currentDate.getDate()+7),ce()}),document.getElementById("btnToday").addEventListener("click",()=>{B.currentDate=new Date,ce()}),document.getElementById("agendaFab").addEventListener("click",()=>{Te()});const t=document.querySelectorAll(".agenda-view-toggle button");t.forEach(o=>{o.addEventListener("click",()=>{t.forEach(s=>s.classList.remove("active")),o.classList.add("active"),B.currentView=o.dataset.view,ce()})});const a=document.getElementById("btnWeekDays");a&&a.addEventListener("click",()=>{ei()}),Qa||(Ya.addEventListener("click",async o=>{const s=o.target.closest(".lc-action-btn, .we-btn");if(s){const c=s.dataset.action;if(c==="open-comanda"){o.stopPropagation();const u=s.closest(".list-card")||s.closest(".week-event-chip"),p=u?JSON.parse(u.dataset.appointment.replace(/&apos;/g,"'")):null;if(!p)return;const f=p.status==="completed"?"finalizadas":"em-atendimento",b={selectedAppointmentId:p.id,initialFilter:f};f==="finalizadas"&&p.transaction?.paidAt&&(b.filterDate=typeof p.transaction.paidAt=="object"?new Date(p.transaction.paidAt._seconds*1e3):p.transaction.paidAt),Y("comandas-section",b)}if(c==="edit-appointment"){o.stopPropagation();const u=s.closest(".list-card");if(!u)return;const p=JSON.parse(u.dataset.appointment.replace(/&apos;/g,"'"));Te(p)}return}if(o.target.dataset?.action==="toggle-select-item"){o.target.checked?B.selectedItems.add(o.target.dataset.id):B.selectedItems.delete(o.target.dataset.id),Ca();return}if(o.target.closest('[data-action="batch-delete"]')){const c=B.selectedItems.size;await U("Excluir em Lote",`Excluir ${c} agendamento(s)?`)&&(await Promise.all(Array.from(B.selectedItems).map(async p=>{try{await Oa(p)}catch{}})),g(`${c} excluído(s).`,"success"),B.selectedItems.clear(),B.isSelectionMode=!1,ce());return}const r=o.target.closest('[data-action="select-professional"]');if(r){const c=r.dataset.profId;B.selectedProfessionalId=B.selectedProfessionalId===c&&c!=="all"?"all":c,ce();return}const i=o.target.closest(".week-event-chip[data-appointment]");if(i){const c=JSON.parse(i.dataset.appointment.replace(/&apos;/g,"'"));if(c.status==="completed"){g("Agendamentos finalizados não podem ser editados.","warning");return}Te(c);return}const n=o.target.closest(".list-card[data-appointment]");if(n){if(B.isSelectionMode)return;const c=JSON.parse(n.dataset.appointment.replace(/&apos;/g,"'"));if(c.status==="completed"){g("Agendamentos finalizados não podem ser editados.","warning");return}Te(c);return}const l=o.target.closest("[data-action]");if(!l)return;switch(l.dataset.action){case"new-appointment":Te();break;case"delete-appointment":{o.stopPropagation();const c=l.dataset.id;await U("Confirmar","Apagar este agendamento?")&&(await Oa(c),g("Agendamento apagado.","success"),ce());break}case"open-comanda":{o.stopPropagation();let c=null;const u=o.target.closest("[data-appointment]");if(u&&(c=JSON.parse(u.dataset.appointment.replace(/&apos;/g,"'"))),B.isSelectionMode||!c)return;const p=c.status==="completed"?"finalizadas":"em-atendimento",f={selectedAppointmentId:c.id,initialFilter:p};p==="finalizadas"&&c.transaction?.paidAt&&(f.filterDate=typeof c.transaction.paidAt=="object"?new Date(c.transaction.paidAt._seconds*1e3):c.transaction.paidAt),Y("comandas-section",f);break}}}),Qa=!0),await Kr(),await ce()}function ei(){const e=document.getElementById("optionsSheet");if(e){e.remove();return}const t=document.createElement("div");t.id="optionsSheet",t.style.cssText="position:fixed;bottom:0;left:50%;right:auto;transform:translateX(-50%) translateY(100%);width:100%;max-width:440px;background:#fff;border-radius:16px 16px 0 0;z-index:10000;box-shadow:0 -8px 30px rgba(0,0,0,0.12);transition:transform 0.3s ease;max-height:60vh;overflow-y:auto;",t.innerHTML=`
        ...
        </div>`;const a=document.createElement("div");a.id="optionsOverlay",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.25);z-index:9999;opacity:0;transition:opacity 0.3s;",document.body.appendChild(a),document.body.appendChild(t),requestAnimationFrame(()=>{t.style.transform="translateX(-50%) translateY(0)",a.style.opacity="1"});const o=()=>{t.style.transform="translateX(-50%) translateY(100%)",a.style.opacity="0",setTimeout(()=>{t.remove(),a.remove()},300)};document.getElementById("closeOptSheet").addEventListener("click",o),a.addEventListener("click",o),document.getElementById("optSelectMode").addEventListener("click",()=>{B.isSelectionMode=!B.isSelectionMode,B.isSelectionMode||B.selectedItems.clear(),o(),Yo()}),document.getElementById("optInactiveToggle").addEventListener("change",s=>{B.showInactiveProfs=s.target.checked,La()})}function Xa(e){e<1||e>4||(P.step=e,Te(null,!0))}function ti(e){return{title:e?"Editar Reserva":"Identificar Cliente",content:`
        <div class="p-5 space-y-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-gray-500 mb-1.5">Nome *</label>
                    <input type="text" id="apptClientName" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm" value="${V(P.data.clientName)}">
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-500 mb-1.5">Telefone/WhatsApp *</label>
                    <input type="tel" id="apptClientPhone" class="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg text-sm" value="${V(P.data.clientPhone)}">
                </div>
            </div>
        ...
        <div class="p-5 space-y-5">
            ...
            <div id="apptServicesContainer" class="grid grid-cols-2 gap-3 max-h-56 overflow-y-auto">
                ${Jt.map(e=>`<div class="service-card p-3 bg-white rounded-xl border ${P.data.selectedServiceIds.includes(e.id)?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer" data-service-id="${e.id}">
                        <p class="font-semibold text-sm text-gray-800 truncate">${V(e.name)}</p>
        ...
        <div class="p-5 space-y-5">
            ...
            <div id="apptProfessionalContainer" class="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-52 overflow-y-auto professional-step-cards">
                ${ma.map(e=>`<div class="professional-modal-card p-3 bg-white rounded-xl border ${P.data.professionalId===e.id?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer text-center" data-professional-id="${e.id}">
                        <div class="w-10 h-10 rounded-full bg-gray-100 mx-auto flex items-center justify-center font-bold text-sm text-gray-500">${V(e.name).charAt(0)}</div>
                        <p class="text-sm font-semibold mt-2 truncate">${V(e.name.split(" ")[0])}</p>
                    </div>`).join("")}
            </div>
        </div>
        <div class="px-5 py-4 border-t border-gray-100 flex justify-between gap-3">
        ...
        </div>`}}function si(){const e=P.data.date||new Date().toISOString().split("T")[0];return{title:"Data e Horário",content:`
        <div class="p-5 space-y-5">
            <div class="flex items-center gap-3 p-3 bg-indigo-50 rounded-xl">
                <div class="w-9 h-9 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold flex-shrink-0">${V(P.data.clientName).charAt(0)}</div>
                <div class="min-w-0">
                    <p class="font-semibold text-sm text-gray-900 truncate">${V(P.data.clientName)}</p>
                    <p class="text-xs text-gray-500 truncate">${V(P.data.professionalName)}</p>
                </div>
            </div>
            <div>
        ...
        </div>`}}async function Te(e=null,t=!1){const a=document.getElementById("appointmentModal");t||(P={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(s=>s.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],time:e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}),Jt=m.services||[],ma=(m.professionals||[]).filter(s=>s.status==="active");let o;switch(P.step){case 1:o=ti(e);break;case 2:o=ai();break;case 3:o=oi();break;case 4:o=si();break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(s=>s.addEventListener("click",()=>{const r=parseInt(s.dataset.currentStep,10);if(r===1&&(P.data.clientName=a.querySelector("#apptClientName").value.trim(),P.data.clientPhone=a.querySelector("#apptClientPhone").value.trim(),!P.data.clientName))return g("Preencha o nome do cliente.","warning");if(r===2&&P.data.selectedServiceIds.length===0)return g("Selecione um serviço.","warning");if(r===3&&!P.data.professionalId)return g("Escolha um profissional.","warning");Xa(r+1)})),a.querySelectorAll('[data-action="prev-step"]').forEach(s=>s.addEventListener("click",()=>Xa(parseInt(s.dataset.currentStep,10)-1))),a.querySelector('[data-action="close-modal"]')?.addEventListener("click",()=>{a.style.display="none"}),P.step===4&&a.querySelector("#appointmentForm").addEventListener("submit",ri),a.style.display="flex",P.step===2&&a.querySelectorAll(".service-card").forEach(s=>s.addEventListener("click",()=>{const r=a.querySelector("#multiServiceToggle")?.checked,i=s.classList.contains("selected");r||(a.querySelectorAll(".service-card.selected").forEach(l=>l.classList.remove("selected","border-indigo-500","bg-indigo-50")),P.data.selectedServiceIds=[]);const n=s.dataset.serviceId;i?(s.classList.remove("selected","border-indigo-500","bg-indigo-50"),P.data.selectedServiceIds=P.data.selectedServiceIds.filter(l=>l!==n)):(s.classList.add("selected","border-indigo-500","bg-indigo-50"),P.data.selectedServiceIds.push(n))})),P.step===3&&a.querySelectorAll(".professional-modal-card").forEach(s=>s.addEventListener("click",()=>{a.querySelectorAll(".professional-modal-card.selected").forEach(i=>i.classList.remove("selected","border-indigo-500","bg-indigo-50")),s.classList.add("selected","border-indigo-500","bg-indigo-50"),P.data.professionalId=s.dataset.professionalId;const r=ma.find(i=>i.id===s.dataset.professionalId);P.data.professionalName=r?r.name:""})),P.step===1&&a.querySelector("#clientSearchInput")?.addEventListener("input",s=>ni(s.target.value)),P.step===4&&(a.querySelector("#apptDate")?.addEventListener("change",Za),Za(),ii())}async function ri(e){e.preventDefault();const a=e.target.querySelector('button[type="submit"]');if(!P.data.time||!P.data.selectedServiceIds.length||!P.data.professionalId)return g("Selecione horário, serviço e profissional.","warning");a.disabled=!0,a.innerHTML="Aguarde...";const o=P.data.selectedServiceIds.map(l=>{const d=Jt.find(c=>c.id===l);return{id:d.id,name:d.name,price:d.price,duration:d.duration,bufferTime:d.bufferTime||0,photo:d.photo||null}}),[s,r]=P.data.time.split(":"),i=new Date(`${P.data.date}T${s}:${r}:00`),n={establishmentId:m.establishmentId,clientName:P.data.clientName,clientPhone:P.data.clientPhone,services:o,professionalId:P.data.professionalId,professionalName:P.data.professionalName,startTime:i.toISOString(),redeemedReward:P.data.redeemedReward};P.data.id&&(n.id=P.data.id);try{P.data.id?await er(P.data.id,n):await Ks(n),g("Agendamento registrado!","success"),document.getElementById("appointmentModal").style.display="none",ce()}catch(l){g(l.message,"error"),a.disabled=!1,a.textContent="Agendar"}}async function Za(){const e=document.getElementById("availableTimesContainer"),t=document.getElementById("apptTotalDuration");if(!e)return;const a=P.data.selectedServiceIds.reduce((i,n)=>{const l=Jt.find(d=>d.id===n);return i+(l?l.duration+(l.bufferTime||0):0)},0);t&&(t.textContent=`${a} min`);const{professionalId:o,selectedServiceIds:s,date:r}=P.data;if(!o||!s.length||!r){e.innerHTML='<p class="col-span-full text-center text-xs text-gray-400">Selecione serviço e profissional</p>';return}try{let i=await Zs({establishmentId:m.establishmentId,professionalId:o,serviceIds:s,date:r});const n=new Date;if(new Date(r+"T00:00:00").toDateString()===n.toDateString()){const l=n.getHours()*60+n.getMinutes();i=i.filter(d=>{const[c,u]=d.split(":").map(Number);return c*60+u>=l})}e.innerHTML=i.length>0?i.map(l=>`<button type="button" class="p-2 text-sm font-semibold rounded-lg border ${P.data.time===l?"bg-indigo-600 text-white border-indigo-600":"bg-gray-50 text-gray-700 border-gray-200 hover:bg-indigo-50"}" onclick="document.querySelectorAll('#availableTimesContainer button').forEach(b=>{b.classList.remove('bg-indigo-600','text-white','border-indigo-600');b.classList.add('bg-gray-50','text-gray-700','border-gray-200')});this.classList.add('bg-indigo-600','text-white','border-indigo-600');this.classList.remove('bg-gray-50','text-gray-700','border-gray-200');window._selectedTime='${l}';">${l}</button>`).join(""):'<p class="col-span-full text-center text-xs text-gray-400">Sem horários</p>'}catch{e.innerHTML='<p class="col-span-full text-center text-xs text-red-400">Erro</p>'}}function ii(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a}=P.data,{enabled:o,rewards:s}=Pt;if(!o||!t||!s?.length){e.innerHTML="";return}const r=s.filter(i=>a>=i.points);if(!r.length){e.innerHTML='<p class="text-xs text-gray-400">Sem recompensas disponíveis.</p>';return}e.innerHTML=`<div class="border-t border-gray-100 pt-4">
        <p class="text-xs font-semibold text-gray-500 mb-2">Resgate fidelidade (${a} pts)</p>
        ${r.map(i=>`<label class="flex items-center gap-3 p-2 bg-gray-50 rounded-lg mb-1 cursor-pointer"><input type="radio" name="loyaltyReward" value="${V(i.reward)}" data-points="${i.points}" class="accent-indigo-600"><span class="text-sm">${V(i.reward)} (-${i.points} pts)</span></label>`).join("")}
    </div>`,e.querySelectorAll('input[name="loyaltyReward"]').forEach(i=>{i.addEventListener("change",n=>{n.target.checked&&(P.data.redeemedReward={reward:n.target.value,points:parseInt(n.target.dataset.points,10)})})})}async function ni(e){const t=document.getElementById("clientSearchResults");if(!t||e.trim().length<3){t&&(t.innerHTML='<p class="text-xs text-gray-400">Digite pelo menos 3 caracteres...</p>');return}t.innerHTML='<div class="text-center py-3"><div class="w-5 h-5 border-2 border-indigo-200 border-t-indigo-600 rounded-full animate-spin mx-auto"></div></div>';try{const a=await Ia(m.establishmentId,e.trim());if(Go=a,!a.length){t.innerHTML='<p class="text-xs text-gray-400">Nenhum cliente encontrado.</p>';return}t.innerHTML=a.map(o=>`<div class="client-card p-2.5 bg-white rounded-lg border ${P.data.clientName===o.name&&P.data.clientPhone===o.phone?"border-indigo-500 bg-indigo-50":"border-gray-200"} cursor-pointer flex items-center gap-2" data-client-name="${V(o.name)}" data-client-phone="${V(o.phone)}" data-loyalty-points="${o.loyaltyPoints||0}">
                <div class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-500">${V(o.name).charAt(0)}</div>
                <div><p class="text-sm font-semibold text-gray-800">${V(o.name)}</p><p class="text-xs text-gray-500">${V(o.phone)}</p></div>
            </div>`).join(""),t.querySelectorAll(".client-card").forEach(o=>o.addEventListener("click",()=>{P.data.clientName=o.dataset.clientName,P.data.clientPhone=o.dataset.clientPhone,P.data.clientLoyaltyPoints=parseInt(o.dataset.loyaltyPoints||"0",10);const s=Math.min(...(Pt?.rewards||[]).map(r=>r.points));P.data.clientHasRewards=Pt.enabled&&s!==1/0&&P.data.clientLoyaltyPoints>=s,document.getElementById("apptClientName").value=o.dataset.clientName,document.getElementById("apptClientPhone").value=o.dataset.clientPhone,t.querySelectorAll(".client-card").forEach(r=>r.classList.remove("border-indigo-500","bg-indigo-50")),o.classList.add("border-indigo-500","bg-indigo-50")}))}catch{t.innerHTML='<p class="text-xs text-red-400">Erro ao buscar.</p>'}}const li=(e,t=null,a=1,o=12)=>{let s=`/api/comandas/${e}?page=${a}&limit=${o}`;return t&&(s+=`&date=${t}`),I(s)},di=(e,t)=>I(`/api/appointments/${e}/comanda`,{method:"POST",body:JSON.stringify({items:t})}),ci=e=>I("/api/sales",{method:"POST",body:JSON.stringify(e)}),ui=e=>I(`/api/sales/${e}`,{method:"DELETE"}),Gt=e=>I(`/api/products/${e}`),mi=e=>I("/api/products",{method:"POST",body:JSON.stringify(e)}),pi=(e,t)=>I(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),gi=e=>I(`/api/products/${e}`,{method:"DELETE"}),bi=(e,t)=>I(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),fi=({startDate:e,endDate:t,productId:a,categoryId:o,establishmentId:s})=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("productId",a),o&&o!=="all"&&r.append("categoryId",o),s&&r.append("establishmentId",s),I(`/api/products/stock-history/report?${r.toString()}`)},vi=()=>I("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),xi=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),I("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},hi=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),I(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},yi=()=>I("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),wi=e=>I(`/api/cashier/report/${e}`),Ta=e=>I(`/api/packages/${e}`),ki=e=>I("/api/packages",{method:"POST",body:JSON.stringify(e)}),Si=(e,t)=>I(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),$i=e=>I(`/api/packages/${e}`,{method:"DELETE"});let y={allComandas:[],catalog:{services:[],products:[],packages:[]},activeFilter:"atendimento",selectedComandaId:null,viewMode:"items",isCashierOpen:!1,activeCashierSessionId:null,loyaltySettings:null,pendingRedemption:null,paging:{page:1,limit:10,total:0},checkoutState:{payments:[],selectedMethod:"dinheiro",installments:1,amountReceived:"",discount:{type:"real",value:0},discountReason:""},isProcessing:!1},Ie=null,De=null,Ka=null;function Xo(e,t){return function(...a){clearTimeout(Ka),Ka=setTimeout(()=>e.apply(this,a),t)}}async function eo(e,t="stay"){if(!e||!e.id)return;e._localUpdatedAt=Date.now(),e._cachedItems=null,e._hasUnsavedChanges=!1,ut(),t==="checkout"&&(y.viewMode="checkout",y.checkoutState.payments||(y.checkoutState.payments=[]),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.amountReceived="",y.checkoutState.discount.value||(y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason=""),G());const a=document.createElement("div");a.id="saving-overlay",a.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",a.innerHTML=`
    ...
    `,Yt()}function Yt(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),Li()}function Li(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
        ...
        `,r.appendChild($)}),e.innerHTML="",e.appendChild(r),to(t)}function to(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:o}=y.paging,s=Math.ceil((a||0)/o);if(s===0)return;const r=document.createElement("div");r.className="flex gap-2 justify-center items-center w-full",r.innerHTML=`
    ...
    `,e.appendChild(r),r.querySelectorAll("button[data-page]").forEach(i=>{i.onclick=n=>{n.stopPropagation();const l=parseInt(i.dataset.page,10);l>0&&l<=s&&(y.paging.page=l,me())}})}function G(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(v=>v.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){Ci(t,e);return}const a=`
    ...
    `;e.innerHTML=`
        ...
        ${s?"":b}
    `,!s&&(t.clientId||t.clientName)&&Ti(t,e.querySelector("#loyalty-container"))}function Ci(e,t){const o=ke(e).reduce((p,f)=>p+Number(f.price||0)*(f.quantity||1),0),s=y.checkoutState,r=s.discount||{type:"real",value:0};let i=0;r.type==="percent"?i=o*r.value/100:i=r.value,i>o&&(i=o);const n=o-i,l=s.payments.reduce((p,f)=>p+f.value,0),d=Math.max(0,n-l);(!s.amountReceived||d>0)&&(s.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;const u=()=>{const p=y.checkoutState.discount.type,f=y.checkoutState.discount.value;let b=p==="percent"?o*f/100:f;b>o&&(b=o);const v=o-b,h=y.checkoutState.payments.reduce((L,A)=>L+A.value,0),$=Math.max(0,v-h),k=t.querySelector("#checkout-total-display");k&&(k.textContent=`R$ ${v.toFixed(2)}`);const E=t.querySelector("#checkout-status-msg");E&&($<=.01?E.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':E.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${$.toFixed(2)}</span></p>`);const T=t.querySelector("#checkout-amount");T&&$>0&&document.activeElement!==T&&(T.value=$.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",p=>{const f=parseFloat(p.target.value)||0;y.checkoutState.discount.value=f,u()}),t.querySelector("#discount-type")?.addEventListener("change",p=>{y.checkoutState.discount.type=p.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",p=>{y.checkoutState.discountReason=p.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",p=>{y.checkoutState.amountReceived=p.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",p=>{y.checkoutState.installments=parseInt(p.target.value,10)})}async function Ti(e,t){if(!t)return;const a=y.loyaltySettings;if(!a||!a.enabled)return;let o=null;try{if(e.clientId)o=await Vo(m.establishmentId,e.clientId);else if(e.clientName){const n=await Ia(m.establishmentId,e.clientName,1);n&&n.length>0&&(o=n[0])}}catch(n){console.warn("Erro ao buscar dados de fidelidade",n)}if(!o||o.loyaltyPoints===void 0)return;const s=Number(o.loyaltyPoints)||0,i=(a.tiers||a.rewards||[]).filter(n=>{const l=Number(n.costPoints||n.points||0);return l>0&&s>=l});if(i.length>0){const n=document.createElement("div");n.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",n.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>Di(i,e),n.appendChild(l),t.innerHTML="",t.appendChild(n)}}function Di(e,t){const a=`
        <div class="space-y-4">
    ...
    `,{modalElement:o,close:s}=se({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});o.addEventListener("click",r=>{const i=r.target.closest('[data-action="select-reward"]');if(i){const n=i.dataset.rewardId,l=e.find(d=>d.id&&d.id==n||(d.name||d.reward)==n);l&&(Pi(l,t),s())}})}async function Pi(e,t){const a=Number(e.costPoints||e.points||0),o=e.name||e.reward,s=e.type||"money";if(s==="money"){const l=parseFloat(e.discount)||0;if(l<=0){g("Erro","O valor do desconto configurado é inválido.","error");return}y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,y.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:"money"},g("Sucesso",`Prémio "${o}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),G();return}const r=ke(t),i=e.itemId?String(e.itemId):null;if(!i){g("Erro de Configuração",`O prémio "${o}" não tem um item vinculado nas configurações.`,"error");return}const n=r.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return s==="service"?d===i||c===i:s==="product"?d===i||u===i:s==="package"?d===i:!1});if(n){let l=parseFloat(e.discount);(!l||l<=0)&&(l=parseFloat(n.price||0)),y.checkoutState.discount={type:"real",value:l},y.checkoutState.discountReason=`Resgate Fidelidade: ${o}`,y.pendingRedemption={rewardId:e.id||null,name:o,cost:a,type:s,appliedToItemId:n.id},g("Sucesso",`Prémio "${o}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),G()}else g("Item Não Encontrado",`Para resgatar o prémio "${o}", o ${s==="service"?"serviço":s==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function Bi(){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=se({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const s=e.querySelector("#add-item-content");s.innerHTML=`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{r>1&&(r--,n())},document.getElementById("quantity-plus-btn").onclick=()=>{r++,n()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Ko(s,r),t()}};e.addEventListener("click",s=>{const r=s.target.closest('[data-action="select-item-for-quantity"]'),i=s.target.closest('[data-action="back-to-catalog"]');if(r){const{itemType:n,itemId:l}=r.dataset,c=(y.catalog[n+"s"]||[]).find(u=>u.id===l);c&&o({...c,type:n})}else i&&a()}),a()}async function pa(e=null){if(!y.isCashierOpen)return g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");if(!m.professionals||m.professionals.length===0)try{m.professionals=await re(m.establishmentId)}catch{return g("Erro","Não foi possível carregar profissionais.","error")}const a=`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Ai)}async function Ai(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),s=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!s)return g("Erro","Nome e Telefone são obrigatórios.","error");try{const r=await Jr(m.establishmentId,s);if(r)g("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",pa(r);else{const i=await _o({establishmentId:m.establishmentId,name:a.value,phone:s});g("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",pa(i)}}catch(r){g("Erro",r.message,"error")}}async function qi(){const e=`
    ...
    `,{modalElement:t}=se({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const o=parseFloat(document.getElementById("initial-amount").value);if(isNaN(o)||o<0)return g("Valor Inválido","Insira um valor válido.","error");try{const s=await xi({establishmentId:m.establishmentId,initialAmount:parseFloat(o.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=s.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${o.toFixed(2)})`,"success"),Yt(),await me()}catch(s){g("Erro",`Falha ao abrir caixa: ${s.message}`,"error")}})}async function Ri(){const e=y.activeCashierSessionId;if(e)try{const t=await wi(e),a=`
        ...
        `,{modalElement:o}=se({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});o.querySelector("#close-cashier-form").addEventListener("submit",async s=>{s.preventDefault();const r=parseFloat(document.getElementById("final-amount").value);if(isNaN(r)||r<0)return g("Valor Inválido","Insira um valor final válido.","error");try{await hi(e,r),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Yt(),await me(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(i){g("Erro",`Falha ao fechar caixa: ${i.message}`,"error")}})}catch(t){g("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Ni(e){if(y.activeFilter===e)return;y.activeFilter=e,y.paging.page=1,document.querySelectorAll(".filter-btn").forEach(a=>a.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),Pe(),y.selectedComandaId=null,y.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await me(),G()}function Zo(e){y.selectedComandaId=e,y.viewMode="items",y.pendingRedemption=null,y.checkoutState.discount={type:"real",value:0},y.checkoutState.discountReason="",ut(),Ei(),G()}async function Ko(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),g("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const o=parseFloat(e.price)||0,s=Array(t).fill(0).map(()=>{const r={id:String(e.id),name:e.name,price:o,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(r.productId=r.id,r.product_id=r.id):e.type==="service"&&(r.serviceId=r.id,r.service_id=r.id),r});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...s),a._cachedItems=null,a._hasUnsavedChanges=!0,G()}async function ao(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;let o=!1,s=(a.comandaItems||[]).findIndex(r=>r.id==e&&r.type===t);s>-1&&(a.comandaItems.splice(s,1),o=!0),o&&(a._cachedItems=null,a._hasUnsavedChanges=!0,G())}async function ji(e){if(y.isProcessing)return;const t=ke(e),a=t.reduce((h,$)=>h+Number($.price||0)*($.quantity||1),0),o=y.checkoutState.discount||{type:"real",value:0};let s=o.type==="percent"?a*o.value/100:o.value;s>a&&(s=a);const r=a-s,{payments:i}=y.checkoutState,n=i.reduce((h,$)=>h+$.value,0),l=r-n;if(l>.01){if(!await U("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;i.push({method:"fiado",value:l,installments:1})}y.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const p=y.loyaltySettings;p&&p.enabled&&(u=parseInt(p.pointsPerVisit||1,10),console.log(`Fidelidade: Cliente ganhou ${u} pontos fixos pela visita.`));const f={...o,reason:y.checkoutState.discountReason||""},b={payments:i,totalAmount:Number(r),items:c,cashierSessionId:y.activeCashierSessionId,loyaltyPointsEarned:u,discount:f,loyaltyRedemption:y.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(v);try{d?await ar(e.id,b):(b.establishmentId=m.establishmentId,b.clientId=e.clientId,b.clientName=e.clientName,b.professionalId=e.professionalId,e.clientPhone&&(b.clientPhone=e.clientPhone),await ci(b));let h="Venda finalizada com sucesso!";u>0&&(h+=` Cliente ganhou ${u} pontos!`),g("Sucesso!",h,"success"),Pe(),y.selectedComandaId=null,y.viewMode="items",y.pendingRedemption=null,await me()}catch(h){g("Erro no Checkout",h.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),y.isProcessing=!1}}async function Fi(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,o=t.value,s=document.getElementById("client-search").value,r=t.dataset.phone||"";if(!o)return g("Erro","Selecione um cliente válido.","error");const i=m.professionals.find(l=>l.id===a);if(!i)return g("Erro","Selecione um profissional válido.","error");const n={id:`temp-${Date.now()}`,type:"walk-in",clientId:o,clientName:s.split("(")[0].trim(),clientPhone:r,professionalId:i.id,professionalName:i.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(n),y.selectedComandaId=n.id,y.viewMode="items",document.getElementById("genericModal").style.display="none",Zo(n.id)}async function me(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=y.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=vi(),o=li(m.establishmentId,t,y.paging.page,y.paging.limit),s=we(m.establishmentId),[r,i,n]=await Promise.all([a,o,s]);if(y.isCashierOpen=!!r,y.activeCashierSessionId=r?r.id:null,Yt(),n&&n.loyaltyProgram&&(y.loyaltySettings=n.loyaltyProgram),!y.isCashierOpen&&y.activeFilter==="atendimento"){ut(),G();return}if(y.allComandas=i.data||i,y.paging.total=i.total||i.length,y.catalog.services.length===0){const[l,d,c,u]=await Promise.all([$e(m.establishmentId),Gt(m.establishmentId),Ta(m.establishmentId),re(m.establishmentId)]);y.catalog={services:l,products:d,packages:c},m.professionals=u}ut(),G()}catch(a){g("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function Hi(e={}){De=document.getElementById("content"),y.selectedComandaId=e.selectedAppointmentId||null,y.viewMode="items",Ii(),Ie&&(De.removeEventListener("click",Ie),De.removeEventListener("change",Ie)),Ie=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&y.activeFilter==="finalizadas"){y.paging.page=1,await me();return}if(a){if(a.matches("[data-filter]"))Ni(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}Zo(a.dataset.comandaId)}else if(a.matches("[data-action]")){const s=a.dataset.action,r=a.dataset.id||y.selectedComandaId,i=y.allComandas.find(n=>n.id===r);switch(s){case"back-to-list":Pe(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(k=>k.classList.remove("selected")),G();break;case"new-sale":pa();break;case"add-item":Bi();break;case"open-cashier":qi();break;case"close-cashier":await Ri();break;case"view-sales-report":Y("sales-report-section");break;case"go-to-checkout":await eo(i,"checkout");break;case"back-to-items":y.viewMode="items",G();break;case"save-comanda":await eo(i,"stay");break;case"select-method":y.checkoutState.selectedMethod=a.dataset.method,y.checkoutState.installments=1,G();break;case"add-payment-checkout":const n=document.getElementById("checkout-amount");let l=parseFloat(n.value);const c=ke(i).reduce((k,E)=>k+(E.price||0),0),u=y.checkoutState.discount||{type:"real",value:0};let p=u.type==="percent"?c*u.value/100:u.value;p>c&&(p=c);const f=c-p,b=y.checkoutState.payments.reduce((k,E)=>k+E.value,0),v=f-b;if(isNaN(l)||l<=0){g("Valor inválido","Insira um valor maior que zero.","error");break}if(l>v+.05){g("Valor inválido","Valor excede o restante.","error");break}const h={method:y.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(y.checkoutState.selectedMethod)&&y.checkoutState.installments>1&&(h.installments=y.checkoutState.installments),y.checkoutState.payments.push(h),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.installments=1,y.checkoutState.amountReceived="",G();break;case"remove-payment-checkout":const $=parseInt(a.dataset.index,10);y.checkoutState.payments.splice($,1),G();break;case"finalize-checkout":await ji(i);break;case"increase-qty":{const k=a.dataset.itemId,E=a.dataset.itemType;if(!k||k==="undefined"||k==="null"){g("Erro","Item inválido para adição.","error");return}let L=ke(i).find(F=>F.id==k&&F.type===E);L||(L=(y.catalog[E+"s"]||[]).find(C=>C.id==k));const A=L?{id:L.id,name:L.name,price:Number(L.price),type:L.type}:{id:k,name:"Item Indisponível",price:0,type:E};await Ko(A,1);break}case"decrease-qty":{await ao(a.dataset.itemId,a.dataset.itemType);break}case"remove-item":await ao(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await U("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await tr(r);const E=y.allComandas.findIndex(T=>T.id===r);E!==-1&&(y.allComandas[E].status="confirmed",delete y.allComandas[E].transaction),y.selectedComandaId=null,Pe(),await me(),g("Sucesso!","Comanda reaberta.","success")}catch(E){g("Erro",E.message,"error")}break}case"go-to-appointment":{const k=a.dataset.id,E=a.dataset.date;Y("agenda-section",{scrollToAppointmentId:k,targetDate:new Date(E)});break}case"delete-walk-in":{if(await U("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(r.startsWith("temp-"))y.allComandas=y.allComandas.filter(E=>E.id!==r),y.selectedComandaId=null,ut(),G(),Pe();else try{await ui(r),g("Sucesso","Venda excluída.","success"),y.selectedComandaId=null,Pe(),await me()}catch(E){g("Erro",E.message,"error")}break}}}}},De.addEventListener("click",Ie),De.addEventListener("change",Ie),e.initialFilter&&(y.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${y.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",y.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await me()}const Qt=e=>I(`/api/financial/natures/${e}`),Oi=e=>I("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),zi=e=>I(`/api/financial/natures/${e}`,{method:"DELETE"}),Da=e=>I(`/api/financial/cost-centers/${e}`),Vi=e=>I("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),Ui=e=>I(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),es=(e,t)=>I(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),ts=(e,t={})=>{let a=`/api/financial/${e}`;const o=new URLSearchParams;t.establishmentId&&o.append("establishmentId",t.establishmentId),t.startDate&&o.append("startDate",t.startDate),t.endDate&&o.append("endDate",t.endDate),t.natureId&&o.append("natureId",t.natureId),t.costCenterId&&o.append("costCenterId",t.costCenterId),t.status&&o.append("status",t.status);const s=o.toString();return s&&(a+=`?${s}`),I(a)},as=(e,t,a)=>I(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),os=(e,t)=>I(`/api/financial/${e}/${t}`,{method:"DELETE"}),ss=(e,t)=>{const a=t.map(o=>I(`/api/financial/${e}/${o}`,{method:"DELETE"}));return Promise.all(a)},rs=(e,t,a)=>I(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),_i=e=>es("payables",e),is=e=>ts("payables",e),Wi=(e,t)=>as("payables",e,t),Ji=e=>os("payables",e),Gi=(e,t)=>rs("payables",e,t),Yi=e=>es("receivables",e),ns=e=>ts("receivables",e),Qi=(e,t)=>as("receivables",e,t),Xi=e=>os("receivables",e),Zi=(e,t)=>rs("receivables",e,t),ga=document.getElementById("content");let ee={};const xt={creditRealized:"#10b981",creditProvisioned:"#6ee7b7",debitRealized:"#ef4444",debitProvisioned:"#fca5a5"},Ki=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],D={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],naturesList:[],rawPayables:[],rawReceivables:[],processedDRE:null,processedCashFlow:null,processedDailyRevenue:null,backendData:null,appointmentsData:[],currentTab:"dashboards",isFilterOpen:!1};async function en(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function tn(){ga.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)] w-full">
        ...
        </div>`;try{await en();const[e,t,a]=await Promise.all([re(m.establishmentId),Mr(m.establishmentId).catch(()=>[]),Qt(m.establishmentId).catch(()=>[])]);D.professionalsList=e||[],D.costCentersList=t||[],D.naturesList=a||[],an(),await ls()}catch(e){console.error("Erro no loadReportsPage:",e),ga.innerHTML=`
            ...
            </div>`}}function an(){const e=D.professionalsList.map(a=>`<option value="${a.id}">${x(a.name)}</option>`).join(""),t=D.costCentersList.map(a=>`<option value="${a.id}">${x(a.name)}</option>`).join("");ga.innerHTML=`
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex-1 min-w-0 mr-2">
                            ...
                            <p class="text-[10px] md:text-xs text-gray-500 mt-0.5 ml-1 truncate" id="date-range-display">
                                ${Bt(D.startDate)} até ${Bt(D.endDate)}
                            </p>
                        </div>
    ...
    `,document.getElementById("toggle-filters-btn").onclick=oo,document.getElementById("btn-apply-filters").onclick=()=>{on(),oo()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{D.currentTab=a.dataset.tab,so(),ds(),window.scrollTo({top:0,behavior:"smooth"})}}),so()}function oo(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");D.isFilterOpen=!D.isFilterOpen,D.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function so(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===D.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Bt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function on(){D.startDate=document.getElementById("report-start").value,D.endDate=document.getElementById("report-end").value,D.selectedProfessional=document.getElementById("report-prof").value,D.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Bt(D.startDate)} até ${Bt(D.endDate)}`,await ls()}function sn(e,t){const a=new Map;D.naturesList.forEach(s=>a.set(s.id,s.name));const o={revenues:{},expenses:{},totalRevenues:0,totalExpenses:0,netResult:0};return t.forEach(s=>{if(s.status==="paid"){const r=s.naturezaId?a.get(s.naturezaId)||"Outras Receitas":"Geral";o.revenues[r]||(o.revenues[r]=0),o.revenues[r]+=s.amount,o.totalRevenues+=s.amount}}),e.forEach(s=>{if(s.status==="paid"){const r=s.naturezaId?a.get(s.naturezaId)||"Outras Despesas":"Geral";o.expenses[r]||(o.expenses[r]=0),o.expenses[r]+=s.amount,o.totalExpenses+=s.amount}}),o.netResult=o.totalRevenues-o.totalExpenses,o}function rn(e,t){const a={},o=d=>{a[d]||(a[d]={realizedCredit:0,provisionedCredit:0,realizedDebit:0,provisionedDebit:0})};let s=new Date(D.startDate);const r=new Date(D.endDate);for(;s<=r;)o(s.toISOString().split("T")[0]),s.setDate(s.getDate()+1);t.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedCredit+=d.amount:a[c].provisionedCredit+=d.amount)}),e.forEach(d=>{const c=d.dueDate.split("T")[0];a[c]&&(d.status==="paid"?a[c].realizedDebit+=d.amount:a[c].provisionedDebit+=d.amount)});const i=Object.keys(a).sort(),n=[];let l=0;return i.forEach(d=>{const c=a[d],u=c.realizedCredit+c.provisionedCredit-(c.realizedDebit+c.provisionedDebit);l+=u,n.push(l)}),{labels:i,realizedCredit:i.map(d=>a[d].realizedCredit),provisionedCredit:i.map(d=>a[d].provisionedCredit),realizedDebit:i.map(d=>a[d].realizedDebit*-1),provisionedDebit:i.map(d=>a[d].provisionedDebit*-1),balance:n}}function nn(e){const t={};let a=new Date(D.startDate);const o=new Date(D.endDate);for(;a<=o;)t[a.toISOString().split("T")[0]]=0,a.setDate(a.getDate()+1);e.forEach(i=>{if(i.status==="paid"){const n=i.dueDate.split("T")[0];t.hasOwnProperty(n)&&(t[n]+=i.amount)}});const s=Object.keys(t).sort(),r=s.map(i=>t[i]);return{labels:s,data:r}}function ln(e){const t=e.length;if(t<2)return{trendData:Array(t).fill(e[0]||0),color:"#9ca3af"};let a=0,o=0,s=0,r=0;for(let c=0;c<t;c++)a+=c,o+=e[c],s+=c*e[c],r+=c*c;const i=(t*s-a*o)/(t*r-a*a),n=(o-i*a)/t,l=[];for(let c=0;c<t;c++)l.push(i*c+n);const d=i>=0?"#10b981":"#ef4444";return{trendData:l,color:d}}async function ls(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20 w-full"><div class="loader border-t-indigo-600"></div></div>';try{const t={startDate:D.startDate,endDate:D.endDate,establishmentId:m.establishmentId};D.selectedCostCenter!=="all"&&(t.costCenterId=D.selectedCostCenter);const[a,o]=await Promise.all([is(t),ns(t)]);D.rawPayables=a.entries||[],D.rawReceivables=o.entries||[];const s=await Br(D.startDate,D.endDate,D.selectedProfessional,D.selectedCostCenter).catch(()=>({charts:{professionals:{labels:[],data:[]},salesMonthly:{labels:[],data:[]}}}));D.backendData=s,D.processedDRE=sn(D.rawPayables,D.rawReceivables),D.processedCashFlow=rn(D.rawPayables,D.rawReceivables),D.processedDailyRevenue=nn(D.rawReceivables);const r=new Date(D.startDate+"T00:00:00").toISOString(),i=new Date(D.endDate+"T23:59:59").toISOString(),n=D.selectedProfessional==="all"?null:D.selectedProfessional,l=await No(m.establishmentId,r,i,n).catch(()=>[]);D.appointmentsData=Array.isArray(l)?l:[],ds()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ds(){const e=document.getElementById("report-content");switch(D.currentTab){case"dashboards":dn(e);break;case"appointments":cn(e);break;case"dre":un(e);break}}function dn(e){const t=D.processedDRE,a=D.processedDailyRevenue,o=D.backendData.charts?.salesMonthly||{labels:[],data:[]},s=D.backendData.charts?.professionals||{labels:[],data:[]};e.innerHTML=`
    ...
    `,pn("chart-appointments-daily",c,u,p),document.querySelectorAll(".app-chart-toggle").forEach(b=>{b.addEventListener("change",v=>{const h=ee["chart-appointments-daily"];if(h){const $=parseInt(v.target.dataset.dataset);h.setDatasetVisibility($,v.target.checked),h.update()}})})}function un(e){const t=D.processedDRE;if(!t)return;const a=t.totalRevenues,o=(n,l,d,c=!1)=>{const u=a>0?l/a*100:0,p=c?"- ":"";return`
    ...
    `}function mn(e,t){const a=document.getElementById(e);if(!a)return;const o=a.getContext("2d");ee[e]&&ee[e].destroy();const s=o.createLinearGradient(0,0,0,400);s.addColorStop(0,"rgba(59, 130, 246, 0.4)"),s.addColorStop(1,"rgba(59, 130, 246, 0.0)");const r=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));ee[e]=new Chart(o,{type:"bar",data:{labels:r,datasets:[{label:"Créd. Realizado",data:t.realizedCredit,backgroundColor:xt.creditRealized,borderRadius:3,barPercentage:.7,order:1},{label:"Créd. Provisionado",data:t.provisionedCredit,backgroundColor:xt.creditProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:2},{label:"Déb. Realizado",data:t.realizedDebit,backgroundColor:xt.debitRealized,borderRadius:3,barPercentage:.7,order:3},{label:"Déb. Provisionado",data:t.provisionedDebit,backgroundColor:xt.debitProvisioned,borderRadius:3,borderWidth:1,borderColor:"#fff",borderDash:[5,5],barPercentage:.7,order:4},{label:"Saldo Acumulado",data:t.balance,type:"line",borderColor:"#3b82f6",backgroundColor:s,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!0,tension:.4,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10,callbacks:{label:function(i){let n=i.dataset.label||"";return n&&(n+=": "),i.parsed.y!==null&&(n+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(Math.abs(i.parsed.y))),n}}}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{size:10}}},y:{stacked:!0,display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(Math.abs(i)),font:{size:10}}}}}})}function pn(e,t,a,o){const s=document.getElementById(e);if(!s)return;const r=s.getContext("2d");ee[e]&&ee[e].destroy();const i=t.map(n=>n.split("-").reverse().slice(0,2).join("/"));ee[e]=new Chart(r,{type:"bar",data:{labels:i,datasets:[{label:"Realizados",data:a,backgroundColor:"#4f46e5",borderRadius:3,barPercentage:.6,order:1},{label:"Cancelados",data:o,backgroundColor:"#ef4444",borderRadius:3,barPercentage:.6,order:2}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function ro(e,t,a,o){const s=document.getElementById(e);if(!s)return;const r=s.getContext("2d");ee[e]&&ee[e].destroy();const{trendData:i,color:n}=ln(o),l=i.map((u,p)=>p===i.length-1?"triangle":"circle"),d=i.map((u,p)=>p===i.length-1?6:3),c=i.map((u,p)=>p===i.length-1&&n==="#ef4444"?180:0);ee[e]=new Chart(r,{type:"bar",data:{labels:a,datasets:[{label:t,data:o,backgroundColor:"#4f46e5",borderRadius:4,order:1},{label:"Tendência",data:i,type:"line",borderColor:n,borderWidth:3,pointStyle:l,pointRadius:d,pointRotation:c,pointBackgroundColor:"#fff",pointBorderColor:n,pointBorderWidth:2,pointHoverRadius:8,hitRadius:30,fill:!1,tension:0,order:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9},callback:u=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(u)}}}}})}function gn(e,t,a,o,s,r){const i=document.getElementById(e);if(!i)return;const n=i.getContext("2d");ee[e]&&ee[e].destroy(),new Chart(n,{type:t,data:{labels:o,datasets:[{label:a,data:s,backgroundColor:r,borderColor:Array.isArray(r)?"#fff":r,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:{}}})}const Xt=(e,t="products")=>I(`/api/${t}/categories/${e}`),cs=(e,t="products")=>I(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),us=(e,t="products")=>I(`/api/${t}/categories/${e}`,{method:"DELETE"}),bn="audit_logs",de=async(e,t,a,o,s,r=null)=>{try{if(!t)return;await Mo(Vt(pe,bn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:o,description:s,details:r,timestamp:new Date})}catch(i){console.error("Falha silenciosa ao registar log:",i)}},ve=document.getElementById("content");let ge=null,tt="services",he="all",at=[];function ze(){const e=oe.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function fn(e){e.preventDefault();const t=e.target.closest("#categoryForm"),a=t.querySelector("#categoryName"),o=a.value;if(!o)return;const s=t.querySelector('button[type="submit"]');s.disabled=!0,s.textContent="...";try{const r=at.reduce((i,n)=>(i.push(n.id),n.branches&&n.branches.forEach(l=>i.push(l.id)),i),[]);r.length===0&&r.push(m.establishmentId),await cs({establishmentId:m.establishmentId,name:o,accessibleIn:r},"services"),de(m.establishmentId,ze(),"Categorias (Serviços)","Criou",`Criou categoria: ${o}`),a.value="",g("Sucesso","Categoria criada!","success"),await Pa(),await bt()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}finally{s.disabled=!1,s.textContent="Adicionar"}}async function vn(e){if(await U("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await us(e,"services"),de(m.establishmentId,ze(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Pa(),await bt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Pa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Xt(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function xn(){se({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",fn),t.addEventListener("click",o=>{const s=o.target.closest('button[data-action="delete-category"]');s&&(o.preventDefault(),vn(s.dataset.id))}))}Pa()}function hn(e=[]){if(!at||at.length===0)return`
            ...
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return at.forEach(a=>{const o=e.includes(a.id)||e.length===0&&a.id===m.establishmentId;t+=`
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[85vh] my-auto">
        <form id="serviceForm">
            ...
            `}).join(""),v.querySelectorAll('input[type="checkbox"]').forEach(T=>{T.addEventListener("change",L=>{const A=L.target.closest(".professional-commission-row");A.querySelector('input[type="number"]').disabled=!L.target.checked,A.classList.toggle("bg-blue-50",L.target.checked)})})),b();const h=t.querySelector("#serviceForm"),$=t.querySelector("#servicePhotoInput"),k=t.querySelector("#servicePhotoPreview"),E=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>$.click()),$.onchange=async()=>{const T=$.files[0];if(T){k.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const L=await Jo(T,800,800,.8);if(L.length*3/4>1e3*1024)throw new Error("Imagem muito grande.");k.src=L,E.value=L}catch(L){g("Erro de Imagem",L.message,"error"),k.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",E.value=e?.photo||""}}},h.addEventListener("submit",yn)}function ot(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",o=new Map((m.serviceCategories||[]).map(r=>[r.id,r.name]));let s=(m.services||[]).filter(Boolean);if(he!=="all"){const r=he==="active";s=s.filter(i=>i.active!==!1===r)}s=s.filter(r=>{const i=r.name.toLowerCase().includes(t),n=a==="all"||r.categoryId===a;return i&&n}),e.innerHTML="",s.length>0?s.forEach(r=>{const i=document.createElement("div"),n=JSON.stringify(r).replace(/'/g,"&apos;");i.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:border-indigo-300 border border-transparent ${r.active!==!1?"opacity-100":"opacity-60 bg-gray-100"} sm:flex-col`,i.dataset.action="edit-service",i.dataset.service=n;const l=x(r.name),d=x(o.get(r.categoryId)||"Sem Categoria"),c=r.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(r.name.charAt(0))}`;i.innerHTML=`
                ...
                </div>`,e.appendChild(i)}):e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum serviço encontrado.</p>'}function Ba(){const e={active:0,inactive:0,total:0},t=(m.services||[]).filter(Boolean);t.forEach(i=>{i.active===!1?e.inactive++:e.active++}),e.total=t.length;const a=document.getElementById("indicator-total"),o=document.getElementById("indicator-active"),s=document.getElementById("indicator-inactive"),r=document.getElementById("indicator-popular");a&&(a.textContent=e.total),o&&(o.textContent=e.active),s&&(s.textContent=e.inactive),r&&(m.mostPopularService&&m.mostPopularService.name!=="N/A"?(r.textContent=x(m.mostPopularService.name),r.closest(".indicator-card").title=`${m.mostPopularService.name} (${m.mostPopularService.count} agendamentos)`):r.textContent="Nenhum agendado")}function wn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${x(a.name)}</option>`)),Ba(),ot()}function kn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function bt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,o,s,r]=await Promise.all([$e(m.establishmentId),re(m.establishmentId),Xt(m.establishmentId,"services"),Hr(m.establishmentId),Ue()]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(o||[]).filter(Boolean),m.mostPopularService=s||{name:"N/A",count:0},at=r?.matrizes||[],m.services.forEach(i=>{i.active===void 0&&(i.active=!0)}),ms(tt)}catch(t){e&&(e.innerHTML='<p class="text-red-500 text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function ms(e){if(document.getElementById("services-content-container")){if(tt===e&&document.getElementById("services-content-container").children.length>1){tt==="services"&&(Ba(),ot());return}tt=e,he="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?wn():e==="reports"&&kn()}}function Sn(){ge&&(ve.removeEventListener("click",ge),ve.removeEventListener("input",ge),ve.removeEventListener("change",ge)),ge=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const s=t.closest('[data-action="toggle-service-status"]'),r=s.dataset.id,i=s.checked;try{await Fr(r,i);const n=m.services.findIndex(l=>l.id===r);n>-1&&(m.services[n].active=i),de(m.establishmentId,ze(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${r}) para ${i?"Ativo":"Inativo"}`),ot(),Ba()}catch(n){g("Erro",`Não foi possível atualizar o status: ${n.message}`,"error"),s.checked=!i}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){ot();return}if(!a)return;if(a.hasAttribute("data-view")){ms(a.dataset.view);return}switch(a.dataset.action){case"new-service":io();break;case"edit-service":const s=JSON.parse(a.dataset.service);io(s);break;case"manage-categories":xn();break;case"filter-service":const r=a.dataset.filterType;if(r==="popular")return;he=r==="total"?"all":r,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(i=>{const n=i.dataset.filterType,d=n===he||n==="total"&&he==="all";i.classList.toggle("ring-2",d),i.classList.toggle("ring-indigo-500",d),i.classList.toggle("shadow-md",d),i.classList.toggle("bg-white",!d)}),ot();break}},ve.addEventListener("click",ge),ve.addEventListener("input",ge),ve.addEventListener("change",ge)}async function $n(){ve.innerHTML=`
        ...
        </div>`,Sn(),tt="services",he="all",await bt()}const Zt="suppliers",Ma=async e=>{try{const t=Ao(Vt(pe,Zt),qo("establishmentId","==",e)),a=await Vs(t),o=[];return a.forEach(s=>{o.push({id:s.id,...s.data()})}),o}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},En=async e=>{try{return{id:(await Mo(Vt(pe,Zt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},In=async(e,t)=>{try{const a=gt(pe,Zt,e);return await ka(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Ln=async e=>{try{const t=gt(pe,Zt,e);return await Us(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},fe=document.getElementById("content");let be=null,st="products",ue="all";async function Cn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await cs({establishmentId:m.establishmentId,name:o},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Aa(),await ft()}catch(s){g("Erro",`Não foi possível criar a categoria: ${s.message}`,"error")}}async function Tn(e){if(await U("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await us(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Aa(),await ft()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Aa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Xt(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${x(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function Dn(){se({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
        ...
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                `).join("")):(M.classList.remove("hidden"),M.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else M.classList.add("hidden");r.size>0?(q.innerHTML="",r.forEach(O=>{const R=o.find(_=>_.id===O);R&&(q.innerHTML+=`
                    ...
                    `)})):q.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};E.querySelector("#modalSupplierSearch").addEventListener("input",T),E.addEventListener("click",C=>{const M=C.target.closest("[data-add-supplier]");if(M){const H=M.dataset.addSupplier;r.add(H),E.querySelector("#modalSupplierSearch").value="",T()}const q=C.target.closest("[data-remove-supplier]");if(q){const H=q.dataset.removeSupplier;r.delete(H),T()}}),T(),E.addEventListener("click",async C=>{const M=C.target.closest("button[data-action]");if(!M)return;const q=M.dataset.action,H=E.querySelector("#productId").value;if(q==="close-modal"&&(E.style.display="none"),q==="delete-product"){if(!H)return;E.style.display="none",await Pn(H)}if(q==="save-product-modal"){const O=E.querySelector("#productForm");if(O){if(!O.querySelector("#productName").value||!O.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const R=M.closest('button[data-action="save-product-modal"]');R.disabled=!0,R.textContent="A salvar...";try{await Bn(O)}catch(_){g("Erro",`Falha ao salvar: ${_.message}`,"error"),R.disabled=!1,R.textContent="Salvar Alterações"}}}if(q==="adjust-stock-modal"){C.preventDefault();const O=E.querySelector("#stockAdjustmentAmount"),R=E.querySelector("#stockAdjustmentReason"),_=parseInt(O.value,10),Ee=parseInt(M.dataset.change,10);if(!_||_<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const ea=_*Ee,Bs=R.value||(ea>0?"Entrada manual":"Saída manual");try{await bi(H,{change:ea,reason:Bs});const We=m.products.findIndex(Je=>Je.id===H);if(We>-1){const Je=m.products[We].currentStock+ea;m.products[We].currentStock=Je,E.querySelector("#currentStockDisplay").textContent=Je,E.querySelector("#productCurrentStock").value=Je,O.value="",R.value="",g("Sucesso","Estoque atualizado!","success"),qa(),mt()}}catch(We){g("Erro de Stock",We.message,"error")}}});const L=E.querySelectorAll(".tab-btn"),A=E.querySelectorAll(".tab-content");L.forEach(C=>{C.addEventListener("click",M=>{M.preventDefault(),L.forEach(q=>{q.classList.remove("border-indigo-500","text-indigo-600"),q.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),C.classList.add("border-indigo-500","text-indigo-600"),C.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),A.forEach(q=>q.classList.add("hidden")),document.getElementById(`tab-content-${C.dataset.tab}`).classList.remove("hidden")})});const F=E.querySelector("#productPhotoInput");E.querySelector("#productPhotoButton").addEventListener("click",()=>F.click()),F.onchange=async()=>{const C=F.files[0];if(!C)return;const M=E.querySelector("#productPhotoPreview"),q=E.querySelector("#productPhotoBase64");M.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const H=await no(C,800,800,"image/jpeg",.8),R=H.length*3/4,_=1e3*1024;if(R>_)throw new Error("A imagem é muito grande mesmo após a compressão.");M.src=H,q.value=H}catch(H){console.error("Erro ao processar imagem:",H),g("Erro de Imagem",H.message||"Não foi possível processar a imagem.","error"),M.src=$,q.value=k,F.value=""}},E.style.display="flex"}function Mn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${x(a.name)}</option>`)),qa(),mt()}function An(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const o=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const s=document.getElementById("productFilterReport"),r=document.getElementById("categoryFilterReport");s&&m.products&&(s.innerHTML+=m.products.map(i=>`<option value="${i.id}">${x(i.name)}</option>`).join("")),r&&m.categories&&(r.innerHTML+=m.categories.map(i=>`<option value="${i.id}">${x(i.name)}</option>`).join(""))}async function qn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await fi(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(i)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ft(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,o]=await Promise.all([Gt(m.establishmentId),Xt(m.establishmentId,"products"),Ma(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(o||[]).filter(Boolean),ps(st)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function ps(e){if(document.getElementById("products-content-container")){if(st===e&&document.getElementById("products-content-container").children.length>1){st==="products"&&(qa(),mt());return}st=e,ue="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Mn():e==="movements"&&An()}}async function Rn(){fe.innerHTML=`
        ...
        </section>`,be&&(fe.removeEventListener("click",be),fe.removeEventListener("input",be),fe.removeEventListener("change",be)),be=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){mt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){ps(a.dataset.view);return}switch(a.dataset.action){case"new-product":lo();break;case"edit-product":lo(JSON.parse(a.dataset.product));break;case"manage-product-categories":Dn();break;case"generate-report":await qn();break;case"filter-stock":const s=a.dataset.filterType;ue=ue===s?"all":s,document.querySelectorAll(".indicator-card").forEach(r=>{r.classList.toggle("ring-2",r.dataset.filterType===ue),r.classList.toggle("ring-indigo-500",r.dataset.filterType===ue),r.classList.toggle("shadow-lg",r.dataset.filterType===ue)}),mt();break}},fe.addEventListener("click",be),fe.addEventListener("input",be),fe.addEventListener("change",be),st="products",ue="all",await ft()}const Ct=document.getElementById("content");let j={partners:[],establishments:[],searchQuery:"",categoryFilter:"all",stateFilter:"all",cityFilter:"",sortBy:"name_asc",hasSearched:!1,viewMode:"list",editingItem:null},ht=null;const Mt={contas_fixas:{label:"Contas Fixas (Água, Luz)",color:"blue",icon:"bi-lightning-charge"},estoque:{label:"Fornecedor de Produtos",color:"emerald",icon:"bi-box-seam"},servicos:{label:"Prestador de Serviço",color:"purple",icon:"bi-tools"},impostos:{label:"Governo / Impostos",color:"red",icon:"bi-bank"},outros:{label:"Outros Parceiros",color:"gray",icon:"bi-person-vcard"}},gs=["AC","AL","AP","AM","BA","CE","DF","ES","GO","MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ","RN","RS","RO","RR","SC","SP","SE","TO"];async function Nn(){try{const t=(await Ue()).matrizes||[];j.establishments=[],t.forEach(a=>{j.establishments.push({id:a.id,name:a.name,type:"Matriz"}),a.branches&&a.branches.forEach(o=>j.establishments.push({id:o.id,name:o.name,type:"Filial"}))})}catch(e){console.warn("Erro ao buscar lojas",e)}j.viewMode="list",j.editingItem=null,j.hasSearched=!1,j.partners=[],jn(),Un(),bs()}function jn(){Ct.innerHTML=`
    ...
    `}function Fn(){const e=Object.entries(Mt).map(([a,o])=>`<option value="${a}">${o.label}</option>`).join(""),t=gs.map(a=>`<option value="${a}">${a}</option>`).join("");return`
    ...
    `}function Hn(e=null){const t=!!e,a=t?"Ficha do Parceiro":"Novo Parceiro de Negócio";let o=e?.category||"";o==="Produtos"&&(o="estoque"),o==="Serviços"&&(o="servicos");const s=Object.entries(Mt).map(([n,l])=>`<option value="${n}" ${o===n?"selected":""}>${l.label}</option>`).join(""),r=gs.map(n=>`<option value="${n}" ${e?.state===n?"selected":""}>${n}</option>`).join(""),i=document.getElementById("form-container-wrapper");i&&(i.innerHTML=`
    ...
    `,document.getElementById("partner-form").addEventListener("submit",zn))}function bs(){const e=document.getElementById("partners-grid");e&&(e.innerHTML=`
        ...
        <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
    `,o='<div class="flex flex-col gap-4 md:hidden">';t.forEach(s=>{let r=s.category;r==="Produtos"&&(r="estoque"),r==="Serviços"&&(r="servicos");const i=Mt[r]||Mt.outros,n=s.document||s.taxId?s.document||s.taxId:"-",l=JSON.stringify(s).replace(/'/g,"&apos;"),d=[s.city,s.state].filter(Boolean).join(" - ");a+=`
        ...
        `}),a+="</tbody></table></div>",o+="</div>",e.innerHTML=a+o}function rt(e,t=null){const a=document.getElementById("suppliers-list-view"),o=document.getElementById("suppliers-form-view");j.viewMode=e,j.editingItem=t,e==="list"?(a.classList.remove("hidden"),o.classList.add("hidden"),o.innerHTML='<div id="form-container-wrapper" class="max-w-5xl mx-auto px-4 sm:px-6 py-8 pb-24"></div>',j.hasSearched&&fs(),window.scrollTo({top:0,behavior:"smooth"})):(a.classList.add("hidden"),o.classList.remove("hidden"),Hn(t),window.scrollTo({top:0,behavior:"smooth"}))}async function zn(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,o={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,document:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,state:t.querySelector("#supState").value,city:t.querySelector("#supCity").value,establishmentId:m.establishmentId,notes:t.querySelector("#supNotes")?.value||"",accessibleIn:[m.establishmentId]},s=t.querySelector('button[type="submit"]'),r=s.innerHTML;s.disabled=!0,s.innerHTML='<div class="loader-small border-white"></div> A gravar...';try{a?(await In(a,o),g("Sucesso","Ficha atualizada!","success")):(await En(o),g("Sucesso","Parceiro registado!","success")),j.hasSearched&&(j.partners=await Ma(m.establishmentId)||[]),rt("list")}catch(i){g("Erro","Falha ao gravar: "+i.message,"error"),s.disabled=!1,s.innerHTML=r}}async function Vn(e){if(await U("Excluir Parceiro","Deseja realmente apagar esta ficha permanentemente? Os lançamentos financeiros antigos não serão apagados."))try{await Ln(e),g("Sucesso","Entidade excluída.","success"),j.partners=j.partners.filter(a=>a.id!==e),rt("list")}catch(a){g("Erro","Erro ao excluir: "+a.message,"error")}}function Un(){ht&&Ct.removeEventListener("click",ht),ht=async e=>{const t=e.target;if(t.closest('button[data-action="new-partner"]')){rt("form",null);return}if(t.closest("#btn-search-partners")){j.searchQuery=document.getElementById("filterSearch").value,j.categoryFilter=document.getElementById("filterCategory").value,j.stateFilter=document.getElementById("filterState").value,j.cityFilter=document.getElementById("filterCity").value,j.sortBy=document.getElementById("filterSortBy").value,j.hasSearched=!0,On();return}if(t.closest('button[data-action="back-to-list"]')){rt("list");return}const a=t.closest('button[data-action="delete-partner"]');if(a){e.preventDefault(),Vn(a.dataset.id);return}const o=t.closest('[data-action="open-form"]');if(o&&!t.closest("button")){const s=JSON.parse(o.dataset.item.replace(/&apos;/g,"'"));rt("form",s)}},Ct.addEventListener("click",ht),Ct.addEventListener("keypress",e=>{e.key==="Enter"&&(e.target.id==="filterSearch"||e.target.id==="filterCity")&&document.getElementById("btn-search-partners").click()})}const aa=document.getElementById("content"),co={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ie=new Set,yt=null,Be=null,Tt=[];function Dt(){const e=oe.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}function _n(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Wn(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",o=x(t.name),s=x(t.specialty||"Especialidade"),r=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,i=JSON.stringify(t).replace(/'/g,"&apos;"),n=t.accessibleIn?t.accessibleIn.length:1,l=n>1?`<span class="text-[10px] font-bold bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded ml-2 border border-indigo-200" title="Atende em ${n} unidades"><i class="bi bi-diagram-3"></i> ${n} Lojas</span>`:"";return`
            ...
            </div>`}).join("")}function oa(){const e=document.getElementById("genericModal");e.style.display="none",Be&&e.removeEventListener("click",Be)}async function Jn(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=x(a.name),s=m.services||await $e(m.establishmentId),r=m.professionals||await re(m.establishmentId),i=`
        ...
        </div>`;t.innerHTML=i,t.style.display="flex",Yn(a,s),Qn(a),Xn(a,r),Kn(a)}function Gn(e=[]){if(!Tt||Tt.length===0)return`
            <input type="hidden" name="accessibleIn" value="${m.establishmentId}">
            <div class="bg-gray-50 p-3 rounded border text-sm text-gray-500">
                <i class="bi bi-info-circle mr-1"></i> Profissional exclusivo desta unidade.
            </div>`;let t='<div class="space-y-1 mt-2 max-h-48 overflow-y-auto p-3 border border-indigo-100 rounded-lg bg-indigo-50/30">';return Tt.forEach(a=>{const o=e.includes(a.id)||e.length===0&&a.id===m.establishmentId;t+=`
            <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-white rounded px-2 transition-colors">
                <input type="checkbox" name="accessibleIn" value="${a.id}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" ${o?"checked":""}>
                <span class="text-sm font-bold text-gray-800">🏢 ${x(a.name)} (Matriz)</span>
            </label>
        `,a.branches&&a.branches.length>0&&a.branches.forEach(s=>{const r=e.includes(s.id)||e.length===0&&s.id===m.establishmentId;t+=`
                ...
                `})}),t+="</div>",t}function Yn(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],s=Array.from({length:12},(h,$)=>{const k=$+1,E=k==o[1]?"selected":"",T=new Date(0,$).toLocaleString("pt-BR",{month:"long"});return`<option value="${k}" ${E}>${T.charAt(0).toUpperCase()+T.slice(1)}</option>`}).join(""),r=e.status||"active",i=x(e.name||""),n=x(e.specialty||""),l=x(e.phone||""),d=x(e.notes||"");a.innerHTML=`
        ...
        </div>`,Zn(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function Xn(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
            ...
            <div class="day-schedule-card p-4 rounded-xl ${s?"bg-white border-gray-200 shadow-sm":"bg-gray-50 border-gray-100 disabled opacity-60"} border transition-all">
                 <div class="flex justify-between items-center mb-3">
                    <span class="font-bold text-gray-800">${co[a]}</span>
        ...
        </section>`,yt&&aa.removeEventListener("click",yt),yt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),o=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let r={};if(a.dataset.professional)try{r=JSON.parse(a.dataset.professional)}catch(i){console.error("Erro ao fazer parse do professional data:",i);return}Jn(r);return}if(o){el();return}const s=t.target.closest(".professional-checkbox");if(s){const r=s.dataset.id;s.checked?ie.add(r):ie.delete(r),Ge(),ba();return}},aa.addEventListener("click",yt),document.getElementById("profSearchInput").addEventListener("input",Ge),document.getElementById("showInactiveProfToggle").addEventListener("change",Ge);const e=document.getElementById("professionalsList");m.professionals=null,m.services=null,Ge();try{const[t,a,o]=await Promise.all([re(m.establishmentId),$e(m.establishmentId),Ue()]);m.professionals=t,m.services=a,Tt=o?.matrizes||[],Ge(),ba()}catch{e.innerHTML='<p class="text-red-500 col-span-full font-bold text-center py-10 bg-red-50 rounded-lg border border-red-100">Erro ao carregar dados do servidor.</p>'}}let w={clients:[],selectedClient:null,activeTab:"profile",filters:{search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},showFilters:!1,loading:!1,historyLimit:20,historySearchTerm:"",historyLoading:!1,historyData:{appointments:[],sales:[],loyaltyLog:[]},modalOpen:!1},vs=null;const tl=e=>e?String(e).replace(/\D/g,""):"",al=e=>{if(!e)return"Nunca";let t;if(typeof e=="object"&&(e.seconds||e._seconds)){const a=e.seconds||e._seconds;t=new Date(a*1e3)}else t=new Date(e);return isNaN(t.getTime())?"Data Inválida":t.toLocaleDateString("pt-BR")};function Ra(){vs.innerHTML=`
    ...
    `;const e=document.getElementById("btn-new-client");e&&(e.onclick=ul)}function pt(){if(w.modalOpen)return;Ra();const e=document.getElementById("clients-content-area"),t=w.filters.inactiveDays||w.filters.birthMonth||w.filters.hasLoyalty||w.filters.hasDebt,a=`
    ...
    `,o=w.clients.length>0?`
        <div class="px-3 sm:px-4 pb-20 pt-2 w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ${w.clients.map(c=>{const u=c.totalDebt&&parseFloat(c.totalDebt)>0,p=al(c.lastVisit);return`
    ...
    `;e.innerHTML=a+o;const s=document.getElementById("client-search"),r=document.getElementById("btn-toggle-filters"),i=document.getElementById("btn-apply-filters"),n=document.getElementById("btn-clear-search");r&&(r.onclick=()=>{w.showFilters=!w.showFilters,pt()});const l=document.getElementById("filter-birth-month");l&&(l.value=w.filters.birthMonth);const d=()=>{const c=document.getElementById("filter-inactive"),u=document.getElementById("filter-loyalty"),p=document.getElementById("filter-debt"),f=document.getElementById("filter-birth-month");w.filters={search:s.value,inactiveDays:c?c.value:"",birthMonth:f?f.value:"",hasLoyalty:u?u.checked:!1,hasDebt:p?p.checked:!1},fa()};i&&(i.onclick=d),n&&(n.onclick=()=>{w.filters={search:"",inactiveDays:"",birthMonth:"",hasLoyalty:!1,hasDebt:!1},w.showFilters=!1,fa()}),s.addEventListener("keypress",c=>{c.key==="Enter"&&d()}),e.querySelectorAll(".client-card").forEach(c=>{c.onclick=()=>xs(c.dataset.id)})}function ol(e){const t=`
    ...
    `;let a="";return w.activeTab==="profile"?a=il(e):w.activeTab==="appointments"?a=nl():w.activeTab==="history"?a=ll():w.activeTab==="loyalty"&&(a=dl(e)),`
    ...
    `}function sl(e,t){if(!document.getElementById("tabs-styles")){const r=document.createElement("style");r.id="tabs-styles",r.textContent=`
        ...
        `,e.appendChild(r)}if(e.querySelectorAll(".tab-btn").forEach(r=>{r.onclick=async()=>{const i=r.dataset.tab;if(w.activeTab===i)return;(i==="appointments"||i==="history")&&(w.historyLimit=20,w.historySearchTerm=""),w.activeTab=i,Re(),i!=="profile"&&!w.historyLoading&&w.historyData.appointments.length===0&&await uo(t.id)}}),w.activeTab==="profile"){const r=e.querySelector("#form-edit-client"),i=e.querySelector("#btn-delete-client");r&&(r.onsubmit=ml),i&&(i.onclick=pl)}if(w.activeTab==="loyalty"){const r=e.querySelector("#btn-manual-redeem");r&&(r.onclick=()=>cl(t))}const a=e.querySelector("#history-search-input");if(a){const r=a.value;a.value="",a.focus(),a.value=r,a.addEventListener("input",i=>{w.historySearchTerm=i.target.value,Re()})}const o=e.querySelector("#btn-load-more");o&&(o.onclick=()=>{w.historyLimit+=20,Re(),uo(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(r=>{r.onclick=i=>{Ne(),Y("agenda-section",{targetDate:new Date(r.dataset.date),scrollToAppointmentId:r.dataset.id})}}),e.querySelectorAll("[data-go-comanda]").forEach(r=>{r.onclick=i=>{Ne(),Y("comandas-section",{selectedAppointmentId:r.dataset.id,initialFilter:"finalizadas"})}});const s=e.querySelector("#btn-close-modal");s&&(s.onclick=Ne)}async function Re(){const e=w.selectedClient;if(!e){Ne();return}rl(e)}function rl(e){let t=document.getElementById("client-details-modal-overlay");t||(t=document.createElement("div"),t.id="client-details-modal-overlay",t.className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-0 sm:p-4 animate-fade-in",t.innerHTML=`
        ...
        `,t.onclick=o=>{o.target===t&&Ne()},document.body.appendChild(t),document.body.classList.add("overflow-hidden"),w.modalOpen=!0);const a=t.querySelector("#client-modal-content");a.innerHTML=ol(e),sl(a,e)}function Ne(){const e=document.getElementById("client-details-modal-overlay");e&&e.remove(),document.body.classList.remove("overflow-hidden"),w.modalOpen=!1,w.selectedClient=null,pt()}function il(e){return`
    ...
    `}function ll(e){let t=w.historyData.sales||[];if(w.historySearchTerm){const a=w.historySearchTerm.toLowerCase();t=t.filter(o=>o.id.includes(a))}return t.sort((a,o)=>new Date(o.date)-new Date(a.date)),t.length===0&&!w.historySearchTerm?'<div class="text-center py-12 text-gray-400">Nenhum registro financeiro.</div>':`
        <div class="space-y-4 w-full">
            <div class="sticky top-0 bg-gray-50 pt-2 pb-2 z-10 w-full">
                <div class="relative w-full">
                    <input type="text" id="history-search-input" 
    ...
    `}function dl(e){const t=w.historyData.loyaltyLog||[];t.sort((o,s)=>new Date(s.date)-new Date(o.date));const a=t.length>0?t.map(o=>{const s=o.type==="redemption";return`
    ...
    `}async function fa(){w.loading=!0,Ra();try{let e=`/api/clients/${m.establishmentId}?limit=20`;w.filters.search&&(e+=`&search=${encodeURIComponent(w.filters.search)}`),w.filters.inactiveDays&&(e+=`&inactiveDays=${w.filters.inactiveDays}`),w.filters.hasLoyalty&&(e+="&hasLoyalty=true"),w.filters.hasDebt&&(e+="&hasDebt=true"),w.clients=await I(e),pt()}catch(e){console.error(e),g("Erro","Falha ao carregar clientes.","error"),w.clients=[],pt()}finally{w.loading=!1;const e=document.querySelector(".loader");e&&e.parentElement&&e.parentElement.remove()}}async function uo(e){const t=w.selectedClient;if(!(!t||!t.phone)){w.historyLoading=!0;try{const a=new Date;a.setMonth(a.getMonth()+12);const o=new Date;o.setFullYear(o.getFullYear()-5);let s=`/api/appointments/${m.establishmentId}?startDate=${o.toISOString()}&endDate=${a.toISOString()}`;s+=`&clientPhone=${encodeURIComponent(tl(t.phone))}`,s+=`&limit=${w.historyLimit}`;const r=await I(s);w.historyData.appointments=r,w.historyData.sales=r.filter(n=>n.status==="completed").map(n=>({id:n.id,date:n.startTime,totalAmount:n.totalAmount||0,items:n.comandaItems||n.services||[]}));const i=[];r.forEach(n=>{n.status==="completed"&&n.loyaltyPointsEarned>0&&i.push({type:"earn",points:n.loyaltyPointsEarned,date:n.startTime,description:"Venda finalizada"}),n.loyaltyRedemption&&i.push({type:"redemption",points:n.loyaltyRedemption.cost||0,date:n.startTime,description:`Resgate: ${n.loyaltyRedemption.name}`})}),w.historyData.loyaltyLog=i}catch(a){console.error("Erro ao buscar histórico",a)}finally{w.historyLoading=!1,w.modalOpen&&w.selectedClient&&Re()}}}function cl(e){const t=e.loyaltyPoints||0,a=`
    ...
    `,{modalElement:o,close:s}=se({title:"Ajuste de Pontos",contentHTML:a,maxWidth:"w-[90%] max-w-xs"});o.querySelector("form").onsubmit=async r=>{r.preventDefault();const i=document.getElementById("redeem-action").value,n=parseInt(document.getElementById("redeem-points").value,10),l=document.getElementById("redeem-reason").value;if(!n||n<=0)return g("Erro","Qtd inválida.","error");if(i==="debit"&&n>t)return g("Erro","Saldo insuficiente.","error");try{let d=t;i==="debit"?(await Wr(m.establishmentId,e.phone,n,l),d-=n):(d+=n,await Wo(e.id,{loyaltyPoints:d})),w.selectedClient.loyaltyPoints=d,w.historyData.loyaltyLog.unshift({type:i==="debit"?"redemption":"earn",points:n,date:new Date().toISOString(),description:l+" (Manual)"}),g("Sucesso","Saldo atualizado.","success"),s(),Re()}catch(d){g("Erro",d.message,"error")}}}function xs(e){w.selectedClient=w.clients.find(t=>t.id===e),w.activeTab="profile",w.historyLimit=20,w.historySearchTerm="",w.historyData={appointments:[],sales:[],loyaltyLog:[]},Re()}function ul(){const e=`
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",d=>{d.preventDefault();const c={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,cnpj:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};_e(c,d)})}function vl(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newEmail").value,s=t.querySelector("#currentPassword").value,r=t.querySelector('button[form="change-email-form"]');r.disabled=!0,r.textContent="A verificar...";try{const i=oe.currentUser,n=Ms.credential(i.email,s);await As(i,n),await qs(i,o),await gr(W,o),g("Sucesso","Link de verificação enviado! Verifique o seu novo e-mail.","success"),a.target.reset()}catch(i){g("Erro",i.message,"error")}finally{r.disabled=!1,r.textContent="Salvar Novo E-mail"}})}function hl(e,t){const a=x(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");e.timezone&&(a.value=e.timezone);const o=t.querySelector("#establishmentWorkingHoursContainer"),s=e.workingHours||{};Object.keys(sa).forEach(r=>{const i=s[r]||{},n=sa[r],l=i.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg border ${l?"bg-gray-50 border-gray-200":"bg-gray-100 border-gray-100 disabled opacity-60"}`,d.innerHTML=`
            <div class="flex justify-between items-center mb-4">
            ...
            </div>`,o.appendChild(d)}),o.addEventListener("change",r=>{const i=r.target.closest('.day-schedule-card input[type="checkbox"]');if(i){const n=i.closest(".day-schedule-card");n.classList.toggle("disabled",!i.checked),n.classList.toggle("opacity-60",!i.checked),n.classList.toggle("bg-gray-50",i.checked),n.classList.toggle("bg-gray-100",!i.checked)}}),t.querySelector("#working-hours-form").addEventListener("submit",r=>{r.preventDefault();const i={};Object.keys(sa).forEach(l=>{i[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const n=t.querySelector("#establishmentTimezone").value;_e({workingHours:i,timezone:n},r)})}function ys(e,t){const a=!!e.whatsappInstance;t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md border border-gray-100">
            <div class="mb-6">
    ...
    `;try{const[a,o]=await Promise.all([Qt(W),Da(W)]),s=e.financialIntegration||{},r=e.commissionConfig||{},i=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Le(a,s.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Le(o,s.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Le(a,i.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Le(o,i.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Le(a,r.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Le(o,r.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar o plano de contas da unidade.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const o={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};_e(o,a)})}function $l(e,t){const a=`https://wa.me/5516997859430?text=Olá, preciso de ajuda com o sistema Kairos (Minha Unidade: ${e.name}).`;t.innerHTML=`
    ...
    `}function El(e,t){const a=`https://wa.me/5516997859430?text=Gostaria de solicitar o cancelamento da assinatura. (Unidade: ${e.name})`;t.innerHTML=`
    ...
    `}function ws(e="indigo",t){const a=t.querySelector("#color-palette-container"),o=t.querySelector("#establishmentThemeColor");!a||!o||(a.innerHTML="",Object.entries(bl).forEach(([s,r])=>{const i=s===e,n=document.createElement("div");n.className="w-24 text-center cursor-pointer mb-4",n.innerHTML=`
        ...
        `,n.addEventListener("click",()=>{o.value=s,ws(s,t)}),a.appendChild(n)}),o.value=e)}function Il(e,t){const a=t.querySelector("#slotIntervalContainer"),o=t.querySelector("#establishmentSlotInterval");if(!a||!o)return;const s=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=s.map(r=>{const i=r.value===e;return`<button type="button" data-value="${r.value}" 
    ...
    `,xe.querySelector('button[data-action="back-to-menu"]').addEventListener("click",s=>{s.preventDefault(),ks({id:W})});const o=document.getElementById("settings-content-detail");switch(e){case"personal-data":fl(z,o);break;case"change-password":vl(z,o);break;case"change-email":xl(z,o);break;case"branding":hl(z,o);break;case"booking":yl(z,o);break;case"working-hours":wl(z,o);break;case"whatsapp-bot":ys(z,o);break;case"loyalty":await kl(z,o);break;case"financial":await Sl(z,o);break;case"support":$l(z,o);break;case"cancellation":El(z,o);break;default:o.innerHTML='<div class="p-4 text-center">Módulo em construção.</div>'}}async function ks(e={}){xe.innerHTML=`
    ...
    `;try{W=e.id||m.establishmentId,z=await we(W);const t=e.id?`<button onclick="window.navigateTo('establishments-section')" class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-lg shadow-sm transition-colors flex items-center gap-2">
                   <i class="bi bi-diagram-3"></i> Voltar à Rede
               </button>`:"",a=z.isMatriz||!z.parentId?'<span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded ml-3">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-xs font-bold px-2 py-1 rounded ml-3">📍 UNIDADE</span>',o=hs();xe.innerHTML=`
            <div class="max-w-5xl mx-auto w-full pb-20">
                ...
                <div class="bg-gradient-to-r from-indigo-900 to-indigo-700 rounded-xl shadow-lg p-6 mb-8 text-white flex justify-between items-center relative overflow-hidden">
                    <div class="relative z-10">
                        <h3 class="text-2xl font-bold mb-1">${x(z.name)} ${a}</h3>
                        <p class="text-indigo-200 text-sm flex items-center gap-2"><i class="bi bi-geo-alt"></i> ${x(z.address||"Morada não definida")}</p>
                    </div>
        ...
        `,xe.querySelectorAll("div[data-section]").forEach(s=>{s.addEventListener("click",r=>{Ll(s.dataset.section)})}),xe.querySelectorAll(".module-toggle").forEach(s=>{s.addEventListener("change",async()=>{const r=s.dataset.module;try{const n={...(await we(W)).modules,[r]:s.checked};await Sa(W,{modules:n}),g("Módulos","Módulos atualizados com sucesso.","success")}catch(i){s.checked=!s.checked,g("Erro",i.message,"error")}})})}catch(t){xe.innerHTML=`
        ...
        `}}function Cl(e){return[{key:"agenda-section",label:"Agenda Diária",icon:"bi-calendar"},{key:"comandas-section",label:"Comandas e PDV",icon:"bi-receipt"},{key:"financial-section",label:"Financeiro Completo",icon:"bi-cash-coin"},{key:"reports-section",label:"Relatórios Gerenciais",icon:"bi-graph-up"}].map(a=>`
    ...
    `).join("")}const nt=document.getElementById("content");async function je(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,o=document.getElementById("filterEndDate")?.value,s=await _t(m.establishmentId,a||new Date().toISOString().split("T")[0],o||new Date().toISOString().split("T")[0],e),r=document.getElementById("filterReason")?.value.toLowerCase(),i=r?s.filter(l=>l.reason&&l.reason.toLowerCase().includes(r)):s,n=i.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",i.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(n).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;c.innerHTML+=E}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function Tl(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,o=t.querySelector("#blockageDate").value,s=t.querySelector("#blockageEndDate").value||o,r=t.querySelector("#blockageStartTime").value,i=t.querySelector("#blockageEndTime").value,n={establishmentId:m.establishmentId,professionalId:a,startTime:new Date(`${o}T${r}:00`).toISOString(),endTime:new Date(`${s}T${i}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Wt(n),t.reset(),g("Sucesso","Bloqueio adicionado com sucesso!","success"),je(a)}catch(l){g("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Dl(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const o=t.querySelector("#batchBlockageDate").value,s=t.querySelector("#batchBlockageEndDate").value||o,r=t.querySelector("#batchBlockageStartTime").value,i=t.querySelector("#batchBlockageEndTime").value,n=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:m.establishmentId,professionalId:c,startTime:new Date(`${o}T${r}:00`).toISOString(),endTime:new Date(`${s}T${i}:00`).toISOString(),reason:n};return Wt(u)});try{await Promise.all(d),g("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&je(c)}catch(c){g("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Pl(e){nt.addEventListener("submit",t=>{t.target.id==="blockageForm"&&Tl(t),t.target.id==="batchBlockageForm"&&Dl(t)}),nt.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&je(e)}),nt.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const o=a.dataset.action;if(o==="back-to-professionals")Y("profissionais-section");else if(o==="delete-blockage"){if(await U("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await $a(a.dataset.id),g("Sucesso","Bloqueio removido.","success"),je(e)}catch(r){g("Erro",`Não foi possível remover o bloqueio: ${r.message}`,"error")}}else if(o==="batch-delete-blockage"){const s=JSON.parse(a.dataset.ids);if(await U("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${s.length} bloqueios de uma vez?`))try{await zo(s),g("Sucesso",`${s.length} bloqueios removidos.`,"success"),je(e)}catch(i){g("Erro",`Não foi possível apagar os bloqueios: ${i.message}`,"error")}}})}async function Bl(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){nt.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const o=x(a);nt.innerHTML=`
        <section>
        ...
        </section>`,Pl(t),await je(t);const s=document.getElementById("batchProfSelectionContainer");try{const r=await re(m.establishmentId);s.innerHTML=r.map(i=>`
            <div class="flex items-center">
    ...
    `}).join("")}function va(){const t=document.getElementById("showInactiveUsersToggle")?.checked?m.users:m.users.filter(a=>a.status==="active");zl(t)}function Vl(e={}){return Object.entries(Fl).map(([t,a])=>{const o=t==="agenda-section"||t==="comandas-section",s=e[t]?.view_all_prof===!0,r=Object.entries(Hl).map(([n,l])=>`
    ...
    `}).join("")}function po(e){if(!Fe||m.userRole==="professional")return"";const t=e?.accessibleEstablishments?.map(r=>r.id)||[],a=e?.accessibleCompanies?.map(r=>r.id)||[];if((e?.role||"professional")==="group_admin")return'<div class="p-3 bg-purple-50 border border-purple-200 rounded-lg text-purple-800 text-sm font-bold">Acesso Total (Global) liberado.</div>';let s='<div class="space-y-3 max-h-48 overflow-y-auto custom-scrollbar p-2 bg-gray-50 rounded border">';return Fe.companies.forEach(r=>{const i=a.includes(r.id),n=Fe.branches.filter(l=>l.companyId===r.id);s+=`
        ...
        `}),s+="</div>",s}async function go(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=m.professionals;if(!a||a.length===0)try{a=await re(m.currentViewContext.id),m.professionals=a}catch{console.warn("Profissionais não carregados")}if(["group_admin","company_admin"].includes(m.userRole)&&!Fe)try{const d=await fetch("/api/establishments/hierarchy",{headers:{Authorization:`Bearer ${await m.getAuthToken?.()||""}`}});d.ok&&(Fe=await d.json())}catch(d){console.error("Falha ao buscar hierarquia",d),Fe={companies:[],branches:[]}}const o=d=>a?.find(c=>c.id===d),s=e?.professionalId;o(s);const r=e!==null;t.querySelector("#userFormTitle").textContent=r?`Editar: ${e.name}`:"Novo Usuário";const i=t.querySelector("#userForm");i.innerHTML=`
    ...
    `,wt&&Ye.removeEventListener("click",wt),kt&&Ye.removeEventListener("change",kt),wt=async e=>{const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":go();break;case"edit-user":const o=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));go(o);break;case"back-to-list":qt();break;case"delete-user":{if(e.stopPropagation(),await U("Excluir Usuário","Tem certeza? Ação irreversível."))try{await Rl(t.dataset.userId),g("Usuário excluído!","success"),qt()}catch(s){g(`Erro: ${s.message}`,"error")}break}}},kt=async e=>{const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")va();else if(t){e.stopPropagation();const a=t.dataset.userId,o=t.checked?"active":"inactive";try{await jl(a,o);const s=m.users.findIndex(r=>r.id===a);s>-1&&(m.users[s].status=o,va())}catch(s){g(`Erro: ${s.message}`,"error"),t.checked=!t.checked}}},Ye.addEventListener("click",wt),Ye.addEventListener("change",kt),await Ul()}const _l=document.getElementById("content");let bo={},xa=null;function Wl(){Object.values(bo).forEach(e=>e?.destroy()),bo={}}function Jl(e,t){if(!window.jspdf){g("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,o=new a({orientation:"landscape",unit:"px",format:"a4"}),s=document.getElementById("salesReportSummaryCards");if(o.setFontSize(18),o.text(e,o.internal.pageSize.getWidth()/2,40,{align:"center"}),s){const i=[["Receita Total",s.querySelector("#summary-revenue").textContent],["Vendas Totais",s.querySelector("#summary-transactions").textContent],["Ticket Médio",s.querySelector("#summary-avg-ticket").textContent]];o.autoTable({startY:60,head:[["Métrica","Valor"]],body:i,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const r=o.lastAutoTable?o.lastAutoTable.finalY+20:60;o.text("Detalhes das Vendas",20,r),o.autoTable({html:`#${t}`,startY:r+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),o.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function fo(e){const t=document.getElementById("genericModal"),a=x(e.client),o=x(e.items),s=x(e.responsavelCaixa||"N/A"),r=(e.payments||[]).map(i=>`
    ...
    `,t.style.display="flex"}function Gl(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const o=document.getElementById("paymentSummaryTableBody"),s=Object.entries(t.paymentMethodTotals).sort(([,n],[,l])=>l-n);o.innerHTML=s.map(([n,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),r.querySelectorAll("tr").forEach(n=>{n.addEventListener("dblclick",()=>{const l=n.dataset.transactionIndex,d=xa.transactions[l];d&&fo(d)})}),i.innerHTML=a.map((n,l)=>{const d=x(n.client),c=x(n.items),u=x(n.type);return`
    ...
    `}).join(""),i.querySelectorAll("div[data-transaction-index]").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.transactionIndex,d=xa.transactions[l];d&&fo(d)})})}async function vo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,s=a.value;if(!o||!s)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const r=document.getElementById("cashierSessionFilter").value,i=await Ar({establishmentId:m.establishmentId,startDate:o,endDate:s,cashierSessionId:r});xa=i,e.innerHTML=`
        ...
        `,Gl(i)}catch(r){g("Erro",`Não foi possível carregar o relatório: ${r.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${x(r.message)}</p>`}}async function Yl(){Wl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];_l.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",vo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const o=document.getElementById("reportStartDate").value,s=document.getElementById("reportEndDate").value,r=`Relatorio_Vendas_${o}_a_${s}`;Jl(r,"transactionsTable")});try{const o=await yi(m.establishmentId),s=document.getElementById("cashierSessionFilter");o&&o.length>0&&o.forEach(r=>{const i=new Date(r.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),n=x(r.closedByName||"N/A");s.innerHTML+=`<option value="${r.id}">${n} - ${i}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await vo()}const Ql=document.getElementById("content");let S={payables:[],receivables:[],natures:[],costCenters:[],establishments:[],currentTab:"receivables",statusFilter:"all",startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date(new Date().getFullYear(),new Date().getMonth()+1,0).toISOString().split("T")[0],filterNaturezaId:"all",filterCostCenterId:"all",filterEstablishmentIds:new Set,searchQuery:"",isAdvancedFilterOpen:!1,selectedIds:new Set,isSelectionMode:!1},St=null,$t=null;function Na(e){const t=new Map,a=[];return e&&(e.forEach(o=>t.set(o.id,{...o,children:[]})),t.forEach(o=>{o.parentId&&t.has(o.parentId)?t.get(o.parentId).children.push(o):a.push(o)})),a}function Ss(e){if(!e)return{day:"--",month:"---",full:"--/--/----"};const[t,a,o]=e.split("-"),s=new Date(t,a-1,o),r=String(s.getDate()).padStart(2,"0"),i=s.toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return{day:r,month:i,full:s.toLocaleDateString("pt-BR")}}function ne(e){return new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(e)}function Rt(e,t){if(t==="paid")return!1;const a=new Date;a.setHours(0,0,0,0);const[o,s,r]=e.split("-");return new Date(o,s-1,r)<a}function Xl(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-400 text-sm py-4">Nenhum item criado.</p>';return}const o=(s,r=0)=>`
        ...
        `;e.innerHTML=t.map(s=>o(s)).join("")}async function ha(e){const t=document.getElementById("genericModal"),a=e==="nature",o=a?"Plano de Contas (Naturezas)":"Centros de Custo",s=a?Qt:Da,r=a?Oi:Vi,i=a?"natures":"costCenters";t.innerHTML=`
    ...
    `,document.querySelector('.date-preset-btn[data-preset="month"]').classList.add("bg-indigo-100","text-indigo-700"),Is()}function Es(){const e=document.getElementById("select-all-toggle");e&&e.addEventListener("change",o=>{const s=o.target.checked,r=document.querySelectorAll(".item-checkbox");S.selectedIds.clear(),r.forEach(i=>{i.checked=s,s&&S.selectedIds.add(i.dataset.id)}),Me()}),document.getElementById("cancel-selection-btn").addEventListener("click",()=>{S.selectedIds.clear(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1),document.querySelectorAll(".item-checkbox").forEach(o=>o.checked=!1),Me()}),document.getElementById("batch-delete-btn").addEventListener("click",async()=>{const o=S.selectedIds.size;if(o===0)return;if(await U("Excluir Lançamentos",`Deseja realmente apagar ${o} registros financeiros?`))try{const r=S.currentTab==="payables"?"payables":"receivables";await ss(r,Array.from(S.selectedIds)),g("Sucesso",`${o} itens excluídos.`,"success"),S.selectedIds.clear(),Me(),Se()}catch{g("Erro","Falha ao excluir itens.","error")}}),document.querySelectorAll(".est-filter-checkbox").forEach(o=>{o.addEventListener("change",s=>{const r=s.target.closest("label");s.target.checked?(S.filterEstablishmentIds.add(s.target.value),r.classList.add("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.remove("border-gray-200","text-gray-600")):(S.filterEstablishmentIds.delete(s.target.value),r.classList.remove("border-indigo-500","ring-1","ring-indigo-500","bg-indigo-50/20","text-indigo-700"),r.classList.add("border-gray-200","text-gray-600"))})}),document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const o=document.getElementById("filter-panel"),s=document.getElementById("toggle-filter-btn");S.isAdvancedFilterOpen=!S.isAdvancedFilterOpen,S.isAdvancedFilterOpen?(o.classList.remove("hidden"),s.classList.add("bg-indigo-50","text-indigo-700","border-indigo-300")):(o.classList.add("hidden"),s.classList.remove("bg-indigo-50","text-indigo-700","border-indigo-300"))}),document.getElementById("settings-btn").addEventListener("click",od),document.querySelectorAll('[data-action="new-financial"]').forEach(o=>{o.addEventListener("click",s=>{ra(s.target.closest("button").dataset.type)})}),document.getElementById("fab-add").addEventListener("click",()=>{const o=S.currentTab==="payables"?"payable":"receivable";ra(o)});const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables");t.addEventListener("click",()=>xo("receivables")),a.addEventListener("click",()=>xo("payables")),document.querySelectorAll(".status-filter-btn").forEach(o=>{o.addEventListener("click",s=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-gray-800","text-white","shadow-sm"),r.classList.add("bg-gray-100","text-gray-600")}),s.target.classList.add("bg-gray-800","text-white","shadow-sm"),s.target.classList.remove("bg-gray-100","text-gray-600","hover:bg-gray-200","hover:bg-red-100"),S.statusFilter=s.target.dataset.status,Nt(),Ls()})}),document.querySelectorAll(".date-preset-btn").forEach(o=>{o.addEventListener("click",s=>{document.querySelectorAll(".date-preset-btn").forEach(d=>d.classList.remove("bg-indigo-100","text-indigo-700")),s.target.classList.add("bg-indigo-100","text-indigo-700");const r=s.target.dataset.preset,i=new Date;let n,l;r==="month"?(n=new Date(i.getFullYear(),i.getMonth(),1),l=new Date(i.getFullYear(),i.getMonth()+1,0)):r==="last_month"?(n=new Date(i.getFullYear(),i.getMonth()-1,1),l=new Date(i.getFullYear(),i.getMonth(),0)):r==="year"&&(n=new Date(i.getFullYear(),0,1),l=new Date(i.getFullYear(),11,31)),document.getElementById("filterStartDate").value=n.toISOString().split("T")[0],document.getElementById("filterEndDate").value=l.toISOString().split("T")[0],document.getElementById("apply-filter-btn").click()})}),document.getElementById("searchInput").addEventListener("input",o=>{S.searchQuery=o.target.value.toLowerCase(),Nt()}),document.getElementById("clear-filters-btn").addEventListener("click",()=>{const o=new Date;document.getElementById("filterStartDate").value=new Date(o.getFullYear(),o.getMonth(),1).toISOString().split("T")[0],document.getElementById("filterEndDate").value=new Date(o.getFullYear(),o.getMonth()+1,0).toISOString().split("T")[0],document.getElementById("filterNaturezaId").value="all",document.getElementById("filterCostCenterId").value="all",S.filterEstablishmentIds.clear(),S.filterEstablishmentIds.add(m.establishmentId),$s(),Es()}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{S.startDate=document.getElementById("filterStartDate").value,S.endDate=document.getElementById("filterEndDate").value,S.filterNaturezaId=document.getElementById("filterNaturezaId").value,S.filterCostCenterId=document.getElementById("filterCostCenterId").value,S.filterEstablishmentIds.size===0&&S.filterEstablishmentIds.add(m.establishmentId),document.getElementById("toggle-filter-btn").click(),Se()}),St&&document.body.removeEventListener("click",St),St=o=>{const s=o.target;if(s.classList.contains("item-checkbox")||s.classList.contains("modal-item-checkbox")){const n=s.value||s.dataset.id;s.checked?S.selectedIds.add(n):S.selectedIds.delete(n),Me(),o.stopPropagation();return}const r=s.closest("button[data-action]");if(r){const{action:n,type:l,id:d}=r.dataset;if(o.stopPropagation(),n==="delete"){const c=r.closest(".financial-row").dataset.item.replace(/&apos;/g,"'");ed(l,JSON.parse(c));return}if(n==="mark-as-paid"){Kl(l,d);return}if(n==="manage-natures"){ha("nature");return}if(n==="manage-cost-centers"){ha("cost-center");return}}const i=s.closest(".financial-row");if(i&&document.getElementById("list-container").contains(i)&&!s.closest("button")&&!s.closest(".item-checkbox")){const{type:n}=i.dataset,l=JSON.parse(i.dataset.item.replace(/&apos;/g,"'"));ra(n,l)}},document.body.addEventListener("click",St),$t&&document.getElementById("genericModal").removeEventListener("click",$t),$t=o=>{if(o.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const r=o.target.closest('button[data-action^="delete-"]');if(r){const i=r.dataset.action.split("-")[1];ad(i,r.dataset.id)}},document.getElementById("genericModal").addEventListener("click",$t)}function Me(){const e=document.getElementById("batch-action-bar"),t=document.getElementById("selected-count"),a=document.getElementById("fab-add"),o=S.selectedIds.size;t.textContent=o,o>0?(e.classList.remove("hidden"),e.classList.add("flex"),a&&a.classList.add("hidden")):(e.classList.add("hidden"),e.classList.remove("flex"),a&&a.classList.remove("hidden"))}function xo(e){S.currentTab=e,S.selectedIds.clear(),Me(),document.getElementById("select-all-toggle")&&(document.getElementById("select-all-toggle").checked=!1);const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),o=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-emerald-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),o&&(o.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-emerald-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-emerald-700","shadow-sm"),t.classList.add("text-gray-500"),o&&(o.className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-all z-40")),Nt()}async function Se(){const e=document.getElementById("list-container");e.innerHTML='<div class="text-center py-16"><div class="loader mx-auto"></div><p class="mt-4 text-gray-500 font-medium text-sm">A processar transações...</p></div>';try{if(S.natures.length===0){const[r,i]=await Promise.all([Qt(m.establishmentId),Da(m.establishmentId)]);S.natures=r,S.costCenters=i,Is()}const t=Array.from(S.filterEstablishmentIds).join(","),a={startDate:S.startDate,endDate:S.endDate,establishmentId:t};S.filterNaturezaId!=="all"&&(a.natureId=S.filterNaturezaId),S.filterCostCenterId!=="all"&&(a.costCenterId=S.filterCostCenterId);const[o,s]=await Promise.all([is(a),ns(a)]);S.payables=o.entries||[],S.receivables=s.entries||[],Ls(),Nt()}catch(t){e.innerHTML=`
            ...
            </div>`}}function Is(){const e=o=>{let s='<option value="all">-- Todas as opções --</option>';const r=Na(o),i=(n,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");s+=`<option value="${n.id}">${d}${n.name}</option>`,n.children.forEach(c=>i(c,l+1))};return r.forEach(n=>i(n)),s},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(S.natures)),a&&(a.innerHTML=e(S.costCenters))}function Ls(){const e=document.getElementById("summary-section");if(!e)return;const t=S.currentTab==="receivables";let o=t?S.receivables:S.payables;S.searchQuery&&(o=o.filter(c=>c.description&&c.description.toLowerCase().includes(S.searchQuery)||c.entity&&c.entity.toLowerCase().includes(S.searchQuery)||c.notes&&c.notes.toLowerCase().includes(S.searchQuery)));const s=o.reduce((c,u)=>c+u.amount,0),r=o.filter(c=>c.status==="paid").reduce((c,u)=>c+u.amount,0),i=o.filter(c=>c.status==="pending"&&!Rt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),n=o.filter(c=>Rt(c.dueDate,c.status)).reduce((c,u)=>c+u.amount,0),l=t?"emerald":"red",d=t?"Receitas":"Despesas";e.innerHTML=`
    ...
    `}function Nt(){const e=document.getElementById("list-container");if(!e)return;const t=S.currentTab==="receivables",a=t?S.receivables:S.payables;let o=a;if(S.statusFilter!=="all"&&(o=a.filter(l=>{const d=Rt(l.dueDate,l.status);return S.statusFilter==="overdue"?d:S.statusFilter==="pending"?l.status==="pending"&&!d:l.status===S.statusFilter})),S.searchQuery&&(o=o.filter(l=>l.description&&l.description.toLowerCase().includes(S.searchQuery)||l.entity&&l.entity.toLowerCase().includes(S.searchQuery)||l.notes&&l.notes.toLowerCase().includes(S.searchQuery))),o.sort((l,d)=>new Date(l.dueDate)-new Date(d.dueDate)),o.length===0){e.innerHTML=`
        ...
        `}).join("")}async function Kl(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?Gi(t,a):Zi(t,a)),g("Baixa Realizada","O lançamento foi registado como pago.","success"),await Se()}catch(o){g("Erro",o.message,"error")}}async function ed(e,t){if(!!!t.recurrenceId){await U("Excluir Lançamento","Tem certeza? Essa ação apagará o registo do seu fluxo de caixa.")&&await Cs(e,[t.id]);return}td(e,t)}function td(e,t){const a=document.getElementById("genericModal"),s=(e==="payable"?S.payables:S.receivables).filter(d=>d.recurrenceId===t.recurrenceId).sort((d,c)=>new Date(d.dueDate)-new Date(c.dueDate));a.innerHTML=`
        <div class="modal-content max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div class="overflow-y-auto p-3 space-y-2 custom-scrollbar flex-1 bg-white">
                ${s.map(d=>{const c=d.id===t.id,u=d.status==="paid",p=Ss(d.dueDate);return`
    ...
    `,a.style.display="flex";const r=a.querySelector("#modal-select-all"),i=a.querySelectorAll(".modal-item-checkbox"),n=a.querySelector("#confirm-batch-delete");r.addEventListener("change",d=>{i.forEach(c=>c.checked=d.target.checked),l()}),i.forEach(d=>d.addEventListener("change",l));function l(){const d=Array.from(i).filter(c=>c.checked).length;n.innerHTML=d>0?`<i class="bi bi-trash3"></i> Excluir ${d} Parcela(s)`:"Selecione para excluir",n.disabled=d===0,d===0?n.classList.add("opacity-50","cursor-not-allowed","bg-gray-400"):n.classList.remove("opacity-50","cursor-not-allowed","bg-gray-400")}n.addEventListener("click",async()=>{const d=Array.from(i).filter(u=>u.checked).map(u=>u.value);if(d.length===0)return;a.style.display="none",await U("Confirmar Ação",`Tem certeza que deseja apagar estas ${d.length} parcelas permanentemente?`)&&await Cs(e,d)}),l()}async function Cs(e,t){try{t.length===1?e==="payable"?await Ji(t[0]):await Xi(t[0]):await ss(e==="payable"?"payables":"receivables",t),g("Sucesso",`${t.length} registo(s) limpo(s) do sistema.`,"success"),S.selectedIds.clear(),Me(),await Se()}catch(a){g("Erro",a.message,"error")}}async function ad(e,t){const o=e==="nature"?zi:Ui;if(await U("Apagar Categoria","Tem certeza? Apagar um item pai também apagará as suas subcategorias."))try{await o(t),ha(e==="nature"?"nature":"cost-center")}catch(r){g("Erro",r.message,"error")}}function od(){const e=document.getElementById("genericModal");e.innerHTML=`
    ...
    `,e.style.display="flex"}function ra(e,t=null){const a=document.getElementById("genericModal"),o=e==="payable",s=o?"red":"emerald",r=t?"Editar Lançamento":"Novo Lançamento",i=S.establishments.map(L=>{const A=t?t.establishmentId===L.id:L.id===m.establishmentId;return`<option value="${L.id}" ${A?"selected":""}>${L.type==="Matriz"?"🏢":"📍"} ${L.name}</option>`}).join(""),n=(L,A)=>{let F='<option value="">-- Selecione --</option>';const C=Na(L),M=(q,H=0)=>{const O="  ".repeat(H)+(H>0?"↳ ":""),R=q.id===A?"selected":"";F+=`<option value="${q.id}" ${R}>${O}${q.name}</option>`,q.children.forEach(_=>M(_,H+1))};return C.forEach(q=>M(q)),F},d=[{value:"dinheiro",label:"Dinheiro"},{value:"pix",label:"PIX"},{value:"cartao_credito",label:"Cartão de Crédito"},{value:"cartao_debito",label:"Cartão de Débito"},{value:"transferencia",label:"Transferência Bancária"},{value:"boleto",label:"Boleto"},{value:"outros",label:"Outros"}].map(L=>`<option value="${L.value}" ${t?.paymentMethod===L.value?"selected":""}>${L.label}</option>`).join("");a.innerHTML=`
        <div class="modal-content max-w-3xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden m-4 flex flex-col max-h-[90vh]">
            ...
            `}};t||a.querySelectorAll(".mode-btn").forEach(L=>{L.addEventListener("click",A=>{if(a.querySelectorAll(".mode-btn").forEach(F=>{F.classList.remove("bg-gray-900","text-white","shadow-sm"),F.classList.add("text-gray-500","hover:bg-gray-100")}),A.target.classList.add("bg-gray-900","text-white","shadow-sm"),A.target.classList.remove("text-gray-500","hover:bg-gray-100"),u=A.target.dataset.mode,u==="single")b.classList.add("hidden");else{b.classList.remove("hidden");const F=b.querySelector("label");F.textContent=u==="installment"?"Número de Parcelas":"Repetir por quantos meses?",T()}})}),f.addEventListener("input",T),h&&(h.addEventListener("input",T),c.querySelector("#btn-minus").addEventListener("click",()=>{let L=parseInt(h.value)||2;L>2&&(h.value=L-1,T())}),c.querySelector("#btn-plus").addEventListener("click",()=>{let L=parseInt(h.value)||2;L<60&&(h.value=L+1,T())})),$.addEventListener("change",()=>{$.checked?(k.classList.remove("hidden"),E.required=!0):(k.classList.add("hidden"),E.required=!1)}),c.addEventListener("submit",async L=>{L.preventDefault();const A=c.querySelector('button[type="submit"]'),F=A.innerHTML;A.disabled=!0,A.innerHTML='<div class="loader-small border-white"></div> A gravar...';const C=new FormData(c),M=$.checked,q=parseFloat(C.get("amount"));let H=q,O=1;!t&&u!=="single"&&(O=parseInt(C.get("installments")),u==="repeat"&&(H=q*O));const R={establishmentId:C.get("establishmentId"),description:C.get("description"),amount:H,dueDate:C.get("dueDate"),naturezaId:C.get("naturezaId")||null,centroDeCustoId:C.get("centroDeCustoId")||null,entity:C.get("entity")||null,paymentMethod:C.get("paymentMethod")||null,documentNumber:C.get("documentNumber")||null,notes:C.get("notes"),status:M?"paid":"pending",paymentDate:M?C.get("paymentDate"):null,installments:O};O>1&&!t&&(R.recurrenceId=self.crypto.randomUUID());try{t?(await(o?Wi(t.id,R):Qi(t.id,R)),g("Sucesso","Atualizado com sucesso!","success")):(await(o?_i(R):Yi(R)),g("Sucesso","Lançamento criado!","success")),document.getElementById("genericModal").style.display="none",Se()}catch(_){g("Erro",_.message||"Erro ao salvar","error"),A.disabled=!1,A.innerHTML=F}})}const sd=e=>I("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),rd=e=>I("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),id=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return I(`/api/commissions/stats?${a}`)},nd=(e={})=>{Object.keys(e).forEach(o=>(e[o]===void 0||e[o]===null||e[o]==="")&&delete e[o]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return I(a)},ld=e=>I(`/api/commissions/report/${e}`,{method:"DELETE"}),jt=new Date,ho=new Date(jt.getFullYear(),jt.getMonth(),1),N={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:ho.toISOString().split("T")[0],dashEndDate:jt.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:ho.toISOString().split("T")[0],histEndDate:jt.toISOString().split("T")[0],histProfessionalId:"all"};let Et=null;const Ze=document.getElementById("content");async function dd(){try{N.professionals=await re(m.establishmentId)}catch(e){console.error("Erro profissionais",e)}yd(),cd(),Kt(),Ht("dashboard")}function cd(){Et&&Ze.removeEventListener("click",Et),Et=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,o=t.dataset.id,s=t.dataset.idx;switch(a){case"tab-nav":Ht(t.dataset.tab);break;case"toggle-all-profs":ud();break;case"back-to-filters":N.calculationResult=null,Ft(document.getElementById("commissions-content"));break;case"view-preview-items":hd(s);break;case"save-final-report":pd();break;case"start-new-calc":Ht("calculator");break;case"print-receipt":gd(o);break;case"delete-report":bd(o);break;case"filter-dashboard":Kt();break;case"filter-history":ja();break}},Ze.addEventListener("click",Et),Ze.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;vd(t)}},Ze.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),md())}}async function Kt(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(N.dashStartDate=e.value),t&&(N.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const o=await id(N.dashStartDate,N.dashEndDate);N.dashStats={revenue:o.totalRevenue||0,commissions:o.totalCommissionsPaid||0},N.currentTab==="dashboard"&&Ts(document.getElementById("commissions-content"))}catch(o){console.error(o),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function ja(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(N.histStartDate=e.value),t&&(N.histEndDate=t.value),a&&(N.histProfessionalId=a.value);const o=document.getElementById("history-list-container");if(o){o.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const s=await nd({startDate:N.histStartDate,endDate:N.histEndDate,professionalId:N.histProfessionalId});N.historyData=s,Ds(o,s)}catch{o.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function ud(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function md(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(r=>r.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),o=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");N.periodString=`${a} a ${o}`;const s=document.getElementById("commissions-content");s.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const r=await sd(t);N.calculationResult=r.map(i=>({...i,extraDebit:0,extraCredit:0,finalValue:i.summary.totalCommission,notes:""})),Ft(s)}catch(r){g("Erro",r.message,"error"),N.calculationResult=null,Ft(s)}}async function pd(){const e=N.calculationResult.length;if(await U("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=N.calculationResult.map(o=>{const s=o.items.map(r=>r.originalSaleId).filter(r=>r!=null);return rd({professionalId:o.professionalId,professionalName:o.professionalName,period:N.periodString,processedSalesIds:s,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}})});await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),N.calculationResult=null,Kt(),Ht("history")}catch(a){g("Erro",a.message,"error")}}function gd(e){const t=N.historyData.find(a=>a.id===e);t&&fd(t)}async function bd(e){if(await U("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await ld(e),g("Sucesso","Registro removido.","success"),ja(),Kt()}catch(a){g("Erro",a.message,"error")}}function fd(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,o=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",o,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const s=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&s.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&s.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:s,theme:"grid"});const r=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,r,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function vd(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let o=0,s=0;if(t.forEach(r=>{r.value&&(o=parseFloat(r.value))}),a.forEach(r=>{r.value&&(s=parseFloat(r.value))}),N.calculationResult&&N.calculationResult[e]){const r=N.calculationResult[e];r.extraDebit=o,r.extraCredit=s,r.finalValue=r.summary.totalCommission-o+s,t.forEach(n=>{n!==document.activeElement&&(n.value=o||"")}),a.forEach(n=>{n!==document.activeElement&&(n.value=s||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(n=>n.innerText=`R$ ${r.finalValue.toFixed(2)}`),xd()}}function xd(){const e=N.calculationResult.reduce((a,o)=>a+o.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function hd(e){const t=N.calculationResult[e];if(!t)return;const a=t.items.map(o=>`
    ...
    `}function wd(e){const t=N.professionals.map(a=>`<option value="${a.id}" ${N.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,N.historyData.length>0?Ds(document.getElementById("history-list-container"),N.historyData):ja()}function Ds(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ia=document.getElementById("content");let ye={allPackages:[],catalogForModal:{services:[],products:[]}},It=null,Ae=null;function kd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Sd(){const e=document.getElementById("packagesListContainer");if(e){if(ye.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=ye.allPackages.map(t=>{const a=t.status==="active",o=JSON.stringify(t).replace(/'/g,"&apos;"),s=t.price||0,r=t.originalPrice||0,i=r>s?r-s:0,n=r>0?(r-s)/r*100:0,l=x(t.name),d=x(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function yo(){const e=document.getElementById("genericModal");e.style.display="none",Ae&&e.removeEventListener("click",Ae)}async function wo(e=null){const t=document.getElementById("genericModal"),a=!!e,o=e?JSON.parse(JSON.stringify(e.items||[])):[],s=x(e?.name||""),r=x(e?.description||""),i=e?.price||"",n=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(f,b)=>{const v=b.querySelector("#originalPrice"),h=f.reduce(($,k)=>$+k.price*k.quantity,0);v&&(v.textContent=`R$ ${h.toFixed(2)}`)},p=f=>{f.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=f.map((b,v)=>{const h=b.type==="service",$=h?"Serviço":"Produto",k=h?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(f,t)};p(o),c.addEventListener("change",f=>{if(f.target.classList.contains("quantity-input")){const b=parseInt(f.target.dataset.index,10),v=parseInt(f.target.value,10);v>0&&o[b]&&(o[b].quantity=v,p(o))}}),c.addEventListener("click",f=>{if(f.target.classList.contains("remove-item-btn")){const b=parseInt(f.target.dataset.index,10);o.splice(b,1),p(o)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>$d(f=>{const b=o.find(v=>v.id===f.id&&v.type===f.type);b?b.quantity++:o.push({...f,quantity:1}),p(o)}),Ae&&t.removeEventListener("click",Ae),Ae=async f=>{const b=f.target.closest("button[data-action]");if(!b)return;const v=b.dataset.action;if(f.stopPropagation(),v==="close-modal"&&yo(),v==="save-package"){const h=b,$={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:o,originalPrice:o.reduce((k,E)=>k+E.price*E.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!$.name||!$.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if($.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}h.disabled=!0,h.textContent="A salvar...";try{a?await Si($.id,$):(delete $.id,await ki($)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),yo(),await Fa()}catch(k){g("Erro",`Não foi possível salvar o pacote: ${k.message}`,"error"),h.disabled=!1,h.textContent="Salvar Pacote"}}},t.addEventListener("click",Ae)}function $d(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const o={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},s=l=>{const d=t.toLowerCase(),c=ye.catalogForModal.services.filter(b=>b.name.toLowerCase().includes(d)),u=ye.catalogForModal.products.filter(b=>b.name.toLowerCase().includes(d)),p=c.map(b=>`
    ...
    `,document.body.appendChild(a);const r=a.querySelector("#item-selection-list"),i=a.querySelector("#item-search-input"),n=()=>{a.remove()};s(r),i.addEventListener("input",()=>{t=i.value,s(r)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:p}=d.dataset,b=(ye.catalogForModal[u+"s"]||[]).find(v=>v.id===p);b&&(e({...b,type:u}),n())}else(c||l.target===a)&&n()})}async function Fa(){ia.innerHTML=`
    ...
    `,It&&ia.removeEventListener("click",It),It=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const o=e.target.closest('[data-action="delete-package"]');if(o){const s=o.dataset.id;U("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async r=>{if(r)try{await $i(s),g("Sucesso!","Pacote excluído.","success"),await Fa()}catch(i){g("Erro",`Não foi possível excluir: ${i.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")wo(null);else if(a==="edit-package"){const o=JSON.parse(t.dataset.package);wo(o)}},ia.addEventListener("click",It);try{const[e,t,a]=await Promise.all([Ta(m.establishmentId),$e(m.establishmentId),Gt(m.establishmentId)]);ye.allPackages=e,ye.catalogForModal={services:t.filter(o=>o.active),products:a},Sd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Ed=document.getElementById("content");let Id=null;async function Ld(){const e=x(m.userName||"Usuário"),t=x(oe.currentUser?.email||"E-mail não disponível"),a=m.userName?m.userName.charAt(0):"U";Ed.innerHTML=`
    ...
    `,await Cd()}async function Cd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await Or(t);Id=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const o=x(a.name);e.innerHTML=`
            ...
            `,Td(a.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>Ot(a.id,r.target.value)),Ot(a.id,"future")}else e.innerHTML=`
    ...
    `;const t=document.getElementById("hierarchy-list-container"),a=document.getElementById("est-parent");try{const s=(await Ue()).matrizes||[];if(a&&(a.innerHTML='<option value="">Nenhuma (Criar como Matriz Independente)</option>'),s.length===0)t.innerHTML=`
            ...
            `;else{let r="";s.forEach(i=>{if(a&&!i.isOrphanBranch){const l=document.createElement("option");l.value=i.id,l.textContent=i.name,a.appendChild(l)}const n=i.isMatriz||!i.parentId?'<span class="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">🏢 MATRIZ</span>':'<span class="bg-amber-100 text-amber-700 text-[10px] font-bold px-2 py-1 rounded ml-3 tracking-wider">📍 UNIDADE</span>';r+=`
                ...
                `}),t.innerHTML=r}ko||(Dd(),ko=!0)}catch(o){console.error("Erro na renderização da rede:",o),t.innerHTML=`
        ...
        `}}function Dd(){const e=document.getElementById("form-create-establishment");e&&e.addEventListener("submit",async t=>{t.preventDefault();const a=e.querySelector('button[type="submit"]'),o=a.innerHTML;a.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span> A gravar...',a.disabled=!0;const s={name:document.getElementById("est-name").value.trim(),cnpj:document.getElementById("est-cnpj").value.trim(),parentId:document.getElementById("est-parent").value||null,timezone:document.getElementById("est-timezone").value};try{const r=await mr(s);alert(r.message||"Sucesso!"),e.reset();const i=document.getElementById("modal-create-establishment"),n=window.bootstrap?.Modal.getInstance(i);n&&n.hide(),await zt(document.getElementById("content"))}catch(r){console.error("Erro ao criar estabelecimento:",r),alert("Erro: "+(r.message||"Falha ao gravar dados."))}finally{a.innerHTML=o,a.disabled=!1}})}window.loadAndRenderHierarchy=()=>zt(document.getElementById("content"));document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("gesturestart",function(t){t.preventDefault()}),document.addEventListener("gesturechange",function(t){t.preventDefault()}),document.addEventListener("gestureend",function(t){t.preventDefault()});let e=0;document.addEventListener("touchend",function(t){const a=new Date().getTime();a-e<=300&&t.preventDefault(),e=a},!1)});const te=document.getElementById("loadingScreen"),Qe=document.getElementById("dashboardContent"),qe=document.getElementById("content"),na=document.getElementById("notificationBell"),Lt=document.getElementById("notificationBadge"),Ce=document.getElementById("notificationPanel"),la=document.getElementById("notificationList"),Xe=document.getElementById("profileMenuButton"),K=document.getElementById("profileDropdown"),So=document.getElementById("profileName"),$o=document.getElementById("profileEmail"),Eo=document.getElementById("logoutButton"),Io=document.getElementById("myProfileLink"),Lo=document.getElementById("hamburger-menu-btn"),Z=document.getElementById("sidebar"),ae=document.getElementById("mobile-overlay"),ya=document.getElementById("mobile-bottom-nav"),Ve=document.getElementById("nav-scroll"),Co=document.getElementById("scroll-hint-left"),To=document.getElementById("scroll-hint-right"),Pd=document.querySelectorAll(".bottom-nav-item");function wa(){if(!Ve||!Co||!To)return;const{scrollLeft:e,scrollWidth:t,clientWidth:a}=Ve;Co.classList.toggle("visible",e>5),To.classList.toggle("visible",e+a<t-5)}function Bd(){if(!Ve)return;const e=document.querySelector(".bottom-nav-item.active");if(!e)return;const t=Ve,a=t.getBoundingClientRect(),o=e.getBoundingClientRect(),r=o.left+o.width/2-a.left-a.width/2;t.scrollBy({left:r,behavior:"smooth"})}const Md={"agenda-section":Qo,"comandas-section":Hi,"relatorios-section":tn,"servicos-section":$n,"produtos-section":Rn,"suppliers-section":Nn,"profissionais-section":At,"clientes-section":gl,"estabelecimento-section":e=>ks(e),"ausencias-section":Bl,"users-section":qt,"sales-report-section":Yl,"financial-section":Zl,"commissions-section":dd,"packages-section":Fa,"my-profile-section":Ld,"hierarquia-section":()=>zt(qe),"establishments-section":()=>zt(qe)},Do={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};function Po(e){const t=Do[e]||Do.indigo,o=(r=>{const i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r);return i?`${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const s=document.getElementById("dynamic-theme-styles");s&&(s.innerHTML=`
            :root {
        ...
        `)}let lt=null,dt=[];function Ps(){if(!Lt||!la)return;const e=dt.filter(t=>!t.read).length;if(e>0?(Lt.textContent=e,Lt.classList.remove("hidden")):Lt.classList.add("hidden"),dt.length===0){la.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}la.innerHTML=dt.map(t=>`
    ...
    `).join("")}function Ad(e){lt&&lt();const t=Vt(pe,"establishments",e,"notifications"),a=Ao(t,qo("timestamp",">=",new Date),Ws("timestamp","desc"));lt=Js(a,o=>{o.docChanges().forEach(s=>{if(s.type==="added"){const r=s.doc.data();dt.unshift({title:r.title,message:r.message,time:r.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(r.title,r.message,"info",!0),Ps();const i=document.querySelector(".sidebar-link.active");i&&i.dataset.target==="agenda-section"&&Qo()}})},o=>{console.error("Erro no listener de notificações:",o)})}async function qd(e){const t=document.getElementById("global-context-switcher"),a=t?.parentElement;if(!(!t||!a))try{const s=(await Ue()).matrizes||[];let r="",i=0;if(s.forEach(n=>{r+=`<option value="${n.id}" class="font-bold">🏢 ${n.name}</option>`,i++,n.branches&&n.branches.length>0&&n.branches.forEach(l=>{r+=`<option value="${l.id}">&nbsp;&nbsp;&nbsp;📍 ${l.name}</option>`,i++})}),i>0){t.innerHTML=r,a.classList.remove("hidden"),a.classList.add("flex");let n=e;Array.from(t.options).some(u=>u.value===e)||(n=t.options[0].value),t.value=n;const l=t.cloneNode(!0);t.parentNode.replaceChild(l,t);const d=async(u,p,f=!1)=>{te&&!f&&(te.classList.remove("hidden","fade-out"),te.style.display="flex");try{const b=await we(u);if(m.establishmentId=u,m.establishmentName=p,m.enabledModules=b.modules,m.currentViewContext={id:u,name:p,type:b.parentId?"BRANCH":"GROUP"},typeof Po=="function"&&Po(b.themeColor||"indigo"),Ad(u),Rd(m.userPermissions),!f){g("Unidade Alterada",`Agora a gerir: ${p}`,"info");const v=document.querySelector(".sidebar-link.active"),h=v?v.getAttribute("data-target"):"agenda-section";Y(h)}}catch(b){console.error("Erro ao trocar de contexto:",b),f||g("Erro","Falha ao aceder aos dados desta unidade.","error")}finally{te&&!f&&(te.classList.add("fade-out"),setTimeout(()=>{te.style.display="none"},500))}},c=l.options[l.selectedIndex].text.replace(/🏢 |📍 |&nbsp;/g,"").trim();await d(n,c,!0),l.addEventListener("change",async u=>{const p=u.target.value,f=u.target.options[u.target.selectedIndex].text.replace(/🏢 |📍 |&nbsp;/g,"").trim();await d(p,f,!1)})}else a.classList.add("hidden"),a.classList.remove("flex")}catch(o){console.error("Erro ao carregar switcher de contexto:",o),a.classList.add("hidden")}}function Y(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const s=["hierarquia-section","establishments-section","estabelecimento-section"].includes(e),r=m.enabledModules?.[a]!==!1,i=m.userPermissions===null||m.userPermissions[e]?.view===!0;if(!s&&(!r||!i)){qe&&(qe.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>'),document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active")),Z&&Z.classList.contains("absolute")&&(Z.classList.add("hidden"),ae&&ae.classList.add("hidden"));return}}const o=Md[e];o&&qe&&(document.querySelectorAll(".sidebar-link").forEach(s=>{s.classList.toggle("active",s.getAttribute("data-target")===e)}),ya&&(Pd.forEach(s=>{s.classList.toggle("active",s.getAttribute("data-target")===e)}),setTimeout(Bd,50),setTimeout(wa,100)),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(s=>s.classList.remove("active")),qe.innerHTML="",window.innerWidth<768&&Z&&(Z.classList.add("hidden"),ae&&ae.classList.add("hidden")),o(t))}window.navigateTo=Y;async function Rd(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),o=document.getElementById("kpi-today-appointments"),s=document.getElementById("kpi-today-revenue"),r=e===null||e["agenda-section"]?.view===!0,i=e===null||e["financial-section"]?.view===!0;if(r&&t&&(t.classList.remove("hidden"),t.classList.add("inline-flex")),i&&a&&(a.classList.remove("hidden"),a.classList.add("inline-flex")),!(!r&&!i))try{const n=await qr();r&&o&&(o.textContent=n.todayAppointments.toString()),i&&s&&(s.textContent=`R$ ${n.todayRevenue.toFixed(2).replace(".",",")}`)}catch(n){console.error("Erro ao carregar KPIs do cabeçalho:",n)}}async function Nd(e){try{le.getPlatform()==="android"&&await X.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0});let t=await X.checkPermissions();if(t.receive==="prompt"&&(t=await X.requestPermissions()),t.receive!=="granted")return;await X.register(),X.addListener("registration",async a=>{try{const o=gt(pe,"users",e);await ka(o,{fcmTokens:_s(a.value),platform:"native_mobile"})}catch{}}),X.addListener("pushNotificationReceived",a=>g(a.title,a.body,"info",!0)),X.addListener("pushNotificationActionPerformed",()=>Y("agenda-section"))}catch{}}function jd(){const e=document.getElementById("exitConfirmationModal"),t=document.getElementById("btn-cancel-exit"),a=document.getElementById("btn-confirm-exit"),o=()=>e&&(e.style.display="block"),s=()=>e&&(e.style.display="none"),r=()=>e&&e.style.display==="block";e&&(t.addEventListener("click",()=>{s(),le.isNativePlatform()||history.pushState(null,document.title,location.href)}),a.addEventListener("click",()=>{s(),le.isNativePlatform()?Ja.exitApp():history.back()}),le.isNativePlatform()?Ja.addListener("backButton",()=>{if(r())s();else{const i=document.querySelectorAll('.modal[style*="display: block"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none");return}if(Z&&!Z.classList.contains("hidden")&&window.innerWidth<768){Z.classList.add("hidden"),ae&&ae.classList.add("hidden");return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="agenda-section"?o():Y("agenda-section")}}):(history.pushState(null,document.title,location.href),window.addEventListener("popstate",()=>{if(r()){s(),history.pushState(null,document.title,location.href);return}const i=document.querySelectorAll('.modal[style*="display: block"], .modal[style*="display: flex"]'),n=Array.from(i).filter(d=>d.id!=="exitConfirmationModal");if(n.length>0){n.forEach(d=>d.style.display="none"),history.pushState(null,document.title,location.href);return}const l=document.querySelector(".sidebar-link.active");l&&l.getAttribute("data-target")==="agenda-section"?o():(Y("agenda-section"),history.pushState(null,document.title,location.href))})))}async function Fd(){try{await js(oe,Fs)}catch{}le.isNativePlatform()&&document.body.classList.add("is-app-native"),rr(),jd(),Lo&&Lo.addEventListener("click",e=>{e.stopPropagation(),Z&&(Z.classList.remove("hidden"),Z.classList.add("absolute","inset-y-0","left-0","z-40","shadow-xl")),ae&&ae.classList.remove("hidden")}),ya&&(ya.addEventListener("click",e=>{const t=e.target.closest(".bottom-nav-item");if(!t)return;e.preventDefault();const a=t.getAttribute("data-target");Y(a)}),Ve&&Ve.addEventListener("scroll",wa),wa()),ae&&ae.addEventListener("click",()=>{Z&&(Z.classList.add("hidden"),Z.classList.remove("absolute","inset-y-0","left-0","z-40","shadow-xl")),ae.classList.add("hidden")}),na&&na.addEventListener("click",e=>{e.stopPropagation(),Ce&&(Ce.classList.toggle("hidden"),Ce.classList.contains("hidden")||(dt.forEach(t=>t.read=!0),Ps()))}),Xe&&Xe.addEventListener("click",e=>{e.stopPropagation(),K&&(K.classList.toggle("active"),K.classList.contains("active")?K.classList.remove("hidden"):setTimeout(()=>K.classList.add("hidden"),200))}),Io&&Io.addEventListener("click",e=>{e.preventDefault(),Y("my-profile-section"),K&&(K.classList.remove("active"),K.classList.add("hidden"))}),document.addEventListener("click",e=>{Ce&&!Ce.contains(e.target)&&e.target!==na&&Ce.classList.add("hidden"),K&&!K.contains(e.target)&&e.target!==Xe&&K.classList.contains("active")&&(K.classList.remove("active"),setTimeout(()=>K.classList.add("hidden"),200))}),Hs(oe,async e=>{if(e){if(!le.isNativePlatform()&&(Dr(),"Notification"in window&&Notification.permission==="default")){const t=document.getElementById("toast-notification-request"),a=document.getElementById("btn-enable-toast");t&&setTimeout(()=>{t.style.display="block"},3500),a&&a.addEventListener("click",async()=>{await Pr()&&t&&(t.style.display="none")});const o=()=>{t&&(t.style.display="none")},s=document.getElementById("btn-deny-toast"),r=document.getElementById("btn-close-toast");s&&s.addEventListener("click",o),r&&r.addEventListener("click",o)}try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="admin"||a.role==="employee")&&a.establishmentId){const o=await we(a.establishmentId);let s=null,r=e.displayName,i=null;const n=gt(pe,"users",e.uid),l=await Bo(n);if(l.exists()){const c=l.data();s=a.role==="employee"?c.permissions||{}:null,r=c.name||r,i=c.professionalId||null}m.userProfessionalId=i,le.isNativePlatform()&&Nd(e.uid);const d=r||e.email;Qs(a.establishmentId,o.name,s),Xe&&(Xe.textContent=d.charAt(0).toUpperCase()),So&&(So.textContent=d),$o&&($o.textContent=e.email),Eo&&Eo.addEventListener("click",c=>{c.preventDefault(),lt&&lt(),Os(oe).then(()=>window.location.href="/login.html")}),await qd(a.establishmentId),ur(Y,s,m.enabledModules),te&&(te.classList.add("fade-out"),setTimeout(()=>{te.style.display="none"},500)),Qe&&(Qe.style.display="flex"),setTimeout(()=>{fr()},1500),Y("agenda-section")}else throw new Error("Permissão ou estabelecimento não configurado.")}catch(t){console.error("Erro na inicialização:",t),te&&(te.style.display="none"),Qe&&(Qe.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center p-4 text-center"><h2>Erro de Acesso</h2><p>${t.message}</p></div>`,Qe.style.display="flex")}}else window.location.href="/login.html"})}Fd();export{jo as W};
