const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-IzoGjcb2.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/firebase-config-C2tbVz-J.js","assets/styles-C2XZ_b0c.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as U,d as _,m as Fa}from"./firebase-config-C2tbVz-J.js";import{EmailAuthProvider as Ps,reauthenticateWithCredential as Ds,verifyBeforeUpdateEmail as Bs,updatePassword as Ms,updateProfile as As,setPersistence as qs,browserLocalPersistence as Ns,onAuthStateChanged as Do,signOut as Ha}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{doc as me,getDoc as Bo,updateDoc as ha,setDoc as Rs,addDoc as Mo,collection as pe,query as Rt,where as st,getDocs as xa,orderBy as Ao,writeBatch as qo,serverTimestamp as Oa,deleteDoc as js,arrayUnion as Fs,onSnapshot as Hs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import{getToken as Os,onMessage as zs}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-messaging.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-storage.js";const m={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,establishmentSettings:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function Vs(e,t,a){m.establishmentId=e,m.establishmentName=t,m.userPermissions=a}const No=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ia=No?"http://localhost:8080":"https://kairos-app-407358446276.us-central1.run.app";console.log(`🚀 API configurada para modo: ${No?"LOCAL (Dev)":"PRODUÇÃO (Cloud)"}`);console.log("📡 URL Base:",ia);async function Us(){const e=U.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function E(e,t={}){const a=await Us();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=ia.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,o=`${s}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${o}`);try{const n=await fetch(o,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ia}. Verifique se o servidor backend está rodando.`):n}}const Ro=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),E(r)},_s=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return E(r)},Ws=e=>E("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Js=(e,t)=>E(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),za=e=>E(`/api/appointments/${e}`,{method:"DELETE"}),Gs=e=>E(`/api/appointments/${e}/reopen`,{method:"POST"}),Ys=(e,t)=>E(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let W;async function Qs(){if(!W)try{W=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Xs(){if(!W){console.warn("AudioContext não inicializado. O som não será tocado.");return}W.state==="suspended"&&W.resume();const e=W.createOscillator(),t=W.createGain();e.connect(t),t.connect(W.destination),e.type="sine",e.frequency.setValueAtTime(800,W.currentTime),t.gain.setValueAtTime(0,W.currentTime),t.gain.linearRampToValueAtTime(.3,W.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,W.currentTime+.2),e.start(W.currentTime),e.stop(W.currentTime+.2)}function p(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&Xs();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function jt(e){const t=document.getElementById(e);t&&(t.style.display="none")}function Zs(){document.body.addEventListener("click",()=>{W||Qs()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const s=t.dataset.target;if(s){const r=document.getElementById(s);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}const X=document.getElementById("sidebar"),Va=document.getElementById("sidebarToggle"),Qe=document.getElementById("mainContent"),Ks=document.querySelectorAll(".sidebar-link"),Ua=document.getElementById("hamburger-menu-btn"),Re=document.getElementById("mobile-overlay");function wt(e){!X||!Qe||(X.classList.toggle("collapsed",e),Qe.classList.toggle("sidebar-collapsed-shift",e))}function er(){!X||!Re||(X.classList.add("mobile-open"),Re.classList.add("visible"))}function mt(){!X||!Re||(X.classList.remove("mobile-open"),Re.classList.remove("visible"))}function tr(){wt(!X.classList.contains("collapsed"))}function ar(e,t,a){if(!X||!Qe)return;Qe.classList.add("main-content-shift"),window.innerWidth>=768?wt(X.classList.contains("collapsed")):(Qe.classList.remove("main-content-shift","sidebar-collapsed-shift"),mt()),Va&&Va.addEventListener("click",r=>{r.stopPropagation(),tr()}),X.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&X.classList.contains("collapsed")&&wt(!1)}),X.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||wt(!0))}),Ua&&Ua.addEventListener("click",r=>{r.stopPropagation(),er()}),Re&&Re.addEventListener("click",r=>{r.stopPropagation(),mt()});let s=0;X.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),X.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&mt()},{passive:!0}),Ks.forEach(r=>{const o=r.getAttribute("data-target"),n=o.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[o]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),o&&typeof e=="function"&&e(o),window.innerWidth<768&&mt()})})}const $e=e=>{const t=e||m.establishmentId;return t?E(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},kt=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},or=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},sr=(e,t)=>{const a=e||m.establishmentId;return a?E(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},K=e=>E(`/api/professionals/${e}`),rr=e=>E(`/api/professionals/details/${e}`),jo=e=>E("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Ct=(e,t)=>E(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),_a=(e,t)=>Ct(e,{services:t}),Fo=e=>E(`/api/professionals/${e}`,{method:"DELETE"}),nr=e=>{const t=e.map(a=>Fo(a));return Promise.all(t)},ge=e=>E(`/api/services/${e}`),Ho=e=>E("/api/services",{method:"POST",body:JSON.stringify(e)}),ir=(e,t)=>E(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),lr=e=>E(`/api/services/${e}`,{method:"DELETE"}),dr=(e,t)=>E(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),cr=e=>E(`/api/services/stats/most-popular/${e}`),lt=e=>E(`/api/products/${e}`),Oo=e=>E("/api/products",{method:"POST",body:JSON.stringify(e)}),ur=(e,t)=>E(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),mr=e=>E(`/api/products/${e}`,{method:"DELETE"}),pr=(e,t)=>E(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),gr=({startDate:e,endDate:t,productId:a,categoryId:s,establishmentId:r})=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),r&&o.append("establishmentId",r),E(`/api/products/stock-history/report?${o.toString()}`)},br={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}};function Wa(e,t,a){return new Promise((s,r)=>{const o=new FileReader;o.readAsDataURL(e),o.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const g=e.type==="image/png"&&t<500?"image/png":"image/jpeg";s(l.toDataURL(g,a))},i.onerror=l=>r(l)},o.onerror=n=>r(n)})}let ce=null;const St=[{id:"company_data",title:"Identidade do Negócio",icon:"🏢",description:"Configure os dados da sua empresa."},{id:"branding",title:"Sua Marca",icon:"🎨",description:"Logo e cores (Opcional)."},{id:"time_config",title:"O Relógio",icon:"⏱️",description:"Tempo padrão entre agendamentos."},{id:"first_service",title:"O Menu",icon:"✂️",description:"Seu principal serviço."},{id:"first_prof",title:"Sua Equipe",icon:"💇",description:"Cadastre o primeiro profissional."},{id:"first_product",title:"O Estoque",icon:"🧴",description:"Cadastre um produto (opcional)."}];let ee=0,Lt=[];async function fr(){try{console.log("Iniciando verificação de Onboarding para ID:",m.establishmentId);const e=await $e(m.establishmentId),t=await K(m.establishmentId),a=await ge(m.establishmentId);Lt=a||[];const s=e&&e.name&&(e.phone||e.address),r=e&&(e.logo||e.themeColor&&e.themeColor!=="indigo"),o=e&&e.slotInterval>0,n=a&&a.length>0,i=t&&t.length>0;if(console.log("Status Onboarding:",{hasCompanyData:s,hasBranding:r,hasTimeConfig:o,hasService:n,hasProf:i}),s&&o&&i&&n)return;if(!s)ee=0;else if(!r&&!o)ee=1;else if(!o)ee=2;else if(!n)ee=3;else if(!i)ee=4;else if(ee===0)return;vr(),wa(ee)}catch(e){console.error("Erro ao verificar onboarding:",e)}}function vr(){document.getElementById("onboarding-overlay")||(ce=document.createElement("div"),ce.id="onboarding-overlay",ce.className="fixed inset-0 bg-gray-900 bg-opacity-95 z-[9999] flex items-center justify-center p-4 overflow-y-auto",ce.style.cssText="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(17, 24, 39, 0.95); z-index: 9999; display: flex; align-items: center; justify-content: center;",ce.innerHTML=`
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="themeColor" class="mt-1 w-full p-2 border rounded text-sm bg-white">
                            ${Object.entries(br).map(([o,n])=>`<option value="${o}">${n.name}</option>`).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{ce&&ce.remove(),window.location.reload()}}async function hr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),s=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),o=Object.fromEntries(r.entries());try{if(e==="company_data")await kt(m.establishmentId,{name:o.name,phone:o.phone,email:o.email,address:o.address,zipCode:o.zipCode});else if(e==="branding"){const n={};o.logoBase64&&(n.logo=o.logoBase64),o.bgBase64&&(n.backgroundImage=o.bgBase64),o.themeColor&&(n.themeColor=o.themeColor),o.primaryColor&&(n.primaryColor=o.primaryColor),Object.keys(n).length>0&&await kt(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(o.slotInterval);await kt(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Ho({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.price),duration:parseInt(o.duration),active:!0});n&&Lt.push(n)}else if(e==="first_prof"){const n=await jo({establishmentId:m.establishmentId,name:o.name,specialty:o.role,active:!0,commissionRate:0});if(o.serviceId&&n&&n.id)try{_a?await _a(n.id,[o.serviceId]):Ct&&await Ct(n.id,{services:[o.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Oo({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.salePrice),stock:parseInt(o.stock),active:!0});p("Sucesso","Passo concluído!","success"),ee++,ya(),wa(ee)}catch(n){p("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=s}}var je;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(je||(je={}));class Xt extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const xr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},yr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:xr(e),o=()=>r()!=="web",n=u=>{const g=d.get(u);return!!(g?.platforms.has(r())||i(u))},i=u=>{var g;return(g=a.PluginHeaders)===null||g===void 0?void 0:g.find(b=>b.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,g={})=>{const b=d.get(u);if(b)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),b.proxy;const h=r(),v=i(u);let y;const w=async()=>(!y&&h in g?y=typeof g[h]=="function"?y=await g[h]():y=g[h]:t!==null&&!y&&"web"in g&&(y=typeof g.web=="function"?y=await g.web():y=g.web),y),S=(P,D)=>{var R,F;if(v){const z=v?.methods.find(j=>D===j.name);if(z)return z.rtype==="promise"?j=>a.nativePromise(u,D.toString(),j):(j,Q)=>a.nativeCallback(u,D.toString(),j,Q);if(P)return(R=P[D])===null||R===void 0?void 0:R.bind(P)}else{if(P)return(F=P[D])===null||F===void 0?void 0:F.bind(P);throw new Xt(`"${u}" plugin is not implemented on ${h}`,je.Unimplemented)}},k=P=>{let D;const R=(...F)=>{const z=w().then(j=>{const Q=S(j,P);if(Q){const Ee=Q(...F);return D=Ee?.remove,Ee}else throw new Xt(`"${u}.${P}()" is not implemented on ${h}`,je.Unimplemented)});return P==="addListener"&&(z.remove=async()=>D()),z};return R.toString=()=>`${P.toString()}() { [capacitor code] }`,Object.defineProperty(R,"name",{value:P,writable:!1,configurable:!1}),R},I=k("addListener"),L=k("removeListener"),B=(P,D)=>{const R=I({eventName:P},D),F=async()=>{const j=await R;L({eventName:P,callbackId:j},D)},z=new Promise(j=>R.then(()=>j({remove:F})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},z},N=new Proxy({},{get(P,D){switch(D){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?B:I;case"removeListener":return L;default:return k(D)}}});return s[u]=N,d.set(u,{name:u,proxy:N,platforms:new Set([...Object.keys(g),...v?[h]:[]])}),N};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Xt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},wr=e=>e.Capacitor=yr(e),oe=wr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ft=oe.registerPlugin;class zo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new oe.Exception(t,je.Unimplemented)}unavailable(t="not available"){return new oe.Exception(t,je.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Ga=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ya=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class kr extends zo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Ya(r).trim(),o=Ya(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Ga(t.key),s=Ga(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ft("CapacitorCookies",{web:()=>new kr});const Sr=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),$r=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},Er=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,Ir=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=$r(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Cr extends zo{async request(t){const a=Ir(t,t.webFetchExtra),s=Er(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await Sr(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const c={};return o.headers.forEach((u,g)=>{c[g]=u}),{data:l,headers:c,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ft("CapacitorHttp",{web:()=>new Cr});const G=Ft("PushNotifications",{}),Lr="modulepreload",Tr=function(e){return"/"+e},Qa={},Pr=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),i=n?.nonce||n?.getAttribute("nonce");r=l(a.map(d=>{if(d=Tr(d),d in Qa)return;Qa[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const g=document.createElement("link");if(g.rel=c?"stylesheet":Lr,c||(g.as="script"),g.crossOrigin="",g.href=d,i&&g.setAttribute("nonce",i),document.head.appendChild(g),c)return new Promise((b,h)=>{g.addEventListener("load",b),g.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(n){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=n,window.dispatchEvent(i),!i.defaultPrevented)throw n}return r.then(n=>{for(const i of n||[])i.status==="rejected"&&o(i.reason);return t().catch(o)})},Xa=Ft("App",{web:()=>Pr(()=>import("./web-IzoGjcb2.js"),__vite__mapDeps([0,1,2,3])).then(e=>new e.AppWeb)}),Dr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Za=!1;async function Vo(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{Wo(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&_o()}async function Uo(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await _o(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function _o(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Os(Fa,{vapidKey:Dr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Wo(t,!1)):console.warn("[Push Web] Token veio vazio."),Za||(zs(Fa,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Za=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Wo(e,t){const a=U.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=me(_,"users",a.uid);try{const r=await Bo(s);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await ha(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Rs(s,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",r)}}const Br=(e,t,a="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),E(`/api/reports/indicators?${r.toString()}`)},Mr=e=>e?E(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Ar=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),E(`/api/reports/sales?${r.toString()}`)},qr=()=>E("/api/reports/summary",{method:"GET"}),Ht=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return E(r)},Ot=e=>E("/api/blockages",{method:"POST",body:JSON.stringify(e)}),ka=e=>E(`/api/blockages/${e}`,{method:"DELETE"}),Jo=e=>E("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Sa=e=>e?String(e).replace(/\D/g,""):"",zt=(e,t="",a=20,s={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),s&&s.hasLoyalty&&r.append("hasLoyalty","true"),s&&s.birthMonth&&r.append("birthMonth",s.birthMonth),s&&s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),E(`/api/clients/${e}?${r.toString()}`)},Go=(e,t)=>{const a=encodeURIComponent(t);return E(`/api/clients/details/${e}/${a}`)},Yo=e=>{const t=e.phone||e.id;if(!t)throw new Error("Telefone é obrigatório");const a=Sa(t),s={...e,phone:a,id:a};return E(`/api/clients/${a}`,{method:"PUT",body:JSON.stringify(s)})},$a=Yo,Qo=(e,t)=>Yo({...t,id:e}),Nr=e=>{const t=encodeURIComponent(e);return E(`/api/clients/${t}`,{method:"DELETE"})},Rr=(e,t,a,s)=>E("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Sa(t),points:a,rewardName:s})}),jr=(e,t)=>Go(e,Sa(t));function f(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Xo(e,t=800,a=800,s=.7){return new Promise((r,o)=>{if(!e.type.match(/image.*/))return o(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const b=u.toDataURL("image/jpeg",s);r(b)},l.onerror=d=>o(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>o(new Error("Erro ao ler o ficheiro."))})}const Ka=document.getElementById("content");let eo=!1;const la=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let dt=[],Vt=[],Fe={},Ae=[],T={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},C={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Fr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Zo(e){const t=new Date(e);if(t.setHours(0,0,0,0),T.currentView==="week"&&T.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function Tt(){const e=document.getElementById("profSelectorContainer"),t=T.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let a=m.professionals.filter(o=>T.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=T.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",c=f(i),u=la[0],g=o.id!=="all"&&m.professionalColors.get(o.id)||u,b=o.photo||`https://placehold.co/64x64/${g.main?.replace("#","")||"E0E7FF"}/${g.light?.replace("#","")||"4F46E5"}?text=${l}`,h=o.id==="all"?"#e0e7ff":g.light,v=o.id==="all"?"#4f46e5":g.main,w=`border: 3px solid ${n?g.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+g.border:"none"};`;return`
        ...
        `}).join("")}function Hr(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function Or(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(s.professionalId)||{},d=f(s.reason),c=f(s.professionalName),u=f(s.clientName),g=f(s.serviceName),b=T.selectedItems.has(s.id),h=T.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const v=s.status==="completed",y=v?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",w=v?"Finalizado":"Aberto",S=JSON.stringify(s).replace(/'/g,"&apos;"),k=s.redeemedReward?.points>0,I=s.hasRewards&&!k,L=Hr(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),B=T.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${S}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
                    ...
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                        ...
                        <div class="mt-1 min-w-0">
                            <p class="font-semibold text-sm text-gray-800 truncate">${B?"🎁 ":""}${S}</p>
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",l=>{l.target.checked&&(C.data.redeemedReward=null)})}async function Wr(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!C.data.time||C.data.selectedServiceIds.length===0||!C.data.professionalId)return p("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const s=C.data.selectedServiceIds.map(d=>{const c=dt.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,o]=C.data.time.split(":"),n=new Date(`${C.data.date}T${r}:${o}:00`),i={establishmentId:m.establishmentId,clientName:C.data.clientName,clientPhone:C.data.clientPhone,services:s,professionalId:C.data.professionalId,startTime:n.toISOString(),redeemedReward:C.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await Js(l,i):await Ws(i),p(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",ae()}catch(d){p(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function as(e){const t=C.data.clientName===e.name&&C.data.clientPhone===e.phone,a=f(e.name),s=f(e.phone);return`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",Gr)}function Qr(){Yr()}function Xr(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",s=`
    ...
    `;return{title:a,content:s}}function Zr(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${dt.map(s=>{const r=C.data.selectedServiceIds.includes(s.id),o=s.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=f(s.name);return`
    ...
    `;return{title:e,content:a}}function Kr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:e,content:t}}function en(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,s=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=C.data.date||s,o=f(C.data.clientName),n=f(C.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function tn(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),s=dt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=C.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>es(r.dataset.serviceId,r))})}function an(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),s=Vt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=C.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=f(r.name);return`
    ...
    `,Ut()}function Ut(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");x.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `),t&&(t.classList.add("opacity-50","cursor-not-allowed"),t.disabled=!0)),hn()}function hn(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `,o.appendChild(w)}),e.innerHTML="",e.appendChild(o),so(t)}function so(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:s}=x.paging,r=Math.ceil((a||0)/s);if(r===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full",o.innerHTML=`
    ...
    `;if(!x.isCashierOpen){e.innerHTML=`
        ...
        `;return}const s=Se(t),r=t.status==="completed",o=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),n=s.reduce((v,y)=>{const w=y._source==="original_service",S=y.id||y.name,k=w?`original-${S}`:`${y.type}-${S}`;return v[k]||(v[k]={...y,quantity:0,sources:[]}),v[k].quantity+=1,y._source&&v[k].sources.push(y._source),v},{}),i=Object.values(n).reduce((v,y)=>v+Number(y.price||0)*y.quantity,0),l=f(t.clientName||"Cliente sem nome"),d=f(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,b=`
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(n).map(v=>{const y=v.sources&&v.sources.includes("original_service"),w=x.pendingRedemption&&String(x.pendingRedemption.appliedToItemId)===String(v.id),S=v.isReward||w;return`
        ...
        ${r?"":h}
    `,!r&&(t.clientId||t.clientName)&&yn(t,e.querySelector("#loyalty-container"))}function xn(e,t){const s=Se(e).reduce((g,b)=>g+Number(b.price||0)*(b.quantity||1),0),r=x.checkoutState,o=r.discount||{type:"real",value:0};let n=0;o.type==="percent"?n=s*o.value/100:n=o.value,n>s&&(n=s);const i=s-n,l=r.payments.reduce((g,b)=>g+b.value,0),d=Math.max(0,i-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
    ...
    `;const u=()=>{const g=x.checkoutState.discount.type,b=x.checkoutState.discount.value;let h=g==="percent"?s*b/100:b;h>s&&(h=s);const v=s-h,y=x.checkoutState.payments.reduce((L,B)=>L+B.value,0),w=Math.max(0,v-y),S=t.querySelector("#checkout-total-display");S&&(S.textContent=`R$ ${v.toFixed(2)}`);const k=t.querySelector("#checkout-status-msg");k&&(w<=.01?k.innerHTML='<p class="text-green-600 font-bold text-lg">Pago</p>':k.innerHTML=`<p class="text-red-500 font-medium">Faltam: <span id="checkout-remaining-display">R$ ${w.toFixed(2)}</span></p>`);const I=t.querySelector("#checkout-amount");I&&w>0&&document.activeElement!==I&&(I.value=w.toFixed(2))};t.querySelector("#discount-value")?.addEventListener("input",g=>{const b=parseFloat(g.target.value)||0;x.checkoutState.discount.value=b,u()}),t.querySelector("#discount-type")?.addEventListener("change",g=>{x.checkoutState.discount.type=g.target.value,u()}),t.querySelector("#discount-reason")?.addEventListener("input",g=>{x.checkoutState.discountReason=g.target.value}),t.querySelector("#checkout-amount")?.addEventListener("input",g=>{x.checkoutState.amountReceived=g.target.value}),t.querySelector("#checkout-installments")?.addEventListener("change",g=>{x.checkoutState.installments=parseInt(g.target.value,10)})}async function yn(e,t){if(!t)return;const a=x.loyaltySettings;if(!a||!a.enabled)return;let s=null;try{if(e.clientId)s=await Go(m.establishmentId,e.clientId);else if(e.clientName){const i=await zt(m.establishmentId,e.clientName,1);i&&i.length>0&&(s=i[0])}}catch(i){console.warn("Erro ao buscar dados de fidelidade",i)}if(!s||s.loyaltyPoints===void 0)return;const r=Number(s.loyaltyPoints)||0,n=(a.tiers||a.rewards||[]).filter(i=>{const l=Number(i.costPoints||i.points||0);return l>0&&r>=l});if(n.length>0){const i=document.createElement("div");i.className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 shadow-sm flex justify-between items-center animate-fade-in",i.innerHTML=`
        ...
        `;const l=document.createElement("button");l.innerText="Resgatar",l.className="text-xs font-bold bg-yellow-500 text-white px-4 py-2 rounded-lg shadow hover:bg-yellow-600 transition-colors",l.onclick=()=>wn(n,e),i.appendChild(l),t.innerHTML="",t.appendChild(i)}}function wn(e,t){const a=`
        <div class="space-y-4">
    ...
    `,{modalElement:s,close:r}=Y({title:"🎁 Resgatar Prémio",contentHTML:a,maxWidth:"max-w-md"});s.addEventListener("click",o=>{const n=o.target.closest('[data-action="select-reward"]');if(n){const i=n.dataset.rewardId,l=e.find(d=>d.id&&d.id==i||(d.name||d.reward)==i);l&&(kn(l,t),r())}})}async function kn(e,t){const a=Number(e.costPoints||e.points||0),s=e.name||e.reward,r=e.type||"money";if(r==="money"){const l=parseFloat(e.discount)||0;if(l<=0){p("Erro","O valor do desconto configurado é inválido.","error");return}x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:e.id||null,name:s,cost:a,type:"money"},p("Sucesso",`Prémio "${s}" resgatado! Desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),V();return}const o=Se(t),n=e.itemId?String(e.itemId):null;if(!n){p("Erro de Configuração",`O prémio "${s}" não tem um item vinculado nas configurações.`,"error");return}const i=o.find(l=>{const d=l.id?String(l.id):null,c=l.serviceId?String(l.serviceId):l.service_id?String(l.service_id):null,u=l.productId?String(l.productId):l.product_id?String(l.product_id):null;return r==="service"?d===n||c===n:r==="product"?d===n||u===n:r==="package"?d===n:!1});if(i){let l=parseFloat(e.discount);(!l||l<=0)&&(l=parseFloat(i.price||0)),x.checkoutState.discount={type:"real",value:l},x.checkoutState.discountReason=`Resgate Fidelidade: ${s}`,x.pendingRedemption={rewardId:e.id||null,name:s,cost:a,type:r,appliedToItemId:i.id},p("Sucesso",`Prémio "${s}" resgatado! Item encontrado e desconto de R$ ${l.toFixed(2)} aplicado.`,"success"),V()}else p("Item Não Encontrado",`Para resgatar o prémio "${s}", o ${r==="service"?"serviço":r==="product"?"produto":"pacote"} correspondente deve estar lançado nesta comanda. Por favor, adicione o item primeiro e tente resgatar novamente.`,"warning")}function Sn(){if(!x.isCashierOpen)return p("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");const{modalElement:e,close:t}=Y({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{const r=e.querySelector("#add-item-content");r.innerHTML=`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",En)}async function En(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector("#regClientName"),r=t.querySelector("#regClientPhone").value.replace(/\D/g,"");if(!a.value||!r)return p("Erro","Nome e Telefone são obrigatórios.","error");try{const o=await jr(m.establishmentId,r);if(o)p("Atenção","Cliente já cadastrado.","info"),document.getElementById("genericModal").style.display="none",ua(o);else{const n=await $a({establishmentId:m.establishmentId,name:a.value,phone:r});p("Sucesso","Cliente cadastrado!","success"),document.getElementById("genericModal").style.display="none",ua(n)}}catch(o){p("Erro",o.message,"error")}}async function In(){const e=`
    ...
    `,{modalElement:t}=Y({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return p("Valor Inválido","Insira um valor válido.","error");try{const r=await dn({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",p("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),Ut(),await re()}catch(r){p("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function Cn(){const e=x.activeCashierSessionId;if(e)try{const t=await mn(e),a=`
        ...
        `,{modalElement:s}=Y({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return p("Valor Inválido","Insira um valor final válido.","error");try{await cn(e,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Ut(),await re(),p("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){p("Erro",`Falha ao fechar caixa: ${n.message}`,"error")}})}catch(t){p("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Ln(e){if(x.activeFilter===e)return;x.activeFilter=e,x.paging.page=1,document.querySelectorAll(".filter-btn").forEach(a=>a.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),Te(),x.selectedComandaId=null,x.viewMode="items";const t=document.getElementById("comandas-list");t&&(t.innerHTML='<div class="loader mx-auto mt-10"></div>'),await re(),V()}function rs(e){x.selectedComandaId=e,x.viewMode="items",x.pendingRedemption=null,x.checkoutState.discount={type:"real",value:0},x.checkoutState.discountReason="",rt(),fn(),V()}async function ns(e,t){const a=x.allComandas.find(o=>o.id===x.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),p("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(e.price)||0,r=Array(t).fill(0).map(()=>{const o={id:String(e.id),name:e.name,price:s,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(o.productId=o.id,o.product_id=o.id):e.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...r),a._cachedItems=null,a._hasUnsavedChanges=!0,V()}async function ro(e,t){const a=x.allComandas.find(o=>o.id===x.selectedComandaId);if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>o.id==e&&o.type===t);r>-1&&(a.comandaItems.splice(r,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,V())}async function Tn(e){if(x.isProcessing)return;const t=Se(e),a=t.reduce((y,w)=>y+Number(w.price||0)*(w.quantity||1),0),s=x.checkoutState.discount||{type:"real",value:0};let r=s.type==="percent"?a*s.value/100:s.value;r>a&&(r=a);const o=a-r,{payments:n}=x.checkoutState,i=n.reduce((y,w)=>y+w.value,0),l=o-i;if(l>.01){if(!await O("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;n.push({method:"fiado",value:l,installments:1})}x.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const g=x.loyaltySettings;g&&g.enabled&&(u=parseInt(g.pointsPerVisit||1,10),console.log(`Fidelidade: Cliente ganhou ${u} pontos fixos pela visita.`));const b={...s,reason:x.checkoutState.discountReason||""},h={payments:n,totalAmount:Number(o),items:c,cashierSessionId:x.activeCashierSessionId,loyaltyPointsEarned:u,discount:b,loyaltyRedemption:x.pendingRedemption},v=document.createElement("div");v.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(v);try{d?await Ys(e.id,h):(h.establishmentId=m.establishmentId,h.clientId=e.clientId,h.clientName=e.clientName,h.professionalId=e.professionalId,e.clientPhone&&(h.clientPhone=e.clientPhone),await rn(h));let y="Venda finalizada com sucesso!";u>0&&(y+=` Cliente ganhou ${u} pontos!`),p("Sucesso!",y,"success"),Te(),x.selectedComandaId=null,x.viewMode="items",x.pendingRedemption=null,await re()}catch(y){p("Erro no Checkout",y.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),x.isProcessing=!1}}async function Pn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=t.value,r=document.getElementById("client-search").value,o=t.dataset.phone||"";if(!s)return p("Erro","Selecione um cliente válido.","error");const n=m.professionals.find(l=>l.id===a);if(!n)return p("Erro","Selecione um profissional válido.","error");const i={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:r.split("(")[0].trim(),clientPhone:o,professionalId:n.id,professionalName:n.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(i),x.selectedComandaId=i.id,x.viewMode="items",document.getElementById("genericModal").style.display="none",rs(i.id)}async function re(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=x.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=ln(),s=on(m.establishmentId,t,x.paging.page,x.paging.limit),r=$e(m.establishmentId),[o,n,i]=await Promise.all([a,s,r]);if(x.isCashierOpen=!!o,x.activeCashierSessionId=o?o.id:null,Ut(),i&&i.loyaltyProgram&&(x.loyaltySettings=i.loyaltyProgram),!x.isCashierOpen&&x.activeFilter==="atendimento"){rt(),V();return}if(x.allComandas=n.data||n,x.paging.total=n.total||n.length,x.catalog.services.length===0){const[l,d,c,u]=await Promise.all([ge(m.establishmentId),lt(m.establishmentId),Ca(m.establishmentId),K(m.establishmentId)]);x.catalog={services:l,products:d,packages:c},m.professionals=u}rt(),V()}catch(a){p("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function Dn(e={}){Le=document.getElementById("content"),x.selectedComandaId=e.selectedAppointmentId||null,x.viewMode="items",vn(),Ie&&(Le.removeEventListener("click",Ie),Le.removeEventListener("change",Ie)),Ie=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&x.activeFilter==="finalizadas"){x.paging.page=1,await re();return}if(a){if(a.matches("[data-filter]"))Ln(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}rs(a.dataset.comandaId)}else if(a.matches("[data-action]")){const r=a.dataset.action,o=a.dataset.id||x.selectedComandaId,n=x.allComandas.find(i=>i.id===o);switch(r){case"back-to-list":Te(),x.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(S=>S.classList.remove("selected")),V();break;case"new-sale":ua();break;case"add-item":Sn();break;case"open-cashier":In();break;case"close-cashier":await Cn();break;case"view-sales-report":Z("sales-report-section");break;case"go-to-checkout":await oo(n,"checkout");break;case"back-to-items":x.viewMode="items",V();break;case"save-comanda":await oo(n,"stay");break;case"select-method":x.checkoutState.selectedMethod=a.dataset.method,x.checkoutState.installments=1,V();break;case"add-payment-checkout":const i=document.getElementById("checkout-amount");let l=parseFloat(i.value);const c=Se(n).reduce((S,k)=>S+(k.price||0),0),u=x.checkoutState.discount||{type:"real",value:0};let g=u.type==="percent"?c*u.value/100:u.value;g>c&&(g=c);const b=c-g,h=x.checkoutState.payments.reduce((S,k)=>S+k.value,0),v=b-h;if(isNaN(l)||l<=0){p("Valor inválido","Insira um valor maior que zero.","error");break}if(l>v+.05){p("Valor inválido","Valor excede o restante.","error");break}const y={method:x.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(x.checkoutState.selectedMethod)&&x.checkoutState.installments>1&&(y.installments=x.checkoutState.installments),x.checkoutState.payments.push(y),x.checkoutState.selectedMethod="dinheiro",x.checkoutState.installments=1,x.checkoutState.amountReceived="",V();break;case"remove-payment-checkout":const w=parseInt(a.dataset.index,10);x.checkoutState.payments.splice(w,1),V();break;case"finalize-checkout":await Tn(n);break;case"increase-qty":{const S=a.dataset.itemId,k=a.dataset.itemType;if(!S||S==="undefined"||S==="null"){p("Erro","Item inválido para adição.","error");return}let L=Se(n).find(N=>N.id==S&&N.type===k);L||(L=(x.catalog[k+"s"]||[]).find(P=>P.id==S));const B=L?{id:L.id,name:L.name,price:Number(L.price),type:L.type}:{id:S,name:"Item Indisponível",price:0,type:k};await ns(B,1);break}case"decrease-qty":{await ro(a.dataset.itemId,a.dataset.itemType);break}case"remove-item":await ro(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await O("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Gs(o);const k=x.allComandas.findIndex(I=>I.id===o);k!==-1&&(x.allComandas[k].status="confirmed",delete x.allComandas[k].transaction),x.selectedComandaId=null,Te(),await re(),p("Sucesso!","Comanda reaberta.","success")}catch(k){p("Erro",k.message,"error")}break}case"go-to-appointment":{const S=a.dataset.id,k=a.dataset.date;Z("agenda-section",{scrollToAppointmentId:S,targetDate:new Date(k)});break}case"delete-walk-in":{if(await O("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))x.allComandas=x.allComandas.filter(k=>k.id!==o),x.selectedComandaId=null,rt(),V(),Te();else try{await nn(o),p("Sucesso","Venda excluída.","success"),x.selectedComandaId=null,Te(),await re()}catch(k){p("Erro",k.message,"error")}break}}}}},Le.addEventListener("click",Ie),Le.addEventListener("change",Ie),e.initialFilter&&(x.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(x.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${x.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",x.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await re()}const La=e=>E(`/api/financial/natures/${e}`),Bn=e=>E("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),Mn=e=>E(`/api/financial/natures/${e}`,{method:"DELETE"}),Ta=e=>E(`/api/financial/cost-centers/${e}`),An=e=>E("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),qn=e=>E(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),is=(e,t)=>E(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),ls=(e,t={})=>{let a=`/api/financial/${e}`;const s=new URLSearchParams;t.establishmentId&&s.append("establishmentId",t.establishmentId),t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId),t.status&&s.append("status",t.status);const r=s.toString();return r&&(a+=`?${r}`),E(a)},ds=(e,t,a)=>E(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),cs=(e,t)=>E(`/api/financial/${e}/${t}`,{method:"DELETE"}),us=(e,t,a)=>E(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),Nn=e=>is("payables",e),Rn=e=>ls("payables",e),jn=(e,t)=>ds("payables",e,t),Fn=e=>cs("payables",e),Hn=(e,t)=>us("payables",e,t),On=e=>is("receivables",e),zn=e=>ls("receivables",e),Vn=(e,t)=>ds("receivables",e,t),Un=e=>cs("receivables",e),_n=(e,t)=>us("receivables",e,t),Wn=(e,t,a)=>E(`/api/financial/cash-flow?establishmentId=${e}&startDate=${t}&endDate=${a}`),ma=document.getElementById("content");let ue={};const no=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],M={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],cashFlowData:null,currentTab:"dashboards",isFilterOpen:!1};async function Jn(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function Gn(){ma.innerHTML=`
        <div class="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
        ...
        </div>`;try{await Jn();const[e,t]=await Promise.all([K(m.establishmentId),Mr(m.establishmentId).catch(()=>[])]);M.professionalsList=e||[],M.costCentersList=t||[],Yn(),await ms()}catch(e){console.error("Erro no loadReportsPage:",e),ma.innerHTML=`
            ...
            </div>`}}function Yn(){const e=M.professionalsList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join(""),t=M.costCentersList.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join("");ma.innerHTML=`
    ...
    `,document.getElementById("toggle-filters-btn").onclick=io,document.getElementById("btn-apply-filters").onclick=()=>{Qn(),io()},document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{M.currentTab=a.dataset.tab,lo(),ps(),window.scrollTo({top:0,behavior:"smooth"})}}),lo()}function io(){const e=document.getElementById("filters-container"),t=document.getElementById("toggle-filters-btn");M.isFilterOpen=!M.isFilterOpen,M.isFilterOpen?(e.classList.remove("hidden"),t.classList.add("bg-indigo-100","text-indigo-800")):(e.classList.add("hidden"),t.classList.remove("bg-indigo-100","text-indigo-800"))}function lo(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===M.currentTab;e.className=t?"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-bold bg-indigo-600 text-white shadow-md transform scale-105 transition-all whitespace-nowrap border-transparent":"tab-btn py-2 px-6 rounded-full text-xs md:text-sm font-medium text-gray-500 bg-white border-gray-200 hover:bg-gray-50 transition-all whitespace-nowrap"})}function Pt(e){if(!e)return"";const t=e.split("-");return`${t[2]}/${t[1]}`}async function Qn(){M.startDate=document.getElementById("report-start").value,M.endDate=document.getElementById("report-end").value,M.selectedProfessional=document.getElementById("report-prof").value,M.selectedCostCenter=document.getElementById("report-cost").value,document.getElementById("date-range-display").textContent=`${Pt(M.startDate)} até ${Pt(M.endDate)}`,await ms()}async function ms(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader border-t-indigo-600"></div></div>';try{const t=M.selectedProfessional==="all"?null:M.selectedProfessional,a=Br(M.startDate,M.endDate,M.selectedProfessional,M.selectedCostCenter),s=Wn(m.establishmentId,M.startDate,M.endDate).catch(()=>({labels:[],payables:[],receivables:[],expectedBalance:[]})),r=new Date(M.startDate+"T00:00:00").toISOString(),o=new Date(M.endDate+"T23:59:59").toISOString(),n=Ro(m.establishmentId,r,o,t).catch(()=>[]),[i,l,d]=await Promise.all([a,s,n]);M.data=i,M.cashFlowData=l,M.appointmentsData=Array.isArray(d)?d:[],ps()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ps(){const e=document.getElementById("report-content");if(M.data)switch(M.currentTab){case"dashboards":Xn(e);break;case"appointments":Zn(e);break;case"dre":Kn(e);break}}function Xn(e){const{dreSimple:t,charts:a}=M.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0};e.innerHTML=`
    ...
    `,M.cashFlowData&&ei("chart-cashflow-modern",M.cashFlowData),co("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,no[0]),co("chart-profs","doughnut","Total Vendas",a.professionals.labels,a.professionals.data,no)}function Zn(e){const t=M.appointmentsData,a=t.length;let s=0,r=0,o=0;const n={},i={};let l=new Date(M.startDate);const d=new Date(M.endDate);for(;l<=d;)n[l.toISOString().split("T")[0]]=0,l.setDate(l.getDate()+1);t.forEach(b=>{const h=parseFloat(b.totalAmount||b.price||0),v=(b.status||"").toLowerCase();let y=b.startTime?(b.startTime.toDate?b.startTime.toDate():new Date(b.startTime)).toISOString().split("T")[0]:"";const w=b.professionalName||"Sem Profissional";i[w]||(i[w]={name:w,count:0,value:0}),["cancelled","cancelado","no-show"].includes(v)?r++:(["completed","finalized","paid"].includes(v)&&s++,o+=h,y&&n.hasOwnProperty(y)&&n[y]++,i[w].count++,i[w].value+=h)});const c=Object.keys(n).sort(),u=c.map(b=>n[b]),g=Object.values(i).sort((b,h)=>h.value-b.value);e.innerHTML=`
    ...
    `,ti("chart-appointments-daily",c,u)}function Kn(e){const{dreFinancial:t}=M.data;if(!t)return;const a=t.totalRevenues,s=(i,l,d,c=!1)=>{const u=a>0?l/a*100:0,g=c?"- ":"";return`
    ...
    `}function ei(e,t){const a=document.getElementById(e);if(!a)return;const s=a.getContext("2d");ue[e]&&ue[e].destroy();const r=s.createLinearGradient(0,0,0,400);r.addColorStop(0,"rgba(59, 130, 246, 0.4)"),r.addColorStop(1,"rgba(59, 130, 246, 0.0)");const o=t.payables.map(i=>i*-1),n=t.labels.map(i=>i.split("-").reverse().slice(0,2).join("/"));ue[e]=new Chart(s,{type:"bar",data:{labels:n,datasets:[{label:"Saldo",data:t.expectedBalance,type:"line",borderColor:"#3b82f6",backgroundColor:r,borderWidth:3,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#3b82f6",pointBorderWidth:2,pointHoverRadius:6,hitRadius:30,fill:!0,tension:.4,order:0,yAxisID:"y"},{label:"Entradas",data:t.receivables,backgroundColor:"#34d399",borderRadius:4,barPercentage:.6,order:1,yAxisID:"y"},{label:"Saídas",data:o,backgroundColor:"#f87171",borderRadius:4,barPercentage:.6,order:2,yAxisID:"y"}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{position:"top",align:"end",labels:{usePointStyle:!0,boxWidth:6,font:{family:"'Inter', sans-serif",size:10}}},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#444",borderColor:"#eee",borderWidth:1,padding:10}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{display:!0,grid:{color:"#f3f4f6",borderDash:[4,4]},ticks:{callback:i=>new Intl.NumberFormat("pt-BR",{notation:"compact"}).format(i),font:{size:10}}}}}})}function ti(e,t,a){const s=document.getElementById(e);if(!s)return;const r=s.getContext("2d");ue[e]&&ue[e].destroy();const o=r.createLinearGradient(0,0,0,300);o.addColorStop(0,"rgba(99, 102, 241, 0.5)"),o.addColorStop(1,"rgba(99, 102, 241, 0.0)");const n=t.map(i=>i.split("-").reverse().slice(0,2).join("/"));ue[e]=new Chart(r,{type:"line",data:{labels:n,datasets:[{label:"Agendamentos",data:a,borderColor:"#6366f1",backgroundColor:o,borderWidth:2,fill:!0,tension:.4,pointRadius:3,pointBackgroundColor:"#fff",pointBorderColor:"#6366f1",pointBorderWidth:2,pointHoverRadius:5,hitRadius:30}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#fff",titleColor:"#111",bodyColor:"#6366f1",borderColor:"#eee",borderWidth:1}},scales:{x:{grid:{display:!1},ticks:{font:{size:10}}},y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{stepSize:1,font:{size:10}}}}}})}function co(e,t,a,s,r,o){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");ue[e]&&ue[e].destroy(),new Chart(i,{type:t,data:{labels:s,datasets:[{label:a,data:r,backgroundColor:o,borderColor:Array.isArray(o)?"#fff":o,borderWidth:1,tension:.3,fill:t==="line"}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"right",labels:{usePointStyle:!0,boxWidth:8,font:{size:10}}}},scales:t==="doughnut"?{}:{x:{grid:{display:!1},ticks:{font:{size:9}}},y:{grid:{color:"#f3f4f6"},beginAtZero:!0,ticks:{font:{size:9}}}}}})}const _t=(e,t="products")=>E(`/api/${t}/categories/${e}`),gs=(e,t="products")=>E(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),bs=(e,t="products")=>E(`/api/${t}/categories/${e}`,{method:"DELETE"}),ai="audit_logs",He=async(e,t,a,s,r,o=null)=>{try{if(!t)return;await Mo(pe(_,ai),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:r,details:o,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},he=document.getElementById("content");let ie=null,Xe="services",we="all";function Oe(){const e=U.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function oi(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await gs({establishmentId:m.establishmentId,name:s},"services"),He(m.establishmentId,Oe(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",p("Sucesso","Categoria criada!","success"),await Pa(),await ct()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function si(e){if(await O("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await bs(e,"services"),He(m.establishmentId,Oe(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),p("Sucesso","Categoria apagada.","success"),await Pa(),await ct()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Pa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function ri(){Y({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),Da(),Pe()}function li(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function ct(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,r]=await Promise.all([ge(m.establishmentId),K(m.establishmentId),_t(m.establishmentId,"services"),cr(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(o=>{o.active===void 0&&(o.active=!0)}),fs(Xe)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),p("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function fs(e){if(document.getElementById("services-content-container")){if(Xe===e&&document.getElementById("services-content-container").children.length>1){Xe==="services"&&(Da(),Pe());return}Xe=e,we="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?ii():e==="reports"&&li()}}function di(){ie&&(he.removeEventListener("click",ie),he.removeEventListener("input",ie),he.removeEventListener("change",ie)),ie=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),o=r.dataset.id,n=r.checked;try{await dr(o,n);const i=m.services.findIndex(l=>l.id===o);i>-1&&(m.services[i].active=n),He(m.establishmentId,Oe(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${o}) para ${n?"Ativo":"Inativo"}`),Pe(),Da()}catch(i){p("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Pe()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Pe();return}if(!a)return;if(a.hasAttribute("data-view")){fs(a.dataset.view);return}switch(a.dataset.action){case"new-service":uo();break;case"edit-service":const r=JSON.parse(a.dataset.service);uo(r);break;case"manage-categories":ri();break;case"filter-service":const o=a.dataset.filterType;if(o==="popular")return;we=o==="total"?"all":o,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===we||i==="total"&&we==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Pe();break}},he.addEventListener("click",ie),he.addEventListener("input",ie),he.addEventListener("change",ie)}async function ci(){he.innerHTML=`
        ...
        </section>`,di();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await K(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),p("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Xe="services",we="all",await ct()}const Wt="suppliers",Ba="purchases",vs="financial_payables",Ma=async e=>{try{const t=Rt(pe(_,Wt),st("establishmentId","==",e)),a=await xa(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},ui=async e=>{try{return{id:(await Mo(pe(_,Wt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},mi=async(e,t)=>{try{const a=me(_,Wt,e);return await ha(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},pi=async e=>{try{const t=me(_,Wt,e);return await js(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},gi=async(e,t=null)=>{try{const a=qo(_),s=me(pe(_,Ba)),r={...e,createdAt:Oa()};if(a.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const o=me(pe(_,vs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:Oa()};a.set(o,i)}return await a.commit(),{id:s.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},bi=async(e,t)=>{try{const a=qo(_),s=me(_,Ba,e);a.delete(s);const r=Rt(pe(_,vs),st("purchaseId","==",e),st("establishmentId","==",t));return(await xa(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},fi=async e=>{try{const t=Rt(pe(_,Ba),st("establishmentId","==",e),Ao("createdAt","desc")),a=await xa(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},be=document.getElementById("content");let le=null,Ze="products",se="all";async function vi(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await gs({establishmentId:m.establishmentId,name:s},"products"),a.value="",p("Sucesso","Categoria de produto criada!","success"),await Aa(),await ut()}catch(r){p("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function hi(e){if(await O("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await bs(e,"products"),p("Sucesso","Categoria de produto apagada.","success"),await Aa(),await ut()}catch{p("Erro","Não foi possível apagar a categoria.","error")}}async function Aa(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${f(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function xi(){Y({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const h=t.querySelector("#productCategory"),v=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>v.click()),h.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(P=>`<option value="${P.id}" ${e?.categoryId===P.id?"selected":""}>${f(P.name)}</option>`).join(""),e&&(h.value=e.categoryId||"");const y=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const w=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",S=e?.photo||"";v.onchange=async()=>{const P=v.files[0];if(P){y.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const D=await mo(P,800,800,"image/jpeg",.8),F=D.length*3/4,z=1e3*1024;if(F>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=D,base64Input.value=D}catch(D){console.error("Erro ao processar imagem:",D),p("Erro de Imagem",D.message||"Não foi possível processar a imagem.","error"),preview.src=w,base64Input.value=S,N.value=""}}};const k=t.cloneNode(!0);t.parentNode.replaceChild(k,t);const I=()=>{const P=k.querySelector("#modalSupplierSearch"),D=k.querySelector("#supplierSearchResults"),R=k.querySelector("#selectedSuppliersList"),F=P.value.toLowerCase();if(F.length>0){const z=s.filter(j=>j.name.toLowerCase().includes(F)&&!o.has(j.id));z.length>0?(D.classList.remove("hidden"),D.innerHTML=z.map(j=>`
                ...
                `).join("")):(D.classList.remove("hidden"),D.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else D.classList.add("hidden");o.size>0?(R.innerHTML="",o.forEach(z=>{const j=s.find(Q=>Q.id===z);j&&(R.innerHTML+=`
                    ...
                    `)})):R.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};k.querySelector("#modalSupplierSearch").addEventListener("input",I),k.addEventListener("click",P=>{const D=P.target.closest("[data-add-supplier]");if(D){const F=D.dataset.addSupplier;o.add(F),k.querySelector("#modalSupplierSearch").value="",I()}const R=P.target.closest("[data-remove-supplier]");if(R){const F=R.dataset.removeSupplier;o.delete(F),I()}}),I(),k.addEventListener("click",async P=>{const D=P.target.closest("button[data-action]");if(!D)return;const R=D.dataset.action,F=k.querySelector("#productId").value;if(R==="close-modal"&&(k.style.display="none"),R==="delete-product"){if(!F)return;k.style.display="none",await yi(F)}if(R==="save-product-modal"){const z=k.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){p("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const j=D.closest('button[data-action="save-product-modal"]');j.disabled=!0,j.textContent="A salvar...";try{await wi(z)}catch(Q){p("Erro",`Falha ao salvar: ${Q.message}`,"error"),j.disabled=!1,j.textContent="Salvar Alterações"}}}if(R==="adjust-stock-modal"){P.preventDefault();const z=k.querySelector("#stockAdjustmentAmount"),j=k.querySelector("#stockAdjustmentReason"),Q=parseInt(z.value,10),Ee=parseInt(D.dataset.change,10);if(!Q||Q<=0){p("Erro","Por favor, insira uma quantidade válida.","error");return}const Qt=Q*Ee,Ts=j.value||(Qt>0?"Entrada manual":"Saída manual");try{await pr(F,{change:Qt,reason:Ts});const Ue=m.products.findIndex(_e=>_e.id===F);if(Ue>-1){const _e=m.products[Ue].currentStock+Qt;m.products[Ue].currentStock=_e,k.querySelector("#currentStockDisplay").textContent=_e,k.querySelector("#productCurrentStock").value=_e,z.value="",j.value="",p("Sucesso","Estoque atualizado!","success"),qa(),nt()}}catch(Ue){p("Erro de Stock",Ue.message,"error")}}});const L=k.querySelectorAll(".tab-btn"),B=k.querySelectorAll(".tab-content");L.forEach(P=>{P.addEventListener("click",D=>{D.preventDefault(),L.forEach(R=>{R.classList.remove("border-indigo-500","text-indigo-600"),R.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),P.classList.add("border-indigo-500","text-indigo-600"),P.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),B.forEach(R=>R.classList.add("hidden")),document.getElementById(`tab-content-${P.dataset.tab}`).classList.remove("hidden")})});const N=k.querySelector("#productPhotoInput");k.querySelector("#productPhotoButton").addEventListener("click",()=>N.click()),N.onchange=async()=>{const P=N.files[0];if(!P)return;const D=k.querySelector("#productPhotoPreview"),R=k.querySelector("#productPhotoBase64");D.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await mo(P,800,800,"image/jpeg",.8),j=F.length*3/4,Q=1e3*1024;if(j>Q)throw new Error("A imagem é muito grande mesmo após a compressão.");D.src=F,R.value=F}catch(F){console.error("Erro ao processar imagem:",F),p("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),D.src=w,R.value=S,N.value=""}},k.style.display="flex"}function ki(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${f(a.name)}</option>`)),qa(),nt()}function Si(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),o=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join("")),o&&m.categories&&(o.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${f(n.name)}</option>`).join(""))}async function $i(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await gr(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function ut(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,s]=await Promise.all([lt(m.establishmentId),_t(m.establishmentId,"products"),Ma(m.establishmentId)]);m.products=(t||[]).filter(Boolean),m.categories=(a||[]).filter(Boolean),m.suppliers=(s||[]).filter(Boolean),hs(Ze)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function hs(e){if(document.getElementById("products-content-container")){if(Ze===e&&document.getElementById("products-content-container").children.length>1){Ze==="products"&&(qa(),nt());return}Ze=e,se="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?ki():e==="movements"&&Si()}}async function Ei(){be.innerHTML=`
        ...
        </section>`,le&&(be.removeEventListener("click",le),be.removeEventListener("input",le),be.removeEventListener("change",le)),le=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){nt();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){hs(a.dataset.view);return}switch(a.dataset.action){case"new-product":po();break;case"edit-product":po(JSON.parse(a.dataset.product));break;case"manage-product-categories":xi();break;case"generate-report":await $i();break;case"filter-stock":const r=a.dataset.filterType;se=se===r?"all":r,document.querySelectorAll(".indicator-card").forEach(o=>{o.classList.toggle("ring-2",o.dataset.filterType===se),o.classList.toggle("ring-indigo-500",o.dataset.filterType===se),o.classList.toggle("shadow-lg",o.dataset.filterType===se)}),nt();break}},be.addEventListener("click",le),be.addEventListener("input",le),be.addEventListener("change",le),Ze="products",se="all",await ut()}const fe=document.getElementById("content");let de=null,$t="list",H={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Ii(){$t==="list"?Jt():$t==="purchases"?(H.step=1,Ke()):$t==="history"&&xs()}async function Ci(){try{const e=await Ma(m.establishmentId);return m.suppliers=e||[],H.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Li(e){if(await O("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await pi(e),p("Sucesso","Fornecedor excluído.","success"),jt("genericModal"),Jt()}catch(t){p("Erro","Erro ao excluir: "+t.message,"error")}}async function Ti(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:m.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await mi(a,s),p("Sucesso","Fornecedor atualizado!","success")):(await ui(s),p("Sucesso","Fornecedor criado!","success")),jt("genericModal"),Jt()}catch(o){p("Erro","Erro ao salvar: "+o.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function Jt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Ci();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=m.suppliers.filter(o=>o.name.toLowerCase().includes(t)||o.contactName&&o.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let s='<div class="flex flex-col gap-2 md:hidden">';a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=f(o.name),l=f(o.category||"Geral"),d=f(o.contactName||"");s+=`
    ...
    `;a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=f(o.name),l=f(o.taxId||"Sem doc."),d=f(o.email||"-"),c=f(o.phone||"-"),u=f(o.category||"Geral");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=s+r}function Pi(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",s=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),o=f(e.name),n=f(e.category||"Fornecedor"),i=f(e.contactName||""),l=f(e.phone||""),d=`
    ...
    `;Y({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Ke(){const e=document.getElementById("purchasesContainer");if(e)if(H.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([lt(m.establishmentId),Ma(m.establishmentId)]);H.allSuppliers=a||[];const s=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(H.productsToBuy=s,s.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',o="";s.forEach(d=>{const c=parseInt(d.minStock)||0,u=parseInt(d.currentStock)||0,g=Math.max(c-u,1),b=parseFloat(d.costPrice||0),h=f(d.name);let v='<option value="">Selecione...</option>';H.allSuppliers.length>0?H.allSuppliers.forEach(y=>{const S=d.supplierIds&&d.supplierIds.includes(y.id)?"selected":"";v+=`<option value="${y.id}" ${S}>${f(y.name)}</option>`}):v='<option value="">Sem fornecedores</option>',r+=`
        ...
        `}).join("");s+=h;const y=encodeURIComponent(JSON.stringify({supplierId:g,supplierName:b.info.name,totalAmount:h,items:b.items})),w=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),S=encodeURIComponent(JSON.stringify(b.items)),k=f(b.info.name),I=f(b.info.email||"");a+=`
    ...
    `;Y({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Ti),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>jt("genericModal"))},50)}function Ai(){fe.innerHTML=`
    ...
    `,de&&(fe.removeEventListener("click",de),fe.removeEventListener("input",de),fe.removeEventListener("change",de)),de=e=>{if(e.target.closest("#tab-btn-list")&&pt("list"),e.target.closest("#tab-btn-purchases")&&pt("purchases"),e.target.closest("#tab-btn-history")&&pt("history"),e.target.id==="toggle-quote-mode"&&(H.isQuoteMode=e.target.checked,Ke()),e.target.id==="supplierSearchInput"&&Jt(),e.target.closest("#btn-new-supplier")&&go(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),s=JSON.parse(a.dataset.supplier);Pi(s)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&Li(t.dataset.id),a==="edit"&&go(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&pa(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=a),pa()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),s={};let r=!1;if(a.forEach(o=>{if(o.offsetParent===null||!o.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=o.querySelector("td:nth-child(2)"),d=o.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(o.querySelector(".qty-input").value),u=parseFloat(o.dataset.cost),b=o.querySelector(".supplier-select").value;if(b){if(!s[b]){const h=H.allSuppliers.find(v=>v.id===b);s[b]={info:h,items:[]}}s[b].items.push({name:i,qty:c,cost:u})}}),!r){p("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}H.finalOrders=s,H.step=2,Ke()}if(e.target.closest("#btn-back-step1")&&(H.step=1,Ke()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),o=parseFloat(a.dataset.total),n=H.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else p("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=m.establishmentId,a.disabled=!0,a.textContent="A processar...",$e(m.establishmentId).then(r=>{const o=r.purchaseConfig||null;return gi(s,o)}).then(()=>{p("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',p("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;O("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await bi(s,m.establishmentId),p("Sucesso","Compra e financeiro excluídos.","success"),xs()}catch(o){p("Erro","Erro ao excluir: "+o.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=H.finalOrders[s];r?Mi(r,H.isQuoteMode):p("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);Bi(s)}},fe.addEventListener("click",de),fe.addEventListener("input",de),fe.addEventListener("change",de),pt("list")}function pt(e){$t=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Ii()}const Zt=document.getElementById("content"),bo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let ne=new Set,gt=null,De=null;function qi(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Ni(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",s=f(t.name),r=f(t.specialty||"Especialidade"),o=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Kt(){const e=document.getElementById("genericModal");e.style.display="none",De&&e.removeEventListener("click",De)}async function Ri(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=f(a.name),r=m.services||await ge(m.establishmentId),o=m.professionals||await K(m.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",ji(a,r),Fi(a),Hi(a,o),zi(a)}function ji(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(y,w)=>{const S=w+1,k=S==s[1]?"selected":"",I=new Date(0,w).toLocaleString("pt-BR",{month:"long"});return`<option value="${S}" ${k}>${I.charAt(0).toUpperCase()+I.slice(1)}</option>`}).join(""),o=e.status||"active",n=f(e.name||""),i=f(e.specialty||""),l=f(e.phone||""),d=f(e.notes||"");a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500">${s.message}</p>`}}}function zi(e){const t=document.getElementById("genericModal");De&&t.removeEventListener("click",De),De=async a=>{const s=a.target.closest("button[data-action]");if(!s){const o=a.target.closest(".tab-link");o&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),o.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(o.dataset.tab).classList.remove("hidden"));return}const r=s.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Kt();break;case"delete-professional":const o=s.dataset.id;if(await O("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Fo(o),p("Sucesso!","Profissional excluído.","success"),Kt(),Dt()}catch(v){p("Erro",`Não foi possível excluir: ${v.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(v=>v.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(v=>{const y=v.querySelector('[data-field="active"]').dataset.day;u[y]={active:v.querySelector('[data-field="active"]').checked,start:v.querySelector('[data-field="start"]').value,end:v.querySelector('[data-field="end"]').value,breakStart:v.querySelector('[data-field="breakStart"]').value,breakEnd:v.querySelector('[data-field="breakEnd"]').value}});const g={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{g.id?(await Ct(g.id,g),p("Sucesso!","Profissional atualizado.","success")):(delete g.id,await jo(g),p("Sucesso!","Profissional criado.","success")),Kt(),Dt()}catch(v){p("Erro",v.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=s.dataset.id;if(await O("Apagar Bloqueio","Tem certeza?"))try{await ka(b),p("Bloqueio removido.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";et(e.id,v)}catch(v){p("Erro",v.message,"error")}break;case"batch-delete-blockage":const h=JSON.parse(s.dataset.ids);if(await O("Apagar em Lote",`Tem certeza que deseja apagar ${h.length} bloqueios com este motivo?`))try{await Jo(h),p("Bloqueios removidos.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";et(e.id,v)}catch(v){p("Erro",v.message,"error")}break}},t.addEventListener("click",De)}function ga(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(ne.size>0?(t.textContent=`${ne.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function Vi(){O("Excluir em Lote",`Tem certeza que deseja excluir ${ne.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await nr(Array.from(ne)),p("Sucesso!",`${ne.size} profissionais foram excluídos.`,"success"),ne.clear(),ga(),Dt()}catch(t){p("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function We(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=qi();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),s=m.professionals.filter(r=>{const o=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return o&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Ni(s)}async function Dt(){ne.clear(),Zt.innerHTML=`
        ...
        <section class="h-full flex flex-col bg-gray-50">
            ...
            <div id="clients-content-area" class="flex-grow overflow-y-auto p-2 sm:p-4 custom-scrollbar">
                ${$.loading?'<div class="loader mx-auto mt-10"></div>':""}
            </div>
        </section>
    `;const e=document.getElementById("btn-new-client"),t=document.getElementById("btn-back-list");e&&(e.onclick=Yi),t&&(t.onclick=()=>{$.selectedClient=null,it()})}function it(){Gt();const e=document.getElementById("clients-content-area"),t=`
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <div class="flex flex-col gap-2 justify-center">
                    <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                        <input type="checkbox" id="filter-loyalty" class="form-checkbox h-4 w-4 text-indigo-600 rounded focus:ring-indigo-500" ${$.filters.hasLoyalty?"checked":""}>
                        <span class="ml-2 text-sm text-gray-700">Com Pontos</span>
                    </label>
                    <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded">
                        <input type="checkbox" id="filter-debt" class="form-checkbox h-4 w-4 text-red-600 rounded focus:ring-red-500" ${$.filters.hasDebt?"checked":""}>
    ...
    `,a=$.clients.length>0?`
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 max-w-6xl mx-auto pb-10">
            ${$.clients.map(l=>{const d=l.totalDebt&&parseFloat(l.totalDebt)>0;return`
                <div class="client-card bg-white p-4 rounded-xl border ${d?"border-red-300 ring-1 ring-red-100":"border-gray-200"} shadow-sm hover:shadow-md transition cursor-pointer group relative overflow-hidden active:bg-gray-50" data-id="${l.id}">
                    <div class="absolute top-0 left-0 w-1 h-full ${d?"bg-red-500":"bg-indigo-500"} opacity-0 group-hover:opacity-100 transition"></div>
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full ${d?"bg-red-100 text-red-600":"bg-indigo-100 text-indigo-600"} flex items-center justify-center font-bold text-lg flex-shrink-0">
                            ${l.name.charAt(0).toUpperCase()}
                        </div>
                        <div class="flex-grow min-w-0">
                            <h3 class="font-bold text-gray-800 truncate text-base sm:text-lg">${f(l.name)}</h3>
                            <p class="text-sm text-gray-500 flex items-center gap-1">
                                <svg class="w-3 h-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                <span class="truncate">${l.phone||"Sem telefone"}</span>
                            </p>
                            
                            <div class="flex flex-wrap gap-2 mt-2">
                                ${l.loyaltyPoints?`<span class="text-xs font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-100">⭐ ${l.loyaltyPoints} pts</span>`:""}
                                ${d?`<span class="text-xs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-full border border-red-100">Devendo: R$ ${parseFloat(l.totalDebt).toFixed(2)}</span>`:""}
                            </div>
                        </div>
                        <div class="text-right flex-shrink-0">
    ...
    `;e.innerHTML=t+a;const s=document.getElementById("client-search"),r=document.getElementById("filter-inactive"),o=document.getElementById("filter-loyalty"),n=document.getElementById("filter-debt"),i=document.getElementById("btn-apply-filters");i.onclick=()=>{$.filters={search:s.value,inactiveDays:r.value,hasLoyalty:o.checked,hasDebt:n.checked},ws()},s.addEventListener("keypress",l=>{l.key==="Enter"&&i.click()}),e.querySelectorAll(".client-card").forEach(l=>{l.onclick=()=>ks(l.dataset.id)})}async function qe(){Gt();const e=document.getElementById("clients-content-area"),t=$.selectedClient;if(!t)return it();$.activeTab!=="profile"&&$.historyData.appointments.length===0&&await fo(t.id);const a=`
        <div class="flex gap-2 mb-6 border-b overflow-x-auto pb-1 scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
            <button class="tab-btn ${$.activeTab==="profile"?"active-tab":""}" data-tab="profile">
                👤 Perfil
            </button>
            <button class="tab-btn ${$.activeTab==="appointments"?"active-tab":""}" data-tab="appointments">
                📅 Agendamentos
            </button>
            <button class="tab-btn ${$.activeTab==="history"?"active-tab":""}" data-tab="history">
                💰 Histórico
            </button>
            <button class="tab-btn ${$.activeTab==="loyalty"?"active-tab":""}" data-tab="loyalty">
                ⭐ Fidelidade
            </button>
        </div>
    `;let s="";$.activeTab==="profile"?s=Ui(t):$.activeTab==="appointments"?s=_i():$.activeTab==="history"?s=Wi():$.activeTab==="loyalty"&&(s=Ji(t)),e.innerHTML=`
        <div class="max-w-4xl mx-auto w-full bg-white sm:rounded-2xl shadow-none sm:shadow-lg border-x-0 sm:border border-gray-200 overflow-hidden -mt-2 sm:mt-0">
                        ...
                        ${t.totalDebt&&t.totalDebt>0?`
                            <div class="mt-2 inline-block bg-red-700/50 border border-red-400/30 px-3 py-1 rounded-lg">
                                <p class="text-xs font-bold text-red-100 flex items-center gap-1">
                                    ...
                                    Débito em Aberto: R$ ${parseFloat(t.totalDebt).toFixed(2)}
                                </p>
                            </div>
                        `:""}
                    </div>
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="animate-fade-in relative min-h-[300px]">
                    ${$.historyLoading?'<div class="absolute inset-0 bg-white/80 flex items-start justify-center pt-10 z-20"><div class="loader"></div></div>':""}
                    ${s}
                </div>
            </div>
        </div>
    ...
    `,e.appendChild(r),e.querySelectorAll(".tab-btn").forEach(i=>{i.onclick=()=>{const l=i.dataset.tab;$.activeTab!==l&&(l==="appointments"||l==="history")&&($.historyLimit=20,$.historySearchTerm=""),$.activeTab=l,qe()}}),$.activeTab==="profile"&&(document.getElementById("form-edit-client").onsubmit=Qi,document.getElementById("btn-delete-client").onclick=Xi),$.activeTab==="loyalty"){const i=document.getElementById("btn-manual-redeem");i&&(i.onclick=()=>Gi(t))}const o=document.getElementById("history-search-input");if(o){o.focus();const i=o.value;o.value="",o.value=i,o.addEventListener("input",l=>{$.historySearchTerm=l.target.value,qe()})}const n=document.getElementById("btn-load-more");n&&(n.onclick=()=>{$.historyLimit+=20,qe(),fo(t.id)}),e.querySelectorAll("[data-go-agenda]").forEach(i=>{i.onclick=l=>{const d=i.dataset.date,c=i.dataset.id;Z("agenda-section",{targetDate:new Date(d),scrollToAppointmentId:c})}}),e.querySelectorAll("[data-go-comanda]").forEach(i=>{i.onclick=l=>{const d=i.dataset.id;Z("comandas-section",{selectedAppointmentId:d,initialFilter:"finalizadas"})}})}function Ui(e){return`
    ...
    `}function Wi(e){let t=$.historyData.sales||[];if($.historySearchTerm){const a=$.historySearchTerm.toLowerCase();t=t.filter(s=>s.id.includes(a)||s.date&&new Date(s.date).toLocaleDateString().includes(a))}return t.sort((a,s)=>new Date(s.date)-new Date(a.date)),t.length===0&&!$.historySearchTerm?`
    ...
    `}function Ji(e){const t=$.historyData.loyaltyLog||[];t.sort((s,r)=>new Date(r.date)-new Date(s.date));const a=t.length>0?t.map(s=>{const r=s.type==="redemption";return`
    ...
    `}async function ws(){$.loading=!0,Gt();try{let e=`/api/clients/${m.establishmentId}?limit=20`;$.filters.search&&(e+=`&search=${encodeURIComponent($.filters.search)}`),$.filters.inactiveDays&&(e+=`&inactiveDays=${$.filters.inactiveDays}`),$.filters.hasLoyalty&&(e+="&hasLoyalty=true"),$.filters.hasDebt&&(e+="&hasDebt=true"),$.clients=await E(e),it()}catch(e){console.error(e),p("Erro","Falha ao carregar clientes.","error"),$.clients=[],it()}finally{$.loading=!1;const e=document.querySelector(".loader");e&&e.remove()}}async function fo(e){const t=$.selectedClient;if(!(!t||!t.phone)){if($.historyLoading=!0,document.getElementById("clients-content-area").querySelector(".tab-btn")){const a=document.createElement("div");a.className="absolute inset-0 bg-white/70 flex items-start justify-center pt-20 z-50 transition-opacity duration-300",a.innerHTML='<div class="loader"></div>';const s=document.querySelector(".animate-fade-in");s&&s.appendChild(a)}try{const a=new Date;a.setMonth(a.getMonth()+12);const s=new Date;s.setFullYear(s.getFullYear()-5);let r=`/api/appointments/${m.establishmentId}?startDate=${s.toISOString()}&endDate=${a.toISOString()}`;r+=`&clientPhone=${encodeURIComponent(t.phone)}`,r+=`&limit=${$.historyLimit}`;const o=await E(r);$.historyData.appointments=o,$.historyData.sales=o.filter(i=>i.status==="completed").map(i=>({id:i.id,date:i.startTime,totalAmount:i.totalAmount||0,items:i.services||[]}));const n=[];o.forEach(i=>{i.status==="completed"&&i.loyaltyPointsEarned>0&&n.push({type:"earn",points:i.loyaltyPointsEarned,date:i.startTime,description:"Venda finalizada"}),i.loyaltyRedemption&&n.push({type:"redemption",points:i.loyaltyRedemption.cost||0,date:i.startTime,description:`Resgate: ${i.loyaltyRedemption.name}`})}),$.historyData.loyaltyLog=n}catch(a){console.error("Erro ao buscar histórico otimizado",a),p("Aviso","Não foi possível carregar o histórico completo. Verifique sua conexão.","warning")}finally{$.historyLoading=!1,qe()}}}function Gi(e){const t=e.loyaltyPoints||0,a=`
        <div class="text-center mb-6">
    ...
    `,{modalElement:s,close:r}=Y({title:"Ajuste Manual de Pontos",contentHTML:a,maxWidth:"max-w-sm"});s.querySelector("form").onsubmit=async o=>{o.preventDefault();const n=document.getElementById("redeem-action").value,i=parseInt(document.getElementById("redeem-points").value,10),l=document.getElementById("redeem-reason").value;if(!i||i<=0)return p("Erro","Insira uma quantidade válida.","error");if(n==="debit"&&i>t)return p("Erro","Saldo insuficiente.","error");try{let d=t;n==="debit"?(await Rr(m.establishmentId,e.phone,i,l),d-=i):(d+=i,await Qo(e.id,{loyaltyPoints:d})),$.selectedClient.loyaltyPoints=d,$.historyData.loyaltyLog.unshift({type:n==="debit"?"redemption":"earn",points:i,date:new Date().toISOString(),description:l+" (Manual)"}),p("Sucesso","Saldo de pontos atualizado.","success"),r(),qe()}catch(d){p("Erro","Falha ao atualizar pontos: "+d.message,"error")}}}function ks(e){$.selectedClient=$.clients.find(t=>t.id===e),$.activeTab="profile",$.historyLimit=20,$.historySearchTerm="",$.historyData={appointments:[],sales:[],loyaltyLog:[]},qe()}function Yi(){const e=`
    ...
    `;try{const[a,s]=await Promise.all([La(m.establishmentId),Ta(m.establishmentId)]),r=e.financialIntegration||{},o=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ce(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ce(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ce(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ce(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ce(a,o.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ce(s,o.defaultCostCenterId)}catch{p("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};ze(s,a)})}function ll(e,t){const a="5516997859430",s=encodeURIComponent("Olá, preciso de ajuda com o sistema Kairos."),r=`https://wa.me/${a}?text=${s}`;t.innerHTML=`
    ...
    `}function $s(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(Ki).forEach(([r,o])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{s.value=r,$s(r,t)}),a.appendChild(i)}),s.value=e)}function ul(e,t){const a=t.querySelector("#slotIntervalContainer"),s=t.querySelector("#establishmentSlotInterval");if(!a||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(o=>{const n=o.value===e;return`<button type="button" data-value="${o.value}" 
    ...
    `,xe.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),Es()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":el(J,a);break;case"change-password":tl(J,a);break;case"change-email":al(J,a);break;case"branding":ol(J,a);break;case"booking":sl(J,a);break;case"working-hours":rl(J,a);break;case"loyalty":await nl(J,a);break;case"financial":await il(J,a);break;case"support":ll(J,a);break;case"cancellation":dl(J,a);break;default:cl(t?t.label:"Definições",a)}}async function Es(){if(xe.innerHTML=`
    ...
    `,xe.querySelector("#settings-menu-list").addEventListener("click",o=>{const n=o.target.closest("button[data-section]");n&&(o.preventDefault(),ml(n.dataset.section))});const r=xe.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",o=>{o.preventDefault(),Z("my-profile-section")})}const tt=document.getElementById("content");async function Ne(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await Ht(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let g=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
        ...
        <section>
        ...
        </section>`,bl(t),await Ne(t);const r=document.getElementById("batchProfSelectionContainer");try{const o=await K(m.establishmentId);r.innerHTML=o.map(n=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const vl=e=>E(`/api/users/${e}`),hl=e=>E("/api/users",{method:"POST",body:JSON.stringify(e)}),xl=(e,t)=>E(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),yl=e=>E(`/api/users/${e}`,{method:"DELETE"}),wl=(e,t)=>E(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),kl=(e,t)=>E(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),ve=document.getElementById("content"),Sl={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},$l={view:"Visualizar",create:"Criar",edit:"Editar"};let Je=null,Ge=null;function El(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const s=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${s}</p>`;return}e.sort((s,r)=>(s.status==="active"?-1:1)-(r.status==="active"?-1:1)),t.innerHTML=e.map(s=>{const r=JSON.stringify(s).replace(/'/g,"&apos;"),o=s.status==="active",n=m.professionals.find(c=>c.id===s.professionalId),i=n?n.name:"N/A",l=n?n.name.charAt(0):s.name.charAt(0),d=n?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function Et(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=m.users:t=m.users.filter(a=>a.status==="active"),El(t)}function Il(e={}){return Object.entries(Sl).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,o=Object.entries($l).map(([i,l])=>`
    ...
    `;const g=window.innerWidth<768,b=u.querySelector(".bg-white");if(g&&b){b.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const w=u.closest("section");w&&(w.style.padding="0",w.style.margin="0"),b.classList.add("p-4")}const h=u.querySelector("#userProfessionalId"),v=u.querySelector("#userPhotoPreview"),y=u.querySelector("#profPhotoName");if(h.addEventListener("change",w=>{const S=w.target.value,k=s(S),I=k?k.name:"Selecione um profissional",L=r(S,n);v.src=L.photoSrc,y.textContent=I,u.querySelector("#professionalPhotoUrl").value=L.photoUrl}),u.addEventListener("submit",async w=>{w.preventDefault();const S=e?.email,k=u.querySelector("#userEmail").value,I={};u.querySelectorAll('input[type="checkbox"]').forEach(N=>{const P=N.dataset.module,D=N.dataset.permission;I[P]||(I[P]={}),I[P][D]=N.checked});const L=u.querySelector("#userProfessionalId").value||null,B={name:u.querySelector("#userName").value,permissions:I,professionalId:L,establishmentId:m.establishmentId};try{c?(S!==k&&(B.email=k),await xl(e.id,B),p("Usuário atualizado com sucesso!","success")):(B.email=u.querySelector("#userEmail").value,B.password=u.querySelector("#userPassword").value,await hl(B),p("Usuário criado com sucesso!","success")),Bt()}catch(N){p(`Erro: ${N.message}`,"error")}}),c){const w=u.querySelector("#password-change-container"),S=w.querySelector('[data-action="show-password-form"]'),k=w.querySelector("#password-form"),I=k.querySelector('[data-action="save-password"]'),L=k.querySelector('[data-action="cancel-password-change"]');S.addEventListener("click",()=>{S.classList.add("hidden"),k.classList.remove("hidden")}),L.addEventListener("click",()=>{S.classList.remove("hidden"),k.classList.add("hidden"),k.querySelector("#userNewPassword").value=""}),I.addEventListener("click",async()=>{const B=k.querySelector("#userNewPassword").value;if(!B||B.length<6){p("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await O("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{I.disabled=!0,I.textContent="Aguarde...",await wl(e.id,B),p("Sucesso!","A senha do usuário foi alterada.","success"),S.classList.remove("hidden"),k.classList.add("hidden"),k.querySelector("#userNewPassword").value=""}catch(P){p("Erro",`Não foi possível alterar a senha: ${P.message}`,"error")}finally{I.disabled=!1,I.textContent="Salvar Nova Senha"}})}}async function Cl(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([vl(m.establishmentId),K(m.establishmentId)]);m.users=t,m.professionals=a,Et()}catch{p("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Bt(){ve.innerHTML=`
    ...
    `,Je&&ve.removeEventListener("click",Je),Ge&&ve.removeEventListener("change",Ge),Je=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("click",Je);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":ho();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));ho(s);break;case"back-to-list":Bt();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await O("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await yl(r),p("Usuário excluído com sucesso!","success"),Bt()}catch(n){p(`Erro ao excluir: ${n.message}`,"error")}break}}},Ge=async e=>{if(!document.getElementById("user-list-view")){ve.removeEventListener("change",Ge);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")Et();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await kl(a,s),p(`Usuário ${s==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=m.users.findIndex(o=>o.id===a);r>-1&&(m.users[r].status=s,Et())}catch(r){p(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,Et()}}},ve.addEventListener("click",Je),ve.addEventListener("change",Ge),await Cl()}const Ll=document.getElementById("content");let xo={},ba=null;function Tl(){Object.values(xo).forEach(e=>e?.destroy()),xo={}}function Pl(e,t){if(!window.jspdf){p("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${t}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function yo(e){const t=document.getElementById("genericModal"),a=f(e.client),s=f(e.items),r=f(e.responsavelCaixa||"N/A"),o=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function Dl(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);s.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&yo(d)})}),n.innerHTML=a.map((i,l)=>{const d=f(i.client),c=f(i.items),u=f(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ba.transactions[l];d&&yo(d)})})}async function wo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r)return p("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,n=await Ar({establishmentId:m.establishmentId,startDate:s,endDate:r,cashierSessionId:o});ba=n,e.innerHTML=`
        ...
        `,Dl(n)}catch(o){p("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${f(o.message)}</p>`}}async function Bl(){Tl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];Ll.innerHTML=`
        ...
        `;e.innerHTML=t.map(r=>s(r)).join("")}async function fa(e){const t=document.getElementById("genericModal"),a=e==="nature",s=a?"Naturezas Financeiras":"Centros de Custo",r=a?La:Ta,o=a?Bn:An,n=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const i=t.querySelector("#hierarchyList"),l=t.querySelector("#itemParent"),d=u=>{const g=Na(u);ql(i,g,e);const b=l.value;l.innerHTML='<option value="">-- Categoria Principal --</option>';const h=(v,y=0)=>{const w="  ".repeat(y)+(y>0?"↳ ":"");l.innerHTML+=`<option value="${v.id}">${w}${v.name}</option>`,v.children.forEach(S=>h(S,y+1))};g.forEach(v=>h(v)),l.value=b};try{const u=await r(m.establishmentId);A[n]=u,d(u)}catch(u){console.error(u)}const c=t.querySelector("#hierarchyForm");c.addEventListener("submit",async u=>{u.preventDefault();const g=t.querySelector("#itemName").value,b=l.value;try{await o({name:g,parentId:b||null,establishmentId:m.establishmentId});const h=await r(m.establishmentId);A[n]=h,d(h),c.reset(),await Ve(),p("Sucesso","Item adicionado.","success")}catch(h){p("Erro",h.message,"error")}})}async function Nl(){Rl(),jl(),await Ve()}function Rl(){Ml.innerHTML=`
    ...
    `}function jl(){document.getElementById("toggle-filter-btn").addEventListener("click",()=>{const a=document.getElementById("filter-panel"),s=document.getElementById("toggle-filter-btn");A.isFilterOpen=!A.isFilterOpen,A.isFilterOpen?(a.classList.remove("hidden"),s.classList.add("bg-indigo-100","text-indigo-600")):(a.classList.add("hidden"),s.classList.remove("bg-indigo-100","text-indigo-600"))}),document.getElementById("settings-btn").addEventListener("click",Ul),document.getElementById("fab-add").addEventListener("click",()=>{const a=A.currentTab==="payables"?"payable":"receivable";ta(a)});const e=document.getElementById("tab-receivables"),t=document.getElementById("tab-payables");e.addEventListener("click",()=>ko("receivables")),t.addEventListener("click",()=>ko("payables")),document.querySelectorAll(".status-filter-btn").forEach(a=>{a.addEventListener("click",s=>{document.querySelectorAll(".status-filter-btn").forEach(r=>{r.classList.remove("bg-indigo-100","text-indigo-700"),r.classList.add("text-gray-500")}),s.target.classList.add("bg-indigo-100","text-indigo-700"),s.target.classList.remove("text-gray-500"),A.statusFilter=s.target.dataset.status})}),document.getElementById("apply-filter-btn").addEventListener("click",()=>{A.startDate=document.getElementById("filterStartDate").value,A.endDate=document.getElementById("filterEndDate").value,A.filterNaturezaId=document.getElementById("filterNaturezaId").value,A.filterCostCenterId=document.getElementById("filterCostCenterId").value,document.getElementById("toggle-filter-btn").click(),Ve()}),bt&&document.body.removeEventListener("click",bt),bt=a=>{const s=a.target,r=s.closest("button[data-action]");if(r){const{action:n,type:i,id:l}=r.dataset;if(a.stopPropagation(),n==="delete"){zl(i,l);return}if(n==="mark-as-paid"){Ol(i,l);return}if(n==="manage-natures"){fa("nature");return}if(n==="manage-cost-centers"){fa("cost-center");return}if(n==="edit"){const d=JSON.parse(r.dataset.item.replace(/&apos;/g,"'"));ta(i,d);return}}const o=s.closest(".financial-card-item");if(o&&document.getElementById("list-container").contains(o)){const{type:n}=o.dataset,i=JSON.parse(o.dataset.item.replace(/&apos;/g,"'"));ta(n,i)}},document.body.addEventListener("click",bt),ft&&document.getElementById("genericModal").removeEventListener("click",ft),ft=a=>{if(a.target.closest('[data-action="close-modal"]')){document.getElementById("genericModal").style.display="none";return}const r=a.target.closest('button[data-action^="delete-"]');if(r){const o=r.dataset.action.split("-")[1];Vl(o,r.dataset.id)}},document.getElementById("genericModal").addEventListener("click",ft)}function ko(e){A.currentTab=e;const t=document.getElementById("tab-receivables"),a=document.getElementById("tab-payables"),s=document.getElementById("fab-add");e==="receivables"?(t.classList.add("bg-white","text-green-700","shadow-sm"),t.classList.remove("text-gray-500"),a.classList.remove("bg-white","text-red-700","shadow-sm"),a.classList.add("text-gray-500"),s.className="fixed bottom-6 right-6 w-14 h-14 bg-green-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-green-700 hover:scale-105 transition-all z-40"):(a.classList.add("bg-white","text-red-700","shadow-sm"),a.classList.remove("text-gray-500"),t.classList.remove("bg-white","text-green-700","shadow-sm"),t.classList.add("text-gray-500"),s.className="fixed bottom-6 right-6 w-14 h-14 bg-red-600 text-white rounded-full shadow-xl flex items-center justify-center hover:bg-red-700 hover:scale-105 transition-all z-40"),Is()}async function Ve(){const e=document.getElementById("list-container");e.innerHTML='<div class="loader mx-auto my-10"></div>';try{if(A.natures.length===0){const[r,o]=await Promise.all([La(m.establishmentId),Ta(m.establishmentId)]);A.natures=r,A.costCenters=o,Fl()}const t={startDate:A.startDate,endDate:A.endDate,establishmentId:m.establishmentId};A.filterNaturezaId!=="all"&&(t.natureId=A.filterNaturezaId),A.filterCostCenterId!=="all"&&(t.costCenterId=A.filterCostCenterId);const[a,s]=await Promise.all([Rn(t),zn(t)]);A.payables=a.entries||[],A.receivables=s.entries||[],Hl(),Is()}catch(t){e.innerHTML=`<p class="text-center text-red-500 mt-10">Erro ao carregar: ${t.message}</p>`}}function Fl(){const e=s=>{let r='<option value="all">Todas</option>';const o=Na(s),n=(i,l=0)=>{const d="  ".repeat(l)+(l>0?"↳ ":"");r+=`<option value="${i.id}">${d}${i.name}</option>`,i.children.forEach(c=>n(c,l+1))};return o.forEach(i=>n(i)),r},t=document.getElementById("filterNaturezaId"),a=document.getElementById("filterCostCenterId");t&&(t.innerHTML=e(A.natures)),a&&(a.innerHTML=e(A.costCenters)),t&&(t.value=A.filterNaturezaId),a&&(a.value=A.filterCostCenterId)}function Hl(){const e=document.getElementById("summary-section");if(!e)return;const t=A.receivables.reduce((l,d)=>l+d.amount,0),a=A.receivables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),s=t-a,r=A.payables.reduce((l,d)=>l+d.amount,0),o=A.payables.filter(l=>l.status==="paid").reduce((l,d)=>l+d.amount,0),n=r-o,i=a-o;e.innerHTML=`
    ...
    `}function Is(){const e=document.getElementById("list-container");if(!e)return;const t=A.currentTab==="receivables",a=t?A.receivables:A.payables;let s=a;if(A.statusFilter!=="all"&&(s=a.filter(n=>n.status===A.statusFilter)),s.sort((n,i)=>new Date(n.dueDate)-new Date(i.dueDate)),s.length===0){e.innerHTML=`
        ...
        `;return}const r=new Map(A.natures.map(n=>[n.id,n.name])),o=t?"receivable":"payable";e.innerHTML=s.map(n=>{const i=Al(n.dueDate),l=n.status==="paid",d=l?"text-gray-400":t?"text-green-600":"text-red-500",c=n.naturezaId&&r.get(n.naturezaId)||"Geral",u=JSON.stringify(n).replace(/'/g,"&apos;");return`
    ...
    `,e.style.display="flex"}function ta(e,t=null){const a=document.getElementById("genericModal"),s=e==="payable",r=`${t?"Editar":"Nova"} ${s?"Despesa":"Receita"}`,o=s?"red":"green",n=(u,g)=>{let b='<option value="">-- Selecione --</option>';const h=Na(u),v=(y,w=0)=>{const S="  ".repeat(w)+(w>0?"↳ ":""),k=y.id===g?"selected":"";b+=`<option value="${y.id}" ${k}>${S}${y.name}</option>`,y.children.forEach(I=>v(I,w+1))};return h.forEach(y=>v(y)),b};a.innerHTML=`
        ...
        </div>`,a.style.display="flex";const i=a.querySelector("#financial-form"),l=i.querySelector("#status-toggle"),d=i.querySelector("#payment-date-wrapper"),c=i.querySelector('[name="paymentDate"]');if(!t){const u=i.querySelector("#toggle-installments"),g=i.querySelector("#installments-container");u.addEventListener("change",()=>{g.classList.toggle("hidden",!u.checked)})}l.addEventListener("change",()=>{l.checked?(d.classList.remove("hidden"),c.required=!0):(d.classList.add("hidden"),c.required=!1)}),i.addEventListener("submit",async u=>{u.preventDefault();const g=new FormData(i),b=l.checked,h={description:g.get("description"),amount:parseFloat(g.get("amount")),dueDate:g.get("dueDate"),naturezaId:g.get("naturezaId")||null,centroDeCustoId:g.get("centroDeCustoId")||null,notes:g.get("notes"),status:b?"paid":"pending",paymentDate:b?g.get("paymentDate"):null,establishmentId:m.establishmentId},v=g.get("installments");!t&&v&&parseInt(v)>1?h.installments=parseInt(v):h.installments=1;try{t?(await(s?jn(t.id,h):Vn(t.id,h)),p("Sucesso","Atualizado com sucesso!","success")):(await(s?Nn(h):On(h)),p("Sucesso","Criado com sucesso!","success")),document.getElementById("genericModal").style.display="none",Ve()}catch(y){p("Erro",y.message,"error")}})}const _l=e=>E("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),Wl=e=>E("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),Jl=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return E(`/api/commissions/stats?${a}`)},Gl=(e={})=>{Object.keys(e).forEach(s=>(e[s]===void 0||e[s]===null||e[s]==="")&&delete e[s]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return E(a)},Yl=e=>E(`/api/commissions/report/${e}`,{method:"DELETE"}),Mt=new Date,So=new Date(Mt.getFullYear(),Mt.getMonth(),1),q={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:So.toISOString().split("T")[0],dashEndDate:Mt.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:So.toISOString().split("T")[0],histEndDate:Mt.toISOString().split("T")[0],histProfessionalId:"all"};let vt=null;const Ye=document.getElementById("content");async function Ql(){try{q.professionals=await K(m.establishmentId)}catch(e){console.error("Erro profissionais",e)}id(),Xl(),Yt(),qt("dashboard")}function Xl(){vt&&Ye.removeEventListener("click",vt),vt=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,s=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":qt(t.dataset.tab);break;case"toggle-all-profs":Zl();break;case"back-to-filters":q.calculationResult=null,At(document.getElementById("commissions-content"));break;case"view-preview-items":nd(r);break;case"save-final-report":ed();break;case"start-new-calc":qt("calculator");break;case"print-receipt":td(s);break;case"delete-report":ad(s);break;case"filter-dashboard":Yt();break;case"filter-history":Ra();break}},Ye.addEventListener("click",vt),Ye.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;sd(t)}},Ye.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),Kl())}}async function Yt(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(q.dashStartDate=e.value),t&&(q.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const s=await Jl(q.dashStartDate,q.dashEndDate);q.dashStats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0},q.currentTab==="dashboard"&&Cs(document.getElementById("commissions-content"))}catch(s){console.error(s),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Ra(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(q.histStartDate=e.value),t&&(q.histEndDate=t.value),a&&(q.histProfessionalId=a.value);const s=document.getElementById("history-list-container");if(s){s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await Gl({startDate:q.histStartDate,endDate:q.histEndDate,professionalId:q.histProfessionalId});q.historyData=r,Ls(s,r)}catch{s.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function Zl(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function Kl(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(o=>o.value);if(e.length===0)return p("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),s=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");q.periodString=`${a} a ${s}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const o=await _l(t);q.calculationResult=o.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),At(r)}catch(o){p("Erro",o.message,"error"),q.calculationResult=null,At(r)}}async function ed(){const e=q.calculationResult.length;if(await O("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=q.calculationResult.map(s=>{const r=s.items.map(o=>o.originalSaleId).filter(o=>o!=null);return Wl({professionalId:s.professionalId,professionalName:s.professionalName,period:q.periodString,processedSalesIds:r,reportData:{...s,summary:{...s.summary,finalValue:s.finalValue,extraDebit:s.extraDebit||0,extraCredit:s.extraCredit||0,notes:s.notes||""}}})});await Promise.all(a),p("Sucesso","Pagamentos registrados!","success"),q.calculationResult=null,Yt(),qt("history")}catch(a){p("Erro",a.message,"error")}}function td(e){const t=q.historyData.find(a=>a.id===e);t&&od(t)}async function ad(e){if(await O("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await Yl(e),p("Sucesso","Registro removido.","success"),Ra(),Yt()}catch(a){p("Erro",a.message,"error")}}function od(e){const{jsPDF:t}=window.jspdf;if(!t)return p("Erro","PDF lib não carregada.","error");const a=new t,s=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",s,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const o=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,o,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function sd(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let s=0,r=0;if(t.forEach(o=>{o.value&&(s=parseFloat(o.value))}),a.forEach(o=>{o.value&&(r=parseFloat(o.value))}),q.calculationResult&&q.calculationResult[e]){const o=q.calculationResult[e];o.extraDebit=s,o.extraCredit=r,o.finalValue=o.summary.totalCommission-s+r,t.forEach(i=>{i!==document.activeElement&&(i.value=s||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${o.finalValue.toFixed(2)}`),rd()}}function rd(){const e=q.calculationResult.reduce((a,s)=>a+s.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function nd(e){const t=q.calculationResult[e];if(!t)return;const a=t.items.map(s=>`
    ...
    `).join("");Y({title:"Detalhes da Comissão",contentHTML:`<div class="bg-gray-50 p-3 rounded-lg mb-4 flex justify-between items-center"><div><p class="text-xs text-gray-500">Profissional</p><p class="font-bold text-gray-800">${t.professionalName}</p></div><div class="text-right"><p class="text-xs text-gray-500">Total Itens</p><p class="font-bold text-gray-800">${t.items.length}</p></div></div><div class="border rounded-lg overflow-hidden max-h-[60vh] overflow-y-auto">${a}</div>`,maxWidth:"max-w-md"})}function At(e){if(q.calculationResult){const t=q.calculationResult,a=t.reduce((o,n)=>o+n.finalValue,0),s=t.map((o,n)=>`
            ...
            </div>`}else{const t=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],s=q.professionals.map(r=>`
    ...
    `}function ld(e){const t=q.professionals.map(a=>`<option value="${a.id}" ${q.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,q.historyData.length>0?Ls(document.getElementById("history-list-container"),q.historyData):Ra()}function Ls(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const aa=document.getElementById("content");let ke={allPackages:[],catalogForModal:{services:[],products:[]}},ht=null,Be=null;function dd(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function cd(){const e=document.getElementById("packagesListContainer");if(e){if(ke.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=ke.allPackages.map(t=>{const a=t.status==="active",s=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,o=t.originalPrice||0,n=o>r?o-r:0,i=o>0?(o-r)/o*100:0,l=f(t.name),d=f(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function $o(){const e=document.getElementById("genericModal");e.style.display="none",Be&&e.removeEventListener("click",Be)}async function Eo(e=null){const t=document.getElementById("genericModal"),a=!!e,s=e?JSON.parse(JSON.stringify(e.items||[])):[],r=f(e?.name||""),o=f(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(b,h)=>{const v=h.querySelector("#originalPrice"),y=b.reduce((w,S)=>w+S.price*S.quantity,0);v&&(v.textContent=`R$ ${y.toFixed(2)}`)},g=b=>{b.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=b.map((h,v)=>{const y=h.type==="service",w=y?"Serviço":"Produto",S=y?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:g}=d.dataset,h=(ke.catalogForModal[u+"s"]||[]).find(v=>v.id===g);h&&(e({...h,type:u}),i())}else(c||l.target===a)&&i()})}async function ja(){aa.innerHTML=`
    ...
    `,ht&&aa.removeEventListener("click",ht),ht=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;O("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async o=>{if(o)try{await bn(r),p("Sucesso!","Pacote excluído.","success"),await ja()}catch(n){p("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")Eo(null);else if(a==="edit-package"){const s=JSON.parse(t.dataset.package);Eo(s)}},aa.addEventListener("click",ht);try{const[e,t,a]=await Promise.all([Ca(m.establishmentId),ge(m.establishmentId),lt(m.establishmentId)]);ke.allPackages=e,ke.catalogForModal={services:t.filter(s=>s.active),products:a},cd()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const md=document.getElementById("content");let pd=null;async function gd(){const e=f(m.userName||"Usuário"),t=f(U.currentUser?.email||"E-mail não disponível"),a=m.userName?m.userName.charAt(0):"U";md.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await bd()}async function bd(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await rr(t);pd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=f(a.name);e.innerHTML=`
            ...
            `,fd(a.id),document.getElementById("my-blocks-filter").addEventListener("change",o=>Nt(a.id,o.target.value)),Nt(a.id,"future")}else e.innerHTML=`
    ...
    `}function va(){const e=ot.filter(t=>!t.read).length;if(e>0?(ra.textContent=e,ra.classList.remove("hidden")):ra.classList.add("hidden"),ot.length===0){Co.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}Co.innerHTML=ot.map(t=>`
