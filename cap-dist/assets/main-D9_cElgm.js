import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as J,d as Q}from"./firebase-config-BCzB3QOS.js";import{EmailAuthProvider as Uo,reauthenticateWithCredential as Jo,verifyBeforeUpdateEmail as _o,updatePassword as Wo,updateProfile as Go,onAuthStateChanged as Yo,signOut as Ta}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{addDoc as ga,collection as Te,getDocs as po,query as go,orderBy as bo,doc as Bt,deleteDoc as Xo,updateDoc as fo,getDoc as Qo,where as Zo,onSnapshot as Ko}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";const p={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function es(e,t,a){p.establishmentId=e,p.establishmentName=t,p.userPermissions=a}const Kt="https://kairos-app-407358446276.us-central1.run.app";console.log("🚀 API configurada para Produção (US):",Kt);async function ts(){const e=J.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function w(e,t={}){const a=await ts();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const o=Kt.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,s=`${o}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${s}`);try{const n=await fetch(s,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,u=l.match(d),c=u?u[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${s}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${s}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${Kt}. Verifique sua conexão com a internet.`):n}}const as=(e,t,a,o=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return o&&(r+=`&professionalId=${o}`),w(r)},os=(e,t,a)=>{const o=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return w(o)},ss=({establishmentId:e,professionalId:t,serviceIds:a,date:o})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${o}`;return w(r)},rs=e=>w("/api/appointments",{method:"POST",body:JSON.stringify(e)}),ba=(e,t)=>w(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),ns=e=>w(`/api/appointments/${e}`,{method:"DELETE"}),is=e=>w(`/api/appointments/${e}/reopen`,{method:"POST"}),ls=(e,t)=>w(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let R;async function ds(){if(!R)try{R=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function cs(){if(!R){console.warn("AudioContext não inicializado. O som não será tocado.");return}R.state==="suspended"&&R.resume();const e=R.createOscillator(),t=R.createGain();e.connect(t),t.connect(R.destination),e.type="sine",e.frequency.setValueAtTime(800,R.currentTime),t.gain.setValueAtTime(0,R.currentTime),t.gain.linearRampToValueAtTime(.3,R.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,R.currentTime+.2),e.start(R.currentTime),e.stop(R.currentTime+.2)}function g(e,t,a="info",o=!1){const r=document.getElementById("toast-container");if(!r)return;o&&cs();const s=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${n[a]||n.info}`,s.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",u=>{u.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function Tt(e){const t=document.getElementById(e);t&&(t.style.display="none")}function us(){document.body.addEventListener("click",()=>{R||ds()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const o=t.dataset.target;if(o){const r=document.getElementById(o);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const o=document.getElementById("genericModal");o&&(o.style.display="none")}})}async function Da(){const e=document.getElementById("cancellationListContainer");if(!e)return;e.innerHTML='<div class="loader mx-auto"></div>';const t=document.getElementById("cancelStartDate").value,a=document.getElementById("cancelEndDate").value;try{const o=await os(p.establishmentId,t,a);if(o.length===0){e.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}e.innerHTML=o.map(r=>`
        ...
        `).join("")}catch(o){e.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${o.message}</p>`}}function ms(){const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const o=`
    ...
    `,{modalElement:r}=N({title:"Histórico de Cancelamentos",contentHTML:o,maxWidth:"max-w-3xl"});r.querySelector("#searchCancellationsBtn").addEventListener("click",Da),Da()}const z=document.getElementById("sidebar"),Ma=document.getElementById("sidebarToggle"),Fe=document.getElementById("mainContent"),ps=document.querySelectorAll(".sidebar-link"),Pa=document.getElementById("hamburger-menu-btn"),Ce=document.getElementById("mobile-overlay");function vt(e){!z||!Fe||(z.classList.toggle("collapsed",e),Fe.classList.toggle("sidebar-collapsed-shift",e))}function gs(){!z||!Ce||(z.classList.add("mobile-open"),Ce.classList.add("visible"))}function st(){!z||!Ce||(z.classList.remove("mobile-open"),Ce.classList.remove("visible"))}function bs(){vt(!z.classList.contains("collapsed"))}function fs(e,t,a){if(!z||!Fe)return;Fe.classList.add("main-content-shift"),window.innerWidth>=768?vt(z.classList.contains("collapsed")):(Fe.classList.remove("main-content-shift","sidebar-collapsed-shift"),st()),Ma&&Ma.addEventListener("click",r=>{r.stopPropagation(),bs()}),z.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&z.classList.contains("collapsed")&&vt(!1)}),z.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||vt(!0))}),Pa&&Pa.addEventListener("click",r=>{r.stopPropagation(),gs()}),Ce&&Ce.addEventListener("click",r=>{r.stopPropagation(),st()});let o=0;z.addEventListener("touchstart",r=>{o=r.changedTouches[0].screenX},{passive:!0}),z.addEventListener("touchend",r=>{const s=r.changedTouches[0].screenX;o-s>50&&st()},{passive:!0}),ps.forEach(r=>{const s=r.getAttribute("data-target"),n=s.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[s]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),s&&typeof e=="function"&&e(s),window.innerWidth<768&&st()})})}const Qe=e=>{const t=e||p.establishmentId;return t?w(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},vs=(e,t)=>{const a=e||p.establishmentId;return a?w(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},hs=(e,t)=>{const a=e||p.establishmentId;return a?w(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},xs=(e,t)=>{const a=e||p.establishmentId;return a?w(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},_=e=>w(`/api/professionals/${e}`),ys=e=>w(`/api/professionals/details/${e}`),ws=e=>w("/api/professionals",{method:"POST",body:JSON.stringify(e)}),ks=(e,t)=>w(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ss=e=>w(`/api/professionals/${e}`,{method:"DELETE"});var Ie;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ie||(Ie={}));class Ot extends Error{constructor(t,a,o){super(t),this.message=t,this.code=a,this.data=o}}const $s=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Es=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},o=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:$s(e),s=()=>r()!=="web",n=c=>{const m=d.get(c);return!!(m?.platforms.has(r())||i(c))},i=c=>{var m;return(m=a.PluginHeaders)===null||m===void 0?void 0:m.find(b=>b.name===c)},l=c=>e.console.error(c),d=new Map,u=(c,m={})=>{const b=d.get(c);if(b)return console.warn(`Capacitor plugin "${c}" already registered. Cannot register plugins twice.`),b.proxy;const f=r(),v=i(c);let x;const h=async()=>(!x&&f in m?x=typeof m[f]=="function"?x=await m[f]():x=m[f]:t!==null&&!x&&"web"in m&&(x=typeof m.web=="function"?x=await m.web():x=m.web),x),k=(M,q)=>{var F,O;if(v){const se=v?.methods.find(W=>q===W.name);if(se)return se.rtype==="promise"?W=>a.nativePromise(c,q.toString(),W):(W,at)=>a.nativeCallback(c,q.toString(),W,at);if(M)return(F=M[q])===null||F===void 0?void 0:F.bind(M)}else{if(M)return(O=M[q])===null||O===void 0?void 0:O.bind(M);throw new Ot(`"${c}" plugin is not implemented on ${f}`,Ie.Unimplemented)}},$=M=>{let q;const F=(...O)=>{const se=h().then(W=>{const at=k(W,M);if(at){const ot=at(...O);return q=ot?.remove,ot}else throw new Ot(`"${c}.${M}()" is not implemented on ${f}`,Ie.Unimplemented)});return M==="addListener"&&(se.remove=async()=>q()),se};return F.toString=()=>`${M.toString()}() { [capacitor code] }`,Object.defineProperty(F,"name",{value:M,writable:!1,configurable:!1}),F},E=$("addListener"),I=$("removeListener"),D=(M,q)=>{const F=E({eventName:M},q),O=async()=>{const W=await F;I({eventName:M,callbackId:W},q)},se=new Promise(W=>F.then(()=>W({remove:O})));return se.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await O()},se},H=new Proxy({},{get(M,q){switch(q){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return v?D:E;case"removeListener":return I;default:return $(q)}}});return o[c]=H,d.set(c,{name:c,proxy:H,platforms:new Set([...Object.keys(m),...v?[f]:[]])}),H};return a.convertFileSrc||(a.convertFileSrc=c=>c),a.getPlatform=r,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=n,a.registerPlugin=u,a.Exception=Ot,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Cs=e=>e.Capacitor=Es(e),_e=Cs(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),fa=_e.registerPlugin;class vo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let o=!1;this.listeners[t]||(this.listeners[t]=[],o=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),o&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,o){const r=this.listeners[t];if(!r){if(o){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}r.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:o=>{this.notifyListeners(a,o)}}}unimplemented(t="not implemented"){return new _e.Exception(t,Ie.Unimplemented)}unavailable(t="not available"){return new _e.Exception(t,Ie.Unavailable)}async removeListener(t,a){const o=this.listeners[t];if(!o)return;const r=o.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(o=>{this.notifyListeners(t,o)}))}}const Aa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),qa=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Is extends vo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(o=>{if(o.length<=0)return;let[r,s]=o.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=qa(r).trim(),s=qa(s).trim(),a[r]=s}),a}async setCookie(t){try{const a=Aa(t.key),o=Aa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,s=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${o||""}${r}; path=${s}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}fa("CapacitorCookies",{web:()=>new Is});const Ls=async e=>new Promise((t,a)=>{const o=new FileReader;o.onload=()=>{const r=o.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},o.onerror=r=>a(r),o.readAsDataURL(e)}),Bs=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,s,n)=>(r[s]=e[t[n]],r),{})},Ts=(e,t=!0)=>e?Object.entries(e).reduce((o,r)=>{const[s,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${s}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${s}=${i}`),`${o}&${l}`},"").substr(1):null,Ds=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Bs(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))s.set(n,i);a.body=s.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{s.append(l,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);a.body=s;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Ms extends vo{async request(t){const a=Ds(t,t.webFetchExtra),o=Ts(t.params,t.shouldEncodeUrlParams),r=o?`${t.url}?${o}`:t.url,s=await fetch(r,a),n=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await s.blob(),l=await Ls(d);break;case"json":l=await s.json();break;case"document":case"text":default:l=await s.text()}const u={};return s.headers.forEach((c,m)=>{u[m]=c}),{data:l,headers:u,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}fa("CapacitorHttp",{web:()=>new Ms});const re=fa("PushNotifications",{}),Ps=(e,t,a="all",o="all")=>{const r={startDate:e,endDate:t};a&&a!=="all"&&(r.professionalId=a),o&&o!=="all"&&(r.costCenterId=o);const s=new URLSearchParams(r).toString();return w(`/api/reports/indicators?${s}`)},As=(e,t="all")=>{const a={date:e};t&&t!=="all"&&(a.professionalId=t);const o=new URLSearchParams(a).toString();return w(`/api/reports/appointments/list?${o}`)},qs=()=>w("/api/financial/cost-centers"),Ns=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:o})=>{let r=`/api/reports/sales/${e}?startDate=${t}&endDate=${a}`;return o&&o!=="all"&&(r+=`&cashierSessionId=${o}`),w(r)},Fs=()=>w("/api/reports/summary",{method:"GET"}),De=e=>w(`/api/services/${e}`),Rs=e=>w("/api/services",{method:"POST",body:JSON.stringify(e)}),js=(e,t)=>w(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Hs=e=>w(`/api/services/${e}`,{method:"DELETE"}),Os=(e,t)=>w(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),zs=e=>w(`/api/services/stats/most-popular/${e}`),Dt=(e,t,a,o="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${o}`;return w(r)},Mt=e=>w("/api/blockages",{method:"POST",body:JSON.stringify(e)}),va=e=>w(`/api/blockages/${e}`,{method:"DELETE"}),ho=e=>w("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Ze=e=>w(`/api/clients/${e}`),ha=e=>w("/api/clients",{method:"POST",body:JSON.stringify(e)}),Vs=(e,t)=>w(`/api/clients/${e}`,{method:"PUT",body:JSON.stringify(t)}),Us=e=>w(`/api/clients/${e}`,{method:"DELETE"}),Js=(e,t,a)=>{const o=`/api/clients/history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return w(o)},_s=(e,t,a)=>{const o=`/api/clients/loyalty-history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return w(o)},Ws=(e,t,a,o)=>w("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientName:t,clientPhone:a,rewardData:o})}),Na=document.getElementById("content");let Fa=!1;const ea=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let Ke=[],Pt=[],We={},ae=[],L={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},S={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Gs(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function xo(e){const t=new Date(e);if(t.setHours(0,0,0,0),L.currentView==="week"&&L.weekViewDays===7){const a=t.getDay(),o=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(o))}return t}function kt(){const e=document.getElementById("profSelectorContainer"),t=L.profSearchTerm.toLowerCase();if(!e||!p.professionals)return;let a=p.professionals.filter(s=>L.showInactiveProfs||s.status!=="inactive");t&&(a=a.filter(s=>s.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(s=>{const n=L.selectedProfessionalId===s.id,i=s.name==="Todos"?"Todos":s.name.split(" ")[0],l=s.name==="Todos"?"T":s.name.charAt(0).toUpperCase(),d=s.status!=="inactive",u=ea[0],c=s.id!=="all"&&p.professionalColors.get(s.id)||u,m=s.photo||`https://placehold.co/64x64/${c.main?.replace("#","")||"E0E7FF"}/${c.light?.replace("#","")||"4F46E5"}?text=${l}`,b=s.id==="all"?"#e0e7ff":c.light,f=s.id==="all"?"#4f46e5":c.main,x=`border: 3px solid ${n?c.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+c.border:"none"};`;return`
            <div class="prof-card ${n?"selected":""} ${d?"":"opacity-50"}" 
                 data-action="select-professional" 
                 data-prof-id="${s.id}">
                ${s.id==="all"?`<div class="prof-card-all-placeholder" style="background-color: ${b}; color: ${f}; ${x}">
                           ${l}
                          </div>`:`<img src="${m}" alt="${s.name}" class="prof-card-photo" style="${x}" />`}
                <span class="prof-card-name">${i}</span>
            </div>
        `}).join("")}function Ys(e,t,a,o,r){const s=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${o} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${s}?text=${d}`}function Xs(e){const t=document.getElementById("agenda-view");if(e.sort((o,r)=>new Date(o.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(o=>{const r=new Date(o.startTime),s=new Date(o.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=p.professionalColors.get(o.professionalId)||{};if(o.type==="blockage")return`
                ...
                </div>`;const d=o.status==="completed",u=d?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",c=d?"Finalizado":"Aberto",m=JSON.stringify(o).replace(/'/g,"&apos;"),b=o.redeemedReward?.points>0,f=o.hasRewards&&!b,v=Ys(o.clientPhone,o.clientName,o.serviceName,o.professionalName,o.startTime);return`
        ...
        `}s+="</div>",t.innerHTML=s}function Zs(){const e=p.allEvents.filter(t=>L.selectedProfessionalId==="all"||t.professionalId===L.selectedProfessionalId);L.currentView==="list"?Xs(e):Qs(e)}async function Z(){const e=document.getElementById("agenda-view");if(!e)return;e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const o=document.getElementById("weekRange");if(L.currentView==="list")t=new Date(L.currentDate),t.setHours(0,0,0,0),a=new Date(L.currentDate),a.setHours(23,59,59,999),o.textContent=Gs(t);else{const r=xa();t=xo(new Date(L.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),o.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await as(p.establishmentId,t.toISOString(),a.toISOString(),L.selectedProfessionalId==="all"?null:L.selectedProfessionalId),n=(await Dt(p.establishmentId,t.toISOString(),a.toISOString(),L.selectedProfessionalId)).map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const u=p.professionals?p.professionals.find(c=>c.id===l.professionalId):null;u&&(d=u.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(p.allEvents=i,kt(),Zs(),L.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${L.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),L.scrollToAppointmentId=null}}catch(r){g("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"),e.innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>'}}async function Ks(){try{const[e,t,a,o]=await Promise.all([p.professionals&&p.professionals.length>0?Promise.resolve(p.professionals):_(p.establishmentId),p.services&&p.services.length>0?Promise.resolve(p.services):De(p.establishmentId),ae.length>0?Promise.resolve(ae):Ze(p.establishmentId),We.enabled!==void 0?Promise.resolve(null):Qe(p.establishmentId)]);(!p.professionals||p.professionals.length===0)&&(p.professionals=e||[]),(!p.services||p.services.length===0)&&(p.services=t||[]),ae.length===0&&(ae=a||[]),o&&(We=o.loyaltyProgram||{enabled:!1}),p.professionals.forEach((r,s)=>{p.professionalColors.set(r.id,ea[s%ea.length])}),kt()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),g("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function ta(e){e<1||e>4||(S.step=e,aa(null,!0))}function yo(e,t){const a=document.getElementById("multiServiceToggle"),o=a&&a.checked,r=t.classList.contains("selected"),s=S.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),s>-1&&S.data.selectedServiceIds.splice(s,1);else{if(!o){S.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),S.data.selectedServiceIds.push(e)}}function wo(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const o=Pt.find(r=>r.id===e);S.data.professionalId=e,S.data.professionalName=o?o.name:"N/A"}function er(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(o=>o.classList.remove("selected")),t.classList.add("selected"),S.data.time=e)}async function Ra(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=S.data.professionalId,o=S.data.selectedServiceIds,r=document.getElementById("apptDate").value;S.data.date=r;const s=o.reduce((n,i)=>{const l=Ke.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${s} min`,s===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await ss({establishmentId:p.establishmentId,professionalId:a,serviceIds:o,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(u=>{const[c,m]=u.split(":").map(Number);return c*60+m>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const u=document.createElement("button");u.type="button",u.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${S.data.time===d?"selected":""}`,u.textContent=d,u.addEventListener("click",()=>er(d,u)),t.appendChild(u)}),S.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${S.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function tr(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:o}=S.data,{enabled:r,rewards:s,pointsPerCurrency:n}=We;if(!r||!t||!s||s.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const i=s.filter(d=>a>=d.points);let l=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",d=>{d.target.checked&&(S.data.redeemedReward=null)})}async function ar(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!S.data.time||S.data.selectedServiceIds.length===0||!S.data.professionalId)return g("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const o=S.data.selectedServiceIds.map(d=>{const u=Ke.find(c=>c.id===d);return{id:u.id,name:u.name,price:u.price,duration:u.duration,bufferTime:u.bufferTime||0,photo:u.photo||null}}),[r,s]=S.data.time.split(":"),n=new Date(`${S.data.date}T${r}:${s}:00`),i={establishmentId:p.establishmentId,clientName:S.data.clientName,clientPhone:S.data.clientPhone,services:o,professionalId:S.data.professionalId,startTime:n.toISOString(),redeemedReward:S.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await ba(l,i):await rs(i),g(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",Z()}catch(d){g(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function or(e){return`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",sr)}function nr(){rr()}function ir(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",o=`
    ...
    `;return{title:a,content:o}}function lr(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${Ke.map(o=>{const r=S.data.selectedServiceIds.includes(o.id),s=o.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
    ...
    `;return{title:e,content:t}}function cr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,o=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=S.data.date||o,s=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:s}}function ur(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),o=Ke.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=S.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>yo(r.dataset.serviceId,r))})}function mr(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),o=Pt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=o.map(r=>{const s=S.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P";return`
        ...
        </section>`,document.querySelectorAll(".view-btn[data-view]").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(r=>r.classList.remove("active")),a.classList.add("active"),L.currentView=a.dataset.view;const o=document.getElementById("week-days-toggle");if(L.currentView==="week"){if(o.style.display="flex",window.innerWidth<768){L.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(s=>s.classList.remove("active"));const r=document.querySelector('.week-days-btn[data-days="3"]');r&&r.classList.add("active")}}else o.style.display="none";Z()})}),document.querySelectorAll(".week-days-btn").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(o=>o.classList.remove("active")),a.classList.add("active"),L.weekViewDays=parseInt(a.dataset.days,10),Z()})}),document.getElementById("todayBtn").addEventListener("click",()=>{L.currentDate=new Date,Z()});const t=a=>{const o=parseInt(a.currentTarget.dataset.amount,10),r=L.currentView==="week"?xa():1,s=new Date(L.currentDate);s.setDate(s.getDate()+o*r),L.currentDate=s,Z()};document.getElementById("prevBtn").addEventListener("click",t),document.getElementById("nextBtn").addEventListener("click",t),document.getElementById("profSearchInput").addEventListener("input",a=>{L.profSearchTerm=a.target.value,kt()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",a=>{L.showInactiveProfs=a.target.checked,kt(),Z()}),Fa||(Na.addEventListener("click",async a=>{const o=a.target.closest("[data-action]");if(a.target.closest('[data-action="select-professional"]')){const l=a.target.closest('[data-action="select-professional"]').dataset.profId,d=L.selectedProfessionalId===l&&l!=="all";if(L.selectedProfessionalId=d?"all":l,l!=="all"){const u=document.getElementById("profSearchInput");u&&(u.value=""),L.profSearchTerm=""}await Z();return}if(!o)return;const r=o.dataset.action;let s=null;const n=a.target.closest("[data-appointment]");switch(n&&(s=JSON.parse(n.dataset.appointment.replace(/&apos;/g,"'"))),r){case"new-appointment":aa();break;case"edit-appointment":if(!s)return;if(s.status==="completed"){g("Atenção","Agendamentos finalizados não podem ser editados.","error");return}s.hasRewards&&!s.redeemedReward&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),aa(s);break;case"delete-appointment":{const i=o.dataset.id;if(await A("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await ns(i),g("Agendamento apagado!","success"),Z()}catch(d){g(`Não foi possível apagar: ${d.message}`,"error")}break}case"open-comanda":if(s){s.hasRewards&&!s.redeemedReward&&s.status!=="completed"&&g("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const i=s.status==="completed"?"finalizadas":"em-atendimento",l={selectedAppointmentId:s.id,initialFilter:i};if(i==="finalizadas"){let d=s.startTime;if(s.transaction&&s.transaction.paidAt){const u=s.transaction.paidAt;typeof u=="object"&&u._seconds?d=new Date(u._seconds*1e3):d=u}l.filterDate=d}Y("comandas-section",l)}break}}),Fa=!0),await Ks(),await Z()}const pr=(e,t=null,a=1,o=12)=>{let r=`/api/comandas/${e}?page=${a}&limit=${o}`;return t&&(r+=`&date=${t}`),w(r)},gr=e=>w("/api/sales",{method:"POST",body:JSON.stringify(e)}),br=e=>w(`/api/sales/${e}/reopen`,{method:"POST"}),fr=e=>w(`/api/sales/${e}`,{method:"DELETE"}),At=e=>w(`/api/products/${e}`),vr=e=>w("/api/products",{method:"POST",body:JSON.stringify(e)}),hr=(e,t)=>w(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),xr=e=>w(`/api/products/${e}`,{method:"DELETE"}),yr=(e,t)=>w(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),wr=({startDate:e,endDate:t,productId:a,categoryId:o})=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("productId",a),o&&o!=="all"&&r.append("categoryId",o),w(`/api/products/stock-history/report?${r.toString()}`)},So=()=>w("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),kr=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),w("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Sr=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),w(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},$r=()=>w("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),Er=e=>w(`/api/cashier/report/${e}`),$o=e=>w(`/api/packages/${e}`),Cr=e=>w("/api/packages",{method:"POST",body:JSON.stringify(e)}),Ir=(e,t)=>w(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),Lr=e=>w(`/api/packages/${e}`,{method:"DELETE"});let y={allComandas:[],catalog:{services:[],products:[],packages:[]},clients:[],activeFilter:"atendimento",selectedComandaId:null,isCashierOpen:!1,activeCashierSessionId:null,paging:{page:1,limit:12,total:0}},xe=null,ye=null;function qt(e){if(e.status==="completed"){const r=e.comandaItems||e.items||[];return r.length>0?r:e.services||[]}const t=e.services||[],a=[...e.comandaItems||[],...e.items||[]];let o=[...t];return a.forEach(r=>{if(r.type==="product"){o.push(r);return}o.some(n=>{const i=n.id&&r.id&&n.id===r.id,l=n.name&&r.name&&n.name===r.name;return i||l})||o.push(r)}),o}function Br(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function ge(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function Tr(){const e=new Date().toISOString().split("T")[0];ye.innerHTML=`
    ...
    `}function Dr(){const e=document.getElementById("cashier-controls");e&&(y.isCashierOpen?e.innerHTML=`
        ...
        `;return}const a={atendimento:"confirmed",finalizadas:"completed"}[y.activeFilter],o=y.allComandas.filter(r=>r.status===a);if(o.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',Ha(e);return}e.innerHTML=o.map(r=>{const n=qt(r).reduce((c,m)=>c+(m.price||0),0),i=r.id===y.selectedComandaId,l=new Date(r.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=r.type==="walk-in"||r.id.startsWith("temp-")?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md">Agendado</span>';return`
    ...
    `}function Mr(){N({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",Pr)}async function Pr(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector('button[type="submit"]'),o={establishmentId:p.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim()||null,phone:t.querySelector("#regClientPhone").value.trim(),dob:`${t.querySelector("#regClientDobDay").value.trim()}/${t.querySelector("#regClientDobMonth").value.trim()}`,notes:t.querySelector("#regClientNotes").value.trim()||null};if(!o.name||!o.phone)return g("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{const r=await ha(o);y.clients.push({id:r.id,...o}),g("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",Eo(r.id)}catch(r){g(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar Cliente"}}function Ar(){if(!y.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:e,close:t}=N({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{let r="";const s=e.querySelector("#add-item-content"),n={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},i=()=>{const l=r.toLowerCase(),d=c=>c.filter(m=>m.name.toLowerCase().includes(l)),u={"modal-service-list":{items:d(y.catalog.services),type:"service"},"modal-product-list":{items:d(y.catalog.products),type:"product"},"modal-package-list":{items:d(y.catalog.packages),type:"package"}};for(const[c,{items:m,type:b}]of Object.entries(u)){const f=s.querySelector(`#${c}`);f&&(f.innerHTML=m.map(v=>`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{s>1&&(s--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{s++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await jr(r,s),t()}};e.addEventListener("click",r=>{const s=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(s){const{itemType:i,itemId:l}=s.dataset,u=(y.catalog[i+"s"]||[]).find(c=>c.id===l);u&&o({...u,type:i})}else n&&a()}),a()}async function Eo(e=null){if(!y.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!y.clients||y.clients.length===0)try{y.clients=await Ze(p.establishmentId)}catch{g("Erro","Não foi possível carregar dados de clientes.","error");return}if(!p.professionals||p.professionals.length===0)try{p.professionals=await _(p.establishmentId)}catch{g("Erro","Não foi possível carregar dados de profissionais.","error");return}const t=y.clients.map(n=>{const i=n.id===e?"selected":"";return`<option value="${n.id}" ${i}>${n.name} - ${n.phone}</option>`}).join(""),a=p.professionals.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""),o=`
    ...
    `,{modalElement:r}=N({title:"Nova Venda Avulsa",contentHTML:o,maxWidth:"max-w-md"});r.querySelector("#new-sale-form").addEventListener("submit",zr);const s=r.querySelector('[data-action="new-client-from-sale"]');s&&s.addEventListener("click",n=>{n.preventDefault(),r.style.display="none",Mr()})}function qr(){if(!y.isCashierOpen){g("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const e=y.allComandas.find(c=>c.id===y.selectedComandaId);if(!e)return;const t=qt(e),a=new Set,o=[];for(const c of t){if(c.type==="service"&&c.id){if(a.has(c.id))continue;a.add(c.id)}o.push(c)}const r=o.reduce((c,m)=>c+(m.price||0),0);let s=[],n={remainingAmount:r,selectedMethod:"dinheiro",installments:1,amountReceived:""};const i=()=>{const c=document.getElementById("payment-list"),m=document.getElementById("remaining-amount"),b=document.getElementById("finalize-checkout-btn"),f=document.getElementById("change-container"),v=document.getElementById("installments-container"),x=document.getElementById("payment-value"),h=document.getElementById("payment-controls"),k=s.reduce((E,I)=>E+I.value,0);n.remainingAmount=r-k,c.innerHTML=s.map((E,I)=>`
    ...
    `,{modalElement:t}=N({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const o=document.getElementById("initial-amount"),r=o.value.trim(),s=document.getElementById("cashier-notes").value.trim(),n=parseFloat(r);if(r===""||isNaN(n)||n<0){g("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),o.focus();return}try{const i={establishmentId:p.establishmentId,initialAmount:parseFloat(n.toFixed(2))};s&&(i.notes=s);const l=await kr(i);y.isCashierOpen=!0,y.activeCashierSessionId=l.id,await ya(),document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto com valor inicial de R$ ${n.toFixed(2)}`,"success")}catch(i){g("Erro",`Não foi possível abrir o caixa: ${i.message}`,"error")}})}async function Fr(){const e=y.activeCashierSessionId;if(e)try{const t=await Er(e),a=`
        ...
        `,{modalElement:o}=N({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});o.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const s=parseFloat(document.getElementById("final-amount").value);if(isNaN(s)||s<0){g("Valor Inválido","Insira um valor final válido.","error");return}try{await Sr(e,s),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await ya(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){g("Erro",`Não foi possível fechar o caixa: ${n.message}`,"error")}})}catch(t){g("Erro",`Não foi possível carregar o relatório de fecho: ${t.message}`,"error")}}async function Rr(e){y.activeFilter!==e&&(y.activeFilter=e,y.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),ge(),await ee(),y.selectedComandaId=null,G())}function oa(e){y.selectedComandaId=e,de(),Br(),G()}async function jr(e,t){const a=y.allComandas.find(r=>r.id===y.selectedComandaId);if(!a)return;const o=Array(t).fill(0).map(()=>({id:e.id,name:e.name,price:e.price,type:e.type}));if(a.comandaItems=a.comandaItems||[],a.comandaItems.push(...o),a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),G(),de();return}try{await ba(a.id,a),g("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),G(),de()}catch(r){g("Erro",`Não foi possível adicionar o item: ${r.message}`,"error"),a.comandaItems.splice(a.comandaItems.length-t,t)}}async function Hr(e,t){const a=y.allComandas.find(s=>s.id===y.selectedComandaId);if(!a)return;let o=!1,r=(a.comandaItems||[]).findIndex(s=>s.id===e&&s.type===t);if(r>-1)a.comandaItems.splice(r,1),o=!0;else{let s=(a.services||[]).findIndex(n=>n.id===e);if(s>-1)a.services.splice(s,1),o=!0;else{let n=(a.items||[]).findIndex(i=>i.id===e&&i.type===t);n>-1&&(a.items.splice(n,1),o=!0)}}if(o){if(a.type==="walk-in"&&a.id.startsWith("temp-")){g("Sucesso","Item removido!","success"),G(),de();return}try{await ba(a.id,a),g("Sucesso","Item removido!","success"),G(),de()}catch(s){g("Erro",`Não foi possível remover o item: ${s.message}`,"error"),await ee()}}}async function Or(e,t,a){const o=e.type==="appointment",r=qt(e),s=new Set,n=[];for(const l of r){if(l.type==="service"&&l.id){if(s.has(l.id))continue;s.add(l.id)}n.push(l)}const i={payments:a,totalAmount:t,items:n,cashierSessionId:y.activeCashierSessionId};try{o?await ls(e.id,i):(i.clientName=e.clientName,i.professionalId=e.professionalId,i.clientPhone=e.clientPhone,await gr(i)),g("Sucesso!","Venda finalizada com sucesso!","success"),document.getElementById("genericModal").style.display="none",ge(),y.selectedComandaId=null,await ee()}catch(l){g("Erro no Checkout",l.message,"error")}}async function zr(e){e.preventDefault();const t=document.getElementById("new-sale-client").value,a=document.getElementById("new-sale-professional").value,o=y.clients.find(n=>n.id===t),r=p.professionals.find(n=>n.id===a);if(!o||!r){g("Erro","Selecione um cliente e um profissional válidos.","error");return}const s={id:`temp-${Date.now()}`,type:"walk-in",clientName:o.name,clientPhone:o.phone,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(s),y.selectedComandaId=s.id,document.getElementById("genericModal").style.display="none",oa(s.id)}async function ee(){const e=document.getElementById("comandas-list");e.innerHTML='<div class="loader mx-auto mt-10"></div>';const t=y.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=await So();if(y.isCashierOpen=!!a,y.activeCashierSessionId=a?a.id:null,Dr(),!y.isCashierOpen&&y.activeFilter==="atendimento"){de(),G();return}const o=await pr(p.establishmentId,t,y.paging.page,y.paging.limit);if(y.allComandas=o.data||o,y.paging.total=o.total||o.length,y.catalog.services.length===0){const[r,s,n,i,l]=await Promise.all([De(p.establishmentId),At(p.establishmentId),$o(p.establishmentId),Ze(p.establishmentId),_(p.establishmentId)]);y.catalog={services:r,products:s,packages:n},y.clients=i,p.professionals=l}de(),y.selectedComandaId,G()}catch(a){g("Erro de Carregamento",`Não foi possível carregar os dados: ${a.message}`,"error"),e.innerHTML=`<p class="text-red-500 p-4">${a.message}</p>`}}async function ya(e={}){ye=document.getElementById("content");try{const t=await So();y.isCashierOpen=!!t,y.activeCashierSessionId=t?t.id:null}catch(t){console.error("Erro ao verificar caixa:",t),y.isCashierOpen=!1}y.selectedComandaId=e.selectedAppointmentId||null,Tr(),xe&&(ye.removeEventListener("click",xe),ye.removeEventListener("change",xe)),xe=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(t.target.id==="filter-date"&&y.activeFilter==="finalizadas"){y.paging.page=1,await ee();return}if(a){if(a.matches("[data-filter]"))Rr(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}oa(a.dataset.comandaId)}else if(a.matches("[data-action]")){const o=a.dataset.action,r=a.dataset.id||y.selectedComandaId;switch(o){case"back-to-list":{ge(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(s=>s.classList.remove("selected")),G();break}case"new-sale":Eo();break;case"add-item":Ar();break;case"checkout":qr();break;case"open-cashier":Nr();break;case"close-cashier":await Fr();break;case"view-sales-report":Y("sales-report-section");break;case"remove-item":await Hr(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await A("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await is(r);const n=y.allComandas.findIndex(i=>i.id===r);n!==-1&&(delete y.allComandas[n].transaction,delete y.allComandas[n].cashierSessionId,delete y.allComandas[n].redeemedReward,y.allComandas[n].status="confirmed"),y.selectedComandaId=null,ge(),g("Sucesso!","Comanda reaberta para edição.","success"),await ee()}catch(n){g("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"reopen-walk-in":{if(await A("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await br(r),g("Sucesso!","Venda revertida."),ge(),y.selectedComandaId=null,await ee()}catch(n){g("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"go-to-appointment":{const s=a.dataset.id,n=a.dataset.date;Y("agenda-section",{scrollToAppointmentId:s,targetDate:new Date(n)});break}case"delete-walk-in":{if(await A("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(r.startsWith("temp-"))y.allComandas=y.allComandas.filter(n=>n.id!==r),y.selectedComandaId=null,de(),G(),g("Sucesso","Venda avulsa removida.","success"),ge();else try{await fr(r),g("Sucesso","Venda avulsa excluída com sucesso.","success"),y.selectedComandaId=null,ge(),await ee()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}break}}}}},ye.addEventListener("click",xe),ye.addEventListener("change",xe),e.initialFilter&&(y.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${y.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",y.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await ee(),y.selectedComandaId&&oa(y.selectedComandaId)}const sa=document.getElementById("content");let $e={};const rt=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],T={startDate:new Date(new Date().getFullYear(),0,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,currentTab:"dashboards",apptViewMode:"year",apptSelectedMonth:null};async function Vr(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function Ur(){sa.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">Carregando inteligência de dados...</p></div>';try{await Vr();const[e,t]=await Promise.all([_(p.establishmentId),qs().catch(()=>[])]);T.professionalsList=e,T.costCentersList=t,Jr(),await Co()}catch(e){sa.innerHTML=`
            ...
            </div>`}}function Jr(){const e=T.professionalsList.map(a=>`<option value="${a.id}">${a.name}</option>`).join(""),t=T.costCentersList.map(a=>`<option value="${a.id}">${a.name}</option>`).join("");sa.innerHTML=`
            ...
            <div class="bg-white shadow-sm border-b sticky top-0 z-20 px-4 py-4">
                <div class="max-w-7xl mx-auto flex flex-col xl:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex flex-col md:flex-row gap-2 w-full xl:w-auto">
                        ...
                        <div class="flex gap-2">
                            <input type="date" id="report-start" value="${T.startDate}" class="border rounded-lg px-2 py-2 text-sm w-full">
                            <input type="date" id="report-end" value="${T.endDate}" class="border rounded-lg px-2 py-2 text-sm w-full">
    ...
    `,document.getElementById("btn-filter").onclick=_r,document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{T.currentTab=a.dataset.tab,Oa(),Io()}}),Oa()}function Oa(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===T.currentTab;e.className=t?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function _r(){T.startDate=document.getElementById("report-start").value,T.endDate=document.getElementById("report-end").value,T.selectedProfessional=document.getElementById("report-prof").value,T.selectedCostCenter=document.getElementById("report-cost").value,T.apptViewMode="year",T.apptSelectedMonth=null,await Co()}async function Co(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const t=await Ps(T.startDate,T.endDate,T.selectedProfessional,T.selectedCostCenter);T.data=t,Io()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function Io(){const e=document.getElementById("report-content");switch(T.currentTab){case"dashboards":Wr(e);break;case"appointments":wa(e);break;case"dre":Qr(e);break}}function Wr(e){const{dreSimple:t,charts:a}=T.data,o=t||{grossRevenue:0,netProfit:0,variableCosts:0},r=T.data.totalAppointments||0,s=r>0?o.grossRevenue/r:0;e.innerHTML=`
    ...
    `,nt("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,rt[0]),nt("chart-profs","doughnut","Total Vendas",a.professionals.labels,a.professionals.data,rt),nt("chart-daily","line","Vendas Diárias",a.salesDaily.labels,a.salesDaily.data,rt[4]),nt("chart-products","bar","Total Vendido",a.products.labels,a.products.data,rt[1])}function wa(e){const{charts:t}=T.data;let a='<h3 class="font-bold text-gray-700 text-lg">Visão Anual/Mensal</h3>',o="Clique na barra do Mês para detalhar os dias";T.apptViewMode==="month"&&(a=`
            <div class="flex items-center gap-4">
                ...
                <h3 class="font-bold text-gray-700 text-lg">Detalhes de ${T.apptSelectedMonth}</h3>
    ...
    `,Gr();const r=document.getElementById("btn-back-year");r&&(r.onclick=()=>{T.apptViewMode="year",T.apptSelectedMonth=null,wa(e)})}function Gr(){const e=document.getElementById("chart-appointments").getContext("2d");$e["chart-appointments"]&&$e["chart-appointments"].destroy();const{charts:t}=T.data;let a,o;if(T.apptViewMode==="year")a=t.appointmentsMonthly.labels,o=t.appointmentsMonthly.data;else{const s={jan:"01",fev:"02",mar:"03",abr:"04",mai:"05",jun:"06",jul:"07",ago:"08",set:"09",out:"10",nov:"11",dez:"12"},[n,i]=T.apptSelectedMonth.split("/"),l=s[n.toLowerCase()]||n,d=i.length===2?"20"+i:i,u=Object.entries(t.appointmentsDaily.data).map(([c,m],b)=>{const f=t.appointmentsDaily.labels[b];return f.includes(`/${l}/${d}`)?{label:f,value:m}:null}).filter(Boolean);a=u.map(c=>c.label),o=u.map(c=>c.value)}const r={type:"bar",data:{labels:a,datasets:[{label:"Volume de Agendamentos",data:o,backgroundColor:T.apptViewMode==="year"?"#3b82f6":"#8b5cf6",borderRadius:4,hoverBackgroundColor:"#1e40af"}]},options:{responsive:!0,maintainAspectRatio:!1,onClick:(s,n)=>{if(n.length>0){const i=n[0].index,l=a[i];Yr(l)}},plugins:{legend:{display:!1},tooltip:{callbacks:{label:s=>` ${s.raw} Agendamentos`}}}}};$e["chart-appointments"]=new Chart(e,r)}function Yr(e){T.apptViewMode==="year"?(T.apptViewMode="month",T.apptSelectedMonth=e,wa(document.getElementById("report-content"))):T.apptViewMode==="month"&&Xr(e)}async function Xr(e){const[t,a,o]=e.split("/"),r=`${o}-${a}-${t}`;N({title:"Carregando...",contentHTML:'<div class="p-8 text-center"><div class="loader mx-auto"></div></div>',maxWidth:"max-w-md"});try{const s=await As(r,T.selectedProfessional);let n="";s.length===0?n='<div class="text-center py-8 text-gray-500 bg-gray-50 rounded-lg">Nenhum agendamento encontrado para este dia.</div>':n=`
    ...
    `}function nt(e,t,a,o,r,s){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");$e[e]&&$e[e].destroy();const l={type:t,data:{labels:o,datasets:[{label:a,data:r,backgroundColor:Array.isArray(s)?s:t==="line"?"rgba(79, 70, 229, 0.1)":s,borderColor:Array.isArray(s)?"#fff":s,borderWidth:2,fill:t==="line",tension:.3,borderRadius:t==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:s,pointHoverBackgroundColor:s}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let u=d.dataset.label||"";return u&&(u+=": "),d.parsed.y!==null?u+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):u+=d.raw,u}}}},scales:t==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};$e[e]=new Chart(i,l)}const Nt=(e,t="products")=>w(`/api/${t}/categories/${e}`),Lo=(e,t="products")=>w(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),Bo=(e,t="products")=>w(`/api/${t}/categories/${e}`,{method:"DELETE"}),Zr="audit_logs",Le=async(e,t,a,o,r,s=null)=>{try{if(!t)return;await ga(Te(Q,Zr),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:o,description:r,details:s,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},pe=document.getElementById("content");let ne=null,Re="services",fe="all";function Be(){const e=J.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function Kr(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await Lo({establishmentId:p.establishmentId,name:o},"services"),Le(p.establishmentId,Be(),"Categorias (Serviços)","Criou",`Criou categoria: ${o}`),a.value="",g("Sucesso","Categoria criada!","success"),await ka(),await et()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function en(e){if(await A("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await Bo(e,"services"),Le(p.establishmentId,Be(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await ka(),await et()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function ka(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Nt(p.establishmentId,"services");p.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function tn(){N({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${a.name}</option>`)),Sa(),we()}function rn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function et(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,o,r]=await Promise.all([De(p.establishmentId),_(p.establishmentId),Nt(p.establishmentId,"services"),zs(p.establishmentId)]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(o||[]).filter(Boolean),p.mostPopularService=r||{name:"N/A",count:0},p.services.forEach(s=>{s.active===void 0&&(s.active=!0)}),To(Re)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function To(e){if(document.getElementById("services-content-container")){if(Re===e&&document.getElementById("services-content-container").children.length>1){Re==="services"&&(Sa(),we());return}Re=e,fe="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?sn():e==="reports"&&rn()}}function nn(){ne&&(pe.removeEventListener("click",ne),pe.removeEventListener("input",ne),pe.removeEventListener("change",ne)),ne=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),s=r.dataset.id,n=r.checked;try{await Os(s,n);const i=p.services.findIndex(l=>l.id===s);i>-1&&(p.services[i].active=n),Le(p.establishmentId,Be(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${s}) para ${n?"Ativo":"Inativo"}`),we(),Sa()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,we()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){we();return}if(!a)return;if(a.hasAttribute("data-view")){To(a.dataset.view);return}switch(a.dataset.action){case"new-service":za();break;case"edit-service":const r=JSON.parse(a.dataset.service);za(r);break;case"manage-categories":tn();break;case"filter-service":const s=a.dataset.filterType;if(s==="popular")return;fe=s==="total"?"all":s,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===fe||i==="total"&&fe==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),we();break}},pe.addEventListener("click",ne),pe.addEventListener("input",ne),pe.addEventListener("change",ne)}async function ln(){pe.innerHTML=`
        ...
        </section>`,nn();try{(!p.professionals||p.professionals.length===0)&&(p.professionals=await _(p.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),p.professionals=[]}Re="services",fe="all",await et()}const Ft="suppliers",Do="purchases",$a=async()=>{try{const e=await po(Te(Q,Ft)),t=[];return e.forEach(a=>{t.push({id:a.id,...a.data()})}),t}catch(e){throw console.error("Erro ao buscar fornecedores:",e),e}},dn=async e=>{try{return{id:(await ga(Te(Q,Ft),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},cn=async(e,t)=>{try{const a=Bt(Q,Ft,e);return await fo(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},un=async e=>{try{const t=Bt(Q,Ft,e);return await Xo(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},mn=async e=>{try{const t={...e,createdAt:new Date};return{id:(await ga(Te(Q,Do),t)).id,...t}}catch(t){throw console.error("Erro ao registrar compra:",t),t}},pn=async e=>{try{const t=go(Te(Q,Do),bo("createdAt","desc")),a=await po(t),o=[];return a.forEach(r=>{o.push({id:r.id,...r.data()})}),o}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},ce=document.getElementById("content");let ie=null,je="products",K="all";async function gn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),o=a.value;if(o)try{await Lo({establishmentId:p.establishmentId,name:o},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Ea(),await tt()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function bn(e){if(await A("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await Bo(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Ea(),await tt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ea(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Nt(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${a.name}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function fn(){N({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",gn),t.addEventListener("click",o=>{const r=o.target.closest('button[data-action="delete-category"]');r&&bn(r.dataset.id)}))}Ea()}async function vn(e){if(!e)return;if(await A("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await xr(e),g("Sucesso","Produto apagado com sucesso!","success"),await tt()}catch(a){g("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function hn(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),o=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),s=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(s).map(l=>l.dataset.id),i={establishmentId:p.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(o)?0:o,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await hr(t,i):await vr(i),document.getElementById("productModal").style.display="none",g("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await tt()}catch(l){throw new Error(l.message)}}function Va(e,t=800,a=800,o="image/jpeg",r=.8){return new Promise((s,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let u=d.width,c=d.height;u>c?u>t&&(c*=t/u,u=t):c>a&&(u*=a/c,c=a);const m=document.createElement("canvas");m.width=u,m.height=c,m.getContext("2d").drawImage(d,0,0,u,c);const f=m.toDataURL(o,r);s(f)},d.onerror=u=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function Ua(e=null){const t=document.getElementById("productModal"),a=p.categories||[],o=p.suppliers||[],r=a.map(x=>`<option value="${x.id}" ${e?.categoryId===x.id?"selected":""}>${x.name}</option>`).join("");let s=new Set(e?.supplierIds||[]);t.innerHTML=`
        ...
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
                ...
                `).join("")):(h.classList.remove("hidden"),h.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else h.classList.add("hidden");s.size>0?(k.innerHTML="",s.forEach(E=>{const I=o.find(D=>D.id===E);I&&(k.innerHTML+=`
                    ...
                    `)})):k.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};c.querySelector("#modalSupplierSearch").addEventListener("input",m),c.addEventListener("click",x=>{const h=x.target.closest("[data-add-supplier]");if(h){const $=h.dataset.addSupplier;s.add($),c.querySelector("#modalSupplierSearch").value="",m()}const k=x.target.closest("[data-remove-supplier]");if(k){const $=k.dataset.removeSupplier;s.delete($),m()}}),m(),c.addEventListener("click",async x=>{const h=x.target.closest("button[data-action]");if(!h)return;const k=h.dataset.action,$=c.querySelector("#productId").value;if(k==="close-modal"&&(c.style.display="none"),k==="delete-product"){if(!$)return;c.style.display="none",await vn($)}if(k==="save-product-modal"){const E=c.querySelector("#productForm");if(E){if(!E.querySelector("#productName").value||!E.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const I=h.closest('button[data-action="save-product-modal"]');I.disabled=!0,I.textContent="A salvar...";try{await hn(E)}catch(D){g("Erro",`Falha ao salvar: ${D.message}`,"error"),I.disabled=!1,I.textContent="Salvar Alterações"}}}if(k==="adjust-stock-modal"){x.preventDefault();const E=c.querySelector("#stockAdjustmentAmount"),I=c.querySelector("#stockAdjustmentReason"),D=parseInt(E.value,10),H=parseInt(h.dataset.change,10);if(!D||D<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const M=D*H,q=I.value||(M>0?"Entrada manual":"Saída manual");try{await yr($,{change:M,reason:q});const F=p.products.findIndex(O=>O.id===$);if(F>-1){const O=p.products[F].currentStock+M;p.products[F].currentStock=O,c.querySelector("#currentStockDisplay").textContent=O,c.querySelector("#productCurrentStock").value=O,E.value="",I.value="",g("Sucesso","Estoque atualizado!","success"),Ca(),Ge()}}catch(F){g("Erro de Stock",F.message,"error")}}});const b=c.querySelectorAll(".tab-btn"),f=c.querySelectorAll(".tab-content");b.forEach(x=>{x.addEventListener("click",h=>{h.preventDefault(),b.forEach(k=>{k.classList.remove("border-indigo-500","text-indigo-600"),k.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),x.classList.add("border-indigo-500","text-indigo-600"),x.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),f.forEach(k=>k.classList.add("hidden")),document.getElementById(`tab-content-${x.dataset.tab}`).classList.remove("hidden")})});const v=c.querySelector("#productPhotoInput");c.querySelector("#productPhotoButton").addEventListener("click",()=>v.click()),v.onchange=async()=>{const x=v.files[0];if(!x)return;const h=c.querySelector("#productPhotoPreview"),k=c.querySelector("#productPhotoBase64");h.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const $=await Va(x,800,800,"image/jpeg",.8),I=$.length*3/4,D=1e3*1024;if(I>D)throw new Error("A imagem é muito grande mesmo após a compressão.");h.src=$,k.value=$}catch($){console.error("Erro ao processar imagem:",$),g("Erro de Imagem",$.message||"Não foi possível processar a imagem.","error"),h.src=d,k.value=u,v.value=""}},c.style.display="flex"}function xn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${a.name}</option>`)),Ca(),Ge()}function yn(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const o=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),s=document.getElementById("categoryFilterReport");r&&p.products&&(r.innerHTML+=p.products.map(n=>`<option value="${n.id}">${n.name}</option>`).join("")),s&&p.categories&&(s.innerHTML+=p.categories.map(n=>`<option value="${n.id}">${n.name}</option>`).join(""))}async function wn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value};try{const a=await wr(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function tt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,o]=await Promise.all([At(p.establishmentId),Nt(p.establishmentId,"products"),$a()]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),p.suppliers=(o||[]).filter(Boolean),Mo(je)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function Mo(e){if(document.getElementById("products-content-container")){if(je===e&&document.getElementById("products-content-container").children.length>1){je==="products"&&(Ca(),Ge());return}je=e,K="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?xn():e==="movements"&&yn()}}async function kn(){ce.innerHTML=`
    ...
    `;a.forEach(s=>{const n=JSON.stringify(s).replace(/"/g,"&quot;");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=o+r}function In(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",o=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),s=`
    ...
    `;N({title:"",contentHTML:s,maxWidth:"max-w-md"})}async function He(){const e=document.getElementById("purchasesContainer");if(e)if(P.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([At(p.establishmentId),$a()]);P.allSuppliers=a||[];const o=t.filter(d=>{const u=parseInt(d.currentStock||0),c=parseInt(d.minStock||0);return u<=c});if(P.productsToBuy=o,o.length===0){e.innerHTML=`
        ...
        `}).join("");o+=f;const x=encodeURIComponent(JSON.stringify({supplierId:m,supplierName:b.info.name,totalAmount:f,items:b.items})),h=encodeURIComponent(JSON.stringify({name:b.info.name,phone:b.info.phone,email:b.info.email})),k=encodeURIComponent(JSON.stringify(b.items));a+=`
    ...
    `}async function Bn(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await pn(p.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(s=>{const n=new Date(s.createdAt.seconds*1e3).toLocaleDateString("pt-BR");a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function Tn(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;N({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",Cn),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Tt("genericModal"))},50)}function Mn(){ue.innerHTML=`
    ...
    `,le&&(ue.removeEventListener("click",le),ue.removeEventListener("input",le),ue.removeEventListener("change",le)),le=e=>{if(e.target.closest("#tab-btn-list")&&it("list"),e.target.closest("#tab-btn-purchases")&&it("purchases"),e.target.closest("#tab-btn-history")&&it("history"),e.target.id==="toggle-quote-mode"&&(P.isQuoteMode=e.target.checked,He()),e.target.id==="supplierSearchInput"&&Rt(),e.target.closest("#btn-new-supplier")&&Ja(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),o=JSON.parse(a.dataset.supplier);In(o)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&En(t.dataset.id),a==="edit"&&Ja(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&ra(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(o=>o.checked=a),ra()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),o={};let r=!1;if(a.forEach(s=>{if(s.offsetParent===null||!s.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=s.querySelector("td:nth-child(2)"),d=s.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const u=parseInt(s.querySelector(".qty-input").value),c=parseFloat(s.dataset.cost),b=s.querySelector(".supplier-select").value;if(b){if(!o[b]){const f=P.allSuppliers.find(v=>v.id===b);o[b]={info:f,items:[]}}o[b].items.push({name:i,qty:u,cost:c})}}),!r){g("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}P.finalOrders=o,P.step=2,He()}if(e.target.closest("#btn-back-step1")&&(P.step=1,He()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),o=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),s=parseFloat(a.dataset.total),n=P.isQuoteMode;if(o.phone){const i=o.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${o.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${o.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order"),o=JSON.parse(decodeURIComponent(a.dataset.order));o.establishmentId=p.establishmentId,mn(o).then(()=>{g("Sucesso","Compra registrada no histórico!","success"),a.disabled=!0,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-print-order")){const o=e.target.closest(".supplier-order-card").dataset.supplierId,r=P.finalOrders[o];r?Dn(r,P.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),o=JSON.parse(a.dataset.purchase);Tn(o)}},ue.addEventListener("click",le),ue.addEventListener("input",le),ue.addEventListener("change",le),it("list")}function it(e){ht=e,["list","purchases","history"].forEach(a=>{const o=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(o.classList.add("border-indigo-500","text-indigo-600"),o.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(o.classList.remove("border-indigo-500","text-indigo-600"),o.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Sn()}const zt=document.getElementById("content"),_a={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let oe=new Set,lt=null,ke=null;function Pn(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function An(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",o=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,r=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Vt(){const e=document.getElementById("genericModal");e.style.display="none",ke&&e.removeEventListener("click",ke)}async function qn(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},o=p.services||await De(p.establishmentId),r=p.professionals||await _(p.establishmentId),s=`
        ...
        </div>`;t.innerHTML=s,t.style.display="flex",Nn(a,o),Rn(a),jn(a,r),On(a)}function Nn(e,t){const a=document.getElementById("professionalForm"),o=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(m,b)=>{const f=b+1,v=f==o[1]?"selected":"",x=new Date(0,b).toLocaleString("pt-BR",{month:"long"});return`<option value="${f}" ${v}>${x.charAt(0).toUpperCase()+x.slice(1)}</option>`}).join(""),s=e.status||"active";a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${e.notes||""}</textarea></div>`;const n=document.getElementById("profPhotoInput"),i=document.getElementById("profPhotoButton"),l=document.getElementById("profPhotoPreview"),d=document.getElementById("profPhotoBase64"),u=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,c=e.photo||"";i&&i.addEventListener("click",()=>n.click()),n&&(n.onchange=async()=>{const m=n.files[0];if(m){l.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const b=await Fn(m,800,800,"image/jpeg",.8);l.src=b,d.value=b}catch(b){g("Erro de Imagem",b.message||"Não foi possível processar a imagem.","error"),l.src=u,d.value=c,n.value=""}}})}function Fn(e,t=800,a=800,o="image/jpeg",r=.8){return new Promise((s,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let u=d.width,c=d.height;u>c?u>t&&(c*=t/u,u=t):c>a&&(u*=a/c,c=a);const m=document.createElement("canvas");m.width=u,m.height=c,m.getContext("2d").drawImage(d,0,0,u,c);const f=m.toDataURL(o,r);s(f)},d.onerror=u=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function Rn(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',Hn(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function jn(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        `).join("")}catch(o){a.innerHTML=`<p class="text-red-500">${o.message}</p>`}}}function On(e){const t=document.getElementById("genericModal");ke&&t.removeEventListener("click",ke),ke=async a=>{const o=a.target.closest("button[data-action]");if(!o){const s=a.target.closest(".tab-link");s&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),s.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(s.dataset.tab).classList.remove("hidden"));return}const r=o.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Vt();break;case"delete-professional":const s=o.dataset.id;if(await A("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await Ss(s),g("Sucesso!","Profissional excluído.","success"),Vt(),St()}catch(v){g("Erro",`Não foi possível excluir: ${v.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=o,d=document.getElementById("profScheduleContainer"),u=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(v=>v.value),c={};d&&d.querySelectorAll(".day-schedule-card").forEach(v=>{const x=v.querySelector('[data-field="active"]').dataset.day;c[x]={active:v.querySelector('[data-field="active"]').checked,start:v.querySelector('[data-field="start"]').value,end:v.querySelector('[data-field="end"]').value,breakStart:v.querySelector('[data-field="breakStart"]').value,breakEnd:v.querySelector('[data-field="breakEnd"]').value}});const m={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:u,workingHours:c,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value};l.disabled=!0,l.textContent="A salvar...";try{m.id?(await ks(m.id,m),g("Sucesso!","Profissional atualizado.","success")):(delete m.id,await ws(m),g("Sucesso!","Profissional criado.","success")),Vt(),St()}catch(v){g("Erro",v.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const b=o.dataset.id;if(await A("Apagar Bloqueio","Tem certeza?"))try{await va(b),g("Bloqueio removido.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Oe(e.id,v)}catch(v){g("Erro",v.message,"error")}break;case"batch-delete-blockage":const f=JSON.parse(o.dataset.ids);if(await A("Apagar em Lote",`Tem certeza que deseja apagar ${f.length} bloqueios com este motivo?`))try{await ho(f),g("Bloqueios removidos.","success");const v=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Oe(e.id,v)}catch(v){g("Erro",v.message,"error")}break}},t.addEventListener("click",ke)}function na(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(oe.size>0?(t.textContent=`${oe.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function zn(){A("Excluir em Lote",`Tem certeza que deseja excluir ${oe.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await(void 0)(Array.from(oe)),g("Sucesso!",`${oe.size} profissionais foram excluídos.`,"success"),oe.clear(),na(),St()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Pe(){const e=document.getElementById("professionalsList");if(!e)return;if(!p.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Pn();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),o=p.professionals.filter(r=>{const s=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return s&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=An(o)}async function St(){oe.clear(),zt.innerHTML=`
        ...
        </section>`,lt&&zt.removeEventListener("click",lt),lt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),o=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let s={};if(a.dataset.professional)try{s=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}qn(s);return}if(o){zn();return}const r=t.target.closest(".professional-checkbox");if(r){const s=r.dataset.id;r.checked?oe.add(s):oe.delete(s),Pe(),na();return}},zt.addEventListener("click",lt),document.getElementById("profSearchInput").addEventListener("input",Pe),document.getElementById("showInactiveProfToggle").addEventListener("change",Pe);const e=document.getElementById("professionalsList");p.professionals=null,p.services=null,Pe();try{const[t,a]=await Promise.all([_(p.establishmentId),De(p.establishmentId)]);p.professionals=t,p.services=a,Pe(),na()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const Ut=document.getElementById("content");let te=[],ze={},j=null,ia="list",U="all",la="O Estabelecimento";const Vn=(e,t)=>`Olá, ${e}! Nós da ${t} desejamos a você um Feliz Aniversário! Esperamos que seu dia seja maravilhoso. Venha comemorar conosco! 🎉🎂`,Un=(e,t)=>`Oi, ${e}! Faz um tempo que não te vemos aqui no(a) ${t}. Sentimos sua falta! Temos novidades/ofertas especiais para você. Que tal agendar seu horário?`,Jn=[{value:30,label:"30 dias"},{value:60,label:"60 dias"},{value:90,label:"90 dias"},{value:120,label:"120 dias"}];function _n(){return Math.floor(Math.random()*140)+10}function Wn(e){if(!e.dob)return!1;const t=e.dob.split("/");if(t.length!==2)return!1;const a=new Date,o=a.getDate(),r=a.getMonth()+1,s=parseInt(t[0],10),n=parseInt(t[1],10);return s===o&&n===r}const Gn=[{value:99,label:"Aniversariantes de Hoje"},{value:0,label:"Todos os meses (com DOB)"},{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}];function Wa(){return Gn.map(e=>{let t="";return e.value===99&&(t="selected"),`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function Ga(){return Jn.map(e=>{const t=e.value===90?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function Yn(e,t){const a=`w-5 h-5 ${t} mr-2`;switch(e){case"cadastro":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>`;case"agendamentos":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`;case"historico":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v2a2 2 0 01-2 2h-2.586a1 1 0 00-.707.293l-1.414 1.414a1 1 0 01-1.414 0l-1.414-1.414A1 1 0 009.586 17H7a2 2 0 01-2-2v-2a2 2 0 012-2h12z" /></svg>`;case"fidelidade":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.5a9.5 9.5 0 1019 0 9.5 9.5 0 00-19 0z" /></svg>`;default:return""}}function Xn(e="cadastro"){const t=[{id:"cadastro",label:"Cadastro"},{id:"agendamentos",label:"Próximos Agend."},{id:"historico",label:"Histórico"},{id:"fidelidade",label:"Fidelidade"}],a=document.getElementById("client-detail-tabs");a&&(a.innerHTML=t.map(o=>{const r=e===o.id,s=r?"text-indigo-600":"text-gray-500";return`
        ...
        `}).join(""),a.querySelectorAll(".tab-btn").forEach(o=>{o.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),da(o.dataset.tab)})}))}async function da(e){Xn(e);const t=document.getElementById("client-detail-content");if(t)switch(t.innerHTML='<form id="client-form" class="p-6 space-y-4"><div class="loader mx-auto my-8"></div></form>',e){case"cadastro":t.innerHTML=Qn(j);break;case"agendamentos":case"historico":try{const o=await Js(p.establishmentId,j.name,j.phone);t.innerHTML=Zn(o,e)}catch(o){console.error("Erro ao carregar histórico do cliente:",o),t.innerHTML=`<form id="client-form" class="p-6 space-y-4"><p class="text-center text-red-500">Erro ao carregar o histórico: ${o.message}</p></form>`}break;case"fidelidade":const a=await _s(p.establishmentId,j.name,j.phone);t.innerHTML=Kn(j,a);break;default:t.innerHTML='<form id="client-form" class="p-6 space-y-4"><p class="p-4 text-center text-gray-500">Secção não implementada.</p></form>'}}function Qn(e){const t=e?.dob?e.dob.split("/"):["",""];return`
    ...
    `}function Zn(e,t){const a=t==="agendamentos"?"Próximos Agendamentos":"Histórico de Visitas",o=t==="agendamentos"?"Nenhum agendamento futuro.":"Nenhum histórico de visitas.",r=new Date;r.setHours(0,0,0,0);const s=t==="agendamentos",n=(e||[]).filter(i=>{const l=new Date(i.date);return s?l>=r:l<r});return n.sort((i,l)=>s?new Date(i.date).getTime()-new Date(l.date).getTime():new Date(l.date).getTime()-new Date(i.date).getTime()),n.length===0?`<form id="client-form" class="p-6 space-y-4"><p class="p-4 text-center text-gray-500">${o}</p></form>`:`
        <form id="client-form" class="p-6 space-y-4">
            <div class="space-y-3 max-h-96 overflow-y-auto">
                <h4 class="font-semibold text-lg mb-2">${a}</h4>
                ${n.map(i=>{const l=new Date(i.date)<r;return`
                        <div class="bg-gray-50 p-3 rounded-lg cursor-pointer flex justify-between items-center ${l?"hover:bg-indigo-50":""}"
    ...
    `}function Kn(e,t){const a=e.loyaltyPoints||0;let o='<p class="text-sm text-gray-500">O programa de fidelidade não está ativo.</p>';ze.enabled&&ze.tiers&&(o=ze.tiers.map(s=>{const n=a>=s.points;return`
    ...
    `}function ca(e){j=e,ia="detail";const t=e!==null,a=t?"Editar Cliente":"Adicionar Cliente",o=`
    ...
    `,r=window.innerWidth<768,s=r?"max-w-full":"max-w-3xl";if(N({title:a,contentHTML:o,maxWidth:s}),r){const u=document.getElementById("genericModal");if(u){const c=u.querySelector(`.${s.replace(":","\\:")}`);c&&(c.style.height="auto",c.style.maxHeight="85vh",c.style.borderRadius="1rem")}}const n=document.getElementById("genericModal");n&&n.addEventListener("click",async u=>{const c=u.target.closest("[data-action]");if(!c)return;switch(c.dataset.action){case"redeem-reward":{const b=parseInt(c.dataset.points,10),f=c.dataset.reward;if(await A("Confirmar Resgate",`Deseja resgatar "${f}" por ${b} pontos?`))try{await Ws(p.establishmentId,j.name,j.phone,{points:b,reward:f}),g("Prémio resgatado com sucesso!","success"),te=await Ze(p.establishmentId);const h=te.find(k=>k.id===j.id);h&&(j=h),da("fidelidade")}catch(x){g(`Erro ao resgatar: ${x.message}`,"error")}break}case"open-comanda-from-history":{const b=c.dataset.appointmentId;b&&(document.getElementById("genericModal").style.display="none",Y("comandas-section",{selectedAppointmentId:b,initialFilter:"finalizada"}));break}case"view-appointment":{const b=c.dataset.appointmentId,f=c.dataset.appointmentDate;b&&f&&(document.getElementById("genericModal").style.display="none",Y("agenda-section",{targetDate:f,scrollToAppointmentId:b}));break}}}),da("cadastro");const i=document.getElementById("client-form");i&&i.addEventListener("submit",u=>{u.preventDefault(),ei()});const l=document.getElementById("cancelDetailViewBtn");l&&l.addEventListener("click",u=>{u.preventDefault(),document.getElementById("genericModal").style.display="none",jt()});const d=document.getElementById("deleteClientBtn");d&&d.addEventListener("click",async()=>{await ti()})}async function ei(){const e=document.getElementById("client-form");if(!e)return;const t=e.querySelector("#clientId").value,a={name:e.querySelector("#clientName").value,email:e.querySelector("#clientEmail").value,phone:e.querySelector("#clientPhone").value,dob:`${e.querySelector("#clientDobDay").value}/${e.querySelector("#clientDobMonth").value}`,notes:e.querySelector("#clientNotes").value,establishmentId:p.establishmentId};if(!a.name||!a.phone){g("Erro","Nome e Telefone são obrigatórios.","error");return}try{t?(await Vs(t,a),g("Sucesso","Cliente atualizado com sucesso!","success")):(await ha(a),g("Sucesso","Cliente cadastrado com sucesso!","success")),document.getElementById("genericModal").style.display="none",await jt()}catch(o){g("Erro",`Não foi possível salvar: ${o.message}`,"error")}}async function ti(){if(!j||!j.id)return;if(await A("Excluir Cliente",`Tem certeza que deseja excluir ${j.name}? Esta ação é irreversível.`))try{await Us(j.id),g("Sucesso","Cliente excluído.","success"),document.getElementById("genericModal").style.display="none",await jt()}catch(t){g("Erro",`Não foi possível excluir: ${t.message}`,"error")}}function xt(e,t){const a=document.getElementById("clientsList");if(a)if(a.innerHTML="",document.getElementById("client-count").textContent=`${e.length} cliente${e.length!==1?"s":""} | Total: ${t}`,e.length>0){const o=U==="inactive",r=U==="birthdays";e.forEach(s=>{const n=document.createElement("div");n.className="client-card bg-white rounded-lg shadow p-4 flex flex-col cursor-pointer",n.dataset.clientId=s.id;const i=s.loyaltyPoints||0,l=ze.enabled?`${i} pts`:`R$ ${i.toFixed(2)}`;let d="";const c=`https://wa.me/55${s.phone?s.phone.replace(/\D/g,""):""}?text=`;if(o){const m=encodeURIComponent(Un(s.name,la));d=`
                    ...
                    </a>`}else if(r&&Wn(s)){const b=encodeURIComponent(Vn(s.name,la));d=`
                ...
                <div class="flex md:grid md:grid-cols-[1fr_1fr_3rem] items-center text-sm pt-2 border-t">
                    <div class="flex-1 md:w-auto">
                        ...
                        <span class="font-bold text-indigo-600 ml-1">${l}</span>
                    </div>
            ...
            `,n.addEventListener("click",()=>ca(s)),a.appendChild(n)})}else a.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum cliente encontrado com os filtros aplicados.</p>'}function yt(e="",t="all"){const a=e.toLowerCase(),o=a.length>0;let r=0,s=90;const n=window.innerWidth<768;if(t==="birthdays"){const l=n?"mobileBirthMonthFilter":"birthMonthFilter",d=document.getElementById(l);d&&(r=parseInt(d.value,10))}else if(t==="inactive"){const l=n?"mobileInactiveDaysFilter":"inactiveDaysFilter",d=document.getElementById(l);d&&(s=parseInt(d.value,10))}let i=te.filter(l=>!o||l.name.toLowerCase().includes(a)||(l.phone||"").includes(a));switch(t){case"birthdays":const l=new Date,d=l.getDate(),u=l.getMonth()+1;return i.filter(c=>{if(!c.dob)return!1;const m=c.dob.split("/");if(m.length!==2)return!1;const b=parseInt(m[0],10),f=parseInt(m[1],10);return r===99?b===d&&f===u:r===0?f>=1&&f<=12:f===r});case"inactive":return i.filter(c=>(c.lastAppointmentDaysAgo||_n())>s);case"scheduled":return i.filter(c=>c.loyaltyPoints>50);case"credit":return i.filter(c=>(c.loyaltyPoints||0)>0);case"debit":return i.filter(c=>!1);case"package":return i.filter(c=>!1);case"all":default:return i}}async function ai(e){const t=document.getElementById("birthMonthFilterContainer"),a=document.getElementById("mobileBirthMonthFilterContainer"),o=document.getElementById("inactiveDaysFilterContainer"),r=document.getElementById("mobileInactiveDaysFilterContainer");if(e==="birthdays"){if(t?.classList.remove("hidden"),a?.classList.remove("hidden"),o?.classList.add("hidden"),r?.classList.add("hidden"),U!=="birthdays"){const l=document.getElementById("birthMonthFilter");l&&(l.value=99);const d=document.getElementById("mobileBirthMonthFilter");d&&(d.value=99)}}else if(e==="inactive"){if(o?.classList.remove("hidden"),r?.classList.remove("hidden"),t?.classList.add("hidden"),a?.classList.add("hidden"),U!=="inactive"){const l=document.getElementById("inactiveDaysFilter");l&&(l.value=90);const d=document.getElementById("mobileInactiveDaysFilter");d&&(d.value=90)}}else t?.classList.add("hidden"),a?.classList.add("hidden"),o?.classList.add("hidden"),r?.classList.add("hidden");if(U===e&&e!=="birthdays"&&e!=="inactive")return;U=e,document.querySelectorAll(".client-filter-btn").forEach(l=>{l.classList.remove("bg-white","text-indigo-600","shadow"),l.classList.add("bg-gray-100","text-gray-600")}),document.querySelectorAll(`[data-filter-key="${e}"]`).forEach(l=>{l&&(l.classList.remove("bg-gray-100","text-gray-600"),l.classList.add("bg-white","text-indigo-600","shadow"))});const n=document.getElementById("clientSearchInput").value,i=yt(n,U);xt(i,te.length)}async function jt(){ia="list",Ut.innerHTML=`
    ...
    `;try{const[u,c]=await Promise.all([Ze(p.establishmentId),Qe(p.establishmentId)]);te=u,ze=c.loyaltyProgram||{enabled:!1},la=c.name||"O Estabelecimento";const m=yt("",U);xt(m,te.length)}catch{document.getElementById("clientsList").innerHTML='<p class="text-red-500 col-span-full text-center">Erro ao carregar dados dos clientes.</p>'}const e=document.getElementById("filter-sheet"),t=document.getElementById("filter-overlay"),a=document.getElementById("openFilterSheetBtn"),o=document.getElementById("closeFilterSheetBtn"),r=()=>{e.classList.add("show"),t.classList.remove("hidden")},s=()=>{e.classList.remove("show"),t.classList.add("hidden")};a&&a.addEventListener("click",r),o&&o.addEventListener("click",s),t&&t.addEventListener("click",s);const n=u=>{const c=u.target.closest(".client-filter-btn");c&&(ai(c.dataset.filterKey),window.innerWidth<768&&s())},i=document.getElementById("desktop-filter-bar"),l=document.getElementById("mobile-filter-list");i&&i.addEventListener("click",n),l&&l.addEventListener("click",n);const d=u=>{const c=document.getElementById(u);c&&c.addEventListener("change",()=>{if(U==="birthdays"||U==="inactive"){const m=document.getElementById("clientSearchInput").value,b=yt(m,U);xt(b,te.length)}})};d("birthMonthFilter"),d("mobileBirthMonthFilter"),d("inactiveDaysFilter"),d("mobileInactiveDaysFilter"),Ut.addEventListener("click",async u=>{const c=u.target.closest("[data-action]"),m=u.target.closest(".client-card");if(ia==="list"){if(c){const b=c.dataset.action;b==="new-client"?ca(null):b==="print-list"&&window.print()}else if(m){const b=m.dataset.clientId,f=te.find(v=>v.id===b);f&&ca(f)}}}),Ut.addEventListener("input",u=>{if(u.target.id==="clientSearchInput"){const c=u.target.value,m=yt(c,U);xt(m,te.length)}})}const Ye=()=>w("/api/financial/natures"),oi=e=>w("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),si=e=>w(`/api/financial/natures/${e}`,{method:"DELETE"}),Xe=()=>w("/api/financial/cost-centers"),ri=e=>w("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),ni=e=>w(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),Po=(e,t)=>w(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),Ao=(e,t={})=>{let a=`/api/financial/${e}`;const o=new URLSearchParams;t.startDate&&o.append("startDate",t.startDate),t.endDate&&o.append("endDate",t.endDate),t.natureId&&o.append("natureId",t.natureId),t.costCenterId&&o.append("costCenterId",t.costCenterId);const r=o.toString();return r&&(a+=`?${r}`),w(a)},qo=(e,t,a)=>w(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),No=(e,t)=>w(`/api/financial/${e}/${t}`,{method:"DELETE"}),Fo=(e,t,a)=>w(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),ii=e=>Po("payables",e),li=e=>Ao("payables",e),di=(e,t)=>qo("payables",e,t),ci=e=>No("payables",e),ui=(e,t)=>Fo("payables",e,t),mi=e=>Po("receivables",e),pi=e=>Ao("receivables",e),gi=(e,t)=>qo("receivables",e,t),bi=e=>No("receivables",e),fi=(e,t)=>Fo("receivables",e,t),vi=(e,t)=>w(`/api/financial/cash-flow?startDate=${e}&endDate=${t}`),hi=()=>w("/api/financial/today-summary"),be=document.getElementById("content"),Jt={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},xi={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}},Ro=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"}];let V=null;function Ya(e,t,a){return new Promise((o,r)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,u=i.height;d>t&&(u*=t/d,d=t),l.width=d,l.height=u,l.getContext("2d").drawImage(i,0,0,d,u);const m=e.type==="image/png"&&t<500?"image/png":"image/jpeg";o(l.toDataURL(m,a))},i.onerror=l=>r(l)},s.onerror=n=>r(n)})}function dt(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const o=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i="")=>{const l=n.id===t?"selected":"";a+=`<option value="${n.id}" ${l}>${i}${n.name}</option>`,n.children.forEach(d=>r(d,i+"— "))};return o(e).forEach(n=>r(n)),a}async function Me(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const o=V||await Qe(p.establishmentId),r=[],{ownerName:s,...n}=e;if(s&&s!==p.userName){const l=J.currentUser;l&&r.push(Go(l,{displayName:s}).then(()=>{p.userName=s}))}const i={...o,...n};if(r.push(vs(p.establishmentId,i)),await Promise.all(r),V=i,g("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),n.themeColor)setTimeout(()=>window.location.reload(),1500);else{const l=document.getElementById("panelEstablishmentName");n.name&&l&&(l.textContent=n.name,p.establishmentName=n.name)}}catch(o){g("Erro",`Não foi possível salvar: ${o.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function yi(e,t){t.innerHTML=`
    ...
    `,t.querySelector("#personal-data-form").addEventListener("submit",a=>{a.preventDefault();const o={ownerName:t.querySelector("#ownerName").value,name:t.querySelector("#establishmentName").value,phone:t.querySelector("#establishmentPhone").value,document:t.querySelector("#establishmentCnpjCpf").value,email:t.querySelector("#establishmentEmail").value,address:t.querySelector("#establishmentAddress").value,website:t.querySelector("#establishmentWebsite").value};Me(o,a)})}function wi(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!o||!r){g("Erro","Preencha todos os campos.","error");return}const s=t.querySelector('button[form="change-email-form"]');s.disabled=!0,s.textContent="A verificar...";try{const n=J.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=Uo.credential(n.email,r);await Jo(n,i),s.textContent="A enviar link...",await _o(n,o),s.textContent="A atualizar BD...",await xs(p.establishmentId,o),g("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,g("Erro",i,"error")}finally{s.disabled=!1,s.textContent="Salvar Novo E-mail"}})}function Si(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,o]=await Promise.all([Ye(),Xe()]),r=e.financialIntegration||{},s=e.commissionConfig||{};t.querySelector("#financialNatureId").innerHTML=dt(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=dt(o,r.defaultCentroDeCustoId),t.querySelector("#commissionNatureId").innerHTML=dt(a,s.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=dt(o,s.defaultCostCenterId)}catch{g("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const o={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Me(o,a)})}function Li(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${e}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function jo(e="indigo",t){const a=t.querySelector("#color-palette-container"),o=t.querySelector("#establishmentThemeColor");!a||!o||(a.innerHTML="",Object.entries(xi).forEach(([r,s])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{o.value=r,jo(r,t)}),a.appendChild(i)}),o.value=e)}function Bi(e,t){const a=t.querySelector("#slotIntervalContainer"),o=t.querySelector("#establishmentSlotInterval");if(!a||!o)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(s=>{const n=s.value===e;return`<button type="button" data-value="${s.value}" 
    ...
    `,be.querySelector('button[data-action="back-to-list"]').addEventListener("click",o=>{o.preventDefault(),Ho()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":yi(V,a);break;case"change-password":wi(V,a);break;case"change-email":ki(V,a);break;case"branding":Si(V,a);break;case"booking":$i(V,a);break;case"working-hours":Ei(V,a);break;case"loyalty":Ci(V,a);break;case"financial":await Ii(V,a);break;default:Li(t?t.label:"Definições",a)}}async function Ho(){if(be.innerHTML=`
    ...
    `,be.querySelector("#settings-menu-list").addEventListener("click",o=>{const r=o.target.closest("button[data-section]");r&&(o.preventDefault(),Ti(r.dataset.section))});const a=be.querySelector('[data-action="go-to-my-profile"]');a&&a.addEventListener("click",o=>{o.preventDefault(),Y("my-profile-section")})}const Ve=document.getElementById("content");async function Ee(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,o=document.getElementById("filterEndDate")?.value,r=await Dt(p.establishmentId,a||new Date().toISOString().split("T")[0],o||new Date().toISOString().split("T")[0],e),s=document.getElementById("filterReason")?.value.toLowerCase(),n=s?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(s)):r,i=n.reduce((l,d)=>{const u=d.reason||"Sem motivo";return l[u]||(l[u]=[]),l[u].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const u=document.createElement("div");u.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let c=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
        ...
        <section>
        ...
        </section>`,Pi(t),await Ee(t);const o=document.getElementById("batchProfSelectionContainer");try{const r=await _(p.establishmentId);o.innerHTML=r.map(s=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{o.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const qi=e=>w(`/api/users/${e}`),Ni=e=>w("/api/users",{method:"POST",body:JSON.stringify(e)}),Fi=(e,t)=>w(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ri=e=>w(`/api/users/${e}`,{method:"DELETE"}),ji=(e,t)=>w(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),Hi=(e,t)=>w(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),me=document.getElementById("content"),Oi={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},zi={view:"Visualizar",create:"Criar",edit:"Editar"};let Ae=null,qe=null;function Vi(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const o=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${o}</p>`;return}e.sort((o,r)=>(o.status==="active"?-1:1)-(r.status==="active"?-1:1)),t.innerHTML=e.map(o=>{const r=JSON.stringify(o).replace(/'/g,"&apos;"),s=o.status==="active",n=p.professionals.find(u=>u.id===o.professionalId),i=n?n.name:"N/A",l=n?n.name.charAt(0):o.name.charAt(0),d=n?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function wt(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=p.users:t=p.users.filter(a=>a.status==="active"),Vi(t)}function Ui(e={}){return Object.entries(Oi).map(([t,a])=>{const o=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,s=Object.entries(zi).map(([i,l])=>`
    ...
    `;const m=window.innerWidth<768,b=c.querySelector(".bg-white");if(m&&b){b.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const h=c.closest("section");h&&(h.style.padding="0",h.style.margin="0"),b.classList.add("p-4")}const f=c.querySelector("#userProfessionalId"),v=c.querySelector("#userPhotoPreview"),x=c.querySelector("#profPhotoName");if(f.addEventListener("change",h=>{const k=h.target.value,$=o(k),E=$?$.name:"Selecione um profissional",I=r(k,n);v.src=I.photoSrc,x.textContent=E,c.querySelector("#professionalPhotoUrl").value=I.photoUrl}),c.addEventListener("submit",async h=>{h.preventDefault();const k=e?.email,$=c.querySelector("#userEmail").value,E={};c.querySelectorAll('input[type="checkbox"]').forEach(H=>{const M=H.dataset.module,q=H.dataset.permission;E[M]||(E[M]={}),E[M][q]=H.checked});const I=c.querySelector("#userProfessionalId").value||null,D={name:c.querySelector("#userName").value,permissions:E,professionalId:I};try{u?(k!==$&&(D.email=$),await Fi(e.id,D),g("Usuário atualizado com sucesso!","success")):(D.email=c.querySelector("#userEmail").value,D.password=c.querySelector("#userPassword").value,await Ni(D),g("Usuário criado com sucesso!","success")),$t()}catch(H){g(`Erro: ${H.message}`,"error")}}),u){const h=c.querySelector("#password-change-container"),k=h.querySelector('[data-action="show-password-form"]'),$=h.querySelector("#password-form"),E=$.querySelector('[data-action="save-password"]'),I=$.querySelector('[data-action="cancel-password-change"]');k.addEventListener("click",()=>{k.classList.add("hidden"),$.classList.remove("hidden")}),I.addEventListener("click",()=>{k.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}),E.addEventListener("click",async()=>{const D=$.querySelector("#userNewPassword").value;if(!D||D.length<6){g("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await A("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{E.disabled=!0,E.textContent="Aguarde...",await ji(e.id,D),g("Sucesso!","A senha do usuário foi alterada.","success"),k.classList.remove("hidden"),$.classList.add("hidden"),$.querySelector("#userNewPassword").value=""}catch(M){g("Erro",`Não foi possível alterar a senha: ${M.message}`,"error")}finally{E.disabled=!1,E.textContent="Salvar Nova Senha"}})}}async function Ji(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([qi(p.establishmentId),_(p.establishmentId)]);p.users=t,p.professionals=a,wt()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function $t(){me.innerHTML=`
    ...
    `,Ae&&me.removeEventListener("click",Ae),qe&&me.removeEventListener("change",qe),Ae=async e=>{if(!document.getElementById("user-list-view")){me.removeEventListener("click",Ae);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":Xa();break;case"edit-user":const o=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));Xa(o);break;case"back-to-list":$t();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await A("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await Ri(r),g("Usuário excluído com sucesso!","success"),$t()}catch(n){g(`Erro ao excluir: ${n.message}`,"error")}break}}},qe=async e=>{if(!document.getElementById("user-list-view")){me.removeEventListener("change",qe);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")wt();else if(t){e.stopPropagation();const a=t.dataset.userId,o=t.checked?"active":"inactive";try{await Hi(a,o),g(`Usuário ${o==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=p.users.findIndex(s=>s.id===a);r>-1&&(p.users[r].status=o,wt())}catch(r){g(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,wt()}}},me.addEventListener("click",Ae),me.addEventListener("change",qe),await Ji()}const _i=document.getElementById("content");let Qa={},ua=null;function Wi(){Object.values(Qa).forEach(e=>e?.destroy()),Qa={}}function Gi(e,t){const{jsPDF:a}=window.jspdf,o=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(o.setFontSize(18),o.text(e,o.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];o.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const s=o.lastAutoTable?o.lastAutoTable.finalY+20:60;o.text("Detalhes das Vendas",20,s),o.autoTable({html:`#${t}`,startY:s+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),o.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function Za(e){const t=document.getElementById("genericModal"),a=(e.payments||[]).map(o=>`
    ...
    `,t.style.display="flex"}function Yi(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const o=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);o.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `).join(""),s.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ua.transactions[l];d&&Za(d)})}),n.innerHTML=a.map((i,l)=>`
    ...
    `).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=ua.transactions[l];d&&Za(d)})})}async function Ka(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const o=t.value,r=a.value;if(!o||!r)return g("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const s=document.getElementById("cashierSessionFilter").value,n=await Ns({establishmentId:p.establishmentId,startDate:o,endDate:r,cashierSessionId:s});ua=n,e.innerHTML=`
        ...
        `,Yi(n)}catch(s){g("Erro",`Não foi possível carregar o relatório: ${s.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${s.message}</p>`}}async function Xi(){Wi();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];_i.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",Ka),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const o=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,s=`Relatorio_Vendas_${o}_a_${r}`;Gi(s,"transactionsTable")});try{const o=await $r(),r=document.getElementById("cashierSessionFilter");o.forEach(s=>{const n=new Date(s.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=s.closedByName||"N/A";r.innerHTML+=`<option value="${s.id}">${i} - ${n}</option>`})}catch{g("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await Ka()}const Qi=document.getElementById("content");let C={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},_t=null,ct=null,ut=null;function Ia(e){const t=new Map,a=[];return e&&(e.forEach(o=>t.set(o.id,{...o,children:[]})),t.forEach(o=>{o.parentId&&t.has(o.parentId)?t.get(o.parentId).children.push(o):a.push(o)})),a}function Oo(e,t,a){if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const o=(r,s=0)=>{const n="— ".repeat(s);return`
    ...
    `,e.style.display="flex"}function el(){const e=document.getElementById("genericModal");e.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.style.display="flex"}function mt(e,t="all"){let a='<option value="all">Todos</option>';const o=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i=0)=>{const l=i>0?"— ".repeat(i):"",d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${l}${n.name}</option>`,n.children.forEach(u=>r(u,i+1))};return o(e).forEach(n=>r(n)),a}async function ve(){const e=document.getElementById("financial-content"),t=document.getElementById("filterStartDate")?.value,a=document.getElementById("filterEndDate")?.value,o=document.getElementById("filterNaturezaId")?.value,r=document.getElementById("filterCostCenterId")?.value;if(!t||!a){try{const[i,l]=await Promise.all([Ye(),Xe()]);C={...C,natures:i,costCenters:l},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=mt(C.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=mt(C.costCenters))}catch(i){g("Erro",`Não foi possível carregar os dados base: ${i.message}`,"error")}ma(),so();return}const s=document.getElementById("payables-list"),n=document.getElementById("receivables-list");s&&(s.innerHTML='<div class="loader mx-auto"></div>'),n&&(n.innerHTML='<div class="loader mx-auto"></div>');try{const i={startDate:t,endDate:a};o&&o!=="all"&&(i.natureId=o),r&&r!=="all"&&(i.costCenterId=r);const[l,d,u,c]=await Promise.all([li(i),pi(i),Ye(),Xe()]),m=d.previousBalance-l.previousBalance;C={...C,payables:l.entries,receivables:d.entries,natures:u,costCenters:c,previousBalance:m,filterNaturezaId:o,filterCostCenterId:r},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=mt(C.natures,C.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=mt(C.costCenters,C.filterCostCenterId)),ma(),so()}catch(i){g("Erro",`Não foi possível carregar os dados: ${i.message}`,"error"),e&&(e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function tl(e,t,a=null){e.preventDefault();const o=e.target,r=o.querySelector('[name="status"]').checked,s=o.querySelector('[name="paymentDate"]').value,n=parseFloat(o.querySelector('[name="amount"]').value),i=parseInt(o.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(n)){g("Erro de Validação","O valor inserido é inválido.","error");return}if(r&&!s){g("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:o.querySelector('[name="description"]').value,amount:n,dueDate:o.querySelector('[name="dueDate"]').value,naturezaId:o.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:o.querySelector('[name="centroDeCustoId"]').value||null,notes:o.querySelector('[name="notes"]').value,status:r?"paid":"pending",paymentDate:r?s:null,installments:a?1:i};try{a?(await(t==="payable"?di(a,l):gi(a,l)),g("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?ii(l):mi(l)),g("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await ve()}catch(d){g("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function al(e,t){if(await A("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?ci(t):bi(t)),g("Sucesso","Lançamento excluído!","success"),await ve()}catch(o){g("Erro",`Falha ao excluir: ${o.message}`,"error")}}async function ol(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?ui(t,a):fi(t,a)),g("Sucesso","Lançamento atualizado!","success"),await ve()}catch(o){g("Erro",`Falha ao atualizar status: ${o.message}`,"error")}}function oo(e){const t=C.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function ma(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(C.natures.map(i=>[i.id,i.name])),o=new Map(C.costCenters.map(i=>[i.id,i.name])),r=oo(C.payables),s=oo(C.receivables),n=(i,l)=>{const d=i.status==="paid",u=JSON.stringify(i).replace(/'/g,"&apos;"),c=i.naturezaId?a.get(i.naturezaId):"N/A",m=i.centroDeCustoId?o.get(i.centroDeCustoId):"N/A";let b=l==="payable"?"text-red-600":"text-green-600";const f=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",v=d?"Finalizado":"Pendente";return d&&(b="text-gray-500"),`
    ...
    `;const r=document.getElementById("main-fab-btn"),s=document.getElementById("fab-menu");if(r&&s){r.addEventListener("click",v=>{v.stopPropagation(),s.classList.toggle("hidden"),r.classList.toggle("rotate-45")});const m=s.querySelector('button[data-action="open-modal"][data-type="receivable"]'),b=s.querySelector('button[data-action="open-modal"][data-type="payable"]'),f=s.querySelector('button[data-action="open-cash-flow-modal"]');m&&m.addEventListener("click",v=>{v.stopPropagation(),Wt("receivable")}),b&&b.addEventListener("click",v=>{v.stopPropagation(),Wt("payable")}),f&&f.addEventListener("click",v=>{v.stopPropagation(),ao()})}ct&&document.body.removeEventListener("click",ct),ut&&document.getElementById("genericModal").removeEventListener("click",ut);const n=()=>{const m=document.getElementById("filterStartDate"),b=document.getElementById("filterEndDate"),f=document.getElementById("filterNaturezaId"),v=document.getElementById("filterCostCenterId");C.startDate=m.value,C.endDate=b.value,C.filterNaturezaId=f.value,C.filterCostCenterId=v.value;const x=document.getElementById("advanced-filters");x&&x.classList.contains("hidden")===!1&&window.innerWidth<768&&x.classList.add("hidden"),ve()},i=m=>{const b=m.target.closest("[data-status-filter]");if(!b)return;const f=b.dataset.statusFilter;C.currentFilter=f,document.querySelectorAll("[data-status-filter]").forEach(v=>{v.classList.remove("bg-blue-100","text-blue-800"),v.classList.add("bg-gray-100","text-gray-600")}),b.classList.remove("bg-gray-100","text-gray-600"),b.classList.add("bg-blue-100","text-blue-800"),ma()},l=m=>{const b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),v=document.getElementById("btn-payables-view"),x=document.getElementById("btn-receivables-view");window.innerWidth>=1024&&C.currentListView===m||(m==="payables"?(b.classList.remove("hidden"),f.classList.add("hidden"),v&&(v.classList.remove("bg-gray-200"),v.classList.add("bg-red-100","border","border-red-500")),x&&(x.classList.remove("bg-green-100","border","border-green-500"),x.classList.add("bg-gray-200"))):(b.classList.add("hidden"),f.classList.remove("hidden"),v&&(v.classList.remove("bg-red-100","border","border-red-500"),v.classList.add("bg-gray-200")),x&&(x.classList.remove("bg-gray-200"),x.classList.add("bg-green-100","border","border-green-500"))),C.currentListView=m)};document.getElementById("applyDateFilterBtn").addEventListener("click",n),document.getElementById("filterNaturezaId").addEventListener("change",()=>{C.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{C.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(m=>{m.addEventListener("click",i)}),ct=m=>{const b=m.target.closest("button[data-action]");if(!b)return;const{action:f,type:v,id:x}=b.dataset;f==="edit"?Wt(v,JSON.parse(b.dataset.item.replace(/&apos;/g,"'"))):f==="delete"?al(v,x):f==="mark-as-paid"?ol(v,x):f==="manage-natures"?eo("nature"):f==="manage-cost-centers"?eo("cost-center"):f==="open-cash-flow-modal"?ao():f==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):f==="open-indicators-modal"?Ki():f==="open-settings-modal"?el():f==="toggle-list-view"&&l(b.dataset.list)},ut=m=>{const b=m.target.closest('button[data-action^="delete-"]');if(b){const f=b.dataset.action.split("-")[1];d(f,b.dataset.id)}},document.body.addEventListener("click",ct),document.getElementById("genericModal").addEventListener("click",ut);async function d(m,b){const f=m==="nature",v=f?si:ni,x=f?Ye:Xe,h=f?"natures":"costCenters",k=document.getElementById("hierarchyList");if(await A("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await v(b);const E=await x();C[h]=E,Oo(k,Ia(E),m),await ve()}catch(E){g("Erro",`Não foi possível apagar: ${E.message}`,"error")}}const u=()=>{const m=window.innerWidth<1024,b=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),v=document.getElementById("list-toggle-buttons");b&&f&&(b.classList.remove("hidden"),f.classList.remove("hidden"),m?(b.classList.remove("lg:col-span-1"),f.classList.remove("lg:col-span-1"),v?.classList.remove("hidden"),l(C.currentListView)):(b.classList.add("lg:col-span-1"),f.classList.add("lg:col-span-1"),v?.classList.add("hidden"),b.classList.remove("hidden"),f.classList.remove("hidden")))};u(),window.addEventListener("resize",u);const c=document.querySelector(`[data-status-filter="${C.currentFilter}"]`);c&&(document.querySelectorAll("[data-status-filter]").forEach(m=>{m.classList.remove("bg-blue-100","text-blue-800"),m.classList.add("bg-gray-100","text-gray-600")}),c.classList.remove("bg-gray-100","text-gray-600"),c.classList.add("bg-blue-100","text-blue-800"));try{const m=await hi(),b=document.getElementById("summary-today-payables");b&&(b.textContent=`R$ ${m.totalPayables.toFixed(2)}`);const f=document.getElementById("summary-today-receivables");f&&(f.textContent=`R$ ${m.totalReceivables.toFixed(2)}`)}catch{g("Erro","Não foi possível carregar o resumo do dia.","error")}await ve()}const rl=e=>w("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),nl=e=>w("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),il=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return w(`/api/commissions/stats?${a}`)},ll=(e={})=>{Object.keys(e).forEach(o=>(e[o]===void 0||e[o]===null||e[o]==="")&&delete e[o]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return w(a)},dl=e=>w(`/api/commissions/report/${e}`,{method:"DELETE"}),Et=new Date,ro=new Date(Et.getFullYear(),Et.getMonth(),1),B={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:ro.toISOString().split("T")[0],dashEndDate:Et.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:ro.toISOString().split("T")[0],histEndDate:Et.toISOString().split("T")[0],histProfessionalId:"all"};let pt=null;const Ne=document.getElementById("content");async function cl(){try{B.professionals=await _(p.establishmentId)}catch(e){console.error("Erro profissionais",e)}gl(),ul(),Ht(),Ct("dashboard")}function ul(){pt&&Ne.removeEventListener("click",pt),pt=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,o=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":Ct(t.dataset.tab);break;case"toggle-all-profs":ml();break;case"back-to-filters":B.calculationResult=null,It(document.getElementById("commissions-content"));break;case"view-preview-items":hl(r);break;case"save-final-report":xl();break;case"start-new-calc":Ct("calculator");break;case"print-receipt":yl(o);break;case"delete-report":wl(o);break;case"filter-dashboard":Ht();break;case"filter-history":La();break}},Ne.addEventListener("click",pt),Ne.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;fl(t)}},Ne.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),pl())}}async function Ht(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(B.dashStartDate=e.value),t&&(B.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const o=await il(B.dashStartDate,B.dashEndDate);B.dashStats={revenue:o.totalRevenue||0,commissions:o.totalCommissionsPaid||0},B.currentTab==="dashboard"&&zo(document.getElementById("commissions-content"))}catch(o){console.error(o),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function La(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(B.histStartDate=e.value),t&&(B.histEndDate=t.value),a&&(B.histProfessionalId=a.value);const o=document.getElementById("history-list-container");if(o){o.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await ll({startDate:B.histStartDate,endDate:B.histEndDate,professionalId:B.histProfessionalId});B.historyData=r,Vo(o,r)}catch{o.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function ml(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function pl(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(s=>s.value);if(e.length===0)return g("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),o=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");B.periodString=`${a} a ${o}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const s=await rl(t);B.calculationResult=s.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),It(r)}catch(s){g("Erro",s.message,"error"),B.calculationResult=null,It(r)}}function gl(){Ne.innerHTML=`
        ...
        <div class="space-y-6 animate-fade-in">
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row gap-4 items-end">
                <div class="flex-1 w-full">
                    ...
                    <input type="date" id="dash-start" value="${B.dashStartDate}" class="w-full mt-1 rounded-lg border-gray-300">
                </div>
                <div class="flex-1 w-full">
                    <label class="text-xs font-bold text-gray-500 uppercase">Data Final</label>
                    <input type="date" id="dash-end" value="${B.dashEndDate}" class="w-full mt-1 rounded-lg border-gray-300">
                </div>
    ...
    `}function bl(e){const t=B.professionals.map(a=>`<option value="${a.id}" ${B.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <div>
                        ...
                        <input type="date" id="hist-start" value="${B.histStartDate}" class="w-full mt-1 rounded-lg border-gray-300">
                    </div>
                    <div>
                        <label class="text-xs font-bold text-gray-500 uppercase">Até</label>
                        <input type="date" id="hist-end" value="${B.histEndDate}" class="w-full mt-1 rounded-lg border-gray-300">
                    </div>
                    <div>
    ...
    `,B.historyData.length>0?Vo(document.getElementById("history-list-container"),B.historyData):La()}function Vo(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}function fl(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let o=0,r=0;if(t.forEach(s=>{s.value&&(o=parseFloat(s.value))}),a.forEach(s=>{s.value&&(r=parseFloat(s.value))}),B.calculationResult&&B.calculationResult[e]){const s=B.calculationResult[e];s.extraDebit=o,s.extraCredit=r,s.finalValue=s.summary.totalCommission-o+r,t.forEach(i=>{i!==document.activeElement&&(i.value=o||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${s.finalValue.toFixed(2)}`),vl()}}function vl(){const e=B.calculationResult.reduce((a,o)=>a+o.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function hl(e){const t=B.calculationResult[e];if(!t)return;const a=t.items.map(o=>`
    ...
    `).join("");N({title:"Detalhes da Comissão",contentHTML:`<div class="bg-gray-50 p-3 rounded-lg mb-4 flex justify-between items-center"><div><p class="text-xs text-gray-500">Profissional</p><p class="font-bold text-gray-800">${t.professionalName}</p></div><div class="text-right"><p class="text-xs text-gray-500">Total Itens</p><p class="font-bold text-gray-800">${t.items.length}</p></div></div><div class="border rounded-lg overflow-hidden max-h-[60vh] overflow-y-auto">${a}</div>`,maxWidth:"max-w-md"})}async function xl(){const e=B.calculationResult.length;if(await A("Confirmar",`Gerar ${e} relatórios?`))try{const a=B.calculationResult.map(o=>nl({professionalId:o.professionalId,professionalName:o.professionalName,period:B.periodString,reportData:{...o,summary:{...o.summary,finalValue:o.finalValue,extraDebit:o.extraDebit||0,extraCredit:o.extraCredit||0,notes:o.notes||""}}}));await Promise.all(a),g("Sucesso","Pagamentos registrados!","success"),B.calculationResult=null,Ht(),Ct("history")}catch(a){g("Erro",a.message,"error")}}function yl(e){const t=B.historyData.find(a=>a.id===e);t&&kl(t)}async function wl(e){if(await A("Excluir","Deseja remover este registro?"))try{await dl(e),g("Sucesso","Registro removido.","success"),La(),Ht()}catch(a){g("Erro",a.message,"error")}}function kl(e){const{jsPDF:t}=window.jspdf;if(!t)return g("Erro","PDF lib não carregada.","error");const a=new t,o=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",o,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const s=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,s,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function It(e){if(B.calculationResult){const t=B.calculationResult,a=t.reduce((s,n)=>s+n.finalValue,0),o=t.map((s,n)=>`
            ...
            </div>`}else{const t=new Date().toISOString().split("T")[0],a=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],o=B.professionals.map(r=>`
            ...
            </form>`}}const Gt=document.getElementById("content");let he={allPackages:[],catalogForModal:{services:[],products:[]}},gt=null,Se=null;function Sl(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `}).join("")}}function no(){const e=document.getElementById("genericModal");e.style.display="none",Se&&e.removeEventListener("click",Se)}async function io(e=null){const t=document.getElementById("genericModal"),a=!!e,o=e?JSON.parse(JSON.stringify(e.items||[])):[],r=`
    ...
    `,document.body.appendChild(a);const s=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(s),n.addEventListener("input",()=>{t=n.value,r(s)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),u=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:c,itemId:m}=d.dataset,f=(he.catalogForModal[c+"s"]||[]).find(v=>v.id===m);f&&(e({...f,type:c}),i())}else(u||l.target===a)&&i()})}async function Ba(){Gt.innerHTML=`
    ...
    `,gt&&Gt.removeEventListener("click",gt),gt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const o=e.target.closest('[data-action="delete-package"]');if(o){const r=o.dataset.id;A("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async s=>{if(s)try{await Lr(r),g("Sucesso!","Pacote excluído.","success"),await Ba()}catch(n){g("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")io(null);else if(a==="edit-package"){const o=JSON.parse(t.dataset.package);io(o)}},Gt.addEventListener("click",gt);try{const[e,t,a]=await Promise.all([$o(p.establishmentId),De(p.establishmentId),At(p.establishmentId)]);he.allPackages=e,he.catalogForModal={services:t.filter(o=>o.active),products:a},$l()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Cl=document.getElementById("content");let Il=null;async function Ll(){Cl.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await Bl()}async function Bl(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await ys(t);Il=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo),e.innerHTML=`
            ...
            `,Tl(a.id),document.getElementById("my-blocks-filter").addEventListener("change",r=>Lt(a.id,r.target.value)),Lt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function Tl(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const o=t.querySelector("#blockDate").value,r=t.querySelector("#blockStartTime").value,s=t.querySelector("#blockEndTime").value,n=t.querySelector("#blockReason").value;if(!o||!r||!s){g("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(r>=s){g("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${o}T${r}:00`),l=new Date(`${o}T${s}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Mt({establishmentId:p.establishmentId,professionalId:e,reason:n||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),g("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const u=document.getElementById("my-blocks-filter").value;Lt(e,u)}catch(u){console.error("Erro ao bloquear agenda:",u),g("Erro",`Não foi possível bloquear a agenda: ${u.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function Lt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const o=new Date;let r,s;t==="history"?(s=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,s=new Date,s.setFullYear(s.getFullYear()+1));let i=(await Dt(p.establishmentId,r.toISOString(),s.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<o).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=o).sort((l,d)=>l.startTime-d.startTime),i.length>0?(a.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),u=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`;return`
                ...
                `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const u=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await va(u),g("Sucesso","Bloqueio removido.","success"),Lt(e,t)}catch(c){console.error("Erro ao remover bloqueio:",c),g("Erro",`Não foi possível remover o bloqueio: ${c.message}`,"error")}})})):a.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(o){console.error("Erro ao carregar bloqueios:",o),a.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${o.message}</p>`}}const bt=document.getElementById("loadingScreen"),Yt=document.getElementById("dashboardContent"),Xt=document.getElementById("content"),lo=document.getElementById("notificationBell"),Qt=document.getElementById("notificationBadge"),ft=document.getElementById("notificationPanel"),co=document.getElementById("notificationList"),Zt=document.getElementById("profileMenuButton"),X=document.getElementById("profileDropdown"),Dl=document.getElementById("profileName"),Ml=document.getElementById("profileEmail"),Pl=document.getElementById("logoutButton"),Al=document.getElementById("cancellationHistoryBtn"),uo=document.getElementById("myProfileLink"),mo={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let Ue=null,Je=[];const ql={"agenda-section":ko,"comandas-section":ya,"relatorios-section":Ur,"servicos-section":ln,"produtos-section":kn,"suppliers-section":Mn,"profissionais-section":St,"clientes-section":jt,"estabelecimento-section":Ho,"ausencias-section":Ai,"users-section":$t,"sales-report-section":Xi,"financial-section":sl,"commissions-section":cl,"packages-section":Ba,"my-profile-section":Ll};function Nl(e){const t=mo[e]||mo.indigo,o=(s=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(s);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function pa(){const e=Je.filter(t=>!t.read).length;if(e>0?(Qt.textContent=e,Qt.classList.remove("hidden")):Qt.classList.add("hidden"),Je.length===0){co.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}co.innerHTML=Je.map(t=>`
    ...
    `).join("")}function Fl(e){Ue&&Ue();const t=Te(Q,"establishments",e,"notifications"),a=go(t,Zo("timestamp",">=",new Date),bo("timestamp","desc"));Ue=Ko(a,o=>{o.docChanges().forEach(r=>{if(r.type==="added"){const s=r.doc.data();Je.unshift({title:s.title,message:s.message,time:s.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),g(s.title,s.message,"info",!0),pa();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(s.type==="cancellation"||s.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),ko())}})},o=>{console.error("Erro no listener de notificações em tempo real:",o),g("Erro de Conexão","Não foi possível receber atualizações em tempo real. Verifique as regras de segurança do Firestore.","error")})}function Y(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=p.enabledModules?.[a]!==!1,s=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!r||!s){Xt.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active"));return}}const o=ql[e];o?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),Xt.innerHTML="",o(t)):(Xt.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`,console.warn(`Nenhum carregador de página definido para: ${e}`))}async function Rl(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),o=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),s=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(s&&t&&t.classList.remove("hidden"),n&&a&&a.classList.remove("hidden"),!(!s&&!n))try{const i=await Fs();s&&o&&(o.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i),s&&o&&(o.textContent="Erro"),n&&r&&(r.textContent="Erro")}}async function jl(e){try{_e.getPlatform()==="android"&&(await re.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal de notificação Android criado com sucesso."));let t=await re.checkPermissions();if(t.receive==="prompt"&&(t=await re.requestPermissions()),t.receive!=="granted"){console.warn("Permissão de notificação push foi negada pelo utilizador.");return}await re.register(),re.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const o=Bt(Q,"users",e);await fo(o,{fcmToken:a.value}),console.log("Token FCM salvo no perfil do utilizador.")}catch(o){console.error("Erro ao salvar token FCM:",o)}}),re.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),re.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),g(a.title,a.body,"info",!0)}),re.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),Y("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function Hl(){_e.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),us(),lo.addEventListener("click",e=>{e.stopPropagation(),ft.classList.toggle("hidden"),ft.classList.contains("hidden")||(Je.forEach(t=>t.read=!0),pa())}),Al.addEventListener("click",()=>{ms()}),Zt.addEventListener("click",e=>{e.stopPropagation(),X.classList.toggle("active"),X.classList.contains("active")?X.classList.remove("hidden"):setTimeout(()=>X.classList.add("hidden"),200)}),uo&&uo.addEventListener("click",e=>{e.preventDefault(),Y("my-profile-section"),X.classList.remove("active"),X.classList.add("hidden")}),document.addEventListener("click",e=>{!ft.contains(e.target)&&e.target!==lo&&ft.classList.add("hidden"),!X.contains(e.target)&&e.target!==Zt&&X.classList.contains("active")&&(X.classList.remove("active"),setTimeout(()=>X.classList.add("hidden"),200))}),Yo(J,async e=>{if(e)try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const o=await Qe(a.establishmentId);p.enabledModules=o.modules,Nl(o.themeColor||"indigo");let r=null,s=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=Bt(Q,"users",e.uid),u=await Qo(d);if(u.exists()){const c=u.data();r=a.role==="employee"?c.permissions||{}:null,s=c.name||s,n=c.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}p.userProfessionalId=n,jl(e.uid);const i=s||e.email;es(a.establishmentId,o.name,r),Zt.textContent=i.charAt(0).toUpperCase(),Dl.textContent=i,Ml.textContent=e.email;const l=()=>{Ue&&Ue(),Ta(J).then(()=>window.location.href="/login.html")};Pl.addEventListener("click",d=>{d.preventDefault(),l()}),fs(Y,r,p.enabledModules),Rl(r),Fl(a.establishmentId),pa(),bt.classList.add("fade-out"),Yt.style.display="flex",setTimeout(()=>{bt.style.display="none"},500),Y("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),bt.classList.add("fade-out"),setTimeout(()=>{bt.style.display="none"},500),Yt.innerHTML=`
                ...
                `,Yt.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{Ta(J).then(()=>window.location.href="/login.html")})}else window.location.href="/login.html"})}Hl();
