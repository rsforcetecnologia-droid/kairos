...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${s}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${s}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ro}. Verifique se o servidor backend está rodando.`):n}}const Ra=(e,t,o,a=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${o}`;return a&&(r+=`&professionalId=${a}`),k(r)},_s=(e,t,o)=>{const a=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${o}`;return k(a)},Ws=({establishmentId:e,professionalId:t,serviceIds:o,date:a})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${o.join(",")}&date=${a}`;return k(r)},Js=e=>k("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Gs=(e,t)=>k(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Uo=e=>k(`/api/appointments/${e}`,{method:"DELETE"}),Ys=e=>k(`/api/appointments/${e}/reopen`,{method:"POST"}),Qs=(e,t)=>k(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let W;async function Xs(){if(!W)try{W=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Zs(){if(!W){console.warn("AudioContext não inicializado. O som não será tocado.");return}W.state==="suspended"&&W.resume();const e=W.createOscillator(),t=W.createGain();e.connect(t),t.connect(W.destination),e.type="sine",e.frequency.setValueAtTime(800,W.currentTime),t.gain.setValueAtTime(0,W.currentTime),t.gain.linearRampToValueAtTime(.3,W.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,W.currentTime+.2),e.start(W.currentTime),e.stop(W.currentTime+.2)}function p(e,t,o="info",a=!1){const r=document.getElementById("toast-container");if(!r)return;a&&Zs();const s=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};s.className=`toast ${n[o]||n.info}`,s.innerHTML=`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",Jr)}function Yr(){Gr()}function Qr(e,t){const o=e?"Editar Agendamento":"Selecionar Cliente",a=`
    ...
    `,{modalElement:t}=Y({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async o=>{o.preventDefault();const a=parseFloat(document.getElementById("initial-amount").value);if(isNaN(a)||a<0)return p("Valor Inválido","Insira um valor válido.","error");try{const r=await ln({establishmentId:m.establishmentId,initialAmount:parseFloat(a.toFixed(2))});x.isCashierOpen=!0,x.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",p("Sucesso!",`Caixa aberto (R$ ${a.toFixed(2)})`,"success"),Ut(),await se()}catch(r){p("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function In(){const e=x.activeCashierSessionId;if(e)try{const t=await un(e),o=`
        ...
        </div>`;try{await Wn();const[e,t]=await Promise.all([Z(m.establishmentId),Dr(m.establishmentId).catch(()=>[])]);D.professionalsList=e||[],D.costCentersList=t||[],Gn(),await cs()}catch(e){console.error("Erro no loadReportsPage:",e),mo.innerHTML=`
...
Aguardo retorno.`;const d=`mailto:${a.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else p("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const o=e.target.closest(".btn-register-order");if(o.disabled)return;const a=JSON.parse(decodeURIComponent(o.dataset.order));a.establishmentId=m.establishmentId,o.disabled=!0,o.textContent="A processar...",Se(m.establishmentId).then(r=>{const s=r.purchaseConfig||null;return pi(a,s)}).then(()=>{p("Sucesso","Compra registrada e integrada ao financeiro!","success"),o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',o.classList.replace("bg-blue-600","bg-green-600"),o.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{o.disabled=!1,o.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',p("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const a=e.target.closest(".btn-delete-purchase").dataset.id;H("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await gi(a,m.establishmentId),p("Sucesso","Compra e financeiro excluídos.","success"),vs()}catch(s){p("Erro","Erro ao excluir: "+s.message,"error")}})}if(e.target.closest(".btn-print-order")){const a=e.target.closest(".supplier-order-card").dataset.supplierId,r=O.finalOrders[a];r?Di(r,O.isQuoteMode):p("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const o=e.target.closest(".btn-view-purchase"),a=JSON.parse(o.dataset.purchase);Bi(a)}},be.addEventListener("click",le),be.addEventListener("input",le),be.addEventListener("change",le),mt("list")}function mt(e){St=e,["list","purchases","history"].forEach(o=>{const a=document.getElementById(`tab-btn-${o}`),r=document.getElementById(`tab-content-${o}`);o===e?(a.classList.add("border-indigo-500","text-indigo-600"),a.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(a.classList.remove("border-indigo-500","text-indigo-600"),a.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Ei()}const Xt=document.getElementById("content"),ba={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let re=new Set,pt=null,Be=null;function Ai(e=8){let t="";for(let o=0;o<e;o++)t+=`
    ...
    `,he.querySelector('button[data-action="back-to-list"]').addEventListener("click",a=>{a.preventDefault(),Es()});const o=document.getElementById("settings-content-detail");switch(e){case"personal-data":Zi(J,o);break;case"change-password":Ki(J,o);break;case"change-email":el(J,o);break;case"branding":tl(J,o);break;case"booking":ol(J,o);break;case"working-hours":al(J,o);break;case"loyalty":sl(J,o);break;case"financial":await rl(J,o);break;case"support":nl(J,o);break;case"cancellation":il(J,o);break;default:ll(t?t.label:"Definições",o)}}async function Es(){if(he.innerHTML=`
