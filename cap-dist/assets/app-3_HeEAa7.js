...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${la}. Verifique se o servidor backend está rodando.`):n}}const Ro=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),k(r)},_s=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return k(s)},Js=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return k(r)},Ws=e=>k("/api/appointments",{method:"POST",body:JSON.stringify(e)}),Gs=(e,t)=>k(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),Ua=e=>k(`/api/appointments/${e}`,{method:"DELETE"}),Ys=e=>k(`/api/appointments/${e}/reopen`,{method:"POST"}),Qs=(e,t)=>k(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let J;async function Xs(){if(!J)try{J=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function Zs(){if(!J){console.warn("AudioContext não inicializado. O som não será tocado.");return}J.state==="suspended"&&J.resume();const e=J.createOscillator(),t=J.createGain();e.connect(t),t.connect(J.destination),e.type="sine",e.frequency.setValueAtTime(800,J.currentTime),t.gain.setValueAtTime(0,J.currentTime),t.gain.linearRampToValueAtTime(.3,J.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,J.currentTime+.2),e.start(J.currentTime),e.stop(J.currentTime+.2)}function g(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&Zs();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `;const t=document.getElementById("progress-bar"),a=document.getElementById("progress-text");t&&(t.style.width="100%"),a&&(a.innerText="100%"),document.getElementById("finish-onboarding-btn").onclick=()=>{de&&de.remove(),window.location.reload()}}async function yr(e){const t=document.getElementById("step-form");if(!t.reportValidity())return;const a=document.getElementById("next-step-btn"),s=a.innerHTML;a.disabled=!0,a.innerHTML="Salvando...";const r=new FormData(t),o=Object.fromEntries(r.entries());try{if(e==="company_data")await St(m.establishmentId,{name:o.name,phone:o.phone,email:o.email,address:o.address,zipCode:o.zipCode});else if(e==="branding"){const n={};o.logoBase64&&(n.logo=o.logoBase64),o.bgBase64&&(n.backgroundImage=o.bgBase64),o.themeColor&&(n.themeColor=o.themeColor),o.primaryColor&&(n.primaryColor=o.primaryColor),Object.keys(n).length>0&&await St(m.establishmentId,n)}else if(e==="time_config"){const n=parseInt(o.slotInterval);await St(m.establishmentId,{slotInterval:n})}else if(e==="first_service"){const n=await Ho({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.price),duration:parseInt(o.duration),active:!0});n&&Tt.push(n)}else if(e==="first_prof"){const n=await Fo({establishmentId:m.establishmentId,name:o.name,specialty:o.role,active:!0,commissionRate:0});if(o.serviceId&&n&&n.id)try{Ga?await Ga(n.id,[o.serviceId]):Lt&&await Lt(n.id,{services:[o.serviceId]})}catch(i){console.warn("Não foi possível vincular o serviço automaticamente.",i)}}else e==="first_product"&&await Oo({establishmentId:m.establishmentId,name:o.name,price:parseFloat(o.salePrice),stock:parseInt(o.stock),active:!0});g("Sucesso","Passo concluído!","success"),K++,Sa(),$a(K)}catch(n){g("Erro","Erro ao salvar: "+n.message,"error"),a.disabled=!1,a.innerHTML=s}}var Ne;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ne||(Ne={}));class Qt extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const wr=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},kr=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:wr(e),o=()=>r()!=="web",n=u=>{const p=d.get(u);return!!(p?.platforms.has(r())||i(u))},i=u=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(f=>f.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,p={})=>{const f=d.get(u);if(f)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),f.proxy;const v=r(),b=i(u);let x;const $=async()=>(!x&&v in p?x=typeof p[v]=="function"?x=await p[v]():x=p[v]:t!==null&&!x&&"web"in p&&(x=typeof p.web=="function"?x=await p.web():x=p.web),x),S=(T,B)=>{var q,F;if(b){const z=b?.methods.find(A=>B===A.name);if(z)return z.rtype==="promise"?A=>a.nativePromise(u,B.toString(),A):(A,Q)=>a.nativeCallback(u,B.toString(),A,Q);if(T)return(q=T[B])===null||q===void 0?void 0:q.bind(T)}else{if(T)return(F=T[B])===null||F===void 0?void 0:F.bind(T);throw new Qt(`"${u}" plugin is not implemented on ${v}`,Ne.Unimplemented)}},w=T=>{let B;const q=(...F)=>{const z=$().then(A=>{const Q=S(A,T);if(Q){const $e=Q(...F);return B=$e?.remove,$e}else throw new Qt(`"${u}.${T}()" is not implemented on ${v}`,Ne.Unimplemented)});return T==="addListener"&&(z.remove=async()=>B()),z};return q.toString=()=>`${T.toString()}() { [capacitor code] }`,Object.defineProperty(q,"name",{value:T,writable:!1,configurable:!1}),q},E=w("addListener"),L=w("removeListener"),N=(T,B)=>{const q=E({eventName:T},B),F=async()=>{const A=await q;L({eventName:T,callbackId:A},B)},z=new Promise(A=>q.then(()=>A({remove:F})));return z.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await F()},z},j=new Proxy({},{get(T,B){switch(B){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return b?N:E;case"removeListener":return L;default:return w(B)}}});return s[u]=j,d.set(u,{name:u,proxy:j,platforms:new Set([...Object.keys(p),...b?[v]:[]])}),j};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=Qt,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Sr=e=>e.Capacitor=kr(e),he=Sr(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Ea=he.registerPlugin;class zo{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new he.Exception(t,Ne.Unimplemented)}unavailable(t="not available"){return new he.Exception(t,Ne.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Xa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Za=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class $r extends zo{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Za(r).trim(),o=Za(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Xa(t.key),s=Xa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Ea("CapacitorCookies",{web:()=>new $r});const Er=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),Ir=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},Cr=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,Lr=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Ir(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Tr extends zo{async request(t){const a=Lr(t,t.webFetchExtra),s=Cr(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await Er(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const c={};return o.headers.forEach((u,p)=>{c[p]=u}),{data:l,headers:c,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Ea("CapacitorHttp",{web:()=>new Tr});const G=Ea("PushNotifications",{}),Pr="BDA-IaH_jjWBRwHbuFcB56I25jKHpchx34yZtv_6iIo_yV2tz_yIZYS3hfntDaN5Slf4ch8ZEJCIt4D7LIWX4mY";let Ka=!1;async function Vo(){if(window.Capacitor&&window.Capacitor.isNativePlatform()){try{await G.removeAllListeners(),await G.addListener("registration",async a=>{Jo(a.value,!0)}),await G.addListener("pushNotificationReceived",a=>{console.log("[Push Nativo] Recebido em Foreground (Visual gerido pelo Firestore):",a)}),await G.addListener("pushNotificationActionPerformed",a=>{const s=a.notification.data;console.log("Notificação clicada (Ação):",s)});let t=await G.checkPermissions();t.receive==="prompt"&&(t=await G.requestPermissions()),t.receive==="granted"&&await G.register()}catch(t){console.error("[Push Nativo] Erro:",t)}return}"Notification"in window&&Notification.permission==="granted"&&_o()}async function Uo(){try{return await Notification.requestPermission()==="granted"?(console.log("Permissão concedida pelo utilizador."),await _o(),!0):(console.warn("Permissão de notificações negada."),!1)}catch(e){return console.error("Erro ao pedir permissão Web:",e),!1}}async function _o(){if("serviceWorker"in navigator)try{const e=await navigator.serviceWorker.register("/firebase-messaging-sw.js");await e.update();const t=await Os(Oa,{vapidKey:Pr,serviceWorkerRegistration:e});t?(console.log("[Push Web] Token validado."),await Jo(t,!1)):console.warn("[Push Web] Token veio vazio."),Ka||(zs(Oa,a=>{console.log("[Push Web] Recebido em Foreground (Silencioso):",a)}),Ka=!0)}catch(e){console.error("[Push Web] Falha no registo:",e)}else console.warn("Navegador sem suporte a Service Worker.")}async function Jo(e,t){const a=U.currentUser;if(!a){console.warn("Usuário não logado. Token não salvo.");return}const s=ce(_,"users",a.uid);try{const r=await Do(s);if(r.exists()){const n=r.data().fcmTokens||[];if(n.length===1&&n[0]===e){console.log("Token já sincronizado e único. Nenhuma ação necessária.");return}}await wa(s,{fcmTokens:[e],lastLoginAt:new Date().toISOString(),platform:t?"android_native":"pwa_web"}),console.log("Token atualizado (Sessão Única garantida).")}catch(r){if(r.code==="not-found")try{await Rs(s,{email:a.email,fcmTokens:[e],platform:t?"android_native":"pwa_web",createdAt:new Date().toISOString()},{merge:!0}),console.log("Utilizador criado e token inicial salvo.")}catch(o){console.error("Erro ao criar user:",o)}else console.error("Erro ao atualizar token:",r)}}const Br=(e,t,a="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),k(`/api/reports/indicators?${r.toString()}`)},Dr=e=>e?k(`/api/financial/cost-centers/${e}`):Promise.resolve([]),Mr=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),k(`/api/reports/sales?${r.toString()}`)},Ar=()=>k("/api/reports/summary",{method:"GET"}),Ot=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return k(r)},zt=e=>k("/api/blockages",{method:"POST",body:JSON.stringify(e)}),Ia=e=>k(`/api/blockages/${e}`,{method:"DELETE"}),Wo=e=>k("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),Ca=e=>e?String(e).replace(/\D/g,""):"",it=(e,t="",a=20,s={})=>{const r=new URLSearchParams;return t&&r.append("search",t),a&&r.append("limit",a),s.hasLoyalty&&r.append("hasLoyalty","true"),s.birthMonth&&r.append("birthMonth",s.birthMonth),s.inactiveDays&&r.append("inactiveDays",s.inactiveDays),k(`/api/clients/${e}?${r.toString()}`)},da=(e,t)=>{const a=encodeURIComponent(t);return k(`/api/clients/details/${e}/${a}`)},Nr=e=>{if(!e.phone)throw new Error("Telefone é obrigatório");const t=Ca(e.phone),a={...e,phone:t,id:t};return k(`/api/clients/${t}`,{method:"PUT",body:JSON.stringify(a)})},qr=(e,t)=>{const a=Ca(t);return k(`/api/clients/full-history/${e}?phone=${a}`)},Go=e=>{const t=encodeURIComponent(e);return k(`/api/clients/${t}`,{method:"DELETE"})},Rr=(e,t,a,s)=>k("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientPhone:Ca(t),points:a,rewardName:s})});function h(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Yo(e,t=800,a=800,s=.7){return new Promise((r,o)=>{if(!e.type.match(/image.*/))return o(new Error("O ficheiro selecionado não é uma imagem."));const n=new FileReader;n.readAsDataURL(e),n.onload=i=>{const l=new Image;l.src=i.target.result,l.onload=()=>{let d=l.width,c=l.height;d>c?d>t&&(c*=t/d,d=t):c>a&&(d*=a/c,c=a);const u=document.createElement("canvas");u.width=d,u.height=c,u.getContext("2d").drawImage(l,0,0,d,c);const f=u.toDataURL("image/jpeg",s);r(f)},l.onerror=d=>o(new Error("Erro ao carregar a imagem para processamento."))},n.onerror=i=>o(new Error("Erro ao ler o ficheiro."))})}const eo=document.getElementById("content");let to=!1;const ca=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let lt=[],Vt=[],qe={},De=[],C={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null,isSelectionMode:!1,selectedItems:new Set},I={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function Fr(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function Qo(e){const t=new Date(e);if(t.setHours(0,0,0,0),C.currentView==="week"&&C.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function Pt(){const e=document.getElementById("profSelectorContainer"),t=C.profSearchTerm.toLowerCase();if(!e||!m.professionals)return;let a=m.professionals.filter(o=>C.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=C.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",c=h(i),u=ca[0],p=o.id!=="all"&&m.professionalColors.get(o.id)||u,f=o.photo||`https://placehold.co/64x64/${p.main?.replace("#","")||"E0E7FF"}/${p.light?.replace("#","")||"4F46E5"}?text=${l}`,v=o.id==="all"?"#e0e7ff":p.light,b=o.id==="all"?"#4f46e5":p.main,$=`border: 3px solid ${n?p.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+p.border:"none"};`;return`
        ...
        `}).join("")}function jr(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function Hr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=m.professionalColors.get(s.professionalId)||{},d=h(s.reason),c=h(s.professionalName),u=h(s.clientName),p=h(s.serviceName),f=C.selectedItems.has(s.id),v=C.isSelectionMode?`<div class="flex items-center justify-center pr-3 border-r border-gray-200 mr-3">
                ...
                </div>`;const b=s.status==="completed",x=b?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",$=b?"Finalizado":"Aberto",S=JSON.stringify(s).replace(/'/g,"&apos;"),w=s.redeemedReward?.points>0,E=s.hasRewards&&!w,L=jr(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime),N=C.isSelectionMode?"":'data-action="open-comanda"';return`
            <div class="appointment-list-card" data-appointment='${S}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
                    <span class="status-badge ${x} mb-1">${$}</span>
                    ...
                    `;const E=JSON.stringify(p).replace(/'/g,"&apos;"),L=p.redeemedReward?.points>0,N=p.hasRewards&&!L,j=p.status==="completed";return`
                    <div class="p-2 rounded-lg border-l-4 flex flex-col cursor-pointer" 
                         style="background-color: ${b.bg}; border-left-color: ${b.border};"
        ...
        `}o+="</div>",t.innerHTML=o}function Xo(){const e=m.allEvents.filter(t=>C.selectedProfessionalId==="all"||t.professionalId===C.selectedProfessionalId);C.currentView==="list"?Hr(e):Or(e),Ta()}function Ta(){const e=document.getElementById("batch-delete-container"),t=document.querySelector('[data-action="new-appointment"]');e&&(C.isSelectionMode&&C.selectedItems.size>0?(e.innerHTML=`
    ...
    `,Ut()}function Ut(){const e=document.getElementById("cashier-alert-box"),t=document.getElementById("btn-new-sale");y.isCashierOpen?(e&&(e.innerHTML=""),t&&(t.classList.remove("opacity-50","cursor-not-allowed"),t.disabled=!1)):(e&&(e.innerHTML=`
        ...
        `,t&&(t.innerHTML="");return}const s={atendimento:"confirmed",finalizadas:"completed"}[y.activeFilter],r=y.allComandas.filter(n=>n.status===s);if(r.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda nesta página.</p>',ro(t);return}const o=document.createDocumentFragment();r.forEach(n=>{const l=Re(n).reduce((x,$)=>x+Number($.price||0),0),d=n.id===y.selectedComandaId,c=new Date(n.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),u=n.type==="walk-in"||typeof n.id=="string"&&n.id.startsWith("temp-"),p=h(n.clientName||"Cliente sem nome"),f=h(n.professionalName||"Sem profissional"),v=u?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md border border-blue-200">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md border border-indigo-200">Agenda</span>',b=document.createElement("div");b.className=`comanda-card cursor-pointer ${d?"selected":""}`,b.dataset.action="select-comanda",b.dataset.comandaId=n.id,b.innerHTML=`
        ...
        `,o.appendChild(b)}),e.innerHTML="",e.appendChild(o),ro(t)}function ro(e){if(!e)return;e.innerHTML="";const{page:t,total:a,limit:s}=y.paging,r=Math.ceil((a||0)/s);if(r===0)return;const o=document.createElement("div");o.className="flex gap-2 justify-center items-center w-full",o.innerHTML=`
    ...
    `,e.appendChild(o),o.querySelectorAll("button[data-page]").forEach(n=>{n.onclick=i=>{i.stopPropagation();const l=parseInt(n.dataset.page,10);l>0&&l<=r&&(y.paging.page=l,se())}})}function V(){const e=document.getElementById("comanda-detail-container");if(!e)return;const t=y.allComandas.find(b=>b.id===y.selectedComandaId);if(y.viewMode==="checkout"&&t){hn(t,e);return}const a=`
    ...
    `;if(!y.isCashierOpen){e.innerHTML=`
        ...
        `;return}const s=Re(t),r=t.status==="completed",o=t.type==="walk-in"||typeof t.id=="string"&&t.id.startsWith("temp-"),n=s.reduce((b,x)=>{const $=x._source==="original_service",S=x.id||x.name,w=$?`original-${S}`:`${x.type}-${S}`;return b[w]||(b[w]={...x,quantity:0,sources:[]}),b[w].quantity+=1,x._source&&b[w].sources.push(x._source),b},{}),i=Object.values(n).reduce((b,x)=>b+Number(x.price||0)*x.quantity,0),l=h(t.clientName||"Cliente sem nome"),d=h(t.professionalName||"Profissional não atribuído"),c=t._hasUnsavedChanges,f=`
    ...
    `;e.innerHTML=`
        ...
        <div class="flex-grow overflow-y-auto p-4 pb-24 custom-scrollbar"> 
            ...
            <div class="space-y-3">
                ...
                ${Object.values(n).map(b=>{const x=b.sources&&b.sources.includes("original_service");return`
                    <div class="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm ${b.isReward?"border-yellow-200 bg-yellow-50":""}">
                        <div class="flex items-center gap-3 w-full">
                            <div class="flex-grow min-w-0">
                                ...
                                <p class="text-xs text-gray-500">${b.isReward?'<span class="text-yellow-700 font-bold">Prémio Fidelidade</span>':`R$ ${(b.price||0).toFixed(2)} un.`}</p>
                            </div>
                            ${r?`<span class="flex items-center justify-center w-8 h-8 bg-gray-100 text-gray-700 font-bold text-sm rounded-lg">${b.quantity}x</span>`:`
                                <div class="flex items-center bg-gray-100 rounded-lg p-1 gap-3">
                                    ${x?`<span class="text-sm font-bold text-gray-500 w-16 text-center py-1 bg-gray-200 rounded text-[10px] uppercase">Fixo: ${b.quantity}</span>`:`<button data-action="decrease-qty" data-item-id="${b.id}" data-item-type="${b.type}" class="w-6 h-6 flex items-center justify-center rounded bg-white text-gray-600 shadow-sm hover:bg-red-50 hover:text-red-600 disabled:opacity-30 disabled:hover:bg-white disabled:hover:text-gray-600">-</button>
                                         <span class="text-sm font-bold text-gray-800 w-4 text-center">${b.quantity}</span>
                                         <button data-action="increase-qty" data-item-id="${b.id}" data-item-type="${b.type}" class="w-6 h-6 flex items-center justify-center rounded bg-white text-gray-600 shadow-sm hover:bg-green-50 hover:text-green-600">+</button>`}
                                </div>
                            `}
                            <div class="flex items-center justify-end w-20">
                                <span class="font-bold text-gray-900 whitespace-nowrap">R$ ${(b.price*b.quantity).toFixed(2)}</span>
                            </div>
                        </div>
                    </div>
                `}).join("")}
        ...
        ${r?"":v}
    `,!r&&(t.clientId||t.clientName)&&xn(t,e.querySelector("#loyalty-container"))}function hn(e,t){const s=Re(e).reduce((u,p)=>u+Number(p.price||0)*(p.quantity||1),0),r=y.checkoutState,o=r.discount||{type:"real",value:0};let n=0;o.type==="percent"?n=s*o.value/100:n=o.value,n>s&&(n=s);const i=s-n,l=r.payments.reduce((u,p)=>u+p.value,0),d=Math.max(0,i-l);(!r.amountReceived||d>0)&&(r.amountReceived=d.toFixed(2));const c=`
        <div class="mobile-only-header">
                ...
                ${r.payments.map((u,p)=>`
                    <div class="flex justify-between items-center bg-white p-3 rounded-lg border border-gray-200 shadow-sm animate-fade-in-fast">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button data-action="remove-payment-checkout" data-index="${p}" class="text-red-400 hover:text-red-600 p-1"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>
                        </div>
                    </div>
                `).join("")}
            </div>
                ...
                ${["credito","crediario"].includes(r.selectedMethod)?`
                    <div class="mb-3">
                        ...
                        <select id="checkout-installments" class="w-full mt-1 p-2 border rounded-lg text-sm bg-gray-50">
                            ${Array.from({length:12},(u,p)=>`<option value="${p+1}" ${r.installments===p+1?"selected":""}>${p+1}x</option>`).join("")}
                        </select>
                    </div>
                `:""}
    ...
    `,{modalElement:t}=Y({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=parseFloat(document.getElementById("initial-amount").value);if(isNaN(s)||s<0)return g("Valor Inválido","Insira um valor válido.","error");try{const r=await ln({establishmentId:m.establishmentId,initialAmount:parseFloat(s.toFixed(2))});y.isCashierOpen=!0,y.activeCashierSessionId=r.id,document.getElementById("genericModal").style.display="none",g("Sucesso!",`Caixa aberto (R$ ${s.toFixed(2)})`,"success"),Ut(),await se()}catch(r){g("Erro",`Falha ao abrir caixa: ${r.message}`,"error")}})}async function In(){const e=y.activeCashierSessionId;if(e)try{const t=await un(e),a=`
        ...
        `,{modalElement:s}=Y({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0)return g("Valor Inválido","Insira um valor final válido.","error");try{await dn(e,o),y.isCashierOpen=!1,y.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",Ut(),await se(),g("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){g("Erro",`Falha ao fechar caixa: ${n.message}`,"error")}})}catch(t){g("Erro",`Falha ao carregar relatório: ${t.message}`,"error")}}async function Cn(e){y.activeFilter!==e&&(y.activeFilter=e,y.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),Le(),await se(),y.selectedComandaId=null,y.viewMode="items",V())}function ss(e){y.selectedComandaId=e,y.viewMode="items",ot(),bn(),V()}async function Pa(e,t){const a=y.allComandas.find(o=>o.id===y.selectedComandaId);if(!a)return;if(!e.id||String(e.id)==="undefined"){console.error("Tentativa de adicionar item sem ID:",e),g("Erro","Item sem identificador. Não foi possível adicionar.","error");return}const s=parseFloat(e.price)||0,r=Array(t).fill(0).map(()=>{const o={id:String(e.id),name:e.name,price:s,type:e.type,isReward:e.isReward||!1,pointsCost:e.pointsCost||0};return e.type==="product"?(o.productId=o.id,o.product_id=o.id):e.type==="service"&&(o.serviceId=o.id,o.service_id=o.id),o});a.comandaItems=a.comandaItems||[],a.comandaItems.push(...r),a._cachedItems=null,a._hasUnsavedChanges=!0,V()}async function no(e,t){const a=y.allComandas.find(o=>o.id===y.selectedComandaId);if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>o.id==e&&o.type===t);r>-1&&(a.comandaItems.splice(r,1),s=!0),s&&(a._cachedItems=null,a._hasUnsavedChanges=!0,V())}async function Ln(e){if(y.isProcessing)return;const t=Re(e),a=t.reduce((b,x)=>b+Number(x.price||0)*(x.quantity||1),0),s=y.checkoutState.discount||{type:"real",value:0};let r=s.type==="percent"?a*s.value/100:s.value;r>a&&(r=a);const o=a-r,{payments:n}=y.checkoutState,i=n.reduce((b,x)=>b+x.value,0),l=o-i;if(l>.01){if(!await H("Pagamento Parcial",`O valor de R$ ${l.toFixed(2)} não foi pago. Deseja registrar como DÍVIDA (Fiado) no cadastro do cliente?`))return;n.push({method:"fiado",value:l,installments:1})}y.isProcessing=!0;const d=e.type==="appointment",c=t;let u=0;const p=y.loyaltySettings;if(p&&p.enabled)if(p.type==="visit")u=Number(p.pointsPerVisit)||1;else{const b=Number(p.pointsPerCurrency)||10;b>0&&(u=Math.floor(o/b))}const f={payments:n,totalAmount:Number(o),items:c,cashierSessionId:y.activeCashierSessionId,loyaltyPointsEarned:u,discount:s},v=document.createElement("div");v.className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center backdrop-blur-sm",v.innerHTML='<div class="bg-white p-6 rounded-2xl shadow-2xl flex flex-col items-center"><div class="loader mb-4 border-t-indigo-600"></div><p>Finalizando venda...</p></div>',document.body.appendChild(v);try{d?await Qs(e.id,f):(f.establishmentId=m.establishmentId,f.clientId=e.clientId,f.clientName=e.clientName,f.professionalId=e.professionalId,e.clientPhone&&(f.clientPhone=e.clientPhone),await sn(f));let b="Venda finalizada com sucesso!";u>0&&(b+=` Cliente ganhou ${u} pontos!`),g("Sucesso!",b,"success"),Le(),y.selectedComandaId=null,y.viewMode="items",await se()}catch(b){g("Erro no Checkout",b.message,"error")}finally{document.body.contains(v)&&document.body.removeChild(v),y.isProcessing=!1}}async function Tn(e){e.preventDefault();const t=document.getElementById("selected-client-id"),a=document.getElementById("new-sale-professional").value,s=t.value,r=document.getElementById("client-search").value,o=t.dataset.phone||"";if(!s)return g("Erro","Selecione um cliente válido.","error");const n=m.professionals.find(l=>l.id===a);if(!n)return g("Erro","Selecione um profissional válido.","error");const i={id:`temp-${Date.now()}`,type:"walk-in",clientId:s,clientName:r.split("(")[0].trim(),clientPhone:o,professionalId:n.id,professionalName:n.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};y.allComandas.unshift(i),y.selectedComandaId=i.id,y.viewMode="items",document.getElementById("genericModal").style.display="none",ss(i.id)}async function se(){const e=document.getElementById("comandas-list");(!e.hasChildNodes()||e.innerHTML.includes("loader"))&&(e.innerHTML='<div class="loader mx-auto mt-10"></div>');const t=y.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=await nn();if(y.isCashierOpen=!!a,y.activeCashierSessionId=a?a.id:null,Ut(),!y.isCashierOpen&&y.activeFilter==="atendimento"){ot(),V();return}try{const r=await(void 0)(m.establishmentId);r&&r.loyaltyProgram&&(y.loyaltySettings=r.loyaltyProgram)}catch{}const s=await an(m.establishmentId,t,y.paging.page,y.paging.limit);if(y.allComandas=s.data||s,y.paging.total=s.total||s.length,y.catalog.services.length===0){const[r,o,n,i]=await Promise.all([Se(m.establishmentId),Ht(m.establishmentId),as(m.establishmentId),Z(m.establishmentId)]);y.catalog={services:r,products:o,packages:n},m.professionals=i}ot(),V()}catch(a){g("Erro",`Não foi possível carregar os dados: ${a.message}`,"error")}}async function Pn(e={}){Ce=document.getElementById("content"),y.selectedComandaId=e.selectedAppointmentId||null,y.viewMode="items",fn(),Ee&&(Ce.removeEventListener("click",Ee),Ce.removeEventListener("change",Ee)),Ee=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id]");if(t.target.id==="filter-date"&&y.activeFilter==="finalizadas"){y.paging.page=1,await se();return}if(a){if(a.matches("[data-filter]"))Cn(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}ss(a.dataset.comandaId)}else if(a.matches("[data-action]")){const r=a.dataset.action,o=a.dataset.id||y.selectedComandaId,n=y.allComandas.find(i=>i.id===o);switch(r){case"back-to-list":Le(),y.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(S=>S.classList.remove("selected")),V();break;case"new-sale":pa();break;case"add-item":kn();break;case"open-cashier":En();break;case"close-cashier":await In();break;case"view-sales-report":ae("sales-report-section");break;case"go-to-checkout":await so(n,"checkout");break;case"back-to-items":y.viewMode="items",V();break;case"save-comanda":await so(n,"stay");break;case"select-method":y.checkoutState.selectedMethod=a.dataset.method,y.checkoutState.installments=1,V();break;case"add-payment-checkout":const i=document.getElementById("checkout-amount");let l=parseFloat(i.value);const c=Re(n).reduce((S,w)=>S+(w.price||0),0),u=y.checkoutState.discount||{type:"real",value:0};let p=u.type==="percent"?c*u.value/100:u.value;p>c&&(p=c);const f=c-p,v=y.checkoutState.payments.reduce((S,w)=>S+w.value,0),b=f-v;if(isNaN(l)||l<=0){g("Valor inválido","Insira um valor maior que zero.","error");break}if(l>b+.05){g("Valor inválido","Valor excede o restante.","error");break}const x={method:y.checkoutState.selectedMethod,value:l};["credito","crediario"].includes(y.checkoutState.selectedMethod)&&y.checkoutState.installments>1&&(x.installments=y.checkoutState.installments),y.checkoutState.payments.push(x),y.checkoutState.selectedMethod="dinheiro",y.checkoutState.installments=1,y.checkoutState.amountReceived="",V();break;case"remove-payment-checkout":const $=parseInt(a.dataset.index,10);y.checkoutState.payments.splice($,1),V();break;case"finalize-checkout":await Ln(n);break;case"increase-qty":{const S=a.dataset.itemId,w=a.dataset.itemType;if(!S||S==="undefined"||S==="null"){g("Erro","Item inválido para adição.","error");return}let L=Re(n).find(j=>j.id==S&&j.type===w);L||(L=(y.catalog[w+"s"]||[]).find(T=>T.id==S));const N=L?{id:L.id,name:L.name,price:Number(L.price),type:L.type}:{id:S,name:"Item Indisponível",price:0,type:w};await Pa(N,1);break}case"decrease-qty":{await no(a.dataset.itemId,a.dataset.itemType);break}case"remove-item":await no(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await H("Reabrir Comanda","Tem certeza? O pagamento será estornado."))try{await Ys(o);const w=y.allComandas.findIndex(E=>E.id===o);w!==-1&&(y.allComandas[w].status="confirmed",delete y.allComandas[w].transaction),y.selectedComandaId=null,Le(),await se(),g("Sucesso!","Comanda reaberta.","success")}catch(w){g("Erro",w.message,"error")}break}case"go-to-appointment":{const S=a.dataset.id,w=a.dataset.date;ae("agenda-section",{scrollToAppointmentId:S,targetDate:new Date(w)});break}case"delete-walk-in":{if(await H("Excluir Venda","Confirma a exclusão desta venda avulsa?"))if(o.startsWith("temp-"))y.allComandas=y.allComandas.filter(w=>w.id!==o),y.selectedComandaId=null,ot(),V(),Le();else try{await rn(o),g("Sucesso","Venda excluída.","success"),y.selectedComandaId=null,Le(),await se()}catch(w){g("Erro",w.message,"error")}break}}}}},Ce.addEventListener("click",Ee),Ce.addEventListener("change",Ee),e.initialFilter&&(y.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(y.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${y.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",y.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await se()}const ga=document.getElementById("content");let Xt={};const mt=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],R={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],currentTab:"dashboards"};async function Bn(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function Dn(){ga.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">A carregar inteligência de dados...</p></div>';try{await Bn();const[e,t]=await Promise.all([Z(m.establishmentId),Dr(m.establishmentId).catch(()=>[])]);R.professionalsList=e||[],R.costCentersList=t||[],Mn(),await rs()}catch(e){console.error("Erro no loadReportsPage:",e),ga.innerHTML=`
            ...
            </div>`}}function Mn(){const e=R.professionalsList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join(""),t=R.costCentersList.map(a=>`<option value="${a.id}">${h(a.name)}</option>`).join("");ga.innerHTML=`
            ...
            <div class="bg-white shadow-sm border-b sticky top-0 z-20 px-4 py-4">
                <div class="max-w-7xl mx-auto flex flex-col xl:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex flex-col md:flex-row gap-2 w-full xl:w-auto">
                        ...
                        <div class="flex gap-2">
                            <input type="date" id="report-start" value="${R.startDate}" class="border rounded-lg px-2 py-2 text-sm w-full">
                            <input type="date" id="report-end" value="${R.endDate}" class="border rounded-lg px-2 py-2 text-sm w-full">
    ...
    `,document.getElementById("btn-filter").onclick=An,document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{R.currentTab=a.dataset.tab,io(),ns()}}),io()}function io(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===R.currentTab;e.className=t?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function An(){R.startDate=document.getElementById("report-start").value,R.endDate=document.getElementById("report-end").value,R.selectedProfessional=document.getElementById("report-prof").value,R.selectedCostCenter=document.getElementById("report-cost").value,await rs()}async function rs(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const t=Br(R.startDate,R.endDate,R.selectedProfessional,R.selectedCostCenter),a=R.selectedProfessional==="all"?null:R.selectedProfessional,s=new Date(R.startDate+"T00:00:00").toISOString(),r=new Date(R.endDate+"T23:59:59").toISOString(),o=Ro(m.establishmentId,s,r,a).catch(l=>[]),[n,i]=await Promise.all([t,o]);R.data=n,R.appointmentsData=Array.isArray(i)?i:[],ns()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function ns(){const e=document.getElementById("report-content");if(R.data)switch(R.currentTab){case"dashboards":Nn(e);break;case"appointments":qn(e);break;case"dre":Rn(e);break}}function Nn(e){const{dreSimple:t,charts:a}=R.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0},r=R.data.totalAppointments||0,o=r>0?s.grossRevenue/r:0;e.innerHTML=`
    ...
    `,Je("chart-monthly","bar","Receita Mensal",a.salesMonthly.labels,a.salesMonthly.data,mt[0]);const n=a.professionals.labels.map(l=>h(l));Je("chart-profs","doughnut","Total Vendas",n,a.professionals.data,mt),Je("chart-daily","line","Vendas Diárias",a.salesDaily.labels,a.salesDaily.data,mt[4]);const i=a.products.labels.map(l=>h(l));Je("chart-products","bar","Total Vendido",i,a.products.data,mt[1])}function qn(e){const t=R.appointmentsData,a=t.length;let s=0,r=0,o=0,n=0;const i={},l={};let d=new Date(R.startDate);const c=new Date(R.endDate);for(;d<=c;)i[d.toISOString().split("T")[0]]=0,d.setDate(d.getDate()+1);t.forEach(v=>{const b=parseFloat(v.totalAmount||v.price||0),x=(v.status||"").toLowerCase();let $=v.startTime?(v.startTime.toDate?v.startTime.toDate():new Date(v.startTime)).toISOString().split("T")[0]:"";const S=v.professionalName||"Sem Profissional";l[S]||(l[S]={name:S,count:0,value:0}),["cancelled","cancelado","no-show"].includes(x)?(r++,n+=b):(["completed","finalized","paid"].includes(x)&&s++,o+=b,$&&i.hasOwnProperty($)&&i[$]++,l[S].count++,l[S].value+=b)});const u=Object.keys(i).sort(),p=u.map(v=>i[v]),f=Object.values(l).sort((v,b)=>b.count-v.count);e.innerHTML=`
    ...
    `,Je("dailyApptChart","line","Agendamentos",u.map(v=>v.split("-").reverse().slice(0,2).join("/")),p,"#4f46e5")}function Rn(e){const{dreFinancial:t}=R.data,a=Object.entries(t.revenues).map(([r,o])=>`
    ...
    `}function Je(e,t,a,s,r,o){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");Xt[e]&&Xt[e].destroy();const l={type:t,data:{labels:s,datasets:[{label:a,data:r,backgroundColor:Array.isArray(o)?o:t==="line"?"rgba(79, 70, 229, 0.1)":o,borderColor:Array.isArray(o)?"#fff":o,borderWidth:2,fill:t==="line",tension:.3,borderRadius:t==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:o,pointHoverBackgroundColor:o}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let c=d.dataset.label||"";return c&&(c+=": "),d.parsed.y!==null?c+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):c+=d.raw,c}}}},scales:t==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};Xt[e]=new Chart(i,l)}const _t=(e,t="products")=>k(`/api/${t}/categories/${e}`),is=(e,t="products")=>k(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),ls=(e,t="products")=>k(`/api/${t}/categories/${e}`,{method:"DELETE"}),Fn="audit_logs",Fe=async(e,t,a,s,r,o=null)=>{try{if(!t)return;await Mo(ue(_,Fn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:r,details:o,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},fe=document.getElementById("content");let ne=null,Ye="services",xe="all";function je(){const e=U.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function jn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await is({establishmentId:m.establishmentId,name:s},"services"),Fe(m.establishmentId,je(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",g("Sucesso","Categoria criada!","success"),await Ba(),await dt()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Hn(e){if(await H("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await ls(e,"services"),Fe(m.establishmentId,je(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),g("Sucesso","Categoria apagada.","success"),await Ba(),await dt()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Ba(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"services");m.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[85vh] my-auto">
        <form id="serviceForm">
    ...
    </div>`,t.style.display="flex",t.addEventListener("click",async E=>{const L=E.target.closest("button[data-action]");if(!L)return;const N=L.dataset.action,j=L.dataset.id;if(N==="close-modal"&&(t.style.display="none"),N==="delete-service"){if(!j)return;if(t.style.display="none",await H("Apagar Serviço","Tem a certeza que deseja apagar este serviço?"))try{const B=m.services.find(q=>q.id===j)?.name||"Desconhecido";await cr(j),Fe(m.establishmentId,je(),"Serviços","Excluiu",`Excluiu o serviço: ${B}`),g("Sucesso","Serviço apagado com sucesso!","success"),await dt()}catch(B){g("Erro",`Não foi possível apagar o serviço: ${B.message}`,"error")}else t.style.display="flex"}});const d=t.querySelectorAll(".tab-btn"),c=t.querySelectorAll(".tab-content");d.forEach(E=>{E.addEventListener("click",()=>{d.forEach(L=>{L.classList.remove("border-indigo-500","text-indigo-600"),L.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),E.classList.add("border-indigo-500","text-indigo-600"),E.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),c.forEach(L=>L.classList.add("hidden")),document.getElementById(`tab-content-${E.dataset.tab}`).classList.remove("hidden")})});const u=t.querySelectorAll('input[name="commissionType"]'),p=document.getElementById("defaultCommissionRateContainer"),f=document.getElementById("professionalCommissionsContainer");function v(){const E=t.querySelector('input[name="commissionType"]:checked').value;p&&(p.style.display=E==="default"?"block":"none"),f&&(f.style.display=E==="custom"?"block":"none")}u.forEach(E=>E.addEventListener("change",v));const b=document.getElementById("professionalCommissionsList");b&&(b.innerHTML=(m.professionals||[]).map(E=>{const L=e?.professionalCommissions?.[E.id]!==void 0,N=e?.professionalCommissions?.[E.id]||0;return`
            ...
            `}).join(""),b.querySelectorAll('input[type="checkbox"]').forEach(E=>{E.addEventListener("change",L=>{const N=L.target.closest(".professional-commission-row");N.querySelector('input[type="number"]').disabled=!L.target.checked,N.classList.toggle("bg-blue-50",L.target.checked)})})),v();const x=t.querySelector("#serviceForm"),$=t.querySelector("#servicePhotoInput"),S=t.querySelector("#servicePhotoPreview"),w=t.querySelector("#servicePhotoBase64");t.querySelector("#servicePhotoButton").addEventListener("click",()=>$.click()),$.onchange=async()=>{const E=$.files[0];if(E){S.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const L=await Yo(E,800,800,.8),j=L.length*3/4,T=1e3*1024;if(j>T)throw new Error("A imagem é muito grande mesmo após a compressão.");S.src=L,w.value=L}catch(L){console.error("Erro ao processar imagem:",L),g("Erro de Imagem",L.message||"Não foi possível processar a imagem.","error"),S.src=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",w.value=e?.photo||"",$.value=""}}},x.addEventListener("submit",zn)}function Te(){const e=document.getElementById("servicesList");if(!e)return;const t=document.getElementById("serviceSearchInput")?.value.toLowerCase()||"",a=document.getElementById("serviceCategoryFilter")?.value||"all",s=new Map((m.serviceCategories||[]).map(o=>[o.id,o.name]));let r=(m.services||[]).filter(Boolean);if(xe!=="all"){const o=xe==="active";r=r.filter(n=>n.active!==!1===o)}r=r.filter(o=>{const n=o.name.toLowerCase().includes(t),i=a==="all"||o.categoryId===a;return n&&i}),e.innerHTML="",r.length>0?r.forEach(o=>{const n=document.createElement("div"),i=JSON.stringify(o).replace(/'/g,"&apos;");n.className=`service-card bg-white rounded-lg shadow-md flex overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-lg hover:bg-gray-50 ${o.active!==!1?"opacity-100":"opacity-50 bg-gray-100"} sm:flex-col`,n.dataset.action="edit-service",n.dataset.service=i;const l=h(o.name),d=h(s.get(o.categoryId)||"N/A"),c=o.photo||`https://placehold.co/200x200/E2E8F0/4A5568?text=${encodeURIComponent(o.name.charAt(0))}`;n.innerHTML=`
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),Da(),Te()}function Un(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function dt(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,r]=await Promise.all([Se(m.establishmentId),Z(m.establishmentId),_t(m.establishmentId,"services"),mr(m.establishmentId)]);m.services=(t||[]).filter(Boolean),m.professionals=(a||[]).filter(Boolean),m.serviceCategories=(s||[]).filter(Boolean),m.mostPopularService=r||{name:"N/A",count:0},m.services.forEach(o=>{o.active===void 0&&(o.active=!0)}),ds(Ye)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),g("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function ds(e){if(document.getElementById("services-content-container")){if(Ye===e&&document.getElementById("services-content-container").children.length>1){Ye==="services"&&(Da(),Te());return}Ye=e,xe="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?Vn():e==="reports"&&Un()}}function _n(){ne&&(fe.removeEventListener("click",ne),fe.removeEventListener("input",ne),fe.removeEventListener("change",ne)),ne=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),o=r.dataset.id,n=r.checked;try{await ur(o,n);const i=m.services.findIndex(l=>l.id===o);i>-1&&(m.services[i].active=n),Fe(m.establishmentId,je(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${o}) para ${n?"Ativo":"Inativo"}`),Te(),Da()}catch(i){g("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Te()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Te();return}if(!a)return;if(a.hasAttribute("data-view")){ds(a.dataset.view);return}switch(a.dataset.action){case"new-service":lo();break;case"edit-service":const r=JSON.parse(a.dataset.service);lo(r);break;case"manage-categories":On();break;case"filter-service":const o=a.dataset.filterType;if(o==="popular")return;xe=o==="total"?"all":o,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===xe||i==="total"&&xe==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Te();break}},fe.addEventListener("click",ne),fe.addEventListener("input",ne),fe.addEventListener("change",ne)}async function Jn(){fe.innerHTML=`
        ...
        </section>`,_n();try{(!m.professionals||m.professionals.length===0)&&(m.professionals=await Z(m.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),g("Erro","Não foi possível carregar a lista de profissionais.","error"),m.professionals=[]}Ye="services",xe="all",await dt()}const Jt="suppliers",Ma="purchases",cs="financial_payables",Aa=async e=>{try{const t=Ft(ue(_,Jt),at("establishmentId","==",e)),a=await ka(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},Wn=async e=>{try{return{id:(await Mo(ue(_,Jt),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},Gn=async(e,t)=>{try{const a=ce(_,Jt,e);return await wa(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},Yn=async e=>{try{const t=ce(_,Jt,e);return await Fs(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},Qn=async(e,t=null)=>{try{const a=No(_),s=ce(ue(_,Ma)),r={...e,createdAt:Va()};if(a.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const o=ce(ue(_,cs)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:Va()};a.set(o,i)}return await a.commit(),{id:s.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},Xn=async(e,t)=>{try{const a=No(_),s=ce(_,Ma,e);a.delete(s);const r=Ft(ue(_,cs),at("purchaseId","==",e),at("establishmentId","==",t));return(await ka(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},Zn=async e=>{try{const t=Ft(ue(_,Ma),at("establishmentId","==",e),Ao("createdAt","desc")),a=await ka(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},pe=document.getElementById("content");let ie=null,Qe="products",oe="all";async function Kn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await is({establishmentId:m.establishmentId,name:s},"products"),a.value="",g("Sucesso","Categoria de produto criada!","success"),await Na(),await ct()}catch(r){g("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function ei(e){if(await H("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await ls(e,"products"),g("Sucesso","Categoria de produto apagada.","success"),await Na(),await ct()}catch{g("Erro","Não foi possível apagar a categoria.","error")}}async function Na(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await _t(m.establishmentId,"products");m.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${h(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
    ...
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const v=t.querySelector("#productCategory"),b=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>b.click()),v.innerHTML='<option value="">Sem categoria</option>'+(m.categories||[]).map(T=>`<option value="${T.id}" ${e?.categoryId===T.id?"selected":""}>${h(T.name)}</option>`).join(""),e&&(v.value=e.categoryId||"");const x=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const $=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",S=e?.photo||"";b.onchange=async()=>{const T=b.files[0];if(T){x.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const B=await co(T,800,800,"image/jpeg",.8),F=B.length*3/4,z=1e3*1024;if(F>z)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=B,base64Input.value=B}catch(B){console.error("Erro ao processar imagem:",B),g("Erro de Imagem",B.message||"Não foi possível processar a imagem.","error"),preview.src=$,base64Input.value=S,j.value=""}}};const w=t.cloneNode(!0);t.parentNode.replaceChild(w,t);const E=()=>{const T=w.querySelector("#modalSupplierSearch"),B=w.querySelector("#supplierSearchResults"),q=w.querySelector("#selectedSuppliersList"),F=T.value.toLowerCase();if(F.length>0){const z=s.filter(A=>A.name.toLowerCase().includes(F)&&!o.has(A.id));z.length>0?(B.classList.remove("hidden"),B.innerHTML=z.map(A=>`
                ...
                `).join("")):(B.classList.remove("hidden"),B.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else B.classList.add("hidden");o.size>0?(q.innerHTML="",o.forEach(z=>{const A=s.find(Q=>Q.id===z);A&&(q.innerHTML+=`
                    ...
                    `)})):q.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};w.querySelector("#modalSupplierSearch").addEventListener("input",E),w.addEventListener("click",T=>{const B=T.target.closest("[data-add-supplier]");if(B){const F=B.dataset.addSupplier;o.add(F),w.querySelector("#modalSupplierSearch").value="",E()}const q=T.target.closest("[data-remove-supplier]");if(q){const F=q.dataset.removeSupplier;o.delete(F),E()}}),E(),w.addEventListener("click",async T=>{const B=T.target.closest("button[data-action]");if(!B)return;const q=B.dataset.action,F=w.querySelector("#productId").value;if(q==="close-modal"&&(w.style.display="none"),q==="delete-product"){if(!F)return;w.style.display="none",await ai(F)}if(q==="save-product-modal"){const z=w.querySelector("#productForm");if(z){if(!z.querySelector("#productName").value||!z.querySelector("#productPrice").value){g("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const A=B.closest('button[data-action="save-product-modal"]');A.disabled=!0,A.textContent="A salvar...";try{await oi(z)}catch(Q){g("Erro",`Falha ao salvar: ${Q.message}`,"error"),A.disabled=!1,A.textContent="Salvar Alterações"}}}if(q==="adjust-stock-modal"){T.preventDefault();const z=w.querySelector("#stockAdjustmentAmount"),A=w.querySelector("#stockAdjustmentReason"),Q=parseInt(z.value,10),$e=parseInt(B.dataset.change,10);if(!Q||Q<=0){g("Erro","Por favor, insira uma quantidade válida.","error");return}const Yt=Q*$e,Ts=A.value||(Yt>0?"Entrada manual":"Saída manual");try{await br(F,{change:Yt,reason:Ts});const Oe=m.products.findIndex(ze=>ze.id===F);if(Oe>-1){const ze=m.products[Oe].currentStock+Yt;m.products[Oe].currentStock=ze,w.querySelector("#currentStockDisplay").textContent=ze,w.querySelector("#productCurrentStock").value=ze,z.value="",A.value="",g("Sucesso","Estoque atualizado!","success"),qa(),st()}}catch(Oe){g("Erro de Stock",Oe.message,"error")}}});const L=w.querySelectorAll(".tab-btn"),N=w.querySelectorAll(".tab-content");L.forEach(T=>{T.addEventListener("click",B=>{B.preventDefault(),L.forEach(q=>{q.classList.remove("border-indigo-500","text-indigo-600"),q.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),T.classList.add("border-indigo-500","text-indigo-600"),T.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),N.forEach(q=>q.classList.add("hidden")),document.getElementById(`tab-content-${T.dataset.tab}`).classList.remove("hidden")})});const j=w.querySelector("#productPhotoInput");w.querySelector("#productPhotoButton").addEventListener("click",()=>j.click()),j.onchange=async()=>{const T=j.files[0];if(!T)return;const B=w.querySelector("#productPhotoPreview"),q=w.querySelector("#productPhotoBase64");B.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const F=await co(T,800,800,"image/jpeg",.8),A=F.length*3/4,Q=1e3*1024;if(A>Q)throw new Error("A imagem é muito grande mesmo após a compressão.");B.src=F,q.value=F}catch(F){console.error("Erro ao processar imagem:",F),g("Erro de Imagem",F.message||"Não foi possível processar a imagem.","error"),B.src=$,q.value=S,j.value=""}},w.style.display="flex"}function si(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(m.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${h(a.name)}</option>`)),qa(),st()}function ri(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        ...
        </div>`;const r=document.getElementById("productFilterReport"),o=document.getElementById("categoryFilterReport");r&&m.products&&(r.innerHTML+=m.products.map(n=>`<option value="${n.id}">${h(n.name)}</option>`).join("")),o&&m.categories&&(o.innerHTML+=m.categories.map(n=>`<option value="${n.id}">${h(n.name)}</option>`).join(""))}async function ni(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:m.establishmentId};try{const a=await fr(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
    ...
    `;a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=h(o.name),l=h(o.taxId||"Sem doc."),d=h(o.email||"-"),c=h(o.phone||"-"),u=h(o.category||"Geral");r+=`
            <tr class="hover:bg-gray-50">
    ...
    `;Y({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Xe(){const e=document.getElementById("purchasesContainer");if(e)if(O.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([Ht(m.establishmentId),Aa(m.establishmentId)]);O.allSuppliers=a||[];const s=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(O.productsToBuy=s,s.length===0){e.innerHTML=`
                ...
                `;return}let r='<div class="flex flex-col gap-3 md:hidden">',o="";s.forEach(d=>{const c=parseInt(d.minStock)||0,u=parseInt(d.currentStock)||0,p=Math.max(c-u,1),f=parseFloat(d.costPrice||0),v=h(d.name);let b='<option value="">Selecione...</option>';O.allSuppliers.length>0?O.allSuppliers.forEach(x=>{const S=d.supplierIds&&d.supplierIds.includes(x.id)?"selected":"";b+=`<option value="${x.id}" ${S}>${h(x.name)}</option>`}):b='<option value="">Sem fornecedores</option>',r+=`
        ...
        `}).join("");s+=v;const x=encodeURIComponent(JSON.stringify({supplierId:p,supplierName:f.info.name,totalAmount:v,items:f.items})),$=encodeURIComponent(JSON.stringify({name:f.info.name,phone:f.info.phone,email:f.info.email})),S=encodeURIComponent(JSON.stringify(f.items)),w=h(f.info.name),E=h(f.info.email||"");a+=`
    ...
    `,le&&(ge.removeEventListener("click",le),ge.removeEventListener("input",le),ge.removeEventListener("change",le)),le=e=>{if(e.target.closest("#tab-btn-list")&&pt("list"),e.target.closest("#tab-btn-purchases")&&pt("purchases"),e.target.closest("#tab-btn-history")&&pt("history"),e.target.id==="toggle-quote-mode"&&(O.isQuoteMode=e.target.checked,Xe()),e.target.id==="supplierSearchInput"&&Wt(),e.target.closest("#btn-new-supplier")&&mo(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),s=JSON.parse(a.dataset.supplier);mi(s)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&ci(t.dataset.id),a==="edit"&&mo(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&ba(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=a),ba()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),s={};let r=!1;if(a.forEach(o=>{if(o.offsetParent===null||!o.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=o.querySelector("td:nth-child(2)"),d=o.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(o.querySelector(".qty-input").value),u=parseFloat(o.dataset.cost),f=o.querySelector(".supplier-select").value;if(f){if(!s[f]){const v=O.allSuppliers.find(b=>b.id===f);s[f]={info:v,items:[]}}s[f].items.push({name:i,qty:c,cost:u})}}),!r){g("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}O.finalOrders=s,O.step=2,Xe()}if(e.target.closest("#btn-back-step1")&&(O.step=1,Xe()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),o=parseFloat(a.dataset.total),n=O.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else g("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=m.establishmentId,a.disabled=!0,a.textContent="A processar...",ke(m.establishmentId).then(r=>{const o=r.purchaseConfig||null;return Qn(s,o)}).then(()=>{g("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',g("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;H("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await Xn(s,m.establishmentId),g("Sucesso","Compra e financeiro excluídos.","success"),ms()}catch(o){g("Erro","Erro ao excluir: "+o.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=O.finalOrders[s];r?bi(r,O.isQuoteMode):g("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);gi(s)}},ge.addEventListener("click",le),ge.addEventListener("input",le),ge.addEventListener("change",le),pt("list")}function pt(e){Et=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),li()}const Zt=document.getElementById("content"),po={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let re=new Set,gt=null,Pe=null;function vi(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",yi(a,r),wi(a),ki(a,o),$i(a)}function yi(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(x,$)=>{const S=$+1,w=S==s[1]?"selected":"",E=new Date(0,$).toLocaleString("pt-BR",{month:"long"});return`<option value="${S}" ${w}>${E.charAt(0).toUpperCase()+E.slice(1)}</option>`}).join(""),o=e.status||"active",n=h(e.name||""),i=h(e.specialty||""),l=h(e.phone||""),d=h(e.notes||"");a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${d}</textarea></div>`;const c=document.getElementById("profPhotoInput"),u=document.getElementById("profPhotoButton"),p=document.getElementById("profPhotoPreview"),f=document.getElementById("profPhotoBase64"),v=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,b=e.photo||"";u&&u.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const x=c.files[0];if(x){p.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const $=await Yo(x,800,800,.8),w=$.length*3/4,E=1e3*1024;if(w>E)throw new Error("A imagem é muito grande mesmo após a compressão.");p.src=$,f.value=$}catch($){g("Erro de Imagem",$.message||"Não foi possível processar a imagem.","error"),p.src=v,f.value=b,c.value=""}}})}function wi(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',Si(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function ki(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        </div>`;const s=document.getElementById("batchBlockageForm");s&&s.addEventListener("submit",async o=>{o.preventDefault();const n=Array.from(o.target.querySelectorAll('input[name="batch-professionals"]:checked')).map(f=>f.value);if(n.length===0)return g("Atenção","Selecione pelo menos um profissional.","error");const i=o.target.batchBlockageStartDate.value,l=o.target.batchBlockageEndDate.value||i,d=o.target.batchBlockageStartTime.value,c=o.target.batchBlockageEndTime.value,u=o.target.batchBlockageReason.value;if(!i||!d||!c)return g("Atenção","Preencha Data de Início, Início e Fim.","error");const p=n.map(f=>{const v={professionalId:f,establishmentId:m.establishmentId,startTime:new Date(`${i}T${d}`).toISOString(),endTime:new Date(`${l}T${c}`).toISOString(),reason:u};return zt(v)});try{await Promise.all(p),g("Sucesso!",`${n.length} bloqueios foram criados.`);const f=document.getElementById("prof-blockages-filter").value;Ze(e.id,f)}catch(f){g("Erro",f.message,"error")}}),document.getElementById("prof-blockages-filter").addEventListener("change",o=>Ze(e.id,o.target.value)),await Ze(e.id,"future")}function Si(e,t){e.innerHTML=Object.keys(po).map(a=>{const s=t[a]||{},r=s.active!==!1;return`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500">${s.message}</p>`}}}function $i(e){const t=document.getElementById("genericModal");Pe&&t.removeEventListener("click",Pe),Pe=async a=>{const s=a.target.closest("button[data-action]");if(!s){const o=a.target.closest(".tab-link");o&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),o.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(o.dataset.tab).classList.remove("hidden"));return}const r=s.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Kt();break;case"delete-professional":const o=s.dataset.id;if(await H("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await jo(o),g("Sucesso!","Profissional excluído.","success"),Kt(),Bt()}catch(b){g("Erro",`Não foi possível excluir: ${b.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(b=>b.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(b=>{const x=b.querySelector('[data-field="active"]').dataset.day;u[x]={active:b.querySelector('[data-field="active"]').checked,start:b.querySelector('[data-field="start"]').value,end:b.querySelector('[data-field="end"]').value,breakStart:b.querySelector('[data-field="breakStart"]').value,breakEnd:b.querySelector('[data-field="breakEnd"]').value}});const p={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:m.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{p.id?(await Lt(p.id,p),g("Sucesso!","Profissional atualizado.","success")):(delete p.id,await Fo(p),g("Sucesso!","Profissional criado.","success")),Kt(),Bt()}catch(b){g("Erro",b.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const f=s.dataset.id;if(await H("Apagar Bloqueio","Tem certeza?"))try{await Ia(f),g("Bloqueio removido.","success");const b=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ze(e.id,b)}catch(b){g("Erro",b.message,"error")}break;case"batch-delete-blockage":const v=JSON.parse(s.dataset.ids);if(await H("Apagar em Lote",`Tem certeza que deseja apagar ${v.length} bloqueios com este motivo?`))try{await Wo(v),g("Bloqueios removidos.","success");const b=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Ze(e.id,b)}catch(b){g("Erro",b.message,"error")}break}},t.addEventListener("click",Pe)}function fa(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(re.size>0?(t.textContent=`${re.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function Ei(){H("Excluir em Lote",`Tem certeza que deseja excluir ${re.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await lr(Array.from(re)),g("Sucesso!",`${re.size} profissionais foram excluídos.`,"success"),re.clear(),fa(),Bt()}catch(t){g("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Ve(){const e=document.getElementById("professionalsList");if(!e)return;if(!m.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=vi();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),s=m.professionals.filter(r=>{const o=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return o&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=hi(s)}async function Bt(){re.clear(),Zt.innerHTML=`
    ...
    `)(e||{}),maxWidth:"max-w-3xl"}),window.switchTab=s=>It(s,t),window.handleSave=Bi,window.handleDelete=Di,window.loadMoreHistory=()=>{P.historyLimit+=10,It("history",t)},!t&&e.id)try{if(typeof da=="function"){const s=await da(m.establishmentId,e.id);if(s){P.currentClient=s;const r=document.querySelector(".bg-indigo-100.text-indigo-700");r&&(r.textContent=`${s.loyaltyPoints||0} pts`)}}P.history=await qr(m.establishmentId,e.phone)}catch(s){console.error("Aviso: Não foi possível atualizar detalhes do cliente",s),P.history=[]}It("details",t)},It=(e,t)=>{const a=document.getElementById("modal-body");if(!a)return;document.querySelectorAll('[id^="tab-btn-"]').forEach(o=>{o.classList.remove("border-indigo-600","text-indigo-600"),o.classList.add("border-transparent","text-gray-500")});const s=document.getElementById(`tab-btn-${e}`);s&&(s.classList.add("border-indigo-600","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"));const r=P.currentClient||{};if(e==="details"){if(a.innerHTML=`
            ...
            <div class="space-y-2">
                ${l.map(d=>{const c=d.costPoints||d.points||0,u=n>=c,p=d.reward||d.name;return`
                        <div class="flex justify-between items-center p-3 border rounded ${u?"bg-green-50 border-green-200":"bg-gray-50 opacity-70"}">
                            ...
                            <button onclick="window.handleRedeem('${c}', '${h(p)}')" ${u?"":"disabled"} 
        ...
        `,window.handleRedeem=async(d,c)=>{if(await H("Resgatar",`Trocar ${d} pontos por "${c}"?`))try{await Rr(m.establishmentId,r.phone,d,c),g("Sucesso","Resgate realizado!","success"),r.loyaltyPoints=(r.loyaltyPoints||0)-parseInt(d),P.history.unshift({type:"loyalty",description:`Resgate: ${c}`,date:new Date().toISOString(),value:-d,isPoints:!0,status:"completed"}),It("loyalty",!1),me()}catch(u){g("Erro",u.message||"Erro ao resgatar","error")}}}},Bi=async()=>{const e=document.getElementById("form-client"),t=new FormData(e),a=t.get("phone").replace(/\D/g,"");if(a.length<10){g("Erro","Telefone inválido","error");return}const s={name:t.get("name"),phone:a,email:t.get("email"),birthDate:t.get("birthDate"),notes:t.get("notes"),establishmentId:m.establishmentId};try{await Nr(s),g("Sucesso","Cliente salvo!","success"),document.getElementById("genericModal").style.display="none",me()}catch(r){g("Erro","Erro ao salvar cliente","error"),console.error(r)}},Di=async()=>{if(await H("Excluir","Tem certeza? Isso apagará o histórico deste cliente."))try{const e=P.currentClient.id||ps(P.currentClient.phone);await Go(e),g("Sucesso","Cliente removido","success"),document.getElementById("genericModal").style.display="none",setTimeout(()=>me(),500)}catch(e){g("Erro","Erro ao remover","error"),console.error(e)}},vs=()=>{const e=document.getElementById("clients-grid");if(e){if(e.innerHTML="",P.clients.length===0){e.innerHTML=`
    ...
    `,t.querySelector("#loyaltyEnabled").checked=a.enabled||!1;const n=t.querySelectorAll('input[name="loyaltyType"]'),i=t.querySelector("#loyalty-config-amount"),l=t.querySelector("#loyalty-config-visit");n.forEach(u=>{u.addEventListener("change",p=>{const f=p.target.value;n.forEach(v=>{const b=v.closest("label");v.checked?b.classList.add("border-indigo-500","bg-indigo-50","ring-1","ring-indigo-500"):b.classList.remove("border-indigo-500","bg-indigo-50","ring-1","ring-indigo-500")}),f==="amount"?(i.classList.remove("hidden"),l.classList.add("hidden")):(i.classList.add("hidden"),l.classList.remove("hidden"))})});const d=t.querySelector("#loyaltyTiersContainer"),c=(u={})=>{const p=document.createElement("div"),f=h(u.reward||"");return p.className="loyalty-tier-row group bg-white md:bg-transparent p-3 md:p-0 border md:border-0 rounded-lg shadow-sm md:shadow-none relative",p.innerHTML=`
    ...
    `,ve.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),Es()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":Xi(W,a);break;case"change-password":Zi(W,a);break;case"change-email":Ki(W,a);break;case"branding":el(W,a);break;case"booking":tl(W,a);break;case"working-hours":al(W,a);break;case"loyalty":ol(W,a);break;case"financial":await sl(W,a);break;case"support":rl(W,a);break;case"cancellation":nl(W,a);break;default:il(t?t.label:"Definições",a)}}async function Es(){if(ve.innerHTML=`
    ...
    `,!W)try{W=await ke(m.establishmentId)}catch{g("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),ve.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const e=U.currentUser;e&&e.displayName&&(m.userName=e.displayName);const t=h(m.userName||U.currentUser.email);let s=`https://placehold.co/96x96/E2E8F0/4A5568?text=${t?t.charAt(0).toUpperCase():"U"}`;e&&e.photoURL&&(s=e.photoURL),ve.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
        ...
        <div data-action="go-to-my-profile" class="bg-white p-4 rounded-lg shadow-md mb-6 cursor-pointer hover:bg-gray-50 transition-all">
            <div class="text-center relative">
                ...
                <div class="absolute top-0 right-0 p-2 text-gray-400 hover:text-indigo-600" title="Ver Meu Perfil">
                 ...
                 ${m.userName&&m.userName!==U.currentUser.email?`<p class="text-sm text-gray-500">${h(U.currentUser.email)}</p>`:""}
    ...
    `,ve.querySelector("#settings-menu-list").addEventListener("click",o=>{const n=o.target.closest("button[data-section]");n&&(o.preventDefault(),dl(n.dataset.section))});const r=ve.querySelector('[data-action="go-to-my-profile"]');r&&r.addEventListener("click",o=>{o.preventDefault(),ae("my-profile-section")})}const Ke=document.getElementById("content");async function Me(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await Ot(m.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let p=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                                <h4 class="font-bold text-gray-700">${h(l)} (${d.length})</h4>`;if(d.length>1){const f=JSON.stringify(d.map(v=>v.id));p+=`<button data-action="batch-delete-blockage" data-ids='${f}' class="text-xs text-red-600 hover:text-red-800 font-semibold flex items-center gap-1">
                                    Apagar Lote
                                </button>`}p+="</div>",c.innerHTML=p,d.forEach(f=>{const v=new Date(f.startTime),b=new Date(f.endTime),x=v.toLocaleDateString("pt-BR"),$=b.toLocaleDateString("pt-BR"),w=`
                    <div class="bg-white p-3 rounded-md flex items-center justify-between shadow-sm">
                        <div>
                            <p class="font-medium text-gray-800 text-sm">
                                ${x===$?`${x} | ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`:`De ${x} às ${v.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}<br>Até ${$} às ${b.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`}
                            </p>
                        </div>
        ...
        </section>`,ml(t),await Me(t);const r=document.getElementById("batchProfSelectionContainer");try{const o=await Z(m.establishmentId);r.innerHTML=o.map(n=>`
            <div class="flex items-center">
    ...
    `}).join("")}function Ct(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=m.users:t=m.users.filter(a=>a.status==="active"),kl(t)}function Sl(e={}){return Object.entries(yl).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,o=Object.entries(wl).map(([i,l])=>`
    ...
    `;const p=window.innerWidth<768,f=u.querySelector(".bg-white");if(p&&f){f.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const $=u.closest("section");$&&($.style.padding="0",$.style.margin="0"),f.classList.add("p-4")}const v=u.querySelector("#userProfessionalId"),b=u.querySelector("#userPhotoPreview"),x=u.querySelector("#profPhotoName");if(v.addEventListener("change",$=>{const S=$.target.value,w=s(S),E=w?w.name:"Selecione um profissional",L=r(S,n);b.src=L.photoSrc,x.textContent=E,u.querySelector("#professionalPhotoUrl").value=L.photoUrl}),u.addEventListener("submit",async $=>{$.preventDefault();const S=e?.email,w=u.querySelector("#userEmail").value,E={};u.querySelectorAll('input[type="checkbox"]').forEach(j=>{const T=j.dataset.module,B=j.dataset.permission;E[T]||(E[T]={}),E[T][B]=j.checked});const L=u.querySelector("#userProfessionalId").value||null,N={name:u.querySelector("#userName").value,permissions:E,professionalId:L,establishmentId:m.establishmentId};try{c?(S!==w&&(N.email=w),await fl(e.id,N),g("Usuário atualizado com sucesso!","success")):(N.email=u.querySelector("#userEmail").value,N.password=u.querySelector("#userPassword").value,await bl(N),g("Usuário criado com sucesso!","success")),Mt()}catch(j){g(`Erro: ${j.message}`,"error")}}),c){const $=u.querySelector("#password-change-container"),S=$.querySelector('[data-action="show-password-form"]'),w=$.querySelector("#password-form"),E=w.querySelector('[data-action="save-password"]'),L=w.querySelector('[data-action="cancel-password-change"]');S.addEventListener("click",()=>{S.classList.add("hidden"),w.classList.remove("hidden")}),L.addEventListener("click",()=>{S.classList.remove("hidden"),w.classList.add("hidden"),w.querySelector("#userNewPassword").value=""}),E.addEventListener("click",async()=>{const N=w.querySelector("#userNewPassword").value;if(!N||N.length<6){g("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await H("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{E.disabled=!0,E.textContent="Aguarde...",await hl(e.id,N),g("Sucesso!","A senha do usuário foi alterada.","success"),S.classList.remove("hidden"),w.classList.add("hidden"),w.querySelector("#userNewPassword").value=""}catch(T){g("Erro",`Não foi possível alterar a senha: ${T.message}`,"error")}finally{E.disabled=!1,E.textContent="Salvar Nova Senha"}})}}async function $l(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([gl(m.establishmentId),Z(m.establishmentId)]);m.users=t,m.professionals=a,Ct()}catch{g("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Mt(){be.innerHTML=`
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=ha.transactions[l];d&&vo(d)})}),n.innerHTML=a.map((i,l)=>{const d=h(i.client),c=h(i.items),u=h(i.type);return`
    ...
    `,e.style.display="flex";const r=e.querySelector("#generateCashFlowBtn");r&&(r.addEventListener("click",yo),yo())}function Dl(){const e=document.getElementById("genericModal"),t=D.payables.filter(u=>u.status==="pending").reduce((u,p)=>u+p.amount,0),a=D.receivables.filter(u=>u.status==="pending").reduce((u,p)=>u+p.amount,0),s=a-t,r=D.payables.filter(u=>u.status==="paid").reduce((u,p)=>u+p.amount,0),o=D.receivables.filter(u=>u.status==="paid").reduce((u,p)=>u+p.amount,0),n=o-r,i=D.previousBalance||0,l=i+n,d=u=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(u),c=u=>u>=0?"text-green-600":"text-red-600";e.innerHTML=`
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2 text-right">
                    ...
                    <div class="flex flex-col items-center gap-1">
                        <span class="text-xs font-semibold px-2 py-1 rounded-full ${v}">${b}</span>
                        <div class="flex">
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(f,v)=>{const b=v.querySelector("#originalPrice"),x=f.reduce(($,S)=>$+S.price*S.quantity,0);b&&(b.textContent=`R$ ${x.toFixed(2)}`)},p=f=>{f.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=f.map((v,b)=>{const x=v.type==="service",$=x?"Serviço":"Produto",S=x?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
                <div class="flex items-center justify-between bg-white p-2 rounded shadow-sm border border-gray-200">
                    <div class="flex items-center gap-3 min-w-0">
                        <input type="number" value="${v.quantity}" min="1" class="w-12 p-1 border rounded-md text-sm quantity-input flex-shrink-0" data-index="${b}">
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0">
                        ...
                        <button type="button" class="text-red-500 hover:text-red-700 remove-item-btn font-bold" data-index="${b}">&times;</button>
                    </div>
                </div>
            `}).join(""),u(f,t)};p(s),c.addEventListener("change",f=>{if(f.target.classList.contains("quantity-input")){const v=parseInt(f.target.dataset.index,10),b=parseInt(f.target.value,10);b>0&&s[v]&&(s[v].quantity=b,p(s))}}),c.addEventListener("click",f=>{if(f.target.classList.contains("remove-item-btn")){const v=parseInt(f.target.dataset.index,10);s.splice(v,1),p(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>sd(f=>{const v=s.find(b=>b.id===f.id&&b.type===f.type);v?v.quantity++:s.push({...f,quantity:1}),p(s)}),Be&&t.removeEventListener("click",Be),Be=async f=>{const v=f.target.closest("button[data-action]");if(!v)return;const b=v.dataset.action;if(f.stopPropagation(),b==="close-modal"&&Eo(),b==="save-package"){const x=v,$={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce((S,w)=>S+w.price*w.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:m.establishmentId};if(!$.name||!$.price){g("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if($.items.length===0){g("Erro","Adicione pelo menos um item ao pacote.","error");return}x.disabled=!0,x.textContent="A salvar...";try{a?await pn($.id,$):(delete $.id,await mn($)),g("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),Eo(),await Ha()}catch(S){g("Erro",`Não foi possível salvar o pacote: ${S.message}`,"error"),x.disabled=!1,x.textContent="Salvar Pacote"}}},t.addEventListener("click",Be)}function sd(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=we.catalogForModal.services.filter(v=>v.name.toLowerCase().includes(d)),u=we.catalogForModal.products.filter(v=>v.name.toLowerCase().includes(d)),p=c.map(v=>`
        ...
        `).join("")||'<p class="text-xs text-gray-400 text-center p-4">Nenhum serviço encontrado.</p>',f=u.map(v=>`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:p}=d.dataset,v=(we.catalogForModal[u+"s"]||[]).find(b=>b.id===p);v&&(e({...v,type:u}),i())}else(c||l.target===a)&&i()})}async function Ha(){oa.innerHTML=`
    ...
    `,await ld()}async function ld(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=m.userProfessionalId;if(t){const a=await ir(t);nd=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=h(a.name);e.innerHTML=`
