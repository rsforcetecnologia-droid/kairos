import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import{a as Y,d as U}from"./firebase-config-BCzB3QOS.js";import{EmailAuthProvider as os,reauthenticateWithCredential as ss,verifyBeforeUpdateEmail as rs,updatePassword as ns,updateProfile as is,onAuthStateChanged as ls,signOut as qa}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{addDoc as ko,collection as ue,query as Pt,where as et,getDocs as xa,orderBy as So,writeBatch as $o,doc as ke,serverTimestamp as Fa,deleteDoc as ds,updateDoc as Eo,getDoc as cs,onSnapshot as us}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";const p={establishmentId:null,establishmentName:null,userName:null,userProfessionalId:null,userPermissions:null,enabledModules:{agenda:!0,comandas:!0,relatorios:!0,commissions:!0,packages:!0,financial:!0,servicos:!0,produtos:!0,profissionais:!0,clientes:!0,users:!0,estabelecimento:!0},professionals:[],services:[],professionalColors:new Map,allEvents:[]};function ms(e,t,a){p.establishmentId=e,p.establishmentName=t,p.userPermissions=a}const ra="https://kairos-app-407358446276.us-central1.run.app";console.log("🚀 API configurada para Produção (US):",ra);async function ps(){const e=Y.currentUser;return e?{"Content-Type":"application/json",Authorization:`Bearer ${await e.getIdToken()}`}:(console.warn("Usuário não logado, tentando redirecionar para /login"),window.location.href="/login",null)}async function y(e,t={}){const a=await ps();if(!a)throw new Error("Utilizador não autenticado. A requisição foi cancelada.");const s=ra.replace(/\/$/,""),r=e.startsWith("/")?e:`/${e}`,o=`${s}${r}`;console.log(`AuthenticatedFetch: ${t.method||"GET"} ${o}`);try{const n=await fetch(o,{...t,headers:{...a,...t.headers}});if(!n.ok){const l=(await n.json().catch(()=>({message:n.statusText}))).message||`Erro na API: ${n.status}`;if(l.includes("FAILED_PRECONDITION")&&l.includes("requires an index")){const d=/(https:\/\/[^\s]+)/,c=l.match(d),u=c?c[0]:"URL não encontrada na mensagem de erro.";console.warn(`%c AVISO IMPORTANTE (FIREBASE): ÍNDICE NECESSÁRIO! %c
...
--------------------------------------------------------------------`,"background-color: #ffc; color: #663300; font-size: 14px; font-weight: bold; padding: 5px;","color: #663300; font-size: 12px;","color: #0000ff; font-size: 12px; font-weight: bold; text-decoration: underline;","color: #663300; font-size: 12px;")}throw console.error(`Erro na API (${n.status}) em ${o}:`,l),new Error(l)}return n.json()}catch(n){throw console.error(`Falha de rede ao tentar acessar ${o}:`,n.message),n.message.includes("Failed to fetch")||n.message.includes("NetworkError")?new Error(`Não foi possível conectar ao servidor em ${ra}. Verifique sua conexão com a internet.`):n}}const Io=(e,t,a,s=null)=>{let r=`/api/appointments/${e}?startDate=${t}&endDate=${a}`;return s&&(r+=`&professionalId=${s}`),y(r)},gs=(e,t,a)=>{const s=`/api/appointments/cancelled/${e}?startDate=${t}&endDate=${a}`;return y(s)},bs=({establishmentId:e,professionalId:t,serviceIds:a,date:s})=>{const r=`/api/availability?establishmentId=${e}&professionalId=${t}&serviceIds=${a.join(",")}&date=${s}`;return y(r)},fs=e=>y("/api/appointments",{method:"POST",body:JSON.stringify(e)}),ya=(e,t)=>y(`/api/appointments/${e}`,{method:"PUT",body:JSON.stringify(t)}),vs=e=>y(`/api/appointments/${e}`,{method:"DELETE"}),hs=e=>y(`/api/appointments/${e}/reopen`,{method:"POST"}),xs=(e,t)=>y(`/api/appointments/${e}/checkout`,{method:"POST",body:JSON.stringify(t)});let z;async function ys(){if(!z)try{z=new(window.AudioContext||window.webkitAudioContext)}catch(e){console.error("Não foi possível inicializar o áudio:",e)}}function ws(){if(!z){console.warn("AudioContext não inicializado. O som não será tocado.");return}z.state==="suspended"&&z.resume();const e=z.createOscillator(),t=z.createGain();e.connect(t),t.connect(z.destination),e.type="sine",e.frequency.setValueAtTime(800,z.currentTime),t.gain.setValueAtTime(0,z.currentTime),t.gain.linearRampToValueAtTime(.3,z.currentTime+.01),t.gain.exponentialRampToValueAtTime(1e-4,z.currentTime+.2),e.start(z.currentTime),e.stop(z.currentTime+.2)}function b(e,t,a="info",s=!1){const r=document.getElementById("toast-container");if(!r)return;s&&ws();const o=document.createElement("div"),n={success:"bg-green-50 border-green-400 text-green-700",error:"bg-red-50 border-red-400 text-red-700",info:"bg-blue-50 border-blue-400 text-blue-700"},i={success:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'},l={success:"bg-green-500",error:"bg-red-500",info:"bg-blue-500"};o.className=`toast ${n[a]||n.info}`,o.innerHTML=`
    ...
    `;const l=r.querySelector("[data-close-modal]");l&&(l.onclick=n);const d=r.querySelector('[data-action="close-modal"]');return d&&(d.onclick=n),r.addEventListener("click",c=>{c.target.closest(".modal-content")||n()}),r.style.display="flex",{modalElement:r,close:n,setContent:i}}function Mt(e){const t=document.getElementById(e);t&&(t.style.display="none")}function ks(){document.body.addEventListener("click",()=>{z||ys()},{once:!0}),document.addEventListener("click",e=>{const t=e.target.closest('[data-action="close-modal"]');if(t){const s=t.dataset.target;if(s){const r=document.getElementById(s);r&&(r.style.display="none")}}if(e.target.closest("[data-close-modal]")){const s=document.getElementById("genericModal");s&&(s.style.display="none")}})}async function Ra(){const e=document.getElementById("cancellationListContainer");if(!e)return;e.innerHTML='<div class="loader mx-auto"></div>';const t=document.getElementById("cancelStartDate").value,a=document.getElementById("cancelEndDate").value;try{const s=await gs(p.establishmentId,t,a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-500 py-4">Nenhum cancelamento encontrado para este período.</p>';return}e.innerHTML=s.map(r=>`
        ...
        `).join("")}catch(s){e.innerHTML=`<p class="text-red-500 text-center py-4">Erro ao carregar histórico: ${s.message}</p>`}}function Ss(){const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const s=`
    ...
    `,{modalElement:r}=J({title:"Histórico de Cancelamentos",contentHTML:s,maxWidth:"max-w-3xl"});r.querySelector("#searchCancellationsBtn").addEventListener("click",Ra),Ra()}const W=document.getElementById("sidebar"),ja=document.getElementById("sidebarToggle"),_e=document.getElementById("mainContent"),$s=document.querySelectorAll(".sidebar-link"),Ha=document.getElementById("hamburger-menu-btn"),Pe=document.getElementById("mobile-overlay");function yt(e){!W||!_e||(W.classList.toggle("collapsed",e),_e.classList.toggle("sidebar-collapsed-shift",e))}function Es(){!W||!Pe||(W.classList.add("mobile-open"),Pe.classList.add("visible"))}function dt(){!W||!Pe||(W.classList.remove("mobile-open"),Pe.classList.remove("visible"))}function Is(){yt(!W.classList.contains("collapsed"))}function Cs(e,t,a){if(!W||!_e)return;_e.classList.add("main-content-shift"),window.innerWidth>=768?yt(W.classList.contains("collapsed")):(_e.classList.remove("main-content-shift","sidebar-collapsed-shift"),dt()),ja&&ja.addEventListener("click",r=>{r.stopPropagation(),Is()}),W.addEventListener("mouseenter",()=>{window.innerWidth>=1024&&W.classList.contains("collapsed")&&yt(!1)}),W.addEventListener("mouseleave",()=>{window.innerWidth>=1024&&(document.querySelector("#sidebarToggle:hover")||yt(!0))}),Ha&&Ha.addEventListener("click",r=>{r.stopPropagation(),Es()}),Pe&&Pe.addEventListener("click",r=>{r.stopPropagation(),dt()});let s=0;W.addEventListener("touchstart",r=>{s=r.changedTouches[0].screenX},{passive:!0}),W.addEventListener("touchend",r=>{const o=r.changedTouches[0].screenX;s-o>50&&dt()},{passive:!0}),$s.forEach(r=>{const o=r.getAttribute("data-target"),n=o.replace("-section",""),i=a?.[n]!==!1,l=t===null||t[o]?.view===!0;if(!i||!l){r.style.display="none";return}r.style.display="flex",r.addEventListener("click",d=>{d.preventDefault(),o&&typeof e=="function"&&e(o),window.innerWidth<768&&dt()})})}const qe=e=>{const t=e||p.establishmentId;return t?y(`/api/establishments/${t}`):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Ls=(e,t)=>{const a=e||p.establishmentId;return a?y(`/api/establishments/${a}`,{method:"PUT",body:JSON.stringify(t)}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Ts=(e,t)=>{const a=e||p.establishmentId;return a?y(`/api/establishments/${a}/booking-status`,{method:"PATCH",body:JSON.stringify({publicBookingEnabled:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},Bs=(e,t)=>{const a=e||p.establishmentId;return a?y(`/api/establishments/${a}/owner-email`,{method:"PATCH",body:JSON.stringify({newEmail:t})}):Promise.reject(new Error("ID do estabelecimento não fornecido."))},X=e=>y(`/api/professionals/${e}`),Ds=e=>y(`/api/professionals/details/${e}`),Ps=e=>y("/api/professionals",{method:"POST",body:JSON.stringify(e)}),Ms=(e,t)=>y(`/api/professionals/${e}`,{method:"PUT",body:JSON.stringify(t)}),As=e=>y(`/api/professionals/${e}`,{method:"DELETE"});var Me;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Me||(Me={}));class _t extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const Ns=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},qs=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:Ns(e),o=()=>r()!=="web",n=u=>{const m=d.get(u);return!!(m?.platforms.has(r())||i(u))},i=u=>{var m;return(m=a.PluginHeaders)===null||m===void 0?void 0:m.find(g=>g.name===u)},l=u=>e.console.error(u),d=new Map,c=(u,m={})=>{const g=d.get(u);if(g)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),g.proxy;const f=r(),h=i(u);let w;const S=async()=>(!w&&f in m?w=typeof m[f]=="function"?w=await m[f]():w=m[f]:t!==null&&!w&&"web"in m&&(w=typeof m.web=="function"?w=await m.web():w=m.web),w),I=(L,T)=>{var A,q;if(h){const O=h?.methods.find(M=>T===M.name);if(O)return O.rtype==="promise"?M=>a.nativePromise(u,T.toString(),M):(M,_)=>a.nativeCallback(u,T.toString(),M,_);if(L)return(A=L[T])===null||A===void 0?void 0:A.bind(L)}else{if(L)return(q=L[T])===null||q===void 0?void 0:q.bind(L);throw new _t(`"${u}" plugin is not implemented on ${f}`,Me.Unimplemented)}},E=L=>{let T;const A=(...q)=>{const O=S().then(M=>{const _=I(M,L);if(_){const Se=_(...q);return T=Se?.remove,Se}else throw new _t(`"${u}.${L}()" is not implemented on ${f}`,Me.Unimplemented)});return L==="addListener"&&(O.remove=async()=>T()),O};return A.toString=()=>`${L.toString()}() { [capacitor code] }`,Object.defineProperty(A,"name",{value:L,writable:!1,configurable:!1}),A},k=E("addListener"),C=E("removeListener"),F=(L,T)=>{const A=k({eventName:L},T),q=async()=>{const M=await A;C({eventName:L,callbackId:M},T)},O=new Promise(M=>A.then(()=>M({remove:q})));return O.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await q()},O},H=new Proxy({},{get(L,T){switch(T){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return h?F:k;case"removeListener":return C;default:return E(T)}}});return s[u]=H,d.set(u,{name:u,proxy:H,platforms:new Set([...Object.keys(m),...h?[f]:[]])}),H};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=r,a.handleError=l,a.isNativePlatform=o,a.isPluginAvailable=n,a.registerPlugin=c,a.Exception=_t,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Fs=e=>e.Capacitor=qs(e),tt=Fs(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),wa=tt.registerPlugin;class Co{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const o=this.windowListeners[t];o&&!o.registered&&this.addWindowListener(o),s&&this.sendRetainedArgumentsForEvent(t);const n=async()=>this.removeListener(t,a);return Promise.resolve({remove:n})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let o=this.retainedEventArguments[t];o||(o=[]),o.push(a),this.retainedEventArguments[t]=o}return}r.forEach(o=>o(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new tt.Exception(t,Me.Unimplemented)}unavailable(t="not available"){return new tt.Exception(t,Me.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Oa=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),za=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Rs extends Co{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,o]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=za(r).trim(),o=za(o).trim(),a[r]=o}),a}async setCookie(t){try{const a=Oa(t.key),s=Oa(t.value),r=`; expires=${(t.expires||"").replace("expires=","")}`,o=(t.path||"/").replace("path=",""),n=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${o}; ${n};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}wa("CapacitorCookies",{web:()=>new Rs});const js=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),Hs=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,o,n)=>(r[o]=e[t[n]],r),{})},Os=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[o,n]=r;let i,l;return Array.isArray(n)?(l="",n.forEach(d=>{i=t?encodeURIComponent(d):d,l+=`${o}=${i}&`}),l.slice(0,-1)):(i=t?encodeURIComponent(n):n,l=`${o}=${i}`),`${s}&${l}`},"").substr(1):null,zs=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Hs(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const o=new URLSearchParams;for(const[n,i]of Object.entries(e.data||{}))o.set(n,i);a.body=o.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const o=new FormData;if(e.data instanceof FormData)e.data.forEach((i,l)=>{o.append(l,i)});else for(const i of Object.keys(e.data))o.append(i,e.data[i]);a.body=o;const n=new Headers(a.headers);n.delete("content-type"),a.headers=n}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Vs extends Co{async request(t){const a=zs(t,t.webFetchExtra),s=Os(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,o=await fetch(r,a),n=o.headers.get("content-type")||"";let{responseType:i="text"}=o.ok?t:{};n.includes("application/json")&&(i="json");let l,d;switch(i){case"arraybuffer":case"blob":d=await o.blob(),l=await js(d);break;case"json":l=await o.json();break;case"document":case"text":default:l=await o.text()}const c={};return o.headers.forEach((u,m)=>{c[m]=u}),{data:l,headers:c,status:o.status,url:o.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}wa("CapacitorHttp",{web:()=>new Vs});const ie=wa("PushNotifications",{}),Us=(e,t,a="all",s="all")=>{const r=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&r.append("professionalId",a),s&&s!=="all"&&r.append("costCenterId",s),y(`/api/reports/indicators?${r.toString()}`)},Js=e=>e?y(`/api/financial/cost-centers/${e}`):Promise.resolve([]),_s=({establishmentId:e,startDate:t,endDate:a,cashierSessionId:s})=>{const r=new URLSearchParams({startDate:t,endDate:a});return s&&s!=="all"&&r.append("cashierSessionId",s),e&&r.append("establishmentId",e),y(`/api/reports/sales?${r.toString()}`)},Ws=()=>y("/api/reports/summary",{method:"GET"}),Fe=e=>y(`/api/services/${e}`),Gs=e=>y("/api/services",{method:"POST",body:JSON.stringify(e)}),Ys=(e,t)=>y(`/api/services/${e}`,{method:"PUT",body:JSON.stringify(t)}),Qs=e=>y(`/api/services/${e}`,{method:"DELETE"}),Xs=(e,t)=>y(`/api/services/${e}/status`,{method:"PATCH",body:JSON.stringify({active:t})}),Zs=e=>y(`/api/services/stats/most-popular/${e}`),At=(e,t,a,s="all")=>{const r=`/api/blockages/${e}?startDate=${t}&endDate=${a}&professionalId=${s}`;return y(r)},Nt=e=>y("/api/blockages",{method:"POST",body:JSON.stringify(e)}),ka=e=>y(`/api/blockages/${e}`,{method:"DELETE"}),Lo=e=>y("/api/blockages/batch-delete",{method:"POST",body:JSON.stringify({ids:e})}),qt=e=>y(`/api/clients/${e}`),Sa=e=>y("/api/clients",{method:"POST",body:JSON.stringify(e)}),Ks=(e,t)=>y(`/api/clients/${e}`,{method:"PUT",body:JSON.stringify(t)}),er=e=>y(`/api/clients/${e}`,{method:"DELETE"}),Va=(e,t,a)=>{const s=`/api/clients/history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return y(s)},tr=(e,t,a)=>{const s=`/api/clients/loyalty-history/${e}?clientName=${encodeURIComponent(t)}&clientPhone=${encodeURIComponent(a)}`;return y(s)},ar=(e,t,a,s)=>y("/api/clients/redeem",{method:"POST",body:JSON.stringify({establishmentId:e,clientName:t,clientPhone:a,rewardData:s})});function v(e){return e==null?"":String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}const Ua=document.getElementById("content");let Ja=!1;const na=[{bg:"#e0e7ff",border:"#4f46e5",main:"#4f46e5"},{bg:"#d1fae5",border:"#059669",main:"#059669"},{bg:"#ffe4e6",border:"#e11d48",main:"#e11d48"},{bg:"#fef3c7",border:"#d97706",main:"#d97706"},{bg:"#cffafe",border:"#0e7490",main:"#0e7490"},{bg:"#e0f2fe",border:"#0284c7",main:"#0284c7"},{bg:"#ede9fe",border:"#7c3aed",main:"#7c3aed"},{bg:"#fce7f3",border:"#db2777",main:"#db2777"}];let nt=[],Ft=[],at={},se=[],D={currentView:"list",weekViewDays:7,currentDate:new Date,selectedProfessionalId:"all",profSearchTerm:"",showInactiveProfs:!1,scrollToAppointmentId:null},$={step:1,data:{id:null,clientName:"",clientPhone:"",selectedServiceIds:[],professionalId:null,professionalName:"",date:null,time:null,redeemedReward:null,clientHasRewards:!1,clientLoyaltyPoints:0}};function or(e){return new Intl.DateTimeFormat("pt-BR",{weekday:"short",day:"2-digit",month:"short"}).format(e).replace(/\./g,"")}function To(e){const t=new Date(e);if(t.setHours(0,0,0,0),D.currentView==="week"&&D.weekViewDays===7){const a=t.getDay(),s=t.getDate()-a+(a===0?-6:1);return new Date(t.setDate(s))}return t}function Et(){const e=document.getElementById("profSelectorContainer"),t=D.profSearchTerm.toLowerCase();if(!e||!p.professionals)return;let a=p.professionals.filter(o=>D.showInactiveProfs||o.status!=="inactive");t&&(a=a.filter(o=>o.name.toLowerCase().includes(t)));const r=[...[{id:"all",name:"Todos",photo:null,status:"active"}],...a];e.innerHTML=r.map(o=>{const n=D.selectedProfessionalId===o.id,i=o.name==="Todos"?"Todos":o.name.split(" ")[0],l=o.name==="Todos"?"T":o.name.charAt(0).toUpperCase(),d=o.status!=="inactive",c=v(i),u=na[0],m=o.id!=="all"&&p.professionalColors.get(o.id)||u,g=o.photo||`https://placehold.co/64x64/${m.main?.replace("#","")||"E0E7FF"}/${m.light?.replace("#","")||"4F46E5"}?text=${l}`,f=o.id==="all"?"#e0e7ff":m.light,h=o.id==="all"?"#4f46e5":m.main,S=`border: 3px solid ${n?m.border:"transparent"}; box-shadow: ${n?"0 0 0 2px "+m.border:"none"};`;return`
        ...
        `}).join("")}function sr(e,t,a,s,r){const o=(e||"").replace(/\D/g,""),n=new Date(r).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}),i=new Date(r).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=`Olá, ${t}! Você tem um agendamento de ${a} com o(a) profissional ${s} para o dia ${n} às ${i}. Podemos confirmar? Agradecemos a preferência!`,d=encodeURIComponent(l);return`https://wa.me/${o}?text=${d}`}function rr(e){const t=document.getElementById("agenda-view");if(!t)return;if(e.sort((s,r)=>new Date(s.startTime)-new Date(r.startTime)),e.length===0){t.innerHTML='<div class="text-center p-10 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg><h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum agendamento ou bloqueio</h3><p class="mt-1 text-sm text-gray-500">Não há eventos para o dia e filtros selecionados.</p></div>';return}const a=e.map(s=>{const r=new Date(s.startTime),o=new Date(s.endTime),n=r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),i=o.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),l=p.professionalColors.get(s.professionalId)||{},d=v(s.reason),c=v(s.professionalName),u=v(s.clientName),m=v(s.serviceName);if(s.type==="blockage")return`
                ...
                </div>`;const g=s.status==="completed",f=g?"bg-green-100 text-green-800":"bg-yellow-100 text-yellow-800",h=g?"Finalizado":"Aberto",w=JSON.stringify(s).replace(/'/g,"&apos;"),S=s.redeemedReward?.points>0,I=s.hasRewards&&!S,E=sr(s.clientPhone,s.clientName,s.serviceName,s.professionalName,s.startTime);return`
            <div class="appointment-list-card" data-appointment='${w}' style="border-left-color: ${l.border};">
                ...
                <div class="status-info">
                    ...
                    `;const k=JSON.stringify(m).replace(/'/g,"&apos;"),C=m.redeemedReward?.points>0,F=m.hasRewards&&!C,H=m.status==="completed";return`
        ...
        `}o+="</div>",t.innerHTML=o}function ir(){const e=p.allEvents.filter(t=>D.selectedProfessionalId==="all"||t.professionalId===D.selectedProfessionalId);D.currentView==="list"?rr(e):nr(e)}async function te(){const e=document.getElementById("agenda-view");if(!e)return;e.innerHTML='<div class="loader mx-auto my-10"></div>';let t,a;const s=document.getElementById("weekRange");if(s){if(D.currentView==="list")t=new Date(D.currentDate),t.setHours(0,0,0,0),a=new Date(D.currentDate),a.setHours(23,59,59,999),s.textContent=or(t);else{const r=$a();t=To(new Date(D.currentDate)),a=new Date(t),a.setDate(t.getDate()+(r-1)),a.setHours(23,59,59,999),s.textContent=`${t.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})} - ${a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"})}`}try{const r=await Io(p.establishmentId,t.toISOString(),a.toISOString(),D.selectedProfessionalId==="all"?null:D.selectedProfessionalId),o=await At(p.establishmentId,t.toISOString(),a.toISOString(),D.selectedProfessionalId);if(!document.getElementById("agenda-view"))return;const n=o.map(l=>{let d=l.professionalName;if(!d&&l.professionalId){const c=p.professionals?p.professionals.find(u=>u.id===l.professionalId):null;c&&(d=c.name)}return{...l,type:"blockage",professionalName:d||"Não identificado"}}),i=[...r.map(l=>({...l,type:"appointment"})),...n];if(p.allEvents=i,Et(),ir(),D.scrollToAppointmentId){const l=document.querySelector(`[data-appointment*='"id":"${D.scrollToAppointmentId}"']`);l&&(l.scrollIntoView({behavior:"smooth",block:"center"}),l.style.transition="background-color 0.5s ease-in-out",l.style.backgroundColor="#e0e7ff",setTimeout(()=>{l.style.backgroundColor=""},2500)),D.scrollToAppointmentId=null}}catch(r){document.getElementById("agenda-view")&&(document.getElementById("agenda-view").innerHTML='<div class="p-6 text-center text-red-600">Falha ao carregar dados.</div>',b("Erro na Agenda",`Não foi possível carregar a agenda: ${r.message}`,"error"))}}}async function lr(){try{const[e,t,a,s]=await Promise.all([p.professionals&&p.professionals.length>0?Promise.resolve(p.professionals):X(p.establishmentId),p.services&&p.services.length>0?Promise.resolve(p.services):Fe(p.establishmentId),se.length>0?Promise.resolve(se):qt(p.establishmentId),at.enabled!==void 0?Promise.resolve(null):qe(p.establishmentId)]);(!p.professionals||p.professionals.length===0)&&(p.professionals=e||[]),(!p.services||p.services.length===0)&&(p.services=t||[]),se.length===0&&(se=a||[]),s&&(at=s.loyaltyProgram||{enabled:!1}),p.professionals.forEach((r,o)=>{p.professionalColors.set(r.id,na[o%na.length])}),Et()}catch(e){console.error("Erro ao popular filtros e dependências do modal:",e),b("Atenção","Não foi possível pré-carregar os dados para agendamento. A abertura do modal pode ser lenta.","error")}}function ia(e){e<1||e>4||($.step=e,la(null,!0))}function Bo(e,t){const a=document.getElementById("multiServiceToggle"),s=a&&a.checked,r=t.classList.contains("selected"),o=$.data.selectedServiceIds.indexOf(e);if(r)t.classList.remove("selected","border-blue-500"),o>-1&&$.data.selectedServiceIds.splice(o,1);else{if(!s){$.data.selectedServiceIds=[];const n=document.getElementById("apptServicesContainer");n&&n.querySelectorAll(".service-card.selected").forEach(i=>{i.classList.remove("selected","border-blue-500")})}t.classList.add("selected","border-blue-500"),$.data.selectedServiceIds.push(e)}}function Do(e,t){const a=document.querySelector(".professional-step-cards");if(!a)return;a.querySelectorAll(".professional-modal-card").forEach(r=>r.classList.remove("selected","border-blue-500")),t.classList.add("selected","border-blue-500");const s=Ft.find(r=>r.id===e);$.data.professionalId=e,$.data.professionalName=s?s.name:"N/A"}function dr(e,t){const a=document.getElementById("availableTimesContainer");a&&(a.querySelectorAll(".time-slot-card").forEach(s=>s.classList.remove("selected")),t.classList.add("selected"),$.data.time=e)}async function _a(){const e=document.getElementById("apptTotalDuration"),t=document.getElementById("availableTimesContainer");if(!e||!t)return;const a=$.data.professionalId,s=$.data.selectedServiceIds,r=document.getElementById("apptDate").value;$.data.date=r;const o=s.reduce((n,i)=>{const l=nt.find(d=>d.id===i);return n+(l?l.duration+(l.bufferTime||0):0)},0);if(e.textContent=`${o} min`,o===0||!a||!r){t.innerHTML='<p class="col-span-full text-center text-gray-500">Selecione serviço, profissional e data.</p>';return}t.innerHTML='<div class="loader mx-auto col-span-full"></div>';try{let n=await bs({establishmentId:p.establishmentId,professionalId:a,serviceIds:s,date:r});const i=new Date;if(new Date(r+"T00:00:00").toDateString()===i.toDateString()){const d=i.getHours()*60+i.getMinutes();n=n.filter(c=>{const[u,m]=c.split(":").map(Number);return u*60+m>=d})}if(t.innerHTML="",n.length>0){if(n.forEach(d=>{const c=document.createElement("button");c.type="button",c.className=`time-slot-card p-2 text-sm bg-gray-100 rounded-md hover:bg-gray-200 transition ${$.data.time===d?"selected":""}`,c.textContent=d,c.addEventListener("click",()=>dr(d,c)),t.appendChild(c)}),$.data.time){const d=t.querySelector(`[data-action="time-slot"][data-time="${$.data.time}"]`);d&&d.classList.add("selected")}}else t.innerHTML='<p class="col-span-full text-center text-gray-500">Nenhum horário disponível.</p>'}catch(n){console.error("Erro ao buscar horários:",n),t.innerHTML='<p class="col-span-full text-center text-red-500">Erro ao buscar horários.</p>'}}function cr(){const e=document.getElementById("loyaltyRewardsContainer");if(!e)return;const{clientHasRewards:t,clientLoyaltyPoints:a,redeemedReward:s}=$.data,{enabled:r,rewards:o,pointsPerCurrency:n}=at;if(!r||!t||!o||o.length===0){e.classList.add("hidden"),e.innerHTML="";return}e.classList.remove("hidden");const i=o.filter(d=>a>=d.points);let l=`
    ...
    `),e.querySelector('input[value="none"]').addEventListener("change",d=>{d.target.checked&&($.data.redeemedReward=null)})}async function ur(e){e.preventDefault();const t=e.target,a=t.querySelector('button[type="submit"]');if(!$.data.time||$.data.selectedServiceIds.length===0||!$.data.professionalId)return b("Erro de Validação","Por favor, selecione o horário, serviço(s) e profissional antes de confirmar.","error");a.disabled=!0,a.textContent="A confirmar...";const s=$.data.selectedServiceIds.map(d=>{const c=nt.find(u=>u.id===d);return{id:c.id,name:c.name,price:c.price,duration:c.duration,bufferTime:c.bufferTime||0,photo:c.photo||null}}),[r,o]=$.data.time.split(":"),n=new Date(`${$.data.date}T${r}:${o}:00`),i={establishmentId:p.establishmentId,clientName:$.data.clientName,clientPhone:$.data.clientPhone,services:s,professionalId:$.data.professionalId,startTime:n.toISOString(),redeemedReward:$.data.redeemedReward},l=t.querySelector("#appointmentId").value;l&&(i.id=l);try{l?await ya(l,i):await fs(i),b(`Agendamento ${l?"atualizado":"criado"} com sucesso!`,"success"),document.getElementById("appointmentModal").style.display="none",te()}catch(d){b(d.message,"error")}finally{a.disabled=!1,a.textContent="Confirmar Agendamento"}}function mr(e){const t=$.data.clientName===e.name&&$.data.clientPhone===e.phone,a=v(e.name),s=v(e.phone);return`
    ...
    `}async function Wa(e){const t=document.getElementById("clientSearchResults");if(!t)return;const a=e.toLowerCase().trim();if(a.length<3){t.innerHTML='<p class="text-sm text-gray-500">Digite pelo menos 3 caracteres para buscar clientes existentes.</p>';return}const s=se.filter(r=>r.name.toLowerCase().includes(a)||r.phone.includes(a));if(s.length===0){t.innerHTML='<p class="text-sm text-gray-500">Nenhum cliente encontrado com este termo.</p>';return}t.innerHTML=s.map(mr).join(""),t.querySelectorAll('[data-action="select-client"]').forEach(r=>{r.addEventListener("click",o=>{const n=r.dataset.clientName,i=r.dataset.clientPhone,l=se.find(d=>d.phone===i&&d.name===n);if($.data.clientName=n,$.data.clientPhone=i,l){const d=at,c=Math.min(...(d?.rewards||[]).map(u=>u.points));$.data.clientLoyaltyPoints=l.loyaltyPoints||0,$.data.clientHasRewards=d.enabled&&c!==1/0&&$.data.clientLoyaltyPoints>=c}else $.data.clientHasRewards=!1,$.data.clientLoyaltyPoints=0;document.getElementById("apptClientName").value=n,document.getElementById("apptClientPhone").value=i,document.querySelectorAll(".client-search-card").forEach(d=>d.classList.remove("selected","border-blue-500")),r.classList.add("selected","border-blue-500")})})}async function pr(e){e.preventDefault();const t=document.getElementById("clientRegistrationForm"),a=t.querySelector('button[type="submit"]'),s={establishmentId:p.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim(),phone:t.querySelector("#regClientPhone").value.trim(),dobDay:t.querySelector("#regClientDobDay").value.trim(),dobMonth:t.querySelector("#regClientDobMonth").value.trim(),notes:t.querySelector("#regClientNotes").value.trim()};if(!s.name||!s.phone)return b("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{await Sa(s),se.push({name:s.name,phone:s.phone,loyaltyPoints:0}),$.data.clientName=s.name,$.data.clientPhone=s.phone,$.data.clientHasRewards=!1,$.data.clientLoyaltyPoints=0,b("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",ia(1)}catch(r){b(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar"}}function gr(){J({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("clientRegistrationForm");t&&t.addEventListener("submit",pr)}function br(){gr()}function fr(e,t){const a=e?"Editar Agendamento":"Selecionar Cliente",s=`
    ...
    `;return{title:a,content:s}}function vr(){const e="Selecionar Serviço",a=`
        <div class="p-5 space-y-6">
            ...
            <div id="apptServicesContainer" class="mt-4 grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-1">
                 ${nt.map(s=>{const r=$.data.selectedServiceIds.includes(s.id),o=s.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S",n=v(s.name);return`
    ...
    `;return{title:e,content:a}}function hr(){const e="Selecionar Profissional",t=`
        <div class="p-5 space-y-6">
             ...
             <div id="apptProfessionalContainer" class="mt-4 flex flex-wrap gap-3 max-h-48 overflow-y-auto p-1 professional-step-cards">
                 ${Ft.map(a=>{const s=$.data.professionalId===a.id,r=a.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",o=v(a.name);return`
    ...
    `;return{title:e,content:t}}function xr(e){const t=e?"Confirmar Edição":"Data e Horário",a=new Date,s=`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}-${String(a.getDate()).padStart(2,"0")}`,r=$.data.date||s,o=v($.data.clientName),n=v($.data.professionalName),i=`
        <div class="p-5 space-y-6">
    ...
    `;return{title:t,content:i}}function yr(e){const t=document.getElementById("apptServicesContainer");if(!t)return;const a=e.toLowerCase(),s=nt.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=$.data.selectedServiceIds.includes(r.id),n=r.photo||"https://placehold.co/40x40/E0E7FF/4F46E5?text=S";return`
            <div class="service-card p-3 bg-white rounded-lg border-2 border-gray-200 cursor-pointer transition-all hover:bg-gray-50 ${o?"selected border-blue-500":""}" data-service-id="${r.id}">
            ...
            </div>`}).join(""),t.querySelectorAll(".service-card").forEach(r=>{r.addEventListener("click",()=>Bo(r.dataset.serviceId,r))})}function wr(e){const t=document.getElementById("apptProfessionalContainer");if(!t)return;const a=e.toLowerCase(),s=Ft.filter(r=>r.name.toLowerCase().includes(a));t.innerHTML=s.map(r=>{const o=$.data.professionalId===r.id,n=r.photo||"https://placehold.co/60x60/E0E7FF/4F46E5?text=P",i=v(r.name);return`
             ...
             </div>`}).join(""),t.querySelectorAll(".professional-modal-card").forEach(r=>{r.addEventListener("click",()=>Do(r.dataset.professionalId,r))})}async function la(e=null,t=!1){const a=document.getElementById("appointmentModal");if(!t){const o=e?.startTime?new Date(e.startTime).toISOString().split("T")[0]:new Date().toISOString().split("T")[0],n=e?.startTime?new Date(e.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",hour12:!1}):null;$={step:1,data:{id:e?.id||null,clientName:e?.clientName||"",clientPhone:e?.clientPhone||"",selectedServiceIds:e?.services?.map(i=>i.id)||[],professionalId:e?.professionalId||null,professionalName:e?.professionalName||"",date:o,time:n,redeemedReward:e?.redeemedReward||null,clientHasRewards:e?.hasRewards||!1,clientLoyaltyPoints:0}}}if(!p.services||!p.professionals||!se||at.enabled===void 0){b("Erro","Os dados da agenda ainda não foram carregados. Tente novamente em alguns segundos.","error");return}if(nt=p.services,Ft=p.professionals.filter(o=>o.status==="active"),$.data.clientName&&$.data.clientPhone){const o=se.find(n=>n.phone===$.data.clientPhone&&n.name===$.data.clientName);o&&($.data.clientLoyaltyPoints=o.loyaltyPoints||0)}let s={title:"Erro",content:"<p>Etapa não encontrada.</p>"};switch($.step){case 1:s=fr(e);break;case 2:s=vr();break;case 3:s=hr();break;case 4:s=xr(e);break}a.innerHTML=`
        ...
        </div>`,a.querySelectorAll('[data-action="next-step"]').forEach(o=>{o.addEventListener("click",()=>{const n=parseInt(o.dataset.currentStep,10);if(n===1){const i=a.querySelector("#apptClientName"),l=a.querySelector("#apptClientPhone");if($.data.clientName=i.value.trim(),$.data.clientPhone=l.value.trim(),!$.data.clientName||!$.data.clientPhone)return b("Atenção","Nome e telefone do cliente são obrigatórios.","error")}else if(n===2){if($.data.selectedServiceIds.length===0)return b("Atenção","Selecione pelo menos um serviço.","error")}else if(n===3&&!$.data.professionalId)return b("Atenção","Selecione um profissional.","error");ia(n+1)})}),a.querySelectorAll('[data-action="prev-step"]').forEach(o=>{o.addEventListener("click",()=>ia(parseInt(o.dataset.currentStep,10)-1))});const r=a.querySelector("#appointmentForm");if($.step===4&&r&&r.addEventListener("submit",ur),a.style.display="flex",$.step===2){a.querySelector("#apptServicesContainer").querySelectorAll(".service-card").forEach(i=>{i.addEventListener("click",()=>Bo(i.dataset.serviceId,i))});const n=a.querySelector("#serviceSearchModalInput");n&&n.addEventListener("input",i=>yr(i.target.value))}if($.step===3){a.querySelector("#apptProfessionalContainer").querySelectorAll(".professional-modal-card").forEach(i=>{i.addEventListener("click",()=>Do(i.dataset.professionalId,i))});const n=a.querySelector("#professionalSearchModalInput");n&&n.addEventListener("input",i=>wr(i.target.value))}if($.step===1){const o=a.querySelector("#clientSearchInput");o&&(o.addEventListener("input",i=>Wa(i.target.value)),$.data.clientName&&$.data.clientPhone&&Wa(`${$.data.clientName} ${$.data.clientPhone}`));const n=a.querySelector('[data-action="open-client-registration"]');n&&n.addEventListener("click",br)}if($.step===4){const o=a.querySelector("#apptDate");o&&o.addEventListener("change",_a),_a(),cr()}}async function Po(e={}){D.currentDate=e.targetDate?new Date(e.targetDate):D.currentDate||new Date,D.scrollToAppointmentId=e.scrollToAppointmentId||null,D.profSearchTerm="",window.innerWidth<768&&(D.currentView="list"),Ua.innerHTML=`
        <section>
        ...
        </section>`,document.querySelectorAll(".view-btn[data-view]").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".view-btn[data-view]").forEach(r=>r.classList.remove("active")),a.classList.add("active"),D.currentView=a.dataset.view;const s=document.getElementById("week-days-toggle");if(D.currentView==="week"){if(s.style.display="flex",window.innerWidth<768){D.weekViewDays=3,document.querySelectorAll(".week-days-btn").forEach(o=>o.classList.remove("active"));const r=document.querySelector('.week-days-btn[data-days="3"]');r&&r.classList.add("active")}}else s.style.display="none";te()})}),document.querySelectorAll(".week-days-btn").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".week-days-btn").forEach(s=>s.classList.remove("active")),a.classList.add("active"),D.weekViewDays=parseInt(a.dataset.days,10),te()})}),document.getElementById("todayBtn").addEventListener("click",()=>{D.currentDate=new Date,te()});const t=a=>{const s=parseInt(a.currentTarget.dataset.amount,10),r=D.currentView==="week"?$a():1,o=new Date(D.currentDate);o.setDate(o.getDate()+s*r),D.currentDate=o,te()};document.getElementById("prevBtn").addEventListener("click",t),document.getElementById("nextBtn").addEventListener("click",t),document.getElementById("profSearchInput").addEventListener("input",a=>{D.profSearchTerm=a.target.value,Et()}),document.getElementById("showInactiveProfsToggle").addEventListener("change",a=>{D.showInactiveProfs=a.target.checked,Et(),te()}),Ja||(Ua.addEventListener("click",async a=>{const s=a.target.closest("[data-action]");if(a.target.closest('[data-action="select-professional"]')){const l=a.target.closest('[data-action="select-professional"]').dataset.profId,d=D.selectedProfessionalId===l&&l!=="all";if(D.selectedProfessionalId=d?"all":l,l!=="all"){const c=document.getElementById("profSearchInput");c&&(c.value=""),D.profSearchTerm=""}await te();return}if(!s)return;const r=s.dataset.action;let o=null;const n=a.target.closest("[data-appointment]");switch(n&&(o=JSON.parse(n.dataset.appointment.replace(/&apos;/g,"'"))),r){case"new-appointment":la();break;case"edit-appointment":if(!o)return;if(o.status==="completed"){b("Atenção","Agendamentos finalizados não podem ser editados.","error");return}o.hasRewards&&!o.redeemedReward&&b("🎁 Cliente com Prêmios!","Este cliente tem pontos para resgatar. Verifique a Etapa 4 do agendamento.","info"),la(o);break;case"delete-appointment":{const i=s.dataset.id;if(await j("Confirmar Exclusão","Tem a certeza que deseja apagar este agendamento?"))try{await vs(i),b("Agendamento apagado!","success"),te()}catch(d){b(`Não foi possível apagar: ${d.message}`,"error")}break}case"open-comanda":if(o){o.hasRewards&&!o.redeemedReward&&o.status!=="completed"&&b("🎁 Cliente com Prêmios!","Este cliente tem pontos de fidelidade para resgatar.","info");const i=o.status==="completed"?"finalizadas":"em-atendimento",l={selectedAppointmentId:o.id,initialFilter:i};if(i==="finalizadas"){let d=o.startTime;if(o.transaction&&o.transaction.paidAt){const c=o.transaction.paidAt;typeof c=="object"&&c._seconds?d=new Date(c._seconds*1e3):d=c}l.filterDate=d}K("comandas-section",l)}break}}),Ja=!0),await lr(),await te()}const kr=(e,t=null,a=1,s=12)=>{let r=`/api/comandas/${e}?page=${a}&limit=${s}`;return t&&(r+=`&date=${t}`),y(r)},Sr=e=>y("/api/sales",{method:"POST",body:JSON.stringify(e)}),$r=e=>y(`/api/sales/${e}/reopen`,{method:"POST"}),Er=e=>y(`/api/sales/${e}`,{method:"DELETE"}),Rt=e=>y(`/api/products/${e}`),Ir=e=>y("/api/products",{method:"POST",body:JSON.stringify(e)}),Cr=(e,t)=>y(`/api/products/${e}`,{method:"PUT",body:JSON.stringify(t)}),Lr=e=>y(`/api/products/${e}`,{method:"DELETE"}),Tr=(e,t)=>y(`/api/products/${e}/stock`,{method:"PATCH",body:JSON.stringify(t)}),Br=({startDate:e,endDate:t,productId:a,categoryId:s,establishmentId:r})=>{const o=new URLSearchParams({startDate:e,endDate:t});return a&&a!=="all"&&o.append("productId",a),s&&s!=="all"&&o.append("categoryId",s),r&&o.append("establishmentId",r),y(`/api/products/stock-history/report?${o.toString()}`)},Mo=()=>y("/api/cashier/status").catch(e=>{if(e.message.includes("404")||e.message.includes("não encontrada"))return null;throw e}),Dr=e=>{const t={establishmentId:e.establishmentId,initialAmount:Number(e.initialAmount),notes:e.notes||""};return console.log("Payload enviado para abrir caixa:",t),y("/api/cashier/open",{method:"POST",body:JSON.stringify(t)})},Pr=(e,t)=>{const a={finalAmount:Number(t)};return console.log("Payload enviado para fechar caixa:",a),y(`/api/cashier/close/${e}`,{method:"PUT",body:JSON.stringify(a)})},Mr=()=>y("/api/cashier/history").then(e=>e||[]).catch(e=>(console.error("Erro ao buscar histórico:",e),[])),Ar=e=>y(`/api/cashier/report/${e}`),Ao=e=>y(`/api/packages/${e}`),Nr=e=>y("/api/packages",{method:"POST",body:JSON.stringify(e)}),qr=(e,t)=>y(`/api/packages/${e}`,{method:"PUT",body:JSON.stringify(t)}),Fr=e=>y(`/api/packages/${e}`,{method:"DELETE"});let x={allComandas:[],catalog:{services:[],products:[],packages:[]},clients:[],activeFilter:"atendimento",selectedComandaId:null,isCashierOpen:!1,activeCashierSessionId:null,paging:{page:1,limit:12,total:0}},$e=null,Ie=null;function jt(e){if(e.status==="completed"){const r=e.comandaItems||e.items||[];return r.length>0?r:e.services||[]}const t=e.services||[],a=[...e.comandaItems||[],...e.items||[]];let s=[...t];return a.forEach(r=>{if(r.type==="product"){s.push(r);return}s.some(n=>{const i=n.id&&r.id&&n.id===r.id,l=n.name&&r.name&&n.name===r.name;return i||l})||s.push(r)}),s}function Rr(){const e=document.getElementById("comandas-layout");if(e){e.classList.add("detail-view-active");const t=document.getElementById("comanda-detail-container");t&&(t.scrollTop=0)}}function ve(){const e=document.getElementById("comandas-layout");e&&e.classList.remove("detail-view-active")}function jr(){const e=new Date().toISOString().split("T")[0];Ie.innerHTML=`
    ...
    `}function Hr(){const e=document.getElementById("cashier-controls");e&&(x.isCashierOpen?e.innerHTML=`
        ...
        `;return}const a={atendimento:"confirmed",finalizadas:"completed"}[x.activeFilter],s=x.allComandas.filter(r=>r.status===a);if(s.length===0){e.innerHTML='<p class="text-center text-gray-400 py-10 text-sm">Nenhuma venda encontrada.</p>',Ga(e);return}e.innerHTML=s.map(r=>{const n=jt(r).reduce((g,f)=>g+(f.price||0),0),i=r.id===x.selectedComandaId,l=new Date(r.startTime).toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),d=r.type==="walk-in"||r.id.startsWith("temp-"),c=v(r.clientName),u=v(r.professionalName),m=d?'<span class="text-[10px] font-bold uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded-md">Avulso</span>':'<span class="text-[10px] font-bold uppercase text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-md">Agendado</span>';return`
    ...
    `;if(!x.isCashierOpen){e.innerHTML=`
        ...
        `;return}const s=jt(a),r=a.status==="completed",o=a.type==="walk-in"||a.id.startsWith("temp-"),n=o?"":`<button data-action="go-to-appointment" data-id="${a.id}" data-date="${a.startTime}" 
    ...
    `}function Or(){J({title:"Cadastrar Novo Cliente",contentHTML:`
    ...
    `,maxWidth:"max-w-2xl"});const t=document.getElementById("comandas_clientRegistrationForm");t&&t.addEventListener("submit",zr)}async function zr(e){e.preventDefault();const t=document.getElementById("comandas_clientRegistrationForm");if(!t)return;const a=t.querySelector('button[type="submit"]'),s={establishmentId:p.establishmentId,name:t.querySelector("#regClientName").value.trim(),email:t.querySelector("#regClientEmail").value.trim()||null,phone:t.querySelector("#regClientPhone").value.trim(),dob:`${t.querySelector("#regClientDobDay").value.trim()}/${t.querySelector("#regClientDobMonth").value.trim()}`,notes:t.querySelector("#regClientNotes").value.trim()||null};if(!s.name||!s.phone)return b("Erro de Validação","Nome e Telefone são obrigatórios.","error");a.disabled=!0,a.textContent="A salvar...";try{const r=await Sa(s);x.clients.push({id:r.id,...s}),b("Cliente cadastrado com sucesso!","success"),document.getElementById("genericModal").style.display="none",No(r.id)}catch(r){b(`Erro ao cadastrar cliente: ${r.message}`,"error")}finally{a.disabled=!1,a.textContent="Salvar Cliente"}}function Vr(){if(!x.isCashierOpen){b("Caixa Fechado","Abra o caixa antes de adicionar itens.","error");return}const{modalElement:e,close:t}=J({title:"Adicionar Item à Comanda",contentHTML:'<div id="add-item-content"></div>',maxWidth:"max-w-4xl"}),a=()=>{let r="";const o=e.querySelector("#add-item-content"),n={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>',package:'<svg class="w-6 h-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-14L4 7m8 4v10M4 7v10l8 4" /></svg>'},i=()=>{const l=r.toLowerCase(),d=u=>u.filter(m=>m.name.toLowerCase().includes(l)),c={"modal-service-list":{items:d(x.catalog.services),type:"service"},"modal-product-list":{items:d(x.catalog.products),type:"product"},"modal-package-list":{items:d(x.catalog.packages),type:"package"}};for(const[u,{items:m,type:g}]of Object.entries(c)){const f=o.querySelector(`#${u}`);f&&(f.innerHTML=m.map(h=>`
        ...
        `,document.getElementById("quantity-minus-btn").onclick=()=>{o>1&&(o--,i())},document.getElementById("quantity-plus-btn").onclick=()=>{o++,i()},document.querySelector('[data-action="confirm-add-item"]').onclick=async()=>{await Gr(r,o),t()}};e.addEventListener("click",r=>{const o=r.target.closest('[data-action="select-item-for-quantity"]'),n=r.target.closest('[data-action="back-to-catalog"]');if(o){const{itemType:i,itemId:l}=o.dataset,c=(x.catalog[i+"s"]||[]).find(u=>u.id===l);c&&s({...c,type:i})}else n&&a()}),a()}async function No(e=null){if(!x.isCashierOpen){b("Caixa Fechado","Abra o caixa antes de criar uma nova venda.","error");return}if(!x.clients||x.clients.length===0)try{x.clients=await qt(p.establishmentId)}catch{b("Erro","Não foi possível carregar dados de clientes.","error");return}if(!p.professionals||p.professionals.length===0)try{p.professionals=await X(p.establishmentId)}catch{b("Erro","Não foi possível carregar dados de profissionais.","error");return}const t=x.clients.map(n=>{const i=n.id===e?"selected":"";return`<option value="${n.id}" ${i}>${v(n.name)} - ${v(n.phone)}</option>`}).join(""),a=p.professionals.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""),s=`
    ...
    `,{modalElement:r}=J({title:"Nova Venda Avulsa",contentHTML:s,maxWidth:"max-w-md"});r.querySelector("#new-sale-form").addEventListener("submit",Xr);const o=r.querySelector('[data-action="new-client-from-sale"]');o&&o.addEventListener("click",n=>{n.preventDefault(),r.style.display="none",Or()})}function Ur(){if(!x.isCashierOpen){b("Caixa Fechado","Abra o caixa antes de finalizar pagamentos.","error");return}const e=x.allComandas.find(u=>u.id===x.selectedComandaId);if(!e)return;const t=jt(e),a=new Set,s=[];for(const u of t){if(u.type==="service"&&u.id){if(a.has(u.id))continue;a.add(u.id)}s.push(u)}const r=s.reduce((u,m)=>u+(m.price||0),0);let o=[],n={remainingAmount:r,selectedMethod:"dinheiro",installments:1,amountReceived:""};const i=()=>{const u=document.getElementById("payment-list"),m=document.getElementById("remaining-amount"),g=document.getElementById("finalize-checkout-btn"),f=document.getElementById("change-container"),h=document.getElementById("installments-container"),w=document.getElementById("payment-value"),S=document.getElementById("payment-controls"),I=o.reduce((k,C)=>k+C.value,0);n.remainingAmount=r-I,u.innerHTML=o.map((k,C)=>`
    ...
    `,{modalElement:c}=J({title:"Finalizar Pagamento",contentHTML:d,maxWidth:"max-w-md"});document.getElementById("payment-value").value=n.remainingAmount.toFixed(2),c.addEventListener("click",u=>{const m=u.target.closest(".payment-method-btn");m&&(n.selectedMethod=m.dataset.method,n.installments=1,document.getElementById("installments-select").value=1,i()),u.target.closest("#add-payment-btn")&&l(),u.target.closest('[data-action="remove-payment"]')&&(o.splice(parseInt(u.target.closest('[data-action="remove-payment"]').dataset.paymentIndex,10),1),i()),u.target.closest("#finalize-checkout-btn")&&Qr(e,r,o)}),c.addEventListener("change",u=>{u.target.id==="installments-select"&&(n.installments=parseInt(u.target.value,10))}),c.addEventListener("input",u=>{u.target.id==="amount-received"&&(n.amountReceived=u.target.value,i())}),i()}async function Jr(){const e=`
    ...
    `,{modalElement:t}=J({title:"Abrir Caixa",contentHTML:e,maxWidth:"max-w-md"});t.querySelector("#open-cashier-form").addEventListener("submit",async a=>{a.preventDefault();const s=document.getElementById("initial-amount"),r=s.value.trim(),o=document.getElementById("cashier-notes").value.trim(),n=parseFloat(r);if(r===""||isNaN(n)||n<0){b("Valor Inválido","Por favor, insira um valor inicial válido (maior ou igual a R$ 0,00).","error"),s.focus();return}try{const i={establishmentId:p.establishmentId,initialAmount:parseFloat(n.toFixed(2))};o&&(i.notes=o);const l=await Dr(i);x.isCashierOpen=!0,x.activeCashierSessionId=l.id,await Ea(),document.getElementById("genericModal").style.display="none",b("Sucesso!",`Caixa aberto com valor inicial de R$ ${n.toFixed(2)}`,"success")}catch(i){b("Erro",`Não foi possível abrir o caixa: ${i.message}`,"error")}})}async function _r(){const e=x.activeCashierSessionId;if(e)try{const t=await Ar(e),a=`
        ...
        `,{modalElement:s}=J({title:"Fechar Caixa",contentHTML:a,maxWidth:"max-w-md"});s.querySelector("#close-cashier-form").addEventListener("submit",async r=>{r.preventDefault();const o=parseFloat(document.getElementById("final-amount").value);if(isNaN(o)||o<0){b("Valor Inválido","Insira um valor final válido.","error");return}try{await Pr(e,o),x.isCashierOpen=!1,x.activeCashierSessionId=null,document.getElementById("genericModal").style.display="none",await Ea(),b("Sucesso!","Caixa fechado com sucesso!","success")}catch(n){b("Erro",`Não foi possível fechar o caixa: ${n.message}`,"error")}})}catch(t){b("Erro",`Não foi possível carregar o relatório de fecho: ${t.message}`,"error")}}async function Wr(e){x.activeFilter!==e&&(x.activeFilter=e,x.paging.page=1,document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${e}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",e!=="finalizadas"),ve(),await oe(),x.selectedComandaId=null,Z())}function da(e){x.selectedComandaId=e,me(),Rr(),Z()}async function Gr(e,t){const a=x.allComandas.find(r=>r.id===x.selectedComandaId);if(!a)return;const s=Array(t).fill(0).map(()=>({id:e.id,name:e.name,price:e.price,type:e.type}));if(a.comandaItems=a.comandaItems||[],a.comandaItems.push(...s),a.type==="walk-in"&&a.id.startsWith("temp-")){b("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),Z(),me();return}try{await ya(a.id,a),b("Sucesso",`${t}x ${e.name} adicionado(s)!`,"success"),Z(),me()}catch(r){b("Erro",`Não foi possível adicionar o item: ${r.message}`,"error"),a.comandaItems.splice(a.comandaItems.length-t,t)}}async function Yr(e,t){const a=x.allComandas.find(o=>o.id===x.selectedComandaId);if(!a)return;let s=!1,r=(a.comandaItems||[]).findIndex(o=>o.id===e&&o.type===t);if(r>-1)a.comandaItems.splice(r,1),s=!0;else{let o=(a.services||[]).findIndex(n=>n.id===e);if(o>-1)a.services.splice(o,1),s=!0;else{let n=(a.items||[]).findIndex(i=>i.id===e&&i.type===t);n>-1&&(a.items.splice(n,1),s=!0)}}if(s){if(a.type==="walk-in"&&a.id.startsWith("temp-")){b("Sucesso","Item removido!","success"),Z(),me();return}try{await ya(a.id,a),b("Sucesso","Item removido!","success"),Z(),me()}catch(o){b("Erro",`Não foi possível remover o item: ${o.message}`,"error"),await oe()}}}async function Qr(e,t,a){const s=e.type==="appointment",r=jt(e),o=new Set,n=[];for(const l of r){if(l.type==="service"&&l.id){if(o.has(l.id))continue;o.add(l.id)}n.push(l)}const i={payments:a,totalAmount:t,items:n,cashierSessionId:x.activeCashierSessionId};try{s?await xs(e.id,i):(i.establishmentId=p.establishmentId,i.clientName=e.clientName,i.professionalId=e.professionalId,i.clientPhone=e.clientPhone,await Sr(i)),b("Sucesso!","Venda finalizada com sucesso!","success"),document.getElementById("genericModal").style.display="none",ve(),x.selectedComandaId=null,await oe()}catch(l){b("Erro no Checkout",l.message,"error")}}async function Xr(e){e.preventDefault();const t=document.getElementById("new-sale-client").value,a=document.getElementById("new-sale-professional").value,s=x.clients.find(n=>n.id===t),r=p.professionals.find(n=>n.id===a);if(!s||!r){b("Erro","Selecione um cliente e um profissional válidos.","error");return}const o={id:`temp-${Date.now()}`,type:"walk-in",clientName:s.name,clientPhone:s.phone,professionalId:r.id,professionalName:r.name,startTime:new Date,status:"confirmed",services:[],comandaItems:[]};x.allComandas.unshift(o),x.selectedComandaId=o.id,document.getElementById("genericModal").style.display="none",da(o.id)}async function oe(){const e=document.getElementById("comandas-list");e.innerHTML='<div class="loader mx-auto mt-10"></div>';const t=x.activeFilter==="finalizadas"?document.getElementById("filter-date").value:null;try{const a=await Mo();if(x.isCashierOpen=!!a,x.activeCashierSessionId=a?a.id:null,Hr(),!x.isCashierOpen&&x.activeFilter==="atendimento"){me(),Z();return}const s=await kr(p.establishmentId,t,x.paging.page,x.paging.limit);if(x.allComandas=s.data||s,x.paging.total=s.total||s.length,x.catalog.services.length===0){const[r,o,n,i,l]=await Promise.all([Fe(p.establishmentId),Rt(p.establishmentId),Ao(p.establishmentId),qt(p.establishmentId),X(p.establishmentId)]);x.catalog={services:r,products:o,packages:n},x.clients=i,p.professionals=l}me(),x.selectedComandaId,Z()}catch(a){b("Erro de Carregamento",`Não foi possível carregar os dados: ${a.message}`,"error"),e.innerHTML=`<p class="text-red-500 p-4">${a.message}</p>`}}async function Ea(e={}){Ie=document.getElementById("content");try{const t=await Mo();x.isCashierOpen=!!t,x.activeCashierSessionId=t?t.id:null}catch(t){console.error("Erro ao verificar caixa:",t),x.isCashierOpen=!1}x.selectedComandaId=e.selectedAppointmentId||null,jr(),$e&&(Ie.removeEventListener("click",$e),Ie.removeEventListener("change",$e)),$e=async t=>{const a=t.target.closest("[data-action], [data-filter], [data-comanda-id], [data-id]");if(t.target.id==="filter-date"&&x.activeFilter==="finalizadas"){x.paging.page=1,await oe();return}if(a){if(a.matches("[data-filter]"))Wr(a.dataset.filter);else if(a.matches("[data-comanda-id]")){if(t.target.closest('[data-action="go-to-appointment"]')){t.stopPropagation();return}da(a.dataset.comandaId)}else if(a.matches("[data-action]")){const s=a.dataset.action,r=a.dataset.id||x.selectedComandaId;switch(s){case"back-to-list":{ve(),x.selectedComandaId=null,document.querySelectorAll(".comanda-card").forEach(o=>o.classList.remove("selected")),Z();break}case"new-sale":No();break;case"add-item":Vr();break;case"checkout":Ur();break;case"open-cashier":Jr();break;case"close-cashier":await _r();break;case"view-sales-report":K("sales-report-section");break;case"remove-item":await Yr(a.dataset.itemId,a.dataset.itemType);break;case"reopen-appointment":{if(await j("Reabrir Comanda","Tem certeza? O pagamento será estornado e os produtos devolvidos ao estoque."))try{await hs(r);const n=x.allComandas.findIndex(i=>i.id===r);n!==-1&&(delete x.allComandas[n].transaction,delete x.allComandas[n].cashierSessionId,delete x.allComandas[n].redeemedReward,x.allComandas[n].status="confirmed"),x.selectedComandaId=null,ve(),b("Sucesso!","Comanda reaberta para edição.","success"),await oe()}catch(n){b("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"reopen-walk-in":{if(await j("Reabrir Venda","Tem certeza? A venda será cancelada e os produtos devolvidos ao estoque."))try{await $r(r),b("Sucesso!","Venda revertida."),ve(),x.selectedComandaId=null,await oe()}catch(n){b("Erro",`Não foi possível reabrir: ${n.message}`,"error")}break}case"go-to-appointment":{const o=a.dataset.id,n=a.dataset.date;K("agenda-section",{scrollToAppointmentId:o,targetDate:new Date(n)});break}case"delete-walk-in":{if(await j("Excluir Venda","Tem certeza que deseja excluir esta venda avulsa? O estoque dos produtos será devolvido."))if(r.startsWith("temp-"))x.allComandas=x.allComandas.filter(n=>n.id!==r),x.selectedComandaId=null,me(),Z(),b("Sucesso","Venda avulsa removida.","success"),ve();else try{await Er(r),b("Sucesso","Venda avulsa excluída com sucesso.","success"),x.selectedComandaId=null,ve(),await oe()}catch(n){b("Erro",`Não foi possível excluir: ${n.message}`,"error")}break}}}}},Ie.addEventListener("click",$e),Ie.addEventListener("change",$e),e.initialFilter&&(x.activeFilter=e.initialFilter==="finalizadas"?"finalizadas":"atendimento"),e.selectedAppointmentId&&(x.selectedComandaId=e.selectedAppointmentId),document.querySelectorAll(".filter-btn").forEach(t=>t.classList.remove("bg-white","text-indigo-600","shadow")),document.querySelector(`[data-filter="${x.activeFilter}"]`).classList.add("bg-white","text-indigo-600","shadow"),document.getElementById("finalizadas-datepicker").classList.toggle("hidden",x.activeFilter!=="finalizadas"),e.filterDate&&(document.getElementById("filter-date").value=new Date(e.filterDate).toISOString().split("T")[0]),await oe(),x.selectedComandaId&&da(x.selectedComandaId)}const ca=document.getElementById("content");let Wt={};const ct=["#4f46e5","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#06b6d4"],N={startDate:new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],selectedProfessional:"all",selectedCostCenter:"all",professionalsList:[],costCentersList:[],data:null,appointmentsData:[],currentTab:"dashboards"};async function Zr(){if(!window.Chart)return new Promise((e,t)=>{const a=document.createElement("script");a.src="https://cdn.jsdelivr.net/npm/chart.js",a.onload=e,a.onerror=t,document.head.appendChild(a)})}async function Kr(){ca.innerHTML='<div class="flex flex-col items-center justify-center h-64"><div class="loader mb-4"></div><p class="text-gray-500">A carregar inteligência de dados...</p></div>';try{await Zr();const[e,t]=await Promise.all([X(p.establishmentId),Js(p.establishmentId).catch(()=>[])]);N.professionalsList=e||[],N.costCentersList=t||[],en(),await qo()}catch(e){console.error("Erro no loadReportsPage:",e),ca.innerHTML=`
            ...
            </div>`}}function en(){const e=N.professionalsList.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join(""),t=N.costCentersList.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join("");ca.innerHTML=`
    ...
    `,document.getElementById("btn-filter").onclick=tn,document.querySelectorAll(".tab-btn").forEach(a=>{a.onclick=()=>{N.currentTab=a.dataset.tab,Ya(),Fo()}}),Ya()}function Ya(){document.querySelectorAll(".tab-btn").forEach(e=>{const t=e.dataset.tab===N.currentTab;e.className=t?"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-bold bg-white text-indigo-600 shadow-sm transition-all whitespace-nowrap":"tab-btn flex-1 px-4 py-2 rounded-md text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-all whitespace-nowrap"})}async function tn(){N.startDate=document.getElementById("report-start").value,N.endDate=document.getElementById("report-end").value,N.selectedProfessional=document.getElementById("report-prof").value,N.selectedCostCenter=document.getElementById("report-cost").value,await qo()}async function qo(){const e=document.getElementById("report-content");e.innerHTML='<div class="flex justify-center py-20"><div class="loader"></div></div>';try{const t=Us(N.startDate,N.endDate,N.selectedProfessional,N.selectedCostCenter),a=N.selectedProfessional==="all"?null:N.selectedProfessional,s=new Date(N.startDate+"T00:00:00").toISOString(),r=new Date(N.endDate+"T23:59:59").toISOString(),o=Io(p.establishmentId,s,r,a).catch(l=>[]),[n,i]=await Promise.all([t,o]);N.data=n,N.appointmentsData=Array.isArray(i)?i:[],Fo()}catch(t){console.error(t),e.innerHTML=`
            ...
            </div>`}}function Fo(){const e=document.getElementById("report-content");if(N.data)switch(N.currentTab){case"dashboards":an(e);break;case"appointments":on(e);break;case"dre":sn(e);break}}function an(e){const{dreSimple:t,charts:a}=N.data,s=t||{grossRevenue:0,netProfit:0,variableCosts:0},r=N.data.totalAppointments||0,o=r>0?s.grossRevenue/r:0;e.innerHTML=`
    ...
    `,Ue("dailyApptChart","line","Agendamentos",u.map(f=>f.split("-").reverse().slice(0,2).join("/")),m,"#4f46e5")}function sn(e){const{dreFinancial:t}=N.data,a=Object.entries(t.revenues).map(([r,o])=>`
    ...
    `}function Ue(e,t,a,s,r,o){const n=document.getElementById(e);if(!n)return;const i=n.getContext("2d");Wt[e]&&Wt[e].destroy();const l={type:t,data:{labels:s,datasets:[{label:a,data:r,backgroundColor:Array.isArray(o)?o:t==="line"?"rgba(79, 70, 229, 0.1)":o,borderColor:Array.isArray(o)?"#fff":o,borderWidth:2,fill:t==="line",tension:.3,borderRadius:t==="bar"?4:0,pointBackgroundColor:"#fff",pointBorderColor:o,pointHoverBackgroundColor:o}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:t==="doughnut",position:"bottom"},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.9)",padding:10,cornerRadius:8,callbacks:{label:d=>{let c=d.dataset.label||"";return c&&(c+=": "),d.parsed.y!==null?c+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(d.parsed.y):c+=d.raw,c}}}},scales:t==="doughnut"?{}:{y:{beginAtZero:!0,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},x:{grid:{display:!1},ticks:{font:{size:11}}}}}};Wt[e]=new Chart(i,l)}const Ht=(e,t="products")=>y(`/api/${t}/categories/${e}`),Ro=(e,t="products")=>y(`/api/${t}/categories`,{method:"POST",body:JSON.stringify(e)}),jo=(e,t="products")=>y(`/api/${t}/categories/${e}`,{method:"DELETE"}),rn="audit_logs",Ae=async(e,t,a,s,r,o=null)=>{try{if(!t)return;await ko(ue(U,rn),{establishmentId:e,userId:t.uid,userName:t.name||t.email||"Utilizador",module:a,action:s,description:r,details:o,timestamp:new Date})}catch(n){console.error("Falha silenciosa ao registar log:",n)}},fe=document.getElementById("content");let le=null,We="services",xe="all";function Ne(){const e=Y.currentUser;return e?{uid:e.uid,name:e.displayName||e.email}:{uid:"unknown",name:"Desconhecido"}}async function nn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Ro({establishmentId:p.establishmentId,name:s},"services"),Ae(p.establishmentId,Ne(),"Categorias (Serviços)","Criou",`Criou categoria: ${s}`),a.value="",b("Sucesso","Categoria criada!","success"),await Ia(),await it()}catch(r){b("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function ln(e){if(await j("Apagar Categoria","Tem a certeza? Os serviços nesta categoria ficarão sem categoria."))try{await jo(e,"services"),Ae(p.establishmentId,Ne(),"Categorias (Serviços)","Excluiu",`Excluiu uma categoria (ID: ${e})`),b("Sucesso","Categoria apagada.","success"),await Ia(),await it()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function Ia(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Ht(p.establishmentId,"services");p.serviceCategories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                ...
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria criada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function dn(){J({title:"Gerir Categorias de Serviços",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
    ...
    `;const t=document.getElementById("serviceCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.serviceCategories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),Ca(),Ce()}function pn(){const e=document.getElementById("services-content-container");e.innerHTML=`
    ...
    `}async function it(){const e=document.getElementById("services-content-container");if(e){const t=e.querySelector(".loader");t&&(t.style.display="block")}try{const[t,a,s,r]=await Promise.all([Fe(p.establishmentId),X(p.establishmentId),Ht(p.establishmentId,"services"),Zs(p.establishmentId)]);p.services=(t||[]).filter(Boolean),p.professionals=(a||[]).filter(Boolean),p.serviceCategories=(s||[]).filter(Boolean),p.mostPopularService=r||{name:"N/A",count:0},p.services.forEach(o=>{o.active===void 0&&(o.active=!0)}),Ho(We)}catch(t){e&&(e.innerHTML='<p class="text-red-500 col-span-full text-center py-10">Erro ao carregar dados. Verifique a conexão com o servidor.</p>'),b("Erro",`Não foi possível carregar os dados: ${t.message}`,"error")}}function Ho(e){if(document.getElementById("services-content-container")){if(We===e&&document.getElementById("services-content-container").children.length>1){We==="services"&&(Ca(),Ce());return}We=e,xe="all",document.querySelectorAll("#services-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="services"?mn():e==="reports"&&pn()}}function gn(){le&&(fe.removeEventListener("click",le),fe.removeEventListener("input",le),fe.removeEventListener("change",le)),le=async e=>{const t=e.target;if(t.closest('[data-action="toggle-service-status"]')){e.stopPropagation();const r=t.closest('[data-action="toggle-service-status"]'),o=r.dataset.id,n=r.checked;try{await Xs(o,n);const i=p.services.findIndex(l=>l.id===o);i>-1&&(p.services[i].active=n),Ae(p.establishmentId,Ne(),"Serviços","Atualizou Status",`Alterou status do serviço (ID: ${o}) para ${n?"Ativo":"Inativo"}`),Ce(),Ca()}catch(i){b("Erro",`Não foi possível atualizar o status: ${i.message}`,"error"),r.checked=!n,Ce()}return}const a=t.closest("button[data-action], button[data-view], .indicator-card[data-action], .service-card[data-action]");if(t.id==="serviceSearchInput"||t.id==="serviceCategoryFilter"){Ce();return}if(!a)return;if(a.hasAttribute("data-view")){Ho(a.dataset.view);return}switch(a.dataset.action){case"new-service":Qa();break;case"edit-service":const r=JSON.parse(a.dataset.service);Qa(r);break;case"manage-categories":dn();break;case"filter-service":const o=a.dataset.filterType;if(o==="popular")return;xe=o==="total"?"all":o,document.querySelectorAll('.indicator-card[data-action="filter-service"]').forEach(n=>{const i=n.dataset.filterType,d=i===xe||i==="total"&&xe==="all";n.classList.toggle("ring-2",d),n.classList.toggle("ring-indigo-500",d),n.classList.toggle("shadow-lg",d)}),Ce();break}},fe.addEventListener("click",le),fe.addEventListener("input",le),fe.addEventListener("change",le)}async function bn(){fe.innerHTML=`
        ...
        </section>`,gn();try{(!p.professionals||p.professionals.length===0)&&(p.professionals=await X(p.establishmentId)||[])}catch(e){console.error("Falha ao carregar profissionais:",e),b("Erro","Não foi possível carregar a lista de profissionais.","error"),p.professionals=[]}We="services",xe="all",await it()}const Ot="suppliers",La="purchases",Oo="financial_payables",Ta=async e=>{try{const t=Pt(ue(U,Ot),et("establishmentId","==",e)),a=await xa(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar fornecedores:",t),t}},fn=async e=>{try{return{id:(await ko(ue(U,Ot),e)).id,...e}}catch(t){throw console.error("Erro ao criar fornecedor:",t),t}},vn=async(e,t)=>{try{const a=ke(U,Ot,e);return await Eo(a,t),{id:e,...t}}catch(a){throw console.error("Erro ao atualizar fornecedor:",a),a}},hn=async e=>{try{const t=ke(U,Ot,e);return await ds(t),!0}catch(t){throw console.error("Erro ao excluir fornecedor:",t),t}},xn=async(e,t=null)=>{try{const a=$o(U),s=ke(ue(U,La)),r={...e,createdAt:Fa()};if(a.set(s,r),t&&t.defaultNatureId&&t.defaultCostCenterId){const o=ke(ue(U,Oo)),n=new Date().toISOString().split("T")[0],i={establishmentId:e.establishmentId,description:`Compra - ${e.supplierName}`,amount:parseFloat(e.totalAmount),dueDate:n,naturezaId:t.defaultNatureId,centroDeCustoId:t.defaultCostCenterId,notes:`Gerado automaticamente pelo Pedido de Compra. Itens: ${e.items.length}`,status:"pending",paymentDate:null,purchaseId:s.id,createdAt:Fa()};a.set(o,i)}return await a.commit(),{id:s.id,...r}}catch(a){throw console.error("Erro ao registrar compra com integração:",a),a}},yn=async(e,t)=>{try{const a=$o(U),s=ke(U,La,e);a.delete(s);const r=Pt(ue(U,Oo),et("purchaseId","==",e),et("establishmentId","==",t));return(await xa(r)).forEach(n=>{a.delete(n.ref)}),await a.commit(),!0}catch(a){throw console.error("Erro ao excluir compra e financeiro:",a),a}},wn=async e=>{try{const t=Pt(ue(U,La),et("establishmentId","==",e),So("createdAt","desc")),a=await xa(t),s=[];return a.forEach(r=>{s.push({id:r.id,...r.data()})}),s}catch(t){throw console.error("Erro ao buscar histórico de compras:",t),t}},pe=document.getElementById("content");let de=null,Ge="products",ae="all";async function kn(e){e.preventDefault();const a=e.target.closest("#categoryForm").querySelector("#categoryName"),s=a.value;if(s)try{await Ro({establishmentId:p.establishmentId,name:s},"products"),a.value="",b("Sucesso","Categoria de produto criada!","success"),await Ba(),await lt()}catch(r){b("Erro",`Não foi possível criar a categoria: ${r.message}`,"error")}}async function Sn(e){if(await j("Apagar Categoria","Tem a certeza? Os produtos nesta categoria ficarão sem categoria."))try{await jo(e,"products"),b("Sucesso","Categoria de produto apagada.","success"),await Ba(),await lt()}catch{b("Erro","Não foi possível apagar a categoria.","error")}}async function Ba(){const e=document.getElementById("categoryList");if(e){e.innerHTML='<div class="loader mx-auto my-4"></div>';try{const t=await Ht(p.establishmentId,"products");p.categories=t,e.innerHTML="",t.length>0?e.innerHTML=t.map(a=>`
                <div class="flex justify-between items-center bg-gray-100 p-2 rounded">
                    <span>${v(a.name)}</span>
                    <button data-action="delete-category" data-id="${a.id}" class="text-red-500 hover:text-red-700 font-semibold text-sm">Apagar</button>
                </div>`).join(""):e.innerHTML='<p class="text-center text-gray-500">Nenhuma categoria encontrada.</p>'}catch{e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar categorias.</p>'}}}function $n(){J({title:"Gerir Categorias de Produtos",contentHTML:`
        <div class="space-y-4">
            <div class="mb-4">
                <form id="categoryForm" class="flex flex-col sm:flex-row gap-4 sm:items-end">
                    <div class="flex-1 w-full">
    ...
    `,maxWidth:"max-w-xl"});const t=document.getElementById("genericModal");if(t){const a=t.querySelector("#categoryForm");a&&(a.addEventListener("submit",kn),t.addEventListener("click",s=>{const r=s.target.closest('button[data-action="delete-category"]');r&&Sn(r.dataset.id)}))}Ba()}async function En(e){if(!e)return;if(await j("Apagar Produto","Tem a certeza que deseja apagar este produto? Esta ação não pode ser revertida."))try{await Lr(e),b("Sucesso","Produto apagado com sucesso!","success"),await lt()}catch(a){b("Erro",`Não foi possível apagar o produto: ${a.message}`,"error")}}async function In(e){const t=e.querySelector("#productId").value,a=parseInt(e.querySelector("#productCurrentStock").value),s=parseInt(e.querySelector("#productMinStock").value),r=parseInt(e.querySelector("#productMaxStock").value),o=e.querySelectorAll("#selectedSuppliersList .selected-supplier-item"),n=Array.from(o).map(l=>l.dataset.id),i={establishmentId:p.establishmentId,name:e.querySelector("#productName").value,price:parseFloat(e.querySelector("#productPrice").value),costPrice:parseFloat(e.querySelector("#productCostPrice").value)||0,commissionRate:parseFloat(e.querySelector("#productCommissionRate").value)||0,currentStock:isNaN(a)?0:a,minStock:isNaN(s)?0:s,maxStock:isNaN(r)?0:r,categoryId:e.querySelector("#productCategory").value||null,photo:e.querySelector("#productPhotoBase64").value,supplierIds:n};try{t?await Cr(t,i):await Ir(i),document.getElementById("productModal").style.display="none",b("Sucesso",`Produto ${t?"atualizado":"adicionado"} com sucesso!`,"success"),await lt()}catch(l){throw new Error(l.message)}}function Xa(e,t=800,a=800,s="image/jpeg",r=.8){return new Promise((o,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,u=d.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const m=document.createElement("canvas");m.width=c,m.height=u,m.getContext("2d").drawImage(d,0,0,c,u);const f=m.toDataURL(s,r);o(f)},d.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function Za(e=null){const t=document.getElementById("productModal"),a=p.categories||[],s=p.suppliers||[],r=a.map(L=>`<option value="${L.id}" ${e?.categoryId===L.id?"selected":""}>${v(L.name)}</option>`).join("");let o=new Set(e?.supplierIds||[]);const n=v(e?.name||""),i=e?.price||"",l=e?.costPrice||"",d=e?.commissionRate||"",c=e?.minStock||0,u=e?.maxStock||0,m=e?.currentStock||0,g=e?n:"Novo Produto";t.innerHTML=`
    <div class="modal-content max-w-3xl overflow-y-auto max-h-[90vh]">
        <form id="productForm">
            ...
            <div class="mt-8 pt-6 border-t flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
    ...
    </div>`;const f=t.querySelector("#productCategory"),h=t.querySelector("#productPhotoInput");t.querySelector("#productPhotoButton").addEventListener("click",()=>h.click()),f.innerHTML='<option value="">Sem categoria</option>'+(p.categories||[]).map(L=>`<option value="${L.id}" ${e?.categoryId===L.id?"selected":""}>${v(L.name)}</option>`).join(""),e&&(f.value=e.categoryId||"");const w=t.querySelector("#productPhotoPreview");t.querySelector("#productPhotoBase64");const S=e?.photo||"https://placehold.co/128x128/E2E8F0/4A5568?text=Foto",I=e?.photo||"";h.onchange=async()=>{const L=h.files[0];if(L){w.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const T=await Xa(L,800,800,"image/jpeg",.8),q=T.length*3/4,O=1e3*1024;if(q>O)throw new Error("A imagem é muito grande mesmo após a compressão.");preview.src=T,base64Input.value=T}catch(T){console.error("Erro ao processar imagem:",T),b("Erro de Imagem",T.message||"Não foi possível processar a imagem.","error"),preview.src=S,base64Input.value=I,H.value=""}}};const E=t.cloneNode(!0);t.parentNode.replaceChild(E,t);const k=()=>{const L=E.querySelector("#modalSupplierSearch"),T=E.querySelector("#supplierSearchResults"),A=E.querySelector("#selectedSuppliersList"),q=L.value.toLowerCase();if(q.length>0){const O=s.filter(M=>M.name.toLowerCase().includes(q)&&!o.has(M.id));O.length>0?(T.classList.remove("hidden"),T.innerHTML=O.map(M=>`
                ...
                `).join("")):(T.classList.remove("hidden"),T.innerHTML='<div class="p-2 text-xs text-gray-500 text-center">Nenhum resultado disponível.</div>')}else T.classList.add("hidden");o.size>0?(A.innerHTML="",o.forEach(O=>{const M=s.find(_=>_.id===O);M&&(A.innerHTML+=`
                    ...
                    `)})):A.innerHTML='<p class="text-xs text-gray-400 text-center py-2">Nenhum fornecedor selecionado.</p>'};E.querySelector("#modalSupplierSearch").addEventListener("input",k),E.addEventListener("click",L=>{const T=L.target.closest("[data-add-supplier]");if(T){const q=T.dataset.addSupplier;o.add(q),E.querySelector("#modalSupplierSearch").value="",k()}const A=L.target.closest("[data-remove-supplier]");if(A){const q=A.dataset.removeSupplier;o.delete(q),k()}}),k(),E.addEventListener("click",async L=>{const T=L.target.closest("button[data-action]");if(!T)return;const A=T.dataset.action,q=E.querySelector("#productId").value;if(A==="close-modal"&&(E.style.display="none"),A==="delete-product"){if(!q)return;E.style.display="none",await En(q)}if(A==="save-product-modal"){const O=E.querySelector("#productForm");if(O){if(!O.querySelector("#productName").value||!O.querySelector("#productPrice").value){b("Erro","Nome e Preço de Venda são obrigatórios.","error");return}const M=T.closest('button[data-action="save-product-modal"]');M.disabled=!0,M.textContent="A salvar...";try{await In(O)}catch(_){b("Erro",`Falha ao salvar: ${_.message}`,"error"),M.disabled=!1,M.textContent="Salvar Alterações"}}}if(A==="adjust-stock-modal"){L.preventDefault();const O=E.querySelector("#stockAdjustmentAmount"),M=E.querySelector("#stockAdjustmentReason"),_=parseInt(O.value,10),Se=parseInt(T.dataset.change,10);if(!_||_<=0){b("Erro","Por favor, insira uma quantidade válida.","error");return}const Jt=_*Se,as=M.value||(Jt>0?"Entrada manual":"Saída manual");try{await Tr(q,{change:Jt,reason:as});const je=p.products.findIndex(He=>He.id===q);if(je>-1){const He=p.products[je].currentStock+Jt;p.products[je].currentStock=He,E.querySelector("#currentStockDisplay").textContent=He,E.querySelector("#productCurrentStock").value=He,O.value="",M.value="",b("Sucesso","Estoque atualizado!","success"),Da(),ot()}}catch(je){b("Erro de Stock",je.message,"error")}}});const C=E.querySelectorAll(".tab-btn"),F=E.querySelectorAll(".tab-content");C.forEach(L=>{L.addEventListener("click",T=>{T.preventDefault(),C.forEach(A=>{A.classList.remove("border-indigo-500","text-indigo-600"),A.classList.add("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300")}),L.classList.add("border-indigo-500","text-indigo-600"),L.classList.remove("border-transparent","text-gray-500","hover:text-gray-700","hover:border-gray-300"),F.forEach(A=>A.classList.add("hidden")),document.getElementById(`tab-content-${L.dataset.tab}`).classList.remove("hidden")})});const H=E.querySelector("#productPhotoInput");E.querySelector("#productPhotoButton").addEventListener("click",()=>H.click()),H.onchange=async()=>{const L=H.files[0];if(!L)return;const T=E.querySelector("#productPhotoPreview"),A=E.querySelector("#productPhotoBase64");T.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const q=await Xa(L,800,800,"image/jpeg",.8),M=q.length*3/4,_=1e3*1024;if(M>_)throw new Error("A imagem é muito grande mesmo após a compressão.");T.src=q,A.value=q}catch(q){console.error("Erro ao processar imagem:",q),b("Erro de Imagem",q.message||"Não foi possível processar a imagem.","error"),T.src=S,A.value=I,H.value=""}},E.style.display="flex"}function Cn(){const e=document.getElementById("products-content-container");e.innerHTML=`
    ...
    `;const t=document.getElementById("productCategoryFilter");t&&(t.innerHTML='<option value="all">Todas as categorias</option>',(p.categories||[]).forEach(a=>t.innerHTML+=`<option value="${a.id}">${v(a.name)}</option>`)),Da(),ot()}function Ln(){const e=document.getElementById("products-content-container"),t=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()-30);const s=a.toISOString().split("T")[0];e.innerHTML=`
        <div class="space-y-6">
        ...
        </div>`;const r=document.getElementById("productFilterReport"),o=document.getElementById("categoryFilterReport");r&&p.products&&(r.innerHTML+=p.products.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join("")),o&&p.categories&&(o.innerHTML+=p.categories.map(n=>`<option value="${n.id}">${v(n.name)}</option>`).join(""))}async function Tn(){const e=document.getElementById("report-results");e.innerHTML='<div class="loader mx-auto my-8"></div>';const t={startDate:document.getElementById("reportStartDate").value,endDate:document.getElementById("reportEndDate").value,productId:document.getElementById("productFilterReport").value,categoryId:document.getElementById("categoryFilterReport").value,establishmentId:p.establishmentId};try{const a=await Br(t);if(a.length===0){e.innerHTML=`
                <div class="bg-white border rounded-lg shadow-sm p-8">
            ...
            <div class="md:hidden space-y-3 pb-20">
                ...
                </div>`,e.appendChild(n)})):(e.className="",e.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum produto encontrado.</p>')}async function lt(){const e=document.getElementById("products-content-container");e&&(e.innerHTML='<div class="loader col-span-full mx-auto my-8"></div>');try{const[t,a,s]=await Promise.all([Rt(p.establishmentId),Ht(p.establishmentId,"products"),Ta(p.establishmentId)]);p.products=(t||[]).filter(Boolean),p.categories=(a||[]).filter(Boolean),p.suppliers=(s||[]).filter(Boolean),zo(Ge)}catch(t){e&&(e.innerHTML=`<p class="text-red-500 col-span-full text-center p-8">Erro ao carregar dados: ${t.message}</p>`)}}function zo(e){if(document.getElementById("products-content-container")){if(Ge===e&&document.getElementById("products-content-container").children.length>1){Ge==="products"&&(Da(),ot());return}Ge=e,ae="all",document.querySelectorAll("#products-tabs button.tab-button").forEach(t=>{const a=t.dataset.view===e;t.classList.toggle("border-indigo-500",a),t.classList.toggle("text-indigo-600",a),t.classList.toggle("border-transparent",!a),t.classList.toggle("text-gray-500",!a)}),e==="products"?Cn():e==="movements"&&Ln()}}async function Bn(){pe.innerHTML=`
        ...
        </section>`,de&&(pe.removeEventListener("click",de),pe.removeEventListener("input",de),pe.removeEventListener("change",de)),de=async e=>{const t=e.target;if(t.id==="productSearchInput"||t.id==="productCategoryFilter"){ot();return}const a=e.target.closest("button[data-action], button[data-view], .indicator-card[data-action], .product-card[data-action]");if(!a||e.target.closest('[data-action-stop-propagation="true"]'))return;if(a.hasAttribute("data-view")){zo(a.dataset.view);return}switch(a.dataset.action){case"new-product":Za();break;case"edit-product":Za(JSON.parse(a.dataset.product));break;case"manage-product-categories":$n();break;case"generate-report":await Tn();break;case"filter-stock":const r=a.dataset.filterType;ae=ae===r?"all":r,document.querySelectorAll(".indicator-card").forEach(o=>{o.classList.toggle("ring-2",o.dataset.filterType===ae),o.classList.toggle("ring-indigo-500",o.dataset.filterType===ae),o.classList.toggle("shadow-lg",o.dataset.filterType===ae)}),ot();break}},pe.addEventListener("click",de),pe.addEventListener("input",de),pe.addEventListener("change",de),Ge="products",ae="all",await lt()}const ge=document.getElementById("content");let ce=null,wt="list",R={step:1,productsToBuy:[],allSuppliers:[],finalOrders:{},isQuoteMode:!1};async function Dn(){wt==="list"?zt():wt==="purchases"?(R.step=1,Ye()):wt==="history"&&Vo()}async function Pn(){try{const e=await Ta(p.establishmentId);return p.suppliers=e||[],R.allSuppliers=e,!0}catch(e){return console.error(e),!1}}async function Mn(e){if(await j("Excluir Fornecedor","Tem a certeza? Isso removerá o vínculo com os produtos."))try{await hn(e),b("Sucesso","Fornecedor excluído.","success"),Mt("genericModal"),zt()}catch(t){b("Erro","Erro ao excluir: "+t.message,"error")}}async function An(e){e.preventDefault();const t=e.target,a=t.querySelector("#supId").value,s={name:t.querySelector("#supName").value,contactName:t.querySelector("#supContact").value,email:t.querySelector("#supEmail").value,phone:t.querySelector("#supPhone").value,taxId:t.querySelector("#supTaxId").value,category:t.querySelector("#supCategory").value,establishmentId:p.establishmentId},r=t.querySelector('button[type="submit"]');r.disabled=!0,r.textContent="A salvar...";try{a?(await vn(a,s),b("Sucesso","Fornecedor atualizado!","success")):(await fn(s),b("Sucesso","Fornecedor criado!","success")),Mt("genericModal"),zt()}catch(o){b("Erro","Erro ao salvar: "+o.message,"error")}finally{r.disabled=!1,r.textContent="Salvar"}}async function zt(){const e=document.getElementById("suppliersList");if(!e)return;e.innerHTML='<div class="loader mx-auto my-8"></div>',await Pn();const t=document.getElementById("supplierSearchInput")?.value.toLowerCase()||"",a=p.suppliers.filter(o=>o.name.toLowerCase().includes(t)||o.contactName&&o.contactName.toLowerCase().includes(t));if(e.innerHTML="",a.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum fornecedor encontrado.</div>';return}let s='<div class="flex flex-col gap-2 md:hidden">';a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.category||"Geral"),d=v(o.contactName||"");s+=`
    ...
    `;a.forEach(o=>{const n=JSON.stringify(o).replace(/"/g,"&quot;"),i=v(o.name),l=v(o.taxId||"Sem doc."),d=v(o.email||"-"),c=v(o.phone||"-"),u=v(o.category||"Geral");r+=`
        ...
        `}),r+="</tbody></table></div>",e.innerHTML=s+r}function Nn(e){const t=e.phone?`https://wa.me/${e.phone.replace(/\D/g,"")}`:"#",a=e.phone?`tel:${e.phone}`:"#",s=e.email?`mailto:${e.email}`:"#",r=JSON.stringify(e).replace(/"/g,"&quot;"),o=v(e.name),n=v(e.category||"Fornecedor"),i=v(e.contactName||""),l=v(e.phone||""),d=`
    ...
    `;J({title:"",contentHTML:d,maxWidth:"max-w-md"})}async function Ye(){const e=document.getElementById("purchasesContainer");if(e)if(R.step===1){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const[t,a]=await Promise.all([Rt(p.establishmentId),Ta(p.establishmentId)]);R.allSuppliers=a||[];const s=t.filter(d=>{const c=parseInt(d.currentStock||0),u=parseInt(d.minStock||0);return c<=u});if(R.productsToBuy=s,s.length===0){e.innerHTML=`
    ...
    `}async function Vo(){const e=document.getElementById("historyContainer");if(e){e.innerHTML='<div class="loader mx-auto my-8"></div>';try{const t=await wn(p.establishmentId);if(t.length===0){e.innerHTML='<div class="text-center text-gray-500 py-8">Nenhum histórico encontrado.</div>';return}let a='<div class="flex flex-col gap-3 md:hidden">';t.forEach(o=>{const n=new Date(o.createdAt.seconds*1e3).toLocaleDateString("pt-BR"),i=v(o.supplierName);a+=`
        ...
        `;e.innerHTML=a+r}catch(t){console.error(t),e.innerHTML='<p class="text-red-500 text-center">Erro ao carregar histórico.</p>'}}}function Fn(e){const t=new Date(e.createdAt.seconds*1e3).toLocaleString("pt-BR"),a=e.items.map(r=>`
    ...
    `;J({title:e?"Editar Fornecedor":"Novo Fornecedor",contentHTML:t,maxWidth:"max-w-lg"}),setTimeout(()=>{document.getElementById("supplierForm").addEventListener("submit",An),document.querySelector("#genericModal .modal-close").addEventListener("click",()=>Mt("genericModal"))},50)}function jn(){ge.innerHTML=`
    ...
    `,ce&&(ge.removeEventListener("click",ce),ge.removeEventListener("input",ce),ge.removeEventListener("change",ce)),ce=e=>{if(e.target.closest("#tab-btn-list")&&ut("list"),e.target.closest("#tab-btn-purchases")&&ut("purchases"),e.target.closest("#tab-btn-history")&&ut("history"),e.target.id==="toggle-quote-mode"&&(R.isQuoteMode=e.target.checked,Ye()),e.target.id==="supplierSearchInput"&&zt(),e.target.closest("#btn-new-supplier")&&Ka(),e.target.closest(".supplier-item-mobile")){const a=e.target.closest(".supplier-item-mobile"),s=JSON.parse(a.dataset.supplier);Nn(s)}const t=e.target.closest("button[data-action]");if(t){const a=t.dataset.action;a==="delete"&&Mn(t.dataset.id),a==="edit"&&Ka(JSON.parse(t.dataset.supplier))}if((e.target.classList.contains("qty-input")||e.target.classList.contains("row-select"))&&ua(),e.target.id==="check-all-rows"){const a=e.target.checked;document.querySelectorAll(".row-select").forEach(s=>s.checked=a),ua()}if(e.target.closest("#btn-go-to-orders")){const a=document.querySelectorAll(".product-row"),s={};let r=!1;if(a.forEach(o=>{if(o.offsetParent===null||!o.querySelector(".row-select").checked)return;r=!0;let i="Produto";const l=o.querySelector("td:nth-child(2)"),d=o.querySelector(".font-bold");l?i=l.innerText:d&&(i=d.innerText);const c=parseInt(o.querySelector(".qty-input").value),u=parseFloat(o.dataset.cost),g=o.querySelector(".supplier-select").value;if(g){if(!s[g]){const f=R.allSuppliers.find(h=>h.id===g);s[g]={info:f,items:[]}}s[g].items.push({name:i,qty:c,cost:u})}}),!r){b("Atenção","Selecione pelo menos um item para gerar o pedido.","error");return}R.finalOrders=s,R.step=2,Ye()}if(e.target.closest("#btn-back-step1")&&(R.step=1,Ye()),e.target.closest(".btn-send-order")){const a=e.target.closest(".btn-send-order"),s=JSON.parse(decodeURIComponent(a.dataset.supplierInfo)),r=JSON.parse(decodeURIComponent(a.dataset.orderItems)),o=parseFloat(a.dataset.total),n=R.isQuoteMode;if(s.phone){const i=s.phone.replace(/\D/g,"");let l="";n?(l=`Olá *${s.name}*, tudo bem?
...
Aguardo retorno.`;const d=`mailto:${s.email}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(l)}`;window.location.href=d}else b("Erro","Fornecedor sem telefone ou email cadastrado.","error")}if(e.target.closest(".btn-register-order")){const a=e.target.closest(".btn-register-order");if(a.disabled)return;const s=JSON.parse(decodeURIComponent(a.dataset.order));s.establishmentId=p.establishmentId,a.disabled=!0,a.textContent="A processar...",qe(p.establishmentId).then(r=>{const o=r.purchaseConfig||null;return xn(s,o)}).then(()=>{b("Sucesso","Compra registrada e integrada ao financeiro!","success"),a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Registrado',a.classList.replace("bg-blue-600","bg-green-600"),a.classList.replace("hover:bg-blue-700","hover:bg-green-700")}).catch(r=>{a.disabled=!1,a.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Salvar',b("Erro","Falha ao registrar compra: "+r.message,"error")})}if(e.target.closest(".btn-delete-purchase")){const s=e.target.closest(".btn-delete-purchase").dataset.id;j("Excluir Compra","Isto apagará o registo histórico E o lançamento financeiro associado. Deseja continuar?").then(async r=>{if(r)try{await yn(s,p.establishmentId),b("Sucesso","Compra e financeiro excluídos.","success"),Vo()}catch(o){b("Erro","Erro ao excluir: "+o.message,"error")}})}if(e.target.closest(".btn-print-order")){const s=e.target.closest(".supplier-order-card").dataset.supplierId,r=R.finalOrders[s];r?Rn(r,R.isQuoteMode):b("Erro","Dados do pedido não encontrados.","error")}if(e.target.closest(".btn-view-purchase")){const a=e.target.closest(".btn-view-purchase"),s=JSON.parse(a.dataset.purchase);Fn(s)}},ge.addEventListener("click",ce),ge.addEventListener("input",ce),ge.addEventListener("change",ce),ut("list")}function ut(e){wt=e,["list","purchases","history"].forEach(a=>{const s=document.getElementById(`tab-btn-${a}`),r=document.getElementById(`tab-content-${a}`);a===e?(s.classList.add("border-indigo-500","text-indigo-600"),s.classList.remove("border-transparent","text-gray-500"),r.classList.remove("hidden")):(s.classList.remove("border-indigo-500","text-indigo-600"),s.classList.add("border-transparent","text-gray-500"),r.classList.add("hidden"))});const t=document.getElementById("btn-new-supplier");t&&(e==="list"?t.classList.remove("hidden"):t.classList.add("hidden")),Dn()}const Gt=document.getElementById("content"),eo={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"};let re=new Set,mt=null,Le=null;function Hn(e=8){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function On(e){return e.length===0?'<p class="col-span-full text-center text-gray-500 py-10">Nenhum profissional encontrado.</p>':e.map(t=>{const a=t.status==="inactive",s=v(t.name),r=v(t.specialty||"Especialidade"),o=t.photo||`https://placehold.co/100x100/E2E8F0/4A5568?text=${encodeURIComponent(t.name?t.name.charAt(0):"P")}`,n=JSON.stringify(t).replace(/'/g,"&apos;");return`
            ...
            </div>`}).join("")}function Yt(){const e=document.getElementById("genericModal");e.style.display="none",Le&&e.removeEventListener("click",Le)}async function zn(e){const t=document.getElementById("genericModal"),a=e.id?e:{name:"Novo Profissional",specialty:"",status:"active",workingHours:{},services:[]},s=v(a.name),r=p.services||await Fe(p.establishmentId),o=p.professionals||await X(p.establishmentId),n=`
        ...
        </div>`;t.innerHTML=n,t.style.display="flex",Vn(a,r),Jn(a),_n(a,o),Gn(a)}function Vn(e,t){const a=document.getElementById("professionalForm"),s=e.dob?e.dob.split("/"):["",""],r=Array.from({length:12},(w,S)=>{const I=S+1,E=I==s[1]?"selected":"",k=new Date(0,S).toLocaleString("pt-BR",{month:"long"});return`<option value="${I}" ${E}>${k.charAt(0).toUpperCase()+k.slice(1)}</option>`}).join(""),o=e.status||"active",n=v(e.name||""),i=v(e.specialty||""),l=v(e.phone||""),d=v(e.notes||"");a.innerHTML=`
        ...
        <div class="form-group"><label for="profNotes">Observações</label><textarea id="profNotes" rows="3" class="mt-1 w-full p-2 border rounded-md">${d}</textarea></div>`;const c=document.getElementById("profPhotoInput"),u=document.getElementById("profPhotoButton"),m=document.getElementById("profPhotoPreview"),g=document.getElementById("profPhotoBase64"),f=e.photo||`https://placehold.co/128x128/E2E8F0/4A5568?text=${encodeURIComponent(e.name?e.name.charAt(0):"P")}`,h=e.photo||"";u&&u.addEventListener("click",()=>c.click()),c&&(c.onchange=async()=>{const w=c.files[0];if(w){m.src="https://placehold.co/128x128/E2E8F0/4A5568?text=...";try{const S=await Un(w,800,800,"image/jpeg",.8);m.src=S,g.value=S}catch(S){b("Erro de Imagem",S.message||"Não foi possível processar a imagem.","error"),m.src=f,g.value=h,c.value=""}}})}function Un(e,t=800,a=800,s="image/jpeg",r=.8){return new Promise((o,n)=>{if(!e.type.startsWith("image/"))return n(new Error("O ficheiro selecionado não é uma imagem."));const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{let c=d.width,u=d.height;c>u?c>t&&(u*=t/c,c=t):u>a&&(c*=a/u,u=a);const m=document.createElement("canvas");m.width=c,m.height=u,m.getContext("2d").drawImage(d,0,0,c,u);const f=m.toDataURL(s,r);o(f)},d.onerror=c=>n(new Error("Não foi possível carregar a imagem.")),d.src=l.target.result},i.onerror=l=>n(new Error("Não foi possível ler o ficheiro.")),i.readAsDataURL(e)})}function Jn(e){const t=document.getElementById("jornada");t.innerHTML='<div><h3 class="text-xl font-semibold mb-4">Jornada de Trabalho Semanal</h3><p class="text-sm text-gray-600 mb-4">Defina os horários de trabalho padrão para este profissional.</p><div id="profScheduleContainer" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"></div></div>',Wn(t.querySelector("#profScheduleContainer"),e.workingHours||{})}async function _n(e,t){const a=document.getElementById("bloqueios");a.innerHTML=`
        ...
        `).join("")}catch(s){a.innerHTML=`<p class="text-red-500">${s.message}</p>`}}}function Gn(e){const t=document.getElementById("genericModal");Le&&t.removeEventListener("click",Le),Le=async a=>{const s=a.target.closest("button[data-action]");if(!s){const o=a.target.closest(".tab-link");o&&(t.querySelectorAll(".tab-link").forEach(n=>n.classList.remove("active")),o.classList.add("active"),t.querySelectorAll(".tab-content").forEach(n=>n.classList.add("hidden")),document.getElementById(o.dataset.tab).classList.remove("hidden"));return}const r=s.dataset.action;switch(a.stopPropagation(),r){case"close-modal":Yt();break;case"delete-professional":const o=s.dataset.id;if(await j("Excluir Profissional",`Tem certeza que deseja excluir ${e.name}? Esta ação não pode ser desfeita.`))try{await As(o),b("Sucesso!","Profissional excluído.","success"),Yt(),It()}catch(h){b("Erro",`Não foi possível excluir: ${h.message}`,"error")}break;case"save-professional":const i=document.getElementById("professionalForm"),l=s,d=document.getElementById("profScheduleContainer"),c=Array.from(i.querySelectorAll("#profServicesContainer input:checked")).map(h=>h.value),u={};d&&d.querySelectorAll(".day-schedule-card").forEach(h=>{const w=h.querySelector('[data-field="active"]').dataset.day;u[w]={active:h.querySelector('[data-field="active"]').checked,start:h.querySelector('[data-field="start"]').value,end:h.querySelector('[data-field="end"]').value,breakStart:h.querySelector('[data-field="breakStart"]').value,breakEnd:h.querySelector('[data-field="breakEnd"]').value}});const m={...e,id:i.querySelector("#professionalId").value||void 0,name:i.querySelector("#profName").value,specialty:i.querySelector("#profSpecialty").value,photo:i.querySelector("#profPhotoBase64").value,services:c,workingHours:u,phone:i.querySelector("#profPhone").value,dob:`${i.querySelector("#profDobDay").value}/${i.querySelector("#profDobMonth").value}`,receivesCommission:i.querySelector("#profCommission").value==="sim",showOnAgenda:i.querySelector("#profShowOnAgenda").value==="sim",orderOnAgenda:parseInt(i.querySelector("#profOrderOnAgenda").value)||1,notes:i.querySelector("#profNotes").value,status:i.querySelector("#profStatus").value,establishmentId:p.establishmentId};l.disabled=!0,l.textContent="A salvar...";try{m.id?(await Ms(m.id,m),b("Sucesso!","Profissional atualizado.","success")):(delete m.id,await Ps(m),b("Sucesso!","Profissional criado.","success")),Yt(),It()}catch(h){b("Erro",h.message,"error"),l.disabled=!1,l.textContent="Salvar"}break;case"delete-blockage":const g=s.dataset.id;if(await j("Apagar Bloqueio","Tem certeza?"))try{await ka(g),b("Bloqueio removido.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Qe(e.id,h)}catch(h){b("Erro",h.message,"error")}break;case"batch-delete-blockage":const f=JSON.parse(s.dataset.ids);if(await j("Apagar em Lote",`Tem certeza que deseja apagar ${f.length} bloqueios com este motivo?`))try{await Lo(f),b("Bloqueios removidos.","success");const h=document.getElementById("prof-blockages-filter")?document.getElementById("prof-blockages-filter").value:"future";Qe(e.id,h)}catch(h){b("Erro",h.message,"error")}break}},t.addEventListener("click",Le)}function ma(){const e=document.getElementById("batch-actions-container"),t=document.getElementById("selected-count");!e||!t||(re.size>0?(t.textContent=`${re.size} selecionado(s)`,e.classList.remove("hidden")):e.classList.add("hidden"))}function Yn(){j("Excluir em Lote",`Tem certeza que deseja excluir ${re.size} profissionais? Esta ação não pode ser desfeita.`).then(async e=>{if(e)try{await(void 0)(Array.from(re)),b("Sucesso!",`${re.size} profissionais foram excluídos.`,"success"),re.clear(),ma(),It()}catch(t){b("Erro",`Não foi possível excluir em lote: ${t.message}`,"error")}})}function Oe(){const e=document.getElementById("professionalsList");if(!e)return;if(!p.professionals){e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=Hn();return}const t=document.getElementById("showInactiveProfToggle").checked,a=document.getElementById("profSearchInput").value.toLowerCase(),s=p.professionals.filter(r=>{const o=r.name.toLowerCase().includes(a),n=t||r.status!=="inactive";return o&&n});e.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 pb-20",e.innerHTML=On(s)}async function It(){re.clear(),Gt.innerHTML=`
        ...
        </section>`,mt&&Gt.removeEventListener("click",mt),mt=t=>{const a=t.target.closest('[data-action="open-professional-modal"]'),s=t.target.closest('[data-action="batch-delete"]');if(a){t.preventDefault();let o={};if(a.dataset.professional)try{o=JSON.parse(a.dataset.professional)}catch(n){console.error("Erro ao fazer parse do professional data:",n);return}zn(o);return}if(s){Yn();return}const r=t.target.closest(".professional-checkbox");if(r){const o=r.dataset.id;r.checked?re.add(o):re.delete(o),Oe(),ma();return}},Gt.addEventListener("click",mt),document.getElementById("profSearchInput").addEventListener("input",Oe),document.getElementById("showInactiveProfToggle").addEventListener("change",Oe);const e=document.getElementById("professionalsList");p.professionals=null,p.services=null,Oe();try{const[t,a]=await Promise.all([X(p.establishmentId),Fe(p.establishmentId)]);p.professionals=t,p.services=a,Oe(),ma()}catch{e.innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar dados da página.</p>'}}const Qt=document.getElementById("content");let Te=[],ne={},V=null,pa="list",Q="all",ga="O Estabelecimento";const Qn=1,Xn=(e,t)=>`Olá, ${e}! Nós da ${t} desejamos a você um Feliz Aniversário! Esperamos que seu dia seja maravilhoso. Venha comemorar conosco! 🎉🎂`,Zn=(e,t)=>`Oi, ${e}! Faz um tempo que não te vemos aqui no(a) ${t}. Sentimos sua falta! Temos novidades/ofertas especiais para você. Que tal agendar seu horário?`,Kn=[{value:30,label:"30 dias"},{value:60,label:"60 dias"},{value:90,label:"90 dias"},{value:120,label:"120 dias"}];function ei(){return Math.floor(Math.random()*140)+10}function ti(e){if(!e.dob)return!1;const t=e.dob.split("/");if(t.length!==2)return!1;const a=new Date,s=a.getDate(),r=a.getMonth()+1,o=parseInt(t[0],10),n=parseInt(t[1],10);return o===s&&n===r}const ai=[{value:99,label:"Aniversariantes de Hoje"},{value:0,label:"Todos os meses (com DOB)"},{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}];function to(){return ai.map(e=>{let t=e.value===99?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function ao(){return Kn.map(e=>{const t=e.value===90?"selected":"";return`<option value="${e.value}" ${t}>${e.label}</option>`}).join("")}function Pa(e){if(!e)return 0;let t=0;if(e.totalAmount!==void 0&&e.totalAmount!==null?t=parseFloat(e.totalAmount):e.value!==void 0&&e.value!==null?t=parseFloat(e.value):e.price!==void 0&&e.price!==null&&!Array.isArray(e.price)&&(t=parseFloat(e.price)),!t||t===0){let a=0;e.services&&Array.isArray(e.services)&&(a+=e.services.reduce((r,o)=>{const n=parseFloat(o.price)||parseFloat(o.servicePrice)||0;return r+n},0));const s=e.comandaItems||e.items;s&&Array.isArray(s)&&(a+=s.reduce((r,o)=>{const n=parseFloat(o.price)||0,i=parseInt(o.quantity)||1;return r+n*i},0)),a>0&&(t=a)}return isNaN(t)?0:t}function oi(e,t){const a=`w-5 h-5 ${t} mr-2`;switch(e){case"cadastro":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>`;case"agendamentos":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`;case"historico":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v2a2 2 0 01-2 2h-2.586a1 1 0 00-.707.293l-1.414 1.414a1 1 0 01-1.414 0l-1.414-1.414A1 1 0 009.586 17H7a2 2 0 01-2-2v-2a2 2 0 012-2h12z" /></svg>`;case"fidelidade":return`<svg xmlns="http://www.w3.org/2000/svg" class="${a}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.5a9.5 9.5 0 1019 0 9.5 9.5 0 00-19 0z" /></svg>`;default:return""}}function si(e="cadastro"){const t=[{id:"cadastro",label:"Cadastro"},{id:"agendamentos",label:"Agend."},{id:"historico",label:"Histórico"},{id:"fidelidade",label:"Fidelidade"}],a=document.getElementById("client-detail-tabs");a&&(a.innerHTML=t.map(s=>{const r=e===s.id,o=r?"text-indigo-600":"text-gray-500";return`
        ...
        `}).join(""),a.querySelectorAll(".tab-btn").forEach(s=>{s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation(),ba(s.dataset.tab)})}))}async function ba(e){si(e);const t=document.getElementById("client-detail-content");if(t){t.innerHTML='<div class="flex h-64 items-center justify-center"><div class="loader"></div></div>';try{switch(e){case"cadastro":t.innerHTML=ri(V);break;case"agendamentos":case"historico":const a=await Va(p.establishmentId,V.name,V.phone);t.innerHTML=ni(a,e);break;case"fidelidade":let s=[],r=[];try{s=await Va(p.establishmentId,V.name,V.phone)}catch(o){console.error("Erro ao buscar histórico de vendas:",o)}if(ne&&ne.enabled)try{r=await tr(p.establishmentId,V.name,V.phone)}catch(o){console.warn("Aviso: Histórico de fidelidade indisponível.",o)}t.innerHTML=li(V,s,r);break;default:t.innerHTML='<p class="p-6 text-center text-gray-500">Seção não implementada.</p>'}}catch(a){console.error("Erro crítico ao carregar aba:",a),t.innerHTML=`<div class="p-6 text-center text-red-500"><p>Erro ao carregar dados.</p><p class="text-xs mt-2">${v(a.message)}</p></div>`}}}function ri(e){const t=e?.dob?e.dob.split("/"):["",""],a=v(e?.name||""),s=v(e?.email||""),r=v(e?.phone||""),o=v(e?.notes||"");return`
    ...
    `}function ii(e,t){const a=(e||[]).filter(l=>{const d=(l.status||"").toLowerCase();return d==="completed"||d==="finished"||d==="paid"||d==="finalized"});let s=0;a.forEach(l=>{s+=Pa(l)});let r=ne&&ne.conversionRate?parseFloat(ne.conversionRate):Qn;r<=0&&(r=1);const o=Math.floor(s/r);let n=0;(t||[]).forEach(l=>{l.type==="redeem"&&(n+=l.points?Math.abs(l.points):0)});const i=o-n;return{totalSpent:s,totalPointsEarned:o,totalPointsRedeemed:n,currentBalance:i,moneyPerPoint:r}}function li(e,t,a){if(!ne||!ne.enabled)return`<div class="p-8 text-center text-gray-500">
        ...
        </div>`;const s=ii(t,a);e.loyaltyPoints=s.currentBalance,e.totalSpent=s.totalSpent;const r=(ne.tiers||[]).map(i=>{const l=s.currentBalance>=i.points,d=v(i.reward);return`
    ...
    `}function Uo(e){V=e,pa="detail";const t=e!==null,a=t?"Editar Cliente":"Adicionar Cliente",s=`
    ...
    `,r=window.innerWidth<768,o=r?"max-w-full":"max-w-3xl";if(J({title:a,contentHTML:s,maxWidth:o}),r){const d=document.getElementById("genericModal");if(d){const c=d.querySelector(`.${o.replace(":","\\:")}`);c&&(c.style.height="auto",c.style.maxHeight="85vh",c.style.borderRadius="1rem")}}const n=document.getElementById("genericModal");n&&(n.onclick=async d=>{const c=d.target.closest("[data-action]");if(!c)return;switch(c.dataset.action){case"redeem-reward":{const m=parseInt(c.dataset.points,10),g=c.dataset.reward;if(await j("Confirmar Resgate",`Deseja resgatar "${g}" por ${m} pontos?`))try{await ar(p.establishmentId,V.name,V.phone,{points:m,reward:g}),b("Prêmio resgatado com sucesso!","success"),await ba("fidelidade")}catch(h){b(`Erro ao resgatar: ${h.message}`,"error")}break}case"open-comanda-from-history":{const m=c.dataset.appointmentId;m&&(document.getElementById("genericModal").style.display="none",K("comandas-section",{selectedAppointmentId:m,initialFilter:"finalizada"}));break}case"view-appointment":{const m=c.dataset.appointmentId,g=c.dataset.appointmentDate;m&&g&&(document.getElementById("genericModal").style.display="none",K("agenda-section",{targetDate:g,scrollToAppointmentId:m}));break}case"save-client":{d.preventDefault(),oo();break}}}),ba("cadastro"),setTimeout(()=>{const d=document.getElementById("client-form");d&&d.addEventListener("submit",c=>{c.preventDefault(),oo()})},500);const i=document.getElementById("cancelDetailViewBtn");i&&i.addEventListener("click",d=>{d.preventDefault(),document.getElementById("genericModal").style.display="none",Vt()});const l=document.getElementById("deleteClientBtn");l&&l.addEventListener("click",async()=>{await di()})}async function oo(){const e=document.getElementById("client-form");if(!e)return;const t=e.querySelector("#clientId").value,a={name:e.querySelector("#clientName").value,email:e.querySelector("#clientEmail").value,phone:e.querySelector("#clientPhone").value,dob:`${e.querySelector("#clientDobDay").value}/${e.querySelector("#clientDobMonth").value}`,notes:e.querySelector("#clientNotes").value,establishmentId:p.establishmentId};if(!a.name||!a.phone){b("Erro","Nome e Telefone são obrigatórios.","error");return}try{t?(await Ks(t,a),b("Sucesso","Cliente atualizado com sucesso!","success")):(await Sa(a),b("Sucesso","Cliente cadastrado com sucesso!","success")),document.getElementById("genericModal").style.display="none",await Vt()}catch(s){b("Erro",`Não foi possível salvar: ${s.message}`,"error")}}async function di(){if(!V||!V.id)return;if(await j("Excluir Cliente",`Tem certeza que deseja excluir ${V.name}? Esta ação é irreversível.`))try{await er(V.id),b("Sucesso","Cliente excluído.","success"),document.getElementById("genericModal").style.display="none",await Vt()}catch(t){b("Erro",`Não foi possível excluir: ${t.message}`,"error")}}function kt(e,t){const a=document.getElementById("clientsList");if(a)if(a.innerHTML="",a.className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 content-start p-2 pb-20",document.getElementById("client-count").textContent=`${e.length} cliente${e.length!==1?"s":""} | Total: ${t}`,e.length>0){const s=Q==="inactive",r=Q==="birthdays";e.forEach(o=>{const n=document.createElement("div");n.className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 hover:shadow-md cursor-pointer transition-all flex flex-col justify-between h-full relative group",n.dataset.clientId=o.id;const i=o.loyaltyPoints||0,l=o.totalSpent||0;let d="";const u=`https://wa.me/55${o.phone?o.phone.replace(/\D/g,""):""}?text=`,m=v(o.name),g=v(o.phone);if(s){const f=encodeURIComponent(Zn(o.name,ga));d=`<a href="${u+f}" target="_blank" class="absolute top-2 right-2 text-blue-500 bg-blue-50 p-1 rounded-full z-10 hover:bg-blue-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM16.64 16.64C16.64 16.64 15.11 17.58 14.54 17.76C13.97 17.94 13.06 18.06 10.66 17.06C8.26 16.06 6.38 13.62 6.38 13.62C6.38 13.62 4.96 11.72 4.96 9.76C4.96 7.8 6.04 6.88 6.04 6.88C6.04 6.88 6.32 6.56 6.6 6.56C6.88 6.56 7.16 6.56 7.16 6.56C7.38 6.56 7.62 6.46 7.86 7.02C8.1 7.58 8.68 9.02 8.68 9.02C8.68 9.02 8.78 9.24 8.64 9.48C8.5 9.72 8.36 9.88 8.16 10.1C7.96 10.32 7.74 10.4 8.02 10.88C8.3 11.36 9.26 12.92 10.68 14.18C11.62 15.02 12.56 15.36 12.94 15.54C13.32 15.72 13.6 15.66 13.84 15.38C14.08 15.1 14.62 14.34 14.62 14.34C14.62 14.34 14.88 14.06 15.18 14.12C15.48 14.18 16.94 14.9 16.94 14.9C16.94 14.9 17.2 15.04 17.3 15.22C17.4 15.4 17.4 16.28 16.64 16.64Z"/></svg></a>`}else if(r&&ti(o)){const f=encodeURIComponent(Xn(o.name,ga));d=`<a href="${u+f}" target="_blank" class="absolute top-2 right-2 text-green-500 bg-green-50 p-1 rounded-full z-10 hover:bg-green-100"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M... (mesmo icone)"/></svg></a>`}n.innerHTML=`
                ${d}
            ...
            `,n.addEventListener("click",()=>Uo(o)),a.appendChild(n)})}else a.innerHTML='<p class="col-span-full text-center text-gray-500 py-10">Nenhum cliente encontrado com os filtros aplicados.</p>'}function St(e="",t="all"){const a=e.toLowerCase(),s=a.length>0;let r=0,o=90;const n=window.innerWidth<768;if(t==="birthdays"){const l=n?"mobileBirthMonthFilter":"birthMonthFilter",d=document.getElementById(l);d&&(r=parseInt(d.value,10))}else if(t==="inactive"){const l=n?"mobileInactiveDaysFilter":"inactiveDaysFilter",d=document.getElementById(l);d&&(o=parseInt(d.value,10))}let i=Te.filter(l=>!s||l.name.toLowerCase().includes(a)||(l.phone||"").includes(a));switch(t){case"birthdays":const l=new Date,d=l.getDate(),c=l.getMonth()+1;return i.filter(u=>{if(!u.dob)return!1;const m=u.dob.split("/");if(m.length!==2)return!1;const g=parseInt(m[0],10),f=parseInt(m[1],10);return r===99?g===d&&f===c:r===0?f>=1&&f<=12:f===r});case"inactive":return i.filter(u=>(u.lastAppointmentDaysAgo||ei())>o);case"credit":return i.filter(u=>(u.loyaltyPoints||0)>0);case"all":default:return i}}async function ci(e){const t=document.getElementById("birthMonthFilterContainer"),a=document.getElementById("mobileBirthMonthFilterContainer"),s=document.getElementById("inactiveDaysFilterContainer"),r=document.getElementById("mobileInactiveDaysFilterContainer"),o=e==="birthdays",n=e==="inactive";if([t,a].forEach(d=>d?.classList.toggle("hidden",!o)),[s,r].forEach(d=>d?.classList.toggle("hidden",!n)),o&&Q!=="birthdays"&&document.querySelectorAll("#birthMonthFilter, #mobileBirthMonthFilter").forEach(d=>d.value=99),n&&Q!=="inactive"&&document.querySelectorAll("#inactiveDaysFilter, #mobileInactiveDaysFilter").forEach(d=>d.value=90),Q===e&&!o&&!n)return;Q=e,document.querySelectorAll(".client-filter-btn").forEach(d=>{d.classList.remove("bg-white","text-indigo-600","shadow"),d.classList.add("bg-gray-100","text-gray-600")}),document.querySelectorAll(`[data-filter-key="${e}"]`).forEach(d=>{d.classList.remove("bg-gray-100","text-gray-600"),d.classList.add("bg-white","text-indigo-600","shadow")});const i=document.getElementById("clientSearchInput").value,l=St(i,Q);kt(l,Te.length)}async function Vt(){pa="list",Qt.innerHTML=`
    ...
    `;try{const[c,u]=await Promise.all([qt(p.establishmentId),qe(p.establishmentId)]);Te=c,ne=u.loyaltyProgram||{enabled:!1},ga=u.name||"O Estabelecimento";const m=St("",Q);kt(m,Te.length)}catch{const u=document.getElementById("clientsList");u&&(u.innerHTML='<p class="text-red-500 col-span-full text-center mt-10">Erro ao carregar dados dos clientes.</p>')}const e=document.getElementById("filter-sheet"),t=document.getElementById("filter-overlay"),a=document.getElementById("openFilterSheetBtn"),s=document.getElementById("closeFilterSheetBtn"),r=()=>{e.classList.remove("translate-y-full"),t.classList.remove("hidden")},o=()=>{e.classList.add("translate-y-full"),t.classList.add("hidden")};a&&a.addEventListener("click",r),s&&s.addEventListener("click",o),t&&t.addEventListener("click",o);const n=c=>{const u=c.target.closest(".client-filter-btn");if(u){ci(u.dataset.filterKey);const m=u.dataset.filterKey;window.innerWidth<768&&m!=="birthdays"&&m!=="inactive"&&o()}},i=document.getElementById("desktop-filter-bar"),l=document.getElementById("mobile-filter-list");i&&i.addEventListener("click",n),l&&l.addEventListener("click",n);const d=c=>{const u=document.getElementById(c);u&&u.addEventListener("change",()=>{if(Q==="birthdays"||Q==="inactive"){const m=document.getElementById("clientSearchInput").value,g=St(m,Q);kt(g,Te.length)}})};d("birthMonthFilter"),d("mobileBirthMonthFilter"),d("inactiveDaysFilter"),d("mobileInactiveDaysFilter"),Qt.addEventListener("click",async c=>{const u=c.target.closest("[data-action]");pa==="list"&&u&&u.dataset.action==="new-client"&&Uo(null)}),Qt.addEventListener("input",c=>{if(c.target.id==="clientSearchInput"){const u=c.target.value,m=St(u,Q);kt(m,Te.length)}})}const st=e=>y(`/api/financial/natures/${e}`),ui=e=>y("/api/financial/natures",{method:"POST",body:JSON.stringify(e)}),mi=e=>y(`/api/financial/natures/${e}`,{method:"DELETE"}),rt=e=>y(`/api/financial/cost-centers/${e}`),pi=e=>y("/api/financial/cost-centers",{method:"POST",body:JSON.stringify(e)}),gi=e=>y(`/api/financial/cost-centers/${e}`,{method:"DELETE"}),Jo=(e,t)=>y(`/api/financial/${e}`,{method:"POST",body:JSON.stringify(t)}),_o=(e,t={})=>{let a=`/api/financial/${e}`;const s=new URLSearchParams;t.establishmentId&&s.append("establishmentId",t.establishmentId),t.startDate&&s.append("startDate",t.startDate),t.endDate&&s.append("endDate",t.endDate),t.natureId&&s.append("natureId",t.natureId),t.costCenterId&&s.append("costCenterId",t.costCenterId),t.status&&s.append("status",t.status);const r=s.toString();return r&&(a+=`?${r}`),y(a)},Wo=(e,t,a)=>y(`/api/financial/${e}/${t}`,{method:"PUT",body:JSON.stringify(a)}),Go=(e,t)=>y(`/api/financial/${e}/${t}`,{method:"DELETE"}),Yo=(e,t,a)=>y(`/api/financial/${e}/${t}/status`,{method:"PATCH",body:JSON.stringify({status:"paid",paymentDate:a})}),bi=e=>Jo("payables",e),fi=e=>_o("payables",e),vi=(e,t)=>Wo("payables",e,t),hi=e=>Go("payables",e),xi=(e,t)=>Yo("payables",e,t),yi=e=>Jo("receivables",e),wi=e=>_o("receivables",e),ki=(e,t)=>Wo("receivables",e,t),Si=e=>Go("receivables",e),$i=(e,t)=>Yo("receivables",e,t),Ei=(e,t,a)=>y(`/api/financial/cash-flow?establishmentId=${e}&startDate=${t}&endDate=${a}`),Ii=e=>y(`/api/financial/today-summary/${e}`),he=document.getElementById("content"),Xt={monday:"Segunda",tuesday:"Terça",wednesday:"Quarta",thursday:"Quinta",friday:"Sexta",saturday:"Sábado",sunday:"Domingo"},Ci={indigo:{name:"Padrão (Índigo)",main:"#4f46e5"},blue:{name:"Azul",main:"#2563eb"},sky:{name:"Céu",main:"#0284c7"},teal:{name:"Verde Água",main:"#0d9488"},emerald:{name:"Esmeralda",main:"#059669"},green:{name:"Verde",main:"#16a34a"},lime:{name:"Lima",main:"#65a30d"},amber:{name:"Âmbar",main:"#d97706"},orange:{name:"Laranja",main:"#ea580c"},red:{name:"Vermelho",main:"#dc2626"},rose:{name:"Rosa",main:"#e11d48"},pink:{name:"Pink",main:"#db2777"},fuchsia:{name:"Fúcsia",main:"#c026d3"},purple:{name:"Roxo",main:"#7c3aed"},violet:{name:"Violeta",main:"#8b5cf6"},gray:{name:"Cinza",main:"#4b5563"},black:{name:"Preto",main:"#111827"}},Qo=[{id:"personal-data",icon:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",label:"Dados Gerais"},{id:"branding",icon:"M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z",label:"Identidade e Cores"},{id:"booking",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",label:"Agendamento Online"},{id:"working-hours",icon:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",label:"Horário de Funcionamento"},{id:"loyalty",icon:"M5 5a2 2 0 012-2h10a2 2 0 012 2v1h2a1 1 0 011 1v3a1 1 0 01-1 1h-2v1a2 2 0 01-2 2H7a2 2 0 01-2-2v-1H3a1 1 0 01-1-1V7a1 1 0 011-1h2V5z",label:"Plano de Fidelidade"},{id:"financial",icon:"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8a1 1 0 011 1v4a1 1 0 11-2 0v-4a1 1 0 011-1zm0 0a1 1 0 001-1V5a1 1 0 10-2 0v2a1 1 0 001 1zm0 0a1 1 0 011 1v2a1 1 0 11-2 0v-2a1 1 0 011-1z",label:"Integração Financeira"},{id:"change-password",icon:"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",label:"Alterar senha"},{id:"change-email",icon:"M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207",label:"Alterar E-mail de Acesso"}];let G=null;function so(e,t,a){return new Promise((s,r)=>{const o=new FileReader;o.readAsDataURL(e),o.onload=n=>{const i=new Image;i.src=n.target.result,i.onload=()=>{const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c*=t/d,d=t),l.width=d,l.height=c,l.getContext("2d").drawImage(i,0,0,d,c);const m=e.type==="image/png"&&t<500?"image/png":"image/jpeg";s(l.toDataURL(m,a))},i.onerror=l=>r(l)},o.onerror=n=>r(n)})}function Ee(e,t=null){let a='<option value="">-- Selecione (Opcional) --</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i="")=>{const l=n.id===t?"selected":"";a+=`<option value="${n.id}" ${l}>${i}${v(n.name)}</option>`,n.children.forEach(d=>r(d,i+"— "))};return s(e).forEach(n=>r(n)),a}async function Re(e,t){const a=t.target.querySelector('button[type="submit"]');a&&(a.disabled=!0,a.textContent="A Salvar...");try{const s=G||await qe(p.establishmentId),r=[],{ownerName:o,...n}=e;if(o&&o!==p.userName){const l=Y.currentUser;l&&r.push(is(l,{displayName:o}).then(()=>{p.userName=o}))}const i={...s,...n};if(r.push(Ls(p.establishmentId,i)),await Promise.all(r),G=i,b("Sucesso","Definições salvas com sucesso! A página será recarregada para aplicar o novo tema.","success"),n.themeColor)setTimeout(()=>window.location.reload(),1500);else{const l=document.getElementById("panelEstablishmentName");n.name&&l&&(l.textContent=n.name,p.establishmentName=n.name)}}catch(s){b("Erro",`Não foi possível salvar: ${s.message}`,"error")}finally{a&&(a.disabled=!1,a.textContent="Salvar")}}function Li(e,t){const a=v(e.name||""),s=v(e.phone||""),r=v(e.document||""),o=v(e.email||""),n=v(e.address||""),i=v(e.website||""),l=v(p.userName||"");t.innerHTML=`
    ...
    `,t.querySelector("#change-email-form").addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#newEmail").value,r=t.querySelector("#currentPassword").value;if(!s||!r){b("Erro","Preencha todos os campos.","error");return}const o=t.querySelector('button[form="change-email-form"]');o.disabled=!0,o.textContent="A verificar...";try{const n=Y.currentUser;if(!n)throw new Error("Usuário não autenticado.");const i=os.credential(n.email,r);await ss(n,i),o.textContent="A enviar link...",await rs(n,s),o.textContent="A atualizar BD...",await Bs(p.establishmentId,s),b("Sucesso","Link de verificação enviado! Por favor, verifique seu **novo e-mail** para confirmar a alteração.","success"),a.target.reset()}catch(n){let i="Não foi possível alterar o e-mail.";n.code==="auth/wrong-password"?i="A senha atual está incorreta.":n.code==="auth/email-already-in-use"?i="Este e-mail já está sendo usado por outra conta.":n.code==="auth/operation-not-allowed"?i="A troca de e-mail precisa ser habilitada no console do Firebase.":i=n.message,b("Erro",i,"error")}finally{o.disabled=!1,o.textContent="Salvar Novo E-mail"}})}function Di(e,t){const a=v(e.welcomeMessage||"");t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-6">
    ...
    `;const a=t.querySelector("#establishmentTimezone");if(e.timezone)a.value=e.timezone;else try{const o=Intl.DateTimeFormat().resolvedOptions().timeZone;Array.from(a.options).some(i=>i.value===o)?a.value=o:a.value="America/Sao_Paulo"}catch{a.value="America/Sao_Paulo"}const s=t.querySelector("#establishmentWorkingHoursContainer"),r=e.workingHours||{};Object.keys(Xt).forEach(o=>{const n=r[o]||{},i=Xt[o],l=n.active!==!1,d=document.createElement("div");d.className=`day-schedule-card p-4 rounded-lg ${l?"bg-gray-50":"bg-gray-100 disabled"}`,d.innerHTML=`
            ...
            </div>`,s.appendChild(d)}),s.addEventListener("change",o=>{const n=o.target.closest('.day-schedule-card input[type="checkbox"]');n&&n.closest(".day-schedule-card").classList.toggle("disabled",!n.checked)}),t.querySelector("#working-hours-form").addEventListener("submit",o=>{o.preventDefault();const n={};Object.keys(Xt).forEach(l=>{n[l]={active:t.querySelector(`#est-${l}-active`).checked,start:t.querySelector(`#est-${l}-start`).value,end:t.querySelector(`#est-${l}-end`).value,breakStart:t.querySelector(`#est-${l}-breakStart`).value,breakEnd:t.querySelector(`#est-${l}-breakEnd`).value}});const i=t.querySelector("#establishmentTimezone").value;Re({workingHours:n,timezone:i},o)})}function Ai(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
             <div class="flex justify-between items-center mb-6">
    ...
    `;try{const[a,s]=await Promise.all([st(p.establishmentId),rt(p.establishmentId)]),r=e.financialIntegration||{},o=e.commissionConfig||{},n=e.purchaseConfig||{};t.querySelector("#financialNatureId").innerHTML=Ee(a,r.defaultNaturezaId),t.querySelector("#financialCostCenterId").innerHTML=Ee(s,r.defaultCentroDeCustoId),t.querySelector("#purchaseNatureId").innerHTML=Ee(a,n.defaultNatureId),t.querySelector("#purchaseCostCenterId").innerHTML=Ee(s,n.defaultCostCenterId),t.querySelector("#commissionNatureId").innerHTML=Ee(a,o.defaultNatureId),t.querySelector("#commissionCostCenterId").innerHTML=Ee(s,o.defaultCostCenterId)}catch{b("Erro","Não foi possível carregar os dados para a integração financeira.","error")}t.querySelector("#financial-form").addEventListener("submit",a=>{a.preventDefault();const s={financialIntegration:{defaultNaturezaId:t.querySelector("#financialNatureId").value||null,defaultCentroDeCustoId:t.querySelector("#financialCostCenterId").value||null},purchaseConfig:{defaultNatureId:t.querySelector("#purchaseNatureId").value||null,defaultCostCenterId:t.querySelector("#purchaseCostCenterId").value||null},commissionConfig:{defaultNatureId:t.querySelector("#commissionNatureId").value||null,defaultCostCenterId:t.querySelector("#commissionCostCenterId").value||null}};Re(s,a)})}function qi(e,t){t.innerHTML=`
        <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-gray-800">${e}</h3>
            <p class="mt-4 text-gray-500">Esta secção ainda não foi implementada.</p>
        </div>
    `}function Xo(e="indigo",t){const a=t.querySelector("#color-palette-container"),s=t.querySelector("#establishmentThemeColor");!a||!s||(a.innerHTML="",Object.entries(Ci).forEach(([r,o])=>{const n=r===e,i=document.createElement("div");i.className="w-24 text-center cursor-pointer mb-4",i.innerHTML=`
        ...
        `,i.addEventListener("click",()=>{s.value=r,Xo(r,t)}),a.appendChild(i)}),s.value=e)}function Fi(e,t){const a=t.querySelector("#slotIntervalContainer"),s=t.querySelector("#establishmentSlotInterval");if(!a||!s)return;const r=[{label:"10 min",value:10},{label:"15 min",value:15},{label:"20 min",value:20},{label:"30 min",value:30},{label:"45 min",value:45},{label:"1 hora",value:60}];a.innerHTML=r.map(o=>{const n=o.value===e;return`<button type="button" data-value="${o.value}" 
    ...
    `,he.querySelector('button[data-action="back-to-list"]').addEventListener("click",s=>{s.preventDefault(),Zo()});const a=document.getElementById("settings-content-detail");switch(e){case"personal-data":Li(G,a);break;case"change-password":Ti(G,a);break;case"change-email":Bi(G,a);break;case"branding":Di(G,a);break;case"booking":Pi(G,a);break;case"working-hours":Mi(G,a);break;case"loyalty":Ai(G,a);break;case"financial":await Ni(G,a);break;default:qi(t?t.label:"Definições",a)}}async function Zo(){if(he.innerHTML=`
    ...
    `,!G)try{G=await qe(p.establishmentId)}catch{b("Erro Fatal","Não foi possível carregar os dados do estabelecimento.","error"),he.innerHTML='<p class="text-red-500">Erro ao carregar dados.</p>';return}const e=Y.currentUser;e&&e.displayName&&(p.userName=e.displayName);const t=v(p.userName||Y.currentUser.email),a=t?t.charAt(0).toUpperCase():"U";he.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-yellow-500" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" /></svg>
                Definições
        ...
        <div data-action="go-to-my-profile" class="bg-white p-4 rounded-lg shadow-md mb-6 cursor-pointer hover:bg-gray-50 transition-all">
            <div class="text-center relative">
                ...
                <div class="absolute top-0 right-0 p-2 text-gray-400 hover:text-indigo-600" title="Ver Meu Perfil">
                 ...
                 ${p.userName&&p.userName!==Y.currentUser.email?`<p class="text-sm text-gray-500">${v(Y.currentUser.email)}</p>`:""}
    ...
    `,he.querySelector("#settings-menu-list").addEventListener("click",r=>{const o=r.target.closest("button[data-section]");o&&(r.preventDefault(),Ri(o.dataset.section))});const s=he.querySelector('[data-action="go-to-my-profile"]');s&&s.addEventListener("click",r=>{r.preventDefault(),K("my-profile-section")})}const Xe=document.getElementById("content");async function De(e){const t=document.getElementById("blockagesList");if(t){t.innerHTML='<div class="loader mx-auto"></div>';try{const a=document.getElementById("filterStartDate")?.value,s=document.getElementById("filterEndDate")?.value,r=await At(p.establishmentId,a||new Date().toISOString().split("T")[0],s||new Date().toISOString().split("T")[0],e),o=document.getElementById("filterReason")?.value.toLowerCase(),n=o?r.filter(l=>l.reason&&l.reason.toLowerCase().includes(o)):r,i=n.reduce((l,d)=>{const c=d.reason||"Sem motivo";return l[c]||(l[c]=[]),l[c].push(d),l},{});if(t.innerHTML="",n.length===0){t.innerHTML='<p class="text-center text-gray-500">Nenhum bloqueio encontrado.</p>';return}Object.entries(i).forEach(([l,d])=>{const c=document.createElement("div");c.className="bg-gray-100 rounded-lg p-3 my-2 space-y-2";let m=`<div class="flex justify-between items-center pb-2 border-b border-gray-200">
                    ...
                    </div>`;c.innerHTML+=E}),t.appendChild(c)})}catch(a){t.innerHTML=`<p class="text-center text-red-500">Erro: ${a.message}</p>`}}}async function ji(e){e.preventDefault();const t=e.target,a=t.querySelector("#blockageProfId").value,s=t.querySelector("#blockageDate").value,r=t.querySelector("#blockageEndDate").value||s,o=t.querySelector("#blockageStartTime").value,n=t.querySelector("#blockageEndTime").value,i={establishmentId:p.establishmentId,professionalId:a,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:t.querySelector("#blockageReason").value};try{await Nt(i),t.reset(),b("Sucesso","Bloqueio adicionado com sucesso!","success"),De(a)}catch(l){b("Erro",`Não foi possível criar o bloqueio: ${l.message}`,"error")}}async function Hi(e){e.preventDefault();const t=e.target,a=Array.from(t.querySelectorAll('input[name="batch-professionals"]:checked')).map(c=>c.value);if(a.length===0)return b("Atenção","Selecione pelo menos um profissional.","error");const s=t.querySelector("#batchBlockageDate").value,r=t.querySelector("#batchBlockageEndDate").value||s,o=t.querySelector("#batchBlockageStartTime").value,n=t.querySelector("#batchBlockageEndTime").value,i=t.querySelector("#batchBlockageReason").value,l=t.querySelector('button[type="submit"]');l.disabled=!0,l.textContent="Aguarde...";const d=a.map(c=>{const u={establishmentId:p.establishmentId,professionalId:c,startTime:new Date(`${s}T${o}:00`).toISOString(),endTime:new Date(`${r}T${n}:00`).toISOString(),reason:i};return Nt(u)});try{await Promise.all(d),b("Sucesso",`${a.length} bloqueios foram criados com sucesso!`,"success"),t.reset(),t.querySelectorAll('input[name="batch-professionals"]:checked').forEach(u=>u.checked=!1);const c=document.getElementById("blockageProfId").value;c&&De(c)}catch(c){b("Erro",`Ocorreu um erro: ${c.message}`,"error")}finally{l.disabled=!1,l.textContent="Adicionar Bloqueio em Lote"}}function Oi(e){Xe.addEventListener("submit",t=>{t.target.id==="blockageForm"&&ji(t),t.target.id==="batchBlockageForm"&&Hi(t)}),Xe.addEventListener("input",t=>{t.target.matches("#filterStartDate, #filterEndDate, #filterReason")&&De(e)}),Xe.addEventListener("click",async t=>{const a=t.target.closest("button[data-action]");if(!a)return;const s=a.dataset.action;if(s==="back-to-professionals")K("profissionais-section");else if(s==="delete-blockage"){if(await j("Apagar Bloqueio","Tem a certeza que deseja apagar este bloqueio?"))try{await ka(a.dataset.id),b("Sucesso","Bloqueio removido.","success"),De(e)}catch(o){b("Erro",`Não foi possível remover o bloqueio: ${o.message}`,"error")}}else if(s==="batch-delete-blockage"){const r=JSON.parse(a.dataset.ids);if(await j("Apagar Lote de Bloqueios",`Tem certeza que deseja apagar ${r.length} bloqueios de uma vez?`))try{await Lo(r),b("Sucesso",`${r.length} bloqueios removidos.`,"success"),De(e)}catch(n){b("Erro",`Não foi possível apagar os bloqueios: ${n.message}`,"error")}}})}async function zi(e){const{professionalId:t,professionalName:a}=e;if(!t||!a){Xe.innerHTML='<p class="text-red-500 p-8">Erro: ID do profissional não fornecido.</p>';return}const s=v(a);Xe.innerHTML=`
        <section>
        ...
        </section>`,Oi(t),await De(t);const r=document.getElementById("batchProfSelectionContainer");try{const o=await X(p.establishmentId);r.innerHTML=o.map(n=>`
            <div class="flex items-center">
            ...
            </div>`).join("")}catch{r.innerHTML='<p class="text-red-500">Erro ao carregar profissionais.</p>'}}const Vi=e=>y(`/api/users/${e}`),Ui=e=>y("/api/users",{method:"POST",body:JSON.stringify(e)}),Ji=(e,t)=>y(`/api/users/${e}`,{method:"PUT",body:JSON.stringify(t)}),_i=e=>y(`/api/users/${e}`,{method:"DELETE"}),Wi=(e,t)=>y(`/api/users/${e}/password`,{method:"PUT",body:JSON.stringify({password:t})}),Gi=(e,t)=>y(`/api/users/${e}/status`,{method:"PATCH",body:JSON.stringify({status:t})}),be=document.getElementById("content"),Yi={"agenda-section":"Agenda","comandas-section":"Comandas","relatorios-section":"Relatórios Gerais","sales-report-section":"Relatório de Vendas (Caixa)","financial-section":"Financeiro","servicos-section":"Serviços","produtos-section":"Produtos","suppliers-section":"Fornecedores","profissionais-section":"Profissionais","ausencias-section":"Ausências e Bloqueios","clientes-section":"Clientes","packages-section":"Pacotes","commissions-section":"Comissões","estabelecimento-section":"Configurações do Estabelecimento","users-section":"Usuários e Acessos"},Qi={view:"Visualizar",create:"Criar",edit:"Editar"};let ze=null,Ve=null;function Xi(e){const t=document.getElementById("usersListContainer");if(!t)return;const a=document.getElementById("showInactiveUsersToggle")?.checked;if(e.length===0){const s=a?"Nenhum usuário encontrado.":"Nenhum usuário ativo cadastrado.";t.innerHTML=`<p class="col-span-full text-center text-gray-500">${s}</p>`;return}e.sort((s,r)=>(s.status==="active"?-1:1)-(r.status==="active"?-1:1)),t.innerHTML=e.map(s=>{const r=JSON.stringify(s).replace(/'/g,"&apos;"),o=s.status==="active",n=p.professionals.find(c=>c.id===s.professionalId),i=n?n.name:"N/A",l=n?n.name.charAt(0):s.name.charAt(0),d=n?.photo||`https://placehold.co/64x64/E2E8F0/4A5568?text=${encodeURIComponent(l)}`;return`
    ...
    `}).join("")}function $t(){const e=document.getElementById("showInactiveUsersToggle")?.checked;let t;e?t=p.users:t=p.users.filter(a=>a.status==="active"),Xi(t)}function Zi(e={}){return Object.entries(Yi).map(([t,a])=>{const s=t==="agenda-section"||t==="comandas-section",r=e[t]?.view_all_prof===!0,o=Object.entries(Qi).map(([i,l])=>`
    ...
    `}).join("")}async function ro(e=null){document.getElementById("user-list-view").classList.add("hidden");const t=document.getElementById("user-form-view");t.classList.remove("hidden");let a=p.professionals;if(!a||a.length===0)try{a=await X(p.establishmentId),p.professionals=a}catch{b("Erro","Não foi possível carregar a lista de profissionais.","error")}const s=S=>a.find(I=>I.id===S),r=(S,I)=>{const k=s(S)?.photo,C=I.charAt(0).toUpperCase();return{photoSrc:k||`https://placehold.co/128x128/E2E8F0/4A5568?text=${C}`,initials:C,photoUrl:k||""}},o=e?.professionalId,n=e?.name||"Novo Usuário",i=r(o,n),l=s(o),d=S=>{let I='<option value="">-- Não Associado a um Profissional --</option>';return I+=a.map(E=>`<option value="${E.id}" ${E.id===S?"selected":""}>${E.name} (${E.specialty||"N/A"})</option>`).join(""),I},c=e!==null;t.querySelector("#userFormTitle").textContent=c?`Editar Usuário: ${e.name}`:"Novo Usuário";const u=t.querySelector("#userForm");u.innerHTML=`
    ...
    `;const m=window.innerWidth<768,g=u.querySelector(".bg-white");if(m&&g){g.classList.remove("rounded-xl","shadow-2xl","sm:p-6");const S=u.closest("section");S&&(S.style.padding="0",S.style.margin="0"),g.classList.add("p-4")}const f=u.querySelector("#userProfessionalId"),h=u.querySelector("#userPhotoPreview"),w=u.querySelector("#profPhotoName");if(f.addEventListener("change",S=>{const I=S.target.value,E=s(I),k=E?E.name:"Selecione um profissional",C=r(I,n);h.src=C.photoSrc,w.textContent=k,u.querySelector("#professionalPhotoUrl").value=C.photoUrl}),u.addEventListener("submit",async S=>{S.preventDefault();const I=e?.email,E=u.querySelector("#userEmail").value,k={};u.querySelectorAll('input[type="checkbox"]').forEach(H=>{const L=H.dataset.module,T=H.dataset.permission;k[L]||(k[L]={}),k[L][T]=H.checked});const C=u.querySelector("#userProfessionalId").value||null,F={name:u.querySelector("#userName").value,permissions:k,professionalId:C,establishmentId:p.establishmentId};try{c?(I!==E&&(F.email=E),await Ji(e.id,F),b("Usuário atualizado com sucesso!","success")):(F.email=u.querySelector("#userEmail").value,F.password=u.querySelector("#userPassword").value,await Ui(F),b("Usuário criado com sucesso!","success")),Ct()}catch(H){b(`Erro: ${H.message}`,"error")}}),c){const S=u.querySelector("#password-change-container"),I=S.querySelector('[data-action="show-password-form"]'),E=S.querySelector("#password-form"),k=E.querySelector('[data-action="save-password"]'),C=E.querySelector('[data-action="cancel-password-change"]');I.addEventListener("click",()=>{I.classList.add("hidden"),E.classList.remove("hidden")}),C.addEventListener("click",()=>{I.classList.remove("hidden"),E.classList.add("hidden"),E.querySelector("#userNewPassword").value=""}),k.addEventListener("click",async()=>{const F=E.querySelector("#userNewPassword").value;if(!F||F.length<6){b("Senha inválida","A nova senha deve ter pelo menos 6 caracteres.","error");return}if(await j("Alterar Senha","Tem a certeza que deseja alterar a senha deste usuário?"))try{k.disabled=!0,k.textContent="Aguarde...",await Wi(e.id,F),b("Sucesso!","A senha do usuário foi alterada.","success"),I.classList.remove("hidden"),E.classList.add("hidden"),E.querySelector("#userNewPassword").value=""}catch(L){b("Erro",`Não foi possível alterar a senha: ${L.message}`,"error")}finally{k.disabled=!1,k.textContent="Salvar Nova Senha"}})}}async function Ki(){const e=document.getElementById("usersListContainer");e.innerHTML='<div class="loader col-span-full mx-auto"></div>';try{const[t,a]=await Promise.all([Vi(p.establishmentId),X(p.establishmentId)]);p.users=t,p.professionals=a,$t()}catch{b("Erro ao carregar usuários.","error"),e.innerHTML='<p class="col-span-full text-center text-red-500">Não foi possível carregar os usuários.</p>'}}async function Ct(){be.innerHTML=`
    ...
    `,ze&&be.removeEventListener("click",ze),Ve&&be.removeEventListener("change",Ve),ze=async e=>{if(!document.getElementById("user-list-view")){be.removeEventListener("click",ze);return}const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"new-user":ro();break;case"edit-user":const s=JSON.parse(t.dataset.user.replace(/&apos;/g,"'"));ro(s);break;case"back-to-list":Ct();break;case"delete-user":{e.stopPropagation();const r=t.dataset.userId;if(await j("Excluir Usuário","Tem certeza que deseja excluir este usuário? Esta ação é irreversível."))try{await _i(r),b("Usuário excluído com sucesso!","success"),Ct()}catch(n){b(`Erro ao excluir: ${n.message}`,"error")}break}}},Ve=async e=>{if(!document.getElementById("user-list-view")){be.removeEventListener("change",Ve);return}const t=e.target.closest('input[data-action="toggle-user-status"]');if(e.target.id==="showInactiveUsersToggle")$t();else if(t){e.stopPropagation();const a=t.dataset.userId,s=t.checked?"active":"inactive";try{await Gi(a,s),b(`Usuário ${s==="active"?"ativado":"inativado"} com sucesso.`,"success");const r=p.users.findIndex(o=>o.id===a);r>-1&&(p.users[r].status=s,$t())}catch(r){b(`Erro ao atualizar status: ${r.message}`,"error"),t.checked=!t.checked,$t()}}},be.addEventListener("click",ze),be.addEventListener("change",Ve),await Ki()}const el=document.getElementById("content");let no={},fa=null;function tl(){Object.values(no).forEach(e=>e?.destroy()),no={}}function al(e,t){if(!window.jspdf){b("Erro","Biblioteca PDF não carregada.","error");return}const{jsPDF:a}=window.jspdf,s=new a({orientation:"landscape",unit:"px",format:"a4"}),r=document.getElementById("salesReportSummaryCards");if(s.setFontSize(18),s.text(e,s.internal.pageSize.getWidth()/2,40,{align:"center"}),r){const n=[["Receita Total",r.querySelector("#summary-revenue").textContent],["Vendas Totais",r.querySelector("#summary-transactions").textContent],["Ticket Médio",r.querySelector("#summary-avg-ticket").textContent]];s.autoTable({startY:60,head:[["Métrica","Valor"]],body:n,theme:"striped",headStyles:{fillColor:[79,70,229]}})}const o=s.lastAutoTable?s.lastAutoTable.finalY+20:60;s.text("Detalhes das Vendas",20,o),s.autoTable({html:`#${t}`,startY:o+10,theme:"grid",headStyles:{fillColor:[22,163,74]}}),s.save(`${e.replace(/[\s/]/g,"_").toLowerCase()}.pdf`)}function io(e){const t=document.getElementById("genericModal"),a=v(e.client),s=v(e.items),r=v(e.responsavelCaixa||"N/A"),o=(e.payments||[]).map(n=>`
    ...
    `,t.style.display="flex"}function ol(e){const{summary:t,transactions:a}=e;document.getElementById("summary-revenue").textContent=`R$ ${t.totalRevenue.toFixed(2)}`,document.getElementById("summary-transactions").textContent=t.totalTransactions,document.getElementById("summary-avg-ticket").textContent=`R$ ${t.averageTicket.toFixed(2)}`;const s=document.getElementById("paymentSummaryTableBody"),r=Object.entries(t.paymentMethodTotals).sort(([,i],[,l])=>l-i);s.innerHTML=r.map(([i,l])=>`
        <tr class="border-b">
    ...
    `}).join(""),o.querySelectorAll("tr").forEach(i=>{i.addEventListener("dblclick",()=>{const l=i.dataset.transactionIndex,d=fa.transactions[l];d&&io(d)})}),n.innerHTML=a.map((i,l)=>{const d=v(i.client),c=v(i.items),u=v(i.type);return`
    ...
    `}).join(""),n.querySelectorAll("div[data-transaction-index]").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.transactionIndex,d=fa.transactions[l];d&&io(d)})})}async function lo(){const e=document.getElementById("main-reports-view"),t=document.getElementById("reportStartDate"),a=document.getElementById("reportEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r)return b("Atenção","Por favor, selecione as datas de início e fim.","error");e.innerHTML='<div class="p-8 text-center"><div class="loader mx-auto"></div><p class="mt-4">A gerar relatório...</p></div>';try{const o=document.getElementById("cashierSessionFilter").value,n=await _s({establishmentId:p.establishmentId,startDate:s,endDate:r,cashierSessionId:o});fa=n,e.innerHTML=`
        ...
        `,ol(n)}catch(o){b("Erro",`Não foi possível carregar o relatório: ${o.message}`,"error"),e.innerHTML=`<p class="p-8 text-center text-red-500">${v(o.message)}</p>`}}async function sl(){tl();const e=new Date().toISOString().split("T")[0],t=new Date;t.setDate(t.getDate()-30);const a=t.toISOString().split("T")[0];el.innerHTML=`
        ...
        </section>`,document.getElementById("generateReportBtn").addEventListener("click",lo),document.getElementById("exportPdfBtn").addEventListener("click",()=>{const s=document.getElementById("reportStartDate").value,r=document.getElementById("reportEndDate").value,o=`Relatorio_Vendas_${s}_a_${r}`;al(o,"transactionsTable")});try{const s=await Mr(p.establishmentId),r=document.getElementById("cashierSessionFilter");s&&s.length>0&&s.forEach(o=>{const n=new Date(o.openTime).toLocaleString("pt-BR",{dateStyle:"short"}),i=v(o.closedByName||"N/A");r.innerHTML+=`<option value="${o.id}">${i} - ${n}</option>`})}catch{b("Erro","Não foi possível carregar o histórico de caixas para o filtro.","error")}await lo()}const rl=document.getElementById("content");let B={payables:[],receivables:[],natures:[],costCenters:[],currentFilter:"pending",startDate:new Date(new Date().getFullYear(),new Date().getMonth()-1,1).toISOString().split("T")[0],endDate:new Date().toISOString().split("T")[0],previousBalance:0,filterNaturezaId:"all",filterCostCenterId:"all",currentListView:"receivables"},Zt=null,pt=null,gt=null;function Ma(e){const t=new Map,a=[];return e&&(e.forEach(s=>t.set(s.id,{...s,children:[]})),t.forEach(s=>{s.parentId&&t.has(s.parentId)?t.get(s.parentId).children.push(s):a.push(s)})),a}function Ko(e,t,a){if(!e)return;if(!t||t.length===0){e.innerHTML='<p class="text-center text-gray-500">Nenhum item criado.</p>';return}const s=(r,o=0)=>{const n="— ".repeat(o);return`
        ...
        `};e.innerHTML=t.map(r=>s(r)).join("")}async function co(e){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const t=document.getElementById("genericModal"),a=e==="nature",s=`Gerir ${a?"Naturezas Financeiras":"Centros de Custo"}`,r=a?st:rt,o=a?"natures":"costCenters";t.innerHTML=`
        ...
        </div>`,t.style.display="flex";const n=t.querySelector("#hierarchyList"),i=t.querySelector("#itemParent"),l=c=>{const u=Ma(c);if(Ko(n,u,e),i){i.innerHTML='<option value="">-- Nível Principal --</option>';const m=(g,f="",h=0)=>{const w=h>0?"— ".repeat(h):"";i.innerHTML+=`<option value="${g.id}">${w}${g.name}</option>`,g.children.forEach(S=>m(S,f+"— "))};u.forEach(g=>m(g))}};try{const c=await r(p.establishmentId);B[o]=c,l(c)}catch(c){console.error(c)}const d=t.querySelector("#hierarchyForm");d&&d.addEventListener("submit",async c=>{c.preventDefault();const u=t.querySelector("#itemName");if(!u)return;const m=u.value,g=i.value,f=a?ui:pi;try{await f({name:m,parentId:g||null,establishmentId:p.establishmentId});const h=await r(p.establishmentId);B[o]=h,l(h),d.reset(),await ye()}catch(h){b("Erro",`Não foi possível criar: ${h.message}`,"error")}})}function nl(e){const t=document.getElementById("cashFlowChart");if(!t)return;const a=t.getContext("2d");Zt&&Zt.destroy();const s=e.payables.map(r=>r*-1);Zt=new Chart(a,{type:"bar",data:{labels:e.labels,datasets:[{label:"Receitas",data:e.receivables,backgroundColor:"rgba(74, 222, 128, 0.6)",borderColor:"rgba(34, 197, 94, 1)",borderWidth:1,yAxisID:"y"},{label:"Despesas",data:s,backgroundColor:"rgba(248, 113, 113, 0.6)",borderColor:"rgba(239, 68, 68, 1)",borderWidth:1,yAxisID:"y"},{label:"Saldo Acumulado",data:e.expectedBalance,type:"line",borderColor:"rgba(59, 130, 246, 1)",backgroundColor:"rgba(59, 130, 246, 0.2)",borderWidth:3,pointRadius:4,pointBackgroundColor:"rgba(59, 130, 246, 1)",fill:!0,tension:.1,yAxisID:"y1"}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{x:{stacked:!0},y:{type:"linear",display:!0,position:"left",stacked:!0,title:{display:!0,text:"Movimentações (R$)"}},y1:{type:"linear",display:!0,position:"right",title:{display:!0,text:"Saldo Acumulado (R$)"},grid:{drawOnChartArea:!1}}},plugins:{tooltip:{callbacks:{label:function(r){let o=r.dataset.label||"";if(o&&(o+=": "),r.parsed.y!==null){const n=Math.abs(r.parsed.y);o+=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(n)}return o}}}}}})}async function uo(){const e=document.getElementById("cash-flow-chart-container"),t=document.getElementById("cashFlowStartDate"),a=document.getElementById("cashFlowEndDate");if(!e||!t||!a)return;const s=t.value,r=a.value;if(!s||!r){b("Atenção","Por favor, selecione as datas de início e fim.","error");return}e.innerHTML='<div class="loader mx-auto my-10"></div>';try{const o=await Ei(p.establishmentId,s,r);document.getElementById("cash-flow-chart-container")&&(e.innerHTML='<canvas id="cashFlowChart"></canvas>',nl(o))}catch(o){document.getElementById("cash-flow-chart-container")&&(e.innerHTML=`<p class="text-red-500 text-center">Erro ao carregar dados do gráfico: ${o.message}</p>`)}}function mo(){document.getElementById("fab-menu")?.classList.add("hidden"),document.getElementById("main-fab-btn")?.classList.remove("rotate-45");const e=document.getElementById("genericModal"),t=new Date,a=new Date(t.getFullYear(),t.getMonth(),1).toISOString().split("T")[0],s=t.toISOString().split("T")[0];e.innerHTML=`
    ...
    `,e.style.display="flex"}function ll(){const e=document.getElementById("genericModal");e.innerHTML=`
        <div class="modal-content max-w-lg">
            <div class="flex justify-between items-center mb-6">
    ...
    `,e.style.display="flex"}function bt(e,t="all"){let a='<option value="all">Todos</option>';const s=n=>{const i=new Map,l=[];return n&&(n.forEach(d=>i.set(d.id,{...d,children:[]})),i.forEach(d=>{d.parentId&&i.has(d.parentId)?i.get(d.parentId).children.push(d):l.push(d)})),l},r=(n,i=0)=>{const l=i>0?"— ".repeat(i):"",d=n.id===t?"selected":"";a+=`<option value="${n.id}" ${d}>${l}${n.name}</option>`,n.children.forEach(c=>r(c,i+1))};return s(e).forEach(n=>r(n)),a}async function ye(){const e=document.getElementById("financial-content");if(!e)return;const t=document.getElementById("filterStartDate"),a=document.getElementById("filterEndDate");if(!t||!a)return;const s=t.value,r=a.value,o=document.getElementById("filterNaturezaId")?.value,n=document.getElementById("filterCostCenterId")?.value;if(!s||!r){try{const[d,c]=await Promise.all([st(p.establishmentId),rt(p.establishmentId)]);if(!document.getElementById("financial-content"))return;B={...B,natures:d,costCenters:c},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=bt(B.natures)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=bt(B.costCenters))}catch(d){b("Erro",`Não foi possível carregar os dados base: ${d.message}`,"error")}va(),go();return}const i=document.getElementById("payables-list"),l=document.getElementById("receivables-list");i&&(i.innerHTML='<div class="loader mx-auto"></div>'),l&&(l.innerHTML='<div class="loader mx-auto"></div>');try{const d={startDate:s,endDate:r,establishmentId:p.establishmentId};o&&o!=="all"&&(d.natureId=o),n&&n!=="all"&&(d.costCenterId=n);const[c,u,m,g]=await Promise.all([fi(d),wi(d),st(p.establishmentId),rt(p.establishmentId)]);if(!document.getElementById("financial-content"))return;const f=(u.previousBalance||0)-(c.previousBalance||0);B={...B,payables:c.entries||[],receivables:u.entries||[],natures:m||[],costCenters:g||[],previousBalance:f,filterNaturezaId:o,filterCostCenterId:n},document.getElementById("filterNaturezaId")&&(document.getElementById("filterNaturezaId").innerHTML=bt(B.natures,B.filterNaturezaId)),document.getElementById("filterCostCenterId")&&(document.getElementById("filterCostCenterId").innerHTML=bt(B.costCenters,B.filterCostCenterId)),va(),go()}catch(d){document.getElementById("financial-content")&&(b("Erro",`Não foi possível carregar os dados: ${d.message}`,"error"),e.innerHTML='<p class="text-red-500 text-center">Falha ao carregar dados.</p>')}}async function dl(e,t,a=null){e.preventDefault();const s=e.target,r=s.querySelector('[name="status"]').checked,o=s.querySelector('[name="paymentDate"]').value,n=parseFloat(s.querySelector('[name="amount"]').value),i=parseInt(s.querySelector('[name="installments"]')?.value,10)||1;if(isNaN(n)){b("Erro de Validação","O valor inserido é inválido.","error");return}if(r&&!o){b("Erro de Validação","Por favor, forneça a data de pagamento para um lançamento pago.","error");return}const l={description:s.querySelector('[name="description"]').value,amount:n,dueDate:s.querySelector('[name="dueDate"]').value,naturezaId:s.querySelector('[name="naturezaId"]').value||null,centroDeCustoId:s.querySelector('[name="centroDeCustoId"]').value||null,notes:s.querySelector('[name="notes"]').value,status:r?"paid":"pending",paymentDate:r?o:null,installments:a?1:i,establishmentId:p.establishmentId};try{a?(await(t==="payable"?vi(a,l):ki(a,l)),b("Sucesso","Lançamento atualizado!","success")):(await(t==="payable"?bi(l):yi(l)),b("Sucesso","Lançamento adicionado!","success")),document.getElementById("genericModal").style.display="none",await ye()}catch(d){b("Erro",`Não foi possível salvar: ${d.message}`,"error")}}async function cl(e,t){if(await j("Confirmar Exclusão","Tem certeza? Esta ação é irreversível."))try{await(e==="payable"?hi(t):Si(t)),b("Sucesso","Lançamento excluído!","success"),await ye()}catch(s){b("Erro",`Falha ao excluir: ${s.message}`,"error")}}async function ul(e,t){const a=new Date().toISOString().split("T")[0];try{await(e==="payable"?xi(t,a):$i(t,a)),b("Sucesso","Lançamento atualizado!","success"),await ye()}catch(s){b("Erro",`Falha ao atualizar status: ${s.message}`,"error")}}function po(e){const t=B.currentFilter;return t==="all"?e:e.filter(a=>a.status===t)}function va(){const e=document.getElementById("payables-list"),t=document.getElementById("receivables-list");if(!e||!t)return;const a=new Map(B.natures.map(i=>[i.id,i.name])),s=new Map(B.costCenters.map(i=>[i.id,i.name])),r=po(B.payables),o=po(B.receivables),n=(i,l)=>{const d=i.status==="paid",c=JSON.stringify(i).replace(/'/g,"&apos;"),u=i.naturezaId?a.get(i.naturezaId):"N/A",m=i.centroDeCustoId?s.get(i.centroDeCustoId):"N/A";let g=l==="payable"?"text-red-600":"text-green-600";const f=d?"bg-gray-200 text-gray-600":l==="payable"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-700",h=d?"Finalizado":"Pendente";return d&&(g="text-gray-500"),`
    ...
    `;if(a.innerHTML=`
        ...
        </div>`,a.style.display="flex",t){const m=a.querySelector('[name="naturezaId"]');m&&(m.value=t.naturezaId||"");const g=a.querySelector('[name="centroDeCustoId"]');g&&(g.value=t.centroDeCustoId||"")}const d=a.querySelector("#status"),c=a.querySelector("#payment-date-container"),u=a.querySelector('[name="paymentDate"]');t?.status==="paid"&&(d.checked=!0,c.classList.remove("hidden"),u.value=t.paymentDate||new Date().toISOString().split("T")[0]),d.addEventListener("change",()=>{c.classList.toggle("hidden",!d.checked),u.required=d.checked}),a.querySelector("#financial-form").addEventListener("submit",m=>dl(m,e,t?.id))}async function ml(){const e=new Date,a=new Date(e.getFullYear(),e.getMonth()-1,1).toISOString().split("T")[0],s=e.toISOString().split("T")[0];B.startDate=a,B.endDate=s,B.currentFilter="pending",B.filterNaturezaId="all",B.filterCostCenterId="all",rl.innerHTML=`
        <section>
    ...
    `;const r=document.getElementById("main-fab-btn"),o=document.getElementById("fab-menu");if(r&&o){r.addEventListener("click",h=>{h.stopPropagation(),o.classList.toggle("hidden"),r.classList.toggle("rotate-45")});const m=o.querySelector('button[data-action="open-modal"][data-type="receivable"]'),g=o.querySelector('button[data-action="open-modal"][data-type="payable"]'),f=o.querySelector('button[data-action="open-cash-flow-modal"]');m&&m.addEventListener("click",h=>{h.stopPropagation(),Kt("receivable")}),g&&g.addEventListener("click",h=>{h.stopPropagation(),Kt("payable")}),f&&f.addEventListener("click",h=>{h.stopPropagation(),mo()})}pt&&document.body.removeEventListener("click",pt),gt&&document.getElementById("genericModal").removeEventListener("click",gt);const n=()=>{const m=document.getElementById("filterStartDate"),g=document.getElementById("filterEndDate"),f=document.getElementById("filterNaturezaId"),h=document.getElementById("filterCostCenterId");if(!m)return;B.startDate=m.value,B.endDate=g.value,B.filterNaturezaId=f.value,B.filterCostCenterId=h.value;const w=document.getElementById("advanced-filters");w&&w.classList.contains("hidden")===!1&&window.innerWidth<768&&w.classList.add("hidden"),ye()},i=m=>{const g=m.target.closest("[data-status-filter]");if(!g)return;const f=g.dataset.statusFilter;B.currentFilter=f,document.querySelectorAll("[data-status-filter]").forEach(h=>{h.classList.remove("bg-blue-100","text-blue-800"),h.classList.add("bg-gray-100","text-gray-600")}),g.classList.remove("bg-gray-100","text-gray-600"),g.classList.add("bg-blue-100","text-blue-800"),va()},l=m=>{const g=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),h=document.getElementById("btn-payables-view"),w=document.getElementById("btn-receivables-view");g&&(window.innerWidth>=1024&&B.currentListView===m||(m==="payables"?(g.classList.remove("hidden"),f.classList.add("hidden"),h&&(h.classList.remove("bg-gray-200"),h.classList.add("bg-red-100","border","border-red-500")),w&&(w.classList.remove("bg-green-100","border","border-green-500"),w.classList.add("bg-gray-200"))):(g.classList.add("hidden"),f.classList.remove("hidden"),h&&(h.classList.remove("bg-red-100","border","border-red-500"),h.classList.add("bg-gray-200")),w&&(w.classList.remove("bg-gray-200"),w.classList.add("bg-green-100","border","border-green-500"))),B.currentListView=m))};document.getElementById("applyDateFilterBtn").addEventListener("click",n),document.getElementById("filterNaturezaId").addEventListener("change",()=>{B.filterNaturezaId=document.getElementById("filterNaturezaId").value}),document.getElementById("filterCostCenterId").addEventListener("change",()=>{B.filterCostCenterId=document.getElementById("filterCostCenterId").value}),document.querySelectorAll("[data-status-filter]").forEach(m=>{m.addEventListener("click",i)}),pt=m=>{const g=m.target.closest("button[data-action]");if(!g)return;const{action:f,type:h,id:w}=g.dataset;f==="edit"?Kt(h,JSON.parse(g.dataset.item.replace(/&apos;/g,"'"))):f==="delete"?cl(h,w):f==="mark-as-paid"?ul(h,w):f==="manage-natures"?co("nature"):f==="manage-cost-centers"?co("cost-center"):f==="open-cash-flow-modal"?mo():f==="toggle-filters"?document.getElementById("advanced-filters")?.classList.toggle("hidden"):f==="open-indicators-modal"?il():f==="open-settings-modal"?ll():f==="toggle-list-view"&&l(g.dataset.list)},gt=m=>{const g=m.target.closest('button[data-action^="delete-"]');if(g){const f=g.dataset.action.split("-")[1];d(f,g.dataset.id)}},document.body.addEventListener("click",pt),document.getElementById("genericModal").addEventListener("click",gt);async function d(m,g){const f=m==="nature",h=f?mi:gi,w=f?st:rt,S=f?"natures":"costCenters",I=document.getElementById("hierarchyList");if(await j("Apagar Item","Tem a certeza? Apagar um item principal também apagará os seus sub-itens."))try{await h(g);const k=await w(p.establishmentId);B[S]=k,Ko(I,Ma(k),m),await ye()}catch(k){b("Erro",`Não foi possível apagar: ${k.message}`,"error")}}const c=()=>{const m=window.innerWidth<1024,g=document.getElementById("payables-container"),f=document.getElementById("receivables-container"),h=document.getElementById("list-toggle-buttons");g&&f&&(g.classList.remove("hidden"),f.classList.remove("hidden"),m?(g.classList.remove("lg:col-span-1"),f.classList.remove("lg:col-span-1"),h?.classList.remove("hidden"),l(B.currentListView)):(g.classList.add("lg:col-span-1"),f.classList.add("lg:col-span-1"),h?.classList.add("hidden"),g.classList.remove("hidden"),f.classList.remove("hidden")))};c(),window.addEventListener("resize",c);const u=document.querySelector(`[data-status-filter="${B.currentFilter}"]`);u&&(document.querySelectorAll("[data-status-filter]").forEach(m=>{m.classList.remove("bg-blue-100","text-blue-800"),m.classList.add("bg-gray-100","text-gray-600")}),u.classList.remove("bg-gray-100","text-gray-600"),u.classList.add("bg-blue-100","text-blue-800"));try{const m=await Ii(p.establishmentId),g=document.getElementById("summary-today-payables");g&&(g.textContent=`R$ ${m.totalPayables.toFixed(2)}`);const f=document.getElementById("summary-today-receivables");f&&(f.textContent=`R$ ${m.totalReceivables.toFixed(2)}`)}catch{}await ye()}const pl=e=>y("/api/commissions/calculate",{method:"POST",body:JSON.stringify(e)}),gl=e=>y("/api/commissions/save",{method:"POST",body:JSON.stringify(e)}),bl=(e,t)=>{const a=new URLSearchParams({startDate:e,endDate:t}).toString();return y(`/api/commissions/stats?${a}`)},fl=(e={})=>{Object.keys(e).forEach(s=>(e[s]===void 0||e[s]===null||e[s]==="")&&delete e[s]);const t=new URLSearchParams(e).toString(),a=`/api/commissions/history${t?"?"+t:""}`;return y(a)},vl=e=>y(`/api/commissions/report/${e}`,{method:"DELETE"}),Lt=new Date,bo=new Date(Lt.getFullYear(),Lt.getMonth(),1),P={currentTab:"dashboard",professionals:[],calculationResult:null,historyData:[],periodString:"",dashStartDate:bo.toISOString().split("T")[0],dashEndDate:Lt.toISOString().split("T")[0],dashStats:{revenue:0,commissions:0},histStartDate:bo.toISOString().split("T")[0],histEndDate:Lt.toISOString().split("T")[0],histProfessionalId:"all"};let ft=null;const Je=document.getElementById("content");async function hl(){try{P.professionals=await X(p.establishmentId)}catch(e){console.error("Erro profissionais",e)}Tl(),xl(),Ut(),Bt("dashboard")}function xl(){ft&&Je.removeEventListener("click",ft),ft=e=>{const t=e.target.closest("button");if(!t)return;const a=t.dataset.action,s=t.dataset.id,r=t.dataset.idx;switch(a){case"tab-nav":Bt(t.dataset.tab);break;case"toggle-all-profs":yl();break;case"back-to-filters":P.calculationResult=null,Tt(document.getElementById("commissions-content"));break;case"view-preview-items":Ll(r);break;case"save-final-report":kl();break;case"start-new-calc":Bt("calculator");break;case"print-receipt":Sl(s);break;case"delete-report":$l(s);break;case"filter-dashboard":Ut();break;case"filter-history":Aa();break}},Je.addEventListener("click",ft),Je.oninput=e=>{if(e.target.classList.contains("input-debit")||e.target.classList.contains("input-credit")){const t=e.target.dataset.idx;Il(t)}},Je.onsubmit=e=>{e.target.id==="calc-form"&&(e.preventDefault(),wl())}}async function Ut(){const e=document.getElementById("dash-start"),t=document.getElementById("dash-end");e&&(P.dashStartDate=e.value),t&&(P.dashEndDate=t.value);const a=document.getElementById("dashboard-stats-container");a&&(a.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>');try{const s=await bl(P.dashStartDate,P.dashEndDate);P.dashStats={revenue:s.totalRevenue||0,commissions:s.totalCommissionsPaid||0},P.currentTab==="dashboard"&&es(document.getElementById("commissions-content"))}catch(s){console.error(s),a&&(a.innerHTML='<p class="text-red-500 text-center">Erro ao carregar dados.</p>')}}async function Aa(){const e=document.getElementById("hist-start"),t=document.getElementById("hist-end"),a=document.getElementById("hist-prof");e&&(P.histStartDate=e.value),t&&(P.histEndDate=t.value),a&&(P.histProfessionalId=a.value);const s=document.getElementById("history-list-container");if(s){s.innerHTML='<div class="flex justify-center py-10"><div class="loader"></div></div>';try{const r=await fl({startDate:P.histStartDate,endDate:P.histEndDate,professionalId:P.histProfessionalId});P.historyData=r,ts(s,r)}catch{s.innerHTML='<p class="text-red-500 text-center py-4">Erro ao buscar registros.</p>'}}}function yl(){const e=document.querySelectorAll(".prof-checkbox"),t=Array.from(e).every(a=>a.checked);e.forEach(a=>a.checked=!t)}async function wl(){const e=Array.from(document.querySelectorAll(".prof-checkbox:checked")).map(o=>o.value);if(e.length===0)return b("Atenção","Selecione profissionais","error");const t={professionalIds:e,startDate:document.getElementById("start-date").value,endDate:document.getElementById("end-date").value,calculationTypes:{services:document.getElementById("type-services").checked,products:document.getElementById("type-products").checked,packages:document.getElementById("type-packages").checked}},a=new Date(t.startDate+"T00:00:00").toLocaleDateString("pt-BR"),s=new Date(t.endDate+"T00:00:00").toLocaleDateString("pt-BR");P.periodString=`${a} a ${s}`;const r=document.getElementById("commissions-content");r.innerHTML='<div class="flex flex-col items-center justify-center py-20"><div class="loader mb-4"></div><p class="text-gray-500 animate-pulse">Calculando...</p></div>';try{const o=await pl(t);P.calculationResult=o.map(n=>({...n,extraDebit:0,extraCredit:0,finalValue:n.summary.totalCommission,notes:""})),Tt(r)}catch(o){b("Erro",o.message,"error"),P.calculationResult=null,Tt(r)}}async function kl(){const e=P.calculationResult.length;if(await j("Confirmar",`Gerar ${e} relatórios? Isso marcará as vendas como pagas.`))try{const a=P.calculationResult.map(s=>{const r=s.items.map(o=>o.originalSaleId).filter(o=>o!=null);return gl({professionalId:s.professionalId,professionalName:s.professionalName,period:P.periodString,processedSalesIds:r,reportData:{...s,summary:{...s.summary,finalValue:s.finalValue,extraDebit:s.extraDebit||0,extraCredit:s.extraCredit||0,notes:s.notes||""}}})});await Promise.all(a),b("Sucesso","Pagamentos registrados!","success"),P.calculationResult=null,Ut(),Bt("history")}catch(a){b("Erro",a.message,"error")}}function Sl(e){const t=P.historyData.find(a=>a.id===e);t&&El(t)}async function $l(e){if(await j("Excluir","Deseja remover este registro? As vendas voltarão a ficar disponíveis para cálculo."))try{await vl(e),b("Sucesso","Registro removido.","success"),Aa(),Ut()}catch(a){b("Erro",a.message,"error")}}function El(e){const{jsPDF:t}=window.jspdf;if(!t)return b("Erro","PDF lib não carregada.","error");const a=new t,s=a.internal.pageSize.getWidth()/2;a.setFontSize(18),a.setFont(void 0,"bold"),a.text("RECIBO DE PAGAMENTO DE COMISSÃO",s,20,{align:"center"}),a.setFontSize(12),a.setFont(void 0,"normal"),a.text(`Profissional: ${e.professionalName}`,15,40),a.text(`Período: ${e.period}`,15,48);const r=[["Comissão Bruta",`R$ ${e.summary.totalCommission.toFixed(2)}`]];e.summary.extraCredit>0&&r.push(["(+) Bônus",`R$ ${e.summary.extraCredit.toFixed(2)}`]),e.summary.extraDebit>0&&r.push(["(-) Descontos",`R$ ${e.summary.extraDebit.toFixed(2)}`]),a.autoTable({startY:60,head:[["Descrição","Valor"]],body:r,theme:"grid"});const o=a.lastAutoTable.finalY+10;a.setFontSize(14),a.setFont(void 0,"bold"),a.text(`Total Líquido: R$ ${(e.summary.finalValue||e.summary.totalCommission).toFixed(2)}`,190,o,{align:"right"}),a.save(`Recibo_${e.professionalName}.pdf`)}function Il(e){const t=document.querySelectorAll(`.input-debit[data-idx="${e}"]`),a=document.querySelectorAll(`.input-credit[data-idx="${e}"]`);let s=0,r=0;if(t.forEach(o=>{o.value&&(s=parseFloat(o.value))}),a.forEach(o=>{o.value&&(r=parseFloat(o.value))}),P.calculationResult&&P.calculationResult[e]){const o=P.calculationResult[e];o.extraDebit=s,o.extraCredit=r,o.finalValue=o.summary.totalCommission-s+r,t.forEach(i=>{i!==document.activeElement&&(i.value=s||"")}),a.forEach(i=>{i!==document.activeElement&&(i.value=r||"")}),document.querySelectorAll(`.final-value-display[data-idx="${e}"]`).forEach(i=>i.innerText=`R$ ${o.finalValue.toFixed(2)}`),Cl()}}function Cl(){const e=P.calculationResult.reduce((a,s)=>a+s.finalValue,0);document.querySelectorAll("#grand-total-display").forEach(a=>a.innerText=`R$ ${e.toFixed(2)}`)}function Ll(e){const t=P.calculationResult[e];if(!t)return;const a=t.items.map(s=>`
    ...
    `}function Bl(e){const t=P.professionals.map(a=>`<option value="${a.id}" ${P.histProfessionalId===a.id?"selected":""}>${a.name}</option>`).join("");e.innerHTML=`
        <div class="space-y-6">
    ...
    `,P.historyData.length>0?ts(document.getElementById("history-list-container"),P.historyData):Aa()}function ts(e,t){if(t.length===0){e.innerHTML=`
    ...
    `}const ea=document.getElementById("content");let we={allPackages:[],catalogForModal:{services:[],products:[]}},vt=null,Be=null;function Dl(e=6){let t="";for(let a=0;a<e;a++)t+=`
        ...
        `;return t}function Pl(){const e=document.getElementById("packagesListContainer");if(e){if(we.allPackages.length===0){e.innerHTML=`
            ...
            </div>`;return}e.innerHTML=we.allPackages.map(t=>{const a=t.status==="active",s=JSON.stringify(t).replace(/'/g,"&apos;"),r=t.price||0,o=t.originalPrice||0,n=o>r?o-r:0,i=o>0?(o-r)/o*100:0,l=v(t.name),d=v(t.description||"Sem descrição");return`
        ...
        `}).join("")}}function fo(){const e=document.getElementById("genericModal");e.style.display="none",Be&&e.removeEventListener("click",Be)}async function vo(e=null){const t=document.getElementById("genericModal"),a=!!e,s=e?JSON.parse(JSON.stringify(e.items||[])):[],r=v(e?.name||""),o=v(e?.description||""),n=e?.price||"",i=e?.commissionRate||0,l=e?.validityDays||30,d=`
    ...
    `;t.innerHTML=d,t.style.display="flex";const c=t.querySelector("#package-items-list"),u=(g,f)=>{const h=f.querySelector("#originalPrice"),w=g.reduce((S,I)=>S+I.price*I.quantity,0);h&&(h.textContent=`R$ ${w.toFixed(2)}`)},m=g=>{g.length===0?c.innerHTML='<p class="text-center text-gray-500 p-4">Nenhum item adicionado.</p>':c.innerHTML=g.map((f,h)=>{const w=f.type==="service",S=w?"Serviço":"Produto",I=w?"bg-indigo-100 text-indigo-800":"bg-green-100 text-green-800";return`
            ...
            `}).join(""),u(g,t)};m(s),c.addEventListener("change",g=>{if(g.target.classList.contains("quantity-input")){const f=parseInt(g.target.dataset.index,10),h=parseInt(g.target.value,10);h>0&&s[f]&&(s[f].quantity=h,m(s))}}),c.addEventListener("click",g=>{if(g.target.classList.contains("remove-item-btn")){const f=parseInt(g.target.dataset.index,10);s.splice(f,1),m(s)}}),t.querySelector("#add-item-to-package-btn").onclick=()=>Ml(g=>{const f=s.find(h=>h.id===g.id&&h.type===g.type);f?f.quantity++:s.push({...g,quantity:1}),m(s)}),Be&&t.removeEventListener("click",Be),Be=async g=>{const f=g.target.closest("button[data-action]");if(!f)return;const h=f.dataset.action;if(g.stopPropagation(),h==="close-modal"&&fo(),h==="save-package"){const w=f,S={id:document.getElementById("packageId").value||null,name:document.getElementById("packageName").value,description:document.getElementById("packageDescription").value,status:document.getElementById("packageStatus").value,items:s,originalPrice:s.reduce((I,E)=>I+E.price*E.quantity,0),price:parseFloat(document.getElementById("finalPrice").value),commissionRate:parseFloat(document.getElementById("commissionRate").value)||0,validityDays:parseInt(document.getElementById("validityDays").value,10)||null,establishmentId:p.establishmentId};if(!S.name||!S.price){b("Erro","Nome do Pacote e Preço Final são obrigatórios.","error");return}if(S.items.length===0){b("Erro","Adicione pelo menos um item ao pacote.","error");return}w.disabled=!0,w.textContent="A salvar...";try{a?await qr(S.id,S):(delete S.id,await Nr(S)),b("Sucesso!",`Pacote ${a?"atualizado":"criado"} com sucesso.`,"success"),fo(),await Na()}catch(I){b("Erro",`Não foi possível salvar o pacote: ${I.message}`,"error"),w.disabled=!1,w.textContent="Salvar Pacote"}}},t.addEventListener("click",Be)}function Ml(e){let t="";const a=document.createElement("div");a.id="item-selection-modal",a.className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[110]";const s={service:'<svg class="w-6 h-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v4.512a9.04 9.04 0 00-3 5.012M12 12a9.04 9.04 0 01-3-5.012V5l-1-1z" /></svg>',product:'<svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>'},r=l=>{const d=t.toLowerCase(),c=we.catalogForModal.services.filter(f=>f.name.toLowerCase().includes(d)),u=we.catalogForModal.products.filter(f=>f.name.toLowerCase().includes(d)),m=c.map(f=>`
    ...
    `,document.body.appendChild(a);const o=a.querySelector("#item-selection-list"),n=a.querySelector("#item-search-input"),i=()=>{a.remove()};r(o),n.addEventListener("input",()=>{t=n.value,r(o)}),a.addEventListener("click",l=>{const d=l.target.closest('[data-action="select-item"]'),c=l.target.closest('[data-action="close-selection-modal"]');if(d){const{itemType:u,itemId:m}=d.dataset,f=(we.catalogForModal[u+"s"]||[]).find(h=>h.id===m);f&&(e({...f,type:u}),i())}else(c||l.target===a)&&i()})}async function Na(){ea.innerHTML=`
    ...
    `,vt&&ea.removeEventListener("click",vt),vt=e=>{if(e.target.closest('[data-action-stop-propagation="true"]')){e.stopPropagation();const s=e.target.closest('[data-action="delete-package"]');if(s){const r=s.dataset.id;j("Excluir Pacote","Tem a certeza que deseja excluir este pacote? Esta ação é irreversível.").then(async o=>{if(o)try{await Fr(r),b("Sucesso!","Pacote excluído.","success"),await Na()}catch(n){b("Erro",`Não foi possível excluir: ${n.message}`,"error")}})}return}const t=e.target.closest('[data-action="new-package"], [data-action="edit-package"]');if(!t)return;const a=t.dataset.action;if(a==="new-package")vo(null);else if(a==="edit-package"){const s=JSON.parse(t.dataset.package);vo(s)}},ea.addEventListener("click",vt);try{const[e,t,a]=await Promise.all([Ao(p.establishmentId),Fe(p.establishmentId),Rt(p.establishmentId)]);we.allPackages=e,we.catalogForModal={services:t.filter(s=>s.active),products:a},Pl()}catch{document.getElementById("packagesListContainer").innerHTML='<p class="text-red-500 col-span-full">Erro ao carregar pacotes.</p>'}}const Al=document.getElementById("content");let Nl=null;async function ql(){const e=v(p.userName||"Usuário"),t=v(Y.currentUser?.email||"E-mail não disponível"),a=p.userName?p.userName.charAt(0):"U";Al.innerHTML=`
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
    ...
    `,await Fl()}async function Fl(){const e=document.getElementById("professional-agenda-block");e.innerHTML="";try{const t=p.userProfessionalId;if(t){const a=await Ds(t);Nl=a,a.photo&&(document.getElementById("user-profile-avatar").src=a.photo);const s=v(a.name);e.innerHTML=`
            ...
            `,Rl(a.id),document.getElementById("my-blocks-filter").addEventListener("change",o=>Dt(a.id,o.target.value)),Dt(a.id,"future")}else e.innerHTML=`
        ...
        `}}function Rl(e){const t=document.getElementById("block-schedule-form");t.addEventListener("submit",async a=>{a.preventDefault();const s=t.querySelector("#blockDate").value,r=t.querySelector("#blockStartTime").value,o=t.querySelector("#blockEndTime").value,n=t.querySelector("#blockReason").value;if(!s||!r||!o){b("Erro","Por favor, preencha a data e os horários de início e fim.","error");return}if(r>=o){b("Erro","A hora de início deve ser anterior à hora de fim.","error");return}const i=new Date(`${s}T${r}:00`),l=new Date(`${s}T${o}:00`),d=t.querySelector('button[type="submit"]');d.disabled=!0,d.textContent="A bloquear...";try{await Nt({establishmentId:p.establishmentId,professionalId:e,reason:n||"Bloqueado (Meu Perfil)",startTime:i.toISOString(),endTime:l.toISOString()}),b("Sucesso","Agenda bloqueada com sucesso!","success"),t.reset();const c=document.getElementById("my-blocks-filter").value;Dt(e,c)}catch(c){console.error("Erro ao bloquear agenda:",c),b("Erro",`Não foi possível bloquear a agenda: ${c.message}`,"error")}finally{d.disabled=!1,d.textContent="Bloquear Agenda"}})}async function Dt(e,t="future"){const a=document.getElementById("my-blocks-list");a.innerHTML='<p class="text-gray-500">A carregar bloqueios...</p>';try{const s=new Date;let r,o;t==="history"?(o=new Date,r=new Date,r.setFullYear(r.getFullYear()-1)):(r=new Date,o=new Date,o.setFullYear(o.getFullYear()+1));let i=(await At(p.establishmentId,r.toISOString(),o.toISOString(),e)).map(l=>({...l,startTime:new Date(l.startTime),endTime:new Date(l.endTime)}));t==="history"?i=i.filter(l=>l.endTime<s).sort((l,d)=>d.startTime-l.startTime):i=i.filter(l=>l.endTime>=s).sort((l,d)=>l.startTime-d.startTime),i.length>0?(a.innerHTML=i.map(l=>{const d=l.startTime.toLocaleDateString("pt-BR"),c=`${l.startTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})} - ${l.endTime.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}`,u=l.endTime<new Date,m=v(l.reason||"Sem motivo");return`
                ...
                `}).join(""),a.querySelectorAll(".remove-block-btn").forEach(l=>{l.addEventListener("click",async d=>{const c=d.currentTarget.dataset.blockId;if(confirm("Tem certeza que deseja remover este bloqueio?"))try{await ka(c),b("Sucesso","Bloqueio removido.","success"),Dt(e,t)}catch(u){console.error("Erro ao remover bloqueio:",u),b("Erro",`Não foi possível remover o bloqueio: ${u.message}`,"error")}})})):a.innerHTML=`<p class="text-gray-500 py-4 text-center">Nenhum bloqueio ${t==="history"?"no histórico recente":"futuro agendado"}.</p>`}catch(s){console.error("Erro ao carregar bloqueios:",s),a.innerHTML=`<p class="text-red-500">Erro ao carregar bloqueios: ${v(s.message)}</p>`}}const ht=document.getElementById("loadingScreen"),ta=document.getElementById("dashboardContent"),aa=document.getElementById("content"),ho=document.getElementById("notificationBell"),oa=document.getElementById("notificationBadge"),xt=document.getElementById("notificationPanel"),xo=document.getElementById("notificationList"),sa=document.getElementById("profileMenuButton"),ee=document.getElementById("profileDropdown"),jl=document.getElementById("profileName"),Hl=document.getElementById("profileEmail"),Ol=document.getElementById("logoutButton"),zl=document.getElementById("cancellationHistoryBtn"),yo=document.getElementById("myProfileLink"),wo={indigo:{main:"#4f46e5",hover:"#4338ca",light:"#e0e7ff",text:"#ffffff"},blue:{main:"#2563eb",hover:"#1d4ed8",light:"#dbeafe",text:"#ffffff"},sky:{main:"#0284c7",hover:"#0369a1",light:"#e0f2fe",text:"#ffffff"},teal:{main:"#0d9488",hover:"#0f766e",light:"#ccfbf1",text:"#ffffff"},emerald:{main:"#059669",hover:"#047857",light:"#d1fae5",text:"#ffffff"},green:{main:"#16a34a",hover:"#15803d",light:"#dcfce7",text:"#ffffff"},lime:{main:"#65a30d",hover:"#4d7c0f",light:"#ecfccb",text:"#ffffff"},amber:{main:"#d97706",hover:"#b45309",light:"#fef3c7",text:"#1f2937"},orange:{main:"#ea580c",hover:"#c2410c",light:"#ffedd5",text:"#ffffff"},red:{main:"#dc2626",hover:"#b91c1c",light:"#fee2e2",text:"#ffffff"},rose:{main:"#e11d48",hover:"#be123c",light:"#ffe4e6",text:"#ffffff"},pink:{main:"#db2777",hover:"#be185d",light:"#fce7f3",text:"#ffffff"},fuchsia:{main:"#c026d3",hover:"#a21caf",light:"#fae8ff",text:"#ffffff"},purple:{main:"#7c3aed",hover:"#6d28d9",light:"#ede9fe",text:"#ffffff"},violet:{main:"#8b5cf6",hover:"#7c3aed",light:"#ddd6fe",text:"#ffffff"},gray:{main:"#4b5563",hover:"#374151",light:"#f3f4f6",text:"#ffffff"},black:{main:"#111827",hover:"#000000",light:"#e5e7eb",text:"#ffffff"}};let Ze=null,Ke=[];const Vl={"agenda-section":Po,"comandas-section":Ea,"relatorios-section":Kr,"servicos-section":bn,"produtos-section":Bn,"suppliers-section":jn,"profissionais-section":It,"clientes-section":Vt,"estabelecimento-section":Zo,"ausencias-section":zi,"users-section":Ct,"sales-report-section":sl,"financial-section":ml,"commissions-section":hl,"packages-section":Na,"my-profile-section":ql};function Ul(e){const t=wo[e]||wo.indigo,s=(o=>{const n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o);return n?`${parseInt(n[1],16)}, ${parseInt(n[2],16)}, ${parseInt(n[3],16)}`:"79, 70, 229"})(t.main);document.body.style.setProperty("--theme-main",t.main);const r=document.getElementById("dynamic-theme-styles");r.innerHTML=`
        :root {
    ...
    `}function ha(){const e=Ke.filter(t=>!t.read).length;if(e>0?(oa.textContent=e,oa.classList.remove("hidden")):oa.classList.add("hidden"),Ke.length===0){xo.innerHTML='<p class="text-center text-gray-500 p-4">Nenhuma notificação.</p>';return}xo.innerHTML=Ke.map(t=>`
    ...
    `).join("")}function Jl(e){Ze&&Ze();const t=ue(U,"establishments",e,"notifications"),a=Pt(t,et("timestamp",">=",new Date),So("timestamp","desc"));Ze=us(a,s=>{s.docChanges().forEach(r=>{if(r.type==="added"){const o=r.doc.data();Ke.unshift({title:o.title,message:o.message,time:o.timestamp.toDate().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),read:!1}),b(o.title,o.message,"info",!0),ha();const n=document.querySelector(".sidebar-link.active");n&&n.dataset.target==="agenda-section"&&(o.type==="cancellation"||o.type==="new_appointment")&&(console.log("Atualizando agenda em tempo real..."),Po())}})},s=>{console.error("Erro no listener de notificações em tempo real:",s),b("Erro de Conexão","Não foi possível receber atualizações em tempo real. Verifique as regras de segurança do Firestore.","error")})}function K(e,t={}){const a=e.replace("-section","");if(e!=="my-profile-section"){const r=p.enabledModules?.[a]!==!1,o=p.userPermissions===null||p.userPermissions[e]?.view===!0;if(!r||!o){aa.innerHTML='<div class="p-8 text-center"><h2 class="text-2xl font-bold text-red-600">Acesso Negado</h2><p class="text-gray-600">Você não tem permissão para visualizar este módulo.</p></div>',document.querySelectorAll(".sidebar-link").forEach(n=>n.classList.remove("active"));return}}const s=Vl[e];s?(document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.toggle("active",r.getAttribute("data-target")===e)}),e==="my-profile-section"&&document.querySelectorAll(".sidebar-link").forEach(r=>r.classList.remove("active")),aa.innerHTML="",s(t)):(aa.innerHTML=`<div class="p-8 text-center"><h2 class="text-2xl font-bold">Página em Construção</h2><p class="text-gray-600">O módulo para "${e}" ainda não foi implementado.</p></div>`,console.warn(`Nenhum carregador de página definido para: ${e}`))}async function _l(e){const t=document.getElementById("kpi-appointments-wrapper"),a=document.getElementById("kpi-financial-wrapper"),s=document.getElementById("kpi-today-appointments"),r=document.getElementById("kpi-today-revenue"),o=e===null||e["agenda-section"]?.view===!0,n=e===null||e["financial-section"]?.view===!0;if(o&&t&&t.classList.remove("hidden"),n&&a&&a.classList.remove("hidden"),!(!o&&!n))try{const i=await Ws();o&&s&&(s.textContent=i.todayAppointments.toString()),n&&r&&(r.textContent=`R$ ${i.todayRevenue.toFixed(2).replace(".",",")}`)}catch(i){console.error("Erro ao carregar KPIs do cabeçalho:",i),o&&s&&(s.textContent="Erro"),n&&r&&(r.textContent="Erro")}}async function Wl(e){try{tt.getPlatform()==="android"&&(await ie.createChannel({id:"default",name:"Notificações Gerais",description:"Alertas de agendamentos e avisos",importance:5,visibility:1,vibration:!0}),console.log("Canal de notificação Android criado com sucesso."));let t=await ie.checkPermissions();if(t.receive==="prompt"&&(t=await ie.requestPermissions()),t.receive!=="granted"){console.warn("Permissão de notificação push foi negada pelo utilizador.");return}await ie.register(),ie.addListener("registration",async a=>{console.log("Push Token gerado:",a.value);try{const s=ke(U,"users",e);await Eo(s,{fcmToken:a.value}),console.log("Token FCM salvo no perfil do utilizador.")}catch(s){console.error("Erro ao salvar token FCM:",s)}}),ie.addListener("registrationError",a=>{console.error("Erro no registo de push notifications:",a)}),ie.addListener("pushNotificationReceived",a=>{console.log("Notificação Push recebida:",a),b(a.title,a.body,"info",!0)}),ie.addListener("pushNotificationActionPerformed",a=>{console.log("Ação na notificação push:",a),K("agenda-section")})}catch(t){console.log("Push Notifications não suportado/inicializado:",t)}}function Gl(){tt.isNativePlatform()&&(document.body.classList.add("is-app-native"),console.log("Modo App Nativo detectado: Layout ajustado para Safe Areas.")),ks(),ho.addEventListener("click",e=>{e.stopPropagation(),xt.classList.toggle("hidden"),xt.classList.contains("hidden")||(Ke.forEach(t=>t.read=!0),ha())}),zl.addEventListener("click",()=>{Ss()}),sa.addEventListener("click",e=>{e.stopPropagation(),ee.classList.toggle("active"),ee.classList.contains("active")?ee.classList.remove("hidden"):setTimeout(()=>ee.classList.add("hidden"),200)}),yo&&yo.addEventListener("click",e=>{e.preventDefault(),K("my-profile-section"),ee.classList.remove("active"),ee.classList.add("hidden")}),document.addEventListener("click",e=>{!xt.contains(e.target)&&e.target!==ho&&xt.classList.add("hidden"),!ee.contains(e.target)&&e.target!==sa&&ee.classList.contains("active")&&(ee.classList.remove("active"),setTimeout(()=>ee.classList.add("hidden"),200))}),ls(Y,async e=>{if(e)try{const a=(await e.getIdTokenResult(!0)).claims;if((a.role==="owner"||a.role==="employee")&&a.establishmentId){const s=await qe(a.establishmentId);p.enabledModules=s.modules,Ul(s.themeColor||"indigo");let r=null,o=e.displayName,n=null;if(a.role==="employee"||a.role==="owner"){const d=ke(U,"users",e.uid),c=await cs(d);if(c.exists()){const u=c.data();r=a.role==="employee"?u.permissions||{}:null,o=u.name||o,n=u.professionalId||null}else if(a.role==="employee")throw new Error("Dados de permissão do funcionário não encontrados.")}p.userProfessionalId=n,Wl(e.uid);const i=o||e.email;ms(a.establishmentId,s.name,r),sa.textContent=i.charAt(0).toUpperCase(),jl.textContent=i,Hl.textContent=e.email;const l=()=>{Ze&&Ze(),qa(Y).then(()=>window.location.href="/login.html")};Ol.addEventListener("click",d=>{d.preventDefault(),l()}),Cs(K,r,p.enabledModules),_l(r),Jl(a.establishmentId),ha(),ht.classList.add("fade-out"),ta.style.display="flex",setTimeout(()=>{ht.style.display="none"},500),K("agenda-section")}else throw new Error("Utilizador não tem permissão de 'owner' ou 'employee' ou 'establishmentId'.")}catch(t){console.error("Erro crítico na inicialização do painel:",t),ht.classList.add("fade-out"),setTimeout(()=>{ht.style.display="none"},500),ta.innerHTML=`
                ...
                `,ta.style.display="flex",document.getElementById("errorLogoutButton").addEventListener("click",()=>{qa(Y).then(()=>window.location.href="/login.html")})}else window.location.href="/login.html"})}Gl();
